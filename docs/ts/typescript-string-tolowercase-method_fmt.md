# TypeScript | String to lowercase()方法

> 原文：[https://www.geeksforgeeks.org/typescript-string-tolowercase-method/](https://www.geeksforgeeks.org/typescript-string-tolowercase-method/)
