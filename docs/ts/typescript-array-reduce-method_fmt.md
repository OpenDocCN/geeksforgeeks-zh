...
> 原文: [https://www.geeksforgeeks.org/typescript-array-reduce-method/](https://www.geeksforgeeks.org/typescript-array-reduce-method/)
...
以下示例说明了 TypeScript 中的 `Array.reduce()` 方法。
