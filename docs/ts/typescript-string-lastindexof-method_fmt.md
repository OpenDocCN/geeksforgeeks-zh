# TypeScript String lastIndexOf() 方法

> 原文: [https://www.geeksforgeeks.org/typescript-string-lastindexof-method/](https://www.geeksforgeeks.org/typescript-string-lastindexof-method/)
