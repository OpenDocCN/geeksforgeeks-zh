...
> 原文：[https://www.geeksforgeeks.org/difference-between-es6-and-typescript/](https://www.geeksforgeeks.org/difference-between-es6-and-typescript/)
...
| --- | --- | --- |
| 1. | `ECMAScript 6` is the sixth edition of `ECMAScript` trademark script language specification defined by `ECMA International`. | `TypeScript` is a free and open source pure object-oriented programming language developed and maintained by Microsoft. |
