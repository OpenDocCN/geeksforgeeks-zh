# TypeScript 字符串 concat() 方法

> 原文: [https://www.geeksforgeeks.org/typescript-string-concat-method/](https://www.geeksforgeeks.org/typescript-string-concat-method/)
...
*   `string2…stringN`: 此参数保存将要连接的字符串。

## 返回值:

这个方法返回串联的字符串。

下面的示例说明了 TypeScript 中的字符串 `concat()` 方法:
