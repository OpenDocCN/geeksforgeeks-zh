# TypeScript 数组 every() 方法

> 原文: [https://www.geeksforgeeks.org/typescript-array-every-method/](https://www.geeksforgeeks.org/typescript-array-every-method/)
...
以下示例说明了 TypeScript 中的 `Array.every()` 方法
