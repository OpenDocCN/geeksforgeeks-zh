# TypeScript | 字符串 split() 方法

> 原文: [https://www.geeksforgeeks.org/typescript-string-split-method/](https://www.geeksforgeeks.org/typescript-string-split-method/)
...
*   `separator` – 该参数是用于分隔字符串的字符。
*   `limit` – 该参数是整数，指定要查找的拆分数量的限制。
