...
> 原文: [https://www.geeksforgeeks.org/javascript-typeerror-reduce-of-empty-array-with-no-initial-value/](https://www.geeksforgeeks.org/javascript-typeerror-reduce-of-empty-array-with-no-initial-value/)

如果对空数组使用 `reduce` 函数，将出现这个没有初始值的空数组的 JavaScript 异常。

**消息:** `reduce of empty array with no initial value`
