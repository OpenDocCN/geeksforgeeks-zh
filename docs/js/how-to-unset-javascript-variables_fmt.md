...
> 原文: [https://www.geeksforgeeks.org/how-to-unset-javascript-variables/](https://www.geeksforgeeks.org/how-to-unset-javascript-variables/)
...
此外，如上所述，变量不能在 JavaScript 中被销毁。那么，现在能做些什么呢？一些开发人员可能会建议使用`delete`，但`delete`操作符会从对象中移除属性。它不能移除变量。那么，在 JS 中最接近解除变量设置的方法是什么呢？
