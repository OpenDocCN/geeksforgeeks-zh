...
> 原文: [https://www.geeksforgeeks.org/how-to-check-a-given-string-is-an-anagram-of-another-string-in-javascript/](https://www.geeksforgeeks.org/how-to-check-a-given-string-is-an-anagram-of-another-string-in-javascript/)

**字谜:** 字谜是一个单词或句子，通常包含所有原始字母恰好一次，以便排列不同术语或短语的字母。一些例子如下:

> **1. evil = live**
> 
> **2. gentleman = elegant man**
> 
