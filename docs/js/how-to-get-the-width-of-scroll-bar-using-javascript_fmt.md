...
> 原文：[https://www.geeksforgeeks.org/how-to-get-the-width-of-scroll-bar-using-javascript/](https://www.geeksforgeeks.org/how-to-get-the-width-of-scroll-bar-using-javascript/)
...
*   `clientWidth` 定义元素的宽度。
*   因此滚动条可以定义为 `width = offsetWidth - clientWidth`。
