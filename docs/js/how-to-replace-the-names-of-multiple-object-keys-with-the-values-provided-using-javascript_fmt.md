...
> 原文：[https://www.geeksforgeeks.org/how-to-replace-the-names-of-multiple-object-keys-with-the-values-provided-using-javascript/](https://www.geeksforgeeks.org/how-to-replace-the-names-of-multiple-object-keys-with-the-values-provided-using-javascript/)
...
以上面举例说明的对象为例。这个对象包含像“你好”这样的键值对。因此，让我们假设我们的目标是`name`密钥，并且我们将通过以下方法将此`name`密钥更改为`FirstName`密钥名称。
...
现在，除了`FirstName`键，`age`键也被替换为用户提供的新名字。
