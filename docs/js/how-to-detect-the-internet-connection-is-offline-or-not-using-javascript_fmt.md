...
> 原文：[https://www.geeksforgeeks.org/how-to-detect-the-internet-connection-is-offline-or-not-using-javascript/](https://www.geeksforgeeks.org/how-to-detect-the-internet-connection-is-offline-or-not-using-javascript/)
...
<html>
<body>
<p>Click the button to check if the browser is online.</p>
<button onclick="isOnline()">Click Me</button>
<p id="demo"></p>
<script>
    function isOnline() {
        if (navigator.onLine) {
