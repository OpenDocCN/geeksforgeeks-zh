...
> 原文：[https://www.geeksforgeeks.org/how-to-get-the-day-and-month-of-a-year-using-javascript/](https://www.geeksforgeeks.org/how-to-get-the-day-and-month-of-a-year-using-javascript/)
...
*   使用``currentDay.getDay()``获取数字格式的当前日期，映射到日期名称。
*   使用``currentDay.getMonth()``获取数字格式的当前月份，映射到月份名称。
...
这是同一个示例，但方法不同。在本例中，月份和日期由上述方法确定。
