...
> 原文：[https://www.geeksforgeeks.org/how-to-select-all-text-in-html-text-input-when-clicked-using-javascript/](https://www.geeksforgeeks.org/how-to-select-all-text-in-html-text-input-when-clicked-using-javascript/)
...
## 示例-2：使用 DOM `InputText.select()` 方法
