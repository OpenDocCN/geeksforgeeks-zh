# 如何在 JavaScript 中将对象转换为键值对的数组？

> 原文：`https://www.geeksforgeeks.org/how-to-convert-an-object-to-an-array-of-key-value-pairs-in-javascript/`
...
## 方法 1：使用 `Object.keys()` 和 `map()`

在此方法中，我们将使用 `Object.keys()` 和 `map()` 来实现这一点。
...
在这个方法中，我们将使用 `Object.entries()` 来实现这一点。
