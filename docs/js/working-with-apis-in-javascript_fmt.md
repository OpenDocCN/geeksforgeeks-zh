...
> 原文：[https://www.geeksforgeeks.org/working-with-apis-in-javascript/](https://www.geeksforgeeks.org/working-with-apis-in-javascript/)
...
[https://randomuser.me/](https://randomuser.me/)是一个为随机用户提供虚拟数据的网站，我们可以轻松使用。我们可以通过向`https://randomuser.me/api/`提出请求来获得响应。我们收到的 [`JSON`](https://www.geeksforgeeks.org/javascript-json/) 回复的格式如下。
