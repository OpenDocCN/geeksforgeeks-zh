...
> 原文: [https://www.geeksforgeeks.org/next-js-dynamic-route-segments/](https://www.geeksforgeeks.org/next-js-dynamic-route-segments/)
...
创建一个名为“动态”的新文件夹，并在该文件夹内创建一个动态路由。我们可以通过在文件名中使用方括号在 NextJs 中创建动态路由。例如:
...
创建一个名为`[data].js`的动态路由文件，并在文件中添加以下内容。
