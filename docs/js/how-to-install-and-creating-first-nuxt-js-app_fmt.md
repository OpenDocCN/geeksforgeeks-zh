...
> 原文: [https://www.geeksforgeeks.org/how-to-install-and-creating-first-nuxt-js-app/](https://www.geeksforgeeks.org/how-to-install-and-creating-first-nuxt-js-app/)
...
现在在桌面上为您的项目创建一个文件夹，并通过您的终端导航到该文件夹。

### 第二步:

在终端运行以下命令。`my-app` 是我们应用的名字，你可以选择任何名字。
...
**参考:** [https://nuxtjs.org/docs/2.x/get-started/installation](https://nuxtjs.org/docs/2.x/get-started/installation)