...
> 原文：[https://www.geeksforgeeks.org/how-to-view-array-of-a-structure-in-javascript/](https://www.geeksforgeeks.org/how-to-view-array-of-a-structure-in-javascript/)
...
`alert()` 的功能是首先向用户提供信息，然后再继续。所以，在下面的代码中，点击 `Alert()` 的按钮有两个提醒 (`alert()`)，在显示完所有的提醒后，它会进一步进入网页。通过点击警报框中的“确定”，它将显示下一个警报，直到所有警报完成。

### 我们来看看可以应用的预警类型：

*   `alert(JSON.stringify(guardians))`：显示为数组结构。
