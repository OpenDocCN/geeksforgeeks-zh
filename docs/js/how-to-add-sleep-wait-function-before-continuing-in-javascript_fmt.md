...
> 原文: [https://www.geeksforgeeks.org/how-to-add-sleep-wait-function-before-continuing-in-javascript/](https://www.geeksforgeeks.org/how-to-add-sleep-wait-function-before-continuing-in-javascript/)

与其他语言不同，JavaScript 没有任何方法来模拟 `sleep()` 函数。有一些方法可以用来模拟睡眠功能。

## 方法 1: 使用无限循环继续检查经过的时间

睡眠功能开始的时间首先使用 `new Date().getTime()` 方法找到。这将返回自 Epoch 时间以来经过的毫秒数。
