...
> 原文: [https://www.geeksforgeeks.org/chaining-of-array-methods-in-javascript/](https://www.geeksforgeeks.org/chaining-of-array-methods-in-javascript/)

JavaScript 中有一些方法可以在数组中循环。我们已经了解了这些数组方法。

1.  `filter()` 方法 ([过滤()](https://www.geeksforgeeks.org/javascript-array-filter-function/))
2.  `map()` 方法 ([地图法()](https://www.geeksforgeeks.org/javascript-array-map-method/))
3.  `reduce()` 方法 ([还原法()](https://www.geeksforgeeks.org/javascript-array-reduce-method/))
4.  `find()` 方法 ([查找方法()](https://www.geeksforgeeks.org/javascript-array-prototype-find-function/))
5.  `sort()` 方法 ([排序方法()](https://www.geeksforgeeks.org/javascript-sort-method/))
