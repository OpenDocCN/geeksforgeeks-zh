...
> 原文: [https://www.geeksforgeeks.org/javascript-array-reduceright-method/](https://www.geeksforgeeks.org/javascript-array-reduceright-method/)

下面是数组 `reduceRight()` 方法的例子。
