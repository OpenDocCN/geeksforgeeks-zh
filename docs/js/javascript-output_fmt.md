...
`innerHTML` 用于访问一个元素。它定义了 HTML 内容。
...
<body>
    ...
    <script>
        document.getElementById("GFG").innerHTML = 10 * 2;
    </script>
</body>
</html>
```
