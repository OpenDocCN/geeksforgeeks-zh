...
> 原文：[https://www.geeksforgeeks.org/javascript-object-initializer/](https://www.geeksforgeeks.org/javascript-object-initializer/)
...
`new Object()` 方法将创建一个新的 JavaScript 对象，其属性可以使用点或括号符号进行初始化。
...
在该方法中，构造函数用于定义对象，[`this`](https://www.geeksforgeeks.org/this-in-javascript/) 用于给属性赋值。使用 `new` 关键字创建对象的实例。
