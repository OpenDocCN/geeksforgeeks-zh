...
> 原文：[https://www.geeksforgeeks.org/how-to-create-a-function-from-a-string-in-javascript/](https://www.geeksforgeeks.org/how-to-create-a-function-from-a-string-in-javascript/)

任务是根据函数格式给出的字符串创建一个函数。这里讨论了一些借助 JavaScript 的技术。

## 方法 1

*   使用`Function()`构造器从字符串创建函数。
