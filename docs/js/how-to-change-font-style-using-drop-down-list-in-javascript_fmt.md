...
> 原文：[https://www.geeksforgeeks.org/how-to-change-font-style-using-drop-down-list-in-javascript/](https://www.geeksforgeeks.org/how-to-change-font-style-using-drop-down-list-in-javascript/)
...
**通过选项下拉菜单改变字体样式：** 字体值可以使用[选项值](https://www.geeksforgeeks.org/html-option-value-attribute/)在 `<option>` 标签中传递。
