...
> 原文：[https://www.geeksforgeeks.org/how-to-convert-jquery-to-javascript/](https://www.geeksforgeeks.org/how-to-convert-jquery-to-javascript/)
...
在 jQuery 中，要选择任意元素，我们只需使用 `$()` 符号，但在 JavaScript 中，要选择任意元素，我们可以使用 [`querySelector()`](https://www.geeksforgeeks.org/html-dom-queryselector-method/) 或 [`querySelectorAll()`](https://www.geeksforgeeks.org/html-dom-queryselectorall-method/)。
