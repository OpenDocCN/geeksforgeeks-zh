...
> 原文: [https://www.geeksforgeeks.org/factorial-of-a-number-using-javascript/](https://www.geeksforgeeks.org/factorial-of-a-number-using-javascript/)
...
在这种方法中，我们使用 `for` 循环来迭代数字序列并获得阶乘。
...
在这种方法中，我们一次又一次地调用同一个函数来得到一个数的阶乘。
