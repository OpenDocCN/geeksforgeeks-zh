...
> 原文: [https://www.geeksforgeeks.org/javascript-regexp-metacharacter/](https://www.geeksforgeeks.org/javascript-regexp-metacharacter/)

正则表达式中的元字符用于搜索单个字符，除了行结束符或换行符。
