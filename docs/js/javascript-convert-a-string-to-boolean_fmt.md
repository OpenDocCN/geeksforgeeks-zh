...
> 原文：[https://www.geeksforgeeks.org/javascript-convert-a-string-to-boolean/](https://www.geeksforgeeks.org/javascript-convert-a-string-to-boolean/)

有时需要将代表布尔值“真”、“假”的字符串转换为 JavaScript 的固有类型。给定一个字符串，任务是将给定的字符串转换为它的布尔值。

## 示例 1
本示例使用 `==` 运算符将字符串转换为其布尔值。
