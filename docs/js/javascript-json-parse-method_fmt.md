...
> 原文：`https://www.geeksforgeeks.org/javascript-json-parse-method/`
...
<body>
    ...
    <p id="GFG"></p>
    <!-- Script to parse a string and return JavaScript object -->
    <script>
        var obj = JSON.parse('{"var1":"Hello", "var2":"Geeks!"}');
        document.getElementById("GFG").innerHTML = obj.var1 + " " + obj.var2;
    </script>
</body>
</html>
```
...
本示例使用 reviver 函数解析字符串并返回 JavaScript 对象。
...
<body>
    ...
    <script>
        ...
        document.getElementById("GFG").innerHTML = obj.var1 + ", " + obj.gender;
    </script>
</body>
</html>
```
