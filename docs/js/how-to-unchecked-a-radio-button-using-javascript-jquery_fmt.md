...
> 原文: [https://www.geeksforgeeks.org/how-to-unchecked-a-radio-button-using-javascript-jquery/](https://www.geeksforgeeks.org/how-to-unchecked-a-radio-button-using-javascript-jquery/)

为了取消选中`单选按钮`，有很多方法可用，但我们将看到最首选的方法。
...
**示例 2:** 本示例使用`jQuery prop()`方法取消选中`单选按钮`。jQuery 中的`prop()`方法，用于设置或返回所选元素的属性和值。
