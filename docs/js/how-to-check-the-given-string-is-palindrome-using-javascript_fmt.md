...
> 原文: [https://www.geeksforgeeks.org/how-to-check-the-given-string-is-palindrome-using-javascript/](https://www.geeksforgeeks.org/how-to-check-the-given-string-is-palindrome-using-javascript/)

一个**回文**是一个从后往前读都一样的单词、句子或偶数。因此，如果我们接受输入，反转字符串并检查反转后的字符串和原始字符串是否相等，这意味着该字符串是回文，否则不是。
