...
> 原文: [https://www.geeksforgeeks.org/javascript-check-if-a-string-is-a-valid-hex-color-representation/](https://www.geeksforgeeks.org/javascript-check-if-a-string-is-a-valid-hex-color-representation/)
...
## 示例 2:
这个示例比前面的示例进行了更高级的检查。在这个例子中，也检查了六进制代码的有效性。
