...
> 原文: [https://www.geeksforgeeks.org/javascript-rangeerror-repeat-count-must-be-less-than-infinity/](https://www.geeksforgeeks.org/javascript-rangeerror-repeat-count-must-be-less-than-infinity/)
...
传递的 `String.prototype.repeat()` 方法的计数参数小于 0 或大于无穷大。

## 例 1

在本例中，传递的参数是 4，所以没有出现错误。
...
在本例中，传递的参数是 2<sup>32</sup>，所以出现了错误。
