...
> 原文：[https://www.geeksforgeeks.org/how-to-set-the-value-of-a-select-box-element-using-javascript/](https://www.geeksforgeeks.org/how-to-set-the-value-of-a-select-box-element-using-javascript/)

在 JavaScript 中，`selectedIndex` 属性用于设置选择框元素的值。`selectedIndex` 属性设置或在下拉列表中返回所选值的索引。

## 语法

> **设置索引：** `selectObject.selectedIndex = number`
> **返回索引：** `selectObject.selectedIndex`
...
### 示例-2：如果选择 `selectedIndex = "-1"`；取消选择选择框的所有元素
