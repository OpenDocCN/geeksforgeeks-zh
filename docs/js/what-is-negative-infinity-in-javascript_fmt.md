...
> 原文：[https://www.geeksforgeeks.org/what-is-negative-infinity-in-javascript/](https://www.geeksforgeeks.org/what-is-negative-infinity-in-javascript/)
...
<body>
    ...
    <h1>GeeksforGeeks</h1>
    <h1>What is negative infinity in JavaScript?</h1>
    <button onclick="geekNegativeInfinity()">Generate negative infinite</button>
    <p id="geek"></p>
    <script>
