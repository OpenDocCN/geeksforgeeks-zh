...
> 原文：[https://www.geeksforgeeks.org/how-to-detect-flash-is-installed-or-not-using-javascript/](https://www.geeksforgeeks.org/how-to-detect-flash-is-installed-or-not-using-javascript/)

## 任务描述
任务是在 JavaScript 的帮助下检测用户是否安装了 Adobe Flash 播放器。我们将讨论 2 个技巧。

### 方法
*   创建 `ShockwaveFlash.ShockwaveFlash` 对象。
*   如果实例的值为真，则安装闪存。
*   如果出现任何错误，使用 `navigator.mimeTypes` 属性了解闪存是否已安装。
