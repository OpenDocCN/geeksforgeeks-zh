# JavaScript | trimStart()和trimLeft()方法

> 原文: [https://www.geeksforgeeks.org/javascript-trimstart-and-trimleft-method/](https://www.geeksforgeeks.org/javascript-trimstart-and-trimleft-method/)
...
`trimStart()` 方法有一个别名，即 `trimLeft()` 方法。它执行与 `trimStart()` 方法完全相同的功能。
