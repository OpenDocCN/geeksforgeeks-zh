...
> 原文：[https://www.geeksforgeeks.org/how-to-sort-numeric-array-using-javascript/](https://www.geeksforgeeks.org/how-to-sort-numeric-array-using-javascript/)

[`Array.sort()`](https://www.geeksforgeeks.org/javascript-array-sort/) 方法用于对数组元素进行就地排序，并返回排序后的数组。该函数以字符串格式对元素进行排序。它对字符串数组有效，但对数字无效。例如：如果数字按字符串排序，那么 `"75"` 比 `"200"` 大。
