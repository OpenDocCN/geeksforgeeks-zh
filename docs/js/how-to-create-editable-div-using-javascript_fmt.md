...
> 原文: [https://www.geeksforgeeks.org/how-to-create-editable-div-using-javascript/](https://www.geeksforgeeks.org/how-to-create-editable-div-using-javascript/)
...
*   **Step 1:** 编辑 `index.html`。此文件包含以下代码。
