...
> 原文: [https://www.geeksforgeeks.org/how-to-remove-the-key-value-pairs-corresponding-to-the-given-keys-from-an-object-using-javascript/](https://www.geeksforgeeks.org/how-to-remove-the-key-value-pairs-corresponding-to-the-given-keys-from-an-object-using-javascript/)

在 JavaScript 中，对象以键值对的形式存储数据，其中键可以是对象的任何属性。在本文中，让我们看看如何移除对象中对应于给定键的`键值`对。

## 使用 `delete` 运算符

当只删除一个键时，我们可以直接使用 `delete` 操作符指定对象中的键。
