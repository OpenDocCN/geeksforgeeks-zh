...
为了获得图像的大小(高度和宽度)，使用`Element.clientHeight`和`Element.clientWidth`属性。
...
**注意:**这里的元素是图像，所以`image.clientHeight`和`image.clientWidth`将分别用于获取图像的高度和宽度。
...
<body>
    ...
    <br>
    <br>
    <img src="https://media.geeksforgeeks.org/wp-content/uploads/geeksforgeeks-20.png"
