...
> 原文: [https://www.geeksforgeeks.org/javascript-object-getownpropertydescriptor-method/](https://www.geeksforgeeks.org/javascript-object-getownpropertydescriptor-method/)

JavaScript 中的 `Object.getOwnPropertyDescriptor()` 方法是标准的内置对象，它返回给定对象自身属性的属性描述符。
...
该方法根据对象的存在，返回给定属性或未定义属性的属性描述符。

以下示例说明了 JavaScript 中的 `Object.getOwnPropertyDescriptor()` 方法：
...
`Object.getOwnPropertyDescriptor()` 方法支持的浏览器如下：
