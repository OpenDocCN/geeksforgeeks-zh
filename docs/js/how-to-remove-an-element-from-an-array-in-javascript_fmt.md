...
> 原文：[https://www.geeksforgeeks.org/how-to-remove-an-element-from-an-array-in-javascript/](https://www.geeksforgeeks.org/how-to-remove-an-element-from-an-array-in-javascript/)
...
*   `index`：必选。它指定移除/添加元素的位置。
*   `howmany`：可选。它指定要移除多少元素。
*   `item1, ..., itemX`：可选。它指定要添加的新元素。
...
<html>
    <body>
        ...
        <!--Script to remove an element from an array using spice method-->
        <script>
...
**支持的浏览器：** `Array.splice()` 方法支持的浏览器如下：
