# Moment.js `moment().format()` 功能

> 原文: [https://www.geeksforgeeks.org/moment-js-moment-format-function/](https://www.geeksforgeeks.org/moment-js-moment-format-function/)

`moment().format()` 功能用于根据用户需要格式化日期。该格式可以以字符串形式提供，并作为参数传递给该函数。
