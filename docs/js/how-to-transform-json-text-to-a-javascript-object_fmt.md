...
> 原文：[https://www.geeksforgeeks.org/how-to-transform-json-text-to-a-javascript-object/](https://www.geeksforgeeks.org/how-to-transform-json-text-to-a-javascript-object/)
...
## JSON 文本到 Javascript 对象的转换

可以使用函数 `JSON.parse()` 将 JSON 文本/对象转换为 Javascript 对象。
...
*   `string`：必输参数，包含一个以 JSON 格式编写的字符串。
