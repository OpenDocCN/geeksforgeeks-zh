...
`moment().daysInMonth()` 函数用于获取 Node.js 中某个特定月份的月天数，返回一个表示天数的整数。
...
## 参考:
[https://momentjs.com/docs/#/displaying/days-in-month/](https://momentjs.com/docs/#/displaying/days-in-month/)