...
> 原文: [https://www.geeksforgeeks.org/javascript-auto-filling-one-field/](https://www.geeksforgeeks.org/javascript-auto-filling-one-field/)
...
*   `required` (第 18、20、29、31 行) - 确保只有当这些字段非空时才会提交表单；
