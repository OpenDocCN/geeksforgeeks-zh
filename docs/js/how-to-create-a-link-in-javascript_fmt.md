...
> 原文：[https://www.geeksforgeeks.org/how-to-create-a-link-in-javascript/](https://www.geeksforgeeks.org/how-to-create-a-link-in-javascript/)
...
1.  创建一个锚点。
2.  创建一个文本节点，其中包含一些将显示为链接的文本。
3.  将文本节点附加到锚点。
4.  设置 `title` 和 `href` 属性。
5.  在正文中追加锚点元素。

## 示例 1

在本例中，节点被创建，属性由 JavaScript 方法设置。
...
此示例与上面的示例类似，但使用 `prepend()` 方法向正文中添加锚点元素。
