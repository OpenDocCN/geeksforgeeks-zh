...
> 原文：[https://www.geeksforgeeks.org/how-to-convert-long-number-into-abbreviated-string-in-javascript/](https://www.geeksforgeeks.org/how-to-convert-long-number-into-abbreviated-string-in-javascript/)
...
*   获取数组中的字符（`ar = ["", "k", "m", "b"]`）。
*   将数字的长度除以 3，得到变量 `sNum` 的值。
*   如果 `sNum` 不等于 0，然后通过除以 `1000^sNum` 来计算数字的精确值。
*   将数组中索引等于 `sNum` 处的字符附加到精确值上，最终得到缩写数字。
...
<body style="text-align:center;">
    ...
    <script>
        ...
        var n = 123287342;
        up.innerHTML = "Click on the button to get the abbreviated number.<br>Number = " + n;
...
*   检查数字是否小于 `1e3`，如果小于 `1e3`，则按原样返回数字。
