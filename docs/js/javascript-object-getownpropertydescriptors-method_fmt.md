...
> 原文：[https://www.geeksforgeeks.org/javascript-object-getownpropertydescriptors-method/](https://www.geeksforgeeks.org/javascript-object-getownpropertydescriptors-method/)

JavaScript 中的 `Object.getOwnPropertyDescriptors()` 方法是标准的内置对象方法，它返回给定对象的所有自身属性描述符。
...
该方法返回包含对象所有自身属性描述符的对象。对于没有属性的对象，此方法可能会返回一个空对象。

下面的例子说明了 JavaScript 中的 `Object.getOwnPropertyDescriptors()` 方法：
...
`Object.getOwnPropertyDescriptors()` 方法支持的浏览器如下：
