...
> 原文：[https://www.geeksforgeeks.org/how-to-create-timeline-animations-using-anime-js/](https://www.geeksforgeeks.org/how-to-create-timeline-animations-using-anime-js/)
...
这是一个简单的网页。我们所需要做的就是创建一个项目，并在其中创建一个名为 `index.html` 的 HTML 文件。
...
点击 `index.html` 在浏览器中打开：

![](img/89cd4c072e4a7c639085532489345f4c.png)

## 示例 2

在本例中，`translateX` 属性变得更加清晰。它首先转换成 `-ve` x 轴，然后是 `+ve` x 轴。
