...
> 原文：[https://www.geeksforgeeks.org/javascript-array-valueof-method/](https://www.geeksforgeeks.org/javascript-array-valueof-method/)
...
以下示例说明了 JavaScript 数组 `valueOf()` 方法：
...
JavaScript`数组 valueOf()`方法支持的浏览器如下：
