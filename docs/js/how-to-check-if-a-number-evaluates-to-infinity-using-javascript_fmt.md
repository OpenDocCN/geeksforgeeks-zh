...
> 原文：[https://www.geeksforgeeks.org/how-to-check-if-a-number-evaluates-to-infinity-using-javascript/](https://www.geeksforgeeks.org/how-to-check-if-a-number-evaluates-to-infinity-using-javascript/)

任务是在 JavaScript 的帮助下检查数字是否评估为无穷大。这里讨论一些技巧。

## 进场 1：

检查数字是否等于 `Number.POSITIVE_INFINITY` 或 `Number.NEGATIVE_INFINITY`。
