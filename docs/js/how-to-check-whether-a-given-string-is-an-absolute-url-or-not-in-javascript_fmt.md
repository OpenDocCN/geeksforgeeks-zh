...
> 原文: [https://www.geeksforgeeks.org/how-to-check-whether-a-given-string-is-an-absolute-url-or-not-in-javascript/](https://www.geeksforgeeks.org/how-to-check-whether-a-given-string-is-an-absolute-url-or-not-in-javascript/)
...
绝对 URL 在开始时包含协议（`HTTPS`）。我们可以简单的检查一下网址前面是否有 `https://`。如果发现了，我们还真还假。
