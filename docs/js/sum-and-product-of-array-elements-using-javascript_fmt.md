...
> 原文: [https://www.geeksforgeeks.org/sum-and-product-of-array-elements-using-javascript/](https://www.geeksforgeeks.org/sum-and-product-of-array-elements-using-javascript/)

给定一个数组，任务是使用 JavaScript 找到数组值的和与积。

## 简单方法

它用一个简单的方法，通过一个索引号访问数组元素，并使用循环使用 JavaScript 找到一个 array 的值的和与积。

### 示例 1

这个示例使用一个简单的方法，使用 JavaScript 找到 Array 元素的和。
...
这个示例使用一个简单的方法，使用 JavaScript 查找 Array 元素的乘积。
...
本示例使用 array `reduce()` 方法，使用 JavaScript 查找 array 的值之和。
...
本示例使用 array `reduce()` 方法，使用 JavaScript 查找 array 的值的乘积。
