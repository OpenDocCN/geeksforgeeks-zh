...
> 原文：[https://www.geeksforgeeks.org/how-to-convert-title-to-url-slug-using-javascript/](https://www.geeksforgeeks.org/how-to-convert-title-to-url-slug-using-javascript/)
...
*   在这里，我们使用了 JavaScript 中的 `replace()` 函数来制作一个字符串 slug。
*   创建的段塞字符串可以进一步用于网址。
