...
> 原文: [https://www.geeksforgeeks.org/how-to-prevent-overriding-using-fake-namespace-in-javascript/](https://www.geeksforgeeks.org/how-to-prevent-overriding-using-fake-namespace-in-javascript/)
...
嗯，发生这种情况是因为我们在 `script1.js` 和 `script2.js` 的全局范围内有相同的变量名 `name`。这就是 `script2.js` 覆盖 `script1.js` 的原因。
