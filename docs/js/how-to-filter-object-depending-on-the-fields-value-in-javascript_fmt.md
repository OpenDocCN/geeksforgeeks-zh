...
> 原文：[https://www.geeksforgeeks.org/how-to-filter-object-depending-on-the-fields-value-in-javascript/](https://www.geeksforgeeks.org/how-to-filter-object-depending-on-the-fields-value-in-javascript/)
...
**方法 2:** 首先，使用`new Array()`创建一个以字段值为关键字，空数组为值的空对象。然后一个接一个地遍历原始对象，并在适当的键处追加该对象。使用`push()`方法将数组末端的对象推送到新对象中。
