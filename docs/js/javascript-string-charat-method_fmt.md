...
> 原文：[https://www.geeksforgeeks.org/javascript-string-charat-method/](https://www.geeksforgeeks.org/javascript-string-charat-method/)
...
该函数的唯一参数是字符串中要从中提取单个字符的索引。该索引的范围在 `0` 和 `length-1` 之间，包括限值。如果没有指定索引，则字符串的第一个字符（索引为 `0`）是用于此功能的默认索引。
