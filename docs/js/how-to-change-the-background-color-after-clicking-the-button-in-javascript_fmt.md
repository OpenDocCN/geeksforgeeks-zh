...
> 原文: [https://www.geeksforgeeks.org/how-to-change-the-background-color-after-clicking-the-button-in-javascript/](https://www.geeksforgeeks.org/how-to-change-the-background-color-after-clicking-the-button-in-javascript/)

给定一个 HTML 文档，任务是使用 JavaScript 和 jQuery 更改文档的背景颜色。

## 方法 1: 使用 JavaScript

该方法使用 JavaScript 在点击按钮后改变背景颜色。
