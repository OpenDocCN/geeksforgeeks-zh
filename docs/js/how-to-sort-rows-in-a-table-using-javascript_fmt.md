...
> 原文：[https://www.geeksforgeeks.org/how-to-sort-rows-in-a-table-using-javascript/](https://www.geeksforgeeks.org/how-to-sort-rows-in-a-table-using-javascript/)
...
## 示例 2
本示例使用相同的循环技术对表进行排序，但对给定的两列以及两个方向（升序和降序）执行该函数。
...
<center>
    <h1 style="color:green">GeeksforGeeks</h1>
    <p>
        <strong>Click the headers to sort in ascending and descending.</strong>
    </p>

    <table id="table">
        <tr>
            <!--Calls sortTable function(0 for country and 1 for capital) when headers are clicked-->
