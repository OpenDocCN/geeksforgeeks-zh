...
> 原文：[https://www.geeksforgeeks.org/how-to-copy-the-text-to-the-clipboard-in-javascript/](https://www.geeksforgeeks.org/how-to-copy-the-text-to-the-clipboard-in-javascript/)

为了在 `javascript` 中将文本复制到剪贴板，我们使用 `document.execCommand()` 方法。这可以分两步完成。
...
### 注意
IE8 及更早版本不支持 `document.execCommand()` 方法。
