...
> 原文：[https://www.geeksforgeeks.org/how-to-convert-map-keys-to-an-array-in-javascript/](https://www.geeksforgeeks.org/how-to-convert-map-keys-to-an-array-in-javascript/)
...
本示例使用 `Array.from()` 方法获取数组中地图的关键点。
