...
> 原文: [https://www.geeksforgeeks.org/how-to-print-a-number-with-commas-as-thousands-separators-in-javascript/](https://www.geeksforgeeks.org/how-to-print-a-number-with-commas-as-thousands-separators-in-javascript/)

## 方法一：使用 `Intl.NumberFormat()`

*   `Intl.NumberFormat()` 对象用于以对语言敏感的格式表示数字。根据指定的区域设置，它可用于表示货币或百分比。
...
*   `toLocaleString()` 方法用于返回具有数字的语言敏感表示的字符串。可选的 `locales` 参数用于指定数字的格式。
