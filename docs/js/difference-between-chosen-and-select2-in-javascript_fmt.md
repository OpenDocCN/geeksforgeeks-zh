...
> 原文:[https://www . geesforgeks . org/JavaScript 中选择和选择 2 的区别/](https://www.geeksforgeks.org/difference-between-chosen-and-select2-in-javascript/)
...
`选择 2`被创建来替换浏览器显示的标准`选择`标签。它支持标准选择框中的所有选项和操作，但更具灵活性。`选择 2`的一些特点是:
