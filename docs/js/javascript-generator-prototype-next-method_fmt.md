...
> 原文：[https://www.geeksforgeeks.org/javascript-generator-prototype-next-method/](https://www.geeksforgeeks.org/javascript-generator-prototype-next-method/)

`generator.prototype.next()`方法是 JavaScript 中的一个内置方法，用于返回一个具有两个属性 `done` 和 `value` 的对象。
...
`generator.prototype.next()` 方法支持的浏览器如下：
