...
> 原文：[https://www.geeksforgeeks.org/javascript-date-getyear-function/](https://www.geeksforgeeks.org/javascript-date-getyear-function/)

JavaScript 中的 `date.getYear()` 方法是根据世界时得到指定日期的年份。我们从 `getYear()` 方法得到的年份是当前年份减去 1900。
...
这里我们给构造函数传递一个完整的日期，日期的格式为月-日-年-时，如 `2010年10月15日 02:05:32`。
