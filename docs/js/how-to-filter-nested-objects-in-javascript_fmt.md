...
> 原文: [https://www.geeksforgeeks.org/how-to-filter-nested-objects-in-javascript/](https://www.geeksforgeeks.org/how-to-filter-nested-objects-in-javascript/)

`filter()` 方法创建一个新数组，其中所有元素都通过了由提供的函数实现的测试。

## 方法 1

该方法使用 `filter()` 方法过滤 JavaScript 中的嵌套对象。
