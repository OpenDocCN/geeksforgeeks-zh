# JavaScript 正则表达式完整参考

> 原文: [https://www.geeksforgeeks.org/javascript-regexp-complete-reference/](https://www.geeksforgeeks.org/javascript-regexp-complete-reference/)
