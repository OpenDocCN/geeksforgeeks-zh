...
> 原文: [https://www.geeksforgeeks.org/how-to-sort-an-array-of-object-by-two-fields-in-javascript/](https://www.geeksforgeeks.org/how-to-sort-an-array-of-object-by-two-fields-in-javascript/)
...
*   首先比较第一个属性，如果两者不相等，则进行相应的排序。
*   如果它们相等，那么对第二个属性做同样的操作。这个例子遵循相同的方法，但是使用逻辑或（`||`）运算符来减少代码。
