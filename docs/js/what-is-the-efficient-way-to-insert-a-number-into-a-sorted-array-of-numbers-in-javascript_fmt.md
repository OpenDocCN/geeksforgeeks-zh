...
> 原文：[https://www.geeksforgeeks.org/what-is-the-efficient-way-to-insert-a-number-into-a-sorted-array-of-numbers-in-javascript/](https://www.geeksforgeeks.org/what-is-the-efficient-way-to-insert-a-number-into-a-sorted-array-of-numbers-in-javascript/)
...
*   在这个例子中，复杂度是 `O(log n)`，其中 `n` 是数组中元素的个数。
