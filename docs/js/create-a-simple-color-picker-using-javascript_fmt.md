...
> 原文: [https://www.geeksforgeeks.org/create-a-simple-color-picker-using-javascript/](https://www.geeksforgeeks.org/create-a-simple-color-picker-using-javascript/)
...
CSS 中包含了一些额外的线条来获得一个很酷的悬停效果。以下代码是上述 HTML 代码中使用的 `style.css` 文件的内容。
...
以下是上述 HTML 代码中使用的 JavaScript 代码 `script.js`。
