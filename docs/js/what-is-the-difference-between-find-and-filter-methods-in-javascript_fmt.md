...
> 原文：[https://www.geeksforgeeks.org/what-is-the-difference-between-find-and-filter-methods-in-javascript/](https://www.geeksforgeeks.org/what-is-the-difference-between-find-and-filter-methods-in-javascript/)
...
<head>
    ...
    <script>
        $(document).ready(function() {
            $("ul").find(":odd").css("background-color", "yellow");
        });
    </script>
</head>
...
<head>
    ...
    <script>
        $(document).ready(function() {
            $("ul").filter(":odd").css("background-color", "yellow");
        });
    </script>
</head>
<body style="text-align:center;">
