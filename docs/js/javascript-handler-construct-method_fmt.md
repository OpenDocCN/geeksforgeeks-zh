...
> 原文：[`https://www.geeksforgeeks.org/javascript-handler-construct-method/`](https://www.geeksforgeeks.org/javascript-handler-construct-method/)

JavaScript 中的 `handler.construct()` 方法是 `new` 操作的陷阱，这个方法返回一个对象。
