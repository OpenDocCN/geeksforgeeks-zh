...
> 原文：[https://www.geeksforgeeks.org/how-do-you-display-javascript-datetime-in-12-hour-am-pm-format/](https://www.geeksforgeeks.org/how-do-you-display-javascript-datetime-in-12-hour-am-pm-format/)
...
**`toLocaleString()`：** 它返回日期对象的字符串表示形式。两个参数*区域*和*选项*允许自定义方法的行为。
