...
> 原文: [https://www.geeksforgeeks.org/javascript-handler-getprototypeof-method/](https://www.geeksforgeeks.org/javascript-handler-getprototypeof-method/)

JavaScript 中的 `handler.getPrototypeOf()` 方法是内部方法的陷阱。此方法返回与对象相同的值。
...
`handler.getPrototypeOf()` 方法支持的浏览器如下:
