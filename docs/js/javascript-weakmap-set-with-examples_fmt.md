...
> 原文: [https://www.geeksforgeeks.org/javascript-weakmap-set-with-examples/](https://www.geeksforgeeks.org/javascript-weakmap-set-with-examples/)
...
取参数 `key`，它是要设置到 `WeakMap` 对象的元素的键，参数 `value` 是要设置到 `WeakMap` 对象的元素的值。
