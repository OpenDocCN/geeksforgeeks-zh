...
> 原文: [https://www.geeksforgeeks.org/javascript-reflect-set-method/](https://www.geeksforgeeks.org/javascript-reflect-set-method/)
...
JavaScript `reflect.set()`方法支持的浏览器如下:
