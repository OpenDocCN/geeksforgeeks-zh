...
这个函数有两个参数，第一个是代表日期的类型 `Moment | String | Number | Date | Array`，第二个是布尔类型的可选参数，用于从值中删除后缀。
...
[https://momentjs.com/docs/#/displaying/to/](https://momentjs.com/docs/#/displaying/to/)