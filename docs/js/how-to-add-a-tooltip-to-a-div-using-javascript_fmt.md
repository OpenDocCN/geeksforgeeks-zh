...
> 原文：[https://www.geeksforgeeks.org/how-to-add-a-tooltip-to-a-div-using-javascript/](https://www.geeksforgeeks.org/how-to-add-a-tooltip-to-a-div-using-javascript/)
...
*   `shown.bs.tooltip`：Tooltip 完全显示在屏幕上。
*   `hide.bs.tooltip`：Tooltip 即将隐藏。
*   `hidden.bs.tooltip`：Tooltip 完全隐藏。
