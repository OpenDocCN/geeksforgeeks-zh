...
> 原文: [https://www.geeksforgeeks.org/javascript-rangeerror-precision-is-out-of-range/](https://www.geeksforgeeks.org/javascript-rangeerror-precision-is-out-of-range/)
...
**示例 1:** 在此示例中，当 -100 被传递给 `toFixed()` 时，会出现范围错误。
...
**示例 3:** 在此示例中，范围错误发生的原因是 -1 被传递给 `toPrecision()`。
