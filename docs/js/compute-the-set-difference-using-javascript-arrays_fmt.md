...
> 原文：[https://www.geeksforgeeks.org/compute-the-set-difference-using-javascript-arrays/](https://www.geeksforgeeks.org/compute-the-set-difference-using-javascript-arrays/)
...
在此示例中，使用 `filter()` 方法计算集差，但方法稍有不同。
