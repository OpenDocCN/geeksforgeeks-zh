...
> 原文：[https://www.geeksforgeeks.org/how-to-get-the-diagonal-length-of-the-device-screen-using-javascript/](https://www.geeksforgeeks.org/how-to-get-the-diagonal-length-of-the-device-screen-using-javascript/)
...
类似于上述公式，`对角线 = Math.sqrt(width^2 + height^2)`。
