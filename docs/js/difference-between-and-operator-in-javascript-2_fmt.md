# JavaScript 中 != 与 !== 运算符的区别

> 原文：[https://www.geeksforgeeks.org/difference-between-and-operator-in-javascript-2/](https://www.geeksforgeeks.org/difference-between-and-operator-in-javascript-2/)
