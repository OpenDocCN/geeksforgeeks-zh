...
> 原文：[https://www.geeksforgeeks.org/how-to-load-the-contents-of-a-text-file-into-a-javascript-variable/](https://www.geeksforgeeks.org/how-to-load-the-contents-of-a-text-file-into-a-javascript-variable/)
...
在本例中，我们将创建一个文本区域，文本将出现在该文本文件中，该文本文件已在 `index.html` 中用作输入。JavaScript 代码将能够从任何文本文件中提取文本，并将其显示在 `script.js` 中。
