...
> 原文：[https://www.geeksforgeeks.org/alternatives-of-push-method-in-javascript/](https://www.geeksforgeeks.org/alternatives-of-push-method-in-javascript/)

任务是在 JavaScript 的帮助下不使用 [`push()`方法](https://www.geeksforgeeks.org/javascript-array-prototype-push-function/)进行推送操作。下面讨论两种方法。

## 方法 1：使用 `length` 属性

使用 [`length`](https://www.geeksforgeeks.org/javascript-array-length-property/) 属性在数组末尾插入元素。
