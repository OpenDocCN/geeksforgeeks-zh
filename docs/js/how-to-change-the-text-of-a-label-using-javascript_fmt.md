...
> 原文：[https://www.geeksforgeeks.org/how-to-change-the-text-of-a-label-using-javascript/](https://www.geeksforgeeks.org/how-to-change-the-text-of-a-label-using-javascript/)

给定一个 HTML 文档，任务是使用 JavaScript 更改标签的文本。

## 什么是标签？

`<label>` 标签用于为鼠标用户提供可用性改进，即如果用户点击 `<label>` 元素内的文本，它将切换控件。
...
- 使用 `innerHTML` 属性更改标签内部的文本。`innerHTML` 属性设置或返回元素的 HTML 内容。
