...
> 原文：[https://www.geeksforgeeks.org/javascript-boolean-prototype-constructor/](https://www.geeksforgeeks.org/javascript-boolean-prototype-constructor/)

下面是`Boolean.prototype`构造函数属性的例子。
...
<script>
    ...
    document.write("Color of Gfg = " + Obj.color(true));
</script>
```
...
`Boolean.prototype`属性用于向所有布尔实例添加新的属性和方法。在创建属性时，所有布尔值都将被赋予该属性，并被赋值，这是默认的，但是在方法的情况下，所有布尔值都可以使用该方法。
...
*   [`Boolean.prototype.valueOf()`](https://www.geeksforgeeks.org/javascript-boolean-valueof-function/)：它只是返回布尔对象的值。
