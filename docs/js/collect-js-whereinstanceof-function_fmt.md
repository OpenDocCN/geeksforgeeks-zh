...
> 原文：[https://www.geeksforgeeks.org/collect-js-whereinstanceof-function/](https://www.geeksforgeeks.org/collect-js-whereinstanceof-function/)
...
在此示例中，我们获取一个集合，然后使用 `whereInstanceOf()` 方法使用键返回过滤后的集合。
...
[https://collect.js.org/api/whereinstanceof.html](https://collect.js.org/api/whereinstanceof.html)