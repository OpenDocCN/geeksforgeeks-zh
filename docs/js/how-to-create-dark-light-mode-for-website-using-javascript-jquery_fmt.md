...
> 原文：[https://www.geeksforgeeks.org/how-to-create-dark-light-mode-for-website-using-javascript-jquery/](https://www.geeksforgeeks.org/how-to-create-dark-light-mode-for-website-using-javascript-jquery/)
...
以下示例演示了使用 JQuery 代码在亮暗模式之间切换。它基本上是通过使用函数 `hasClass()`，`addClass()` 和 `removeClass()` 方法工作的。
...
以下示例演示了在 javascript 代码中使用 `toggle()` 函数在亮暗模式之间切换。
