...
> 原文: [https://www.geeksforgeeks.org/instanceof-operator-in-javascript/](https://www.geeksforgeeks.org/instanceof-operator-in-javascript/)
...
JavaScript 中的 `instanceof` 运算符用于在运行时检查对象的类型。它返回一个布尔值。如果为真，那么它表示该对象是一个特定类的实例，如果为假，那么它不是。
