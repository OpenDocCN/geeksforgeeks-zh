...
> 原文: [https://www.geeksforgeeks.org/javascript-function-name-property/](https://www.geeksforgeeks.org/javascript-function-name-property/)
...
JavaScript 对象的`函数名`属性用于返回函数名。函数的这个`name`属性只能读取，不能更改。创建函数时给定的函数名由`函数名`返回。
