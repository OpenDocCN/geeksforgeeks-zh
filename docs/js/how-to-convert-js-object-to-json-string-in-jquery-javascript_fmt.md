...
> 原文：[https://www.geeksforgeeks.org/how-to-convert-js-object-to-json-string-in-jquery-javascript/](https://www.geeksforgeeks.org/how-to-convert-js-object-to-json-string-in-jquery-javascript/)

给定一个 JS 对象，任务是将其转换为 JSON 字符串。

## 使用 `JSON.stringify()` 方法

JavaScript 中的 `JSON.stringify()` 方法允许我们获取一个 JavaScript 对象或数组，并从中创建一个 JSON 字符串。
