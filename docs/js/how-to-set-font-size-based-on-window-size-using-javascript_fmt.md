...
> 原文：[https://www.geeksforgeeks.org/how-to-set-font-size-based-on-window-size-using-javascript/](https://www.geeksforgeeks.org/how-to-set-font-size-based-on-window-size-using-javascript/)
...
**方法 2：** 使用带有字体大小的 `vw`（视口单位）转换视口的字体大小。
