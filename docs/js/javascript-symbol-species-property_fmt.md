...
> 原文：[https://www.geeksforgeeks.org/javascript-symbol-species-property/](https://www.geeksforgeeks.org/javascript-symbol-species-property/)
...
**属性：** `species` 访问器属性可用于允许子类覆盖对象的默认构造函数。
