...
> 原文：[https://www.geeksforgeeks.org/how-to-use-javascript-function-in-check-box/](https://www.geeksforgeeks.org/how-to-use-javascript-function-in-check-box/)
...
*   **HTML 代码：** HTML 文档，采用专用的 HTML 标签包装 JavaScript 代码。标签可以放在你的 HTML 的部分，在部分中，或者在结束标签之后，这取决于你希望 JavaScript 什么时候加载。
...
*   **JavaScript 代码：** 现在，在 JavaScript 代码中，我们试图给出在表单中包含学位的选项。用户需要知道他/她是否毕业。因此，当我们点击这个复选框，一个新的输入字段打开。因此，如果有人点击或不点击它，`graduatedFunction` 功能将显示隐藏部分或不显示。
