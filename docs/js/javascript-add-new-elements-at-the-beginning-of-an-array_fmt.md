...
> 原文: [https://www.geeksforgeeks.org/javascript-add-new-elements-at-the-beginning-of-an-array/](https://www.geeksforgeeks.org/javascript-add-new-elements-at-the-beginning-of-an-array/)

在已有数组的开头添加新元素可以使用 `Array.prototype.unshift()` 方法完成。这个方法类似于 `push()` 方法，但是它在数组的开头添加了元素。
