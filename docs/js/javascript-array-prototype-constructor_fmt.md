...
> 原文: [https://www.geeksforgeeks.org/javascript-array-prototype-constructor/](https://www.geeksforgeeks.org/javascript-array-prototype-constructor/)
...
本示例使用`JavaScript 数组原型构造函数`，将字符串转换为大写字符。
...
本例使用`JavaScript 数组原型构造函数`对字符串长度进行计数。
