...
> 原文：[https://www.geeksforgeeks.org/documentation-comments-in-jsdoc/](https://www.geeksforgeeks.org/documentation-comments-in-jsdoc/)
...
这里 `@param` 标签用于记录函数的不同参数，而 `@returns` 标签记录函数的返回值。
