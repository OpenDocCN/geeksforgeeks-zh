...
> 原文: [https://www.geeksforgeeks.org/javascript-encode-decode-a-string-to-base64/](https://www.geeksforgeeks.org/javascript-encode-decode-a-string-to-base64/)
...
本示例通过 `btoa()` 函数对字符串 **“This is GeeksForGeeks”** 进行编码。
...
本示例借助 `atob()` 函数对由 `btoa()` 函数编码的字符串 **【VGhpcyBpcyBHZWVrc0ZvckdlZWtz】** 进行解码。
...
本示例通过创建一个 `Base64` 对象来编码字符串 **“This is GeeksForGeeks”**。
...
本示例通过创建一个 `Base64` 对象来解码字符串 **“VGhpcyBpcyBHZWVrc0ZvckdlZWtz”**。
