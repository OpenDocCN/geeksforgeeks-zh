...
> 原文：[https://www.geeksforgeeks.org/javascript-internalerror-too-much-recursion/](https://www.geeksforgeeks.org/javascript-internalerror-too-much-recursion/)
...
**示例 2：** 在本例中，停止条件为 `x >= 10000000000000`。这是一个很大的值，因此出现了错误。
