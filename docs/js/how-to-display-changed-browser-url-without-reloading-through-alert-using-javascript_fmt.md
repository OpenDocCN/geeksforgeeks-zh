...
> 原文：[https://www.geeksforgeeks.org/how-to-display-changed-browser-url-without-reloading-through-alert-using-javascript/](https://www.geeksforgeeks.org/how-to-display-changed-browser-url-without-reloading-through-alert-using-javascript/)
...
`History.pushState()` 方法结合了 HTML 5 History 和 JavaScript `pushState()` 方法。
