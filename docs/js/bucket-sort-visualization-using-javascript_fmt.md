...
> 原文: [https://www.geeksforgeeks.org/bucket-sort-visualization-using-javascript/](https://www.geeksforgeeks.org/bucket-sort-visualization-using-javascript/)
...
*   按 `Ctrl+R` 键可生成新数组。
*   使用桶的 `bucketRT()` 功能执行排序。

## 示例

![排序前](img/18ae23b20475cee589231663709646fd.png)

![排序后](img/b39bf785771eb6f97752af865e90a45e.png)
...
以下是上述 HTML 代码中使用的 `script.js` 文件的内容。
