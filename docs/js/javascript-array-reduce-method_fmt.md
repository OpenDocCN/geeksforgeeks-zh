...
> 原文: [https://www.geeksforgeeks.org/javascript-array-reduce-method/](https://www.geeksforgeeks.org/javascript-array-reduce-method/)
...
## 支持的浏览器:
JavaScript `Array reduce()` 方法支持的浏览器如下:
