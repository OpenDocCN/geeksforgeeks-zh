...
> 原文：[https://www.geeksforgeeks.org/find-all-the-combinations-of-the-array-values-in-javascript/](https://www.geeksforgeeks.org/find-all-the-combinations-of-the-array-values-in-javascript/)
...
*   将第一个数组元素减少`.reduce()`方法并返回递归结果返回的结果（递归在每次离开数组的第一项后调用）加上与每个数组元素串联的前一个值。
*   返回包含所有组合的最终 `ans` 数组。
