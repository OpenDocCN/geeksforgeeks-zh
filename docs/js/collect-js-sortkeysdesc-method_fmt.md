...
> 原文：[`https://www.geeksforgeeks.org/collect-js-sortkeysdesc-method/`](https://www.geeksforgeeks.org/collect-js-sortkeysdesc-method/)

`sortKeysDesc()`方法用于根据底层关联数组的给定键对集合元素进行降序排序。
