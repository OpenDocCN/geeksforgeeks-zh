...
> 原文: [https://www.geeksforgeeks.org/how-to-get-all-the-methods-of-an-object-using-javascript/](https://www.geeksforgeeks.org/how-to-get-all-the-methods-of-an-object-using-javascript/)
...
*   创建一个以对象为输入的函数。
*   使用 `typeof` 运算符，检查对象的类型是否为函数。此示例还检查是否发生了任何错误，如果发生了，请正确处理。
*   如果对象的类型是函数，那么返回它。
