...
> 原文：[https://www.geeksforgeeks.org/how-to-set-timezone-offset-using-javascript/](https://www.geeksforgeeks.org/how-to-set-timezone-offset-using-javascript/)
...
**代码片段：** 在下面的代码片段中，`date.getTimezoneOffset()` 方法将以分钟为单位返回 UTC 和本地时间之间的时区差异。这将存储在 `offset` 变量中。
