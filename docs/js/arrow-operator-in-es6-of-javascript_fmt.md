...
> 原文: [https://www.geeksforgeeks.org/arrow-operator-in-es6-of-javascript/](https://www.geeksforgeeks.org/arrow-operator-in-es6-of-javascript/)
...
`Arrow` 运算符词汇绑定上下文，因此 `this` 是指起始上下文。这意味着它使用箭头函数。我们考虑一个有年龄数组的类，如果年龄 < 18，我们将把它们推入子队列。在 ES5 中，您必须按如下方式进行:
