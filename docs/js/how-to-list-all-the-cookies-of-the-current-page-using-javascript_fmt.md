...
> 原文：[https://www.geeksforgeeks.org/how-to-list-all-the-cookies-of-the-current-page-using-javascript/](https://www.geeksforgeeks.org/how-to-list-all-the-cookies-of-the-current-page-using-javascript/)
...
*   使用 [`document.cookie`](https://www.geeksforgeeks.org/html-dom-cookie-property/) 访问 cookie。
*   使用 `.split()` 方法将它们拆分在“；”上，得到一个数组。
*   遍历 cookies 数组。
...
<body style="text-align:center;">
    ...
    <script>
        ...
        el_up.innerHTML = "Click on the button to get the stored cookies.";
...
*   获取 cookie 的名称和值。对于每个 cookie，使用 `.split('=')` 方法并从 cookie 中访问 `name` 和 `val`。
