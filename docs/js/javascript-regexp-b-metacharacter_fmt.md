...
> 原文: [https://www.geeksforgeeks.org/javascript-regexp-b-metacharacter/](https://www.geeksforgeeks.org/javascript-regexp-b-metacharacter/)

JavaScript 中的 `RegExp \b` 元字符用于在单词的开头或结尾查找匹配项。如果找到匹配，则返回单词否则返回空值。
