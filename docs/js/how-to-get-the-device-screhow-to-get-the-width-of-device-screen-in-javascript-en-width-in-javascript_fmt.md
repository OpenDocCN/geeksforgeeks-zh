...
> 原文：[https://www.geeksforgeeks.org/how-to-get-the-width-of-device-screen-in-javascript/](https://www.geeksforgeeks.org/how-to-get-the-width-of-device-screen-in-javascript/)

给定一个运行在设备上的 HTML 文档。任务是使用 JavaScript 找到工作屏幕设备的宽度。

## 示例 1

本示例使用 `window.innerWidth` 获取设备屏幕的宽度。`innerWidth` 属性用于返回设备的宽度。
...
本示例使用 `document.documentElement.clientWidth` 方法获取设备屏幕的宽度。
