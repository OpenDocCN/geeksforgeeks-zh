...
> 原文：[https://www.geeksforgeeks.org/how-to-select-min-max-dates-in-an-array-using-javascript/](https://www.geeksforgeeks.org/how-to-select-min-max-dates-in-an-array-using-javascript/)
...
*   使用`Math.max.apply()`和`Math.min.apply()`函数分别获取最大和最小日期。
