...
> 原文: [https://www.geeksforgeeks.org/how-to-remove-multiple-elements-from-array-in-javascript/](https://www.geeksforgeeks.org/how-to-remove-multiple-elements-from-array-in-javascript/)
...
*   开始一个循环，并运行到数组中的元素数。
*   使用 [`splice()`方法](https://www.geeksforgeeks.org/javascript-array-splice-method/) 移除特定索引处的元素。

**示例 1:** 本示例使用 [`splice()`方法](https://www.geeksforgeeks.org/javascript-array-splice-method/) 从数组中移除多个元素。
...
*   将数组元素的索引存储到另一个需要移除的数组中。
*   使用 [`filter()`方法](https://www.geeksforgeeks.org/javascript-array-filter/) 对元素数组进行操作。
*   使用 [`indexOf()`方法](https://www.geeksforgeeks.org/javascript-array-indexof/) 只选择索引数组中不存在的元素。

**示例 2:** 本示例使用 [`filter()`方法](https://www.geeksforgeeks.org/javascript-array-filter/) 和 [`indexOf()`方法](https://www.geeksforgeeks.org/javascript-array-indexof/) 从数组中移除多个元素。
