...
> 原文：[https://www.geeksforgeeks.org/how-to-access-an-object-having-spaces-in-the-objects-key-using-javascript/](https://www.geeksforgeeks.org/how-to-access-an-object-having-spaces-in-the-objects-key-using-javascript/)
...
*   创建一个具有空格分隔键的对象。
*   取一个变量的键，用这个变量代替键（但是，这里`方括号符号`也可以）。
