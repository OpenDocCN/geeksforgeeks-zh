...
> 原文: [https://www.geeksforgeeks.org/how-to-use-checkbox-inside-select-option-using-javascript/](https://www.geeksforgeeks.org/how-to-use-checkbox-inside-select-option-using-javascript/)

给定一个 HTML 文档，任务是使用 JavaScript 在选择选项中添加复选框。

## 进场

*   创建一个显示“选择选项”的 `select` 元素，并创建一个包含复选框和使用 CSS 样式的 `div`。
