...
> 原文：[https://www.geeksforgeeks.org/what-is-the-call-stack-in-javascript/](https://www.geeksforgeeks.org/what-is-the-call-stack-in-javascript/)
...
**第 4 步：** 现在 `f1()` 功能开始执行。`console.log()` 方法的新堆栈框架将被推送到堆栈。
