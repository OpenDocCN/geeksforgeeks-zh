...
`get()`函数用于返回出现在特定键上的值。在 JavaScript 中，首先将数组转换为集合，然后将函数应用于集合。
...
在本例中，我们取一个集合，然后使用 `get()`函数，它使用键返回值。
...
[https://collect.js.org/api/get.html](https://collect.js.org/api/get.html)