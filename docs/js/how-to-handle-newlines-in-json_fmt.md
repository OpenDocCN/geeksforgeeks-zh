...
> 原文：[https://www.geeksforgeeks.org/how-to-handle-newlines-in-json/](https://www.geeksforgeeks.org/how-to-handle-newlines-in-json/)
...
每当我们想要以 JSON 格式多行发送数据时，都会用到上面的语法。一般来说，很难用新的线路从服务器向网络发送数据。但是通过使用它，我们可以达到以下要求。
