...
> 原文：[https://www.geeksforgeeks.org/find-the-or-and-and-of-array-elements-using-javascript/](https://www.geeksforgeeks.org/find-the-or-and-and-of-array-elements-using-javascript/)

给定一个数组和，任务是用 JavaScript 找到数组值的“或”和“与”。

## 简单方法

它使用一个简单的方法通过一个索引号访问数组元素，并使用循环使用 JavaScript 找到数组的 OR 和 and 值。

### 示例 1

这个示例使用一个简单的方法，使用 JavaScript 找到 Array 元素的 OR。
...
这个示例使用一个简单的方法，使用 JavaScript 找到 Array 元素的 AND。
...
本示例使用 array `reduce()` 方法，使用 JavaScript 查找 array 的值的 OR。
...
本示例使用 array `reduce()` 方法，使用 JavaScript 查找 array 的值的 AND。
