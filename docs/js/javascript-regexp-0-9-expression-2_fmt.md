...
> 原文: [https://www.geeksforgeeks.org/javascript-regexp-0-9-expression-2/](https://www.geeksforgeeks.org/javascript-regexp-0-9-expression-2/)

JavaScript 中的 `RegExp [^0-9]` 表达式用于搜索不在括号内的任何数字。括号内的字符可以是一个数字或一串数字。
...
本示例搜索整个字符串中不在[0-9]之间的数字，并用哈希(#)替换字符。
