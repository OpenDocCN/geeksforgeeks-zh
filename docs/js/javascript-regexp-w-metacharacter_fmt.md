...
> 原文：[https://www.geeksforgeeks.org/javascript-regexp-w-metacharacter/](https://www.geeksforgeeks.org/javascript-regexp-w-metacharacter/)

JavaScript 中的 `RegExp` `\W` 元字符用于查找非单词字符，即不是从 A 到 Z、a 到 z、0 到 9 的字符。这和 `[^a-zA-Z0-9]` 一样。
