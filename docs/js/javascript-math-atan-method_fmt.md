...
> 原文：`https://www.geeksforgeeks.org/javascript-math-atan-method/`
...
<script type="text/javascript">
     document.write("When 1 is passed as a parameter: " + Math.atan(1));
</script>
```
...
```javascript
<script type="text/javascript">
      document.write("When 0 is passed as a parameter: " + Math.atan(0));
</script>
```
...
```javascript
<script type="text/javascript">
         document.write("When Infinity is passed as a parameter: " + Math.atan(Infinity));
</script>
```
