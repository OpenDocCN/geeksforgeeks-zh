...
> 原文：[https://www.geeksforgeeks.org/calculate-the-length-of-an-associative-array-using-javascript/](https://www.geeksforgeeks.org/calculate-the-length-of-an-associative-array-using-javascript/)
...
与普通数组一样，关联数组没有`length`属性。所以我们将看到计算关联数组长度的其他方法。
...
`Object.keys()`方法返回一个包含关联数组中所有键的数组。因此，我们可以使用这个数组的`length`属性来获得关联数组的长度。
