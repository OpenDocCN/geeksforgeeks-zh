...
> 原文: [https://www.geeksforgeeks.org/moment-js-isdstshift-function/](https://www.geeksforgeeks.org/moment-js-isdstshift-function/)

它用于使用 `isDSTShifted()` 功能检查 Node.js 中的夏时制时移。另一件重要的事情是知道日期是否被夏令时移动了。
...
**参考:** [https://momentjs.com/docs/#/query/is-dst-shifted/](https://momentjs.com/docs/#/query/is-dst-shifted/)