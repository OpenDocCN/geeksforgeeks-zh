...
> 原文：[https://www.geeksforgeeks.org/how-to-dim-entire-screen-except-a-fixed-area-using-javascript/](https://www.geeksforgeeks.org/how-to-dim-entire-screen-except-a-fixed-area-using-javascript/)
...
*   选择焦点的元素。
*   使用 `box-shadow` 属性使该区域可见。

## 示例 1

本示例聚焦 HTML 文档的一个 `div`，其他部分变暗。
...
在此示例中，按钮被聚焦，并且 `pointer-events` 属性设置为 `none`，其他部分变暗。
