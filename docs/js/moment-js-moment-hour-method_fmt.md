...
`moment().hour()` 方法用于从当前时间获取小时数或设置小时数。
...
这个方法接受一个你想要设置小时数的单个参数，然后你需要一个额外的参数:
...
这在正常的 Node.js 程序中是行不通的，因为它需要一个外部的 moment.js 库全局安装或者安装在项目目录中。
...
[https://momentjs.com/docs/#/get-set/hour/](https://momentjs.com/docs/#/get-set/hour/)