...
> 原文：[https://www.geeksforgeeks.org/javascript-window-innerwidth-and-innerheight-properties/](https://www.geeksforgeeks.org/javascript-window-innerwidth-and-innerheight-properties/)
...
返回一个数字，代表窗口内容区域的宽度和高度。

## 注意

对于 IE 8 即互联网 Edg 8 或更早版本，使用 `clientWidth` 和 `clientHeight` 获取窗口的宽度和高度。
