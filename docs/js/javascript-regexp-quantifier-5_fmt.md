...
> 原文：[https://www.geeksforgeeks.org/javascript-regexp-quantifier-5/](https://www.geeksforgeeks.org/javascript-regexp-quantifier-5/)

JavaScript 中的 `RegExp ^m` 量词用于查找任何在其开头包含 `m` 的字符串的匹配。
