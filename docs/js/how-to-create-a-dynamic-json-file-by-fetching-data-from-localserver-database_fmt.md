...
> 原文: [https://www.geeksforgeeks.org/how-to-create-a-dynamic-json-file-by-fetching-data-from-localserver-database/](https://www.geeksforgeeks.org/how-to-create-a-dynamic-json-file-by-fetching-data-from-localserver-database/)
...
考虑一下，我们有一个名为 `gfg` 的数据库，一个名为 `userdata` 的表。现在，下面是从数据库中获取数据并将它们存储到名为 `gfguserdetails.json` 的 json 文件中的 PHP 代码，通过将它们转换成 JSON 对象的数组来实现。
