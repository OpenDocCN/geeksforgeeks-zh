...
> 原文: [https://www.geeksforgeeks.org/how-to-shuffle-an-array-using-javascript/](https://www.geeksforgeeks.org/how-to-shuffle-an-array-using-javascript/)
...
将返回`(随机值–0.5)`的函数作为比较器传递给`sort()`函数，以便对元素进行随机排序。
