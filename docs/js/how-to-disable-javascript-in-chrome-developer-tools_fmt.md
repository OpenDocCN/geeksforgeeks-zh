...
> 原文: [https://www.geeksforgeeks.org/how-to-disable-javascript-in-chrome-developer-tools/](https://www.geeksforgeeks.org/how-to-disable-javascript-in-chrome-developer-tools/)
...
*   再次在 WindowsOS 中选择 `Ctrl+Shift+P`，在 MacOS 中选择 `命令+shift+P`，选择 `启用 JavaScript` 命令。
