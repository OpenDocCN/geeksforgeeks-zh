...
> 原文: [https://www.geeksforgeeks.org/javascript-window-scrollto-method/](https://www.geeksforgeeks.org/javascript-window-scrollto-method/)

`window.scrollTo()`方法用于滚动到文档中的一组特定坐标。
