# JavaScript Date 构造器属性

> 原文：[https://www.geeksforgeeks.org/javascript-date-constructor-property/](https://www.geeksforgeeks.org/javascript-date-constructor-property/)
...
在 JavaScript 中，`Date.constructor`属性返回对象的构造函数。对于 JavaScript，`Date`构造器属性返回`function Date() { [native code] }`。
