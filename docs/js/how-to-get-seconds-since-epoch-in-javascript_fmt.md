...
> 原文：[https://www.geeksforgeeks.org/how-to-get-seconds-since-epoch-in-javascript/](https://www.geeksforgeeks.org/how-to-get-seconds-since-epoch-in-javascript/)

给定一个日期，我们必须找到自纪元以来的秒数（即 1970 年 1 月 1 日，世界协调时 00:00:00）。JavaScript 中的 `getTime()` 方法返回自 1970 年 1 月 1 日以来的毫秒数，即纪元。如果我们将这些毫秒除以 1000，整数部分将给出自纪元以来的秒数。
