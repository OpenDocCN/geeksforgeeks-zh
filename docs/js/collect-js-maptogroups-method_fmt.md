...
> 原文: [https://www.geeksforgeeks.org/collect-js-maptogroups-method/](https://www.geeksforgeeks.org/collect-js-maptogroups-method/)

`mapToGroups()`方法用于迭代集合元素，并将集合的每个值传递给给定的回调函数。
