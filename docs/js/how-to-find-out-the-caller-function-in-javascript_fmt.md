...
> 原文：[https://www.geeksforgeeks.org/how-to-find-out-the-caller-function-in-javascript/](https://www.geeksforgeeks.org/how-to-find-out-the-caller-function-in-javascript/)

有时，开发人员可能希望根据调用者函数修改函数的工作方式。为了找出调用者函数名，我们将使用函数对象的`caller`属性。
