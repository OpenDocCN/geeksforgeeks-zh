...
> 原文：[https://www.geeksforgeeks.org/how-to-call-a-function-that-return-another-function-in-javascript/](https://www.geeksforgeeks.org/how-to-call-a-function-that-return-another-function-in-javascript/)
...
在本例中，从`fun2`返回【功能 2】，最终由`fun1`返回。
...
在本例中，“来自`fun2`的警报”与警报一起从`fun2`返回，返回值最终由`fun1`返回。
