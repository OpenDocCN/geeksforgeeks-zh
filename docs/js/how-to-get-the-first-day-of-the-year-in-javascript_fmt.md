...
> 原文: [https://www.geeksforgeeks.org/how-to-get-the-first-day-of-the-year-in-javascript/](https://www.geeksforgeeks.org/how-to-get-the-first-day-of-the-year-in-javascript/)
...
本示例使用 `getFullYear()` 方法获取当天的整年，然后获取当年的第一天。
