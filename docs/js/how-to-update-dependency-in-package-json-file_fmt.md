...
> 原文: [https://www.geeksforgeeks.org/how-to-update-dependency-in-package-json-file/](https://www.geeksforgeeks.org/how-to-update-dependency-in-package-json-file/)
...
如果你想添加一个特定的版本，你可以运行 `npm install @version` 在这里像`npm install react@^1.8.5`
