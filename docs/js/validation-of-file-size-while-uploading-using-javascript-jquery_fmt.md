...
> 原文: [https://www.geeksforgeeks.org/validation-of-file-size-while-uploading-using-javascript-jquery/](https://www.geeksforgeeks.org/validation-of-file-size-while-uploading-using-javascript-jquery/)
...
*   通过 `files.item(i).size` 得到文件的大小。
*   该值将以字节为单位。通过 `Math.round((fileSize / 1024))` 将其转换为您想要的任何单位，在本例中为兆字节。
*   检查尺寸是否符合您想要的标准。
