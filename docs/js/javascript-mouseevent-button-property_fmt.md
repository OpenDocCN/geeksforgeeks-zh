# JavaScript 鼠标事件 button 属性

> 原文：`https://www.geeksforgeeks.org/javascript-mouseevent-button-property/`

`MouseEvent` 的 `button` 属性用于定义左键或右键单击事件。当点击鼠标按钮时，它将返回一个描述鼠标左键、右键或中键的整数值。
