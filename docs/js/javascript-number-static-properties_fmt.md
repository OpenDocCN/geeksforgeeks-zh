...
> 原文: [https://www.geeksforgeeks.org/javascript-number-static-properties/](https://www.geeksforgeeks.org/javascript-number-static-properties/)
...
**示例 2:** 在这个例子中，我们找出了 JavaScript 中的正无穷大和负无穷大的值。
