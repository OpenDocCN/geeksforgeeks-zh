...
> 原文: [https://www.geeksforgeeks.org/how-to-check-if-an-element-has-any-children-in-javascript/](https://www.geeksforgeeks.org/how-to-check-if-an-element-has-any-children-in-javascript/)
...
在本例中，`hasChildNodes()`方法用于确定`<div>`元素的子元素。
...
在本例中，`children.length`属性用于确定`<div>`元素的子元素。
