...
> 原文：[https://www.geeksforgeeks.org/how-to-disable-arrow-key-in-textarea-using-javascript/](https://www.geeksforgeeks.org/how-to-disable-arrow-key-in-textarea-using-javascript/)

给定一个包含`<textarea>`元素的 HTML 元素，任务是在 JavaScript 的帮助下禁止滚动箭头键。
