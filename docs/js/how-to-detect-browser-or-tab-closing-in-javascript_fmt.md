...
> 原文: [https://www.geeksforgeeks.org/how-to-detect-browser-or-tab-closing-in-javascript/](https://www.geeksforgeeks.org/how-to-detect-browser-or-tab-closing-in-javascript/)
...
<body>
    ...
    <form>
        <textarea placeholder="Trigger an interaction by writing something here">
        </textarea>
    </form>
