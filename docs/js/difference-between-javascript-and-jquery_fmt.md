...
> 原文: [https://www.geeksforgeeks.org/difference-between-javascript-and-jquery/](https://www.geeksforgeeks.org/difference-between-javascript-and-jquery/)
...
| 2. JavaScript 使用长行代码，就像个人必须自己编写代码一样。 | 有了 JQuery，一个人要写的代码行就比 JavaScript 少了。我们只需要导入库，并在我们的代码中只使用库的特定函数或方法。 |
