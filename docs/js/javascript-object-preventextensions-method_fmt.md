...
> 原文：[https://www.geeksforgeeks.org/javascript-object-preventextensions-method/](https://www.geeksforgeeks.org/javascript-object-preventextensions-method/)

JavaScript 中的 `Object.preventExtensions()` 方法是一个标准的内置对象方法，用于防止新属性被添加到对象中。
