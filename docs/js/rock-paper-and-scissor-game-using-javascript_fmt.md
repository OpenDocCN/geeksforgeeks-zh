...
> 原文：[https://www.geeksforgeeks.org/rock-paper-and-scissor-game-using-javascript/](https://www.geeksforgeeks.org/rock-paper-and-scissor-game-using-javascript/)
...
*   创建一个包含游戏所有逻辑的功能`game()`。
*   在函数内部声明三个变量`playerScore`、`computerScore`，招式将分别记录玩家的得分、计算机的得分以及完成的招式。
