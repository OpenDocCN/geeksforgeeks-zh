...
> 原文: [https://www.geeksforgeeks.org/difference-between-function-declaration-and-function-expression-in-javascript/](https://www.geeksforgeeks.org/difference-between-function-declaration-and-function-expression-in-javascript/)
...
*   函数声明也称为函数语句，用 `function` 关键字声明函数。函数声明必须有函数名。
...
| 6. | **(英文):** `function geeksforgeeks(stop, param){ //... }` | **(英文):** `var geeksforGeeks = function(param, param b){ //... }` |