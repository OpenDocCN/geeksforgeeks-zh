...
> 原文：[https://www.geeksforgeeks.org/implement-green-screen-algorithm-using-javascript/](https://www.geeksforgeeks.org/implement-green-screen-algorithm-using-javascript/)
...
<p>
    Forward Image: <input type="file" id="fgFile" multiple="false" onChange="frontimg()">
</p>

<p>
    Background Image: <input type="file" id="bgFile" multiple="false" onChange="backimg()">
</p>
