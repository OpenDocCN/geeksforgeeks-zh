...
> 原文：[https://www.geeksforgeeks.org/how-to-disable-dragging-an-image-from-an-html-page-using-javascript-jquery/](https://www.geeksforgeeks.org/how-to-disable-dragging-an-image-from-an-html-page-using-javascript-jquery/)
...
该方法使用 jQuery 将 `draggable` 属性设置为 `false`。
...
该方法使用 JavaScript 将 `draggable` 属性设置为 `false`。
