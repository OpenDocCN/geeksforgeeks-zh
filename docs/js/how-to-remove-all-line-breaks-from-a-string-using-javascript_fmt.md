...
> 原文: [https://www.geeksforgeeks.org/how-to-remove-all-line-breaks-from-a-string-using-javascript/](https://www.geeksforgeeks.org/how-to-remove-all-line-breaks-from-a-string-using-javascript/)
...
是实现解决这个问题的基本途径。访问字符串中的每个字符，并以删除换行符和回车符的方式对它们进行切分。
...
该方法使用正则表达式检测和替换字符串中的换行符。它和要替换的字符串一起被送入 `replace` 函数，在我们的例子中是一个空字符串。
