...
> 原文：[https://www.geeksforgeeks.org/detect-the-operating-system-of-user-using-javascript/](https://www.geeksforgeeks.org/detect-the-operating-system-of-user-using-javascript/)
...
在本例中，`navigator.appVersion` 属性用于获取 OS。
...
在本例中，`navigator.userAgent` 属性用于获取 OS。
