...
> 原文：[https://www.geeksforgeeks.org/javascript-regexp-quantifier-6/](https://www.geeksforgeeks.org/javascript-regexp-quantifier-6/)

JavaScript 中的 `RegExp $` 量词用于查找任何末尾包含 `m` 的字符串的匹配。
