...
> 原文：[https://www.geeksforgeeks.org/how-to-add-a-delay-in-a-javascript-loop/](https://www.geeksforgeeks.org/how-to-add-a-delay-in-a-javascript-loop/)
...
**示例：** 下面给定的程序将使用 `for` 循环，对每个数字延迟 2 秒后，在控制台打印 0 到 9。
...
Same concept is applied to make below given while loop.
...
Same concept is applied to make below given do-while loop.
