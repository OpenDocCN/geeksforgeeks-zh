...
> 原文: [https://www.geeksforgeeks.org/collect-js-whenempty-function/](https://www.geeksforgeeks.org/collect-js-whenempty-function/)

`Collect.js`是一个流畅方便的包装器，用于处理数组和对象。`whenEmpty()`功能在集合为空时执行回调功能。
...
**参考:** [https://collect.js.org/api/whenEmpty.html](https://collect.js.org/api/whenEmpty.html)