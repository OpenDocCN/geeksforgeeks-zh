...
> 原文: [https://www.geeksforgeeks.org/how-to-write-shorthand-for-document-getelementbyid-method-in-javascript/](https://www.geeksforgeeks.org/how-to-write-shorthand-for-document-getelementbyid-method-in-javascript/)
...
**示例 1:** 在本例中，创建了一个函数，该函数返回 `document`。
...
*   定义一个原型 = `document`。
*   通过将 `IDName` 作为 `document` 的第一个且唯一的参数来使用这个原型。
