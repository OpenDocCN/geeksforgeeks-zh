...
> 原文：[https://www.geeksforgeeks.org/how-to-get-the-information-from-a-meta-tag-using-javascript/](https://www.geeksforgeeks.org/how-to-get-the-information-from-a-meta-tag-using-javascript/)

为了用 JavaScript 在 HTML 中显示元标签信息，我们将使用一个名为 [`getElementsByTagName()`](https://www.geeksforgeeks.org/html-dom-getelementsbytagname-method/) 的方法。
...
## 方法 2：使用 `getElementsByTagName()` 方法，带索引
