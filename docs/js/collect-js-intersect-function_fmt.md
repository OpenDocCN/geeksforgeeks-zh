...
> 原文: [https://www.geeksforgeeks.org/collect-js-intersect-function/](https://www.geeksforgeeks.org/collect-js-intersect-function/)
...
以下示例说明了`collect.js`中的`intersect()`函数。在本例中，我们获取一个集合，然后使用`intersect()`函数获取一个新集合，该集合与值相交，并返回修改后的集合。
