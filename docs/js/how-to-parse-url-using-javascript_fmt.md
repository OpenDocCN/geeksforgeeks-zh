...
> 原文：[https://www.geeksforgeeks.org/how-to-parse-url-using-javascript/](https://www.geeksforgeeks.org/how-to-parse-url-using-javascript/)
...
## 方法 1：
在这个方法中，我们将使用 [`createElement()`](https://www.geeksforgeeks.org/html-dom-createelement-method/) 方法创建一个 HTML 元素，锚定标签，然后使用它来解析给定的 URL。
...
## 方法 2：
在这个方法中，我们将使用 [`URL()`](https://developer.mozilla.org/en-US/docs/Web/API/URL/URL) 创建一个新的 URL 对象，然后使用它来解析提供的 URL。
