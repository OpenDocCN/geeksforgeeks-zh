...
> 原文：[https://www.geeksforgeeks.org/how-to-cartesian-product-of-2-arrays-using-javascript/](https://www.geeksforgeeks.org/how-to-cartesian-product-of-2-arrays-using-javascript/) 生成 2 的笛卡尔乘积数组
...
*   创建一个新数组。
*   这里遵循同样的方法，对于第一个数组的每个元素，第二个数组的每个元素在`apply()`和`map()`方法的帮助下被连接并推到新数组。
