...
> 原文：[https://www.geeksforgeeks.org/how-to-prevent-overriding-using-immediately-invoked-function-expression-in-javascript/](https://www.geeksforgeeks.org/how-to-prevent-overriding-using-immediately-invoked-function-expression-in-javascript/)
...
为了解决这个问题，我们将使用**立即调用函数表达式(IIFE)**的概念，如下所述：
...
在上面的两个文件中，我们已经创建了 IIFE 并传递给 `window` 变量并调用了它。
