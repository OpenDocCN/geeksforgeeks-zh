# JavaScript 函数.caller 属性

> 原文：[https://www.geeksforgeeks.org/javascript-function-caller-property/](https://www.geeksforgeeks.org/javascript-function-caller-property/)
...
对于严格函数、异步函数和生成器函数调用方，该函数返回 `null`。
