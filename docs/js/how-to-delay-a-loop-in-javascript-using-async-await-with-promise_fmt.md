...
> 原文: [https://www.geeksforgeeks.org/how-to-delay-a-loop-in-javascript-using-async-await-with-promise/](https://www.geeksforgeeks.org/how-to-delay-a-loop-in-javascript-using-async-await-with-promise/)
...
`Promise` 实际上做的是，它将程序执行困在其中，直到它没有得到解决，当它在一段时间后得到解决时，它将控制权从调用它的地方交还给主方法。
