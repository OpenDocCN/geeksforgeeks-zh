...
> 原文: [https://www.geeksforgeeks.org/how-to-remove-html-tags-with-regexp-in-javascript/](https://www.geeksforgeeks.org/how-to-remove-html-tags-with-regexp-in-javascript/)
...
*   接受变量中的字符串。
*   小于符号的 `**` 和大于符号 `**` 之间的任何内容都将被正则表达式从字符串中移除。
*   最后我们会得到文本。
