...
> 原文: [https://www.geeksforgeeks.org/javascript-regexp-uxxxx-metacharacter/](https://www.geeksforgeeks.org/javascript-regexp-uxxxx-metacharacter/)

JavaScript 中的 `RegExp \uxxxx` 元字符用于查找十六进制数 `xxxx` 指定的 unicode 字符。如果找到匹配，则返回单词否则返回空值。
...
## 示例 1:
本示例匹配整个字符串中对应于十六进制数 `0047` 即 `G` 的单词。
