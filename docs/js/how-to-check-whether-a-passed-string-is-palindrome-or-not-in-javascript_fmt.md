...
> 原文：[https://www.geeksforgeeks.org/how-to-check-whether-a-passed-string-is-palindrome-or-not-in-javascript/](https://www.geeksforgeeks.org/how-to-check-whether-a-passed-string-is-palindrome-or-not-in-javascript/)
...
*   初始化 `reverse_str` 一个变量，该变量存储传递的字符串的反码。
