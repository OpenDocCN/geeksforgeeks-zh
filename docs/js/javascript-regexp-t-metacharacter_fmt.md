...
> 原文: [https://www.geeksforgeeks.org/javascript-regexp-t-metacharacter/](https://www.geeksforgeeks.org/javascript-regexp-t-metacharacter/)

JavaScript 中的 `RegExp \t` 元字符用于查找制表符。如果找到，它返回位置，否则返回-1。
