...
> 原文：[https://www.geeksforgeeks.org/how-to-select-a-random-element-from-array-in-javascript/](https://www.geeksforgeeks.org/how-to-select-a-random-element-from-array-in-javascript/)
...
*   `random(a, b)` 方法用于生成一个介于 (a 到 b，b 除外) 之间的数字。
*   取地板值，将数字范围从 (1 到 arrayLength)。
