...
> 原文：`https://www.geeksforgeeks.org/how-to-get-the-height-of-scroll-bar-using-javascript/`

给定一个 HTML 文档，任务是使用 JavaScript 获取滚动条的高度。下面是解决这个问题的不同方法，将在下面讨论：

**方法 1：** 在这种方法中，创建一个包含滚动条的 `div` 元素。为了得到滚动条的高度，从 `clientHeight` of `div` 中减去 `offsetHeight` of `div`。
