# 如何用 JavaScript 添加 Bootstrap 拨动开关？

> 原文：[https://www.geeksforgeeks.org/how-to-add-bootstrap-toggle-switch-using-javascript/](https://www.geeksforgeeks.org/how-to-add-bootstrap-toggle-switch-using-javascript/)
