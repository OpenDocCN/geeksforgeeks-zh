...
> 原文：[https://www.geeksforgeeks.org/difference-between-loopback-io-and-sails-js/](https://www.geeksforgeeks.org/difference-between-loopback-io-and-sails-js/)

## LoopBack.io

`LoopBack.io` 是一个高度可扩展、开源的 `Node.js` 和 `TypeScript` 框架，用于构建 `API` 和微服务，使我们能够执行以下操作。
...
`Sails.js` 是一个开源的、免费的、实时的模型-视图-控制器网络应用框架。这个框架是在 `Node.js` 环境的基础上开发的。它还设计用于构建定制的企业级 `web` 应用程序和 `API`。
