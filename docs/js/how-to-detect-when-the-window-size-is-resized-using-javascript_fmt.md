...
> 原文：[https://www.geeksforgeeks.org/how-to-detect-when-the-window-size-is-resized-using-javascript/](https://www.geeksforgeeks.org/how-to-detect-when-the-window-size-is-resized-using-javascript/)
...
我们可以给 `body` 元素添加一个事件监听器，每次调整窗口大小时都会触发。
...
## 方法 2：使用 `ResizeObserver` API

我们可以使用最新的 [`ResizeObserver` API](https://www.geeksforgeeks.org/javascript-resizeobserver-interface/) 来监听窗口调整大小事件。不完全支持此 API。
