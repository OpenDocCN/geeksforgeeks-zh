...
> 原文: [https://www.geeksforgeeks.org/how-to-empty-an-array-in-javascript/](https://www.geeksforgeeks.org/how-to-empty-an-array-in-javascript/)

JavaScript 中有许多清空数组的方法，下面讨论其中一些：

## 方法 1: 设置为新数组

这个方法将数组变量设置为大小为零的新数组，那么它将完美工作。
...
该方法连续弹出数组元素，得到空数组。但是这种方法比其他方法花费更多的时间，并且不太受欢迎。
