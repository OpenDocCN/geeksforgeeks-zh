...
> 原文: [https://www.geeksforgeeks.org/javascript-program-to-read-text-file/](https://www.geeksforgeeks.org/javascript-program-to-read-text-file/)

## 先决条件
如何在 JavaScript 中导入库。从这里阅读: [JavaScript | 导入和导出模块](https://www.geeksforgeeks.org/javascript-importing-and-exporting-modules/)。
