...
> 原文：[https://www.geeksforgeeks.org/javascript-object-getownpropertysymbols-method/](https://www.geeksforgeeks.org/javascript-object-getownpropertysymbols-method/)

JavaScript 中的 `Object.getOwnPropertySymbols()` 方法是标准的内置对象，它返回给定对象中存在的所有符号属性的数组。
