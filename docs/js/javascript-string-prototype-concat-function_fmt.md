...
> 原文: [https://www.geeksforgeeks.org/javascript-string-prototype-concat-function/](https://www.geeksforgeeks.org/javascript-string-prototype-concat-function/)
...
在本例中，函数 `concat()` 将 `'It'` 与 `' is'`、`' a'`、`' great'`、`' day.'` 连接在一起，创建包含所有字符串的最终字符串。
