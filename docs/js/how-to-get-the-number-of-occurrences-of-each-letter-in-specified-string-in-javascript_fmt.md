...
> 原文：[https://www.geeksforgeeks.org/how-to-get-the-number-of-occurrences-of-each-letter-in-specified-string-in-javascript/](https://www.geeksforgeeks.org/how-to-get-the-number-of-occurrences-of-each-letter-in-specified-string-in-javascript/)
...
在这种方法中，我们使用嵌套 for 循环对字符串进行迭代，并对字符串中的每个字符进行计数。

*   首先用字符串的值初始化值为 0 的计数。
*   现在我们遍历字符串，如果带有值的与字符匹配，则将计数值增加 1。
*   最后，打印计数的值。
