...
> 原文：[https://www.geeksforgeeks.org/how-to-convert-a-string-into-kebab-case-using-javascript/](https://www.geeksforgeeks.org/how-to-convert-a-string-into-kebab-case-using-javascript/)
...
这里，我们使用检查空格、大写字母和下划线的 `match` 方法。它创建一个数组，并推送分隔字符串的单词。现在使用连字符 `join()` 连接数组。之后将整个字符串转换成小写。
