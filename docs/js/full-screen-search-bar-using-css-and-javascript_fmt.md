...
> 原文: [https://www.geeksforgeeks.org/full-screen-search-bar-using-css-and-javascript/](https://www.geeksforgeeks.org/full-screen-search-bar-using-css-and-javascript/)
...
*   现在取一个 `div`，将其位置固定，`top`、`bottom`、`left`、`right` 属性设置为零，这样搜索栏就变成固定的(不可滚动的)全屏显示。
