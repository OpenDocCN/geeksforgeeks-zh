...
> 原文：[https://www.geeksforgeeks.org/how-to-create-show-more-and-show-less-functionality-for-hiding-text-using-javascript/](https://www.geeksforgeeks.org/how-to-create-show-more-and-show-less-functionality-for-hiding-text-using-javascript/)

`显示更多`和`显示更少`功能在文本量很大的网站中会很有用，比如在单个页面上包含大量文章的新闻和杂志网站。这可以帮助网页设计者根据需要给用户自由阅读更多或更少的文本。
