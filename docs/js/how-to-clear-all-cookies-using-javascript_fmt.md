...
> 原文：[https://www.geeksforgeeks.org/how-to-clear-all-cookies-using-javascript/](https://www.geeksforgeeks.org/how-to-clear-all-cookies-using-javascript/)
...
下面的代码说明了如何使用 JavaScript 删除 cookies。该代码在一个在线编辑器上运行，以演示只有您的站点创建的 cookies 才能被该代码删除。
...
如果 cookie 的属性“HTTP”设置为“True”，则无法使用 JavaScript 修改其任何属性。