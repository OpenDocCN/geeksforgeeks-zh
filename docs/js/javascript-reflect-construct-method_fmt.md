...
> 原文：[https://www.geeksforgeeks.org/javascript-reflect-construct-method/](https://www.geeksforgeeks.org/javascript-reflect-construct-method/)
...
JavaScript `Reflect.construct()` 方法支持的浏览器如下：
