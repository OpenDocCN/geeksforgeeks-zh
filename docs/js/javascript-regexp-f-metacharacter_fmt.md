...
> 原文: [https://www.geeksforgeeks.org/javascript-regexp-f-metacharacter/](https://www.geeksforgeeks.org/javascript-regexp-f-metacharacter/)

JavaScript 中的 `RegExp \f` 元字符用于查找表单提要字符（表单提要是一个分页的 ASCII 控制字符）。如果找到，它返回位置，否则返回 `-1`。
