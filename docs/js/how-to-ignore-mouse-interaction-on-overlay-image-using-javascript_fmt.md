...
> 原文：[https://www.geeksforgeeks.org/how-to-ignore-mouse-interaction-on-overlay-image-using-javascript/](https://www.geeksforgeeks.org/how-to-ignore-mouse-interaction-on-overlay-image-using-javascript/)

忽略叠加图像上的鼠标交互可以由 CSS 属性控制，即 `pointer-events`。它是一个属性，定义页面的某个元素是否会对指针事件做出反应。
...
**示例：** 以下示例演示了 `pointer-events` 属性的使用。
