...
> 原文：`https://www.geeksforgeeks.org/how-to-declare-variables-in-different-ways-in-javascript/`
...
## var
此关键字用于全局声明变量。如果你用这个关键字来声明变量，那么这个变量可以是全局可访问的，也是可变的。这对于短长度的代码来说是很好的，如果代码变得很大，那么你会感到困惑。
...
## let
此关键字用于在本地声明变量。如果您使用这个关键字来声明变量，那么这个变量可以在本地访问，并且也是可变的。如果代码变得庞大，那就好了。
...
## const
此关键字用于全局声明变量。如果你用这个关键字来声明变量，那么这个变量是全局可访问的，它是不可改变的。
