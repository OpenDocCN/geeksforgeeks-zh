...
> 原文: [https://www.geeksforgeeks.org/javascript-symbol-hasinstance-property/](https://www.geeksforgeeks.org/javascript-symbol-hasinstance-property/)

`Symbol.hasInstance` 是 JavaScript 中的一个内置属性，用于确定给定的构造函数对象是否将该对象识别为其实例。
...
**参考:** [https://devdocs.io/javascript/global_objects/symbol/hasinstance](https://devdocs.io/javascript/global_objects/symbol/hasinstance)