...
> 原文：[https://www.geeksforgeeks.org/how-to-dynamically-load-js-inside-js/](https://www.geeksforgeeks.org/how-to-dynamically-load-js-inside-js/)
...
假设我们想要运行一个脚本，根据单击的按钮对字符串执行一些操作。
...
这些模块也可以在正则脚本中动态加载。一个本地服务器需要被设置，以避免在使用 ES6 模块时出现跨域问题。
