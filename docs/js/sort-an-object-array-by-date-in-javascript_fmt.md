...
> 原文：[https://www.geeksforgeeks.org/sort-an-object-array-by-date-in-javascript/](https://www.geeksforgeeks.org/sort-an-object-array-by-date-in-javascript/)

要按日期对对象数组进行排序，有许多方法，但我们将看到几个最受欢迎的方法。

## 日期对象

JavaScript 中的 `Date` 对象用来表示某个时刻。该时间值自世界协调时 1970 年 1 月 1 日起。我们可以通过调用新的 `date()` 构造函数，使用 `Date` 对象创建日期，如下语法所示。
