...
下面的例子说明了`collect.js`中的`forPage()`函数。在这个例子中，我们取一个集合，然后使用`forPage()`函数显示给定页面中作为参数的值，并返回该值。
...
**参考:** [`https://collect.js.org/api/forPage.html`](https://collect.js.org/api/forPage.html)