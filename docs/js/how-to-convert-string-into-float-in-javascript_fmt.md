...
> 原文: [https://www.geeksforgeeks.org/how-to-convert-string-into-float-in-javascript/](https://www.geeksforgeeks.org/how-to-convert-string-into-float-in-javascript/)
...
## 方法 1:
在此方法中，我们将使用 JavaScript 的[类型转换](https://www.geeksforgeeks.org/javascript-type-conversion/)功能，该功能将字符串值转换为浮点数。
...
## 方法 2:
在这个方法中，我们将使用 [`parseFloat()`](https://www.geeksforgeeks.org/javascript-parsefloat-with-examples/) 方法，这是 JavaScript 中的一个内置函数，用于接受字符串并将其转换为浮点数。如果字符串不包含数字值，或者如果字符串的第一个字符不是数字，则返回 `NaN`，即不是数字。
