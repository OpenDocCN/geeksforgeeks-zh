...
> 原文: [https://www.geeksforgeeks.org/how-getelementbyid-works-in-javascript/](https://www.geeksforgeeks.org/how-getelementbyid-works-in-javascript/)
...
网页中应使用唯一的 id。但是，如果特定 id 存在多个元素，那么第一个元素将被考虑并由代码中的 `getElementById` 返回。
...
**返回值:** 指定标识的元素对象，如果没有找到匹配的元素，则为 `null`。
