...
> 原文：`https://www.geeksforgeeks.org/javascript-string-constructor-property/`
...
<body>
    ...
    <p>
        Click the button to see string contructor property.
    </p>
    ...
    <script>
        function myGeeks() {
            var str = "Hello World!";
            document.getElementById("GFG").innerHTML = str.constructor;
        }
    </script>
</body>
</html>
