...
> 原文: [https://www.geeksforgeeks.org/how-to-change-image-dynamically-when-user-scrolls-using-javascript/](https://www.geeksforgeeks.org/how-to-change-image-dynamically-when-user-scrolls-using-javascript/)
...
CSS 用于设计结构。[`position`](https://www.geeksforgeeks.org/css-positioning-elements/) 属性是这里最重要的东西。它将使所有的图像出现在彼此之上。
