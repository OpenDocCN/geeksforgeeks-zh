...
> 原文：[https://www.geeksforgeeks.org/how-to-create-a-new-object-from-the-specified-object-where-all-the-keys-are-in-lowercase-in-javascript/](https://www.geeksforgeeks.org/how-to-create-a-new-object-from-the-specified-object-where-all-the-keys-are-in-lowercase-in-javascript/)
...
一个简单的方法是从 `Object` 中提取所有键并将其转为小写，然后用它们创建新对象。为此，我们使用 `Object.keys()` 从对象中提取键，并使用 `String.toLowerCase()` 方法来小写键，使用 `Array.reduce()` 方法来制作一个带有小写字符串的对象。
