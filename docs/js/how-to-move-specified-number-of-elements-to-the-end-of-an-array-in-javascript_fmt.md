...
> 原文：[https://www.geeksforgeeks.org/how-to-move-specified-number-of-elements-to-the-end-of-an-array-in-javascript/](https://www.geeksforgeeks.org/how-to-move-specified-number-of-elements-to-the-end-of-an-array-in-javascript/)
...
*   从索引 `i = 0` 到 `X-1` 运行循环的 [for](https://www.geeksforgeeks.org/javascript-for-loop/)。
*   在每次迭代中，获取当前索引处的元素，并将其追加到数组的末尾。
*   迭代完成后，使用 JavaScript [`splice()`](https://www.geeksforgeeks.org/javascript-array-splice-method/) 方法从数组中移除第一个 `X` 元素，得到结果数组。
