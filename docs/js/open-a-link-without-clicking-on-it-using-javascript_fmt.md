...
> 原文: [https://www.geeksforgeeks.org/open-a-link-without-clicking-on-it-using-javascript/](https://www.geeksforgeeks.org/open-a-link-without-clicking-on-it-using-javascript/)

## 问题陈述
如何使用 JavaScript 打开链接而不点击？

## 解决方法
当鼠标移过文本时，链接将打开。它返回一个新创建的窗口，如果调用失败，则返回空值。
