...
> 原文：[https://www.geeksforgeeks.org/delete-the-array-elements-in-javascript-delete-vs-splice/](https://www.geeksforgeeks.org/delete-the-array-elements-in-javascript-delete-vs-splice/)

对于删除数组中的元素，可以使用两种方法。它们在执行删除的方式上有自己的优点。
