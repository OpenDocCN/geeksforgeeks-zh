...
> 原文：[https://www.geeksforgeeks.org/how-to-set-textarea-scroll-bar-to-bottom-as-a-default-using-javascript-jquery/](https://www.geeksforgeeks.org/how-to-set-textarea-scroll-bar-to-bottom-as-a-default-using-javascript-jquery/)

给定一个包含`<textarea>`元素的 HTML 文档，任务是在 jQuery 的帮助下将滚动条的位置设置到`<textarea>`的底部。

## 方法 1

*   获取文本区域的`scrollHeight`属性。
*   使用`scrollTop`属性，通过 jQuery 设置垂直滚动条的位置。
