...
> 原文: [https://www.geeksforgeeks.org/how-to-remove-an-html-element-using-javascript/](https://www.geeksforgeeks.org/how-to-remove-an-html-element-using-javascript/)

给定一个 HTML 元素，任务是使用 JavaScript 从文档中移除该元素。

## 进场

选择需要移除的 HTML 元素。使用 JavaScript `remove()` 和 `removeChild()` 方法从 HTML 文档中移除元素。

## 示例 1

本示例使用 `removeChild()` 方法移除 HTML 元素。
...
本示例使用 `remove()` 方法从文档中移除一个 HTML 元素。
