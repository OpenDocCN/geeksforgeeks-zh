...
> 原文：[https://www.geeksforgeeks.org/how-to-get-array-structure-with-alert-in-javascript/](https://www.geeksforgeeks.org/how-to-get-array-structure-with-alert-in-javascript/)
...
<body style="text-align:center;" id="body">
    ...
    <script>
        ...
        var arr = [1, 2, 4, 6, 9];
        el_up.innerHTML = "Click on the button to see the array structure using Alert().<br> Array is = " + arr;
