...
> 原文: [https://www.geeksforgeeks.org/javascript-regexp-tostring-method/](https://www.geeksforgeeks.org/javascript-regexp-tostring-method/)

JavaScript 中的 `RegExp toString()`方法用于返回正则表达式的字符串值。
...
**支持的浏览器:** 下面列出了 `RegExp toString()`方法支持的浏览器:
