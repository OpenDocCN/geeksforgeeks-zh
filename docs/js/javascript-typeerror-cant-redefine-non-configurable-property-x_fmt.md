...
> 原文: [https://www.geeksforgeks.org/javascript-typeerror-cant-redefine-non-configurable-property-x/](https://www.geeksforgeks.org/javascript-typeerror-cant-redefine-non-configurable-property-x/)

这个 JavaScript 异常 `Cannot redefine non-configurable property` 如果用户试图重新定义一个属性，但是该属性是不可配置的，就会出现这个异常。

**消息:** `TypeError: Cannot redefine property: x`
