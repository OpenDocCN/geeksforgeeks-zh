...
> 原文: [https://www.geeksforgeeks.org/google-geo-coding-web-service-json-response/](https://www.geeksforgeeks.org/google-geo-coding-web-service-json-response/)
...
您可以阅读该服务的在线文档，但它非常简单，您甚至可以通过在浏览器中键入以下网址来使用浏览器进行测试: [http://maps.googleapis.com/maps/api/geocode/json?address=Ann+Arbor%2C+MI](http://maps.googleapis.com/maps/api/geocode/json?address=Ann+Arbor%2C+MI)
