...
> 原文: [https://www.geeksforgeeks.org/javascript-course-javascript-prompt-example/](https://www.geeksforgeeks.org/javascript-course-javascript-prompt-example/)
...
**注意:** 任何浏览器都可以，不过推荐 `谷歌 Chrome` 或者 `Mozilla Firefox`。
