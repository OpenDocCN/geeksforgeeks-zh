...
> 原文：[https://www.geeksforgeeks.org/javascript-course-logical-operators-in-javascript/](https://www.geeksforgeeks.org/javascript-course-logical-operators-in-javascript/)
...
运算符将值 `1` 转换为布尔值，结果是 `true`，然后在翻转（反转）该值后，这就是为什么当我们最终提醒该值时，我们得到 `false`。
