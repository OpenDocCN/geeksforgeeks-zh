...
> 原文: [https://www.geeksforgeeks.org/how-to-convert-an-object-to-string-using-javascript/](https://www.geeksforgeeks.org/how-to-convert-an-object-to-string-using-javascript/)

下面是将不同对象转换为字符串的方法。

## 方法 1: 使用函数 `String()`

`String()`函数将`object`的值转换为字符串。
