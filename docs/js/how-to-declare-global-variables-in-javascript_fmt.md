...
> 原文：[https://www.geeksforgeeks.org/how-to-declare-global-variables-in-javascript/](https://www.geeksforgeeks.org/how-to-declare-global-variables-in-javascript/)
...
`示例 2`：使用 `window` 对象在函数中声明全局变量。使用 `window` 对象声明的变量是全局变量，可以从程序的任何部分访问。
