# Moment.js 中的 second() 方法

> 原文: [https://www.geeksforgeeks.org/moment-js-moment-second-method/](https://www.geeksforgeeks.org/moment-js-moment-second-method/)

`moment().second()` 方法用于从当前时间获取秒数或设置秒数。
