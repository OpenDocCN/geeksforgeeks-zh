...
> 原文：[https://www.geeksforgeeks.org/how-to-get-the-elements-of-one-array-which-are-not-present-in-another-array-using-javascript/](https://www.geeksforgeeks.org/how-to-get-the-elements-of-one-array-which-are-not-present-in-another-array-using-javascript/)
...
- 以变量中的数组为例。
- 使用 `.filter()` 方法在第一个数组上，检查第一个数组的元素是否不在第二个数组中，将那些元素包含在输出中。
...
这个示例使用了相同的方法，但是 JavaScript 的方法不同。
