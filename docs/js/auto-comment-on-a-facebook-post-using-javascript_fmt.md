...
> 原文：[https://www.geeksforgeeks.org/auto-comment-on-a-facebook-post-using-javascript/](https://www.geeksforgeeks.org/auto-comment-on-a-facebook-post-using-javascript/)
...
请确保有稳定的互联网连接可用，这样脚本才能顺利运行。还要确保使用`m.facebook.com`而不是`www.facebook.com`访问 facebook，因为此脚本仅适用于移动版 facebook。
