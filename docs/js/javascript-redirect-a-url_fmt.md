...
*   [学习基本 HTML](https://www.geeksforgeeks.org/html-basics/)
*   [学习基本 JavaScript](https://www.geeksforgeeks.org/understanding-basic-javascript-codes/)

在 JavaScript 中重定向一个网址只不过是将用户从一个网址发送到另一个网址。在 Javascript 中，`window.location` 函数用于重定向到一个 URL。

## JavaScript 重定向网址代码示例
...
*   用 `.html` 扩展名保存这些文件为 `file_name.html`。
