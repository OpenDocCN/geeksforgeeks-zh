...
> 原文：[https://www.geeksforgeeks.org/how-to-convert-decimal-to-hex-in-javascript/](https://www.geeksforgeeks.org/how-to-convert-decimal-to-hex-in-javascript/)

给定一个数字，任务是将数字从十进制转换为十六进制。这可以通过使用 `toString()` 方法来完成。它接受参数，该参数是转换后的字符串的基数。在这种情况下，基数将是 16。
