...
> 原文：[https://www.geeksforgeeks.org/how-to-detect-keypress-using-javascript/](https://www.geeksforgeeks.org/how-to-detect-keypress-using-javascript/)
...
上述所有技术都用于实现按键检测。
像 `Atom` 或 `Sublime Text` 这样的程序编辑器应用程序可以用来编译程序。
