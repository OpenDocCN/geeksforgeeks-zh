...
> 原文: [https://www.geeksforgeeks.org/explain-the-rest-parameter-in-es6/](https://www.geeksforgeeks.org/explain-the-rest-parameter-in-es6/)
...
在本例中，我们将使用一种简单的方法编写函数，进一步添加 rest 参数，并在调用函数本身的同时将函数内部的一些参数作为参数传递。
...
在本例中，我们将计算用户在调用时在函数内部作为参数传递的所有数字的总和。
