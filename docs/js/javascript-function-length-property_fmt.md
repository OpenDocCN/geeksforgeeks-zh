...
> 原文: [https://www.geeksforgeeks.org/javascript-function-length-property/](https://www.geeksforgeeks.org/javascript-function-length-property/)

`function.length` 是 JavaScript 中函数对象的属性，用于返回函数所需的参数个数。
