...
> 原文: [https://www.geeksforgeeks.org/javascript-regexp-s-metacharacter-2/](https://www.geeksforgeeks.org/javascript-regexp-s-metacharacter-2/)

JavaScript 中的 `RegExp` `\S` 元字符用于查找非空白字符。空白字符可以是空格/制表符/新行/垂直字符。这和 `[^\t\n\r]` 一样。
