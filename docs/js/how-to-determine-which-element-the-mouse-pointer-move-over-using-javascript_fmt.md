...
> 原文：[https://www.geeksforgeeks.org/how-to-determine-which-element-the-mouse-pointer-move-over-using-javascript/](https://www.geeksforgeeks.org/how-to-determine-which-element-the-mouse-pointer-move-over-using-javascript/)

给定一个 HTML 文档，任务是获取鼠标指针移动到的元素。有两种方法可以解决这个问题，讨论如下：

## 方法 1

*   使用 `event.clientX` 和 `event.clientY` 属性获取 x、y 坐标值。
