...
> 原文：[https://www.geeksforgeeks.org/how-to-check-a-url-contains-a-hash-or-not-using-javascript/](https://www.geeksforgeeks.org/how-to-check-a-url-contains-a-hash-or-not-using-javascript/)

任务是检查一个网址是否包含哈希。这可以通过在 JavaScript 中使用 `Location` 对象的 `hash` 属性来实现。它返回一个字符串，该字符串表示包含哈希符号“#”的 URL 的锚定部分。
