...
> 原文：[https://www.geeksforgeeks.org/how-to-deep-clone-in-javascript/](https://www.geeksforgeeks.org/how-to-deep-clone-in-javascript/)
...
如本例所示，如果我们更改一个对象值，数据就会损坏，然后它会反映在其他对象中，这也是我们使用深度克隆来避免此问题的原因。
...
我们可以使用所有这些方法来确保数据是安全的，并且当我们在一个对象中改变时不会发生突变。