...
> 原文：[`https://www.geeksforgeeks.org/javascript-new-target-meta-property/`](https://www.geeksforgeeks.org/javascript-new-target-meta-property/)
...
<body style="text-align:center;">
    ...
    <script>
        ...
        function Fun() {
            if (!new.target) {
                throw 'Fun() is called without new operator';
            }
        }
