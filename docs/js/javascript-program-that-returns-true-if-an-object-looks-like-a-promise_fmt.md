...
> 原文：[https://www.geeksforgeeks.org/javascript-program-that-returns-true-if-an-object-looks-like-a-promise/](https://www.geeksforgeeks.org/javascript-program-that-returns-true-if-an-object-looks-like-a-promise/)

在 JavaScript 中，`Promise`是将生产代码和消费代码链接在一起的对象。简单来说，JavaScript 中的承诺和现实生活中的承诺是一样的。每当一个承诺被创造出来，有 3 个条件，或者说我们可以期待的结果：
