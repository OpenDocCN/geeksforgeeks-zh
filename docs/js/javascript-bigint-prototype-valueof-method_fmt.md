...
> 原文：[https://www.geeksforgeeks.org/javascript-bigint-prototype-valueof-method/](https://www.geeksforgeeks.org/javascript-bigint-prototype-valueof-method/)

`BigInt.prototype.valueOf()`方法是 JavaScript 中的一个内置方法，用于返回 BigInt 对象的包装基元值。
...
**支持的浏览器：** `BigInt.prototype.valueOf()`方法支持的浏览器如下：
