...
在安装 Ember CLI 工具之前，您需要在本地计算机上安装节点和 [npm](https://www.geeksforgeeks.org/node-js-npm-node-package-manager/) 。你可以从它的[官方](https://nodejs.org/en/download/)网站安装 NodeJS。
...
安装完节点和 npm 后，可以在本地计算机上运行以下命令来安装 Ember CLI。
