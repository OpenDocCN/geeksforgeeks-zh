...
> 原文: [https://www.geeksforgeeks.org/how-to-check-all-values-of-an-array-are-equal-or-not-in-javascript/](https://www.geeksforgeeks.org/how-to-check-all-values-of-an-array-are-equal-or-not-in-javascript/)
...
**示例 1:** 本示例使用 `array.every()` 方法打印所需响应。
...
**示例:** 本示例使用 `array.reduce()` 方法打印给定数组的 `false`。
