...
> 原文: [https://www.geeksforgeeks.org/javascript-regexp-xy-expression/](https://www.geeksforgeeks.org/javascript-regexp-xy-expression/)

JavaScript 中的 `正则表达式(x|y)` 表达式用于搜索任何指定的字符（用 `|` 分隔）。
