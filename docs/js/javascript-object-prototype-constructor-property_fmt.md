...
> 原文: [https://www.geeksforgeeks.org/javascript-object-prototype-constructor-property/](https://www.geeksforgeeks.org/javascript-object-prototype-constructor-property/)

`constructor` 属性返回对已创建对象实例的对象构造函数的引用。构造函数的值不是包含函数名称的字符串，而是对函数本身的引用。
