...
> 原文：[https://www.geeksforgeeks.org/how-to-convert-json-results-into-a-date-using-javascript/](https://www.geeksforgeeks.org/how-to-convert-json-results-into-a-date-using-javascript/)

任务是在 JavaScript 的帮助下将一个 JSON 结果转换成 JavaScript 日期。下面讨论两种方法：

## 方法 1

*   使用 `substr()` 方法获取字符串的整数部分。
*   使用 `parseInt()` 方法后跟 `Date()` 获取 JavaScript 日期。
