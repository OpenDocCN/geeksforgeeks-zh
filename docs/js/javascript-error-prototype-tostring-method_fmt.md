...
> 原文：[https://www.geeksforgeeks.org/javascript-error-prototype-tostring-method/](https://www.geeksforgeeks.org/javascript-error-prototype-tostring-method/)
...
`Error.prototype.toString()` 方法支持的浏览器如下：
