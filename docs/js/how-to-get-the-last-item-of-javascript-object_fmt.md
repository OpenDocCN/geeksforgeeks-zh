...
> 原文: [https://www.geeksforgeeks.org/how-to-get-the-last-item-of-javascript-object/](https://www.geeksforgeeks.org/how-to-get-the-last-item-of-javascript-object/)
...
*   使用 `for...in` 循环访问对象的所有键，在循环结束时，循环变量将拥有对象的最后一个键。
