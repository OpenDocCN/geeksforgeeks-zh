...
> 原文: [https://www.geeksforgeeks.org/how-to-uniquely-identify-computers-visiting-web-site-in-javascript/](https://www.geeksforgeeks.org/how-to-uniquely-identify-computers-visiting-web-site-in-javascript/)
...
关于 [cookies 在网站中是如何使用的？](https://www.geeksforgeeks.org/cookies-used-website/) 的更多细节。
...
JavaScript 可以使用 [`document.cookie`](https://www.geeksforgeeks.org/html-dom-cookie-property/) 属性进行读取、创建和删除 Cookies 等所有操作。cookie 文本记录由四个属性组成。
...
以下示例演示了 cookies，它存储 cookies 2 天，并使用 cookies 用用户的语言向用户打招呼。运行此代码后，系统会要求您输入语言“英语/西班牙语”。输入后，您可以再次运行代码，并看到系统用选定的语言向用户问好。
