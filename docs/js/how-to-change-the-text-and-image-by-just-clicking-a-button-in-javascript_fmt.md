...
> 原文: [https://www.geeksforgeeks.org/how-to-change-the-text-and-image-by-just-clicking-a-button-in-javascript/](https://www.geeksforgeeks.org/how-to-change-the-text-and-image-by-just-clicking-a-button-in-javascript/)
...
在这一部分我们创建了结构，加上我们将添加 [Bootstrap](https://www.geeksforgeeks.org/bootstrap-tutorials/) CDN 链接为按钮设计和字体。
...
在本节中，我们将使用一些基本的 CSS 样式，使其看起来尽可能正常。
...
在本节中，我们将定义 JavaScript 函数，我们拍摄了两张图像，它们出现在单独的 `img` 文件夹中。
