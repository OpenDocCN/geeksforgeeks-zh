...
> 原文: [https://www.geeksforgeeks.org/fastest-way-to-convert-javascript-nodelist-to-array/](https://www.geeksforgeeks.org/fastest-way-to-convert-javascript-nodelist-to-array/)
...
将 NodeList 转换成 JavaScript 数组的方法有很多，但最快的是 ES6 的一个新方法。在 ES6 中，我们现在可以简单地使用`Array.from()`方法从节点列表创建一个数组。此方法用于从类似数组或可迭代的对象创建浅拷贝的新数组实例。在这种情况下，我们转换的节点列表是类似数组的对象。
