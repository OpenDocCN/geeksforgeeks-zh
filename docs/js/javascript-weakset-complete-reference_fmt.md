...
> 原文：`https://www.geeksforgeeks.org/javascript-weakset-complete-reference/`
...
*   [JavaScript WeakSet.`add()`方法](https://www.geeksforgeeks.org/javascript-weakset-add-with-examples/)
*   [JavaScript WeakSet.`delete()`方法](https://www.geeksforgeeks.org/javascript-weakset-delete-with-example/)
