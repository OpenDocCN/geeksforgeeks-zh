...
> 原文: [https://www.geeksforgeeks.org/how-to-add-special-characters-to-text-to-print-in-color-in-the-console-in-javascript/](https://www.geeksforgeeks.org/how-to-add-special-characters-to-text-to-print-in-color-in-the-console-in-javascript/)
...
**示例:** 以下是使用 `colorHelper` 函数执行任务的 JavaScript 代码。
