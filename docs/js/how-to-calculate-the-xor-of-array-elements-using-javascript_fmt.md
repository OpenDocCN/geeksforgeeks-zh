...
> 原文：[https://www.geeksforgeeks.org/how-to-calculate-the-xor-of-array-elements-using-javascript/](https://www.geeksforgeeks.org/how-to-calculate-the-xor-of-array-elements-using-javascript/)
...
**`使用 reduce() 方法`：** JavaScript 中的 array `reduce()` 方法用于将数组缩减为单个值，并为数组的每个值（从左到右）执行一个提供的函数，该函数的返回值存储在累加器中。
