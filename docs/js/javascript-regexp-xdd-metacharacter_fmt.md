...
> 原文: [https://www.geeksforgeeks.org/javascript-regexp-xdd-metacharacter/](https://www.geeksforgeeks.org/javascript-regexp-xdd-metacharacter/)
...
本例匹配对应于十六进制数 `47` 的单词，即整个字符串中的 `G`。
