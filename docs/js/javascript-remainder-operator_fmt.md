...
> 原文: [https://www.geeksforgeeks.org/javascript-remainder-operator/](https://www.geeksforgeeks.org/javascript-remainder-operator/)
...
本示例返回正余数，在这种情况下，模和余数将相同，因为两个操作数都是正的。
