...
*   使用不同的颜色来指示哪个元素是对比、左分区、右分区和枢轴元素。
...
![排序前](img/733de0b804880a8e6444cde4ca22e627.png)

在排序之前

![排序后](img/e39ecc179af174ac51a141378d32e0b9.png)
...
![Колибри0.7.0](img/71cd73e90ec09e9a7886b47de6cd43b1.png)