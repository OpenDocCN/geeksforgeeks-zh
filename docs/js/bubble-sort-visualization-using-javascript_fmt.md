...
> 原文：[https://www.geeksforgeeks.org/bubble-sort-visualization-using-javascript/](https://www.geeksforgeeks.org/bubble-sort-visualization-using-javascript/)
...
*   按 `Ctrl+R` 键可生成新数组。
*   使用 `swap()` 功能，使用 `bubblerSort()` 功能执行排序。
