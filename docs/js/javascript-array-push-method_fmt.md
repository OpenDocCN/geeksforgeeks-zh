...
> 原文：`https://www.geeksforgeeks.org/javascript-array-push-method/`
...
此方法包含的参数数量与要插入数组的元素数量相同。

## 返回值：

该方法在数组中插入参数后返回新的数组长度。

## 以下示例说明了 JavaScript 数组 `push()` 方法：
