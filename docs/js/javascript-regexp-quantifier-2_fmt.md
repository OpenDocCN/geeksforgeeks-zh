...
> 原文: [https://www.geeksforgeeks.org/javascript-regexp-quantifier-2/](https://www.geeksforgeeks.org/javascript-regexp-quantifier-2/)

JavaScript 中的 `m+` 量词用于查找任何至少包含一个 `m` 的字符串的匹配。
