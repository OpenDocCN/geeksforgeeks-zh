...
> 原文：[https://www.geeksforgeeks.org/how-to-convert-a-dom-nodelist-to-an-array-using-javascript/](https://www.geeksforgeeks.org/how-to-convert-a-dom-nodelist-to-an-array-using-javascript/)
...
使用 ES6 扩展语法，它允许在预期有零个或多个参数或元素的地方扩展可迭代对象，如数组表达式或字符串。
