...
## encodeURI()、decodeURI()及其组件函数

> 原文: [https://www.geeksforgeeks.org/javascript-encodeuri-decodeuri-and-its-components-functions/](https://www.geeksforgeeks.org/javascript-encodeuri-decodeuri-and-its-components-functions/)
...
参数: 该函数接受保存编码字符串的单个参数 `complete_encoded_uri_string`。
...
参数: 该函数接受保存编码字符串的单个参数 `encoded_uri_string_component`。
