...
React 是一个 JavaScript 库，用于创建网络应用程序。React 使用[JSX](https://www.geeksforgeeks.org/reactjs-introduction-jsx/)允许我们在 HTML 元素内部编写 JavaScript 对象。JSX 既不是字符串，也不是 HTML。它是 JavaScript 的语法扩展。JSX 让代码变得简单易懂。
