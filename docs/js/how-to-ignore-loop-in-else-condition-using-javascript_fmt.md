...
> 原文：[https://www.geeksforgeeks.org/how-to-ignore-loop-in-else-condition-using-javascript/](https://www.geeksforgeeks.org/how-to-ignore-loop-in-else-condition-using-javascript/)
...
当涉及到`forEach`循环时，AngularJS会因为`break`和`continue`语句而变得非常混乱。
...
但是，可以通过包含布尔函数来实现`break`操作，如下例所示：
