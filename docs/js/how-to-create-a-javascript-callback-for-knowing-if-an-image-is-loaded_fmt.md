...
> 原文: [https://www.geeksforgeeks.org/how-to-create-a-javascript-callback-for-knowing-if-an-image-is-loaded/](https://www.geeksforgeeks.org/how-to-create-a-javascript-callback-for-knowing-if-an-image-is-loaded/)
...
**注意:** 该程序将持续检查图像是否使用 `img` 元素的 `complete` 属性加载。它还会检查错误。当图像被加载时，它将通过“已加载”警告消息框发出警告。
