# JavaScript MouseEvent which 属性

> 原文: [https://www.geeksforgeeks.org/javascript-mouseevent-which-property/](https://www.geeksforgeeks.org/javascript-mouseevent-which-property/)

鼠标事件`which`属性用于在鼠标事件被触发时返回与按下的鼠标按钮相对应的数字。
