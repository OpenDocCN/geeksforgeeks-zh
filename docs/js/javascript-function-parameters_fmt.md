...
> 原文: [https://www.geeksforgeeks.org/javascript-function-parameters/](https://www.geeksforgeeks.org/javascript-function-parameters/)
...
<body style="text-align:center;">
    ...
    <script>
        ...
        document.getElementById("geeks").innerHTML = GFG(4, 50, 6);
    </script>
</body>
</html>
```
...
默认参数用于在没有值或未定义的情况下，用默认值初始化命名参数。
...
<body style="text-align:center;">
    ...
    <script>
        ...
        document.getElementById("geeks").innerHTML = GFG(4);
    </script>
</body>
</html>
```
...
参数对象是 JavaScript 函数中的内置对象。在所有非箭头函数中，`arguments` 对象是一个局部变量。使用函数的参数对象分析函数内部的参数。
...
<body style="text-align:center;">
    ...
    <script>
        ...
        document.getElementById("geeks").innerHTML = GFG(10, 12, 500, 5, 440, 45);
    </script>
</body>
</html>
```
...
在函数调用中，参数作为参数调用。传递值将变量值发送给函数。它不发送变量的地址。如果函数改变了参数的值，那么它不会影响原始值。
...
在通过引用传递的对象中，传递变量的地址而不是值作为调用函数的参数。如果我们改变函数内部变量的值，那么它将影响函数外部变量。
