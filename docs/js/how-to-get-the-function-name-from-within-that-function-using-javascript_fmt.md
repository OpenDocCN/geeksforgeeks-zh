...
> 原文: [https://www.geeksforgeeks.org/how-to-get-the-function-name-from-within-that-function-using-javascript/](https://www.geeksforgeeks.org/how-to-get-the-function-name-from-within-that-function-using-javascript/)
...
返回一个新的字符串，包含文本的提取部分。如果 `length` 为 0 或负数，则返回空字符串。

## Function prototype `name` property
...
本示例首先使用 `toString()` 方法将函数转换为字符串，然后使用 `substr()` 方法从该字符串中提取名称。
...
本示例使用 `Function.prototype.name` 属性获取函数的名称。
