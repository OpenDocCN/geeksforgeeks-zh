...
> 原文：[https://www.geeksforgeeks.org/how-to-remove-objects-from-associative-array-in-javascript/](https://www.geeksforgeeks.org/how-to-remove-objects-from-associative-array-in-javascript/)

创建一个包含键值对的关联数组，任务是使用 JavaScript 从关联数组中移除对象。我们可以使用 `delete` 关键字从 JavaScript 关联数组中移除对象。

## 方法
声明一个包含键值对对象的关联数组。然后使用 `delete` 关键字从关联数组中删除数组对象。

## 示例 1
本示例使用 `delete` 关键字从关联数组中移除对象。
