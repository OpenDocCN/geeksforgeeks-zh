...
> 原文: [https://www.geeksforgeeks.org/javascript-string-replace-method/](https://www.geeksforgeeks.org/javascript-string-replace-method/)

下面是`string.replace()`方法的示例。
...
这里的参数`A`是正则表达式，`B`是将替换给定字符串内容的字符串。
