...
> 原文：[https://www.geeksforgeeks.org/how-to-remove-all-rows-from-a-table-in-javascript/](https://www.geeksforgeeks.org/how-to-remove-all-rows-from-a-table-in-javascript/)
...
*   首先给表设置 ID 或唯一类。
*   选择表格元素，使用 `remove()` 或 `detach()` 方法删除所有表格行。

## 示例 1

在本例中，使用 `remove()` 方法删除所有行。
