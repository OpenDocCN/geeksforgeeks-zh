...
> 原文：[https://www.geeksforgeeks.org/how-to-check-if-a-string-is-html-or-not-using-javascript/](https://www.geeksforgeeks.org/how-to-check-if-a-string-is-html-or-not-using-javascript/)
...
在本例中，创建了一个正则表达式，它正在验证 HTML 字符串是否有效。
...
在这个示例中，这里也创建了一个正则表达式，它正在验证 HTML 字符串是否无效。
