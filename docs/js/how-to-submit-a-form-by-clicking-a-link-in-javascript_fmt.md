...
给定的 HTML 代码会将表单数据重定向到 [`action`](https://www.geeksforgeeks.org/html-action-attribute/) 属性中提到的站点或文件。

## PHP 代码

创建一个 PHP 文件获取用户输入的表单数据，将这个 PHP 文件重命名为 `form.php`。此代码显示用户表单数据。
