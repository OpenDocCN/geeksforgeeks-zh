...
> 原文: [https://www.geeksforgeeks.org/how-to-use-javascript-fetch-api-to-get-data/](https://www.geeksforgeeks.org/how-to-use-javascript-fetch-api-to-get-data/)
...
作为一个例子，我们将使用 API: [https://reqres.in/api/users](https://reqres.in/api/users)，它会给我们关于一个人的随机数据，我们在这里的目标是看看这些数据中呈现了什么。
...
2.  `options`: 这是一个可选参数，它是一个选项对象，可以有以下值:
    *   `method`: 表示方法类型，可以是任何 HTTP 请求类型，如 `GET`、`POST`、`PUT`、`DELETE` 等。
