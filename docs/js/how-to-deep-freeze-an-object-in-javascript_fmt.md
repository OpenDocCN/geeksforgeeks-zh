...
> 原文：[https://www.geeksforgeeks.org/how-to-deep-freeze-an-object-in-javascript/](https://www.geeksforgeeks.org/how-to-deep-freeze-an-object-in-javascript/)

在本文中，我们将看到 JavaScript 中的对象有什么问题，以及为什么我们需要在 JavaScript 中“深度冻结”一个对象。我们还将学习如何在 JavaScript 中“深度冻结”对象。

## JavaScript 中对象的问题

我们都知道 JavaScript 对象是可变的。我们如何让它们不可改变？将它们定义为常量，但是如果我们将一个 JavaScript 对象声明为常量，只会防止该对象作为一个整体被重新分配。我们仍然可以重新分配属性并更改它们的值。
