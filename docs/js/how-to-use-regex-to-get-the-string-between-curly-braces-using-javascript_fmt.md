...
> 原文：[https://www.geeksforgeeks.org/how-to-use-regex-to-get-the-string-between-curly-braces-using-javascript/](https://www.geeksforgeeks.org/how-to-use-regex-to-get-the-string-between-curly-braces-using-javascript/)
...
*   正则表达式从右侧选择字符串。它从最右边的花括号中查找开始的花括号，并将其打印为字符串。
