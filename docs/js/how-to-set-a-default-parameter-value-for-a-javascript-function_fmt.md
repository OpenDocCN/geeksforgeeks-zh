...
> 原文：[https://www.geeksforgeeks.org/how-to-set-a-default-parameter-value-for-a-javascript-function/](https://www.geeksforgeeks.org/how-to-set-a-default-parameter-value-for-a-javascript-function/)

让我们先来看看一个问题，然后我们再来看看函数参数的默认值是如何解决这个问题的。我们先创建一个简单的函数。
