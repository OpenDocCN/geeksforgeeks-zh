...
> 原文：[https://www.geeksforgeeks.org/how-to-create-a-function-that-invokes-each-provided-function-with-the-arguments-it-receives-using-javascript/](https://www.geeksforgeeks.org/how-to-create-a-function-that-invokes-each-provided-function-with-the-arguments-it-receives-using-javascript/)
...
`findEven` 和 `findOdd` 函数通过 `segregateEvenOdd` 函数获取相同的参数，并在 `segregateEvenOdd` 函数中调用。
...
`findMin` 和 `findMax` 函数采用与 `FindMinMax` 函数相同的参数，并在 `FindMinMax` 函数中调用。
