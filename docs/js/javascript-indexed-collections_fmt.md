...
> 原文：[https://www.geeksforgeeks.org/javascript-indexed-collections/](https://www.geeksforgeeks.org/javascript-indexed-collections/)
...
使用索引访问数组元素。数组的索引从零开始，这意味着元素的索引从零开始。
...
要获取数组的长度，请使用 `array_name.length` 属性。
...
我们可以使用各种数组方法来处理数组。这些是：

*   **[`push()` 方法](https://www.geeksforgeeks.org/javascript-array-prototype-push-function/)：** 此方法添加一个或多个元素到数组的末尾，并返回数组的新长度。
...
*   **[`concat()` 方法](https://www.geeksforgeeks.org/javascript-array-prototype-concat-function/)：** 此方法连接两个数组并返回一个新数组。
...
*   **[`join()` 方法](https://www.geeksforgeeks.org/javascript-array-join-method/)：** 此方法通过连接数组的所有元素创建一个字符串。
...
*   **[`sort()` 方法](https://www.geeksforgeeks.org/javascript-array-sort/)：** 此方法对数组的元素进行排序。
...
*   **[`indexOf()` 方法](https://www.geeksforgeeks.org/javascript-array-indexof/)：** 此方法在数组中搜索 `Element` 并返回 `element` 第一次出现的索引。
...
*   **[`shift()` 方法](https://www.geeksforgeeks.org/javascript-array-prototype-shift/)：** 此方法从数组中移除第一个元素并返回该元素。
...
*   **[`reverse()` 方法](https://www.geeksforgeeks.org/javascript-array-prototype-reverse/)：** 此方法反转数组，第一个数组元素成为最后一个，最后一个成为第一个。它以这种方式转置数组中的所有元素，并返回对数组的引用。
...
*   **[`map()` 方法](https://www.geeksforgeeks.org/javascript-array-map-method/)：** 此方法返回一个新数组，其中包含对每个数组项执行函数后返回的值。
...
*   **[`filter()` 方法](https://www.geeksforgeeks.org/javascript-array-filter/)：** 此方法返回一个新数组，包含函数返回 `true` 的项。
