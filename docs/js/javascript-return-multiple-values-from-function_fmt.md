...
> 原文：[https://www.geeksforgeeks.org/javascript-return-multiple-values-from-function/](https://www.geeksforgeeks.org/javascript-return-multiple-values-from-function/)

为了从一个函数返回多个值，我们不能直接返回它们。但是我们可以以数组和对象的形式返回它们。

**示例 1：** 本示例返回包含多个值的数组 `["GFG_1", "GFG_2"]`。
...
**例 2：** 本例返回对象 `return { Prop_1: "Value_1", Prop_2: "Value_2" };` 包含多个值。
