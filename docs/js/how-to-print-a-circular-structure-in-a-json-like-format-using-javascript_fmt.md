...
> 原文：[https://www.geeksforgeeks.org/how-to-print-a-circular-structure-in-a-json-like-format-using-javascript/](https://www.geeksforgeeks.org/how-to-print-a-circular-structure-in-a-json-like-format-using-javascript/)

`循环结构`是当你试图引用一个直接或间接引用自己的对象时。
...
开发应用程序时，`循环结构`非常常见。例如，假设您正在开发一个社交媒体应用程序，其中每个用户可能有一个或多个图像。每个图像都可能引用其所有者。大概是这样的：
...
在这里，您可以通过将用户 id 传递给`Owner`而不是用户对象来轻松解决这个问题。
