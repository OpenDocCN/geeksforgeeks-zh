...
> 原文: [https://www.geeksforgeeks.org/change-an-element-class-javascript/](https://www.geeksforgeeks.org/change-an-element-class-javascript/)
...
在此代码中，使用 `onclick` 事件将按钮的类别从“默认”更改为“更改类别”，这又将按钮的背景颜色从红色更改为绿色。
...
在这段代码中，使用 `onclick` 事件将按钮的类别从“默认”更改为“newclass1”和“newclass2”。
