...
> 原文：[https://www.geeksforgeeks.org/how-to-get-the-file-name-from-full-path-using-javascript/](https://www.geeksforgeeks.org/how-to-get-the-file-name-from-full-path-using-javascript/)
...
**示例 1：** 本示例使用 `replace()` 方法借助正则表达式获取文件名。
