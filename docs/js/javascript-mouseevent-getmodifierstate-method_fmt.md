...
> 原文: [https://www.geeksforgeeks.org/javascript-mouseevent-getmodifierstate-method/](https://www.geeksforgeeks.org/javascript-mouseevent-getmodifierstate-method/)
...
在本例中，如果 `CapsLock` 被激活，则显示 `true`，否则显示 `false`。要查看效果，请在打开/关闭 `CapsLock` 后单击输入元素。
