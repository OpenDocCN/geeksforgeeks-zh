...
> 原文：[https://www.geeksforgeeks.org/implement-enqueue-and-dequeue-using-only-two-stacks-in-javascript/](https://www.geeksforgeeks.org/implement-enqueue-and-dequeue-using-only-two-stacks-in-javascript/)
...
function dequeue() {
    ...
    if (stack2.length > 0) {
        console.log(
            "Element after dequeue : " + stack2.pop()
        );
    }
