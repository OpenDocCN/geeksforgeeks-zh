...
> 原文: [https://www.geeksforgeeks.org/how-to-remove-object-from-array-of-objects-using-javascript/](https://www.geeksforgeeks.org/how-to-remove-object-from-array-of-objects-using-javascript/)
...
*   对于每个对象，使用 `delete` 操作符从对象数组中删除特定的对象元素。
...
*   使用 `array.map()` 方法遍历数组中的每个对象。
*   对于每个对象，使用 `delete` 操作符从对象数组中删除特定对象。
