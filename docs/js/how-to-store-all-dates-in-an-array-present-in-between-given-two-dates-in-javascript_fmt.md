...
> 原文：[https://www.geeksforgeeks.org/how-to-store-all-dates-in-an-array-present-in-between-given-two-dates-in-javascript/](https://www.geeksforgeeks.org/how-to-store-all-dates-in-an-array-present-in-between-given-two-dates-in-javascript/)
...
以毫秒为单位计算 1 天当量，称为 `_1Day`。
设置一个等于开始日期的变量，称为毫秒。
在数组中以日期形式推送毫秒(`ms`)，并将其值增加 `_1Day`。
重复上述步骤，直到毫秒等于最后一个日期。
