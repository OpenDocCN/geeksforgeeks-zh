...
> 原文: [https://www.geeksforgeeks.org/infix-to-postfix-converter-using-javascript/](https://www.geeksforgeeks.org/infix-to-postfix-converter-using-javascript/)
...
*   按钮`Convert`调用函数`infixToPostfix()`，该函数使用 JavaScript 转换给定的中缀表达式。
*   显示后缀表达式。
...
以下代码为上述 HTML 代码中使用的 `infix.css` 文件的内容。
...
以下代码是上述 HTML 代码中使用的文件 `script.js` 的内容。
