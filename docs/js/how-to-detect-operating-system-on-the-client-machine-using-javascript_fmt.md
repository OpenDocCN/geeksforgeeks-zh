...
> 原文：[https://www.geeksforgeeks.org/how-to-detect-operating-system-on-the-client-machine-using-javascript/](https://www.geeksforgeeks.org/how-to-detect-operating-system-on-the-client-machine-using-javascript/)

要检测客户机上的操作系统，只需使用 `navigator.appVersion` 或 `navigator.userAgent` 属性。`navigator.appVersion` 属性是一个只读属性，它返回一个表示浏览器版本信息的字符串。
