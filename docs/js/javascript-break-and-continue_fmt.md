...
> 原文: [https://www.geeksforgeeks.org/javascript-break-and-continue/](https://www.geeksforgeeks.org/javascript-break-and-continue/)

## Break 语句

Break 语句用于跳出一个循环。它可以用来“跳出” `switch()` 语句。它中断循环，并在循环后继续执行代码。
...
Continue 语句在循环中“跳过”一次迭代。它中断循环中的迭代，并继续执行循环中的下一个迭代。
...
在 JavaScript 中，标签语句被写成带有标签名和冒号的语句。
