...
> 原文：[https://www.geeksforgeeks.org/nlp-how-tokenizing-text-sentence-words-works/](https://www.geeksforgeeks.org/nlp-how-tokenizing-text-sentence-words-works/)
...
## 代码#7：`WordPunctTokenizer`–它将标点符号与单词分开。
