# Python NLTK | `nltk.tokenize.word_tokenize()`

> 原文：[https://www.geeksforgeeks.org/python-nltk-nltk-tokenizer-word_tokenize/](https://www.geeksforgeeks.org/python-nltk-nltk-tokenizer-word_tokenize/)
