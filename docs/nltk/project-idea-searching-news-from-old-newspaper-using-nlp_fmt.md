# 项目构想——使用 NLP 从旧报纸上搜索新闻

> 原文：[https://www.geeksforgeeks.org/project-idea-searching-news-from-old-newspaper-using-nlp/](https://www.geeksforgeeks.org/project-idea-searching-news-from-old-newspaper-using-nlp/)
...
*   提取的文字将会被 `NLP` 的实践所清理，以简化和消除对我们没有帮助的词语（停止词语）。
