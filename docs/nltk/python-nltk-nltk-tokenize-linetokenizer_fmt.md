# NLTK | nltk.tokenize.LineTokenizer

> 原文: [https://www.geeksforgeeks.org/python-nltk-nltk-tokenize-linetokenizer/](https://www.geeksforgeeks.org/python-nltk-nltk-tokenize-linetokenizer/)
