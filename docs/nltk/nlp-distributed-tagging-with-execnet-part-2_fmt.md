...
> 原文: [https://www.geeksforgeeks.org/nlp-distributed-tagging-with-execnet-part-2/](https://www.geeksforgeeks.org/nlp-distributed-tagging-with-execnet-part-2/)
...
*   这类似于 `__name__ == '__main__'` 检查模块是否正在命令行上执行。
