...
> 原文: [https://www.geeksforgeeks.org/nlp-part-of-speech-tagged-word-corpus/](https://www.geeksforgeeks.org/nlp-part-of-speech-tagged-word-corpus/)

## 什么是词性标注？

这是一个将句子转换成形式的过程——单词列表、元组列表（其中每个元组都有一个形式`(单词, 标签)`）。标记是词性标记，表示该词是否是名词、形容词、动词等。
