...
> 原文: [https://www.geeksforgeeks.org/nlp-singularizing-plural-nouns-and-swapping-infinite-phrases/](https://www.geeksforgeeks.org/nlp-singularizing-plural-nouns-and-swapping-infinite-phrases/)
...
**代码#3: 我们来了解一下 `swap_infinitive_phrase()`类**
...
**代码#4: 我们来评估一下 `swap_infinitive_phrase`**
