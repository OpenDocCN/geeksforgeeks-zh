...
> 原文: [https://www.geeksforgeeks.org/understanding-semantic-analysis-nlp/](https://www.geeksforgeeks.org/understanding-semantic-analysis-nlp/)
...
同样，“摇滚”一词可能意味着“石头”或“一种音乐类型”——因此，该词的准确含义在很大程度上取决于其上下文和在文本中的用法。
...
*   在情感分析中，我们试图用文本传达的突出情感来标记文本。当分析客户评论以进行改进时，这是非常有益的。
*   在主题分类中，我们试图将我们的文本分类到一些预定义的类别中。例如: 确定一篇研究论文是物理、化学还是数学
*   在意图分类中，我们尝试确定一条短信背后的意图。例如: 确定客户服务部门收到的电子邮件是查询、投诉还是请求。
