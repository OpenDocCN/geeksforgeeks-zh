...
> 原文：[https://www.geeksforgeeks.org/nlp-trigramsntags-tnt-tagging/](https://www.geeksforgeeks.org/nlp-trigramsntags-tnt-tagging/)
...
*   如果这个标记已经被训练过了，你可以通过 `Trained = True`。
*   否则，它将调用 `unk.train(data)`，其数据与传递给 `train()` 方法的数据相同。
