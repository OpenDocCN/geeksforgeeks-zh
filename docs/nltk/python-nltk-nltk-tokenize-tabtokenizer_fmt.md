# NLTK | nltk.tokenize.TabTokenizer()

> 原文: [https://www.geeksforgeeks.org/python-nltk-nltk-tokenize-tabtokenizer/](https://www.geeksforgeeks.org/python-nltk-nltk-tokenize-tabtokenizer/)
