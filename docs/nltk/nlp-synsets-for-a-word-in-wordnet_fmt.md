...
> 原文: [https://www.geeksforgeeks.org/nlp-synsets-for-a-word-in-wordnet/](https://www.geeksforgeeks.org/nlp-synsets-for-a-word-in-wordnet/)
...
两者都是以类似于继承树的结构来组织的。这棵树可以一直追溯到词根的上位词。上位词提供了一种根据单词之间的相似性对单词进行分类和分组的方法。
