...
> 原文: [https://www.geeksforgeeks.org/python-gender-identification-by-name-using-nltk/](https://www.geeksforgeeks.org/python-gender-identification-by-name-using-nltk/)
...
如果一个**分类器**是基于包含每个输入的正确标签的训练语料库构建的，则称之为监督的。监督分类使用的**框架**如图所示。
...
*   直接通过文本 URL。[male.txt](https://media.geeksforgeeks.org/wp-content/uploads/male.txt) [female.txt](https://media.geeksforgeeks.org/wp-content/uploads/female.txt)
