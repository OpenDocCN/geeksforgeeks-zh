# NLTK `nltk.tokenize.mwe()` 方法

> 原文: [https://www.geeksforgeeks.org/python-nltk-nltk-tokenize-mwe/](https://www.geeksforgeeks.org/python-nltk-nltk-tokenize-mwe/)
...
> ['who_are_you', 'at', 'geeks', 'for', 'geeks']