# SVG `FESpotLightElement.pointsAtZ` 属性

> 原文：[https://www.geeksforgeeks.org/svg-fespotlightelement-pointsatz-property/](https://www.geeksforgeeks.org/svg-fespotlightelement-pointsatz-property/)

`SVG FESpotLightElement.pointsAtZ` 属性返回与 `feSpotLight` 元素的 `pointsAtZ` 属性对应的 `SVGAnimatedNumber` 对象。
...
**返回值：** 该属性返回 `feSpotLight` 元素的 `pointsAtZ` 属性对应的 `SVGAnimatedNumber` 对象。
