...
> 原文: [https://www.geeksforgeks.org/svg-lineargradientelement-y2-property/](https://www.geeksforgeks.org/svg-lineargradientelement-y2-property/)

`LinearGradientElement.y2` 属性返回一个对应于给定 `LinearGradient` 元素属性的 `SVGAnimatedLength` 对象。
...
### 返回值:
该属性返回 `SVGAnimatedLength` 对象，该对象可用于获取线性渐变元素的 `y2`。
