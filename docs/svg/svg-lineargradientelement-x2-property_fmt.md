...
> 原文: [https://www.geeksforgeeks.org/svg-lineargradientelement-x2-property/](https://www.geeksforgeeks.org/svg-lineargradientelement-x2-property/)

`LinearGradientElement.x2` 属性返回一个对应于给定 `LinearGradient` 元素属性的 `SVGAnimatedLength` 对象。
