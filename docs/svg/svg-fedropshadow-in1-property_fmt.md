...
> 原文: [https://www.geeksforgeeks.org/svg-fedropshadow-in1-property/](https://www.geeksforgeeks.org/svg-fedropshadow-in1-property/)

`SVG FEDropShadow.in1` 属性返回对应于 `feDropShadow` 元素的 `in1` 组件的 `SVGAnimatedString` 对象。
...
这个属性返回对应于 `feDropShadow` 元素的 `in1` 成分的 `SVGAnimatedString` 对象。
