...
> 原文: [https://www.geeksforgeeks.org/svg-fespecularlighting-surfacescale-property/](https://www.geeksforgeeks.org/svg-fespecularlighting-surfacescale-property/)

`FeSpecularLighting.surfaceScale` 属性返回对应于 `FeSpecularLighting` 元素的 `surfaceScale` 组件的 `SVGAnimatedNumber` 对象。
...
该属性返回对应于 `feSpecularLighting` 元素的 `surfaceScale` 组件的 `SVGAnimatedNumber` 对象。
