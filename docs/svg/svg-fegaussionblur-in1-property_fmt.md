# SVG feGaussianBlur.in1 属性

> 原文: [https://www.geeksforgeeks.org/svg-fegaussionblur-in1-property/](https://www.geeksforgeeks.org/svg-fegaussionblur-in1-property/)

`SVG feGaussianBlur.in1` 属性返回对应于 `feGaussianBlur` 元素的 `in1` 组件的 `SVGAnimatedString` 对象。
...
**返回值:**
该属性返回对应于 `feGaussianBlur` 元素的 `in1` 组件的 `SVGAnimatedString` 对象。
