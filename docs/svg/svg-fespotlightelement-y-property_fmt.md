...
> 原文: [https://www.geeksforgeeks.org/svg-fespotlightelement-y-property/](https://www.geeksforgeeks.org/svg-fespotlightelement-y-property/)

`FESpotLightElement.y` 属性返回与 `feSpotLight` 元素的 `y` 属性对应的 `SVGAnimatedNumber` 对象。
