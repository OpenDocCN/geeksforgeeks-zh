# SVG feGaussianBlur stdDeviationY 属性

> 原文: [https://www.geeksforgeeks.org/svg-fegaussionblur-stddeviationy-property/](https://www.geeksforgeeks.org/svg-fegaussionblur-stddeviationy-property/)

`feGaussianBlur.stdDeviationY` 属性返回与 `feGaussianBlur` 元素的 `stdDeviationY` 组件对应的 `SVGAnimatedNumber` 对象。
...
此属性返回对应于 `FEGaussionBlur.stdDeviationY` 元素的 `stdDeviationY` 组件的 `SVGAnimatedNumber` 对象。
...
<body> 
    <svg viewBox="0 0 1000 1000"> 
        ...
        <script type="text/javascript">
            ...
            console.log("stdDeviationY value is : ", g.stdDeviationY.baseVal)
        </script>
    </svg> 
</body>
