...
> 原文: [https://www.geeksforgeeks.org/svg-element-innerhtml-property/](https://www.geeksforgeeks.org/svg-element-innerhtml-property/)

## 属性介绍

`SVG Element.innerHTML` 属性返回给定元素的 `innerHTML`。
