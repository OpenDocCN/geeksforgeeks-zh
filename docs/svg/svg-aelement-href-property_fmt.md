...
## 返回值：
该属性返回 `SVGAnimatedLength` 对象，该对象可用于获取元素的 `href`。
...
## 参考：
[https://developer.mozilla.org/en-US/docs/Web/API/SVGAElement](https://developer.mozilla.org/en-US/docs/Web/API/SVGAElement)