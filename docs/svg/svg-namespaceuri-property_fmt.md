...
SVG `namespaceURI` 属性返回给定属性元素的 `namespaceURI`。
...
**参考:** [https://developer.mozilla.org/en-US/docs/Web/API/Attr/namespaceURI](https://developer.mozilla.org/en-US/docs/Web/API/Attr/namespaceURI)