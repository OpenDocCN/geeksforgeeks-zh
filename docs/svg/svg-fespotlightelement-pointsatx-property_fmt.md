...
> 原文: [https://www.geeksforgeeks.org/svg-fespotlightelement-pointsatx-property/](https://www.geeksforgeeks.org/svg-fespotlightelement-pointsatx-property/)

`SVG FESpotLightElement.pointsAtX` 属性返回与 `fespot lightelement . pointsAtX` 元素的 `point satx` 属性对应的 `SVGAnimatedNumber` 对象。
