...
> 原文：[https://www.geeksforgeeks.org/svg-specularlighting-specularexponent-property/](https://www.geeksforgeeks.org/svg-specularlighting-specularexponent-property/)
...
该属性返回对应于镜象照明.镜象组件元素的镜象组件组件的 `SVGAnimatedNumber` 对象。
...
<body>
    <svg height="200" width="200" viewBox="0 0 220 220">
        ...
        <script type="text/javascript">
            ...
            console.log("specularExponent value is : ", g.specularExponent.baseVal)
        </script>
    </svg>
</body>
</html>
...
<body>
    <svg height="200" width="200" viewBox="0 0 220 220">
        ...
        <circle cx="130" cy="130" r="50" style="fill: black; filter:url(#filter)" />
        <script type="text/javascript">
            var g = document.getElementById("gfg");
            console.log(g.specularExponent)
            console.log("specularExponent value is : ", g.specularExponent.baseVal)
