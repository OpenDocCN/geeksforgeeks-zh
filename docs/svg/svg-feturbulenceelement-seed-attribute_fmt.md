# SVG feTurbulence 元素的 seed 属性

> 原文：`https://www.geeksforgeeks.org/svg-feturbulenceelement-seed-attribute/`

**SVG feTurbulence 元素的 seed 属性**返回与 `feTurbulence` 元素的 `seed` 组件对应的 `SVGAnimatedNumber` 对象。
