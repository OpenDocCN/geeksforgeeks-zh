...
> 原文: [https://www.geeksforgeeks.org/svg-font-size-adjust-attribute/](https://www.geeksforgeeks.org/svg-font-size-adjust-attribute/)

`font-size-adjust`属性允许您设置元素的纵横比值，该值将设置给定替代字体中首选字体的 x 高度。该属性根据`font-family`调整字体大小 x 高度。
...
我们将使用`font-size-adjust`属性来调整字体的大小。
