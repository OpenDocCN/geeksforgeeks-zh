...
> 原文: [https://www.geeksforgeeks.org/svg-fedisplacementmap-in1-property/](https://www.geeksforgeeks.org/svg-fedisplacementmap-in1-property/)

`SVG` `<feDisplacementMap>` `in1` 属性返回对应于 `feDisplacementMap` 元素的 `in1` 组件中的 `SVGAnimatedString` 对象。
...
**返回值:**
该属性返回与 `in1` 属性对应的 `SVGAnimatedString` 对象。
