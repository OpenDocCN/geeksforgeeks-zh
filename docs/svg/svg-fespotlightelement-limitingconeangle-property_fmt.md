...
> 原文: [https://www.geeksforgeeks.org/svg-fespotlightelement-limitingconeangle-property/](https://www.geeksforgeeks.org/svg-fespotlightelement-limitingconeangle-property/)

`SVG feSpotLightElement.limitingConeAngle` 属性返回与 `feSpotLightElement` 元素的 `limitingConeAngle` 属性对应的 `SVGAnimatedNumber` 对象。
...
该属性返回对应于 `feSpotLightElement` 元素的 `limitingConeAngle` 属性的 `SVGAnimatedNumber` 对象。
