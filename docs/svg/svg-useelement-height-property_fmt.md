...
> 原文: [https://www.geeksforgeeks.org/svg-useelement-height-property/](https://www.geeksforgeeks.org/svg-useelement-height-property/)

`SVG UseElement.height` 属性返回一个对应于给定 `use` 元素属性的 `SVGAnimatedLength` 对象。
...
**返回值:**
该属性返回 `SVGAnimatedLength` 对象，该对象可用于获取所用元素的高度。
