...
> 原文: [https://www.geeksforgeeks.org/svg-fespecularlighting-specularconstant-property/](https://www.geeksforgeeks.org/svg-fespecularlighting-specularconstant-property/)

`feSpecularLighting.specularConstant` 属性返回对应于 `feSpecularLighting.specularConstant` 元素的镜面常量组件的 `SVGAnimatedNumber` 对象。
...
**返回值:** 该属性返回对应于 `feSpecularLighting.specularConstant` 元素的镜面常量组件的 `SVGAnimatedNumber` 对象。
