...
> 原文: [https://www.geeksforgeeks.org/svg-ellipseelement-rx-property/](https://www.geeksforgeeks.org/svg-ellipseelement-rx-property/)
...
这个属性返回一个`SVGAnimatedLength`对象，可以用来获取椭圆元素的`rx`。
