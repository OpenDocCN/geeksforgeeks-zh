...
> 原文: [https://www.geeksforgeeks.org/svg-fespotlightelement-z-property/](https://www.geeksforgeeks.org/svg-fespotlightelement-z-property/)

`FESpotLightElement.z` 属性返回与 `FESpotLightElement` 元素的 `z` 属性对应的 `SVGAnimatedNumber` 对象。
...
**返回值:** 该属性返回 `FESpotLightElement` 元素的 `z` 属性对应的 `SVGAnimatedNumber` 对象。
