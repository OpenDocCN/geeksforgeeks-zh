# jQuery `mouseover()` 方法详解

> 原文: [https://www.geeksforgeeks.org/jquery-mouseover-with-examples/](https://www.geeksforgeeks.org/jquery-mouseover-with-examples/)
...
该方法接受单参数函数，可选。此参数用于指定调用 `mouseover` 事件时要运行的函数。
