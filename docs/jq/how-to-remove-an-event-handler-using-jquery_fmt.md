...
> 原文: [https://www.geeksforgeeks.org/how-to-remove-an-event-handler-using-jquery/](https://www.geeksforgeeks.org/how-to-remove-an-event-handler-using-jquery/)

这里的任务是移除 jQuery/JavaScript 中的一个事件处理程序。下面讨论解决这个问题的三种方法:

## 使用 `unbind()` 方法

这是 jQuery 中的一种内置方法，用于移除任何选定的事件处理程序。
