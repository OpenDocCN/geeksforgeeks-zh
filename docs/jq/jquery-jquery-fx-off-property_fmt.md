...
> 原文: [https://www.geeksforgeeks.org/jquery-jquery-fx-off-property/](https://www.geeksforgeeks.org/jquery-jquery-fx-off-property/)
...
本示例使用 `jQuery.fx.off` 属性来禁用和启用动画。
