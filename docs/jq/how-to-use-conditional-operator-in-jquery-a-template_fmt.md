...
> 原文：[https://www.geeksforgeeks.org/how-to-use-conditional-operator-in-jquery-a-template/](https://www.geeksforgeeks.org/how-to-use-conditional-operator-in-jquery-a-template/)

在本文中，我们将学习在`jQuery`中使用三元或条件运算符。
...
现在让我们尝试一个示例，以了解在`jQuery`模板中如何使用条件运算符。
