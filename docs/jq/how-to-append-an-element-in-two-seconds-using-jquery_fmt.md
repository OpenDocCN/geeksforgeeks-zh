...
> 原文：[https://www.geeksforgeeks.org/how-to-append-an-element-in-two-seconds-using-jquery/](https://www.geeksforgeeks.org/how-to-append-an-element-in-two-seconds-using-jquery/)
...
1.  选择要追加元素的目标元素。
2.  使用 [`appendTo()`](https://www.geeksforgeeks.org/jquery-appendto-with-examples/) 或 [`append()`](https://www.geeksforgeeks.org/jquery-append-method/) 方法之一来追加元素。

## 示例 1

在本例中，`<div>` 元素使用 `append()` 方法被追加到 `<body>` 元素中。
...
在本示例中，使用 `appendTo()` 方法将 `<div>` 元素追加到 `<p>` 元素中。
