...
> 原文: [https://www.geeksforgeeks.org/how-to-copy-the-content-of-a-div-into-another-div-using-jquery/](https://www.geeksforgeeks.org/how-to-copy-the-content-of-a-div-into-another-div-using-jquery/) 将一个部门的内容复制到另一个部门
...
*   使用 [`append()`方法](https://www.geeksforgeeks.org/jquery-append-method/) 将元素复制为其子元素。
