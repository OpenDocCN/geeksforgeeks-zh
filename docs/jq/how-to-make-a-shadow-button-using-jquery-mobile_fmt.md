...
> 原文：[https://www.geeksforgeeks.org/how-to-make-a-shadow-button-using-jquery-mobile/](https://www.geeksforgeeks.org/how-to-make-a-shadow-button-using-jquery-mobile/)
...
<body>
    <center>
        <h1>GeeksforGeeks</h1>
        <h4>Shadowed Anchor using jQuery Mobile</h4>
    </center>
    <a href="#" class="ui-btn ui-shadow">Shadowed Anchor</a>
</body>
...
<body>
    ...
    <button class="ui-btn ui-shadow">Shadowed Button</button>
</body>
