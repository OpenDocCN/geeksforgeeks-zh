...
> 原文: [https://www.geeksforgeeks.org/password-strength-indicator-using-jquery/](https://www.geeksforgeeks.org/password-strength-indicator-using-jquery/)
...
应遵循的步骤:
*   在密码字段中，使用 `keyup()` 功能检查每次按键。
*   提取密码字段中添加的输入。
*   根据密码长度更新 `percentage` 变量和进度条颜色。
*   检查字符集约束。
