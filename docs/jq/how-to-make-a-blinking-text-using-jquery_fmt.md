...
> 原文：[https://www.geeksforgeeks.org/how-to-make-a-blinking-text-using-jquery/](https://www.geeksforgeeks.org/how-to-make-a-blinking-text-using-jquery/)
...
1.  从文档中选择特定元素。
2.  在特定时间段后，将其 `visibility` 属性从 `hidden` 切换到 `visible`，反之亦然。
...
1.  从文档中选择特定元素。
2.  在特定时间段后，将其 `opacity` 属性从 `0` 设置为 `1`，反之亦然。
