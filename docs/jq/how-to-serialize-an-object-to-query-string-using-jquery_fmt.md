...
> 原文: [https://www.geeksforgeeks.org/how-to-serialize-an-object-to-query-string-using-jquery/](https://www.geeksforgeeks.org/how-to-serialize-an-object-to-query-string-using-jquery/)
...
*   `convert()` 函数使用 `keys()` 和 `map()` 方法将序列化对象转换为查询字符串。
