...
> 原文: [https://www.geeksforgeeks.org/how-to-change-font-size-using-jquery/](https://www.geeksforgeeks.org/how-to-change-font-size-using-jquery/)
...
在下面的例子中，我们创建了一个包含一些文本的 `div` 元素，还创建了一个按钮元素。当用户点击按钮时，调用 `css()`方法，该方法将 `fontSize` 属性值设置为 `"32px"`。
