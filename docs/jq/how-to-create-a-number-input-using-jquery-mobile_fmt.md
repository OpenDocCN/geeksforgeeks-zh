...
> 原文：[https://www.geeksforgeeks.org/how-to-create-a-number-input-using-jquery-mobile/](https://www.geeksforgeeks.org/how-to-create-a-number-input-using-jquery-mobile/)

jQuery Mobile 是一种基于网络的技术，用于制作可在所有智能手机、平板电脑和台式机上访问的响应内容。在本文中，我们将使用 jQuery Mobile 创建一个数字输入区域。
...
我们将使用 jQuery Mobile 创建一个数字输入区域。我们使用 `type="number"` 属性只输入数字，使用 `data-clear-btn="true"` 属性清除输入文本。
