...
> 原文: [https://www.geeksforgeeks.org/how-to-add-options-to-a-select-element-using-jquery/](https://www.geeksforgeeks.org/how-to-add-options-to-a-select-element-using-jquery/) 向选择元素添加选项

可以使用 jQuery 中的 3 种方法向 `select` 元素添加一个选项:

## 方法 1: 将选项标签附加到选择框

要添加的选项是像普通的 HTML 字符串一样创建的。使用 jQuery 选择器选择选择框，并使用 [`append()` 方法](https://www.geeksforgeeks.org/jquery-append-method/) 添加该选项。`append()` 方法将指定的内容作为 jQuery 集合的最后一个子元素插入。因此，该选项被添加到选择元素中。
