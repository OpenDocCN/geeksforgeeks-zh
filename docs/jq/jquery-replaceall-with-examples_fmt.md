...
> 原文: [https://www.geeksforgeeks.org/jquery-replaceall-with-examples/](https://www.geeksforgeeks.org/jquery-replaceall-with-examples/)
...
*   `content`: 是指定要插入内容的必选参数。
*   `selector`: 是指定要替换的元素的必需参数。
