...
> 原文：[如何使用 jQuery 创建简单地图](https://www.geeksforgeeks.org/how-to-create-a-simple-map-using-jquery/)
...
创建一个函数来设置地图属性。可以通过创建函数来设置地图属性。我们必须使用位于谷歌的 JavaScript 库提供的谷歌地图应用编程接口的功能。
...
前往下述链接：[https://console.developers.google.com/flows/enableapi?apiid=maps_backend,geocoding_backend,directions_backend,distance_matrix_backend,elevation_backend,places_backend&reusekey=true](https://console.developers.google.com/flows/enableapi?apiid=maps_backend,geocoding_backend,directions_backend,distance_matrix_backend,elevation_backend,places_backend&reusekey=true)
...
输出：
![输出](img/773150a3ac515a64b544da4f02ae68df.png)
...
输出：
![输出](img/c28bbdef9dfc761f11fc587a8b6d445e.png)
...
输出：
![输出](img/c86979c52b9be2fb96ad450ea7b5247c.png)
...
输出：
![输出](img/4df682af89f43f2ffa3e5cec69f099b2.png)