...
> 原文：[https://www.geeksforgeeks.org/jquery-vertical-dot-navigation-plugin/](https://www.geeksforgeeks.org/jquery-vertical-dot-navigation-plugin/)
...
**下载链接**：`https://github.com/maiamachine/jquery-vertical-dot-navigation`

## 示例 1

在下面的示例中，`verticalDotNav()` 方法的非常基本的调用是使用 jQuery 显示的。HTML 页面的不同部分提供了不同的页面内容。
...
在以下示例中，`verticalDotNav()` 方法的各种选项设置如下。只需注意图像输出中的点对齐和滚动速度，并根据要求在代码中进行相应的定制。
