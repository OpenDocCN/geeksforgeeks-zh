# 如何使用 jQuery EasyUI 设计网页右键菜单？

> 原文: [https://www.geeksforgeeks.org/how-to-design-menu-on-right-click-of-webpage-using-jquery-easyui/](https://www.geeksforgeeks.org/how-to-design-menu-on-right-click-of-webpage-using-jquery-easyui/)
...
**示例 1:** 以下示例演示了在网页的右键上显示的简单菜单。脚本部分还显示了使用 `jQuery EasyUI` 框架的事件处理。
