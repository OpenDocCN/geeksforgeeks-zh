...
> 原文: [https://www.geeksforgeeks.org/how-to-make-an-element-flash-in-jquery/](https://www.geeksforgeeks.org/how-to-make-an-element-flash-in-jquery/)
...
## 方法 1: 使用 `fadeIn()` 和 `fadeOut()` 方法

在这种方法中，我们将在元素上设置连续的 `fadeIn()` 和 `fadeOut()` 方法，然后设置一个间隔，以确保闪烁无限期地继续。
...
<head>
    ...
    <title>How to make an element "flash" in jQuery?</title>
    <script src="https://code.jquery.com/jquery-3.4.1.min.js"
        integrity="sha256-CSXorXvZcTkaix6Yvo6HppcZGetbYMGWSFlBw8HfCJo="
        crossorigin="anonymous">
    </script>
...
## 方法二: 使用 `toggleClass()` 方法

我们将使用方法来更改不同设计的 CSS 类。因此，元素看起来会是闪光的。
