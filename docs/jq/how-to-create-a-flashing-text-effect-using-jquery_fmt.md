...
> 原文：[https://www.geeksforgeeks.org/how-to-create-a-flashing-text-effect-using-jquery/](https://www.geeksforgeeks.org/how-to-create-a-flashing-text-effect-using-jquery/)
...
**Fadein 效果：** 我们要在每个元素上使用 `CSS` 标记 [`display: none`](https://www.geeksforgeeks.org/css-display-property/) ，来展示 `fadeIn()` 方法的工作情况。
