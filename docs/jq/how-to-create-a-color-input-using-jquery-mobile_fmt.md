...
> 原文：[https://www.geeksforgeeks.org/how-to-create-a-color-input-using-jquery-mobile/](https://www.geeksforgeeks.org/how-to-create-a-color-input-using-jquery-mobile/)
...
我们将使用 `jQuery Mobile` 创建一个颜色输入区域。我们使用 `type="color"` 属性来设置输入区域的颜色。
