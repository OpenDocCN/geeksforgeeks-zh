...
> 原文: [https://www.geeksforgeeks.org/how-to-change-radio-button-state-programmatically-in-jquery/](https://www.geeksforgeeks.org/how-to-change-radio-button-state-programmatically-in-jquery/)
...
**注意:** `selector`是需要选择的单选按钮元素。

## 示例

让我们创建一个单选按钮组来选择最喜欢的板球运动员。我们创建了一个单选选项。默认情况下，将选择“Sachin”。当我们点击按钮时，将选择程序中给出的“Dhoni”选项。
