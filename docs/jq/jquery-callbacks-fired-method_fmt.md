...
> 原文: [https://www.geeksforgeeks.org/jquery-callbacks-fired-method/](https://www.geeksforgeeks.org/jquery-callbacks-fired-method/)

jQuery `callbacks.fired()`方法用于检查回调是否已经被调用过至少一次。此方法返回布尔值。
