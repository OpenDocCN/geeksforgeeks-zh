...
> 原文：[https://www.geeksforgeeks.org/how-to-change-the-position-of-the-colorbox-using-jquery/](https://www.geeksforgeeks.org/how-to-change-the-position-of-the-colorbox-using-jquery/)

`Colorbox` 是一个 `jQuery` 插件，它扩展了 `jQuery` 库以包含额外的功能。

方法：我们可以使用位置参数来更改 `jQuery` 中 `colorbox` 的位置，例如顶部、左侧、右侧、底部。
...
示例 3：以下示例演示了使用 `right: 0px` 向右移动颜色框。
