...
> 原文: [https://www.geeksforgeeks.org/jquery-get-content-and-attributes/](https://www.geeksforgeeks.org/jquery-get-content-and-attributes/)

## 获取内容

为了获取 DOM 对象的内容，有三种简单的方法，下面列出了 DOM 操作的 jQuery 方法:
