...
> 原文: [https://www.geeksforgeeks.org/how-to-upload-files-using-jquery-dropzone-plugin/](https://www.geeksforgeeks.org/how-to-upload-files-using-jquery-dropzone-plugin/)
...
## 示例:
下面的示例是使用 `Dropzone` 插件和代码所需的 `CDN` 库实现的。
...
## 结论:
在上面的例子中，我们可以一次拖动多个文档。我们可以只通过 `JavaScript` 代码来执行相同的操作，我们还可以对文件的大小和类型进行限制。