...
> 原文: [https://www.geeksforgeeks.org/how-to-click-anywhere-on-the-page-except-one-element-using-jquery/](https://www.geeksforgeeks.org/how-to-click-anywhere-on-the-page-except-one-element-using-jquery/)
...
*   否则，使用 `event.stopPropagation()` 方法停止事件的发生。
