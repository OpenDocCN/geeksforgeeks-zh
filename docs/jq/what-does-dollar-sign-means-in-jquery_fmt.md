...
> 原文: [https://www.geeksforgeeks.org/what-dollar-sign-means-in-jquery/](https://www.geeksforgeeks.org/what-dollar-sign-means-in-jquery/)
...
**示例 1:** 一个简单的插例显示 jQuery 和`$`具有相同的功能。
