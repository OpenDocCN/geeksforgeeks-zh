...
> 原文: [https://www.geeksforgeeks.org/how-to-design-combotree-using-jquery-easyui/](https://www.geeksforgeeks.org/how-to-design-combotree-using-jquery-easyui/)
...
以下示例演示了使用文件 `dataTree.json` 和 jQuery EasyUI 库的基本 combotree。
...
*   **执行前:** ![](img/b9d60bfb9128fac182cc4151f8d31005.png)
*   **执行后:** ![](img/3001a31f3435e720250ef0e3486acfcb.png)