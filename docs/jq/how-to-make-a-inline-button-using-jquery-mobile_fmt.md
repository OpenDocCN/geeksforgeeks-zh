...
> 原文：[https://www.geeksforgeeks.org/how-to-make-a-inline-button-using-jquery-mobile/](https://www.geeksforgeeks.org/how-to-make-a-inline-button-using-jquery-mobile/)
...
我们将使用带有 `class="ui-btn ui-btn-inline"` 的 `Button` 来制作按钮。
...
我们将使用带有 `class="ui-btn ui-btn-inline"` 的 `Anchor` 标记来实现我们的目的。
