...
> 原文: [https://www.geeksforgeeks.org/jquery-mobile-collapsibleset-widget-corners-option/](https://www.geeksforgeeks.org/jquery-mobile-collapsibleset-widget-corners-option/)

jQuery Mobile 是一种基于网络的技术，用于制作可在所有智能手机、平板电脑和台式机上访问的响应内容。在本文中，我们将使用 `collapsibleset` Widget 的 `corners` 选项来设置 `collapsibleset` 元素的边框半径。它接受布尔类型值，默认值为 `true`。
...
<body>
    <div data-role="page" id="page1">
        <div data-role="header">
            <h1>GeeksforGeeks</h1>
            <h3>jQuery Mobile Collapsibleset Widget corners Option</h3>
        </div>
...
![](img/5fa896f42d23eaf84ca5b4f2e71cea53.png)

## 参考

[https://api.jquerymobile.com/collapsibleset/#option-corners](https://api.jquerymobile.com/collapsibleset/#option-corners)