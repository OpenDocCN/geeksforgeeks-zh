...
**输出:**
![Simple Logo Distort Output](img/2d12ceb4fb8f810732e8451d3e5e018b.png)

## 示例 2

以下示例显示了 `logosDistort()` 方法的几个选项设置。程序员可以根据应用程序对视觉效果的要求来设置选项。
...
**输出:**
![Logos distort with option set](img/f1c718cffa24aa7b2c675ecfb3536318.png)

## 示例 3

以下示例显示了在同一页面中显示的多张具有 `logosDistort` 效果的卡片。
...
**输出:**
![multiple card output](img/c7fcd0e30850b72fc258c6f4b607b778.png)

## 示例 4

以下示例为用户显示固定登录屏幕的扭曲背景。
...
**输出:**
![logo distort with login screen](img/b75d966b9ebd8f854480335f152a5fce.png)