...
> 原文: [https://www.geeksforgeeks.org/jquery-event-pagex-property-with-examples/](https://www.geeksforgeeks.org/jquery-event-pagex-property-with-examples/)

`event.pageX` 是 jQuery 中的一个内置属性，用于查找鼠标指针**相对于文档左边缘**的位置。
