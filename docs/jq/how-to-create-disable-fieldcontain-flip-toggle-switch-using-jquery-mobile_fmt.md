# 如何使用 jQuery Mobile 创建禁用字段包含翻转开关？

> 原文：[https://www.geeksforgeeks.org/how-to-create-disable-fieldcontain-flip-toggle-switch-using-jquery-mobile/](https://www.geeksforgeeks.org/how-to-create-disable-fieldcontain-flip-toggle-switch-using-jquery-mobile/)
