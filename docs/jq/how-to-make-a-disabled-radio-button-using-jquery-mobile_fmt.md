...
> 原文: [https://www.geeksforgeeks.org/how-to-make-a-disabled-radio-button-using-jquery-mobile/](https://www.geeksforgeeks.org/how-to-make-a-disabled-radio-button-using-jquery-mobile/)
...
我们将使用 jQuery Mobile 创建一个禁用单选按钮。我们使用输入 `type="radio"` 属性创建单选按钮，并使用 `disabled="disabled"` 属性禁用单选按钮。
