...
> 原文:[https://www . geeksforgeeks . org/jquery-mobile-collapsibleset-widget-mini-option/](https://www.geeksforgeeks.org/jquery-mobile-collapsibleset-widget-mini-option/)

jQuery Mobile 是一种基于网络的技术，用于制作可在所有智能手机、平板电脑和台式机上访问的响应内容。
在本文中，我们将使用 jQuery Mobile collapsiblete Widget*mini*选项将元素的大小设置为更紧凑的迷你版本。它接受一个布尔值，默认值为 false。
...
            <h1>GeeksforGeeks</h1>
            <h3>jQuery Mobile Collapsibleset Widget mini Option</h3>
        </div>
...
![](img/08456c3b0088945ef25658257d19a3a5.png)

**参考:**[https://API . jquerymobile . com/collapsible et/# option-mini](https://api.jquerymobile.com/collapsibleset/#option-mini)