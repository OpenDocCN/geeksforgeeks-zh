...
> 原文：[https://www.geeksforgeeks.org/how-to-move-one-div-element-inside-another-using-jquery/](https://www.geeksforgeeks.org/how-to-move-one-div-element-inside-another-using-jquery/)
...
<html>
  ...
  <body>
    ...
    <div id="nonSelected">
      <div id="div1" onclick="move(this)" style="background-color: green">
        Inner division one
      </div>
      <div id="div2" onclick="move(this)" style="background-color: blue">
        Inner division two
      </div>
      <div id="div3" onclick="move(this)" style="background-color: red">
...
![从一个分区到另一个分区](img/699e0019547d15748d571200bc98fb57.png)