# jQuery | scrollLeft() 带示例

> 原文: [https://www.geeksforgeeks.org/jquery-scrollleft-with-examples/](https://www.geeksforgeeks.org/jquery-scrollleft-with-examples/)
...
该方法接受单参数 `position`，可选。它用于以像素为单位指定水平滚动条的位置。
