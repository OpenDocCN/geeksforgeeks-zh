...
> 原文：[https://www.geeksforgeeks.org/how-to-insert-a-jquery-object-after-all-paragraphs-using-jquery/](https://www.geeksforgeeks.org/how-to-insert-a-jquery-object-after-all-paragraphs-using-jquery/)

## 任务
使用 jQuery 在所有段落之后插入一个 jQuery 对象。

## 进场
- 使用标签创建 DOM 元素或 jQuery 对象。
- 使用 `<p>` 标签创建段落。
- 点击后使用 `<button>` 标签创建一个按钮，对象将被插入到段落之后。
