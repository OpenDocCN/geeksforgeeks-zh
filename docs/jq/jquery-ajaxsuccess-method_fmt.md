...
jQuery 中的 `ajaxSuccess()` 方法用于指定当 AJAX 请求成功完成时要运行的函数。
...
该方法接受单参数函数，为必选项。该函数接受三个参数，如下所述：
...
本示例通过从服务器获取数据来更改 `<p>` 元素的内容。当 AJAX 请求成功完成时，页面显示“AJAX 请求成功完成”。
...
本示例通过从服务器获取数据来更改 `<h1>` 元素的内容。当 AJAX 请求成功完成时，页面显示“AJAX 请求成功完成”。
