...
## jQuery 代码示例：展示 `keyup()` 方法的工作原理

### 代码 #1

下面的代码用于检查键盘按键在被按下后是否被释放。
