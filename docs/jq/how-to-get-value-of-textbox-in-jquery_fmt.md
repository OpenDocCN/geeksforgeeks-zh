...
> 原文: [https://www.geeksforgeeks.org/how-to-get-value-of-textbox-in-jquery/](https://www.geeksforgeeks.org/how-to-get-value-of-textbox-in-jquery/)
...
在本例中，我们将看到输入 `val()` 方法的使用。我们获取一个输入字段（键入文本）并为其附加一个输入事件监听器。当用户在文本框中键入任何字母或单词时，它将立即在输入字段的底部显示文本。
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('.textbox').on('input', function () {
                // Set the inner text of the span tag
