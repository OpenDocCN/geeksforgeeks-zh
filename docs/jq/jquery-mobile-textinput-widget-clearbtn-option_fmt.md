...
jQuery Mobile 是一种基于网络的技术，用于制作可在所有智能手机、平板电脑和台式机上访问的响应内容。在本文中，我们将使用 jQuery Mobile Textinput Widget `clearBtn` 选项在输入元素设置为 `true` 时向其添加一个清除按钮。
...
[https://api.jquerymobile.com/textinput/#option-clearBtn](https://api.jquerymobile.com/textinput/#option-clearBtn)