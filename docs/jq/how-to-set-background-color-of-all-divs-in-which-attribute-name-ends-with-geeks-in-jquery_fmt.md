...
> 原文: [https://www.geeksforgeeks.org/how-to-set-background-color-of-all-divs-in-which-attribute-name-ends-with-geeks-in-jquery/](https://www.geeksforgeeks.org/how-to-set-background-color-of-all-divs-in-which-attribute-name-ends-with-geeks-in-jquery/)

在本文中，我们将选择名称属性值以“极客”结尾的所有 HTML [`div`](https://www.geeksforgeeks.org/div-tag-html/) ，并使用 CSS 背景属性将[背景颜色](https://www.geeksforgeeks.org/css-background-color-property/)设置为绿色。
...
**示例 1:** 本示例有三个 `div` 标签。其中两个名字属性的值以“极客”结尾，第三个是普通的 `div`。当我们点击按钮时，前两个 div 的背景颜色将设置为绿色。
