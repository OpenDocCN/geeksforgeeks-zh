...
> 原文：[https://www.geeksforgeeks.org/how-to-make-a-value-text-input-using-jquery-mobile/](https://www.geeksforgeeks.org/how-to-make-a-value-text-input-using-jquery-mobile/)
...
我们将使用 jQuery Mobile 创建一个值/文本输入区域。
