...
> 原文: [https://www.geeksforgeeks.org/how-to-animate-jquery-addclass-removeclass-functions/](https://www.geeksforgeeks.org/how-to-animate-jquery-addclass-removeclass-functions/)

在本文中，我们将学习使用 jQuery `addClass()` 和 `removeClass()` 函数制作动画。

我们将使用 jQuery 和 jQuery UI。jQuery UI（用户界面）是免费的开源软件，构建在核心强大的 jQuery 库之上。如果要使用 jQuery UI，也必须包含 jQuery。jQuery UI 提供了更多功能，如添加类、颜色动画和缓动等。
