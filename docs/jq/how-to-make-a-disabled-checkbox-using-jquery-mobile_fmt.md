...
> 原文：[https://www.geeksforgeeks.org/how-to-make-a-disabled-checkbox-using-jquery-mobile/](https://www.geeksforgeeks.org/how-to-make-a-disabled-checkbox-using-jquery-mobile/)
...
我们将使用 jQuery Mobile 创建一个禁用的复选框。我们使用 `input type="checkbox"` 属性创建复选框，并使用 `disabled="disabled"` 属性禁用复选框。
