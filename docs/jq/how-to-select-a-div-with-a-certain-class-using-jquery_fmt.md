...
<body>
    ...
    <script>
        ...
        function GFG_Fun() {
            ...
            $('.div:not(.first)').css("background-color", "#173F5F");
            $('#geeks').text("DIV Box of class 'first' is not selected.");
        }
    </script>
</body>
...
**方法二:**首先使用 `jQuery Selector` 选择某个类的 DIV，然后使用 `.not()` 方法忽略特定类的元素。
...
<body>
    ...
    <script>
        ...
        function GFG_Fun() {
            ...
            $('.div').not('.first').css("background-color", "#173F5F");
            $('#GFG_DOWN').text("DIV Box of class 'first' is not selected.");
        }
    </script>
</body>
