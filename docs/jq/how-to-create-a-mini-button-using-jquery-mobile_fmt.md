...
> 原文: [https://www.geeksforgeeks.org/how-to-create-a-mini-button-using-jquery-mobile/](https://www.geeksforgeeks.org/how-to-create-a-mini-button-using-jquery-mobile/)
...
我们将使用带有 `class="ui-btn ui-mini"` 的锚点标签来制作按钮。
...
我们将使用带有 `class="ui-btn ui-mini"` 的按钮标签。
