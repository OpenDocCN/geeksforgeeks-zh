...
> 原文: [https://www.geeksforgeeks.org/how-to-submit-a-form-using-ajax-in-jquery/](https://www.geeksforgeeks.org/how-to-submit-a-form-using-ajax-in-jquery/)
...
<head>
    ...
    <script>
        // When DOM is loaded this function will get executed
        $(() => {
