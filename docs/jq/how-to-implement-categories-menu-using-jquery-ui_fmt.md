...
> 原文：[https://www.geeksforgeeks.org/how-to-implement-categories-menu-using-jquery-ui/](https://www.geeksforgeeks.org/how-to-implement-categories-menu-using-jquery-ui/)
...
在本例中，我们创建了两个列表，一个用于编程语言类别，另一个是库。在这里，我们对不同类别的标题都应用了这种方法。
