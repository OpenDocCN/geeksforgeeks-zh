...
> 原文：[https://www.geeksforgeeks.org/how-to-make-a-themed-radio-button-using-jquery-mobile/](https://www.geeksforgeeks.org/how-to-make-a-themed-radio-button-using-jquery-mobile/)
...
我们将使用 jQuery Mobile 创建一个主题单选按钮。我们使用 `input type="radio"` 属性创建单选按钮，并使用 `data-theme="b"` 属性创建主题单选按钮。
