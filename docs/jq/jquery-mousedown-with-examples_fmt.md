...
> 原文: [https://www.geeksforgeeks.org/jquery-mousedown-with-examples/](https://www.geeksforgeeks.org/jquery-mousedown-with-examples/)
...
## 参数:
该功能接受单参数`function`，可选。它用于指定调用`mousedown`事件时要运行的函数。
...
## 输出:
之前点击段落元素:
![](img/b0ceb0e7a8d387a9aef1cbaf87edb037.png)
