...
> 原文: [https://www.geeksforgeeks.org/jquery-removedata-with-examples/](https://www.geeksforgeeks.org/jquery-removedata-with-examples/)

`removeData()` 是 jQuery 中的一个内置方法，用于移除之前用 `Data()` 方法设置的那些数据。
...
## 参数:
它接受一个可选参数 `args`，该参数指定要为所选元素移除的数据的名称。
...
### 输出:
附加数据后-
![](img/701af20c9a21498db817d51b7079ce56.png)
移除数据后-
