...
> 原文：[如何使用 jQuery Mobile 制作网址输入](https://www.geeksforgeeks.org/how-to-make-an-url-input-using-jquery-mobile/)
...
我们将使用 jQuery Mobile 创建一个 URL 输入区域。我们使用 `type="url"` 属性来设置 url。
