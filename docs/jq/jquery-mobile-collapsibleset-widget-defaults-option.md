...
> 原文:[https://www . geesforgeks . org/jquery-mobile-collapsibleset-widget-defaults-option/](https://www.geeksforgeeks.org/jquery-mobile-collapsibleset-widget-defaults-option/)

jQuery Mobile 是一种基于网络的技术，用于制作可在所有智能手机、平板电脑和台式机上访问的响应内容。在本文中，我们将使用带有真值的 jQuery Mobile Collapsibleset 小部件默认值选项来设置具有默认值的其他小部件选项，并使小部件自动增强代码省略从数据属性中检索选项值的步骤。它接受布尔类型值，默认值为 false。
...
            <h1>GeeksforGeeks</h1>
            <h3>jQuery Mobile Collapsibleset Widget defaults Option</h3>
        </div>
...
![](img/a1eff8ee4f6de9b72220d44c709930e1.png)

**参考:**[https://API . jquerymobile . com/collapsibleset/# option-defaults](https://api.jquerymobile.com/collapsibleset/#option-defaults)