...
> 原文: [https://www.geeksforgeeks.org/how-to-load-local-jquery-file-in-case-cdn-is-not-available/](https://www.geeksforgeeks.org/how-to-load-local-jquery-file-in-case-cdn-is-not-available/)
...
### 示例:
在本例中，我们将只在脚本标签中包含 CDN 行，如果您单击提交按钮，您将在浏览器中看到您的姓名显示为提醒。
...
### 示例:
在本例中，我们将下载库文件 `jquery.min.js`，如果您单击提交按钮，您将在浏览器中看到您的名字作为警报出现。
