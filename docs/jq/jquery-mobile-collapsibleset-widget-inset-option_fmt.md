...
> 原文: [https://www.geeksforgeeks.org/jquery-mobile-collapsibleset-widget-inset-option/](https://www.geeksforgeeks.org/jquery-mobile-collapsibleset-widget-inset-option/)

jQuery Mobile 是一种基于网络的技术，用于制作可在所有智能手机、平板电脑和台式机上访问的响应内容。
在本文中，我们将使用 jQuery Mobile `collapsibleset` Widget 的 `inset` 选项将其值设置为 `false`，这意味着 `collapsibleset` 将获得没有角的全幅外观。接受布尔类型值，默认值为 `true`。
...
[https://api.jquerymobile.com/collapsibleset/#option-inset](https://api.jquerymobile.com/collapsibleset/#option-inset)