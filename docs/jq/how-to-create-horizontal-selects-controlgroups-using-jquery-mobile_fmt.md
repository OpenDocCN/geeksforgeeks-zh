# 如何使用 jQuery Mobile 创建水平选择控件组？

> 原文: [https://www.geeksforgeeks.org/how-to-create-horizontal-selects-controlgroups-using-jquery-mobile/](https://www.geeksforgeeks.org/how-to-create-horizontal-selects-controlgroups-using-jquery-mobile/)
