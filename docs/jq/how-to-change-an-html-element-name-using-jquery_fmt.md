...
> 原文：[https://www.geeksforgeeks.org/how-to-change-an-html-element-name-using-jquery/](https://www.geeksforgeeks.org/how-to-change-an-html-element-name-using-jquery/)

给定一个 HTML 文档，任务是用另一个元素替换一个 HTML 元素。例如：我们可以用 `<h1>` 元素改变一个 `<b>` 元素，而不改变任何其他属性。
