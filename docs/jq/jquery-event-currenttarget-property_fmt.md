...
> 原文: [https://www.geeksforgeeks.org/jquery-event-currenttarget-property/](https://www.geeksforgeeks.org/jquery-event-currenttarget-property/)

jQuery 中的 `event.currentTarget` 属性用于在事件冒泡阶段内返回当前 DOM 元素。
事件电流目标通常等于 `this`。
