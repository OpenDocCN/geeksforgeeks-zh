...
jQuery Mobile 是一种基于网络的技术，用于制作可在所有智能手机、平板电脑和台式机上访问的响应内容。在本文中，我们将使用 jQuery Mobile collapsiblete Widget 边角选项来设置 collapsiblete 元素的边框半径。它接受布尔类型值，默认值为真。
...
**参考:**T2】https://api.jquerymobile.com/collapsibleset/#option-corners