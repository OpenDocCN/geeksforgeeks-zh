...
> 原文: [https://www.geeksforgeeks.org/how-to-find-which-dom-element-has-the-focus-using-jquery/](https://www.geeksforgeeks.org/how-to-find-which-dom-element-has-the-focus-using-jquery/) 查找哪个 DOM 元素具有焦点

超文本标记语言 DOM 有一个 `activeElement` 属性。它可用于获取文档中当前聚焦的元素：
...
<html>
  ...
  <body>
    <p> Click wherever you like. The active/focused DOM name will be displayed at the end</p>
...
`<script>` 内部主体标签将 id 为 `fun` 的 DOM 元素的 HTML Content 修改为当前活动或焦点所在的 DOM 元素的名称。这是由 `document.activeElement.tagName` 完成的。
