...
> 原文：[https://www.geeksforgeeks.org/how-to-create-animations-using-relative-value-in-jquery/](https://www.geeksforgeeks.org/how-to-create-animations-using-relative-value-in-jquery/)

使用 jQuery 的 [`animate()`](https://www.geeksforgeeks.org/jquery-animate-with-examples/) 方法，我们可以给元素添加不同的 CSS 动画。这是用于在 jQuery 中操作 HTML 元素和添加动画功能的强大方法之一。动画效果是在我们改变 `animate()` 方法中的 CSS 样式时创建的。
