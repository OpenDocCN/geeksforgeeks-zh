...
> 原文: [https://www.geeksforgeeks.org/explain-the-concept-of-fade-effect-in-jquery/](https://www.geeksforgeeks.org/explain-the-concept-of-fade-effect-in-jquery/)
...
<!-- Image added using img tag with src attribute -->
    <img src="https://media.geeksforgeeks.org/wp-content/cdn-uploads/20210728124621/geekslogo.png"
...
**示例 2:** 下面的代码显示了 jQuery 中的 `fadeTo()` 方法，该方法用于更改所选元素的不透明度。
