...
> 原文：[https://www.geeksforgeeks.org/how-to-create-a-text-input-using-jquery-mobile/](https://www.geeksforgeeks.org/how-to-create-a-text-input-using-jquery-mobile/)
...
在本例中，我们将使用 jQuery Mobile 创建一个文本输入区域。`data-clear-btn` 属性设置为 `"true"`，增加一个清除输入区文本的按钮。
