...
**:radio 选择器**用于选择类型为 radio 的所有元素。`$(":radio")` 和 `$("[type=radio]")` 的工作原理相同。
...
## 方法-1: `$("input[type=radio]")`

这种选择方法选择类型为 radio 的所有输入元素。页面的每个无线电元素。
...
## 方法-3: `$("input[type=radio][name=group-1]")`
...
**控制台:**
![](img/aa06c668499e171fca919ec7c61f4927.png)
