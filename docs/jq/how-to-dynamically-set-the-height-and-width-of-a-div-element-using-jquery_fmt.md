...
> 原文: [https://www.geeksforgeeks.org/how-to-dynamically-set-the-height-and-width-of-a-div-element-using-jquery/](https://www.geeksforgeeks.org/how-to-dynamically-set-the-height-and-width-of-a-div-element-using-jquery/)
...
*   **使用 [`height()` 方法](https://www.geeksforgeeks.org/jquery-height-and-innerheight-with-examples/)**
*   **使用 [`innerHeight()` 方法](https://www.geeksforgeeks.org/jquery-height-and-innerheight-with-examples/)**
*   **使用 [`outerHeight()` 方法](https://www.geeksforgeeks.org/jquery-outerheight-method/)**

### 示例 1: 使用 `height()` 方法

div 内容高度将更改元素内容的高度，不包括元素的填充、边框和边距。
...
### 示例 2: 使用 `innerHeight()` 方法

对 div 的内容高度进行修改将会改变元素内容的高度，包括元素的填充。
...
### 示例 3: 使用 `outerHeight()` 方法

对 div 的内容高度进行更改将会改变元素内容的高度，包括元素的填充和边框。
...
div 内容宽度将更改元素内容的宽度，不包括元素的填充、边框和边距。
...
## 示例 2：使用 `innerWidth()` 方法对 div 的内容宽度进行更改，包括元素的填充。
...
## 示例 3：使用 `outerWidth()` 方法对 div 的内容宽度进行更改将会改变元素内容的宽度，包括元素的填充和边框。
