...
> 原文: [https://www.geeksforgeeks.org/jquery-not-method-with-examples/](https://www.geeksforgeeks.org/jquery-not-method-with-examples/)
...
它接受一个参数“A”，这个参数或者是指定元素的“id”或者是“class”。
