# jQuery Mobile 滚动停止事件

> 原文: [https://www.geeksforgeeks.org/jquery-mobile-scrollstop-event/](https://www.geeksforgeeks.org/jquery-mobile-scrollstop-event/)

`jQuery Mobile` `滚动`完成时触发`scrollstop`事件。我们可以将这个事件用于不同的目的。
