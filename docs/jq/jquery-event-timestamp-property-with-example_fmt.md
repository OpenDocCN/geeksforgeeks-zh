...
> 原文: [https://www.geeksforgeeks.org/jquery-event-timestamp-property-with-example/](https://www.geeksforgeeks.org/jquery-event-timestamp-property-with-example/)

`event.timeStamp` 是 jQuery 中的一个内置属性，用于测量浏览器创建的事件时间和 1970 年 1 月 1 日之间的毫秒差。
