...
> 原文: [https://www.geeksforgeeks.org/how-to-get-the-input-file-size-in-jquery/](https://www.geeksforgeeks.org/how-to-get-the-input-file-size-in-jquery/)
...
本示例向 `input[type=file]` 元素添加一个事件，当用户上传文件时，文件的大小会打印在屏幕上。
...
本示例向 `input[type=file]` 元素添加一个事件，当用户上传文件时，文件的大小会打印在屏幕上。这个例子允许用户上传小于 2MB 的文件。
