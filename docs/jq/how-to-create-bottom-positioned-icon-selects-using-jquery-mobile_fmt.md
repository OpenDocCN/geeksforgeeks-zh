# 如何使用 jQuery Mobile 创建底部定位图标选择？

> 原文：[`https://www.geeksforgeeks.org/how-to-create-bottom-positioned-icon-selects-using-jquery-mobile/`](https://www.geeksforgeeks.org/how-to-create-bottom-positioned-icon-selects-using-jquery-mobile/)
