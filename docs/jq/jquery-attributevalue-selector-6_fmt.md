...
> 原文: [https://www.geeksforgeeks.org/jquery-attribute-value-selector-6/](https://www.geeksforgeeks.org/jquery-attribute-value-selector-6/)
...
本示例使用 `[attribute^=value]` 选择器选择类名以 `top` 开头的元素。
