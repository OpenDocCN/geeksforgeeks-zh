...
> 原文：[https://www.geeksforgeeks.org/how-to-make-a-icon-position-radio-button-using-using-jquery-mobile/](https://www.geeksforgeeks.org/how-to-make-a-icon-position-radio-button-using-using-jquery-mobile/)
...
我们将使用 jQuery Mobile 创建一个图标位置单选按钮。我们使用 `input type="radio"` 属性创建单选按钮，并使用 `data-iconpos="right"` 属性定位图标单选按钮。
