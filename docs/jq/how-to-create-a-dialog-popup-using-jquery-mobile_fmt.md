...
> 原文：[https://www.geeksforgeeks.org/how-to-create-a-dialog-popup-using-jquery-mobile/](https://www.geeksforgeeks.org/how-to-create-a-dialog-popup-using-jquery-mobile/)
...
### 示例
我们将创建一个可以放入弹出窗口的对话框。我们将添加 `data-dismissible="false"` 属性，以防止用户在对话框外单击时弹出关闭。
