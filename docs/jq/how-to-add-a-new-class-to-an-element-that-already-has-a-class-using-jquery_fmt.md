...
> 原文：[https://www.geeksforgeeks.org/how-to-add-a-new-class-to-an-element-that-already-has-a-class-using-jquery/](https://www.geeksforgeeks.org/how-to-add-a-new-class-to-an-element-that-already-has-a-class-using-jquery/) 将新类添加到已经有类的元素中
