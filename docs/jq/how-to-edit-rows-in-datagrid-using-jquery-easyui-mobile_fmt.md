...
> 原文：[https://www.geeksforgeeks.org/how-to-edit-rows-in-datagrid-using-jquery-easyui-mobile/](https://www.geeksforgeeks.org/how-to-edit-rows-in-datagrid-using-jquery-easyui-mobile/)

[EasyUI](https://www.jeasyui.com/index.php) 是一个 HTML5 框架，用于使用基于 jQuery、React、Angular 和 Vue 技术的用户界面组件。它有助于构建交互式 web 和移动应用程序的功能，为开发人员节省了大量时间。

在本文中，我们将学习使用 jQuery EasyUI Mobile 插件编辑数据网格的行。
...
## 示例 1
以下示例演示了使用 jQuery EasyUI Mobile 的基本数据网格。
