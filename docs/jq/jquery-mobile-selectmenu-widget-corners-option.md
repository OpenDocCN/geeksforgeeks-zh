# jQuery Mobile 精选菜单小部件角选项

> 哎哎哎:# t0]https://www . geeksforgeeks . org/jquery-mobile-selectmenu widget-corners 选项/

jQuery Mobile 是一种基于网络的技术，用于制作可在所有智能手机、平板电脑和台式机上访问的响应内容。
在本文中，我们将使用 jQuery Mobile selectmenu Widget 边角选项来设置的*边框半径和 *selectmenu* 选项。它接受布尔类型值，默认值为 *true。**
...
当*拐角*选项设置为*真时，*我们得到如下输出，通过该输出您可以很好地注意到拐角的差异。
...
**参考:**[https://API . jquerymobile . com/select menu/# option-corners](https://api.jquerymobile.com/selectmenu/#option-corners)