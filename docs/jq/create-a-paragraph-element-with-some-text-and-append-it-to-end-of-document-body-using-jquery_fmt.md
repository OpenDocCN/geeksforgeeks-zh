# 使用一些文本创建一个段落元素，并使用 jQuery 将其附加到文档正文的末尾

> 原文: [https://www.geeksforgeeks.org/create-a-paragraph-element-with-some-text-and-append-it-to-end-of-document-body-using-jquery/](https://www.geeksforgeeks.org/create-a-paragraph-element-with-some-text-and-append-it-to-end-of-document-body-using-jquery/)
