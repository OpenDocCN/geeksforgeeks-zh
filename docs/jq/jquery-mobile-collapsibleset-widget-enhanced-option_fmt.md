# jQuery Mobile 可折叠集合小部件增强选项

> 原文：[https://www.geeksforgeeks.org/jquery-mobile-collapsibleset-widget-enhanced-option/](https://www.geeksforgeeks.org/jquery-mobile-collapsibleset-widget-enhanced-option/)

jQuery Mobile 是一种基于网络的技术，用于制作可在所有智能手机、平板电脑和台式机上访问的响应内容。
在本文中，我们将使用 jQuery Mobile Collapsibleset 小部件的 `enhanced` 选项来设置作为原始标记的一部分提供的 collapsibleset 小部件所需的标记。它接受布尔类型值，默认值为 `false`。
...
<body>
    <div data-role="page" id="page1">
        <div data-role="header">
            <h1>GeeksforGeeks</h1>
            <h3>jQuery Mobile Collapsibleset Widget enhanced Option</h3>
        </div>
...
![](img/8cbbc4170905999458c71cac2df6a39f.png)

**参考：** [https://api.jquerymobile.com/collapsibleset/#option-enhanced](https://api.jquerymobile.com/collapsibleset/#option-enhanced)