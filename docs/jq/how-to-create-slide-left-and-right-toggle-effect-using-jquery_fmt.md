...
> 原文：[https://www.geeksforgeeks.org/how-to-create-slide-left-and-right-toggle-effect-using-jquery/](https://www.geeksforgeeks.org/how-to-create-slide-left-and-right-toggle-effect-using-jquery/)

这里的任务是在 JQuery 中创建一个左右滑动的切换效果，可以使用 [jQuery animate()方法。](https://www.geeksforgeeks.org/jquery-animate-with-examples/)

## `.animate()`方法

用于改变 CSS 属性，为所选元素创建动画效果。
