...
> 原文: [https://www.geeksforgeeks.org/jquery-mobile-collapsibleset-widget-iconpos-option/](https://www.geeksforgeeks.org/jquery-mobile-collapsibleset-widget-iconpos-option/)

jQuery Mobile 是一种基于网络的技术，用于制作可在所有智能手机、平板电脑和台式机上访问的响应内容。
在本文中，我们将使用 jQuery Mobile `collapsibleset` Widget 的 `iconpos` 选项来设置图标在可折叠标题中的位置。`iconpos` 的可能值为 `left`、`right`、`top`、`bottom`、`none`、`notext`。接受字符串类型值，默认值为 `left`。
...
**参考:** [https://api.jquerymobile.com/collapsibleset/#option-iconpos](https://api.jquerymobile.com/collapsibleset/#option-iconpos)