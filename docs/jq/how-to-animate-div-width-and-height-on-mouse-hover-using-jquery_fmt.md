...
> 原文：[https://www.geeksforgeeks.org/how-to-animate-div-width-and-height-on-mouse-hover-using-jquery/](https://www.geeksforgeeks.org/how-to-animate-div-width-and-height-on-mouse-hover-using-jquery/)
...
*   `.animate()`方法：`animate()`方法用 CSS 样式改变元素的状态。
    **语法：**
...
*   `.mouseenter()`方法：当鼠标指针移动到所选元素上时，`mouseenter()`方法工作。
    **语法：**
...
*   `.mouseleave()`方法：当鼠标指针离开所选元素时，`mouseleave()`方法工作。
    **语法：**
...
*   当鼠标指针事件被处理时，使用 `.mouseenter()` 和 `.mouseleave()` 方法。
