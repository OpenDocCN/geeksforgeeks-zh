...
> 原文: [https://www.geeksforgeeks.org/jquery-add-elements-with-examples/](https://www.geeksforgeeks.org/jquery-add-elements-with-examples/)
...
jQuery 中的 `append()` 方法用于在所选元素的末尾添加新元素。
...
jQuery 中的 `prepend()` 方法用于在所选元素的开头添加新元素。
...
jQuery 中的 `after()` 方法用于在所选元素后插入内容。
...
jQuery 中的 `before()` 方法用于在所选元素前插入内容。
