...
> 原文：[https://www.geeksforgeeks.org/how-to-enable-disable-all-input-controls-inside-a-form-element-using-jquery/](https://www.geeksforgeeks.org/how-to-enable-disable-all-input-controls-inside-a-form-element-using-jquery/)

给出一个包含表单元素的 HTML 文档。表单元素包含输入元素、选项元素和按钮元素。使用 jQuery 启用或禁用窗体内所有输入控件的任务。可以使用 `prop()` 方法来完成。
