...
在本文中，我们将使用 jQuery Mobile `collapsibleset` Widget 的 `mini` 选项将元素的大小设置为更紧凑的迷你版本。它接受一个布尔值，默认值为 `false`。
...
[https://api.jquerymobile.com/collapsibleset/#option-mini](https://api.jquerymobile.com/collapsibleset/#option-mini)