...
> 原文：[https://www.geeksforgeeks.org/how-to-append-a-jquery-object-to-all-paragraphs-using-jquery/](https://www.geeksforgeeks.org/how-to-append-a-jquery-object-to-all-paragraphs-using-jquery/)
...
*   [`append()` 方法](https://www.geeksforgeeks.org/jquery-append-method/)：此方法用于在所选元素的末尾插入指定内容。

## 进场

*   创建带有段落 [`<p>`](https://www.geeksforgeeks.org/html-paragraph/) 元素的 HTML 页面。
