...
> 原文：[https://www.geeksforgeeks.org/how-to-find-all-inputs-that-are-descendants-of-a-form-and-mark-them-with-a-dotted-red-border-in-jquery/](https://www.geeksforgeeks.org/how-to-find-all-inputs-that-are-descendants-of-a-form-and-mark-them-with-a-dotted-red-border-in-jquery/)

任务是找到作为表单后代（子代或孙代）的所有输入，并使用 jQuery 用红色虚线框标记它们。

## 使用的方法和选择器

1.  [parent descendant selector](https://www.geeksforgeeks.org/jquery-parent-descendant-selector/)：此选择器用于选择指定元素的所有后代元素。
