...
> 原文：[https://www.geeksforgeeks.org/how-to-hide-the-checkbox-based-on-value-in-jquery/](https://www.geeksforgeeks.org/how-to-hide-the-checkbox-based-on-value-in-jquery/)
...
下面的示例说明了该方法。它使用功能`click()`返回分配给表格框或栏的复选框的值。每当复选框被选中或取消选中时，它会将相应的返回值分配到表框中。
