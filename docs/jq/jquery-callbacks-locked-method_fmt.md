...
> 原文：[https://www.geeksforgeeks.org/jquery-callbacks-locked-method/](https://www.geeksforgeeks.org/jquery-callbacks-locked-method/)

jQuery 中的 `Callbacks.locked()` 方法用于回答回调列表是否被锁定。
