...
> 原文：[https://www.geeksforgeeks.org/how-to-get-selected-option-from-dropdown-in-jquery/](https://www.geeksforgeeks.org/how-to-get-selected-option-from-dropdown-in-jquery/)
...
jQuery 中的 `val()`方法用于设置或返回所选元素的属性值。此方法适用于 HTML 表单元素。
