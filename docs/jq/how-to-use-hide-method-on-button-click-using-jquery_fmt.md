...
> 原文: [https://www.geeksforgeeks.org/how-to-use-hide-method-on-button-click-using-jquery/](https://www.geeksforgeeks.org/how-to-use-hide-method-on-button-click-using-jquery/)
...
**示例 2:** 我们可以使用 [`hide()`](https://www.geeksforgeeks.org/jquery-hide-with-examples/) 方法隐藏图像。
...
<body>
    <img
      id="image"
      src="https://media.geeksforgeeks.org/wp-content/uploads/20210805112556/gfgImage.png"
      alt=""/>
    <button id="btn" 
...
**示例 3:** [`hide()`](https://www.geeksforgeeks.org/jquery-hide-with-examples/) 方法也可以用于隐藏任何几何形状。
