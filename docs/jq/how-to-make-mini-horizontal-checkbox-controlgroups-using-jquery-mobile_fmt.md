...
> 原文：[https://www.geeksforgeeks.org/how-to-make-mini-horizontal-checkbox-controlgroups-using-jquery-mobile/](https://www.geeksforgeeks.org/how-to-make-mini-horizontal-checkbox-controlgroups-using-jquery-mobile/)

jQuery Mobile 是一种基于网络的技术，用于制作可在所有智能手机、平板电脑和台式机上访问的响应内容。迷你水平复选框控件组按钮可以很容易地使用 jQuery Mobile。

包含脚本：您可以通过将这些标签添加到您的 `<head>` 标签中，将 jQuery Mobile 脚本添加到您的项目中。
