# jQuery Mobile swipeleft事件

> 原文：[https://www.geeksforgeeks.org/jquery-mobile-swipeleft-event/](https://www.geeksforgeeks.org/jquery-mobile-swipeleft-event/)

`jQuery Mobile`的`swipeleft`事件在元素区域向左滑动时触发。我们可以将这个事件用于不同的目的。
