...
> 原文：[https://www.geeksforgeeks.org/jquery-attributevalue-selector-7/](https://www.geeksforgeeks.org/jquery-attributevalue-selector-7/)

`jQuery [attribute~='value']` 选择器选择 `name` 属性包含特定字符串的所有元素。
