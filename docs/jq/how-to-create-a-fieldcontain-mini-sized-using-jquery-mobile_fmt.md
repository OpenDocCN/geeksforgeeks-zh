...
> 原文：[https://www.geeksforgeeks.org/how-to-create-a-fieldcontain-mini-sized-using-jquery-mobile/](https://www.geeksforgeeks.org/how-to-create-a-fieldcontain-mini-sized-using-jquery-mobile/)
...
## 示例
我们将使用 `jQuery Mobile` 创建一个 `Fieldcontain` 小型区域。我们使用 `class="ui-field-contain"` 属性来设置最小大小的字段。
