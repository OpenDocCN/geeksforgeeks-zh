...
> 原文: [https://www.geeksforgeeks.org/jquery-mouseenter-with-examples/](https://www.geeksforgeeks.org/jquery-mouseenter-with-examples/)
...
**参数:** 该方法接受单参数`function`，可选。它用于指定调用`mouseenter`事件时要运行的函数。
...
在进入鼠标悬停段落前:
![](img/1d35bc5f59be1970cb38b7947df456dc.png)
