...
> 原文：[https://www.geeksforgeeks.org/how-to-change-the-font-styles-of-paragraphs-on-mouseenter-and-mouseleave-using-jquery/](https://www.geeksforgeeks.org/how-to-change-the-font-styles-of-paragraphs-on-mouseenter-and-mouseleave-using-jquery/)
...
## 方法 3：对所选元素的 `mouseenter` 和 `mouseleave` 事件应用 `css()` 方法
