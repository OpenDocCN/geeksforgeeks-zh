# jQuery serializeArray() 方法介绍

> 原文: [https://www.geeksforgeeks.org/jquery-serializearray-with-examples/](https://www.geeksforgeeks.org/jquery-serializearray-with-examples/)
...
## 示例代码
以下 jQuery 代码展示了 `serializeArray()` 方法的工作情况：
```html
<html>
<head>
...
## 输出
点击前“点击这里！”按钮：
![](img/aee3dfd172c9d3fb077b5a83eda2b6e5.png)
