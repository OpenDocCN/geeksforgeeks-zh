# jQuery Mobile Collapsibleset Widget Disabled 选项

> 原文：[https://www.geeksforgeeks.org/jquery-mobile-collapsibleset-widget-disabled-option/](https://www.geeksforgeeks.org/jquery-mobile-collapsibleset-widget-disabled-option/)

jQuery Mobile 是一种基于网络的技术，用于制作可在所有智能手机、平板电脑和台式机上访问的响应内容。
在本文中，我们将使用 jQuery Mobile `collapsibleset` Widget 的 `disabled` 选项来禁用 `collapsibleset`，如果其值设置为 `true`。接受布尔类型值，默认值为 `false`。
...
在以下示例中，我们将 `disabled` 选项设置为 `false`。
...
[https://api.jquerymobile.com/collapsibleset/#option-disabled](https://api.jquerymobile.com/collapsibleset/#option-disabled)