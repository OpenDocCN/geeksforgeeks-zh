...
> 原文：[https://www.geeksforgeeks.org/how-to-design-tabs-and-pills-using-jquery-easyui-mobile/](https://www.geeksforgeeks.org/how-to-design-tabs-and-pills-using-jquery-easyui-mobile/)

在本文中，我们将学习如何使用 `jQuery EasyUI Mobile` 插件设计标签和药丸。药丸基本上是下拉菜单形式的标签。
...
**示例 1：** 下面演示了使用 `jQuery EasyUI Mobile` 插件的基本选项卡。
...
**示例 2：** 下面的代码演示了使用 `jQuery EasyUI Mobile` 插件的不同类来导航标签。
