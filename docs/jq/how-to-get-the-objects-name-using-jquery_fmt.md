...
> 原文：[https://www.geeksforgeeks.org/how-to-get-the-objects-name-using-jquery/](https://www.geeksforgeeks.org/how-to-get-the-objects-name-using-jquery/) 获取对象名称

在本文中，我们将学习如何使用 jQuery 查找元素的名称。`name`属性可以应用于 HTML 中的多个元素，并用于为任何元素指定名称。使用`attr()`方法可以找出任意元素的`name`属性。该方法用于查找匹配集中第一个元素的任意属性的值。
