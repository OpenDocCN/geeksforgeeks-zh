...
> 原文：[https://www.geeksforgeeks.org/how-to-use-jquery-touch-events-plugin-for-mobiles/](https://www.geeksforgeeks.org/how-to-use-jquery-touch-events-plugin-for-mobiles/)

在本文中，我们将学习如何使用完全基于 JavaScript 的 `jQuery Touch Events` 插件来处理移动用户界面设计中的各种触摸事件。这些是可以与 jQuery 一起使用的附加事件，jQuery 也与桌面应用程序以及移动网络应用程序兼容。
...
以下代码演示了用户使用 `jQuery Touch Events` 插件进行的简单点击事件。
...
*   **触摸事件后：** 在“Touch Me!”被点击一次，将显示以下输出。
    T3】

## 示例 2

下面的代码演示了用户使用如下所示的双链功能进行的单次点击和两次点击事件。
...
**输出：** 在“Touch Me!”被轻敲两次，将显示以下输出。
T3】

## 示例 3

以下代码演示了当用户点击 HTML 控件时的点击开始和点击结束触摸事件。
...
**输出：** 当用户点击“Touch Me!” div，将显示以下输出。
T3】

## 示例 4

以下代码演示了用户在 HTML 控件上滑动时的滑动事件和滑动结束事件。
...
**输出：** 当用户在“Touch Me!” div上滑动，将显示以下输出。
T3】
