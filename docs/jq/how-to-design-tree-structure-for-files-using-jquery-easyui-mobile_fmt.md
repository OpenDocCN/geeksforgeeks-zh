# 如何使用 jQuery EasyUI Mobile 为文件设计树形结构？

> 原文：[https://www.geeksforgeeks.org/how-to-design-tree-structure-for-files-using-jquery-easyui-mobile/](https://www.geeksforgeeks.org/how-to-design-tree-structure-for-files-using-jquery-easyui-mobile/)
...
**示例 1：** 以下示例使用 `jQuery EasyUI` 框架演示了手机中文件或目录的基本树状结构。在 `ul` 标签中，使用的类是 `easyui-tree` 来给文件一种树状的感觉。
...
**示例 2：** 以下示例使用 `jQuery EasyUI` 框架演示了树中文件节点的“拖放”功能。
