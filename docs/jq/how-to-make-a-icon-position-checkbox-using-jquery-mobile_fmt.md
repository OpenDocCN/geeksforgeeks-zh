...
> 原文：[https://www.geeksforgeeks.org/how-to-make-a-icon-position-checkbox-using-jquery-mobile/](https://www.geeksforgeeks.org/how-to-make-a-icon-position-checkbox-using-jquery-mobile/)
...
**示例：** 我们将使用 `jQuery Mobile` 创建一个图标位置复选框。我们使用 `input type="checkbox"` 属性创建复选框，并使用 `data-iconpos="right"` 属性创建图标位置复选框。
