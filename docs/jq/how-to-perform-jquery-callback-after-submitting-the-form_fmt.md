...
> 原文: [https://www.geeksforgeeks.org/how-to-perform-jquery-callback-after-submitting-the-form/](https://www.geeksforgeeks.org/how-to-perform-jquery-callback-after-submitting-the-form/)

表单提交后的回调是触发提交按钮后执行的一组代码。通常，一旦提交，它就用来清空表单。例如，当登录凭证错误时，表单中的输入变为空白。
