...
> 原文：[https://www.geeksforgeeks.org/how-to-select-all-links-inside-the-paragraph-using-jquery/](https://www.geeksforgeeks.org/how-to-select-all-links-inside-the-paragraph-using-jquery/) 选择段落内的所有链接
...
**方法：** 这里，我们已经在段落元素内部创建了链接和内容。之后，我们使用`$(“p a”)`选择器选择段落元素内的所有链接，并使用[css()方法](https://www.geeksforgeeks.org/jquery-css-method/)更改其样式。
