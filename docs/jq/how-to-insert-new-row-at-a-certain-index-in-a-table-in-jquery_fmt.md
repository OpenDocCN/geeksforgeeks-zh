...
> 原文：[https://www.geeksforgeeks.org/how-to-insert-new-row-at-a-certain-index-in-a-table-in-jquery/](https://www.geeksforgeeks.org/how-to-insert-new-row-at-a-certain-index-in-a-table-in-jquery/)
...
*   将表列值柠檬存储到变量中。
*   然后使用 `eq()` 和 `after()` 方法在表格中插入该行。

### 示例 1

在此示例中，行插入到索引 1 处（硬编码）。
