...
jQuery 中的 `each()` 方法用于为每个匹配的元素指定要运行的函数。
...
该方法接受单参数 `function(index, element)`，为必选项。它用于运行每个匹配的元素。它包含两个参数。
...
*   **之前点击按钮**
    ![](img/2bdd30e7fb192792a687546f2bfe9ae9.png)
*   **点击按钮后**
