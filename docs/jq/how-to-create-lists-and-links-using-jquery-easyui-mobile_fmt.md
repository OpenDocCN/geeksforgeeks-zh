...
> 原文：[https://www.geeksforgeeks.org/how-to-create-lists-and-links-using-jquery-easyui-mobile/](https://www.geeksforgeeks.org/how-to-create-lists-and-links-using-jquery-easyui-mobile/)

在本文中，我们将学习如何使用 [jQuery EasyUI Mobile](https://www.jeasyui.com/index.php) 设计列表、对列表进行分组并创建链接以便于导航。
...
以下示例演示了使用 `jQuery EasyUI Mobile` 通过按钮创建列表和链接。
...
<body>
    ...
    <div class="easyui-navpanel">
        ...
        <ul class="m-list">
            ...
            <li>
                <a href="https://www.geeksforgeeks.org/analysis-of-algorithms-set-1-asymptotic-analysis/"
            ...
            <li>
                <a href="https://www.geeksforgeeks.org/geometric-algorithms/"
                    onclick="display(this)">
                    Geometric algorithms
                </a>
            </li>
            <li>
                <a href="https://www.geeksforgeeks.org/greedy-algorithms/"
                    onclick="display(this)">
                    Greedy algorithms
                </a>
            </li>
            ...
            <li>
                <a href="" onclick="display(this)">HTML</a>
            </li>
            <li>
                <a href="https://www.geeksforgeeks.org/javascript-tutorial/" 
                    onclick="display(this)">
                    Javascript
                </a>
            </li>
    ...
    <div id="divID2" class="easyui-navpanel">
        <header>
            <div class="m-toolbar">
                ...
                <div class="m-left">
                    <!--'m-back' class is used for going back-->
...
<body>
    <div class="easyui-navpanel">
        <header>
            <div class="m-toolbar">
                <span class="m-title">List with Images</span>
            </div>
        </header>
        <ul id="listID" class="m-list">
            <li>
                <img class="list-image" src="https://www.geeksforgeeks.org/wp-content/uploads/gfg_200X200.png">
