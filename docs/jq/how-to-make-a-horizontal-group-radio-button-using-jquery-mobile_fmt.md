...
> 原文：[https://www.geeksforgeeks.org/how-to-make-a-horizontal-group-radio-button-using-jquery-mobile/](https://www.geeksforgeeks.org/how-to-make-a-horizontal-group-radio-button-using-jquery-mobile/)
...
我们将使用 jQuery Mobile 创建一个水平组单选按钮。我们使用 `input type="radio"` 属性创建单选按钮，并使用 `data-type="horizontal"` 属性创建水平组单选按钮。
