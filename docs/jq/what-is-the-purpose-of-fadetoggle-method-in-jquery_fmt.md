# fadeToggle()方法在 JQuery 中的用途是什么？

> 原文：[https://www.geeksforgeeks.org/what-is-the-purpose-of-fadetoggle-method-in-jquery/](https://www.geeksforgeeks.org/what-is-the-purpose-of-fadetoggle-method-in-jquery/)
...
`fadeToggle()`方法用于在`fadeIn()`和`fadeOut()`方法之间切换。如果元素淡入，`fadeToggle()`将淡出。如果元素淡出，`fadeToggle()`将淡入。
