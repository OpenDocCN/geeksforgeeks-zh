...
> 原文: [https://www.geeksforgeeks.org/how-to-make-a-icon-button-using-jquery-mobile/](https://www.geeksforgeeks.org/how-to-make-a-icon-button-using-jquery-mobile/)
...
在本文中，我们将使用带有 `class = "ui-btn ui-icon-delete ui-btn-icon-left"` 的 `Anchor` 来制作按钮。
...
在本文中，我们将使用带有 `class = "ui-btn ui-icon-delete ui-btn-icon-left"` 的 `button` 标记来实现我们的目的。
