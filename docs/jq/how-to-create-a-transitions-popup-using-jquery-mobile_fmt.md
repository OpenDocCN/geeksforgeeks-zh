...
> 原文：[https://www.geeksforgeeks.org/how-to-create-a-transitions-popup-using-jquery-mobile/](https://www.geeksforgeeks.org/how-to-create-a-transitions-popup-using-jquery-mobile/)
...
`popup` 元素不包含任何类型的转换。通过向引用弹出窗口的链接添加 `data-transition` 属性，可以将转换添加到弹出窗口元素中。反向转换用于关闭弹出窗口。
