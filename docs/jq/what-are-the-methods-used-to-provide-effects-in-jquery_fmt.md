...
> 原文：[https://www.geeksforgeeks.org/what-are-the-methods-used-to-provide-effects-in-jquery/](https://www.geeksforgeeks.org/what-are-the-methods-used-to-provide-effects-in-jquery/)

jQuery 中的效果通常用于向网页添加动画。jQuery 库有几种方法，我们可以用来为网页制作自定义动画。在本文中，我们将看到 jQuery 中用于制作动画的每一种方法。我们将讨论所有方法以及 jQuery 代码片段和输出。

## 1. `animate()` 方法
该方法用于制作带有一些选定 CSS 属性的自定义动画。例如，`height`、`width` 等可以用这种方法制作动画。
