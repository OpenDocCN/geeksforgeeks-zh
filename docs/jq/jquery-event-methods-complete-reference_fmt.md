...
> 原文：`https://www.geeksforgeeks.org/jquery-event-methods-complete-reference/`
...
*   [`jQuery | event.isImmediatePropagationStopped()方法`](https://www.geeksforgeeks.org/jquery-event-isimmediatepropagationstopped-method/)
*   [`jQuery | event.isPropagationStopped()方法`](https://www.geeksforgeeks.org/jquery-event-ispropagationstopped-method/)
...
*   [`jQuery | event.stopImmediatePropagation()方法`](https://www.geeksforgeeks.org/jquery-event-stopimmediatepropagation-method/)
*   [`jQuery | event.stopPropagation()方法`](https://www.geeksforgeeks.org/jquery-event-stoppropagation-method/)
...
*   [`jQuery | event.which 属性`](https://www.geeksforgeeks.org/jquery-event-which-property-with-examples/)
...
*   [`jQuery | undelegate()带示例`](https://www.geeksforgeeks.org/jquery-undelegate-with-examples/)