...
> 原文：[https://www.geeksforgeeks.org/how-to-detect-and-change-the-content-style-of-a-div-using-jquery/](https://www.geeksforgeeks.org/how-to-detect-and-change-the-content-style-of-a-div-using-jquery/)
...
本示例使用 [jQuery `on()`方法](https://www.geeksforgeeks.org/jquery-on-with-examples/)更改 `<div>` 元素的文本。
    ...
    <script>
        $(document).ready(function(){
            $("div").on("click", function(){
                document.getElementById("div1").innerHTML = "A computer science portal for geeks"; 
            });
        });
    </script>
</head>
...
本示例使用 [jQuery `on()`方法](https://www.geeksforgeeks.org/jquery-on-with-examples/)更改 `<div>` 元素的样式。
