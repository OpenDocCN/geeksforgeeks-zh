...
> 原文：[https://www.geeksforgeeks.org/what-is-slice-method-in-jquery/](https://www.geeksforgeeks.org/what-is-slice-method-in-jquery/)
...
*   如果 `start_index` 和 `end_index` 在结束索引被考虑之前都被给定了，从开始索引到结束索引的所有元素都会被选中。
