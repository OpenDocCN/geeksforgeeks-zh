...
> 原文: [https://www.geeksforgeeks.org/jquery-mouseleave-with-examples/](https://www.geeksforgeeks.org/jquery-mouseleave-with-examples/)
...
## 参数:
该方法接受单参数`function`，可选。它用于指定调用`mouseleave`事件时要运行的函数。

## 返回值:
该方法返回带有`mouseleave()`方法所做更改的选定元素。
...
## 输出:
将鼠标移过段落前:
![](img/b49157a75ffdfc9d56bde9c40fa2c8a6.png)
将鼠标移过段落后:
