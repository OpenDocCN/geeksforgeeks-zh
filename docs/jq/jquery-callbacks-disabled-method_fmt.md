...
> 原文: [https://www.geeksforgeeks.org/jquery-callbacks-disabled-method/](https://www.geeksforgeeks.org/jquery-callbacks-disabled-method/)

jQuery `callbacks.disabled()` 方法用于检查回调是否被禁用。该方法根据回调返回“真”或“假”。
...
本示例禁用回调，然后调用 `callbacks.disabled()` 方法查看结果。
