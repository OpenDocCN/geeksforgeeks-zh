...
> 原文: [https://www.geeksforgeeks.org/how-to-get-a-divs-background-image-with-jquery/](https://www.geeksforgeeks.org/how-to-get-a-divs-background-image-with-jquery/)
...
首先，用按钮创建一个空的 *div* 。将该按钮映射到 jQuery 中的 *`CSS()`* 方法。单击按钮后，使用图像放置在 *div* 元素中。
