...
> 原文: [https://www.geeksforgeeks.org/jquery-height-and-innerheight-with-examples/](https://www.geeksforgeeks.org/jquery-height-and-innerheight-with-examples/)
...
<body>
    ...
    <p>Click on the button and check the height of the element(excluding padding).</p>
</body>
</html>
```
...
<body>
    <div id="demo"></div>
    <button>Click Me!!!</button>
    <p>Click on the button and check the innerHeight of an element(includes padding).</p>
</body>
</html>
```
