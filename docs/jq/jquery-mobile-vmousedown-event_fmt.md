...
> 原文: [https://www.geeksforgeeks.org/jquery-mobile-vmousedown-event/](https://www.geeksforgeeks.org/jquery-mobile-vmousedown-event/)

`jQuery Mobile`的`vmousedown`事件在我们点击元素时被触发。我们可以将这个事件用于不同的目的。
