...
> 原文：[https://www.geeksforgeeks.org/how-to-add-edit-and-delete-table-row-in-jquery/](https://www.geeksforgeeks.org/how-to-add-edit-and-delete-table-row-in-jquery/)

在本文中，我们将创建一个如何在 jQuery 中添加、编辑和删除表行的示例。为了创建这个功能，我们需要了解 [HTML 表格](https://www.geeksforgeeks.org/html-table-bgcolor-attribute/)、 [jQuery](https://www.geeksforgeeks.org/jquery-tutorials/) 基础知识。
...
5.  使用 jQuery [`stopPropagation()`](https://www.geeksforgeeks.org/html-dom-stoppropagation-event-method/) 和 [`stopImmediatePropagation()`](https://www.geeksforgeeks.org/jquery-event-stopimmediatepropagation-method/) 方法来停止事件调用的传播。
6.  在代码的 CSS 部分，表格行和按钮设计是随着 CSS 淡入淡出[动画效果](https://www.geeksforgeeks.org/css-animation-and-keyframes-property/)使用 [`@keyframes`](https://www.geeksforgeeks.org/css-animation-and-keyframes-property/) 规则来处理的。
