...
> 原文: [https://www.geeksforgeeks.org/how-to-hide-div-element-after-few-seconds-in-jquery/](https://www.geeksforgeeks.org/how-to-hide-div-element-after-few-seconds-in-jquery/)
...
在本例中，`setTimeOut()`方法用于为`fadeOut()`方法提供延迟。
...
在本例中，`delay()`方法用于向`fadeOut()`方法提供延迟。
