...
> 原文：[https://www.geeksforgeeks.org/how-do-you-get-the-length-of-a-string-in-jquery/](https://www.geeksforgeeks.org/how-do-you-get-the-length-of-a-string-in-jquery/)

任务是在 JQuery 的帮助下获取字符串的长度。我们可以通过 jQuery 找到字符串的长度。`length` 属性包含 jQuery 对象中的元素数量。因此，它可以用来获取或找出字符串中的字符数。
...
### 输出：
入文前：
![](img/7a75335d85698ff946d5a9ec169873f2.png)
入文后：