...
> 原文: [https://www.geeksforgeeks.org/how-to-destroy-a-button-in-jquery-ui/](https://www.geeksforgeeks.org/how-to-destroy-a-button-in-jquery-ui/)

要销毁 jQuery 用户界面中的按钮，我们将使用下面讨论的 `destroy()` 方法:
...
> `<link rel='stylesheet' href="http://ajax.googleapis.com/ajax/libs/jqueryui/1.8.16/themes/ui-light/jquery-ui.css">`
...
**参考:** [https://api.jqueryui.com/button/](https://api.jqueryui.com/button/)