...
> 原文：[https://www.geeksforgeeks.org/how-to-scroll-window-using-jquery/](https://www.geeksforgeeks.org/how-to-scroll-window-using-jquery/)
...
使用选择器选择文档。
使用 `scrollTop()` 或 `scrollTo()` 方法将文档移动到该位置。

## 示例 1

本示例使用 `scrollTop()` 方法滚动 HTML 文档。
