...
> 原文：[https://www.geeksforgeeks.org/how-to-know-which-radio-button-is-selected-using-jquery/](https://www.geeksforgeeks.org/how-to-know-which-radio-button-is-selected-using-jquery/)
...
选择器`'input[name=option]:checked'`用于选择所有以指定形式输入选项类型的输入组。
