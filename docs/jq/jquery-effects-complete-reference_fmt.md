...
> 原文：`https://www.geeksforgeeks.org/jquery-effects-complete-reference/`
...
`jQuery` 提供了一个非常简单的界面，可以实现各种令人惊叹的效果。`jQuery` 效果用于创建常用的视觉效果。

下面给出了完整的 `jQuery` 效果列表：

*   [`jQuery | animate()` 示例](https://www.geeksforgeeks.org/jquery-animate-with-examples/)
...
*   [`jQuery | dequeue()` 示例](https://www.geeksforgeeks.org/jquery-dequeue-with-examples/)
