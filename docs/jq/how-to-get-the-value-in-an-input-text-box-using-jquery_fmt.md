...
> 原文：[https://www.geeksforgeeks.org/how-to-get-the-value-in-an-input-text-box-using-jquery/](https://www.geeksforgeeks.org/how-to-get-the-value-in-an-input-text-box-using-jquery/)
...
该示例是在字段中写入文本的情况下实现的，当单击显示值按钮时，弹出窗口出现并显示输入的文本。
...
该实现显示了点击按钮时的 set value 属性。它会自动调用并使用代码中提到的预定义数据填充文本框。
...
<body>
    ...
    <p>User Text: <input type="text" name="userInput">
    </p>
