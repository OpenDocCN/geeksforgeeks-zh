...
> 原文：[https://www.geeksforgeeks.org/jquery-mobile-dialog-widget-defaults-option/](https://www.geeksforgeeks.org/jquery-mobile-dialog-widget-defaults-option/)
...
`参考:` [https://api.jquerymobile.com/dialog/#option-defaults](https://api.jquerymobile.com/dialog/#option-defaults)