...
> 原文：[https://www.geeksforgeeks.org/how-to-enable-a-jquery-ui-menu/](https://www.geeksforgeeks.org/how-to-enable-a-jquery-ui-menu/)

jQuery UI 由 GUI 小部件、视觉效果和使用 jQuery、CSS 和 HTML 实现的主题组成。jQuery 用户界面非常适合为网页构建用户界面。jQuery UI 菜单是一个菜单，用于鼠标和键盘交互在页面之间导航。在本文中，我们将展示如何在 jQuery UI 中启用菜单。
