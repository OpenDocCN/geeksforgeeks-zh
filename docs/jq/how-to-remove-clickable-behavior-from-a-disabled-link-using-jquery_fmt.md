...
> 原文：[https://www.geeksforgeeks.org/how-to-remove-clickable-behavior-from-a-disabled-link-using-jquery/](https://www.geeksforgeeks.org/how-to-remove-clickable-behavior-from-a-disabled-link-using-jquery/)
...
**参数：** 该方法接受强制的单参数 `attribute`。它用于指定要移除的一个或多个属性。使用空间运算符可以分隔多个属性。
