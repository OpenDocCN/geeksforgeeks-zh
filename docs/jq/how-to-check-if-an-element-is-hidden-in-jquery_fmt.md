...
> 原文: [https://www.geeksforgeeks.org/how-to-check-if-an-element-is-hidden-in-jquery/](https://www.geeksforgeeks.org/how-to-check-if-an-element-is-hidden-in-jquery/)

要检查一个元素是`隐藏的`还是`不是`，可以使用 jQuery `:hidden`选择器。`.toggle()`功能用于切换元素的可见性。
