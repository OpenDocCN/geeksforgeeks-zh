...
> 原文：[https://www.geeksforgeeks.org/how-to-make-vertical-selects-controlgroup-using-jquery-mobile/](https://www.geeksforgeeks.org/how-to-make-vertical-selects-controlgroup-using-jquery-mobile/)

jQuery mobile 是一种基于网络的技术，用于制作可在所有智能手机、平板电脑和台式机上访问的响应内容。

## 包含脚本

您可以通过将这些标签添加到您的 `<头>` 标签中，将 jQuery 移动脚本添加到您的项目中。
