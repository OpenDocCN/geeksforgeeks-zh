...
> 原文：[https://www.geeksforgeeks.org/what-are-all-the-ways-to-include-jquery-on-a-page/](https://www.geeksforgeeks.org/what-are-all-the-ways-to-include-jquery-on-a-page/)
...
**第二步：** 创建一个 HTML 文件，在 HTML 文件的 [`<head>` 标记](https://www.geeksforgeeks.org/html-head-tag/)段内的 [`<script>` 标记](https://www.geeksforgeeks.org/html-script-tag/)中声明 jQuery 文件路径。请注意，jQuery 文件必须放在工作区内。
...
## 方法二：通过 CDN 使用 jQuery

与之前的方法相比，这个方法非常容易使用。我们只需要将下面的代码粘贴到 HTML 文件的头部。
