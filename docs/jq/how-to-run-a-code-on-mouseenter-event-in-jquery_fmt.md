...
> 原文: [https://www.geeksforgeeks.org/how-to-run-a-code-on-mouseenter-event-in-jquery/](https://www.geeksforgeeks.org/how-to-run-a-code-on-mouseenter-event-in-jquery/)
...
该方法接受单参数函数，可选。它用于指定调用 `mouseenter()`方法时要运行的函数。
