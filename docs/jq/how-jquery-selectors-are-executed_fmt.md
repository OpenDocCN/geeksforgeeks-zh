...
> 原文: [https://www.geeksforgeeks.org/how-jquery-selectors-are-executed/](https://www.geeksforgeeks.org/how-jquery-selectors-are-executed/)
...
它以“少写多做”的哲学而闻名，因为它是为用很少的代码执行更多的任务而开发的。jQuery 比 JavaScript 更快，因为与 JavaScript 相比，它的代码更少。
...
例如，jQuery 将首先找到所有带有类 `second` 的元素。然后它将选择 id 为 `second` 的所有元素。
