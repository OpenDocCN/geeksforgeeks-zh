...
> 原文: [https://www.geeksforgeeks.org/jquery-parentsuntil-with-example/](https://www.geeksforgeeks.org/jquery-parentsuntil-with-example/)
...
它接受参数 `selector2`，这是树中所选元素的最后一个标记的父元素。
