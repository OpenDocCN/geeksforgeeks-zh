...
> 原文：[https://www.geeksforgeeks.org/how-to-create-a-datetime-input-using-jquery-mobile/](https://www.geeksforgeeks.org/how-to-create-a-datetime-input-using-jquery-mobile/)
...
## 示例
我们将使用 `jQuery Mobile` 创建一个日期时间输入区域。我们使用 `type="datetime"` 属性来设置 `datetime`。
