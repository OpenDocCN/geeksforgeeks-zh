...
> 原文：[https://www.geeksforgeeks.org/how-to-make-a-basic-radio-button-using-jquery-mobile/](https://www.geeksforgeeks.org/how-to-make-a-basic-radio-button-using-jquery-mobile/)

`jQuery Mobile` 是一项基于 web 的技术，用于制作可在所有智能手机、平板电脑和台式机上访问的响应内容。
