...
> 原文：[https://www.geeksforgeeks.org/how-to-create-a-zebra-stripes-table-effect-using-jquery/](https://www.geeksforgeeks.org/how-to-create-a-zebra-stripes-table-effect-using-jquery/)
...
在上面的函数中，`zebrastripe` 是使用的类名，`odd` 描述奇数行将有彩色条纹。
