...
> 原文：[https://www.geeksforgeeks.org/how-to-perform-click-and-hold-operation-inside-an-element-using-jquery/](https://www.geeksforgeeks.org/how-to-perform-click-and-hold-operation-inside-an-element-using-jquery/)
...
在本例中，在 `div` 内点击并保持 2 秒将触发其他事件，该事件只是打印发生的事件。
...
在本例中，在正文文档内点击并保持 2 秒钟将触发其他事件，该事件只是打印发生的事件。这个例子分离了 `mousedown` 和 `mouseup` 事件的逻辑。
