...
> 原文: [https://www.geeksforgeeks.org/how-to-check-whether-the-meta-key-pressed-when-event-is-fired-using-jquery/](https://www.geeksforgeeks.org/how-to-check-whether-the-meta-key-pressed-when-event-is-fired-using-jquery/)
...
它是一个特殊的键，位于键盘上的空格键旁边。对于不同的操作系统，它位于不同的位置，例如：
...
它将返回一个布尔值(真或假)，指示事件触发时是否按下了 `Meta` 键。
