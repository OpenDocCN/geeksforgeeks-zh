...
> 原文: [https://www.geeksforgeeks.org/jquery-event-type-property-with-examples/](https://www.geeksforgeeks.org/jquery-event-type-property-with-examples/)

`event.type` 是 jQuery 中的一个内置属性，用于返回哪个事件类型被启动。
