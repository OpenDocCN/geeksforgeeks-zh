...
> 原文:[https://www.geeksforgeeks.org/jquery-interview-questions-and-answers-set-3/](https://www.geeksforgeeks.org/jquery-interview-questions-and-answers-set-3/)
...
2.  **What is the difference between `jQuery.get()` and `jQuery.ajax()` method ?**
...
13. **Define `slideToggle()` effect ?**
    ...
    *   [`slideDown()`](https://www.geeksforgeeks.org/jquery-slidedown-method/)
...
17. **How to find browser and browser version in jQuery** ?
    ...
    使用`$.browser`并不是 jQuery 本身建议的，因此这个特性被移到了 `jQuery.migrate` 插件中，如果用户愿意，可以下载这个插件。
