...
> 原文: [https://www.geeksforgeeks.org/how-to-make-a-basic-markup-button-using-jquery-mobile/](https://www.geeksforgeeks.org/how-to-make-a-basic-markup-button-using-jquery-mobile/)
...
我们将使用带有 `class="ui-btn ui-corner-all"` 的锚标签来创建按钮。
