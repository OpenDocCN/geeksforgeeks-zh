...
> 原文：[https://www.geeksforgeeks.org/how-to-count-child-element-using-jquery/](https://www.geeksforgeeks.org/how-to-count-child-element-using-jquery/)

使用 jQuery 计算 HTML 文件中子元素的数量非常简单。例如：如果您有一个由许多子元素组成的父元素，那么您可以使用`.length`或`.children().length`方法，如下图。
