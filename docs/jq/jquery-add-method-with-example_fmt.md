...
> 原文: [https://www.geeksforgeeks.org/jquery-add-method-with-example/](https://www.geeksforgeeks.org/jquery-add-method-with-example/)
...
<body>
    ...
    <div>This example adds the same css style for both "p" and "span" elements, using its class and id name!!! </div>
</body>
</html>
```
