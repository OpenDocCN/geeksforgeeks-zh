# 如何使用 jQuery Mobile 创建星标图标？

> 原文: [https://www.geeksforgeeks.org/how-to-create-a-star-icon-using-jquery-mobile/](https://www.geeksforgeeks.org/how-to-create-a-star-icon-using-jquery-mobile/)
