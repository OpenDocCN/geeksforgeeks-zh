...
> 原文: [https://www.geeksforgeeks.org/jquery-first-of-type-selector/](https://www.geeksforgeeks.org/jquery-first-of-type-selector/)

**:first-of-type** 选择器用于选择所有元素，这些元素是其父元素的特定类型的第一个子元素。
...
本示例将父标签（`div` 标签）的第一个标题的背景颜色更改为绿色，文本颜色更改为白色。
...
本示例将 `<body>` 标签的第一个标题的背景颜色更改为绿色，文本颜色更改为白色。
