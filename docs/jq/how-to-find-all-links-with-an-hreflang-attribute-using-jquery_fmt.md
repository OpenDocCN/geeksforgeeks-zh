...
> 原文：[https://www.geeksforgeeks.org/how-to-find-all-links-with-an-hreflang-attribute-using-jquery/](https://www.geeksforgeeks.org/how-to-find-all-links-with-an-hreflang-attribute-using-jquery/)
...
您可以使用`属性包含前缀选择器`在页面上找到所有带有 `hreflang` 属性的链接。

**属性包含前缀选择器：** 该选择器用于选择具有指定属性的元素，该属性的值等于给定字符串或以该字符串开头。
