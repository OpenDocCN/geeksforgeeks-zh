# jQuery Mobile Collapsible Widget expandedIcon Option

> 哎哎哎: [https://www.geeksforgeeks.org/jquery-mobile-collapsibleset-widget-expandedicon-option/](https://www.geeksforgeeks.org/jquery-mobile-collapsibleset-widget-expandedicon-option/)

jQuery Mobile 是一种基于网络的技术，用于制作可在所有智能手机、平板电脑和台式机上访问的响应内容。在本文中，我们将使用 jQuery Mobile `collapsibleset` Widget 的 `expandedIcon` 选项来设置处于展开状态时可折叠容器的标题图标。它接受字符串类型值，默认值为“减”。
...
<body>
    <div data-role="page" id="page1">
        <div data-role="header">
            <h1>GeeksforGeeks</h1>
            <h3>jQuery Mobile Collapsibleset Widget expandedIcon Option</h3>
        </div>
...
**参考:** [https://api.jquerymobile.com/collapsibleset/#option-expandedIcon](https://api.jquerymobile.com/collapsibleset/#option-expandedIcon)