...
> 原文：[https://www.geeksforgeeks.org/restoring-division-algorithm-unsigned-integer/](https://www.geeksforgeeks.org/restoring-division-algorithm-unsigned-integer/)
...
这里，寄存器 `Q` 包含商，寄存器 `A` 包含余数。这里，`n` 位被除数加载在 `Q` 中，除数加载在 `M` 中。寄存器 `A` 的值最初保持为 0，这是其值在迭代期间被恢复的寄存器，因此它被称为恢复。
...
| 3 | 00011 | 00010 | 110_ | 向左移动 AQ |
|  | 00011 | 11111 | 110_ | A=A-M |
|  | 00011 | 00010 | 1100 | `Q[0]=0` |
| 2 | 00011 | 00101 | 100_ | 向左移动 AQ |
|  | 00011 | 00010 | 100_ | A=A-M |
|  | 00011 | 00010 | 1001 | `Q[0]=1` |
| 1 | 00011 | 00101 | 001_ | 向左移动 AQ |
