# 8086 程序将 16 位十进制数转换为十六进制

> 原文: [https://www.geeksforgeeks.org/8086-program-to-convert-a-16-bit-decimal-number-to-hexadecimal/](https://www.geeksforgeeks.org/8086-program-to-convert-a-16-bit-decimal-number-to-hexadecimal/)

## 问题
给我们一个 16 位的十进制数，我们必须以十六进制格式打印这个数。
...
;if value is greater than 9 then add 7 so that after adding 48 it represents A for example 10 + 7 + 48 = 65 which is ASCII value of A
            add dx, 7
