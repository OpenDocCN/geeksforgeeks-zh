...
> 原文：[https://www.geeksforgeeks.org/minimization-of-boolean-functions/](https://www.geeksforgeeks.org/minimization-of-boolean-functions/)
...
比如功能`F=x′y′z + x′yz + xy′`可以最小化为`F=x′z + xy′`。与上述表达式相关联的电路是–
...
考虑示例-1 中的相同表达式，并使用 K-Map 将其最小化。
