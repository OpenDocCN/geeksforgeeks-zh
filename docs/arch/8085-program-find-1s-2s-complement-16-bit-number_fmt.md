...
> 原文: [https://www.geeksforgeeks.org/8085-program-find-1s-2s-complement-16-bit-number/](https://www.geeksforgeeks.org/8085-program-find-1s-2s-complement-16-bit-number/)

先决条件 – [8085 程序查找 8 位数字的 1 和 2 补码](https://www.geeksforgeeks.org/8085-program-find-1s-2s-complement-8-bit-number/)

## 问题
编写程序查找 16 位数字的 1 和 2 补码，其中起始地址为 `2000`，该数字存储在 `3000` 内存地址，并将结果存储到 `3002` 和 `3004` 内存地址。
