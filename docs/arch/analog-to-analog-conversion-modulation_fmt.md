...
> 原文:[https://www.geeksforgeeks.org/analog-to-analog-conversion-modulation/](https://www.geeksforgeeks.org/analog-to-analog-conversion-modulation/)
...
**`调频带宽`:**
1. 调频信号的带宽随偏差和调制频率而变化。中频调制频率(`Mf`) 0.5，宽带 `Fm` 信号。
