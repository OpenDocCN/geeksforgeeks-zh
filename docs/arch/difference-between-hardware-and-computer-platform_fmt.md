...
> 原文：[https://www.geeksforgeeks.org/difference-between-hardware-and-computer-platform/](https://www.geeksforgeeks.org/difference-between-hardware-and-computer-platform/)
...
| 硬件的特性包括`功能性`、`可移植性`、`效率`、`用户文档`等。 | 计算机平台的特征包括`功能性`、`抽象性`、`体系结构`等。 |
