...
> 原文：[https://www.geeksforgeeks.org/difference-between-minicomputer-and-supercomputer/](https://www.geeksforgeeks.org/difference-between-minicomputer-and-supercomputer/)
...
| 它们的速度在 `10-30 米/秒` 的范围内。 | 超级计算机的速度在 `100-900 MIPS` 的范围内。 |
