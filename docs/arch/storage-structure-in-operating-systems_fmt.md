...
> 原文：[https://www.geeksforgeeks.org/storage-structure-in-operating-systems/](https://www.geeksforgeeks.org/storage-structure-in-operating-systems/)
...
*   **易失性存储设备**：当设备断电时，它会丢失内容。
*   **非易失性存储设备**：当电源被移除时，它不会丢失其内容。它在断电时保存所有数据。
