...
> 原文: [https://www.geeksforgeeks.org/all-about-hc-05-bluetooth-module-connection-with-android/](https://www.geeksforgeeks.org/all-about-hc-05-bluetooth-module-connection-with-android/)
...
现在，我们将为列表创建一个 `On Click Listener`，以便可以从设备中提取名称和 `MAC` 地址。
