...
> 原文：[https://www.geeksforgeeks.org/arithmetic-pipeline-and-instruction-pipeline/](https://www.geeksforgeeks.org/arithmetic-pipeline-and-instruction-pipeline/)
...
此处指令在段 1 的第一个时钟周期提取。现在在下一个时钟周期解码，然后提取操作数，最后执行指令。我们可以看到，在这里，由于流水线操作，提取和解码阶段重叠。当第一条指令被解码时，流水线取出下一条指令。
