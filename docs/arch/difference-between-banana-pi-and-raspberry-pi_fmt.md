...
> 原文：[https://www.geeksforgeeks.org/difference-between-banana-pi-and-raspberry-pi/](https://www.geeksforgeeks.org/difference-between-banana-pi-and-raspberry-pi/)
...
| GPU | 对于图形需求使用 `ARM Mali400MP2` 图形处理器 | 图形功能使用博通视频核心四图形处理器。 |
