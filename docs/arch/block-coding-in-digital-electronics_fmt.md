...
> 原文: [https://www.geeksforgeeks.org/block-coding-in-digital-electronics/](https://www.geeksforgeeks.org/block-coding-in-digital-electronics/)
...
在接收机处，`NRZ-I` 编码的数字信号首先被解码成比特流，然后被再次解码以去除冗余比特。
