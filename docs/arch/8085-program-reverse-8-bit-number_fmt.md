...
> 原文: [https://www.geeksforgeeks.org/8085-program-reverse-8-bit-number/](https://www.geeksforgeeks.org/8085-program-reverse-8-bit-number/)

## 问题
在 8085 微处理器中编写汇编语言程序，倒 8 位数字。
