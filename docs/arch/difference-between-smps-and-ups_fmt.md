...
> 原文：[`https://www.geeksforgeeks.org/difference-between-smps-and-ups/`](https://www.geeksforgeeks.org/difference-between-smps-and-ups/)

## 1. 开关电源(SMPS)
用于从特定的 `DC` 电压变为另一个 `DC` 电压电平。通常它会将电源电压降低到较低的电平，以便需要较低电压的组件使用。
...
| 电子元件 | 整流器、不间断电源电池、逆变器、静态旁路开关。 | `PWM` 振荡器，高频整流器，`MOSFET` 开关。 |
