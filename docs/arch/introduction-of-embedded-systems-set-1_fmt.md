...
> 原文：[https://www.geeksforgeeks.org/introduction-of-embedded-systems-set-1/](https://www.geeksforgeeks.org/introduction-of-embedded-systems-set-1/)
...
嵌入式系统可以使用不同的编程语言进行编程，如嵌入式 C、嵌入式 C++、嵌入式 Java、嵌入式 Python。然而，这完全取决于开发人员使用哪种编程语言来开发嵌入式系统。