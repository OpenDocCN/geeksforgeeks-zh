...
> 原文: [https://www.geeksforgeeks.org/8086-program-add-two-16-bit-numbers-without-carry/](https://www.geeksforgeeks.org/8086-program-add-two-16-bit-numbers-without-carry/)

## 问题
编写一个程序，将两个 16 位数字相加，起始地址为 `2000`，数字位于 `3000` 和 `3002` 内存地址，并将结果存入 `3004` 和 `3006` 内存地址。
