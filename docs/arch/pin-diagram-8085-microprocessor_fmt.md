...
> 原文: [https://www.geeksforgeeks.org/pin-diagram-8085-microprocessor/](https://www.geeksforgeeks.org/pin-diagram-8085-microprocessor/)
...
微处理器通过 `INTA` 的信号确认中断请求。除了中断，还有三个外部启动的信号，即 `RESET`、`HOLD` 和 `READY`。为了响应保持请求，它有一个信号叫做 `HLDA`。
