...
> 原文：[https://www.geeksforgeeks.org/difference-between-8051-and-msp430/](https://www.geeksforgeeks.org/difference-between-8051-and-msp430/)

先决条件–[微控制器(`µc`)和微处理器(`µp`)](https://www.geeksforgeeks.org/whats-difference-between-microcontoller-%C2%B5c-and-microprocessor-%C2%B5p/)
...
| 2. | `8051` 微控制器有 `128` 字节的内部内存。但是 `8051` 的现代变种有 `256` 字节的内存。 | `MSP430` 微控制器具有 `28/256/512` 字节的 `RAM/SRAM`。 |
