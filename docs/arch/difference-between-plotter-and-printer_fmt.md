...
> 原文：[https://www.geeksforgeeks.org/difference-between-plotter-and-printer/](https://www.geeksforgeeks.org/difference-between-plotter-and-printer/)
...
| 没有。 | 计划者 | 打印机 |
| --- | --- | --- |
| one | 它可以读取 `DWG`、`CDR`、`AI` 和其他矢量格式的文件。 | 它可以读取 `BMP`，`PDF` 和 `JPG` `TIFF` 格式。 |
