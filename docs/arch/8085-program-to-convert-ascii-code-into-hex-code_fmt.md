...
> 原文: [https://www.geeksforgeeks.org/8085-program-to-convert-ascii-code-into-hex-code/](https://www.geeksforgeeks.org/8085-program-to-convert-ascii-code-into-hex-code/)

## 问题
编写一个汇编级语言程序，将 ASCII 代码转换为各自的 HEX Code。
...
| `2003` | `SUI 30H` | `A <- A - 30H` |
| `2005` | `CPI 0AH` | 比较 `A` 与 `0AH` |
| `2007` | `JC 200D` | 检查进位，若 `C=1` 则跳转 |
