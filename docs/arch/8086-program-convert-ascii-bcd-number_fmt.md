...
> 原文: [https://www.geeksforgeeks.org/8086-program-convert-ascii-bcd-number/](https://www.geeksforgeeks.org/8086-program-convert-ascii-bcd-number/)

## 问题
编写程序将 ASCII 转换为 BCD 8 位数字，起始地址为 `2000`，数字存储在 `2050` 内存地址，并将结果存储到 `3050` 内存地址。
...
3.  `HLT` is used to pause the program.