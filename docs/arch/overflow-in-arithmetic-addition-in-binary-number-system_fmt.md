...
n 位 2 的补数系统可以表示从![- 2^{n-1}  ](img/8f0f623a4cb76cdfb53aba4eb83de05b.png "Rendered by QuickLaTeX.com")到![2^{n-1} -1  ](img/0786ddc219b3fc740fa9e8899676a91d.png "Rendered by QuickLaTeX.com")的数字，4 位可以表示从 **( -8 到 7 )** 的数字，5 位可以表示 2 的补数系统中从 **( -16 到 15 )** 的数字。
...
读者也可以尝试 `C-in` `C-out` 和 `MSB` 的其他组合来检查溢出。
