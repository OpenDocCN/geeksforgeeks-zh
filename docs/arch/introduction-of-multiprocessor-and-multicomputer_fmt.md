...
> 原文：[https://www.geeksforgeeks.org/introduction-of-multiprocessor-and-multicomputer/](https://www.geeksforgeeks.org/introduction-of-multiprocessor-and-multicomputer/)
...
一个多计算机系统是由多个处理器连接在一起解决一个问题的计算机系统。每个处理器都有自己的存储器，并且可以被特定的处理器访问，这些处理器可以通过互连网络相互通信。
