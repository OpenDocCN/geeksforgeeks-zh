...
> 原文: [https://www.geeksforgeeks.org/signal-processing-and-time-series-data-analysis/](https://www.geeksforgeeks.org/signal-processing-and-time-series-data-analysis/)
...
这里我们计算 5 天的均线。通常，对于第一种情况，我们要么采用当前收盘价，要么采用前 5 天的 `SMA` 值来获得第一个均线。对于下面的例子，当前收盘价(22.81 美元)作为第一个均线值。
