...
> 原文：[https://www.geeksforgeeks.org/stack-frame-in-computer-organization/](https://www.geeksforgeeks.org/stack-frame-in-computer-organization/)
...
| findProduct() a = 6 b=6 product = a* b |
| --- |
| main() a = 6 b = 6 product = 调用 findProduct() sum = 调用 findSum() |
...
| --- |
| main() a = 6 b=6 product = 36 sum = 调用 findSum() |
