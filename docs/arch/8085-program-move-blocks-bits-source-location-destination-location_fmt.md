...
> 原文：[https://www.geeksforgeeks.org/8085-program-move-blocks-bits-source-location-destination-location/](https://www.geeksforgeeks.org/8085-program-move-blocks-bits-source-location-destination-location/)

## 问题
编写一个程序，将从 `2500` 开始的源位置的位块移动到从 `2600` 开始的目标位置，其中块的大小为 `05` 字节。
