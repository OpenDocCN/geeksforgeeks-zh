...
> 原文: [https://www.geeksforgeeks.org/mongodb-python-insert-update-data/](https://www.geeksforgeeks.org/mongodb-python-insert-update-data/)
...
### Step 3 – Insert
要插入数据，需创建一个字典对象并将数据插入数据库。用于插入数据的方法：
