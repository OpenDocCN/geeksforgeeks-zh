...
> 原文: [https://www.geeksforgeeks.org/python-program-to-implement-full-subtractor/](https://www.geeksforgeeks.org/python-program-to-implement-full-subtractor/)

## 先决条件

[数字逻辑中的全减法器](https://www.geeksforgeeks.org/full-subtractor-in-digital-logic/)
...
*   我们取三个输入 `A`、`B` 和 `Bin`。
*   应用 `(A XOR B) XOR Bin` 给出差值。
*   应用 `Ā Bin + Ā B + B Bin` 给出 `B-Out` 的值。
