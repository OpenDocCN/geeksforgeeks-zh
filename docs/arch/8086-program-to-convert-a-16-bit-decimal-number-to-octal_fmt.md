...
> 原文:[https://www.geeksforgeeks.org/8086-program-to-convert-a-16-bit-decimal-number-to-octal/](https://www.geeksforgeeks.org/8086-program-to-convert-a-16-bit-decimal-number-to-octal/)

## 问题
给我们一个 16 位的十进制数，我们必须以八进制格式打印这个数。
