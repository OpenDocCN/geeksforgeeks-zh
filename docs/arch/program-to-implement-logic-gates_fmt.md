...
> 原文：[https://www.geeksforgeeks.org/program-to-implement-logic-gates/](https://www.geeksforgeeks.org/program-to-implement-logic-gates/)
...
或门在两个输入中至少有一个为 1 时给出 1 的输出，否则给出 0。
...
与非门（取反的与门）在两个输入都为 1 时给出 0 的输出，否则给出 1。
...
或非门（取反的或门）在两个输入都为 0 时给出 1 的输出，否则给出 0。
