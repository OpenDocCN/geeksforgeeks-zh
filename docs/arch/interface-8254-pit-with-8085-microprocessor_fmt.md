...
> 原文：[https://www.geeksforgeeks.org/interface-8254-pit-with-8085-microprocessor/](https://www.geeksforgeeks.org/interface-8254-pit-with-8085-microprocessor/)

## 先决条件
[8254 控制寄存器和操作模式](https://www.geeksforgeeks.org/8254-control-word-operating-modes/)

## 问题
在 `8085` 微处理器中编写一个汇编语言程序，如果 `8254` 的时钟频率为 `2 MHz`，该程序通过使用计数器 `1` 作为二进制计数器来产生 `1 kHz` 方波。

## 假设
假设 `C0`（计数器 `0`）、`C1`（计数器 `1`）、`C2`（计数器 `2`）、控制寄存器的端口地址为 `80H`、`81H`、`82H`、`83H`。
