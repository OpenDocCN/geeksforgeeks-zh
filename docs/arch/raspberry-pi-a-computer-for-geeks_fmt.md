...
> 原文：[https://www.geeksforgeeks.org/raspberry-pi-a-computer-for-geeks/](https://www.geeksforgeeks.org/raspberry-pi-a-computer-for-geeks/)

## 什么是树莓派？
树莓派是总部位于英国的树莓派基金会开发的“信用卡大小的计算机板”的名称。它可以插在电视或显示器上，并提供全功能的计算机功能。
...
## 项目示例
可以通过连接一些仪器，把它变成一个气象站，用来检查温度、风速、湿度等。
