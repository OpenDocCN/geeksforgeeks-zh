...
> 原文: [https://www.geeksforgeeks.org/register-allocation-in-code-generation/](https://www.geeksforgeeks.org/register-allocation-in-code-generation/)
...
*   注意，`k-可着色图`的发现是一个 NP 完全问题，所以我们需要一个近似。
