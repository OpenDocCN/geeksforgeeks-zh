...
> 原文：[https://www.geeksforgeeks.org/conventional-computing-vs-quantum-computing/](https://www.geeksforgeeks.org/conventional-computing-vs-quantum-computing/)
...
| 信息的存储和操纵是基于“位”，位是基于电压或电荷的；低为 0，高为 1。 | 信息存储和操纵是基于`量子比特(Quantum Bit)`或`量子比特`(`qubit`)，它是基于电子的自旋或单个光子的偏振。 |
