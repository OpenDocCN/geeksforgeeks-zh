...
> 原文：[https://www.geeksforgeeks.org/difference-between-multiplexer-and-demultiplexer/](https://www.geeksforgeeks.org/difference-between-multiplexer-and-demultiplexer/)
...
## 2. 多路分解器
多路分解器是一个数据分配器，它接受一个输入并给出几个输出。在解复用器中，我们有 `1` 条输入线和 `2^n` 条输出线，其中 `n` 是选择线。
