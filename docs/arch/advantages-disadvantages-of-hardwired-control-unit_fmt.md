...
> 原文：[https://www.geeksforgeeks.org/advantages-disadvantages-of-hardwired-control-unit/](https://www.geeksforgeeks.org/advantages-disadvantages-of-hardwired-control-unit/)
...
**硬连线控制单元：**
为了解释指令并为它们产生控制信号，该控制单元使用固定的逻辑电路。为了产生信号，固定逻辑电路使用控制步进计数器、指令寄存器（`IR`）及代码标志和一些外部输入信号（如中断信号）的内容。下图显示了硬连线控制单元的架构视图，如下所示。
