...
> 原文：[https://www.geeksforgeeks.org/difference-between-von-neumann-and-harvard-architecture/](https://www.geeksforgeeks.org/difference-between-von-neumann-and-harvard-architecture/)

## 冯·诺依曼架构

冯·诺依曼架构是一种数字计算机架构，其设计基于存储程序计算机的概念，其中程序数据和指令数据存储在同一存储器中。这个建筑是由著名的数学家和物理学家约翰·冯·诺依曼在 1945 年设计的。
