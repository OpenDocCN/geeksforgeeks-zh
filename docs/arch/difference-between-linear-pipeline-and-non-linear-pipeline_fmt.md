...
> 原文：[https://www.geeksforgeeks.org/difference-between-linear-pipeline-and-non-linear-pipeline/](https://www.geeksforgeeks.org/difference-between-linear-pipeline-and-non-linear-pipeline/)
...
| 5. | 它生成一个预订表。 | 它可以生成多个预订表。 |
| 6. | 它允许简单的功能划分。 | 函数划分在非线性流水线中是困难的。 |