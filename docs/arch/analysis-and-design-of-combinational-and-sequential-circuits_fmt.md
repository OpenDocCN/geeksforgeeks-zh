...
> 原文：[https://www.geeksforgeeks.org/analysis-and-design-of-combinational-and-sequential-circuits/](https://www.geeksforgeeks.org/analysis-and-design-of-combinational-and-sequential-circuits/)
...
时序电路的例子有寄存器、移位寄存器、计数器、纹波计数器、同步计数器等。