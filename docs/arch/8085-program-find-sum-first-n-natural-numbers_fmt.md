...
> 原文：[https://www.geeksforgeeks.org/8085-program-find-sum-first-n-natural-numbers/](https://www.geeksforgeeks.org/8085-program-find-sum-first-n-natural-numbers/)

## 问题
用 8085 微处理器编写一个计算前 n 个自然数之和的汇编语言程序。
...
输入：`14H`
继续从输入中减去 2，直到减少到 0。
由于 `14H` 变为 0 之前要做 10<sub>10</sub> 次减法，所以商为 10<sub>10</sub> => `0AH`。
