...
> 原文：[https://www.geeksforgeeks.org/arithmetic-operations-of-binary-numbers/](https://www.geeksforgeeks.org/arithmetic-operations-of-binary-numbers/)
...
这里 0-1 应该是 1 和 1。需要从下一个高阶位借用 1 来从 0 减去 1。所以，结果变成了 0。
