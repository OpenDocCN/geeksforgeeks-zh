...
> 原文: [https://www.geeksforgeeks.org/difference-between-ddr3-and-ddr4/](https://www.geeksforgeeks.org/difference-between-ddr3-and-ddr4/)
...
| 7. | `DDR3` 的时钟速度从 `800 MHz` 到 `2133 MHz` 不等。 | 而 `DDR4` 的最小时钟速度为 `2133 MHz`，没有定义最大时钟速度。 |
