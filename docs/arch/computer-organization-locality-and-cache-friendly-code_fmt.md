...
> 原文：[https://www.geeksforgeeks.org/computer-organization-locality-and-cache-friendly-code/](https://www.geeksforgeeks.org/computer-organization-locality-and-cache-friendly-code/)
...
**例-1：** 通过以下多维数组代码的简单示例，可以理解上述上下文。考虑 `sumarrayrows()` 函数，该函数按行主顺序对二维数组的元素求和：
