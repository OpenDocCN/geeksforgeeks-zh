...
> 原文: [https://www.geeksforgeeks.org/operational-amplifier-op-amp-in-digital-electronics/](https://www.geeksforgeeks.org/operational-amplifier-op-amp-in-digital-electronics/)
...
**7. 电源电压抑制比(`SVRR`):** 定义为运算放大器的输入失调电压变化、 `V_io` 与电源电压变化、 `V` 的比值。
