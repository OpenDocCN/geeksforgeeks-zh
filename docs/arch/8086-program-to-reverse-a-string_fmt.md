...
> 原文: [https://www.geeksforgeeks.org/8086-program-to-reverse-a-string/](https://www.geeksforgeeks.org/8086-program-to-reverse-a-string/)

## 问题
给定一个字符串，我们必须反转该字符串并打印反转后的字符串。
