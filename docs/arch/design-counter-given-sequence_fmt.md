...
> 原文: [https://www.geeksforgeeks.org/design-counter-given-sequence/](https://www.geeksforgeeks.org/design-counter-given-sequence/)

先决条件 – [计数器](https://www.geeksforgeeks.org/counters-in-digital-logic/)

## 问题
使用 T 触发器为序列设计同步计数器: `0 -> 1 -> 3 -> 4 -> 5 -> 7 -> 0`。
...
用 K-Map(卡诺图)求 `Q3`、`Q2`、`Q1` 中 `T3`、`T2`、`T1` 的值:
