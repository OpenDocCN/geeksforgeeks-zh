...
> 原文: [https://www.geeksforgeeks.org/python-program-to-implement-half-subtractor/](https://www.geeksforgeeks.org/python-program-to-implement-half-subtractor/)
...
> *借用: 1*
>
> **说明:** 根据逻辑表达式差 = `A XOR B` 即 `0 XOR 1 = 1`，借 = `Ā AND B` 即 `1 AND 1 = 1`
>
> **输入:** `A = 1`；`B = 1`
>
> **输出:** 差值: 0
