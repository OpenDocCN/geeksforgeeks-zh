...
> 原文: [https://www.geeksforgeeks.org/instruction-word-size-in-microprocessor/](https://www.geeksforgeeks.org/instruction-word-size-in-microprocessor/)
...
**注意:** 这些指令需要三个存储位置来存储二进制代码。助记符后面总是跟着 16 位（或地址）。