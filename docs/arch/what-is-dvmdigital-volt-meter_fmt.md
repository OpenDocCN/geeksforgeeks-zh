...
> 原文:[https://www . geesforgeks . org/what-is-dvm digital-volt-meter/](https://www.geeksforgeks.org/what-is-dvmdigital-volt-meter/)
...
*   数字电压表用于测量电器消耗的`AC`或`DC`电压，并以数字形式直接显示该值，而不是使用指针偏转。
...
*   其次，数字电压表比早期系统更稳定，因此更可靠。他们可以测量`AC`和`DC`电压系统。
