...
> 原文: [https://www.geeksforgeeks.org/difference-between-implied-addressing-mode-and-immediate-addressing-mode/](https://www.geeksforgeeks.org/difference-between-implied-addressing-mode-and-immediate-addressing-mode/)

先决条件 – [寻址模式](https://www.geeksforgeeks.org/addressing-modes/)

## 1. 隐含寻址模式
在隐含寻址模式下，操作数在指令定义中隐含指定。所有引用使用`累加器`的寄存器的指令都是隐含模式指令。堆栈式计算机中的零地址指令也是隐含模式指令。因此，它也被称为堆栈寻址模式。
