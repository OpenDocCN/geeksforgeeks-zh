...
> 原文: [https://www.geeksforgeeks.org/conversion-of-j-k-flip-flop-into-t-flip-flop/](https://www.geeksforgeeks.org/conversion-of-j-k-flip-flop-into-t-flip-flop/)
...
### Step-1
构造 `T` 触发器的特征表和 `J-K` 触发器的激励表。

![](img/aa26ec694f1288460ba98c9b75d6537b.png)

### Step-2
使用 `K map`，找出 `J` 和 `K` 关于 `T` 的布尔表达式。
