...
> 原文：`https://www.geeksforgeeks.org/advantages-and-disadvantages-of-optical-disks/`
...
*   **复制–**
    使用光盘制作副本并不容易，因为这表明是在 `u盘` 上。说到刻录的方式，应该有一个软件是独立的硬件。尽管有很多人支持这个功能，但最新版本的 `windows` 包含一个编写软件。
*   **用户友好–**
