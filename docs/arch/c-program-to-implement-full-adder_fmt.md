...
> 原文: [https://www.geeksforgeeks.org/c-program-to-implement-full-adder/](https://www.geeksforgeeks.org/c-program-to-implement-full-adder/)
...
[全加器](https://www.geeksforgeeks.org/full-adder-in-digital-logic/) 是对三个 1 位二进制数进行加法运算的组合电路。全加器有三个输入状态和两个输出状态。两个输出是求和和进位。
