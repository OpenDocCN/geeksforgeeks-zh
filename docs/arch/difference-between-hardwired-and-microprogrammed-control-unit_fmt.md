...
> 原文：[https://www.geeksforgeeks.org/difference-between-hardwired-and-microprogrammed-control-unit/](https://www.geeksforgeeks.org/difference-between-hardwired-and-microprogrammed-control-unit/)

先决条件 – [硬连线和微编程控制单元](https://www.geeksforgeeks.org/computer-organization-hardwired-vs-micro-programmed-control-unit/)

控制单元使用两种组织之一产生控制信号：`hardwired control unit`、`microprogrammed control unit`。
