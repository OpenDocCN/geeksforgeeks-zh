...
> 原文: [https://www.geeksforgeeks.org/difference-between-relative-addressing-mode-and-direct-addressing-mode/](https://www.geeksforgeeks.org/difference-between-relative-addressing-mode-and-direct-addressing-mode/)
...
| 2. | 相对模式有三种：`PC` 相对、索引寄存器相对、基址寄存器相对寻址模式。 | 直接寻址模式没有类型。 |
