...
> 原文：[https://www.geeksforgeeks.org/difference-between-at-and-atx-power-supply/](https://www.geeksforgeeks.org/difference-between-at-and-atx-power-supply/)

**AT**和**ATX**代表先进技术电源和先进技术扩展电源。两种都是开关电源（`SMPS`）。开关模式电源向电负载提供电能。`SMPS` 使用开关调节器来有效转换电能。
