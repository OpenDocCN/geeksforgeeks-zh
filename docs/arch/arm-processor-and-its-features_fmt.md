...
> 原文: [https://www.geeksforgeeks.org/arm-processor-and-its-features/](https://www.geeksforgeeks.org/arm-processor-and-its-features/)
...
`ARM`处理器的架构由`高级 RISC 机`打造，因此得名`ARM`。这需要很少的指令集和晶体管。它的尺寸很小。这就是它非常适合小尺寸设备的原因。它的功耗更低，电路复杂度也更低。
