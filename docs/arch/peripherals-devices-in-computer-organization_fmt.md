...
> 原文：[`https://www.geeksforgeeks.org/peripherals-devices-in-computer-organization/`](https://www.geeksforgeeks.org/peripherals-devices-in-computer-organization/)
...
3.  **存储设备**
    存储设备用于存储系统中执行任何操作所需的数据。存储设备是最必需的设备之一，并且提供更好的兼容性。
    **例：**
    ```
