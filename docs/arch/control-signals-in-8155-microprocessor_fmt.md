...
> 原文：[https://www.geeksforgeeks.org/control-signals-in-8155-microprocessor/](https://www.geeksforgeeks.org/control-signals-in-8155-microprocessor/)
...
3.  `INTR`（中断请求）：
    从名称本身可以清楚地看出，`INT` 信号的上升沿产生该信号。每当中断触发器 `INT` 被使能时，就会发生这种情况。这可以用来中断微处理器。
4.  `INT`（中断使能）：
