...
> 原文: [https://www.geeksforgeeks.org/differences-between-data-paths/](https://www.geeksforgeeks.org/differences-between-data-paths/)

先决条件 – [`算术逻辑单元`和`数据路径`](https://www.geeksforgeeks.org/computer-organization-alu-and-data-path/)
