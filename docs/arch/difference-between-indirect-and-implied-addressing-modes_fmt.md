...
> 原文: [https://www.geeksforgeeks.org/difference-between-indirect-and-implied-addressing-modes/](https://www.geeksforgeeks.org/difference-between-indirect-and-implied-addressing-modes/)
...
L1: INC AL
    LOOP L1 
```
这里，每次循环执行时，`AL` 将增加 1。因此，指令 `INC AL` 中隐含了 1。
