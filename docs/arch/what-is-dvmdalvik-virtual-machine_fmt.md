...
> 原文:[https://www.geeksforgeeks.org/what-is-dvmdalvik-virtual-machine/](https://www.geeksforgeeks.org/what-is-dvmdalvik-virtual-machine/)
...
Java 编译器将 Java 源代码转换成 `Java 字节码`。`类`)。然后 `DEX 编译器`将此转换为 `()。类`)文件，即 `.dex` "文件。
