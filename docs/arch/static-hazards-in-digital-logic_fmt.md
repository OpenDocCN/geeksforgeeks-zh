...
> 原文: [https://www.geeksforgeeks.org/static-hazards-in-digital-logic/](https://www.geeksforgeeks.org/static-hazards-in-digital-logic/)
...
我们有输出，比如 `F`，如下所示：`F(P, Q, R) = QR+P\overline{R} =\sum m \{3, 4, 6, 7\}`
