...
> 原文:[https://www.geeksforgeeks.org/co-processor-computer-architecture/](https://www.geeksforgeeks.org/co-processor-computer-architecture/)
...
*   对于一个 `ARM` 处理器，我们可以连接协处理器。一个协处理器在增加的时候，我们需要扩展核心 CPU 的指令集或者增加可配置的寄存器，来增加处理能力。协处理器接口允许几个协处理器连接到 `ARM` 中央处理器。
