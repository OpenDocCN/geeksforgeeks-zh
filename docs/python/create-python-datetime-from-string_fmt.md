...
> 原文：[https://www.geeksforgeeks.org/create-python-datetime-from-string/](https://www.geeksforgeeks.org/create-python-datetime-from-string/)
...
> 现在输入日期字符串的类型是：`<class 'datetime.datetime'>`
>
...
| `%c` | 区域设置的适当日期和时间表示。 | Tue Aug 16 21:30:00 2013 |
| `%x` | 区域设置的适当日期表示。 | 08/16/13 |
| `%%` | 文字“%”字符。 | % |