...
> 原文: [https://www.geeksforgeeks.org/python-convert-a-list-of-multiple-integers-into-a-single-integer/](https://www.geeksforgeeks.org/python-convert-a-list-of-multiple-integers-into-a-single-integer/)
...
这个程序的一个小变化导致在计算和时计算量减少，即使用 `reduce()`。这利用了霍纳规则，该规则对代表数字的多项式进行因子化，以减少乘法次数。
