...
> 原文: [https://www.geeksforgeeks.org/python-consecutive-division-in-list/](https://www.geeksforgeeks.org/python-consecutive-division-in-list/)

给定一个列表，对中间步骤中获得的每个商执行连续除法，并将连续元素视为除数。

> 输入: `test_list = [1000, 50, 5, 10, 2]`
> 输出: `0.2`
