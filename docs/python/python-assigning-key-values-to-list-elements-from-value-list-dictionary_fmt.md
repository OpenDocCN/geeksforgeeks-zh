...
> 原文: [https://www.geeksforgeeks.org/python-assigning-key-values-to-list-elements-from-value-list-dictionary/](https://www.geeksforgeeks.org/python-assigning-key-values-to-list-elements-from-value-list-dictionary/)

给定元素列表，用值列表中匹配值的键映射它们。

**输入** : `test_list = [4, 6, 3, 5, 3]`, `test_dict = {"Gfg":[5, 3, 6], "is":[8, 4]}`
**输出** : `['is', 'Gfg', 'Gfg', 'Gfg']`
