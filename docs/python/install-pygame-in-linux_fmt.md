...
因为 `PyGame` 只支持 python 3.7.7 或更高版本，所以请确保您使用的是最新版本的 python。键入以下命令检查版本。

```
python3 --version
```

**注意:** 如果没有安装 python 请参考[在 Linux 系统中安装 Python](https://www.geeksforgeeks.org/how-to-install-python-on-linux/)。
