...
> 原文: [https://www.geeksforgeeks.org/python-append-multitype-values-in-dictionary/](https://www.geeksforgeeks.org/python-append-multitype-values-in-dictionary/)
...
>
> **输入**: `test_dict = {'gfg': '123', 'is': {}, 'best': ['极客']}`
...
> 更新词典: `{'is': {'b': 6, 'a': 5, 'c': 7}, 'best': [1, 2, 3, 4, 5], 'gfg': 'geekforgeeks'}`