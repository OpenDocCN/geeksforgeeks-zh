...
> 原文: [https://www.geeksforgeeks.org/python-create-a-dictionary-with-key-as-first-character-and-value-as-words-starting-with-that-character/](https://www.geeksforgeeks.org/python-create-a-dictionary-with-key-as-first-character-and-value-as-words-starting-with-that-character/)
...
*   然后我们将使用 [`split()`](https://www.geeksforgeeks.org/python-string-split/) 将字符串拆分成单词，并形成这些单词的列表。
