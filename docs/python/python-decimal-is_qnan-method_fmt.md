...
> 原文: [https://www.geeksforgeeks.org/python-decimal-is_qnan-method/](https://www.geeksforgeeks.org/python-decimal-is_qnan-method/)

`Decimal.is_qnan()` 是 `Decimal` 类的方法，用于检查 `Decimal` 值是否是“相当 NaN”的值。
...
## 返回
`true` – 如果十进制值相当于 `NaN` 值；否则为 `false`
