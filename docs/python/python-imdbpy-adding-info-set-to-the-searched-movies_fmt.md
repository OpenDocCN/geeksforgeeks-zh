...
> 原文: [https://www.geeksforgeeks.org/python-imdbpy-adding-info-set-to-the-searched-movies/](https://www.geeksforgeeks.org/python-imdbpy-adding-info-set-to-the-searched-movies/)
...
> **语法:** `IMDB_object.update(movie_object, info=['plot', 'tagline'])`
>
