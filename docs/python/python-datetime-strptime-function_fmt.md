...
> **语法**: `datetime.strptime(time_data, format_data)`
>
> **参数:**
>
> *   `time_data` 是以字符串格式显示的时间
...
> **语法：** `datetime.datetime.strptime(input, format)`
>
> **参数:**
>
> *   `input` 是字符串日期时间
> *   `format` 是格式–“yyyy-mm-DD”
> *   `datetime` 是模块
...
> **语法:** `datetime.strptime(input_date, "%d/%m/%Y %H:%M:%S")`
>
> **参数:**
>
> *   `datetime` 是模块
