...
> 原文：[https://www.geeksforgeeks.org/how-to-add-multiple-columns-in-pyspark-dataframes/](https://www.geeksforgeeks.org/how-to-add-multiple-columns-in-pyspark-dataframes/)

在本文中，我们将看到在 PySpark 数据框中添加多列的不同方式。

让我们创建一个示例数据框进行演示：

**使用的数据集：** `Cricket_data_set_odi.csv`
