...
> 原文: [https://www.geeksforgeeks.org/pyglet-setting-selection-range-in-incremental-text-layout/](https://www.geeksforgeeks.org/pyglet-setting-selection-range-in-incremental-text-layout/)
...
为了创建窗口，我们对布局对象使用 `set_selection` 方法。

**语法:** `layout.set_selection(start, end)`
