...
> 原文: [https://www.geeksforgeeks.org/python-delete-items-from-dictionary-while-iterating/](https://www.geeksforgeeks.org/python-delete-items-from-dictionary-while-iterating/)
...
创建列表 `delete` 并添加我们想要删除的所有值的键。遍历列表中的每个键，并不断删除它们。
