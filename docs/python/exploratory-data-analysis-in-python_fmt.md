...
> 原文：[https://www.geeksforgeeks.org/exploratory-data-analysis-in-python/](https://www.geeksforgeeks.org/exploratory-data-analysis-in-python/)
...
- 分组数据（以分组的基本分组）
- 方差分析（ANOVA），这是一种将一组观察值中的变化分成不同部分的计算方法。
- 相关和相关方法
