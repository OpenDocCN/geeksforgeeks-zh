...
> 原文: [https://www.geeksforgeeks.org/deep-convolutional-gan-with-keras/](https://www.geeksforgeeks.org/deep-convolutional-gan-with-keras/)
...
# call the training function with 10 epochs and record time
%%time
