...
> 原文: [https://www.geeksforgeeks.org/implementation-of-xor-linked-list-in-python/](https://www.geeksforgeeks.org/implementation-of-xor-linked-list-in-python/)
...
在 Python 垃圾收集器中，当节点的对象为 XORed 时，收集节点并减少节点对象的引用计数，Python 认为没有办法访问节点，所以我们使用 `__nodes` 来存储节点的对象，只是为了防止它成为垃圾。