...
> 原文: [https://www.geeksforgeeks.org/internal-structure-of-python-dictionary/](https://www.geeksforgeeks.org/internal-structure-of-python-dictionary/)
...
## 例 3: 键值不存储在字典中，即使我们增加了键值的大小，字典的大小也不会改变
