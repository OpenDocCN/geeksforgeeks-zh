# Python API `unsubscribe_list()` 在 Tweepy 中

> 原文: [https://www.geeksforgeeks.org/python-api-unsubscribe_list-in-tweepy/](https://www.geeksforgeeks.org/python-api-unsubscribe_list-in-tweepy/)
