...
> 原文: [https://www.geeksforgeeks.org/get-zip-code-with-given-location-using-geopy-in-python/](https://www.geeksforgeeks.org/get-zip-code-with-given-location-using-geopy-in-python/)
...
**步骤#3:** 现在获取一个带有 `geographic()` 的完整地址。
