# 使用 youtube_dl 模块下载 YouTube 视频

> 原文: [https://www.geeksforgeeks.org/python-download-youtube-videos-using-youtube_dl-module/](https://www.geeksforgeeks.org/python-download-youtube-videos-using-youtube_dl-module/)
