...
> 原文: [https://www.geeksforgeeks.org/python-add-prefix-to-each-key-name-in-dictionary/](https://www.geeksforgeeks.org/python-add-prefix-to-each-key-name-in-dictionary/)
