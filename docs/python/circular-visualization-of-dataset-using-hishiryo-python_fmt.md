...
> 原文: [https://www.geeksforgeeks.org/circular-visualization-of-dataset-using-hishiryo-python/](https://www.geeksforgeeks.org/circular-visualization-of-dataset-using-hishiryo-python/)
...
> 语法: `hishiryoconverter.convertcsvtoradialbitmap(输入路径, 分隔符, 输出路径, 半径, 无, “点”)`
>
> 参数:
>
> *   `输入路径`: csv 的路径。
