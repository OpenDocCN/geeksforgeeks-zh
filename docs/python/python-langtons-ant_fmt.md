...
> 参考：[https://www.geeksforgeeks.org/python-langtons-ant/](https://www.geeksforgeeks.org/python-langtons-ant/)
...
参考[对朗顿蚂蚁的视觉解说](https://www.youtube.com/watch?v=NWBToaXK5T0)。这有助于直观地了解蚂蚁是如何工作的。
