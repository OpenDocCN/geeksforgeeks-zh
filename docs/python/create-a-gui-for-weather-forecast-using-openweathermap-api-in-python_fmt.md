...
*   [`Tkinter`](https://www.geeksforgeeks.org/python-gui-tkinter/)：它是创建 GUI 应用最快最简单的方法。这包含在 Python 标准模块中，所以不需要到外部安装。
*   [`PIL`](https://pillow.readthedocs.io/)：PIL 是 python 图像库，为 Python 解释器提供图像编辑功能。
*   [`json`](https://www.geeksforgeeks.org/working-with-json-data-in-python/)：该模块用于处理 json 文件，内置 Python。所以不需要从外部安装。
*   [`requests`](https://www.geeksforgeeks.org/python-requests-tutorial/)：它用于向指定的网址发出 HTTP 请求。这个模块没有内置 Python。要安装它，请在终端中键入以下命令。
...
![](img/ee4b042cccac852281bd011144f8f2b4.png) `moon.png` 档案
![](img/a5b445d11c0860d1617ee9c156f8b024.png) `sun.png`
![](img/9bdc40f3d1b7ad021c1e3d423c3b2616.png) `logo.png`
