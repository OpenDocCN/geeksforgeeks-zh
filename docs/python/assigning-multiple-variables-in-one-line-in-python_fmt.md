...
> 原文：[https://www.geeksforgeeks.org/assigning-multiple-variables-in-one-line-in-python/](https://www.geeksforgeeks.org/assigning-multiple-variables-in-one-line-in-python/)
...
以这种方式声明变量时，必须注意名称及其对应值的顺序。赋值运算符左边的第一个变量名被赋值为右边的第一个值，以此类推。
