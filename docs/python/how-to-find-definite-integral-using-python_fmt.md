...
> 原文: [https://www.geeksforgeeks.org/how-to-find-definite-integral-using-python/](https://www.geeksforgeeks.org/how-to-find-definite-integral-using-python/)
...
*   [`numpy`](https://www.geeksforgeeks.org/numpy-in-python-set-1-introduction/)：定义定积分范围的辅助库。
*   `sympy`：库容易计算积分的数值解。
