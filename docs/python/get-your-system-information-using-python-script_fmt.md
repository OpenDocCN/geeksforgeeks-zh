...
> 原文: [https://www.geeksforgeeks.org/get-your-system-information-using-python-script/](https://www.geeksforgeeks.org/get-your-system-information-using-python-script/)
...
我们将使用 [`subprocess`](https://docs.python.org/3/library/subprocess.html) 模块与 `cmd` 交互，并将信息检索到您的 python IDE 中。我们可以通过 `subprocess` 模块读取 `cmd` 命令。它是 python 中的一个内置模块。
