...
> 原文: [https://www.geeksforgeeks.org/python-convert-matrix-to-dictionary/](https://www.geeksforgeeks.org/python-convert-matrix-to-dictionary/)
...
上述功能的组合可以用来解决这个问题。在这种情况下，字典理解有助于构造字典，`enumerate()` 有助于迭代，就像上述方法中的 `range()` 一样。
