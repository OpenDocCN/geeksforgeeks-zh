...
> 原文:[https://www.geeksforgeeks.org/java-vs-python-which-one-should-i-learn/](https://www.geeksforgeeks.org/java-vs-python-which-one-should-i-learn/)

很多时候你会听到人们说 [`Java`](https://www.geeksforgeeks.org/java/) 比 [`Python`](https://www.geeksforgeeks.org/python-programming-language/) 快或者 [`Python`](https://www.geeksforgeeks.org/python-programming-language/) 比 `Java` 更安全，以及它们之间的很多其他种类的比较。
...
在 `Java` 中，我们都知道源文件首先被转换成字节码，然后 [`JVM`](https://www.geeksforgeeks.org/jvm- java-virtual-machine/) (Java Virtual Machine)运行该字节码来给出输出，这是一个非常简单的过程。`Python` 是一种解释语言，但这并不意味着它没有编译过程，它有，而且会被编译。
...
你们都在想 `Python` 更快但是不行！`Java` 更快是因为 `JVM`，它比 [`PVM`](https://www.geeksforgeeks.org/pvm-python-virtual-machine/) (`Python` 虚拟机)执行字节码更快，因此使这个过程变得超级简单和快速。
