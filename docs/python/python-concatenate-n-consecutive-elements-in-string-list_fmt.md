# Python |串联字符串列表中的N个连续元素

> 原文：[https://www.geeksforgeeks.org/python-concatenate-n-consecutive-elements-in-string-list/](https://www.geeksforgeeks.org/python-concatenate-n-consecutive-elements-in-string-list/)

有时，在处理数据时，我们会遇到一个问题，即我们需要在字符串列表中执行N个连续字符串的连接。这可以有许多跨域的应用。让我们讨论执行这项任务的某些方法。
