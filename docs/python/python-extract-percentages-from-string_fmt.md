...
> 原文: [https://www.geeksforgeeks.org/python-extract-percentages-from-string/](https://www.geeksforgeeks.org/python-extract-percentages-from-string/)
...
在这种情况下，我们使用后缀中带有“%”符号的适当正则表达式，并使用 `findall()` 从字符串中获取此类数字的所有出现。
