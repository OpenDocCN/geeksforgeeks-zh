...
> 原文：[https://www.geeksforgeeks.org/python-decimal-adjusted-method/](https://www.geeksforgeeks.org/python-decimal-adjusted-method/)

`Decimal.adjusted()`是一个`Decimal`类方法，它在移出系数最右边的数字直到只剩下前导数字后返回调整后的指数。
