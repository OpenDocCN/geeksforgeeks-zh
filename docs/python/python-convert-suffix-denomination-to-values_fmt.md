...
> 原文: [https://www.geeksforgeeks.org/python-convert-suffix-denomination-to-values/](https://www.geeksforgeeks.org/python-convert-suffix-denomination-to-values/)

给定带面额后缀的字符串列表，任务是编写 Python 程序将字符串转换为其实际值，替代面额实际值。

> **输入**: `test_list = ["25Cr", "7M", "24B", "9L", "2Tr", "17K"]`
> **输出**: `[2500000000.0, 7000000.0, 2400000000.0, 900000.0, 20000000000.0, 17000.0]`
> **解释**: 后缀替换
>
> **输入**: `test_list = ["25Cr", "7M", "24B"]`
> **输出**: `[2500000000.0, 7000000.0, 2400000000.0]`
> **解释**: 后缀按符号符号替换为数字。
