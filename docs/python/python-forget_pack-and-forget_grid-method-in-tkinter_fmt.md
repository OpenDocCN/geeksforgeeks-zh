# Tkinter中的Python：forget_pack()和forget_grid()方法

> 原文：[https://www.geeksforgeeks.org/python-forget_pack-and-forget_grid-method-in-tkinter/](https://www.geeksforgeeks.org/python-forget_pack-and-forget_grid-method-in-tkinter/)
...
遗忘后：
![After forget](img/471717f005efbe0db8dc78a68f7eae83.png)

检索后：
![After retrieval](img/cdd1273ee7072f080600b1886ce5d370.png)

**注意**：忘记前后以及取回后按钮1的位置差异。
...
**注意**：在`forget`和`retrieve`后，按钮1的位置保持不变。用`grid_forget()`方法，检索后可以放在任意网格上，但一般选择原网格。