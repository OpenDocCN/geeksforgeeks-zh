...
> 原文：[https://www.geeksforgeeks.org/how-to-manually-add-a-legend-color-and-legend-font-size-on-a-plotly-figure-in-python/](https://www.geeksforgeeks.org/how-to-manually-add-a-legend-color-and-legend-font-size-on-a-plotly-figure-in-python/)
...
在此条形图中，我们使用 `fig.update_layout()` 方法、`legend_font_color="red"`（此参数允许您设置字体颜色）和 `legend_font_size=19`（此参数允许您设置字体大小）。
...
在此散点图中，我们使用 `fig.update_layout()` 方法、`legend_font_color="gold"`（此参数允许您设置字体颜色）和 `legend_font_size=10`（此参数允许您设置字体大小）。
