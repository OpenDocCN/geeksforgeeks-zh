...
> 原文: [https://www.geeksforgeeks.org/pyglet-setting-exclusive-mouse-for-window/](https://www.geeksforgeeks.org/pyglet-setting-exclusive-mouse-for-window/)
...
>
> **语法:** `window.set_exclusive_mouse(True)`
>
> **自变量:** 它以布尔为自变量
>
> **返回:** 返回 `None`
