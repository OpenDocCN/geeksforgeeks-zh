...
> 原文: [https://www.geeksforgeeks.org/cyclic-redundancy-check-python/](https://www.geeksforgeeks.org/cyclic-redundancy-check-python/)
...
让数据发送的是“EVN”。我们把一个字符串转换成二进制字符串数据。
