# 如何在 Plotly-Python 中定位图例内部？

> 原文：[https://www.geeksforgeeks.org/how-to-position-legends-inside-a-plot-in-plotly-python/](https://www.geeksforgeeks.org/how-to-position-legends-inside-a-plot-in-plotly-python/)

在本文中，我们将学习如何使用 Plotly Express 和 Plotly 隐藏图例。图例是描述图形元素的区域。在 Plotly 中，图例用于在轴上放置图例。
...
在这个例子中，我们在方法的帮助下，通过传递位置为 `x=0.6` 和 `y=1`，将图例定位在图中。
