...
> 原文：[https://www.geeksforgeeks.org/how-are-variables-stored-in-python-stack-or-heap/](https://www.geeksforgeeks.org/how-are-variables-stored-in-python-stack-or-heap/)
...
方法/方法调用和引用存储在**栈内存**中，所有值对象存储在**私有堆中。**
