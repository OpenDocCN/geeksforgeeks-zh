...
> 原文: [https://www.geeksforgeeks.org/insert-image-in-a-jupyter-notebook/](https://www.geeksforgeeks.org/insert-image-in-a-jupyter-notebook/)
...
第一步：这个方法最简单。首先，将单元格的类型更改为 -> Markdown。
