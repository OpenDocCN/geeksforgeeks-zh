...
> 原文:[https://www . geeksforgeeks . org/python-embedded-numbers-summary-in-string-list/](https://www.geeksforgeeks.org/python-embedded-numbers-summation-in-string-list/)
