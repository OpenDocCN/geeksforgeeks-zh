...
> 原文: [https://www.geeksforgeeks.org/python-extract-only-characters-from-given-string/](https://www.geeksforgeeks.org/python-extract-only-characters-from-given-string/)
