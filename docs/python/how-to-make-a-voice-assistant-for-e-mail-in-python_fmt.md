...
> 原文：[https://www.geeksforgeeks.org/how-to-make-a-voice-assistant-for-e-mail-in-python/](https://www.geeksforgeeks.org/how-to-make-a-voice-assistant-for-e-mail-in-python/)
...
*   创建以下功能：
    ...
    *   `check_mails()`：此功能用于检查收件箱主要部分的未读邮件。
*   调用上面创建的函数。
...
# if you run this for the first time it will take you to gmail to choose your account
