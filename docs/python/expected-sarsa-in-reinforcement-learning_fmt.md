...
> 原文: [https://www.geeksforgeeks.org/expected-sarsa-in-reinforcement-learning/](https://www.geeksforgeeks.org/expected-sarsa-in-reinforcement-learning/)
...
*   **SARSA:** ![Q(S_{t}, A_{t}) = Q(S_{t}, A_{t}) + \alpha (R_{t+1}+\gamma Q(S_{t+1}, A_{t+1})-Q(S_{t}, A_{t}))](img/bd58440dc4bb3103830bbbd7dda0475d.png "Rendered by QuickLaTeX.com")
*   **Q-Learning:**
...
牢记理论和公式，让我们用一个实验来比较这三种算法。我们将实现一个 Cliff Walker 作为我们的环境，该环境由[健身房](https://gym.openai.com/)库提供。

**Python 代码来创建类 `Agent`，该类 `Agent` 将被其他代理继承以避免重复代码。**
