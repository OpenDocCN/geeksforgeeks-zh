...
> 原文: [https://www.geeksforgeeks.org/cascading-behavior-in-social-networks/](https://www.geeksforgeeks.org/cascading-behavior-in-social-networks/)

## 先决条件

- [社交网络入门](https://www.geeksforgeeks.org/introduction-to-social-networks-using-networkx-in-python/)
- [Python 基础知识](https://www.geeksforgeeks.org/python-basics/)
