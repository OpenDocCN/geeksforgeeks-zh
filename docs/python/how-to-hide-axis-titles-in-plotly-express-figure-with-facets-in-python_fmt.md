...
> 原文: [https://www.geeksforgeeks.org/how-to-hide-axis-titles-in-plotly-express-figure-with-facets-in-python/](https://www.geeksforgeeks.org/how-to-hide-axis-titles-in-plotly-express-figure-with-facets-in-python/)

在本文中，我们将学习如何在 Python 中隐藏带有小平面的图形中的轴标题。

我们可以通过循环迭代将轴标题设置为空白来隐藏轴。我们只隐藏了 X 轴和 Y 轴的轴，所以我们必须在每次迭代中比较这个条件。
