...
> 原文: [https://www.geeksforgeeks.org/how-to-get-the-tkinter-label-text/](https://www.geeksforgeeks.org/how-to-get-the-tkinter-label-text/)

## 先决条件

[Python 图形用户界面–Tkinter](https://www.geeksforgeeks.org/python-gui-tkinter/)
