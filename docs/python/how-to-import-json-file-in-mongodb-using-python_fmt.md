# 如何用 Python 在 MongoDB 中导入 JSON文件？

> 原文: [https://www.geeksforgeeks.org/how-to-import-json-file-in-mongodb-using-python/](https://www.geeksforgeeks.org/how-to-import-json-file-in-mongodb-using-python/)
...
`JSON` 代表 JavaScript 对象符号。它是一种开放的标准文件格式，并且是带扩展名的数据交换格式 “.json”，它使用人类可读的文本来存储和传输由属性值对和数组数据类型组成的数据对象。
