...
> 原文: [https://www.geeksforgeeks.org/python-api-update_profile_image-in-tweepy/](https://www.geeksforgeeks.org/python-api-update_profile_image-in-tweepy/)
...
> **语法:** `API.update_profile_image(filename)`
>
> **参数:**
>
> *   `filename`: 图像文件的本地路径。
