...
> 原文：[https://www.geeksforgeeks.org/introduction-to-physical-security/](https://www.geeksforgeeks.org/introduction-to-physical-security/)
...
*   **自然监视**：在这种情况下，架构师寻求构建对授权用户和安全人员更加开放和可见的场所，以便攻击者在不被发现的情况下无法执行未经授权的活动。例如，减少茂密高大的植被的数量。
...
如果你有黑客喜欢得到的数据，他们会尝试任何方法，可能只是透过窗户看。确保您知道放置屏幕和其他设备的视角。从不同的视角俯瞰看到你的凭据被称为“肩冲浪”。
