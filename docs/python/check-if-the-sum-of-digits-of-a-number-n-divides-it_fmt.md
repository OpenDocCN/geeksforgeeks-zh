...
> 原文：[https://www.geeksforgeeks.org/check-if-the-sum-of-digits-of-a-number-n-divides-it/](https://www.geeksforgeeks.org/check-if-the-sum-of-digits-of-a-number-n-divides-it/)
...
提取数字的位数，计算其所有位数的总和，并检查位数的总和是否为 `N`。以下是上述方法的实现：
