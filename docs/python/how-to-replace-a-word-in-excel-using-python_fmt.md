...
> 原文: [https://www.geeksforgeeks.org/how-to-replace-a-word-in-excel-using-python/](https://www.geeksforgeeks.org/how-to-replace-a-word-in-excel-using-python/)
...
这里让我们通过`xlwt` & `xlrd` 包和`openpyxl` 包来看看用 Python 替换 excel 中的一个单词。
