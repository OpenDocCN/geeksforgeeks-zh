...
> 原文: [https://www.geeksforgeeks.org/python-imdbpy-getting-series-genres-as-xml/](https://www.geeksforgeeks.org/python-imdbpy-getting-series-genres-as-xml/)
...
> 2. 创建一个 IMDB 实例
> 3. 借助系列 ID 获取系列对象
> 4. 在这里获取 XML 格式值，它将是字符串形式的，方法是借助“流派”关键字将系列对象转换为 XML
