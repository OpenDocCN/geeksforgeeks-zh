...
> 原文: [https://www.geeksforgeeks.org/python-group-tuples-by-kth-index-element/](https://www.geeksforgeeks.org/python-group-tuples-by-kth-index-element/)
...
**方法: 使用 `groupby()` + `itemgetter()` + 生成器表达式**
