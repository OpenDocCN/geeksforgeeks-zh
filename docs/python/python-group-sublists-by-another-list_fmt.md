...
> 原文: [https://www.geeksforgeeks.org/python-group-sublists-by-another-list/](https://www.geeksforgeeks.org/python-group-sublists-by-another-list/)

有时，在处理列表时，我们可能会遇到这样的问题：我们需要将所有的子列表分组，由不同列表中的元素分开。这种类型的自定义分组是不常见的实用程序，但是解决这些问题总是很方便的。让我们讨论执行这项任务的特定方式。
