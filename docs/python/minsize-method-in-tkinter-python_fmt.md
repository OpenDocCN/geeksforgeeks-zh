...
> 原文: [https://www.geeksforgeeks.org/minsize-method-in-tkinter-python/](https://www.geeksforgeeks.org/minsize-method-in-tkinter-python/)
...
这里，`height` 和 `width` 以像素为单位。

## 代码示例 #1

根窗口没有最小尺寸，也就是说你可以随意缩小窗口。
