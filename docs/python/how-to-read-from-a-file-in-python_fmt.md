...
> 原文: [https://www.geeksforgeeks.org/how-to-read-from-a-file-in-python/](https://www.geeksforgeeks.org/how-to-read-from-a-file-in-python/)
...
*   **`readlines()`:** Read all rows and return them as string elements of each row in the list.
...
**注:** 欲了解更多关于 `with` 的声明，请[点击此处](https://www.geeksforgeeks.org/with-statement-in-python/)。