...
> 原文: [https://www.geeksforgeeks.org/how-to-install-sqlobject-package-on-windows-and-linux/](https://www.geeksforgeeks.org/how-to-install-sqlobject-package-on-windows-and-linux/)
...
Python `SQLObject` 可以通过多种方式安装在 Linux 上，使用 `pip` 就是其中之一。
