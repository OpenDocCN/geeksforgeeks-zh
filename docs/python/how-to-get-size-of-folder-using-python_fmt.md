...
> 原文：[https://www.geeksforgeeks.org/how-to-get-size-of-folder-using-python/](https://www.geeksforgeeks.org/how-to-get-size-of-folder-using-python/)
...
*   创建一个变量`size`，并为其赋值 0。
*   分配文件夹的路径。
*   扫描文件夹，获取文件夹中每个文件的大小，并添加到`size`中。
*   显示文件夹的总大小。
