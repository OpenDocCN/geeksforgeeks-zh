...
> 原文: [https://www.geeksforgeeks.org/draw-a-parabola-using-arcade-in-python3/](https://www.geeksforgeeks.org/draw-a-parabola-using-arcade-in-python3/)
...
## 1. `arcade.draw_parabola_outline()`

这个函数绘制抛物线的轮廓。

> **语法:** `arcade.draw_parabola_outline(start_x, start_y, end_x, height, color, border_width, tilt_angle)`
>
> **参数:**
>
> *   `start_x` :抛物线的起始 x 位置
...
## 2. `arcade.draw_parabola_filled()`

此函数用于绘制一个彩色场抛物线。

> **语法:** `arcade.draw_parabola_filled(start_x, start_y, end_x, height, color, tilt_angle)`
>
> **参数:**
>
> *   `start_x` :抛物线的起始 x 位置
