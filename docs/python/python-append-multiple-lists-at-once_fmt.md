...
> 原文: [https://www.geeksforgeeks.org/python-append-multiple-lists-at-once/](https://www.geeksforgeeks.org/python-append-multiple-lists-at-once/)
...
`chain()`函数也可以用来执行这个特定的任务，因为它使用迭代器来执行这个任务，因此比上述方法提供了更好的性能。
