# mahotas – 获取给定半径的圆盘结构元素

> 原文: [https://www.geeksforgeeks.org/mahotas-getting-disk-structuring-element-of-given-radius/](https://www.geeksforgeeks.org/mahotas-getting-disk-structuring-element-of-given-radius/)
