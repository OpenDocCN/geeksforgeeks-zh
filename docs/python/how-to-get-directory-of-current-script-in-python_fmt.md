...
父目录是*分层*文件系统中另一个文件/目录之上的目录。获取父目录对于执行某些与文件系统管理相关的任务至关重要。在本文中，我们将了解用于获取当前运行的 python 脚本的父目录的方法，并了解每种方法的各种用途/缺点。为了执行上述任务，我们将使用两个名为`os`和`inspect`的库，这两个库都是内置的，因此不需要任何安装。
...
> **语法:** `getsourcefile(object)`
> 
> **参数:**
> 
> `object`: python 脚本中的可引用对象
> 
> **返回类型:**
> 
