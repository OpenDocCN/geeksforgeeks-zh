...
> 原文: [https://www.geeksforgeeks.org/isoformat-function-of-datetime-date-class-in-python/](https://www.geeksforgeeks.org/isoformat-function-of-datetime-date-class-in-python/)
...
> *   `timespec`: 是 `timespec` 的格式说明符。它也是一个可选参数，默认值为 `"auto"`。
>
