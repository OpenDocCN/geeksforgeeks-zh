...
> 原文: [https://www.geeksforgeeks.org/python-consecutive-ranges-of-k-greater-than-n/](https://www.geeksforgeeks.org/python-consecutive-ranges-of-k-greater-than-n/)
...
## 方法2：使用 `enumerate()` + `zip()` + 列表切片 + 列表推导式
