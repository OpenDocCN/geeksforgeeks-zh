...
> 原文: [https://www.geeksforgeeks.org/crontab-running-a-python-script-with-parameters/](https://www.geeksforgeeks.org/crontab-running-a-python-script-with-parameters/)
...
**注意:** `#!/usr/bin/python3` (指定脚本解释器的路径) 如果您希望使脚本可执行，则是必需的。
