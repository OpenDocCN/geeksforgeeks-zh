...
> 原文: [https://www.geeksforgeeks.org/python-formable-strings-count-in-matrix/](https://www.geeksforgeeks.org/python-formable-strings-count-in-matrix/)

给定字符串矩阵，任务是编写一个 Python 程序来计算字符串，这些字符串可以由给定列表中的字母组成。

**示例:**

> **输入**: `test_list = [["gfg", "best"], ["all", "love", "gfg"], ["gfg", "is", "good"], ["geeksforgeeks"]]`, `tar_list = ["g", "f", "s", "b", "o", "d", "e", "t"]`
> **输出**: 5
> **解释**: `gfg`、`best`、`gfg`、`gfg`、`good` 都是可以由目标列表字符组成的字符串。
>
> **输入**: `test_list = [["gfg", "best"], ["all", "love", "gfg"], ["gfg", "is", "good"], ["geeksforgeeks"]]`, `tar_list = ["g", "f", "s", "b", "d", "e", "t"]`
> **输出**: 4
