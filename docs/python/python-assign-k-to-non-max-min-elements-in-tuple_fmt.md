...
> 原文: [https://www.geeksforgeeks.org/python-assign-k-to-non-max-min-elements-in-tuple/](https://www.geeksforgeeks.org/python-assign-k-to-non-max-min-elements-in-tuple/)
