...
> 原文: [https://www.geeksforgeeks.org/list-all-the-microphones-connected-to-system-in-python-using-pyaudio-and-speechrecognition/](https://www.geeksforgeeks.org/list-all-the-microphones-connected-to-system-in-python-using-pyaudio-and-speechrecognition/)
...
### SpeechRecognition
This module does not comes built-in with Python. There are two ways to install this module.
