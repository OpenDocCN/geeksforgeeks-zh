...
> 原文: [https://www.geeksforgeeks.org/pyspark-dataframe-add-column-based-on-other-columns/](https://www.geeksforgeeks.org/pyspark-dataframe-add-column-based-on-other-columns/)
