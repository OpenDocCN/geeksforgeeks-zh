...
> 原文: [https://www.geeksforgeeks.org/python-indices-of-sorted-list-of-list-elements/](https://www.geeksforgeeks.org/python-indices-of-sorted-list-of-list-elements/)

排序是一种常见的构造，已经讨论了它的许多变体。但是有时候，我们需要对列表的列表进行排序，而且只需要在排序之前找到元素出现的顺序。让我们来看看如何在列表中获得排序顺序的索引。
