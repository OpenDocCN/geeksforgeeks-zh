...
> 原文: [https://www.geeksforgeeks.org/python-consecutive-repetition-of-characters/](https://www.geeksforgeeks.org/python-consecutive-repetition-of-characters/)
...
> 连续重复后的列表为: ['g', 'g', 'g', 'f', 'f', 'f', 'g', 'g', 'g', 'i', 'i', 'i', 's', 's', 's', 'b', 'b', 'b', 'e', 'e', 'e', 's', 's', 's', 't', 't', 't']