...
> 原文: [https://www.geeksforgeeks.org/download-youtube-videos-or-whole-playlist-with-python/](https://www.geeksforgeeks.org/download-youtube-videos-or-whole-playlist-with-python/)
...
*   [在 Tkinter 中使用线程](https://www.geeksforgeeks.org/how-to-use-thread-in-tkinter-python/)
*   YouTube API
...
在我们开始之前，我们先来讨论一下 `pyyoutube` 模块。`pyyoutube` 模块提供了一种使用 YouTube 数据应用编程接口 V3 的简单方法。
