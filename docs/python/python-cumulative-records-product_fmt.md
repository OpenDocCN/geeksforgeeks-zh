...
> 原文: [https://www.geeksforgeeks.org/python-cumulative-records-product/](https://www.geeksforgeeks.org/python-cumulative-records-product/)
...
## 方法 2: 使用 loop+`map()`+`chain.from_iterable()`
