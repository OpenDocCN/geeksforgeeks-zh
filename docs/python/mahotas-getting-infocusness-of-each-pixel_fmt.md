# Mahotas – 获取每个像素的信息清晰度

> 原文: [https://www.geeksforgeeks.org/mahotas-getting-infocusness-of-each-pixel/](https://www.geeksforgeeks.org/mahotas-getting-infocusness-of-each-pixel/)
