...
> 原文: [https://www.geeksforgeeks.org/python-calendar-module-itermonthdays2-method/](https://www.geeksforgeeks.org/python-calendar-module-itermonthdays2-method/)
...
## 代码示例 2
`itermonthdays2()` 方法的工作示例，`firstweekday=2`。
