...
> 原文：[https://www.geeksforgeeks.org/how-to-convert-pdf-file-to-excel-file-using-python/](https://www.geeksforgeeks.org/how-to-convert-pdf-file-to-excel-file-using-python/)
...
![PDF 文件](img/9d0d66474395cdfb7cf3989bbf1f5292.png)
...
![EXCEL 文件](img/915ad240e28089e4b2cb660c97aadd22.png)
...
- 然后我们将使用 `到_excel()` 的方法将 PDF 文件转换成 Excel 文件。
...
![EXCEL 文件](img/68e90b067111c3799fe8230812ebb444.png)