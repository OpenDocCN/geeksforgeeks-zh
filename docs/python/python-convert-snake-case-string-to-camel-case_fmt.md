...
> 原文: [https://www.geeksforgeeks.org/python-convert-snake-case-string-to-camel-case/](https://www.geeksforgeeks.org/python-convert-snake-case-string-to-camel-case/)

给定一个蛇格字符串，转换为骆驼格。

> **输入**: `test_str = 'geeksforgeeks_is_best_for_geeks'`
> **输出**: `geeksforgeeksIsBestForGeeks`
> **解释**: 字符串转换为驼色大小写。
>
> **输入**: `test_str = 'geeksforgeeks_best_for_geeks'`
> **输出**: `geeksforgeeksBestForGeeks`
> **解释**: 字符串转换为驼色格。
