...
1.  回填–[`bfill()`](https://www.geeksforgeeks.org/python-pandas-dataframe-bfill/): 根据上次观测值
...
## 方法二: 使用 [`interpolate()`](https://www.geeksforgeeks.org/python-pandas-dataframe-interpolate/) 方法
...
**注意:** 带有多索引的数据帧/系列只支持 `method='linear'`。
