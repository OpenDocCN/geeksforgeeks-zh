...
> 原文: [https://www.geeksforgeeks.org/pyglet-loading-plain-text-document/](https://www.geeksforgeeks.org/pyglet-loading-plain-text-document/)
...
> 为此，我们对 `pyglet.resource` 使用 `text` 方法
> **语法:** `resource.text(file_name)`
> **参数:** 它以字符串即文件名作为参数
> **返回:** 它返回未格式化的文档对象
