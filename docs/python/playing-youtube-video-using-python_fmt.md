...
> 原文：[https://www.geeksforgeeks.org/playing-youtube-video-using-python/](https://www.geeksforgeeks.org/playing-youtube-video-using-python/)
...
2.  创建一个包含视频网址的变量
3.  使用链接创建一个 `pafy` 对象
4.  获得给定 `youtube` 链接的最佳质量流
5.  通过传递最佳流创建一个 `vlc MediaPlayer` 对象
6.  播放视频
