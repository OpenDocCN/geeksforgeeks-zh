...
> 原文: [https://www.geeksforgeeks.org/pyglet-getting-style-of-formatted-document-at-given-position/](https://www.geeksforgeeks.org/pyglet-getting-style-of-formatted-document-at-given-position/)
...
为了创建窗口，我们对文档对象使用 `get_style(属性，pos)` 方法。

**语法:** `document.get_style(属性，pos)`
