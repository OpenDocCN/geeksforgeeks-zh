...
> 原文: [https://www.geeksforgeeks.org/python-extract-range-of-consecutive-similar-elements-ranges-from-string-list/](https://www.geeksforgeeks.org/python-extract-range-of-consecutive-similar-elements-ranges-from-string-list/)
