# mahotas–去除小波中心图像的边界效果

> 原文: [https://www.geeksforgeeks.org/mahotas-removing-border-effect-from-wavelet-center-image/](https://www.geeksforgeeks.org/mahotas-removing-border-effect-from-wavelet-center-image/)
...
语法: `mahotas.wavelet_center(centered_image, original_img_shape)`
参数: 它以图像对象和原始图像形状为参数
返回: 它返回图像对象
