...
> 原文：[https://www.geeksforgeeks.org/python-extract-dictionaries-with-empty-string-value-in-k-key/](https://www.geeksforgeeks.org/python-extract-dictionaries-with-empty-string-value-in-k-key/)

给定字典列表，提取所有具有空字符串作为特定键值的字典。

> **输入**：`test_list = [{"Gfg":"4", "is":"good", "best":"1"}, {"Gfg":"9", "is":"CS", "best":"10"}]`，`K = "Gfg"`
> **输出**：`[]`
> **解释**：无“Gfg”键为空。
>
> **输入**：`test_list = [{"Gfg":"", "is":"good", "best":"1"}, {"Gfg":"9", "is":"CS", "best":"10"}]`，`K = "Gfg"`
> **输出**：`[{"Gfg":"", "is":"good", "best":"1"}]`
> **解释**：字典中带空的“Gfg”提取出来。

## 方法一：使用列表理解

这是执行这项任务的方法之一。在这种情况下，我们在所有字典中运行一个循环，并检查键的空字符串值。所有这些都是在列表理解而不是循环中编写的。
