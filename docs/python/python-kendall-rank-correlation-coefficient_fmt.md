...
> 原文: [https://www.geeksforgeeks.org/python-kendall-rank-correlation-coefficient/](https://www.geeksforgeeks.org/python-kendall-rank-correlation-coefficient/)

## 什么是相关性检验？

两个变量之间的关联强度被称为相关性检验。例如，如果我们想知道父亲和儿子的身高之间是否有关系，可以计算相关系数来回答这个问题。

如需了解更多相关信息，请参考[相关文章](https://www.geeksforgeeks.org/mathematics-covariance-and-correlation/)。
...
![\tau=\frac{\text { Number of concordant pairs-Number of discordant pairs }}{n(n-1) / 2}](img/602572736574c2d2e8c16ce20d962fab.png "Rendered by QuickLaTeX.com")
...
**注**：对于 `x1 = x2` 和 `y1 = y2` 的配对未被归类为一致或不一致，它们被忽略。

## 例

我们来考虑下表中两位专家对食物项目的排名。
...
Python 函数计算 Python 中的 Kendall 秩相关系数
