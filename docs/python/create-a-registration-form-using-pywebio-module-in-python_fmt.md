...
> 原文：[https://www.geeksforgeeks.org/create-a-registration-form-using-pywebio-module-in-python/](https://www.geeksforgeeks.org/create-a-registration-form-using-pywebio-module-in-python/)
...
**1. `input_group`：** 这个元素用于获取组中的输入。当我们使用 `input_group` 时，我们需要为每个输入函数提供 `name` 参数来识别结果中的输入项。
