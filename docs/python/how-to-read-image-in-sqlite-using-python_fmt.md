...
> 原文: [https://www.geeksforgeeks.org/how-to-read-image-in-sqlite-using-python/](https://www.geeksforgeeks.org/how-to-read-image-in-sqlite-using-python/)
...
3.  使用 `cursor.execute()` 在 Python 中执行 `SELECT` 查询。
...
5.  创建一个函数，将 BLOB 数据转换为正确的格式，并将其保存为人类可读的格式。
