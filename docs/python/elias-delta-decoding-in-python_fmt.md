...
> 原文：[https://www.geeksforgeeks.org/elias-delta-decoding-in-python/](https://www.geeksforgeeks.org/elias-delta-decoding-in-python/)
...
> 在我们的例子中，`L=1`
>
> 步骤 2：将‘1’视为第一位，多读 `L` 位（多读 1 位）并丢弃所有内容。
>
> ~~011~~ `11` = `11`
>
