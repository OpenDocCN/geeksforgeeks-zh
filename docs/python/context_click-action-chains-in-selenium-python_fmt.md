...
> 原文: [https://www.geeksforgeeks.org/context_click-action-chains-in-selenium-python/](https://www.geeksforgeeks.org/context_click-action-chains-in-selenium-python/)
...
演示一下，硒蟒的 `context_click` 动作链法。让我们参观 [https://www.geeksforgeeks.org/](https://www.geeksforgeeks.org/)，并对一个元素进行操作。
