...
> 原文: [https://www.geeksforgeeks.org/logistic-regression-using-statsmodels/](https://www.geeksforgeeks.org/logistic-regression-using-statsmodels/)
...
`predict()`功能可用于执行预测。得到的预测是分数(0 到 1 之间)，表示被录取的概率。因此，这些值被舍入，以获得 1 或 0 的离散值。
