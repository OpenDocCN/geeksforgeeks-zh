...
> 原文: [https://www.geeksforgeeks.org/python-library-for-self-balancing-bst/](https://www.geeksforgeeks.org/python-library-for-self-balancing-bst/)
...
treeSet.floor(10) :  10
treeSet :  [1, 3, 7, 10]
2nd example treeSet : [10, 20, 30, 70]
Adding 40 to the above, it is arranged in     sorted order :  [10, 20, 30, 40, 70]
After removing 70  [10, 20, 30, 40]
After removing 50, no issue even if not     available  [10, 20, 30, 40]
After adding many elements, duplicate are     not taken : [10, 20, 30, 40, 50, 60]
10
60 40 50 30 20 10
True
False
