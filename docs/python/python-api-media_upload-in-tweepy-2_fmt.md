# Python–API.media_upload()在Tweepy中

> 原文: [https://www.geeksforgeeks.org/python-api-media_upload-in-tweepy-2/](https://www.geeksforgeeks.org/python-api-media_upload-in-tweepy-2/)
