...
> 原文: [https://www.geeksforgeeks.org/pyglet-getting-position-from-point-in-incremental-text-layout/](https://www.geeksforgeeks.org/pyglet-getting-position-from-point-in-incremental-text-layout/)
...
> **语法:** `layout.get_position_from_point(x, y)`
> **参数:** 它以两个整数作为参数
> **返回:** 它返回整数
