...
> 原文: [https://www.geeksforgeeks.org/python-filter-string-tuples-if-string-lengths-equals-k/](https://www.geeksforgeeks.org/python-filter-string-tuples-if-string-lengths-equals-k/)

给定元组列表，过滤元组，其元素字符串长度等于 `k`。

> **输入**: `test_list = [("ABC", "Gfg", "CS1"), ("Gfg", "Best"), ("Gfg", "WoW")]`, `K = 3`
> **输出**: `[("ABC", "Gfg", "CS1")]`
> **解释**: 以上元组中所有字符串长度均为 3。
>
> **输入**: `test_list = [("ABCD", "Gfg", "CS1"), ("Gfg", "Best"), ("Gfg", "WoW")]`, `K = 3`
> **输出**: `[]`
