...
> 原文：[https://www.geeksforgeeks.org/difference-between-and-append-in-python/](https://www.geeksforgeeks.org/difference-between-and-append-in-python/)
...
使用 `.append()` 方法即一种有效的方法：列表上的 `append()` 方法更改代码，使用[变异器方法](https://www.geeksforgeeks.org/accessor-and-mutator-methods-in-python/)通过仅追加一个元素来更改列表。
