...
> 原文：[https://www.geeksforgeeks.org/conversion-between-binary-hexadecimal-and-decimal-numbers-using-coden-module/](https://www.geeksforgeeks.org/conversion-between-binary-hexadecimal-and-decimal-numbers-using-coden-module/)
...
**随机十六进制：** 函数 `randoms.hexadecimal` 返回给定十六进制数范围之间的随机十六进制数。
