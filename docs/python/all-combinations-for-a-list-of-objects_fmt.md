...
> 原文: [https://www.geeksforgeeks.org/all-combinations-for-a-list-of-objects/](https://www.geeksforgeeks.org/all-combinations-for-a-list-of-objects/)

**先决条件:** [Python itertools](https://www.geeksforgeeks.org/python-itertools/)

有几种方法可以获得 python 中对象列表的所有组合。这个问题已经有了[递归解](https://www.geeksforgeeks.org/print-all-possible-combinations-of-r-elements-in-a-given-array-of-size-n/)。Python 有一个 `itertools` 模块，提供了两个名为 [`combinations()`](https://www.geeksforgeeks.org/python-itertools-combinations-function/) 和 [`combinations_with_replacement()`](https://www.geeksforgeeks.org/python-itertools-combinations_with_replacement/) 的功能，让我们的工作轻松了很多。以下是两种方法：
...
*   返回物品数量为 `nCr = n! / (r! * (n-r)!)` 当 `0 <= r <= n` 时；而 `0` 当 `r > n`。
