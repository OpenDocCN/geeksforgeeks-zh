...
> 原文: [https://www.geeksforgeeks.org/python-group-concatenate-till-k/](https://www.geeksforgeeks.org/python-group-concatenate-till-k/)

给定字符串列表，分组执行连接，直到 `K`。

### 输入
`test_list = ["Gfg", "is", "Best", None, "I", "Love", None, "Gfg"]`, `K = None`

### 输出
`['Gfg is Best', 'I Love', 'Gfg']`

### 解释
串接单词用空格作为新的字符串分隔符。

### 输入
`test_list = ["Gfg", "is", "Best", None, "I", "Love"]`, `K = None`
