...
从命令行（Windows 中的 CMD 或 Linux 中的 TERMINAL）显示一年中的某个月，例如：
...
本文由 [T2【aja 0007】T4 供稿](https://auth.geeksforgeeks.org/profile.php?user=ajay0007)。如果你喜欢 GeeksforGeeks 并想投稿，你也可以使用 [write.geeksforgeeks.org](https://write.geeksforgeeks.org) 写一篇文章或者把你的文章邮寄到 review-team@geeksforgeeks.org。看到你的文章出现在极客博客主页上，帮助其他极客。
