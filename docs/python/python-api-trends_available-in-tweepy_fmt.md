# Python API: trends_available() 在 Tweepy 中

> 原文: [https://www.geeksforgeeks.org/python-api-trends_available-in-tweepy/](https://www.geeksforgeeks.org/python-api-trends_available-in-tweepy/)
