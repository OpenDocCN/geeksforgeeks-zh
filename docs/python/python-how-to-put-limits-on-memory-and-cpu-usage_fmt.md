...
> 原文: [https://www.geeksforgeeks.org/python-how-to-put-limits-on-memory-and-cpu-usage/](https://www.geeksforgeeks.org/python-how-to-put-limits-on-memory-and-cpu-usage/)

本文旨在展示如何限制正在运行的程序的内存或 CPU 使用。要做到这一点，可以使用`资源`模块，这样两个任务都可以很好地执行，如下面给出的代码所示:
