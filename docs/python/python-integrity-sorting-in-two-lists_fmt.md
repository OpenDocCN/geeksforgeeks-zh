...
> 原文: [https://www.geeksforgeeks.org/python-integrity-sorting-in-two-lists/](https://www.geeksforgeeks.org/python-integrity-sorting-in-two-lists/)
...
## 方法二: 使用 `sorted()` + `zip()` + lambda function
