# Pmagick `sharpen()`方法–Python

> 原文: [https://www.geeksforgeeks.org/pgmagick-sharpen-method-python/](https://www.geeksforgeeks.org/pgmagick-sharpen-method-python/)

`sharpen()`函数是`Pgmagick`库中的一个内置函数，用于锐化图像。它使用给定半径和标准差(σ)的高斯算子。
