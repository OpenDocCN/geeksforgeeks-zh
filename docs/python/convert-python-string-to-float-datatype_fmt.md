...
> 原文: [https://www.geeksforgeks.org/convert-python-string-to-float-datatype/](https://www.geeksforgeks.org/convert-python-string-to-float-datatype/)
...
因为我们只要一个带有十进制数值的字符串，所以这个方法也可以使用。
