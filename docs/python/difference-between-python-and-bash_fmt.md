...
> 原文：[`https://www.geeksforgeeks.org/difference-between-python-and-bash/`](https://www.geeksforgeeks.org/difference-between-python-and-bash/)
...
*   **简约:**
    `Python` 更容易维护。而 `bash` 不需要，它不需要维护。
*   **性能:**
