...
> 原文: [https://www.geeksforgeeks.org/pyglet-inserting-element-in-formatted-document/](https://www.geeksforgeeks.org/pyglet-inserting-element-in-formatted-document/)
...
为了创建窗口，我们对文档对象使用 `insert_element` 方法。

**语法:** `document.insert_element(position, element)`
