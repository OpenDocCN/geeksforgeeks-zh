...
> 原文: [https://www.geeksforgeeks.org/how-to-store-xml-data-into-a-mysql-database-using-python/](https://www.geeksforgeeks.org/how-to-store-xml-data-into-a-mysql-database-using-python/)
...
*   创建 XML 文件。
    ...
    ```
    我们将使用 XML 模块 `xml.etree.ElementTree`。这是一个元素树 XML 应用编程接口，用于实现一个简单有效的应用编程接口来解析和创建 XML 数据。所以我们需要导入这个模块。
    **语法:**
    ```py
