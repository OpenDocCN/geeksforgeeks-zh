...
> 原文: [https://www.geeksforgeeks.org/executing-shell-commands-with-python/](https://www.geeksforgeeks.org/executing-shell-commands-with-python/)
...
Python 中的操作系统模块包括与操作系统通信的功能。`os` 模块是 Python 的标准实用程序模块之一。这个 Python 模块提供了一种使用操作系统相关特性的便捷方式，shell 命令可以使用 `os` 模块中的 [`system()`](https://www.geeksforgeeks.org/python-os-system-method/) 方法来执行。
