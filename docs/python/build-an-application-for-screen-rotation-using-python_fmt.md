...
> 原文: [https://www.geeksforgeeks.org/build-an-application-for-screen-rotation-using-python/](https://www.geeksforgeeks.org/build-an-application-for-screen-rotation-using-python/)
...
### 步骤 2) 创建一个`rotatescreen.get_primary_display()`的对象进入系统主屏幕。
