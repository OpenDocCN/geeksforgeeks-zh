...
> 原文：`https://www.geeksforgeeks.org/dividing-sticks-problem/`
...
> 可以获得的期望长度的最大棒是：3
> **解释：**
> 我们已经有一根长度为 3 的棒，通过将长度为 11 的棒分成 `[5, 3, 3]` 块可以获得另外两根棒，因此棒总数将为 3。
>
> **输入：**
> `列表 = [2, 1, 4, 5]`
> `n = 2`
...
> 可以获得的期望长度的最大棒是：1
> **解释：**
> 我们已经有一根长度为 4 的棒，通过折断任何棒都无法获得更多的棒，因此棒总数将为 1
