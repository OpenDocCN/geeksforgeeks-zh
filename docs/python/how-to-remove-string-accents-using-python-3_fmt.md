...
> 原文: [https://www.geeksforgeeks.org/how-to-remove-string-accents-using-python-3/](https://www.geeksforgeeks.org/how-to-remove-string-accents-using-python-3/) 移除字符串重音
...
我们可以通过使用名为 `Unidecode` 的 Python 模块来移除字符串中的重音符号。该模块由 `unidecode()` 方法组成，该方法接受一个 Unicode 对象或字符串，并返回一个没有扩展名的字符串。
