...
> 原文：[https://www.geeksforgeeks.org/date-calculator-for-adding-and-subtracting-days-using-tkinter-python/](https://www.geeksforgeeks.org/date-calculator-for-adding-and-subtracting-days-using-tkinter-python/)

**先决条件：** [Tkinter](https://www.geeksforgeeks.org/python-gui-tkinter/)，Tkinter 中的 `tkcalendar`，[datetime](https://www.geeksforgeeks.org/python-datetime-module-with-examples/)
...
*   使用 `datetime` 模块中的 `strptime()` 方法将日期转换为不同的时间格式。
*   然后我们将从日期中加上/减去天数。
