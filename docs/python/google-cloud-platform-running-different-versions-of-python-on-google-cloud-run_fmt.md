...
> 原文：[https://www.geeksforgeeks.org/google-cloud-platform-running-different-versions-of-python-on-google-cloud-run/](https://www.geeksforgeeks.org/google-cloud-platform-running-different-versions-of-python-on-google-cloud-run/)
...
一旦 `sweet-ldap` 包有了 Python 3 的支持，Rinki 就可以使用 Cloud Run 的 `流量拆分` 功能，通过逐步推出服务的新版本来测试这个新版本。
