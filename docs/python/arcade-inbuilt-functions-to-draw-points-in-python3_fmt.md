...
> 原文: [https://www.geeksforgeeks.org/arcade-inbuilt-functions-to-draw-points-in-python3/](https://www.geeksforgeeks.org/arcade-inbuilt-functions-to-draw-points-in-python3/)
...
## 2. `arcade.draw_points()`

使用该功能，可以更容易地以特定的模式绘制多个指向的点。

> **语法:** `arcade.draw_points(point_list, 颜色, 大小)`
>
> **参数:**
>
> *   `point_list` – 它基本上是点的列表，其中每个点都在一个列表中。这是一个列表。
> *   `颜色` – 使用 `arcade.color.COLOR NAME` 指定颜色。(注意颜色名称应该用大写字母。)
> *   `大小` – 以像素为单位的点的大小。
