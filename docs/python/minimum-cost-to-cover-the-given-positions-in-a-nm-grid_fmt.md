...
> 原文: [https://www.geeksforgeeks.org/minimum-cost-to-cover-the-given-positions-in-a-nm-grid/](https://www.geeksforgeeks.org/minimum-cost-to-cover-the-given-positions-in-a-nm-grid/)
...
由于在柱子中移动是唯一的成本，如果我们走到任何一根柱子上，我们会画出那根柱子上的所有柱子，然后向前移动。所以，基本上，答案将是最远的两列之间的差异。
