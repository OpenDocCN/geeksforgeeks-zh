...
**先决条件–** [Python类](https://www.geeksforgeeks.org/python-classes-and-objects/)、[对象](https://www.geeksforgeeks.org/python-classes-and-objects/)、[self](https://www.geeksforgeeks.org/self-in-python-class/)
...
**注:** 了解更多继承[点击此处](https://www.geeksforgeeks.org/inheritance-in-python/)。