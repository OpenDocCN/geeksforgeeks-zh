...
> 原文: [https://www.geeksforgeeks.org/how-to-get-keyboard-input-in-pygame/](https://www.geeksforgeeks.org/how-to-get-keyboard-input-in-pygame/)
...
每当按下或释放一个键时，`pygame.event()` 队列方法 `pygame.KEYDOWN` 和 `pygame.KEYUP` 事件。
