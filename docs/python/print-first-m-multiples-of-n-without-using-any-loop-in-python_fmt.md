...
> 原文: [https://www.geeksforgeeks.org/print-first-m-multiples-of-n-without-using-any-loop-in-python/](https://www.geeksforgeeks.org/print-first-m-multiples-of-n-without-using-any-loop-in-python/)

给定 `n` 和 `m`，不使用 Python 中的任何循环，打印 `n` 的前 `m` 个倍数。
