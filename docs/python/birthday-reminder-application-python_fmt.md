...
> 原文: [https://www.geeksforgeeks.org/birthday-reminder-application-python/](https://www.geeksforgeeks.org/birthday-reminder-application-python/)
...
4.  在全局搜索中，搜索`启动应用程序`
5.  单击添加，并为您的流程指定所需的名称
6.  在命令字段中键入命令。例如，我们的文件名是 `reminder.py`，那么在命令字段中键入 `reminder.py`，然后选择添加。
