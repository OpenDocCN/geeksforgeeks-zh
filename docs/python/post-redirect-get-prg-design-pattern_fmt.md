...
> 原文: [https://www.geeksforgeeks.org/post-redirect-get-prg-design-pattern/](https://www.geeksforgeeks.org/post-redirect-get-prg-design-pattern/)
...
- 在项目根目录下创建一个文件夹 `templates`，在 `templates` 目录下创建一个文件 `home.html`，并在里面写下下面的代码。
