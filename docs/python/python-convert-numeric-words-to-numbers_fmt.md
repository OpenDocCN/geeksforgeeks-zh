...
> 原文: [https://www.geeksforgeeks.org/python-convert-numeric-words-to-numbers/](https://www.geeksforgeeks.org/python-convert-numeric-words-to-numbers/)

有时，在使用 Python 字符串时，我们可能会遇到一个问题，需要将命名数字形式的字符串转换为实际数字。这在数学领域和数据科学领域都有应用。让我们讨论执行这项任务的某些方法。
