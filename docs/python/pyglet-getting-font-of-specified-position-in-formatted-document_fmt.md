...
> 原文: [https://www.geeksforgeeks.org/pyglet-getting-font-of-specified-position-in-formatted-document/](https://www.geeksforgeeks.org/pyglet-getting-font-of-specified-position-in-formatted-document/)
...
为了创建窗口，我们对文档对象使用 `get_font` 方法。

**语法:** `document.get_font(n)`
