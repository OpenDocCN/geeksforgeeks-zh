...
| 功能名称 | 描述 |
| --- | --- |
| [`clear()`](https://www.geeksforgeeks.org/python-dictionary-clear/) | 从字典中移除所有项目 |
| [`copy()`](https://www.geeksforgeeks.org/python-dictionary-copy/) | 返回字典的一个简单副本 |
...
| [`items()`](https://www.geeksforgeeks.org/python-dictionary-items-method/) | 返回包含所有字典键和值的列表 |
| [`keys()`](https://www.geeksforgeeks.org/python-dictionary-keys-method/) | 返回一个 view 对象，该对象按插入顺序显示字典中所有键的列表 |
| [`pop()`](https://www.geeksforgeeks.org/python-dictionary-pop-method/) | 返回并移除具有给定键的元素 |
| [`popitem()`](https://www.geeksforgeeks.org/python-dictionary-popitem-method/) | 从字典中返回并移除键值对 |
| [`setdefault()`](https://www.geeksforgeeks.org/python-dictionary-setdefault-method/) | 如果关键字在字典中，则返回该关键字的值，否则将带有值的关键字插入字典 |
| [`update()`](https://www.geeksforgeeks.org/python-dictionary-update-method/) | 用另一个字典中的元素更新字典 |
| [`values()`](https://www.geeksforgeeks.org/python-dictionary-values/) | 返回给定字典中所有可用值的列表 |
