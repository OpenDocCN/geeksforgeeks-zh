...
> 原文: [https://www.geeksforgeeks.org/python-coefficient-of-determination-r2-score/](https://www.geeksforgeeks.org/python-coefficient-of-determination-r2-score/)
...
`R<sup>2</sup>` 表示位于回归方程创建的直线内的数据点的比例。更高的 `R<sup>2</sup>` 值是可取的，因为它表明更好的结果。
