...
> 原文: [https://www.geeksforgeeks.org/one-liner-for-python-if-elif-else-statements/](https://www.geeksforgeeks.org/one-liner-for-python-if-elif-else-statements/)
...
> `{(条件 1 : <code1>), (条件 2 : <code2>)}.get(True, <code3>)`
...
对于 Python 中的 `if-elif-else` 这种语法，下面的代码不会给你带来想要的结果:
