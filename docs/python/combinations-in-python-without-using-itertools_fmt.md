...
> 原文: [https://www.geeksforgeeks.org/combinations-in-python-without-using-itertools/](https://www.geeksforgeeks.org/combinations-in-python-without-using-itertools/)

[`itertools`](https://www.geeksforgeeks.org/python-itertools/) 是一个在迭代器上工作的方法的帮助下产生复杂迭代器的模块。这个模块作为一个快速、内存高效的工具，可以单独使用，也可以组合使用，形成迭代器代数。
