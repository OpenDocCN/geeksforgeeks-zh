...
> 原文: [https://www.geeksforgeeks.org/download-instagram-profile-pic-using-python/](https://www.geeksforgeeks.org/download-instagram-profile-pic-using-python/)
...
对于给定的用户档案，打开*视图-来源*，找到*“profile_pic_url_HD”*。要查找，请按 `ctrl+f` 并键入*“profile_pic_url_HD”*。与之相关的链接是我们的数据或 profile pic。
链接看起来像:
