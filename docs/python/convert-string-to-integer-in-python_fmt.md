...
> 原文: [https://www.geeksforgeeks.org/convert-string-to-integer-in-python/](https://www.geeksforgeeks.org/convert-string-to-integer-in-python/)
...
作为旁注，要转换为 float，我们可以使用 Python 中的 `float()`。
