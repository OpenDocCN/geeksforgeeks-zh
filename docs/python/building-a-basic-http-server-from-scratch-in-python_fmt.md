...
> 原文: [https://www.geeksforgeeks.org/building-a-basic-http-server-from-scratch-in-python/](https://www.geeksforgeeks.org/building-a-basic-http-server-from-scratch-in-python/)
...
要在本地访问服务器，我们需要访问 [http://localhost:8000/](http://localhost:8000/) 或 [http://127.0.0.1:8000/](http://127.0.0.1:8000/)。在这里我们可以看到您本地存储的所有目录以及所有数据。您还可以访问一个网页，当您访问它时，它将由您的网络浏览器渲染。
...
*   `HTTPServer(server_address, BaseHTTPRequestHandler)`: 这是一个函数，用于存储服务器的端口以及服务器的名称。
...
在浏览器中，转到 [http://localhost:5555/](http://localhost:5555/) 或 [http://127.0.0.1:5555/](http://127.0.0.1:5555/)
