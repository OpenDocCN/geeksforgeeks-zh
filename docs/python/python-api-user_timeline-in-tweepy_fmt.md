...
> 原文: [https://www.geeksforgeeks.org/python-api-user_timeline-in-tweepy/](https://www.geeksforgeeks.org/python-api-user_timeline-in-tweepy/)
...
使用带有 `count` 参数的 `user_timeline()` 方法仅获取指定数量的状态。
