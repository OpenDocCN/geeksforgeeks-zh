...
> 原文: [`https://www.geeksforgeeks.org/python-extract-target-key-from-other-key-values/`](https://www.geeksforgeeks.org/python-extract-target-key-from-other-key-values/)
