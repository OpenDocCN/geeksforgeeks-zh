# Python–API.get_saved_search() 在 Tweepy 中

> 原文: [https://www.geeksforgeeks.org/python-api-get_saved_search-in-tweepy/](https://www.geeksforgeeks.org/python-api-get_saved_search-in-tweepy/)
