...
> 原文: [https://www.geeksforgeeks.org/python-element-with-largest-frequency-in-list/](https://www.geeksforgeeks.org/python-element-with-largest-frequency-in-list/)
...
## 方法4: 使用`collections.Counter.most_common()`
