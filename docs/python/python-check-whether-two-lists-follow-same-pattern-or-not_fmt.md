...
> 原文: [https://www.geeksforgeeks.org/python-check-whether-two-lists-follow-same-pattern-or-not/](https://www.geeksforgeeks.org/python-check-whether-two-lists-follow-same-pattern-or-not/)

给定两个列表 `A` 和 `B`，检查它们是否遵循相同的模式。
模式匹配条件:
