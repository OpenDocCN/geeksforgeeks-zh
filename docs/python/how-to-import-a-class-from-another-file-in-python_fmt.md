...
> 原文: [https://www.geeksforgeeks.org/how-to-import-a-class-from-another-file-in-python/](https://www.geeksforgeeks.org/how-to-import-a-class-from-another-file-in-python/)
...
现在是时候导入模块并开始测试我们的新类和函数了。这里，我们将导入一个名为 `module` 的模块，并在该模块中创建名为 `GFG` 的类的对象。现在，我们可以使用它的方法和变量。
