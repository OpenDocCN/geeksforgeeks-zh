...
> 原文: [https://www.geeksforgeeks.org/python-find-index-containing-string-in-list/](https://www.geeksforgeeks.org/python-find-index-containing-string-in-list/)
...
## 方法 1: 在 for 循环中使用 [`type()` 运算符](https://www.geeksforgeeks.org/python-type-function/)
...
> **语法:** `[list1.index(i) for i in list1 if(type(i) is str)]`
