...
![f(x)=b x^{-a}](img/4823f7793f69bead61c66d6cc15c7acc.png "Rendered by QuickLaTeX.com")

幂律是统计学中一个非常重要的概念，它描述了两个变量之间的关系。这两个变量相对成比例，这意味着一个变量数量的变化将反映另一个变量数量的变化。一个量随着另一个量的幂次而变化。

现在让我们借助自然对数（`ln`）来解这个方程。
...
![\ln y=\ln (b)-a \ln (x)](img/4b76547fbae2bd34f3bc9f69adc75b0d.png "Rendered by QuickLaTeX.com")
...
![\hat{y}=-a \hat{x}+\ln (b)](img/5735572a77b2bd2da718969b60935e03.png "Rendered by QuickLaTeX.com")

## 结论

现在很明显，假设已经被转换为一个线性方程。这将使我们的任务变得容易，可以分析参数是如何相互影响的。