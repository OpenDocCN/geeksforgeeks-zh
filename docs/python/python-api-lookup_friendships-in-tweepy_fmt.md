# Python: API.lookup_friendships() 在 Tweepy 中

> 原文: [https://www.geeksforgeeks.org/python-api-lookup_friendships-in-tweepy/](https://www.geeksforgeeks.org/python-api-lookup_friendships-in-tweepy/)
...
> `语法:` `API.lookup_friendships(user_ids/screen_names)`
>
> `参数:` 仅使用两个选项之一:
>
> *   `用户标识:` 指定用户标识的列表。
