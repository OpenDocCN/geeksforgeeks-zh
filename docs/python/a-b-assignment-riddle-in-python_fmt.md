...
> 原文: [https://www.geeksforgeeks.org/a-b-assignment-riddle-in-python/](https://www.geeksforgeeks.org/a-b-assignment-riddle-in-python/)
...
*   指定 `s[a] = TOS`。这将失败，如果 `s` 是不可变的。`TypeError`，因为在上面例子中元组是不可变的。
