...
> 原文: [https://www.geeksforgeeks.org/pyglet-getting-style-of-formatted-document-for-given-range/](https://www.geeksforgeeks.org/pyglet-getting-style-of-formatted-document-for-given-range/)
...
**语法:** `document.get_style_range(attribute, start, end)`

**参数:** 它以字符串和两个整数作为参数。

**返回:** 它返回给定范围内的属性的样式集，如果设置了多个值，则返回 `STYLE_UNDERLINE`。
