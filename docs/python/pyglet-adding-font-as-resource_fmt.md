...
> 原文: [https://www.geeksforgeeks.org/pyglet-adding-font-as-resource/](https://www.geeksforgeeks.org/pyglet-adding-font-as-resource/)
...
> 为了创建窗口，我们对 `pyglet.resource` 使用 `add_font` 方法。
> **语法:** `resource.add_font(name)`
> **参数:** 它将字符串作为参数。
> **返回:** 它返回 `None`。
