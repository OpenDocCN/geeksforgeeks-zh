...
> 原文: [https://www.geeksforgeeks.org/python-find-words-with-both-alphabets-and-numbers/](https://www.geeksforgeeks.org/python-find-words-with-both-alphabets-and-numbers/)
...
> 原始字符串为: geeksfor23geeks is best45 for gee34ks and cs
> 带有字母和数字的单词: ['geeksfor23geeks', 'best45', 'gee34ks']