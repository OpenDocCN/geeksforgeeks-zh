...
> 原文: [https://www.geeksforgeeks.org/mahotas-sizes-of-labeled-region/](https://www.geeksforgeeks.org/mahotas-sizes-of-labeled-region/)
...
为了做到这一点，我们将使用 `mahotas.labelled_size` 方法。

> **语法:** `mahotas.labelled_size(labelled_region)`
> **参数:** 以 `numpy.ndarray` 对象为参数，即 `labelled_region`
> **返回:** 返回整数列表
