...
> 原文: [https://www.geeksforgeeks.org/python-extract-digits-from-given-string/](https://www.geeksforgeeks.org/python-extract-digits-from-given-string/)
...
可以使用上述功能的组合来执行该任务。`filter()`功能过滤由`isdigit()`功能检测到的数字，`join()`功能执行连接功能的重构任务。
