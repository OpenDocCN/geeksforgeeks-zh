...
> 原文:[https://www . geeksforgeks . org/python-JSON-load 和-json-loads 之差/](https://www.geeksforgeeks.org/python-difference-between-json-load-and-json-loads/)
...
>
> `*object_pairs_hook*`: 这是一个可选参数，将使用任何对象文字的结果调用，这些对象文字使用有序的对列表进行解码。
