# Python 中的 `plotly.express.line()` 函数

> 原文: [https://www.geeksforgeeks.org/plotly-express-line-function-in-python/](https://www.geeksforgeeks.org/plotly-express-line-function-in-python/)
