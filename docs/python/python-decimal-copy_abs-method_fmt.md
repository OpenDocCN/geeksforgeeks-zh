...
> 原文: [https://www.geeksforgeeks.org/python-decimal-copy_abs-method/](https://www.geeksforgeeks.org/python-decimal-copy_abs-method/)

`Decimal.copy_abs()`是一个`Decimal`类方法，返回`Decimal`的绝对值。
