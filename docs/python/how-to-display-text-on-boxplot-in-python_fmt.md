...
> 原文:[https://www.geeksforgeeks.org/how-to-display-text-on-boxplot-in-python/](https://www.geeksforgeeks.org/how-to-display-text-on-boxplot-in-python/)
...
*   `horizontalalignment`或`ha`: 设置文本的水平对齐。
*   `verticalalignment`或`va`: 设置文本的垂直对齐。
