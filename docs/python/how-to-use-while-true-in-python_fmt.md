...
> 原文: [https://www.geeksforgeeks.org/how-to-use-while-true-in-python/](https://www.geeksforgeeks.org/how-to-use-while-true-in-python/)
...
如果我们运行上面的代码，那么这个循环将运行无限多次。为了摆脱这个循环，我们将明确使用 [`break`](https://www.geeksforgeeks.org/python-break-statement/) 语句。
