...
> 原文: [https://www.geeksforgeeks.org/python-dictionary-values-mapped-summation/](https://www.geeksforgeeks.org/python-dictionary-values-mapped-summation/)

给定一个带有值列表的字典，我们的任务是提取使用映射找到的值的总和。

> **输入:** `test_dict = {4 : ['a', 'v', 'b', 'e'], 1 : ['g', 'f', 'g'], 3: ['e', 'v']}`, `map_vals = {'a': 3, 'g': 8, 'f': 10, 'b': 4, 'e': 7, 'v': 2}`
>
> **输出:** `{4: 16, 1: 26, 3: 9}`
>
> **说明:** “g”有 8，“f”有 10 作为量值，因此 1 由 8 + 8 + 10 = 26 映射。(映射列表的总和)。

> **输入:** `test_dict = {4 : ['a', 'v', 'b', 'e'], 1:['g', 'f', 'g']}`, `map_vals = {'a': 3, 'g': 8, 'f': 10, 'b': 4, 'e': 7, 'v': 2}`
>
> **输出:** `{4: 16, 1: 26}`
>
> **说明:** “g”有 8，“f”有 10 作为量值，因此 1 由 8 + 8 + 10 = 26 映射。(映射列表的总和)。
