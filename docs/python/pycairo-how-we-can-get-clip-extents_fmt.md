...
原文：[https://www.geeksforgeeks.org/pycairo-how-we-can-get-clip-extents/](https://www.geeksforgeeks.org/pycairo-how-we-can-get-clip-extents/)
...
为了做到这一点，我们将使用 `clip_extents()` 方法与 `Context` 对象一起使用。

## `clip_extents()` 方法

**语法：** `Context.clip_extents()`

**参数：** 它不带参数

**返回：** `(x1, y1, x2, y2)`，全部为浮点数
