...
> 原文：[https://www.geeksforgeeks.org/build-a-gui-application-to-get-distance-between-two-places-using-python/](https://www.geeksforgeeks.org/build-a-gui-application-to-get-distance-between-two-places-using-python/)
...
*   通过 `geocode()` 获取纬度和经度。
*   用 `geopy.distance` 中的 `distance()` 方法求距离。
