...
> 原文: [https://www.geeksforgeeks.org/python-extract-hashtags-from-text/](https://www.geeksforgeeks.org/python-extract-hashtags-from-text/)

一个哈希表是一个关键字或短语，前面有一个哈希符号(`#`)，写在帖子或评论中以突出显示它并方便搜索。一些例子是：`#like`，`#gfg`，`#自拍`。
