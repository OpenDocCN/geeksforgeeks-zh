...
> 原文: [https://www.geeksforgeeks.org/python-characters-occurring-in-multiple-strings/](https://www.geeksforgeeks.org/python-characters-occurring-in-multiple-strings/)
...
> 原始列表为: ['gfg', 'is', 'best', 'for', 'geeks', 'and', 'cs']
> 出现多个字符串的字符: ['g', 'e', 'f', 's']