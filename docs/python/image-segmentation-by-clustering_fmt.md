...
> 原文：[https://www.geeksforgeeks.org/image-segmentation-by-clustering/](https://www.geeksforgeeks.org/image-segmentation-by-clustering/)
...
其中 `j` 是簇的数量，`I` 是属于第 `j` 个簇的点。上述目标函数称为平方（WCSS）距离的簇内和。
