...
> 原文: [https://www.geeksforgeeks.org/avoid-tle-in-python-in-competitive-programming/](https://www.geeksforgeeks.org/avoid-tle-in-python-in-competitive-programming/)
...
*   如果新的限制在当前递归深度太低，它将引发 [`RecursionError` 异常](https://www.geeksforgeeks.org/python-handling-recursion-limit/)。

> **语法:** `sys.setrecursionlimit(limit)`
>
> **参数:** `limit`: 可以用来设置 Python 解释器堆栈限制的整数值。
>
> **返回:** 不返回任何内容。
