...
> 原文: [https://www.geeksforgeeks.org/how-to-show-a-timer-on-screen-using-arcade-in-python3/](https://www.geeksforgeeks.org/how-to-show-a-timer-on-screen-using-arcade-in-python3/)
...
现在，定义一个 `on_update` 函数，随着分钟和秒钟的增加来更新时间。
