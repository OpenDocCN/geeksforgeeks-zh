...
> 原文: [https://www.geeksforgeeks.org/mahotas-rgb-to-sepia-conversion/](https://www.geeksforgeeks.org/mahotas-rgb-to-sepia-conversion/)
...
为了做到这一点，我们将使用 `mahotas.colors.rgb2sepia` 方法。

语法: `mahotas.colors.rgb2sepia(img)`
参数: 它以图像对象作为参数
返回: 它返回图像对象
