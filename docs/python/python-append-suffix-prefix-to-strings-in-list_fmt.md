# Python |在列表的字符串中添加后缀/前缀

> 原文：[https://www.geeksforgeeks.org/python-append-suffix-prefix-to-strings-in-list/](https://www.geeksforgeeks.org/python-append-suffix-prefix-to-strings-in-list/)
