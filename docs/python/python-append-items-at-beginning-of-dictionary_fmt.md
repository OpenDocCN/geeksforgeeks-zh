...
> 原文：[https://www.geeksforgeeks.org/python-append-items-at-beginning-of-dictionary/](https://www.geeksforgeeks.org/python-append-items-at-beginning-of-dictionary/)

给定一部词典，在它的开头附加另一部词典。

> **输入**：`test_dict = {"Gfg": 5, "is": 3, "best": 10}`，`updict = {"pre1": 4}`
> **输出**：`{"pre1": 4, "Gfg": 5, "is": 3, "best": 10}`
> **解释**：词典前更新新词典。
>
> **输入**：`test_dict = {"Gfg": 5}`，`updict = {"pre1": 4}`
> **输出**：`{"pre1": 4, 'Gfg': 5}`
> **解释**：词典前更新新词典，`"pre1": 4`。
