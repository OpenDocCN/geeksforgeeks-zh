...
> 原文：[https://www.geeksforgeeks.org/interesting-python-implementation-for-next-greater-elements/](https://www.geeksforgeeks.org/interesting-python-implementation-for-next-greater-elements/)
...
注意，上述解的时间复杂度为 `O(n*n)`。我们可以使用堆栈在 `O(n)` 时间内对其进行优化。