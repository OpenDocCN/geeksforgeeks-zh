...
> 原文：[https://www.geeksforgeeks.org/python-create-list-of-numbers-with-given-range/](https://www.geeksforgeeks.org/python-create-list-of-numbers-with-given-range/)
...
我们也可以使用列表理解来达到这个目的。只需在从 `r1` 到 `r2` 的 `for` 循环中迭代 `item`，并将所有 `item` 作为列表返回。这将是一个简单的一行代码。
