...
> 原文: [https://www.geeksforgeeks.org/python-imdbpy-person-info-set/](https://www.geeksforgeeks.org/python-imdbpy-person-info-set/)
...
> **语法:** `IMDB_object.get_person_infoset()`
> 
> **论证:** 不需要论证。
> 
> **返回:** 它返回列表。
