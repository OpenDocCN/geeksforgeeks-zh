...
> 原文：[https://www.geeksforgeeks.org/python-imdbpy-getting-movie-id-from-searched-movies/](https://www.geeksforgeeks.org/python-imdbpy-getting-movie-id-from-searched-movies/)
...
> **语法：**`movie[0].movieID`
>
> 这里的`movie`是`search_movie`返回的电影列表，`movie[0]`引用列表中的第一个元素
>
> **参数：**不需要参数。
>
> **返回：**返回电影标识字符串
