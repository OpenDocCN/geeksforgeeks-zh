...
> 原文：`https://www.geeksforgeeks.org/difference-between-python-and-c/`
...
| 参数 | Python | C++ |
| :--- | :--- | :--- |
| 代码量 | Python 的代码行更少。 | C++往往有大量的代码。 |
| 内存管理 | Python 支持垃圾收集 | C++不支持垃圾收集。 |
| 语法 | Python 很容易记住，几乎类似于人类语言。 | C++有一条僵硬的学习曲线，因为它有许多预定义的语法和结构 |
| 执行方式 | Python 使用解释器。 | C++是预编译。 |
...
| 类型系统 | Python 是动态类型的。 | C++是静态类型的。 |
| 文件扩展名 | Python 程序是用`.py`扩展名。 | C++程序是用`.cpp`扩展名。 |
