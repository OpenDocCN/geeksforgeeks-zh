# Python–API.saved_searches()在 Tweepy 中

> 原文: [`https://www.geeksforgeeks.org/python-api-saved_searches-in-tweepy/`](https://www.geeksforgeeks.org/python-api-saved_searches-in-tweepy/)
