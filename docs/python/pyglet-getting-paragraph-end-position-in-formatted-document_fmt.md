...
> 原文: [https://www.geeksforgeeks.org/pyglet-getting-paragraph-end-position-in-formatted-document/](https://www.geeksforgeeks.org/pyglet-getting-paragraph-end-position-in-formatted-document/)
...
> 为了创建窗口，我们对文档对象使用 `get_paragraph_end` 方法
> **语法:** `document.get_paragraph_end(pos)`
> **参数:** 它以整数作为参数
> **返回:** 它返回整数
