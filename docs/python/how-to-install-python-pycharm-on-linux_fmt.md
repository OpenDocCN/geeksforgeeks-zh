...
> 原文: [https://www.geeksforgeeks.org/how-to-install-python-pycharm-on-linux/](https://www.geeksforgeeks.org/how-to-install-python-pycharm-on-linux/)
...
*   **在 bin 文件夹中打开终端:**
    转到 `首页 -> nikhil -> 文档 -> pycharm-community-2019.3.1 -> bin` 打开终端窗口。
    ![Opening Terminal Window](img/eb58c2c176233ff49b13265dee4ce524.png)
*   **启动 PyCharm 的命令:**
    在终端窗口中，键入以下命令以启动 PyCharm。
