...
> 原文: [https://www.geeksforgeeks.org/add-new-enum-column-to-existing-MySQL-table-using-python/](https://www.geeksforgeeks.org/add-new-enum-column-to-existing-MySQL-table-using-python/)
