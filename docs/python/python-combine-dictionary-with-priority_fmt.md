...
> **输入**: `test_dict1 = {'Gfg' : 6, 'is' : 15, 'best' : 13}`，`test_dict2 = {'Gfg': 8, 'is' : 10}`
> **输出**: `{'Gfg': 8, 'best': 13, 'is': 10}`
>
> **输入**: `test_dict1 = {'Gfg': 6}`，`test_dict2 = {'Gfg': 8}`
> **输出**: `{'Gfg': 8}`
...
> 原词典为 2 : `{'for': 7, 'is': 10, 'geeks': 12, 'Gfg': 4}`
> 组合后的词典: `{'for': 7, 'is': 10, 'best': 3, 'geeks': 12, 'Gfg': 4}`
