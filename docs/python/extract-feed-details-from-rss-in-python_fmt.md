...
> 原文：[https://www.geeksforgeeks.org/extract-feed-details-from-rss-in-python/](https://www.geeksforgeeks.org/extract-feed-details-from-rss-in-python/)
...
现在用上面的代码写一个函数，取 RSS feed 的链接，返回细节。
