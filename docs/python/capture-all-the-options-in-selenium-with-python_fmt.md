...
> 原文：[https://www.geeksforgeeks.org/capture-all-the-options-in-selenium-with-python/](https://www.geeksforgeeks.org/capture-all-the-options-in-selenium-with-python/)
...
## 使用下拉列表
首先你要导入`Select`类，然后你要做`Select`类的案例。完成`Select`类的案例后，您可以在该场合执行选择策略，从下拉列表中选择选项。
