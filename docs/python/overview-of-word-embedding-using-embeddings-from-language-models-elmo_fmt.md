...
> 原文: [https://www.geeksforgeeks.org/overview-of-word-embedding-using-embeddings-from-language-models-elmo/](https://www.geeksforgeeks.org/overview-of-word-embedding-using-embeddings-from-language-models-elmo/)

## 什么是单词嵌入？

它是将单词表示成向量。这些向量捕捉关于单词的重要信息，使得在向量空间中共享相同邻域的单词表示相似的含义。创建单词嵌入的方法有很多种，例如 `Word2Vec`、[连续单词包(`CBOW`)、`Skip Gram`、`Glove`](https://www.geeksforgeeks.org/word-embeddings-in-nlp/#:~:text=Word%20Embeddings%20are%20a%20method,preserve%20syntactical%20and%20semantic%20information.)、`Elmo` 等。
