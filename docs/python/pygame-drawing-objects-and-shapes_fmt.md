...
> 原文: [https://www.geeksforgeeks.org/pygame-drawing-objects-and-shapes/](https://www.geeksforgeeks.org/pygame-drawing-objects-and-shapes/)
...
这可以通过遵循给定的程序来完成。创建以起始位置、宽度和高度为参数的绘图函数。绘制所需的形状如上所述。调用`drawingfunction()`
