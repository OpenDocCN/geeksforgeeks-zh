...
原文: [https://www.geeksforgeeks.org/python-custom-space-size-padding-in-strings-list/](https://www.geeksforgeeks.org/python-custom-space-size-padding-in-strings-list/)

在本文中，给定一个字符串列表，任务是编写一个 Python 程序，用空格填充每个字符串，并指定所需的前导和尾随空格数。

示例:

输入: `test_list = ["Gfg", "is", "Best"]`, `lead_size = 3`, `trail_size = 2`

输出: `['   Gfg  ', '   is  ', '   Best  ']`

说明: 每个单词 3 个空格后开始，完成后加 2 个空格。

输入: `test_list = ["Gfg", "Best"]`, `lead_size = 3`, `trail_size = 2`
