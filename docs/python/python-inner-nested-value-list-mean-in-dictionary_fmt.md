...
> 原文: [https://www.geeksforgeeks.org/python-inner-nested-value-list-mean-in-dictionary/](https://www.geeksforgeeks.org/python-inner-nested-value-list-mean-in-dictionary/)
