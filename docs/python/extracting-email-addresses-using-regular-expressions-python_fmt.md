...
> 原文：[https://www.geeksforgeeks.org/extracting-email-addresses-using-regular-expressions-python/](https://www.geeksforgeeks.org/extracting-email-addresses-using-regular-expressions-python/)
...
正则表达式是一个字符序列，主要用于查找和替换字符串或文件中的模式。所以我们可以说搜索和提取的任务是如此普遍，以至于 Python 有一个非常强大的名为正则表达式的库，可以非常优雅地处理其中的许多任务。
