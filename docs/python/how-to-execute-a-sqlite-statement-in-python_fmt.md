...
> 原文: [https://www.geeksforgeeks.org/how-to-execute-a-sqlite-statement-in-python/](https://www.geeksforgeeks.org/how-to-execute-a-sqlite-statement-in-python/)
...
*   创建到数据库的连接。这将通过连接数据库来创建一个新的数据库，这里我们必须指定数据库名称，并使用光标对象连接到它。
