...
> 原文: [https://www.geeksforgeeks.org/how-to-get-value-from-address-in-python/](https://www.geeksforgeeks.org/how-to-get-value-from-address-in-python/)
...
# get the memory address of the python object for variable
print(id(val))

# get the memory address of the python object for list
print(id([1, 2, 3, 4, 5]))

# get the memory address of the python object for tuple
print(id((1, 2, 3, 4, 5)))

# get the memory address of the python object for set
print(id({1, 2, 3, 4, 5}))
```
...
Python 程序从 Python 数据结构的内存地址中获取值。
...
# get the memory address of the python object for variable list
x = id(val)
...
# get the memory address of the python object for variable tuple
x = id(val)
...
# get the memory address of the python object for variable set
x = id(val)
...
# get the memory address of the python object for variable dictionary
x = id(val)
