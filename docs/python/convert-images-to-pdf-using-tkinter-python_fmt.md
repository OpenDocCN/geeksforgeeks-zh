...
> 原文: [https://www.geeksforgeeks.org/convert-images-to-pdf-using-tkinter-python/](https://www.geeksforgeeks.org/convert-images-to-pdf-using-tkinter-python/)
...
**第二步:** 我们将创建三个函数；`select_file()`、`image_to_pdf()` 、`images_to_pdf()`
