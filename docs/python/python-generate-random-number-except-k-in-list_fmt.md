...
> 原文：[https://www.geeksforgeeks.org/python-generate-random-number-except-k-in-list/](https://www.geeksforgeeks.org/python-generate-random-number-except-k-in-list/)
