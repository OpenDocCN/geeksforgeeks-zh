...
> 原文：[https://www.geeksforgeeks.org/python-color_matrix-function-in-wand/](https://www.geeksforgeeks.org/python-color_matrix-function-in-wand/)
...
| 参数 | 输入类型 | 描述 |
| --- | --- | --- |
| `matrix` | `collections.abc.Sequence` | 双精度二维列表。 |
