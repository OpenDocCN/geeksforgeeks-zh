...
> 原文: [https://www.geeksforgeeks.org/python-find-frequency-of-given-character-at-every-position-in-list-of-lists/](https://www.geeksforgeeks.org/python-find-frequency-of-given-character-at-every-position-in-list-of-lists/)
...
**说明:**
我们每个子列表中有 3 个元素，我们要在 0、1、2 位置找到‘X’的位置。对于所有子列表中的位置 `0` ，第一个子列表中的`X`位于零位置，第二个子列表中的`Z`位于零位置，第三个子列表中的`Y`位于零位置，第四个子列表中的`Z`位于零位置，第五个子列表中的`Y`位于零位置。
