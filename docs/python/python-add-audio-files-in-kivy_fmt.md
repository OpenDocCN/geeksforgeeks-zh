...
> 原文: [https://www.geeksforgeeks.org/python-add-audio-files-in-kivy/](https://www.geeksforgeeks.org/python-add-audio-files-in-kivy/)
...
下面代码的输出如下图，点击播放按钮会播放一个音频文件 `sampleaudio.wav`。