...
> 原文: [https://www.geeksforgeeks.org/how-to-clone-webpage-using-pywebcopy-in-python/](https://www.geeksforgeeks.org/how-to-clone-webpage-using-pywebcopy-in-python/)
...
`pywebcopy` 是一个 Python 包，用于将完整的网页和网站克隆到本地存储。

步骤:
*   导入 `pywebcopy`
*   将参数传入 `save_webpage(url="…", project_folder="路径/下载", kwargs)`
*   检查你给定的位置。
