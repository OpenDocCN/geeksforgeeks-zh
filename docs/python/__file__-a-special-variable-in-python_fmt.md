...
> 原文: [https://www.geeksforgeeks.org/__file__-a-special-variable-in-python/](https://www.geeksforgeeks.org/__file__-a-special-variable-in-python/)
...
**注意:** 更多信息请参考[邓德或 Python 中的魔法方法](https://www.geeksforgeeks.org/dunder-magic-methods-python/)。
