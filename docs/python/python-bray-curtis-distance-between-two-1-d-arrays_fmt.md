...
> 原文: [https://www.geeksforgeeks.org/python-bray-curtis-distance-between-two-1-d-arrays/](https://www.geeksforgeeks.org/python-bray-curtis-distance-between-two-1-d-arrays/)

## `scipy.stats.braycurtis(数组，轴=0)` 函数
