...
> 原文: [https://www.geeksforgeeks.org/python-add-leading-zeros-to-string/](https://www.geeksforgeeks.org/python-add-leading-zeros-to-string/)

有时，在字符串操作过程中，我们会遇到一个问题，需要根据需要填充或添加前导零到字符串中。这个问题可能发生在 web 开发中。在许多情况下，用人手解决这个问题会很方便。让我们讨论一下解决这个问题的某些方法。

## 方法 1: 使用 `rjust()`

`rjust()` 函数提供了一种单线方式来执行这一特定任务。因此可以很容易地应用于任何需要填充的字符串。我们可以指定所需的填充量。
