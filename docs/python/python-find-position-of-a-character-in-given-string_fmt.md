...
> 原文: [https://www.geeksforgeeks.org/python-find-position-of-a-character-in-given-string/](https://www.geeksforgeeks.org/python-find-position-of-a-character-in-given-string/)

给定一个字符串和一个字符，您的任务是找到该字符在字符串中的第一个位置。这些类型的问题在非常有竞争力的编程中很常见，您需要定位字符串中字符的位置。
我们来讨论几个解决问题的方法。
