...
#### 方法
想法是将邻接表存储到字典中，这有助于以任何格式存储图形，而不仅仅是以整数的形式。在这里，我们使用字符作为这些地方的参考，任何自定义对象也可以使用。
...
#### 方法
思路是使用[队列](https://www.geeksforgeeks.org/queue-data-structure/)以[广度优先搜索](https://www.geeksforgeeks.org/breadth-first-search-or-bfs-for-a-graph/)的方式访问遍历图的起始节点的每个相邻节点，找到图的两个节点之间的最短路径。
