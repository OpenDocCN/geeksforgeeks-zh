...
> 原文: [https://www.geeksforgeeks.org/python-adjacent-coordinates-in-n-dimension/](https://www.geeksforgeeks.org/python-adjacent-coordinates-in-n-dimension/)

有时，在使用 Python Matrix 时，我们可能会遇到一个问题，需要提取给定坐标的所有相邻坐标。这类问题可以应用于许多领域，如 web 开发和学校编程。让我们讨论执行这项任务的特定方式。

> **输入** : `test_tup = (1, 2, 3)`
> **输出** : `[[0, 1, 2], [0, 1, 3], [0, 1, 4], [0, 2, 2], [0, 2, 3], [0, 3, 2], [0, 3, 3], [0, 3, 4], [1, 1, 2], [1, 1, 3], [1, 1, 4], [1, 2, 2], [1, 2, 3], [1, 2, 4], [1, 3, 2], [1, 3, 3], [1, 3, 4], [2, 1, 2], [2, 1, 3], [2, 1, 4], [2, 2, 2], [2, 2, 3], [2, 2, 4], [2, 3, 2], [2, 3, 3], [2, 3, 4]]`
> **输入** : `test_tup = (5, 6)`
