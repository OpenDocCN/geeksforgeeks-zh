...
> 原文: [https://www.geeksforgeeks.org/different-forms-of-assignment-statements-in-python/](https://www.geeksforgeeks.org/different-forms-of-assignment-statements-in-python/)

我们使用 Python 赋值语句将对象赋给名称。赋值语句的目标写在等号 (`=`) 的左边，右边的对象可以是计算对象的任意表达式。
