...
> 原文: [https://www.geeksforgeeks.org/adding-collisions-using-pygame-rect-colliderect-in-pygame/](https://www.geeksforgeeks.org/adding-collisions-using-pygame-rect-colliderect-in-pygame/)

**先决条件:** [在 Pygame 中绘制形状](https://www.geeksforgeeks.org/python-drawing-different-shapes-on-pygame-window/) [Pygame 简介](https://www.geeksforgeeks.org/introduction-to-pygame/)

在本文中，我们将使用 `pygame.Rect.colliderect` 用于使用 Python 中的 Pygame 在形状中添加碰撞。

我们可以使用 `colliderect()` 在 Pygame 形状中轻松添加碰撞。为此，我们将绘制两个矩形，然后我们将检查矩形是否碰撞。

`语法：pygame.Rect.colliderect(rect1, rect2)`
