...
> 原文: [https://www.geeksforgeeks.org/prediction-of-wine-type-using-deep-learning/](https://www.geeksforgeeks.org/prediction-of-wine-type-using-deep-learning/)
...
5.  **氯化物:** 它可能是葡萄酒咸味的一个重要因素。该变量的值在数据集中用 `gm/dm3` 表示。
6.  **游离二氧化硫:** 是二氧化硫加到葡萄酒中的部分。该变量的值在数据集中用 `gm/dm3` 表示。
7.  **总二氧化硫:** 是结合二氧化硫和游离二氧化硫的总和。该变量的值在数据集中用 `gm/dm3` 表示。
