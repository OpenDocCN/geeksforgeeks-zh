...
> 原文: [https://www.geeksforgeeks.org/how-to-handle-a-python-exception-in-a-list-comprehension/](https://www.geeksforgeeks.org/how-to-handle-a-python-exception-in-a-list-comprehension/)
...
考虑两个包含整数的列表(`list1`、`list2`)。现在需要通过将 `list1` 元素除以 `list2` 元素来形成一个新的列表(`list3`)。它可以用下面给出的公式表示。
...
> 数字 17 不能被 2 整除！！
>
> 新列表有: `[2, None, 56, -78, 12, None, None, None, -24]`
