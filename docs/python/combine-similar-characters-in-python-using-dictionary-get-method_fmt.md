...
> 原文：[https://www.geeksforgeeks.org/combine-similar-characters-in-python-using-dictionary-get-method/](https://www.geeksforgeeks.org/combine-similar-characters-in-python-using-dictionary-get-method/)
...
我们将使用 `dictionary` 类的 [`get()`](https://www.geeksforgeeks.org/get-method-dictionaries-python/) 方法。
...
# storing the product of keys and their respective values in result
for i, j in zip(k, v):
    result.append(i * j)
...
```py
# declaring the list of characters
mylist = ['p', 'y', 't', 'h', 'o', 'n', 't', 'u', 't', 'o', 'r', 'i', 'a', 'l']
