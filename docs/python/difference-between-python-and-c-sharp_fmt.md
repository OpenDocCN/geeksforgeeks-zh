...
| 没有 | C# | 计算机编程语言 |
| :--- | :--- | :--- |
| 1. | C#由微软开发，免费提供，甚至用于商业目的。`.NET`生态系统是完全开源的&归`.NET`基金会，这是一个独立的组织。 | Python 也是一个开源平台，即使出于商业目的，也可以免费获得。 |
| 2. | C#支持面向对象编程、结构化编程、函数式编程以及许多其他编程。 | 而 python 支持多范式编程语言，如 OOPs 和结构化编程等。 |
| 3. | C#要求`.NET SDK`&运行时。`.NET`生态系统提供了与 F#、VB.NET、JavaScript、Python 等语言的互操作。 | 同时也可以与`.NET`、C、javaScript 和 Java。 |
