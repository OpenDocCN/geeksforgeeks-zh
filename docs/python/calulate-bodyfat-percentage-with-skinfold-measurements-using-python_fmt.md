...
> 原文：[https://www.geeksforgeeks.org/calculate-bodyfat-percentage-with-skinfold-measurements-using-python/](https://www.geeksforgeeks.org/calculate-bodyfat-percentage-with-skinfold-measurements-using-python/)
...
我们将使用`fitness-tools`模块来计算体脂百分比。在开始之前，我们需要安装`fitness-tools`模块：
...
*   Import module
*   Pass the following parameters to `DurninWomersley`
*   用`body_density()`
