...
> 原文: [https://www.geeksforgeeks.org/caller-id-lookup-using-python/](https://www.geeksforgeeks.org/caller-id-lookup-using-python/)
...
在本文中，我们将看到如何使用 `numverify` API 获取来电显示信息。Numverify 提供了一个强大的工具，只需使用一个简单的网址发出请求，就可以以便携式 JSON 格式提供电话号码验证和信息查找。
...
*   `requests`: Request 让你可以极其轻松地发送 HTTP/1.1 请求。该模块也没有内置 Python。要安装，请在您的终端中键入以下命令。
