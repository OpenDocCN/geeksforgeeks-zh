...
> 原文：[https://www.geeksforgeeks.org/c-extension-module-using-python/](https://www.geeksforgeeks.org/c-extension-module-using-python/)
...
`代码#5`：现在只需使用 `python3 setup.py build_ext --inplace`，构建结果库。
