...
> 原文: [https://www.geeksforgeeks.org/dumping-queue-in-list-or-array-in-python/](https://www.geeksforgeeks.org/dumping-queue-in-list-or-array-in-python/)
...
在本例中，我们将使用 `collections` 包创建一个队列，然后将其转换到列表中。
...
在本例中，我们将使用 `queue` 模块创建一个队列，然后将其转换到列表中。
