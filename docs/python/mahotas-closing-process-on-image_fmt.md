...
> 原文: [https://www.geeksforgeeks.org/mahotas-closing-process-on-image/](https://www.geeksforgeeks.org/mahotas-closing-process-on-image/)
...
为此，我们将使用 `mahotas.morph.close` 方法。

语法: `mahotas.morph.close(image)`
自变量: 它以图像对象为自变量
返回: 它返回图像对象
