...
> 原文: [https://www.geeksforgeeks.org/environment-setup-for-cherrypy/](https://www.geeksforgeeks.org/environment-setup-for-cherrypy/)
...
奇瑞没有任何环境要求。常见的 Python 包管理器（如 `setuptools` 或 `pip`）会自动安装所有基于 Python 的分发需求。
