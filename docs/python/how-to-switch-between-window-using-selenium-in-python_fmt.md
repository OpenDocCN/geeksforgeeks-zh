...
> 原文: [https://www.geeksforgeeks.org/how-to-switch-between-window-using-selenium-in-python/](https://www.geeksforgeeks.org/how-to-switch-between-window-using-selenium-in-python/)
...
如果我们打开多个窗口，那么我们希望打印每个窗口页面的标题，但是我们只打印标题的父窗口，而不是所有窗口页面的标题。这个问题将通过 `driver.switch_to_window()` 解决。使用这种方法，我们能够打印标题的每一页。
