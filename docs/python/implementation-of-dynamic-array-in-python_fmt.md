...
> 原文：[https://www.geeksforgeeks.org/implementation-of-dynamic-array-in-python/](https://www.geeksforgeeks.org/implementation-of-dynamic-array-in-python/)
...
关于公共方法和私有方法的快速说明，我们可以在方法名前使用一个 `下划线_` 来保持它的非公共性。例如：
...
2.  将 **B[i]=A[i]** 设置为 **i=0** 到 **n-1**，其中 `n` 表示当前项目数。
