...
> 原文: [https://www.geeksforgeeks.org/convert-string-to-set-in-python/](https://www.geeksforgeeks.org/convert-string-to-set-in-python/)

我们可以使用 `set()` 函数将字符串转换为 Python 中的 set。
