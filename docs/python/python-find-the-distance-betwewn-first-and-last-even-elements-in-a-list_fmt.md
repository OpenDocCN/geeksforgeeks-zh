...
> 原文: [https://www.geeksforgeeks.org/python-find-the-distance-between-first-and-last-even-elements-in-a-list/](https://www.geeksforgeeks.org/python-find-the-distance-between-first-and-last-even-elements-in-a-list/)
...
在这种情况下，我们使用`列表理解`获得所有偶数元素的所有索引，然后执行列表中匹配元素的第一个和最后一个索引的差异。
