...
> 原文: [https://www.geeksforgeeks.org/parsing-xml-with-dom-apis-in-python/](https://www.geeksforgeeks.org/parsing-xml-with-dom-apis-in-python/)

[文档对象模型](https://www.geeksforgeeks.org/dom-document-object-model/) (DOM) 是一个用于 `HTML` 和 `XML` (可扩展标记语言) 文档的编程接口。它定义了文档的逻辑结构以及访问和操作文档的方式。
