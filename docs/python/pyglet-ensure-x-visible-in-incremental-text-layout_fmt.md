...
> 原文: [https://www.geeksforgeeks.org/pyglet-ensure-x-visible-in-incremental-text-layout/](https://www.geeksforgeeks.org/pyglet-ensure-x-visible-in-incremental-text-layout/)
...
> 为了创建窗口，我们使用了 `ensure_x_visible` 方法
> **语法:** `layout.ensure_x_visible(x)`
> **参数:** 它以整数作为参数
> **返回:** 它返回 `None`
