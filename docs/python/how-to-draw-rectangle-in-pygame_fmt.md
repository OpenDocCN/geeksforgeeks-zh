...
> 原文: [https://www.geeksforgeeks.org/how-to-draw-rectangle-in-pygame/](https://www.geeksforgeeks.org/how-to-draw-rectangle-in-pygame/)
...
*   `pygame.display.set_mode()`: 此功能用于初始化一个曲面进行显示。该函数将显示屏的大小作为参数。
