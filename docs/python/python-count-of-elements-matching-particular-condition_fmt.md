...
> 原文: [https://www.geeksforgeeks.org/python-count-of-elements-matching-particular-condition/](https://www.geeksforgeeks.org/python-count-of-elements-matching-particular-condition/)
...
`map()`完成的任务几乎类似于生成器表达式，不同的只是它采用的内部数据结构不同因此效率更高。
