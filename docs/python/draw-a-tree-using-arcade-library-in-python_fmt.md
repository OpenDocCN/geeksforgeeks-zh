...
> 原文: [https://www.geeksforgeeks.org/draw-a-tree-using-arcade-library-in-python/](https://www.geeksforgeeks.org/draw-a-tree-using-arcade-library-in-python/)

使用[海龟](https://www.geeksforgeeks.org/turtle-programming-python/)模块在 Python 中绘制一棵树并不是一件难事。但是，如果你也可以用街机模块画出来呢。街机是一个面向对象的库。它可以像任何其他 Python 包一样使用`import arcade`进行安装。
