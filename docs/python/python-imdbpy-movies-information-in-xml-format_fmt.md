...
> 原文: [https://www.geeksforgeeks.org/python-imdbpy-movies-information-in-xml-format/](https://www.geeksforgeeks.org/python-imdbpy-movies-information-in-xml-format/)
...
> 1. 导入 IMDbPY 模块
> 2. 创建一个 `IMDb` 实例
> 3. 借助 `get_movie` 方法，需要电影 ID 来获取电影对象
> 4. 通过使用 `asXML` 方法将电影对象转换为 XML，在此获取 XML 格式值，它将是字符串形式
