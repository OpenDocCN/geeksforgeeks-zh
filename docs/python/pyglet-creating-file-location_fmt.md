...
> 原文: [https://www.geeksforgeeks.org/pyglet-creating-file-location/](https://www.geeksforgeeks.org/pyglet-creating-file-location/)
...
> 为了创建窗口，我们使用文件位置方法和 `pyglet` 资源。
> `pyglet.resource.FileLocation(路径)`
> 以字符串为参数。
> 返回文件位置对象。
