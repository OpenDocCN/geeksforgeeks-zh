...
> 原文: [https://www.geeksforgeeks.org/how-to-install-anaconda-on-windows/](https://www.geeksforgeeks.org/how-to-install-anaconda-on-windows/)
...
*   **选择安装类型：** 如果您希望软件由单个用户使用，请选择 `只需我`。
    ![Installation-Type](img/0fff06b594b0bc12f81685254f33b457.png)
*   **选择安装地点：**
...
安装过程完成后，`Anaconda` 可用于执行多个操作。要开始使用 `Anaconda`，请在 Windows 的开始菜单中搜索 `Anaconda Navigator`。
![Anaconda-Navigator-Search](img/8ceb3e3f619d861a93a1630763c25f2d.png)
![Anaconda-Navigator-Window](img/6382464f8a7481c169480ec5e4b1d34e.png)