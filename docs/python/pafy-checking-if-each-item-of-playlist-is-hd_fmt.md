...
> 原文：[https://www.geeksforgeeks.org/pafy-checking-if-each-item-of-playlist-is-hd/](https://www.geeksforgeeks.org/pafy-checking-if-each-item-of-playlist-is-hd/)
...
6.  对于元数据，使用 `"is_hd"` 键，当项目在高清模式下可用时，该键将返回 `True`。
