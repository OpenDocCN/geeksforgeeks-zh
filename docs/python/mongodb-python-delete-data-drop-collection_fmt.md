...
> 原文: [https://www.geeksforgeeks.org/mongodb-python-delete-data-drop-collection/](https://www.geeksforgeeks.org/mongodb-python-delete-data-drop-collection/)

## 先决条件
*   [MongoDB 基础](https://www.geeksforgeeks.org/mongodb-getting-started/)
*   [插入并更新](https://www.geeksforgeeks.org/mongodb-python-insert-update-data/)

## 目的
删除数据库中集合的条目/文档。假定集合的名称为 `my_collection`。
