...
> 原文：[https://www.geeksforgeeks.org/python-find-elements-of-a-list-by-indices/](https://www.geeksforgeeks.org/python-find-elements-of-a-list-by-indices/)

给定两个包含元素和索引的列表，编写一个 Python 程序，在`lst2`中的索引处找到`lst1`的元素。
...
下面是一些完成上述任务的 Python 方法。

### 方法#1：列表理解

找到所需元素的第一种方法是使用列表理解。我们遍历`lst2`，对于每个第`i`个元素，我们输出`lst1[i]`。
