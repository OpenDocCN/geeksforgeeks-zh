...
> 原文: [https://www.geeksforgeeks.org/how-to-create-a-frame-inside-a-frame-tkinter/](https://www.geeksforgeeks.org/how-to-create-a-frame-inside-a-frame-tkinter/)
...
`Frame()` 是一个内置的 Tkinter 方法，有助于实现我们所需的功能。
