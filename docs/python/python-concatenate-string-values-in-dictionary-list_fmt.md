...
> 原文: [https://www.geeksforgeeks.org/python-concatenate-string-values-in-dictionary-list/](https://www.geeksforgeeks.org/python-concatenate-string-values-in-dictionary-list/)
...
>
> 输入: `test_list = [{'id': 1, 'gfg': 'geeks for'}, {'id': 1, 'gfg': 'geeks'}, {'id': 1, 'gfg': 'good'}]`
