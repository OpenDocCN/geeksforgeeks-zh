...
> 原文: [https://www.geeksforgeeks.org/mahotas-loading-image-as-grey/](https://www.geeksforgeeks.org/mahotas-loading-image-as-grey/)
...
> **语法:** `mahotas.demos.load('luispedro', as_grey=True)`
> **参数:** 它以图像名称作为参数
