...
> 原文: [https://www.geeksforgeeks.org/how-to-make-a-proper-double-scrollbar-frame-in-tkinter/](https://www.geeksforgeeks.org/how-to-make-a-proper-double-scrollbar-frame-in-tkinter/)
...
*   `geometry()`: 该方法用于设置 Tkinter 窗口的尺寸，也用于设置主窗口在用户桌面上的位置。
