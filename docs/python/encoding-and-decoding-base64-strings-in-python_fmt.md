...
> 原文: [https://www.geeksforgeeks.org/encoding-and-decoding-base64-strings-in-python/](https://www.geeksforgeeks.org/encoding-and-decoding-base64-strings-in-python/)
...
## 使用 Python 编码字符串:
在 Python 中，`base64`模块用于编码和解码数据。首先，字符串被转换为类字节对象，然后使用`base64`模块进行编码。下面的示例展示了如何将字符串编码为 Base64 字符。
