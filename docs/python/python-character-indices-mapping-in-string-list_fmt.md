...
> 原文: [https://www.geeksforgeeks.org/python-character-indices-mapping-in-string-list/](https://www.geeksforgeeks.org/python-character-indices-mapping-in-string-list/)
