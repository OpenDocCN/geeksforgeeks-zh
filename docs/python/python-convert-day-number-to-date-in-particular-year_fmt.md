...
> 原文: [https://www.geeksforgeeks.org/python-convert-day-number-to-date-in-particular-year/](https://www.geeksforgeeks.org/python-convert-day-number-to-date-in-particular-year/)

给定日期，转换为它所指的日期。

> **输入**: `Day_num = "339"`, `year = "2020"`
> **输出**: 12-04-2020
> **说明**: 2020 年第 339 天是 12 月 4 日。
>
> **输入**: `Day_num = "4"`, `year = "2020"`
> **输出**: 01-04-2020
