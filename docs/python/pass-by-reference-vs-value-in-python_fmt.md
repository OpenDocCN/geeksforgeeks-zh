...
> 原文: [https://www.geeksforgeeks.org/pass-by-reference-vs-value-in-python/](https://www.geeksforgeeks.org/pass-by-reference-vs-value-in-python/)
...
读完之后，你可能想打一些东西，所以振作起来。`Python` 的参数传递模型既不是“按值传递”，也不是“按引用传递”，而是“按对象引用传递”。
...
![](img/7e2199bf5e02421d7a9661aafcb38044.png)
