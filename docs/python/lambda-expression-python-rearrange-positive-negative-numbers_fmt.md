...
> 原文: [https://www.geeksforgeeks.org/lambda-expression-python-rearrange-positive-negative-numbers/](https://www.geeksforgeeks.org/lambda-expression-python-rearrange-positive-negative-numbers/)
...
这个问题有很多解决方法，请参考[重新排列正负数字](https://www.geeksforgeeks.org/rearrange-positive-negative-numbers-using-inbuilt-sort-function/)链接，但是我们将用 Python 中的单行代码使用 `Lambda` 表达式来解决这个问题。
