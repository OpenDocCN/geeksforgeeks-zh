...
> 原文: [https://www.geeksforgeeks.org/python-cross-mapping-of-two-dictionary-value-lists/](https://www.geeksforgeeks.org/python-cross-mapping-of-two-dictionary-value-lists/)

给定两个具有列表值的字典，通过检查值-键链接，执行第一个列表的键与其他列表的值的映射。

> **输入**: `test_dict1 = {"Gfg":[4, 10], "Best":[8, 6], "is":[9, 3]}`, `test_dict2 = {6: [15, 9], 8: [6, 3], 7: [9, 8], 9: [10, 11]}`
> **输出**: `{"Best": [6, 3, 15, 9], "is": [10, 11]}`
> **解释**:
>
> **输入**: `test_dict1 = {"Gfg":[4, 10], "Best":[18, 16], "is":[9, 3]}`, `test_dict2 = {6: [15, 9], 8: [6, 3], 7: [9, 8], 9: [10, 11]}`
> **输出**: `{'is': [10, 11]}`
> **解释**: 只有 9 作为可能的键存在。
