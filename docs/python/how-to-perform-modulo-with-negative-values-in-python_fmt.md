...
> 原文: [https://www.geeksforgeeks.org/how-to-perform-modulo-with-negative-values-in-python/](https://www.geeksforgeeks.org/how-to-perform-modulo-with-negative-values-in-python/)

取负数的`模`是一个稍微复杂一点的数学，是在 Python 程序后面完成的。如果我们不理解负数模背后的数学，它将成为一个巨大的搅拌机。

## 负模背后的数学

让我们考虑一个例子，我们希望找到`-5%4`。你们一定都想知道答案是否符合以下规则：
