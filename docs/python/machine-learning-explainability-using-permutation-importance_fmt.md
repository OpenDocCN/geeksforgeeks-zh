...
> 原文：[https://www.geeksforgeeks.org/machine-learning-explainability-using-permutation-importance/](https://www.geeksforgeeks.org/machine-learning-explainability-using-permutation-importance/)
...
1.  [ELI5 文档](https://eli5.readthedocs.io/en/latest/index.html)
2.  [Kaggle 机器学习可解释性课程](https://www.kaggle.com/learn/machine-learning-explainability)
3.  [Scikit-learn 随机森林回归器](https://scikit-learn.org/stable/modules/generated/sklearn.ensemble.RandomForestRegressor.html)
