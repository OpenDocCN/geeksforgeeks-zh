...
> 原文：[https://www.geeksforgeeks.org/next-sentence-prediction-using-bert/](https://www.geeksforgeeks.org/next-sentence-prediction-using-bert/)

**先决条件**：[BERT-GFG](https://www.geeksforgeeks.org/explanation-of-bert-model-nlp/)

`BERT`代表**变压器的双向表示**。它是由谷歌研究公司的研究人员在 2018 年提出的。尽管如此，其主要目的是提高对谷歌搜索相关查询含义的理解。一项研究显示，谷歌每天都会遇到 15%的新查询。因此，它要求谷歌搜索引擎对语言有更好的理解，以便理解搜索查询。
...
![](img/f6f0aa8644b43228a9f651c172e1b1ad.png) 硬模型

![](img/7be77836b5535c99cb71cf96e1793756.png) 二进制精度图
