...
> 原文: [https://www.geeksforgeeks.org/how-to-drop-multiple-column-names-given-in-a-list-from-pyspark-dataframe/](https://www.geeksforgeeks.org/how-to-drop-multiple-column-names-given-in-a-list-from-pyspark-dataframe/)

在本文中，我们将删除 Python 中 Pyspark 数据框中列表中给出的多个列。

为此，我们将使用 `drop()` 功能。此函数用于从数据框中移除值。

> **语法:** `dataframe.drop(*['列1'，'列2'，'列n'])`
>
> 哪里，
>
> *   `dataframe` 是输入数据帧
> *   列名是通过 `dataframe` 中的列表传递的。
