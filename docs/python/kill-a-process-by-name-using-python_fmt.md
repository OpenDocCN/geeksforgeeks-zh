...
> 原文：[https://www.geeksforgeeks.org/kill-a-process-by-name-using-python/](https://www.geeksforgeeks.org/kill-a-process-by-name-using-python/)
...
*   `os.popen()`: 此方法用于打开一个 pip 往返命令。
    在下图中，您可以看到火狐正在运行的进程
*   `os.kill()`: Python 中的这个方法是用来给进程发送一个指定的信号，这个进程有指定的进程 id。
