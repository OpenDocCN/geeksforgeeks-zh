...
> 原文：[https://www.geeksforgeeks.org/get-live-train-status-using-python/](https://www.geeksforgeeks.org/get-live-train-status-using-python/)
...
现在将列车名称合并为 URL，并将 URL 传递给 `getdata()` 函数，并将该数据转换为 HTML 代码。
