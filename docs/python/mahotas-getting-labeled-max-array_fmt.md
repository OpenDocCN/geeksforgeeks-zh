...
> 原文: [https://www.geeksforgeeks.org/mahotas-getting-labeled-max-array/](https://www.geeksforgeeks.org/mahotas-getting-labeled-max-array/)
...
为了做到这一点，我们将使用 `mahotas.labeled.label_max` 方法。

> **语法:** `mahotas.labeled.label_max(array, label_img)`
