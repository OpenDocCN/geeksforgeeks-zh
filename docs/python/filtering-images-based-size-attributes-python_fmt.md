...
> 原文：[https://www.geeksforgeeks.org/filtering-images-based-size-attributes-python/](https://www.geeksforgeeks.org/filtering-images-based-size-attributes-python/)

## 先决条件
[PIL-Working-with-Images-Python](https://www.geeksforgeeks.org/working-images-python/)
