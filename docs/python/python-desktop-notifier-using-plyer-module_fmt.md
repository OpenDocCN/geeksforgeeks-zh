...
> 原文: [https://www.geeksforgeeks.org/python-desktop-notifier-using-plyer-module/](https://www.geeksforgeeks.org/python-desktop-notifier-using-plyer-module/)
...
> *   `标题` (*str*) – 通知标题
> *   `消息` (*str*) – 通知消息
> *   `app_Name` (*str*) – 启动此通知的应用程序的名称
> *   `app_Icon` (*str*) – 与消息一起显示的图标
> *   `超时` (*int*) – 显示消息的时间，默认为 10
> *   `滚动条` (*str*) – 通知到达时状态栏上显示的文本
> *   `祝酒` (*bool*) – 简单的安卓消息，而不是完整的通知
