...
> 原文: [https://www.geeksforgeeks.org/python-custom-element-repetition/](https://www.geeksforgeeks.org/python-custom-element-repetition/)

给定元素列表和所需的出现列表，执行元素的重复。

> `输入`: `test_list1 = ["Gfg", "Best"]`, `test_list2 = [4, 5]`
> `输出`: `['Gfg', 'Gfg', 'Gfg', 'Gfg', 'Best', 'Best', 'Best', 'Best']`
> `解释`: 按出现次数重复的元素。
>
> `输入`: `test_list1 = ["Gfg"]`, `test_list2 = [5]`
> `输出`: `['Gfg', 'Gfg', 'Gfg', 'Gfg', 'Gfg']`
> `解释`: 按出现次数重复的元素。
