...
> 原文: [https://www.geeksforgeeks.org/digital-low-pass-butterworth-filter-in-python/](https://www.geeksforgeeks.org/digital-low-pass-butterworth-filter-in-python/)
...
### 步骤 3: 使用 `signal.buttord` 功能构建滤波器。
