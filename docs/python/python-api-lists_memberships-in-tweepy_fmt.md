...
> 原文: [https://www.geeksforgeeks.org/python-api-lists_memberships-in-tweepy/](https://www.geeksforgeeks.org/python-api-lists_memberships-in-tweepy/)
...
> **语法:** `API.lists_memberships(参数)`
>
> **参数:**
>
> *   `user_id`: 用户的 id。
> *   `screen_name`: 用户的屏幕名称。
> *   `filter_to_owned_list`: 布尔值，指示是否只返回认证用户拥有的列表。
>
