...
> 原文：[https://www.geeksforgeeks.org/how-to-build-a-simple-auto-login-bot-with-python/](https://www.geeksforgeeks.org/how-to-build-a-simple-auto-login-bot-with-python/)
...
我们将使用 [`selenium`](https://www.geeksforgeeks.org/browser-automation-using-selenium/) (`python` 库)来制作自动登录机器人。`Python` `selenium` 库帮助我们访问 `selenium` 网络驱动程序的所有功能，如 `Firefox`、`Chrome`、远程等。
