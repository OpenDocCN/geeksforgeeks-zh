...
> 原文: [https://www.geeksforgeeks.org/internal-working-of-list-in-python/](https://www.geeksforgeeks.org/internal-working-of-list-in-python/)

**Python 列表介绍:**
[Python 列表](https://www.geeksforgeeks.org/python-list/)内部表示为数组。使用的思想类似于 C++ 中向量的[实现](https://www.geeksforgeeks.org/how-does-a-vector-work-in-c/)或者 Java 中的 `ArrayList`。代价高昂的操作是在靠近开始处插入和删除项目（因为所有东西都必须移动）。如果预先分配的空间变满，在末尾插入也会变得昂贵。
...
| 操作 | 平均情况 | [摊销](https://www.geeksforgeeks.org/analysis-algorithm-set-5-amortized-analysis-introduction/) 最坏情况 |
| :--- | :--- | :--- |
| 复制 | O(n) | O(n) |
| 追加[1] | O(1) | O(1) |
| 最后一次流行 | O(1) | O(1) |
