...
> 原文：[https://www.geeksforgeeks.org/how-to-merge-all-excel-files-in-a-folder-using-python/](https://www.geeksforgeeks.org/how-to-merge-all-excel-files-in-a-folder-using-python/)
...
*   [`Pandas`](https://www.geeksforgeeks.org/introduction-to-pandas-in-python/)：`Pandas` 是一个为 python 编程语言开发的 python 库，用于操纵数据和分析数据。它被广泛用于数据科学和数据分析。
...
*   使用 `Glob` 模块显示文件夹中的文件名。 [`glob.glob()`](https://www.geeksforgeeks.org/how-to-use-glob-function-to-find-files-recursively-in-python/) 函数将使用搜索给定路径中的所有文件。`xlsx` 扩展。`print(filenames)` 显示所有扩展名为 `xlsx` 的文件的名称。
