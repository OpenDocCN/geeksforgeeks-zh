...
> 原文: [https://www.geeksforgeeks.org/pprint-data-pretty-printer-python/](https://www.geeksforgeeks.org/pprint-data-pretty-printer-python/)
...
我们所做的只是导入 `pprint` 模块的 `pprint` 功能。并且使用 `pprint()` 功能而不是 `print()` 功能！
