...
> 原文: [https://www.geeksforgeeks.org/link-prediction-predict-edges-in-a-network-using-networkx/](https://www.geeksforgeeks.org/link-prediction-predict-edges-in-a-network-using-networkx/)
...
> **comm_masseb(X, Y) =** |N(X) ![\cap](img/6463f39e73afb70f874d7c5e7c1d05ae.png "Rendered by QuickLaTeX.com") N(Y)|，其中 `N(X)` 是 `X` 的所有邻居的集合
