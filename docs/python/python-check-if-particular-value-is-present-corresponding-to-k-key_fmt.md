...
> 原文: [https://www.geeksforgeeks.org/python-check-if-particular-value-is-present-corresponding-to-k-key/](https://www.geeksforgeeks.org/python-check-if-particular-value-is-present-corresponding-to-k-key/)
