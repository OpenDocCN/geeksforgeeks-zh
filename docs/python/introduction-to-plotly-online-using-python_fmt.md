...
> 原文：[https://www.geeksforgeeks.org/introduction-to-plotly-online-using-python/](https://www.geeksforgeeks.org/introduction-to-plotly-online-using-python/)

Plotly 库是一个交互式开源库。这对于数据可视化和简单容易地理解数据是非常有用的工具。Plotly graph 对象是易于使用的高级绘图界面。它可以绘制各种类型的图形和图表，如散点图、折线图、条形图、箱线图、直方图、饼图等。
