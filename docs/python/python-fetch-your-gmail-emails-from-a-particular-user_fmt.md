...
> 原文: [https://www.geeksforgeeks.org/python-fetch-your-gmail-emails-from-a-particular-user/](https://www.geeksforgeeks.org/python-fetch-your-gmail-emails-from-a-particular-user/)
...
*   这个过程从借助 `imaplib` 库建立 Gmail 连接并向其证明我们的 Gmail 登录凭证开始。
...
for msg in msgs[::-1]:
    for sent in msg:
        if type(sent) is tuple:
            ...
            # Handling errors related to unicodeencode
            try:
