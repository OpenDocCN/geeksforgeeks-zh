...
> 原文: [https://www.geeksforgeeks.org/python-geometry-method-in-tkinter/](https://www.geeksforgeeks.org/python-geometry-method-in-tkinter/)
...
Tkinter 提供了很多方法；其中之一就是 `geometry()` 方法。该方法用于设置 [Tkinter](https://www.geeksforgeeks.org/python-gui-tkinter/) 窗口的尺寸，并用于设置主窗口在用户桌面上的位置。

## 不使用几何方法的示例

**代码#1:** 不使用 `geometry` 方法的 Tkinter 窗口。
