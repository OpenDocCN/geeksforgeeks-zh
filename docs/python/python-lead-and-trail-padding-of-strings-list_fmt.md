...
> 原文: [https://www.geeksforgeeks.org/python-lead-and-trail-padding-of-strings-list/](https://www.geeksforgeeks.org/python-lead-and-trail-padding-of-strings-list/)
...
该任务也可以使用上述功能的组合来执行。在本文中，我们使用带格式的字符串和`+`运算符来执行填充任务。
