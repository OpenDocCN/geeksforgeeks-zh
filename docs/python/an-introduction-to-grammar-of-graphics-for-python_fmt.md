...
> 原文：[https://www.geeksforgeeks.org/an-introduction-to-grammar-of-graphics-for-python/](https://www.geeksforgeeks.org/an-introduction-to-grammar-of-graphics-for-python/)
...
`plotnine` 是 Python 中图形语法的实现/绑定。它基于 `ggplot2`。所以，基本上，如果你熟悉 R 编程和 `ggplot2`，你很可能很快就会赶上 `plotnine`。`ggplot2` 和 `plotnine` 只有 2 处明显的变化。
...
**注意：** 以下是以下示例中使用的 CSV 文件的链接：[dataset.csv](https://drive.google.com/file/d/15d90LElqnVfCo6v0zQltwRWorkm6gzsL/view?usp=sharing)
