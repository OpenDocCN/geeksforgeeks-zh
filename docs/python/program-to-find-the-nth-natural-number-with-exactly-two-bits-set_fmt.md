...
> 原文: [https://www.geeksforgeeks.org/program-to-find-the-nth-natural-number-with-exactly-two-bits-set/](https://www.geeksforgeeks.org/program-to-find-the-nth-natural-number-with-exactly-two-bits-set/)
...
3.  **注意:** [在数字 `K` 中设置第 `I` 位](https://www.geeksforgeeks.org/set-k-th-bit-given-number/)（`i = 0, 1, 2…`）:
    ```
    k = k | (1<<(i))
    ```
