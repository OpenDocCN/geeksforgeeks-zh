...
> 原文: [https://www.geeksforgeeks.org/intermediate-coding-problems-in-python/](https://www.geeksforgeeks.org/intermediate-coding-problems-in-python/)
...
它是 `a` 的每个元素的平方。因此，它们是相同的。如果 `a` 或 `b` 都不是，我们的程序应该写为假。
