...
> 原文: [https://www.geeksforgeeks.org/python-count-the-number-of-matching-characters-in-a-pair-of-string/](https://www.geeksforgeeks.org/python-count-the-number-of-matching-characters-in-a-pair-of-string/)
...
> **注：** 为此，在 Python 中使用 `string.find(char)`。
...
2. 之后在给定的字符串上使用[集合（交集）](https://www.geeksforgeeks.org/python-set-operations-union-intersection-difference-symmetric-difference/)的概念。
