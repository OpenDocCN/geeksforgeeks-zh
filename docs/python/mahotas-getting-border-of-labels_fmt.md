...
在本文中，我们将看到如何在 mahotas 中获取标签图像中标签的边界。为此，我们将使用来自核分割基准的荧光显微图像。我们可以借助下面给出的命令获得图像
...
> **语法:** `mahotas.label.borders(label_image)`
> **参数:** 它以 `numpy.ndarray` 对象作为参数，即标签图像
> **返回:** 它返回 `numpy.ndarray` 对象，即仅带有标签边框的标签图像
