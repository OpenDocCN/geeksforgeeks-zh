...
> 原文: [https://www.geeksforgeeks.org/get-all-the-information-of-a-collections-indexes-using-pymongo/](https://www.geeksforgeeks.org/get-all-the-information-of-a-collections-indexes-using-pymongo/)
...
现在我们已经导入了模块，是时候建立与 MongoDB 服务器的连接了，该服务器大概运行在端口 `27017`（端口号）的 `localhost`（主机名）上。
...
使用函数 `index_information` 获取集合中所有索引的信息。
