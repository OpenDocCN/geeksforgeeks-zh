...
> 原文：[https://www.geeksforgeeks.org/implementing-web-scraping-using-lxml-python/](https://www.geeksforgeeks.org/implementing-web-scraping-using-lxml-python/)
...
为了完成这项任务，需要安装一些第三方软件包。使用 pip 安装 `wheel()` 文件。
...
以上代码将第一篇文章中的段落从[geeksforgeeks 主页](https://www.geeksforgeeks.org)主页中划去。下面是输出示例。对每个人来说，输出可能不一样，因为文章可能会发生变化。
