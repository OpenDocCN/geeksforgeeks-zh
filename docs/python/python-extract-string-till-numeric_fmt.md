...
> 原文: [https://www.geeksforgeeks.org/python-extract-string-till-numeric/](https://www.geeksforgeeks.org/python-extract-string-till-numeric/)

给定一个字符串，提取它的所有内容，直到第一次出现数字字符。

> **输入**: `test_str = "geeksforgeek 7 best"`
> **输出**: `geeksforgeek`
> **说明**: 7之前的字符全部提取。
>
> **输入**: `test_str = "2 geekforgeek S7 best"`
> **输出**:
> **解释**: 第一个字母提取的字符都不是数字。
...
这是执行这项任务的另一种方式。使用适当的 `正则表达式()`，可以在可能的数字之前获取内容。
