...
> 原文: [https://www.geeksforgeeks.org/copyreg-register-pickle-support-functions/](https://www.geeksforgeeks.org/copyreg-register-pickle-support-functions/)
...
`constructor` 参数可选。它是一个可调用的对象，当在酸洗时用函数返回的参数元组调用时，它可以用来重构对象。如果对象是类或构造函数不可调用，则会引发类型错误。
