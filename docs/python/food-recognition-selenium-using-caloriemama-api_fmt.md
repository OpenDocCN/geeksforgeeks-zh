...
[`Selenium`](https://www.geeksforgeeks.org/browser-automation-using-selenium/)是通过程序控制网页浏览器的强大工具。它适用于所有浏览器，适用于所有主要操作系统，其脚本是用各种语言编写的，如 `Python`、`Java`、`C#`等，我们将使用 `Python`。
