...
> 原文: [https://www.geeksforgeeks.org/draw-a-circle-using-arcade-in-python3/](https://www.geeksforgeeks.org/draw-a-circle-using-arcade-in-python3/)
...
> **语法:** `arcade.draw_circle_outline(center_x, center_y, radius, color, border_width, num_segments)`
>
> **参数:**
>
> *   `center_x` – 作为圆心的 x 位置。
...
> *   `num_segments` – 段数越高，质量越高，但渲染时间越慢。默认值为-1，这意味着 arcade 将尝试根据圆的大小计算合理的线段数量。
...
> **语法:** `arcade.draw_circle_filled(center_x, center_y, radius, color, num_segments)`
>
> **参数:**
>
> *   `center_x` – 作为圆心的 x 位置。
