...
> 原文:[https://www.geeksforgeeks.org/pafy-getting-populate-of-each-item-from-playlist/](https://www.geeksforgeeks.org/pafy-getting-populate-of-each-item-from-playlist/)
...
> **语法:**`playlist_pafy.populate_from_playlist`
>
> **论证:**不需要论证
>
> **返回:**返回字符串
