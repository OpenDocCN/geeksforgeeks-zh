...
> 原文: [https://www.geeksforgeeks.org/mahotas-rgb-to-xyz-conversion/](https://www.geeksforgeeks.org/mahotas-rgb-to-xyz-conversion/)
...
为此，我们将使用 `mahotas.colors.rgb2xyz` 方法。
