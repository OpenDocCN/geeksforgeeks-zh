...
> 原文：[https://www.geeksforgeeks.org/how-to-create-a-splash-screen-using-tkinter/](https://www.geeksforgeeks.org/how-to-create-a-splash-screen-using-tkinter/)
...
*   `after()` 方法指定一个时间段（作为参数），在该时间段之后，特定的操作发生，该操作被转换为函数，并作为参数在 `after()` 方法中传递。
...
下面是一个创建两个普通 Tkinter 窗口的程序。较小的窗口充当闪屏，但不会消失。
...
闪屏窗口：
![](img/b8878e8cec977c78b89f3fb32424cc63.png)
...
[视频演示](https://media.geeksforgeeks.org/wp-content/uploads/20201030173557/splash_screen.mp4)
