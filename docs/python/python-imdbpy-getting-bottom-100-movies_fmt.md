...
> 原文: [https://www.geeksforgeeks.org/python-imdbpy-getting-bottom-100-movies/](https://www.geeksforgeeks.org/python-imdbpy-getting-bottom-100-movies/)
...
## 语法
`IMDb_object.get_bottom100_movies()`

## 论证
不需要论证

## 返回
返回 100 个元素的列表，每个元素都是 `idbm` 电影对象
