...
> 原文：[https://www.geeksforgeeks.org/python-imdbpy-adding-info-set-to-the-searched-persons/](https://www.geeksforgeeks.org/python-imdbpy-adding-info-set-to-the-searched-persons/)
...
> **语法：**`IMDB_object.update(person_object, info=['biography'])`
>
