...
> 原文: [https://www.geeksforgeeks.org/python-arcade-collision-detection/](https://www.geeksforgeeks.org/python-arcade-collision-detection/)
...
在这个例子中，我们将使用 `check_for_collision()` 函数在两个精灵之间添加碰撞。

> **语法:** `arcade.check_for_collision(sprite1, sprite2)`
>
> **参数:**
>
> *   `sprite1`: 第一个精灵
