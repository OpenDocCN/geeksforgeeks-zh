...
> 原文: [https://www.geeksforgeeks.org/python-extract-keys-with-specific-value-type/](https://www.geeksforgeeks.org/python-extract-keys-with-specific-value-type/)
...
## 方法 2: 使用列表推导式 + `isinstance()`

与上述方法类似，单行速记使用列表推导式来解决这个问题。
