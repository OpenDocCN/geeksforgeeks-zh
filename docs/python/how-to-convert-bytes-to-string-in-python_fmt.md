...
> 原文：[https://www.geeksforgeeks.org/how-to-convert-bytes-to-string-in-python/](https://www.geeksforgeeks.org/how-to-convert-bytes-to-string-in-python/)
...
```py
# Program for converting bytes to string using codecs.decode()
