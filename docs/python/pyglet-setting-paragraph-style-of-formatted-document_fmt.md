...
> 原文: [https://www.geeksforgeeks.org/pyglet-setting-paragraph-style-of-formatted-document/](https://www.geeksforgeeks.org/pyglet-setting-paragraph-style-of-formatted-document/)
...
为了创建窗口，我们对文档对象使用 `set_paragraph_style` 方法。

**语法:** `document.set_paragraph_style(开始, 结束, 属性)`
