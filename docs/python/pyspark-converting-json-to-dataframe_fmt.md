...
> 原文：[https://www.geeksforgeeks.org/pyspark-converting-json-to-dataframe/](https://www.geeksforgeeks.org/pyspark-converting-json-to-dataframe/)
...
> **语法：** `pandas.read_json("file_name.json")`
...
> **语法：** `spark.read.json('file_name.json')`
