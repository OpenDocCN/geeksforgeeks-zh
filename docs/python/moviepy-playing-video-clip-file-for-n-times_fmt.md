...
> 原文：[https://www.geeksforgeeks.org/moviepy-playing-video-clip-file-for-n-times/](https://www.geeksforgeeks.org/moviepy-playing-video-clip-file-for-n-times/)
...
>
> **语法：**`clip.ipython_display(loop = n)`
>
