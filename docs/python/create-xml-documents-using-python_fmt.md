...
> 原文：[https://www.geeksforgeeks.org/create-xml-documents-using-python/](https://www.geeksforgeeks.org/create-xml-documents-using-python/)
...
属性值可以一次配置一个`set()`(如根节点)，或者通过将字典传递给节点工厂(如每个组和播客节点)来一次性配置。