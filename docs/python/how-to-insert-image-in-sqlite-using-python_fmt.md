...
> 原文：[https://www.geeksforgeeks.org/how-to-insert-image-in-sqlite-using-python/](https://www.geeksforgeeks.org/how-to-insert-image-in-sqlite-using-python/)
...
5.  使用 `cursor.execute()` 在 Python 中执行选择查询。
    ```py
    cursor = sqliteConnection.cursor()
