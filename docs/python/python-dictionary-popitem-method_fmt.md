...
> 原文: [https://www.geeksforgeeks.org/python-dictionary-popitem-method/](https://www.geeksforgeeks.org/python-dictionary-popitem-method/)
...
从字典中返回一个包含任意键值对的元组。该键值对已从词典中删除。
...
这里我们将使用 `popitem()` 在 Python 字典中打开最后元素。
