...
> 原文: [https://www.geeksforgeeks.org/find-the-length-of-a-set-in-python/](https://www.geeksforgeeks.org/find-the-length-of-a-set-in-python/)
...
这个想法是用 Python 中 [`len()`](https://www.geeksforgeeks.org/list-methods-in-python-set-1-in-not-in-len-min-max/) 方法。
