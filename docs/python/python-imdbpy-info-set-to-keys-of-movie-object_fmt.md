# Python IMdbpy：将信息集设置为电影对象的键

> 原文：[https://www.geeksforgeeks.org/python-imdbpy-info-set-to-keys-of-movie-object/](https://www.geeksforgeeks.org/python-imdbpy-info-set-to-keys-of-movie-object/)

在本文中，我们将看到如何将信息集转换为键。我们可以通过`get_movie_infoset`知道电影的信息集，但是即使在获得信息集后，我们也无法像字典一样使用它。
