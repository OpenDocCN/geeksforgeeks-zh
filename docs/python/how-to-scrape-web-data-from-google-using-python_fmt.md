...
> 原文：[https://www.geeksforgeeks.org/how-to-scrape-web-data-from-google-using-python/](https://www.geeksforgeeks.org/how-to-scrape-web-data-from-google-using-python/)
...
*   `beautifulsoup4`：该模块用于在 HTML 或 XML 解析器上迭代、搜索和修改解析树。要下载它，请在终端中键入以下命令。
    ```
    pip install beautifulsoup4
    ```
*   `requests`：`requests`库是 Python 的一个组成部分，用于向指定的网址发出 HTTP 请求。要下载它，请在终端中键入以下命令。
    ```
