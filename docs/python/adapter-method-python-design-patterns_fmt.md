...
> 原文:[https://www.geeksforgeeks.org/adapter-method-python-design-patterns/](https://www.geeksforgeeks.org/adapter-method-python-design-patterns/)
...
*   **开/闭原则:**我们可以在不违反开/闭原则的情况下，在代码中引入 `newadapter` 类。

## 不足之处

*   **代码的复杂性:**随着我们引入了一组新的类、对象和接口，代码的复杂性肯定会上升。
