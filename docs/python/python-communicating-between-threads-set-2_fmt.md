...
> 原文：[https://www.geeksforgeeks.org/python-communicating-between-threads-set-2/](https://www.geeksforgeeks.org/python-communicating-between-threads-set-2/)

## 先决条件
[线程间通信 Set-1](https://www.geeksforgeeks.org/python-communicating-between-threads-set-1/)
...
*   如果创建一个具有可选大小的队列，如 `Queue(N)`，它会限制在 `put()` 阻塞生成器之前可以排队的项目数量。
