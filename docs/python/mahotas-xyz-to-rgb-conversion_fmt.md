...
> 原文: [https://www.geeksforgeeks.org/mahotas-xyz-to-rgb-conversion/](https://www.geeksforgeeks.org/mahotas-xyz-to-rgb-conversion/)
...
为此，我们将使用 `mahotas.colors.xyz2rgb` 方法。

> **语法:** `mahotas.colors.xyz2rgb(img)`
> **参数:** 它以图像对象作为参数
> **返回:** 它返回图像对象
