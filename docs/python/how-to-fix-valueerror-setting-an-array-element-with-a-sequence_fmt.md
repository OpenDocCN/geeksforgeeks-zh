...
> 原文：[https://www.geeksforgeeks.org/how-to-fix-valueerror-setting-an-array-element-with-a-sequence/](https://www.geeksforgeeks.org/how-to-fix-valueerror-setting-an-array-element-with-a-sequence/)

在本文中，我们将讨论如何修复 `ValueError: 用序列设置数组元素`。
