...
> 原文：[https://www.geeksforgeeks.org/normalizing-textual-data-with-python/](https://www.geeksforgeeks.org/normalizing-textual-data-with-python/)
...
在 Python 中，`lower()`是用于字符串处理的内置方法。`lower()`方法从给定的字符串中返回小写化的字符串。它将所有大写字符转换为小写字符。如果不存在大写字符，它将返回原始字符串。
...
在像“the”、“a”、“on”、“is”、“all”这样的语言中，“停止词”是最常见的词。这些词没有重要的意义，通常与课文相去甚远。使用自然语言工具包（NLTK）可以摆脱停止词，这是一组用于符号和统计自然语言处理的库和程序。
