...
> 原文: [https://www.geeksforgeeks.org/python-convert-list-of-dictionaries-to-list-of-lists/](https://www.geeksforgeeks.org/python-convert-list-of-dictionaries-to-list-of-lists/)
...
这个任务可以使用列表理解一行解决。在本例中，我们最初使用 `keys()` 提取键，使用 `values()` 提取值。
