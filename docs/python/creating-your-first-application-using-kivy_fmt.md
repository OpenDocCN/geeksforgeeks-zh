...
> 原文: [https://www.geeksforgeeks.org/creating-your-first-application-using-kivy/](https://www.geeksforgeeks.org/creating-your-first-application-using-kivy/)

**先决条件:** [Kivy入门](https://www.geeksforgeeks.org/introduction-to-kivy/)， [Kivy的Hello World](https://www.geeksforgeeks.org/hello-world-in-kivy/)
...
要更改类别 `MDFlatButton` 的文本颜色，请使用 `text_color` 参数:
...
*   继承 **Kivymd** 的 `App` 类，它代表了我们小部件的窗口。
