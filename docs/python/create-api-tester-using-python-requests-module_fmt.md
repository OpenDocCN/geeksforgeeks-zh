...
> 原文：[https://www.geeksforgeeks.org/create-api-tester-using-python-requests-module/](https://www.geeksforgeeks.org/create-api-tester-using-python-requests-module/)
...
在本文中，我们将通过创建一个应用编程接口测试器来讨论 Python `requests` 模块的工作过程。
...
[`requests`](https://www.geeksforgeeks.org/python-requests-tutorial/) 库是 Python 的一个组成部分，用于向指定的网址发出 HTTP 请求。无论是 REST APIs 还是 Web 报废，都必须了解请求，以便进一步使用这些技术。当一个人向 URI 提出请求时，它会返回一个响应。Python 请求提供了管理请求和响应的内置功能。
