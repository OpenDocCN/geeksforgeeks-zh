...
> 原文: [https://www.geeksforgeeks.org/python-api-trends_place-in-tweepy/](https://www.geeksforgeeks.org/python-api-trends_place-in-tweepy/)
...
*   `id` : Yahoo！地点的地球标识
*   `exclude`: 将此参数设置为“哈希表”时，会从列表中排除哈希表。
