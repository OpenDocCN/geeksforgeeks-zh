# Python | Decimal conjugate()方法

> 原文: [https://www.geeksforgeeks.org/python-decimal-conjugate-method/](https://www.geeksforgeeks.org/python-decimal-conjugate-method/)

`Decimal.conjugate()`是一个返回自身的`Decimal`类方法，这个方法只是为了遵守`Decimal`规范。
