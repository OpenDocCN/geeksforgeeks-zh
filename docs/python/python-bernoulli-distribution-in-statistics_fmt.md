...
> 原文: [https://www.geeksforgeeks.org/python-bernoulli-distribution-in-statistics/](https://www.geeksforgeeks.org/python-bernoulli-distribution-in-statistics/)

## scipy.stats.bernoulli()
`scipy.stats.bernoulli()` 是一个伯努利离散随机变量。它继承自泛型方法，作为 `rv_discrete` 类的实例。它用特定于这个分布的细节来完成这些方法。
