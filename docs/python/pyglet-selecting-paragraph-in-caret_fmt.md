...
> 原文: [https://www.geeksforgeeks.org/pyglet-selecting-paragraph-in-caret/](https://www.geeksforgeeks.org/pyglet-selecting-paragraph-in-caret/)
...
> 为了创建窗口，我们对插入符号对象使用 `select_paragraph` 方法。

**语法:** `caret.select_paragraph(x, y)`
