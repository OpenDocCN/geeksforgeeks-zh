...
> 原文: [https://www.geeksforgeeks.org/python-convert-list-of-dictionaries-to-dictionary-of-lists/](https://www.geeksforgeeks.org/python-convert-list-of-dictionaries-to-dictionary-of-lists/)
...
## 方法二: 使用[字典理解](https://www.geeksforgeeks.org/python-dictionary-comprehension/)

这里我们使用字典理解将字典列表转换为列表的字典，因此我们根据新字典中的键将列表作为值传递

> 语法: `{key:[i[key] for i in list_of_dictionary] for key in list_of_dictionary[0]}`
>
> 其中
>
> *   `list_of_dictionary` 是输入
> *   `key` 是字典列表中的关键字
...
> 语法: `pandas.DataFrame(list_of_dictionary).to_dict(orient="list")`
>
> 其中:
>
> *   `list_of_dictionary` 是输入
