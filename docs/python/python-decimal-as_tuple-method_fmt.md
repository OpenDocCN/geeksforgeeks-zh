...
> 原文: [https://www.geeksforgeeks.org/python-decimal-as_tuple-method/](https://www.geeksforgeeks.org/python-decimal-as_tuple-method/)

`Decimal.as_tuple()` 是一个 `Decimal` 类方法，返回 `Decimal` 值的命名元组表示。
