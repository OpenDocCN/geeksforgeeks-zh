...
> 原文：[https://www.geeksforgeeks.org/detect-an-unknown-language-using-python/](https://www.geeksforgeeks.org/detect-an-unknown-language-using-python/)
...
这个模块是谷歌语言检测库的一个端口，支持 55 种语言。这个模块不是 Python 的标准实用程序模块。所以，需要从外部安装。要安装此软件，请在终端中键入以下命令。
