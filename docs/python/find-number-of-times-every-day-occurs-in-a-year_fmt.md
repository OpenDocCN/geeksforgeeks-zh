...
> 原文：[https://www.geeksforgeeks.org/find-number-of-times-every-day-occurs-in-a-year/](https://www.geeksforgeeks.org/find-number-of-times-every-day-occurs-in-a-year/)

给定一年时间。你的任务是找出一年中每天出现的次数，即该年中周一、周二、周三、周四、周五、周六、周日各出现了多少次。
...
**方法：** 创建一个列表，大小为 7，初始值为 52，表示最小出现次数为 52。找到第一天的索引。计算发生的天数为 53 天。
下面是实现。
