...
> 原文: [https://www.geeksforgeeks.org/change-image-resolution-using-pillow-in-python/](https://www.geeksforgeeks.org/change-image-resolution-using-pillow-in-python/)

**先决条件:** [Python Pillow](https://www.geeksforgeeks.org/python-pillow-a-fork-of-pil/)
...
1.  从 Pillow 导入 `Image` 模块。
2.  使用 `Image.open()` 方法，通过指定图像路径打开图像。
