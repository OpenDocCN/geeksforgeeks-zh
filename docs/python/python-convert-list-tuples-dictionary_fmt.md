...
> 原文: [https://www.geeksforgeeks.org/python-convert-list-tuples-dictionary/](https://www.geeksforgeeks.org/python-convert-list-tuples-dictionary/)

有时，您可能需要将一个[元组](https://www.geeksforgeeks.org/tuples-in-python/)转换为[字典](https://www.geeksforgeeks.org/tag/python-dict/)对象，以使其更具可读性。在本文中，我们将尝试学习如何将元组列表转换为字典。在这里，我们将找到两种方法。
