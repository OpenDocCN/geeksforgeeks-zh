...
> 原文：[https://www.geeksforgeeks.org/different-ways-to-clear-a-list-in-python/](https://www.geeksforgeeks.org/different-ways-to-clear-a-list-in-python/)
...
## Method #3 : Using `*= 0`
This is a lesser known method, but this method removes all elements of the list and makes it empty.
...
## Method #4 : Using `del`
`del` can be used to clear the list elements in a range, if we don’t give a range, all the elements are deleted.
