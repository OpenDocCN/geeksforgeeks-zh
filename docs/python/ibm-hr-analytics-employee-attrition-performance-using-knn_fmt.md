# IBM 人力资源分析员工流失与使用 KNN 的绩效

> 原文：[https://www.geeksforgeeks.org/ibm-hr-analytics-employee-attrition-performance-using-knn/](https://www.geeksforgeeks.org/ibm-hr-analytics-employee-attrition-performance-using-knn/)
...
数据集中有 4 个不相关的列，分别是：`EmployeeCount`、`EmployeeNumber`、`Over18` 和 `StandardHours`。所以，为了更准确，我们必须去掉这些。
