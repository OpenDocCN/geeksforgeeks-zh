...
> 原文：[https://www.geeksforgeeks.org/fractal-using-spirograph-python/](https://www.geeksforgeeks.org/fractal-using-spirograph-python/)
...
您可以访问[优势-方程博客](http://benice-equation.blogspot.in/2012/01/fractal-spirograph.html)了解更多带有参数方程的分形设计。其中一些在下面给出。
...
关于数学部分，你可以参考[维基百科](https://en.wikipedia.org/wiki/Spirograph#Mathematical_basis)，尽管我会在这里简短地解释一点数学。如果我们对数学背后的东西感兴趣，那么你可以查看参考链接。到目前为止，这些不同的曲线可以用一个参数方程来绘制，通过改变方程的一些值，我们可以得到不同的分形。这是参数方程：
...
本文由 [**Subhajit Saha**](https://www.linkedin.com/in/subhajit-saha-06aa29131/) 供稿。如果你喜欢 GeeksforGeeks 并想投稿，你也可以使用`contribute.geeksforgeeks.org`写一篇文章或者把你的文章邮寄到`contribute@geeksforgeeks.org`。看到你的文章出现在极客博客主页上，帮助其他极客。
