...
> 原文：[`https://www.geeksforgeeks.org/g-fact-21-increment-and-decrement-operators-in-python/`](https://www.geeksforgeeks.org/g-fact-21-increment-and-decrement-operators-in-python/)
...
本文由 Basavaraja 供稿。如果你喜欢极客博客并想投稿，你也可以用 [`contribute.geeksforgeeks.org`](http://contribute.geeksforgeeks.org) 写一篇文章或者把你的文章邮寄到 [`review-team@geeksforgeeks.org`](mailto:review-team@geeksforgeeks.org)。看到你的文章出现在极客博客主页上，帮助其他极客。
