...
> 原文：[https://www.geeksforgeeks.org/python-count-unique-sublists-within-list/](https://www.geeksforgeeks.org/python-count-unique-sublists-within-list/)
...
```py
{('geeks', 'for'): 1, ('for', 'Geeks', 'geek'): 1, ('Geek', 'for', 'geeks'): 2}
```
