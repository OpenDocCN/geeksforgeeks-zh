...
> 原文: [https://www.geeksforgeeks.org/python-check-if-two-strings-are-rotationally-equivalent/](https://www.geeksforgeeks.org/python-check-if-two-strings-are-rotationally-equivalent/)

有时，在使用 Python 字符串时，我们可能会遇到这样的问题：我们需要检查一个字符串是否可以在向左或向右旋转时从其他字符串中派生出来。这类问题可以应用于许多领域，如 Web 开发和竞争性编程。让我们讨论执行这项任务的某些方法。

## 输入
> `test_str1 = 'GFG'`，`test_str2 = 'FGG'`
> 输出: 真

> `test_str1 = '极客'`，`test_str2 = 'ksege'`
> 输出: 假
