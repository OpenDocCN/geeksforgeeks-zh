...
> 原文: [https://www.geeksforgeeks.org/implementing-lru-cache-decorator-in-python/](https://www.geeksforgeeks.org/implementing-lru-cache-decorator-in-python/)
...
> **参考以下文章获取更多主题信息:**
> *   [Python 和 LRU 缓存](https://www.geeksforgeeks.org/python-lru-cache/)
