...
> 原文: [https://www.geeksforgeeks.org/create-a-cycle-graph-using-networkx-in-python/](https://www.geeksforgeeks.org/create-a-cycle-graph-using-networkx-in-python/)
...
> **返回:**
>
> 此方法返回 `C_n`（有 `n` 个节点的循环图）。因此，它用于初始化图形对象 `G`。
