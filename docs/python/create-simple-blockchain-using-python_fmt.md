...
> 原文：[https://www.geeksforgeeks.org/create-simple-blockchain-using-python/](https://www.geeksforgeeks.org/create-simple-blockchain-using-python/)

一个区块链是一个带有时间戳的分散的固定记录系列，包含任何大小的数据，由分散在全球各地的大型计算机网络控制，不归单一组织所有。每个块都是安全的，并使用哈希技术相互连接，防止未经授权的人对其进行篡改。
