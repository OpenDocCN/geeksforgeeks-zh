...
> 原文: [https://www.geeksforgeeks.org/python-convert-list-to-delimiter-separated-string/](https://www.geeksforgeeks.org/python-convert-list-to-delimiter-separated-string/)
