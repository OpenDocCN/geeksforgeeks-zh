...
> 原文：[https://www.geeksforgeeks.org/how-to-delete-columns-in-pyspark-dataframe/](https://www.geeksforgeeks.org/how-to-delete-columns-in-pyspark-dataframe/)
...
这里我们将从数据框中删除 `student ID`，为此我们将使用 `drop()`。
