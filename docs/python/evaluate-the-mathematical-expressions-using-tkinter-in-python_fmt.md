...
> 原文：[https://www.geeksforgeeks.org/evaluate-the-mathematical-expressions-using-tkinter-in-python/](https://www.geeksforgeeks.org/evaluate-the-mathematical-expressions-using-tkinter-in-python/)

本文着重于使用 Python 中的 `Tkinter` 和 `math` 包来评估数学表达式。
