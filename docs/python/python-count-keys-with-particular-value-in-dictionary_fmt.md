...
> 原文:[https://www . geeksforgeks . org/python-count-key-with-special-value-in-dictionary/](https://www.geeksforgeeks.org/python-count-keys-with-particular-value-in-dictionary/)
