...
> 原文: [https://www.geeksforgeeks.org/mahotas-rgb-to-lab-conversion/](https://www.geeksforgeeks.org/mahotas-rgb-to-lab-conversion/)
...
为此，我们将使用 `mahotas.colors.rgb2lab` 方法。

> 语法: `mahotas.colors.rgb2lab(img)`
> 参数: 它以图像对象作为参数
> 返回: 它返回图像对象
