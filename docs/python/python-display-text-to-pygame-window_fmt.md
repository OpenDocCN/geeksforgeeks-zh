...
> 原文：[https://www.geeksforgeeks.org/python-display-text-to-pygame-window/](https://www.geeksforgeeks.org/python-display-text-to-pygame-window/)
...
5.  当文本从屏幕左侧沿对角线滚动时
    ...
    ![](img/f28dc2b438185ffb882e446ff13e8883.png)
