...
> 原文: [https://www.geeksforgeeks.org/python-extract-records-if-kth-elements-not-in-list/](https://www.geeksforgeeks.org/python-extract-records-if-kth-elements-not-in-list/)
...
这是完成这项任务的一种方式。在这种情况下，我们使用 `set` 来缩短参数列表，然后有效地检查是否有来自 `arg_list` 的任何元素的 Kth 索引。并相应追加。
