...
> 原文: [https://www.geeksforgeeks.org/python-key-with-maximum-unique-values/](https://www.geeksforgeeks.org/python-key-with-maximum-unique-values/)

给定带有值列表的字典，提取其值具有最多唯一值的键。

> **输入**: `test_dict = {"Gfg":[5,7,9,4,0],"is":[6,7,4,3,3],"Best":[9,9,6,5,5]}`
> **输出**: `"Gfg"`
> **解释**: `"Gfg"`具有最大唯一元素即 5。
>
> **输入**: `test_dict = {"Gfg":[5,7,7,7,7],"is":[6,7,7,7],"Best":[9,9,6,5,5]}`
> **输出**: `"Best"`
