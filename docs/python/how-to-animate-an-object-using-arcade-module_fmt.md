...
> 原文：[https://www.geeksforgeeks.org/how-to-animate-an-object-using-arcade-module/](https://www.geeksforgeeks.org/how-to-animate-an-object-using-arcade-module/)
...
### 步骤 2)
这里我们将指定一些参数，我们稍后将在程序中使用这些参数来声明屏幕的宽度、高度和标题。
...
### 步骤 3)
定义绘制方块街机的函数，`draw_rectangle_filled()`根据增量向量修改矩形位置。
...
### 步骤 4
现在，定义函数特定的变量。另外，我们需要给它们初始值。那么这些值将在函数调用之间保持不变。
...
### 步骤 5)
现在，最后一步是定义主功能。在这种情况下，您需要定义背景颜色。
