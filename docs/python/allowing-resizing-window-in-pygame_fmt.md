...
> 原文: [https://www.geeksforgeeks.org/allowing-resizing-window-in-pygame/](https://www.geeksforgeeks.org/allowing-resizing-window-in-pygame/)
...
1.  导入 `pygame`。
2.  使用 `pygame.display.set_mode()` 方法形成屏幕，并允许使用 `pygame.RESIZABLE` 调整大小。
3.  设置标题并添加内容。
4.  运行游戏。
5.  退出 `pygame`。
