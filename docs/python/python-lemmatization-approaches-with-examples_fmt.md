...
> 原文: [https://www.geeksforgeeks.org/python-lemmatization-approaches-with-examples/](https://www.geeksforgeeks.org/python-lemmatization-approaches-with-examples/)
...
**下载 spaCy 包:**
(a) 以管理员身份打开 anaconda prompt 或终端，并运行命令:
`(b) 现在，正常打开 anaconda prompt 或终端并运行命令:`
