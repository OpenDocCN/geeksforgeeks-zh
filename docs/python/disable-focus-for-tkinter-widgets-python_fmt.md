...
> 原文: [https://www.geeksforgeeks.org/disable-focus-for-tkinter-widgets-python/](https://www.geeksforgeeks.org/disable-focus-for-tkinter-widgets-python/)

**先决条件:** [Python-Tkinter](https://www.geeksforgeeks.org/create-first-gui-application-using-python-tkinter/)
...
> **#创建按钮部件**
>
> `btn = tk.Button(root, text="Button")` #初始化小部件。
>
