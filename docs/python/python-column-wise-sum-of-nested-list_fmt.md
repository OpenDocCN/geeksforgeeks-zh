...
> 原文：[https://www.geeksforgeeks.org/python-column-wise-sum-of-nested-list/](https://www.geeksforgeeks.org/python-column-wise-sum-of-nested-list/)
...
另一种方法是使用 `map()`。我们将 `sum` 函数应用于一列中的每个元素，并相应地求出每列的和。
