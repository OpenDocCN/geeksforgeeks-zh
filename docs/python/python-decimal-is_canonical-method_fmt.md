...
> 原文: [https://www.geeksforgeeks.org/python-decimal-is_canonical-method/](https://www.geeksforgeeks.org/python-decimal-is_canonical-method/)

`Decimal.is_canonical()` 是一个 `Decimal` 类方法，用于检查 `Decimal` 值是否规范。
