...
> 原文: [https://www.geeksforgeeks.org/action-chains-in-selenium-python/](https://www.geeksforgeeks.org/action-chains-in-selenium-python/)
...
要创建 `ActionChains` 对象，请从文档中导入 `ActionChains` 类，并将驱动程序作为关键参数传递。之后，可以使用这个对象来执行动作链的所有操作。
...
第一个驱动器打开 https://www.geeksforgeeks.org/，
...
| [上下文_点击](https://www.geeksforgeeks.org/context_click-action-chains-in-selenium-python/?ref=rp) | 对元素执行上下文单击(右键单击)。 |
...
| [移动_到_元素_带_偏移](https://www.geeksforgeeks.org/move_to_element_with_offset-method-action-chains-in-selenium-python/?ref=rp) | 将鼠标移动指定元素的偏移量，偏移量相对于元素的左上角。 |
...
| [复位_动作](https://www.geeksforgeeks.org/reset_actions-method-action-chains-in-selenium-python/?ref=rp) | 清除已经存储在本地和远程端的操作 |
| [发送_键](https://www.geeksforgeeks.org/send_keys-method-action-chains-in-selenium-python/?ref=rp) | 向当前聚焦元素发送键。 |