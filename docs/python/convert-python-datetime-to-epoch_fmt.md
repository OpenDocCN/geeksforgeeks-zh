...
> 原文：[https://www.geeksforgeeks.org/convert-python-datetime-to-epoch/](https://www.geeksforgeeks.org/convert-python-datetime-to-epoch/)
...
> **语法：** `datetime.datetime(timestamp).timestamp()`
>
> **参数：**
>
> *   `datetime` 是模块
...
**示例：** 使用 `timestamp()` 将 DateTime 转换为 epoch 的 Python 代码
