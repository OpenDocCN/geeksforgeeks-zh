...
> 原文：[https://www.geeksforgeeks.org/how-to-make-a-todo-list-cli-application-using-python/](https://www.geeksforgeeks.org/how-to-make-a-todo-list-cli-application-using-python/)
...
*   如果你是 Windows 用户，那么创建另一个文件 `todo.bat` 文件。这是批处理文件。它用于运行 python 脚本
...
要在 Windows 上创建符号链接，您需要以管理员权限运行 Windows 命令提示符或 Windows Powershell。为此，右键单击命令提示符或 Powershell 的图标，然后选择“以管理员身份运行”选项。
