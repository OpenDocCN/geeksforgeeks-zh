...
> 原文: [https://www.geeksforgeeks.org/python-convert-strings-to-uppercase-in-dictionary-value-lists/](https://www.geeksforgeeks.org/python-convert-strings-to-uppercase-in-dictionary-value-lists/)
...
## 方法一: 使用字典理解 + `upper()` + 列表理解

上述功能的组合可以用来解决这个问题。在这种情况下，我们使用 `upper()` 执行大写，使用列表理解来遍历所有字符串，使用字典理解来用大写值重新构建字典。
