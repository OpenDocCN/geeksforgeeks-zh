...
> 原文：[https://www.geeksforgeeks.org/how-to-generate-a-random-number-between-0-and-1-in-python/](https://www.geeksforgeeks.org/how-to-generate-a-random-number-between-0-and-1-in-python/)

随机性的使用是现代算法配置和评估的重要部分。在这里，我们将看到生成 0 和 1 之间的随机数的各种方法。
...
在这里，我们将看到生成随机数的自定义方法。[`randint()`](https://www.geeksforgeeks.org/python-randint-function/) 是返回两个指定值之间的随机整数的方法。
