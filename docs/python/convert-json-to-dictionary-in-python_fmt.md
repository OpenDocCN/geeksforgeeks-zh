...
> 原文：[https://www.geeksforgeeks.org/convert-json-to-dictionary-in-python/](https://www.geeksforgeeks.org/convert-json-to-dictionary-in-python/)
...
读取嵌套数据。在上面的 JSON 文件中，第一个关键字 `people1` 中有一个嵌套字典。下面是读取嵌套数据的实现。
