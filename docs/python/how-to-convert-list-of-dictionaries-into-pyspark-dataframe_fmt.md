...
> 原文: [https://www.geeksforgeeks.org/how-to-convert-list-of-dictionaries-into-pyspark-dataframe/](https://www.geeksforgeeks.org/how-to-convert-list-of-dictionaries-into-pyspark-dataframe/)

在本文中，我们将从字典列表中讨论 Pyspark 数据框的创建。

我们将在 `createDataFrame()` 方法的帮助下，使用字典列表在 PySpark 中创建一个数据帧。`data` 属性采用字典列表，`columns` 属性采用名称列表。
