...
> 原文: [https://www.geeksforgeeks.org/python-database-management-in-postgresql/](https://www.geeksforgeeks.org/python-database-management-in-postgresql/)
...
`cursor` 对象用于执行 `sql` 查询。我们可以使用连接对象 (`conn`) 创建一个光标对象。
