...
> 原文: [https://www.geeksforgeeks.org/filtering-a-pyspark-dataframe-using-isin-by-exclusion/](https://www.geeksforgeeks.org/filtering-a-pyspark-dataframe-using-isin-by-exclusion/)
...
`where():` 本条款用于检查条件并给出结果

> **语法:** `dataframe.where(条件)`

### 示例 1: 获取带有 where() 子句的特定学院
