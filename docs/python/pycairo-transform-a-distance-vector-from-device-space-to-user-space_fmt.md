...
> 原文: [https://www.geeksforgeeks.org/pycairo-transform-a-distance-vector-from-device-space-to-user-space/](https://www.geeksforgeeks.org/pycairo-transform-a-distance-vector-from-device-space-to-user-space/)
...
为此，我们将对上下文对象使用 `device_to_user_distance()` 方法。
