...
> 原文: [https://www.geeksforgeeks.org/python-incremental-and-cyclic-repetition-of-list-elements/](https://www.geeksforgeeks.org/python-incremental-and-cyclic-repetition-of-list-elements/)

有时，在使用 Python 列表时，我们可能会遇到一个问题，即我们需要将元素重复 K 次。但是我们可以在这方面有变化，必须以循环和增量的方式重复元素。让我们讨论执行这项任务的某些方法。

## 方法1: 使用 loop + `enumerate()`
