...
> 原文：[https://www.geeksforgeeks.org/python-find-whether-all-tuple-have-same-length/](https://www.geeksforgeeks.org/python-find-whether-all-tuple-have-same-length/)
