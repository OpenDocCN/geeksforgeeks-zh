...
> 原文: [https://www.geeksforgeeks.org/insert-python-dictionary-in-postgresql-using-psycopg2/](https://www.geeksforgeeks.org/insert-python-dictionary-in-postgresql-using-psycopg2/)
...
创建空表后，使用 [`values()`](https://www.geeksforgeeks.org/python-dictionary-values/) 方法从字典中获取表中的值。
