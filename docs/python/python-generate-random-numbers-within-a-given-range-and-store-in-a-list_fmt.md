...
> 原文: [https://www.geeksforgeeks.org/python-generate-random-numbers-within-a-given-range-and-store-in-a-list/](https://www.geeksforgeeks.org/python-generate-random-numbers-within-a-given-range-and-store-in-a-list/)
...
Python 提供了一个 `random` 模块来生成随机数。为了生成随机数，我们使用了 `random` 函数和 `randint` 函数。
...
使用 `numpy` [`random.randint()`](https://www.geeksforgeeks.org/python-randint-function/) 方法生成 `random` 数。
