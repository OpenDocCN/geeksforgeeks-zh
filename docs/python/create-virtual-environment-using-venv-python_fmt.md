...
> 原文: [https://www.geeksforgeeks.org/create-virtual-environment-using-venv-python/](https://www.geeksforgeeks.org/create-virtual-environment-using-venv-python/)
...
输出:
> c:\user\geeksforgeeks\AppData\Local\Programs\Python\Python37\Python.exe
> c:\user\geeksforgeeks\AppData\Local\Programs\Python\Python37\Scripts\pip.exe
