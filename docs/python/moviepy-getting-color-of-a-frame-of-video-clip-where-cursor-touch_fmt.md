...
> 原文：[https://www.geeksforgeeks.org/moviepy-getting-color-of-a-frame-of-video-clip-where-cursor-touch/](https://www.geeksforgeeks.org/moviepy-getting-color-of-a-frame-of-video-clip-where-cursor-touch/)
...
为此，我们将对 `VideoFileClip` 对象使用 `show` 方法。

**语法：** `clip.show(t, interactive=True)`

**参数：** 需要时间 `t`，`interactive=True` 作为参数。
