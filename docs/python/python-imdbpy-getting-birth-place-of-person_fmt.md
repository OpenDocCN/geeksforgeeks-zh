...
> 原文: [https://www.geeksforgeeks.org/python-imdbpy-getting-birth-place-of-person/](https://www.geeksforgeeks.org/python-imdbpy-getting-birth-place-of-person/)
...
> 1. 使用 `get_person` 方法
> 2. 借助 `id` 获取人物对象。
> 3. 使用 `result['birth info']['birth place']` 作为关键字获得出生地点
> 4. 打印结果
