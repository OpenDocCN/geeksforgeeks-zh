...
对于这个问题我们已经有了解决方案，请参考[根据输入字符串](https://www.geeksforgeeks.org/generate-two-output-strings-depending-upon-occurrence-character-input-string/)链接中出现的字符生成两个输出字符串。我们可以使用 [`Counter()`](https://www.geeksforgeeks.org/counters-in-python-set-1/) 方法在 Python 中快速解决这个问题。方法很简单：
