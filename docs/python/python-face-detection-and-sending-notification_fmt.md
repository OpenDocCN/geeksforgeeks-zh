...
> 原文: [https://www.geeksforgeeks.org/python-face-detection-and-sending-notification/](https://www.geeksforgeeks.org/python-face-detection-and-sending-notification/)
...
我们正在使用 [Harcascade 分类器正面文件](https://github.com/opencv/opencv/blob/master/data/haarcascades/haarcascade_frontalface_default.xml) 下载该文件并指定路径。
