...
> 原文: [https://www.geeksforgeeks.org/python-imdbpy-getting-company-id-from-searched-companies/](https://www.geeksforgeeks.org/python-imdbpy-getting-company-id-from-searched-companies/)
...
> **语法:** `company[0].companyID`
>
> 这里的 `company` 是 `search_movie` 返回的公司列表，`company[0]` 引用列表中的第一个元素。
>
> **论证:** 不需要论证。
>
> **返回:** 返回公司标识字符串
