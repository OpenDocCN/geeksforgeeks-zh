...
> 原文: [https://www.geeksforgeeks.org/python-fast-walsh-hadamard-transform/](https://www.geeksforgeeks.org/python-fast-walsh-hadamard-transform/)
...
它可以执行**沃尔什哈达玛变换（WHT）**。该方法使用哈达玛序列排序。序列自动向右填充零，因为基数-2 FWHT 要求样本点数为 2 的幂。
