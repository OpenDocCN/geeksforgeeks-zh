...
> 原文: [https://www.geeksforgeeks.org/free-python-course-for-beginners/](https://www.geeksforgeeks.org/free-python-course-for-beginners/)
...
但是……心满意足地，为了让所有初学者的事情变得更容易——geeksforgeeks 正在提供一个惊人的机会，一个面向初学者的免费 Python 课程！

## 课程详情

这实际上是一门基于研讨会的课程，它的设计方式需要各种理论和活动，让您的孩子了解 Python 的基础。这些理论和活动将以一种最有趣和最令人兴奋的方式通过一系列研讨会进行教授。

课程已于 2021 年 1 月 05 日开始，您可以从这里直接[报名参加课程。](https://practice.geeksforgeeks.org/courses/start-with-python-kids)
...
### 第四天: [代码是选择性的，如果……](https://practice.geeksforgeeks.org/tracks/pw-4/?batchId=321)
...
### 第六天: [数学中的循环](https://practice.geeksforgeeks.org/tracks/pw-6/?batchId=321)
...
### 第八天: [有用模块](https://practice.geeksforgeeks.org/tracks/pw-8/?batchId=321)
...
*   [时间模块](https://youtu.be/0-uSqGpEH7Q?t=320)
    ...
    *   [https://youtu.be/0-uSqGpEH7Q?t=649](https://youtu.be/0-uSqGpEH7Q?t=649)
...
*   [字符串功能](https://youtu.be/f6X_SqoKPxE?t=569)
    *   [`len()`](https://youtu.be/f6X_SqoKPxE?t=575)
...
*   [搜索子串](https://youtu.be/f6X_SqoKPxE?t=2280)
    *   [`endswith()`](https://youtu.be/f6X_SqoKPxE?t=2290)
    *   [`startswith()`](https://youtu.be/f6X_SqoKPxE?t=2412)
    *   [`find()`](https://youtu.be/f6X_SqoKPxE?t=2479)
    *   [`rfind()`](https://youtu.be/f6X_SqoKPxE?t=2544)
    *   [`count()`](https://youtu.be/f6X_SqoKPxE?t=2635)
*   [转换字符串](https://youtu.be/f6X_SqoKPxE?t=2675)
    *   [`upper()`](https://youtu.be/f6X_SqoKPxE?t=2706)
    *   [`lower()`](https://youtu.be/f6X_SqoKPxE?t=2821)
    *   [`swapcase()`](https://youtu.be/f6X_SqoKPxE?t=2915)
    *   [`title()`](https://youtu.be/f6X_SqoKPxE?t=2874)
    *   [`capitalize()`](https://youtu.be/f6X_SqoKPxE?t=2854)
    *   [`replace()`](https://youtu.be/f6X_SqoKPxE?t=2946)
*   [活动: 回文串](https://youtu.be/f6X_SqoKPxE?t=3022)

### 第十天: [列表中接下来是什么](https://practice.geeksforgeeks.org/tracks/pw-10/?batchId=321)
...
不用说，Python 目前正主导着科技世界，并且在即将到来的时代也拥有统治一切的潜力。那么，你还在等什么？加入我们这个激动人心的 5 周旅程，以最有趣的方式开始使用 Python！