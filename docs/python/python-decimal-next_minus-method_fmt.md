# Python | Decimal next_minus()方法

> 原文: [https://www.geeksforgeeks.org/python-decimal-next_minus-method/](https://www.geeksforgeeks.org/python-decimal-next_minus-method/)

`Decimal.next_minus()` 是一个 `Decimal` 类方法，返回小于 `Decimal` 值的最大可表示数。
