...
> 原文：[https://www.geeksforgeeks.org/get-all-text-of-the-page-using-selenium-in-python/](https://www.geeksforgeeks.org/get-all-text-of-the-page-using-selenium-in-python/)
...
使用 `pip` 安装 `selenium` 包。只需在命令提示符下写下以下命令。
...
> `webdriver.Chrome(executable_path="D:\pycharm_project\SeleniumLearning\Drivers\chromedriver_server.exe")`
