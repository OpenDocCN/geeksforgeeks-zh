...
> 原文：[https://www.geeksforgeeks.org/g-fact-42-changing-class-members-python/](https://www.geeksforgeeks.org/g-fact-42-changing-class-members-python/)

在[之前的事实](https://www.geeksforgeeks.org/g-fact-34-class-or-static-variables-in-python/)中，我们已经看到 Python 没有 `static` 关键字。在类声明中被赋值的所有变量都是类变量。
