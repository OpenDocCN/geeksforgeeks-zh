...
> 原文: [https://www.geeksforgeeks.org/labeled-image-function-in-python-mahotas/](https://www.geeksforgeeks.org/labeled-image-function-in-python-mahotas/)
...
语法: `mahotas.label(regions)`
参数: 它以 `numpy.ndarray` 对象作为参数
返回: 它返回 `numpy.ndarray` 对象和整数值
