...
> 原文: [https://www.geeksforgeeks.org/generate-waffle-chart-using-pywaffle-in-python/](https://www.geeksforgeeks.org/generate-waffle-chart-using-pywaffle-in-python/)
...
要在 Python 中生成华夫饼图，需要的模块是 `pandas` 和 `pywaffle`。
要安装这些软件包，请运行以下命令:
