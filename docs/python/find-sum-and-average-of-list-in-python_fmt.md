...
> 原文：[https://www.geeksforgeeks.org/find-sum-and-average-of-list-in-python/](https://www.geeksforgeeks.org/find-sum-and-average-of-list-in-python/)
...
在这个方法中，我们将遍历列表，并将每个元素添加到一个变量 `count` 中，该计数存储第 i <sup>个</sup>元素的和，然后将该和除以变量的总数，得到平均值。
