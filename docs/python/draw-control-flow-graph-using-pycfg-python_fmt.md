...
> 原文: [https://www.geeksforgeeks.org/draw-control-flow-graph-using-pycfg-python/](https://www.geeksforgeeks.org/draw-control-flow-graph-using-pycfg-python/)
...
借助导入库和 [tkinter](https://www.geeksforgeeks.org/python-gui-tkinter/) ，我们可以比单独使用 `pycfg.py` 文件做得更好。
...
一旦完成，使用相同的`whiletest`进行测试。我们可以在`whiletest.py`上运行下面的 python 程序。
...
**参考:** [https://pypi.org/project/pycfg/](https://pypi.org/project/pycfg/)