...
Python 更容易编码和学习。Python 程序可以写在任何纯文本编辑器上，如`记事本++`或任何类似的东西。人们也可以使用一个`在线 ide`来编写 Python 代码或者甚至可以在他们的系统上安装一个，使编写这些代码更加可行，因为 IDE 提供了很多功能，比如直观的代码编辑器、调试器、编译器等。
...
在开始安装过程之前，您需要下载它。为此，视窗系统的所有 Python 版本都可以在`python.org`上获得。
...
**Output:**
![Hello-World-Python-Windows](img/1f385d7017c0da150420ffc84bb361c4.png)