...
> 原文: [https://www.geeksforgeeks.org/python-elements-frequency-in-tuple/](https://www.geeksforgeeks.org/python-elements-frequency-in-tuple/)
...
在这种情况下，我们使用 `defaultdict` 执行获取所有元素并分配频率的任务，`defaultdict` 用键映射每个元素，然后频率可以增加。
