# Python IMDbPY – 从剧集中获取剧集名称

> 原文：[https://www.geeksforgeeks.org/python-imdbpy-get-series-name-from-the-episode/](https://www.geeksforgeeks.org/python-imdbpy-get-series-name-from-the-episode/)
...
> 6. 使用 `'episode of'` 作为剧集的关键字来获取父剧集。
