...
> 原文：[https://www.geeksforgeeks.org/how-to-get-the-size-of-pygame-window/](https://www.geeksforgeeks.org/how-to-get-the-size-of-pygame-window/)
...
1.  导入 `pygame`。
2.  初始化 `pygame`。
3.  使用 `pygame.display.set_mode()` 方法形成屏幕。
