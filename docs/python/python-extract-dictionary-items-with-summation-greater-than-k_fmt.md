...
> 原文: [https://www.geeksforgeeks.org/python-extract-dictionary-items-with-summation-greater-than-k/](https://www.geeksforgeeks.org/python-extract-dictionary-items-with-summation-greater-than-k/)

给定带有值列表的字典，提取所有那些值加起来超过 `k` 的项目。

> **输入**：`{"Gfg":[6,3,4],"is":[8,10,12],"Best":[10,16,14],"for":[7,4,3],"geeks":[1,2,3,4]}`，`K = 10`
> **输出**：`{"Gfg":[6,3,4],"is":[8,10,12],"Best":[10,16,14]}`
>
> **输入**：`{"Gfg":[6,3,4],"is":[8,10,12],"Best":[10,16,14],"for":[7,4,3],"geeks":[1,2,3,4]}`，`K = 50`
> **输出**：`{}`
> **解释**：没有大于 50 的元素。
