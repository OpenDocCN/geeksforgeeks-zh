...
> 原文: [https://www.geeksforgeeks.org/pafy-getting-category-id-for-each-item-of-playlist/](https://www.geeksforgeeks.org/pafy-getting-category-id-for-each-item-of-playlist/)
...
6.  对于元数据，使用 `"category_id"` 键，这将返回给定项目的类别标识。
