...
> 原文: [https://www.geeksforgeeks.org/python-convert-tuple-to-tuple-pair/](https://www.geeksforgeeks.org/python-convert-tuple-to-tuple-pair/)
...
以上功能的组合可以用来解决这个问题。在本例中，我们使用 `product()` 进行配对，使用 `next()` 进行与下一个元素配对的选择。
