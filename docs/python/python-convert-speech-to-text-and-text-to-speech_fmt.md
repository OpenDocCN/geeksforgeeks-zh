...
> 原文:[https://www.geeksforgeeks.org/python-convert-speech-to-text-and-text-to-speech/](https://www.geeksforgeeks.org/python-convert-speech-to-text-and-text-to-speech/)
...
初始化后，我们将使用`say()`功能使程序朗读文本。这个方法也可以带 2 个参数。
```py
