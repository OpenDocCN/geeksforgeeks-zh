...
> 原文: [https://www.geeksforgeeks.org/python-incremental-k-sized-row-matrix-initialization/](https://www.geeksforgeeks.org/python-incremental-k-sized-row-matrix-initialization/)
