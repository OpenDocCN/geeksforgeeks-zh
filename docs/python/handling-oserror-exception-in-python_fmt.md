...
> 原文：[https://www.geeksforgeeks.org/handling-oserror-exception-in-python/](https://www.geeksforgeeks.org/handling-oserror-exception-in-python/)
...
我们可以使用 `try...except` 语句来处理 `OSError` 异常。

## 使用 try...except 处理 OSError
