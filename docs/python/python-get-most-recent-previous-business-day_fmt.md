...
> 原文: [https://www.geeksforgeeks.org/python-get-most-recent-previous-business-day/](https://www.geeksforgeeks.org/python-get-most-recent-previous-business-day/)
...
## 方法三: 使用 `pd.tseries.offsets.BusinessDay(n)`
