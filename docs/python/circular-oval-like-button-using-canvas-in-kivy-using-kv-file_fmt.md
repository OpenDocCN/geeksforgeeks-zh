# 圆形(类似椭圆形)按钮使用画布中的kivy(使用.kv档)

> 原文: [https://www.geeksforgeeks.org/circular-oval-like-button-using-canvas-in-kivy-using-kv-file/](https://www.geeksforgeeks.org/circular-oval-like-button-using-canvas-in-kivy-using-kv-file/)
...
2) 必须是四个值的列表:(下、右、上、左)。
3) `border` 为列表属性，默认为 `(16，16，16，16)`。

**按钮行为:**
1) `ButtonBehavior` 混合类提供按钮行为。
