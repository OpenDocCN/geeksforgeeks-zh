...
> 原文：[https://www.geeksforgeks.org/__getitem__-and-__setitem__-in-python/](https://www.geeksforgeeks.org/__getitem__-and-__setitem__-in-python/)
...
**注意：** 更多信息请参考[Python 中的 Dunder 或者魔法方法](https://www.geeksforgeeks.org/dunder-magic-methods-python/)。
