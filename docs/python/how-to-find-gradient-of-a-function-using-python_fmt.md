...
> 原文：[https://www.geeksforgeeks.org/how-to-find-gradient-of-a-function-using-python/](https://www.geeksforgeeks.org/how-to-find-gradient-of-a-function-using-python/)
...
*   **对于单变量函数：** 对于单变量函数，我们可以直接使用 `lambda` 进行定义，如下所示：

```py
g=lambda x:(x**4)+x+1
```

*   **对于多变量函数：** 我们将使用 `def` 定义一个函数，传递一个数组 `x`，它将返回多元函数，如下所示：
