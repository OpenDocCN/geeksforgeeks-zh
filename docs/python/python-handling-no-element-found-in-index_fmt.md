## Python：处理在`index()`中找不到元素

> 原文：[https://www.geeksforgeeks.org/python-handling-no-element-found-in-index/](https://www.geeksforgeeks.org/python-handling-no-element-found-in-index/)
