...
> 原文: [https://www.geeksforgeeks.org/amazon-product-availability-checker-using-python/](https://www.geeksforgeeks.org/amazon-product-availability-checker-using-python/)
...
- `requests`: 用于发出 HTTP get 和 post 请求
- `time`: 用于查找当前时间，等待，休眠
- `schedule`: 用于调度某个功能在间隔后再次运行。它类似于 JavaScript 中的“setInterval”功能。
- `smtplib`: 用于使用 Python 发送邮件。
