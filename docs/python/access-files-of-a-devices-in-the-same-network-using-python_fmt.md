...
> 原文: [https://www.geeksforgeeks.org/access-files-of-a-devices-in-the-same-network-using-python/](https://www.geeksforgeeks.org/access-files-of-a-devices-in-the-same-network-using-python/)
...
*   要在本地访问服务器，我们需要访问`http://localhost:8000/`或`http://127.0.0.1:8000/`。在这里我们可以看到您本地存储的所有目录以及所有数据。您还可以访问一个网页，当您访问它时，它将由您的网络浏览器呈现。
