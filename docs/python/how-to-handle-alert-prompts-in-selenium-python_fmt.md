...
> 原文: [https://www.geeksforgeeks.org/how-to-handle-alert-prompts-in-selenium-python/](https://www.geeksforgeeks.org/how-to-handle-alert-prompts-in-selenium-python/)
...
*   `accept()` – 接受可用的警报。
*   `dismiss()` – 取消可用的警报。
*   `send_keys(keys_to_send)` – 向警报发送密钥。
*   `text` – 获取警报的文本。
