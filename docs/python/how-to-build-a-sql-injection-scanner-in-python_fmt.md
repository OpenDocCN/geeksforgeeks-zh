...
> 原文：[https://www.geeksforgeeks.org/how-to-build-a-sql-injection-scanner-in-python/](https://www.geeksforgeeks.org/how-to-build-a-sql-injection-scanner-in-python/)
...
为此，我们将需要`requests`和`beautifulsoup4`包。
...
> [+]在`https://www.geeksforgeeks.org/python-programming-language/`检测到 0 个表单