...
> 原文: [https://www.geeksforgeeks.org/how-to-create-index-for-mongodb-collection-using-python/](https://www.geeksforgeeks.org/how-to-create-index-for-mongodb-collection-using-python/)

## 先决条件

[MongoDB Python 基础知识](https://www.geeksforgeeks.org/mongodb-and-python/)
...
现在我们已经导入了模块，是时候建立与 MongoDB 服务器的连接了，该服务器大概运行在端口 `27017` 的 `localhost` 上。
...
由于与 MongoDB 服务器的连接已经建立，我们现在可以创建或使用现有的数据库。
...
> — > 38“分支”:“CSE”})
>
> 重复密钥错误:`E11000` 重复密钥错误集合:`GFG.学生` 索引:`Roll No_1` dup 键:{:“1008”}
