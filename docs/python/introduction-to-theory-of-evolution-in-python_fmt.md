...
> 原文：[`https://www.geeksforgeeks.org/introduction-to-theory-of-evolution-in-python/`](https://www.geeksforgeeks.org/introduction-to-theory-of-evolution-in-python/)
...
为了理解进化的概念，我们将取一个非常大的二进制数，其中只包含零，然后我们将使用`random`库将所有的零随机转换为一。你会震惊地发现，一段时间后，所有的`0`都会被转换成`1`。
