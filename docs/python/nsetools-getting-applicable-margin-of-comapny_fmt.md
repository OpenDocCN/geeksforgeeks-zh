...
> 原文：[https://www.geeksforgeeks.org/nsetools-get-applied-margin-of-company/](https://www.geeksforgeeks.org/nsetools-get-applied-margin-of-company/)
...
4.  借助 `'applicableMargin'` 键从报价中获取适用的利润。
5.  打印适用的余量值。
