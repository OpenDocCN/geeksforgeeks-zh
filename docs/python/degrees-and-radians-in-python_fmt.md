...
> 原文: [https://www.geeksforgeeks.org/degrees-and-radians-in-python/](https://www.geeksforgeeks.org/degrees-and-radians-in-python/)

`degrees()` 和 `radians()` 是 Python 3 和 Python 2 中 `math` 模块中指定的方法。
