...
> 原文: [https://www.geeksforgeeks.org/python-check-if-list-contains-all-unique-elements/](https://www.geeksforgeeks.org/python-check-if-list-contains-all-unique-elements/)
