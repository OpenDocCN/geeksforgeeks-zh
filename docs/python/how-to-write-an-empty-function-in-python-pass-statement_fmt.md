...
> 原文: [https://www.geeksforgeeks.org/how-to-write-an-empty-function-in-python-pass-statement/](https://www.geeksforgeeks.org/how-to-write-an-empty-function-in-python-pass-statement/)
...
在 Python 中，为了编写空函数，我们使用 `pass` 语句。`pass` 是 Python 中的一个特殊语句，它不做任何事情。它只是作为一个伪语句工作。
