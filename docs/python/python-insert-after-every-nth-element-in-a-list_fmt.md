...
> 原文: [https://www.geeksforgeeks.org/python-insert-after-every-nth-element-in-a-list/](https://www.geeksforgeeks.org/python-insert-after-every-nth-element-in-a-list/)
...
我们可以使用 `join` 函数将第 n 个子串中的每一个与数字 `K` 连接起来，并 `enumerate` 可以执行列表选择性迭代的任务。
...
> 插入后的列表: ['g', 'e', 'e', 'x', 'k', 's', 'f', 'x', 'o', 'r', 'g', 'x', 'e', 'k', 's']