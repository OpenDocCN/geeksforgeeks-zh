...
> 原文: [https://www.geeksforgeeks.org/python-api-destroy_block-in-tweepy/](https://www.geeksforgeeks.org/python-api-destroy_block-in-tweepy/)
...
**语法:** `API.destroy_block(id/screen_name/user_id)`
