...
> 原文：[https://www.geeksforgeeks.org/3d-mesh-plots-using-plotly-in-python/](https://www.geeksforgeeks.org/3d-mesh-plots-using-plotly-in-python/)
...
`plotly.graph_objects.Mesh3d(arg=None, hoverinfo=None, x=None, y=None, z=None, **kwargs)`

**参数：**

- `arg`: 与此构造函数或 `plotly.graph_objects.Mesh3d` 实例兼容的属性集合。
