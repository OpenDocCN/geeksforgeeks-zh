...
> 原文：[https://www.geeksforgeeks.org/how-to-do-exponential-and-logarithmic-curve-fitting-in-python/](https://www.geeksforgeeks.org/how-to-do-exponential-and-logarithmic-curve-fitting-in-python/)
...
> *   **x** -> x 坐标
> *   **y** -> y 坐标
> *   **deg** -> 次拟合多项式。所以，如果 `deg` 为 1，我们得到线性多项式的系数，或者如果它为 2，我们得到二次多项式的系数。
...
所以我们得到系数为 `[5.04, -10.79]`，这样我们就可以得到曲线的方程，它是 (`y= a*log(x)+b`，其中 `a`，`b` 是系数)
