# Python – 在魔杖库中 `clone()` 函数

> 原文: [https://www.geeksforgeeks.org/python-clone-function-in-wand-library/](https://www.geeksforgeeks.org/python-clone-function-in-wand-library/)
