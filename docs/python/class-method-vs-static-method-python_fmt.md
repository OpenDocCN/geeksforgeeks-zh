...
> 原文: [https://www.geeksforgeeks.org/class-method-vs-static-method-python/](https://www.geeksforgeeks.org/class-method-vs-static-method-python/)
...
*   类方法是绑定到类而不是类的对象的方法。
*   它们可以访问类的状态，因为它采用指向类而不是对象实例的类参数 `cls`。
