...
> 原文：[https://www.geeksforgeeks.org/how-to-fix-typeerror-no-numeric-data-to-plot/](https://www.geeksforgeeks.org/how-to-fix-typeerror-no-numeric-data-to-plot/)
...
当我们绘制的数据类型不同于此错误引发的数字数据时，只能对数字数据进行绘制。要知道数据类型是否是数字，我们可以使用函数 `dtypes()` 来知道。
