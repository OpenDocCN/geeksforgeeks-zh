...
> 原文: [https://www.geeksforgeeks.org/how-to-make-rounded-buttons-in-tkinter/](https://www.geeksforgeeks.org/how-to-make-rounded-buttons-in-tkinter/)
...
在本文中，我们将讨论如何在 `Tkinter` 中制作圆角按钮。在 `Tkinter` 中没有内置的方法来制作圆角按钮。为了使按钮变圆，我们将定义边界值为零。
