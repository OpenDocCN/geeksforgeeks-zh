...
> 原文: [https://www.geeksforgeeks.org/navigating-links-using-get-method-selenium-python/](https://www.geeksforgeeks.org/navigating-links-using-get-method-selenium-python/)
...
项目示例:
安装完 Selenium 后，创建一个名为 `run.py` 的文件。
