...
> 原文：[https://www.geeksforgeeks.org/extract-authors-information-from-geeksforgeeks-article-using-python/](https://www.geeksforgeeks.org/extract-authors-information-from-geeksforgeeks-article-using-python/)
...
*   初始化文章标题
*   将网址传递到 `getdata()`
*   借助 `requests` 和 `BeautifulSoup` 刮数据
*   找到所需的详细信息并进行筛选。
