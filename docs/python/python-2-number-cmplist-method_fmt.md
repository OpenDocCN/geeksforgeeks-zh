...
> 原文:[https://www.geeksforgeeks.org/python-2-number-cmplist-method/](https://www.geeksforgeeks.org/python-2-number-cmplist-method/)
...
### 返回:
如果第一个列表“大于”第二个列表，则该函数返回 1，如果第一个列表小于第二个列表，则返回 -1，否则如果两个列表相等，则返回 0。
