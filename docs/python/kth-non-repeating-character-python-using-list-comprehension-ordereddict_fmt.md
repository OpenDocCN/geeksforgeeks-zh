...
> 原文: [https://www.geeksforgeeks.org/kth-non-repeating-character-python-using-list-comprehension-ordereddict/](https://www.geeksforgeeks.org/kth-non-repeating-character-python-using-list-comprehension-ordereddict/)
...
此问题已有解决方案请参考链接。我们可以使用`列表理解`和`排序`在 python 中快速解决这个问题。
