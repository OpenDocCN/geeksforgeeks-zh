...
> 原文: [https://www.geeksforgeeks.org/mahotas-center-of-mass-of-given-image/](https://www.geeksforgeeks.org/mahotas-center-of-mass-of-given-image/)
...
为此，我们将使用 `mahotas.center_of_mass` 方法。

**语法:** `mahotas.center_of_mass(img)`
**参数:** 它将图像对象作为参数
**返回:** 它返回质心坐标
