...
> 原文: [https://www.geeksforgeeks.org/python-extract-numerical-dictionary-values/](https://www.geeksforgeeks.org/python-extract-numerical-dictionary-values/)
...
> **输出**: `[('5', 1, '124'), ('35', 2, '4')]`
>
> **输入**: `test_dict = {"Gfg": ["4"], "best": ["6"], "CS": [1]}`
> **输出**: `[('6', 1, '4')]`
...
> 原始字典: `{'Gfg': ['34', '45', 'geeks'], 'best': ['98', 'abc', '12k'], 'is': ['875', None, '15']}`
