...
> 原文: [https://www.geeksforgeeks.org/python-add-the-element-in-the-list-with-help-of-indexing/](https://www.geeksforgeeks.org/python-add-the-element-in-the-list-with-help-of-indexing/)
...
这个问题的解决方案可以通过这样一个事实来实现，如果我们用`None`初始化所有的元素，内存将被分配给列表，然后它可以在以后根据需要被覆盖。
