...
> 原文：[https://www.geeksforgeeks.org/full-domain-hashing-with-variable-hash-size-in-python/](https://www.geeksforgeeks.org/full-domain-hashing-with-variable-hash-size-in-python/)
...
1.  获取要数字签名的消息 – `M`
2.  使用 `SHA` 或其他哈希算法生成消息摘要 – `H = Hash(M)`
...
> 使用图像大小/摘要大小等于 `RSA` 模大小的函数对消息进行散列
...
```
00cf161c36df4db9e30d79cf9cb3d72e1934cbaeb9eb8638f0f1872679e1df9c3932c77c70c98efa64d34e3166c5b698738b36d9b87261c5ae3c61883c98e19b362db1c73658f0e4c9
```
...
```
b65d6df8d8819869b3cf59b859d72971b93f102ca20af812b931714a558c7a134cb3bb08335f470c890bd1d509283558
```
