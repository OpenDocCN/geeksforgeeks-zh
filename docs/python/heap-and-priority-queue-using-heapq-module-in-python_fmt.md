...
> 原文：[https://www.geeksforgeeks.org/heap-and-priority-queue-using-heapq-module-in-python/](https://www.geeksforgeeks.org/heap-and-priority-queue-using-heapq-module-in-python/)
...
*   `is_empty`：检查队列是否为空。
*   `insert`：插入一个元素及其优先级。该元素将仅按照其优先级的顺序放置。
