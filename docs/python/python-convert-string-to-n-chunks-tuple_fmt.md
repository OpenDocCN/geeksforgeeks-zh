...
> 原文：[https://www.geeksforgeeks.org/python-convert-string-to-n-chunks-tuple/](https://www.geeksforgeeks.org/python-convert-string-to-n-chunks-tuple/)

有时，在使用 Python 字符串时，我们可能会遇到一个问题，需要将一个字符串分解成 N 个大小的块，再分解成一个元组。让我们讨论执行这项任务的某些方法。
