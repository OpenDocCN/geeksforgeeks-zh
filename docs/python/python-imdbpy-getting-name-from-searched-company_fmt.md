...
> 原文: [https://www.geeksforgeeks.org/python-imdbpy-getting-name-from-searched-company/](https://www.geeksforgeeks.org/python-imdbpy-getting-name-from-searched-company/)
...
> **语法:** `company[0]['name']`
>
> 这里的 `company` 是 `search_company` 方法返回的列表，`company[0]` 是指列表的第一个元素。
>
> **返回**: 返回字符串即名称。
