...
> 原文：[https://www.geeksforgeeks.org/how-to-capture-a-image-from-webcam-in-python/](https://www.geeksforgeeks.org/how-to-capture-a-image-from-webcam-in-python/)
...
if result:
    ...
    # Move to this part if input image has some error
    pass
```
...
3.  使用 `list_cameras()` 方法检测所有可用的摄像机。
...
if camlist:
    ...
    # if camera is not detected then moving to this part
    pass
```
...
if camlist:
    ...
    # saving the image
    pygame.image.save(image, "filename.jpg")
# if camera is not detected then moving to else part
else:
