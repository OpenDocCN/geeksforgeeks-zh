...
> 原文: [https://www.geeksforgeeks.org/image-viewer-app-in-python-using-tkinter/](https://www.geeksforgeeks.org/image-viewer-app-in-python-using-tkinter/)

## 先决条件

[Python 图形界面 – Tkinter](https://www.geeksforgeeks.org/python-gui-tkinter/)、[Python: Pillow](https://www.geeksforgeeks.org/python-pillow-a-fork-of-pil/)

你有没有想过用 Python 做一个图像查看器？这里有一个借助 Python 制作图像查看器的解决方案。我们可以在 Tkinter 和 Pillow 的帮助下做到这一点。我们将在下面讨论所需的模块和代码。
...
*   [**Pillow:**](https://www.geeksforgeeks.org/python-pillow-a-fork-of-pil/) 我们可以添加照片，因为它是一个 Python 的成像库。
