# Python | 查找差异等于k的所有不同对

> 原文: [https://www.geeksforgeeks.org/python-find-all-distinct-pairs-with-difference-equal-to-k/](https://www.geeksforgeeks.org/python-find-all-distinct-pairs-with-difference-equal-to-k/)
...
最好的方法是使用来自 `itertools` 模块的内置函数。`combinations()` 对输入中 n 个元素的所有组合的元组产生迭代器。我们利用这些组合，输出那些有 `k` 差的组合。
