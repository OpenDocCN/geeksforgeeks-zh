...
> 原文: [https://www.geeksforgeeks.org/message-boxes-using-pyautogui/](https://www.geeksforgeeks.org/message-boxes-using-pyautogui/)
...
## `confirm()`
显示一个带有确定和取消按钮的消息框。按钮的数量和文本可以自定义。返回单击的按钮的文本。
...
## `prompt()`
显示文字输入的消息框，确定&取消按钮。返回输入的文本，如果单击“取消”，则返回“无”。
...
## `password()`
显示文字输入消息框，点击【确定】&取消按钮。键入的字符显示为*。返回输入的文本，如果单击了取消，则返回无。
