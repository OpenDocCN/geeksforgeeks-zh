...
> 原文：[https://www.geeksforgeeks.org/box-blur-algorithm-with-python-implementation/](https://www.geeksforgeeks.org/box-blur-algorithm-with-python-implementation/)
...
然后，模糊后得到的图像是 `blurred_image = ![ \begin{bmatrix} 1 \end{bmatrix} ](img/ebeaf87d807352c2ff2f89f825967e2b.png "Rendered by QuickLaTeX.com")`
