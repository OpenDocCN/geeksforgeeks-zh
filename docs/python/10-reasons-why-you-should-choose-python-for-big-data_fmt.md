...
> 原文：[https://www.geeksforgeeks.org/10-reasons-why-you-should-choose-python-for-big-data/](https://www.geeksforgeeks.org/10-reasons-why-you-should-choose-python-for-big-data/)
...
`Python` 是一种开源编程语言，您可以免费使用。其实您可以直接从他们的官网 [`python.org`](https://www.python.org/) 下载最新版本的 `Python`。`Python` 也很容易学习！它简单，语法易读，因此深受经验丰富的开发人员和实验学生的喜爱。`Python` 的简单性意味着大数据工程师和数据科学家可以专注于实际管理大数据并获得可操作的见解，而不是花费他们所有的时间（和精力！）只理解语言的技术细微差别。这也是大数据使用 `Python` 的原因之一！
...
*   [`Pandas`](https://www.geeksforgeeks.org/introduction-to-pandas-in-python/) 是一个用于数据分析和数据处理的自由软件库。它提供了各种数据结构和操作，用于以数值表和时间序列的形式操作数据。`Pandas` 还拥有多种工具，可以在内存数据结构和不同文件格式之间读写数据。
