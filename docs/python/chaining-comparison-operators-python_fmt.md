...
> 原文：[https://www.geeksforgeeks.org/chaining-comparison-operators-python/](https://www.geeksforgeeks.org/chaining-comparison-operators-python/)
...
在 Python 中，有一种更好的方法可以使用比较运算符 Chaining 来写这个。运算符的链接可以写成如下形式：
...
本文由 普拉蒂克·查哈尔 供稿。如果你喜欢 GeeksforGeeks 并想投稿，你也可以使用 [contribute.geeksforgeeks.org](http://contribute.geeksforgeeks.org) 写一篇文章或者把你的文章邮寄到 `contribute@geeksforgeeks.org`。看到你的文章出现在极客博客主页上，帮助其他极客。
