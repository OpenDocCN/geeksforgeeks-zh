...
> 原文: [https://www.geeksforgeeks.org/pyglet-getting-line-count-of-incremental-text-layout/](https://www.geeksforgeeks.org/pyglet-getting-line-count-of-incremental-text-layout/)
...
为了获取行数，我们使用 `get_line_count` 方法。

**语法:** `layout.get_line_count()`
