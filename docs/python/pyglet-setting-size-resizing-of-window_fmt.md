...
> 原文: [https://www.geeksforgeeks.org/pyglet-setting-size-resizing-of-window/](https://www.geeksforgeeks.org/pyglet-setting-size-resizing-of-window/)
...
为了创建窗口，我们对窗口对象使用 `set_size` 方法。

**语法:** `window.set_size(宽度, 高度)`
