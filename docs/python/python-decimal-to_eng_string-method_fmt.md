...
> 原文: [https://www.geeksforgeeks.org/python-decimal-to_eng_string-method/](https://www.geeksforgeeks.org/python-decimal-to_eng_string-method/)

`Decimal.to_eng_string()`是一个`Decimal`类方法，它转换为字符串，如果需要指数，则使用工程符号。
