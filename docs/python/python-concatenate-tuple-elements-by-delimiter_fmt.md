...
> 原文: [https://www.geeksforgeeks.org/python-concatenate-tuple-elements-by-delimiter/](https://www.geeksforgeeks.org/python-concatenate-tuple-elements-by-delimiter/)

给定一个元组，用分隔符连接元组的每个元素。

> **输入**: `test_tup = (“Gfg”, “is”, 4, “Best”)`, `delim = “-”`
> **输出**: `Gfg-is-4-Best`
> **解释**: 以“-”连接的元素。
>
> **输入**: `test_tup = (“Gfg”, “is”, 4)`, `delim = “,”`
> **输出**: `Gfg,is,4`
> **解释**: 以“,”连接的元素。
