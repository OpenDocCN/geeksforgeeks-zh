...
> 原文：[`https://www.geeksforgeeks.org/introduction-to-simulation-modeling-in-python/`](https://www.geeksforgeeks.org/introduction-to-simulation-modeling-in-python/)
...
模拟模型是在建立新系统或改变现有系统之前建立的，以优化系统的性能并减少失败的机会。当今场景中领先的模拟模型之一是蒙特卡罗模拟。
