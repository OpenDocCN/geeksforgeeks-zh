...
> 原文: [https://www.geeksforgeeks.org/python-extract-indices-of-substring-matches/](https://www.geeksforgeeks.org/python-extract-indices-of-substring-matches/)

给定一个字符串列表和一个子字符串，提取该子字符串所在的字符串索引列表。

> **输入**: `test_list = ["Gfg is good", "for Geeks", "I love Gfg", "Its useful"]`, `K = "Gfg"`
> **输出**: `[0, 2, 3]`
> **解释**: “Gfg”作为子串出现在第 0、2、3 个元素中。
>
> **输入**: `test_list = ["Gfg is good", "for Geeks", "I love Gfg", "Its useful"]`, `K = "is"`
> **输出**: `[0]`
> **解释**: “is”出现在第 0 个子串。

## 方法 1: 使用循环+enumerate()

这是完成这项任务的粗暴方式。在这种情况下，我们使用 `enumerate()` 迭代所有元素及其索引，并使用条件语句来获得所需的结果。
