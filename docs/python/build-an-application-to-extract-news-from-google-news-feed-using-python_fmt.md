...
> 原文：[https://www.geeksforgeeks.org/build-an-application-to-extract-news-from-google-news-feed-using-python/](https://www.geeksforgeeks.org/build-an-application-to-extract-news-from-google-news-feed-using-python/)

**先决条件** – [Python Tkinter](https://www.geeksforgeeks.org/python-gui-tkinter/)

在本文中，我们将编写一个 Python 脚本，通过使用 `gnewsclient` 模块从 Google News Feed 中提取新闻文章，并将其与 GUI 应用程序绑定。`gnewsclient` 是谷歌新闻提要的 Python 客户端。必须先显式安装该 API 才能使用。
