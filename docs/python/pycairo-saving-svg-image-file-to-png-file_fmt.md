...
> 原文: [https://www.geeksforgeeks.org/pycairo-saving-svg-image-file-to-png-file/](https://www.geeksforgeeks.org/pycairo-saving-svg-image-file-to-png-file/)
...
> **语法:** `surface.write_to_png('geeks.png')`
> **参数:** 要保存的文件名
> **返回:** 它返回 `None`
