...
> 原文: [https://www.geeksforgeeks.org/python-escape-reserved-characters-in-strings-list/](https://www.geeksforgeeks.org/python-escape-reserved-characters-in-strings-list/)

给定字符串列表，转义每个字符串中的保留字符。

> **输入**: `test_list = ["Gf-g", "be)s(t)"]`
> **输出**: `['Gf\\-g', 'be\\)s\\(t']`
