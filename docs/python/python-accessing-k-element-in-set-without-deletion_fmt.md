...
> 原文: [https://www.geeksforgeeks.org/python-accessing-k-element-in-set-without-deletion/](https://www.geeksforgeeks.org/python-accessing-k-element-in-set-without-deletion/)

在本文中，给定一个集合(`set`)，任务是编写一个Python程序来访问元素`K`，而不使用`pop()`执行删除。
