...
> 原文: [https://www.geeksforgeeks.org/python-construct-cartesian-product-tuple-list/](https://www.geeksforgeeks.org/python-construct-cartesian-product-tuple-list/)
...
> 原始列表: [1, 4, 6, 7]
> 原始元组: (1, 3)
> 笛卡尔积为: [(1, 1), (1, 4), (1, 6), (1, 7), (3, 1), (3, 4), (3, 6), (3, 7)]