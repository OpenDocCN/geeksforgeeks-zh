...
> 原文：[https://www.geeksforgeeks.org/python-check-if-given-multiple-keys-exist-in-a-dictionary/](https://www.geeksforgeeks.org/python-check-if-given-multiple-keys-exist-in-a-dictionary/)

Python 中的[字典由键值对的集合组成。每个键值对将键映射到其关联的值。](https://www.geeksforgeeks.org/python-dictionary/)

> 输入：`dict[] = {“geeksforgeeks”:1, “practice”:2, “contribute”:3}`
> 键[] = {“geeksforgeeks”, “practice”}
> 输出：是
>
> 输入：`dict[] = {“geeksforgeeks”:1, “practice”:2, “contribute”:3}`
> 键[] = {“geeksforgeeks”, “ide”}
