...
> 原文: [https://www.geeksforgeeks.org/python-imdbpy-getting-top-250-movies/](https://www.geeksforgeeks.org/python-imdbpy-getting-top-250-movies/)
...
返回 250 个元素的列表，每个元素都是 `idbm` 电影对象。
