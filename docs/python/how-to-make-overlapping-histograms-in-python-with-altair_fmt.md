...
> 原文: [https://www.geeksforgeeks.org/how-to-make-overlapping-histograms-in-python-with-altair/](https://www.geeksforgeeks.org/how-to-make-overlapping-histograms-in-python-with-altair/)

## 先决条件
[牛郎星](https://www.geeksforgeeks.org/introduction-to-altair-in-python/)
...
### 方法二: 宽形
*   通常，您可能会从各种形式的数据开始。阿尔泰有`transform_fold()`功能，可以将宽格式的数据转换成整齐的长格式。这允许我们不使用熊猫的`melt()`功能，让我们在牛郎星内部传递信息。
