...
> 原文：[https://www.geeksforgeeks.org/an-application-to-test-the-given-page-is-found-or-not-on-the-server-using-python/](https://www.geeksforgeeks.org/an-application-to-test-the-given-page-is-found-or-not-on-the-server-using-python/)

## 先决条件
[Python urllib 模块](https://www.geeksforgeeks.org/python-urllib-module/)
...
## 用于测试给定页面的应用程序在服务器上是否找到 [Tkinter](https://www.geeksforgeeks.org/create-first-gui-application-using-python-tkinter/)
该脚本将上述实现与图形用户界面相结合。
