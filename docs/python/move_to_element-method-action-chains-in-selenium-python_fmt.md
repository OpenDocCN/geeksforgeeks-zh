...
> 原文: [https://www.geeksforgeeks.org/move_to_element-method-action-chains-in-selenium-python/](https://www.geeksforgeeks.org/move_to_element-method-action-chains-in-selenium-python/)
...
演示一下，硒蟒的`move_to_element`动作链法。让我们参观 [https://www.geeksforgeeks.org/](https://www.geeksforgeeks.org/) ，并对一个元素进行操作。
