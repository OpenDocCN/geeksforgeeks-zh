...
> 原文：[https://www.geeksforgeeks.org/difference-between-iterator-vs-generator/](https://www.geeksforgeeks.org/difference-between-iterator-vs-generator/)
...
| --- | --- |
| 类用于实现迭代器 | 函数用于实现生成器。 |
| 这里不使用局部变量。 | 存储 `yield` 函数之前的所有局部变量。 |
