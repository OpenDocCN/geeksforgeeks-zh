...
## 游戏介绍
`Tkinter` 广泛用于开发 `GUI` 应用。除了应用程序，我们还可以使用 `Tkinter GUI` 开发游戏。
...
## 输出
[https://media.geeksforgeeks.org/wp-content/uploads/tkinter_game.mp4](https://media.geeksforgeeks.org/wp-content/uploads/tkinter_game.mp4)

## 注意
由于 `TKinter` 模块，上述代码可能无法在联机 `IDE` 上运行。