# Python：检查给定列表中是否有任何元素出现了n次

> 原文：[https://www.geeksforgeeks.org/python-check-if-any-element-occurs-n-times-in-given-list/](https://www.geeksforgeeks.org/python-check-if-any-element-occurs-n-times-in-given-list/)
