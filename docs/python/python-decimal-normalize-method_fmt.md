...
> 原文: [https://www.geeksforgeeks.org/python-decimal-normalize-method/](https://www.geeksforgeeks.org/python-decimal-normalize-method/)

## Decimal.normalize()

`normalize()`是一个`Decimal`类方法，返回`Decimal`值的最简单形式。
