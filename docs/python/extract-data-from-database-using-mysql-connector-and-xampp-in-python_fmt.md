...
> 原文: [https://www.geeksforgeeks.org/extract-data-from-database-using-mysql-connector-and-xampp-in-python/](https://www.geeksforgeeks.org/extract-data-from-database-using-mysql-connector-and-xampp-in-python/)
...
*   启动你的 *XAMPP* 网络服务器。
*   在浏览器中键入 `http://localhost/phpmyadmin/`。
