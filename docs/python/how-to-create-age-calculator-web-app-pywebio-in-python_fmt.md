...
> 原文：[https://www.geeksforgeeks.org/how-to-create-age-calculator-web-app-pywebio-in-python/](https://www.geeksforgeeks.org/how-to-create-age-calculator-web-app-pywebio-in-python/)
...
将用户的出生日期和当前日期除以“/”。然后将所有拆分的部分类型转换为整数。用月份和年份交换用户的出生日期和当前日期。
...
检查当前年份是否小于用户的出生年份。如果当前年份小于，则通过错误。
