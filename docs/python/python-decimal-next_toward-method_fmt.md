# Python | Decimal next_toward()方法

> 原文: [https://www.geeksforgeeks.org/python-decimal-next_toward-method/](https://www.geeksforgeeks.org/python-decimal-next_toward-method/)

`Decimal.next_toward()`是一个`Decimal`类方法，它返回在朝向第二个小数值的方向上最接近第一个小数值的数字。
...
## 返回
向第二个小数值方向最接近第一个小数值的数字。

## 代码# 1: `next_toward()`方法示例
