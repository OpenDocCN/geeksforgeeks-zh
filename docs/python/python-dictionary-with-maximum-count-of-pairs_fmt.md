...
> 原文: [https://www.geeksforgeeks.org/python-dictionary-with-maximum-count-of-pairs/](https://www.geeksforgeeks.org/python-dictionary-with-maximum-count-of-pairs/)

给定字典列表，提取最大关键字的字典。

> **输入**: `test_list = [{"gfg":2, "best":4}, {"gfg":2, "is":3, "best":4, "CS":9}, {"gfg":2}]`
> **输出**: 4
> **解释**: 第二字典最大键数，4。
>
> **输入**: `test_list = [{"gfg":2, "best":4}, {"gfg":2}]`
> **输出**: 2
> **解释**: 第一字典最大键数，2。
