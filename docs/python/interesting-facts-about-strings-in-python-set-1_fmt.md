...
> 原文：[https://www.geeksforgeeks.org/interesting-facts-about-strings-in-python-set-1/](https://www.geeksforgeeks.org/interesting-facts-about-strings-in-python-set-1/)
...
了解使用 [`id()`](https://www.geeksforgeeks.org/id-function-python/) 功能。`id()` 函数用于返回对象的标识。
