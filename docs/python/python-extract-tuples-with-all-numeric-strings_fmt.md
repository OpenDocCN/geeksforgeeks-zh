...
> 原文: [https://www.geeksforgeeks.org/python-extract-tuples-with-all-numeric-strings/](https://www.geeksforgeeks.org/python-extract-tuples-with-all-numeric-strings/)

给定一个元组列表，只提取那些包含所有数字字符串的元组。

> **输入**: `test_list = [("45", "86"), ("Gfg", "1"), ("98", "10")]`
> **输出**: `[("45", "86"), ("98", "10")]`
> **解释**: 只过滤代表元组的数字。
>
> **输入**: `test_list = [("Gfg", "1")]`
