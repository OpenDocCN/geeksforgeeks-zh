# Python Decimal logical_and() 方法

> 原文：[https://www.geeksforgeeks.org/python-decimal-logical_and-method/](https://www.geeksforgeeks.org/python-decimal-logical_and-method/)

`Decimal.logical_and()` 是一个 `Decimal` 类方法，它返回两个（逻辑）`Decimal` 值的数字和。

> **语法：** `decimal.logical_and()`
>
> **参数：** 十进制值
>
> **返回：** 两位（逻辑）十进制值的数字和。

**代码#1：`logical_and()` 方法示例**
