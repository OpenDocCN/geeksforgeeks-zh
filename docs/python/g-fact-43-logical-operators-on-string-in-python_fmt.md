...
> 原文: [https://www.geeksforgeeks.org/g-fact-43-logical-operators-on-string-in-python/](https://www.geeksforgeeks.org/g-fact-43-logical-operators-on-string-in-python/)
...
2.  对于 `and` 运算符，如果左值为真，则检查并返回右值。如果左值为假，则返回左值。
3.  对于 `or` 运算符，如果左值为真，则返回左值，否则，如果左值为假，则返回右值。
