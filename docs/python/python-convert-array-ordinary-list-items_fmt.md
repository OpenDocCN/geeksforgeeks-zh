# Python：将数组转换为包含相同项目的普通列表

> 原文：[https://www.geeksforgeeks.org/python-convert-array-ordinary-list-items/](https://www.geeksforgeeks.org/python-convert-array-ordinary-list-items/)
