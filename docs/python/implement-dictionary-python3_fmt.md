...
我制作了一个文本文件，其中单词及其含义以 Python 的字典格式存储，示例：
...
输出将是你的结果。
![](img/8cbee176b360c9033a38120365bc6a03.png)

## 视频演示

[https://media.geeksforgeeks.org/wp-content/uploads/ujjuDictionary-1.mp4](https://media.geeksforgeeks.org/wp-content/uploads/ujjuDictionary-1.mp4)