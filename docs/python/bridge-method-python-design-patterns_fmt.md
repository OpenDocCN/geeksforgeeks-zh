...
> 原文: [https://www.geeksforgeeks.org/bridge-method-python-design-patterns/](https://www.geeksforgeeks.org/bridge-method-python-design-patterns/)
...
*   **复杂性:** 我们代码在应用**桥接方法**之后可能会变得复杂，因为我们正在入侵新的抽象类和接口。
...
**进一步阅读:** [Java桥法](https://www.geeksforgeeks.org/bridge-design-pattern/)