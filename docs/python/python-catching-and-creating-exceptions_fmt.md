...
> 原文: [https://www.geeksforgeeks.org/python-catching-and-creating-exceptions/](https://www.geeksforgeeks.org/python-catching-and-creating-exceptions/)
...
### 代码 #1：为 `Exception` 编写异常处理器以捕获所有异常。
...
要创建新的异常，只需将它们定义为从 `Exception` 继承的类（或者其他现有异常类型，如果更有意义的话）。
