...
> 原文：[https://www.geeksforgeeks.org/how-to-update-all-the-values-of-a-specific-column-of-sqlite-table-using-python/](https://www.geeksforgeeks.org/how-to-update-all-the-values-of-a-specific-column-of-sqlite-table-using-python/)
...
## 例 2：更新 `ship_destination` 列

在这个程序中，我们首先插入数据，然后将 `ship_destination` 中的所有数据更新到同一个表中的 `delhi`。
