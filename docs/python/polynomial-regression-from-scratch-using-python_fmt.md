...
> 原文: [https://www.geeksforgeeks.org/polynomial-regression-from-scratch-using-python/](https://www.geeksforgeeks.org/polynomial-regression-from-scratch-using-python/)
...
h( x ) = w1*x + w2*x^2 + .... + wn*x^n
here, w is the weight vector.
where x^2 is the derived feature from x.
```
