...
> 原文: [https://www.geeksforgeeks.org/pyglet-on-text-motion-select-event/](https://www.geeksforgeeks.org/pyglet-on-text-motion-select-event/)
...
下面是 `on_text_motion` 的语法，当触发此事件时会调用此方法
