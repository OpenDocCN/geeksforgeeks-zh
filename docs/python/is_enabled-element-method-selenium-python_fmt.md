...
> 原文: [https://www.geeksforgeeks.org/is_enabled-element-method-selenium-python/](https://www.geeksforgeeks.org/is_enabled-element-method-selenium-python/)
...
本文围绕如何在硒中使用 `is_enabled` 方法展开。`is_enabled` 方法用于检查元件是否启用。它返回一个布尔值 `true` 或 `false`。
