...
> 原文: [https://www.geeksforgeeks.org/python-convert-list-of-dictionaries-to-json/](https://www.geeksforgeeks.org/python-convert-list-of-dictionaries-to-json/)
...
其中 `mydata.json` 是新的 JSON 文件。最后，我们必须下载创建的 JSON 文件。
