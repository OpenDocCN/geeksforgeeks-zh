...
> 原文：[https://www.geeksforgeeks.org/download-file-in-selenium-using-python/](https://www.geeksforgeeks.org/download-file-in-selenium-using-python/)
...
下载文件时，我们将使用 [`click()`](https://www.geeksforgeeks.org/click-element-method-selenium-python/) 方法。这里是我们的自动化，我们将下载一个生成的文本文件。
