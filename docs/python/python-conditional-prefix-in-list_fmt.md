...
> 原文: [https://www.geeksforgeeks.org/python-conditional-prefix-in-list/](https://www.geeksforgeeks.org/python-conditional-prefix-in-list/)

给定一个元素列表，根据条件附加不同的前缀。

> **输入** : `test_list = [45, 53, 76, 86, 3, 49]`, `pref_1 = "LOSE-"`, `pref_2 = "WIN-"`
> **输出** : `['LOSE-45', 'WIN-53', 'WIN-76', 'WIN-86', 'LOSE-3', 'LOSE-49']`
> **解释**: 所有 50+ 前缀为 `"WIN-"`，其他为 `"LOSE-"`。
>
> **输入** : `test_list = [78, 53, 76, 86, 83, 69]`, `pref_1 = "LOSE-"`, `pref_2 = "WIN-"`
