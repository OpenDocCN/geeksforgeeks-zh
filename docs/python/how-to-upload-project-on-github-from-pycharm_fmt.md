...
> 原文: [https://www.geeksforgeeks.org/how-to-upload-project-on-github-from-pycharm/](https://www.geeksforgeeks.org/how-to-upload-project-on-github-from-pycharm/)
...
## 先决条件
在阅读本文之前，请考虑一个人必须已经有一个 GitHub 帐户。此外，考虑一下您一定已经在 Pycharm 上开发了一个 Python 项目。

## 从 pycharm 上传 GitHub 上的 Python 项目的逐步过程

### Step 1
转到位于 PyCharm 顶部的 `VCS` 面板并单击它。单击后选择 “`Enable Version Control Integration`“。
...
### Step 2
下一步是单击 PyCharm 上部的绿色对勾。基本上这个符号指的是 `Commit`，它的作用是收集所有未版本控制的文件并使它们准备好更新到 GitHub。
...
### Step 3
最后一步是转到 `VCS`，然后选择 `Import into Version Control`，接着点击 `Share project on GitHub`。
