...
> 原文：[https://www.geeksforgeeks.org/how-to-open-external-programs-using-tkinter/](https://www.geeksforgeeks.org/how-to-open-external-programs-using-tkinter/)
...
*   要打开该文件，我们将使用 `os` 模块中的 `system()` 方法。
