...
> 原文：[https://www.geeksforgeeks.org/moviepy-concatenating-multiple-video-files/](https://www.geeksforgeeks.org/moviepy-concatenating-multiple-video-files/)
...
> **语法：** `concatenate_videoclips(clips)`
> **参数：** 它以视频文件剪辑列表作为参数。
