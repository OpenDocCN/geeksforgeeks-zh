...
> 原文: [https://www.geeksforgeeks.org/diverging-bar-chart-using-python/](https://www.geeksforgeeks.org/diverging-bar-chart-using-python/)
...
## 方法二: 使用 [Plotly](https://www.geeksforgeeks.org/getting-started-with-plotly-python/)
