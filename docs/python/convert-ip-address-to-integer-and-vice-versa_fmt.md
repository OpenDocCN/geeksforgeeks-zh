...
> 原文：[https://www.geeksforgeeks.org/convert-ip-address-to-integer-and-vice-versa/](https://www.geeksforgeeks.org/convert-ip-address-to-integer-and-vice-versa/)

为此，我们将使用 [`ipaddress`](https://docs.python.org/3/library/ipaddress.html) 模块。`ipaddress` 是一个帮助创建、操作和操作 IPv4 和 IPv6 地址和网络的模块。
