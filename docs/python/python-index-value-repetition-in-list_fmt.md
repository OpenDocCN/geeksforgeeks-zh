...
> 原文: [https://www.geeksforgeeks.org/python-index-value-repetition-in-list/](https://www.geeksforgeeks.org/python-index-value-repetition-in-list/)

给定一个元素列表，任务是编写一个 Python 程序来根据索引中的值重复每个索引值。

> **输入**: `test_list = [3, 0, 4, 2]`
