...
> 原文：[https://www.geeksforgeeks.org/python-extract-particular-data-type-rows/](https://www.geeksforgeeks.org/python-extract-particular-data-type-rows/)
...
## 方法二：使用 `filter()` + `lambda` + `isinstance()`
