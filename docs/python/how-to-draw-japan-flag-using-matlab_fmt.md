...
> 原文: [https://www.geeksforgeeks.org/how-to-draw-japan-flag-using-matlab/](https://www.geeksforgeeks.org/how-to-draw-japan-flag-using-matlab/)
...
*   首先用白色给整个矩阵上色。白色的 `RGB` 是(255，255，255)。

```matlab
I(:, :, :) = 255;
```

*   对行和列应用循环，并实现圆的方程，以便在旗帜中心得到一个圆，并使用 `RGB` 格式将其染成深红荣耀色。
    **圆的方程:**
