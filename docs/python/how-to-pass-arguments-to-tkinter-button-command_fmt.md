...
> 原文: [https://www.geeksforgeeks.org/how-to-pass-arguments-to-tkinter-button-command/](https://www.geeksforgeeks.org/how-to-pass-arguments-to-tkinter-button-command/)
...
这两种方法的步骤都是一样，唯一需要改变的是如何应用这两种方法。
