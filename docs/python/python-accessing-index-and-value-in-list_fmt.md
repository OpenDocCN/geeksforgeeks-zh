...
> 原文：[https://www.geeksforgeeks.org/python-accessing-index-and-value-in-list/](https://www.geeksforgeeks.org/python-accessing-index-and-value-in-list/)

有各种方法可以访问列表的元素，但是有时我们可能需要访问元素以及找到它的索引。让我们看看访问列表中索引和值的所有不同方式。
...
这个方法的工作方式与上面的方法类似，但是使用了列表推导式技术，这减少了可能要编写的代码行，因此节省了时间。
