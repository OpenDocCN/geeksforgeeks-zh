...
> 原文: [https://www.geeksforgeeks.org/how-to-parse-and-modify-xml-in-python/](https://www.geeksforgeeks.org/how-to-parse-and-modify-xml-in-python/)
...
让我们**删除**`hobby`标签。也让我们**修改**把`年龄`改为`29`。
