...
> 原文: [https://www.geeksforgeeks.org/creating-a-dataframe-using-excel-files/](https://www.geeksforgeeks.org/creating-a-dataframe-using-excel-files/)

让我们看看如何使用`pandas`将 excel 文件读取到`pandas`数据框对象。

## 代码#1：用`pandas`的`read_excel()`方法读取 excel 文件
