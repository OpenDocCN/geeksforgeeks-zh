...
> 原文：[https://www.geeksforgeeks.org/counting-number-of-unique-values-in-a-python-list/](https://www.geeksforgeeks.org/counting-number-of-unique-values-in-a-python-list/)
...
## 方法 1：
遍历列表，使用字典统计每个元素的频率，最后统计频率为 1 的元素。
...
## 方法 2：
这里我们将使用字典类的`get()`方法来统计频率。这使得程序变得更短，并演示了`get()`方法如何代替 if…else 有用。
