...
> 原文: [https://www.geeksforgeeks.org/find_element_by_name-driver-method-selenium-python/](https://www.geeksforgeeks.org/find_element_by_name-driver-method-selenium-python/)
...
本文围绕如何使用 Selenium Web Driver 的定位策略抓取或定位网页中的元素展开。更具体地说，本文中讨论了 `find_element_by_name()`。
...
让我们尝试实际实现这个方法，并为获取一个元素实例。让我们尝试使用搜索表单的名称“search”来抓取搜索表单输入。
