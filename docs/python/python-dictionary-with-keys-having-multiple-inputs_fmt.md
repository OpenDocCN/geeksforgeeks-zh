...
> 原文: [https://www.geeksforgeeks.org/python-dictionary-with-keys-having-multiple-inputs/](https://www.geeksforgeeks.org/python-dictionary-with-keys-having-multiple-inputs/)
...
让我们获取密钥。让我们考虑一个字典，其中经度和纬度是`键`，它们所属的地方是`值`。
