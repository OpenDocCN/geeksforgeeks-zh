...
> 原文: [https://www.geeksforgeeks.org/python-get-number-of-characters-words-spaces-and-lines-in-a-file/](https://www.geeksforgeeks.org/python-get-number-of-characters-words-spaces-and-lines-in-a-file/)
...
在这种方法中，思路是通过开发自己的逻辑来解决任务。不使用 Python 的任何内置函数，计算文件的字符、单词、空格和行的总数。
