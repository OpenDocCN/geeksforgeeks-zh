...
> 原文: [https://www.geeksforgeeks.org/arcade-inbuilt-functions-to-draw-polygon-in-python3/](https://www.geeksforgeeks.org/arcade-inbuilt-functions-to-draw-polygon-in-python3/)
...
> **语法:** `arcade.draw_polygon_outline(点_列表，颜色，线宽)`
>
> **参数:**
>
> *   **点_列表:** 组成线的点列表。每个点都在一个列表中。这是一个列表。
...
arcade 的这个内置功能是用来绘制填充了颜色的多边形。

> **语法:** `arcade.draw_polygon_filled(点_列表，颜色)`
>
> **参数:**
>
> *   **点_列表:** 基本上是点列表，每个点都在一个列表中。这是一个列表。
