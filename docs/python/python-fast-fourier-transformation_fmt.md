...
> 原文: [https://www.geeksforgeeks.org/python-fast-fourier-transformation/](https://www.geeksforgeeks.org/python-fast-fourier-transformation/)
...
它可以在复域中进行离散傅里叶变换。
由于基数-2 快速傅立叶变换要求样本点数为 2 的幂，因此序列会自动向右填充零。对于短序列，仅将此方法与默认参数一起使用，因为序列的大小会增加表达式的复杂性。
