# Python–根据第 k 列自定义行删除

> 原文: [https://www.geeksforgeeks.org/python-custom-rows-removal-depending-on-kth-column/](https://www.geeksforgeeks.org/python-custom-rows-removal-depending-on-kth-column/)
