...
> 原文: [https://www.geeksforgeeks.org/pyglet-accessing-caret-mark-property/](https://www.geeksforgeeks.org/pyglet-accessing-caret-mark-property/)
...
> 为了创建窗口，我们对插入符号对象使用标记属性语法: `caret.mark`
> **参数:** 它不带参数
> **返回:** 它返回整数
