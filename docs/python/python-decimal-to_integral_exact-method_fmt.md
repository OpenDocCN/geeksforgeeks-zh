# Python Decimal to_integral_exact()方法

> 原文: [https://www.geeksforgeeks.org/python-decimal-to_integral_exact-method/](https://www.geeksforgeeks.org/python-decimal-to_integral_exact-method/)

`Decimal.to_integral_exact()` 是一个 `Decimal` 类方法，返回舍入值。
