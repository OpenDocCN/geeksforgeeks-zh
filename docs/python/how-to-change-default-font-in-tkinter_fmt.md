...
> 原文: [https://www.geeksforgeeks.org/how-to-change-default-font-in-tkinter/](https://www.geeksforgeeks.org/how-to-change-default-font-in-tkinter/)
...
*   在字体对象上使用 `configure` 方法
*   然后改变字体样式，如 `family`、`size`、等。
