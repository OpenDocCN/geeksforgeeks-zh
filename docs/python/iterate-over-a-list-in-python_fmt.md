...
> 原文：[https://www.geeksforgeeks.org/iterate-over-a-list-in-python/](https://www.geeksforgeeks.org/iterate-over-a-list-in-python/)
...
**注意：** 即使方法 2 也可以用来查找索引，但是方法 1 不能（除非每次迭代都增加一个额外的变量）。方法 5 给出了该索引的简洁表示。
