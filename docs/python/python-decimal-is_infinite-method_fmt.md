...
> 原文: [https://www.geeksforgeeks.org/python-decimal-is_infinite-method/](https://www.geeksforgeeks.org/python-decimal-is_infinite-method/)

`Decimal.is_infinite()` 是一个 `Decimal` 类方法，检查 `Decimal` 值是否为无穷大值。
...
## 返回
true – 如果十进制值为无穷大值；否则为假

## 代码示例 1: is_infinite()方法示例
