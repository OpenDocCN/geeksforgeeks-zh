...
> 原文: [https://www.geeksforgeeks.org/python-check-if-tuple-contains-only-k-elements/](https://www.geeksforgeeks.org/python-check-if-tuple-contains-only-k-elements/)
