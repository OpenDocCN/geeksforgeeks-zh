...
> 原文: [https://www.geeksforgeeks.org/g-fact-25-print-single-multiple-variable-python/](https://www.geeksforgeeks.org/g-fact-25-print-single-multiple-variable-python/)

在 `Python 3`中。`X`，打印语句写成`print()`函数。下面是 `Python 3` 中的代码。显示 `Python` 中打印值的过程的 `x`。
