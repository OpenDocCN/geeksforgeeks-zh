...
> 原文: [https://www.geeksforgeeks.org/python-group-similar-items-to-dictionary-values-list/](https://www.geeksforgeeks.org/python-group-similar-items-to-dictionary-values-list/)
...
这是执行这项任务的方法之一。在这个中，我们构造用缺省列表构造一个 `defaultdict()`，并不断将相似的值追加到相似的列表中。
