...
> 原文: [https://www.geeksforgeeks.org/how-to-get-selected-value-from-listbox-in-tkinter/](https://www.geeksforgeeks.org/how-to-get-selected-value-from-listbox-in-tkinter/)
...
可以将 `listbox` 小部件的 `selectmode` 参数更改为 `"SINGLE"`，用于设置仅选择单个值的约束。