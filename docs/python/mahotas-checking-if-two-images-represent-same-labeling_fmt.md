# mahotas – 检查两幅图像是否代表相同的标签

> 原文: [https://www.geeksforgeeks.org/mahotas-checking-if-two-images-represent-same-labeling/](https://www.geeksforgeeks.org/mahotas-checking-if-two-images-represent-same-labeling/)
...
为了做到这一点，我们将使用 `mahotas.labeled.is_same_labeling` 方法。

> **语法:** `mahotas.labeled.is_same_labeling(label1, label2)`
> **参数:** 它以两个标签图像作为参数
> **返回:** 它返回 `bool`
