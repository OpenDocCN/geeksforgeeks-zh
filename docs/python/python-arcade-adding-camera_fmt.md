...
您可以使用`camera()`函数在街机中创建摄像机。

> **语法:** `arcade.Camera(width, height)`
> 
> **参数:**
> 
> *   `width`: 相机的宽度
...
*   `setup()`: 在这个函数里面，我们将调用`arcade.Scene()`和`arcade.Camera()`函数，然后我们将在精灵列表中加载和存储我们的精灵。
