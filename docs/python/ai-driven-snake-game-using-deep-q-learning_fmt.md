...
> 原文: [https://www.geeksforgeeks.org/ai-driven-snake-game-using-deep-q-learning/](https://www.geeksforgeeks.org/ai-driven-snake-game-using-deep-q-learning/)

## 简介
本项目基于强化学习，训练蛇吃环境中存在的食物。
...
要了解我们如何使用 `pygame` 手动构建这个蛇 2D 动画模拟，请遵循以下链接: [https://www.geeksforgeeks.org/snake-game-in-python-using-pygame-module/](https://www.geeksforgeeks.org/snake-game-in-python-using-pygame-module/)
...
**注:** 开采和勘探之间存在权衡。其中开采包括根据目前观察到的数据做出假设为最佳的决策。探索是随机做出决定，而不考虑之前的行动和奖励对。所以两者都是必要的，因为采取剥削可能会导致代理人无法探索整个环境，而探索可能不会总是提供一个更好的奖励。
...
**源代码:** [https://github.com/vedantgoswami/SnakeGameAI](https://github.com/vedantgoswami/SnakeGameAI)
...
*   使用单独的环境并安装所有必需的模块。(您可以使用 `anaconda` 环境)
