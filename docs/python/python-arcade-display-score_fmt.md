...
> **语法:** `arcade.Camera(width, height, window)`
>
> **参数:**
>
> - `width`: 视口的宽度
...
> **语法:** `arcade.Scene(sprite_list, name_map)`
>
> **参数:**
>
> - `sprite_list`: `SpriteList` 对象的列表
> - `name_map`: `SpriteList` 对象的字典
...
如果玩家从平台上掉下来，我们会将 `score` 变量的值设置为 0，并调用 `setup()` 函数来重启游戏。
