...
> 原文: [https://www.geeksforgeeks.org/python-convert-list-of-dictionary-to-tuple-list/](https://www.geeksforgeeks.org/python-convert-list-of-dictionary-to-tuple-list/)

给定一个字典列表，编写一个 python 代码将字典列表转换成元组列表。
