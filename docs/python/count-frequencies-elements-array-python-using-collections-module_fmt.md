...
> 原文：[https://www.geeksforgeeks.org/count-frequencies-elements-array-python-using-collections-module/](https://www.geeksforgeeks.org/count-frequencies-elements-array-python-using-collections-module/)

给定一个可以包含 `n` 个整数的未排序数组。计算数组中所有元素的频率。
