...
> 原文: [https://www.geeksforgeeks.org/build-a-covid19-vaccine-tracker-using-python/](https://www.geeksforgeeks.org/build-a-covid19-vaccine-tracker-using-python/)
...
*   `requests`：`Requests` 可以让你极其轻松的发送 HTTP/1.1 请求。该模块也没有内置 Python。要安装此软件，请在终端中键入以下命令。
