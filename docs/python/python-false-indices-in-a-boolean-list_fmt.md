...
> 原文: [https://www.geeksforgeeks.org/python-false-indices-in-a-boolean-list/](https://www.geeksforgeeks.org/python-false-indices-in-a-boolean-list/)
...
`enumerate()`可以用其值做散列索引的任务，加上列表理解可以让我们检查错误的值。
