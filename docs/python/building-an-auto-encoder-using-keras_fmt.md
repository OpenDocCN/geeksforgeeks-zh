...
> 原文: [https://www.geeksforgeeks.org/building-an-auto-encoder-using-keras/](https://www.geeksforgeeks.org/building-an-auto-encoder-using-keras/)
...
### 注意:
加载数据时，注意加载训练标签的空间保持为空，因为压缩过程不涉及输出标签。
