...
> 原文: [https://www.geeksforgeeks.org/python-api-followers_ids-in-tweepy/](https://www.geeksforgeeks.org/python-api-followers_ids-in-tweepy/)
...
> **语法:** `API.followers_ids(id/user_id/screen_name)`
>
> **参数:** 仅使用 3 个选项之一:
>
> *   `id`: 指定用户的 id 或屏幕名称。
