...
> 原文: [https://www.geeksforgeeks.org/mahotas-full-histogram-of-image/](https://www.geeksforgeeks.org/mahotas-full-histogram-of-image/)
...
> 为了做到这一点，我们将使用 `mahotas.fullhistogram` 方法
> **语法:** `mahotas.fullhistogram(img)`
> **参数:** 它以图像对象作为参数
> **返回:** 它返回 `np.uint32` 类型的数组
