...
> 原文: [https://www.geeksforgeeks.org/python-flatten-list-to-individual-elements/](https://www.geeksforgeeks.org/python-flatten-list-to-individual-elements/)
...
> 原列表为: ['gfg', 1, [5, 6, 'geeks'], 67.4, [5], 'best']
> 扁平化后的列表: ['gfg', 1, 5, 6, 'geeks', 67.4, 5, 'best']