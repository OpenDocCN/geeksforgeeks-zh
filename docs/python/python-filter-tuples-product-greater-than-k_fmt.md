...
> 原文: [https://www.geeksforgeeks.org/python-filter-tuples-product-greater-than-k/](https://www.geeksforgeeks.org/python-filter-tuples-product-greater-than-k/)
...
在这种情况下，过滤元组的任务使用 `filter()` 和 `lambda` 来完成，乘积以类似的方式计算。
