...
> 原文: [https://www.geeksforgeeks.org/python-extract-row-with-any-boolean-true/](https://www.geeksforgeeks.org/python-extract-row-with-any-boolean-true/)
...
> 原始列表为: `[[False, False], [True, True, True], [False, True], [False]]`
> 提取的行: `[[True, True, True], [False, True]]`
