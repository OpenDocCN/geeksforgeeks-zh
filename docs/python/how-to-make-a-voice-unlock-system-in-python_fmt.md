...
> 原文：[https://www.geeksforgeeks.org/how-to-make-a-voice-unlock-system-in-python/](https://www.geeksforgeeks.org/how-to-make-a-voice-unlock-system-in-python/)
...
现在使用 python 语音识别模块的 `Recognizer()` 功能从麦克风获取音频。这样，我们就从我们的系统中捕获了语音命令。
...
现在是使用 **谷歌语音识别引擎** 的时候了。注意这一点不用这个 API 你可以用自己的语音识别系统。你需要通过你的代码处理一些来自谷歌引擎的异常错误。
