...
> 原文: [https://www.geeksforgeeks.org/python-arcade-player-movement/](https://www.geeksforgeeks.org/python-arcade-player-movement/)
...
> **语法:** `arcade.draw_rectangle_filled(x, y, width, height, color, angle)`
>
> **参数:**
>
> *   `x`: 矩形中心的 x 坐标
...
> *   `on_key_release(symbol, modifier)`
>
> **参数:**
>
> *   `symbol`: 被击中的键
> *   `modifier`: 在此事件期间按下的所有修饰符(shift、ctrl、num lock)的按位“与”
