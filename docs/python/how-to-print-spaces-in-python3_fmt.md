...
> 原文：[https://www.geeksforgeeks.org/how-to-print-spaces-in-python3/](https://www.geeksforgeeks.org/how-to-print-spaces-in-python3/)

在本文中，我们将学习如何在 Python 编程语言中打印空格或多个空格。Python 语言中的间距比其他编程语言要简单的多。在 C 语言中，要打印 10 个空格，需要使用一个循环，而在 python 中，不使用循环来打印空格数。
