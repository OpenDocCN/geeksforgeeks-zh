...
> 原文：[https://www.geeksforgeeks.org/plot-multiple-separate-graphs-for-same-data-from-one-python-script/](https://www.geeksforgeeks.org/plot-multiple-separate-graphs-for-same-data-from-one-python-script/)
...
为了使图表更有创意，更容易找到图表中的定位数据，我们使用了 `chart_studio.plotly` 和 `cufflinks` 库。要使用这些库，安装方法也与上述库相同。
...
![散点图](img/5bdd1d89bc74f2bb6ad009352a4c0935.png)

### 直方图:

![直方图](img/f0865624eb80d2108e20d98b16f7402c.png)

### 箱线图:

![箱线图](img/ca55dbcffe4cd503d0d46557ffaa0ff7.png)