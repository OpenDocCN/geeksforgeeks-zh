...
> 原文: [https://www.geeksforgeeks.org/how-to-plot-bar-graph-in-python-using-csv-file/](https://www.geeksforgeeks.org/how-to-plot-bar-graph-in-python-using-csv-file/)
...
在这篇文章中，我们将学习如何使用 `CSV` 文件绘制条形图。有很多模块可以用来读取 `.csv` 文件，如 `csv`，`pandas` 等。但是在这篇文章中，我们将手动阅读 `.csv` 文件来了解事情是如何运作的。
