...
> 原文: [https://www.geeksforgeeks.org/python-decimal-number_class-method/](https://www.geeksforgeeks.org/python-decimal-number_class-method/)

`Decimal.number_class()`是一个`Decimal`类方法，返回`Decimal`值的类的指示。
