...
> 原文: [https://www.geeksforgeeks.org/object-oriented-programming-in-python-set-2-data-hiding-and-object-printing/](https://www.geeksforgeeks.org/object-oriented-programming-in-python-set-2-data-hiding-and-object-printing/)
...
在 Python 中，我们在属性名称前使用双下划线（`__`），这些属性在外部将不直接可见。
