# 如何在 Python 中安装 psycopg2 包？

> 原文：[https://www.geeksforgeeks.org/how-to-install-pyscopg2-package-in-python/](https://www.geeksforgeeks.org/how-to-install-pyscopg2-package-in-python/)

`psycopg2` 是 Python 编程语言最流行的 PostgreSQL 数据库适配器。它是一个符合数据库应用编程接口 2.0 的后回归 SQL 驱动程序，正在积极开发中。它是为创建和销毁大量游标并创建大量“INSERTs”或“UPDATEs”的多线程应用程序而设计的。
