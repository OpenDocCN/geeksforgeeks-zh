...
> 原文: [https://www.geeksforgeeks.org/python-create-a-digital-clock-using-tkinter/](https://www.geeksforgeeks.org/python-create-a-digital-clock-using-tkinter/)
...
## 使用 Label widget 和 time 模块

在下面的应用程序中，我们将使用 `Label` widget，并且还将使用 `time` 模块来检索系统的时间。
下面是实现：
