...
> 原文：[https://www.geeksforgeeks.org/get-silver-and-gold-price-in-tkinter-using-python/](https://www.geeksforgeeks.org/get-silver-and-gold-price-in-tkinter-using-python/)

**先决条件：** [`BeautifulSoup`](https://www.geeksforgeeks.org/implementing-web-scraping-python-beautiful-soup/) [`requests`](https://www.geeksforgeeks.org/python-requests-tutorial/) [`tkinter`](https://www.geeksforgeeks.org/python-gui-tkinter/) [`datetime`](https://www.geeksforgeeks.org/python-datetime-module-with-examples/)
...
*   `get_number_from_string():` 此函数用于从字符串中提取整数或浮点数。
*   `change_price():` 此功能用于获取特定重量的黄金或白银价格。
