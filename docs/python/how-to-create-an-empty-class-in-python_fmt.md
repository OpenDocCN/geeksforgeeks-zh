...
> 原文: [https://www.geeksforgeeks.org/how-to-create-an-empty-class-in-python/](https://www.geeksforgeeks.org/how-to-create-an-empty-class-in-python/)
...
```py
# Incorrect empty class in Python
class Geeks:
```
...
在 Python 中，要编写一个空类，需要使用`pass`语句。`pass`是 Python 中的一个特殊语句，不做任何事情。它只是作为一个伪语句工作。但是，也可以创建空类的对象。

**示例:**

```py
# Python program to demonstrate empty class
class Geeks:
    pass
