...
> 原文：[https://www.geeksforgeeks.org/convert-html-source-code-to-json-object-using-python/](https://www.geeksforgeeks.org/convert-html-source-code-to-json-object-using-python/)
...
> *   `xml_attribs` 如果设置为真，将包括属性。否则，如果设置为“假”，则忽略它们。
