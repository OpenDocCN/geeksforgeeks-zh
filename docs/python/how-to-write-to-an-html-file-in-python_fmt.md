...
> 原文：[https://www.geeksforgeeks.org/how-to-write-to-an-html-file-in-python/](https://www.geeksforgeeks.org/how-to-write-to-an-html-file-in-python/)
...
我们已经使用`python`中的一个简单函数成功地将输出数据保存到了一个`HTML`文件中。上述方法中的任何一种都可以用来获得期望的结果。