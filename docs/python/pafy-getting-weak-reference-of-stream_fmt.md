...
> 原文: [https://www.geeksforgeeks.org/pafy-getting-weak-reference-of-stream/](https://www.geeksforgeeks.org/pafy-getting-weak-reference-of-stream/)
...
我们可以在 `new()` 方法的帮助下获得 `pafy` 对象，在 `allstreams` 属性的帮助下，我们可以获得视频的所有可用流，下面是获取给定视频的 `pafy` 对象的命令。
