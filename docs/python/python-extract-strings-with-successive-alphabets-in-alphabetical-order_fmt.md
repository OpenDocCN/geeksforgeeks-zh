...
> 原文: [https://www.geeksforgeeks.org/python-extract-strings-with-successive-alphabets-in-alphabetical-order/](https://www.geeksforgeeks.org/python-extract-strings-with-successive-alphabets-in-alphabetical-order/)
...
在本例中，我们检查每个字符串是否包含前面字符的字母后继字符，ASCII 转换使用 `ord()` 完成。
