...
> 原文: [https://www.geeksforgeeks.org/creating-first-web-application-using-bottle-framework-python/](https://www.geeksforgeeks.org/creating-first-web-application-using-bottle-framework-python/)

Python 中有很多框架允许你创建一个像瓶子、Django 这样的网页。在本文中，您将学习如何使用 Bottle Web 框架创建一个简单的应用程序。Bottle 是一个快速、简单、轻量级的 Python WSGI 微网络框架。它是作为单个文件模块分发的，除了 Python 标准库之外没有其他依赖项。
