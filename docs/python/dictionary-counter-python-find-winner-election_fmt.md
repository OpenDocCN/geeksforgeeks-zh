...
> 原文: [https://www.geeksforgeeks.org/dictionary-counter-python-find-winner-election/](https://www.geeksforgeeks.org/dictionary-counter-python-find-winner-election/)
...
1.  使用 `Counter()` 方法将给定的投票列表转换为字典。我们将有一个字典，候选名称为**键**，它们的频率(计数)为**值**。
