...
> 原文：[https://www.geeksforgeeks.org/how-to-compress-images-using-python-and-pil/](https://www.geeksforgeeks.org/how-to-compress-images-using-python-and-pil/)
...
懂一点 Python 的可以安装 Python，在命令提示符下（终端为 Linux 用户）使用 `pip install` [`Pillow`](https://www.geeksforgeeks.org/python-pillow-a-fork-of-pil/) 来安装 Pillow（PIL 的一个分支）。
