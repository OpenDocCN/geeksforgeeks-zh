...
> 原文: [https://www.geeksforgeeks.org/python-api-mutes_ids-in-tweepy/](https://www.geeksforgeeks.org/python-api-mutes_ids-in-tweepy/)
...
使用 `mutes_ids()` 方法查找被认证用户静音的所有用户的用户标识。
