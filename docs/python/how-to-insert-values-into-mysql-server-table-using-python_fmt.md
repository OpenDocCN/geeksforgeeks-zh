...
> 原文: [https://www.geeksforgeeks.org/how-to-insert-values-into-mysql-server-table-using-python/](https://www.geeksforgeeks.org/how-to-insert-values-into-mysql-server-table-using-python/)
...
> **语法:** `INSERT INTO table_name (column_name) VALUES (ValuesOfRow);`
...
> **语法:** `INSERT INTO table_name (column_name) VALUES (ValuesOfRow1), (ValuesOfRow2), ..., (ValuesOfRowN);`
