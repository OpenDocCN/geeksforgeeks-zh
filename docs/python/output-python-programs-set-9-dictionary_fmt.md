...
> 原文: [https://www.geeksforgeeks.org/output-python-programs-set-9-dictionary/](https://www.geeksforgeeks.org/output-python-programs-set-9-dictionary/)
...
**解释:** 语句 `del dictionary;` 删除整个字典，因此迭代删除的字典会引发如下运行时错误:
...
**说明:** `dictionary1.update(dictionary2)` 用于用 `dictionary2` 的条目更新 `dictionary1` 的条目。如果两个字典中有相同的键，则使用第二个字典中的值。
