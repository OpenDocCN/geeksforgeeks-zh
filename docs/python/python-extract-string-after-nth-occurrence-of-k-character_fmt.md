...
> 原文: [https://www.geeksforgeeks.org/python-extract-string-after-nth-occurrence-of-k-character/](https://www.geeksforgeeks.org/python-extract-string-after-nth-occurrence-of-k-character/)

给定一个字符串，在第 n 次出现一个字符后提取该字符串。

> **输入**: `test_str = 'geekforgeeks'`，`K = 'e'`，`N = 2`
> **输出**: `kforgeks`
> **解释**: 第二次出现后，的“e”字符串被提取。
>
> **输入**: `test_str = 'geekforgeeks'`，`K = 'e'`，`N = 4`
> **输出**: `ks`
