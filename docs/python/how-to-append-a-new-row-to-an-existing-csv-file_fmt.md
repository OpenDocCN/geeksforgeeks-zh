...
> 原文：[https://www.geeksforgeeks.org/how-to-append-a-new-row-to-an-existing-csv-file/](https://www.geeksforgeeks.org/how-to-append-a-new-row-to-an-existing-csv-file/)
...
*   将字典作为参数传递给 `DictWriter` 的 `Writerow()` 函数(它会在 CSV 文件中添加一个新行)。
*   关闭文件对象
