...
> 原文: [https://www.geeksforgeeks.org/python-decimal-next_plus-method/](https://www.geeksforgeeks.org/python-decimal-next_plus-method/)

`Decimal.next_plus()`是一个`Decimal`类方法，返回大于`Decimal`值的最小可表示数。
