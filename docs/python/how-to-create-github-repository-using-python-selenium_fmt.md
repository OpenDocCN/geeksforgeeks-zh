...
> 原文: [https://www.geeksforgeeks.org/how-to-create-github-repository-using-python-selenium/](https://www.geeksforgeeks.org/how-to-create-github-repository-using-python-selenium/)

**先决条件:** [`selenium`](https://www.geeksforgeeks.org/selenium-python-tutorial/)
...
### 步骤 2: 创建 `github_repo()` 函数

使用以下参数创建 `github_repo()` 函数，以合适的参数访问用户 `github` 并执行所需的任务。
...
用驱动程序代码中合适的参数调用上述函数，创建 `GitHub` 存储库。
