...
> 原文：[https://www.geeksforgeeks.org/analysis-of-test-data-using-k-means-clustering-in-python/](https://www.geeksforgeeks.org/analysis-of-test-data-using-k-means-clustering-in-python/)

本文演示了使用 `OpenCV` 库对样本随机数据进行 [K 均值聚类](https://www.geeksforgeeks.org/k-means-clustering-introduction/)的示例。

## 先决条件
`Numpy`、`OpenCV`、`matplotlib`。

让我们首先使用 `matplotlib` 工具可视化具有多个特征的测试数据。
