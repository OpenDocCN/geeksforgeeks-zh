...
> 原文: [https://www.geeksforgeeks.org/mahotas-eccentricity-of-image/](https://www.geeksforgeeks.org/mahotas-eccentricity-of-image/)
...
> 为了做到这一点，我们将使用 `mahotas.features.eccentricity()` 方法
> **语法:** `mahotas.features.eccentricity(img)`
> **参数:** 它将图像对象作为参数
> **返回:** 它返回浮点值
