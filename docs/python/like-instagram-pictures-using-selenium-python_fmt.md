...
> 原文: [https://www.geeksforgeeks.org/like-instagram-pictures-using-selenium-python/](https://www.geeksforgeeks.org/like-instagram-pictures-using-selenium-python/)
...
> 3. 谷歌浏览器
> 4. 硒包 (`pip install selenium`)，bs4 包 (`pip install bs4`)
