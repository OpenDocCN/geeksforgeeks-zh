...
> 原文: [https://www.geeksforgeeks.org/how-to-create-a-text-input-box-with-pygame/](https://www.geeksforgeeks.org/how-to-create-a-text-input-box-with-pygame/)
...
| 功能 | 描述 |
| --- | --- |
| `clock.tick()` | 它用于在给定的秒内刷新帧 |
| `pygame.quit()` | 它是用来退出游戏的 |
| `pygame.init()` | 它用于初始化所有导入的模块 |
| `pygame.font.Font` | 从文件创建新的字体对象 |
