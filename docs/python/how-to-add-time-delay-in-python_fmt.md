...
> 原文: [https://www.geeksforgeeks.org/how-to-add-time-delay-in-python/](https://www.geeksforgeeks.org/how-to-add-time-delay-in-python/)

在本文中，我们将讨论如何在程序代码中引入或增加时间延迟。

## 时间延迟

*   为了在程序代码中增加时间延迟，我们使用了`time`模块中的`sleep()`函数。这是 Python 中的内置模块，我们不需要从外部安装。
