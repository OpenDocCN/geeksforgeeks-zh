...
> 原文：[https://www.geeksforgeeks.org/byte-objects-vs-string-python/](https://www.geeksforgeeks.org/byte-objects-vs-string-python/)
...
同样，解码是将**字节对象转换为字符串**的过程。使用 `decode()` 实现。一个字节串可以被解码成一个字符串，如果你知道是用哪种编码来编码的话。编码和解码是**逆**过程。
