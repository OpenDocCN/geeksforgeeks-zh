...
> 原文: [https://www.geeksforgeeks.org/convert-string-to-double-in-python3/](https://www.geeksforgeeks.org/convert-string-to-double-in-python3/)
...
因为我们只需要一个带有十进制数值的字符串，所以也可以使用这个方法。
