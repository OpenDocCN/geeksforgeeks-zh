# Tweepy 中的 API.destroy_mute() 方法

> 原文：[https://www.geeksforgeeks.org/python-api-destroy_mute-in-tweepy/](https://www.geeksforgeeks.org/python-api-destroy_mute-in-tweepy/)
...
> **语法：**`API.destroy_mute(id/screen_name/user_id)`
>
> **参数：**仅使用 3 个选项之一：
>
> *   `id`：指定用户的 id 或屏幕名称。
