...
> 原文: [https://www.geeksforgeeks.org/python-change-type-of-key-in-dictionary-list/](https://www.geeksforgeeks.org/python-change-type-of-key-in-dictionary-list/)
...
> 转换后的 Dictionary 列表: `[{'is': 56, 'gfg': 1, 'best': (1, 2)}, {'is': 12, 'gfg': 5, 'best': (6, 2)}, {'is': 789, 'gfg': 3, 'best': (7, 2)}]`
