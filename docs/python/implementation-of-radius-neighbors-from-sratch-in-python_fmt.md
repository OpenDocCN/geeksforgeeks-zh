...
> 原文：[https://www.geeksforgeeks.org/implementation-of-radius-neighbors-from-sratch-in-python/](https://www.geeksforgeeks.org/implementation-of-radius-neighbors-from-sratch-in-python/)
...
在上图中，“+”表示标记为 1 的训练实例。“-”表示带有 0 的训练实例。在这里，我们将测试实例 `xt` 分类为这个循环中训练实例中最常见的类。这里，`r` 是用户指定的选项。上图中，圆圈内正例居多，所以 `x^t` 归类为“+”或 1。
