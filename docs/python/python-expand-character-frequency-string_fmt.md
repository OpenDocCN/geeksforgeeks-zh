...
> 原文: [https://www.geeksforgeeks.org/python-expand-character-frequency-string/](https://www.geeksforgeeks.org/python-expand-character-frequency-string/)

给定一个字符串，哪个字符后跟它的频率，创建适当的字符串。

**示例:**

> **输入**: `test_str = 'g7f2g3i2s2b3e4'`
