...
> 原文: [https://www.geeksforgeeks.org/pyspark-count-distinct-from-dataframe/](https://www.geeksforgeeks.org/pyspark-count-distinct-from-dataframe/)
...
### 示例 1: 使用 Distinct().count() 将 Pyspark 计数与 DataFrame 区分开来
...
### 示例 1: 使用 CountDistinct() 将 Pyspark 计数与数据框区分开来
