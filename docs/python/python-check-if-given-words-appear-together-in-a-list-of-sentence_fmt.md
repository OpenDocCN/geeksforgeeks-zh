...
> 原文: [https://www.geeksforgeeks.org/python-check-if-given-words-appear-together-in-a-list-of-sentence/](https://www.geeksforgeeks.org/python-check-if-given-words-appear-together-in-a-list-of-sentence/)

给定一个句子`sentence`列表和一个单词`words`列表，编写一个 Python 程序来查找句子列表中的哪个句子由`words`中包含的所有单词组成，并在列表中返回它们。
