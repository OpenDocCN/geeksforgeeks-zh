...
> 原文: [https://www.geeksforgeeks.org/python-check-if-string-contain-only-defined-characters-using-regex/](https://www.geeksforgeeks.org/python-check-if-string-contain-only-defined-characters-using-regex/)

在本文中，我们将看到如何在 Python 中检查给定的字符串是否只包含特定的字符集。这些定义的字符将使用集合来表示。

### 示例:

> **输入:** ‘657’ 假设正则表达式包含以下字符 - `([78653])`
> **输出:** 有效
> **解释:** 输入字符串仅由给定字符串中的字符组成
>
> **输入:** ‘7606’ 假设正则表达式包含以下字符 - `([102])`
> **输出:** 无效
