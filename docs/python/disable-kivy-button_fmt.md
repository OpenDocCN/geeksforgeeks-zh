...
在这篇文章中，我们将学习如何禁用 Kivy 中的一个按钮。有些地方我们需要禁用按钮，所以在这篇文章中，你将学习如何做到这一点。

> [Kivy 教程——用例子学习 Kivy。](https://www.geeksforgeeks.org/kivy-tutorial/)

## 按钮与禁用属性

按钮是一个带有相关动作的标签，当按钮被按下（或在点击/触摸后被释放）时会被触发。我们可以在按钮后面添加功能，并为按钮设置样式。但是要禁用该按钮，我们有一个属性名：
...
> **注意:** `disabled` 属性在 1.8.0 版本中引入。如果你想使用它，你需要实现你的框架。
