...
> 原文：[`https://www.geeksforgeeks.org/c-strings-conversion-to-python/`](https://www.geeksforgeeks.org/c-strings-conversion-to-python/)
...
如果 `s` 是以其他已知的编码方式编码的，则使用 `PyUnicode_Decode()` 的字符串可以表示为:
