...
> 原文：[https://www.geeksforgeeks.org/facts-app-using-tkinter-module/](https://www.geeksforgeeks.org/facts-app-using-tkinter-module/)

这是一个应用程序，将为我们提供事实。有了 Python，我们可以让事情变得非常简单。我们有一个非常惊人的图书馆，这样我们就可以做它。

我们只需要两个库，如果我们把这个概念结合起来，我们就能做出新的东西。我们只需要使用 `tkinter` 和 `randfacts` 就可以做到这一点。
...
[https://media.geeksforgeeks.org/wp-content/uploads/20201115204925/factapp.mp4](https://media.geeksforgeeks.org/wp-content/uploads/20201115204925/factapp.mp4)