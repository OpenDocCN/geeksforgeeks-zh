...
> 原文: [https://www.geeksforgeeks.org/create-a-gui-to-check-domain-availability-using-tkinter/](https://www.geeksforgeeks.org/create-a-gui-to-check-domain-availability-using-tkinter/)

可能会有这样一种情况，用户想要创建一个网站，并对网站的名称有某些想法，但对它们的可用性感到惊讶。因此，让我们开发一个检查域可用性的图形用户界面。我们将使用 `python-whois` 模块获取该网站的相关信息。它能够提取所有流行顶级域名的数据。
