...
> 原文: [https://www.geeksforgeeks.org/python-arcade-handling-mouse-inputs/](https://www.geeksforgeeks.org/python-arcade-handling-mouse-inputs/)
...
> **语法:** `on_mouse_press(x, y, button, modifiers)`
>
> **参数:**
>
> *   `x` : x 坐标
> *   `y` : y 坐标
> *   `button`: 按下的按钮
> *   `modifiers`: 在此事件期间按下的所有修饰符(shift、ctrl、num lock)的按位“与”。
