# Python 中使用 Tkinter 的 place_forget() 方法

> 原文: [https://www.geeksforgeeks.org/place_forget-method-using-tkinter-in-python/](https://www.geeksforgeeks.org/place_forget-method-using-tkinter-in-python/)

要在 [`tkinter`](https://www.geeksforgeeks.org/python-gui-tkinter/) 中从父小部件或屏幕隐藏或忘记小部件，基于位置几何管理在该小部件上使用 `place_forget()` 方法。

> **语法**: `widget.place_forget()`
>
> **参数:** 无
>
> **返回:** 无
...
**注意:** 还有其他方法 `pack_forget()` 和 `grid_forget()` 的工作方式与 `place_forget()` 相同。