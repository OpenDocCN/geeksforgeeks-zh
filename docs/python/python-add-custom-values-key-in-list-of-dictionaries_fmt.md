...
> 原文: [https://www.geeksforgeeks.org/python-add-custom-values-key-in-list-of-dictionaries/](https://www.geeksforgeeks.org/python-add-custom-values-key-in-list-of-dictionaries/)

给定一个字典列表、自定义列表和关键字，将关键字按顺序添加到每个字典的列表值中。

> **输入**: `test_list = [{"Gfg": 6, "is": 9, "best": 10}, {"Gfg": 8, "is": 11, "best": 19}, {"Gfg": 2, "is": 16, "best": 10}]`, `K = "Geeks"`, `append_list = [6, 7, 4]`
> **输出**: `[{"Gfg": 6, "is": 9, "best": 10, "Geeks": 6}, {"Gfg": 8, "is": 10, ...}]`
>
> **输入**: `test_list = [{"Gfg": 6, "is": 9, "best": 10}]`, `K = "CS"`, `append_list = [6]`
