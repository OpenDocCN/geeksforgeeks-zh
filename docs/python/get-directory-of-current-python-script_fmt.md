...
> 原文: [https://www.geeksforgeeks.org/get-directory-of-current-python-script/](https://www.geeksforgeeks.org/get-directory-of-current-python-script/)
...
Python 提供 [`OS` 模块](https://www.geeksforgeeks.org/os-module-python-examples/)用于与操作系统交互。该模块属于 Python 的标准实用程序模块。在文件名和路径无效或不可访问的情况下，或者在其他具有正确类型但不被操作系统接受的参数的情况下，`OS` 模块中的所有函数都会引发 `OSError`。
