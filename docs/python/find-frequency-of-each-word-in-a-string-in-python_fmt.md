...
> 原文：[https://www.geeksforgeeks.org/find-frequency-of-each-word-in-a-string-in-python/](https://www.geeksforgeeks.org/find-frequency-of-each-word-in-a-string-in-python/)
...
2.  初始化一个新的空列表。
3.  如果新列表中没有该单词，现在将该单词追加到先前字符串的新列表中。
