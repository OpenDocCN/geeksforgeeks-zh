...
> 原文：[https://www.geeksforgeeks.org/data-classes-in-python-set-6-interconversion-to-and-from-other-datatypes/](https://www.geeksforgeeks.org/data-classes-in-python-set-6-interconversion-to-and-from-other-datatypes/)
...
在上述功能中，如果只提供 `cls_name`，则类型使用 `typing.Any`。`init`、`repr`、`eq`、`order`、`unsafe_hash`、`frozen` 的值与 [`dataclass()`](https://www.geeksforgeeks.org/data-classes-in-python-set-2-decorator-parameters/) 中的值含义相同。
