...
> 原文: [https://www.geeksforgeeks.org/python-decimal-is_subnormal-method/](https://www.geeksforgeeks.org/python-decimal-is_subnormal-method/)

`Decimal.is_subnormal()`是`Decimal`类方法，检查`Decimal`值是否低于正常值。
