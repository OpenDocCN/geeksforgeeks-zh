...
> 原文: [https://www.geeksforgeeks.org/python-convert-delimiter-separated-list-to-number/](https://www.geeksforgeeks.org/python-convert-delimiter-separated-list-to-number/)

给定一个带分隔符的字符串，去掉分隔符后连接成整数。

> **输入**: `test_str = "1 @ 6 @ 7 @ 8"`, `delim = "@"`
> **输出**: `1678`
> **解释**: 去掉 `delim` 后的连接元素 `"@"`
> **输入**: `test_str = "1！6!7!8"`, `delim = '！'`
> **输出**: `1678`
