...
> 原文: [https://www.geeksforgeeks.org/data-visualisation-with-chartify/](https://www.geeksforgeeks.org/data-visualisation-with-chartify/)
...
在这种情况下，数据清理和操作需要 `pandas`。让我们将这些导入到我们的 `Python` 代码中。建议使用 `Jupyter` 笔记本或 `Google Colab` 进行任何类型的数据可视化或分析。
