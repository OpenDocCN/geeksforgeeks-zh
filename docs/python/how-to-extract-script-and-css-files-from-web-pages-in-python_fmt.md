...
> 原文: [https://www.geeksforgeeks.org/how-to-extract-script-and-css-files-from-web-pages-in-python/](https://www.geeksforgeeks.org/how-to-extract-script-and-css-files-from-web-pages-in-python/)
...
*   `requests`: `requests`让你可以极其轻松地发送 HTTP/1.1 请求。该模块也没有内置 Python。
