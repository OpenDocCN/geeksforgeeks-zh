# Python–在 Tweepy 中的 `API.retweets_of_me()`

> 原文: [https://www.geeksforgeeks.org/python-api-retweets_of_me-in-tweepy/](https://www.geeksforgeeks.org/python-api-retweets_of_me-in-tweepy/)
...
使用带有 `count` 参数的 `retweets_of_me()` 方法仅获取指定数量的转发。
