...
> 原文: [https://www.geeksforgeeks.org/how-to-setup-conda-environment-with-jupyter-notebook/](https://www.geeksforgeeks.org/how-to-setup-conda-environment-with-jupyter-notebook/)
...
*   如果 jupyter 笔记本没有打开，会自动复制屏幕上显示的链接。链接看起来像 `localhost:8888/？代币` 或 `127.0.0.1:8888/？令牌` 并粘贴在任意浏览器的搜索栏上。
