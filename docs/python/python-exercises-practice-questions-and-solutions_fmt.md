...
> 原文：[https://www.geeksforgeeks.org/python-exercises-practice-questions-and-solutions/](https://www.geeksforgeeks.org/python-exercises-practice-questions-and-solutions/)
...
## [Python 列表练习](https://www.geeksforgeeks.org/python-list-exercise/)
...
## [Python 字符串练习](https://www.geeksforgeeks.org/python-string-exercise/)
...
## [Python 字典练习](https://www.geeksforgeeks.org/python-dictionary-exercise/)
...
## [Python 集合练习](https://www.geeksforgeeks.org/python-set-exercise/)
...
> > [集合上的更多程序](https://www.geeksforgeeks.org/python-set-exercise/)

## [Python 矩阵练习](https://www.geeksforgeeks.org/tag/python-matrix-program/)
...
## [Python Lambda 练习](https://www.geeksforgeeks.org/tag/python-lambda/)
...
*   [Python | 使用 lambda 查找斐波那契数列 up n](https://www.geeksforgeeks.org/python-find-fibonacci-series-upto-n-using-lambda/)
...
## [Python 图案打印练习](https://www.geeksforgeeks.org/tag/python-pattern-printing/)
...
*   [Python 程序使用 Regex 查找 IP 地址的类型](https://www.geeksforgeeks.org/python-program-to-find-the-type-of-ip-address-using-regex/)
...
*   [Python–使用正则表达式检查字符串是否只包含定义的字符](https://www.geeksforgeeks.org/python-check-if-string-contain-only-defined-characters-using-regex/)
*   [Python 程序使用正则表达式查找具有特定扩展名的文件](https://www.geeksforgeeks.org/python-program-to-find-files-having-a-particular-extension-using-regex/)
...
*   [使用堆栈检查给定字符串是否为回文](https://www.geeksforgeeks.org/check-whether-the-given-string-is-palindrome-using-stack/)
...
*   [使用 for 循环创建熊猫列](https://www.geeksforgeeks.org/create-a-pandas-column-using-for-loop/)
*   [从数组创建熊猫系列](https://www.geeksforgeeks.org/create-a-pandas-series-from-array/)
