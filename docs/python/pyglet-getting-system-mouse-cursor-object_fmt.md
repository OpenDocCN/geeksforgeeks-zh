...
> 原文: [https://www.geeksforgeeks.org/pyglet-getting-system-mouse-cursor-object/](https://www.geeksforgeeks.org/pyglet-getting-system-mouse-cursor-object/)
...
为了创建窗口，我们对窗口对象使用 `get_system_mouse_cursor` 方法。

**语法:**
`window.get_system_mouse_cursor(Cursor_name)`
