...
> 原文：[https://www.geeksforgeeks.org/cropping-an-image-in-a-circular-way-using-python/](https://www.geeksforgeeks.org/cropping-an-image-in-a-circular-way-using-python/)
...
`PIL.ImageDraw.Draw.pieslice(xy, 开始, 结束, 填充=无, 轮廓=无)`
