...
> 原文: [https://www.geeksforgeeks.org/generating-random-ids-using-uuid-python/](https://www.geeksforgeeks.org/generating-random-ids-using-uuid-python/)

我们已经讨论了在 python 中生成唯一标识的方法，而不使用任何 Python 内置库[在 Python 中生成随机标识](https://www.geeksforgeeks.org/generating-random-ids-python/)。在本文中，我们将使用内置函数来生成它们。
