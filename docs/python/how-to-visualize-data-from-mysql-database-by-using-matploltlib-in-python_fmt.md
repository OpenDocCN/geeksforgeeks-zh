# 如何使用 Python 中的 Matplotlib 可视化 MySQL 数据库中的数据？

> 原文: [https://www.geeksforgeeks.org/how-to-visualize-data-from-mysql-database-by-using-matploltlib-in-python/](https://www.geeksforgeeks.org/how-to-visualize-data-from-mysql-database-by-using-matploltlib-in-python/)

## 先决条件

Python 中的 [Matplotlib](https://www.geeksforgeeks.org/python-introduction-matplotlib/)、 [MySQL](https://www.geeksforgeeks.org/mysql-common-mysql-queries/)
...
在本文中，我们将讨论如何使用 Python 中的 `matplotlib` 可视化 MySQL 数据库中的数据。为了执行这个任务，我们只需要安装一个模块名 `mysqlconnector`，它可以通过使用
