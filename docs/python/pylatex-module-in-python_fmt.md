...
在这个例子中我们形成了一个简单的 latex 为了从 latex 中，我们使用了简单的输入格式就像我们在 LaTeX 中使用的一样。
...
*   从 pylatex 模块创建文档导入文档类。乳胶中有不同的文件类型:文章、报告、信件等。要创建文章类型的文档，请创建 latex 的 document 类的对象，并将“文章”作为参数传递。
