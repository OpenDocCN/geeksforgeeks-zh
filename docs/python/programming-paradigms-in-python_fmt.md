...
> 原文：[https://www.geeksforgeeks.org/programming-paradigms-in-python/](https://www.geeksforgeeks.org/programming-paradigms-in-python/)
...
更多信息请参考[Python 中的面向对象编程](https://www.geeksforgeeks.org/object-oriented-programming-in-python-set-1-class-and-its-members/)
...
更多信息请参考[Python 中的函数编程](https://www.geeksforgeeks.org/functional-programming-in-python/)