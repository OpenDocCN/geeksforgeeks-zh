...
> 原文: [https://www.geeksforgeeks.org/python-column-mapped-tuples-to-dictionary-items/](https://www.geeksforgeeks.org/python-column-mapped-tuples-to-dictionary-items/)

给定长度为 2 的元组矩阵，将每列的元素值映射到下一列，并构造字典键。

> **输入**: `test_list = [(1, 4), (6, 3), (4, 7)], [(7, 3), (10, 14), (11, 22)]`
> **输出**: `{1: 7, 4: 3, 6: 10, 3: 14, 4: 11, 7: 22}`
> **解释**: `1 -> 7`, `4 -> 3`... 如在同一列和索引中。
>
> **输入**: `test_list = [(1, 4), (6, 3)], [(7, 3), (10, 14)]`
