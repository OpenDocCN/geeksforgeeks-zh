...
> 原文: [https://www.geeksforgeeks.org/python-convert-string-to-matrix-having-k-characters-per-row/](https://www.geeksforgeeks.org/python-convert-string-to-matrix-having-k-characters-per-row/)

给定一个字符串，将其转换为矩阵，每行有 K 个字符。

> **输入** : `test_str = 'GeeksforGeeks is best'`，`K = 7`
> **输出** : `[['G', 'e', 'e', 'k', 's', 'f', 'o'], ['r', 'G', 'e', 'e', 'k', 's', ' '], ['i', 's', ' ', 'b', 'e', 's', 't']]`
