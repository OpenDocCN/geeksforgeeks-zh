...
> 原文：[https://www.geeksforgeeks.org/port-scanner-using-python-nmap/](https://www.geeksforgeeks.org/port-scanner-using-python-nmap/)
...
for i in range(begin, end+1):
    ...
    # the result is a dictionary containing several information
    # we only need to check if the port is opened or closed
