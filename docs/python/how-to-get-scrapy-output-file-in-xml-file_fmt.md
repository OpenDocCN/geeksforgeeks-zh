...
> 原文: [https://www.geeksforgeeks.org/how-to-get-scrapy-output-file-in-xml-file/](https://www.geeksforgeeks.org/how-to-get-scrapy-output-file-in-xml-file/)

前提: [用 Scrapy 在 Python 中实现网页抓取](https://www.geeksforgeeks.org/implementing-web-scraping-python-scrapy/)
...
一个名为 `corona.py` 的新文件被添加到 `spiders` 目录中。

![](img/92bcb77e5b429c277e1742d85934e729.png)

### 第三步: 对 `population.py` 进行以下更改
...
首先，我们将访问 `www.worldometers.info/world-population/population-by-country` 并禁用 `javascript`，如下所示
...
*   编写提取特定数据的代码。我们在 `spider` 的 `parse` 方法中编写了以下代码。
