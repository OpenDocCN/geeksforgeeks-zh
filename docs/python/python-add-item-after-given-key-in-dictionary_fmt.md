...
> 原文: [https://www.geeksforgeeks.org/python-add-item-after-given-key-in-dictionary/](https://www.geeksforgeeks.org/python-add-item-after-given-key-in-dictionary/)

给定一个字典和一个关键字，在字典中的某个关键字后添加新项。

> **输入**: `test_dict = {"Gfg": 3, "is": 5, "for": 8, "Geeks": 10}`, `K = "is"`, `add_item = {"good": 19}`
> **输出**: `{"Gfg": 3, "is": 5, "good": 19, "for": 8, "Geeks": 10}`
> **解释**: 字典中所需键后添加的项。
>
> **输入**: `test_dict = {"Gfg": 3, "is": 5, "for": 8, "Geeks": 10}`, `K = "for"`, `add_item = {"good": 19}`
> **输出**: `{"Gfg": 3, "is": 5, "for": 8, "good": 19, "Geeks": 10}`
> **解释**: 字典中所需键后添加的项。
