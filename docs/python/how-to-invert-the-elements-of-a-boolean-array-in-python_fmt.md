...
> 原文: [https://www.geeksforgeeks.org/how-to-invert-the-elements-of-a-boolean-array-in-python/](https://www.geeksforgeeks.org/how-to-invert-the-elements-of-a-boolean-array-in-python/)

给定一个布尔数组，这里的任务是反转它的元素。布尔数组是只包含布尔值如真或假、1 或 0 的数组。

> **输入:** `A=[True, True, False]`
> 
> **输出:** `A=[False, False, True]`
> 
> **输入:** `A=[0, 1, 0, 1]`
> 
> **输出:** `A=[1, 0, 1, 0]`
...
所以在布尔数组中对于 `True` 或 `1` 会得到 `-2`，对于 `False` 或 `0` 会得到 `-1`。再次使用 `if..else` 我们可以将数组转换成或所需的答案。
