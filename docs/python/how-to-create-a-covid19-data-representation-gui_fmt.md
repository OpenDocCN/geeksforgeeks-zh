...
> 原文：[https://www.geeksforgeeks.org/how-to-create-a-covid19-data-representation-gui/](https://www.geeksforgeeks.org/how-to-create-a-covid19-data-representation-gui/)
...
*   我们使用 `requests` 库从非官方 `api` 获取数据。
*   然后，我们显示我们需要的数据，在这种情况下，它的总活跃病例和确诊病例。
