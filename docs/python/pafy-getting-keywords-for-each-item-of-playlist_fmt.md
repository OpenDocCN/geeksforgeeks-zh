...
> 原文: [https://www.geeksforgeeks.org/pafy-getting-keywords-for-each-item-of-playlist/](https://www.geeksforgeeks.org/pafy-getting-keywords-for-each-item-of-playlist/)
...
6.  元数据使用 `"keywords"` 键，这将返回给定项目的持续时间。
