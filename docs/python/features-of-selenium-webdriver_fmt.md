...
> 原文: [https://www.geeksforgeeks.org/features-of-selenium-webdriver/](https://www.geeksforgeeks.org/features-of-selenium-webdriver/)
...
*   **无需安装** – `Selenium webdriver` 不需要安装服务器，测试脚本直接与浏览器交互。
