...
> 原文: [https://www.geeksforgeeks.org/python-extract-domain-name-from-email-address/](https://www.geeksforgeeks.org/python-extract-domain-name-from-email-address/)

给定一个字符串电子邮件地址，提取域名。

> **输入**: `test_str = 'manjeet@geeks.com'`
> **输出**: `geeks.com`
> **说明**: 域名，`geeks.com` 提取。
>
> **输入**: `test_str = 'manjeet@gfg.com'`
> **输出**: `gfg.com`
> **说明**: 域名，`gfg.com` 提取。
