...
> 原文: [https://www.geeksforgeeks.org/pyglet-getting-point-from-position-in-incremental-text-layout/](https://www.geeksforgeeks.org/pyglet-getting-point-from-position-in-incremental-text-layout/)
...
**语法:** `layout.get_point_from_position(pos)`
