...
> 原文：[https://www.geeksforgeeks.org/check-the-equality-of-integer-division-and-math-floor-of-regular-division-in-python/](https://www.geeksforgeeks.org/check-the-equality-of-integer-division-and-math-floor-of-regular-division-in-python/)
...
在上面的例子中，`floor division(//)`的输出是 89930901288686914，`math.floor`的输出是 89930901288686912。除了本例中的最后两位数字，即 14 和 12 之外，所有数字都相等。
