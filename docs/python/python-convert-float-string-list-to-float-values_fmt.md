...
> 原文: [https://www.geeksforgeeks.org/python-convert-float-string-list-to-float-values/](https://www.geeksforgeeks.org/python-convert-float-string-list-to-float-values/)
