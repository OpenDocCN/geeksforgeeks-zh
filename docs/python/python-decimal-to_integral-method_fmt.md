...
> 原文: [https://www.geeksforgeeks.org/python-decimal-to_integral-method/](https://www.geeksforgeeks.org/python-decimal-to_integral-method/)

`Decimal.to_integral()`是一个`Decimal`类方法，返回舍入的整数值。
