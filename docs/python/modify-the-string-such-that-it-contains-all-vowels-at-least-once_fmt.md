...
[https://www.geeksforgeeks.org/modify-the-string-such-that-it-contains-all-vowels-at-least-once/](https://www.geeksforgeeks.org/modify-the-string-such-that-it-contains-all-vowels-at-least-once/)
...
由于只有 5 个元音 `A`、`E`、`I`、`O`、`U` 所以，如果字符串长度小于 5 总是不可能的。
