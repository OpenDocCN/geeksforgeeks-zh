...
> 原文：[https://www.geeksforgeeks.org/create-html-user-interface-using-eel-in-python/](https://www.geeksforgeeks.org/create-html-user-interface-using-eel-in-python/)
...
包含这个库创建了一个可以用来与 Python 端通信的 `eel` 对象。Python 代码中任何用 `@eel.expose` 修饰的函数，这样暴露：
