...
> 原文: [https://www.geeksforgeeks.org/python-initialize-dictionary-keys-with-matrix/](https://www.geeksforgeeks.org/python-initialize-dictionary-keys-with-matrix/)
