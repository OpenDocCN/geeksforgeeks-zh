...
> 原文: [https://www.geeksforgeeks.org/pyglet-creating-file-location-2/](https://www.geeksforgeeks.org/pyglet-creating-file-location-2/)
...
> **语法:** `pyglet.resource.FileLocation(path)`
> **参数:** 以字符串为参数
> **返回:** 返回文件位置对象
