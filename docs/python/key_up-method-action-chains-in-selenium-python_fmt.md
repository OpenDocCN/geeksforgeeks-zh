...
> 原文: [https://www.geeksforgeeks.org/key_up-method-action-chains-in-selenium-python/](https://www.geeksforgeeks.org/key_up-method-action-chains-in-selenium-python/)
...
*   `element`: 发送密钥的元素。如果为 `None`，则向当前聚焦元素发送一个键。
