...
> 原文：[https://www.geeksforgeeks.org/formatted-string-literals-f-strings-python/](https://www.geeksforgeeks.org/formatted-string-literals-f-strings-python/)
...
**参考：** [PEP 498，文字串插值](https://www.python.org/dev/peps/pep-0498/)