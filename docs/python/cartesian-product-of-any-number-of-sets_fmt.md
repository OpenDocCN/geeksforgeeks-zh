...
> 原文：`https://www.geeksforgeeks.org/cartesian-product-of-any-number-of-sets/`
...
该方法是在开始时计算集-1 和集-2 的乘积，然后集-1 和集-2 的结果将具有集-3 的乘积，然后集-1、集-2、集-3 的结果将具有集-4 的笛卡尔乘积，以此类推，直到集-n。
下面是上述方法的实现。
