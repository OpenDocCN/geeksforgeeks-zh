...
> 原文: [https://www.geeksforgeeks.org/python-find-the-sum-of-length-of-strings-at-given-indices/](https://www.geeksforgeeks.org/python-find-the-sum-of-length-of-strings-at-given-indices/)

给定字符串列表，编写一个 Python 程序来计算列表自定义索引的长度总和。

**示例:**

> **输入**: `test_list = ["gfg", "is", "best", "for", "geeks"]`, `idx_list = [0, 1, 4]`
> **输出**: 10
> **解释**: 3 + 2 + 5 = 10。(idx 的字符串大小。)
>
> **输入**: `test_list = ["gfg", "is", "best", "for", "geeks"]`, `idx_list = [0, 2, 4]`
> **输出**: 12
> **解释**: 3 + 4 + 5 = 12。
