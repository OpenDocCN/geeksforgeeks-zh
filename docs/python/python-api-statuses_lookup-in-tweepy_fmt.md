# Python–Tweepy中的API.statuses_lookup()

> 原文:[https://www.geeksforgeeks.org/python-api-statuses_lookup-in-tweepy/](https://www.geeksforgeeks.org/python-api-statuses_lookup-in-tweepy/)
