# 用 `move_to_element_with_offset` 方法移动到元素 — Selenium Python 中的动作链

> 原文：[https://www.geeksforgeeks.org/move_to_element_with_offset-method-action-chains-in-selenium-python/](https://www.geeksforgeeks.org/move_to_element_with_offset-method-action-chains-in-selenium-python/)
...
演示一下，Selenium Python 的 `move_to_element_with_offset` 动作链方法。让我们访问 https://www.geeksforgeeks.org/，并对一个元素进行操作。
