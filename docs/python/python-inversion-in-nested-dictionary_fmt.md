...
> 原文: [https://www.geeksforgeeks.org/python-inversion-in-nested-dictionary/](https://www.geeksforgeeks.org/python-inversion-in-nested-dictionary/)

给定一个嵌套字典，执行键的反转，即最里面的嵌套变成最外面的，反之亦然。

> **输入** : `test_dict = {"a" : {"b" : {}, "d" : {"e" : {}, "f" : {"g" : {}}}}}`
> **输出**: `{ 'b': {'a': {}}, 'e': {'d': {}}, 'g': {'f': {}} }`
