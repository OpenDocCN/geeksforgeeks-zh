...
> 原文: [https://www.geeksforgeeks.org/python-integers-string-to-integer-list/](https://www.geeksforgeeks.org/python-integers-string-to-integer-list/)

给定一个整数字符串，由负数和正数组成，转换为整数列表。

> **输入**: `test_str = ' 4 5-3 2-100-2 '`
> **输出**: `[4, 5, -3, 2, -100, -2]`
> **解释**: 正负串数转换成整数列表。
>
> **输入**: `test_str = '-4-5-3 2-100-2 '`
