...
> 原文: [`https://www.geeksforgeeks.org/python-eliminate-capital-letter-starting-words-from-string/`](https://www.geeksforgeeks.org/python-eliminate-capital-letter-starting-words-from-string/)

有时，在使用 Python 字符串时，我们可能会遇到一个问题，需要删除所有以大写字母开头的单词。以大写字母开头的单词是专有名词，它们的出现对句子来说意味着不同的意思，有时可能是不受欢迎的。让我们讨论执行这项任务的某些方法。
