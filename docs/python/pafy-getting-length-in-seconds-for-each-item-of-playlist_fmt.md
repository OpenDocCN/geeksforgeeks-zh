...
> 原文: [https://www.geeksforgeeks.org/pafy-getting-length-in-seconds-for-each-item-of-playlist/](https://www.geeksforgeeks.org/pafy-getting-length-in-seconds-for-each-item-of-playlist/)
...
> 6. 使用 `"length_seconds"` 键返回给定项目的长度为秒
