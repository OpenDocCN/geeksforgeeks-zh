...
> 原文：[https://www.geeksforgeeks.org/implicit-waits-in-selenium-python/](https://www.geeksforgeeks.org/implicit-waits-in-selenium-python/)
...
定义的隐式等待将是使用驱动程序的 `implicitly_wait()` 方法设置的。让我们在 `https://www.geeksforgeeks.org/` 上实现它，并等待 10 秒钟再定位一个元素。
