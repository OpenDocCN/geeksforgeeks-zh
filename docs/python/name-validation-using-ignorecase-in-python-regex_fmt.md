...
> 原文: [https://www.geeksforgeeks.org/name-validation-using-ignorecase-in-python-regex/](https://www.geeksforgeeks.org/name-validation-using-ignorecase-in-python-regex/)
