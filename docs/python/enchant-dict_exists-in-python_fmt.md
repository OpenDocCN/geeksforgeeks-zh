# Enchant.dict_exists() 在 Python 中

> 原文: [https://www.geeksforgeeks.org/enchant-dict_exists-in-python/](https://www.geeksforgeeks.org/enchant-dict_exists-in-python/)
...
一个布尔值，如果字典存在则为真，如果不存在则为假。

### 示例 1：当 `enchant.dict_exists()` 返回 True 时
...
### 示例 2：当 `enchant.dict_exists()` 返回 False 时
