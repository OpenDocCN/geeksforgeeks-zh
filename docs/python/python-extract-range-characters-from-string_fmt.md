...
> 原文: [https://www.geeksforgeeks.org/python-extract-range-characters-from-string/](https://www.geeksforgeeks.org/python-extract-range-characters-from-string/)

给定一个字符串，只提取位于给定字母之间的字符。

> **输入**: `test_str = 'geekforgeeks is best'`, `strt`, `end = 'g', 's'`
> **输出**: `gkorgksis`
> **解释**: 保留 `g` 之后 `s` 之前的所有字符。
>
> **输入**: `test_str = 'geekforgeeks is best'`, `strt`, `end = 'g', 'r'`
> **输出**: `gkorgki`
