...
> 原文：[https://www.geeksforgeeks.org/python-k-length-consecutive-characters/](https://www.geeksforgeeks.org/python-k-length-consecutive-characters/)

给定一个字符串，提取所有 K 长度的连续字符。

> **输入**：`test_str = 'geekforgeekss is bbbbest forrr geeks'`，`K = 3`
> **输出**：`['eee', 'sss', 'bbb', 'rrr']`
> **解释**：提取 K 长度连续字符串。
>
> **输入**：`test_str = 'geekforgeekss is bbbbest forrrr geeks'`，`K = 4`
> **输出**：`['rrrr']`
> **解释**：提取 K 长度连续字符串。
