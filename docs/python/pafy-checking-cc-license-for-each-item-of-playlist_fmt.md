...
> 原文: [https://www.geeksforgeeks.org/pafy-checking-cc-license-for-each-item-of-playlist/](https://www.geeksforgeeks.org/pafy-checking-cc-license-for-each-item-of-playlist/)
...
1. 导入 pafy 模块
2. 借助播放列表的网址获取播放列表
3. 返回播放列表作为字典工作，因此在返回播放列表中使用“项目”作为关键字
