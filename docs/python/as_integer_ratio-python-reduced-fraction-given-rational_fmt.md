# 给定有理数的缩减分数：Python 中的 `as_integer_ratio()`

> 原文: [https://www.geeksforgeeks.org/as_integer_ratio-python-reduced-fraction-given-rational/](https://www.geeksforgeeks.org/as_integer_ratio-python-reduced-fraction-given-rational/)
