...
> 原文：[https://www.geeksforgeeks.org/moviepy-saving-a-frame-of-video-clip/](https://www.geeksforgeeks.org/moviepy-saving-a-frame-of-video-clip/)
...
>
> **语法：**`clip.save_frame("frame.png", t)`
>
> **参数：**以图像名称为参数，时间为可选参数
>
> **返回：**返回无
