...
> 原文：[https://www.geeksforgeeks.org/pafy-getting-comment-number-for-each-item-of-playlist/](https://www.geeksforgeeks.org/pafy-getting-comment-number-for-each-item-of-playlist/)
...
> 4. 将结果存储在变量中，并从项目中选择单个项目
> 5. 对于单个项目，使用“playlist_meta”键获取元数据
> 6. 对于元数据，使用“comments”键，这将返回给定项目的注释数量
