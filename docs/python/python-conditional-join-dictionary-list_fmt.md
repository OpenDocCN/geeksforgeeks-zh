...
> 原文: `https://www.geeksforgeeks.org/python-conditional-join-dictionary-list/`
...
> **输入:**
> `test_list1 = [{"gfg": 1, "is": 3, "best": 2}, {"gfg": 1, "best": 6}, {"all": 7, "best": 10}]`,
...
> **输入:**
> `test_list1 = [{"gfg": 1, "is": 3, "best": 3}, {"gfg": 1, "best": 6}, {"all": 7, "best": 10}]`,
> `test_list2 = [{"good": 4, "best": 2}, {"geeks": 2, "best": 3}, {"CS": 2, "best": 10}]`, `test_key = "best"`
>
...
>
> 原始列表 2 是: `[{'good': 4, 'best': 2}, {'geeks': 2, 'best': 3}, {'CS': 2, 'best': 10}]`
>
> 联接结果: `[{'gfg': 1, 'is': 3, 'best': 2, 'good': 4}, {'gfg': 1, 'best': 6}, {'all': 7, 'best': 10, 'CS': 2}]`