...
> 原文: [https://www.geeksforgeeks.org/access-metadata-of-various-audio-and-video-file-formats-using-python-tinytag-library/](https://www.geeksforgeeks.org/access-metadata-of-various-audio-and-video-file-formats-using-python-tinytag-library/)
...
您可以使用返回布尔值的方法 `TinyTag.is_supported(filename)` 来检查您正在使用的文件格式是否受支持。
