...
> 原文: [https://www.geeksforgeeks.org/how-to-calculate-mape-in-python/](https://www.geeksforgeeks.org/how-to-calculate-mape-in-python/)
...
| **第**天 | **实际销售额** | **预测销售额** | **绝对百分比误差(APE)** |
| --- | --- | --- | --- |
| one | One hundred and thirty-six | One hundred and thirty-four | Zero point zero one four |
| Two | One hundred and twenty | One hundred and twenty-four | Zero point zero three three |
...
如果你正在用 `python` 处理时间序列数据，你可能正在处理 `pandas` 或 `NumPy`。在这种情况下，您可以使用下面的代码来获得 `MAPE` 输出。
