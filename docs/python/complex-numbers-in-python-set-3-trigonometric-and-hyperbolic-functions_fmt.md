...
> 原文：[https://www.geeksforgeeks.org/complex-numbers-in-python-set-3-trigonometric-and-hyperbolic-functions/](https://www.geeksforgeeks.org/complex-numbers-in-python-set-3-trigonometric-and-hyperbolic-functions/)
...
### 4. `asinh()`
这个函数返回参数中传递的复数的反双曲正弦。

### 5. `acosh()`
这个函数返回参数中传递的复数的反双曲余弦。

### 6. `atanh()`
这个函数返回参数中传递的复数的反双曲正切。
