# Python API get_direct_message() 在 Tweepy 中

> 原文: [https://www.geeksforgeeks.org/python-api-get_direct_message-in-tweepy/](https://www.geeksforgeeks.org/python-api-get_direct_message-in-tweepy/)
...
> **语法:** `API.get_direct_message(id, full_text)`
>
> **参数:**
>
> *   `id` : 直接消息的 id。
