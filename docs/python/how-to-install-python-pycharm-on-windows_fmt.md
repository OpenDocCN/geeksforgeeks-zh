...
> 原文: [https://www.geeksforgeeks.org/how-to-install-python-pycharm-on-windows/](https://www.geeksforgeeks.org/how-to-install-python-pycharm-on-windows/)
...
在开始在 Windows 中安装 PyCharm 的过程之前，必须确保他们的系统上安装了 Python。检查系统是否配备 Python，进入**命令行**（在运行对话框中搜索 `cmd` (`Win` + `R`)）。
现在运行以下命令：
