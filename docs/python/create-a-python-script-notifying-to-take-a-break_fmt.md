...
> 原文: [https://www.geeksforgeeks.org/create-a-python-script-notifying-to-take-a-break/](https://www.geeksforgeeks.org/create-a-python-script-notifying-to-take-a-break/)
...
*   `plyer` – `plyer` 模块用于访问硬件的功能。这个模块没有内置 Python。我们需要从外部安装它。要安装此模块，请在终端中键入以下命令。
