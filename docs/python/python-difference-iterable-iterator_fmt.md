...
> 原文：[https://www.geeksforgeeks.org/python-difference-iterable-iterator/](https://www.geeksforgeeks.org/python-difference-iterable-iterator/)
...
**注意：** 如果`next(iterator_obj)`被再次调用，它将返回`StopIteration`。
