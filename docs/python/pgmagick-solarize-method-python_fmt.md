...
> 原文: [https://www.geeksforgeeks.org/pgmagick-solarize-method-python/](https://www.geeksforgeeks.org/pgmagick-solarize-method-python/)
...
> ```
> **参数:** 该函数接受单个参数 `thresholdLevel`，用于指定 0 到 100 之间的阈值水平。
> **返回值:** 该函数返回添加了图像的 `Pgmick` 对象。
