...
> 原文: [https://www.geeksforgeeks.org/get-yesterdays-date-using-python/](https://www.geeksforgeeks.org/get-yesterdays-date-using-python/)
...
为了处理日期，`datetime` 模块提供了 `date` 类，`timedelta` 类用于计算日期差异。让我们看看他们。
