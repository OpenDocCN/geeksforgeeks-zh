...
> 原文：[https://www.geeksforgeeks.org/directed-graphs-multigraphs-and-visualization-in-networkx/](https://www.geeksforgeeks.org/directed-graphs-multigraphs-and-visualization-in-networkx/)
...
网络允许我们创建有向和无向多重图。多重图是多个平行边可以连接相同节点的图。
