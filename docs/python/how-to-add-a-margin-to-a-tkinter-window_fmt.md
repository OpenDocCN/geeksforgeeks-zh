...
> 原文：[https://www.geeksforgeeks.org/how-to-add-a-margin-to-a-tkinter-window/](https://www.geeksforgeeks.org/how-to-add-a-margin-to-a-tkinter-window/)
...
通过使用本模块的 `frame()` 方法。使用 `frame()` 时，我们使用 `pack()` 函数放置内容并创建边距。
