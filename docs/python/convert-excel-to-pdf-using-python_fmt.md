...
> 原文: [https://www.geeksforgeeks.org/convert-excel-to-pdf-using-python/](https://www.geeksforgeeks.org/convert-excel-to-pdf-using-python/)
...
*   然后我们将阅读 Excel 文件，传递“Excel.Application”给 `Dispatch` 方法。
*   传递 Excel 文件路径。
