...
> 原文：[https://www.geeksforgeeks.org/how-to-hide-the-colorbar-and-legend-in-plotly-express/](https://www.geeksforgeeks.org/how-to-hide-the-colorbar-and-legend-in-plotly-express/)
...
在这个例子中，我们借助于方法在 Plotly Express 中隐藏颜色条。
...
在这个例子中，我们借助于方法在 Plotly Express 中隐藏图例。
...
在本例中，我们借助方法 `fig.update(layout_showlegend=False)` 和 `fig.update(layout_coloraxis_showscale=False)`，在 Plotly Express 中同时隐藏图例和色标。
