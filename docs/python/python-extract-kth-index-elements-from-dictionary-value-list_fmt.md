# Python–从字典值列表中提取第Kth个索引元素

> 原文: [https://www.geeksforgeeks.org/python-extract-kth-index-elements-from-dictionary-value-list/](https://www.geeksforgeeks.org/python-extract-kth-index-elements-from-dictionary-value-list/)

给定一个以列表为值的字典，提取所有的Kth索引元素。

> **输入**: `{“Gfg”:[4，7，5]，“Best”:[8，6，7]，“is”:[9，3，8]}`，`K = 2`
> **输出**: `[5，7，8]`
> **解释**: 第2个索引元素在不同的键中分别为5，7，8。
>
> **输入**: `{“Gfg”:[4，7，5]，“Best”:[8，6，7]，“is”:[9，3，8]}`，`K = 0`
> **输出**: `[4，8，9]`
> **解释**: 第0个索引元素在不同的键中分别为4，8，9。
