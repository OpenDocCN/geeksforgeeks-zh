...
> 原文：[https://www.geeksforgeeks.org/how-to-do-math-in-python-3-with-operators/](https://www.geeksforgeeks.org/how-to-do-math-in-python-3-with-operators/)
...
|   | `*` | 乘法 | `x * y` | 在两个操作数之间使用“*”运算符相乘 |
|   | `/` | 除法 | `x / y` | 使用“/”运算符将左操作数与右操作数相除 |
|   | `//` | 地板除 | `x // y` | 使用“//”运算符将左操作数与右操作数相除并提供唯一的商作为输出 |
|   | `**` | 幂运算 | `x ** y` | `x` 的幂(幂)到 `y` 的幂 |
|   | `%` | 取模 | `x % y` | 使用“%”运算符将左操作数与右操作数相除并提供唯一的余数作为输出 |
