...
> 原文：`https://www.geeksforgeeks.org/python-decimal-is_normal-method/`

`Decimal.is_normal()`是`Decimal`类方法，检查`Decimal`值是否为正常的有限数。
...
## 返回
`true` – 如果十进制值是正常的有限数字；否则为假

## 代码示例 1：is_normal()方法示例
