...
> 原文: [https://www.geeksforgeeks.org/python-check-substring-present-given-string/](https://www.geeksforgeeks.org/python-check-substring-present-given-string/)
...
我们可以迭代检查每个单词，但是 Python 为我们提供了一个内置函数 `find()`，它检查字符串中是否存在子字符串，这是在一行中完成的。
