...
> 原文: [https://www.geeksforgeeks.org/basics-of-discrete-event-simulation-using-simpy/](https://www.geeksforgeeks.org/basics-of-discrete-event-simulation-using-simpy/)
...
如果函数有一个 `return` 语句，那么即使在多次函数调用中，它也会返回相同的值。例如：
