...
> 原文: [https://www.geeksforgeeks.org/download-and-install-python-3-latest-version/](https://www.geeksforgeeks.org/download-and-install-python-3-latest-version/)
...
*   首先，打开浏览器，访问 [https://www.python.org/downloads/windows/](https://www.python.org/downloads/windows/)。
...
*   在此页面移动到 **Files**，根据您的系统点击 **Windows x86-64 executable installer**（64位）或 **Windows x86 executable installer**（32位）。
...
*   从下载文件夹运行 Python 安装程序。
    ![how to install python on windows](img/b872c4d0541e3d51e57a42804c044a6c.png)
...
*   首先，打开浏览器，打开 [https://www.python.org/downloads/source/](https://www.python.org/downloads/source/)
    ![how-to-install-python-on-linux-1](img/d470fc8ae7a0a537e055c7d83609252a.png)
*   在 **Stable Releases** 下找到 **Download Gzipped source tarball**（目前最新的稳定版本是 Python 3.7.4）。
...
现在我们都准备好打开从 python 官网下载的文件，使用终端中的 `cd` 命令移动到下载目录，然后输入以下命令：
...
要从应用程序->实用程序安装 python，简单的打开终端应用程序，并输入以下命令：
...
在 iOS 平台上，可以使用应用商店的各种应用安装 Python。最受欢迎的应用之一是 [Pythonista](http://omz-software.com/pythonista/)。Python 是一个完整的开发环境，用于在您的 iPad 或 iPhone 上编写 Python 脚本。包括了很多例子——从游戏和动画到绘图、图像处理、自定义用户界面和自动化脚本。
