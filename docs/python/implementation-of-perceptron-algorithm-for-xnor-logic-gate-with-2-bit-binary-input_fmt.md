...
> 原文：[https://www.geeksforgeeks.org/implementation-of-perceptron-algorithm-for-xnor-logic-gate-with-2-bit-binary-input/](https://www.geeksforgeeks.org/implementation-of-perceptron-algorithm-for-xnor-logic-gate-with-2-bit-binary-input/)
...
### Step1
对于输入向量![$\boldsymbol{x} : (\boldsymbol{x_{1}}, \boldsymbol{x_{2}})$](img/29110e5e151bd1672384d8ad571650b1.png "Rendered by QuickLaTeX.com")到 OR 和 AND 节点的对应权重向量![$\boldsymbol{w} : (\boldsymbol{w_{1}}, \boldsymbol{w_{2}})$](img/094e9945bcbef60421988602f7f77a3c.png "Rendered by QuickLaTeX.com")，相关的感知器函数可以定义为：
...
### Step2
来自 OR 节点的输出![($\boldsymbol{\hat{y}}_{1}$)](img/cdec6c73f988c5d4a519b1fc000c4414.png "Rendered by QuickLaTeX.com")将作为输入传递给 NOT 节点，其权重为![$\boldsymbol{w_{NOT}}$](img/4e10403d8f76f7b9024a360a4ecb58fa.png "Rendered by QuickLaTeX.com")，相关的感知器函数可以定义为：
...
### Step3
来自 AND 节点的输出![($\boldsymbol{\hat{y}}_{2}$)](img/f2fff49e8f3cf5395c51659e7c3c8472.png "Rendered by QuickLaTeX.com")和来自 NOT 节点的输出![($\boldsymbol{\hat{y}}_{3}$)](img/bc9502cbc54f7957d54d1068608b0e6c.png "Rendered by QuickLaTeX.com")（如 Step2 所述）将作为输入传递给 OR 节点，其权重为![$(\boldsymbol{w_{OR1}}, \boldsymbol{w_{OR2}})$](img/2baab9f293ea8c00cf2608b18badf2c2.png "Rendered by QuickLaTeX.com")。然后，相应的输出![$\boldsymbol{\hat{y}}$](img/a6e8955385eea2eb103e7a07d209a00c.png "Rendered by QuickLaTeX.com")就是 XNOR 逻辑函数的最终输出。相关的感知器函数可以定义为：
