...
> **输入 ：** [`datetime(2019, 12, 30)`, `datetime(2019, 12, 31)`, `datetime(2020, 1, 1)`, `datetime(2020, 1, 2)`, `datetime(2020, 1, 3)`, `datetime(2020, 1, 4)`]
> 
> **输出:**真
> 
> **说明:**所有日期均为连续，从 2019 年 12 月 30 日至 2020 年 1 月 4 日。
> 
> **输入 ：** [`datetime(2019, 12, 29)`, `datetime(2019, 12, 31)`, `datetime(2020, 1, 1)`, `datetime(2020, 1, 2)`, `datetime(2020, 1, 3)`, `datetime(2020, 1, 4)`]
> 
> **输出:**假
> 
> **说明:**非连续日期。

**方法#1:使用`天()`+ [`循环`](https://www.geeksforgeeks.org/loops-in-python/)**

在本例中，我们通过使用`天数()`检查与前一个日期的天数差异来检查连续日期。所有日期的迭代都是使用循环完成的。
...
**方法 2:使用[`all()`](https://www.geeksforgeeks.org/any-all-in-python/)+`天()`**
