...
> 原文：[https://www.geeksforgeeks.org/find-the-most-repeated-word-in-a-text-file/](https://www.geeksforgeeks.org/find-the-most-repeated-word-in-a-text-file/)
...
我们在 Python 中操作 `.txt` 文件。通过这个程序，我们会找到一个文件中重复次数最多的单词。
