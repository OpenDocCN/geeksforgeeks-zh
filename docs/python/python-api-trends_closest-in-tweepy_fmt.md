# Python–API.trends_closest() 在 Tweepy 中

> 原文: [https://www.geeksforgeeks.org/python-api-trends_closest-in-tweepy/](https://www.geeksforgeeks.org/python-api-trends_closest-in-tweepy/)
...
> **语法:** `API.trends_closest(lat, long)`
>
> **参数:**
>
> *   `lat`: 位置的纬度。
