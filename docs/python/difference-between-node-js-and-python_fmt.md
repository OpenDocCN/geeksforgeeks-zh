...
> 原文：[https://www.geeksforgeeks.org/difference-between-node-js-and-python/](https://www.geeksforgeeks.org/difference-between-node-js-and-python/)
...
*   基于 JSON 的应用程序接口
*   制作一个 REST 应用编程接口服务器
*   网络应用程序(如网络服务器，类似于 PHP、Java 或 ASP.NET)
