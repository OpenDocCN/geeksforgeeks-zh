...
> 原文: [https://www.geeksforgeeks.org/encrypt-and-decrypt-pdf-using-pypdf2/](https://www.geeksforgeeks.org/encrypt-and-decrypt-pdf-using-pypdf2/)
...
所以，这是一个加密和解密 PDF 文件的基本脚本。但是有太多的想法来扩展这一点。您可以创建一个图形用户界面工具来实现它，或者开发一个网络应用程序来加密 PDF 文件。您也可以使用 `PyPDF2` 库创建一个完整的 PDF 管理器。