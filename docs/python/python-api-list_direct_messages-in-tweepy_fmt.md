...
> 原文: [https://www.geeksforgeeks.org/python-api-list_direct_messages-in-tweepy/](https://www.geeksforgeeks.org/python-api-list_direct_messages-in-tweepy/)
...
`API.list_direct_messages(count)`
