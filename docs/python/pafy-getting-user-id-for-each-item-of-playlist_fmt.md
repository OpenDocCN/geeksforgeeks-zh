...
> 原文：[`https://www.geeksforgeeks.org/pafy-getting-user-id-for-each-item-of-playlist/`](https://www.geeksforgeeks.org/pafy-getting-user-id-for-each-item-of-playlist/)
...
> 6. 元数据使用 `'user_id'` 键，这将返回给定项目的用户标识
