...
> 原文: [https://www.geeksforgeeks.org/python-filter-rows-without-space-strings/](https://www.geeksforgeeks.org/python-filter-rows-without-space-strings/)

给定矩阵，提取字符串中没有空格的行。

**示例:**

> **输入**: `test_list = [["gfg is", "best"], ["gfg", "good"], ["gfg is cool"], ["love", "gfg"]]`
> **输出**: `[['gfg', 'good'], ['love', 'gfg']]`
> **解释**: 两个列表都有字符串没有空格。
>
> **输入**: `test_list = [["gfg is", "best"], ["gfg", "good"], ["gfg is cool"], ["love", "gfg"]]`
> **输出**: `[['love', 'gfg']]`
...
### 方法 2: 使用`filter()` + `lambda` + `any()` + `regex`
