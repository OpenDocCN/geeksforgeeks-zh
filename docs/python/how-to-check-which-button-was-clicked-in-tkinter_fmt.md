...
> 原文: [https://www.geeksforgeeks.org/how-to-check-which-button-was-clicked-in-tkinter/](https://www.geeksforgeeks.org/how-to-check-which-button-was-clicked-in-tkinter/)
...
**步骤 4:** 进一步，通过调用您在步骤 3 中声明的 `which_button` 函数来创建和显示第一个按钮。
...
**第 6 步:** 接下来，继续重复第 4 步和第 5 步 `n` 个按钮，将 `n` 替换为您希望它在应用程序上显示的按钮数量。不要忘记调用您在步骤 3 中声明的 `which_button` 函数。
