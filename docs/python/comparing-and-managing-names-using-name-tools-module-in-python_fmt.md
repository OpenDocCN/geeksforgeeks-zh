...
> 原文: [https://www.geeksforgeeks.org/comparing-and-managing-names-using-name-tools-module-in-python/](https://www.geeksforgeeks.org/comparing-and-managing-names-using-name-tools-module-in-python/)

在处理文档时，我们可能会遇到需要处理名称的问题。本文讨论的 `name_tools` 库可以帮助执行此任务。它可以用来管理和比较姓名。它目前包括英语和西式名称。
