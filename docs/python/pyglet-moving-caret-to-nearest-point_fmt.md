...
> 原文: [https://www.geeksforgeeks.org/pyglet-moving-caret-to-nearest-point/](https://www.geeksforgeeks.org/pyglet-moving-caret-to-nearest-point/)
...
> 为了创建窗口，我们对插入符号对象
> **使用 `move_to_point` 方法语法:** `caret.move_to_point(x, y)`
> **参数:** 它采用两个整数作为参数
> **返回:** 它返回 `None`
...
[https://media.geeksforgeeks.org/wp-content/uploads/20200908023359/Geeksforgeeks-2020-09-08-02-33-33.mp4](https://media.geeksforgeeks.org/wp-content/uploads/20200908023359/Geeksforgeeks-2020-09-08-02-33-33.mp4)