...
> 原文: [https://www.geeksforgeeks.org/create-and-save-animated-gif-with-python-pillow/](https://www.geeksforgeeks.org/create-and-save-animated-gif-with-python-pillow/)
...
### 步骤 2
在我们输入圆的值后，创建一个列表。`(0,255, 0)`是绿色的色码，`(255, 0, 0)`是红色的色码。
