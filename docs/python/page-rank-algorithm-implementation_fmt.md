...
> 原文：[https://www.geeksforgeeks.org/page-rank-algorithm-implementation/](https://www.geeksforgeeks.org/page-rank-algorithm-implementation/)
...
![PR(A)={\frac {PR(B)}{L(B)}}+{\frac {PR(C)}{L(C)}}+{\frac {PR(D)}{L(D)}}.\,  ](img/4ff89cba2e11f33592fc564563910fc5.png "Rendered by QuickLaTeX.com")
...
本文由 `贾扬特`（[https://in.linkedin.com/in/jayant-bisht-978085114](https://in.linkedin.com/in/jayant-bisht-978085114)）供稿。如果你喜欢 `GeeksforGeeks` 并想投稿，你也可以使用 [write.geeksforgeeks.org](https://write.geeksforgeeks.org) 写一篇文章或者把你的文章邮寄到 `review-team@geeksforgeeks.org`。看到你的文章出现在极客博客主页上，帮助其他极客。
