## Python：将每个数字的出现次数添加为子列表

> 原文：[https://www.geeksforgeeks.org/python-add-the-occurrence-of-each-number-as-sublists/](https://www.geeksforgeeks.org/python-add-the-occurrence-of-each-number-as-sublists/)
