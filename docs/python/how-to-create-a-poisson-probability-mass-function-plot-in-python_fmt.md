...
> 原文: [https://www.geeksforgeeks.org/how-to-create-a-poisson-probability-mass-function-plot-in-python/](https://www.geeksforgeeks.org/how-to-create-a-poisson-probability-mass-function-plot-in-python/)
...
> 为了得到 Python 中的泊松概率质量函数图，我们使用了 `scipy` 的 `poisson.pmf` 方法。
