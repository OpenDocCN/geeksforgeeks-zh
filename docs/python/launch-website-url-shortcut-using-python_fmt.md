...
> 原文: [https://www.geeksforgeeks.org/launch-website-url-shortcut-using-python/](https://www.geeksforgeeks.org/launch-website-url-shortcut-using-python/)

在这篇文章中，我们将使用快捷方式启动您喜欢的网站，为此，我们将使用 Python 的 `sqlite3` 和 `webbrowser` 模块使用快捷方式启动您喜欢的网站。
