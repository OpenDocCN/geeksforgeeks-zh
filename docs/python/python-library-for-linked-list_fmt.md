...
> 原文: [https://www.geeksforgeeks.org/python-library-for-linked-list/](https://www.geeksforgeeks.org/python-library-for-linked-list/)
...
### 方法 3: 使用 `structlinks` 包

`structlinks` 用于轻松访问和可视化不同的数据结构，包括链表、双链表、二叉树、图、栈和队列。

`structlinks.LinkedList` 和 `structlinks.DoublyLinkedList` 模块可以用来制作链表。所有可以用列表执行的操作也可以用 `structlinks.LinkedList` 类。

访问 [文档](https://eeshannarula29.github.io/structlinks/)
