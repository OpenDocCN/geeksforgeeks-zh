...
> 原文: [https://www.geeksforgeeks.org/pyglet-getting-position-on-line-in-incremental-text-layout/](https://www.geeksforgeeks.org/pyglet-getting-position-on-line-in-incremental-text-layout/)
...
>
> **语法:** `layout.get_position_on_line(line, x)`
>
> **自变量:** 取两个整数作为自变量
>
> **返回:** 返回整数
