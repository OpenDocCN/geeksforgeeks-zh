...
> 原文: [https://www.geeksforgeeks.org/create-a-gui-to-search-bank-information-with-ifsc-code-using-python/](https://www.geeksforgeeks.org/create-a-gui-to-search-bank-information-with-ifsc-code-using-python/)
...
`requests` 可以让你极其轻松的发送 HTTP/1.1 请求。这不是 Python 内置的，因此必须显式安装。
...
用 IFSC 码搜索银行明细的 GUI 应用 : 概念与上述实现类似
