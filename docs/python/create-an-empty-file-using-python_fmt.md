...
> 原文：[https://www.geeksforgeeks.org/create-an-empty-file-using-python/](https://www.geeksforgeeks.org/create-an-empty-file-using-python/)
...
在此示例中，我们将创建一个新文件`myfile.txt`。为了验证这一点，我们将使用 [`os`](https://www.geeksforgeeks.org/os-module-python-examples/) 模块的 [`os.listdir()`](https://www.geeksforgeeks.org/python-os-listdir-method/) 方法列出创建新文件前后的目录。
...
在指定位置创建新文件。使用 [`os`](https://www.geeksforgeeks.org/os-module-python-examples/) 模块在指定位置创建文件。下面是实现。
