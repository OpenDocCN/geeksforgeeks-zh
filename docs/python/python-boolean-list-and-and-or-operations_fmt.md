...
> 原文：[https://www.geeksforgeeks.org/python-boolean-list-and-and-or-operations/](https://www.geeksforgeeks.org/python-boolean-list-and-and-or-operations/)

有时，在使用Python列表时，我们可能会遇到一个问题，即我们有一个布尔列表，我们需要找到其中所有元素的布尔“与”或“或”。这类问题在数据科学领域有应用。让我们讨论一个简单的方法来解决这两个任务。
