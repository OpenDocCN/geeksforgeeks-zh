...
> 原文: [https://www.geeksforgeeks.org/build-fuel-price-tracker-using-python/](https://www.geeksforgeeks.org/build-fuel-price-tracker-using-python/)
...
### 第四步: 现在，用 `soup.find_all()` 搜索你需要的数据。
