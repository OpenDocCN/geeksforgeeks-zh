...
> 原文: [https://www.geeksforgeeks.org/ipl-score-prediction-using-deep-learning/](https://www.geeksforgeeks.org/ipl-score-prediction-using-deep-learning/)
...
我们使用 `pandas` 的 `read_csv()` 方法读入数据帧，并显示每个数据集的前 5 行。我们对数据集做了一些修改，比如增加了一个名为“y”的新列，该列记录了该局前 6 轮的得分。
