...
> 原文: [https://www.geeksforgeeks.org/mahotas-riddler-calvard-method/](https://www.geeksforgeeks.org/mahotas-riddler-calvard-method/)
...
为了过滤图像，我们将获取 `numpy.ndarray` 的 `image` 对象，并在索引的帮助下过滤它，下面是这样做的命令
