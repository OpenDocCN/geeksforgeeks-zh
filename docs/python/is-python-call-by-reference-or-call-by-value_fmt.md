...
> 原文: [https://www.geeksforgeeks.org/is-python-call-by-reference-or-call-by-value/](https://www.geeksforgeeks.org/is-python-call-by-reference-or-call-by-value/)
...
在 python 中，我们赋予值/容器的每个变量都被视为一个对象。当我们给一个变量赋值时，我们实际上是把一个名字绑定到一个对象上。
