...
> 原文: [https://www.geeksforgeeks.org/python-extract-rear-k-digits-from-numbers/](https://www.geeksforgeeks.org/python-extract-rear-k-digits-from-numbers/)
...
> **解释**: 提取后 2 位数字。
>
> **输入**: `test_list = [5645, 23567, 34543, 87652, 2342]`, `K = 4`
