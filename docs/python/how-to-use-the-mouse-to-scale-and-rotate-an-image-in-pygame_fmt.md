...
> 原文: [https://www.geeksforgeeks.org/how-to-use-the-mouse-to-scale-and-rotate-an-image-in-pygame/](https://www.geeksforgeeks.org/how-to-use-the-mouse-to-scale-and-rotate-an-image-in-pygame/)
...
### 第 12 步：稍后，画出 [`长方形`](https://www.geeksforgeeks.org/how-to-draw-rectangle-in-pygame/)、[`线条`](http://www.pygame.org/docs/ref/draw.html#pygame.draw.line) 和 [`圆圈`](http://www.pygame.org/docs/ref/draw.html#pygame.draw.circle)，这将有助于移动图像。
