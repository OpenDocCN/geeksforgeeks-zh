...
> 原文: [https://www.geeksforgeeks.org/python-imdbpy-getting-series-run-times-as-xml/](https://www.geeksforgeeks.org/python-imdbpy-getting-series-run-times-as-xml/)
...
2.  创建一个 `IMDb` 实例
3.  借助系列 ID 获取系列对象
4.  通过在 `runtimes` 关键字的帮助下将序列对象转换为 XML，在这里获取 XML 格式值，它将是字符串
...
<runtimes infoset="main"><item>50</item></runtimes>
```
