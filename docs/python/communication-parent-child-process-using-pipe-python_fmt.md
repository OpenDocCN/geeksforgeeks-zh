...
> 原文：[https://www.geeksforgeeks.org/communication-parent-child-process-using-pipe-python/](https://www.geeksforgeeks.org/communication-parent-child-process-using-pipe-python/)

## 先决条件
[在 Python 中创建子进程](https://www.geeksforgeeks.org/creating-child-process-using-fork-python/)
...
## 系统调用
### `pipe()` 系统调用
[`pipe()` 系统调用:](https://www.geeksforgeeks.org/pipe-system-call/) 方法 `pipe()` 创建一个管道，并返回一对分别可用于读写的文件描述符 (`r`, `w`)。此方法返回一对文件描述符。
