...
> 原文: [https://www.geeksforgeeks.org/awesome-new-features-in-python-3-8/](https://www.geeksforgeeks.org/awesome-new-features-in-python-3-8/)
...
Python 3.8 比早期版本包含了许多小的改进。本文概述了 Python 3.8 中最重要的增加和变化。
