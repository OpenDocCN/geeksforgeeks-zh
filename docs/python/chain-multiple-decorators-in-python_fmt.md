...
> 原文: [https://www.geeksforgeeks.org/chain-multiple-decorators-in-python/](https://www.geeksforgeeks.org/chain-multiple-decorators-in-python/)
...
对于 `num()` 函数，我们应用了 2 个装饰函数。首先内部装饰者会工作，然后外部装饰者。
