...
> 原文: [https://www.geeksforgeeks.org/python-checkbox-widget-in-kivy/](https://www.geeksforgeeks.org/python-checkbox-widget-in-kivy/)
...
要使用`CheckBox`，首先必须从包含滑块所有功能的模块中导入`CheckBox`，即
...
[参考: https://kivy.org/doc/stable/api-kivy.uix.checkbox.html](https://kivy.org/doc/stable/api-kivy.uix.checkbox.html)。