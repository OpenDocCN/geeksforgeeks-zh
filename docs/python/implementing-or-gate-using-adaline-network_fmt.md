...
> 原文：[https://www.geeksforgeeks.org/implementing-or-gate-using-adaline-network/](https://www.geeksforgeeks.org/implementing-or-gate-using-adaline-network/)

**Adaline** 代表自适应线性神经元。它利用线性激活函数，并使用增量规则进行训练，以最小化实际输出和期望目标输出之间的均方误差。权重和偏差可调。这里，我们执行 10 个时期的训练，并计算每种情况下的总平均误差，总平均误差在某些时期后下降，随后变得几乎恒定。
