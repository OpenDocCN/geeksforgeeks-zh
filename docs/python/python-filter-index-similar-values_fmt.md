...
> 原文：`https://www.geeksforgeeks.org/python-filter-index-similar-values/`

有时，在使用 Python 字典时，我们可能会遇到一个问题，即我们需要从字典中的某个键匹配列表中的值中提取值列表中与筛选索引匹配的所有值。这种应用可以出现在 web 开发中。

> **输入**：`test_dict = {"Gfg":[4,5,7],"is":[5,6,8],"best":[10,7,4]}`
> **输出**：`{"Gfg":[4,5,7],"is":[5,6,8],"best":[10,7,4]}`
>
> **输入**：`test_dict = {"Gfg":[4,20,5,7],"is":[5,17,6,8],"best":[10,11,7,4]}`
> **输出**：`{"Gfg":[4,5,7],"is":[5,6,8],"best":[10,7,4]}`
