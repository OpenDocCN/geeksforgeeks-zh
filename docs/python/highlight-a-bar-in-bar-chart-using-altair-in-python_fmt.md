...
> 原文: [https://www.geeksforgeeks.org/highlight-a-bar-in-bar-chart-using-altair-in-python/](https://www.geeksforgeeks.org/highlight-a-bar-in-bar-chart-using-altair-in-python/)
...
在本文中，我们使用了 `Altair` 来创建数据集的条形图，并突出显示符合指定条件的条形图。使用的另一个库是 `Pandas`。`Pandas` 是 Python 中的数据分析库，可用于数据集的操作。
