...
> 原文：[https://www.geeksforgeeks.org/best-python-libraries-for-machine-learning/](https://www.geeksforgeeks.org/best-python-libraries-for-machine-learning/)
...
`NumPy` 是一个非常流行的 Python 库，用于大型多维数组和矩阵处理，借助于大量高级数学函数的集合。它对于机器学习中的基础科学计算非常有用。它对于线性代数、傅立叶变换和随机数功能特别有用。像 `TensorFlow` 这样的高端库在内部使用 `NumPy` 来操纵张量。
