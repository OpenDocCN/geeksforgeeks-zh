...
> 原文: [https://www.geeksforgeeks.org/python-largest-number-possible-from-list-of-given-numbers/](https://www.geeksforgeeks.org/python-largest-number-possible-from-list-of-given-numbers/)
...
`itertools.permutation` 可用于获得可能的置换，`max` 函数根据 `join` 函数给出的连接输出将其转换为整数后选择其中的最大值。
