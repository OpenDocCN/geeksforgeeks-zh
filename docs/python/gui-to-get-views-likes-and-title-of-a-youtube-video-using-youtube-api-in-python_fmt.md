...
> 原文：[https://www.geeksforgeeks.org/gui-to-get-views-likes-and-title-of-a-youtube-video-using-youtube-api-in-python/](https://www.geeksforgeeks.org/gui-to-get-views-likes-and-title-of-a-youtube-video-using-youtube-api-in-python/)
...
在继续之前，你应该通过 [YouTube API](https://www.geeksforgeeks.org/youtube-data-api-set-1/) 来安装所需的模块，并启用文章中提到的所需功能。
...
*   在 `list()` 方法中，在 `part` 属性和 `id` 属性中传递视频网址的 `video_id`。
