...
> 原文: [https://www.geeksforgeeks.org/python-common-keys-in-list-and-dictionary/](https://www.geeksforgeeks.org/python-common-keys-in-list-and-dictionary/)

给定一个字典和列表，提取所有常用的关键字和列表。

> **输入**: `test_dict = {"Gfg":3, "is":5, "best":9, "for":0, "geeks":3}`, `test_list = ["Gfg", "best", "CS"]`
> **输出**: `['Gfg', 'best']`
> **解释**: `Gfg` 和 `best` 都出现在字典和列表中。
>
> **输入**: `test_dict = {"Gfg":3, "is":5, "best":9, "for":0, "geeks":3}`, `test_list = ["Gfg", "good", "CS"]`
> **输出**: `['Gfg']`
> **解释**: `Gfg` 在字典和列表中都存在。
