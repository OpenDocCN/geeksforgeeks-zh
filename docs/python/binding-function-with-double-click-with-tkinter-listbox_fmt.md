...
> 原文: [https://www.geeksforgeeks.org/binding-function-with-double-click-with-tkinter-listbox/](https://www.geeksforgeeks.org/binding-function-with-double-click-with-tkinter-listbox/)

## 先决条件

*   [Python GUI–Tkinter](http://geeksforgeeks.org/python-gui-tkinter/)
*   [Python | Tkinter 中的绑定功能](http://geeksforgeeks.org/python-binding-function-in-tkinter/)
