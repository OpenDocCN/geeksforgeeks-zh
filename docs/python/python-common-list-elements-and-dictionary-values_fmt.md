...
> 原文: [https://www.geeksforgeeks.org/python-common-list-elements-and-dictionary-values/](https://www.geeksforgeeks.org/python-common-list-elements-and-dictionary-values/)

给定列表和字典，提取列表和字典值的公共元素。

> **输入**: `test_list = ["Gfg", "is", "Best", "For"]`, `subs_dict = { 4:"Gfg", 8:"Geeks", 9:"Good", }`
> **输出**: `['Gfg']`
> **解释**: “Gfg”在列表和字典值中都很常见。
> **输入**: `test_list = ["Gfg", "is", "Best", "For", "Geeks"]`, `subs_dict = { 4:"Gfg", 8:"Geeks", 9:"Best", }`
> **输出**: `["Gfg", "Geeks", "Best"]`
> **解释**: 提取 3 个常用值。
