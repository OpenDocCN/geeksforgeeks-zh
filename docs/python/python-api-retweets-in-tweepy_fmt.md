...
> 原文: [https://www.geeksforgeeks.org/python-api-retweets-in-tweepy/](https://www.geeksforgeeks.org/python-api-retweets-in-tweepy/)
...
使用带 `count` 参数的 `retweets()` 方法只获取一定数量的转发。只打印以下推文的 3 个转发者的网名:
