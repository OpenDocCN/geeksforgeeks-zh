...
> 原文: [https://www.geeksforgeeks.org/convert-object-to-string-in-python/](https://www.geeksforgeeks.org/convert-object-to-string-in-python/)
...
# Converting custom object to string
print(repr(C()))
```
