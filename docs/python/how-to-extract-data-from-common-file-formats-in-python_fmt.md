...
> 原文: [https://www.geeksforgeeks.org/how-to-extract-data-from-common-file-formats-in-python/](https://www.geeksforgeeks.org/how-to-extract-data-from-common-file-formats-in-python/)

有时处理一些数据集必须主要处理仅限 csv (逗号分隔值) 文件。它们确实是应用数据科学技术和算法的一个很好的起点。但我们中的许多人迟早会进入数据科学公司或从事数据科学领域的实际项目。不幸的是，在现实世界的项目中，数据不会以简洁的方式提供给我们 csv 文件。在那里，我们必须从不同的来源提取数据，如图像、pdf 文件、文档文件、图像文件等。在本文中，我们将看到解决这些情况的完美开始。
