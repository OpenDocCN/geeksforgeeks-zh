...
> 原文: [https://www.geeksforgeeks.org/sass-booleans-and-boolean-operators/](https://www.geeksforgeeks.org/sass-booleans-and-boolean-operators/)
...
**条件编译中的用法:**
我们可以在条件编译中使用布尔值。请看下面的例子，我们在 mixin 中传递了一个真值，这样`@if`块将被编译。
...
SASS 有三个布尔运算符：两个是二元：`and`、`or`；一个是一元：`not`。
