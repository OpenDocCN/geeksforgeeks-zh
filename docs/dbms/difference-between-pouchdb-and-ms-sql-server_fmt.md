...
> 原文：[https://www.geeksforgeeks.org/difference-between-pouchdb-and-ms-sql-server/](https://www.geeksforgeeks.org/difference-between-pouchdb-and-ms-sql-server/)
...
## 2. 微软 SQL Server
[微软 SQL Server](https://www.geeksforgeeks.org/introduction-of-ms-sql-server/) 是由微软公司开发的关系数据库管理系统（[RDBMS](https://www.geeksforgeeks.org/rdbms-architecture/)），最初发布于 1989 年 4 月 24 日。是用 [C](https://www.geeksforgeeks.org/c-programming-language/) 和 [C++](https://www.geeksforgeeks.org/c-plus-plus/) 语言写的。它依赖于平台，并且是基于[图形用户界面和命令行界面的软件](https://www.geeksforgeeks.org/difference-between-cli-and-gui/)。它支持企业环境中的各种事务处理、分析应用程序和商业智能。
