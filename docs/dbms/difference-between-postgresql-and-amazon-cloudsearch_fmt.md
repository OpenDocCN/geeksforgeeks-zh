# PostgreSQL 和亚马逊 CloudSearch 的区别

> 原文: [https://www.geeksforgeeks.org/difference-between-postgresql-and-amazon-cloudsearch/](https://www.geeksforgeeks.org/difference-between-postgresql-and-amazon-cloudsearch/)
...
| 2. | 它是开源的。 | 这是商业广告。 |
| 3. | `PostgreSQL` 的服务器操作系统是 `FreeBSD`、`HP-UX`、`Linux`、`NetBSD`、`OpenBSD`、`OS X`、`Solaris`、`Unix`、`Windows`。 | 亚马逊云搜索的服务器操作系统是托管的。 |
