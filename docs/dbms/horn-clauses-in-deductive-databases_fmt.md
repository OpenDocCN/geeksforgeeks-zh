...
> 原文：[https://www.geeksforgeeks.org/horn-clauses-in-deductive-databases/](https://www.geeksforgeeks.org/horn-clauses-in-deductive-databases/)
...
在数据日志中，规则被表示为被称为 `Horn 子句`的子句的受限形式，其中一个子句最多可以包含一个正文字。
