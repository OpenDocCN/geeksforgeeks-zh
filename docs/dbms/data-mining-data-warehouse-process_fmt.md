...
> 原文：[https://www.geeksforgeeks.org/data-mining-data-warehouse-process/](https://www.geeksforgeeks.org/data-mining-data-warehouse-process/)
...
2.  **转换：** 它将存储在数据库中的数据转换成`数据立方体`，以便可以加载到仓库中。
