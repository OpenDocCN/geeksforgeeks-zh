...
> 原文: [https://www.geeksforgeeks.org/sql-declare-local-temporary-table/](https://www.geeksforgeeks.org/sql-declare-local-temporary-table/)

`DECLARE LOCAL TEMPORARY TABLE` 语句用于创建临时表。临时表中的行仅对创建表并插入行的连接可见。
