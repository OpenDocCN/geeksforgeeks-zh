...
> 原文：[https://www.geeksforgeeks.org/difference-between-postgresql-and-teradata/](https://www.geeksforgeeks.org/difference-between-postgresql-and-teradata/)
...
| Two | `PostgreSQL` 服务器操作系统有 `FreeBSD`、`HP-UX`、`Linux`、`NetBSD`、`OpenBSD`、`OS X`、`Solaris`、`Unix` 和 `Windows`。 | `Teradata` 服务器操作系统是 `Linux`，托管的。 |
