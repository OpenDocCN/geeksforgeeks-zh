...
> 原文: [https://www.geeksforgeeks.org/difference-between-conservative-and-rigorous-2-pl/](https://www.geeksforgeeks.org/difference-between-conservative-and-rigorous-2-pl/)
...
*   它也被称为静态 `2-PL`。
*   该协议要求事务在开始执行之前通过预先声明其`读集`和`写集`来锁定它访问的所有项目。
