...
> 原文：[https://www.geeksforgeeks.org/sql-interview-questions-asked-in-top-tech-companies/](https://www.geeksforgeeks.org/sql-interview-questions-asked-in-top-tech-companies/)
...
**答案：** 我们可以使用以下语句：`SELECT LEN('A value' + ' x ') - 1`
...
**回答：** 主动数据库是包含主动规则的数据库，多为 `ECA` 规则（事件-条件-动作规则）的形式。主动数据库系统通过强大的规则处理功能增强了传统数据库的功能，为数据库系统应用程序提供了一种统一而高效的机制。
