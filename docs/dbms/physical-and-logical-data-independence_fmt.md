...
> 原文: [https://www.geeksforgeeks.org/physical-and-logical-data-independence/](https://www.geeksforgeeks.org/physical-and-logical-data-independence/)
...
**注–**
`DBMS`的模式架构有3个层次：`物理层`、`逻辑层`、`视图层`（从最低到最高排列）。
