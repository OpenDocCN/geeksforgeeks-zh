...
> 原文: [https://www.geeksforgeeks.org/difference-between-natural-join-and-cross-join-in-sql/](https://www.geeksforgeeks.org/difference-between-natural-join-and-cross-join-in-sql/)
...
| 4. | 语法: `SELECT * FROM Table1 NATURAL JOIN Table2;` | 语法: `SELECT * FROM Table1 CROSS JOIN Table2;` |