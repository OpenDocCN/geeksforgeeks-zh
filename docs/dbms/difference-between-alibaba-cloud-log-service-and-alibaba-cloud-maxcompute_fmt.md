...
> 原文：[https://www.geeksforgeeks.org/difference-between-alibaba-cloud-log-service-and-alibaba-cloud-maxcompute/](https://www.geeksforgeeks.org/difference-between-alibaba-cloud-log-service-and-alibaba-cloud-maxcompute/)
...
| 12. | 它提供了一个 `ES-Hadoop` 连接器作为 `MapReduce` 方法。 | 它为用户定义的 `MapReduce` 方法提供了一个 `API`。 |
