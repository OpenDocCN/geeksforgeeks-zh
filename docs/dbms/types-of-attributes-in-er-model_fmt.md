...
> 原文：[https://www.geeksforgeeks.org/types-of-attributes-in-er-model/](https://www.geeksforgeeks.org/types-of-attributes-in-er-model/)
...
那些可以由复合属性和多值属性嵌套而成的属性称为复杂属性。这些属性很少在数据库管理系统中使用。这就是它们不那么受欢迎的原因。
