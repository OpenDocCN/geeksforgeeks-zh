...
> 原文: [https://www.geeksforgeeks.org/delete-statement-in-ms-sql-server/](https://www.geeksforgeeks.org/delete-statement-in-ms-sql-server/)
...
以下 SQL 语句从 `student` 表中删除了一行，该行的学生名为 `'ABC'`。
