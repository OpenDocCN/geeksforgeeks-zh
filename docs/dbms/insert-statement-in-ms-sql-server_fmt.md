...
> 原文: [https://www.geeksforgeeks.org/insert-statement-in-ms-sql-server/](https://www.geeksforgeeks.org/insert-statement-in-ms-sql-server/)
...
考虑一个表 `student`。如果用户一次要输入 6 个学生的数据，必须按如下方式进行查询:
