...
> 原文：[https://www.geeksforgeeks.org/data-architecture-design-and-data-management/](https://www.geeksforgeeks.org/data-architecture-design-and-data-management/)
...
```json
{
  "dataArchitecture": {
    ...
    "purpose": "Define standards for data collection, storage, and usage."
  }
}
```