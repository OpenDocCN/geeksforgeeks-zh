...
> 原文：[https://www.geeksforgeeks.org/difference-between-hierarchical-and-relational-data-model/](https://www.geeksforgeeks.org/difference-between-hierarchical-and-relational-data-model/)
...
| 目前这种模式正在购物车和搜索引擎中使用。有一些工具可以模拟分层数据库，例如 `Mangodb`、`firebase` | 大多数传统软件都使用关系数据库，例如 `甲骨文数据库`、`微软 sql 服务器`、`IBM DB2` |