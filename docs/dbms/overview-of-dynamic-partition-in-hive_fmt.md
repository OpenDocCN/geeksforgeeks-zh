...
> 原文：[https://www.geeksforgeeks.org/overview-of-dynamic-partition-in-hive/](https://www.geeksforgeeks.org/overview-of-dynamic-partition-in-hive/)
...
现在让我们来执行一些动态分区的操作。你可以选择 `ubuntu`，它的操作速度会很快，如下所示。
