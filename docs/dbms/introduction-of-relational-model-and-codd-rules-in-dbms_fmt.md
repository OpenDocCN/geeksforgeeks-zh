...
> 原文: [https://www.geeksforgeeks.org/introduction-of-relational-model-and-codd-rules-in-dbms/](https://www.geeksforgeeks.org/introduction-of-relational-model-and-codd-rules-in-dbms/)
...
**属性:** 每个关系都是根据一些属性来定义的，每个属性都被称为属性。例如，`螺柱_编号`、`螺柱_名称`等。是关系 `STUDENT` 的属性。
