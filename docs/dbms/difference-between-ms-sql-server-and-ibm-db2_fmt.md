...
> 原文：[https://www.geeksforgeeks.org/difference-between-ms-sql-server-and-ibm-db2/](https://www.geeksforgeeks.org/difference-between-ms-sql-server-and-ibm-db2/)
...
**2. IBM DB2：**
它是来自 `IBM` 的关系数据库管理系统（`RDBMS`）产品。它的目的是高效地分析、存储和检索数据。`DB2` 产品随着面向对象特性和非关系结构对 `XML` 的支持而增加。它是用 `C` 和 `C++` 语言编写的。
