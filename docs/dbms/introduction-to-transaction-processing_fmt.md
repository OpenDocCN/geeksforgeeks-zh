...
> 原文：[https://www.geeksforgeeks.org/introduction-to-transaction-processing/](https://www.geeksforgeeks.org/introduction-to-transaction-processing/)

## 单用户系统
在这种系统中，一次最多只有一个用户可以使用。
...
事务是一组操作，既可以嵌入应用程序中，也可以通过高级语言（如 `SQL`）交互指定。
