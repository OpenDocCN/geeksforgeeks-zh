...
> 原文: [https://www.geeksforgeeks.org/difference-between-amazon-documentdb-and-amazon-redshift/](https://www.geeksforgeeks.org/difference-between-amazon-documentdb-and-amazon-redshift/)

## 1. Amazon DocumentDB
它是一个快速、可扩展、高可用性和完全托管的文档数据库服务，支持 `MongoDB` 工作负载。它目前在加利福尼亚州、俄勒冈州、北弗吉尼亚州和爱尔兰地区的 `AWS` 上提供。它通过模拟响应来实现 Apache 2.0 开源 `MongoDB` 3.6 API。
