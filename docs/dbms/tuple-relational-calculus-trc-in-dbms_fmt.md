...
> 原文：[https://www.geeksforgeeks.org/tuple-relational-calculus-trc-in-dbms/](https://www.geeksforgeeks.org/tuple-relational-calculus-trc-in-dbms/)
...
其中 `t` = 结果元组，`P(t)` = 称为谓词，这些是用于获取 `t` 的条件。
...
- `∀ t ∈ r (Q(t))` = 对于关系 `r` 中的“所有”元组，`Q(t)` 为真。
