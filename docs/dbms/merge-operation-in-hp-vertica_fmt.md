...
> 原文: [https://www.geeksforgeeks.org/merge-operation-in-hp-vertica/](https://www.geeksforgeeks.org/merge-operation-in-hp-vertica/)
...
新行“908–KARAN–99”和“777–MANU–67”作为新行插入结果表中。但是我们看到行“201–TIM–94”出现在源表和目标表中(在 `source.数字 = target.数字` 条件下)。因此，我们通过从源表中获取值来更新结果表中的值。
