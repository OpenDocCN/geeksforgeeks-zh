...
CouchDB 是一个`开源NoSQL`数据库。它主要关注易用性。它是由`阿帕奇软件`基金会开发的。
...
2.  安装下载的软件。
3.  现在访问链接 [http://127.0.0.1:5984/](http://127.0.0.1:5984/)。

![](img/5782c7269a40a893d8273dcbf803bd22.png)

4.  要与 CouchDB Web 界面交互，请访问链接 [http://127.0.0.1:5984/_utils/](http://127.0.0.1:5984/_utils/)。
