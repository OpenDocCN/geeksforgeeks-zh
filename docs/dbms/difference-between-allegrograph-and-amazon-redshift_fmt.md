...
> 原文：[https://www.geeksforgeeks.org/difference-between-allegrograph-and-amazon-redshift/](https://www.geeksforgeeks.org/difference-between-allegrograph-and-amazon-redshift/)
...
| 10. | 它为用户定义的映射/缩减方法提供了 `API`。 | 它没有为用户定义的映射/缩减方法提供 `API`。 |
| 11. | 它不支持内存功能。 | 它支持内存功能。 |
