...
> 原文：`https://www.geeksforgeeks.org/frequent-itemsets-and-its-applications-in-data-analytics/`
...
**示例–**
例如，一组项目，如`面包`和`黄油`，经常一起出现在事务数据集中，这是一个频繁项目集。
...
*   通过这种分析，我们可以确定许多人一起买`面包`和`黄油`，但这没有什么吸引力，因为我们已经知道有个别受欢迎的项目。我们可能会发现很多人一起买`热狗`和`奶酪`。
*   这不会让买`热狗`的人感到震惊，但它给了超市一个通过巧妙营销赚取高额利润的机会。他们可以出售`热狗`，并将提高`奶酪`的价格。当人们来买`热狗`时，他们一定会买`奶酪`，而不考虑它的高价格。
*   还有一个例子是`啤酒`和`尿布`。通过数据分析超市销售人员观察到，购买`尿布`的人，很可能会有一个孩子在他们的房子里，如果他们购买`尿布`，他们通常不会购买`啤酒`，他们不太可能在酒吧喝酒。
