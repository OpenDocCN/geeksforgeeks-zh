...
> 原文:[https://www . geeksforgeks . org/perl-数据库-管理-使用-dbi/](https://www.geeksforgeeks.org/perl-database-management-using-dbi/)
...
要导入数据库独立接口模块的功能，我们需要借助“使用”实用程序来导入或包含该模块。`use DBI` 实用程序允许我们使用 `DBI` 模块来操作我们正在连接的数据库。
