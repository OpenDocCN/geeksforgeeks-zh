...
> 原文: [https://www.geeksforgeeks.org/incedo-inc-interview-experience-for-sde-quality-assurance-engineer-on-campus/](https://www.geeksforgeeks.org/incedo-inc-interview-experience-for-sde-quality-assurance-engineer-on-campus/)

Incedo Inc. 在 2021 年 8 月访问了我们学院 SRM 科技学院，一切都以虚拟模式进行。
...
*   解释标准化的不同形式，
*   我对 `SQL` 连接的了解，
*   编写一个查询，从两个表中显示员工的姓名和职务——员工个人信息（带有员工 id、姓名、地址、电话号码等）和员工信息（带有员工 id、部门、职务、工资等）。查询如下：
    `select employee.name, employee_info.designation from employee, employee_info where employee.emp_id = employee_info.emp_id`
*   什么是参照完整性，
*   合并排序和快速排序，哪种排序算法更好，
