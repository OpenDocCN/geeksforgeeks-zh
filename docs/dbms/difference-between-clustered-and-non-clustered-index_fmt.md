...
> 原文：[https://www.geeksforgeeks.org/difference-between-clustered-and-non-clustered-index/](https://www.geeksforgeeks.org/difference-between-clustered-and-non-clustered-index/)
...
在本例中，`Roll_No`是主键，它将自动充当聚集索引。
该代码的输出将按照`Roll_No`的递增顺序产生。
...
非聚集索引类似于一本书的索引。一本书的索引由章节名称和页码组成，如果你想阅读任何主题或章节，那么你可以使用该书的索引直接转到该页。不需要浏览一本书的每一页。
