...
> 原文: [https://www.geeksforgeeks.org/handling-superuser-account-in-cassandra/](https://www.geeksforgeeks.org/handling-superuser-account-in-cassandra/)
...
现在，我们将了解如何在特定的键空间上使用 `GRANT` 授予访问权限。这样，如果我们想将大学键空间上的读取访问权限授予 `User` 角色，那么我们将使用 `GRANT` 命令。
