...
> 原文：[https://www.geeksforgeeks.org/inserting-data-using-a-csv-file-in-cassandra/](https://www.geeksforgeeks.org/inserting-data-using-a-csv-file-in-cassandra/)
...
## 步骤-2：创建 Student_personal_data table
在这里，可以使用下面的 `cqlsh` 命令创建 `Student_personal_data` table，如下所示。
...
| e6ae4cf0-d358-4d55-b511-85902fda9cc6 突击步枪 | 丽娜 | M |
