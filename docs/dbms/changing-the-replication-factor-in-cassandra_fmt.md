...
> 原文: [https://www.geeksforgeeks.org/changing-the-replication-factor-in-cassandra/](https://www.geeksforgeeks.org/changing-the-replication-factor-in-cassandra/)
...
*   在卡珊德拉中，您不能更改键空间的名称。
*   在更改复制因子或任何修改之后，执行修复命令总是一种好的做法。
*   您可以执行以下 CQL 查询进行完全修复。
