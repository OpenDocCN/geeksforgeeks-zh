...
> 原文: [https://www.geeksforgeeks.org/difference-between-elasticsearch-and-sqlite/](https://www.geeksforgeeks.org/difference-between-elasticsearch-and-sqlite/)
...
| 9. | 就排名而言，它被认为比 `SQLite` 更好。 | 就排名而言，它被认为不如 `Elasticsearch`。 |
| 10. | 它接受所有有 `JVM` 的操作系统。 | `SQLite` 基本上是少服务器的。 |