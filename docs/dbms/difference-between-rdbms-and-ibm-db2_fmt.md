...
> 原文：[https://www.geeksforgeeks.org/difference-between-rdbms-and-ibm-db2/](https://www.geeksforgeeks.org/difference-between-rdbms-and-ibm-db2/)

## 关系数据库管理系统

关系数据库管理系统代表关系数据库管理系统。它是最受欢迎的数据库。在它中，数据以元组形式的行的形式存储。因为数据存储在表中，所以它包含大量的表和数据，可以很容易地访问。该模型是由英菲尼提出的。
