...
> 原文: [https://www.geeksforgeeks.org/features-of-structured-query-language-sql/](https://www.geeksforgeeks.org/features-of-structured-query-language-sql/)
...
## 6. 事务控制语言
事务是数据库管理系统的一个重要元素，为了控制事务，使用了 TCL，它有 `commit`、`rollback` 和 `savepoint` 等命令。
