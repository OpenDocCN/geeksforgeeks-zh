...
> 原文: [https://www.geeksforgeeks.org/orchestration-in-cloud-computing/](https://www.geeksforgeeks.org/orchestration-in-cloud-computing/)
...
## 云编排
云编排可以定义为基于云的环境中服务部署的协调、安排或端到端自动化。它为各种流程的自动化活动引入并实施工作流，以向其客户交付所需的服务。云编排工具充分利用`IaaS`服务提供商来实现全自动部署，删除了被认为耗时的手动流程。一些编排工具有`Terraform`、`Ansible`、`AWS`云形成等。
