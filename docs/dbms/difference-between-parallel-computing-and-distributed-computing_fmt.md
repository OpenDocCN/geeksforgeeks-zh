...
> 原文:[https://www.geeksforgeeks.org/difference-between-parallel-computing-and-distributed-computing/](https://www.geeksforgeeks.org/difference-between-parallel-computing-and-distributed-computing/)
...
| 5. | 处理器通过总线相互通信 | 计算机通过信息传递相互通信。 |
| 6. | 提高系统性能 | 提高系统可扩展性、容错能力和资源共享能力 |