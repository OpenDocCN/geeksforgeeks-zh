...
> 原文：[https://www.geeksforgeeks.org/lossless-decomposition-in-dbms/](https://www.geeksforgeeks.org/lossless-decomposition-in-dbms/)
...
如果下列函数依赖中至少有一个在 `F+`（函数依赖的闭包）中，将关系 `R` 分解成 `R1` 和 `R2` 是无损连接分解：
