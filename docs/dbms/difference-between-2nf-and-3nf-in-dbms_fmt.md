...
> 原文: [https://www.geeksforgeeks.org/difference-between-2nf-and-3nf-in-dbms/](https://www.geeksforgeeks.org/difference-between-2nf-and-3nf-in-dbms/)
...
关系 `R` 在 2NF 中，因为没有质数属性在导出非质数属性，即不存在部分函数依赖。
