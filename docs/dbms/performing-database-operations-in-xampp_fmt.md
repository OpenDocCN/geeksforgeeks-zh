...
> 原文: [https://www.geeksforgeeks.org/performing-database-operations-in-xampp/](https://www.geeksforgeeks.org/performing-database-operations-in-xampp/)
...
```
SELECT `Rollno`, `Name` FROM `itdept`
```
