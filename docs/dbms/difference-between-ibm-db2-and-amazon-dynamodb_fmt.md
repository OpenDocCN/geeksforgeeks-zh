...
> 原文: [https://www.geeksforgeeks.org/difference-between-ibm-db2-and-amazon-dynamodb/](https://www.geeksforgeeks.org/difference-between-ibm-db2-and-amazon-dynamodb/)
...
| 5. | 它支持 `AIX`、`HP-UX`、`Linux`、`Solaris`、`Windows`、`z/OS`。 | 它支持所有托管操作系统。 |
