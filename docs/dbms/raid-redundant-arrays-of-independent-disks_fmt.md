...
> 原文: [https://www.geeksforgeeks.org/raid-redundant-arrays-of-independent-disks/](https://www.geeksforgeeks.org/raid-redundant-arrays-of-independent-disks/)
...
*   奇偶校验是使用简单的异或函数计算的。如果数据位为 `0, 0, 0, 1`，奇偶校验位为 `XOR(0, 0, 0, 1) = 1`。如果数据位为 `0, 1, 1, 0`，奇偶校验位为 `XOR(0, 1, 1, 0) = 0`。一个简单的方法是偶数个 `1` 产生奇偶校验 `0`，奇数个 `1` 产生奇偶校验 `1`。
