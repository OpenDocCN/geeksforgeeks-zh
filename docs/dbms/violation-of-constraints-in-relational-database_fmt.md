...
> 原文: [https://www.geeksforgeeks.org/violation-of-constraints-in-relational-database/](https://www.geeksforgeeks.org/violation-of-constraints-in-relational-database/)
...
上述插入违反了实体完整性约束，因为主键 `EID` 为空，所以不允许，所以被拒绝。
