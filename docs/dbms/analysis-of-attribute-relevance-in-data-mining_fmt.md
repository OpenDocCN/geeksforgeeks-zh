...
> 原文: [https://www.geeksforgeeks.org/analysis-of-attribute-relevance-in-data-mining/](https://www.geeksforgeeks.org/analysis-of-attribute-relevance-in-data-mining/)

## 属性分析方法:
在 `AI` 中已经有了大量的调查，关于质量相关性调查的见解、模糊和苛刻的设定假设。特征相关性检查背后的总体思路是处理一些用于评估某一特定类别或想法的特征重要性的标准。这些指标包括数据采集、基尼指数、不确定性和关联系数。
