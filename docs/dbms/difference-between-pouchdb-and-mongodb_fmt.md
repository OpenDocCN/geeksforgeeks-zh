...
> 原文：[https://www.geeksforgeeks.org/difference-between-pouchdb-and-mongodb/](https://www.geeksforgeeks.org/difference-between-pouchdb-and-mongodb/)
...
## MongoDB :
MongoDB 是一个跨平台的面向文档和非关系(即 NoSQL)的数据库程序。它是一个开源文档数据库，以键值对的形式存储数据。MongoDB 由 `MongoDB Inc.` 开发，最初于 2009 年 2 月 11 日发布。用 [C++](https://www.geeksforgeeks.org/c-plus-plus/)、[Go](https://www.geeksforgeeks.org/golang/)、[JavaScript](https://www.geeksforgeeks.org/javascript-tutorial/)、[Python](https://www.geeksforgeeks.org/python-programming-language/) 语言编写。MongoDB 提供了高速度、高可用性和高扩展性。

## PouchDB 和 MongoDB 的区别:

| SR.NO | PouchDB | MongoDB |
| --- | --- | --- |
| 1. | 它是由 Apache 软件基金会开发的。 | 它是由 `MongoDB Inc.` 开发的。 |
