...
> 原文：[`https://www.geeksforgeeks.org/difference-between-cloud-storage-and-traditional-storage/`](https://www.geeksforgeeks.org/difference-between-cloud-storage-and-traditional-storage/)

## 1. 云存储
[`云存储`](https://www.geeksforgeeks.org/cloud-storage-actually-works/) 是我们使用远程驱动器将数据存储在客户端使用的云位置的存储选项。它还使用网络将数据存储到服务提供商拥有的异地服务器。用户将此存储选项用于容量、带宽和远程访问。
