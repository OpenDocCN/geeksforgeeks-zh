...
> 原文: [https://www.geeksforgeeks.org/difference-between-mongodb-and-amazon-dynamodb/](https://www.geeksforgeeks.org/difference-between-mongodb-and-amazon-dynamodb/)
...
| 8. | 它不是基于云的。 | 它基于云。 |
| 9. | 就排名而言，它被认为比亚马逊 `DynamoDB` 更好。 | 就排名而言，它被认为不如 `MongoDB`。 |
