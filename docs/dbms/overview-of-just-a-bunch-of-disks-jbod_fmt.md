...
> 原文: [https://www.geeksforgeeks.org/overview-of-just-a-bunch-of-disks-jbod/](https://www.geeksforgeeks.org/overview-of-just-a-bunch-of-disks-jbod/)
...
`JBOD`通过组合所有磁盘使磁盘看起来像一个整体。像在`RAID`系统中一样，数据冗余地存储在多个磁盘中，这些磁盘在操作系统中显示为单个磁盘。
