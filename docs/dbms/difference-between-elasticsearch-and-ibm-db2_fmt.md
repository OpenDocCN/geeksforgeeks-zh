# Elasticsearch 与 IBM DB2 的区别

> 原文：[https://www.geeksforgeeks.org/difference-between-elasticsearch-and-ibm-db2/](https://www.geeksforgeeks.org/difference-between-elasticsearch-and-ibm-db2/)
...
| 9. | 就排名而言，它被认为不如 `IBM DB2`。 | 就排名而言，它被认为比弹性搜索更好。 |
| 10. | 它接受所有有 `JVM` 的操作系统。 | 它支持 `AIX`、`惠普-UX`、`Linux`、`Solaris`、`Windows`、`z/OS`。 |