...
> 原文：[https://www.geeksforgeeks.org/inserting-json-data-into-a-table-in-cassandra/](https://www.geeksforgeeks.org/inserting-json-data-into-a-table-in-cassandra/)
...
使用 JSON 格式，如果您没有为任何列插入任何值，那么将自动输入一个空值，如下例所示。
