...
> 原文: [https://www.geeksforgeeks.org/additional-functions-in-cql-cassandra-query-language/](https://www.geeksforgeeks.org/additional-functions-in-cql-cassandra-query-language/)
