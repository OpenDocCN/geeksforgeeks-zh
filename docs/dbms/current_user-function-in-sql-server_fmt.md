...
> 原文: [https://www.geeksforgeeks.org/current_user-function-in-sql-server/](https://www.geeksforgeeks.org/current_user-function-in-sql-server/)
...
## 返回:
返回正在使用的 SQL Server 数据库中当前用户的名称。
