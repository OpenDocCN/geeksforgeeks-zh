...
> 原文:[https://www.geeksforgeeks.org/difference-between-data-security-and-data-integrity/](https://www.geeksforgeeks.org/difference-between-data-security-and-data-integrity/)
...
| 8. | 可以通过:<br><br>*   User account number (password)<br>*   Certification scheme<br><br>实现 | 可以通过以下规则实现:<br><br>*   [PK]<br>*   [Foreign key]<br>*   relationship |