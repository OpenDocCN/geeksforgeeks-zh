...
> 原文:[https://www . geeksforgeks . org/wea viate 和-yanza 之间的差异/](https://www.geeksforgeeks.org/difference-between-weaviate-and-yanza/)

**1。燕莎:**
`燕莎`是[物联网](https://www.geeksforgeeks.org/introduction-to-internet-of-things-iot-set-1/)(物联网)应用的时间序列数据库管理系统。是`燕莎`开发的。它的服务器操作系统是视窗，支持超文本传输协议。
...
| 8. | 在`Weaviate`中，`GraphQL`被用作查询语言。 | `燕莎`没有使用`SQL`。 |