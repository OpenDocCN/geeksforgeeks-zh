...
> 原文：[https://www.geeksforgeeks.org/difference-between-parallel-and-distributed-databases/](https://www.geeksforgeeks.org/difference-between-parallel-and-distributed-databases/)
...
并行数据库和分布式数据库的主要区别在于，前者是**紧耦合**，而后者是**松耦合**。
...
| 在并行数据库中，有 3 种类型的体系结构：共享内存、共享磁盘和无共享。 | 分布式数据库通常是一种无共享的架构 |
