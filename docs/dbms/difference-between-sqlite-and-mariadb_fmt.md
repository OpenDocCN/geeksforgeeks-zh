...
> 原文: [https://www.geeksforgeeks.org/difference-between-sqlite-and-mariadb/](https://www.geeksforgeeks.org/difference-between-sqlite-and-mariadb/)
...
| 4. | `SQLite` 的主要数据库模型是关系数据库管理系统。 | `MariaDB` 的主要数据库模型也是关系数据库管理系统。 |
