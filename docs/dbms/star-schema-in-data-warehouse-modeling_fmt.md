...
> 原文: [https://www.geeksforgeeks.org/star-schema-in-data-warehouse-modeling/](https://www.geeksforgeeks.org/star-schema-in-data-warehouse-modeling/)
...
星型模式是数据集市模式中的基础模式，也是最简单的。该模式被广泛用于开发或构建数据仓库和维度数据集市。它包括一个或多个索引任意数量维度表的事实表。星型模式是雪花模式的必然原因。它对于处理基本查询也很有效。
