...
> 原文: [https://www.geeksforgeeks.org/difference-between-pouchdb-and-couchbase/](https://www.geeksforgeeks.org/difference-between-pouchdb-and-couchbase/)
...
| 9. | 它支持 `JavaScript` 编程语言。 | 它支持 `.Net`、`C`、`Clojure`、`ColdFusion`、`Erlang`、`Go`、`Java`、`JavaScript`、`Perl`、`PHP`、`Python`、`Ruby`、`Scala`、`Tcl` 等编程语言。 |
