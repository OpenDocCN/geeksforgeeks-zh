...
> 原文：[https://www.geeksforgeeks.org/difference-between-derby-and-sqlite/](https://www.geeksforgeeks.org/difference-between-derby-and-sqlite/)
...
| SR.NO | Derby | SQLite |
| --- | --- | --- |
| one | 它是由 `Apache` 软件基金会在 1997 年开发的 | 它是由理查德·希普在 2000 年开发的。 |
