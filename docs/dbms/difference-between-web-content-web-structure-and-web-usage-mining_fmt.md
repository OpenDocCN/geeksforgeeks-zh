...
> 原文：[https://www.geeksforgeeks.org/difference-between-web-content-web-structure-and-web-usage-mining/](https://www.geeksforgeeks.org/difference-between-web-content-web-structure-and-web-usage-mining/)
...
| 标准 | 网络内容 | 网页结构 | 网络使用 |
| :--- | :--- | :--- | :--- |
| `数据视图` | *   非结构化 | *   半结构化<br>*   网站是数据库 | *   连接结构 | *   交互 |
| `主要数据` | *   文本文档<br>*   超文本文档 | 超文本文档 | 链接结构 | *   服务器日志<br>*   浏览器日志 |
| `方法` | *   机器学习<br>*   统计学（包括`NLP`） | *   专有关法<br>*   关联规则 | 专有关法 | *   机器学习<br>*   统计学<br>*   关联规则 |
| `表示` | *   词袋和名词术语<br>*   短语、概念或本体<br>*   关系 | *   关系图 | 图表 | *   关系表<br>*   曲线图 |
| `应用类别` | *   分类<br>*   聚类<br>*   搜索规则<br>*   在文本中寻找模式 | *   查找频繁子结构<br>*   网站模式发现 | *   网站构建<br>*   适配与管理 |