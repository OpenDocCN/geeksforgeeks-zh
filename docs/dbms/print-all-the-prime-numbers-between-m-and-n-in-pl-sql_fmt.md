...
> 原文: [https://www.geeksforgeeks.org/print-all-the-prime-numbers-between-m-and-n-in-pl-sql/](https://www.geeksforgeeks.org/print-all-the-prime-numbers-between-m-and-n-in-pl-sql/)
...
例如，考虑数字 5。它只有两个除数: 1 和数字 5 本身。因此，它是一个质数。
