...
> 原文：[https://www.geeksforgeeks.org/concurrency-control-techniques/](https://www.geeksforgeeks.org/concurrency-control-techniques/)
...
**多版本 2 阶段锁定：**
每次成功写入都会创建所写入数据项的新版本。时间戳用于标记版本。当发出 `读(X)` 操作时，根据事务的时间戳选择适当的 `X` 版本。
