...
> 原文: [https://www.geeksforgeeks.org/difference-between-derby-and-mongodb/](https://www.geeksforgeeks.org/difference-between-derby-and-mongodb/)
...
| four | `Derby` 的服务器操作系统有 `Windows`、`macOs`、`Linux`、`Unix`、`BSD` 和 `z/OS`。 | `MongoDB` 的服务器操作系统是 `Linux`、`OS X`、`Solaris` 和 `Windows`。 |
