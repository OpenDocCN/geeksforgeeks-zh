...
> 原文：[https://www.geeksforgeeks.org/difference-between-rdbms-and-oodbms/](https://www.geeksforgeeks.org/difference-between-rdbms-and-oodbms/)
...
## OODBMS
`OODBMS`代表面向对象的数据库管理系统。它是一种数据库管理系统，其中数据以对象的形式表示，如面向对象编程中所使用的。`OODB`实现了面向对象的概念，如对象类、对象标识、多态性、封装和继承。与关系数据库相比，面向对象数据库存储复杂的数据。面向对象数据库管理系统的一些例子有通用对象数据库、客观性/数据库、对象存储、`Caché`和`ZODB`。
