...
> 原文:[https://www.geeksforgeeks.org/data-preprocessing-in-data-mining/](https://www.geeksforgeeks.org/data-preprocessing-in-data-mining/)
...
#### (a) 缺少数据:
当数据中缺少一些数据时，就会出现这种情况。可以用各种方式处理。其中一些是:
...
#### 4. 概念层次生成:
这里属性从层次结构中的较低级别转换到较高级别。例如，属性“城市”可以转换为“国家”。
