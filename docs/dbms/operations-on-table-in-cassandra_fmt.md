...
> 原文: [https://www.geeksforgeks.org/operations-on-table-in-cassandra/](https://www.geeksforgeeks.org/operations-on-table-in-cassandra/)

在本文中，我们将通过一些示例练习来讨论像在 [Cassandra](https://www.geeksforgeeks.org/introduction-to-apache-cassandra/) 中创建、插入、截断、删除这样的表操作。让我们看看。

## 创建表格–注册:

首先，我们要创建一个表格，即注册，其中我们有`id`、`name`、`email`、`city`是字段。让我们看看。
