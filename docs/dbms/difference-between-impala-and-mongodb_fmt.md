...
> 原文: [https://www.geeksforgeeks.org/difference-between-impala-and-mongodb/](https://www.geeksforgeeks.org/difference-between-impala-and-mongodb/)
...
## 2. MongoDB
[`MongoDB`](https://www.geeksforgeeks.org/mongodb-an-introduction/) 是一个面向跨平台文档的非关系型(即 [`NoSQL`](https://www.geeksforgeeks.org/introduction-to-nosql/) )数据库程序。它是一个开源文档数据库，以键值对的形式存储数据。`MongoDB` 由 `MongoDB Inc.` 开发，最初于 2009 年 2 月 11 日发布。它是用 `C++`、`Go`、`JavaScript`、`Python` 语言编写的。`MongoDB` 提供了高速度、高可用性和高扩展性。
