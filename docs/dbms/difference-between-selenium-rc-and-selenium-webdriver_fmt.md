...
> 原文：[https://www.geeksforgeeks.org/difference-between-selenium-rc-and-selenium-webdriver/](https://www.geeksforgeeks.org/difference-between-selenium-rc-and-selenium-webdriver/)
...
| 没有。 | 硒 RC | 硒网络驱动程序 |
| --- | --- | --- |
| 1. | 这个`应用编程接口`支持特定的浏览器。 | 这是一个不绑定到特定浏览器的`应用编程接口`，即几乎每个浏览器都支持它。 |
