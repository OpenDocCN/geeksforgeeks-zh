...
> 原文：[https://www.geeksforgeeks.org/how-to-print-duplicate-rows-in-a-table/](https://www.geeksforgeeks.org/how-to-print-duplicate-rows-in-a-table/)
...
给定一个名为 `PERSON` 的表，任务是编写一个 SQL 查询来查找表中所有重复的名字。
...
是使用 `GROUP BY` 和 `HAVING` 条件。它比以前的更有效、更快。
