...
> 原文: [https://www.geeksforgeeks.org/difference-between-ddl-and-tcl/](https://www.geeksforgeeks.org/difference-between-ddl-and-tcl/)

## 先决条件
[SQL 命令](https://www.geeksforgeeks.org/sql-ddl-dql-dml-dcl-tcl-commands/)
...
| 7. | 一些常用的 `DDL` 命令：`CREATE`、`ALTER`、`DROP`。 | 一些常用的 `TCL` 命令：`COMMIT`、`ROLLBACK`。 |