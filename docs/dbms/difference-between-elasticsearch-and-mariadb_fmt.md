...
> 原文：[https://www.geeksforgeeks.org/difference-between-elasticsearch-and-mariadb/](https://www.geeksforgeeks.org/difference-between-elasticsearch-and-mariadb/)
...
| 9. | 就排名而言，它被认为高于马里亚数据库。 | 就排名而言，它被认为不如弹性搜索。 |
| 10. | 它接受所有带有`JVM`的操作系统。 | 它支持`LINUX`、`FreeBSD`、`Solaris`、`Windows`。 |