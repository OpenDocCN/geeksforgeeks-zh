...
> 原文：[https://www.geeksforgeeks.org/difference-between-k-means-and-dbscan-clustering/](https://www.geeksforgeeks.org/difference-between-k-means-and-dbscan-clustering/)
...
| **3.** | `K-means`聚类对大数据集更有效。 | `DBScan`聚类不能有效处理高维数据集。 |
...
| **7.** | 数据点密度的变化不影响`K-means`聚类算法。 | `DBScan`聚类对于稀疏数据集或密度变化的数据点效果不太好。 |