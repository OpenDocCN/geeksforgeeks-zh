...
> 原文：[https://www.geeksforgeeks.org/difference-between-mysql-and-msql/](https://www.geeksforgeeks.org/difference-between-mysql-and-msql/)
...
| 7. | `mSQL` 的 API 和其他访问方式有 [`JDBC`](https://www.geeksforgeeks.org/difference-odbc-jdbc/)、[`ODBC`](https://www.geeksforgeeks.org/difference-odbc-jdbc/)。 | `MySQL` 的 API 和其他访问方法有 ADO.NET、`JDBC`、`ODBC`、专有原生 API。 |
