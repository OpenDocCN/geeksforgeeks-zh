# Aerospike 和亚马逊 SimpleDB 的区别

> 原文: [https://www.geeksforgeeks.org/difference-between-aerospike-and-amazon-simpledb/](https://www.geeksforgeeks.org/difference-between-aerospike-and-amazon-simpledb/)
...
| 编号 | Aerospike | Amazon SimpleDB |
| :--- | :--- | :--- |
| 1. | 由 `Aerospike` 于 2012 年开发。 | 2007 年由亚马逊开发。 |
| 2. | 这是一个闪存优化的内存中 `NoSQL` 数据库。 | 它是由亚马逊托管的简单数据库服务，数据存储在亚马逊云中。 |
| 3. | `Aerospike` 的许可证是开源的。 | `Amazon SimpleDB` 的许可证是商业的。 |
| 4. | `Aerospike` 的服务器操作系统是 `Linux`。 | 在 `Amazon SimpleDB` 中，托管服务器操作系统。 |
