...
> 原文: [https://www.geeksforgeeks.org/basic-object-oriented-data-model/](https://www.geeksforgeeks.org/basic-object-oriented-data-model/)
...
在这个例子中，`student` 指的是类，`S1`、`S2` 是类的对象，可以在主函数中创建。
