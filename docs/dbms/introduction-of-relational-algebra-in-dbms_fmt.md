...
> 原文: [https://www.geeksforgeeks.org/introduction-of-relational-algebra-in-dbms/](https://www.geeksforgeeks.org/introduction-of-relational-algebra-in-dbms/)
...
### 重命名(ρ)
重命名是一元操作，用于重命名关系的属性。`ρ (a/b)R` 将关系的属性‘b’重命名为‘a’。
