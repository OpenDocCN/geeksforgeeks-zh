...
> 原文：[https://www.geeksforgeeks.org/file-organization-in-dbms-set-1/](https://www.geeksforgeeks.org/file-organization-in-dbms-set-1/)
...
读取下一个集合：[DBMS 文件组织 - 集合 2 | DBMS 中的哈希](https://www.geeksforgeeks.org/hashing-in-dbms/)