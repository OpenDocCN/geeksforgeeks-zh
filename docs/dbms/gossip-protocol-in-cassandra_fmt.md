...
> 原文：`https://www.geeksforgeeks.org/gossip-protocol-in-cassandra/`

在本文中，我们将简要地看一下在 `Apache Cassandra` 数据库中实现的流言协议。在本文中，我们将讨论 Gossip 协议以及 Cassandra 如何实现节点之间的协调以及节点如何保持同步。
