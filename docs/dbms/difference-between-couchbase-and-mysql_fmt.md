...
> 原文: [https://www.geeksforgeeks.org/difference-between-couchbase-and-mysql/](https://www.geeksforgeeks.org/difference-between-couchbase-and-mysql/)
...
| 10. | 像 `Oxylabs`、`凯迪`、`英摩威尔股份公司`、`Trendyol 集团` 等知名公司都使用 `Couchbase`。 | 像 `Airbnb`、`Pinterest`、`Slack`、`Udemy`、`Twitter` 等知名公司都使用 `MySQL`。 |