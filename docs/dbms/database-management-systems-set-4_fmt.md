...
> 原文:[https://www.geeksforgeeks.org/database-management-systems-set-4/](https://www.geeksforgeeks.org/database-management-systems-set-4/)
...
## 2. 考虑一个记录数足够多的关系表 `r`，它有属性 `A1`，`A2`，…，`An` 和 let `1 <= p <= n`。下面给出了两个查询。
