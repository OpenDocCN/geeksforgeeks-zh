# 马里亚数据库和微软 SQL Server 的区别

> 原文: [https://www.geeksforgeeks.org/difference-between-mariadb-and-ms-sql-server/](https://www.geeksforgeeks.org/difference-between-mariadb-and-ms-sql-server/)

## 1. 马里亚数据库
马里亚数据库是一个开源的`关系数据库管理系统(RDBMS)`，它是广泛使用的`MySQL`数据库技术的兼容插件替代。它由马里亚数据库基金会开发，最初于 2009 年 10 月 29 日发布。`MariaDB`的新功能数量显著增加，这使得它在性能和面向用户方面比`MySQL`更好。
...
| 9. | 技术文档: `mariadb.com/kb/en/library` | 技术文档: `docs.microsoft.com/en-ie/sql/sql-server/sql-server-technical-documentation` |