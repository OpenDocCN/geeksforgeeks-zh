# Adabas 与阿里巴巴云 MaxCompute 的区别

> 原文：[https://www.geeksforgeeks.org/difference-between-adabas-and-alibaba-cloud-maxcompute/](https://www.geeksforgeeks.org/difference-between-adabas-and-alibaba-cloud-maxcompute/)
...
| 8. | 它支持带有附加产品 Adabas SQL Gateway 的 SQL 查询语言。 | 它支持类似 SQL 的查询语言。 |
...
| 14. | 它支持 ACID 属性来执行操作。 | 它不支持 ACID 属性。 |
```