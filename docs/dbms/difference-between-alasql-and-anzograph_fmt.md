...
> 原文：[`https://www.geeksforgeeks.org/difference-between-alasql-and-anzograph/`](https://www.geeksforgeeks.org/difference-between-alasql-and-anzograph/)
...
| 3. | `AlaSQL` 的许可证是开源的。 | `AnzoGraph` 的许可证是商业的。 |
