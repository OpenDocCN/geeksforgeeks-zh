...
> 原文:[https://www . geeksforgeks . org/五大优势-apache-cassandra/](https://www.geeksforgeeks.org/five-main-benefits-of-apache-cassandra/)
...
## 1. `Scalability`
在 Cassandra 中，如果系统是可扩展的，那么您的业务就不会在流量高峰期错失机会。
...
## 2. `High Availability`
在 Cassandra 中，通过在不同位置和不同数据中心进行数据复制来实现高可用性。
