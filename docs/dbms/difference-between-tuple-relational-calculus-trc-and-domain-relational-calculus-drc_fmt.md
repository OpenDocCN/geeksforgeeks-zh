...
> 原文：[https://www.geeksforgeeks.org/difference-between-tuple-relational-calculus-trc-and-domain-relational-calculus-drc/](https://www.geeksforgeeks.org/difference-between-tuple-relational-calculus-trc-and-domain-relational-calculus-drc/)
...
| 符号：`{T | P (T)}` 或 `{T | 条件(T)}` | 符号：`{ a1, a2, a3, …, an | P (a1, a2, a3, …, an) }` |
| 示例：`{T | EMPLOYEE (T) 和 T.DEPT_ID = 10}` | 示例：`{ | <员工> DEPT_ID = 10 }` |