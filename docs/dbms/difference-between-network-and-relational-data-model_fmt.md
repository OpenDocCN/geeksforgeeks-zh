...
> 原文：[https://www.geeksforgeeks.org/difference-between-network-and-relational-data-model/](https://www.geeksforgeeks.org/difference-between-network-and-relational-data-model/)
...
| `UNIVAC` 的 `VAX-数据库管理系统`、`DMS-1100` 和 `超数据库管理系统` 都使用这种模型。 | 它主要用于现实世界的应用。甲骨文，`SQL`。 |