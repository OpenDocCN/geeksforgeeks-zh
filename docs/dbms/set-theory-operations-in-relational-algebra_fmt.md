...
> 原文: [https://www.geeksforgeeks.org/set-theory-operations-in-relational-algebra/](https://www.geeksforgeeks.org/set-theory-operations-in-relational-algebra/)
...
5. 此外，在 SQL 中，还有多集操作 `INTERSECT ALL`。
...
## 示例:
考虑下面给出的 `Student(FirstName, LastName)` 和 `Faculty(FirstName, LastName)` 之间的关系:
