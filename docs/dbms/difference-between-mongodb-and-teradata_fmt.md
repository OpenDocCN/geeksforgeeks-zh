...
> 原文：[https://www.geeksforgeeks.org/difference-between-mongodb-and-teradata/](https://www.geeksforgeeks.org/difference-between-mongodb-and-teradata/)
...
| five | `Adobe`、`Amadeus`、`Lyft`、`ViaVarejo`、`Craftbase` 等知名公司都使用 `MongoDB`。 | 像 `Cognizant`、`凯捷`、`aws`、`思科`、`花旗银行`等知名公司都使用 `Teradata`。 |
