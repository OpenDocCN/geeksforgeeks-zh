...
> 原文: [https://www.geeksforgeeks.org/domain-key-normal-form-in-dbms/](https://www.geeksforgeeks.org/domain-key-normal-form-in-dbms/)
...
考虑 `CAR(MAKE, vin#)` 和 `manufacturing(vin#, country)` 之间的关系，其中 `vin#` 代表车辆识别号，“country”代表生产国的名称。
