...
> 原文：[https://www.geeksforgeeks.org/difference-between-postgresql-and-hbase/](https://www.geeksforgeeks.org/difference-between-postgresql-and-hbase/)
...
| 5. | 它支持内存功能。 | 它不支持内存功能。 |
| 6. | `HBase` 使用可选择的复制因子。 | 它不使用可选择的复制因子。 |
