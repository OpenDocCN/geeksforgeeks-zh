...
> 原文：[https://www.geeksforgeeks.org/left-join-and-right-join-in-ms-sql-server/](https://www.geeksforgeeks.org/left-join-and-right-join-in-ms-sql-server/)

## 先决条件

[微软 SQL Server 简介](https://www.geeksforgeeks.org/introduction-of-ms-sql-server/)
...
将显示左表和右表中相应的匹配行。如果用户希望只显示左表中的行，可以在查询中使用`WHERE`子句。左连接通常最多用于两个表，但是对于 SQL Server，它也可以用于多个表。
