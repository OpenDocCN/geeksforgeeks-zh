...
> 原文: [https://www.geeksforgeeks.org/unique-constraint-in-ms-sql-server/](https://www.geeksforgeeks.org/unique-constraint-in-ms-sql-server/)
...
## 结果
违反唯一键约束 'UQ__Student__EBE41F7A3D93XXXX'。无法在对象“学生”中插入重复的键。
重复键值为 (111)。
声明已经终止。
