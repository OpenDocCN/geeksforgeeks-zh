...
> 原文：[https://www.geeksforgeeks.org/difference-between-alibaba-cloud-apsaradb-for-polardb-and-alibaba-cloud-log-service/](https://www.geeksforgeeks.org/difference-between-alibaba-cloud-apsaradb-for-polardb-and-alibaba-cloud-log-service/)

## 1. 阿里巴巴云宝丽来数据库
宝丽来数据库是一个云原生关系数据库，兼容 `MySQL`、`Postgresql` 和甲骨文。`ApsaraDB` 架构在单个集群中支持 5000 台物理机。它是为需要快速性能、高并发性和自动扩展的关键业务数据库应用程序而设计的。
