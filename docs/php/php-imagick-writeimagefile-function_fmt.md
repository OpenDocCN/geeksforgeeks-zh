...
> 原文：[https://www.geeksforgeeks.org/php-imagick-writeimagefile-function/](https://www.geeksforgeeks.org/php-imagick-writeimagefile-function/)

`Imagick::WriteImageFile()` 函数是 PHP 中的一个内置函数，用于将图像序列写入打开的文件句柄。句柄必须用 `fopen` 打开。
