# PHP Imagick::colorFloodfillImage() 函数
...
`Imagick::colorFloodfillImage()` 函数是 PHP 中的一个内置函数，用于更改与目标匹配的任何像素的颜色值。
...
[https://www.php.net/manual/en/imagick.colorfloodfillimage.php](https://www.php.net/manual/en/imagick.colorfloodfillimage.php)