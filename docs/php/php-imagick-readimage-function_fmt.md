...
`Imagick::readImage()` 函数是 PHP 中的一个内置函数，用于从文件名读取图像。
...
此函数接受保存文件名的单个参数 `$filename`。它还可以接受文件的 URL。
...
[https://www.php.net/manual/en/imagick.readimage.php](https://www.php.net/manual/en/imagick.readimage.php)