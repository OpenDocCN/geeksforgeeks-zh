...
此函数接受单个参数 `$threshold`，该参数是必需的。所有低于阈值的像素值，所有内容都变为黑色。
...
[http://php.net/manual/en/imagick.blackthresholdimage.php](http://php.net/manual/en/imagick.blackthresholdimage.php)