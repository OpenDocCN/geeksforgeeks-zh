# ImagickDraw::setTextInterlineSpacing() 函数
...
`ImagickDraw::setTextInterlineSpacing()` 函数是 PHP 中的内置函数，用于设置文本行间间距。
...
[https://www.php.net/manual/en/imagickdraw.settextinterlinespacing.php](https://www.php.net/manual/en/imagickdraw.settextinterlinespacing.php)