...
`Imagick::implodeImage()`函数是 PHP 中的一个内置函数，用于创建一个新图像作为副本。
...
[https://www.php.net/manual/en/imagick.implodeimage.php](https://www.php.net/manual/en/imagick.implodeimage.php)