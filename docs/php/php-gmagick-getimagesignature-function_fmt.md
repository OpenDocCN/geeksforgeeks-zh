...
`Gmagick::getimagesignature()` 函数是 PHP 中的一个内置函数，用于为图像生成 SHA-256 消息摘要。
...
此函数返回文件的 SHA-256 散列字符串。

下面的程序演示了 PHP 中的 `Gmagick::getimagesignature()` 函数：
...
[http://php.net/manual/en/gmagick.getimagesignature.php](http://php.net/manual/en/gmagick.getimagesignature.php)