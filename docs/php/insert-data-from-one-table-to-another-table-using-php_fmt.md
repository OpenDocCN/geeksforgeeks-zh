...
> 原文: [https://www.geeksforgeeks.org/insert-data-from-one-table-to-another-table-using-php/](https://www.geeksforgeeks.org/insert-data-from-one-table-to-another-table-using-php/)
...
*   打开 XAMPP 服务器，启动 Apache 和 MySQL。
    ![](img/41c4153114914c5527c2d1b962362b62.png)
*   打开浏览器，输入 `localhost/phpmyadmin`。[创建](https://www.geeksforgeeks.org/sql-create/)一个名为 `geeks_database` 的数据库。
    ![](img/f873665bbf073d953d81d7ec8a7dddef.png)
*   现在[创建一个名为 `table1` 的表](https://www.geeksforgeeks.org/sql-create/)，表 1 有 4 列，点击保存。
    ![](img/5cb1e1c1098375e4738cd2c4fb231326.png)
*   在数据库服务器中打开 SQL 列，并[插入](https://www.geeksforgeeks.org/sql-insert-statement/)记录。
    ![](img/65f829231290fb4bfb97b8dfb26fe9fb.png)
    ![](img/0dcb558aa74429f81f47b02a0f4a31cb.png)

## MySQL 代码

以下是在表 1 中插入数据的 SQL 语句。
...
*   在 XAMPP SQL server 的同一个数据库 `geeks_database` 中编写创建 `table2` 的语句。
    ![](img/5a1fc4e2ca193c7d70d9dd52278b16dd.png)
*   现在使用 PHP 代码从 `table1` 向 `table2` 插入记录。
...
*   将此代码保存为 `xampp->htdocs` 文件夹下的 `copy_data.php`。
*   **输出:**
*   打开浏览器并输入 `http://localhost/copying_data.php`。
    ![](img/f8657a534f4f4b96d38d7b36e8425190.png)
*   最后，查看您的 `table2`。表 1 数据复制成功。