# PHP Imagick::importImagePixels() 函数
...
`Imagick::importImagePixels()` 函数是 PHP 中的内置函数，用于将像素从数组导入图像。
...
下面给出的程序演示了 PHP 中的 `Imagick::importImagePixels()` 函数：
...
[https://www.php.net/manual/en/imagick.importimagepixels.php](https://www.php.net/manual/en/imagick.importimagepixels.php)