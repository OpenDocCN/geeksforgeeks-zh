...
`Imagick::getFormat()` 函数是 PHP 中的一个内置函数，用于获取 `Imagick` 对象的格式。
...
[https://www.php.net/manual/en/imagick.getformat.php](https://www.php.net/manual/en/imagick.getformat.php)