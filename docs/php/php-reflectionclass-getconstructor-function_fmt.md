# ReflectionClass::getConstructor() 函数
...
`ReflectionClass::getConstructor()` 函数是 PHP 中的一个内置函数，用于返回指定类的构造函数，如果该类没有任何构造函数，则返回 `NULL`。
...
此函数返回指定类的构造函数，如果该类没有任何构造函数，则返回 `NULL`。
...
[https://www.php.net/manual/en/reflectionclass.getconstructor.php](https://www.php.net/manual/en/reflectionclass.getconstructor.php)