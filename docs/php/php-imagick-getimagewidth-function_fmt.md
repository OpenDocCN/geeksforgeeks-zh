...
下面的程序说明了 PHP 中的 `Imagick::getImageWidth()` 函数：
...
$image = new Imagick('https://media.geeksforgeeks.org/wp-content/uploads/geeksforgeeks-15.png');
...
[http://php.net/manual/en/imagick.getimagewidth.php](http://php.net/manual/en/imagick.getimagewidth.php)