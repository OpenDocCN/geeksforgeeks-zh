...
> 原文: [https://www.geeksforgeeks.org/php-arrayobject-serialize-function/](https://www.geeksforgeeks.org/php-arrayobject-serialize-function/)

`ArrayObject::serialize()`函数是 PHP 中的一个内置函数，用于序列化 `ArrayObject`。
...
[https://www.php.net/manual/en/arrayobject.serialize.php](https://www.php.net/manual/en/arrayobject.serialize.php)