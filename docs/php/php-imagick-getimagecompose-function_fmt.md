...
`Imagick::getImageCompose()` 函数是 PHP 中的一个内置函数，用于获取与图像相关联的复合运算符。
...
[https://www.php.net/manual/en/imagick.getimagecompose.php](https://www.php.net/manual/en/imagick.getimagecompose.php)