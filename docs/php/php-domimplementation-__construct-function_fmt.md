# DOMImplementation::__construct() 函数
...
`DOMImplementation::__construct()` 函数是 PHP 中的内置函数，用于创建新的 `DOMImplementation` 对象。
...
[https://www.php.net/manual/en/domimplementation.construct.php](https://www.php.net/manual/en/domimplementation.construct.php)