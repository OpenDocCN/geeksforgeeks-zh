...
`Imagick::queryFonts` 函数是 PHP 中的内置函数，用于返回 Imagick 库的配置字体。
...
[http://php.net/manual/en/imagick.queryfonts.php](http://php.net/manual/en/imagick.queryfonts.php)