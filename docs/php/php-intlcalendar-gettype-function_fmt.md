...
`IntlCalendar::getType()` 函数是 PHP 中的一个内置函数，用于获取字符串形式的日历类型。“日历”是关键字的有效值。
...
此函数接受单个参数 `$cal`，该参数保存 `IntlCalendar` 的资源。
...
[https://www.php.net/manual/en/intlcalendar.gettype.php](https://www.php.net/manual/en/intlcalendar.gettype.php)