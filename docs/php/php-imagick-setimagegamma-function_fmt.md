...
`Imagick::setImageGamma()`函数是 PHP 中的内置函数，用于设置图像 Gamma。
...
此函数接受单个参数 `$gamma`，该参数保存图像的 Gamma。
...
[https://www.php.net/manual/en/imagick.setimagegamma.php](https://www.php.net/manual/en/imagick.setimagegamma.php)