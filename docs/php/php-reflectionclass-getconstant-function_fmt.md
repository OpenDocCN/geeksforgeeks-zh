...
`ReflectionClass::getConstant()` 函数是 PHP 中的内置函数，用于返回定义的常量的值。
...
[https://www.php.net/manual/en/reflectionclass.getconstant.php](https://www.php.net/manual/en/reflectionclass.getconstant.php)