...
`Imagick::mapImage()` 函数是 PHP 中的一个内置函数，用于用与参考图像最接近的颜色替换图像的颜色。
...
[https://www.php.net/manual/en/imagick.mapimage.php](https://www.php.net/manual/en/imagick.mapimage.php)