...
`Imagick::setImageBackround Color()`函数是 PHP 中的一个内置函数，用于设置图像背景颜色。
...
## 引用：
[https://www.php.net/manual/en/imagick.setimagebackgroundcolor.php](https://www.php.net/manual/en/imagick.setimagebackgroundcolor.php)