...
`ArrayIterator::natsort()`函数是 PHP 中的一个内置函数，用来对数组进行自然排序。
...
[https://www.php.net/manual/en/arrayiterator.natsort.php](https://www.php.net/manual/en/arrayiterator.natsort.php)