...
该函数接受单个参数 `$scale` ，并且是 int 类型，是强制的。此参数告诉所有 bc 数学函数的函数调用结果中小数点后出现的位数。它的默认值为零。
...
[http://php.net/manual/en/function.bcscale.php](http://php.net/manual/en/function.bcscale.php)