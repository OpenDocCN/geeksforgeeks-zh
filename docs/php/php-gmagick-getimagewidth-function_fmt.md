...
`Gmagick::getimagewidth()` 函数是 PHP 中的一个内置函数，用于获取图像宽度，即图像的水平长度。
...
[https://www.php.net/manual/en/gmagick.getimagewidth.php](https://www.php.net/manual/en/gmagick.getimagewidth.php)