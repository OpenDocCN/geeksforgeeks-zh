...
> 原文：[https://www.geeksforgeeks.org/what-is-the-difference-between-a-language-construct-and-a-built-in-function-in-php/](https://www.geeksforgeeks.org/what-is-the-difference-between-a-language-construct-and-a-built-in-function-in-php/)
...
```php
<?php
/* PHP program to use unset function */
$arr = array(
    "1" => "Amit",
    "2" => "Rajeev",
    "3" => "Mohit",
...
// Use unset function to unset element
unset($arr["2"]);
