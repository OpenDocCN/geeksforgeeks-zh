...
`Imagick::setPointSize()`函数是 PHP 中的内置函数，用于设置 Imagick 对象的磅大小。
...
此函数接受单个参数`$point_size`，该参数保存点的大小。
...
[https://www.php.net/manual/en/imagick.setpointsize.php](https://www.php.net/manual/en/imagick.setpointsize.php)