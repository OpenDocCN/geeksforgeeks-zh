...
> 原文：[https://www.geeksforgeeks.org/php-dssequence-pop-function/](https://www.geeksforgeeks.org/php-dssequence-pop-function/)

`Ds\Sequence::pop()` 函数是 PHP 中的一个内置函数，它从 Sequence 中删除最后一个值并返回它。
