...
> 原文：[https://www.geeksforgeeks.org/how-to-validate-an-email-using-php/](https://www.geeksforgeeks.org/how-to-validate-an-email-using-php/)
...
**说明：** 在上例中，将输入的邮件地址传递给预定义函数 `filter_var()`，该函数以两个参数作为输入邮件，第二个参数是邮件过滤器的类型。该功能过滤邮件并返回真或假。
