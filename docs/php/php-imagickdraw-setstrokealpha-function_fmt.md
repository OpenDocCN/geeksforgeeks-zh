...
此函数接受单个参数 `$opacity`，该参数用于指定笔划对象的透明度。它是浮点值，介于 0 和 1 之间。
...
[http://php.net/manual/en/imagickdraw.setstrokealpha.php](http://php.net/manual/en/imagickdraw.setstrokealpha.php)