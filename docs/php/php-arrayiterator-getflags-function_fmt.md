...
`ArrayIterator::getFlags()`是 PHP 中的一个内置函数，用来获取数组迭代器的标志行为。
...
[https://www.php.net/manual/en/arrayiterator.getflags.php](https://www.php.net/manual/en/arrayiterator.getflags.php)