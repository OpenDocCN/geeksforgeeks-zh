...
`ReflectionFunction::invokeArgs()` 函数是 PHP 中的内置函数，用于返回调用的函数调用的结果。
...
此函数接受单个参数 `$args`，该参数保存传递给被调用函数的参数数组。
...
[https://www.php.net/manual/en/reflectionfunction.invokeargs.php](https://www.php.net/manual/en/reflectionfunction.invokeargs.php)