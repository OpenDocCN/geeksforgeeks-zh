...
`ReflectionClass::getStaticProperties()` 函数是 PHP 中的内置函数，用于返回静态属性数组。 此函数目前没有文档，但有其参数列表。
...
以下程序说明 PHP 中的 `ReflectionClass::getStaticProperties()` 函数：
...
[https://www.php.net/manual/en/reflectionclass.getstaticproperties.php](https://www.php.net/manual/en/reflectionclass.getstaticproperties.php)