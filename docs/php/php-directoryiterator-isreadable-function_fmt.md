...
`DirectoryIterator::isReadable()` 函数是 PHP 中的内置函数，用于检查当前 `DirectoryIterator` 项是否可读。
...
[https://www.php.net/manual/en/directoryiterator.isreadable.php](https://www.php.net/manual/en/directoryiterator.isreadable.php)