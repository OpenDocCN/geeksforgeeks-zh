...
`Gmagick::read()` 函数是 PHP 中的一个内置函数，用于从本地文件夹读取图像并将其添加到 `Gmagick` 对象。
...
[https://www.php.net/manual/en/gmagick.read.php](https://www.php.net/manual/en/gmagick.read.php)