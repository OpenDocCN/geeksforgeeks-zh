...
> 原文: [https://www.geeksforgeeks.org/how-to-create-a-table-in-pdf-file-from-external-text-files-using-php/](https://www.geeksforgeeks.org/how-to-create-a-table-in-pdf-file-from-external-text-files-using-php/)
...
**方法:** 你需要从 [FPDF 网站](http://www.fpdf.org/) [下载](http://www.fpdf.org/en/download.php) `FPDF` 类，并将其包含在你的 PHP 脚本中。
...
**employees.txt:** 以下是上述 PHP 文件中使用的文件 `employees.txt` 的内容。
