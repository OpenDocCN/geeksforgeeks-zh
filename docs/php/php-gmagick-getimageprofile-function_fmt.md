...
`Gmagick::getimageprofile()` 函数是 PHP 中的一个内置函数，用于获取命名的图像配置文件。
...
[https://www.php.net/manual/en/gmagick.getimageprofile.php](https://www.php.net/manual/en/gmagick.getimageprofile.php)