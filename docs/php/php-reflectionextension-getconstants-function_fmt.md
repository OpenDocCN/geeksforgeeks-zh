...
`ReflectionExtension::getConstants()` 函数是 PHP 中的内置函数，用于返回常量名称作为键的关联数组。
...
[https://www.php.net/manual/en/reflectionextension.getconstants.php](https://www.php.net/manual/en/reflectionextension.getconstants.php)