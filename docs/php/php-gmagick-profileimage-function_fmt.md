...
`Gmagick::profileimage()` 函数是 PHP 中的一个内置函数，用于在图像中添加或删除配置文件。
...
[https://www.php.net/manual/en/gmagick.profileimage.php](https://www.php.net/manual/en/gmagick.profileimage.php)