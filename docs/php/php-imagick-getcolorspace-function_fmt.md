...
`Imagick::getColorspace()` 函数是 PHP 中的一个内置函数，用于获取图像的全局色彩空间值。
...
此函数返回一个整数值，可以与[颜色空间常量](https://www.php.net/manual/en/imagick.constants.php#imagick.constants.colorspace-undefined)进行比较。
...
[https://www.php.net/manual/en/imagick.getcolorspace.php](https://www.php.net/manual/en/imagick.getcolorspace.php)