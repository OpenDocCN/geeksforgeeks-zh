...
## ImagickDraw::pathCurveToSmoothRelative() 函数

`ImagickDraw::pathCurveToSmoothRelative()` 函数是 PHP 中的一个内置函数，用于使用相对坐标绘制从当前点到 (`x`, `y`) 的三次贝塞尔曲线。
...
[https://www.php.net/manual/en/imagickdraw.pathcurvetosmoothrelative.php](https://www.php.net/manual/en/imagickdraw.pathcurvetosmoothrelative.php)