...
`Imagick::setImageIndex()` 函数是 PHP 中的内置函数，用于设置迭代器位置。
...
[https://www.php.net/manual/en/imagick.setimageindex.php](https://www.php.net/manual/en/imagick.setimageindex.php)