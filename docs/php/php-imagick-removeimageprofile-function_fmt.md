...
`Imagick::removeImageProfile()` 函数是 PHP 中的一个内置函数，用于删除命名的图像配置文件。
...
[https://www.php.net/manual/en/imagick.removeimageprofile.php](https://www.php.net/manual/en/imagick.removeimageprofile.php)