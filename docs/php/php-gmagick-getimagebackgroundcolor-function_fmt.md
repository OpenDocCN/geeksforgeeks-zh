# PHP Gmagick getimagebackgroundcolor() 函数
...
`Gmagick::getimagebackgroundcolor()` 函数是 PHP 中的一个内置函数，用于获取图像背景颜色。
...
下面给出的程序演示了 PHP 中的 `Gmagick::getimagebackgroundcolor()` 函数：
...
[https://www.php.net/manual/en/gmagick.getimagebackgroundcolor.php](https://www.php.net/manual/en/gmagick.getimagebackgroundcolor.php)