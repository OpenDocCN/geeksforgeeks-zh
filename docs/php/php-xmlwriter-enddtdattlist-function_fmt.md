...
`XMLWriter::endDtdAttlist()` 函数是 PHP 中的内置函数，用于结束当前的 DTD AttList。DTD 是 Document Type Definition 的缩写，它定义了 XML 文档的结构、合法元素和属性。DTD 在网页中不可见，因为它们的行为类似于注释。在 DTD 中，属性是用 `ATTLIST` 声明声明的。
...
[https://www.php.net/manual/en/function.xmlwriter-end-dtd-attlist.php](https://www.php.net/manual/en/function.xmlwriter-end-dtd-attlist.php)