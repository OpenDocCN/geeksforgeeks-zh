...
`Gmagick::cropthumbnailimage()` 函数是 PHP 中的一个内置函数，用于通过缩小图像，然后从中心裁剪指定区域来创建固定大小的缩略图。
...
以下程序说明 PHP 中的 `Gmagick::cropthumbnailimage()` 函数。
...
[http://php.net/manual/en/gmagick.cropthumbnailimage.php](http://php.net/manual/en/gmagick.cropthumbnailimage.php)