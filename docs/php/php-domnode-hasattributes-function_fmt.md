...
`DOMNode::hasAttributes()` 函数是 PHP 中的一个内置函数，用于检查节点是否有属性。
...
[https://www.php.net/manual/en/domnode.hasattributes.php](https://www.php.net/manual/en/domnode.hasattributes.php)