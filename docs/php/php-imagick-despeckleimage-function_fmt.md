...
`Imagick::despeckleImage()` 函数是 PHP 中的一个内置函数，用于减少图像中的斑点噪声，同时保留原始图像的边缘。
...
下面的程序演示了 PHP 中的 `Imagick::despeckleImage()` 函数：
...
/*Imagick Object*/
$image = new \Imagick('https://media.geeksforgeeks.org/wp-content/uploads/geeksforgeeks-17.png');
