...
`ImagickDraw::pathLineToHorizontalRelative()` 函数是 PHP 中的内置函数，用于使用相对坐标绘制从当前点到目标点的水平线路径。然后，目标点将成为新的当前点。
...
下面给定的程序说明了 PHP 中的 `ImagickDraw::pathLineToHorizontalRelative()` 函数：
...
[https://www.php.net/manual/en/imagickdraw.pathlinetohorizontalrelative.php](https://www.php.net/manual/en/imagickdraw.pathlinetohorizontalrelative.php)