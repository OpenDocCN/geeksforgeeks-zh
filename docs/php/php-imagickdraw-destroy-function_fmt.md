...
`ImagickDraw::destroy()` 函数是 PHP 中的一个内置函数，用于释放与 `ImagickDraw` 对象关联的所有资源。
...
[https://www.php.net/manual/en/imagickdraw.destroy.php](https://www.php.net/manual/en/imagickdraw.destroy.php)