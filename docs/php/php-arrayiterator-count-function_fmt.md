...
`ArrayIterator::count()`函数是 PHP 中的一个内置函数，用于对数组迭代器的元素进行计数。
...
**参考:** [https://www.php.net/manual/en/arrayiterator.count.php](https://www.php.net/manual/en/arrayiterator.count.php)