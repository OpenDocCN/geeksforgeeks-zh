...
此函数接受单个参数 `$capacity`，该参数表示分配的容量数量。

## 返回值

此函数不返回任何值。

下面的程序说明了 PHP 中的 `Ds\Sequence::allocate()` 函数：
...
[http://php.net/manual/en/ds-sequence.allocate.php](http://php.net/manual/en/ds-sequence.allocate.php)