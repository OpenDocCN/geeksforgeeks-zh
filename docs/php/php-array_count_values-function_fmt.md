...
> 原文: [https://www.geeksforgeeks.org/php-array_count_values-function/](https://www.geeksforgeeks.org/php-array_count_values-function/)
...
该功能接受单参数`$array`。这个参数是我们需要计算其中存在的值的计数的数组。
