...
> 原文：[https://www.geeksforgeeks.org/how-to-convert-first-character-of-all-the-words-uppercase-using-php/](https://www.geeksforgeeks.org/how-to-convert-first-character-of-all-the-words-uppercase-using-php/)
...
第二个参数（分隔符）是可选的。如果我们不提它，那么它会将空格后的所有单词大写。 [`echo`](https://www.geeksforgeeks.org/php-echo-print/) 关键字用于在屏幕上打印输出。
