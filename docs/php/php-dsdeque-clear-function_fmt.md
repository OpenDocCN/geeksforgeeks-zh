...
> 原文：[https://www.geeksforgeeks.org/php-dsdeque-clear-function/](https://www.geeksforgeeks.org/php-dsdeque-clear-function/)
...
[http://php.net/manual/en/ds-deque.clear.php](http://php.net/manual/en/ds-deque.clear.php)