# `SplObjectStorage::valid()` 函数

> 原文：[https://www.geeksforgeeks.org/php-splobjectstorage-valid-function/](https://www.geeksforgeeks.org/php-splobjectstorage-valid-function/)
...
如果迭代器条目有效，则此函数返回 `TRUE`，否则返回 `FALSE`。
...
[https://www.php.net/manual/en/splobjectstorage.valid.php](https://www.php.net/manual/en/splobjectstorage.valid.php)