...
`ImagickDraw::clone()` 函数是 PHP 中的一个内置函数，用于精确复制指定的 `ImagickDraw` 对象。
...
成功时返回指定 `ImagickDraw` 对象的精确副本，失败时返回错误。
...
[https://www.php.net/manual/en/imagickdraw.clone.php](https://www.php.net/manual/en/imagickdraw.clone.php)