...
**DirectoryIterator::key()** 函数是 PHP 中的内置函数，用于返回当前 `DirectoryIterator` 项的键。
...
[https://www.php.net/manual/en/directoryiterator.key.php](https://www.php.net/manual/en/directoryiterator.key.php)