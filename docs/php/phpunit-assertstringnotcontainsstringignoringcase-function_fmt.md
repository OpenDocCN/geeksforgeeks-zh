...
## 注意：要使用 `phpunit` 运行测试用例，请执行此处[中的步骤](https://www.jetbrains.com/help/phpstorm/using-phpunit-framework.php)。 此外，phpunit 7 及更高版本支持 `assertStringNotContainsStringIgnoringCase()`。