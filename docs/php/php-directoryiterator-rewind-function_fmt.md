...
`DirectoryIterator::rewind()`函数是 PHP 中的一个内置函数，用于将 `DirectoryIterator` 倒回到开始位置。
...
[https://www.php.net/manual/en/directoryiterator.rewind.php](https://www.php.net/manual/en/directoryiterator.rewind.php)