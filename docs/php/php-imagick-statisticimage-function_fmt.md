...
`Imagick::statisticImage()` 函数是 PHP 中的一个内置函数，用于用指定宽度和高度附近的相应统计数据替换每个像素。
...
下面的程序演示了 PHP 中的 `Imagick::statisticImage()` 函数：
...
*   [PHP|Imagick chopImage()函数](https://www.geeksforgeeks.org/php-imagick-chopimage-function/)
*   [PHP|Imagick vignetteImage()函数](https://www.geeksforgeeks.org/php-imagick-vignetteimage-function/)

## 引用

[http://php.net/manual/en/imagick.statisticimage.php](http://php.net/manual/en/imagick.statisticimage.php)