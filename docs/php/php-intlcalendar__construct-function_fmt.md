...
`IntlCalendar::__construct()` 函数是 PHP 中的一个内置函数，用于创建用于禁止实例化的私有构造函数。
...
[https://www.php.net/manual/en/intlcalendar.construct.php](https://www.php.net/manual/en/intlcalendar.construct.php)