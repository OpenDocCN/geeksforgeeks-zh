# ReflectionClass::isCloneable()函数
...
`ReflectionClass::isCloneable()`函数是 PHP 中的内置函数，用于检查指定的类是否可克隆。
...
[https://www.php.net/manual/en/reflectionclass.iscloneable.php](https://www.php.net/manual/en/reflectionclass.iscloneable.php)