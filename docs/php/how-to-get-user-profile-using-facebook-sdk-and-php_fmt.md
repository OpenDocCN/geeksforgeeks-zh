...
> 原文：[https://www.geeksforgeeks.org/how-to-get-user-profile-using-facebook-sdk-and-php/](https://www.geeksforgeeks.org/how-to-get-user-profile-using-facebook-sdk-and-php/)
...
*   PHP5 及以上
*   通过取消对行 `extension=mbstring` 的注释，在 `php.ini` 文件中启用 `mbstring` 扩展名。
...
1.  请转到[链接](https://developers.facebook.com/)创建应用程序标识和应用程序密钥，并记下以便在 PHP 代码中使用。
...
下面的示例代码演示了，如何使用 FaceBook SDK 访问当前用户名并打印出来，以及使用 PHP 的 Graph API。
