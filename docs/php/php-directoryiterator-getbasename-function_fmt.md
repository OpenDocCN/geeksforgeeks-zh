...
`DirectoryIterator::getBasename()` 函数是 PHP 中的内置函数，用于获取当前 `DirectoryIterator` 项的基本名称。
...
此函数接受单个参数 `$suffix`，该参数保存以后缀结尾的基本名称。

## 返回值

此函数返回当前 `DirectoryIterator` 项的基本名称。
...
[https://www.php.net/manual/en/directoryiterator.getbasename.php](https://www.php.net/manual/en/directoryiterator.getbasename.php)