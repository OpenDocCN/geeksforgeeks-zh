...
> 原文：[https://www.geeksforgeeks.org/difference-between-break-and-continue-in-php/](https://www.geeksforgeeks.org/difference-between-break-and-continue-in-php/)

`break`和`continue`都用于跳过循环的迭代。这些关键词有助于控制程序的流程。
