...
`Imagick::getImageAlphaChannel()` 函数是 PHP 中的一个内置函数，用于获取图像 Alpha 通道。返回值是 [ALPHACHANNEL 常量](https://www.php.net/manual/en/imagick.constants.php#imagick.constants.alphachannel) 之一。
...
*   `Imagick::ALPHACHANNEL_TRANSPECTION` (9)
