...
`Imagick::removeImage()` 函数是 PHP 中的一个内置函数，用于从图像列表中删除图像。此函数用于删除光标指向的当前图像。
...
[https://www.php.net/manual/en/imagick.removeimage.php](https://www.php.net/manual/en/imagick.removeimage.php)