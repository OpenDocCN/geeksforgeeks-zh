...
> 原文：[https://www.geeksforgeeks.org/how-to-generate-pdf-file-and-add-truetype-fonts-using-php/](https://www.geeksforgeeks.org/how-to-generate-pdf-file-and-add-truetype-fonts-using-php/)
...
*   **第一步：** 你需要从 [FPDF 网站](http://www.fpdf.org/)下载 `FPDF` 类，并将其包含在你的 PHP 脚本中。
