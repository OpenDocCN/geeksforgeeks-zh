...
这个函数接受两个参数，如上所述，如下所述:

*   `$class_name`: It holds the class names that need to be checked for their existence.
*   `$autoload`: By default, check whether `__autoload` is called.

## 返回值:

如果定义了类名，该函数返回真，否则返回假。
...
**参考:**[https://www.php.net/manual/en/function.class-exists.php](https://www.php.net/manual/en/function.class-exists.php)