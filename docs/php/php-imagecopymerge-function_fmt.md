...
$dest = imagecreatefromgif('https://media.geeksforgeeks.org/wp-content/uploads/animateImages.gif');
$src = imagecreatefromgif('https://media.geeksforgeeks.org/wp-content/uploads/slider.gif');
...
<?php
// Create image instances
$dest = imagecreatefrompng('https://media.geeksforgeeks.org/wp-content/uploads/geeksforgeeks-9.png');
...
[http://php.net/manual/en/function.imagecopymerge.php](http://php.net/manual/en/function.imagecopymerge.php)