...
`imagegif()` 函数是 PHP 中的一个内置函数，用于从给定的图像创建 GIF 图像文件。如果图像已经通过 `imagecolortransparent()` 函数转换为透明的，则将生成 GIF89a 图像格式，否则将生成 GIF87a 图像格式。
...
$png = imagecreatefrompng('https://media.geeksforgeeks.org/wp-content/uploads/geeksforgeeks-9.png');
...
[http://php.net/manual/en/function.imagegif.php](http://php.net/manual/en/function.imagegif.php)