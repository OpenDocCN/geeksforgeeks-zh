...
`IntlCalendar::getTime()`函数是 PHP 中的一个内置函数，用于返回对象当前表示的时间。时间以自纪元以来的毫秒为单位表示。
...
此函数返回一个浮点数，表示自纪元(1970 年 1 月 1 日 00:00:00 UTC)以来经过的毫秒数。
...
[https://www.php.net/manual/en/intlcalendar.gettime.php](https://www.php.net/manual/en/intlcalendar.gettime.php)