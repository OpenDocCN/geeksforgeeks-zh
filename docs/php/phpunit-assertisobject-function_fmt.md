...
> Original: `https://www.geeksforgeeks.org/phpunit-assertisobject-function/`
...
**引用：** `https://phpunit.readthedocs.io/en/9.2/assertions.html#assertisobject`