...
> 原文：[https://www.geeksforgeeks.org/convert-multidimensional-array-to-xml-file-in-php/](https://www.geeksforgeeks.org/convert-multidimensional-array-to-xml-file-in-php/)
...
function generateXML($data) {
    ...
    $root = $xmlDoc -> appendChild($xmlDoc -> createElement("geeks"));
