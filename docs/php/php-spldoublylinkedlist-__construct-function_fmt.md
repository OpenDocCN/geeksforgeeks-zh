...
`SplDoublyLinkedList::__construct()` 函数是 PHP 中的内置函数，用于创建新的空双向链表。
...
[https://www.php.net/manual/en/spldoublylinkedlist.construct.php](https://www.php.net/manual/en/spldoublylinkedlist.construct.php)