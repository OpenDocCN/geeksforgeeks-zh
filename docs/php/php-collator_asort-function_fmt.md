...
*   `$sort_flag`: is an optional parameter used to define the sort method, one of the following:
    *   `Collator::SORT_REGULAR`: Normal comparison items. This is the default sort.
    *   `Collator::SORT_NUMERIC`: It compares items with numbers.
    *   `Collator::SORT_STRING`: It compares items as strings.
...
[http://php.net/manual/en/collator.asort.php](http://php.net/manual/en/collator.asort.php)