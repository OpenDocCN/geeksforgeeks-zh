...
`Gmagick::despeckleimage()` 函数是 PHP 中的一个内置函数，用于减少图像中的斑点噪声，同时保留原始图像的边缘。
...
下面给出的程序演示了 PHP 中的 `Gmagick::despeckleimage()` 函数：
...
[https://www.php.net/manual/en/gmagick.despeckleimage.php](https://www.php.net/manual/en/gmagick.despeckleimage.php)