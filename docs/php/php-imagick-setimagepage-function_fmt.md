...
`Imagick::setImagePage()` 函数是 PHP 中的一个内置函数，用于设置图像页面几何图形。
...
[https://www.php.net/manual/en/imagick.setimagepage.php](https://www.php.net/manual/en/imagick.setimagepage.php)