...
该函数接受单个参数 `$value`。这是您要查找其反正切值的数字。此参数的值必须以弧度为单位。

## 返回值:

返回一个浮点数，该浮点数是作为参数传递给它的数的反正切值。
...
[http://php.net/manual/en/function.atan.php](http://php.net/manual/en/function.atan.php)