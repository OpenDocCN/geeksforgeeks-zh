...
`Imagick::setImageExtent()` 函数是 PHP 中的内置函数，用于设置图像大小。 此函数不会缩放图像，但会裁剪不需要的部分。
...
[https://www.php.net/manual/en/imagick.setimageextent.php](https://www.php.net/manual/en/imagick.setimageextent.php)