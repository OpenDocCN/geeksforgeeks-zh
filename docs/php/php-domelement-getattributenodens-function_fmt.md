...
`DOMElement::getAttributeNodeNS()` 函数是 PHP 中的一个内置函数，用于获取当前节点具有本地名称的特定名称空间中的属性节点。
...
[https://www.php.net/manual/en/domelement.getattributenodens.php](https://www.php.net/manual/en/domelement.getattributenodens.php)