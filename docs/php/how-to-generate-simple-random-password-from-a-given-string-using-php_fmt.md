...
> 原文: [https://www.geeksforgeeks.org/how-to-generate-simple-random-password-from-a-given-string-using-php/](https://www.geeksforgeeks.org/how-to-generate-simple-random-password-from-a-given-string-using-php/)
...
在这种方法中，我们使用 PHP [`rand()`](https://www.geeksforgeeks.org/php-rand-function/) 函数并创建一个临时变量，并使用 `for` 循环从给定字符串创建随机字符，并将该字符连接到临时变量。下面是这种方法的实现。
...
在这个方法中，我们使用 PHP [`str_shuffle()`](https://www.geeksforgeeks.org/php-str_shuffle-function/) 函数，然后我们使用 [`substr()`](https://www.geeksforgeeks.org/php-substr-function/) 函数提取给定字符串的部分。
