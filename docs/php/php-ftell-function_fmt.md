...
PHP 中的 `ftell()` 函数只接受一个参数 `$file`。它是指定文件的必选参数。

## 返回值

成功时返回当前文件指针位置，失败时返回 `False`。
...
[http://php.net/manual/en/function.ftell.php](http://php.net/manual/en/function.ftell.php)