...
## 参数
此函数接受所需的单个参数 `$path`。用于指定 XML 文档的 XPath 路径。

## 返回值
成功时返回 `SimpleXMLElement` 数组，失败时返回 `False` 数组。

## 注意
此函数在 PHP 5.2.0 及更新版本中可用。
...
## 引用
[https://www.php.net/manual/en/simplexmlelement.xpath.php](https://www.php.net/manual/en/simplexmlelement.xpath.php)