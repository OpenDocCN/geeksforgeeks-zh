...
`Imagick::getSizeOffset()` 函数是 PHP 中的一个内置函数，用于获取大小偏移量。
...
[https://www.php.net/manual/en/imagick.getsizeoffset.php](https://www.php.net/manual/en/imagick.getsizeoffset.php)