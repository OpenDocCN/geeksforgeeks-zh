...
> 原文: [https://www.geeksforgeeks.org/how-to-convert-xml-data-into-json-using-php/](https://www.geeksforgeeks.org/how-to-convert-xml-data-into-json-using-php/)
...
PHP 代表超文本预处理器，用于创建动态网页。它还解析 XML 和 JSON 数据。XML 代表一种可扩展标记语言，我们可以在其中定义自己的数据。
...
我们正在考虑学生 XML 数据，并将其转换为 JSON 格式。
...
*   打开记事本，在 `xampp-htdocs` 文件夹中输入以下代码并保存为 `base.php`。

## PHP 代码

以下为文件 `base.php` 文件的内容。
