...
函数的作用是：是 PHP 中的一个内置函数，用于销毁图像并释放与该图像相关的任何内存。
...
[https://www.php.net/manual/en/function.imagedestroy.php](https://www.php.net/manual/en/function.imagedestroy.php)