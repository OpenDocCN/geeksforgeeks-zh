...
`ReflectionExtension::getVersion()` 函数是 PHP 中的内置函数，用于返回指定扩展的版本。
...
[https://www.php.net/manual/en/reflectionextension.getversion.php](https://www.php.net/manual/en/reflectionextension.getversion.php)