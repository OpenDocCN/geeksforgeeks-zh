...
`Imagick::readImageFile()` 函数是 PHP 中的一个内置函数，用于从打开的文件句柄读取图像。
...
[https://www.php.net/manual/en/imagick.readimagefile.php](https://www.php.net/manual/en/imagick.readimagefile.php)