...
> Original: [https://www.geeksforgeeks.org/php-ftp-exec-function/](https://www.geeksforgeeks.org/php-ftp-exec-function/)

函数的作用是：`ftp_exec()`函数是 PHP 中的内置函数，用于在 FTP 服务器上执行命令。
