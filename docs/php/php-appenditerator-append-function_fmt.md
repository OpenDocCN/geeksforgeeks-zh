...
> 原文: [https://www.geeksforgeeks.org/php-appenditerator-append-function/](https://www.geeksforgeeks.org/php-appenditerator-append-function/)

`AppendIterator::append()`函数是 PHP 中的一个内置函数，用于追加迭代器。
...
参考: [https://www.php.net/manual/en/appenditerator.append.php](https://www.php.net/manual/en/appenditerator.append.php)