...
> 原文：[https://www.geeksforgeeks.org/how-to-find-out-where-a-function-is-defined-using-php/](https://www.geeksforgeeks.org/how-to-find-out-where-a-function-is-defined-using-php/)
...
假设在给定的代码中，我们想要找到函数“打印”的位置。在输出中，可以看到函数打印的文件名和位置。
...
假设在给定的代码中，我们想要找到函数“极客”的位置。在输出中，可以看到函数极客传递的文件名、位置、开始行和参数。
