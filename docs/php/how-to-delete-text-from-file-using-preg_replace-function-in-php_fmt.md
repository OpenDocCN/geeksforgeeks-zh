...
> 原文：[https://www.geeksforgeeks.org/how-to-delete-text-from-file-using-preg_replace-function-in-php/](https://www.geeksforgeeks.org/how-to-delete-text-from-file-using-preg_replace-function-in-php/)
...
该程序使用 `preg_replace()` 函数从文件中删除特定内容。
