# Spreadsheet_Excel_Writer::setColor() 函数
...
`SetColor()` 函数是 `Spreadsheet_Excel_Writer` 中的内置函数，用于设置单元格内容的颜色。
...
此函数接受单个参数 `$color`，它将颜色值作为字符串，如 `'green'` 或从 0 到 64 的值。
...
[https://pear.php.net/manual/en/package.fileformats.spreadsheet-excel-writer.spreadsheet-excel-writer-format.setcolor.php](https://pear.php.net/manual/en/package.fileformats.spreadsheet-excel-writer.spreadsheet-excel-writer-format.setcolor.php)