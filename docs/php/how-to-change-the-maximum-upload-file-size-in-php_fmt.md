...
> 原文: [https://www.geeksforgeeks.org/how-to-change-the-maximum-upload-file-size-in-php/](https://www.geeksforgeeks.org/how-to-change-the-maximum-upload-file-size-in-php/)
...
**注意:** `upload_max_filesize`限制单个附件的大小，`post_max_size`是帖子所有内容的限制。