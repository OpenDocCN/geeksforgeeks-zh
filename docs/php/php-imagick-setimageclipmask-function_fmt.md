...
`Imagick::setImageClipMask()` 函数是 PHP 中的内置函数，用于设置图像剪辑蒙版。
...
[https://www.php.net/manual/en/imagick.setimageclipmask.php](https://www.php.net/manual/en/imagick.setimageclipmask.php)