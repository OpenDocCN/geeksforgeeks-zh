...
> 原文：[https://www.geeksforgeeks.org/php-imagefttext-function/](https://www.geeksforgeeks.org/php-imagefttext-function/)

`imagefttext()` 函数是 PHP 中的一个内置函数，用于使用 FreeType2 的字体将文本写入图像。
...
[https://www.php.net/manual/en/function.imagefttext.php](https://www.php.net/manual/en/function.imagefttext.php)