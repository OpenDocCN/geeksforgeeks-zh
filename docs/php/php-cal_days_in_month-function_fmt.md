...
> 原文: [https://www.geeksforgeeks.org/php-cal_days_in_month-function/](https://www.geeksforgeeks.org/php-cal_days_in_month-function/)
...
PHP 中的 `cal_days_in_month()` 函数接受三个参数，如下所述:
...
1.  当使用的日期在 1550 年之前时，`cal_days_in_month` 函数给出错误的输出。
2.  `cal_days_in_month` 函数给出了闰年发现之前的日期的错误输出。
...
[http://php.net/manual/en/function.cal-days-in-month.php](http://php.net/manual/en/function.cal-days-in-month.php)