...
下面的程序演示了当数字字符串作为参数传递且缺少第二个参数时，`gmp_strval()` 函数的工作原理。
...
下面的程序演示了当数字字符串作为参数传递并且存在第二个参数时，`gmp_strval()` 函数的工作原理。
...
下面的程序演示了当传递 GMP 编号且没有第二个参数时，`gmp_strval()` 函数的工作原理。
...
下面的程序演示了当 GMP 编号作为参数传递且存在第二个参数时，`gmp_strval()` 函数的工作原理。
