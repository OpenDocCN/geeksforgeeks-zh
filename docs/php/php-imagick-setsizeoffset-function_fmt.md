...
`Imagick::setSizeOffset()` 函数是 PHP 中的一个内置函数，用于设置 Imagick 对象的大小和偏移量。
...
[https://www.php.net/manual/en/imagick.setsizeoffset.php](https://www.php.net/manual/en/imagick.setsizeoffset.php)