...
此函数接受单个参数 `$channel`，该参数指定对通道模式有效的通道常量。`CHANNEL` 的默认值为 `Imagick::Channel_Default`。
...
[http://php.net/manual/en/imagick.getimagechanneldepth.php](http://php.net/manual/en/imagick.getimagechanneldepth.php)