...
`ImagickDraw::pathLineToVerticalAbsolute()`函数是 PHP 中的一个内置函数，用于使用绝对坐标绘制从当前点到目标点的垂直线路径。然后，目标点将成为新的当前点。
...
[https://www.php.net/manual/en/imagickdraw.pathlinetoverticalabsolute.php](https://www.php.net/manual/en/imagickdraw.pathlinetoverticalabsolute.php)