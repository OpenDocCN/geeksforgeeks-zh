...
`ReflectionExtension::info()` 函数是 PHP 中的内置函数，用于返回指定扩展的信息。
...
[https://www.php.net/manual/en/reflectionextension.info.php](https://www.php.net/manual/en/reflectionextension.info.php)