...
`DOMCdataSection::__construct()` 函数是 PHP 中的内置函数，用于构造新的 `DOMCdataSection` 对象。 DOM 代表文档对象模型，可以使用 [`DOMCharacterData`](https://www.php.net/manual/en/class.domcharacterdata.php) 类的方法进一步操作此部分。 此 CDATA 节点的工作方式类似于 [`DOMText`](https://www.php.net/manual/en/class.domtext.php) 类。
...
此函数接受单个参数 `$value`，该参数保存 CDATA 节点的值。

## 示例

下面给出的程序说明了 PHP 中的 `DOMCdataSection::__construct()` 函数：
...
[https://www.php.net/manual/en/domcdatasection.construct.php](https://www.php.net/manual/en/domcdatasection.construct.php)