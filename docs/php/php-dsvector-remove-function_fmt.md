...
> 原文：[https://www.geeksforgeeks.org/php-dsvector-remove-function/](https://www.geeksforgeeks.org/php-dsvector-remove-function/)

`Ds\Vector::reverse()` 函数是 PHP 中的一个内置函数，用于就地反转向量的元素。例如，如果向量元素是 `[1, 2, 3, 4, 5]`，那么它将被反转为 `[5, 4, 3, 2, 1]`。
