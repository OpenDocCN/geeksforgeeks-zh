...
> 原文：[https://www.geeksforgeeks.org/php-appenditerator-key-function/](https://www.geeksforgeeks.org/php-appenditerator-key-function/)

`AppendIterator::key()` 函数是 PHP 中的一个内置函数，用来返回当前键。
...
[https://www.php.net/manual/en/appenditerator.key.php](https://www.php.net/manual/en/appenditerator.key.php)