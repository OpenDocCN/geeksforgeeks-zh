...
> 原文: [https://www.geeksforgeeks.org/php-appenditerator-current-function/](https://www.geeksforgeeks.org/php-appenditerator-current-function/)

`AppendIterator::current()`函数是 PHP 中的一个内置函数，用来获取当前值。
...
[https://www.php.net/manual/en/appenditerator.current.php](https://www.php.net/manual/en/appenditerator.current.php)