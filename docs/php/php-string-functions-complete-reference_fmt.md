...
*   [`PHP|bin2hex()`](https://www.geeksforgeeks.org/php-bin2hex-function/)
*   [`PHP | chop () function`](https://www.geeksforgeeks.org/php-chop-function/)
*   [`PHP|CHUNK_SPLIT()`](https://www.geeksforgeeks.org/php-chunk_split-function/)
...
*   [`PHP|EXPLODE()`](https://www.geeksforgeeks.org/php-explode-function/)
*   [`PHP|HEX2bin()`](https://www.geeksforgeeks.org/php-hex2bin-function/)
*   [`PHP|INPRODE()`](https://www.geeksforgeeks.org/php-implode-function/)
*   [`php|lcfirst()`函数](https://www.geeksforgeeks.org/php-lcfirst-function/)
*   [`PHP|levenshtein()`](https://www.geeksforgeeks.org/php-levenshtein-function/)
*   [`PHP | ltrim () function`](https://www.geeksforgeeks.org/php-ltrim-function/)
*   [`PHP|md5_file()`](https://www.geeksforgeeks.org/php-md5_file-function/)
...
*   [`PHP|SHA1_FILE()`](https://www.geeksforgeeks.org/php-sha1_file-function/)
*   [`PHP|SHA1.`](https://www.geeksforgeeks.org/php-md5-sha1-hash-functions/) [`PHP|SIMILAR_TEXT()`](https://contribute.geeksforgeeks.org/improve/maximum-water-that-can-be-stored-between-two-buildings-4/)
...
*   [`php|strie_tag()`函数](https://www.geeksforgeeks.org/php-strip_tags-function/)
*   [`php|stripslash()`函数](https://www.geeksforgeeks.org/php-stripslashes-function/)
*   [`PHP|stristr()`](https://www.geeksforgeeks.org/php-stristr-function/)
*   [`PHP|strlen()`](https://www.geeksforgeeks.org/php-strlen-function/)
...
*   [`php|strtoupper()`函数](https://www.geeksforgeeks.org/php-strtoupper-function/)
