...
> 原文：[https://www.geeksforgeeks.org/how-to-pass-variables-and-data-from-php-to-javascript/](https://www.geeksforgeeks.org/how-to-pass-variables-and-data-from-php-to-javascript/)
...
这个程序使用赋值运算符将变量和数据从 PHP 传递给 JavaScript。
...
这个程序使用 Cookies 将变量和数据从 PHP 传递给 JavaScript。
