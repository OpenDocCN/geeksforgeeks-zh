...
```php
bool jpeg2wbmp( string $jpegname, int $wbmpname, int $dest_height, int $dest_width, int $threshold )
```
...
[https://www.php.net/manual/en/function.jpeg2wbmp.php](https://www.php.net/manual/en/function.jpeg2wbmp.php)