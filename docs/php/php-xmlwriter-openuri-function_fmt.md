...
`XMLWriter::openUri()` 函数是 PHP 中的一个内置函数，用于使用源 URI 创建一个新的 `XMLWriter` 进行输出。简而言之，此函数决定如何将 XML 输出给用户，可以通过浏览器输出，也可以直接输出到文件。
...
[https://www.php.net/manual/en/function.xmlwriter-open-uri.php](https://www.php.net/manual/en/function.xmlwriter-open-uri.php)