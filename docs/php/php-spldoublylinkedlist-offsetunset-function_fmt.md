...
此函数接受单个参数 `$index`，该参数保存要取消设置其值的索引值。
...
[https://www.php.net/manual/en/spldoublylinkedlist.offsetunset.php](https://www.php.net/manual/en/spldoublylinkedlist.offsetunset.php)