...
> 原文: [https://www.geeksforgeeks.org/how-to-destroy-session-after-some-time-in-php/](https://www.geeksforgeeks.org/how-to-destroy-session-after-some-time-in-php/)
...
如果您输入了错误的凭据，它将抛出一个错误，如果您输入了正确的凭据，您将被重定向到 `HomePage.php` 并在 1 分钟后销毁会话。开发人员可以相应地更改时间。
