...
> 原文：[https://www.geeksforgeeks.org/php-dssequence-map-function/](https://www.geeksforgeeks.org/php-dssequence-map-function/)
...
```php
abstract public Ds\Sequence::map( $callback )
```
