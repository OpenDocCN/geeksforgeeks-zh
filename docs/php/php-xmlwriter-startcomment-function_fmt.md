...
`XMLWriter::startComment()` 函数是 PHP 中的一个内置函数，用于启动注释。稍后需要使用 `XMLWriter::endComment()` 函数关闭此注释。
...
[https://www.php.net/manual/en/function.xmlwriter-start-comment.php](https://www.php.net/manual/en/function.xmlwriter-start-comment.php)