...
> 原文：[https://www.geeksforgeeks.org/php-simplexmlelement-addchild-function/](https://www.geeksforgeeks.org/php-simplexmlelement-addchild-function/)

**前提条件：** [阅读 XML 基础知识](https://www.geeksforgeeks.org/xml-basics/)
...
*   `$name`：必选参数。指定要添加的子元素的名称。
*   `$value`：可选参数。指定要添加的子元素的值。
*   `$namespace`：可选参数。指定子元素的命名空间。

## 返回值

子元素添加成功时返回 `SimpleXMLElement` 对象。
