...
`Imagick::setSize()` 函数是 PHP 中的一个内置函数，用于设置与 `Imagick` 对象相关联的大小。
...
[https://www.php.net/manual/en/imagick.setsize.php](https://www.php.net/manual/en/imagick.setsize.php)