...
`GmagickDraw::polygon()` 函数是 PHP 中的一个内置函数，用于使用指定的坐标数组，使用当前笔划、笔划宽度和填充颜色或纹理绘制多边形。
...
[https://www.php.net/manual/en/gmagickdraw.polygon.php](https://www.php.net/manual/en/gmagickdraw.polygon.php)