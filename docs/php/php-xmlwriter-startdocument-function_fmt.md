...
`XMLWriter::startDocument()` 函数是 PHP 中的一个内置函数，用于启动文档。然后，本文档需要以 `XMLWriter::endDocument()` 函数结束。
...
*   `$encoding` (可选)：它将文档的编码指定为 XML 声明的一部分。
*   `$standalone` (可选)：它指定文档是否为独立文档。
...
[https://www.php.net/manual/en/function.xmlwriter-start-document.php](https://www.php.net/manual/en/function.xmlwriter-start-document.php)