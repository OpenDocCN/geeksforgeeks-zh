# PHP Imagick getImageHistogram() 函数
...
`Imagick::getImageHistogram()` 函数是 PHP 中的一个内置函数，用于获取图像直方图。
...
此函数返回包含图像直方图的 `ImagickPixel` 对象数组。
...
下面的程序演示了 PHP 中的 `Imagick::getImageHistogram()` 函数：
...
[https://www.php.net/manual/en/imagick.getimagehistogram.php](https://www.php.net/manual/en/imagick.getimagehistogram.php)