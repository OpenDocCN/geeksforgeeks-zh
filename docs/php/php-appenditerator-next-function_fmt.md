...
> 原文：`https://www.geeksforgeeks.org/php-appenditerator-next-function/`

## 函数介绍

`AppendIterator::next()` 函数是 PHP 中的一个内置函数，用于将元素移动到下一个元素中。
...
`https://www.php.net/manual/en/appenditerator.next.php`