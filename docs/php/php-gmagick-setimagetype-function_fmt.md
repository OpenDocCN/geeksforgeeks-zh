...
`Gmagick::setimagetype()` 函数是 PHP 中的一个内置函数，用于设置图像类型。
...
此函数接受单个参数 `$imgType`，该参数保存与 [IMGTYPE 常量](https://www.php.net/manual/en/gmagick.constants.php#gmagick.constants.imgtype-undefined)之一相对应的整数值。
