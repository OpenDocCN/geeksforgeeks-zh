...
> 原文: [https://www.geeksforgeeks.org/how-to-handle-the-warning-of-file_get_contents-function-in-php/](https://www.geeksforgeeks.org/how-to-handle-the-warning-of-file_get_contents-function-in-php/)
...
> PHP 警告: file_get_contents(): PHP_network_getaddress: getaddrinfo failed: 在 /home/3d11f9784b99e2c83058d5842d5533ce.php 第 5 行
> PHP 警告: file_get_contents(https://www.geeksforgeeks.org/) 中出现系统错误: 无法打开流: PHP_network_getaddress: getaddrinfo failed: 在 /home/3d11f97844 中出现系统错误
...
> PHP 警告: file_get_contents(): PHP_network_getaddress: getaddinfo failed: 在 /home/4659aeca06fdba457da0c5d78befb39a.php 第 6 行
> PHP 警告: file_get_contents(gfg.txt): 无法打开流: 在 /home/4659aeca06fdba457da0c5d78befb39a.php 第 6 行没有这样的文件或目录
...
PHP 支持一个错误控制操作符: 符号 (`@`)。在 PHP 中添加到表达式之前，该表达式可能生成的任何错误消息都将被忽略。因此，只需在函数调用 `file_get_contents()` 之前插入错误控制运算符 (`@`) 就可以抑制上述 PHP 警告，方法如下:
...
**参考:** [https://www.php.net/manual/en/language.operators.errorcontrol.php](https://www.php.net/manual/en/language.operators.errorcontrol.php)