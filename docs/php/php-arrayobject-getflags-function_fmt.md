# ArrayObject::getFlags() 函数

> 原文: [https://www.geeksforgeeks.org/php-arrayobject-getflags-function/](https://www.geeksforgeeks.org/php-arrayobject-getflags-function/)

`ArrayObject::getFlags()` 函数是 PHP 中的一个内置函数，用于获取 `ArrayObject` 的标志行为。
...
**参考:** [https://www.php.net/manual/en/arrayobject.getflags.php](https://www.php.net/manual/en/arrayobject.getflags.php)