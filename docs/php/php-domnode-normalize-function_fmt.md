...
`DOMNode::normalize()`函数是 PHP 中的一个内置函数，用于删除空文本节点并合并该节点及其所有子节点中的相邻文本节点。
...
下面的示例说明了 PHP 中的`DOMNode::normalize()`函数：

### 示例 1

在本程序中，我们将展示`normalize()`如何删除空文本节点。
...
在本程序中，我们将展示`normalize()`如何合并所有相邻文本节点。
...
[https://www.php.net/manual/en/domnode.normalize.php](https://www.php.net/manual/en/domnode.normalize.php)