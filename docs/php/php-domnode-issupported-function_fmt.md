...
> Original: `https://www.geeksforgeeks.org/php-domnode-issupported-function/`

## DOMNode::isSupported() 函数

`DOMNode::isSupported()` 函数是 PHP 中的一个内置函数，用于检查指定版本是否支持被询问的功能。
...
下面的示例说明了 PHP 中的 `DOMNode::isSupported()` 函数：
