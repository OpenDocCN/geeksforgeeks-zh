# XMLReader::moveToFirstAttribute() 函数
...
`XMLReader::moveToFirstAttribute()` 函数是 PHP 中的一个内置函数，用于将光标定位在元素的第一个属性上。当一个元素有多个属性并且我们想要获取第一个属性时，或者当我们想检查一个元素是否有任何属性时，这个函数很有用。
...
[https://www.php.net/manual/en/xmlreader.movetofirstattribute.php](https://www.php.net/manual/en/xmlreader.movetofirstattribute.php)