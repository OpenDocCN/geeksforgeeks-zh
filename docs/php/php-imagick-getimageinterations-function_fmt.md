# PHP Imagick getImageIterations() 函数
...
`Imagick::getImageIterations()` 函数是 PHP 中的一个内置函数，用于获取图像迭代。迭代意味着帧自身应该重复多少次。
...
[https://www.php.net/manual/en/imagick.getimageiterations.php](https://www.php.net/manual/en/imagick.getimageiterations.php)