...
`DOMXPath::__construct()` 函数是 PHP 中的内置函数，用于创建 `DOMXPath` 的实例。
...
此函数接受单个参数 `$doc`，该参数保存与 `DOMXPath` 关联的 `DOMDocument`。
...
[https://www.php.net/manual/en/domxpath.construct.php](https://www.php.net/manual/en/domxpath.construct.php)