...
> 原文: [https://www.geeksforgeeks.org/php-arrayobject-setiteratorclass-function/](https://www.geeksforgeeks.org/php-arrayobject-setiteratorclass-function/)

`ArrayObject::setIteratorClass()` 函数是 PHP 中的一个内置函数，用于设置 `ArrayObject` 的迭代器类名。
