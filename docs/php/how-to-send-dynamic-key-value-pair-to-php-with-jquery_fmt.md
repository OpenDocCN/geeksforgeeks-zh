...
> 原文：[https://www.geeksforgeeks.org/how-to-send-dynamic-key-value-pair-to-php-with-jquery/](https://www.geeksforgeeks.org/how-to-send-dynamic-key-value-pair-to-php-with-jquery/)
...
以下代码是上述 HTML 代码中使用的文件 `script.js` 文件的内容。
...
以下是上述 HTML 代码中使用的文件 `action.php` 的代码。
