...
> 原文：[https://www.geeksforgeeks.org/php-dsstack-capacity-function/](https://www.geeksforgeeks.org/php-dsstack-capacity-function/)

`Ds\Stack::capacity()` 函数是 PHP 中的内置函数，用于返回堆栈的当前容量。
