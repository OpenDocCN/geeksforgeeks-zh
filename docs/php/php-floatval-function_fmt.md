...
## 注意：
如果将对象传递给函数，则会产生 `E_NOTICE` 级别错误并返回 1。
...
## 引用：
[http://php.net/manual/en/function.floatval.php](http://php.net/manual/en/function.floatval.php)