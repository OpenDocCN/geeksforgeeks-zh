...
函数的作用是：`imagefontwidth()` 函数是 PHP 中的一个内置函数，用于获取指定字体中字符的像素宽度。
...
此函数接受保存字体的单个参数 `$font`。对于内置字体，它可以是 1、2、3、4、5；对于自定义字体，它可以与 `imageloadfont()` 一起使用。
...
[https://www.php.net/manual/en/function.imagefontwidth.php](https://www.php.net/manual/en/function.imagefontwidth.php)