...
> 原文：[https://www.geeksforgeeks.org/how-to-get-a-file-extension-in-php/](https://www.geeksforgeeks.org/how-to-get-a-file-extension-in-php/)
...
以下方法使用 [`strpos()`](https://www.geeksforgeeks.org/php-strpos-stripos-functions/) 和 [`substr()`](https://www.geeksforgeeks.org/php-substr-function/) 方法打印最后一次出现的值。
...
以下方法使用预定义函数 [`pathinfo()`](https://www.geeksforgeeks.org/php-pathinfo-function/)。在输出中，“名称:”显示文件的名称，“扩展名:”显示文件的扩展名。
...
下面的代码使用预定义函数 [`parse_url()`](https://www.geeksforgeeks.org/php-parse_url-function/) 和 [`pathinfo()`](https://www.geeksforgeeks.org/php-pathinfo-function/) 来获取 url。
