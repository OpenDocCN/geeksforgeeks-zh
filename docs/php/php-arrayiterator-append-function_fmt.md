...
`ArrayIterator::append()` 函数是 PHP 中的一个内置函数，用于将元素追加到数组迭代器中。
...
**参考:** [https://www.php.net/manual/en/arrayiterator.append.php](https://www.php.net/manual/en/arrayiterator.append.php)