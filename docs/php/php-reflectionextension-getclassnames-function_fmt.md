# ReflectionExtension::getClassNames() 函数
...
`ReflectionExtension::getClassNames()` 函数是 PHP 中的内置函数，用于返回指定扩展的类名数组。如果未指定类，则返回空数组。
...
[https://www.php.net/manual/en/reflectionextension.getclassnames.php](https://www.php.net/manual/en/reflectionextension.getclassnames.php)