...
`Imagick::raiseImage()` 函数是 PHP 中的一个内置函数，用于通过加亮和使图像边缘变暗来创建模拟的三维按钮效果。
...
下面的程序说明 PHP 中的 `Imagick::raiseImage()` 函数：
...
$image = new Imagick('https://media.geeksforgeeks.org/wp-content/uploads/geeksforgeeks-19.png');
...
[http://php.net/manual/en/imagick.raiseimage.php](http://php.net/manual/en/imagick.raiseimage.php)