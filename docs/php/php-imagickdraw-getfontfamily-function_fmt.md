...
`ImagickDraw::getFontFamily()` 函数是 PHP 中的一个内置函数，用于在注释文本时获取要使用的字体系列。它告诉您要使用的文本的具体大小和样式，并且有许多字体系列可供选择，如 Times、avantgarde、NewCenturySchlbk、Palatino 等。
...
// Annotate a text
$draw->annotation(50, 100, 'The Font Family here is default.');
...
// Annotate a text
$draw->annotation(50, 200, 'The Font Family here is ' . $draw->getFontFamily() . '.');
