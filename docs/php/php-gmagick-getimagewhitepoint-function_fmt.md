...
`Gmagick::getimageWhitepoint()` 函数是 PHP 中的一个内置函数，用于将色度白点作为具有键“x”和“y”的关联数组来获取。
...
[https://www.php.net/manual/en/gmagick.getimagewhitepoint.php](https://www.php.net/manual/en/gmagick.getimagewhitepoint.php)