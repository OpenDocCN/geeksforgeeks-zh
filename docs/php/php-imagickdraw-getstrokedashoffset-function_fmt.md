...
`ImagickDraw::getStrokeDashOffset()` 函数是 PHP 中的一个内置函数，用于获取划线模式中的偏移量以开始划线。这个偏移量只是在开始由 `setStrokeDashArray()` 设置的划线之前要给出的间距。
...
[https://www.php.net/manual/en/imagickdraw.getstrokedashoffset.php](https://www.php.net/manual/en/imagickdraw.getstrokedashoffset.php)