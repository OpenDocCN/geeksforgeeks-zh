...
> 原文:[https://www . geesforgeks . org/where-PHP-store-the-error-log-PHP 5-Apache-fastcgi-cpanel/](https://www.geeksforgeks.org/where-does-php-store-the-error-log-php5-apache-fastcgi-cpanel/)
...
例如：`error_log = /var/log/php-scripts.log`，错误将记录在`php-scripts.log`文件中。