...
`ImagickPixelIterator::getNextIteratorRow()` 函数是 PHP 中的一个内置函数，用于从像素迭代器获取下一行像素棒阵列。
...
[https://www.php.net/manual/en/imagickpixeliterator.getnextiteratorrow.php](https://www.php.net/manual/en/imagickpixeliterator.getnextiteratorrow.php)