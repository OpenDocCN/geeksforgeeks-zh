...
## gmagick::getimageiterations() 函数

`Gmagick::getimageiterations()` 函数是 PHP 中的一个内置函数，用于获取图像迭代。迭代实际上意味着帧在图像中显示的次数，在静止图像的情况下为 0，在动画的情况下为 1。
...
此函数返回一个包含图像迭代的整数值，对于静止图像，该值为 0，对于动画，该值为 1。
...
[https://www.php.net/manual/en/gmagick.getimageiterations.php](https://www.php.net/manual/en/gmagick.getimageiterations.php)