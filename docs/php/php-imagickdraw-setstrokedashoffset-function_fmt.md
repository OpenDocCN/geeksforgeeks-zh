...
`ImagickDraw::setStrokeDashOffset()` 函数是 PHP 中的一个内置函数，用于设置划线模式中的偏移量以开始划线。
...
## `参数：`
此函数接受保存破折号偏移量的单个参数 `$dash_offset`。
...
## `输出：`
![使用 setStrokeDashOffset 函数绘制的虚线椭圆](img/3a1eb5f232e3bc0eb4fdf7f7a1a7a33c.png)

## `引用：`
[https://www.php.net/manual/en/imagickdraw.setstrokedashoffset.php](https://www.php.net/manual/en/imagickdraw.setstrokedashoffset.php)