...
> 原文：[https://www.geeksforgeeks.org/how-to-get-youtube-video-id-with-php-regex/](https://www.geeksforgeeks.org/how-to-get-youtube-video-id-with-php-regex/)
...
*   [https://youtu.be/hjGD08xfg9c](https://youtu.be/hjGD08xfg9c)
...
**Regex：** 现在我们知道有五种基本格式可以获得 YouTube ID，即通过 `v=` 或 `vi=` 或 `v/` 或 `vi/` 或 `youtu.be/`。那么查询从什么开始呢？用“？”开始正则表达式或者寻找“youtu.be/”。它会忽略之前的网址部分吗？然后搜索“v=”或“vi=”，存储下 11 个字符并打印出来。
