...
> 原文: `https://www.geeksforgeeks.org/php-arrayiterator-setflags-function/`

`ArrayIterator::setFlags()`函数是 PHP 中的一个内置函数，用于设置标志的行为。
...
**参考:** `https://www.php.net/manual/en/arrayiterator.setflags.php`