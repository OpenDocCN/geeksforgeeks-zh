...
`ReflectionProperty::getModifiers()` 函数是 PHP 中的内置函数，用于返回指定修饰符的数字表示形式。
...
下面的程序演示了 PHP 中的 `ReflectionProperty::getModifiers()` 函数：
...
[https://www.php.net/manual/en/reflectionproperty.getmodifiers.php](https://www.php.net/manual/en/reflectionproperty.getmodifiers.php)