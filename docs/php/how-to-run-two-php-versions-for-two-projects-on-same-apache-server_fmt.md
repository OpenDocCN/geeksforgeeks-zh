...
> 原文：[https://www.geeksforgeeks.org/how-to-run-two-php-versions-for-two-projects-on-same-apache-server/](https://www.geeksforgeeks.org/how-to-run-two-php-versions-for-two-projects-on-same-apache-server/)
...
打开文件 `httpd.conf` 文件 > 将端口从 `80` 更改为 `8080`。

![](img/d238454754b51aff99b9e27c375e763e.png)

*   更改端口后，单击保存并退出。
*   现在转到 `extra` 的文件夹
*   要在 `httpd-ssl.conf` 文件中进行的更改
*   将 `Listen 443` 改为 `444`
