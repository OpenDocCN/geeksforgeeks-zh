...
`ImagickKernel::addUnityKernel()`函数是 PHP 中的一个内置函数，用于将给定数量的‘Unity’卷积内核添加到给定内核。此函数用于将定义的内核转换为混合软模糊、锐化内核或锐化内核。
...
[https://www.php.net/manual/en/imagickkernel.addunitykernel.php](https://www.php.net/manual/en/imagickkernel.addunitykernel.php)