...
`ImagickPixel::getColorAsString()` 函数是 PHP 中的一个内置函数，用于以字符串形式获取 `ImagickPixel` 对象的颜色。
...
[`https://www.php.net/manual/en/imagickpixel.getcolorasstring.php`](https://www.php.net/manual/en/imagickpixel.getcolorasstring.php)