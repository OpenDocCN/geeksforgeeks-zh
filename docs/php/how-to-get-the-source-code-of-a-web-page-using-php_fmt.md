...
> 原文：[https://www.geeksforgeeks.org/how-to-get-the-source-code-of-a-web-page-using-php/](https://www.geeksforgeeks.org/how-to-get-the-source-code-of-a-web-page-using-php/)

给定一个网页，我们需要用 PHP 找到它的源代码。为此，我们将使用 PHP `htmlspecialchars()` 函数，该函数将任何预定义的字符转换为其后续的 HTML 实体。

## 示例 1

假设我们取一个看起来像下图的示例网站，让我们看看代码会产生什么样的输出。
...
> 警告: 文件(`file:///D:/Html %20 网站/gfg %20 示例%20 网站/索引. Html`): 无法打开流: `C:\xampp\htdocs\programs\source code.php` 第 2 行没有这样的文件或目录
>
