...
> Original: [https://www.geeksforgeeks.org/php-is-real-function/](https://www.geeksforgeeks.org/php-is-real-function/)

`is_real()`函数是 PHP 中的一个内置函数，用于检查给定值是否为实数。
...
如果变量的给定值为实数，则返回 `TRUE`，否则返回 `FALSE`。
