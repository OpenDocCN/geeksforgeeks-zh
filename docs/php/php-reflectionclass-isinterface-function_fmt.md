...
`ReflectionClass::isInterface()` 函数是 PHP 中的内置函数，用于检查指定的类是否为接口。
...
如果指定的类是接口，则此函数返回 `TRUE`，否则返回 `FALSE`。
...
[https://www.php.net/manual/en/reflectionclass.isinterface.php](https://www.php.net/manual/en/reflectionclass.isinterface.php)