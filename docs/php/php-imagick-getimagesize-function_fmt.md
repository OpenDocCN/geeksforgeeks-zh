...
`Imagick::getImageSize()` 函数是 PHP 中的一个内置函数，用于获取以字节为单位的图像长度。
...
[https://www.php.net/manual/en/imagick.getimagesize.php](https://www.php.net/manual/en/imagick.getimagesize.php)