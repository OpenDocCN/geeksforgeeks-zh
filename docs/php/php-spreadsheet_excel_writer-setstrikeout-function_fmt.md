...
`setStrikeOut()` 函数是 `Spreadsheet_Excel_Writer` 中的内置函数，用于将字体设置为删除线。
...
[https://pear.php.net/manual/en/package.fileformats.spreadsheet-excel-writer.spreadsheet-excel-writer-format.setstrikeout.php](https://pear.php.net/manual/en/package.fileformats.spreadsheet-excel-writer.spreadsheet-excel-writer-format.setstrikeout.php)