# PHP Imagick::paintTransparentImage() 函数
...
`Imagick::paintTransparentImage()` 函数是 PHP 中的一个内置函数，用于更改与定义的颜色匹配的任何像素。
...
下面的程序演示了 PHP 中的 `Imagick::paintTransparentImage()` 函数：
...
// Use Imagick::paintTransparentImage() function
...
[https://www.php.net/manual/en/imagick.painttransparentimage.php](https://www.php.net/manual/en/imagick.painttransparentimage.php)