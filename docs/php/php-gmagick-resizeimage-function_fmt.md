...
下面的程序说明了 PHP 中的 `Gmagick::resizeimage()` 函数：
...
**引用：**[http://php.net/manual/en/gmagick.resizeimage.php](http://php.net/manual/en/gmagick.resizeimage.php)