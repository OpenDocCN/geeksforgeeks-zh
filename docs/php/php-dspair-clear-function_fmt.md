...
> 原文：[https://www.geeksforgeeks.org/php-dspair-clear-function/](https://www.geeksforgeeks.org/php-dspair-clear-function/)

`Ds\Pair::clear()` 函数是 PHP 中的一个内置函数，用于从对中删除所有值。
