...
此函数接受单个参数`$position`，该参数用于返回从零开始的位置索引。
...
$map = new \Ds\Map(["1" => "Geeks", "2" => "for", "3" => "Geeks"]);
...
// Declare a new map
$map = new \Ds\Map(["Geeks1" => "computer", "Geeks2" => "science", "Geeks3" => 5, "Geeks4" => 20]);
...
[https://www.php.net/manual/en/ds-map.skip.php](https://www.php.net/manual/en/ds-map.skip.php)