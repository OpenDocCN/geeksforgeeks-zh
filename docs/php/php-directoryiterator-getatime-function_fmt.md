...
`DirectoryIterator::getATime()` 函数是 PHP 中的内置函数，用于获取当前 `DirectoryIterator` 项的最后访问时间。
...
[https://www.php.net/manual/en/directoryiterator.getatime.php](https://www.php.net/manual/en/directoryiterator.getatime.php)