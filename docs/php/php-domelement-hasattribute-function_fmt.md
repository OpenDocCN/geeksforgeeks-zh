...
`DOMElement::hasAttribute()` 函数是 PHP 中的一个内置函数，用于知道具有特定名称的属性是否作为元素的成员存在。
...
[`https://www.php.net/manual/en/domelement.hasattribute.php`](https://www.php.net/manual/en/domelement.hasattribute.php)