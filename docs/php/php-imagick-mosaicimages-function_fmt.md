...
`Imagick::MosaicImages()`函数是 PHP 中的一个内置函数，用于从图像形成马赛克。此函数使用图像序列来形成单个相干图片。
...
[https://www.php.net/manual/en/imagick.mosaicimages.php](https://www.php.net/manual/en/imagick.mosaicimages.php)