...
`Imagick::getPointSize()` 函数是 PHP 中的一个内置函数，用于获取 `Imagick` 对象的磅大小。
...
[https://www.php.net/manual/en/imagick.getpointsize.php](https://www.php.net/manual/en/imagick.getpointsize.php)