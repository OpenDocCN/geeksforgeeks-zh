...
## 函数介绍
`Gmagick::current()` 函数是 PHP 中的一个内置函数，用于返回当前 `Gmagick` 对象的引用。此函数不创建任何副本，但返回相同的 `Gmagick` 实例。
...
## 引用
[https://www.php.net/manual/en/gmagick.current.php](https://www.php.net/manual/en/gmagick.current.php)