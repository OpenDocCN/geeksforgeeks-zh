...
> 原文：[https://www.geeksforgeeks.org/php-interface/](https://www.geeksforgeeks.org/php-interface/)
...
实现接口的类称为具体类。它必须实现接口中定义的所有方法。由于歧义错误，无法实现同名接口。与任何类一样，可以使用 `extends` 运算符扩展接口，如下所示：
