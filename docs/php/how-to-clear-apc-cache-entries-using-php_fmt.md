...
> 原文：[https://www.geeksforgeeks.org/how-to-clear-apc-cache-entries-using-php/](https://www.geeksforgeeks.org/how-to-clear-apc-cache-entries-using-php/)
...
要清除 APC 缓存，请在您的 PHP 文件中复制并粘贴以下代码。请确保将字符串“您的 IP 地址”替换为您的实际 IP 地址。如果缓存清除成功，将显示带有“成功”消息的警告框，否则将显示“错误”警告消息。
