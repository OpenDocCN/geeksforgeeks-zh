...
`ImagickDraw::getStrokeDashArray()` 函数是 PHP 中的一个内置函数，用于获取表示用于描边路径的虚线和间隙模式的数组。
...
如果成功，此函数将返回包含笔划破折号的数组，如果未设置，则返回空数组。
...
[https://www.php.net/manual/en/imagickdraw.getstrokedasharray.php](https://www.php.net/manual/en/imagickdraw.getstrokedasharray.php)