...
此函数返回代码点的 `FC_NFKC_CLOSURE` 属性字符串，如果没有，则返回空字符串。
...
[http://php.net/manual/en/intlchar.getfc-nfkc-closure.php](http://php.net/manual/en/intlchar.getfc-nfkc-closure.php)