...
`GmagickDraw::Rotate()` 函数是 PHP 中的一个内置函数，用于将指定的旋转应用于当前坐标空间。
...
此函数接受单个参数 `$coordinates_array`，该参数用于保存旋转度的值。
...
[https://www.php.net/manual/en/gmagickdraw.rotate.php](https://www.php.net/manual/en/gmagickdraw.rotate.php)