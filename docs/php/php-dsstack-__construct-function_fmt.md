...
`Ds\Stack::__construct()` 函数是 PHP 中的一个内置函数，用于创建一个新的堆栈实例。
...
[https://www.php.net/manual/en/ds-stack.construct.php](https://www.php.net/manual/en/ds-stack.construct.php)