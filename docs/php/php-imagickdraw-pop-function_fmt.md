...
`ImagickDraw::pop()` 函数是 PHP 中的一个内置函数，用于销毁堆栈中的当前 `ImagickDraw`，并返回之前推送的 `ImagickDraw`。对于每个 `pop()` 函数，必须已经有一个等效的 `push()` 函数。
...
[https://www.php.net/manual/en/imagickdraw.pop.php](https://www.php.net/manual/en/imagickdraw.pop.php)