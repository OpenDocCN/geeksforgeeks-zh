...
> 原文：[https://www.geeksforgeeks.org/how-to-copy-a-file-from-one-directory-to-another-using-php/](https://www.geeksforgeeks.org/how-to-copy-a-file-from-one-directory-to-another-using-php/)
...
*   `$context`：指定由 `stream_context_create()` 函数创建的上下文资源。这是一个可选参数。
...
**参考：** [https://www.php.net/manual/en/function.copy.php](https://www.php.net/manual/en/function.copy.php)