...
## 原文链接
[https://www.geeksforgeeks.org/php-domdocument-createtextnode-function/](https://www.geeksforgeeks.org/php-domdocument-createtextnode-function/)

`DOMDocument::createTextNode()` 函数是 PHP 中的内置函数，用于创建 `DOMText` 类的新实例。
