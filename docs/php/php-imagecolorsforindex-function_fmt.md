...
此函数返回一个关联数组，该数组包含给定索引处的红、绿、蓝和 Alpha 键值。下面的程序说明了 PHP 中的`imagecolorsforindex()`函数：
...
[http://php.net/manual/en/function.imagecolorsforindex.php](http://php.net/manual/en/function.imagecolorsforindex.php)