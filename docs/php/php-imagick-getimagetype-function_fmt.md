...
`Imagick::getImageType()` 函数是 PHP 中的一个内置函数，用于获取潜在的图像类型。
...
[https://www.php.net/manual/en/imagick.getimagetype.php](https://www.php.net/manual/en/imagick.getimagetype.php)