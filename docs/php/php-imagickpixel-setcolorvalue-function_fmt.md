...
`ImagickPixel::setColorValue()` 函数是 PHP 中的一个内置函数，用于为给定 `ImagickPixel` 的颜色设置所提供颜色通道的规格化值。规格化值是介于 0 和 1 之间的浮点数。
...
[https://www.php.net/manual/en/imagickpixel.setcolorvalue.php](https://www.php.net/manual/en/imagickpixel.setcolorvalue.php)