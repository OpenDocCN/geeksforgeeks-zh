...
`DirectoryIterator::next()` 函数是 PHP 中的一个内置函数，用于前进到下一个 `DirectoryIterator` 项。
...
[https://www.php.net/manual/en/directoryiterator.next.php](https://www.php.net/manual/en/directoryiterator.next.php)