...
`Imagick::setImageWhitePoint()` 函数是 PHP 中的内置函数，用于设置图像色度白点。
...
[https://www.php.net/manual/en/imagick.setimagewhitepoint.php](https://www.php.net/manual/en/imagick.setimagewhitepoint.php)