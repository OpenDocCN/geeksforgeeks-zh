# DOMDocument::createDocumentFragment()函数
...
`DOMDocument::createDocumentFragment()`函数是 PHP 中的内置函数，用于创建新的文档片段。
...
此函数返回新的 `DOMDocumentFragment`，如果出现错误，则返回 `False`。
...
[https://www.php.net/manual/en/domdocument.createdocumentfragment.php](https://www.php.net/manual/en/domdocument.createdocumentfragment.php)