...
`Gmagick::getimagehistogram()` 函数是 PHP 中的一个内置函数，用于获取图像直方图。此函数以 Gmagick 像素数组的形式返回图片中的所有像素。我们可以使用此函数逐个像素地分析任何图片的颜色。
...
下面给出的程序演示了 PHP 中的 `Gmagick::getimagehistogram()` 函数：
...
[https://www.php.net/manual/en/gmagick.getimagehistogram.php](https://www.php.net/manual/en/gmagick.getimagehistogram.php)