...
> 原文：[https://www.geeksforgeeks.org/php-dsdeque-shift-function/](https://www.geeksforgeeks.org/php-dsdeque-shift-function/)

`Ds\Deque::shift()` 函数是 PHP 中的一个内置函数，用于删除和返回 deque 的第一个值。
