...
## Imagick::getNumberImages()函数

`Imagick::getNumberImages()`函数是 PHP 中的一个内置函数，用于获取 Imagick 对象中的图像数量。此函数还可用于计算 GIF 动画中的帧数。
...
[https://www.php.net/manual/en/imagick.getnumberimages.php](https://www.php.net/manual/en/imagick.getnumberimages.php)