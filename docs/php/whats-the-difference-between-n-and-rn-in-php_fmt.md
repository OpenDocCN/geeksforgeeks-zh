...
> 原文：[https://www.geeksforgeeks.org/whats-the-difference-between-n-and-rn-in-php/](https://www.geeksforgeeks.org/whats-the-difference-between-n-and-rn-in-php/)
...
| It's a two-word literal sequence. | `\n` is a character constant representing a single character, that is, a newline character. |