...
> 原文: [https://www.geeksforgeeks.org/php-array_fill-keys-function/](https://www.geeksforgeeks.org/php-array_fill-keys-function/)
...
这个函数接受两个参数，键和它们的值出现在新数组中。这两个参数描述如下：
...
[http://php.net/manual/en/function.array-fill-keys.php](http://php.net/manual/en/function.array-fill-keys.php)