...
`Gmagick::getimageextrema()` 函数是 PHP 中的一个内置函数，用于获取图像的极值。极值是观察到函数的最大值或最小值的点。
...
[https://www.php.net/manual/en/gmagick.getimageextrema.php](https://www.php.net/manual/en/gmagick.getimageextrema.php)