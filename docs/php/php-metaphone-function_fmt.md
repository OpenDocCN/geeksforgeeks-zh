...
`metaphone()` 函数是 PHP 中的一个内置函数，用于计算给定字符串的[变音位键](https://en.wikipedia.org/wiki/Metaphone)。变音位键是一种语音算法，用于根据单词的发音对单词进行索引。它使用较大的一套英语发音规则。
...
### 引用：
[http://php.net/manual/en/function.metaphone.php](http://php.net/manual/en/function.metaphone.php)