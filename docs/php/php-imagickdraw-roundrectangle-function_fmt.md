...
`ImagickDraw::roundRectangle()` 函数是 PHP 的 Imagick 库中的内置函数，用于绘制圆角矩形。
...
下面的程序演示了 PHP 中的 `ImagickDraw::roundRectangle()` 函数：
...
[http://php.net/manual/en/imagickdraw.roundrectangle.php](http://php.net/manual/en/imagickdraw.roundrectangle.php)