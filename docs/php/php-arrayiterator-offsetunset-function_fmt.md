...
`ArrayIterator::offsetUnset()`函数是 PHP 中的一个内置函数，用于取消设置偏移量的值。
...
## 参数:
该函数接受单个参数 `$index`，该参数保存索引以取消偏移设置。
...
## 参考:
[https://www.php.net/manual/en/arrayiterator.offsetunset.php](https://www.php.net/manual/en/arrayiterator.offsetunset.php)