...
`Gmagick::getimageHeight()` 函数是 PHP 中的一个内置函数，用于获取图像高度，即图像的垂直长度。
...
[https://www.php.net/manual/en/gmagick.getimageheight.php](https://www.php.net/manual/en/gmagick.getimageheight.php)