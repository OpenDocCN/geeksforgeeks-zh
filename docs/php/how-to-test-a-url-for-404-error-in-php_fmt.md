...
> 原文：[https://www.geeksforgeeks.org/how-to-test-a-url-for-404-error-in-php/](https://www.geeksforgeeks.org/how-to-test-a-url-for-404-error-in-php/)

在 PHP 中，检查网页网址是否存在相对容易。如果所需的网址不存在，那么它将返回 404 错误。使用和不使用 cURL 库都可以进行检查。

## cURL

cURL 的意思是‘URL 的客户端’，最初是用大写字母拼写 URL，以表明它处理 URL。它的发音是“看网址”。CUlR 项目有两个产品 libcurl 和 CUlR。
...
本示例在不使用 cURL 方法的情况下测试 URL 是否有 404 错误。
...
本示例使用 cURL 方法测试一个 URL 的 404 错误。
