...
`ImagickDraw::pathLineToAbsolute()` 函数是 PHP 中的一个内置函数，用于使用绝对坐标绘制从当前点到给定坐标的直线路径。然后，该坐标将成为新的当前点。初始点可以使用 `pathMoveToAbsolute()` 函数设置。
...
[https://www.php.net/manual/en/imagickdraw.pathlinetoabsolute.php](https://www.php.net/manual/en/imagickdraw.pathlinetoabsolute.php)