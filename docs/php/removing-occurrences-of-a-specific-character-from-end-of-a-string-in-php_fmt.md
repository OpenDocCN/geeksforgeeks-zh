...
> 原文: [https://www.geeksforgeeks.org/removing-occurrences-of-a-specific-character-from-end-of-a-string-in-php/](https://www.geeksforgeeks.org/removing-occurrences-of-a-specific-character-from-end-of-a-string-in-php/)

有很多选项可以删除字符串末尾的所有特定字符。其中一些将在下面讨论:

## 使用 `rtrim()` 函数

[`rtrim()`](https://www.geeksforgeeks.org/php-rtrim-function/) 函数是 PHP 中的一个内置函数，它从字符串的右侧移除空格或其他字符(如果指定的话)。
...
[`preg_replace()`](https://www.geeksforgeeks.org/php-preg_replace-function/) 函数是 PHP 中的一个内置函数，用于执行正则表达式来搜索和替换内容。
