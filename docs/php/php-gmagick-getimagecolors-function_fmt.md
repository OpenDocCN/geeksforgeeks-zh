...
`Gmagick::getimagecolors()` 函数是 PHP 中的一个内置函数，用于获取图像中唯一颜色的数量。
...
[https://www.php.net/manual/en/gmagick.getimagecolors.php](https://www.php.net/manual/en/gmagick.getimagecolors.php)