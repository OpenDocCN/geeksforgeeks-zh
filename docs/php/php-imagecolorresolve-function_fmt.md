...
*   [PHP `imagecolor()`](https://www.geeksforgeeks.org/php-imagecolor-function/)
*   [PHP `Imagearc()` 函数](https://www.geeksforgeeks.org/php-imagearc-function/)

## 引用

[http://php.net/manual/en/function.imagecolorresolve.php](http://php.net/manual/en/function.imagecolorresolve.php)