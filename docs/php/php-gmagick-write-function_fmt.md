...
`Gmagick::write()` 函数是 PHP 中的一个内置函数，用于将图像写入指定的文件名。这是 `Gmagick::writeImage()` 函数的别名。
...
[https://www.php.net/manual/en/gmagick.write.php](https://www.php.net/manual/en/gmagick.write.php)