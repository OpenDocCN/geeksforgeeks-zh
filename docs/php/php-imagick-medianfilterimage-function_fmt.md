...
`Imagick::medianFilterImage()`函数是 PHP 中的一个内置函数，它应用数字过滤器来改善噪声图像的质量。
...
![输出图像](img/51e30f27f222b275ff4e3a1e47d3a7a3.png)

## 引用：

[https://www.php.net/manual/en/imagick.medianfilterimage.php](https://www.php.net/manual/en/imagick.medianfilterimage.php)