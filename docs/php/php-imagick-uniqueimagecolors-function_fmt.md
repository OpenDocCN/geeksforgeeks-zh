...
`Imagick::uniqueImageColors()` 函数是 PHP 中的一个内置函数，用于丢弃任何像素颜色中除一种以外的所有颜色。 此功能在版本 6.2.9 或更高版本中可用。
...
下面的程序演示了 PHP 中的 `Imagick::uniqueImageColors()` 函数：
...
[http://php.net/manual/en/imagick.uniqueimagecolors.php](http://php.net/manual/en/imagick.uniqueimagecolors.php)