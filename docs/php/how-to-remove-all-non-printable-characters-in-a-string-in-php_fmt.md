...
> 原文：[https://www.geeksforgeeks.org/how-to-remove-all-non-printable-characters-in-a-string-in-php/](https://www.geeksforgeeks.org/how-to-remove-all-non-printable-characters-in-a-string-in-php/)
...
有很多正则表达式可用。最好的解决方案是从输入字符串中去除所有非 ASCII 字符，这可以通过 `preg_replace` 来完成。
...
其他可能的解决方案是使用 `print` 正则表达式。`[:print:]` 正则表达式代表“任意可打印字符”。
