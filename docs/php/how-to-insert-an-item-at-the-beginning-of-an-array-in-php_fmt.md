...
> 原文：[https://www.geeksforgeeks.org/how-to-insert-an-item-at-the-beginning-of-an-array-in-php/](https://www.geeksforgeeks.org/how-to-insert-an-item-at-the-beginning-of-an-array-in-php/)
...
`array_merge()` 函数用于将两个或多个数组合并为一个数组。该函数用于将两个或多个数组的元素或值合并成一个数组。

1.  创建包含数组元素的数组。
2.  创建另一个包含一个元素的数组，该元素需要插入到另一个数组的开头。
3.  使用 `array_merge()` 函数合并两个数组以创建一个数组。
