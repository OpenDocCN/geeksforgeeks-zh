# ReflectionGenerator::getExecutingGenerator()函数
...
`ReflectionGenerator::getExecutingGenerator()`函数是 PHP 中的内置函数，用于返回当前正在执行的 Generator 对象。
...
[https://www.php.net/manual/en/reflectiongenerator.getexecutinggenerator.php](https://www.php.net/manual/en/reflectiongenerator.getexecutinggenerator.php)