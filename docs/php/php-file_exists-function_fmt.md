...
> 原文：[https://www.geeksforgeeks.org/php-file_exists-function/](https://www.geeksforgeeks.org/php-file_exists-function/)
...
PHP 中的 `file_exists()` 函数只接受一个参数 `$path`。它指定要检查的文件或目录的路径。
