...
`ImagickDraw::affine()` 函数是 PHP 中的一个内置函数，用于调整当前仿射变换矩阵。
...
此函数接受单个参数 `$affine`，该参数保存包含仿射矩阵参数的数组。
...
[https://www.php.net/manual/en/imagickdraw.affine.php](https://www.php.net/manual/en/imagickdraw.affine.php)