# ImagickDraw::pathCurveToQuadraticBezierAbsolute() 函数
...
`ImagickDraw::pathCurveToQuadraticBezierAbsolute()` 函数是 PHP 语言中的一个内置函数，用于绘制一条二次贝塞尔曲线，它只是一条参数二次曲线。
...
[https://www.php.net/manual/en/imagickdraw.pathcurvetoquadraticbezierabsolute.php](https://www.php.net/manual/en/imagickdraw.pathcurvetoquadraticbezierabsolute.php)