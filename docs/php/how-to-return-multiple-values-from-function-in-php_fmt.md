...
> 原文: [https://www.geeksforgeeks.org/how-to-return-multiple-values-from-function-in-php/](https://www.geeksforgeeks.org/how-to-return-multiple-values-from-function-in-php/)
...
这个示例展示了如何在 PHP 中从一个函数返回多个值。首先，创建一个空数组，将元素推入数组，然后返回数组。
...
本示例使用 [列表](https://www.geeksforgeeks.org/php-list-function/) 功能存储变量的交换值。它用于同时向多个变量分配数组值。可以使用 `list()` 将函数在数组中返回的多个值分配给相应的变量。
