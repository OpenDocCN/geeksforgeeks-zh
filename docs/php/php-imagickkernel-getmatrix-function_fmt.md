...
`ImagickKernel::getMatrix()` 函数是 PHP 中的一个内置函数，用于获取内核中使用的值的 2D 矩阵。如果应跳过元素，则元素为 Float 或 `false`。
...
[https://www.php.net/manual/en/imagickkernel.getmatrix.php](https://www.php.net/manual/en/imagickkernel.getmatrix.php)