...
此函数接受指定所请求索引的单个参数 `$index`。

## 返回值

如果找到请求的索引，则此函数返回 `TRUE`，否则返回 `FALSE`。
...
[https://www.php.net/manual/en/splfixedarray.offsetexists.php](https://www.php.net/manual/en/splfixedarray.offsetexists.php)