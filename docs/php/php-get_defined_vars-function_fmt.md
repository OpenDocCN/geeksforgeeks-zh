...
> Original: [https://www.geeksforgeeks.org/php-get_defined_vars-function/](https://www.geeksforgeeks.org/php-get_defined-vars-function/)
...
下面的程序演示了 PHP 中的 `get_defined_vars()` 函数：
