...
> 原文：[https://www.geeksforgeeks.org/php-simplexmliterator-valid-function/](https://www.geeksforgeeks.org/php-simplexmliterator-valid-function/)

`SimpleXMLIterator::valid()` 函数是 PHP 中的内置函数，用于检查当前元素是否有效。
