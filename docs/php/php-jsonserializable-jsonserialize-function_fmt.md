# JsonSerializable::jsonSerialize()函数
...
`JsonSerializable::jsonSerialize()`函数是 PHP 中的一个内置函数，用于将 JSON 对象序列化为可以使用`json_encode()`函数本地序列化的值。
...
[https://www.php.net/manual/en/jsonserializable.jsonserialize.php](https://www.php.net/manual/en/jsonserializable.jsonserialize.php)