...
函数的作用是：`ftp_delete()` 函数是 PHP 的内置函数，用于删除 FTP 服务器上的文件。
...
[https://www.php.net/manual/en/function.ftp-delete.php](https://www.php.net/manual/en/function.ftp-delete.php)