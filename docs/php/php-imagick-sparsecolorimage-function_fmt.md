# PHP Imagick sparseColorImage() 函数
...
`Imagick::sparseColorImage()` 函数是 PHP 中的一个内置函数，用于对整个图像中的颜色进行插值。
...
下面的程序说明了 PHP 中的 `Imagick::sparseColorImage()` 函数：
...
[https://www.php.net/manual/en/imagick.sparsecolorimage.php](https://www.php.net/manual/en/imagick.sparsecolorimage.php)