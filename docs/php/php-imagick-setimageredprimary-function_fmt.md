...
`Imagick::setImageRedPrimary()` 函数是 PHP 中的一个内置函数，用于设置图像的色度红色基准点。
...
下面给定的程序说明了 PHP 中的 `Imagick::setImageRedPrimary()` 函数：
...
[https://www.php.net/manual/en/imagick.setimageredprimary.php](https://www.php.net/manual/en/imagick.setimageredprimary.php)