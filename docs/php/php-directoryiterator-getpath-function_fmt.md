...
`DirectoryIterator::getPath()`函数是 PHP 中的一个内置函数，用于获取当前迭代器项的路径，不带文件名。
...
[https://www.php.net/manual/en/directoryiterator.getpath.php](https://www.php.net/manual/en/directoryiterator.getpath.php)