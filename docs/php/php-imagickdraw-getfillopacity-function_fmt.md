...
`ImagickDraw::getFillOpacity()` 函数是 PHP 中的一个内置函数，用于获取使用填充颜色或填充纹理绘制时使用的不透明度。完全不透明为 1，完全透明为 0。
...
[https://www.php.net/manual/en/imagickdraw.getfillopacity.php](https://www.php.net/manual/en/imagickdraw.getfillopacity.php)