...
`DOMNode::getNodePath()` 函数是 PHP 中的一个内置函数，用于获取节点的 XPath 位置路径。
...
此函数返回包含 XPath 的字符串，如果出现错误，则返回 `NULL`。
...
[https://www.php.net/manual/en/domnode.getnodepath.php](https://www.php.net/manual/en/domnode.getnodepath.php)