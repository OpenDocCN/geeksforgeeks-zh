...
`Gmagick::Destroy()` 函数是 PHP 中的一个内置函数，用于销毁 `Gmagick` 对象并释放与其关联的所有资源。
...
[https://www.php.net/manual/en/gmagick.destroy.php](https://www.php.net/manual/en/gmagick.destroy.php)