...
*   `$index`: 此参数保存要插入元素的索引。
*   `$value`: 此参数保存要插入到 Deque 中给定索引处的值。
...
如果 Deque 为空，则此函数抛出`OutOfRangeException`。
...
[http://php.net/manual/en/ds-deque.insert.php](http://php.net/manual/en/ds-deque.insert.php)