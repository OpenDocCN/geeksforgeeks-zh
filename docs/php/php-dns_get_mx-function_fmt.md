...
`dns_get_mx()` 函数是 PHP 中的内置函数，它返回指定 Internet 主机名的 MX 记录。 此函数是 `getmxrr()` 函数的别名。
...
如果找到任何记录，此函数返回 TRUE，否则返回 FALSE。
...
[https://www.php.net/manual/en/function.dns-get-mx.php](https://www.php.net/manual/en/function.dns-get-mx.php)