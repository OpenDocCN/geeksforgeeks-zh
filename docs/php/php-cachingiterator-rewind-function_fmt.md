...
`CachingIterator::rewind()`函数是 PHP 中的一个内置函数，用来倒带迭代器。
...
## 参考:
[https://www.php.net/manual/en/cachingiterator.rewind.php](https://www.php.net/manual/en/cachingiterator.rewind.php)