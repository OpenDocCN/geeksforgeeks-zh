...
`Ds\Map::intersect()`函数是 PHP 中的一个内置函数，用于创建包含与另一个地图的交集的新地图。
...
此函数接受单个参数`$map`，该参数保存包含其他元素键的另一个映射。
...
[https://www.php.net/manual/en/ds-map.intersect.php](https://www.php.net/manual/en/ds-map.intersect.php)