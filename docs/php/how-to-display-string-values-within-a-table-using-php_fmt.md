...
> 原文: [https://www.geeksforgeeks.org/how-to-display-string-values-within-a-table-using-php/](https://www.geeksforgeeks.org/how-to-display-string-values-within-a-table-using-php/)
...
使用 PHP 中的 HTML 表格元素 `echo` 来打印表格中的字符串值。我们可以在一个 PHP 脚本中编写 HTML 标签来显示作为 HTML 组件呈现的输出。
