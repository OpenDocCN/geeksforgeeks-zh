...
## 参数
该函数只取一个引用输入数组的参数 `$array`。

## 返回类型
该函数返回另一个数组，元素交换或翻转后，如果输入数组无效，则返回 `null`。

## 示例说明
下面的程序说明了 `array_flip()`函数在 PHP 中的工作：
...
## 参考文献
[http://php.net/manual/en/function.array-flip.php](http://php.net/manual/en/function.array-flip.php)