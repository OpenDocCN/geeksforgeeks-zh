...
> 原文：[https://www.geeksforgeeks.org/php-strcoll-function/](https://www.geeksforgeeks.org/php-strcoll-function/)
...
该函数接受两个必需的字符串参数，如下所述。

1.  `$string1`：此参数引用要在比较中使用的第一个字符串。
2.  `$string2`：此参数引用要在比较中使用的第二个字符串。

## 返回值

该函数根据匹配条件返回一个随机整数值，其表达式为：
