...
`Imagick::__toString()` 函数是 PHP 中的一个内置函数，用于将图像作为字符串返回。此函数将仅返回单个图像，不应用于包含多个图像的 `Imagick` 对象。
...
[https://www.php.net/manual/en/imagick.tostring.php](https://www.php.net/manual/en/imagick.tostring.php)