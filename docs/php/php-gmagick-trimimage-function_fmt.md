...
下面给出的程序演示了PHP中的`Gmagick::trimimage()`函数：
...
[https://www.php.net/manual/en/gmagick.trimimage.php](https://www.php.net/manual/en/gmagick.trimimage.php)