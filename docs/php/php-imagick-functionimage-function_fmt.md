...
`Imagick::functionImage()` 函数是 PHP 中的内置函数，用于将算术、关系或逻辑表达式应用于伪图像。
...
[https://www.php.net/manual/en/imagick.functionimage.php](https://www.php.net/manual/en/imagick.functionimage.php)