...
`date_get_last_errors()` 函数是 PHP 中的一个内置函数，用于返回警告和错误。此函数解析日期/时间字符串，并返回警告和错误数组。
...
下面的程序说明了 PHP 中的 `date_get_last_errors()` 函数：
...
[http://php.net/manual/en/datetime.getlasterrors.php](http://php.net/manual/en/datetime.getlasterrors.php)