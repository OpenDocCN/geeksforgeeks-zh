...
`SplDoublyLinkedList::push()` 函数是 PHP 中的一个内置函数，用于在双向链表末尾推送元素。
...
此函数接受单个参数 `$value`，该参数保存一个元素以将其推送到双向链表的末尾。
...
[https://www.php.net/manual/en/spldoublylinkedlist.push.php](https://www.php.net/manual/en/spldoublylinkedlist.push.php)