...
> 原文：[https://www.geeksforgeeks.org/how-to-remove-a-key-and-its-value-from-an-associative-array-in-php/](https://www.geeksforgeeks.org/how-to-remove-a-key-and-its-value-from-an-associative-array-in-php/)
...
该函数用于获取一个或多个数组之间的差异。此函数比较一个或多个数组之间的键，并返回它们之间的差异。
