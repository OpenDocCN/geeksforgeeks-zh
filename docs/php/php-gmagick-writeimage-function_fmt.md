...
## Gmagick::WriteImage() 函数

`Gmagick::WriteImage()` 函数是 PHP 中的一个内置函数，用于将图像写入指定的文件名。
...
[https://www.php.net/manual/en/gmagick.writeimage.php](https://www.php.net/manual/en/gmagick.writeimage.php)