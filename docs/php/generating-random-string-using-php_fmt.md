...
[`random_bytes()`](https://www.geeksforgeeks.org/php-random_bytes-function/) 函数生成密码安全的伪随机字节，稍后可以使用 [`bin2hex()`](https://www.geeksforgeeks.org/php-bin2hex-function/) 函数将其转换为十六进制格式。
