...
`ReflectionParameter::getName()` 函数是 PHP 中的内置函数，用于返回指定参数的名称。
...
以下程序说明 PHP 中的 `ReflectionParameter::getName()` 函数：
...
[https://www.php.net/manual/en/reflectionparameter.getname.php](https://www.php.net/manual/en/reflectionparameter.getname.php)