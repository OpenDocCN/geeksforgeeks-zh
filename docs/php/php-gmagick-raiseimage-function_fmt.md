...
`Gmagick::raiseImage()` 函数是 PHP 中的一个内置函数，用于通过创建图像的边缘变亮和变暗来创建模拟的三维按钮效果。`RAISE_INFO` 的宽度和高度定义效果的垂直边和水平边的宽度。
...
以下程序说明了 PHP 中的 `Gmagick::raiseImage()` 函数：
...
$gmagick = new Gmagick('https://media.geeksforgeeks.org/wp-content/uploads/tech.png');
...
[http://php.net/manual/en/gmagick.raiseimage.php](http://php.net/manual/en/gmagick.raiseimage.php)