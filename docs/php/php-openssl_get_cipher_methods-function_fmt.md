...
`openssl_get_cipher_methods()` 函数是 PHP 中的一个内置函数，用于获取所有可用的加密方法。
...
此函数接受单个参数 `$aliases`，该参数决定是否应该存在密码别名。
...
[https://www.php.net/manual/en/function.openssl-get-cipher-methods.php](https://www.php.net/manual/en/function.openssl-get-cipher-methods.php)