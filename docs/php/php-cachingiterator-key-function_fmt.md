...
`CachingIterator::key()` 函数是 PHP 中的一个内置函数，用于返回当前元素的键。
...
**参考:** [https://www.php.net/manual/en/cachingiterator.key.php](https://www.php.net/manual/en/cachingiterator.key.php)