...
`Imagick::opaquePaintImage()` 函数是 PHP 中的一个内置函数，用于将目标颜色替换为与目标颜色匹配的任何像素的指定填充颜色值。
...
// Image Path
$imagePath = "https://cdncontribute.geeksforgeeks.org/wp-content/uploads/geeksforgeeks-9.png";
...
// Image Path
$imagePath = "https://media.geeksforgeeks.org/wp-content/uploads/20190826021518/checkerboardgfg.png";
