...
`ReflectionClass::getFileName()` 函数是 PHP 中的一个内置函数，用于返回定义了类的文件的文件名，如果找不到该文件，则返回 `False`。
...
此函数返回定义了类的文件的文件名，如果找不到该文件，则返回 `False`。
...
[https://www.php.net/manual/en/reflectionclass.getfilename.php](https://www.php.net/manual/en/reflectionclass.getfilename.php)