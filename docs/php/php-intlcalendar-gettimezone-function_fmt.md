...
`IntlCalendar::getTimeZone()` 函数是 PHP 中的一个内置函数，用于返回与此日历关联的时区对象。
...
[https://www.php.net/manual/en/intlcalendar.gettimezone.php](https://www.php.net/manual/en/intlcalendar.gettimezone.php)