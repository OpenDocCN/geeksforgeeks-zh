...
`Imagick::sigmoidalContrastImage()` 函数是 PHP 中的一个内置函数，用于通过非线性 Sigmoid 对比度算法调整图像的对比度。
...
[https://www.php.net/manual/en/imagick.sigmoidalcontrastimage.php](https://www.php.net/manual/en/imagick.sigmoidalcontrastimage.php)