...
> 原文：[https://www.geeksforgeeks.org/what-are-the-best-input-sanitizing-functions-in-php/](https://www.geeksforgeeks.org/what-are-the-best-input-sanitizing-functions-in-php/)

**对数据进行消毒**意味着从数据中删除任何非法字符。净化用户输入是 web 应用程序中最常见的任务之一。为了使这项任务更容易，PHP 提供了本机过滤器扩展，您可以使用它来净化数据，如电子邮件地址、网址、IP 地址等。
