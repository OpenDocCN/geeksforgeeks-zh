...
`Gmagick::setimagefilename()` 函数是 PHP 中的一个内置函数，用于设置序列中特定图像的文件名。
...
[https://www.php.net/manual/en/gmagick.setimagefilename.php](https://www.php.net/manual/en/gmagick.setimagefilename.php)