...
`Gmagick::getfilename()` 函数是 PHP 中的一个内置函数，用于获取与 `Gmagick` 对象中的图像相关联的文件名。
...
下面给出的程序说明了 PHP 中的 `Gmagick::getfilename()` 函数。
...
[https://www.php.net/manual/en/gmagick.getfilename.php](https://www.php.net/manual/en/gmagick.getfilename.php)