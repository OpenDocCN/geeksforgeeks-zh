# IntlCalendar::getAvailableLocales() 函数
...
`IntlCalendar::getAvailableLocales()` 函数是 PHP 中的一个内置函数，用于显示安装日历的区域设置的数组列表。
...
[https://www.php.net/manual/en/intlcalendar.getavailablelocales.php](https://www.php.net/manual/en/intlcalendar.getavailablelocales.php)