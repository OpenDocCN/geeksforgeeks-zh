# PHP `ctype_digit()` 函数详解

> 原文：[https://www.geeksforgeeks.org/php-ctype_digit-function/](https://www.geeksforgeeks.org/php-ctype_digit-function/)
...
检查 `ctype_digit()` 函数以查找包含所有数字的单个字符串。
