...
`Imagick::setImage()` 函数是 PHP 中的内置函数，用于替换对象中的图像。
...
此函数接受包含 `Imagick` 对象的单个参数 `$replace`。
...
[https://www.php.net/manual/en/imagick.setimage.php](https://www.php.net/manual/en/imagick.setimage.php)