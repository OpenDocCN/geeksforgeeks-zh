...
> 原文：[https://www.geeksforgeeks.org/php-gmagick-motionblurimage-function/](https://www.geeksforgeeks.org/php-gmagick-motionblurimage-function/)
...
下面的程序说明了 PHP 中的 `Gmagick::motionblurimage()` 函数：
