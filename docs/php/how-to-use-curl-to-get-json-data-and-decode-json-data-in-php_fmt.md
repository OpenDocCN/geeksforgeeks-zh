...
> 原文：[https://www.geeksforgeeks.org/how-to-use-curl-to-get-json-data-and-decode-json-data-in-php/](https://www.geeksforgeeks.org/how-to-use-curl-to-get-json-data-and-decode-json-data-in-php/)
...
*   使用 `curl_setopt()` 方法和 `CURLOPT_URL` 向 `reqres.in` 服务器发送 `GET` 请求以获取 `json` 数据。
