...
`DirectoryIterator::__construct()`函数是 PHP 中的内置函数，用于从路径构造新的目录迭代器。
...
[https://www.php.net/manual/en/directoryiterator.construct.php](https://www.php.net/manual/en/directoryiterator.construct.php)