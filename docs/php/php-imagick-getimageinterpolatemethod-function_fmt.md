...
`Imagick::getImageInterpolateMethod()` 函数是 PHP 中的内置函数，用于获取指定图像的插值方法。
...
[https://www.php.net/manual/en/imagick.getimageinterpolatemethod.php](https://www.php.net/manual/en/imagick.getimageinterpolatemethod.php)