...
*   [php|IntlChar::charDigitValue()函数](https://www.geeksforgeeks.org/php-intlchardigitvalue-function/)
...
[http://php.net/manual/en/intlchar.chartype.php](http://php.net/manual/en/intlchar.chartype.php)