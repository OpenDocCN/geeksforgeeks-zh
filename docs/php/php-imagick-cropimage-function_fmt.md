...
以下程序说明 PHP 中的 `Imagick::cropImage()` 函数。
...
$image = new Imagick('https://media.geeksforgeeks.org/wp-content/uploads/geeksforgeeks-13.png');
...
$im->newImage($matrix['textWidth'], $matrix['textHeight'], new ImagickPixel('white'));
