...
`ReflectionClass::getMethod()` 函数是 PHP 中的内置函数，用于返回指定类方法的 `ReflectionMethod`。
...
[https://www.php.net/manual/en/reflectionclass.getmethod.php](https://www.php.net/manual/en/reflectionclass.getmethod.php)