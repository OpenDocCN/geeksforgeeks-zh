...
> 原文：`https://www.geeksforgeeks.org/php-arrayiterator-offsetget-function/`

`ArrayIterator::offsetGet()` 函数是 PHP 中的一个内置函数，用于获取偏移量的值。
...
该函数接受单个参数 `$index`，该参数保存从中获取值的偏移量。
...
`https://www.php.net/manual/en/arrayiterator.offsetget.php`