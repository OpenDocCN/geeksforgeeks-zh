...
> 原文：[https://www.geeksforgeeks.org/how-to-remove-duplicate-values-from-array-using-php/](https://www.geeksforgeeks.org/how-to-remove-duplicate-values-from-array-using-php/)

在本文中，我们将讨论如何在 PHP 中移除数组中的重复元素。我们可以通过使用 [`array_unique()`](https://www.geeksforgeeks.org/php-array_unique-function/) 函数来获取独特元素。该函数将从数组中删除重复的值。
...
**返回值：** `array_unique()`函数在从数组中移除所有重复项后返回过滤后的数组。
