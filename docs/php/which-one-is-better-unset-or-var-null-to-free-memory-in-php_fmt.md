...
> 原文: [https://www.geeksforgeeks.org/which-one-is-better-unset-or-var-null-to-free-memory-in-php/](https://www.geeksforgeeks.org/which-one-is-better-unset-or-var-null-to-free-memory-in-php/)
...
`null`：`null`用于清空变量。我们可以创建一个`null`变量，只需将其赋为空即可。不会释放内存，但会在该特定变量上重写或重新分配空数据。
