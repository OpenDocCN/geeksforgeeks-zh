...
`Imagick::colorizeImage()` 函数是 PHP 中的一个内置函数，用于将填充颜色与图像中具有指定不透明度的每个像素混合。
...
[https://www.php.net/manual/en/imagick.colorizeimage.php](https://www.php.net/manual/en/imagick.colorizeimage.php)