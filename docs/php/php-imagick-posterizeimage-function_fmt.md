...
`Imagick::posterizeImage()` 函数是 PHP 中的一个内置函数，用于将图像减少到有限的颜色级别。
...
下面的程序演示了 PHP 中的 `Imagick::posterizeImage()` 函数：
...
[http://php.net/manual/en/imagick.posterizeimage.php](http://php.net/manual/en/imagick.posterizeimage.php)