# `ReflectionParameter::getPosition()` 函数

> 原文：[https://www.geeksforgeeks.org/php-reflectionparameter-getposition-function/](https://www.geeksforgeeks.org/php-reflectionparameter-getposition-function/)

`ReflectionParameter::getPosition()` 函数是 PHP 中的内置函数，用于返回指定参数的位置。
