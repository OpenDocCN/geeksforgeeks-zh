...
`DOMComment::__construct()` 函数是 PHP 中的一个内置函数，用于创建一个新的 `DOMComment` 对象。此对象是只读的，可以追加到文档中。
...
[https://www.php.net/manual/en/domcomment.construct.php](https://www.php.net/manual/en/domcomment.construct.php)