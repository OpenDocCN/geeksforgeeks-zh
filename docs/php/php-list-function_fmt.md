...
> 原文：[https://www.geeksforgeeks.org/php-list-function/](https://www.geeksforgeeks.org/php-list-function/)
...
它接受由空格分隔的变量列表。这些变量被赋值。必须至少将一个变量传递给函数。

## 返回值

函数向传递的多个变量返回赋值的数组。如果传递的变量数大于数组中的元素数，则会引发错误。
