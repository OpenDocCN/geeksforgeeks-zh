...
`Imagick::levelImage()` 函数是 PHP 中的一个内置函数，用于调整图像的级别。
...
*   `$channel`：此参数保存对通道模式有效的通道常量。 使用按位运算符合并多个通道。
...
下面的程序演示了 PHP 中的 `Imagick::levelImage()` 函数：
...
$imagick = "https://media.geeksforgeeks.org/wp-content/uploads/geeksforgeeks-9.png";
...
[https://www.php.net/manual/en/imagick.levelimage.php](https://www.php.net/manual/en/imagick.levelimage.php)