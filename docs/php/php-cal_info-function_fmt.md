...
PHP 中的 `cal_info()` 函数只接受一个参数 `$calendar`。此参数指定一个数字，表示您想要了解的日历。以下是可用作该参数值的有效数字列表。
...
[http://php.net/manual/en/function.cal-info.php](http://php.net/manual/en/function.cal-info.php)