...
`Gmagick::getimagedelay()` 函数是 PHP 中的一个内置函数，用于获取图像延迟。延迟实际上是在 GIF 动画中从一个图像过渡到另一个图像所花费的时间。
...
此函数返回包含图像延迟的整数值，单位为厘米秒（100 centi = 1 秒）。
...
[https://www.php.net/manual/en/gmagick.getimagedelay.php](https://www.php.net/manual/en/gmagick.getimagedelay.php)