...
`Imagick::getFilename()` 函数是 PHP 中的一个内置函数，用于获取与图像序列相关联的文件名。
...
[https://www.php.net/manual/en/imagick.getfilename.php](https://www.php.net/manual/en/imagick.getfilename.php)