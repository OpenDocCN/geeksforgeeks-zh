...
此函数接受单个参数 `$zip_entry`。它是一个必选参数，用于指定 zip 条目资源。

## 返回值

如果成功，则返回指定 zip 存档条目的文件或目录的压缩方法，否则返回 PHP 警告。
...
[http://php.net/manual/en/function.zip-entry-compressionmethod.php](http://php.net/manual/en/function.zip-entry-compressionmethod.php)