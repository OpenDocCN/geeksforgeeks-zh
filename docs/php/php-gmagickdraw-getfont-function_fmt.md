...
`GmagickDraw::getfont()` 函数是 PHP 中的一个内置函数，用于获取指定使用文本批注时使用的字体的字符串。
...
[https://www.php.net/manual/en/gmagickdraw.getfont.php](https://www.php.net/manual/en/gmagickdraw.getfont.php)