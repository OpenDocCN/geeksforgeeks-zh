...
`call_user_func()`函数接受两种类型的参数，如上所述，如下所述:
...
### 程序 2: 使用名称空间名称调用`call_user_func()`
...
**参考文献:** [http://php.net/manual/en/function.call-user-func.php](http://php.net/manual/en/function.call-user-func.php)