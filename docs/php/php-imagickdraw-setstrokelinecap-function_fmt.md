...
`ImagickDraw::setStrokeLineCap()` 函数是 PHP 中的一个内置函数，用于设置在打开的子路径被描边时要使用的形状。
...
此函数接受单个参数 `$linecap`，该参数保存与 [LINECAP 常量](https://www.php.net/manual/en/imagick.constants.php/#imagick.constants.linecap-undefined) 之一相对应的整数值。
...
[https://www.php.net/manual/en/imagickdraw.setstrokelinecap.php](https://www.php.net/manual/en/imagickdraw.setstrokelinecap.php)