...
> 原文：[https://www.geeksforgeeks.org/how-to-import-config-php-file-in-a-php-script/](https://www.geeksforgeeks.org/how-to-import-config-php-file-in-a-php-script/)
...
如果您想将 `config.php` 文件的内容保存到一个变量中，那么下面的代码可以做到。
