...
`ReflectionGenerator::getFunction()` 函数是 PHP 中的内置函数，用于返回指定生成器的函数名。
...
以下程序说明 `ReflectionGenerator::getFunction()` 函数的用法：
...
[https://www.php.net/manual/en/reflectiongenerator.getfunction.php](https://www.php.net/manual/en/reflectiongenerator.getfunction.php)