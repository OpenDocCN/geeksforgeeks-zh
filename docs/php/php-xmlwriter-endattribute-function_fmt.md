...
`XMLWriter::endAttribute()` 函数是 PHP 中的一个内置函数，用于结束使用 `XMLWriter::startAttribute()` 函数启动的属性。
...
[https://www.php.net/manual/en/function.xmlwriter-end-attribute.php](https://www.php.net/manual/en/function.xmlwriter-end-attribute.php)