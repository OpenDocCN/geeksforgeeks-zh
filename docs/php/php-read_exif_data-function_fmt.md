...
`read_exif_data()` 函数是 PHP 中的一个内置函数，用于从图像文件中读取 EXIF 头文件，是 `exif_read_data()` 的替代函数。
...
[https://www.php.net/manual/en/function.read-exif-data.php](https://www.php.net/manual/en/function.read-exif-data.php)