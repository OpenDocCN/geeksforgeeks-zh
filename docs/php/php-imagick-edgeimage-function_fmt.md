...
下面的程序说明了 PHP 中的`Imagick::edgeImage()`函数。
...
[http://php.net/manual/en/imagick.edgeimage.php](http://php.net/manual/en/imagick.edgeimage.php)