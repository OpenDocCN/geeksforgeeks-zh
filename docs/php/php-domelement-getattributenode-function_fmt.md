# `DOMElement::getAttributeNode()` 函数
...
`DOMElement::getAttributeNode()` 函数是 PHP 中的一个内置函数，用于获取当前元素的带有名称的属性节点。
...
[https://www.php.net/manual/en/domelement.getattributenode.php](https://www.php.net/manual/en/domelement.getattributenode.php)