...
`Imagick::setFilename()` 函数是 PHP 中的一个内置函数，用于在读取或写入图像之前设置文件名。
...
此函数接受单个参数 `$filename`，该参数保存表示文件名的字符串。
...
[https://www.php.net/manual/en/imagick.setfilename.php](https://www.php.net/manual/en/imagick.setfilename.php)