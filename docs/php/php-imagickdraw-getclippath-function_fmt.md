...
`ImagickDraw::getClipPath()`函数是 PHP 中的一个内置函数，用于获取当前剪切路径 ID。
...
此函数返回包含剪辑路径 ID 的字符串值，如果不存在剪辑路径，则返回 `False`。
...
[https://www.php.net/manual/en/imagickdraw.getclippath.php](https://www.php.net/manual/en/imagickdraw.getclippath.php)