...
如果 `$codepoint` 是空格或水平空格字符，则返回 TRUE，否则返回 FALSE。
...
[http://php.net/manual/en/intlchar.isblank.php](http://php.net/manual/en/intlchar.isblank.php)