...
## gmagick::getimagegreenprimary() 函数

`gmagick::getimagegreenprimary()` 函数是 PHP 中的一个内置函数，用于返回色度绿色基准点。此函数返回一个具有键“x”和“y”的数组。
...
[https://www.php.net/manual/en/gmagick.getimagegreenprimary.php](https://www.php.net/manual/en/gmagick.getimagegreenprimary.php)