...
> 原文：[https://www.geeksforgeeks.org/php-dssequence-first-function/](https://www.geeksforgeeks.org/php-dssequence-first-function/)
...
## 引用
[`http://php.net/manual/en/ds-sequence.first.php`](http://php.net/manual/en/ds-sequence.first.php)