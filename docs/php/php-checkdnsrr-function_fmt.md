...
`checkdnsrr()`函数是 PHP 中的一个内置函数，用于检查主机名或 IP 地址对应的 DNS 记录。此功能可用于验证域名是否存在。
...
**参考:**[https://www.php.net/manual/en/function.checkdnsrr.php](https://www.php.net/manual/en/function.checkdnsrr.php)