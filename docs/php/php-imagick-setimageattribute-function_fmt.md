...
`Imagick::setImageAttribute()` 函数是 PHP 中的一个内置函数，用于设置键的值属性。
...
[https://www.php.net/manual/en/imagick.setimageattribute.php](https://www.php.net/manual/en/imagick.setimageattribute.php)