...
`Imagick::getImagePixelColor()` 函数是 PHP 中的内置函数，用于返回指定像素的颜色。
...
[https://www.php.net/manual/en/imagick.getimagepixelcolor.php](https://www.php.net/manual/en/imagick.getimagepixelcolor.php)