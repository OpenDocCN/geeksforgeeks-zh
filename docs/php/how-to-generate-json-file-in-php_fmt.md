...
> 原文: [https://www.geeksforgeeks.org/how-to-generate-json-file-in-php/](https://www.geeksforgeeks.org/how-to-generate-json-file-in-php/)
...
使用 [`file_put_contents()`](https://www.geeksforgeeks.org/php-file_put_contents-function/) 将文件放置在路径中
