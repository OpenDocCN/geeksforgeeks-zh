...
`Imagick::setImageScene()` 函数是 PHP 中的内置函数，用于设置图像场景。Scene 的值包含整数值。
...
[https://www.php.net/manual/en/imagick.setimagescene.php](https://www.php.net/manual/en/imagick.setimagescene.php)