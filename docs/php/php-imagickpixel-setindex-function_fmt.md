...
`ImagickPixel::setIndex()` 函数是 PHP 中的一个内置函数，用于设置像素的色彩映射表索引。
...
[https://www.php.net/manual/en/imagickpixel.setindex.php](https://www.php.net/manual/en/imagickpixel.setindex.php)