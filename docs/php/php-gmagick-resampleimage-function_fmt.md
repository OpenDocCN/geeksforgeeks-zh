...
```php
Gmagick Gmagick::resampleimage( $xResolution, $yResolution, $filter, $blur )
```
...
下面的程序说明了 PHP 中的 `Gmagick::resampleimage()` 函数。
...
[http://php.net/manual/en/gmagick.resampleimage.php](http://php.net/manual/en/gmagick.resampleimage.php)