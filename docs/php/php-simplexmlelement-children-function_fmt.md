...
## 先决条件
[读取 XML 基础知识](https://www.geeksforgeeks.org/xml-basics/)

`SimpleXMLElement::children()` 函数是 PHP 中的内置函数，它返回 `SimpleXMLElement` 对象中给定节点的子节点。
...
## 返回值
此函数返回 `SimpleXMLElement` 对象。

## 注意
此函数在 `PHP 5.0.1` 和更新版本中可用。

下面的程序说明了 PHP 中的 `SimpleXMLElement::children()` 函数。
