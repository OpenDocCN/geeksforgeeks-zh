...
`Gmagick::quantizeImage()` 函数是 PHP 中的一个内置函数，用于分析参考图像中的颜色，并选择固定数量的颜色来表示图像。此功能的主要原因是在最小化处理时间的同时最小化输入和输出图像之间的色差。
...
[https://www.php.net/manual/en/gmagick.quantizeimage.php](https://www.php.net/manual/en/gmagick.quantizeimage.php)