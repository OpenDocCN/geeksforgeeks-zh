...
`ImagickDraw::getTextKerning()` 函数是 PHP 中的一个内置函数，用于获取图像中使用的文本字距调整，即字母之间的间距。
...
[https://www.php.net/manual/en/imagickdraw.gettextkerning.php](https://www.php.net/manual/en/imagickdraw.gettextkerning.php)