...
*   [PHP|gmp_invert() 模逆](https://www.geeksforgeeks.org/php-gmp_invert-inverse-modulo/)
*   [PHP|gmp_rootrem() 函数](https://www.geeksforgeeks.org/php-gmp_rootrem-function/)

## 引用

[http://php.net/manual/en/function.gmp-export.php](http://php.net/manual/en/function.gmp-export.php)