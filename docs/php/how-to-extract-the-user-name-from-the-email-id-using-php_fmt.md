...
> 原文：[https://www.geeksforgeeks.org/how-to-extract-the-user-name-from-the-email-id-using-php/](https://www.geeksforgeeks.org/how-to-extract-the-user-name-from-the-email-id-using-php/)
...
*   **第一步：** 定义一个变量 `$email` 并在里面存储邮箱地址的值。

    ```php
    $email= 'princepriyank@geeks.com';
    ```

*   **第 2 步：** 通过使用“@”作为分隔符分解（分割）字符串来获取用户名，并将第一部分存储在变量 `$username` 中。
