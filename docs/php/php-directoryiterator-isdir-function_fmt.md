...
`DirectoryIterator::isDir()` 函数是 PHP 中的内置函数，用于检查当前 `DirectoryIterator` 项是否为目录。
...
[https://www.php.net/manual/en/directoryiterator.isdir.php](https://www.php.net/manual/en/directoryiterator.isdir.php)