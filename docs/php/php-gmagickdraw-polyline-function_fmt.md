...
`GmagickDraw::polyline()` 函数是 PHP 中的一个内置函数，用于使用指定的坐标数组，结合当前笔划、笔划宽度和填充颜色或纹理绘制多段线。
...
此函数接受单个参数 `$coordinates_array`，该参数用于将点的坐标保存为数组。
...
[https://www.php.net/manual/en/gmagickdraw.polyline.php](https://www.php.net/manual/en/gmagickdraw.polyline.php)