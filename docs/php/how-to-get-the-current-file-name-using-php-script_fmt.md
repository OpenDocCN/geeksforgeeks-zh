...
> 原文：[https://www.geeksforgeeks.org/how-to-get-the-current-file-name-using-php-script/](https://www.geeksforgeeks.org/how-to-get-the-current-file-name-using-php-script/)
...
`$_SERVER`是一个存储信息的数组，如标题、路径和脚本位置。这些条目由 web 服务器创建。没有其他方法可以让每个网络服务器都提供这些信息。
