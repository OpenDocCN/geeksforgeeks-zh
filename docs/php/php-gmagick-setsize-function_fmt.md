...
`gmagick::setsize()` 函数是 PHP 中的一个内置函数，用于设置与 `gmagick` 对象相关联的大小。
...
[https://www.php.net/manual/en/gmagick.setsize.php](https://www.php.net/manual/en/gmagick.setsize.php)