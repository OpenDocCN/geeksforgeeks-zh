...
`DirectoryIterator::getPathname()` 函数是 PHP 中的内置函数，用于返回当前 `DirectoryIterator` 项的路径和文件名。
...
[https://www.php.net/manual/en/directoryiterator.getpathname.php](https://www.php.net/manual/en/directoryiterator.getpathname.php)