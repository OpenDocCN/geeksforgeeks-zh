...
`Imagick::getImageRegion()` 函数是 PHP 中的一个内置函数，用于提取图像的一个区域。
...
[https://www.php.net/manual/en/imagick.getimageregion.php](https://www.php.net/manual/en/imagick.getimageregion.php)