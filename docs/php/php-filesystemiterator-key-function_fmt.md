...
`FilesystemIterator::key()` 函数是 PHP 中的一个内置函数，用于检索当前文件的密钥。
...
[https://www.php.net/manual/en/filesystemiterator.key.php](https://www.php.net/manual/en/filesystemiterator.key.php)