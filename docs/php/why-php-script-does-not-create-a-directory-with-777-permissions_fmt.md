...
> 原文：[https://www.geeksforgeeks.org/why-php-script-does-not-create-a-directory-with-777-permissions/](https://www.geeksforgeeks.org/why-php-script-does-not-create-a-directory-with-777-permissions/)
...
**例 2:** 假设新创建目录的权限为 665 或 `mkdir(“geeks”, 655)`。文件夹 “geeks” 将具有权限：`drw–wx-wx`。
...
**参考文献：** [https://www.php.net/manual/en/function.umask.php](https://www.php.net/manual/en/function.umask.php)