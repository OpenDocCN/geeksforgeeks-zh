...
`Gmagick::setImageBluePrimary()` 函数是 PHP 中的一个内置函数，用于设置特定图像通道的深度。
...
此函数返回一个包含点的 x 和 y 坐标的数组。

## 示例

下面的程序说明了 PHP 中的 `Gmagick::setImageBluePrimary()` 函数：
...
[http://php.net/manual/en/gmagick.setimageblueprimary.php](http://php.net/manual/en/gmagick.setimageblueprimary.php)