# `ImagickDraw::getStrokeLineJoin()` 函数
...
`ImagickDraw::getStrokeLineJoin()` 函数是 PHP 中的一个内置函数，用于在路径被描边时获取路径拐角处使用的形状。这通常会影响笔划的外缘和转弯。
...
[https://www.php.net/manual/en/imagickdraw.getstrokelinejoin.php](https://www.php.net/manual/en/imagickdraw.getstrokelinejoin.php)