...
`Imagick::setResourceLimit()` 函数是 PHP 中的内置函数，用于设置特定资源的限制。
...
*   `$type`: 指定对应于 `RESOURCETYPE` 常量之一的整数值。
*   `$limit`: 指定包含限制值的整数值。
...
[https://www.php.net/manual/en/imagick.setresourcelimit.php](https://www.php.net/manual/en/imagick.setresourcelimit.php)