...
`Imagick::setImageCompose()` 函数是 PHP 中的一个内置函数，用于设置与图像相关联的复合运算符。此函数用于指定使用 `Imagick::montageImage()` 方法时如何合成图像缩略图。
...
[https://www.php.net/manual/en/imagick.setimagecompose.php](https://www.php.net/manual/en/imagick.setimagecompose.php)