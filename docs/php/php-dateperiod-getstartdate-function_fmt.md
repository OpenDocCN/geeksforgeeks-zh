...
`DatePeriod::getStartDate()` 函数是 PHP 中的内置函数，用于返回给定日期段的开始日期。
...
[https://www.php.net/manual/en/dateperiod.getstartdate.php](https://www.php.net/manual/en/dateperiod.getstartdate.php)