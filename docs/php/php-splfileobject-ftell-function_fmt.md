...
`ftell()` 函数是 PHP 中标准 PHP 库 (SPL) 的内置函数，用于返回指定文件中当前偏移量的文件指针的位置。
...
下面的程序演示了 PHP 中的 `SplFileObject::ftell()` 函数：
...
[http://php.net/manual/en/splfileobject.ftell.php](http://php.net/manual/en/splfileobject.ftell.php)