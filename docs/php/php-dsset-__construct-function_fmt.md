...
`Ds\Set::__construct()`函数是 PHP 中的内置函数，用于创建 Set 的新实例。
...
下面的程序说明了 PHP 中的`Ds\Set::__construct()`函数：
...
[https://www.php.net/manual/en/ds-set.construct.php](https://www.php.net/manual/en/ds-set.construct.php)