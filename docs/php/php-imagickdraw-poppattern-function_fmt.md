...
`ImagickDraw::popPattern()` 函数是 PHP 中的一个内置函数，用于终止包含要应用的设计的模式定义。
...
[https://www.php.net/manual/en/imagickdraw.poppattern.php](https://www.php.net/manual/en/imagickdraw.poppattern.php)