...
`ReflectionParameter::getDeclaringClass()` 函数是 PHP 中的内置函数，用于返回声明类。
...
以下程序说明 PHP 中的 `ReflectionParameter::getDeclaringClass()` 函数：
...
[https://www.php.net/manual/en/reflectionparameter.getdeclaringclass.php](https://www.php.net/manual/en/reflectionparameter.getdeclaringclass.php)