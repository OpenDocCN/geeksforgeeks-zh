...
`ImagickDraw::getStrokeLineCap()` 函数是 PHP 中的一个内置函数，用于在打开的子路径被描边时获取要在其末尾使用的形状。
...
此函数返回与 [LINECAP 常量](https://www.php.net/manual/en/imagick.constants.php/#imagick.constants.linecap-undefined) 之一对应的整数值。
