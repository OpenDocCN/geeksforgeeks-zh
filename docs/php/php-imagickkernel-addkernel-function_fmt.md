...
`ImagickKernel::addKernel()` 函数是 PHP 中的一个内置函数，用于将另一个内核附加到该内核。使用此函数，我们可以将多个矩阵附加到同一内核，并使用我们想要的任何一个。
...
[https://www.php.net/manual/en/imagickkernel.addkernel.php](https://www.php.net/manual/en/imagickkernel.addkernel.php)