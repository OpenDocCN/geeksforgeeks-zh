...
此函数接受单个参数 `$radius`，该参数用于保存像素的半径。

## 返回值

此函数返回带中值滤波的 `Gmagick` 对象。
...
[http://php.net/manual/en/gmagick.medianfilterimage.php](http://php.net/manual/en/gmagick.medianfilterimage.php)