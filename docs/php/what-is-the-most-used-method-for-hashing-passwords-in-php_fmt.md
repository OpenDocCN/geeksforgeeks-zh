...
> 原文：[https://www.geeksforgeeks.org/what-is-the-most-used-method-for-hashing-passwords-in-php/](https://www.geeksforgeeks.org/what-is-the-most-used-method-for-hashing-passwords-in-php/)
...
> **密码为：** GeeksforGeeks
>
> **使用 CRYPT_BLOWFISH 散列的密码：** `$2y$10$v4v4agaqblwbw8i/phok9loptyoxyqze3az3cw9ddvju7wxoi`
>
> **使用 Argon2i 进行散列的密码：** `$argon2i$v=19$m=65536,t=4,p=1$y2f2tvouvwplyvyucy9dsw$p164c28n85l5v1i8gis1ao10zznM9/ejayi/clax/w`
>
> **使用 bcrypt 散列密码：** `$2y$10$MQU3vDgoN10.JxyJ1m9UQOEqFy.Jg3D8tmHdZUAAkcpGFRwkbbLfi`
