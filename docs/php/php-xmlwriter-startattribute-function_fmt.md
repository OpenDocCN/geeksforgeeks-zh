...
`XMLWriter::startAttribute()` 函数是 PHP 中的一个内置函数，用于启动属性。稍后可以使用 `XMLWriter::endAttribute()` 函数关闭该属性。
...
[https://www.php.net/manual/en/function.xmlwriter-start-attribute.php](https://www.php.net/manual/en/function.xmlwriter-start-attribute.php)