...
`imagesetstyle()` 函数是 PHP 中的一个内置函数，用于设置所有线条绘制函数（如 `imageline()` 或 `imagepolygon()`）使用的样式。
...
[https://www.php.net/manual/en/function.imagesetstyle.php](https://www.php.net/manual/en/function.imagesetstyle.php)