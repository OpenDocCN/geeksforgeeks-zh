...
`ImagickDraw::pathLineToHorizontalAbsolute()`函数是 PHP 中的内置函数，用于使用绝对坐标绘制从当前点到目标点的水平线路径。然后，目标点将成为新的当前点。也可以使用`pathMoveToRelative()`函数设置当前点。
...
[https://www.php.net/manual/en/imagickdraw.pathlinetohorizontalabsolute.php](https://www.php.net/manual/en/imagickdraw.pathlinetohorizontalabsolute.php)