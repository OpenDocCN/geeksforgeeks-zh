...
`Imagick::Destroy()` 函数是 PHP 中的一个内置函数，用于销毁 `Imagick` 对象并释放与其关联的所有资源。一旦对象内容被销毁，您将无法访问它。
...
[https://www.php.net/manual/en/imagick.destroy.php](https://www.php.net/manual/en/imagick.destroy.php)