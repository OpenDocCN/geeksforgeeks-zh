...
`ReflectionClass::getTraitNames()` 函数是 PHP 中的一个内置函数，用于返回用户定义类使用的特征名称数组。
...
[https://secure.php.net/manual/en/reflectionclass.gettraitnames.php](https://secure.php.net/manual/en/reflectionclass.gettraitnames.php)