...
`SimpleXMLIterator::getChildren()` 函数是 PHP 中的内置函数，用于返回包含当前元素的子元素的 `SimpleXMLIterator` 对象。
...
此函数返回包含当前元素的子元素的 `SimpleXMLIterator` 对象。
...
[https://www.php.net/manual/en/simplexmliterator.getchildren.php](https://www.php.net/manual/en/simplexmliterator.getchildren.php)