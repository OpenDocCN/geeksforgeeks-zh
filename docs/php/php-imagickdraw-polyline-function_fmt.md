...
`ImagickDraw::polyline()` 函数是 PHP 的 Imagick 库中的内置函数，用于使用指定的坐标数组，结合当前的笔划、笔划宽度和填充颜色或纹理来绘制多段线。
...
此函数接受单个参数 `$coordinates`，该参数是一个用于保存点坐标的数组。
...
[http://php.net/manual/en/imagickdraw.polyline.php](http://php.net/manual/en/imagickdraw.polyline.php)