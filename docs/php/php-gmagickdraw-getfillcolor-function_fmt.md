...
`GmagickDraw::getfillcolor()` 函数是 PHP 中的一个内置函数，用于获取用于绘制填充对象的填充颜色。
...
此函数返回用于绘制填充对象的 `GmagickPixel` 填充颜色。
...
下面给出的程序演示了 PHP 中的 `GmagickDraw::getfillcolor()` 函数：
...
[https://www.php.net/manual/en/gmagickdraw.getfillcolor.php](https://www.php.net/manual/en/gmagickdraw.getfillcolor.php)