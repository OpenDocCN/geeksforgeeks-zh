# SimpleXMLElement::addAttribute() 函数
...
## 引用
[https://www.php.net/manual/en/simplexmlelement.addattribute.php](https://www.php.net/manual/en/simplexmlelement.addattribute.php)