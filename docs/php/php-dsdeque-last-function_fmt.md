...
> 原文：[https://www.geeksforgeeks.org/php-dsdeque-last-function/](https://www.geeksforgeeks.org/php-dsdeque-last-function/)
...
如果双队列中的最后一个元素不为空，则此函数返回该元素。

## 异常

如果 Deque 为空，则此函数抛出 `UnderflowException`。
...
[http://php.net/manual/en/ds-deque.last.php](http://php.net/manual/en/ds-deque.last.php)