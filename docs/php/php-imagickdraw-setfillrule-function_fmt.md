...
`ImagickDraw::setFillRule()`函数是 PHP 中的一个内置函数，用于设置绘制多边形时使用的填充规则。
...
此函数接受单个参数`$FILL_RULE`，该参数保存与[FILLRULE 常量](https://www.php.net/manual/en/imagick.constants.php/#imagick.constants.fillrule-undefined)之一相对应的整数值。
