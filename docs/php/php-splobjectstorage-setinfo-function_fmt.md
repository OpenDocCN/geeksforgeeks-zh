...
此函数接受单个参数 `$val`，该参数指定要与存储的当前迭代器条目相关联的数据。
...
[https://www.php.net/manual/en/splobjectstorage.setinfo.php](https://www.php.net/manual/en/splobjectstorage.setinfo.php)