# ImagickDraw::setTextInterwordSpacing() 函数
...
`ImagickDraw::setTextInterwordSpacing()` 函数是 PHP 中的一个内置函数，用于设置文本的单词间间距，即每个单词之间的间距。数字越大，空间就越大。默认间距为 0。
...
[https://www.php.net/manual/en/imagickdraw.settextinterwordspacing.php](https://www.php.net/manual/en/imagickdraw.settextinterwordspacing.php)