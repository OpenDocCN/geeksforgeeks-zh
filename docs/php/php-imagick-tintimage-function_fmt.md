...
`Imagick::tintImage()`函数是 PHP 中的一个内置函数，用于将颜色向量应用到图像的每个像素。
...
[https://www.php.net/manual/en/imagick.tintimage.php](https://www.php.net/manual/en/imagick.tintimage.php)