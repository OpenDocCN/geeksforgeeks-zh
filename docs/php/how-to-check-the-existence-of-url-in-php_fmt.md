...
> 原文：[https://www.geeksforgeeks.org/how-to-check-the-existence-of-url-in-php/](https://www.geeksforgeeks.org/how-to-check-the-existence-of-url-in-php/)
...
*   `strpos()` 函数：此函数用于将一个字符串的第一个匹配项查找到另一个字符串中。

## 示例 1

本示例检查响应标题中的状态代码 200。如果状态代码为 200，则表示网址存在，否则不存在。
...
该示例检查响应报头中的状态代码 404。如果状态代码为 404，则表明网址不存在，否则网址存在。
