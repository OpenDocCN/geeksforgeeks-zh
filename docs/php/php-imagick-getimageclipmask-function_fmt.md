...
`Imagick::getImageClipMask()` 函数是 PHP 中的一个内置函数，用于获取图像剪辑蒙版。
...
[https://www.php.net/manual/en/imagick.getimageclipmask.php](https://www.php.net/manual/en/imagick.getimageclipmask.php)