...
`DOMNode::cloneNode()` 函数是 PHP 中的一个内置函数，用于创建节点的副本。
...
此函数接受单个参数 `$deep`，该参数指示是否复制所有子代节点。 默认情况下，此参数设置为 `False`。
...
[https://www.php.net/manual/en/domnode.clonenode.php](https://www.php.net/manual/en/domnode.clonenode.php)