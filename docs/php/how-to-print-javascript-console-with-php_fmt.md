...
> 原文: [https://www.geeksforgeeks.org/how-to-print-javascript-console-with-php/](https://www.geeksforgeeks.org/how-to-print-javascript-console-with-php/)

PHP 中使用 `echo` 命令来打印 HTML 文档的任何值。
...
## 注意:
`echo` 命令将打印 HTML 文档。这个特性可以用来在 HTML 页面中放置 JavaScript 语句。

## 示例 1:
本示例说明如何使用 `echo` 关键字显示内容。
