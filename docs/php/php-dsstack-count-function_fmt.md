...
> 原文：[https://www.geeksforgeeks.org/php-dsstack-count-function/](https://www.geeksforgeeks.org/php-dsstack-count-function/)

`Ds\Stack::count()` 函数是 PHP 中的一个内置函数，用于计算 Stack 中存在的元素数量。
...
[https://www.php.net/manual/en/ds-stack.count.php](https://www.php.net/manual/en/ds-stack.count.php)