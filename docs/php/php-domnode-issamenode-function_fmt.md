...
`DOMNode::isSameNode()` 函数是 PHP 中的一个内置函数，用于指示两个节点是否为同一节点。
...
[https://www.php.net/manual/en/domnode.issamenode.php](https://www.php.net/manual/en/domnode.issamenode.php)