...
[阅读 XML 基础知识](https://www.geeksforgeeks.org/xml-basics/)

`SimpleXMLElement::count()` 函数是 PHP 中内置函数，用于计算 `SimpleXMLElement` 对象中的子元素数量。
...
[https://www.php.net/manual/en/simplexmlelement.count.php](https://www.php.net/manual/en/simplexmlelement.count.php)