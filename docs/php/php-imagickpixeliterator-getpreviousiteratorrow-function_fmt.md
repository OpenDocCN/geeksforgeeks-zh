# ImagickPixelIterator::getPreviousIteratorRow() 函数
...
`ImagickPixelIterator::getPreviousIteratorRow()` 函数是 PHP 中的一个内置函数，用于从像素迭代器获取作为像素棒数组的前一行。
...
[https://www.php.net/manual/en/imagickpixeliterator.getpreviousiteratorrow.php](https://www.php.net/manual/en/imagickpixeliterator.getpreviousiteratorrow.php)