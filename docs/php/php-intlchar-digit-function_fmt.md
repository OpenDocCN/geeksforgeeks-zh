...
此函数返回由给定基数中的字符表示的数字，如果没有值或值超过基数，则返回 `false`。
...
*   字符是介于 `'A'` 到 `'Z'` 之间的大写拉丁字母。那么字符值是 `ch - 'A' + 10`。
...
[http://php.net/manual/en/intlchar.digit.php](http://php.net/manual/en/intlchar.digit.php)