...
下面的程序演示了 PHP 中的 `Imagick::autoLevelImage()` 函数：
...
[http://php.net/manual/en/imagick.autolevelimage.php](http://php.net/manual/en/imagick.autolevelimage.php)