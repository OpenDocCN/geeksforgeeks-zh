...
`ImagickDraw::setTextEncoding()` 函数是 PHP 中的一个内置函数，用于设置用于文本注释的代码集。这些代码集告诉计算机如何将原始的 0 和 1 解释为真正的字符。通常，它们生成相同的文本，但使用不同的代码集。
...
此函数接受单个参数 `$encoding_name`，该参数保存代码集的名称。
...
[https://www.php.net/manual/en/imagickdraw.settextencoding.php](https://www.php.net/manual/en/imagickdraw.settextencoding.php)