...
`ArrayIterator::uksort()`函数是 PHP 中的一个内置函数，用于通过使用用户定义的比较函数对键进行排序。
...
该功能接受单参数 `$cmp_function`，保存用户定义的比较函数。
...
[https://www.php.net/manual/en/arrayiterator.uksort.php](https://www.php.net/manual/en/arrayiterator.uksort.php)