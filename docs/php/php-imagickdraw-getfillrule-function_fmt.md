...
`ImagickDraw::getFillRule()` 函数是 PHP 中的一个内置函数，用于获取绘制多边形时使用的填充规则。
...
此函数返回与 [FILLRULE 常量](https://www.php.net/manual/en/imagick.constants.php/#imagick.constants.fillrule-undefined) 之一对应的整数值。
...
[https://www.php.net/manual/en/imagickdraw.getfillrule.php](https://www.php.net/manual/en/imagickdraw.getfillrule.php)