...
PHP（Professional Hypertext Preprocessor 的缩写）示例代码：
...
[http://php.net/manual/en/function.array-unshift.php](http://php.net/manual/en/function.array-unshift.php)