...
`Imagick::getRegistry()` 函数是 PHP 中的一个内置函数，用于获取命名键的 StringRegistry 条目，如果未设置，则为 `False`。
...
[https://www.php.net/manual/en/imagick.getregistry.php](https://www.php.net/manual/en/imagick.getregistry.php)