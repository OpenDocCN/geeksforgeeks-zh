...
`Gmagick::queryFormats()` 函数是 PHP 中的一个内置函数，用于获取 Gmagick 对象支持的格式。
...
此函数接受单个参数 `$pattern`，该参数保存正则表达式模式以检查是否支持某种格式。
...
下面给出的程序演示了 PHP 中的 `Gmagick::queryFormats()` 函数：
...
[https://www.php.net/manual/en/gmagick.queryformats.php](https://www.php.net/manual/en/gmagick.queryformats.php)