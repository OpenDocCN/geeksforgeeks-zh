...
> 原文：[`https://www.geeksforgeeks.org/php-var_dump-function/`](https://www.geeksforgeeks.org/php-var_dump-function/)
...
该函数接受单个参数`$expsn`，该参数可以是单个变量，也可以是包含多个任意类型的空格分隔变量的表达式。
