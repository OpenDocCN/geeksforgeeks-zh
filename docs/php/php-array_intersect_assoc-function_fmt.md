...
> 原文：[https://www.geeksforgeeks.org/php-array_intersect_assoc-function/](https://www.geeksforgeeks.org/php-array_intersect_assoc-function/)
...
`array_intersect_assoc()` 函数将至少两个数组作为参数。该函数可以将任意数量的数组作为大于或等于 2 的参数。

## 返回值

函数返回另一个包含所有输入数组交集的数组。如果没有元素匹配，则返回空数组。
...
[http://php.net/manual/en/function.array-intersect-assoc.php](http://php.net/manual/en/function.array-intersect-assoc.php)