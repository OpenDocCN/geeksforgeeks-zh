...
如果优先级队列处于损坏状态，则此函数返回 `TRUE`，否则返回 `FALSE`。
...
[https://www.php.net/manual/en/splpriorityqueue.iscorrupted.php](https://www.php.net/manual/en/splpriorityqueue.iscorrupted.php)