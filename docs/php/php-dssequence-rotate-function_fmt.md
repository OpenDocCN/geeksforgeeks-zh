# Ds\Sequence::rotate() 函数

> 原文：[https://www.geeksforgeeks.org/php-dssequence-rotate-function/](https://www.geeksforgeeks.org/php-dssequence-rotate-function/)
