...
`exif_tagname()` 函数是 PHP 中的一个内置函数，用于获取索引头名称。
...
此函数接受保存头名称的单个参数 `$index`。

## 返回值

如果成功，此函数返回 Header 的名称。
...
[https://www.php.net/manual/en/function.exif-tagname.php](https://www.php.net/manual/en/function.exif-tagname.php)