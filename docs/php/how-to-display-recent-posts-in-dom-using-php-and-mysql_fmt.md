...
> 原文：[https://www.geeksforgeeks.org/how-to-display-recent-posts-in-dom-using-php-and-mysql/](https://www.geeksforgeeks.org/how-to-display-recent-posts-in-dom-using-php-and-mysql/)
...
3.  创建一个名为 `posts.php` 的 PHP 页面，并将其放在 **XAMPP** 内的 **htdocs** 文件夹中。

## HTML 代码

将 [**font-awesome**](https://fontawesome.com/v4.7.0/get-started/) 目录下载到你的工作文件夹中，并参考文件 `font-awesome.min.css` 的适当位置，如下所示。
                ...
                <div class="carousel-cell p-2">
                    <div class="card  mx-2" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            ...
                            <h5 class="card-title">
                                <a href="blog-template.php" class="blog-link">
                                    CAT 1
                                </a>
                            </h5>
...
上面的代码中使用了下面的 `style.css` 文件来设置 HTML 控件的样式。
...
<div class="blog-latest">
    <div class="container">
        <h1 class="blog-secondary-heading text-dark">Latest Blogs</h1>
        <div class="main-carousel p-2" id="latestCarousel">
            <div class="row">
                <?php
                for($x = 0; $x < 4; $x++) {
                    ...
                    if(isset($x)) {
                        $query = mysqli_query($conn,"SELECT * FROM `posts` WHERE id = '$idarray[$x]'");
