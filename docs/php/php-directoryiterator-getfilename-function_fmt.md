...
`DirectoryIterator::getFilename()` 函数是 PHP 中的内置函数，用于返回当前 DirectoryIterator 项的文件名。
...
此函数返回当前 DirectoryIterator 项的文件名。
...
[https://www.php.net/manual/en/directoryiterator.getfilename.php](https://www.php.net/manual/en/directoryiterator.getfilename.php)