...
`ImagickDraw::popClipPath()` 函数是 PHP 中的内置函数，用于终止剪辑路径定义。剪辑路径用于创建剪辑区域，该区域决定应显示图像的哪一部分。显示区域内的零件，而隐藏区域外部的零件。
...
[https://www.php.net/manual/en/imagickdraw.popclippath.php](https://www.php.net/manual/en/imagickdraw.popclippath.php)