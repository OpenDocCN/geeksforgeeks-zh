...
此函数接受单个参数 `$stroke_opacity`，该参数用于将笔划不透明度的值保存为浮点类型。
...
[http://php.net/manual/en/imagickdraw.setstrokeopacity.php](http://php.net/manual/en/imagickdraw.setstrokeopacity.php)