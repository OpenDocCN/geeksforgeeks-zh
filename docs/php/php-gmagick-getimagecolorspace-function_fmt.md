...
`Gmagick::getimagecolorspace()` 函数是 PHP 中的一个内置函数，用于获取图像色彩空间。颜色空间是一个数学模型，它将颜色范围描述为数字元组，通常为 3 或 4 个值是颜色分量（RGB）。
...
[https://www.php.net/manual/en/gmagick.getimagecolorspace.php](https://www.php.net/manual/en/gmagick.getimagecolorspace.php)