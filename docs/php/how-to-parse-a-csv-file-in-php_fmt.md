...
> 原文：[https://www.geeksforgeeks.org/how-to-parse-a-csv-file-in-php/](https://www.geeksforgeeks.org/how-to-parse-a-csv-file-in-php/)
...
### 第一步
将数据添加到 excel 文件中。下面给出了一个示例数据，其列标题为“名称”和“编码分数”。

![](img/585440bf5d3e07b4540fa0ce66654be0.png)

### 第二步
按照路径转换成 CSV 文件。转到文件 > 导出 > 更改文件类型 > CSV 类型。将文件保存在名为 `Book1.csv` 的工作文件夹中。
...
### 第一步
创建一个文件夹，添加那个 CSV 文件，并在其中创建一个新的 PHP 文件。
