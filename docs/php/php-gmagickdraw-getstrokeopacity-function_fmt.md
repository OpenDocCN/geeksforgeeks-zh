...
`GmagickDraw::getstrokeopacity()` 函数是 PHP 中的一个内置函数，用于返回笔划对象轮廓的不透明度。
...
以下程序说明了 PHP 中的 `GmagickDraw::getstrokeopacity()` 函数：
...
引用：`http://php.net/manual/en/gmagickdraw.getstrokeopacity.php`