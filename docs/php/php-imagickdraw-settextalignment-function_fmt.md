...
此函数接受单个参数 `$alignment`，该参数用于保存 `ALIGN_CONSTANNTS` 的值。

`ALIGN_CONSTAINT` 列表如下所示：
...
[http://php.net/manual/en/imagickdraw.settextalignment.php](http://php.net/manual/en/imagickdraw.settextalignment.php)