...
`GmagickDraw::getfontstyle()` 函数是 PHP 中的一个内置函数，用于获取在注释文本时使用的字体样式。
...
此函数返回与[样式常量](https://www.php.net/manual/en/gmagick.constants.php#gmagick.constants.style-normal)之一相对应的整数值。
样式常量列表如下：
