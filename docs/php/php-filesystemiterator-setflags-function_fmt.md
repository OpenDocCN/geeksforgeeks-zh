...
`FilesystemIterator::setFlags()` 函数是 PHP 中的内置函数，用于设置处理标志。
...
[https://www.php.net/manual/en/filesystemiterator.setflags.php](https://www.php.net/manual/en/filesystemiterator.setflags.php)