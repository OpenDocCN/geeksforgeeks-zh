...
此函数接受单个参数 `$mode`，该参数包含下面列出的两组正交模式：
...
以下程序说明 PHP 中的 `SplDoublyLinkedList::setIteratorMode()` 函数：
...
[https://www.php.net/manual/en/spldoublylinkedlist.setiteratormode.php](https://www.php.net/manual/en/spldoublylinkedlist.setiteratormode.php)