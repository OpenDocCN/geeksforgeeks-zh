...
`Imagick::getCompression()` 函数是 PHP 中的一个内置函数，用于获取对象压缩类型。
...
[https://www.php.net/manual/en/imagick.getcompression.php](https://www.php.net/manual/en/imagick.getcompression.php)