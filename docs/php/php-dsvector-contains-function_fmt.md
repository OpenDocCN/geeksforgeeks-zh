...
> 原文：[https://www.geeksforgeeks.org/php-dsvector-contains-function/](https://www.geeksforgeeks.org/php-dsvector-contains-function/)
...
此函数接受包含单个或多个值的单个参数 `$values`。

## 返回值

如果给定值存在，此函数返回 `TRUE`，否则返回 `FALSE`。
...
[http://php.net/manual/en/ds-vector.contains.php](http://php.net/manual/en/ds-vector.contains.php)