...
`Gmagick::queryfontmetrics()` 函数是 PHP 中的内置函数，它返回一个数组，该数组表示包含 `characterWidth`、`characterHeight`、`ascender`、`descender`、`textWidth`、`textHeight` 和 `maximumHorizontalAdvance` 的字体度量。
...
[https://www.php.net/manual/en/gmagick.queryfontmetrics.php](https://www.php.net/manual/en/gmagick.queryfontmetrics.php)