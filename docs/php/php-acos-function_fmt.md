...
该函数接受单个参数 `$value`。它是您想要查找其弧余弦值的数字。此参数的值必须以弧度为单位。

## 返回值

返回一个浮点数，该浮点数是作为参数传递给它的数的弧余弦值。
...
*   传递 2 作为参数。由于 2 超出了范围 [-1,1]，该函数将返回 `NaN`：
...
[http://php.net/manual/en/function.acos.php](http://php.net/manual/en/function.acos.php)