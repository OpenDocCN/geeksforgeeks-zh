...
`XMLReader::close()` 函数是 PHP 中的一个内置函数，用于关闭当前正在解析的 `XMLReader` 对象的输入。
...
[https://www.php.net/manual/en/xmlreader.close.php](https://www.php.net/manual/en/xmlreader.close.php)