...
$image = new Gmagick();
$draw = new GmagickDraw();
$image = new Gmagick('https://media.geeksforgeeks.org/wp-content/uploads/geeksforgeeks-9.png');
...
/* Create text */
$image->annotateImage($draw, 5, 120, 0, 'GeeksforGeeks: A computer science portal');
...
[http://php.net/manual/en/gmagick.annotateimage.php](http://php.net/manual/en/gmagick.annotateimage.php)