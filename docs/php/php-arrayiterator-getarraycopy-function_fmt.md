...
`ArrayIterator::getArrayCopy()` 函数是 PHP 中的一个内置函数，用于创建数组的副本。
...
[https://www.php.net/manual/en/arrayiterator.getarraycopy.php](https://www.php.net/manual/en/arrayiterator.getarraycopy.php)