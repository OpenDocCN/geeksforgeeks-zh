...
> 原文：[https://www.geeksforgeeks.org/php-arrayiterator-ksort-function/](https://www.geeksforgeeks.org/php-arrayiterator-ksort-function/)

`ArrayIterator::ksort()` 函数是 PHP 中的一个内置函数，用于按键对数组元素进行排序。
...
[https://www.php.net/manual/en/arrayiterator.ksort.php](https://www.php.net/manual/en/arrayiterator.ksort.php)