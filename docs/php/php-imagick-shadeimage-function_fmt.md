...
$imagick = new Imagick('https://media.geeksforgeeks.org/wp-content/uploads/geeksforgeeks-12.png');
...
*   [PHP|Imagick transposeImage() 函数](https://www.geeksforgeeks.org/php-imagick-transposeimage-function/)
*   [PHP|Imagick addNoiseImage() 函数](https://www.geeksforgeeks.org/php-imagickaddnoiseimage-function/)

## 引用

[http://php.net/manual/en/imagick.shadeimage.php](http://php.net/manual/en/imagick.shadeimage.php)