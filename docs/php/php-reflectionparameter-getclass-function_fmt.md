...
`ReflectionParameter::getClass()` 函数是 PHP 中的一个内置函数，用于返回参数提示的类类型。
...
以下程序说明 PHP 中的 `ReflectionParameter::getClass()` 函数：
...
[https://www.php.net/manual/en/reflectionparameter.getclass.php](https://www.php.net/manual/en/reflectionparameter.getclass.php)