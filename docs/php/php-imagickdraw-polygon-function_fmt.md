...
> 原文：[https://www.geeksforgeeks.org/php-imagickdraw-polygon-function/](https://www.geeksforgeeks.org/php-imagickdraw-polygon-function/)
...
此函数接受数组类型的单个参数 `$coordinates`。 它是用来存放这组点的。
...
[http://php.net/manual/en/imagickdraw.polygon.php](http://php.net/manual/en/imagickdraw.polygon.php)