...
`Imagick::getPage()` 函数是 PHP 中的一个内置函数，用于以关联数组格式返回与 `Imagick` 对象相关联的页面的几何形状。
...
此函数返回具有键 `"width"`、`"Height"`、`"x"` 和 `"y"` 的关联数组。
...
[https://www.php.net/manual/en/imagick.getpage.php](https://www.php.net/manual/en/imagick.getpage.php)