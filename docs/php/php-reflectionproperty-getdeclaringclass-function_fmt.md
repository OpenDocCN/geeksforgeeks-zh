...
> Original: `https://www.geeksforgeeks.org/php-reflectionproperty-getdeclaringclass-function/`

`ReflectionProperty::getDeclaringClass()` 函数是 PHP 中的内置函数，用于返回指定的声明类。
...
以下程序说明 PHP 中的 `ReflectionProperty::getDeclaringClass()` 函数：
