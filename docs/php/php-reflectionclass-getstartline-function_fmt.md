# ReflectionClass::getStartLine()函数
...
`ReflectionClass::getStartLine()`函数是 PHP 中的一个内置函数，用于返回用户定义的类开始时的行号。
...
[https://www.php.net/manual/en/reflectionclass.getstartline.php](https://www.php.net/manual/en/reflectionclass.getstartline.php)