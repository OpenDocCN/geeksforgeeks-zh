...
`Gmagick::levelimage()` 函数是 PHP 中的一个内置函数，用于通过将落在指定白点和黑点之间的颜色缩放到全部可用量子范围来调整图像的级别。
...
下面给出的程序演示了 PHP 中的 `Gmagick::levelimage()` 函数：
...
[https://www.php.net/manual/en/gmagick.levelimage.php](https://www.php.net/manual/en/gmagick.levelimage.php)