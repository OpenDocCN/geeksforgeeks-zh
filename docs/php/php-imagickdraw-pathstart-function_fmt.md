...
`ImagickDraw::pathStart()` 函数是 PHP 中的一个内置函数，用于声明路径图纸列表的开始。稍后，使用 `pathFinish()` 函数来终止该列表。
...
[https://www.php.net/manual/en/imagickdraw.pathstart.php](https://www.php.net/manual/en/imagickdraw.pathstart.php)