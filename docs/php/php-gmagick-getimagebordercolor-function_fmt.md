...
`Gmagick::getimagebordercolor()`函数是 PHP 中的一个内置函数，用于获取图像边框颜色。
...
[https://www.php.net/manual/en/gmagick.getimagebordercolor.php](https://www.php.net/manual/en/gmagick.getimagebordercolor.php)