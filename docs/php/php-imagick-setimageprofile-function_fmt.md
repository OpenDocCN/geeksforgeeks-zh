...
`Imagick::setImageProfile()` 函数是 PHP 中的一个内置函数，用于将命名配置文件设置为 Imagick 对象。
...
[https://www.php.net/manual/en/imagick.setimageprofile.php](https://www.php.net/manual/en/imagick.setimageprofile.php)