...
> 原文：[https://www.geeksforgeeks.org/php-imagestringup-function/](https://www.geeksforgeeks.org/php-imagestringup-function/)

函数的作用是：`imagestringup()` 函数是 PHP 中的一个内置函数，用于垂直绘制字符串。
...
[http://php.net/manual/en/function.imagestringup.php](http://php.net/manual/en/function.imagestringup.php)