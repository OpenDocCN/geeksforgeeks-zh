...
此函数接受单个参数 `$image`，该参数是必需的。函数的作用是：创建给定大小的图像。此函数用于创建给定大小的空白图像。

## 返回值

此函数返回给定图像调色板中的颜色数，或者返回真彩色图像的 0。
...
[http://php.net/manual/en/function.imagecolorstotal.php](http://php.net/manual/en/function.imagecolorstotal.php)