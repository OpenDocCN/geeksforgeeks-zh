...
> 原文: [https://www.geeksforgeeks.org/how-to-calculate-total-time-of-an-array-in-php/](https://www.geeksforgeeks.org/how-to-calculate-total-time-of-an-array-in-php/)
...
`strtotime()` 函数用于将字符串转换为时间格式。该函数以 `h:m:s` 格式返回时间。
