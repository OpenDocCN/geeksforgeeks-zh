...
`Imagick::hasNextImage()` 函数是 PHP 中的一个内置函数，用于检查对象是否包含更多图像。
...
此函数返回一个布尔值，如果对象在正向遍历列表时有更多图像，则返回 `TRUE`，如果没有图像，则返回 `FALSE`。
...
[https://www.php.net/manual/en/imagick.hasnextimage.php](https://www.php.net/manual/en/imagick.hasnextimage.php)