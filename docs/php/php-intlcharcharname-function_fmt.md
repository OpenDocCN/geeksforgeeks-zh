...
生成的字符名称是 Unicode 1.0 版的现代名称，名称包含“不变”字符 *A-Z、0-9、“”和‘-’*，并取决于其 `$nameChoice` 参数。

## 返回值

此函数返回输入数据对应的名称。 如果没有字符名称，则返回空字符串。
...
*   [`IntlChar::charDigitValue()` 函数](https://www.geeksforgeeks.org/php-intlchardigitvalue-function/)
...
[http://php.net/manual/en/intlchar.charname.php](http://php.net/manual/en/intlchar.charname.php)