...
此函数接受单个参数 `$kes_width`，该参数用于保存笔划宽度的值。 它是浮点型的值。
...
[http://php.net/manual/en/imagickdraw.setstrokewidth.php](http://php.net/manual/en/imagickdraw.setstrokewidth.php)