# ImagickPixelIterator::syncIterator() 函数
...
`ImagickPixelIterator::syncIterator()` 函数是 PHP 中的内置函数，用于同步像素迭代器。
...
[https://www.php.net/manual/en/imagickpixeliterator.synciterator.php](https://www.php.net/manual/en/imagickpixeliterator.synciterator.php)