...
`SplFixedArray::Next()` 函数是 PHP 中的一个内置函数，用于将数组内部指针移动到数组的下一个条目。
...
[https://www.php.net/manual/en/splfixedarray.next.php](https://www.php.net/manual/en/splfixedarray.next.php)