...
`DOMDocument::loadHTMLFile()` 函数是 PHP 中的内置函数，用于从文件加载 HTML。
...
*   `$options`: 此参数用于指定额外的 Libxml 参数，需要 PHP 5.4.0 和 Libxml 2.6.0。
...
[https://www.php.net/manual/en/domdocument.loadhtmlfile.php](https://www.php.net/manual/en/domdocument.loadhtmlfile.php)