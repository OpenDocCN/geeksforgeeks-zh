...
`Imagick::getIteratorIndex()` 函数是 PHP 中的一个内置函数，用于获取当前活动图像的索引。这是 [`getImageIndex()`](https://www.geeksforgeeks.org/php-imagick-getimageindex-function/) 函数的替代函数。
...
[https://www.php.net/manual/en/imagick.getiteratorindex.php](https://www.php.net/manual/en/imagick.getiteratorindex.php)