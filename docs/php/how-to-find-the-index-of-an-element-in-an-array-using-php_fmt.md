...
> 原文：[https://www.geeksforgeeks.org/how-to-find-the-index-of-an-element-in-an-array-using-php/](https://www.geeksforgeeks.org/how-to-find-the-index-of-an-element-in-an-array-using-php/)

在本文中，我们将讨论如何在 PHP 中找到数组中元素的索引。数组索引从 `0` 到 `n-1` 开始。我们可以通过使用 `array_search()` 函数来获取数组索引。该函数用于搜索给定的元素。它将接受两个参数。
