...
`ImagickDraw::setStrokeDashArray()` 函数是 PHP 中的一个内置函数，用于设置用于描边路径的虚线和间隙模式。在值为奇数的情况下，重复值列表以产生偶数个值。要删除现有的破折号数组，请传递零 `Number_Elements` 参数或空的破折号数组。
...
[https://www.php.net/manual/en/imagickdraw.setstrokedasharray.php](https://www.php.net/manual/en/imagickdraw.setstrokedasharray.php)