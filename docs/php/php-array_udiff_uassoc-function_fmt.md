...
> 原文: [https://www.geeksforgeeks.org/php-array_udiff_uassoc-function/](https://www.geeksforgeeks.org/php-array_udiff_uassoc-function/)

`array_udiff_uassoc()`函数是 PHP 中的一个内置函数，用于区分两个或多个数组。该函数通过使用两个带有附加索引键的用户定义函数来计算差异数组。它通过使用回调函数来比较数据和索引，并返回差异。
...
**参考:** [http://php.net/manual/en/function.array-udiff-uassoc.php](http://php.net/manual/en/function.array-udiff-uassoc.php)