...
const parent = new Vue({
    el : '#parent',
    data : {
        // The data that will be interpolated in the DOM
        name : 'Vue.Js'
    }
})
```
...
<body>
    <div id='parent'>
        ...
        <ul>
            <li>
              <strong>{{priority1}}</strong> is Awesome
            </li>
            <li>
              <strong>{{priority2}}</strong> is quite good
            </li>
            <li>
              <strong>{{priority3}}</strong> is good too
            </li>
        </ul>
        <script src='app.js'></script>
    </div>
