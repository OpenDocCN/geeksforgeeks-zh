...
> 原文: [https://www.geeksforgeeks.org/difference-between-reactjs-and-vue-js/](https://www.geeksforgeeks.org/difference-between-reactjs-and-vue-js/)
...
| 在 React 状态管理库中被称为 `MobX`。 | 在 Vue 中，状态管理库被称为 `Vuex`。 |
