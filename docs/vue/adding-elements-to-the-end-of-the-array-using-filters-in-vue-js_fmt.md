...
> 原文：[https://www.geeksforgeeks.org/adding-elements-to-the-end-of-the-array-using-filters-in-vue-js/](https://www.geeksforgeeks.org/adding-elements-to-the-end-of-the-array-using-filters-in-vue-js/)
...
<body>
  <div id='parent'>
    <p>
      ...
      <ol>
        <li v-for='item in $options.filters.addLast(arr1, ["Rice","Bread","Milk"])'>
          <strong>{{ item }}</strong>
        </li>
      </ol>
    </p>
