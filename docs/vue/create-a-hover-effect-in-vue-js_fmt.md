...
> 原文：[https://www.geeksforgeeks.org/create-a-hover-effect-in-vue-js/](https://www.geeksforgeeks.org/create-a-hover-effect-in-vue-js/)
...
const parent = new Vue({
    ...
    data : {
        ...
        vueMsg: "Vue is a progressive framework for building user interfaces",
        angularMsg: "Angular is awesome for single page application development"
    }
})
```
