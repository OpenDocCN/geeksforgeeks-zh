...
> 原文: [https://www.geeksforgeeks.org/python-sympy-expand_pow_exp-method/](https://www.geeksforgeeks.org/python-sympy-expand_pow_exp-method/)
...
## 例 #1
在这个例子中我们可以看到，通过使用 `sympy.expand_pow_exp()` 方法，我们可以用幂展开一个数学表达式。
