# Python 中的 sympy.integrals.transforms.Hankel_transform()

> 原文: [https://www.geeksforgeeks.org/sympy-integrals-transforms-hankel_transform-in-python/](https://www.geeksforgeeks.org/sympy-integrals-transforms-hankel_transform-in-python/)
...
> **语法:** `hankel_transform(f, r, k, nu, **hints)`
> 
> **返回:** 返回转换后的函数。
