...
> 原文: [https://www.geeksforgeeks.org/python-sympy-eigenvals-method/](https://www.geeksforgeeks.org/python-sympy-eigenvals-method/)

借助 `sympy.eigenvals()` 方法，我们可以求出一个矩阵的特征值。
