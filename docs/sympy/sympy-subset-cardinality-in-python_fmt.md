...
> 原文: [https://www.geeksforgeeks.org/sympy-subset-cardinality-in-python/](https://www.geeksforgeeks.org/sympy-subset-cardinality-in-python/)

`subset.cardinality()` 是一个 sympy Python 库函数，返回所有可能子集的数量。
