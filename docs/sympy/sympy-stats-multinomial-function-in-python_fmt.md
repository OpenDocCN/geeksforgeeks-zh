## Python 中的 `sympy.stats.Multinomial()` 函数

> 原文: [https://www.geeksforgeeks.org/sympy-stats-multinomial-function-in-python/](https://www.geeksforgeeks.org/sympy-stats-multinomial-function-in-python/)

借助`Multinomial`方法，我们可以创建一个具有多项式分布的离散随机变量。
