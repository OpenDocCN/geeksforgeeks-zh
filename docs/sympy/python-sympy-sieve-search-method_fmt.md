...
> 原文: [https://www.geeksforgeeks.org/python-sympy-sieve-search-method/](https://www.geeksforgeeks.org/python-sympy-sieve-search-method/)

借助 `sieve.search()` 方法，我们可以找到束缚给定数的素数的指数 `i` 和 `j`。如果给定的数是质数，那么 `i == j`。
