...
> 原文: [https://www.geeksforgeeks.org/python-sympy-permutation-array_form-method-2/](https://www.geeksforgeeks.org/python-sympy-permutation-array_form-method-2/)

借助 `sympy.combinatorics.Permutation().array_form` 方法，我们可以从多维数组或矩阵中得到线性数组。
