...
> 原文: [https://www.geeksforgeeks.org/sympy-polyhedron-rotate-in-python/](https://www.geeksforgeeks.org/sympy-polyhedron-rotate-in-python/)

`多面体.rotate()` 是一个关于多面体轴旋转的 sympy Python 库函数。
