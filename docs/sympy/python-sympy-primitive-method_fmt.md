...
> 原文: [https://www.geeksforgeeks.org/python-sympy-primitive-method/](https://www.geeksforgeeks.org/python-sympy-primitive-method/)

借助 `sympy.primitive()` 方法，我们可以找到一个数学表达式的公共部分。
