...
> 原文: [https://www.geeksforgeeks.org/python-sympy-plane-equation-method/](https://www.geeksforgeeks.org/python-sympy-plane-equation-method/)

在 Simpy 中，函数 `Plane.equation()` 用于生成给定平面的方程。
