...
> 原文: [https://www.geeksforgeeks.org/python-sympy-is_positive-method/](https://www.geeksforgeeks.org/python-sympy-is_positive-method/)

在 `sympy` 模块中，我们可以使用 `sympy.is_positive()` 函数来测试给定的数字 `n` 是否为正。
