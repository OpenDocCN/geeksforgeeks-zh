...
> 原文: [https://www.geeksforgeeks.org/python-sympy-bernoulli-method/](https://www.geeksforgeeks.org/python-sympy-bernoulli-method/)

借助`sympy.bernoulli()`方法，我们可以在`sympy`中找到[伯努利数](https://en.wikipedia.org/wiki/Bernoulli_number)和[伯努利多项式](https://en.wikipedia.org/wiki/Bernoulli_polynomial)。
