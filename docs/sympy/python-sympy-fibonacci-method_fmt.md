...
> 原文: [https://www.geeksforgeeks.org/python-sympy-fibonacci-method/](https://www.geeksforgeeks.org/python-sympy-fibonacci-method/)

借助 `sympy.fibonacci()` 方法，我们可以在 sympy 中找到[斐波那契数和斐波那契多项式](https://en.wikipedia.org/wiki/Fibonacci_number)。
