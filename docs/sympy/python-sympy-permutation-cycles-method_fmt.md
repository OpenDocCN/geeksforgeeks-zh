...
> 原文: [https://www.geeksforgeeks.org/python-sympy-permutation-cycles-method/](https://www.geeksforgeeks.org/python-sympy-permutation-cycles-method/)

`Permutation.cycles()` 是一个 sympy Python 库函数，返回置换中存在的循环数。这也包括单例。
