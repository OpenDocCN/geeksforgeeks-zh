# Permutation.rmul() in Python

> 原文: [https://www.geeksforgeeks.org/sympy-permutation-rmul-in-python/](https://www.geeksforgeeks.org/sympy-permutation-rmul-in-python/)

`Permutation.rmul()` 是一个 `sympy` Python 库函数，返回置换的乘积。

> **语法:** `sympy.combinatorics.permutations.Permutation.rmul()`
>
> **返回:** 排列的乘积。
