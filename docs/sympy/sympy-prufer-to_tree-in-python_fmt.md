...
> 原文: [https://www.geeksforgeeks.org/sympy-prufer-to_tree-in-python/](https://www.geeksforgeeks.org/sympy-prufer-to_tree-in-python/)

`Prufer.to_tree()` 是一个 sympy Python 库函数，返回 Prufer 序列的树表示。
