# sympy.stats.BetaNoncentral() 在 Python 中的使用

> 原文: [https://www.geeksforgeeks.org/sympy-stats-betanoncentral-in-python/](https://www.geeksforgeeks.org/sympy-stats-betanoncentral-in-python/)
...
`sympy.stats.BetaNoncentral(alpha, beta, lamda)`

其中 `alpha` 和 `beta` 是大于 0 的实数。
`lamda` 大于或等于 0。
