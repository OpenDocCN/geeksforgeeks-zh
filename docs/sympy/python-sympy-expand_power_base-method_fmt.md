...
> 原文: [https://www.geeksforgeeks.org/python-sympy-expand_power_base-method/](https://www.geeksforgeeks.org/python-sympy-expand_power_base-method/)

借助`sympy.expand_power_base()`方法，我们可以简化数学表达式的幂。
