# Python 中的 `sympy.stats.multivariatewens()` 函数

> 原文: [https://www.geeksforgeeks.org/sympy-stats-multivariateewens-function-in-python/](https://www.geeksforgeeks.org/sympy-stats-multivariateewens-function-in-python/)
