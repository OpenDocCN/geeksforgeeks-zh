# Python 中的 `sympy.stats.NegativeMultinomial()` 函数

> 原文: [https://www.geeksforgeeks.org/sympy-stats-negativemultinomial-function-in-python/](https://www.geeksforgeeks.org/sympy-stats-negativemultinomial-function-in-python/)

借助`sympy.stats.NegativeMultinomial()`方法，我们可以创建一个具有负多项式分布的离散随机变量。
