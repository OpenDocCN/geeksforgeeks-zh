...
> 原文: [https://www.geeksforgeeks.org/python-sympy-partitions-rgs_enum-method/](https://www.geeksforgeeks.org/python-sympy-partitions-rgs_enum-method/)

借助`sympy.combinatorics.partitions.RGS_enum()`方法，可以得到大小为`m`的无限制生长串的总数。
