...
> 原文：[https://www.geeksforgeeks.org/python-sympy-combinatorics-next_lex-method/](https://www.geeksforgeeks.org/python-sympy-combinatorics-next_lex-method/)

借助 `sympy.combinatorics.partitions.IntegerPartition().next_lex()` 方法，我们可以得到词法顺序中整数 `n` 的下一个划分。
