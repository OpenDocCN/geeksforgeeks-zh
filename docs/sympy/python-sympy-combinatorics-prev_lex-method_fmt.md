...
> 原文: [https://www.geeksforgeeks.org/python-sympy-combinatorics-prev_lex-method/](https://www.geeksforgeeks.org/python-sympy-combinatorics-prev_lex-method/)

借助`sympy.combinatorics.partitions.IntegerPartition().prev_lex()`方法，我们可以得到整数 n 在词法顺序上的上一次划分。
