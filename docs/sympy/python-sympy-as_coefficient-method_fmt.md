...
> 原文: [https://www.geeksforgeeks.org/python-sympy-as_coefficient-method/](https://www.geeksforgeeks.org/python-sympy-as_coefficient-method/)

借助`sympy.as_coefficient()`方法，我们可以求出数学表达式中任意元素的系数。
