...
> 原文: [https://www.geeksforgeeks.org/python-sympy-matrix-nullspace-method/](https://www.geeksforgeeks.org/python-sympy-matrix-nullspace-method/)

借助`Matrix().nullspace()`方法，我们可以找到一个矩阵的零空间。`Matrix().nullspace()`返回跨越矩阵的零空间的列向量列表。
