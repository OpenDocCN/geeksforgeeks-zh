...
> 原文: [https://www.geeksforgeeks.org/python-sympy-primeomega-method/](https://www.geeksforgeeks.org/python-sympy-primeomega-method/)

借助 `sympy.primeomega()` 方法，我们可以计算出给定正整数的计算重数的素因子个数。例如 `primeomega(12) = 3`，因为 `12 = 2^2 * 3^1`。因此，素因子数=素因子的倍数之和，`2 + 1 = 3`。
