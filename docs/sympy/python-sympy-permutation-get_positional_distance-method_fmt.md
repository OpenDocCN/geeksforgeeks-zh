...
> 原文: [https://www.geeksforgeeks.org/python-sympy-permutation-get_positional_distance-method/](https://www.geeksforgeeks.org/python-sympy-permutation-get_positional_distance-method/)

`Permutation.get_positional_distance()` 是一个 SymPy Python 库函数，用于计算两个排列之间的位置距离。

## 语法
`syy.combinatorics.permutations.Permutation.get_positional_distance()`
...
### 代码 #2 : `get_positional_distance()` 示例 – 2D 排列
