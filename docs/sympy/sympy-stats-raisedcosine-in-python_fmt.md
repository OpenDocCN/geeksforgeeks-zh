...
> 原文: [https://www.geeksforgeeks.org/sympy-stats-raisedcosine-in-python/](https://www.geeksforgeeks.org/sympy-stats-raisedcosine-in-python/)

## 借助 `sympy.stats.RaisedCosine()` 方法

我们可以得到代表升余弦分布的连续随机变量。
