# Python 中的 SymPy | Polyhedron.faces()

> 原文: [https://www.geeksforgeeks.org/sympy-polyhedron-faces-in-python/](https://www.geeksforgeeks.org/sympy-polyhedron-faces-in-python/)

`Polyhedron.faces()` 是一个 sympy Python 库函数，返回多面体的面。

## 语法

`combinatorics.polyhedron.Polyhedron.faces()`
