# Python | sympy.sets.Lopen()方法

> 原文: [https://www.geeksforgeeks.org/python-sympy-sets-lopen-method/](https://www.geeksforgeeks.org/python-sympy-sets-lopen-method/)

借助`sympy.sets.Lopen()`方法，我们可以通过设置间隔值来制作一组值，如左开，这意味着一组使用`sympy.sets.Lopen()`方法有左开括号和右闭括号。

## 语法
`sympy.sets.Lopen(val1, val2)`
