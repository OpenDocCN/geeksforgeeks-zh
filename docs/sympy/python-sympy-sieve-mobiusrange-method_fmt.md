# Python SymPy: `sieve.mobiusrange()` 方法

> 原文: [https://www.geeksforgeeks.org/python-sympy-sieve-mobiusrange-method/](https://www.geeksforgeeks.org/python-sympy-sieve-mobiusrange-method/)

借助 `sieve.mobiusrange()` 方法，我们可以为给定范围 `[a, b)` 生成[莫比乌斯数](https://en.wikipedia.org/wiki/M%C3%B6bius_function)。它返回一个类型为生成器的对象，该对象可以被转换为一个列表以供进一步操作。

## 语法
`sieve.mobiusrange(a, b)`
