...
> 原文: [https://www.geeksforgeeks.org/sympy-stats-loglogistic-in-python/](https://www.geeksforgeeks.org/sympy-stats-loglogistic-in-python/)
...
其中，`alpha`和`beta`为实数，`alpha`、`beta` > 0。
