# sympy.stats.StudentT() 在 Python 中的使用

> 原文: [https://www.geeksforgeeks.org/sympy-stats-studentt-in-python/](https://www.geeksforgeeks.org/sympy-stats-studentt-in-python/)
