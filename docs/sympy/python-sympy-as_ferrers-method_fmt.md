...
> 原文: [https://www.geeksforgeeks.org/python-sympy-as_ferrers-method/](https://www.geeksforgeeks.org/python-sympy-as_ferrers-method/)

借助`sympy.combinatorics.IntegerPartition().as_ferrers()`方法，我们可以得到分区值的费雷尔图。
