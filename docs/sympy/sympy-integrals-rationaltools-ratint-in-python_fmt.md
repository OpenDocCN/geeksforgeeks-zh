# Python 中的 `sympy.integrals.rationaltools.ratint()`

> 原文: [https://www.geeksforgeeks.org/sympy-integrals-rationaltools-ratint-in-python/](https://www.geeksforgeeks.org/sympy-integrals-rationaltools-ratint-in-python/)
