...
> 原文: [https://www.geeksforgeeks.org/sympy-subset-next_binary-in-python/](https://www.geeksforgeeks.org/sympy-subset-next_binary-in-python/)

`subset.next_binary():next_binary()` 是一个 sympy Python 库函数，返回下一个二进制有序子集。
