...
> 原文: [https://www.geeksforgeeks.org/sympy-subset-iterate_binary-in-python/](https://www.geeksforgeeks.org/sympy-subset-iterate_binary-in-python/)

`subset.iterate_binary()` 是一个 sympy Python 库函数，通过 k 步迭代二进制子集。“k”的值可以是正数，也可以是负数。
