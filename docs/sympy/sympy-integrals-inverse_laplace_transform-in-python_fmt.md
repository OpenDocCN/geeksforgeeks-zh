...
借助`inverse_laplace_transform()`方法，可以计算 `F(s)` 的拉普拉斯变换的逆。

![](img/a2ba3b5c730cde39e7d0d1a3271b482d.png)

> 语法: `inverse_laplace_transform(F, s, t)`
> 返回: 返回未赋值的变换函数。

## 示例 1

在这个示例中，我们可以看到，通过使用`inverse_laplace_transform()`方法，我们能够计算逆拉普拉斯变换并返回未赋值的函数。
