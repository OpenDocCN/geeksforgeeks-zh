...
> 原文: [https://www.geeksforgeeks.org/python-sympy-matrix-col_insert/](https://www.geeksforgeeks.org/python-sympy-matrix-col_insert/)

借助`Matrix().col_insert()`方法，我们可以在维数为 `n x m` 的矩阵中插入一列，其中插入列的维数为 `n x 1`。
