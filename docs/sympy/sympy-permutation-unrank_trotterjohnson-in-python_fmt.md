# Python 中的 SymPy | `Permutation.unrank_trotterjohnson()`

> 原文: [https://www.geeksforgeeks.org/sympy-permutation-unrank_trotterjohnson-in-python/](https://www.geeksforgeeks.org/sympy-permutation-unrank_trotterjohnson-in-python/)

`Permutation.unrank_trotterjohnson()` 是一个 SymPy Python 库函数，返回 Trotter-Johnson 排列的反排序（unranking）。
...
## 代码示例 1：`unrank_trotterjohnson()` 示例
...
**输出:**
> 排列 a – unrank_trotterjohnson 形式: (2)(0 1)
> 排列 b – unrank_trotterjohnson 形式: (0 4 2 1)

## 代码示例 2：`unrank_trotterjohnson()` 示例
...
**输出:**
> 排列 a – unrank_trotterjohnson 形式: (3)(0 2 1)