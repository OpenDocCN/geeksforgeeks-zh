...
> 原文: [https://www.geeksforgeeks.org/sympy-stats-multivariatet-function-in-python/](https://www.geeksforgeeks.org/sympy-stats-multivariatet-function-in-python/)

借助`sympy.stats.MultivariateT()`方法，我们可以创建一个具有多元 T 分布的联合随机变量。
