...
> 原文: `https://www.geeksforgeeks.org/sympy-stats-continuousrv-in-python/`
...
> continuousdistributionhandling(Lambda(z，分片)((sqrt(2)*z/pi，(z >= -oo) & (z < oo))、(0，True)))、Interval(-oo，oo))
