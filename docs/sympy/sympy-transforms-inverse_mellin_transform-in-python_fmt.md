## Python 中的 `sympy.transforms.inverse_mellin_transform()`

> 原文: [https://www.geeksforgeeks.org/sympy-transforms-inverse_mellin_transform-in-python/](https://www.geeksforgeeks.org/sympy-transforms-inverse_mellin_transform-in-python/)
...
### 示例 #1
在这个示例中，我们可以看到，通过使用 `inverse_mellin_transform()` 方法，我们能够通过执行逆梅林变换来获得函数 `F(x)`。
