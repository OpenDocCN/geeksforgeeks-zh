...
> 原文:[https://www . geeksforgeks . org/sympy-stats-naka gami-in-python/](https://www.geeksforgeeks.org/sympy-stats-nakagami-in-python/)
...
> 其中，`mu`和`omega`是实数，`mu`>1/2，`omega`>0。
> **返回:**返回连续随机变量。
