...
> 原文: [https://www.geeksforgeeks.org/python-sympy-is_comparable-method/](https://www.geeksforgeeks.org/python-sympy-is_comparable-method/)

借助 `sympy.is_comparable()` 方法，我们可以精确计算实数。如果计算值是精确实数，则 `sympy.is_comparable()` 方法返回真。
