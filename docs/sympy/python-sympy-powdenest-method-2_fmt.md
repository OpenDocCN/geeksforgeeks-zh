...
> 原文：[https://www.geeksforgeeks.org/python-sympy-powdenest-method-2/](https://www.geeksforgeeks.org/python-sympy-powdenest-method-2/)
...
- `表达式` – 需要转换的数学表达式。
- `force` – 对于 `表达式` 来说，它应该总是等于 `True` 来转换，而不检查它们的有效性。

## 返回

返回与输入表达式对应的转换后的数学表达式。
