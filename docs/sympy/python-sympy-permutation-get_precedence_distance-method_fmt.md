...
> 原文: [https://www.geeksforgeeks.org/python-sympy-permutation-get_precedence_distance-method/](https://www.geeksforgeeks.org/python-sympy-permutation-get_precedence_distance-method/)

`Permutation.get_precedence_distance()` 是一个 SymPy Python 库函数，用于计算两个排列之间的优先距离。
...
## 代码# 2: `get_precedence_distance()` 示例 – 2D 置换
