# Python 中的 sympy.stats.FDistribution()

> 原文: [https://www.geeksforgeeks.org/sympy-stats-fdistribution-in-python/](https://www.geeksforgeeks.org/sympy-stats-fdistribution-in-python/)
...
```
D2**(D1/2 + D2/2)*(D1*z)**(D1/2 - 1)*(D1*z + D2)**(-D1/2 - D2/2)
──────────────────────────────────────────────────────────────────
                          sqrt(pi)*gamma(D1/2)*gamma(D2/2)
```
