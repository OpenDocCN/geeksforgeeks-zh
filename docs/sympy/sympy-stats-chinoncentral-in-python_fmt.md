...
> 原文: [https://www.geeksforgeeks.org/sympy-stats-chinoncentral-in-python/](https://www.geeksforgeeks.org/sympy-stats-chinoncentral-in-python/)
...
`2 2 -k l z —–— k 2 2/k \ l * z *(l * z)* e * besseli |-–1，l*z| \2 /`
