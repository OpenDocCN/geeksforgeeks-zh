...
> 原文: `https://www.geeksforgeeks.org/python-sympy-permutation-atoms-method/`

`Permutation.atoms()` 是一个 SymPy Python 库函数，返回置换中存在的所有元素。

> **语法:** `combinatorics.permutations.Permutation.atoms()`
>
> **返回:** 参数化排列的元素。
