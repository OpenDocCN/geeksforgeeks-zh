...
> 原文: [https://www.geeksforgeeks.org/sympy-subset-next_gray-in-python/](https://www.geeksforgeeks.org/sympy-subset-next_gray-in-python/)

`subset.next_gray()` 是一个 sympy Python 库函数，返回下一个 Gray 码有序子集。
