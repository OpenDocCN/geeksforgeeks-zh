# Python 中的 SymPy 积分变换：正弦变换

> 原文：[https://www.geeksforgeeks.org/sympy-integrals-transforms-sine_transform-in-python/](https://www.geeksforgeeks.org/sympy-integrals-transforms-sine_transform-in-python/)
