...
> 原文: [https://www.geeksforgeeks.org/python-sympy-permutation-cycle_structure-method/](https://www.geeksforgeeks.org/python-sympy-permutation-cycle_structure-method/)

`Permutation.cycle_structure()` 是一个 SymPy Python 库函数，它将置换的循环结构作为字典返回，这将指示每个循环长度的多重性。
...
> 置换 a - cycle_structure 形式: {2: 1, 4: 1}
> 置换 b - cycle_structure 形式: {1: 3, 3: 1}
