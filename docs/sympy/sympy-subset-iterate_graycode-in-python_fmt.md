...
> 原文: [https://www.geeksforgeeks.org/sympy-subset-iterate_graycode-in-python/](https://www.geeksforgeeks.org/sympy-subset-iterate_graycode-in-python/)

`Subset.iterate_graycode()` 是一个 SymPy Python 库函数，它迭代 k 个步骤以获得各自的 Gray 码。
