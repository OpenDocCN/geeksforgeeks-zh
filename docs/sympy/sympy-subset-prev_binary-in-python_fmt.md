...
> 原文: [https://www.geeksforgeeks.org/sympy-subset-prev_binary-in-python/](https://www.geeksforgeeks.org/sympy-subset-prev_binary-in-python/)

`Subset.prev_binary()` 是一个 SymPy Python 库函数，返回之前的二进制有序子集。
