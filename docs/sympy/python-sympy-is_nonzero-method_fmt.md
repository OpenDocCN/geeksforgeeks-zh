# Python | sympy.is_nonzero()方法

> 原文: [https://www.geeksforgeeks.org/python-sympy-is_nonzero-method/](https://www.geeksforgeeks.org/python-sympy-is_nonzero-method/)

在`sympy`模块中，我们可以使用`sympy.is_nonzero()`函数来测试给定的数字`n`是否非零。
