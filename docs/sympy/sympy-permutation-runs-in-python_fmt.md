# Python 中的 SymPy | Permutation.runs()

> 原文: [https://www.geeksforgeeks.org/sympy-permutation-runs-in-python/](https://www.geeksforgeeks.org/sympy-permutation-runs-in-python/)

`Permutation.runs()` 是一个 `sympy` Python 库函数，返回排列的游程。
