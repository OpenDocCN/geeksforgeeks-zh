...
借助 `sympy.Integral()` 方法，我们可以创建一个未赋值的 SymPy 表达式的积分。其语法与 [`integrate()`](https://www.geeksforgeeks.org/python-sympy-integrate-method/) 方法相同。要评估未评估的积分，请使用 [`doit()`](https://www.geeksforgeeks.org/python-sympy-doit-method/) 方法。

> **语法:** `Integral(表达式, 参考变量)`
>
> **参数:**
