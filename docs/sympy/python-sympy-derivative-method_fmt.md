...
> 原文: [https://www.geeksforgeeks.org/python-sympy-derivative-method/](https://www.geeksforgeeks.org/python-sympy-derivative-method/)

借助 `sympy.Derivative()` 方法，我们可以创建一个未赋值的 SymPy 表达式的导数。其语法与 [`diff()`](https://www.geeksforgeeks.org/python-sympy-diff-method/) 方法相同。要评估未估值的衍生产品，请使用 [`doit()`](https://www.geeksforgeeks.org/python-sympy-doit-method/) 方法。
