...
> 原文: [`https://www.geeksforgeeks.org/python-sympy-count_ops-method/`](https://www.geeksforgeeks.org/python-sympy-count_ops-method/)

使用 `sympy` 模块中的 `count_ops()` 方法，我们可以统计数学函数中使用的运算次数。`count_ops()` 方法返回数学函数中使用的运算次数。
