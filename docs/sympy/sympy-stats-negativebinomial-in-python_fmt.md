# 使用`sympy.stats.NegativeBinomial()`进行负二项分布计算

> 原文: [https://www.geeksforgeeks.org/sympy-stats-negativebinomial-in-python/](https://www.geeksforgeeks.org/sympy-stats-negativebinomial-in-python/)
