...
> 原文: [https://www.geeksforgeeks.org/python-sympy-as_coefficients_dict-method/](https://www.geeksforgeeks.org/python-sympy-as_coefficients_dict-method/)
...
```python
defaultdict(<class 'int'>, {1: 12, x**3: 1, x: 21})
```
...
```python
defaultdict(<class 'int'>, {1: 4, x**3: 1, x**2: 21, x: 121})
```