# Python SymPy 组合学 `conjugate()` 方法

> 原文: [https://www.geeksforgeeks.org/python-sympy-combinatorics-conjugate-method/](https://www.geeksforgeeks.org/python-sympy-combinatorics-conjugate-method/)
