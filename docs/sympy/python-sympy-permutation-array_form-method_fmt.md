...
> 原文: [https://www.geeksforgeeks.org/python-sympy-permutation-array_form-method/](https://www.geeksforgeeks.org/python-sympy-permutation-array_form-method/)

`Permutation.array_form()` 是一个 SymPy Python 库函数，返回有论证的数组的一维副本。

> **语法:** `sympy.combinatorics.permutations.Permutation.array_form()`
>
> **返回:** 参数中置换的副本。
