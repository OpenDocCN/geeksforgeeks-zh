...
> 原文：[https://www.geeksforgeeks.org/maximum-number-zombie-process-system-can-handle/](https://www.geeksforgeeks.org/maximum-number-zombie-process-system-can-handle/)

## 僵尸进程

[`僵尸进程`](https://www.geeksforgeeks.org/zombie-and-orphan-processes-in-c/)或**失效进程**是那些通过`exit()`系统调用完成执行，但在**进程表**中仍有条目的进程。这是一个处于终止状态的进程。
