...
> 原文：[https://www.geeksforgeeks.org/difference-between-clock-driven-and-event-driven-scheduling/](https://www.geeksforgeeks.org/difference-between-clock-driven-and-event-driven-scheduling/)
...
调度点由除时钟中断之外的事件决定的调度称为事件驱动调度。事件驱动调度处理下一个要处理的任务，与时钟中断点无关。
