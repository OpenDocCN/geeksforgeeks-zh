...
> 原文：[https://www.geeksforgeeks.org/difference-between-traditional-and-reactive-computer-system/](https://www.geeksforgeeks.org/difference-between-traditional-and-reactive-computer-system/)
...
| 传统系统 | 反应系统 |
| --- | --- |
| 传统系统产生的输出是输入的函数。 | 反应系统不产生作为输入函数的输出。 |
| 它不与环境互动。 | 它与环境相互作用。 |
