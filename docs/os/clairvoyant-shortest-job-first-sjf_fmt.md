...
> 原文：[https://www.geeksforgeeks.org/clairvoyant-shortest-job-first-sjf/](https://www.geeksforgeeks.org/clairvoyant-shortest-job-first-sjf/)
...
**注：** 千里眼 SJF 和 SJF 如果所有进程同时到达会给出同样的结果。
