...
> 原文：[https://www.geeksforgeeks.org/volatile-data-collection-from-window-system/](https://www.geeksforgeeks.org/volatile-data-collection-from-window-system/)

易失性数据是通常存储在高速缓冲存储器或`RAM`中的数据。这种易失性数据不是永久的，而是暂时的，如果断电，即当计算机失去连接时，这些数据可能会丢失。
