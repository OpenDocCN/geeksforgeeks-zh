...
> 原文: [https://www.geeksforgeeks.org/techniques-to-handle-thrashing/](https://www.geeksforgeeks.org/techniques-to-handle-thrashing/)
...
如果 `D` 是对框架的总需求，`WSS_i` 是过程 `i` 的工作集大小，
