...
> 原文：[https://www.geeksforgeeks.org/difference-between-android-1-1-and-android-4-4-1/](https://www.geeksforgeeks.org/difference-between-android-1-1-and-android-4-4-1/)
...
## 安卓 4.4.1
安卓 4.4.1 是继谷歌推出的安卓 4.4 之后的下一个安卓版本。它具有以前版本的所有功能，并且在这个版本中添加了一些新的用户功能。这个版本修复了各种错误。在这个版本中，相机质量也得到了增强。此版本中没有添加新的开发人员功能。它的版本名是 `KitKat`。安卓 4.4.1 中的 `API` 级别是 `19`。它于 `2013 年 12 月 5 日`发布。
...
| 3. | 它是安卓 1.5 版本的前身。 | 它是安卓 4.4.2 版本的前身。 |
| 4. | 它于 `2009 年 2 月 9 日`发布。 | 它于 `2013 年 12 月 5 日`发布。 |
| 5. | 安卓 1.1 版本中的 `API` 级别为 `2`。 | 安卓 4.4.1 版本的 `API` 级别是 `19`。 |
