...
> 原文: [https://www.geeksforgeeks.org/xv6-operating-system-adding-a-new-system-call/](https://www.geeksforgeeks.org/xv6-operating-system-adding-a-new-system-call/)
...
现在你只有两个小文件要编辑，这些文件将包含用户程序访问系统调用的接口。打开名为 `usys.s` 的文件，并在末尾添加下面的行。
