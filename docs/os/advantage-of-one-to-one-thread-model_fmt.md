...
> 原文：[https://www.geeksforgeeks.org/advantage-of-one-to-one-thread-model/](https://www.geeksforgeeks.org/advantage-of-one-to-one-thread-model/)
...
这个版本的缺点是开发人员线程调用对应的`Kernel`线程。`OS/2`、`家庭视窗 NT`和`家庭视窗 2000`使用一到至少一个求爱版本。