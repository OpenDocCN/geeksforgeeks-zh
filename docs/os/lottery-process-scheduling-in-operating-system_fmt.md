...
> 原文: [https://www.geeksforgeeks.org/lottery-process-scheduling-in-operating-system/](https://www.geeksforgeeks.org/lottery-process-scheduling-in-operating-system/)

## 先决条件
- [CPU 调度](https://www.geeksforgeeks.org/gate-notes-operating-system-process-scheduling/)
- [进程管理](https://www.geeksforgeeks.org/gate-notes-operating-system-process-management-introduction/)
...
## 示例
如果我们有两个流程 A 和 B，在总共 100 张票中分别有 60 张和 40 张票。A 的 CPU 份额是 60%，B 的是 40%。这些份额是概率计算的，而不是确定的。
