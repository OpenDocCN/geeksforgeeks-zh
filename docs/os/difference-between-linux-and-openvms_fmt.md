...
> 原文：[https://www.geeksforgeeks.org/difference-between-linux-and-openvms/](https://www.geeksforgeeks.org/difference-between-linux-and-openvms/)
...
| 编号 | Linux 操作系统 | OpenVMS |
| :--- | :--- | :--- |
| 1. | 它是由 `Linus Torvalds` 开发的。 | 由数字设备公司(`DEC`)开发。 |
| 2. | 它于 1991 年推出。 | 它于 1977 年推出。 |
| 3. | 它的目标系统类型是嵌入式系统、移动设备、个人计算机、服务器、大型计算机和超级计算机。 | 它的目标系统类型是服务器和工作站。 |
| 4. | `Linux` 支持的计算机架构有 `IA-32`、`x86-64`、`ARM`、`PowerPC` 和 `SPARC`。 | `OpenVMS` 支持的计算机架构有 `VAX`、`Alpha` 和 `IA-64`。 |
