...
> 原文：[https://www.geeksforgeeks.org/difference-between-aix-and-dragonfly-bsd/](https://www.geeksforgeeks.org/difference-between-aix-and-dragonfly-bsd/)
...
## 蜻蜓 BSD
是由马修·狄龙开发的免费开源操作系统。这是一个类似 Unix 的操作系统，其设计灵感来自 FreeBSD 操作系统。基本不用于个人电脑。它是专门为服务器、工作站、网络连接存储和嵌入式系统设计的。主要使用的编程语言是 C 语言。蜻蜓 BSD 的第一个版本于 2003 年推出。蜻蜓 BSD 的最新稳定版本是 5.6.1。它有混合内核。
