...
> 原文: [https://www.geeksforgeeks.org/why-executable-files-are-os-dependent/](https://www.geeksforgeeks.org/why-executable-files-are-os-dependent/)
...
*   有些程序被编译成中间形式，而不是机器代码。然后，这被动态地转化为实际的指令，或者可以被理解。这允许程序独立于其体系结构。在 `UCSD p-系统`上，利用了这种方法。
