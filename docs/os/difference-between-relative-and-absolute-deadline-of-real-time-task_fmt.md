...
> 原文：`https://www.geeksforgeeks.org/difference-between-relative-and-absolute-deadline-of-real-time-task/`
...
时间 0 到实时任务完成之间的时间间隔称为绝对截止时间。基本上是时间 0 到实时任务对应截止时间的时间间隔。
