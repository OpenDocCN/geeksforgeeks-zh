...
> 原文：[https://www.geeksforgeeks.org/free-space-management-in-operating-system/](https://www.geeksforgeeks.org/free-space-management-in-operating-system/)
...
例如，在`图-1`中，空闲空间列表的第一个条目将是：(`块 5 的地址`，`2`)，因为块 `5` 后面有 `2` 个连续的空闲块。