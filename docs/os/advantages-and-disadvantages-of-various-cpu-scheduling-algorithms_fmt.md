...
> 原文：[https://www.geeksforgeeks.org/advantages-and-disadvantages-of-various-cpu-scheduling-algorithms/](https://www.geeksforgeeks.org/advantages-and-disadvantages-of-various-cpu-scheduling-algorithms/)
...
## Disadvantages
1.  Not flexible.
2.  It also needs some means to take values for all parameters to define the optimal scheduler, so it is also the most complicated of all.