...
> 原文: [https://www.geeksforgeeks.org/difference-between-linux-and-amigaos-4/](https://www.geeksforgeeks.org/difference-between-linux-and-amigaos-4/)
...
| Linux 操作系统 | AmigaOS 4 |
| --- | --- |
| 它是由 `Linus Torvalds` 开发的。 | 由 `Hyperion Entertainment` 开发。 |
...
| 它的更新管理取决于分布。 | 它的更新管理是几乎不需要的 `AmiUpdate`。 |
