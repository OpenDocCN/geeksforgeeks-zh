...
> 原文：[https://www.geeksforgeeks.org/message-passing-model-of-process-communication/](https://www.geeksforgeeks.org/message-passing-model-of-process-communication/)
...
1.  让我们考虑一个由 `n` 个名为 `p_0`、`p_1`、`p_2`……..`p_{n-1}` 的节点组成的网络，为双向点对点通道。
