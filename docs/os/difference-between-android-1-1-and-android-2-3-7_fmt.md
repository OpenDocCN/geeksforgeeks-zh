...
> 原文：[https://www.geeksforgeeks.org/difference-between-android-1-1-and-android-2-3-7/](https://www.geeksforgeeks.org/difference-between-android-1-1-and-android-2-3-7/)
...
## 安卓 2.3.7
安卓 2.3.7 是继谷歌推出的安卓 2.3.6 之后的下一个安卓版本。它拥有以前版本的所有功能，在这个版本中还增加了一些新的用户功能。这个版本中引入了像谷歌钱包支持这样的新功能。其余功能与安卓 2.3.6 相同。此版本中没有添加新的开发人员功能。它的版本名是`姜饼`。安卓 2.3.7 中的 `API` 级别为 10。它于 2011 年 9 月 21 日发布。
...
| 3. | 它是安卓 1.5 的前身。 | 它是安卓 3.0 的前身。 |
| 4. | 它于 2009 年 2 月 9 日发布。 | 它于 2011 年 9 月 21 日发布。 |
| 5. | 安卓 1.1 版本中的 `API` 级别为 2。 | 安卓 2.3.7 版本中的 `API` 级别为 10。 |
