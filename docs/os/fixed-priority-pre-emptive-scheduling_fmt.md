...
> 原文: [https://www.geeksforgeeks.org/fixed-priority-pre-emptive-scheduling/](https://www.geeksforgeeks.org/fixed-priority-pre-emptive-scheduling/)
...
[低优先级进程可能出现饥饿](https://www.geeksforgeeks.org/starvation-and-aging-in-operating-systems/)。这可以通过使用称为“老化”的技术来克服。老化逐渐增加了在系统中等待很长时间的进程的优先级。[上下文切换](https://practice.geeksforgeeks.org/problems/what-is-context-switching)开销是有的。