...
## 2. 安卓 2.0 :
安卓 2.0 是继谷歌推出的安卓 1.6 之后的下一个安卓版本。它拥有以前版本中包含的所有功能，即安卓 1.0、安卓 1.1、安卓 1.5 和安卓 1.6，并且在这个版本中添加了一些突出的功能。这个版本引入了 `HTML`、微软支持、蓝牙 2.1、实时壁纸和更新的 `UI` 等功能。这个版本有一个版本名。它的官方版本名为“艾克蕾尔”。`Android 2.0` 中的 `API` 级别为 5。它于 2009 年 10 月 26 日发布。
