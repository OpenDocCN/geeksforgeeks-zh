...
安卓 5.0.1 是继谷歌推出的安卓 5.0 之后的下一个安卓版本。它具有以前版本的所有功能，并且在这个版本中添加了一些新的用户功能。这个版本修复了各种错误。视频播放和密码故障功能在此版本中已修复。此版本中没有添加新的开发人员功能。它的版本名是`棒棒糖`。Android 5.0.1 中的 API 级别为 `21`。它于 `2014 年 12 月 2 日`发布。
...
| 3. | 它于 `2008 年 9 月 23 日`发布。 | 它于 `2014 年 12 月 2 日`发布。 |
