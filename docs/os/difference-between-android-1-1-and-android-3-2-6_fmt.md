...
> 原文：[https://www.geeksforgeeks.org/difference-between-android-1-1-and-android-3-2-6/](https://www.geeksforgeeks.org/difference-between-android-1-1-and-android-3-2-6/)
...
## 安卓 3.2.6
安卓 3.2.6 是继谷歌推出的安卓 3.2.4 之后的下一个安卓版本。它具有以前版本的所有功能，并且在这个版本中做了一些新的改进。此版本中没有添加新的用户或开发人员功能。它与之前的安卓 3.2.4 版本非常相似。在这个版本中，只有一些主要和次要的问题被修复，一些特性被改进。其版本名为`蜂巢`。安卓 3.2.6 中的 `API` 级别为 `13`。它于 2012 年 2 月 15 日发布。
...
| 3. | 它是安卓 1.5 版本的前身。 | 它是安卓 4.0 版本的前身。 |
| 4. | 它于 2009 年 2 月 9 日发布。 | 它于 2012 年 2 月 15 日发布。 |
| 5. | 安卓 1.1 版本中的 `API` 级别为 `2`。 | 安卓 3.2.6 版本中的 `API` 级别为 `13`。 |
