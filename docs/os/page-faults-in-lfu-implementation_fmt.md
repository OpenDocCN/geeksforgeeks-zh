...
> 原文: [https://www.geeksforgeeks.org/page-faults-in-lfu-implementation/](https://www.geeksforgeeks.org/page-faults-in-lfu-implementation/)
...
给定长度为 `N`、内存容量为 `C` 的页面数组 `pages[]` 中的页面序列，使用最少使用(LFU)算法找出页面错误的数量。
...
> 第 1 页是必需的，因为它不存在，这是页面错误: `Page Faults = 1`
> 第 2 页是必需的，因为它不存在，这是一个页面错误: `Page Faults = 1 + 1 = 2`
> 第 3 页是必需的，因为它不存在，这是一个页面错误: `Page Faults = 2 + 1 = 3`
> 第 4 页是必需的，因为它不存在，它取代了 LFU 第 1 页: `Page Faults = 3 + 1 = 4`
> 第 2 页是必需的，因为它存在，这不是页面错误: `Page Faults = 4 + 0 = 4`
> 第 1 页是必需的，因为它不存在，它取代了 LFU 第 3 页: `Page Faults = 4 + 1 = 5`
> 第 5 页是必需的，因为它不存在，它取代了 LFU 第 4 页: `Page Faults = 5 + 1 = 6`
...
> 第 5 页是必需的，因为它不存在，这是页面错误: `Page Faults = 1`
> 第 0 页是必需的，因为它不存在，这是一个页面错误: `Page Faults = 1 + 1 = 2`
> 第 1 页是必需的，因为它不存在，这是一个页面错误: `Page Faults = 2 + 1 = 3`
> 第 3 页是必需的，因为它不存在，这是一个页面错误: `Page Faults = 3 + 1 = 4`
> 第 2 页是必需的，因为它不存在，它取代了 LFU 第 5 页: `Page Faults = 4 + 1 = 5`
> 第 4 页是必需的，因为它不存在，它取代了 LFU 页面 0: `Page Faults = 5 + 1 = 6`
> 第 1 页是必需的，因为它存在，这不是页面错误: `Page Faults = 6 + 0 = 6`
> 第 0 页是必需的，因为它不存在，它取代了 LRU 第 3 页: `Page Faults = 6 + 1 = 7`
> 第 5 页是必需的，因为它不存在，它取代了 LFU 第 2 页: `Page Faults = 7 + 1 = 8`
