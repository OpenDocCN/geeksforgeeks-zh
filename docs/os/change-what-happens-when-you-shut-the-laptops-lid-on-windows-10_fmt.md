...
> 原文：[https://www.geeksforgeeks.org/change-what-happens-when-you-shut-the-laptops-lid-on-windows-10/](https://www.geeksforgeeks.org/change-what-happens-when-you-shut-the-laptops-lid-on-windows-10/)
...
3.  **Hibernate–**
    `Hibernate` 模式会将你打开的文档和运行的应用保存到你的硬盘上，并关闭笔记本电脑，所以它使用零功耗。当您再次打开笔记本电脑时，它会将以前的状态从硬盘加载到内存中。当您需要节省电池并保持所有打开的文档和运行的应用程序安全时，您可以使用它。
4.  **Do Nothing –**
    正如其名，它什么也不做。但如果您选择此选项，可能会损害您的笔记本电脑。
