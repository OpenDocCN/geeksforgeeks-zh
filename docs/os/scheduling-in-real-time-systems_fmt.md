...
> 原文: [https://www.geeksforgeeks.org/scheduling-in-real-time-systems/](https://www.geeksforgeeks.org/scheduling-in-real-time-systems/)

[实时系统](https://www.geeksforgeeks.org/real-time-systems/)是承载实时任务的系统。这些任务需要以一定的紧急程度立即执行。特别是，这些任务与控制某些事件(或)对其做出反应有关。实时任务可以分为硬实时任务和软实时任务。
