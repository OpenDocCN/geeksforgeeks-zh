...
> 原文：[https://www.geeksforgeeks.org/hardware-protection-and-type-of-hardware-protection/](https://www.geeksforgeeks.org/hardware-protection-and-type-of-hardware-protection/)
...
所以基本上 `Bare register` 存储程序的起始地址，而 `limit register` 存储进程的大小，所以当一个进程想要访问内存时，就会检查它能不能访问内存。
