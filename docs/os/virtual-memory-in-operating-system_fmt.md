...
> 原文: [https://www.geeksforgeeks.org/virtual-memory-in-operating-system/](https://www.geeksforgeeks.org/virtual-memory-in-operating-system/)
...
1.  **High degree of multiprogramming**：如果内存中的进程数量持续增加，那么分配给每个进程的帧数将会减少。因此，每个进程可用的帧会更少。由于此，页面错误将更频繁地发生，更多的 CPU 时间将浪费在仅仅换入换出页面上，利用率将持续下降。
