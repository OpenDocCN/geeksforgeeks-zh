...
> 原文: [https://www.geeksforgeeks.org/difference-between-dos-and-unix/](https://www.geeksforgeeks.org/difference-between-dos-and-unix/)
...
| 5. | 它有 3 个专有实现(`Microsoft OS`、`IBM OS` 和 `DR-DOS`)和一个免费实现(`FreeDOS`)。 | 有许多专有的和免费/开源的实现。 |
| 6. | 它不区分大小写。 | 它区分大小写。 |
| 7. | 它用于嵌入式系统。 | 它主要用于服务器。 |
| 8. | 它使用反斜杠(`\`)。 | 它使用正斜杠(`/`)。 |
