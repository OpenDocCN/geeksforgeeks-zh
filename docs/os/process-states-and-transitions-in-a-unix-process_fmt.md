...
> 原文: [https://www.geeksforgeeks.org/process-states-and-transitions-in-a-unix-process/](https://www.geeksforgeeks.org/process-states-and-transitions-in-a-unix-process/)
...
9.  `僵尸`: 进程已彻底执行，退出调用已启用。因此，这个过程不再存在。但是，它存储了该过程的统计记录。这是所有流程的最终状态。