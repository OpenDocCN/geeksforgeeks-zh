...
> 原文：[https://www.geeksforgeeks.org/difference-between-seek-time-and-transfer-time-in-disk-scheduling/](https://www.geeksforgeeks.org/difference-between-seek-time-and-transfer-time-in-disk-scheduling/)
...
| Two | 根据当前位置和最终位置之间的距离以及指示的行进方式，可能会有很大的不同。 | `T = b/rN`<br>T 是传输时间，b 是要传输的字节数，N 是磁道上的字节数，r 是转速，单位为 Rps |
