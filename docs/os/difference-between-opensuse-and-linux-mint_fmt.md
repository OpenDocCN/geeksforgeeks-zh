...
> 原文：[https://www.geeksforgeeks.org/difference-between-opensuse-and-linux-mint/](https://www.geeksforgeeks.org/difference-between-opensuse-and-linux-mint/)
...
| 6. | `OpenSUSE` 起源于德国。 | `Linux Mint` 起源于爱尔兰。 |
| 7. | `OpenSUSE` 的包管理器是 `RPM` 包管理器。 | `Linux Mint` 的包管理器是 `Debian` 包管理器。 |
| 8. | 它有一个单片内核。 | 它使用肉桂内核。 |
| 9. | `openSUSE` 论坛是 [https://forums.opensuse.org/](https://forums.opensuse.org/) | `Linux Mint` 论坛是 [https://forums.linuxmint.com/](https://forums.linuxmint.com/) |
