...
> 原文：[https://www.geeksforgeeks.org/difference-between-multiprogramming-and-multitasking/](https://www.geeksforgeeks.org/difference-between-multiprogramming-and-multitasking/)

`多编程`和`多任务`都与`操作系统概念`相关。
...
**注：**
1.  多任务系统中的任务不是整个应用程序，但当一个进程被划分为子任务时，它可以指“执行线程”。
2.  多编程和多任务操作系统是分时系统。
