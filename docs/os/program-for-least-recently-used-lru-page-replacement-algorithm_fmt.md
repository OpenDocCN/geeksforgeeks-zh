...
> 原文：[https://www.geeksforgeeks.org/program-for-least-recently-used-lru-page-replacement-algorithm/](https://www.geeksforgeeks.org/program-for-least-recently-used-lru-page-replacement-algorithm/)
...
最近最少使用（LRU）算法是一种贪婪算法，其中要替换的页面是最近使用最少的。这个想法是基于引用的局部性，最近使用最少的页面不太可能被再次引用。
