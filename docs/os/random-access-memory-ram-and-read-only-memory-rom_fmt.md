...
> 原文:[https://www . geeksforgeks . org/随机存取存储器 ram 和只读存储器 rom/](https://www.geeksforgeeks.org/random-access-memory-ram-and-read-only-memory-rom/)
...
*   `EPROM(电可擦除可编程只读存储器)`–可重新编程。要清除其中的数据，将其暴露在紫外线下。要重新编程，清除所有先前的数据。
