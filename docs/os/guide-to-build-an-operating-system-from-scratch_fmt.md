...
> 原文：[https://www.geeksforgeeks.org/guide-to-build-an-operating-system-from-scratch/](https://www.geeksforgeeks.org/guide-to-build-an-operating-system-from-scratch/)

[`操作系统`](https://www.geeksforgeeks.org/operating-systems/)：一个`操作系统`充当计算机硬件和计算机用户之间的中介。操作系统的主要目的是为应用程序的有效执行提供一个环境。
