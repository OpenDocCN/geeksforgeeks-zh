...
在一些特殊情况下，除了上面的 5 个字段之外，您还可以使用 `@` 后跟一个关键字，例如 `reboot`、`midnight`、`yearly`、`hourly`。
...
参考：[cron](http://man7.org/linux/man-pages/man8/cron.8.html) Linux 手册页本文由 **[Kishlay 维尔马](https://www.linkedin.com/in/kishlayverma/)** 供稿。如果你喜欢 GeeksforGeeks 并想投稿，你也可以使用 [contribute.geeksforgeeks.org](http://contribute.geeksforgeeks.org) 写一篇文章或者把你的文章邮寄到 contribute@geeksforgeeks.org。看到你的文章出现在极客博客主页上，帮助其他极客。
