...
> 原文：[https://www.geeksforgeeks.org/difference-between-android-1-1-and-android-4-0-3/](https://www.geeksforgeeks.org/difference-between-android-1-1-and-android-4-0-3/)
...
## 安卓 4.0.3
安卓 4.0.3 是继谷歌推出的安卓 4.0.2 之后的下一个安卓版本。它具有以前版本的所有功能，并且在这个版本中添加了一些新功能。此版本引入了关键用户功能，如联系人提供程序中的社交流 `API`，以显示与您的联系人相关联的更新、视频稳定、`QVGA` 视频分辨率 `API` 访问、屏幕阅读器的可访问性 `API` 改进以及日历提供程序更新。它的版本名是“冰淇淋三明治”。安卓 4.0.3 中的 `API` 级别为 `15`。它于 `2011` 年 `12` 月 `16` 日发布。
...
| 3. | 它是安卓 1.5 版本的前身。 | 它是安卓 4.0.4 版本的前身。 |
| 4. | 它于 2009 年 2 月 9 日发布。 | 它于 2011 年 12 月 16 日发布。 |
| 5. | 安卓 1.1 版本中的 `API` 级别为 `2`。 | 安卓 4.0.3 版本的 `API` 级别是 `15`。 |
