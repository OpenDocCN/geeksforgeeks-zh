...
> 原文：[https://www.geeksforgeeks.org/difference-between-opensuse-and-fedora/](https://www.geeksforgeeks.org/difference-between-opensuse-and-fedora/)
...
| 3. | OpenSUSE 开发者论坛是 [https://forums.opensuse.org/](https://forums.opensuse.org/) | Fedora 的发展论坛是 [https://fedoraforum.org](https://fedoraforum.org/) |
| 4. | OpenSUSE 起源于德国。 | Fedora 起源于美国。 |
...
| 8. | 它不如 Fedora 安全。 | Fedora 比 OpenSUSE 更安全。 |
| 9. | 硬件支持不如 Fedora。 | 它提供当前硬件平台上的所有最新技术。 |
| 10. | OpenSUSE 自带 Tilda 终端仿真器。 | 默认情况下，Fedora 使用 Gnome 终端仿真器。 |