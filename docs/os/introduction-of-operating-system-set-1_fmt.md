...
> 原文：[https://www.geeksforgeeks.org/introduction-of-operating-system-set-1/](https://www.geeksforgeeks.org/introduction-of-operating-system-set-1/)
...
*   **存储管理**：**文件系统**机制用于管理存储。**NIFS**、**CFS**、**CIFS**、**NFS** 等是一些文件系统。所有数据都存储在硬盘的不同磁道上，这些磁道都由存储管理器管理。它包括**硬盘**。
