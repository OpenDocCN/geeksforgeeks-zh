...
> 原文: [https://www.geeksforgeeks.org/page-faults-in-lru-implementation/](https://www.geeksforgeeks.org/page-faults-in-lru-implementation/)
...
**例如:**
给定长度为 `N`、内存容量为 `C` 的页面数组 `pages[]` 中的页面序列，使用[最近最少使用(LRU)算法](https://www.geeksforgeeks.org/program-for-least-recently-used-lru-page-replacement-algorithm/)找出页面错误的数量。
