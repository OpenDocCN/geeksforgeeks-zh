...
> 原文：[https://www.geeksforgeeks.org/difference-between-paging-and-swapping-in-os/](https://www.geeksforgeeks.org/difference-between-paging-and-swapping-in-os/)

## **交换**
交换是将进程从主内存临时交换到辅助内存的过程，与辅助内存相比速度更快。但是由于内存的大小较小，所以不活动的进程被转移到辅助内存。交换的主要部分是传输时间，总时间与交换的内存量成正比。
