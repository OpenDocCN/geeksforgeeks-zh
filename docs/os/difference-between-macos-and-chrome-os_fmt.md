...
> 原文: [https://www.geeksforgeeks.org/difference-between-macos-and-chrome-os/](https://www.geeksforgeeks.org/difference-between-macos-and-chrome-os/)
...
| 11. | `macOS` 支持的文件系统有 `HFS+`、`APFS`、`HFS`、`UFS`、`AFP`、`ISO 9660`、`FAT`、`UDF`、`NFS`、`SMBFS`、`NTFS`、`FTP`、`WebDAV` 和 `ZFS`。 | `Chrome OS` 支持的文件系统有 `eCryptfs`、`NTFS`、`FAT`、`FAT16`、`FAT32`、`exFAT`、`ext2`、`ext3`、`ext4`、`HFS+`、`MTP`、`ISO 9660`、`UDF`。 |