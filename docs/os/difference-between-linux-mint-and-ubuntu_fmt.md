...
> 原文：[https://www.geeksforgeeks.org/difference-between-linux-mint-and-ubuntu/](https://www.geeksforgeeks.org/difference-between-linux-mint-and-ubuntu/)
...
| 序号 | Linux Mint | Ubuntu |
| :--- | :--- | :--- |
| 1. | Linux Mint 是由 Clement Lefebvre 开发并发布的。 | Ubuntu 是由 Canonical 开发的。 |
| 2. | 最初于 2006 年 8 月 26 日发布。 | 它最初于 2004 年 10 月发布。 |
| 3. | Linux Mint 起源于爱尔兰。 | Ubuntu 起源于马恩岛。 |
| 4. | Linux Mint 的包管理器是 Debian 包管理器。 | Ubuntu 使用 `apt` 包管理器。 |
| 5. | Linux Mint 的论坛是 `https://forums.linuxmint.com/`。 | Ubuntu 的论坛是 `https://ubuntuforums.org/`。 |
| 6. | Linux Mint 的 Github 存储库是 `https://github.com/linuxmint`。 | Ubuntu 的 Github 存储库是 `https://github.com/ubuntu`。 |
