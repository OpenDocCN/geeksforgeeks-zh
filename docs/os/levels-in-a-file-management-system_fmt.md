...
> 原文：[https://www.geeksforgeeks.org/levels-in-a-file-management-system/](https://www.geeksforgeeks.org/levels-in-a-file-management-system/)

## 前提
[文件系统](https://www.geeksforgeeks.org/file-systems-in-operating-system/)中，文件的管理和设备的管理是相互关联的。下面给出的是用于有效执行输入/输出系统所需功能的层次结构。
