...
> 原文: [https://www.geeksforgeeks.org/protection-in-os-domain-of-protection-association-authentication/](https://www.geeksforgeeks.org/protection-in-os-domain-of-protection-association-authentication/)
...
*   计算机系统有进程和对象，它们被视为抽象数据类型，这些对象有特定于它们的操作。一个域元素被描述为 `<object of operations on object>`。
