...
> 原文：[https://www.geeksforgeeks.org/difference-between-windows-and-netbsd/](https://www.geeksforgeeks.org/difference-between-windows-and-netbsd/)
...
| 编号 | `Windows` | `NetBSD` |
| :--- | :--- | :--- |
| 1. | 它是由`微软公司`开发并拥有的。 | 它是由`NetBSD`基金会开发并拥有的。 |
