...
> 原文: [https://www.geeksforgeeks.org/points-to-remember-for-database-design-interview/](https://www.geeksforgeeks.org/points-to-remember-for-database-design-interview/)
...
`TenantApartment`表存储了租户和公寓之间的关系。
