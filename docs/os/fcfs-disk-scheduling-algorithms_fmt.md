...
> 原文: [https://www.geeksforgeeks.org/fcfs-disk-scheduling-algorithms/](https://www.geeksforgeeks.org/fcfs-disk-scheduling-algorithms/)
...
实施 `FCFS` 如下。请注意，`distance` 用于存储磁头和当前磁道位置之间的绝对距离。
