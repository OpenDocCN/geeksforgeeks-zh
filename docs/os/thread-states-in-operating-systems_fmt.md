...
> 原文：[https://www.geeksforgeeks.org/thread-states-in-operating-systems/](https://www.geeksforgeeks.org/thread-states-in-operating-systems/)
...
5.  当应用程序有能力延迟线程的处理时，它可以在需要时延迟线程并将其休眠特定的时间。然后，线程从`RUNNING`转换到`DELAYED`队列。
