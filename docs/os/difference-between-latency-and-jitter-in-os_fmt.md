...
> 原文：[https://www.geeksforgeeks.org/difference-between-latency-and-jitter-in-os/](https://www.geeksforgeeks.org/difference-between-latency-and-jitter-in-os/)
...
*   **静态抖动缓冲器** – 这些缓冲器在系统的硬件内实现，并且大部分由制造商配置。
*   **动态抖动缓冲区** – 这些缓冲区在系统软件内实现，由网络管理员配置，可以轻松适应网络变化。
