...
> 原文: [https://www.geeksforgeeks.org/difference-between-macos-and-openbsd/](https://www.geeksforgeeks.org/difference-between-macos-and-openbsd/)
...
| 11. | macOS 支持的文件系统有 `HFS+`、`APFS`、`HFS`、`UFS`、`AFP`、`ISO 9660`、`FAT`、`UDF`、`NFS`、`SMBFS`、`NTFS`、`FTP`、`WebDAV` 和 `ZFS`。 | OpenBSD 支持的文件系统有 `ffs`、`ext2`、`FAT`、`ISO 9660` 和 `NFS`。 |