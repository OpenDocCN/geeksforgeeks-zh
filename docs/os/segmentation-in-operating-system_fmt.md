...
> 原文: [`https://www.geeksforgeeks.org/segmentation-in-operating-system/`](https://www.geeksforgeeks.org/segmentation-in-operating-system/)
...
在分段中，逻辑地址和物理地址之间没有简单的关系。一个表存储了所有这些段的信息，称为`段表`。

## `段表`–
它将二维逻辑地址映射为一维物理地址。它的每个表条目都有:
