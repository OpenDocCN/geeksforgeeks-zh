...
> 原文：[https://www.geeksforgeeks.org/creating-symbolic-links-on-windows/](https://www.geeksforgeeks.org/creating-symbolic-links-on-windows/)
...
**示例–**
在本例中，我们将使用与上例中相同的文件，位于 `C:\suga\settings`。为了在同一路径上用不同的名称（例如。`moba`）创建链接，命令如下：
