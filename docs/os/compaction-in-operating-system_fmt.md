...
> 原文：[https://www.geeksforgeeks.org/compaction-in-operating-system/](https://www.geeksforgeeks.org/compaction-in-operating-system/)
...
在压缩之前，主内存在已占用的空间之间有一些空闲空间。这种情况称为[外部碎片](https://www.geeksforgeeks.org/difference-between-internal-and-external-fragmentation/)。由于占用空间之间的可用空间较少，大型进程无法加载到其中。
