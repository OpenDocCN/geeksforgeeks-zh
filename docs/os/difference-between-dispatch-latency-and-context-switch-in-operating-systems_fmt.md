...
> 原文：[https://www.geeksforgeeks.org/difference-between-dispatch-latency-and-context-switch-in-operating-systems/](https://www.geeksforgeeks.org/difference-between-dispatch-latency-and-context-switch-in-operating-systems/)
...
| 调度延迟 | 上下文开关程序 |
| --- | --- |
| 调度程序暂停一个进程并启动另一个进程所花费的时间量称为调度延迟。 | 保存先前运行的进程或线程的状态并由调度程序加载新进程的初始或先前保存的状态的过程。 |
