...
微软 Windows Server 2003、微软 Windows Server 2008、UNIX、Linux、Mac OS X、Novell NetWare、BSD 等。
...
*   **嵌入式系统中的实时操作系统:** 由于程序规模小，RTOS 也可以用在交通等嵌入式系统中。
*   **无错误:** 这些类型的系统是无错误的。
...
科学实验、医学成像系统、工业控制系统、武器系统、机器人、空中交通管制系统等。