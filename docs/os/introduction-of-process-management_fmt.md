...
> 原文: [https://www.geeksforgeeks.org/introduction-of-process-management/](https://www.geeksforgeeks.org/introduction-of-process-management/)
...
一个`I/O`绑定的进程需要更多的`I/O`时间 and 更少的`CPU`时间。受输入/输出限制的进程在等待状态下花费更多的时间。
...
[http://cs.nyu.edu/courses/spring11/G22.2250-001/lectures/lecture-04.html](http://cs.nyu.edu/courses/spring11/G22.2250-001/lectures/lecture-04.html)
