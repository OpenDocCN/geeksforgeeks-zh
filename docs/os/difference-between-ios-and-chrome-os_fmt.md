...
> 原文：[https://www.geeksforgeeks.org/difference-between-ios-and-chrome-os/](https://www.geeksforgeeks.org/difference-between-ios-and-chrome-os/)
...
| 6. | 它的原生 API 是 `Cocoa` 和 `BSD-POSIX`。 | 它的原生 API 是 `Linux/POSIX`。 |
| 7. | 它拥有的首选许可证是专有，`APSL` 和 `GNU GPL`。 | 它拥有专有的首选许可。 |
| 8. | 它没有包管理。 | 它的包管理是 `Portage`。 |
| 9. | 它是专门为 iPhone 和 iPad 设计的。 | 它是专门为 Chromebook 设计的。 |
