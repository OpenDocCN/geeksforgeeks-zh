...
> 原文：[https://www.geeksforgeeks.org/getting-hash-of-a-file-using-cmd/](https://www.geeksforgeeks.org/getting-hash-of-a-file-using-cmd/)
...
其中 `certutil` 是命令，`-hashfile` 是提供给它的开关。
