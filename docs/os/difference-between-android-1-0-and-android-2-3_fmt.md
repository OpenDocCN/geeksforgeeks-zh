...
> 原文：[https://www.geeksforgeeks.org/difference-between-android-1-0-and-android-2-3/](https://www.geeksforgeeks.org/difference-between-android-1-0-and-android-2-3/)
...
| 5. | 它没有开发人员功能。 | 这个版本增加了一些关键的开发者特性，比如 `NDK`、`音频影响api`、`多摄像头传感器支持`、`严格的模式调试`。 |
