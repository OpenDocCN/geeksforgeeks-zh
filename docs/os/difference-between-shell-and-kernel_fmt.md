...
> 原文:[https://www . geeksforgeks . org/shell 和内核的区别/](https://www.geeksforgeeks.org/difference-between-shell-and-kernel/)
...
`内核`是管理计算机和硬件操作的操作系统的心脏和核心。它通过访问各种计算机资源，如中央处理器、输入/输出设备和其他资源，充当用户和系统资源之间的桥梁。
