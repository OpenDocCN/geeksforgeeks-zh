...
基于指令集架构，每个进程需要的页面数量最少。示例 IBM 370：6 页处理 `MVC`（存储到存储移动）指令。指令为 6 字节，可能跨越 2 页。
2 页待处理。
2 页处理到。
...
参考文献:
[http://barbara.stattenfield.org/ta/cs162/section-notes/sec8.txt](http://barbara.stattenfield.org/ta/cs162/section-notes/sec8.txt)
