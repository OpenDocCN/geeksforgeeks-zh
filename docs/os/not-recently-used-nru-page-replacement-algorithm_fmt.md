...
> 原文：[https://www.geeksforgeeks.org/not-recently-used-nru-page-replacement-algorithm/](https://www.geeksforgeeks.org/not-recently-used-nru-page-replacement-algorithm/)
...
这很容易理解，实现起来效率适中，并且给出的性能虽然肯定不是最佳的，但可能是足够的。修改页面时，会设置一个`修改位`。当一个页面需要被替换时，操作系统将页面分成 4 类。
...
![img](img/2eb805a5b4a2ff054e742f068c0b1a6b.png)