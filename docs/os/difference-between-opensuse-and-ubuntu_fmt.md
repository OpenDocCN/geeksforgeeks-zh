...
> 原文：[https://www.geeksforgeeks.org/difference-between-opensuse-and-ubuntu/](https://www.geeksforgeeks.org/difference-between-opensuse-and-ubuntu/)
...
| 8. | 它有单片内核。 | 它使用基于规范的内核。 |
| 9. | `openSUSE` 论坛是 [https://forums.opensuse.org/](https://forums.opensuse.org/) | `ubuntu` 论坛是 [https://ubuntuforums.org/](https://ubuntuforums.org/) |
