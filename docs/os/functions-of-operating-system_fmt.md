...
> 原文：[`https://www.geeksforgeeks.org/functions-of-operating-system/`](https://www.geeksforgeeks.org/functions-of-operating-system/)
...
5.  **资源分配**：操作系统通过决定哪些资源由谁使用多长时间来确保所有可用资源的正确的使用。所有的决定都是由操作系统做出的。
