...
> 原文：[https://www.geeksforgeeks.org/completely-fair-scheduler-cfs-and-brain-fuck-scheduler-bfs/](https://www.geeksforgeeks.org/completely-fair-scheduler-cfs-and-brain-fuck-scheduler-bfs/)
...
因此，在最坏的情况下，在上下文切换时选择新的进程可以变成 `O(n)`，并且当使用队列时，进程的插入是 `O(1)`。
