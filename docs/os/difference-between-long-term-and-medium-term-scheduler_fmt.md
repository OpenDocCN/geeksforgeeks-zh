...
> 原文：[https://www.geeksforgeeks.org/difference-between-long-term-and-medium-term-scheduler/](https://www.geeksforgeeks.org/difference-between-long-term-and-medium-term-scheduler/)
...
| S.NO | 长期调度程序 | 中期调度程序 |
| --- | --- | --- |
| 1. | 长期调度程序被称为作业调度程序。 | 而中期调度程序被称为进程交换调度程序。 |
| 2. | 在长期调度程序中，从作业池中选择进程，并将这些进程加载到内存中以便执行。 | 在这种情况下，可以在内存中恢复进程，也可以执行进程。 |
