...
> 原文：[https://www.geeksforgeeks.org/difference-between-delay-and-deadline-constraint-in-real-time-system/](https://www.geeksforgeeks.org/difference-between-delay-and-deadline-constraint-in-real-time-system/)
...
| 这意味着在事件 `E1` 发生之后，事件 `E2` 只有在经过的时间等于延迟约束之后才能发生。 | 这意味着在事件 `E1` 发生之后，事件 `E2` 必须仅在经过的时间等于截止时间约束之前发生。 |
