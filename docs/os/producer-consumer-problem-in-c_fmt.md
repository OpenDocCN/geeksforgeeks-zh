...
> 原文：[https://www.geeksforgeeks.org/producer-consumer-problem-in-c/](https://www.geeksforgeeks.org/producer-consumer-problem-in-c/)
...
**方法：** 思路是利用并行编程的概念和[临界区](https://www.geeksforgeeks.org/g-fact-70/)使用 `OpenMP` 在 `C 语言`中实现生产者-消费者问题。
