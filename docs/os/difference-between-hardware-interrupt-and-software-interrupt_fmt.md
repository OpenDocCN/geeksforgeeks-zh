...
> 原文：[https://www.geeksforgeeks.org/difference-between-hardware-interrupt-and-software-interrupt/](https://www.geeksforgeeks.org/difference-between-hardware-interrupt-and-software-interrupt/)

先决条件 – [`8085` 微处理器](https://www.geeksforgeeks.org/interrupts-8085-microprocessor/)中的中断。
