...
*   如果逻辑地址空间 = 128 M 字 = 2<sup>7</sup> * 2<sup>20</sup> 字，则逻辑地址 = log<sub>2</sub> 2<sup>27</sup> = 27 位
*   如果物理地址 = 22 位，那么物理地址空间 = 2<sup>22</sup> 字 = 4 M 字（1 M = 2<sup>20</sup>）
*   如果物理地址空间 = 16 M 字 = 2<sup>4</sup> * 2<sup>20</sup> 字，那么物理地址 = log<sub>2</sub> 2<sup>24</sup> = 24 位
