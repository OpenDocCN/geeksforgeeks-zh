...
> 原文：[https://www.geeksforgeeks.org/difference-between-ios-and-openbsd/](https://www.geeksforgeeks.org/difference-between-ios-and-openbsd/)
...
| 7. | 它的首选许可证是专有，`APSL` 和通用公共许可证。 | 它拥有 `ISC` 的优先许可。 |
