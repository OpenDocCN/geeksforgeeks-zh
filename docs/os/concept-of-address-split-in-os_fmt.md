...
> 原文: [https://www.geeksforgeeks.org/concept-of-address-split-in-os/](https://www.geeksforgeeks.org/concept-of-address-split-in-os/)
...
> **注：** 内存中最小的可寻址单元叫做字。它是指使用地址位可以明确识别的最小单位。
...
> **注意：** 字可寻址和字节可寻址的概念是不同的，当有疑问时，询问字可寻址，将地址空间转换成字，然后应用上面解释的所有概念。