...
> 原文: [https://www.geeksforgeks.org/running-user-interface-thread-in-android-using-kotlin/](https://www.geeksforgeks.org/running-user-interface-thread-in-android-using-kotlin/)
...
**第二步:** 在 `MainActivity` 类中添加下面的代码。这里我们用按钮添加 `onClickListener` 。点击按钮时，`runOnUiThread` 功能显示剩余时间。
