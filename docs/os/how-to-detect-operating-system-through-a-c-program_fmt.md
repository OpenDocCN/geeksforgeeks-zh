...
> 原文：[https://www.geeksforgeeks.org/how-to-detect-operating-system-through-a-c-program/](https://www.geeksforgeeks.org/how-to-detect-operating-system-through-a-c-program/)
...
| 5. | iOS 嵌入式 | `TARGET_OS_EMBEDDED` | 包含 `TargetConditionals.h` |
| 6. | iOS 模拟器 | `TARGET_IPHONE_SIMULATOR` | 包含 `TargetConditionals.h` |
| 7. | 苹果手机 | `TARGET_OS_IPHONE` | 包含 `TargetConditionals.h` |
| 8. | 苹果电脑 | `TARGET_OS_MAC` | 包含 `TargetConditionals.h` |
...
| 13. | Solaris | `__sun` | – |
| 14. | 惠普用户体验 | `__hpux` | – |
| 15. | 加州大学伯克利分校软件(Berkeley Software Distribution) | `BSD` | 所有 BSD 口味 |
| 16. | 蜻蜓 BSD | `__DragonFly__` | – |
...
类似地，人们可以找到操作系统，并可以[为系统设置适当的代码](https://www.geeksforgeeks.org/writing-os-independent-code-cc/)。