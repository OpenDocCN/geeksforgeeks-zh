...
> 原文: [https://www.geeksforgeeks.org/client-server-computing-and-its-terminologies/](https://www.geeksforgeeks.org/client-server-computing-and-its-terminologies/)
...
这是 IBM（国际商业机器）和 ANSI 标准化的开发语言，用于处理、生成、更新和查询 RDB（关系数据库）。