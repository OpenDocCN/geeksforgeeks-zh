...
> 原文：[https://www.geeksforgeeks.org/traps-and-system-calls-in-operating-system-os/](https://www.geeksforgeeks.org/traps-and-system-calls-in-operating-system-os/)
...
这个用于获取操作系统管理的组件被称为 **系统调用**。可访问框架调用的安排被称为操作系统的**应用程序接口**或**应用编程接口**。