...
> 原文：[https://www.geeksforgeeks.org/advantages-and-disadvantages-of-various-disk-scheduling-algorithms/](https://www.geeksforgeeks.org/advantages-and-disadvantages-of-various-disk-scheduling-algorithms/)
...
3.  与扫描算法相比，在`C-SCAN`中，磁头刚刚访问的柱面的等待时间减少了。
4.  提供统一的等待时间。
5.  提供了更好的响应时间。

**缺点：**

1.  与扫描算法相比，`C-SCAN`会导致更多的寻道运动。
