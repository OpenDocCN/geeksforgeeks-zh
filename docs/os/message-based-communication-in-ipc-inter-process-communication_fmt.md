...
> 原文: [https://www.geeksforgeeks.org/message-based-communication-in-ipc-inter-process-communication/](https://www.geeksforgeeks.org/message-based-communication-in-ipc-inter-process-communication/)

## 先决条件
[云计算](https://www.geeksforgeeks.org/cloud-computing/)、[云计算中的负载平衡](https://www.geeksforgeeks.org/load-balancing-in-cloud-computing/)、[进程间通信](https://www.geeksforgeeks.org/inter-process-communication/)
...
### 消息传递
在该模型中，引入了消息作为模型主要抽象的概念。以信息的形式对明确编码的数据和信息进行交互的单元。根据当时的模型，消息的模式和内容会发生变化。`消息传递接口`和`OpenMP`是这种类型模型的主要例子。
