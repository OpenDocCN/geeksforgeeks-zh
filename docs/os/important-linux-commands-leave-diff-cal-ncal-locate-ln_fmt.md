...
> 原文：[https://www.geeksforgeeks.org/important-linux-commands-leave-diff-cal-ncal-locate-ln/](https://www.geeksforgeeks.org/important-linux-commands-leave-diff-cal-ncal-locate-ln/)
...
`leave` 一直等到指定的时间（在接下来的 12 小时内），然后通过给你执行 `leave` 的 TTY 写信提醒你必须离开。在实际时间前 5 分钟和 1 分钟、当时和之后的每一分钟都会提醒您。
...
## 11. `cal`, `ncal` — displays a calendar and the date of Easter
...
用指定的名称创建一个到 TARGET 的链接。

[![](img/bf4c652a7490f6a29e93f046c3e3449c.png)](https://media.geeksforgeeks.org/wp-content/uploads/Screenshot-from-2017-06-05-19-22-43.png)
