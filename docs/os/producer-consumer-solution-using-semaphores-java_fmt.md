...
## 先决条件
–[Java 中的信号量](https://www.geeksforgeeks.org/semaphore-in-java/)、[进程间通信](https://www.geeksforgeeks.org/inter-process-communication/)、[生产者消费者使用信号量的问题|集合 1](https://www.geeksforgeeks.org/producer-consumer-problem-using-semaphores-set-1/)
