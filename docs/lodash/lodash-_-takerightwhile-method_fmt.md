...
> 原文: [https://www.geeksforgeeks.org/lodash-_-takerightwhile-method/](https://www.geeksforgeeks.org/lodash-_-takerightwhile-method/)
...
// Use of _.takeRightWhile() method 
...
let gfg = _.takeRightWhile(users, { 'user': 'pebbles', 'active': false }); 
...
let gfg = _.takeRightWhile(users, ['active', false]); 
