...
`_.clone()`方法用于创建值的浅拷贝。此方法支持克隆数组、数组缓冲区、布尔值、日期对象、映射、数字、对象对象、正则表达式、集合、字符串、符号和类型化数组。它松散地基于结构化克隆算法。
...
**参考:** [https://lodash.com/docs/4.17.15#clone](https://lodash.com/docs/4.17.15#clone)