...
洛达什 `_.bindAll()`方法用于绑定对象上的方法数量。每个方法都有一个方法名。使用事件处理程序很方便。
...
下面的例子说明了 Lodash `_.bindAll()`在 JavaScript 中的方法:
...
[https://docs-lodash.com/v4/bind-all/](https://docs-lodash.com/v4/bind-all/)