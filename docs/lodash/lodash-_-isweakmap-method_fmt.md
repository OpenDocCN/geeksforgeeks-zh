...
`_.isWeakMap()` 方法用于查找给定值是否为 WeakMap 对象。如果给定值是 WeakMap 对象，则返回 `true`。否则，它返回 `false`。
...
如果值是 WeakMap，该方法返回 `true`，否则返回 `false`。
...
**参考资料:** [https://lodash.com/docs/4.17.15#isWeakMap](https://lodash.com/docs/4.17.15#isWeakMap)