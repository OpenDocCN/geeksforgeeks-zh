...
> 原文: [https://www.geeksforgeeks.org/lodash-_-prototype-chain-method/](https://www.geeksforgeeks.org/lodash-_-prototype-chain-method/)

**Lodash** 是一个工作在下划线.js之上的JavaScript库，Lodash有助于处理数组、字符串、对象、数字等。

`lodash`中的`_.prototype.chain()`方法用于创建带有启用的显式方法链序列的`lodash`包装器的实例。
