...
> 原文: [https://www.geeksforgeeks.org/lodash-_-sortedindexof-method/](https://www.geeksforgeeks.org/lodash-_-sortedindexof-method/)

`_.sortedIndexOf()` 方法用于获取排序数组中特定元素第一次出现的索引。它使用二分搜索法对数组进行排序。
