...
> 原文: [https://www.geeksforgeeks.org/lodash-_-intersectionwith-method/](https://www.geeksforgeeks.org/lodash-_-intersectionwith-method/)
...
*   `arrays`: 它以数组为参数。
*   `comparator`: 它是对数组的每个值进行迭代并将这些值与给定的比较器函数进行比较的函数。
...
在使用下面给出的代码之前，请使用命令 `npm install lodash` 安装 lodash 模块。
