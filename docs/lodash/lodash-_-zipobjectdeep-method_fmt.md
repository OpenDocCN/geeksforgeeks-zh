...
> 原文: [https://www.geeksforgeeks.org/lodash-_-zipobjectdeep-method/](https://www.geeksforgeeks.org/lodash-_-zipobjectdeep-method/)

`_.zipObjectDeep()` 方法类似于 `_.zipObject()` 方法，除了它支持属性路径之外，它还接受两个数组，一个是属性标识符，一个是对应的值。
...
*   `[props=[]]` (array): 此参数持有属性标识符。
*   `[values=[]]` (array): 此参数持有属性值。
