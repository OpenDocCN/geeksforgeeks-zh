...
**Lodash** 在处理数组、字符串、对象等时非常有用。它使数学运算和函数范式变得更加容易、简洁。 `_.compact()`函数用于创建一个数组，在 JavaScript 中去掉所有虚假值。
...
## 注意:
值 `false`、`null`、`0`、`""`、`undefined` 和 `NaN` 是假的。
