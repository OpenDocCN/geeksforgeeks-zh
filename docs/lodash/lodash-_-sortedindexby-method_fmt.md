...
> 原文: [https://www.geeksforgeeks.org/lodash-_-sortedindexby-method/](https://www.geeksforgeeks.org/lodash-_-sortedindexby-method/)

`_.sortedIndexBy()`方法用于返回数组中可以插入元素的最低索引，并保持其排序顺序。此外，它接受对值和数组的每个元素调用的迭代来计算它们的排序。它使用二分搜索法。
...
**示例 1:** 这里，`const _ = require('lodash')`用于将lodash库导入文件。
