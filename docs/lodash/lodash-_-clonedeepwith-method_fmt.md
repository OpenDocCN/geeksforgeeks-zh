...
> 原文: [https://www.geeksforgeeks.org/lodash-_-clonedeepwith-method/](https://www.geeksforgeeks.org/lodash-_-clonedeepwith-method/)

`_.cloneDeepWith()`方法用于递归克隆值，就像的 _.方法，但以递归方式执行。
...
*   `customizer`: 此参数保存定制克隆的功能。

**返回值:** 该方法返回克隆值。

下面的例子说明了 Lodash `_.cloneDeepWith()`方法:
...
**参考:** https://docs-lodash.com/v4/clone-deep-with/