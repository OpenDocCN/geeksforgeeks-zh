...
**`_.rearg()`方法**用于创建一个调用`函数`参数的函数，参数根据所述索引组织。其中，第一个索引值的参数作为第一个参数发送，第二个索引值的参数作为第二个参数发送，依此类推。
...
**参考:** [https://lodash.com/docs/4.17.15#rearg](https://lodash.com/docs/4.17.15#rearg)