...
`_.pullAt()`方法用于移除给定地址对应的元素，并返回被移除元素的数组。
...
*   `Array`：此参数存储要修改的数组。
*   `ArrayOfIndexes`：此参数保存要从数组中移除的元素的索引。
...
**参考：** [https://lodash.com/docs/4.17.15#pullAt](https://lodash.com/docs/4.17.15#pullAt)