...
> 原文: [https://www.geeksforgeeks.org/mongoose-findoneandreplace-function/](https://www.geeksforgeeks.org/mongoose-findoneandreplace-function/)

`findOneAndReplace()`函数用于查找匹配的元素，用提供的元素替换，并将返回的单据传递给回调。
