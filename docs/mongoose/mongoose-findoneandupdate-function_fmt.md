...
> 原文: [https://www.geeksforgeeks.org/mongoose-findoneandupdate-function/](https://www.geeksforgeeks.org/mongoose-findoneandupdate-function/)

`findOneAndUpdate()`函数用于查找匹配的文档并根据更新参数进行更新，传递任意选项，并将找到的文档(如有)返回回调。
