# Mongoose findOneAndRemove() 功能

> 原文: [https://www.geeksforgeeks.org/mongoose-findoneandremove-function/](https://www.geeksforgeeks.org/mongoose-findoneandremove-function/)

`findOneAndRemove()` 函数用于根据条件找到元素，然后移除第一个匹配的元素。
...
![output](img/17a84c464a495c3f7f4a4095ebf2062e.png)
