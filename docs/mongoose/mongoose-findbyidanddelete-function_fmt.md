...
> 原文: [https://www.geeksforgeeks.org/mongoose-findbyidanddelete-function/](https://www.geeksforgeeks.org/mongoose-findbyidanddelete-function/)

`findByIdAndDelete()`函数用于查找匹配的文档，将其移除，并将找到的文档(如果有)传递给回调。

## Mongoose模块安装

1.  您可以访问[安装Mongoose模块](https://www.npmjs.com/package/mongoose)的链接。您可以使用此命令安装此软件包。

    ```
    npm install mongoose
    ```

2.  安装Mongoose模块后，您可以使用命令在命令提示符下检查您的Mongoose版本。
