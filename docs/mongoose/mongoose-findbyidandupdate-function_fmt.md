...
> 原文: [https://www.geeksforgeeks.org/mongoose-findbyidandupdate-function/](https://www.geeksforgeeks.org/mongoose-findbyidandupdate-function/)

`findByIdAndUpdate()`函数用于查找匹配的文档，根据更新参数进行更新，传递任意选项，并将找到的文档(如有)返回回调。
...
5.  执行该功能后，您可以在数据库中看到特定用户被更新，如下所示:
