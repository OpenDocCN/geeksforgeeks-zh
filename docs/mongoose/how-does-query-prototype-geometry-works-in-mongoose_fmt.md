...
> 原文: [https://www.geeksforgeeks.org/how-does-query-prototype-geometry-works-in-mongoose/](https://www.geeksforgeeks.org/how-does-query-prototype-geometry-works-in-mongoose/)
...
该函数有一个对象参数，该参数必须包含字符串类型的 `type` 属性和数组类型的 `coordinates` 属性。
...
[https://mongoosejs.com/docs/api/query.html#query_Query-geometry](https://mongoosejs.com/docs/api/query.html#query_Query-geometry)