...
> 原文: [https://www.geeksforgeeks.org/mongoose-countdocuments-function/](https://www.geeksforgeeks.org/mongoose-countdocuments-function/)

`countDocuments()` 函数用于统计数据库集合中匹配过滤器的文档数量。
