# `Query.prototype.box()` 在 Mongoose 中是如何工作的？

> 原文: [https://www.geeksforgeeks.org/how-does-query-prototype-box-work-in-mongoose/](https://www.geeksforgeeks.org/how-does-query-prototype-box-work-in-mongoose/)

`Query.prototype.box()` 用于指定 `$box` 条件。使用该功能时，`$geoWithin` 根据网格坐标返回文档。
...
**参考:** [https://mongoosejs.com/docs/api/query.html#query_Query-box](https://mongoosejs.com/docs/api/query.html#query_Query-box)