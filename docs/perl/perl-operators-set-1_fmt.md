...
*   [算术运算符](https://www.geeksforgeeks.org/perl-operators-set-1/#Arithmetic%20Operators)
*   [关系运算符](https://www.geeksforgeeks.org/perl-operators-set-1/#Relational%20Operators)
*   [逻辑运算符](https://www.geeksforgeeks.org/perl-operators-set-1/#Logical%20Operators)
*   [逐位运算符](https://www.geeksforgeeks.org/perl-operators-set-1/#Bitwise%20Operators)
*   [分配操作员](https://www.geeksforgeeks.org/perl-operators-set-1/#Assignment%20Operators)
*   [三元算子](https://www.geeksforgeeks.org/perl-operators-set-1/#Ternary%20Operator)
...
*   **逻辑与:** 当所考虑的两个条件都满足时，`and` 运算符返回真。例如，当 `a` 和 `b` 都为真（即非零）时，`$a and $b` 为真。也可以使用 `&&`。
*   **逻辑或:** 当所考虑的条件中的一个（或两个）满足时，运算符 `or` 返回真。例如，如果 `a` 或 `b` 中的一个为真（即非零），则 `$a or $b` 为真。当然，当 `a` 和 `b` 都为真时，它给出的结果是“真”。也可以使用 `||`。
*   **逻辑非:** 如果满足所考虑的条件，`not` 运算符将给出 1。例如，如果 `$d` 为 0，`not($d)` 为真。
