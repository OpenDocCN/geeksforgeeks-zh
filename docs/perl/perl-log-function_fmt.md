...
[Perl](https://www.geeksforgeeks.org/introduction-to-perl/) 中的 `log()` 函数返回传递给它的值的自然对数。如果在不传递值的情况下调用，则返回 `$_`。`log()` 函数可以通过公式 ![](img/c41d20795a4101d736d89eab659307fa.png) 找到任意底数的对数。
