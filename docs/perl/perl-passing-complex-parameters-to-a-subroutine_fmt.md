...
> 原文: [https://www.geeksforgeeks.org/perl-passing-complex-parameters-to-a-subroutine/](https://www.geeksforgeeks.org/perl-passing-complex-parameters-to-a-subroutine/)

## 先决条件

[Perl | 子程序或函数](https://www.geeksforgeeks.org/perl-subroutines-or-functions/)
...
数组或列表可以作为参数传递给子程序，数组变量`@_`用于接受子程序或函数内部的列表值。

### 示例 1

这里，一个单独的列表被传递给子程序，并显示它们的元素。
