...
> 原文: [https://www.geeksforgeeks.org/perl-use-of-capturing-in-regular-expressions/](https://www.geeksforgeeks.org/perl-use-of-capturing-in-regular-expressions/)
...
找到字符串中的匹配很重要，这是通过正则表达式来完成的。当我们将这些匹配从字符串中取出进行进一步处理时，它们会更有用。
