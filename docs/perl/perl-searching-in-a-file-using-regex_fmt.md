...
> 原文: [https://www.geeksforgeeks.org/perl-searching-in-a-file-using-regex/](https://www.geeksforgeeks.org/perl-searching-in-a-file-using-regex/)
...
该表达式将在文件中搜索包含带有字母“the”的单词的行，并将该单词存储在变量`$String`中。此外，这个变量的值可以复制到一个文件中，或者简单地打印在控制台上。
