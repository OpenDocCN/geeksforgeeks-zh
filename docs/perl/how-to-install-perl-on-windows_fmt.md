...
> 原文: [https://www.geeksforgeeks.org/how-to-install-perl-on-windows/](https://www.geeksforgeeks.org/how-to-install-perl-on-windows/)
...
要检查您的设备是否预装了 Perl，只需转到`命令行`（对于`窗口`，在运行对话框中搜索`cmd`（`Win+R`））。
...
在开始安装过程之前，您需要下载它。为此，Windows Perl 的所有版本都可以在 [https://www.activestate.com/products/perl/](https://www.activestate.com/products/perl/) 上获得。下载 Perl 并按照进一步的说明安装 Perl。
...
![Hello-World-Program](img/b5fe158ec58727c7e3f316b06eafb319.png)