...
> 原文: [https://www.geeksforgeeks.org/perl-stdin-in-scalar-and-list-context/](https://www.geeksforgeeks.org/perl-stdin-in-scalar-and-list-context/)
...
为了从键盘上获取输入，在 Perl 中使用的是 `<STDIN>` 运算符。该操作符读取通过键盘输入的一行，以及对应于我们在输入后按下的回车键的换行符。
