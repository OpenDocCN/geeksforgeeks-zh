...
> 原文: [https://www.geeksforgeeks.org/perl-listing-your-program-with-a-debugger/](https://www.geeksforgeeks.org/perl-listing-your-program-with-a-debugger/)

完美的程序很难在第一次尝试中得到。他们必须经历各种调试步骤来修复所有错误。有两种类型的错误——语法错误和逻辑错误。语法错误很容易修复，而且很快就能找到。另一方面，逻辑错误很难发现和修复。因此，需要`调试器`来修复这些错误。
