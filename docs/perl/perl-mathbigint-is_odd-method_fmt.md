# Perl | Math::BigInt->is_odd()方法

> 原文: [https://www.geeksforgeeks.org/perl-mathbigint-is_odd-method/](https://www.geeksforgeeks.org/perl-mathbigint-is_odd-method/)
...
> **语法:** `Math::BigInt->is_odd()`
>
> **参数:** 无
>
> **返回:** 如果 `BigInt` 对象中存储的数字是奇数，则返回 `true`，否则返回 `false`。
