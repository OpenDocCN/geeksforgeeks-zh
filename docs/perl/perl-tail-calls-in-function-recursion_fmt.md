...
> 原文: [https://www.geeksforgeeks.org/perl-tail-calls-in-function-recursion/](https://www.geeksforgeeks.org/perl-tail-calls-in-function-recursion/)
...
## 使用`goto`语句演示 Tail 递归

`goto`将编译器从当前运行的子程序转移到给定名称的子程序。这将替换函数调用，并以同样的方式创建递归过程。
