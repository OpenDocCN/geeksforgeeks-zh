...
> 原文: [https://www.geeksforgeeks.org/perl-line-action-commands-in-a-debugger/](https://www.geeksforgeeks.org/perl-line-action-commands-in-a-debugger/)
...
`'A' command` 用于删除之前使用 `'a' command` 指定的行动作。它会删除命令中指定的行的行操作。
