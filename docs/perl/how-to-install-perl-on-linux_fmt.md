...
Perl 程序可以写在任何纯文本编辑器上，比如 `Notepad++` 或者任何类似的东西。人们也可以使用在线的 `IDE` 来编写 Perl 代码，或者甚至可以在他们的系统上安装一个，使编写这些代码更加可行。使用一个 `IDE` 使得编写 Perl 代码变得更加容易，因为 IDE 提供了很多功能，比如直观的代码编辑器、调试器、编译器等等。
...
要检查您的设备是否预装了 Perl，请使用 `Ctrl+Alt+T` 打开终端。现在运行以下命令:
...
在开始安装过程之前，您需要下载它。为此，Linux 的所有 Perl 版本都可以在 [https://www.perl.org/get.html](https://www.perl.org/get.html) 上获得。下载 Perl 并按照进一步的说明安装 Perl。

![Perl-Download-Page](img/f89805fbea3eca1b89a0e5da87bd4c46.png)

### 从安装开始

1.  **更改目录以安装 Perl:**
    ![Change-Directory](img/1e1f52fd545091762bccf78919d8fa18.png)

2.  **开始安装过程:**
    ![Start-Installation](img/e2878710f49b91d45954cf3006fb3ac3.png)

3.  **选择安装 Perl 的目录:**
    ![Choose-Directory](img/a631c40ac06fe921c79cf8190cea5b9a.png)

4.  **完成安装:**
    ![Complete-Installation](img/032c1be3ba17f409707d216a2b98374f.png)
...
**Output:**
![Hello-World-Program-Linux](img/039ef4214cd2df8d254966dc04dd5c58.png)