...
> 原文: [https://www.geeksforgeeks.org/how-to-convert-a-file-to-zip-file-and-download-it-using-node-js/](https://www.geeksforgeeks.org/how-to-convert-a-file-to-zip-file-and-download-it-using-node-js/)
...
打开浏览器打开 `localhost:7777` 然后 `upload_data` 文件夹转换成 zip 文件下载！
...
### 输出
借助下面的 gif 表示将文件转换为 zip 文件的整个过程，这样就可以将文件夹更改为 zip 文件，然后下载！
