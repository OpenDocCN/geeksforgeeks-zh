...
> 原文: [https://www.geeksforgeeks.org/node-js-http2serverresponse-getheader-method/](https://www.geeksforgeeks.org/node-js-http2serverresponse-getheader-method/)

`Http2ServerResponse.getHeader()` 是 `http2` 模块内的类 `Http2ServerResponse` 的内置 API，用于读出已经排队但未发送到客户端的头。
...
**参考：** [https://nodejs.org/dist/latest-v12.x/docs/api/http2.html#http2_response_getheader_name](https://nodejs.org/dist/latest-v12.x/docs/api/http2.html#http2_response_getheader_name)