...
> 原文: [https://www.geeksforgeeks.org/node-js-fs-filehandle-write-method/](https://www.geeksforgeeks.org/node-js-fs-filehandle-write-method/)
...
该方法返回一个待定承诺，该承诺包含缓冲区和描述写入字节数的`bytesWritten`属性。

下面的程序说明了`fs.filehandle.write()`方法在Node.js中的使用。
...
**参考:** [https://nodejs.org/dist/latest-v12.x/docs/api/fs.html#fs_filehandle_write_buffer_offset_length_position](https://nodejs.org/dist/latest-v12.x/docs/api/fs.html#fs_filehandle_write_buffer_offset_length_position)