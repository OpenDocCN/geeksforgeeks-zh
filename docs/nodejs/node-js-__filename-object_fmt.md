...
Node.js 中的 `__filename` 返回被执行代码的文件名。它给出了代码文件的绝对路径。以下方法介绍了如何在 NodeJS 项目中实现 `__filename`。
...
**参考：** [https://nodejs.org/api/globals.html#globals_filename](https://nodejs.org/api/globals.html#globals_filename)