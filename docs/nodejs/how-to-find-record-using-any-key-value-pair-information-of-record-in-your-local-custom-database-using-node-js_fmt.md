...
> 原文：[https://www.geeksforgeeks.org/how-to-find-record-using-any-key-value-pair-information-of-record-in-your-local-custom-database-using-node-js/](https://www.geeksforgeeks.org/how-to-find-record-using-any-key-value-pair-information-of-record-in-your-local-custom-database-using-node-js/)
...
3.  使用键值信息为数据库中的特定用户创建一个 POST 路由请求。
4.  将服务器设置为在特定端口（开发者端口–3000）上运行。
5.  创建一个存储库文件，并添加与创建本地数据库相关的所有逻辑。
6.  在存储库文件中创建一个方法，使用键值属性从数据库中获取记录。
