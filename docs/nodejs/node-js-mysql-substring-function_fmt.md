...
> 原文: [https://www.geeksforgeeks.org/node-js-mysql-substring-function/](https://www.geeksforgeeks.org/node-js-mysql-substring-function/)
...
返回给定起始位置和长度之间的输入字符串的子串。如果长度超出字符串，则忽略多余的部分。
