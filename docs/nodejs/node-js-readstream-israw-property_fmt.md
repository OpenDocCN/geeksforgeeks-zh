...
> 原文: [https://www.geeksforgeeks.org/node-js-readstream-israw-property/](https://www.geeksforgeeks.org/node-js-readstream-israw-property/)
...
当且仅当读取流对象当前被配置为作为原始设备运行时，该属性返回 `true`。
...
[https://nodejs.org/dist/latest-v12.x/docs/api/tty.html#tty_readstream_israw](https://nodejs.org/dist/latest-v12.x/docs/api/tty.html#tty_readstream_israw)