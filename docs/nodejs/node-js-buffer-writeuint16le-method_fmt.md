...
`Buffer.writeUInt16LE()`方法用于将小端格式的指定字节写入缓冲对象。这里，值应该是有效的无符号 16 位整数。
...
[https://nodejs . org/API/buffer . html # buff _ writeuint16le _ value _ offset](https://nodejs.org/api/buffer.html#buffer_buf_writeuint16le_value_offset)