...
> 原文: [https://www.geeksforgeeks.org/node-js-dnspromises-resolve4-method/](https://www.geeksforgeeks.org/node-js-dnspromises-resolve4-method/)

`dnsPromises.resolve4()`方法是`dns`模块承诺的内置应用程序编程接口，用于使用DNS协议解析指定主机名的IPv4地址(“A”记录)。
...
[https://nodejs.org/api/dns.html#dns_dnspromises_resolve4_hostname_options](https://nodejs.org/api/dns.html#dns_dnspromises_resolve4_hostname_options)