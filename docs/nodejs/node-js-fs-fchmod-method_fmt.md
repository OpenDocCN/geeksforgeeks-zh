...
> 原文:[https://www.geeksforgeeks.org/node-js-fs-fchmod-method/](https://www.geeksforgeeks.org/node-js-fchmod-method/)

`fs.fchmod()`方法用于更改给定文件描述符的权限。这些权限可以使用对应于各自文件模式的字符串常量或八进制数指定为参数。
...
**参考:**[https://nodejs.org/api/fs.html#fs_fs_fchmod_fd_mode_callback](https://nodejs.org/api/fs.html#fs_fs_fchmod_fd_mode_callback)