...
> 原文: [https://www.geeksforgeeks.org/node-js-tlssocket-getprotocol-method/](https://www.geeksforgeeks.org/node-js-tlssocket-getprotocol-method/)
...
## 返回值:
这个方法返回一个包含当前连接的协商 SSL/TLS 协议版本的字符串。
...
## 参考:
[https://nodejs.org/dist/latest-v12.x/docs/api/tls.html#tls_tlssocket_getprotocol](https://nodejs.org/dist/latest-v12.x/docs/api/tls.html#tls_tlssocket_getprotocol)