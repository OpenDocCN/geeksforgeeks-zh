...
`os.homedir()`方法是`os`模块内置的应用编程接口，用于获取当前用户的主目录路径。
...
下面的例子说明了`os.homedir()`方法在Node.js中的使用:
...
**参考资料:** [https://nodejs.org/api/os.html#os_os_homedir](https://nodejs.org/api/os.html#os_os_homedir)