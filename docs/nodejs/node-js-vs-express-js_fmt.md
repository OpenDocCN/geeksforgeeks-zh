...
下面的比较显示了相同的代码在 `Node.js`（左标签代码）和 `Express.js`（右标签代码）中是如何不同地编写的。

**注**: 这些代码包含在下面的比较中。

![](img/9bb19c0fe316129cd1cabb2abe8732e3.png)

## 在 Node.js & Express.js 中启动服务器
...
打开浏览器，进入 `http://localhost:8080/about`，输出如下:
...
打开浏览器，进入 `http://localhost:3000/about`，输出如下:
