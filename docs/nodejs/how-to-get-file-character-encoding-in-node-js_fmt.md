...
> 原文：[https://www.geeksforgeeks.org/how-to-get-file-character-encoding-in-node-js/](https://www.geeksforgeeks.org/how-to-get-file-character-encoding-in-node-js/)
...
具有以下值的对象：`{language: 'French', encoding: 'CP1252', confidence: 0.99}`
