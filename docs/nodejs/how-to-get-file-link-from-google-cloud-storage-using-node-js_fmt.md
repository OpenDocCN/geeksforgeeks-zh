...
> 原文: [https://www.geeksforgeeks.org/how-to-get-file-link-from-google-cloud-storage-using-node-js/](https://www.geeksforgeeks.org/how-to-get-file-link-from-google-cloud-storage-using-node-js/)
...
方法 `getSignedUrl()` 将一个配置对象作为输入任务，并返回一个 Promise，该 Promise 使用下载 Url 进行解析，或者如果提取失败(包括该对象不存在)则拒绝。
