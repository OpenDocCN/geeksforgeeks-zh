...
> 原文: [https://www.geeksforgeeks.org/node-js-gm-despeckle-function/](https://www.geeksforgeeks.org/node-js-gm-despeckle-function/)

`despeckle()`函数是 GraphicsMagick 库中的一个内置函数，用于减少图像中的斑点。该函数在成功时返回真值。
