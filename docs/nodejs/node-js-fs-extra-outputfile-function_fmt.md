...
> 原文: [https://www.geeksforgeeks.org/node-js-fs-extra-outputfile-function/](https://www.geeksforgeeks.org/node-js-fs-extra-outputfile-function/)
...
3.   `标志`: 它是一个字符串值，定义写入文件时使用的标志。默认情况下，该值为 `w`。你可以在这里查看[标志](https://nodejs.org/api/fs.html#fs_file_system_flags)。
...
**参考:** [https://github.com/jprichardson/node-fs-extra/blob/HEAD/docs/outputFile.md](https://github.com/jprichardson/node-fs-extra/blob/HEAD/docs/outputFile.md)