...
> 原文：[https://www.geeksforgeeks.org/how-to-convert-csv-to-excel-in-node-js/](https://www.geeksforgeeks.org/how-to-convert-csv-to-excel-in-node-js/)
...
*   **步骤 1：** 在 cli 中运行 `npm init` 并输入基本信息。

```js
npm init
```

*   **步骤 2：** 现在，创建 `app.js` 或 `index.js` 或我们将在其中实现功能的任何东西。

```js
touch app.js
```

*   **步骤 3：** 创建 Nodejs 应用程序后，使用以下命令安装所需的模块：
