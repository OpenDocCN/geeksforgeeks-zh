...
> 原文：[https://www.geeksforgeeks.org/node-js-mapbox-reverse-geocoding-api/](https://www.geeksforgeeks.org/node-js-mapbox-reverse-geocoding-api/)

## 反向地理编码
反向地理编码将地理坐标转换为地理要素或该位置存在的要素。比如把 `22.7196，75.8577` 变成‘印多尔’。Mapbox 在地理编码应用编程接口和其他位置和地图服务中很受欢迎。
