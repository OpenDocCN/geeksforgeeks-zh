...
> 原文: [https://www.geeksforgeeks.org/node-js-process-disconnect-method/](https://www.geeksforgeeks.org/node-js-process-disconnect-method/)
...
**示例 1:** 在 `Parent.js` 中，我们生成子进程。在 `Child.js` 中，我们在 `Child.js` 中得到消息。然后如果 `process.connected` 为真，则在控制台上打印一条消息并断开连接。
...
**参考:** [https://nodejs.org/api/process.html#process_process_disconnect](https://nodejs.org/api/process.html#process_process_disconnect)