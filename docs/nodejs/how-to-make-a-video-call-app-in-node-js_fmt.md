...
> 原文:[https://www.geeksforgeeks.org/how-to-make-a-video-call-app-in-node-js/](https://www.geeksforgeeks.org/how-to-make-a-video-call-app-in-node-js/)
...
*   `Socket.io`：它管理基于事件的通信的 Websocket。
