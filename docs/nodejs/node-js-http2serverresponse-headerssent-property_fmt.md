# Http2ServerResponse.headersSent 属性

> 原文：[https://www.geeksforgeeks.org/node-js-http2serverresponse-headerssent-property/](https://www.geeksforgeeks.org/node-js-http2serverresponse-headerssent-property/)

`Http2ServerResponse.headersSent` 是 `http2` 模块内的类 `Http2ServerResponse` 的内置应用程序编程接口，用于检查是否发送了标头。
...
**参考：** [https://nodejs.org/dist/latest-v12.x/docs/api/http2.html#http2_response_headerssent](https://nodejs.org/dist/latest-v12.x/docs/api/http2.html#http2_response_headerssent)