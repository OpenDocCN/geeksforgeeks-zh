...
> 原文: [https://www.geeksforgeeks.org/jwt-authentication-with-node-js/](https://www.geeksforgeeks.org/jwt-authentication-with-node-js/)
...
*   处理路线的 `express`: [express](https://www.geeksforgeeks.org/introduction-to-express/)。
*   `jsonwebtoken` 模块:
