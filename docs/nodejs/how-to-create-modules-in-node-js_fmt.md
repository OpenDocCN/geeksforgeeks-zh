...
> 原文：[https://www.geeksforgeeks.org/how-to-create-modules-in-node-js/](https://www.geeksforgeeks.org/how-to-create-modules-in-node-js/)

模块是一个单独的逻辑文件中的 JavaScript 代码的集合，可以根据它们的相关功能在外部应用程序中使用。模块很受欢迎，因为它们易于使用且可重用。

要在 Node.js 中创建一个模块，需要`exports`关键字。这个关键字告诉 Node.js 这个函数可以在模块外使用。
