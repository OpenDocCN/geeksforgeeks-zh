...
> 原文：[https://www.geeksforgeeks.org/node-js-process-multipleresolves-event/](https://www.geeksforgeeks.org/node-js-process-multipleresolves-event/)

“多重解析”是`process`模块中的一个`Process`类事件，每当一个承诺被：
*   解决了不止一次。
*   被拒绝了不止一次。
*   解决后被拒绝。
*   拒绝后解决。
...
[https://nodejs.org/dist/latest-v16.x/docs/api/process.html#process_event_multipleresolves](https://nodejs.org/dist/latest-v16.x/docs/api/process.html#process_event_multipleresolves)