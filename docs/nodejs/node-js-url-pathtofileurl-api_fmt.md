...
**参数:** 该函数接受单参数`path`，该路径保存转换文件网址的路径。

**返回值:** 该函数返回文件 URL 对象。

以下程序说明了`URL.pathToFileURL`方法的使用:
...
参考 [https://nodejs.org/api/url.html#url_url_pathtofileurl_path](https://nodejs.org/api/url.html#url_url_pathtofileurl_path)