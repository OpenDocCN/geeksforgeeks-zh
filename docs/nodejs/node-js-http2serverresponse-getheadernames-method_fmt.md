...
> 原文：[https://www.geeksforgeeks.org/node-js-http2serverresponse-getheadernames-method/](https://www.geeksforgeeks.org/node-js-http2serverresponse-getheadernames-method/)

`Http2ServerResponse.getHeaderNames()`是`http2`模块中类`Http2ServerResponse`的内置应用程序编程接口，用于返回包含当前传出头的唯一名称的数组。
...
## 参考
[https://nodejs.org/dist/latest-v12.x/docs/api/http2.html#http2_response_getheader_name](https://nodejs.org/dist/latest-v12.x/docs/api/http2.html#http2_response_getheader_name)