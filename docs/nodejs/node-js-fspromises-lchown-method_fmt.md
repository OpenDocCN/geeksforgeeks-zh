...
> 原文: [https://www.geeksforgeeks.org/node-js-fspromises-lchown-method/](https://www.geeksforgeeks.org/node-js-fspromises-lchown-method/)
...
Node.js 程序演示 `fsPromises.lchown()`方法。
