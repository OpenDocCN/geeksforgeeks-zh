...
> 原文: [https://www.geeksforgeeks.org/node-js-x509-checkprivatekey-function/](https://www.geeksforgeeks.org/node-js-x509-checkprivatekey-function/)
...
## 返回值:
当且仅当该证书的公钥与给定的私钥一致时，该函数返回布尔值 `true`。
...
**参考:** [https://nodejs.org/dist/latest-v15.x/docs/api/crypto.html#crypto_x509_checkprivatekey_privatekey](https://nodejs.org/dist/latest-v15.x/docs/api/crypto.html#crypto_x509_checkprivatekey_privatekey)