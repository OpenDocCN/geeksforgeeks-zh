# Node.js HTTP/2 ServerResponse.write() 方法

> 原文: [https://www.geeksforgeeks.org/node-js-http2serverresponse-write-method/](https://www.geeksforgeeks.org/node-js-http2serverresponse-write-method/)

`http2.ServerResponse.write()` 是 Http2 模块中 `Http2ServerResponse` 类的内置应用程序编程接口，用于将响应主体的块发送给客户端。
...
[https://nodejs.org/dist/latest-v12.x/docs/api/http2.html#http2_response_write_chunk_encoding_callback](https://nodejs.org/dist/latest-v12.x/docs/api/http2.html#http2_response_write_chunk_encoding_callback)