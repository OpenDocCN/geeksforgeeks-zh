...
> 原文: [https://www.geeksforgeeks.org/node-js-http-clientrequest-writableended-api/](https://www.geeksforgeeks.org/node-js-http-clientrequest-writableended-api/)
...
**返回值:** 当且仅当 `request.end()` 被调用时，此方法返回 `true`。
