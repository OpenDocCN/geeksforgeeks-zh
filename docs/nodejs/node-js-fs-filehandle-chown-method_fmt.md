...
> 原文: [https://www.geeksforgeeks.org/node-js-fs-filehandle-chown-method/](https://www.geeksforgeeks.org/node-js-fs-filehandle-chown-method/)

## 描述

`fs.filehandle.chown()` 方法是 `fs` 模块中类 `fs.FileHandle` 的内置应用编程接口，用于更改特定文件的所有权。
...
[https://nodejs.org/dist/latest-v12.x/docs/api/fs.html#fs_filehandle_chown_uid_gid](https://nodejs.org/dist/latest-v12.x/docs/api/fs.html#fs_filehandle_chown_uid_gid)