...
> 原文：`https://www.geeksforgeeks.org/node-js-server-address-method/`

`server.address()`是`tls`模块内类`Socket`的内置应用编程接口，用于获取服务器的绑定地址。
...
// Check if the authorization worked
  if (client.authorized) {
      console.log("Connection authorized by"
...
// console.log("Bound address : " + value)
...
**参考:** `https://nodejs.org/dist/latest-v12.x/docs/api/tls.html#tls_server_address`