...
> 原文: [https://www.geeksforgeeks.org/node-js-util-callbackify-method/](https://www.geeksforgeeks.org/node-js-util-callbackify-method/)

`util.callbackify()`方法是`util`模块的内置应用编程接口，用于运行异步函数并在 Node.js 中获取回调。
...
**参考:** [https://nodejs.org/api/util.html#util_util_callbackify_original](https://nodejs.org/api/util.html#util_util_callbackify_original)