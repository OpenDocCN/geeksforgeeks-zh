...
> 原文：[https://www.geeksforgeeks.org/node-js-zlib-creategunzip-method/](https://www.geeksforgeeks.org/node-js-zlib-creategunzip-method/)

## `zlib.createGunzip()`方法
...
**参考资料：**[https://nodejs.org/api/zlib.html#zlib_zlib_creategunzip_options](https://nodejs.org/api/zlib.html#zlib_zlib_creategunzip_options)