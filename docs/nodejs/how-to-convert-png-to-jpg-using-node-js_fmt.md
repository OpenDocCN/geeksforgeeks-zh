...
> 原文：[https://www.geeksforgeks.org/how-to-convert-png-to-jpg-using-node-js/](https://www.geeksforgeks.org/how-to-convert-png-to-jpg-using-node-js/)

下面的方法介绍了如何使用 `Jimp` 模块在 Node.js 中将 PNG 转换为 JPG。`Jimp` 是一个图像处理库，我们可以用它对图像进行很多操作。`Jimp` 代表 JavaScript 图像处理程序。

**方法：** 我们将采用以下步骤：

1.  在我们的应用程序中导入 `Jimp` 模块。
...
**步骤 3：** 获取一个示例 PNG 文件，对于本例，我们已经拍摄了下面的图像，并将其放置在 `static` 文件夹中。
