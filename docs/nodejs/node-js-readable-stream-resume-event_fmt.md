...
> 原文: [https://www.geeksforgeeks.org/node-js-readable-stream-resume-event/](https://www.geeksforgeeks.org/node-js-readable-stream-resume-event/)
...
如果可读则发出，如果调用 `resume()` 则不发出。

下面的例子说明了恢复事件在 Node.js 中的使用:
...
[https://nodejs.org/api/stream.html#stream_event_resume](https://nodejs.org/api/stream.html#stream_event_resume)