...
`console.debug()`方法是控制台模块的内置应用编程接口，用于将消息以换行符打印到`stdout`。类似于`console.log()`方法。
...
[https://nodejs.org/api/console.html#console_console_debug_data_args](https://nodejs.org/api/console.html#console_console_debug_data_args)