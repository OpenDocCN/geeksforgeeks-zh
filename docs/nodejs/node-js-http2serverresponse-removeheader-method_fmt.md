# Http2ServerResponse.removeHeader()方法

> 原文：[https://www.geeksforgeeks.org/node-js-http2serverresponse-removeheader-method/](https://www.geeksforgeeks.org/node-js-http2serverresponse-removeheader-method/)

`Http2ServerResponse.removeHeader()`是`http2`模块中类`Http2ServerResponse`的内置应用程序编程接口，用于删除已排队等待隐式发送的标头。
...
**参考：**[https://nodejs.org/dist/latest-v12.x/docs/api/http2.html#http2_response_removeheader_name](https://nodejs.org/dist/latest-v12.x/docs/api/http2.html#http2_response_removeheader_name)