...
> 原文: [https://www.geeksforgeeks.org/node-js-crypto-creatediffiehellmanprimelength-generator-method/](https://www.geeksforgeeks.org/node-js-crypto-creatediffiehellmanprimelength-generator-method/)

`crypto.createDiffieHellman()` 方法用于创建 DiffieHellman 密钥交换对象。此外，在可选的特定数字生成器的帮助下，创建 *素数* 位的素数。此外，如果没有定义生成器，则使用值 2。
...
**参考:** [https://nodejs.org/api/crypto.html#crypto_crypto_creatediffiehellman_primelength_generator](https://nodejs.org/api/crypto.html#crypto_crypto_creatediffiehellman_primelength_generator)