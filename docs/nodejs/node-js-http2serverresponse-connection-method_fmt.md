...
> 原文: [https://www.geeksforgeeks.org/node-js-http2serverresponse-connection-method/](https://www.geeksforgeeks.org/node-js-http2serverresponse-connection-method/)

`Http2ServerResponse.connection` 是 `http2` 模块内一个内置的类 `Http2ServerRequest` 的应用编程接口，用于获取网络的引用。套接字对象。
...
**参考:** [https://nodejs.org/dist/latest-v12.x/docs/api/http2.html#http2_response_connection](https://nodejs.org/dist/latest-v12.x/docs/api/http2.html#http2_response_connection)