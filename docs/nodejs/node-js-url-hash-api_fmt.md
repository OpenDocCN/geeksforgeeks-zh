...
`url.hash`是`url`模块中`URL`类的内置应用编程接口，用于获取和设置URL的片段部分。
...
**注意**:上述程序可以使用`node myapp.js`命令运行。

**参考:**
[https://nodejs.org/dist/latest-v10.x/docs/api/url.html#url_url_hash](https://nodejs.org/dist/latest-v10.x/docs/api/url.html#url_url_hash)