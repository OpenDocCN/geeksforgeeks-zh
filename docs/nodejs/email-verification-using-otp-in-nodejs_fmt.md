...
> 原文：[https://www.geeksforgeeks.org/email-verification-using-otp-in-nodejs/](https://www.geeksforgeeks.org/email-verification-using-otp-in-nodejs/)
...
*   自定义电子邮件标识用法：
    *   从包装中拉出 `LoginCredentials` 对象，并按下述方式使用它们。
    *   使用自定义电子邮件标识的先决条件：
