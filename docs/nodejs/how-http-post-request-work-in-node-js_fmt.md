...
> 原文: [https://www.geeksforgeeks.org/how-http-post-request-work-in-node-js/](https://www.geeksforgeeks.org/how-http-post-request-work-in-node-js/)
...
在这个语法中，路径是你必须发布从 HTML 中获取的数据的地方。获取数据可以使用 `body-parser` 包。
