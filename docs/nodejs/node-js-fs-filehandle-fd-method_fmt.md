...
> 原文: [https://www.geeksforgeeks.org/node-js-fs-filehandle-fd-method/](https://www.geeksforgeeks.org/node-js-fs-filehandle-fd-method/)

`fs.filehandle.fd()` 方法是 `fs` 模块中类 `fs.FileHandle` 的内置应用编程接口，用于提供该文件句柄对象的数字文件描述符。
...
下面的程序说明了 `fs.filehandle.fd()` 方法在 Node.js 中的使用。
...
**参考:** [https://nodejs.org/dist/latest-v12.x/docs/api/fs.html#fs_filehandle_fd](https://nodejs.org/dist/latest-v12.x/docs/api/fs.html#fs_filehandle_fd)