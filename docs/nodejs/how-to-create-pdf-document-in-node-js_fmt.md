...
> 原文：[https://www.geeksforgeeks.org/how-to-create-pdf-document-in-node-js/](https://www.geeksforgeeks.org/how-to-create-pdf-document-in-node-js/)
...
**PDF kit** – 这是一个内置模块，用于以非常简单和容易的方式在节点中生成 PDF 文档，我们可以制作图形、加载图像，还可以提供网站链接。
...
## 第二步：安装设置 NodeJS 环境的模块

我们还需要配置 `package.json` 文件。
...
这里是应该用 `app.js` 写的 JavaScript 代码，是给 NodeJS 用的。
