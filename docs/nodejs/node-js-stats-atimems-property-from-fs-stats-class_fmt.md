...
> 原文: [https://www.geeksforgeeks.org/node-js-stats-atimems-property-from-fs-stats-class/](https://www.geeksforgeeks.org/node-js-stats-atimems-property-from-fs-stats-class/)

`stats.atimeMs` 属性是 `fs` 的内置应用编程接口。`Stats` 类用于获取自 POSIX 纪元以来最后一次访问文件时的时间戳，以毫秒表示。
...
**参考资料:** [https://nodejs.org/api/fs.html#fs_stats_atimems](https://nodejs.org/api/fs.html#fs_stats_atimems)