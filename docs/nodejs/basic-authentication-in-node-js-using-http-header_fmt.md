...
> 原文：[https://www.geeksforgeeks.org/basic-authentication-in-node-js-using-http-header/](https://www.geeksforgeeks.org/basic-authentication-in-node-js-using-http-header/)
...
`HTTP WWW-Authenticate` 头是一个响应类型的头，它支持各种身份验证机制，这些机制对于控制对页面和其他资源的访问也很重要。
