# 用 Express 在 Node.js 中构建您的第一台路由器

> 原文: [https://www.geeksforgeeks.org/build-your-first-router-in-node-js-with-express/](https://www.geeksforgeeks.org/build-your-first-router-in-node-js-with-express/)
...
**步骤 2:** 现在我们将创建第二条路由，用于登录，并将处理“/login”URL。
