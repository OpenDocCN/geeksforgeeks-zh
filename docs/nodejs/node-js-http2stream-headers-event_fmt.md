...
> 原文: `https://www.geeksforgeeks.org/node-js-http2stream-headers-event/`

当接收到一个流的附加头块时，`http2` 服务器中的 `headers` 事件被发出。
...
`参考:` `https://nodejs.org/dist/latest-v12.x/docs/api/http2.html#http2_event_headers`