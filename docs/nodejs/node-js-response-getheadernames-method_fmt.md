...
> 原文：[https://www.geeksforgeeks.org/node-js-response-getheadernames-method/](https://www.geeksforgeeks.org/node-js-response-getheadernames-method/)
...
> 服务器正在端口 3000 上运行…
>
> > `[Object: null prototype] { alfa: 'Beta', alfa1: '', alfa2: 5, 'cookie-setup': [ 'Alfa=Beta', 'Beta=Romeo' ] }`
> >
...
> Hello Geeksforgeeks…，可用的标题和预告片有：{"Alfa1":"","cookie-setup":["Alfa = Beta","Beta = Romeo"],"content-type":"text/plain","trailer":"Content-MD5"}好的

**参考：**[https://nodejs.org/api/http.html#http_response_getheadernames](https://nodejs.org/api/http.html#http_response_getheadernames)