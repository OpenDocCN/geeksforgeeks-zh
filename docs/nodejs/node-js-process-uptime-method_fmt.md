...
> 原文: [https://www.geeksforgeeks.org/node-js-process-uptime-method/](https://www.geeksforgeeks.org/node-js-process-uptime-method/)

`process.uptime()` 方法是 `process` 模块的内置 API，用于获取 Node.js 进程运行的秒数。
...
[https://nodejs.org/api/process.html#process_process_uptime](https://nodejs.org/api/process.html#process_process_uptime)