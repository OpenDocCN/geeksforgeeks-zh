...
> 原文: [https://www.geeksforgeeks.org/how-to-setup-view-engine-in-node-js/](https://www.geeksforgeeks.org/how-to-setup-view-engine-in-node-js/)
...
2.  安装 `ejs` 后，您可以使用命令在命令提示符下检查您的 `ejs` 版本。
...
4.  要设置视图引擎，您需要在您的 `index.js` 中写入这个中间件，如下所示：
...
这就是如何在 Node.js 中设置视图引擎。还有许多其他的引擎存在，如车把，小胡子等。