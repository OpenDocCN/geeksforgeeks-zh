...
> 原文：[https://www.geeksforgeeks.org/how-to-get-post-data-in-node-js/](https://www.geeksforgeeks.org/how-to-get-post-data-in-node-js/)
...
### 第一步
[如果你的机器中没有安装 Node.js，安装 Node.js](https://www.geeksforgeeks.org/installation-of-node-js-on-windows/)。

### 步骤 2
为项目创建一个文件夹，并在其中创建了两个名为 `app.js` 和 `index.html` 的文件。

### 步骤 3
现在，使用命令行中的以下命令，用默认配置初始化一个新的 Node.js 项目。
