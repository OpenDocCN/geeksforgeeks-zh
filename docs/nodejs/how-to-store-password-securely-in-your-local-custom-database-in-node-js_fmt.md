...
> 原文：[https://www.geeksforgeeks.org/how-to-store-password-securely-in-your-local-custom-database-in-node-js/](https://www.geeksforgeeks.org/how-to-store-password-securely-in-your-local-custom-database-in-node-js/)
...
此示例说明了如何在本地数据库中安全地存储密码（Hashed+Salt）。
