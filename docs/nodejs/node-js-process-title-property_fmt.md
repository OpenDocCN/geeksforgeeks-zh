...
> 原文: [https://www.geeksforgeeks.org/node-js-process-title-property/](https://www.geeksforgeeks.org/node-js-process-title-property/)

## 流程标题属性

`流程标题属性`是`流程模块`的内置应用编程接口，用于获取和设置流程标题。
...
该属性返回一个指定进程标题的字符串值，当前值为`' ps '`。

### 注意

为该属性赋予新值将修改当前值。不同的平台可以对进程标题的最大长度施加限制。
...
[https://nodejs.org/api/process.html#process_process_title](https://nodejs.org/api/process.html#process_process_title)