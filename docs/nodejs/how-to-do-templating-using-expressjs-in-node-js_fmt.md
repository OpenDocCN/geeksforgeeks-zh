...
> 原文: [https://www.geeksforgeeks.org/how-to-do-templating-using-expressjs-in-node-js/](https://www.geeksforgeeks.org/how-to-do-templating-using-expressjs-in-node-js/)

## 模板引擎

一个模板引擎基本上帮助我们用最少的代码使用静态模板文件。在运行时，模板引擎在客户端用实际值替换所有变量。
