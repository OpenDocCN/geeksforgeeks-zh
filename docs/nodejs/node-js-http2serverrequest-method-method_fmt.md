# Node.js HTTP2 ServerRequest.method

> 原文: [https://www.geeksforgeeks.org/node-js-http2serverrequest-method-method/](https://www.geeksforgeeks.org/node-js-http2serverrequest-method-method/)

`http2ServerRequest.method` 是 `Http2` 模块内 `Http2ServerRequest` 类的内置应用程序编程接口，用于获取请求方法的字符串表示。
...
**参考:** [https://nodejs.org/dist/latest-v12.x/docs/api/http2.html#http2_request_method](https://nodejs.org/dist/latest-v12.x/docs/api/http2.html#http2_request_method)