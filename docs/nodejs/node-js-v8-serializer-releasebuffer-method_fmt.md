...
> 原文: [https://www.geeksforgeeks.org/node-js-v8-serializer-releasebuffer-method/](https://www.geeksforgeeks.org/node-js-v8-serializer-releasebuffer-method/)
...
下面的例子说明了 `v8` 的 `Serializer.releaseBuffer()` 方法在 Node.js 中的使用。
...
### 参考资料:
[https://nodejs.org/api/v8.html#v8_serializer_releasebuffer](https://nodejs.org/api/v8.html#v8_serializer_releasebuffer)