...
> 原文: [https://www.geeksforgeeks.org/how-to-deploy-a-machine-learning-model-using-node-js/](https://www.geeksforgeeks.org/how-to-deploy-a-machine-learning-model-using-node-js/)
...
为了训练模型，我们将使用 [谷歌可乐](https://colab.research.google.com)。它是一个我们可以运行所有 `python` 代码的平台，并且它装载了大多数使用的机器学习库。
