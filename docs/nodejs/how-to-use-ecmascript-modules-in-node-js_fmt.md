...
> 原文：[https://www.geeksforgeeks.org/how-to-use-ecmascript-modules-in-node-js/](https://www.geeksforgeeks.org/how-to-use-ecmascript-modules-in-node-js/)

**CommonJS** 模块由 `export` 和 `require()` 语句组成，而 **EcmaScript** 模块由 `import` 和 `export` 语句组成。
...
默认情况下，Node.js 将 js 代码视为 **CommonJS** 模块，但是可以使用 **EcmaScript** 模块来代替使用 `--experimental-modules` 标志。
