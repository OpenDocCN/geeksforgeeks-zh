...
> 哎哎哎: [https://www.geeksforgeeks.org/node-js-urlsearchparams-foreach/](https://www.geeksforgeeks.org/node-js-urlsearchparams-foreach/)

在 `URLSearchParams` 接口中，`forEach()` 方法返回一个迭代器，该迭代器允许在回调函数的帮助下遍历该对象中包含的所有值。
