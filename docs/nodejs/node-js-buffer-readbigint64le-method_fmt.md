...
> 原文: [https://www.geeksforgeeks.org/node-js-buffer-readbigint64le-method/](https://www.geeksforgeeks.org/node-js-buffer-readbigint64le-method/)

`Buffer.readBigInt64LE()`方法用于从给定偏移量的缓冲区对象中读取64位大整数，并以小端顺序返回结果。
...
**参考:** [https://nodejs.org/dist/latest-v12.x/docs/api/buffer.html#buffer_buf_readbigint64le_offset](https://nodejs.org/dist/latest-v12.x/docs/api/buffer.html#buffer_buf_readbigint64le_offset)