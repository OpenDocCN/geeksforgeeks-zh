...
> 原文: [https://www.geeksforgeeks.org/how-to-search-an-element-without-using-any-loops-in-node-js/](https://www.geeksforgeeks.org/how-to-search-an-element-without-using-any-loops-in-node-js/)
...
*   **timerFunction<Function>**: 是要执行的功能。
...
*   **interval**<*Function*>: 是下一个区间需要停止执行的函数名。
...
排序需要访问每个元素，然后执行一些操作，这需要 `for` 循环访问这些元素。
