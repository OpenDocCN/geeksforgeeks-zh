...
> 原文：[https://www.geeksforgeeks.org/node-js-process-warning-event/](https://www.geeksforgeeks.org/node-js-process-warning-event/)

**“警告”**是`process`模块中`Process`类的事件，每当 Node.js 发出过程警告时就会发出。
...
**参考：** [https://nodejs.org/dist/latest-v16.x/docs/api/process.html#process_event_warning](https://nodejs.org/dist/latest-v16.x/docs/api/process.html#process_event_warning)