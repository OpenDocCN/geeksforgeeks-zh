...
> 原文: [https://www.geeksforgeeks.org/node-js-mysql-length-function/](https://www.geeksforgeeks.org/node-js-mysql-length-function/)
...
`LENGTH()`函数接受单个参数，如下所述。

*   `input_string`: 我们将获取这个字符串的字符数。

## 返回值

`LENGTH()`函数以字节为单位返回给定字符串的长度。
