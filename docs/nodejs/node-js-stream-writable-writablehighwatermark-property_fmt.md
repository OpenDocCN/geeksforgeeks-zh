...
## 参考:
[https://nodejs . org/API/stream . html # stream _ writable _ writablehighwark](https://nodejs.org/api/stream.html#stream_writable_writablehighwatermark)