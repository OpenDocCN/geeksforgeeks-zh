...
> 原文: [https://www.geeksforgeeks.org/dockerizing-a-simple-node-js-app/](https://www.geeksforgeeks.org/dockerizing-a-simple-node-js-app/)

本文的目标是展示如何将 Node.js 应用程序放入 Docker 容器中。

*   首先，我们将创建一个示例节点应用程序。
*   构建该应用程序的 Docker 镜像并运行它。
...
现在添加 `.dockerignore` 文件，防止本地模块和日志被复制到 Docker 映像上，并添加这两个文件。
