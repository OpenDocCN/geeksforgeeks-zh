...
> 原文: [https://www.geeksforgeeks.org/node-js-writestream-getwindowsize-method/](https://www.geeksforgeeks.org/node-js-writestream-getwindowsize-method/)
...
该方法返回包含 `numColumns` 和 `numRows` 的 `[numColumns, numRows]` 类型的数组。
...
[https://nodejs.org/dist/latest-v12.x/docs/api/tty.html#tty_writestream_getwindowsize](https://nodejs.org/dist/latest-v12.x/docs/api/tty.html#tty_writestream_getwindowsize)