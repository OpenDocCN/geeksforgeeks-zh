...
> 原文：[https://www.geeksforgeeks.org/what-is-callback-hell-in-node-js/](https://www.geeksforgeeks.org/what-is-callback-hell-in-node-js/)
...
*   承诺有用。`then()`方法调用异步回调。我们可以链接任意多的回调，订单也得到严格维护。
