...
> 原文：[https://www.geeksforgeeks.org/node-js-console-groupcollapsed-method/](https://www.geeksforgeeks.org/node-js-console-groupcollapsed-method/)

`console.groupCollapsed()` 方法内置于 `console` 模块中，用于折叠分组内容，直到调用 `console.groupEnd()` 方法。它启动折叠的组，可以用 `groupEnd()` 方法结束。
...
**参考：** [https://nodejs.org/api/console.html#console_console_groupcollapsed](https://nodejs.org/api/console.html#console_console_groupcollapsed)