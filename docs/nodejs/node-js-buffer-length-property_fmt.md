...
> 原文: [https://www.geeksforgeeks.org/node-js-buffer-length-property/](https://www.geeksforgeeks.org/node-js-buffer-length-property/)
...
**参考:** [https://nodejs.org/dist/latest-v12.x/docs/api/buffer.html#buffer_buf_length](https://nodejs.org/dist/latest-v12.x/docs/api/buffer.html#buffer_buf_length)