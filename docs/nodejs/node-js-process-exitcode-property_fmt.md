...
> 原文：[https://www.geeksforgeeks.org/node-js-process-exitcode-property/](https://www.geeksforgeeks.org/node-js-process-exitcode-property/)
...
一种方法是将 exitcode 值传递给 `process.exit()` 函数。当未处理的未处理的致命异常发生时，使用退出代码 1，而当不再发生异步操作时，使用退出代码 0 终止。
