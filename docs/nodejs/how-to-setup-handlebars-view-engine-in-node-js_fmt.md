# 如何在 Node.js 中设置 Handlebars 视图引擎？

> 原文：[https://www.geeksforgeeks.org/how-to-setup-handlebars-view-engine-in-node-js/](https://www.geeksforgeeks.org/how-to-setup-handlebars-view-engine-in-node-js/)

Handlebars 是一个模板引擎，广泛使用，易于使用。这些页面包含 `.hbs` 扩展，市场上还有很多其他的模板引擎，比如 EJS、小胡子等。
...
4.  打开浏览器，输入这个网址：`http://localhost:8080/`。然后你会看到首页如下所示：
    ![HBS page demo](img/6489ac279812944a0faa4f5d321064af.png)

这就是如何在 `node.js` 中设置 Handlebars (`HBS`) 视图引擎。