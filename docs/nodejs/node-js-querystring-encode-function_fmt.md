...
> 原文: [https://www.geeksforgeeks.org/node-js-querystring-encode-function/](https://www.geeksforgeeks.org/node-js-querystring-encode-function/)
...
*   `options` : 是一个可以用来修改方法行为的对象。它具有以下参数:
...
**参考:** [https://nodejs.org/api/querystring.html#querystring_querystring_encode](https://nodejs.org/api/querystring.html#querystring_querystring_encode)