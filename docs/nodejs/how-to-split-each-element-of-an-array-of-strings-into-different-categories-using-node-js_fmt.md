...
> 原文: [https://www.geeksforgeeks.org/how-to-split-each-element-of-an-array-of-strings-into-different-categories-using-node-js/](https://www.geeksforgeeks.org/how-to-split-each-element-of-an-array-of-strings-into-different-categories-using-node-js/)
...
> **输入数组:** `const input = ['abc', 'def', 'ghi', 'jkl', 'mno', 'pqr', 'stw', 'xyz']`
>
> **类别数组:** `const categories = ['a', 'b', 'c']`
>
> **分割大小:** `const split_size = 3`
>
> **输出:**
>
> a: [ 'abc', 'def', 'ghi' ],
...
*   初始化一个存储类别的对象，并初始化一个保存类别索引的变量 `index`。
*   开始遍历数组，并根据 `split_size` 拆分。
*   将新的分割数组分配给给定的类别，增加 `index`。
