...
> 原文: [https://www.geeksforgeeks.org/how-to-render-plain-text-of-html-in-node-js/](https://www.geeksforgeeks.org/how-to-render-plain-text-of-html-in-node-js/)
...
**输出:** 打开浏览器，转到 `http://localhost:3000`，手动切换到 `http://localhost:3000/products`，会看到如下输出。
