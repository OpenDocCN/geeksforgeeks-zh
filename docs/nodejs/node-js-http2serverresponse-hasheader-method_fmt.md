# Node.js HTTP2 Server Response.hasHeader() 方法

> 原文: [https://www.geeksforgeeks.org/node-js-http2serverresponse-hasheader-method/](https://www.geeksforgeeks.org/node-js-http2serverresponse-hasheader-method/)

`Http2ServerResponse.hasHeader()` 是 `http2` 模块内的类 `Http2ServerResponse` 的内置 API，用于检查名称标识的标头当前是否设置在传出标头中。
...
**返回值:** 当且仅当名称标识的标头当前设置在传出标头中时，此方法返回真。
...
**参考:** [https://nodejs.org/dist/latest-v12.x/docs/api/http2.html#http2_response_hasheader_name](https://nodejs.org/dist/latest-v12.x/docs/api/http2.html#http2_response_hasheader_name)