...
> 原文：[https://www.geeksforgeeks.org/how-to-send-different-html-files-based-on-query-parameters-in-node-js/](https://www.geeksforgeeks.org/how-to-send-different-html-files-based-on-query-parameters-in-node-js/)

下面的方法介绍了如何根据 Node.js 中的查询参数发送不同的 HTML 文件。

## 方法

通过接收查询参数，将不同的 HTML 文件映射到各自的参数，可以轻松完成任务。

## 步骤

### 步骤 1

创建您的项目文件夹，并使用以下命令安装 `express` 模块：
...
在你的项目根目录下创建一个 `main.js` 文件，并在里面写下下面的代码。
