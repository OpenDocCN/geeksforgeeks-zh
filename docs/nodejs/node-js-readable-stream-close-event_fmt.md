...
> 原文：[https://www.geeksforgeeks.org/node-js-readable-stream-close-event/](https://www.geeksforgeeks.org/node-js-readable-stream-close-event/)
...
```js
// Node.js program to demonstrate the readable close event
