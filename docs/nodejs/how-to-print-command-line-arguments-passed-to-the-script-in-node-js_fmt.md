...
> 原文: [https://www.geeksforgeeks.org/how-to-print-command-line-arguments-passed-to-the-script-in-node-js/](https://www.geeksforgeeks.org/how-to-print-command-line-arguments-passed-to-the-script-in-node-js/)
...
## 第一步: 安装 Node.js
[如果你的机器上没有安装 Node.js](https://www.geeksforgeeks.org/installation-of-node-js-on-windows/)。
