...
> 原文：[https://www.geeksforgeeks.org/node-js-fs-mkdtempsync-method/](https://www.geeksforgeeks.org/node-js-fs-mkdtempsync-method/)
...
*   `Prefix`：将六个随机字符附加到前缀以创建唯一的临时目录。
*   `Option`：可选参数，可以是指定代码的字符串或具有 `code` 属性的对象，用于指定要使用的字符编码。
...
**参考：**[https://nodejs.org/api/fs.html#fs_fs_mkdtempsync_prefix_options](https://nodejs.org/api/fs.html#fs_fs_mkdtempsync_prefix_options)