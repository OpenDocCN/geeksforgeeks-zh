...
> 原文: [https://www.geeksforgeeks.org/how-to-share-code-between-node-js-and-the-browser/](https://www.geeksforgeeks.org/how-to-share-code-between-node-js-and-the-browser/)
...
在节点中，我们使用 `module.exports` 来公开功能或属性。但是，这将在浏览器中中断，因为浏览器无法识别 `exports`。因此，为了使它工作，我们检查 `exports` 是否被定义，如果没有，那么我们为导出函数创建一个合理的对象。在浏览器中，这可以通过创建一个与模块同名的全局变量来实现。
模块的结构如下所示:
