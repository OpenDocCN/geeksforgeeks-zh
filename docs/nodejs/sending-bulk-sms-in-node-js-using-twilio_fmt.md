...
> 原文: [https://www.geeksforgeeks.org/sending-bulk-sms-in-node-js-using-twilio/](https://www.geeksforgeeks.org/sending-bulk-sms-in-node-js-using-twilio/)
...
4.  Requiring module: 您需要使用以下代码行在文件中包含 twilio 模块。
