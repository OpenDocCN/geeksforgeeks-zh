...
> 原文：[https://www.geeksforgeeks.org/how-to-design-movie-telegram-bot-using-node-js/](https://www.geeksforgeeks.org/how-to-design-movie-telegram-bot-using-node-js/)
...
`node-telegram-bot-api` 模块与官方 Telegram Bot API 进行交互。
