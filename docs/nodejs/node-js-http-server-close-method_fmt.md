...
> 原文: [https://www.geeksforgeeks.org/node-js-http-server-close-method/](https://www.geeksforgeeks.org/node-js-http-server-close-method/)
...
[https://nodejs.org/dist/latest-v12.x/docs/api/http.html#http_server_close_callback](https://nodejs.org/dist/latest-v12.x/docs/api/http.html#http_server_close_callback)