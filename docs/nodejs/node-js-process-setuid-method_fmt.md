...
> 原文: [https://www.geeksforgeeks.org/node-js-process-setuid-method/](https://www.geeksforgeeks.org/node-js-process-setuid-method/)

`process.setuid()`方法是流程模块的内置应用编程接口，用于设置 Node.js 流程的用户身份。
...
下面的例子说明了 `process.setuid()`方法在 Node.js 中的使用:
...
**参考:** [https://nodejs.org/api/process.html#process_process_setuid_id](https://nodejs.org/api/process.html#process_process_setuid_id)