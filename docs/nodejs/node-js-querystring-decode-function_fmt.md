...
> 原文：[`https://www.geeksforgeeks.org/node-js-querystring-decode-function/`](https://www.geeksforgeeks.org/node-js-querystring-decode-function/)
...
**参考:** [`https://nodejs.org/api/querystring.html#querystring_querystring_decode`](https://nodejs.org/api/querystring.html#querystring_querystring_decode)