# Node.js HTTP2 ServerRequest.rawHeaders 方法

> 原文: [https://www.geeksforgeeks.org/node-js-http2serverrequest-rawheaders-method/](https://www.geeksforgeeks.org/node-js-http2serverrequest-rawheaders-method/)

`http2ServerRequest.rawHeaders` 是 Http2 模块中 `Http2ServerRequest` 类的内置应用程序编程接口，用于获取原始请求/响应头，以便在收到它们时准确列出。
...
**参考:** [https://nodejs.org/dist/latest-v12.x/docs/api/http2.html#http2_request_rawheaders](https://nodejs.org/dist/latest-v12.x/docs/api/http2.html#http2_request_rawheaders)