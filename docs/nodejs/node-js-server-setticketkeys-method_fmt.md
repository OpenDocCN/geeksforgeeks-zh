...
> 原文：[https://www.geeksforgeeks.org/node-js-server-setticketkeys-method/](https://www.geeksforgeeks.org/node-js-server-setticketkeys-method/)

`server.setTicketKeys(keys)` 是 `tls` 模块内 `Socket` 类的内置应用编程接口，用于设置包含会话票证密钥的 48 字节缓冲区。
...
[https://nodejs.org/dist/latest-v12.x/docs/api/tls.html#tls_server_setticketkeys_keys](https://nodejs.org/dist/latest-v12.x/docs/api/tls.html#tls_server_setticketkeys_keys)