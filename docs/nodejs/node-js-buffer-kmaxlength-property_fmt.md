...
> 原文: [https://www.geeksforgeeks.org/node-js-buffer-kmaxlength-property/](https://www.geeksforgeeks.org/node-js-buffer-kmaxlength-property/)
...
这个属性作为一个 getter 和 setter 工作，所以它有时会将整数值作为一个参数。
...
**参考:** [https://nodejs.org/dist/latest-v12.x/docs/api/buffer.html#buffer_buffer_kmaxlength](https://nodejs.org/dist/latest-v12.x/docs/api/buffer.html#buffer_buffer_kmaxlength)