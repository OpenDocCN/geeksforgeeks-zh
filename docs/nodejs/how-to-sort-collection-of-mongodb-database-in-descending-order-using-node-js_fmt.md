...
> 原文：[https://www.geeksforgeeks.org/how-to-sort-collection-of-mongodb-database-in-descending-order-using-node-js/](https://www.geeksforgeeks.org/how-to-sort-collection-of-mongodb-database-in-descending-order-using-node-js/)
...
**`sort()` 方法**用于对文档进行排序。此方法用于定义文件的顺序。
