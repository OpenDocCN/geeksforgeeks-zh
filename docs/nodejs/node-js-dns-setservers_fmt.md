...
## 参考:
[https://nodejs.org/docs/latest-v9.x/api/dns.html#dns_dns_setservers_servers](https://nodejs.org/docs/latest-v9.x/api/dns.html#dns_dns_setservers_servers)