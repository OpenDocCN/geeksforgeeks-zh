...
> 哎哎哎: [https://www.geeksforgeeks.org/node-js-OS-eol/](https://www.geeksforgeeks.org/node-js-OS-eol/)

`os.EOL` 常量是 `os` 模块的内置应用编程接口，用于获取操作系统指定的行尾字符或标记。
...
下面的例子说明了 Node.js 中 `os.EOL` 常数的使用:
...
**参考资料:** [https://nodejs.org/api/os.html#os_os_eol](https://nodejs.org/api/os.html#os_os_eol)