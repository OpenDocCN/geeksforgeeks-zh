...
`blur()` 函数是 GraphicsMagick 库中的一个内置函数，用于给图像添加模糊滤镜。该函数在成功时返回真值。
...
*   [http://www.graphicsmagick.org/GraphicsMagick.html#details-blur](http://www.graphicsmagick.org/GraphicsMagick.html#details-blur)
