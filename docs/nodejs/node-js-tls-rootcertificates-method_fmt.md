# Node.js `tls.rootCertificates()` 方法

> 原文：[https://www.geeksforgeeks.org/node-js-tls-rootcertificates-method/](https://www.geeksforgeeks.org/node-js-tls-rootcertificates-method/)

`tls.rootCertificates()` 方法是 `tls` 模块中类 TLS 的内置应用程序编程接口，用于返回表示根证书的字符串数组。
...
**参考：** [https://nodejs.org/dist/latest-v12.x/docs/api/tls.html#tls_tls_rootcertificates](https://nodejs.org/dist/latest-v12.x/docs/api/tls.html#tls_tls_rootcertificates)