...
> 原文：[https://www.geeksforgeeks.org/how-to-automatically-build-the-package-json-file-for-node-js-projects/](https://www.geeksforgeeks.org/how-to-automatically-build-the-package-json-file-for-node-js-projects/)
...
首先，我们将学习如何在 NodeJS 中手动构建 `package.json` 文件。现在，只要我们在 Visual Studio 代码编辑器中打开一个文件夹，当我们键入以下代码时，就可以打开终端：
