...
> 原文: [https://www.geeksforgeeks.org/how-to-connect-node-js-application-to-mysql/](https://www.geeksforgeeks.org/how-to-connect-node-js-application-to-mysql/)
...
*   首先，在你机器的特定文件夹中初始化 node.js 项目。
*   在项目文件夹中下载 `mysql` 模块。
*   之后，使用 `mysql` 模块的 `createConnection()` 方法创建到数据库的连接。
