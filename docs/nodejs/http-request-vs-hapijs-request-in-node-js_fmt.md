...
> 原文: [https://www.geeksforgeeks.org/http-request-vs-hapijs-request-in-node-js/](https://www.geeksforgeeks.org/http-request-vs-hapijs-request-in-node-js/)
...
上面的语法导入了“哈比神”模块，现在它创建了一个服务器。它与客户端和服务器通信请求和响应。需要 PORT <号>和主机<串>进行通信。
