...
> 原文: [https://www.geeksforgeeks.org/node-js-http-server-maxheaderscount-property/](https://www.geeksforgeeks.org/node-js-http-server-maxheaderscount-property/)

`http.Server.maxHeadersCount` 是 HTTP 模块内 `Server` 类的内置 API，用于获取最大传入头数。
...
**参考:** [https://nodejs.org/dist/latest-v12.x/docs/api/http.html#http_server_maxheaderscount](https://nodejs.org/dist/latest-v12.x/docs/api/http.html#http_server_maxheaderscount)