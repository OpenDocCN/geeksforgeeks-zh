...
> 原文: [https://www.geeksforgeeks.org/node-js-urlsearchparams-get-method/](https://www.geeksforgeeks.org/node-js-urlsearchparams-get-method/)
...
下面的程序说明了在 Node.js 中 `URLSearchParams.get()` 方法的使用:
...
**参考:** [https://nodejs.org/dist/latest-v14.x/docs/api/url.html#url_urlsearchparams_get_name](https://nodejs.org/dist/latest-v14.x/docs/api/url.html#url_urlsearchparams_get_name)