# Node.js 中的 `fs.Stats.nlink` 属性

> 原文：[https://www.geeksforgeeks.org/node-js-stats-nlink-property-from-fs-stats-class/](https://www.geeksforgeeks.org/node-js-stats-nlink-property-from-fs-stats-class/)

`stats.nlink` 属性是 `fs` 内置应用编程接口的一部分，用于获取文件硬链接数量的 `Stats` 类。
...
[https://nodejs.org/api/fs.html#fs_stats_nlink](https://nodejs.org/api/fs.html#fs_stats_nlink)