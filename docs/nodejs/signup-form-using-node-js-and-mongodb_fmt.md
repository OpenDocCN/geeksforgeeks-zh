...
> 原文：[https://www.geeksforgeeks.org/signup-form-using-node-js-and-mongodb/](https://www.geeksforgeeks.org/signup-form-using-node-js-and-mongodb/)

## 安装
首先，我们需要为我们的 Node.js 应用程序包含几个包。
...
如果你想读取 HTTP POST 数据，你必须使用 `body-parser` 节点模块。
...
该记录现在保存在 `details` 集合中的 `gfg` 数据库中。