...
> 原文：[https://www.geeksforgeeks.org/node-js-tls-default_min_version-method/](https://www.geeksforgeeks.org/node-js-tls-default_min_version-method/)

`tls.DEFAULT_MIN_VERSION` 是 `tls` 模块内 TLS 类的内置 API，用于返回 `tls.createSecureContext()` 的 `minVersion` 选项的默认值。
...
**参考：** [https://nodejs.org/dist/latest-v12.x/docs/api/tls.html#tls_tls_default_min_version](https://nodejs.org/dist/latest-v12.x/docs/api/tls.html#tls_tls_default_min_version)