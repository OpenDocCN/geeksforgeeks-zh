...
> 原文: [https://www.geeksforgeeks.org/node-js-mysql-select-from-table/](https://www.geeksforgeeks.org/node-js-mysql-select-from-table/)

## 简介
了解使用 `node.js` 从 `MySQL` 数据库中选择数据，我们将使用标准的 `SELECT FROM` SQL 查询。
