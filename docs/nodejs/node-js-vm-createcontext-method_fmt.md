...
> 原文：[https://www.geeksforgeeks.org/node-js-vm-createcontext-method/](https://www.geeksforgeeks.org/node-js-vm-createcontext-method/)
...
下面的例子说明了 `createContext()` 方法在 Node.js 中的使用：
...
[https://nodejs.org/api/vm.html#vm_vm_createcontext_contextobject_options](https://nodejs.org/api/vm.html#vm_vm_createcontext_contextobject_options)