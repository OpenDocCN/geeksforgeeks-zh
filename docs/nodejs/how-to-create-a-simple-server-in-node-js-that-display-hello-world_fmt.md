...
> 原文：[https://www.geeksforgeeks.org/how-to-create-a-simple-server-in-node-js-that-display-hello-world/](https://www.geeksforgeeks.org/how-to-create-a-simple-server-in-node-js-that-display-hello-world/)
...
使用以下命令安装 *express* 模块，该模块是 NodeJS 的 web 框架。
