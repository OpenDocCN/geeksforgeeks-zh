...
## 优点
Node.js 语法容易处理，有 Python 或 C++背景的人很容易习惯。nodejs 中的编译时间比其他任何东西都快。
...
async function main() {
  const image1 = await Jimp.read('https://media.geeksforgeeks.org/wp-content/uploads/20190328185307/gfg28.png');
  const image2 = await Jimp.read('https://media.geeksforgeeks.org/wp-content/uploads/20190328185333/gfg111.png');
