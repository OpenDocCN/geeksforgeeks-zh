...
> 原文：[https://www.geeksforgeeks.org/how-to-do-compression-with-gzip-in-node-js/](https://www.geeksforgeeks.org/how-to-do-compression-with-gzip-in-node-js/)
...
**步骤 3：** 在项目的根目录下创建一个文件，并命名 `index.js` 并编写以下代码。
