...
> 原文：[https://www.geeksforgeeks.org/how-to-run-node-js-program-as-an-executable/](https://www.geeksforgeeks.org/how-to-run-node-js-program-as-an-executable/)

将 Node.js 程序作为可执行文件运行意味着我们不必去程序目录，从终端的任何地方，我们都可以用一个特定的自注册字来执行我们的程序。
