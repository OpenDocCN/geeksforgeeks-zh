...
> 原文：[https://www.geeksforgeeks.org/how-set-default-timezone-in-node-js-for-windows/](https://www.geeksforgeeks.org/how-set-default-timezone-in-node-js-for-windows/)
...
### 2. 使用 `new Date().toLocaleString()` 设置变量
