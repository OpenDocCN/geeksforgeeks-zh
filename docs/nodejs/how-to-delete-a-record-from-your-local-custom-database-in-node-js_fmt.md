...
> 原文：[https://www.geeksforgeeks.org/how-to-delete-a-record-from-your-local-custom-database-in-node-js/](https://www.geeksforgeeks.org/how-to-delete-a-record-from-your-local-custom-database-in-node-js/)
...
### 文件名：`repository.js` 文件

该文件包含删除自定义数据库记录的所有逻辑。
