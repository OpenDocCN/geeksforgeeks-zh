...
> 原文: [https://www.geeksforgeeks.org/node-js-fs-dirent-name-property/](https://www.geeksforgeeks.org/node-js-fs-dirent-name-property/)

`fs.Dirent.name` 属性是 `fs` 模块中 `Dirent` 类的内置属性，用于提供特定目录条目的名称。
...
下面的程序说明了 `fs.Dirent.name` 属性在 Node.js 中的使用：
...
**参考:** [https://nodejs.org/dist/latest-v12.x/docs/api/fs.html#fs_fs_dirent_name](https://nodejs.org/dist/latest-v12.x/docs/api/fs.html#fs_fs_dirent_name)