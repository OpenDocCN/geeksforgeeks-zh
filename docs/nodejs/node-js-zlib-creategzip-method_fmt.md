...
> 原文：[https://www.geeksforgeeks.org/node-js-zlib-creategzip-method/](https://www.geeksforgeeks.org/node-js-zlib-creategzip-method/)

`zlib.createGzip()`方法是`zlib`模块的内置应用编程接口，用于创建一个新的 Gzip 对象。
...
该方法接受单参数`options`，这是保存`zlib`选项的可选参数。
...
[https://nodejs.org/api/zlib.html#zlib_zlib_creategzip_options](https://nodejs.org/api/zlib.html#zlib_zlib_creategzip_options)