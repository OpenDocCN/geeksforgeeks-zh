...
> 原文：[https://www.geeksforgeeks.org/node-js-zlib-createdeflate-method/](https://www.geeksforgeeks.org/node-js-zlib-createdeflate-method/)

`zlib.createDeflate()`方法是`zlib`模块的内置应用编程接口，用于创建新的`Deflate`对象。
...
下面的例子说明了在Node.js中使用`zlib.createDeflate()`方法：
...
[https://nodejs.org/api/zlib.html#zlib_zlib_createdeflate_options](https://nodejs.org/api/zlib.html#zlib_zlib_createdeflate_options)