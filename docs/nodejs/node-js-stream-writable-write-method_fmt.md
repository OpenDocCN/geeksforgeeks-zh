...
> 原文: [https://www.geeksforgeeks.org/node-js-stream-writable-write-method/](https://www.geeksforgeeks.org/node-js-stream-writable-write-method/)

`write.write()`方法是 Stream 模块的内置应用编程接口，用于将一些数据写入可写流。一旦数据被完全处理，就调用回调函数。
...
**参考:** [https://nodejs.org/api/stream.html#stream_writable_write_chunk_encoding_callback](https://nodejs.org/api/stream.html#stream_writable_write_chunk_encoding_callback)