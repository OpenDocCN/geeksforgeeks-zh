...
> 原文: [https://www.geeksforgeeks.org/node-js-assert-deepequal-function/](https://www.geeksforgeeks.org/node-js-assert-deepequal-function/)
...
[https://nodejs.org/dist/latest-v12.x/docs/api/assert.html#assert_assert_deepequal_actual_expected_message](https://nodejs.org/dist/latest-v12.x/docs/api/assert.html#assert_assert_deepequal_actual_expected_message)