...
## 返回值:
当且仅当此 PEM 编码的 X509 证书是证书颁发机构(ca)证书时，此属性返回布尔值 `true`。
...
**参考**:[https://nodejs.org/dist/latest-v15.x/docs/api/crypto.html#crypto_x509_ca](https://nodejs.org/dist/latest-v15.x/docs/api/crypto.html#crypto_x509_ca)