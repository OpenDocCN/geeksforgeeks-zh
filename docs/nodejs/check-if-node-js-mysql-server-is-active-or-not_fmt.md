...
> 原文: [https://www.geeksforgeeks.org/check-if-node-js-mysql-server-is-active-or-not/](https://www.geeksforgeeks.org/check-if-node-js-mysql-server-is-active-or-not/)
...
7.  **输出:** 将此链接放入浏览器 `http://localhost:5000/getMysqlStatus`
