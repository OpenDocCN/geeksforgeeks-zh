...
> 原文：[https://www.geeksforgeeks.org/how-to-list-npm-user-installed-packages-in-node-js/](https://www.geeksforgeeks.org/how-to-list-npm-user-installed-packages-in-node-js/)
...
要放弃依赖项列表，请使用：`$ npm list -g --depth=0`

示例输出：

![](img/d27ff5083ea2f63e549f05069b5c4090.png)

要检查是否全局安装了特定的包，请执行：`npm list -g [包名]`
