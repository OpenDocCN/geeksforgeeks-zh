...
> 原文: [https://www.geeksforgeeks.org/node-js-socket-setmulticastttl-method/](https://www.geeksforgeeks.org/node-js-socket-setmulticastttl-method/)
...
该方法取整数值，表示允许数据包通过指定多播流量的 IP 跳数。
...
[https://nodejs.org/dist/latest-v12.x/docs/api/dgram.html#dgram_socket_setmulticastttl_ttl](https://nodejs.org/dist/latest-v12.x/docs/api/dgram.html#dgram_socket_setmulticastttl_ttl)