...
> 原文：[https://www.geeksforgeeks.org/node-js-http2serverrequest-rawtrailers-method/](https://www.geeksforgeeks.org/node-js-http2serverrequest-rawtrailers-method/)

`http2ServerRequest.rawTrailers` 是 Http2 模块中 `Http2ServerRequest` 类的内置应用程序编程接口，用于在收到原始请求/响应拖车键和值时获取它们。
...
**参考：** [https://nodejs.org/dist/latest-v12.x/docs/api/http2.html#http2_request_rawtrailers](https://nodejs.org/dist/latest-v12.x/docs/api/http2.html#http2_request_rawtrailers)