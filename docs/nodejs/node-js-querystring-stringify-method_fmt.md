...
> 原文：[https://www.geeksforgeeks.org/node-js-querystring-stringify-method/](https://www.geeksforgeeks.org/node-js-querystring-stringify-method/)

`querystring.stringify()` 方法用于从包含键值对的给定对象中生成一个网址查询字符串。方法迭代对象自身的属性以生成查询字符串。
...
**参考：**[https://nodejs.org/api/querystring.html#querystring_querystring_stringify_obj_sep_eq_options](https://nodejs.org/api/querystring.html#querystring_querystring_stringify_obj_sep_eq_options)