# 从 Node.js 使用 PythonShell 运行 Python 脚本

> 原文：[https://www.geeksforgeeks.org/run-python-script-using-pythonshell-from-node-js/](https://www.geeksforgeeks.org/run-python-script-using-pythonshell-from-node-js/)
