...
> 原文: [https://www.geeksforgeeks.org/node-js-diffiehellman-getprivatekey-method/](https://www.geeksforgeeks.org/node-js-diffiehellman-getprivatekey-method/)

`DiffieHellman.getPrivateKey()`方法是加密模块中类`DiffieHellman`的内置应用编程接口，用于返回`dh`对象的私钥。
...
**参考:** [https://nodejs.org/api/crypto.html#crypto_diffiehellman_getprivatekey_encoding](https://nodejs.org/api/crypto.html#crypto_diffiehellman_getprivatekey_encoding)