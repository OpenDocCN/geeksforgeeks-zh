...
> 原文: [https://www.geeksforgeeks.org/node-js-process-config-property/](https://www.geeksforgeeks.org/node-js-process-config-property/)

`process.config` 属性是 `process` 模块的内置 API，用于获取用于编译当前 Node.js 代码的配置选项的 JavaScript 表示。
...
该属性返回一个对象，该对象包含用于编译当前可执行 Node.js 的 JavaScript 表示形式的配置。
...
[https://nodejs.org/api/process.html#process_process_config](https://nodejs.org/api/process.html#process_process_config)