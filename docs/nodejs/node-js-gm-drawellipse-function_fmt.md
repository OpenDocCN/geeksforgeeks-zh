# Node.js GM drawEllipse() 函数

> 原文: [https://www.geeksforgeeks.org/node-js-gm-drawellipse-function/](https://www.geeksforgeeks.org/node-js-gm-drawellipse-function/)

`drawEllipse()` 函数是 GraphicsMagick 库中的一个内置函数，用于绘制具有指定坐标的椭圆。该函数在成功时返回真值。
