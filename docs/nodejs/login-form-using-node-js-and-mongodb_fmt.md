...
> 原文: [https://www.geeksforgeeks.org/login-form-using-node-js-and-mongodb/](https://www.geeksforgeeks.org/login-form-using-node-js-and-mongodb/)
...
*   Passport 是节点的认证中间件。Passport 非常灵活和模块化，可以不引人注目地插入到任何基于 Express 的网络应用程序中。一套全面的策略支持使用用户名和密码、脸书、推特等进行身份验证。
