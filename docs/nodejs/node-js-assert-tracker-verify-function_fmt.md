...
> 原文：`https://www.geeksforgeeks.org/node-js-assert-tracker-verify-function/`
...
**参考：** [https://nodejs.org/api/assert.html#assert_tracker_verify](https://nodejs.org/api/assert.html#assert_tracker_verify)