...
一个`process`对象是全局对象，所以可以从任何地方访问。因为它是一个预定义的库，所以我们不必在全球范围内将其下载到我们的系统中。
...
**参考:**[https://nodejs.org/api/process.html#process_process](https://nodejs.org/api/process.html#process_process)