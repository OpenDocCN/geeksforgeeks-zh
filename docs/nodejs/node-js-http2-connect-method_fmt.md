...
这个方法返回 `ClientHttp2Session` 实例的对象。

## 如何生成私钥和公钥证书？

**1. 文件名: 私钥**
打开记事本复制粘贴以下密钥，将文件保存为 `私钥`

**2. 文件名: 公共证书**
打开记事本复制粘贴以下密钥，将文件保存为 `公共证书 pem`
...
**参考:** [https://nodejs.org/dist/latest-v12.x/docs/api/http2.html#http2_http2_connect_authority_options_listener](https://nodejs.org/dist/latest-v12.x/docs/api/http2.html#http2_http2_connect_authority_options_listener)