# `path.toNamespacedPath()`方法

> 原文：[https://www.geeksforgeeks.org/node-js-path-tonamespacedpath-method/](https://www.geeksforgeeks.org/node-js-path-tonamespacedpath-method/)
...
* `Path`：它是一个字符串，包含必须转换的路径。

## 返回值

它返回一个字符串，该字符串具有等效的命名空间前缀路径。
...
[https://nodejs.org/api/path.html#path_path_tonamespacedpath_path](https://nodejs.org/api/path.html#path_path_tonamespacedpath_path)