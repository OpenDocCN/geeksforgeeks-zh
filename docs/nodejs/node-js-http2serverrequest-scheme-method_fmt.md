...
> 原文：[https://www.geeksforgeeks.org/node-js-http2serverrequest-scheme-method/](https://www.geeksforgeeks.org/node-js-http2serverrequest-scheme-method/)

`Http2ServerRequest.scheme`是`http2`模块内`Http2ServerRequest`类的内置应用编程接口，用于获取指示目标网址的方案部分的请求方案伪头字段。
...
**参考：** [https://nodejs.org/dist/latest-v12.x/docs/api/http2.html#http2_request_scheme](https://nodejs.org/dist/latest-v12.x/docs/api/http2.html#http2_request_scheme)