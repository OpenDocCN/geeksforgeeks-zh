...
`__dirname` 字符串给出了当前模块的目录路径，这也类似于文件名的 `path.dirname()` 的路径。
...
**参考:** [https://nodejs.org/docs/latest/api/globals.html#globals_dirname](https://nodejs.org/docs/latest/api/globals.html#globals_dirname)