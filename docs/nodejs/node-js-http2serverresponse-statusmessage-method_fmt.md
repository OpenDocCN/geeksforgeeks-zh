...
> 原文: [https://www.geeksforgeeks.org/node-js-http2serverresponse-statusmessage-method/](https://www.geeksforgeeks.org/node-js-http2serverresponse-statusmessage-method/)

`Http2ServerResponse.statusMessage` 是 HTTP/2 模块内 `Http2ServerResponse` 类的内置应用程序编程接口，用于返回空字符串，因为它不受 HTTP/2 (RFC 7540 8.1.2.4)的支持。
...
**参考:** [https://nodejs.org/dist/latest-v12.x/docs/api/http2.html#http2_response_statusmessage](https://nodejs.org/dist/latest-v12.x/docs/api/http2.html#http2_response_statusmessage)