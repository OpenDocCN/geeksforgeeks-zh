...
> 原文：[https://www.geeksforgeeks.org/node-js-crypto-scryptsync-function/](https://www.geeksforgeeks.org/node-js-crypto-scryptsync-function/)
...
*   `options`：类型为 `Object`，有七个参数，分别是 `cost`、`blockSize`、`parallelization`、`N`、`r`、`p`、`maxmem`。
