...
> 原文：[https://www.geeksforgeeks.org/how-to-send-email-using-mailgun-api-in-node-js/](https://www.geeksforgeeks.org/how-to-send-email-using-mailgun-api-in-node-js/)
...
1.  您可以访问[安装 Mailgun 模块](https://www.npmjs.com/package/mailgun-js)的链接。您可以使用以下命令安装此软件包。

```js
npm install mailgun-js
```

2.  安装 `mailgun-js` 后，您可以使用命令在命令提示符下检查您的 `mailgun-js` 版本。
...
4.  **需要模块：** 您需要使用这些行在您的文件中包含 `mailgun-js` 模块。
