...
> 原文: [https://www.geeksforgeeks.org/introduction-about-node-js-and-mongodb/](https://www.geeksforgeeks.org/introduction-about-node-js-and-mongodb/)
...
要使用 MongoDB，需要安装 `mongoose` 模块。

### 安装猫鼬:

打开命令提示符或终端，输入以下命令，安装 `mongoose` 模块
...
*   使用数据库功能，创建到 `admin` 数据库的连接。
*   出现在 `geeks4geeks` 集合中的所有文档都被检索并显示在控制台中。

**注意:** 这里使用的是管理数据库，里面包含了 `geeks4geeks` 的集合，里面有一些文档。
