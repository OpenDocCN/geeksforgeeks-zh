...
`` `httpServerResponse.socket`` 是 [http](https://www.geeksforgeeks.org/node-js-http-module/#:~:text=The%20HTTP%20module%20creates%20an,with%20the%20help%20of%20http.) 模块中类 `ServerResponse` 的内置应用编程接口，用于获取底层 `socket` 对象的引用。
...
**参考**: [https://nodejs.org/dist/latest-v12.x/docs/api/http.html#http_response_socket](https://nodejs.org/dist/latest-v12.x/docs/api/http.html#http_response_socket)