...
> 原文: [https://www.geeksforgeeks.org/node-js-diffiehellman-getprime-method/](https://www.geeksforgeeks.org/node-js-diffiehellman-getprime-method/)
...
返回指定编码的 DiffieHellman 质数。如果不提供编码，则返回缓冲区，否则返回字符串。
...
[https://nodejs.org/api/crypto.html#crypto_diffiehellman_getprime_encoding](https://nodejs.org/api/crypto.html#crypto_diffiehellman_getprime_encoding)