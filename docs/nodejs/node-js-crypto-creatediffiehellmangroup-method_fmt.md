...
> 原文：[https://www.geeksforgeeks.org/node-js-crypto-creatediffiehellmangroup-method/](https://www.geeksforgeeks.org/node-js-crypto-creatediffiehellmangroup-method/)

`crypto.createDiffieHellmanGroup()`方法是用于创建 DiffieHellman group 的加密模块的内置应用程序编程接口。
...
参考：[https://nodejs.org/api/crypto.html#crypto_crypto_creatediffiehellmangroup_name](https://nodejs.org/api/crypto.html#crypto_crypto_creatediffiehellmangroup_name)