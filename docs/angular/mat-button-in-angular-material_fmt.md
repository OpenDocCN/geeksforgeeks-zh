...
> 原文: [https://www.geeksforgeeks.org/mat-button-in-angular-material/](https://www.geeksforgeeks.org/mat-button-in-angular-material/)
...
角材中出现的按钮称为`<mat-button>`。它们是许多类型的垫子按钮，有角形材料，它们是:

| **按钮名称** | **按钮所使用的标签** | **解释** |
| :--- | :--- | :--- |
| 基本按钮 | `<mat-button>` | They have a frame-shadow. |
| 描边按钮 | `<mat-raised-button>` | These buttons do not have any background theme color. |
| 扁平按钮 | `<mat-flat-button>` | These buttons are very flat, that is, they don't have any kind of animation, only ripple effect. |
