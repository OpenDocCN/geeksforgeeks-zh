...
> 原文：`https://www.geeksforgeeks.org/angularjs-window-service/`
...
<body ng-app="windowService">
    ...
    <div ng-controller="windowServiceController">
        <button ng-click="alertBox()">Show Alert Box</button>
    </div>
    <script>
...
<body ng-app="windowService">
    ...
    <div ng-controller="windowServiceController">
        <button ng-click="promptBox()">Show Prompt Box</button>
        <p>{{fullname}}</p>
    </div>
    <script>
        var app = angular.module('windowService', []);
...
<body ng-app="windowService">
    ...
    <div ng-controller="windowServiceController">
        <button ng-click="confirmBox()">Show Confirm Box</button>
        <p>{{confirmMessage}}</p>
    </div>
    <script>
        var app = angular.module('windowService', []);
