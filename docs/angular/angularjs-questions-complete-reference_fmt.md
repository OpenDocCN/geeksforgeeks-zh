...
> 原文：[https://www.geeksforgeeks.org/angularjs-questions-complete-reference/](https://www.geeksforgeeks.org/angularjs-questions-complete-reference/)
...
*   [Bootstrap 和 AngularJS 的区别](https://www.geeksforgeeks.org/difference-between-bootstrap-and-angularjs/)
*   [NodeJS 和 AngularJS 的区别](https://www.geeksforgeeks.org/difference-between-nodejs-and-angularjs/)
*   [VueJS 和 AngularJS 的区别](https://www.geeksforgeeks.org/difference-between-vuejs-and-angularjs/)
...
*   [`ngRoute` 和 `ui-router` 有什么区别？](https://www.geeksforgeeks.org/difference-between-ngroute-and-ui-router/)
...
*   [`ng-class` 和 `ng-style` 如何结合？](https://www.geeksforgeeks.org/how-to-combine-ng-class-with-ng-style/)
...
*   [我们为什么要用 `$rootScope.$broadcast`？](https://www.geeksforgeeks.org/why-do-we-use-rootscope-broadcast-in-angularjs/)
*   [如何在 AngularJS 中迭代对象的过滤(`ng-repeat filter`)集合？](https://www.geeksforgeeks.org/how-to-iterate-over-filtered-collection-of-objects-in-angularjs/)

# AngularJS 常见问题与解答

*   [如何在 AngularJS 中迭代过滤后的 `ng-repeat` 对象集合？](https://www.geeksforgeeks.org/how-to-iterate-over-filtered-ng-repeat-filter-collection-of-objects-in-angularjs/)
*   [如何在 AngularJS 中使用控制器内的过滤器？](https://www.geeksforgeeks.org/how-to-use-filter-within-controllers-in-angularjs/)
*   [AngularJS 中的 `ng-pristine` 和 `ng-dirty` 有什么区别？](https://www.geeksforgeeks.org/whats-the-difference-between-ng-pristine-and-ng-dirty-in-angularjs/)
...
*   [在 AngularJS 中使用 `ng-model` 格式化日期](https://www.geeksforgeeks.org/format-a-date-using-ng-model-in-angularjs/)
...
*   [Angular 7 | 使用可观测数据的角度数据服务](https://www.geeksforgeeks.org/angular-7-angular-data-services-using-observable/)
...
*   [什么是角模的 `entryComponents` 成分？](https://www.geeksforgeeks.org/what-is-entrycomponents-in-angular-ngmodule/)
...
*   [AngularJS 中 `declarations` 和 `entryComponents` 的区别](https://www.geeksforgeeks.org/difference-between-declarations-and-entrycomponents-in-angularjs/)
*   [AngularJS 中 `ng-container` 和 `ng-template` 的区别](https://www.geeksforgeeks.org/difference-between-ng-container-and-ng-template-in-angularjs/)
...
*   [`NgModule` 中的 `declarations`、`providers` 和 `import` 有什么区别？](https://www.geeksforgeeks.org/what-is-the-difference-between-declarations-providers-and-import-in-ngmodule/)
...
*   [AngularJS 中 `template` 和 `templateUrl` 的区别](https://www.geeksforgeeks.org/difference-between-template-and-templateurl-in-angularjs/)
...
*   [AngularJS 中 `directive` 和 `component` 的区别](https://www.geeksforgeeks.org/difference-between-directive-and-component-in-angularjs/)
...
*   [org/what-is-spa-single-page-application-in-angularjs/](https://www.geeksforgeeks.org/what-is-spa-single-page-application-in-angularjs/)
...
*   [`Angular` 文件上传](https://www.geeksforgeeks.org/angular-file-upload/)
*   [`Angular 8` 中的字符串插值](https://www.geeksforgeeks.org/string-interpolation-in-angular-8/)
*   [`AngularJS` 中的响应页面](https://www.geeksforgeeks.org/responsive-page-in-angularjs/)
*   [`Angular` 的 `MDBootstrap` 介绍和安装](https://www.geeksforgeeks.org/mdbootstrap-introduction-and-installation-for-angular/)
*   [`Ant Design` 介绍及安装 `Angular`](https://www.geeksforgeeks.org/ant-design-introduction-and-installation-for-angular/)
*   [如何使用 `ngx-webcam` 在 `Angular 10` 中启用网络摄像头？](https://www.geeksforgeeks.org/how-to-enable-webcam-in-angular-10-using-ngx-webcam/)
...
*   [使用 `Hammer.js` 在 `Angular 9` 中进行鼠标滑动控制](https://www.geeksforgeeks.org/mouse-swipe-controls-in-angular-9-using-hammerjs/)
...
*   [`Angular 8` 中的类绑定](https://www.geeksforgeeks.org/class-binding-in-angular-8/)
*   [如何在 `Angular5` 中的每次路由点击中滚动到顶部？](https://www.geeksforgeeks.org/how-to-scroll-to-top-on-every-route-click-in-angular5/)
*   [`Angular` 和 `Aurelia` 的区别](https://www.geeksforgeeks.org/difference-between-angular-and-aurelia/)
*   [`Angular 8` 中的样式绑定](https://www.geeksforgeeks.org/style-binding-in-angular-8/)
*   [`Angular 8` 中的事件绑定](https://www.geeksforgeeks.org/event-binding-in-angular-8/)
*   [如何在 `Angular Smart Table` 中搜索特殊字符？](https://www.geeksforgeeks.org/how-to-search-special-character-in-an-angular-smart-table/)
*   [如何在 `Angular` 中强制重定向到特定路由？](https://www.geeksforgeeks.org/how-to-force-redirect-to-a-particular-route-in-angular/)
*   [使用 `GitHub Pages` 部署 `Angular` 应用](https://www.geeksforgeeks.org/deployment-of-angular-application-using-github-pages/)
...
*   [`Angular 8` 中的属性绑定](https://www.geeksforgeeks.org/property-binding-in-angular-8/)
...
*   [`ng-checked` 的替代选项，在 `AngularJS` 中获取复选框的状态](https://www.geeksforgeeks.org/alternative-of-ng-checked-to-get-the-checkboxs-state-in-angularjs/)
...
*   [使用 `AngularJS` 从数组中移除重复的元素](https://www.geeksforgeeks.org/remove-duplicate-elements-from-an-array-using-angularjs/)
...
*   [如何检测 `Angular` 组件外的点击事件？](https://www.geeksforgeeks.org/how-to-detect-click-event-outside-angular-component/)
*   [如何在 `Angular` 中使用 `Mat-Dialog`？](https://www.geeksforgeeks.org/how-to-use-mat-dialog-in-angular/)
*   [`Angular 6+` 中的事件处理程序](https://www.geeksforgeeks.org/event-handler-in-angular-6/)
...
*   [`JavaScript` 和 `AngularJS` 的区别](https://www.geeksforgeeks.org/difference-between-javascript-and-angularjs/)
...
*   [`Angular 11` 中的更新](https://www.geeksforgeeks.org/updates-in-angular-11/)
...
*   [`AngularJS` 端到端(`E2E`)测试 | `Protractor`](https://www.geeksforgeeks.org/angularjs-end-to-end-e2e-testing-protractor/)
*   [`Angular Material` 中的 `MatDatePicker`](https://www.geeksforgeeks.org/mat-date-picker-in-angular-material/)
*   [`AngularJS` 端到端(`E2E`)测试 `Protractor` | 安装和设置](https://www.geeksforgeeks.org/angularjs-end-to-end-e2e-testing-protractor-installation-and-setup/)
*   [`Angular Material` 中的 `MatButton`](https://www.geeksforgeeks.org/mat-button-in-angular-material/)
*   [`Angular Universal` 介绍](https://www.geeksforgeeks.org/introduction-to-angular-universal/)
*   [当 `AngularJS` 中特定条件为真时，如何显示/隐藏数据？](https://www.geeksforgeeks.org/how-to-show-hide-data-when-specific-condition-is-true-in-angularjs/)
