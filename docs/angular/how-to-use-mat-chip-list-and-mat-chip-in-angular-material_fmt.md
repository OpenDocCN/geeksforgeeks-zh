# 如何在棱角材质中使用`<mat-chip-list>`和`<mat-chip>`？

> 原文：[https://www.geeksforgeeks.org/how-to-use-mat-chip-list-and-mat-chip-in-angular-material/](https://www.geeksforgeeks.org/how-to-use-mat-chip-list-and-mat-chip-in-angular-material/)
...
*   首先，使用上述命令安装角度材料。
*   安装完成后，从 `app.module.ts` 文件中的 `@angular/material/chips` 导入 `MatChipsModule`。
*   然后使用 `<mat-chip-list>` 标签将该组标签内的所有标签或项目分组。
*   在 `<mat-chip-list>` 标签中，我们需要对每个项目或标签使用 `<mat-chip>` 标签。
