...
> 原文: [https://www.geeksforgeeks.org/how-to-open-popup-using-angular-and-bootstrap/](https://www.geeksforgeeks.org/how-to-open-popup-using-angular-and-bootstrap/)
...
在对应组件的 TypeScript 文件中导入 `NgbModal` 模块，然后我们要在对应组件的 HTML 文件中使用上面的模块为弹出模型编写代码。
