...
> 原文：`https://www.geeksforgeeks.org/angularjs-tables/`

表中的数据基本上是可重复的，因此您可以使用 `ng-repeat` 指令轻松创建表。该示例将明确这种方法。
...
## 带有上述代码的 AngularJS ng-repeat 指令示例

在这里，您将看到带有 AngularJS `ng-repeat` 指令的上述 html 和 css 的组合。
