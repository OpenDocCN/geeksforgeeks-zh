# `<mat-progress-bar>` 在 Angular Material 中的使用

> 原文: [https://www.geeksforgeeks.org/mat-progress-bar-in-angular-material/](https://www.geeksforgeeks.org/mat-progress-bar-in-angular-material/)

## 简介

Angular Material 是一个 UI 组件库，由 Angular 团队开发，用于构建桌面和移动网络应用程序的设计组件。为了安装它，我们需要在我们的项目中安装 Angular，一旦你有了它，你可以输入下面的命令并下载它。`<mat-progress-bar>` 标签用于显示进度条。进度条用于指示特定任务的状态。
...
*   要使用进度条，我们只需要使用 `<mat-progress-bar>` 标签。
