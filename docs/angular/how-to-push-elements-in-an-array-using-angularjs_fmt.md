...
> 原文: [https://www.geeksforgeeks.org/how-to-push-elements-in-an-array-using-angularjs/](https://www.geeksforgeeks.org/how-to-push-elements-in-an-array-using-angularjs/)

给定一个数组，任务是使用 AngularJS 对数组执行推送操作。

## 方法

在该方法中，`push()`方法用于将元素插入到数组的末尾。在第一个示例中，数组中插入了一个静态值“极客”，在第二个示例中，向用户提供了一个输入框来推送他们想要的值。
