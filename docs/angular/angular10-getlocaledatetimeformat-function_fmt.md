# Angular 10 getLocaleDateTimeFormat() 函数

> 原文：[https://www.geeksforgeeks.org/angular10-getlocaledatetimeformat-function/](https://www.geeksforgeeks.org/angular10-getlocaledatetimeformat-function/)

在这篇文章中，我们将看到什么是 Angular 10 中的 `getLocaleDateTimeFormat` 以及如何使用它。

`getLocaleDateTimeFormat` 用于获取给定地区的本地化日期时间格式。
...
**模块：** `getLocaleDateTimeFormat` 使用的模块为：
...
**参考：** [https://angular.io/api/common/getLocaleDateTimeFormat](https://angular.io/api/common/getLocaleDateTimeFormat)