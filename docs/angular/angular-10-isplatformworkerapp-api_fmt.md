...
> 原文: [https://www.geeksforgeeks.org/angular-10-isplatformworkerapp-api/](https://www.geeksforgeeks.org/angular-10-isplatformworkerapp-api/)

在本文中，我们将看到 Angular 10 中的 `isPlatformWorkerApp` 是什么以及如何使用它。`isPlatformWorkerApp` API 用于获取表示工作应用程序平台的平台 id。
...
**参考:** [https://angular.io/api/common/isPlatformWorkerApp](https://angular.io/api/common/isPlatformWorkerApp)