# AngularJS | angular.uppercase()函数

> 原文: [https://www.geeksforgeeks.org/angularjs-angular-uppercase-function/](https://www.geeksforgeeks.org/angularjs-angular-uppercase-function/)

AngularJS 中的 `angular.uppercase()` 函数用于将字符串转换为**大写**。当用户想用大写字母而不是小写字母显示文本时，可以使用它。
