...
Angular 10 中的 `ngIf` 指令用于根据表达式移除或重新创建 HTML 元素的一部分。如果其中的表达式为假，则删除该元素，如果为真，则将该元素添加到 DOM 中。
...
**参考:** [https://angular.io/api/common/NgIf](https://angular.io/api/common/NgIf)