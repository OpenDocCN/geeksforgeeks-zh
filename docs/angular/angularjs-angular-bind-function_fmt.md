...
> 原文: [https://www.geeksforgeeks.org/angularjs-angular-bind-function/](https://www.geeksforgeeks.org/angularjs-angular-bind-function/)

AngularJS 中的 `angular.bind()`函数用于将当前上下文绑定到一个函数，但实际上是在以后执行它。也可用于**部分应用**。部分应用程序是当你想要创建一个函数，但是一些参数已经被传递了。
