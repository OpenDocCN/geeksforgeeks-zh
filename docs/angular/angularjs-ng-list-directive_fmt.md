...
AngularJS 中的 `ng-list` 指令用于分隔输入字符串，并使用分隔符将其转换为字符串数组。默认情况下，逗号用作默认分隔符。但是任何自定义分隔符都可以用作 `ng-list` 指令的值。
...
<body ng-app="app" style="text-align:center">
    ...
    <div ng-controller="geek">
        ...
        <p>Enter Input: <input type="text" ng-model="list" ng-list="-">
        </p>
