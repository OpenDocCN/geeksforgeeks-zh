...
> 原文: [https://www.geeksforgeeks.org/angular10-isplatformbrowser-function/](https://www.geeksforgeeks.org/angular10-isplatformbrowser-function/)
...
`isPlatformBrowser` 使用的模块为：

*   **公共模块**

## 返回值

返回一个布尔值，说明平台 id 是否代表浏览器平台。
...
[https://angular.io/api/common/isPlatformBrowser](https://angular.io/api/common/isPlatformBrowser)