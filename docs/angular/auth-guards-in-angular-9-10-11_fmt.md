...
> 原文: [https://www.geeksforgeeks.org/auth-guards-in-angular-9-10-11/](https://www.geeksforgeeks.org/auth-guards-in-angular-9-10-11/)
...
上面的命令在 `service` 文件夹中创建了 `AuthGuard`，`AuthGuard` 的名称是 `auth`。
