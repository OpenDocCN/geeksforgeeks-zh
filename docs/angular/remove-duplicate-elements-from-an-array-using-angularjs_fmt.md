# 使用 AngularJS 从数组中移除重复的元素

> 原文：`https://www.geeksforgeeks.org/remove-duplicate-elements-from-an-array-using-angularjs/`
...
本示例执行区分大小写比较，因此像 `'gfg'` 和 `'GFG'` 这样的元素不会被视为重复。
