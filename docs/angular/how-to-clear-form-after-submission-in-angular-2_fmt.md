...
> 原文：[https://www.geeksforgeeks.org/how-to-clear-form-after-submission-in-angular-2/](https://www.geeksforgeeks.org/how-to-clear-form-after-submission-in-angular-2/)
...
在模板驱动的表单中，大部分内容将在 `.html` 文件中填充。在反应形式中，大部分功能和内容将在 `.ts` 文件中执行。反应式表单的主要优势是，我们可以创建自定义验证，第二个关键优势是当我们执行单元测试时，因为 HTML 代码将是干净的，所以编写单元测试更可行。
...
在反应表单中，我们需要从 `@angular/forms` 导入 `FormGroup`。
