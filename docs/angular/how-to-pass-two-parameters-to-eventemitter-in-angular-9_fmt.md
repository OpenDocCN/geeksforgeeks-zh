...
> 原文：[https://www.geeksforgeeks.org/how-to-pass-two-parameters-to-eventemitter-in-angular-9/](https://www.geeksforgeeks.org/how-to-pass-two-parameters-to-eventemitter-in-angular-9/)

在 Angular 中，我们可以在两个方向上传输数据，即内部：传输到子组件，外部：传输到父组件。对于发送数据给子组件，我们使用属性绑定，对于后者，我们使用`EventEmitter`。
...
我们将在子组件中创建两个属性，并使用事件发射器在父组件中接收它们。
...
*   父组件中的名称和年龄在从子组件接收后更新。
    ![](img/fdb11105844f97bc41e60c1d787bc5d0.png)