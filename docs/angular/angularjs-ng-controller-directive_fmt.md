...
> 原文: [https://www.geeksforgeeks.org/angularjs-ng-controller-directive/](https://www.geeksforgeeks.org/angularjs-ng-controller-directive/)
...
其中 `expression` 是指控制器的名称。

## 示例 1

本示例使用 `ng-controller` 指令显示输入元素。
...
本示例使用 `ng-controller` 指令在点击按钮后显示内容。
