...
> 原文: [https://www.geeksforgeeks.org/angular-primeng-inputswitch-component/](https://www.geeksforgeeks.org/angular-primeng-inputswitch-component/)
...
在本例中，我们使用 `disabled` 和 `readonly` 属性进行输入开关预选。
...
**参考:** [https://primefaces.org/primeng/showcase/#/inputswitch](https://primefaces.org/primeng/showcase/#/inputswitch)