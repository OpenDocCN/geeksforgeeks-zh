...
AngularJS 中的 `ng-src` 指令用于指定 `<img>` 元素的 `src` 属性。它确保在评估完 AngularJS 之前不会产生错误的图像。它由 `<img>` 元素支持。
        ...
        <div ng-controller="geek">
            ...
            <script>
                ...
                app.controller('geek', ['$scope', function ($scope) {
                    $scope.pic = "https://media.geeksforgeeks.org/wp-content/uploads/20190328034223/ngimg1.png";
                }]);
            </script>
        </div>
    </body>
