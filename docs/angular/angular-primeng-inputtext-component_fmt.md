...
> 原文：[https://www.geeksforgeeks.org/angular-primeng-inputtext-component/](https://www.geeksforgeeks.org/angular-primeng-inputtext-component/)
...
## 尺寸
除常规尺寸外，还有 2 种以上尺寸可选，小文本输入添加 `p-inputtext-sm`&大文本输入添加 `p-inputtext-lg`。这些类必须用于更改特定输入字段的大小。
...
## 示例 2
在本例中，我们将了解如何设置 InputText 组件的大小。
...
**参考：** [https://primefaces.org/primeng/showcase/#/inputtext](https://primefaces.org/primeng/showcase/#/inputtext)