...
> 原文：[https://www.geeksforgeeks.org/how-to-set-the-input-field-value-dynamically-in-angularjs/](https://www.geeksforgeeks.org/how-to-set-the-input-field-value-dynamically-in-angularjs/)
...
在本例中，输入字段为 `readonly`，用户不能修改，数值是动态设置的。
