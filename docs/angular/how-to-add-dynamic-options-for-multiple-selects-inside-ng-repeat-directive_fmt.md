...
> 原文：[https://www.geeksforgeeks.org/how-to-add-dynamic-options-for-multiple-selects-inside-ng-repeat-directive/](https://www.geeksforgeeks.org/how-to-add-dynamic-options-for-multiple-selects-inside-ng-repeat-directive/)
    ...
    <center>
        ...
        <table>
            ...
            <tr ng-repeat="model in models">
                ...
                <td>
                    <select ng-options="state as state for state in getState(model.country)"
