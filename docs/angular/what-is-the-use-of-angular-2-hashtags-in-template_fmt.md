...
> 原文：[https://www.geeksforgeeks.org/what-is-the-use-of-angular-2-hashtags-in-template/](https://www.geeksforgeeks.org/what-is-the-use-of-angular-2-hashtags-in-template/)
...
在上面的语法中，它创建了对`input`元素的引用，该元素可以在以后的模板中使用。
