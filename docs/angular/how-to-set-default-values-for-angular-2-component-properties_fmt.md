...
> 原文：[https://www.geeksforgeeks.org/how-to-set-default-values-for-angular-2-component-properties/](https://www.geeksforgeeks.org/how-to-set-default-values-for-angular-2-component-properties/)
...
当我们把国家财产作为 `'India'` 传递时，它就会被显示出来。但是当涉及到资本时，因为我们没有传递任何值，所以它在 `child.component.ts` 文件中显示默认值。
