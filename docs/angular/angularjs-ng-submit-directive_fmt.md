...
> 原文: [https://www.geeksforgeeks.org/angularjs-ng-submit-directive/](https://www.geeksforgeeks.org/angularjs-ng-submit-directive/)

AngularJS 中的 `ng-submit` 指令用于指定在提交事件上运行的函数。如果表单不包含 `action`，它可用于阻止表单提交。由 `<form>` 元素支撑。
