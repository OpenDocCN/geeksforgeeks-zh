...
> 原文：[https://www.geeksforgeeks.org/how-to-reset-selected-file-with-input-tag-file-type-in-angular-9/](https://www.geeksforgeeks.org/how-to-reset-selected-file-with-input-tag-file-type-in-angular-9/)
...
*   现在在组件中，我们可以使用`ViewChild`指令从 HTML 视图中读取输入的值。
