...
> 原文: [https://www.geeksforgeeks.org/angular-primeng-knob-component/](https://www.geeksforgeeks.org/angular-primeng-knob-component/)

Angular PrimeNG 是一个开源框架，拥有一套丰富的原生 Angular UI 组件，用于实现出色的造型，该框架用于非常轻松地制作响应性网站。在本文中，我们将了解如何在 Angular PrimeNG 中使用旋钮组件。

## 旋钮组件

它是一个表单组件，用于定义包含标签和一些数据值的拨号器类型旋钮。
...
在本例中，我们将了解如何在旋钮组件中使用 steps &笔画属性。
...
**参考:** [https://primefaces.org/primeng/showcase/#/knob](https://primefaces.org/primeng/showcase/#/knob)