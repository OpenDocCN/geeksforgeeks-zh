...
> 原文: [https://www.geeksforgeeks.org/how-to-create-mat-button-toggle-group-as-read-only-mode-in-angularjs/](https://www.geeksforgeeks.org/how-to-create-mat-button-toggle-group-as-read-only-mode-in-angularjs/)
...
*   然后使用 `<mat-button-toggle-group>` 和标签创建角度按钮切换组。
...
```ts
<mat-button-toggle-group name="techno" aria-label="technology">
...
如果你清楚地观察上面的输出，你就能理解你不能选择，这就是只读属性的样子。