...
> 原文: [https://www.geeksforgeeks.org/angular10-getlocaledirection-function/](https://www.geeksforgeeks.org/angular10-getlocaledirection-function/)

在这篇文章中，我们将看到什么是 Angular 10 中的 `getLocaleDirection` 以及如何使用它。

`getLocaleDirection` 是用来获取给定区域的书写方向。
...
**参考:** [https://angular.io/api/common/getLocaleDirection](https://angular.io/api/common/getLocaleDirection)