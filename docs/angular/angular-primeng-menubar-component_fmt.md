...
> 原文: [https://www.geeksforgeeks.org/angular-primeng-menubar-component/](https://www.geeksforgeeks.org/angular-primeng-menubar-component/)
...
*   `autoDisplay`: 用于指定是否在鼠标悬停时显示根子菜单。它接受布尔数据类型作为输入&默认值为假。
...
[https://primefaces.org/primeng/showcase/#/menubar](https://primefaces.org/primeng/showcase/#/menubar)