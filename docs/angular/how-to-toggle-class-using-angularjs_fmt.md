...
> 原文：[https://www.geeksforgeeks.org/how-to-toggle-class-using-angularjs/](https://www.geeksforgeeks.org/how-to-toggle-class-using-angularjs/)
...
<body style="text-align:center;">
    ...
    <div ng-app="app">
        <div ng-controller="controller">
            <div ng-class="{'class1':!val, 'class2': val}">
                {{ val }}
            </div>
            <a href="javascript:void(0);" ng-click='toggleClass();'>
...
<body style="text-align:center;">
    ...
    <div ng-app="app">
        <div ng-controller="controller">
            <div id='div' ng-class="{'class1':!val, 'class2': val}">
                {{ val }}
            </div>
            <a href="javascript:void(0);" ng-click='toggleClass();'>
                Click to toggle class
