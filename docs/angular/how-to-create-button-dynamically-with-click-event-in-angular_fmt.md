...
> 原文：[https://www.geeksforgeeks.org/how-to-create-button-dynamically-with-click-event-in-angular/](https://www.geeksforgeeks.org/how-to-create-button-dynamically-with-click-event-in-angular/)
...
这里我们有一个 `counter` 变量，它保存 DOM 中当前存在的按钮的计数。每次按下主按钮（GFG）时，它都会增加 1。计数增加后，`ng-repeat` 会生成一个新按钮。
