...
> 原文: [https://www.geeksforgeeks.org/angular-primeng-invalidstate-component/](https://www.geeksforgeeks.org/angular-primeng-invalidstate-component/)
...
在本例中，我们将知道如何在下拉列表中使用 `invalidState`。
...
**参考:** [https://primefaces.org/primeng/showcase/#/invalid](https://primefaces.org/primeng/showcase/#/invalid)