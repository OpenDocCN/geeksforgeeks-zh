...
> 原文: [https://www.geeksforgeeks.org/how-to-count-array-items-in-angularjs/](https://www.geeksforgeeks.org/how-to-count-array-items-in-angularjs/)

给定一个数组，任务是获取 AngularJS 中数组变量的长度。为此，我们将使用`.length()`方法获取一个数组变量的长度。
