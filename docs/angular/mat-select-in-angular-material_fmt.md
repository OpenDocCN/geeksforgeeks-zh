# Angular Material 中的 `<mat-select>`

> 原文: [https://www.geeksforgeeks.org/mat-select-in-angular-material/](https://www.geeksforgeeks.org/mat-select-in-angular-material/)
...
- 然后使用 `<mat-select>` 标签将该组标签内的所有项目分组。
- 在 `<mat-select>` 标签中，我们需要对每个项目使用 `<mat-option>` 标签。
