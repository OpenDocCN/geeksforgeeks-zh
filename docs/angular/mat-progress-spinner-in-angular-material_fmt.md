# mat-progress-spinner 在 Angular Material 中的使用

> 原文：[https://www.geeksforgeeks.org/mat-progress-spinner-in-angular-material/](https://www.geeksforgeeks.org/mat-progress-spinner-in-angular-material/)
...
*   要使用旋转器，我们需要简单地使用 `<mat-spinner>` 标签。
