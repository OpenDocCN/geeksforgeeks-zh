...
在本文中，我们将看到什么是 Angular 10 中的 `uppercase` 管道以及如何使用它。

`uppercase` 管道用于将所有文本转换为大写。
...
**参考:** [https://angular.io/api/common/UpperCasePipe](https://angular.io/api/common/UpperCasePipe)