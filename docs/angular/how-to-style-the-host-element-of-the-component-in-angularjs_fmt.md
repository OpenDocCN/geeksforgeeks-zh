...
> 原文：[https://www.geeksforgeeks.org/how-to-style-the-host-element-of-the-component-in-angularjs/](https://www.geeksforgeeks.org/how-to-style-the-host-element-of-the-component-in-angularjs/)

若要设置组件的宿主元素的样式，请使用 `ng-style` 指令。`CSS` 属性有助于组件的样式化。

## 方法

宿主组件的样式使用 `CSS` 属性，可以在任何需要的时候进行更改、修改和更新。
...
本示例使用 `ng-style` 的指令。这里使用字体颜色和背景颜色的 `CSS` 属性。
