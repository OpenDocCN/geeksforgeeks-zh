...
> 原文: [https://www.geeksforgeeks.org/angularjs-ng-non-bindable-directive/](https://www.geeksforgeeks.org/angularjs-ng-non-bindable-directive/)

AngularJS 中的 `ng-non-bindable` 指令用于指定 HTML 的特定内容不应该被编译，即内容应该被 AngularJS 忽略。当我们想要显示代码片段而不是编译输出时，可以使用它。
