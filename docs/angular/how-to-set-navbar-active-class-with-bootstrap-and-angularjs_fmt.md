...
> 原文：[https://www.geeksforgeeks.org/how-to-set-navbar-active-class-with-bootstrap-and-angularjs/](https://www.geeksforgeeks.org/how-to-set-navbar-active-class-with-bootstrap-and-angularjs/)
...
这个例子解释了如何使用 `ng-controller` 用 AngularJS 设置 bootstrap navbar 活动类。
