...
> 原文: [https://www.geeksforgeeks.org/angular-primeng-scrolltop-component/](https://www.geeksforgeeks.org/angular-primeng-scrolltop-component/)
...
这是说明如何使用 `scrollTop` 组件的基本示例。`阈值`的值设置为 150，因此滚动 150 像素后将显示滚动顶部图标。
...
在本例中，我们将`行为`属性设置为自动，因此，滚动到元素顶部时动画不可见，`阈值`设置为 0，因此滚动时会立即显示 `scrollTop` 图标。
...
**参考:** [https://primefaces.org/primeng/showcase/#/scrolltop](https://primefaces.org/primeng/showcase/#/scrolltop)