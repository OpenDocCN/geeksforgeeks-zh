...
> 原文：[https://www.geeksforgeeks.org/angular-primeng-inputgroup-component/](https://www.geeksforgeeks.org/angular-primeng-inputgroup-component/)
...
在本例中，我们将了解如何在 `InputGroup` 组件中使用 `disabled` 属性。
...
**参考:** [https://primefaces.org/primeng/showcase/#/inputgroup](https://primefaces.org/primeng/showcase/#/inputgroup)