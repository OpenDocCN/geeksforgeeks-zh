# Angular 10 getLocaleDateFormat() 函数

> 原文: [https://www.geeksforgeeks.org/angular10-getlocaledateformat-function/](https://www.geeksforgeeks.org/angular10-getlocaledateformat-function/)

在本文中，我们将看到 Angular 10 中什么是 `getLocaleDateFormat` 以及如何使用它。
...
*   [https://angular.io/api/common/getLocaleDateFormat](https://angular.io/api/common/getLocaleDateFormat)