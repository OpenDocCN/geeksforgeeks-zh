...
> 原文: [https://www.geeksforgeeks.org/how-to-use-mattooltip-in-angular-material/](https://www.geeksforgeeks.org/how-to-use-mattooltip-in-angular-material/)
...
首先，使用上述命令安装角度材料。安装完成后，从 `app.module.ts` 文件中的 `@angular/material/tooltip` 模块导入 `MatTooltipModule`。我们需要使用 `matTooltip` 属性来显示我们想要渲染的文本。为了显示位置，我们需要使用 `matTooltipPosition` 属性。我们还可以自定义工具提示的位置，比如使用下面的名称“上”、“下”、“左”、“右”等。完成上述步骤后，就可以开始项目了。
