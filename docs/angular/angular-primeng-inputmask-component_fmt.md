...
> 原文: [https://www.geeksforgeeks.org/angular-primeng-inputmask-component/](https://www.geeksforgeeks.org/angular-primeng-inputmask-component/)
...
在本例中，我们将了解如何在 `InputMask` 组件中使用 `disabled` 属性。
...
**参考:** [https://primefaces.org/primeng/showcase/#/inputmask](https://primefaces.org/primeng/showcase/#/inputmask)