...
> 原文: [https://www.geeksforgeeks.org/routing-angular-js-using-angular-ui-router/](https://www.geeksforgeeks.org/routing-angular-js-using-angular-ui-router/)
...
可以使用 `templateUrl` 代替 `template`，并给定要为状态呈现的 HTML 文件的路径。
...
### 先决条件
[Node.js](https://www.geeksforgeeks.org/tag/node-js/) 和 [npm](https://www.geeksforgeeks.org/node-js-npm-node-package-manager/)
...
*   正文中的最后一个 `division` 定义了 `ui-view` div，不同路由的内容将在此处渲染。
...
5.  要在浏览器中运行上述演示应用，请安装 `http-server` 节点模块。要安装 `http-server` 模块，请使用以下命令:
...
8.  点击导航栏中的 `Login` 选项卡后，输出如下:
    ![](img/7d3dd599e738f8fa4a3f8749e15debc5.png)

9.  点击导航栏中的 `Signup` 标签，输出如下:
    ![](img/047145d62b3ef2090b02e84a3f765b32.png)

本示例应用程序创建了三条路线，即 `Home`、`Login` 和 `Signup`。

## 应用

*   路由对于单页应用程序很重要，因为它们为同一页上的应用程序提供了不同的功能。
*   使用 `angular-ui-router` 模块，路由的创建和操作变得简单。

## 参考文献

*   [https://github.com/angular-ui/ui-router/wiki/quick-reference](https://github.com/angular-ui/ui-router/wiki/quick-reference)
*   [https://ui-router.github.io/ng1/docs/1.0.0-beta.1/classes/state.stateprovider.html](https://ui-router.github.io/ng1/docs/1.0.0-beta.1/classes/state.stateprovider.html)
