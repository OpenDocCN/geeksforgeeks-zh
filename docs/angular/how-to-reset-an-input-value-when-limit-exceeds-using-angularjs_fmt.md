...
> 原文: [https://www.geeksforgeeks.org/how-to-reset-an-input-value-when-limit-exceeds-using-angularjs/](https://www.geeksforgeeks.org/how-to-reset-an-input-value-when-limit-exceeds-using-angularjs/)
...
如果用户输入的限制超过 100，本示例将用户输入的值设置为 0。
...
这里我们根据输入限制更改文本。如果输入值小于 0，则它变为 0。如果它的值大于 100，那么它将变为 100，否则它将保持不变。
