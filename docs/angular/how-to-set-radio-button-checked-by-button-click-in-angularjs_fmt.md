...
> 原文: [https://www.geeksforgeeks.org/how-to-set-radio-button-checked-by-button-click-in-angularjs/](https://www.geeksforgeeks.org/how-to-set-radio-button-checked-by-button-click-in-angularjs/)

在本文中，我们将看到如何在 AngularJS 中通过按钮点击来设置单选按钮。

## 方法

方法是使用 `ng-checked` 检查 DOM 中的单选按钮。在第一个示例中，单个单选按钮被按钮选中，在第二个示例中，多个单选按钮被按钮选中。`ng-model` 用于绑定单选按钮。
