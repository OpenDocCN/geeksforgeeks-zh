...
> 原文: [https://www.geeksforgeeks.org/angularjs-angular-isarray-function/](https://www.geeksforgeeks.org/angularjs-angular-isarray-function/)

AngularJS 中的 `angular.isArray()` 函数用于返回 `TRUE` 如果引用是数组，则返回 `FALSE` 如果不是数组。
