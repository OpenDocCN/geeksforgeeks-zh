...
> 原文: [https://www.geeksforgeeks.org/angularjs-ng-transclude-directive/](https://www.geeksforgeeks.org/angularjs-ng-transclude-directive/)

`ng-transclude` 指令用于标记使用 transclusion 的最近父代的 transcluded DOM 的插入点。使用转换槽名称作为 `transclude` 或 `ng-transclude` 属性的值。
