...
> 原文：[https://www.geeksforgeeks.org/define-ng-if-ng-show-and-ng-hide/](https://www.geeksforgeeks.org/define-ng-if-ng-show-and-ng-hide/)
...
`ng-show` 指令在 AngularJS 中用于显示或隐藏指定的 HTML 元素。
...
`ng-hide` 指令在 AngularJS 中用于显示或隐藏指定的 HTML 元素。
