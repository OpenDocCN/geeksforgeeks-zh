...
*   `p-inplace`: 是容器元素
*   `p-inplace-display`:是 Display 容器
...
**示例 1:** 这是说明如何在 Inplace 组件中实现 `closable` 属性的基本示例。
...
**参考:**[https://primefaces.org/primeng/showcase/#/inplace](https://primefaces.org/primeng/showcase/#/inplace)