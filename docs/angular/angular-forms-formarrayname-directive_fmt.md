...
> 原文: [https://www.geeksforgeeks.org/angular-forms-formarrayname-directive/](https://www.geeksforgeeks.org/angular-forms-formarrayname-directive/)

在本文中，我们将看到什么是 Angular 10 中的 Style 以及如何使用它。

`formArrayName` 用于将嵌套的表单与 DOM 元素同步。
...
参考: [https://angular.io/api/forms/FormArrayName](https://angular.io/api/forms/FormArrayName)