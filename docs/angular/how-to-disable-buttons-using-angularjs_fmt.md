...
> 原文: [https://www.geeksforgeeks.org/how-to-disable-buttons-using-angularjs/](https://www.geeksforgeeks.org/how-to-disable-buttons-using-angularjs/)

有时我们需要禁用点击事件上的按钮、链接。在本文中，我们将看到如何在 AngularJS 的帮助下做到这一点。

## 进场

*   方法是使用 `ng-disabled` 指令禁用特定按钮。
