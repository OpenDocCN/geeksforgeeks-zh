...
> 原文：[https://www.geeksforgeeks.org/how-to-convert-string-into-a-number-using-angularjs/](https://www.geeksforgeeks.org/how-to-convert-string-into-a-number-using-angularjs/)
...
*   我们将通过 `angular.isNumber()` 方法检查字符串是否为整数。

## 示例 1

在第一个示例中，字符串 `'90'` 被转换为整数。
...
<body style="text-align:center;">
    ...
    <p>
        Convert string into a number in AngularJS
    </p>
