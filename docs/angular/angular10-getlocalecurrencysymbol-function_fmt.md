# Angular 10 getLocaleCurrencySymbol()函数

> 原文: [https://www.geeksforgeeks.org/angular10-getlocalecurrencysymbol-function/](https://www.geeksforgeeks.org/angular10-getlocalecurrencysymbol-function/)

在本文中，我们将看到 Angular 10 中的 `getLocaleCurrencySymbol` 是什么以及如何使用。

`getLocaleCurrencySymbol` 是用来获取给定地区的货币符号。
...
`getLocaleCurrencySymbol` 使用的模块为：
...
[https://angular.io/api/common/getLocaleCurrencySymbol](https://angular.io/api/common/getLocaleCurrencySymbol)