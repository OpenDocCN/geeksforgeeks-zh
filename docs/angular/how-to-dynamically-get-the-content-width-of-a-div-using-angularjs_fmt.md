...
> 原文: [https://www.geeksforgeeks.org/how-to-dynamically-get-the-content-width-of-a-div-using-angularjs/](https://www.geeksforgeeks.org/how-to-dynamically-get-the-content-width-of-a-div-using-angularjs/) 动态获取内容宽度
...
## 示例 1：使用 `clientWidth` 属性

使用 `clientWidth` 属性的 div 的内容宽度将返回元素整个内容的宽度。
...
## 示例 2：使用 `scrollWidth` 属性

使用 `scrollWidth` 属性的 div 的内容宽度将返回元素整个内容的宽度。
