...
> 原文: [https://www.geeksforgeeks.org/angular-ng-bootstrap-dropdown-component/](https://www.geeksforgeeks.org/angular-ng-bootstrap-dropdown-component/)

Angular ng bootstrap 是一个 bootstrap 框架，与 Angular 一起使用来创建具有很好风格的组件，这个框架非常容易使用，用于制作响应性网站。

在本文中，我们将看到如何在 angular ng bootstrap 中使用 Dropdown。下拉用来制作一组对象，点击就会出来。
...
在本例中，我们使用的是放置在右上角的 `ngbDropdown`。
...
参考: [https://ng-bootstrap.github.io/#/components/dropdown/examples](https://ng-bootstrap.github.io/#/components/dropdown/examples)