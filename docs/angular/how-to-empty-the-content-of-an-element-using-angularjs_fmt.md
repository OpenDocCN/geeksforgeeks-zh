...
> 原文: [https://www.geeksforgeeks.org/how-to-empty-the-content-of-an-element-using-angularjs/](https://www.geeksforgeeks.org/how-to-empty-the-content-of-an-element-using-angularjs/)

这里的任务是在 AngularJS 的帮助下移除 HTML DOM 中元素的内容。

## 方法

首先选择要清空内容的元素。然后使用 `empty()` 方法移除元素的内容。

## 示例 1

在本示例中，ID(`#div`) 元素的内容被清空。
