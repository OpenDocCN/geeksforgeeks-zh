...
> 原文: [https://www.geeksforgeeks.org/angular10-animation-transition-api/](https://www.geeksforgeeks.org/angular10-animation-transition-api/)
...
[https://angular.io/api/animations/transition](https://angular.io/api/animations/transition)