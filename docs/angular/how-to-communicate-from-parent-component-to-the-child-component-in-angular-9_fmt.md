...
> 原文: [https://www.geeksforgeeks.org/how-to-communicate-from-parent-component-to-the-child-component-in-angular-9/](https://www.geeksforgeeks.org/how-to-communicate-from-parent-component-to-the-child-component-in-angular-9/)

Angular 使得组件之间的交流非常容易。在本文中，我们将学习如何从父组件与子组件进行通信。
...
*   现在在子组件中导入 `@angular/core` 的 `Input`，创建一个由 `@Input` 修饰器修饰的属性，从父组件接收 `ParentId`。属性的名称应该与用于绑定 `ParentId` 属性(即 `id`)的名称相同。
