# Angular ng-bootstrap 进度条组件

> 原文：[https://www.geeksforgeeks.org/angular-ng-bootstrap-progressbar-component/](https://www.geeksforgeeks.org/angular-ng-bootstrap-progressbar-component/)

Angular ng-bootstrap 是一个 Bootstrap 框架，与 Angular 一起使用来创建具有很好风格的组件。这个框架非常容易使用，用于制作响应性网站。

在本文中，我们将看到如何在 Angular ng-bootstrap 中使用 `Progressbar`。进度条组件用于提供工作进度的最新反馈。
...
在这个示例中，我们正在制作 `progressbar` 的基本示例。
...
在本例中，我们正在制作一个条纹和动画设置为 `true` 的进度条。
...
**参考：**[https://ng-bootstrap.github.io/#/components/progressbar/examples](https://ng-bootstrap.github.io/#/components/progressbar/examples)