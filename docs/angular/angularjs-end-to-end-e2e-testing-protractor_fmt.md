...
> 原文: [https://www.geeksforgeeks.org/angularjs-end-to-end-e2e-testing-protractor/](https://www.geeksforgeeks.org/angularjs-end-to-end-e2e-testing-protractor/)
...
*   `browser` 是量角器创建的全局，用于浏览器级命令，如使用 `browser.get()`。
*   `describe` 和 `it` 的语法来自 Jasmine 框架，其中 `describe` 是对您的测试的描述，而 `it` 是测试的步骤。
...
describe('Protractor Demo App', function () {
    it('should have a title', function () {
        ...
        // Check if the title is 'Super Calculator' or not.
