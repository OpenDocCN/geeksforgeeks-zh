# angolajs | ng-dblclick 指令

> 哎哎哎: [https://www.geeksforgeeks.org/angolajs-ng-dblclick-directive/](https://www.geeksforgeeks.org/angolajs-ng-dblclick-directive/)

AngularJS 中的 `ng-dblclick` 指令用于在双击元素时应用自定义行为。它可以用来显示或隐藏一些元素，或者它可以弹出警告或改变文本的颜色，当它被点击两次。
