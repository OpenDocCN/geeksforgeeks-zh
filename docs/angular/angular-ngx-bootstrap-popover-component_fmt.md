...
> 原文: [https://www.geeksforgeeks.org/angular-ngx-bootstrap-popover-component/](https://www.geeksforgeeks.org/angular-ngx-bootstrap-popover-component/)
...
*   在模块中导入 `popover` 组件。
*   在 `app.component.html` 中创建一个 `popover` 组件。
*   使用 `ng serve` 为应用提供服务。
...
[https://valor-software.com/ngx-bootstrap/popover](https://valor-software.com/ngx-bootstrap/popover)