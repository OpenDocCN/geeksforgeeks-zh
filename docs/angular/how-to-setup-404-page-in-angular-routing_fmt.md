...
> 原文：[https://www.geeksforgeeks.org/how-to-setup-404-page-in-angular-routing/](https://www.geeksforgeeks.org/how-to-setup-404-page-in-angular-routing/)
...
在这个组件的 HTML 模板里面添加下面的代码，显示一个简单的 404 错误消息。
...
此处`页面未找到组件`的路线在路线数组中提供。这里，除了提供的路线之外的任何路径都由这个`页面查找组件`处理，我们的 HTML 模板显示在浏览器中。所以现在，如果有人试图向任何不在路由数组中的页面发送请求，那么该用户将自动导航到这个`页面 notfoundComponent`。
