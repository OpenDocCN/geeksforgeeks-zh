...
> 原文: [https://www.geeksforgeeks.org/how-to-create-module-with-routing-in-angular-9/](https://www.geeksforgeeks.org/how-to-create-module-with-routing-in-angular-9/)
...
**为主模块创建组件:** 我们现在使用以下命令为我们的`主模块`添加一个新组件，所以让我们为主模块创建`主页`，`关于我们`，以及`联系我们`组件:
