...
> 原文: [https://www.geeksforgeeks.org/mat-label-in-angular-material/](https://www.geeksforgeeks.org/mat-label-in-angular-material/)
...
*   现在我们需要在 `<mat-form-field>` 标签中使用带有各自标签名称的 `<mat-label>` 标签。
*   下面是一个如何在 `<mat-form-field>` 中使用 `<mat-label>` 标签的例子。
*   完成上述步骤后，就可以开始项目了。
