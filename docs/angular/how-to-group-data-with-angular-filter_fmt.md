...
> 原文：[https://www.geeksforgeeks.org/how-to-group-data-with-angular-filter/](https://www.geeksforgeeks.org/how-to-group-data-with-angular-filter/)
...
1.  您可以使用以下四种不同的方法安装角度过滤器：
    ...
    *   Via Bower：通过运行 `$ bower install angular-filter` 从您的终端安装角度过滤器
    ...
    *   通过 npm：通过运行 `$ npm install angular-filter` 从您的终端安装角度过滤器。
