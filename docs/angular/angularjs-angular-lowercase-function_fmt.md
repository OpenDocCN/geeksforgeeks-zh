# AngularJS | `angular.lowercase()`函数

> 原文：[https://www.geeksforgeeks.org/angularjs-angular-lowercase-function/](https://www.geeksforgeeks.org/angularjs-angular-lowercase-function/)

AngularJS 中的 `angular.lowercase()` 函数用于将字符串转换为小写。当用户想要以小写而不是大写显示文本或者想要比较两个字符串时，可以使用它。
