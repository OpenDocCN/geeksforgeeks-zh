...
> 原文: [https://www.geeksforgeeks.org/angular-10-formatnumber-method/](https://www.geeksforgeeks.org/angular-10-formatnumber-method/)

在本文中，我们将看到什么是 Angular 10 中的 `formatNumber` 以及如何使用它。

`formatNumber` 用于根据我们对十进制形式的要求对数字进行格式化。
...
*   创建要使用的 Angular 应用程序。
*   在 `app.module.ts` 中导入 `LOCALE_ID`，因为我们需要使用 `formatNumber` 导入 `LOCALE`。
...
[https://angular.io/api/common/formatNumber](https://angular.io/api/common/formatNumber)