...
> 原文: [https://www.geeksforgeeks.org/how-to-get-form-input-value-using-angularjs/](https://www.geeksforgeeks.org/how-to-get-form-input-value-using-angularjs/)

给定一个表单元素，任务是在 AngularJS 的帮助下获取用户输入的表单值。

**进场:**

*   在用户借助 `angular.copy(object)` 方法将数据输入输入元素后，我们将数据存储在 JSON 对象中。
