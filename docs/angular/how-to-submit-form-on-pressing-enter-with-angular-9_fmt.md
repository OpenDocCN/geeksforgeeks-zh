...
> 原文：[https://www.geeksforgeeks.org/how-to-submit-form-on-pressing-enter-with-angular-9/](https://www.geeksforgeeks.org/how-to-submit-form-on-pressing-enter-with-angular-9/)
...
我们可以使用角度`keydown`事件来使用回车键作为我们的提交键。
...
@Component({
    selector: 'app-root',
    //here we used inline template format.
    template: `
        ...
        <form #geeksForm="ngForm"
            ...
            <div *ngIf="geekname.errors.minlength">
                The geek name should be at least {{ geekname.errors.minlength.requiredLength }} characters long
            </div>
