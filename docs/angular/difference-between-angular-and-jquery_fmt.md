...
> 原文: [https://www.geeksforgeeks.org/difference-between-angular-and-jquery/](https://www.geeksforgeeks.org/difference-between-angular-and-jquery/)
...
| **功能:**<br><br>*   lightweight<br>*   `Ajax/JSONP`<br>*   Cross-browser compatibility<br>*   `html/domaint`<br>*   `CSS` manipulation<br>*   event handling | **特性:**<br><br>*   `MVC` support<br>*   Form validation<br>*   Use serenity `API`<br>*   Accurate order is an extension of `HTML`.<br>*   Dependent injection<br>*   Bidirectional information binding |
| 易于记忆 | 理解很难得到它 |