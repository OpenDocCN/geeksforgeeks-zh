...
> 原文: [https://www.geeksforgeeks.org/angular-ng-bootstrap-popover-component/](https://www.geeksforgeeks.org/angular-ng-bootstrap-popover-component/)
...
在本例中，我们制作了一个 popover，其位置为底部、右侧、左侧。
