...
> 原文：[https://www.geeksforgeeks.org/how-to-detect-a-route-change-in-angularjs/](https://www.geeksforgeeks.org/how-to-detect-a-route-change-in-angularjs/)
...
在这里，每当有任何路线变更时，我们都会在控制台窗口中显示“路线变更”。在 `$on()` 方法中，我们更改了控制台路由。因此，通过这种方式，每当发生路由更改时，它都会触发由 `$on()` 事件处理程序处理的 `$routeChangeSuccess`，然后在控制台窗口中显示“路由已更改”。
