...
> 原文: [https://www.geeksforgeeks.org/angularjs-ng-disabled-directive/](https://www.geeksforgeeks.org/angularjs-ng-disabled-directive/)
...
本示例使用 `ng-disabled` 指令使用复选框启用和禁用按钮。
