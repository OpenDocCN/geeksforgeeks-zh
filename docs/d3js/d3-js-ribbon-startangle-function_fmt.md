...
> 原文: [https://www.geeksforgeeks.org/d3-js-ribbon-startangle-function/](https://www.geeksforgeeks.org/d3-js-ribbon-startangle-function/)
...
*   `angle`：该参数是设置起始角度取值器的弧度值。

## 返回值

该函数返回色带生成器。

以下程序说明了`D3.js`中的`ribbon.startAngle()`功能。
