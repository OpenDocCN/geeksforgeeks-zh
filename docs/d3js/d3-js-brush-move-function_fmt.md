...
`D3.js`中的`brush.move()`函数用于在指定的组中设置笔刷的活动选择。
...
下面的程序说明了`D3.js`中的`brush.move()`函数。
...
<br>
<br>
<svg style="background-color: lightgreen;" width="500" height="100"></svg>
<script>
// Selecting SVG element
const svg = d3.select("svg");
const g = svg.append("g");
// Creating a brush using the d3.brush function
g.call(d3.brush());
