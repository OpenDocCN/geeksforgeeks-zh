...
这个函数接受一个参数`数组`，它是一个要计算方差的元素数组。这里的元素应该是整数而不是字符串，否则会返回`undefined`。

## 返回值

返回给定数组元素的方差。

以下程序说明了D3.js中的`d3.variance()`功能。
...
**参考：**[https://devdocs.io/d3~4/d3-array#variance](https://devdocs.io/d3~4/d3-array#variance)