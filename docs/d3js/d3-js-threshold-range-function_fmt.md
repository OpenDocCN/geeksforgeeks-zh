...
> 原文：[https://www.geeksforgeeks.org/d3-js-threshold-range-function/](https://www.geeksforgeeks.org/d3-js-threshold-range-function/)

`threshold.range()`功能用于设置阈值范围。范围数组中的值的数量总是比域数组大一个，如果不是，则标度的行为可能是未定义的。
...
*   `range`：该参数接受离散值数组。如果域中有“n”个值，则范围必须有“n+1”个值。
