...
D3.js 中的 `d3.sum()` 函数用于返回给定数组元素的和。如果数组为空，则返回 0。
...
这个函数接受一个参数 `Array`，它是一个元素数组，元素的和要被计算。
...
在上面的输出中，如果参数为空或字符串，则返回 0，如果参数为包含一些整数值的字符串，则返回整数值的总和。

## 参考

[https://devdocs.io/d3~4/d3-array#sum](https://devdocs.io/d3~4/d3-array#sum)