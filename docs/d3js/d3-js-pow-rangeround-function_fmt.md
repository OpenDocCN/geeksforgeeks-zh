...
> 原文: [https://www.geeksforgeeks.org/d3-js-pow-rangeround-function/](https://www.geeksforgeeks.org/d3-js-pow-rangeround-function/)
...
该函数采用上面给出并在下面描述的单个参数。

*   `range`: 这是一个包含指定域范围的数组。
