# d3.lineRadial.curve()方法

> 原文: [https://www.geeksforgeeks.org/d3-js-lineradial-curve-method/](https://www.geeksforgeeks.org/d3-js-lineradial-curve-method/)

`d3.lineRadial.curve()`方法用来给我们的 lineRadial 一条曲线。D3.js 提供了几个曲线工厂，可以用来给出不同的曲线。
