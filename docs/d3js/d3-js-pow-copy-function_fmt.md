...
<body>
    ...
    <script>
        ...
        document.write("<h3>Original scale: " + pow(2.5) + "</h3>");
        document.write("<h3>Copy scale: " + powCopy(2.5) + "</h3>");
    </script>
</body>
</html>
```
...
<body>
    ...
    <script>
        ...
        pow.exponent(2);
        document.write("<p> Changes in original scale does not affect copy scale.</p>");
