...
> 原文: [https://www.geeksforgeeks.org/d3-js-interpolategnbu-function/](https://www.geeksforgeeks.org/d3-js-interpolategnbu-function/)

D3.js 中的 `d3.interpolateGnBu()` 函数用于从“GnBu”顺序配色方案中返回特定的颜色，该配色方案以 RGB 字符串的形式返回。
