...
> 原文: [https://www.geeksforgeeks.org/d3-js-geoconicequalarea-function/](https://www.geeksforgeeks.org/d3-js-geoconicequalarea-function/)

`d3.js`中的`geoConicEqualArea()`功能用于根据给定的geojson数据绘制艾伯斯的圆锥等面积投影。
...
### 示例 1
以下示例绘制世界的圆锥等面积投影，中心位于(0，0)，旋转 0 度。
...
### 示例 2
以下示例绘制世界的圆锥等面积投影，中心位于(-10，0)，相对于 y 轴旋转 90 度。
