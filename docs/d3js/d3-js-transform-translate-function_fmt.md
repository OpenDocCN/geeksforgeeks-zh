...
> 原文：[https://www.geeksforgeeks.org/d3-js-transform-translate-function/](https://www.geeksforgeeks.org/d3-js-transform-translate-function/)
...
<body>
    <center>
        ...
        <svg height="200px" width="400px">
            <g id="GFG" transform="translate(25,25) scale(0.25)">
            </g>
        </svg>
        <script>
