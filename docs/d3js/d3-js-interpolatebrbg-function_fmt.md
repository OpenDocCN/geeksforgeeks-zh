# D3.js 插值 `interpolateBrBG()` 函数

> 原文：[https://www.geeksforgeeks.org/d3-js-interpolatebrbg-function/](https://www.geeksforgeeks.org/d3-js-interpolatebrbg-function/)

D3.js 中的 `d3.interpolateBrBG()` 函数是一种发散配色方案，可用作连续插值器。该函数从 BrBG 发散配色方案中返回相应的颜色。
...
<html lang="en">
    ...
    <body>
        ...
        <br />
        <div class="b1">
            <span>D3.interpolateBrBG(0.9)</span>
        </div>
        <div class="b2">
            <span>D3.interpolateBrBG(0.1)</span>
        </div>
        <div class="b3">
            <span>D3.interpolateBrBG(0.2)</span>
        </div>
        <div class="b4">
            <span>D3.interpolateBrBG(0.5)</span>
        </div>
