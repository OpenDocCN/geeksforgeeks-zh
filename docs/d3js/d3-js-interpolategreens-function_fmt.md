# D3.js `interpolateGreens()`函数

> 原文: [https://www.geeksforgeeks.org/d3-js-interpolategreens-function/](https://www.geeksforgeeks.org/d3-js-interpolategreens-function/)

`d3.js` 中的 `d3.interpolateGreens()` 函数用于返回“绿色”顺序配色方案对应的颜色。该函数用于返回不同深浅的绿色。
