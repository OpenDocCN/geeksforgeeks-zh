# D3.js `interpolateObject()`函数

> 原文: [https://www.geeksforgeeks.org/d3-js-interpolateobject-function/](https://www.geeksforgeeks.org/d3-js-interpolateobject-function/)

D3.js 中的 `interpolateObject()` 函数用于返回给定两个对象之间的插值函数。如果“a”中存在“b”的任何属性，则使用插值为“a”和“b”创建通用插值器。
...
<body>
  ...
  <script>
    ...
    let interpolationFunction=d3.interpolateObject(obj1, obj2);
...
<body>
  ...
  <script>
    ...
    console.log(d3.interpolateObject({"c":4, "d":3}, {"a":10, "b":12})(5))
