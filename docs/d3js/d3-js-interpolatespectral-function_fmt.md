...
> 原文: [https://www.geeksforgeeks.org/d3-js-interpolatespectral-function/](https://www.geeksforgeeks.org/d3-js-interpolatespectral-function/)

`d3.interpolateSpectral()` 函数用于从“光谱”发散配色方案中返回颜色。此函数返回的颜色是 `RGB` 字符串的形式。
...
![输出结果](img/0a913df1f091e47ac8c0d4fb95fab6e6.png)
...
[![输出结果](img/5c742c8c9085414de9dd419e3128c69a.png)](https://media.geeksforgeeks.org/wp-content/uploads/20200817122944/Capture587.png)