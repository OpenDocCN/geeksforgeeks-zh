# D3.js geoConicEquidistant() 功能

> 原文: [https://www.geeksforgeeks.org/d3-js-geoconicequidistant-function/](https://www.geeksforgeeks.org/d3-js-geoconicequidistant-function/)

`d3.js` 中的 `geoConicEquidistant()` 功能用于根据给定的地理坐标数据绘制圆锥等距投影。
...
以下示例绘制世界的圆锥等距投影，中心位于 (0, 0)，旋转 0 度。
...
以下示例绘制世界的圆锥等距投影，中心位于 (-10, 0)，相对于 y 轴旋转 90 度。
