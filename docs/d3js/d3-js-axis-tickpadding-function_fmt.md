...
> 原文：[https://www.geeksforgeeks.org/d3-js-axis-tickpadding-function/](https://www.geeksforgeeks.org/d3-js-axis-tickpadding-function/)

D3.js 中的 `d3.axis.tickPadding()` 函数用于将填充设置为以像素为单位的指定值，并返回轴。
