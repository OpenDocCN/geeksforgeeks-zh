...
> 原文：[https://www.geeksforgeeks.org/d3-js-interpolatestring-function/](https://www.geeksforgeeks.org/d3-js-interpolatestring-function/)

D3.js 中的 `interpolateString()` 函数用于返回两个字符串之间的插值函数。对于字符串“b”中的每个数字，该函数在字符串“a”中为其找到一个数字，然后使用 number 插值器函数返回这些数字的插值，字符串“b”的剩余部分用作模板。
