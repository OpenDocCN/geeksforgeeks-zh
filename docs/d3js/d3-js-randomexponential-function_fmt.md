...
> 原文: [https://www.geeksforgeeks.org/d3-js-randomexponential-function/](https://www.geeksforgeeks.org/d3-js-randomexponential-function/)
...
* `lambda`: 它是指数分布函数的速率，等于泊松过程中事件之间的时间。
