# D3.js diverging.copy() 函数

> 原文: [https://www.geeksforgeeks.org/d3-js-diverging-copy-function/](https://www.geeksforgeeks.org/d3-js-diverging-copy-function/)

**发散音阶**与连续音阶非常相似。唯一的区别是，该标尺的输出范围由插值器固定，因此该范围不可配置。

d3.js 中的 `diverging.copy()` 函数用于构造并返回原始比例的精确副本。原始比例的任何变化都不会影响拷贝比例，反之亦然。
