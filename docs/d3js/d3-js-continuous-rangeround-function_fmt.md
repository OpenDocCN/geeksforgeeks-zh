...
> 原文: [https://www.geeksforgeeks.org/d3-js-continuous-rangeround-function/](https://www.geeksforgeeks.org/d3-js-continuous-rangeround-function/)

`continuous.rangeRound()` 函数用于将刻度范围设置为指定的值数组。它还将插值器设置为插值或环绕。舍入插值器对于避免抗混叠伪像可能很有用。
