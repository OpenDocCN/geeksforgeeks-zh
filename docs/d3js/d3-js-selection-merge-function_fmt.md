# D3.js `selection.merge()`功能

> 原文：[https://www.geeksforgeeks.org/d3-js-selection-merge-function/](https://www.geeksforgeeks.org/d3-js-selection-merge-function/)
...
<body>
    ...
    <script>
        ...
        console.log("Collection after merging odd and even is:")
        merged.forEach((e) => {
