...
> 原文: [https://www.geeksforgeeks.org/d3-js-chord-sortchords-function/](https://www.geeksforgeeks.org/d3-js-chord-sortchords-function/)

`D3.js`中的`chord.sortChords()`功能用于将和弦比较器设置为指定功能或`null`，并返回该和弦布局。
...
*   `compare`：该参数是设置和弦比较器的功能。

## 返回值

该函数返回和弦布局。

下面的程序说明了`D3.js`中的`chord.sortChords()`功能。
