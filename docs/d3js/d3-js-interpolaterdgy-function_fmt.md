...
> 原文: [https://www.geeksforgeeks.org/d3-js-interpolaterdgy-function/](https://www.geeksforgeeks.org/d3-js-interpolaterdgy-function/)

d3.js 中的 `d3.interpolateRdGy()` 函数是发散配色方案的一部分，它从 D3.js 中的 RdBu 发散配色方案返回颜色，这里 Rd 可以解释为红色，Gy 可以解释为灰色。
