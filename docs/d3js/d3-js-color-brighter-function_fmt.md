...
> 原文: [https://www.geeksforgeeks.org/d3-js-color-brighter-function/](https://www.geeksforgeeks.org/d3-js-color-brighter-function/)
...
该功能只接受一个参数 `k` 即原颜色所需的亮度大小。它是整数值。
...
<html lang="en">
    ...
    <body>
        ...
        <script>
            ...
            box1.style.backgroundColor = `rgb(${color.r},${color.g},${color.b})`;
        </script>
    </body>
</html>
```
