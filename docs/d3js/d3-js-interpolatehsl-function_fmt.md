...
> 原文: [https://www.geeksforgeeks.org/d3-js-interpolatehsl-function/](https://www.geeksforgeeks.org/d3-js-interpolatehsl-function/)

D3.js 的 `d3.interpolateHsl()` 函数用于返回两个给定颜色的 HSL 颜色空间插值器函数。给出的颜色不能是 HSL 格式。
