...
> 原文: [https://www.geeksforgeeks.org/d3-js-ordinal-domain-function/](https://www.geeksforgeeks.org/d3-js-ordinal-domain-function/)

d3.js 中的`ordinal.domain()`函数用于设置序数刻度的定义域。在这种情况下，域的第一个元素被映射到范围的第一个元素，域的第二个元素被映射到范围的第二个元素，以此类推。
