...
> 原文: [https://www.geeksforgeeks.org/d3-js-interpolatepiyg-function/](https://www.geeksforgeeks.org/d3-js-interpolatepiyg-function/)

D3.js 中的 `D3.interpolatePiYG()` 函数是一个发散配色方案，可作为连续插值器使用，从 PiYG 发散配色方案中返回相应的颜色。
