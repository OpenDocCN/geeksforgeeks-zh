...
> 原文: [https://www.geeksforgeeks.org/d3-js-d3-timeseconds-function/](https://www.geeksforgeeks.org/d3-js-d3-timeseconds-function/)

D3.js 中的 `d3.timeSeconds()` 函数用于返回给定开始和结束时间范围内所有带有日期的秒。
...
下面的程序说明了 D3.js 中的 `d3.timeSeconds()` 函数:
...
[https://devdocs.io/d3~5/d3-time#timeSeconds](https://devdocs.io/d3~5/d3-time#timeSeconds)