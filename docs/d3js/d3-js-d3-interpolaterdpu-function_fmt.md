# D3.js `d3.interpolateRdPu()` 函数

> 原文: [https://www.geeksforgeeks.org/d3-js-d3-interpolaterdpu-function/](https://www.geeksforgeeks.org/d3-js-d3-interpolaterdpu-function/)

`d3.js` 中的 `d3.interpolateRdPu()` 函数用于返回与“RdPu”的顺序配色方案相对应的颜色。该函数返回的颜色是 `RGB` 格式。此功能设置红色和紫色之间的颜色范围。给定的值介于 `0` 和 `1` 之间，包括 `0` 和 `1`。
