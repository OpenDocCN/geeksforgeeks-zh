...
> 原文：[https://www.geeksforgeeks.org/d3-js-interpolatergbBasisClosed-function/](https://www.geeksforgeeks.org/d3-js-interpolatergbBasisClosed-function/)

D3.js 中的 `d3.interpolateRgbBasisClosed()` 函数用于通过包含颜色串的数组输入返回均匀非有理 B-样条插值器。
