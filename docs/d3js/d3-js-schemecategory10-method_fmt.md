# D3.js schemeCategory10方法

> 原文: [https://www.geeksforgeeks.org/d3-js-schemecategory10-method/](https://www.geeksforgeeks.org/d3-js-schemecategory10-method/)

`D3.js`中的`schemeCategory10`方法用于返回十种分类颜色的数组，该数组以RGB十六进制字符串的形式返回。
...
下面的例子说明了`D3.js`中的`schemeCategory10`方法:
