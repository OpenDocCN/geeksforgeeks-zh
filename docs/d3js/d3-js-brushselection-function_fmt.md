# D3.js brushSelection()功能

> 原文: [https://www.geeksforgeeks.org/d3-js-brushselection-function/](https://www.geeksforgeeks.org/d3-js-brushselection-function/)

D3.js 中的 `brushSelection()` 函数用于获取给定节点的画笔选择。
...
在本例中，我们将创建一个笔刷，并将使用此方法获得其选择绑定边。
...
<html>
    ...
    <body>
        ...
        <p style="text-align: center;" id="p"></p>
