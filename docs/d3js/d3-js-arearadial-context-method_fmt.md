...
> 原文: [https://www.geeksforgeeks.org/d3-js-arearadial-context-method/](https://www.geeksforgeeks.org/d3-js-arearadial-context-method/)
...
**返回值:** 该方法返回当前下面给出了`D3.js`中`areaRadial.context()`方法的几个例子:
...
<body>
  ...
  <script>
    ...
    var Gen = d3.areaRadial()
      ...
      // Specify the context to be used
      .context(context);
