# D3.js 插值 `d3.interpolateInferno()` 函数

> 原文: [https://www.geeksforgeeks.org/d3-js-interpolateinferno-function/](https://www.geeksforgeeks.org/d3-js-interpolateinferno-function/)

`D3.js` 中的 `d3.interpolateInferno()` 函数用于从“地狱”顺序配色方案中返回特定颜色，该配色方案以 RGB 字符串的形式返回。
