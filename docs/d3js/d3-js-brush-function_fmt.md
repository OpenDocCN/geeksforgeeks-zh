...
D3.js 中的 `d3.brush()` 函数用来新建一个 2D 画笔。画笔通常是由 SVG 元素创建的。
...
在本例中，我们将使用此方法在 SVG 元素上创建一个大小为 600×600 像素的画笔。
...
画笔创建成功，可以用这个画笔拖动创建矩形。

![](img/35376b593482fb0cb6da77ea17338fdb.png)

**参考：**
- [https://devdocs.io/d3~5/d3-brush#_brush](https://devdocs.io/d3~5/d3-brush#_brush)