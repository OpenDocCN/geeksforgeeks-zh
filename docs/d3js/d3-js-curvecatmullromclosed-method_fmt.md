...
> 原文: [https://www.geeksforgeeks.org/d3-js-curvecatmullromclosed-method/](https://www.geeksforgeeks.org/d3-js-curvecatmullromclosed-method/)

内插器产生一个三次曲线样条。该曲线也基于这些三次曲线样条。这是一个开放曲线，它将数据集中的第一个和最后一个点与一条曲线结合在一起。
