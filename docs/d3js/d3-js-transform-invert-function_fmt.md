...
> 原文: [https://www.geeksforgeeks.org/d3-js-transform-invert-function/](https://www.geeksforgeeks.org/d3-js-transform-invert-function/)

## 函数描述

`D3.js`中的`transform.invert()`函数用于获取指定点的逆变换，该点是一个二元数字数组`[x, y]`。返回的点等于`[(x–t_x)/k, (y–t_y)/k]`。
