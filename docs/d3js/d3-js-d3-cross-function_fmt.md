...
D3.js 中的 `d3.cross()` 函数用于返回给定的两个数组 `A` 和 `B` 的笛卡尔乘积。
...
返回两个给定数组中每个数组的两个元素的笛卡儿积数组。

以下程序说明了 D3.js 中的 `d3.cross()` 功能。
...
**参考:** [https://devdocs.io/d3~4/d3-array#cross](https://devdocs.io/d3~4/d3-array#cross)