...
> 原文: [https://www.geeksforgeeks.org/d3-js-interpolate-array-function/](https://www.geeksforgeeks.org/d3-js-interpolate-array-function/)

`d3.interpolateArray()` 用于对两个数组进行插值，并返回它们之间的插值器。
...
下面给出了 `d3.interpolateArray()` 函数的几个例子。
