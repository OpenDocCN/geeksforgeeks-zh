# D3.js `interpolateLab()` 函数

> 原文: [https://www.geeksforgeeks.org/d3-js-interpolatelab-function/](https://www.geeksforgeeks.org/d3-js-interpolatelab-function/)

D3.js 中的 `interpolateLab()` 函数用于返回两个给定颜色之间的 CIELAB 颜色空间插值器。作为参数给出的颜色不要求是 CIELAB 格式。简单的颜色名称可以稍后给出，它们由内置函数 `d3.lab()` 转换为 CIELAB 格式。
