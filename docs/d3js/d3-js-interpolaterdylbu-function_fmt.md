# D3.js 插值 `interpolateRdYlBu()` 函数

> 原文：[https://www.geeksforgeeks.org/d3-js-interpolaterdylbu-function/](https://www.geeksforgeeks.org/d3-js-interpolaterdylbu-function/)

D3.js 中的 `d3.interpolateRdYlBu()` 函数用于从 RdYlBu 的发散配色方案中返回相应的颜色，其中 Rd 为红色，Yl 为黄色，Bu 为蓝色。
...
下面的例子说明了 JavaScript 中的 D3.js 插值器（interpolator）函数：
