# D3.js bandScale 的 band() 函数

> 原文: [https://www.geeksforgeeks.org/d3-js-bandscale-band-function/](https://www.geeksforgeeks.org/d3-js-bandscale-band-function/)

`d3.js` 库中的 `band()` 函数用于从对应于给定输入域的范围返回波段的起点。
