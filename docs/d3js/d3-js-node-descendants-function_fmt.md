...
> 原文: [https://www.geeksforgeeks.org/d3-js-node-descendants-function/](https://www.geeksforgeeks.org/d3-js-node-descendants-function/)

`d3.js` 库中的 `node.descendants()` 函数用于生成并返回一个后代节点数组。
