# D3.js zoom.translateExtent() 功能

> 原文: [https://www.geeksforgeeks.org/d3-js-zoom-translateextent-function/](https://www.geeksforgeeks.org/d3-js-zoom-translateextent-function/)

`D3.js` 中的 `zoom.translateExtent()` 功能用于将平移范围设置为指定的点数组 `[[左上角, 右下角]]`，并返回该缩放行为。
...
*   `extent`: 此参数用于将平移范围设置为指定的点数组。

## 返回值

该函数返回缩放行为。

以下程序说明了 `D3.js` 中的 `zoom.translateExtent()` 功能。
