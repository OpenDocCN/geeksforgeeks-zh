...
D3.js 中的 `map.set()`函数用于在创建的映射中设置指定键串的值。
...
**注意:** 在上面的代码中，字符串 `"c"` 不存在于创建的地图中，这就是为什么 `undefined` 被打印为输出的原因。

**参考:** [https://devdocs.io/d3~5/d3-collection#map_set](https://devdocs.io/d3~5/d3-collection#map_set)