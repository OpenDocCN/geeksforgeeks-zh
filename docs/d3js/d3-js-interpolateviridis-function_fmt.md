...
> 原文: [https://www.geeksforgeeks.org/d3-js-interpolateviridis-function/](https://www.geeksforgeeks.org/d3-js-interpolateviridis-function/)

D3.js 中的 `d3.interpolateViridis()` 函数用于从“维里迪斯”顺序配色方案中返回特定的颜色，该配色方案以 RGB 字符串的形式返回。
