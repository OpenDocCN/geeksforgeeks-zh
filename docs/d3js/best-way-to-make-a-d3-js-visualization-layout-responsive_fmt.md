...
> 原文：[https://www.geeksforgeeks.org/best-way-to-make-a-d3-js-visualization-layout-responsive/](https://www.geeksforgeeks.org/best-way-to-make-a-d3-js-visualization-layout-responsive/)
...
让我们看看我们已经学习的一些重要概念，这些概念将通过下面的 HTML 代码实现。
...
当窗口大小改变时，创建的图形会调整大小，而不是切割图形的边缘：
