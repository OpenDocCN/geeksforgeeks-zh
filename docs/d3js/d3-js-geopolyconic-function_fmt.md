...
使用 `d3.js` 中的 `geoPolyconic()` 功能绘制美国多坐标投影。
...
该方法根据给定的 JSON 数据创建美国多点投影。

## 示例 1

以下示例创建世界的多曲面投影，中心位于 (0，0) 且无旋转。
...
在下面的示例中，我们将创建世界的多曲面投影，中心位于 (0，-20) 并相对于 Y 轴旋转 90 度。
