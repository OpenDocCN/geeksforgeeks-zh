...
D3.js 中的 `d3.brushX()` 函数用于沿着 x 维度创建一个新的一维笔刷。
...
在本例中，我们将使用此方法在一个 `svg` 元素上创建一个一维笔刷以及大小为 600×600 像素的 x 轴笔刷。
...
<html>
<head>
    <title>D3.js | d3.brushX() Function</title>
...
[https://devdocs.io/d3~5/d3-brush#brushX](https://devdocs.io/d3~5/d3-brush#brushX)