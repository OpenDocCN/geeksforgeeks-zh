...
轴可以使用内置的 D3 函数绘制。它由线条、记号和标签组成。D3.js 中的 `d3.axisTop()` 函数用于创建顶部水平轴。这个函数将为给定的刻度构造一个新的面向顶部的轴生成器，带有空的刻度参数，刻度大小为 6，填充为 3。
...
**参考:** [https://devdocs.io/d3~5/d3-axis#axisTop](https://devdocs.io/d3~5/d3-axis#axisTop)