# D3.js | D3.timeSaturday 函数

> 原文: [https://www.geeksforgeeks.org/d3-js-d3-timesaturday-function/](https://www.geeksforgeeks.org/d3-js-d3-timesaturday-function/)

D3.js 中的 `D3.timeSaturday` 函数用于返回给定起止日期范围内基于周六的所有日期。
...
下面的程序说明了 D3.js 中的 `D3.timeSaturday` 功能:
