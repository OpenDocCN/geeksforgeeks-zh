...
> 原文: [https://www.geeksforgeeks.org/d3-js-d3-timefridays-function/](https://www.geeksforgeeks.org/d3-js-d3-timefridays-function/)

D3.js 中的 `d3.timeFridays()` 函数用于返回给定起止日期范围内基于星期五的所有日期。
...
[https://devdocs.io/d3~5/d3-time#timeFridays](https://devdocs.io/d3~5/d3-time#timeFridays)