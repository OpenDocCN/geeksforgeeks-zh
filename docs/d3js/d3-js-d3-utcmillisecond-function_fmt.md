# D3.js | D3.utcMillisecond 功能

> 原文：`https://www.geeksforgeeks.org/d3-js-d3-utcmillisecond-function/`

D3.js 中的 `D3.utcMillisecond` 函数用于返回协调世界时（UTC）中开始和结束时间给定范围内所有带有日期的毫秒。
...
下面的程序说明了 D3.js 中的 `D3.utcMillisecond` 功能：
...
<html>
<head>
    <title>d3.utcMillisecond Function</title>
...
<script>
    ...
    // Calling the utcMillisecond function without step value
...
<script>
    ...
    // Calling the utcMillisecond function with step value
...
`https://devdocs.io/d3~5/d3-time#timeMillisecond`