# D3.js 插值器 `d3.interpolateRdBu()` 函数

> 原文: [https://www.geeksforgeeks.org/d3-js-interpolaterdbu-function/](https://www.geeksforgeeks.org/d3-js-interpolaterdbu-function/)

D3.js 中的 `d3.interpolateRdBu()` 函数是从 D3.js 中的 RdBu 发散配色方案返回颜色的发散配色方案的一部分，这里 Rd 可以解释为红色，Bu 可以解释为蓝色。请仔细阅读例子，以便更好地理解。
