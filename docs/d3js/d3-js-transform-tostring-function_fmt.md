...
> 原文: [https://www.geeksforgeeks.org/d3-js-transform-tostring-function/](https://www.geeksforgeeks.org/d3-js-transform-tostring-function/)

`D3.js` 中的 `transform.toString()` 函数用于获取表示该变换对应的 SVG 变换的字符串。
