# D3.js | `d3.timeMillisecond` 功能

> 原文: [https://www.geeksforgeeks.org/d3-js-d3-timemillisecond-function/](https://www.geeksforgeeks.org/d3-js-d3-timemillisecond-function/)

D3.js 中的 `d3.timeMillisecond` 函数用于返回给定开始和结束时间范围内所有带有日期的毫秒。
...
下面的程序说明了 D3.js 中的 `d3.timeMillisecond` 功能：
...
[https://devdocs.io/d3~5/d3-time#timeMillisecond](https://devdocs.io/d3~5/d3-time#timeMillisecond)