# D3.js `power.interpolate()` 函数

> 原文：[https://www.geeksforgeeks.org/d3-js-pow-interpolate-function/](https://www.geeksforgeeks.org/d3-js-pow-interpolate-function/)

`power.interpolate()` 函数用于设置范围插值器工厂，该工厂用于为相邻范围的每对值创建插值器。
