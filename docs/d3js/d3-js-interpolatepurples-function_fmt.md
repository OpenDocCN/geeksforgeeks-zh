# D3.js `interpolatePurples()`函数

> 原文：[https://www.geeksforgeeks.org/d3-js-interpolatepurples-function/](https://www.geeksforgeeks.org/d3-js-interpolatepurples-function/)

`d3.interpolatePurples()`函数是 D3.js 中顺序（单一色调）颜色的一部分。该函数用于根据给定参数的不同值返回不同的颜色深浅。
