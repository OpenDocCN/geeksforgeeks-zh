...
> 原文: [https://www.geeksforgeeks.org/d3-js-transform-inverty-function/](https://www.geeksforgeeks.org/d3-js-transform-inverty-function/)

`D3.js`库中的`transform.invertY()`函数用于获取指定`y`坐标的逆变换，`(y–t_y)/k`。
