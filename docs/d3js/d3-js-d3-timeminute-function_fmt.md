...
D3.js 中的 `d3.timeMinute` 功能用于返回在给定的开始和结束时间范围内的所有时间，以分钟为单位。
...
**参考：** [https://devdocs.io/d3~5/d3-time#timeMinute](https://devdocs.io/d3~5/d3-time#timeMinute)