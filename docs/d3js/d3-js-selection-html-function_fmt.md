...
> 原文: [https://www.geeksforgeeks.org/d3-js-selection-html-function/](https://www.geeksforgeeks.org/d3-js-selection-html-function/)
...
*   `value`: 它是将 HTML 设置为文档的字符串类型。

### 返回值：
这个函数不返回任何东西。

## 示例 1:
在下面的代码中，HTML “p” 元素内容被更改为“粗体”文本。
