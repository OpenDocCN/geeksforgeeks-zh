...
D3.js 中的 `d3.utcDays()`函数用于返回协调世界时(UTC)中两个给定日期之间的所有日期。
...
## 示例
下面的程序说明了 D3.js 中的 `d3.utcDays()`功能。
...
**参考:** [https://devdocs.io/d3~5/d3-time#timeDays](https://devdocs.io/d3~5/d3-time#timeDays)