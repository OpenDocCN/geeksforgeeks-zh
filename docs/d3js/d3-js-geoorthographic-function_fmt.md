...
> 原文: [https://www.geeksforgeeks.org/d3-js-geoorthographic-function/](https://www.geeksforgeeks.org/d3-js-geoorthographic-function/)

JavaScript `d3.geoOrthographic()` 函数给我们提供了**方位正投影**投影。当我们想把地球看成一个三维物体，把它的两个半球分开时，这是很有用的。
...
**返回值:** 这个方法从给定的 JSON 数据中创建并返回 `geoOrthographic()` 投影。

让我们看一个例子来理解我们如何使用 `geoOrthographic()` 函数。
