# D3.js `interpolateOrRd()` 函数

> 原文：[https://www.geeksforgeeks.org/d3-js-interpolateorrd-function/](https://www.geeksforgeeks.org/d3-js-interpolateorrd-function/)

D3.js 中的 `d3.interpolateOrRd()` 函数用于从“OrRd”顺序配色方案中返回特定的颜色，该配色方案以 RGB 字符串的形式返回。
