...
D3.js 中的 `d3.selectAll()`函数用于选择与指定选择器字符串匹配的所有元素。
...
**参考:**[https://devdocs.io/d3~5/d3-selection#selectAll](https://devdocs.io/d3~5/d3-selection#selectAll)