...
> 原文：[https://www.geeksforgeeks.org/d3-js-band-bandwidth-function/](https://www.geeksforgeeks.org/d3-js-band-bandwidth-function/)

d3.js 中的 `band.bandwidth()` 函数用来求每个波段的宽度。
