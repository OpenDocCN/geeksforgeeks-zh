...
> 原文: [https://www.geeksforgeeks.org/d3-js-d3-utctuesdays-function/](https://www.geeksforgeeks.org/d3-js-d3-utctuesdays-function/)

D3.js 中的 `d3.utcTuesdays()` 函数用于返回以协调世界时(UTC)中给定的开始和结束日期范围内基于星期二的所有日期。
