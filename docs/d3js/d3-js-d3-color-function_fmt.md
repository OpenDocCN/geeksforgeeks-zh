...
D3.js 中的 `d3.color()`函数用于解析作为函数参数的指定 CSS 颜色，并返回 [RGB](https://www.geeksforgeeks.org/computer-graphics-the-rgb-color-model/) 或 [HSL](https://www.geeksforgeeks.org/html-color-styles-hsl/) 颜色。如果未给出说明符，则返回 `null`。
...
该功能接受单参数`color`，指定 CSS 颜色。

## 返回值

该函数返回作为函数参数的指定 CSS 颜色的 RGB 或 HSL 颜色值。
...
**参考:**[https://devdocs.io/d3~5/d3-color#color](https://devdocs.io/d3~5/d3-color#color)