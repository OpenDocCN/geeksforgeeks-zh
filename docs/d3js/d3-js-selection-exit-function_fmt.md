# D3.js `selection.exit()`功能

> 原文：[https://www.geeksforgeeks.org/d3-js-selection-exit-function/](https://www.geeksforgeeks.org/d3-js-selection-exit-function/)
    ...
    <body>
        ...
        <script>
            ...
            var div = d3
                .select("body")
                .selectAll("div")
                .data(["geeks", "for", "geeks"]) // Old dataset
                .enter()
                .append("div")
                .text(function (d) {
                    return d;
