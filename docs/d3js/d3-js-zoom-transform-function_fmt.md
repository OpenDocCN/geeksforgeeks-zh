...
> 原文: [https://www.geeksforgeeks.org/d3-js-zoom-transform-function/](https://www.geeksforgeeks.org/d3-js-zoom-transform-function/)
...
*   `selection`: 该参数可以是选择，也可以是过渡。
*   `transform`: 该参数可定义为缩放变换或函数。

## 返回值

该函数返回缩放变换。

以下程序说明了 `D3.js` 中的 `zoom.transform()` 功能。
