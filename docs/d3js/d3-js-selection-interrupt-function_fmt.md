# D3.js `selection.interrupt()`功能

> 原文：[https://www.geeksforgeeks.org/d3-js-selection-interrupt-function/](https://www.geeksforgeeks.org/d3-js-selection-interrupt-function/)

`D3.js`中的`selection.interrupt()`功能用于中断所选元素上指定名称的活动转换，并取消任何具有指定名称的未决转换。
...
以下程序说明了`D3.js`中的`selection.interrupt()`功能。
