# D3.js `selection.transition()` 功能

> 原文：[https://www.geeksforgeeks.org/d3-js-selection-transition-function/](https://www.geeksforgeeks.org/d3-js-selection-transition-function/)

`D3.js` 中的 `selection.transition()` 功能用于获取给定选区上具有指定名称的新过渡。新转场仅与其他同名转场独占。
...
以下程序说明了 `D3.js` 中的 `selection.transition()` 功能。
