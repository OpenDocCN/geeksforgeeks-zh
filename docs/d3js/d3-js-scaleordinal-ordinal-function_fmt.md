...
> 原文：[https://www.geeksforgeeks.org/d3-js-scaleordinal-ordinal-function/](https://www.geeksforgeeks.org/d3-js-scaleordinal-ordinal-function/)

`d3.js`库中的`ordinal()`函数用于在给出对应于指定域的输入时从指定范围返回值。
