# D3.js 插值 `d3.interpolateYlGnBu()` 函数

> 原文: [https://www.geeksforgeeks.org/d3-js-interpolateylgnbu-function/](https://www.geeksforgeeks.org/d3-js-interpolateylgnbu-function/)

`d3.js` 中的 `d3.interpolateYlGnBu()` 函数用于返回对应于顺序配色方案的 RGB 颜色字符串。
...
下面的例子说明了 `d3.js` 中的 `d3.interpolateYlGnBu()` 函数:
...
<body>
    ...
    <script>
        ...
        // Values of t is 0.4
        let color1 = d3.interpolateYlGnBu(0.4);
        // Values of t is 0.6
        let color2 = d3.interpolateYlGnBu(0.6);
