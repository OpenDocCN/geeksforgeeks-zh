...
> 原文: [https://www.geeksforgeeks.org/d3-js-axis-ticksizeouter-function/](https://www.geeksforgeeks.org/d3-js-axis-ticksizeouter-function/)

D3.js 中的 `d3.axis.tickSizeOuter()` 函数用于将外刻度尺寸设置为指定值并返回坐标轴。外部刻度尺寸控制从轴的原始位置偏移的域路径的正方形末端的长度。
