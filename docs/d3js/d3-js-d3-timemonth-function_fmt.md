...
> 原文：`https://www.geeksforgeeks.org/d3-js-d3-timemonth-function/`

D3.js 中的 `d3.timeMonth` 函数用于返回日期在给定起止日期范围内的所有月份。
...
**参考：** [https://devdocs.io/d3~5/d3-time#timeMonth](https://devdocs.io/d3~5/d3-time#timeMonth)