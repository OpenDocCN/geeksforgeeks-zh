...
> 原文: [https://www.geeksforgeeks.org/d3-js-interpolatereds-function/](https://www.geeksforgeeks.org/d3-js-interpolatereds-function/)

D3.js 中的 `d3.interpolateReds()` 函数用于返回一个红色范围。简单地说，它根据作为参数给出的整数值返回不同深浅的红色。
