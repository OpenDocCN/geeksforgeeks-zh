...
> 原文: [https://www.geeksforgeeks.org/d3-js-lineradial-defined-method/](https://www.geeksforgeeks.org/d3-js-lineradial-defined-method/)

`d3.lineRadial.defined()`方法允许您指定是否为给定的数据点、角度定义了数据。如果此方法返回`false`，这意味着数据点存在，否则返回`true`。
