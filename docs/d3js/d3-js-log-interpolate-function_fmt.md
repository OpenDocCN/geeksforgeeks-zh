...
> 原文: [https://www.geeksforgeeks.org/d3-js-log-interpolate-function/](https://www.geeksforgeeks.org/d3-js-log-interpolate-function/)

`log.interpolate()`功能用于设置范围插值器工厂，该工厂用于为相邻范围的每对值创建插值器。如果未指定工厂，则返回当前的比例插值工厂。
