...
D3.js 中的 `set.has()` 函数用于当且仅当给定的集合包含指定值的条目时返回 `true`。
...
**参考:** [https://devdocs.io/d3~5/d3-collection#set_has](https://devdocs.io/d3~5/d3-collection#set_has)