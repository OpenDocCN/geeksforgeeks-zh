...
D3.js 中的 `set.empty()`函数用于在给定数组没有元素的情况下返回真，否则返回假。
...
## 参考：
[https://devdocs.io/d3~5/d3-collection#set_empty](https://devdocs.io/d3~5/d3-collection#set_empty)