...
> 原文：[https://www.geeksforgeeks.org/d3-js-interpolatehsllong-function/](https://www.geeksforgeeks.org/d3-js-interpolatehsllong-function/)

D3.js 的 `d3.interpolateHslLong()` 函数和 `d3.interpolateHsl()` 函数几乎一样，两者唯一的区别是这个函数没有使用两种色调之间的最短路径。
...
下面给出了几个 `d3.interpolateHslLong()` 函数的例子。
