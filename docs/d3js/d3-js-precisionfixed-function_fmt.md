...
> 原文: [https://www.geeksforgeeks.org/d3-js-precisionfixed-function/](https://www.geeksforgeeks.org/d3-js-precisionfixed-function/)
...
*   `step`: 步长值表示小数点后需要多少位，例如，0.1 表示输出中小数点后一位，0.001 表示小数点后三位。
