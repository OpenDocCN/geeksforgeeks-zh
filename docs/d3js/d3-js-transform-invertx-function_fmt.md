...
> 原文: [https://www.geeksforgeeks.org/d3-js-transform-invertx-function/](https://www.geeksforgeeks.org/d3-js-transform-invertx-function/)

`D3.js`中的`transform.invertX()`函数用于获取指定x坐标的逆变换，(x–tx)/k。
