...
> 原文: [https://www.geeksforgeeks.org/d3-js-interpolateround-function/](https://www.geeksforgeeks.org/d3-js-interpolateround-function/)

`d3.interpolateRound()` 函数用于返回两个给定数字的插值，并将它们舍入到最接近的整数。
