...
> 原文: [https://www.geeksforgeeks.org/d3-js-stackoffsetexpand-method/](https://www.geeksforgeeks.org/d3-js-stackoffsetexpand-method/)

D3.js 的 `stackOffsetExpand()` 方法应用零基线，并对每个点的值进行标准化，使顶线始终为一。
