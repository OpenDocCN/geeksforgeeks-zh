...
D3.js 中的 `map.keys()` 函数用于为创建的映射中的每个条目返回一个字符串键数组。返回密钥的顺序是任意的。
...
## 参考：
[https://devdocs.io/d3~5/d3-collection#map_keys](https://devdocs.io/d3~5/d3-collection#map_keys)