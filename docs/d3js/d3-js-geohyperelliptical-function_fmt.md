...
> 原文：[https://www.geeksforgeeks.org/d3-js-geohyperelliptical-function/](https://www.geeksforgeeks.org/d3-js-geohyperelliptical-function/)

JavaScript 库 `D3.js` 使用 HTML5、可伸缩矢量图形和级联样式表为网页提供动态的交互式数据可视化。
使用 `d3.js` 库中的 `geoHyperelliptical()` 函数绘制伪圆柱形的等面积 Goode 同质投影。
...
*   `alpha`：它控制圆柱投影的重量，该重量用超椭圆平均。默认值为 0。
*   `gamma`：长宽比。默认值为 1.183136。
