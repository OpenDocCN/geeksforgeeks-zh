...
> 原文: [https://www.geeksforgeeks.org/d3-js-precisionprefix-function/](https://www.geeksforgeeks.org/d3-js-precisionprefix-function/)
...
*   `step`: 它告诉需要格式化的值之间的最小差异。
*   `value`: 这里的值告诉我们给定的数字要使用什么样的 SI 前缀，例如 `M` 代表百万，`G` 代表千兆。
