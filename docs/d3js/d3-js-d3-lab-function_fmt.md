...
D3.js 中的 `d3.lab()` 函数用于构造新的 lab 颜色，并返回指定颜色的‘l’、‘a’和‘b’属性作为函数的参数。
...
该功能接受单参数 `color`，这是指定的 CSS 颜色。

## 返回值

该函数返回作为函数参数的指定 CSS 颜色的‘l’、‘a’和‘b’属性。
...
[https://devdocs.io/d3~5/d3-color#lab](https://devdocs.io/d3~5/d3-color#lab)