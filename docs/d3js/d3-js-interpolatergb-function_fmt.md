...
> 原文: [https://www.geeksforgeeks.org/d3-js-interpolatergb-function/](https://www.geeksforgeeks.org/d3-js-interpolatergb-function/)

`d3.interpolateRgb()`函数用于插值两种颜色，并使用可调的伽马值返回它们之间的插值器。
...
下面给出了几个 `d3.interpolateRgb` 函数的例子。
