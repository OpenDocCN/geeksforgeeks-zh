...
> 原文: [https://www.geeksforgeeks.org/d3-js-interpolateylorrd-function/](https://www.geeksforgeeks.org/d3-js-interpolateylorrd-function/)

`d3.js` 中的 `d3.interpolateYlOrRd()` 函数用于从“YlOrRd”的发散配色方案中返回一个 RGB 颜色字符串。
