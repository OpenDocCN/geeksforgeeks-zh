...
> 原文: [https://www.geeksforgeeks.org/d3-js-continuous-tickformat-function/](https://www.geeksforgeeks.org/d3-js-continuous-tickformat-function/)
...
*   `count`: 是要使用的刻度值的数量。这是一个可选参数。
*   `specifier`: 是指定要使用的格式的字符串。这是一个可选参数。
