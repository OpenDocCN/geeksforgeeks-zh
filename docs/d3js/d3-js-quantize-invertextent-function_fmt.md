...
> 原文: [https://www.geeksforgeeks.org/d3-js-quantize-invertextent-function/](https://www.geeksforgeeks.org/d3-js-quantize-invertextent-function/)

`quantize.invertExtent()` 函数用于返回域 `[x0, x1]` 中存在的值的范围，对应范围内的值。
