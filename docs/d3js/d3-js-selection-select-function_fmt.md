# D3.js `selection.select()`功能

> 原文: [https://www.geeksforgeeks.org/d3-js-selection-select-function/](https://www.geeksforgeeks.org/d3-js-selection-select-function/)
...
*   `selector`: 这是 HTML 容器或 SVG 标签的名称。
