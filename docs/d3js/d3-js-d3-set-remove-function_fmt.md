...
如果给定数组包含指定值，则返回 `true`，否则返回 `false`。

## 注

不更新原数组。

以下程序说明了 D3.js 中的 `d3.set.remove()` 功能。
...
[https://devdocs.io/d3~5/d3-collection#set_remove](https://devdocs.io/d3~5/d3-collection#set_remove)