...
D3.js 中的 `d3.permute()`函数用于用给定的指定索引数组置换给定数组的元素，并返回包含每个给定索引对应元素的数组。
...
在下面的代码中，使用给定的指定索引数组对给定数组的元素进行置换，并返回包含每个给定索引的对应元素的数组。
...
[https://devdocs.io/d3~4/d3-array#permute](https://devdocs.io/d3~4/d3-array#permute)