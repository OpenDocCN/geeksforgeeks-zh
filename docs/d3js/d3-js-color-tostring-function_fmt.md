...
> 原文: [`https://www.geeksforgeeks.org/d3-js-color-tostring-function/`](https://www.geeksforgeeks.org/d3-js-color-tostring-function/)

D3.js 中的 `color.toString()`函数用于根据 CSS 对象模型规范返回表示颜色的字符串。
...
**参考:** [`https://devdocs.io/d3~5/d3-color#color_toString`](https://devdocs.io/d3~5/d3-color#color_toString)