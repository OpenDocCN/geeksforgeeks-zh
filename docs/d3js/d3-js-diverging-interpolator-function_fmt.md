...
> 原文: [https://www.geeksforgeeks.org/d3-js-diverging-interpolator-function/](https://www.geeksforgeeks.org/d3-js-diverging-interpolator-function/)

发散音阶与连续音阶非常相似。唯一的区别是，该标尺的输出范围由插值器固定，因此该范围不可配置。
