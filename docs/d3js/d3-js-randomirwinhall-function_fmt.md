# D3.js randomIrwinHall() 函数

> 原文: [https://www.geeksforgeeks.org/d3-js-randomirwinhall-function/](https://www.geeksforgeeks.org/d3-js-randomirwinhall-function/)

`d3.js` 中的 `d3.randomIrwinHall()` 函数用于基于具有“n”个独立变量的 Irwin-Hall 分布生成随机数。
