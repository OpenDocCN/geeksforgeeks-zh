...
> 原文: [https://www.geeksforgeeks.org/d3-js-interpolateoranges-function/](https://www.geeksforgeeks.org/d3-js-interpolateoranges-function/)

d3.js 中的 `d3.interpolateOranges()` 函数是顺序配色方案的一部分。此函数用于返回与顺序配色方案中的颜色相对应的 `RGB` 字符串。
