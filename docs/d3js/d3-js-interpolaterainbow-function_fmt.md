...
> 原文: [https://www.geeksforgeeks.org/d3-js-interpolaterainbow-function/](https://www.geeksforgeeks.org/d3-js-interpolaterainbow-function/)

函数的作用是：返回一串 RGB 颜色，对应于 0 到 0.5 范围内的 `d3.interpolateColor` 和 0.5 到 1.0 范围内的 `d3.interpolateColor`。因此，它在 `d3.js` 中形成了循环的不太生气的彩虹配色方案。
