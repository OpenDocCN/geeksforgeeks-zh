# D3.js | D3.utcThursday 功能

> 原文: [https://www.geeksforgeeks.org/d3-js-d3-utcthursday-function/](https://www.geeksforgeeks.org/d3-js-d3-utcthursday-function/)

D3.js 中的 `D3.utcThursday` 函数用于返回协调世界时(UTC)中给定的开始和结束日期范围内基于星期四的所有日期。
...
下面的程序说明了 D3.js 中的 `D3.utcThursday` 功能:
...
**参考:** [https://devdocs.io/d3~5/d3-time#timeThursday](https://devdocs.io/d3~5/d3-time#timeThursday)