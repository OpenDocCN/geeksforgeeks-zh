...
> 原文: [https://www.geeksforgeeks.org/d3-js-axis-tickarguments-function/](https://www.geeksforgeeks.org/d3-js-axis-tickarguments-function/)

D3.js 中的 `d3.axis.tickArguments()`函数用于控制轴显示哪些刻度。该函数返回轴生成器。
...
*   `arguments`: 这些参数用于显示刻度数和自定义刻度值的格式。
...
这类似于 `d3.axis.tick()`函数，但在该函数中，所有参数都可以是可选的。
