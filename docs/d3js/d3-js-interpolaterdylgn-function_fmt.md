# D3.js 插值 `d3.interpolateRdYlGn()` 函数

> 原文: [https://www.geeksforgeeks.org/d3-js-interpolaterdylgn-function/](https://www.geeksforgeeks.org/d3-js-interpolaterdylgn-function/)

D3.js 中的 `d3.interpolateRdYlGn()` 函数用于从 RdYlGn 的发散配色方案中返回相应的颜色，其中 Rd 为红色，Yl 为黄色，Gn 为绿色。
