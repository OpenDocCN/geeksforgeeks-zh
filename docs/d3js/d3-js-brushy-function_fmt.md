...
D3.js 中的 `d3.brushY()` 函数用于沿着 y 维创建一个新的一维画笔。
...
在本例中，我们将使用此方法在一个 `svg` 元素上创建一个一维笔刷以及大小为 600×600 像素的 y 轴笔刷。
...
[https://devdocs.io/d3~5/d3-brush#brushY](https://devdocs.io/d3~5/d3-brush#brushY)