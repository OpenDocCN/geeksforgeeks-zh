# D3.js `selection.selectAll()`功能

> 原文: [https://www.geeksforgeeks.org/d3-js-selection-selectall-function/](https://www.geeksforgeeks.org/d3-js-selection-selectall-function/)

`d3.js` 中的 `selection.selectAll()` 函数用于选择与作为参数给出的特定选择器字符串相匹配的所有后代元素。如果没有找到匹配项，则该函数返回 `null`。
