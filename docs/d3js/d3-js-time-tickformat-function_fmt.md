...
> 原文: [https://www.geeksforgeeks.org/d3-js-time-tickformat-function/](https://www.geeksforgeeks.org/d3-js-time-tickformat-function/)
...
*   `count`: 指定刻度值的个数。
*   `specifier`: 是将用作说明符的字符串。它的格式类型为“s”。
