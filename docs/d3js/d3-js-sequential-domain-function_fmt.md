# D3.js sequential.domain() 函数

> 原文: [https://www.geeksforgeeks.org/d3-js-sequential-domain-function/](https://www.geeksforgeeks.org/d3-js-sequential-domain-function/)

**顺序刻度**与连续刻度非常相似。在连续的尺度上，映射在域和范围之间以连续的方式完成。唯一不同的是，该标尺的输出范围由其插值器固定，并且该范围不能改变。

**sequential.domain()** 功能用于设置给定顺序标度的域。域数组总是接受两个数值。
