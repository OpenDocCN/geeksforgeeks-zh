...
D3.js 中的 `d3.scaleBand()`函数用于构造一个新的波段尺度，其域指定为一组值，范围为波段的最小和最大范围。此函数将范围分成 n 个波段，其中 n 是域数组中的值的数量。
...
**参考:** [`https://devdocs.io/d3~5/d3-scale#scaleBand`](https://devdocs.io/d3~5/d3-scale#scaleBand)