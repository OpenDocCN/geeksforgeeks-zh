...
> 原文: [https://www.geeksforgeeks.org/d3-js-time-rangeround-function/](https://www.geeksforgeeks.org/d3-js-time-rangeround-function/)
...
<body>
    ...
    <script>
        ...
        var time = d3.scaleTime()
            ...
            .rangeRound([1, 10])
        document.write("<h3>time(2.4): " + time(2.4) + "</h3>");

        document.write("<h3>time(2): " + time(2) + "</h3>");

        document.write("<h3>time(6.4): " + time(6.4) + "</h3>");

        document.write("<h3>time(4.5): " + time(4.5) + "</h3>");
    </script>
</body>
