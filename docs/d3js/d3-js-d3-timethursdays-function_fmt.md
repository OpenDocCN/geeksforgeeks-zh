...
> 原文: [https://www.geeksforgeeks.org/d3-js-d3-timethursdays-function/](https://www.geeksforgeeks.org/d3-js-d3-timethursdays-function/)

D3.js 中的 `d3.timeThursdays()` 函数用于返回给定起止日期范围内基于周四的所有日期。
...
[https://devdocs.io/d3~5/d3-time#timeThursdays](https://devdocs.io/d3~5/d3-time#timeThursdays)