...
> 原文: [https://www.geeksforgeeks.org/d3-js-interpolateblues-function/](https://www.geeksforgeeks.org/d3-js-interpolateblues-function/)

d3.js 中的 `d3.interpolateBlues()` 函数用于返回一个对应于“蓝色”顺序配色方案的 RGB 颜色字符串。
