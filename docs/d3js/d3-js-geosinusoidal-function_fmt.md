...
该方法根据给定的JSON数据创建正弦投影。

## 示例1

以下示例创建世界的正弦投影，中心位于(0，0)且无旋转。
...
在下面的示例中，我们将创建世界的正弦投影，中心位于(-10，0)，并相对于Y轴旋转90度。
