...
`d3.schemeBrBG[]` 函数是 `d3.js` 中发散配色方案的一部分，用于返回一个 HEX 代码颜色串，该颜色串对应于“BrBG”发散配色方案中的颜色。
...
<body>
    ...
    <script>
        ...
        let color1 = d3.schemeBrBG[10][0];
        let color2 = d3.schemeBrBG[10][1];
        let color3 = d3.schemeBrBG[10][2];
        let color4 = d3.schemeBrBG[10][3];
        let color5 = d3.schemeBrBG[10][4];
