...
> 原文: [https://www.geeksforgeeks.org/d3-js-d3-utcwednesdays-function/](https://www.geeksforgeeks.org/d3-js-d3-utcwednesdays-function/)

D3.js 中的 `d3.utcWednesdays()` 函数用于返回以协调世界时(UTC)中给定的开始和结束日期范围内基于星期三的所有日期。
...
参考: [https://devdocs.io/d3~5/d3-time#timeWednesdays](https://devdocs.io/d3~5/d3-time#timeWednesdays)