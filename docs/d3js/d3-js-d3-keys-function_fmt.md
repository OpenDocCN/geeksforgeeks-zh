...
D3.js 中的 `d3.keys()` 函数用于返回一个包含指定对象的属性名或键的数组或一个关联数组。
...
[https://devdocs.io/d3~5/d3-collection#keys](https://devdocs.io/d3~5/d3-collection#keys)