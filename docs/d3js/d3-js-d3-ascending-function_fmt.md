...
D3.js 中的 `d3.ascending()` 函数是一个内置的自然顺序比较器函数，它接受两个参数并计算它们的自然顺序。
...
下面的程序说明了 D3.js 中的 `d3.ascending()` 功能。
...
**参考:** [https://devdocs.io/d3~5/d3-array#ascending](https://devdocs.io/d3~5/d3-array#ascending)