...
> 原文: [https://www.geeksforgeeks.org/d3-js-threshold-invertextent-function/](https://www.geeksforgeeks.org/d3-js-threshold-invertextent-function/)

`d3.js` 中的 `threshold.invertExtent()` 函数用于返回指定域中值的范围。
