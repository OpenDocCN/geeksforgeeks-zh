...
> 原文: [https://www.geeksforgeeks.org/d3-js-quadraticcurveto-function/](https://www.geeksforgeeks.org/d3-js-quadraticcurveto-function/)

`D3.path.quadraticCurveTo()`函数用于通过某些控制点，将二次贝塞尔曲线段从当前点绘制到某一点。
