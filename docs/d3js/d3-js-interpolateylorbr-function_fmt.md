...
> 原文：[https://www.geeksforgeeks.org/d3-js-interpolateylorbr-function/](https://www.geeksforgeeks.org/d3-js-interpolateylorbr-function/)

`d3.js` 中的 `d3.interpolateYlOrBr()` 函数用于返回一串对应于“YlOrBr”顺序配色方案的 RGB 颜色。
