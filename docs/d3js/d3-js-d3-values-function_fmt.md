...
D3.js 中的 `d3.values()` 函数用于返回包含指定对象属性值的数组或关联数组。
...
**参考:** [https://devdocs.io/d3~5/d3-collection#values](https://devdocs.io/d3~5/d3-collection#values)