# D3.js `selection.property()`函数

> 原文：[https://www.geeksforgeeks.org/d3-js-selection-property-function/](https://www.geeksforgeeks.org/d3-js-selection-property-function/)
