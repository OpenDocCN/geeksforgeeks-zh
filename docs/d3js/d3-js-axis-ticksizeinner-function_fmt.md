...
> 原文: [https://www.geeksforgeeks.org/d3-js-axis-ticksizeinner-function/](https://www.geeksforgeeks.org/d3-js-axis-ticksizeinner-function/)

D3.js 中的 `d3.axis.tickSizeInner()` 函数用于将内部刻度尺寸设置为指定值并返回坐标轴。内部刻度尺寸控制刻度线的长度，从轴的原始位置偏移。
