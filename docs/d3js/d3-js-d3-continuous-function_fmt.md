...
D3.js 中的 `d3.continuous()`函数用于在给定域值的情况下，从范围中返回相应的值。
...
以下程序说明了 D3.js 中的 `d3.continuous()` 功能:
...
**参考:** [https://devdocs.io/d3~5/d3-scale#_continuous](https://devdocs.io/d3~5/d3-scale#_continuous)