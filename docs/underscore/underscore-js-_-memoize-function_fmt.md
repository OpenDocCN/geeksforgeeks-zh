# Underscore.js _.memoize()功能

> 原文：[https://www.geeksforgeeks.org/underscore-js-_-memoize-function/](https://www.geeksforgeeks.org/underscore-js-_-memoize-function/)
...
*   `function`：需要执行的功能。
*   `hashFunction`：是可选参数。哈希函数用于计算存储结果的哈希键。

## 返回值

返回被调用函数的结果。

下面的例子说明了Underscore中的`memoize`功能：
