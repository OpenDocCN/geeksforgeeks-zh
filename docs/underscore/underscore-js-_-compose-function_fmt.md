...
> 原文：[https://www.geeksforgeeks.org/underscore-js-_-compose-function/](https://www.geeksforgeeks.org/underscore-js-_-compose-function/)
...
*   **functions：** 包含要执行的功能列表。

**返回值：** 返回函数列表的组成。

下面的例子说明了 `_.compose()` 函数在下划线中的使用：
