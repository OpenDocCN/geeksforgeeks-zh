# Underscore.js _.noop() 函数

> 原文: [https://www.geeksforgeeks.org/underscore-js-_-noop-function/](https://www.geeksforgeeks.org/underscore-js-_-noop-function/)

`underscore.js` 是一个 JavaScript 库，使得对数组、字符串、对象的操作变得更加容易和便捷。
`_.noop()` 函数用于返回 `undefined`，与传递给它的参数无关。
