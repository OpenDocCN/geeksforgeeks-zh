# 下划线.js _.firstExisting()方法

> 原文: [https://www.geeksforgeeks.org/underscore-js-_-firstexisting-method/](https://www.geeksforgeeks.org/underscore-js-_-firstexisting-method/)
...
**注意:** 这在正常的 JavaScript 中无法工作，因为它需要安装下划线.js contrib 库。可以使用 `npm install underscore-contrib` 来安装下划线.js contrib 库。
