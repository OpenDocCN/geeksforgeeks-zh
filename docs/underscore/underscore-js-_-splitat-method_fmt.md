...
> 原文: [https://www.geeksforgeeks.org/underscore-js-_-splitat-method/](https://www.geeksforgeeks.org/underscore-js-_-splitat-method/)

`_.splitAt()`方法获取一个数组和一个数值索引，并返回一个包含两个数组的新数组，这两个数组是通过在提供的数值索引处拆分原始数组而得到的。
