...
> 原文: [https://www.geeksforgeeks.org/underscore-js-_-create-function/](https://www.geeksforgeeks.org/underscore-js-_-create-function/)

`下划线.js` 是一个 JavaScript 库，它提供了很多有用的函数，在很大程度上有助于编程，比如映射、过滤、调用等，甚至不使用任何内置对象。

`_.create()`函数是 JavaScript 的 `下划线.js` 库中的一个内置函数，用于创建一个新的对象，该对象以所述的 `原型` 和 `道具` 作为其自身属性，并可选择附加。
...
**参考:** [https://underscorejs.org/#create](https://underscorejs.org/#create)