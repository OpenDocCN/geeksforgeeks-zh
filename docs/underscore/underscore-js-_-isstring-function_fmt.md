...
> 原文：[https://www.geeksforgeeks.org/underscore-js-_-isstring-function/](https://www.geeksforgeeks.org/underscore-js-_-isstring-function/)
...
*   `object`：包含需要检查是否为字符串的对象的值。

## 返回值

如果给定的对象元素是字符串，则返回布尔值 `true`，否则返回 `false`。
