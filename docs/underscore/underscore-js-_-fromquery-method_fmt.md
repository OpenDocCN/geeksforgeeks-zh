...
> 原文: [https://www.geeksforgeeks.org/underscore-js-_-fromquery-method/](https://www.geeksforgeeks.org/underscore-js-_-fromquery-method/)
...
*   `URL_Query`: This method uses URL query string for conversion.
