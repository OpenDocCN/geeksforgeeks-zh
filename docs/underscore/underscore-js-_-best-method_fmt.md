...
`_.best()`方法获取一个数组和一个函数，并使用函数的条件从该数组中生成最佳合适值。
...
下划线.js contrib 库可以使用安装 `npm install underscore-contrib`。

### 示例 1

在本例中，我们将从数组中获取最佳值作为最大值。
