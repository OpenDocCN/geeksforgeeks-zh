...
> 原文: [https://www.geeksforgeeks.org/underscore-js-_-curry2-method/](https://www.geeksforgeeks.org/underscore-js-_-curry2-method/)

方法 `_.curry2()` 使用了给定函数的柯里化版本，但是将使用两个参数，不多也不少。
