# 下划线.js _.frequencies()方法

> 原文:[https://www.geeksforgeeks.org/underscore-js-_-frequencies-method/](https://www.geeksforgeeks.org/underscore-js-_-frequencies-method/)

`_.frequencies()`方法获取一个数组，r 返回一个映射对象，其键是数组的元素的值，而值是该数组中出现的键的计数。
