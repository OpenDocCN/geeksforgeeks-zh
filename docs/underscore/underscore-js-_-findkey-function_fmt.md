...
> 原文: [https://www.geeksforgeeks.org/underscore-js-_-findkey-function/](https://www.geeksforgeeks.org/underscore-js-_-findkey-function/)

`_.findKey()` 函数用于返回谓词逻辑或条件返回真值或未定义的键值。谓词函数/条件通过迭代进行转换，以便于简化语法。
