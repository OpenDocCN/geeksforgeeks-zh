...
> 原文: [https://www.geeksforgeeks.org/underscore-js-_-curry3-method/](https://www.geeksforgeeks.org/underscore-js-_-curry3-method/)

方法`_.curry3()`是给定的函数的柯里化版本，但是将精确地处理三个参数，不多也不少。
