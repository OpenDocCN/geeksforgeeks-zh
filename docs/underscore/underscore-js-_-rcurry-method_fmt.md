...
> 原文: [https://www.geeksforgeeks.org/underscore-js-_-rcurry-method/](https://www.geeksforgeeks.org/underscore-js-_-rcurry-method/)

下划线 `_.rCurry()` 方法返回一个给定函数的柯里化版本，在这里从右到左处理参数。
