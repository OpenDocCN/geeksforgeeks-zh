# Underscore.js _.mixin() 功能

> 原文: [https://www.geeksforgeeks.org/underscore-js-_-mixin-function/](https://www.geeksforgeeks.org/underscore-js-_-mixin-function/)

**Underscore.js** 是一个 JavaScript 库，使得对数组、字符串、对象的操作变得更加容易和便捷。`_.mixin()` 函数用于添加额外的功能，并将全局下划线对象扩展到一些特殊的实用函数。
