...
> 原文：[https://www.geeksforgeeks.org/underscore-js-_-partitionby-method/](https://www.geeksforgeeks.org/underscore-js-_-partitionby-method/)

`_.partitionBy()` 方法获取一个数组和一个函数，并根据给定函数的条件生成一个分区数组。
...
*   `array`：要从中创建分区数组的给定数组。
*   `function`：包含数组分区条件的函数。
