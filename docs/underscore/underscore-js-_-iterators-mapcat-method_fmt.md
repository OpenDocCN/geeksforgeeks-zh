# 下划线.js _.iterators.mapcat()方法

> 原文：[https://www.geeksforgeeks.org/underscore-js-_-iterators-mapcat-method/](https://www.geeksforgeeks.org/underscore-js-_-iterators-mapcat-method/)
...
下面的例子说明了JavaScript中的`_.iterators.mapcat()`方法。

## 示例 1

在这个示例中，我们可以看到，通过使用`_.iterators.mapcat()`方法，我们能够得到函数迭代器，通过使用这个方法，可以在与一元函数映射后生成值。
