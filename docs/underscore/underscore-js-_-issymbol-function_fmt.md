...
> 原文：[https://www.geeksforgeeks.org/underscore-js-_-issymbol-function/](https://www.geeksforgeeks.org/underscore-js-_-issymbol-function/)

`下划线.js` 是 JavaScript 中的一个库，使得对数组、字符串、对象的操作变得更加容易和便捷。`_.isSymbol()` 函数用于检查给定对象是否为 JavaScript Symbol 对象。
