...
> 原文: [https://www.geeksforgeeks.org/underscore-js-_-bindall-function/](https://www.geeksforgeeks.org/underscore-js-_-bindall-function/)

`_.bindAll()` 函数在 Underscore.js 中用于绑定对象上的方法数量。每个方法都有一个方法名。使用事件处理程序很方便。
...
*   `object`: 是包含不同方法和功能需要绑定的对象。
*   `methodNames`: 是对象中存在的方法的名称。
...
请在浏览器中通过代码直接使用该代码之前，先链接 Underscore CDN。
