...
**注意:** 这个方法在普通的 JavaScript 中无法工作，因为它需要安装 `underscore-contrib` 库。

`underscore-contrib` 库可以使用 `npm install underscore-contrib --save` 安装。
...
`_.cat()` 方法也可以像处理数组一样处理 `arguments` 对象。
