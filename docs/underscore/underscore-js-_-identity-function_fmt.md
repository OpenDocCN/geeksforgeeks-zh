...
> 原文: [https://www.geeksforgeeks.org/underscore-js-_-identity-function/](https://www.geeksforgeeks.org/underscore-js-_-identity-function/)

**Underscore.js** 是一个 JavaScript 库，使得对数组、字符串、对象的操作变得更加容易和便捷。
`_.identity()` 函数用于返回与参数值完全相同的副本。这个函数看起来没用，但是在整个下划线中作为默认迭代使用。
