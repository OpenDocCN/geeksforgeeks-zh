...
> 原文：[https://www.geeksforgeeks.org/underscore-js-_-isfloat-method/](https://www.geeksforgeeks.org/underscore-js-_-isfloat-method/)

`_.isFloat()`方法检查给定值是否为浮点值，并返回对应的布尔值。
