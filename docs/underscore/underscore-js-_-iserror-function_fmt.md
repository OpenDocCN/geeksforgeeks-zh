...
> 原文: [https://www.geeksforgeeks.org/underscore-js-_-iserror-function/](https://www.geeksforgeeks.org/underscore-js-_-iserror-function/)

`Underscore.js` 是 JavaScript 中的一个库，使得对数组、字符串、对象的操作变得更加容易和便捷。`_.isError()` 函数用于检查给定对象是否为 JavaScript Error Object。
