# Underscore.js _.accessor()方法

> 原文: [https://www.geeksforgeeks.org/underscore-js-_-accessor-method/](https://www.geeksforgeeks.org/underscore-js-_-accessor-method/)
...
*   `field_name`: This method takes the field to be searched in a given object.
