# _.iterators.reject() 方法

> 原文: [https://www.geeksforgeeks.org/underscore-js-_-iterators-reject-method/](https://www.geeksforgeeks.org/underscore-js-_-iterators-reject-method/)
...
下面的例子说明了 JavaScript 中的 `_.iterators.reject()` 方法。

## 示例 1

在这个示例中，我们可以看到，通过使用 `_.iterators.reject()` 方法，每当一元谓词函数每次被调用时，我们都可以从迭代函数中获取 `false` 值。
