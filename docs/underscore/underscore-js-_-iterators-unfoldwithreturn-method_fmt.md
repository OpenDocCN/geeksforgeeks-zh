...
> 原文: [https://www.geeksforgeeks.org/underscore-js-_-iterators-unfoldwithreturn-method/](https://www.geeksforgeeks.org/underscore-js-_-iterators-unfoldwithreturn-method/)
...
**注意:** 要执行以下示例，您必须使用此命令提示符安装 `underscore-contrib` 库，并执行以下命令。
