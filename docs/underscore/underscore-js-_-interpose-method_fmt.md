...
> 原文: [https://www.geeksforgeeks.org/underscore-js-_-interpose-method/](https://www.geeksforgeeks.org/underscore-js-_-interpose-method/)

`_.interpose()`方法获取一个数组和一个元素，并返回一个新的数组，给定的元素插入到原始数组的每个元素之间。
