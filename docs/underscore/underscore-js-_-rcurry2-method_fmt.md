...
> 原文: [https://www.geeksforgeeks.org/underscore-js-_-rcurry2-method/](https://www.geeksforgeeks.org/underscore-js-_-rcurry2-method/)

下划线.js `_.rcurry2()`方法是给定函数的简化版本，其中从右到左最多处理两个参数。
