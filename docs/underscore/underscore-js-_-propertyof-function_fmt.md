# 下划线.js | _.propertyOf()功能属性

> 原文: [https://www.geeksforgeeks.org/underscore-js-_-propertyof-function/](https://www.geeksforgeeks.org/underscore-js-_-propertyof-function/)

`_.propertyOf()`函数是`_.property()`函数的逆函数。此函数将对象作为参数，并返回一个函数，该函数将返回所提供属性的值。
