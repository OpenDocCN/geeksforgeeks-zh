...
> 原文：[https://www.geeksforgeeks.org/underscore-js-_-ismap-function/](https://www.geeksforgeeks.org/underscore-js-_-ismap-function/)
...
返回布尔值。如果对象是 JavaScript 的 Map，则返回 `true`，否则函数返回 `false`。
