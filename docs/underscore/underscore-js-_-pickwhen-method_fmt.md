...
> 原文: [https://www.geeksforgeeks.org/underscore-js-_-pickwhen-method/](https://www.geeksforgeeks.org/underscore-js-_-pickwhen-method/)
...
*   `Object_name`: 从中选取键/值对的对象。
*   `predicate_func`: 包含属性条件的给定函数将被选取。
