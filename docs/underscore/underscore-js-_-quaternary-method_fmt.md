...
> 原文: [https://www.geeksforgeeks.org/underscore-js-_-quaternary-method/](https://www.geeksforgeeks.org/underscore-js-_-quaternary-method/)

下划线 `_.quaternary()` 方法返回一个新的函数，该函数只接受四个参数，并将这些参数传递给给定的函数。其他参数将被丢弃。
