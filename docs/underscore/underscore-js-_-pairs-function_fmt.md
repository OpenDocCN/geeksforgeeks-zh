...
> 原文: [https://www.geeksforgeeks.org/underscore-js-_-pairs-function/](https://www.geeksforgeeks.org/underscore-js-_-pairs-function/)

`_.pairs()` 函数用于将一个对象转换成 `[key, value]` 对。
