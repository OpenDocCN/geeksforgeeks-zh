...
> 原文: [https://www.geeksforgeeks.org/underscore-js-_-isindexed-method/](https://www.geeksforgeeks.org/underscore-js-_-isindexed-method/)

`_.isIndexed()` 方法检查给定值是否可以被认为是“Indexed”，并返回对应的布尔值。索引值是接受数值索引来访问其元素的值。
