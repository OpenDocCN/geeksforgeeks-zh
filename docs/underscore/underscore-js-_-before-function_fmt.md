...
> 原文: [https://www.geeksforgeeks.org/underscore-js-_-before-function/](https://www.geeksforgeeks.org/underscore-js-_-before-function/)
...
请在浏览器中通过代码直接使用该代码之前，先链接`下划线 CDN`。
