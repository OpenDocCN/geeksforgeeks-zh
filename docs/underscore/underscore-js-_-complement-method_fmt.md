...
> 原文: [https://www.geeksforgeeks.org/underscore-js-_-complement-method/](https://www.geeksforgeeks.org/underscore-js-_-complement-method/)

`_.complement()` 方法返回一个与给定谓词函数的意义相反的函数。
