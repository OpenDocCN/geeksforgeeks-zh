...
> 原文: [https://www.geeksforgeeks.org/underscore-js-_-allkeys-function/](https://www.geeksforgeeks.org/underscore-js-_-allkeys-function/)
...
下面的例子说明了 `_.allKeys()` 函数在 Underscore.js 中:
