...
> 原文:[https://www.geeksforgeeks.org/underscore-js-_-haspath-method/](https://www.geeksforgeeks.org/underscore-js-_-haspath-method/)

`_.hasPath()` 方法返回一个布尔值，指示在给定的键描述的路径上是否有属性。键可以以数组或点分隔字符串的形式给出。
