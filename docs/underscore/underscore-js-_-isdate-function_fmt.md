# Underscore.js _.isDate() 函数

> 原文: [https://www.geeksforgeeks.org/underscore-js-_-isdate-function/](https://www.geeksforgeeks.org/underscore-js-_-isdate-function/)

`Underscore.js` 是一个 JavaScript 库，足以轻松高效地处理数组、字符串、对象、映射、集合。`_.isDate()` 函数用于判断给定的对象是否是日期对象。
...
**注意:** 请在浏览器中通过代码直接使用该代码之前，先链接 Underscore CDN。
