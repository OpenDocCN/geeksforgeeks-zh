...
> 原文: [https://www.geeksforgeeks.org/underscore-js-_-iterators-slice-method/](https://www.geeksforgeeks.org/underscore-js-_-iterators-slice-method/)
...
**注意:** 要执行以下示例，您必须安装 `underscore-contrib` 库。通过使用此命令提示符，我们必须执行以下命令。
