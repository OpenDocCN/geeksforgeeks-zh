...
> 原文: [https://www.geeksforgeeks.org/how-to-troubleshoot-common-http-error-codes/](https://www.geeksforgeeks.org/how-to-troubleshoot-common-http-error-codes/)
...
此类中的 HTTP 状态代码是临时的，由服务器在发送任何完整的第二个响应之前发送。
...
此类中的 HTTP 状态代码表示需要在客户端执行额外的操作才能完成请求。
...
此类中的 HTTP 状态代码表示技术上由客户端请求问题导致的错误。
...
此类中的 HTTP 状态代码表示服务器意识到它遇到了错误或无法执行请求。
