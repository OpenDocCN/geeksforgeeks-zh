...
*   `< Type >:` The default authentication type saved in this instruction is `Basic` , and the other types are `iana registration authentication scheme` and AWS server authentication (AWS 4-HMAC-SHA256)
