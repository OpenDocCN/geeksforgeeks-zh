...
> 原文：[https://www.geeksforgeeks.org/classification-of-context-free-grammars/](https://www.geeksforgeeks.org/classification-of-context-free-grammars/)

`CFG`（上下文无关语法）可根据以下两个属性进行分类：
...
**注：** 线性语法是一种上下文无关的语法，在其每个产生式的右侧最多有一个非终结符。
