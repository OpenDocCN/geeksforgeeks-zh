...
> 原文：`https://www.geeksforgeeks.org/recursive-descent-parser/`

## 先决条件

- [构建 LL(1)解析表](https://www.geeksforgeeks.org/compiler-design-construction-of-ll1-parsing-table/)
- [自上而下解析器的分类](https://www.geeksforgeeks.org/compiler-design-classification-top-parsers/)
