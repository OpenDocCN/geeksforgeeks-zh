...
> 原文：[https://www.geeksforgeeks.org/cpp-program-to-implement-symbol-table/](https://www.geeksforgeeks.org/cpp-program-to-implement-symbol-table/)

## 先决条件

[符号表](https://www.geeksforgeeks.org/symbol-table-compiler/)
...
下面是符号表的C++实现，使用了[散列和单独链接](https://www.geeksforgeeks.org/hashing-set-2-separate-chaining/)的概念：
```cpp
