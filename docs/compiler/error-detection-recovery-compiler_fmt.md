...
> 原文：[https://www.geeksforgeeks.org/error-detection-recovery-compiler/](https://www.geeksforgeeks.org/error-detection-recovery-compiler/)
...
关键字 `switch` 被错误地写成 `swich`。因此，出现“未识别关键字/标识符”错误。
