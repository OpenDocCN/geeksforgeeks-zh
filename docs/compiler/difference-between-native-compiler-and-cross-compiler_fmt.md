...
> 原文：[https://www.geeksforgeeks.org/difference-between-native-compiler-and-cross-compiler/](https://www.geeksforgeeks.org/difference-between-native-compiler-and-cross-compiler/)
...
| 它可以生成像 `.可执行程序` 的扩展名 | 它可以生成原始代码 `.十六进制` |
| `Turbo` 或 `GCC` 是原生编译器。 | `Keil` 是一个交叉编译器。 |