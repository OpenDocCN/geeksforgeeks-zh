...
> 原文: [https://www.geeksforgeeks.org/lex-program-to-check-if-a-date-is-valid-or-not/](https://www.geeksforgeeks.org/lex-program-to-check-if-a-date-is-valid-or-not/)

## 问题:
写一个 Lex 程序，检查一个日期是否有效。
