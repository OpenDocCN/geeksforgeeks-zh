...
> 原文: [https://www.geeksforgeeks.org/lex-program-to-search-a-word-in-a-file/](https://www.geeksforgeeks.org/lex-program-to-search-a-word-in-a-file/)

## 问题
写一个 Lex 程序在文件中搜索一个单词。
