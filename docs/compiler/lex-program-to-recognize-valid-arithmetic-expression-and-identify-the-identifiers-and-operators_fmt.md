...
> 原文: [https://www.geeksforgeeks.org/lex-program-to-recognize-valid-arithmetic-expression-and-identify-the-identifiers-and-operators/](https://www.geeksforgeeks.org/lex-program-to-recognize-valid-arithmetic-expression-and-identify-the-identifiers-and-operators/)

## 问题
编写 Lex 程序，识别有效的算术表达式，识别标识符和运算符。
