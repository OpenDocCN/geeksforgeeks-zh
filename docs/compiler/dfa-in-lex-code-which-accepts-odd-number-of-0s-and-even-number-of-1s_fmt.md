...
> 原文: [https://www.geeksforgeeks.org/dfa-in-lex-code-which-accepts-odd-number-of-0s-and-even-number-of-1s/](https://www.geeksforgeeks.org/dfa-in-lex-code-which-accepts-odd-number-of-0s-and-even-number-of-1s/)

先决条件: [设计有限自动机](https://www.geeksforgeeks.org/dfa-machines-accepting-odd-number-of-0s-or-and-even-number-of-1s/)

## 问题
设计一个 LEX 代码来构造一个 DFA，该 DFA 接受以下语言: 在输入“0”和“1”上所有奇数为 0、偶数为 1 的字符串。
