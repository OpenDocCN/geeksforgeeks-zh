...
> 原文: [https://www.geeksforgeeks.org/yacc-program-to-recognize-string-with-grammar-anbn-n0/](https://www.geeksforgeeks.org/yacc-program-to-recognize-string-with-grammar-anbn-n0/)

## 问题
编写 YACC 程序识别带语法的字符串{ a<sup>n</sup>b<sup>n</sup> | n≥0 }。
