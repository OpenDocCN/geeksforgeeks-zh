...
> 原文: [https://www.geeksforgeeks.org/lex-program-to-count-the-positive-numbers-negative-numbers-and-fractions/](https://www.geeksforgeeks.org/lex-program-to-count-the-positive-numbers-negative-numbers-and-fractions/)

## 问题
写一个 Lex 程序，计算正数、负数和分数。
