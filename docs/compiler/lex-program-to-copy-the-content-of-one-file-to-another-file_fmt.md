...
> 原文: [https://www.geeksforgeeks.org/lex-program-to-copy-the-content-of-one-file-to-another-file/](https://www.geeksforgeeks.org/lex-program-to-copy-the-content-of-one-file-to-another-file/)

## 问题
给定一个文本文件作为输入，任务是将给定文件的内容复制到另一个文件。
