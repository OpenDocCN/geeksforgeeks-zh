# matplotlib.pyplot.summer() 用法

> 原文: [matplotlib.pyplot.summer() in Python](https://www.geeksforgeeks.org/matplotlib-pyplot-summer-in-python/)
...
`matplotlib` 库 `pyplot` 模块中的 `summer()` 函数用于将 colormap 设置为“summer”。
