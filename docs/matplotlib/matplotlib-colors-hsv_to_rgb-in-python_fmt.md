...
> 原文: [https://www.geeksforgeeks.org/matplotlib-colors-hsv_to_rgb-in-python/](https://www.geeksforgeeks.org/matplotlib-colors-hsv_to_rgb-in-python/)
...
> **语法:** `matplotlib.colors.hsv_to_rgb(HSV)`
>
> **参数:**
>
