...
> 原文：[https://www.geeksforgeeks.org/matplotlib-axes-axes-add_callback-in-python/](https://www.geeksforgeeks.org/matplotlib-axes-axes-add_callback-in-python/)
...
## matplotlib.axes.Axes.add_callback() 方法

matplotlib 库的 axes 模块中的 `add_callback()` 方法用于获取每次出图命令后是否重绘。
...
下面的例子说明了 matplotlib 中的 `matplotlib.axes.Axes.add_callback()` 函数：
