...
> 原文: [https://www.geeksforgeeks.org/matplotlib-axis-axis-set_gid-function-in-python/](https://www.geeksforgeeks.org/matplotlib-axis-axis-set_gid-function-in-python/)
...
`matplotlib` 库的 `Axis` 模块中的 `Axis.set_gid()` 函数用于设置艺术家的(组)id。
...
以下示例说明 `matplotlib.axis.Axis.set_gid()` 函数在 `matplotlib.axis` 中的使用:
