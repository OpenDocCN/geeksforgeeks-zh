...
> 原文：[https://www.geeksforgeeks.org/make-a-violin-plot-in-python-using-matplotlib/](https://www.geeksforgeeks.org/make-a-violin-plot-in-python-using-matplotlib/)
...
`violinplot(数据集，位置=无，垂直=真，宽度=0.5，显示平均值=假，显示极值=真，显示中间值=假，分位数=无，点数=100，bw_method=无，*数据=无)`
