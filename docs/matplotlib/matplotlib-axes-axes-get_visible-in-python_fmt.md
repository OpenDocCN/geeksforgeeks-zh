# Python 中的 `matplotlib.axes.Axes.get_visible()`

> 原文: [https://www.geeksforgeeks.org/matplotlib-axes-axes-get_visible-in-python/](https://www.geeksforgeeks.org/matplotlib-axes-axes-get_visible-in-python/)
...
## `matplotlib.axes.Axes.get_visible()` 函数

`matplotlib` 库的 `Axes` 模块中的 `Axes.get_visible()` 函数用于获取可见性。
...
下面的例子说明了 `matplotlib.axes.Axes.get_visible()` 函数在 `matplotlib.axes` 中的作用：
