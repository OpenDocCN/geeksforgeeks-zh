...
> 原文: [https://www.geeksforgeeks.org/plot-2-d-histogram-in-python-using-matplotlib/](https://www.geeksforgeeks.org/plot-2-d-histogram-in-python-using-matplotlib/)
...
> `matplotlib.pyplot.hist2d(x, y, bin=(NX, ny), range=None, density=False, weights=None, cmin=None, cmax=None, cmap=value)`
