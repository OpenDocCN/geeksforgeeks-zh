# Python 中的 matplotlib.axes.Axes.get_rasterized()

> 原文: [https://www.geeksforgeeks.org/matplotlib-axes-axes-get_rasterized-in-python/](https://www.geeksforgeeks.org/matplotlib-axes-axes-get_rasterized-in-python/)
...
## matplotlib.axes.Axes.get_rasterized() 函数

`matplotlib` 库的 `Axes` 模块中的 `axes.get_rasterized()` 函数用于获取艺术家是否要栅格化。

### 语法
`Axes.get_rasterized(self)`
...
下面的例子说明了 `matplotlib.axes.Axes.get_rasterized()` 函数在 `matplotlib.axes` 中的作用：
