...
> 原文: [https://www.geeksforgeeks.org/how-to-add-a-grid-on-a-figure-in-matplotlib/](https://www.geeksforgeeks.org/how-to-add-a-grid-on-a-figure-in-matplotlib/)
...
>
> *   `b` : 布尔或无，是否显示网格线的可选参数。
> *   `which` : { 'major', 'minor', 'both' }，可选。它指定要应用更改的网格线。
> *   `axis` : {'both', 'x', 'y'}，可选。要应用更改的轴。
