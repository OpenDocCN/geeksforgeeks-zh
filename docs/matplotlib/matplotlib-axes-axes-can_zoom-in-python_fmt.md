# matplotlib.axes.Axes.can_zoom() 用法详解

> 原文: [https://www.geeksforgeeks.org/matplotlib-axes-axes-can_zoom-in-python/](https://www.geeksforgeeks.org/matplotlib-axes-axes-can_zoom-in-python/)
...
`matplotlib` 库的 `Axes` 模块中的 `Axes.can_zoom()` 函数用于检查轴是否支持任何缩放框按钮功能。

> **语法:** `Axes.can_zoom(self)`
>
> **参数:** 此方法不接受任何参数。
>
> **返回值:** 如果支持任何缩放框按钮功能，该方法返回布尔值 `True`。

以下示例说明 `matplotlib.axes.Axes.can_zoom()` 函数在 `matplotlib.axes` 中的用法：
