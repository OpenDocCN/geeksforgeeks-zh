...
>
> **返回(`cid`):** 一个可以与 `figure.canvas.mpl_disconnect` 一起使用的连接 id。
...
![](img/dd894ae461d01f9fee7006972170bcc1.png)
...
![](img/7994cea96b215a3d7d0eb50343dd9037.png)

![](img/37bcb5cb3a342570f71ece9503ad57b1.png)