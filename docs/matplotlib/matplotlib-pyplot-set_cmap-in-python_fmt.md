# Matplotlib.pyplot.set_cmap() 用法详解

> 原文: [https://www.geeksforgeeks.org/matplotlib-pyplot-set_cmap-in-python/](https://www.geeksforgeeks.org/matplotlib-pyplot-set_cmap-in-python/)
