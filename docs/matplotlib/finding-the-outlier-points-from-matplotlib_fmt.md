...
> 原文: [https://www.geeksforgeeks.org/finding-the-outlier-points-from-matplotlib/](https://www.geeksforgeeks.org/finding-the-outlier-points-from-matplotlib/)
...
1.  通过 `matplotlib` 的 `boxplot` 进行可视化，使用 `plt.boxplot()`。
2.  使用 1.5 IQR 规则。
