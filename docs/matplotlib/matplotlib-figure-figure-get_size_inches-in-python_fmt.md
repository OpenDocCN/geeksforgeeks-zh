# Python 中的 `matplotlib.figure.Figure.get_size_inches()`

> 原文: [https://www.geeksforgeeks.org/matplotlib-figure-figure-get_size_inches-in-python/](https://www.geeksforgeeks.org/matplotlib-figure-figure-get_size_inches-in-python/)
...
## `matplotlib.figure.Figure.get_size_inches()` 方法

利用 `matplotlib` 库的 `get_size_inches()` 方法图形模块获取当前图形的尺寸，单位为英寸。
...
下面的例子说明了 `matplotlib.figure.Figure.get_size_inches()` 函数在 `matplotlib.figure` 中的作用:
