# Python 中的 matplotlib.axes.axes.set_axisbelow()

> 原文: [https://www.geeksforgeeks.org/matplotlib-axes-axes-set_axisbelow-in-python/](https://www.geeksforgeeks.org/matplotlib-axes-axes-set_axisbelow-in-python/)
...
> **参数:** 该方法只接受一个参数。
>
> *   `b`: 此参数包含一个布尔值，其可能值为：`True`、`False` 或 `"line"`。
>
> **返回:** 这个方法不返回任何东西。

下面的例子说明了 `matplotlib.axes.axes.set_axisbelow()` 函数在 `matplotlib.axes` 中的作用：
