# Python中的matplotlib.axes.axes.angle_spectrum()

> 原文：[https://www.geeksforgeeks.org/matplotlib-axes-axes-angle_spectrum-in-python/](https://www.geeksforgeeks.org/matplotlib-axes-axes-angle_spectrum-in-python/)
...
## matplotlib.axes.axes.angle_spectrum()函数

matplotlib库的Axes模块中的`Axes.angle_spectrum()`函数用于绘制角度谱。
