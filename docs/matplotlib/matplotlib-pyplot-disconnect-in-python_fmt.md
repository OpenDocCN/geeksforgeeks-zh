# Matplotlib.pyplot.disconnect() 在 Python 中的使用

> 原文: [https://www.geeksforgeeks.org/matplotlib-pyplot-disconnect-in-python/](https://www.geeksforgeeks.org/matplotlib-pyplot-disconnect-in-python/)

[Matplotlib](https://www.geeksforgeeks.org/python-introduction-matplotlib/) 是 Python 中的一个库，是 NumPy 库的数值-数学扩展。[Pyplot](https://www.geeksforgeeks.org/pyplot-in-matplotlib/) 是一个基于状态的接口到 `Matplotlib` 模块，它提供了一个类似于 MATLAB 的接口。

## `matplotlib.pyplot.disconnect()` 函数

`matplotlib` 库 `pyplot` 模块中的 `disconnect()` 函数用于断开 ID 为 `cid` 的回调。
