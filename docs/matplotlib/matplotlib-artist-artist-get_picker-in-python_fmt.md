...
> 原文：[https://www.geeksforgeeks.org/matplotlib-artist-artist-get_picker-in-python/](https://www.geeksforgeeks.org/matplotlib-artist-artist-get_picker-in-python/)
...
`matplotlib`库的`artist`模块中的`get_picker()`方法用于定义艺术家的拾取行为。
