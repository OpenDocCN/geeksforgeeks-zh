...
> 原文: [https://www.geeksforgeeks.org/matplotlib-axes-axes-set_snap-in-python/](https://www.geeksforgeeks.org/matplotlib-axes-axes-set_snap-in-python/)
...
`matplotlib.axes.Axes` 模块中的 `Axes.set_snap()` 函数用于设置捕捉行为。

> **语法:** `Axes.set_snap(self, snap)`
>
> **参数:** 该方法只接受一个参数。
>
> *   `snap`: 此参数包含布尔值或 `None`。
