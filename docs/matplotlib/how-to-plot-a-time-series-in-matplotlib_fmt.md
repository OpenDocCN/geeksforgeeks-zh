...
> 原文: [https://www.geeksforgeeks.org/how-to-plot-a-time-series-in-matplotlib/](https://www.geeksforgeeks.org/how-to-plot-a-time-series-in-matplotlib/)
...
我们也可以使用 [`xticks()`](https://www.geeksforgeeks.org/matplotlib-pyplot-xticks-in-python/) 函数来旋转坐标轴。
...
*   [`plt.plot()`](https://www.geeksforgeeks.org/matplotlib-pyplot-plot-function-in-python/) 方法用于绘制 matplotlib 中的图形。
...
同样，我们可以绘制两个数据帧的时间序列并进行比较。假设我们有两个学院——“XYZ”和“ABC”。现在我们需要用 matplotlib 的时间序列图来比较这两个。
