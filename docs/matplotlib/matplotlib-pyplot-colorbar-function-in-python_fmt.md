...
> 原文: [https://www.geeksforgeeks.org/matplotlib-pyplot-colorbar-function-in-python/](https://www.geeksforgeeks.org/matplotlib-pyplot-colorbar-function-in-python/)
...
>   - **彩条属性:**
>     - `extend`: `{"neither", "both", "min", "max"}` 为超出范围的值制作尖头端。
>     - `label`: 彩条长轴上的标签。
>     - `ticks`: `None` 或刻度或定位器列表。
>
