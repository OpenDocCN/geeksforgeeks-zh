...
> 原文: [https://www.geeksforgeeks.org/matplotlib-pyplot-subplot_tool-in-python/](https://www.geeksforgeeks.org/matplotlib-pyplot-subplot_tool-in-python/)
...
`matplotlib` 库 `pyplot` 模块中的 `subplot_tool()` 函数用于启动一个图形的子图工具窗口。
