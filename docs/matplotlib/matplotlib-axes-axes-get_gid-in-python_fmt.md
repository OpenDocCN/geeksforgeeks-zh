# matplotlib.axes.Axes.get_gid() 用法详解

> 原文：[https://www.geeksforgeeks.org/matplotlib-axes-axes-get_gid-in-python/](https://www.geeksforgeeks.org/matplotlib-axes-axes-get_gid-in-python/)
...
`matplotlib` 库的 `Axes` 模块中的 `Axes.get_gid()` 函数用于获取组 id。
