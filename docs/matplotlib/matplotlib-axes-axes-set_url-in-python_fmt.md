...
> 原文：[https://www.geeksforgeeks.org/matplotlib-axes-axes-set_url-in-python/](https://www.geeksforgeeks.org/matplotlib-axes-axes-set_url-in-python/)
...
`matplotlib` 库的 `Axes` 模块中的 `Axes.set_url()` 函数用于为艺术家设置 url。
