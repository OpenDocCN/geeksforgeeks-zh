# Python中的matplotlib.axes.Axes.set_clip_on()

> 原文：[https://www.geeksforgeeks.org/matplotlib-axes-axes-set_clip_on-in-python/](https://www.geeksforgeeks.org/matplotlib-axes-axes-set_clip_on-in-python/)
...
## matplotlib.axes.Axes.set_clip_on()函数

`matplotlib`库的`Axes`模块中的`Axes.set_clip_on()`函数用于设置艺术家是否使用剪裁。
...
下面的例子说明了`matplotlib.axes.Axes.set_clip_on()`函数在`matplotlib.axes`中的作用：
