...
> 原文: [https://www.geeksforgeeks.org/matplotlib-axes-axes-axis-in-python/](https://www.geeksforgeeks.org/matplotlib-axes-axes-axis-in-python/)
...
`matplotlib.axes.Axes.axis()` 函数是 `matplotlib` 库的 `Axes` 模块中的一个便捷方法，用于获取或设置一些轴属性。
