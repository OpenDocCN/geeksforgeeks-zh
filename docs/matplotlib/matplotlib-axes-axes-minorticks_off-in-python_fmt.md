# Python 中的 `matplotlib.axes.Axes.minorticks_off()`

> 原文: [https://www.geeksforgeeks.org/matplotlib-axes-axes-minorticks_off-in-python/](https://www.geeksforgeeks.org/matplotlib-axes-axes-minorticks_off-in-python/)
...
## `matplotlib.axes.Axes.minorticks_off()` 函数

`matplotlib` 库的 `Axes` 模块中的 `axes.minorticks_off()` 函数用于去除轴上的小记号。
...
使用 `minorticks_on()` 功能后，如果使用该功能，将显示任何变化或效果。

下面的例子说明了 `matplotlib.axes.Axes.minorticks_off()` 函数在 `matplotlib.axes` 中的作用：
