...
> 原文: [https://www.geeksforgeeks.org/matplotlib-axis-axis-get_units-function-in-python/](https://www.geeksforgeeks.org/matplotlib-axis-axis-get_units-function-in-python/)

[`Matplotlib`](https://www.geeksforgeeks.org/python-introduction-matplotlib/) 是 Python 中的一个库，是 `NumPy` 库的数值-数学扩展。这是一个神奇的 Python 可视化库，用于 2D 数组图，并用于处理更广泛的 `SciPy` 堆栈。

## `Matplotlib.axis.Axis.get_units()` 函数

`matplotlib` 库的轴模块中的 `Axis.get_units()` 函数用于获取轴的单位。
...
以下示例说明 `matplotlib.axis.Axis.get_units()` 函数在 `matplotlib.axis` 中的用法：
