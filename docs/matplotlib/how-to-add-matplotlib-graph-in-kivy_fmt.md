...
> 原文: [https://www.geeksforgeeks.org/how-to-add-matplotlib-graph-in-kivy/](https://www.geeksforgeeks.org/how-to-add-matplotlib-graph-in-kivy/)
...
*   导入 `numpy`
*   导入 `FigureCanvasKivyAgg` (来自 `kivy.garden.matplotlib`)
*   导入 `kivy.app`
*   导入 `kivy.lang`
*   创建应用程序类
*   返回生成器字符串
