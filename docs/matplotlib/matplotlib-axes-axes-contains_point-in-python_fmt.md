...
> 原文: [https://www.geeksforgeeks.org/matplotlib-axes-axes-contains_point-in-python/](https://www.geeksforgeeks.org/matplotlib-axes-axes-contains_point-in-python/)
...
> **语法:** `Axes.contains_point(self, point)`
>
> **参数:** 该方法只接受一个参数。
>
> - **point:** 该参数为像素坐标对。
