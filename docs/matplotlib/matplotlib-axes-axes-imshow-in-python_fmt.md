# matplotlib.axes.imshow() 中的 Python
...
> **语法:**
>
> > `Axes.imshow(self, X, cmap=None, norm=None, aspect=None, interpolation=None, alpha=None, vmin=None, vmax=None, origin=None, extent=None, shape=None, filternorm=1, filterrad=4.0, imlim=None, resample=None, url=None, *, data=None, **kwargs)`
>
> **参数:**该方法接受以下描述的参数:
>
> *   `X:` 这个参数是图像的数据。
