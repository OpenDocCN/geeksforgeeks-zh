...
> 原文: [https://www.geeksforgeeks.org/how-to-save-a-plot-to-a-file-using-matplotlib/](https://www.geeksforgeeks.org/how-to-save-a-plot-to-a-file-using-matplotlib/) 保存绘图到文件
...
> **语法:** `pyplot.savefig(fname, dpi=None, facecolor='w', edgecolor='w', orientation='portrait', papertype=None, format=None, transparent=False, bbox_inches=None, pad_inches=0.1, frameon=None, metadata=None)`
>
> **参数:**
>
...
> *   `edgecolor` : 图的边缘颜色
> *   `orientation` : 横向或纵向
> *   `format` : 文件格式，如‘png’、‘pdf’、‘SVG’等。
> *   `transparent` : 如果为真，那么轴的面片都是透明的
