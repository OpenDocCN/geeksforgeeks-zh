...
matplotlib 库 pyplot 模块中的 `inferno()` 函数用于将 colormap 设置为 “inferno”。

> **语法:** `matplotlib.pyplot.inferno()`
>
> **参数:** 该方法不接受任何参数。
>
> **返回:** 该方法不返回值。

下面的例子说明了 `matplotlib.pyplot.inferno()` 函数在 `matplotlib.pyplot` 中的作用:
