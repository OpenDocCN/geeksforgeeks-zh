...
> 原文: [https://www.geeksforgeeks.org/how-to-export-matplotlib-plot-with-transparent-background-in-python/](https://www.geeksforgeeks.org/how-to-export-matplotlib-plot-with-transparent-background-in-python/)
...
*   `transparent` 设置为 `True` 时，用于获取透明背景

## 示例 1

Python 代码，用数据帧的两个数据点创建图并导出。
...
使用数据框的 3 个数据点创建绘图并将其导出的 Python 代码。
