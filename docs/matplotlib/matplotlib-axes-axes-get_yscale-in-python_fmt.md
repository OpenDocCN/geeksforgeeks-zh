...
> 原文: [https://www.geeksforgeeks.org/matplotlib-axes-axes-get_yscale-in-python/](https://www.geeksforgeeks.org/matplotlib-axes-axes-get_yscale-in-python/)
...
## matplotlib.axes.axes.get_yscale() 函数

`matplotlib` 库的 `Axes` 模块中的 `Axes.get_yscale()` 函数用于获取字符串形式的 y 轴比例。
...
下面的例子说明了 `matplotlib.axes.axes.get_yscale()` 函数在 `matplotlib.axes` 中的作用：
