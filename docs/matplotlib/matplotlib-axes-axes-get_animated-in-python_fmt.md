...
> 原文：[https://www.geeksforgeeks.org/matplotlib-axes-axes-get_animated-in-python/](https://www.geeksforgeeks.org/matplotlib-axes-axes-get_animated-in-python/)
...
## matplotlib.axes.Axes.get_animated() 函数

Matplotlib 库的 `Axes` 模块中的 `Axes.get_animated()` 函数用于获取动画状态。
...
下面的例子说明了 `matplotlib.axes.Axes.get_animated()` 函数在 `matplotlib.axes` 中的作用：
