# matplotlib.axes.get_facecolor() 用法详解

> 原文链接: [https://www.geeksforgeeks.org/matplotlib-axes-get_facecolor-in-python/](https://www.geeksforgeeks.org/matplotlib-axes-get_facecolor-in-python/)
...
## matplotlib.axes.Axes.get_facecolor() 函数

`matplotlib` 库的 `axes` 模块中的 `Axes.get_facecolor()` 函数用于获取 `Axes` 的 `facecolor`。
...
下面的例子说明了 `matplotlib.axes.Axes.get_facecolor()` 函数在 `matplotlib.axes` 中的作用：
