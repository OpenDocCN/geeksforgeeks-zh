...
> 原文: [https://www.geeksforgeeks.org/matplotlib-axes-axes-yaxis_inverted-in-python/](https://www.geeksforgeeks.org/matplotlib-axes-axes-yaxis_inverted-in-python/)
...
`matplotlib` 库的 `Axes` 模块中的 `Axes.yaxis_inverted()` 函数返回 y 轴是否反转。
...
下面的例子说明了 `matplotlib.axes.Axes.yaxis_inverted()` 函数在 `matplotlib.axes` 中的作用：
