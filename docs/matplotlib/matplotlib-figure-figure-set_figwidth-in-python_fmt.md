# Python 中的 matplotlib.figure.Figure.set_figwidth()

> 原文: [https://www.geeksforgeeks.org/matplotlib-figure-figure-set_figwidth-in-python/](https://www.geeksforgeeks.org/matplotlib-figure-figure-set_figwidth-in-python/)
...
## matplotlib.figure.Figure.set_figwidth() 方法

matplotlib 库的 `set_figwidth()` 方法图形模块用于设置图形的宽度，单位为英寸。
...
下面的例子说明了 `matplotlib.figure.Figure.set_figwidth()` 函数在 matplotlib:
