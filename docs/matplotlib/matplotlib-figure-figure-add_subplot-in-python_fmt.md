...
> 原文: [https://www.geeksforgeeks.org/matplotlib-figure-figure-add_subplot-in-python/](https://www.geeksforgeeks.org/matplotlib-figure-figure-add_subplot-in-python/)
...
下面的例子说明了 `matplotlib.figure.Figure.add_subplot()` 函数在 `matplotlib.figure` 中的使用:
