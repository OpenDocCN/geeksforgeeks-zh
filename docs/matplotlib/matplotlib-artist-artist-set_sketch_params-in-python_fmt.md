...
> 原文:[https://www.geeksforgeeks.org/matplotlib-artist-artist-set_sketch_params-in-python/](https://www.geeksforgeeks.org/matplotlib-artist-artist-set_sketch_params-in-python/)
...
## matplotlib.artist.Artist.set_sketch_params()方法

matplotlib 库的 artist 模块中的 `set_sketch_params()`方法用于设置草图参数。

> **语法:** `artist.set_sketch_params(self, scale=None, length=None, randomness=None)`
> 
> **参数:** 该方法接受以下参数。
> 
...
以下示例说明了 matplotlib 中的 `matplotlib.artist.Artist.set_sketch_params()` 函数:
