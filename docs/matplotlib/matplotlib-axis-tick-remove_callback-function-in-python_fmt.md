# Python 中的 `matplotlib.axis.Tick.remove_callback()` 函数

> 原文: [https://www.geeksforgeeks.org/matplotlib-axis-tick-remove_callback-function-in-python/](https://www.geeksforgeeks.org/matplotlib-axis-tick-remove_callback-function-in-python/)

[**Matplotlib**](https://www.geeksforgeeks.org/python-introduction-matplotlib/) 是 Python 中的一个库，是 NumPy 库的数值-数学扩展。这是一个神奇的 Python 可视化库，用于 2D 数组图，并用于处理更广泛的 SciPy 堆栈。

## `matplotlib.axis.Tick.remove_callback()` 函数

`matplotlib` 库的 `axis` 模块中的 `Tick.remove_callback()` 函数用于根据观察器 id 移除回调。
...
以下示例说明 `matplotlib.axis.Tick.remove_callback()` 函数在 `matplotlib.axis` 中的用法:
