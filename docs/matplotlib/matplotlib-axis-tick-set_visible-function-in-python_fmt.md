...
> 原文: [https://www.geeksforgeeks.org/matplotlib-axis-tick-set_visible-function-in-python/](https://www.geeksforgeeks.org/matplotlib-axis-tick-set_visible-function-in-python/)

[**Matplotlib**](https://www.geeksforgeeks.org/python-introduction-matplotlib/) 是 Python 中的一个库，是 NumPy 库的数值-数学扩展。这是一个神奇的 Python 可视化库，用于 2D 数组图，并用于处理更广泛的 SciPy 堆栈。

## `matplotlib.axis.tick.set_visible()`函数

matplotlib 库的轴模块中的 `Tick.set_visible()` 函数用于将属性从他人复制到自己。
...
以下示例说明 `matplotlib.axis.tick.set_visible()` 函数在 matplotlib.axis:
