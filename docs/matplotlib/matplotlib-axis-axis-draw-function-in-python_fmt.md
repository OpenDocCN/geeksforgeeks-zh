...
> 原文: [https://www.geeksforgeeks.org/matplotlib-axis-axis-draw-function-in-python/](https://www.geeksforgeeks.org/matplotlib-axis-axis-draw-function-in-python/)

[**Matplotlib**](https://www.geeksforgeeks.org/python-introduction-matplotlib/) 是 Python 中的一个库，是 `NumPy` 库的数值-数学扩展。这是一个神奇的 Python 可视化库，用于 2D 数组图，并用于处理更广泛的 `SciPy` 堆栈。

## Matplotlib.axis.Axis.draw()函数

`matplotlib` 库的轴模块中的 `Axis.draw()`函数用于绘制轴线、网格线、刻度线和标签。

> **语法:** `Axis.draw(self, renderer, *args, **kwargs)`
>
> **参数:** 该方法接受以下参数。
>
