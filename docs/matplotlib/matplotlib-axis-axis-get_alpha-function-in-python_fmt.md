...
> 原文: [https://www.geeksforgeeks.org/matplotlib-axis-axis-get_alpha-function-in-python/](https://www.geeksforgeeks.org/matplotlib-axis-axis-get_alpha-function-in-python/)
...
`matplotlib` 库的 `Axis` 模块中的 `Axis.get_alpha()` 函数用于获取用于混合的 `alpha` 值。
...
下面的例子说明了 `matplotlib.axis.Axis.get_alpha()` 函数在 `matplotlib.axis` 中的作用。
