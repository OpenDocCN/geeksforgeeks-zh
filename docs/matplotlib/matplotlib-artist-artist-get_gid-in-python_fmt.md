...
> 原文: [https://www.geeksforgeeks.org/matplotlib-artist-artist-get_gid-in-python/](https://www.geeksforgeeks.org/matplotlib-artist-artist-get_gid-in-python/)
...
## matplotlib.artist.Artist.get_gid() 方法

`matplotlib`库的`Artist`模块中的`get_gid()`方法用于获取组 id。

> **语法:** `Artist.get_gid(self)`
>
> **参数:** 此方法不接受任何参数。
>
> **返回:** 该方法返回组 id。

以下示例说明了`matplotlib`中的`matplotlib.artist.Artist.get_gid()`函数:
