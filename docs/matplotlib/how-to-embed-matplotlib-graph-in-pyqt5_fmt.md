...
> 原文：[https://www.geeksforgeeks.org/how-to-embed-matplotlib-graph-in-pyqt5/](https://www.geeksforgeeks.org/how-to-embed-matplotlib-graph-in-pyqt5/)
...
为了在 `PyQt5` 中使用 `Matplotlib` 绘制图形，我们需要 `FigureCanvasQTAgg` 和 `NavigationToolbar2QT` 这些类似于正在嵌入的 `PyQt5` 小部件。

*   **NavigationToolbar2QT**：它将为图形提供工具栏，可以借助下面给出的命令
    > `from matplotlib.backends.backend_qt5agg import NavigationToolbar2QT as NavigationToolbar`

*   **FigureCanvasQTAgg**：它将为图提供画布，可以借助下面给出的命令
    > `from matplotlib.backends.backend_qt5agg import FigureCanvasQTAgg as FigureCanvas`

以下是 `FigureCanvasQTAgg` 和 `NavigationToolbar2QT` 的样子：
