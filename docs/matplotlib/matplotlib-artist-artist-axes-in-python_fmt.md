...
> 原文: [https://www.geeksforgeeks.org/matplotlib-artist-artist-axes-in-python/](https://www.geeksforgeeks.org/matplotlib-artist-artist-axes-in-python/)
...
`matplotlib`库的`artist`模块中的`axes()`属性是`Artist`所在的`Axes`实例，或者`None`。
