# matplotlib.pyplot.get_fignums()用法详解

> 原文: [https://www.geeksforgeeks.org/matplotlib-pyplot-get_fignums-in-python/](https://www.geeksforgeeks.org/matplotlib-pyplot-get_fignums-in-python/)
...
`matplotlib` 库 `pyplot` 模块中的 `get_fignums()` 方法用于获取已有图号列表。

> **语法:** `matplotlib.pyplot.get_fignums()`
>
> **参数:** 此方法不接受任何参数。
>
> **返回:** 该方法返回已有图号列表。
