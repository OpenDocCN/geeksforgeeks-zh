# matplotlib.axes.get_label() 用法详解

> 原文: [https://www.geeksforgeeks.org/matplotlib-axes-axes-get_label-in-python/](https://www.geeksforgeeks.org/matplotlib-axes-axes-get_label-in-python/)
...
`matplotlib` 库中 `Axes` 模块的 `Axes.get_label()` 函数用于获取图例中该艺术家使用的标签。
