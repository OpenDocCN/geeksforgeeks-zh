...
> 原文: [https://www.geeksforgeeks.org/plotting-a-sawtooth-wave-using-matplotlib/](https://www.geeksforgeeks.org/plotting-a-sawtooth-wave-using-matplotlib/)
...
> `numpy.linspace(开始，停止，num = 50，端点=真，retstep=假，dtype=无)`
