...
> 原文: [https://www.geeksforgeeks.org/matplotlib-axes-axes-set_navigate-in-python/](https://www.geeksforgeeks.org/matplotlib-axes-axes-set_navigate-in-python/)
...
`matplotlib.axes.Axes.set_navigate()` 函数用于检查轴是否响应导航工具栏命令。
...
以下示例说明了 `matplotlib.axes.Axes.set_navigate()` 函数在 `matplotlib.axes` 中的用法:
