...
> 原文: [https://www.geeksforgeeks.org/matplotlib-axis-axis-zoom-function-in-python/](https://www.geeksforgeeks.org/matplotlib-axis-axis-zoom-function-in-python/)

[**Matplotlib**](https://www.geeksforgeeks.org/python-introduction-matplotlib/) 是 Python 中的一个库，是 NumPy 库的数值-数学扩展。这是一个神奇的 Python 可视化库，用于 2D 数组图，并用于处理更广泛的 SciPy 堆栈。

## Matplotlib.axis.Axis.zoom()

`matplotlib` 库的轴模块中的 `Axis.zoom()` 功能用于在轴上放大或缩小。

> **语法:** `Axis.zoom(self, direction)`
>
> **参数:** 该方法接受以下参数。
>
> *   `direction`: 该参数为放大 (`direction > 0`) 或缩小 (`direction <= 0`) 的值。
>
> **返回值:** 此方法不返回值。
