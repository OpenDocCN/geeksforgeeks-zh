# matplotlib.axes.Axes.set_ylabel()函数详解

> 原文链接：[https://www.geeksforgeeks.org/matplotlib-axes-set_ylabel-in-python/](https://www.geeksforgeeks.org/matplotlib-axes-set_ylabel-in-python/)
...
`matplotlib`库的`Axes`模块中的`Axes.set_ylabel()`函数用于设置 y 轴的标签。
...
下面的例子说明了`matplotlib.axes.Axes.set_ylabel()`函数在`matplotlib.axes`中的作用：
