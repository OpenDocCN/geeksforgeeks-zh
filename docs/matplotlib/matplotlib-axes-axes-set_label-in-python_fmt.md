# matplotlib.axes.set_label() 用法详解

> 原文链接: [https://www.geeksforgeeks.org/matplotlib-axes-set_label-in-python/](https://www.geeksforgeeks.org/matplotlib-axes-set_label-in-python/)
...
`matplotlib.axes.Axes` 模块中的 `Axes.set_label()` 函数用于设置将在图例中显示的标签。
