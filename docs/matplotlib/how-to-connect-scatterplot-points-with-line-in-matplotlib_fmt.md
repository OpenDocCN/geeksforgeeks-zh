...
> 原文: [https://www.geeksforgeeks.org/how-to-connect-scatterplot-points-with-line-in-matplotlib/](https://www.geeksforgeeks.org/how-to-connect-scatterplot-points-with-line-in-matplotlib/)
...
我们也可以用线连接散点图点，而不使用 `seaborn.scatterplot`。我们将只使用 `pyplot` 将散点图点与线连接起来。
