...
> 原文：[https://www.geeksforgeeks.org/matplotlib-axes-axes-remove_callback-in-python/](https://www.geeksforgeeks.org/matplotlib-axes-axes-remove_callback-in-python/)
...
## matplotlib.axes.Axes.remove_callback() 方法

matplotlib 库的 `axes` 模块中的 `remove_callback()` 方法用于根据观察器 id 移除回调。
...
下面的例子说明了 matplotlib 中的 `matplotlib.axes.Axes.remove_callback()` 函数：
