# Python 中的 `matplotlib.axis.tick.set_clip_on()` 函数

> 原文: [https://www.geeksforgeeks.org/matplotlib-axis-tick-set_clip_on-function-in-python/](https://www.geeksforgeeks.org/matplotlib-axis-tick-set_clip_on-function-in-python/)

[`Matplotlib`](https://www.geeksforgeeks.org/python-introduction-matplotlib/) 是 Python 中的一个库，是 NumPy 库的数值-数学扩展。这是一个神奇的 Python 可视化库，用于 2D 数组图，并用于处理更广泛的 SciPy 堆栈。

## `matplotlib.axis.tick.set_clip_on()` 函数

`matplotlib` 库的轴模块中的 `Tick.set_clip_on()` 功能用于设置艺术家是否使用剪裁。
...
以下示例说明 `matplotlib.axis.tick.set_clip_on()` 函数在 `matplotlib.axis` 中的用法。
