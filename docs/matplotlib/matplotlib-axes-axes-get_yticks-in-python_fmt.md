# matplotlib.axes.Axes.get_yticks() 用 Python

> 原文: [https://www.geeksforgeeks.org/matplotlib-axes-axes-get_yticks-in-python/](https://www.geeksforgeeks.org/matplotlib-axes-axes-get_yticks-in-python/)
...
`matplotlib` 库的 `Axes` 模块中的 `Axes.get_yticks()` 函数用于将 y 刻度作为位置列表返回。
...
下面的例子说明了 `matplotlib.axes.Axes.get_yticks()` 函数在 `matplotlib.axes` 中的作用：
