...
> 原文: [https://www.geeksforgeeks.org/python-introduction-matplotlib/](https://www.geeksforgeeks.org/python-introduction-matplotlib/)
...
`matplotlib` 库的 `show()`方法图形模块用于显示图形窗口。
