# Python中的matplotlib.axis.Axis.set_contains()函数

> 原文：[https://www.geeksforgeeks.org/matplotlib-axis-axis-set_contains-function-in-python/](https://www.geeksforgeeks.org/matplotlib-axis-axis-set_contains-function-in-python/)
...
## matplotlib.axis.Axis.set_contains()函数

matplotlib库的Axis模块中的`Axis.set_contains()`函数用于为艺术家定义自定义的包含测试。
...
以下示例说明`matplotlib.axis.Axis.set_contains()`函数在matplotlib.axis中的用法：
