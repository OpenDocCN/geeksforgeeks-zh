...
> 原文: [https://www.geeksforgeeks.org/how-to-set-tick-labels-font-size-in-matplotlib/](https://www.geeksforgeeks.org/how-to-set-tick-labels-font-size-in-matplotlib/)
...
*   `plt.xticks()`/`plt.yticks()` 中的 `fontsize`
*   `ax.set_yticklabels()`/`ax.set_xticklabels()` 中的 `fontsize`
*   `tick_params()` 中的 `labelsize`
