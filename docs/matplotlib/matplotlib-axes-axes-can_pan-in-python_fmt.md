...
> 原文: [https://www.geeksforgeeks.org/matplotlib-axes-axes-can_pan-in-python/](https://www.geeksforgeeks.org/matplotlib-axes-axes-can_pan-in-python/)
...
`matplotlib.axes.Axes` 模块中的 `Axes.can_pan()` 函数用于检查轴是否支持任何平移/缩放按钮功能。
...
以下示例说明 `matplotlib.axes.Axes.can_pan()` 函数在 `matplotlib.axes` 中的用法：
