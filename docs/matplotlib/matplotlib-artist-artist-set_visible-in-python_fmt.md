# Python 中的 `matplotlib.artist.Artist.set_visible()`

> 原文: [https://www.geeksforgeeks.org/matplotlib-artist-artist-set_visible-in-python/](https://www.geeksforgeeks.org/matplotlib-artist-artist-set_visible-in-python/)
...
`matplotlib` 库的 `artist` 模块中的 `set_visible()` 方法用于设置 artist 的可见性。
