...
> 原文: [https://www.geeksforgeeks.org/how-to-change-imshow-aspect-ratio-in-matplotlib/](https://www.geeksforgeeks.org/how-to-change-imshow-aspect-ratio-in-matplotlib/)
...
> **语法:** `pyplot.imshow(图像, aspect='值')`

我们可以用`'equal'`、`'auto'`或任何代表所需纵横比的浮点值来替换`aspect`的值。在这篇文章中，我们使用下面的图片来演示使用 Matplotlib 时长宽比的变化。
