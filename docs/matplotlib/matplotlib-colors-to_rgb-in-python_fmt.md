...
> 原文: [https://www.geeksforgeeks.org/matplotlib-colors-to_rgb-in-python/](https://www.geeksforgeeks.org/matplotlib-colors-to_rgb-in-python/)
...
> **语法:** `matplotlib.colors.to_rgb(c)`
>
> **参数:**
>
> - **c:** 这接受一个代表颜色名称的字符串。它可以是 RGB 或 RGBA 序列，也可以是几种形式的字符串:
>     1.  十六进制颜色字符串，如 `"#000fff"`
>     2.  一个标准的名字，像 `'green'`
>     3.  一封来自 `'rgbcmykw'` 的信
