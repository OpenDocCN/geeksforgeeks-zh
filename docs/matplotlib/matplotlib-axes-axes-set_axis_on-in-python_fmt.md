# Python 中的 matplotlib.axes.Axes.set_axis_on()

> 原文: [https://www.geeksforgeeks.org/matplotlib-axes-axes-set_axis_on-in-python/](https://www.geeksforgeeks.org/matplotlib-axes-axes-set_axis_on-in-python/)
...
`matplotlib` 库的 `Axes` 模块中的 `Axes.set_axis_on()` 函数用于打开 x 轴和 y 轴，这会影响轴线、刻度、标签、网格和轴标签。
...
下面的例子说明了 `matplotlib.axes.Axes.set_axis_on()` 函数在 `matplotlib.axes` 中的作用:
