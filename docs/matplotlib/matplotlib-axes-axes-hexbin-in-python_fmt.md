# Matplotlib.axes.Axes.hexbin() 用 Python 表示
...
> **语法：** `Axes.hexbin(self, x, y, C=None, gridsize=100, bins=None, xscale='linear', yscale='linear', extent=None, cmap=None, norm=None, vmin=None, vmax=None, alpha=None, linewidths=None, edgecolors='face', reduce_C_function=<function mean at 0x...>, mincnt=None, marginals=False, *, data=None, **kwargs)`
>
> **参数：** 该方法接受以下描述的参数：
>
...
> *   `marginals`： 此参数用于将边缘密度绘制为沿`x`轴底部和`y`轴左侧的彩色矩形。
> *   `extent`： 该参数是箱的极限。
>
> **返回：** 这将返回以下内容：
>
