# matplotlib.axis.Axis.set_pickradius() 函数

> 原文: [https://www.geeksforgeeks.org/matplotlib-axis-axis-set_pickradius-function-in-python/](https://www.geeksforgeeks.org/matplotlib-axis-axis-set_pickradius-function-in-python/)
...
[`matplotlib`](https://www.geeksforgeeks.org/python-introduction-matplotlib/) 库的轴模块中的 `Axis.set_pickradius()` 函数用于设置拾取器使用的轴的深度。

> **语法:** `Axis.set_pickradius(self, pickradius)`
>
> **参数:** 该方法接受以下参数。
>
> *   `pickradius`: 该参数为浮点值。
...
下面的例子说明了 `matplotlib.axis.Axis.set_pickradius()` 函数在 `matplotlib.axis` 中的作用。
