# matplotlib.figure.Figure.dpi() 用法详解

> 原文: [https://www.geeksforgeeks.org/matplotlib-figure-figure-dpi-in-python/](https://www.geeksforgeeks.org/matplotlib-figure-figure-dpi-in-python/)
...
`matplotlib` 库图形模块的 `dpi` 方法是以每英寸点数为单位的分辨率。
