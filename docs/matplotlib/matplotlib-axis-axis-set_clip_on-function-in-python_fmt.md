# matplotlib.axis.Axis.set_clip_on() 函数

> 原文: [https://www.geeksforgeeks.org/matplotlib-axis-axis-set_clip_on-function-in-python/](https://www.geeksforgeeks.org/matplotlib-axis-axis-set_clip_on-function-in-python/)
...
以下示例说明 `matplotlib.axis.Axis.set_clip_on()` 函数在 `matplotlib.axis` 中的用法。
