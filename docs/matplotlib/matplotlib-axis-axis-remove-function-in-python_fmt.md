...
> 原文: [https://www.geeksforgeeks.org/matplotlib-axis-axis-remove-function-in-python/](https://www.geeksforgeeks.org/matplotlib-axis-axis-remove-function-in-python/)
...
`matplotlib` 库的 `Axis` 模块中的 `Axis.remove()` 函数用于在可能的情况下从图形中移除艺术家。
...
以下示例说明 `matplotlib.axis.Axis.remove()` 函数在 `matplotlib.axis` 中的用法:
