# Matplotlib.pyplot.show() 用法详解

> 参考：[Matplotlib.pyplot.show() in Python](https://www.geeksforgeeks.org/matplot-lib-pyplot-show-in-python/)
...
`matplotlib` 库 `pyplot` 模块中的 `show()` 函数用于显示所有图形。
