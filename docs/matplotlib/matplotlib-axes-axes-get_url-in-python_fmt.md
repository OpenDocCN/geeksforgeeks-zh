# matplotlib.axes.Axes.get_url()函数详解

> 原文: [https://www.geeksforgeeks.org/matplotlib-axes-axes-get_url-in-python/](https://www.geeksforgeeks.org/matplotlib-axes-axes-get_url-in-python/)
...
`matplotlib.axes.Axes.get_url()`函数用于获取 URL。
