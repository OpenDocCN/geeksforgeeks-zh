# Python 中的 matplotlib.axis.xaxis.get_figure() 函数

> 原文: [https://www.geeksforgeeks.org/matplotlib-axis-xaxis-get_figure-function-in-python/](https://www.geeksforgeeks.org/matplotlib-axis-xaxis-get_figure-function-in-python/)

[`matplotlib`](https://www.geeksforgeeks.org/python-introduction-matplotlib/) 是 Python 中的一个库，是 NumPy 库的数值-数学扩展。这是一个神奇的 Python 可视化库，用于 2D 数组图，并用于处理更广泛的 SciPy 堆栈。

## matplotlib.axis.XAxis.get_figure() 函数
