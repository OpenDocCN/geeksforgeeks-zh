# Python 中的 matplotlib.axes.Axes.draw_artist()

> 原文: [https://www.geeksforgeeks.org/matplotlib-axes-axes-draw_artist-in-python/](https://www.geeksforgeeks.org/matplotlib-axes-axes-draw_artist-in-python/)
