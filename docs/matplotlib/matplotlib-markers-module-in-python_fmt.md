...
> 原文: [https://www.geeksforgeeks.org/matplotlib-markers-module-in-python/](https://www.geeksforgeeks.org/matplotlib-markers-module-in-python/)
...
| 小路 | 路径实例 |
| (数量、样式、角度) | The marker can also be a tuple (numsides, style, angle), which will create a custom, regular symbol. A) numsides: the number of sides B) style: the style of the regular symbol, 0: a regular polygon 1: a star-like symbol 2: an asterisk C) angle: the angle of rotation of the symbol |
