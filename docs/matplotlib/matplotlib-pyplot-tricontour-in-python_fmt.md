# matplotlib.pyplot.tricontour() 用法详解

> 原文链接: [https://www.geeksforgeeks.org/matplotlib-pyplot-tricontour-in-python/](https://www.geeksforgeeks.org/matplotlib-pyplot-tricontour-in-python/)
...
所有剩余的 `args` 和 `kwargs` 与 `contour()` 相同。
