...
> 原文：[https://www.geeksforgeeks.org/how-change-the-vertical-spacing-between-legend-entries-in-matplotlib/](https://www.geeksforgeeks.org/how-change-the-vertical-spacing-between-legend-entries-in-matplotlib/)
...
在本例中，我们将借助 `matplotlib` 绘制不同的线条，并使用 `labelspacing` 参数至 `plt.legend()` 来更改标签之间的垂直间距。
