# Python 中的 `matplotlib.axes.Axes.set_yscale()`

> 原文: [https://www.geeksforgeeks.org/matplotlib-axes-axes-set_yscale-in-python/](https://www.geeksforgeeks.org/matplotlib-axes-axes-set_yscale-in-python/)
...
## `matplotlib.axes.Axes.set_yscale()` 函数

`matplotlib` 库的 `Axes` 模块中的 `Axes.set_yscale()` 函数用于设置 y 轴比例。

> **语法:** `Axes.set_yscale(self, value, **kwargs)`
>
> **参数:** 该方法接受以下参数。
>
> *   `value`: 此参数是要应用的轴比例类型。
