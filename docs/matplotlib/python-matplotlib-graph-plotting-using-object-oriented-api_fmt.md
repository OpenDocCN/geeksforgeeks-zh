...
> 原文: [https://www.geeksforgeeks.org/python-matplotlib-graph-plotting-using-object-oriented-api/](https://www.geeksforgeeks.org/python-matplotlib-graph-plotting-using-object-oriented-api/)
...
`left`、`bottom`、`height`和`width`的值介于 0 到 1 之间。另一个例子会让你更清楚这个概念。
