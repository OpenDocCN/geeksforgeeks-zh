...
要创建多个地块，请使用[`matplotlib.pyplot.subplots`](https://www.geeksforgeeks.org/matplotlib-pyplot-subplots-in-python/)方法，该方法返回图形以及轴对象或轴对象数组。`nrows`，`ncols`子图的属性()方法决定了子图网格的行数和列数。
