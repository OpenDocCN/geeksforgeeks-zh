...
> 原文: [https://www.geeksforgeeks.org/matplotlib-figure-figure-get_figheight-in-python/](https://www.geeksforgeeks.org/matplotlib-figure-figure-get_figheight-in-python/)
...
## `matplotlib.figure.Figure.get_figheight()` 方法

利用 `matplotlib` 库的 `get_figheight()` 方法，`Figure` 模块将图形高度作为一个浮点数获取。
...
下面的例子说明了 `matplotlib.figure.Figure.get_figheight()` 函数在 `matplotlib` 中的用法:
