...
> 原文: [https://www.geeksforgeeks.org/how-to-remove-ticks-from-matplotlib-plots/](https://www.geeksforgeeks.org/how-to-remove-ticks-from-matplotlib-plots/)
...
要移除 y 轴上的刻度，`tick_params()` 方法的左侧有一个名为 `left` 的属性，我们可以将其值设置为 `False`，并将其作为参数传递到 `tick_params()` 函数中。它删除 y 轴上的刻度。
