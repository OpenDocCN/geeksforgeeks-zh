...
> 原文: [https://www.geeksforgeeks.org/three-dimensional-plotting-in-python-using-matplotlib/](https://www.geeksforgeeks.org/three-dimensional-plotting-in-python-using-matplotlib/)
...
**有线有点的图形**是最简单的三维图形。 `ax.plot3d` 和 `ax.scatter` 分别是绘制线图和点图的功能。
