...
> 原文: [https://www.geeksforgeeks.org/matplotlib-ticker-funcformatter-class-in-python/](https://www.geeksforgeeks.org/matplotlib-ticker-funcformatter-class-in-python/)
...
> **语法:** `matplotlib.ticker.FuncFormatter(func)`
> **参数:**
> *   `func`: 用户定义的绘图格式化功能。
