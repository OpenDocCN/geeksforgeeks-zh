...
> 原文: [https://www.geeksforgeeks.org/matplotlib-axes-axes-xaxis_inverted-in-python/](https://www.geeksforgeeks.org/matplotlib-axes-axes-xaxis_inverted-in-python/)
...
## `matplotlib.axes.Axes.xaxis_inverted()` 函数

`matplotlib` 库的 `Axes` 模块中的 `xaxis_inverted()` 函数返回 x 轴是否反转。

> **语法:** `xaxis_inverted(self)`
>
> **参数:** 该方法不接受任何参数。
>
> **返回:** 该方法返回 x 轴是否反转。

下面的例子说明了 `matplotlib.axes.Axes.xaxis_inverted()` 函数在 `matplotlib.axes` 中的作用：
