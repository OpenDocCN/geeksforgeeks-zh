# Python 中的 `matplotlib.axes.Axes.set_contains()`

> 原文: [https://www.geeksforgeeks.org/matplotlib-axes-axes-set_contains-in-python/](https://www.geeksforgeeks.org/matplotlib-axes-axes-set_contains-in-python/)
...
## `matplotlib.axes.Axes.set_contains()` 函数

`matplotlib` 库的 `Axes` 模块中的 `Axes.set_contains()` 函数用于为艺术家定义自定义的包含测试。
...
下面的例子说明了 `matplotlib.axes.Axes.set_contains()` 函数在 `matplotlib.axes` 中的作用:
