# Python 中的 `matplotlib.axis.Axis.get_label_position()` 函数

> 原文：[`https://www.geeksforgeeks.org/matplotlib-axis-axis-get_label_position-function-in-python/`](https://www.geeksforgeeks.org/matplotlib-axis-axis-get_label_position-function-in-python/)
...
## `matplotlib.axis.Axis.get_label_position()` 函数

[`matplotlib`](https://www.geeksforgeeks.org/python-introduction-matplotlib/) 库的 [`Axis`](https://www.geeksforgeeks.org/matplotlib-axis-axis-get_label_position-function-in-python/) 模块中的 [`Axis.get_label_position()`](https://www.geeksforgeeks.org/matplotlib-axis-axis-get_label_position-function-in-python/) 函数用于获取标签位置。

> **语法:** `axis.get_label_position(self)`
>
> **参数:** 该方法不接受任何参数。
>
> **返回值:** 此方法返回标签位置。

下面的例子说明了 [`matplotlib.axis.Axis.get_label_position()`](https://www.geeksforgeeks.org/matplotlib-axis-axis-get_label_position-function-in-python/) 函数在 [`matplotlib.axis`](https://www.geeksforgeeks.org/matplotlib-axis-axis-get_label_position-function-in-python/) 中的作用:
