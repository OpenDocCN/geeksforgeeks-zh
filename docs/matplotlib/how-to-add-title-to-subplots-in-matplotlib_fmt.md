...
> 原文：[https://www.geeksforgeeks.org/how-to-add-title-to-subplots-in-matplotlib/](https://www.geeksforgeeks.org/how-to-add-title-to-subplots-in-matplotlib/)
...
*   支线剧情：`matplotlib` 库 `pyplot` 模块中的 `subplots()` 函数用于创建一个人物和一组支线剧情。当我们想在同一个图中显示两个或更多的情节时，需要支线剧情。
...
我们使用 `matplotlib.axes._axes.Axes.set_title()` 方法为当前子图设置标题（字符串标签）。
