...
> 原文：[https://www.geeksforgeeks.org/how-to-remove-the-legend-in-matplotlib/](https://www.geeksforgeeks.org/how-to-remove-the-legend-in-matplotlib/)
...
在有多个子图的情况下，我们可以提到需要移除图例的子图对象。这里，我们写了 `axs[1].get_legend().remove()`，这意味着我们正在删除第二个子图的图例。
