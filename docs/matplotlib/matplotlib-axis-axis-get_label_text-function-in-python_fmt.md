# Python中的matplotlib.axis.Axis.get_label_text()函数

> 原文：[https://www.geeksforgeeks.org/matplotlib-axis-axis-get_label_text-function-in-python/](https://www.geeksforgeeks.org/matplotlib-axis-axis-get_label_text-function-in-python/)

`Matplotlib`是Python中的一个库，是NumPy库的数值-数学扩展。这是一个神奇的Python可视化库，用于2D数组图，并用于处理更广泛的SciPy堆栈。

## 函数说明

matplotlib库的Axis模块中的`Axis.get_label_text()`函数用于获取标签的文本。
...
下面的例子说明了`matplotlib.axis.Axis.get_label_text()`函数在`matplotlib.axis`中的作用：
