...
> 原文: [https://www.geeksforgeeks.org/matplotlib-axes-axes-has_data-in-python/](https://www.geeksforgeeks.org/matplotlib-axes-axes-has_data-in-python/)
...
`matplotlib` 库的 `Axes` 模块中的 `Axes.has_data()` 函数用于检查是否有任何艺术家被添加到轴中。
