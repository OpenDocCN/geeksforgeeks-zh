...
> 原文: [https://www.geeksforgeeks.org/matplotlib-axis-tick-set_gid-function-in-python/](https://www.geeksforgeeks.org/matplotlib-axis-tick-set_gid-function-in-python/)

[**Matplotlib**](https://www.geeksforgeeks.org/python-introduction-matplotlib/) 是 Python 中的一个库，是 NumPy 库的数值-数学扩展。这是一个神奇的 Python 可视化库，用于 2D 数组图，并用于处理更广泛的 SciPy 堆栈。

## 函数介绍

`matplotlib.axis.Tick.set_gid()` 函数用于设置艺术家的（组）id。
...
以下示例说明 `matplotlib.axis.Tick.set_gid()` 函数在 `matplotlib.axis` 中的使用。
