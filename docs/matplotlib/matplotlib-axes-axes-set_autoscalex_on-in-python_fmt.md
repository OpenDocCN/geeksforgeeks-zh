...
> 原文: [https://www.geeksforgeeks.org/matplotlib-axes-axes-set_autoscalex_on-in-python/](https://www.geeksforgeeks.org/matplotlib-axes-axes-set_autoscalex_on-in-python/)
...
[`matplotlib`](https://www.geeksforgeeks.org/python-introduction-matplotlib/) 库的 [`Axes`](https://www.geeksforgeeks.org/python-introduction-matplotlib/) 模块中的 [`Axes.set_autoscalex_on()`](https://www.geeksforgeeks.org/matplotlib-axes-axes-set_autoscalex_on-in-python/) 函数用于设置 x 轴的自动缩放是否应用于绘图命令。
...
以下示例说明 [`matplotlib.axes.Axes.set_autoscalex_on()`](https://www.geeksforgeeks.org/matplotlib-axes-axes-set_autoscalex_on-in-python/) 函数在 [`matplotlib.axes`](https://www.geeksforgeeks.org/matplotlib-axes-axes-set_autoscalex_on-in-python/) 中的使用:
