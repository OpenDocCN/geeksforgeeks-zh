# 如何在 Matplotlib 中设置绘图背景色？

> 原文: [https://www.geeksforgeeks.org/how-to-set-plot-background-color-in-matplotlib/](https://www.geeksforgeeks.org/how-to-set-plot-background-color-in-matplotlib/)
