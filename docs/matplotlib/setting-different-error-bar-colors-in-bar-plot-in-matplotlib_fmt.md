...
> 原文: [https://www.geeksforgeeks.org/setting-different-error-bar-colors-in-bar-plot-in-matplotlib/](https://www.geeksforgeeks.org/setting-different-error-bar-colors-in-bar-plot-in-matplotlib/)
...
> *   `capsize`: 这个参数也是可选参数。它是误差线的长度，以磅为单位，默认值为 `None`。
