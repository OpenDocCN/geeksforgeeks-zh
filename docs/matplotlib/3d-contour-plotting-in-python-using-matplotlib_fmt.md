...
> 原文: [https://www.geeksforgeeks.org/3d-contour-plotting-in-python-using-matplotlib/](https://www.geeksforgeeks.org/3d-contour-plotting-in-python-using-matplotlib/)
...
| 函数参数 | 描述 |
| --- | --- |
| `np.meshgrid` | numpy 函数，用于从两个给定的一维数组中创建一个矩形网格，表示笛卡尔索引或矩阵索引 |
| `plt.axes()` | 创建轴的对象 |
| `ax.contour3D` | 形成轮廓 |
| `ax.set_xlabel` | 标记 X 轴 |
...
为了更好地理解概念，我们再来看另一个 3d 图。这一次，3d tan 功能。
