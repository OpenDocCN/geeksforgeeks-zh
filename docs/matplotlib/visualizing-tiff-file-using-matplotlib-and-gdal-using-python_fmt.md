...
> 原文: [https://www.geeksforgeeks.org/visualizing-tiff-file-using-matplotlib-and-gdal-using-python/](https://www.geeksforgeeks.org/visualizing-tiff-file-using-matplotlib-and-gdal-using-python/)

Tiff 文件格式用于存储光栅图像。一个名为 GDAL（地理空间数据抽象库）的库专门用于读取这种光栅文件以及其他文件格式，如矢量格式。`gdal` 模块属于开源地理空间基金会。
...
注意我们传递的 `int` 的值总是从 1 开始（波段索引从 1 开始）。
