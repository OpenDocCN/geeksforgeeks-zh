...
> 原文: [https://www.geeksforgeeks.org/how-to-create-an-empty-figure-with-matplotlib-in-python/](https://www.geeksforgeeks.org/how-to-create-an-empty-figure-with-matplotlib-in-python/)
...
*   然后，我们使用 `plt.figure()` 创建一个 `fig` 对象，并通过将其设置为 `fig` 变量来保持对该对象的引用。这个图形对象是空的，因为我们没有添加任何图形组件，如轴、图例、轴等。
