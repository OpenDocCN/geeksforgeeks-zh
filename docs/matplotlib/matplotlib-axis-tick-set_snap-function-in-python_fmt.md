...
> 原文: [https://www.geeksforgeeks.org/matplotlib-axis-tick-set_snap-function-in-python/](https://www.geeksforgeeks.org/matplotlib-axis-tick-set_snap-function-in-python/)
...
`matplotlib` 库的轴模块中的 `Tick.set_snap()` 函数用于设置捕捉行为。

> **语法:** `Tick.set_snap(self, snap)`
> 
> **参数:** 该方法接受以下参数。
> 
> *   `snap`: 此参数包含布尔值或无。
...
以下示例说明 `matplotlib.axis.Tick.set_snap()` 函数在 `matplotlib.axis` 中的使用。
