# matplotlib.pyplot.plasma() 函数用法

> 原文: [matplotlib.pyplot.plasma() in Python](https://www.geeksforgeeks.org/matplotlib-pyplot-plasma-in-python/)

[Matplotlib](https://www.geeksforgeeks.org/python-introduction-matplotlib/) 是 Python 中的一个库，是 NumPy 库的数值-数学扩展。[Pyplot](https://www.geeksforgeeks.org/pyplot-in-matplotlib/) 是一个基于状态的接口到 `Matplotlib` 模块，它提供了一个类似于 MATLAB 的接口。

## `matplotlib.pyplot.plasma()` 函数

`matplotlib` 库 `pyplot` 模块中的 `plasma()` 函数用于将 colormap 设置为“plasma”。
