...
> 原文: [https://www.geeksforgeeks.org/use-multiple-columns-in-a-matplotlib-legend/](https://www.geeksforgeeks.org/use-multiple-columns-in-a-matplotlib-legend/)
...
*   [**Pyplot:**](https://www.geeksforgeeks.org/pyplot-in-matplotlib/) 在 Python 中，“pyplot”是一个用于二维图形的绘图库。它用于 python 脚本、shell、web 应用服务器和其他 GUI 工具包。
