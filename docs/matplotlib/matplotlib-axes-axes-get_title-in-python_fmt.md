...
> 原文: [https://www.geeksforgeeks.org/matplotlib-axes-axes-get_title-in-python/](https://www.geeksforgeeks.org/matplotlib-axes-axes-get_title-in-python/)
...
`matplotlib` 库的 `Axes` 模块中的 `Axes.get_title()` 函数用于获取一个 axes 标题。
