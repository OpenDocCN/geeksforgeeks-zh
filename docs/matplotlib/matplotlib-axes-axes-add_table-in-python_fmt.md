...
> 原文: [https://www.geeksforgeeks.org/matplotlib-axes-axes-add_table-in-python/](https://www.geeksforgeeks.org/matplotlib-axes-axes-add_table-in-python/)
...
`matplotlib` 库的 `Axes` 模块中的 `Axes.add_table()` 函数也用来给 axes 的表添加一个 `table`，并返回该表。
