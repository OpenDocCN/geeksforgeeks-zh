...
> 原文: [https://www.geeksforgeeks.org/how-to-create-a-candlestick-chart-in-matplotlib/](https://www.geeksforgeeks.org/how-to-create-a-candlestick-chart-in-matplotlib/)
...
## 示例 2: 在这里，我们定义了一个包含 5 个参数的股票价格数据集，即开盘价、收盘价、高、低和指数(即日期)，之后，我们使用 `pandas.to_datetime` 转换日期，然后 `pandas.DataFrame.astype` 将所有数据转换为 `float()`。
