...
> 原文：[https://www.geeksforgeeks.org/how-to-change-the-font-size-of-the-title-in-a-matplotlib-figure/](https://www.geeksforgeeks.org/how-to-change-the-font-size-of-the-title-in-a-matplotlib-figure/)

在本文中，我们将讨论如何使用 `matplotlib` 模块更改图中标题的字体大小。

我们使用 `matplotlib.pyplot.title()` 方法为一个图分配一个标题。因此，为了更改字体大小，我们将使用 `matplotlib` 模块中 `pyplot.title()` 方法的 `fontsize` 参数。
