# matplotlib.axes.Axes.set_gid() 用法详解

> 原文: [https://www.geeksforgeeks.org/matplotlib-axes-axes-set_gid-in-python/](https://www.geeksforgeeks.org/matplotlib-axes-axes-set_gid-in-python/)
...
`matplotlib` 库的 `Axes` 模块中的 `Axes.set_gid()` 函数用于设置艺术家的（组）id。
