...
> 原文：[https://www.geeksforgeeks.org/matplotlib-axes-axes-update_from-in-python/](https://www.geeksforgeeks.org/matplotlib-axes-axes-update_from-in-python/)
...
下面的例子说明了 `matplotlib.axes.Axes.update_from()` 函数在 `matplotlib.axes` 中的作用：
