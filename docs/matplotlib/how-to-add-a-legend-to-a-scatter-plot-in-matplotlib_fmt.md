...
> **语法:**
> `matplotlib.pyplot.legend(["Title_1", "Title_2"], ncol=1, loc="upper left", bbox_to_anchor=(1, 1))`
>
> **参数:**
>
...
**注意:** 我们可以使用参数在 `matplotlib.pyplot.scatter()` 中标记地块的元素。然而，要显示它*必须*调用 `matplotlib.pyplot.legend()`。
...
**注意:** 如果 `label` 参数不是用代码写的，那么标签就不会显示。