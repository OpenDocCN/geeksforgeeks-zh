# Python 中的 Matplotlib.axis.Tick.findobj()函数

> 原文: [https://www.geeksforgeeks.org/matplotlib-axis-tick-findobj-function-in-python/](https://www.geeksforgeeks.org/matplotlib-axis-tick-findobj-function-in-python/)
...
[`matplotlib`](https://www.geeksforgeeks.org/python-introduction-matplotlib/) 库的轴模块中的 [`Tick.findobj()`](https://www.geeksforgeeks.org/matplotlib-axis-tick-findobj-function-in-python/) 函数用于查找艺术家对象。

> **语法:** [`Tick.findobj(self，match=None，include_self=True)`](https://www.geeksforgeeks.org/matplotlib-axis-tick-findobj-function-in-python/)
>
> **参数:** 该方法接受以下参数。
>
> *   [`match`](https://www.geeksforgeeks.org/matplotlib-axis-tick-findobj-function-in-python/): 该参数是匹配的过滤标准。默认值为 [`None`](https://www.geeksforgeeks.org/matplotlib-axis-tick-findobj-function-in-python/)。
> *   [`include_self`](https://www.geeksforgeeks.org/matplotlib-axis-tick-findobj-function-in-python/): 此参数将 [`self`](https://www.geeksforgeeks.org/matplotlib-axis-tick-findobj-function-in-python/) 包含在要检查匹配的列表中。
>
> **返回值:** 此方法返回艺术家（艺术家列表）。

下面的例子说明了 [`matplotlib.axis.Tick.findobj()`](https://www.geeksforgeeks.org/matplotlib-axis-tick-findobj-function-in-python/) 函数在 [`matplotlib.axis`](https://www.geeksforgeeks.org/matplotlib-axis-tick-findobj-function-in-python/): 中的作用
