...
> 原文: [https://www.geeksforgeeks.org/matplotlib-axes-axes-set_autoscaley_on-in-python/](https://www.geeksforgeeks.org/matplotlib-axes-axes-set_autoscaley_on-in-python/)
...
`matplotlib.axes.Axes.set_autoscaley_on()` 函数用于设置 y 轴的自动缩放是否应用于绘图命令。
...
以下示例说明 `matplotlib.axes.Axes.set_autoscaley_on()` 函数在 `matplotlib.axes` 中的用法。
