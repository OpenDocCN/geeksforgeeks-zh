...
> 原文：[https://www.geeksforgeeks.org/difference-between-finite-automata-and-turing-machine/](https://www.geeksforgeeks.org/difference-between-finite-automata-and-turing-machine/)
...
| 有限自动机中的转移函数可以表示为：`δ:Q×σ*→Q` | 图灵机中的转移函数可以表示为：`δ : Q × T → Q × T × {L，R}`，其中 `L` 和 `R` 指定磁头的左右移动。 |