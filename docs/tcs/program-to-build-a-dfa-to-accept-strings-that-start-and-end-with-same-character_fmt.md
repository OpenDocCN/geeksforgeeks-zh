...
> 原文: [https://www.geeksforgeeks.org/program-to-build-a-dfa-to-accept-strings-that-start-and-end-with-same-character/](https://www.geeksforgeeks.org/program-to-build-a-dfa-to-accept-strings-that-start-and-end-with-same-character/)
...
> **输出:** 是
> **解释:**
> 给定的输入字符串以相同的字符‘a’开始和结束，因此下面的 DFA 机器的状态将是 `Q0->q1->Q2->Q2->Q1->Q1->Q2->Q1` 和 `Q1` 是最终状态，因此输出将是
>
> **输入:** str = "ababab"
> **输出:** 否
> **解释:**
> 给定的输入字符串以不同的字符‘a’和‘b’开始和结束，因此下面 DFA Machine 的状态将为 `Q0->Q1->q2->Q1->Q2->Q1->Q2` 和 `Q2` 不是最终的
