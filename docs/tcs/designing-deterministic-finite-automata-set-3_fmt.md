...
> 原文: [https://www.geeksforgeeks.org/designing-deterministic-finite-automata-set-3/](https://www.geeksforgeeks.org/designing-deterministic-finite-automata-set-3/)
...
## 问题-1
在 `{a，b}` 上构造一个接受字符串集的最小 DFA，其中每个字符串包含 `a` 作为子字符串。
...
## 问题-2
在 `{a，b}` 上构造一个接受字符串集的最小 DFA，其中每个字符串包含 `ab` 作为子字符串。
