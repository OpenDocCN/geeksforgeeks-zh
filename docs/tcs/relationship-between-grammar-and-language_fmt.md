...
> 原文: [https://www.geeksforgeeks.org/relationship-between-grammar-and-language/](https://www.geeksforgeeks.org/relationship-between-grammar-and-language/)

## 先决条件

- [常规语法、常规表达式、](https://www.geeksforgeeks.org/regular-expressions-regular-grammar-and-regular-languages/)
