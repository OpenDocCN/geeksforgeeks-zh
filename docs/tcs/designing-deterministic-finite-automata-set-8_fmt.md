...
> 原文: [https://www.geeksforgeeks.org/designing-deterministic-finite-automata-set-8/](https://www.geeksforgeeks.org/designing-deterministic-finite-automata-set-8/)
...
## 问题-1
构造一个最小 DFA，接受{a，b}上的一组字符串，其中左手边的第二个符号总是“b”。
...
## 问题-2
构造一个最小 DFA，接受{a，b}上的一组字符串，其中左侧的第三个符号总是“b”。
