...
> 原文: [https://www.geeksforgeeks.org/dfa-of-a-string-in-which-2nd-symbol-from-rhs-is-a/](https://www.geeksforgeeks.org/dfa-of-a-string-in-which-2nd-symbol-from-rhs-is-a/)

先决条件 – [有限自动机简介](https://www.geeksforgeeks.org/toc-finite-automata-introduction/)

## 问题描述

绘制包含 `{a, b}` 上所有字符串集合的语言的确定性有限自动机（DFA），其中 RHS 的第二个符号是“a”。
