# 构造接受语言 L = {aⁿbᵐ | n mod 2=0, m≥1} 的 DFA 的程序

> 原文: [https://www.geeksforgeeks.org/program-to-construct-a-dfa-which-accept-the-language-l-anbm-n-mod-20-m1/](https://www.geeksforgeeks.org/program-to-construct-a-dfa-which-accept-the-language-l-anbm-n-mod-20-m1/)

先决条件 – [有限自动机简介](https://www.geeksforgeeks.org/toc-finite-automata-introduction/)

**问题:** 设计一个接受语言的确定性有限自动机(DFA) `L = {aⁿbᵐ | n mod 2=0, m ≥ 1}`。
...
1.  为 `(aa)*` 构造 FA 意味着有偶数个 a。
2.  `b+` 的构造 FA 是指具有大于 1 的任意数量的 b。
