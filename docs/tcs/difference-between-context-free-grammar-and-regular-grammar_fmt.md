...
> 原文: [https://www.geeksforgeeks.org/difference-between-context-free-grammar-and-regular-grammar/](https://www.geeksforgeeks.org/difference-between-context-free-grammar-and-regular-grammar/)
...
![乔姆斯基层次结构](img/2c58de215841e6bf48162c8db370c00f.png)
...
| 类型 | 类型 2 | 类型 3 |
| 承认 | 下推自动机。 | 有限状态自动机 |
| 规则 | 作品的形式为: `A->B`；`A∈N`(非终端) `B∈V*` (任意字符串) | 作品的形式为: `V–>VT/T`(左线性语法) (或) `V–>TV/T`(右线性语法) |
