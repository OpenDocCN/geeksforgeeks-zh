...
> 原文: [https://www.geeksforgeeks.org/regular-grammar-model-regular-grammars/](https://www.geeksforgeeks.org/regular-grammar-model-regular-grammars/)
...
它 derives the language that contains all the strings which end with `b`.
