# NFA 机器接受所有以子串‘ab’结束或非结束的字符串

> 原文: [https://www.geeksforgeeks.org/nfa-machines-accepting-all-strings-that-ends-or-not-ends-with-substring-ab/](https://www.geeksforgeeks.org/nfa-machines-accepting-all-strings-that-ends-or-not-ends-with-substring-ab/)
