...
> 原文: [https://www.geeksforgeeks.org/dfa-of-a-string-in-which-3rd-symbol-from-rhs-is-a/](https://www.geeksforgeeks.org/dfa-of-a-string-in-which-3rd-symbol-from-rhs-is-a/)
...
## 问题
绘制包含 `{a, b}` 上所有字符串集合的语言的确定性有限自动机(DFA)，其中 RHS 的第三个符号是‘a’。
