...
> 原文: [https://www.geeksforgeeks.org/npda-for-accepting-the-language-l-ambncn-mn-1/](https://www.geeksforgeeks.org/npda-for-accepting-the-language-l-ambncn-mn-1/)
...
## 问题
设计一个非确定性的 PDA 接受语言 `L = {a^m b^n c^n | m, n \geq 1}`，即，
...
这里，`q0` = 初始状态，`qf` = 最终状态，`ε` = 表示弹出操作，`q1`，`q2` = 中间状态。