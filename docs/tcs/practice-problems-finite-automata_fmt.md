...
> 原文: [https://www.geeksforgeeks.org/practice-problems-finite-automata/](https://www.geeksforgeeks.org/practice-problems-finite-automata/)

## Que-1

画一个确定性和非确定性的有限自动机，在包含 0，1 的字符串末尾接受 00 和 11，例如 01010100 但不接受 000111010。
...
画一个确定性和非确定性的有限自动机，它接受一个包含{a-z}字符串中任意位置的“the”的字符串，例如“有”，但不接受“那些”。
...
画一个确定性的和非确定性的有限自动机，它接受{a-z}串中一个串的末尾包含“ing”的串，例如“任何东西”，但不接受“任何地方”。
