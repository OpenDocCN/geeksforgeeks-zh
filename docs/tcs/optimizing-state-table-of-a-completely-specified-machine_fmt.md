...
> 原文：[https://www.geeksforgeeks.org/optimizing-state-table-of-a-completely-specified-machine/](https://www.geeksforgeeks.org/optimizing-state-table-of-a-completely-specified-machine/)
...
这里，状态 A、C 可以组合成一个状态，状态 B、D 可以组合成另一个状态。我们认为 `S1`、`S2`、`S3`、`S4` 是新状态表中的状态。
