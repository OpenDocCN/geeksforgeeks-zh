# NPDA 接受语言 L = {a^n b^n | n >= 1}

> 原文: [https://www.geeksforgeeks.org/npda-for-accepting-the-language-l-an-bn-n1/](https://www.geeksforgeeks.org/npda-for-accepting-the-language-l-an-bn-n1/)
...
## 问题–
设计一个接受语言 L = { a^n b^n | n >= 1}的非确定性 PDA，即，
