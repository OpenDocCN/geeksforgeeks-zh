...
**方法:** 思路是解释给定的语言 `L = C (A + B)+`。对于 `C(A+B)+` 形式的[正则表达式](https://www.geeksforgeeks.org/write-regular-expressions/)，下面是 [**DFA 状态转移图**](https://www.geeksforgeeks.org/designing-deterministic-finite-automata-set-2/):
