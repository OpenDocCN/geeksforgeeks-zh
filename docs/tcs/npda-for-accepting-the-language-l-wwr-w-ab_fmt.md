...
> 原文: [https://www.geeksforgeeks.org/npda-for-accepting-the-language-l-wwr-w-ab/](https://www.geeksforgeeks.org/npda-for-accepting-the-language-l-wwr-w-ab/)
...
## 问题
设计一个接受语言 `L = { wwR | w∈(a, b)*}` 的非确定性 PDA，即，
