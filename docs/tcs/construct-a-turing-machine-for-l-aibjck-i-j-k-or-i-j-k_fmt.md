# 为 L = { aibjk | I<j<k 或 i > j > k} 构建图灵机

> 原文: [https://www.geeksforgeeks.org/construct-a-turing-machine-for-l-aibjck-i-j-k-or-i-j-k/](https://www.geeksforgeeks.org/construct-a-turing-machine-for-l-aibjck-i-j-k-or-i-j-k/)

先决条件 – [图灵机](https://www.geeksforgeeks.org/turing-machine/)

语言 `L = { aibjck | I<j<k 或 i > j > k}` 与两种语言的并集 [L1 = { aibjck | I<j<k)】 i > j > k }](https://www.geeksforgeeks.org/construct-a-turing-machine-for-l-aibjck-i-j-k-i-1/) 相关。
