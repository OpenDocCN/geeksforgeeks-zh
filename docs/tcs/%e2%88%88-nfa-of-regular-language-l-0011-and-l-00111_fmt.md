...
> 原文：[https://www.geeksforge.org/∈-nfa-of-regular-language-l-0011-and-l-00111/](https://www.geeksforgeks.org/%e2%88%88-nfa-of-regular-language-l-0011-and-l-00111/)
...
此结构用于`a+`，这意味着表达式中必须至少有一个“a”。它的前面是`ε`，后面也是1。从状态`q2`到`q1`有`ε`反馈，因此表达式中可以有多个“a”。
...
由于`0`和`1`只是连接到第二部分，最终的∑-NFA是在第四个规则`ab`的帮助下绘制的。
