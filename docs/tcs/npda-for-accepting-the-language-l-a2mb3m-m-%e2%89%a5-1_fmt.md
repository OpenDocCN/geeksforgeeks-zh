...
> 原文: [https://www.geeksforgeeks.org/npda-for-accepting-the-language-l-a2mb3m-m-%e2%89%a5-1/](https://www.geeksforgeeks.org/npda-for-accepting-the-language-l-a2mb3m-m-%e2%89%a5-1/)
...
## 问题
设计一个接受语言 `L = { a2m b3m | m≥1 }` 的非确定性 PDA，即，
...
(q2, b, a) → (q3, ε)  [Indicates pop operation ]
(q3, b, a) → (q3, ε)  [Indicates pop operation ]
(q3, ε, z) → (qf, z )
```
