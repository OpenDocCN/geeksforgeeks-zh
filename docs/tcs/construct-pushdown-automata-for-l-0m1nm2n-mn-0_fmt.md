...
> 原文: [https://www.geeksforgeeks.org/construct-pushdown-automata-for-l-0m1nm2n-mn-0/](https://www.geeksforgeeks.org/construct-pushdown-automata-for-l-0m1nm2n-mn-0/)
...
## 问题:
构造 L = { 0<sup>m</sup>1<sup>(n+m)</sup>2<sup>n</sup>| m，n ≥ 0}的下推自动机。
