...
> 原文: [https://www.geeksforgeeks.org/npda-for-accepting-the-language-l-anbm-nm-1-and-n-m/](https://www.geeksforgeeks.org/npda-for-accepting-the-language-l-anbm-nm-1-and-n-m/)
...
## 问题
为接受语言 `L = {a^n b^m | n, m >= 1 and n!=m}` 设计一个非确定性的 PDA，即，
```
...
所以，这是我们接受语言所需要的非决定性的 PDA `L = {a^n b^m | n, m >= 1 and n!=m}`。