...
> 原文: [https://www.geeksforgeeks.org/designing-non-deterministic-finite-automata-set-1/](https://www.geeksforgeeks.org/designing-non-deterministic-finite-automata-set-1/)
...
## 问题-1
构造一个最小 NFA，接受 `{a，b}` 上的一组字符串，其中语言的每个字符串都以“a”开头。
...
## 问题-2
构造一个最小 NFA，接受 `{a，b}` 上的一组字符串，其中语言的每个字符串都不是以“a”开头。
