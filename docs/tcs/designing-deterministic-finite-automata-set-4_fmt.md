...
> 原文: [https://www.geeksforgeeks.org/designing-deterministic-finite-automata-set-4/](https://www.geeksforgeeks.org/designing-deterministic-finite-automata-set-4/)
...
## 问题-1
在 `{a, b}` 上构造一个接受字符串集的最小 DFA，其中每个“a”后面跟一个“b”。
...
## 问题-2
在 `{a, b}` 上构造一个接受字符串的最小 DFA 集合，其中每个“a”后面都不跟“b”。
