...
> 原文: [https://www.geeksforgeeks.org/npda-for-accepting-the-language-l-an-bn-cm-mn1/](https://www.geeksforgeeks.org/npda-for-accepting-the-language-l-an-bn-cm-mn1/)
...
## 问题
设计一个接受语言 L = { ![a^n](img/347b4ff81cbcc2fb2ff95c05c9438df8.png "Rendered by QuickLaTeX.com") ![b^n](img/ccc205985e45e55e57f89bc858ee68c9.png "Rendered by QuickLaTeX.com") ![c^m](img/464fc0e56bed6af5a568e96272c895d5.png "Rendered by QuickLaTeX.com") | m，n > =1}的非确定性 PDA，即，
...
其中，![\Gamma](img/7227a362929bad8def3d7ea099742850.png "Rendered by QuickLaTeX.com") =所有堆栈字母表的集合，`z` =堆栈开始符号。
...
其中，`q0` =初始状态，`qf` =最终状态，![\epsilon](img/9e0d0faaeb36399f71c3ccdd6c2b69d0.png "Rendered by QuickLaTeX.com") =表示弹出操作。
