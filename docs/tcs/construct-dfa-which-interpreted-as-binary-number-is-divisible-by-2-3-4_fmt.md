...
> 原文: [https://www.geeksforgeeks.org/construct-dfa-which-interpreted-as-binary-number-is-divisible-by-2-3-4/](https://www.geeksforgeeks.org/construct-dfa-which-interpreted-as-binary-number-is-divisible-by-2-3-4/)
...
**解释:**
参考解: [使用 DFA 的 3 的二进制串倍数](https://www.geeksforgeeks.org/check-binary-string-multiple-3-using-dfa/)。
