# NPDA 接受语言 L = {a^m b^(2m) | m >= 1}

> 原文: [https://www.geeksforgeeks.org/npda-for-accepting-the-language-l-am-b2m-m1/](https://www.geeksforgeeks.org/npda-for-accepting-the-language-l-am-b2m-m1/)
...
## 问题
设计一个非确定性的 PDA 接受语言 `L = {a^m b^(2m) | m >= 1}`，即，
...
所以，这是我们接受语言 `L = {a^m b^(2m) | m >= 1}` 所需要的非确定性 PDA。