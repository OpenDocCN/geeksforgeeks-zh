...
> 原文: [https://www.geeksforgeeks.org/how-does-auto-property-work-in-margin0-auto-in-css/](https://www.geeksforgeeks.org/how-does-auto-property-work-in-margin0-auto-in-css/)

在本文中，我们将学习自动属性如何在 `margin:0 auto` 在 CSS 中工作。`margin` 属性用于设置元素的边距。`margin` 属性有四个值:上边距、右边距、下边距和左边距。
...
所以在 `margin:0 auto` 中，上下边距为 `0`，左右边距为 `auto`，其中 `auto` 是指浏览器根据容器自动设置左右边距，使元素居中。`margin:0 auto` 等同于:
