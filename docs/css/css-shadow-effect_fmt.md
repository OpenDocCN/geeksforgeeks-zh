...
> 原文：`https://www.geeksforgeeks.org/css-shadow-effect/`

CSS 中的阴影效果属性用于在 HTML 文档中添加文本和图像阴影。

## 文字阴影

CSS `text-shadow` 属性用来显示有阴影的文字。此属性保存阴影的像素长度、宽度和宽度以及阴影的颜色。
...
CSS `box Shadow` 属性对文本框应用阴影。该属性保存阴影的像素长度、宽度和宽度以及阴影的颜色。
