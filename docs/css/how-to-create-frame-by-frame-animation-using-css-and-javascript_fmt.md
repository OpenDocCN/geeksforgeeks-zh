...
> 原文: [https://www.geeksforgeeks.org/how-to-create-frame-by-frame-animation-using-css-and-javascript/](https://www.geeksforgeeks.org/how-to-create-frame-by-frame-animation-using-css-and-javascript/)
...
我们可以使用 JavaScript [`setInterval()`](https://www.geeksforgeeks.org/java-script-settimeout-setinterval-method/) 方法来创建逐帧动画。`setInterval()` 方法用于在每个给定的时间间隔重复特定的功能，因此它可以在帧集合上的逐帧动画中使用，以便它们之间看起来有固定的时间间隔间隙。
...
*   `function`: 必须执行的功能。
*   `milliseconds`: 表示每帧之间时间间隔的长度，单位为毫秒。
...
<body>
    ...
    <div class="center">
        <img id="img" src="https://media.geeksforgeeks.org/wp-content/uploads/20210721215006/frame1.PNG">
