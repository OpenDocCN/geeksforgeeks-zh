...
> 原文: [https://www.geeksforgeeks.org/how-to-create-a-css-rule-or-class-at-runtime-using-jquery/](https://www.geeksforgeeks.org/how-to-create-a-css-rule-or-class-at-runtime-using-jquery/)
...
CSS 规则一旦被编写，就可以存储在一个变量中，并在任何需要的地方多次使用。我们使用 jQuery 的 `css("attribute1", "value1")`。
...
它还有一个替代方案，可以直接使用类似 CSS 的样式代码，而不是类似 JavaScript 的样式。
