...
> 原文：[https://www.geeksforgeeks.org/how-to-make-div-not-larger-than-its-contents-using-css/](https://www.geeksforgeeks.org/how-to-make-div-not-larger-than-its-contents-using-css/)

有三种方法可以解决这个问题：

1.  [默认情况下](#no_1)
2.  [使用内联块属性](#no_2)
3.  [在宽度和高度上使用适合内容属性](#no_3)
...
在此方法中，我们将 `width` 和 `height` 属性设置为 `fit-content` 值。
