...
> 原文：[https://www.geeksforgeeks.org/what-are-the-classes-of-breadcrumb-in-materialize-css/](https://www.geeksforgeeks.org/what-are-the-classes-of-breadcrumb-in-materialize-css/)
...
*   `breadcrumb`：用于将锚点元素设置为面包屑。最后一个锚点元素处于活动状态，而其余元素显示为灰色。
...
在本例中，我们用当前位置面包屑创建了一个简单的面包屑，这意味着您在面包屑页面上，它在物化类别下，HTML5 指向 HTML5 页面。
...
在本例中，我们将使用活动的当前位置面包屑创建一个简单的面包屑。
