...
> 原文: [https://www.geeksforgeeks.org/css-attributevalue-selector-6/](https://www.geeksforgeeks.org/css-attributevalue-selector-6/)

`[attribute^=value]`选择器用于选择那些属性值以给定字符串开始的元素。
