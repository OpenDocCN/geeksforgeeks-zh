...
> 原文：[https://www.geeksforgeeks.org/how-to-apply-css-style-using-jquery/](https://www.geeksforgeeks.org/how-to-apply-css-style-using-jquery/)
...
通过点击按钮，它将多个 [CSS 属性](https://www.geeksforgeeks.org/css-properties-complete-reference/)添加到所选元素，但是通过双击按钮，它仅添加一个 CSS 属性。这个例子的目的是展示所讨论的两种 `CSS` 方法的使用。
