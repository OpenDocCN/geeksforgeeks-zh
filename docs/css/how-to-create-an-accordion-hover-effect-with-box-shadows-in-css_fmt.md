...
> 原文：[https://www.geeksforgeeks.org/how-to-create-an-accordion-hover-effect-with-box-shadows-in-css/](https://www.geeksforgeeks.org/how-to-create-an-accordion-hover-effect-with-box-shadows-in-css/)

本文的目的是使用框阴影来创建手风琴悬停效果。

## 方法

[CSS `box-shadow`](https://www.geeksforgeeks.org/css-box-shadow-property/) 属性用于在元素周围绘制阴影。[CSS `box-shadow`](https://www.geeksforgeeks.org/css-box-shadow-property/) 属性有以下语法。
