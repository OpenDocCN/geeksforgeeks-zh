...
> 原文：`https://www.geeksforgeeks.org/css-read-write-selector/`

`:read-write` 选择器用于选择用户可编辑的元素（如输入文本）。没有 `readonly` 和 `disabled` 属性的元素被定义为可读和可写。
...
<html>
    ...
    <body style="text-align:center">
        ...
        <input type="text" value="Editable input field"><br><br>
