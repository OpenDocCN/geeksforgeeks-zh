...
### [字体家族](https://www.geeksforgeeks.org/css-font-family-property/)
用于设置一个 HTML 元素的字体类型。它有几个字体名称作为后备系统。
**语法:**
...
### [字体样式](https://www.geeksforgeeks.org/css-font-style-property/)
用于指定 HTML 元素的字体样式。可以是“正常、斜体或倾斜”。
...
### [字体粗细](https://www.geeksforgeeks.org/css-font-weight-property/)
用于设置字体的气魄。它的值可以是“正常、加粗、更轻、更粗”。
**语法:**
...
### [字体变体](https://www.geeksforgeeks.org/css-font-variant-property/)
用于创建小盘股效果。它可以是“普通或小盘股”。
**语法:**
...
### [字号](https://www.geeksforgeeks.org/css-font-size-property/)
用于设置一个 HTML 元素的字号。字体大小可以用不同的方式设置，比如“像素、百分比、em，或者我们可以设置小、大”等值。
**语法:**
