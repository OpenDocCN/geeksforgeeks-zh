...
> 原文: [https://www.geeksforgeeks.org/cssstyledeclaration-removeproperty-method/](https://www.geeksforgeeks.org/cssstyledeclaration-removeproperty-method/)

`removeProperty()` 方法用于移除现有 CSS 属性。
...
下面列出了 `CSSStyleDeclaration removeProperty()` 方法支持的浏览器:
