...
*   `W3.CSS` 是一个内置响应性的现代框架，与其他 CSS 框架相比，它更易于学习和使用。
*   它旨在加快和简化网络开发，并支持现代响应设备，如移动设备、笔记本电脑、平板电脑和台式机。
*   `W3.CSS` 旨在成为 `Bootstrap` 的高质量替代品。

## 如何在网页上使用 W3.CSS？

`W3.CSS` 是免费供大家使用的。任何人都可以通过简单地链接网页中的样式来使用它。在网站上包含 `W3.CSS` 有两种方式：

*   从这个[链接](https://www.w3schools.com/w3css/4/w3.css)包含 `W3.CSS`，如下所述：
...
*   从[这里](https://www.w3schools.com/w3css/4/w3.css)下载 `W3.CSS` 开始使用。
