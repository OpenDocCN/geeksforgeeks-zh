...
*   `border-transparent`: 边框颜色将为透明。
*   `border-current`: 边框颜色将取决于父元素颜色。
*   `border-black`: 边框颜色将为黑色。
*   `border-white`: 边框颜色将为白色。
*   `border-gray-50`: 边框颜色将为灰色。
*   `border-red-50`: 边框颜色为红色。
*   `border-blue-50`: 边框颜色将为蓝色。
*   `border-indigo-50`: 边框颜色将为靛蓝。
*   `border-purple-50`: 边框颜色将为紫色。
*   `border-green-50`: 边框颜色将为绿色。
*   `border-yellow-50`: 边框颜色将为黄色。
*   `border-pink-50`: 边框颜色将为粉色。
