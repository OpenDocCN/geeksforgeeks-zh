...
这些类根据分配给它们的编号向目标元素添加顶部和底部填充。属于这一类的班级名单如下：

| Sr 编号 | 班级名称 | 描述 |
| --- | --- | --- |
| 1. | `w3-padding-16` | 这个类给目标元素增加了 16px 的上下填充。 |
| 2. | `w3-padding-24` | 这个类给目标元素添加了 24px 的上下填充。 |
| 3. | `w3-padding-32` | 这个类给目标元素添加了 32px 的上下填充。 |
...
<body>
    ...
    <div class="w3-container">
        ...
        <h3 class="w3-text-blue">Numbered Padding Classes:</h3>
...
这些类根据其大小向目标元素添加顶部、底部、左侧和右侧填充。属于这一类别的班级名单如下：

| Sr 编号 | 班级名称 | 描述 |
| --- | --- | --- |
| 1. | `w3-padding-small` | 这个类给元素添加了 4px 的顶部、底部和 8px 的左、右填充。 |
| 2. | `w3-padding` | 这个类给元素添加了 8px 的顶部、底部和 16px 的左、右填充。 |
| 3. | `w3-padding-large` | 这个类给元素添加了 12px 的顶部、底部和 24px 的左、右填充。 |
...
<body>
    ...
    <div class="w3-container">
        ...
        <h3 class="w3-text-blue">Sized Padding Classes:</h3>

        <!-- w3-padding-small class -->
        <div class="w3-container w3-padding-small w3-teal">
        ...
        <div class="w3-container w3-padding-large w3-deep-orange">
