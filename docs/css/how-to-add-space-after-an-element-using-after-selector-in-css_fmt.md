...
> 原文：[https://www.geeksforgeeks.org/how-to-add-space-after-an-element-using-after-selector-in-css/](https://www.geeksforgeeks.org/how-to-add-space-after-an-element-using-after-selector-in-css/)

CSS 中的`:after`选择器，用于在其他元素的内容后多次添加相同的内容。它在每个选定元素的内容后插入一些内容。
