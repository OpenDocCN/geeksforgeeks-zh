...
> 原文: [https://www.geeksforgeeks.org/how-to-decorate-list-bullets-in-arrow-using-css/](https://www.geeksforgeeks.org/how-to-decorate-list-bullets-in-arrow-using-css/)
...
*   首先，我们将关闭列表的默认项目符号样式。
*   然后我们将在 `li::before` 选择器的 `content` 属性中插入箭头字符的 Unicode。
...
*   我们将在 `list-style-image` 属性中插入我们想要插入的图像的网址来代替默认的项目符号样式。
