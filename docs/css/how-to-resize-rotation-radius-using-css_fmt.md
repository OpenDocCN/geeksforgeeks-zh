...
> 原文: [https://www.geeksforgeeks.org/how-to-resize-rotation-radius-using-css/](https://www.geeksforgeeks.org/how-to-resize-rotation-radius-using-css/)
...
*   然后使用 [`calc()`函数](https://www.geeksforgeeks.org/css-calc-function/)计算 45°的`--radius`值。在这里，您还可以根据需要使用任何其他定义的变量来计算半径。
*   它可以用来调整旋转半径。
