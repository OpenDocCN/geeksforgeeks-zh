...
> 原文: [https://www.geeksforgeeks.org/how-to-create-animated-background-using-css3/](https://www.geeksforgeeks.org/how-to-create-animated-background-using-css3/)
...
在本节中，我们使用一些 CSS 属性来设计背景动画。我们使用 [`linear-gradient()`](https://www.geeksforgeeks.org/css-linear-gradient-function/) 方法和 [`animation`](https://www.geeksforgeeks.org/css-animations/) 属性来设计背景。
...
在本节中，我们将结合 HTML 和 CSS 代码制作一个背景动画。
