...
> 原文：[https://www.geeksforgeeks.org/how-to-set-div-width-to-fit-content-using-css/](https://www.geeksforgeeks.org/how-to-set-div-width-to-fit-content-using-css/)
...
在该方法中，我们将 `width` 和 `height` 属性设置为 `fit-content` 值。
