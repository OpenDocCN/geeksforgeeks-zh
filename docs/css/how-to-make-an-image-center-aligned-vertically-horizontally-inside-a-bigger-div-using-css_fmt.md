...
> 原文：`https://www.geeksforgeeks.org/how-to-make-an-image-center-aligned-vertically-horizontally-inside-a-bigger-div-using-css/`

在本文中，我们将了解如何使用 CSS 对 `div` 标签中的图像进行居中对齐&还将通过示例了解其实现。给定一个图像，我们需要在一个更大的 `div` 中设置与中心对齐(垂直和水平)的图像。可以使用元素的`位置属性`来完成。
