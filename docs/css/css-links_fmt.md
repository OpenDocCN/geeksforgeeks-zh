...
在讨论 CSS 属性之前，了解链接的状态很重要。链接可以存在于不同的状态，并且它们可以使用伪类进行样式化。
下面给出了四种状态的链接:
...
<html>
    ...
    <body>
        <p><a href="https://www.geeksforgeeks.org/">GeeksforGeeks</a> This link will change colours with different states.</p>
    </body>
</html>
```
...
<html>
    ...
    <body>
        <p><a href="https://www.geeksforgeeks.org/" id="link">GeeksforGeeks</a> a Computer Science Portal for Geeks.</p>
    </body>
</html>
```
...
<html>
    <head>
        ...
        <style>
            ...
            /* underline can be added using text-decoration: underline; */
        </style>
    </head>
    <body>
        <p><a href="https://www.geeksforgeeks.org/" id="link">GeeksforGeeks</a> a Computer Science Portal for Geeks.</p>
...
CSS 链接也可以使用按钮/框进行样式化。以下示例显示了如何将 CSS 链接设计为按钮。
