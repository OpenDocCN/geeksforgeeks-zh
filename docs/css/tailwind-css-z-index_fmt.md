...
用于给元素赋予 `z-index` 10。元素沿 z 轴向上显示 10px。
...
用于给元素赋予 `z-index` 20。元素沿 z 轴向上显示 20px。
...
用于给元素赋予 `z-index` 30。元素沿 z 轴向上显示 30px。
...
用于给元素赋予 `z-index` 40。元素沿 z 轴向上显示 40px。
...
用来给元素赋予 `z-index` 50。元素沿 z 轴向上显示 50px。
