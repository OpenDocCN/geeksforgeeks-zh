...
`.inset-0`、`.inset-y-0`、`.inset-x-0`、`.top-0`、`.right-0`、`.bottom-0`、`.left-0`。
...
**示例:**在本例中，我们使用的是`left-0` 和`top-0` 类。
...
**示例:**在本例中，我们使用的是`right-0` 和`bottom-0` 类。
