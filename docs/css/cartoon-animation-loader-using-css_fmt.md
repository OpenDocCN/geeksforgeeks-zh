...
> 原文: [https://www.geeksforgeeks.org/cartoon-animation-loader-using-css/](https://www.geeksforgeeks.org/cartoon-animation-loader-using-css/)
...
## CSS 代码
在本节中，卡通加载器的设计是使用 `@keyframes` 等 CSS 属性实现的。动画是通过从一套风格逐渐改变到另一套风格来创建的。更改以百分比表示，或者带有关键字“从”和“到”，这将与 `0%` 和 `100%` 相同。我们可以根据需要多次更改 CSS 样式集。
