...
## 方法
方法是给一个渐变的背景，做一些边框，给它一种闪亮的反射的样子。对于高级概念，我们将使用关键帧来更改背景颜色。
...
*   **第 2 步:** 现在使用一个名为 `animate` 的标识符应用动画属性制作动画
...
*   **步骤 4:** 现在使用 `section::before` 选择器[创建从顶部出现的左侧边框。](https://www.geeksforgeeks.org/css-before-selector/)
*   **第五步:** 现在使用 `section::after` 选择器[创建从顶部出现的右侧边框。](https://www.geeksforgeeks.org/css-after-selector/)
