# 如何用 HTML、CSS、JavaScript 为 Portfolio Gallery 添加滤镜？

> 原文：[https://www.geeksforgeeks.org/how-to-add-filter-with-portfolio-gallery-using-html-css-and-javascript/](https://www.geeksforgeeks.org/how-to-add-filter-with-portfolio-gallery-using-html-css-and-javascript/)

![](img/2aec497ff8b51c6a5b510f8fb1565908.png)

当您的网站包含不同类型的内容或如此多的内容时，组合库非常有用。在作品集图库的帮助下，您可以轻松地向用户显示首页上的所有内容。但是如果用户想要一些具体的内容，那么我们需要在投资组合上附加过滤器。在本文中，我们将使用 JavaScript 添加过滤器。在进入本文之前，您可以看到文章“[如何使用 HTML 和 CSS 创建一个 Portfolio Gallery？](https://www.geeksforgeeks.org/how-to-create-a-portfolio-gallery-using-html-and-css/)”。

## 创建结构

在本节中，我们将创建投资组合的基本网站结构。在这里，我们将附加标题属性，以便用户可以知道投资组合的每个网格上的内容类型。

### HTML 代码

本节我们将设计 Portfolio Gallery 的基本结构。
...
在上一节中，我们已经创建了基本网站的结构，现在我们将使用 CSS 来设计网页的结构。
...
现在我们已经完成了结构和设计，最后一步是添加功能。我们将使用 JavaScript 来实现过滤功能。
...
结合 HTML、CSS 和 JavaScript 部分代码，用过滤器组成一个完整的 Portfolio Gallery。
...
![CSS](https://www.geeksforgeeks.org/wp-content/uploads/CSS.png)
...
![PHP](https://www.geeksforgeeks.org/wp-content/uploads/php-1.png)
...
![JavaScript](https://www.geeksforgeeks.org/wp-content/uploads/javascript.png)
