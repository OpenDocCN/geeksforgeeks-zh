...
`pagination` 类用于将 `<ul>` 列表元素设置为分页组件。必须显示的页面在该组件中定义为 `<li>` 项。左右箭头图标可用于显示移动到下一页或上一页的按钮。
...
<head>
    ...
    <!-- Include Compiled and minified Materialize CSS -->
    <link rel="stylesheet" href=
...
<body>
    <div class="card-panel">
        ...
        <ul class="pagination center-align">
            ...
            <!-- Use icon inside list item for the left arrow -->
            <li class="disabled">
                <a href="#!">
                    <i class="material-icons">
                        chevron_left
            ...
            <!-- Various classes that can be used with the page links -->
            <li class="waves-effect">
                <a href="#!">1</a>
            </li>
            ...
            <!-- Use icon inside list item for the right arrow -->
            <li class="waves-effect">
                <a href="#!">
                    <i class="material-icons">
                        chevron_right
