...
> 原文: [https://www.geeksforgeeks.org/how-to-add-a-box-shadow-on-one-side-of-an-element-using-css/](https://www.geeksforgeeks.org/how-to-add-a-box-shadow-on-one-side-of-an-element-using-css/)

[`box-shadow`](https://www.geeksforgeeks.org/css-box-shadow-property/) 属性用于设置元素一侧的框阴影。
...
默认情况下，阴影在框外生成，但 `inset` 值可用于在框内创建阴影。
