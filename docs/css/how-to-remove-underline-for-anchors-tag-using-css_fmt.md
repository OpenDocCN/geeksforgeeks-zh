...
> 原文：[https://www.geeksforgeeks.org/how-to-remove-underline-for-anchors-tag-using-css/](https://www.geeksforgeeks.org/how-to-remove-underline-for-anchors-tag-using-css/)

锚点标签用于定义超链接，默认情况下，它显示带下划线的锚点部分。使用`text-decoration`属性可以很容易地删除下划线。CSS 的`text-decoration`属性允许根据需要修饰文本。通过将`text-decoration`设置为`none`来移除锚点标签的下划线。
