...
> 原文: [https://www.geeksforgeeks.org/css-transform-origin-property/](https://www.geeksforgeeks.org/css-transform-origin-property/)

CSS 的 `transform-origin` 属性用于指定元素的旋转原点。它是元素旋转的点。它可以用于 2D 和三维旋转。
...
<head>
    <style>
        ...
        .box {
            position: absolute;
            border: 1px solid;
            background: url("https://contribute.geeksforgeeks.org/wp-content/uploads/geeksforgeeks-logo.png") no-repeat;
...
<body>
    ...
    <p>The CSS transform-origin Property is used to set the origin of the element's transformation</p>
    <div class="outer">
        <div class="box"></div>
    </div>
</body>
