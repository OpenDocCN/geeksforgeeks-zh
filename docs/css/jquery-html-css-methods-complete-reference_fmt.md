...
> 原文: [https://www.geeksforgeeks.org/jquery-html-css-methods-complete-reference/](https://www.geeksforgeeks.org/jquery-html-css-methods-complete-reference/)

JQuery 提供了有效控制 DOM 的方法。JQuery 提供了充当 getter 的方法，从类似`.attr()`、`.html()` 和`.val()`的 DOM 元素中检索信息。

在 jQuery 中支持 CSS 中包含的所有选择器。jQuery CSS 方法用于在 DOM 元素上应用 CSS 属性。
