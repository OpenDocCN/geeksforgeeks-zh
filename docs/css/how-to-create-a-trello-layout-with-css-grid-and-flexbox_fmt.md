...
> 原文：[https://www.geeksforgeeks.org/how-to-create-a-trello-layout-with-css-grid-and-flexbox/](https://www.geeksforgeeks.org/how-to-create-a-trello-layout-with-css-grid-and-flexbox/)
...
为了理解 Trello 布局，让我们首先创建一个包含单个列表项的 Trello 布局。
