...
> 原文: [https://www.geeksforgeeks.org/10-best-css-generator-tools-that-you-can-use/](https://www.geeksforgeeks.org/10-best-css-generator-tools-that-you-can-use/)
...
使用 `clip-path` 属性，这个在线工具为图像创建形状。您可以从预设形状中进行选择或创建自定义形状，然后通过在图像上移动点来对其进行自定义。当你有了完美的形状后，CSS 代码就会自动生成。如果你愿意，你自己的图片可以上传。
