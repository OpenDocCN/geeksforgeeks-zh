...
> 原文: [https://www.geeksforgeeks.org/maintain-the-aspect-ratio-of-a-div-with-css/](https://www.geeksforgeeks.org/maintain-the-aspect-ratio-of-a-div-with-css/)
...
要保持 div 的纵横比，请为 `padding-top` 添加一个百分比值。不同的纵横比具有不同的百分比值。其中一些如下所示：
