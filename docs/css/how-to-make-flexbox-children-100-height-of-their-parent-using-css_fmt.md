...
> 原文：[https://www.geeksforgeeks.org/how-to-make-flexbox-children-100-height-of-their-parent-using-css/](https://www.geeksforgeeks.org/how-to-make-flexbox-children-100-height-of-their-parent-using-css/)
...
**示例 2:** 第二种方法是使用父 div 中的 `align-items` 属性来“拉伸”。它让每一个子分区 100%的高度是父分区的高度。
