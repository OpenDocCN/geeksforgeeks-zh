...
> 原文：[https://www.geeksforgeeks.org/how-to-dynamically-create-keyframe-css-animations/](https://www.geeksforgeeks.org/how-to-dynamically-create-keyframe-css-animations/)
...
*   `rule`：一个 `DOMString`，本质上是要插入的 CSS 规则。
*   `index`（可选）：在 CSS 样式表中插入规则的索引。
