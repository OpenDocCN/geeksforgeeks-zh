# 如何使用 Pure CSS 创建带图标按钮？

> 原文：[https://www.geeksforgeeks.org/how-to-use-buttons-with-icons-using-pure-css/](https://www.geeksforgeeks.org/how-to-use-buttons-with-icons-using-pure-css/)
...
下面的代码演示了使用各种纯 CSS 类的纯按钮。为了更好地理解，请参考以下代码和输出图像中的注释。
...
以下示例演示了使用纯 CSS 类的其他按钮。开发人员可以开发自己的自定义按钮，如下面所示的成功按钮。
