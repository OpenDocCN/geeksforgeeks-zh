...
> 原文: [https://www.geeksforgeeks.org/how-to-create-custom-banner-background-using-css/](https://www.geeksforgeeks.org/how-to-create-custom-banner-background-using-css/)
...
*   **步骤 3:** 使用 `before` 选择器，使用 `linear-gradient` 属性创建一个小的三角形链，具有相同的度数，但保持其中一个为负。
