...
> 原文: [https://www.geeksforgeeks.org/cssstyledeclaration-item-method/](https://www.geeksforgeeks.org/cssstyledeclaration-item-method/)

`item()`方法用于通过索引从CSS声明块中返回CSS的属性名。
...
*   `index`: 这是一个必需的参数，包含一个代表CSS属性索引的数字。
