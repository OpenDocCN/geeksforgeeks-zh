...
> 原文: [https://www.geeksforgeeks.org/explain-the-concept-of-pseudo-elements-in-css/](https://www.geeksforgeeks.org/explain-the-concept-of-pseudo-elements-in-css/)
...
**注意:** 在 `CSS3` 中，双冒号 `::` 代替了伪元素的单冒号符号。单冒号也可以用在 `CSS1` 和 `CSS2` 中。
...
**1. `selector::first-line`:** `first-line` 伪元素为选择器中文本的第一行**添加特殊样式**。我们可以用这个给第一行添加各种样式。这里我们看到一个例子:
