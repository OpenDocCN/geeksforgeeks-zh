...
> 原文: [https://www.geeksforgeeks.org/css-background-attachment-property/](https://www.geeksforgeeks.org/css-background-attachment-property/)

CSS 中的 `background-attachment` 属性用于指定背景图像相对于其容器的附件种类。它可以设置为滚动或保持固定。它可以应用于所有的 HTML 元素。
...
**scroll:** 设置背景图像固定在相对于包含元素的位置，随页面滚动。这是默认值。
...
**fixed:** 该属性用于将背景图像设置为固定在相对于视口的位置。
...
<html>
    ...
    <body style="text-align:center">
        <h1>GeeksforGeeks</h1>
        <h2> background-attachment: initial;</h2>
        <div id="example">
            <p>
                Prepare for the Recruitment drive of product based companies like Microsoft, Amazon, Adobe etc with a free online placement preparation course. The course focuses on various MCQ's & Coding question likely to be asked in the interviews & make your upcoming placement season efficient and successful.
            </p>
...
### 支持的浏览器
`background-attachment`属性支持的浏览器如下：
