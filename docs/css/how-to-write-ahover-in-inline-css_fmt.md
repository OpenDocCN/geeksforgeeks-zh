# 如何在内嵌 CSS 中写一个 `:hover`？

> 原文：[https://www.geeksforgeeks.org/how-to-write-ahover-in-inline-css/](https://www.geeksforgeeks.org/how-to-write-ahover-in-inline-css/)
...
本示例使用 JavaScript 在 CSS 中显示一个 `:hover` 内容。调用 `onmouseover` 和 `onmouseout` 事件属性来显示 `a:hover` 内容。
