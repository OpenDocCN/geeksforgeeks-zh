...
有时我们需要创建文本，并在文本中添加轮廓。主要有两种方法可以为字体创建边框：

*   使用[文本阴影属性](https://www.geeksforgeeks.org/css-text-shadow-property/)
*   使用文本笔画属性

## 方法一：使用 `text-shadow` 属性

`text-shadow` 属性用于给文字添加字体边框或阴影。
...
**示例 2：** 本示例使用 `text-shadow` 属性创建带边框的文本。
...
`text-stroke` 属性用于给文字添加笔画。此属性可用于更改文本的宽度和颜色。使用 `-webkit-` 前缀支持此属性。
