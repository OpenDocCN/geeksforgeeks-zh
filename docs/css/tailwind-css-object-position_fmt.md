...
*   `object-left-top`:位于图像或视频的左上方。
*   `object-top`:它位于图像或视频的顶部。
*   `object-right-top`:位于图像或视频的右上方。
*   `object-left`:它位于图像或视频的左侧。
*   `object-center`:它位于图像或视频的中心。
*   `object-right`:它位于图像或视频的右侧。
*   `object-left-bottom`:位于图像或视频的左下方。
*   `object-bottom`:它位于图像或视频的底部。
*   `object-right-bottom`:位于图像或视频的右下方。
