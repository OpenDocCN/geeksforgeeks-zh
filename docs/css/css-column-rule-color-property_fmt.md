# CSS column-rule-color属性

> 原文：[https://www.geeksforgeeks.org/css-column-rule-color-property/](https://www.geeksforgeeks.org/css-column-rule-color-property/)

CSS 的 `column-rule-color` 属性用于改变列间规则的颜色。
