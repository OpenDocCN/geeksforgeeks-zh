...
> 原文：[https://www.geeksforgeeks.org/how-to-make-rounded-corner-using-css/](https://www.geeksforgeeks.org/how-to-make-rounded-corner-using-css/)

为了创建圆角，我们使用 CSS [`border-radius`](https://www.geeksforgeeks.org/css-border-radius-property/) 属性。此属性用于设置元素的边框半径。
...
**示例 2：** 本示例描述了使用 `border-bottom-left-radius` 属性在左下角制作圆角。
...
**示例 3：** 本示例描述了使用 `border-top-right-radius` 属性在右上角制作圆角。
...
**示例 5：** 本示例描述了使用 `border-top-left-radius` 属性在左上角制作拐角。
