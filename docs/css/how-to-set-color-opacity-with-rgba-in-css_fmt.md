...
> 原文: [https://www.geeksforgeeks.org/how-to-set-color-opacity-with-rgba-in-css/](https://www.geeksforgeeks.org/how-to-set-color-opacity-with-rgba-in-css/)
...
在下面的示例中，我们使用了带有 alpha 值(不透明度)的 CSS [`background-color`](https://www.geeksforgeeks.org/css-background-color-property/) 属性。
