...
> 原文：[https://www.geeksforgeeks.org/how-to-create-a-hidden-border-using-css-properties/](https://www.geeksforgeeks.org/how-to-create-a-hidden-border-using-css-properties/)
...
*   所用属性将设为 [`border-style`](https://www.geeksforgeeks.org/css-border-style-property/) ：`hidden`。
...
*   我们将使用两个标题，其中一个将显示边框颜色，另一个将不会显示，因为它将使用 CSS 隐藏。
*   我们将使用的 CSS 位于 `style` 标签内，也称为[内部 CSS](https://www.geeksforgeeks.org/types-of-css-cascading-style-sheet/) ，应用于像 `h1`、`h2` 这样的元素。
*   我们将使用 `border-style` 属性：`hidden`。
