...
> 原文：[https://www.geeksforgeeks.org/how-to-modify-css-class-using-jquery-library/](https://www.geeksforgeeks.org/how-to-modify-css-class-using-jquery-library/)
...
<head>
    ...
    <script>
        $(() => {
            ...
            // Div having class gfg_class_1 and
...
- 点击按钮将使包含文本 'Sam' 的下一列文字变为蓝色。
- 点击按钮将使紧邻包含 '6.' 的区块的所有列文字变为黄色。
- 点击按钮将使包含 '8.' 的行文字变为粉红色。
- 点击按钮将使包含 '8.' 的行文字变为粗体。
- 点击按钮将使包含 '2756' 的列的子元素变为粗体。
