...
> 原文: [https://www.geeksforgeks.org/css-border-block-start-property/](https://www.geeksforgeks.org/css-border-block-start-property/)

CSS 中的 `border-block-start` 属性用于在样式表的一个地方定义单个逻辑块开始边框属性值。此属性将边框放置在定义元素的顶部。
...
以下示例说明了 CSS 中的 `border-block-start` 属性:
