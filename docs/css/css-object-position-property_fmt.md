...
CSS 的 `object-position` 属性指定图像或视频元素如何在其内容框内用 x/y 坐标定位。
...
<body>
    ...
    <img id="object" src="https://media.geeksforgeeks.org/wp-content/uploads/sample_image.png" />
</body>
</html>
```
