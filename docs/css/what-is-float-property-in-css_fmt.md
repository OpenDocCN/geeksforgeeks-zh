...
> 原文：[https://www.geeksforgeeks.org/what-is-float-property-in-css/](https://www.geeksforgeeks.org/what-is-float-property-in-css/)
...
在下面的例子中，我们使用 `left` 的浮点值。使用此值后，元素必须留在其容器中，如下图所示。
