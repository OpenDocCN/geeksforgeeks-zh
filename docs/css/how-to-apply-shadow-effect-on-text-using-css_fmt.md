...
> 原文: [https://www.geeksforgeeks.org/how-to-apply-shadow-effect-on-text-using-css/](https://www.geeksforgeeks.org/how-to-apply-shadow-effect-on-text-using-css/)

在本文中，我们将学习如何使用 CSS 对文本应用阴影效果。CSS 的文本阴影属性用于对文本应用阴影效果。

**方法:** CSS 的 [`text-shadow`](https://www.geeksforgeeks.org/css-text-shadow-property/) 属性用于对文本应用阴影效果。它有四个值: 垂直阴影、水平阴影、模糊和颜色。文本阴影属性的所有细节如下:
