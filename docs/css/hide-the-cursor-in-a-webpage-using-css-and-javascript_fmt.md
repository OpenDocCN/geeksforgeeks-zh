...
> 原文: [https://www.geeksforgeeks.org/hide-the-cursor-in-a-webpage-using-css-and-javascript/](https://www.geeksforgeeks.org/hide-the-cursor-in-a-webpage-using-css-and-javascript/)
...
*   首先，选择光标元素需要隐藏的元素。
*   将 CSS 样式 `` `cursor: none` `` 添加到一个类中。
*   将类名（CSS 样式 `` `cursor: none` `` 的类名）添加到要隐藏光标元素的特定元素中。
