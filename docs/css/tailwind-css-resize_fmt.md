...
*   `resize-none`: 这个类是为了防止一个元素被调整大小。
*   `resize-y`: 这个类是让一个元素可以垂直调整大小。
*   `resize-x`: 这个类是让一个元素可以水平调整大小。
*   `resize`: 这个类是让一个元素可以水平和垂直调整大小。
...
<body class="text-center">
    ...
    <div id="main" class="p-2 justify-around ml-32 h-26 w-2/3 flex items-stretch bg-green-200 border-solid border-4 border-green-900 gap-4">
        <textarea class="resize border rounded-md w-24 h-12"></textarea>
        <textarea class="resize-y border rounded-md w-24 h-12"></textarea>
        <textarea class="resize-x border rounded-md w-24 h-12"></textarea>
        <textarea class="resize-none border rounded-md w-24 h-12"></textarea>
    </div>
</body>
</html>
```
