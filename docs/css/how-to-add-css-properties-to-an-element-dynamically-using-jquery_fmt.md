...
> 原文：[https://www.geeksforgeeks.org/how-to-add-css-properties-to-an-element-dynamically-using-jquery/](https://www.geeksforgeeks.org/how-to-add-css-properties-to-an-element-dynamically-using-jquery/)
...
在这里，我们在主体标签中创建了两个元素，即 `<h1>` 和 `<h3>` 元素。我们使用 `css()` 方法动态地在 `<body>` 标签和 `<h1>` 标签上应用 CSS 属性。
