...
> 原文: [https://www.geeksforgeeks.org/how-to-create-animation-loading-bar-using-css/](https://www.geeksforgeeks.org/how-to-create-animation-loading-bar-using-css/)
...
**CSS 代码:** 在本节中，我们将使用一些 CSS 属性来设计**加载栏**。我们将使用指定动画代码的 `@keyframes`。动画是通过从一组 CSS 样式逐渐改变到另一组样式来创建的。使用关键字“从”(0%)和“到”(100%)时，样式会发生百分比变化。我们可以多次更改 CSS 样式集。
