...
> 原文：[https://www.geeksforgeeks.org/how-to-create-dark-theme-using-slider-in-css/](https://www.geeksforgeeks.org/how-to-create-dark-theme-using-slider-in-css/)
...
下面的示例演示了如何在 CSS 中使用滑块创建深色主题。

### 步骤 1

创建一个 `index.html` 文件，并在其中添加以下 html 代码，为网页提供基本结构。
...
现在我们将创建一个新的文件，为上面的 html 代码添加样式。
...
现在我们将创建一个 javascript 文件，并使函数 `toggleSwitch` 允许我们在黑暗和光明主题之间切换。
