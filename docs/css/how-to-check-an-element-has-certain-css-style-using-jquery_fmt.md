...
> 原文：[https://www.geeksforgeeks.org/how-to-check-an-element-has-certain-css-style-using-jquery/](https://www.geeksforgeeks.org/how-to-check-an-element-has-certain-css-style-using-jquery/)

给定一个包含一些 CSS 属性的 HTML 文档，任务是在 jQuery 的帮助下检查一个元素是否有特定的 CSS 样式。

## 方法 1：使用 `css()` 方法

使用 `css()` 方法检查一个元素是否包含某些 CSS 样式。

**示例：** 本示例使用 `css()` 方法检查元素是否包含某种 CSS 样式。
...
使用 `hasClass()` 方法检查元素是否包含某些 CSS 样式。

**示例：** 本示例使用 `hasClass()` 方法检查元素是否包含某种 CSS 样式。
