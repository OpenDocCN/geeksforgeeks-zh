...
> 原文：[https://www.geeksforgeeks.org/how-to-create-horizontal-scrollable-sections-using-css/](https://www.geeksforgeeks.org/how-to-create-horizontal-scrollable-sections-using-css/)
...
*   用类 `content` 创建一个 `div` 元素。
*   在我们的内容分区中，创建另一个包含类 `section` 的四个 `div`。
*   给每个分区四个不同的 `id`。
