...
> 原文: [https://www.geeksforgeeks.org/how-to-use-animation-delay-in-css/](https://www.geeksforgeeks.org/how-to-use-animation-delay-in-css/)
...
### 示例 1:
在本例中，我们使用动画属性来添加动画效果，还使用动画-延迟属性来添加动画中的时间延迟。
...
### 示例 2:
在本例中，我们使用动画名称属性来添加动画效果，还使用动画延迟属性来添加动画中的时间延迟。我们还使用了动画迭代计数属性来添加动画迭代。
