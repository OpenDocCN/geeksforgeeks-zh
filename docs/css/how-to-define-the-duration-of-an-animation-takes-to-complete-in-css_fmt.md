...
> 原文：[https://www.geeksforgeeks.org/how-to-define-the-duration-of-an-animation-takes-to-complete-in-css/](https://www.geeksforgeeks.org/how-to-define-the-duration-of-an-animation-takes-to-complete-in-css/)
...
**定义动画持续时间：** 要使用 CSS 动画，我们需要定义 CSS 显示不同外观的时间间隔。为此，我们有 `animation-duration` 属性，该属性设置动画完成一个周期所需的时间间隔。
...
以下是说明使用 `animation-duration` 的例子。
...
现在我们的 HTML 文件已经准备好了，我们可以在 CSS 文件中定义我们的样式和动画。在这个例子中，我们将使用 `animation-duration` 属性，它将在 5 秒内改变我们标题的颜色。
