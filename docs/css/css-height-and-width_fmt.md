...
用于设置盒子的最大宽度。它的效果可以通过调整浏览器的大小来看到。
...
用于设置盒子的最小宽度。它的效果可以通过调整浏览器的大小来看到。
...
用于设置盒子的最大高度。它的效果可以通过调整浏览器的大小来看到。
...
用于设置盒子的最小高度。它的效果可以通过调整浏览器的大小来看到。
