...
> 原文: [https://www.geeksforgeeks.org/how-to-insert-line-break-before-an-element-using-css/](https://www.geeksforgeeks.org/how-to-insert-line-break-before-an-element-using-css/)

`white-space` 属性用于在元素前插入换行符。此属性控制文本换行和空白。
![](img/83f77db14741ac087d07a40a8c2054e5.png)

## 空白属性介绍

**行与行之间的换行符:** 可以在文本行之间添加换行符。`white-space: pre-line;` 用于在元素前插入换行符。
...
HTML 元素之间的换行符可以使用 CSS 属性添加。有两种方法可以强制内联元素添加新行。

*   **使用 `display` 属性:** 块级元素从新的一行开始，并占据其可用的整个宽度。
