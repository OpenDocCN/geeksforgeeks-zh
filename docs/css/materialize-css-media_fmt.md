...
为使图像响应页面宽度，`responsive-img` 类添加了图像标签。
...
物化 CSS 为嵌入式视频提供了一个容器，可以相应地调整大小。

### 响应嵌入

要使嵌入响应，只需将它们包装在包含类 `video-container` 的 div 中。
...
要使 HTML5 视频具有响应性，只需将类 `responsive-video` 添加到视频标签中。
...
<body>
    ...
    <div class="card-panel">
        ...
        <video class="responsive-video" controls>
            <source src="WhatsApp Video 2020-06-02 at 13.23.30.mp4" type="video/mp4">
        </video>
    </div>
