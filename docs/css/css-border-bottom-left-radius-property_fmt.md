...
> 原文: [https://www.geeksforgeks.org/css-border-bottom-left-radius-property/](https://www.geeksforgeks.org/css-border-bottom-left-radius-property/)

`border-bottom-left-radius` 属性用于定义边框左下角的半径，即使边框左下角变圆。
