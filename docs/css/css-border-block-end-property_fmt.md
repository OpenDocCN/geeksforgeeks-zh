...
> 原文：[https://www.geeksforgeeks.org/css-border-block-end-property/](https://www.geeksforgeeks.org/css-border-block-end-property/)

CSS 中的 `border-block-end` 属性用于在样式表的一个地方定义单个逻辑块尾边框属性值。此属性将边框放置在定义元素的底部。
...
以下示例说明了 CSS 中的 `border-block-end` 属性：
