...
> 原文：[https://www.geeksforgeeks.org/how-to-set-css-style-to-half-of-a-character/](https://www.geeksforgeeks.org/how-to-set-css-style-to-half-of-a-character/)
...
*   使用 HTML 和 CSS
*   使用 HTML、CSS 和 jQuery

### 示例 1：使用 HTML 和 CSS

本示例使用 HTML 和 CSS 为半个字符设置样式。
...
### 示例 2：使用 HTML、CSS 和 jQuery

本示例使用 HTML、CSS 和 jQuery 来样式化半个字符。
