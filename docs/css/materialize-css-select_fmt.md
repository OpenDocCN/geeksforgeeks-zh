...
*   **通过多个选项选择下拉菜单:** 允许从选择下拉菜单中选择多个选项。为此，在`<选择>`标签中使用了`multiple`属性。
*   **使用选项组选择下拉菜单:** 允许从列表中选择基于选择下拉菜单的类别。
*   **选择带图像的下拉菜单:** 允许显示带选项的图像。
*   **使用浏览器默认值选择下拉菜单:** 它可以与选择标签中的`browser-default`类一起使用。

**禁用样式:**

物化选择提供了自己使用的禁用功能。要使整个项目不可选择，将`disabled`属性添加到选择元素，并禁用单个选项，然后将`disabled`添加到选项。
            ...
            <form class="col s12">
                ...
                <div class="row green-text">
                    ...
                    <select class="icons">
                        ...
                        <option value="1" data-icon="https://pbs.twimg.com/profile_images/1138375574726955008/1fNUyEdv_400x400.png" class="circle"> HTML</option>
