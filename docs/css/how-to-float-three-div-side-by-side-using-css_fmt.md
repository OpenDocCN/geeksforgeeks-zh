...
> 原文: [https://www.geeksforgeeks.org/how-to-float-three-div-side-by-side-using-css/](https://www.geeksforgeeks.org/how-to-float-three-div-side-by-side-using-css/)

使用 CSS 可以并排放置三个或更多不同的 `div`。使用 CSS 属性设置 `div` 的高度和宽度，使用 `display` 属性以并排格式放置 `div`。

*   `float: left;` 此属性用于将在左侧浮动的元素(`div`)。
*   `float: right;` 此属性用于将在右侧浮动的元素(`div`)。

## 示例 1: 使用 float 属性并排放置三个 div
...
### 输出
![](img/49d5caad4687e0c192fbfc97ff33c315.png)

## 示例 2: 使用 float 属性并排放置三个 div
...
<html> 
    ...
    <body>
        ...
        <div class="container">
            <div id="st-box">
                <img src="https://media.geeksforgeeks.org/wp-content/uploads/download-49.png" style="width:180px; height:160px;">
            </div>
            <div id="nd-box">
                <p>
            ...
            <div id="rd-box">
                <img src="https://media.geeksforgeeks.org/wp-content/uploads/images-31.png" style="width:180px; height:160px;">
            </div>
        </div>
        </center>
    </body>
...
## 示例 3: 使用 display 属性并排放置三个 div 的另一种方法

*   `display: table;` 该属性用于行为类似于表的元素(`div`)。
*   `display: table-cell;` 该属性用于行为类似于 `td` 的元素(`div`)。
*   `display: table-row;` 该属性用于行为类似 `tr` 的元素(`div`)。
