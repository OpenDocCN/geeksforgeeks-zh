...
CSS 中的`行内尺寸属性`用于定义元素块的水平或垂直尺寸。根据`书写模式属性`的值，它与`width`或`height`属性一致。它会在元素文本周围留出空间。
...
[https://developer.mozilla.org/en-US/docs/Web/CSS/inline-size](https://developer.mozilla.org/en-US/docs/Web/CSS/inline-size)