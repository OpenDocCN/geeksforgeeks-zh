...
> 原文：[https://www.geeksforgeeks.org/how-to-design-initial-letter-of-text-paragraph-using-css/](https://www.geeksforgeeks.org/how-to-design-initial-letter-of-text-paragraph-using-css/)
...
本文将告诉你如何仅使用`HTML`和`CSS`在网页中创建一个类似的故事书效果。

在编写代码之前，您只需要在程序中为字体系列包含以下样式表：`Cormorant Infant`
...
现在，正如你在输出中看到的，我们已经创建了一个漂亮的故事书般的效果，它将吸引读者阅读网页上的内容。