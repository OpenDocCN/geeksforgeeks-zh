...
> 原文：[https://www.geeksforgeeks.org/css-border-inline-start-property/](https://www.geeksforgeeks.org/css-border-inline-start-property/)

CSS 中的 `border-inline-start` 属性用于在样式表中的一个位置定义单个逻辑内联结束边框属性值。此属性将边框放置在定义元素的左侧。
...
`border-inline-start` 属性支持的浏览器如下：
...
[https://developer.mozilla.org/en-US/docs/Web/CSS/border-inline-start](https://developer.mozilla.org/en-US/docs/Web/CSS/border-inline-start)