...
> 原文: [https://www.geeksforgeeks.org/hide-scroll-bar-but-while-still-being-able-to-scroll-using-css/](https://www.geeksforgeeks.org/hide-scroll-bar-but-while-still-being-able-to-scroll-using-css/)
...
3.  如果确实需要隐藏滚动条：将所有重要信息显示在首屏（above the fold）之上。用户通常根据无需滚动就能看到的内容来决定是否停留。
...
<html>
    ...
    <body>
        <div class="outer-border">
            <div class="inner-border">
            <div class="content">
            <img src="https://media.geeksforgeeks.org/wp-content/uploads/Screenshot-73-1.png">
            <img src="https://media.geeksforgeeks.org/wp-content/uploads/Screenshot-74-4.png">
            </div>
            </div>
        </div>
    </body>
