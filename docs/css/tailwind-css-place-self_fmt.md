...
这个类接受 [Tailwind CSS](https://www.geeksforgeeks.org/css-tailwind-introduction/) 中的很多值。它是 [CSS place-self 属性](https://www.geeksforgeeks.org/css-place-self-property/)的替代物。此类用于控制如何同时对齐和对齐单个项目。在这个类中，您可以在一个类中设置多个类值。
