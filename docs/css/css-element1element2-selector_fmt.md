...
> 原文: [https://www.geeksforgeeks.org/css-element1element2-selector/](https://www.geeksforgeeks.org/css-element1element2-selector/)
...
在此示例中，两个元素没有相同的父元素。所以 CSS 属性不适用。
