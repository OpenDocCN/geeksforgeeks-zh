...
> 原文：[https://www.geeksforgeeks.org/how-to-fill-up-the-rest-of-screen-height-using-tailwind-css/](https://www.geeksforgeeks.org/how-to-fill-up-the-rest-of-screen-height-using-tailwind-css/)

在本文中，我们将学习如何使用 [Tailwind CSS](https://www.geeksforgeeks.org/css-tailwind-introduction/) 填充屏幕高度的剩余部分。

## 方法

为了解决上述问题，我们将使用 Tailwind CSS 的 [flex 类](https://www.geeksforgeeks.org/tailwind-css-flex/) 和 [height 类](https://www.geeksforgeeks.org/tailwind-css-height/)。

我们将用来解决这个问题的类如下。

*   `flex`：用于设置弹性项目的长度。`flex` 类反应灵敏，移动友好。
*   `flex-col`：用于垂直定位弹性项。
