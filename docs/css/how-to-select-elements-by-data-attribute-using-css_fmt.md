...
> 原文：[https://www.geeksforgeeks.org/how-to-select-elements-by-data-attribute-using-css/](https://www.geeksforgeeks.org/how-to-select-elements-by-data-attribute-using-css/)
...
*   `[attr|="value"]`：选择以指定值开始的具有指定属性的元素。
*   `[attr^="value"]`：选择属性值以指定值开始的元素。
*   `[attr$="value"]`：选择属性值以指定值结束的元素。
*   `[attr*="value"]`：选择属性值包含指定值的元素。

**示例 1：** 本示例通过使用 CSS 选择元素 `[target]` 来更改 `<a>` 元素的背景颜色。
...
**示例 2：** 本示例通过使用 CSS 选择具有 `[target="_top"]` 的元素来更改 `<a>` 元素的背景色和文本色。
