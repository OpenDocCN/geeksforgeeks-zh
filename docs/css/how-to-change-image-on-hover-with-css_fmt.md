...
> 原文：[https://www.geeksforgeeks.org/how-to-change-image-on-hover-with-css/](https://www.geeksforgeeks.org/how-to-change-image-on-hover-with-css/)

本文的方法是当用户将鼠标悬停在图像上时改变图像。这个任务可以简单地通过使用 `background-image` 属性结合 `:hover` 伪类来替换或更改鼠标悬停时的图像来完成。
