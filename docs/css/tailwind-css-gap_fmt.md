...
<body class="text-center">
    ...
    <div id="main" class="grid grid-rows-2 grid-flow-col gap-5">
...
<body class="text-center">
    ...
    <div id="main" class="grid grid-rows-2 grid-flow-col gap-x-5">
        <div class="bg-green-500 rounded-lg m-4 h-12">1</div>
        <div class="bg-green-500 rounded-lg m-4 h-12">2</div>
        <div class="bg-green-500 rounded-lg m-4 h-12">3</div>
        <div class="bg-green-500 rounded-lg m-4 h-12">4</div>
...
## HTML 示例：gap-y-number

`gap-y-number`：通过使用 `gap-y` 类将间隙保持在 y 轴上根据提到的数字。
...
<body class="text-center">
    ...
    <div id="main" class="grid grid-rows-2 grid-flow-col gap-y-5">
        <div class="bg-green-500 rounded-lg m-4 h-12">1</div>
        <div class="bg-green-500 rounded-lg m-4 h-12">2</div>
        <div class="bg-green-500 rounded-lg m-4 h-12">3</div>
        <div class="bg-green-500 rounded-lg m-4 h-12">4</div>
