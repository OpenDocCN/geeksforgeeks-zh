...
> 原文: `https://www.geeksforgeks.org/difference-between-webkit-box-shadow-box-shadow-in-css/`
...
**`box-shadow`:** CSS 中的 `box-shadow` 属性用于应用 `box-shadow`。`box-shadow` 是 CSS 标准实现。
...
*   **优势:** 如果我们使用 `box-shadow` 最新版本的浏览器支持它。
