...
W3.CSS 有三个类来将文本居中、左对齐和右对齐。它们的描述如下：

| Sr number | taxon | describe |
| --- | --- | --- |
| 1. | `w3-left-align` | Used to align text to the left. |
| 2. | `w3-right-align` | It is used to align text to the right. |
...
为了使文本看起来更宽，我们使用了 W3.CSS 的一个 `w3-wide` 类。
...
| 2. | `w3-small` | This class sets the font size of the target element to 12px. |
...
| 5. | `w3-xxlarge` | This class sets the font size of the target element to 32px. |
| 6. | `w3-xxxlarge` | This class sets the font size of the target element to 48px. |
| 7. | `w3-jumbo` | This class sets the font size of the target element to 64px. |
...
W3.CSS 也有一些内置的字体样式，可以广泛用于装饰网页。字体样式的类别列表如下：

| Sr number | 类别名 | 描述 |
| --- | --- | --- |
| 1. | `w3-serif` | 字体样式更改为衬线。 |
| 2. | `w3-sans-serif` | 字体样式更改为无衬线。 |
| 3. | `w3-cursive` | 字体样式更改为草书。 |
| 4. | `w3-monospace` | 字体样式更改为等宽。 |
