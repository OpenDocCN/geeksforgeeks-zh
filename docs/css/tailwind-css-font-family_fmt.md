...
本类用于申请网页安全无衬线字体系列，如 `ui-sans-serif`、`system-ui`、`-apple-system`。
...
该类用于应用像 `ui-serif`、`Georgia`、`Cambria`、`Times New Roman`、`Times`、`serif` 等 websafe 衬线字体系列。
...
此类用于应用 websafe 等宽字体系列，如 `ui-monospace`、`SFMono-Regular`、`Menlo`、`Monaco`、`Consolas`、`Liberation Mono`、`Courier New`、`monospace`。
