...
> 原文: [https://www.geeksforgeeks.org/how-to-create-multiple-background-image-parallax-in-css/](https://www.geeksforgeeks.org/how-to-create-multiple-background-image-parallax-in-css/)

在这篇文章中，我们将学习如何在 CSS 中创建多个背景图像视差。

**方法：** 首先，我们将使用 CSS 中的 `background-image` 属性添加背景图像。我们可以使用 `background-image` 添加多个图像。
...
然后我们在 CSS 中应用 `animation` 属性来制作图像动画。
