...
> 原文：[https://www.geeksforgeeks.org/how-to-set-the-margins-of-a-paragraph-element-using-css/](https://www.geeksforgeeks.org/how-to-set-the-margins-of-a-paragraph-element-using-css/)
...
*   [`margin-top`](https://www.geeksforgeeks.org/css-margin-top-property/)
*   [`margin-right`](https://www.geeksforgeeks.org/css-margin-right-property/)
*   [`margin-bottom`](https://www.geeksforgeeks.org/css-margin-bottom-property/)
*   [`margin-left`](https://www.geeksforgeeks.org/css-margin-left-property/)
...
**示例 2：** 在下面的示例中，宽度为 `300px`，段落的边距将相同，并且将位于中心，因为它具有 `margin:auto`。边框宽度为 `80px`，颜色为紫色。
