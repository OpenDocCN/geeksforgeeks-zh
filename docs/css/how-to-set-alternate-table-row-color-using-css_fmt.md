...
> 原文: [https://www.geeksforgeeks.org/how-to-set-alternate-table-row-color-using-css/](https://www.geeksforgeeks.org/how-to-set-alternate-table-row-color-using-css/)

CSS 中的 `:nth-child()` 选择器用于根据元素在一组同级元素中的位置来匹配元素。它匹配第 n 个子元素的每个元素。
