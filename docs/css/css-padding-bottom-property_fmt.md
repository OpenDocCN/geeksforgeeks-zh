...
此值用于将填充大小指定为固定值。默认值为 `0`。它必须是非负的。
...
<html>
    ...
    <body style="text-align: center;">
        ...
        <!-- Below paragraph element has a padding-bottom of 35px -->
        <p class="geek">
...
此类型的值用于将底部填充指定为元素宽度的百分比。它必须是非负的。
...
<html>
    ...
    <body style="text-align: center;">
        <h1 style="color: green;">GeeksforGeeks</h1>
        <h2>padding-bottom Property</h2>
        <!-- Below Paragraph element has a padding-bottom of 10% -->
        <p class="geek">
