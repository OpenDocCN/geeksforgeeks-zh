...
> 原文: [https://www.geeksforgeeks.org/css-margin-block-end-property/](https://www.geeksforgeeks.org/css-margin-block-end-property/)

`margin-block-end` 属性用于定义元素的逻辑块结束边距。此属性有助于根据元素的书写模式、方向和文本方向来放置边距。
...
**支持的浏览器:** `margin-block-end` 属性支持的浏览器如下:
