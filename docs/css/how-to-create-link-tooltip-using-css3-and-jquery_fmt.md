...
> 原文: [https://www.geeksforgeeks.org/how-to-create-link-tooltip-using-css3-and-jquery/](https://www.geeksforgeeks.org/how-to-create-link-tooltip-using-css3-and-jquery/)

当一个元素或链接被悬停时，链接工具提示是显示额外信息的好方法。有几种方法可以做到这一点。

## 使用 CSS 和 jQuery

在 jQuery 中使用 `mouseenter` 和 `mouseleave` 事件来执行这个操作。
...
jQuery UI 的工具提示小部件有助于自定义工具提示。`tooltip()` 方法用于向任何元素添加工具提示。
...
工具提示可以使用 CSS 创建，并且可以像任何其他元素一样进行自定义。
