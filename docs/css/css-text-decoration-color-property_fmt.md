...
> 原文: [https://www.geeksforgeeks.org/css-text-decoration-color-property/](https://www.geeksforgeeks.org/css-text-decoration-color-property/)
...
## 支持的浏览器
`text-decoration-color` 属性支持的浏览器如下：
