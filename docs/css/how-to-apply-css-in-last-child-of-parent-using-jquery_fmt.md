...
> 原文：[https://www.geeksforgeeks.org/how-to-apply-css-in-last-child-of-parent-using-jquery/](https://www.geeksforgeeks.org/how-to-apply-css-in-last-child-of-parent-using-jquery/)
...
首先，我们创建一个包含 `div` 元素的 HTML 元素。这个 `div` 元素包含一些段落元素，然后我们使用`:last-child`选择器来选择父元素的最后一个段落。
