...
`w3-container`: 这个类用于在元素的左侧和右侧添加 16px 的填充。它可以与所有 HTML5 容器元素一起使用，即 `div`、`文章`、`节`、`页眉`、`页脚`等。这个类中的所有元素共享相同的字体大小、字体颜色、填充、对齐等。
...
`w3-panel`: 这个类在所有边上，即上、右、下、左增加 16px 填充。它也可以用于所有的 HTML5 容器元素，即 `div`、`文章`、`节`、`页眉`、`页脚`等。这个类中的所有元素共享相同的字体大小、字体颜色、填充、对齐等。
