...
> 原文: [https://www.geeksforgeeks.org/fading-text-animation-effect-using-css3/](https://www.geeksforgeeks.org/fading-text-animation-effect-using-css3/)
...
<style>
    * {
    ...
    h2:before {
        ...
        width: 130%;
        height: 100%;
        background: linear-gradient(90deg, transparent 0%, green 5%, green 100%);
