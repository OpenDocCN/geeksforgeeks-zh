...
> 原文: [https://www.geeksforgeeks.org/cssstyledeclaration-csstext-property/](https://www.geeksforgeeks.org/cssstyledeclaration-csstext-property/)
...
<body>
    ...
    <!-- Script to get cssText property -->
    <script>
        function myFunction() {
            var x =
