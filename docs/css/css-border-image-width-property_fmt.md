...
> 原文: [https://www.geeksforgeeks.org/css-border-image-width-property/](https://www.geeksforgeeks.org/css-border-image-width-property/)

`border-image-width` 属性用于设置边框图像的宽度。可以通过提供多个值来设置。
...
支持 `border-image-width` 属性的浏览器如下:
