...
> 原文：[https://www.geeksforgeeks.org/what-are-web-safe-fonts-and-fallback-fonts-in-css/](https://www.geeksforgeeks.org/what-are-web-safe-fonts-and-fallback-fonts-in-css/)
...
**解释：** 将显示 `font-1`，但是由于任何原因，`font-1` 在任何浏览器或操作系统上都不可用，那么在这种情况下将使用 `font-2`。如果 `font-2` 也不可用，那么将使用 `font-3`，以此类推。
