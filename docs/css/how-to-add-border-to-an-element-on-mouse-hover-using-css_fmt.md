...
> 原文: [https://www.geeksforgeeks.org/how-to-add-border-to-an-element-on-mouse-hover-using-css/](https://www.geeksforgeeks.org/how-to-add-border-to-an-element-on-mouse-hover-using-css/) 将边框添加到鼠标悬停元素中
