...
> 原文: [https://www.geeksforgeeks.org/html-dom-querycommandenabled-method/](https://www.geeksforgeeks.org/html-dom-querycommandenabled-method/)
...
**返回值:** 返回一个布尔值，该值指定浏览器是否启用该命令。如果命令启用，则返回`true`，如果命令禁用，则返回`false`。
