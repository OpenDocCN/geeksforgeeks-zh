...
> 原文: [https://www.geeksforgeeks.org/html-dom-button-formenctype-property/](https://www.geeksforgeeks.org/html-dom-button-formenctype-property/)
...
## 示例 1:
这个示例说明了如何返回`Button formEnctype`属性。
...
## 示例 2:
本示例说明如何设置`Button formEnctype`属性。
