...
> 原文: [https://www.geeksforgeeks.org/html-dom-link-disabled-property/](https://www.geeksforgeeks.org/html-dom-link-disabled-property/)

`DOM` 链接禁用属性用于设置或返回链接文档是否禁用。此属性仅用于样式表链接。
