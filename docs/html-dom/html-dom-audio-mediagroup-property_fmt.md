...
> 原文: `https://www.geeksforgeeks.org/html-dom-audio-mediagroup-property/`

**音频媒体组属性**用于**设置**或**返回**音频所属媒体组的名称。两个或更多`<audio>`元素可以使用一个媒体组同步在一起。
