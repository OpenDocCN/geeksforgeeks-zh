...
> 原文：[https://www.geeksforgeeks.org/html-dom-audio-defaultmuted-property/](https://www.geeksforgeeks.org/html-dom-audio-defaultmuted-property/)

`音频默认静音属性`用于设置或返回是否默认静音。
`音频 defaultMuted 属性`不能改变当前静音状态，它只影响默认静音状态。
...
以下列出了 `HTML | DOM Audio defaultMuted Property` 支持的浏览器：
