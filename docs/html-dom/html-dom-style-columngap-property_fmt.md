...
> 原文: [https://www.geeksforgeeks.org/html-dom-style-columngap-property/](https://www.geeksforgeeks.org/html-dom-style-columngap-property/)

## DOM Style columnGap 属性
...
## 3. initial
This sets this property to its default value.
...
## 4. inherit
This inherits this property from its parent element.
