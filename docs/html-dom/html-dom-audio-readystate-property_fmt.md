...
> 原文：[https://www.geeksforgeeks.org/html-dom-audio-readystate-property/](https://www.geeksforgeeks.org/html-dom-audio-readystate-property/)
...
*   **4 = HAVE_ENOUGH_DATA:** 告知有足够的数据可以开始播放。
...
*DOM Audio readyState Property*支持的浏览器如下：
