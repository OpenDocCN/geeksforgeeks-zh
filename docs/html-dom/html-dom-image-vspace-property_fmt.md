...
> 原文: [https://www.geeksforgeeks.org/html-dom-image-vspace-property/](https://www.geeksforgeeks.org/html-dom-image-vspace-property/)

**HTML DOM 图像空间属性**用于设置或返回图像元素的 **vspace** 属性的值。`vspace` 属性用于指定图像底部和顶部的空白数量。
...
**属性值:** 它包含值，即 `pixels`，表示图像底部和顶部的空白区域数量。
