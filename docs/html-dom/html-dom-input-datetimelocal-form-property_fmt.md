...
> 原文：[https://www.geeksforgeeks.org/html-dom-input-datetimelocal-form-property/](https://www.geeksforgeeks.org/html-dom-input-datetimelocal-form-property/)
...
**示例：** 本示例返回包含 `<input type="datetime-local">` 元素的表单的 `id`。
