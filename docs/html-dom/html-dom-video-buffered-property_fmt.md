...
> 原文: [https://www.geeksforgeeks.org/html-dom-video-buffered-property/](https://www.geeksforgeeks.org/html-dom-video-buffered-property/)

**视频缓冲属性**用于返回时间范围对象。用户缓冲的视频范围可以使用时间范围对象来表示。
