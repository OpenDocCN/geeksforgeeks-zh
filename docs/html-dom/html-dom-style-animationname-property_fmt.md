...
> 原文: [https://www.geeksforgeeks.org/html-dom-style-animationname-property/](https://www.geeksforgeeks.org/html-dom-style-animationname-property/)

HTML DOM 中的 `animationName` 属性用于设置或返回 [@keyframes](https://www.geeksforgeeks.org/css-keyframes-rule/) 动画的名称。
