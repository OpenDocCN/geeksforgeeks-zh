...
<body>
    ...
    <script>
        document.getElementById("videoID").addEventListener("suspend", GFGfun);

        function GFGfun() {
            alert("Media loading suspended");
        }
    </script>
