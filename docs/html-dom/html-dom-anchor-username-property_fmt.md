...
> 原文：[https://www.geeksforgeeks.org/html-dom-anchor-username-property/](https://www.geeksforgeeks.org/html-dom-anchor-username-property/)

HTML DOM 中的`锚点用户名属性`用于设置或返回`href属性`的用户名部分的值。用户名部分用于定义用户输入的用户名。它在协议之后和密码部分之前指定。
...
<body> 
    <center> 
        ...
        <p>Welcome to 
            <a href = "https://manaschhabra:manaschhabra499@www.geeksforgeeks.org/" id="GFG"> 
                GeeksforGeeks 
            </a> 
        </p>
