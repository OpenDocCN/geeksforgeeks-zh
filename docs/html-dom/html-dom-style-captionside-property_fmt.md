...
> 原文：[https://www.geeksforgeeks.org/html-dom-style-captionside-property/](https://www.geeksforgeeks.org/html-dom-style-captionside-property/)

DOM Style `captionSide` 属性用于设置或返回表格中标题的位置。
...
This is used to position the caption on the bottom.
...
<html>
<head>
    <title>DOM Style captionSide Property</title>
    <style>
        th,td {
...
<body>
    ...
    <b>DOM Style captionSide Property</b>
    <table>
        <caption id="caption1">List of books</caption>
        <tr>
            <th>Book</th>
            <th>Author</th>
            <th>Price</th>
    ...
    <button onclick="setCaptionSide()" style="margin-top: 10px">Set captionSide</button>
...
This is used to position the caption on the top. This is the default value.
...
<body>
    ...
    <div id="parent">
        <table>
            <caption id="caption1" style="caption-side: top">List of books</caption>
            <tr>
                <th>Book</th>
                <th>Author</th>
                <th>Price</th>
