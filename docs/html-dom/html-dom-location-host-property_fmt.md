...
> 原文: [https://www.geeksforgeeks.org/html-dom-location-host-property/](https://www.geeksforgeeks.org/html-dom-location-host-property/)
...
**主机名:端口:** 它包含一个字符串值，该值定义了一个网址的主机名和端口号。

**返回值:** 一个字符串，代表域名和端口号，或者 URL 的 IP 地址。
