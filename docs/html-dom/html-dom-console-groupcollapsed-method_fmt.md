...
> 原文：[https://www.geeksforgeeks.org/html-dom-console-groupcollapsed-method/](https://www.geeksforgeeks.org/html-dom-console-groupcollapsed-method/)
...
该方法接受单参数 `label`，该标签为可选，用于指定折叠组的标签。
...
### 示例 2：使用带标签参数的 `console.groupCollapsed()` 方法
...
下面列出了 `console.groupCollapsed()` 方法支持的浏览器：
