...
> 原文: [https://www.geeksforgeeks.org/html-dom-storage-length-property/](https://www.geeksforgeeks.org/html-dom-storage-length-property/)
...
## 返回值
返回一个数字，表示存储对象中当前的项目数。

## 示例-1
在 `localStorage` 对象上使用。
