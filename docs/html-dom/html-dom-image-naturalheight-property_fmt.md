# HTML DOM 图像 naturalHeight 属性

> 原文: [https://www.geeksforgeeks.org/html-dom-image-naturalheight-property/](https://www.geeksforgeeks.org/html-dom-image-naturalheight-property/)

## 自然高度

此属性用于获取图像的原始高度。由于要在网页上显示的图像的高度可以使用 `<img>` 标签中的 `height` 属性进行修改，因此 `naturalHeight` 属性在需要图像的原始高度而不是定制高度并且它是只读属性的情况下变得有用。
...
<body>
    <center>
        <img src="https://media.geeksforgeeks.org/wp-content/uploads/20190602171808/629-300x255.png" 
