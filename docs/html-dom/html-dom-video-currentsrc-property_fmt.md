...
> 原文：[https://www.geeksforgeeks.org/html-dom-video-currentsrc-property/](https://www.geeksforgeeks.org/html-dom-video-currentsrc-property/)

`视频流属性`用于返回当前视频的网址。如果未指定视频，`Video`的`currentSrc`属性返回一个空字符串。
