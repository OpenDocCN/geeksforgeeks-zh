...
> 原文：`https://www.geeksforgeeks.org/html-dom-caption-object/`

**DOM Caption 对象**用于表示 HTML `<caption>` 元素（标题元素用于指定表格的标题）。标题元素由 `getElementById()` 访问。

## 属性

*   它有一个 `align` 属性，用于设置或返回标题的对齐方式。
...
可以使用 `document.createElement` 方法创建 caption 对象。
