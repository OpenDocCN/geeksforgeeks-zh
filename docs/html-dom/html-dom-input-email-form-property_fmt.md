...
> 原文：[https://www.geeksforgeeks.org/html-dom-input-email-form-property/](https://www.geeksforgeeks.org/html-dom-input-email-form-property/)
...
它返回一个字符串值，该值指定包含输入电子邮件字段的表单的引用。
