...
> 原文: [https://www.geeksforgeeks.org/html-dom-style-paddingbottom-property/](https://www.geeksforgeeks.org/html-dom-style-paddingbottom-property/)
...
<body>
    ...
    <p>For setting the bottom padding, double click the "Apply Bottom Padding" button: </p>
    <br>
...
以下列出了 *HTML | DOM Style padding bottom Property* 支持的浏览器:
