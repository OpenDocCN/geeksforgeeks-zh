...
> 原文: [https://www.geeksforgeeks.org/html-dom-option-disabled-property/](https://www.geeksforgeeks.org/html-dom-option-disabled-property/)
...
<body>
    ...
    <script>
        function myGeeks() {
            ...
            var x = document.getElementById("GFG").options[2].disabled = true;
        }
    </script>
...
<body>
    ...
    <script>
        function myGeeks() {
            ...
            var x = document.getElementById("GFG").options[2].disabled;
