...
> 原文：[https://www.geeksforgeeks.org/html-dom-output-htmlfor-property/](https://www.geeksforgeeks.org/html-dom-output-htmlfor-property/)

**HTML DOM 输出 htmlFor 属性**用于返回`<output>`元素的 For 属性的值。`htmlFor`属性用于指定结果和计算之间的关系。
...
## 支持的浏览器
属性的 `HTML DOM 输出 htmlFor` 支持的浏览器如下：
