...
> 原文：[https://www.geeksforgeeks.org/html-dom-input-month-defaultvalue-property/](https://www.geeksforgeeks.org/html-dom-input-month-defaultvalue-property/)

HTML DOM 中的 `defaultValue` 属性用于设置或返回月字段的默认值。它是在 `value` 属性中指定的值。
