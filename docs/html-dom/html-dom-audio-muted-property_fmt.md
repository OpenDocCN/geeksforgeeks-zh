...
> 原文: [https://www.geeksforgeeks.org/html-dom-audio-muted-property/](https://www.geeksforgeeks.org/html-dom-audio-muted-property/)
...
## 属性值:
该属性接受值`真|假`，用于指定音频输出是否静音。

## 返回:
如果音频静音，`音频静音属性`返回布尔值`true`，否则返回`false`。

下面的程序说明了 HTML DOM 中的`音频静音属性`:
