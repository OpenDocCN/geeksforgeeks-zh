...
> 原文: [https://www.geeksforgeeks.org/html-dom-style-borderright-property/](https://www.geeksforgeeks.org/html-dom-style-borderright-property/)
...
该属性返回一个字符串，该字符串表示元素右边框的宽度、样式和颜色。
