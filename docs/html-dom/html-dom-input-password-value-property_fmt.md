...
> 原文：[https://www.geeksforgeeks.org/html-dom-input-password-value-property/](https://www.geeksforgeeks.org/html-dom-input-password-value-property/)

**DOM 输入密码值属性**用于设置或返回密码字段的`value`属性的值。`value`属性指定输入电子邮件字段的初始值。该值可以是单个地址或地址列表。
