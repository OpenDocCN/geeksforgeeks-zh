...
> 原文：[https://www.geeksforgeeks.org/html-dom-input-submit-form-property/](https://www.geeksforgeeks.org/html-dom-input-submit-form-property/)
...
返回一个字符串值，指定包含输入提交字段的表单的引用。

## 示例

这个示例说明了如何返回 Input Submit 表单属性。
