# HTML DOM 表格`rules`属性

> 原文：[https://www.geeksforgeeks.org/html-dom-table-rules-property/](https://www.geeksforgeeks.org/html-dom-table-rules-property/)

**HTML DOM Table `rules`**属性用于设置或返回 `<table>` 标记的 `rules` 属性的值。`rules`属性用于定义边框的哪个部分应该可见。
