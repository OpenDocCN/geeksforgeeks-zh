...
> 原文：[https://www.geeksforgeeks.org/html-dom-input-color-defaultvalue-property/](https://www.geeksforgeeks.org/html-dom-input-color-defaultvalue-property/)

HTML DOM 中的 `DOM` 输入颜色默认值属性用于设置或返回颜色选择器的默认值。它是在 `value` 属性中指定的值。
