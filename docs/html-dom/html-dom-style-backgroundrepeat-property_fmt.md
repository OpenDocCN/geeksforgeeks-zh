...
> 原文：[https://www.geeksforgeeks.org/html-dom-style-backgroundrepeat-property/](https://www.geeksforgeeks.org/html-dom-style-backgroundrepeat-property/)
...
由 `DOM Style backgroundRepeat` 属性支持的浏览器如下:
