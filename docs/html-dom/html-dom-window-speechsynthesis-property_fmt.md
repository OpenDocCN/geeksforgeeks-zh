...
> 原文：[https://www.geeksforgeeks.org/html-dom-window-speechsynthesis-property/](https://www.geeksforgeeks.org/html-dom-window-speechsynthesis-property/)
...
这个示例展示了如何使用这个对象获取 `SpeechSynthesis` 对象。
