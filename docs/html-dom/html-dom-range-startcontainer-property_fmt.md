...
> 原文：[https://www.geeksforgeeks.org/html-dom-range-startcontainer-property/](https://www.geeksforgeeks.org/html-dom-range-startcontainer-property/)
...
这个示例将展示如何获取当前范围的 `startContainer` 节点。
