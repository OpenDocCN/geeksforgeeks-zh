...
> 原文：[https://www.geeksforgeeks.org/html-dom-textarea-autocomplete-property/](https://www.geeksforgeeks.org/html-dom-textarea-autocomplete-property/)

HTML DOM 中的 `textarea` 自动完成属性用于设置或返回 `textarea` 字段的自动完成属性的值。自动完成属性用于指定自动完成属性的值是“开”还是“关”。当“自动完成”属性设置为“开”时，浏览器将根据用户之前输入的值自动完成。
...
`HTML DOM textarea` 自动完成属性支持的浏览器如下：
