...
> 原文：[https://www.geeksforgeeks.org/html-dom-queuemicrotask-method/](https://www.geeksforgeeks.org/html-dom-queuemicrotask-method/)
...
*   `function`：当浏览器引擎确定调用您的代码是安全的时要执行的函数。
