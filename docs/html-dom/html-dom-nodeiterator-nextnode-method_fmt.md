...
> 原文：[https://www.geeksforgeeks.org/html-dom-nodeiterator-nextnode-method/](https://www.geeksforgeeks.org/html-dom-nodeiterator-nextnode-method/)
...
在本例中，我们将创建一个节点迭代器，因此将使用 `nextNode()` 方法进行迭代。
