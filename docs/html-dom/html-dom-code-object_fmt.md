...
**DOM 代码对象**用于表示 [HTML `<code>` 元素](https://www.geeksforgeeks.org/html-code-tag/)。代码元素由 `getElementById()` 访问。
...
可以使用 `document.createElement` 方法创建代码对象。
