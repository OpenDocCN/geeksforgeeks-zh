...
> 原文: [https://www.geeksforgeeks.org/html-dom-input-text-value-property/](https://www.geeksforgeeks.org/html-dom-input-text-value-property/)

HTML DOM 中的`输入文本值属性`用于设置或返回输入字段的`value`属性的值。`value`属性指定输入文本字段的初始值。它包含默认值或用户类型。
