...
> 原文: [https://www.geeksforgeeks.org/html-dom-input-url-autofocus-property/](https://www.geeksforgeeks.org/html-dom-input-url-autofocus-property/)

**DOM 输入网址自动聚焦属性**用于**设置**或**返回**页面加载时输入网址字段是否应该聚焦。此属性用于反映 HTML `autofocus` 属性。
