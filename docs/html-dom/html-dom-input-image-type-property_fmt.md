...
> 原文: [https://www.geeksforgeeks.org/html-dom-input-image-type-property/](https://www.geeksforgeeks.org/html-dom-input-image-type-property/)
...
<h2>DOM Input Image Type Property</h2>
    ...
    <script>
        function my_geek() {
            ...
            var txt = document.getElementById("myImage").type;
