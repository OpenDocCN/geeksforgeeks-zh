...
> 原文：[https://www.geeksforgeeks.org/html-dom-image-height-property/](https://www.geeksforgeeks.org/html-dom-image-height-property/)
...
<body>
    <center>
        ...
        <img id="GFG" src="https://media.geeksforgeeks.org/wp-content/uploads/a1-25.png" width="400" height="150" />
        <br>
...
<body>
    ...
    <script>
        function Geeks() {
            var g = document.getElementById("GFG").height = "75";
            document.getElementById("sudo").innerHTML = g + "px";
        }
    </script>
</body>
