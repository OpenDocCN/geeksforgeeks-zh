...
该方法接受单个参数`node`，该参数为必选项，用于指定需要追加的节点对象。
...
本示例描述了 `appendChild()` 方法的使用，该方法将创建文本节点作为节点的最后一个子节点。
...
本示例描述了 `appendChild()` 方法的使用，在单击提交按钮后将文本追加到文档中。
