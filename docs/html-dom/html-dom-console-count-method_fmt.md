...
> 原文：[https://www.geeksforgeeks.org/html-dom-console-count-method/](https://www.geeksforgeeks.org/html-dom-console-count-method/)
...
该方法接受单参数 `label`，该标签为可选，用于统计使用该标签调用 `console.count()` 的次数。
