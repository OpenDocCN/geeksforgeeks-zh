...
> 原文: [https://www.geeksforgeeks.org/html-dom-style-flexbasis-property/](https://www.geeksforgeeks.org/html-dom-style-flexbasis-property/)

DOM Style `flexBasis` 属性用于设置或返回一个灵活项目的初始长度。
