...
> 原文: [https://www.geeksforgeeks.org/html-dom-iframe-contentwindow-property/](https://www.geeksforgeeks.org/html-dom-iframe-contentwindow-property/)

HTML DOM 中的 `IFrame contentWindow` 属性用于返回 IFrame 元素生成的 `Window` 对象。它可以在宿主窗口中用于访问属于框架或 iframe 元素的文档对象。
...
`IFrame contentWindow` 属性支持的浏览器如下:
