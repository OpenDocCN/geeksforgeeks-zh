...
> 原文：[https://www.geeksforgeeks.org/html-dom-window-parent-property/](https://www.geeksforgeeks.org/html-dom-window-parent-property/)

HTML DOM `窗口父项`属性返回当前窗口的父窗口。这是一个`只读`属性。如果一个窗口没有父窗口，那么它就是指它自己。
