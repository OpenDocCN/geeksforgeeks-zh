...
> 原文: [https://www.geeksforgeeks.org/html-dom-button-form-property/](https://www.geeksforgeeks.org/html-dom-button-form-property/)
...
返回对包含按钮的表单元素的引用。如果按钮不在表单中，它将返回空值。
