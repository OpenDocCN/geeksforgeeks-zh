...
> 原文: [https://www.geeksforgeeks.org/html-dom-video-controls-property/](https://www.geeksforgeeks.org/html-dom-video-controls-property/)

`视频控件属性`用于设置或返回视频是否显示标准视频控件。
`<视频>`控件属性通过该属性体现。
...
返回值为布尔值，如果显示视频控件则返回 `true`，否则返回 `false`。
