...
> 原文: [https://www.geeksforgeeks.org/html-dom-input-image-autofocus-property/](https://www.geeksforgeeks.org/html-dom-input-image-autofocus-property/)

`HTML DOM 输入图像自动对焦属性`用于设置或返回页面加载时输入图像字段是否应该对焦。它反映了 HTML `autofocus` 属性。
