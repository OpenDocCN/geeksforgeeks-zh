# HTML DOM 地理位置坐标高度精确属性

> 原文：[https://www.geeksforgeeks.org/html-dom-geolocation-coords-altitudeaccuracy-property/](https://www.geeksforgeeks.org/html-dom-geolocation-coords-altitudeaccuracy-property/)
...
下面的 HTML 代码将返回 `altitudeAccuracy` 属性。
