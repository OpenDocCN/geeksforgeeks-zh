...
> 原文：[https://www.geeksforgeeks.org/html-dom-console-group-method/](https://www.geeksforgeeks.org/html-dom-console-group-method/)
...
**参数：** 该方法接受单参数 `label`，该标签为可选，用于指定组的标签。
