...
> 原文: [https://www.geeksforgeeks.org/html-dom-select-form-property/](https://www.geeksforgeeks.org/html-dom-select-form-property/)
...
对包含下拉列表的表单元素的引用。如果下拉列表不在表单中，则返回 `null`。

下面的程序说明了 HTML DOM 中的 Select form 属性:

## 示例:

本示例使用 Select form 属性返回包含下拉列表的表单的 id。
