...
> 原文：[https://www.geeksforgeeks.org/html-dom-mouseevent-screeny-property/](https://www.geeksforgeeks.org/html-dom-mouseevent-screeny-property/)

**鼠标事件屏幕**属性是只读属性，用于在事件被触发时返回鼠标指针的垂直坐标。
...
返回一个数字，以像素为单位表示鼠标指针的垂直坐标。

下面的程序说明了 `MouseEvent` `screenY` 属性：

## 示例

当鼠标按钮被点击在一个元素上时，找出鼠标指针相对于屏幕的水平坐标。
