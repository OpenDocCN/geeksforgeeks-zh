...
> 原文: [https://www.geeksforgeeks.org/html-dom-video-muted-property/](https://www.geeksforgeeks.org/html-dom-video-muted-property/)
...
如果视频的音频输出为静音，则视频静音属性返回布尔值 `true`，否则返回 `false`。
...
*   最初:
    ![](img/e1a66119600e29992b89b3a6ac522b77.png)
*   启用静音前:
    ![](img/e12450fea590f2650deeef8053337b7a.png)
*   启用静音后:
    ![](img/81bb192764bee24f7e7fdb643bf41666.png)

## 支持的浏览器

以下是 HTML DOM 视频静音属性支持的浏览器:
