...
> 原文：[https://www.geeksforgeeks.org/html-dom-area-coords-property/](https://www.geeksforgeeks.org/html-dom-area-coords-property/)
...
<body>
    ...
    <script>
        function GFG() {
            ...
            var x = document.getElementById("Geeks").coords = "2, 2, 100, 100";
            document.getElementById("GEEK!").innerHTML = "The coords has been changed to " + x;
        }
    </script>
</body>
</html>
