...
> 原文：[https://www.geeksforgeeks.org/html-dom-style-borderimageoutset-property/](https://www.geeksforgeeks.org/html-dom-style-borderimageoutset-property/)
...
<body align="center">
    ...
    <script>
        function myGeeks() {
            document.getElementById("GFG").style.borderImageOutset = "10px";
        }
    </script>
</body>
