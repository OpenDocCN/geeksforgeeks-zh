...
> 原文: [https://www.geeksforgeeks.org/html-dom-style-paddingleft-property-2/](https://www.geeksforgeeks.org/html-dom-style-paddingleft-property-2/)
...
*   设置属性:
    ```html
    object.style.paddingLeft = "auto|length|%|initial|inherit"
    ```
...
<body>
    ...
    <p>For setting the left padding, double click the "Apply Left Padding" button: </p>
    <br>
