...
> 原文：[https://www.geeksforgeeks.org/html-dom-window-crypto-property/](https://www.geeksforgeeks.org/html-dom-window-crypto-property/)

属性返回与全局对象相关的`crypto`对象。这是只读属性。此对象允许网页访问某些加密相关服务。这个加密对象提供了一些访问方法，例如`getRandomValues()`方法。
...
本示例使用`crypto`属性及其`getRandomValues()`方法生成大小为5的随机数组。
