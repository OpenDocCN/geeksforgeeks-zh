...
> 原文：`https://www.geeksforgeeks.org/html-dom-li-object/`

**DOM Li 对象**用于表示 HTML [`<li>`](https://www.geeksforgeeks.org/html-li-tag/) 元素。通过 `getElementById()` 访问 `li` 元素。

## 属性

*   [**值**](https://www.geeksforgeeks.org/html-dom-li-value-property/)：它有一个名为 `value` 的属性，用于返回 `<li>` 标签的值属性的值。
...
`<li>` 可以使用 `document.createElement` 方法创建对象。
