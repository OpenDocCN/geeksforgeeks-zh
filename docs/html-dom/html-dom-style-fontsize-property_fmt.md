...
> 原文：[https://www.geeksforgeeks.org/html-dom-style-fontsize-property/](https://www.geeksforgeeks.org/html-dom-style-fontsize-property/)

`fontSize` 属性用于设置或获取一个单词中字符应该出现的字体大小。
...
| 值 | 描述 |
| :--- | :--- |
| `xx-small` `x-small` `small` `medium` `large` `x-large` `xx-large` | 预定义的字体大小 |
| `smaller` | 减小字体大小的一个相对单位 |
| `larger` | 增加字体大小的一个相对单位 |
| `length` | 以长度单位表示的字体大小 |
| `%` | 父元素字体大小的百分比 |
| `initial` | 设置默认值 |
| `inherit` | 从其父值继承属性 |
...
*   点击按钮前：
    ![](img/eb7bb6d3ba16bed4d9a7b22392662a0f.png)
*   点击按钮后：
    ![](img/bc81d99646117d45080bded132256a64.png)

## 支持的浏览器

以下列出了 *HTML DOM Style fontSize 属性*支持的浏览器：
