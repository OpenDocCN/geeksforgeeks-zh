...
> 原文：[https://www.geeksforgeeks.org/html-dom-input-hidden-value-property/](https://www.geeksforgeeks.org/html-dom-input-hidden-value-property/)
...
**返回值：** 返回一个字符串值，代表隐藏输入字段的 `value` 属性的值。
