...
> 原文: [https://www.geeksforgeeks.org/html-dom-input-reset-disabled-property/](https://www.geeksforgeeks.org/html-dom-input-reset-disabled-property/)
...
返回布尔值，即如果重置按钮字段被禁用，则为真；如果重置字段未被禁用，则为假。
