...
> 原文: [https://www.geeksforgeeks.org/html-dom-input-range-form-property/](https://www.geeksforgeeks.org/html-dom-input-range-form-property/)
...
<script>
        function myGeeks() {
            // Return the form id.
            var x = document.getElementById("Geek_Range").form.id;
