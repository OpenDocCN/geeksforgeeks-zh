...
> 原文: [https://www.geeksforgeeks.org/html-dom-link-hreflang-property/](https://www.geeksforgeeks.org/html-dom-link-hreflang-property/)

**DOM 链接 `hreflang` 属性**用于**设置**或**返回**链接文档 `hreflang` 属性的值。`hreflang` 属性用于指定链接文档的语言。
...
包含指定链接文档语言代码的值，即**语言代码**。

## 返回值

返回一个字符串值，代表链接文档的语言代码。
