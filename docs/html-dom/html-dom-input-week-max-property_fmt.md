...
> 原文: [https://www.geeksforgeeks.org/html-dom-input-week-max-property/](https://www.geeksforgeeks.org/html-dom-input-week-max-property/)

HTML DOM 中的 `DOM 输入周最大值` 属性用于设置或返回周字段的 `max` 属性值。`max` 属性指定周字段的最大值（周和年）。
