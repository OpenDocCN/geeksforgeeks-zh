...
> 原文: [https://www.geeksforgeeks.org/html-dom-input-url-autocomplete-property/](https://www.geeksforgeeks.org/html-dom-input-url-autocomplete-property/)

HTML DOM 中的 `DOM 输入 URL 自动完成属性` 用于设置或返回一个输入 URL 字段的自动完成属性值。自动完成属性用于指定自动完成属性是“开”还是“关”值。当“自动完成”属性设置为“开”时，浏览器将根据用户之前输入的值自动完成。
