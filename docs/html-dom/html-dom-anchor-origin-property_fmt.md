...
> 原文：[https://www.geeksforgeeks.org/html-dom-anchor-origin-property/](https://www.geeksforgeeks.org/html-dom-anchor-origin-property/)
...
<body>
    <center>
        ...
        <script>
            function myGeeks() {
                var x = document.getElementById("GFG").origin;
