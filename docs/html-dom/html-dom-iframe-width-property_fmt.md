...
> 原文: [https://www.geeksforgeeks.org/html-dom-iframe-width-property/](https://www.geeksforgeeks.org/html-dom-iframe-width-property/)
...
返回一个字符串值，以像素为单位表示 Iframe 的宽度。

## 示例 1

本示例说明如何返回 Iframe 宽度属性。
...
<body style="text-align:center;">
    ...
    <iframe src="https://ide.geeksforgeeks.org/index.php" id="GFG" height="200" width="400">
    </iframe>
    <br>
    <br>
...
<body style="text-align:center;">
    ...
    <script>
        function Geeks() {
            var x = document.getElementById("GFG").width = "100%";
            document.getElementById("sudo").innerHTML = x;
        }
    </script>
</body>
...
**HTML DOM IFrame width Property** 支持的浏览器如下:
