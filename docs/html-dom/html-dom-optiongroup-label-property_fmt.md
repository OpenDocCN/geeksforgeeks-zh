...
> 原文：[https://www.geeksforgeeks.org/html-dom-optiongroup-label-property/](https://www.geeksforgeeks.org/html-dom-optiongroup-label-property/)
...
它包含单个值`文本`，该文本指定了光学组元素的描述。

## 示例 1

本示例返回`OptionGroup`标签属性。
