...
> 原文: [https://www.geeksforgeeks.org/html-dom-object-vspace-property/](https://www.geeksforgeeks.org/html-dom-object-vspace-property/)

**HTML DOM Object `vspace` 属性**用于设置或返回 `object` 元素的 `vspace` 属性的值。`vspace` 属性用于指定对象顶部和底部的空白数量。
