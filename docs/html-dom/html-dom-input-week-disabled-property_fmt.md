...
> 原文: [https://www.geeksforgeeks.org/html-dom-input-week-disabled-property/](https://www.geeksforgeeks.org/html-dom-input-week-disabled-property/)
...
返回布尔值，即如果周字段被禁用，则为真；如果周字段未被禁用，则为假。
