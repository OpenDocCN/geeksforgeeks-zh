...
> 原文：`https://www.geeksforgeeks.org/html-dom-table-summary-property/`

**HTML DOM 表格摘要属性**用于设置或返回 `<table>` 元素的 `summary` 属性的值。`summary` 属性用于定义表的摘要。
