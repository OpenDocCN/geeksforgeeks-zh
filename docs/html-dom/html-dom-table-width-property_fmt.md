...
> 原文: [https://www.geeksforgeeks.org/html-dom-table-width-property/](https://www.geeksforgeeks.org/html-dom-table-width-property/)

HTML DOM 中的表格宽度属性用于设置或返回表格宽度属性的值。
...
<body>
    ...
    <script>
        function thead() {
            var x = document.getElementById("gfg").width = "350";

            document.getElementById("sudo").innerHTML = "The width ws set to" + x;
        }
    </script>
</body>
