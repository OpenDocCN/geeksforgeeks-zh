...
> 原文: [https://www.geeksforgeeks.org/html-dom-input-image-height-property/](https://www.geeksforgeeks.org/html-dom-input-image-height-property/)

HTML DOM 中的 `输入图像高度` 用于设置或返回 `height` 属性的值。
