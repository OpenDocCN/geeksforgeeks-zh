...
<body>
    ...
    <script>
        ...
        document.getElementById("divID").addEventListener("webkitTransitionEnd", GFGfun);

        // Standard syntax
        document.getElementById("divID").addEventListener("transitionend", GFGfun);
