...
> 原文：[https://www.geeksforgeeks.org/html-dom-track-srclang-property/](https://www.geeksforgeeks.org/html-dom-track-srclang-property/)

**DOM track srclang 属性**用于**设置**或**返回**`srclang`属性的值，该属性显示文本轨道的语言。

**注意：** 此属性为必填项，`kind="subtitles"`。
...
<body>
    ...
    <p>Click the button to get the language of the track.</p>
    ...
    <script>
        function myFunction() {
            ...
            document.getElementById("gfg").innerHTML = x.srclang;
        }
    </script>
</body>
