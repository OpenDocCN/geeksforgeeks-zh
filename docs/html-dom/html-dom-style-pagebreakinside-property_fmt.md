...
> 原文：[https://www.geeksforgeeks.org/html-dom-style-pagebreakinside-property/](https://www.geeksforgeeks.org/html-dom-style-pagebreakinside-property/)

`Style pageBreakInside` 属性用于在打印或打印预览中设置或返回元素内部的分页行为。
`Style pageBreakInside` 属性不影响绝对定位的元素。
...
下面的程序说明了 `Style pageBreakInside` 属性：
...
以下是 *HTML DOM Style pageBreakInside Property* 支持的浏览器：
