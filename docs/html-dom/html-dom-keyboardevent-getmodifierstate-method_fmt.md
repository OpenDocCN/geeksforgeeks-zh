...
> 原文：[https://www.geeksforgeeks.org/html-dom-keyboardevent-getmodifierstate-method/](https://www.geeksforgeeks.org/html-dom-keyboardevent-getmodifierstate-method/)
...
下面列出了 `KeyboardEvent.getModifierState()` 方法支持的浏览器：
