...
> 原文：`https://www.geeksforgeeks.org/html-dom-form-novalidate-property/`
...
## 示例：返回表单 NoValidate 属性

此示例说明如何返回表单 NoValidate 属性。
...
<body style="text-align:center;">
    ...
    <!-- Script to return form formnovalidate Property -->
    <script>
        function myGeeks() {
...
## 示例：设置表单 NoValidate 属性

此示例说明如何设置表单 NoValidateproperty。
...
**DOM Form noValidate Property**支持的浏览器如下:
