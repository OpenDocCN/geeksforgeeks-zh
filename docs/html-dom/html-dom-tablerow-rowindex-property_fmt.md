...
> 原文: [https://www.geeksforgeeks.org/html-dom-tablerow-rowindex-property/](https://www.geeksforgeeks.org/html-dom-tablerow-rowindex-property/)

HTML DOM 中的 `TableRow rowIndex` 属性用于返回行集合中的行的位置和索引。
...
## 支持的浏览器
下面列出了 `HTML DOM tableRow rowIndex` 属性支持的浏览器:
*   谷歌 Chrome
*   微软公司出品的 web 浏览器
*   火狐浏览器
*   旅行队
