...
> 原文：[https://www.geeksforgeeks.org/html-dom-range-setstartbefore-method/](https://www.geeksforgeeks.org/html-dom-range-setstartbefore-method/)
...
本示例介绍如何设置范围的起点。同样在这个例子中，我们使用了 `setEndAfter()` 方法来设置范围的结束。开始参考节点是文档的第一个 `<i>` 元素。
...
<body>
    ...
    The range will start from 1st element in italics <i> RangeStart</i> and end at 2nd italics element <i>RangeEnd</i>
