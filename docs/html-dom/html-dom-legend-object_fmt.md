...
**DOM 图例对象**用于表示 HTML [`<legend>`](https://www.geeksforgeeks.org/html-legend-tag/) 元素。*图例*元素由 `getElementById()` 访问。
...
可以使用`document.createElement`方法创建图例对象。
