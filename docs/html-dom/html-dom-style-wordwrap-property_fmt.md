...
> 原文：[https://www.geeksforgeeks.org/html-dom-style-wordwrap-property/](https://www.geeksforgeeks.org/html-dom-style-wordwrap-property/)

HTML DOM 中的 `Style wordWrap` 属性用于设置或返回是否要断长词绕到下一行。
...
### normal
This is used to break long words only at the break points.
...
### break-word
This is used to allow unbreakable words to be broken to the next line.
...
### inherit
This is used to inherit the value from the parent of the element.
