...
> 原文: [https://www.geeksforgeeks.org/html-dom-heading-align-property/](https://www.geeksforgeeks.org/html-dom-heading-align-property/)

`HTML DOM` `标题` `对齐`属性用于设置或返回`<h1>`到`<h6>`元素的水平对齐。
...
下面的 HTML 代码返回并设置`标题`为`align`属性。
