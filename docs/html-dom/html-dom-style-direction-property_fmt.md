...
> 原文: [https://www.geeksforgeeks.org/html-dom-style-direction-property/](https://www.geeksforgeeks.org/html-dom-style-direction-property/)

HTML DOM 中的 `style.direction` 属性用于设置或返回元素的文本方向。
...
<body>
    ...
    <script>
        function myGeeks() {
            document.getElementById("para").style.direction = "rtl";
        }
    </script>
</body>
