# HTML DOM Textarea autofocus 属性

> 原文：[https://www.geeksforgeeks.org/html-dom-textarea-autofocus-property/](https://www.geeksforgeeks.org/html-dom-textarea-autofocus-property/)

**DOM Textarea autofocus 属性**用于设置或返回页面加载时元素是否应该获得焦点。该属性用于反映 HTML `autofocus` 属性。
...
DOM Textarea autofocus 属性支持的浏览器如下:
