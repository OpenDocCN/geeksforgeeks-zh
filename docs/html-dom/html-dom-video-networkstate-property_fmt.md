...
> 原文：[https://www.geeksforgeeks.org/html-dom-video-networkstate-property/](https://www.geeksforgeeks.org/html-dom-video-networkstate-property/)
...
<script>
        function set() {
            var v = document.getElementById("Test_Video").networkState;
