...
> 原文：[https://www.geeksforgeeks.org/html-dom-input-email-required-property/](https://www.geeksforgeeks.org/html-dom-input-email-required-property/)
...
返回一个布尔值，代表提交表单前是否必须填写电子邮件字段。

## 示例 1

本示例说明如何返回 Input Email 必需属性。
