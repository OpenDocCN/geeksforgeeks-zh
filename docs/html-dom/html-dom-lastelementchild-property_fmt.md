...
> 原文：[https://www.geeksforgeeks.org/html-dom-lastelementchild-property/](https://www.geeksforgeeks.org/html-dom-lastelementchild-property/)
...
返回一个代表元素最后一个子元素的对象。如果没有子元素，则返回 `null`。
...
DOM `lastElementChild` 属性支持的浏览器如下：
