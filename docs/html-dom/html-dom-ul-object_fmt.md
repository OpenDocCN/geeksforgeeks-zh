...
*   [**compact:**](https://www.geeksforgeeks.org/html-dom-ul-compact-property/) 用于设置或返回无序列表的高度是否会渲染得比正常情况下小。
*   [**type:**](https://www.geeksforgeeks.org/html-dom-ul-type-property/) 用于设置或返回 `<ul>` 元素的 `type` 属性的值。
