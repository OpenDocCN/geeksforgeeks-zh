...
> 原文：[https://www.geeksforgeeks.org/html-dom-image-align-property/](https://www.geeksforgeeks.org/html-dom-image-align-property/)

**HTML DOM 图像对齐属性**用于设置或返回图像元素的 [`align`](https://www.geeksforgeeks.org/html-align-attribute/) 属性的值。
