# HTML DOM Input Month stepDown()方法

> 原文：[https://www.geeksforgeeks.org/html-dom-input-month-stepdown-method/](https://www.geeksforgeeks.org/html-dom-input-month-stepdown-method/)

HTML DOM 中的 `stepDown()` 方法用于将月输入字段的值减少给定的数字。这种方法只会减少月数而不是年数。
