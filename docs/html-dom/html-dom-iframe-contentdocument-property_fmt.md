...
> 原文：[https://www.geeksforgeeks.org/html-dom-iframe-contentdocument-property/](https://www.geeksforgeeks.org/html-dom-iframe-contentdocument-property/)

HTML DOM 中的 `IFrame contentDocument` 属性用于返回框架或 IFrame 元素生成的文档对象。它可以在宿主窗口中用于访问属于框架或 iframe 元素的文档对象。
...
HTML DOM IFrame contentDocument 属性支持的浏览器如下：
