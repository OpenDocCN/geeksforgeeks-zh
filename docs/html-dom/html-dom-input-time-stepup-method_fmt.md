...
> 原文：[https://www.geeksforgeeks.org/html-dom-input-time-stepup-method/](https://www.geeksforgeeks.org/html-dom-input-time-stepup-method/)

`DOM 输入时间步长()方法`用于将时间字段的值增加给定的数字。它只会影响分钟数（而不是小时、秒或毫秒）。
