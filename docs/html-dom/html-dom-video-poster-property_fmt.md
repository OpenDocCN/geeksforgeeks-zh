...
> 原文: [https://www.geeksforgeeks.org/html-dom-video-poster-property/](https://www.geeksforgeeks.org/html-dom-video-poster-property/)

视频海报属性用于设置或返回视频海报属性的值。海报属性专门用于在下载视频时或用户点击播放按钮之前显示图像。如果不包括海报选项，则显示视频的第一帧。
