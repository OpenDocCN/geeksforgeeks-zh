...
> 原文：[https://www.geeksforgeeks.org/html-dom-fullscreenenabled-method/](https://www.geeksforgeeks.org/html-dom-fullscreenenabled-method/)
...
## 支持的浏览器：
下面列出了 `fullscreenEnabled()` 方法支持的浏览器：
*   谷歌 Chrome 45.0 -webkit-
*   火狐 47.0 -moz-
