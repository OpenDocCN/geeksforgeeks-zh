...
> 原文: [https://www.geeksforgeeks.org/html-dom-dialog-open-property/](https://www.geeksforgeeks.org/html-dom-dialog-open-property/)

DOM 对话框打开属性用于设置或返回对话框是否应该打开。它在 HTML5 中是新的，如果打开，意味着用户可以与之交互。
...
它接受两个值，即 `true|false`，指定对话框窗口是否应该打开。默认情况下，它是假的。
