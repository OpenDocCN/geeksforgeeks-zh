...
> 原文: [https://www.geeksforgeeks.org/html-dom-iframe-align-property/](https://www.geeksforgeeks.org/html-dom-iframe-align-property/)
...
它返回一个表示 Iframe 元素对齐方式的字符串值。

## 示例 1:

下面的示例说明了如何返回 Iframe `align` 属性。
