...
> 原文: [https://www.geeksforgeeks.org/html-dom-style-zindex-property/](https://www.geeksforgeeks.org/html-dom-style-zindex-property/)

`Style zIndex` 属性用于设置或返回定位元素的堆栈顺序。具有较低堆叠顺序的元素将落后于具有较高堆叠顺序的另一个元素。
...
<body>
    <center>
        ...
        <img id="MyImage" src="https://media.geeksforgeeks.org/wp-content/uploads/gfg_200X200-1.png"
        ...
        <br>
        <p>To bring the logo in the front, double-click the "Bring Logo In The Front" button.</p>
...
以下列出了 `HTML DOM Style zIndex Property` 支持的浏览器:
