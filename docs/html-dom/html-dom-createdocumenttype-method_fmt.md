...
> 原文: [https://www.geeksforgeeks.org/html-dom-createdocumenttype-method/](https://www.geeksforgeeks.org/html-dom-createdocumenttype-method/)

`createDocumentType()`方法返回一个文档类型对象，该对象可以与`createDocument()`方法一起使用，也可以放入文档中。
