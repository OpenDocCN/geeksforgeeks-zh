...
> 原文：[https://www.geeksforgeeks.org/html-dom-input-week-stepup-method/](https://www.geeksforgeeks.org/html-dom-input-week-stepup-method/)
...
## 参数
接受单参数`number`，为必输项。它指定要增加的周数。默认情况下，周数增加 1。

## 返回值
不返回值。

## 示例
本示例使用 Input Week stepUp()方法将周增加 2。
