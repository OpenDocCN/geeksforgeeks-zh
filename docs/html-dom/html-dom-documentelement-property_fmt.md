# DOM documentElement 属性

> 原文：[https://www.geeksforgeeks.org/html-dom-documentelement-property/](https://www.geeksforgeeks.org/html-dom-documentelement-property/)
...
`DOM documentElement` 属性支持的浏览器如下：
