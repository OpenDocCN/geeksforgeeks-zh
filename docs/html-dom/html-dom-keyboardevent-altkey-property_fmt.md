...
> 原文：[https://www.geeksforgeeks.org/html-dom-keyboardevent-altkey-property/](https://www.geeksforgeeks.org/html-dom-keyboardevent-altkey-property/)
...
下面列出了 `KeyboardEvent altKey` 属性支持的浏览器：
