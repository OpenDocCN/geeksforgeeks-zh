...
> 原文：[https://www.geeksforgeeks.org/html-dom-location-reload-method/](https://www.geeksforgeeks.org/html-dom-location-reload-method/)

HTML DOM 中的 `location.reload()` 方法用于重载当前文档。此方法刷新当前文档。它类似于浏览器中的刷新按钮。
...
**支持的浏览器：** `DOM Location reload()` 方法支持的浏览器如下：
