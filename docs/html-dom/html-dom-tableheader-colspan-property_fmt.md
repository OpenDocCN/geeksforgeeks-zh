...
> 原文: [https://www.geeksforgeeks.org/html-dom-tableheader-colspan-property/](https://www.geeksforgeeks.org/html-dom-tableheader-colspan-property/)

`HTML DOM TableHeader` 的 `colSpan` 属性用于设置或返回 `colSpan` 属性的值。`colspan` 属性定义了标题单元格应该跨越的列数。
