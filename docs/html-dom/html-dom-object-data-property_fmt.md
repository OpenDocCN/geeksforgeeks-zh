...
> 原文：[https://www.geeksforgeeks.org/html-dom-object-data-property/](https://www.geeksforgeeks.org/html-dom-object-data-property/)

**HTML | DOM 对象数据属性**用于**设置**或**返回** `<object>` 元素的数据属性值。**数据属性**用于指定对象将要使用的资源的网址。
