...
<body>
    ...
    <map name="Geeks1">
        <area id="Geeks"
              ...
              coords="0, 0, 110, 100"
              alt="Geeks"
              href="https://manaschhabra:manaschhabra499@www.geeksforgeeks.org#abc/"
              target="_self">
    </map>
