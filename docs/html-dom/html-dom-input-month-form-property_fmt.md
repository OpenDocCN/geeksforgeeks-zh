...
> 原文: [https://www.geeksforgeeks.org/html-dom-input-month-form-property/](https://www.geeksforgeeks.org/html-dom-input-month-form-property/)
...
成功时返回一个表单对象，否则如果月字段不在表单中，则返回 `NULL`。
