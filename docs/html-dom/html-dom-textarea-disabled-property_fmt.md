...
> 原文：[https://www.geeksforgeeks.org/html-dom-textarea-disabled-property/](https://www.geeksforgeeks.org/html-dom-textarea-disabled-property/)

**DOM Textarea 禁用属性**用于**设置**或**返回** Textarea 元素是**禁用**还是**不禁用**。禁用的文本区域不可点击且不可用。它是一个布尔属性，用于反映 HTML `disabled` 属性。
...
<body style="text-align:center">
    ...
    <script>
        function myGeeks() {
            ...
            document.getElementById("GFG").disabled = false;
        }
    </script>
</body>
