# HTML DOM 按钮 formNoValidate 属性

> 原文：[https://www.geeksforgeeks.org/html-dom-button-formnovalidate-property/](https://www.geeksforgeeks.org/html-dom-button-formnovalidate-property/)

HTML DOM 中的按钮 `formNoValidate` 属性用于在提交表单时设置或返回表单数据是否需要验证。此属性用于反映 HTML `formnovalidate` 属性。
...
## 返回值
如果不应该验证表单数据，则返回布尔值 `true`，否则返回 `false`。

## 示例 1
此示例说明了 HTML DOM Button `formNoValidate` 属性。
...
## 示例 2
本示例说明如何设置 Button `formNoValidate` 属性。
