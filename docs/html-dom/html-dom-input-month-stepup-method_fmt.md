# HTML DOM Input Month stepUp()方法

> 原文：[https://www.geeksforgeeks.org/html-dom-input-month-stepup-method/](https://www.geeksforgeeks.org/html-dom-input-month-stepup-method/)

HTML DOM 中的 `stepUp()` 方法用于将月输入字段的值增加给定的数字。这种方法只会增加月的值，而不会增加年的值。
