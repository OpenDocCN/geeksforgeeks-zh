...
> 原文: [https://www.geeksforgeeks.org/html-dom-table-header-align-property/](https://www.geeksforgeeks.org/html-dom-table-header-align-property/)
...
返回一个字符串值，代表 `<th>` 元素的水平对齐。

## 示例 1

下面的代码说明了如何返回 `TableHeader.align` 属性。
...
下面的代码说明了如何设置 `TableHeader.align` 属性。
