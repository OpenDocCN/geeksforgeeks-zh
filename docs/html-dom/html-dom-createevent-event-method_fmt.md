...
> 原文: [https://www.geeksforgeeks.org/html-dom-createevent-event-method/](https://www.geeksforgeeks.org/html-dom-createevent-event-method/)

HTML 中的 `createEvent()` 方法创建一个指定类型的事件对象。创建的事件必须在使用前初始化。
