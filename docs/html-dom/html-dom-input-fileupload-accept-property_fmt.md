...
> 原文: [https://www.geeksforgeeks.org/html-dom-input-fileupload-accept-property/](https://www.geeksforgeeks.org/html-dom-input-fileupload-accept-property/)

HTML DOM 中的 `DOM输入文件上传接受属性` 用于设置或返回文件上传按钮的 `accept` 属性值。`accept` 属性指定服务器可接受的文件类型。
