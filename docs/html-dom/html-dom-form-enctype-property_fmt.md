...
> 原文：[https://www.geeksforgeeks.org/html-dom-form-enctype-property/](https://www.geeksforgeeks.org/html-dom-form-enctype-property/)
...
本示例使用 `getElementById()` 方法返回 `enctype` 属性。
