...
> 原文: [https://www.geeksforgeeks.org/html-dom-window-customelements-property/](https://www.geeksforgeeks.org/html-dom-window-customelements-property/)
...
在本例中，我们将获得关于自定义元素的信息，并将使用 `define()` 方法创建 `自定义元素`。
