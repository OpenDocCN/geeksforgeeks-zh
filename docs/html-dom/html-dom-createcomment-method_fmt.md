...
> 原文: [https://www.geeksforgeeks.org/html-dom-createcomment-method/](https://www.geeksforgeeks.org/html-dom-createcomment-method/)
...
DOM `createComment()` 方法属性支持的浏览器如下:
