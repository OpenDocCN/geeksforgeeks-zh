...
> 原文：[https://www.geeksforgeeks.org/html-dom-range-selectnodecontents-method/](https://www.geeksforgeeks.org/html-dom-range-selectnodecontents-method/)
...
DOM `selectNodeContents()`方法支持的浏览器如下：
