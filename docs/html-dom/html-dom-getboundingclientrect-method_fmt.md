...
> 原文: [https://www.geeksforgeeks.org/html-dom-getboundingclientrect-method/](https://www.geeksforgeeks.org/html-dom-getboundingclientrect-method/)

`HTML DOM getBoundingClientRect()`方法返回相对视口的定位。
