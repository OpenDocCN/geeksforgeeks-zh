...
> 原文: [https://www.geeksforgeeks.org/html-dom-style-wordbreak-property/](https://www.geeksforgeeks.org/html-dom-style-wordbreak-property/)

**DOM Style** `wordBreak` 属性用于设置或返回断字属性。断字属性用于指定当单词到达行尾时如何断字。文本中的换行符可以出现在某个断字属性中。
...
DOM Style `wordBreak` 属性支持的浏览器如下:
