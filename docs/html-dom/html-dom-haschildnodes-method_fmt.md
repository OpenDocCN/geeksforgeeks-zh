...
> 原文：[https://www.geeksforgeeks.org/html-dom-haschildnodes-method/](https://www.geeksforgeeks.org/html-dom-haschildnodes-method/)
...
在下面的段落中，`<p>` 标签没有任何内容，因此它返回 `false`。
...
<head>
        <script>
            ...
            function exampleFunction() {
                ...
                document.getElementById("GeeksForGeeks").innerHTML = res;
            }
        </script>
    </head>
