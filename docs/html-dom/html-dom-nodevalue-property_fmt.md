...
HTML DOM `nodeValue` 属性用于描述给定节点的属性。它用于设置或获取任何 Html 文档中的节点值。先决条件 [DOM(文档对象模型)](https://www.geeksforgeeks.org/dom-document-object-model/)
...
## 示例:
以下示例创建一个名为**【迪维】**的段落标记，并提供一个按钮，该按钮生成段落标记属性，并将其值返回给 Id 为“极客 ForGeeks”的标记。
