...
> 原文：[https://www.geeksforgeeks.org/html-dom-input-submit-value-property/](https://www.geeksforgeeks.org/html-dom-input-submit-value-property/)

HTML DOM 中的 **DOM 输入提交值属性**用于设置或返回输入提交字段的 `value` 属性的值。`value` 属性指定提交字段中显示的文本。
