...
> 原文: [https://www.geeksforgeeks.org/html-dom-geolocation-coords-speed-property/](https://www.geeksforgeeks.org/html-dom-geolocation-coords-speed-property/)

在本文中，我们将讨论地理定位速度属性。HTML 中的地理定位用来获取用户的地理位置。

`coords.speed` 属性用于返回该位置的速度，单位为米/秒(mps)。
