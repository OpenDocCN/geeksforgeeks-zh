...
> 原文: [https://www.geeksforgeeks.org/html-dom-input-datetimelocal-autocomplete-property/](https://www.geeksforgeeks.org/html-dom-input-datetimelocal-autocomplete-property/)

**输入日期时间本地自动完成属性**用于设置或返回输入日期时间本地字段的自动完成属性的值。自动完成属性用于指定自动完成属性的值是“开”还是“关”。当`autocomplete`属性设置为“开”时，浏览器将根据用户之前输入的值自动完成。
...
此示例说明如何返回 Input DatetimeLocal 自动完成属性。
...
本示例说明如何设置 Input DatetimeLocal 自动完成属性。
...
以下列出了 **HTML DOM Input DatetimeLocal 自动完成属性**支持的浏览器:
