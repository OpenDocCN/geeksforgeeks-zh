...
> 原文：[`https://www.geeksforgeeks.org/html-dom-range-collapse-method/`](https://www.geeksforgeeks.org/html-dom-range-collapse-method/)
...
**示例：** 此示例显示了如何使用此方法折叠范围。`collapsed`属性用于检查范围是否折叠。
