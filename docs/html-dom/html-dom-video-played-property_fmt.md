...
> 原文: [https://www.geeksforgeeks.org/html-dom-video-played-property/](https://www.geeksforgeeks.org/html-dom-video-played-property/)

**视频播放属性**用于*返回一个时间范围对象*。时间范围对象用于表示用户已经播放的视频范围。播放范围是播放视频的时间范围。如果用户跳过视频，他可能会获得几个播放范围。视频播放属性为只读属性。
...
*   点击按钮前:
    ![](img/2f78e14a75d789f482a19cd663a38cf2.png)
*   点击按钮后:
    ![](img/6ebc8fe9a60ef7788a8302d6a8bc9150.png)

## 支持的浏览器

`HTML | DOM 视频播放属性`支持的浏览器如下:
