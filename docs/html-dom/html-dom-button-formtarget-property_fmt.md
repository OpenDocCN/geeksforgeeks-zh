...
> 原文: [https://www.geeksforgeeks.org/html-dom-button-formtarget-property/](https://www.geeksforgeeks.org/html-dom-button-formtarget-property/)
...
返回一个字符串值，代表必须提交响应的地方。

## 示例

这个示例描述了如何设置和获取 `formTarget` 属性的值。
