...
> 原文：[https://www.geeksforgeeks.org/html-dom-anchor-password-property/](https://www.geeksforgeeks.org/html-dom-anchor-password-property/)

HTML DOM 中的**锚点密码属性**用于设置或返回 `href` 属性值的密码部分。密码部分由用户在网址中输入，并在用户名和主机名之后指定。
