...
> 原文: [https://www.geeksforgeeks.org/html-dom-style-columncount-property/](https://www.geeksforgeeks.org/html-dom-style-columncount-property/)
    ...
    <body>
        ...
        <script>
            function mainFunction() {
                // Set columnCount.
                document.getElementById("mainDIV").style.columnCount = "4";
            }
        </script>
    </body>
    </html>
...
2.  **自动:** 是默认值，取决于像列宽这样的属性。
    ...
    <body>
        ...
        <script>
            function mainFunction() {
                document.getElementById("mainDIV").style.columnWidth = "100px";
                // Set columnCount.
                document.getElementById("mainDIV").style.columnCount = "auto";
            }
        </script>
    </body>
    </html>
...
<body>
    ...
    <script>
        function mainFunction() {
            // Set columnCount.
            document.getElementById("mainDIV").style.columnCount = "initial";
        }
    </script>
</body>
</html>
...
<body>
    ...
    <script>
        function mainFunction() {
            // Set columnCount.
            document.getElementById("p1").style.columnCount = "inherit";
        }
    </script>
</body>
</html>
