...
> 原文: [https://www.geeksforgeeks.org/html-dom-legend-align-property/](https://www.geeksforgeeks.org/html-dom-legend-align-property/)

HTML DOM 中的**图例对齐属性**用于设置或返回 `<legend>` 元素的对齐属性值。
...
<body>
    ...
    <script>
        function myGeeks() {
            // Accessing legend tag
            var g = document.getElementById("GFG").align = "right";
...
以下列出 *HTML DOM Legend align Property* 支持的浏览器:
