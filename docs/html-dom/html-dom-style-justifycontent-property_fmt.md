...
> 原文: [https://www.geeksforgeeks.org/html-dom-style-justifycontent-property/](https://www.geeksforgeeks.org/html-dom-style-justifycontent-property/)
...
*   `flex-end`: 用于对齐容器末端的伸缩项。
*   `center`: 它在容器中心对齐弯曲项目。
*   `space-between`: 弹性项目以均匀的间距放置，项目被推到开始，最后一个项目被推到结束。
*   `space-around`: 弯曲的物品以相等的间距放置，即角落。
*   `space-evenly`: 物品之间的间距相等，但与角的间距不同。
*   `initial`: 物品按照默认值摆放。
*   `inherit`: 项目根据其继承的父元素值放置。

## 返回值

返回一个字符串，代表元素的 `justifyContent` 属性。
...
<body> 
    <center> 
        ...
        <div id = "GFG">
            <div>
                <img src ="https://media.geeksforgeeks.org/wp-content/uploads/g1-15.png" width = "60px" height = "80px">
            </div>

            <div>
                <img src ="https://media.geeksforgeeks.org/wp-content/uploads/g2-14.png" width = "60px" height = "80px">
            </div>
            ...
            <div>
                <img src ="https://media.geeksforgeeks.org/wp-content/uploads/g3-10.png" width = "60px" height = "80px">
            </div>
        </div>
...
以下列出了 *DOM Style justifyContent 属性*支持的浏览器:
