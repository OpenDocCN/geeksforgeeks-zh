...
> 原文: [https://www.geeksforgeeks.org/html-dom-option-index-property/](https://www.geeksforgeeks.org/html-dom-option-index-property/)

`DOM` 选项索引属性用于设置或返回下拉列表中选项值的索引位置。索引从零开始。
