...
> 原文: [https://www.geeksforgeks.org/html-dom-offsetwidth-property/](https://www.geeksforgeks.org/html-dom-offsetwidth-property/)

`DOM offsetWidth` 属性用于以整数形式返回元素的布局宽度。它以像素为单位。它包括宽度、边框、填充和垂直滚动条，但不包括边距。如果元素被隐藏，那么它返回 0。
...
**支持的浏览器:** `DOM offsetWidth` 属性支持的浏览器如下:
