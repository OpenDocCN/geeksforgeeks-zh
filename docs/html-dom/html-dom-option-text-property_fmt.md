...
> 原文: [https://www.geeksforgeeks.org/html-dom-option-text-property/](https://www.geeksforgeeks.org/html-dom-option-text-property/)

HTML DOM 中的**选项文本属性**用于设置或返回 `<option>` 元素的文本。用户提交表单时发送到服务器的文本值。
...
它包含单个值 `text`，该文本定义了 `<option>` 元素的文本内容。
...
<body style="text-align: center;">
    ...
    <script>
        function myGeeks() {
            var x = document.getElementById("GFG").text = "Heap Sort";
        }
    </script>
</body>
</html>
...
<body style="text-align: center;">
    ...
    <script>
        function myGeeks(selTag) {
            ...
            document.getElementById("sudo").innerHTML = "The Selected Option is : " + x;
        }
    </script>
</body>
</html>
