...
> 原文：[https://www.geeksforgeeks.org/html-dom-touchevent-touches-property/](https://www.geeksforgeeks.org/html-dom-touchevent-touches-property/)
...
支持的浏览器 `DOM touch event touch Property` 如下：
