...
> 原文：[https://www.geeksforgeeks.org/html-dom-details-open-property/](https://www.geeksforgeeks.org/html-dom-details-open-property/)

HTML DOM 中的 `Details open` 属性用于设置或返回隐藏信息对用户是否可见。此属性用于反映 HTML `open` 属性。
