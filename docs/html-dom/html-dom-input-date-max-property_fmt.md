...
> 原文: [https://www.geeksforgeeks.org/html-dom-input-date-max-property/](https://www.geeksforgeeks.org/html-dom-input-date-max-property/)
...
<body>
    ...
    <h1>GeeksforGeeks</h1>
    <h2>Input Date max Property</h2>
    <input type="date" id="Test_Date" min="2019-02-18" max="2019-02-20"><br>
