...
> 原文：[https://www.geeksforgeeks.org/html-dom-console-groupend-method/](https://www.geeksforgeeks.org/html-dom-console-groupend-method/)
...
下面列出了 `console.groupEnd()` 方法支持的浏览器：
