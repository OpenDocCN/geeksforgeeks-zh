...
**DOM 图形对象**用于表示 HTML [`<figure>`](https://www.geeksforgeeks.org/html5-figure-tag/) 元素。图形元素由 `getElementById()` 访问。
...
<body>
    ...
    <script>
        function Geeks() {
            ...
            var g = document.getElementById("GFG").id;
...
可以使用`document.createElement()`方法创建图形对象。
...
<body>
    ...
    <script>
        function Geeks() {
            ...
            f.setAttribute("src", "https://media.geeksforgeeks.org/wp-content/uploads/geeks-25.png");
