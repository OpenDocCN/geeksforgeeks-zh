...
> 原文: [https://www.geeksforgeeks.org/html-dom-style-borderstyle-property/](https://www.geeksforgeeks.org/html-dom-style-borderstyle-property/)

DOM Style `borderStyle` 属性用于设置或返回元素的边框样式。
