...
> 原文: [https://www.geeksforgeeks.org/html-dom-output-type-property/](https://www.geeksforgeeks.org/html-dom-output-type-property/)
...
<body>
    ...
    <form oninput="sumresult.value = parseInt(A.value) + parseInt(B.value) + parseInt(C.value)">
