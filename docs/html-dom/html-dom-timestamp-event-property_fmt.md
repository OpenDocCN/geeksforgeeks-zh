...
> 原文: [https://www.geeksforgeeks.org/html-dom-timestamp-event-property/](https://www.geeksforgeeks.org/html-dom-timestamp-event-property/)
...
此事件返回自 1970 年 1 月 1 日起，事件触发时的毫秒数。
