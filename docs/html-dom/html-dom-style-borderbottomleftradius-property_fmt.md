...
<script>
    function myGeeks() {
        document.getElementById("main").style.borderBottomLeftRadius = "35px";
    }
</script>
</body>
</html>
...
<script>
    function myGeeks() {
        document.getElementById("main").style.borderBottomLeftRadius = "35px";
        var x = document.getElementById("main").style.borderBottomLeftRadius;
        document.getElementById("val").innerHTML = "Border Radius: " + x;
    }
</script>
</body>
</html>
...
## 支持的浏览器:
`borderBottomLeftRadius` 属性支持的浏览器如下:
