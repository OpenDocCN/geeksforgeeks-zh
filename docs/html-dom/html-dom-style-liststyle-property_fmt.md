...
> 原文: [https://www.geeksforgeeks.org/html-dom-style-liststyle-property/](https://www.geeksforgeeks.org/html-dom-style-liststyle-property/)
...
*DOM Style listStyle 属性*支持的浏览器如下:
