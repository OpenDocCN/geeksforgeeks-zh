...
> 原文: [https://www.geeksforgeeks.org/html-dom-anchor-href-property/](https://www.geeksforgeeks.org/html-dom-anchor-href-property/)
...
<body>
    <center>
        ...
        <script>
            function myGeeks() {
                var x = document.getElementById("GFG").href = "https://ide.geeksforgeeks.org/tryit.php";
                document.getElementById("sudo").innerHTML = x;
            }
        </script>
    </center>
