...
> 原文：[https://www.geeksforgeeks.org/html-dom-video-defaultmuted-property/](https://www.geeksforgeeks.org/html-dom-video-defaultmuted-property/)

`视频默认静音属性`用于**设置**或**返回**视频是否默认静音。
`Video defaultMuted` 属性不能改变当前静音状态，它只影响默认静音状态。
...
*   点击按钮前：
    ![](img/23770568c1947cb6e3065313bc554525.png)
*   点击按钮后：
    ![](img/53b8d585efcf77e8586428d62f325537.png)

## 支持的浏览器

以下是 `HTML | DOM 视频默认静音属性` 支持的浏览器：
