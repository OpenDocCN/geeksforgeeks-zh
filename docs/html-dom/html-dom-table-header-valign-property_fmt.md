...
> 原文: [https://www.geeksforgeeks.org/html-dom-table-header-valign-property/](https://www.geeksforgeeks.org/html-dom-table-header-valign-property/)

`HTML DOM TableHeader` `vAlign` 属性用于设置或返回 `<th>` 元素的 `vAlign` 属性的值。`vAlign` 属性用于指定表格标题内文本内容的垂直对齐方式。
