...
> 原文: [https://www.geeksforgeeks.org/html-dom-video-seekable-property/](https://www.geeksforgeeks.org/html-dom-video-seekable-property/)

`视频可搜索属性`用于返回`一个时间范围对象`。时间范围对象用于表示可供用户搜索的视频范围。
