...
本示例描述了使用 `getElementById()` 方法访问具有 `type = "hidden"` 属性的 `<input>` 元素。
...
<body>
    <center>
        ...
        <input type = "hidden" id = "myGeeks" value="GeeksForGeeks">
...
输入隐藏对象可以使用 `document.createElement()` 方法创建。
    ...
    <center>
        ...
        <script>
            function Geeks() {
                ...
                document.getElementById("sudo").innerHTML = "Hidden Content";
            }
        </script>
    </center>
</body>
