...
> 原文: [https://www.geeksforgeeks.org/html-dom-window-performance-property/](https://www.geeksforgeeks.org/html-dom-window-performance-property/)

`performance` 属性返回一个性能对象，可以进一步用来收集当前文档的性能信息。
