...
> 原文：[https://www.geeksforgeeks.org/html-dom-embed-width-property/](https://www.geeksforgeeks.org/html-dom-embed-width-property/)

HTML 中的 **DOM 嵌入宽度属性**用于设置或返回 `width` 属性的值。`width` 属性定义嵌入内容的宽度，以像素为单位。
