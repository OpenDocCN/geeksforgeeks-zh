...
> 原文：[https://www.geeksforgeeks.org/html-dom-implementation-property/](https://www.geeksforgeeks.org/html-dom-implementation-property/)

HTML 中的 DOM 实现属性用于返回与当前文档关联的 `document.implementation` 对象。`DOMImplementation` 是表示提供不依赖于任何特定文档的对象的方法的接口。
