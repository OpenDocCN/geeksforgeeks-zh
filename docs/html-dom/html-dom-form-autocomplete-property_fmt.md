...
> 原文: [https://www.geeksforgeeks.org/html-dom-form-autocomplete-property/](https://www.geeksforgeeks.org/html-dom-form-autocomplete-property/)
...
<body>
    ...
    <script>
        function myGeeks() {
            ...
            document.getElementById("GFG").innerHTML = "Now the autocomplete is set to " + x;
        }
    </script>
</body>
</html>
