...
> 原文: [https://www.geeksforgeeks.org/html-dom-style-right-property/](https://www.geeksforgeeks.org/html-dom-style-right-property/)
...
## 返回值
它返回一个字符串，代表定位元素的正确位置。

## 属性值描述

*   `auto` - 该值由浏览器自动设置默认的右侧值。
*   `length` - 该值以指定的长度单位设置正确的值。该指定长度可以是正的，也可以是负的。
*   `%` - 百分比值以父元素宽度的指定百分比设置右值。
*   `initial` - 该值将右侧属性设置为浏览器的默认值。
...
*   之前点击按钮:
    ![](img/9153c6355e2d659b2f04aee147e8c9a1.png)
...
*   之前点击按钮:
    ![](img/a8f429f1a1e47a34b44d3687bb4932ab.png)
*   After click on the button:
