...
> 原文: [https://www.geeksforgeeks.org/html-dom-dialog-showmodal-method/](https://www.geeksforgeeks.org/html-dom-dialog-showmodal-method/)
...
本示例展示了 Dialog `showModal()`方法的工作原理:
