...
> 原文: [https://www.geeksforgeeks.org/html-dom-anchor-pathname-property/](https://www.geeksforgeeks.org/html-dom-anchor-pathname-property/)

HTML DOM 中的 `DOM 锚点路径名属性` 用于设置或返回 `href` 属性值的路径名部分。所有浏览器将返回“/test.htm”，而 IE 9 将返回“test.htm”。
