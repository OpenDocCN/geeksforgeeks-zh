...
> 原文: [https://www.geeksforgeeks.org/html-dom-keyboardevent-shiftkey-property/](https://www.geeksforgeeks.org/html-dom-keyboardevent-shiftkey-property/)
...
下面列出了 `KeyboardEvent` `shiftKey` 属性支持的浏览器:
