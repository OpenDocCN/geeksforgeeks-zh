...
> 原文: [https://www.geeksforgeeks.org/html-dom-video-currenttime-property/](https://www.geeksforgeeks.org/html-dom-video-currenttime-property/)
...
以下是 *HTML | DOM Video currentTime 属性*支持的浏览器:
