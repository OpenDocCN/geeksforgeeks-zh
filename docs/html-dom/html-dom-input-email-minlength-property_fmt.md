...
> 原文：[https://www.geeksforgeeks.org/html-dom-input-email-minlength-property/](https://www.geeksforgeeks.org/html-dom-input-email-minlength-property/)
...
它包含单个值`number`，用于指定电子邮件最大长度字段中允许的最小字符数。

返回值是一个数字值，代表电子邮件最小长度字段中允许的最小字符数。

## 示例 1

此示例说明如何返回输入电子邮件最小长度属性。
...
*   **点击按钮后：**![](img/b0f3b765998067c841c3c6d8a32a23e6.png)

## 示例 2

本示例说明如何设置输入电子邮件最小长度属性。
...
*   **点击按钮前：**![](img/2bb371e6a6160c20bf5f4b77ed355b5c.png)
*   **点击按钮后：**![](img/7800832aaeb3a646c13f92830b020fb1.png)

## 支持的浏览器

**HTML DOM 输入邮件最小长度属性**支持的浏览器如下：
