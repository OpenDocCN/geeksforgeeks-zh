...
> 原文: [https://www.geeksforgeeks.org/html-dom-style-tabsize-property/](https://www.geeksforgeeks.org/html-dom-style-tabsize-property/)

HTML DOM 中的 `Style tabSize` 属性用于设置或返回用于代替制表符的空格长度。
...
`DOM Style tab size` 属性支持的浏览器如下:

*   铬
*   Firefox: `-moz-tab-size`
*   Opera 15.0
*   Safari 6.1