...
> 原文: [https://www.geeksforgeeks.org/html-dom-tabledata-colspan-property/](https://www.geeksforgeeks.org/html-dom-tabledata-colspan-property/)

HTML DOM 中的 `Dom TableData colSpan` 属性用于设置或返回 `colSpan` 属性的值。`colspan` 属性用于指定表格单元格应该跨越的列数。
