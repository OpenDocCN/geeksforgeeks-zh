...
> 原文：[https://www.geeksforgeeks.org/html-dom-input-datetime-max-property/](https://www.geeksforgeeks.org/html-dom-input-datetime-max-property/)

`Input Datetime max` 属性用于设置或返回 Datetime 字段的 `max` 属性值。
