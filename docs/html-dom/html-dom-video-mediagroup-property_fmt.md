...
> 原文：[https://www.geeksforgeeks.org/html-dom-video-mediagroup-property/](https://www.geeksforgeeks.org/html-dom-video-mediagroup-property/)

**视频媒体组属性**用于**设置**或**返回**视频所属媒体组的名称。两个或更多 `<video>` 元素可以使用一个媒体组同步在一起。视频媒体组属性返回一个代表视频媒体组的字符串。
