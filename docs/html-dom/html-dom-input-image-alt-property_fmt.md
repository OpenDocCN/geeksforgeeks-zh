...
> 原文: [https://www.geeksforgeeks.org/html-dom-input-image-alt-property/](https://www.geeksforgeeks.org/html-dom-input-image-alt-property/)
...
它包含为输入图像指定替代文本的值，即 `text`。

## 返回值

返回一个字符串值，代表输入图像的可选文本。
