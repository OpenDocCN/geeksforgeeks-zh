...
> 原文：[https://www.geeksforgeeks.org/html-dom-local-storage-clear-method/](https://www.geeksforgeeks.org/html-dom-local-storage-clear-method/)

`clear()` 方法删除当前域的所有存储对象项目。
...
`DOM Local Storage clear()` 支持的浏览器如下：
