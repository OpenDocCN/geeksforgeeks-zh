...
> 原文: [https://www.geeksforgeeks.org/html-dom-video-readystate-property/](https://www.geeksforgeeks.org/html-dom-video-readystate-property/)
...
*   `4` = `HAVE_TOTAL_DATA`: 告知有足够的数据可以开始播放。
...
以下是 HTML DOM 视频 readyState Property 支持的浏览器:
