...
> 原文: [https://www.geeksforgeeks.org/html-dom-anchor-type-property/](https://www.geeksforgeeks.org/html-dom-anchor-type-property/)
...
包含单值 **MIME 类型**，用于指定目标网址。

## 返回值

返回一个字符串值，代表链接文档的 MIME 类型。
