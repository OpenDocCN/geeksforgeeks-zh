...
> 原文: [https://www.geeksforgeeks.org/html-dom-input-submit-autofocus-property/](https://www.geeksforgeeks.org/html-dom-input-submit-autofocus-property/)

`输入提交自动对焦属性`用于设置或返回页面加载时输入提交字段是否应该对焦。它反映了 HTML `autofocus` 属性。
...
<body style="text-align:center;">
    ...
    <form id="myGeeks" action="#" method="get" target="_self">
        <input type="submit" id="Geeks" name="myGeeks" value="Submit @ geeksforgeeks" autofocus>
    </form>
...
<body style="text-align:center;">
    ...
    <script>
        function myGeeks() {
            var btn = document.getElementById("Geeks").autofocus = false;
            document.getElementById("GFG").innerHTML = btn;
        }
    </script>
</body>
...
**支持的浏览器:** `DOM 输入提交自动对焦属性`支持的浏览器如下:
