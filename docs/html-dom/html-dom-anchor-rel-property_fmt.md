...
<body>
    <center>
        ...
        <script>
            function myGeeks() {
                var x = document.getElementById("GFG").rel = "prefetch";
                document.getElementById("sudo").innerHTML = "The value of the rel attribute " + "was changed to " + x;
            }
        </script>
    </center>
</body>
...
**支持的浏览器：** `anchorObject.rel` 属性支持的浏览器如下：
