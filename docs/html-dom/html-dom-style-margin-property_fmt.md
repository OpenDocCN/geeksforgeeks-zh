...
> 原文: [https://www.geeksforgeeks.org/html-dom-style-margin-property/](https://www.geeksforgeeks.org/html-dom-style-margin-property/)
...
`Margin` 属性设置为四个值 `80px 40px 20px 90px`，表示顶部= `80px`，右侧= `40px`，底部= `20px`，左侧= `90px`。
...
<body>
    <center>
        ...
        <script>
            function Geeks() {
                document.getElementById("GFG").style.margin = "80px 40px 20px 90px";
            }
        </script>
    </center>
</body>
...
将四个边距全部改为单个边距 `margin:25px` 表示 `顶部、右侧、底部和左侧= 25px`。
...
<body>
    <center>
        ...
        <script>
            function Geeks() {
                document.getElementById("GFG").style.margin = "25px";
            }
        </script>
    </center>
</body>
