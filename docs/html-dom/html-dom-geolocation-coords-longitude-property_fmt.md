...
> 原文：[https://www.geeksforgeeks.org/html-dom-geolocation-coords-longitude-property/](https://www.geeksforgeeks.org/html-dom-geolocation-coords-longitude-property/)

在本文中，我们将讨论[地理位置](https://www.geeksforgeeks.org/html-geolocation/)的`longitude`属性。
