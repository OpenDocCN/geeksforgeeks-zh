...
> 原文: [https://www.geeksforgeeks.org/html-dom-keygen-type-property/](https://www.geeksforgeeks.org/html-dom-keygen-type-property/)
...
返回一个字符串值，代表表单元素的 `keygen` 字段的类型。

## 示例

下面的程序说明了`键根` `类型`属性的使用。
...
<body>
    ...
    <form id="formID">
        ...
        <br><br> Encryption:
        <keygen id="keyid" form="formID" name="secure" autofocus>
        <input type="submit">
    </form>
