...
> 原文: [https://www.geeksforgeeks.org/html-dom-window-devicepixelratio-property/](https://www.geeksforgeeks.org/html-dom-window-devicepixelratio-property/)
...
返回一个双精度浮点值，表示显示器的物理像素分辨率与 CSS 像素分辨率的比值。
