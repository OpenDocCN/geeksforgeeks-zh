...
<!-- Assigning id to 'li tag' -->
    ...
    <script> 
        function myGeeks() { 
            // Accessing 'ol' tag. 
            var g = document.getElementById("Geeks").compact; 
...
<!-- Assigning id to 'li tag' -->
    ...
    <script> 
        function myGeeks() { 
            // Accessing 'ol' tag. 
            var g = document.getElementById("Geeks").compact = "false"; 
            document.getElementById("sudo").innerHTML = g; 
        } 
    </script> 
</body>
