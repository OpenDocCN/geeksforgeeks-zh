...
> 原文：[https://www.geeksforgeeks.org/html-dom-input-password-pattern-property/](https://www.geeksforgeeks.org/html-dom-input-password-pattern-property/)
...
**属性值：** 它接受单个值 `regexp`，用于指定检查密码字段值的正则表达式。
