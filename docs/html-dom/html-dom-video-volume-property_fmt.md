...
> 原文：[https://www.geeksforgeeks.org/html-dom-video-volume-property/](https://www.geeksforgeeks.org/html-dom-video-volume-property/)

`视频音量属性`用于**设置**或**返回**视频的音频音量。
`视频音量属性`接受的值范围介于 `0.0`（静音）和 `1.0`（最大声）之间。
