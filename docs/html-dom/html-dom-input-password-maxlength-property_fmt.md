...
> 原文: [https://www.geeksforgeeks.org/html-dom-input-password-maxlength-property/](https://www.geeksforgeeks.org/html-dom-input-password-maxlength-property/)

**DOM 输入密码最大长度属性**用于设置或返回密码字段的 `maxLength` 属性的值。指定元素中允许的最大字符数。
