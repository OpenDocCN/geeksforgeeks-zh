...
> 原文：[https://www.geeksforgeeks.org/html-dom-iframe-sandbox-property/](https://www.geeksforgeeks.org/html-dom-iframe-sandbox-property/)

HTML DOM 中的 `IFrame` 沙盒属性用于返回 `IFrame` 元素中 `sandbox` 属性的值。
