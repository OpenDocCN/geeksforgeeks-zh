...
> 原文: [https://www.geeksforgeeks.org/html-dom-nodelist-entries-method/](https://www.geeksforgeeks.org/html-dom-nodelist-entries-method/)
...
## 示例:
在本例中，我们将创建一个节点列表，因此将获得一个迭代器来获取节点列表中的所有值。
