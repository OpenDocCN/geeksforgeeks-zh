...
> 原文：[`https://www.geeksforgeeks.org/html-dom-range-setendafter-method/`](https://www.geeksforgeeks.org/html-dom-range-setendafter-method/)
...
本示例介绍如何设置范围的结束位置。同样在这个例子中，我们使用了 `setStartBefore()` 方法来设置范围的开始。结束引用节点是文档的第二个 `<i>` 元素。
