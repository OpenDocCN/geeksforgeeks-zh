...
> 原文：[https://www.geeksforgeeks.org/html-dom-textarea-wrap-property/](https://www.geeksforgeeks.org/html-dom-textarea-wrap-property/)

**DOM 文本区环绕属性**用于**设置**或**返回**文本区的环绕属性的值。它描述了提交表单时文本的包装方式。
...
*   **soft:** 定义文本不换行。这是默认值。
*   **hard:** 定义文字被包裹。这里必须提到 `cols` 属性。

## 返回值

以字符串的形式返回文本在文本区域中的换行方式。
