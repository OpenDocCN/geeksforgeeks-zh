...
> 原文：[https://www.geeksforgeeks.org/html-dom-input-url-maxlength-property/](https://www.geeksforgeeks.org/html-dom-input-url-maxlength-property/)

HTML DOM 中的 `DOM 输入网址最大长度属性` 用于设置或返回网址输入字段的最大长度属性值。它指定了 URL 字段中允许的最大字符数。输入搜索最大长度属性的默认值是 524288。
