...
> 原文：[https://www.geeksforgeeks.org/html-dom-style-outline-property/](https://www.geeksforgeeks.org/html-dom-style-outline-property/)
...
<body>
    ...
    <script>
        function myGeeks() {
            document.getElementById("container").style.outline = "thick solid blue";
        }
        myGeeks();
    </script>
</body>
...
<body>
    ...
    <script>
        function myGeeks() {
            document.getElementById("GFG").style.outline = "7px dashed green";
        }
    </script>
</body>
