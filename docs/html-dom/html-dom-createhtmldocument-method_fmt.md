...
> 原文: [https://www.geeksforgeeks.org/html-dom-createhtmldocument-method/](https://www.geeksforgeeks.org/html-dom-createhtmldocument-method/)

`createHTMLDocument()` 方法用于创建一个新的 HTML 文档。
...
*   `title` (可选): 它是一个包含要用于新 HTML 文档的标题的 DOMString。
