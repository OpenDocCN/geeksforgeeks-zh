...
> 原文: [https://www.geeksforgeeks.org/html-dom-console-trace-method/](https://www.geeksforgeeks.org/html-dom-console-trace-method/)

`console.trace()` 方法用来显示代表代码如何在某个点结束的跟踪。
