...
> 原文:[https://www.geeksforgeeks.org/html-dom-style-bordertop-property/](https://www.geeksforgeeks.org/html-dom-style-bordertop-property/)
...
<html>
    ...
    <body>
        <center>
            ...
            <script>
                function geeks() {
                    document.getElementById("sudo").style.borderTop = "thick solid green";
                }
            </script>
        </center>
    </body>
...
<html>
    ...
    <body>
        <center>
            ...
            <script>
                function geeks() {
                    document.getElementById("sudo").style.borderTop = "thick dotted green";
                }
            </script>
        </center>
    </body>
