...
> 原文：[https://www.geeksforgeeks.org/html-dom-fieldset-form-property/](https://www.geeksforgeeks.org/html-dom-fieldset-form-property/)

HTML DOM 中的**字段集表单属性**用于设置或返回对包含 `<fieldset>` 元素的表单的引用。它是只读属性，在成功时返回表单对象。
