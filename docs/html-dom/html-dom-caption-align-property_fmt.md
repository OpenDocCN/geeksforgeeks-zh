...
> 原文: [https://www.geeksforgeeks.org/html-dom-caption-align-property/](https://www.geeksforgeeks.org/html-dom-caption-align-property/)
...
<body>
    ...
    <script>
        function myGeeks() {
            var w = document.getElementById("GFG").align = "right";
            document.getElementById("sudo").innerHTML = w;
        } 
    </script>
</body>
