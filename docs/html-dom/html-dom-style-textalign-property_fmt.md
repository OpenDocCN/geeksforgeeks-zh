...
> 原文: [https://www.geeksforgeeks.org/html-dom-style-textalign-property/](https://www.geeksforgeeks.org/html-dom-style-textalign-property/)
...
*   `left`: 为默认值。内容向左对齐。
*   `right`: 内容向右对齐。
*   `center`: 这将内容设置在中心，在左右边缘之间。
*   `justify`: 这在单词之间引入了额外的空格，使得该行的第一个单词向左对齐，最后一个单词向右对齐。
*   `inherit`: 它不做任何花哨的事情，而是将值设置为与其直接父级完全相同。
...
<body>
    ...
    <script type="text/javascript">
        //  Collecting elements  
        let inside_content = document.getElementById("inside-content");
...
*   设置 `align` 属性前: ![](img/250eb82f78ea57379181ac929be8853d.png)
*   设置 `align` 属性后: ![](img/80d58b13a1e7f1d1b7fe04ea58a426a4.png)

## 支持的浏览器:
下面列出了 `HTML | DOM Style textAlign Property` 支持的浏览器:
