...
HTML DOM 中的图像名称属性用于设置或返回 `<img>` 元素的 `name` 属性的值。
...
<body>
    <center>
        ...
        <img src="https://media.geeksforgeeks.org/wp-content/uploads/20190602171808/629.png"
             id="image"
             alt=""
             width="250"
             height="205"
    ...
    <script>
        function getHeight() {
            ...
            output.innerHTML = "The name of the image is : " + imgObject.name;
        }
    </script>
</body>
...
<body>
    ...
    <script>
        function getHeight() {
            var imgObject = document.getElementById("image").name = "Hello Geeks";
            var output = document.getElementById("text").innerHTML = "The name of the image was changed to " + imgObject;
        }
    </script>
</body>
