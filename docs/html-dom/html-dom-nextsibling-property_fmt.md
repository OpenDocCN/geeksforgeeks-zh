...
> 原文: [https://www.geeksforgeeks.org/html-dom-nextsibling-property/](https://www.geeksforgeeks.org/html-dom-nextsibling-property/)
...
此属性返回指定节点的下一个同级，如果当前节点没有下一个同级，则返回 `null`。
...
两个兄弟元素之间不要放空格，否则结果会是“未定义”。

## 支持的浏览器

`nextSibling` 属性支持的浏览器如下:
