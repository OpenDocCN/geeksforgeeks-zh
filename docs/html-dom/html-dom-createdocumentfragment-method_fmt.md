...
> 原文：[https://www.geeksforgeeks.org/html-dom-createdocumentfragment-method/](https://www.geeksforgeeks.org/html-dom-createdocumentfragment-method/)
...
以下是 `DOM createDocumentFragment()` 方法支持的浏览器：
