...
> 原文：[https://www.geeksforgeeks.org/html-dom-style-textindent-property/](https://www.geeksforgeeks.org/html-dom-style-textindent-property/)
...
*DOM Style text indent* 支持的浏览器如下：
