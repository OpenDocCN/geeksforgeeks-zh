...
> 原文：[https://www.geeksforgeeks.org/html-dom-tableheader-cellindex-property/](https://www.geeksforgeeks.org/html-dom-tableheader-cellindex-property/)

HTML DOM 中的 `TableHeader` `cellIndex` 属性用于返回表格行的单元格集合中单元格的位置。
...
`DOM TableHeader cellIndex` 属性支持的浏览器如下：
