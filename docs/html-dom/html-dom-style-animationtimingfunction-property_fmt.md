...
> 原文：[https://www.geeksforgeeks.org/html-dom-style-animationtimingfunction-property/](https://www.geeksforgeeks.org/html-dom-style-animationtimingfunction-property/)

HTML DOM 中的 `Style.animationTimingFunction` 属性定义了样式之间的过渡时间，以使过渡平滑。它指定动画的速度曲线。
...
由 `DOM 样式的 animationTimingFunction 属性`支持的浏览器如下:
