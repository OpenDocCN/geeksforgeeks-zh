...
> 原文：[https://www.geeksforgeeks.org/html-dom-input-number-stepup-method/](https://www.geeksforgeeks.org/html-dom-input-number-stepup-method/)

HTML DOM 中的 `stepUp()` 方法用于将数字字段的值增加给定值。
...
*   `number`：指定数字字段要增加的数字。默认情况下，它会增加 1。
