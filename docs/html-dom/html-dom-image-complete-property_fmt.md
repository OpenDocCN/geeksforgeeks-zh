...
> 原文: [https://www.geeksforgeeks.org/html-dom-image-complete-property/](https://www.geeksforgeeks.org/html-dom-image-complete-property/)

HTML DOM 中的`图像完整属性`用于返回浏览器是否完成加载图像。它返回一个布尔值。
...
当浏览器完成图像加载时，返回布尔值`true`，否则返回`false`。
