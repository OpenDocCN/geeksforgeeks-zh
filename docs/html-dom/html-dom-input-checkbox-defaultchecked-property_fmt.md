...
> 原文：[https://www.geeksforgeeks.org/html-dom-input-checkbox-defaultchecked-property/](https://www.geeksforgeeks.org/html-dom-input-checkbox-defaultchecked-property/)
...
它返回一个布尔值，如果默认情况下复选框被选中，则该值返回真，否则返回假。
