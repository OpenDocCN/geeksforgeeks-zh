...
> 原文：[https://www.geeksforgeeks.org/html-dom-console-timeend-method/](https://www.geeksforgeeks.org/html-dom-console-timeend-method/)
...
## 参数：
该方法接受单参数 `label`，可选。它用于指定要停止的计时器的标签。
