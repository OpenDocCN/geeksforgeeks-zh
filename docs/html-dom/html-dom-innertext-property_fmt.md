...
`innerText` 属性用于设置或返回指定节点及其后代的文本内容。此属性与 `textContent` 属性非常相似，但返回所有元素的内容，除了 `<script>` 和 `<style>` 元素。
...
**输出:**
点击按钮前:
![](img/73f8c83340bd45b12dd35ddcaaa7ac85.png)

点击按钮后:
![](img/098587184533e46cba3f6bd13ee96b7a.png)

## 支持的浏览器
`innerText` 属性支持的浏览器如下:
