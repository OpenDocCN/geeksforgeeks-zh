...
> 原文: [https://www.geeksforgeeks.org/html-dom-contenteditable-property/](https://www.geeksforgeeks.org/html-dom-contenteditable-property/)

`contentEditable` 属性用于返回一个布尔值，其中 `true` 表示元素的内容可编辑，`false` 表示内容不可编辑。此属性是只读的。
