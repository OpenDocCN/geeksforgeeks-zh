...
> 原文: [https://www.geeksforgeeks.org/html-dom-style-widows-property/](https://www.geeksforgeeks.org/html-dom-style-widows-property/)

`widows` 属性用于设置或返回最小行数。这些行必须在元素的页面顶部可见。`widows` 属性仅影响块级元素。
...
`HTML DOM Style widows` 属性支持的浏览器如下:
