# HTML DOM 鼠标事件 buttons 属性

> 原文：[https://www.geeksforgeeks.org/html-dom-mouseevent-buttons-property/](https://www.geeksforgeeks.org/html-dom-mouseevent-buttons-property/)

鼠标事件的 `buttons` 属性用于返回一个数字。该数字指示在触发鼠标事件时按下了哪个或哪些鼠标按钮。
