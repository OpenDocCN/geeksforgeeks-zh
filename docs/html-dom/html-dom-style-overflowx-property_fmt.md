...
> 原文: [https://www.geeksforgeeks.org/html-dom-style-overflowx-property/](https://www.geeksforgeeks.org/html-dom-style-overflowx-property/)
...
`overflowX` 属性指定了内容在块级元素的左右边缘溢出时的行为。
