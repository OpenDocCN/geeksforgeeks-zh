...
HTML DOM 中的**输入文本对象**用于表示带有 `type="text"` 属性的 HTML `<input>` 元素。使用 `getElementById()` 方法可以访问带有 `type="text"` 的 `<input>` 元素。
...
| `autocomplete` | This property is used to set or return the value of the autocomplete property of a text field. |
| `autofocus` | This property is used to set or return whether the text field should be autofocused when the page is loaded. |
| `defaultValue` | This property is used to set or return the default value of a text field. |
| `disabled` | This property is used to set or return whether the text field is disabled. |
| `form` | This property is used to return a reference to a form that contains a text field. |
| `list` | This property is used to return a reference to a data list containing a text field. |
| `maxLength` | This property is used to set or return the value of the maxLength property of a text field. |
| `name` | This property is used to set or return the value of the name property of a text field. |
| `pattern` | This property is used to set or return the value of the pattern property of the text field. |
| `placeholder` | This property is used to set or return the value of the placeholder property of a text field. |
| `readOnly` | This property is used to set or return whether the text field is read-only. |
...
本示例使用 `getElementById()` 方法访问具有 `type="text"` 属性的 `<input>` 元素。
...
本示例使用 `document.createElement()` 方法创建具有 `type="text"` 属性的 `<input>` 元素。
