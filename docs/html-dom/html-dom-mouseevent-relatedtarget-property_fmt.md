...
> 原文: [https://www.geeksforgeeks.org/html-dom-mouseevent-relatedtarget-property/](https://www.geeksforgeeks.org/html-dom-mouseevent-relatedtarget-property/)

`MouseEvent` `relatedTarget` 属性为只读属性，用于返回与**触发鼠标事件**的元素相关的元素。
