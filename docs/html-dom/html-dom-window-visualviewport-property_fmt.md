...
> 原文：[https://www.geeksforgeeks.org/html-dom-window-visualviewport-property/](https://www.geeksforgeeks.org/html-dom-window-visualviewport-property/)

窗口界面的`视口`属性返回一个表示当前窗口视口的`视口`对象。这是只读属性。
...
这个示例展示了如何使用这个对象获取`可视化视口`对象。此外，我们已经展示了使用该对象的`可视化视口`的一些细节。
