...
> 原文：[`https://www.geeksforgeeks.org/html-dom-audio-autoplay-property/`](https://www.geeksforgeeks.org/html-dom-audio-autoplay-property/)

**音频自动播放属性**用于**设置**或**返回**是否*音频一加载就开始播放*。可以用来指定音频一加载就自动开始播放。
...
返回布尔值，如果音频自动开始播放，则返回 `true`，否则返回 `false`。
