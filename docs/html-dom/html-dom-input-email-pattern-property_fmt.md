...
> 原文：[https://www.geeksforgeeks.org/html-dom-input-email-pattern-property/](https://www.geeksforgeeks.org/html-dom-input-email-pattern-property/)
...
它包含单个值**正则表达式**，用于指定检查电子邮件字段值所依据的正则表达式。

## 返回值

它返回一个字符串值，该值代表检查电子邮件字段值所依据的正则表达式。
