...
> 原文：[https://www.geeksforgeeks.org/html-dom-input-text-pattern-property/](https://www.geeksforgeeks.org/html-dom-input-text-pattern-property/)
...
它包含单值正则表达式，用于指定检查文本字段值所依据的正则表达式。

## 返回值

它返回一个字符串值，该值代表检查文本字段值所依据的正则表达式。
