...
> 原文: [https://www.geeksforgeeks.org/html-dom-input-image-formnovalidate-property/](https://www.geeksforgeeks.org/html-dom-input-image-formnovalidate-property/)

## HTML DOM 输入图像表单合并属性

用于在用户提交表单时设置或返回表单数据是否经过验证。此属性用于反映 HTML 表单验证属性。
