...
> 原文：[https://www.geeksforgeeks.org/html-dom-iframe-name-property/](https://www.geeksforgeeks.org/html-dom-iframe-name-property/)
...
它返回一个指定 Iframe 元素名称的字符串值。

## 示例 1

本示例说明如何返回 Iframe 名称属性。
...
HTML DOM IFrame name 属性支持的浏览器如下：
