...
> 原文：[https://www.geeksforgeeks.org/html-dom-style-borderleft-property/](https://www.geeksforgeeks.org/html-dom-style-borderleft-property/)

DOM `style.borderLeft` 属性用于设置或返回元素的三种不同的左边框属性，如左边框宽度、左边框样式和左边框颜色。
