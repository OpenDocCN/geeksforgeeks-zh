...
> 原文: [https://www.geeksforgeeks.org/html-dom-window-closed-property/](https://www.geeksforgeeks.org/html-dom-window-closed-property/)

`HTML DOM` 中的 `window.closed` 属性用于返回一个值，该值指示引用的窗口是否关闭。
