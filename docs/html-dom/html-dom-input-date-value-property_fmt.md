...
> 原文: [https://www.geeksforgeeks.org/html-dom-input-date-value-property/](https://www.geeksforgeeks.org/html-dom-input-date-value-property/)

`input`日期`value`属性用于设置或返回日期字段的`value`属性的值。
`input`日期`value`属性可用于为日期字段指定日期。
