...
> 原文: [https://www.geeksforgeeks.org/html-dom-audio-seeking-property/](https://www.geeksforgeeks.org/html-dom-audio-seeking-property/)
...
如果用户当前正在搜索，音频搜索属性返回布尔值`true`，否则返回`false`。音频搜索属性是只读属性。
