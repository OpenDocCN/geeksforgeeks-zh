...
> 原文：[https://www.geeksforgeeks.org/html-dom-button-autofocus-property/](https://www.geeksforgeeks.org/html-dom-button-autofocus-property/)

HTML DOM 中的`按钮自动对焦属性`用于设置或返回页面加载时按钮是否应该对焦。此属性用于反映 HTML `autofocus` 属性。
