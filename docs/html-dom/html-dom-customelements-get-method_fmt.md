...
> 原文: [https://www.geeksforgeeks.org/html-dom-customelements-get-method/](https://www.geeksforgeeks.org/html-dom-customelements-get-method/)
...
该方法返回自定义元素的构造函数，如果没有同名的自定义元素定义，则返回 `undefined`。

## 示例

在这个示例中，我们将定义一个自定义元素，然后使用这个方法获取它的构造函数。
