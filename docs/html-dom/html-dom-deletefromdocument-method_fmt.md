...
> 原文: [https://www.geeksforgeks.org/html-dom-deletefromdocument-method/](https://www.geeksforgeks.org/html-dom-deletefromdocument-method/)
...
<html>
   ...
   <body>
      <h1>GeeksforGeeks</h1>
      <p>select some text and click on button to delete it from document</p>
      <button>Click</button>
   </body>
   <script>
