...
> 原文: [https://www.geeksforgeeks.org/html-dom-audio-buffered-property/](https://www.geeksforgeeks.org/html-dom-audio-buffered-property/)

**音频缓冲属性**用于返回时间范围对象。用户缓冲的音频范围可以使用时间范围对象来表示。
