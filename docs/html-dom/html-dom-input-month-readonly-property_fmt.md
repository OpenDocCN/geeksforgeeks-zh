...
> 原文：[https://www.geeksforgeeks.org/html-dom-input-month-readonly-property/](https://www.geeksforgeeks.org/html-dom-input-month-readonly-property/)

`DOM输入月只读`属性用于设置或返回输入月字段是否为只读。可以复制但不能修改。
