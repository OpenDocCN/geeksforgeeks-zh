...
> 原文: [https://www.geeksforgeeks.org/html-dom-onloadedmetadata-event/](https://www.geeksforgeeks.org/html-dom-onloadedmetadata-event/)
...
<body>
    <center>
        ...
        <video controls id="VideoId">
            <source src="https://media.geeksforgeeks.org/wp-content/uploads/20190705202742/Disabling-Tabs.mp4" type="video/mp4">
        </video>

        <script>
            document.getElementById("VideoId").addEventListener("loadedmetadata", GFGFun);
...
## 支持的浏览器
`HTML DOM onloadedmetadata` 事件支持的浏览器如下:
- `Google Chrome`
- `Microsoft Edge`
- `Firefox`
- `Safari`
