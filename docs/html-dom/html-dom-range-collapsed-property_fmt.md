...
> 原文：[`https://www.geeksforgeeks.org/html-dom-range-collapsed-property/`](https://www.geeksforgeeks.org/html-dom-range-collapsed-property/)
...
在这个例子中，我们给了范围一些内容，然后应用这个属性得到`假`值。
