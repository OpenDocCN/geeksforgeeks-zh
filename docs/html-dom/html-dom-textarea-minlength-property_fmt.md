...
> 原文: [https://www.geeksforgeeks.org/html-dom-textarea-minlength-property/](https://www.geeksforgeeks.org/html-dom-textarea-minlength-property/)
...
返回一个数值，代表文本区域字段中允许的最小字符数。

## 示例 1

HTML 程序说明如何**返回 minlength 属性**。
