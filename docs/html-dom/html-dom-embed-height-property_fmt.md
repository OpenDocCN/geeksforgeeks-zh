...
> 原文: [https://www.geeksforgeeks.org/html-dom-embed-height-property/](https://www.geeksforgeeks.org/html-dom-embed-height-property/)

HTML DOM 中的嵌入高度属性用于设置或返回高度属性的值。高度属性以像素为单位定义嵌入内容的高度。
