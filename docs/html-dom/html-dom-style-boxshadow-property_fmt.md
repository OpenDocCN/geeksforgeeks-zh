...
> 原文：[https://www.geeksforgeeks.org/html-dom-style-boxshadow-property/](https://www.geeksforgeeks.org/html-dom-style-boxshadow-property/)

DOM Style `boxShadow` 属性用于设置或返回元素的投影。
...
This is used to specify the position of the shadow in length units. Negative values are allowed.
...
This is used to define the amount of blur to be used in the shadow.
...
This is used to define the amount of spread of the shadow.
...
This is used to define the color of the shadow to be used.
...
This is used to set the shadow to an inner one. Normally a shadow is an outset, that is outside.
...
This is used to remove any shadow present. This is the default value.
