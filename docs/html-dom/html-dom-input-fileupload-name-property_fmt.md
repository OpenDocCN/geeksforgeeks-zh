...
> 原文: [https://www.geeksforgeeks.org/html-dom-input-fileupload-name-property/](https://www.geeksforgeeks.org/html-dom-input-fileupload-name-property/)

`name`属性用于**设置**或**返回**文件上传按钮的名称属性值。
