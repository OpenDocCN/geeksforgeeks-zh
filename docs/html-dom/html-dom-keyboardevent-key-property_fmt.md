...
> 原文: [https://www.geeksforgeeks.org/html-dom-keyboardevent-key-property/](https://www.geeksforgeeks.org/html-dom-keyboardevent-key-property/)

HTML 中的 `keyboardEvent` 键属性用于返回按键事件发生时按下的按键值。它根据按下的键返回单个字符或多个字符串。它是只读属性。
