...
> 原文: [https://www.geeksforgeeks.org/html-dom-image-ismap-property/](https://www.geeksforgeeks.org/html-dom-image-ismap-property/)
...
它包含一个布尔值，该值定义图像是否是服务器端图像映射的一个组件。
...
返回一个布尔值，该值表示图像是否是服务器端图像映射的组成部分。
  ...
  <body>
    <center>
      ...
      <a href="#">
        <img
          id="GFG"
          src="https://media.geeksforgeeks.org/wp-content/uploads/a1-25.png"
          width="400"
          height="150"
          ismap
        />
