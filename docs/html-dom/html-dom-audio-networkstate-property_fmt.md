...
> 原文：[https://www.geeksforgeeks.org/html-dom-audio-networkstate-property/](https://www.geeksforgeeks.org/html-dom-audio-networkstate-property/)
...
*   点击`Return Network State`按钮后：
    ![](img/3a7f6205eeb977c36fc8d56a0d7abb4a.png)

## 支持的浏览器

`DOM 音频网络状态属性`支持的浏览器如下：
