...
> 原文: [https://www.geeksforgeeks.org/html-dom-image-width-property/](https://www.geeksforgeeks.org/html-dom-image-width-property/)

`HTML` DOM `Image` `width` 属性用于设置或返回 `<img>` 元素的 `width` 属性的值。它以像素为单位返回一个数值。
