...
> 原文: [https://www.geeksforgeeks.org/html-dom-progress-position-property/](https://www.geeksforgeeks.org/html-dom-progress-position-property/)
...
<body> 
    ...
    <script> 
        function myGeeks() { 
            var pr = document.getElementById("GFG").position;
