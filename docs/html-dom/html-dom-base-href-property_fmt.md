...
HTML DOM 中的 DOM Base href 属性用于设置或返回一个 [`<base>`](https://www.geeksforgeeks.org/html-base-tag/) 元素的 `href` 属性值。`href` 属性用于指定网页中所有相对网址的基本网址。
