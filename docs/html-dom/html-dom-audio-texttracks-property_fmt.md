...
> 原文: [https://www.geeksforgeeks.org/html-dom-audio-texttracks-property/](https://www.geeksforgeeks.org/html-dom-audio-texttracks-property/)

**HTML DOM 音频文本轨道属性**用于返回一个文本轨道列表对象。
...
<head>
    <title>HTML DOM Audio textTracks Property</title>
    <style>
        h1 {
            color: green;
        }
...
<body>
    ...
    <script>
        function access() {
            ...
            var m = document.getElementById("track").textTracks.length;
