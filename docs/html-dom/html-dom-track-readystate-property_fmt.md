...
> 原文: [https://www.geeksforgeeks.org/html-dom-track-readystate-property/](https://www.geeksforgeeks.org/html-dom-track-readystate-property/)

**DOM 轨道就绪状态属性**用于返回轨道当前就绪状态的值。它是只读属性，就绪状态表示轨道是否准备好播放。
...
*   `2` = `LOADED`：这意味着文本轨道已加载，没有错误。
*   `3` = `ERROR`：这意味着文本轨道已启用，但当用户试图获取它时出现了故障。
...
`HTML DOM Track readyState` 属性支持的浏览器如下:
