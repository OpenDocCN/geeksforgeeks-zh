...
> 原文: [https://www.geeksforgeeks.org/html-dom-input-datetime-autocomplete-property/](https://www.geeksforgeeks.org/html-dom-input-datetime-autocomplete-property/)

HTML DOM 中的输入 Datetime 自动完成属性用于设置或返回输入 Datetime 字段的自动完成属性值。自动完成属性用于指定自动完成属性的值是“开”还是“关”。当“自动完成”属性设置为“开”时，浏览器将根据用户之前输入的值自动完成。
...
本示例说明如何返回 Input Datetime 自动完成属性。
