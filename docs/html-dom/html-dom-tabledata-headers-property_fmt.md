...
> 原文: [https://www.geeksforgeeks.org/html-dom-tabledata-headers-property/](https://www.geeksforgeeks.org/html-dom-tabledata-headers-property/)
...
它包含值，即 `标题_id`，指定一个或多个标题单元格的单独 `id` 列表。

## 返回值

返回一个字符串值，代表标题列表标识的分隔列表。
