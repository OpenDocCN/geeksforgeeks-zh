...
> 原文: [https://www.geeksforgeeks.org/html-dom-style-borderleftwidth-property/](https://www.geeksforgeeks.org/html-dom-style-borderleftwidth-property/)

DOM Style `borderLeftWidth` 属性用于**设置**或**返回**元素左边框的宽度。
...
<html lang="en">
<head>
    <title>DOM Style BorderLeftWidth</title>
    <style>
        .elem {
            padding: 10px;
            border-style: solid;
...
<body>
    ...
    <button onclick="changeWidth()">Change BorderLeftWidth</button>
