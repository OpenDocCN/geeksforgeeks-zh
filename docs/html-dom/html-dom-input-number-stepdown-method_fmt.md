# HTML DOM 输入数字 stepDown() 方法

> 原文: [https://www.geeksforgeeks.org/html-dom-input-number-stepdown-method/](https://www.geeksforgeeks.org/html-dom-input-number-stepdown-method/)

HTML DOM 中的 `DOM 输入数字步降()` 方法用于将数字字段的值减少给定值。
...
`DOM 输入 Number stepDown()` 方法支持的浏览器如下:
