...
> 原文: [https://www.geeksforgeeks.org/html-dom-keygen-keytype-property/](https://www.geeksforgeeks.org/html-dom-keygen-keytype-property/)

HTML DOM 中的 `HTML keygen` `keytype` 属性用于设置或返回 `keygen` 元素的 `keytype` 属性的值。`keytype` 属性用于定义将要使用的键的类型。
