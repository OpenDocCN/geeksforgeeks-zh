...
> 原文：[https://www.geeksforgeeks.org/html-dom-console-table-method/](https://www.geeksforgeeks.org/html-dom-console-table-method/)

HTML 中的 `console.table()` 方法用于在控制台视图中以表格形式写入数据。表数据作为参数发送到 `console.table()` 方法，该方法必须是一个包含要填充到表中的数据的对象或数组。
