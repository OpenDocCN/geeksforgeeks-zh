...
> 原文：`https://www.geeksforgeeks.org/html-dom-input-datetime-form-property/`
...
它返回一个字符串值，该值指定包含输入日期时间字段的表单的引用。
...
<head>
    <title>Input Datetime form Property in HTML</title>
    <style>
        h1 {
            color: green;
        }
...
<body>
    ...
    <p>To return the id of the form, double click the "Return Form Object" button.</p>
    ...
    <script>
        function My_Datetime() {
            // Return form ID
            var d = document.getElementById("Test_Datetime").form.id;
