...
> 原文: [https://www.geeksforgeeks.org/html-dom-audio-error-property/](https://www.geeksforgeeks.org/html-dom-audio-error-property/)
...
*   `1` = `MEDIA_ERR_ABORTED` – 用户中止了提取过程
*   `2` = `MEDIA_ERR_NETWORK` – 下载时出错
*   `3` = `MEDIA_ERR_DECODE` – 解码时出错
