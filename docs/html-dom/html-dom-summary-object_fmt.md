...
**DOM 摘要对象**用于表示 HTML [`<summary>`](https://www.geeksforgeeks.org/html-5-summary-tag/) 元素。`summary` 元素由 `getElementById()` 访问。
...
可以使用 `document.createElement` 方法创建摘要对象。
