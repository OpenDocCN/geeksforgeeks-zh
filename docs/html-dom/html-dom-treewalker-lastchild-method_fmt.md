...
> 原文: [https://www.geeksforgeeks.org/html-dom-treewalker-lastchild-method/](https://www.geeksforgeeks.org/html-dom-treewalker-lastchild-method/)
...
在本例中，创建一个带有头节点的 `TreeWalker`，因此显示了该 `TreeWalker` 节点的最后一个子节点。
