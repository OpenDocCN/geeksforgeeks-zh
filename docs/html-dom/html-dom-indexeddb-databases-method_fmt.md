...
> 原文: [https://www.geeksforgeeks.org/html-dom-indexeddb-databases-method/](https://www.geeksforgeeks.org/html-dom-indexeddb-databases-method/)
...
这个方法返回一个包含字典列表的承诺，每个字典有两个元素，名字和版本。

## 示例

在本例中，我们将打开一个数据库，因此，将使用此方法获取数据库。
