...
> 原文: [https://www.geeksforgeeks.org/html-dom-anchor-text-property/](https://www.geeksforgeeks.org/html-dom-anchor-text-property/)
...
<body>
    <center>
        ...
        <p>Welcome to
            <a href="https://manaschhabra:manaschhabra499@www.geeksforgeeks.org/"
               id="GFG">
                GeeksforGeeks
            </a>
        </p>
...
<body>
    <center>
        ...
        <script>
            function myGeeks() {
                var x = document.getElementById("GFG").text = "GFG";
                document.getElementById("sudo").innerHTML = "The text was changed to " + x;
            }
        </script>
    </center>
</body>
