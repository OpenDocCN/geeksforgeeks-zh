...
> 原文: [https://www.geeksforgeeks.org/html-dom-output-value-property/](https://www.geeksforgeeks.org/html-dom-output-value-property/)

**HTML DOM 输出值属性**用于设置或返回 `<output>` 元素的属性值。`value` 属性用于指定计算结果。
...
<body>
    ...
    <script>
        function myGeeks() {
            var x = document.getElementById("geeks").value = 150;
