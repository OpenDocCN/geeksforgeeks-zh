...
> 原文: [https://www.geeksforgeeks.org/html-dom-documenturi-property/](https://www.geeksforgeeks.org/html-dom-documenturi-property/)

HTML DOM 中的 `documentURI` 属性用于设置或返回文档的位置。如果文档是由 `Document` 实现或 `undefined` 创建的，返回值为空。
`documentURI` 属性可用于任何文档类型。
