...
> 原文：[https://www.geeksforgeeks.org/html-dom-textarea-form-property/](https://www.geeksforgeeks.org/html-dom-textarea-form-property/)
...
**注意：** 上面的代码打印表单类型的对象。要打印表单的 id 或名称，请仅在脚本中使用`form.id`而不是`form`。
