...
> 原文：[https://www.geeksforgeeks.org/html-dom-input-date-min-property/](https://www.geeksforgeeks.org/html-dom-input-date-min-property/)
...
<body>
    ...
    <p>To return the min range of the date field, double click the "Return Min" button.</p>
...
<body>
    ...
    <p>To set the min range of the date field, double click the "Set Min" button.</p>
    ...
    <script>
        function My_Date() {
            var d = document.getElementById("Test_Date").min = "2019-01-01";
            document.getElementById("test").innerHTML = d;
        }
    </script>
