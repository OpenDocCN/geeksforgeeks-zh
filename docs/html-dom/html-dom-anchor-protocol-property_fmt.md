...
> 原文: [https://www.geeksforgeeks.org/html-dom-anchor-protocol-property/](https://www.geeksforgeeks.org/html-dom-anchor-protocol-property/)
...
**属性值:** 它包含单个值 `protocol`，指定数据如何在两台计算机之间传输。例如: `file`、`ftp`、`http`、`https`、`mailto` 等。
...
<body>
    <center>
        ...
        <p>Welcome to
            <a href="https://write.geeksforgeeks.org/wp-admin/post.php?post=964437&action=edit"
...
<body>
    <center>
        ...
        <script>
            function myGeeks() {
                var x = document.getElementById("GFG").protocol = "http";
                document.getElementById("sudo").innerHTML = "The value of the Protocol attribute was changed to " + x;
            }
        </script>
    </center>
</body>
