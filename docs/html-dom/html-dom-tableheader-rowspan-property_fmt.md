...
> 原文: [https://www.geeksforgeeks.org/html-dom-tableheader-rowspan-property/](https://www.geeksforgeeks.org/html-dom-tableheader-rowspan-property/)

[`HTML DOM TableHeader`](https://www.geeksforgeeks.org/html-dom-tableheader-object/) `rowSpan` 属性用于设置或返回 `rowspan` 属性的值。HTML 中的 `rowspan` 属性指定了单元格应该跨越的行数。
