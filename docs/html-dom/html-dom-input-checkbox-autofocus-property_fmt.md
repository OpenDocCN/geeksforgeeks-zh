...
> 原文：[https://www.geeksforgeeks.org/html-dom-input-checkbox-autofocus-property/](https://www.geeksforgeeks.org/html-dom-input-checkbox-autofocus-property/)
...
**示例 - 2：** 下面的 HTML 代码说明了如何设置复选框自动对焦属性。
...
**支持的浏览器：** DOM 输入复选框自动对焦属性支持的浏览器如下：
