...
> 原文: [https://www.geeksforgeeks.org/html-dom-wheelevent-deltamode-property/](https://www.geeksforgeeks.org/html-dom-wheelevent-deltamode-property/)
...
`DOM WheelEvent deltaMode` 属性支持的浏览器如下:
