...
> 原文: [https://www.geeksforgeeks.org/html-dom-style-fontstyle-property/](https://www.geeksforgeeks.org/html-dom-style-fontstyle-property/)
    ...
    <center>
        ...
        <script>
            function changeStyle() {
                document.getElementById("gfg").style.fontStyle = "italic";
            }
        </script>
        <p id="gfg">
            Geeks For Geeks
...
<body>
    <center>
        ...
        <script>
            function changeStyle() {
                document.getElementById("gfg").style.fontStyle = "oblique";
            }
        </script>
        <div id="gfg">
...
**支持的浏览器:** 以下列出了 *HTML | DOM Style fontStyle Property* 支持的浏览器:
