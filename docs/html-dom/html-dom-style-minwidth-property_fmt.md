# HTML DOM Style minWidth 属性

> 原文: [https://www.geeksforgeeks.org/html-dom-style-minwidth-property/](https://www.geeksforgeeks.org/html-dom-style-minwidth-property/)

`DOM Style minWidth` 属性用于**设置**或**返回**元素的最小宽度。它只适用于块级元素或具有绝对或固定位置的元素。
...
`HTML DOM Style minWidth` 属性支持的浏览器如下:
