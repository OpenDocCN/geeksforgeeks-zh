...
HTML DOM 中的 `borderRightStyle` 属性用于设置或返回元素右边框的样式。
...
<body>
    ...
    <!-- Script to uses DOM Style borderRightStyle Property -->
    <script>
...
**支持的浏览器:** 以下列出了 `DOM Style borderRightStyle` 属性支持的浏览器:
