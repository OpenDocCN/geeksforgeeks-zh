...
> 原文：[https://www.geeksforgeeks.org/html-dom-input-date-type-property/](https://www.geeksforgeeks.org/html-dom-input-date-type-property/)
...
返回一个字符串值，代表日期字段的表单元素类型。

下面的程序说明了日期类型属性：**返回日期字段的表单元素类型。**
