...
DOM 样式 `borderImageSource` 属性用于设置或返回要使用的图像，而不是边框样式属性给出的样式。
...
返回一个字符串值，代表元素的边框图像源属性。

## 属性值

### 1. `none`

This sets the property to use no image.
...
<head>
    ...
    <style>
        .item {
            ...
            /* Setting the border before demonstrate the effect of 'none' */
            border-image: url('https://media.geeksforgeeks.org/wp-content/uploads/border-img.png');
        }
    </style>
</head>
<body>
    ...
    <button onclick="changeSource()">Change source of border-image</button>
    <script>
...
This sets the image to the path specified.
...
<body>
    ...
    <script>
        function changeSource() {
            ...
            elem.style.borderImageSource = "url('https://media.geeksforgeeks.org/wp-content/uploads/border-img.png')";
        }
    </script>
</body>
</html>
...
<head>
    ...
    <style>
        .item {
            height: 50px;
            border: 25px solid transparent;
            /* Setting the border before to demonstrate the effect of 'initial' */
            border-image: url('https://media.geeksforgeeks.org/wp-content/uploads/border-img.png');
        }
    </style>
</head>
...
This is used to inherit the property from its parent.
...
<head>
    ...
    <style>
        ...
        #parent {
            /* Setting the border of parent demonstrate the effect of 'inherit' */
            border-image: url('https://media.geeksforgeeks.org/wp-content/uploads/border-img.png');
        }
    </style>
</head>
<body>
    ...
    <script>
        function changeSource() {
            elem = document.querySelector('.item');
            // Setting the border image source to inherit from its parent
