...
> 原文：[https://www.geeksforgeeks.org/html-dom-input-fileupload-autofocus-property/](https://www.geeksforgeeks.org/html-dom-input-fileupload-autofocus-property/)

HTML DOM 中的`输入文件上传自动对焦属性`用于**设置**或**返回**页面加载时文件上传按钮是否自动对焦。
