...
> 原文: [https://www.geeksforgeeks.org/html-dom-input-radio-required-property/](https://www.geeksforgeeks.org/html-dom-input-radio-required-property/)

HTML DOM 中的 DOM 输入单选必填属性用于设置或返回提交表单时是否勾选输入单选字段。此属性用于反映 HTML 必需的属性。
...
返回一个布尔值，表示在提交表单之前是否必须检查单选字段。

## 示例-1

本示例说明如何返回 Input Radio 必需属性。
