...
> 原文: [https://www.geeksforgeeks.org/html-dom-select-size-property/](https://www.geeksforgeeks.org/html-dom-select-size-property/)

**选择尺寸属性**用于**设置**或**返回**下拉列表的尺寸属性值。“选择大小”属性通常用于指定下拉列表中可见选项的数量。
