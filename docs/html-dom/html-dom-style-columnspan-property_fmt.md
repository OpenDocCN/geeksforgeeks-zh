...
> 原文: [https://www.geeksforgeeks.org/html-dom-style-columnspan-property/](https://www.geeksforgeeks.org/html-dom-style-columnspan-property/)
...
该属性返回一个字符串，代表元素的列跨度属性。

## 示例-1:

将 `columnSpan` 属性设置为 `"all"`。
    ...
    <center>
        ...
        <script>
            function geeks() {
                ...
                document.getElementById("h2tag").style.WebkitColumnSpan = "all";
...
以下是 *HTML | DOM Style columnSpan Property* 支持的浏览器:
