...
> 原文: [https://www.geeksforgeeks.org/html-dom-console-error-method/](https://www.geeksforgeeks.org/html-dom-console-error-method/)

HTML 中的 `console.error()` 方法用于在控制台上显示错误消息。`console.error()` 方法用于测试目的。错误信息作为参数发送到 `console.error()` 方法。
...
## 参数:
该方法接受单参数 `message`，该信息为强制信息，用于保存错误信息。
