...
> 原文: [https://www.geeksforgeeks.org/html-dom-input-password-minlength-property/](https://www.geeksforgeeks.org/html-dom-input-password-minlength-property/)

HTML DOM 输入密码最小长度属性用于设置或返回密码字段的最小长度属性的值。它指定元素中允许的最小字符数。
