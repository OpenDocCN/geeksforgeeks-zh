...
`DOM 细节对象`用于表示 HTML [`<细节>`](https://www.geeksforgeeks.org/html5-details-tag/) 元素。细节元素由`getElementById()`访问。

**属性:**

*   `open`: 细节标签有一个名为`open`的属性，默认用于显示隐藏信息。
...
可以使用`document.createElement()`方法创建细节对象。
