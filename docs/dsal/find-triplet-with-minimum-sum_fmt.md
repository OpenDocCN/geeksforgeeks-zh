...
> 原文：[https://www.geeksforgeeks.org/find-triplet-with-minimum-sum/](https://www.geeksforgeeks.org/find-triplet-with-minimum-sum/)
...
想法是生成数组中所有可能的三元组，然后将一个三元组的和与其他三元组进行比较，然后找到最小和。
以下是上述办法的实施情况：
