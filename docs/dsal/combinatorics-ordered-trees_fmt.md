...
加泰罗尼亚数字 | [二项式系数](https://www.geeksforgeeks.org/dynamic-programming-set-9-binomial-coefficient/)。

## 标记有序树

标记树是指每个顶点被赋予从 1 到 n 的唯一数字的树。
...
未标记树是每个顶点都没有标记的树。下面给出了可能的具有 3 个顶点的无标签有序树。
