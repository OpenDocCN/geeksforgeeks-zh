...
> 原文：[https://www.geeksforgeeks.org/sort-matrix-in-alternating-ascending-and-descending-order-rowwise/](https://www.geeksforgeeks.org/sort-matrix-in-alternating-ascending-and-descending-order-rowwise/)
...
**解决方法**
为了解决上面提到的问题，我们迭代 `0` 到 `N`，检查第 `i` 行是偶数还是奇数，如果是偶数，那么我们按升序对该行进行排序，否则按降序对第 `i` 行进行排序。`N` 次迭代后返回矩阵。
