...
> 原文：[https://www.geeksforgeeks.org/largest-sphere-that-can-be-inscribed-inside-a-cube/](https://www.geeksforgeeks.org/largest-sphere-that-can-be-inscribed-inside-a-cube/)
...
从 2d 图中可以清楚地看到，`2r = a`，其中，`a` = 立方体的边，`r` = 球体的半径。所以 `r = a/2`。
