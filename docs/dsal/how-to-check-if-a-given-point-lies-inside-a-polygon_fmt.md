...
> 原文：`https://www.geeksforgeeks.org/how-to-check-if-a-given-point-lies-inside-a-polygon/`
...
1.  从每个点向右画一条水平线并将其延伸到无穷远。
2.  计算该线与多边形边相交的次数。
3.  如果相交次数为奇数，或者点位于多边形的一条边上，则该点在多边形内部。如果以上条件都不满足，则点在多边形外部。
