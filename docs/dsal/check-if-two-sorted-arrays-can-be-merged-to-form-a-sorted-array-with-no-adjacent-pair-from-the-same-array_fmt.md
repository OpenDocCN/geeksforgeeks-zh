...
> 原文: [https://www.geeksforgeeks.org/check-if-two-sorted-arrays-can-be-merged-to-form-a-sorted-array-with-no-adjacent-pair-from-the-same-array/](https://www.geeksforgeeks.org/check-if-two-sorted-arrays-can-be-merged-to-form-a-sorted-array-with-no-adjacent-pair-from-the-same-array/)
...
*   初始化一个变量，说 `flag = true` 检查是否有可能通过合并给定的两个排序数组来形成一个新的[排序数组](https://www.geeksforgeeks.org/program-check-array-sorted-not-iterative-recursive/)，使得没有两个连续的元素来自同一个数组。
