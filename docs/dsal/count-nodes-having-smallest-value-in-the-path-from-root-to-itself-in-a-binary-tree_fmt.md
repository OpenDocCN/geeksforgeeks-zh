...
> 原文：[https://www.geeksforgeeks.org/count-nodes-having-smallest-value-in-the-path-from-root-to-itself-in-a-binary-tree/](https://www.geeksforgeeks.org/count-nodes-having-smallest-value-in-the-path-from-root-to-itself-in-a-binary-tree/)
...
想法是在给定的二叉树上进行[前序遍历](https://www.geeksforgeeks.org/tree-traversals-inorder-preorder-and-postorder/)。按照以下步骤解决问题：
