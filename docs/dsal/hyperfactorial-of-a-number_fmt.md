...
由于数字的超阶乘可能很大，因此数字会溢出。我们可以用 C++中的 [`boost`](https://www.geeksforgeeks.org/advanced-c-boost-library/) 库或者 Java 中的[`big integer`](https://www.geeksforgeeks.org/biginteger-class-in-java/)来存储一个数 n 的超阶乘。
