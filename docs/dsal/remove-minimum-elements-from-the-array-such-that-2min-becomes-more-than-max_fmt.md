...
> 原文: [https://www.geeksforgeeks.org/remove-minimum-elements-from-the-array-such-that-2min-becomes-more-than-max/](https://www.geeksforgeeks.org/remove-minimum-elements-from-the-array-such-that-2min-becomes-more-than-max/)
...
> **输出:** `4`
> 移除 4 个元素(4，5，100，200)使 `2*min` 大于 `max`。
> **输入:** `arr[] = {4，7，5，6}`
> **输出:** `0`
