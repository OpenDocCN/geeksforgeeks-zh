...
> 原文: [https://www.geeksforgeeks.org/haversine-formula-to-find-distance-between-two-points-on-a-sphere/](https://www.geeksforgeeks.org/haversine-formula-to-find-distance-between-two-points-on-a-sphere/)
...
![\large haversine\Big(\frac{d}{r}\Big)=haversine(\Phi_2-\Phi_1)+ cos(\Phi_1)cos(\Phi_2)haversine(\lambda_2-\lambda_1)](img/f80ab05f601c8c4301c085f7d433d2ab.png "Rendered by QuickLaTeX.com")
...
伦敦大本钟(北纬 51.5007 度，西经 0.1246 度)与纽约自由女神像(北纬 40.6892 度，西经 74.0445 度)之间的距离为 5574.8 公里。这不是精确的测量，因为公式假设地球是一个完美的球体，而实际上它是一个扁球体。
