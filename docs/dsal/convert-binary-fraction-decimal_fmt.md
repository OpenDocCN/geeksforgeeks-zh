...
> 原文：[https://www.geeksforgeeks.org/convert-binary-fraction-decimal/](https://www.geeksforgeeks.org/convert-binary-fraction-decimal/)
...
[将十进制小数转换为二进制数。](https://www.geeksforgeeks.org/convert-decimal-fraction-binary-number/)
