...
> 原文: [https://www.geeksforgeeks.org/sequence-with-sum-k-and-minimum-sum-of-absolute-differences-between-consecutive-elements/](https://www.geeksforgeeks.org/sequence-with-sum-k-and-minimum-sum-of-absolute-differences-between-consecutive-elements/)
...
> **输入:** `N = 3`，`K = 56`
> **输出:** 1
> 序列为 `{19, 19, 18}`，所有连续元素的绝对差之和为 `|19–19| + |19–18| = 0 + 1 = 1`，这是最小可能。
>
> **输入:** `N = 12`，`K = 48`
> **输出:** 0
> 顺序为 `{4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4}`。
