...
> 原文: [https://www.geeksforgeeks.org/subarray-of-size-k-with-given-sum/](https://www.geeksforgeeks.org/subarray-of-size-k-with-given-sum/)
...
一个简单的解决方案是使用嵌套循环，在这里我们检查每个大小为 `k` 的子阵列。下面是上述方法的实现：
