...
> 原文: [https://www.geeksforgeeks.org/generate-a-bitonic-array-starting-with-n-and-adjacent-difference-of-k/](https://www.geeksforgeeks.org/generate-a-bitonic-array-starting-with-n-and-adjacent-difference-of-k/)
...
思路是用[递归](https://www.geeksforgeeks.org/recursion/)来解决这个问题。如问题所述，双离子阵列的第一个元素是 `N`。因此，将其追加到数组中并求解 `n`。下面是递归函数定义:
