...
> 原文: [https://www.geeksforgeeks.org/number-of-edges-in-mirror-image-of-complete-binary-tree/](https://www.geeksforgeeks.org/number-of-edges-in-mirror-image-of-complete-binary-tree/)

给定深度为 `H` 的完全二叉树。如果从这棵树的左右两边拍摄镜像，那么:
