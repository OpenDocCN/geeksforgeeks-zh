...
> 原文：[https://www.geeksforgeeks.org/interactive-problems-in-competitive-programming/](https://www.geeksforgeeks.org/interactive-problems-in-competitive-programming/)
...
我们也可以交互式地应用二分搜索法来寻找解决方案。与以前的方法相比，这种解决方案是高效的。
