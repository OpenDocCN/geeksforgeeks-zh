...
> 原文：[https://www.geeksforgeeks.org/find-the-player-who-is-the-last-to-remove-any-character-from-the-beginning-of-a-binary-string/](https://www.geeksforgeeks.org/find-the-player-who-is-the-last-to-remove-any-character-from-the-beginning-of-a-binary-string/)
...
想法是比较如果两个玩家都以最佳状态玩游戏，每个玩家可以移动的总次数。请遵循以下步骤：
