...
> 原文: [https://www.geeksforgeeks.org/find-n-th-element-from-sterns-diatomic-series/](https://www.geeksforgeeks.org/find-n-th-element-from-sterns-diatomic-series/)
...
我们用一个非常简单的动态规划概念来解决这个问题，这个概念用于寻找[斐波那契数](https://www.geeksforgeeks.org/program-for-nth-fibonacci-number/)。在保存了 `DP[0] = 0`、`DP[1] = 1` 的基本情况后，我们必须简单地从 `i = 2` 遍历到 `n`，并根据斯特恩双原子级数的解释定义计算 `DP[i]`。最后返回 `DP[n]` 的值。
