...
> 原文: [https://www.geeksforgeeks.org/javascript-math-ceil-function/](https://www.geeksforgeeks.org/javascript-math-ceil-function/)
...
该函数接受单个参数 `value`，是向上舍入法中要舍入到其最近整数的数字。

## 返回值

对作为参数传递给函数的数字进行舍入后，返回结果。
...
JavaScript `Math.ceil()` 函数支持的浏览器如下:
