...
> 原文: [https://www.geeksforgeeks.org/minimum-removals-to-make-array-sum-odd/](https://www.geeksforgeeks.org/minimum-removals-to-make-array-sum-odd/)
...
解决这个问题的思路是先回忆一下 `ODD`s 和 `EVEN`s 的以下性质:
