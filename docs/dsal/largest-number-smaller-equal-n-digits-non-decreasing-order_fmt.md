...
> 原文: [https://www.geeksforgeeks.org/largest-number-smaller-equal-n-digits-non-decreasing-order/](https://www.geeksforgeeks.org/largest-number-smaller-equal-n-digits-non-decreasing-order/)
...
**第四步:** 继续更新该索引，直到如第三步中所讨论的那样完全遍历该数组。
**第五步:** 将该索引右侧的所有数字设置为 `9`。
**第六步:** 打印数组，因为这是需要的数字。
