...
> 原文：[`https://www.geeksforgeeks.org/python3-program-to-find-if-there-is-a-subarray-with-0-sum/`](https://www.geeksforgeeks.org/python3-program-to-find-if-there-is-a-subarray-with-0-sum/)
