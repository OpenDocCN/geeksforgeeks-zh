...
> 原文: [https://www.geeksforgeeks.org/printing-longest-common-subsequence/](https://www.geeksforgeeks.org/printing-longest-common-subsequence/)
...
**3)** 从 `L[m][n]` 开始遍历 2D 阵。对每个单元格 `L[i][j]` 执行以下操作…..
**a)** 如果对应于 `L[i][j]` 的字符（在 `X` 和 `Y` 中）相同（或 `X[i-1] == Y[j-1]`），则包括该字符作为 LCS 的一部分。
...
| **one** | X | 0 | 0 | 0 | 0 | 0 | 1 | 1 |
| **Two** | M | 0 | **1** | 1 | 1 | 1 | 1 | 1 |
| **three** | J | 0 | 1 | 1 | **2** | 2 | 2 | 2 |
| **four** | Y | 0 | 1 | 1 | 2 | 2 | 2 | 2 |
| **five** | A | 0 | 1 | 1 | 2 | **3** | 3 | 3 |
| **six** | U | 0 | 1 | 1 | 2 | 3 | 3 | **4** |
| **seven** | Z | 0 | 1 | 2 | 2 | 3 | 3 | 4 |
