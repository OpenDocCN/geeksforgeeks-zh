...
> 原文: [https://www.geeksforgeeks.org/sum-squares-first-n-natural-numbers/](https://www.geeksforgeeks.org/sum-squares-first-n-natural-numbers/)
...
思路是运行一个从 1 到 `N` 的循环，对于每个 `i`，1 <= i <= n，找 i<sup>2</sup> 求和。
