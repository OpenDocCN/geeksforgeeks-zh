...
> 原文：[https://www.geeksforgeeks.org/program-to-find-value-of-1k-2k-3k-nk/](https://www.geeksforgeeks.org/program-to-find-value-of-1k-2k-3k-nk/)
...
> ∑(x<sup>4</sup>)= 1+16+81 = 98

## 进场

1.  想法是利用 [`pow()`](https://www.geeksforgeeks.org/power-function-cc/) 函数求 `x^K` 的值（其中 `x` 为 1 至 `N`）。
2.  所需的总和是上面计算的所有值的总和。
