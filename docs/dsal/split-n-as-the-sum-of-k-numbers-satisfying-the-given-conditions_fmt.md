...
> 原文: [https://www.geeksforgeeks.org/split-n-as-the-sum-of-k-numbers-satisfying-the-given-conditions/](https://www.geeksforgeeks.org/split-n-as-the-sum-of-k-numbers-satisfying-the-given-conditions/)
...
*   打印 `prod` 向量的前 `K-1` 个元素。
*   如果 `prod` 向量的前 `K-1` 个元素之和大于 `N`，则打印 `-1`。
