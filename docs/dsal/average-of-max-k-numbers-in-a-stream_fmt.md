...
> 原文: [https://www.geeksforgeeks.org/average-of-max-k-numbers-in-a-stream/](https://www.geeksforgeeks.org/average-of-max-k-numbers-in-a-stream/)
...
> 4.66666
> 5.333333
> 查询 1 后，`arr = {1，2，3，4，7}`和最大 K 的平均值(即`{3，4，7}`)为 4.666666。
...
[堆](https://www.geeksforgeeks.org/binary-heap/) (Min Heap)数据结构可以用来解决类似这样的问题，其中元素的插入和删除可以在`O(log n)`时间内执行。
