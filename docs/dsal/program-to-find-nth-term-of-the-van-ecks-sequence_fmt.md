...
> 原文: [https://www.geeksforgeeks.org/program-to-find-nth-term-of-the-van-ecks-sequence/](https://www.geeksforgeeks.org/program-to-find-nth-term-of-the-van-ecks-sequence/)

给定一个正整数 `N`，任务是打印`范埃克序列`的第`N`项。
...
**方法 2: 使用 lambda 函数**
不需要存储整个序列来获取`n`项的值。我们可以递归地构建直到第 n 项的系列，并使用[lambda 表达式](https://www.geeksforgeeks.org/lambda-expressions-java-8/)只找到第 n 个项的值。
...
**参考:**[https://codegolf.stackexchange.com/questions/186654/nth-term-of-van-eck-sequence](https://codegolf.stackexchange.com/questions/186654/nth-term-of-van-eck-sequence)