...
> 原文: [https://www.geeksforgeeks.org/check-if-the-square-of-a-number-is-divisible-by-k-or-not/](https://www.geeksforgeeks.org/check-if-the-square-of-a-number-is-divisible-by-k-or-not/)

给定两个整数 `X` 和 `K`，任务是找出 `X<sup>2</sup>` 是否能被 `K` 整除。这里 `K` 和 `X` 都可以位于【1，10<sup>18</sup>】的范围内。
