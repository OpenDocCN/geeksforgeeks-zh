...
> 原文: [https://www.geeksforgeeks.org/area-of-a-n-sided-regular-polygon-with-given-radius/](https://www.geeksforgeeks.org/area-of-a-n-sided-regular-polygon-with-given-radius/)

给定一个半径为 **R**（从中心到任意顶点的距离）的 **N** 边正多边形。任务是找到多边形的面积。
