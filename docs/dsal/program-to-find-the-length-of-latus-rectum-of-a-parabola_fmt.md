...
给定 `a`、`b` 和 `c`，即 `X^2`、`X` 的系数以及抛物线 `y = a*x^2 + b*x + c` 一般方程中的常数项，任务就是求抛物线的 [Latus 直肠的长度。](https://en.wikipedia.org/wiki/Parabola)
