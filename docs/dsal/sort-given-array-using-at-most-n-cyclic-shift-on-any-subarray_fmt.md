...
> 原文：[https://www.geeksforgeeks.org/sort-given-array-using-at-most-n-cyclic-shift-on-any-subarray/](https://www.geeksforgeeks.org/sort-given-array-using-at-most-n-cyclic-shift-on-any-subarray/)
...
> 然后考虑从**索引 = 3 到索引 = 4** 的段 `[1, 2, 3, 8, 5]`。旋转 1 个偏移量，新数组变成 `[1, 2, 3, 5, 8]`。
>
> **输入：** `arr[] = {2, 4, 1, 3}`
> **输出：** 2
> **解释：** 从**索引 = 0 到索引 = 2** 的段 `[2, 4, 1, 3]`。将此线段向左旋转 2 个偏移量，新数组变成 `[1, 2, 4, 3]`。
