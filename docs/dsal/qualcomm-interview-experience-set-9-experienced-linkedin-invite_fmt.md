...
4. [合并排序](https://practice.geeksforgeeks.org/problems/merge-sort/1) 和 [快速排序](https://practice.geeksforgeeks.org/problems/quick-sort/1)(代码和时序复杂度)
...
## 第 3 轮(30 分钟)
1. `malloc` vs `calloc`
2. 写一个 `python` 脚本，在文件中找到一个单词的出现。
3. 什么是时序复杂度符号？
4. 在二叉查找树创建和插入功能(`BST`)
5. 访问说明符示例
6. 1 年工作经验。`SAP BI` 中的步骤？
7. 谜题:用最少的移动次数将给定的形状变成另一个形状(火柴杆)
8. 困惑:一个人做的工作是前一天的两倍。它在 15 天内完成了全部工作，那么完成 50%的工作需要多少天？
