...
> 原文：[https://www.geeksforgeeks.org/find-the-sum-of-all-truncatable-primes-below-n/](https://www.geeksforgeeks.org/find-the-sum-of-all-truncatable-primes-below-n/)
...
一种有效的方法是使用厄拉多塞的[筛找出所有素数](https://www.geeksforgeeks.org/sieve-of-eratosthenes/)，并对 `N` 以下的每个数检查它是否是可截断素数。如果是，则加到运行总和中。
