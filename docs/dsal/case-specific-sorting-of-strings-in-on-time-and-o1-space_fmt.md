...
> 原文: [https://www.geeksforgeeks.org/case-specific-sorting-of-strings-in-on-time-and-o1-space/](https://www.geeksforgeeks.org/case-specific-sorting-of-strings-in-on-time-and-o1-space/)

给定一个由大写和小写字符组成的字符串 `str`。任务是分别对大写和小写字符进行排序，这样如果原始字符串中的第 `i` 个位置有一个大写字符，则排序后它不应该有一个小写字符，反之亦然。
