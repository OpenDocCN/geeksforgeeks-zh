...
> 原文:[https://www.geeksforgeeks.org/print-paths-root-specified-sum-binary-tree/](https://www.geeksforgeeks.org/print-paths-root-specified-sum-binary-tree/)
...
同样，由于树节点没有指向其父节点的指针，我们必须从我们移动的地方显式保存。我们使用向量 `path` 来存储该路径。
