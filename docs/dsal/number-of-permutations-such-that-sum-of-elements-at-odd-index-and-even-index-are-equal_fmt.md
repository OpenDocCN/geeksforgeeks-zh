...
> 原文：[https://www.geeksforgeeks.org/number-of-permutations-such-that-sum-of-elements-at-odd-index-and-even-index-are-equal/](https://www.geeksforgeeks.org/number-of-permutations-such-that-sum-of-elements-at-odd-index-and-even-index-are-equal/)
...
解决这个问题的`方法`是在 C++ STL 中使用[`next_permutation()`](https://www.geeksforgeeks.org/stdnext_permutation-prev_permutation-c/)，这有助于生成 `N` 个数字的所有可能的置换。如果奇数索引元素的总和等于生成的置换的偶数索引元素的总和，则增加计数。检查所有排列后，打印计数。
