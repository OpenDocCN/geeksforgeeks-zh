...
> 原文：[https://www.geeksforgeeks.org/java-program-for-selecting-a-random-node-from-a-singly-linked-list/](https://www.geeksforgeeks.org/java-program-for-selecting-a-random-node-from-a-singly-linked-list/)
...
想法是用[水库采样](https://www.geeksforgeeks.org/reservoir-sampling/)。以下是步骤。这是[水库取样](https://www.geeksforgeeks.org/reservoir-sampling/)的一个更简单的版本，因为我们只需要选择一个键，而不是 `k` 键。
