...
> 原文: [https://www.geeksforgeeks.org/possible-strings-length-can-formed-given-string/](https://www.geeksforgeeks.org/possible-strings-length-can-formed-given-string/)
...
下面是 C++实现。它使用 C++中的 [`next_permutation` 函数](https://www.geeksforgeeks.org/find-the-next-lexicographically-greater-word-than-a-given-word/)。
