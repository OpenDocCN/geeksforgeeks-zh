...
> 原文: [https://www.geeksforgeeks.org/count-number-of-ways-to-arrange-first-n-numbers/](https://www.geeksforgeeks.org/count-number-of-ways-to-arrange-first-n-numbers/)
...
> **输入:** `N = 4`
> **输出:** `4`
> 唯一可能的排列是 `(1, 2, 3, 4)`，`(1, 2, 4, 3)`，`(1, 3, 4, 2)` 和 `(1, 3, 2, 4)`。
>
> **输入:** `N = 6`
> **输出:** `9`
