...
> 原文：[https://www.geeksforgeeks.org/generic-implementation-of-quicksort-algorithm-in-c/](https://www.geeksforgeeks.org/generic-implementation-of-quicksort-algorithm-in-c/)

## 简介

编写一个函数来实现[快速排序](https://www.geeksforgeeks.org/quick-sort/)算法，该算法将适用于所有类型的数据，即整型、浮点型、字符型等。它应该接受所有类型的数据，并将排序后的数据显示为输出。
