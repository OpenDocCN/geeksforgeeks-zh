...
> 原文: [https://www.geeksforgeeks.org/find-the-most-valued-alphabet-in-the-string/](https://www.geeksforgeeks.org/find-the-most-valued-alphabet-in-the-string/)
...
**方法:** 想法是将每个字母的第一次和最后一次出现存储在两个辅助数组中，比如 `first[]` 和 `last[]`。现在，这两个数组可以用来找到给定字符串中的最大值字母表。
以下是上述方法的实现:
