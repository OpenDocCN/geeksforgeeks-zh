...
> 原文: [https://www.geeksforgeeks.org/construct-a-matrix-such-that-each-cell-consists-of-sum-of-adjacent-elements-of-respective-cells-in-given-matrix/](https://www.geeksforgeeks.org/construct-a-matrix-such-that-each-cell-consists-of-sum-of-adjacent-elements-of-respective-cells-in-given-matrix/)
...
思路是遍历给定矩阵的每个像元，对于每个像元 `(r，c)`，存储相邻像元的和 `{{r-1，c-1}，{r+1，c+1}，{r-1，c+1}，{r+1，c-1}，{r，c-1}，{r，c-1 }，{r-1，c}，{r+1，c}，{r，c+1}}` 如果可能。
