...
> 原文: [https://www.geeksforgeeks.org/largest-k-digit-number-divisible-by-all-numbers-in-given-array/](https://www.geeksforgeeks.org/largest-k-digit-number-divisible-by-all-numbers-in-given-array/)
...
**方法:** 解决方案基于类似于寻找[最大 K 位数可被 X 整除](https://www.geeksforgeeks.org/largest-k-digit-number-divisible-x/)的思路。遵循下面提到的步骤。

*   找到数组 `arr[]` 的所有数字的 **LCM**
*   使用以下公式找出具有 K 个数字的 LCM 的最大倍数:
    `LCM(arr) * floor((10^K - 1) / LCM(arr))`
