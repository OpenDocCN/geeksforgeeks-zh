...
> 原文: [https://www.geeksforgeeks.org/check-if-any-large-number-is-divisible-by-19-or-not/](https://www.geeksforgeeks.org/check-if-any-large-number-is-divisible-by-19-or-not/)
...
换句话说，要检查一个 3 位数是否能被 19 整除，我们只需去掉最后一位数字，乘以 2，再加到剩下的两位数上即可。
