# Streamoid Technologies 面试体验 | 第 1 集 (针对新生)

> 原文: [https://www.geeksforgeeks.org/streamoid-technologies-interview-experience-set-1-for-freshers/](https://www.geeksforgeeks.org/streamoid-technologies-interview-experience-set-1-for-freshers/)
...
2. [https://www.geeksforgeeks.org/find-the-smallest-window-in-a-string-containing-all-characters-of-another-string/](https://www.geeksforgeeks.org/find-the-smallest-window-in-a-string-containing-all-characters-of-another-string/)
3. 打印给定范围之间的质数。
...
## 第 1 回合 (6 人被列入射击名单::持续时间 2 小时)
1. 给你一个整数数组和四个运算符 `+`，`*`，`(`，`)`，使用这四个运算符，你必须找到你能得到的最大和。例子: 数组元素是 `{1，2，3}` 让我们研究两种情况 `1*2*3` 和 `(1+2)*3`，所以第二个给出 9，第一个给出 6，所以答案应该是 9。
...
2. [https://www.geeksforgeeks.org/given-sorted-dictionary-find-precedence-characters/](https://www.geeksforgeeks.org/given-sorted-dictionary-find-precedence-characters/)
