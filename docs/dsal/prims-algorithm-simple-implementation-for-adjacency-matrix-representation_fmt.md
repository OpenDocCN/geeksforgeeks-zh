...
我们讨论了图的邻接矩阵表示的 [Prim 算法及其实现](https://www.geeksforgeeks.org/prims-minimum-spanning-tree-mst-greedy-algo-5/)。如前一篇文章所述，在 [Prim 的算法](https://www.geeksforgeeks.org/prims-minimum-spanning-tree-mst-greedy-algo-5/)中，维护了两个集合，一个集合包含已经包含在 MST 中的顶点列表，另一个集合包含尚未包含的顶点。在每次迭代中，我们考虑连接两个集合的边中的最小权重边。
