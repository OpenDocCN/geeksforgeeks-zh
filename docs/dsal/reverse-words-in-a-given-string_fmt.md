...
> 原文：[https://www.geeksforgeeks.org/reverse-words-in-a-given-string/](https://www.geeksforgeeks.org/reverse-words-in-a-given-string/)
...
遍历字符串，镜像字符串中的每个单词，然后，在最后，镜像整个字符串。
