...
> 原文：[https://www.geeksforgeeks.org/javascript-program-for-reversing-a-linked-list-in-groups-of-given-size-set-1/](https://www.geeksforgeeks.org/javascript-program-for-reversing-a-linked-list-in-groups-of-given-size-set-1/)
...
**算法：** [`reverse(head, k)`](https://www.geeksforgeeks.org/reverse-a-linked-list/)

*   反转大小为 `k` 的第一个子列表。反转时，跟踪下一个节点和上一个节点。让指向下一个节点的指针为 `next`，指向上一个节点的指针为 `prev`。反向链表见[本帖](https://www.geeksforgeeks.org/reverse-a-linked-list/)。
