...
> 原文: [https://www.geeksforgeeks.org/construct-a-bst-from-given-postorder-traversal-using-stack/](https://www.geeksforgeeks.org/construct-a-bst-from-given-postorder-traversal-using-stack/)
...
2. 如果给定的遍历是 `{2, 6, 4, 9, 13, 11, 7}`，那么应该构造下面的树并返回树的根。
...
让我们先看看[后序遍历](https://www.geeksforgeeks.org/tree-traversals-inorder-preorder-and-postorder/)的工作原理。
...
*   开始反向遍历数组，如果下一个元素 > 堆栈顶部的元素，则将该元素设置为堆栈顶部元素的右子元素，并将其推入堆栈。
*   否则，如果下一个元素 < 堆栈顶部的元素，则开始弹出堆栈中的所有元素，直到堆栈为空或者当前元素变成 > 堆栈顶部的元素。
