...
> 原文: [https://www.geeksforgeeks.org/check-if-all-the-palindromic-sub-strings-are-of-odd-length/](https://www.geeksforgeeks.org/check-if-all-the-palindromic-sub-strings-are-of-odd-length/)
