...
> 原文: [https://www.geeksforgeeks.org/recursive-program-to-print-extreme-nodes-of-each-level-of-binary-tree-in-alternate-order/](https://www.geeksforgeeks.org/recursive-program-to-print-extreme-nodes-of-each-level-of-binary-tree-in-alternate-order/)
...
想法是以螺旋形式执行[级顺序遍历](https://www.geeksforgeeks.org/level-order-traversal-in-spiral-form/)，在每一级打印遍历过程中的第一个节点，这些节点将是交替形式中出现的极端拐角处的节点。
