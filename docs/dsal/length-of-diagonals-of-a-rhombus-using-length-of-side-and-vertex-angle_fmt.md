...
> 原文: [https://www.geeksforgeeks.org/length-of-diagonals-of-a-rhombus-using-length-of-side-and-vertex-angle/](https://www.geeksforgeeks.org/length-of-diagonals-of-a-rhombus-using-length-of-side-and-vertex-angle/)
...
这个问题可以用[余弦定律](https://en.wikipedia.org/wiki/Law_of_cosines)来解决。使用由菱形的对角线和边形成的三角形上的余弦定律给出以下关系来计算对角线的长度:
