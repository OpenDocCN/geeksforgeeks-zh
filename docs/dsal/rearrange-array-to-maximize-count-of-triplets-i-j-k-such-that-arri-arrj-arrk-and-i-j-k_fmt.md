...
> 原文: [https://www.geeksforgeeks.org/rearrange-array-to-maximize-count-of-triplets-i-j-k-such-that-arri-arrj-arrk-and-i-j-k/](https://www.geeksforgeeks.org/rearrange-array-to-maximize-count-of-triplets-i-j-k-such-that-arri-arrj-arrk-and-i-j-k/)
...
解决问题最简单的方法是[生成数组的所有可能排列](https://www.geeksforgeeks.org/iterative-approach-to-print-all-permutations-of-an-array/)并计算满足给定条件的三元组的数量。最后，打印三元组的计数和给定数组的排列，该数组包含给定条件下三元组的最大计数。
...
对上述方法进行优化，思路是首先[对给定数组](https://www.geeksforgeeks.org/sorting-algorithms/)进行排序，将给定数组的前半部分放在临时数组的奇数索引处，后半部分放在偶数索引处。最后，打印给定条件下的临时数组和三元组数。按照以下步骤解决问题:
