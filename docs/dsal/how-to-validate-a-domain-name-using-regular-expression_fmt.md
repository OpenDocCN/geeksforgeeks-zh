...
> 原文: [https://www.geeksforgeeks.org/how-to-validate-a-domain-name-using-regular-expression/](https://www.geeksforgeeks.org/how-to-validate-a-domain-name-using-regular-expression/)
...
5.  域名可以是一个子域(例如 `contribute.geeksforgeeks.org`)。
