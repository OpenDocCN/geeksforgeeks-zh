...
> 原文: [https://www.geeksforgeeks.org/printing-the-triangle-pattern-using-last-term-n/](https://www.geeksforgeeks.org/printing-the-triangle-pattern-using-last-term-n/)
...
*   从给定的最后一项 `n` 中找出完整的行数
    ...
    *   因此，[数列 1、3、6、10、15 的第 n 项，……](https://www.geeksforgeeks.org/find-nth-term-series-136101521/) `A(n)= 1+2+3+4……+(n–1)+n = n(n+1)/2`
        即 `A(n)` 是前 `n` 个自然数之和。
    *   所以在
