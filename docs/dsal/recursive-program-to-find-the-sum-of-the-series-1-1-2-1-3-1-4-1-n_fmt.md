...
> 原文: [https://www.geeksforgeeks.org/recursive-program-to-find-the-sum-of-the-series-1-1-2-1-3-1-4-1-n/](https://www.geeksforgeeks.org/recursive-program-to-find-the-sum-of-the-series-1-1-2-1-3-1-4-1-n/)
...
思路是形成递归案例和基本案例，以便使用递归解决这个问题。因此:
