...
> 原文: [https://www.geeksforgeeks.org/check-if-there-exists-a-permutation-of-given-string-which-doesnt-contain-any-monotonous-substring/](https://www.geeksforgeeks.org/check-if-there-exists-a-permutation-of-given-string-which-doesnt-contain-any-monotonous-substring/)

给定一个由小写英文字母组成的字符串 `S`，任务是检查字符串 `S` 的排列是否不包含任何单调的子串。
