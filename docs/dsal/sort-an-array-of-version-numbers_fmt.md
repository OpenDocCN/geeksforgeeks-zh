...
> 原文：[https://www.geeksforgeeks.org/sort-an-array-of-version-numbers/](https://www.geeksforgeeks.org/sort-an-array-of-version-numbers/)
...
*   为了比较两个点分隔的字符串 `S1` 和 `S2`，迭代至长度 `min(S1, S2) + 1`，并比较字符串的每个数字部分并进行相应排序。
*   对每一对字符串重复上述步骤，并相应地对数组进行排序。
