...
> 原文: [https://www.geeksforgeeks.org/program-to-print-the-given-digit-in-words/](https://www.geeksforgeeks.org/program-to-print-the-given-digit-in-words/)
...
**方法:** 思路是遍历数字的每个位，使用开关盒。由于数字只有十个可能的值，因此在一个开关块中可以定义十种情况。对于每个数字，将执行其对应的大小写块，并将该数字打印成文字。
