...
给定一个大小为 `N` 的整数[数组](https://www.geeksforgeeks.org/introduction-to-arrays/) `arr[]`，任务是找到数组的所有[子数组的乘积](https://www.geeksforgeeks.org/generating-subarrays-using-recursion/)。
