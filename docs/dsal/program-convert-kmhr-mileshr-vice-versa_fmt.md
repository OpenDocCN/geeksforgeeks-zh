...
> 原文：[https://www.geeksforgeeks.org/program-convert-kmhr-mileshr-vice-versa/](https://www.geeksforgeeks.org/program-convert-kmhr-mileshr-vice-versa/)

给定以公里/小时为单位的速度，将其转换为英里/小时，英里/小时转换为公里/小时。
