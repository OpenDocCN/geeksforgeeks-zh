...
> 原文: [https://www.geeksforgeeks.org/check-whether-bitwise-and-of-n-numbers-is-even-or-odd/](https://www.geeksforgeeks.org/check-whether-bitwise-and-of-n-numbers-is-even-or-odd/)
...
一个简单的解决方法是首先找到给定 `N` 个数的 `AND`，然后检查这个 `AND` 是偶数还是奇数。
一个更好的解决方案是基于比特操作和数学事实。
