...
> 原文: [https://www.geeksforgeeks.org/sum-of-all-the-prime-numbers-with-the-maximum-position-of-set-bit-d/](https://www.geeksforgeeks.org/sum-of-all-the-prime-numbers-with-the-maximum-position-of-set-bit-d/)
...
**方法：** 满足给定条件的最大数为 `2^D – 1`。因此，使用[厄拉多塞的筛](https://www.geeksforgeeks.org/sieve-of-eratosthenes/)生成所有质数直到 `2^D – 1`，然后找到相同范围内所有质数的和。
