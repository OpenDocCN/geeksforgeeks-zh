...
*   按 `Ctrl+R` 键可生成新数组。
*   使用 `CountingSort()` 功能进行排序。

### 示例:

![排序前](img/6e11115d44c966762a50bf1767a127e4.png)

![排序后](img/c5577562f4bf8dd7e110ff389d4efb4a.png)
...
![输出](img/867ac02c0079a94eb792bbe4763e47dc.png)