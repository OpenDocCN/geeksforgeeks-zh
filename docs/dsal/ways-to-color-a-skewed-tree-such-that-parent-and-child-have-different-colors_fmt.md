...
> 原文: [https://www.geeksforgeeks.org/ways-to-color-a-skewed-tree-such-that-parent-and-child-have-different-colors/](https://www.geeksforgeeks.org/ways-to-color-a-skewed-tree-such-that-parent-and-child-have-different-colors/)
...
我们可以利用时间复杂度为 `O(N)` 的正态幂函数来寻找答案。但是为了获得更好的时间复杂度，我们使用了取 `O(log N)` 时间复杂度的快速指数函数。
