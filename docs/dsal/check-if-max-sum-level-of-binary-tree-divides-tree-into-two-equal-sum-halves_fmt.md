...
> 原文: [https://www.geeksforgeeks.org/check-if-max-sum-level-of-binary-tree-divides-tree-into-two-equal-sum-halves/](https://www.geeksforgeeks.org/check-if-max-sum-level-of-binary-tree-divides-tree-into-two-equal-sum-halves/)
