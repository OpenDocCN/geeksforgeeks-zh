...
> 原文：[https://www.geeksforgeeks.org/jagged-array-or-array-of-arrays-in-c-with-examples/](https://www.geeksforgeeks.org/jagged-array-or-array-of-arrays-in-c-with-examples/)

## 先决条件
[C 中的数组](https://www.geeksforgeeks.org/arrays-in-c-cpp/)

## 交错数组
交错数组是[数组](https://www.geeksforgeeks.org/arrays-in-c-cpp/)的[数组](https://www.geeksforgeeks.org/arrays-in-c-cpp/)，这样成员数组可以有不同的大小，也就是说，我们可以创建一个二维数组，但是每行的列数是可变的。这些类型的数组也称为交错数组。
...
[![](img/9cce46f7917c4f4d20330d7a8b70a4b6.png)](https://media.geeksforgeeks.org/wp-content/uploads/20200313134104/Jagged-Array.jpg)
