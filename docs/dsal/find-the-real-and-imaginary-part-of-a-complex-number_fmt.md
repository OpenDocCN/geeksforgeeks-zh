...
> 原文：[https://www.geeksforgeeks.org/find-the-real-and-imaginary-part-of-a-complex-number/](https://www.geeksforgeeks.org/find-the-real-and-imaginary-part-of-a-complex-number/)
...
一个复数可以表示为 `Z = x + yi`，其中 `x` 为实部，`y` 为虚部。
我们将按照以下步骤分离出实部和虚部：
