...
> 原文: [https://www.geeksforgeeks.org/generate-an-n-length-array-having-sum-of-each-subarray-divisible-by-k/](https://www.geeksforgeeks.org/generate-an-n-length-array-having-sum-of-each-subarray-divisible-by-k/)
...
2.  因此，迭代一个从 `i = 1` 到 `i = N` 的循环，对于 `i` 的每个值，打印 `K * i`。
