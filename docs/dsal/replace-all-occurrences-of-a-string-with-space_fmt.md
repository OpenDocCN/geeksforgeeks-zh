...
> 原文: [https://www.geeksforgeeks.org/replace-all-occurrences-of-a-string-with-space/](https://www.geeksforgeeks.org/replace-all-occurrences-of-a-string-with-space/)
...
> **输出:** I AM COOL
> 通过用空格替换 `str` 中所有出现的 `sub`，我们提取秘密消息为 "I AM COOL"。
