...
> 原文: [https://www.geeksforgeeks.org/convert-number-negative-base-representation/](https://www.geeksforgeeks.org/convert-number-negative-base-representation/)

给我们一个数字 `n` 和一个负基数 `negBase`，我们需要在那个负基数上表示 `n`。负基数的作用类似于正基数。例如，在基数为 2 的情况下，我们将比特乘以 1、2、4、8 等，得到十进制的实际数字。在基数为 2 的情况下，我们需要将位与 1、-2、4、-8 等相乘，以得到十进制数。
