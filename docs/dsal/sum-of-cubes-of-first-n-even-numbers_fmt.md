...
> 原文：[https://www.geeksforgeeks.org/sum-of-cubes-of-first-n-even-numbers/](https://www.geeksforgeeks.org/sum-of-cubes-of-first-n-even-numbers/)
...
We know that sum of cubes of first n natural numbers is = n^2 * (n+1)^2 / 4
