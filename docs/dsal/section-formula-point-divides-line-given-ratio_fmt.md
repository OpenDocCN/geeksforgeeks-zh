...
> 原文：[https://www.geeksforgeeks.org/section-formula-point-divides-line-given-ratio/](https://www.geeksforgeeks.org/section-formula-point-divides-line-given-ratio/)

给定两个坐标`(x1, y1)`和`(x2, y2)`以及`m`和`n`，求以`m : n`的比例划分连接线`(x1, y1)`和`(x2, y2)`的坐标。
...
**参考文献：**
[http://doubleroot.in/lessons/coordinate-geometry-basics/section-formula/#.WjYXQvbhU8o](http://doubleroot.in/lessons/coordinate-geometry-basics/section-formula/#.WjYXQvbhU8o)