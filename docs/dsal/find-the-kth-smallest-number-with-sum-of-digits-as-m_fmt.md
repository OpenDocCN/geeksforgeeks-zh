...
> 原文：[https://www.geeksforgeeks.org/find-the-kth-smallest-number-with-sum-of-digits-as-m/](https://www.geeksforgeeks.org/find-the-kth-smallest-number-with-sum-of-digits-as-m/)
...
为了找到最小的 `kth`，我们需要对序列进行排序，所以如果我们将数字存储在 C++ 中的[集合中会更好，因为集合中的数字是按排序顺序排列的。](https://www.geeksforgeeks.org/set-in-cpp-stl/)
