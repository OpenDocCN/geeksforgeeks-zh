...
> 原文：[https://www.geeksforgeeks.org/a-program-to-check-if-a-binary-tree-is-bst-or-not/](https://www.geeksforgeeks.org/a-program-to-check-if-a-binary-tree-is-bst-or-not/)
...
2) 该方法假设树中没有重复值。
3) 检查 `temp` 数组是否按升序排序，如果是，则树为 BST。
