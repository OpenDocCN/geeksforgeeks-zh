...
> 原文: [https://www.geeksforgeeks.org/possible-words-using-given-characters-python/](https://www.geeksforgeeks.org/possible-words-using-given-characters-python/)
...
1.  使用`collections`模块的`Counter(input)`方法，逐个遍历给定字符串列表，并将其转换为字典。
