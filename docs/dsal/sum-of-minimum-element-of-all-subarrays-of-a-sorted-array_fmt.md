...
> 原文: [https://www.geeksforgeeks.org/sum-of-minimum-element-of-all-subarrays-of-a-sorted-array/](https://www.geeksforgeeks.org/sum-of-minimum-element-of-all-subarrays-of-a-sorted-array/)

给定一个排序数组`A`，它由`n`个整数组成。任务是求`A`所有可能子阵的最小值之和。
