...
> 原文: [https://www.geeksforgeeks.org/check-if-all-enemies-are-killed-with-bombs-placed-in-a-matrix/](https://www.geeksforgeeks.org/check-if-all-enemies-are-killed-with-bombs-placed-in-a-matrix/)
...
3.  如果所有敌人都被当前炸弹杀死，打印 `Yes`，否则打印 `No`。
...
5.  如果没有炸弹的行或列中有任何敌人，则打印 `No`，否则打印 `Yes`。
