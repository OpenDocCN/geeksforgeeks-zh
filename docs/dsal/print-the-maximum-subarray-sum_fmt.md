...
> 原文: [https://www.geeksforgeeks.org/print-the-maximum-subarray-sum/](https://www.geeksforgeeks.org/print-the-maximum-subarray-sum/)
...
> **输出:** `[6, -2, -3, 1, 5]`
> **解释:**
> 在上述输入中，最大连续子阵列和为 7，子阵列的元素为 `[6, -2, -3, 1, 5]`
...
**交替高效方法**: 该方法消除了上述方法中向左递减 `globalMax` 的内部 `while` 循环。因此这种方法减少了时间。
...
4.  现在打印 `[startIndex, endIndex]` 之间的子数组。
