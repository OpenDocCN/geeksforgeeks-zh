...
> 原文: [https://www.geeksforgeeks.org/find-the-number-of-binary-strings-of-length-n-with-at-least-3-consecutive-1s/](https://www.geeksforgeeks.org/find-the-number-of-binary-strings-of-length-n-with-at-least-3-consecutive-1s/)
...
**高效方法:** 我们使用[动态规划](https://www.geeksforgeeks.org/dynamic-programming/)来计算字符串的数量。
...
**基础条件:** `dp(i, 3) = 2^i`。因为一旦你有 3 个连续的 1，你就不在乎字符串的 1, 2…i 位置有什么字符，因为所有的字符串都是有效的。
