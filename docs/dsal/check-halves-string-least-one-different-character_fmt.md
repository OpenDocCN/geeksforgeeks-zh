...
> 原文: [https://www.geeksforgeeks.org/check-halves-string-least-one-different-character/](https://www.geeksforgeeks.org/check-halves-string-least-one-different-character/)
