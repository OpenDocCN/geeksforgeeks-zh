...
> 原文:[https://www . geeksforgeeks . org/find-最大-range-lr-其和可被 m 整除/](https://www.geeksforgeeks.org/find-the-maximum-range-lr-whose-sum-is-divisible-by-m/)
...
天真的方法是，我们可以迭代数组中所有可能的 `L` 和 `R`，检查和是否可分。如果是，则存储数组的长度。

## 高效方法

这里的想法是使用一个[前缀和数组](https://www.geeksforgeeks.org/prefix-sum-array-implementation-applications-competitive-programming/)。
