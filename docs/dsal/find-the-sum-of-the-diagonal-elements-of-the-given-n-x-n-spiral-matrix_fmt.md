...
> 原文：[https://www.geeksforgeeks.org/find-the-sum-of-the-diagonal-elements-of-the-given-n-x-n-spiral-matrix/](https://www.geeksforgeeks.org/find-the-sum-of-the-diagonal-elements-of-the-given-n-x-n-spiral-matrix/)
...
解决方案背后的思想是使用[递归](https://www.geeksforgeeks.org/recursion/)来计算对角线元素的和。
...
解决方案背后的思路是使用[动态规划](https://www.geeksforgeeks.org/dynamic-programming/)的概念。我们将使用数组 `dp[]` 来存储我们的解决方案。问题中给出的 `n` 可以是偶数，也可以是奇数。
