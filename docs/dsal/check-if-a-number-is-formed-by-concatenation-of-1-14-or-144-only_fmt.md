...
> 原文: [https://www.geeksforgeeks.org/check-if-a-number-is-formed-by-concatenation-of-1-14-or-144-only/](https://www.geeksforgeeks.org/check-if-a-number-is-formed-by-concatenation-of-1-14-or-144-only/)

给定一个数字`N`。任务是检查数字是否是由数字 1、14 和 144 以任意顺序串联起来的。
如有可能，打印`YES`否则打印`NO`。
