...
> 原文：[https://www.geeksforgeeks.org/program-to-print-sum-triangle-for-a-given-array/](https://www.geeksforgeeks.org/program-to-print-sum-triangle-for-a-given-array/)

给定一个数组，编写一个程序构造一个三角形，其中最后一行包含给定数组的元素，第二倒数一行的每个元素包含下面两个元素的和，以此类推。
