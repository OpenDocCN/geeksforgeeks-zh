...
> 原文: [https://www.geeksforgeeks.org/arrange-n-elements-in-circular-fashion-such-that-all-elements-are-strictly-less-than-sum-of-adjacent-elements/](https://www.geeksforgeeks.org/arrange-n-elements-in-circular-fashion-such-that-all-elements-are-strictly-less-than-sum-of-adjacent-elements/)

给定一个由 `N` 个整数组成的数组，任务是以一种**圆形**排列方式排列它们，使得元素严格小于其相邻元素的和。如果这样的安排是不可能的，那么打印 `-1`。
