...
> 原文: [https://www.geeksforgeeks.org/split-a-string-in-equal-parts-such-that-all-parts-are-palindromes/](https://www.geeksforgeeks.org/split-a-string-in-equal-parts-such-that-all-parts-are-palindromes/)
...
> **输入:** `str = "civicbob"`
> **输出:** 8
> “b”“b”“c”“c”“i”“i”“v”“o”为所需分区。“civic”和“bob”也是回文，但它们的长度不相等。
> **输入:** `str = "noonpeep"`
> **输出:** 1

**进场:**

*   统计出现的奇数字符数，并存储在 `countOdd` 中。
*   将所有偶出现字符的频率相加并存储在 `sumEven` 中。
