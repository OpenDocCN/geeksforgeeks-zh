...
> 原文: [https://www.geeksforgeeks.org/check-if-the-given-binary-tree-have-a-subtree-with-equal-no-of-1s-and-0s/](https://www.geeksforgeeks.org/check-if-the-given-binary-tree-have-a-subtree-with-equal-no-of-1s-and-0s/)
...
想法是将树的数据 0 更改为 -1。这样就很容易找到 0 和 1 数量相等的子树。将所有 0 转换为 -1 后，创建一个和树。创建求和树后，每个节点将包含位于其下的所有节点的和。
