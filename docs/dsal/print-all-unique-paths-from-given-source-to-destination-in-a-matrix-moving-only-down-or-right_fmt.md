...
> 原文: [https://www.geeksforgeeks.org/print-all-unique-paths-from-given-source-to-destination-in-a-matrix-moving-only-down-or-right/](https://www.geeksforgeeks.org/print-all-unique-paths-from-given-source-to-destination-in-a-matrix-moving-only-down-or-right/)
...
**方法:** 使用[递归](http://www.geeksforgeeks.org/recursion/)从源开始，从矩阵路径 `mat[][]` 中的每个单元格先右后下移动，并将每个值存储在一个向量中。如果到达目的地，打印矢量作为可能的路径之一。按照以下步骤解决问题:
