...
> 原文: [https://www.geeksforgeeks.org/program-to-print-product-of-even-and-odd-indexed-elements-in-an-array/](https://www.geeksforgeeks.org/program-to-print-product-of-even-and-odd-indexed-elements-in-an-array/)
...
遍历数组，保留两个变量`even`和`odd`分别存储元素乘积和奇偶索引。遍历时，检查当前索引是偶数还是奇数，即`(i%2)`是否为零。如果当前元素与偶数索引积相乘，则与奇数索引积相乘。
以下是上述方法的实施:
