...
> 原文: [https://www.geeksforgeeks.org/print-numbers-range-1-n-bits-alternate-pattern/](https://www.geeksforgeeks.org/print-numbers-range-1-n-bits-alternate-pattern/)
...
**方法 1 (天真方法):** 生成 1 到 `n` 范围内的所有数字，对于每个生成的数字[检查它是否有交替模式的位](https://www.geeksforgeeks.org/check-number-bits-alternate-pattern-set-2-o1-approach/)。时间复杂度为 O(n)。
