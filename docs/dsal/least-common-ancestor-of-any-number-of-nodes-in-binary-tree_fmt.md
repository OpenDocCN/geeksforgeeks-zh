...
> 原文: [https://www.geeksforgeeks.org/least-common-ancestor-of-any-number-of-nodes-in-binary-tree/](https://www.geeksforgeeks.org/least-common-ancestor-of-any-number-of-nodes-in-binary-tree/)

给定一棵二叉树（不是二叉查找树）和任意数量的关键节点，任务是找到所有关键节点的最小公共祖先。
