...
> 原文：[https://www.geeksforgeeks.org/count-number-elements-two-given-elements-array/](https://www.geeksforgeeks.org/count-number-elements-two-given-elements-array/)
...
在所有情况下（当单个或两个元素都不存在时），解决方案应该只遍历数组一次。
