...
> 原文：[https://www.geeksforgeeks.org/count-number-of-primes-in-an-array/](https://www.geeksforgeeks.org/count-number-of-primes-in-an-array/)
...
一个简单的解决方法是遍历数组并保持[检查每个元素是否是素数](https://www.geeksforgeeks.org/primality-test-set-1-introduction-and-school-method/)并同时保持素数元素的计数。

## 高效方法

使用厄拉多塞的[筛生成数组最大元素之前的所有素数，并将它们存储在散列中。现在遍历数组，使用哈希表找到那些质数元素的数量。](https://www.geeksforgeeks.org/sieve-of-eratosthenes/)
