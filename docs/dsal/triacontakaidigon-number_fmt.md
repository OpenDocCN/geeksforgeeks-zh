...
给定一个 `N` 号，任务是找到第 `N` 个[三十开地贡号](https://en.wikipedia.org/wiki/Triacontadigon)。
...
**参考资料:** [https://en.wikipedia.org/wiki/Triacontadigon](https://en.wikipedia.org/wiki/Triacontadigon)