# 亚马逊面试体验|第 400 集(针对 SDE 2)

> 原文: [https://www.geeksforgeeks.org/Amazon-interview-experience-set-400-sde-2/](https://www.geeksforgeeks.org/Amazon-interview-experience-set-400-sde-2/)
...
1.  项目详细讨论
2.  设计一个分布式 LRU 缓存
3.  设计 Gmail–考虑可扩展性、冗余性、关于 CAP 定理的简短讨论、类图、数据库模式(SQL vs NOSQL)、如何处理附件
