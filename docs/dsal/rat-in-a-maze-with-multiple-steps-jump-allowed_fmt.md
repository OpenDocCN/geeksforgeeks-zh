...
> 原文：[https://www.geeksforgeeks.org/rat-in-a-maze-with-multiple-steps-jump-allowed/](https://www.geeksforgeeks.org/rat-in-a-maze-with-multiple-steps-jump-allowed/)

这是[大鼠在迷宫](https://write.geeksforgeeks.org/javapythoncc-code-for-article-backtracking-set-2-rat-in-a-maze/)中的变异。一个迷宫被给出为 `N*N` 个块的二元矩阵，其中源块是最左上的块即迷宫`[0][0]`，目的块是最右下的块即迷宫`[N-1][N-1]`。老鼠从源头开始，必须到达目的地。老鼠只能朝两个方向移动：向前和向下。
