...
> 原文: [https://www.geeksforgeeks.org/find-nth-term-of-the-series-where-each-term-differs-by-6-and-2-alternately/](https://www.geeksforgeeks.org/find-nth-term-of-the-series-where-each-term-differs-by-6-and-2-alternately/)
...
想法是从 `1` 开始迭代，交替增加 `6` 和 `2`，直到我们到达第 `n` 个项。
以下是上述方法的实施:
