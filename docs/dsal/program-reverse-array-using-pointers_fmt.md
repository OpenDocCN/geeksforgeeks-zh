...
> 原文: [https://www.geeksforgeeks.org/program-reverse-array-using-pointers/](https://www.geeksforgeeks.org/program-reverse-array-using-pointers/)
...
在`reverse`函数中，我们取两个指针，一个指向数组的开头，另一个指向数组的结尾。这两个指针指向的内存位置的内容被交换，然后第一个指针的值增加，第二个指针的值减少。
