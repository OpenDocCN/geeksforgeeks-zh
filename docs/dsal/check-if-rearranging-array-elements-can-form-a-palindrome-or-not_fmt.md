...
> 原文: [https://www.geeksforgeeks.org/check-if-rearranging-array-elements-can-form-a-palindrome-or-not/](https://www.geeksforgeeks.org/check-if-rearranging-array-elements-can-form-a-palindrome-or-not/)
...
> 由于 12321 是回文，所以输出会是“Yes”。
>
> **输入:** `arr = [1, 2, 3, 4, 1]`
> **输出:** No
> **解释:** 给定数组的元素不能在所有可能的排列中重新排列形成回文。所以输出将是“No”。

**方法:** 给定的问题可以使用[map](https://www.geeksforgeeks.org/map-associative-containers-the-c-standard-template-library-stl/)存储[数组元素频率](https://www.geeksforgeeks.org/counting-frequencies-of-array-elements/)来解决。

*   存储所有数组元素的频率。
*   检查每个元素的频率是否均匀。
*   对于频率为奇数的元素，如果只有一个这样的元素，则打印“Yes”。否则打印“No”。
