...
> 原文：[https://www.geeksforgeeks.org/bankers-algorithm-in-operating-system/](https://www.geeksforgeeks.org/bankers-algorithm-in-operating-system/)
...
银行家算法是一种资源分配和避免死锁的算法。该算法测试安全性，模拟所有资源的预定最大可能量的分配，然后进行“安全状态”检查以测试可能的活动，然后决定是否允许继续分配。
