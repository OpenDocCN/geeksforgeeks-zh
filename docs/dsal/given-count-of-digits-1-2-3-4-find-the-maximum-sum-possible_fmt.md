...
> 原文: [https://www.geeksforgeeks.org/given-count-of-digits-1-2-3-4-find-the-maximum-sum-possible/](https://www.geeksforgeeks.org/given-count-of-digits-1-2-3-4-find-the-maximum-sum-possible/)
...
一个有效的方法是先试着做 `234`，`234` 的可能个数是 `c2`，`c3`，`c4` 的最小值。之后，用剩下的 `1` 和 `2` 试着形成 `12`。
