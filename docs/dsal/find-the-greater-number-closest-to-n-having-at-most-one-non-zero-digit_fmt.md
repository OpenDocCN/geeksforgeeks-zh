...
> 原文: [https://www.geeksforgeeks.org/find-the-greater-number-closest-to-n-having-at-most-one-non-zero-digit/](https://www.geeksforgeeks.org/find-the-greater-number-closest-to-n-having-at-most-one-non-zero-digit/)
...
想法是将给定整数的第一个数字的值增加 1，并将结果字符串初始化为给定整数的第一个数字。最后，在结果字符串的末尾追加 `(N–1)0` 并返回结果字符串。
