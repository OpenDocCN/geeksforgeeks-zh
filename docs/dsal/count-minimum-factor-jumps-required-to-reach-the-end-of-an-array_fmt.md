...
> 原文：[https://www.geeksforgeeks.org/count-minimum-factor-jumps-required-to-reach-the-end-of-an-array/](https://www.geeksforgeeks.org/count-minimum-factor-jumps-required-to-reach-the-end-of-an-array/)
...
这个问题可以用[递归](https://www.geeksforgeeks.org/recursion/)解决。

*   首先，我们需要预先计算从 1 到 1000000 的每个数字的[因子](https://www.geeksforgeeks.org/efficient-program-print-number-factors-n-numbers/)，这样我们就可以在 `O(1)` 时间内得到不同的跳跃选择。
*   然后，递归计算到达数组末尾所需的最小跳转并打印出来。
