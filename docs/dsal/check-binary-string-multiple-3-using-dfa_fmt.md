...
> 原文: [https://www.geeksforgeeks.org/check-binary-string-multiple-3-using-dfa/](https://www.geeksforgeeks.org/check-binary-string-multiple-3-using-dfa/)
...
## 方法 2
我们将检查非零奇数位位置和非零偶数位位置的数量之差是否能被 3 整除。
