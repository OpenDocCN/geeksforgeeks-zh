...
> 原文: [https://www.geeksforgeeks.org/check-if-left-and-right-shift-of-any-string-results-into-given-string/](https://www.geeksforgeeks.org/check-if-left-and-right-shift-of-any-string-results-into-given-string/)
...
2.  为此，我们只需检查给定字符串的每个字符是否等于其下一个字符（即位于 `i` 位置的字符必须等于位于 `i+2` 位置的字符）。
