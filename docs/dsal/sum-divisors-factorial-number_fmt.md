...
> 原文: [https://www.geeksforgeeks.org/sum-divisors-factorial-number/](https://www.geeksforgeeks.org/sum-divisors-factorial-number/)
...
一个简单的解法是先计算给定数的阶乘，然后计算阶乘的除数。这种解决方案效率不高，并且可能由于阶乘计算而导致溢出。
...
一个有效的解决方案是基于[勒让德公式](https://www.geeksforgeeks.org/given-p-and-n-find-the-largest-x-such-that-px-divides-n-2/)。以下是步骤。
