# 检查所有数组元素是否可以通过给定的操作移除

> 原文: [https://www.geeksforgeeks.org/check-if-all-array-elements-can-be-removed-by-the-given-operations/](https://www.geeksforgeeks.org/check-if-all-array-elements-can-be-removed-by-the-given-operations/)
