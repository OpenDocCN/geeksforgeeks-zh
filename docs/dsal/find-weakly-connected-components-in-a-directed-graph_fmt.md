...
> 原文：[https://www.geeksforgeeks.org/find-weakly-connected-components-in-a-directed-graph/](https://www.geeksforgeeks.org/find-weakly-connected-components-in-a-directed-graph/)

## 弱连通图

一个**有向图** `G = (V, E)` 是**弱连通的**，如果其底层无向图 `ĝ` 是连通的。
