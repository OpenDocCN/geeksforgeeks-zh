...
> 原文：`https://www.geeksforgeeks.org/count-number-of-common-elements-between-two-arrays-by-using-bitset-and-bitwise-operation/`
...
我们将使用 3 个相同大小的[位组](https://www.geeksforgeeks.org/c-bitset-and-its-application/)。首先，我们将遍历第一个数组，并将位 1 设置为第一个位集中的位置 `a[i]`。
