...
> 原文：[https://www.geeksforgeeks.org/area-of-the-largest-square-that-can-be-inscribed-in-an-ellipse/](https://www.geeksforgeeks.org/area-of-the-largest-square-that-can-be-inscribed-in-an-ellipse/)

给定一个椭圆，长轴长度为 `2a` 和 `2b`，任务是找出其中可内接的最大矩形的面积。
...
> 因此，`x = √(a^2+b^2)/ab`，所以 `y = √(a^2+b^2)/ab`
> 所以面积 `a = 4(a^2+b^2)/a^2b^2`
