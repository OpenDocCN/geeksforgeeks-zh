...
> 原文: [https://www.geeksforgeeks.org/painters-partition-problem-set-2/](https://www.geeksforgeeks.org/painters-partition-problem-set-2/)
...
在[之前的帖子](https://www.geeksforgeeks.org/painters-partition-problem/)中，我们讨论了一种基于动态规划的方法，该方法具有时间复杂度 `O(K * N^2)` 和额外空间 `O(k * N)`。
...
[https://articles . leetcode . com/the-paintiers-partition-problem-ii/](https://articles.leetcode.com/the-paintiers-partition-problem-part-ii/)
