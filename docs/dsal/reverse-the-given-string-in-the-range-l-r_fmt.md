...
> 原文: [https://www.geeksforgeeks.org/reverse-the-given-string-in-the-range-l-r/](https://www.geeksforgeeks.org/reverse-the-given-string-in-the-range-l-r/)

给定一个字符串 `str`，和两个整数 `L` 和 `R`，任务是在范围`【L，R】`内反转字符串，即`str【L…R】`。

**举例:**

> **输入:** `str =“geeksforgeeks”`，`L = 5`，`R = 7`
> **输出:** `geeksforgeks`
> 将范围 `str[5…7]=“for”`中的字符反转为`“rof”`，新字符串将为“geeks**rof**geeks”
