...
> 原文：[https://www.geeksforgeeks.org/sum-of-decomposition-values-of-all-suffixes-of-an-array/](https://www.geeksforgeeks.org/sum-of-decomposition-values-of-all-suffixes-of-an-array/)

给定一个数组 `arr[]`，任务是找到后缀子数组的分解值之和。

**分解值：** 子阵列的分解值是子阵列中可能的分区数。只有当数组的元素小于当前索引时，才能在索引 `i` 处对数组进行分区。即 `A[k] < A[i]`，其中 `k ≤ i`。
...
> **输出：** 8
> **解释：**
> `arr`的所有后缀都是[9，6，9，35]，[6，9，35]，[9，35]，[35]
> 后缀[35] =>只有 1 个分解 **{35}**
> 后缀[9，35] => 2 分解 **{9}** **{35}**
> 后缀[6，9，35] => 3 分解 **{6}** **{9}** **{35}**
