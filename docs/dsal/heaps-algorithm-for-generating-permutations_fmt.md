...
> 原文：[https://www.geeksforgeeks.org/heaps-algorithm-for-generating-permutations/](https://www.geeksforgeeks.org/heaps-algorithm-for-generating-permutations/)
...
2.  如果 n 是奇数，交换第一个和最后一个元素，如果 n 是偶数，交换第 i 个元素（i 是从 0 开始的计数器）和最后一个元素，重复上述算法，直到 i 小于 n。
...
**参考文献：**
1.  [https://en.wikipedia.org/wiki/Heap%27s_algorithm#cite_note-3](https://en.wikipedia.org/wiki/Heap%27s_algorithm#cite_note-3)
