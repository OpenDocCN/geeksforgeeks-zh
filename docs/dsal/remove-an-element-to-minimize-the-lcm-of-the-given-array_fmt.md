...
> 原文: [https://www.geeksforgeeks.org/remove-an-element-to-minimize-the-lcm-of-the-given-array/](https://www.geeksforgeeks.org/remove-an-element-to-minimize-the-lcm-of-the-given-array/)
...
*   为了最佳地找到子序列的 LCM，使用单状态动态编程保持一个 `前缀 LCM[]` 和一个 `后缀 LCM[]` 数组。
