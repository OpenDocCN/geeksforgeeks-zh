...
> 原文：[https://www.geeksforgeeks.org/convert-tree-forest-even-nodes/](https://www.geeksforgeeks.org/convert-tree-forest-even-nodes/)
...
### 参考
[http://stackoverflow.com/questions/12043252/obtain-forest-out-of-tree-with-even-number-of-nodes](http://stackoverflow.com/questions/12043252/obtain-forest-out-of-tree-with-even-number-of-nodes)

本文由 GeeksforGeeks 供稿。如果你喜欢 GeeksforGeeks 并想投稿，你也可以使用 [write.geeksforgeeks.org](https://write.geeksforgeeks.org) 写一篇文章或者把你的文章邮寄到 review-team@geeksforgeeks.org。看到你的文章出现在极客博客主页上，帮助其他极客。
