...
> 原文: [https://www.geeksforgeeks.org/convert-a-binary-tree-to-bst-by-left-shifting-digits-of-node-values/](https://www.geeksforgeeks.org/convert-a-binary-tree-to-bst-by-left-shifting-digits-of-node-values/)
...
想法是在[二叉树](https://www.geeksforgeeks.org/binary-tree-data-structure/)上以递增的顺序执行[有序遍历](https://www.geeksforgeeks.org/inorder-tree-traversal-without-recursion/)，因为 BST 的有序遍历总是生成排序的序列。按照以下步骤解决问题:
