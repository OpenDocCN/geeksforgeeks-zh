...
> 原文: [https://www.geeksforgeeks.org/split-the-array-into-equal-sum-parts-according-to-given-conditions/](https://www.geeksforgeeks.org/split-the-array-into-equal-sum-parts-according-to-given-conditions/)
...
**方法:** 我们可以使用递归方法，通过保持左和和右和来维持两个不同的组。左和为 5 的倍数、右和为 3 的倍数(不是 5 的倍数)并且既不能被 5 整除也不能被 3 整除的元素可以位于满足等和法则的任意组中(将它们一一包含在左和右和中)。
