...
> 原文: [https://www.geeksforgeeks.org/largest-number-in-the-array-having-frequency-same-as-value/](https://www.geeksforgeeks.org/largest-number-in-the-array-having-frequency-same-as-value/)
...
**注:** 该方法仅在给定数组中的数字小于 `65536` 时有效，即 `2^16`。
