...
> 原文：[https://www.geeksforgeeks.org/find-the-xor-of-first-n-prime-numbers/](https://www.geeksforgeeks.org/find-the-xor-of-first-n-prime-numbers/)

给定一个正整数 `N`，任务是求第一个 `N` 个素数的**异或**。
...
1.  创建厄拉多塞的筛，以识别一个数字在 `O(1)` 时间内是否为质数。
