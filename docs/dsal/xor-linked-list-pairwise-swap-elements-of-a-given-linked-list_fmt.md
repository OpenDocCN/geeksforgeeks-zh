...
> 原文：`https://www.geeksforgeeks.org/xor-linked-list-pairwise-swap-elements-of-a-given-linked-list/`
...
使用给定链表的[成对交换元素的概念](https://www.geeksforgeeks.org/pairwise-swap-elements-of-a-given-linked-list/)可以解决这个问题。其思想是[遍历给定的异或链表](https://www.geeksforgeeks.org/xor-linked-list-a-memory-efficient-doubly-linked-list-set-2/)并选择两个相邻的节点对并交换它们。按照以下步骤解决问题：
