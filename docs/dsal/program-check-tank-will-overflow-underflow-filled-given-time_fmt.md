...
> 原文：[https://www.geeksforgeeks.org/program-check-tank-will-overflow-underflow-filled-given-time/](https://www.geeksforgeeks.org/program-check-tank-will-overflow-underflow-filled-given-time/)
...
圆柱形油箱的容积为 `(22/7) * radius * radius * height`。首先，找出完全充满油箱所需的时间，然后将其与给定的时间进行比较。如果给定时间大于所需时间，将导致溢出情况。如果给定的时间少于所需的时间，那么它将导致底流状态，否则罐被填满。
