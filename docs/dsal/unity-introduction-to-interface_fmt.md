...
带 Unity 的[游戏开发简介](https://www.geeksforgeeks.org/game-development-with-unity-introduction/)一文介绍了关于 Unity 以及如何安装。在本文中，我们将看到如何创建一个新项目，并了解 Unity 游戏编辑器的界面。
...
默认情况下，Unity 编辑器将打开一个示例场景。编辑器窗口中不同选项卡的排列方式使您可以轻松访问最常见的功能。下图为默认布局：
