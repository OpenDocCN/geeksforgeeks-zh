...
> 原文：[https://www.geeksforgeeks.org/construct-full-binary-tree-using-preorder-traversal-preorder-traversal-mirror-tree/](https://www.geeksforgeeks.org/construct-full-binary-tree-using-preorder-traversal-preorder-traversal-mirror-tree/)
...
我们把给定的两个数组看作 `preOrder[] = {1，2，4，5，3，6，7}` 和 `preOrderMirror[] = {1，3，7，6，2，5，4}`。
