...
> 原文: [https://www.geeksforgeeks.org/check-if-a-number-is-a-perfect-square-having-all-its-digits-as-a-perfect-square/](https://www.geeksforgeeks.org/check-if-a-number-is-a-perfect-square-having-all-its-digits-as-a-perfect-square/)
...
想法是检查给定的数字 `N` 是否是一个完美的正方形。如果发现是真的，检查其所有数字是 `0`、`1`、`4` 还是 `9`。如果发现是真的，打印“`是`”。否则，打印“`否`”。
