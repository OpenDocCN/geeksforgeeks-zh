...
> 原文：[https://www.geeksforgeeks.org/find-m-th-smallest-value-in-k-sorted-arrays/](https://www.geeksforgeeks.org/find-m-th-smallest-value-in-k-sorted-arrays/)
...
2.  重复以下步骤 `m` 次：
    ...
    b) 从提取元素的数组中插入下一个元素。如果数组没有更多的元素，那么什么也不做。
3.  打印最后删除的项目。
