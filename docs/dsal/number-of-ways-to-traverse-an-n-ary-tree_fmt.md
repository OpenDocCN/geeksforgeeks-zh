...
> 原文：[https://www.geeksforgeeks.org/number-of-ways-to-traverse-an-n-ary-tree/](https://www.geeksforgeeks.org/number-of-ways-to-traverse-an-n-ary-tree/)
...
这是一个巨大的数量的方法，其中只有少数被证明是有用的，如 `in-order`，`level-order`，`preorder`，`postorder`（根据这些遍历的流行程度排列）
