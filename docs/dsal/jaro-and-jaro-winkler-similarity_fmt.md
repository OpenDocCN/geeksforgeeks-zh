...
> 原文: [https://www.geeksforgeeks.org/jaro-and-jaro-winkler-similarity/](https://www.geeksforgeeks.org/jaro-and-jaro-winkler-similarity/)
...
如果字符相同，并且字符不超过
![\Big\lfloor\cfrac{max(|s1|, |s2|)}{2}\Big\rfloor-1            ](img/a795d115082fd24a661dd50f3ff70cd4.png "Rendered by QuickLaTeX.com")
位置是两个字符串中匹配字符数量的一半，但顺序不同，则称字符匹配。

**计算:**

*   让 `S1 = "arnab"`, `S2 = "raanb"`，这样每个字符匹配的最大距离就是 1。
