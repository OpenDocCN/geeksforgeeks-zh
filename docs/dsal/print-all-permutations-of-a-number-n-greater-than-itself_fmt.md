...
> 原文: [https://www.geeksforgeeks.org/print-all-permutations-of-a-number-n-greater-than-itself/](https://www.geeksforgeeks.org/print-all-permutations-of-a-number-n-greater-than-itself/)

给定一个数 `N`，我们的任务是打印那些大于 `N` 的整数 `N` 的排列。
...
**方法:** 为了解决这个问题，我们可以使用 C++ 中的 [`next_permutation()`](https://www.geeksforgeeks.org/stdnext_permutation-prev_permutation-c/) 方法获得 `N` 的所有字典序上较大的排列。得到所有这些数字后，打印出来。
