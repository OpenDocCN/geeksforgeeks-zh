...
> 原文: [https://www.geeksforgeeks.org/find-smallest-number-whose-digits-multiply-given-number-n/](https://www.geeksforgeeks.org/find-smallest-number-whose-digits-multiply-given-number-n/)
...
**情况 1: n < 10**
当 `n` 小于 10 时，输出总是 `n+10`。例如，对于 `n = 7`，输出为 17。对于 `n = 9`，输出为 19。

**情况 2: n >= 10**
求 `n` 的所有因子，均在 2 和 9 之间(含 2 和 9)。这个想法是从 9 开始搜索，这样结果中的位数就最小化了。例如，9 比 33 更优选，8 比 24 更优选。
