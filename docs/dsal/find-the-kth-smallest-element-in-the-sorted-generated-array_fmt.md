...
> 原文:[https://www.geeksforgeeks.org/find-the-kth-smallest-element-in-the-sorted-generated-array/](https://www.geeksforgeeks.org/find-the-kth-smallest-element-in-the-sorted-generated-array/)

给定一个由 `N` 元素和一个整数 `K` 组成的数组 `arr[]`，任务是生成一个具有以下规则的 `B[]`：
