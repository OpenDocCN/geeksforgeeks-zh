...
检查 `N1` 和 `N2` 是否都是[素数](https://www.geeksforgeeks.org/sieve-of-eratosthenes/)和[字谜](https://www.geeksforgeeks.org/check-whether-two-strings-are-anagram-of-each-other/)。如果数是质数和字谜，那么数就是奥米斯顿质数对。
