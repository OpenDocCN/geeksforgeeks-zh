...
> 原文：[https://www.geeksforgeeks.org/program-find-sum-prime-numbers-1-n/](https://www.geeksforgeeks.org/program-find-sum-prime-numbers-1-n/)
...
一个`高效的解决方案`是使用厄拉多塞的[筛找出从 1 到 `n` 的所有素数，然后进行求和。](https://www.geeksforgeeks.org/sieve-of-eratosthenes/)
