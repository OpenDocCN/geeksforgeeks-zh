...
> 原文：[https://www.geeksforgeeks.org/return-an-array-of-anti-diagonals-of-given-nn-square-matrix/](https://www.geeksforgeeks.org/return-an-array-of-anti-diagonals-of-given-nn-square-matrix/)
...
*   而第二个观察结果是，其余对角线从每行的结束列开始，并在任意一行的开始 `< N` 或起始列 `>= 0` 时结束。
