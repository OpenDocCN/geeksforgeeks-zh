...
> 原文: [https://www.geeksforgeeks.org/program-to-find-slant-height-of-cone-and-pyramid/](https://www.geeksforgeeks.org/program-to-find-slant-height-of-cone-and-pyramid/)

给定两个整数 `H1` 和 `R` 代表一个[圆锥体的高度和半径](https://www.geeksforgeeks.org/calculate-volume-surface-area-cone/)，和两个整数 `H2` 和 `S` 代表一个[棱锥](https://www.geeksforgeeks.org/program-for-volume-of-pyramid/)底部的高度和长度，任务是找出圆锥体和棱锥的倾斜高度。
...
圆锥或棱锥等物体的倾斜高度是从沿侧面的任意顶点到底部（沿面中心）的距离。直圆锥的倾斜高度在整个表面上是一致的，由下式给出:
