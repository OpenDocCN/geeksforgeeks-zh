...
> 原文: [https://www.geeksforgeeks.org/find-patterns-101-given-string/](https://www.geeksforgeeks.org/find-patterns-101-given-string/)

字符串包含 `1(0+)1` 形式的模式，其中 `(0+)` 表示任何非空的连续 `0` 序列。请统计所有此类模式。允许图案重叠。

**注意:** 只包含数字和小写字符。字符串不一定是二进制的。`100201` 不是有效的模式。

这里讨论了一种解决问题的方法，其他使用正则表达式的方法在[第 2 集](https://www.geeksforgeeks.org/find-patterns-101-given-string-set-2regular-expression-approach/)中给出。
