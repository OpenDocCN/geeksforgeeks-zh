...
> 原文: [https://www.geeksforgeeks.org/program-determine-quadrant-cartesian-plane/](https://www.geeksforgeeks.org/program-determine-quadrant-cartesian-plane/)

给定坐标(`x`，`y`)，确定笛卡尔平面的象限。

![](img/5517758da7e6c2e58271fe398a74be0c.png)

image_source: [wikipedia.org](https://en.wikipedia.org/wiki/Cartesian_coordinate_system)
