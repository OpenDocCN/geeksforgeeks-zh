...
> 原文：[https://www.geeksforgeeks.org/print-siblings-of-given-node-in-an-n-ary-tree/](https://www.geeksforgeeks.org/print-siblings-of-given-node-in-an-n-ary-tree/)
...
> **输出：** `90 110`
>
> **说明：** 值为 `90`、`100`、`110` 的节点有相同的父节点，即值为 `40` 的节点。因此，节点 `90` 和 `110` 是给定节点 `X( = 100)` 的兄弟节点。
>
> **输入：** `X = 30`
>
> ![](img/51491feb76419d6cf3e24d15504927a9.png)
...
> **输出：** `20 40`
>
> **说明：** 值为 `20`、`30`、`40` 的节点有相同的父节点，即值为 `10` 的节点。因此，节点 `20` 和 `40` 是给定节点 `X( = 30)` 的兄弟节点。
