...
> 原文：[https://www.geeksforgeeks.org/print-n-terms-newman-conway-sequence/](https://www.geeksforgeeks.org/print-n-terms-newman-conway-sequence/)

[纽曼-康威数](https://www.geeksforgeeks.org/newman-conway-sequence/)是生成以下整数序列的那个：`1 1 2 3 4 4 5 6 7….` 并遵循以下递归公式。
