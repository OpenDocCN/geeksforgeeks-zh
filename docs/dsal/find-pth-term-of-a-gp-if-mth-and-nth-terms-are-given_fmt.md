...
> 原文: [https://www.geeksforgeeks.org/find-pth-term-of-a-gp-if-mth-and-nth-terms-are-given/](https://www.geeksforgeeks.org/find-pth-term-of-a-gp-if-mth-and-nth-terms-are-given/)

给定一个[几何级数](https://www.geeksforgeeks.org/geometric-progression/)的第 `m` 项和第 `n` 项。找到它的 `Pth` 项。

**例:**

> **输入:** `m = 10`，`n = 5`，`mth = 2560`，`nth = 80`，`p = 30`
> **输出:** `pth = 81920`
> **输入:** `m = 8`，`n = 2`，`mth = 1250`，`nth = 960`，`p = 15`
> **输出:** `24964.4`
...
为了方便起见，假设 `m > n`
从这两个方程中，
由于我们已经给出了 `m`，`n`，第 `m` 项和第 `n` 项的值，因此
