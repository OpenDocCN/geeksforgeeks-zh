...
> 原文: [https://www.geeksforgeeks.org/kth-smallest-element-in-a-subarray/](https://www.geeksforgeeks.org/kth-smallest-element-in-a-subarray/)
...
思路是使用[段树](https://www.geeksforgeeks.org/segment-tree-set-1-sum-of-given-range/)，更准确的说是使用[合并排序段树](https://www.geeksforgeeks.org/merge-sort-tree-smaller-or-equal-elements-in-given-row-range/)。这里，我们不是存储排序元素，而是存储排序元素的索引。
...
> `upper_bound(start(), end()) - lower_bound(start(), end())`
