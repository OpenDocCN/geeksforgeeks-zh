...
> 原文：[https://www.geeksforgeeks.org/area-of-circumcircle-of-an-equilateral-triangle-using-median/](https://www.geeksforgeeks.org/area-of-circumcircle-of-an-equilateral-triangle-using-median/)

给定等边三角形的中值 `M`，任务是使用中值 `M` 找到这个等边三角形的外接圆的面积。
...
问题中的关键观察点是等边三角形的质心、外心、正心和燃烧点都在同一点上。
...
然后可以使用本文中使用的方法计算圆的面积，下面是上述方法的实现：
