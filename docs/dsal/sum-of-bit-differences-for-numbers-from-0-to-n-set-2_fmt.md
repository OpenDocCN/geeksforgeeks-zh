...
> 原文: [https://www.geeksforgeeks.org/sum-of-bit-differences-for-numbers-from-0-to-n-set-2/](https://www.geeksforgeeks.org/sum-of-bit-differences-for-numbers-from-0-to-n-set-2/)
...
我们可以观察到对于 `N = [1，2，3，4，…..]`，连续元素中不同位的和形成序列 `[1，3，4，7，8，…]`。因此，本系列的 `N` 第项将是我们需要的答案，可计算为:
