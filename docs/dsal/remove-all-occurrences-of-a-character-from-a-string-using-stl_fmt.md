...
> 原文: [https://www.geeksforgeeks.org/remove-all-occurrences-of-a-character-from-a-string-using-stl/](https://www.geeksforgeeks.org/remove-all-occurrences-of-a-character-from-a-string-using-stl/)
...
> **输出:** `PLEASEmove空间`
> **解释:**
> 移除字符 `' '` 的所有出现将 `S` 修改为 `"PLEASEmove空间"`。
