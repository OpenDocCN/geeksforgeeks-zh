...
> 原文: [https://www.geeksforgeeks.org/sum-of-integers-upto-n-with-given-unit-digit-set-2/](https://www.geeksforgeeks.org/sum-of-integers-upto-n-with-given-unit-digit-set-2/)

给定两个整数 `N` 和 `D`，其中 `1 ≤ N ≤ 10^18`，任务是求从 `1` 到 `N` 的所有整数之和，其单位数字为 `D`。
