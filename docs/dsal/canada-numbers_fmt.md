...
**方法：** 思路是求一个数的所有适当除数的[和](https://www.geeksforgeeks.org/sum-of-all-proper-divisors-of-a-natural-number/)，从中减去 `N` 和 `1`。另外，求 `n` 位数的平方和。现在检查两个和是否相同。如果所有适当除数的和与 `n` 位数的平方和相等，那么这个数就是加拿大数。
...
**参考：** [http://www.numbersaplenty.com/set/Canada_number/](http://www.numbersaplenty.com/set/Canada_number/)