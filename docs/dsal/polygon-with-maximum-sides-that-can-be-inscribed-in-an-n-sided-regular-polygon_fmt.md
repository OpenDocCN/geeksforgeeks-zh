...
> 原文: [https://www.geeksforgeeks.org/polygon-with-maximum-sides-that-can-be-inscribed-in-an-n-sided-regular-polygon/](https://www.geeksforgeeks.org/polygon-with-maximum-sides-that-can-be-inscribed-in-an-n-sided-regular-polygon/)
...
### 方法:
思路是观察如果 `N` 为偶数，一个正多边形可以内接另一个 `N` 边的正多边形。按照以下步骤解决问题:
