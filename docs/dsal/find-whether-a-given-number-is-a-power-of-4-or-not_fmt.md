...
> 原文: [https://www.geeksforgeeks.org/find-whether-a-given-number-is-a-power-of-4-or-not/](https://www.geeksforgeeks.org/find-whether-a-given-number-is-a-power-of-4-or-not/)
...
**2.** 另一种解决方法是继续用 4 除数，即迭代做 `n = n/4`。在任何迭代中，如果 `n%4` 变成非零且 `n` 不是 1，则 `n` 不是 4 的幂，否则 `n` 是 4 的幂。
