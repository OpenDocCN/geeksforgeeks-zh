...
> 原文：[https://www.geeksforgeeks.org/program-to-check-if-the-string-is-null-in-java/](https://www.geeksforgeeks.org/program-to-check-if-the-string-is-null-in-java/)
...
*   获取要在字符串中检查的字符串。
*   我们可以简单地使用`==`关系运算符将字符串与`null`进行比较。
    语法：
