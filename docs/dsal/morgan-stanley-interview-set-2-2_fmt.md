...
> 原文: [https://www.geeksforgeeks.org/morgan-stanley-interview-set-2-2/](https://www.geeksforgeeks.org/morgan-stanley-interview-set-2-2/)
...
示例:
输入:
`this is morgan stanley interview problem`
输出:
`problem interview stanley morgan is this`
