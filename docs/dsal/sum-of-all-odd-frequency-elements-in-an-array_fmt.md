...
> 原文: [https://www.geeksforgeeks.org/sum-of-all-odd-frequency-elements-in-an-array/](https://www.geeksforgeeks.org/sum-of-all-odd-frequency-elements-in-an-array/)
...
*   遍历数组，并使用 [C++中的映射](https://www.geeksforgeeks.org/map-associative-containers-the-c-standard-template-library-stl/) 来存储数组元素的频率，其中映射的键是数组元素，值是其在数组中的频率。
*   然后，遍历映射以查找元素的频率，检查其是否为奇数，如果是奇数，则将该元素添加到总和中。
...
*   使用 [`counter`](https://www.geeksforgeeks.org/python-counter-objects-elements/) 函数。
*   遍历频率字典，并将所有出现奇数次的元素与其频率相乘后求和。
