...
> 原文: [https://www.geeksforgeeks.org/check-line-touches-intersects-circle/](https://www.geeksforgeeks.org/check-line-touches-intersects-circle/)

给定圆心坐标和半径大于 1 的圆和直线方程。任务是检查给定的线是否与圆碰撞。有三种可能:
