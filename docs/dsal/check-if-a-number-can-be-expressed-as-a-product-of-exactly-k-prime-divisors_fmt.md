...
> 原文：[https://www.geeksforgeeks.org/check-if-a-number-can-be-expressed-as-a-product-of-exactly-k-prime-divisors/](https://www.geeksforgeeks.org/check-if-a-number-can-be-expressed-as-a-product-of-exactly-k-prime-divisors/)

给定一个`整数 N`，任务是检查它是否可以精确地表示为`K`个质因数的乘积。
