# 不能被[2,10]范围内的任何数整除的数

> 原文: [https://www.geeksforgeeks.org/numbers-that-are-not-divisible-by-any-number-in-the-range-2-10/](https://www.geeksforgeeks.org/numbers-that-are-not-divisible-by-any-number-in-the-range-2-10/)
...
因此，公式是 `n - ⌊n/2⌋ - ⌊n/3⌋ - ⌊n/5⌋ - ⌊n/7⌋ + ⌊n/(2 * 3)⌋ + ⌊n/(2 * 5)⌋ + ⌊n/(2 * 7)⌋ + ⌊n/(3 * 5)⌋ + ⌊n/(3 * 7)⌋ + ⌊n/(5 * 7)⌋ - ⌊n/(2 * 3 * 5)⌋ - ⌊n/(2 * 3 * 7)⌋ - ⌊n/(2 * 5 * 7)⌋ - ⌊n/(3 * 5 * 7)⌋ + ⌊n/(2 * 3 * 5 * 7)⌋`。
