...
> 原文：[https://www.geeksforgeeks.org/queries-maximum-difference-prime-numbers-given-ranges/](https://www.geeksforgeeks.org/queries-maximum-difference-prime-numbers-given-ranges/)
...
**步骤 1:** 使用厄拉多塞的筛算法找到素数。
**步骤 2:** 制作一个数组，比如说`前缀[]`，其中`前缀[i]`表示小于或等于 `i` 的最大素数。
**步骤 3:** 制作一个数组，比如说`后缀[]`，其中`后缀[i]`表示大于或等于 `i` 的最小素数。
