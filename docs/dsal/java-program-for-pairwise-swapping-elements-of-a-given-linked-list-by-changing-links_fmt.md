...
> 原文：[https://www.geeksforgeeks.org/java-program-for-pairwise-swapping-elements-of-a-given-linked-list-by-changing-links/](https://www.geeksforgeeks.org/java-program-for-pairwise-swapping-elements-of-a-given-linked-list-by-changing-links/)
...
上述程序的时间复杂度为 `O(n)`，其中 `n` 为给定链表中的节点数。`while` 循环遍历给定的链表。
