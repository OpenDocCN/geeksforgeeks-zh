...
> 原文: [https://www.geeksforgeeks.org/program-to-print-n-alphabet-using-the-number-pattern-from-1-to-n/](https://www.geeksforgeeks.org/program-to-print-n-alphabet-using-the-number-pattern-from-1-to-n/)
...
*   将第一个值打印为 `index + 1`，其中 `index` 是该行的索引。
*   然后打印空格 `2 * index` 次。
*   再次打印数值 `index + 1` 作为当前行的对角线元素。
