...
> 原文：[https://www.geeksforgeeks.org/convert-given-array-to-arithmetic-progression-by-adding-an-element/](https://www.geeksforgeeks.org/convert-given-array-to-arithmetic-progression-by-adding-an-element/)
...
*   如果最多一对 `(arr[i–1]，arr[i])` 的差异等于 `2 * 所有其他元素的共同差异`，则打印 `arr[i]–共同差异`。
*   否则打印 `-1`。
