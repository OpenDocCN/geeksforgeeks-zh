# Snapdeal 面试体验 | 第 14 集（针对软件工程师）

> 原文：[https://www.geeksforgeeks.org/snapdeal-interview-experience-set-14-for-software-engineer/](https://www.geeksforgeeks.org/snapdeal-interview-experience-set-14-for-software-engineer/)

软件工程师职位的 Snapdeal 面试经验：

## 第一轮：模拟轮
问题：开发 `REST API`，用于添加、获取、更新和删除书签。使用 `Spring Boot` 开发了 `API`。
...
问题 2：抽象类和接口的区别？
问题 3：什么是超越和超载？
问题 4：在什么业务场景下会用到[链表或者数组](https://www.geeksforgeeks.org/linked-list-vs-array/)列表？
问题 5：[不使用哈希表，用任意指针](https://practice.geeksforgeeks.org/problems/clone-a-linked-list-with-next-and-random-pointer/1)复制链表。
