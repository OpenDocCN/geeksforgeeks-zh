...
> 原文: [https://www.geeksforgeeks.org/number-of-ways-to-arrange-n-numbers-which-are-in-a-range-from-1-to-k-under-given-constraints/](https://www.geeksforgeeks.org/number-of-ways-to-arrange-n-numbers-which-are-in-a-range-from-1-to-k-under-given-constraints/)
...
思路是用[动态规划](https://www.geeksforgeeks.org/dynamic-programming/)解决这个问题。
...
// of ways
void NumberOfWays(int n, int k, int p, int q)
{
