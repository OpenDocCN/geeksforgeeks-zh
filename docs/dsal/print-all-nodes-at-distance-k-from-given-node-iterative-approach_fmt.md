...
> 原文: [https://www.geeksforgeeks.org/print-all-nodes-at-distance-k-from-given-node-iterative-approach/](https://www.geeksforgeeks.org/print-all-nodes-at-distance-k-from-given-node-iterative-approach/)
...
class GFG {
    ...
    // node of every node of
    // the given Binary Tree
    static Dictionary<Node, Node> um = new Dictionary<Node, Node>();
