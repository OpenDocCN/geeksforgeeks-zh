...
> 原文: [https://www.geeksforgeeks.org/caesar-cipher-in-cryptography/](https://www.geeksforgeeks.org/caesar-cipher-in-cryptography/)
...
接收 `text`（字符串）和移位值（整数）并返回加密文本的程序。
...
https://www.youtube.com/watch?v=S472gPqwF-o
