...
> 原文：[https://www.geeksforgeeks.org/check-if-two-strings-can-be-made-equal-by-reversing-a-substring-of-one-of-the-strings/](https://www.geeksforgeeks.org/check-if-two-strings-can-be-made-equal-by-reversing-a-substring-of-one-of-the-strings/)
...
解决问题最简单的方法是反转字符串 `X` 的每个可能的子串，对于每个反转，检查两个字符串是否相等。如果反转后发现是真的，则打印`“是”`。否则，打印`“否”`。
