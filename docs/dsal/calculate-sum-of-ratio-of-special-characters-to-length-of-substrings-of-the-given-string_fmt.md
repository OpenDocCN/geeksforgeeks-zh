...
> 原文：[https://www.geeksforgeeks.org/calculate-sum-of-ratio-of-special-characters-to-length-of-substrings-of-the-given-string/](https://www.geeksforgeeks.org/calculate-sum-of-ratio-of-special-characters-to-length-of-substrings-of-the-given-string/)
...
> 由于字符串的所有字符都包含在 `specialArray[]`，因此每个子字符串的特殊字符计数与子字符串长度的比率均为 1。
> 因此，比值之和 = 子串数 * 1 = 28。
> 
