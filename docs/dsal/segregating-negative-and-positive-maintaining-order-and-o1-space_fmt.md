...
> 原文: [https://www.geeksforgeeks.org/segregating-negative-and-positive-maintaining-order-and-o1-space/](https://www.geeksforgeeks.org/segregating-negative-and-positive-maintaining-order-and-o1-space/)
...
1.  [在不维持顺序的情况下重新排列正数和负数](https://www.geeksforgeeks.org/rearrange-positive-and-negative-numbers/)
2.  [用不变的额外空间重新排列正数和负数](https://www.geeksforgeeks.org/rearrange-positive-and-negative-numbers/)

在这篇文章中，我们讨论了一种占用 `O(1)` 个额外空间的新方法。我们首先计算负数总数，然后将负数一个接一个地移动到正确的位置。
