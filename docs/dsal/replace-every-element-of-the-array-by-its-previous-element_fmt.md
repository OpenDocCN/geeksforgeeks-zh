...
> 原文: [https://www.geeksforgeeks.org/replace-every-element-of-the-array-by-its-previous-element/](https://www.geeksforgeeks.org/replace-every-element-of-the-array-by-its-previous-element/)
...
> **输入:** `arr[] = {5, 1, 3, 2, 4}`
> **输出:** `-1 5 1 3 2`
> **输入:** `arr[] = {6, 8, 32, 12, 14, 10, 25}`
> **输出:** `-1 6 8 32 12 14 10`

## 方法

从 `n–1` 到 `1` 遍历数组，更新 `arr[i] = arr[i-1]`。最后设置 `a[0] = -1` 并打印更新后数组的内容。
