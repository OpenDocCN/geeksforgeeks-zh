...
> 原文: [https://www.geeksforgeeks.org/split-array-into-k-subarrays-such-that-sum-of-maximum-of-all-subarrays-is-maximized/](https://www.geeksforgeeks.org/split-array-into-k-subarrays-such-that-sum-of-maximum-of-all-subarrays-is-maximized/)
...
给定的问题可以使用[地图数据结构](https://www.geeksforgeeks.org/map-associative-containers-the-c-standard-template-library-stl/)和[排序技术](https://www.geeksforgeeks.org/sorting-algorithms/)来解决，基于以下观察:
...
*   [在范围](https://www.geeksforgeeks.org/range-based-loop-c/) `[0，N-1]` 内迭代，使用变量表示 `i` ，执行以下步骤:
    ...
    *   如果 `mp[arr[i]]` 大于 `0` ，则执行以下操作:
        ...
        *   现在按下 `P` 中的当前段 `V` 。
*   最后，完成上述步骤后，打印变量 `ans` 中存储的最大和，然后分区存储在 `P` 中。
