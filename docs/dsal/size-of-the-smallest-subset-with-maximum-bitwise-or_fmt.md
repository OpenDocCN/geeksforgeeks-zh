...
> 原文: [https://www.geeksforgeeks.org/size-of-the-smallest-subset-with-maximum-bitwise-or/](https://www.geeksforgeeks.org/size-of-the-smallest-subset-with-maximum-bitwise-or/)
...
为此，使用类似于 [子集和问题](https://www.geeksforgeeks.org/dynamic-programming-subset-sum-problem/) 中给出的动态规划方法。`count[i][j]`表示最小大小子集，直到第一个元素的 OR 为 `j`。
