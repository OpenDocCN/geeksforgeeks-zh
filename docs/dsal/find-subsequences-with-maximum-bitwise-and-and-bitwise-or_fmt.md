...
> 原文：[https://www.geeksforgeeks.org/find-subsequences-with-maximum-bitwise-and-and-bitwise-or/](https://www.geeksforgeeks.org/find-subsequences-with-maximum-bitwise-and-and-bitwise-or/)
...
`方法：`最大“或”是所有数字的“或”，最大“与”是数组中的最大元素。这是因为 `(x | y) >= x, y` 和 `(x & y) <= x, y`。
