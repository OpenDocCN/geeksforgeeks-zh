...
> 原文: [https://www.geeksforgeeks.org/node-maximum-sum-immediate-children-n-ary-tree/](https://www.geeksforgeeks.org/node-maximum-sum-immediate-children-n-ary-tree/)
...
遍历树，在 `currsum` 整型变量中维护其所有直系子代的根和数据之和，并相应更新 `maxsum` 变量。
