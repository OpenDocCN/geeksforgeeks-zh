...
> 原文：[https://www.geeksforgeeks.org/check-whether-two-numbers-differ-one-bit-position/](https://www.geeksforgeeks.org/check-whether-two-numbers-differ-one-bit-position/)
...
1.  计算 `num` = `a` ^ `b`。
2.  检查 `num` 是否为 2 的幂。参考[这篇](https://www.geeksforgeeks.org/program-to-find-whether-a-no-is-power-of-two/)帖子。
