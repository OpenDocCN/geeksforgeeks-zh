...
[阿尔库因序列](https://en.wikipedia.org/wiki/Alcuin%27s_sequence)是的扩展
...
*   使用 `a(n)= round(n^2/12–地板(n/4)*地板((n+2)/4)` 找到阿尔库因序列的第 `n` 项
*   找出第一个术语并显示出来。
...
**参考:**[https://en.wikipedia.org/wiki/Alcuin%27s_sequence](https://en.wikipedia.org/wiki/Alcuin%27s_sequence)