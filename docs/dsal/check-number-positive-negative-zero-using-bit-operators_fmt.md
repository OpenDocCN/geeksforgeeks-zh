...
> 原文: [https://www.geeksforgeeks.org/check-number-positive-negative-zero-using-bit-operators/](https://www.geeksforgeeks.org/check-number-positive-negative-zero-using-bit-operators/)
...
当我们做 `-n >> 31` 时，如果它是一个正数，那么它会像我们做的那样返回 `-1`，`n>>31` 反之亦然。
