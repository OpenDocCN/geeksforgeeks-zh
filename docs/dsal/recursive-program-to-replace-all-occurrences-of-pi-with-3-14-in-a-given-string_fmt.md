# 递归程序：在给定字符串中用 3.14 替换圆周率的所有出现

> 原文: [https://www.geeksforgeeks.org/recursive-program-to-replace-all-occurrences-of-pi-with-3-14-in-a-given-string/](https://www.geeksforgeeks.org/recursive-program-to-replace-all-occurrences-of-pi-with-3-14-in-a-given-string/)

给定大小为 `N` 的字符串 `str`。任务是编写一个递归函数，用给定字符串中的 `3.14` 替换所有出现的 `pi`，并打印修改后的字符串。

## 示例

> **输入:** `str = " pippiiiipi "`
> **输出:** `3.14pp3.14iiiii3.14`
>
> **输入:** `str = " pip "`
> **输出:** `3.14p`
>
