...
> 原文：[https://www.geeksforgeeks.org/program-to-convert-a-bcd-to-hexa-decimal-number/](https://www.geeksforgeeks.org/program-to-convert-a-bcd-to-hexa-decimal-number/)

给定一个二进制数，任务是将这个二进制数转换成其等价的[十六进制数](https://www.geeksforgeeks.org/program-decimal-hexadecimal-conversion/)。
