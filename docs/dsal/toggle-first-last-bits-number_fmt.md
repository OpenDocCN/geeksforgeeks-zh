...
> 原文：[https://www.geeksforgeeks.org/toggle-first-last-bits-number/](https://www.geeksforgeeks.org/toggle-first-last-bits-number/)
...
### 先决条件：
[找到给定数量的 MSB](https://www.geeksforgeeks.org/find-significant-set-bit-number/)。
