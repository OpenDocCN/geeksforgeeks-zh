...
> 原文：[https://www.geeksforgeeks.org/find-the-sum-of-non-prime-elements-in-the-given-array/](https://www.geeksforgeeks.org/find-the-sum-of-non-prime-elements-in-the-given-array/)
...
**方法：** 初始化 `sum = 0` 并开始逐元素遍历数组元素，如果当前元素不是素数，则更新 `sum = sum + arr[i]`。最后打印 `sum`。可以使用厄拉多塞的筛法对素性进行最佳测试。
