...
> 原文: [https://www.geeksforgeeks.org/number-sextuplets-six-values-satisfy-equation/](https://www.geeksforgeeks.org/number-sextuplets-six-values-satisfy-equation/)

给定一组 `n` 个元素。任务是找到满足下面等式的六个组的数量，使得 `a`、`b`、`c`、`d`、`e` 和 `f` 属于给定的数组:
