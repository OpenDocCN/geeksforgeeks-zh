...
> 原文：[https://www.geeksforgeeks.org/right-most-non-zero-digit-in-multiplication-of-array-elements/](https://www.geeksforgeeks.org/right-most-non-zero-digit-in-multiplication-of-array-elements/)

给定非负整数的数组`arr[]`和大小`N`。任务是找到数组元素乘积中最右边的非零数字。
