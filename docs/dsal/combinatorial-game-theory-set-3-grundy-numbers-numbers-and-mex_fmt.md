...
> 原文: [https://www.geeksforgeeks.org/combinatorial-game-theory-set-3-grundy-numbers-numbers-and-mex/](https://www.geeksforgeeks.org/combinatorial-game-theory-set-3-grundy-numbers-numbers-and-mex/)
...
一旦我们使用斯普拉格-格伦迪定理计算出与任何不偏不倚的游戏（不仅仅是尼姆的游戏）相关的格伦迪数，那么格伦迪数或数字就决定了如何求解该游戏。但是在计算 Grundy 数之前，我们需要了解另一个术语——Mex。
