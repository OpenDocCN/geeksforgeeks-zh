...
> 原文: [https://www.geeksforgeeks.org/generate-all-numbers-up-to-n-in-lexicographical-order/](https://www.geeksforgeeks.org/generate-all-numbers-up-to-n-in-lexicographical-order/)
...
*   使用 `DFS`: 始终将 `temp` 乘以 10，直到 `temp * 10` 大于 `n`。
