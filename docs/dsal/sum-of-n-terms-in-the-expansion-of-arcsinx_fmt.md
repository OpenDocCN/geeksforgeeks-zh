...
> 原文: [https://www.geeksforgeeks.org/sum-of-n-terms-in-the-expansion-of-arcsinx/](https://www.geeksforgeeks.org/sum-of-n-terms-in-the-expansion-of-arcsinx/)
...
> **输入:** `N = 4`，`X = 0.5`
> **输出:** `0.5233863467`
> 对 `x = 0.5` 的反正弦(X)展开的前 4 项之和为 `0.5233863467`。
> **输入:** `N = 8`，`X = -0.5`
> **输出:** `-0.5233948501`
