...
> 原文: [https://www.geeksforgeeks.org/group-consecutive-characters-of-same-type-in-a-string/](https://www.geeksforgeeks.org/group-consecutive-characters-of-same-type-in-a-string/)
...
删除字符串中的所有空格。删除所有空格后，逐个遍历字符串，并根据字符的 ASCII 值对其进行分组。
以下是上述办法的实施情况:
