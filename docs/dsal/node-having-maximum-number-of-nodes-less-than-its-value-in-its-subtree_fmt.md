...
> 原文：[https://www.geeksforgeeks.org/node-having-maximum-number-of-nodes-less-than-its-value-in-its-subtree/](https://www.geeksforgeeks.org/node-having-maximum-number-of-nodes-less-than-its-value-in-its-subtree/)
...
思路是使用[后序遍历](https://www.geeksforgeeks.org/iterative-postorder-traversal/)。以下是步骤：
