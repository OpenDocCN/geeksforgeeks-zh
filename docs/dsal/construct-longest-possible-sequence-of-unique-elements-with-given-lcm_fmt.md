...
> 原文: [https://www.geeksforgeeks.org/construct-longest-possible-sequence-of-unique-elements-with-given-lcm/](https://www.geeksforgeeks.org/construct-longest-possible-sequence-of-unique-elements-with-given-lcm/)
...
*   初始化一个[数组](https://www.geeksforgeeks.org/vector-in-cpp-stl/)，比如说 `newArr[]`，来存储所有唯一的数组元素，这些元素的 LCM 等于 `N`。
*   [找到 `N` 的所有因子](https://www.geeksforgeeks.org/find-divisors-natural-number-set-1/)，储存在 `newArr[]` 中。
*   [排序数组](https://www.geeksforgeeks.org/sort-c-stl/) `newArr[]`。
*   [打印所有 `newArr` 的数组元素](https://www.geeksforgeeks.org/print-distinct-elements-given-integer-array/)。
