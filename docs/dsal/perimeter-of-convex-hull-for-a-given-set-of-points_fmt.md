...
> 原文: [https://www.geeksforgeeks.org/perimeter-of-convex-hull-for-a-given-set-of-points/](https://www.geeksforgeeks.org/perimeter-of-convex-hull-for-a-given-set-of-points/)

给定 `n` 个二维点 `点数[]`，任务是找到这组点的凸包周长。一组点的凸包是包含所有点的最小凸多边形。
