...
> 原文: [https://www.geeksforgeeks.org/operations-required-to-make-the-string-empty/](https://www.geeksforgeeks.org/operations-required-to-make-the-string-empty/)
...
找到字符串字符的唯一频率。唯一频率的总计数将是使字符串为空所需的操作数。
