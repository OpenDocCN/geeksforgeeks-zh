...
> 原文：[https://www.geeksforgeeks.org/program-calculate-distance-two-points/](https://www.geeksforgeeks.org/program-calculate-distance-two-points/)
...
我们将使用从毕达哥拉斯定理导出的**距离公式**。两点`(x1, y1)`和`(x2, y2)`之间的距离公式为
距离 = ![$\sqrt{(x2-x1)^{2} + (y2-y1)^{2}}$](img/83554de66e914edcab7f8a5b024e6fb5.png "Rendered by QuickLaTeX.com")
简单应用[毕达哥拉斯定理](https://en.wikipedia.org/wiki/Pythagorean_theorem)即可得到上述公式。
