# 可被 C 整除且不在 [A, B] 范围内的最小正整数

> 原文: [https://www.geeksforgeeks.org/minimum-positive-integer-divisible-by-c-and-is-not-in-range-a-b/](https://www.geeksforgeeks.org/minimum-positive-integer-divisible-by-c-and-is-not-in-range-a-b/)
