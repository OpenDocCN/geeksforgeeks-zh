...
> 原文: [https://www.geeksforgeeks.org/print-all-paths-of-the-binary-tree-with-maximum-element-in-each-path-greater-than-or-equal-to-k/](https://www.geeksforgeeks.org/print-all-paths-of-the-binary-tree-with-maximum-element-in-each-path-greater-than-or-equal-to-k/)
...
*   如果是，则将其插入到[向量](https://www.geeksforgeeks.org/vector-in-cpp-stl/)中，并将标志变量 `flag` 设置为 1。这表示将打印通过该节点的所有路径。
