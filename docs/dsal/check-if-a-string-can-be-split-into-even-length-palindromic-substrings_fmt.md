...
> 原文: [https://www.geeksforgeeks.org/check-if-a-string-can-be-split-into-even-length-palindromic-substrings/](https://www.geeksforgeeks.org/check-if-a-string-can-be-split-into-even-length-palindromic-substrings/)
...
思路是使用[栈数据结构](https://www.geeksforgeeks.org/stack-data-structure/)。以下是步骤:
