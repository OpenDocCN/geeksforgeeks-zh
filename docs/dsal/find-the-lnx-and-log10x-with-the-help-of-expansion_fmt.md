# 借助展开找到 ln(X) 和 log10(X)

> 原文: [https://www.geeksforgeeks.org/find-the-lnx-and-log10x-with-the-help-of-expansion/](https://www.geeksforgeeks.org/find-the-lnx-and-log10x-with-the-help-of-expansion/)

给定一个正数 `x`，任务是在展开的帮助下找到这个数的自然对数 (`ln`) 并记录到这个数的基数 10 (`log10`)。
