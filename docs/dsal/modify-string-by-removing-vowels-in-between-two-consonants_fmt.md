...
> 原文: [https://www.geeksforgeeks.org/modify-string-by-removing-vowels-in-between-two-consonants/](https://www.geeksforgeeks.org/modify-string-by-removing-vowels-in-between-two-consonants/)
...
> 因此，它从那里被移除，字符串变成`geeksgeeks`

**方法:** 初始化一个空的`updatedString`。下面给出了解决上述问题的步骤。
...
以下展示了如何用不同编程语言实现移除字符串中所有夹在两个辅音之间的元音。
