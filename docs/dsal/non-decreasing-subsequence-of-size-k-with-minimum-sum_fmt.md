...
> 原文：[https://www.geeksforgeeks.org/non-decreasing-subsequence-of-size-k-with-minimum-sum/](https://www.geeksforgeeks.org/non-decreasing-subsequence-of-size-k-with-minimum-sum/)
...
设 `solve(i, k)` 是以索引 `i` 结束的大小为 `k` 的子序列的最小和，那么将有两种状态：
