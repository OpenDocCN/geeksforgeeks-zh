...
> 原文：[https://www.geeksforgeeks.org/remove-one-bit-from-a-binary-number-to-get-maximum-value/](https://www.geeksforgeeks.org/remove-one-bit-from-a-binary-number-to-get-maximum-value/)
