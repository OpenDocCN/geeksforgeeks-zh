...
> 原文: [https://www.geeksforgeeks.org/check-if-subarray-with-given-product-exists-in-an-array/](https://www.geeksforgeeks.org/check-if-subarray-with-given-product-exists-in-an-array/)
...
该方法类似于[最大产品子阵](https://www.geeksforgeeks.org/maximum-product-subarray-set-3/)中使用的方法，唯一的任务是同时检查产品是否等于 `k`。以下是上述方法的实施:
