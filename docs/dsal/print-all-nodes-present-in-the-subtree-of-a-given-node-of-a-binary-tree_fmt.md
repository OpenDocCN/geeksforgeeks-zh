...
> 原文: [https://www.geeksforgeeks.org/print-all-nodes-present-in-the-subtree-of-a-given-node-of-a-binary-tree/](https://www.geeksforgeeks.org/print-all-nodes-present-in-the-subtree-of-a-given-node-of-a-binary-tree/)

给定两个[数组](https://www.geeksforgeeks.org/introduction-to-arrays/) `Node_ID[]` 和 `Parent_ID[]`，构造一个[二叉树](https://www.geeksforgeeks.org/binary-tree-data-structure/)，其中第 i 个节点的值等于 `Node_ID[i]`，第 i 个节点的父节点为 `Parent_ID[i]`。给定一个节点 `X`，任务是打印以 `X` 为根的树的节点值。
