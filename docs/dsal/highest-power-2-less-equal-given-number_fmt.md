...
> 原文: [https://www.geeksforgeeks.org/highest-power-2-less-equal-given-number/](https://www.geeksforgeeks.org/highest-power-2-less-equal-given-number/)
...
一个简单的解决方案是从 `n` 开始检查，一直递减，直到我们找到 2 的幂。
