...
> 原文：[https://www.geeksforgeeks.org/print-all-permutations-of-a-string-in-java/](https://www.geeksforgeeks.org/print-all-permutations-of-a-string-in-java/)
...
编写一个递归函数，打印给定字符串的每个排列。当传递的字符串为空时，将出现终止条件。
...
>
> **输入：** `str = "geek"`
> **输出：** `geek geke gkee egek egke eegk eekg ekge ekeg kgee kege keeg`
