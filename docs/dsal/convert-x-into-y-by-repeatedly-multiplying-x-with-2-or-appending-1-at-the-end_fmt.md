...
> 原文: [https://www.geeksforgeeks.org/convert-x-into-y-by-repeatedly-multiplying-x-with-2-or-appending-1-at-the-end/](https://www.geeksforgeeks.org/convert-x-into-y-by-repeatedly-multiplying-x-with-2-or-appending-1-at-the-end/)
...
*   迭代直到 `Y` 的值大于 `X` 并执行以下步骤:
    *   如果 `Y` 的最后一位的值为 `1`，那么将 `Y` 的值除以 `10`。
