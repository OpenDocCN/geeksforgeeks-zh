...
> 原文: [https://www.geeksforgeeks.org/queries-to-find-the-maximum-xor-value-between-x-and-the-nodes-of-a-given-level-of-a-perfect-binary-tree/](https://www.geeksforgeeks.org/queries-to-find-the-maximum-xor-value-between-x-and-the-nodes-of-a-given-level-of-a-perfect-binary-tree/)
...
> 因此，`2^5 = 7`，`3^5 = 6`。
> 因此，答案是 7。
> 第二次查询: 3 级有数字 4、5、6 和 7，`4^15 = 11` 是最大可能。
