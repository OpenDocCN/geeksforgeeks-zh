...
> 原文: [https://www.geeksforgeeks.org/top-20-backtracking-algorithm-interview-questions/](https://www.geeksforgeeks.org/top-20-backtracking-algorithm-interview-questions/)
...
5.  [使用正则表达式匹配模式和字符串](https://www.geeksforgeeks.org/match-a-pattern-and-string-without-using-regular-expressions/)
...
本文由 `Ayushmaan Bansal` 供稿。如果你喜欢 GeeksforGeeks 并想投稿，你也可以使用 `contribute.geeksforgeeks.org` 写一篇文章或者把你的文章邮寄到 `contribute@geeksforgeeks.org`。看到你的文章出现在极客博客主页上，帮助其他极客。
