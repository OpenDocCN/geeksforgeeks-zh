...
> 原文：[https://www.geeksforgeeks.org/count-array-elements-that-divide-the-sum-of-all-other-elements/](https://www.geeksforgeeks.org/count-array-elements-that-divide-the-sum-of-all-other-elements/)

给定一个数组 `arr[]`，任务是计算数组中能整除所有其他元素之和的元素数量。
