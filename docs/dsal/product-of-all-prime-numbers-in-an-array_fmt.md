...
> 原文: [https://www.geeksforgeeks.org/product-of-all-prime-numbers-in-an-array/](https://www.geeksforgeeks.org/product-of-all-prime-numbers-in-an-array/)
...
**高效方法:** 使用厄拉多塞的[筛](https://www.geeksforgeeks.org/sieve-of-eratosthenes/)生成数组中最大元素的所有素数，并将它们存储在哈希中。现在遍历数组，用筛子找出那些质数的乘积。
以下是上述方法的实施:
