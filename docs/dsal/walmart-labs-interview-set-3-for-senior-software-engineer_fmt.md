# 沃尔玛实验室面试|第 4 集(高级软件工程师)

> 原文:[https://www.geeksforgeeks.org/walmart-labs-interview-set-3-for-senior-software-engineer/](https://www.geeksforgeeks.org/walmart-labs-interview-set-3-for-senior-software-engineer/)
...
2) 壮丽喷泉
[https://www.hackerearth.com/problem/algorithm/magnificent-fountains/](https://www.hackerearth.com/problem/algorithm/magnificent-fountains/)
...
6) 解释 `JAVA` 内存模型。
7) 实例和实例之间的差异。
8) 可以覆盖`ArrayList`的方法吗？如果是，怎么做？
9) `HashMap`和`TreeMap`的区别
10) 解释`ConcurrentHashMap`。(我记不起还有几个了)
