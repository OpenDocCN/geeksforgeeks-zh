...
> 原文：[https://www.geeksforgeeks.org/area-of-a-circle-inscribed-in-a-regular-hexagon/](https://www.geeksforgeeks.org/area-of-a-circle-inscribed-in-a-regular-hexagon/)
...
我们取一个三角形 `OAB`，以 `O` 为六边形或圆的中心，`AB` 为六边形的一边。
