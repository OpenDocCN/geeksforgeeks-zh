...
> 原文: [https://www.geeksforgeeks.org/print-the-nearest-prime-number-formed-by-adding-prime-numbers-to-n/](https://www.geeksforgeeks.org/print-the-nearest-prime-number-formed-by-adding-prime-numbers-to-n/)
...
使用[厄拉多塞的筛](https://www.geeksforgeeks.org/sieve-of-eratosthenes/)，在 `isPrime[]` 列表中用 1 标记质数索引，并将所有质数存储在一个列表 `prime[]` 中。继续把质数按顺序加到 `N` 上，直到它变成质数。
