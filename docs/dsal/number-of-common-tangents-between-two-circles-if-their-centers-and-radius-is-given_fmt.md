...
> 原文: [https://www.geeksforgeeks.org/number-of-common-tangents-between-two-circles-if-their-centers-and-radius-is-given/](https://www.geeksforgeeks.org/number-of-common-tangents-between-two-circles-if-their-centers-and-radius-is-given/)
...
*   如果圆在外部相互接触，那么它们将有 3 条公共切线，两条直切线和一条横切线。中间的切线可以认为是重合在一起的横向切线。
