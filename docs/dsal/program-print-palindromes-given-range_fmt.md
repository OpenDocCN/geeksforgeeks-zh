...
> 原文：[https://www.geeksforgeeks.org/program-print-palindromes-given-range/](https://www.geeksforgeeks.org/program-print-palindromes-given-range/)

给定一个数字范围，打印给定范围内的所有回文。例如，如果给定的范围是{10，115}，那么输出应该是{11，22，33，44，55，66，77，88，99，101，111}。我们可以运行一个从最小值到最大值的循环，并检查每个数字的回文。如果数字是回文，我们可以简单地打印出来。
