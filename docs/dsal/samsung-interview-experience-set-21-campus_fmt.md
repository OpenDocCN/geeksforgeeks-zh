...
> 原文:[https://www.geeksforgeeks.org/samsung-interview-experience-set-21-campus/](https://www.geeksforgeeks.org/samsung-interview-experience-set-21-campus/)
...
2) [`快速排序算法`](https://practice.geeksforgeeks.org/problems/quick-sort/1):他问我最好的情况，最坏的情况时间复杂度以及一些我们看到最好情况和最坏情况的例子。然后他让我给`快速排序`编码。即使我在纸上写字，他也非常讲究缩进。然后他问我是否可以说`堆排序`和`合并排序`的时间复杂性。我全都回答了。
