...
> 原文：[https://www.geeksforgeeks.org/get-level-node-binary-tree-iterative-approach/](https://www.geeksforgeeks.org/get-level-node-binary-tree-iterative-approach/)
...
迭代方法讨论如下：
迭代方法是[级序树遍历](https://www.geeksforgeeks.org/level-order-tree-traversal/)的修改版本。
