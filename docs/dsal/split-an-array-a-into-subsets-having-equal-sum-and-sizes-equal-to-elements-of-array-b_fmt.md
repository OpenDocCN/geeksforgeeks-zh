...
> 原文: [https://www.geeksforgeeks.org/split-an-array-a-into-subsets-having-equal-sum-and-sizes-equal-to-elements-of-array-b/](https://www.geeksforgeeks.org/split-an-array-a-into-subsets-having-equal-sum-and-sizes-equal-to-elements-of-array-b/)
...
**时间复杂度:** `O(N^3)`
**辅助空间:** `O(2^maxm)`，其中 `maxm` 是数组 `B[]` 中的最大元素。