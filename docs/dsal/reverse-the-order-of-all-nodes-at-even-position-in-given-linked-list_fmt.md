...
> 原文：[https://www.geeksforgeeks.org/reverse-the-order-of-all-nodes-at-even-position-in-given-linked-list/](https://www.geeksforgeeks.org/reverse-the-order-of-all-nodes-at-even-position-in-given-linked-list/)
...
> **输入：** `A[] = 1->2->3->4->5->6->NULL`
> **输出：** `1 6 3 4 5 2`
> **说明：** 给定链表中偶数位置的节点为 2、4 和 6。所以，在颠倒了那里的顺序之后，新的链表将是 `1->6->3->4->5->2->NULL`。
>
> **输入：** `A[] = 1->5->3->NULL`
> **输出：** `1 5 3`
