...
> 原文:[https://www.geeksforgeeks.org/sum-of-all-perfect-numbers-lying-in-the-range-l-r/](https://www.geeksforgeeks.org/sum-of-all-perfect-numbers-lying-in-the-range-l-r/)
...
*   预计算所花费的时间是`O(K * sqrt(K))`，其中`K`是正在执行预计算的数字。
*   预计算后，在`O(1)`中回答每个查询。
