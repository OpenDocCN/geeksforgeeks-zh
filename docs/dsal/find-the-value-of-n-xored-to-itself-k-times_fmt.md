...
> 原文: [https://www.geeksforgeeks.org/find-the-value-of-n-xored-to-itself-k-times/](https://www.geeksforgeeks.org/find-the-value-of-n-xored-to-itself-k-times/)
...
**有效方法:** 从属性 `X XOR X = 0` 和 `X ^ 0 = X` 可以观察到，当 `K` 为奇数时，答案将是 `N` 本身，否则答案将是 `0`。
