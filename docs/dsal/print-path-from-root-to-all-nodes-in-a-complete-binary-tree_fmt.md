...
> 原文: [https://www.geeksforgeeks.org/print-path-from-root-to-all-nodes-in-a-complete-binary-tree/](https://www.geeksforgeeks.org/print-path-from-root-to-all-nodes-in-a-complete-binary-tree/)
...
`解释`：因为，给定的树是一个完整的二叉树。对于每个节点 `i`，我们可以将其左子节点计算为 `2*i`，右子节点计算为 `2*i + 1`。
