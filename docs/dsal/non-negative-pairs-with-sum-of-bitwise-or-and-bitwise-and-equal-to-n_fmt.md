...
> 原文: [https://www.geeksforgeeks.org/non-negative-pairs-with-sum-of-bitwise-or-and-bitwise-and-equal-to-n/](https://www.geeksforgeeks.org/non-negative-pairs-with-sum-of-bitwise-or-and-bitwise-and-equal-to-n/)
...
最简单的方法是迭代范围 `[0, N]` 并打印那些满足条件 `(A | B) + (A & B) = N` 的对 `(A, B)`。
...
优化上述方法，其思想是基于所有和等于 `N` 的非负对满足给定条件的观察。因此，使用变量 `i` 迭代范围 `[0, N]`，并打印对 `i` 和 `(N - i)`。
