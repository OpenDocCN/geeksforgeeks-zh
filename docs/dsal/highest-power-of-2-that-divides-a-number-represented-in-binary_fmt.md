...
> 原文: [https://www.geeksforgeeks.org/highest-power-of-2-that-divides-a-number-represented-in-binary/](https://www.geeksforgeeks.org/highest-power-of-2-that-divides-a-number-represented-in-binary/)
...
从右边开始，计算二进制表示中的 0 的个数，这是 2 的最高幂，它将除以这个数。
