...
> 原文: [https://www.geeksforgeeks.org/sum-of-quotients-of-division-of-n-by-powers-of-k-not-exceeding-n/](https://www.geeksforgeeks.org/sum-of-quotients-of-division-of-n-by-powers-of-k-not-exceeding-n/)
...
思路是在 `K` 当前功率小于或等于 `N` 的情况下[迭代一个循环](https://www.geeksforgeeks.org/loops-in-c-and-cpp/)，每次迭代不断将商加和。
按照以下步骤解决问题:

*   初始化一个变量，比如 `ans`，来存储需要的和。
