...
> 原文: [https://www.geeksforgeeks.org/height-of-factor-tree-for-a-given-number/](https://www.geeksforgeeks.org/height-of-factor-tree-for-a-given-number/)

给定一个正整数 `N`，任务是找到给定整数 `N` 的[因子树](https://www.geeksforgeeks.org/factor-tree-of-a-given-number/)的高度。
