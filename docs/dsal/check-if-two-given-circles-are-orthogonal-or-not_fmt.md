...
> 原文: [https://www.geeksforgeeks.org/check-if-two-given-circles-are-orthogonal-or-not/](https://www.geeksforgeeks.org/check-if-two-given-circles-are-orthogonal-or-not/)
