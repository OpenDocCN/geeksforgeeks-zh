...
> 原文：[https://www.geeksforgeeks.org/number-of-cells-in-the-nth-order-figure/](https://www.geeksforgeeks.org/number-of-cells-in-the-nth-order-figure/)

给定一个整数 `N`，任务是找到给定类型的 `N` 阶图中的单元格数：
...
可以观察到，对于 `N = 1、2、3、…` 的值，一个系列将形成为 `1、5、13、25、41、61、85、113、145、181、…`，其 `N` 项将为 `N^2 + (N–1)^2`。
