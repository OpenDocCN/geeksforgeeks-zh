...
> 原文：[https://www.geeksforgeeks.org/shortest-path-to-traverse-all-the-elements-of-a-circular-array-in-increasing-order/](https://www.geeksforgeeks.org/shortest-path-to-traverse-all-the-elements-of-a-circular-array-in-increasing-order/)
...
**方法：** 如果我们想在两个有指数的元素 `i` 和 `j` 之间旅行，我们有两条可能的路径，一条是长度 `|i - j|`，另一条是长度 `n - |i - j|`，我们会选择距离最小的一条。
