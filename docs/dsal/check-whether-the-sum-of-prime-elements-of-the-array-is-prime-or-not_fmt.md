...
> 原文: [https://www.geeksforgeeks.org/check-whether-the-sum-of-prime-elements-of-the-array-is-prime-or-not/](https://www.geeksforgeeks.org/check-whether-the-sum-of-prime-elements-of-the-array-is-prime-or-not/)
...
**方法:** 首先使用[筛法](https://www.geeksforgeeks.org/sieve-of-eratosthenes/)找到 `10^5` 的素数。然后迭代数组的所有元素。如果这个数是质数，那就把它加到和上。最后，检查总和是否为质数。如果是，则打印 **Yes** 否则 **No**。
