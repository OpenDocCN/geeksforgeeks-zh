...
> 原文: [https://www.geeksforgeeks.org/queries-to-count-integers-in-a-range-l-r-such-that-their-digit-sum-is-prime-and-divisible-by-k/](https://www.geeksforgeeks.org/queries-to-count-integers-in-a-range-l-r-such-that-their-digit-sum-is-prime-and-divisible-by-k/)
...
*   取标记数组的前缀和。
*   通过 `prefix[R] - prefix[L - 1]` 回答给定的查询。
