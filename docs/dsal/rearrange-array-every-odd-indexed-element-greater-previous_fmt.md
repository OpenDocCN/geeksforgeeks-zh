...
> 原文：[https://www.geeksforgeeks.org/rearrange-array-every-odd-indexed-element-greater-previous/](https://www.geeksforgeeks.org/rearrange-array-every-odd-indexed-element-greater-previous/)
...
如果给定的数组具有偶数长度，那么它可以在一次运行中完成。对于每对邻居，将最大值放在奇数位置，最小值放在偶数位置。所以我们从一开始就开始一个循环，每两个元素进行比较。假设`6，5，4，3，2，1`会给我们`5，6，3，4，1，2`。
