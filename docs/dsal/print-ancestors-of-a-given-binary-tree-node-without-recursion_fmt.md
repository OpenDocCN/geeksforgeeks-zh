...
> 原文: [https://www.geeksforgeeks.org/print-ancestors-of-a-given-binary-tree-node-without-recursion/](https://www.geeksforgeeks.org/print-ancestors-of-a-given-binary-tree-node-without-recursion/)
...
<script>
    ...
    function printAncestors(root, key)
    {
        ...
        while (true)
        {
            ...
            // set the root as right child of top
            // and start traversing right sub-tree.
            root = st.length == 0 ? null : st[st.length - 1].right;
        }
