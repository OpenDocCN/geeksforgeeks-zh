...
> 原文: [https://www.geeksforgeeks.org/print-given-sentence-equivalent-ascii-form/](https://www.geeksforgeeks.org/print-given-sentence-equivalent-ascii-form/)
...
转换成等价 ASCII 句子的时间复杂度是 `O(len)`，其中 `len` 是字符串的长度。
