...
> 原文: [https://www.geeksforgeeks.org/second-order-eulerian-numbers/](https://www.geeksforgeeks.org/second-order-eulerian-numbers/)
...
> **输入:** `N = 0`
> **输出:** 1
> ![0^{th} 项](img/d910b3e9696cad744b227b635dc025b2.png "Rendered by QuickLaTeX.com") = 1
> **输入:** `N = 4`
> **输出:** 8

## 方法

想法是找到二阶欧拉数的一般项。下面是二阶欧拉数一般项的计算:
...
**参考:** [OEIS A000295](https://oeis.org/A000295)