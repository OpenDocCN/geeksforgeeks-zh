...
> 原文：[https://www.geeksforgeeks.org/find-original-numbers-from-gcd-every-pair/](https://www.geeksforgeeks.org/find-original-numbers-from-gcd-every-pair/)
...
以下展示了使用 C#、PHP 和 JavaScript 实现同一算法的代码。
