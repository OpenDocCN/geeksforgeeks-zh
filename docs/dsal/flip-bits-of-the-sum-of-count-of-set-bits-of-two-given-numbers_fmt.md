...
> 原文: [https://www.geeksforgeeks.org/flip-bits-of-the-sum-of-count-of-set-bits-of-two-given-numbers/](https://www.geeksforgeeks.org/flip-bits-of-the-sum-of-count-of-set-bits-of-two-given-numbers/)
...
解决这个问题的想法是首先遍历两个数字的二进制表示，然后计算两个数字中设置位的数量。最后，将它们相加并反转结果数的位。
