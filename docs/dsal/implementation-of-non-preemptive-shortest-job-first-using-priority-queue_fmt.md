...
> 原文: [https://www.geeksforgeeks.org/implementation-of-non-preemptive-shortest-job-first-using-priority-queue/](https://www.geeksforgeeks.org/implementation-of-non-preemptive-shortest-job-first-using-priority-queue/)
...
*   保持当前运行时间，即已执行进程的突发时间总和。
    *   一个进程根据它的到达时间进入等待队列，如果一个新进程的到达时间小于等于当前运行时间，它将被推入等待队列。
