...
> 原文：[https://www.geeksforgeeks.org/check-given-circle-lies-completely-inside-ring-formed-two-concentric-circles/](https://www.geeksforgeeks.org/check-given-circle-lies-completely-inside-ring-formed-two-concentric-circles/)
...
同心圆是那些圆心相同的圆。位于两个同心圆之间的区域称为环或圆环。
