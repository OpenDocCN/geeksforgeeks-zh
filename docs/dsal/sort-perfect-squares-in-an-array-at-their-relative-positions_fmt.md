...
> 原文: [https://www.geeksforgeeks.org/sort-perfect-squares-in-an-array-at-their-relative-positions/](https://www.geeksforgeeks.org/sort-perfect-squares-in-an-array-at-their-relative-positions/)

给定一个整数数组 `arr[]`，任务是只对在数组中相对位置为完美正方形的元素进行排序（不得影响其他元素的位置）。
