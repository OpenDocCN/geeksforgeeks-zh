...
> 原文: [https://www.geeksforgeeks.org/program-to-find-the-xor-of-ascii-values-of-characters-in-a-string/](https://www.geeksforgeeks.org/program-to-find-the-xor-of-ascii-values-of-characters-in-a-string/)
...
**做法:** 思路是[逐个找出每个字符](https://www.geeksforgeeks.org/program-print-ascii-value-character/)的 ASCII 值，再找出这些值的 [XOR 值。](https://www.geeksforgeeks.org/calculate-xor-1-n/)
以下是上述方法的实现:
