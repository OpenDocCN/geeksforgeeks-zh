...
> 原文：[https://www.geeksforgeeks.org/calculate-difficulty-sentence/](https://www.geeksforgeeks.org/calculate-difficulty-sentence/)
...
*   否则检查一个单词是否完成，辅音的数量是否大于元音的数量，则该单词为硬单词，否则为易单词。将所有计数重置为 0。
