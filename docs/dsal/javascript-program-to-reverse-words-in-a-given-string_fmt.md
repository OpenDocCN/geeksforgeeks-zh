...
> 原文：[https://www.geeksforgeeks.org/javascript-program-to-reverse-words-in-a-given-string/](https://www.geeksforgeeks.org/javascript-program-to-reverse-words-in-a-given-string/)

## 例

让输入字符串为“我很喜欢这个程序”。该函数应该将字符串更改为“非常像我这样的程序”。
