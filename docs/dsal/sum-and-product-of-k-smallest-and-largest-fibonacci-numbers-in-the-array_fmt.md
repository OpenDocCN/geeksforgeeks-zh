...
想法是使用[哈希](http://www.geeksforgeeks.org/hashing-data-structure/)预先计算并存储[斐波纳契节点](https://www.geeksforgeeks.org/program-for-nth-fibonacci-number/)到最大值，并将其存储在[集合](https://www.geeksforgeeks.org/set-in-java/)中，使检查变得容易和高效（在`O(1)`时间内）。
