...
> 原文: [https://www.geeksforgeeks.org/check-if-given-binary-string-follows-then-given-condition-or-not/](https://www.geeksforgeeks.org/check-if-given-binary-string-follows-then-given-condition-or-not/)
...
1.  检查第 0 个字符是否为 `'1'`。如果不是 `'1'`，则返回 `false`，因为字符串不符合条件 1。
