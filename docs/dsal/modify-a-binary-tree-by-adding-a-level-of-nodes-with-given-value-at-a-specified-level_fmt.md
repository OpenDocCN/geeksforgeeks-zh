...
> 原文: [https://www.geeksforgeeks.org/modify-a-binary-tree-by-adding-a-level-of-nodes-with-given-value-at-a-specified-level/](https://www.geeksforgeeks.org/modify-a-binary-tree-by-adding-a-level-of-nodes-with-given-value-at-a-specified-level/)
...
使用[广度优先搜索](https://www.geeksforgeeks.org/breadth-first-traversal-for-a-graph/)遍历树，在 `(L–1)` 级的节点与其左右子树的根之间添加给定值的节点，即可解决给定的问题。按照以下步骤解决问题:
