...
> 原文: [https://www.geeksforgeeks.org/check-whether-a-given-number-is-an-ugly-number-or-not/](https://www.geeksforgeeks.org/check-whether-a-given-number-is-an-ugly-number-or-not/)
...
思路是用[递归](https://www.geeksforgeeks.org/recursion/)解决这个问题，检查一个数是否能被 2、3 或 5 整除。如果是，然后除以那个数，递归地检查一个数是否是一个丑陋的数。如果在任何时候，没有这样的除数，那么返回假，否则返回真。
