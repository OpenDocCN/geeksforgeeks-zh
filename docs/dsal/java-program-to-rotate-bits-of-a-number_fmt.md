...
> 原文：[https://www.geeksforgeeks.org/java-program-to-rotate-bits-of-a-number/](https://www.geeksforgeeks.org/java-program-to-rotate-bits-of-a-number/)
...
```java
// Java code to rotate bits of number
class GFG {
