...
> 原文: [https://www.geeksforgeeks.org/print-all-the-sum-pairs-which-occur-maximum-number-of-times/](https://www.geeksforgeeks.org/print-all-the-sum-pairs-which-occur-maximum-number-of-times/)

给定不同整数的数组`arr[]`和`N`。任务是求两个数组整数的和`a[i] + a[j]`，出现次数最多。如果有多个答案，请全部打印出来。
