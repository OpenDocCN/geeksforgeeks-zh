...
> 原文: [https://www.geeksforgeeks.org/remove-one-element-to-get-maximum-xor/](https://www.geeksforgeeks.org/remove-one-element-to-get-maximum-xor/)
...
一种方法是逐个移除每个元素，然后找到剩余元素的异或。这种方法的时间复杂度为 `O(N^2)`。
