...
> 原文: [https://www.geeksforgeeks.org/c-cpp-program-to-find-prime-numbers-between-given-range/](https://www.geeksforgeeks.org/c-cpp-program-to-find-prime-numbers-between-given-range/)

给定两个数字 `L` 和 `R`，任务是在 `L` 和 `R` 之间找到[质数](https://www.geeksforgeeks.org/prime-numbers/)。
