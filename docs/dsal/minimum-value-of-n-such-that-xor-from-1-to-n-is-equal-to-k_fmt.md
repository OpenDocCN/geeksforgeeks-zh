...
> 原文: [https://www.geeksforgeeks.org/minimum-value-of-n-such-that-xor-from-1-to-n-is-equal-to-k/](https://www.geeksforgeeks.org/minimum-value-of-n-such-that-xor-from-1-to-n-is-equal-to-k/)
...
这个问题类似于[从 1 到 n 计算异或](https://www.geeksforgeeks.org/calculate-xor-1-n/)。以下是需要检查的条件:
