...
> 原文：[https://www.geeksforgeeks.org/program-for-reversed-string-pattern/](https://www.geeksforgeeks.org/program-for-reversed-string-pattern/)

给定字符串`str`作为输入。任务是打印模式，如示例所示。
