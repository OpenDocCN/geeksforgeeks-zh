...
> 原文：[https://www.geeksforgeeks.org/path-traversed-using-exactly-m-coins-in-k-jumps/](https://www.geeksforgeeks.org/path-traversed-using-exactly-m-coins-in-k-jumps/)
...
第二跳：5 号箱 -> 1 号箱，因此，`|5-1| = 4` 使用了 4 枚硬币。
第三跳：1 号箱 -> 4 号箱，使用 3 枚硬币。
第四跳：4 号箱 -> 5 号箱，使用 1 枚硬币。
