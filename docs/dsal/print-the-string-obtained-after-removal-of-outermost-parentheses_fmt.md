...
> 原文: [https://www.geeksforgeeks.org/print-the-string-obtained-after-removal-of-outermost-parentheses/](https://www.geeksforgeeks.org/print-the-string-obtained-after-removal-of-outermost-parentheses/)
...
思路是[迭代字符串](https://www.geeksforgeeks.org/iterate-over-characters-of-a-string-in-c/)的字符，分别统计字符串两端连续的左括号和右括号的个数。然后，[遍历出现在内部字符串中的字符](https://www.geeksforgeeks.org/iterate-over-characters-of-a-string-in-c/)，并计算平衡字符串所需的左括号的数量。按照以下步骤解决问题:
