...
> 原文: [https://www.geeksforgeeks.org/find-the-nth-digit-in-the-proper-fraction-of-two-numbers/](https://www.geeksforgeeks.org/find-the-nth-digit-in-the-proper-fraction-of-two-numbers/)

给定三个整数 `P`、`Q` 和 `N`，其中 `P < Q`，任务是计算 `P / Q` 的分数值，并找到小数点后的 `N`th 位。
