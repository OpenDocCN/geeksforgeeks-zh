...
> 原文: [https://www.geeksforgeeks.org/printing-maximum-sum-increasing-subsequence/](https://www.geeksforgeeks.org/printing-maximum-sum-increasing-subsequence/)
...
以上动态规划解的时间复杂度为 O(n <sup>2</sup> )。
程序使用的辅助空间为 O(n <sup>2</sup> )。
