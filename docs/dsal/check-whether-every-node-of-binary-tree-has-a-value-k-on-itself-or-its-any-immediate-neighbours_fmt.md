...
> 原文: [https://www.geeksforgeeks.org/check-whether-every-node-of-binary-tree-has-a-value-k-on-itself-or-its-any-immediate-neighbours/](https://www.geeksforgeeks.org/check-whether-every-node-of-binary-tree-has-a-value-k-on-itself-or-its-any-immediate-neighbours/)

给定一个[二叉树](https://www.geeksforgeeks.org/binary-tree-data-结构/)和值 `K`，任务是检查二叉树的每个节点是将该节点的值作为 `K`，还是至少其一个相邻的连接节点具有值 `K`。
