...
> 原文：[https://www.geeksforgeeks.org/javascript-program-to-delete-n-nodes-after-m-nodes-of-a-linked-list/](https://www.geeksforgeeks.org/javascript-program-to-delete-n-nodes-after-m-nodes-of-a-linked-list/)
...
问题的主要部分是维护节点之间的适当链接，确保所有的角落案例都得到处理。下面是 `skipMdeleteN()` 函数的实现，它跳过 `M` 个节点，删除 `N` 个节点，直到列表结束。假设 `M` 不能为 0。
...
更多详情请参考完整文章：[删除链表 M 个节点后的 N 个节点！](https://www.geeksforgeeks.org/delete-n-nodes-after-m-nodes-of-a-linked-list/)