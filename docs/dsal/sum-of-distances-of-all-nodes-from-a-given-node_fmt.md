...
> 原文：[https://www.geeksforgeeks.org/sum-of-distances-of-all-nodes-from-a-given-node/](https://www.geeksforgeeks.org/sum-of-distances-of-all-nodes-from-a-given-node/)
...
> `sumDists(父节点(u))`：所有节点到节点 `u` 的父节点的距离之和
> `u`
...
上述方法可以通过添加一个额外的变量来优化，比如说`大小`，以表示节点结构中其左右子树中的节点数。这将计算子树的[大小的任务减少到恒定的计算时间](https://www.geeksforgeeks.org/calculate-number-nodes-subtrees-using-dfs/)
