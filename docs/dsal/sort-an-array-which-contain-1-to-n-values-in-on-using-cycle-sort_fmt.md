...
> 原文: [https://www.geeksforgeeks.org/sort-an-array-which-contain-1-to-n-values-in-on-using-cycle-sort/](https://www.geeksforgeeks.org/sort-an-array-which-contain-1-to-n-values-in-on-using-cycle-sort/)
...
> **输出:** 1 2 3 4 5
> **解释:**
> 既然 `arr[0] = 2` 不在正确位置，那么用 `arr[arr[0]–1]` 交换 `arr[0]`，现在数组变成: `arr[] = {1, 2, 5, 4, 3}`
