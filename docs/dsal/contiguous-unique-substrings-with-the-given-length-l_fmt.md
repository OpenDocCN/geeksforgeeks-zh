...
> 原文：[https://www.geeksforgeeks.org/contiguous-unique-substrings-with-the-given-length-l/](https://www.geeksforgeeks.org/contiguous-unique-substrings-with-the-given-length-l/)

给定一个字符串 `str` 和一个整数 `L`。任务是从字符串 `str` 打印所有长度为 `L` 的唯一子字符串。
