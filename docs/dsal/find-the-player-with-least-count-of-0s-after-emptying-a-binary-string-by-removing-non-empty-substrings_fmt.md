# 通过移除非空子串在清空一个二进制串后找到最少为 0 的玩家

> 原文：[https://www.geeksforgeeks.org/find-the-player-with-least-count-of-0s-after-emptying-a-binary-string-by-removing-non-empty-substrings/](https://www.geeksforgeeks.org/find-the-player-with-least-count-of-0s-after-emptying-a-binary-string-by-removing-non-empty-substrings/)
...
*   给定字符串清空后，最小计数为 `0` 的玩家将赢得游戏。如果两个玩家的 `0` 相同，则打印“**平局**”。
...
*   如果字符串中 `0` 的计数是[偶数](https://www.geeksforgeeks.org/c-program-to-check-whether-a-given-number-is-even-or-odd/)，那么玩家 1 和玩家 2 每回合选择子字符串 `"0"`，没有玩家会赢这场游戏。
*   否则，将连续 `1` 的计数存储在一个数组中，并在该数组中应用 nim 规则的[游戏](https://www.geeksforgeeks.org/combinatorial-game-theory-set-2-game-nim/)。
...
*   [遍历数组](https://www.geeksforgeeks.org/c-program-to-traverse-an-array/)，计算 `0` 的个数、`nimSum`。
*   最后，[检查 `cntZero` 的值是否为偶数](https://www.geeksforgeeks.org/c-program-to-check-whether-a-given-number-is-even-or-odd/)。如果发现属实，则打印“**Tie**”。
