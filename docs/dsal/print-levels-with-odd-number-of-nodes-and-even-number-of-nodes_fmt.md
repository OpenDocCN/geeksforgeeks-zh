...
> 原文: [https://www.geeksforgeeks.org/print-levels-with-odd-number-of-nodes-and-even-number-of-nodes/](https://www.geeksforgeeks.org/print-levels-with-odd-number-of-nodes-and-even-number-of-nodes/)
...
*   将所有连接节点插入二维向量树。
*   在树上运行 [DFS](https://www.geeksforgeeks.org/depth-first-traversal-for-a-graph/) ，使`height[节点]` = 1 +`height[父节点]`
