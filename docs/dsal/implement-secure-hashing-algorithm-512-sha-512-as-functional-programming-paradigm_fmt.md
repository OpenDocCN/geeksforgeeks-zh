...
> 原文: [https://www.geeksforgeeks.org/implement-secure-hashing-algorithm-512-sha-512-as-functional-programming-paradigm/](https://www.geeksforgeeks.org/implement-secure-hashing-algorithm-512-sha-512-as-functional-programming-paradigm/)

给定一个长度为 `N` 的[字符串](https://www.geeksforgeeks.org/string-data-structure/) `S`，任务是找到给定字符串 `S` 的 [SHA-512 哈希值](https://www.geeksforgeeks.org/sha-512-hash-in-java/)。

## 示例

> **输入:** `s = "geeksforgeeks"`
> **输出:** `acc10c4e0b38617f59e88e4925e894afae5ec948c2af6f44903f039f9fe47a9210e01d5cd926c142bdc9179c2ad30f927a8f69421`
>
> **输入:** `s = "hello world"`
> **输出:** `309ecc489c112d6eb4cc40f2c902f4b4d0s0和77ee511a7c7a9bcd3ca86d4cd86f989dd35bc5ff49670da34255b45b0cfd830和81f605dcf`
...
*   [遍历阵列](https://www.geeksforgeeks.org/c-program-to-traverse-an-array/) `区块[]` 并执行以下步骤:
    ...
    *   现在，通过 `A`、`B`、`C`、`D`、`E`、`F`、`G`、`H` 的前值之和更新 `A` 的值 `H` 以及 `A`、`B`、`C`、`D`、`E`、`F`、`G`、`H` 的最新更新值。
