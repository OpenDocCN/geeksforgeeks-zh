...
> 原文: [https://www.geeksforgeeks.org/count-number-binary-strings-without-consecutive-1s/](https://www.geeksforgeeks.org/count-number-binary-strings-without-consecutive-1s/)
...
**来源:**
[http://courses.csail.mit.edu/6.006/oldquizzes/solutions/q2-f2009-sol.pdf](http://courses.csail.mit.edu/6.006/oldquizzes/solutions/q2-f2009-sol.pdf)
...
因此，我们也可以使用方法 5 来计算 `O(Log n)` 时间中的字符串。
