...
> 原文: [https://www.geeksforgeeks.org/sum-of-specially-balanced-nodes-from-a-given-binary-tree/](https://www.geeksforgeeks.org/sum-of-specially-balanced-nodes-from-a-given-binary-tree/)
...
思想是使用递归对给定的树执行 [`DFS 遍历`](https://www.geeksforgeeks.org/dfs-traversal-of-a-tree-using-recursion/)，并根据给定的条件更新最终的和。请遵循以下步骤:
