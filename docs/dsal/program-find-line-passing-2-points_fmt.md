...
> 原文: [https://www.geeksforgeeks.org/program-find-line-passing-2-points/](https://www.geeksforgeeks.org/program-find-line-passing-2-points/)
...
让给定的两点为 `P(x1, y1)` 和 `Q(x2, y2)`。现在，我们找到这些点形成的线的方程。
任意一条线都可以表示为，
`ax + by = c`
让两点满足给定的线。所以，我们有，
`ax1 + by1 = c`
