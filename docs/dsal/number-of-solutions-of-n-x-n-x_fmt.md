...
> 原文：[https://www.geeksforgeeks.org/number-of-solutions-of-n-x-n-x/](https://www.geeksforgeeks.org/number-of-solutions-of-n-x-n-x/)
...
我们可以看到 `x` 总是等于或小于 `n`，所以我们可以在 `[0, n]` 的范围内迭代，统计满足要求条件的值的个数。这种方法的时间复杂度是 `O(n)`。
