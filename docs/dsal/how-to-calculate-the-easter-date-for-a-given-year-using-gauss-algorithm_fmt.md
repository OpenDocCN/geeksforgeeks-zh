...
> 原文: [https://www.geeksforgeeks.org/how-to-calculate-the-easter-date-for-a-given-year-using-gauss-algorithm/](https://www.geeksforgeeks.org/how-to-calculate-the-easter-date-for-a-given-year-using-gauss-algorithm/)
...
*   `M` 取决于一年中的世纪 `Y`。对于 19 世纪，`M = 23`。对于 21 世纪，`M = 24` 等等。
    ...
    `P = floor(Y/100)`
    `Q = floor((13 + 8 * P) / 25)`
    `M = (15 - Q + P - floor(P / 4)) mod 30`
*   儒略历和公历的闰日数之差由下式给出:
    `N = (4 + P - floor(P / 4)) mod 7`
