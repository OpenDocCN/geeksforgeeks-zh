...
> 原文: [https://www.geeksforgeeks.org/find-minimum-number-of-log-value-needed-to-calculate-log-upto-n/](https://www.geeksforgeeks.org/find-minimum-number-of-log-value-needed-to-calculate-log-upto-n/)
...
因此，为了计算 `log(x.y)`，我们必须知道 `x` 和 `y` 的对数值。让 `ans` 表示从 1 到 6 查找所有日志值所需的日志值数量。
