...
> 原文：[https://www.geeksforgeeks.org/search-an-element-in-given-n-ranges/](https://www.geeksforgeeks.org/search-an-element-in-given-n-ranges/)
...
*   遍历所有范围。
*   检查条件是否 `K >= arr[i].first` 且 `K <= arr[i].second` 适用于任何迭代。
