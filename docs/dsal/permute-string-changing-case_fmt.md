...
> 原文：`https://www.geeksforgeeks.org/permute-string-changing-case/`
...
**方法 2（更好）：** 对于长度为 `n` 的字符串，存在 `2^n` 最大组合。我们可以将其表示为按位运算。在[打印所有子序列](https://www.geeksforgeeks.org/subarraysubstring-vs-subsequence-and-programs-to-generate-them/)中讨论了相同的想法。
