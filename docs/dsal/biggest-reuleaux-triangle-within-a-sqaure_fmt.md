...
> 原文：[https://www.geeksforgeeks.org/biggest-reuleaux-triangle-within-a-sqaure/](https://www.geeksforgeeks.org/biggest-reuleaux-triangle-within-a-sqaure/)

给定一个整数`a`，这是一个正方形的边，任务是找到最大的[勒乌三角](https://en.wikipedia.org/wiki/Reuleaux_triangle)，它可以被内接在里面。
...
**逼近**: 我们知道勒乌三角的[区域为`0.70477 * b^2`，其中`b`为支撑勒乌三角的平行线之间的距离。](https://www.geeksforgeeks.org/area-of-reuleaux-triangle/)
从图中可以清楚的看到，支撑勒鲁三角的平行线之间的距离=正方形的边即`a`
所以，勒鲁三角的面积，`A = 0.70477 * a^2`
