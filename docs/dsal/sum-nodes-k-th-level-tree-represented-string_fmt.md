...
> 原文: [https://www.geeksforgeeks.org/sum-nodes-k-th-level-tree-represented-string/](https://www.geeksforgeeks.org/sum-nodes-k-th-level-tree-represented-string/)
...
思想是将字符串视为树，而不实际创建一个树，简单地以 Postorder 方式递归遍历字符串，并考虑仅在 `k` 级的节点。
