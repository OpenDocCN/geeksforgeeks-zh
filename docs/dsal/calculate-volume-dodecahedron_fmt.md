...
> 原文: [https://www.geeksforgeeks.org/calculate-volume-dodecahedron/](https://www.geeksforgeeks.org/calculate-volume-dodecahedron/)

给定十二面体的边，计算它的体积。体积是形状占据的空间量。
一个`十二面体`是一个由 12 个面或平边组成的三维图形。所有的面都是同样大小的五角星。“十二面体”一词来源于希腊语中的“十二面体”和“面”。
