...
> 原文: [https://www.geeksforgeeks.org/second-largest-element-in-binary-search-tree-bst/](https://www.geeksforgeeks.org/second-largest-element-in-binary-search-tree-bst/)
...
function secondLargestUtil(node, C)
{
    ...
    // If c becomes k now, then this is the 2nd largest
    if (C.c == 2) {
        document.write("2nd largest element is "+ node.data);
        return;
    }
