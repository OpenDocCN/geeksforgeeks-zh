...
> 原文: [https://www.geeksforgeeks.org/shortest-distance-between-a-line-and-a-point-in-a-3-d-plane/](https://www.geeksforgeeks.org/shortest-distance-between-a-line-and-a-point-in-a-3-d-plane/)
...
如图构造 BP 和 CP，形成平行四边形。现在 C 是平行四边形 ABPC 的顶点，CD 垂直于 AB 面。因此，CD 是平行四边形的高度。
