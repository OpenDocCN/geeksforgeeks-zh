...
> 原文：[https://www.geeksforgeeks.org/sink-even-nodes-in-binary-tree/](https://www.geeksforgeeks.org/sink-even-nodes-in-binary-tree/)

给定具有奇数和偶数元素的二叉树，下沉其所有偶数值的节点，使得具有偶数值的节点不能是具有奇数值的节点的父节点。
