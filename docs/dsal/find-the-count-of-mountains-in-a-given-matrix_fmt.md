...
> 原文: [https://www.geeksforgeeks.org/find-the-count-of-mountains-in-a-given-matrix/](https://www.geeksforgeeks.org/find-the-count-of-mountains-in-a-given-matrix/)
...
想法是迭代矩阵，同时检查所有可能的 8 个方向上的相邻元素。如果元素大于所有元素，则递增计数器变量。最后，退回柜台。
