...
> 原文: [https://www.geeksforgeeks.org/sudo-placement-palindrome-family/](https://www.geeksforgeeks.org/sudo-placement-palindrome-family/)
...
3.  如果第二种情况不成立，那么如果 `evenString` 是回文，则打印“偶数回文”，否则如果 `oddString` 是回文，则打印“奇数回文”。
