...
> 原文: [https://www.geeksforgeeks.org/iterative-search-for-a-key-x-in-binary-tree/](https://www.geeksforgeeks.org/iterative-search-for-a-key-x-in-binary-tree/)
...
下面的实现使用 [`迭代前序遍历`](https://www.geeksforgeeks.org/iterative-preorder-traversal/) 在二叉树中寻找 `x`。
