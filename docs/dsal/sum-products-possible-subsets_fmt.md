...
> 原文：[https://www.geeksforgeeks.org/sum-products-possible-subsets/](https://www.geeksforgeeks.org/sum-products-possible-subsets/)
...
**天真法：** 简单的方法是[逐个生成所有可能的子集](https://www.geeksforgeeks.org/finding-all-subsets-of-a-given-set-in-java/)并计算所有元素的和。这种方法的时间复杂度是指数级的，因为总共有 `2^n`–1 个子集。
