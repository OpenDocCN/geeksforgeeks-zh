...
> 原文：[https://www.geeksforgeeks.org/quickhull-algorithm-convex-hull/](https://www.geeksforgeeks.org/quickhull-algorithm-convex-hull/)
...
**时间复杂度:**分析类似快速排序。平均来说，我们得到的时间复杂度为 `O(n Log n)`，但在最坏的情况下，它可能变成 `O(n^2)`。
