...
> 原文：[https://www.geeksforgeeks.org/number-of-sub-arrays-that-have-at-least-one-duplicate/](https://www.geeksforgeeks.org/number-of-sub-arrays-that-have-at-least-one-duplicate/)
...
*   现在找到所有元素都不同的子数组（可以使用[窗口滑动技术](https://www.geeksforgeeks.org/window-sliding-technique/)找到），并用 `unique` 表示。
*   最后，至少有一个元素重复的子数组的数量为 `(total - unique)`。
