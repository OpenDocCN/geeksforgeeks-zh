...
> 原文: [https://www.geeksforgeeks.org/print-indices-of-array-elements-whose-removal-makes-the-sum-of-odd-and-even-indexed-elements-equal/](https://www.geeksforgeeks.org/print-indices-of-array-elements-whose-removal-makes-the-sum-of-odd-and-even-indexed-elements-equal/)
...
**天真法:** 解决这个问题最简单的方法是[遍历数组](https://www.geeksforgeeks.org/c-program-to-traverse-an-array/)并从数组中移除 `i` 元素，检查奇数索引数组元素的和是否等于偶数索引数组元素的和。如果发现是真的，那么打印索引。
...
*   初始化两个数组，比如 `odd[]` 和 `even[]`，分别存储奇数和偶数索引数组元素的前缀和。
