...
> 原文: [https://www.geeksforgeeks.org/print-all-permutation-of-a-string-using-arraylist/](https://www.geeksforgeeks.org/print-all-permutation-of-a-string-using-arraylist/)
...
> **输入:** `str = "bat"`
> **输出:** bat bta abt atb tba tab

### 方法:

编写一个递归函数，它将生成字符串的所有排列。终止条件将是当传递的字符串为空时，在这种情况下，函数将返回一个空的[数组列表](https://www.geeksforgeeks.org/arraylist-in-java/)。
以下是上述方法的实施:
