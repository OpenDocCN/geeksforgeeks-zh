...
> 原文: [https://www.geeksforgeeks.org/count-all-possible-visited-cells-of-a-knight-after-n-moves/](https://www.geeksforgeeks.org/count-all-possible-visited-cells-of-a-knight-after-n-moves/)
...
**思路:** 思路很简单，我们从一个给定的位置出发，尝试所有可能的招式。每次移动后，递归调用`n-1`次移动。我们需要确保我们再也不去牢房了。我们制作一个访问布尔矩阵，作为访问矩阵，这样位置就不会重复。当我们访问一个位置时，在矩阵中将该位置标记为真。
