...
> 原文：[https://www.geeksforgeeks.org/program-to-check-if-n-is-a-star-number/](https://www.geeksforgeeks.org/program-to-check-if-n-is-a-star-number/)
...
3.  最后，检查使用此公式计算的值是否为整数，这意味着 `N` 是一个星形数。
