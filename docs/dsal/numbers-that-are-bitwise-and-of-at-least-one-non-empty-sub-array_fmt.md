...
> 原文: [https://www.geeksforgeeks.org/numbers-that-are-bitwise-and-of-at-least-one-non-empty-sub-array/](https://www.geeksforgeeks.org/numbers-that-are-bitwise-and-of-at-least-one-non-empty-sub-array/)
...
让我们从第 I 个元素 `A[i]` 开始一个子数组。当后续元素与 `A[i]` 进行“与”运算时，结果可以减少或保持不变(因为在“与”运算后，位永远不会从“0”变为“1”)。
