...
> 原文：[https://www.geeksforgeeks.org/boundary-root-to-leaf-path-traversal-of-a-binary-tree/](https://www.geeksforgeeks.org/boundary-root-to-leaf-path-traversal-of-a-binary-tree/)
...
function traverse_matrix(mtrx, height, width)
{
    ...
    for(let round = 0; round < parseInt(height / 2, 10); round++)
    {
        for(j = k2; j < width; j++)
        {
