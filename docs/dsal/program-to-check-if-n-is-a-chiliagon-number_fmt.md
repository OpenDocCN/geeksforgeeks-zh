...
> 原文: [https://www.geeksforgeeks.org/program-to-check-if-n-is-a-chiliagon-number/](https://www.geeksforgeeks.org/program-to-check-if-n-is-a-chiliagon-number/)

给定一个整数 `N`，任务是检查 `N` 是否为奇利亚贡数。如果编号 `N` 是一个[奇利亚贡编号](https://www.geeksforgeeks.org/chiliagon-number/)，则打印“是”，否则打印“否”。

> [**奇利亚贡数**](https://www.geeksforgeeks.org/chiliagon-number/) 是类俑数。它有一个 1000 边的多边形，叫做奇利亚贡。第 `N` 个奇利亚贡数字计算 1000 个点的数量，所有其他点被一个共同的共享角包围并形成一个图案。前几个奇利亚贡数字是 **1，1000，2997，5992，…**
