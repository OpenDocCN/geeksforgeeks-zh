...
> 原文：[https://www.geeksforgeeks.org/find-the-number-obtained-after-concatenation-of-binary-representation-of-m-and-n/](https://www.geeksforgeeks.org/find-the-number-obtained-after-concatenation-of-binary-representation-of-m-and-n/)
...
> 串接后，形成的结果二进制数为 `100101`，其十进制等效值为 `37`。
>
> **输入：** `M = 3`，`N = 4`
> **输出：** `28`
...
将数字 `M` 和 `N` 转换为二进制等价数，然后将这些数字连接为 `M + N`，并打印连接后形成的二进制数的十进制等价数。
