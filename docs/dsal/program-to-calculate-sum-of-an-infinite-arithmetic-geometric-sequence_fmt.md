...
> 原文: [https://www.geeksforgeeks.org/program-to-calculate-sum-of-an-infinite-arithmetic-geometric-sequence/](https://www.geeksforgeeks.org/program-to-calculate-sum-of-an-infinite-arithmetic-geometric-sequence/)
...
[算术几何级数](https://www.geeksforgeeks.org/sum-arithmetic-geometric-sequence/)的第 `N` 项由下式给出:
> `T_N = [a + (N - 1) * d] * (b * r^{n - 1})`
