...
> 原文: [https://www.geeksforgeeks.org/find-the-largest-n-digit-perfect-square-number-in-base-b/](https://www.geeksforgeeks.org/find-the-largest-n-digit-perfect-square-number-in-base-b/)
...
基数 `B` 中最大的数 `N` 由 `B^N - 1` 给出。所以如果我们[找到整数形式的这个数的平方根](https://www.geeksforgeeks.org/square-root-of-an-integer/)，然后我们必须再次求它的平方，那么它将是 `N` 位数的最大完美平方，由公式 `\left\lfloor\sqrt{B^N-1}\right\rfloor^2` 给出。
