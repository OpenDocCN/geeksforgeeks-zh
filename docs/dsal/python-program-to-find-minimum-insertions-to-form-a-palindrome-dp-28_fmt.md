...
> 原文: [https://www.geeksforgeeks.org/python-program-to-find-minimum-insertions-to-form-a-palindrome-dp-28/](https://www.geeksforgeeks.org/python-program-to-find-minimum-insertions-to-form-a-palindrome-dp-28/)
...
*   `abcda`: 需要的插入数为 2，即 `adcbcda`，与子串 `bcd` 中的插入数相同(为什么？).
