...
> 原文：[https://www.geeksforgeeks.org/subtraction-of-two-large-numbers-using-10s-compliment/](https://www.geeksforgeeks.org/subtraction-of-two-large-numbers-using-10s-compliment/)
...
> **输入：** `N = 10`，`str1 = "3434243434"`，`M = 14`，`str2 = "22324365765767"`
> **输出：** `22320931522333`
>
> **输入：** `N = 20`，`str1 = "1234533423242431433"`，`M = 20`，`str2 = "1234533423242431432"`
> **输出：** `1`

**方法：** 基本思路类似于[用 2 的补码](https://www.geeksforgeeks.org/subtraction-of-two-numbers-using-2s-complement/)减去两个数。

> 给定字符串的减法可以写成
> `str1 – str2 = str1 + (-str2) = str1 + (str2 的 10 补码)`
