...
> 原文: [https://www.geeksforgeeks.org/find-the-total-number-of-composite-factor-for-a-given-number/](https://www.geeksforgeeks.org/find-the-total-number-of-composite-factor-for-a-given-number/)
...
*   找到 `N` 的所有质因数，并将其存储在变量 `primeFactors` 中
*   现在，总合成因子将是 `totalFactors – primeFactors – 1` (减去 1，因为 1 既不是质数也不是合成数)。
