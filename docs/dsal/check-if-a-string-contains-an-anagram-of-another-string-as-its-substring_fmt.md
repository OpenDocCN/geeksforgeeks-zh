...
> 原文：[https://www.geeksforgeeks.org/check-if-a-string-contains-an-anagram-of-another-string-as-its-substring/](https://www.geeksforgeeks.org/check-if-a-string-contains-an-anagram-of-another-string-as-its-substring/)
...
1.  初始化两个[hashmap](https://www.geeksforgeeks.org/java-util-hashmap-in-java-with-examples/) `s1hash` 和 `s2hash`，存储两个字符串的字母出现频率。
