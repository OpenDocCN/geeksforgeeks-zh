...
> 原文: [https://www.geeksforgeeks.org/find-temperature-of-missing-days-using-given-sum-and-average/](https://www.geeksforgeeks.org/find-temperature-of-missing-days-using-given-sum-and-average/)
...
> 所以在排除第一天或第二天之后，我们只剩下 6 天了，所以 `N = 6`，等式是:
...
> ![Day2 = \frac{(S +(x-y)*6)}{2}](img/e15d01fd24700948cf241ad8909c5f5d.png "Rendered by QuickLaTeX.com")
> 第 1 天 = 第 2 天
