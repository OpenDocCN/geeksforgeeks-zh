# 求函数 Y = (X^6 + X^2 + 9894845) % 971 的值

> 原文: [https://www.geeksforgeeks.org/find-the-value-of-the-function-y-x6-x2-9894845-971/](https://www.geeksforgeeks.org/find-the-value-of-the-function-y-x6-x2-9894845-971/)
...
> 如果我们分解方程，我们得到`y = (x^6) % 971 + (x^2) % 971 + (9894845) % 971`，我们可以将方程简化为`y = (x^6) % 971 + (x^2) % 971 + 355`。
