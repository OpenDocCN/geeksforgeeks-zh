...
> 原文：`https://www.geeksforgeeks.org/arrangement-of-the-characters-of-a-word-such-that-all-vowels-are-at-odd-places/`
...
> 首先找出给定单词中奇数位和偶数位的总数。
> 偶数位总数 = `floor(str.length() / 2)`
> 奇数位总数 = `str.length() - even`
