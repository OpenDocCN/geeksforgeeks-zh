...
> 原文：[https://www.geeksforgeeks.org/print-all-the-levels-with-odd-and-even-number-of-nodes-in-it-set-2/](https://www.geeksforgeeks.org/print-all-the-levels-with-odd-and-even-number-of-nodes-in-it-set-2/)
...
*   将所有连接节点插入二维向量树。
*   在树上运行一个 [BFS](https://www.geeksforgeeks.org/breadth-first-traversal-for-a-graph/) ，使得 `height[节点] = 1 + height[父节点]`
