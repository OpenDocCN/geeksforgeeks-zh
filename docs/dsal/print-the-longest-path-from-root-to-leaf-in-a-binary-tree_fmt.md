...
> 原文: [https://www.geeksforgeeks.org/print-the-longest-path-from-root-to-leaf-in-a-binary-tree/](https://www.geeksforgeeks.org/print-the-longest-path-from-root-to-leaf-in-a-binary-tree/)
...
*   通过递归遍历`root->right`，得到向量`右向量`中右子树的最长路径。
*   类似地，通过递归遍历`root->left`，获得向量`左向量`中从左子树开始的最长路径。
