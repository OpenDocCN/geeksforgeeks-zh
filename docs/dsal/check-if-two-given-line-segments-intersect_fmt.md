...
> 原文: [https://www.geeksforgeeks.org/check-if-two-given-line-segments-intersect/](https://www.geeksforgeeks.org/check-if-two-given-line-segments-intersect/)
...
**2. 特例**
- `(p1, q1, p2)`、`(p1, q1, q2)`、`(p2, q2, p1)` 和 `(p2, q2, q1)` 共线，
