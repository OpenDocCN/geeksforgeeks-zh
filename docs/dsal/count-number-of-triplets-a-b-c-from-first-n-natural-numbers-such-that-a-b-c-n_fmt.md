...
> 原文: [https://www.geeksforgeeks.org/count-number-of-triplets-a-b-c-from-first-n-natural-numbers-such-that-a-b-c-n/](https://www.geeksforgeeks.org/count-number-of-triplets-a-b-c-from-first-n-natural-numbers-such-that-a-b-c-n/)
...
*   初始化一个变量，比如说 `cntTriplet`，来存储满足给定条件的第一个 `N` 个自然数的三元组计数。
*   使用变量 `i` 迭代范围 `[1，N–1]`，检查 `N % i == 0` 与否。如果发现为真，则更新 `cntTriplet += (N / i) - 1`。
*   否则，更新 `cntTriplet += (N / i)`。
*   最后，打印 `cntTriplet` 的值。
