...
> 原文：[https://www.geeksforgeeks.org/find-minimum-radius-atleast-k-point-lie-inside-circle/](https://www.geeksforgeeks.org/find-minimum-radius-atleast-k-point-lie-inside-circle/)
...
思路是求各点距离原点 `(0, 0)` 的[欧氏距离](https://en.wikipedia.org/wiki/Euclidean_distance)的平方。现在，按照递增的顺序排列这些距离。现在距离的第 `k` 个元素是所需的最小半径。
以下是本办法的实施情况：
