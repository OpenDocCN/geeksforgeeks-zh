...
> 原文: [https://www.geeksforgeeks.org/angle-between-two-planes-in-3d/](https://www.geeksforgeeks.org/angle-between-two-planes-in-3d/)
...
> **输出:** 角度为 60.0 度
> **输入:** `a1 = 2`，`b1 = 2`，`c1 = -3`，`d1 = -5`，`a2 = 3`，`b2 = -3`，`c2 = 5`，`d2 = -6`
> **输出:** 角度为 123.69655
