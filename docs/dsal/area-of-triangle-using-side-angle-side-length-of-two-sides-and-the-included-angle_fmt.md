...
> 原文: [https://www.geeksforgeeks.org/area-of-triangle-using-side-angle-side-length-of-two-sides-and-the-included-angle/](https://www.geeksforgeeks.org/area-of-triangle-using-side-angle-side-length-of-two-sides-and-the-included-angle/)
...
然后，可以使用[边-角-边](https://en.wikipedia.org/wiki/Triangle)公式计算三角形的面积:
