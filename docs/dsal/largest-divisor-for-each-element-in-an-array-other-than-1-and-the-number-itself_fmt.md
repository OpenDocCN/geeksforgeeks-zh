...
> 原文: [https://www.geeksforgeeks.org/largest-divisor-for-each-element-in-an-array-other-than-1-and-the-number-itself/](https://www.geeksforgeeks.org/largest-divisor-for-each-element-in-an-array-other-than-1-and-the-number-itself/)
...
想法是[迭代所有数组元素](https://www.geeksforgeeks.org/iterating-arrays-java/)，并使用本文[中讨论的方法找到每个元素的最大除数](https://www.geeksforgeeks.org/find-divisors-natural-number-set-1/)。
时间复杂度: `O(N * √N)`

## 高效的方法

更好的解决方法是预先计算从 `2` 到 `10^5` 的数字的最大除数，然后只运行一个数组的循环，打印预先计算好的答案。

*   使用厄拉多塞的[筛标记素数，并存储每个数的最小素数除数。](https://www.geeksforgeeks.org/sieve-of-eratosthenes/)
*   现在任何数的最大除数将是 `数 / 最小素数除数`。
*   使用预计算答案找出每个数字的最大除数。
