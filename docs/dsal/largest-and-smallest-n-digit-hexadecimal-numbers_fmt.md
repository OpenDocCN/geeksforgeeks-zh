...
> 原文: [https://www.geeksforgeeks.org/largest-and-smallest-n-digit-hexadecimal-numbers/](https://www.geeksforgeeks.org/largest-and-smallest-n-digit-hexadecimal-numbers/)

给定一个整数 `N`，任务是找到最小和最大的 `N` 位[十六进制数字系统](https://www.geeksforgeeks.org/program-decimal-hexadecimal-conversion/)数字。
...
*   **最大数字:** 要得到最大的数字，数字的每个数字都必须是最大的。十六进制数字系统中的最大位数是 `F`。因此:
