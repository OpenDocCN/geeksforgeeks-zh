...
> 原文: [https://www.geeksforgeeks.org/traverse-the-matrix-in-diagonally-bottom-up-fashion-using-recursion/](https://www.geeksforgeeks.org/traverse-the-matrix-in-diagonally-bottom-up-fashion-using-recursion/)
...
思路是遍历矩阵的主对角线元素，然后递归调用，求矩阵的下对角线和上面的对角线到矩阵的主对角线。该方法的递归定义描述如下:
