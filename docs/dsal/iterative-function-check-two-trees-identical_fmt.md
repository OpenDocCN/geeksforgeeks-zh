...
> 原文：[https://www.geeksforgeeks.org/iterative-function-check-two-trees-identical/](https://www.geeksforgeeks.org/iterative-function-check-two-trees-identical/)
...
想法是用`等级顺序遍历`。我们同时遍历这两个树，并且每当我们出列和从队列中取出项目时比较数据。下面是这个想法的实现。
