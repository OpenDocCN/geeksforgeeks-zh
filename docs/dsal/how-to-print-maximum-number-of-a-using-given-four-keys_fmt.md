...
> 原文: [https://www.geeksforgeeks.org/how-to-print-maximum-number-of-a-using-given-four-keys/](https://www.geeksforgeeks.org/how-to-print-maximum-number-of-a-using-given-four-keys/)
...
下面是基于动态编程的 C 实现，其中辅助数组`screen[N]`用于存储子问题的结果。
