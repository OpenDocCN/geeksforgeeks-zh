...
> 原文: [https://www.geeksforgeeks.org/area-of-largest-isosceles-triangle-that-can-be-inscribed-in-an-ellipse-whose-vertex-coincides-with-one-extremity-of-the-major-axis/](https://www.geeksforgeeks.org/area-of-largest-isosceles-triangle-that-can-be-inscribed-in-an-ellipse-whose-vertex-coincides-with-one-extremity-of-the-major-axis/)

给定一个长、短轴长度各为一半的[椭圆](https://en.wikipedia.org/wiki/Ellipse)`A`和`B`，任务是找出顶点与长轴的一个端点重合的椭圆中可内接的最大[等腰三角形](https://en.wikipedia.org/wiki/Isosceles_triangle)的面积。
