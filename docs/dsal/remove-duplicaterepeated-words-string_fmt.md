...
> 原文：[https://www.geeksforgeeks.org/remove-duplicaterepeated-words-string/](https://www.geeksforgeeks.org/remove-duplicaterepeated-words-string/)
...
要将给定的字符串拆分成单词，我们在 C++ 中使用 [`stringstream`](https://www.geeksforgeeks.org/stringstream-c-applications/)。
