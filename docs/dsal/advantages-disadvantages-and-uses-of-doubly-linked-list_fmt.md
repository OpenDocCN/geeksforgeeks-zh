...
> 原文：[https://www.geeksforgeeks.org/advantages-disadvantages-and-uses-of-doubly-linked-list/](https://www.geeksforgeeks.org/advantages-disadvantages-and-uses-of-doubly-linked-list/)
...
*   双向链表也用于构建`MRU`/`LRU`（最近/最近最少使用）缓存。
*   其他数据结构如`栈`、`散列表`、`二叉树`也可以使用双向链表来构建或编程。
