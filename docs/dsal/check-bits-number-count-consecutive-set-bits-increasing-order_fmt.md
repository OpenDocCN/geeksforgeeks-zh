...
> 原文: [https://www.geeksforgeeks.org/check-bits-number-count-consecutive-set-bits-increasing-order/](https://www.geeksforgeeks.org/check-bits-number-count-consecutive-set-bits-increasing-order/)
