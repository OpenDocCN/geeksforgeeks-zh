...
> 原文:[https://www . geeksforgeks . org/find-n-4-n 大值 4 的余数/](https://www.geeksforgeeks.org/find-n-4-remainder-with-4-for-a-large-value-of-n/)
...
除以 4 的余数只依赖于一个数的最后 2 位数字，所以我们不除 `N`，而是只除 `N` 的最后两位数字，求余数。
以下是上述办法的实施情况:
