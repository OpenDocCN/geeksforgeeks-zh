...
> 原文：[https://www.geeksforgeeks.org/columnar-transposition-cipher/](https://www.geeksforgeeks.org/columnar-transposition-cipher/)
...
2.  然后，再次将消息按列写出，然后通过重组关键字来重新排列列的顺序。
