...
> 原文: [https://www.geeksforgeeks.org/check-if-a-matrix-can-be-converted-to-another-by-repeatedly-adding-any-value-to-x-consecutive-elements-in-a-row-or-column/](https://www.geeksforgeeks.org/check-if-a-matrix-can-be-converted-to-another-by-repeatedly-adding-any-value-to-x-consecutive-elements-in-a-row-or-column/)
...
这个问题可以通过[贪婪地](https://www.geeksforgeeks.org/greedy-algorithms/)执行所有水平操作，然后是垂直操作来解决。
按照以下步骤解决问题:
