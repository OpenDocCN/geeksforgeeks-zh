...
> 原文: [https://www.geeksforgeeks.org/qualcomm-interview-experience-set-8-experienced/](https://www.geeksforgeeks.org/qualcomm-interview-experience-set-8-experienced/)
...
3.  编码问题:
    a. [反转链表。](https://practice.geeksforgeeks.org/problems/reverse-a-linked-list/1)
...
1.  然后在他问我到现在为止我所做的所有项目之后。他还询问了不同的情况，比如你如何使用来修复内存溢出、当前公司的崩溃等问题。
2.  关于大端和小端的问题:
...
1.  然后他从操作系统
    ...
    c. 关于存储类的问题。
2.  [反转数字的位。](https://practice.geeksforgeeks.org/problems/reverse-bits/0)
...
[Reverse Bits](https://practice.geeksforgeeks.org/problems/reverse-bits/0)
...
[Set Bits](https://practice.geeksforgeeks.org/problems/set-bits/0)