...
> 原文: [https://www.geeksforgeeks.org/print-string-after-removing-all-10-or-01-from-the-binary-string/](https://www.geeksforgeeks.org/print-string-after-removing-all-10-or-01-from-the-binary-string/)
...
3.  如果 1 的**计数**等于 0 的**计数**，则可以减少整个字符串。因此，返回 **-1**。
4.  如果 **1 的计数**大于 **0 的计数**，那么最后剩下许多 1，进一步减少是不可能的。因此，将许多 **1** 追加到一个空字符串中并返回该字符串。
5.  类似地，如果 **0 的计数**大于 **1 的计数**，则找出差异，并将那些许多 **0** 附加到空字符串中并返回。
