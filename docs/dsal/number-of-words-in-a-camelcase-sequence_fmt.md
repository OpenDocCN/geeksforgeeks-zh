...
> 原文：[https://www.geeksforgeeks.org/number-of-words-in-a-camelcase-sequence/](https://www.geeksforgeeks.org/number-of-words-in-a-camelcase-sequence/)
...
由于已经知道序列是 CamelCase，所以可以说序列中的字数会比大写字母多一个。
