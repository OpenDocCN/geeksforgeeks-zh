...
> 原文: [https://www.geeksforgeeks.org/average-squares-natural-numbers/](https://www.geeksforgeeks.org/average-squares-natural-numbers/)
...
[自然数平方和](https://www.geeksforgeeks.org/sum-squares-first-n-natural-numbers/) 是 `(n + 1)(2n + 1) / 6`。因此平均值为 `n(n + 1)(2n + 1) / 6 * n = (n + 1)(2n + 1) / 6`。
...
```python
# Python program to get the Average of
# Square of first n natural numbers
