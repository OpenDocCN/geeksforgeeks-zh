...
> 原文：[https://www.geeksforgeeks.org/sum-of-elements-in-an-array-whose-difference-with-the-mean-of-another-array-is-less-than-k/](https://www.geeksforgeeks.org/sum-of-elements-in-an-array-whose-difference-with-the-mean-of-another-array-is-less-than-k/)

给定两个未排序的数组 `arr1[]` 和 `arr2[]`。求 `arr1[]` 的元素之和，其与 `arr2[]` 的平均值之差为 `< k`。
