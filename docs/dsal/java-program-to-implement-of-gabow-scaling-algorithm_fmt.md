...
> 原文: [https://www.geeksforgeeks.org/java-program-to-implement-of-gabow-scaling-algorithm/](https://www.geeksforgeeks.org/java-program-to-implement-of-gabow-scaling-algorithm/)
...
1.  在中凯伊姆 `getSCComponents()` 拜占庭 conv `在`开头
    ...
    *   To declare a graph, and then we apply `DFS()` method。
...
public class GFG {
    ...
    public static void main(String[] args) {
        ...
        int[] x = new int[] { 0, 1, 2, 3, 3, 7, 2, 7, 5, 6, 1, 4, 4, 1 };
        int[] y = new int[] { 1, 2, 3, 2, 7, 3, 6, 6, 6, 5, 5, 5, 0, 4 };
