...
> 原文: [https://www.geeksforgeeks.org/find-the-smallest-positive-number-missing-from-an-unsorted-array-hashing-implementation/](https://www.geeksforgeeks.org/find-the-smallest-positive-number-missing-from-an-unsorted-array-hashing-implementation/)
...
我们可以使用 C++ 中的 `unordered_map` 来实现散列，该散列允许以几乎 `O(1)` 的时间复杂度执行查找操作。
