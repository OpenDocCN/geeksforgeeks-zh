...
> 原文：[https://www.geeksforgeeks.org/breadth-first-traversal-bfs-on-a-2d-array/](https://www.geeksforgeeks.org/breadth-first-traversal-bfs-on-a-2d-array/)
...
>
> **输入：** `grid[][] = {{-1, 0, 0, 1}, {-1, -1, -2, -1}, {-1, -1, -1, -1}, {0, 0, 0, 0}}`
> **输出：** `-1 0 -1 0 -1 0 -1 1 1 -2 -1 0 -1 0 -1 0 -1 0 0 0`

**方法：** 按照以下步骤解决问题：

1.  初始化方向[向量](https://www.geeksforgeeks.org/vector-in-cpp-stl/) `dRow[] = {-1, 0, 1, 0}` 和 `dCol[] = {0, 1, 0, -1}` 以及[对](https://www.geeksforgeeks.org/pair-in-cpp-stl/)的[队列](https://www.geeksforgeeks.org/queue-data-structure/)，以存储矩阵单元的索引。
