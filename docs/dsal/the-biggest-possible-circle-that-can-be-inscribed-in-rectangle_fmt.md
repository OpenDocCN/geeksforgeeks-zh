...
> 原文：[https://www.geeksforgeeks.org/the-biggest-possible-circle-that-can-be-inscribed-in-rectangle/](https://www.geeksforgeeks.org/the-biggest-possible-circle-that-can-be-inscribed-in-rectangle/)

给定一个长度为 `l` 与宽度为 `b` 的矩形，我们必须找到可以在该矩形内接的最大圆。
