...
> 原文：[https://www.geeksforgeeks.org/implementation-of-avl-tree-using-graphics-in-cpp/](https://www.geeksforgeeks.org/implementation-of-avl-tree-using-graphics-in-cpp/)
...
在本文中，我们将使用 C++ 中的[图形](https://www.geeksforgeeks.org/basic-graphic-programming-in-c/)来实现 **AVL 树**的概念。作为先决条件，必须设置图形。他们的编辑。使用此链接在代码块中安装 [`graphics.h`](https://www.youtube.com/watch?v=VEkAj-xVTKQ)。
