...
> 原文：[https://www.geeksforgeeks.org/check-if-a-string-contains-anagrams-of-length-k-which-does-not-contain-the-character-x/](https://www.geeksforgeeks.org/check-if-a-string-contains-anagrams-of-length-k-which-does-not-contain-the-character-x/)
...
**输出：** `geeks geeks`
**解释：**
子字符串“geeks”和“geeks”互为字谜，不含'f'。

**输入：** `S = "rotator"`，`X = 'a'`，`K = 3`
**输出：** `rot tor`
**解释：**
