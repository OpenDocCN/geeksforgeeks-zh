...
> 原文: [https://www.geeksforgeeks.org/n-digit-numbers-divisible-by-5-formed-from-the-m-digits/](https://www.geeksforgeeks.org/n-digit-numbers-divisible-by-5-formed-from-the-m-digits/)
...
一个数字要被 5 整除，唯一的条件是数字中单位位置的数字必须是 `0` 或 `5`。
