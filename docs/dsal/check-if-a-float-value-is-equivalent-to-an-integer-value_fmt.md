...
> 原文: [https://www.geeksforgeeks.org/check-if-a-float-value-is-equivalent-to-an-integer-value/](https://www.geeksforgeeks.org/check-if-a-float-value-is-equivalent-to-an-integer-value/)
...
**做法:** 思路是采用[类型转换](https://www.geeksforgeeks.org/type-conversion-in-c/)的概念。按照以下步骤解决问题:
