...
> 原文：`https://www.geeksforgeeks.org/reduce-a-given-number-to-form-a-key-by-the-given-operations/`
...
思路是迭代数字的位数，[检查数字的奇偶性](https://www.geeksforgeeks.org/finding-the-parity-of-a-number-efficiently/)。如果是偶数，则继续下一个数字，直到遇到奇数。对于奇数，添加连续的数字，直到数字之和为偶数。最后，连接计算出的总和以获得所需的密钥。
