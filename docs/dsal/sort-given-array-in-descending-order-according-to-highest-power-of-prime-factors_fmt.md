...
> 原文：[https://www.geeksforgeeks.org/sort-given-array-in-descending-order-according-to-highest-power-of-prime-factors/](https://www.geeksforgeeks.org/sort-given-array-in-descending-order-according-to-highest-power-of-prime-factors/)
...
这个问题可以用[素分解](https://www.geeksforgeeks.org/prime-factorization-using-sieve-olog-n-multiple-queries/)解决。按照以下步骤解决给定的问题。
...
**时间复杂度**：`O(N^1.5 * log(K))`，其中 `K` 是数组中最大的元素。
**辅助空间**：`O(1)`