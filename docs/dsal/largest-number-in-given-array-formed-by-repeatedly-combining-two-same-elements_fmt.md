...
> 原文: [https://www.geeksforgeeks.org/largest-number-in-given-array-formed-by-repeatedly-combining-two-same-elements/](https://www.geeksforgeeks.org/largest-number-in-given-array-formed-by-repeatedly-combining-two-same-elements/)
...
这个问题可以用给定数组中元素的频率来解决。

*   在 `map` 中找到并存储给定数组中每个元素的频率。
