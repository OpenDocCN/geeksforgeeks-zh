...
> 原文: [https://www.geeksforgeeks.org/sort-an-array-of-strings-lexicographically-based-on-prefix/](https://www.geeksforgeeks.org/sort-an-array-of-strings-lexicographically-based-on-prefix/)
...
**方法:** 想法是使用内置的[排序](https://www.geeksforgeeks.org/sort-c-stl/)函数，使用下面的比较器函数对给定的字符串数组进行排序。比较器函数使用 C++ 中的 [`compare()`](https://www.geeksforgeeks.org/stdstringcompare-in-c/) 函数检查是否有任何字符串作为子字符串出现在另一个字符串中，然后，它应该按照长度的降序排列它们。
