...
> 原文: [https://www.geeksforgeeks.org/print-k-inorder-successors-of-a-binary-tree-in-o1-space/](https://www.geeksforgeeks.org/print-k-inorder-successors-of-a-binary-tree-in-o1-space/)

给定一个**二叉树**和两个数字 `P` 和 `K`，任务是在常数空间中从二叉树打印给定数字 `P` 的 `K` 个有序后继者。
...
**方法:**
为了解决这个问题，我们使用 [Morris Inorder 遍历二叉树](https://www.geeksforgeeks.org/inorder-tree-traversal-without-recursion-and-without-stack/)来避免使用任何额外的空间。在生成有序序列时搜索节点 `P`。找到后，按顺序打印下一个出现的 `K` 个节点。
