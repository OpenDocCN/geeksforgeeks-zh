...
> 原文：`https://www.geeksforgeeks.org/sum-first-n-odd-numbers-o1-complexity/`
...
一个高效的解决方案就是用直接公式。为了求前 `n` 个奇数的和，我们可以应用奇数定理，它规定前 `n` 个奇数的和等于 `n` 的平方。

> ∑(2i–1)= `n^2` 其中 `i` 从 1 到 `n` 变化
