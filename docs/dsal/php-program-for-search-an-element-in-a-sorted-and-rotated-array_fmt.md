...
> 原文：[https://www.geeksforgeeks.org/php-program-for-search-an-element-in-a-sorted-and-rotated-array/](https://www.geeksforgeeks.org/php-program-for-search-an-element-in-a-sorted-and-rotated-array/)
...
// Function calling
echo "Index of the element is : ", pivotedBinarySearch($arr1, $n, $key);
...
代替二分搜索法的两次或两次以上传球，结果可以在二分搜索法的一次传球中找到。需要修改二分搜索法号来执行搜索。其思想是创建一个递归函数，将 `l` 和 `r` 作为输入和键的范围。
