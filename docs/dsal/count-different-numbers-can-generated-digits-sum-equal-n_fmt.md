...
> 原文: [https://www.geeksforgeeks.org/count-different-numbers-can-generated-digits-sum-equal-n/](https://www.geeksforgeeks.org/count-different-numbers-can-generated-digits-sum-equal-n/)

给定一个正整数 `n`。计算可以使用数字 1、2、3 和 4 生成的不同数字，使数字总和为数字 `n`。这里数字 `4` 将被视为 `1`。比如
`32 = 3+2 = 5`
`1341 = 1+3+1+1 = 6`
`441 = 1+1+1 = 3`
注: 回答 `mod = 10^9 + 7` 中的数值
