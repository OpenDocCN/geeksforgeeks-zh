# 以 `2^x-1` 的形式打印制作数字的步骤

> 原文: [https://www.geeksforgeeks.org/print-steps-to-make-a-number-in-form-of-2x-1/](https://www.geeksforgeeks.org/print-steps-to-make-a-number-in-form-of-2x-1/)
...
> 第 3 步: 与 `7` 异或
> 第 4 步: 增加 `1`
> 选择 `M = 5`，`n` 转化为 `39 ^ 31 = 56`。
> 增加 `N` `1`，将其值改为 `N = 57`。
> 选择 `M = 3`，`x` 转化为 `57 ^ 7 = 62`。
