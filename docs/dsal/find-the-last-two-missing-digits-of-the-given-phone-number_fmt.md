...
> 原文: [https://www.geeksforgeeks.org/find-the-last-two-missing-digits-of-the-given-phone-number/](https://www.geeksforgeeks.org/find-the-last-two-missing-digits-of-the-given-phone-number/)
...
*   现在，有两种情况:
    *   如果 `sum < 10`，那么它就是一个位数，即在开头插入 `0`，使其成为两位数，而不影响数值。
    *   否则 `sum` 是最后两位数字代表的数字。
