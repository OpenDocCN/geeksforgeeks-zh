...
> 原文：[https://www.geeksforgeeks.org/convert-given-string-to-a-valid-mobile-number/](https://www.geeksforgeeks.org/convert-given-string-to-a-valid-mobile-number/)
...
*   现在如果 `S` 的长度不是 `10`，打印 `"Invalid"`，结束程序。
