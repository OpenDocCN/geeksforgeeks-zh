...
> 原文: [https://www.geeksforgeeks.org/minimum-possible-bitwise-or-of-all-bitwise-and-of-pairs-generated-from-two-given-arrays/](https://www.geeksforgeeks.org/minimum-possible-bitwise-or-of-all-bitwise-and-of-pairs-generated-from-two-given-arrays/)
...
最简单的方法是用 `brr[]` 生成[所有可能的数组对](https://www.geeksforgeeks.org/find-all-pairs-possible-from-the-given-array/) `arr[]` 的[位 OR](https://www.geeksforgeeks.org/bitwise-operators-in-c-cpp/)。完成上述步骤后，只选择按位“或”最小的那些 `N` 元素。打印最小位或。
...
对上述方法进行优化，思路是从最大可能的答案开始，然后在每一步尽量最小化。以下是步骤:

1.  初始化最大可能答案（比如 `ans`），这将是一个所有位都被设置为 `1` 的数字。
