...
> 原文: [https://www.geeksforgeeks.org/find-the-winner-of-a-game-where-scores-are-given-as-a-binary-string-set-2/](https://www.geeksforgeeks.org/find-the-winner-of-a-game-where-scores-are-given-as-a-binary-string-set-2/)

给定一个代表排球比赛比分的二进制字符串 `str`。任务是根据以下条件找到比赛的获胜者:
...
## 天真法
天真法在本题 [集-1](https://www.geeksforgeeks.org/find-winner-game/) 中有提及。

## 高效进场
无论时间线是什么，最后得分的玩家都是赢家。原因如下:
