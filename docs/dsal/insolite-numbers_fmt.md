...
**不可分解数**是一个数 `N`，如果它可以被其数字的**和**整除，也可以被其数字平方的**乘积**整除。
极少不溶物编号为:
> 111、11112、1122112、111111111、122121216、11111112112……

## 检查一个号码是否为不可溶号码

给定一个数字 `N`，任务是检查 `N` 是否为**不溶物数字**。如果 `N` 是不溶物号，则打印`“是”`否则打印`“否”`。
...
**参考:** [http://www.numbersaplenty.com/set/insolite_number/](http://www.numbersaplenty.com/set/insolite_number/)