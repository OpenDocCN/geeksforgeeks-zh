...
> 原文: [https://www.geeksforgeeks.org/print-all-unique-elements-present-in-a-sorted-array/](https://www.geeksforgeeks.org/print-all-unique-elements-present-in-a-sorted-array/)
...
解决问题最简单的方法就是[遍历数组](https://www.geeksforgeeks.org/c-program-to-traverse-an-array/) `arr[]`，只打印那些频率为 `1` 的元素。按照以下步骤解决问题:
