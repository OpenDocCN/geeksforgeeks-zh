...
> 原文: [https://www.geeksforgeeks.org/sum-of-all-subarrays-of-size-k/](https://www.geeksforgeeks.org/sum-of-all-subarrays-of-size-k/)
...
> 子阵列 1: `{1, 2, 3}` = 1 + 2 + 3 = 6
> 子阵列 2: `{2, 3, 4}` = 2 + 3 + 4 = 9
> 子阵列 3: `{3, 4, 5}` = 3 + 4 + 5 = 12
> 子阵列 4: `{4, 5, 6}` = 4 + 5 + 6 = 15
>
...
想法是使用[滑动窗口](https://www.geeksforgeeks.org/window-sliding-technique/)方法来寻找阵列中所有可能子阵列的和。
