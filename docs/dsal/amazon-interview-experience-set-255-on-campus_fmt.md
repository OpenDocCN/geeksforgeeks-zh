...
> 原文: [https://www.geeksforgeeks.org/amazon-interview-experience-set-255-on-campus/](https://www.geeksforgeeks.org/amazon-interview-experience-set-255-on-campus/)
...
[https://www.quora.com/Programming-Puzzles-Given-a-continuous-input-stream-of-integers-can-you-find-the-maximum-N-numbers-at-any-given-instance](https://www.quora.com/Programming-Puzzles-Given-a-continuous-input-stream-of-integers-can-you-find-the-maximum-N-numbers-at-any-given-instance)
...
## 第 5 轮(现场 f2f)
1) 从 BST 中找 floor 和 ceil
[https://www.geeksforgeeks.org/floor-and-ceil-from-a-bst/](https://www.geeksforgeeks.org/floor-and-ceil-from-a-bst/)

2) [在未排序的数组中找出出现次数为奇数的两个数字](https://practice.geeksforgeeks.org/problems/two-numbers-with-odd-occurrences/0)

3) [求出现奇数次的元素](https://practice.geeksforgeeks.org/problems/find-the-odd-occurence/0)
