...
> 原文: [https://www.geeksforgeeks.org/area-of-incircle-of-a-right-angled-triangle/](https://www.geeksforgeeks.org/area-of-incircle-of-a-right-angled-triangle/)
...
直角三角形的内切圆半径计算公式可以给出为 `r = (P + B - H) / 2`。
