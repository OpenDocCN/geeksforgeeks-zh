...
> 原文: [https://www.geeksforgeeks.org/ways-of-dividing-a-group-into-two-halves-such-that-two-elements-are-in-different-groups/](https://www.geeksforgeeks.org/ways-of-dividing-a-group-into-two-halves-such-that-two-elements-are-in-different-groups/)
...
有两种方式，两个漂亮的女生分在不同的组中，每种方式对应剩余的 `(2n–2)` 个女生可以分成两组的方式数 `C(2n-2, n-1)`。因此方式总数为 `2 * C(2n-2, n-1)`。
