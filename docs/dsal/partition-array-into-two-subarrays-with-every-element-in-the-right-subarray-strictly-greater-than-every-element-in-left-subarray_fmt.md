...
> 原文: [https://www.geeksforgeeks.org/partition-array-into-two-subarrays-with-every-element-in-the-right-subarray-strictly-greater-than-every-element-in-left-subarray/](https://www.geeksforgeeks.org/partition-array-into-two-subarrays-with-every-element-in-the-right-subarray-strictly-greater-than-every-element-in-left-subarray/)
...
> 第二个子阵列`{7，9}`的最小值大于第一个子阵列`{5，3，2}`的最大值。
>
> **输入:** `arr[] = {1，1，1，1，1}`
> **输出:** 不可能
> **说明:**
...
**高效方法:** 上述方法可以通过计算**前缀最大数组**和**后缀最小数组**来优化，这导致第一个子数组的最大值和第二个子数组的最小值的时间计算是恒定的。按照以下步骤解决问题:
