...
> 原文: [https://www.geeksforgeeks.org/count-number-of-binary-strings-such-that-there-is-no-substring-of-length-greater-than-or-equal-to-3-with-all-1s/](https://www.geeksforgeeks.org/count-number-of-binary-strings-such-that-there-is-no-substring-of-length-greater-than-or-equal-to-3-with-all-1s/)

给定一个整数 `N`，任务是计算可能长度为 `N` 的二进制字符串的数量，使得它们不包含`"111"`作为子字符串。答案可能很大，所以打印答案模 `10^9 + 7`。

**举例:**

> **输入:** `N = 3`
> **输出:** 7
> 所有可能的子串为“000”、“001”、“010”、“011”、“100”、“101”和“110”。“111”不是有效字符串。
> **输入** `N = 16`
> **输出:** 19513
