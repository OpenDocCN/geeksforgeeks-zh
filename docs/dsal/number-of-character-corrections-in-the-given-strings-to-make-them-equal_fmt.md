...
> 原文: [https://www.geeksforgeeks.org/number-of-character-corrections-in-the-given-strings-to-make-them-equal/](https://www.geeksforgeeks.org/number-of-character-corrections-in-the-given-strings-to-make-them-equal/)
...
运行一个循环，检查所有字符串的 `i`<sup>th</sup> 字符是否相等，然后不需要任何操作。如果两个字符相等，则需要一个操作，如果三个字符都不同，则需要两个操作。
