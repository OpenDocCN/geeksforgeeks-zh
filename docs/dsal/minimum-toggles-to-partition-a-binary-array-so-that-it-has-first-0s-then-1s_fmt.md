...
> 原文:[https://www.geeksforgeeks.org/minimum-toggles-to-partition-a-binary-array-so-that-it-has-first-0s-then-1s/](https://www.geeksforgeeks.org/minimum-toggles-to-partition-a-binary-array-so-that-it-has-first-0s-then-1s/)
