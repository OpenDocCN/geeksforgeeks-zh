...
`方法一:`使用 [`acos()`](https://www.geeksforgeeks.org/acos-function-in-c-stl/)功能:

1.  π的值使用 [`acos()`](https://www.geeksforgeeks.org/acos-function-in-c-stl/)函数计算，该函数返回一个介于`[-π，π]`之间的数值。
