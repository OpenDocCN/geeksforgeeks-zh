...
> 原文：[https://www.geeksforgeeks.org/javascript-program-to-remove-duplicates-from-a-given-string/](https://www.geeksforgeeks.org/javascript-program-to-remove-duplicates-from-a-given-string/)
...
## 方法 6 (使用 `unordered_map` STL 方法)

**先决条件:** [unordered_map STL C++方法](https://www.geeksforgeeks.org/unordered_map-in-cpp-stl/)
...
谢谢，**Alan James Vinoy** 提出这个方法。

更多详情请参考[从给定字符串中删除重复项的完整文章](https://www.geeksforgeeks.org/remove-duplicates-from-a-given-string/)！