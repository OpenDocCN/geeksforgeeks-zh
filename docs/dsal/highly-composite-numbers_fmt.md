...
给定一个数字 `N`，任务是检查 `N` 是否为高复合数。如果 `N` 是高复合数则打印“是”，否则打印“否”。

**示例:**

> **输入:** `N = 60`
> **输出:** 是的
> 60 是一个高度复合的数，因为它有 12 个除数，并且 59 以下的数都没有 12 个或更多的除数。
>
> **输入:** `N = 18`
> **输出:** 否
...
`时间复杂度: O(n)`
参考: [http://www.numbersaplenty.com/set/highly_composite_number/](http://www.numbersaplenty.com/set/highly_composite_number/)