...
> 原文：[https://www.geeksforgeeks.org/modify-array-by-sorting-nearest-perfect-squares-of-array-elements-having-their-digits-sorted-in-decreasing-order/](https://www.geeksforgeeks.org/modify-array-by-sorting-nearest-perfect-squares-of-array-elements-having-their-digits-sorted-in-decreasing-order/)

给定一个大小为`N`（`1≤N≤10^5`）的数组`arr[]`，任务是将每个数组元素的数字按降序排序，并用最近的完美正方形替换每个数组元素，然后按升序打印该数组。
