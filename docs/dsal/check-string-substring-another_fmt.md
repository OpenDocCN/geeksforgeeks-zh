...
> 原文: [https://www.geeksforgeeks.org/check-string-substring-another/](https://www.geeksforgeeks.org/check-string-substring-another/)
...
**简单方法:** 想法是从头到尾运行一个循环，对于给定字符串中的每个索引，检查子字符串是否可以从该索引形成。这可以通过运行遍历给定字符串的嵌套循环来完成，并在该循环中运行另一个循环来检查每个索引中的子字符串。
