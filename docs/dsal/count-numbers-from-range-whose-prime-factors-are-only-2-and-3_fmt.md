...
> 原文：[https://www.geeksforgeeks.org/count-numbers-from-range-whose-prime-factors-are-only-2-and-3/](https://www.geeksforgeeks.org/count-numbers-from-range-whose-prime-factors-are-only-2-and-3/)
...
*   如果 `num = 1` 则增加 `count`，为 `num` 只有 `2` 和 `3` 作为其主要因素。
