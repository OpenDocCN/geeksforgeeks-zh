...
> 原文：[https://www.geeksforgeeks.org/count-balanced-binary-trees-height-h/](https://www.geeksforgeeks.org/count-balanced-binary-trees-height-h/)
...
树高，`h = 1 + max(leftHeight, rightHeight)`
