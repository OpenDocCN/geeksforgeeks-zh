...
> 原文: [https://www.geeksforgeeks.org/rgybcolor-slots-game-guess-correct-color-correct-slot/](https://www.geeksforgeeks.org/rgybcolor-slots-game-guess-correct-color-correct-slot/)
...
本文由 **Somesh Awasthi 先生**供稿。如果你喜欢 GeeksforGeeks 并想投稿，你也可以用`write.geeksforgeeks.org`写一篇文章或者把你的文章邮寄到`review-team@geeksforgeeks.org`。看到你的文章出现在极客博客主页上，帮助其他极客。
