...
> 原文：[https://www.geeksforgeeks.org/basic-algorithm-techniques-not-taught-in-academics/](https://www.geeksforgeeks.org/basic-algorithm-techniques-not-taught-in-academics/)
...
额外提示：每当你解决一个问题时，确保你正确地分析它。在这里，分析不是关于它的效率，“而是关于在一个问题中找到一个模式。”在一类模式下练习分组问题会让你变得更好。这是因为当你再次看到类似的问题时，你的大脑会立即识别出这个模式，并把它捡起来交给你。这似乎很快，也让你感到有点自信。
