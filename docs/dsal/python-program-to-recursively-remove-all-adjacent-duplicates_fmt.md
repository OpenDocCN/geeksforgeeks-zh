...
> 原文: [https://www.geeksforgeeks.org/python-program-to-recursively-remove-all-adjacent-duplicates/](https://www.geeksforgeeks.org/python-program-to-recursively-remove-all-adjacent-duplicates/)
...
> **输入**: `azxzy`
> 输出: `ay`
> 第一个“azxzy”降为“azzy”。字符串“azzy”包含重复项，因此进一步简化为“ay”。
>
> **输入**: `geeksforgeeg`
> 输出: `gksfor`
> 第一个“geeksforgeeg”降为“gksforgg”。字符串“gksforgg”包含重复项，因此进一步简化为“gksfor”。
>
> **输入**: `caaabbbaacdddd`
> **输出**: 空字符串
>
