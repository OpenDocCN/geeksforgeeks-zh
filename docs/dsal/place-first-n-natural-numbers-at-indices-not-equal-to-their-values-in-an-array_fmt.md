...
> 原文：[https://www.geeksforgeeks.org/place-first-n-natural-numbers-at-indices-not-equal-to-their-values-in-an-array/](https://www.geeksforgeeks.org/place-first-n-natural-numbers-at-indices-not-equal-to-their-values-in-an-array/)
...
> **输入：** `N = 5`
> **输出：** `2 1 5 3 4`
> **解释：** 大小为 5 的数组的一种可能排列是 `2 1 5 3 4`。
