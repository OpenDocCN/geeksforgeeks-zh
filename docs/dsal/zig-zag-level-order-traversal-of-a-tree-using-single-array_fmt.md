...
> 原文：[https://www.geeksforgeeks.org/zig-zag-level-order-traversal-of-a-tree-using-single-array/](https://www.geeksforgeeks.org/zig-zag-level-order-traversal-of-a-tree-using-single-array/)

写一个函数打印一棵树的螺旋顺序遍历。对于下面的树，函数应该打印 1、2、3、4、5、6、7。

![spiral_order](img/0fa801db3a2977ececf7c42f35bb946a.png)

我们已经讨论了朴素方法和两个基于栈的方法，在[具有递归的水平顺序和多个栈](https://www.geeksforgeeks.org/level-order-traversal-in-spiral-form/)中，该方法背后的思想是首先我们必须取一个队列、一个方向标志和一个空的分离标志。
...
以下是一个使用单个双端队列以螺旋形式打印二叉树层序遍历的 C# 程序。
...
以下是使用单个双端队列以螺旋形式打印层序遍历的 JavaScript 实现。
