...
> 原文：[https://www.geeksforgeeks.org/generate-an-array-having-sum-of-euler-totient-function-of-all-elements-equal-to-n/](https://www.geeksforgeeks.org/generate-an-array-having-sum-of-euler-totient-function-of-all-elements-equal-to-n/)
...
*   一个数 `N` 的[欧拉全能性函数](https://www.geeksforgeeks.org/eulers-totient-function/)是从 `1` 到 `N` 的整数中，使得 `GCD(i, N)` 为 `1` 的数的个数。一个数 `N` 可以表示为[其所有除数](https://www.geeksforgeeks.org/find-divisors-natural-number-set-1/)的[欧拉全能性函数](https://www.geeksforgeeks.org/eulers-totient-function/)值之和。
