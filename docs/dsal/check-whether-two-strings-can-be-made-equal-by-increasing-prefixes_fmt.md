...
> 原文: [https://www.geeksforgeeks.org/check-whether-two-strings-can-be-made-equal-by-increasing-prefixes/](https://www.geeksforgeeks.org/check-whether-two-strings-can-be-made-equal-by-increasing-prefixes/)
...
**解决方法**
只有当第一个字符串的所有 ASCII 值都小于或等于第二个字符串，并且字符的 ASCII 值之差按降序排列时，才可以通过增加第一个字符串前缀的 ASCII 值来使两个字符串相等。
