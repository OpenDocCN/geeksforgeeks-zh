...
> 原文：[https://www.geeksforgeeks.org/check-if-elements-of-an-array-can-be-arranged-in-a-circle-with-consecutive-difference-as-1/](https://www.geeksforgeeks.org/check-if-elements-of-an-array-can-be-arranged-in-a-circle-with-consecutive-difference-as-1/)

给定一组`N`个数字。任务是检查是否有可能将所有的数字排列成一个圆，使任何两个相邻的数字相差 1。如果可能得到这样的安排，打印“是”，否则打印“否”。
