...
> 原文: [https://www.geeksforgeeks.org/print-all-exponential-levels-of-a-binary-tree/](https://www.geeksforgeeks.org/print-all-exponential-levels-of-a-binary-tree/)
...
# Utility function to get Exponential
# Level of a given Binary tree
def find_ExponentialLevels(node, queue, index, size):
    Lev = []
...
# Function to find Exponential levels
# In a given binary tree
def printExponentialLevels(node):
