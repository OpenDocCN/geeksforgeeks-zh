...
> 原文: [https://www.geeksforgeeks.org/find-the-sum-of-the-series-1-2-3-6-9-18-27-54-till-n-terms/](https://www.geeksforgeeks.org/find-the-sum-of-the-series-1-2-3-6-9-18-27-54-till-n-terms/)
...
通过观察给定序列中的模式，序列的下一个数字交替乘以 `2` 和 `3/2`。
