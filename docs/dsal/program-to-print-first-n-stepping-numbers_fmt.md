...
> 原文: [https://www.geeksforgeeks.org/program-to-print-first-n-stepping-numbers/](https://www.geeksforgeeks.org/program-to-print-first-n-stepping-numbers/)

给定一个数字 `N`，任务是打印第一个 `N` 个[步进数字](https://www.geeksforgeeks.org/stepping-numbers/)。
