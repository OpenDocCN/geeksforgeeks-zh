...
> 原文: [https://www.geeksforgeeks.org/number-from-a-range-l-r-having-kth-minimum-cost-of-conversion-to-1-by-given-operations/](https://www.geeksforgeeks.org/number-from-a-range-l-r-having-kth-minimum-cost-of-conversion-to-1-by-given-operations/)
...
> 与 `14` 相关的成本为 `17` (`14–>7–>22–>11–>34–>17–>52–>26–>13–>40–>20–>10–>5–>16–>8–>4–>2–>1`)
> 与 `15` 相关的成本为 `17` (`15–>46–>23–>70–>35–>106–>53–>160–>80–>40–>20–>10–>5–>16–>8–>4–>2–>1`)
> 对于 `K = 2`，输出为 `13`。
...
最简单的方法是使用[递归](https://www.geeksforgeeks.org/recursion/)计算 `L` 和 `R` 之间每个元素的相关成本。以下是步骤:
1. 定义一个递归计算成本的函数 `func()`。
2. 将元素的所有成本存储在一对数组中。
3. 根据成本对数组进行排序。
...
上述方法可以通过[动态规划](https://www.geeksforgeeks.org/dynamic-programming/)进行优化。以下是步骤:
...
* 然后从数组中返回第 `(K–1)`<sup>个</sup>索引处的元素。
