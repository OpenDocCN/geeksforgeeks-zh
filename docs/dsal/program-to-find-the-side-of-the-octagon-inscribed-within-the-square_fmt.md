...
> 原文: [https://www.geeksforgeeks.org/program-to-find-the-side-of-the-octagon-inscribed-within-the-square/](https://www.geeksforgeeks.org/program-to-find-the-side-of-the-octagon-inscribed-within-the-square/)
...
从图中可以看出，八边形的边长 = `b`。同样由于多边形是规则的，因此 `2 * x + b = a`。从直角三角形中，`x^2 + x^2 = b^2`。所以，`x = b / √2`。因此，`√2b + b = a`。
