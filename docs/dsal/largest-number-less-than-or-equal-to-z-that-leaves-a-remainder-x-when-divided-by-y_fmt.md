...
> 原文：[https://www.geeksforgeeks.org/largest-number-less-than-or-equal-to-z-that-leaves-a-remainder-x-when-divided-by-y/](https://www.geeksforgeeks.org/largest-number-less-than-or-equal-to-z-that-leaves-a-remainder-x-when-divided-by-y/)
...
要解决上面提到的问题，第一个观察是如果 `x > z` 那么答案是不可能的，所以输出将是 `-1`。
