...
> 原文：[https://www.geeksforgeeks.org/check-if-two-strings-can-be-made-equal-by-swapping-one-character-among-each-other/](https://www.geeksforgeeks.org/check-if-two-strings-can-be-made-equal-by-swapping-one-character-among-each-other/)
...
> **输出：** 是
> “`S`eeksforgeks”和“geesforgeek`G`”可以对调，使两个字符串相等。
