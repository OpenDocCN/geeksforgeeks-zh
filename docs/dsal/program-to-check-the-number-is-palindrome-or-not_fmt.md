...
> 原文：[https://www.geeksforgeeks.org/program-to-check-the-number-is-palindrome-or-not/](https://www.geeksforgeeks.org/program-to-check-the-number-is-palindrome-or-not/)
...
**方法：**
这个问题的一个简单方法是先将 `n` 的[倒位](https://www.geeksforgeeks.org/write-a-c-program-to-reverse-digits-of-a-number/)，然后将 `n` 的倒位与 `n` 进行对比。如果两者相同，则返回真，否则返回假。
以下是上述方法的实施：
