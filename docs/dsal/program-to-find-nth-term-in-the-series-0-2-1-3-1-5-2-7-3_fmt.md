...
> 原文:[https://www.geeksforgeeks.org/program-to-find-nth-term-in-the-series-0-2-1-3-1-5-2-7-3/](https://www.geeksforgeeks.org/program-to-find-nth-term-in-the-series-0-2-1-3-1-5-2-7-3/)
...
*   如果是奇数，设置 `N=(N/2) + 1`(因为有两个系列并行运行)并找到第 `N` 个[斐波那契数](https://www.geeksforgeeks.org/program-for-nth-fibonacci-number/)。
