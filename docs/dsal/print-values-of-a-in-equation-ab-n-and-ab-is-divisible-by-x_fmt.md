# 打印等式(a+b) <= n中‘a’的值，a+b 可被 x 整除

> 原文: [https://www.geeksforgeeks.org/print-values-of-a-in-equation-ab-n-and-ab-is-divisible-by-x/](https://www.geeksforgeeks.org/print-values-of-a-in-equation-ab-n-and-ab-is-divisible-by-x/)
