...
> 原文: [https://www.geeksforgeeks.org/highest-power-of-2-that-divides-the-lcm-of-first-n-natural-numbers/](https://www.geeksforgeeks.org/highest-power-of-2-that-divides-the-lcm-of-first-n-natural-numbers/)
...
**有效方法:** 前 `N` 个自然数的 LCM 总是可被 2 的幂整除，并且由于前 `N` 个自然数的 LCM 包含 2 * 4 * 8 * 16 ……N 的乘积，因此，除以第一个 `N` 自然数 LCM 的最大 2 的幂将总是 $\lfloor \log_2 N \rfloor$。
