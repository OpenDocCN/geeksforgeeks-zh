...
> 原文：[https://www.geeksforgeeks.org/volume-of-biggest-sphere-within-a-right-circular-cylinder/](https://www.geeksforgeeks.org/volume-of-biggest-sphere-within-a-right-circular-cylinder/)

给定半径为`r`、高度为`h`的右圆柱体。任务是找到可以在其中内接的最大球体的半径。
