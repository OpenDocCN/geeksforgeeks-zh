...
> 原文: [https://www.geeksforgeeks.org/sum-product-elements-sub-arrays-size-k/](https://www.geeksforgeeks.org/sum-product-elements-sub-arrays-size-k/)
...
一种天真的方法是生成大小为 `k` 的所有子阵，并对子阵所有元素的乘积求和。
...
一个高效的方法就是使用[滑动窗口](https://www.geeksforgeeks.org/window-sliding-technique/)的概念。
