...
> 原文: [https://www.geeksforgeeks.org/all-elements-in-an-array-are-same-or-not/](https://www.geeksforgeeks.org/all-elements-in-an-array-are-same-or-not/)
...
我们创建一个空的 `HashSet`，把所有的元素都插入其中，然后我们最后看看 `HashSet` 的大小是否为 1。
