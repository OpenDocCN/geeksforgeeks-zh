...
> 原文：[https://www.geeksforgeeks.org/convert-decimal-fraction-binary-number/](https://www.geeksforgeeks.org/convert-decimal-fraction-binary-number/)
...
参考:
[http://cs.furman.edu/digitaldomain/more/ch6/dec_frac_to_bin.htm](http://cs.furman.edu/digitaldomain/more/ch6/dec_frac_to_bin.htm)
[http://www.cquestions.com/2011/07/c-program-for-fractional-decimal-to.html](http://www.cquestions.com/2011/07/c-program-for-fractional-decimal-to.html)
如果你喜欢 GeeksforGeeks 并想投稿，你也可以使用 [write.geeksforgeeks.org](https://write.geeksforgeeks.org)写一篇文章或者把你的文章邮寄到 `contribute@geeksforgeeks.org`。看到你的文章出现在极客博客主页上，帮助其他极客。
