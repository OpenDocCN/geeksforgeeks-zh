...
> 原文: [https://www.geeksforgeeks.org/mix-order-traversal-of-a-binary-tree/](https://www.geeksforgeeks.org/mix-order-traversal-of-a-binary-tree/)
...
*   打印**当前节点**。
*   在左子树(`root->left`)上执行[有序遍历](https://www.geeksforgeeks.org/inorder-tree-traversal-without-recursion/)。
*   在**右子树**上执行**有序遍历**。
