...
> 原文：[https://www.geeksforgeeks.org/find-the-maximum-between-n-and-the-number-formed-by-reversing-32-bit-binary-representation-of-n/](https://www.geeksforgeeks.org/find-the-maximum-between-n-and-the-number-formed-by-reversing-32-bit-binary-representation-of-n/)

给定一个正的 32 位整数 `N`，任务是找出 `N` 的值与将 `N` 在 32 位整数中的二进制表示进行反转后得到的数之间的最大值。
...
> **输出:** `1610612736`
> **解释:**
> 6 在 32 位整数中的二进制表示为 `00000000000000000000000000000110`。
> 反转这个二进制字符串得到 `01100000000000000000000000000000`。
