...
> 原文: [https://www.geeksforgeeks.org/javascript-program-for-sorting-a-linked-list-that-is-sorted-alternating-ascending-and-descending-orders/](https://www.geeksforgeeks.org/javascript-program-for-sorting-a-linked-list-that-is-sorted-alternating-ascending-and-descending-orders/)
...
**方法:** 基本思路是应用于链表上的合并排序。本文讨论实现: [链表合并排序](https://www.geeksforgeeks.org/merge-sort-for-linked-list/)。
