...
> 原文: [https://www.geeksforgeeks.org/count-all-the-numbers-less-than-106-whose-minimum-prime-factor-is-n/](https://www.geeksforgeeks.org/count-all-the-numbers-less-than-106-whose-minimum-prime-factor-is-n/)
...
**方法:** 用厄拉多塞的筛子寻找问题的解决方案。存储所有小于 `10^6` 的质数。形成另一个筛子，它将存储其最小质因数是筛子索引的所有数字的计数。然后显示素数 `N` 的计数(即 `sieve_count[N]+1`)，其中 `N` 是素数。
