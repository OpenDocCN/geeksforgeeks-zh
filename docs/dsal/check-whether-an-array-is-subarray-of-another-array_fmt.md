...
> 原文：[https://www.geeksforgeeks.org/check-whether-an-array-is-subarray-of-another-array/](https://www.geeksforgeeks.org/check-whether-an-array-is-subarray-of-another-array/)

给定由 `n` 和 `m` 个整数组成的两个数组 `A[]` 和 `B[]`。任务是检查数组 `B[]` 是否是数组 `A[]` 的[子数组](https://www.geeksforgeeks.org/subarraysubstring-vs-subsequence-and-programs-to-generate-them/)。
