...
> 原文：[https://www.geeksforgeeks.org/largest-coprime-set-between-two-integers/](https://www.geeksforgeeks.org/largest-coprime-set-between-two-integers/)

给定表示一个范围的两个整数 `L` 和 `R`，任务是找到范围 `L` 到 `R` 的最大的互质整数集。
