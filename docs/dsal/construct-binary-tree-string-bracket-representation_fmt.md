...
> 原文：[https://www.geeksforgeeks.org/construct-binary-tree-string-bracket-representation/](https://www.geeksforgeeks.org/construct-binary-tree-string-bracket-representation/)
...
以下是一个使用 JavaScript 从字符串构造二叉树并进行前序遍历的示例。
