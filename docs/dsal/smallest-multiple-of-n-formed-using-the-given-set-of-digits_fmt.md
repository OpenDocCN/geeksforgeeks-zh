...
> 原文：[https://www.geeksforgeeks.org/smallest-multiple-of-n-formed-using-the-given-set-of-digits/](https://www.geeksforgeeks.org/smallest-multiple-of-n-formed-using-the-given-set-of-digits/)
...
> `结果[new_mod] = { current_element_of_queue, 数字 }`
