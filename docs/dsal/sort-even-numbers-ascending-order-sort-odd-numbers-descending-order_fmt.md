...
> 原文：[https://www.geeksforgeeks.org/sort-even-numbers-ascending-order-sort-odd-numbers-descending-order/](https://www.geeksforgeeks.org/sort-even-numbers-ascending-order-sort-odd-numbers-descending-order/)
...
1.  [对输入数组](https://www.geeksforgeeks.org/hoares-vs-lomuto-partition-scheme-quicksort/)进行分区，使所有奇数元素向左移动，所有偶数元素向右移动。这一步需要 `O(n)`。
