...
> 原文: [https://www.geeksforgeeks.org/closest-greater-or-same-value-on-left-side-for-every-element-in-array/](https://www.geeksforgeeks.org/closest-greater-or-same-value-on-left-side-for-every-element-in-array/)
...
我们使用 C++ 中的 [`lower_bound()`](https://www.geeksforgeeks.org/lower_bound-in-cpp/) 来寻找最近的更大元素。这个函数在一个集合的 `Log n` 时间内工作。
