...
> 原文: [https://www.geeksforgeeks.org/print-all-possible-combinations-of-words-from-dictionary-using-trie/](https://www.geeksforgeeks.org/print-all-possible-combinations-of-words-from-dictionary-using-trie/)
...
```java
// Java implementation of word break using Trie
class GFG
{
