...
> 原文: [https://www.geeksforgeeks.org/generate-an-array-such-with-elements-maximized-through-swapping-bits/](https://www.geeksforgeeks.org/generate-an-array-such-with-elements-maximized-through-swapping-bits/)
...
> **输出:** `12, 15`
> **解释:**
> 二进制表示 `(10)₁₀ = (1010)₂`。交换第二位和第三位，得到二进制表示为 `(1100)₂ = (12)₁₀`。
...
*   如果设置位或未设置位的计数等于数组元素的位数，则该元素不能更改（例如 `(7)₁₀ = (111)₂`）。
*   打印数组中最大化的元素。
