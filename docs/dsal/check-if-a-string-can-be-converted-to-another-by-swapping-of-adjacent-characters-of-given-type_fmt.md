...
> 原文: [https://www.geeksforgeeks.org/check-if-a-string-can-be-converted-to-another-by-swapping-of-adjacent-characters-of-given-type/](https://www.geeksforgeeks.org/check-if-a-string-can-be-converted-to-another-by-swapping-of-adjacent-characters-of-given-type/)
...
> **输入:** `str1 = "BCCABCBCA"`, `str2 = "CBACCBBAC"`
> **输出:** 是
> **解释:**
> 使用以下步骤变换字符串:
> `BCCABCBCA` -> `CBCABCBCA` -> `CBACBCBCA` -> `CBACCBBCA` -> `CBACCBBAC`。
> **输入:** `str1 = "BAC"`, `str2 = "CAB"`
> **输出:** False
