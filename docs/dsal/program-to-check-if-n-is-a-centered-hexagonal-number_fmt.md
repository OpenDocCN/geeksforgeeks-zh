...
> 原文: [https://www.geeksforgeeks.org/program-to-check-if-n-is-a-centered-hexagonal-number/](https://www.geeksforgeeks.org/program-to-check-if-n-is-a-centered-hexagonal-number/)

给定一个整数 `N`，任务是检查 `N` 是否为[中心六边形数](https://www.geeksforgeeks.org/centered-hexagonal-number/)。如果数字 `N` 是居中的六边形数字，则打印“是”，否则打印“否”。

> **中心六边形数**，呈六边形。中心六边形数不同于六边形数，因为它在中心包含一个元素。前几个居中的六边形数字是 1，7，19，37，61，91，127 …**
