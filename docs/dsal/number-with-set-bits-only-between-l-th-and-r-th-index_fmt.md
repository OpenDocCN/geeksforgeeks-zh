...
> 原文: [https://www.geeksforgeeks.org/number-with-set-bits-only-between-l-th-and-r-th-index/](https://www.geeksforgeeks.org/number-with-set-bits-only-between-l-th-and-r-th-index/)
...
> **输入:** `L = 2`，`R = 5`
> **输出:** `60`
> **说明:** 二进制表示为 `0..0111100` => `60`
>
> **输入:** `L = 1`，`R = 3`
> **输出:** `14`
> **说明:** 二进制表示为 `0..01110` => `14`

## 天真法

求数的天真法是从 `i = L` 迭代到 `i = R`，计算 `2^i` 的所有次方之和。
下面的程序说明了天真的方法:
