...
> 原文：[https://www.geeksforgeeks.org/smallest-k-digit-number-divisible-x/](https://www.geeksforgeeks.org/smallest-k-digit-number-divisible-x/)
...
一个**简单的解决方法**是从最小的 `K` 位数（是 `100……(K-1)` 次）开始尝试所有数字，返回第一个被 `X` 整除的数字。
