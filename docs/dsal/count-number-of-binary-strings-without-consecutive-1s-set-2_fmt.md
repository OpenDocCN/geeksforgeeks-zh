...
> 原文：[https://www.geeksforgeeks.org/count-number-of-binary-strings-without-consecutive-1s-set-2/](https://www.geeksforgeeks.org/count-number-of-binary-strings-without-consecutive-1s-set-2/)
...
[动态规划](https://www.geeksforgeeks.org/dynamic-programming/)方法已经在[这篇文章](https://www.geeksforgeeks.org/count-number-binary-strings-without-consecutive-1s/)中讨论过了。

## 方法

本文讨论了一种使用[数字-dp](https://www.geeksforgeeks.org/digit-dp-introduction/)概念的方法。

*   类似于数字 dp 问题，这里创建了一个**三维表格**来存储计算值。假设 `N < 2^31 - 1`，每个数字的范围只有 2（0 或 1）。因此，表的尺寸取为 `32 × 2 × 2`。
