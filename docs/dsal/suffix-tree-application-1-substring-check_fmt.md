...
> 原文: [https://www.geeksforgeeks.org/suffix-tree-application-1-substring-check/](https://www.geeksforgeeks.org/suffix-tree-application-1-substring-check/)

给定一个文本字符串和一个模式字符串，检查文本中是否存在模式。
很少有模式搜索算法（ [`KMP`](https://www.geeksforgeeks.org/searching-for-patterns-set-2-kmp-algorithm/) 、[`Rabin-Karp`](https://www.geeksforgeeks.org/searching-for-patterns-set-3-rabin-karp-algorithm/) 、[朴素算法](https://www.geeksforgeeks.org/searching-for-patterns-set-1-naive-pattern-searching/) 、[有限自动机](https://www.geeksforgeeks.org/pattern-searching-set-5-efficient-constructtion-of-finite-automata/)）已经讨论过，可以用于本次检查。
这里我们将讨论基于后缀树的算法。
...
*   [Ukkonen 的后缀树构建–第 6 部分](https://www.geeksforgeeks.org/ukkonens-suffix-tree-construction-part-6/)
