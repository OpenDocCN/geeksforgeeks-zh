...
> 原文: [https://www.geeksforgeeks.org/check-if-any-large-number-is-divisible-by-17-or-not/](https://www.geeksforgeeks.org/check-if-any-large-number-is-divisible-by-17-or-not/)
...
请注意，上面的程序可能没有多大意义，因为可以简单地做 `n % 17` 来检查可分性。这个程序的想法是验证这个概念。此外，如果输入数字很大并且以字符串形式给出，这可能是一种有效的方法。