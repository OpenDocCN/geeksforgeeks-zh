...
> 原文: [https://www.geeksforgeeks.org/sum-of-all-even-factors-of-numbers-in-the-range-l-r/](https://www.geeksforgeeks.org/sum-of-all-even-factors-of-numbers-in-the-range-l-r/)
...
我们可以修改【厄拉多塞的 T2】筛将一个数的所有偶数因子的和存储在其对应的索引处。然后我们将创建一个前缀数组来存储该索引的总和。现在每个查询都可以用`前缀[r]–前缀[l–1]`在 O(1)中回答。
