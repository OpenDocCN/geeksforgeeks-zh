...
> 原文: [https://www.geeksforgeeks.org/josephus-problem-set-2-simple-solution-k-2/](https://www.geeksforgeeks.org/josephus-problem-set-2-simple-solution-k-2/)
...
这个问题的另一个有趣的解决方案，当 k=2 时，可以根据观察给出，我们只需要向左旋转 N 的二进制表示，就可以得到所需的答案。考虑到编号为 64 位编号，下面提供了的工作代码。
