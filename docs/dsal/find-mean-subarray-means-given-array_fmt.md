...
> 原文：[https://www.geeksforgeeks.org/find-mean-subarray-means-given-array/](https://www.geeksforgeeks.org/find-mean-subarray-means-given-array/)
...
一个**有效的解决方案**是使用[滑动窗口算法](https://www.geeksforgeeks.org/window-sliding-technique/)来解决这个问题，在这个问题中，我们找到 `m` 长度窗口的和，然后将每个窗口的平均值加到一个值和上。最后，我们将通过将总和除以可能的窗口数得到我们的结果，这也是`总和/(n-m+1)`。
...
```csharp
// C# program to find mean of means
using System;
