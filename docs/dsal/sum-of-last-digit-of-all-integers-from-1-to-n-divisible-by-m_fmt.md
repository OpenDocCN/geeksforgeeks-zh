...
> 原文: [https://www.geeksforgeeks.org/sum-of-last-digit-of-all-integers-from-1-to-n-divisible-by-m/](https://www.geeksforgeeks.org/sum-of-last-digit-of-all-integers-from-1-to-n-divisible-by-m/)

给定两个整数 `N` 和 `M`。任务是计算从 `1` 到 `N` 的所有整数最后一位的和，该和可被 `M` 整除。
