# 仅通过插入元素使长度为 K 的所有子阵列的和相等

> 原文: [https://www.geeksforgeeks.org/modify-given-array-to-make-the-sum-of-all-subarrays-of-length-k-equal/](https://www.geeksforgeeks.org/modify-given-array-to-make-the-sum-of-all-subarrays-of-length-k-equal/)
