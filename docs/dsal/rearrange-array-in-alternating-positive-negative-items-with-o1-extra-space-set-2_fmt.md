# 用 O(1) 个额外空间交替排列正负项目 | 设置 2

> 原文: [https://www.geeksforgeeks.org/rearrange-array-in-alternating-positive-negative-items-with-o1-extra-space-set-2/](https://www.geeksforgeeks.org/rearrange-array-in-alternating-positive-negative-items-with-o1-extra-space-set-2/)
...
我们已经讨论了一个 `O(n^2)`解决方案，它保持了数组中的出现顺序[这里](https://www.geeksforgeeks.org/rearrange-array-alternating-positive-negative-items-o1-extra-space/)。如果允许我们改变出现的顺序，我们可以在 `O(n)`时间和 `O(1)`空间中解决这个问题。
