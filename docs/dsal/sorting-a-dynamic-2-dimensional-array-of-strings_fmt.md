...
> 原文: [https://www.geeksforgeeks.org/sorting-a-dynamic-2-dimensional-array-of-strings/](https://www.geeksforgeeks.org/sorting-a-dynamic-2-dimensional-array-of-strings/)

## 先决条件
[如何在 C 中动态分配一个 2D 阵？](https://www.geeksforgeeks.org/dynamically-allocate-2d-array-c/)

## 双指针
指向另一个指针的指针称为双指针。使用`**`来表示双指针。双指针也被称为指针对指针。
