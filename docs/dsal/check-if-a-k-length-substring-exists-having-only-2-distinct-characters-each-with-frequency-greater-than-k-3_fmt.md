...
> 原文:[https://www . geeksforgeeks . org/check-if-a-k-length-substring-exists-仅具有-2 个不同字符-每个字符的频率大于-k-3/](https://www.geeksforgeeks.org/check-if-a-k-length-substring-exists-having-only-2-distinct-characters-each-with-frequency-greater-than-k-3/)
