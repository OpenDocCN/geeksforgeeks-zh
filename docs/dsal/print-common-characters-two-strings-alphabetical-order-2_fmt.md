...
> 原文：[https://www.geeksforgeeks.org/print-common-characters-two-strings-alphabetical-order-2/](https://www.geeksforgeeks.org/print-common-characters-two-strings-alphabetical-order-2/)
...
**时间复杂度：** 如果我们考虑`n`=`length(更大的字符串)`，那么这个算法以`O(n)`复杂度运行。