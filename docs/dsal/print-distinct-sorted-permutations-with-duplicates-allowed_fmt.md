...
> 原文: [https://www.geeksforgeeks.org/print-distinct-sorted-permutations-with-duplicates-allowed/](https://www.geeksforgeeks.org/print-distinct-sorted-permutations-with-duplicates-allowed/)
...
**例:** 考虑一个字符串 `ABCD`。
**第一步:** 整理字符串。
**第二步:** 获取该字符串可形成的[排列总数](https://www.geeksforgeeks.org/number-distinct-permutation-string-can/)。
