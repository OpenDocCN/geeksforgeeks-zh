...
> 原文: [https://www.geeksforgeeks.org/find-the-maximum-possible-value-of-the-minimum-value-of-modified-array/](https://www.geeksforgeeks.org/find-the-maximum-possible-value-of-the-minimum-value-of-modified-array/)

给定一个大小为 `N` 的数组和一个数字 `S`。任务是修改给定的数组，使得:
*   修改前后数组元素之和的差值正好等于 `S`。
*   修改后的数组元素应该是非负的。
*   修改后的数组中的最小值必须最大化。
