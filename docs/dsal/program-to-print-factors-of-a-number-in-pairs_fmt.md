...
> 原文：[https://www.geeksforgeeks.org/program-to-print-factors-of-a-number-in-pairs/](https://www.geeksforgeeks.org/program-to-print-factors-of-a-number-in-pairs/)
...
如果 `a*b = N` 其中 `1<a≤b<n`，则 `n = ab≥a^2⇔a^2≤n⇔a≤√n`。
