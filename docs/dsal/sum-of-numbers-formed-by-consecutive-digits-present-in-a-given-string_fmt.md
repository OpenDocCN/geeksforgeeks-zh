...
> 原文: [https://www.geeksforgeeks.org/sum-of-numbers-formed-by-consecutive-digits-present-in-a-given-string/](https://www.geeksforgeeks.org/sum-of-numbers-formed-by-consecutive-digits-present-in-a-given-string/)
...
*   如果当前字符不是数字，将 `curr` 的当前值加到最后的 `答案` 中。将 `curr` 复位至 `0`。
*   否则，将当前数字追加到 `curr` 中。
*   最后，返回最终答案。
