...
> 原文：[https://www.geeksforgeeks.org/move-zeroes-end-array-using-list-comprehension-python/](https://www.geeksforgeeks.org/move-zeroes-end-array-using-list-comprehension-python/)
...
```
# Function to append all zeros at the end of array
def moveZeros(arr):
    # first expression returns a list of all non zero elements in arr in the same order they were inserted into arr
    # second expression returns a list of zeros present in arr
