...
> 原文: [https://www.geeksforgeeks.org/check-if-n-contains-all-digits-as-k-in-base-b/](https://www.geeksforgeeks.org/check-if-n-contains-all-digits-as-k-in-base-b/)
...
**天真方法:** 一个简单的解决方法是[将给定的数字 `N` 转换为基数 `B`](https://www.geeksforgeeks.org/convert-base-decimal-vice-versa/) 并逐一检查其所有数字是否为 `K`。
