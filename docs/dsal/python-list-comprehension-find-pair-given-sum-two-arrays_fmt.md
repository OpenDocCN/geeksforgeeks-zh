...
> 原文: [https://www.geeksforgeeks.org/python-list-comprehension-find-pair-given-sum-two-arrays/](https://www.geeksforgeeks.org/python-list-comprehension-find-pair-given-sum-two-arrays/)
...
```python
# Function to find all pairs whose sum is x in two arrays
def allPairs(arr1, arr2, x):
    # finds all pairs in two arrays whose sum is x
