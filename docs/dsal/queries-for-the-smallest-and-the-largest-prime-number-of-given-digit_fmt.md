...
> 原文：[https://www.geeksforgeeks.org/queries-for-the-smallest-and-the-largest-prime-number-of-given-digit/](https://www.geeksforgeeks.org/queries-for-the-smallest-and-the-largest-prime-number-of-given-digit/)

给定 `Q` 个查询，其中每个查询由一个整数 `D` 组成，任务是找到具有 `D` 位数的最小和最大素数。如果不存在这样的质数，则打印 `-1`。
