...
> 原文: [https://www.geeksforgeeks.org/program-for-point-of-intersection-of-two-lines/](https://www.geeksforgeeks.org/program-for-point-of-intersection-of-two-lines/)
...
首先假设我们有两点`(x1, y1)`和`(x2, y2)`。现在，我们找到这些点形成的线的方程。
...
我们现在必须解这两个方程来找到交点。为了求解，我们乘以 1 由 `b2` 和 2 由 `b1`。这就给了我们，
`a1b2x + b1b2y = c1b2`
`a2b1x + b2b1y = c2b1`
...
如果线段由点`(x1, y1)`和`(x2, y2)`指定，那么为了检查`(x, y)`是否在线段上，我们只需检查
