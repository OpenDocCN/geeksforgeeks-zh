...
> 原文：[https://www.geeksforgeeks.org/form-minimum-number-of-palindromic-strings-from-a-given-string/](https://www.geeksforgeeks.org/form-minimum-number-of-palindromic-strings-from-a-given-string/)
...
>
> **解释：**
> 给定的字符串 `S = "ababa"` 已经是回文字符串了。所以，只会形成 1 个字符串。
>
> **输入：** `S = "abc"`
> **输出：** `{"a", "b", "c"}`
>
...
*   一般的方法是存储每个字符的[频率](https://www.geeksforgeeks.org/python-frequency-of-each-character-in-string/)，如果某个字符的频率是奇数，那么我们必须创建一个新的字符串，并将我们的答案增加 1。
