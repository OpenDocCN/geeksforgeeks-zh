...
> 原文：[https://www.geeksforgeeks.org/find-number-co-prime-pairs-array/](https://www.geeksforgeeks.org/find-number-co-prime-pairs-array/)
...
使用两个循环，检查数组中每一个可能的对。如果该对的 Gcd 为 1，递增计数器值，最后显示它。
