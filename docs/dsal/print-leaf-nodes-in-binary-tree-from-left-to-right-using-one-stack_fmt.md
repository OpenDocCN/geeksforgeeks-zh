...
> 原文: [https://www.geeksforgeeks.org/print-leaf-nodes-in-binary-tree-from-left-to-right-using-one-stack/](https://www.geeksforgeeks.org/print-leaf-nodes-in-binary-tree-from-left-to-right-using-one-stack/)
...
我们已经讨论了使用两个堆栈的[迭代方法](https://www.geeksforgeeks.org/print-all-leaf-nodes-of-a-binary-tree-from-left-to-right-set-2-iterative-approach/)。

## 方法

想法是使用一个堆栈执行迭代[后序遍历](https://www.geeksforgeeks.org/iterative-postorder-traversal-using-stack/)并打印叶节点。
