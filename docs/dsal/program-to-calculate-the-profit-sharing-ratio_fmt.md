...
> 原文: [https://www.geeksforgeeks.org/program-to-calculate-the-profit-sharing-ratio/](https://www.geeksforgeeks.org/program-to-calculate-the-profit-sharing-ratio/)

给定一系列金额和时间段，表示 N 个人投资的金额和他们投资的时间段。任务是计算**末利润比**。

**例:**

> **输入:** `n` = 2，`Amount1` = 7000，`时间1` = 12 个月，`Amount2` = 6000，`时间2` = 6 个月
> **输出:** 7:3
>
> **输入:** `n` = 3，`Amount1` = 5000，`时间1` = 6 个月，`Amount2` = 6000，`时间2` = 6 个月，`Amount3` = 1000，`时间3` = 12 个月
> **输出:** 5:6:2
