...
> 原文: [https://www.geeksforgeeks.org/program-to-print-the-initials-of-a-name-with-the-surname/](https://www.geeksforgeeks.org/program-to-print-the-initials-of-a-name-with-the-surname/)
...
基本做法是一个个提取单词，然后打印单词的第一个字母，后面跟着一个点(`.`).对于姓氏，提取并打印整个单词。
