...
> 原文: [https://www.geeksforgeeks.org/print-pairs-anagrams-given-array-strings/](https://www.geeksforgeeks.org/print-pairs-anagrams-given-array-strings/)
...
我们可以通过计数数组[在线性时间](https://www.geeksforgeeks.org/check-whether-two-strings-are-anagram-of-each-other/)内找到两个字符串是否为字谜(见本[方法二](https://www.geeksforgeeks.org/check-whether-two-strings-are-anagram-of-each-other/))。
