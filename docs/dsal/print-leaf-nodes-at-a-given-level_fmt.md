...
> 原文: [https://www.geeksforgeeks.org/print-leaf-nodes-at-a-given-level/](https://www.geeksforgeeks.org/print-leaf-nodes-at-a-given-level/)
...
**方法**: 以层级顺序递归遍历树。如果当前级别与给定级别相同，则检查当前节点是否是叶节点。如果它是叶节点，那么打印它。
以下是上述办法的实施情况:
