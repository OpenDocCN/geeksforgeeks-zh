...
> 原文：[https://www.geeksforgeeks.org/find-the-minimum-and-maximum-sum-of-n-1-elements-of-the-array/](https://www.geeksforgeeks.org/find-the-minimum-and-maximum-sum-of-n-1-elements-of-the-array/)

给定一个大小为 `N` 的未排序数组 `A`，任务是通过精确添加 `N-1` 个元素来找到可以计算的最小值和最大值。
