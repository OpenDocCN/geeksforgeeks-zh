...
> 原文: [https://www.geeksforgeeks.org/check-whether-given-matrix-orthogonal-not/](https://www.geeksforgeeks.org/check-whether-given-matrix-orthogonal-not/)
...
思路很简单，我们先找到矩阵的转置。然后我们用给定的矩阵乘以转置。最后我们检查得到的矩阵是否恒等式。
