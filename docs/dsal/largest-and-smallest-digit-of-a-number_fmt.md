...
> 原文: [https://www.geeksforgeeks.org/largest-and-smallest-digit-of-a-number/](https://www.geeksforgeeks.org/largest-and-smallest-digit-of-a-number/)
...
一种有效的方法是找出给定数字中的所有数字，并找出最大和最小的数字。
