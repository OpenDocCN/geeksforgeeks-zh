...
> 原文: [https://www.geeksforgeeks.org/number-of-binary-trees-for-given-preorder-sequence-length/](https://www.geeksforgeeks.org/number-of-binary-trees-for-given-preorder-sequence-length/)
...
*   假设只有一个节点(在这种情况下是 `2`)，那么只有一个二叉树是可能的。
...
**替代:**
这个也可以用[加泰罗尼亚数](https://www.geeksforgeeks.org/program-nth-catalan-number/) `Cn = (2n)! / ((n+1)! * n!)` 来完成。
