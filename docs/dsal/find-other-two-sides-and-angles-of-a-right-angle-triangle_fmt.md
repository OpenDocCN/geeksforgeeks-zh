...
> 原文: [https://www.geeksforgeeks.org/find-other-two-sides-and-angles-of-a-right-angle-triangle/](https://www.geeksforgeeks.org/find-other-two-sides-and-angles-of-a-right-angle-triangle/)
...
> 解释: `a = 12`，`b = 35` 和 `c = 37` 形成直角角三角形因为 `12*12 + 35*35 = 37*37`
