...
> 原文：[https://www.geeksforgeeks.org/sum-of-all-subsequences-of-a-number/](https://www.geeksforgeeks.org/sum-of-all-subsequences-of-a-number/)
...
**方法：** 使用[幂集](https://www.geeksforgeeks.org/subarraysubstring-vs-subsequence-and-programs-to-generate-them/)，我们可以找到所有的子序列，并在不同的函数中单独对所有的子序列求和。可能的子序列总数为 `2^n -1`。将所有子序列的总和与最终输出的总和相加。
以下是上述方法的实施。
