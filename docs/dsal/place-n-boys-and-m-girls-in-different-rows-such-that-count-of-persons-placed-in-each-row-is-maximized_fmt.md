...
> 原文: [https://www.geeksforgeeks.org/place-n-boys-and-m-girls-in-different-rows-such-that-count-of-persons-placed-in-each-row-is-maximized/](https://www.geeksforgeeks.org/place-n-boys-and-m-girls-in-different-rows-such-that-count-of-persons-placed-in-each-row-is-maximized/)
...
*   由于每行可以包含男孩或女孩，并且所有行的大小必须相同，因此最理想的排列方式是在每行中放置 `(N, M)` 数量的元素的[最大公约数](https://www.geeksforgeeks.org/c-program-find-gcd-hcf-two-numbers/)。
