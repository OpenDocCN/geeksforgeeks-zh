...
> 原文：[https://www.geeksforgeeks.org/smallest-subarray-such-that-all-elements-are-greater-than-k/](https://www.geeksforgeeks.org/smallest-subarray-such-that-all-elements-are-greater-than-k/)
...
```javascript
<script>
// JavaScript to print the length of the shortest
// subarray with all elements greater than X
