...
> 原文: [https://www.geeksforgeeks.org/radius-of-a-circle-having-area-equal-to-the-sum-of-area-of-the-circles-having-given-radii/](https://www.geeksforgeeks.org/radius-of-a-circle-having-area-equal-to-the-sum-of-area-of-the-circles-having-given-radii/)

给定两个整数 `r1` 和 `r2`，代表两个圆的半径，任务是求面积等于给定半径的两个圆的面积之和的圆的半径。
