...
> 原文: [https://www.geeksforgeeks.org/find-the-k-th-permutation-sequence-of-first-n-natural-numbers/](https://www.geeksforgeeks.org/find-the-k-th-permutation-sequence-of-first-n-natural-numbers/)

给定两个整数 `N` 和 `K`，在不使用 STL 函数的情况下，求出从 1 到 N 的数的第 K 个置换序列。
