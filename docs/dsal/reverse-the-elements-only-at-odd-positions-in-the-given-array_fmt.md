...
> 原文: [https://www.geeksforgeeks.org/reverse-the-elements-only-at-odd-positions-in-the-given-array/](https://www.geeksforgeeks.org/reverse-the-elements-only-at-odd-positions-in-the-given-array/)

给定一个包含 `N` 整数的数组 `arr[]`，任务是重新排列数组，使奇数索引元素的顺序相反。
