...
> 原文: [https://www.geeksforgeeks.org/selection-sort-visualizer-in-javascript/](https://www.geeksforgeeks.org/selection-sort-visualizer-in-javascript/)
...
*   按钮`生成新数组`使用`Math.random()`函数和对应于高度值的条生成随机值数组。
