...
> 原文：[https://www.geeksforgeeks.org/java-program-to-find-minimum-insertions-to-form-a-palindrome-dp-28/](https://www.geeksforgeeks.org/java-program-to-find-minimum-insertions-to-form-a-palindrome-dp-28/)
...
1.  在子串 `字符串[l+1，…h]` 中找到插入的最小数量。
2.  找到子字符串 `字符串[l …h-1]` 中插入的最小数量。
3.  找到子串 `字符串[l+1……h-1]` 中插入的最小数量。
