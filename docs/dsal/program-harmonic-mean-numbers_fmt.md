...
> 原文：[https://www.geeksforgeeks.org/program-harmonic-mean-numbers/](https://www.geeksforgeeks.org/program-harmonic-mean-numbers/)
...
> n 个数字的调和平均值 x<sub>1</sub>，x<sub>2</sub>，x<sub>3</sub>，...，x<sub>n</sub> 可以写成如下。
...
其中 f<sub>1</sub>，f<sub>2</sub>，f<sub>3</sub>，...，f<sub>n</sub> 为元素的频率，x<sub>1</sub>，x<sub>2</sub>，x<sub>3</sub>，...，x<sub>n</sub> 是数组的元素。
...
调和平均数在 Python 中的使用：`harmonic_mean()`
简单 Python 程序查找调和平均数使用`harmonic_mean()`函数。
