...
> 原文: [https://www.geeksforgeeks.org/represent-n-as-sum-of-k-even-numbers/](https://www.geeksforgeeks.org/represent-n-as-sum-of-k-even-numbers/)
...
解决上述问题的一个简单方法是最大化最小偶数 2 的出现。将 `N` 表示为 `K` 个数之和的必要条件是:
