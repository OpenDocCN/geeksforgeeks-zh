...
> 原文：[https://www.geeksforgeeks.org/find-the-sum-of-the-first-nth-centered-pentadecagonal-number/](https://www.geeksforgeeks.org/find-the-sum-of-the-first-nth-centered-pentadecagonal-number/)

给定一个数字 `N`，任务是找出第一个 `N` 个[居中的五边形数](https://www.geeksforgeeks.org/centered-pentadecagonal-number/)的和。

> 前几个居中的五边形数是 **1、16、46、91、151、226、316……**
...
1.  首先，我们需要创建一个函数来帮助我们计算第 `N` 个[以五边形为中心的数](https://www.geeksforgeeks.org/centered-pentadecagonal-number/)。
2.  现在，运行一个从 `1` 到 `N` 的循环，找到第 `i` 个居中的五边形数。
3.  将上面计算的所有居中的五边形数相加。
