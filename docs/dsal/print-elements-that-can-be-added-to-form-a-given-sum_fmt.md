...
> 原文: [https://www.geeksforgeeks.org/print-elements-that-can-be-added-to-form-a-given-sum/](https://www.geeksforgeeks.org/print-elements-that-can-be-added-to-form-a-given-sum/)

给定一个正整数数组 `arr[]` 和一个 `Sum`，任务是打印将要包含的元素以获得给定的和。
...
>
> **输入:** `arr[] = {7, 10, 6, 4}`, `Sum = 12`
> **输出:** `7 4`
> 因为，`7+10` 和 `7+6` 的总和大于 12，
> 但 `7+4 = 11` 小于 12。
> 所以，7 和 4 可以包含在内。
