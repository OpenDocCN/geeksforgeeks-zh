...
> 原文：[https://www.geeksforgeeks.org/write-your-own-strcmp-which-ignores-cases/](https://www.geeksforgeeks.org/write-your-own-strcmp-which-ignores-cases/)

编写一个修改后的 `strcmp` 函数，该函数忽略大小写，如果 `s1 < s2` 返回 `-1`，`0 if s1 = s2`，否则返回 `1`。例如，你的 `strcmp` 应该考虑 “GeeksforGeeks” 和 “geeksforgeeks” 为相同字符串。
来源：[微软面试集 5](https://www.geeksforgeeks.org/microsoft-interview-set-5/)
