...
> 原文: [https://www.geeksforgeeks.org/java-program-for-removing-duplicates-from-a-sorted-linked-list/](https://www.geeksforgeeks.org/java-program-for-removing-duplicates-from-a-sorted-linked-list/)
...
更多详情请参考[从排序链表中删除重复项的完整文章](https://www.geeksforgeeks.org/remove-duplicates-from-a-sorted-linked-list/)！