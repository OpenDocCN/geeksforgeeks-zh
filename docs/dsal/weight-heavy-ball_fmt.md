...
共有 2187 个球，其中 1 个重。找出最小的尝试次数，为了找到重球，球必须被称重。
...
### Step 1
将 2187 个球分成 3 个相等的组，每组 729 个，分别称为 `C1`、`C2` 和 `C3`。将 `C1` 放在天平的一侧，`C2` 放在另一侧。这可能产生 3 种情况：
...
### Step 2
现在将 `C3` 再次分成 3 个相等的组，每组 243 个，再次命名为 `C1`、`C2` 和 `C3`。将 `C1` 放在天平的一侧，`C2` 放在另一侧。这可能产生 3 种情况：
*   条件 1: `C1` 等于 `C2`，这意味着 `C3` 有最重的球
*   条件二:`C1` < `C2`，意味着 `C2` 的球最重。
*   条件三:`C1` > `C2`，也就是说 `C1` 的球最重。
...
### Step 3
现在将 `C2` 再次分成 3 个相等的组，每组 81 个，再次命名为 `C1`、`C2` 和 `C3`。将 `C1` 放在天平的一侧，`C2` 放在另一侧。这可能产生 3 种情况：
*   条件 1: `C1` 等于 `C2`，这意味着 `C3` 有最重的球
*   条件二:`C1` < `C2`，意味着 `C2` 的球最重。
*   条件三:`C1` > `C2`，也就是说 `C1` 的球最重。
...
### Step 4
现在将 `C1` 再次分成 3 个相等的组，每组 27 个，再次命名为 `C1`、`C2` 和 `C3`。将 `C1` 放在天平的一侧，`C2` 放在另一侧。这可能产生 3 种情况：
*   条件 1: `C1` 等于 `C2`，这意味着 `C3` 有最重的球
*   条件二:`C1` < `C2`，意味着 `C2` 的球最重。
*   条件三:`C1` > `C2`，也就是说 `C1` 的球最重。
...
### Step 5
现在将 `C1` 再次分成 3 个相等的组，每组 9 个，再次命名为 `C1`、`C2` 和 `C3`。将 `C1` 放在天平的一侧，`C2` 放在另一侧。这可能产生 3 种情况：
*   条件 1: `C1` 等于 `C2`，这意味着 `C3` 有最重的球
*   条件二:`C1` < `C2`，意味着 `C2` 的球最重。
*   条件三:`C1` > `C2`，也就是说 `C1` 的球最重。
...
### Step 6
现在将 `C3` 再次分成 3 个相等的组，每组 3 个，再次命名为 `C1`、`C2` 和 `C3`。将 `C1` 放在天平的一侧，`C2` 放在另一侧。这可能产生 3 种情况：
*   条件 1: `C1` 等于 `C2`，这意味着 `C3` 有最重的球
*   条件二:`C1` < `C2`，意味着 `C2` 的球最重。
*   条件三:`C1` > `C2`，也就是说 `C1` 的球最重。
...
### Step 7
现在最后将有 3 个球的 `C3` 分成每组 1 个，再次命名为 `B1`、`B2` 和 `B3`。将 `B1` 放在天平的一侧，`B2` 放在另一侧。这可能产生 3 种情况：
