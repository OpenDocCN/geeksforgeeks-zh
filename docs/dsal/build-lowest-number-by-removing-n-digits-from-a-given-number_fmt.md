...
> 原文: [https://www.geeksforgeeks.org/build-lowest-number-by-removing-n-digits-from-a-given-number/](https://www.geeksforgeeks.org/build-lowest-number-by-removing-n-digits-from-a-given-number/)
...
2.  创建一个堆栈，遍历 `num` 字符串，如果该位置的值大于堆栈的顶部元素，则推送该位置的值。
