...
> 原文：[https://www.geeksforgeeks.org/number-of-balanced-parenthesis-substrings/](https://www.geeksforgeeks.org/number-of-balanced-parenthesis-substrings/)

给定一个由 `(` 和 `)` 组成的平衡括号字符串。任务是找到给定字符串中[平衡括号](https://www.geeksforgeeks.org/check-for-balanced-parentheses-in-an-expression/)子串的数量。
