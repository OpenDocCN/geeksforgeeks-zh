...
> 原文: [https://www.geeksforgeeks.org/goldman-sachs-interview-experience-set-34-off-campus/](https://www.geeksforgeeks.org/goldman-sachs-interview-experience-set-34-off-campus/)
...
## 第 2 轮:Coderpad 回合:(1 小时)
通常有两个问题。但是根据时间的不同，他们可能会也可能不会问第二个问题。您应该至少完成一个最佳解决方案。
