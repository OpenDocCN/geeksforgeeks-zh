# 打印 N 个数字，使它们的乘积是一个完美的立方体

> 原文: [https://www.geeksforgeeks.org/print-n-numbers-such-that-their-product-is-a-perfect-cube/](https://www.geeksforgeeks.org/print-n-numbers-such-that-their-product-is-a-perfect-cube/)

给定一个数字 `N`，任务是找到 `N` 个不同的数字，使它们的乘积是一个[完美立方体](https://www.geeksforgeeks.org/perfect-cube/)。
