...
> 原文: [https://www.geeksforgeeks.org/find-the-node-whose-xor-with-x-gives-minimum-value/](https://www.geeksforgeeks.org/find-the-node-whose-xor-with-x-gives-minimum-value/)

给定一棵树，所有节点的权重和一个整数 `x`，任务是找到一个节点 `i`，使得 `weight[i] xor x` 最小。
