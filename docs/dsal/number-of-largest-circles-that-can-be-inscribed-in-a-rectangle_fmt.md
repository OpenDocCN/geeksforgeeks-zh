...
> 原文：[https://www.geeksforgeeks.org/number-of-largest-circles-that-can-be-inscribed-in-a-rectangle/](https://www.geeksforgeeks.org/number-of-largest-circles-that-can-be-inscribed-in-a-rectangle/)

给定两个整数 `L` 和 `B` 代表一个[矩形](https://www.geeksforgeeks.org/largest-rectangle-under-histogram/)的长度和宽度，任务是找到在给定矩形中可以不重叠地内接的最大可能圆的最大数量。
...
从上图可以清楚地看到，在给定的矩形内可以内切出直径为 3 厘米的最大圆。因此，此类圆的计数为 2。
