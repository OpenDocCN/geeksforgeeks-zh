...
> 原文: [https://www.geeksforgeeks.org/check-whether-the-exchange-is-possible-or-not/](https://www.geeksforgeeks.org/check-whether-the-exchange-is-possible-or-not/)
...
为了使兑换成为可能，`P` 必须能被所有面额的 [GCD](https://www.geeksforgeeks.org/basic-and-extended-euclidean-algorithms/) 整除。所以，求数组元素的 gcd，检查 `P` 是否能被它整除。
以下是实施办法:
