...
> 原文: [https://www.geeksforgeeks.org/find-the-word-from-a-given-sentence-having-given-word-as-prefix/](https://www.geeksforgeeks.org/find-the-word-from-a-given-sentence-having-given-word-as-prefix/)

给定一个代表一个句子的字符串 `S` 和另一个字符串 `word`，任务是从 `S` 中找到这个单词，这个单词有字符串 `word` 作为[前缀](https://www.geeksforgeeks.org/longest-common-prefix-using-divide-and-conquer-algorithm/)。如果字符串中没有这样的单词，打印 `-1`。

## 示例

> **输入:** `S = "Welcome to Geeksforgeeks"`, `word = "Gee"`
> **输出:** `Geeksforgeeks`
> **解释:**
> 句子中的“Geeksforgeeks”一词有前缀“Gee”。
>
> **输入:** `S = "Competitive programming"`, `word = "kdflk"`
> **输出:** `-1`
> **解释:**
> 字符串中没有单词以“kdflk”为前缀。
