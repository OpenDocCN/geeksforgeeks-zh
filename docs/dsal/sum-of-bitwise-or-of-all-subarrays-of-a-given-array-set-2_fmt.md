...
> 原文: [https://www.geeksforgeeks.org/sum-of-bitwise-or-of-all-subarrays-of-a-given-array-set-2/](https://www.geeksforgeeks.org/sum-of-bitwise-or-of-all-subarrays-of-a-given-array-set-2/)
...
**简单方法**: 简单的方法是[利用两个嵌套循环求给定数组](https://www.geeksforgeeks.org/sum-of-bitwise-or-of-all-subarrays/)每个子数组的按位 OR，然后求总和。该方法的时间复杂度为 `O(N^2)`。
