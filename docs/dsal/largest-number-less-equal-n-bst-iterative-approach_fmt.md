...
> 原文：[https://www.geeksforgeeks.org/largest-number-less-equal-n-bst-iterative-approach/](https://www.geeksforgeeks.org/largest-number-less-equal-n-bst-iterative-approach/)
...
我们在下面的文章中讨论了递归方法：[BST 中小于或等于 N 的最大数](https://www.geeksforgeeks.org/largest-number-bst-less-equal-n/)。
