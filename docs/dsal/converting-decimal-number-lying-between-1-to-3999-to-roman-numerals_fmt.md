...
> 原文: [https://www.geeksforgeeks.org/converting-decimal-number-lying-between-1-to-3999-to-roman-numerals/](https://www.geeksforgeeks.org/converting-decimal-number-lying-between-1-to-3999-to-roman-numerals/)
...
*   现在，数字= 9
*   数字 9 出现在列表 `ls` 中，因此我们直接从字典 `dict` 中获取值，并将余数设置为 0 并停止循环。
