...
> 原文: [https://www.geeksforgeeks.org/cartesian-tree-from-inorder-traversal-segment-tree/](https://www.geeksforgeeks.org/cartesian-tree-from-inorder-traversal-segment-tree/)
...
**方法:** 我们已经在这里看到了一个算法，平均花费 `O(NlogN)` 时间，但在最坏的情况下可以到达 `O(N^2)`。
