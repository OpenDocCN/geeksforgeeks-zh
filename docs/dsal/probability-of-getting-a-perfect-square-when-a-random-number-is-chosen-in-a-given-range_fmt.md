...
> 原文：[https://www.geeksforgeeks.org/probability-of-getting-a-perfect-square-when-a-random-number-is-chosen-in-a-given-range/](https://www.geeksforgeeks.org/probability-of-getting-a-perfect-square-when-a-random-number-is-chosen-in-a-given-range/)
...
这个问题的关键观察是从 0 到一个数范围内的完美平方的计数可以用给定的公式计算：
