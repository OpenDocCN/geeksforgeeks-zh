...
> 原文：[https://www.geeksforgeeks.org/place-replace-multiple-occurrences-pattern/](https://www.geeksforgeeks.org/place-replace-multiple-occurrences-pattern/)
...
这个实现的想法是使用 STL 内置函数在主字符串中搜索模式字符串，然后将其从主字符串中删除。
...
本文由阿迪蒂亚·戈尔供稿。如果你喜欢极客博客并想投稿，你也可以写一篇文章并把你的文章邮寄到 `review-team@geeksforgeeks.org`。看到你的文章出现在极客博客主页上，帮助其他极客。
