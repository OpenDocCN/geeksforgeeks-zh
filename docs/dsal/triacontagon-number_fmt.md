...
给定一个编号 `N`，任务是找到第 `N` 个[三十烷编号](https://en.wikipedia.org/wiki/Triacontagon)。
...
**参考资料:** [https://en.wikipedia.org/wiki/Triacontagon](https://en.wikipedia.org/wiki/Triacontagon)