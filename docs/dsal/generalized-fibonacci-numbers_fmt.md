...
> 原文: [https://www.geeksforgeeks.org/generalized-fibonacci-numbers/](https://www.geeksforgeeks.org/generalized-fibonacci-numbers/)
...
**另一种方法:** 想法是使用 [DP 制表](https://www.geeksforgeeks.org/tabulation-vs-memoization/)找到所有的术语直到第 `n` 个术语，然后打印第 `n` 个术语。
**时间复杂度:** `O(N)`
