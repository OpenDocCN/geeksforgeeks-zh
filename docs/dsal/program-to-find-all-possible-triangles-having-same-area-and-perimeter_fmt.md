...
> 原文: [https://www.geeksforgeeks.org/program-to-find-all-possible-triangles-having-same-area-and-perimeter/](https://www.geeksforgeeks.org/program-to-find-all-possible-triangles-having-same-area-and-perimeter/)
...
这个想法是基于[海伦公式](https://www.geeksforgeeks.org/area-of-a-triangle-coordinate-geometry-class-10-maths/)的观察。以下是观察结果:
...
>
> 由于此条件:
> `(-a + b + c)`, `(a - b + c)`, `(a + b - c)` 的最大值如下:
> `(-a + b + c) * (a - b + c) * (a + b - c) <= 16 * 16 * 16 * 16`
> => `16 * (a + b + c) <= 16 * 16 * 16`

由上式可知，三角形的边数之和不超过 `256`，其[三角形周长](https://www.geeksforgeeks.org/find-perimeter-triangle/)和[三角形面积](https://www.geeksforgeeks.org/area-of-triangle-using-side-angle-side-length-of-two-sides-and-the-included-angle/)可以相同。因此，想法是在范围 **[1, 256]** 上迭代三个嵌套循环，并打印具有相同面积和周长的边的三元组。
