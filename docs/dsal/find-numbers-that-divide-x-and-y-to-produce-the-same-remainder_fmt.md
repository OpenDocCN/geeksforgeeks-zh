...
> 原文: [https://www.geeksforgeeks.org/find-numbers-that-divide-x-and-y-to-produce-the-same-remainder/](https://www.geeksforgeeks.org/find-numbers-that-divide-x-and-y-to-produce-the-same-remainder/)
...
这个问题的朴素法是检查[1，max(`X`，`Y`)]范围内 `M` 的所有可能值的模值，如果条件满足则打印 `M` 的值。
以下是上述办法的实施情况:
