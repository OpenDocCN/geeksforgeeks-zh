...
> 原文: [https://www.geeksforgeeks.org/find-pairs-in-array-whose-sums-already-exist-in-array/](https://www.geeksforgeeks.org/find-pairs-in-array-whose-sums-already-exist-in-array/)
...
一个**高效的解决方案**是将所有元素存储在一个哈希表中(如 C++ 中的 `unordered_set`)，并逐一检查所有对，并检查其和是否存在于集合中。如果它存在于集合中，则打印对。如果在数组中没有找到配对，则打印不存在。
