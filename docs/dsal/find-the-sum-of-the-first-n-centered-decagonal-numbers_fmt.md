...
> 原文：[`https://www.geeksforgeeks.org/find-the-sum-of-the-first-n-centered-decagonal-numbers/`](https://www.geeksforgeeks.org/find-the-sum-of-the-first-n-centered-decagonal-numbers/)
...
1.  首先，我们需要创建一个函数来帮助我们计算第 `N` 个居中的十边形数。
2.  现在，运行一个从 `1` 到 `N` 的循环，找到第 `i` 个居中的十边形数。
3.  将以上计算的所有居中十边形数字相加。
