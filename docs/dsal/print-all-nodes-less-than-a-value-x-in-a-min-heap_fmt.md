...
> 原文: [https://www.geeksforgeeks.org/print-all-nodes-less-than-a-value-x-in-a-min-heap/](https://www.geeksforgeeks.org/print-all-nodes-less-than-a-value-x-in-a-min-heap/)
