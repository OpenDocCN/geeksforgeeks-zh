...
> 原文：[https://www.geeksforgeeks.org/print-all-possible-permutations-of-an-array-vector-without-duplicates-using-backtracking/](https://www.geeksforgeeks.org/print-all-possible-permutations-of-an-array-vector-without-duplicates-using-backtracking/)
...
***时间复杂度***：`O(N*N!)` 注意有 `N!` 个排列，打印排列需要 `O(N)` 的时间。
***辅助空间***：`O(r–l)`