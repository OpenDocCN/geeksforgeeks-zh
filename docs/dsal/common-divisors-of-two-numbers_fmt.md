...
> 原文：[https://www.geeksforgeeks.org/common-divisors-of-two-numbers/](https://www.geeksforgeeks.org/common-divisors-of-two-numbers/)
...
时间复杂度:`O(log(n)+ n^(1/2) )`，其中 `n` 为两个数的 gcd。
