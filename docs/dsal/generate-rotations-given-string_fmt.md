...
> 原文：[https://www.geeksforgeeks.org/generate-rotations-given-string/](https://www.geeksforgeeks.org/generate-rotations-given-string/)
...
这个想法是基于[高效的方法来检查字符串是否是彼此的旋转](https://www.geeksforgeeks.org/a-program-to-check-if-strings-are-rotations-of-each-other/)。我们把 `str` 和它自己连接起来，也就是说，我们在。是 `+` 串联运算符。现在，我们遍历从 `0` 到 `n–1` 的串联字符串，并打印大小为 `n` 的所有子字符串。
