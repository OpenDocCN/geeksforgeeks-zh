...
> 原文: `https://www.geeksforgeeks.org/tetrahedral-numbers/`

如果一个数可以表示为一个有三角形底和三条边的金字塔，称为四面体，那么这个数就称为四面体数。第 `n` 个四面体数是前 `n` 个[三角形数](https://www.geeksforgeeks.org/triangular-numbers/)的和。
前十个四面体编号为:
