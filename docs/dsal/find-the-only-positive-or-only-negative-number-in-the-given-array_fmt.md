...
> 原文: [https://www.geeksforgeeks.org/find-the-only-positive-or-only-negative-number-in-the-given-array/](https://www.geeksforgeeks.org/find-the-only-positive-or-only-negative-number-in-the-given-array/)
...
给定的问题只需要比较 `arr[]` 的前三个数字就可以解决。之后应用[线性搜索](https://www.geeksforgeeks.org/linear-search/)找到号码。按照以下步骤解决问题。
