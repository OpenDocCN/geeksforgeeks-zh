...
> 原文：[https://www.geeksforgeeks.org/print-first-n-numbers-with-exactly-two-set-bits/](https://www.geeksforgeeks.org/print-first-n-numbers-with-exactly-two-set-bits/)
...
一个简单解法就是从 1 开始逐个考虑所有正整数。对于每个数字，检查它是否正好有两组位。如果一个数字正好有两个设定位，打印出来并增加这些数字的计数。

## 高效解法

一个高效的解决方案就是直接生成这样的数字。如果我们清楚地观察这些数字，我们可以把它们改写为下面给定的幂(2，1)+幂(2，0)，幂(2，2)+幂(2，0)，幂(2，2)+幂(2，1)，幂(2，3)+幂(2，0)，幂(2，3)+幂(2，1)，幂(2，3)+幂(2，2)，……
