...
> 原文: [https://www.geeksforgeeks.org/number-of-levels-having-balanced-parentheses-in-a-binary-tree/](https://www.geeksforgeeks.org/number-of-levels-having-balanced-parentheses-in-a-binary-tree/)
...
*   初始化一个[队列](https://www.geeksforgeeks.org/queue-data-structure/)，在给定的[二叉树](https://www.geeksforgeeks.org/binary-tree-data-structure/)上执行[层序遍历](https://www.geeksforgeeks.org/level-order-tree-traversal/)。
