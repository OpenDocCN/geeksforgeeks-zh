...
> 原文：[https://www.geeksforgeeks.org/qualcomm-interview-experience-set-10-campus/](https://www.geeksforgeeks.org/qualcomm-interview-experience-set-10-campus/)
...
我的面试只有 30 分钟。第一轮后，43 名候选人被选中参加下一轮技术比赛。
...
6.  没有互斥就不能共享数据吗？给出你支持的任何场景的例子
7.  编译器阶段，并简要说明每个阶段
8.  制作文件和多文件程序的编译和执行。
9.  编译器如何进行中间代码优化以及一些例子。
10. 静态链接和动态链接，它们是如何实现的，以及两者的示例
11. 外部变量和函数

我这一轮持续了 35 分钟。第一轮后，32 名候选人被选入人力资源组。
