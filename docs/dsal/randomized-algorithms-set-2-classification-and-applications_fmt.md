...
蒙特卡罗算法以概率 `1 –( 1/2)^k` 找到 `1`。蒙特卡罗的时间复杂度是确定性的。
...
**来源:** [http://theory.stanford.edu/people/pragh/amstalk.pdf](http://theory.stanford.edu/people/pragh/amstalk.pdf) [https://en.wikipedia.org/wiki/Randomized_algorithm](https://en.wikipedia.org/wiki/Randomized_algorithm)
