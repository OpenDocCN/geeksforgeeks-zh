...
> 原文: [https://www.geeksforgeeks.org/check-if-any-permutation-of-string-is-a-k-times-repeated-string/](https://www.geeksforgeeks.org/check-if-any-permutation-of-string-is-a-k-times-repeated-string/)
...
思路是找出字符串中每个字符的[频率](https://www.geeksforgeeks.org/print-characters-frequencies-order-occurrence/)，并检查该字符的频率是否为给定整数 `K` 的倍数。如果字符串中所有字符的频率都可以被 `K` 整除，那么就有一个字符串是给定字符串的排列，也是一个 K 倍重复字符串。
