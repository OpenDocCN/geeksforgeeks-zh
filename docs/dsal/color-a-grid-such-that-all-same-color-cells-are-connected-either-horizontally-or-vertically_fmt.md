...
> 原文: [https://www.geeksforgeeks.org/color-a-grid-such-that-all-same-color-cells-are-connected-either-horizontally-or-vertically/](https://www.geeksforgeeks.org/color-a-grid-such-that-all-same-color-cells-are-connected-either-horizontally-or-vertically/)
...
> 2 5 4 5 3
> 2 5 5 5 3
> 这是因为颜色 3 和 4 的连接被位置(0，2)中 3 的无效位置断开了。我们不能再通过仅穿过相应的 3 和 4 来横向或纵向穿过所有 4 或所有 3。
