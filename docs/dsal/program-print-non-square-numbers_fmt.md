...
> 原文: [https://www.geeksforgeeks.org/program-print-non-square-numbers/](https://www.geeksforgeeks.org/program-print-non-square-numbers/)
...
我们可以通过使用下面的公式 `F(n)= n+floor(1/2+sqrt(n))` 来改进上面的算法，通过应用这个函数我们得到第 `n` 个非平方数。
