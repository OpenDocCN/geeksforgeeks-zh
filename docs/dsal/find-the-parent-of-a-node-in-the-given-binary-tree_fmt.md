...
> 原文: [https://www.geeksforgeeks.org/find-the-parent-of-a-node-in-the-given-binary-tree/](https://www.geeksforgeeks.org/find-the-parent-of-a-node-in-the-given-binary-tree/)
...
编写一个递归函数，以当前节点及其父节点为参数(根节点以`-1`作为其父节点传递)。如果当前节点等于所需节点，则打印其父节点并返回，否则为其子节点递归调用该函数，并将当前节点作为父节点。
