...
> 原文: [https://www.geeksforgeeks.org/wedderburn-etherington-number/](https://www.geeksforgeeks.org/wedderburn-etherington-number/)
...
**方法:**
[递推关系](https://en.wikipedia.org/wiki/Wedderburn%E2%80%93Etherington_number#Formula)求第 `n` 个数为:
