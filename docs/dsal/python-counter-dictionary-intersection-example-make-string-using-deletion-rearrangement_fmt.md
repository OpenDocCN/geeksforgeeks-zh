...
> 原文：[https://www.geeksforgeeks.org/python-counter-dictionary-intersection-example-make-string-using-deletion-rearrangement/](https://www.geeksforgeeks.org/python-counter-dictionary-intersection-example-make-string-using-deletion-rearrangement/)
...
1.  使用 [counter (迭代)](https://www.geeksforgeeks.org/counters-in-python-set-1/) 方法将两个字符串转换为字典，每个字典包含字符串中的字符作为键及其频率作为值。
2.  现在取两个字典的[集合](https://www.geeksforgeeks.org/sets-in-python/)交集，并将结果输出与第一个字符串的字典进行比较。如果两个字典相等，则意味着**可能**转换该字符串，否则是不可能的。
