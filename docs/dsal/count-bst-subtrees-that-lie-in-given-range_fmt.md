...
> 原文：[https://www.geeksforgeeks.org/count-bst-subtrees-that-lie-in-given-range/](https://www.geeksforgeeks.org/count-bst-subtrees-that-lie-in-given-range/)

## 问题描述
给定一个整数值的二叉查找树（BST）和一个范围`[low, high]`，返回该节点下的所有节点（或以该节点为根的子树）位于给定范围内的节点数。
