...
> 原文：[https://www.geeksforgeeks.org/3-way-quicksort-dutch-national-flag/](https://www.geeksforgeeks.org/3-way-quicksort-dutch-national-flag/)
...
3路快速排序的思想是处理枢轴的所有出现，并且基于[荷兰国旗算法。](https://www.geeksforgeeks.org/sort-an-array-of-0s-1s-and-2s/)
...
### 参考
- [http://algs4.cs.princeton.edu/lectures/23DemoPartitioning.pdf](http://algs4.cs.princeton.edu/lectures/23DemoPartitioning.pdf)
