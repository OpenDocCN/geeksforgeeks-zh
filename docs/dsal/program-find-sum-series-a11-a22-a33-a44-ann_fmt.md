# 程序求一系列 a^1/1! + a^2/2! + a^3/3! + a^4/4! + ... + a^n/n! 的和

> 原文: [https://www.geeksforgeeks.org/program-find-sum-series-a11-a22-a33-a44-ann/](https://www.geeksforgeeks.org/program-find-sum-series-a11-a22-a33-a44-ann/)

给定两个值 `a` 和 `n`，求 `a^1/1! + a^2/2! + a^3/3! + a^4/4! + ... + a^n/n!` 的和。
