...
> 原文：[https://www.geeksforgeeks.org/check-whether-second-string-can-formed-first-string-using-count-array/](https://www.geeksforgeeks.org/check-whether-second-string-can-formed-first-string-using-count-array/)

给定两个字符串 `str1` 和 `str2`，检查 `str2` 是否可以由 `str1` 构成。
