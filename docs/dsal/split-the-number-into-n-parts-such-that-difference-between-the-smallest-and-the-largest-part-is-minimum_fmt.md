...
> 原文：[`https://www.geeksforgeeks.org/split-the-number-into-n-parts-such-that-difference-between-the-smallest-and-the-largest-part-is-minimum/`](https://www.geeksforgeeks.org/split-the-number-into-n-parts-such-that-difference-between-the-smallest-and-the-largest-part-is-minimum/)
...
> **输入：** `X = 5`，`N = 3`
> **输出：** `1 2 2`
> 将`5`分成`3`份，使得中最大和最小的整数之差尽可能小。所以我们把`5`除以`1 + 2 + 2`。
>
> **输入：** `X = 25`，`N = 5`
> **输出：** `5 5 5 5 5`
