...
> 原文：[https://www.geeksforgeeks.org/php-program-to-find-the-smallest-missing-number/](https://www.geeksforgeeks.org/php-program-to-find-the-smallest-missing-number/)
...
### 方法 2（[线性搜索](https://www.geeksforgeeks.org/linear-search/)）
...
请参考完整文章[查找最小的缺失数字](https://www.geeksforgeeks.org/find-the-first-missing-number/)获取更多细节！