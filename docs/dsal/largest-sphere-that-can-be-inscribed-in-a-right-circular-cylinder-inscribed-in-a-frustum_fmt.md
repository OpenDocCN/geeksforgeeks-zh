...
> 原文：[https://www.geeksforgeeks.org/largest-sphere-that-can-be-inscribed-in-a-right-circular-cylinder-inscribed-in-a-frustum/](https://www.geeksforgeeks.org/largest-sphere-that-can-be-inscribed-in-a-right-circular-cylinder-inscribed-in-a-frustum/)

这里给定的是一个平截头体高度 `h`，顶半径 `r` 和底半径 `R`，它描绘了一个右圆柱体，而右圆柱体又描绘了一个球体。任务是找到这个球体的最大可能体积。
