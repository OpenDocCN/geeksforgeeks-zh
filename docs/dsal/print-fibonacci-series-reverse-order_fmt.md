...
> 原文: [https://www.geeksforgeeks.org/print-fibonacci-series-reverse-order/](https://www.geeksforgeeks.org/print-fibonacci-series-reverse-order/)
...
> **3)** 运行从 `2` 到 `n-1` 的循环，并将 `a[i-2]` 和 `a[i-1]` 的之和存储在 `a[i]` 中。
> **4)** 按相反顺序打印数组。
