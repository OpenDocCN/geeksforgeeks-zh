...
> 原文: [https://www.geeksforgeeks.org/print-all-root-to-leaf-paths-with-maximum-count-of-even-nodes/](https://www.geeksforgeeks.org/print-all-root-to-leaf-paths-with-maximum-count-of-even-nodes/)
...
> 路径上偶数节点的计数 2->6->4->12 = 4
> 路径上偶数节点的计数 2->6->7->1 = 2
> 路径上偶数节点的计数 2->3->11 = 1
...
使用[前序遍历](https://www.geeksforgeeks.org/tree-traversals-inorder-preorder-and-postorder/)可以解决问题。这个想法是[遍历给定的二叉树](https://www.geeksforgeeks.org/tree-traversals-inorder-preorder-and-postorder/)，并找到根到叶路径中可能的偶数节点的最大数量。最后，遍历树并打印所有可能的根到叶路径，这些路径具有偶数节点的最大数量。按照以下步骤解决问题:
...
*   [遍历树](https://www.geeksforgeeks.org/tree-traversals-inorder-preorder-and-postorder/)检查以下情况:
    *   检查当前节点是否为叶节点，以及 `cntEven` 是否大于 `cntMaxEven`。如果发现是真的，那么更新 `cntMaxEven = cntEven`。
