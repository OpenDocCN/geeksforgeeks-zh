...
> 原文: [https://www.geeksforgeeks.org/remove-leading-zeros-from-a-number-given-as-a-string/](https://www.geeksforgeeks.org/remove-leading-zeros-from-a-number-given-as-a-string/)

给定数字字符串`str`，任务是从给定字符串中移除所有的`前导零`。如果字符串只包含零，那么打印单个`"0"`。
...
关于使用 [`StringBuffer`](https://www.geeksforgeeks.org/stringbuffer-class-in-java/) 的特定于 Java 的方法，请参考[这篇文章](https://www.geeksforgeeks.org/remove-trailing-zeros-string-java/)。