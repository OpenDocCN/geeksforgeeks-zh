...
> 原文：[https://www.geeksforgeeks.org/python-program-for-swapping-nodes-in-a-linked-list-without-swapping-data/](https://www.geeksforgeeks.org/python-program-for-swapping-nodes-in-a-linked-list-without-swapping-data/)
...
```python
# Python program to swap two given nodes without swapping data
class Node:
...
class LinkedList:
    ...
    # Function to swap data of x and y nodes
...
Linked list after calling swapNodes() 1 2 3 4 5 6 7 
```
