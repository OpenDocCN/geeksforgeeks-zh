...
> 原文：[https://www.geeksforgeeks.org/find-the-sum-of-the-ascii-values-of-characters-which-are-present-at-prime-positions/](https://www.geeksforgeeks.org/find-the-sum-of-the-ascii-values-of-characters-which-are-present-at-prime-positions/)
...
> **输入：** `str = "abcdef"`
> **输出：** 298
> “b”、“c”和“e”是仅有的位于质数位置即分别为 2、3 和 5 的字符。
> 它们的 ASCII 值之和为 298。
