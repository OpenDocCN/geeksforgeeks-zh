...
表达式 `(x & 0b10101010) >> 1` 提取高位比特位置并将其移动到低位比特位置。
...
((x & 0b10101010) >> 1) = 00001010 >> 1
                        = 00000101
((x & 0b01010101) << 1) = 00010000 << 1
                        = 00100000
((x & 0b10101010) >> 1) | ((x & 0b01010101) << 1) = 00000101 | 00100000
                                                = 00100101
```
...
**参考:**
[https://stackoverflow.com/questions/4788799/swap-every-pair-of-bits-in-byte](https://stackoverflow.com/questions/4788799/swap-every-pair-of-bits-in-byte)