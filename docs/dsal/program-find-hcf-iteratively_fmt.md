...
我们已经在下面的帖子中讨论了递归解决方案：[求两个数 GCD 或 HCF 的递归程序](https://www.geeksforgeeks.org/c-program-find-gcd-hcf-two-numbers/)。下面是[欧几里德算法（基础与扩展）](https://www.geeksforgeeks.org/euclidean-algorithms-basic-and-extended/)的迭代实现。
