...
> 原文：[https://www.geeksforgeeks.org/shortest-distance-between-a-point-and-a-circle/](https://www.geeksforgeeks.org/shortest-distance-between-a-point-and-a-circle/)
...
*   点的坐标 = `(x2, y2)`
*   让中心和点之间的距离 = `d`
*   由于直线 AC 在 B 处与圆相交，因此最短距离为 BC，等于 `(d - r)`
*   这里使用距离公式，`d = √((x2 - x1)^2 + (y2 - y1)^2)`
*   所以最短距离 = `√((x2 - x1)^2 + (y2 - y1)^2) - r`
