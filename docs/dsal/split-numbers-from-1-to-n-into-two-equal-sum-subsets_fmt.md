...
> 原文：[https://www.geeksforgeeks.org/split-numbers-from-1-to-n-into-two-equal-sum-subsets/](https://www.geeksforgeeks.org/split-numbers-from-1-to-n-into-two-equal-sum-subsets/)
...
2.  **前 N 个自然数之和为偶数**：只需从最后一个元素循环到第一个元素，取集合 1 中值小于和的一半的元素，维护另一个集合 2，存储集合 1 中未包含的元素。
