...
> 原文: [https://www.geeksforgeeks.org/rearrange-array-to-make-product-of-prefix-sum-array-non-zero/](https://www.geeksforgeeks.org/rearrange-array-to-make-product-of-prefix-sum-array-non-zero/)
...
*   [计算给定数组的元素之和](https://www.geeksforgeeks.org/program-find-sum-elements-given-array/)，比如 `totalSum`。
*   如果 `totalSum = 0`，则打印 `-1`。
