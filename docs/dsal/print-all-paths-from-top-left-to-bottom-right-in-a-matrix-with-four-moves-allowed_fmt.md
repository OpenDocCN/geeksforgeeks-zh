...
> 原文：[https://www.geeksforgeeks.org/print-all-paths-from-top-left-to-bottom-right-in-a-matrix-with-four-moves-allowed/](https://www.geeksforgeeks.org/print-all-paths-from-top-left-to-bottom-right-in-a-matrix-with-four-moves-allowed/)
...
这个问题主要是[在允许两次移动的矩阵中从左上方到右下方计数所有路径](https://www.geeksforgeeks.org/count-possible-paths-top-left-bottom-right-nxm-matrix/)的扩展。
