...
> 原文: [https://www.geeksforgeeks.org/check-if-there-is-any-common-character-in-two-given-strings/](https://www.geeksforgeeks.org/check-if-there-is-any-common-character-in-two-given-strings/)
...
遍历第一个字符串，将字符串的字符与其频率进行映射，在该映射中，字符充当键，频率作为其值。然后遍历第二个字符串，我们将检查两个字符串中是否有任何字符，然后确认有一个公共的子序列。
