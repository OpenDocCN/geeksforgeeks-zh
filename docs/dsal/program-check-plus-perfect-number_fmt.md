...
> 原文：[https://www.geeksforgeeks.org/program-check-plus-perfect-number/](https://www.geeksforgeeks.org/program-check-plus-perfect-number/)

## 定义

给定一个`n`位数字`x`，检查它是否是一个正完全数。如果一个数等于其数字的`n`次方的和，则该数为正完全数。
