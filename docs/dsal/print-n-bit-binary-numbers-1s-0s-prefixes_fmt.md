...
> 原文: [https://www.geeksforgeeks.org/print-n-bit-binary-numbers-1s-0s-prefixes/](https://www.geeksforgeeks.org/print-n-bit-binary-numbers-1s-0s-prefixes/)
...
一个有效的解决方案是只生成那些满足给定条件的 `N` 位数字。我们使用递归。在递归中的每一点，我们将 0 和 1 附加到部分形成的数字上，并用少一个数字重复。
