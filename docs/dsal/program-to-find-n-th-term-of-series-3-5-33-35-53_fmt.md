...
> 原文: [https://www.geeksforgeeks.org/program-to-find-n-th-term-of-series-3-5-33-35-53/](https://www.geeksforgeeks.org/program-to-find-n-th-term-of-series-3-5-33-35-53/)
...
这个想法是基于这样一个事实，即序列中最后一个数字的值是交替的。例如，如果第 `i` 个数字的最后一位是 3，那么第 `(i-1)` 个和第 `(i+1)` 个数字的最后一位必须是 5。
