...
这个想法是基于这样一个事实:如果一个[数是一个质数](https://www.geeksforgeeks.org/c-program-to-check-whether-a-number-is-prime-or-not/)，那么这个数的平方正好包含三个不同的[因子](https://www.geeksforgeeks.org/perfect-square-factors-of-a-number/)。按照以下步骤解决问题:
