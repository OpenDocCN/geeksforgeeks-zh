...
> 原文：[https://www.geeksforgeeks.org/rearrange-array-such-that-all-even-indexed-elements-in-the-array-is-even/](https://www.geeksforgeeks.org/rearrange-array-such-that-all-even-indexed-elements-in-the-array-is-even/)
...
*   对于包含奇数元素的第 `i` 个索引，使用 `j` 迭代奇数索引，直到遇到偶数元素。
*   互换 `a[i]` 和 `a[j]`。
