...
> 原文：[https://www.geeksforgeeks.org/minimum-time-required-to-print-given-string-from-a-circular-container-based-on-given-conditions/](https://www.geeksforgeeks.org/minimum-time-required-to-print-given-string-from-a-circular-container-based-on-given-conditions/)
...
function minTime(word)
{
    ...
    for (let i = 0; i < word.length; i++) {
        // Find index of that element
        let k = word[i].charCodeAt(0) - 'a'.charCodeAt(0);
        // Calculate absolute difference
        // between pointer index and character
        // index as clockwise distance
        ...
        // the character
        ans++;
        curr = word[i].charCodeAt(0) - 'a'.charCodeAt(0);
    }
    // Print the final answer
    document.write(ans);
}
