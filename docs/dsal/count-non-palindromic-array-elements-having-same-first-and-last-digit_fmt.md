...
> 原文：[https://www.geeksforgeeks.org/count-non-palindromic-array-elements-having-same-first-and-last-digit/](https://www.geeksforgeeks.org/count-non-palindromic-array-elements-having-same-first-and-last-digit/)
...
通过检查每个数组元素，不管是不是[回文](https://www.geeksforgeeks.org/program-to-check-the-number-is-palindrome-or-not/)都可以解决这个问题。按照步骤解决问题。

1.  [遍历数组](https://www.geeksforgeeks.org/c-program-to-traverse-an-array/) `arr`。
