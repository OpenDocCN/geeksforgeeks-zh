...
> 原文: [https://www.geeksforgeeks.org/probability-of-rain-on-n1th-day/](https://www.geeksforgeeks.org/probability-of-rain-on-n1th-day/)

给定 1 和 0 的数组，其中 `A[i] = 1` 表示第 `i` 天是雨天，`A[i] = 0` 表示不是雨天。任务是找到第 `N+1` 次是雨天的概率。

**举例:**

> **输入:** `a[] = {0，0，1，0}`
> **输出:** .25
> 由于 4 天中有一天下雨，因此第 5 天的概率为 0.25
> **输入:** `a[] = {1，0，1，0，1，1，1}`
> **输出:** 0.71

第 `N+1` 天下雨的概率可以用下面的公式计算出来:
