...
> 原文: [https://www.geeksforgeeks.org/convert-ternary-expression-binary-tree/](https://www.geeksforgeeks.org/convert-ternary-expression-binary-tree/)
...
1.  如果我们看到符号`?`，然后我们添加下一个字符作为 `root` 的左子字符。
2.  如果我们看到符号`:`，然后我们将其添加为当前根的右子。
