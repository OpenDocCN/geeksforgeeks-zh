...
> 原文: [https://www.geeksforgeeks.org/check-large-number-divisible-4-not/](https://www.geeksforgeeks.org/check-large-number-divisible-4-not/)
...
本文由 [**Danish RAZA**](https://www.facebook.com/danish.raza.98096721) 供稿。如果你喜欢 GeeksforGeeks 并想投稿，你也可以使用 [contribute.geeksforgeeks.org](http://www.contribute.geeksforgeeks.org) 写一篇文章或者把你的文章邮寄到 `contribute@geeksforgeeks.org`。看到你的文章出现在极客博客主页上，帮助其他极客。
