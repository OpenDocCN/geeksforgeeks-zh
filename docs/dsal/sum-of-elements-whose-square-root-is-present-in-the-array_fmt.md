...
> 原文: [https://www.geeksforgeeks.org/sum-of-elements-whose-square-root-is-present-in-the-array/](https://www.geeksforgeeks.org/sum-of-elements-whose-square-root-is-present-in-the-array/)
...
我们可以创建一个包含数组中所有元素的[哈希集](https://www.geeksforgeeks.org/hashset-in-java/)，然后在 `O(n)` 时间内检查数组中每个元素的平方根。
