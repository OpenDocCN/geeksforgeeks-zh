...
> 原文：[https://www.geeksforgeeks.org/find-the-shortest-binary-string-containing-one-or-more-occurrences-of-given-strings/](https://www.geeksforgeeks.org/find-the-shortest-binary-string-containing-one-or-more-occurrences-of-given-strings/)
...
*   将变量 `gcd` 初始化为 `x` 和 `y` 的[GCD](https://www.geeksforgeeks.org/stdgcd-c-inbuilt-function-finding-gcd/)。
*   调用[函数](https://www.geeksforgeeks.org/functions-in-c/) `repeat(y / gcd, s1)` 多次形成[字符串](https://www.geeksforgeeks.org/category/data-structures/c-strings/) `S1` 并将其存储到变量 `A` 中。
*   调用[函数](https://www.geeksforgeeks.org/functions-in-c/) `repeat(x / gcd, s2)` 多次形成[字符串](https://www.geeksforgeeks.org/category/data-structures/c-strings/) `S2` 并将其存储到变量 `B` 中。
