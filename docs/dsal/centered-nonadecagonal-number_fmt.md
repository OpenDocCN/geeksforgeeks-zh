...
> 原文：[https://www.geeksforgeeks.org/centered-nonadecagonal-number/](https://www.geeksforgeeks.org/centered-nonadecagonal-number/)

给定一个`n`，求第`n`个居中的非十边形数。
一个居中的非十边形数代表在连续的非十边形（19边多边形）图层中的中心点和围绕它的其他点。
...
参考文献：[http://oeis.org/A069132](http://oeis.org/A069132)