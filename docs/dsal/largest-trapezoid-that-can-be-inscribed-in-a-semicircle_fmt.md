...
> 原文：[https://www.geeksforgeeks.org/largest-trapezoid-that-can-be-inscribed-in-a-semicircle/](https://www.geeksforgeeks.org/largest-trapezoid-that-can-be-inscribed-in-a-semicircle/)
...
**逼近：** 设 `r` 为半圆半径，`x` 为梯形下缘，`y` 为上缘，`h` 为梯形高度。
现在从图中，
