...
> 原文: [https://www.geeksforgeeks.org/number-of-factors-of-very-large-number-n-modulo-m-where-m-is-any-prime-number/](https://www.geeksforgeeks.org/number-of-factors-of-very-large-number-n-modulo-m-where-m-is-any-prime-number/)
...
这里筛的实现不能用于寻找大数的质因数分解，因为它需要比例空间。
