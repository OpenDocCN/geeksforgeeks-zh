...
> 原文: [https://www.geeksforgeeks.org/calculate-the-cgpa-and-cgpa-of-marks-obtained-by-a-student-in-n-subjects/](https://www.geeksforgeeks.org/calculate-the-cgpa-and-cgpa-of-marks-obtained-by-a-student-in-n-subjects/)

给定一个大小为 `N` 的数组 `arr[]`，该数组包含学生在 `N` 个科目中的分数，任务是计算学生的 CGPA 和 CGPA 百分比。
