# JavaScript 程序在 O(n) 时间和 O(1) 额外空间内重新排列正数和负数

> 原文：[https://www.geeksforgeeks.org/javascript-program-to-rearrange-positive-and-negative-numbers-in-on-time-and-o1-extra-space/](https://www.geeksforgeeks.org/javascript-program-to-rearrange-positive-and-negative-numbers-in-on-time-and-o1-extra-space/)
...
**注：** 划分过程改变元素的相对顺序。也就是说，用这种方法不能保持元素出现的顺序。[维护本问题中元素的出现顺序见本文](https://www.geeksforgeeks.org/rearrange-array-alternating-positive-negative-items-o1-extra-space/)。
...
更多详情请参考[整篇文章：在 O(n) 时间和 O(1) 额外空间内重新排列正负数](https://www.geeksforgeeks.org/rearrange-positive-and-negative-numbers-publish/)！