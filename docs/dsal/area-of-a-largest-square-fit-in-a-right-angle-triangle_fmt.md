...
> 原文：[https://www.geeksforgeeks.org/area-of-a-largest-square-fit-in-a-right-angle-triangle/](https://www.geeksforgeeks.org/area-of-a-largest-square-fit-in-a-right-angle-triangle/)

给定一个直角三角形，高度 `l`，底边 `b`，斜边 `h`。我们需要找到直角三角形中能容纳的最大正方形的面积。
