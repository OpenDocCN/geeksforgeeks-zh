...
> 原文: [https://www.geeksforgeeks.org/query-ancestor-descendant-relationship-tree/](https://www.geeksforgeeks.org/query-ancestor-descendant-relationship-tree/)
...
因此预处理的时间复杂度为 `O(N)`，查询的时间复杂度为 `O(1)`。
