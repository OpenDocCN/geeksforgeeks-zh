# 查找给定字符串中“1(0+)1”的所有模式（正则表达式方法）

> 原文：[https://www.geeksforgeeks.org/find-patterns-101-given-string-set-2-regular-expression-approach/](https://www.geeksforgeeks.org/find-patterns-101-given-string-set-2-regular-expression-approach/)
