...
> 原文: [https://www.geeksforgeeks.org/bidgely-interview-experience-set-3/](https://www.geeksforgeeks.org/bidgely-interview-experience-set-3/)
...
4.  Why is there multiple inheritance of `class` but not `interface` in Java?
5.  How does Java manage deadlock?
6.  What is the set of `reflection` and `Class` in Java?
...
9.  What is your career ambition?
10. Where will you look at yourself three years later?
11. What are your expectations of the company?
