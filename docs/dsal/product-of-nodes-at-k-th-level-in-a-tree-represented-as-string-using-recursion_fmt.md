...
> 原文: [https://www.geeksforgeeks.org/product-of-nodes-at-k-th-level-in-a-tree-represented-as-string-using-recursion/](https://www.geeksforgeeks.org/product-of-nodes-at-k-th-level-in-a-tree-represented-as-string-using-recursion/)

**先决条件:** [给定一个整数 `K` 和一个字符串格式的二叉树](https://www.geeksforgeeks.org/product-nodes-k-th-level-tree-represented-string/)，求树中第 `K` 级节点的乘积。树的每个节点的值都在 0 到 9 之间。我们需要从根开始寻找 `K` 级元素的乘积。根在 0 级。
...
> `k = 2` 级的元素是 `6`、`4`、`1`、`3`
> 这些元素的乘积 = `6 * 4 * 1 * 3 = 72`
> **输入:** `Tree = "(8(3(2()())(2()())))(6(5(5()())(1()())))(5(10(10()())(6()()))(7(13()())(2()())))))"`
> `k = 3`
> **输出:** `15`
> `k = 3` 级的元素是 `5`、`1` 和 `3`，这些元素的乘积是 `15`
