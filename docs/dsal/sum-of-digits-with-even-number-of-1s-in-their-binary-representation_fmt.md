...
> 原文: [https://www.geeksforgeeks.org/sum-of-digits-with-even-number-of-1s-in-their-binary-representation/](https://www.geeksforgeeks.org/sum-of-digits-with-even-number-of-1s-in-their-binary-representation/)

给定一个大小为 `N` 的数组 `arr[]`。任务是找到包含偶数个 `1` 的所有数组元素的数字总和。
