...
> 原文: [https://www.geeksforgeeks.org/smallest-power-of-2-which-is-greater-than-or-equal-to-sum-of-array-elements/](https://www.geeksforgeeks.org/smallest-power-of-2-which-is-greater-than-or-equal-to-sum-of-array-elements/)
...
问题是数组元素的[求和](https://www.geeksforgeeks.org/program-find-sum-elements-given-array/)与[大于等于 `N` 的 2 的最小幂](https://www.geeksforgeeks.org/smallest-power-of-2-greater-than-or-equal-to-n/)的组合。求数组元素的和，然后求大于等于 `n` 的 2 的最小幂。
