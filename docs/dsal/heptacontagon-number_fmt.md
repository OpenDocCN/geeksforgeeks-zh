...
给定一个数字 `N`，任务是找到 `N`<sup>th</sup> [七角数字](https://en.wikipedia.org/wiki/Heptacontagon)。
...
*   因此 70 边多边形的第 `n` 项是
> ![T_n =\frac{((70-2)n^2 - (70-4)n)}{2} =\frac{(68n^2 - 66n)}{2}](img/f790f840525ebd3b62ab702989b37194.png "Rendered by QuickLaTeX.com")
...
**参考资料:** [https://en.wikipedia.org/wiki/Heptacontagon](https://en.wikipedia.org/wiki/Heptacontagon)