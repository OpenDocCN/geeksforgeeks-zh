...
> 原文: [https://www.geeksforgeeks.org/find-the-original-coordinates-whose-manhattan-distances-are-given/](https://www.geeksforgeeks.org/find-the-original-coordinates-whose-manhattan-distances-are-given/)
...
我们来分析一下什么时候没有解。首先，三角形不等式必须成立，即最大距离不应超过其他两个的总和。第二，所有曼哈顿距离的总和应该是偶数。
