...
> 原文：[https://www.geeksforgeeks.org/xor-of-prime-frequencies-of-characters-in-a-string/](https://www.geeksforgeeks.org/xor-of-prime-frequencies-of-characters-in-a-string/)
...
*   使用[`map` STL](https://www.geeksforgeeks.org/map-associative-containers-the-c-standard-template-library-stl/) 遍历字符串并存储所有字符的频率。
