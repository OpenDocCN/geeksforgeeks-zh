...
> 原文：[https://www.geeksforgeeks.org/find-the-minimum-number-of-steps-to-reach-m-from-n/](https://www.geeksforgeeks.org/find-the-minimum-number-of-steps-to-reach-m-from-n/)
...
思路是把问题反过来如下：我们应该用运算得到从 `M` 开始的数 `N`
