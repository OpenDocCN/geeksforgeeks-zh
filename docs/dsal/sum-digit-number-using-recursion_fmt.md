...
> 原文: [https://www.geeksforgeeks.org/sum-digit-number-using-recursion/](https://www.geeksforgeeks.org/sum-digit-number-using-recursion/)
...
更好地理解算法工作原理的逐步过程。
设数字为 `12345`。
步骤 1 -> `12345 % 10` 等于 `5` + (发送 `12345/10` 到下一步)
步骤 2 -> `1234 % 10` 等于 `4` + (发送 `1234/10` 到下一步)
步骤 3 -> `123 % 10` 等于 `3` + (发送 `123/10` 到下一步)
步骤 4 -> `12 % 10`
第 5 步 -> `1 % 10` 等于 `1` + (发送 `1/10` 到下一步)
第 6 步 -> `0` 算法停止
下图将说明递归的过程
