...
> 原文：[https://www.geeksforgeeks.org/compute-the-minimum-or-maximum-max-of-two-integers-without-branching/](https://www.geeksforgeeks.org/compute-the-minimum-or-maximum-max-of-two-integers-without-branching/)
...
如果 `x>y`，那么 `-(x < y)` 将是 `0`，所以 `r = y ^((x ^ y)&0)= y ^ 0 = y`。
