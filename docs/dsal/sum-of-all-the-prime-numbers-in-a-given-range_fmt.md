...
> 原文: [https://www.geeksforgeeks.org/sum-of-all-the-prime-numbers-in-a-given-range/](https://www.geeksforgeeks.org/sum-of-all-the-prime-numbers-in-a-given-range/)
...
迭代从 `l` 到 `r` 的循环，将所有质数相加。以下是上述办法的实施:
