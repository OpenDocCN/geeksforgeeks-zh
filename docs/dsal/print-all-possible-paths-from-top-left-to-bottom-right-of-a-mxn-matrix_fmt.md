...
> 原文: [https://www.geeksforgeeks.org/print-all-possible-paths-from-top-left-to-bottom-right-of-a-mxn-matrix/](https://www.geeksforgeeks.org/print-all-possible-paths-from-top-left-to-bottom-right-of-a-mxn-matrix/)

问题是打印 mXn 矩阵从左上方到右下方的所有可能路径，限制条件是从每个单元格只能向右或向下移动。
...
4.  我们将继续探索右下单元(如果可能的话)，直到队列不是空的，并通过更新当前单元向量将它们推入队列。
