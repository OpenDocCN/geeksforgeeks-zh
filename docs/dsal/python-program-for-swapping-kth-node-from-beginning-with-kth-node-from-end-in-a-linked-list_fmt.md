...
> 原文: [https://www.geeksforgeeks.org/python-program-for-swapping-kth-node-from-beginning-with-kth-node-from-end-in-a-linked-list/](https://www.geeksforgeeks.org/python-program-for-swapping-kth-node-from-beginning-with-kth-node-from-end-in-a-linked-list/)
...
思路很简单，从开始找第 `k` 个节点，最后第 `k` 个节点从开始就是第 `n-k+1` 个节点。交换两个节点。
*不过也有一些角落案例，必须要处理*
...
更多详情请参考完整文章 [在链表中从开始到结束交换第 k 个节点！](https://www.geeksforgeeks.org/swap-kth-node-from-beginning-with-kth-node-from-end-in-a-linked-list/)