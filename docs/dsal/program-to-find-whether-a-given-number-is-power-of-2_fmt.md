...
> 原文：[https://www.geeksforgeeks.org/program-to-find-whether-a-given-number-is-power-of-2/](https://www.geeksforgeeks.org/program-to-find-whether-a-given-number-is-power-of-2/)
...
一个简单的方法是简单地取基数为 2 的数的对数，如果你得到一个整数，那么这个数就是 2 的幂。
...
另一种解决方法是继续将数除以 2，即迭代做 `n = n/2`。在任何迭代中，如果 `n%2` 变成非零，并且 `n` 不是 1，那么 `n` 不是 2 的幂。如果 `n` 变成 1，那么它就是 2 的幂。
