...
> 原文: [https://www.geeksforgeeks.org/print-nth-stepping-or-autobiographical-number/](https://www.geeksforgeeks.org/print-nth-stepping-or-autobiographical-number/)
...
这个问题可以使用[**队列**](https://www.geeksforgeeks.org/queue-data-structure/)数据结构来解决。首先，准备一个空队列，**按照**的顺序将 `1`，`2`，…，`9` 入队。
