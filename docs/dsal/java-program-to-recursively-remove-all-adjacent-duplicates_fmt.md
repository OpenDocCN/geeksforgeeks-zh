...
> 原文: [https://www.geeksforgeeks.org/java-program-to-recursively-remove-all-adjacent-duplicates/](https://www.geeksforgeeks.org/java-program-to-recursively-remove-all-adjacent-duplicates/)
