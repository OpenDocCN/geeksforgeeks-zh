...
> 原文：[https://www.geeksforgeeks.org/program-to-check-if-the-string-is-empty-in-java/](https://www.geeksforgeeks.org/program-to-check-if-the-string-is-empty-in-java/)
...
*   获取要在字符串中检查的字符串。
*   我们可以简单地使用 `String` 类的 `isEmpty()` 方法检查字符串是否为空。
