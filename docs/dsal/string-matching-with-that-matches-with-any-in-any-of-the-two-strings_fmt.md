...
> 原文：[https://www.geeksforgeeks.org/string-matching-with-that-matches-with-any-in-any-of-the-two-strings/](https://www.geeksforgeeks.org/string-matching-with-that-matches-with-any-in-any-of-the-two-strings/)
...
```javascript
<script>
// javascript program for string matching with *
public class GfG {
