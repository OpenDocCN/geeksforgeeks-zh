...
> 原文: [https://www.geeksforgeeks.org/numbers-difference-digit-sum-s/](https://www.geeksforgeeks.org/numbers-difference-digit-sum-s/)
...
*   对于最大可能的整数(比如 `long long int`，即 `10^18`)，最大可能的数字总和是 `9*18`(当所有数字都是 9 时)= `162`。这意味着在任何情况下，所有大于 `s + 162` 的整数都满足 `整数–digitSum > s` 的条件。
