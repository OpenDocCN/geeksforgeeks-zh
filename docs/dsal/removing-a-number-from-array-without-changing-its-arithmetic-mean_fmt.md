...
> 原文：[https://www.geeksforgeeks.org/removing-a-number-from-array-without-changing-its-arithmetic-mean/](https://www.geeksforgeeks.org/removing-a-number-from-array-without-changing-its-arithmetic-mean/)
...
> **输入:** `a[] = {1, 2, 3, 4, 5}`
> **输出:** `3`
> 给定数组的平均值为 `3`。移动第三个元素后，数组变成 `{1, 2, 4, 5}`，其平均值也是 `3`。
> **输入:** `a[] = {5, 4, 3, 6}`
> **输出:** `-1`
