...
> 原文: [https://www.geeksforgeeks.org/sort-and-separate-odd-and-even-numbers-in-an-array-using-custom-comparator/](https://www.geeksforgeeks.org/sort-and-separate-odd-and-even-numbers-in-an-array-using-custom-comparator/)
...
**方法:** 正如我们所知 `std::sort()` 用于按升序排序，但是我们可以使用[自定义比较器](https://www.geeksforgeeks.org/comparator-class-in-c-with-examples/)来操纵 `sort()`。
