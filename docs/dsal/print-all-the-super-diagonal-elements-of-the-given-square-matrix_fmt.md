...
> 原文: [https://www.geeksforgeeks.org/print-all-the-super-diagonal-elements-of-the-given-square-matrix/](https://www.geeksforgeeks.org/print-all-the-super-diagonal-elements-of-the-given-square-matrix/)
...
遍历矩阵的所有元素，只打印 `j = i + 1` 的元素，这需要 `O(n^2)` 的时间复杂度，或者只遍历从 1 到列 count–1 的列，并将元素打印为 `arr[column–1][column]`。
