...
> 原文: [https://www.geeksforgeeks.org/check-if-all-levels-of-two-trees-are-anagrams-or-not/](https://www.geeksforgeeks.org/check-if-all-levels-of-two-trees-are-anagrams-or-not/)
...
在上面的程序中，我们直接使用`!=`操作符来比较存储树的每一级的向量！首先根据向量的大小进行比较，然后根据其内容进行比较，从而节省了我们迭代比较向量的工作。
