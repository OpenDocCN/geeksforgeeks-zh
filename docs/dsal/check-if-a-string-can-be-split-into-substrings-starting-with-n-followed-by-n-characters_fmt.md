...
> 原文: [https://www.geeksforgeeks.org/check-if-a-string-can-be-split-into-substrings-starting-with-n-followed-by-n-characters/](https://www.geeksforgeeks.org/check-if-a-string-can-be-split-into-substrings-starting-with-n-followed-by-n-characters/)
