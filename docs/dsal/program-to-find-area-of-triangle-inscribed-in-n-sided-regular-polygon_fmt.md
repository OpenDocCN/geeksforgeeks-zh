...
> 原文：[https://www.geeksforgeeks.org/program-to-find-area-of-triangle-inscribed-in-n-sided-regular-polygon/](https://www.geeksforgeeks.org/program-to-find-area-of-triangle-inscribed-in-n-sided-regular-polygon/)
...
*   求正多边形的面积。[正多边形](https://www.geeksforgeeks.org/area-of-a-n-sided-regular-polygon-with-given-side-length/)的面积可以借助公式 `(A*P)/2` 来计算，其中 `P` 是该多边形的周长，`A` 是该多边形的[周长](https://www.geeksforgeeks.org/apothem-of-a-n-sided-regular-polygon/)。
