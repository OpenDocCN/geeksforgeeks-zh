...
> 原文: [https://www.geeksforgeeks.org/sum-of-elements-in-an-array-with-frequencies-greater-than-or-equal-to-that-element/](https://www.geeksforgeeks.org/sum-of-elements-in-an-array-with-frequencies-greater-than-or-equal-to-that-element/)
...
*   遍历数组，将所有元素的频率存储在 C++ 中的 `unordered_map` 中或任何其他编程语言中的等效数据结构中。
*   计算频率大于或等于该元素的元素的总和。
