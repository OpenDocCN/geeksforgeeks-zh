...
> 原文：[https://www.geeksforgeeks.org/java-program-for-deleting-a-node-in-a-linked-list/](https://www.geeksforgeeks.org/java-program-for-deleting-a-node-in-a-linked-list/)

我们在之前关于单链表的文章中讨论过[链表介绍](https://www.geeksforgeeks.org/linked-list-set-1-introduction/)和[链表插入](https://www.geeksforgeeks.org/linked-list-set-2-inserting-a-node/)。让我们制定问题陈述，了解删除过程。给定一个‘键’，删除链表中该键的第一次出现。
