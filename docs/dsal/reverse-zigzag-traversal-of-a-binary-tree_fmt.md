...
> 原文：[https://www.geeksforgeeks.org/reverse-zigzag-traversal-of-a-binary-tree/](https://www.geeksforgeeks.org/reverse-zigzag-traversal-of-a-binary-tree/)
...
想法是以[反向水平顺序](https://www.geeksforgeeks.org/reverse-level-order-traversal/)的方式遍历树，但稍加修改。我们将使用一个变量`flag`，并将其值设置为 1。当我们完成树的反向级别顺序遍历时，从右到左，我们将把`flag`的值设置为零，这样下次我们从左到右遍历树时，当我们完成遍历时，我们把它的值设置回 1。我们将重复这整个步骤，直到我们完全遍历了二叉树。
