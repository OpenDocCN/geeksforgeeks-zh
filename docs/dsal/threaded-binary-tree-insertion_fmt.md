...
> 原文：[https://www.geeksforgeeks.org/threaded-binary-tree-insert/](https://www.geeksforgeeks.org/threaded-binary-tree-insertion/)
...
在适当的位置插入节点后，我们必须使其左线程和右线程分别指向前序和后继。这个节点是[为了接班人](https://www.geeksforgeeks.org/inorder-successor-in-binary-search-tree/)。所以新节点的左右线程将会：
