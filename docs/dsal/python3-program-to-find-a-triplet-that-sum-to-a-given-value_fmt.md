...
> 原文: [https://www.geeksforgeeks.org/python3-program-to-find-a-triplet-that-sum-to-a-given-value/](https://www.geeksforgeeks.org/python3-program-to-find-a-triplet-that-sum-to-a-given-value/)
...
更多细节请参考[整篇文章找到一个和给定值的三元组！](https://www.geeksforgeeks.org/find-a-triplet-that-sum-to-a-given-value/)