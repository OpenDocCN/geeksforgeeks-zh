...
> 原文: [https://www.geeksforgeeks.org/find-the-permutation-of-first-n-natural-numbers-such-that-sum-of-i-pi-is-maximum-possible/](https://www.geeksforgeeks.org/find-the-permutation-of-first-n-natural-numbers-such-that-sum-of-i-pi-is-maximum-possible/)

给定一个数字 `N`。任务是找到第一个 `N` 自然数的排列 `P`，使得 `i % Pi` 的和最大可能。任务是找到最大可能的和，而不是它的排列。
