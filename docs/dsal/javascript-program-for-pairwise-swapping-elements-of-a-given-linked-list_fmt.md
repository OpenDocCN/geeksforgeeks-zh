...
> 原文：[https://www.geeksforgeeks.org/javascript-program-for-pairwise-swapping-elements-of-a-given-linked-list/](https://www.geeksforgeeks.org/javascript-program-for-pairwise-swapping-elements-of-a-given-linked-list/)
...
例如，如果链表是 `1->2->3->4->5`，那么函数应该将其改为 `2->1->4->3->5`，如果链表是 `1->2->3->4->5->6`，那么函数应该将其改为 `2->1->4->3->6->5`。
