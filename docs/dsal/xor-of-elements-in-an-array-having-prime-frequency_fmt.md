...
> 原文: [https://www.geeksforgeeks.org/xor-of-elements-in-an-array-having-prime-frequency/](https://www.geeksforgeeks.org/xor-of-elements-in-an-array-having-prime-frequency/)
...
*   构建厄拉多塞的[筛](https://www.geeksforgeeks.org/sieve-of-eratosthenes/)，用于测试一个数在 `O(1)` 时间内的素性。
