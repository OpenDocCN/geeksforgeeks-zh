...
> 原文: [https://www.geeksforgeeks.org/pair-with-min-absolute-difference-and-whose-product-is-n1-or-n2/](https://www.geeksforgeeks.org/pair-with-min-absolute-difference-and-whose-product-is-n1-or-n2/)
...
思想是用一个循环变量 `i` 从 `sqrt(N+2)` 到 `1` 迭代一个循环，并检查以下条件:
