...
> 原文：[https://www.geeksforgeeks.org/check-if-an-octal-number-is-even-or-odd/](https://www.geeksforgeeks.org/check-if-an-octal-number-is-even-or-odd/)
...
由于八进制数包含 0 到 7 的数字，因此我们可以简单地检查最后一个数字是`'0'`、`'2'`、`'4'`还是`'6'`。如果是，那么给定的八进制数将是偶数，否则是奇数。
