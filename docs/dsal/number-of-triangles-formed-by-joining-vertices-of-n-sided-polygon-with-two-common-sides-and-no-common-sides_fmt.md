...
> 原文: [https://www.geeksforgeeks.org/number-of-triangles-formed-by-joining-vertices-of-n-sided-polygon-with-two-common-sides-and-no-common-sides/](https://www.geeksforgeeks.org/number-of-triangles-formed-by-joining-vertices-of-n-sided-polygon-with-two-common-sides-and-no-common-sides/)
...
> 形成的三角形有两条边(AB 和 BC)与多边形的边相同。同理 BC 和 CD 可以组成一个三角形。有了这个，我们可以说总共有 6 个三角形可能有两个与多边形相同的边。六边形的第二个图像，三角形没有与多边形相同的边。
