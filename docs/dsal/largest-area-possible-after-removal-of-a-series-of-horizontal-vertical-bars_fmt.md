...
> 原文: [https://www.geeksforgeeks.org/largest-area-possible-after-removal-of-a-series-of-horizontal-vertical-bars/](https://www.geeksforgeeks.org/largest-area-possible-after-removal-of-a-series-of-horizontal-vertical-bars/)

给定一个由大小为 `(N + 2) x (M + 2)` 的水平和垂直条以及两个表示需要移除的水平&垂直条数量的数组 `H[]` 和 `V[]` 组成的网格，任务是在移除一系列垂直和水平条时找到最大的区域。
