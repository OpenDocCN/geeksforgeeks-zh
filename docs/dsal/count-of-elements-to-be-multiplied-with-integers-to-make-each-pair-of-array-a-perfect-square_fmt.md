...
给定包含正整数的数组`arr[]`，任务是找到要在数组上执行的最小操作数，以使数组的每个数成为超级幂。在每个操作中，我们可以将数组的任何元素乘以整数。
...
> **输出**：0
>
> **说明**：我们不需要在数组上执行任何操作，因为选择任何元素（2）并将其与其他索引（2）中的任何元素相乘，我们得到一个完美的平方（4）。
...
class GFG{
    ...
    public static void main(String[] args)
    {
        ...
        System.out.println(minimum_operation(b, d, spf));
    }
}
```
