...
> 原文：[https://www.geeksforgeeks.org/one97paytm-interview-experience/](https://www.geeksforgeeks.org/one97paytm-interview-experience/)
...
**Q4:** 给定一个数组，以 `a<b>c<d>e<f>g……` 的形式排列。

**Q5:** 给定一组数字，以单个数字的形式排列，这样得出的数字就是最大值。
...
**Q3:** 在用 Java 和 C#编写的程序之间传输数据。
**Q4:** 我需要建立一个网络，在这个网络中我会保证安全，你会怎么进行。
**Q5:** A 和 B 是两个集合写一个非嵌套的查询，这样我就可以得到 B 中的数据而不是 A 中的数据了。
**Q6:** `000……..？11111111111111111111…………….？` 写一个程序，找到系列 `111111111` 的开头的索引…..？。

## Round 2 (Technical)
**Q1:** Give your introduction along with your technical skills.
**Q2:** Explain your project “Stock Prediction”.
**Q3:** I want to retrieve records from a table from date 1 – 15. I don’t want to use range Queries. Suggest optimal solutions…
