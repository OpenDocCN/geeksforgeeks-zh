...
> 原文: [https://www.geeksforgeeks.org/python-code-move-spaces-front-string-single-traversal/](https://www.geeksforgeeks.org/python-code-move-spaces-front-string-single-traversal/)
