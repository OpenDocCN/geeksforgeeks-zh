...
> **输入**：`Dictionary = {POON, PLEE, SAME, POIE, PLEA, PLIE, POIE}`
>
> `start = "TOON"`
>
> `target = "PLEA"`
...
可以使用标准 [BFS](http://www.geeksforgeeks.org/breadth-first-traversal-for-a-graph/) 方法（如[在此处](https://www.geeksforgeeks.org/word-ladder-length-of-shortest-chain-to-reach-a-target-word/)讨论的方法）解决，但可以通过使用双向 BFS 来提高其性能。
