...
> 原文: [https://www.geeksforgeeks.org/bitwise-and-of-all-even-number-up-to-n/](https://www.geeksforgeeks.org/bitwise-and-of-all-even-number-up-to-n/)

给定一个整数 `N`，任务是找到从 1 到 `N` 的所有偶数的按位与 (`&`)。
...
**高效方式:** 高效方式是 `N` 小于 4 返回 2，`N` >= 4 全部返回 0，因为 2 和 4 的按位与为 0，0 与任意数字的按位与为 0。
以下是实施办法:
