...
> 原文：[https://www.geeksforgeeks.org/find-the-other-end-coordinates-of-diameter-in-a-circle/](https://www.geeksforgeeks.org/find-the-other-end-coordinates-of-diameter-in-a-circle/)
...
**中点公式：**
两端坐标点的中点，(`x1`，`y1`)和(`x2`，`y2`)是 `M` 点，可以用以下公式找到：
![M = \frac{x_{1} + x_{2}}{2}, \ \ \frac{y_{1} + y_{2}}{2}  ](img/cde2139928b1c68f51216d7b36a1cfbe.png "Rendered by QuickLaTeX.com")

我们需要一个(`x2`，`y2`)坐标，所以我们应用中点公式：
