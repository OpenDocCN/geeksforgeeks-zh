...
> 原文: [https://www.geeksforgeeks.org/print-the-sequence-of-size-n-in-which-every-term-is-sum-of-previous-k-terms/](https://www.geeksforgeeks.org/print-the-sequence-of-size-n-in-which-every-term-is-sum-of-previous-k-terms/)
...
**有效方法:** 想法是将当前的和存储在一个变量中，在每一步中减去最后一个 `K` 项，并将最后一项添加到预和中，以计算该系列的每个项。
以下是上述方法的实现:
