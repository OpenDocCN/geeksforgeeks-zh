...
> 原文：[https://www.geeksforgeeks.org/sort-all-special-primes-in-their-relative-positions/](https://www.geeksforgeeks.org/sort-all-special-primes-in-their-relative-positions/)
...
*   所有特殊素数存储在列表中后，[对更新后的列表进行排序](https://www.geeksforgeeks.org/quick-sort-vs-merge-sort/)。
*   再次遍历数组，对于每个元素，
