# 数列 1、2、4、3、5、7、9、6、8、10、11、13 的和直到第 N 项

> 原文: [https://www.geeksforgeeks.org/sum-of-the-series-1-2-4-3-5-7-9-6-8-10-11-13-till-n-th-term/](https://www.geeksforgeeks.org/sum-of-the-series-1-2-4-3-5-7-9-6-8-10-11-13-till-n-th-term/)

给定一系列数字 `1、2、4、3、5、7、9、6、8、10、11、13……`，任务是找到所有系列数字的和，直到第 `N` 个数字。
...
系列基本上是 `2^0` 个奇数，`2^1` 个偶数，`2^2` 个偶数。前 `N` 个奇数之和为 `N * N`，前 `N` 个偶数之和为 `(N * (N+1))`。计算 `2^i` 个奇数或偶数的总和，并不断将它们加到总和中。
