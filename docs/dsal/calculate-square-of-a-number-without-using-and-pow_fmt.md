...
> 原文：[https://www.geeksforgeeks.org/calculate-square-of-a-number-without-using-and-pow/](https://www.geeksforgeeks.org/calculate-square-of-a-number-without-using-and-pow/)

给定一个整数 `n`，在不使用 `*`、`/` 和 `pow()` 的情况下计算一个数的平方。
