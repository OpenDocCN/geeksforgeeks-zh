...
> 原文：[https://www.geeksforgeeks.org/third-last-digit-in-5n-for-given-n/](https://www.geeksforgeeks.org/third-last-digit-in-5n-for-given-n/)

给定一个正整数 `N`，任务是从 `5^N` 的最后一位（最右边）找到第三位数字的值。
...
Input : N = 6
Output : 6
Explanation : Value of 5^6 = 15625.

Input : N = 3
Output : 1
Explanation : Value of 5^3 = 125.
```

**方法：** 在进入实际方法之前，关于数论的一些事实如下：

*   `5^3` 是最小的 3 位数，是 5 的幂。
