...
> 原文: [https://www.geeksforgeeks.org/check-if-any-anagram-of-string-s-is-lexicographically-smaller-than-that-of-string-t/](https://www.geeksforgeeks.org/check-if-any-anagram-of-string-s-is-lexicographically-smaller-than-that-of-string-t/)
...
处理方法是检查字符串 `S` 的字典最小变位是否小于字符串 `T` 的字典最大变位，如果是，那么答案是**是**。否则，**不**。现在，按照以下步骤解决这个问题:
