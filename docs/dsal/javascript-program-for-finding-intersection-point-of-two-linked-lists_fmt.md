...
> 原文: [https://www.geeksforgeeks.org/javascript-program-for-finding-intersection-point-of-two-linked-lists/](https://www.geeksforgeeks.org/javascript-program-for-finding-intersection-point-of-two-linked-lists/)
...
## 方法 6: 遍历两个列表，比较最后一个节点的地址

这个方法只是检测是否有交点。(感谢纽泰萨沃的建议)
