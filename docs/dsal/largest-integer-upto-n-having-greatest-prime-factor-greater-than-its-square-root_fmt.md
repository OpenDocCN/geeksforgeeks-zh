...
> 原文：[https://www.geeksforgeeks.org/largest-integer-upto-n-having-greatest-prime-factor-greater-than-its-square-root/](https://www.geeksforgeeks.org/largest-integer-upto-n-having-greatest-prime-factor-greater-than-its-square-root/)

给定一个正整数 `N`，任务是找到范围 `[1, N]` 中最大的数，使得数的[平方根](https://www.geeksforgeeks.org/square-root-of-an-integer/)小于其[最大质因数](https://www.geeksforgeeks.org/find-largest-prime-factor-number/)。
...
**方法:** 给定的问题可以通过使用[厄拉多塞的筛](https://www.geeksforgeeks.org/sieve-of-eratosthenes/)进行少量修改来解决。创建一个数组 `gpf[]`，它存储给定范围内所有整数的[最大质因数](https://www.geeksforgeeks.org/find-largest-prime-factor-number/)。最初，`gpf[] = {0}`。使用 Sieve，初始化数组 `gpf[]` 的所有索引，使用相应索引的最大质因数，类似于本文中讨论的算法。

现在，[以相反的方式迭代范围](https://www.geeksforgeeks.org/range-based-loop-c/) `[N, 1]`，并打印第一个整数，其数字的[平方根](https://www.geeksforgeeks.org/square-root-of-an-integer/)小于其[最大质因数](https://www.geeksforgeeks.org/find-largest-prime-factor-number/)。
