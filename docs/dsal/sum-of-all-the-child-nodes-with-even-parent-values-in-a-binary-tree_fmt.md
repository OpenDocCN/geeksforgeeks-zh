...
> 原文: [https://www.geeksforgeeks.org/sum-of-all-the-child-nodes-with-even-parent-values-in-a-binary-tree/](https://www.geeksforgeeks.org/sum-of-all-the-child-nodes-with-even-parent-values-in-a-binary-tree/)
...
### 方法:
初始化`和= 0`并执行树的递归遍历，检查节点是否为偶数，如果节点为偶数，则将其子节点的值加到和中。最后，打印总和。
以下是上述方法的实施:
