...
是使用两个嵌套循环。外循环用于选择起点，内循环用于选择终点。对于每对起点到起点，我们都会计算其中的不同元素，如果当前窗口较小，则会更新结果。我们使用散列来计算范围内的不同元素。
...
本文由 `Pawan Asipu` 提供。 如果您喜欢 GeeksforGeeks 并希望做出贡献，则还可以使用 [tribution.geeksforgeeks.org](http://www.contribute.geeksforgeeks.org) 撰写文章，或将您的文章邮寄至 tribution@geeksforgeeks.org。 查看您的文章出现在 GeeksforGeeks 主页上，并帮助其他 Geeks。
