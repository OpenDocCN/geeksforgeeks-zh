...
> 原文: [https://www.geeksforgeeks.org/n-th-term-in-the-series-1-11-55-239-991/](https://www.geeksforgeeks.org/n-th-term-in-the-series-1-11-55-239-991/)
...
### 方法-2:
级数有一个通式 `4^N - 2^N - 1`，用来得到级数的第 `N` 项。
以下是上述方法的实施:
