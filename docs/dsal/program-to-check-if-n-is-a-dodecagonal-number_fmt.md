...
> 原文：[https://www.geeksforgeeks.org/program-to-check-if-n-is-a-dodecagonal-number/](https://www.geeksforgeeks.org/program-to-check-if-n-is-a-dodecagonal-number/)

给定一个数字 `N`，任务是检查 `N` 是否为[十二边形数字](https://www.geeksforgeeks.org/dodecagonal-number/)。如果数字 `N` 是十二边形数字，则打印“是”否则打印“否”。

> **十二边形数字**代表[十二边形](https://www.geeksforgeeks.org/dodecagonal-number/)（12 边多边形）。前几个十二边形数字是 1、12、33、64、105、156、217……
