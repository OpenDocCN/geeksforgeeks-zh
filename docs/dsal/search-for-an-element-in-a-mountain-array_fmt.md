...
> 原文: [https://www.geeksforgeeks.org/search-for-an-element-in-a-mountain-array/](https://www.geeksforgeeks.org/search-for-an-element-in-a-mountain-array/)
...
最简单的方法是[遍历数组](https://www.geeksforgeeks.org/c-program-to-traverse-an-array/)检查当前索引中的元素是否等于 `X`。如果发现是真的，那么打印索引。
...
解决这个问题的最佳思路是使用[二分搜索法](https://www.geeksforgeeks.org/binary-search/)。按照以下步骤解决此问题:
