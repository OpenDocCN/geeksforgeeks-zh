...
> 原文: [https://www.geeksforgeeks.org/printing-matrix-chain-multiplication-a-space-optimized-solution/](https://www.geeksforgeeks.org/printing-matrix-chain-multiplication-a-space-optimized-solution/)
...
### 辅助空间
`O(n^2)`：这个渐近值保持不变，但是我们把辅助空间减少到一半。