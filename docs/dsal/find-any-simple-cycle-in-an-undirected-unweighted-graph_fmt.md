...
上图中的图形说明了循环 1-> 2-> 3-> 4-> 1 不是一个简单的循环，因为它可以分为 2 个简单的循环 1-> 3-> 4-> 1 和 1-> 2-> 3-> 1。
...
的想法是[检查图形是否包含循环](https://www.geeksforgeeks.org/detect-cycle-in-a-graph/)。 只需使用 [DFS](http://www.geeksforgeeks.org/depth-first-traversal-for-a-graph/) 即可完成。
