...
1) [给定 `BST`，找到和等于给定数](https://practice.geeksforgeeks.org/problems/pair-sum-in-bst/1)的配对
2) `二分搜索法`。
其他基本算法题我忘了。
...
2)我的项目
然后开始 `algos`
3) [反向链表](https://practice.geeksforgeeks.org/problems/reverse-a-linked-list-in-groups-of-given-size/1)中的每 k 个节点写工作代码
4) `反向栈内元素`。不应使用额外的内存。
