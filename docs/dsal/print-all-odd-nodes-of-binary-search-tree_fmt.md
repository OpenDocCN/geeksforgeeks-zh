...
> 原文：[`https://www.geeksforgeeks.org/print-all-odd-nodes-of-binary-search-tree/`](https://www.geeksforgeeks.org/print-all-odd-nodes-of-binary-search-tree/)
...
使用任意一个[树遍历](https://www.geeksforgeeks.org/tree-traversals-inorder-preorder-and-postorder/)遍历二叉查找树，检查当前节点的值是否为奇数。如果是，则打印，否则跳过该节点。
以下是上述办法的实施情况：
