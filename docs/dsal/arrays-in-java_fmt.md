...
*   由于数组是 Java 中的对象，因此我们可以使用成员`length`来找到它们的长度。 这与 C/C++ 不同，在 C/C++ 中，我们使用`sizeof`查找长度。
...
Oracle 的[数组](https://docs.oracle.com/javase/tutorial/java/nutsandbolts/arrays.html)