...
> 原文：[https://www.geeksforgeeks.org/intuit-interview-experience-set-11-on-campus/](https://www.geeksforgeeks.org/intuit-interview-experience-set-11-on-campus/)
...
3.  给定两个数组 `A` 和 `B`，求 `GCD(a, b) != 1` 对应的对的个数，其中 `a` 是 `A` 中的数字，`b` 是 `B` 中的数字。
