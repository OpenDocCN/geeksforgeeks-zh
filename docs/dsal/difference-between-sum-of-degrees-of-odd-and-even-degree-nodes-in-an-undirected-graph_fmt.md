...
给定[无向图](https://www.geeksforgeeks.org/graph-data-structure-and-algorithms/)，其中 `N` 个顶点且 `M` 个边，任务是找到奇数度节点和偶度度节点的度和之间的绝对差。

## 范例

> **输入**：`N = 4`，`edges[][] = {{1, 2}, {1, 3}, {1, 4}, {2, 3}, {2, 4}, {3, 4}}`
> **输出**：`12`
> **说明**：
> 下图是上述信息的图形：
...
1.  对于每个顶点，度可以通过给定图形在相应顶点处的[邻接矩阵](https://www.geeksforgeeks.org/convert-adjacency-matrix-to-adjacency-list-representation-of-graph/)或[邻接表](https://www.geeksforgeeks.org/convert-adjacency-matrix-to-adjacency-list-representation-of-graph/)的长度来计算。
