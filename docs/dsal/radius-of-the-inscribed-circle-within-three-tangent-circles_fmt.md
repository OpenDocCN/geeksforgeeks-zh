...
> 原文: [https://www.geeksforgeeks.org/radius-of-the-inscribed-circle-within-three-tangent-circles/](https://www.geeksforgeeks.org/radius-of-the-inscribed-circle-within-three-tangent-circles/)
...
2.  有边的主三角形 `(r1+r2, r1+r3, r2+r3)` 和有边的三个小三角形 `(r1+r4, r2+r4, r1+r2)`、`(r1+r4, r3+r4, r1+r3)`、`(r2+r4, r3+r4, r2+r3)`。
...
凭直觉，`r4` 作为内接圆半径进入 `(r1+r2, r1+r3, r2+r3)` 三角形的上界值小于:
`r_上界 = 2s/(r1+r2+r2+r3+r3+r1) = s/(r1+r2+r3)`
现在[二分搜索法](https://www.geeksforgeeks.org/binary-search/)可应用于以下搜索空间。
...
*   [http://www.ambrsoft.com/TrigoCalc/Circles3/Tangency/Tangent.htm](http://www.ambrsoft.com/TrigoCalc/Circles3/Tangency/Tangent.htm)