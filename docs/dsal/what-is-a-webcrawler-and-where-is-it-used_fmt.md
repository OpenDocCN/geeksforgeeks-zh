...
> 原文：`https://www.geeksforgeeks.org/what-is-a-webcrawler-and-where-is-it-used/`
...
该算法工作背后的思想是解析网站的原始 HTML，并在获得的数据中寻找其他 URL。如果有网址，则将其添加到[队列](https://www.geeksforgeeks.org/queue-data-structure/)中，并以广度优先搜索方式访问它们。
