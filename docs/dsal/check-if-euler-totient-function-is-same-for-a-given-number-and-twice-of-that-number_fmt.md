...
> 原文: [https://www.geeksforgeeks.org/check-if-euler-totient-function-is-same-for-a-given-number-and-twice-of-that-number/](https://www.geeksforgeeks.org/check-if-euler-totient-function-is-same-for-a-given-number-and-twice-of-that-number/)
...
最简单的方法就是找到 `N` 和 `2 * N` 的[欧拉全能性函数](https://www.geeksforgeeks.org/eulers-totient-function/)。如果相同，则打印“是”。否则，打印“否”。
...
要优化上述方法，关键的观察是不需要计算[欧拉全能性函数](https://www.geeksforgeeks.org/eulers-totient-function/)，因为只有奇数遵循属性 `φ(N) = φ(2 * N)`，其中 `φ()` 是欧拉全能性函数。
