...
> 原文: [https://www.geeksforgeeks.org/find-the-largest-divisor-subset-in-the-array/](https://www.geeksforgeeks.org/find-the-largest-divisor-subset-in-the-array/)
...
这里的任务是找到最大的子集，其中在每对数字中，一个可被另一个整除，即对于序列 `a1, a2, a3...ak` 其中 `a1 ≤ a2 ≤ ... ≤ ak`，和这个序列可以使用[动态编程](https://www.geeksforgeeks.org/dynamic-programming/)找到（类似于[最长递增子序列](https://www.geeksforgeeks.org/longest-monotonically-increasing-subsequence-size-n-log-n/)）。
