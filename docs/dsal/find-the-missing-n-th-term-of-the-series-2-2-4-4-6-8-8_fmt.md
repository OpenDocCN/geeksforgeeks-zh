...
> 原文: [https://www.geeksforgeeks.org/find-the-missing-n-th-term-of-the-series-2-2-4-4-6-8-8/](https://www.geeksforgeeks.org/find-the-missing-n-th-term-of-the-series-2-2-4-4-6-8-8/)
...
1.  如果 `n` 是奇数:
    1.  要求的条款是 A.P `[2，4，6，8 …]`的第 `(n+1)/2` 个条款。
    2.  A.P 的第 `n` 个项可计算为 `A+(n–1)d`。
2.  如果 `n` 是偶数:
    1.  所需术语是通用术语 `[2，4，8 …]`的第 `n/2` 个术语。
    2.  通用零件的第 `n` 个项可计算为 `a * r^(n-1)`。
