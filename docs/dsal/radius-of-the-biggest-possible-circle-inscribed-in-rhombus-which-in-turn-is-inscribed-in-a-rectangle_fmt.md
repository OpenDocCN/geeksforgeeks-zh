...
> 原文：[https://www.geeksforgeeks.org/radius-of-the-biggest-possible-circle-inscribed-in-rhombus-which-in-turn-is-inscribed-in-a-rectangle/](https://www.geeksforgeeks.org/radius-of-the-biggest-possible-circle-inscribed-in-rhombus-which-in-turn-is-inscribed-in-a-rectangle/)
...
所以，圆的半径就 `l` `b` 而言就是= `lb/2√(l^2+b^2).`
