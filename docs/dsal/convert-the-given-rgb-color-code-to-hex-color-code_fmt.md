...
> 原文: [https://www.geeksforgeeks.org/convert-the-given-rgb-color-code-to-hex-color-code/](https://www.geeksforgeeks.org/convert-the-given-rgb-color-code-to-hex-color-code/)
...
> **输出:** `-1`
> **解释:**
> 一个 256 色码是不可能的，因为一种颜色只有 0-255 范围可用。
