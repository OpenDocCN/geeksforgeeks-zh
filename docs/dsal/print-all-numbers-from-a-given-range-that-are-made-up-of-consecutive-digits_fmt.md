...
> 原文：[https://www.geeksforgeeks.org/print-all-numbers-from-a-given-range-that-are-made-up-of-consecutive-digits/](https://www.geeksforgeeks.org/print-all-numbers-from-a-given-range-that-are-made-up-of-consecutive-digits/)
...
给定的问题可以通过[生成所有可能的数字](https://www.geeksforgeeks.org/print-all-possible-combinations-of-r-elements-in-a-given-array-of-size-n/)并存储所有满足给定条件的数字来解决。生成所有数字后，按排序顺序打印所有存储的数字。按照以下步骤解决给定的问题：
