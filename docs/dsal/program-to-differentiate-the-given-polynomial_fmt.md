...
> 原文：[https://www.geeksforgeeks.org/program-to-differentiate-the-given-polynomial/](https://www.geeksforgeeks.org/program-to-differentiate-the-given-polynomial/)
...
> **输入：** `str = " 4X^3+3X^1+2X^2"`
> **输出：** `" 12X^2+3X^0+4X^1"`
> **解释：**
> `p(X)= A * X^N` 的导数为 `p'(x) = A*N*X^{N - 1}`
> **输入：** `str = " 5X^4+6X^2+5X^2"`
> **输出：** `" 20X^3+12X^1+10X^1"`

## 方法

想法是观察当给定的方程由多个多项式组成时
