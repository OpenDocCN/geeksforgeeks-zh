# 求数列 1 + 1/2^2 + 1/3^3 + ... + 1/n^n 的和的程序

> 原文: [https://www.geeksforgeeks.org/program-find-sum-series-1-122-133-1nn/](https://www.geeksforgeeks.org/program-find-sum-series-1-122-133-1nn/)
