...
> 原文：`https://www.geeksforgeeks.org/print-all-k-sum-levels-in-a-binary-tree/`

给定一个二叉树和一个整数 `K`，其中该树有正负节点，任务是打印其和等于 `K` 的级别的元素。如果不存在这样的结果，则打印“`不可能`”。
