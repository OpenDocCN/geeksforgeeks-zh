...
> 原文: [https://www.geeksforgeeks.org/sum-of-all-vertical-levels-of-a-binary-tree/](https://www.geeksforgeeks.org/sum-of-all-vertical-levels-of-a-binary-tree/)
...
> 对于垂直标高 4: (1) <sub>2</sub> = 1
> 对于垂直标高 5: (10) <sub>2</sub> = 2
