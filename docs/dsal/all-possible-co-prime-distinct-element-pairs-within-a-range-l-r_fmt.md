# 范围[L，R]内所有可能的同素不同元素对

> 原文：[https://www.geeksforgeeks.org/all-possible-co-prime-distinct-element-pairs-within-a-range-l-r/](https://www.geeksforgeeks.org/all-possible-co-prime-distinct-element-pairs-within-a-range-l-r/)
...
**方法：** 对问题的关键观察是，差为`1`的数总是彼此相对素数，即同素数。这一对的`GCD`始终为`1`。因此，答案将是`(R-L+1)/2` [（范围内的总数）/ 2]。
