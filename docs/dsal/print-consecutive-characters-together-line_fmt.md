...
> 原文：[https://www.geeksforgeeks.org/print-consecutive-characters-together-line/](https://www.geeksforgeeks.org/print-consecutive-characters-together-line/)

给定一个字符序列，在一行中打印连续的字符序列，否则在新的一行中打印。
