...
> 原文：[https://www.geeksforgeeks.org/program-to-find-the-volume-of-an-irregular-tetrahedron/](https://www.geeksforgeeks.org/program-to-find-the-volume-of-an-irregular-tetrahedron/)

给定不规则四面体的边长。任务是确定四面体的体积。
让金字塔的边长为 `u`、`u`、`v`、`v`、`w`、`w`。
...
> 体积 = `sqrt(a/288)` =
> `sqrt(4 * u * u * v * v * w * w - u * u * (v * v + w * w - u * u)^2 - v * v * (w * w + u * u - v)^2 - w * w * (u * u + v * v - w)^2 + (u * u + v * v - w) * (w * w + u * u - v * v) * (w * v)`
