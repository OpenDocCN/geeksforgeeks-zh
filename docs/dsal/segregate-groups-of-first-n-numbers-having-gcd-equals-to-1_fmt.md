...
> 原文: [https://www.geeksforgeeks.org/segregate-groups-of-first-n-numbers-having-gcd-equals-to-1/](https://www.geeksforgeeks.org/segregate-groups-of-first-n-numbers-having-gcd-equals-to-1/)
...
众所周知，每一个连续号码的 [GCD](https://www.geeksforgeeks.org/basic-and-extended-euclidean-algorithms/) 都是 1。所以我们就用这个事实来解决这个问题。以下是步骤:
