...
> 原文：[https://www.geeksforgeeks.org/add-elements-in-start-to-sort-the-array-variation-of-stalin-sort/](https://www.geeksforgeeks.org/add-elements-in-start-to-sort-the-array-variation-of-stalin-sort/)
...
想法是每当数组的元素少于前一个元素时，就在数组的开始处推送元素。重复此步骤，直到没有顺序不正确的元素。
