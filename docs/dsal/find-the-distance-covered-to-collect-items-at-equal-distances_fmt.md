...
> 原文：[https://www.geeksforgeeks.org/find-the-distance-covered-to-collect-items-at-equal-distances/](https://www.geeksforgeeks.org/find-the-distance-covered-to-collect-items-at-equal-distances/)
...
> = 2(5`n`+3/2[(`n-1`)*(`n-1+1`)]
> = 2(5`n`+3/2[(`n-1`)* `n`])
> = 2(5`n`+3/2(`n`<sup>2</sup>–`n`))
> = 10`n`+3 * `n`<sup>2</sup>–3 * `n`
> = 3 * `n`<sup>2</sup>+7 *
