...
> 原文: [https://www.geeksforgeeks.org/program-implement-standard-error-mean/](https://www.geeksforgeeks.org/program-implement-standard-error-mean/)

`平均值的标准误差(SEM)` 用于从总体平均值估计样本平均离差。标准误差和样本均值一起用于估计均值的近似置信区间。它也被称为平均值或测量值的标准误差，通常用 `SE`、`SEM` 或 `S_E` 表示。
...
> 给定一个数组 `arr[] = {78.53, 79.62, 80.25, 81.05, 83.21, 83.46}`，任务是找到均值的标准误差。
> `均值 = (78.53 + 79.62 + 80.25 + 81.05 + 83.21 + 83.46) / 6`
> `= 486.12 / 6`
> `= 81.02`
> `样本标准差 = sqrt((78.53–81.02)^2 + (79.62-81.02)^2 + ... + (83.46–81.02)^2 / (6–1))`
> `= sqrt(19.5036 / 5)`
> `= 1.97502`
