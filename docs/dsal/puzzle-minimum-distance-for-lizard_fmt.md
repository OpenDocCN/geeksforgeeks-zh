...
> 原文:[https://www.geeksforgeeks.org/puzzle-minimum-distance-for-lizard/](https://www.geeksforgeeks.org/puzzle-minimum-distance-for-lizard/)

一只蜥蜴出现在立方体的一角，它想到达立方体的对角。你必须计算蜥蜴到达目的地的最小距离。
注意:蜥蜴不会飞，它是沿着墙移动的。
给你一个代表立方体的一边。你必须计算蜥蜴必须行进的最小距离。
