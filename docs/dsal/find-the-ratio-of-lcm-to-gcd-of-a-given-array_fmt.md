...
> 原文：[https://www.geeksforgeeks.org/find-the-ratio-of-lcm-to-gcd-of-a-given-array/](https://www.geeksforgeeks.org/find-the-ratio-of-lcm-to-gcd-of-a-given-array/)
...
1.  首先，我们会找到给定数组的 `GCD`。为此，我们可以使用 STL 提供的 `GCD` 的[内置函数](https://www.geeksforgeeks.org/stdgcd-c-inbuilt-function-finding-gcd/)，也可以使用[欧几里德算法](https://www.geeksforgeeks.org/euclidean-algorithms-basic-and-extended/)。
2.  然后，我们将使用下面的公式找到数组的 `LCM`：
