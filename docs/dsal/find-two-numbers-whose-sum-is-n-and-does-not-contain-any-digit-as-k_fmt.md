...
> 原文: [https://www.geeksforgeeks.org/find-two-numbers-whose-sum-is-n-and-does-not-contain-any-digit-as-k/](https://www.geeksforgeeks.org/find-two-numbers-whose-sum-is-n-and-does-not-contain-any-digit-as-k/)
...
思路是迭代一个从 `i = 1` 到 `n-1` 的循环，检查 `i` 和 `(n–i)` 是否不包含 `K`。如果它不包含任何数字，那么打印这两个数字，并打破循环。
