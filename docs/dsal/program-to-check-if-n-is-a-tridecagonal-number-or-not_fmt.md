...
> 原文: [https://www.geeksforgeeks.org/program-to-check-if-n-is-a-tridecagonal-number-or-not/](https://www.geeksforgeeks.org/program-to-check-if-n-is-a-tridecagonal-number-or-not/)
...
3.  最后，检查使用该公式计算的值是否为整数，这意味着 `N` 是一个三叉戟数。
