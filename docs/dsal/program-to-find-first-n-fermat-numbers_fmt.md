...
> 原文: [https://www.geeksforgeeks.org/program-to-find-first-n-fermat-numbers/](https://www.geeksforgeeks.org/program-to-find-first-n-fermat-numbers/)
...
> **输出:** 3、5、17、257
> **输入:** `N = 7`
> **输出:** 3、5、17、257、65537、4294967297、18446744073709551617

## 方法

使用上述公式，我们将找到该系列的第 `n` 个项。
以下是上述方法的实施:
...
**参考资料:** [https://en.wikipedia.org/wiki/Fermat_number](https://en.wikipedia.org/wiki/Fermat_number)