...
> 原文: [https://www.geeksforgeeks.org/write-an-iterative-olog-y-function-for-powx-y/](https://www.geeksforgeeks.org/write-an-iterative-olog-y-function-for-powx-y/)

给定一个整数 `x` 和一个正数 `y`，编写一个函数，在以下条件下计算 `x^y`。
