...
> 原文: [https://www.geeksforgeeks.org/print-number-ascending-order-contains-1-2-3-digits/](https://www.geeksforgeeks.org/print-number-ascending-order-contains-1-2-3-digits/)
...
首先从包含 `1, 2 & 3` 的数组中找出所有的数字，然后按照 1，2，3 排序，然后打印出来。
