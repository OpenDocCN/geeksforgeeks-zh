...
> 原文: [https://www.geeksforgeeks.org/check-if-uppercase-characters-in-a-string-are-used-correctly-or-not/](https://www.geeksforgeeks.org/check-if-uppercase-characters-in-a-string-are-used-correctly-or-not/)
...
*   检查字符串的第一个字符是否大写。如果发现为真，则迭代剩余的字符。
