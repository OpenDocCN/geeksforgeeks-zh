...
这个问题是[从给定的字符串中删除空格](https://www.geeksforgeeks.org/remove-spaces-from-a-given-string/)的扩展。

## 方法 1

*   想法是保持 2 个指针。最初两者都指向数组的开头。
