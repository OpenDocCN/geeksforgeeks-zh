...
> 原文：[https://www.geeksforgeeks.org/how-to-flatten-a-vector-of-vectors-or-2d-vector-in-c/](https://www.geeksforgeeks.org/how-to-flatten-a-vector-of-vectors-or-2d-vector-in-c/)
...
3.  创建一个 `hasNext()` 方法来检查它是否有向量有下一个元素。
