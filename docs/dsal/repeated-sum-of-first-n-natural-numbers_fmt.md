...
> 原文: [https://www.geeksforgeeks.org/repeated-sum-of-first-n-natural-numbers/](https://www.geeksforgeeks.org/repeated-sum-of-first-n-natural-numbers/)
...
> **输入:** `N = 2`，`K = 2`
> **输出:** `6`
> 运算 1: `n = sum(n) = sum(2) = 1 + 2 = 3`
> 运算 2: `n = sum(n) = sum(3) = 1 + 2 + 3 = 6`
> **输入:** `N = 3`，`K = 2`
> **输出:** `21`
