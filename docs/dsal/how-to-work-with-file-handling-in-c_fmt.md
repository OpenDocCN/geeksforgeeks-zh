...
> 原文: [https://www.geeksforgeeks.org/how-to-work-with-file-handling-in-c/](https://www.geeksforgeeks.org/how-to-work-with-file-handling-in-c/)

## 先决条件

[通过 C++ 类进行文件处理](https://www.geeksforgeeks.org/file-handling-c-classes/)
