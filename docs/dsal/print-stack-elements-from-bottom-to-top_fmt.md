...
> 原文: [https://www.geeksforgeeks.org/print-stack-elements-from-bottom-to-top/](https://www.geeksforgeeks.org/print-stack-elements-from-bottom-to-top/)
...
思路是弹出栈的元素，调用递归函数 `PrintStack`。一旦堆栈变空，开始打印最后弹出的元素，最后弹出的元素是最底部的元素。因此，元素将从下往上打印。现在推回被打印的元素，这将保持元素在堆栈中的顺序。
