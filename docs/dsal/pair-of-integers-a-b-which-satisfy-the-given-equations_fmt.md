...
> 原文:[https://www.geeksforgeeks.org/pair-of-integers-a-b-which-satisfy-the-given-equations/](https://www.geeksforgeeks.org/pair-of-integers-a-b-which-satisfy-the-given-equations/)

给定方程组 `a^2 + b = n` 和 `a + b^2 = m`。任务是找出满足给定的 `n` 和 `m` 等式的正整数对 `(a，b)` 的个数。
