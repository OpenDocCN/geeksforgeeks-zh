...
给定一个[链表](https://www.geeksforgeeks.org/data-structures/linked-list/)和两个整数`X`和`Y`，任务是在第一次出现值为`X`的节点后删除所有出现的`Y`，[打印修改后的链表](https://www.geeksforgeeks.org/print-nodes-of-linked-list-at-given-indexes/)。
