# 通过擦除任意两个连续的相似字母找到要获胜的游戏的获胜者

> 原文: [https://www.geeksforgeeks.org/find-the-winner-of-the-game-to-win-by-erasing-any-two-consecutive-similar-alphabets/](https://www.geeksforgeeks.org/find-the-winner-of-the-game-to-win-by-erasing-any-two-consecutive-similar-alphabets/)
...
我们可以用一个[栈](https://www.geeksforgeeks.org/stack-data-structure/)来简化问题。
