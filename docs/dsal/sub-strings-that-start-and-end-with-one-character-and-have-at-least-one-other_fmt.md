...
> 原文: [https://www.geeksforgeeks.org/sub-strings-that-start-and-end-with-one-character-and-have-at-least-one-other/](https://www.geeksforgeeks.org/sub-strings-that-start-and-end-with-one-character-and-have-at-least-one-other/)
