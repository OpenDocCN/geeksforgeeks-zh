...
> 原文: [https://www.geeksforgeeks.org/find-the-sum-of-the-first-nth-centered-hexadecagonal-number/](https://www.geeksforgeeks.org/find-the-sum-of-the-first-nth-centered-hexadecagonal-number/)

给定一个数 `N`，任务是求前 `N` 个[居中的十六边形数](https://www.geeksforgeeks.org/centered-hexadecagonal-number/)的和。
...
1.  首先，我们需要创建一个函数来帮助我们计算第 `N` 个[居中的十六边形数](https://www.geeksforgeeks.org/centered-hexadecagonal-number/)。
2.  现在，我们运行一个从 1 到 `N` 的循环，找到一个以十六边形为中心的数。
3.  将上面计算的所有居中十六边形数相加。
4.  最后，显示前 `N` 个居中十六边形数的和。
