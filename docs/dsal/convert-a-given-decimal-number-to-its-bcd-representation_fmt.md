...
> 原文：[https://www.geeksforgeeks.org/convert-a-given-decimal-number-to-its-bcd-representation/](https://www.geeksforgeeks.org/convert-a-given-decimal-number-to-its-bcd-representation/)
...
> **输出:** `0001 0000`
> **解释:**
> 考虑 4 位概念：二进制中的 1 为 `0001`，二进制中的 0 为 `0000`。
