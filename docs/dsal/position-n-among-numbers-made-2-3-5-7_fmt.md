# n 在由 2、3、5、7 组成的数字中的位置

> 原文: [https://www.geeksforgeeks.org/position-n-among-numbers-made-2-3-5-7/](https://www.geeksforgeeks.org/position-n-among-numbers-made-2-3-5-7/)
...
与以下文章相反：[只求质数(2、3、5、7)组成的第 n 个数](https://www.geeksforgeeks.org/finding-n-th-number-made-prime-digits/)
...
如果数字为 2，则位于位置 `pos*2+1` 上；如果数字为 3，则位于位置 `pos*2+2` 上；如果数字为 5，则位于位置 `pos*2+3` 上；如果数字为 7，则位于位置 `pos*2+4` 上；这里，位置是大于或等于 0 的整数。
