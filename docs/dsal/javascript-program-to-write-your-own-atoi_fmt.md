...
> 原文: [https://www.geeksforgeeks.org/javascript-program-to-write-your-own-atoi/](https://www.geeksforgeeks.org/javascript-program-to-write-your-own-atoi/)
...
这个实现处理各种类型的错误。如果字符串为空或字符串包含非数字字符，则返回 0，因为该数字无效。
