...
> 原文: [https://www.geeksforgeeks.org/pick-points-from-array-such-that-minimum-distance-is-maximized/](https://www.geeksforgeeks.org/pick-points-from-array-such-that-minimum-distance-is-maximized/)
...
> **输出:** `4`
> 我们可以将 4 个磁铁放置到位置 1，5，10，18，因此最大距离最小为 `min(dist(1，5)，dist(5，10)，dist(10，18)) = dist(1，5) = 4`。
> 这将是两个最近的磁铁之间的最大可能距离。
> **输入:** `C = 3`，`arr[] = {5，7，11，20，23}`
> **输出:** `6`
> 我们可以在位置 5，11，23 放置 3 块磁铁，这样答案将是 `min(dist(5，11)，dist(11，23)) = dist(5，11) = 6`。
...
class GFG
{
    ...
    // to place C magnets assuming mid as
    // maximum possible distance
    static bool isPossible(int []arr, int n, int C, int mid)
    {
        // Variable magnet will store count of magnets
        // that got placed and currPosition will store
        // the position of last placed magnet
