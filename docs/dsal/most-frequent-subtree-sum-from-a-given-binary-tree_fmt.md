...
> 原文：[https://www.geeksforgeeks.org/most-frequent-subtree-sum-from-a-given-binary-tree/](https://www.geeksforgeeks.org/most-frequent-subtree-sum-from-a-given-binary-tree/)
...
对给定的树使用 [DFS 遍历](https://www.geeksforgeeks.org/dfs-traversal-of-a-tree-using-recursion/)的思想来解决给定的问题。按照以下步骤解决问题：
...
*   对给定的树执行 DFS 遍历，并执行以下操作：
    ...
    *   将地图 `M` 中 `F[totalSum]` 值更新为 `totalSum` 的频率。
