...
> 原文: [https://www.geeksforgeeks.org/print-n-numbers-such-that-their-sum-is-a-perfect-square/](https://www.geeksforgeeks.org/print-n-numbers-such-that-their-sum-is-a-perfect-square/)
...
第一个 `n` 个奇数的和总是一个完美的平方。因此，我们将打印第一个 `n` 个奇数作为输出。
以下是上述方法的实现:
