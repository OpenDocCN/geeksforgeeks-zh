...
> 原文: [https://www.geeksforgeeks.org/compress-the-array-into-ranges/](https://www.geeksforgeeks.org/compress-the-array-into-ranges/)
...
*   如果 `i` 不在 `while` 循环中，则增加 1，否则增加 `j+1`，以便它跳到当前范围之外的下一个 `i` 元素。
