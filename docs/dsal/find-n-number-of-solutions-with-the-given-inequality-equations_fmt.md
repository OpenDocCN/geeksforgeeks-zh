...
> 原文：[https://www.geeksforgeeks.org/find-n-number-of-solutions-with-the-given-inequality-equations/](https://www.geeksforgeeks.org/find-n-number-of-solutions-with-the-given-inequality-equations/)

找出 `a1`、`a2`、`a3`、...、`an` 的值，满足以下两个条件。
...
打印 `a1`、`a2`、...、`an` 的值，否则为“无解”。

**注：** 可能有一个或几个方案，打印其中任意一个。
...
2.  如果 `y` 小于 `n` 或者 `x` 大于 `n`，则没有 `a1`...`an` 的解。
