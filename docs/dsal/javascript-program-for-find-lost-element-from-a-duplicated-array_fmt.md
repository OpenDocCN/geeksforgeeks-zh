...
> 原文：[https://www.geeksforgeeks.org/javascript-program-for-find-lost-element-from-a-duplicated-array/](https://www.geeksforgeeks.org/javascript-program-for-find-lost-element-from-a-duplicated-array/)
...
一个简单的解决方案是迭代数组，逐元素检查，当发现不匹配的元素时标记缺失的元素，但是这个解决方案需要数组的线性时间过大。

另一个高效解决方案是基于[二分搜索法](http://geeksquiz.com/binary-search/)的方法。算法步骤如下：
...
更多详细信息，请参考完整文章[从重复数组中查找丢失元素！](https://www.geeksforgeeks.org/find-lost-element-from-a-duplicated-array/)