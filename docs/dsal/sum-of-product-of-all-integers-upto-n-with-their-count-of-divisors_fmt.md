...
> 原文: [https://www.geeksforgeeks.org/sum-of-product-of-all-integers-upto-n-with-their-count-of-divisors/](https://www.geeksforgeeks.org/sum-of-product-of-all-integers-upto-n-with-their-count-of-divisors/)

给定一个正整数 `N`，任务是求 `[1, N]` 范围内所有整数与其除数的乘积之和。
...
天真法是从 `1` 到 `N` 遍历，找出所有数字的和及其[除数](https://www.geeksforgeeks.org/count-divisors-n-on13/)。
