...
> 原文: [https://www.geeksforgeeks.org/program-to-find-the-number-from-given-holes/](https://www.geeksforgeeks.org/program-to-find-the-number-from-given-holes/)
...
2.  如果给定的孔数大于 1，则将孔数除以 2，并将余数存储在 `rem` 变量中。而商在 `quo` 变量中。
3.  现在，如果 `rem` 变量的值等于 1，那么首先打印 4，然后打印 `quo` 次 8。
4.  否则只打印 `quo` 次 8。
