...
> 原文：[https://www.geeksforgeeks.org/largest-number-less-than-x-having-at-most-k-set-bits/](https://www.geeksforgeeks.org/largest-number-less-than-x-having-at-most-k-set-bits/)

给定一个整数 `X > 1` 和一个整数 `K > 0`，任务是找到最大的奇数 `< X`，使得其二进制表示中 `1` 的数量最多为 `K`。
