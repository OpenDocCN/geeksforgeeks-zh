...
> 原文：[`https://www.geeksforgeeks.org/n-th-term-series-2-12-36-80-150/`](https://www.geeksforgeeks.org/n-th-term-series-2-12-36-80-150/)
...
如果我们仔细看，我们可以注意到数列是自然数(1，4，9，16，25，…)的平方和立方的和..) + (1, 8, 27, 64, 125, ….)。因此该系列的第 n 个号码是`n^2+n^3`。
