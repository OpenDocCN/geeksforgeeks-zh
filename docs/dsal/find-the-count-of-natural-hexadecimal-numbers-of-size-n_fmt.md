...
> 原文: [https://www.geeksforgeeks.org/find-the-count-of-natural-hexadecimal-numbers-of-size-n/](https://www.geeksforgeeks.org/find-the-count-of-natural-hexadecimal-numbers-of-size-n/)
...
因此 `n` 第项将为 `15 * pow(16, n-1)`。
所以 `n` 位自然十六进制数的计数将为 `15 * pow(16, n-1)`。
