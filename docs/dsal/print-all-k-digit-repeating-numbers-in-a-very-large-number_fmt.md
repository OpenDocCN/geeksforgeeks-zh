...
由于数字是以字符串形式给出的，因此，想法是将大小为`K`的所有子字符串及其频率存储在[映射](http://www.geeksforgeeks.org/map-associative-containers-the-c-standard-template-library-stl/)中。现在，在迭代映射时，仅打印那些频率大于 1 的子字符串及其出现的次数。
