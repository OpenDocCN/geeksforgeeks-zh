...
> 原文: [https://www.geeksforgeeks.org/php-program-for-find-maximum-value-of-sum-iarri-with-only-rotations-on-given-array-allowed/](https://www.geeksforgeeks.org/php-program-for-find-maximum-value-of-sum-iarri-with-only-rotations-on-given-array-allowed/)
...
一个简单解就是逐个找到所有的旋转，检查每个旋转的和，返回最大和。这个解的时间复杂度为 `O(n^2)`。
