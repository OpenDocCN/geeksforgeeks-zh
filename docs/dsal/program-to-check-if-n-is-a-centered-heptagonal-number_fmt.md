...
> 原文: [https://www.geeksforgeeks.org/program-to-check-if-n-is-a-centered-heptagonal-number/](https://www.geeksforgeeks.org/program-to-check-if-n-is-a-centered-heptagonal-number/)
...
**方法:**
为了解决上面提到的问题，我们必须知道中心七边形数的第 K 项给出为：
`K^{th} Term = \frac {7*N^{2} - 7*N + 2}{2}`
