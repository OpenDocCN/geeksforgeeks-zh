...
> 原文：[https://www.geeksforgeeks.org/rearrange-two-given-arrays-to-maximize-sum-of-same-indexed-elements/](https://www.geeksforgeeks.org/rearrange-two-given-arrays-to-maximize-sum-of-same-indexed-elements/)

给定两个大小为 `N` 的[数组](https://www.geeksforgeeks.org/array-data-structure/) `A[]` 和 `B[]`，任务是通过重新排列数组元素找到 `abs(A[i]–B[i])` 的最大可能和。
...
*   [遍历两个数组](https://www.geeksforgeeks.org/c-program-to-traverse-an-array/)并打印 `abs(A[i]–B[i])` 所有可能值的总和。
