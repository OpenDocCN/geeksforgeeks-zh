...
> 原文：[https://www.geeksforgeeks.org/python-program-to-print-sum-of-all-key-value-pairs-in-a-dictionary/](https://www.geeksforgeeks.org/python-program-to-print-sum-of-all-key-value-pairs-in-a-dictionary/)
...
想法是[遍历字典的键](https://www.geeksforgeeks.org/iterate-over-a-dictionary-in-python/)。按照以下步骤解决问题：

*   初始化一个[列表](https://www.geeksforgeeks.org/python-list/)，记为 `l`，存储结果。
*   [遍历字典](https://www.geeksforgeeks.org/iterate-over-a-dictionary-in-python/) `arr`，然后将 `i + arr[i]` [追加到列表](https://www.geeksforgeeks.org/append-extend-python/) `l` 中。
...
解决问题的替代方法是使用 [`keys()` 方法](https://www.geeksforgeeks.org/python-dictionary-keys-method/)。按照以下步骤解决问题：
