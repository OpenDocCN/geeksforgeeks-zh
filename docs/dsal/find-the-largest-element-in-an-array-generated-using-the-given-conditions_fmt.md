...
> 原文: [https://www.geeksforgeeks.org/find-the-largest-element-in-an-array-generated-using-the-given-conditions/](https://www.geeksforgeeks.org/find-the-largest-element-in-an-array-generated-using-the-given-conditions/)
...
*   `arr[2 * i + 1] = arr[i] + arr[i + 1]` 当 `2 ≤ 2 * i + 1 ≤ N`
...
> **如果 `i` 是偶数:** `Arr[i] = Arr[i/2]`
> **否则，如果 `i` 是奇数:** `Arr[i] = Arr[(i–1)/2] + Arr[(i–1)/2+1]`
