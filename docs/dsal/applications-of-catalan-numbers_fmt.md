...
> 原文：[https://www.geeksforgeeks.org/applications-of-catalan-numbers/](https://www.geeksforgeeks.org/applications-of-catalan-numbers/)
...
9.  长度为 `2n` 的 Dyck 字数。Dyck 单词是由 `n` 个 `X` 和 `n` 个 `Y` 组成的字符串，因此字符串的初始段没有比 `X` 更多的 `Y`。例如，以下是长度为 6 的 Dyck 单词:`XXXYYY XYXYY XYXYXYXYXYXYXYY`。
...
12. 形成一个“山脉”的方法的数量，`n` 个上划和 `n` 个下划都保持在原始线以上。山脉的解释是山永远不会低于地平线。
    ![Mountain_Ranges](img/a84b3a279e08608d31c52a578fc2b89d.png)
