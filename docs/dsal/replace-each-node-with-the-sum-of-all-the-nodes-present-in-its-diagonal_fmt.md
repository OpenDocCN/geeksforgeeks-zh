...
> 原文：[https://www.geeksforgeeks.org/replace-each-node-with-the-sum-of-all-the-nodes-present-in-its-diagonal/](https://www.geeksforgeeks.org/replace-each-node-with-the-sum-of-all-the-nodes-present-in-its-diagonal/)
...
**方法：** 思想是执行二叉树的[对角遍历](https://www.geeksforgeeks.org/diagonal-traversal-of-binary-tree/)，并将每个节点的和存储在同一对角线上。最后，遍历树并用对角线上的节点总和替换每个节点。按照以下步骤解决问题：
