...
> 原文：[https://www.geeksforgeeks.org/largest-triangle-that-can-be-inscribed-in-an-ellipse/](https://www.geeksforgeeks.org/largest-triangle-that-can-be-inscribed-in-an-ellipse/)

给定一个椭圆，长轴长度为 `2a` 和 `2b`，任务是找出其中可内接的最大三角形的面积。
