...
> 原文: [https://www.geeksforgeeks.org/nth-number-made-up-of-odd-digits-only/](https://www.geeksforgeeks.org/nth-number-made-up-of-odd-digits-only/)

给定一个整数 `N`，任务是找到仅由奇数位(1，3，5，7，9)组成的第 `N` 个数。
...
**方法 1 (简单):** 从 `1` 开始，继续检查号码是否仅由奇数(1、3、5、7、9)组成，当发现第 n 个这样的号码时停止。
