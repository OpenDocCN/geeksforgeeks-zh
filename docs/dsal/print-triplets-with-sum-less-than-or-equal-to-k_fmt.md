...
> 原文: [https://www.geeksforgeeks.org/print-triplets-with-sum-less-than-or-equal-to-k/](https://www.geeksforgeeks.org/print-triplets-with-sum-less-than-or-equal-to-k/)

给定一组不同的整数和一个和值。打印总和小于给定总和值的所有三元组。预期时间复杂度为 `O(n^2)`。
