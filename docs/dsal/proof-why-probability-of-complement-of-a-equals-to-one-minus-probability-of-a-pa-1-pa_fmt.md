...
> 3.  If a<sub>1</sub>, a<sub>2</sub>, a<sub>3</sub>, a<sub>4</sub> ... A<sub>N</sub> are mutually exclusive events, then the probability of the combination of these mutually exclusive events will be equal to the sum of the probabilities of these mutually exclusive events. That is, P(a<sub>1</sub> ∪ a<sub>2</sub> ∪ ... ∪ a<sub>n</sub>) = P(a<sub>1</sub>) + P(a<sub>2</sub>) + ... + P(A<sub>N</sub>)
...
1.  考虑一个事件，因为一个实验的样本空间包含了这个实验的所有可能的结果，而 A 和 A' 的[并集](https://www.geeksforgeeks.org/union-and-intersection-of-sets/)包含了这个实验的所有可能的结果。所以，样本空间可以写成-
