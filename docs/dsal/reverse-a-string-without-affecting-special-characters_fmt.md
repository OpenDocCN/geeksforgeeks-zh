...
> 原文：[https://www.geeksforgeeks.org/reverse-a-string-without-affecting-special-characters/](https://www.geeksforgeeks.org/reverse-a-string-without-affecting-special-characters/)

给定一个包含特殊字符和字母（“A”到“Z”和“a”到“z”）的字符串，以不影响特殊字符的方式反转该字符串。
...
3. 使用标准[字符串反转算法](https://www.geeksforgeeks.org/write-a-program-to-reverse-an-array-or-string/)反转 `temp[]`。
