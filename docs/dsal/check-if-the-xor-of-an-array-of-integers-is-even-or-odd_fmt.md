...
> 原文: [https://www.geeksforgeeks.org/check-if-the-xor-of-an-array-of-integers-is-even-or-odd/](https://www.geeksforgeeks.org/check-if-the-xor-of-an-array-of-integers-is-even-or-odd/)
...
先求给定整数数组的 XOR，然后检查这个 XOR 是偶数还是奇数。

**时间复杂度:** `O(N)`

## 高效解决方案

更好的解决方案基于[位操作](https://www.geeksforgeeks.org/bits-manipulation-important-tactics/)事实，即:
