...
> 原文: [https://www.geeksforgeeks.org/perform-the-given-queries-on-the-rooted-tree/](https://www.geeksforgeeks.org/perform-the-given-queries-on-the-rooted-tree/)
...
这个问题是 dfs 的轻微变异。在这种情况下，我们将节点的原始值和相加值存储在对的向量中。我们做了两次 dfs。
