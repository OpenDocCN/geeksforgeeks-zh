...
> 原文: [https://www.geeksforgeeks.org/count-distinct-regular-bracket-sequences-which-are-not-n-periodic/](https://www.geeksforgeeks.org/count-distinct-regular-bracket-sequences-which-are-not-n-periodic/)
...
> 一个 `常规括号序列` 是以下方式的序列:
> *   空字符串是常规的括号序列。
> *   如果 `s` 和 `t` 是常规括号序列，那么 `s + t` 就是常规括号序列。
...
> **输出:** 5
> **解释:**
> 将有 5 个长度为 `2 * N` 的截然不同的规则括号序列：`()()())`、`((()))())`、`((()))`、`((((())))`。现在，没有一个序列是 `N 周期`的。因此，输出为 5。
>
> **输入:** `N = 4`
> **输出:** 12
> **解释:**
> 将有 14 个长度为 `2*N` 的截然不同的规则括号序列，它们分别是 `()()()()())`、`()()()()()())`、`()())())`、`()())()())`、`()())())())`、`()())())())`、`()())())())`、`()())())())`、`()())())())`、`()())())())`、`()())())())`、`()())())())`、`()())())())`、`()())())())`。它们有一个周期 `N`。
> 因此，长度为 `2 * N` 的不同规则括号序列是非 `N 周期`的是 `14–2 = 12`。
...
2.  对于长度为 `2*N` 的序列是 `N 周期`的，`N` 应该是偶数，因为如果 `N` 是奇数，那么长度为 `2*N` 的序列不能是一个规则序列，同时具有一个 `N 周期`。
