# 计算数组中总和在[a, b]范围内的三元组的数量

> 原文: [https://www.geeksforgeeks.org/count-number-of-triplets-in-an-array-having-sum-in-the-range-a-b/](https://www.geeksforgeeks.org/count-number-of-triplets-in-an-array-having-sum-in-the-range-a-b/)
...
一种天真的方法是运行三个循环来逐个考虑所有的三元组。求每个三元组的和，如果和在给定的范围`[a, b]`内，则增加计数。
以下是上述办法的实施情况:
