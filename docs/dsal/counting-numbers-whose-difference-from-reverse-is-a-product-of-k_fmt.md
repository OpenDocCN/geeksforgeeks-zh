...
> 原文：[https://www.geeksforgeeks.org/counting-numbers-whose-difference-from-reverse-is-a-product-of-k/](https://www.geeksforgeeks.org/counting-numbers-whose-difference-from-reverse-is-a-product-of-k/)
...
对于给定范围内的每个数字，检查该数字与其反向数字之间的差值是否可被 `k` 整除，如果是，则递增计数。
