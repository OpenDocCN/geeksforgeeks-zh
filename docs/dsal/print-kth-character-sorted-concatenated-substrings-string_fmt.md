...
> 原文：[https://www.geeksforgeeks.org/print-kth-character-sorted-concatenated-substrings-string/](https://www.geeksforgeeks.org/print-kth-character-sorted-concatenated-substrings-string/)
...
class suffix:
    def __init__(self):
        ...
        self.rank = [0] * 2  # To store ranks and next
                             # rank pair
