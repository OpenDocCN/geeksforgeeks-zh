...
> 原文: [https://www.geeksforgeeks.org/check-given-power-enough-reach-end-array-please-review/](https://www.geeksforgeeks.org/check-given-power-enough-reach-end-array-please-review/)
...
**有效方法:** 上述方法可以通过使用厄拉多塞的筛来检查一个数是否是素数来优化。
