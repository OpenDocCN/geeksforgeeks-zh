...
> 原文: [https://www.geeksforgeeks.org/smallest-element-from-all-square-submatrices-of-size-k-from-a-given-matrix/](https://www.geeksforgeeks.org/smallest-element-from-all-square-submatrices-of-size-k-from-a-given-matrix/)
...
> **输入:** `K = 3`，
> `arr[][] = { {-1, 5, 4, 1, -3}, {4, 3, 1, 1, 6}, {2, -2, 5, 3, 1}, {8, 5, 1, 9, -4}, {12, 3, 5, 8, 1} }`
> **输出:**
> -2 -2 -3
> -2 -4 -4
...
解决问题最简单的方法是[从给定的矩阵中生成所有可能的大小为 `K` 的正方形子矩阵](https://www.geeksforgeeks.org/given-n-x-n-square-matrix-find-sum-sub-squares-size-k-x-k/)，并从每个这样的子矩阵中打印最小的元素。
...
*   执行上述操作后，矩阵的左上角子矩阵 `(N–K+1)*(M–K+1)` 由给定矩阵的所有 `K x K` 子矩阵的所有最小元素组成。
