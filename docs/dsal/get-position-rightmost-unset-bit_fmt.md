...
> 原文：[https://www.geeksforgeeks.org/get-position-rightmost-unset-bit/](https://www.geeksforgeeks.org/get-position-rightmost-unset-bit/)
...
4.  获取 `num` 最右边设定位的[位置](https://www.geeksforgeeks.org/position-of-rightmost-set-bit/)。这将是 `n` 最右边未置位的位置。
