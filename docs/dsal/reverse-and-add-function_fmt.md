...
**反转加功能**以一个数字开始，反转其数字，并将反转加到原来的数字上。如果总和不是回文，重复这个过程，直到它是回文。

写一个程序，取数字并给出结果回文（如果有的话）。如果需要 1000 次以上的迭代（加法）或产生大于 `4294967295` 的回文，假设给定数字不存在回文。
...
[https://app.assembla.com/spaces/AASU_Fall2008_ProgrammingTeam/wiki](https://app.assembla.com/spaces/AASU_Fall2008_ProgrammingTeam/wiki)
