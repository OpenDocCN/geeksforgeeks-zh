...
> 原文: [https://www.geeksforgeeks.org/common-nodes-in-the-inorder-sequence-of-a-tree-between-given-two-nodes-in-o1-space/](https://www.geeksforgeeks.org/common-nodes-in-the-inorder-sequence-of-a-tree-between-given-two-nodes-in-o1-space/)

给定一个由不同值和两个数字 `K1` 和 `K2` 组成的**二叉树**，任务是按照树的顺序找到它们之间的所有节点。
...
> `1 4`
> **解释:**
> 顺序为 `3 12 1 4 15 11 9 13`，`12` 和 `15` 之间的公共节点是 `1` 和 `4`。
...
> `10 5 77`
> **解释:**
> 顺序为 `61 21 16 23 10 5 77 36`，`23` 和 `3` 之间的公共节点是 `10`、`5` 和 `77`。
