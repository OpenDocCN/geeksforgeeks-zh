...
> 原文：`https://www.geeksforgeeks.org/number-of-cells-in-matrix-which-are-equidistant-from-given-two-points/`

给定一个 `N` 行 `M` 列的矩阵，给定矩阵上的两点；任务是计算与给定两点等距的像元数量。水平方向或垂直方向或两个方向的任何遍历都被认为是有效的，但对角线路径无效。
...
> **输出**: 5
> **说明:**
> 在所有单元格中，这些是点(3，1)；(3, 2);(3, 3);(4, 4);(4，5)满足给定条件。
> **输入:** 4 3
> 2 3
> 4 1
> **输出:** 4
> **解释:**
> 在所有单元格中，这些是点(1，1)；(2, 1);(3, 2);(4，3)满足给定条件。
