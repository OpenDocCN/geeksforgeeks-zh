...
> 原文：[https://www.geeksforgeeks.org/largest-even-and-odd-n-digit-numbers-in-octal-number-system/](https://www.geeksforgeeks.org/largest-even-and-odd-n-digit-numbers-in-octal-number-system/)

给定一个整数 `N`，任务是找出八进制数制中最大的偶数和奇数 `N` 位数。
