...
> 原文：[https://www.geeksforgeeks.org/print-possible-strings-can-made-placing-spaces-2/](https://www.geeksforgeeks.org/print-possible-strings-can-made-placing-spaces-2/)
...
如果我们仔细看一下，可以发现这个问题归结为`功率设置问题`。我们基本上需要生成所有子集，其中每个元素都是不同的空间。
