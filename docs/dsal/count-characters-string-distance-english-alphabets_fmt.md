...
> 原文：[https://www.geeksforgeeks.org/count-characters-string-distance-english-alphabets/](https://www.geeksforgeeks.org/count-characters-string-distance-english-alphabets/)
...
```python
# An optimized Python3 program to find pairs with
# distance equal to English alphabet distance
