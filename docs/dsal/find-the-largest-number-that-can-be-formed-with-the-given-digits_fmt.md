...
> 原文：[https://www.geeksforgeeks.org/find-the-largest-number-that-can-be-formed-with-the-given-digits/](https://www.geeksforgeeks.org/find-the-largest-number-that-can-be-formed-with-the-given-digits/)
...
**朴素方法**：朴素方法是将给定的数字数组按照降序排序，然后使用数组中的数字组成数字，保持数字在数字中的顺序与排序后的数组相同。
