...
> 原文: [https://www.geeksforgeeks.org/find-the-maximum-possible-value-of-ai-aj-over-all-pairs-of-i-and-j/](https://www.geeksforgeeks.org/find-the-maximum-possible-value-of-ai-aj-over-all-pairs-of-i-and-j/)

给定一个正整数数组 `arr[]` 和 `N`。任务是在所有对 `i` 和 `j` 上找到 `a[i] % a[j]` 的最大可能值。
