...
> 原文：[https://www.geeksforgeeks.org/count-and-sum-of-composite-elements-in-an-array/](https://www.geeksforgeeks.org/count-and-sum-of-composite-elements-in-an-array/)
...
**有效方法：** 使用厄拉多塞的[筛生成一个布尔向量](https://www.geeksforgeeks.org/sieve-of-eratosthenes/)[达到数组中最大元素的大小](https://www.geeksforgeeks.org/vector-in-cpp-stl/)，可用于检查一个数是否为素数。另外，将 0 和 1 相加作为质数，这样它们就不会被算作复合数。现在遍历数组，使用生成的布尔向量找到那些复合元素的数量。
以下是上述方法的实施：
