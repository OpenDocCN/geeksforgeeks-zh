...
> 原文: [https://www.geeksforgeeks.org/bitwise-or-of-all-even-number-from-1-to-n/](https://www.geeksforgeeks.org/bitwise-or-of-all-even-number-from-1-to-n/)
...
**有效方法:** 计算 `N` 中的总位数。在按位“或”运算中，最右边的位将为 0，所有其他位将为 1。因此，返回 `pow(2, bitCount) - 2`。它将给出按位“或”的十进制等值。
