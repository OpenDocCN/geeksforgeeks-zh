...
> 原文: [https://www.geeksforgeeks.org/program-to-find-the-centroid-of-the-triangle/](https://www.geeksforgeeks.org/program-to-find-the-centroid-of-the-triangle/)
...
假设一个三角形的顶点是`(x1, y1)`、`(x2, y2)`、`(x3, y3)`，那么这个三角形的质心可以从下面的公式中找到：
