...
> 原文: [https://www.geeksforgeeks.org/number-of-hours-after-which-the-second-person-moves-ahead-of-the-first-person-if-they-travel-at-a-given-speed/](https://www.geeksforgeeks.org/number-of-hours-after-which-the-second-person-moves-ahead-of-the-first-person-if-they-travel-at-a-given-speed/)
...
> 2 小时后，第二个人领先第一个人 1 公里。
>
> **输入:** `A = 6`，`B = 5`，`K = 1`
> **输出:** `-1`

一种天真的做法是线性检查每一个小时，当第二个人移动到第一个人之前时打印第 n 个小时。
一种高效的方法就是用数学方法解决问题。当第二个人移动到第一个人之前时，小时数将为 `K/(B–A)+1`。由于您需要行驶 `K` 公里，因此所花费的时间将是 `K/(B–A)`，其中 `B–A` 是第二个人相对于第一个人的速度。如果 `A >= B` 那么第二个人不可能超越第一个人。
