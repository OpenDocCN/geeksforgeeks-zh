# 检查数组的和是否可以通过将数组元素重复减少它们的索引值而减少到零

> 原文: [https://www.geeksforgeeks.org/check-if-sum-of-array-can-be-reduced-to-zero-by-repetitively-reducing-array-element-by-their-index-value/](https://www.geeksforgeeks.org/check-if-sum-of-array-can-be-reduced-to-zero-by-repetitively-reducing-array-element-by-their-index-value/)
