...
> **输出:** 10
> 可以准备带标记【2】和标记【3】的题目，也可以准备标记【0】和标记【1】。两种情况合计 10 个标记，等于及格分。
> **输入:** n = 5，h = 40，p = 21，mark[]= { 10，10，10，10，3}，time[] = {12，16，20，24，8}
> **输出:** 36

**方法:** 给定的问题是 [0/1 背包](https://www.geeksforgeeks.org/0-1-knapsack-problem-dp-10/)的修改版本，在这个版本中，我们要么考虑拿一个包，要么忽略那个包。这个问题的变化是给我们一个特定题目所用时间和考试最大剩余时间的约束条件。
