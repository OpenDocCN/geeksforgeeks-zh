...
> 原文: [https://www.geeksforgeeks.org/check-if-elements-of-array-can-be-arranged-in-ap-gp-or-hp/](https://www.geeksforgeeks.org/check-if-elements-of-array-can-be-arranged-in-ap-gp-or-hp/)
...
想法是观察三个级数 A.P.、G.P. 或 H.P. 中的任何一个中的元素都与排序顺序有些关系。因此，我们需要首先对给定的数组进行排序。

1.  **对于算术级数:** 检查排序后的[数组](https://www.geeksforgeeks.org/introduction-to-arrays/)的连续元素之间的差异是否相同。如果是，那么给定的[数组](https://www.geeksforgeeks.org/introduction-to-arrays/)元素形成一个**等差数列**。
2.  **对于几何级数:** 检查排序后的[数组](https://www.geeksforgeeks.org/introduction-to-arrays/)的连续元素的比例是否相同。如果是，那么给定的数组元素形成一个**几何级数**。
3.  **对于调和级数:** 检查排序后的[数组](https://www.geeksforgeeks.org/introduction-to-arrays/)的所有连续元素的倒数之差是否相同。如果是，那么给定的数组元素形成一个**调和级数**。
