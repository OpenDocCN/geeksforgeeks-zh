...
> 原文: [https://www.geeksforgeeks.org/sum-square-sums-first-n-natural-numbers/](https://www.geeksforgeeks.org/sum-square-sums-first-n-natural-numbers/)
...
思路是求第一个 `i` 自然数的平方和，其中 `1 <= i <= n`，然后将它们全部相加。
