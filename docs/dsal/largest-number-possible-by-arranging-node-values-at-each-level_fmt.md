...
> 原文: [https://www.geeksforgeeks.org/largest-number-possible-by-arranging-node-values-at-each-level/](https://www.geeksforgeeks.org/largest-number-possible-by-arranging-node-values-at-each-level/)
...
*   使用[层序遍历](https://www.geeksforgeeks.org/level-order-tree-traversal/)来逐一遍历每个级别的所有节点。
*   将它们的值存储在一个字符串向量中。
*   使用[比较方法](https://www.geeksforgeeks.org/given-an-array-of-numbers-arrange-the-numbers-to-form-the-biggest-number/)对向量进行排序，以生成尽可能大的数字。
*   显示数字并重复所有级别的处理过程。
