...
> 原文：[https://www.geeksforgeeks.org/radii-of-the-three-tangent-circles-of-equal-radius-which-are-inscribed-within-a-circle-of-given-radius/](https://www.geeksforgeeks.org/radii-of-the-three-tangent-circles-of-equal-radius-which-are-inscribed-within-a-circle-of-given-radius/)
...
*   设切圆的半径为 `r`，外接圆的半径为 `R`。`x` 是切圆圆周到外接圆中心的较小距离。
*   从图上看，很明显，`2r + x = R`
*   现在在三角 `OBC` 中，`cos 30 = r/(r+x)`，即 `r cos 30 + x cos 30 = r`
*   所以，`x = r(1 - cos30) / cos30`
*   同样，`x = R - 2r`
*   所以，`R - 2r = R(1 - cos30) / cos30`
    `R - 2r = 0.133 R / 0.867`
    `R - 2r = 0.153 R`
    `R = 2.153 R`
    所以，`r = 0.4645R`
