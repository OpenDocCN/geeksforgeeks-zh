...
> 原文：[https://www.geeksforgeeks.org/number-of-subarrays-required-to-be-rearranged-to-sort-the-given-array/](https://www.geeksforgeeks.org/number-of-subarrays-required-to-be-rearranged-to-sort-the-given-array/)

给定一个由前 `N` 个[自然数](https://www.geeksforgeeks.org/natural-numbers/)组成的[数组](https://www.geeksforgeeks.org/introduction-to-arrays/) `arr[]`，任务是找到需要重新排列的最小数量的子数组，从而对最终的[数组进行排序](https://www.geeksforgeeks.org/program-check-array-sorted-not-iterative-recursive/)。
...
*   否则，对两个子阵列进行排序，即 `arr[1, N-1]` 和 `arr[0, N-2]`。
