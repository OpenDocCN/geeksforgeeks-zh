...
> 原文: [https://www.geeksforgeeks.org/find-the-sum-of-the-series-2-5-13-35-97/](https://www.geeksforgeeks.org/find-the-sum-of-the-series-2-5-13-35-97/)
...
从这个给定的数列中，我们发现它是两个具有共同比率 2，3 的 **GP** 数列的和。

> `sn = 2+5+13+35+97……+第 n 项`
> `sn = (2^0+3^0)+(2^1+3^1)+(2^2+3^2)+(2^3+3^3)+(2^4+3^4)……+第 n 项`
> `sn = (2^0+2^1+2^2+2^3+2^4……+第 n 项)+(3^0+3^1+3^2+3^3……+第 n 项)`
