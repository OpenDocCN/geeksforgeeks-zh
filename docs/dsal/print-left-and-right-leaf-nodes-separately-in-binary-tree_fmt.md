...
> 原文: [https://www.geeksforgeeks.org/print-left-and-right-leaf-nodes-separately-in-binary-tree/](https://www.geeksforgeeks.org/print-left-and-right-leaf-nodes-separately-in-binary-tree/)
...
*   对于在右侧和左侧的每个遍历，使用参数`type`发送关于子对象(左侧或右侧子对象)的信息。下降到左分支时设置 `type = 0`，右分支时设置 `type = 1`。
