...
> 原文: [https://www.geeksforgeeks.org/check-if-an-integer-is-rotation-of-another-given-integer/](https://www.geeksforgeeks.org/check-if-an-integer-is-rotation-of-another-given-integer/)
...
*   现在，迭代并执行以下操作:
    *   如果 `A` 等于 `B` 和[断开](https://www.geeksforgeeks.org/program-count-digits-integer-3-different-methods/)，则打印`“是”`。
