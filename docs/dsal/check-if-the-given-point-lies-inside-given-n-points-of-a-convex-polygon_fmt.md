...
> 原文: [https://www.geeksforgeeks.org/check-if-the-given-point-lies-inside-given-n-points-of-a-convex-polygon/](https://www.geeksforgeeks.org/check-if-the-given-point-lies-inside-given-n-points-of-a-convex-polygon/)
...
想法是使用[格雷厄姆扫描算法](https://www.geeksforgeeks.org/convex-hull-set-2-graham-scan/)来发现给定点是否位于凸多边形内。以下是一些观察结果:
