...
> 原文: [https://www.geeksforgeeks.org/sort-a-string-according-to-the-frequency-of-characters/](https://www.geeksforgeeks.org/sort-a-string-according-to-the-frequency-of-characters/)
...
> 因此最终输出为 `for ggk seee`
> **输入:** `str = "abc"`
> **输出:** `abc`

## 逼近

思路是将每个字符及其频率存储在一个 `vector pair` 中，然后[根据存储的频率对向量对](https://www.geeksforgeeks.org/sorting-vector-of-pairs-in-c-set-1-sort-by-first-and-second/)进行排序。最后，按顺序打印矢量。
