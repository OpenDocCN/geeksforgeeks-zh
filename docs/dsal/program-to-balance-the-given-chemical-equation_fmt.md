...
> 原文: [https://www.geeksforgeeks.org/program-to-balance-the-given-chemical-equation/](https://www.geeksforgeeks.org/program-to-balance-the-given-chemical-equation/)
...
任务是找到常数 `b1`，`b2`，`b3` 的值，使得方程式两边平衡，且必须是简化形式。
