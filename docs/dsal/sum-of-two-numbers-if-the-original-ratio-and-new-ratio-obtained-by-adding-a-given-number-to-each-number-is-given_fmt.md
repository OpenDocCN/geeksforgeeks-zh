...
> 原文: [https://www.geeksforgeeks.org/sum-of-two-numbers-if-the-original-ratio-and-new-ratio-obtained-by-adding-a-given-number-to-each-number-is-given/](https://www.geeksforgeeks.org/sum-of-two-numbers-if-the-original-ratio-and-new-ratio-obtained-by-adding-a-given-number-to-each-number-is-given/)
...
让数字之和为 `S`。那么，数字可以是 `(a * S)/(a + b)` 和 `(b * S)/(a + b)`。
现在，如给定的:
