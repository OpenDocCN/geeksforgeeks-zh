...
> 原文：[https://www.geeksforgeeks.org/binary-representation-next-greater-number-number-1s-0s/](https://www.geeksforgeeks.org/binary-representation-next-greater-number-number-1s-0s/)
...
这个问题简单地归结为寻找给定字符串的下一个排列。我们可以找到输入二进制数的 [`next_arrangement()`](https://www.geeksforgeeks.org/find-the-next-lexicographically-greater-word-than-a-given-word/)。
