...
> 原文: [https://www.geeksforgeeks.org/biggest-reuleaux-triangle-inscribed-within-a-square-which-is-inscribed-within-an-ellipse/](https://www.geeksforgeeks.org/biggest-reuleaux-triangle-inscribed-within-a-square-which-is-inscribed-within-an-ellipse/)

给定一个椭圆，其长轴和短轴分别为 `2a` 和 `2b`，该椭圆画出一个正方形，该正方形又画出一个三角形。任务是找到这个 reuleaux 三角形的最大可能面积。
