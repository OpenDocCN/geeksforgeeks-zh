...
> 原文: [https://www.geeksforgeeks.org/sieve-sundaram-print-primes-smaller-n/](https://www.geeksforgeeks.org/sieve-sundaram-print-primes-smaller-n/)
...
我们已经针对上述任务讨论了厄拉多塞算法的[筛](https://www.geeksforgeeks.org/sieve-of-eratosthenes/)。下图是 Sundaram 算法的筛子。
...
4) // Mark all numbers of the form i + j + 2ij as true
   ...
   Loop for i=1 to nNew
        ...
        b) Loop While (i + j + 2*i*j) <= nNew
             Mark marked[i + j + 2*i*j] as true.
             j++;

5) Print 2 (as it is a prime)

6) For i = 1 to nNew
       If marked[i] is false, then print 2*i + 1
```
