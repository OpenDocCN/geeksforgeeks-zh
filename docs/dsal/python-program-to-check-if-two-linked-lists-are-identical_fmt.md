...
> 原文：[https://www.geeksforgeeks.org/python-program-to-check-if-two-linked-lists-are-identical/](https://www.geeksforgeeks.org/python-program-to-check-if-two-linked-lists-are-identical/)
