...
> 原文: [https://www.geeksforgeeks.org/sum-of-width-max-and-min-diff-of-all-subsequences/](https://www.geeksforgeeks.org/sum-of-width-max-and-min-diff-of-all-subsequences/)
...
思路是先，**排序**数组作为排序数组不会影响最终答案。排序后，这让我们知道最小 `A[i]` 最大 `A[j]` 的子序列数将为 `2^(j-i-1)`。
因此，我们的答案归结为发现:
