...
> 原文:[https://www.geeksforgeeks.org/introduction-to-tree-data-structure/](https://www.geeksforgeeks.org/introduction-to-tree-data-structure/)
...
一棵树由一个根和零个或多个子树 `T1`、`T2`、…、`Tk` 组成，这样从树根到每个子树的根都有一条边。
...
*   **后代:** 从叶节点到该节点的路径上的任何后继节点。`7`、`14` 是节点 `2` 的后代。
