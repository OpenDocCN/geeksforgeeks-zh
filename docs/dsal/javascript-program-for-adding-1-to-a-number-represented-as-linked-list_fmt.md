...
> 原文: [https://www.geeksforgeeks.org/javascript-program-for-adding-1-to-a-number-represented-as-linked-list/](https://www.geeksforgeeks.org/javascript-program-for-adding-1-to-a-number-represented-as-linked-list/)
...
function addOneUtil(head) {
    ...
    while (head != null) {
        // Calculate value of next digit in resultant list. The next digit is
