...
> 原文: [https://www.geeksforgeeks.org/sum-of-first-n-terms-of-quadratic-sequence-3-7-13/](https://www.geeksforgeeks.org/sum-of-first-n-terms-of-quadratic-sequence-3-7-13/)
...
在上面的系列中，除了 3，从 4 到 `(TN–TN-1)` 的项将形成 A.P.，因为 A.P 的 `n` 个项之和的公式为:
