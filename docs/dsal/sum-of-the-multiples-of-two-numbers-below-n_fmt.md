...
> 原文：[https://www.geeksforgeeks.org/sum-of-the-multiples-of-two-numbers-below-n/](https://www.geeksforgeeks.org/sum-of-the-multiples-of-two-numbers-below-n/)
...
所以总计 `sum = sum1 + sum2`，但是可能有两者都通用的和数，
