...
我们在[之前的文章](https://www.geeksforgeeks.org/largest-sub-string-where-all-the-characters-appear-at-least-k-times/)中讨论了朴素方法。

## 方法

在本文中，我们将讨论使用[分治](https://www.geeksforgeeks.org/divide-and-conquer-algorithm-introduction/)技术和[递归](https://www.geeksforgeeks.org/recursion/)的方法。 步骤如下：
