...
> 原文：[https://www.geeksforgeeks.org/generate-all-binary-strings-of-length-n-with-sub-string-01-appearing-exactly-twice/](https://www.geeksforgeeks.org/generate-all-binary-strings-of-length-n-with-sub-string-01-appearing-exactly-twice/)
...
> **输出：**
> 0101
> “0101”是长度为 4 的唯一二进制字符串，其中包含的“01”正好是子字符串的两倍。
>
> **输入：** `N = 5`
> **输出：**
> 00101
