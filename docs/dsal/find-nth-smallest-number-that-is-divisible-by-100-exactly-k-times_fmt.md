...
> 原文: [https://www.geeksforgeeks.org/find-nth-smallest-number-that-is-divisible-by-100-exactly-k-times/](https://www.geeksforgeeks.org/find-nth-smallest-number-that-is-divisible-by-100-exactly-k-times/)
...
> **输入:** `N = 12`，`K = 2`
> **输出:** `120000`
> `120000` 正好被 100 整除 2 次，也是第 12 个最小的数。
> **输入:** `N = 1000`，`K = 2`
> **输出:** `10010000`
