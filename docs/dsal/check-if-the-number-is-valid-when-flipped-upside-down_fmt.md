...
> 原文：[https://www.geeksforgeeks.org/check-if-the-number-is-valid-when-flipped-upside-down/](https://www.geeksforgeeks.org/check-if-the-number-is-valid-when-flipped-upside-down/)
...
只有 `1`、`3` 和 `8` 这几个数字，在颠倒过来的时候，才能形成另一个有效数字。如果数字中包含这些数字以外的数字，则打印“否”，否则打印“是”。
