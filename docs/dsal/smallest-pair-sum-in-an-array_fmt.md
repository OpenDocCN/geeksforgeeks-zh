...
> 原文: [https://www.geeksforgeeks.org/smallest-pair-sum-in-an-array/](https://www.geeksforgeeks.org/smallest-pair-sum-in-an-array/)
...
*   从数组中找到第二个最小元素，并将其存储在 `secondMin` 中。
*   打印 `min + secondMin`。
