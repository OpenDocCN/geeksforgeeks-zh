...
> 原文：[https://www.geeksforgeeks.org/number-n-digit-stepping-numbers/](https://www.geeksforgeeks.org/number-n-digit-stepping-numbers/)
...
[n 位步进数个数|空间优化解](https://www.geeksforgeeks.org/number-of-n-digit-stepping-numbers-space-optimized-solution/)