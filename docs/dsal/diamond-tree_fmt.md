...
1.  首先使用[级顺序遍历](https://www.geeksforgeeks.org/level-order-tree-traversal/)创建`K`级[平衡二叉树](https://www.geeksforgeeks.org/binary-tree-set-3-types-of-binary-tree/)，并给出从 1 开始并从左向右递增的值。
