...
> 原文: [https://www.geeksforgeeks.org/print-level-order-traversal-line-line/](https://www.geeksforgeeks.org/print-level-order-traversal-line-line/)
...
一个简单的解决方案是使用[级顺序遍历帖子](https://www.geeksforgeeks.org/level-order-tree-traversal/)中讨论的递归函数进行打印，并在每次调用 `printGivenLevel()` 后打印一个新行。
