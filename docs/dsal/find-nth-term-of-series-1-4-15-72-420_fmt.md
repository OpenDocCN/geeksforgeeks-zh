...
> 原文: [https://www.geeksforgeeks.org/find-nth-term-of-series-1-4-15-72-420/](https://www.geeksforgeeks.org/find-nth-term-of-series-1-4-15-72-420/)

给定一个数字 `N`。任务是编写一个程序来查找下面系列中的第 `N` 个项:
