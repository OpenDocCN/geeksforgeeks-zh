...
> 原文：[https://www.geeksforgeeks.org/proto-van-emde-boas-tree-set-5-queries-minimum-maximum/](https://www.geeksforgeeks.org/proto-van-emde-boas-tree-set-5-queries-minimum-maximum/)
...
2.  **递归：**
    ...
    *   最后，我们将根据我们在 `summary` 上从过程中获得的簇号和我们在最后一步中在簇上从过程中获得的位置返回该键的索引。
