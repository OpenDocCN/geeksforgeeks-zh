...
> 原文: [https://www.geeksforgeeks.org/print-nodes-in-top-view-of-binary-tree-set-2/](https://www.geeksforgeeks.org/print-nodes-in-top-view-of-binary-tree-set-2/)
...
```python
# Python3 Program to print Top View of
