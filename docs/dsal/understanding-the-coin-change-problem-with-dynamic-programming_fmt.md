...
> 原文: [https://www.geeksforgeeks.org/understanding-the-coin-change-problem-with-dynamic-programming/](https://www.geeksforgeeks.org/understanding-the-coin-change-problem-with-dynamic-programming/)
...
假设给你 `1` 分钱、`5` 分钱、`10` 分钱的硬币，`N = 8` 分钱，你能安排获得 `8` 分钱的硬币组合总数是多少。
...
假设给你 `1` 美分、`5` 美分、`10` 美分的硬币，`N = 10` 美分，你能安排获得 `10` 美分的硬币组合总数是多少。
