...
> 原文: [https://www.geeksforgeeks.org/replace-every-node-with-depth-in-n-ary-generic-tree/](https://www.geeksforgeeks.org/replace-every-node-with-depth-in-n-ary-generic-tree/)
...
class GFG {
    ...
    // Function to replace with depth
    static void replaceWithDepthValue(TreeNode<Integer> root) {
        helper(root, 0);
    }
    ...
    public static void main(String[] args) {
        // Given level order traversal in
        // the array arr[]
        int arr[] = {10, 3, 20, 30, 40, 2, 40, 50, 0, 0, 0, 0};
    ...
    while (pendingNodes.size() != 0) {
        ...
        while (size > 0) {
            ...
            for (int i = 0; i < numChild; i++) {
                ...
                TreeNode<int>* child = new TreeNode<int>(depthLevel);
