...
> 原文: [https://www.geeksforgeeks.org/total-number-of-cells-covered-in-a-matrix-after-d-days/](https://www.geeksforgeeks.org/total-number-of-cells-covered-in-a-matrix-after-d-days/)
...
因此，考虑到四边形的边界，总答案将是 `D` 天后所有四边形细胞的总和+沿顶部、右侧、下侧、左侧和 1(起始细胞)的总细胞。
以下是向四个方向延伸的条件:
