...
给定一个编号 `N`，任务是找到第 `N` 个 [Icosihexagon 编号](https://en.wikipedia.org/wiki/Icosihexagon)。
...
*   因此 26 边多边形的第 `n` 项为
> ![T_n =\frac{((26-2)n^2 - (26-4)n)}{2} =\frac{(24n^2 - 22n)}{2}](img/4f0a18d595d1f7b4912311ddaef9f316.png "Rendered by QuickLaTeX.com")
...
**参考资料:** [https://en.wikipedia.org/wiki/Icosihexagon](https://en.wikipedia.org/wiki/Icosihexagon)