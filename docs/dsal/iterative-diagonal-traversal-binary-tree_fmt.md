...
> 原文：[https://www.geeksforgeeks.org/iterative-diagonal-traversal-binary-tree/](https://www.geeksforgeeks.org/iterative-diagonal-traversal-binary-tree/)
...
不使用分隔符，就像级别顺序遍历一样，使用队列。几乎没有要做的修改。
