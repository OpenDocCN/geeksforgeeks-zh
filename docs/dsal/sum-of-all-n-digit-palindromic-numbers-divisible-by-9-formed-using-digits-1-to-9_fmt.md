...
> 原文: [https://www.geeksforgeeks.org/sum-of-all-n-digit-palindromic-numbers-divisible-by-9-formed-using-digits-1-to-9/](https://www.geeksforgeeks.org/sum-of-all-n-digit-palindromic-numbers-divisible-by-9-formed-using-digits-1-to-9/)
...
问题中的关键观察是[如果一个数能被 9 整除，那么这个数的位数之和也能被 9 整除](https://www.geeksforgeeks.org/check-large-number-divisible-9-not/)。另一个观察是，如果我们用 1 到 9 的数字来计算 N 位回文数字的数量，那么可以观察到
...
3.  如果 `N > 2`，那么第 `N` 位可被 9 整除的回文数字之和为
