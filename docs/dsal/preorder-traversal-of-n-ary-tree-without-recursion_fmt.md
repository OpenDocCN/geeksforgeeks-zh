...
> 原文: [https://www.geeksforgeeks.org/preorder-traversal-of-n-ary-tree-without-recursion/](https://www.geeksforgeeks.org/preorder-traversal-of-n-ary-tree-without-recursion/)

给定一个 n 元树，打印它的前序遍历。

**示例:**

> 下树的前序遍历是 `A B K N M J F D G E C H I L`
> 
> ![](img/42ef427450c10d39d2222412a85c2c79.png)

其思想是使用类似[迭代二叉树的前序遍历](https://www.geeksforgeeks.org/iterative-preorder-traversal/)的栈。
1) 创建一个空堆栈来存储节点。
2) 将根节点推送到堆栈。
3) 当堆栈不为空时运行一个循环
    …。a) 从堆栈中弹出顶部节点。
