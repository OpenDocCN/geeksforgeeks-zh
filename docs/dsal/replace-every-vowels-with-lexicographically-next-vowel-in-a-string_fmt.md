...
> 原文：[https://www.geeksforgeeks.org/replace-every-vowels-with-lexicographically-next-vowel-in-a-string/](https://www.geeksforgeeks.org/replace-every-vowels-with-lexicographically-next-vowel-in-a-string/)

给定字符串大小为 `N` 的字符串，其中包含小写英文字母。任务是用词典学上的下一个直接元音替换每个元音，即，
