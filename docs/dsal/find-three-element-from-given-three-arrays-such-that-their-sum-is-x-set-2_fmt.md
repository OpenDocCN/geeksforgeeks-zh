...
> 原文: [https://www.geeksforgeeks.org/find-three-element-from-given-three-arrays-such-that-their-sum-is-x-set-2/](https://www.geeksforgeeks.org/find-three-element-from-given-three-arrays-such-that-their-sum-is-x-set-2/)
...
> **情况 2:** 在较小的两个数组上应用两个指针
> 迭代次数的顺序将是= `len(A)*(len(B)+len(C))= 100000 *(10000+10)= 1001000000`
