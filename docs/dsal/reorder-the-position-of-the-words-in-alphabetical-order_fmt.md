...
> 原文：[https://www.geeksforgeeks.org/reorder-the-position-of-the-words-in-alphabetical-order/](https://www.geeksforgeeks.org/reorder-the-position-of-the-words-in-alphabetical-order/)
...
> **输入：** `arr[] = {"zxc", "efg", "jkl"}`
> **输出：** 2 3 1
> 排序后的列表将为 `{"EFG", "jkl", "zxc"}`，它们的原始位置分别为 2、3 和 1。
