...
> 原文：[https://www.geeksforgeeks.org/minimum-swaps-to-group-similar-characters-side-by-side/](https://www.geeksforgeeks.org/minimum-swaps-to-group-similar-characters-side-by-side/)
...
递归为 `T(n) = 2n*T(n-1) + O(n)`，所以时间复杂度大于 `O((2*n)！)`。