...
> 原文: [https://www.geeksforgeeks.org/check-whether-the-binary-equivalent-of-a-number-ends-with-001-or-not/](https://www.geeksforgeeks.org/check-whether-the-binary-equivalent-of-a-number-ends-with-001-or-not/)
...
> **输出**: 是
> **解释**
> 9 的二进制是 `1001`，以 `001` 结束
> **输入** : `N = 5`
> **输出**: 否
> 5 的二进制是 `101`，不以 `001` 结束
...
> **图解:**
> 序列 `1、9、17、25、33……`在其二进制表示中有 `001` 作为后缀。
> 上述序列的第 `N` 项用 `8 * N + 1` 表示，所以只有当 `(N–1) % 8 == 0` 时，一个数的二进制等价物才以“001”结束
