...
> 原文: [https://www.geeksforgeeks.org/average-of-first-n-odd-naturals-numbers/](https://www.geeksforgeeks.org/average-of-first-n-odd-naturals-numbers/)
...
思路是前 `n` 个奇数的[和为 `n^2`](https://www.geeksforgeeks.org/sum-first-n-odd-numbers-o1-complexity/)，求前 `n` 个奇数的平均值，所以除以 `n`，因此公式为 `n^2 / n = n`。这需要 `O(1)` 时间。
...
Avg of first n odd numbers = n^2/n
                           = n
```