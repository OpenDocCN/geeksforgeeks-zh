...
> 原文: [https://www.geeksforgeeks.org/check-whether-given-circle-reside-boundary-maintained-outer-circle-inner-circle/](https://www.geeksforgeeks.org/check-whether-given-circle-reside-boundary-maintained-outer-circle-inner-circle/)
...
是计算圆心 `(0，0)` 与被检圆坐标的距离。如果距离+半径(待检圆)小于或等于外半径，距离-半径(待检圆)大于或等于外圆半径-内圆半径，则符合。
