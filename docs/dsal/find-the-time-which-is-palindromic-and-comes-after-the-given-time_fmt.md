...
> 原文: [https://www.geeksforgeeks.org/find-the-time-which-is-palindromic-and-comes-after-the-given-time/](https://www.geeksforgeeks.org/find-the-time-which-is-palindromic-and-comes-after-the-given-time/)
...
2.  如果 `HH = 23` 且 `MM ≥ 32`，则输出为 `00:00`，即上午 12:00。
