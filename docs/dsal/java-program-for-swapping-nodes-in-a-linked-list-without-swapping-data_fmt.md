...
> 原文: [https://www.geeksforgeeks.org/java-program-for-swapping-nodes-in-a-linked-list-without-swapping-data/](https://www.geeksforgeeks.org/java-program-for-swapping-nodes-in-a-linked-list-without-swapping-data/)
...
class LinkedList {
    ...
    public void swapNodes(int x, int y) {
        ...
        // prevX and currX for x
        // prevY and currY for y
    ...
    public static void main(String args[]) {
        ...
        // Create linked list 10->15->12->13->20->14
        llist.push(14);
        llist.push(20);
        llist.push(13);
        llist.push(12);
...
```
Linked list before calling swapNodes() 10 15 12 13 20 14 
Linked list after calling swapNodes() 10 15 20 13 12 14 
```
