...
> 原文: [https://www.geeksforgeeks.org/generate-quadratic-equation-having-given-sum-and-product-of-roots/](https://www.geeksforgeeks.org/generate-quadratic-equation-having-given-sum-and-product-of-roots/)
...
> **输出:** `1 -5 6`
> **说明:**
> 对于二次方程 `x^2–5x+6 = 0`。方程的根是 `2` 和 `3`。所以根的和是 `2 + 3 = 5`，根的积是 `2*3 = 6`。
>
> **输入:** `S = -2`，`M = 1`
> **输出:** `1 2 1`
