...
> 原文: [https://www.geeksforgeeks.org/shortest-job-first-or-sjf-cpu-scheduling-non-preemptive-algorithm-using-segment-tree/](https://www.geeksforgeeks.org/shortest-job-first-or-sjf-cpu-scheduling-non-preemptive-algorithm-using-segment-tree/)
...
4.  在计算之后，在数组中更新相应的时间，并且在段树基数组中将所执行的过程的突发时间设置为无穷大，从而在进一步的查询中不将其视为最小突发时间。
...
*   该算法的性能优于[本文中提到的方法](https://www.geeksforgeeks.org/program-for-shortest-job-first-or-sjf-cpu-scheduling-set-1-non-preemptive/)，因为它需要 `O(N^2)` 来执行。