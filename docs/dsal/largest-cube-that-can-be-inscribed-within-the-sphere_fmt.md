...
> 原文: [https://www.geeksforgeeks.org/largest-cube-that-can-be-inscribed-within-the-sphere/](https://www.geeksforgeeks.org/largest-cube-that-can-be-inscribed-within-the-sphere/)

这里给定的是一个半径为 `r` 的球体，任务是找到可以放入其中的最大立方体的边长。
