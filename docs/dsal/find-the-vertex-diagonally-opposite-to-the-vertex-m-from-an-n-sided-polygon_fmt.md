...
> 原文：[https://www.geeksforgeeks.org/find-the-vertex-diagonally-opposite-to-the-vertex-m-from-an-n-sided-polygon/](https://www.geeksforgeeks.org/find-the-vertex-diagonally-opposite-to-the-vertex-m-from-an-n-sided-polygon/)

给定两个整数 `N` 和 `M`，任务是找到一个 `N` 边多边形的与 `M` 顶点对角相对的顶点。
