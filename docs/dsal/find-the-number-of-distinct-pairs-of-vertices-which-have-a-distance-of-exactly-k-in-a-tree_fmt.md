...
> 原文: [https://www.geeksforgeeks.org/find-the-number-of-distinct-pairs-of-vertices-which-have-a-distance-of-exactly-k-in-a-tree/](https://www.geeksforgeeks.org/find-the-number-of-distinct-pairs-of-vertices-which-have-a-distance-of-exactly-k-in-a-tree/)
...
然后我们计算答案。对于任何顶点 `v`，对的数量将是 `j` 级和 `k-j` 级顶点数量的乘积。
