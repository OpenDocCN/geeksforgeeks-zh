...
> 原文: [https://www.geeksforgeeks.org/program-to-calculate-the-perimeter-of-a-decagon/](https://www.geeksforgeeks.org/program-to-calculate-the-perimeter-of-a-decagon/)

给定十边形的边`S`，任务是找出十边形的周长。
