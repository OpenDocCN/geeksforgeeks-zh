...
> 原文：[https://www.geeksforgeeks.org/implement-stack-queue-using-deque/](https://www.geeksforgeeks.org/implement-stack-queue-using-deque/)
...
// Class for a node of deque
    public class DQueNode {
        public int value;
        public DQueNode next;
        public DQueNode prev;
    }
