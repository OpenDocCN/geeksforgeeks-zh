...
> 原文: [https://www.geeksforgeeks.org/min-max-product-tree-of-a-given-binary-tree/](https://www.geeksforgeeks.org/min-max-product-tree-of-a-given-binary-tree/)
...
最小-最大乘积树包含其左右子树在每个节点的最小值和最大值的乘积。

## 注意

对于只有一个子节点的任何节点，该子节点的值将被视为最小值和最大值。
