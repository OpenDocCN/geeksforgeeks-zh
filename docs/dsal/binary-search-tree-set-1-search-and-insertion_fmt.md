...
> 原文：[https://www.geeksforgeeks.org/binary-search-tree-set-1-search-and-insertion/](https://www.geeksforgeeks.org/binary-search-tree-set-1-search-and-insertion/)

以下是根据[维基百科](http://en.wikipedia.org/wiki/Binary_search_tree)对二叉查找树（BST）的定义：二叉查找树是一个基于节点的二叉树数据结构，具有以下性质：
...
*   [`BST` 上的所有文章](https://www.geeksforgeeks.org/binary-search-tree/)
