...
> 原文: [https://www.geeksforgeeks.org/the-knights-tour-problem-backtracking-1/](https://www.geeksforgeeks.org/the-knights-tour-problem-backtracking-1/)
...
### 时间复杂度:
有 `n` 个 <sup>2</sup> 细胞，对于每个细胞，我们最多有 8 个可能的招式可供选择，所以最差的运行时间是 `O(8个N^2)`。
...
参考文献:
[http://see.stanford.edu/materials/icspacs106b/H19-RecBacktrackExamples.pdf](http://see.stanford.edu/materials/icspacs106b/H19-RecBacktrackExamples.pdf)
[http://www.cis.upenn.edu/~matuszek/cit594-2009/Lectures/35-backtracking.ppt](http://www.cis.upenn.edu/~matuszek/cit594-2009/Lectures/35-backtracking.ppt)
