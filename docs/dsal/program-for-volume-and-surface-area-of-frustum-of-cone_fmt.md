...
> 原文: [https://www.geeksforgeeks.org/program-for-volume-and-surface-area-of-frustum-of-cone/](https://www.geeksforgeeks.org/program-for-volume-and-surface-area-of-frustum-of-cone/)
...
其在半径 `R` 的底部具有圆形基部，圆形上部具有半径 `r`、高度 `h` 和倾斜高度 `l`。
