...
> 原文:[https://www.geeksforgeeks.org/generate-largest-n-digit-number-from-0-in-k-steps-by-incrementing-x-or-multiplying-by-y/](https://www.geeksforgeeks.org/generate-largest-n-digit-number-from-0-in-k-steps-by-incrementing-x-or-multiplying-by-y/)
                        ...
                        int currentValue)
{
    ...
    // if current value already becomes equal
