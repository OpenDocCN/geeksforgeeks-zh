...
给定一个数字 `N`，任务是找到第 `N` 个[赫克塔贡数](https://en.wiktionary.org/wiki/hectagon)。

> 一个[赫克塔贡数](https://en.wiktionary.org/wiki/hectagon)是一类合数。它有一个 100 边的多边形，叫做赫克塔贡。第 `N` 个点的个数是 100 个点的个数，所有其他点都被一个公共的共享角包围并形成一个图案。最初的几个赫克塔贡数是 `1，100，297，592……`
...
*   因此 100 边多边形的第 `n` 项为
    > ![T_n =\frac{((100-2)n^2 - (100-4)n)}{2} =\frac{(98n^2 - 96n)}{2}](img/f81106daf3b8b4ff175c3ad31c9bfc00.png "Rendered by QuickLaTeX.com")
...
**参考资料:** [https://en.wiktionary.org/wiki/hectagon](https://en.wiktionary.org/wiki/hectagon)