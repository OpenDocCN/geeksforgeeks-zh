...
> 原文: [https://www.geeksforgeeks.org/rank-of-all-elements-in-a-stream-in-descending-order-when-they-arrive/](https://www.geeksforgeeks.org/rank-of-all-elements-in-a-stream-in-descending-order-when-they-arrive/)
...
**时间复杂度:** `O(N^2)`，其中 `N` 为阵长。
**空间复杂度:** `O(1)`

## 高效方法:

思路是用[二分搜索法](https://www.geeksforgeeks.org/binary-search/)来求数字的秩。它将给出大于给定数字的数字计数。
以下是上述方法的实施:
