...
> 原文：[https://www.geeksforgeeks.org/sort-m-elements-of-given-circular-array-starting-from-index-k/](https://www.geeksforgeeks.org/sort-m-elements-of-given-circular-array-starting-from-index-k/)

给定一个大小为 `N` 的[圆形数组](https://www.geeksforgeeks.org/circular-array/) `arr[]` 和两个整数 `K` 和 `M`，任务是从索引 `K` 开始排序 `M` 个数组元素。
