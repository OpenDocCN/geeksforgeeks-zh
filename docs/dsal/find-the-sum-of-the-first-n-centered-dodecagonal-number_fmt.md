...
> 原文: [https://www.geeksforgeeks.org/find-the-sum-of-the-first-n-centered-dodecagonal-number/](https://www.geeksforgeeks.org/find-the-sum-of-the-first-n-centered-dodecagonal-number/)
...
1.  首先，创建一个函数来帮助我们计算第 `N` 个[中心十二边形数](https://www.geeksforgeeks.org/centered-dodecagonal-number/)。
