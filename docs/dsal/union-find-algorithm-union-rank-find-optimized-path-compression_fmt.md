...
`find`函数需要2个映射才能得到节点8的根。映射如下所示：
从节点8开始，跳过节点5、节点6和节点7，到达节点4。
从节点4，跳过节点2，到达节点0。
...
最后，我们看到`find`函数只需要1个映射就可以得到节点8的根。映射如下所示：
从节点8开始，跳过节点5、节点6、节点7、节点4和节点2，到达节点0。
