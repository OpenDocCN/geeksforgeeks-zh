...
我们已经在[两个水罐难题](https://www.geeksforgeeks.org/two-water-jug-puzzle/)中讨论了一个解决方案，在这篇文章中讨论了一个基于 [BFS](https://www.geeksforgeeks.org/breadth-first-traversal-for-a-graph/) 的解决方案。
