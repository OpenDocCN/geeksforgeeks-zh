...
> 原文: [https://www.geeksforgeeks.org/find-number-of-substrings-of-length-k-whose-sum-of-ascii-value-of-characters-is-divisible-by-k/](https://www.geeksforgeeks.org/find-number-of-substrings-of-length-k-whose-sum-of-ascii-value-of-characters-is-divisible-by-k/)
...
首先求出长度为 `k` 的第一个子串的字符的 ASCII 值之和，然后利用滑动窗口技术减去前一个子串的第一个字符的 ASCII 值，再加上当前字符的 ASCII 值。如果和能被 `k` 整除，我们将在每一步增加计数器。
