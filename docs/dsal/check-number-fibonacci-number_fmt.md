...
> 原文: [https://www.geeksforgeeks.org/check-number-fibonacci-number/](https://www.geeksforgeeks.org/check-number-fibonacci-number/)
...
*当且仅当(`5*n^2 + 4`)或(`5 * n^2 - 4`)中的一个或两个是完美正方形*（来源: [Wiki](http://en.wikipedia.org/wiki/Fibonacci_number#Recognizing_Fibonacci_numbers)）时，一个数就是斐波那契数。下面是一个基于这个概念的简单程序。
