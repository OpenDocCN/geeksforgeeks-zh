...
> 原文: [https://www.geeksforgeeks.org/check-if-frequency-of-each-digit-in-a-number-is-equal-to-its-value/](https://www.geeksforgeeks.org/check-if-frequency-of-each-digit-in-a-number-is-equal-to-its-value/)
