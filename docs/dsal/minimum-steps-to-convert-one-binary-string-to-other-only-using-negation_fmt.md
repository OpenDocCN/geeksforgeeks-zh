...
> 原文: [https://www.geeksforgeeks.org/minimum-steps-to-convert-one-binary-string-to-other-only-using-negation/](https://www.geeksforgeeks.org/minimum-steps-to-convert-one-binary-string-to-other-only-using-negation/)
