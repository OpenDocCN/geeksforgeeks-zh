...
> 原文：[https://www.geeksforgeeks.org/check-if-it-is-possible-to-serve-customer-queue-with-different-notes/](https://www.geeksforgeeks.org/check-if-it-is-possible-to-serve-customer-queue-with-different-notes/)
...
记录 Rs 的数量。25 和 Rs。50 个音符，我们目前分别有`c25`和`c50`。没有必要记录卢比的数量。100 张纸币，因为我们不能退还给任何顾客。现在有 3 种可能：
