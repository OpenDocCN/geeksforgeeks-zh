...
> 原文：[https://www.geeksforgeeks.org/swapping-four-variables-without-temporary-variable/](https://www.geeksforgeeks.org/swapping-four-variables-without-temporary-variable/)

假设我们有四个变量 `a, b, c, d`，我们希望以如下方式执行这些变量的交换：
`a = b, b = c, c = d, d = a`
而不使用任何其他第五个或临时变量。
