...
> 原文: [https://www.geeksforgeeks.org/program-to-calculate-angle-between-two-n-dimensional-vectors/](https://www.geeksforgeeks.org/program-to-calculate-angle-between-two-n-dimensional-vectors/)

给定一个由两个 [N 维](https://www.geeksforgeeks.org/multidimensional-arrays-c-cpp/) [向量](https://en.wikipedia.org/wiki/Vector_(mathematics_and_physics)) `A` 和 `B` 的大小组成的数组 `arr[]`，任务是找到两个向量之间的角度。
...
> **输出:** `0.845289`
> **解释:**
> 将数值放入公式 `cos\theta=\frac{\vec{a}.\vec{b}}{|\vec{a}||\vec{b}|}` 中，即可得到所需结果。
>
...
>
> 因此，`cos\theta=\frac{\vec{a}.\vec{b}}{|\vec{a}||\vec{b}|}`
