...
> 原文:[https://www.geeksforgeeks.org/modify-a-given-array-by-replacing-each-element-with-the-sum-or-product-of-their-digits-based-on-a-given-condition/](https://www.geeksforgeeks.org/modify-a-given-array-by-replacing-each-element-with-the-sum-or-product-of-their-digits-based-on-a-given-condition/)

给定一个由 `N` 个整数组成的[数组](https://www.geeksforgeeks.org/array-data-structure/) `arr[]`，任务是在对每个数组元素执行以下操作之一后修改数组元素：

*   如果数组元素中偶数数字的[计数](https://www.geeksforgeeks.org/count-even-odd-digits-integer/)大于奇数数字的[计数](https://www.geeksforgeeks.org/count-even-odd-digits-integer/)，那么将该元素更新为该元素所有数字的总和。
