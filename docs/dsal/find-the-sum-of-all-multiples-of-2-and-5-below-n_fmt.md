...
> 原文: [https://www.geeksforgeeks.org/find-the-sum-of-all-multiples-of-2-and-5-below-n/](https://www.geeksforgeeks.org/find-the-sum-of-all-multiples-of-2-and-5-below-n/)
...
这里，重复 10。事实上，所有 10 或 `2*5` 的倍数都是重复的，因为它被计数两次，一次在 2 的系列中，另一次在 5 的系列中。因此，我们将从 `Sum(1) + Sum(2)` 中减去 10 的和。
