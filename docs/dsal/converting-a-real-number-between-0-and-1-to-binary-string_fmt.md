...
> 原文: [https://www.geeksforgeeks.org/converting-a-real-number-between-0-and-1-to-binary-string/](https://www.geeksforgeeks.org/converting-a-real-number-between-0-and-1-to-binary-string/)
...
**解决方法:** 首先，我们先问问自己，二进制中的非整数是什么样子的。通过类比十进制数，二进制数 `0.101` 看起来像:
