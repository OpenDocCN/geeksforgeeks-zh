...
> 原文: [https://www.geeksforgeeks.org/python-program-for-moving-last-element-to-front-of-a-given-linked-list/](https://www.geeksforgeeks.org/python-program-for-moving-last-element-to-front-of-a-given-linked-list/)
...
1.  将倒数第二个设为最后一个 (`sec_last.next = None`)。
2.  将倒数第二个设置为标题 (`tmp.next = head_ref`)。
