...
> 原文：[https://www.geeksforgeeks.org/reduce-the-array-by-deleting-elements-which-are-greater-than-all-elements-to-its-left/](https://www.geeksforgeeks.org/reduce-the-array-by-deleting-elements-which-are-greater-than-all-elements-to-its-left/)

## 问题描述

给定一个由 `N` 个整数组成的数组 `arr[]`，任务是从给定数组中删除左边小于它的元素。继续从数组中删除元素，直到没有元素的左边相邻元素变小。在上述操作后打印结果数组。
