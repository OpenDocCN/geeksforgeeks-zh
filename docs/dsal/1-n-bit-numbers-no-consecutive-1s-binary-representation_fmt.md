...
> 原文: [https://www.geeksforgeeks.org/1-n-bit-numbers-no-consecutive-1s-binary-representation/](https://www.geeksforgeeks.org/1-n-bit-numbers-no-consecutive-1s-binary-representation/)
...
1.  将有 2<sup>n</sup> 个数字，位数从 1 到 `n`。
