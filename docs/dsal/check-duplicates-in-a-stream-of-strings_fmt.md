...
> 原文：[https://www.geeksforgeeks.org/check-duplicates-in-a-stream-of-strings/](https://www.geeksforgeeks.org/check-duplicates-in-a-stream-of-strings/)
...
**方法：** 创建一个[无序集](https://www.geeksforgeeks.org/unorderd_set-stl-uses/)来存储员工的姓名并开始遍历数组，如果当前姓名已经存在于该集中，则打印 `Yes`，否则打印 `No` 并将其插入该集中。
