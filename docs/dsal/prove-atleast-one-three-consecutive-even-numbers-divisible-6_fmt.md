...
> 原文: [https://www.geeksforgeeks.org/prove-atleast-one-three-consecutive-even-numbers-divisible-6/](https://www.geeksforgeeks.org/prove-atleast-one-three-consecutive-even-numbers-divisible-6/)
...
如果你看到任意三个连续的数字，你可以算出其中至少有一个能被 6 整除。我们可以用数学归纳法进行数学证明。

一个数要能被 6 整除，就应该能被 2 和 3 整除。因为都是偶数，所以这个数可以被 2 整除。

为了检查数被 3 除的可能性，考虑下面的证明:
