...
> 原文：[https://www.geeksforgeeks.org/implementation-of-0-1-knapsack-using-branch-and-bound/](https://www.geeksforgeeks.org/implementation-of-0-1-knapsack-using-branch-and-bound/)
...
5.  当 `Q` 不为空时，执行以下操作。
    ...
    *   计算下一级节点的利润。如果利润大于 `maxProfit`，那么更新 `maxProfit`。
    *   计算下一级节点的界限。如果绑定大于 `maxProfit`，那么在 `Q` 上增加下一级节点。
