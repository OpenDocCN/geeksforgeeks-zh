...
> 原文：[https://www.geeksforgeeks.org/bitwise-complement-operator-tilde/](https://www.geeksforgeeks.org/bitwise-complement-operator-tilde/)

**先决条件：**
[C/C++中的按位运算符](https://www.geeksforgeeks.org/bitwise-operators-in-c-cpp/)
[Java中的按位运算符](https://www.geeksforgeeks.org/bitwise-operators-in-java/)
