...
> 原文：[`https://www.geeksforgeeks.org/program-to-duplicate-vowels-in-string/`](https://www.geeksforgeeks.org/program-to-duplicate-vowels-in-string/)
...
使用循环迭代字符串。检查字符是否是元音并复制它。然后打印结果字符串。
