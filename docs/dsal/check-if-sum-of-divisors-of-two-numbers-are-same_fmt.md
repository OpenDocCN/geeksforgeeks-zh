...
> 原文: [https://www.geeksforgeeks.org/check-if-sum-of-divisors-of-two-numbers-are-same/](https://www.geeksforgeeks.org/check-if-sum-of-divisors-of-two-numbers-are-same/)

给定两个数字 `n1` 和 `n2`，我们需要检查这些数字是否是等价的数字。
**等价数**是这样的数，它们的除数之和是相同的。
...
> 输入: `n1 = 559`，`n2 = 703`
> 输出: 是。
> 说明: 两个数都有 57 作为它们的除数之和。
>
> 输入: `n1 = 36`，`n2 = 57`
> 输出: No.
> 说明: 36 有和 55，而 57 有它们的除数的和 23。
