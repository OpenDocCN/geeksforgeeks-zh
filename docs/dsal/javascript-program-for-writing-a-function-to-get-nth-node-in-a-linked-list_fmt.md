...
> 原文: [https://www.geeksforgeeks.org/javascript-program-for-writing-a-function-to-get-nth-node-in-a-linked-list/](https://www.geeksforgeeks.org/javascript-program-for-writing-a-function-to-get-nth-node-in-a-linked-list/)
...
// Use push() to construct list 1->12->1->4->1
push(1);
push(4);
push(1);
push(12);
...
document.write("Element at index 3 is " + GetNth(3));
...
```javascript
<script>
// javascript program to find n'th node in linked list using recursion
...
详情请参考[写函数获取链表中第 n 个节点的完整文章](https://www.geeksforgeeks.org/write-a-function-to-get-nth-node-in-a-linked-list/)！