...
> 原文：[https://www.geeksforgeeks.org/pattern-searching-using-suffix-tree/](https://www.geeksforgeeks.org/pattern-searching-using-suffix-tree/)

给定文本 `txt[0..n-1]` 和模式 `pat[0..m-1]`，编写一个函数 `search(char pat[], char txt[])`，打印出所有出现在 `txt[]` 中的 `pat[]`。你可以假设 `n > m`。
...
## 给定文本的后缀树是给定文本所有后缀的压缩树

我们已经讨论了[标准特里](https://www.geeksforgeeks.org/trie-insert-and-search/)。让我们用以下一系列单词来理解**压缩的特里**。
...
让我们考虑一个示例文本 `banana\0`，其中 `\0` 是字符串终止字符。以下是 `banana\0` 的所有后缀
...
如果我们加入单个节点的链，我们会得到下面的压缩 trie，它是给定文本 `banana\0` 的后缀树。
![](img/4b6388ce3c0907eda180743cb0036087.png "suffix tree")
...
- [Ukkonen 的后缀树构造–第 5 部分](https://www.geeksforgeeks.org/ukkonens-suffix-tree-construction-part-5/)
- [Ukkonen 的后缀树构造–第 6 部分](https://www.geeksforgeeks.org/ukkonens-suffix-tree-construction-part-6/ "Ukkonen’s Suffix Tree Construction – Part 6")

## 参考文献

- [http://fbim.fh-regensburg.de/~saj39122/sal/skript/progr/pr45102/Tries.pdf](http://fbim.fh-regensburg.de/~saj39122/sal/skript/progr/pr45102/Tries.pdf)
