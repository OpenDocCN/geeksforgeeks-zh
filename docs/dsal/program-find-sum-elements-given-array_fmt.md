...
> 原文: [https://www.geeksforgeeks.org/program-find-sum-elements-given-array/](https://www.geeksforgeeks.org/program-find-sum-elements-given-array/)
...
`first`, `last`: 要添加元素的范围的第一个和最后一个元素
`sum`: 总和的初始值
