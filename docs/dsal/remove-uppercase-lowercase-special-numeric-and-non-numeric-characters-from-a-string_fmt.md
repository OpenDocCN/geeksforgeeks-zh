...
> 原文: [https://www.geeksforgeeks.org/remove-uppercase-lowercase-special-numeric-and-non-numeric-characters-from-a-string/](https://www.geeksforgeeks.org/remove-uppercase-lowercase-special-numeric-and-non-numeric-characters-from-a-string/)

给定长度为 `N` 的[字符串](https://www.geeksforgeeks.org/string-data-structure/) `str`，任务是从该字符串中删除大写、小写、特殊、数字和非数字字符，并在同时修改后打印该字符串。
...
1.  创建[正则表达式](https://www.geeksforgeeks.org/write-regular-expressions/)从字符串中删除大写、小写、特殊、数字和非数字字符，如下所述:
    *   `regexRemoveUpperCaseCharacters = "[A-Z]"`
    *   `regexRemoveLowerCaseCharacters = "[a-z]"`
    *   `regexRemoveSpecialCharacters = "[^A-Za-z0-9]"`
    *   `regexRemoveNumericCharacters = "[0-9]"`
    *   `regexRemoveNonNumericCharacters = "[^0-9]"`
...
public class GFG
{
    ...
    public static String removingUpperCaseCharacters(String str)
    {
        ...
        // Replace every matched pattern with the target string using replaceAll() method
    ...
    public static void main(String[] args)
    {
        ...
        // Print the strings after the simultaneous modifications
...
str = "GFGgfg123$%"
print("After removing uppercase characters:", removingUpperCaseCharacters(str))
print("After removing lowercase characters:", removingLowerCaseCharacters(str))
print("After removing special characters:", removingSpecialCharacters(str))
print("After removing numeric characters:", removingNumericCharacters(str))
print("After removing non-numeric characters:", removingNonNumericCharacters(str))
