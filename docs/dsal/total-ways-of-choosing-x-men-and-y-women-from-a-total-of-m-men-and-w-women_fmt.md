...
> 原文：[https://www.geeksforgeeks.org/total-ways-of-choosing-x-men-and-y-women-from-a-total-of-m-men-and-w-women/](https://www.geeksforgeeks.org/total-ways-of-choosing-x-men-and-y-women-from-a-total-of-m-men-and-w-women/)
...
从共计 `M` 男性中选择 `X` 男性的途径总数为 <sup>M</sup>C<sub>X</sub>，而从 `W` 女性中选择 `Y` 女性的途径总数为 <sup>W</sup>C<sub>Y</sub>。因此，组合方式的总数将为 <sup>M</sup>C<sub>X</sub> * <sup>W</sup>C<sub>Y</sub>。
