...
> 原文: [https://www.geeksforgeeks.org/check-if-roots-of-a-quadratic-equation-are-reciprocal-of-each-other-or-not/](https://www.geeksforgeeks.org/check-if-roots-of-a-quadratic-equation-are-reciprocal-of-each-other-or-not/)

给定三个数字 `A`，`B`，`C`，代表一个二次方程 $Ax^{2} + Bx + C = 0$ 的系数（常数），任务是检查由这些常数代表的方程的根是否相互倒数。
...
1.  让方程的根为 $\alpha$ 和 $\frac{1}{\alpha}$。
2.  上述方程的根的乘积由 $\alpha$ * $\frac{1}{\alpha}$ 给出。
