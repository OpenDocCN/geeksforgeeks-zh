...
> 原文：[https://www.geeksforgeeks.org/total-ways-of-selecting-a-group-of-x-men-from-n-men-with-or-without-including-a-particular-man/](https://www.geeksforgeeks.org/total-ways-of-selecting-a-group-of-x-men-from-n-men-with-or-without-including-a-particular-man/)
...
**途径：** 从 `N` 个男人中选择 `X` 个男人的途径总数为 `<sup>N</sup>C<sub>X</sub>`

*   **包括特定的男人：** 我们可以从 `(N–1)` 个男人中选择 `(X–1)` 个男人，方法数为 `<sup>N–1</sup>C<sub>X–1</sub>`。
*   **排除特定男性：** 我们可以从 `(N–1)` 个男人中选择 `X` 个男人，方法数为 `<sup>N–1</sup>C<sub>X</sub>`。
