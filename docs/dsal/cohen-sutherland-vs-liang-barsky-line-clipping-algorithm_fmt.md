...
> 原文: [https://www.geeksforgeeks.org/cohen-sutherland-vs-liang-barsky-line-clipping-algorithm/](https://www.geeksforgeeks.org/cohen-sutherland-vs-liang-barsky-line-clipping-algorithm/)

## [科恩-萨瑟兰线裁剪算法](https://www.geeksforgeeks.org/line-clipping-set-1-cohen-sutherland-algorithm/)
它是一种线裁剪算法。其中二维空间（线位于其中）被分成 **9** 区域，然后在感兴趣的中心区域中可见的线和线的部分被有效地确定。它可以快速检测并省去两个常见且琐碎的案例。由`丹尼·科恩`和`伊凡·苏泽兰`开发。
