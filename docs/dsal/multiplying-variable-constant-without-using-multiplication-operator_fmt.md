...
> 原文：[https://www.geeksforgeeks.org/multiplying-variable-constant-without-using-multiplication-operator/](https://www.geeksforgeeks.org/multiplying-variable-constant-without-using-multiplication-operator/)
...
表达式`a << 3`将`a`乘以 8，表达式`a<<1`将`a`乘以 2。
...
```
<script>
// JavaScript program to Multiplying a
// variable with a constant
