...
> 原文: [https://www.geeksforgeeks.org/check-if-a-subarray-exists-with-sum-greater-than-the-given-array/](https://www.geeksforgeeks.org/check-if-a-subarray-exists-with-sum-greater-than-the-given-array/)
...
**方法:** 只有在两种情况之一下，子阵列的和大于原始阵列的和才有可能
