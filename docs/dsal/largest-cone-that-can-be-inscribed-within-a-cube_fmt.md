...
> 原文：[https://www.geeksforgeeks.org/largest-cone-that-can-be-inscribed-within-a-cube/](https://www.geeksforgeeks.org/largest-cone-that-can-be-inscribed-within-a-cube/)

这里给出的是一个边长为`a`的立方体。我们必须找到最大的右圆锥的高度和半径，它可以被内接在里面。
