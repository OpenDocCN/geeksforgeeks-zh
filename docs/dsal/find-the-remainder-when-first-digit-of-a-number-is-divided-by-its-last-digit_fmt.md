...
> 原文：[https://www.geeksforgeeks.org/find-the-remainder-when-first-digit-of-a-number-is-divided-by-its-last-digit/](https://www.geeksforgeeks.org/find-the-remainder-when-first-digit-of-a-number-is-divided-by-its-last-digit/)
...
求数字的第一位和最后一位。当第一个数字除以最后一个数字时，求余数。
