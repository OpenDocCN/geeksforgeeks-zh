...
> 原文：[https://www.geeksforgeeks.org/rearrange-odd-and-even-values-in-alternate-fashion-in-ascending-order/](https://www.geeksforgeeks.org/rearrange-odd-and-even-values-in-alternate-fashion-in-ascending-order/)

给定一个整数数组（奇数和偶数），任务是将它们排列成奇数和偶数值分别以非递减顺序（升序）交替出现。

*   如果最小值是**偶数**，那么我们必须打印**偶-奇**图案。
