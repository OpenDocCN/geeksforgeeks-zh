...
> 原文：[https://www.geeksforgeeks.org/sum-of-array-elements-after-reversing-each-element/](https://www.geeksforgeeks.org/sum-of-array-elements-after-reversing-each-element/)
...
**时间复杂度:** `O(N*log10 M)`，其中 `N` 表示数组长度，`M` 表示最大数组元素。
**辅助空间:** `O(1)`