...
> 原文: [https://www.geeksforgeeks.org/find-smallest-range-containing-at-least-1-elements-from-given-n-ranges/](https://www.geeksforgeeks.org/find-smallest-range-containing-at-least-1-elements-from-given-n-ranges/)
...
> **输出:** 6 6
> **解释:** 所有给定的范围都包含 6 作为它们之间的整数。因此，`[6，6]`是具有 1 个整数的有效范围，这是最小可能值。其他有效范围是`[4，4]`和`[5，5]`。
...
这个问题可以使用[贪婪方法](https://www.geeksforgeeks.org/greedy-algorithms/)通过以下观察来解决:
