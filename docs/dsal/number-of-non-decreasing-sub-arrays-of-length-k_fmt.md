...
> 原文: [https://www.geeksforgeeks.org/number-of-non-decreasing-sub-arrays-of-length-k/](https://www.geeksforgeeks.org/number-of-non-decreasing-sub-arrays-of-length-k/)
...
*   假设上一步找到的子阵列长度为 `L`。其中包含的长度为 `K` 的子阵列数量将为 `max(L–K+1，0)`。
