...
> 原文：`https://www.geeksforgeeks.org/priority-queue-in-python/`
...
一个更好的实现是使用[二进制堆](https://www.geeksforgeeks.org/binary-heap/)，它通常用于实现优先级队列。注意 Python 在库也提供 [`heapq`](https://www.geeksforgeeks.org/heap-queue-or-heapq-in-python/)。
