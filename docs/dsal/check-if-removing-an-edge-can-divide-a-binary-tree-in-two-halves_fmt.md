...
> 原文：[https://www.geeksforgeeks.org/check-if-removing-an-edge-can-divide-a-binary-tree-in-two-halves/](https://www.geeksforgeeks.org/check-if-removing-an-edge-can-divide-a-binary-tree-in-two-halves/)
...
上述解的时间复杂度为 `O(n^2)`，其中 `n` 是给定二叉树中的节点数。
