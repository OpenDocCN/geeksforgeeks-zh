...
> 原文: [https://www.geeksforgeeks.org/check-if-a-point-is-inside-outside-or-on-the-parabola/](https://www.geeksforgeeks.org/check-if-a-point-is-inside-outside-or-on-the-parabola/)

给定一个带有顶点 `(h, k)` 和 `a` 的抛物线，焦点和顶点之间的距离。任务是确定点 `(x, y)` 是在抛物线内、外还是在抛物线上。
