...
> 原文：[https://www.geeksforgeeks.org/complement-of-a-number-with-any-base-b/](https://www.geeksforgeeks.org/complement-of-a-number-with-any-base-b/)
...
在这篇文章中，讨论了一种寻找任意基数补码的一般方法。

**寻找`b-1`补码的步骤**：寻找`b-1`补码，

*   用基数为`b`的数字系统中最大的数字减去数字的每个数字。
*   例如，如果数字是以 9 为基数的三位数，则从 888 中减去该数字，因为 8 是以 9 为基数的数字系统中最大的数字。
*   得到的结果是`b-1`的补码。

**求`b`补码的步骤**：要求`b`的补码，只需在计算出的`b-1`的补码上加 1 即可。
