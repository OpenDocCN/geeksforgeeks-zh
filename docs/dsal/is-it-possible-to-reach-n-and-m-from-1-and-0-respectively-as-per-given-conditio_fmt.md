...
> 原文: [https://www.geeksforgeeks.org/is-it-possible-to-reach-n-and-m-from-1-and-0-respectively-as-per-given-conditio/](https://www.geeksforgeeks.org/is-it-possible-to-reach-n-and-m-from-1-and-0-respectively-as-per-given-conditio/)
...
1.  如果 `N` 小于 2 且 `M` 不等于零，则无法得到最终值，因此答案为**否**。
