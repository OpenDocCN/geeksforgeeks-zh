...
> 原文: [https://www.geeksforgeeks.org/program-to-calculate-the-value-of-sinx-and-cosx-using-expansion/](https://www.geeksforgeeks.org/program-to-calculate-the-value-of-sinx-and-cosx-using-expansion/)
...
本文由**萨基提瓦里**供稿。如果你喜欢极客(我们知道你喜欢！)并愿意投稿，也可以使用`write.geeksforgeeks.org`写一篇文章或者将文章邮寄到`review-team@geeksforgeeks.org`。看到你的文章出现在极客博客主页上，帮助其他极客。
