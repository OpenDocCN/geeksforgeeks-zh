...
> 原文: [https://www.geeksforgeeks.org/sum-substrings-string-presented-number-set-2-constant-extra-space/](https://www.geeksforgeeks.org/sum-substrings-string-presented-number-set-2-constant-extra-space/)
