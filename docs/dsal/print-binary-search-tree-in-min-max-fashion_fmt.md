...
> 原文: [https://www.geeksforgeeks.org/print-binary-search-tree-in-min-max-fashion/](https://www.geeksforgeeks.org/print-binary-search-tree-in-min-max-fashion/)
...
3.  打印`arr[i]`并更新`i = i + 1`。
4.  打印`arr[j]`并更新`j = j–1`。
5.  重复步骤 3 和 4，直到所有元素都被打印出来。
