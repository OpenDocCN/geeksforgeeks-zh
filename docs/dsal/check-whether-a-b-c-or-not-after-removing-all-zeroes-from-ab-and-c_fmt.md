...
> 原文：[https://www.geeksforgeeks.org/check-whether-a-b-c-or-not-after-removing-all-zeroes-from-ab-and-c/](https://www.geeksforgeeks.org/check-whether-a-b-c-or-not-after-removing-all-zeroes-from-ab-and-c/)
...
*   创建一个从数字 `n` 中删除零的函数。
*   检查（`removeZero(a)` + `removeZero(b)` = `removeZero(a+b)`）然后打印“是”否则打印“否”
