# 计数并打印 ASCII 值不在 [l, r] 范围内的字母

> 原文: [https://www.geeksforgeeks.org/count-and-print-the-alphabets-having-ascii-value-not-in-the-range-l-r/](https://www.geeksforgeeks.org/count-and-print-the-alphabets-having-ascii-value-not-in-the-range-l-r/)
