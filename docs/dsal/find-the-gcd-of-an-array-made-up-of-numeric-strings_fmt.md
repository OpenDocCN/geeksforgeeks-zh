...
> 原文: [https://www.geeksforgeeks.org/find-the-gcd-of-an-array-made-up-of-numeric-strings/](https://www.geeksforgeeks.org/find-the-gcd-of-an-array-made-up-of-numeric-strings/)
...
*   检查给定数组的所有字符串是否都可以通过连接子字符串`{arr[0][0], ..., arr[0][GCD-1]}`任意次或不任意次组成。如果发现是真的，那么打印`{arr[0][0], ..., arr[0][GCD-1]}`。
*   否则，打印一个空字符串。
