...
> 原文: [https://www.geeksforgeeks.org/program-to-print-the-series-2-15-41-80-132-197-till-n-terms/](https://www.geeksforgeeks.org/program-to-print-the-series-2-15-41-80-132-197-till-n-terms/)
...
**示例:**
> **输入:** `N = 7`
> **输出:** `2 15 41 80 132 197 275`
> **输入:** `N = 3`
> **输出:** `2 15 41`

## 方法
从给定的级数中，我们可以找到第 `n` 项的公式:
> 第一项 = `2`
> 第二项 = `15` = `13 * 1 + 2`
