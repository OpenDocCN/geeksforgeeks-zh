...
> 原文: [https://www.geeksforgeeks.org/find-the-equation-of-plane-which-passes-through-two-points-and-parallel-to-a-given-axis/](https://www.geeksforgeeks.org/find-the-equation-of-plane-which-passes-through-two-points-and-parallel-to-a-given-axis/)
...
直线 ![\overrightarrow{AB}](img/ad122dbf18f7dbfca31e6fcda9caf12d.png "Rendered by QuickLaTeX.com") 平行于给定的轴 ![(ai + bj + ck)](img/93f15e8acd9bbd174a8f4f3d5f0571fb.png "Rendered by QuickLaTeX.com")。因此，叉积 ![\overrightarrow{AB}](img/ad122dbf18f7dbfca31e6fcda9caf12d.png "Rendered by QuickLaTeX.com") 和 ![(ai + bj + ck)](img/93f15e8acd9bbd174a8f4f3d5f0571fb.png "Rendered by QuickLaTeX.com") 是 0，由下式给出:
...
**等式 1** 与直线 `AB` 垂直，即与所需平面垂直。
让平面的方程式由 `Ax + By + Cz = D` **(方程式 2)** 给出，其中 `A`、`B`、`C` 是平面垂直于平面的方向比。
由于**等式 1** 是**方程式 2** 相互垂直，因此**等式 1 & 2** 的方向比数值是平行的。那么平面的系数由下式给出:
