...
> 原文: [https://www.geeksforgeeks.org/python-program-to-check-if-a-singly-linked-list-is-palindrome/](https://www.geeksforgeeks.org/python-program-to-check-if-a-singly-linked-list-is-palindrome/)
...
1.  从头到尾遍历给定的列表，并将每个访问过的节点推送到堆栈。
2.  再次遍历列表。对于每个访问的节点，从堆栈中弹出一个节点，并将弹出的节点的数据与当前访问的节点进行比较。
...
更多详情请参考[整篇文章，查看单链表是否回文](https://www.geeksforgeeks.org/function-to-check-if-a-singly-linked-list-is-palindrome/)！