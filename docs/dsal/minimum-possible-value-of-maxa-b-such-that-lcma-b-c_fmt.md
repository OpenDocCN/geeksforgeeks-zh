...
> 原文：[https://www.geeksforgeeks.org/minimum-possible-value-of-maxa-b-such-that-lcma-b-c/](https://www.geeksforgeeks.org/minimum-possible-value-of-maxa-b-such-that-lcma-b-c/)
...
解决这个问题的一个方法是使用[这篇](https://www.geeksforgeeks.org/find-divisors-natural-number-set-1/)文章中讨论的方法找到给定数的所有因子，然后找到满足给定条件的对 `(A, B)`，并取这些对的最大值的整体最小值。
