...
> 原文：[https://www.geeksforgeeks.org/number-of-closing-brackets-needed-to-complete-a-regular-bracket-sequence/](https://www.geeksforgeeks.org/number-of-closing-brackets-needed-to-complete-a-regular-bracket-sequence/)
...
*   如果 `s` 和 `t` 是正则括号序列，那么 `st` 是正则括号序列。
