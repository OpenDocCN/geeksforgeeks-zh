...
> 原文：[https://www.geeksforgeeks.org/program-to-check-if-n-is-a-centered-octadecagonal-number/](https://www.geeksforgeeks.org/program-to-check-if-n-is-a-centered-octadecagonal-number/)

给定一个整数 `N`，任务是检查它是否是一个[中心十八进制数](https://www.geeksforgeeks.org/centered-octadecagonal-number/)。如果输出为“否”，则打印“是”。

> **【居中十八边形数】** 表示在中心的一个点，其他点在十八边形（18 边多边形）的连续层中围绕它排列。前几个居中的十八进制数是 1，19，55，109，181，271，379，…
...
**方法：** 为了解决上面提到的问题，我们知道中心十八角数的第 `K` 项给出为：
![K^{th} Term = 9*N^{2} + - 9*N + 1](img/3af29b5a34ed3f5ca404da93e0073874.png "Rendered by QuickLaTeX.com")
