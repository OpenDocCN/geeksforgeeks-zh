...
> 原文: [https://www.geeksforgeeks.org/check-product-every-pair-exists-array/](https://www.geeksforgeeks.org/check-product-every-pair-exists-array/)
...
**条件 3 :** 如果数组中有一个以上的“`-1`”，并且没有 `1`，那么答案也将是否定的，因为两个“`-1`”的乘积等于 `1`。
