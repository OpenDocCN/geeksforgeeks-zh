...
> 原文: [https://www.geeksforgeeks.org/number-of-subarrays-having-absolute-sum-greater-than-k-set-2/](https://www.geeksforgeeks.org/number-of-subarrays-having-absolute-sum-greater-than-k-set-2/)
...
这里[讨论了一个在正整数数组上工作的类似方法](https://www.geeksforgeeks.org/number-subarrays-sum-less-k/)。在本文中，我们将研究一种算法，可以同时解决正整数和负整数的这个问题。
