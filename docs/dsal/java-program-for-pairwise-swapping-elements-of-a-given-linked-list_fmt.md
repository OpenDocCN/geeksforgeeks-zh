...
> 原文：[https://www.geeksforgeeks.org/java-program-for-pairwise-swapping-elements-of-a-given-linked-list/](https://www.geeksforgeeks.org/java-program-for-pairwise-swapping-elements-of-a-given-linked-list/)
...
例如，如果链表是 `1->2->3->4->5`，那么函数应该将其改为 `2->1->4->3->5`，如果链表是 `1->NULL`，那么函数应该将其改为 `1->NULL`。

## 方法 1（迭代）

从头节点 `head` 开始遍历列表。同时用下一个节点的数据遍历每个节点的交换数据。
以下是上述方法的实施：
...
**更多详情请参考完整文章：**[给定链表的成对交换元素！](https://www.geeksforgeeks.org/pairwise-swap-elements-of-a-given-linked-list/)