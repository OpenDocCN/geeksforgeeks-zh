...
> 原文：[https://www.geeksforgeeks.org/count-number-of-bits-changed-after-adding-1-to-given-n/](https://www.geeksforgeeks.org/count-number-of-bits-changed-after-adding-1-to-given-n/)

给定一个整数`N`。任务是找出给定数字加 1 后改变的位数。
