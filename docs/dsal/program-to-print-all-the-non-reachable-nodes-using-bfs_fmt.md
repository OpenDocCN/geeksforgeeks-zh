...
*   为此，我们可以使用 [`BFS`](https://www.geeksforgeeks.org/breadth-first-traversal-for-a-graph/) 或 [`DFS`](https://www.geeksforgeeks.org/depth-first-traversal-for-a-graph/) 。[本文第 1 集](https://www.geeksforgeeks.org/count-number-non-reachable-nodes/)实现了 [`DFS`](https://www.geeksforgeeks.org/depth-first-traversal-for-a-graph/) 方法。本文采用了 [`BFS`](https://www.geeksforgeeks.org/breadth-first-traversal-for-a-graph/) 方法。
*   我们从给定的来源做 [`BFS`](https://www.geeksforgeeks.org/breadth-first-traversal-for-a-graph/) 。由于给定的图是无向的，属于断开组件的所有顶点都是不可达的节点。为此，我们使用访问数组，该数组用于跟踪 [`BFS`](https://www.geeksforgeeks.org/breadth-first-traversal-for-a-graph/) 的非访问顶点。
