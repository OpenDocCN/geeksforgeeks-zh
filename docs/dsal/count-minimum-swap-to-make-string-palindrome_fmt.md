...
> 原文：[https://www.geeksforgeeks.org/count-minimum-swap-to-make-string-palindrome/](https://www.geeksforgeeks.org/count-minimum-swap-to-make-string-palindrome/)
...
**时间复杂度：** 由于我们在字符串长度上运行两个嵌套循环，时间复杂度为 `O(n^2)`。
