...
> 原文: [https://www.geeksforgeeks.org/find-number-consecutive-zero-end-multiplying-n-numbers/](https://www.geeksforgeeks.org/find-number-consecutive-zero-end-multiplying-n-numbers/)
...
**高效方法:**
首先计算 `n` 个数的 2 的因子，然后计算所有 `n` 个数的 5 的因子，然后打印最小的一个。例如–
