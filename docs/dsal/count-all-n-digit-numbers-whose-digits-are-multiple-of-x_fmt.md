...
> 原文: [https://www.geeksforgeeks.org/count-all-n-digit-numbers-whose-digits-are-multiple-of-x/](https://www.geeksforgeeks.org/count-all-n-digit-numbers-whose-digits-are-multiple-of-x/)
...
2.  通过将以上所有数字排列在不同的位置，形成一个 `N` 位数字，就可以得到所需的计数。
