...
> 原文: [https://www.geeksforgeeks.org/vantieghems-theorem-primality-test/](https://www.geeksforgeeks.org/vantieghems-theorem-primality-test/)
...
*   对于 `n = 3`，最终产品为`(2^1 – 1)*(2^2 – 1)= 1 * 3 = 3`。`3` 与 `3` 模 `7` 全等。我们从表达式 `3 mod(2^3 – 1)` 得到 `3 mod 7`，因此 `3` 是素数。
