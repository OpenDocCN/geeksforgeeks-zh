...
> 原文：[https://www.geeksforgeeks.org/program-to-check-if-an-array-is-palindrome-or-not/](https://www.geeksforgeeks.org/program-to-check-if-an-array-is-palindrome-or-not/)
...
*   循环数组直到大小为 `n/2`。
*   循环检查 `if (arr[i] != arr[n-i-1])` 然后设置 `flag = 1` 和 `break`。
