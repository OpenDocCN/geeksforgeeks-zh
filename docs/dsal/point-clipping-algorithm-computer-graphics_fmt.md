...
> 原文：[https://www.geeksforgeeks.org/point-clipping-algorithm-computer-graphics/](https://www.geeksforgeeks.org/point-clipping-algorithm-computer-graphics/)
...
1.  获取两个观察窗Pane的最小和最大坐标。
2.  获取一个点的坐标。
3.  检查给定输入是否位于查看窗Pane的最小和最大坐标之间。
