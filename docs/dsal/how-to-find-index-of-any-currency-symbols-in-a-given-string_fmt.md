...
> 原文: [https://www.geeksforgeeks.org/how-to-find-index-of-any-currency-symbols-in-a-given-string/](https://www.geeksforgeeks.org/how-to-find-index-of-any-currency-symbols-in-a-given-string/)
...
3.  使用 `Pattern.matcher()` 将给定字符串与正则表达式匹配。
