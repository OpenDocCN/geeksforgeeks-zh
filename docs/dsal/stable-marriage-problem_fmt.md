...
这个想法是在有任何自由人可用的时候遍历所有自由人。每个自由的男人都会按照顺序去找他偏爱的所有女人。对于他去找的每个女人，他都会检查这个女人是否有空，如果有，他们就会订婚。如果女方没有空，那么女方选择要么拒绝他，要么根据自己的偏好清单放弃目前的婚约。所以，如果一个女人有更好的选择，一次订婚就可能被打破。`盖尔-沙普利算法`的时间复杂度为 `O(n^2)`。
...
### 参考文献:
[http://www.csee.wvu.edu/~ksmani/courses/fa01/random/lecnotes/lecture5.pdf](http://www.csee.wvu.edu/~ksmani/courses/fa01/random/lecnotes/lecture5.pdf)
