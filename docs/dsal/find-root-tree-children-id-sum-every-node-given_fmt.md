...
> 原文: [https://www.geeksforgeeks.org/find-root-tree-children-id-sum-every-node-given/](https://www.geeksforgeeks.org/find-root-tree-children-id-sum-every-node-given/)
...
乍一看，这个问题似乎是一个典型的树数据结构问题，但它可以通过以下方式解决。除了根，每个节点 id 都出现在子总和中。所以如果我们对所有的 id 求和，然后从所有子和的和中减去它，我们就得到根。
