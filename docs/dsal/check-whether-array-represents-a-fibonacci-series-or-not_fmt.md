...
> 原文: [https://www.geeksforgeeks.org/check-whether-array-represents-a-fibonacci-series-or-not/](https://www.geeksforgeeks.org/check-whether-array-represents-a-fibonacci-series-or-not/)
...
为了解决上述问题，主要思路是 [排序](https://www.geeksforgeeks.org/sort-c-stl/) 给定数组。排序后，检查每个元素是否等于前两个元素的总和。如果是这样，那么数组元素就形成了斐波那契数列。
