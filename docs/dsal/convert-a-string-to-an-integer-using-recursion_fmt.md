...
> 原文：[https://www.geeksforgeeks.org/convert-a-string-to-an-integer-using-recursion/](https://www.geeksforgeeks.org/convert-a-string-to-an-integer-using-recursion/)

给定一个表示数字的字符串 `str`，任务是将给定的字符串转换成整数。
