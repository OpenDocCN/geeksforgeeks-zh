...
> 原文: [https://www.geeksforgeeks.org/check-whether-number-exactly-three-distinct-factors-not/](https://www.geeksforgeeks.org/check-whether-number-exactly-three-distinct-factors-not/)
...
**更好的方法**是用**数论**。根据完美正方形的性质，“*每个完美正方形(x^2)总是只有奇数个因子*”。
