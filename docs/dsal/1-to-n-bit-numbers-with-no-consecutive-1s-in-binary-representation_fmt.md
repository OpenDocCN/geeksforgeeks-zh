...
> 原文: [https://www.geeksforgeeks.org/1-to-n-bit-numbers-with-no-consecutive-1s-in-binary-representation/](https://www.geeksforgeeks.org/1-to-n-bit-numbers-with-no-consecutive-1s-in-binary-representation/)
...
我们一个接一个地添加位，并递归打印数字。对于最后一位，我们有两个选择。
...
void numberWithNoConsecutiveOnes(int n, vector<int> sol)
{
...
本文由 `尼泰什·库马尔` 供稿。如果你喜欢 GeeksforGeeks 并想投稿，你也可以使用 `contribute.geeksforgeeks.org` 写一篇文章或者把你的文章邮寄到 `contribute@geeksforgeeks.org`。看到你的文章出现在极客博客主页上，帮助其他极客。
