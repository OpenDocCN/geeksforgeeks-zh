...
> 原文：`https://www.geeksforgeeks.org/check-if-a-string-contains-a-palindromic-sub-string-of-even-length/`
...
注意**偶数**长度的回文必须在中间包含两个相同的字母。所以我们只需要检查一下这种情况。如果我们在字符串中找到两个连续的相同字母，那么我们输出“是”，否则输出“否”。
