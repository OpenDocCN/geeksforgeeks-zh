...
> 原文：[https://www.geeksforgeeks.org/find-minimum-number-k-such-that-sum-of-array-after-multiplication-by-k-exceed-s/](https://www.geeksforgeeks.org/find-minimum-number-k-such-that-sum-of-array-after-multiplication-by-k-exceed-s/)
...
*   求数组所有元素的[和](https://www.geeksforgeeks.org/program-find-sum-elements-given-array/)，存储在变量 `sum` 中。
