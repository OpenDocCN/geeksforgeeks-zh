...
> 原文: [https://www.geeksforgeeks.org/construct-two-n-length-arrays-with-same-indexed-elements-as-co-prime-and-a-difference-of-n-in-their-sum/](https://www.geeksforgeeks.org/construct-two-n-length-arrays-with-same-indexed-elements-as-co-prime-and-a-difference-of-n-in-their-sum/)
...
这个想法是基于这样的观察：[两个连续的自然数总是同素的](https://www.geeksforgeeks.org/group-all-co-prime-numbers-from-1-to-n/)，它们之间的区别是 `1`。按照以下步骤解决问题:
