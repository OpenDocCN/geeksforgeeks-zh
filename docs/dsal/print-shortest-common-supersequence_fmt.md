...
> 原文：[https://www.geeksforgeeks.org/print-shortest-common-supersequence/](https://www.geeksforgeeks.org/print-shortest-common-supersequence/)
...
下表显示了如果我们使用动态编程对**字符串 `X = "AGGTAB"` 和 `Y = "GXTXAYB"`** 进行自下而上的求解，则上述算法遵循的步骤。

![Shortest Supersequence Problem DP table](img/f54d7359c166001f15b27b9ff4946418.png)

使用 `DP` 解决方案矩阵，我们可以按照以下步骤轻松打印两个字符串的最短超序列。
...
一个基于动态规划的 Java 程序，用于打印两个字符串的最短公共超序列。
...
一个基于动态规划的 Python3 程序，用于打印两个字符串的最短公共超序列。
