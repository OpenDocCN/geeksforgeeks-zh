...
> 原文：[https://www.geeksforgeeks.org/find-maximum-sum-pair-with-same-digit-sum/](https://www.geeksforgeeks.org/find-maximum-sum-pair-with-same-digit-sum/)
