...
> 原文: [https://www.geeksforgeeks.org/print-adjacency-list-for-a-directed-graph/](https://www.geeksforgeeks.org/print-adjacency-list-for-a-directed-graph/)
...
> 输出表示给定图形的邻接表。
>
> **输入:** `V = 4`，`edges[][] = {{0，1}，{1，2}，{1，3}，{2，3}，{3，0}}`
>
...
**方法 (使用 [C++ STL](https://www.geeksforgeeks.org/cpp-stl-tutorial/)):** 主要思想是将图表示为向量阵列，使得每个向量表示单个顶点的邻接表。使用 STL，代码变得更简单，更容易理解。
