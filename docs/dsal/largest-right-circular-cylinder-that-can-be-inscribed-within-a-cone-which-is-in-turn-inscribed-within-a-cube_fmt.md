...
> 原文: [https://www.geeksforgeeks.org/largest-right-circular-cylinder-that-can-be-inscribed-within-a-cone-which-is-in-turn-inscribed-within-a-cube/](https://www.geeksforgeeks.org/largest-right-circular-cylinder-that-can-be-inscribed-within-a-cone-which-is-in-turn-inscribed-within-a-cube/)

这里给定的是一个边长为`a`的立方体，立方体上刻有一个圆锥体，圆锥体又刻有一个正圆柱体。任务是找到这个圆柱体的最大可能体积。
