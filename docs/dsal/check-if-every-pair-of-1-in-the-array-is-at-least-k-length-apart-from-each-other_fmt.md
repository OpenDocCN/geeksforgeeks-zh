...
> 原文: [https://www.geeksforgeeks.org/check-if-every-pair-of-1-in-the-array-is-at-least-k-length-apart-from-each-other/](https://www.geeksforgeeks.org/check-if-every-pair-of-1-in-the-array-is-at-least-k-length-apart-from-each-other/)
...
要解决上面提到的问题，我们必须检查每对相邻 1 之间的距离。找到 1 的第一个位置，然后遍历数组的其余部分，如果距离为 0，则增加距离，否则，如果距离小于 k，则执行检查操作，并将计数再次重置为 0。
