...
> 原文: [https://www.geeksforgeeks.org/analysis-of-different-sorting-techniques/](https://www.geeksforgeeks.org/analysis-of-different-sorting-techniques/)
...
|   | 最佳案例 | 平均案例 | 最坏情况 | 最坏情况 |
| --- | --- | --- | --- | --- |
| **气泡排序** | `ω(n)` | `θ(n^2)` | `O(n^2)` | `O(1)` |
| **选择排序** | `ω(n^2)` | `θ(n^2)` | `O(n^2)` | `O(1)` |
| **插入输出** | `ω(n)` | `θ(n^2)` | `O(n^2)` | `O(1)` |
