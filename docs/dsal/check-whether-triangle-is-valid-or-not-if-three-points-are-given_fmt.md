...
> 原文: [https://www.geeksforgeeks.org/check-whether-triangle-is-valid-or-not-if-three-points-are-given/](https://www.geeksforgeeks.org/check-whether-triangle-is-valid-or-not-if-three-points-are-given/)
...
> **输出:** 是
>
> **输入:** `P1 = (1, 1)`, `P2 = (1, 4)`, `P3 = (1, 5)`
> **输出:** 否

**逼近:** 问题中的关键观察点是三个点不在直线上时才形成三角形，也就是这三个点形成的三角形面积不等于零。
