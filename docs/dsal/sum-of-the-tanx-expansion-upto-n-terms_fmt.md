...
> 原文: [https://www.geeksforgeeks.org/sum-of-the-tanx-expansion-upto-n-terms/](https://www.geeksforgeeks.org/sum-of-the-tanx-expansion-upto-n-terms/)
...
`tan(x)` 的展开在这里显示。用一个简单的循环计算每个术语，得到所需的答案。
