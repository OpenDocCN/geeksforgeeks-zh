...
> 原文：[https://www.geeksforgeeks.org/print-last-character-of-each-word-in-a-string/](https://www.geeksforgeeks.org/print-last-character-of-each-word-in-a-string/)
...
在给定字符串的末尾添加一个空格，即 `" "`，这样字符串中的最后一个单词后面也会跟一个空格，就像字符串中的所有其他单词一样。现在开始逐字符遍历字符串，并打印每个后跟空格的字符。
