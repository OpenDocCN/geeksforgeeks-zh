...
> 原文: [https://www.geeksforgeeks.org/prime-triplets-up-to-n-having-difference-between-two-elements-equal-to-the-third/](https://www.geeksforgeeks.org/prime-triplets-up-to-n-having-difference-between-two-elements-equal-to-the-third/)
...
按照以下步骤解决问题:
- 使用厄拉多塞的[筛预计算范围 `[1, N]` 内的所有质数](https://www.geeksforgeeks.org/sieve-of-eratosthenes/)。
