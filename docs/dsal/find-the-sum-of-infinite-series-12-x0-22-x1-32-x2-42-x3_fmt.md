...
> 原文: [https://www.geeksforgeeks.org/find-the-sum-of-infinite-series-12-x0-22-x1-32-x2-42-x3/](https://www.geeksforgeeks.org/find-the-sum-of-infinite-series-12-x0-22-x1-32-x2-42-x3/)
...
虽然给定的数列不是算术-几何数列，但是，差异 `(2^2-1^2), (3^2-2^2), ...` 等等形成了一个 AP。所以，我们可以使用差异法。
