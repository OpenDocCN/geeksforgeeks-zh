# 统计奇偶位置分别由偶数和素数组成的N位数

> 原文：[https://www.geeksforgeeks.org/count-n-digits-numbers-made-up-of-even-and-prime-digits-at-odd-and-even-positions-respectively/](https://www.geeksforgeeks.org/count-n-digits-numbers-made-up-of-even-and-prime-digits-at-odd-and-even-positions-respectively/)

给定一个正整数 `N`，任务是找出奇数索引处为偶数、偶数索引处为素数的 `N` 位整数个数。
...
> **输出：** `20`
> **解释：**
> 以下是满足给定标准的可能的 2 位数：`{20，22，24，26，28，30，32，34，36，38，50，52，54，56，58，70，72，74，76，78}`。因此，这个数字的计数是 `20`。

> **输入：** `N = 5`
> **输出：** `1600`

**方法：** 通过观察**偶数位置**有 `[2，3，5，7]` 共 **4** 种选择，**奇数位置**有 `[0，2，4，6，8]` 共 **5** 种选择这一事实，可以使用[**排列组合**](https://www.geeksforgeeks.org/permutation-and-combination/)的概念来解决给定的问题。因此，满足给定标准的 `N` 位数的计数由下式给出：
