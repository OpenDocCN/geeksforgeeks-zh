...
> 原文：[https://www.geeksforgeeks.org/how-to-implement-a-stack-using-list-in-c-stl/](https://www.geeksforgeeks.org/how-to-implement-a-stack-using-list-in-c-stl/)
...
[堆栈](https://www.geeksforgeeks.org/stack-data-structure/)是一个线性数据结构，遵循后进先出（LIFO）原则。主要支持 4 大操作：
1.  **Push**：将一个元素推入堆栈。
2.  **Pop**：按照后进先出顺序删除元素。
3.  **Top**：返回堆栈顶部的元素。
4.  **Empty**：返回堆栈是否为空。
