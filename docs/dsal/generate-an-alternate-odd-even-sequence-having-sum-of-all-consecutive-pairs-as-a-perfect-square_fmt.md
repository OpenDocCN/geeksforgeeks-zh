...
> 原文: [https://www.geeksforgeeks.org/generate-an-alternate-odd-even-sequence-having-sum-of-all-consecutive-pairs-as-a-perfect-square/](https://www.geeksforgeeks.org/generate-an-alternate-odd-even-sequence-having-sum-of-all-consecutive-pairs-as-a-perfect-square/)
...
**方法:** 根据上述例子的观察，可以解决给定的问题，对于整数 `N`，序列将是 `1，8，17，32，49` 等形式。因此，第 `N` 项可由下式计算:
