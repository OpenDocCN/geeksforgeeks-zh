...
> 原文：[https://www.geeksforgeeks.org/find-number-times-string-occurs-given-string/](https://www.geeksforgeeks.org/find-number-times-string-occurs-given-string/)
...
本文由阿迪蒂亚·戈尔供稿。如果你喜欢 GeeksforGeeks 并想投稿，你也可以使用[contribute.GeeksforGeeks.org](http://www.contribute.GeeksforGeeks.org)写一篇文章或者把你的文章邮寄到 contribute@GeeksforGeeks.org。看到你的文章出现在极客博客主页上，帮助其他极客。
