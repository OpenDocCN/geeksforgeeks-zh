...
> 原文: [https://www.geeksforgeeks.org/print-any-pair-of-integers-with-sum-of-gcd-and-lcm-equals-to-n/](https://www.geeksforgeeks.org/print-any-pair-of-integers-with-sum-of-gcd-and-lcm-equals-to-n/)
...
**方法:**
为了解决上面提到的问题，让我们考虑这一对是`(1，n-1)`。`GCD(1，n-1) = 1`，`LCM(1，n-1)= n–1`。因此，GCD 和 LCM 之和= `1+(n–1)= n`。因此，对`(1，n–1)`将是 GCD 和 LCM 之和等于 `n` 的对。
