# 求模 p 下的平方根(Shanks Tonelli 算法)

> 原文: [https://www.geeksforgeeks.org/find-square-root-modulo-p-set-2-shanks-tonelli-algorithm/](https://www.geeksforgeeks.org/find-square-root-modulo-p-set-2-shanks-tonelli-algorithm/)
...
我们已经讨论了[欧拉准则](https://www.geeksforgeeks.org/eulers-criterion-check-if-square-root-under-modulo-p-exists/)来检查平方根是否存在。我们还讨论了[一个只有当 `p` 是 `4*i + 3` 形式时才起作用的解决方案](https://www.geeksforgeeks.org/find-square-root-under-modulo-p-set-1-when-p-is-in-form-of-4i-3/)。在这篇文章中，[讨论了适用于所有类型输入的 Shank Tonelli 算法](https://en.wikipedia.org/wiki/Tonelli%E2%80%93Shanks_algorithm)。
...
以下是实现 Shanks-Tonelli 算法以寻找模平方根的 Java 代码示例。
...
以下是实现 Shanks-Tonelli 算法以寻找模平方根的 Python 3 代码示例。
...
[http://www.math.vt.edu/people/brown/class_homepages/shanks_tonelli.pdf](http://www.math.vt.edu/people/brown/class_homepages/shanks_tonelli.pdf)
