...
> 原文: [https://www.geeksforgeeks.org/find-the-length-of-the-longest-subsequence-with-first-k-alphabets-having-same-frequency/](https://www.geeksforgeeks.org/find-the-length-of-the-longest-subsequence-with-first-k-alphabets-having-same-frequency/)

给定带有大写字符的字符串 `str` 和整数 `K`，任务是找到最长子序列的长度，使得第一个 `K` 字母表的频率相同。
