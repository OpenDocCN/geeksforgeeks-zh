...
> 原文：[https://www.geeksforgeeks.org/find-the-sum-of-power-of-bit-count-raised-to-the-power-b/](https://www.geeksforgeeks.org/find-the-sum-of-power-of-bit-count-raised-to-the-power-b/)

给定一个整数数组 `A[]`。求 `A[i]` 中每个元素的集合位的和，其幂为 `A[i]`。
