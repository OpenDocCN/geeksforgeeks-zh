...
> 原文: [https://www.geeksforgeeks.org/count-number-of-trailing-zeros-in-binary-representation-of-a-number-using-bitset/](https://www.geeksforgeeks.org/count-number-of-trailing-zeros-in-binary-representation-of-a-number-using-bitset/)
...
我们只需设置位集中的数字，然后从位集的 0 个索引开始迭代，一旦我们得到 1，我们将打破循环，因为在此之后没有尾随零。
以下是上述办法的实施:
