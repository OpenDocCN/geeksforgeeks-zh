...
> 原文: [https://www.geeksforgeeks.org/sort-an-array-where-a-subarray-of-a-sorted-array-is-in-reverse-order/](https://www.geeksforgeeks.org/sort-an-array-where-a-subarray-of-a-sorted-array-is-in-reverse-order/)
...
一个**天真的做法**将是[排序数组](https://www.geeksforgeeks.org/sorting-algorithms/)并打印数组。**该方法的时间复杂度**将为 `O(N log N)`。
