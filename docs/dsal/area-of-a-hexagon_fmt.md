...
n 边的等边三角形主要有 6 个，[等边三角形的面积](https://www.geeksforgeeks.org/program-calculate-area-perimeter-equilateral-triangle/)为`(sqrt(3)/4) * n * n`。由于在六边形中，总共有 6 个 n 边的等边三角形，所以六边形的面积变为`(3*sqrt(3)/2) * n * n`。
