...
> 原文: [https://www.geeksforgeeks.org/centered-hexadecagonal-number/](https://www.geeksforgeeks.org/centered-hexadecagonal-number/)

给定一个数 `n`，求第 `n` 个居中的十六边形数。
一个以十六边形数字为中心的表示在连续的十六边形(16 边多边形)图层中，位于中心的一个点及其周围的其他点。
...
参考文献:
[http://oeis.org/A069129](http://oeis.org/A069129)