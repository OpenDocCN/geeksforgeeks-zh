...
> 原文: [https://www.geeksforgeeks.org/check-whether-a-straight-line-can-be-formed-using-n-co-ordinate-points/](https://www.geeksforgeeks.org/check-whether-a-straight-line-can-be-formed-using-n-co-ordinate-points/)

给定一个由 `N` 个坐标点组成的数组 `arr[]`，任务是检查是否可以使用这些坐标点形成一条直线。
...
**逼近:** 思路是求数组中每一对点之间的直线的斜率，如果每一对点的斜率相同，那么这几个点就连成一条直线。
