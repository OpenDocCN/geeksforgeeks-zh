...
> 原文: [https://www.geeksforgeeks.org/find-the-deepest-node-in-a-binary-tree-using-queue-stl-set-2/](https://www.geeksforgeeks.org/find-the-deepest-node-in-a-binary-tree-using-queue-stl-set-2/)

给定一棵二叉树。任务是找到给定二叉树中最深节点的值。
