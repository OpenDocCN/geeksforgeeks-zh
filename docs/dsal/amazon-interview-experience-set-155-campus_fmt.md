...
> 原文：[https://www.geeksforgeeks.org/amazon-interview-experience-set-155-campus/](https://www.geeksforgeeks.org/amazon-interview-experience-set-155-campus/)
...
这是在 HackerRank 上进行的。测试持续时间为 1.5 小时。
...
共 4 轮。每一轮都是淘汰赛。在每一轮面试中，面试官都要求你解释算法并在纸上实现它。
...
如果你喜欢 GeeksforGeeks 博客并想投稿，你也可以写一篇文章并把你的文章邮寄到 `contribute@geeksforgeeks.org`。看到你的文章出现在 GeeksforGeeks 博客主页上，帮助其他极客。
