...
> 原文: [https://www.geeksforgeeks.org/program-to-check-if-n-is-a-pentadecagonal-number/](https://www.geeksforgeeks.org/program-to-check-if-n-is-a-pentadecagonal-number/)
...
3.  如果用上述公式计算出的 `K` 的值是一个整数，那么 `N` 就是一个十边形数。
4.  否则 `N` 不是五边形数。
