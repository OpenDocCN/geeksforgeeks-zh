...
> 原文: [https://www.geeksforgeeks.org/find-sum-terms-n-th-row-given-series/](https://www.geeksforgeeks.org/find-sum-terms-n-th-row-given-series/)
...
Sum of all the terms in the nth row = n * (2 * n^2 + 1)
```
