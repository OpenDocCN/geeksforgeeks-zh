...
一个芒奇豪森数是一个等于其数字加到每个数字幂的和的数。类似于[自恋号](https://www.geeksforgeeks.org/narcissistic-number/)。
...
如果采用 `0^0 = 0` 的定义，那么正好有四个 münchausen 数:0、1、3435 和 438579088【来源:[math world](http://mathworld.wolfram.com/MuenchhausenNumber.html)】