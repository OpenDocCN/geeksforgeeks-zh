# 求数列 1+11+111+1111+... 的和

> 原文: [https://www.geeksforgeeks.org/find-sum-series-1111111111-upto-n-terms/](https://www.geeksforgeeks.org/find-sum-series-1111111111-upto-n-terms/)

## 问题描述

这里我们要求数列 `1 + 11 + 111 + 1111 + ...` 的和，最多 `N` 项（其中 `N` 是给定的）。
...
另一种方法：让给定的数列 `S = 1 + 11 + 111 + 1111 + ... + 直到第 n 项`。用公式求数列的和。
