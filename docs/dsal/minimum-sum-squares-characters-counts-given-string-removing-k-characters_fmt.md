...
> 原文: [https://www.geeksforgeeks.org/minimum-sum-squares-characters-counts-given-string-removing-k-characters/](https://www.geeksforgeeks.org/minimum-sum-squares-characters-counts-given-string-removing-k-characters/)
...
一个`简单的解决方案`是使用排序技术通过所有当前最高频率减少到 `k` 倍。对于每次降低排序频率后的数组。
...
本文由**Somesh Awasthi**先生供稿。如果你喜欢 GeeksforGeeks 并想投稿，你也可以使用`write.geeksforgeeks.org`写一篇文章或者把你的文章邮寄到`review-team@geeksforgeeks.org`。看到你的文章出现在极客博客主页上，帮助其他极客。
