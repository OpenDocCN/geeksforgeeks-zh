...
> 原文：[https://www.geeksforgeeks.org/count-array-elements-exceeding-all-previous-elements-as-well-as-the-next-array-element/](https://www.geeksforgeeks.org/count-array-elements-exceeding-all-previous-elements-as-well-as-the-next-array-element/)
...
思路是线性[遍历数组](https://www.geeksforgeeks.org/c-program-to-traverse-an-array/)，检查每个数组元素是否满足给定条件。按照以下步骤解决此问题：

*   [遍历数组](https://www.geeksforgeeks.org/c-program-to-traverse-an-array/)。
*   从数组的第一个元素开始，跟踪到目前为止遇到的最大数组元素。
*   如果当前数组元素大于之前遇到的最大数组元素，请更新它。
