...
> 原文: [https://www.geeksforgeeks.org/sum-of-gcds-of-each-row-of-the-given-matrix/](https://www.geeksforgeeks.org/sum-of-gcds-of-each-row-of-the-given-matrix/)

给定一个大小为 `N * N` 的矩阵 `mat[][]`，任务是求给定矩阵所有行的 gcd 之和。

**例:**

> **输入:** `arr[][] = { {2, 4, 6, 8}, {3, 6, 9, 12}, {4, 8, 12, 16}, {5, 10, 15, 20} };`
> **输出:** 14
> `gcd(2, 4, 6, 8) = 2`
> `gcd(3, 6, 9, 12) = 3`
> `gcd(4, 8, 12, 16) = 4`
