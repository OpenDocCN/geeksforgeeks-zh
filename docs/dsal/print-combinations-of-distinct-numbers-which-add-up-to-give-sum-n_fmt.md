...
> 原文: [https://www.geeksforgeeks.org/print-combinations-of-distinct-numbers-which-add-up-to-give-sum-n/](https://www.geeksforgeeks.org/print-combinations-of-distinct-numbers-which-add-up-to-give-sum-n/)
...
该方法是[这里讨论的方法的扩展](https://www.geeksforgeeks.org/find-all-combinations-that-adds-upto-given-number-2/)。用来得到所有不同元素的想法是，首先我们找到所有相加得到总和的元素 `N`。然后我们迭代每个元素并将元素存储到[集合](https://www.geeksforgeeks.org/set-in-cpp-stl/)中。将元素存储到集合中会删除所有重复的元素，然后我们将集合的元素之和相加，并检查它是否等于 `N`。
