...
> 原文：[https://www.geeksforgeeks.org/sort-vector-of-numeric-strings-in-ascending-order/](https://www.geeksforgeeks.org/sort-vector-of-numeric-strings-in-ascending-order/)
...
**方法：** [C++](https://www.geeksforgeeks.org/c-plus-plus/) [STL](https://www.geeksforgeeks.org/the-c-standard-template-library-stl/) 中的 [`sort()` 函数](https://www.geeksforgeeks.org/sort-c-stl/) 能够对字符串的向量进行[排序](https://www.geeksforgeeks.org/sorting-a-vector-in-c/)，如果且仅当它包含单个数字字符，例如 `{'1', '2'}`。但是要对包含多个字符的字符串的数字向量进行排序，例如 `{'12', '56', '14'}`，应该在 `sort()` 函数中编写自己的比较器。按照升序逻辑排序的比较器函数如下：
