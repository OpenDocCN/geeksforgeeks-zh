...
> 原文：[https://www.geeksforgeeks.org/counting-pairs-person-can-form-pair-one/](https://www.geeksforgeeks.org/counting-pairs-person-can-form-pair-one/)
...
2.  让我们考虑 `X-th` 参与者，他可以保持单身或者他可以与来自 `[1, X-1]` 的人配对。
...
本文由 [**nikunj_agarwal**](https://auth.geeksforgeeks.org/profile.php?user=nikunj_agarwal&list=practice) 供稿。如果你喜欢 GeeksforGeeks 并想投稿，你也可以使用 [contribute.geeksforgeeks.org](http://www.contribute.geeksforgeeks.org) 写一篇文章或者把你的文章邮寄到 contribute@geeksforgeeks.org。看到你的文章出现在极客博客主页上，帮助其他极客。
