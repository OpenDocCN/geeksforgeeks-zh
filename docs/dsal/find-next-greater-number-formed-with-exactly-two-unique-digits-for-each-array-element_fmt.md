...
> 原文：[https://www.geeksforgeeks.org/find-next-greater-number-formed-with-exactly-two-unique-digits-for-each-array-element/](https://www.geeksforgeeks.org/find-next-greater-number-formed-with-exactly-two-unique-digits-for-each-array-element/)
...
对于范围 `[0, N]` 中的每个 `i` 迭代所有大于 `arr[i]` 的整数，并跟踪第一个整数，使得整数中唯一数字的[计数正好为 2](https://www.geeksforgeeks.org/count-of-unique-digits-in-a-given-number-n/)，就可以解决给定的问题。
