...
> 原文: [https://www.geeksforgeeks.org/print-n-distinct-numbers-following-the-given-operations/](https://www.geeksforgeeks.org/print-n-distinct-numbers-following-the-given-operations/)
...
*   为了打印数组，我们将考虑两个部分，即第一个部分是 `N/2` 个元素，是 2 的倍数，另一半是 `2*i - 1` 的倍数。对于数组中的最后一个元素，我们将通过应用直接公式 `N + N/2 - 1` 来计算整数，因为我们应该使两半的和相等。
