...
**说明**：[双端队列](https://www.geeksforgeeks.org/deque-interface-java-example/)是双端队列，可以在其中插入数据以及从两端删除数据。 当我们使用[`descendingIterator()`](https://www.geeksforgeeks.org/deque-descendingiterator-method-in-java/)时，我们实际上以与存储数据相反的顺序获取输出。
