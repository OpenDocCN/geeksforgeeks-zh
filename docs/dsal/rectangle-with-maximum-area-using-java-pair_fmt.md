...
> 原文: [https://www.geeksforgeeks.org/rectangle-with-maximum-area-using-java-pair/](https://www.geeksforgeeks.org/rectangle-with-maximum-area-using-java-pair/)
...
1.  使用用户定义的`Rectangle`类存储矩形的宽度和高度。
2.  制作这个类的数组。
