...
> 原文: [https://www.geeksforgeeks.org/sand-timer-flip-counting-problem/](https://www.geeksforgeeks.org/sand-timer-flip-counting-problem/)
...
两个数字的最低公倍数（LCM）将决定两个砂计时器一起清空的时间。
`LCM(A, B) = (A * B) / GCD(A, B)`
