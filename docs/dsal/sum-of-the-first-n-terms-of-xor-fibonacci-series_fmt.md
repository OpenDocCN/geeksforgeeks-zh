...
> 原文: [https://www.geeksforgeeks.org/sum-of-the-first-n-terms-of-xor-fibonacci-series/](https://www.geeksforgeeks.org/sum-of-the-first-n-terms-of-xor-fibonacci-series/)
...
**天真方法:** 最简单的方法是生成异或斐波那契数列直到第一个 `N` 项并计算总和。最后，打印得出的总和。
