...
> 原文: [https://www.geeksforgeeks.org/illustration-for-tracing-all-the-8-octaves-in-bresenhams-line-algorithm/](https://www.geeksforgeeks.org/illustration-for-tracing-all-the-8-octaves-in-bresenhams-line-algorithm/)

**先决条件:** [布雷森汉姆线生成算法](https://www.geeksforgeeks.org/bresenhams-line-generation-algorithm/)

在本文中，我们将了解如何使用布雷森汉的直线算法来寻找所有的八度音阶。

在理解算法的同时只考虑两点 `P0(x0, y0)` 和 `P1(x1, y1)` 的坐标，使得 `x0 < x1` 和 `y0 < y1`。任务是在像素的电脑屏幕上找到画线所需的所有中间点 `P0(x0, y0)` 和 `P1(x1, y1)`。
...
*   `D = 3` -> 选择 `NE` -> 绘制`(5, 14)` -> `D = 3 + DNE = 3 + -12 = -9`。
...
最初，我们要绘制`(y0, x0)`也就是`(-2, 4)`

*   图`(-2, 4)`。
*   `D = 0` -> `E` 被选中 -> 绘制`(-2, 5)` -> `D = 0 + DE = 0 + 8 = 8`。
*   `D = 8` -> 选择 `NE` -> 绘制`(-3, 6)` -> `D = 8 + DNE = 8 + -8 = 0`。
*   `D = 0` -> `E` 被选中 -> 绘制`(-3, 7)` -> `D = 0 + DE = 0 + 8 = 8`。
*   `D = 8` -> 选择 `NE` -> 绘制`(-4, 8)` -> `D = 8 + DNE = 8 + -8 = 0`。
*   `D = 0` -> `E` 被选中 -> 绘制`(-4, 9)` -> `D = 0 + DE = 0 + 8 = 8`。
*   `D = 8` -> 选择 `NE` -> 绘制`(-5, 10)` -> `D = 8 + DNE = 8 + -8 = 0`。
*   `D = 0` -> `E` 被选中 -> 绘制`(-5, 11)` -> `D = 0 + DE = 0 + 8 = 8`。
*   `D = 8` -> 选择 `NE` -> 绘制`(-6, 12)` -> `D = 8 + DNE = 8 + -8 = 0`。
*   `x = x1`，因此在循环时退出。
...
*   图`(-6, 3)`。
*   `D = 0` -> `E` 被选中 -> 绘制`(-5, 3)` -> `D = 0 + DE = 0 + 4 = 4`。
*   `D = 4` -> 选择 `NE` -> 绘制`(-4, 2)` -> `D = 4 + DNE = 4 + -4 = 0`。
*   `D = 0` -> `E` 被选中 -> 绘制`(-3, 2)` -> `D = 0 + DE = 0 + 4 = 4`。
...
*   图`(-9, -3)`。
*   `D = -2` -> `E` 被选中 -> 绘制`(-8, -3)` -> `D = -2 + DE = -2 + 4 = 2`。
*   `D = 2` -> 选择 `NE` -> 绘制`(-7, -2)` -> `D = 2 + DNE = 2 + -8 = -6`。
*   `D = -6` -> `E` 被选中 -> 绘制`(-6, -2)` -> `D = -6 + DE = -6 + 4 = -2`。
*   `D = -2` -> `E` 被选中 -> 绘制`(-5, -2)` -> `D = -2 + DE = -2 + 4 = 2`。
*   `D = 2` -> 选择 `NE` -> 绘制`(-4, -1)` -> `D = 2 + DNE = 2 + -8 = -6`。
*   `D = -6` -> `E` 被选中 -> 绘制`(-3, -1)` -> `D = -6 + DE = -6 + 4 = -2`。
*   `x = x1`，因此在循环时退出。
...
*   图`(-3, -6)`。
*   `D = 0` -> `E` 被选中 -> 绘制`(-3, -5)` -> `D = 0 + DE = 0 + 4 = 4`。
*   `D = 4` -> 选择 `NE` -> 绘制`(-2, -4)` -> `D = 4 + DNE = 4 + -4 = 0`。
*   `D = 0` -> `E` 被选中 -> 绘制`(-2, -3)` -> `D = 0 + DE = 0 + 4 = 4`。
