...
> 原文: [https://www.geeksforgeeks.org/product-array-puzzle-set-2-o1-space/](https://www.geeksforgeeks.org/product-array-puzzle-set-2-o1-space/)
...
然后再次遍历数组，使用公式（`乘积 * pow(a[i], -1)`）找到除该数之外的所有元素的乘积。
