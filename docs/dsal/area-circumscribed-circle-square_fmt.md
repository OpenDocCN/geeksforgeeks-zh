...
> 原文: [https://www.geeksforgeeks.org/area-circumscribed-circle-square/](https://www.geeksforgeeks.org/area-circumscribed-circle-square/)
...
> 用来计算内切圆面积的公式是: **`(PI * a * a)/2`**，其中，`a` 是正方形中圆的外切边。
>
> **这个公式是怎么用的？**
