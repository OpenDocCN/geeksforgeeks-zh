...
> 原文: [https://www.geeksforgeeks.org/program-to-convert-pixels-to-rem-and-em/](https://www.geeksforgeeks.org/program-to-convert-pixels-to-rem-and-em/)

给定一个以[像素](https://www.geeksforgeeks.org/program-to-convert-centimeters-to-pixels/)表示盒子宽度的整数`pixels`，任务是将`pixels`转换为以 [rem 和 em](https://www.geeksforgeeks.org/css-units/) 单位测量的它们的等值。
...
*   通过将`pixels`乘以 `0.0625`，计算`pixels`在 [rem 和 em](https://www.geeksforgeeks.org/css-units/) 中的等值。
*   以 [rem 和 em](https://www.geeksforgeeks.org/css-units/) 为单位打印`pixels`的等值。
