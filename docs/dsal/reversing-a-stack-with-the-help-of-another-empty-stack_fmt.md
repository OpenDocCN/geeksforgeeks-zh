...
> 原文: [https://www.geeksforgeeks.org/reversing-a-stack-with-the-help-of-another-empty-stack/](https://www.geeksforgeeks.org/reversing-a-stack-with-the-help-of-another-empty-stack/)

给定一个由 `N` 元素组成的[堆栈](https://www.geeksforgeeks.org/stack-data-structure/)，任务是使用额外的[堆栈](https://www.geeksforgeeks.org/stack-data-structure/)来反转[堆栈](https://www.geeksforgeeks.org/stack-data-structure/)。
...
*   弹出给定堆栈的[顶部元素](https://www.geeksforgeeks.org/stack-top-c-stl/)，并将其存储在临时变量中。
