...
> 原文: [https://www.geeksforgeeks.org/shortest-distance-from-the-centre-of-a-circle-to-a-chord/](https://www.geeksforgeeks.org/shortest-distance-from-the-centre-of-a-circle-to-a-chord/)

给定一个内部有弦的圆。给出了弦的长度和圆的半径。任务是找到从弦到中心的最短距离。
