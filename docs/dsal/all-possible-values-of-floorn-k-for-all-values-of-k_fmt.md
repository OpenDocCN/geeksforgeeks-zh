...
> 原文: [https://www.geeksforgeeks.org/all-possible-values-of-floor-n-k-for-all-values-of-k/](https://www.geeksforgeeks.org/all-possible-values-of-floor-n-k-for-all-values-of-k/)
...
**最简单的方法**迭代`【1，N+1】`并存储在[集合](https://www.geeksforgeeks.org/set-in-cpp-stl/)中，`(N/i)`（`1 <= i <= N + 1`）以避免重复。
以下是上述方法的实施:
