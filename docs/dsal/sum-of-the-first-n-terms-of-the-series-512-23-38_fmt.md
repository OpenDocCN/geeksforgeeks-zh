...
> 原文: [https://www.geeksforgeeks.org/sum-of-the-first-n-terms-of-the-series-512-23-38/](https://www.geeksforgeeks.org/sum-of-the-first-n-terms-of-the-series-512-23-38/)
...
方法: 让第 `n` 项用 `tn` 表示。
这个问题可以很容易地借助于这些类型级数的一个通式，上面给出的级数是一个二次级数。它们是特殊的，因为这个数列的连续项的差将是算术级数。通式如下:
