...
*   汽车底盘可以在同一条线上向前移动一个站，或者在另一条线上对角移动一个站。从 I 线移动到 j 站会产生额外的成本 t<sub>i，j</sub>。在同一条线上移动不会产生任何成本。
*   I 线 j 站的时间为 a<sub>i，j</sub>。
