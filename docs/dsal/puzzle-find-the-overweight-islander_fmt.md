...
> 原文:[https://www . geeksforgeks . org/拼图-寻找超重岛民/](https://www.geeksforgeeks.org/puzzle-find-the-overweight-islander/)
...
A [分治法](https://www.geeksforgeeks.org/divide-and-conquer/)可以如下解决这个问题。

### 第一步

将 12 人分成 3 组，每组 4 人(A、B & C)，称第一组(A)与第二组(B)的重量。
