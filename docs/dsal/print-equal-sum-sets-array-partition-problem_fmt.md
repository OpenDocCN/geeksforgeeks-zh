...
> 原文: [https://www.geeksforgeeks.org/print-equal-sum-sets-array-partition-problem/](https://www.geeksforgeeks.org/print-equal-sum-sets-array-partition-problem/)
...
PHP（Professional Hypertext Preprocessor 的缩写）是一种服务器端脚本语言。
