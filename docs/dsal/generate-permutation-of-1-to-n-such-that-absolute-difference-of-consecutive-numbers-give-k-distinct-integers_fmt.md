...
> 原文:[https://www.geeksforgeeks.org/generate-permutation-of-1-to-n-such-that-absolute-difference-of-consecutive-numbers-give-k-distinct-integers/](https://www.geeksforgeeks.org/generate-permutation-of-1-to-n-such-that-absolute-difference-of-consecutive-numbers-give-k-distinct-integers/)
...
简单观察就能轻松解决问题。奇数索引处放置递增序列 `1、2、3、…`，偶数索引处放置递减序列 `N、N-1、N-2、…` 等等。
