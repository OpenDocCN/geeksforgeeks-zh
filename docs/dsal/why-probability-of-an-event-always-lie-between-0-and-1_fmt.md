...
> 原文: [https://www.geeksforgeeks.org/why-probability-of-an-event-always-lie-between-0-and-1/](https://www.geeksforgeeks.org/why-probability-of-an-event-always-lie-between-0-and-1/)
...
1.  任何事件 `a` 的概率总是大于或等于零，即 `P(A) >= 0`。
2.  样本空间的概率总是等于 1，即 `P(S) = 1`。
3.  给定一些互斥事件，所有这些互斥事件组合的概率总是等于各个事件概率之和，即 `p (a1 ∪ a2 ∪ a3 ∪ a4 ... ∪ an) = p(a1) + p(a2) + p(a3) + ... + p(an)`。
