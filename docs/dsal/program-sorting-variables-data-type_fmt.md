...
> 原文：[https://www.geeksforgeeks.org/program-sorting-variables-data-type/](https://www.geeksforgeeks.org/program-sorting-variables-data-type/)
...
在下面的代码中，我们实现了[冒泡排序](https://www.geeksforgeeks.org/bubble-sort/)对数组进行排序。
