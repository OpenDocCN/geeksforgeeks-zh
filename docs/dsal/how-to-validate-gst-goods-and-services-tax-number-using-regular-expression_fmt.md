...
> 原文：[https://www.geeksforgeeks.org/how-to-validate-gst-goods-and-services-tax-number-using-regular-expression/](https://www.geeksforgeeks.org/how-to-validate-gst-goods-and-services-tax-number-using-regular-expression/)
...
print(isValidGSTNo(str1))

# Test Case 2:
str2 = "06BZAF67"
print(isValidGSTNo(str2))

# Test Case 3:
str3 = "AZBZAHM6385P6Z2"
print(isValidGSTNo(str3))

# Test Case 4:
str4 = "06BZ63AHM85P6Z2"
print(isValidGSTNo(str4))

# Test Case 5:
str5 = "06BZAHM6385P6F2"
print(isValidGSTNo(str5))
```
