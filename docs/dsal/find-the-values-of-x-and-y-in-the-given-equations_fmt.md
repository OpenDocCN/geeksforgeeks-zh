...
> 原文: [https://www.geeksforgeeks.org/find-the-values-of-x-and-y-in-the-given-equations/](https://www.geeksforgeeks.org/find-the-values-of-x-and-y-in-the-given-equations/)

给定两个数字 `A` 和 `B`。求方程中 `X` 和 `Y` 的值。
1.  `A = X + Y`
2.  `B = X 异或 Y`
