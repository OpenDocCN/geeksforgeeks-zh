...
> 原文: [https://www.geeksforgeeks.org/sort-an-array-based-on-the-absolute-difference-of-adjacent-elements/](https://www.geeksforgeeks.org/sort-an-array-based-on-the-absolute-difference-of-adjacent-elements/)

给定一个包含 `N` 个整数的[数组](https://www.geeksforgeeks.org/introduction-to-arrays/) `arr[]`，任务是重新排列数组的所有元素，使得数组中连续元素之间的[绝对差按递增顺序排序](https://www.geeksforgeeks.org/absolute-difference-of-all-pairwise-consecutive-elements-in-an-array/)。
...
**方法:** 使用[贪婪方法](https://www.geeksforgeeks.org/greedy-algorithms/)可以解决问题。我们知道[数组中的最大差异是在最小和最大元素之间](https://www.geeksforgeeks.org/maximum-difference-between-two-elements-in-an-array/)。利用这个事实，如果我们在答案中包含一个最小元素，那么答案数组中包含的下一个元素将是最大元素，然后包含的第三个元素将是第二个最小元素，然后包含的第四个元素将是第二个最大元素，以此类推，将得到所需的数组。
