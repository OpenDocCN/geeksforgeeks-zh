...
> 原文：[https://www.geeksforgeeks.org/how-to-validate-indian-driving-license-number-using-regular-expression/](https://www.geeksforgeeks.org/how-to-validate-indian-driving-license-number-using-regular-expression/)
...
2.  驾驶执照号码可以用以下任何格式输入：
    ...
    HR06 19850034761
    ```
3.  前两个字符应该是代表状态代码的大写字母。
4.  接下来的两个字符应该是代表实时操作系统代码的数字。
5.  接下来的四个字符应该是代表许可证颁发年份的数字。
6.  接下来的七个字符应该是 0-9 之间的任意数字。
