...
> 原文: [https://www.geeksforgeeks.org/find-the-number-of-chicks-in-a-zoo-at-nth-day/](https://www.geeksforgeeks.org/find-the-number-of-chicks-in-a-zoo-at-nth-day/)

考虑到动物园只有一只小鸡。一只小鸡每天生 2 只小鸡，小鸡的预期寿命是 6 天。任务是找到第 `N` 天的小鸡数量。
...
**有效方法:** 如果你仔细观察，你可以观察到一个模式，即动物园中第 `N` 天的小鸡数量可以直接使用公式 `pow(3, N-1)` 来计算。
