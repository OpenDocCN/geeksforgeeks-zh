...
给定一个数字 `N`，任务是找到第 `N` 个 **Icositrigonal 数**。

> 一个整数是一类整数。它有一个 23 边的多边形，叫做 Icositrigon。第 `N` 个 Icositrigonal 数字计数是 23 个点的数量，所有其他点都被一个公共的共享角包围并形成一个图案。前几个 Icositrigonal 数字是 **1、23、66、130、215、321、448……**
