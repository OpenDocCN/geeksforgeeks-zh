...
> 原文：[`https://www.geeksforgeeks.org/tail-recursion-to-calculate-sum-of-array-elements/`](https://www.geeksforgeeks.org/tail-recursion-to-calculate-sum-of-array-elements/)
...
这里尾部递归的关键是无论函数调用应用了什么操作，都将其作为单独的函数参数维护。
