...
> 原文: [https://www.geeksforgeeks.org/python-program-for-count-pairs-with-given-sum/](https://www.geeksforgeeks.org/python-program-for-count-pairs-with-given-sum/)
...
更多详情请参考[给定和计数对的完整文章](https://www.geeksforgeeks.org/count-pairs-with-given-sum/)！