...
> 原文：[https://www.geeksforgeeks.org/xor-encryption-shifting-plaintext/](https://www.geeksforgeeks.org/xor-encryption-shifting-plaintext/)
...
加密和解密的关键成分在于**异或**的属性。异或是一种逐位运算，如果两个可能的输入相同，结果为 `1`，但输入不同，结果为 `0`。异或表如下，供参考：
