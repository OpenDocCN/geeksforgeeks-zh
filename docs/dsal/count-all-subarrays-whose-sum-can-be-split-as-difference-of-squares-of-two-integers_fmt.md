...
> 原文: [https://www.geeksforgeeks.org/count-all-subarrays-whose-sum-can-be-split-as-difference-of-squares-of-two-integers/](https://www.geeksforgeeks.org/count-all-subarrays-whose-sum-can-be-split-as-difference-of-squares-of-two-integers/)
...
> 子阵列 `{3}` = 3 = 2<sup>2</sup>–1<sup>2</sup>
> 子阵列 `{5}` = 5 = 3<sup>2</sup>–2<sup>2</sup>
> 子阵列 `{1，3}` = 4 = 2<sup>2</sup>–0<sup>2</sup>
> 子阵列 `{3，5}` = 8 = 3<sup>2</sup>–1<sup>2</sup>
> 子阵列 `{1，3，5}` 之和 = 9 = 5<sup>2</sup>–4<sup>2</sup>
...
为了解决这个问题，需要进行观察。除了可以用 `((4 * N) + 2)` 形式表示的数字之外，任何数字都可以表示为两个正方形的差，其中 `N` 是整数。因此，可以按照以下步骤计算答案:
