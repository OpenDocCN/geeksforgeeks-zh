...
> 原文: [https://www.geeksforgeeks.org/program-to-check-strong-number/](https://www.geeksforgeeks.org/program-to-check-strong-number/)

**强数**是位数阶乘之和等于原数的数。给定一个数`n`，检查它是否是强数。
