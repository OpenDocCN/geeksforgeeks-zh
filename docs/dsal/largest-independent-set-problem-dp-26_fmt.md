...
> 原文：[https://www.geeksforgeeks.org/largest-independent-set-problem-dp-26/](https://www.geeksforgeeks.org/largest-independent-set-problem-dp-26/)

给定一棵二叉树，找出其中最大的独立集的大小。如果一个树节点子集的任意两个节点之间没有边，则该子集是一个独立的集合。
