# 从 BST 构建二叉树，使其层级顺序遍历打印排序后的数据

> 原文: [https://www.geeksforgeeks.org/build-binary-tree-from-bst-such-that-its-level-order-traversal-prints-sorted-data/](https://www.geeksforgeeks.org/build-binary-tree-from-bst-such-that-its-level-order-traversal-prints-sorted-data/)
