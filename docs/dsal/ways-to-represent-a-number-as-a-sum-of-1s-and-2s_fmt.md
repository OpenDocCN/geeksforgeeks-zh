...
> 原文: [https://www.geeksforgeeks.org/ways-to-represent-a-number-as-a-sum-of-1s-and-2s/](https://www.geeksforgeeks.org/ways-to-represent-a-number-as-a-sum-of-1s-and-2s/)
...
我们可以在 O(Log n)时间内找到第 `N` 个斐波那契数。请参考本岗位[方法五](https://www.geeksforgeeks.org/program-for-nth-fibonacci-number/)。
以下是本办法的实施情况:
