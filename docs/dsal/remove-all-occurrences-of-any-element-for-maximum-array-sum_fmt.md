...
> 原文: [https://www.geeksforgeeks.org/remove-all-occurrences-of-any-element-for-maximum-array-sum/](https://www.geeksforgeeks.org/remove-all-occurrences-of-any-element-for-maximum-array-sum/)
...
一种**更好的逼近**是先求数组的总和，然后对数组进行排序，遍历数组的同时统计各个频率，得到最大值。排序后，我们可以使用 O(n) 时间内所有元素的频率，
