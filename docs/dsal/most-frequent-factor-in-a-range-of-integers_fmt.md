...
> 原文: [https://www.geeksforgeeks.org/most-frequent-factor-in-a-range-of-integers/](https://www.geeksforgeeks.org/most-frequent-factor-in-a-range-of-integers/)
...
1.  如果`lower`=`higher`，则所有因子的频率都为 1。所以我们可以打印任何因子的数字，因为每个数字都是自身的因子，所以我们打印相同的数字。
