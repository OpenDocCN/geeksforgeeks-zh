...
> 原文: [https://www.geeksforgeeks.org/javascript-math-atanh-function/](https://www.geeksforgeeks.org/javascript-math-atanh-function/)

`Math.atanh()` 函数是 JavaScript 中的一个内置函数，用来获取一个数的双曲反正切。
