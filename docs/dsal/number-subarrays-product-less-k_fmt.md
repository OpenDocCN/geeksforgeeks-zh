...
> 原文: [https://www.geeksforgeeks.org/number-subarrays-product-less-k/](https://www.geeksforgeeks.org/number-subarrays-product-less-k/)
...
这个问题的一个天真的方法是生成阵列的所有子阵列，然后计算乘积小于 `k` 的阵列的数量。
下面是上述方法的实现:
