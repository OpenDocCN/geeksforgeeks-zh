# 给定两个字符串，找出第一个字符串是否是第二个的子序列

> 原文: [https://www.geeksforgeeks.org/given-two-strings-find-first-string-subsequence-second/](https://www.geeksforgeeks.org/given-two-strings-find-first-string-subsequence-second/)
