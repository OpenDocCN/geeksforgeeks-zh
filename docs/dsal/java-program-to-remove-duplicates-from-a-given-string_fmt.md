...
> 原文：[https://www.geeksforgeeks.org/java-program-to-remove-duplicates-from-a-given-string/](https://www.geeksforgeeks.org/java-program-to-remove-duplicates-from-a-given-string/)
...
## 方法 2（使用 BST）
使用[集合](https://www.geeksforgeeks.org/set-in-cpp-stl/)，实现二叉查找树的自平衡。
