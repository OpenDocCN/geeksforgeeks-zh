...
> 原文：[https://www.geeksforgeeks.org/bitwise-operations-on-subarrays-of-size-k/](https://www.geeksforgeeks.org/bitwise-operations-on-subarrays-of-size-k/)
...
以下代码展示了如何寻找大小为 K 的子阵中，每个元素进行位或（OR）运算后的最大值。
...
`O(n * B)` 其中 `n` 是数组的大小，`B` 是大小为 32 的整数数组位。

# 辅助空间

`O(n)`

下面是寻找[最小位与子阵](https://www.geeksforgeeks.org/bitwise-and-of-sub-array-closest-to-k/)的程序:
...
下面是寻找`最小逐位异或子阵列`的程序: [https://www.geeksforgeeks.org/find-the-subarray-of-size-k-with-minimum-xor/](https://www.geeksforgeeks.org/find-the-subarray-of-size-k-with-minimum-xor/)
