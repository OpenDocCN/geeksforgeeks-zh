...
> 原文：[https://www.geeksforgeeks.org/find-the-count-of-substrings-in-alphabetic-order/](https://www.geeksforgeeks.org/find-the-count-of-substrings-in-alphabetic-order/)

给定一串由小写字母组成的长度为 `N` 的字符串。任务是找到字符按字母顺序出现的子字符串的数量。子字符串的最小允许长度为 2。
