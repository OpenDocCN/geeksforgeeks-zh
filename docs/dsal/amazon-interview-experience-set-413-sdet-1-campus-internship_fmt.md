...
> 原文: [https://www.geeksforgeeks.org/amazon-interview-experience-set-413-sdet-1-campus-internship/](https://www.geeksforgeeks.org/amazon-interview-experience-set-413-sdet-1-campus-internship/)

这是亚马逊为实习而开设的泳池校园。

## 线上回合

有 20 道 MCQ (+各 1 道) 和 2 道编码题 (+各 30 道)。MCQ 有更多的网络和 DS 问题。
