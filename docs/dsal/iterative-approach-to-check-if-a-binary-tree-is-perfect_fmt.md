...
> 原文：[https://www.geeksforgeeks.org/iterative-approach-to-check-if-a-binary-tree-is-perfect/](https://www.geeksforgeeks.org/iterative-approach-to-check-if-a-binary-tree-is-perfect/)
...
想法是使用一个队列和一个变量`标志`，初始化为零，检查是否发现了叶节点。我们将检查：
