...
> 原文: [https://www.geeksforgeeks.org/find-nth-term-of-the-series-5-2-13-41/](https://www.geeksforgeeks.org/find-nth-term-of-the-series-5-2-13-41/)
...
**方法:** 问题看起来很难，但方法很简单。如果 `n` 的值是奇数，则第 `n` 项将是 `((n + 1 ) ^ 2 ) + n`。否则，它将是 `((n–1)^ 2)+n`。
