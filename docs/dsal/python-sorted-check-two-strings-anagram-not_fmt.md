...
> 原文: [https://www.geeksforgeeks.org/python-sorted-check-two-strings-anagram-not/](https://www.geeksforgeeks.org/python-sorted-check-two-strings-anagram-not/)
...
*   使用 `Counter()` 计算第一个字符串和第二个字符串的所有频率
*   如果它们相等，则打印字谜
