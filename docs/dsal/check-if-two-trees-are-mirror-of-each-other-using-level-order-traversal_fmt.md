...
> 原文: [https://www.geeksforgeeks.org/check-if-two-trees-are-mirror-of-each-other-using-level-order-traversal/](https://www.geeksforgeeks.org/check-if-two-trees-are-mirror-of-each-other-using-level-order-traversal/)
...
已经讨论了[递归解](https://www.geeksforgeeks.org/check-if-two-trees-are-mirror/)和使用有序遍历来检查两个二叉树是否是彼此的镜像的[迭代方法](https://www.geeksforgeeks.org/iterative-method-check-two-trees-mirror/)。在这篇文章中，已经讨论了使用[级顺序遍历](https://www.geeksforgeeks.org/level-order-tree-traversal/)的解决方案。
