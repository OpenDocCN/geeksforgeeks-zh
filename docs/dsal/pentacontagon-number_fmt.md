...
给定一个编号 `N`，任务是找到 `N`<sup>th</sup> [五角星编号](https://en.wikipedia.org/wiki/Pentacontagon)。
...
*   因此 50 边多边形的第 `n` 项是
> ![T_n =\frac{((50-2)n^2 - (50-4)n)}{2} =\frac{(48n^2 - 46n)}{2}](img/036e4d787ec779751277b71081548ac5.png "Rendered by QuickLaTeX.com")
...
**参考资料:** [https://en.wikipedia.org/wiki/Pentacontagon](https://en.wikipedia.org/wiki/Pentacontagon)