...
> 原文: [https://www.geeksforgeeks.org/generate-an-array-of-size-n-according-to-the-given-rules/](https://www.geeksforgeeks.org/generate-an-array-of-size-n-according-to-the-given-rules/)
...
**方法:** 想法是首先创建一个填充有大小为 `n` 的零的数组。然后对于每次迭代，我们搜索该元素是否发生在最近的过去。如果是，那么我们遵循 `规则 1`。否则，遵循 `规则 2` 来填充数组。
以下是上述方法的实现:
