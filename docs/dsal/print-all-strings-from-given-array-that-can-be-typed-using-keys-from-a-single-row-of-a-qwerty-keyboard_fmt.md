...
> 原文: [https://www.geeksforgeeks.org/print-all-strings-from-given-array-that-can-be-typed-using-keys-from-a-single-row-of-a-qwerty-keyboard/](https://www.geeksforgeeks.org/print-all-strings-from-given-array-that-can-be-typed-using-keys-from-a-single-row-of-a-qwerty-keyboard/)
...
> “Had”可以从第 2<sup>nd</sup> 行输入。
> “GFG”可以从 2<sup>nd</sup> 行输入。
> 因此，需要的输出是 **Yeti Had GFG**。
>
> **输入:** `arr[] = {"Geeks", "for", "Geeks", "Geek"}`
> **输出:** Geek
