...
> 原文:[https://www.geeksforgeeks.org/print-path-common-two-paths-root-two-given-nodes/](https://www.geeksforgeeks.org/print-path-common-two-paths-root-two-given-nodes/)
...
2.  如果 `LCA` 存在，则打印从根到 `LCA` 的路径。参见[本](https://www.geeksforgeeks.org/print-path-root-given-node-binary-tree/)。否则打印“无公共路径”。
