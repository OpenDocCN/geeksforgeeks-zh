...
> 原文: [https://www.geeksforgeeks.org/permutation-of-first-n-positive-integers-such-that-prime-numbers-are-at-prime-indices-set-2/](https://www.geeksforgeeks.org/permutation-of-first-n-positive-integers-such-that-prime-numbers-are-at-prime-indices-set-2/)

给定一个整数 `N`，任务是找到前 `N` 个正整数的排列数，使得素数位于素数索引处（对于基于 1 的索引）。

**注:** 既然途径数可能很大，返回答案模 `10^9 + 7`。
...
**进场: 使用** [**厄拉多塞筛**](https://www.geeksforgeeks.org/sieve-of-eratosthenes/)
