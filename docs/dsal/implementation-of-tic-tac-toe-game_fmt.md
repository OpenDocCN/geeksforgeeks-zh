...
在我们的程序中，计算机和人类采取的走法是随机选择的。我们为此使用`rand()`函数。
...
如上所述，如果两个有经验的玩家在玩井字游戏，那么游戏总是会打平。这款游戏还有另一个病毒变种——终极井字游戏，旨在让正常的井字游戏变得更有趣、更不可预测。看一下这里的游戏：[Link1](https://mathwithbaddrawings.com/2013/06/16/ultimate-tic-tac-toe/) [Link2](http://www.geek.com/games/tic-tac-toe-made-much-more-interesting-with-a-simple-tweak-1559289/)
