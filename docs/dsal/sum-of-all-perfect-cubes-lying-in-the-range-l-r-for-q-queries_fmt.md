...
> 原文: [https://www.geeksforgeeks.org/sum-of-all-perfect-cubes-lying-in-the-range-l-r-for-q-queries/](https://www.geeksforgeeks.org/sum-of-all-perfect-cubes-lying-in-the-range-l-r-for-q-queries/)
...
2.  `pref[]` 数组中的第 `i` 个索引代表从 1 到该数字的完美立方体的总和。
