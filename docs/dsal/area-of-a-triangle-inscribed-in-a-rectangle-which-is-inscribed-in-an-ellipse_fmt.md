...
> 原文: [https://www.geeksforgeeks.org/area-of-a-triangle-inscribed-in-a-rectangle-which-is-inscribed-in-an-ellipse/](https://www.geeksforgeeks.org/area-of-a-triangle-inscribed-in-a-rectangle-which-is-inscribed-in-an-ellipse/)
...
我们知道椭圆内接矩形的面积是 `Ar = 2ab` ([请参考此处](https://www.geeksforgeeks.org/area-of-largest-rectangle-that-can-be-inscribed-in-an-ellipse/))，也是矩形 `s` 内接三角形的面积，`A = Ar/2 = ab` ([请参考此处](https://www.geeksforgeeks.org/area-of-largest-triangle-that-can-be-inscribed-within-a-rectangle/))。
