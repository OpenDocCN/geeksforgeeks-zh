...
> 原文：[https://www.geeksforgeeks.org/minimum-removals-required-such-that-a-string-can-be-rearranged-to-form-a-palindrome/](https://www.geeksforgeeks.org/minimum-removals-required-such-that-a-string-can-be-rearranged-to-form-a-palindrome/)
...
*   计算奇数频率的字符数，并将其存储在一个变量中，例如 `count`。
*   如果 `count` 为 `1` 或 `0`，则打印 `0` 作为答案。否则，打印 `count - 1` 作为答案。
