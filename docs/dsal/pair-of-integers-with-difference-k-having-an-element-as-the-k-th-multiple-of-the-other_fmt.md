...
> 原文: [https://www.geeksforgeeks.org/pair-of-integers-with-difference-k-having-an-element-as-the-k-th-multiple-of-the-other/](https://www.geeksforgeeks.org/pair-of-integers-with-difference-k-having-an-element-as-the-k-th-multiple-of-the-other/)
...
*   可以观察到，如果 `K` 的值是 `1`，那么就找不到这样的对，因为 `A` 和 `B` 的分母都变成了 0。
