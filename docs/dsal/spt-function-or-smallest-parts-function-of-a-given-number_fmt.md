...
> 原文: [https://www.geeksforgeeks.org/spt-function-or-smallest-parts-function-of-a-given-number/](https://www.geeksforgeeks.org/spt-function-or-smallest-parts-function-of-a-given-number/)
...
思路是考虑从 1 到 `N` 的每一个整数，并将其加入到一个答案向量中，对于和减少的剩余元素再次递归。为了避免再次打印相同的制图表达，每个制图表达都将按升序构建。如果达到 `N` 的表示，我们将找到答案向量中最小元素出现的频率，并添加到 Spt 值变量中，最后打印 Spt 变量的值。
