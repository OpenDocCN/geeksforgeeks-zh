...
> 原文：[https://www.geeksforgeeks.org/array-value-by-repeatedly-replacing-max-2-elements-with-their-absolute-difference/](https://www.geeksforgeeks.org/array-value-by-repeatedly-replacing-max-2-elements-with-their-absolute-difference/)

给定一个数组 `arr`，大小为 `N`，任务是当数组的最大值和第二个最大值元素被它们在数组中的绝对差替换时，重复打印数组中剩余的最终数组值。
