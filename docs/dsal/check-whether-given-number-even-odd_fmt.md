...
> 原文: [https://www.geeksforgeeks.org/check-whether-given-number-even-odd/](https://www.geeksforgeeks.org/check-whether-given-number-even-odd/)
...
一个更好的解决方案是使用按位运算符。我们需要检查最后一位是否为 1。如果最后一位是 1，那么数字是奇数，否则总是偶数。
