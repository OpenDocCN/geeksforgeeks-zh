...
> 原文: [https://www.geeksforgeeks.org/sum-of-multiplication-of-triplet-of-divisors-of-a-number/](https://www.geeksforgeeks.org/sum-of-multiplication-of-triplet-of-divisors-of-a-number/)
...
存储一个数的所有除数，应用蛮力方法，对于每个三元组，将这三个元素的乘积加到答案中。

## 高效方法

这个方法类似于厄拉多塞的[筛](https://www.geeksforgeeks.org/sieve-of-eratosthenes/)，我们用它来求一个范围的所有素数。
