...
> 原文: [https://www.geeksforgeeks.org/number-of-square-matrices-with-all-1s/](https://www.geeksforgeeks.org/number-of-square-matrices-with-all-1s/)

给定一个只包含 0 和 1 的 `N*M` 矩阵，任务是计算包含所有 1 的正方形子矩阵的数量。

**例:**

> **输入:** `arr[][] = {{0，1，1，1}，{1，1，1，1}，{0，1，1，1}}`
> **输出:** 15
> **说明:**
> 边长 1 的方块有 10 个。
> 边长 2 的正方形有 4 个。
