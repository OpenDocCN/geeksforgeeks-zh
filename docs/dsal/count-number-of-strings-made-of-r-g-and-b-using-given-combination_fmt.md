...
> 原文: [https://www.geeksforgeeks.org/count-number-of-strings-made-of-r-g-and-b-using-given-combination/](https://www.geeksforgeeks.org/count-number-of-strings-made-of-r-g-and-b-using-given-combination/)

我们需要制作一个大小为 `n` 的字符串，字符串的每个字符不是‘R’、‘B’就是‘G’。在最后的字符串中需要有至少 `R` 个‘R’，至少 `B` 个‘B’和至少 `G` 个‘G’(比如 `r + g + b <= n`)。我们需要找出可能的字符串数量。
...
问于: [方向](https://www.geeksforgeeks.org/directi-interview-set-5-campus/)
