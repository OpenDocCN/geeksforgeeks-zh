...
> 原文: [https://www.geeksforgeeks.org/square-root-of-two-complex-numbers/](https://www.geeksforgeeks.org/square-root-of-two-complex-numbers/)
...
根据以上观察，使用上述公式计算 `X` 和 `Y` 的值，并将值 `(X + i*Y)` 打印为给定复数的平方根值。
