...
> 原文：[https://www.geeksforgeeks.org/print-all-subsequences-of-a-string-using-arraylist/](https://www.geeksforgeeks.org/print-all-subsequences-of-a-string-using-arraylist/)

给定一个字符串 `str`，任务是打印 `str` 的所有子序列。
一个[子序列](https://en.wikipedia.org/wiki/Subsequence)是一个序列，可以通过删除一些元素或不删除元素而不改变剩余元素的顺序，从另一个序列中派生出来。
...
```
g e ge e ge ee gee k gk ek gek gek eek geek
```
