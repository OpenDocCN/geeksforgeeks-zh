...
> 原文: [https://www.geeksforgeeks.org/compute-the-maximum-power-with-a-given-condition/](https://www.geeksforgeeks.org/compute-the-maximum-power-with-a-given-condition/)

给定 3 个整数 `N`，`M` 和 `K`。任务是找到最大 `P` 使得 `N * K^P ≤ M`。
