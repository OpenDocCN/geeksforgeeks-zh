...
> 原文：[https://www.geeksforgeeks.org/java-program-for-printing-nth-node-from-the-end-of-a-linked-list/](https://www.geeksforgeeks.org/java-program-for-printing-nth-node-from-the-end-of-a-linked-list/)
...
下面是同一方法的递归 Java 代码。感谢 Anuj Bansal 提供以下代码。
