...
> 原文: [https://www.geeksforgeeks.org/sum-of-k-largest-elements-in-bst/](https://www.geeksforgeeks.org/sum-of-k-largest-elements-in-bst/)

给定一个 [BST](https://www.geeksforgeeks.org/binary-search-tree-set-1-search-and-insertion/)，任务是求大于等于第 `k` 个最大元素的所有元素的和。
