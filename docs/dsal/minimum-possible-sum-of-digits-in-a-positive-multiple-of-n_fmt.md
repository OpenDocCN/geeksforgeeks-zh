...
> 原文：[https://www.geeksforgeeks.org/minimum-possible-sum-of-digits-in-a-positive-multiple-of-n/](https://www.geeksforgeeks.org/minimum-possible-sum-of-digits-in-a-positive-multiple-of-n/)
...
以 `N = 11` 为例，答案为 2。它从 `11*1 = 11` 到 `11*10 = 110`。
