...
> 原文：[https://www.geeksforgeeks.org/find-position-given-number-among-numbers-made-4-7/](https://www.geeksforgeeks.org/find-position-given-number-among-numbers-made-4-7/)
...
如果数字是 4，那么它是树的左节点，那么它对应于(`pos`*2)+1。否则右子节点(7)对应于(`pos`*2)+2。
