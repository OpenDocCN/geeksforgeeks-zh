...
> 原文: [https://www.geeksforgeeks.org/area-of-the-circle-that-has-a-square-and-a-circle-inscribed-in-it/](https://www.geeksforgeeks.org/area-of-the-circle-that-has-a-square-and-a-circle-inscribed-in-it/)

给定正方形的边`a`和保持在圆内的边。它一直膨胀，直到它的四个顶点都接触到圆的圆周。另一个更小的圆现在被保留在正方形内，它不断地膨胀，直到它的圆周接触到正方形的所有四边。外环和内环形成一个环。如下图所示，找到阴影部分的区域。
