...
> 原文: [https://www.geeksforgeeks.org/sum-of-sides-of-largest-and-smallest-child-polygons-possible-from-a-given-polygon/](https://www.geeksforgeeks.org/sum-of-sides-of-largest-and-smallest-child-polygons-possible-from-a-given-polygon/)
...
思路是先找到主多边形的边数，然后，检查是否有可能做出次多边形。按照以下步骤解决问题:
