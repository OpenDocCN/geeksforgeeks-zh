...
> 原文：[https://www.geeksforgeeks.org/find-the-sum-of-the-first-nth-centered-pentagonal-number/](https://www.geeksforgeeks.org/find-the-sum-of-the-first-nth-centered-pentagonal-number/)

给定一个数字 `N`，任务是找到前 `N` 个中心五边形数的和。

> 前几个居中的五边形数是 1，6，16，31，51，76，106 …
...
1.  运行[循环](https://www.geeksforgeeks.org/loops-in-c-and-cpp/)从 1 开始到 `N`，找到第 `i` 个中心五边形数。
2.  将上面计算的所有中心五边形数相加。
3.  然后，显示前 `N` 个中心五边形数字之和。
