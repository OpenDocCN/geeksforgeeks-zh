...
> 原文: [https://www.geeksforgeeks.org/k-distant-prime-pairs-in-a-given-range/](https://www.geeksforgeeks.org/k-distant-prime-pairs-in-a-given-range/)
...
**时间复杂度:** `O(sqrt((N))*(R–L+1)^2`，其中 `N` 为`【L，R】`范围内的任意数字。
**辅助空间:** `O(1)`
