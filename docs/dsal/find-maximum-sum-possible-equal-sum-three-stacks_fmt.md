...
> 原文:[https://www . geeksforgeeks . org/find-最大可能和-等和-三栈/](https://www.geeksforgeeks.org/find-maximum-sum-possible-equal-sum-three-stacks/)
...
这种方法之所以有效，因为元素是积极的。为了使和相等，我们必须从堆栈中移除一些具有更多和的元素，并且我们只能从顶部移除。
...
https://youtu.be/PZ-tngvx-0?list=plqm7alhxfysf7lap-wi5qlad8oebx9rmv
