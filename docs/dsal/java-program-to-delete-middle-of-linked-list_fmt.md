...
> 原文：[https://www.geeksforgeeks.org/java-program-to-delete-middle-of-linked-list/](https://www.geeksforgeeks.org/java-program-to-delete-middle-of-linked-list/)
...
class GfG {
    ...
    static Node deleteMid(Node head) {
        ...
        Node prev = null; // To store previous of slow_ptr
