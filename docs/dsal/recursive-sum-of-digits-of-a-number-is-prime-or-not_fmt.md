...
> 原文：[https://www.geeksforgeeks.org/recursive-sum-of-digits-of-a-number-is-prime-or-not/](https://www.geeksforgeeks.org/recursive-sum-of-digits-of-a-number-is-prime-or-not/)

给定一个数字 `n`，我们需要找到这个数字的每个数字的和，直到这个数字变成一个数字。如果总和是质数，我们需要打印“Yes”，如果不是质数，我们需要打印“No”。
