...
> 原文：[https://www.geeksforgeeks.org/program-to-find-sum-of-the-given-sequence/](https://www.geeksforgeeks.org/program-to-find-sum-of-the-given-sequence/)

给定两个数字`N`和`K`。任务是找出下面给出的序列的和。
