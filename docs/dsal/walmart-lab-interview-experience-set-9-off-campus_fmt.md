...
> 原文: [https://www.geeksforgeeks.org/walmart-lab-interview-experience-set-9-off-campus/](https://www.geeksforgeeks.org/walmart-lab-interview-experience-set-9-off-campus/)
...
1. 每个中间词必须在字典中。
2. 您只能更改单词中的一个字符来转换为另一个单词。

例如，如果给你的起始词是“SAT”，结束词是“PAN”，并且字典包含的单词=[“RAT”、“PAT”、“DAM”]，那么 SAT -> PAT -> PAN 就是答案。
