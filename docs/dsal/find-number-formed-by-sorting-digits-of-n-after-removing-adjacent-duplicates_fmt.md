...
> 原文：[https://www.geeksforgeeks.org/find-number-formed-by-sorting-digits-of-n-after-removing-adjacent-duplicates/](https://www.geeksforgeeks.org/find-number-formed-by-sorting-digits-of-n-after-removing-adjacent-duplicates/)
...
2.  创建一个函数 `getDigits()`，它将接受一个整数作为参数，并以字符串的形式返回它。
