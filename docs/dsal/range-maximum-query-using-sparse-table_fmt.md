...
> 原文：[https://www.geeksforgeeks.org/range-maximum-query-using-sparse-table/](https://www.geeksforgeeks.org/range-maximum-query-using-sparse-table/)
...
回答范围最小查询的类似问题已经在[这里](https://www.geeksforgeeks.org/sparse-table/)讨论过了。可以修改相同的方法来回答最大范围查询。下面是修改：
