...
> 原文：[https://www.geeksforgeeks.org/total-number-of-possible-binary-search-trees-with-n-keys/](https://www.geeksforgeeks.org/total-number-of-possible-binary-search-trees-with-n-keys/)
...
具有 `n` 个不同键的可能二叉树总数(`countBT(n)`)= `countBST(n) * n!`
