...
> 原文: [https://www.geeksforgeeks.org/find-sum-of-the-series-1-23-45-67/](https://www.geeksforgeeks.org/find-sum-of-the-series-1-23-45-67/)

给定一个数字 `n`，任务是找到下面系列的和，直到第 `n` 项。
...
如果我们仔细观察，可以看到上述级数的和遵循从 1 到 `N` 的正负整数交替的模式，如下所示:
