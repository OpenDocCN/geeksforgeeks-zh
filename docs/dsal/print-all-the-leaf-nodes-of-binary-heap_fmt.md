...
> 原文: [https://www.geeksforgeeks.org/print-all-the-leaf-nodes-of-binary-heap/](https://www.geeksforgeeks.org/print-all-the-leaf-nodes-of-binary-heap/)

给定一个表示二进制堆的数组表示的 `N` 元素数组，任务是找到这个[二进制堆](https://www.geeksforgeeks.org/binary-heap/)的叶节点。
...
问题中的关键观察是，如果 `H` 是二进制堆的高度，那么二进制堆的每个叶节点都将处于高度 `H` 或 `H - 1` 处。因此，叶节点可以计算如下:
