...
> 原文：[https://www.geeksforgeeks.org/python-convert-list-characters-string/](https://www.geeksforgeeks.org/python-convert-list-characters-string/)
...
可以通过初始化 `str1 = ""` 来轻松地连接字符列表，以便其间没有空格。
