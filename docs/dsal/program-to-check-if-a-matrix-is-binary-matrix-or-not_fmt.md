...
> 原文：[https://www.geeksforgeeks.org/program-to-check-if-a-matrix-is-binary-matrix-or-not/](https://www.geeksforgeeks.org/program-to-check-if-a-matrix-is-binary-matrix-or-not/)
...
**方法：** 遍历矩阵，检查每个元素是 `0` 还是 `1`。如果有除 `0` 和 `1` 之外的任何元素，则打印 `No`，否则打印 `Yes`。
