...
在下面的代码中，`nCr` 是使用[动态编程方法](https://www.geeksforgeeks.org/dynamic-programming-set-9-binomial-coefficient/)实现的，你可以在这里阅读更多相关内容。
...
PHP 是 Professional Hypertext Preprocessor 的缩写。
...
本文由 `乌卡什·特里维迪` 供稿。如果你喜欢 GeeksforGeeks 并想投稿，你也可以使用 [write.geeksforgeeks.org](https://write.geeksforgeeks.org) 写一篇文章或者把你的文章邮寄到 `contribute@geeksforgeeks.org`。看到你的文章出现在极客博客主页上，帮助其他极客。
