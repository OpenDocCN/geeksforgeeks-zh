...
> 原文：[https://www.geeksforgeeks.org/scheduling-in-greedy-algorithms/](https://www.geeksforgeeks.org/scheduling-in-greedy-algorithms/)
...
*   在这种情况下，事件的最大数量是两个。作为选定的赛事 `B` 和 `D` 如下：
