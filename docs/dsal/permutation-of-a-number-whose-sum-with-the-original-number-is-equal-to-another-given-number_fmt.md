...
> 原文: `https://www.geeksforgeeks.org/permutation-of-a-number-whose-sum-with-the-original-number-is-equal-to-another-given-number/`
...
**天真法:** 解决问题最简单的方法是[生成数字`A`的所有排列](https://www.geeksforgeeks.org/write-a-c-program-to-print-all-permutations-of-a-given-string/)，并与 `A` 的原值相加。现在，检查它们的总和是否等于 `C`。

***时间复杂度:** O((log<sub>10</sub> `A`)!)*
***辅助空间:** O(1)*
