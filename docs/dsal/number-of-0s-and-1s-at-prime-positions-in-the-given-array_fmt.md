...
> 原文：[https://www.geeksforgeeks.org/number-of-0s-and-1s-at-prime-positions-in-the-given-array/](https://www.geeksforgeeks.org/number-of-0s-and-1s-at-prime-positions-in-the-given-array/)
...
遍历数组，如果当前索引是质数，则每遇到一个 0，就更新 0 的计数，并更新所有处于质数索引的 1 的计数。
