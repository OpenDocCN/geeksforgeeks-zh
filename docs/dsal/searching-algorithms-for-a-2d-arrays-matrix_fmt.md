...
> 原文: [https://www.geeksforgeeks.org/searching-algorithms-for-a-2d-arrays-matrix/](https://www.geeksforgeeks.org/searching-algorithms-for-a-2d-arrays-matrix/)
...
2D 数组中线性搜索的时间复杂度为 `O(N * M)`，其中 `N` 是行数，`M` 是列数。
