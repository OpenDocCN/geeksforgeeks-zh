...
> 原文：[https://www.geeksforgeeks.org/why-integer-size-varies-from-computer-to-computer/](https://www.geeksforgeeks.org/why-integer-size-varies-from-computer-to-computer/)
...
3.  如果某个程序试图将某个值存储在一个大于该变量所能存储的最大值的整数变量中，则可能会出现整数溢出。
