...
> 原文: [https://www.geeksforgeeks.org/find-the-batting-average-of-a-batsman/](https://www.geeksforgeeks.org/find-the-batting-average-of-a-batsman/)

给定三个整数分别代表得分的跑数、匹配、未出局代表击球手打出的局数和他保持未出局的次数，任务是计算击球手的[击球率](https://en.wikipedia.org/wiki/Batting_average_(cricket))。
...
> **输入:** `runs`= 10000，`matches`= 250，`notout`= 50
> **输出:** 50
> **说明:**
> 击球手被解雇次数= 250–50 = 200
> 击球率= 10000 / 200 = 50。
>
> **输入:** `runs`= 100，`matches`= 1，`notout`= 1
> **输出:** NA
...
1.  计算解雇次数，等于`matches - notout`。
2.  计算击球率，等于`runs / (matches - notout)`。
