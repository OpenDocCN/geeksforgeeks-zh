...
> 原文: [https://www.geeksforgeeks.org/find-nth-term-dragon-curve-sequence/](https://www.geeksforgeeks.org/find-nth-term-dragon-curve-sequence/)
...
这也就是俗称的**常规折纸顺序**。给定一个自然数 `n`。任务是找到长度为 `2^n - 1` 的龙曲线序列形成的第 `n` 根弦。
