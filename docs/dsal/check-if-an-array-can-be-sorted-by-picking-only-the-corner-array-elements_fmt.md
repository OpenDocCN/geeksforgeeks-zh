...
> 原文: [https://www.geeksforgeeks.org/check-if-an-array-can-be-sorted-by-picking-only-the-corner-array-elements/](https://www.geeksforgeeks.org/check-if-an-array-can-be-sorted-by-picking-only-the-corner-array-elements/)

给定一个由 `N` 个元素组成的数组 `arr[]`，任务是检查给定的数组是否可以通过只选取角元素来排序，即可以选择数组左侧或右侧的元素。
...
要解决这个问题，我们需要使用一个类似于[双音素序列](https://www.geeksforgeeks.org/find-bitonic-point-given-bitonic-sequence/)的概念。按照以下步骤解决问题:
