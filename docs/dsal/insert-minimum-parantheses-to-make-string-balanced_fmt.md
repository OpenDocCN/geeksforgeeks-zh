...
> 原文: [https://www.geeksforgeeks.org/insert-minimum-parantheses-to-make-string-balanced/](https://www.geeksforgeeks.org/insert-minimum-parantheses-to-make-string-balanced/)
...
2.  然后我们迭代字符串，从 1 到字符串的长度。
    ...
    *   如果 `w >= 0`，则插入 `w` 个右括号，并将 `p` 更新为 (`p - w`)。否则，
