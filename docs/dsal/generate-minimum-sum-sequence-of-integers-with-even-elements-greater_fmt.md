...
> 原文: [https://www.geeksforgeeks.org/generate-minimum-sum-sequence-of-integers-with-even-elements-greater/](https://www.geeksforgeeks.org/generate-minimum-sum-sequence-of-integers-with-even-elements-greater/)

给定一个整数 `N`，任务是生成一个长度为 `N` 的正整数序列，使得：
