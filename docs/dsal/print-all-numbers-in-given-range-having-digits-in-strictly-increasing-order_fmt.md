...
> 原文: [https://www.geeksforgeeks.org/print-all-numbers-in-given-range-having-digits-in-strictly-increasing-order/](https://www.geeksforgeeks.org/print-all-numbers-in-given-range-having-digits-in-strictly-increasing-order/)
...
思路是迭代范围 `[L, R]`，对于该范围内的每个数字，检查该数字的位数是否严格递增。如果是，则打印该号码，否则检查下一个号码。
