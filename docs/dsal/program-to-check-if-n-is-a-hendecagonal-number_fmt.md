...
> 原文: [https://www.geeksforgeeks.org/program-to-check-if-n-is-a-hendecagonal-number/](https://www.geeksforgeeks.org/program-to-check-if-n-is-a-hendecagonal-number/)
...
3.  如果使用上述公式计算的 `K` 的值是整数，那么 `N` 是一个亨德戈纳尔数。
4.  否则 `N` 不是韩德正交数。
