...
> 原文: [https://www.geeksforgeeks.org/permutation-of-a-string-with-maximum-number-of-characters-greater-than-its-adjacent-characters/](https://www.geeksforgeeks.org/permutation-of-a-string-with-maximum-number-of-characters-greater-than-its-adjacent-characters/)
...
4.  答案将是 `((n–1)/2，n–max_freq–flag)` 的最小值。
