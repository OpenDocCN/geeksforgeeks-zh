...
> 原文: [https://www.geeksforgeeks.org/reverse-the-rows-and-columns-of-a-matrix-alternatively/](https://www.geeksforgeeks.org/reverse-the-rows-and-columns-of-a-matrix-alternatively/)

给定一个大小为 `M*N` 的矩阵 `arr[][]`，其中 `M` 是行的数量，`N` 是列的数量。任务是将矩阵的行和列交替反转，即先反转第一行，再反转第二列，依此类推。

**示例**:

> **输入** : `arr[][] = { {3, 4, 1, 8}, {11, 23, 43, 21}, {12, 17, 65, 91}, {71, 56, 34, 24} }`
> **输出** : `{ {8, 56, 4, 24}, {11, 17, 43, 12}, ... }`
> *   反转第一行
> *   反转第二列
> *   反转第三行
> *   反转第四列
