...
> 原文: [https://www.geeksforgeeks.org/sort-the-array-having-one-misplaced-number-by-swapping-elements-any-number-of-times/](https://www.geeksforgeeks.org/sort-the-array-having-one-misplaced-number-by-swapping-elements-any-number-of-times/)
...
这个问题可以用[**贪婪进场**](https://www.geeksforgeeks.org/greedy-algorithms/)解决。由于最终数组要排序，放错位置的元素左侧的**元素必须更小，右侧的元素必须更大**。按照下面给出的步骤解决问题:
