...
> 原文: [https://www.geeksforgeeks.org/check-large-number-divisible-5-not/](https://www.geeksforgeeks.org/check-large-number-divisible-5-not/)
...
本文由 `Danish_RAZA` 供稿。如果你喜欢 GeeksforGeeks 并想投稿，你也可以使用 [write.geeksforgeeks.org](https://write.geeksforgeeks.org) 写一篇文章或者把你的文章邮寄到 `contribute@geeksforgeeks.org`。看到你的文章出现在极客博客主页上，帮助其他极客。
