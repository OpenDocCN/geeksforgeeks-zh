...
> 原文：[https://www.geeksforgeeks.org/heapq-python-print-elements-sorted-order-row-column-wise-sorted-matrix/](https://www.geeksforgeeks.org/heapq-python-print-elements-sorted-order-row-column-wise-sorted-matrix/)
...
此问题已有解决方案，请参考链接。我们将在 Python 中使用[合并两个排序数组](https://www.geeksforgeeks.org/merge-two-sorted-arrays-python-using-heapq/)的相同方法，使用 [`heapq` 模块](https://www.geeksforgeeks.org/heap-queue-or-heapq-in-python/)来解决这个问题。
