...
> 原文: [https://www.geeksforgeeks.org/convert-given-complex-numbers-into-polar-form-and-perform-all-arithmetic-operations/](https://www.geeksforgeeks.org/convert-given-complex-numbers-into-polar-form-and-perform-all-arithmetic-operations/)
...
*   复数 `Z` 的极坐标形式为:
    ...
    >
    > 其中，`r` 被称为复数的模，![\theta](img/5a47c79344ecb82823a74b87e4a14bb8.png "Rendered by QuickLaTeX.com")是与正 `X` 轴的夹角。
