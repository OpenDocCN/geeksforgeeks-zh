...
> 原文：[https://www.geeksforgeeks.org/check-if-a-number-is-a-pythagorean-prime-or-not/](https://www.geeksforgeeks.org/check-if-a-number-is-a-pythagorean-prime-or-not/)

给定一个正整数 `N`，检查它是否是毕达哥拉斯素数。如果是毕达哥拉斯素数，则打印“是”，否则打印“否”。

[**毕达哥拉斯素数**](https://en.wikipedia.org/wiki/Pythagorean_prime) 是形如 `4*n+1` 的素数。也可以表示为两个平方之和。

1-100 范围内的毕达哥拉斯素数是：5、13、17、29、37、41、53、61、73、89、97。
