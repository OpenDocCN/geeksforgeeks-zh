...
> 原文: [https://www.geeksforgeeks.org/sum-parent-nodes-child-node-x/](https://www.geeksforgeeks.org/sum-parent-nodes-child-node-x/)

给定一个包含 `n` 个节点的二叉树。问题是找到所有父节点的和，这些父节点有一个值为 `x` 的子节点。
