...
> 原文: [https://www.geeksforgeeks.org/find-the-angle-between-tangents-drawn-from-a-given-external-point-to-a-circle/](https://www.geeksforgeeks.org/find-the-angle-between-tangents-drawn-from-a-given-external-point-to-a-circle/)
...
function tangentAngle(x1, y1, x2, y2, radius)
{
    ...
    // Find the angle using the formula
    var result = 2 * Math.asin(radius / distance) * 180 / 3.1415;
