...
> 原文: [https://www.geeksforgeeks.org/print-all-possible-k-length-subsequences-of-first-n-natural-numbers-with-sum-n/](https://www.geeksforgeeks.org/print-all-possible-k-length-subsequences-of-first-n-natural-numbers-with-sum-n/)
...
**输入:** `N = 5`，`K = 3`
**输出:** `{ {1, 1, 3}, {1, 2, 2}, {1, 3, 1}, {2, 1, 2}, {2, 2, 1}, {3, 1, 1} }`
**说明:**
1 + 1 + 3 = `N`(= 5) 长度为 `K`(= 3)
1 + 2 + 2 = `N`(= 5) 长度为 `K`(= 3)
1 + 3 + 1 = `N`(= 5) 长度为 `K`(= 3)
...
使用[回溯技术](https://www.geeksforgeeks.org/backtracking-algorithms/)可以解决问题。下面是循环关系:
