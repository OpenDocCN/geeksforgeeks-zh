...
class LinkedList:
    ...
    def printList(self):
        ...
        while(ptr != None): 
            print(ptr.data, '->', end = '')
            # Moving the iterating object to next node 
            ptr = ptr.next
        print()
...
def reverse(head_ref):
    ...
    # at None and starting node respectively. 
    prev = None
    ...
    # to main head object. 
    head_ref.head = prev
    # Returning the lemgth of linked list. 
    return Len
...
def multiplyTwoLists(first, second):
    ...
    while(second_ptr != None): 
        ...
        # node from which we started last time. 
        result_ptr2 = result_ptr1 
    ...
    # Remove starting nodes containing zeroes. 
    start = result.head 
    while(start.data == 0): 
        result.head = start.next
        start = start.next

    # Return the resultant multiplicated linked list. 
    return result
...
if __name__=='__main__':
    ...
    # Pushing elements at start of first linked list. 
    first.push(9) 
    first.push(6) 
    first.push(4) 
    first.push(9) 
    ...
    # Pushing elements at start of second linked list. 
    second.push(9) 
    second.push(4) 
    second.push(8) 
    second.push(9) 
    ...
    # Multiply two linked list and print the result. 
