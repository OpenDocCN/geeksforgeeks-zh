...
> 原文: [https://www.geeksforgeeks.org/number-arrays-size-n-whose-elements-positive-integers-sum-k/](https://www.geeksforgeeks.org/number-arrays-size-n-whose-elements-positive-integers-sum-k/)
