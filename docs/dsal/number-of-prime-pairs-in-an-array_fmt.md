...
> 原文: [https://www.geeksforgeeks.org/number-of-prime-pairs-in-an-array/](https://www.geeksforgeeks.org/number-of-prime-pairs-in-an-array/)
...
一个有效的方法是使用厄拉多塞筛计算数组中的素数。假设是 `C`。现在，可能对的总数等于 `C*(C-1)/2`。
