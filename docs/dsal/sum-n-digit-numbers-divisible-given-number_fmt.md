...
> 原文: [https://www.geeksforgeeks.org/sum-n-digit-numbers-divisible-given-number/](https://www.geeksforgeeks.org/sum-n-digit-numbers-divisible-given-number/)
...
**高效方法:**
首先，找出能被给定数整除的 n 位数[个数](https://www.geeksforgeeks.org/count-n-digit-numbers-divisible-by-given-number/)。然后应用[公式计算 AP](https://www.geeksforgeeks.org/program-sum-arithmetic-series/) 之和。
