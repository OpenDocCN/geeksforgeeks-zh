...
> 原文: [https://www.geeksforgeeks.org/find-smallest-permutation-given-number/](https://www.geeksforgeeks.org/find-smallest-permutation-given-number/)
...
**处理方法:**
由于数字很长，将数字存储为字符串，对字符串进行排序，如果没有前导零，则返回该字符串，如果有前导零，则用字符串的第一个非零元素交换字符串的第一个元素，并返回该字符串。
以下是上述方法的实施:
