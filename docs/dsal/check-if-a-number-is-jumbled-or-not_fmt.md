...
> 原文: [https://www.geeksforgeeks.org/check-if-a-number-is-jumbled-or-not/](https://www.geeksforgeeks.org/check-if-a-number-is-jumbled-or-not/)
...
要发现一个数字是否乱码，我们只需要检查一个数字是否有差大于 1 的邻居。如果找到了这样的数字，这个数字就不乱了。
