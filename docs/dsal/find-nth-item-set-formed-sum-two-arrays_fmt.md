# 在两个数组之和形成的集合中找到第N个项目

> 原文：[https://www.geeksforgeeks.org/find-nth-item-set-formed-sum-two-arrays/](https://www.geeksforgeeks.org/find-nth-item-set-formed-sum-two-arrays/)
