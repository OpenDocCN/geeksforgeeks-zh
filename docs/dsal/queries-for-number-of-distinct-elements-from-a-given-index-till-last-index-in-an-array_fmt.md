...
> 原文: [https://www.geeksforgeeks.org/queries-for-number-of-distinct-elements-from-a-given-index-till-last-index-in-an-array/](https://www.geeksforgeeks.org/queries-for-number-of-distinct-elements-from-a-given-index-till-last-index-in-an-array/)
...
> **输出:** `5 5 3 1`
> 在查询 1 中，`a[0…7]`中的不同整数的数量为 `5` (`1, 2, 3, 4, 5`)
> 在查询 2 中，`a[3…7]`中的不同整数的数量为 `5` (`1, 2, 3, 4, 5`)
