...
> 原文: [https://www.geeksforgeeks.org/split-a-given-string-into-substrings-of-length-k-with-equal-sum-of-ascii-values/](https://www.geeksforgeeks.org/split-a-given-string-into-substrings-of-length-k-with-equal-sum-of-ascii-values/)
...
> **输出:** YES
> **解释:**
> 3 个长度子串{ "abd", "cbb", "dba" }它们的 ASCII 值之和等于 295。
