...
> 原文: [https://www.geeksforgeeks.org/print-rectangular-pattern-with-given-center/](https://www.geeksforgeeks.org/print-rectangular-pattern-with-given-center/)

给定 `3` 个正整数 `c1`，`c2` 和 `n`，其中 `n` 是[二维正方形矩阵的大小](https://www.geeksforgeeks.org/how-to-access-elements-of-a-square-matrix/)。任务是打印填充有矩形图案的矩阵，该矩形图案具有中心坐标 `c1`、`c2`，使得 `0 <= c1, c2 < n`。
