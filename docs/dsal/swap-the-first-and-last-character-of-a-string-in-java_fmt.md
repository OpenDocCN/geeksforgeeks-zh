...
> 原文：[https://www.geeksforgeeks.org/swap-the-first-and-last-character-of-a-string-in-java/](https://www.geeksforgeeks.org/swap-the-first-and-last-character-of-a-string-in-java/)
...
## 方法 2 – 使用 `StringBuilder.setCharAt()` 方法

1.  获取要交换的第一个和最后一个字符的字符串。
2.  检查字符串是否只有一个字符，然后返回字符串。
3.  使用作为参数传递的给定字符串创建一个 `StringBuilder` 对象。
