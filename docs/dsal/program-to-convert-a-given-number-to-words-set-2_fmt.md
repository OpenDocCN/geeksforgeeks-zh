...
> 原文：[https://www.geeksforgeeks.org/program-to-convert-a-given-number-to-words-set-2/](https://www.geeksforgeeks.org/program-to-convert-a-given-number-to-words-set-2/)
...
**解决方案：** 这种方法可以处理长度小于 `ULLONG_MAX`（无符号长整型对象的最大值）的 20 位数字。`ULLONG_MAX` 在十进制中等于 18446744073709551615，假设编译器取 8 个字节存储无符号长整型。
