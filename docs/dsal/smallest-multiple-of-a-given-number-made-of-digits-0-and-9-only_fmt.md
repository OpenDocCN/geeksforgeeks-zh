...
> 原文: [https://www.geeksforgeeks.org/smallest-multiple-of-a-given-number-made-of-digits-0-and-9-only/](https://www.geeksforgeeks.org/smallest-multiple-of-a-given-number-made-of-digits-0-and-9-only/)
...
解决这个问题的想法是生成并存储所有可以用数字 0 和 9 构成的数字。然后在这些生成的数中找出能被 `n` 整除的最小数。我们将使用[生成二进制数的方法](https://www.geeksforgeeks.org/interesting-method-generate-binary-numbers-1-n/)生成所有能用数字 0 & 9 构成的数。
