...
> 原文: [https://www.geeksforgeeks.org/check-if-two-arrays-are-equal-or-not/](https://www.geeksforgeeks.org/check-if-two-arrays-are-equal-or-not/)
...
以下是上述想法的实现。我们使用`unordered_map`来存储计数。
