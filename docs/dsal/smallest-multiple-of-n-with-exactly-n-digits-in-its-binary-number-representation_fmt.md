...
> 原文: [https://www.geeksforgeeks.org/smallest-multiple-of-n-with-exactly-n-digits-in-its-binary-number-representation/](https://www.geeksforgeeks.org/smallest-multiple-of-n-with-exactly-n-digits-in-its-binary-number-representation/)
...
> **输出:** `20`
> **说明:**
> `20` 是 `5` 的最小倍数，在二进制中长度也是 `5` (`10100`)。
