...
> 原文：[https://www.geeksforgeeks.org/find-the-next-factorial-greater-than-n/](https://www.geeksforgeeks.org/find-the-next-factorial-greater-than-n/)
...
1.  在一个[数组](https://www.geeksforgeeks.org/introduction-to-arrays/)中将所有数字的[阶乘](https://www.geeksforgeeks.org/program-for-factorial-of-a-number/)预先计算到 `20`，因为 `20! > 10^18`。
