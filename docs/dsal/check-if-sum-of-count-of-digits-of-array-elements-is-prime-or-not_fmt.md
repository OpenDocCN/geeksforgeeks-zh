...
> 原文: [https://www.geeksforgeeks.org/check-if-sum-of-count-of-digits-of-array-elements-is-prime-or-not/](https://www.geeksforgeeks.org/check-if-sum-of-count-of-digits-of-array-elements-is-prime-or-not/)
...
3.  将每根弦的[长度加到 `sum` 上。](https://www.geeksforgeeks.org/c-program-to-find-the-length-of-a-string/)
4.  在完成阵列的[遍历后，检查 `sum` 的值，](https://www.geeksforgeeks.org/c-program-to-traverse-an-array/)是否为[质数](https://www.geeksforgeeks.org/primality-test-set-1-introduction-and-school-method/)。
5.  如果发现为真，打印 `Yes`。否则，打印 `No`。
