...
> 原文: [https://www.geeksforgeeks.org/construct-a-binary-in-level-order-using-recursion/](https://www.geeksforgeeks.org/construct-a-binary-in-level-order-using-recursion/)
...
一棵 n 层的完美二叉树有 `2^(n-1)` 节点，所有的叶节点都在同一层。
