...
> 原文: [https://www.geeksforgeeks.org/program-to-find-the-discount-percentage/](https://www.geeksforgeeks.org/program-to-find-the-discount-percentage/)

给定产品的标价 `M` 和售价 `S`。任务是计算应用于该产品的折扣百分比。
