# 从 1 开始，重复乘以 K 或 2 正好 N 次可能的最小数

> 原文: [https://www.geeksforgeeks.org/smallest-number-possible-by-repeatedly-multiplying-with-k-or-2-exactly-n-times-starting-from-1/](https://www.geeksforgeeks.org/smallest-number-possible-by-repeatedly-multiplying-with-k-or-2-exactly-n-times-starting-from-1/)
...
给定的问题可以用[贪婪方法](https://www.geeksforgeeks.org/greedy-algorithms/)解决。其思想是重复执行其中一个给定的操作，直到局部执行第二个操作使 `X` 的值最大化。按照以下步骤解决问题:
