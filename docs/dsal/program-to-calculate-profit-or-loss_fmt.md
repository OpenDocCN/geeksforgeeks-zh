...
> 原文: [https://www.geeksforgeeks.org/program-to-calculate-profit-or-loss/](https://www.geeksforgeeks.org/program-to-calculate-profit-or-loss/)
...
    // Function to calculate Loss.
    function Loss(costPrice, sellingPrice)
    {
