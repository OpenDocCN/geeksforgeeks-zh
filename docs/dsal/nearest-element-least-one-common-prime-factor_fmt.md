...
> 原文：[https://www.geeksforgeeks.org/nearest-element-least-one-common-prime-factor/](https://www.geeksforgeeks.org/nearest-element-least-one-common-prime-factor/)
...
我们找到所有数组元素的素因子。为了快速找到质因数，我们使用[埃拉托斯特尼的筛](https://www.geeksforgeeks.org/sieve-of-eratosthenes/)。对于每个元素，我们考虑所有的素因子，并使用一个公共因子来跟踪最接近的元素。
