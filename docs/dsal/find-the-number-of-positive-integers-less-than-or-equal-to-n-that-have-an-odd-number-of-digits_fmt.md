...
> 原文: [https://www.geeksforgeeks.org/find-the-number-of-positive-integers-less-than-or-equal-to-n-that-have-an-odd-number-of-digits/](https://www.geeksforgeeks.org/find-the-number-of-positive-integers-less-than-or-equal-to-n-that-have-an-odd-number-of-digits/)

给定一个整数 `N`，其中 `1 ≤ N ≤ 10^5`，任务是找出小于或等于 `N` 的正整数个数，其位数为奇数，没有前导零。
