...
> 原文: [https://www.geeksforgeeks.org/sum-of-absolute-difference-of-maximum-and-minimum-of-all-subarrays/](https://www.geeksforgeeks.org/sum-of-absolute-difference-of-maximum-and-minimum-of-all-subarrays/)
...
方法是找到所有可能的子阵，并保持它们的最大值和最小值，然后用它们来计算和。现在，按照下面的步骤来解决这个问题:

1.  创建一个变量 `sum` 来存储最终答案并将其初始化为 `0`。
