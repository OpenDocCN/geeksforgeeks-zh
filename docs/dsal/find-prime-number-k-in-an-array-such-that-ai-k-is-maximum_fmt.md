...
> 原文: [https://www.geeksforgeeks.org/find-prime-number-k-in-an-array-such-that-ai-k-is-maximum/](https://www.geeksforgeeks.org/find-prime-number-k-in-an-array-such-that-ai-k-is-maximum/)

给定一个由 `n` 个整数组成的数组 `arr[]`。任务是从数组中找到一个元素 `K`，使得：
1.  `K` 为质数。
...
1.  首先，使用[埃拉托斯特尼筛法](https://www.geeksforgeeks.org/sieve-eratosthenes-0n-time-complexity/)从数组中找出所有小于或等于最大元素的素数。
