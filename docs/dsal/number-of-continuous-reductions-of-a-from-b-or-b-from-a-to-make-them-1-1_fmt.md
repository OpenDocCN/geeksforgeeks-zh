...
**高效方法:**想法是使用[欧几里德算法](https://www.geeksforgeeks.org/euclidean-algorithms-basic-and-extended/)来解决这个问题。通过这种方法，我们可以在 `A/B` 步骤中从`(A，B)`到`(A % B，B)`。但是如果 `A` 和 `B` 的最小值是 1，那么我们可以在`A–1`步中达到(1，1)。
