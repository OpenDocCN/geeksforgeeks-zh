...
# JavaScript 实现：寻找第 n 个 k 位回文数

下面的 JavaScript 程序展示了如何寻找第 `n` 个 `k` 位回文数。
...
- [如何高效计算第 n 位数字回文](http://stackoverflow.com/questions/11925840/how-to-calculate-nth-n-digit-palindrome-efficiently)
