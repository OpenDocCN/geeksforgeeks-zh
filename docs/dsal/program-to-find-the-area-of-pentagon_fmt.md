...
> 原文: [https://www.geeksforgeeks.org/program-to-find-the-area-of-pentagon/](https://www.geeksforgeeks.org/program-to-find-the-area-of-pentagon/)
...
设 `a` 为五边形的边，那么求五边形面积的公式由面积=![\frac{1}{4}\sqrt{5\left ( 5 + 2\sqrt{5} \right )} a^{2}](img/bda5f701bfcd31c797543ca1edad670a.png "Rendered by QuickLaTeX.com") 给出。
