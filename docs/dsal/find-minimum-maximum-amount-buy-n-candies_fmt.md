...
> 原文:[https://www.geeksforgeeks.org/find-minimum-maximum-amount-buy-n-candies/](https://www.geeksforgeeks.org/find-minimum-maximum-amount-buy-n-candies/)
...
**另一个实现:**
我们可以借助最小整数函数(天花板函数)使用内置的`ceil()`函数来实现:
