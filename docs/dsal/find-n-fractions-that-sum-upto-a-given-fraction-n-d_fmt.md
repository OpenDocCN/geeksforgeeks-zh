...
> 原文：[`https://www.geeksforgeeks.org/find-n-fractions-that-sum-upto-a-given-fraction-n-d/`](https://www.geeksforgeeks.org/find-n-fractions-that-sum-upto-a-given-fraction-n-d/)
...
问题中的关键观察是，第一个分数分子可以是 `D + N - 1`，然后进一步的 `N-1` 分母可以使用下面的递推关系。
