...
> 原文: [https://www.geeksforgeeks.org/smallest-perfect-square-divisible-by-all-elements-of-an-array/](https://www.geeksforgeeks.org/smallest-perfect-square-divisible-by-all-elements-of-an-array/)
...
**有效方法:** 找到数组中所有元素的[最小公倍数](https://www.geeksforgeeks.org/c-program-find-lcm-two-numbers/)，并将其存储在变量`lcm`中。找到找到的 LCM 的所有`质因数`。
现在检查是否有`质因数`除以`lcm`奇数次。如果有这些因素，将`LCM`乘以这些因素。最后打印更新后的`LCM`。
