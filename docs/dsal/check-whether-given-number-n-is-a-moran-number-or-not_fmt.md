...
> 原文：[https://www.geeksforgeeks.org/check-whether-given-number-n-is-a-moran-number-or-not/](https://www.geeksforgeeks.org/check-whether-given-number-n-is-a-moran-number-or-not/)

给定一个整数 `N`，检查给定的数字是否为**莫兰数字**。莫兰数字是[哈沙德数字](https://www.geeksforgeeks.org/harshad-or-niven-number/)的一个子集。
