...
> 原文：[https://www.geeksforgeeks.org/check-if-a-number-n-can-be-represented-as-a-sum-of-multiples-of-3-5-and-7/](https://www.geeksforgeeks.org/check-if-a-number-n-can-be-represented-as-a-sum-of-multiples-of-3-5-and-7/)
...
*   如果 `N` 是 `3x + 1` 的形式，
    *   如果 `N > 7`，那么 `N` 可以表示为 `3*(x-2)+7`，因为 `7` 类似于 `3*2 + 1`。
    *   否则如果 `N <= 7`，则不能以给定的形式表示。
*   如果 `N` 是 `3n + 2` 的形式，
    *   如果 `N > 5`，那么 `N` 可以表示为 `3x + 5`，因为 `5` 类似于 `3*1 + 2`。
