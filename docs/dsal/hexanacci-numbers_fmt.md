...
思路是按照递归求数，用[递归](https://www.geeksforgeeks.org/recursion/)求解。
...
一个**更好的解决方案**是使用[**动态编程**](https://www.geeksforgeeks.org/dynamic-programming/)的想法是跟踪的最后六个术语来计算系列的最后一个当前术语。将本系列的最后六个术语初始化为:
