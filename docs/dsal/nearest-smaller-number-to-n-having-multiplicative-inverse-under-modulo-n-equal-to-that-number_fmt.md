...
> 原文：[https://www.geeksforgeeks.org/nearest-smaller-number-to-n-having-multiplicative-inverse-under-modulo-n-equal-to-that-number/](https://www.geeksforgeeks.org/nearest-smaller-number-to-n-having-multiplicative-inverse-under-modulo-n-equal-to-that-number/)
...
解决这个问题最简单的方法是[遍历所有从 1 到 `N` 的自然数](https://www.geeksforgeeks.org/c-program-to-print-numbers-from-1-to-n-without-using-semicolon/)，找到最大的数，使得[模 `N` 下数的模乘逆](https://www.geeksforgeeks.org/multiplicative-inverse-under-modulo-m/)等于数本身。
