...
> 原文: [https://www.geeksforgeeks.org/minimum-time-required-to-fill-a-cistern-using-n-pipes/](https://www.geeksforgeeks.org/minimum-time-required-to-fill-a-cistern-using-n-pipes/)
...
*   同样，如果管道 2 可以在 `m` 小时内充满水箱，那么在一小时内，管道 2 将能够充满 `1/m` 水箱。
*   所以在...对于其他管道。
...
> 上述表达式的结果将是所有管道在 1 小时内共同完成的那部分工作，假设为 `a / b`。
> 计算加满水箱的时间为 `b / a`。
