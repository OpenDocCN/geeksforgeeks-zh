...
> 原文: [https://www.geeksforgeeks.org/program-spearmans-rank-correlation/](https://www.geeksforgeeks.org/program-spearmans-rank-correlation/)

## 前提条件
[相关系数](https://www.geeksforgeeks.org/program-find-correlation-coefficient/)
...
用于计算集合 `X` 和 `Y` 的皮尔逊相关系数（`r` 或 `ρ`）的公式如下：
