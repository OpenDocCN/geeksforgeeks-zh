...
> 原文: [https://www.geeksforgeeks.org/accolite-interview-experience-set-8/](https://www.geeksforgeeks.org/accolite-interview-experience-set-8/)
...
2.  [在一个数组中找出其和在 `K` 的所有对。](https://practice.geeksforgeeks.org/problems/count-pairs-with-given-sum/0) 例如 `[-1，2，5，3，2]`，`k=4`，输出为 `{2，2}`，`{-1，5}`。
...
## 相关实践问题
- [Count ways to N’th Stair(Order does not matter)](https://practice.geeksforgeeks.org/problems/count-ways-to-nth-stairorder-does-not-matter/0)
- [Binary Array Sorting](https://practice.geeksforgeeks.org/problems/binary-array-sorting/0)
