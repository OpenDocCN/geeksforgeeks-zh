...
> 原文：[https://www.geeksforgeeks.org/program-check-strength-password/](https://www.geeksforgeeks.org/program-check-strength-password/)
...
给定一个字符串，找到它的强度。让强密码满足以上所有条件。中等密码满足前三个条件，长度至少为 6。否则密码为弱。
