...
> 原文：[https://www.geeksforgeeks.org/time-taken-loop-unrolling-vs-normal-loop/](https://www.geeksforgeeks.org/time-taken-loop-unrolling-vs-normal-loop/)
...
关于普通循环与循环展开的比较，请参考[循环展开](https://www.geeksforgeeks.org/loop-unrolling/)。