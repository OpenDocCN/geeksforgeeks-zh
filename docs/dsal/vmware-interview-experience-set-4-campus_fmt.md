# VMware 面试体验 | 第 4 集 (校内)

> 原文: [https://www.geeksforgeeks.org/vmware-interview-experience-set-4-campus/](https://www.geeksforgeeks.org/vmware-interview-experience-set-4-campus/)
...
第二部分是技术，包括 20 个关于网络的问题（关于 `SSH`、`TelNet`、`TCP/IP` 等的高级问题）和操作系统概念（像内存管理和调度算法）。
...
6. [数组中 kth 最小的元素](https://practice.geeksforgeeks.org/problems/kth-smallest-element/0)

拼图：
[2 个鸡蛋，100 个地板拼图](https://www.geeksforgeeks.org/puzzle-set-35-2-eggs-and-100-floors/)
