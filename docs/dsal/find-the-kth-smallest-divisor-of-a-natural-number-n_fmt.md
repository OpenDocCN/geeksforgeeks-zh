...
> 原文：[https://www.geeksforgeeks.org/find-the-kth-smallest-divisor-of-a-natural-number-n/](https://www.geeksforgeeks.org/find-the-kth-smallest-divisor-of-a-natural-number-n/)

给你一个数字 `N` 和一个数字 `K`。我们的任务是找到 `N` 的第 `k` 个最小除数。
