...
> 原文: [https://www.geeksforgeeks.org/program-to-check-if-a-number-is-divisible-by-sum-of-its-digits/](https://www.geeksforgeeks.org/program-to-check-if-a-number-is-divisible-by-sum-of-its-digits/)
...
**做法:** 解决问题的思路是提取数字的位数并相加。然后检查这个数是否能被它的数字之和整除。如果是可分的，则打印是，否则打印否。以下是上述方法的实现:
