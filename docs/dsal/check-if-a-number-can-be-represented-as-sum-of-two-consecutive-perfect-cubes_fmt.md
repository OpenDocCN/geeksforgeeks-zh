...
> 原文: [https://www.geeksforgeeks.org/check-if-a-number-can-be-represented-as-sum-of-two-consecutive-perfect-cubes/](https://www.geeksforgeeks.org/check-if-a-number-can-be-represented-as-sum-of-two-consecutive-perfect-cubes/)
...
**天真法:** 解决问题最简单的方法是从 1 迭代到 `N` 的[立方根](https://www.geeksforgeeks.org/find-cubic-root-of-a-number/)，检查任意两个连续数的完美立方之和是否等于 `N`。如果发现是真的，打印“是”。否则，打印“否”。
