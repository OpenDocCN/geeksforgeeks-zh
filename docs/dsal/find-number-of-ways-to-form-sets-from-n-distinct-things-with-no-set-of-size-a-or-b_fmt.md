...
> 原文: [https://www.geeksforgeeks.org/find-number-of-ways-to-form-sets-from-n-distinct-things-with-no-set-of-size-a-or-b/](https://www.geeksforgeeks.org/find-number-of-ways-to-form-sets-from-n-distinct-things-with-no-set-of-size-a-or-b/)
...
思路是先找到包含大小套的路数包括 `A`、`B` 和空套。然后去掉尺寸 `A`、`B` 的套数，清空套数。
