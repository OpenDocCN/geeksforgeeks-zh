...
> 原文: [https://www.geeksforgeeks.org/number-of-m-length-sorted-arrays-that-can-be-formed-using-first-n-natural-numbers/](https://www.geeksforgeeks.org/number-of-m-length-sorted-arrays-that-can-be-formed-using-first-n-natural-numbers/)
