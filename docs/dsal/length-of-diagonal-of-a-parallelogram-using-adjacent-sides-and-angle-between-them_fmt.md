...
> 原文: [https://www.geeksforgeeks.org/length-of-diagonal-of-a-parallelogram-using-adjacent-sides-and-angle-between-them/](https://www.geeksforgeeks.org/length-of-diagonal-of-a-parallelogram-using-adjacent-sides-and-angle-between-them/)

给定两个整数 `a` 和 `b`，其中 `a` 和 `b` 代表平行四边形相邻边的长度和它们之间的角度 `θ`，任务是求平行四边形对角线的长度。
