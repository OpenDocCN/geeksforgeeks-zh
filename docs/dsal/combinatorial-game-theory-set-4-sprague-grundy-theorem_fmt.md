...
> 原文: [https://www.geeksforgeeks.org/combinatorial-game-theory-set-4-sprague-grundy-theorem/](https://www.geeksforgeeks.org/combinatorial-game-theory-set-4-sprague-grundy-theorem/)
...
我们已经在 Set 2 (https://www.geeksforgeeks.org/combinatorial-game-theory-set-2-game-nim/) 中看到，我们可以在 nim 的一场游戏中找到谁赢了，而无需实际玩游戏。
...
游戏从 3 堆石头开始，每堆有 3、4 和 5 块石头，玩家可以从任何一堆石头中取出任意正数量的最多 3 块石头[前提是该堆有那么多石头]。最后移动的玩家获胜。假设两个玩家都玩得最好，哪个玩家会赢？
