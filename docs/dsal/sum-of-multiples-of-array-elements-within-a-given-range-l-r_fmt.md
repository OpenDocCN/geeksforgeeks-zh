...
> 原文:[https://www.geeksforgeeks.org/sum-of-multiples-of-array-elements-within-a-given-range-l-r/](https://www.geeksforgeeks.org/sum-of-multiples-of-array-elements-within-a-given-range-l-r/)
...
天真的想法是对于给定数组中的每个元素 `arr[]` 找到该元素在范围 `[L，R]` 内的倍数，并打印所有倍数的总和。
