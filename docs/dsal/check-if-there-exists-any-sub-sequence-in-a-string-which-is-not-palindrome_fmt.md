...
> 原文：[https://www.geeksforgeeks.org/check-if-there-exists-any-sub-sequence-in-a-string-which-is-not-palindrome/](https://www.geeksforgeeks.org/check-if-there-exists-any-sub-sequence-in-a-string-which-is-not-palindrome/)
