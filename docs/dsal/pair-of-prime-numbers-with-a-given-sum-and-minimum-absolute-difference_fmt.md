...
> 原文：[https://www.geeksforgeeks.org/pair-of-prime-numbers-with-a-given-sum-and-minimum-absolute-difference/](https://www.geeksforgeeks.org/pair-of-prime-numbers-with-a-given-sum-and-minimum-absolute-difference/)

给定一个整数`和`（小于 10^8），任务是从所有可能的对中找出一对和等于给定`和`的素数，所选对之间的绝对差必须最小。
