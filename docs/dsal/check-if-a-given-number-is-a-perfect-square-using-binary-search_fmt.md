# 使用二分搜索法检查给定的数字是否是完美的正方形

> 原文: [https://www.geeksforgeeks.org/check-if-a-given-number-is-a-perfect-square-using-binary-search/](https://www.geeksforgeeks.org/check-if-a-given-number-is-a-perfect-square-using-binary-search/)
...
*   从开始和最后一个值找到中间元素，并将中间(`mid*mid`)的平方值与 `n` 进行比较。
