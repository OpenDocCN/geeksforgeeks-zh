...
> 原文: [https://www.geeksforgeeks.org/sum-of-all-even-numbers-in-range-l-and-r/](https://www.geeksforgeeks.org/sum-of-all-even-numbers-in-range-l-and-r/)
...
**方法-2:** 求从 `L` 到 `R` 的所有自然数的[和](https://www.geeksforgeeks.org/sum-of-all-natural-numbers-in-range-l-to-r/)，从中减去 `L` 到 `R` 范围内奇数自然数的[和](https://www.geeksforgeeks.org/sum-of-all-odd-natural-numbers-in-range-l-and-r/)。
