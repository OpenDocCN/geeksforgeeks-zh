...
> 原文: [https://www.geeksforgeeks.org/node-whose-removal-minimizes-the-maximum-size-forest-from-an-n-ary-tree/](https://www.geeksforgeeks.org/node-whose-removal-minimizes-the-maximum-size-forest-from-an-n-ary-tree/)
