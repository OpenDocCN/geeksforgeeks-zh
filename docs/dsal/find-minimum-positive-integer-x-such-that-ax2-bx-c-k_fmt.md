...
> 原文: [https://www.geeksforgeeks.org/find-minimum-positive-integer-x-such-that-ax2-bx-c-k/](https://www.geeksforgeeks.org/find-minimum-positive-integer-x-such-that-ax2-bx-c-k/)

给定四个整数 `a`、`b`、`c` 和 `k`。任务是找到 `x` 的最小正值，使得 `ax^2 + bx + c >= k`。
