...
> 原文: [https://www.geeksforgeeks.org/find-the-array-element-from-indices-not-divisible-by-k-having-largest-composite-product-of-digits/](https://www.geeksforgeeks.org/find-the-array-element-from-indices-not-divisible-by-k-having-largest-composite-product-of-digits/)
...
> `arr[2] = 89`: 数字乘积 = `8 * 9 = 72`
> `arr[7] = 34`: 位数乘积 = `3 * 4 = 12`
...
*   遍历给定数组 `arr[]`。
*   对于每个数组元素，检查其数字的乘积是复合数还是其数字的乘积小于或等于 `1`。
