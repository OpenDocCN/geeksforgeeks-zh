...
> 原文: [https://www.geeksforgeeks.org/program-to-check-if-n-is-a-triacontagonal-number/](https://www.geeksforgeeks.org/program-to-check-if-n-is-a-triacontagonal-number/)
...
2.  因为我们必须检查给定的数是否可以表示为三十进制数。这可以通过以下方式进行检查:
> =>
...
3.  最后，检查使用此公式计算的值是否为整数，这意味着 `N` 是一个三十进制数。
