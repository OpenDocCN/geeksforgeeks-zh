...
使用两个循环从两个链表中选择元素，并检查该对的总和是否等于 `x` 。
...
使用合并排序技术以升序对第一个链表和降序排列第二个[列表](https://www.geeksforgeeks.org/merge-sort-for-linked-list/)。 现在，按照以下方式从左到右遍历两个列表：
