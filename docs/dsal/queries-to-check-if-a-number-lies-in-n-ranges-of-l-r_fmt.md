...
> 原文：[https://www.geeksforgeeks.org/queries-to-check-if-a-number-lies-in-n-ranges-of-l-r/](https://www.geeksforgeeks.org/queries-to-check-if-a-number-lies-in-n-ranges-of-l-r/)
...
4.  对于每个查询，使用二分搜索法查找第一次出现的等于或大于它的数字。这可以使用 [`lower_bound`](https://www.geeksforgeeks.org/lower_bound-in-cpp/) 函数来完成。
