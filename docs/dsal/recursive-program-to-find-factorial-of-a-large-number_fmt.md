...
> 原文: [https://www.geeksforgeeks.org/recursive-program-to-find-factorial-of-a-large-number/](https://www.geeksforgeeks.org/recursive-program-to-find-factorial-of-a-large-number/)
...
> `输入:` N = 100
> `输出:` 933262154439441526816992388562667004907159682643816214685929638952175999932915608414639761565182866
>
> `输入:` N = 50
> `输出:` 3041409320171337804361260816606476884437764156896051200000000000

`迭代方法:` 本文的[第 1 集讨论了迭代方法](https://www.geeksforgeeks.org/factorial-large-number/)。这里，我们已经讨论了递归方法。
...
*   否则，调用[函数](https://www.geeksforgeeks.org/functions-in-c/) `multiply(n, factorialRecursiveAlgorithm(n - 1))` 找到答案。
