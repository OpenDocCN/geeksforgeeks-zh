...
> 原文：[https://www.geeksforgeeks.org/java-program-to-display-lower-triangular-matrix/](https://www.geeksforgeeks.org/java-program-to-display-lower-triangular-matrix/)
...
*   **空间复杂度：** 矩阵可原地更改。即不需要额外的矩阵空间。`O(N^2)`
*   **时间复杂度：** `O(N^2)`