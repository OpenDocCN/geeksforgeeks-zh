...
> 原文：[https://www.geeksforgeeks.org/generate-permutations-adjacent-swaps-allowed/](https://www.geeksforgeeks.org/generate-permutations-adjacent-swaps-allowed/)
...
2. 交换一下。因为它可以与其相邻的、
    ...
    b. 用前一个字符替换它–我们不需要单独考虑这种情况，因为第 `i` 个字符是第 `(i-1)` 个字符的下一个字符，这与情况 2.a. 相同。
