...
> 原文: [https://www.geeksforgeeks.org/print-root-leaf-path-without-using-recursion/](https://www.geeksforgeeks.org/print-root-leaf-path-without-using-recursion/)
...
我们可以迭代遍历树（我们已经使用了[迭代预序遍历](https://www.geeksforgeeks.org/iterative-preorder-traversal/)）。问题是，如何扩展遍历来打印根到叶的路径？其思想是维护一个映射来存储二叉树节点的父指针。现在，每当我们在进行迭代前序遍历时遇到一个叶节点，我们就可以使用父指针轻松地打印根到叶路径。下面是这个想法的实现。
