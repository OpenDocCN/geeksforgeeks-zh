...
> 原文: [https://www.geeksforgeeks.org/minimum-rotations-required-to-get-the-same-string-set-2/](https://www.geeksforgeeks.org/minimum-rotations-required-to-get-the-same-string-set-2/)
...
基本方法是从第一个位置开始不断旋转字符串，并计算旋转次数，直到我们得到初始字符串。

## 高效方法

我们将遵循基本方法，但会尽量减少生成旋转所花费的时间。想法如下:
