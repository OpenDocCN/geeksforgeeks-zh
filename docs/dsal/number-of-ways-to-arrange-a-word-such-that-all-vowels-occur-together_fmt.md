...
> 原文：[https://www.geeksforgeeks.org/number-of-ways-to-arrange-a-word-such-that-all-vowels-occur-together/](https://www.geeksforgeeks.org/number-of-ways-to-arrange-a-word-such-that-all-vowels-occur-together/)
...
因为单词包含元音和辅音。所有的元音都需要保持在一起，然后我们将把所有的元音看作一个字母。

> 因为，在单词“geeksforgeeks”中，我们可以把元音“eeoee”看作一个字母。
> 于是，我们有了 **gksfrgks (eeoee)** 。
> 这有 9 个(8 + 1)字母，其中 g、k、s 各出现 2 次，其余各不相同。
> 排列这些字母的方式数= `9!/(2!)*(2!)*(2!)` = 45360 方式
> 现在，5 个‘e’出现 4 次，‘o’出现 1 次的元音，可以排列成 `5!/4!` = 5 种方式。
