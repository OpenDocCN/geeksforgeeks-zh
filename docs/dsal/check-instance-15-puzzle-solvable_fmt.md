...
> 原文：[https://www.geeksforgeeks.org/check-instance-15-puzzle-solvable/](https://www.geeksforgeeks.org/check-instance-15-puzzle-solvable/)
...
2.  如果 `N` 为偶数，则解谜实例可解，如果
    ...
    *   空白在从底部（最后、倒数第三、倒数第五等）开始计数的奇数行上且逆序数为偶数。
...
### 来源:
[https://www.cs.bham.ac.uk/~mdr/teaching/modules04/java2/TilesSolvability.html](https://www.cs.bham.ac.uk/~mdr/teaching/modules04/java2/TilesSolvability.html)
