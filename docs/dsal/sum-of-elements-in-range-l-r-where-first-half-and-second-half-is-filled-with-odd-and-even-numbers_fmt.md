...
> 原文: [https://www.geeksforgeeks.org/sum-of-elements-in-range-l-r-where-first-half-and-second-half-is-filled-with-odd-and-even-numbers/](https://www.geeksforgeeks.org/sum-of-elements-in-range-l-r-where-first-half-and-second-half-is-filled-with-odd-and-even-numbers/)
...
不构建数组，问题可以用 `O(1)` 复杂度解决。考虑这样形成的序列的中点。那么 `L` 和 `R` 可以有 3 种可能。
