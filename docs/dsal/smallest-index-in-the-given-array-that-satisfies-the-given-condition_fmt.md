...
> 原文: [https://www.geeksforgeeks.org/smallest-index-in-the-given-array-that-satisfies-the-given-condition/](https://www.geeksforgeeks.org/smallest-index-in-the-given-array-that-satisfies-the-given-condition/)
...
**逼近:** 对于每个索引 `i` 从 `0` 开始，求给定序列的和，给定和大于等于 `K` 的第一个索引就是我们需要的索引。如果没有这样的索引，则打印 `-1`。
