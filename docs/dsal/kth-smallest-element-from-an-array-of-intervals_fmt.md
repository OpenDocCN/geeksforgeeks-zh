...
> 原文：[https://www.geeksforgeeks.org/kth-smallest-element-from-an-array-of-intervals/](https://www.geeksforgeeks.org/kth-smallest-element-from-an-array-of-intervals/)

给定一个间隔为的[数组](https://www.geeksforgeeks.org/array-data-structure/)，大小为 `N`，任务是在给定数组的间隔内的所有元素中找到 `K<sup>th</sup>` 最小的元素。
