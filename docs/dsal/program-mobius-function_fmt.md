...
Since the prime factor occurs twice answer is 0. 
...
**参考文献**
1. [`http://mathworld.wolfram.com/MoebiusFunction.html`](http://mathworld.wolfram.com/MoebiusFunction.html)
2. [`https://en.wikipedia.org/wiki/M%C3%B6bius_function`](https://en.wikipedia.org/wiki/M%C3%B6bius_function)
3. [`https://en.wikipedia.org/wiki/Completely_multiplicative_function`](https://en.wikipedia.org/wiki/Completely_multiplicative_function)