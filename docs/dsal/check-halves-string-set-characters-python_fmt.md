...
> 原文：[https://www.geeksforgeeks.org/check-halves-string-set-characters-python/](https://www.geeksforgeeks.org/check-halves-string-set-characters-python/)
...
此问题已有解决方案，请参考[检查字符串的两半是否有相同的字符集](https://www.geeksforgeeks.org/check-half-string-character-frequency-character/)链接。我们将使用`字典`比较来快速解决 Python 中的这个问题。
