...
> 原文：[https://www.geeksforgeeks.org/minimum-sum-of-differences-with-an-element-in-an-array/](https://www.geeksforgeeks.org/minimum-sum-of-differences-with-an-element-in-an-array/)
...
abs(2-4) + abs(5-4) + abs(1-4) + abs(7-4) + abs(4-4) = 9
