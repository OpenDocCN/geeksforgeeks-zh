...
> 原文:[https://www.geeksforgeeks.org/check-whether-the-binary-equivalent-of-a-number-ends-with-given-string-or-not/](https://www.geeksforgeeks.org/check-whether-the-binary-equivalent-of-a-number-ends-with-given-string-or-not/)
...
思路是找到 `N` 的[二进制等价物](https://www.geeksforgeeks.org/program-decimal-binary-conversion/)，检查 `str` 是否是其二进制等价物的后缀。
