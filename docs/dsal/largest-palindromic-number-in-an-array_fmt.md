...
> 原文：[`https://www.geeksforgeeks.org/largest-palindromic-number-in-an-array/`](https://www.geeksforgeeks.org/largest-palindromic-number-in-an-array/)
...
1.  [按升序排序](https://www.geeksforgeeks.org/merge-sort/)数组。
2.  从末尾开始遍历数组。
3.  第一个数字是回文，这是必须的答案。
4.  如果没有找到回文编号，则打印 `-1`。
