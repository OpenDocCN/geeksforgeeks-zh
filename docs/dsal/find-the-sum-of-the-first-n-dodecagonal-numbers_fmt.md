...
> 原文：`https://www.geeksforgeeks.org/find-the-sum-of-the-first-n-dodecagonal-numbers/`

给定一个数字 `N`，任务是找出第一个 `N` 个[十二边形数字](https://www.geeksforgeeks.org/dodecagonal-number/)的和。
...
1.  首先，我们需要创建一个函数来帮助我们计算第 `N` 个[十二边形数](https://www.geeksforgeeks.org/dodecagonal-number/)。
