...
> 原文：[https://www.geeksforgeeks.org/sort-prime-numbers-of-an-array-in-descending-order/](https://www.geeksforgeeks.org/sort-prime-numbers-of-an-array-in-descending-order/)

给定一个整数数组`arr`，任务是按相对位置降序排列数组中的所有素数，即其他元素的位置不得受到影响。
