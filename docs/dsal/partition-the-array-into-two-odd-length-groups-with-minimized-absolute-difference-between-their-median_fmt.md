# 将数组划分为两个奇数长度组，中间值之间的绝对差值最小

> 原文：[https://www.geeksforgeeks.org/partition-the-array-into-two-odd-length-groups-with-minimized-absolute-difference-between-their-median/](https://www.geeksforgeeks.org/partition-the-array-into-two-odd-length-groups-with-minimized-absolute-difference-between-their-median/)
...
*   因此，将第一组 `arr[]` 的 `n/2` 第元素和第二组 `arr[]` 的 `(n/2–1)` 第元素分别作为中位数。
