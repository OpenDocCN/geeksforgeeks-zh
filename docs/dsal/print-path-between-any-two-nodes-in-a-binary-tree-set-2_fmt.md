...
> 原文: [https://www.geeksforgeeks.org/print-path-between-any-two-nodes-in-a-binary-tree-set-2/](https://www.geeksforgeeks.org/print-path-between-any-two-nodes-in-a-binary-tree-set-2/)
...
在[这篇](https://www.geeksforgeeks.org/print-path-between-any-two-nodes-in-a-binary-tree/)文章中已经讨论了解决这个问题的方法。在本文中，将讨论一种甚至优化的递归方法。
