...
> 原文: [https://www.geeksforgeeks.org/sum-of-all-integers-in-given-n-ranges/](https://www.geeksforgeeks.org/sum-of-all-integers-in-given-n-ranges/)

## 问题描述

给定形式为`【L，R】`的`N`个范围，任务是找出位于任何给定范围内的所有整数的和。
...
给定的问题可以通过类似于[合并重叠区间](https://www.geeksforgeeks.org/merging-intervals/)问题的方法来解决。以下是要遵循的步骤:

*   根据`L`的递增顺序对[区间进行排序](https://www.geeksforgeeks.org/sorting-algorithms/)。
