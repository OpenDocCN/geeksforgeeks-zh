...
> 原文: [https://www.geeksforgeeks.org/check-if-it-is-possible-to-perform-the-given-grid-division/](https://www.geeksforgeeks.org/check-if-it-is-possible-to-perform-the-given-grid-division/)
...
**方法:** 为了使分割成为可能，所有部分的单元之和必须等于给定网格中的单元总数，即所有数组元素之和必须等于 `N * M`。
