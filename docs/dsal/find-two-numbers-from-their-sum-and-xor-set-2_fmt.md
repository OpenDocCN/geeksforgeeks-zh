...
> 原文: [https://www.geeksforgeeks.org/find-two-numbers-from-their-sum-and-xor-set-2/](https://www.geeksforgeeks.org/find-two-numbers-from-their-sum-and-xor-set-2/)

给定两个整数 `X` 和 `Y`，任务是找出两个整数，其和 `X` 和[按位异或](https://www.geeksforgeeks.org/tag/xor/)等于 `Y`。
