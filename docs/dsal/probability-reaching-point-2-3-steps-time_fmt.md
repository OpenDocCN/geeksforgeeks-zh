...
> 原文: [https://www.geeksforgeeks.org/probability-reaching-point-2-3-steps-time/](https://www.geeksforgeeks.org/probability-reaching-point-2-3-steps-time/)

一个人从 `X = 0` 的位置开始走，如果她只能走 2 步或 3 步，找到恰好到达 `X = N` 的概率。给出步长 2 的概率 `P`，即步长 3 的概率为 `1–P`。
...
这是一个简单的[动态规划](https://www.geeksforgeeks.org/dynamic-programming/)问题。它是这个问题的简单延伸: [Count of different ways to express n as sum of 1, 3 and 4](https://www.geeksforgeeks.org/count-ofdifferent-ways-express-n-sum-1-3-4/)。
