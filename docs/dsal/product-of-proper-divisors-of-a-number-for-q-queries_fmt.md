...
> 原文: [https://www.geeksforgeeks.org/product-of-proper-divisors-of-a-number-for-q-queries/](https://www.geeksforgeeks.org/product-of-proper-divisors-of-a-number-for-q-queries/)

给定一个整数 `N`，任务是为 `Q` 查询找到模 `10^9 + 7` 这个数的适当除数的乘积。
...
思路是借助厄拉多塞的[筛](https://www.geeksforgeeks.org/sieve-of-eratosthenes/)，预先计算并存储元素的适当除数的乘积。
