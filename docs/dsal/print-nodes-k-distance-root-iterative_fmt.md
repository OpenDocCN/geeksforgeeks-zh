...
> 原文：[https://www.geeksforgeeks.org/print-nodes-k-distance-root-iterative/](https://www.geeksforgeeks.org/print-nodes-k-distance-root-iterative/)
...
这个问题的递归方法在这里讨论。
下面是迭代方法。
解决方法类似于[获取二叉树](https://www.geeksforgeeks.org/get-level-node-binary-tree-iterative-approach/)中节点的级别。
