...
> 原文: [https://www.geeksforgeeks.org/bottom-left-to-upward-right-traversal-in-a-binary-tree/](https://www.geeksforgeeks.org/bottom-left-to-upward-right-traversal-in-a-binary-tree/)

给定一个[二叉树](https://www.geeksforgeeks.org/binary-tree-data-structure/)，任务是打印给定二叉树的从左下到右上的[遍历](https://www.geeksforgeeks.org/tree-traversals-inorder-preorder-and-postorder/)，即以从左下到右上的节点为级别的级别顺序遍历。
...
### 方法:
想法是使用[广度优先搜索](https://www.geeksforgeeks.org/breadth-first-traversal-for-a-graph/)技术。遵循解决此问题所需的步骤:
