...
> 原文：[https://www.geeksforgeeks.org/program-to-find-the-common-ratio-of-three-numbers/](https://www.geeksforgeeks.org/program-to-find-the-common-ratio-of-three-numbers/)
...
诀窍在于使两个比率中的常用术语 `b` 相等。因此，将第一个比率乘以 `b2`（第二个比率的 `b` 项），将第二个比率乘以 `b1`。

> **给定：** `a:b1` 和 `b2:c`
> **解：** `a:b:c = (a * b2):(b1 * b2):(c * b1)`
> **例如：**
> 如果 `a : b = 5 : 9` 和 `b : c = 7 : 4`
