...
> 原文：[https://www.geeksforgeeks.org/sum-of-all-n-digit-palindrome-numbers/](https://www.geeksforgeeks.org/sum-of-all-n-digit-palindrome-numbers/)
...
仔细观察 `n` 位回文的和，形成一个数列，即 45，495，49500，495000，4950000，49500000，49500000。因此，通过推导出一个数学公式，我们得到 `n = 1` 时 `sum = 45`，`n>1` 时 `sum = (99/2) * 10^(n-1) * 10^((n-1)/2)`。
