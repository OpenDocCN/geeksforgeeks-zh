...
> 原文：[https://www.geeksforgeeks.org/total-distinct-pairs-of-ugly-numbers-from-two-arrays/](https://www.geeksforgeeks.org/total-distinct-pairs-of-ugly-numbers-from-two-arrays/)
...
> **输入:** `arr1[] = { 1，2，3}`，`arr2[] = { 1，1}`
> **输出:** `3`
> All

**进场:**

*   首先生成所有难看的数字，并将其插入一个 `unordered_set` `s1`。
*   再取空 `set` `s2`。
