...
> 原文: [https://www.geeksforgeeks.org/minimum-possible-number-with-the-given-operation/](https://www.geeksforgeeks.org/minimum-possible-number-with-the-given-operation/)
...
只有大于等于 `5` 的数字需要更改，因为更改小于 `5` 的数字会导致数字变大。更新所有要求的数字后，检查结果数字是否有前导零，如果有，则将其更改为 `9`。
