...
> 原文：[https://www.geeksforgeeks.org/last-remaining-element-after-repeated-removal-of-odd-indexed-elements/](https://www.geeksforgeeks.org/last-remaining-element-after-repeated-removal-of-odd-indexed-elements/)
...
解决上述问题的幼稚方法是存储序列。迭代序列并从中移除奇数索引元素。重复以上步骤，直到只剩下一个元素。
