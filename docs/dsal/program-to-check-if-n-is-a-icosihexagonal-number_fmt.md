...
> 原文: [https://www.geeksforgeeks.org/program-to-check-if-n-is-a-icosihexagonal-number/](https://www.geeksforgeeks.org/program-to-check-if-n-is-a-icosihexagonal-number/)

给定一个整数 `N`，任务是检查它是否是一个[二十六边形数](https://www.geeksforgeeks.org/icosihexagonal-number/)。
...
1.  二十边形数的第 K<sup>项</sup>给出为
    ![K^{th} Term = \frac{24*K^{2} - 22*K}{2}](img/406bba2b8d48f44d0896cdc2a0466c03.png "Rendered by QuickLaTeX.com")
...
3.  最后，检查使用此公式计算的值是否为整数，这意味着 `N` 是一个二十进制数。
