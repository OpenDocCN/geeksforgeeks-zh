...
> 原文：[https://www.geeksforgeeks.org/check-if-two-given-rational-numbers-are-equal-or-not/](https://www.geeksforgeeks.org/check-if-two-given-rational-numbers-are-equal-or-not/)
