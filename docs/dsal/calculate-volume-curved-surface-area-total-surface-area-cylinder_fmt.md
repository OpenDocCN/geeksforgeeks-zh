...
> 原文: [https://www.geeksforgeeks.org/calculate-volume-curved-surface-area-total-surface-area-cylinder/](https://www.geeksforgeeks.org/calculate-volume-curved-surface-area-total-surface-area-cylinder/)

给定圆柱体的半径和高度，计算圆柱体的体积、总表面积和曲面面积。

*   **圆柱体的体积:**
    圆柱体的体积定义为圆柱体所占据的三维空间量或圆柱体的存储容量。我们可以用公式计算圆柱体的体积
