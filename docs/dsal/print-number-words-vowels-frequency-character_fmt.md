...
> 原文：[`https://www.geeksforgeeks.org/print-number-words-vowels-frequency-character/`](https://www.geeksforgeeks.org/print-number-words-vowels-frequency-character/)
...
**方法：** 我们使用[`TreeMap`](https://www.geeksforgeeks.org/hashmap-treemap-java/)来存储字符及其频率。`TreeMap`用于按排序顺序获取输出。
下面是上述方法的 Java 实现：
