...
> 原文: [https://www.geeksforgeeks.org/number-of-trailing-zeroes-in-base-16-representation-of-n/](https://www.geeksforgeeks.org/number-of-trailing-zeroes-in-base-16-representation-of-n/)
...
*   我们知道 `16 = 2^4`。所以， `16` 的最高幂等于 `N` 除以 `4` 的阶乘中的最高幂 `2`。
