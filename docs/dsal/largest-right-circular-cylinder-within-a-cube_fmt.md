...
> 原文：[https://www.geeksforgeeks.org/largest-right-circular-cylinder-within-a-cube/](https://www.geeksforgeeks.org/largest-right-circular-cylinder-within-a-cube/)

给定一个边长为`a`的立方体。任务是找出最大的右圆柱体内可内接的体积。
