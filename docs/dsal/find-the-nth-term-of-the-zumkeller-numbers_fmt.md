...
> 原文: [https://www.geeksforgeeks.org/find-the-nth-term-of-the-zumkeller-numbers/](https://www.geeksforgeeks.org/find-the-nth-term-of-the-zumkeller-numbers/)

## 祖姆凯勒数

**祖姆凯勒数**是一组数，其除数可以被分成两个不相交的集合，这两个集合的和等于同一个值。最初的几个祖姆凯勒数字是 **6，12，20，24，28，30，40，42，48，54，…** 。

在这篇文章中，我们将找到第 N 个祖姆凯勒数。

## 找到第 N 个祖姆凯勒号

给定一个号 **N** ，任务是找到第 N 个祖姆凯勒号。
