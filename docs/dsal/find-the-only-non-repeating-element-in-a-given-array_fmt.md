...
> 原文: [https://www.geeksforgeeks.org/find-the-only-non-repeating-element-in-a-given-array/](https://www.geeksforgeeks.org/find-the-only-non-repeating-element-in-a-given-array/)

给定一个由 `N` (`1 ≤ N ≤ 10^5`) 正整数组成的[数组](https://www.geeksforgeeks.org/array-data-structure/) `A[]`，任务是找到唯一一个出现一次的数组元素。
...
*   使用 [`Counter()`](https://www.geeksforgeeks.org/python-counter-objects-elements/) 功能计算频率。
