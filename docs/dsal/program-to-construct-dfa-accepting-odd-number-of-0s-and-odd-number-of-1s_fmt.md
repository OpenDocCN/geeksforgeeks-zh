...
> 原文: [https://www.geeksforgeeks.org/program-to-construct-dfa-accepting-odd-number-of-0s-and-odd-number-of-1s/](https://www.geeksforgeeks.org/program-to-construct-dfa-accepting-odd-number-of-0s-and-odd-number-of-1s/)
...
*   有 4 种状态 `q_0`，`q_1`，`q_2`，`q_3`，其中 `q_0` 为初始状态，`q_3` 为最终状态。
*   上述 DFA 的过渡表如下:
...
*   通过此表，了解 DFA 中的过渡。
*   如果在读取整个字符串后达到最终状态 (`q_3`)，则该字符串被接受，否则不被接受。
