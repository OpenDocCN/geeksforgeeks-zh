...
> 原文: [https://www.geeksforgeeks.org/minimum-steps-to-remove-substring-010-from-a-binary-string/](https://www.geeksforgeeks.org/minimum-steps-to-remove-substring-010-from-a-binary-string/)

给定一个二进制字符串，任务是计算从这个二进制字符串中移除子字符串“010”的最小步骤。

## 例:

> **输入:** `binary_string = "0101010"`
> **输出:** 2
