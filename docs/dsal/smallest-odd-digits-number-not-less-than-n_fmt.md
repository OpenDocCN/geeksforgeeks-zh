...
> 原文: [https://www.geeksforgeeks.org/smallest-odd-digits-number-not-less-than-n/](https://www.geeksforgeeks.org/smallest-odd-digits-number-not-less-than-n/)
...
天真的方法是从 `N` 开始不断迭代，直到我们找到一个所有数字都是奇数的数字。以下是上述办法的实施情况：
