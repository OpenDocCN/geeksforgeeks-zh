...
> 原文: [https://www.geeksforgeeks.org/ratio-of-area-of-two-nested-polygons-formed-by-connecting-midpoints-of-sides-of-a-regular-n-sided-polygon/](https://www.geeksforgeeks.org/ratio-of-area-of-two-nested-polygons-formed-by-connecting-midpoints-of-sides-of-a-regular-n-sided-polygon/)

给定一个 `N` 边的[多边形](https://www.geeksforgeeks.org/gre-geometry-polygons/)，任务是找到 `N` 边的规则嵌套[多边形](https://www.geeksforgeeks.org/gre-geometry-polygons/)的面积比，该多边形是通过连接原始多边形边的中点而生成的。
...
> 嵌套三角形
> 
> 三角形中点连接而成的边长与原三角形边长之比为 `0.5`。因此，`R = (第 N 个三角形的面积) / (第(N + 1) 个三角形的面积) = 4`
> 
> **输入:** `N = 4`
> **输出:** `2.000000`
...
*   `r = s / (2 * [1 – cos(2B)]^(1/2))` 和 `b = r * [cos(B)]^2`
*   结合以上等式后:
