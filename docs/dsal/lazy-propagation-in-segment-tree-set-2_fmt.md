...
> 原文：[https://www.geeksforgeeks.org/lazy-propagation-in-segment-tree-set-2/](https://www.geeksforgeeks.org/lazy-propagation-in-segment-tree-set-2/)
...
**方法：** 关于线段树中的惰性传播的详细解释在[之前的](https://www.geeksforgeeks.org/lazy-propagation-in-segment-tree/)文章中进行了解释。问题中唯一需要改变的是在调用父节点查询时返回两个子节点之间的最大值。请参阅代码以获得更好的理解。
以下是上述方法的实现：
