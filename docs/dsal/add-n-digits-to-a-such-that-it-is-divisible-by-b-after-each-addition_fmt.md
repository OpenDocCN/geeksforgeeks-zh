# 将N个数字加到A上使其在每次相加后可被B整除

> 原文：[https://www.geeksforgeeks.org/add-n-digits-to-a-such-that-it-is-divisible-by-b-after-each-addition/](https://www.geeksforgeeks.org/add-n-digits-to-a-such-that-it-is-divisible-by-b-after-each-addition/)
