...
> 原文: [https://www.geeksforgeeks.org/length-of-array-pair-formed-where-one-contains-all-distinct-elements-and-other-all-same-elements/](https://www.geeksforgeeks.org/length-of-array-pair-formed-where-one-contains-all-distinct-elements-and-other-all-same-elements/)
...
*   因此，实际的答案是 `max(min(dist–1, maxfrq), min(dist, maxfrq–1))`。
*   下面是上述方法的实现:
