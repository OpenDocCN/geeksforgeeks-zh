...
一个**居中五边形数字**是一个居中的图形数字，表示一个五边形，中心有一个点，其他点依次围绕在五边形层中【来源: [维基](https://en.wikipedia.org/wiki/Centered_pentagonal_number)】

![Centered pentagonal number](img/9c18fa40fa0ae5cdc92e152b2b56ddd4.png)

少数中心五边形数是: 1，6，16，31，51，76，106，141，181，226，276，331，391……
...
class GFG
{
    ...
    {
        // Formula to calculate nth Centered pentagonal number and return it into main function.
        return (5 * n * n - 5 * n + 2) / 2;
    }
...
class GFG
{
    ...
    {
        int n = 7;
        Console.Write(n + "th Centered " + "pentagonal number: ");
...
// Driver Code
var n = 7;
document.write(n + "th Centered " + "pentagonal number: ");
