...
> 原文：[https://www.geeksforgeeks.org/construct-binary-tree-from-inorder-traversal/](https://www.geeksforgeeks.org/construct-binary-tree-from-inorder-traversal/)
...
4.  对最大元素后的元素调用 `buildTree`，将构建的树作为`根`的右子树。
5.  返回`根`。
