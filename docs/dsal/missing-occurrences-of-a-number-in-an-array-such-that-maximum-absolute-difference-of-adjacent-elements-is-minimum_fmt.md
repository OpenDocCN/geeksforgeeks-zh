...
> 原文: [https://www.geeksforgeeks.org/missing-occurrences-of-a-number-in-an-array-such-that-maximum-absolute-difference-of-adjacent-elements-is-minimum/](https://www.geeksforgeeks.org/missing-occurrences-of-a-number-in-an-array-such-that-maximum-absolute-difference-of-adjacent-elements-is-minimum/)
...
思想是找到与缺失数相邻的最大和最小元素，缺失数可以是这两个值的平均值，使得最大绝对差最小。

```
=> max = Maximum adjacent element
=> min = Minimum adjacent element

Missing number = (max + min) / 2
```
