...
> 原文: [https://www.geeksforgeeks.org/split-a-given-array-into-k-subarrays-minimizing-the-difference-between-their-maximum-and-minimum/](https://www.geeksforgeeks.org/split-a-given-array-into-k-subarrays-minimizing-the-difference-between-their-maximum-and-minimum/)
...
2.  [按升序排列](https://www.geeksforgeeks.org/sorting-algorithms/)数组 `temp[]`。
3.  将总差值（比如 `diff`）初始化为给定数组的第一个和最后一个元素的差值 `arr[]`。
4.  将数组 `temp[]` 中的第一个 `K–1` 值加到上述差值上。
