...
> 原文: [https://www.geeksforgeeks.org/smallest-indexed-array-element-required-to-be-flipped-to-make-sum-of-array-equal-to-0/](https://www.geeksforgeeks.org/smallest-indexed-array-element-required-to-be-flipped-to-make-sum-of-array-equal-to-0/)
...
解决这个问题最简单的方法就是[遍历数组](https://www.geeksforgeeks.org/c-program-to-traverse-an-array/)，对于每个数组元素，翻转数组元素的符号，检查数组的[和是否变为 `0`。如果发现为真，则打印当前元素的索引。](https://www.geeksforgeeks.org/program-find-sum-elements-given-array/)
