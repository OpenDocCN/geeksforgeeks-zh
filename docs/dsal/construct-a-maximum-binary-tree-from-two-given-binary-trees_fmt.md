...
> 原文: [https://www.geeksforgeeks.org/construct-a-maximum-binary-tree-from-two-given-binary-trees/](https://www.geeksforgeeks.org/construct-a-maximum-binary-tree-from-two-given-binary-trees/)
...
class Node{
    ...
    static Node MaximumBinaryTree(Node t1, Node t2)
    {
        ...
        t1.data = Math.Max(t1.data, t2.data);
        t1.left = MaximumBinaryTree(t1.left, t2.left);
        t1.right = MaximumBinaryTree(t1.right, t2.right);
        return t1;
    }
