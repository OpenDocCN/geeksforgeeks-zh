...
> 原文：[https://www.geeksforgeeks.org/in-place-convert-bst-into-a-min-heap/](https://www.geeksforgeeks.org/in-place-convert-bst-into-a-min-heap/)
...
// Binary Search tree to Sorted Linked List
// root -. Root of Binary Search Tree
// head_ref -. Pointer to head node of created linked list
...
// Function to convert a sorted Linked List to Min-Heap.
// root -. Root of Min-Heap
