...
> 原文: [https://www.geeksforgeeks.org/check-if-two-people-starting-from-different-points-ever-meet/](https://www.geeksforgeeks.org/check-if-two-people-starting-from-different-points-ever-meet/)
...
在这种情况下，我们计算每个人每次跳跃后的位置，并检查他们是否已经降落在同一个地点。这个有复杂性 `O(n)`。
