...
> 原文：[https://www.geeksforgeeks.org/insert-a-character-in-a-rotated-string/](https://www.geeksforgeeks.org/insert-a-character-in-a-rotated-string/)
...
对于每个字符，将其插入到所需的位置，并跟踪前一个位置和前一次插入后的字符。插入所有字符后，打印最后一次插入的字符。
