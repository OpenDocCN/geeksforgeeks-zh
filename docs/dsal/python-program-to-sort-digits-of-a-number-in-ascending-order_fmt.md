...
> 原文：[https://www.geeksforgeeks.org/python-program-to-sort-digits-of-a-number-in-ascending-order/](https://www.geeksforgeeks.org/python-program-to-sort-digits-of-a-number-in-ascending-order/)
...
*   使用 [`join()`](https://www.geeksforgeeks.org/join-function-python/) 和 [`sorted()`](https://www.geeksforgeeks.org/sorted-function-python/) 对字符串中的字符进行排序。
