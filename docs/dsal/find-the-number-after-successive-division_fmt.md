...
> 原文: [https://www.geeksforgeeks.org/find-the-number-after-successive-division/](https://www.geeksforgeeks.org/find-the-number-after-successive-division/)

给定两个数组 `div` 和 `rem`，这两个数组保存了因子和余数的值，任务是找到在被 `div` 数组的元素连续除之后剩下的余数，这些余数在 `rem` 数组中。
