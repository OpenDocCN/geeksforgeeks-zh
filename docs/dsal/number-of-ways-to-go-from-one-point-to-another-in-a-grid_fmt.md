...
> 原文：[https://www.geeksforgeeks.org/number-of-ways-to-go-from-one-point-to-another-in-a-grid/](https://www.geeksforgeeks.org/number-of-ways-to-go-from-one-point-to-another-in-a-grid/)
...
**以上公式是如何工作的？**
让我们考虑一下上面所示的 `5×5` 网格的例子。为了从 `5×5` 网格中的 A 点到 B 点，我们必须走 5 个水平步和 5 个垂直步。每条路径将由 10 个台阶组成，其中 5 个台阶在一种情况下是相同的，另外 5 个台阶在另一种情况下是相同的。因此路数= `10! / (5! * 5!)` 即 252 种方式。
