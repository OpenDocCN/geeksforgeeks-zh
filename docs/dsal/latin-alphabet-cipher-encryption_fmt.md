...
> 原文: [https://www.geeksforgeeks.org/latin-alphabet-cipher-encryption/](https://www.geeksforgeeks.org/latin-alphabet-cipher-encryption/)
...
[`isalpha()`](https://www.geeksforgeeks.org/isalpha-isdigit-functions-c-example/)和[`isdigit()`](https://www.geeksforgeeks.org/isalpha-isdigit-functions-c-example/)函数在 C/C++中使用示例。
