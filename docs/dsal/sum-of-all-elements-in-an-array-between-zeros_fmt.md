...
> 原文:[https://www.geeksforgeeks.org/sum-of-all-elements-in-an-array-between-zeros/](https://www.geeksforgeeks.org/sum-of-all-elements-in-an-array-between-zeros/)

给定一个由 `N` 个整数组成的[数组](https://www.geeksforgeeks.org/introduction-to-arrays/) `arr[]`，任务是找出给定数组中两个零之间所有元素的[和](https://www.geeksforgeeks.org/program-find-sum-elements-given-array/)。如果可能，那么打印所有的总和，否则打印 `"-1"`。
**注意:**给定数组中没有连续的零。
