...
> 原文: [https://www.geeksforgeeks.org/number-of-distinct-integers-obtained-by-lcmx-n-x/](https://www.geeksforgeeks.org/number-of-distinct-integers-obtained-by-lcmx-n-x/)
...
所以只有 `N` 的相异因子才可能是相异的整数。因此，计算 `N` 的不同因子的数量，包括 1 和 `N` 本身，这是必需的答案。
