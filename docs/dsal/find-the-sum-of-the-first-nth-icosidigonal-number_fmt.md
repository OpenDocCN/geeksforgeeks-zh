...
> 原文: [https://www.geeksforgeeks.org/find-the-sum-of-the-first-nth-icosidigional-number/](https://www.geeksforgeeks.org/find-the-sum-of-the-first-nth-icosidigional-number/)
...
1.  首先，我们需要创建一个函数来帮助我们计算第 `N` 个 [icosidigional 数字](https://www.geeksforgeeks.org/icosidigonal-number/)。
2.  现在，运行一个从 `1` 到 `N` 的循环，找到第 `i` 个 [icosidigional 数字](https://www.geeksforgeeks.org/icosidigonal-number/)。
