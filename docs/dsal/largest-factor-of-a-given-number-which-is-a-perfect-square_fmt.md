...
> 原文: [https://www.geeksforgeeks.org/largest-factor-of-a-given-number-which-is-a-perfect-square/](https://www.geeksforgeeks.org/largest-factor-of-a-given-number-which-is-a-perfect-square/)

给定一个数字`N`。任务是找到那个数的最大因子，它是一个完美的正方形。
...
*   取一个变量，`answer`，初始化为 1。它代表最大的平方数，也是这个数的一个因子。
