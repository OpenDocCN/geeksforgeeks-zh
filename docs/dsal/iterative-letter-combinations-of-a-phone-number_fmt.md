...
> 原文：[https://www.geeksforgeeks.org/iterative-letter-combinations-of-a-phone-number/](https://www.geeksforgeeks.org/iterative-letter-combinations-of-a-phone-number/)
...
栈是后进先出（LIFO）的直接序列。我们可以使用另一种数据结构吗？如果我们使用先进先出（FIFO），会有什么不同？比如队列。既然 BFS 是按队列完成的，而 DFS 是按栈完成的，这两者有什么区别吗？
