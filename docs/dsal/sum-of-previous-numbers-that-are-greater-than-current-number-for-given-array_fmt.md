...
> 原文: [https://www.geeksforgeeks.org/sum-of-previous-numbers-that-are-greater-than-current-number-for-given-array/](https://www.geeksforgeeks.org/sum-of-previous-numbers-that-are-greater-than-current-number-for-given-array/)
...
4.  `total_sum - curr_sum` 的值将给出严格大于当前元素左侧元素的所有元素的总和。
5.  更新芬威克树中的当前元素。
6.  对数组中的所有元素重复上述步骤。
