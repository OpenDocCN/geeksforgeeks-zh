...
Console.Write("Linked list before insertion: "); 
            PrintList(head);

int data = 12, pos = 3; 
            head = InsertPos(head, pos, data); 
            Console.Write("Linked list after" + " insertion of 12 at position 3: "); 
            PrintList(head);
...
// front of the linked list  
            ...
            pos = 1; 
            head = InsertPos(head, pos, data); 
            Console.Write("Linked list after" + " insertion of 1 at position 1: "); 
            PrintList(head);
...
// insetion at end of the linked list  
            ...
            pos = 7; 
            head = InsertPos(head, pos, data); 
            Console.Write("Linked list after" + " insertion of 15 at position 7: "); 
            PrintList(head); 
        } 
    } 
}
