...
> 原文：[https://www.geeksforgeeks.org/solution-get-prime-numbers-smaller-n/](https://www.geeksforgeeks.org/solution-get-prime-numbers-smaller-n/)

这种方法是基于[威尔逊定理](https://www.geeksforgeeks.org/wilsons-theorem/)并利用阶乘计算可以很容易地用 DP 完成的事实，威尔逊定理说如果一个数 `k` 是素数，那么 `((k-1)! + 1) % k` 必须为 0。
