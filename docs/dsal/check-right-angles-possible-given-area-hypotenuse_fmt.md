...
> 原文: [https://www.geeksforgeeks.org/check-right-angles-possible-given-area-hypotenuse/](https://www.geeksforgeeks.org/check-right-angles-possible-given-area-hypotenuse/)
...
面积: `A = 0.5 * a * b`
斜边正方形: `H^2 = a^2 + b^2`
代入 `b`，重新排列得到 `h^2 = a^2 + (4 * a^2) / a^2`，我们得到方程 `A^4 - (H^2)(A^2) + 4 * (A^2)`
这个方程的判别式 `D` 将是 `D = H^4 - 16 * (A^2)`
如果 `D = 0`，那么根由线性方程公式给出，`root = (-b ± sqrt(D)) / 2 *`
