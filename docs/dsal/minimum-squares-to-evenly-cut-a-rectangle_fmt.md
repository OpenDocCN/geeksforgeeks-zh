...
> 原文: [https://www.geeksforgeeks.org/minimum-squares-to-evenly-cut-a-rectangle/](https://www.geeksforgeeks.org/minimum-squares-to-evenly-cut-a-rectangle/)

给定一张长 `l`、宽 `w` 的矩形纸，我们需要把这张纸分成正方形纸，这样正方形纸的数量应该应该尽可能少。
...
正方形边的最佳长度等于两个数的 [GCD](https://www.geeksforgeeks.org/basic-and-extended-euclidean-algorithms/)。
