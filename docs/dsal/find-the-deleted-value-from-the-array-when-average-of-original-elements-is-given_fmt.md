...
> 原文：[https://www.geeksforgeeks.org/find-the-deleted-value-from-the-array-when-average-of-original-elements-is-given/](https://www.geeksforgeeks.org/find-the-deleted-value-from-the-array-when-average-of-original-elements-is-given/)
...
> **输出：** `4`
> 原始数组为 `{2，7，3，4，4，4}`，其中删除了 3 次出现的 4。
> `(2 + 7 + 3 + 4 + 4 + 4) / 6 = 4`
>
...
*   平均值为 `avg`，即 `avg = sumOrg / (N + K)`。
*   现在，`X` 可以很容易地计算为 `X = ((avg * (N + K)) – sum) / K`。
