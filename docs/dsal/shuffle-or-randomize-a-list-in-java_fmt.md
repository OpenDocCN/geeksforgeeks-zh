...
> 原文: [https://www.geeksforgeeks.org/shuffle-or-randomize-a-list-in-java/](https://www.geeksforgeeks.org/shuffle-or-randomize-a-list-in-java/)

*   `Collections.shuffle()` 是 Java 中用来洗牌列表的方法。
    等级体系:
    ```
    java
       ↳ util
...
*   如何编写自己的 Shuffle 方法？
    我们可以使用[费希尔-耶茨洗牌算法](https://www.geeksforgeeks.org/shuffle-a-given-array/)，该算法在 O(n) 时间内有效。
