...
> 原文: [https://www.geeksforgeeks.org/find-the-nearest-smaller-numbers-on-left-side-in-an-array/](https://www.geeksforgeeks.org/find-the-nearest-smaller-numbers-on-left-side-in-an-array/)
...
上述程序的时间复杂度为 `O(n)`，因为每个元素最多被推入和弹出一次到堆栈。所以每个元素执行的操作总数是恒定的。
