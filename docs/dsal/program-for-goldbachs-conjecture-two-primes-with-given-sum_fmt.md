...
> 原文: [https://www.geeksforgeeks.org/program-for-goldbachs-conjecture-two-primes-with-given-sum/](https://www.geeksforgeeks.org/program-for-goldbachs-conjecture-two-primes-with-given-sum/)

哥德巴赫猜想是数学数论中最古老、最著名的未解决问题之一。`每一个大于 2 的偶数可以表示为两个素数之和。`
...
本文由`萨希尔·查布拉(akku)`供稿。如果你喜欢 GeeksforGeeks 并想投稿，你也可以使用`write.geeksforgeeks.org`写一篇文章或者把你的文章邮寄到`contribute@geeksforgeeks.org`。看到你的文章出现在极客博客主页上，帮助其他极客。
