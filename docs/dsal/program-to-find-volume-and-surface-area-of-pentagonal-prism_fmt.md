...
> 原文：[https://www.geeksforgeeks.org/program-to-find-volume-and-surface-area-of-pentagonal-prism/](https://www.geeksforgeeks.org/program-to-find-volume-and-surface-area-of-pentagonal-prism/)

有 5 个矩形面和 2 个平行的五边形底面的棱镜就是五边形棱镜。所以给你五角棱镜的[顶点](https://en.wikipedia.org/wiki/Apothem)长度 `a`、基长 `b` 和高度 `h`。你要找到五角棱镜的表面积和体积。
