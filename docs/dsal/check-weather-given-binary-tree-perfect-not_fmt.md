...
> 原文: [https://www.geeksforgeeks.org/check-weather-given-binary-tree-perfect-not/](https://www.geeksforgeeks.org/check-weather-given-binary-tree-perfect-not/)
...
高度为 `h` (其中高度是从根到叶的路径上的节点数)的[完美二叉树](https://www.geeksforgeeks.org/binary-tree-set-3-types-of-binary-tree/)有 `2^h – 1` 个节点。
下面是一个检查给定二叉树是否完美的想法。
