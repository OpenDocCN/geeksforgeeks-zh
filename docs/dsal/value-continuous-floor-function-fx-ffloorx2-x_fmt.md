# 连续楼层函数的值：`F(x) = F(floor(x/2)) + x`

> 原文：[https://www.geeksforgeeks.org/value-continuous-floor-function-fx-ffloorx2-x/](https://www.geeksforgeeks.org/value-continuous-floor-function-fx-ffloorx2-x/)
...
对于给定的 `x` 值，我们可以使用简单的递归函数计算 `F(x)` 如下：
...
本文由[Shivam Pradhan(anuj_charm)](http://www.facebook.com/ma5ter6it)供稿。如果你喜欢 GeeksforGeeks 并想投稿，你也可以使用[write.geeksforgeeks.org](https://write.geeksforgeeks.org)写一篇文章或者把你的文章邮寄到 contribute@geeksforgeeks.org。看到你的文章出现在极客博客主页上，帮助其他极客。
