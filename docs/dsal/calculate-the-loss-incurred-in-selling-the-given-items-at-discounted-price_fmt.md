...
> 原文: [https://www.geeksforgeeks.org/calculate-the-loss-incurred-in-selling-the-given-items-at-discounted-price/](https://www.geeksforgeeks.org/calculate-the-loss-incurred-in-selling-the-given-items-at-discounted-price/)
...
每件商品计算其售价，即 `原价 + 原价的 X%`。再计算折扣价为 `售价 - 售价的 X%`。现在损失可以计算为 `(原价 - 折扣价) * 数量`。添加所有项目的损失，这是必需的答案。
