...
> 原文：[https://www.geeksforgeeks.org/c-code-article-backtracking-set-8-solving-cryptarithmetic-puzzles/](https://www.geeksforgeeks.org/c-code-article-backtracking-set-8-solving-cryptarithmetic-puzzles/)
...
这个想法是给每个字母分配一个从 0 到 9 的数字，以便算术运算正确。`permutation`是一个递归函数，它为整数的每个可能的置换调用一个`check`函数。
