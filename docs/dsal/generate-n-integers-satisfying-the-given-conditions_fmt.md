...
> 原文: [https://www.geeksforgeeks.org/generate-n-integers-satisfying-the-given-conditions/](https://www.geeksforgeeks.org/generate-n-integers-satisfying-the-given-conditions/)
...
> **输入:** `N = 3`
> **输出:** `3 5 7`
> 没有两个元素相互除，所有奇数子集 `{3}`、`{5}`、`{7}` 和 `{3，5，7}` 的和都是奇数。
