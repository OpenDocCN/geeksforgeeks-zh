...
> 原文:[https://www.geeksforgeeks.org/count-all-possible-paths-from-top-left-to-bottom-right-of-a-matrix-without-crossing-the-diagonal/](https://www.geeksforgeeks.org/count-all-possible-paths-from-top-left-to-bottom-right-of-a-matrix-without-crossing-the-diagonal/)
...
> `K<sub>N</sub>=(<sup>2N</sup>C<sub>N</sub>)/(N+1)`，其中 `<sup>2n</sup>C<sub>n</sub>` 为二项式系数。
>
> 总路数 = `K<sub>n</sub>`
