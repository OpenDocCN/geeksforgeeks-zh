...
> 原文：[https://www.geeksforgeeks.org/store-duplicate-keys-values-pair-and-sort-the-key-value-pair-by-key/](https://www.geeksforgeeks.org/store-duplicate-keys-values-pair-and-sort-the-key-value-pair-by-key/)
...
键值对是 `{(5，0)，(1，1)，(4，2)，(6，3)，(8，4)，(0，5)，(6，6)，(6，7)，(5，8)，(5，9)}`。我们想存储这些键值对，并按键对这些键值对进行排序。所以，期望的输出是 `{(0，5)，(1，1)，(4，2)，(5，0)，(5，8)，(5，9)，(6，3)，(6，6)，(6，7)，(8，4)}`。因为排序后的键递增顺序是 `{0，1，4，5，5，5，6，6，6，8}`。
