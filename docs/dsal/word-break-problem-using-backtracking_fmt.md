...
> 原文：[https://www.geeksforgeeks.org/word-break-problem-using-backtracking/](https://www.geeksforgeeks.org/word-break-problem-using-backtracking/)
...
*   **时间复杂度** : O(2<sup>n</sup>)。因为最坏情况下有 2<sup>n</sup> 组合。
