...
> 原文: [https://www.geeksforgeeks.org/time-minute-hand-hour-hand-coincide/](https://www.geeksforgeeks.org/time-minute-hand-hour-hand-coincide/)
...
**进场:**
1. 取小时`h1`和`h2`的两个变量，然后求出角度`theta` (`theta = (30 * h1)`)，再除以`11`求出分钟(`m`)的时间。我们用`11`分开，因为时钟的指针在12小时内重合11次时间，在24小时内重合22次:
