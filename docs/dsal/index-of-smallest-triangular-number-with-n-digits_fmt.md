...
> 原文: [https://www.geeksforgeeks.org/index-of-smallest-triangular-number-with-n-digits/](https://www.geeksforgeeks.org/index-of-smallest-triangular-number-with-n-digits/)

给定一个数字 `N`，任务是用 `N` 位数找到最小[三角数](https://www.geeksforgeeks.org/triangular-numbers/)的索引。
