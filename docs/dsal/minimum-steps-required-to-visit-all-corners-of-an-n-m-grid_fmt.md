...
> 原文：[https://www.geeksforgeeks.org/minimum-steps-required-to-visit-all-corners-of-an-n-m-grid/](https://www.geeksforgeeks.org/minimum-steps-required-to-visit-all-corners-of-an-n-m-grid/)
...
> 从 `(i1，j1)` 开始访问区块 `(i2，j2)` 所需的最小步数等于 `abs(i2 - i1) + abs(j2 - j1)`。
