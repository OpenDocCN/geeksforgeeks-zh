...
> 原文: [https://www.geeksforgeeks.org/check-if-two-elements-of-a-matrix-are-on-the-same-diagonal-or-not/](https://www.geeksforgeeks.org/check-if-two-elements-of-a-matrix-are-on-the-same-diagonal-or-not/)
...
解决问题的关键观察是，矩阵的两个元素只有在元素的指数之和或指数的绝对差相等时才在同一对角线上。按照以下步骤解决问题:
