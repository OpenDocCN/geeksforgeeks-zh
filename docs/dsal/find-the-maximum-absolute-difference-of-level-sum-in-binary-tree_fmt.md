...
> 原文: [https://www.geeksforgeeks.org/find-the-maximum-absolute-difference-of-level-sum-in-binary-tree/](https://www.geeksforgeeks.org/find-the-maximum-absolute-difference-of-level-sum-in-binary-tree/)
...
2.  遍历时，分别处理不同级别的节点。
3.  对于正在处理的每个级别，计算级别中节点的[和](https://www.geeksforgeeks.org/sum-nodes-k-th-level-tree-represented-string/)，并跟踪`最大`和`最小`级别和。
4.  然后返回最大和最小电平和的`绝对差`。
