...
> 原文：[https://www.geeksforgeeks.org/find-pair-with-maximum-difference-in-any-column-of-a-matrix/](https://www.geeksforgeeks.org/find-pair-with-maximum-difference-in-any-column-of-a-matrix/)
...
观察任何列中具有最大差异的对是该列的最大和最小元素之间的差异。现在按列遍历矩阵。找出每列的最大和最小元素之间的差异，并返回最大差异。
