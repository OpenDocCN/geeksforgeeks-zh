...
请参考`https://www.geeksforgeeks.org/smallest-window-contains-characters-string/`，以获取实现和更多详细信息。

**提问者：DailyHunt**

本文由 **Harshit Agrawal** 提供。 如果您喜欢 GeeksforGeeks 并希望做出贡献，则还可以使用`http://www.contribute.geeksforgeeks.org`撰写文章，或将您的文章邮寄至`tribution@geeksforgeeks.org`。 查看您的文章出现在 GeeksforGeeks 主页上，并帮助其他 Geeks。
