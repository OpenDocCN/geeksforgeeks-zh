...
> 原文：[https://www.geeksforgeeks.org/check-whether-a-number-can-be-represented-as-difference-of-two-squares/](https://www.geeksforgeeks.org/check-whether-a-number-can-be-represented-as-difference-of-two-squares/)
...
思想是所有的数都可以表示为两个平方的差，除了当除以 4 时产生 2 的余数的数。
