# 检查一个数的偶数位的位数乘积是否能被K整除

> 原文：[https://www.geeksforgeeks.org/check-whether-product-of-digits-at-even-places-of-a-number-is-divisible-by-k/](https://www.geeksforgeeks.org/check-whether-product-of-digits-at-even-places-of-a-number-is-divisible-by-k/)
