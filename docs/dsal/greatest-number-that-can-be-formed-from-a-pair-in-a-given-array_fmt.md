...
> 原文: [https://www.geeksforgeeks.org/greatest-number-that-can-be-formed-from-a-pair-in-a-given-array/](https://www.geeksforgeeks.org/greatest-number-that-can-be-formed-from-a-pair-in-a-given-array/)
...
想法是形成每一个[可能的数组对](https://www.geeksforgeeks.org/print-all-possible-combinations-of-r-elements-in-a-given-array-of-size-n/)。然后对于每对 `X` 和 `Y`，将它们连接为 `XY` 和 `YX`，并从所有这些对中取最大值。
