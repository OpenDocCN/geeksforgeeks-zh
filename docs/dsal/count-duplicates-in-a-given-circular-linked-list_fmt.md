...
> 原文: [https://www.geeksforgeeks.org/count-duplicates-in-a-given-circular-linked-list/](https://www.geeksforgeeks.org/count-duplicates-in-a-given-circular-linked-list/)
...
**方法:** 给定的问题有一个非常类似的解决方案[在链表中找到重复的计数](https://www.geeksforgeeks.org/count-duplicates-in-a-given-linked-list/)。想法是使用[哈希](https://www.geeksforgeeks.org/hashing-data-structure/)。使用[这里](https://www.geeksforgeeks.org/circular-linked-list-set-2-traversal/)讨论的算法遍历给定的循环链表。创建一个 hashmap 来存储列表中出现的整数，对于每个整数，检查该整数是否已经出现。保持变量中已经出现的整数的计数。
