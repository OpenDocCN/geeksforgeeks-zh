...
> 原文：[https://www.geeksforgeeks.org/program-to-convert-kilobytes-to-bytes-and-bits/](https://www.geeksforgeeks.org/program-to-convert-kilobytes-to-bytes-and-bits/)

给定千字节数。任务是将它们转换成字节和位。

**Bit**：Bit 是计算机信息中的基本单位，只有**两个不同的值**，通常定义为一个 **0 或一个 1**。这些值可以解释为开或关、是或否、真或假等。这取决于二进制代码。加 1 位，图案数量翻倍。
