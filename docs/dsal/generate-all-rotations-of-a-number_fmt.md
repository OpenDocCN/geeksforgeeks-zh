...
> 原文: [https://www.geeksforgeeks.org/generate-all-rotations-of-a-number/](https://www.geeksforgeeks.org/generate-all-rotations-of-a-number/)
...
*   从结果数中减去 `(第一位数字)* 10^k`，其中 `k` 是原始数中的位数（在本例中，`k = 3`）。
