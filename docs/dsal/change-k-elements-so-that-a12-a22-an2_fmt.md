...
> 原文: [https://www.geeksforgeeks.org/change-k-elements-so-that-a12-a22-an2/](https://www.geeksforgeeks.org/change-k-elements-so-that-a12-a22-an2/)
...
Output: Not Possible
(As we can only change 1 element to any arbitrary number and after changing it doesn't satisfy above condition)
```

## 方法

当数组的所有元素都等于 `1` 时，那么只能满足给定的方程，否则不能满足。
