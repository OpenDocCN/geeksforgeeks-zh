# 查询是否所有元素都可以通过将符号精确翻转 K 次变成正的

> 原文: [https://www.geeksforgeeks.org/queries-to-check-whether-all-the-elements-can-be-made-positive-by-flipping-signs-exactly-k-times/](https://www.geeksforgeeks.org/queries-to-check-whether-all-the-elements-can-be-made-positive-by-flipping-signs-exactly-k-times/)
