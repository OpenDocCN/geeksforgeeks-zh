...
> 原文: [https://www.geeksforgeeks.org/program-calculate-area-circumcircle-equilateral-triangle/](https://www.geeksforgeeks.org/program-calculate-area-circumcircle-equilateral-triangle/)
...
我们知道[圆的面积](https://www.geeksforgeeks.org/c-program-find-area-circle/) = `π*r^2`，其中`r`是给定圆的半径。
