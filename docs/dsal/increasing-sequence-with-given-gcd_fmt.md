...
> 原文: [https://www.geeksforgeeks.org/increasing-sequence-with-given-gcd/](https://www.geeksforgeeks.org/increasing-sequence-with-given-gcd/)

给定两个整数 `n` 和 `g`，任务是生成 `n` 个整数的**递增序列**，使得:
