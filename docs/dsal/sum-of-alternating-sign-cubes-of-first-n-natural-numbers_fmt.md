...
> 原文: [https://www.geeksforgeeks.org/sum-of-alternating-sign-cubes-of-first-n-natural-numbers/](https://www.geeksforgeeks.org/sum-of-alternating-sign-cubes-of-first-n-natural-numbers/)
...
> **输出:** 20
> **解释:**
> 所需和= 1<sup>3</sup>–2<sup>3</sup>+3<sup>3</sup>=20

**天真方法:** 一个简单的解决方案是通过迭代一个从 1 到 `N` 的[循环](https://www.geeksforgeeks.org/c-c-for-loop-with-examples/)来解决这个问题，并通过每次交替符号来计算总和。
以下是上述方法的实施:
