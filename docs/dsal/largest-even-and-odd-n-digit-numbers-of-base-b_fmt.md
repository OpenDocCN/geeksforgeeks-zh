...
> 原文: [https://www.geeksforgeeks.org/largest-even-and-odd-n-digit-numbers-of-base-b/](https://www.geeksforgeeks.org/largest-even-and-odd-n-digit-numbers-of-base-b/)
...
**方法:**
以十进制形式得到基 B 的最大偶数和奇数 `N` 位数由下式给出:
