...
> 原文: [https://www.geeksforgeeks.org/partition-a-set-into-two-non-empty-subsets-such-that-the-difference-of-subset-sums-is-maximum/](https://www.geeksforgeeks.org/partition-a-set-into-two-non-empty-subsets-such-that-the-difference-of-subset-sums-is-maximum/)
...
> **输出:** `2`
> **说明:**
> 子集为`{1}`和`{2，1}`。它们的绝对差是 `abs(1 –( 2+1))= 2`，最大。
>
> **输入:** `S[] = { -2，3，-1，5 }`
> **输出:** `11`
> **说明:**
> 子集为`{-1，-2}`和`{3，5}`。它们的绝对差是 `abs((-1，-2)–(3+5))= 11`，最大。
