...
> 原文: [https://www.geeksforgeeks.org/building-expression-tree-from-prefix-expression/](https://www.geeksforgeeks.org/building-expression-tree-from-prefix-expression/)

给定一个字符数组`a[]`，表示一个前缀表达式。任务是为该表达式构建一个[表达式树](https://www.geeksforgeeks.org/expression-tree/)，然后打印所构建的树的**中缀**和**后缀**表达式。
