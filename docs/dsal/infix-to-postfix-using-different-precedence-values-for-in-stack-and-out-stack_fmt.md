...
> 原文: [https://www.geeksforgeeks.org/infix-to-postfix-using-different-precedence-values-for-in-stack-and-out-stack/](https://www.geeksforgeeks.org/infix-to-postfix-using-different-precedence-values-for-in-stack-and-out-stack/)
...
例如，电力操作符`^`。`"a^b^c"`的后缀是`"abc^^"`，但上面的解决方案会将后缀打印为`"ab^c^"`，这是错误的。
