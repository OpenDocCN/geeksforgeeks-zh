...
> 原文: [https://www.geeksforgeeks.org/pairs-of-positive-negative-values-in-an-array/](https://www.geeksforgeeks.org/pairs-of-positive-negative-values-in-an-array/)

给定一个由**不同的**整数组成的数组，打印该数组中所有具有正负值的数字对。我们需要按出现的顺序打印配对。任何元素首先出现的对应该首先打印。
