...
> 原文: [https://www.geeksforgeeks.org/sort-a-2d-vector-diagonally-using-map-data-structure/](https://www.geeksforgeeks.org/sort-a-2d-vector-diagonally-using-map-data-structure/)
...
1.  同一对角线上的所有元素具有相同的索引差异 `i-j`，其中 `i` 是行号，`j` 是列号。因此，我们可以使用地图来存储索引 `i-j` 的每一条对角线。
