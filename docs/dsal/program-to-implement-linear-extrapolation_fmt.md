...
> 原文：[https://www.geeksforgeeks.org/program-to-implement-linear-extrapolation/](https://www.geeksforgeeks.org/program-to-implement-linear-extrapolation/)
...
## 例：
> **输入：**`x1=1.2, y1=2.7`，`x2=0.5, y2=2.1`，`x = 1.2`
> **输出：** `y = 3.15`
