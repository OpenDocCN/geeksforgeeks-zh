...
> 原文：[https://www.geeksforgeeks.org/print-a-number-as-string-of-a-and-b-in-lexicographic-order/](https://www.geeksforgeeks.org/print-a-number-as-string-of-a-and-b-in-lexicographic-order/)
...
4.  因此‘A’和‘B’k 长度串可以表示从 `(pow(2, k)-2)+1` 到 `pow(2, k+1)-2` 的 `pow(2, k+1)` 个数，即 `AA…A` (k 次) 到 `BB…B` (k 次)。
