...
> 原文: [https://www.geeksforgeeks.org/program-to-check-if-n-is-an-icosikaioctagonal-number/](https://www.geeksforgeeks.org/program-to-check-if-n-is-an-icosikaioctagonal-number/)

给定一个整数 `N`，任务是检查它是否是一个 [icosikaioctagonal 数字](https://www.geeksforgeeks.org/icosikaioctagon-or-icosioctagon-number/)。

> 一个 [icosikaioctagonal 数](https://www.geeksforgeeks.org/icosikaioctagon-or-icosioctagon-number/) 是一类图形数。它有一个 28 边的多边形，叫做 icosikaioctagon。第 N 个 icosikaioctagonal 数字计数是 28 个点的数量，所有其他点都被一个公共共享角包围并形成一个图案。icosikaioctagonal 的前几个数字是 1、28、81、160 …
...
1.  icosikaioctagonal 数的第 K<sup>项</sup>给出如下:
