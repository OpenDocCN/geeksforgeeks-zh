...
> 原文：[https://www.geeksforgeeks.org/construct-a-string-of-length-l-such-that-each-substring-of-length-x-has-exactly-y-distinct-letters/](https://www.geeksforgeeks.org/construct-a-string-of-length-l-such-that-each-substring-of-length-x-has-exactly-y-distinct-letters/)
...
> 子串中正好有三个不同的字符（`a`、`b`、`c`）。
> 同样，如果我们从长度为 5 的字符串中提取任何子字符串，那么它将有正好 3 个不同的字符。
>
> **输入：** `l = 3`，`x = 1`，`y = 1`
> **输出：** `aaa`
> **解释：**
