...
> 原文: [https://www.geeksforgeeks.org/check-if-queue-elements-are-pairwise-consecutive-set-2/](https://www.geeksforgeeks.org/check-if-queue-elements-are-pairwise-consecutive-set-2/)
