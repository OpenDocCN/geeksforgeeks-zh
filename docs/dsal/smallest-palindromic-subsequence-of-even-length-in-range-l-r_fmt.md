# 范围[L，R]：内偶数长度的最小回文子序列

> 原文: [https://www.geeksforgeeks.org/smallest-palindromic-subsequence-of-even-length-in-range-l-r/](https://www.geeksforgeeks.org/smallest-palindromic-subsequence-of-even-length-in-range-l-r/)
