...
> 原文: [https://www.geeksforgeeks.org/check-whether-the-given-matrix-is-balanced-or-not/](https://www.geeksforgeeks.org/check-whether-the-given-matrix-is-balanced-or-not/)
...
1.  遍历给定矩阵 `mat[][]`。
2.  对于矩阵的每个单元，检查所有相邻单元，即 `mat[i+1][j]`、`mat[i][j+1]`、`mat[i-1][j]`、`mat[i][j-1]` 是否严格小于当前单元。
