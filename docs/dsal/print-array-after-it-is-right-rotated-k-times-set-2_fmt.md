...
> 原文: [https://www.geeksforgeeks.org/print-array-after-it-is-right-rotated-k-times-set-2/](https://www.geeksforgeeks.org/print-array-after-it-is-right-rotated-k-times-set-2/)

给定一个大小为 `N` 的数组 `arr[]` 和一个值 `K`，任务是打印向右旋转 `K` 次的数组。
...
给定的问题可以通过反转子数组来解决。可以遵循以下步骤来解决问题:
