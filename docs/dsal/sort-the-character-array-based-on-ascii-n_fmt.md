...
> 原文：[https://www.geeksforgeeks.org/sort-the-character-array-based-on-ascii-n/](https://www.geeksforgeeks.org/sort-the-character-array-based-on-ascii-n/)
...
排序也可以使用 [std::sort()](https://www.geeksforgeeks.org/sort-c-stl/) 并修改比较器来完成。
