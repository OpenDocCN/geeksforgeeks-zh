...
> **输出**：`2`
> **说明**：
> 如果 3 顶点图中有三个边，它将有一个三角形。

## 方法

可以使用[曼特尔定理](https://en.wikipedia.org/wiki/Tur%C3%A1n%27s_theorem#Mantel's_theorem)解决此问题，该定理指出图形中不包含任何三角形的最大边数是 `floor(n^2 / 4)`。换句话说，必须删除几乎一半的边才能获得无三角形的图形。
