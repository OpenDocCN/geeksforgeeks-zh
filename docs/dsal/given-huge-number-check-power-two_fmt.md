...
> 原文: [https://www.geeksforgeeks.org/given-huge-number-check-power-two/](https://www.geeksforgeeks.org/given-huge-number-check-power-two/)
...
Boost 库旨在广泛使用，并可用于广泛的应用领域。例如，在 C++中，它们有助于处理范围超过长双数据类型(`2^64`)的大数。
...
**参考:**[https://www.boost.org/doc/libs/1_61_0/libs/multiprecision/doc/html/index.html](https://www.boost.org/doc/libs/1_61_0/libs/multiprecision/doc/html/index.html)
