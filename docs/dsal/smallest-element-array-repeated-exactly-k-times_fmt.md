...
> 原文: [https://www.geeksforgeeks.org/smallest-element-array-repeated-exactly-k-times/](https://www.geeksforgeeks.org/smallest-element-array-repeated-exactly-k-times/)
...
### 高效方法
高效方法基于数组具有小范围(1 到 1000)的数字这一事实。我们通过使用最大大小的频率数组来解决这个问题，并将每个数字的频率存储在该数组中。
