...
> 原文: [https://www.geeksforgeeks.org/print-the-nodes-corresponding-to-the-level-value-for-each-level-of-a-binary-tree/](https://www.geeksforgeeks.org/print-the-nodes-corresponding-to-the-level-value-for-each-level-of-a-binary-tree/)
...
1.  [遍历给定的树](https://www.geeksforgeeks.org/tree-traversals-inorder-preorder-and-postorder/)并将每个节点的级别和节点的值存储在`multimap`中。
...
3.  现在，在范围**【1，L】**内迭代多重映射，并执行以下操作：
    *   对于每一级 **L** ，遍历至该级的 **L<sup>第</sup>** 节点，检查是否存在。如果发现存在，打印该节点的值。
    *   否则，打印 **-1**，进入下一级。
