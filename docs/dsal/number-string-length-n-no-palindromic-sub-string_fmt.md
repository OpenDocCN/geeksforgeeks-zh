...
> 原文: [https://www.geeksforgeeks.org/number-string-length-n-no-palindromic-sub-string/](https://www.geeksforgeeks.org/number-string-length-n-no-palindromic-sub-string/)
