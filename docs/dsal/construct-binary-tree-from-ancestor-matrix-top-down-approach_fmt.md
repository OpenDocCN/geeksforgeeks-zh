...
> 原文: [https://www.geeksforgeeks.org/construct-binary-tree-from-ancestor-matrix-top-down-approach/](https://www.geeksforgeeks.org/construct-binary-tree-from-ancestor-matrix-top-down-approach/)
...
**自下而上的方法** : [从祖先矩阵构造树](https://www.geeksforgeeks.org/construct-tree-from-ancestor-matrix/)
