...
> 原文：[https://www.geeksforgeeks.org/convert-given-decimal-number-into-an-irreducible-fraction/](https://www.geeksforgeeks.org/convert-given-decimal-number-into-an-irreducible-fraction/)
...
>
> 考虑精度值为(`10^9`)即精度值= `1000000000`
>
> 计算 `GCD(0.50 * 10^9, 10^9) = 50000000`
>
> 计算**分子** = (`0.50 * 10^9`) / `50000000` = `10`
> 计算**分母** = `10^9` / `50000000` = `20`
>
> 因此，分数部分为 `10/20`，化简后为 `1/2`。
>
> 最终分数为 `4 + 1/2 = 9/2`。
