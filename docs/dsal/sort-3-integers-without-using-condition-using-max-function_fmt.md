...
> 原文: [https://www.geeksforgeeks.org/sort-3-integers-without-using-condition-using-max-function/](https://www.geeksforgeeks.org/sort-3-integers-without-using-condition-using-max-function/)
...
2.  将所有整数乘以 `-1`。再次使用 `max()` 函数找到 `-a`、`-b`、`-c` 的最小值。
3.  将上述步骤中的最大值和最小值相加，并将总和细分为 `(a+b+c)`。它给了我们中间的元素。
4.  对负数也有效。
