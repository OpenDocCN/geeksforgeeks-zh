# 检查一个字符串的长度是否等于其最后一个所附加的数字

> 原文: [https://www.geeksforgeeks.org/check-length-string-equal-number-appended-last/](https://www.geeksforgeeks.org/check-length-string-equal-number-appended-last/)
