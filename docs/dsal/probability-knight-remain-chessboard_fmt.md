...
> 原文: [https://www.geeksforgeeks.org/probability-knight-remain-chessboard/](https://www.geeksforgeeks.org/probability-knight-remain-chessboard/)
...
那么，`K` 步之后的最终概率将简单地等于 (`K-1` 步之后到达这 8 个位置中每一个的概率)/8；
