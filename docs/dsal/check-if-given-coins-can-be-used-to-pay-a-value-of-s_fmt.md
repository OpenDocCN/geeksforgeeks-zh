...
> 原文: [https://www.geeksforgeeks.org/check-if-given-coins-can-be-used-to-pay-a-value-of-s/](https://www.geeksforgeeks.org/check-if-given-coins-can-be-used-to-pay-a-value-of-s/)

给定价值为 `A` 的硬币 `N` 和价值为 `B` 的硬币 `M`，任务是检查给定的硬币是否可以用来支付价值为 `S` 的硬币。
