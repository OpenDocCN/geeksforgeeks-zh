...
> 原文: [https://www.geeksforgeeks.org/program-to-find-the-eccentricity-of-an-ellipse/](https://www.geeksforgeeks.org/program-to-find-the-eccentricity-of-an-ellipse/)
...
给定问题可基于以下公式求解，计算椭圆的[偏心率，公式如下:](https://en.wikipedia.org/wiki/Eccentricity_(mathematics)#Ellipses)
