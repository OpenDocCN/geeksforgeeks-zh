...
> 原文: [https://www.geeksforgeeks.org/check-if-it-is-possible-to-rearrange-rectangles-in-a-non-ascending-order-of-breadths/](https://www.geeksforgeeks.org/check-if-it-is-possible-to-rearrange-rectangles-in-a-non-ascending-order-of-breadths/)
...
> `l = 56，b = 80`
> **输出:** NO
> 宽度为 `[60，55，80]`。`55` 不大于 `60`，但 `80` 大于 `55`。所以不可能以非升序排列宽度，这就是为什么我们要打印 NO。
