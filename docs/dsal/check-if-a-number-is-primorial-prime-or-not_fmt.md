...
> 原文: [https://www.geeksforgeeks.org/check-if-a-number-is-primorial-prime-or-not/](https://www.geeksforgeeks.org/check-if-a-number-is-primorial-prime-or-not/)
...
2.  检查 `n` 是否为质数，如果 `n` 不是质数，则打印“否”。
3.  否则，从第一个质数(即 2)开始乘以下一个质数，并继续检查 `乘积+ 1 = n` 或 `乘积–1 = n`。
