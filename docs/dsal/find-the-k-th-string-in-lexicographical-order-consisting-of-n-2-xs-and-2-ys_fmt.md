...
> 原文: [https://www.geeksforgeeks.org/find-the-k-th-string-in-lexicographical-order-consisting-of-n-2-xs-and-2-ys/](https://www.geeksforgeeks.org/find-the-k-th-string-in-lexicographical-order-consisting-of-n-2-xs-and-2-ys/)

给定两个数字 `N` 和 `K`，如果起始字符串首先包含 `(N-2)` 个 `X`，然后包含 `2` 个 `Y`。
