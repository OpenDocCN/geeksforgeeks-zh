...
> 原文：[`https://www.geeksforgeeks.org/array-representation-of-binary-heap/`](https://www.geeksforgeeks.org/array-representation-of-binary-heap/)
...
`2. 最大堆属性`：每个节点的值小于或等于其父节点的值，最大值在根节点。
