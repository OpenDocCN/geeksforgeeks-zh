...
> 原文: [https://www.geeksforgeeks.org/smallest-number-dividing-minimum-number-of-elements-in-the-array-set-2/](https://www.geeksforgeeks.org/smallest-number-dividing-minimum-number-of-elements-in-the-array-set-2/)
...
先观察一些细节。除零元素的数字已经存在，即 `max(arr) + 1`。现在，我们只需要找到数组中除以零的最小数。
