...
> 原文: [https://www.geeksforgeeks.org/amazon-interview-experience-set-357-1-5-years-experienced/](https://www.geeksforgeeks.org/amazon-interview-experience-set-357-1-5-years-experienced/)
...
1.  在未排序的数组中找到一个元素，这样所有左边的元素都变小，所有右边的元素都变大。
    **解决方案**: [geeksforgeeks Link](https://practice.geeksforgeeks.org/problems/unsorted-array/0)
    `O(n)`时间复杂度解决方案。
