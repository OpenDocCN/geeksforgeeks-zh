# 检查将另一字符串旋转 2 个位置是否可以得到另一字符串

> 原文: [https://www.geeksforgeeks.org/check-string-can-obtained-rotating-another-string-2-places/](https://www.geeksforgeeks.org/check-string-can-obtained-rotating-another-string-2-places/)
