...
> 原文: [https://www.geeksforgeeks.org/alternate-vowel-consonant-string/](https://www.geeksforgeeks.org/alternate-vowel-consonant-string/)
...
本文由**阿尤什·乔哈里**供稿。如果你喜欢 GeeksforGeeks 并想投稿，你也可以使用`write.geeksforgeeks.org`写一篇文章或者把你的文章邮寄到`review-team@geeksforgeeks.org`。看到你的文章出现在极客博客主页上，帮助其他极客。
