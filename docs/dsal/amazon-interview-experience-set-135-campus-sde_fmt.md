...
> 原文: [https://www.geeksforgeeks.org/amazon-interview-experience-set-135-campus-sde/](https://www.geeksforgeeks.org/amazon-interview-experience-set-135-campus-sde/)
...
1.  [给定一个正负整数数组，在 `O(n)` 时间内重新排列正负数字。](https://practice.geeksforgeeks.org/problems/array-of-alternate-ve-and-ve-nos/0)
