...
> 原文: [https://www.geeksforgeeks.org/students-with-maximum-average-score-of-three-subjects/](https://www.geeksforgeeks.org/students-with-maximum-average-score-of-three-subjects/)
...
> **输入:** `file[] = {"Shrikanth", "20", "30", "10", "Ram", "100", "50", "10"}`
> **输出:** `Ram 53`
> Shrikanth、Ram 平均成绩分别为 20 和 53。所以拉姆的最高平均分是 53 分。

> **输入:** `file[] = {"Ramesh", "90", "70", "40", "Adam", "50", "10", "40", "Suresh", "22", "1", "56", "Rocky", "100", "90", "10"}`
> **输出:** `Ramesh Rocky 66`
