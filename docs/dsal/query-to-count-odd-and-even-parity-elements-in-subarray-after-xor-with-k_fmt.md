...
> 原文: [https://www.geeksforgeeks.org/query-to-count-odd-and-even-parity-elements-in-subarray-after-xor-with-k/](https://www.geeksforgeeks.org/query-to-count-odd-and-even-parity-elements-in-subarray-after-xor-with-k/)
...
class GFG{
    ...
    static void add(int currL, int a[])
    {
        ...
        // __builtin_parity(x)returns true
        // if the number has odd parity else
