...
> 原文: [https://www.geeksforgeeks.org/circumradius-of-a-cyclic-quadrilateral-using-the-length-of-sides/](https://www.geeksforgeeks.org/circumradius-of-a-cyclic-quadrilateral-using-the-length-of-sides/)
...
*   用以下公式计算带边循环四边形的[半周长](https://en.wikipedia.org/wiki/Semiperimeter)`A`，`B`，`C` 和 `D`:
