...
> 原文: [https://www.geeksforgeeks.org/number-of-sub-sequences-of-non-zero-length-of-a-binary-string-divisible-by-3/](https://www.geeksforgeeks.org/number-of-sub-sequences-of-non-zero-length-of-a-binary-string-divisible-by-3/)
...
> **输入:** `S = "1001"`
> **输出:** 5
> “11”“1001”“0”“0”“00”是唯一可被 3 整除的子序列。
> **输入:** `S = "1"`
> **输出:** 0

## 天真方法

生成所有可能的子序列，检查它们是否能被 3 整除。时间复杂度为 `(2^N) * N`。

## 更好的做法

动态规划可以解决这个问题。让我们看看 DP 的状态。
