...
> 原文：[https://www.geeksforgeeks.org/find-minimum-sum-factors-number/](https://www.geeksforgeeks.org/find-minimum-sum-factors-number/)
...
为了使总和最小化，我们必须尽可能长时间地分解因素。有了这个过程，我们进行[质因数分解](https://www.geeksforgeeks.org/print-all-prime-factors-of-a-given-number/)。所以要求数的积的最小和，就要求积的素因子的和。
