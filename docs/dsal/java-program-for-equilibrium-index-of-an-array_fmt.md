...
> 原文：[https://www.geeksforgeeks.org/java-program-for-equilibrium-index-of-an-array/](https://www.geeksforgeeks.org/java-program-for-equilibrium-index-of-an-array/)
...
在获取两个前缀和之后，运行一个循环并检查对于某个 `i`，如果一个数组的两个前缀和等于第二个数组的前缀和，那么该点可以被认为是平衡点。
