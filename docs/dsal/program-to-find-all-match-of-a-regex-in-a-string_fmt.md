...
> 原文：[https://www.geeksforgeeks.org/program-to-find-all-match-of-a-regex-in-a-string/](https://www.geeksforgeeks.org/program-to-find-all-match-of-a-regex-in-a-string/)

## 先决条件
[c++中的 `smatch` | Regex(正则表达式)](https://www.geeksforgeeks.org/smatch-regex-regular-expressions-in-c/)
