...
这个想法是使用[前缀总和](https://www.geeksforgeeks.org/prefix-sum-array-implementation-applications-competitive-programming/)来有效地解决这个问题。请按照以下步骤解决问题：
...
为了优化上述方法，我们可以使用[映射数据结构](https://www.geeksforgeeks.org/map-associative-containers-the-c-standard-template-library-stl/)来节省空间。 请按照以下步骤解决问题：
