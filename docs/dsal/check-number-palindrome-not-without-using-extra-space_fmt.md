...
> 原文: [https://www.geeksforgeeks.org/check-number-palindrome-not-without-using-extra-space/](https://www.geeksforgeeks.org/check-number-palindrome-not-without-using-extra-space/)
...
一个递归的解决方案将在下面的文章中讨论。[检查一个数字是否是回文](https://www.geeksforgeeks.org/check-if-a-number-is-palindrome/)在这篇文章中讨论了一个不同的解决方案。
