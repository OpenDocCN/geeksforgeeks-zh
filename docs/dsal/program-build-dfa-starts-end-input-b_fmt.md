# 构建以输入(a，b)中的'a'开始和结束的DFA的程序

> 原文：[https://www.geeksforgeeks.org/program-build-dfa-starts-end-input-b/](https://www.geeksforgeeks.org/program-build-dfa-starts-end-input-b/)
