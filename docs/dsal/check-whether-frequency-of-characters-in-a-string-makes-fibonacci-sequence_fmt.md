...
> 原文: [https://www.geeksforgeeks.org/check-whether-frequency-of-characters-in-a-string-makes-fibonacci-sequence/](https://www.geeksforgeeks.org/check-whether-frequency-of-characters-in-a-string-makes-fibonacci-sequence/)
...
*   将字符串中每个字符的频率存储在地图中。存储频率后让地图大小为 `n`。
