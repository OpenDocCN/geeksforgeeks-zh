...
> 原文：[https://www.geeksforgeeks.org/find-the-number-of-occurrences-of-a-character-upto-preceding-position/](https://www.geeksforgeeks.org/find-the-number-of-occurrences-of-a-character-upto-preceding-position/)
...
天真的方法是迭代字符串，直到位置 1 搜索相似的字符。每当出现类似字符时，将计数器变量递增 1。
...
在这种情况下，如果有多个这样的查询，并且每个查询都有一个唯一的索引 `P`，那么一个高效的方法是使用一个频率数组来存储字符串每次迭代中的字符数。
