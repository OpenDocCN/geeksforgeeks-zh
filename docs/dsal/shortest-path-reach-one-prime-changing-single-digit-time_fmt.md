...
这个问题可以通过`BFS`来解决，作为初学者的入门问题，解决起来还是蛮有意思的。我们首先利用厄拉多塞的[筛技术](https://www.geeksforgeeks.org/sieve-of-eratosthenes/)找出 9999 以前的所有 4 位素数。然后用这些数字组成了使用[邻接表](https://www.geeksforgeeks.org/graph-and-its-representations/)的图。在形成邻接表之后，我们使用简单的 `BFS` 来解决这个问题。
