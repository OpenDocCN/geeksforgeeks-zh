...
> 原文: [https://www.geeksforgeeks.org/count-common-prime-factors-of-two-numbers/](https://www.geeksforgeeks.org/count-common-prime-factors-of-two-numbers/)

给定两个整数`A`和`B`，任务是找出因子为素数的两个数的公共因子的个数。
