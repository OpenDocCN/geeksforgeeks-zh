...
> 原文: [https://www.geeksforgeeks.org/number-of-ones-in-the-smallest-repunit/](https://www.geeksforgeeks.org/number-of-ones-in-the-smallest-repunit/)
...
> 输入: 3
> 输出: 3
> As 3 除以 111，111 是该数的最小重复单位倍数。所以 111 中的 1 数是 3。
> 输入: 13
> 输出: 6
