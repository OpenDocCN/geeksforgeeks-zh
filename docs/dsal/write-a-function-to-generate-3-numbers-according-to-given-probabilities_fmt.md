...
> 原文: [https://www.geeksforgeeks.org/write-a-function-to-generate-3-numbers-according-to-given-probabilities/](https://www.geeksforgeeks.org/write-a-function-to-generate-3-numbers-according-to-given-probabilities/)
...
b) `r` 大于 `P(x)`，小于或等于 `P(x) + P(y)`，概率 `P(y)/100`。
