...
> 原文: [https://www.geeksforgeeks.org/greatest-divisor-which-divides-all-natural-number-in-range-l-r/](https://www.geeksforgeeks.org/greatest-divisor-which-divides-all-natural-number-in-range-l-r/)
...
*   如果 `L = R` 那么答案将是 `L`。
*   如果 `L < R` 那么这个范围内所有连续的自然数都是互素的。因此，`1` 是唯一能够整除范围内所有元素的数字。
