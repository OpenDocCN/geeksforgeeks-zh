...
> 原文：[https://www.geeksforgeeks.org/javascript-program-for-reversing-a-doubly-linked-list/](https://www.geeksforgeeks.org/javascript-program-for-reversing-a-doubly-linked-list/)
...
function reverse() {
    ...
    // Popped all the elements and the added in the linked list,
