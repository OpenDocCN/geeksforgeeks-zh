...
> 原文: [https://www.geeksforgeeks.org/calculate-volume-and-surface-area-of-torus/](https://www.geeksforgeeks.org/calculate-volume-and-surface-area-of-torus/)
...
其中 `r` 是小圆的半径，`R` 是大圆的半径，`π` 是常数 `π= 3.14159`。
