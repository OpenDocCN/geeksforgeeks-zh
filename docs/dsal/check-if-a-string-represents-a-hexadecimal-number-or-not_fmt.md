...
> 原文：[https://www.geeksforgeeks.org/check-if-a-string-represents-a-hexadecimal-number-or-not/](https://www.geeksforgeeks.org/check-if-a-string-represents-a-hexadecimal-number-or-not/)
...
该方法基于以下思想：十六进制数的所有元素位于字符 `A` 到 `F` 之间或整数 `0` 到 `9` 之间。以下是解决问题的步骤：
