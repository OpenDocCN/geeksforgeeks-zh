...
> 原文: [https://www.geeksforgeeks.org/sum-natural-numbers-up-to-n-whose-modulo-with-k-yield-r/](https://www.geeksforgeeks.org/sum-natural-numbers-up-to-n-whose-modulo-with-k-yield-r/)
...
*   初始化 `sum = 0` 并用 `K` 取每个元素从 `1` 到 `N` 的模。
