...
> 原文: [https://www.geeksforgeeks.org/rearrange-a-string-s1-such-that-another-given-string-s2-is-not-its-subsequence/](https://www.geeksforgeeks.org/rearrange-a-string-s1-such-that-another-given-string-s2-is-not-its-subsequence/)
...
*   [使用变量 `i` 遍历数组](https://www.geeksforgeeks.org/c-program-to-traverse-an-array/) `cnt[]`。如果 `cnt[i]` 的值等于 `M`，这意味着 `S2` 仅由 `1` 个唯一字符组成。将该字符存储在 `ch` 和[中，脱离循环](https://www.geeksforgeeks.org/break-statement-cc/)。
*   如果未定义 `ch` 的值，则执行以下操作:
