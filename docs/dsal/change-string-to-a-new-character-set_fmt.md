...
> 原文: [https://www.geeksforgeeks.org/change-string-to-a-new-character-set/](https://www.geeksforgeeks.org/change-string-to-a-new-character-set/)
...
1.  第一个字符是 q，在散列过程中，我们将在索引 `q` 处放置‘a’（表示位置），即（17<sup>第</sup>）。
