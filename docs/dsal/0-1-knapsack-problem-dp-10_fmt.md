...
**方法二:** 和其他典型的[动态规划(DP)问题](https://www.geeksforgeeks.org/archives/tag/dynamic-programming)一样，通过自下而上的方式构造临时数组 `K[][]`，可以避免相同子问题的重新计算。下面是基于动态编程的实现。
...
*   [http://www.cse.unl.edu/~goddard/Courses/CSCE310J/Lectures/Lecture8-DynamicProgramming.pdf](http://www.cse.unl.edu/~goddard/Courses/CSCE310J/Lectures/Lecture8-DynamicProgramming.pdf)
*   [https://youtu.be/T4bY72lCQac?list=PLqM7alHXFySGMu2CSdW_6d2u1o6WFTIO-](https://youtu.be/T4bY72lCQac?list=PLqM7alHXFySGMu2CSdW_6d2u1o6WFTIO-)

如果你发现任何不正确的地方，或者你想分享更多关于上面讨论的话题的信息，请写评论。

### 方法 4 :-

我们再次使用动态规划方法，该方法具有更优化的空间复杂度。
