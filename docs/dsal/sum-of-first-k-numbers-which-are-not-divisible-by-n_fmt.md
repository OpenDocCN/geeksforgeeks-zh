...
> 原文: [https://www.geeksforgeeks.org/sum-of-first-k-numbers-which-are-not-divisible-by-n/](https://www.geeksforgeeks.org/sum-of-first-k-numbers-which-are-not-divisible-by-n/)

给定两个数字 `N` 和 `K`，任务是找出前 `K` 个不能被 `N` 整除的数字的和。

**示例:**

> **输入:** `N = 5`，`K = 10`
> **输出:** 63
> **说明:** `{1, 2, 3, 4, 6, 7, 8, 9, 11, 12}` 之和为 63。
>
> **输入:** `N = 3`，`K = 13`
> **输出:** 127
