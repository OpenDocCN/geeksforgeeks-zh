...
> 原文: [https://www.geeksforgeeks.org/greatest-odd-factor-of-an-even-number/](https://www.geeksforgeeks.org/greatest-odd-factor-of-an-even-number/)
...
**朴素法:** 朴素法是[找出 `N` 的所有因子](https://www.geeksforgeeks.org/find-divisors-natural-number-set-1/)，然后从中选出最大的奇因子。
**时间复杂度:** `O(sqrt(N))`
