...
> 原文: [https://www.geeksforgeeks.org/calculate-depth-full-binary-tree-preorder/](https://www.geeksforgeeks.org/calculate-depth-full-binary-tree-preorder/)
...
二叉树的前序是这样遍历的。同样，我们会得到一串字符(由‘n’和‘l’组成)，所以也没有必要实现树。
