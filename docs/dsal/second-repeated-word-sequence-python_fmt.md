...
> 原文：[`https://www.geeksforgeeks.org/second-repeated-word-sequence-python/`](https://www.geeksforgeeks.org/second-repeated-word-sequence-python/)
...
此问题已有解决方案请参考[序列中重复次数第二多的单词](https://www.geeksforgeeks.org/second-repeated-word-sequence/)链接。我们可以使用[`Counter`](https://www.geeksforgeeks.org/counters-in-python-set-1/)方法在 Python 中快速解决这个问题。

方法很简单：

1.  使用`Counter`方法创建一个字典，其中包含单词作为关键字，其频率作为值。
