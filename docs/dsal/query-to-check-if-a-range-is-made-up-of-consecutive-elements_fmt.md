...
> 原文: [https://www.geeksforgeeks.org/query-to-check-if-a-range-is-made-up-of-consecutive-elements/](https://www.geeksforgeeks.org/query-to-check-if-a-range-is-made-up-of-consecutive-elements/)
...
3.  由于没有重复的元素，因此可以得出结论，如果最大和最小元素+1的差等于范围的长度 `(r-l+1)`，则该范围由连续的元素组成。
