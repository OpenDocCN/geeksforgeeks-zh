...
> 原文：[https://www.geeksforgeeks.org/find-the-number-of-p-sided-squares-in-a-grid-with-k-blacks-painted/](https://www.geeksforgeeks.org/find-the-number-of-p-sided-squares-in-a-grid-with-k-blacks-painted/)
...
*   例如，假设单元格 `[i, j]` 被涂成黑色。那么它将对具有起始点 `[i-p+1][j-p+1]` 到 `[i, j]` 的所有子网格贡献额外的 `+1`。
