...
> 原文: [https://www.geeksforgeeks.org/given-a-number-n-in-decimal-base-find-the-sum-of-digits-in-any-base-b/](https://www.geeksforgeeks.org/given-a-number-n-in-decimal-base-find-the-sum-of-digits-in-any-base-b/)

给定一个以十进制为基数的数 `N`，任务是求任意基数 `B` 的数的位数之和。
