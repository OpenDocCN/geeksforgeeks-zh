...
> 原文：[https://www.geeksforgeeks.org/generate-n-random-hexadecimal-numbers/](https://www.geeksforgeeks.org/generate-n-random-hexadecimal-numbers/)

给定一个正整数 `N`，任务是生成 `N` 个随机的[十六进制整数](https://www.geeksforgeeks.org/program-decimal-hexadecimal-conversion/)。
...
**方法：** 借助用于生成随机整数的 [`rand()` 函数](https://www.geeksforgeeks.org/rand-and-srand-in-ccpp/)可以解决给定的问题。可以创建字符[数组](https://www.geeksforgeeks.org/array-data-structure/)，该数组将所有可能的字符存储在[十六进制符号](https://www.geeksforgeeks.org/program-decimal-hexadecimal-conversion/)中，并从该数组中随机选择字符。
