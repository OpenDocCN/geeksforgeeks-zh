...
> 原文: [https://www.geeksforgeeks.org/print-triangle-separated-pattern/](https://www.geeksforgeeks.org/print-triangle-separated-pattern/)
...
通过观察上述模式，当行列索引相等时，则打印 `\`，当行列索引之和为 `N-1` 时，则打印 `/`。下面是递归方法:
