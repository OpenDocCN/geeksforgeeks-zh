...
> 原文：[https://www.geeksforgeeks.org/repeated-character-whose-first-appearance-is-leftmost/](https://www.geeksforgeeks.org/repeated-character-whose-first-appearance-is-leftmost/)
...
我们从左向右遍历字符串。我们跟踪每个字符最左边的索引。如果一个字符重复，我们将它的左边的索引与当前结果进行比较，如果结果大于则更新结果。
...
我们从右向左遍历字符串。我们跟踪被访问的角色。如果一个字符重复，我们会更新结果。
