...
> 原文:[https://www.geeksforgeeks.org/program-to-find-the-profit-or-loss-when-cp-of-n-items-is-equal-to-sp-of-m-items/](https://www.geeksforgeeks.org/program-to-find-the-profit-or-loss-when-cp-of-n-items-is-equal-to-sp-of-m-items/)

给定`N`、`M`表示 N 件的**成本价等于 M 件**的**售价。任务是确定利润或亏损百分比。**
