# 通过仅交换第三个字符串使两个字符串相等的最小交换

> 原文: [https://www.geeksforgeeks.org/minimum-swaps-to-make-two-strings-equal-by-swapping-only-with-third-string/](https://www.geeksforgeeks.org/minimum-swaps-to-make-two-strings-equal-by-swapping-only-with-third-string/)
...
由于字符串的长度相等，因此想法是遍历字符串并检查字符串中存在的字符。
对于每个索引 `i`，出现以下情况:
