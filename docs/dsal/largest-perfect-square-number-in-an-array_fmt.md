...
> 原文：[https://www.geeksforgeeks.org/largest-perfect-square-number-in-an-array/](https://www.geeksforgeeks.org/largest-perfect-square-number-in-an-array/)

给定一组 `n` 个整数。任务是找到最大的数，也就是一个完美的正方形。如果没有完美平方的数字，打印 `-1`。
