...
> 原文: [https://www.geeksforgeeks.org/largest-number-not-greater-than-n-all-the-digits-of-which-are-odd/](https://www.geeksforgeeks.org/largest-number-not-greater-than-n-all-the-digits-of-which-are-odd/)

给定一个数字 `N`，任务是找到不大于 `N` 的最大数字，它的所有数字都是奇数。
