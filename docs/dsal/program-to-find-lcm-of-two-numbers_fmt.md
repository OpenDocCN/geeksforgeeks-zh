...
> 原文: [https://www.geeksforgeeks.org/program-to-find-lcm-of-two-numbers/](https://www.geeksforgeeks.org/program-to-find-lcm-of-two-numbers/)
...
一个简单的解决方案是[找到两个数的所有素因子](https://www.geeksforgeeks.org/print-all-prime-factors-of-a-given-number/)，然后找到两个数中所有因子的并集。最后，返回联合元素的乘积。

## 有效的解决方案

一个有效的解决方案是基于两个数字 `a` 和 `b` 的 LCM 的以下公式。
