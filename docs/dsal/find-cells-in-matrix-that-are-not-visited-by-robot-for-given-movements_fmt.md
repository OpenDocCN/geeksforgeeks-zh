...
> **输入**：
> `N = 5`，`move[] = {(0, SE), (1, NE), (2, E), (6, SW), (15, N), (20, W)}`
> **输出**：
> `13`
> **说明**：
> 机器人移动后，未访问 `13` 个单元。
...
的想法是使用[递归](http://www.geeksforgeeks.org/recursion/)解决此问题。首先，将机器人的当前位置设置为（0，0）。按照给定的方向开始机器人的运动，并标记矩阵访问的单元格。最后，在机器人标记完全移动之后，对未标记为已访问的矩阵单元进行计数。
