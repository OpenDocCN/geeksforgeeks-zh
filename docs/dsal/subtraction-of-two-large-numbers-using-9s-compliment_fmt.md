...
> 原文：[https://www.geeksforgeeks.org/subtraction-of-two-large-numbers-using-9s-compliment/](https://www.geeksforgeeks.org/subtraction-of-two-large-numbers-using-9s-compliment/)
...
> **输入:** `N = 17`，`str1 = "12345678987654321"`，`M = 11`，`str2 = "22324324343"`
> **输出:** `1234565663329978`
> **输入:** `N = 20`，`str1 = "1234534233242431433"`，`M = 20`
...
> 给定字符串的减法可以写成
> `str1 – str2 = str1 + (-str2) = str1 + (str2 的 9 补码)`
