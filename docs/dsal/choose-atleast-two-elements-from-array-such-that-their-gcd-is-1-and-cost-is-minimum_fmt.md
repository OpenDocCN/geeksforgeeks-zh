...
> 原文: [https://www.geeksforgeeks.org/choose-atleast-two-elements-from-array-such-that-their-gcd-is-1-and-cost-is-minimum/](https://www.geeksforgeeks.org/choose-atleast-two-elements-from-array-such-that-their-gcd-is-1-and-cost-is-minimum/)
...
> **输入:** `arr[] = {5, 10, 12, 1}`，`cost[] = {2, 1, 2, 6}`
> **输出:** 4
> `{5, 12}` 是成本 = 2 + 2 = 4
> **输入:** `arr[] = {50, 100, 150, 200, 300}`，`cost[] = {2, 3, 4, 5, 6}`
> **输出:** -1
