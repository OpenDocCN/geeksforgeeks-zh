...
![置信区间图解](img/cedafe205fe893d32675b9301af58a7c.png)
...
![等式-1](img/11c05f6d98a5aee15d7c35864a23f91a.png)
...
![\mu=\frac{1+2+3+\ldots+n}{n} \quad {.. Eq 2}](img/bfa2e1b261ae6336823d1bbb5ff7b9f6.png)

*   **标准差（`σ`）** — 它是衡量数字分布的尺度。它被定义为每个数和平均值之间的差的平方和。**（等式-3）**

![\sigma=\sqrt{\sum \frac{\left(x_{i}-\mu\right)^{2}}{n}} \quad {... Eq 3}](img/b09a2a62f5a779f65b540b0dde807a2c.png)
...
![d f=n-1 \quad {... Eq 4}](img/3b10c488aeab69dcbd0a75f0e8c1a26b.png)
...
![\alpha=\frac{1-C L}{2} \quad {... Eq 5}](img/89b0b70d3015ce6519450b1cede95bcf.png)
...
利用 `t` 分布表中 `df` 和 `α` 的值，我们得到 **`t = 2.262`**。
...
![\mu \pm t\left(\frac{\sigma}{\sqrt{n}}\right) \quad {...Eq6}](img/cf0929999844b9828f235d7b9362ed29.png)
...
![\begin{array}{l} \Rightarrow 240 \pm(2.262)^{*}(25 / \sqrt{10}) \\ \Rightarrow 240 \pm 17.883 \\ \Rightarrow(240-17.883,240+17.883) \\ \Rightarrow(222.117,257.883) \end{array}](img/02cab7df54169d5544ae4a5a9a99e6cd.png)
...
![\mu \pm z\left(\frac{\sigma}{\sqrt{n}}\right) \quad {.....Eq7}](img/d5b9b23db1620ef07b4a5e7c9014816c.png)
...
![\begin{array}{l} \Rightarrow4.63 \pm(1.960)^{*}(0.54 / \sqrt{50}) \\ \Rightarrow 4.63 \pm 0.149 \\ \Rightarrow(4.63-0.149,4.63+0.149) \\ \Rightarrow(4.480,4.780) \end{array}](img/14ee64ac48b30519fa64888384e08941.png)
