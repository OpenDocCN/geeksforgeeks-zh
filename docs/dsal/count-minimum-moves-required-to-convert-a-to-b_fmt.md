...
> 原文：[https://www.geeksforgeeks.org/count-minimum-moves-required-to-convert-a-to-b/](https://www.geeksforgeeks.org/count-minimum-moves-required-to-convert-a-to-b/)
...
思路是将 `A` 和 `B` 的[绝对差](https://www.geeksforgeeks.org/abs-labs-llabs-functions-cc/)除以 `[1...10]` 范围内的所有数字，并将其加到合成变量中，简单计算出所需的移动次数。按照以下步骤解决问题：
