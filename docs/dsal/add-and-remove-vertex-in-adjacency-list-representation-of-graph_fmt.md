...
[链表](https://www.geeksforgeeks.org/data-structures/linked-list/) [图形数据结构](https://www.geeksforgeeks.org/graph-data-structure-and-algorithms/)
...
*   **在图中移除顶点:** 要删除图中的一个顶点，需要遍历每个顶点的列表，检查边是否存在。如果边存在，则以链表中删除的方式删除该顶点。例如，如果从列表中删除顶点`4`，邻接表将转换为以下列表:
