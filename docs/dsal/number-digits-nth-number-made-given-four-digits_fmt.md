...
> 原文：[https://www.geeksforgeeks.org/number-digits-nth-number-made-given-four-digits/](https://www.geeksforgeeks.org/number-digits-nth-number-made-given-four-digits/)

找出第 `n` 个数字中的位数，该数字是用 6、1、4 和 9 作为升序中的唯一数字构造的。
通过仅使用 6、1、4 和 9 作为升序数字构建的前几个数字将是：1、6、4、9、11、14、16、19、41、44、46、49、61、64、66、69、91、94、96、99、111、114、116、119 等等。
...
你可以计算出在 `O(1)` 时间内 `k` 个数字的个数，它们总是 4 的幂，例如数列中 1 个数字的个数是 4，数列中 2 个数字的个数是 16，等等。
