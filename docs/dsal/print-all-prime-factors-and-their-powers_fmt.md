...
> 原文: [https://www.geeksforgeeks.org/print-all-prime-factors-and-their-powers/](https://www.geeksforgeeks.org/print-all-prime-factors-and-their-powers/)
...
一个`简单的解决方法`是首先[找到 `N` 的素因子](https://www.geeksforgeeks.org/print-all-prime-factors-of-a-given-number/)。然后对于每一个质因数，找到它除以 `N` 的最高幂并打印出来。
