...
> 原文: [https://www.geeksforgeeks.org/nth-term-where-k1th-term-is-product-of-kth-term-with-difference-of-max-and-min-digit-of-kth-term/](https://www.geeksforgeeks.org/nth-term-where-k1th-term-is-product-of-kth-term-with-difference-of-max-and-min-digit-of-kth-term/)
...
思路是借助[循环](https://www.geeksforgeeks.org/c-c-do-while-loop-with-examples/)迭代计算 `F(2)` 到 `F(N)` 的值。此外，每个数字中的最大和最小位数可以通过将数字除以 10 来计算，同时取模得到位数。
以下是上述方法的实施:
