...
> 原文: [https://www.geeksforgeeks.org/program-to-find-the-nth-prime-number/](https://www.geeksforgeeks.org/program-to-find-the-nth-prime-number/)

给定一个整数 `N`。任务是找到第 `n` 个素数。
...
*   使用厄拉多塞的[筛法](https://www.geeksforgeeks.org/sieve-of-eratosthenes/)找出最大大小的质数。
*   将所有素数存储在一个向量中。
