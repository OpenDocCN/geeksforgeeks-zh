...
> 原文: [https://www.geeksforgeeks.org/pair-with-minimum-absolute-difference-bst/](https://www.geeksforgeeks.org/pair-with-minimum-absolute-difference-bst/)
...
我们知道二叉查找树的有序遍历是按排序顺序遍历的。因此，对于每个节点，我们将在树的有序遍历中找到它与前一个节点的区别。如果这个差值小于之前的最小差值，我们将更新之前的最小差值。以下是要遵循的步骤:
