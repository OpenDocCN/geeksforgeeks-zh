...
> 原文：[https://www.geeksforgeeks.org/minimum-swap-required-convert-binary-tree-binary-search-tree/](https://www.geeksforgeeks.org/minimum-swap-required-convert-binary-tree-binary-search-tree/)
...
我们能不能把这个推广到正常的二叉树，也就是用左右指针表示的二叉树，不一定完整？
