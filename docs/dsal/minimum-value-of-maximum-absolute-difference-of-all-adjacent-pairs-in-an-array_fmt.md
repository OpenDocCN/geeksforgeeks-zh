...
> 原文: [https://www.geeksforgeeks.org/minimum-value-of-maximum-absolute-difference-of-all-adjacent-pairs-in-an-array/](https://www.geeksforgeeks.org/minimum-value-of-maximum-absolute-difference-of-all-adjacent-pairs-in-an-array/)
...
> **输入:** `arr = {-1, -1, 11, -1, 3, -1}`
> **输出:** `4`
> 用 `7` 替换每一个 `-1` 元素。现在所有相邻对的最大绝对差最小，等于 `4`
>
> **输入:** `arr = {4, -1}`
> **输出:** `0`
...
4.  最佳值等于 `(minimum element + maximum element) / 2`。
