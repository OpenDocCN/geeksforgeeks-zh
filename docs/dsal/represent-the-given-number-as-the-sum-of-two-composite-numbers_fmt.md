...
> 原文: [https://www.geeksforgeeks.org/represent-the-given-number-as-the-sum-of-two-composite-numbers/](https://www.geeksforgeeks.org/represent-the-given-number-as-the-sum-of-two-composite-numbers/)
...
当 `N ≤ 11` 时，只有 `8` 和 `10` 是可以表示为两个复合整数之和的整数，即分别为 `4 + 4` 和 `4 + 6`。
