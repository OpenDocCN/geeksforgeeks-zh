...
> 原文：[https://www.geeksforgeeks.org/program-class-interval-arithmetic-mean/](https://www.geeksforgeeks.org/program-class-interval-arithmetic-mean/)
...
> 式中 `(x) =(lower[i] + upper[i])/2`；
> 和 `平均值=(freq[0]* mid[0]+freq[1]* mid[1]+。。。+freq[n–1]* mid[n–1])/(freq[0]+freq[1]+。。。+freq[n-1])`
> = 2450/150
> = 16.3333
