...
> 原文: [https://www.geeksforgeeks.org/binary-tree-array-implementation/](https://www.geeksforgeeks.org/binary-tree-array-implementation/)
...
> **注:** `father`、`left_son`、`right_son` 为数组的索引值。
