...
> 原文: [https://www.geeksforgeeks.org/number-flips-make-binary-string-alternate/](https://www.geeksforgeeks.org/number-flips-make-binary-string-alternate/)
...
给定一个二进制字符串，目标是使其变为交替字符串（即字符0和1交替出现，如"010101..."或"101010..."）。每次操作可以翻转一个字符（0变1或1变0）。需要找到完成此目标所需的最小翻转次数。
