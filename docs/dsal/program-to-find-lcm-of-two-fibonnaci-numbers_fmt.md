...
> 原文: [https://www.geeksforgeeks.org/program-to-find-lcm-of-two-fibonnaci-numbers/](https://www.geeksforgeeks.org/program-to-find-lcm-of-two-fibonnaci-numbers/)

这里给出了两个正数 `a` 和 `b`。任务是打印第 `a` 个和第 `b` 个斐波那契数的最小公倍数。
