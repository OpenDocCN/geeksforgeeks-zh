...
> 原文：[https://www.geeksforgeeks.org/php-program-for-leaders-in-an-array/](https://www.geeksforgeeks.org/php-program-for-leaders-in-an-array/)

编写一个程序来打印数组中的所有 LEADERS。如果某个元素大于其右侧的所有元素，则该元素为引线。最右边的元素总是一个领导者。例如，在数组 `{16，17，4，3，5，2}` 中，前导是 17，5 和 2。
让输入数组为 `arr[]`，数组的大小为 `size`。
...
更多详情请参考[数组中的领导者](https://www.geeksforgeeks.org/leaders-in-an-array/)整篇文章！