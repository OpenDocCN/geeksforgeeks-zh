...
> 原文: [https://www.geeksforgeeks.org/find-n-th-term-series-1-2-2-3-3-3-4-4-4-4/](https://www.geeksforgeeks.org/find-n-th-term-series-1-2-2-3-3-3-4-4-4-4/)
...
是运行两个循环，一个从 `1` 到 `n`，另一个从 `1` 到 `i`，并且对于内部循环的每次迭代保持一个计数，每当计数达到 `n` 时，我们可以打破这两个循环，`i` 将是我们的答案。
**时间复杂度:** `O(n)`
