...
> 原文: [https://www.geeksforgeeks.org/program-for-centered-nonagonal-number/](https://www.geeksforgeeks.org/program-for-centered-nonagonal-number/)

居中的非正交数是一个居中的图形数，它代表一个在中心有一个点的非多边形，以及在连续的非正交层中围绕中心点的所有其他点。
`n` 的中心非正交数由公式给出：
中心非正交数 = `(3 * n - 2) * (3 * n - 1) / 2`
