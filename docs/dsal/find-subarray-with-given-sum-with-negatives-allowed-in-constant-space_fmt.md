...
> 原文: [https://www.geeksforgeeks.org/find-subarray-with-given-sum-with-negatives-allowed-in-constant-space/](https://www.geeksforgeeks.org/find-subarray-with-given-sum-with-negatives-allowed-in-constant-space/)
...
我们已经讨论了一种方法，使用哈希法在包含正负元素的数组中找到给定和的子数组。在本文中，讨论了一种不使用任何额外空间的方法。
