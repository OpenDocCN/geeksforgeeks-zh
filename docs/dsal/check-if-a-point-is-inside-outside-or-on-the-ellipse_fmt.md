...
> 原文: [https://www.geeksforgeeks.org/check-if-a-point-is-inside-outside-or-on-the-ellipse/](https://www.geeksforgeeks.org/check-if-a-point-is-inside-outside-or-on-the-ellipse/)
...
**逼近**: 我们要求解给定点 `(x, y)` 的椭圆方程：

> `(x-h)^2/a^2+(y-k)^2/b^2 <= 1`

如果在不等式中，结果**小于 1**，那么点位于**内部**；否则如果**等于 1**，那么点**位于椭圆上**；如果上述不等式不满足，那么点**位于椭圆外**。
