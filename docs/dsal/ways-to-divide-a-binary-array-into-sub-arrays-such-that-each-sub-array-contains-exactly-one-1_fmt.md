...
> 原文: [https://www.geeksforgeeks.org/ways-to-divide-a-binary-array-into-sub-arrays-such-that-each-sub-array-contains-exactly-one-1/](https://www.geeksforgeeks.org/ways-to-divide-a-binary-array-into-sub-arrays-such-that-each-sub-array-contains-exactly-one-1/)
...
*   否则，在相邻的两个之间，我们只能有一次分离。所以，答案等于值 `pos[i+1] – pos[i]` (对于所有有效对)的乘积，其中 `pos[i]` 是 i<sup>th</sup> `1` 的位置。
