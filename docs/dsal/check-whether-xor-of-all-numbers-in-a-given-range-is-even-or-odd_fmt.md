...
> 原文: [https://www.geeksforgeeks.org/check-whether-xor-of-all-numbers-in-a-given-range-is-even-or-odd/](https://www.geeksforgeeks.org/check-whether-xor-of-all-numbers-in-a-given-range-is-even-or-odd/)
...
一个`简单的解决方案`是计算范围 `[L, R]` 内所有数字的异或，然后检查结果异或值是偶数还是奇数。这种方法的时间复杂度为 `O(n)`。
