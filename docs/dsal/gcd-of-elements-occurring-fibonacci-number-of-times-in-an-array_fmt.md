...
> 原文: [https://www.geeksforgeeks.org/gcd-of-elements-occurring-fibonacci-number-of-times-in-an-array/](https://www.geeksforgeeks.org/gcd-of-elements-occurring-fibonacci-number-of-times-in-an-array/)
...
想法是使用[散列](http://www.geeksforgeeks.org/hashing-data-structure/)来预计算并存储[斐波那契节点](https://www.geeksforgeeks.org/program-for-nth-fibonacci-number/)直到最大值，以使检查变得容易且高效（在 `O(1)` 时间内）。
