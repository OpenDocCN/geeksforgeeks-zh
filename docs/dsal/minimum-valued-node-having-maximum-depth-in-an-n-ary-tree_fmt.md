...
> 原文：[https://www.geeksforgeeks.org/minimum-valued-node-having-maximum-depth-in-an-n-ary-tree/](https://www.geeksforgeeks.org/minimum-valued-node-having-maximum-depth-in-an-n-ary-tree/)
...
*   思想是在树上使用[深度优先搜索 (DFS)](https://www.geeksforgeeks.org/depth-first-search-or-dfs-for-a-graph/)。对于每个节点，当我们向下移动树时，检查每个节点的高度。
*   检查它是否是迄今为止最大的，如果它的高度等于最大值，则检查它是否是最小的节点。
*   如果是，则相应地更新迄今为止的最大高度和节点值。
