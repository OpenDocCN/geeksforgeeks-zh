...
> 原文：[https://www.geeksforgeeks.org/number-of-smaller-circles-that-can-be-inscribed-in-a-larger-circle/](https://www.geeksforgeeks.org/number-of-smaller-circles-that-can-be-inscribed-in-a-larger-circle/)
...
求半径较小的圆 `R2` 在半径为 `R1` 的圆的圆心处所成的角度，再除以 `360` 度，即可求解给定问题。

按照以下步骤解决给定问题：

*   如果 `R1` 的值小于 `R2`，那么单圈是不可能内切的。因此，打印 `0`。
