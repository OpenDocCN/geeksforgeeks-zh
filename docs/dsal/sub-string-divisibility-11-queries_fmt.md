...
> 原文: [https://www.geeksforgeeks.org/sub-string-divisibility-11-queries/](https://www.geeksforgeeks.org/sub-string-divisibility-11-queries/)
...
我们知道，任何数字如果奇数索引数字之和与偶数索引数字之和之差能被 11 整除，即 `Sum(奇数位数字)–Sum(偶数位数字)` 应能被 11 整除。
