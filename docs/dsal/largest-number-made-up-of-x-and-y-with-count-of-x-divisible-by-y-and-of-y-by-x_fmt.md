...
> 原文: [https://www.geeksforgeeks.org/largest-number-made-up-of-x-and-y-with-count-of-x-divisible-by-y-and-of-y-by-x/](https://www.geeksforgeeks.org/largest-number-made-up-of-x-and-y-with-count-of-x-divisible-by-y-and-of-y-by-x/)
...
*   完成上述步骤后，如果 `N < 0`，则无法形成所需类型的数字。打印 `-1`。
*   否则，打印答案。
