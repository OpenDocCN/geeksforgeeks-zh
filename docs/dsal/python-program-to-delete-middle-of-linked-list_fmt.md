...
> 原文：[https://www.geeksforgeeks.org/python-program-to-delete-middle-of-linked-list/](https://www.geeksforgeeks.org/python-program-to-delete-middle-of-linked-list/)
...
如果输入链表为空，那么应该保持为空。如果输入的链表有 `1` 个节点，那么这个节点应该被删除，并返回一个新的头。

## 简单的解决方案

思路是先统计链表中的节点数，然后用简单的删除过程删除第 `n/2` 个节点。
