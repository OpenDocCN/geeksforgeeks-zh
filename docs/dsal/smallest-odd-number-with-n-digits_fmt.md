...
> 原文: [https://www.geeksforgeeks.org/smallest-odd-number-with-n-digits/](https://www.geeksforgeeks.org/smallest-odd-number-with-n-digits/)
...
**Approach**: 根据 `N` 的值可以有两种情况

**情况 1**: 如果 `N = 1`，那么答案就是 `1`。
