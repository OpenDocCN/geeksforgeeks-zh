# 求给定 f(x) 的最大值(F(x))–最小值(F(x))

> 原文: [https://www.geeksforgeeks.org/find-the-value-of-maxfx-minfx-for-a-given-fx/](https://www.geeksforgeeks.org/find-the-value-of-maxfx-minfx-for-a-given-fx/)
