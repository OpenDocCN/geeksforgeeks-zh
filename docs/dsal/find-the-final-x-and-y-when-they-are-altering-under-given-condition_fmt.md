...
> 原文: [https://www.geeksforgeeks.org/find-the-final-x-and-y-when-they-are-altering-under-given-condition/](https://www.geeksforgeeks.org/find-the-final-x-and-y-when-they-are-altering-under-given-condition/)
...
由于 `x` 和 `y` 的初始值可以高达 `10^18`，简单的暴力方法是行不通的。
