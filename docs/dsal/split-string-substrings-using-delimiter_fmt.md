...
> 原文: [https://www.geeksforgeeks.org/split-string-substrings-using-delimiter/](https://www.geeksforgeeks.org/split-string-substrings-using-delimiter/)
...
该算法将填充数组 `substr_list[]` 中的拆分子串，并返回 `num` 等子串的个数。
