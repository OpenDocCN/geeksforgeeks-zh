...
> 原文: [https://www.geeksforgeeks.org/print-the-longest-prefix-of-the-given-string-which-is-also-the-suffix-of-the-same-string/](https://www.geeksforgeeks.org/print-the-longest-prefix-of-the-given-string-which-is-also-the-suffix-of-the-same-string/)
...
> `lps[i]` = 最长的 `pat[0..i]` 前缀，也是 `pat[0..i]` 的后缀。
