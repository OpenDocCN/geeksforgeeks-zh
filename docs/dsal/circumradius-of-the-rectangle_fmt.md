...
> 原文：[https://www.geeksforgeeks.org/circumradius-of-the-rectangle/](https://www.geeksforgeeks.org/circumradius-of-the-rectangle/)

这里我们有一个长方形的长度 `l` 和宽度 `b`。我们必须找到矩形的外半径。
