...
> 原文：[https://www.geeksforgeeks.org/range-queries-for-number-of-armstrong-numbers-in-an-array-with-updates/](https://www.geeksforgeeks.org/range-queries-for-number-of-armstrong-numbers-in-an-array-with-updates/)
...
每次查询更新的时间复杂度为 `O(log N)`，构建段树的时间复杂度为 `O(N)`。