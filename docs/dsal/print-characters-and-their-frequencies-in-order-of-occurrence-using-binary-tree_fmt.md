...
> 原文: [https://www.geeksforgeeks.org/print-characters-and-their-frequencies-in-order-of-occurrence-using-binary-tree/](https://www.geeksforgeeks.org/print-characters-and-their-frequencies-in-order-of-occurrence-using-binary-tree/)

给定一个只包含小写字符的字符串`字符串`。问题是使用二叉树`打印字符及其出现频率。示例:`
