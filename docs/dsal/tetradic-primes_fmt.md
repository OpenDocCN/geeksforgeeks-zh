...
> 原文：`https://www.geeksforgeeks.org/tetradic-primes/`

一个**四进制素数**既是[素数](https://www.geeksforgeeks.org/prime-numbers/)，也是四进制数。
...
思想是生成所有小于或等于给定数 `N` 的素数，并检查每个素数是否为四进制。

*   使用[埃拉托斯特尼筛法](https://www.geeksforgeeks.org/sieve-of-eratosthenes/)来确定给定的数是否是素数。
