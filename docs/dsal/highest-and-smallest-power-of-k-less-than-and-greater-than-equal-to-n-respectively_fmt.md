...
> 原文: [https://www.geeksforgeeks.org/highest-and-smallest-power-of-k-less-than-and-greater-than-equal-to-n-respectively/](https://www.geeksforgeeks.org/highest-and-smallest-power-of-k-less-than-and-greater-than-equal-to-n-respectively/)
...
1.  计算以 `K` 为基数的 `N` 的[对数](https://www.geeksforgeeks.org/logarithm/)（`对数<sub>K</sub> N`）得到指数幂，使 `K` 上升到这个指数就是 `K` 小于等于 `N` 的最高幂。
