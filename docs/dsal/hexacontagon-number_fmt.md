...
给定一个数字 `N`，任务是找到第 `N` 个[六角数字](https://en.wikipedia.org/wiki/Hexacontagon)。
...
*   因此 60 边多边形的第 `n` 项是
> ![T_n =\frac{((60-2)n^2 - (60-4)n)}{2} =\frac{(58n^2 - 56n)}{2}](img/1b7c6d68e5d58ef1aaed6382affaa971.png "Rendered by QuickLaTeX.com")
...
**参考资料:** [https://en.wikipedia.org/wiki/Hexacontagon](https://en.wikipedia.org/wiki/Hexacontagon)