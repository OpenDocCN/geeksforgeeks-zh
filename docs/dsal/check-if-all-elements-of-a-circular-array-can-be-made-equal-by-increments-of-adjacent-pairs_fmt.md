...
> 原文: [https://www.geeksforgeeks.org/check-if-all-elements-of-a-circular-array-can-be-made-equal-by-increments-of-adjacent-pairs/](https://www.geeksforgeeks.org/check-if-all-elements-of-a-circular-array-can-be-made-equal-by-increments-of-adjacent-pairs/)
...
1.  计算所有偶数索引数的和，即 `sumEven`。
2.  计算所有奇数索引数的和，即 `sumOdd`。
