...
> 原文: [https://www.geeksforgeeks.org/minimum-value-of-k-such-that-sum-of-cubes-of-first-k-natural-number-is-greater-than-equal-to-n/](https://www.geeksforgeeks.org/minimum-value-of-k-such-that-sum-of-cubes-of-first-k-natural-number-is-greater-than-equal-to-n/)
...
这个问题的天真方法是运行一个循环，从中找出立方体的和。每当总和超过 `N` 值时，从循环中断开。
