...
> 原文: [https://www.geeksforgeeks.org/zig-zag-traversal-of-a-binary-tree-using-recursion/](https://www.geeksforgeeks.org/zig-zag-traversal-of-a-binary-tree-using-recursion/)
...
**递归方法:** 想法是以[级顺序](https://www.geeksforgeeks.org/level-order-tree-traversal/)的方式遍历树，但方式略有不同。我们将使用一个变量`flag`，并最初将其值设置为零。当我们完成树的级别顺序遍历时，从右到左，我们将把`flag`的值设置为 1，这样下次我们可以从左到右遍历树，当我们完成遍历时，我们将把它的值设置回零。我们将重复这整个步骤，直到我们完全遍历了二叉树。
