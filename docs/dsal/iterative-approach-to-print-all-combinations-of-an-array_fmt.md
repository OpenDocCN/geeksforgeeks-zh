...
> 原文: [https://www.geeksforgeeks.org/iterative-approach-to-print-all-combinations-of-an-array/](https://www.geeksforgeeks.org/iterative-approach-to-print-all-combinations-of-an-array/)
...
递归方法在这里[讨论](https://www.geeksforgeeks.org/print-all-possible-combinations-of-r-elements-in-a-given-array-of-size-n/)。在这篇文章中，将讨论一种迭代方法来输出给定数组的所有组合。
