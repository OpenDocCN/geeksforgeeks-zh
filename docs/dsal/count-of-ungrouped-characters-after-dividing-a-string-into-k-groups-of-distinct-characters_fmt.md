...
这个想法是使用[频率计数](https://www.geeksforgeeks.org/basic/frequency-counting/)。
...
void findUngroupedElement(string s, int k) 
{ 
    int n = s.length(); 
...
static void findUngroupedElement(String s, int k) 
{ 
    int n = s.length(); 
