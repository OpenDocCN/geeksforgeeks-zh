...
> 原文: [https://www.geeksforgeeks.org/print-even-positioned-nodes-of-odd-levels-in-level-order-of-the-given-binary-tree/](https://www.geeksforgeeks.org/print-even-positioned-nodes-of-odd-levels-in-level-order-of-the-given-binary-tree/)
...
要逐层打印节点，请使用层级顺序遍历。思路基于[逐行打印级次遍历](https://www.geeksforgeeks.org/print-level-order-traversal-line-line/)。为此，逐级遍历节点，并在每一级后切换奇数级标志。同样，将每一级中的第一个节点标记为偶数位置，并在每次处理下一个节点后切换它。
