...
> 原文：[https://www.geeksforgeeks.org/average-even-numbers-till-given-even-number/](https://www.geeksforgeeks.org/average-even-numbers-till-given-even-number/)
...
偶数的平均数只能用单步求，公式如下：`(n+2)/2`，其中 `n` 是最后一个偶数。
