# 沃尔玛实验室面试经验|第八集(校外 3 年经验)

> 原文: [https://www.geeksforgeeks.org/walmart-lab-interview-experience-set-8-off-campus-3-years-experience/](https://www.geeksforgeeks.org/walmart-lab-interview-experience-set-8-off-campus-3-years-experience/)
...
## 第 5 轮(经理)
1) [给定一个数组形式的数字，最大化允许的交换次数(只能交换相邻元素)–`maximize(int[] data, int numSwaps)`](https://practice.geeksforgeeks.org/problems/largest-number-in-k-swaps/0)
...
[Largest number in K swaps](https://practice.geeksforgeeks.org/problems/largest-number-in-k-swaps/0)
...
[Find the highest occurring digit in prime numbers in a range](https://practice.geeksforgeeks.org/problems/find-the-highest-occurring-digit-in-prime-numbers-in-a-range/0)
[Find the highest occurring digit in prime numbers in a range](https://practice.geeksforgeeks.org/problems/find-the-highest-occurring-digit-in-prime-numbers-in-a-range/0)