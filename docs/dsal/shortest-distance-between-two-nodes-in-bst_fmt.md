...
> 原文: [https://www.geeksforgeeks.org/shortest-distance-between-two-nodes-in-bst/](https://www.geeksforgeeks.org/shortest-distance-between-two-nodes-in-bst/)
...
我们已经讨论了二叉树中两个节点之间的[距离](https://www.geeksforgeeks.org/find-distance-between-two-nodes-of-a-binary-tree/)。这个解的时间复杂度是 `O(n)`。在 BST 的情况下，我们可以更快的找到距离。我们从根开始，对于每个节点，我们执行以下操作。
