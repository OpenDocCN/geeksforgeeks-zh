...
*   实际意思是直到[字符串](https://www.geeksforgeeks.org/string-data-structure/)结束。
...
在上面的程序中 `string::npos` 常量的定义值为 -1，因为 `size_t` 是无符号整数类型，而 -1 是该类型最大的可能表示值。