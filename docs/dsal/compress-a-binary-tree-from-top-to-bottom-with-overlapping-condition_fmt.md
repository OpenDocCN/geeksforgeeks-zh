...
> 原文: [https://www.geeksforgeeks.org/compress-a-binary-tree-from-top-to-bottom-with-overlapping-condition/](https://www.geeksforgeeks.org/compress-a-binary-tree-from-top-to-bottom-with-overlapping-condition/)
...
想法是[遍历树](https://www.geeksforgeeks.org/tree-traversals-inorder-preorder-and-postorder/)并为每个访问节点保持`到根节点的水平距离`的轨迹。以下是步骤:
