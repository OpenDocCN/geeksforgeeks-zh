...
> 原文: [https://www.geeksforgeeks.org/largest-number-smaller-than-or-equal-to-n-divisible-by-k/](https://www.geeksforgeeks.org/largest-number-smaller-than-or-equal-to-n-divisible-by-k/)
...
**方法:** 思路是 `N` 除以 `K`，如果余数为 0，则打印 `N`，否则打印 `N - rem`。
