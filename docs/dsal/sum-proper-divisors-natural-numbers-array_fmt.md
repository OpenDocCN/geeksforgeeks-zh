...
原文: [https://www.geeksforgeeks.org/sum-proper-divisors-natural-numbers-array/](https://www.geeksforgeeks.org/sum-proper-divisors-natural-numbers-array/)
...
这个问题的一个天真的解决方案已经在下面的帖子中讨论过了：[自然数的所有适当因子之和](https://www.geeksforgeeks.org/sum-of-all-proper-divisors-of-a-natural-number/)。

我们可以通过利用厄拉多塞的[筛](https://www.geeksforgeeks.org/sieve-of-eratosthenes/)更有效地做到这一点。思想基于一个数的素分解。通过[使用筛子，我们可以存储一个数的所有质因数及其幂](https://www.geeksforgeeks.org/print-all-prime-factors-and-their-powers/)。
