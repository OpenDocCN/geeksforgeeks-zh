...
> 原文：[https://www.geeksforgeeks.org/java-program-for-deleting-last-occurrence-of-an-item-from-linked-list/](https://www.geeksforgeeks.org/java-program-for-deleting-last-occurrence-of-an-item-from-linked-list/)
...
class GFG {
    ...
    public static void main(String args[]) {
        ...
        printList(head);
        deleteLast(head, 2);
        System.out.printf("Linked List after Deletion of 1: ");
        printList(head);
    }
}
...
**当要删除的节点是最后一个节点时，上述解决方案不起作用。** 以下方案处理所有案件。
...
详情请参考完整文章[从链表中删除一项的最后一次出现！](https://www.geeksforgeeks.org/delete-last-occurrence-of-an-item-from-linked-list/)