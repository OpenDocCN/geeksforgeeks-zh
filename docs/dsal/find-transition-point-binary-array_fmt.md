...
> 原文: [https://www.geeksforgeeks.org/find-transition-point-binary-array/](https://www.geeksforgeeks.org/find-transition-point-binary-array/)
...
思路是利用二分搜索法，找到数组中最小的索引 1。当数组被排序时，可以执行二分搜索法。
