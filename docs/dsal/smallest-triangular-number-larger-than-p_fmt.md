...
> 原文: [https://www.geeksforgeeks.org/smallest-triangular-number-larger-than-p/](https://www.geeksforgeeks.org/smallest-triangular-number-larger-than-p/)
...
它是如何工作的？
我们需要比 `n*(n+1)/2 >= p` 更小的 `n`，所以我们需要求方程 `n^2+n–2*p >= 0` 的根。
