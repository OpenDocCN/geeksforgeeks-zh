...
> 原文: [https://www.geeksforgeeks.org/how-to-validate-guid-globally-unique-identifier-using-regular-expression/](https://www.geeksforgeeks.org/how-to-validate-guid-globally-unique-identifier-using-regular-expression/)
...
> **输入:** `str = "123e4567-e89b-12d3-a456-9ac7cbdcee52"`
> **输出:** true
> **解释:**
> 给定字符串满足上述所有条件。因此，它是一个有效的 GUID(全球唯一标识符)。
> **输入:** `str = "123e4567-h89b-12d3-a456-9ac7cbdcee52"`
> **输出:** false
> **解释:**
> 给定字符串包含‘h’，有效的十六进制字符后面应该跟有来自 a-f、A-F 和 0-9 的字符。因此，它不是有效的 GUID(全球唯一标识符)。
> **输入:** `str = "123e4567-h89b-12d3-a456"`
> **输出:** false
> **解释:**
...
*   其中:
    ...
    *   `[}]?` 表示可选的“}”字符。
    *   `$` 代表字符串的结尾。
*   将给定的字符串与正则表达式匹配。在 Java 中，这可以通过使用 `Pattern.matcher()` 来完成。
