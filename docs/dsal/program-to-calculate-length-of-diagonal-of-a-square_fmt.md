...
> 原文: [https://www.geeksforgeeks.org/program-to-calculate-length-of-diagonal-of-a-square/](https://www.geeksforgeeks.org/program-to-calculate-length-of-diagonal-of-a-square/)

给定一个正整数 `S`，任务是找到一个边长为 `S` 的正方形的对角线长度。
...
>
> 从上图可以看到，对角线和正方形的两边形成了一个直角三角形。因此，应用勾股定理:
> **(斜边)<sup>2</sup> = (底)<sup>2</sup> + (垂直)<sup>2</sup>**，其中 `D` 和 `S` 为对角线和正方形的长度。
>
> 因此，
> => ![](img/720394c2816553a7cc60e88703ecf782.png)
> => ![](img/c01fb90eb431a06b83331954d26e0327.png)
> => ![](img/57e35f30ecf8c13849a6fca2efb8ef84.png)
