...
> 原文: [https://www.geeksforgeeks.org/check-if-a-number-n-can-be-expressed-in-base-b/](https://www.geeksforgeeks.org/check-if-a-number-n-can-be-expressed-in-base-b/)

给定一个数字 `N` 和任意一个基数 `B`。任务是检查 `N` 是否可以用 `a1 * b^0 + a2 * b^1 + a3 * b^2 + ... + a101 * b^100` 表示，其中各系数 `a1, a2, a3...a101` 为 `0`，`1` 或 `-1`。
...
> **输出:** 是
> **说明:**
> 数字 `7` 可以表示为 `1 * 3^0 + (-1) * 3^1 + 1 * 3^2 = 1 - 3 + 9`。
>
> **输入:** `B = 100`，`N = 50`
> **输出:** 否
> **说明:**
