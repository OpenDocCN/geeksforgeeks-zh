# 卡维森系统公司面试体验|第一集(SDE 校园)

> 原文: [https://www.geeksforgeeks.org/cavisson-system-inc-interview-experience-set-1-campus-sde/](https://www.geeksforgeeks.org/cavisson-system-inc-interview-experience-set-1-campus-sde/)
...
## 第 2 轮
是 `cocubes.com` 的编码轮。有两个问题与数据结构和算法有关。

1) 最长偶数长度子串，使得前半部分和后半部分的和相同。
([https://www.geeksforgeeks.org/longest-even-length-substring-sum-first-second-half/](https://www.geeksforgeeks.org/longest-even-length-substring-sum-first-second-half/))
