...
> 原文: [https://www.geeksforgeeks.org/product-of-all-subarrays-of-an-array/](https://www.geeksforgeeks.org/product-of-all-subarrays-of-an-array/)
...
一个简单的解决方案是[生成所有子阵列](https://www.geeksforgeeks.org/generating-subarrays-using-recursion/)并计算它们的乘积。
