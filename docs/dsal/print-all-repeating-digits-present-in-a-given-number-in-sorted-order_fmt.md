...
> 原文: [https://www.geeksforgeeks.org/print-all-repeating-digits-present-in-a-given-number-in-sorted-order/](https://www.geeksforgeeks.org/print-all-repeating-digits-present-in-a-given-number-in-sorted-order/)
...
**方法:** 思路是用[哈希](https://www.geeksforgeeks.org/hashing-data-structure/)存储 `N` 的数字的[频率](https://www.geeksforgeeks.org/find-the-frequency-of-a-digit-in-a-number/)，打印那些频率超过 `1` 的数字。
...
*   [迭代字符串](https://www.geeksforgeeks.org/iterate-over-characters-of-a-string-in-c/)的字符，对于每个字符，执行以下步骤:
    *   [使用](https://www.geeksforgeeks.org/convert-char-to-int-in-java-with-examples/)[类型转换](https://www.geeksforgeeks.org/type-conversion-in-c/)将当前字符转换为整数。
