...
> 原文：[https://www.geeksforgeeks.org/all-ways-to-add-parenthesis-for-evaluation/](https://www.geeksforgeeks.org/all-ways-to-add-parenthesis-for-evaluation/)
...
参见`c_str()`函数的用法，这个函数把C++字符串转换成C字符数组，这个函数用在下面的代码中是因为`atoi()`函数需要一个字符数组作为参数而不是字符串。它将字符数组转换为数字。
...
本文由 **[乌卡什·特里维迪](https://in.linkedin.com/in/utkarsh-trivedi-253069a7)** 供稿。如果你喜欢GeeksforGeeks并想投稿，你也可以使用[contribute.geeksforgeeks.org](http://www.contribute.geeksforgeeks.org)写一篇文章或者把你的文章邮寄到`contribute@geeksforgeeks.org`。看到你的文章出现在极客博客主页上，帮助其他极客。
