...
> 原文:[https://www . geeksforgeeks . org/check-when-二叉树-complete-not-set-2-递归-solution/](https://www.geeksforgeeks.org/check-whether-binary-tree-complete-not-set-2-recursive-solution/)
...
1.  计算二叉树中的节点数(`count`)。
2.  从二叉树的根节点开始递归二叉树，索引(`i`)设置为 0，二进制中的节点数(`count`)。
