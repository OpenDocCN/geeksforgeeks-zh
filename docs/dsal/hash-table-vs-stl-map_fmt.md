...
[映射容器](https://www.geeksforgeeks.org/map-associative-containers-the-c-standard-template-library-stl/)是 C++ 的[标准库](https://www.geeksforgeeks.org/stack-in-cpp-stl/)中包含的关联容器。 此类的定义位于名称空间`std`的`map`头文件中。
