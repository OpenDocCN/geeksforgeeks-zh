...
> 原文: [https://www.geeksforgeeks.org/check-if-expression-contains-redundant-bracket-or-not-set-2/](https://www.geeksforgeeks.org/check-if-expression-contains-redundant-bracket-or-not-set-2/)
