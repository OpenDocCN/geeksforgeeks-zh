...
> 原文: [https://www.geeksforgeeks.org/amazon-interview-experience-set-364-campus/](https://www.geeksforgeeks.org/amazon-interview-experience-set-364-campus/)
...
1.  合并两个排序的数组
    [GeeksforGeeks Link](https://www.geeksforgeeks.org/merge-two-sorted-arrays/)
2.  找到给定数组中重复两次以上的元素
    [GeeksforGeeks Link](https://practice.geeksforgeeks.org/problems/make-a-distinct-digit-array/0)
...
1.  给定一个数组，以奇数元素占据奇数位置，偶数元素占据偶数位置的方式排列它。
    [GeeksforGeeks Link](https://www.geeksforgeeks.org/even-numbers-even-index-odd-numbers-odd-index/)
2.  通过删除最少数量的字符，将给定的字符串转换为回文。
    [GeeksforGeeks Link](https://www.geeksforgeeks.org/minimum-number-deletions-make-string-palindrome/)

## 第三轮：笔试：2 个项目
在这里，我们有 1 个小时的时间，一个小时的时间，我们必须向他解释我们的答案，并满足他的期望。

1.  使用给定数字中的相同数字查找下一个最大的数字。
    [GeeksforGeeks Link](https://practice.geeksforgeeks.org/problems/next-permutation/0)
2.  给定一个按行排序的矩阵，找到所有行中的公共元素。
    [GeeksforGeeks Link](https://www.geeksforgeeks.org/find-common-element-rows-row-wise-sorted-matrix/)
