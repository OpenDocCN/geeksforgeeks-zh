...
> 原文: [https://www.geeksforgeeks.org/perfect-cube-greater-than-a-given-number/](https://www.geeksforgeeks.org/perfect-cube-greater-than-a-given-number/)
...
1.  求给定 `n` 的立方根。
2.  使用 C++ 中的 [`floor函数`](https://www.geeksforgeeks.org/ceil-floor-functions-cpp/) 计算其楼层值。
3.  然后再加 1。
4.  打印该数字的立方体。
