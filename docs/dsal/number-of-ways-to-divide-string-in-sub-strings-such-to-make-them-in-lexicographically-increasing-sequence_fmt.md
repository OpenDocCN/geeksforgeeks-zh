...
> 原文：[https://www.geeksforgeeks.org/number-of-ways-to-divide-string-in-sub-strings-such-to-make-them-in-lexicographically-increasing-sequence/](https://www.geeksforgeeks.org/number-of-ways-to-divide-string-in-sub-strings-such-to-make-them-in-lexicographically-increasing-sequence/)
...
> **输出：** `6`
> 以下是允许的分区：
> `{“aabc”}`、`{“aa”、“bc”}`、`{“aab”、“c”}`、`{“a”、“abc”}`、`{“a”、“ab”、“c”}` 和 `{“aa”、“b”、“c”}`。
>
> **输入：** `S = "za"`
> **输出：** `1`
> 唯一可能的分区是 `{“za”}`。
