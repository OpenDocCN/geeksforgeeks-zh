...
> 原文：[https://www.geeksforgeeks.org/number-subsequences-string-divisible-n/](https://www.geeksforgeeks.org/number-subsequences-string-divisible-n/)
...
# JavaScript 实现：计算字符串中可被 n 整除的子序列数量
