...
> 原文: [https://www.geeksforgeeks.org/find-the-next-non-fibonacci-number/](https://www.geeksforgeeks.org/find-the-next-non-fibonacci-number/)
...
**方法:** 作为[斐波那契数列](https://www.geeksforgeeks.org/program-for-nth-fibonacci-number/)给出
