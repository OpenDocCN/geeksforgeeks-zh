...
> 原文: [https://www.geeksforgeeks.org/number-formed-after-k-times-repeated-addition-of-smallest-divisor-of-n/](https://www.geeksforgeeks.org/number-formed-after-k-times-repeated-addition-of-smallest-divisor-of-n/)
...
**高效方法:** 这里的诀窍是，如果给定的 `N` 是*偶数*，则所有 `K` 运算的最小除数将始终为 2。因此，所需的第 `K` 号将简单地为
