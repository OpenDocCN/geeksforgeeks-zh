...
> 原文: [https://www.geeksforgeeks.org/replace-all-occurrences-of-pi-with-3-14-in-a-given-string/](https://www.geeksforgeeks.org/replace-all-occurrences-of-pi-with-3-14-in-a-given-string/)
...
要将所有 PI 事件替换为 3.14，请使用 Java String 类的 `replaceAll()` 方法。
