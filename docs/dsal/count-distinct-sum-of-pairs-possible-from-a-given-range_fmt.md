...
原文: [https://www.geeksforgeeks.org/count-distinct-sum-of-pairs-possible-from-a-given-range/](https://www.geeksforgeeks.org/count-distinct-sum-of-pairs-possible-from-a-given-range/)
...
**天真法:** 解决给定问题最简单的方法是从范围 `[L, R]` 中找出所有可能的数对之和，并打印得到的所有不同和的计数。
