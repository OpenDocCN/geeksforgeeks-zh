...
> 原文: [https://www.geeksforgeeks.org/reduce-the-array-to-atmost-one-element-by-the-given-operations/](https://www.geeksforgeeks.org/reduce-the-array-to-atmost-one-element-by-the-given-operations/)
...
*   每次迭代都要提取两次 `top` 元素。如果它们的绝对差值不为零，将把它们的差值推回队列。
*   继续，直到只剩下一个或没有元素。
