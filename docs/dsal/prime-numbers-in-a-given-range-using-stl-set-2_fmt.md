...
> 原文：[https://www.geeksforgeeks.org/prime-numbers-in-a-given-range-using-stl-set-2/](https://www.geeksforgeeks.org/prime-numbers-in-a-given-range-using-stl-set-2/)
...
2.  使用二分搜索法查找小于起始值的元素的索引。我们在 STL 中使用 [`std::lower_bound()`](https://www.geeksforgeeks.org/stdlower_bound-in-c/)。
3.  从向量的开始到索引删除元素。我们使用 [`vector::clear()`](https://www.geeksforgeeks.org/vectorclear-vectorerase-c-stl/) 和 [`vector::erase()`](https://www.geeksforgeeks.org/vectorclear-vectorerase-c-stl/)。
