...
> 原文: [https://www.geeksforgeeks.org/find-multiplication-of-sums-of-data-of-all-leaves-at-sane-levels/](https://www.geeksforgeeks.org/find-multiplication-of-sums-of-data-of-all-leaves-at-sane-levels/)
...
一个`简单的解决方案`是从上到下递归计算所有级别的叶和。然后乘以有叶子的层次的和。该解决方案的时间复杂度为 `O(n^2)`。
