...
> 原文: [https://www.geeksforgeeks.org/check-if-an-array-can-be-split-into-subarrays-with-gcd-exceeding-k/](https://www.geeksforgeeks.org/check-if-an-array-can-be-split-into-subarrays-with-gcd-exceeding-k/)
...
*   如果没有发现任何阵列元素小于或等于 `K`，那么总是有可能将整个阵列分成 `N` 个子阵列，每个子阵列的大小至少为 `1`，其 GCD 总是大于 `K`。
...
string canSplitArray(int arr[], int n, int k)
{
