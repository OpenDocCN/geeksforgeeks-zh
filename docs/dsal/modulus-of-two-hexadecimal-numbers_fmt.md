...
> 原文: [https://www.geeksforgeeks.org/modulus-of-two-hexadecimal-numbers/](https://www.geeksforgeeks.org/modulus-of-two-hexadecimal-numbers/)

给定两个[十六进制数](https://www.geeksforgeeks.org/arithmetic-operations-of-hexadecimal-numbers/) `N` 和 `K`，任务是找到 `N` 模 `K`。
