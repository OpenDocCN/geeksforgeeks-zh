...
> 原文：[https://www.geeksforgeeks.org/queries-to-search-an-element-in-an-array-and-move-it-to-front-after-every-query/](https://www.geeksforgeeks.org/queries-to-search-an-element-in-an-array-and-move-it-to-front-after-every-query/)
...
> 查询 3：将 2 从 `[1, 3, 2, 4, 5]` 移动到数组的开头，使数组看起来像 `[2, 1, 3, 4, 5]`。索引 2 中有 2。
