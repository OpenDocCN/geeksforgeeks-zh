...
> 原文: [https://www.geeksforgeeks.org/remove-leaf-nodes-binary-search-tree/](https://www.geeksforgeeks.org/remove-leaf-nodes-binary-search-tree/)
...
我们以[中序遍历](https://www.geeksforgeeks.org/tree-traversals-inorder-preorder-and-postorder/)的方式穿越给定的二叉查找树。在遍历过程中，我们检查当前节点是否是叶子，如果是，我们删除它。否则我们会为左右孩子递归调用。要记住的一件重要的事情是，如果子树的根有任何修改，我们必须分配新的左右子树。
