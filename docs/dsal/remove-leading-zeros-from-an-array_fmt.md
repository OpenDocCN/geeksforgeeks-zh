...
> 原文: [https://www.geeksforgeeks.org/remove-leading-zeros-from-an-array/](https://www.geeksforgeeks.org/remove-leading-zeros-from-an-array/)
...
标记给定数组中第一个非零数字的索引。将从该索引到末尾的数字存储在不同的数组中。一旦所有数字都存储在不同的容器中，就打印数组。
