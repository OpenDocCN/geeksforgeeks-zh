...
> 原文: [https://www.geeksforgeeks.org/largest-palindrome-product-two-n-digit-numbers/](https://www.geeksforgeeks.org/largest-palindrome-product-two-n-digit-numbers/)
...
3.  考虑所有的数对，其中任何一个数都在范围内 `[lower_limit, upper_limit]`。
...
本文由`希瓦姆·普拉丹(anuj_charm)`供稿。如果你喜欢 GeeksforGeeks 并想投稿，你也可以使用`contribute.geeksforgeeks.org`写一篇文章或者把你的文章邮寄到`contribute@geeksforgeeks.org`。看到你的文章出现在极客博客主页上，帮助其他极客。
