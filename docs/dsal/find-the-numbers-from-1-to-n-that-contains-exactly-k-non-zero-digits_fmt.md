...
> 原文: [https://www.geeksforgeeks.org/find-the-numbers-from-1-to-n-that-contains-exactly-k-non-zero-digits/](https://www.geeksforgeeks.org/find-the-numbers-from-1-to-n-that-contains-exactly-k-non-zero-digits/)
...
考虑 `N` 位的整数就够了，必要时用 `0` 填充高位。这个问题可以通过应用名为[数字 DP](https://www.geeksforgeeks.org/digit-dp-introduction/) 的方法来解决。
