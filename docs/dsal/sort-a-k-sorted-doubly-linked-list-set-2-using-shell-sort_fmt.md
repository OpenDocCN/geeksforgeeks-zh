...
> 原文：[https://www.geeksforgeeks.org/sort-a-k-sorted-doubly-linked-list-set-2-using-shell-sort/](https://www.geeksforgeeks.org/sort-a-k-sorted-doubly-linked-list-set-2-using-shell-sort/)
...
>
> **输出：** `dll: 2 <-> 3 <-> 6 <-> 8 <-> 12 <-> 56`

**注意：** 使用插入排序和使用[最小堆数据结构](https://www.geeksforgeeks.org/difference-between-min-heap-and-max-heap/)的方法[已经在](https://www.geeksforgeeks.org/insertion-sort/)[此处](https://www.geeksforgeeks.org/sort-k-sorted-doubly-linked-list/)讨论过。
