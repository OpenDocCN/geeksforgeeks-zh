...
> 原文: [https://www.geeksforgeeks.org/calculate-volume-surface-area-sphere/](https://www.geeksforgeeks.org/calculate-volume-surface-area-sphere/)
...
精确填充球体的立方单位数或球体的存储容量。我们可以用公式计算球体的体积：

![Volume Of Sphere](img/0139ffed327f2fd0204d8496711847f9.png)

## 球体表面积

球体物体的表面积是球体表面所占总面积的量度。我们可以用公式计算球体的表面积：
