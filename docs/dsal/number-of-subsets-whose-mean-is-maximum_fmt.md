...
> 原文: [https://www.geeksforgeeks.org/number-of-subsets-whose-mean-is-maximum/](https://www.geeksforgeeks.org/number-of-subsets-whose-mean-is-maximum/)
...
### 方法
任何子集平均值的最大值将是该子集仅由数组中的最大元素组成时的值。因此，为了计数所有可能的子集，从数组中找到最大元素的频率，比如 `cnt`，并且可能的子集的计数将是 `2^cnt - 1`。
