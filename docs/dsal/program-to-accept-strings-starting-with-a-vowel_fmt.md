...
> 原文：[https://www.geeksforgeeks.org/program-to-accept-strings-starting-with-a-vowel/](https://www.geeksforgeeks.org/program-to-accept-strings-starting-with-a-vowel/)

给定字符串`str`由字母组成，任务是检查给定字符串是否以元音开头。
