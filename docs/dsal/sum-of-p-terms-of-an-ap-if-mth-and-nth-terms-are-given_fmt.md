...
> 原文：[https://www.geeksforgeeks.org/sum-of-p-terms-of-an-ap-if-mth-and-nth-terms-are-given/](https://www.geeksforgeeks.org/sum-of-p-terms-of-an-ap-if-mth-and-nth-terms-are-given/)

给定算术级数的 `m`th 和 `n`th 项。任务是找出它的前 `p` 项的和。
