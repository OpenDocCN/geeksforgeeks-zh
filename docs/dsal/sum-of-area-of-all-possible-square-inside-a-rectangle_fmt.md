...
> 原文: [https://www.geeksforgeeks.org/sum-of-area-of-all-possible-square-inside-a-rectangle/](https://www.geeksforgeeks.org/sum-of-area-of-all-possible-square-inside-a-rectangle/)
...
> **大小为 `K` 的平方数 = `(L-K+1)*(B-K+1)`**

因此，大小为 `K` 的方块总数的面积将为:

> **面积大小为 `K` 的正方形总数的面积 = `(L-K+1)*(B-K+1)*K*K`**
