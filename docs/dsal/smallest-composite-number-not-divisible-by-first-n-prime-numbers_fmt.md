...
> 原文: [https://www.geeksforgeeks.org/smallest-composite-number-not-divisible-by-first-n-prime-numbers/](https://www.geeksforgeeks.org/smallest-composite-number-not-divisible-by-first-n-prime-numbers/)

## 问题描述

给定一个整数 `N`，任务是找到不能被第一个 `N` 个素数整除的最小[合成数](https://www.geeksforgeeks.org/composite-number/)。
...
> 第一个不能被前 `N` 个质数中的任何一个整除的复合数 = **((N + 1)<sup>第</sup>质数)<sup>2</sup>**
...
想法是用厄拉多塞的[筛找到 **(N+1)<sup>第</sup>** 素数](https://www.geeksforgeeks.org/sieve-of-eratosthenes/)，打印 **(N+1)<sup>第</sup>素数**的[方块作为答案。](https://www.geeksforgeeks.org/calculate-square-of-a-number-without-using-and-pow/)
