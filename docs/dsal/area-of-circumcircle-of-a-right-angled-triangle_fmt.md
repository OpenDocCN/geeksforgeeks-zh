...
> 原文: [https://www.geeksforgeeks.org/area-of-circumcircle-of-a-right-angled-triangle/](https://www.geeksforgeeks.org/area-of-circumcircle-of-a-right-angled-triangle/)
...
我们知道圆的面积是 `PI * r^2`，其中 `PI = 22/7`，`r` 是圆的半径。
因此外接圆的面积为 `π*(C/2)^2`，即 `π* C^2/4`。
以下是上述方法的实施:
