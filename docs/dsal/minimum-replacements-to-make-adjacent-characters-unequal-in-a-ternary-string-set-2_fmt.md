...
**方法:**问题已经在[之前的](https://www.geeksforgeeks.org/minimum-replacements-to-make-adjacent-characters-unequal-in-a-ternary-string/)帖子中用贪婪的方法解决了。在这篇文章中，我们将讨论解决同样问题的动态编程方法。创建一个函数`charVal`，根据字符返回 0、1 或 2。
