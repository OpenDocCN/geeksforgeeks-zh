...
> 原文: [https://www.geeksforgeeks.org/remove-characters-from-a-string-that-appears-exactly-k-times/](https://www.geeksforgeeks.org/remove-characters-from-a-string-that-appears-exactly-k-times/)
...
*   创建大小为 `26` 的[哈希表](https://www.geeksforgeeks.org/hashing-set-1-introduction/)，其中第 `0` 个索引代表 `a`，第 `1` 个索引代表 `b`，以此类推。
*   将哈希表初始化为零。
