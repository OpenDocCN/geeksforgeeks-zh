...
> 原文：[https://www.geeksforgeeks.org/greatest-contiguous-sub-array-of-size-k/](https://www.geeksforgeeks.org/greatest-contiguous-sub-array-of-size-k/)
...
生成所有大小为 `K` 的子数组，并将它们存储在任何数据结构中。对所有子数组进行排序，答案将是排序后的数据结构中的最后一个子数组。在 C++中，我们可以使用向量的[向量](https://www.geeksforgeeks.org/vector-in-cpp-stl/)来存储大小为 `K` 的子数组。
