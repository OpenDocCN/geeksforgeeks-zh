...
> 原文：[https://www.geeksforgeeks.org/possible-number-of-rectangle-and-squares-with-the-given-set-of-elements/](https://www.geeksforgeeks.org/possible-number-of-rectangle-and-squares-with-the-given-set-of-elements/)

给定长度为 `a1`，`a2`，`a3` … `an` 的木棒数量。任务是计算可能的正方形和长方形的数量。
