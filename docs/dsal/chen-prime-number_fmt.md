...
[陈质数](https://en.wikipedia.org/wiki/Chen_prime)：在数学中，如果`'p+2'`是质数或半质数，则称质数`'p'`为陈质数。
一个[半素数](https://www.geeksforgeeks.org/check-whether-number-semiprime-not/)是两个素数的乘积。
前几个陈素数是：
