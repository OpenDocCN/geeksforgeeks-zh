...
> 原文：[https://www.geeksforgeeks.org/find-the-sum-of-the-first-nth-centered-tridecagonal-numbers/](https://www.geeksforgeeks.org/find-the-sum-of-the-first-nth-centered-tridecagonal-numbers/)

## 问题描述

给定一个数 `N`，任务是求第一个 `N` 个[居中三叉数](https://www.geeksforgeeks.org/centered-tridecagonal-number/)的和。
...
1.  首先，我们需要创建一个函数来帮助我们计算第 `N` 个[居中三叉数](https://www.geeksforgeeks.org/centered-tridecagonal-number/)。
2.  现在，运行一个从 1 到 `N` 的循环，在这个范围内找到居中的三叉数。
3.  将以上计算的所有居中三叉数相加。
4.  最后，显示前 `N` 个居中三叉数的总和。
