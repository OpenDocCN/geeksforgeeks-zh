...
> 原文: [https://www.geeksforgeeks.org/check-if-string-is-palindrome-after-removing-all-consecutive-duplicates/](https://www.geeksforgeeks.org/check-if-string-is-palindrome-after-removing-all-consecutive-duplicates/)
...
想法是从给定的字符串创建一个新字符串，并检查新字符串是否是回文。以下是步骤:
