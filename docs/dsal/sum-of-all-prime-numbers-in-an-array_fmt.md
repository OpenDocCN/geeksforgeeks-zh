...
> 原文: [https://www.geeksforgeeks.org/sum-of-all-prime-numbers-in-an-array/](https://www.geeksforgeeks.org/sum-of-all-prime-numbers-in-an-array/)
...
一个简单的解决方法是遍历数组，不断检查每个元素是否是素数，同时添加素数元素。

### 高效方法

使用厄拉多塞的[筛](https://www.geeksforgeeks.org/sieve-of-eratosthenes/)生成数组中最大元素的所有素数，并将它们存储在哈希中。现在遍历数组，用筛子找出那些质数元素的和。
