...
> 原文: [https://www.geeksforgeeks.org/script-aculo-us-sliders-onchange-option/](https://www.geeksforgeeks.org/script-aculo-us-sliders-onchange-option/)
...
*   `function`: 这是一个回调函数，每当滑块完成移动或使用 `setValue()` 方法进行更改时，都会调用该函数。
