...
> 原文: [https://www.geeksforgeeks.org/script-aculo-us-highlight-effect/](https://www.geeksforgeeks.org/script-aculo-us-highlight-effect/)
...
*   `startcolor`: 用于设置效果第一帧的颜色。默认值为“#fffff99”。
