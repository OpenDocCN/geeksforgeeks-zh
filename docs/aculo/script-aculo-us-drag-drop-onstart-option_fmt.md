...
> 原文：[https://www.geeksforgeeks.org/script-aculo-us-drag-drop-onstart-option/](https://www.geeksforgeeks.org/script-aculo-us-drag-drop-onstart-option/)
...
**第一步：** 开始之前，您需要下载包含在我们的 HTML 页面的 `<head>` 标签中的脚本文件。你可以从 [http://script.aculo.us/downloads](http://script.aculo.us/downloads) 下载。
...
*   **function：** 这是一个回调函数，每当开始拖动元素时都会调用。
...
**参考：** [http://script.aculo.us/](http://script.aculo.us/)