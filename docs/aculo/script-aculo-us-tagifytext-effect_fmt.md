...
> 原文: [https://www.geeksforgeeks.org/script-aculo-us-tagifytext-effect/](https://www.geeksforgeeks.org/script-aculo-us-tagifytext-effect/)
...
要使用这个库，我们应该安装这个库，然后在我们的程序中使用它。而要做到这一点你可以遵循这个链接 [http://script.aculo.us/downloads](http://script.aculo.us/downloads)。
