...
> 原文: [https://www.geeksforgeeks.org/script-aculo-us-drag-drop-endeffect-option/](https://www.geeksforgeeks.org/script-aculo-us-drag-drop-endeffect-option/)
...
*   **效果函数:** 该值定义了包含当拖动山墙停止拖动时要显示的效果的函数 `effectFunction`。
...
<head>
    ...
    <script type="text/javascript">
        window.onload = function () {
            ...
            Droppables.add('droparea', { onDrop: moveItem });
...
<body>
    ...
    <strong>script.aculo.us Drag & Drop endeffect Option</strong>
    <div id="draggables">
        <img src="https://media.geeksforgeeks.org/wp-content/cdn-uploads/20200817185016/gfg_complete_logo_2x-min.png">
    </div>
    <br>
    <br>
    <div id="droparea">Drag the Image and Drop Your Image in this area</div>
</body>
</html>
```
