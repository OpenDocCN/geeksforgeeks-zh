...
> 原文：[https://www.geeksforgeeks.org/script-aculo-us-scrollto-effect/](https://www.geeksforgeeks.org/script-aculo-us-scrollto-effect/)
...
**方法：** 为了演示这个函数的使用，我们编写了一小段代码。我们已经编写了一个名为 `ShowEffect()` 的小 JavaScript 函数，该函数使用了本库的 `Effect.ScrollTo()` 方法。点击 *点击我滚动！*，你会看清楚效果的。
