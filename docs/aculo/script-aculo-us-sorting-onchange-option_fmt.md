...
> 原文: [https://www.geeksforgeeks.org/script-aculo-us-sorting-onchange-option/](https://www.geeksforgeeks.org/script-aculo-us-sorting-onchange-option/)
...
*   `function`: 这是一个回调函数，每当元素的顺序改变时都会调用。
