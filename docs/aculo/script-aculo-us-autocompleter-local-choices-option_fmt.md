...
> 原文: [https://www.geeksforgeeks.org/script-aculo-us-autocompleter-local-choices-option/](https://www.geeksforgeeks.org/script-aculo-us-autocompleter-local-choices-option/)
...
![输出示例 1](img/e500f038184f3a5f3df76045924fcdec.png)

### 例 2

在本例中，我们将选项数设置为 7，因此提供了 7 个选项。
...
![输出示例 2](img/c0bf3d91fe37fdf3bcc96cc8ad618dcb.png)
