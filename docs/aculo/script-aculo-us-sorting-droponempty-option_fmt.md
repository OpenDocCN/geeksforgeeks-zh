...
> 原文: [https://www.geeksforgeeks.org/script-aculo-us-sorting-droponempty-option/](https://www.geeksforgeeks.org/script-aculo-us-sorting-droponempty-option/)

可排序模块中的 `dropOnEmpty` 选项允许将可排序的元素放到另一个列表中。它的默认值是 `false`。
