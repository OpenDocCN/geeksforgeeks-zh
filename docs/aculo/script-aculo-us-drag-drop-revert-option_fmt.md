# Script.aculo.us 拖放恢复选项

> 原文: [https://www.geeksforgeeks.org/script-aculo-us-drag-drop-revert-option/](https://www.geeksforgeeks.org/script-aculo-us-drag-drop-revert-option/)
...
*   `revert`: 这个值有 `true` 和 `false` 两个值，默认为 `false`。
