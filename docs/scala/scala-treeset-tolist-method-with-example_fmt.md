...
> 原文: [https://www.geeksforgeeks.org/scala-treeset-tolist-method-with-example/](https://www.geeksforgeeks.org/scala-treeset-tolist-method-with-example/)

`toList()` 方法用于返回包含树集合所有元素的列表。

> **方法定义:** `def toList: List[A]`
>
