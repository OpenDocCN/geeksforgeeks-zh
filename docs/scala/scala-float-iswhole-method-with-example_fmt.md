# Scala Float isWhole() 方法示例

> 原文: [https://www.geeksforgeeks.org/scala-float-iswhole-method-with-example/](https://www.geeksforgeeks.org/scala-float-iswhole-method-with-example/)
