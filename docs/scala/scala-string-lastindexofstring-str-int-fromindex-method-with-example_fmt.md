# Scala String lastIndexOf(String str, int fromIndex) 方法，示例

> 原文: [https://www.geeksforgeeks.org/scala-string-lastindexofstring-str-int-fromindex-method-with-example/](https://www.geeksforgeeks.org/scala-string-lastindexofstring-str-int-fromindex-method-with-example/)
