# Scala Int.<<(x: Double) 方法详解

> 原文: [https://www.geeksforgeeks.org/scala-int-x-double-method-with-example-17/](https://www.geeksforgeeks.org/scala-int-x-double-method-with-example-17/)
