...
> 原文：[https://www.geeksforgeeks.org/program-to-convert-java-list-to-seq-in-scala/](https://www.geeksforgeeks.org/program-to-convert-java-list-to-seq-in-scala/)
...
因此，返回一个整数序列。这里，首先创建一个列表，使用 `add` 方法将 `int` 元素添加到列表中。之后，利用 `toSeq` 方法将所述列表转换为序列。
