...
> 原文：`https://www.geeksforgeeks.org/scala-auxiliary-constructor/`
...
**辅助构造函数**定义为类中的方法，关键字为 `this`。我们可以定义多个辅助构造函数，但是它们必须有不同的参数列表。
