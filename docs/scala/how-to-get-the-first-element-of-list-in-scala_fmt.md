...
> 原文：[https://www.geeksforgeeks.org/how-to-get-the-first-element-of-list-in-scala/](https://www.geeksforgeeks.org/how-to-get-the-first-element-of-list-in-scala/)

在 Scala 中，列表是在 `scala.collection.immutable` 包下定义的。列表是包含不可变数据的相同类型元素的集合。让我们看看如何在 Scala 中获得给定列表的第一个元素。
