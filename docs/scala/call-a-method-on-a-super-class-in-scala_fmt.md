...
> 原文：[https://www.geeksforgeeks.org/call-a-method-on-a-super-class-in-scala/](https://www.geeksforgeeks.org/call-a-method-on-a-super-class-in-scala/)

当我们想调用超类方法时，就要用到这个概念。因此，每当基类和子类有相同的命名方法时，为了解决歧义，我们使用 `super` 关键字来调用基类方法。关键词`super`带着传承的概念来到这里。
