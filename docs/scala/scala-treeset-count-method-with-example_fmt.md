# Scala TreeSet count()方法示例

> 原文：`https://www.geeksforgeeks.org/scala-treeset-count-method-with-example/`

在 Scala 中，`TreeSet`类的`count()`方法用于计算满足给定谓词的树集中的元素数量。
