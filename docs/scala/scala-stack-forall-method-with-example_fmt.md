...
> 原文：[https://www.geeksforgeeks.org/scala-stack-forall-method-with-example/](https://www.geeksforgeeks.org/scala-stack-forall-method-with-example/)

在 Scala 中，`Stack`类的`forall()`方法用于检查谓词是否对堆栈的所有元素都成立。
