...
> 原文: [https://www.geeksforgeeks.org/scala-immutable-treeset-foreach-method/](https://www.geeksforgeeks.org/scala-immutable-treeset-foreach-method/)

在 Scala 不可变的`TreeSet`类中，`foreach()`方法被用来将给定的函数应用于树集中的所有元素。
