# Scala SortedSet dropWhile()方法示例

> 原文: [https://www.geeksforgeeks.org/scala-sortedset-dropwhile-method-with-example/](https://www.geeksforgeeks.org/scala-sortedset-dropwhile-method-with-example/)
