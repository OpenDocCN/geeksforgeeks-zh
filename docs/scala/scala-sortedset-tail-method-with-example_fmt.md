...
> 原文: [https://www.geeksforgeeks.org/scala-sortedset-tail-method-with-example/](https://www.geeksforgeeks.org/scala-sortedset-tail-method-with-example/)
...
**返回类型:**
它返回一个 `SortedSet`，由除 `SortedSet` 的第一个元素之外的所有元素组成。
