...
> 原文: [https://www.geeksforgeeks.org/scala-immutable-treeset-copytoarray-method/](https://www.geeksforgeeks.org/scala-immutable-treeset-copytoarray-method/)

在 Scala 不可变 `TreeSet` 类中， `copyToArray()` 方法用于将树集的元素复制到数组中。
