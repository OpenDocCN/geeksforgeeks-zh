# Scala TreeSet drop()方法示例

> 原文: [https://www.geeksforgeeks.org/scala-treeset-drop-method-with-example/](https://www.geeksforgeeks.org/scala-treeset-drop-method-with-example/)

在 Scala `TreeSet` 类中，`drop()` 方法用于丢弃树集中的前 n 个元素。
