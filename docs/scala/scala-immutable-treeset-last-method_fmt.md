...
> 原文: [https://www.geeksforgeeks.org/scala-immutable-treeset-last-method/](https://www.geeksforgeeks.org/scala-immutable-treeset-last-method/)

在 Scala 中，不可变的 `TreeSet` 类的 `last()` 方法用于返回 `TreeSet` 的最后一个元素。
