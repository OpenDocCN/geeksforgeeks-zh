...
> 原文：`https://www.geeksforgeeks.org/program-to-convert-java-set-of-shorts-to-a-traversable-in-scala/`

通过利用 Scala 中 `java` 的 `toTraversable` 方法，可以将一个 Java `Shorts` 集合转换为 Scala 中的可遍历集合。在这里，您需要导入 Scala 的 `JavaConversions` 对象，以便进行转换。
