# Scala Int <(x: Float)方法

原文: [https://www.geeksforgeeks.org/scala-int-x-float-method-with-example-8/](https://www.geeksforgeeks.org/scala-int-x-float-method-with-example-8/)
