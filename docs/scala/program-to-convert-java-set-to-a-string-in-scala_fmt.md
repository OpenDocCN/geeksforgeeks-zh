...
> 原文：[https://www.geeksforgeks.org/program-to-convert-java-set-to-a-string-in-scala/](https://www.geeksforgeks.org/program-to-convert-java-set-to-a-string-in-scala/)
...
因此，将返回的字符串。这里，首先创建一个集合，利用 `add` 方法向其中添加整数元素。之后利用 `toString` 方法将所述集合转换为字符串。
