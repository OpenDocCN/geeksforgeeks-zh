...
> 原文: [https://www.geeksforgeeks.org/scala-stack-dropright-method-with-example/](https://www.geeksforgeeks.org/scala-stack-dropright-method-with-example/)

在 Scala `Stack` 类中，`dropRight()` 方法用于删除堆栈的最后 n 个元素。
