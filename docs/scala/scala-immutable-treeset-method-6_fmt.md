...
> 原文: [https://www.geeksforgeeks.org/scala-immutable-treeset-method-6/](https://www.geeksforgeeks.org/scala-immutable-treeset-method-6/)

在 Scala 不可变 `TreeSet` 类中，`--()` 方法被用来从一个树集中减去另一个树集中的元素。

> **方法定义:** `def –(that: IterableOnce[A]): TreeSet[A]`
>
