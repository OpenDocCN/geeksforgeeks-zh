...
## 先决条件
[Scala 简介](https://www.geeksforgeeks.org/introduction-to-scala/)
...
### 下载 Scala
在开始安装过程之前，需要先下载。为此，所有版本的 Scala 都可以在[scala-lang.org](https://www.scala-lang.org/download/)上获得。
![download-scala-from-here](img/84e5fce39230f6eff5f5b46d6f16faf4.png)
下载 Scala 并按照进一步的说明安装 Scala。但是，您可以使用以下命令轻松地在 Ubuntu 上安装最新版本的 Scala:
...
**Output:**
![Hello-World-program-in-scala](img/374602da1e84f7d53bde1e15870841e8.png)