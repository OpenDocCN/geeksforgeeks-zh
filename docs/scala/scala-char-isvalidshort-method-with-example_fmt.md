...
> 原文: [https://www.geeksforgeeks.org/scala-char-isvalidshort-method-with-example/](https://www.geeksforgeeks.org/scala-char-isvalidshort-method-with-example/)

使用 `isValidShort()` 方法来查找所述字符是否在 `Short` 类型的范围内。

> **方法定义:** `def isValidShort: Boolean`
>
