...
> 原文: [https://www.geeksforgeeks.org/scala-string-replacefirst-method-with-example/](https://www.geeksforgeeks.org/scala-string-replacefirst-method-with-example/)

`replaceFirst()` 方法与 `replaceAll` 相同，但这里只替换所述子字符串的第一次出现。

> **方法定义:** `String replaceFirst(String regex, String replace)`
