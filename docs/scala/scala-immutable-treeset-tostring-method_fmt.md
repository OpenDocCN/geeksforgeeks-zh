...
> 原文：[https://www.geeksforgeeks.org/scala-immutable-treeset-tostring-method/](https://www.geeksforgeeks.org/scala-immutable-treeset-tostring-method/)

在 Scala 不可变 `TreeSet` 类中，`toString()` 方法用于返回 `TreeSet` 对象的字符串表示。
