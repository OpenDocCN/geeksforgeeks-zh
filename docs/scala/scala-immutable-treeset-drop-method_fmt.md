...
> 原文: [https://www.geeksforgeeks.org/scala-immutable-treeset-drop-method/](https://www.geeksforgeeks.org/scala-immutable-treeset-drop-method/)

在 Scala 不可变的`TreeSet`类中，`drop()`方法被用来删除树集中的前 n 个元素。
