...
> 原文: [https://www.geeksforgeeks.org/scala-stack-tobuffer-method-with-example/](https://www.geeksforgeeks.org/scala-stack-tobuffer-method-with-example/)

在 Scala `Stack` 类中，`toBuffer()` 方法被用来返回一个包含堆栈所有元素的缓冲区。
