# Scala Map transform()方法示例

> 原文：`https://www.geeksforgeeks.org/scala-map-transform-method-with-example/`

利用`transform()`方法将地图的元素变换成可变地图。

## 方法定义

> **方法定义:** `def transform(f: (K, V) => V): Map.this.type`
>
