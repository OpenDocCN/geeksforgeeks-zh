...
> 原文: [https://www.geeksforgeeks.org/program-to-convert-java-list-of-strings-to-an-iterable-in-scala/](https://www.geeksforgeeks.org/program-to-convert-java-list-of-strings-to-an-iterable-in-scala/)

通过在 Scala 中使用 Java 的 `to` 方法，可以将 Java 字符串列表转换为 Scala 中的 `Iterable`。在这里，您需要导入 Scala 的 `JavaConversions` 对象，以便进行转换，否则会出现错误。
