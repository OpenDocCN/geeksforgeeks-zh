...
> 原文：[https://www.geeksforgeeks.org/program-to-apply-foreach-method-on-java-list-in-scala/](https://www.geeksforgeeks.org/program-to-apply-foreach-method-on-java-list-in-scala/)
...
因此，当对所述列表应用 `foreach` 方法时，将打印列表的每一项。
