...
> 原文: [https://www.geeksforgeeks.org/scala-immutable-treeset-method-3/](https://www.geeksforgeeks.org/scala-immutable-treeset-method-3/)

在 Scala 不可变 `TreeSet` 类中，`+()` 方法用于向树集合添加元素，除非它已经存在。
