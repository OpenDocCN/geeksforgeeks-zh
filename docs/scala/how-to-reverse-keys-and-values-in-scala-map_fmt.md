...
> 原文：[https://www.geeksforgeeks.org/how-to-reverse-keys-and-values-in-scala-map/](https://www.geeksforgeeks.org/how-to-reverse-keys-and-values-in-scala-map/)
...
```scala
val reverseMap = for ((k,v) <- originalMap) yield (v,k)
```

下面是在 Scala 映射中反转键和值的例子。
