## 带分隔符的 Scala 迭代器 `addString()` 方法示例

> 原文：[https://www.geeksforgeeks.org/scala-iterator-addstring-method-with-a-separator-with-example/](https://www.geeksforgeeks.org/scala-iterator-addstring-method-with-a-separator-with-example/)
