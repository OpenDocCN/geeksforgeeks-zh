# Scala String lastIndexOf(int ch, int fromIndex) 方法与示例

> 原文: [https://www.geeksforgeeks.org/scala-string-lastindexofint-ch-int-fromindex-method-with-example/](https://www.geeksforgeeks.org/scala-string-lastindexofint-ch-int-fromindex-method-with-example/)
