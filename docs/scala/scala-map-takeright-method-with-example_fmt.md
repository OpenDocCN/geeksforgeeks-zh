...
> 原文: [https://www.geeksforgeeks.org/scala-map-takeright-method-with-example/](https://www.geeksforgeeks.org/scala-map-takeright-method-with-example/)

利用 `takeRight()` 方法选择地图的最后 n 个元素。

> **方法定义:** `def takeRight(n: Int): Map[A, B]`
>
> **返回类型:** 返回地图的最后 n 个元素。
