...
> 原文: [https://www.geeksforgeeks.org/scala-int-compareto-method-with-example/](https://www.geeksforgeeks.org/scala-int-compareto-method-with-example/)

如果第一个整数值等于第二个整数值，则使用 `compareTo()` 方法返回 0，如果第一个大于第二个，则返回 1，如果第一个小于第二个，则返回-1。

> **方法定义:** `(First_Integer_Value).compareTo(Second_Integer_Value)`
