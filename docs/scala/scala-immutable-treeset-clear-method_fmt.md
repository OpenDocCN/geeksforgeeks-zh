...
> 原文: [https://www.geeksforgeeks.org/scala-immutable-treeset-clear-method/](https://www.geeksforgeeks.org/scala-immutable-treeset-clear-method/)

在 Scala 不可变 `TreeSet` 类中，`clear()` 方法被用来删除树集中的所有元素。
