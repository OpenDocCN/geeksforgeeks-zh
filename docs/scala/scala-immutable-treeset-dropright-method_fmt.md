...
> 原文: [https://www.geeksforgeeks.org/scala-immutable-treeset-dropright-method/](https://www.geeksforgeeks.org/scala-immutable-treeset-dropright-method/)

在 Scala 不可变的`TreeSet`类中，`dropRight()`方法被用来删除树集中的最后 n 个元素。
