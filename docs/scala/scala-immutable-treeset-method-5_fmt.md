...
> 原文: [https://www.geeksforgeeks.org/scala-immutable-treeset-method-5/](https://www.geeksforgeeks.org/scala-immutable-treeset-method-5/)

在 Scala 不可变 `TreeSet` 类中， `-()` 方法被用来从给定的树集中移除元素。
