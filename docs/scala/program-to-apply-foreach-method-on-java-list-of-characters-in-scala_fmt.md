...
> 原文: [https://www.geeksforgeeks.org/program-to-apply-foreach-method-on-java-list-of-characters-in-scala/](https://www.geeksforgeeks.org/program-to-apply-foreach-method-on-java-list-of-characters-in-scala/)
...
因此，当对所述字符列表应用 `foreach` 方法时，列表的每一项都被打印。
