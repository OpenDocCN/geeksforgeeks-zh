...
> 原文：[https://www.geeksforgeeks.org/how-to-sort-a-scala-map-by-key/](https://www.geeksforgeeks.org/how-to-sort-a-scala-map-by-key/)

Map 与保存键:值对的字典相同。在本文中，我们将学习如何按键对 Scala 映射进行排序。我们可以使用`sortBy`键从低到高或从高到低对地图进行排序。
