...
> 原文: [https://www.geeksforgeeks.org/scala-mutable-sortedmap-tolist-method-with-example/](https://www.geeksforgeeks.org/scala-mutable-sortedmap-tolist-method-with-example/)

利用 `toList()` 方法显示列表中 `SortedMap` 的元素。

> **方法定义:** 定义为 `toList(): List[A]`
