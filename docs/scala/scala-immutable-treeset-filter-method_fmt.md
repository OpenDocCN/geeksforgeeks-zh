...
> 原文: [https://www.geeksforgeeks.org/scala-immutable-treeset-filter-method/](https://www.geeksforgeeks.org/scala-immutable-treeset-filter-method/)

在 Scala 不可变 `TreeSet` 类中，`filter()` 方法用于返回一个新的树集，该树集由满足给定谓词的所有元素组成。
