...
> 原文：[https://www.geeksforgeeks.org/program-to-convert-java-set-to-sequence-in-scala/](https://www.geeksforgeeks.org/program-to-convert-java-set-to-sequence-in-scala/)
...
因此，返回一个整数序列。这里，首先创建一个集合，利用 `add` 方法向其中添加整数元素。之后，使用 `toSeq` 方法将所述集合转换为序列。
