...
> 原文: [https://www.geeksforgeeks.org/scala-immutable-treeset-method-4/](https://www.geeksforgeeks.org/scala-immutable-treeset-method-4/)

在 Scala 不可变`TreeSet`类中，`++()`方法用于将一个树集的元素添加到另一个树集中。
