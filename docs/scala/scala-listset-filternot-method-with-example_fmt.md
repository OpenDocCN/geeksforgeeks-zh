...
> 原文：[`https://www.geeksforgeeks.org/scala-listset-filternot-method-with-example/`](https://www.geeksforgeeks.org/scala-listset-filternot-method-with-example/)
...
它返回一个新的列表集，该列表集包含列表集中不满足给定谓词的所有元素。
