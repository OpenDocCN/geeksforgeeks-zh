...
> 原文: [https://www.geeksforgeeks.org/scala-immutable-treeset-clone-method/](https://www.geeksforgeeks.org/scala-immutable-treeset-clone-method/)

在 Scala 不可变 `TreeSet` 类中，`clone()` 方法用于创建给定树集的副本。

> **方法定义:** `def clone(): TreeSet[A]`
>
