# Scala BitSet++:[B>:Int](即:GenTraversableOnce[B])方法，带示例

> 原文: [https://www.geeksforgeeks.org/scala-bitset-bintthat-gentraversableonceb-method-with-example/](https://www.geeksforgeeks.org/scala-bitset-bintthat-gentraversableonceb-method-with-example/)
