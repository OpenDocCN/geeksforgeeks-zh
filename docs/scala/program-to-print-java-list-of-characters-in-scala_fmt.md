...
> 原文：[https://www.geeksforgeeks.org/program-to-print-java-list-of-characters-in-scala/](https://www.geeksforgeeks.org/program-to-print-java-list-of-characters-in-scala/)

通过在 Scala 中编写一个用户定义的 Java 方法，可以从 Scala 程序中返回一个 Java 字符列表。在这里，我们甚至不需要导入任何 Scala 的 `JavaConversions` 对象来进行转换。现在，让我们来看一些例子。
