...
> 原文: [https://www.geeksforgeeks.org/scala-immutable-treeset-takeright-method/](https://www.geeksforgeeks.org/scala-immutable-treeset-takeright-method/)

在 Scala 不可变树集合类中，`takeRight()` 方法用于返回由树集合的最后 n 个元素组成的树集合。

> **方法定义:** `def takeRight(n: Int): TreeSet[A]`
>
