...
> 原文：[`https://www.geeksforgeeks.org/parameterless-method-in-scala/`](https://www.geeksforgeeks.org/parameterless-method-in-scala/)
...
空括号方法可以在没有括号的情况下调用，但通常建议并接受使用括号调用空括号方法。