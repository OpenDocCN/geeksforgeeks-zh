# Scala Float的isInfinity()方法，示例

> 原文: [https://www.geeksforgeeks.org/scala-float-isinfinity-method-with-example/](https://www.geeksforgeeks.org/scala-float-isinfinity-method-with-example/)
