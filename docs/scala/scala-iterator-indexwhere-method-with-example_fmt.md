# Scala 迭代器 `indexWhere()` 方法示例

> 原文: [https://www.geeksforgeeks.org/scala-iterator-indexwhere-method-with-example/](https://www.geeksforgeeks.org/scala-iterator-indexwhere-method-with-example/)
