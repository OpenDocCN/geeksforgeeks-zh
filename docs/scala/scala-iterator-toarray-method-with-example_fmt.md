# Scala 迭代器 `toArray()` 方法示例

> 原文: [https://www.geeksforgeeks.org/scala-iterator-toarray-method-with-example/](https://www.geeksforgeeks.org/scala-iterator-toarray-method-with-example/)
