# Scala Int !=(x: Long) 方法举例

> 原文: [https://www.geeksforgeeks.org/scala-int-x-long-method-with-example-5/](https://www.geeksforgeeks.org/scala-int-x-long-method-with-example-5/)
