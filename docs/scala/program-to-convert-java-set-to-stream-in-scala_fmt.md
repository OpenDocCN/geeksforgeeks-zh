# 在 Scala 中将 Java 集合转换为流的程序

> 原文：[https://www.geeksforgeeks.org/program-to-convert-java-set-to-stream-in-scala/](https://www.geeksforgeeks.org/program-to-convert-java-set-to-stream-in-scala/)
...
因此，返回一个流。这里，首先创建一个集合，利用 `add` 方法向其中添加整数元素。之后利用 `toStream` 方法将所述集合转换为流。
