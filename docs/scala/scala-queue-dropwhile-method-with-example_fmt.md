...
> 原文: [https://www.geeksforgeeks.org/scala-queue-dropwhile-method-with-example/](https://www.geeksforgeeks.org/scala-queue-dropwhile-method-with-example/)

`dropWhile()` 方法用于从前面丢弃满足队列中给定谓词的最长前缀。

> **方法定义:** `def dropWhile(p: (A) => Boolean): Queue[A]`
>
