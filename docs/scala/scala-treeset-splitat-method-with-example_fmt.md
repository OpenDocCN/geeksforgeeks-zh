...
> 原文: [https://www.geeksforgeeks.org/scala-treeset-splitat-method-with-example/](https://www.geeksforgeeks.org/scala-treeset-splitat-method-with-example/)
...
```scala
// Scala program of splitAt() method
