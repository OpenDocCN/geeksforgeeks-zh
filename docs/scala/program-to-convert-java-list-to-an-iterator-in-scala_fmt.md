...
> 原文：[https://www.geeksforgeeks.org/program-to-convert-java-list-to-an-iterator-in-scala/](https://www.geeksforgeeks.org/program-to-convert-java-list-to-an-iterator-in-scala/)
...
因此，返回一个非空迭代器。这里，首先创建一个列表，使用 `add` 方法将 `int` 元素添加到列表中。之后利用 `toIterator` 的方法将所述列表转换成迭代器。
