...
T2】原文: [https://www.geeksforgeeks.org/scala-short-x-double-boolean-4/](https://www.geeksforgeeks.org/scala-short-x-double-boolean-4/)

简言之，16 位有符号整数（相当于 Java 的 `short` 原语类型）是 `scala.AnyVal` 的子类型。如果该值小于 `x`，则使用。
