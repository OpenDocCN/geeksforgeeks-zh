...
> 原文: [https://www.geeksforgeeks.org/scala-sortedset-filter-method-with-example/](https://www.geeksforgeeks.org/scala-sortedset-filter-method-with-example/)

`filter()`方法用于选择满足所述谓词的排序集合的所有元素。
