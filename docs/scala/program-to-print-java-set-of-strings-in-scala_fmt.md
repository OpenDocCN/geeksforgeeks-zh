...
> 原文：[https://www.geeksforgeeks.org/program-to-print-java-set-of-strings-in-scala/](https://www.geeksforgeeks.org/program-to-print-java-set-of-strings-in-scala/)

通过在 Scala 中编写用户定义的 Java 方法，可以从 Scala 程序中返回一组 Java 字符串。在这里，我们甚至不需要导入任何 Scala 的 `JavaConversions` 对象来进行转换。现在，让我们来看一些例子。
