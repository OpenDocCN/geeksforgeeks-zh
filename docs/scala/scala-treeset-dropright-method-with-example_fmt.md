...
> 原文: [https://www.geeksforgeeks.org/scala-treeset-dropright-method-with-example/](https://www.geeksforgeeks.org/scala-treeset-dropright-method-with-example/)

在 Scala `TreeSet` 类中，`dropRight()` 方法用于删除树集中的最后 n 个元素。
