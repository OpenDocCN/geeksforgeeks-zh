# Scala SortedMap `contains()` 方法示例

> 原文: [https://www.geeksforgeeks.org/scala-sortedmap-contains-method-with-example/](https://www.geeksforgeeks.org/scala-sortedmap-contains-method-with-example/)
...
如果 `SortedMap` 声明的键有绑定，则返回真，否则返回假。
