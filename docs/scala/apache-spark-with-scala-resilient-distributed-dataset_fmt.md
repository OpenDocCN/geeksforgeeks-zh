...
> 原文: [https://www.geeksforgeeks.org/apache-spark-with-scala-resilient-distributed-dataset/](https://www.geeksforgeeks.org/apache-spark-with-scala-resilient-distributed-dataset/)
...
1.  **[RDD (弹性分布式数据集)](https://www.geeksforgeeks.org/introduction-pyspark-distributed-computing-apache-spark/)** – 它是一个不可变的分布式对象集合。就 `RDD` 而言，数据集是其主要部分，被划分为逻辑分区。
2.  **SparkSession** – 使用数据集和数据框架应用程序编程接口进行 `Spark` 编程的入口点。
