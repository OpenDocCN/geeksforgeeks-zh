...
> 原文: [https://www.geeksforgeeks.org/understanding-pytorch-lightning-datamodules/](https://www.geeksforgeeks.org/understanding-pytorch-lightning-datamodules/)
...
在本文中，我将以 MNIST 数据为例。如我们所见，创建闪电数据模块的第一个要求是继承 `pytorch-lightning` 中的 `LightningDataModule` 类：
