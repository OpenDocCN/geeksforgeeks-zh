...
> 原文: [https://www.geeksforgeeks.org/identifying-handwritten-digits-using-logistic-regression-pytorch/](https://www.geeksforgeeks.org/identifying-handwritten-digits-using-logistic-regression-pytorch/)
...
在我们的数据集中，图像大小是 28*28。因此，我们的输入大小是 784。此外，这里有 10 位数字，因此我们可以有 10 个不同的输出。因此，我们将 `num_classes` 设置为 10。此外，我们将在整个数据集上训练五次。最后，我们将分批训练，每批 100 张图片，以防止程序因内存溢出而崩溃。
