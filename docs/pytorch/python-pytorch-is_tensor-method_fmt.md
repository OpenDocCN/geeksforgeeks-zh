# Python–PyTorch `torch.is_tensor()` 方法

> 原文: [https://www.geeksforgeeks.org/python-pytorch-is_tensor-method/](https://www.geeksforgeeks.org/python-pytorch-is_tensor-method/)
