...
> 两个向量的加法：`tensor([158, 179, 200, 221, 242])`
>
> 两个向量的减法：`tensor([-42, -61, -80, -99, -118])`
>
> 两个向量的乘法：`tensor([5800, 7080, 8400, 9760, 11160])`
>
> 两个向量的乘法：`tensor([5800, 7080, 8400, 9760, 11160])`
>
> 两个向量的除法：`tensor([0.5800, 0.4917, 0.4286, 0.3812, 0.3444])`
>
> 两个向量的楼层划分：`tensor([0, 0, 0, 0, 0])`
>
> 两个向量的模运算：`tensor([58, 59, 60, 61, 62])`
>
> 两个向量的幂运算：`tensor([0, -4166911448072485343, 0, 8747520307384418433, 0])`
