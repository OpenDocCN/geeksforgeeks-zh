...
> 原文: [https://www.geeksforgeeks.org/python-pytorch-is_storage-method-2/](https://www.geeksforgeeks.org/python-pytorch-is_storage-method-2/)

如果对象是 PyTorch 存储对象，PyTorch 的 `torch.is_storage()` 方法返回 `True`。
