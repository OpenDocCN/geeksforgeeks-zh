...
> 原文：[https://www.geeksforgeeks.org/difference-between-cellpadding-and-cellspacing/](https://www.geeksforgeeks.org/difference-between-cellpadding-and-cellspacing/)
...
| Use html tag to create, but the type property is set to `cellpadding`. | It is also created using HTML tag, but the type property is set to `cellspacing`. |
