...
> 原文：[https://www.geeksforgeeks.org/how-to-build-portfolio-website-and-host-it-on-github-pages/](https://www.geeksforgeeks.org/how-to-build-portfolio-website-and-host-it-on-github-pages/)
...
![用于编辑文件的 VS 代码编辑器](img/a24ac620b69f83c7fd0bbbdafb5e025e.png)

## 上传到 GitHub 存储库中

最后，您的文件现在需要被推送到一个新的 GitHub 存储库中，并且必须使用`GitHub Pages`托管。要在 GitHub 中推送您的投资组合网站的必要文件，请遵循给定的步骤：

*   登录[https://github.com/](https://github.com/)并点击左侧窗格中仓库旁边的**新建**选项。

![单击新建选项](img/a5f98955d86435d4dca9f86c3abc1c6a.png)

*   将存储库命名为“`your-username.github.io`”。（例如，如果您的用户名是 `chandrikadeb7`，则将存储库命名为 `chandrikadeb7.github.io`）。
*   点击**创建存储库**。

![输入必要的详细信息，然后单击创建存储库](img/0ecf21c9918615b8268797716bef6689.png)
...
![上传必要的文件，然后单击提交更改](img/5385644cd13d0ed19cc38b3b2511cc5a.png)

### 2. 使用 Git 版本控制

*   您可以使用`Git 版本控制系统`将文件推送到您的存储库。
*   参见本指南**安装 Git**：[https://git-scm.com/book/en/v2/Getting-Started-Installing-Git](https://git-scm.com/book/en/v2/Getting-Started-Installing-Git)
*   将当前工作目录更改为您的本地项目。
*   将本地目录初始化为 Git 存储库。
...
![单击剪贴板图标复制网址](img/b3ff72157e6ce316ab2143919d7af259.png)
...
*   现在转到上面的**设置**标签，向下滚动寻找`GitHub Pages`选项。
*   现在在源代码下拉列表中选择**主分支**，一个通知将会出现，说明您准备在一两分钟内发布您的站点。

![GitHub Pages 设置](img/2c00e87ebde86b90dd522aa5f2ec5d78.png)

*   点击通知超链接，就可以了..**你的作品集免费托管在 GitHub 页面！**

[![您的个人投资组合网站](img/3c24ad720f77e496b784f2713d5d8356.png)](https://miro.medium.com/max/1000/1*D4yp87vUoKIKKdlj7bwiGg.png)

您的个人投资组合网站发布在`https://<your-github-username>.github.io`

你可以在这里看看我的——[https://chandrikadeb7.github.io](https://chandrikadeb7.github.io)