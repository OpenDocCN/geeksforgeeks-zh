...
> 原文：[https://www.geeksforgeeks.org/difference-between-restless-webservice-and-restful-webservice/](https://www.geeksforgeeks.org/difference-between-restless-webservice-and-restful-webservice/)
...
| Functions | These services use service interfaces to show business logic. | These services use `URL`s to show business logic. |
