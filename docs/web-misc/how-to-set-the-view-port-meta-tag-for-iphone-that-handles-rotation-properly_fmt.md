...
> 原文：[https://www.geeksforgeeks.org/how-to-set-the-view-port-meta-tag-for-iphone-that-handles-rotation-properly/](https://www.geeksforgeeks.org/how-to-set-the-view-port-meta-tag-for-iphone-that-handles-rotation-properly/)
...
*   **宽度：** 用于设置布局视图-端口的宽度。在我们的例子中，我们将其设置为`设备宽度`，这将覆盖苹果的默认设置`960像素`。
