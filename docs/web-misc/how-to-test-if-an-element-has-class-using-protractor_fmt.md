...
> 原文：[https://www.geeksforgeeks.org/how-to-test-if-an-element-has-class-using-protractor/](https://www.geeksforgeeks.org/how-to-test-if-an-element-has-class-using-protractor/)
...
*   `browser` 是量角器创建的全局对象，用于浏览器级命令，如 `browser.navigate()`，`browser.get()`。
