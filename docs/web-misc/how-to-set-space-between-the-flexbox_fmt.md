...
> 原文：[https://www.geeksforgeeks.org/how-to-set-space-between-the-flexbox/](https://www.geeksforgeeks.org/how-to-set-space-between-the-flexbox/)

柔性盒模块或柔性盒是一种布局模型。这种布局的主要目的是在容器中的项目之间分配空间。这种布局是一维布局模型。当项目的大小未知或动态时，flexbox 布局甚至可以工作。

要设置弹性框之间的空间，您可以使用弹性框属性 `justify-content`。您也可以访问该链接中的所有属性。
...
*   值 `space-around` 用于显示线条之间、之前和之后有空格的弹性项。
