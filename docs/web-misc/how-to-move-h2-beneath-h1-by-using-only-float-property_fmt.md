...
> 原文: [https://www.geeksforgeeks.org/how-to-move-h2-beneath-h1-by-using-only-float-property/](https://www.geeksforgeeks.org/how-to-move-h2-beneath-h1-by-using-only-float-property/)
...
<body>
    <div class="container-fluid p-5">
        ...
        <span class="font-weight-bolder">H1 & H2 Without float</span>
        ...
        <span class="font-weight-bolder">Using clearfix with float</span>
        ...
        <span class="font-weight-bolder">Wrapped by flex with float</span>
