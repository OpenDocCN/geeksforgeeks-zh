            ...
            <div class="box">
                <article class="media">
                    ...
                    <div class="media-content">
                        <div class="content">
                            <p>
                                `GeeksforGeeks` <small>@geeks</small>
                                <br>
...
**注意:** 在上面所有的例子中，我们使用了一些额外的布尔玛类，比如 `container`、`columns`、`title`、`button`、`media`、`image`、`input`、`label` 等，来很好地设计我们的内容。