...
> 原文: [https://www.geeksforgeeks.org/change-image-dynamic-when-user-scroll-down-set-2/](https://www.geeksforgeeks.org/change-image-dynamically-when-user-scrolls-down-set-2/)
...
在本例中，只要页面垂直滚动 150 像素，我们就会更改图像的来源。该页面由图像和文本部分组成。它们是通过内部 CSS 设计的。
...
在本例中，我们将根据用户向下滚动的程度动态更改图像的排列。该页面由四个图像组成，在页面底部有一个粘性位置。
