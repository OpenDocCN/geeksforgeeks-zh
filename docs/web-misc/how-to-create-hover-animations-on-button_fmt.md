...
> 原文: [https://www.geeksforgeeks.org/how-to-create-hover-animations-on-button/](https://www.geeksforgeeks.org/how-to-create-hover-animations-on-button/)
...
**CDN 链接:** 对于按钮图标，我们将使用 `fontawesome` CDN 链接。将此链接放在 `script` 标签中。
