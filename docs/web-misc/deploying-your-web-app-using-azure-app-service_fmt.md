...
> 原文: [https://www.geeksforgeeks.org/deploying-your-web-app-using-azure-app-service/](https://www.geeksforgeeks.org/deploying-your-web-app-using-azure-app-service/)
...
**注:** 微软 Azure 对新用户有免费试用优惠。您可以访问此 [链接](https://azure.microsoft.com/en-us/free/)，免费创建一个新的微软 Azure 帐户。
