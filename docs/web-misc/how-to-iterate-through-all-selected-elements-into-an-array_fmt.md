...
> 原文：[https://www.geeksforgeeks.org/how-to-iterate-through-all-selected-elements-into-an-array/](https://www.geeksforgeeks.org/how-to-iterate-through-all-selected-elements-into-an-array/)
...
*   点击按钮（“点击我！”）来选择元素并将它们附加到第二个容器。
*   使用 `querySelector()` 选择第二个容器（`list-2`）。
*   使用 `forEach()` 方法循环遍历所有 `div` 元素。
