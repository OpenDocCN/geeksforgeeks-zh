...
> 原文: [https://www.geeksforgeeks.org/integrating-facebook-like-share-plugin-using-django/](https://www.geeksforgeeks.org/integrating-facebook-like-share-plugin-using-django/)
...
然后在 `INSTALLED_APPS` (**settings.py**)中添加应用名称。
...
在主应用程序内部创建新目录 **templates**，即创建 **main** 目录
