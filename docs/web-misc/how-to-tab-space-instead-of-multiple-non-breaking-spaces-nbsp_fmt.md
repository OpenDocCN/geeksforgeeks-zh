...
> 原文：[https://www.geeksforgeeks.org/how-to-tab-space-instead-of-multiple-non-breaking-spaces-nbsp/](https://www.geeksforgeeks.org/how-to-tab-space-instead-of-multiple-non-breaking-spaces-nbsp/)

在 CSS 属性中，`padding` 和 `margin` 可以用来定位空格，而不是非中断空格。
