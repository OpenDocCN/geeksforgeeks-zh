...
> 原文: [https://www.geeksforgeeks.org/how-to-stretch-div-to-fit-the-container/](https://www.geeksforgeeks.org/how-to-stretch-div-to-fit-the-container/)

容器内的子 div 可以取父 div 的全部宽度和高度。下面讨论使用 CSS 拉伸 div 以适应容器的两种方法：
