...
> 原文:`https://www.geeksforgeeks.org/observables-knockoutjs/`
...
## 特色:
读写观察点
1. READ–`appviewmodel.yourname()`；
2. WRITE–`appviewmodel.yourname(' Diana ')`；
3. 写多个–`appviewmodel.yourname(' Diana ').尤若阁(25)`；
