...
本文的目的是改变 HTML [`<input>`](https://www.geeksforgeeks.org/html-input-type-attribute/) 的类型。[Javascript](https://www.geeksforgeeks.org/javascript-tutorial/) 提供[文档对象模型（DOM）](https://www.geeksforgeeks.org/html-dom-getelementbyid-method/) 来更改输入字段的类型。
