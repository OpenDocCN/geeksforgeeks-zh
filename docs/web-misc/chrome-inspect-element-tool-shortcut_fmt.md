...
> 原文: [https://www.geeksforgeeks.org/chrome-inspect-element-tool-shortcut/](https://www.geeksforgeeks.org/chrome-inspect-element-tool-shortcut/)

## 工具介绍

Chrome 的检查元素工具被认为是一个开发工具，用来调试网站。

右键单击任意网页，单击检查，您将看到该网站的视图：它的源代码、形成其风格的图片和 CSS、它使用的字体和图标、为动画提供动力的 Javascript 代码等等。你可以看到网站加载需要多长时间，它使用了多少带宽，以及它的文本的实际颜色。
...
*   选择您想要模拟的设备，点击刷新按钮，然后转到您想要点击或搜索的任何网页，这样就完成了。
