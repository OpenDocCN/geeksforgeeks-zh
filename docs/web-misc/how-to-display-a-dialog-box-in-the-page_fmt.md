...
> 原文：[https://www.geeksforgeeks.org/how-to-display-a-dialog-box-in-the-page/](https://www.geeksforgeeks.org/how-to-display-a-dialog-box-in-the-page/)

在本文中，我们将看到如何在我们的网页上实现一些特定动作的对话框。这可以通过[jQuery UI](https://www.geeksforgeeks.org/jquery-ui-introduction/)来实现，它是各种样式组件、小部件、效果、主题以及更多可以与 jQuery 一起使用的东西的集合。

`jQueryUI CDN 链接`：在 HTML 文件的[`head`](https://www.geeksforgeeks.org/html-head-tag/)标签中添加以下链接。
