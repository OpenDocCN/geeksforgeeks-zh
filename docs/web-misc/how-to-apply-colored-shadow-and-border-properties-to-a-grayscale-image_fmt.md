...
> 原文：[https://www.geeksforgeeks.org/how-to-apply-colored-shadow-and-border-properties-to-a-grayscale-image/](https://www.geeksforgeeks.org/how-to-apply-colored-shadow-and-border-properties-to-a-grayscale-image/)

有一种非常简单的方法可以将灰度效果应用于图像。使用`filter()`属性，我们可以对任何 HTML 元素应用灰度效果。当我们对具有灰度属性的图像应用彩色框阴影时，阴影也会变成灰度。例如：
...
您可以使用这三个属性（`grayscale()`、`box-shadow`、`border`）的组合来创建一些更有趣的 CSS 效果。下面是一些例子：

### 示例 1

您可以使用下面的代码，在鼠标指针悬停时将按钮#1 转换为按钮#2。
...
![](img/759099d8261738f85bcdd8bdeec05111.png)

### 示例 2

您也可以使用这些效果将 PNG 图像转换为可区分的按钮。这些效果主要用于创建三维透视图和最小视图。
...
![](img/d4bfd9cd377d09773dfa2e4af49b8c46.png)