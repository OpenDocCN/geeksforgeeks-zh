...
> 原文：[https://www.geeksforgeeks.org/how-to-use-anchor-tag-as-submit-button/](https://www.geeksforgeeks.org/how-to-use-anchor-tag-as-submit-button/)

HTML 中的 [`<a>` (锚点标签)](https://www.geeksforgeeks.org/html-a-tag/) 用于在网页上创建超链接。此超链接用于将网页链接到其他网页。它或者用于提供绝对参考，或者作为其 `href` 值的相对参考。
...
要使用锚点标签作为提交按钮，我们需要 [JavaScript](https://www.geeksforgeeks.org/javascript-tutorial/) 的帮助。要提交表单，我们使用 JavaScript 的 `submit()` 功能。该函数提交表单。
...
**注：** 我们也可以调用 `submit()` 功能，通过编写 JavaScript 作为：
...
*   现在点击超链接 “Click here to submit form”。
