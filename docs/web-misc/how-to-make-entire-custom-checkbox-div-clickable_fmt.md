...
> 原文: [https://www.geeksforgeeks.org/how-to-make-entire-custom-checkbox-div-clickable/](https://www.geeksforgeeks.org/how-to-make-entire-custom-checkbox-div-clickable/)

在你的网站中使用自定义复选框而不是老式的 HTML 复选框总是一个不错的选择。本文为其提供了一个分步实现。
