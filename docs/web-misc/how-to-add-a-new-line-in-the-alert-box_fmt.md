...
> 原文：[https://www.geeksforgeeks.org/how-to-add-a-new-line-in-the-alert-box/](https://www.geeksforgeeks.org/how-to-add-a-new-line-in-the-alert-box/)

为了给**警告框**的内容添加新的一行，我们将使用 `\n` 反斜杠(n)。

## 示例-1

本示例在**警告框**的文本中的两行之间添加了 `\n`。
