...
> 原文: [https://www.geeksforgeeks.org/how-to-insert-text-into-the-textarea-at-the-current-cursor-position/](https://www.geeksforgeeks.org/how-to-insert-text-into-the-textarea-at-the-current-cursor-position/)
...
这里，有一个名为 `setTextToCurrentPos` 的书面方法。点击 `在当前位置` 插入，调用该方法。
...
>
> `$('#text1').val(x.slice(0,curPos)+text_to_insert+x.slice(curPos));` //在文本区域设置更新值