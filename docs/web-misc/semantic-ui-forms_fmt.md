...
## 示例 4
本示例创建复选框。语义用户界面中有各种各样的复选框样式，比如标准的复选框、切换和滑动。
为此，您需要导入 jQuery 库。
...
*   您可以用错误或警告代替成功来显示该状态。
*   您可以使用 `small`、`large`、`big`、`huge`、`massive` 类来更改表单的大小。