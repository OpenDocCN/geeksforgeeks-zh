...
> 原文：[https://www.geeksforgeeks.org/how-to-count-number-of-notification-on-an-icon/](https://www.geeksforgeeks.org/how-to-count-number-of-notification-on-an-icon/)
...
我们将继续执行以下步骤，以确保无论 DOM 结构如何，我们总能获得图标的通知号/徽章数。
...
下面是我们将用作模板的示例代码。最后，我们将根据下面的问题陈述应用 jQuery。
...
## 结合 HTML、CSS 和 JavaScript 代码

这是最后的代码，是上面两部分的结合，创建结构和设计结构。
