...
> 原文: [https://www.geeksforgeeks.org/explain-codeigniter-folder-structure/](https://www.geeksforgeeks.org/explain-codeigniter-folder-structure/)
...
应用程序文件夹是存储我们正在开发的应用程序的所有代码的地方。它由其他几个文件夹组成。
...
所有与编码相关的文件、库和其他文件都会存储在这里，这将有助于您轻松编码。
...
它作为离线 CodeIgniter 指南，帮助你学习 CodeIgniter 各种库的基本功能。你应该通过这个来了解 CodeIgniter。它包含一个 `index.php` 文件，其中包含设置环境和错误级别的重要内容。如果你不知道，就不要碰这个文件。
