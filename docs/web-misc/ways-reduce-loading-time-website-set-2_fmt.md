...
> 原文: [https://www.geeksforgeeks.org/ways-reduce-loading-time-website-set-2/](https://www.geeksforgeeks.org/ways-reduce-loading-time-website-set-2/)
...
*   `标记` 可能包含在您的网页中，以指定您的移动等效网址，以便谷歌机器人可以发现您的移动页面。
...
您可以点击这里找到简单的步骤，将 `亚马逊 S3` 与 `CloudFront` 设置为您的内容交付网络。

## 5. 避免自办视频

视频文件通常非常大，上传到你的网站可能会非常缓慢。相反，可以使用第三方视频托管服务，如 `YouTube`、`Vimeo` 或 `Wistia`。
