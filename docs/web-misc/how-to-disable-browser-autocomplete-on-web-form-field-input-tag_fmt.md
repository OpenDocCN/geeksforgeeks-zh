...
> 原文: [https://www.geeksforgeeks.org/how-to-disable-browser-autocomplete-on-web-form-field-input-tag/](https://www.geeksforgeeks.org/how-to-disable-browser-autocomplete-on-web-form-field-input-tag/)
...
`autocomplete` 属性用于启用和禁用文本的自动完成。该属性包含两个值:

*   `on`
*   `off`

要禁用表单或输入字段中的自动完成功能，请将 `autocomplete` 属性设置为 `off`。
...
本示例不使用 `autocomplete` 属性，因此默认情况下自动完成属性为启用。
