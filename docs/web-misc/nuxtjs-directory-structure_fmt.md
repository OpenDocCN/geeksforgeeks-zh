...
*   **页面：** 在这个目录中，我们可以为我们的 NuxtJs 应用创建页面。你只需要创造一个新的 `.vue` 文件在 `pages` 目录内创建一个新页面。之后，NuxtJs 将自动扫描页面，并为应用程序创建路由器。您也可以通过在 `pages` 目录中创建新文件夹来创建嵌套页面。
...
**输出：**
![Simple Output Text](img/e7c61e5a95e7d7bbb47a0bbd1185d3cc.png)

**参考：** [https://nuxtjs.org/docs/get-started/directory-structure/](https://nuxtjs.org/docs/get-started/directory-structure/)