...
> 原文：[https://www.geeksforgeeks.org/how-to-load-window-width-value-to-scss-variable/](https://www.geeksforgeeks.org/how-to-load-window-width-value-to-scss-variable/)
...
**注意：** 这里，提到 `box-sizing: border-box` 在这里真的很重要，因为这将渲染 DOM 以移除任何默认的边距或空格。
