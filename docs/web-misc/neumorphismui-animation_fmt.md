...
<style>
    ...
    .anime {
        ...
        /* Adding Animations */
        animation: gfg 5s cubic-bezier(0.16, 1, 0.3, 1) 1s infinite alternate;
    }
    ...
    @keyframes gfg {
        ...
        100% {
            ...
            height: 77px;
            /* background: #fefefe; */
            background: url(https://media.geeksforgeeks.org/wp-content/cdn-uploads/20200817185016/gfg_complete_logo_2x-min.png);
