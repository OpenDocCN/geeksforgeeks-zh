...
> 原文: [https://www.geeksforgeeks.org/how-to-create-an-affix-or-sticky-navbar/](https://www.geeksforgeeks.org/how-to-create-an-affix-or-sticky-navbar/)
...
在这一部分，我们将为粘性导航栏创建一个基本的网站结构，当用户向下滚动页面时，它将显示效果。
...
上一节我们已经创建了基础网站的结构。在本节中，我们将设计导航栏的结构，并使用 JavaScript 在导航栏上实现向下滚动效果。
