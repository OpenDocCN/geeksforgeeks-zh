...
> 原文:[https://www.geeksforgeeks.org/slim-framework-installation-and-configuration/](https://www.geeksforgeeks.org/slim-framework-installation-and-configuration/)
...
9.  现在打开一个网页浏览器**转到 URL**：`http://localhost:81/project_name/`
