...
> 原文：[https://www.geeksforgeeks.org/reading-selected-webpage-content-using-python-web-scraping/](https://www.geeksforgeeks.org/reading-selected-webpage-content-using-python-web-scraping/)
...
首先我们看到右键点击新闻文字看到的源代码 [![1](img/2243b2006b4e5b3717cb4059857df3b6.png)](https://media.geeksforgeeks.org/wp-content/uploads/124.png)

### 2. 检查标签

我们需要找出源代码中包含我们想要抓取的新闻部分的主体。它位于 `ul`（即无序列表）下，类名为 `"searchNews"` 的部分包含了新闻内容。

[![2](img/f91222a84f49f29bd8cdc7b6742d18c9.png)](https://media.geeksforgeeks.org/wp-content/uploads/219.png)

注意新闻文本出现在锚点标签 `<a>` 的文本部分。仔细观察会发现，所有的新闻都在无序标签的列表标签中。
