...
> 原文: [https://www.geeksforgeeks.org/differentiate-between-find-and-children-methods/](https://www.geeksforgeeks.org/differentiate-between-find-and-children-methods/)
...
[`children()`](https://www.geeksforgeeks.org/jquery-children-with-examples/) 方法也用于获取匹配元素集中每个元素的所有后代。我们也可以过滤结果。
...
## 差异 `find()` 和 `children()` 方法

两者的工作方法几乎相同。它们之间只有一个主要区别，让我们看看是什么。
