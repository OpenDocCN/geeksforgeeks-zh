...
> 原文: [https://www.geeksforgeeks.org/how-to-create-hamburger-menu-for-mobile-devices/](https://www.geeksforgeeks.org/how-to-create-hamburger-menu-for-mobile-devices/)
...
## 使用 html、CSS 和 JavaScript 的汉堡菜单

我们将编写自己的所有 HTML 和 CSS，并添加一些 JavaScript 来处理点击事件。基本方法是将导航栏的可见性标记为隐藏。当用户点击图标时，JavaScript 会将可见性从隐藏中移除。
...
在这种方法中，我们将使用 Bootstrap 来设计我们的页面，JavaScript 的工作与上述方法相同。
