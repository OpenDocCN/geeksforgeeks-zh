...
> 原文: [https://www.geeksforgeeks.org/dom-tablerow-insertcell-method/](https://www.geeksforgeeks.org/dom-tablerow-insertcell-method/)

**简介:** HTML DOM 中的 `TableRow insertCell()`方法用于在当前行的任意特定位置添加单个单元格。它是 `TableRow` 对象的预定义方法。
