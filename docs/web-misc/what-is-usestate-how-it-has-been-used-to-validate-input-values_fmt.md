# 什么是 `useState()` 及其如何用于验证输入值？

> 原文：[https://www.geeksforgeeks.org/what-is-usestate-how-it-has-been-used-to-validate-input-values/](https://www.geeksforgeeks.org/what-is-usestate-how-it-has-been-used-to-validate-input-values/)
...
如果用户没有用预期值填写表单，则在“React”中验证输入值会显示一条错误消息。有许多方法可以用 React 验证输入值。
