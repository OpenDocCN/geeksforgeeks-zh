...
> 原文：[https://www.geeksforgeeks.org/how-to-show-and-hide-div-elements-using-radio-buttons/](https://www.geeksforgeeks.org/how-to-show-and-hide-div-elements-using-radio-buttons/)
...
*   单选按钮的选择器名称与用于显示内容的元素相同。
*   使用 `show()` 将每个元素的 CSS `display` 属性设置为 `none`。
...
<body>
    <center>
        ...
        <div>
            <label>
                <input type="radio" name="colorRadio" value="C"> C</label>
            <label>
                <input type="radio" name="colorRadio" value="Cplus"> C++</label>
            <label>
                <input type="radio" name="colorRadio" value="Python"> Python</label>
            <label>
                <input type="radio" name="colorRadio" value="Java"> Java</label>
        </div>
        <div class="C selectt">
          <strong>C</strong>
