...
> 原文: [https://www.geeksforgeeks.org/how-to-build-a-great-product-from-scratch/](https://www.geeksforgeeks.org/how-to-build-a-great-product-from-scratch/)
...
现在，这里有一个 `Firebase` 和 `MongoDB` 之间的快速比较。这两个都是 `NoSQL` 数据库，如果你不想有服务器，我们建议你使用 `Firebase`。但是它比 `MongoDB` 安全得多，因为您必须在客户端公开您的应用编程接口密钥。如果你想让你的 `Firebase` 账户更安全，请看[这个](https://stackoverflow.com/questions/37482366/is-it-safe-to-expose-firebase-apikey-to-the-public)。但是尽管如此，如果你有一个服务器，那么你肯定应该使用 `MongoDB`。
