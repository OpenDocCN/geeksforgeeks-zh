...
*   **`is-lowercase`：** 这个类用来小写你使用这个类的标签里面的整个文本。
*   **`is-uppercase`：** 这个类用来大写你使用这个类的标签里面的整个文本。
*   **`is-italic`：** 这个类用来斜体你使用这个类的标签里面的整个文本。
*   **`is-underlined`：** 这个类用来给你使用这个类的标签里面的整个文本加下划线。
...
**参考：** [https://bulma.io/documentation/helpers/typography-helpers/#text-transformation](https://bulma.io/documentation/helpers/typography-helpers/#text-transformation)