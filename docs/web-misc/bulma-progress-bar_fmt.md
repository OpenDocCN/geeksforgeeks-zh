...
以下展示了使用 Bulma CSS 框架创建的不同颜色的进度条。
...
<tr>
    ...
    <td>
        <div>
            <progress class="progress is-link" max="100">35</progress>
        </div>
    </td>
</tr>
```
...
<tr>
    ...
    <td>
        <div>
            <progress class="progress is-info" max="100">50</progress>
        </div>
    </td>
</tr>
```
...
<tr>
    ...
    <td>
        <div>
            <progress class="progress is-success" max="100">65</progress>
        </div>
    </td>
</tr>
```
...
<tr>
    ...
    <td>
        <div>
            <progress class="progress is-warning" max="100">80</progress>
        </div>
    </td>
</tr>
```
...
<tr>
    ...
    <td>
        <div>
            <progress class="progress is-danger" max="100">95</progress>
        </div>
    </td>
</tr>
```
...
说明：不确定进度条用于显示正在进行的一些进度，但实际持续时间尚未确定。未定义 `HTML` `value` 属性时，将显示不确定的进度条。

注意：在上面的例子中，我们使用了一些额外的布尔玛类，如 `container`、`columns`、`title`、`table` 等。设计好内容。