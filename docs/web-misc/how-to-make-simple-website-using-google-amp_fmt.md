...
> 原文：[https://www.geeksforgeeks.org/how-to-make-simple-website-using-google-amp/](https://www.geeksforgeeks.org/how-to-make-simple-website-using-google-amp/)
...
*   设计者必须使用 `<html amp>` 或 `<html ⚡>` 标签来启动 AMP 页面代码。这告诉浏览器该文件是一个 AMP 文件。
    ```html
    <html amp>
    ```
...
*   通过在 `<style amp-custom>` 标记中编写 `CSS`，可以在 AMP 页面中添加自定义 `CSS`，如下所示：
    ```html
    <style amp-custom>
      <!-- Custom CSS -->
    </style>
