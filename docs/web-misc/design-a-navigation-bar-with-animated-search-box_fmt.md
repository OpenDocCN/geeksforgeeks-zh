...
> 原文: [https://www.geeksforgeeks.org/design-a-navigation-bar-with-animated-search-box/](https://www.geeksforgeeks.org/design-a-navigation-bar-with-animated-search-box/)
...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* Styling the search box where the input would be given */
        ...
        /* Changing the colour of the login icon when hovered over*/
