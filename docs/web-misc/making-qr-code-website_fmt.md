...
1.  不要要求使用特殊的二维码扫描器。二维码应该是应用无关的，这样任何人都可以使用任何阅读器扫描代码。

```
if (condVar > someVal) {console.log("xxx")}
```

本文由 [**舒布罗迪普·班纳吉**](https://auth.geeksforgeeks.org/profile.php?user=Shubrodeep Banerjee) 供稿。如果你喜欢 GeeksforGeeks 并想投稿，你也可以使用 `write.geeksforgeeks.org` 写一篇文章或者把你的文章邮寄到 `review-team@geeksforgeeks.org`。看到你的文章出现在极客博客主页上，帮助其他极客。
