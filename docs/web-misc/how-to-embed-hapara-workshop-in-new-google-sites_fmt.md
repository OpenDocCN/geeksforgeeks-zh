...
> 原文：[https://www.geeksforgeeks.org/how-to-embed-hapara-workshop-in-new-google-sites/](https://www.geeksforgeeks.org/how-to-embed-hapara-workshop-in-new-google-sites/)
...
教师可以构建项目、作业，并轻松地将它们分发给小组。仪表板还提供了访问`谷歌教室`、`谷歌驱动`等 `Hapara` 工作空间的途径。

## Hapara Workspace 的特点
...
4.  转到你的谷歌网站，点击“插入”，然后点击“嵌入网址”，复制粘贴链接。
5.  您可以在此选择页面视图类型：
    *   访问量
    *   链接视图
6.  一旦选择了视图，就嵌入了 `hapara` 车间。
