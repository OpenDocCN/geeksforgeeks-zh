...
> 原文：[https://www.geeksforgeeks.org/difference-between-dropbox-and-icloud/](https://www.geeksforgeeks.org/difference-between-dropbox-and-icloud/)
...
| DROPBOX | iCloud |
| --- | --- |
| 它属于`Dropbox公司`。 | 它归`苹果公司`所有。 |
| 它于 `2007` 年推出。 | 它于 `2011` 年推出。 |
| 它是由`德鲁·休斯顿`和`阿拉什·菲尔多西`开发的。 | 是`苹果`开发的。 |
