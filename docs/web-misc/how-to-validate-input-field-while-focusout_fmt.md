...
> 原文：[`https://www.geeksforgeeks.org/how-to-validate-input-field-while-focusout/`](https://www.geeksforgeeks.org/how-to-validate-input-field-while-focusout/)
...
如果输入字段为空，请使用 `siblings()`，`addClass()` 方法发出验证警报。
