# 如何使用 `.join()` 与 `push()` 和 `splice()` 连接在一起？

> 原文: [https://www.geeksforgeeks.org/how-to-use-join-with-push-and-replace-together/](https://www.geeksforgeeks.org/how-to-use-join-with-push-and-replace-together/)
...
**示例:** 下面是说明使用的示例。将 `.join()` 方法与 `push()` 方法和 `splice()` 方法连接在一起:
```
<!DOCTYPE html>
<html>
    <body>
