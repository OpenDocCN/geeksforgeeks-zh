...
> 原文：[https://www.geeksforgeeks.org/how-to-add-lightbox-effect-to-amp-carousel-in-google-amp/](https://www.geeksforgeeks.org/how-to-add-lightbox-effect-to-amp-carousel-in-google-amp/)

![](img/9f4c77d78e00cf75fc29323762067dd8.png)

`amp-carousel` 用于在一个 AMP HTML 页面中制作一个图像转盘。在 AMP HTML 中，也可以使用 `amp-lightbox-gallery` 将灯箱效果添加到 `amp-carousel` 中，因为 `amp-carousel` 中只包含图像。
