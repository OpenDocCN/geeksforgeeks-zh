...
**Bulma** 是一个基于 `Flexbox` 的免费开源 `CSS` 框架。它是组件丰富的，兼容的，并且有很好的文档记录。它本质上是高度反应的。它使用类来实现它的设计。项目中的列表组件可以设计成与 Bulma 课程一起看起来很有吸引力。
            ...
            <div class='column is-5'>
                <div class='list'>
                    <ul>
                        <div class='list-item'>
                            <li>
                                Design a custom database to store your daily activity
                            </li>
                        </div>
                        <div class='list-item'>
                            <li>
                        ...
                        <div class='list-item'>
                            <li>
                                Ride to a horse and write your experience
                            </li>
                        </div>
                        <div class='list-item'>
                            <li>
