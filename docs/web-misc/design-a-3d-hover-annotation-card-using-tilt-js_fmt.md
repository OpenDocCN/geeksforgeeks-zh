...
> 原文: [https://www.geeksforgeeks.org/design-a-3d-hover-annotation-card-using-tilt-js/](https://www.geeksforgeeks.org/design-a-3d-hover-annotation-card-using-tilt-js/)

**3D 悬停注释卡:** 悬停时，该卡将在顶部显示另一张 3D 效果的卡，该卡还具有倾斜效果。这个效果可以使用 `vanilla-tilt.js` 库和 `CSS` 来创建。

### 安装

这可以通过使用节点包管理器 (`npm`) 或通过在代码中添加 `CDN` 链接来安装。
...
![三维悬停注释卡](img/544e547a31b4636cd2c2ccc00a791238.png)