...
> 原文：[https://www.geeksforgeeks.org/how-to-calculate-area-of-circle-dynamically-using-amp-bind-macro-in-google-amp/](https://www.geeksforgeeks.org/how-to-calculate-area-of-circle-dynamically-using-amp-bind-macro-in-google-amp/)
...
要在我们的 amp 页面中使用 `amp-bind-macro`，我们必须在文档的头部导入 `amp-bind` 脚本。
