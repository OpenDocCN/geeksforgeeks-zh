...
> 原文: [https://www.geeksforgeeks.org/simple-post-request-using-the-fetch-api/](https://www.geeksforgeeks.org/simple-post-request-using-the-fetch-api/)

像 `XMLHttpRequest` 和 `Axios` 请求一样，`fetch()`方法用于向服务器发送请求。主要区别在于 Fetch API 使用了 Promises，这使得 API 变得更加简单和干净。您将使用提取应用编程接口获得整个**获取和发布方法**
