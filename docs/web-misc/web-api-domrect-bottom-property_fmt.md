# Web API: DOMRect.bottom 属性

> 原文: [https://www.geeksforgeeks.org/web-api-domrect-bottom-property/](https://www.geeksforgeeks.org/web-api-domrect-bottom-property/)
...
<html>
<head>
    <title>DOMRect bottom property</title>
</head>
<body>
    <center>
