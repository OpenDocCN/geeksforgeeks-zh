...
<body>
    <div style="margin-top: 20px" class="ui container">
        <div class="ui button" data-content="You are learning Semantic-ui popup">
            Hover Me
        </div>
    </div>
    <script>
...
`hoverable` 属性设置为 `true` 以悬停在弹出菜单上。如果我们不使用这个属性，它将是假的，并且不能悬停在弹出菜单上。
...
<body>
    <div style="margin-top: 20px" class="ui container">
        <div class="ui menu">
            ...
            <div class="ui fluid popup bottom left transition hidden" style="top: 554.6px; left: 1px; bottom: auto; right: auto; width: 840.2px;">
...
<body>
    <div style="margin-top: 20px" class="ui container">
        <div class="ui icon input">
            <input type="text" placeholder="Enter Email" data-content="Enter the email of person whose account you want to search" />
...
<body>
    <div style="margin-top: 20px" class="ui container">
        ...
        <img class="medium ui image" src="https://media.geeksforgeeks.org/wp-content/uploads/20200511124031/image30.png">
    </div>
    <script>
        $('.button').popup({
            position: 'right center',
