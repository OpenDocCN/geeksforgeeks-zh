...
> 原文: [https://www.geeksforgeeks.org/how-to-pass-query-parameters-with-a-routerlink/](https://www.geeksforgeeks.org/how-to-pass-query-parameters-with-a-routerlink/)
...
*   然后进去 `.ts` 文件，通过从 `@angular/router` 导入，尝试使用 `ActivatedRoute` 访问查询参数
...
```html
<a [routerLink]="['/punjab']" [queryParams]="{capital:'mohali',language:'punjabi'}">
    State Details
</a>
