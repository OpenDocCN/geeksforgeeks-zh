...
> 原文：[https://www.geeksforgeeks.org/how-to-add-announcement-banner-in-new-google-sites/](https://www.geeksforgeeks.org/how-to-add-announcement-banner-in-new-google-sites/)
...
3.  `公告`：该字段包含三个子字段，即消息、按钮标签和链接。消息字段用于显示公告消息。如果公告必须包含任何按钮，按钮标签字段将被填充。将链接添加到按钮链接字段已填充。如果您想在新窗口中打开该字段，只需选中名为`在新窗口中打开`的复选框。
