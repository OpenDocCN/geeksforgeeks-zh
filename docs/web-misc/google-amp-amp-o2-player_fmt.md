...
*   `data-pid`: O2 玩家的玩家 ID。
*   `data-vid`: O2 播放器的视频 id。
*   `data-bcid`: O2 播放器的播放列表 id。
*   `data-macros`: O2 播放器的宏。
...
<head>
    ...
    <link rel="canonical" href="https://amp.dev/documentation/examples/components/amp-o2-player/index.html">
