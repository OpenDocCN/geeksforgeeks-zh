...
> 原文: [https://www.geeksforgeeks.org/how-to-detect-alt-option-another-key-in-textarea/](https://www.geeksforgeeks.org/how-to-detect-alt-option-another-key-in-textarea/)
...
下面的代码说明了当用户按下文本区域上的 `Alt + h` 键时检测到的情况。它将产生警报信息。
...
<body>
    ...
    <script>
        function myFunction(e) {
            ...
            if (e.altKey && e.key === "h") {
                alert("GeeksforGeeks says Detection successfully ");
            }
        }
    </script>
</body>
