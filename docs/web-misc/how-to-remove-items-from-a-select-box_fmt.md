...
> 原文: [https://www.geeksforgeeks.org/how-to-remove-items-from-a-select-box/](https://www.geeksforgeeks.org/how-to-remove-items-from-a-select-box/)

可以使用 jQuery 中的两种方法从选择框中删除一个选项:

## 方法一: 直接删除框内选项

通过选择框选择要删除的选项。要删除的值在选择框的值选择器`(value='optionValue')`中指定。然后使用`remove()`方法移除该选择的选项。
