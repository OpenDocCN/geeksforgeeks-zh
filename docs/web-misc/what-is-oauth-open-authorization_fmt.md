...
> 原文：[https://www.geeksforgeeks.org/what-is-oauth-open-authorization/](https://www.geeksforgeeks.org/what-is-oauth-open-authorization/)
...
2.  OAuth 客户端 – 这是我们共享或验证信息使用情况的网站，如极客博客等。
3.  所有者 – 登录验证信息共享的用户。
