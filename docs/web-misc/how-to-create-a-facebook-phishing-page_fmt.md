...
> 原文:[https://www . geeksforgeks . org/如何创建-Facebook-网络钓鱼-页面/](https://www.geeksforgeeks.org/how-to-create-a-facebook-phishing-page/)
...
*   现在，搜索字符串`methode="POST"`，它会给你两个结果，第一个是登录，第二个是注册。
