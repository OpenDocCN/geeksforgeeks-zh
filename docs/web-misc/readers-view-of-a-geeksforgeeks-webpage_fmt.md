...
> 原文：[https://www.geeksforgeeks.org/readers-view-of-a-geeksforgeeks-webpage/](https://www.geeksforgeeks.org/readers-view-of-a-geeksforgeeks-webpage/)

## 读者视图
读者视图是一项功能，它删除了网页中所有不必要的东西，如按钮、广告等，并改变了页面的布局，即文本大小、对比度等。为了更好的可读性。
