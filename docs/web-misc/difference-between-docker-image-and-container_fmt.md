...
> 原文: [https://www.geeksforgeeks.org/difference-between-docker-image-and-container/](https://www.geeksforgeeks.org/difference-between-docker-image-and-container/)
...
## 3. Docker 镜像与 Docker 容器的区别

| S.NO | Docker 镜像 | Docker 容器 |
| --- | --- | --- |
| one | 它是容器的蓝图。 | 它是图像的实例。 |
