...
*   **主进程**主进程负责使用`BrowserWindow`实例创建窗口。单个浏览器窗口实例在其呈现器过程中呈现网页。销毁浏览器窗口实例意味着相应的渲染器进程也将终止。
...
**参考文献:**[https://electronjs.org/docs/tutorial/first-app#installing-electron](https://electronjs.org/docs/tutorial/first-app#installing-electron)