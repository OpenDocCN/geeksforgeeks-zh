...
> 原文: [https://www.geeksforgeeks.org/what-is-the-aria-labelledby-attribute/](https://www.geeksforgeeks.org/what-is-the-aria-labelledby-attribute/)
...
Here each element is a field with both labels, the individual labels, and the group labels.
...
In this example, the header element is linked with the group head div, which makes the relation between the group head and the header element.
...
In this example, the radio group of a button is in relation to the container head.
...
In this example relation established between dialog and the header element.
