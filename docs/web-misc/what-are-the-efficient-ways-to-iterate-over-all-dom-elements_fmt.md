...
> 原文: [https://www.geeksforgeeks.org/what-are-the-efficient-ways-to-iterate-over-all-dom-elements/](https://www.geeksforgeeks.org/what-are-the-efficient-ways-to-iterate-over-all-dom-elements/)
...
*   运行一个循环，并通过索引一个接一个地访问它们（例如，第 i 个元素的 `el[i]`）。
