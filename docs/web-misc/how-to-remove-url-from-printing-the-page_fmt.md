...
> 原文：[https://www.geeksforgeeks.org/how-to-remove-url-from-printing-the-page/](https://www.geeksforgeeks.org/how-to-remove-url-from-printing-the-page/)
...
*   **Apple Safari:** 转到菜单中的打印选项，打印对话框出现。取消选中`“Print headers and footers”`选项。
