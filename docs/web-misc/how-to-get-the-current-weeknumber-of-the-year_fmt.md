...
> 原文: [https://www.geeksforgeeks.org/how-to-get-the-current-weeknumber-of-the-year/](https://www.geeksforgeeks.org/how-to-get-the-current-weeknumber-of-the-year/)
...
            document.getElementById("result").innerHTML = "Week Numbers is " + result;
        }
    </script>
</head>
...
    <br>
    <br>
    <button onclick="printWeekNumber()">Get week number</button>
</p>
