...
> 原文: [https://www.geeksforgeeks.org/how-to-watch-service-variables/](https://www.geeksforgeeks.org/how-to-watch-service-variables/)
...
<html>
    ...
    <body>
        <div ng-app="watchApp" ng-controller="watchCtrl">
            Enter Text:<input type="text" ng-model="txtval" />
            <br />
            <br />
...
<div class="container" data-ng-app="app">
    <div class="well" data-ng-controller="FooCtrl">
        ...
        <div class="row">
            <div class="col-sm-6">
                <p><a href="" ng-click="setItems([ { name: 'I am single item' } ])">
                  Send item one </a></p>
                <p><a href="" ng-click="setItems([ { name: 'Item 1 of 2' }, { name: 'Item 2 of 2' } ])">
                  Send item two </a></p>
                <p><a href="" ng-click="setItems([ { name: 'Item 1 of 3' }, { name: 'Item 2 of 3' }, { name: 'Item 3 of 3' } ])">
                  Send item three </a></p>
            </div>
            <div class="col-sm-6">
                <p><a href="" ng-click="setName('Sheldon')">
                  Send name: Geeks</a></p>
                <p><a href="" ng-click="setName('Leonard')">
                  Send name: For</a></p>
                <p><a href="" ng-click="setName('Penny')">
                  Send name: Geeks</a></p>
            </div>
        </div>
    </div>
