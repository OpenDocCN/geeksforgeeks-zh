...
> 原文：[https://www.geeksforgeeks.org/how-to-show-page-loading-div-until-the-page-has-finished-loading/](https://www.geeksforgeeks.org/how-to-show-page-loading-div-until-the-page-has-finished-loading/)
...
### 步骤 1
在文本编辑器中复制并粘贴上面的示例代码，并用`.html`扩展名保存。

### 第二步
打开你保存的`.html`文件，然后打开浏览器的开发者工具，转到网络选项卡，将节流设置为 Slow 3G。这里有一个 GIF 来告诉你怎么做：
