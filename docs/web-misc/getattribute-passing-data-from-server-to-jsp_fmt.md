...
> 原文: [https://www.geeksforgeeks.org/getattribute-passing-data-from-server-to-jsp/](https://www.geeksforgeeks.org/getattribute-passing-data-from-server-to-jsp/)
...
1.  运行 servlet “StudentServlet.java”，将学生数据传递到 JSP 页面 “stdlist.jsp”。
