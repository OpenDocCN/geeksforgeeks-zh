...
> 原文：[https://www.geeksforgeeks.org/how-to-call-the-key-of-an-object-but-returned-as-a-method-not-a-string/](https://www.geeksforgeeks.org/how-to-call-the-key-of-an-object-but-returned-as-a-method-not-a-string/)
...
**示例 2：** 下面的代码是使用 [`Object.entries()`](https://www.geeksforgeeks.org/object-entries-javascript/) 和 [`new Function()`](https://javascript.info/new-function) 实现的。
