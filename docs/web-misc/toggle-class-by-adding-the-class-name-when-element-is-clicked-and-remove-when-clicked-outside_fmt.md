...
> 原文:[https://www . geeksforgeks . org/通过单击元素时添加类名和单击时移除外部来切换类/](https://www.geeksforgeeks.org/toggle-class-by-adding-the-class-name-when-element-is-clicked-and-remove-when-clicked-outside/)
