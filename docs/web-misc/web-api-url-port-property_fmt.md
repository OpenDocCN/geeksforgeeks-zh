...
<body>
    ...
    <script type="text/javascript">
        function get() {
            var url = new URL('https://www.geeksforgeeks.org:123/GeeksforGeeks');

            console.log("port of current URL is :", url.port);
        }
    </script>
</body>
...
<body>
    ...
    <script type="text/javascript">
        function get() {
            ...
            a.innerHTML = "port of current URL is : " + url.port;
        }
    </script>
</body>
