...
> 原文: [https://www.geeksforgeeks.org/whats-the-best-way-to-reload-refresh-an-iframe/](https://www.geeksforgeeks.org/whats-the-best-way-to-reload-refresh-an-iframe/)
...
在 Firefox 中，如果你要使用 `window.frames[]`，它可能不会被 id 索引。所以你必须通过索引或名字来索引它。
