...
> 原文: [https://www.geeksforgeeks.org/difference-between-textcontent-and-innertext/](https://www.geeksforgeeks.org/difference-between-textcontent-and-innertext/)

**1. [`textContent`](https://www.geeksforgeeks.org/html-dom-textcontent-property/)**
此属性用于设置或返回所选节点及其所有后代的文本值。设置 `textContent` 属性时，将删除所有子节点。它被包含指定字符串的单个文本节点替换。
...
**`innerText` 和 `textContent` 之间的其他差异:**

| Sl 号 | `innerText` | `textContent` |
| :--- | :--- | :--- |
