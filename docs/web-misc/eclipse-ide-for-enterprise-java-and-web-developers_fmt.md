...
> 原文：[https://www.geeksforgeeks.org/eclipse-ide-for-enterprise-java-and-web-developers/](https://www.geeksforgeeks.org/eclipse-ide-for-enterprise-java-and-web-developers/)
...
2.  安装 Eclipse 集成开发环境。
3.  打开下载的文件，从弹出的窗口中选择“面向企业 Java 和网络开发人员的 Eclipse IDE”。
...
要在您的工作空间中运行 Eclipse，您首先需要下载并安装 JDK（Java 开发工具包）。打开你的默认浏览器，搜索“JDK 下载”，点击 oracle.com 链接。甲骨文为您提供最新版本的 JDK。您可以根据需要的配置从这里下载。请参考本文[如何为 64 位机器下载并安装 Java](https://www.geeksforgeeks.org/how-to-download-and-install-java-for-64-bit-machine/)，并在您的系统中安装 JDK。

### 步骤 2：安装 Eclipse IDE

在你的工作区安装完 JDK 之后，我们可以通过[下载 Eclipse IDE](https://www.eclipse.org/downloads/) 来安装 Eclipse IDE。

![](img/79305706d3953271433812e2805e0756.png)

### 步骤 3：选择安装包

下载完成后，打开下载的文件，从屏幕上打开的弹出窗口中选择 `RUN`。现在从下面的页面选择第二个选项“面向企业 Java 和网络开发人员的 Eclipse IDE”。

![](img/5233cde668e47013eb056ebc1f6eb1bf.png)

### 步骤 4：开始安装

点击此处后，将出现以下屏幕。现在点击 `INSTALL` 按钮。通过接受协议，您可以完成安装。完成安装需要一些时间。

![](img/274f11f2cac45e8da2f711f4d13d2288.png)

### 步骤 5：完成安装

安装成功后点击 `LAUNCH` 按钮，如下图。
