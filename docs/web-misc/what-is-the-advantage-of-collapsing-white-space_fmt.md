...
> 原文：[https://www.geeksforgeeks.org/what-is-the-advantage-of-collapsing-white-space/](https://www.geeksforgeeks.org/what-is-the-advantage-of-collapsing-white-space/)
...
以下示例显示了折叠空白的基本示例。`h1` 标签在短形式和完整形式之间包含大量空间。如果您在浏览器中运行此代码，您将看到以下输出。两者之间的所有空白都被转换成了一个单独的空白。
...
以下示例将代码中类型为结构的整数 2d 数组显示为每行位于不同的行中。如果您将看到输出，它将与所有折叠的空白在一行。
