...
> 原文：[https://www.geeksforgeeks.org/how-to-create-an-email-newsletter/](https://www.geeksforgeeks.org/how-to-create-an-email-newsletter/)
...
上一节我们已经创建了基本形态的结构。在这一节中，我们将使用 CSS 样式设计电子邮件简讯的结构。
...
这个例子结合了上面两个部分（HTML 和 CSS 代码）来制作一个 Email 简讯。
