...
*   [`XMLHttpRequest`](https://www.geeksforgeeks.org/xmlhttprequest-in-javascript/) 对象: 为了从网络服务器请求数据，ajax 使用了一个内置的 [`XMLHttpRequest`](https://www.geeksforgeeks.org/xmlhttprequest-in-javascript/) 对象。
*   [`JavaScript`](https://www.geeksforgeeks.org/javascript-tutorial/) 和 [`HTML DOM`](https://www.geeksforgeeks.org/html-dom-html-object/): 为了显示或使用数据，ajax 使用 [`JavaScript`](https://www.geeksforgeeks.org/javascript-tutorial/) 和 [`HTML DOM`](https://www.geeksforgeeks.org/html-dom-html-object/) 。
...
*   **1996:** IE 推出的 [`iframe`](https://www.geeksforgeeks.org/html-iframes/) 标签；像 object 元素一样，它可以异步加载或获取内容。
*   **1998 年:** 微软 outlook web access 团队开发了 [`XMLHttpRequest`](https://www.geeksforgeeks.org/xmlhttprequest-in-javascript/) 脚本对象背后的概念。
*   **2000:** 后台 [`HTTP 请求`](https://www.geeksforgeeks.org/http-request-methods/) 和异步 web 技术的效用一直相当模糊，直到它开始出现在 Outlook Web Access 等大规模在线应用程序中。
