...
> 原文：[https://www.geeksforgeeks.org/java-servlet-and-jdbc-example-insert-data-in-mysql/](https://www.geeksforgeeks.org/java-servlet-and-jdbc-example-insert-data-in-mysql/)

## 先决条件
[Servlet](https://www.geeksforgeeks.org/introduction-java-servlets/)， [JDBC 连接](https://www.geeksforgeeks.org/establishing-jdbc-connection-in-java/)
...
创建一个 HTML 文件中的表单，获取所有需要插入数据库的输入。在其中指定 Servlet 名称，并使用 `POST` 方法，因为安全性是数据库连接的重要方面。
