...
> 原文：[https://www.geeksforgeeks.org/new-google-site-navigation-bar/](https://www.geeksforgeeks.org/new-google-site-navigation-bar/)
...
导航没有加载很多属性，原因是它们必须保持布局的响应性。

1.  `模式`：导航栏有两种显示方式，即`顶部`和`侧面`。
2.  `颜色`：有`透明`、`白色`、`黑色`三种颜色可选。
