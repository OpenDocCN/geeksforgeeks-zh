...
> 原文：[https://www.geeksforgeeks.org/how-to-add-brand-image-in-new-google-sites/](https://www.geeksforgeeks.org/how-to-add-brand-image-in-new-google-sites/)
...
现在我们要通过点击`上传按钮`上传 `logo` 和 `favicon`。您也可以通过点击`选择按钮`从网上选择。
