...
> 原文：[https://www.geeksforgeeks.org/how-to-embed-tables-in-new-google-sites/](https://www.geeksforgeeks.org/how-to-embed-tables-in-new-google-sites/)

![](img/f0cc3d82f889693de178f574498200f6.png)

有时，我们必须以系统的方式显示一些数据，为此我们使用表格。要将表格嵌入谷歌网站，请执行以下步骤：

从`插入`面板中选择`嵌入`选项，然后转到出现的对话框的`嵌入代码`部分。
