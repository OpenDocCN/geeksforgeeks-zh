...
> 原文:[https://www.geeksforgeeks.org/which-tag-is-used-to-find-the-version-of-xml-and-syntax/](https://www.geeksforgeeks.org/which-tag-is-used-to-find-the-version-of-xml-and-syntax/)
...
[DOM(文档对象模型)](https://www.geeksforgeeks.org/dom-document-object-model/)表示一个完整的 HTML 或 XML 文档，作为文档树的根。它有许多属性，如 `xmlVersion`、`encoding` 等。

## XML 版本

作为 XML 声明的一部分，指定此文档版本号的属性。如果没有声明，并且该文档支持“XML”特性，则该值为“1.0”。
...
*   `version="1.0"` 是当前使用的 XML 版本。有各种版本的 XML 可供使用。
...
*   [https://www.geeksforgeeks.org/how-to-parse-and-process-html-xml-using-php/](https://www.geeksforgeeks.org/how-to-parse-and-process-html-xml-using-php/)