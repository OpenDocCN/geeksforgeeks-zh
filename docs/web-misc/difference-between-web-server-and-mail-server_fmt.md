...
> 原文：[https://www.geeksforgeeks.org/difference-between-web-server-and-mail-server/](https://www.geeksforgeeks.org/difference-between-web-server-and-mail-server/)
...
例子：雅虎！、`Gmail` 传入邮件服务器、`Gmail` 传出邮件服务器等。
