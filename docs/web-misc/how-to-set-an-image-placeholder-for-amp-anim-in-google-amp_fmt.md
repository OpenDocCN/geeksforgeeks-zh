...
> 原文：[https://www.geeksforgeeks.org/how-to-set-an-image-placeholder-for-amp-anim-in-google-amp/](https://www.geeksforgeeks.org/how-to-set-an-image-placeholder-for-amp-anim-in-google-amp/)

![](img/911091c569b094b6e54a226311a9df7b.png)

如果你想在你的 AMP 网页上嵌入一个动画，那么你可以使用 `amp-anim` 这个标签。它帮助开发者在网络平台中嵌入动画、GIF、WebP 等。这真的是一个非常有用的标签，因为在网站上有动画真的使它看起来更生动和好看。

## 设置

要在你的 AMP 网页中使用 `amp-anim`，你必须导入这个脚本。
