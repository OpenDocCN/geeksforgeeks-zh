...
> 原文: [https://www.geeksforgeeks.org/how-to-get-an-element-by-its-href-attribute/](https://www.geeksforgeeks.org/how-to-get-an-element-by-its-href-attribute/)

任务是通过 **href 属性**选择元素。

*   使用 JQuery 选择器 `$('a[href = link_to_site]')`。
...
*   使用 JQuery 选择器 `$('a[href *= part_of_link]')`。如果属性的任何部分与值匹配，它将选择元素。
