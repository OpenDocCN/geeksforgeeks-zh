        ...
        <div class="ui medium image">
            <div class="ui dimmer">
                <div class="content">
                    ...
                    <a href="https://geeksforgeeks.org" class="ui primary button">
                        Go on site
                    </a>
                    <div class="ui button">View</div>
                </div>
            </div>
            <img class="ui image" src="https://media.geeksforgeeks.org/wp-content/uploads/20200511124031/image30.png">
        </div>
    </div>
    <script>
        $('.image').dimmer({
