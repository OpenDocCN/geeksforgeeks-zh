...
*   打开 `Docker` 应用程序。
*   点击 **设置 -> `Kubernetes` -> 启用 `Kubernetes`**

![](img/76921e1b8c6d61287aed28e5abafc5c6.png)

### 步骤 3:为 `Kubernetes` 添加 `Helm` 包:
...
*   首先，确保您使用的是管理外壳。
*   在您的命令上运行 `Set-ExecutionPolicy Bypass -Scope Process` 来检查执行策略
...
*   现在从巧克力安装 `Helm`，转到**命令外壳**或更常见的**动力外壳**并键入:

```html
choco install kubernetes-helm
```

![](img/b057f628eb388f042bfdb068564716f2.png)

`Windows PowerShell` 运行 `choco install kubernetes-helm`
