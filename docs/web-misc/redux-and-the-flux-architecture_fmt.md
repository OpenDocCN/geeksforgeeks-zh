...
> 原文: [https://www.geeksforgeeks.org/redux-and-the-flux-architecture/](https://www.geeksforgeeks.org/redux-and-the-flux-architecture/)
...
sample_store.dispatch({ type: 'INCR' }) //Output:1
sample_store.dispatch({ type: 'INCR' }) //Output:2
sample_store.dispatch({ type: 'DECR' }) //Output:1
```