...
> 原文：[https://www.geeksforgeeks.org/how-to-auto-suggest-rich-contents-while-searching-in-google-amp/](https://www.geeksforgeeks.org/how-to-auto-suggest-rich-contents-while-searching-in-google-amp/)
...
为了使用 `amp-autocomplete` 建议丰富的内容，我们将数据传递到如下所示的 `items` 中的 `JsonObject` 数组中。
...
```html
    ...
    <body>
        `<form class="sample-form"`
              method="post"
              `action-xhr="https://amp.dev/documentation/examples/api/echo"` target="_top">
            `<label>`
