...
> 原文：[https://www.geeksforgeeks.org/what-is-the-use-of-mixins-in-less/](https://www.geeksforgeeks.org/what-is-the-use-of-mixins-in-less/)
...
从上面的代码示例中，我们已经调用了在`btn1`、`btn2`和`btn3`类中声明的`.button_basic` mixins。编译上述代码后，它将生成以下本机 CSS 代码。
...
重要关键词：我们可以用`!important`关键字在 mixin 旁边，使整个 mixin 变得“重要”。
...
参考：[https://lesscss.org/features/#mixins-feature](https://lesscss.org/features/#mixins-feature)