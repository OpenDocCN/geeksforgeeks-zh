...
> 原文：[https://www.geeksforgeeks.org/how-to-fix-a-401-unauthorized-error/](https://www.geeksforgeeks.org/how-to-fix-a-401-unauthorized-error/)
...
*   **刷新域名系统：** 域名系统中的错误有时也会导致 401 错误状态。因此，清除域名系统也将纠正这一错误。在 Windows 中，可以通过在命令提示符下键入 `ipconfig/flushdns` 并点击回车键来刷新 DNS。
