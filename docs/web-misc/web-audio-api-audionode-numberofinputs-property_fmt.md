...
> 原文: [https://www.geeksforgeeks.org/web-audio-api-audionode-numberofinputs-property/](https://www.geeksforgeeks.org/web-audio-api-audionode-numberofinputs-property/)

## 属性介绍

`AudioNode.numberOfInputs` 属性用于返回输入节点的输入数量。源节点用于定义包含值为零的 `numberOfInputs` 属性的节点。
...
下面列出了 `AudioNode.numberOfInputs` 属性支持的浏览器：
