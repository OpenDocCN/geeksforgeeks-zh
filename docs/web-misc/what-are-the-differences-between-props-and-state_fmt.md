...
> 原文：[https://www.geeksforgeeks.org/what-are-the-differences-between-props-and-state/](https://www.geeksforgeeks.org/what-are-the-differences-between-props-and-state/)
...
[道具](https://www.geeksforgeeks.org/reactjs-props-set-1/)被称为属性，它可以用来将数据从一个组件传递到另一个组件。道具不能修改、只读和不可变。
...
下面将是我们执行上述命令时的输出。使用“道具”功能，数据将从父组件即`App.js`传递到子组件即`Fruit.js`。

![](img/2364c0d2103e9e733f8fc0dfe4c2eded.png)

## 状态

[状态](https://www.geeksforgeeks.org/reactjs-state-react/)表示应用程序中可以更改的部分。每个组件都可以有自己的状态。状态是可变的，并且它只对组件是本地的。
