...
> 原文: [https://www.geeksforgeeks.org/design-a-form-component-which-takes-input-from-its-user-and-displays-a-form/](https://www.geeksforgeeks.org/design-a-form-component-which-takes-input-from-its-user-and-displays-a-form/)
...
在这里，`Event`类是基本的发布/订阅实现，其中每个模块都可以对事件做出反应。这是事件类
