...
> 原文: [https://www.geeksforgeeks.org/how-to-implement-postgresql-database-in-rails-application/](https://www.geeksforgeeks.org/how-to-implement-postgresql-database-in-rails-application/)
...
因此，要在 rails 应用程序中添加 PostgreSQL 数据库，我们必须在我们的项目中添加 `pg` gem 文件，并从 `gemfile` 中删除 `gem "sqlite3", "~>1.4"`。
