...
> 原文: [https://www.geeksforgeeks.org/how-to-align-item-baseline-of-the-container/](https://www.geeksforgeeks.org/how-to-align-item-baseline-of-the-container/)

在本文中，我们将学习如何将项目与容器的基线对齐。CSS 中有三种类型的对齐方式：基线对齐、位置对齐和分布式对齐。基线对齐用于跨一组对齐主题对齐框的基线。它们可以用作与 `align-content` 的内容对齐值，也可以用作与 `align-self` 的自对齐值。

![](img/7dbf63b0e6b1ac590b13613717e59a7e.png)

## 语法

有三个关键词可以用来设置容器中项目的基线对齐，如下语法所示。
