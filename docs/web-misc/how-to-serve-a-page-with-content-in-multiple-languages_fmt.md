...
> 原文：[https://www.geeksforgeeks.org/how-to-serve-a-page-with-content-in-multiple-languages/](https://www.geeksforgeeks.org/how-to-serve-a-page-with-content-in-multiple-languages/)
...
要更改语言，只需简单设置 `lang` 属性即可。我们可以在文档的任何地方定义它，例如在正文、段落、标题或 `span` 标签中。但最好的做法是在 `span` 标签中设置 `lang`。
...
为了完成这项任务，我们有两种方法来达到同样的结果。首先，我们遵循下面的方法，其中 HTML `lang` 属性设置为英语或法语或任何合适的语言。第二种方法，我们将使用谷歌翻译 API 并将该 API 添加到我们的 HTML 代码中。让我们从第一种方法开始讨论。
