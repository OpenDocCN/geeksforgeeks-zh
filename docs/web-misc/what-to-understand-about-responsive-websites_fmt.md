...
> 原文：[https://www.geeksforgeeks.org/what-to-understand-about-responsive-websites/](https://www.geeksforgeeks.org/what-to-understand-about-responsive-websites/)
...
## GeeksforGeeks 网站是一个响应性网站的很好的例子
...
**1. 第一步是在代码的 `<head>` 标签中包含以下元标签。**

```html
<meta name="viewport" content="width=device-width, initial-scale=1.0">
```

这将设置 `viewport`，根据设备的屏幕宽度调整内容，并将在浏览器中以初始缩放级别加载页面。
...
**2. 使文本大小具有响应性：** 响应性文本大小是根据浏览器大小而变化的大小，即宽度增加时放大，宽度减小时缩小。可以使用视口宽度属性（即 `vw` 单元）对文本进行响应。
