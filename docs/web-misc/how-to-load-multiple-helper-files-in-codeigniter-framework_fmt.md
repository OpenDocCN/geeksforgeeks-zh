...
> 原文：[https://www.geeksforgeeks.org/how-to-load-multiple-helper-files-in-codeigniter-framework/](https://www.geeksforgeeks.org/how-to-load-multiple-helper-files-in-codeigniter-framework/)
...
为了在 PHP 工作环境中加载多个助手文件，我们可以在数组中将它们指定为组件，其中每个组件对应一个助手名称。
...
![img](img/8960342b3a5a04bac9eb5c866d870beb.png)

## 方法 2（在自动加载文件中）

在执行系统初始化时，可以在环境中自动加载助手。当指定在`application/config/autoload.php`文件中定义的自动加载数组时，可以通过添加助手将助手添加到环境中。
...
![img](img/3e02f65f02fa302152bf8a4ce24c28e8.png)