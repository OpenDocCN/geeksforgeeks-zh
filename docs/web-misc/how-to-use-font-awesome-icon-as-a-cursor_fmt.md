...
> 原文: [https://www.geeksforgeeks.org/how-to-use-font-awesome-icon-as-a-cursor/](https://www.geeksforgeeks.org/how-to-use-font-awesome-icon-as-a-cursor/)

让一个简单的光标看起来像汽车、饮料、表情符号或任何其他形状或符号看起来很迷人。我们实际上可以将光标更改为网页上任何字体的牛逼图标。为了给光标添加任何字体棒的图标，我们需要在标题部分添加字体棒的 CDN。

有一个 CSS `cursor` 属性可以改变光标的类型。它还允许在光标属性中添加图像。
...
字体牛逼图标的所有 Unicode 都可以在 [https://fontawesome.com/cheatsheet](https://fontawesome.com/cheatsheet) 找到

`font awesome cdn link:` [https://maxcdn.bootstrapcdn.com/font-awesome/4.5.0/css/font-awesome.min.css](https://maxcdn.bootstrapcdn.com/font-awesome/4.5.0/css/font-awesome.min.css)