...
> 原文：[https://www.geeksforgeeks.org/cakephp-framework-installation-and-configuration/](https://www.geeksforgeeks.org/cakephp-framework-installation-and-configuration/)
...
4.  现在输入命令。
    ...
    ![](img/3383224a6cbb03fa12d17540f5461269.png)
    ![](img/66b4c9600834c0284cc571796a36196a.png)
    ![](img/c73db0f9574afa77f59783520d87faae.png)
5.  打开 `xampp` 控制面板，运行 `apache` 服务器。
6.  现在打开一个网页浏览器，转到 `URL`：`http://localhost:80/project_name/app_name/`
    可以看到我们的第一个 `app` 在服务器上成功运行。
    ![](img/cdd170586a04c869e00c5e1d3f59e69b.png)
