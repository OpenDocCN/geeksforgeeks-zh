...
> 原文：[https://www.geeksforgeeks.org/what-are-templates-on-wordpress/](https://www.geeksforgeeks.org/what-are-templates-on-wordpress/)
...
模板是预先制作的文件，它将定义你的网站的外观、`WordPress` 网站的结构和帖子。模板给你的网站设计。
...
模板文件从 `WordPress` 数据库即 `MySQL` 中抽取信息，通过 `HTML` 代码生成网站的前端，并将所有信息发送到网页浏览器。网络浏览器向用户显示网站，这就是模板在 `WordPress` 中的工作方式。
...
3.  创建页面后，您必须通过点击添加新插件来添加插件名称**“Elementor”**。然后点击激活插件。
    ![](img/e750b15c97c7f2cf65265577da4b136f.png)

4.  添加“Elementor”插件后，转到您创建的页面，然后点击“用 Elementor 编辑”。然后单击文件夹图标添加模板。
