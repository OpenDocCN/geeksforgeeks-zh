...
> 原文: [https://www.geeksforgeeks.org/intermediate-fields-in-django-python/](https://www.geeksforgeeks.org/intermediate-fields-in-django-python/)

先决条件: [Django 模型](https://www.geeksforgeeks.org/django-models-set-1/)、[Django 中的关系字段](https://www.geeksforgeeks.org/python-relational-fields-in-django-models/)
