...
> 原文：[https://www.geeksforgeeks.org/what-is-the-max-size-of-localstorage-values/](https://www.geeksforgeeks.org/what-is-the-max-size-of-localstorage-values/)
...
这段 JavaScript 代码将通过添加不断增加长度的字符串来运行，直到浏览器引擎抛出异常。此后，它将清除测试数据，并在本地存储中设置一个 `size` 键，以千字节（KBs）为单位存储本地存储的大小。

## 参考：
[https://www.geeksforgeeks.org/html-dom-storage-setitem-method/](https://www.geeksforgeeks.org/html-dom-storage-setitem-method/)