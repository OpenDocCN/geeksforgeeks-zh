...
安装完套装后，我们可以在 app 中轻松添加评级。对于这个例子，我们将在我们的主页上添加星级。
...
**解释:**首先在上面的例子中，我们从已安装的包中导入我们的 `ReactStars` 组件。之后，我们使用组件并设置 `count`、`size` 和 `color2`。然后我们将展示星级评定。
...
![](img/a0ba68bd57e9253a61b30b57bb635459.png)