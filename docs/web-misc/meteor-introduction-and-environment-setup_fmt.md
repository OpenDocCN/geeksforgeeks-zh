...
> 原文: [https://www.geeksforgeeks.org/meteor-introduction-and-environment-setup/](https://www.geeksforgeeks.org/meteor-introduction-and-environment-setup/)
...
首先，我们需要安装`Meteor`到我们的操作系统中。要运行任何 Meteor 应用程序，我们必须在电脑上安装`NodeJS`。`NodeJS`是 Meteor 开发所需的平台。
...
我们需要[下载](https://www.meteor.com/developers/install)官方 Meteor 安装程序。在安装过程中，如果出现任何错误，请尝试以管理员身份运行安装程序包。安装完 Meteor 后，您需要检查每个软件包是否安装正确，为此，您需要在命令提示符窗口中运行以下命令。

```
C:\Users\..>meteor
```

您将获得以下输出，这意味着 Meteor 包已成功安装在您各自的系统上。

![](img/ced2326c6dc700d87bb9383b8ba0be73.png)

### 步骤 2

现在您只需要在您想要的位置使用以下命令创建一个项目目录。
