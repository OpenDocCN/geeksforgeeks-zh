...
> 原文：[https://www.geeksforgeeks.org/difference-between-native-apps-and-web-apps/](https://www.geeksforgeeks.org/difference-between-native-apps-and-web-apps/)

## 原生应用程序

原生应用程序安装在设备本身上，专门为特定的移动操作系统开发。这些应用可以在苹果应用商店、谷歌 Play 商店等应用商店上找到。
...
网络应用程序可以通过移动设备的网络浏览器访问，网络应用程序基于支持互联网的应用程序。为了访问，我们不需要下载应用程序并安装到移动设备上。
...
设计相似，采用相同的配色方案和字体，但本质上这是两款不同的产品。

| 【原生 Apps】 | Web Apps |
| --- | --- |
| 移动应用都是针对特定平台开发的，比如 `iOS` 针对的是苹果 `iPhone` 或者安卓。它们通过应用商店（如谷歌 Play 商店和苹果商店）下载和安装，并可以访问系统资源，如 `GPS` 和设备的摄像头。 | 另一方面，网络应用程序通过互联网浏览器访问，并将根据您在 Web 上查看的设备运行。Web 应用并非特定系统的原生应用，无需下载或安装。 |
