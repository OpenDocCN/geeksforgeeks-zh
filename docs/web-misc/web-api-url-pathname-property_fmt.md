...
> 原文: [https://www.geeksforgeeks.org/web-api-url-pathname-property/](https://www.geeksforgeeks.org/web-api-url-pathname-property/)
...
这个属性返回一个包含 URL 路径名的 USVString。

## 注意

如果这里的 `t` 没有为 URL 设置路径，那么它只会返回 `/`。
...
<body>
    ...
    <script type="text/javascript">
        function get() {
            ...
            console.log("pathname of current URL is :", url.pathname);
        }
    </script>
</body>
...
<body>
    ...
    <script type="text/javascript">
        function get() {
            ...
            a.innerHTML = "pathname of current URL is : " + url.pathname;
        }
    </script>
</body>
