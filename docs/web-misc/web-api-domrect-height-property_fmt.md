# 网页 API | DOMRect height 属性

> 原文: [https://www.geeksforgeeks.org/web-api-domrect-height-property/](https://www.geeksforgeeks.org/web-api-domrect-height-property/)
...
<body>
    <center>
        ...
        <button onclick="getDOMRect();">Get height</button>
        <p id='DOMRect'></p>
    </center>
</body>
<script type="text/javascript">
    function getDOMRect() {
        ...
        document.getElementById('DOMRect').innerHTML = recheight;
    }
</script>
</html>
```
