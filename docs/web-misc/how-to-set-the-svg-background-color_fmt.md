...
> 原文: [https://www.geeksforgeeks.org/how-to-set-the-svg-background-color/](https://www.geeksforgeeks.org/how-to-set-the-svg-background-color/)
...
`SVG` 代表可缩放矢量图形。SVG 背景用于绘制任何类型的形状，通过 `set` 属性设置您想要的任何颜色。下面的例子更具体地说明了 SVG 设置背景色的概念。SVG 允许 CSS 的 `background-size`、`background-position` 和更复杂的属性。
