...
*   `is-size-1`: 这个类的大小是预定义的，是 3rem 的字号。
*   `is-size-2`: 这个类的大小是预定义的，字体大小为 2.5 雷姆。
*   `is-size-3`: 这个类的大小是预定义的，字体大小为 2 雷姆。
*   `is-size-4`: 这个类的大小是预定义的，字体大小为 1.5 雷姆。
*   `is-size-5`: 这个类的大小是预定义的，字体大小为 1.25 雷姆。
*   `is-size-6`: 这个类的大小是预定义的，字体大小为 1.0rem。
*   `is-size-7`: 这个类的大小是预定义的，字体大小为 0.75 雷姆。
