...
> 原文：[https://www.geeksforgeeks.org/what-is-the-difference-between-offsetheight-and-clientheight/](https://www.geeksforgeeks.org/what-is-the-difference-between-offsetheight-and-clientheight/)

## offsetHeight

`offsetHeight` 是帮助以像素为单位测量元素可见高度的属性，包括元素可见内容、垂直填充、边框和滚动条等 CSS 属性，但不包括上下边距。
...
`clientHeight` 是帮助以像素为单位测量元素内部高度的属性，包括像填充这样的 CSS 属性，但不包括水平滚动条高度、边框或边距。
