# Web API：DOMRect 的 fromRect 属性

> 原文：[https://www.geeksforgeeks.org/web-api-domrect-fromrect-property/](https://www.geeksforgeeks.org/web-api-domrect-fromrect-property/)

在网络应用编程接口中，有一个多矩形接口，它有一个属性 `fromRect()` 用于创建一个多矩形只读对象，该对象有给定的位置和尺寸。
