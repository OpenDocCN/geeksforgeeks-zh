...
## 目的
这款应用程序的目的是帮助印度的公立学校，这样即使是最贫穷的人也能得到高质量的教育。

## 实施
我们的想法主要是通过提供众包平台来改善公立学校的现状。 来自这些官立学校的外来者、教师或校长都可以利用我们的平台分享他们的困难和需求。 愿意提供帮助的人可以捐款(直接进入政府学校的银行账户)，也可以通过提供书写板、书桌、长凳等直接帮助学生。
...
## 构建项目所需的技能集
1.  `React Native` for Android 应用程序开发
2.  UI 和 UX 设计
3.  后端开发
4.  数据库设计、开发和管理
