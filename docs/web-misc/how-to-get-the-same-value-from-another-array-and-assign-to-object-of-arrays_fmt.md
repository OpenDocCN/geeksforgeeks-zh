...
> 原文：[https://www.geeksforgeeks.org/how-to-get-the-same-value-from-another-array-and-assign-to-object-of-arrays/](https://www.geeksforgeeks.org/how-to-get-the-same-value-from-another-array-and-assign-to-object-of-arrays/)
...
- [数组 `push()` 方法](https://www.geeksforgeeks.org/javascript-array-push-method/)
- [数组 `includes()` 方法](https://www.geeksforgeeks.org/javascript-array-includes-method/)
- [数组 `filter()` 方法](https://www.geeksforgeeks.org/es6-array-filter-method/)
- [ES6 箭头功能](https://www.geeksforgeeks.org/arrow-functions-in-javascript/)

`方法 1:` 使用 `forEach()` 和 `push()`，包括数组的 `includes()` 方法。
...
`方法 2:` 使用 `filter()`，`push()` 并包含数组的 `includes()`。
