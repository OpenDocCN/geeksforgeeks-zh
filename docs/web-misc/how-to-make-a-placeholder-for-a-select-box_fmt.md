...
> 原文：[https://www.geeksforgeeks.org/how-to-make-a-placeholder-for-a-select-box/](https://www.geeksforgeeks.org/how-to-make-a-placeholder-for-a-select-box/)

`<select>`标签中没有`placeholder`属性，但它可以成为“选择”框的占位符。有许多方法可以为“选择”框创建占位符。
