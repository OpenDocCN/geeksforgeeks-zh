# Web API: TextDecoder.decode()方法

> 原文: [https://www.geeksforgeeks.org/web-api-textdecoder-decode-method/](https://www.geeksforgeeks.org/web-api-textdecoder-decode-method/)
