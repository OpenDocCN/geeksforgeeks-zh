...
> 原文：[https://www.geeksforgeeks.org/how-to-initialize-a-dialog-without-a-title-bar/](https://www.geeksforgeeks.org/how-to-initialize-a-dialog-without-a-title-bar/)
...
*   下一步是使用对话框和 [`click()`](https://www.geeksforgeeks.org/jquery-click-with-examples/) 方法，每当我们单击按钮时都会创建一个对话框。
