...
> 原文：[https://www.geeksforgeeks.org/web-window-api-dom-window-fullscreen-property/](https://www.geeksforgeeks.org/web-window-api-dom-window-fullscreen-property/)

`窗口`接口有一个`全屏`属性，告知窗口是否以全屏模式显示。
