...
> 原文: [https://www.geeksforgeeks.org/how-to-create-a-less-file-and-how-to-compile-it/](https://www.geeksforgeeks.org/how-to-create-a-less-file-and-how-to-compile-it/)
...
### 第一步
转到你的项目文件夹，创建一个名为 `less` 的子文件夹，然后在里面创建一个名为 `styles.less` 的文件。
...
### 第五步
现在，你可以把这个 CSS 文件链接到你的 HTML 文件了。
