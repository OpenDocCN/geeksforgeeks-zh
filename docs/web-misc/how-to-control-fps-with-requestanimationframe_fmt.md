...
> 原文: [https://www.geeksforgeeks.org/how-to-control-fps-with-requestanimationframe/](https://www.geeksforgeeks.org/how-to-control-fps-with-requestanimationframe/)
...
<h2>Testing approach 1: Results should be approximately 5 fps</h2>
...
### 2. 一种更优化的方法
大多数浏览器无法优化 `setTimeout()` 函数，因此为了优化控制 fps 的过程，可以使用简单的计算。这可以通过跟踪帧上次更新的时间来轻松完成。如果时间的变化 (`当前时间 — 上次时间`) 超过了更新间隔，则更新帧/屏幕。
...
*   FPS is 4.99, after 8.61 seconds have elapsed:
