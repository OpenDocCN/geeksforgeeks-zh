...
> 原文：[https://www.geeksforgeeks.org/django-react-full-stack-development-setup-using-dact/](https://www.geeksforgeeks.org/django-react-full-stack-development-setup-using-dact/)
...
`npx create-react-app` 命令使我们能够在不考虑所有巴别塔、网络包等的情况下处理 react。当我们试图在 Django 应用程序中使用 `npx create-react-app` 时，它就成了一个问题。因此，在本文中，我们将使用 Python 命令行界面应用程序或包 - [Dact](https://pypi.org/project/dact/)。`Dact` 使我们能够在一个**命令**中设置一个反应-姜戈开发设置。它是开源的，其代码可在 **GitHub** 上获得。
