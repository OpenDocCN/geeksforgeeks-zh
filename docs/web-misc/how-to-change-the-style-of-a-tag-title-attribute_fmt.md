...
> 原文: [https://www.geeksforgeeks.org/how-to-change-the-style-of-a-tag-title-attribute/](https://www.geeksforgeeks.org/how-to-change-the-style-of-a-tag-title-attribute/)

## 概述

选项是根据需要使用 CSS 属性制作一个假的工具提示。为此，必须使用 `data-title` 属性。[数据-*属性](https://www.geeksforgeeks.org/html-data-attributes/)方法用于存储页面或应用程序私有的自定义数据。CSS 可以使用各种方式来访问它们。

### 示例 1

此示例使工具提示变大，并具有不同的背景颜色。
...
以下示例使用一些更好的 CSS 属性，使工具提示的样式比上一个更好。
