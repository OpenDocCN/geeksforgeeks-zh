...
> 原文:[https://www.geeksforgeeks.org/django-introduction-set-2-creating-a-project/](https://www.geeksforgeeks.org/django-introduction-set-2-creating-a-project/)
...
在 `geeks_site` 文件夹(项目文件夹)里面会有以下文件-

### manage.py

该文件用于通过命令行与您的项目进行交互(启动服务器、同步数据库等)。要获取可由 `manage` 执行的命令的完整列表，请在命令窗口中键入以下代码–
