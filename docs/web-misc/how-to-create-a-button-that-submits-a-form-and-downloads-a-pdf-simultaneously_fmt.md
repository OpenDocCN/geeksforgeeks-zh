...
> 原文: [https://www.geeksforgeeks.org/how-to-create-a-button-that-submits-a-form-and-downloads-a-pdf-simultaneously/](https://www.geeksforgeeks.org/how-to-create-a-button-that-submits-a-form-and-downloads-a-pdf-simultaneously/)
...
*   使用 `createElement` 属性创建一个锚标记，并为其分配 `href` 和 `download` 属性。
*   之后，我们只需使用 `onclick` 属性，在单击下载按钮时调用提交按钮单击事件。
...
比较简单的方法可以是点击提交-表单按钮禁用提交，调用先下载 PDF 再提交表单的函数手动提交。
