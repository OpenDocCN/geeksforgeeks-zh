...
> 原文: [https://www.geeksforgeeks.org/how-to-add-app-to-home-screen-progressive-web-apps/](https://www.geeksforgeeks.org/how-to-add-app-to-home-screen-progressive-web-apps/)

`Web App Manifest` 是一个简单的 `JSON` 文件，它告诉浏览器你的 `Web` 应用程序，以及当它‘安装’在用户的移动设备或桌面上时应该如何表现。

我们需要添加一个清单的链接，以便将网络应用程序添加到主屏幕。在你的代码的 `HTML` 头部写入。
