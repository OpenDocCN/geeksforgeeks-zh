...
> 原文: [https://www.geeksforgeeks.org/how-to-install-seaborn-on-windows/](https://www.geeksforgeeks.org/how-to-install-seaborn-on-windows/)
...
PIP 用户可以打开命令提示符，运行以下命令在 Windows 上安装 Python `Seaborn` 包:
