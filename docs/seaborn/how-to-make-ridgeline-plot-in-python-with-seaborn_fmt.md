...
> 原文:[https://www.geeksforgeeks.org/how-to-make-ridgeline-plot-in-python-with-seaborn/](https://www.geeksforgeeks.org/how-to-make-ridgeline-plot-in-python-with-seaborn/)
...
> **语法:** `seaborn.FacetGrid(data, row, col, hue, palette, aspect, height)`
>
> **参数:**
>
...
*   使用 [`map()`](https://seaborn.pydata.org/generated/seaborn.FacetGrid.map.html) 方法在网格的每个元素中创建密度图。在这个例子中，我们需要一个密度图，所以使用在 `Seaborn` 中可用的 [`kdeplot()`](https://datavizpyr.com/ridgeline-plot-in-python-with-seaborn/#:~:text=The%20way%20to%20make%20ridgeline,a%20empty%20grid%20for%20us.) 方法。
