...
> 原文: [https://www.geeksforgeeks.org/seaborn-heatmap-a-comprehensive-guide/](https://www.geeksforgeeks.org/seaborn-heatmap-a-comprehensive-guide/)
...
> 语法: `seaborn.heatmap(*data*, *, vmin=None, vmax=None, cmap=None, center=None, annot_kws=None, linewidths=0, linecolor='white', ...)`
>
> **重要参数:**
>
> - `data`: 可以强制到数组中的 2D 数据集。
...
在此，我们将查看 `cmap` 参数。Matplotlib 为我们提供了多种颜色的地图，你可以在这里查看所有的[链接](https://matplotlib.org/3.1.0/tutorials/colors/colormaps.html)。在我们的例子中，我们将使用 `tab20`。
...
通过将 `center` 参数作为 0，将 `cmap` 中心化为 0。
