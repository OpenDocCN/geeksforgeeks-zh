...
> 原文：[https://www.geeksforgeeks.org/how-to-add-text-in-a-heatmap-cell-annotations-using-seaborn-in-python/](https://www.geeksforgeeks.org/how-to-add-text-in-a-heatmap-cell-annotations-using-seaborn-in-python/)

**先决条件：** [Seaborn 热图](https://www.geeksforgeeks.org/seaborn-heatmap-a-comprehensive-guide/)
...
热图注释是显示热图中行和列的附加信息的好方法。一般来说，为了在热图上显示数据值，我们将 `annot` 参数设置为 `True`，但是如果您想在单元格注释中添加文本，可以通过以下方式完成。
