...
> 原文：[https://www.geeksforgeeks.org/horizontal-boxplots-with-points-using-seaborn-in-python/](https://www.geeksforgeeks.org/horizontal-boxplots-with-points-using-seaborn-in-python/)
...
我们遇到的大多数数据都是宽格式的。比如你刮网站的时候。该数据为宽格式。使用 `pandas` 的 `melt` 功能将数据转换为长格式。
