...
> 原文：[https://www.geeksforgeeks.org/dns-spoofing-or-dns-cache-poisoning/](https://www.geeksforgeeks.org/dns-spoofing-or-dns-cache-poisoning/)
...
虽然 DNS 缓存提高了域名解析过程的速度，但是域名的重大变化需要一天的时间才能在全球范围内反映出来。
