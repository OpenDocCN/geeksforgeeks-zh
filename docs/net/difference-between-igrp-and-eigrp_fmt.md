...
> 原文：[https://www.geeksforgeeks.org/difference-between-igrp-and-eigrp/](https://www.geeksforgeeks.org/difference-between-igrp-and-eigrp/)
...
`IGRP` 路由协议和 `EIGRP` 的主要区别在于，内部网关路由协议是有类路由技术，而增强型内部网关路由协议是无类路由技术。
