...
> 原文: [https://www.geeksforgeeks.org/computer-network-aaa-authentication-authorization-and-accounting/](https://www.geeksforgeeks.org/computer-network-aaa-authentication-authorization-and-accounting/)
...
AAA 可以通过使用设备的本地数据库或使用外部 ACS 服务器来实现。
