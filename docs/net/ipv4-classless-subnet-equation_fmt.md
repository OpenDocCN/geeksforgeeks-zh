...
> 原文: [https://www.geeksforgeeks.org/ipv4-classless-subnet-equation/](https://www.geeksforgeeks.org/ipv4-classless-subnet-equation/)

## 先决条件
- [无类寻址](https://www.geeksforgeeks.org/ip-addressing-classless-addressing/)
- [超网](https://www.geeksforgeeks.org/computer-network-supernetting/)

## 问题
如何计算 IP 地址子网信息（网络、广播、第一个 IP、最后一个 IP）？
