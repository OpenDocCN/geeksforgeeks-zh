...
> 原文: [https://www.geeksforgeeks.org/outdoor-mobility-model-gauss-markov/](https://www.geeksforgeeks.org/outdoor-mobility-model-gauss-markov/)
...
```
v_n = α * v_{n-1} + (1 - α) * v_avg + √(1 - α^2) * σ_v * X_{n-1}
θ_n = α * θ_{n-1} + (1 - α) * θ_avg + √(1 - α^2) * σ_θ * Y_{n-1}
```
