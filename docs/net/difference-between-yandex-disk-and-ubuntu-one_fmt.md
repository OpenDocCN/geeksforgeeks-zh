# Yandex Disk 和 Ubuntu One 的区别

> 原文：[https://www.geeksforgeeks.org/difference-between-yandex-disk-and-ubuntu-one/](https://www.geeksforgeks.org/difference-between-yandex-disk-and-ubuntu-one/)
...
| --- | --- |
| 归 `Yandex` 所有。 | 它由 `Canonical Limited` 所有。 |
| 它于 2012 年推出。 | 它于 2009 年推出。 |
| 它提供 10 GB 的可用存储空间。 | 它提供了 5 GB 的可用存储空间。 |
| 由 `Yandex` 开发。 | 由 `Canonical Limited` 开发。 |
