...
> 原文:[https://www . geeksforgeks . org/rip-and-OSPF 之差/](https://www.geeksforgeks.org/difference-between-rip-and-ospf/)

**1. [`路由信息协议(RIP)`](https://www.geeksforgeks.org/routing-information-protocol-rip/) :**
...
**2. [`开放最短路径优先(OSPF)`](https://www.geeksforgeks.org/open-shortest-path-first-ospf-protocol-states/) :**
