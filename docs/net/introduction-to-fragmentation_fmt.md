...
> 原文：[https://www.geeksforgeeks.org/introduction-to-fragmentation/](https://www.geeksforgeeks.org/introduction-to-fragmentation/)
...
这种分段是由一个网络完成的，对于数据包通过的后续网络是非透明的。由一个网络的网关分段的数据包不会由同一网络的出口网关重新组合，如下图所示。

![](img/48a3f45d460986f28836c61236c71b76.png)
