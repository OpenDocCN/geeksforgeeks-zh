...
> 原文: [https://www.geeksforgeeks.org/structure-and-types-of-ip-address/](https://www.geeksforgeeks.org/structure-and-types-of-ip-address/)
...
2.  [**主机 ID**](https://www.geeksforgeeks.org/ip-addressing-gq/) –
    主机 ID 是网络 ID 没有取的 IP 地址的一部分。识别网络中的特定设备(在 TCP / IP 世界中，我们称设备为“主机”)。继续我们的 IP 地址 `192.168.1.32` 的例子，主机标识将是 `32`，在 `192.168.1.0` 网络上唯一的主机标识。
