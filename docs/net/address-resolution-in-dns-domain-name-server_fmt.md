...
> 原文:[https://www.geeksforgeeks.org/address-resolution-in-dns-domain-name-server/](https://www.geeksforgeeks.org/address-resolution-in-dns-domain-name-server/)

### 先决条件
[域名服务器](https://www.geeksforgeeks.org/dns-domain-name-server/)
