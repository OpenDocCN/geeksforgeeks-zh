...
> 原文：[https://www.geeksforgeeks.org/advantages-and-disadvantages-of-twisted-pair/](https://www.geeksforgeeks.org/advantages-and-disadvantages-of-twisted-pair/)
...
双绞线有两种类型如下：非屏蔽双绞线（`UTP`）和屏蔽双绞线（`STP`）。我们一个一个来讨论。
