# Backblaze B2 和 Ubuntu One 的区别

> 原文：[https://www.geeksforgeeks.org/difference-between-backblaze-b2-and-ubuntu-one/](https://www.geeksforgeeks.org/difference-between-backblaze-b2-and-ubuntu-one/)
...
| B2 | UBUNTU ONE |
| --- | --- |
| 它由 `Backblaze Corporation` 所有。 | 它由 `Canonical Limited` 所有。 |
| 它于 2015 年推出。 | 它于 2009 年推出。 |
| 它提供 10 GB 的可用存储空间。 | 它提供了 5 GB 的可用存储空间。 |
| 它是由 `Backblaze Inc.` 开发的。 | 由 `Canonical Limited` 开发。 |
