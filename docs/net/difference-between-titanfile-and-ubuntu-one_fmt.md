...
> 原文:[https://www.geeksforgeeks.org/difference-between-titanfile-and-ubuntu-one/](https://www.geeksforgeeks.org/difference-between-titanfile-and-ubuntu-one/)
...
| 泰坦文件 | UBUNTU ONE |
| --- | --- |
| 它属于`Titan File公司`。 | 它由`Canonical Limited`所有。 |
| 它于 2011 年推出。 | 它于 2009 年推出。 |
| 它不提供免费存储空间。 | 它提供了 5 GB 的可用存储空间。 |
| 它是由`Titan File公司`开发的。 | 由`Canonical Limited`开发。 |
