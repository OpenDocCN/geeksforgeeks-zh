...
> 原文: [https://www.geeksforgeeks.org/routing-tables-in-computer-network/](https://www.geeksforgeeks.org/routing-tables-in-computer-network/)
...
[GATE-CS-2004 | 问题 55](https://www.geeksforgeeks.org/gate-gate-cs-2004-question-55/)

## 示例-2

[GATE IT 2006 | 问题 63](https://www.geeksforgeeks.org/gate-gate-it-2006-question-63/)

**请注意**路由表并不特定于思科设备。甚至您的 Windows 操作系统也有一个路由表，可以使用`路由打印`命令显示。