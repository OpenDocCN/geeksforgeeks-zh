...
> 原文: [https://www.geeksforgeeks.org/difference-between-onedrive-and-rapidshare/](https://www.geeksforgeeks.org/difference-between-onedrive-and-rapidshare/)
...
| 这里的最大文件大小是 `100 GB`。 | 最大文件大小为每个文件 `500 MB`。 |
