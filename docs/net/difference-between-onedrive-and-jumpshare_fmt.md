...
> 原文：[https://www.geeksforgeeks.org/difference-between-onedrive-and-jumpshare/](https://www.geeksforgeeks.org/difference-between-onedrive-and-jumpshare/)

## 1. OneDrive
`OneDrive` 或 `Microsoft OneDrive` 是由微软提供的文件托管和同步服务。它为用户存储文件、个人数据和共享文件提供了便利。它提供了 5 GB 的可用存储空间。它是微软在 2007 年推出的。它主要由专业人员用来存储与可能需要更高安全性的工作相关的数据。
