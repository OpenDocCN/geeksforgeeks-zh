...
> 原文: [https://www.geeksforgeeks.org/setting-up-a-basic-home-network-using-packet-tracer/](https://www.geeksforgeeks.org/setting-up-a-basic-home-network-using-packet-tracer/)
...
请注意，智能手机放在工作区后会自动连接到家庭路由器。

`步骤 3:`
通过将电脑配置为`快速以太网 0`，将家庭路由器配置为`千兆以太网 1`，使用“连接”中提供的铜线将电脑连接到家庭路由器。
