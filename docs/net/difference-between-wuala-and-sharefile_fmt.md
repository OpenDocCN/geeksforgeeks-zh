...
> 原文: [https://www.geeksforgeeks.org/difference-between-wuala-and-sharefile/](https://www.geeksforgeeks.org/difference-between-wuala-and-sharefile/)

## 1. Wuala
Wuala 是一个文件同步服务、文件存储服务、文件版本服务和备份存储服务，最初由 Caleido Incorporation 提供，但后来归希捷科技所有。它是由张秀坤格罗利蒙和卢修斯梅瑟林开发的。它主要是用 `Java` 开发的。它提供了 `5 GB` 的可用存储空间。它于 `2008` 年推出。
