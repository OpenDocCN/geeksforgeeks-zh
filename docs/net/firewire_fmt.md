...
| **名称** | **发布年份** | **速度** | **描述** |
| --- | --- | --- | --- |
| `IEEE 1394` （`FireWire 400`） | One thousand nine hundred and ninety-five | 100-400 Mbps | 1.这是一个 6 针连接器。<br>2.它能够向连接设备供电，这意味着需要少量电力的设备不需要额外的电源。<br>3.它的射程仅限于 4.5 米。 |
| `IEEE 1394a` | Two thousand | 高达 400 Mbps | 1.这是一个 4 针连接器。<br>2.它无法为连接的设备供电。<br>3.它是向后兼容的，这意味着也支持所有上一代产品。 |
...
| `火线 S1600` 和 `S3200` | Two thousand and twelve | 1.57 Gbps | 1.这是最后一个商业化的版本。<br>2.它向后兼容。 |
