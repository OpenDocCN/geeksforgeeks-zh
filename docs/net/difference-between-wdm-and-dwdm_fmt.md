...
> 原文：[https://www.geeksforgeeks.org/difference-between-wdm-and-dwdm/](https://www.geeksforgeeks.org/difference-between-wdm-and-dwdm/)

在本文中，我们将讨论 `WDM`（波分复用）和密集波分复用（`DWDM`）的区别。我们一个一个来讨论。
