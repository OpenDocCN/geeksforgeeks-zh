...
> 原文：[https://www.geeksforgeeks.org/difference-between-box-and-yandex-disk/](https://www.geeksforgeeks.org/difference-between-box-and-yandex-disk/)
...
| Box | Yandex Disk |
| --- | --- |
| 它属于 `Box Incorporation`。 | 归 `Yandex` 所有。 |
| 它于 2005 年推出。 | 它于 2012 年推出。 |
| 它是由 `Aaron Levie` 和 `Dylan Smith` 开发的。 | 由 `Yandex` 开发。 |
