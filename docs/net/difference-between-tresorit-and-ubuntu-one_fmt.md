...
> 原文: [https://www.geeksforgeeks.org/difference-between-tresorit-and-ubuntu-one/](https://www.geeksforgeeks.org/difference-between-tresorit-and-ubuntu-one/)
...
| TRESORIT | UBUNTU ONE |
| --- | --- |
| 它归 `Tresorit` 所有。 | 它由 `Canonical Limited` 所有。 |
| 它于 2014 年推出。 | 它于 2009 年推出。 |
| 它提供 3 GB 的可用存储空间。 | 它提供了 5 GB 的可用存储空间。 |
| 由 `Tresorit` 开发。 | 由 `Canonical Limited` 开发。 |
...
| 它有客户端加密。 | 它没有客户端加密。 |
| 它没有流量或带宽限制。 | 它有 `Amazon S3` 流量限制或带宽限制。 |