...
> 原文: [https://www.geeksforgeeks.org/open-shortest-path-first-ospf-protocol-states/](https://www.geeksforgeeks.org/open-shortest-path-first-ospf-protocol-states/)
...
DR 和 BDR 选举在广播网络或多址网络中进行。以下是选举的标准:
