# Jumpshare 和 MiMedia 的区别

> 原文：[https://www.geeksforgeeks.org/difference-between-jumpshare-and-mimedia/](https://www.geeksforgeeks.org/difference-between-jumpshare-and-mimedia/)
...
| 序号 | Jumpshare | MiMedia |
| :--- | :--- | :--- |
| 1. | 它是由 `Jumpshare Incorporation` 开发并拥有的。 | 它是由 `MiMedia LLC` 开发并拥有的。 |
...
| 7. | 最大文件大小为免费 `250 MB`，付费不限。 | 此处最大文件大小为 `5 GB`。 |
| 8. | 支持远程上传。 | 它不支持远程上传。 |
