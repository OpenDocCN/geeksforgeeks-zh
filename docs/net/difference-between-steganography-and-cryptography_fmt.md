...
> 原文：[https://www.geeksforgeeks.org/difference-between-steganography-and-cryptography/](https://www.geeksforgeeks.org/difference-between-steganography-and-cryptography/)
...
| 7. | 在隐写术中，不涉及太多的数学变换。 | 密码学涉及数论、数学等的使用。 |