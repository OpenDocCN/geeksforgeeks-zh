...
> 原文: [https://www.geeksforgeeks.org/difference-between-arp-and-rarp/](https://www.geeksforgeeks.org/difference-between-arp-and-rarp/)
...
| 5. | 在地址解析协议中，获取接收方的媒体访问控制地址。 | 而在 `RARP` 中，获取 `IP` 地址。 |
