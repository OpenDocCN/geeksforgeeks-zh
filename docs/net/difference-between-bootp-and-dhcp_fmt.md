...
> 原文: [https://www.geeksforgeeks.org/difference-between-bootp-and-dhcp/](https://www.geeksforgeeks.org/difference-between-bootp-and-dhcp/)

`BOOTP` 代表 `Bootstrap 协议`，`DHCP` 代表 [`动态主机配置协议`](https://www.geeksforgeeks.org/computer-network-dynamic-host-configuration-protocol-dhcp/)。这些协议用于获取主机的网络地址以及引导信息。每个协议的操作在某些方面完全不同。动态主机配置协议也是引导协议的扩展版本。
