...
> 原文：[https://www.geeksforgeeks.org/network-news-transfer-protocol-nntp/](https://www.geeksforgeeks.org/network-news-transfer-protocol-nntp/)
...
端口`563`或`119`由 NNTP 客户端/新闻阅读器使用。端口`433`由服务器使用，因此它也被称为 NNSP。
