...
> 原文: [https://www.geeksforgeeks.org/architecture-of-internet-of-things-iot/](https://www.geeksforgeeks.org/architecture-of-internet-of-things-iot/)
...
因此，从上面的图像可以清楚地看出，存在 4 层，可分为以下几层：传感层、网络层、数据处理层和应用层。这些解释如下。
...
## 数据处理层
这是物联网生态系统的处理单元。在这里，在将数据发送到数据中心之前，对数据进行分析和预处理，在数据中心，软件应用程序(通常称为业务应用程序)访问数据，在业务应用程序中，对数据进行监控和管理，并准备进一步的操作。因此，`边缘信息技术`或`边缘分析`应运而生。
