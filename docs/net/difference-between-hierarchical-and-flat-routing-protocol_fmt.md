...
> 原文：[https://www.geeksforgeeks.org/difference-between-hierarchical-and-flat-routing-protocol/](https://www.geeksforgeeks.org/difference-between-hierarchical-and-flat-routing-protocol/)

## 1. 分层路由协议

分层路由是网络中基于分层寻址的路由方法。大多数传输控制协议，互联网协议（DCPIP）。路由基于两级分层路由，其中 IP 地址分为网络、个人和主机。网关只使用一个人告诉 IP 数据的网络，直到网关直接传送它。
