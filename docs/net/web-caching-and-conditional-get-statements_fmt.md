...
> 原文：[https://www.geeksforgeeks.org/web-caching-and-conditional-get-statements/](https://www.geeksforgeeks.org/web-caching-and-conditional-get-statements/)
...
“条件 `GET`”语句比普通的 `GET` 语句有一个额外的字段，称为 `If-modified-since` 字段，它指定了最后一次发出相同请求的时间。原始服务器或者：
