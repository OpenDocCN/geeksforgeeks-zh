...
> 原文：[https://www.geeksforgeeks.org/types-of-icmp-internet-control-message-protocol-messages/](https://www.geeksforgeeks.org/types-of-icmp-internet-control-message-protocol-messages/)
...
*   **回应-请求和回复消息**
    ...
    *例如*，主机 A 想要检查它是否可以与另一个主机 B 通信，因此它将向 B 发送回显请求，并且如果 A 和 B 之间的链路是活动的，那么它将在接收到请求时向 A 发送回显回复。
