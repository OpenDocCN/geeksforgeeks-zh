...
> 原文：[https://www.geeksforgeeks.org/image-encryption-using-cellular-automata/](https://www.geeksforgeeks.org/image-encryption-using-cellular-automata/)
...
1.  灰度图像作为输入。
2.  图像被转换成 2D 矩阵。
3.  执行 `M1 = Key(M)`，其中 `M1` 是加密的 2D 矩阵。
...
## 项目链接
[https://github.com/Lakshyasukhralia/CellularAutomata](https://github.com/Lakshyasukhralia/CellularAutomata)