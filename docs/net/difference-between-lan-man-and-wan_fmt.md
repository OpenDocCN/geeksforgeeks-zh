...
> 原文：[https://www.geeksforgeeks.org/difference-between-lan-man-and-wan/](https://www.geeksforgeeks.org/difference-between-lan-man-and-wan/)
...
| 所有权 | 局域网的所有权是私有的。 | 城域网的所有权可以是私有的，也可以是公有的。 | 广域网也可能不属于一个组织。 |
| 传输速度 | 局域网的传输速度很快。 | 城域网的传输速度一般。 | 广域网的传输速度很低。 |
| 传播延迟 | 局域网中的传播延迟很短。 | 城域网中有适度的传播延迟。 | 广域网中有很长的传播延迟。 |
| 拥挤 | 局域网中拥塞较少。 | 城域网则更加拥堵。 | 广域网中的拥塞比城域网多。 |
| 设计和维护 | 局域网的设计和维护很容易。 | 城域网的设计和维护比局域网困难。 | 广域网的设计和维护也比局域网和城域网困难。 |
| 容错 | 局域网中有更多的容错能力。 | 城域网的容错性较低。 | 广域网中的容错性也较低。 |