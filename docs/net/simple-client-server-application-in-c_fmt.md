...
> 原文: [https://www.geeksforgeeks.org/simple-client-server-application-in-c/](https://www.geeksforgeeks.org/simple-client-server-application-in-c/)
...
*   客户端套接字是通过 `socket()` 调用创建的。`socket()` 函数返回一个整数。在套接字调用中，我们指定了以下参数
    *   域: IPv4 (由 `AF_INET` 表示)
...
**参考:** [http://pirate.shu.edu/~wachsmut/Teaching/CSAS2214/Virtual/Lectures/lecture17.html](http://pirate.shu.edu/~wachsmut/Teaching/CSAS2214/Virtual/Lectures/lecture17.html)