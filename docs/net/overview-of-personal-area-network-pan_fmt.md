...
> 原文: [https://www.geeksforgeeks.org/overview-of-personal-area-network-pan/](https://www.geeksforgeeks.org/overview-of-personal-area-network-pan/)
...
个人区域网根据其连接可以有两种类型，即无线 `PAN` 和有线 `PAN`。解释如下。
