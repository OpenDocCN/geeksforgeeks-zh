...
> 原文：[https://www.geeksforgeeks.org/design-issues-in-network-layer/](https://www.geeksforgeeks.org/design-issues-in-network-layer/)

[网络层](https://www.geeksforgeeks.org/layers-of-osi-model/)主要关注从源到目的地的数据包获取、路由错误处理和拥塞控制。

在了解网络层的设计问题之前，让我们先了解一下它的各种功能。

*   [`寻址`](https://www.geeksforgeeks.org/introduction-of-classful-ip-addressing/)：在源和目的地的帧头维护地址，并执行寻址以检测网络中的各种设备。
*   `打包`：这是通过互联网协议执行的。网络层转换来自其上层的数据包。
*   [`路由`](https://www.geeksforgeeks.org/types-of-routing/)：这是最重要的功能。网络层为从源到目的地的数据传输选择最相关和最佳的路径。
*   `互联网络`：它的工作原理是在多个设备之间提供逻辑连接。
