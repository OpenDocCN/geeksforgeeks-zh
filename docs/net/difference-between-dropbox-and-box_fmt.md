...
> 原文: [https://www.geeksforgeeks.org/difference-between-dropbox-and-box/](https://www.geeksforgeeks.org/difference-between-dropbox-and-box/)
...
| DROPBOX | BOX |
| --- | --- |
| 它属于`Dropbox Incorporation`。 | 它属于`Box Incorporation`。 |
| 它于 2007 年推出。 | 它于 2005 年推出。 |
| 它是由`德鲁·休斯顿`和`阿拉什·菲尔多西`开发的。 | 它是由`亚伦·列维`和`迪伦·史密斯`开发的。 |
...
| 它不支持远程上传。 | 它支持通过 `IFTTT` 远程上传每个文件 `30 MB`。 |
