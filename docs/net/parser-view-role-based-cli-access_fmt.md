...
> 原文：[https://www.geeksforgeeks.org/parser-view-role-based-cli-access/](https://www.geeksforgeeks.org/parser-view-role-based-cli-access/)
...
R2(config-view)#commands exec exclude ping
R2(config-view)#commands exec exclude telnet
R2(config-view)#commands exec exclude all show
R2(config-view)#commands exec exclude configure terminal
