...
> 原文：[https://www.geeksforgeeks.org/single-band-double-band-and-multi-band-routers/](https://www.geeksforgeeks.org/single-band-double-band-and-multi-band-routers/)
...
*   它仅限于一个频带，也称为“无线网络”。
*   `2.4 GHz` 频段的单频段路由器理论速度高达 `800 Mbps`。互联网服务限制就是一个例子。
