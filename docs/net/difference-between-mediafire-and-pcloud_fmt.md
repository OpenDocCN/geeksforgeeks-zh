...
> 原文: [https://www.geeksforgeeks.org/difference-between-mediafire-and-pcloud/](https://www.geeksforgeeks.org/difference-between-mediafire-and-pcloud/)
...
| 它是由 `Derek Rapan` 和 `Tom Langridge` 开发的。 | 由 `pCloud AG` 开发。 |
