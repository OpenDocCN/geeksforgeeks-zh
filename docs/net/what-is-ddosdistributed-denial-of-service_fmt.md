...
> 原文：`https://www.geeksforgeeks.org/what-is-ddosdistributed-denial-of-service/`
...
## DDoS 攻击的例子:
2000 年，使用网名“Mafiaboy”的 15 岁男孩 Michael Calce 策划了第一次 DDoS 攻击。他侵入了不同大学的计算机网络。他用他们的服务器来操作导致易贝和雅虎等多家网站瘫痪的 DDoS 攻击。
