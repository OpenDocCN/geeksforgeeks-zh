...
> 原文:[https://www.geeksforgeeks.org/difference-between-adware-and-spyware/](https://www.geeksforgeeks.org/difference-between-adware-and-spyware/)
...
## 2. `间谍软件`
间谍软件是一种类型的`恶意软件`，它执行某些任务，包括监视和跟踪用户操作以及收集个人数据。间谍软件程序通常安装在用户计算机上，并通过在用户不知情的情况下收集用户的数据为第三方提供利润。此外，间谍软件通过在系统后台运行来窃取用户的密码和个人信息。
