...
> 原文：[https://www.geeksforgeeks.org/difference-between-sugarsync-and-ubuntu-one/](https://www.geeksforgeeks.org/difference-between-sugarsync-and-ubuntu-one/)
...
| SugarSync | Ubuntu One |
| --- | --- |
| 它归 **J2 环球**所有。 | 它由 **Canonical Limited** 所有。 |
| 它于 2009 年推出。 | 它也于 2009 年推出。 |
| 它不提供免费存储空间。 | 它提供了 5 GB 的可用存储空间。 |
| 由 **J2 环球**开发。 | 由 **Canonical Limited** 开发。 |
