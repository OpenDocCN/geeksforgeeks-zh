...
> 原文: [https://www.geeksforgeeks.org/difference-between-ring-topology-and-bus-topology-in-computer-networks/](https://www.geeksforgeeks.org/difference-between-ring-topology-and-bus-topology-in-computer-networks/)
...
总线拓扑是一种网络拓扑，其中所有设备都连接到一根电缆，该电缆被称为网络的主干。它由电缆两端的终端组成。网线负责设备之间的通信，当数据到达网线末端时，它会被`终结器`从数据线上移除。当设备以线性方式连接时，这是最简单的网络拓扑。
