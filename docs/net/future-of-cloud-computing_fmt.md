...
位置跟踪应用程序利用内置于移动设备中的`全球定位系统(GPS)`的数据，将个人位置集成到它执行的处理中。随着越来越多的设备内置全球定位系统功能，应用程序将开始提供更多的位置跟踪解决方案。
...
如今，大多数家庭都拥有无线网络功能，允许家庭成员连接到 `Web` 并访问他们想要的网站和内容。随着智能设备、智能织物的到来，以及更多使用射频识别设备(`RFID`)，关系将期待按需个性化的技术解决方案。家庭将使用云设备来定制他们的环境和体验。在这种环境中，家庭会希望将处理限制在家里，这意味着他们不希望邻居接收到他们的设备和衣服产生的信号。
