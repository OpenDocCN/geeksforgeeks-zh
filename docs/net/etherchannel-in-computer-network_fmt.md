...
> 原文: [https://www.geeksforgeeks.org/etherchannel-in-computer-network/](https://www.geeksforgeeks.org/etherchannel-in-computer-network/)
...
要形成以太网通道，有两个协议，端口聚合协议(`PAgP`)和链路聚合控制协议(`LACP`)。
