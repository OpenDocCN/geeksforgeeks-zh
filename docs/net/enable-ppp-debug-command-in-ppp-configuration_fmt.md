# 在 PPP 配置中启用 PPP 调试命令

> 原文: [https://www.geeksforgeeks.org/enable-ppp-debug-command-in-ppp-configuration/](https://www.geeksforgeeks.org/enable-ppp-debug-command-in-ppp-configuration/)
