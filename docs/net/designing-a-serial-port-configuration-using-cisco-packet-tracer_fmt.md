...
> 原文：[https://www.geeksforgeeks.org/designing-a-serial-port-configuration-using-cisco-packet-tracer/](https://www.geeksforgeeks.org/designing-a-serial-port-configuration-using-cisco-packet-tracer/)
...
4.  要告诉路由器间接连接的网络，请使用 `CLI` 中的 `IP route` 命令。
