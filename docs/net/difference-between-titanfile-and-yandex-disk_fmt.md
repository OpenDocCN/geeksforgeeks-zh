# Titanfile 和 Yandex Disk 的区别

> 原文：[https://www.geeksforgeeks.org/difference-between-titanfile-and-yandex-disk/](https://www.geeksforgeeks.org/difference-between-titanfile-and-yandex-disk/)
...
```
| Titanfile | Yandex Disk |
| --- | --- |
| 它属于`Titanfile`公司。 | 归`Yandex`所有。 |
| 它于 2011 年推出。 | 它于 2012 年推出。 |
| 它是由`Titanfile`公司开发的。 | 由`Yandex`开发。 |
