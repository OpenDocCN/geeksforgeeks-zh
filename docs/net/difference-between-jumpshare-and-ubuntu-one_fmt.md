# Jumpshare 和 Ubuntu One 的区别

> 原文: [https://www.geeksforgeeks.org/difference-between-jumpshare-and-ubuntu-one/](https://www.geeksforgeeks.org/difference-between-jumpshare-and-ubuntu-one/)
...
| --- | --- |
| 它由`Jumpshare Inc.`所有。 | 它由`Canonical Limited`所有。 |
| 它于 2012 年推出。 | 它于 2009 年推出。 |
| 它提供 2 GB 的可用存储空间。 | 它提供了 5 GB 的可用存储空间。 |
| 它是由`Jumpshare Inc.`开发的。 | 由`Canonical Limited`开发。 |
