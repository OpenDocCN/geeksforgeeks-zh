...
> 原文：[https://www.geeksforgeeks.org/difference-between-wasabi-and-yandex-disk/](https://www.geeksforgeeks.org/difference-between-wasabi-and-yandex-disk/)

## 1. 山葵

山葵是一种文件托管和云存储服务，由`Wasabi`技术公司提供。它是一种对象存储服务。它于 2017 年由`Wasabi`技术公司推出。它不提供免费存储空间。它为付费用户提供无限的最大存储空间。又称`山葵热储`或`山葵热云存储`。
...
| 山萮菜 | YANDEX DISK |
| --- | --- |
| 它由`Wasabi科技公司`所有。 | 归`Yandex`所有。 |
| 它于 2017 年推出。 | 它于 2012 年推出。 |
| 它是由`Wasabi科技有限公司`开发的。 | 由`Yandex`开发。 |
