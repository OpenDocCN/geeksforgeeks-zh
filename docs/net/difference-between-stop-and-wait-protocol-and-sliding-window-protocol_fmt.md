...
> 原文：[https://www.geeksforgeeks.org/difference-between-stop-and-wait-protocol-and-sliding-window-protocol/](https://www.geeksforgeeks.org/difference-between-stop-and-wait-protocol-and-sliding-window-protocol/)
...
| 6. | 停止等待协议的效率为 `1/(1+2*a)` | 滑动窗口协议的效率为 `N/(1+2*a)` |
