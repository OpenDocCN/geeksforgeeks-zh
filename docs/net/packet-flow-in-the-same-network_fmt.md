...
> 原文: [https://www.geeksforgeeks.org/packet-flow-in-the-same-network/](https://www.geeksforgeeks.org/packet-flow-in-the-same-network/)
...
交换机广播 `ARP` 请求，因为以太网报头中的条目是 `FFFF.FFFF`（广播媒体访问控制地址）。
...
![](img/86294d863dd622bc64cbaf5f490c6a4a.png)
![](img/394fe53f48cb39025e963dbf3c0c0ab1.png)

现在 `ARP` 已经解决，`ICMP` 将从主机 `A` 单播到主机 `B`（如上所示）。

![](img/86294d863dd622bc64cbaf5f490c6a4a.png)
![](img/5e82fc87efb97ee4aab7df543e4357db.png)
