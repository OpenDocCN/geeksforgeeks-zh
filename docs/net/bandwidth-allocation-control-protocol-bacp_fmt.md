...
> 原文: [https://www.geeksforgeeks.org/bandwidth-allocation-control-protocol-bacp/](https://www.geeksforgeeks.org/bandwidth-allocation-control-protocol-bacp/)
...
### 1. `Code field`
这个字段是 8 位的。它基本上用于确定需要执行的功能类型。可以执行多种类型的功能。这些功能及其特定代码如下：
