...
> 原文: [https://www.geeksforgeeks.org/routing-v-s-routed-protocols-in-computer-network/](https://www.geeksforgeeks.org/routing-v-s-routed-protocols-in-computer-network/)

网络层负责提供逻辑寻址，路由器使用逻辑寻址来选择路由数据包的最佳路径。该层使用两种类型的数据包:
