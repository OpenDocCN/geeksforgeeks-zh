...
> 原文: [https://www.geeksforgeeks.org/difference-between-round-trip-time-rtt-and-time-to-live-ttl/](https://www.geeksforgeeks.org/difference-between-round-trip-time-rtt-and-time-to-live-ttl/)
...
| 序列号 | **Round trip time** | **Survival time** |
| :--- | :--- | :--- |
...
标有**红色**框的数值为 **RTT(往返时间)**，由于是以毫秒计量的，所以以**毫秒**显示，标有**蓝色**框的数值为 **TTL(生存时间)**，以**秒**计量。
