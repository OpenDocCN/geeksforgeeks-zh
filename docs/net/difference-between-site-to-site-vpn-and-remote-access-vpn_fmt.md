...
> 原文：[https://www.geeksforgeeks.org/difference-between-site-to-site-vpn-and-remote-access-vpn/](https://www.geeksforgeeks.org/difference-between-site-to-site-vpn-and-remote-access-vpn/)

## 介绍

`站点到站点 VPN` 和 `远程访问 VPN` 都是代表`虚拟专用网络`的 VPN 类型。
