...
> 原文:[https://www . geesforgeks . org/卫星通信和光通信的区别/](https://www.geeksforgeks.org/difference-between-satellite-communication-and-optical-communication/)
...
| 2. | 在卫星通信中，卫星作为中继站用于通信。 | 在光通信中，通信是通过光纤进行的。 |
