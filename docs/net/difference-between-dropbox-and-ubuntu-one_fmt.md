...
> 原文：[https://www.geeksforgeks.org/difference-between-dropbox-and-ubuntu-one/](https://www.geeksforgeks.org/difference-between-dropbox-and-ubuntu-one/)
...
| DROPBOX | UBUNTU ONE |
| --- | --- |
| 它属于 Dropbox 公司。 | 它由 Canonical 有限公司所有。 |
| 它于 2007 年推出。 | 它于 2009 年推出。 |
| 它提供 2 GB 的可用存储空间。 | 它提供了 5 GB 的可用存储空间。 |
| 它是由德鲁·休斯顿和阿拉什·菲尔多西开发的。 | 由 Canonical 有限公司开发。 |
