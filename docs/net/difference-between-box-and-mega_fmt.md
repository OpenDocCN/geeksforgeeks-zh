...
> 原文：[https://www.geeksforgeeks.org/difference-between-box-and-mega/](https://www.geeksforgeeks.org/difference-between-box-and-mega/)
...
| Box | Mega |
| --- | --- |
| 它属于`Box Inc.`。 | 它由`Mega Limited`所有。 |
| 它于 2005 年推出。 | 它于 2013 年推出。 |
| 它是由`Aaron Levie`和`Dylan Smith`开发的。 | 它是由`Kim Dotcom`开发的。 |
...
| 最大文件大小免费为 250 MB，付费为 5 GB。 | 这里，最大文件大小等于可用的云驱动器空间。 |
