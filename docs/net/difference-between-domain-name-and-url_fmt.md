...
> 原文：[https://www.geeksforgeeks.org/difference-between-domain-name-and-url/](https://www.geeksforgeeks.org/difference-between-domain-name-and-url/)
...
### 主机名
一般是`google`、`geeksforgeeks`等域名的主名称。

### 顶级域名
域名的最后一部分是顶级域名。例子有`.com`、`.in`、`.edu`等等。
...
### 主机名
也称为域名或文件或文档所在服务器的 IP 地址的人性化文本形式。
