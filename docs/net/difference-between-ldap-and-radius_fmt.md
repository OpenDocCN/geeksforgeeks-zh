...
> 原文: [https://www.geeksforgeeks.org/difference-between-ldap-and-radius/](https://www.geeksforgeeks.org/difference-between-ldap-and-radius/)
...
| 3. | 它不是开源的，但它拥有开源的实现，如 `开放 LDAP`。 | 它不是开源的，但它拥有开源的 `自由半径` 等实现。 |
