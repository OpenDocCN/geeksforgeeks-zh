...
1.  **静电耦合**：当电流在与另一根平行导线非常接近的导线中流动时产生的静电场由于在两根导线之间建立的虚拟电容而在该平行导线中产生干扰信号时，就会发生静电耦合。又称为容性耦合，这种现象产生的干扰信号称为容性串扰。
2.  **电磁耦合**：当在与另一根平行导线非常接近的导线中流动的交流电产生动态变化的磁场时，由于两根导线之间的互感，该磁场在该平行导线中产生干扰信号。又称为感应耦合，这种现象产生的干扰信号称为感应串扰。
