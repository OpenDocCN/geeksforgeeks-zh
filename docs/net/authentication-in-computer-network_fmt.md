...
> 原文：`https://www.geeksforgeeks.org/authentication-in-computer-network/`

前提–[认证与授权的区别](https://www.geeksforgeeks.org/difference-between-authentication-and-authorization/)
...
密码验证是最流行和最常用的认证技术。密码是一个秘密文本，应该只有用户知道。在基于密码的系统中，系统管理员为每个用户分配一个有效的用户名和密码。
