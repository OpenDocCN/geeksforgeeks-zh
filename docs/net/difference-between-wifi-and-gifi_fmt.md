...
> 原文: [https://www.geeksforgeeks.org/difference-between-wifi-and-gifi/](https://www.geeksforgeeks.org/difference-between-wifi-and-gifi/)
...
| 编号 | WiFi | Gi-Fi |
| :--- | :--- | :--- |
| 01. | WiFi 使用无线电频率波在空中传输数据。 | Gi-Fi 使用毫米波进行空中数据传输。 |
| 02. | WiFi 的频率范围是 2.4 GHz 和/或 5 GHz。 | Gi-Fi 的频率范围是 57 到 64 GHz。 |
| 03. | WiFi 提供 150 Mbps 及以上的数据速率/速度。 | Gi-Fi 提供 5 Gbps 及以上的数据速率/速度。 |
| 04. | 它的覆盖范围比较大。 | 它的覆盖范围更小。 |
| 05. | WiFi 可以覆盖大约 300 米的距离。 | Gi-Fi 可以覆盖 10 米左右的距离。 |
| 06. | 它的数据密度很低。 | 它的数据密度非常高。 |
| 07. | 发展始于 1990 年。 | 发展始于 2004 年。 |
| 08. | 它的成本很高。 | 它的成本低。 |
| 09. | WiFi 的规范权威是 `IEEE` 和 `WECA`。 | Gi-Fi 的规范权威是 `NICTA`。 |
| 10. | 它的功耗有点高，即 10 mW (毫瓦)。 | 它的功耗有点低，即不到 2 毫瓦。 |
| 11. | WiFi 的主要应用是无线局域网。 | Gi-Fi 的主要应用是 `WPAN` 和无线局域网。 |