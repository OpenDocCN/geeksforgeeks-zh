...
> 原文：[https://www.geeksforgeeks.org/cyber-crime-mobile-security-threats/](https://www.geeksforgeeks.org/cyber-crime-mobile-security-threats/)
...
### `Web-Based Threats`
这些类型的威胁发生在人们访问那些表面上看起来正常，但实际上会自动将恶意内容下载到移动设备上的网站时。此外，许多移动应用程序会在后台持续同步数据，这也构成了威胁。这些威胁通常不会被用户注意到。
...
### `Physical Threats`
这些威胁发生在有人试图物理访问您的设备时。当您丢失手机或手机被盗时，就可能发生物理威胁。移动设备承载着您的交易数据，并且连接着您的银行账户应用程序，这对您的隐私构成了威胁。
...
移动网络包括蜂窝网络和本地网络支持，如蓝牙和 `Wi-Fi`。这些都被用来承载网络威胁。这些威胁尤其危险，因为网络犯罪分子可以在人们使用公共 `WiFi` 网络时窃取未加密的数据。
