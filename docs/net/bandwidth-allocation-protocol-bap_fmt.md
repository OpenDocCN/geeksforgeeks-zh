...
> 原文：[https://www.geeksforgeeks.org/bandwidth-allocation-protocol-bap/](https://www.geeksforgeeks.org/bandwidth-allocation-protocol-bap/)
...
### 1. Type field
该字段为 8 位。它通常指定正在发送或传输的`BAP`消息或数据报包的类型。消息或数据报的类型如下表所示：
