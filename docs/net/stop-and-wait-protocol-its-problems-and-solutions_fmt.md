...
> 原文：[https://www.geeksforgeeks.org/stop-and-wait-protocol-its-problems-and-solutions/](https://www.geeksforgeeks.org/stop-and-wait-protocol-its-problems-and-solutions/)
...
注意：停止等待距离越短越好。因此它是一个很好的局域网协议。停止和等待有利于更大的数据包。
