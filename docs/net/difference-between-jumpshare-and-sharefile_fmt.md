# Jumpshare 和 ShareFile 的区别

> 原文：[https://www.geeksforgeeks.org/difference-between-jumpshare-and-sharefile/](https://www.geeksforgeeks.org/difference-between-jumpshare-and-sharefile/)
...
| JUMPSHARE | SHAREFILE |
| --- | --- |
| 它由 `Jumpshare Inc.` 所有。 | 它归 `Citrix Systems` 公司所有。 |
| 它于 2012 年推出。 | 它于 2005 年推出。 |
| 它提供 2 GB 的可用存储空间。 | 它提供 30 天免费试用，最大存储容量为 10 GB。 |
| 它是由 `Jumpshare Inc.` 开发的。 | 它是由杰西·利普森开发的。 |
