...
> 原文：[https://www.geeksforgeeks.org/advantages-and-disadvantages-of-subnetting/](https://www.geeksforgeeks.org/advantages-and-disadvantages-of-subnetting/)
...
2.  在单网络情况下，只有两个IP地址被浪费用于表示`Network Id`和`Broadcast address`，但在子网划分情况下，每个子网都会浪费两个IP地址。
    **示例：** 如果一个网络有四个子网，这意味着将有8个IP地址被浪费。
...
3.  网络的总体成本也会增加。子网划分需要内部路由器、交换机、集线器、网桥等，这些设备非常昂贵。

    ![](img/9f3a965ce479f671fe604c38a32f114c.png)

4.  子网划分和网络管理需要有经验的网络管理员。这也增加了总成本。