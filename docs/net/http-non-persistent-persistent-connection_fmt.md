...
> 原文: [https://www.geeksforgeeks.org/http-non-persistent-persistent-connection/](https://www.geeksforgeeks.org/http-non-persistent-persistent-connection/)
...
每个对象需要两个 RTT(假设没有窗口限制)，一个用于 TCP 连接，另一个用于 HTTP 图像/文本文件。
...
**参考:** [https://en.wikipedia.org/wiki/HTTP_persistent_connection](https://en.wikipedia.org/wiki/HTTP_persistent_connection)
