...
> 原文: [https://www.geeksforgeeks.org/principle-of-information-system-security/](https://www.geeksforgeeks.org/principle-of-information-system-security/)
...
这些层级共同构成了中情局三角，这恰好是保护信息系统安全的首要需要。这三个层次证明了信息系统安全的原则。
...
3.  **可用性:**
    此功能意味着任何授权人员都可以在给定的`时间范围内`访问和修改信息。这里需要注意的一点是，信息的可及性有限。每个组织访问它的时间范围是不同的。
