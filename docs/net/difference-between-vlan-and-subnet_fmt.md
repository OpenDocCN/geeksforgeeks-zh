...
> 原文：[`https://www.geeksforgeeks.org/difference-between-vlan-and-subnet/`](https://www.geeksforgeeks.org/difference-between-vlan-and-subnet/)

## 1. VLAN

[`VLAN`](https://www.geeksforgeeks.org/virtual-lan-vlan/) 代表虚拟局域网，它们由 `802.1q` 协议定义（这是一个 VLAN 标记协议，由于在以太网帧中插入了一个 4 字节的 VLAN 标记，允许以太网帧大小增加 4 字节）。使用虚拟局域网，我们实际上可以将我们的局域网分成更小的网络，它们像普通的局域网一样工作，只是它们在逻辑上或实际上是分开的，而不是物理上分开的。
