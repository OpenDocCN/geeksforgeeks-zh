...
> 原文: [https://www.geeksforgeeks.org/setting-up-local-dns-server-between-client-server-machines/](https://www.geeksforgeeks.org/setting-up-local-dns-server-between-client-server-machines/)
...
**注意–** 将 10.0.2.15 更改为您的服务器机器 IP 地址在我的情况下，我的服务器 IP 地址是 10.0.2.15。
...
**注意–** 使用`sudo`命令以管理员权限打开 Wireshark，如下图所示。
