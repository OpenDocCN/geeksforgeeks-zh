...
> 原文: [https://www.geeksforgeeks.org/telnet-and-ssh-on-adaptive-security-appliance-asa/](https://www.geeksforgeeks.org/telnet-and-ssh-on-adaptive-security-appliance-asa/)
...
这里是一个小型拓扑，其中三个路由器，即路由器 1 (IP 地址-10.1.1.1/24)、路由器 2 (IP 地址-10.1.2.1/24)、路由器 3 (IP 地址-10.1.3.1/24)连接到 ASA (IP 地址-10.1.1.2/24 在内部接口上，安全级别为-100，IP 地址-10.1.2.2/24 在外部接口上，安全级别为-0，10.1.3.1/24 在 DMZ 接口上，安全级别为-50)。
...
使用相同的拓扑，其中三个路由器，即路由器 1 (IP 地址-10.1.1.1/24)、路由器 2 (IP 地址-10.1.2.1/24)、路由器 3 (IP 地址-10.1.3.1/24)连接到 ASA (IP 地址-10.1.1.2/24 在内部接口，安全级别-100，IP 地址-10.1.2.2/24 在外部接口，安全级别-0，10.1.3.1/24 在 DMZ 接口，安全级别-50)。
