...
> 原文：[https://www.geeksforgeeks.org/difference-between-amazon-s3-and-tresorit/](https://www.geeksforgeeks.org/difference-between-amazon-s3-and-tresorit/)

## 亚马逊 S3

亚马逊 S3 代表亚马逊简单存储服务。它是由 `AWS` 提供的云存储服务。它通过 web 服务接口提供对象存储。它允许存储任何类型的对象，如用于分析、数据归档、备份和恢复、灾难恢复、混合云存储和互联网应用的数据湖。它由 `AWS` 于 2006 年推出。
