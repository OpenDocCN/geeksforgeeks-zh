...
> 原文: [https://www.geeksforgeeks.org/basic-configuration-of-adaptive-security-appliance-asa/](https://www.geeksforgeeks.org/basic-configuration-of-adaptive-security-appliance-asa/)
...
#### 2. 为 ASA 的接口分配一个 IP 地址

打开接口后，通过命令分配一个 IP 地址
