...
## 先决条件
[Web 1.0、Web 2.0 和 Web 3.0](https://www.geeksforgeeks.org/web-1-0-web-2-0-and-web-3-0-with-their-difference/)
...
由于 `Web3` 仍处于开发阶段，人们会发现 `Web3` 有两个版本，即 `v0.x.x` 和 `v1.x.x`。前者支持原语接口——仅支持异步代码的回调，而后者支持`承诺+异步/等待`。简而言之，两个版本的语法都有显著差异，后者是前者的改进版本。
