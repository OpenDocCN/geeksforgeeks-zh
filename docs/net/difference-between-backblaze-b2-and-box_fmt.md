# Backblaze B2 和 Box 的区别

> 原文：[https://www.geeksforgeeks.org/difference-between-backblaze-b2-and-box/](https://www.geeksforgeeks.org/difference-between-backblaze-b2-and-box/)
...
| B2 | Box |
| --- | --- |
| 它由 **Backblaze Corporation** 所有。 | 它属于 **Box 公司**。 |
| 它于 2015 年推出。 | 它于 2005 年推出。 |
| 由 **Backblaze** 开发。 | 它是由**亚伦·列维**和**迪伦·史密斯**开发的。 |
