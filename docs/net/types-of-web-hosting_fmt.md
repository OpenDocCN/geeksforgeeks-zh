...
> 原文：`https://www.geeksforgeeks.org/types-of-web-hosting/`
...
## 2. 共享/虚拟托管
这是一种网络托管服务，许多网站驻留在一个连接到互联网的网络服务器上。这种类型的托管是以自己的域名 `www.yourname.com` 提供的。有了 web 托管公司的托管计划，一个人可以以完全独立的身份向他/她的网络观众展示自己。
