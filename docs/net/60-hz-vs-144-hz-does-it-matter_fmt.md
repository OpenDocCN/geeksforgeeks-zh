...
> 原文: [https://www.geeksforgeeks.org/60-hz-vs-144-hz-does-it-matter/](https://www.geeksforgeeks.org/60-hz-vs-144-hz-does-it-matter/)
...
对于一个正常人来说，观察不同显示器之间的差异可能是困难的。但是对于游戏玩家来说，显示器上的这些微小差异可能是生与死的界限，也可能是主宰严肃比赛的关键，尤其是像 `CS:GO`、`Overwatch`、`Rainbow Six Seige`、`堡垒之夜` 和 `PUBG` 这样的 `FPS` 游戏。
