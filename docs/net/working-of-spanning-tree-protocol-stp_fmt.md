...
> 原文: [https://www.geeksforgeeks.org/working-of-spanning-tree-protocol-stp/](https://www.geeksforgeeks.org/working-of-spanning-tree-protocol-stp/)
...
1.  根交换机的选择。它的所有接口都处于转发状态。
2.  所有其他非根交换机构成一个根端口。根端口是到根交换机路径开销最小的端口。所有根端口都处于转发状态。
3.  从每台交换机到根交换机的最小路径开销称为该交换机的根开销。在所有交换机中，根开销最小的交换机成为指定交换机。计算根开销的指定交换机端口成为指定端口(`DP`)。`DP` 处于转发状态。
...
![Root switch election](img/e0065919bce1b68eaac3c1ff1527a9b1.png)
...
![Root port selection on Non-root switches](img/d4a523c4995f1de2bbff318abff5933e.png)
