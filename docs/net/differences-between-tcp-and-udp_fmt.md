...
> 原文: [`https://www.geeksforgeeks.org/differences-between-tcp-and-udp/`](https://www.geeksforgeeks.org/differences-between-tcp-and-udp/)

先决条件–[`传输层职责`](https://www.geeksforgeeks.org/computer-network-transport-layer-responsibilities/)、 [`TCP`](https://www.geeksforgeeks.org/computer-network-tcp-congestion-control/) 、 [`UDP`](https://www.geeksforgeeks.com/computer-network-user-datagram-protocol-udp/)
