...
> 原文: [https://www.geeksforgeeks.org/difference-between-imap-and-smtp/](https://www.geeksforgeeks.org/difference-between-imap-and-smtp/)
...
| 序号 | 互联网消息访问协议 (IMAP) | 简单邮件传输协议 (SMTP) |
| :--- | :--- | :--- |
