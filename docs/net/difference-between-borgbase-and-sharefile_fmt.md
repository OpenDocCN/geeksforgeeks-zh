...
> 原文：[https://www.geeksforgeeks.org/difference-between-borgbase-and-sharefile/](https://www.geeksforgeeks.org/difference-between-borgbase-and-sharefile/)
...
| 它只被类似 `Unix` 的操作系统支持。 | `Windows`、`macOS`、`iOS`、`安卓` 操作系统都支持。 |