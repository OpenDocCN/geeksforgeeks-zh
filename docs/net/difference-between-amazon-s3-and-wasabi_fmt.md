...
> 原文：[https://www.geeksforgeeks.org/difference-between-amazon-s3-and-wasabi/](https://www.geeksforgeeks.org/difference-between-amazon-s3-and-wasabi/)
...
山葵是一种文件托管和云存储服务，由山葵技术公司提供。它是一种对象存储服务。它于 2017 年由 `Wasabi` 技术公司推出。它不提供免费存储空间。它为付费用户提供无限的最大存储空间。又称**山葵热储**或**山葵热云存储**。
