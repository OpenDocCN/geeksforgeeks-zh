...
> 原文：[https://www.geeksforgeeks.org/basics-of-ns2-and-otcltcl-script/](https://www.geeksforgeeks.org/basics-of-ns2-and-otcltcl-script/)
...
说明：在第一行中，变量 `a` 被赋予值 8。在第二行中，命令 `[expr $a/8]` 的结果等于 1，然后用作另一个命令的参数，该命令又为变量 `b` 赋值。`$` 符号用于获取变量中包含的值，方括号表示命令替换。
