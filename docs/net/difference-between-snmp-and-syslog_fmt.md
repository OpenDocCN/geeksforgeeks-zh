...
> 原文: [https://www.geeksforgeeks.org/difference-between-snmp-and-syslog/](https://www.geeksforgeeks.org/difference-between-snmp-and-syslog/)
...
| 3. | 它的陷阱以二进制格式共享。 | 它的事件以纯文本格式共享。 |
| 4. | 这是一个主动协议。 | 这是一个被动协议。 |
| 5. | 很安全。 | 它不安全。 |
| 6. | 它被称为获取实时信息。 | 它是指获取历史数据。 |
| 7. | 它用于对关键操作发出警报，如提到的热斯坦比路由器协议(`HSRP`)状态变化。 | 它可以让运维人员找出为什么会发生这种热斯坦比路由器协议(`HSRP`)状态变化。 |
