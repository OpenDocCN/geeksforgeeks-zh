...
> 原文: [https://www.geeksforgeeks.org/difference-between-wifi-repeater-and-wifi-extender/](https://www.geeksforgeeks.org/difference-between-wifi-repeater-and-wifi-extender/)
...
| 编号 | WiFi 中继器 | WiFi 扩展器 |
| :--- | :--- | :--- |
| 01 | WiFi 中继器在信号较弱的区域重新广播信号意味着现有信号强度较弱。 | WiFi 扩展器扩展了现有网络覆盖区域的范围，创建了更大的网络覆盖区域。 |
