...
> 原文：[https://www.geeksforgeeks.org/wireless-media-access-issues-in-internet-of-things/](https://www.geeksforgeeks.org/wireless-media-access-issues-in-internet-of-things/)
...
观察到的非常重要的问题是：半双工操作、时变信道和突发信道错误。这些解释如下。
...
突发信道错误被称为在通信信道中接收的连续符号序列，其中第一个和最后一个符号有错误，并且没有证据表明已校正的接收符号的连续子序列。当使用时变信道时，会引入信号强度，从而在传输中观察到误差。对于有线网络中的这些信道，比特率高达 `10^-3`。