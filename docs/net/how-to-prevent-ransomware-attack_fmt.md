...
> 原文：[https://www.geeksforgeeks.org/how-to-prevent-ransomware-attack/](https://www.geeksforgeeks.org/how-to-prevent-ransomware-attack/)

`Ransomware` 是一种恶意软件，犯罪分子攻击用户的个人数据，威胁用户在线发布，或者 `Ransomware` 攻击者可以阻止用户访问他的数据，并要求支付赎金金额来解除阻止。
...
*   **WannaCry**
    `WannaCry` 是一种加密文件的勒索软件计算机蠕虫，于 2017 年 5 月 12 日首次发布。索要的赎金从 300 美元到 600 美元不等，将以比特币支付。`WannaCrypt`、`WCry`、`Wana Decrypt0r 2.0`、`WannaCrypt0r 2.0` 和 `Wanna Decryptor` 都是 `WannaCry ransomware` 的名称。
