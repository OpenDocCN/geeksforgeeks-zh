...
> 原文：[https://www.geeksforgeeks.org/difference-between-box-and-securesafe/](https://www.geeksforgeeks.org/difference-between-box-and-securesafe/)
...
| Box | SecureSafe |
| --- | --- |
| 它属于`Box Incorporation`。 | 归`DSwiss AG`所有。 |
| 它于`2005`年推出。 | 它于`2009`年推出。 |
| 它是由`Aaron Levie`和`Dylan Smith`开发的。 | 由`DSwiss AG`开发。 |
