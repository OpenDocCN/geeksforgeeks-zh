...
> 原文：[https://www.geeksforgeeks.org/difference-between-borgbase-and-wasabi/](https://www.geeksforgeeks.org/difference-between-borgbase-and-wasabi/)
...
## 2. 芥末:
芥末是一种文件托管和云存储服务，由芥末技术公司提供。它是一种对象存储服务。它于 2017 年由 `Wasabi` 技术公司推出。它不提供免费存储空间。它为付费用户提供无限的最大存储空间。又称 `Wasabi Hot Storage` 或 `Wasabi Hot Cloud Storage`。

## 枸杞和山葵的区别:

| BorgBase | Wasabi |
| --- | --- |
| 它归博格人集体所有。 | 它由 `Wasabi Technologies Inc.` 所有。 |
| 它于 2010 年推出。 | 它于 2017 年推出。 |
| 它是由博格人集体开发的。 | 它是由 `Wasabi Technologies Inc.` 开发的。 |
