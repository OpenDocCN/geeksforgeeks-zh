...
> 原文: [https://www.geeksforgeeks.org/lightweight-directory-access-protocol-ldap/](https://www.geeksforgeeks.org/lightweight-directory-access-protocol-ldap/)

`LDAP` 是一种工作在 `TCP/IP` 上的互联网协议，用于从目录中访问信息。`LDAP` 协议基本上用于访问活动目录。
