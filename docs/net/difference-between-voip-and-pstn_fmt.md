...
> 原文: [https://www.geeksforgeeks.org/difference-between-voip-and-pstn/](https://www.geeksforgeeks.org/difference-between-voip-and-pstn/)
...
公共交换电话网基于电路交换概念。当两部电话之间建立了专用路径时，它们之间就建立了电路。所有的座机都是公共交换电话网。

## VoIP 和 PSTN 的区别

| 序号 | VoIP（互联网协议语音） | PSTN（公共交换电话网） |
| :--- | :--- | :--- |
