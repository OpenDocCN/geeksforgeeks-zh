...
> 原文: [https://www.geeksforgeeks.org/difference-between-ntp-and-ptp/](https://www.geeksforgeeks.org/difference-between-ntp-and-ptp/)

## 1. 网络时间协议(NTP)

它是一种促进系统中计算机时钟时间同步的协议。该协议是一种应用协议，适用于 `TCP/IP` 网络上的主机同步。1981 年，特拉华大学的大卫·米尔斯解释了 `NTP`。这在通信机制中是需要的，以便在机器之间开始无缝连接。
...
| 4. | 它设计用于公共网络和广域网(`WAN`)。 | 它的设计版本包括局域网的版本 1 和广域网的版本 2。 |
