...
> 原文：[https://www.geeksforgeeks.org/difference-between-jumpshare-and-pcloud/](https://www.geeksforgeeks.org/difference-between-jumpshare-and-pcloud/)
...
| JUMPSHARE | pCloud |
| --- | --- |
| 它由 `Jumpshare Inc.` 所有。 | 归 `pCloud AG` 所有。 |
| 它于 `2012` 年推出。 | 它于 `2013` 年推出。 |
| 它是由 `Jumpshare Inc.` 开发的。 | 由 `pCloud AG` 开发。 |
...
| 最大文件大小为免费 `250 MB`，付费不限。 | 此处的最大文件大小不受限制。 |
| 它不支持客户端加密。 | 它支持客户端加密。 |
