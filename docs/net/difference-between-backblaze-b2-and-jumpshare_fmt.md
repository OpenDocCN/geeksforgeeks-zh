# Backblaze B2 和 Jumpshare 的区别

> 原文：[https://www.geeksforgeeks.org/difference-between-backblaze-b2-and-jumpshare/](https://www.geeksforgeeks.org/difference-between-backblaze-b2-and-jumpshare/)
...
| B2 | JUMPSHARE |
| --- | --- |
| 它由 `Backblaze Corporation` 所有。 | 它由 `Jumpshare Incorporation` 所有。 |
