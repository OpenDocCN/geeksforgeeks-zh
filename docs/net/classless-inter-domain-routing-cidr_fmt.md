...
> 原文：[https://www.geeksforgeeks.org/classless-inter-domain-routing-cidr/](https://www.geeksforgeeks.org/classless-inter-domain-routing-cidr/)
...
它也是一个 32 位地址，包括一个特殊的数字，代表块标识中的位数。
