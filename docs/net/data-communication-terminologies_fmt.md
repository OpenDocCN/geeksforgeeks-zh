...
> 原文: [https://www.geeksforgeeks.org/data-communication-terminologies/](https://www.geeksforgeeks.org/data-communication-terminologies/)
...
| 序号 | 速度 | 表示为 | 完全形式 |
| :--- | :--- | :--- | :--- |
| 1 | 每秒千位的速率 | `Kbps` | 每秒千比特 |
| 2 | 每秒千字节的速率 | `KBps` | 每秒千字节数 |
| 3 | 每秒百万位的速率 | `Mbps` | 每秒兆位 |
| 4 | 每秒百万字节的速率 | `MBps` | 每秒兆字节 |

### 4. 带宽

是通信系统工作的频率范围。它通常测量在给定时间内通过数据通道传输的数据量。这是数据通道最高频率和最低频率之间的差异。频率的测量单位是每秒周期数，即赫兹。

| 序号 | 信号的类型 | 频率范围(赫兹) | 带宽(赫兹) |
| :--- | :--- | :--- | :--- |
| 1 | 语音信号 | 300-3400 | 3,100 |
| 2 | 电视信号 | 0-5 兆赫 | 5 兆赫 |
| 3 | 数字数据 | 300-3400 | 3,100 |
| 4 | 音乐信号 | 20-15000 | 14,980 |
