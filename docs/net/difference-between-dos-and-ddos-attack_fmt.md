...
> 原文: [https://www.geeksforgeeks.org/difference-between-dos-and-ddos-attack/](https://www.geeksforgeeks.org/difference-between-dos-and-ddos-attack/)
...
在 `DDOS` 攻击中是指分布式拒绝服务，在这种攻击中 `DOS` 攻击是从许多不同的位置使用许多系统完成的。
...
| `DOS` 攻击的类型有：<br>1. 缓冲区溢出攻击<br>2. 死亡之平或 `ICMP` 洪水<br>3. 泪滴攻击 | |
