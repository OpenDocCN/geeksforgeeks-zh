...
> 原文：[https://www.geeksforgeeks.org/difference-between-securesafe-and-ubuntu-one/](https://www.geeksforgeeks.org/difference-between-securesafe-and-ubuntu-one/)
...
| SecureSafe | Ubuntu One |
| --- | --- |
| 归 `DSwiss AG` 所有。 | 它由 `Canonical Limited` 所有。 |
| 它于 2009 年推出。 | 它也于 2009 年推出。 |
| 它提供 100 兆的可用存储空间。 | 它还提供了 5 GB 的可用存储空间。 |
| 由 `DSwiss AG` 开发。 | 由 `Canonical Limited` 开发。 |
