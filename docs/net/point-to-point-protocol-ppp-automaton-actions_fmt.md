...
> 原文：[https://www.geeksforgeeks.org/point-to-point-protocol-ppp-automaton-actions/](https://www.geeksforgeeks.org/point-to-point-protocol-ppp-automaton-actions/)
...
## 10. scn
此操作标签表示“发送配置 nak/rej”。每当发送配置-nak 或配置-拒绝数据包时，此操作都会确认收到配置-请求数据包以及一组错误的配置选项。该动作执行如下：
