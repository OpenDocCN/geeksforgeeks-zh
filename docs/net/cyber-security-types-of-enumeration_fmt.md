...
> 原文: [https://www.geeksforgeeks.org/cyber-security-types-of-enumeration/](https://www.geeksforgeeks.org/cyber-security-types-of-enumeration/)
...
*   中小型企业列表是任何笔测试人员的重要专业知识。在弄清楚如何计算 `SMB` 之前，我们应该先了解什么是 `SMB`。`SMB` 代表服务器消息块。
