...
> 原文: [https://www.geeksforgeeks.org/difference-between-can-and-man/](https://www.geeksforgeeks.org/difference-between-can-and-man/)

## 1. 校园网 (CAN)

校园网 (CAN) 是指在有限的地理区域内，如学校校园、大学校园、军事基地或组织校园、公司大楼等，相互连接的一组局域网 (LAN)。校园网比局域网大，但比城域网和广域网小。

![CAN示意图](img/b66500b21d5c5f4ac1f496c5e24c3523.png)

## 2. 城域网 (MAN)

城域网覆盖面积比局域网最大的如: 小城镇、城市等。城域网连接 2 台或多台计算机，这些计算机以区域为单位分开，但位于相同或完全不同的城市。MAN 是昂贵的，应该或不应该由一个组织拥有。

![MAN示意图](img/6c2d398535f80c16b7a25fd369b3f7ae.png)
