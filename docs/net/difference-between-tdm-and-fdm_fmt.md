...
> 原文: [https://www.geeksforgeeks.org/difference-between-tdm-and-fdm/](https://www.geeksforgeeks.org/difference-between-tdm-and-fdm/)
...
| 7. | 在时分复用中，同步脉冲是必要的。 | 在里面，守卫带 (`guard bands`) 是必要的。 |