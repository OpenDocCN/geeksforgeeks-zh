...
> 原文: [https://www.geeksforgeeks.org/difference-between-pdh-and-sdh/](https://www.geeksforgeeks.org/difference-between-pdh-and-sdh/)

## 1. 准同步数字体系 (PDH)

`PDH` 代表准同步数字体系。它是一种电信网络传输技术，旨在通过大规模数字网络传输大量数据。在分组数据业务中，将 `2兆比特/秒` 的信号多路转换成更高阶的多路信号。交换机站点之间的电缆铺设非常昂贵。它通过提高比特率来增加电缆的流量。
