...
> 原文：[https://www.geeksforgeeks.org/difference-between-cloudme-and-ubuntu-one/](https://www.geeksforgeeks.org/difference-between-cloudme-and-ubuntu-one/)
...
| CLOUDME | UBUNTU ONE |
| --- | --- |
| 归 `CloudMe AB` 所有。 | 它由 `Canonical Limited` 所有。 |
| 它于 2011 年推出。 | 它于 2009 年推出。 |
| 它提供 3 GB 的可用存储空间。 | 它提供了 5 GB 的可用存储空间。 |
| 它是由丹尼尔·阿瑟森开发的。 | 由 `Canonical Limited` 开发。 |
...
| 支持 `Windows`、`OS X`、`Linux`、`iOS`、`安卓`。 | 它支持 `Windows`、`OS X`、`iOS`、`Ubuntu` 和 `安卓`。 |
