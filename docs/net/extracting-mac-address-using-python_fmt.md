...
> 原文: [https://www.geeksforgeeks.org/extracting-mac-address-using-python/](https://www.geeksforgeeks.org/extracting-mac-address-using-python/)
...
## 方法三: 使用 getnode() + format() 【为了更好的格式化】
