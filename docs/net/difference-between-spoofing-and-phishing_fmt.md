...
> 原文: [`https://www.geeksforgeeks.org/difference-between-spoofing-and-phishing/`](https://www.geeksforgeeks.org/difference-between-spoofing-and-phishing/)
...
| **类型:** `IP 欺骗`、`邮件欺骗`、`网址欺骗`等。 | **类型:** `电话钓鱼`、`克隆钓鱼`等。 |