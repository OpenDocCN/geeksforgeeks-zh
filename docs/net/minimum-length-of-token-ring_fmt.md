...
## 先决条件
–[令牌环帧格式](https://www.geeksforgeeks.org/computer-network-token-ring-frame-format/)、[令牌环的效率](https://www.geeksforgeeks.com/computer-network-efficiency-token-ring/)、[令牌环的问题](https://www.geeksforgeeks.org/computer-networks-problems-with-token-ring/)
...
因此，环的大小必须大于`(24 * velocity) / Bandwidth`。
