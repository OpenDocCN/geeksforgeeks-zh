...
> 原文: [https://www.geeksforgeeks.org/introduction-to-sshsecure-shell-keys/](https://www.geeksforgeeks.org/introduction-to-sshsecure-shell-keys/)
...
`SSH` 是基于密比的认证，不容易受到[蛮力攻击](https://en.wikipedia.org/wiki/Brute-force_attack)。
