...
> 原文：[https://www.geeksforgeeks.org/differences-between-flutter-and-xamarin/](https://www.geeksforgeeks.org/differences-between-flutter-and-xamarin/)
...
## 2. Xamarin
这是一个开源框架，一个跨平台的工具包，有助于开发移动应用，也允许我们生产 iOS 和 Android 应用。它基于 `C#` 语言的概念，由微软推出。它使用 `HTML` 和 `JavaScript` 通过 `Mono` 框架开发和管理任何应用的 UI，`Mono` 框架可以帮助与频繁的蜂窝机功能的 API 进行通信。
