...
> 原文：[https://www.geeksforgeeks.org/difference-between-qr-code-bar-code-and-nfc/](https://www.geeksforgeeks.org/difference-between-qr-code-bar-code-and-nfc/)
...
## 2. 二维码
[二维码](https://www.geeksforgeeks.org/how-to-generate-and-read-qr-code-with-java-using-zxing-library/)是用来存储数据的二维条码。二维码扫描仪扫描这些代码，以获取存储在其中的信息。它们是 1994 年在日本开发的。它们是一种存储多媒体数据（视频、音频、图片、链接等）的方法。）水平和垂直。
...
## 3. 近场通信（NFC）
[近场通信（NFC）](https://www.geeksforgeeks.org/near-field-communication-nfc/)于 2002 年由飞利浦和索尼推出。NFC 是一种近场通信方法，在保持 4 厘米或更短距离的两个设备之间传输数据变得非常有用。它基于耦合原理（电感耦合）。
