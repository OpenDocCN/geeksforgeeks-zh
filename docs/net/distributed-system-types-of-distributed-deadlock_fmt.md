...
> 原文:[https://www.geeksforgeeks.org/distributed-system-types-of-distributed-deadlock/](https://www.geeksforgeeks.org/distributed-system-types-of-distributed-deadlock/)
...
*   也可以使用`与`条件来表示，因为进程只有在拥有所有所需资源的情况下才会执行。
