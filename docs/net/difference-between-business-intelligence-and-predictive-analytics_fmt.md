...
> 原文：[https://www.geeksforgeeks.org/difference-between-business-intelligence-and-predictive-analytics/](https://www.geeksforgeeks.org/difference-between-business-intelligence-and-predictive-analytics/)
...
| 没有。 | 商业智能 | 预测分析 |
| --- | --- | --- |
| 1. | 它是关于`描述性分析`或对发生的事情进行搜索。 | 它是关于发现隐藏的模式，使用复杂的算法来帮助预测未来的输出。 |
...
| 5. | 它具有特别报告技术、警报技术等。 | 它包括`预测建模`、预测等技术。 |
