...
> 原文:[https://www.geeksforgeeks.org/virtual-reality-vs-immersive-technology/](https://www.geeksforgeeks.org/virtual-reality-vs-immersive-technology/)
...
虚拟现实的重点是模拟视觉。用户需要将`VR`耳机屏幕放在眼前。因此，消除了与现实世界的任何互动。在虚拟现实中，两个镜头放在屏幕之间。用户需要根据眼睛的单独运动及其位置来调整眼睛。屏幕上的视觉效果可以通过连接到电脑或手机的高清晰度多媒体接口（`HDMI`）电缆来呈现。
