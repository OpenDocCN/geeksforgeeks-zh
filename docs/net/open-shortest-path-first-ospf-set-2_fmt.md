...
> 原文:[https://www.geeksforgeeks.org/open-shortest-path-first-ospf-set-2/](https://www.geeksforgeeks.org/open-shortest-path-first-ospf-set-2/)
...
OSPF 使用 100 Mbps 的参考带宽进行成本计算。计算成本的公式是参考带宽除以接口带宽。例如，在以太网的情况下，它是：
```
10 Mbps / 10 Mbps = 1
```