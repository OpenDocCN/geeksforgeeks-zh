...
> 原文：[https://www.geeksforgeeks.org/ip-addressing-classless-addressing/](https://www.geeksforgeeks.org/ip-addressing-classless-addressing/)
...
将一大块地址划分成几个连续的子块，并将这些子块分配给不同的较小网络，称为划分子网。当进行无类寻址时，这是一种广泛使用的做法。
...
**解决方法**：这是一个 B 类地址。所以，子网数量 = `2^(25-16) = 2^9 = 512`。

每个子网的主机数量 = `2^(32-25) – 2 = 2^7 – 2 = 128 – 2 = 126`
...
*   GATE | GATE CS 2006 | 问题 45
*   GATE | GATE CS 2007 | 问题 67
*   GATE | GATE CS 2008 | 问题 57
*   GATE | GATE CS 2010 | 问题 47
*   GATE | GATE CS 2012 | 问题 21
