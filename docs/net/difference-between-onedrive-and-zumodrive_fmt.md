...
| 特性 | OneDrive | ZumoDrive |
| :--- | :--- | :--- |
| **所有权** | 它归**微软公司**所有。 | 最初由**泽克特公司**拥有，但后来被**摩托罗拉移动**拥有。 |
| **推出年份** | 它于 2007 年推出。 | 它于 2009 年推出。 |
| **免费存储空间** | 它提供了 5 GB 的可用存储空间。 | 它提供了 2 GB 的可用存储空间。 |
| **开发者** | 是**微软**开发的。 | 由**泽克特公司**开发。 |
| **最大存储容量** | 它的最大存储容量为 5 TB。 | 此处提供的最大存储大小为 500 GB。 |
| **服务类型** | 它是一个文件托管、文件同步和云存储服务。 | 它是一种文件托管、文件同步和基于云的文件存储服务。 |
| **当前状态** | 它仍在使用中。 | 这项服务于 2012 年暂停。 |
| **最大文件大小** | 这里的最大文件大小是 100 GB。 | 最大文件在这里没有限制。 |
| **智能缓存** | 它不提供智能预测缓存。 | 它提供了智能预测缓存。 |
| **主要用户** | 它基本上是由专业人员用来存储数据的。 | 它被用于个人和专业数据。 |