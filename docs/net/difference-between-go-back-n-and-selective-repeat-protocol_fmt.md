...
> 原文: [https://www.geeksforgeeks.org/difference-between-go-back-n-and-selective-repeat-protocol/](https://www.geeksforgeeks.org/difference-between-go-back-n-and-selective-repeat-protocol/)
...
| 9. | 回退 N 协议的效率为 `N/(1+2*a)` | 选择性重复协议的效率也是 `N/(1+2*a)` |