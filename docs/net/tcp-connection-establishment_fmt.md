...
## 先决条件
– [TCP 三次握手过程](https://www.geeksforgeeks.org/computer-network-tcp-3-way-handshake-process/)
...
2.  TCP 是一种全双工协议，因此发送方和接收方都需要一个窗口来接收对方的消息。
    ...
    *   **窗口大小(`window=10000 B`):** 接收者告诉他的缓冲容量，他必须在其中存储来自发送者的消息。
