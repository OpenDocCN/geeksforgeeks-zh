...
> 原文: [https://www.geeksforgeeks.org/difference-between-onedrive-and-yandex-disk/](https://www.geeksforgeeks.org/difference-between-onedrive-and-yandex-disk/)
...
| 微软云储存 | YANDEX DISK |
| --- | --- |
| 它归`Microsoft`所有。 | 归`Yandex`所有。 |
| 它于 2007 年推出。 | 它于 2012 年推出。 |
| 是`Microsoft`开发的。 | 由`Yandex`开发。 |
