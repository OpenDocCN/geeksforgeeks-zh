...
> 原文: [https://www.geeksforgeeks.org/difference-between-thunderbolt-and-usb-c/](https://www.geeksforgeeks.org/difference-between-thunderbolt-and-usb-c/)
...
## 2. `USB-C`
外观类似 `USB` B 型，但尺寸略小。有了 `U` 盘，你可以把相机、`mp3` 播放器和其他小设备连接到电脑上。它最特别的一点就是可以从两面使用。这种通用串行总线端口使设备可以选择多种连接方式。除了所有这些，它还可以非常快速地执行数据传输。
