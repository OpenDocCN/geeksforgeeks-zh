...
> 原文: [https://www.geeksforgeeks.org/basic-frame-structure-of-sdlc/](https://www.geeksforgeeks.org/basic-frame-structure-of-sdlc/)
...
信息(`I`)字段紧跟在控制字段之后。该字段为可选字段，主要包含信息数据。需要在数据链路上传输的数据就在这个字段中。
