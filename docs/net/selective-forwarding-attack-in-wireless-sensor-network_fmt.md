...
> 原文：[https://www.geeksforgeeks.org/selective-forwarding-attack-in-wireless-sensor-network/](https://www.geeksforgeeks.org/selective-forwarding-attack-in-wireless-sensor-network/)
...
*   恶意节点禁止信息从授权节点流向基站。从而导致`拒绝服务攻击`，通过攻击整个网络，限制信息从每个节点流向汇聚节点，可以转化为黑洞攻击。
