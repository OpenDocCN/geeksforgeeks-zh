...
> 原文：`https://www.geeksforgeeks.org/goals-of-networks/`
...
1.  **资源共享**
    许多组织都有大量运行中的计算机，这些计算机位于不同的位置。例如，一群上班族可以共用一台打印机、传真机、调制解调器、扫描仪等。
...
4.  **灵活访问**
    文件可以从网络中的任何计算机访问。项目可以在一台计算机上开始，在另一台计算机上完成。
