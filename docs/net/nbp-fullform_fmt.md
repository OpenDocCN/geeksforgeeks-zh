...
> 原文：`https://www.geeksforgeeks.org/nbp-fullform/`

`NBP` 代表名称绑定协议，是[开放系统互连(`OSI`)模型](https://www.geeksforgeeks.org/layers-of-osi-model/)传输层的一部分，用于将实体名称绑定到内部存储地址。它记录这些映射，以便其他实体进行查找。
