...
> 原文：[https://www.geeksforgeeks.org/difference-between-sharefile-and-pcloud/](https://www.geeksforgeeks.org/difference-between-sharefile-and-pcloud/)
...
| ShareFile | pCloud |
| --- | --- |
| 它归 Citrix Systems 公司所有。 | 归 **pCloud AG** 所有。 |
| 它于 2005 年推出。 | 它于 2013 年推出。 |
| 它是由 Jesse Lipson 开发的。 | 由 **pCloud AG** 开发。 |
