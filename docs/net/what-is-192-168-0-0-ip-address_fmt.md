...
`192.168.0.0` 不被移动或计算机设备使用，因为它是 `C 块`的起始 IP，起始地址用于网络标识，类似地，最后一个值(`192.168.0.0`)被分配给广播流量，因此它也不能被设备使用。
...
| 网络掩码 | 起点 | 终点 | 可能的主机总数 |
| :--- | :--- | :--- | :--- |
| `192.168.0.0/16` | `192.168.0.0` | `192.168.255.255` | Sixty-five thousand five hundred and thirty-four |
