...
> 原文：[https://www.geeksforgeeks.org/difference-between-fastag-bar-code-and-nfc/](https://www.geeksforgeeks.org/difference-between-fastag-bar-code-and-nfc/)

## 1. Fastag
`Fastag` 彻底改变了通行费的缴纳方式。它由印度国家支付公司开发，由负责高速公路的政府机构印度国家公路局（`NHAI`）使用。这是一个印刷标签，使用射频识别（`RFID`）技术进行电子收税。
