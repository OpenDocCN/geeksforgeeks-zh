...
> 原文: [https://www.geeksforgeeks.org/application-layer-in-osi-model/](https://www.geeksforgeeks.org/application-layer-in-osi-model/)

**先决条件:** [OSI 模型的分层](https://www.geeksforgeeks.org/layers-of-osi-model/)
...
4.  [**FTP**](https://www.geeksforgeeks.org/file-transfer-protocol-ftp-in-application-layer/) –
