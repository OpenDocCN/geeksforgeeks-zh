...
互联网是互联设备的集合，而 WWW 是用来存储超文本的系统。使用互联网我们可以访问这些文档。万维网是存储超文本的服务器的集合。

## WWW 的工作原理

基本的客户端-服务器模型用于访问网页。服务器存储网页，客户端通过提供[统一资源定位符](https://www.geeksforgeeks.org/url-full-form/)请求该网页。我们一在搜索栏输入网址，万维网就进来播放和定位网页。
...
3.  Berners-Lee，之前命名为“Web”，曾考虑过“information network”、“information mine”和“information mine”这些名称。
4.  编写程序代码的系统是 Steve Jobs 开发的 NeXt。
5.  1993年，万维网向所有人免费开放。