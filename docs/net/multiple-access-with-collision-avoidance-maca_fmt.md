...
> 原文：`https://www.geeksforgeeks.org/multiple-access-with-collision-avoidance-maca/`

**冲突避免多址接入(MACA)** 是无线自组织网络中使用的一种媒体访问控制(`MAC`)层协议。用于解决隐藏终端问题和暴露终端问题。它是载波侦听多路访问(`CSMA`)的一种替代方案，具有隐藏终端问题和暴露终端问题。
