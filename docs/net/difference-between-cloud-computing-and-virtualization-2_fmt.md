...
> 原文：[https://www.geeksforgeeks.org/difference-between-cloud-computing-and-virtualization-2/](https://www.geeksforgeeks.org/difference-between-cloud-computing-and-virtualization-2/)
...
| 可量测性 | 高的 | 低的 |
| 设置 | 沉闷的 | 简单的 |
| 费用 | 私有云：高资本支出和低 `OPEX`<br>公共云：低资本支出和高 `OPEX` | 高资本支出（资本支出）<br>低运营支出（`OPEX`） |
| 灵活性 | 非常灵活 | 相当少 |
| 服务类型 | `Laas` | `Saas` |
| 专用硬件 | 多重 | 单身也可以工作 |
| 综合 | 用户、应用等的未来扩展 | 在同一基础架构内扩展新机器 |
| 工作量 | 无国籍的 | 宏伟威严的 |
