...
> 原文：[https://www.geeksforgeeks.org/how-to-change-dns-server-settings-windows-mac-ubuntu-and-android/](https://www.geeksforgeeks.org/how-to-change-dns-server-settings-windows-mac-ubuntu-and-android/)
...
打开系统偏好设置搜索网络并点击 WiFi，转到高级设置，然后点击 DNS。在域名系统中，您可以选择输入您的自定义域名系统 IP 地址。
...
打开 WiFi 设置，点击与你的 WiFi 网络对应的设置，然后转到 IPV4，禁用自动 DNS，输入你的 DNS 服务器 IP 地址，点击应用。
...
打开你的安卓手机上的 WiFi 设置，之后打开你连接的 WiFi 网络的设置，之后添加你的 DNS 服务器的 IP 地址。
