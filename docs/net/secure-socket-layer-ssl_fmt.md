...
*   **警告:** 此警报对发送方和接收方之间的连接没有影响。
*   **致命错误:** 此警报断开发送方和接收方之间的连接。
...
参见【安全套接字层(SSL)和传输层安全性(TLS)】之间的[区别](https://www.geeksforgeeks.org/difference-between-secure-socket-layer-ssl-and-transport-layer-security-tls/)。