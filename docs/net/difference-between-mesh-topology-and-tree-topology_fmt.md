...
> 原文：[https://www.geeksforgeeks.org/difference-between-mesh-topology-and-tree-topology/](https://www.geeksforgeeks.org/difference-between-mesh-topology-and-tree-topology/)
...
树状拓扑是一种网络拓扑，其中节点以树的设计进行组织。树形拓扑由分支电缆开始的根节点组成，分支电缆以分层方式将根节点与所有其他节点连接起来。树形拓扑比网状拓扑便宜。
...
| 6. | 网状拓扑非常昂贵，因为使用的电缆更多。 | 与网状拓扑相比，树形拓扑的成本更低。 |