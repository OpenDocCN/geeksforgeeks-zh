# Tresorit 和 Yandex Disk 的区别

> 原文：[https://www.geeksforgeeks.org/difference-between-tresorit-and-yandex-disk/](https://www.geeksforgeeks.org/difference-between-tresorit-and-yandex-disk/)
...
| 它不支持开发人员 `API`。 | 开发者 `API` 是 `REST`、`WebDAV` 和 `SDK`。 |
