...
> 原文：[https://www.geeksforgeeks.org/fixed-and-flooding-routing-algorithms/](https://www.geeksforgeeks.org/fixed-and-flooding-routing-algorithms/)
...
*   跳计数器可以包含在分组报头中，在每一跳递减。当计数器变为零时，数据包被丢弃
