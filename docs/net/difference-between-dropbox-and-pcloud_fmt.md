...
> 原文：[https://www.geeksforgeeks.org/difference-between-dropbox-and-pcloud/](https://www.geeksforgeeks.org/difference-between-dropbox-and-pcloud/)
...
| DROPBOX | pCloud |
| --- | --- |
| 它属于`Dropbox Incorporation`。 | 归 `pCloud AG` 所有。 |
| 它于 `2007` 年推出。 | 它于 `2013` 年推出。 |
| 它是由德鲁·休斯顿和阿拉什·菲尔多西开发的。 | 由 `pCloud AG` 开发。 |
