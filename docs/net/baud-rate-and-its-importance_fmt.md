...
*   在图像 1 中，信号元素的数量(用红色标记)= 3，传输的位数(1，0，1) = 3。所以，这里比特率= 3/1 =每秒 3 比特。并且，波特率= 3/1 =每秒 3 波特。

![Baud Rate](img/9bf577564f812dca32ae162bf2480bda.png)

图像 2

*   在图像 2 中，信号元素的数量(用红色标记)= 6，传输的位数(1，1，0) = 3。所以，这里比特率= 3/1 =每秒 3 比特。并且，波特率= 6/1 = 6 波特每秒。
