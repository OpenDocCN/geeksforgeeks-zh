...
> 原文：[https://www.geeksforgeeks.org/difference-between-fastag-and-nfc/](https://www.geeksforgeeks.org/difference-between-fastag-and-nfc/)

## 1. Fastag
印度国家公路局使用一种独特的方法征收税款。这是 2014 年开发的技术。它使用`射频识别`技术，在征收通行费期间进行更快、更容易的交易。
