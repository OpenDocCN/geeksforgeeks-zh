...
> 原文: [https://www.geeksforgeeks.org/interactive-zero-knowledge-proof/](https://www.geeksforgeeks.org/interactive-zero-knowledge-proof/)

[零知识证明(ZKP)](https://www.geeksforgeeks.org/zero-knowledge-proof/) 的目标是让被称为“验证者”的一方，通过满足某些关系而不向其他任何人透露“见证”，来证明自己是某些信息的拥有者。交互式零知识证明需要验证者和证明者的实时交互。
