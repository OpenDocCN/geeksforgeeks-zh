...
> 原文: [https://www.geeksforgeeks.org/how-to-prevent-broken-access-control/](https://www.geeksforgeeks.org/how-to-prevent-broken-access-control/)
...
[**在线社区 `OWASP`(开放 web 应用安全项目)**](https://www.geeksforgeeks.org/owasp-top-10-vulnerabilities-and-preventions/) 分析 Web 应用的弱点和攻击，给出了十大最危险的漏洞列表，`Broken Access Control` 就是其中之一。这表明大多数 web 应用程序的安全性很差。为了防止访问控制中断，安全团队可以采用以下做法:
