...
## [波分复用(WDM)](https://practice.geeksforgeeks.org/problems/what-is-wdm)

WDM 代表波分复用。这是一种光纤传输技术，便于使用多种光波长(或颜色)在同一介质上发送数据。在一根光纤上，两种或更多种颜色的光可以传播，几个信号可以在光波导中以不同的波长或光谱上的不同频率传输。

![](img/5afb21ed4deacf80f49ac8444914a9b7.png)

## [同步光网络(SONET)](https://www.geeksforgeeks.org/synchronous-optical-network-sonet/)
