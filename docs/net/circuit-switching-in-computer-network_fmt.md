...
> 原文: [https://www.geeksforgeeks.org/circuit-switching-in-computer-network/](https://www.geeksforgeeks.org/circuit-switching-in-computer-network/)
...
要了解电路交换和分组交换的区别，请参考–[带电路交换的区别&分组交换](https://www.geeksforgeeks.org/computer-network-circuit-switching-vs-packet-switching/)
