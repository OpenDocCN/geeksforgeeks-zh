...
> 原文：[https://www.geeksforgeeks.org/difference-between-browsing-and-surfing/](https://www.geeksforgeeks.org/difference-between-browsing-and-surfing/)
...
| S.NO | 浏览 | 冲浪 |
| --- | --- | --- |
| 1. | 浏览是通过`网络浏览器`完成的。 | 而它是通过`搜索引擎`完成的。 |
