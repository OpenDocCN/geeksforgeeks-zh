...
## 主动攻击:
主动攻击是攻击者试图更改或修改消息内容的攻击类型。主动攻击对`完整性和可用性`都是危险的。由于主动攻击，系统总是被破坏，系统资源可以被改变。最重要的是，在主动攻击中，受害者被告知攻击。

![](img/e2720b401bb2d35af60b7070b4e8d549.png)

## 被动攻击:
被动攻击是攻击者观察消息内容或复制消息内容的攻击类型。被动攻击是`保密`的危险。由于被动攻击，对系统没有任何伤害。最重要的是，在被动攻击中，受害者不会被告知攻击。
