...
2.  [**实时传输控制协议(`RTCP`)**](https://www.geeksforgeeks.org/real-time-transport-control-protocol-rtcp/) –
    `RTCP` 是一种为 `RTP`(实时传输协议)会话提供带外统计和控制信息的协议。
...
6.  [**套接字直接协议(`SDP`)**](https://www.geeksforgeeks.org/socket-direct-protocol-sdp/) –
