...
> 原文：[https://www.geeksforgeeks.org/difference-between-cloud-computing-and-cluster-computing/](https://www.geeksforgeeks.org/difference-between-cloud-computing-and-cluster-computing/)
...
| 9. | 硬件 | 物理上没有硬件要求。 | 物理上对硬件要求更高。 |
| 10. | `node.js` | 虚拟机中运行多个操作系统 | Windows、Linux |
