...
> 原文:[https://www . geeksforgeks . org/mega 和 wasabi 的区别/](https://www.geeksforgeeks.org/difference-between-mega-and-wasabi/)
...
**2。芥末:**
`芥末`是一种文件托管和云存储服务，由`芥末技术公司`提供。它是一种对象存储服务。它于 2017 年由`Wasabi技术公司`推出。它不提供免费存储空间。它为付费用户提供无限的最大存储空间。又称`山葵热储`或`山葵热云存储`。
