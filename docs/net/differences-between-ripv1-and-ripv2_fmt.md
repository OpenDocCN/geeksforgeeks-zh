...
> 原文: [https://www.geeksforgeks.org/differences-between-ripv1-and-ripv2/](https://www.geeksforgeks.org/differences-between-ripv1-and-ripv2/)
...
由于 RIPv1 的不足，RIP 版本 2 (`RIPv2`) 于 1993 年开发，具备支持子网信息的能力，支持[无类域间路由(CIDR)](https://www.geeksforgeks.org/classless-inter-domain-routing-cidr/)。
