...
> 原文: [https://www.geeksforgeeks.org/what-are-the-differences-between-http-ftp-and-smtp/](https://www.geeksforgeeks.org/what-are-the-differences-between-http-ftp-and-smtp/)
...
| `TCP` 连接的类型 | 可以同时使用持久和非持久 | 持久用于控制连接。<br>非持久用于数据连接 | 持久的 |
| 协议类型 | 拉协议（主要） | – | 推送协议（主要） |
