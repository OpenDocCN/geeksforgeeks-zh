# 带有显式链路故障通知的 TCP(TCP-ELFN)

> 原文：[https://www.geeksforgeeks.org/tcp-with-explicit-link-failure-notification-tcp-elfn/](https://www.geeksforgeeks.org/tcp-with-explicit-link-failure-notification-tcp-elfn/)
