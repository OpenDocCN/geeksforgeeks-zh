...
> 原文：[https://www.geeksforgeeks.org/cisco-discovery-protocol-cdp-and-link-layer-discovery-protocol-lldp-in-data-link-layer/](https://www.geeksforgeeks.org/cisco-discovery-protocol-cdp-and-link-layer-discovery-protocol-lldp-in-data-link-layer/)
...
数据链路层中的思科发现协议(CDP)和链路层发现协议(LLDP)是第 2 层(数据链路层)协议。它们都有助于发现设备在网络中是如何相互连接的。它们都独立于协议 `IPv4/IPv6` 运行。它们还有助于验证和创建文档。
