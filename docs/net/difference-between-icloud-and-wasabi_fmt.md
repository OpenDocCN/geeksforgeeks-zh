...
> 原文：[https://www.geeksforgeeks.org/difference-between-icloud-and-wasabi/](https://www.geeksforgeeks.org/difference-between-icloud-and-wasabi/)
...
Wasabi 是一种文件托管和云存储服务，由 Wasabi 技术公司提供。它是一种对象存储服务。它于 2017 年由 Wasabi 技术公司推出。它不提供免费存储空间。它为付费用户提供无限的最大存储空间。又称 **Wasabi Hot Storage** 或 **Wasabi Hot Cloud Storage**。

## iCloud 和 Wasabi 的区别

| 云端服务 | Wasabi |
| --- | --- |
| 它归 **苹果公司** 所有。 | 它由 **Wasabi 科技公司** 所有。 |
| 它于 2011 年推出。 | 它于 2017 年推出。 |
| 是 **苹果** 开发的。 | 它是由 **Wasabi 科技有限公司** 开发的。 |
| 它提供了 5 GB 的可用存储空间。 | 它不提供免费存储空间。 |
| 它提供免费和付费两种类型的存储空间。 | 它只提供付费存储空间。 |
| 它为付费用户提供有限的最大存储空间。 | 它为付费用户提供无限的最大存储空间。 |
| 它的最大存储大小为 2 TB。 | 这里的最大存储空间是无限的。 |
| 它支持开发人员 API。 | 它还支持开发人员 API。 |
