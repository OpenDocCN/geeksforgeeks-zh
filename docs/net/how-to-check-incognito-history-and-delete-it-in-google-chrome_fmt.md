...
> 原文：[https://www.geeksforgeeks.org/how-to-check-incognito-history-and-delete-it-in-google-chrome/](https://www.geeksforgeeks.org/how-to-check-incognito-history-and-delete-it-in-google-chrome/)
...
您可以从这里了解更多关于 `DNS` 的信息：[https://www.geeksforgeeks.org/working-of-domain-name-system-dns-server/](https://www.geeksforgeeks.org/working-of-domain-name-system-dns-server/)
...
**步骤 2：** 键入命令 `ipconfig /displaydns` 查看 DNS 缓存历史。
...
**第二步：** 键入命令 `ipconfig /flushdns` 清除 DNS。
