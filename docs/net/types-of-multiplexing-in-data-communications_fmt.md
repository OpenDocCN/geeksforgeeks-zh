...
> 原文:[https://www.geeksforgeeks.org/types-of-multiplexing-in-data-communications/](https://www.geeksforgeeks.org/types-of-multiplexing-in-data-communications/)
...
在 `FDM`，我们可以观察到大量的信道间串扰，因为在这种类型的复用中，带宽被划分为频率信道。为了防止通道间串扰，必须在每个通道之间放置未使用的带宽条。每个通道之间这些未使用的条带称为`保护带`。
