...
> 原文：[https://www.geeksforgeeks.org/algorithm-for-csma-and-rules-for-csma-cd/](https://www.geeksforgeeks.org/algorithm-for-csma-and-rules-for-csma-cd/)
...
4.  发送干扰信号后，等待一段随机时间（称为`后退`），然后再次尝试发送

## `CSMA` 的算法：
`CSMA` 的算法有：`非持久`、`1-持久`、`p-持久`。这些解释如下。
