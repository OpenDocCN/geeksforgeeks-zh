...
> 原文：[https://www.geeksforgeeks.org/winternitz-one-time-signature-scheme/](https://www.geeksforgeeks.org/winternitz-one-time-signature-scheme/)
...
1.  Alice 使用 `SHA-256` 对消息进行哈希处理，生成一个 256 位的摘要。这个摘要被分割成 32 个 8 位值 (`N1`, `N2`, …, `N32`)。
