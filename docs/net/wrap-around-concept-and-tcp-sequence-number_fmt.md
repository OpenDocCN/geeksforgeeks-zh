...
> 原文: [https://www.geeksforgeeks.org/wrap-around-concept-and-tcp-sequence-number/](https://www.geeksforgeeks.org/wrap-around-concept-and-tcp-sequence-number/)
...
信道带宽为 1 GBps。一个数据包在链路中能停留多长时间而不用担心有 2 个序列号相同的数据包的问题？

**解释–**

```
Bandwidth = 1 GBps = 2^30
Sequence numbers = 2^32
...
[GATE-CS-2014-(集-3) | 问题 65](https://www.geeksforgeeks.org/gate-gate-cs-2014-set-3-question-37/)

## 示例-5

[GATE CS 2018 | 问题 32](https://www.geeksforgeeks.org/gate-gate-cs-2018-question-32/)