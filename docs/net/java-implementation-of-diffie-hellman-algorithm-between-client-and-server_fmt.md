...
> 原文: [https://www.geeksforgeeks.org/java-implementation-of-diffie-hellman-algorithm-between-client-and-server/](https://www.geeksforgeeks.org/java-implementation-of-diffie-hellman-algorithm-between-client-and-server/)
...
在下面的程序中，客户端将共享 `p`、`q` 和公钥 `A` 的值。而服务器将接受这些值并计算其公钥 `B` 并将其发送给客户端。
