...
> 原文: [https://www.geeksforgeeks.org/difference-between-fdma-tdma-and-cdma/](https://www.geeksforgeeks.org/difference-between-fdma-tdma-and-cdma/)
...
在上图中，有 4 个站点标记为 1、2、3 和 4。分配给各站的数据为 `d1`、`d2`、`d3` 和 `d4`，分配给各站的代码为 `c1`、`c2`、`c3` 和 `c4`。

## FDMA、CDMA、TDMA 的区别

| FDMA | TDMA | CDMA |
| :--- | :--- | :--- |
| FDMA 代表频分多址。 | TDMA 代表时分多址。 | CDMA 代表码分多址。 |
