...
> 原文: [https://www.geeksforgeeks.org/difference-between-pptp-and-openvpn/](https://www.geeksforgeeks.org/difference-between-pptp-and-openvpn/)
...
| 4. | 在 `PPTP`，使用 `GRE` 协议和端口号 `1723`。 | 虽然端口号 `1194` 用于此，但它可以改为任何人。 |
