...
> 原文：[https://www.geeksforgeeks.org/difference-between-analog-communication-and-digital-communication/](https://www.geeksforgeeks.org/difference-between-analog-communication-and-digital-communication/)
...
| 10. | 在模拟通信中，复用使用[频分复用(`FDM`)](https://www.geeksforgeeks.org/frequency-division-and-time-division-multiplexing/)。 | 在数字通信中，复用使用[时分复用(`TDM`)](https://www.geeksforgeeks.org/frequency-division-and-time-division-multiplexing/)。 |
