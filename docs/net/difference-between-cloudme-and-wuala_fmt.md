...
> 原文：[https://www.geeksforgeeks.org/difference-between-cloudme-and-wuala/](https://www.geeksforgeeks.org/difference-between-cloudme-and-wuala/)
...
## 2. Wuala
Wuala 是一个文件同步服务、文件存储服务、文件版本服务和备份存储服务，最初由 Caleido Incorporation 提供，但后来归希捷科技所有。它是由**张秀坤格罗利蒙**和**卢修斯梅瑟林**开发的。它主要是用 Java 开 CloudMe 和 Wuala 的区别：
