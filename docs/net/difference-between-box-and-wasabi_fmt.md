...
> 原文：[https://www.geeksforgeeks.org/difference-between-box-and-wasabi/](https://www.geeksforgeeks.org/difference-between-box-and-wasabi/)
...
| Box | Wasabi |
| --- | --- |
| 它属于`Box Inc.`。 | 它由`Wasabi Technologies Inc.`所有。 |
| 它于`2005`年推出。 | 它于`2017`年推出。 |
| 它是由`Aaron Levie`和`Dylan Smith`开发的。 | 它是由`Wasabi Technologies Inc.`开发的。 |
...
| 最大文件大小免费为`250 MB`，付费为`5 GB`。 | 这里最大文件大小没有限制。 |
