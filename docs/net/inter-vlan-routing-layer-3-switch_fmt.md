...
> 原文: [https://www.geeksforgeeks.org/inter-vlan-routing-layer-3-switch/](https://www.geeksforgeeks.org/inter-vlan-routing-layer-3-switch/)

## 先决条件
– [接入和中继端口](https://www.geeksforgeeks.org/access-trunk-ports/)
