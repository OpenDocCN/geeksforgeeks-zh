...
> 原文: [https://www.geeksforgeeks.org/vernam-cipher-in-cryptography/](https://www.geeksforgeeks.org/vernam-cipher-in-cryptography/)

## Vernam 密码

`Vernam` 密码是一种加密字母文本的方法。这是将纯文本转换为密文的转置技术之一。在这个机制中，我们给纯文本的每个字符分配一个数字，比如(`a = 0`，`b = 1`，`c = 2`，… `z = 25`)。
