...
> 原文: [https://www.geeksforgeeks.org/internal-external-forwarding-rule-in-gcp/](https://www.geeksforgeeks.org/internal-external-forwarding-rule-in-gcp/)
...
*   根据网络的范围或广度，转发规则可以分为`内部转发规则`或`外部转发规则`。
