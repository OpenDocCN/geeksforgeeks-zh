...
> 原文：[https://www.geeksforgeeks.org/difference-between-google-drive-and-yandex-disk/](https://www.geeksforgeeks.org/difference-between-google-drive-and-yandex-disk/)

## 1. Google Drive
Google Drive 是由 Google 提供的文件存储和同步服务。它允许用户存储文件和个人数据，并共享文件。它提供 15 GB 的可用存储空间。它是 Google 在 2012 年推出的。几乎每个与互联网有某种联系的人都在使用它。每个人都用它来存储一些专业和个人数据。
...
| --- | --- |
| 它归 **Google LLC** 所有。 | 归 **Yandex** 所有。 |
| 它于 2012 年推出。 | 它也于 2012 年推出。 |
| 是 **Google** 开发的。 | 由 **Yandex** 开发。 |
