...
> 原文: [https://www.geeksforgeeks.org/design-issues-in-presentation-layer/](https://www.geeksforgeeks.org/design-issues-in-presentation-layer/)
...
3.  **压缩–**
    为了减少需要传输的比特数量，表示层执行数据压缩。在处理音频、视频等多媒体文件时，这能提高效率。
