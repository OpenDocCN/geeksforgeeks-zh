...
> 原文: [https://www.geeksforgeeks.org/difference-between-mega-and-ubuntu-one/](https://www.geeksforgeeks.org/difference-between-mega-and-ubuntu-one/)
...
| 它支持`Windows`、`OS X`、`Linux`、`安卓`、`iOS`和`黑莓`。 | 它支持`Windows`、`OS X`、`Ubuntu`、`iOS`和`安卓`。 |
| 它有客户端加密。 | 它没有客户端加密。 |
| 它的流量或带宽限制为每月免费 10 GB，每月付费 96 TB。 | 它有`亚马逊S3`流量限制或带宽限制。 |