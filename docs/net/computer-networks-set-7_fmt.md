...
答案(C)
子网掩码的二进制表示为 `11111111.11111111.11111000.00000000`。子网中设置了 21 位。所以主机 id 还剩 11 (32-21)位。主机 id 的总可能值是 `2^11 = 2048`。在这 `2048` 个值中，保留了 2 个地址。所有位为 1 的地址被保留为广播地址，所有主机 id 位为 0 的地址被用作子网的网络地址。
