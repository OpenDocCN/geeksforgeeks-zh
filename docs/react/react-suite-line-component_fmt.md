...
React Suite Charts 是一个流行的前端库，包含一组 React 组件，用于提供一组基于 `rsuite` 和 `echarts` 的图表。`Line` 组件有助于为图表添加不同的数据线，当我们必须在图表中显示多条线时，它就会被使用。我们可以在 ReactJS 中使用以下方法来使用 React Suite Line 组件。
...
![输出](img/12a488c70b7f5d5c4931e38f2b030a14.png)
