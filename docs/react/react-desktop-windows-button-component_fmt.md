...
Reaction Desktop 是一个将原生桌面体验带到 Web 上的受欢迎的库。该库提供 MacOS 和 Windows OS 组件。按钮组件用于用户只需轻点即可进行操作和选择。我们可以在 ReactJS 中使用以下方法来使用 Reaction Desktop Windows 按钮组件。
...
[http://reactdesktop.js.org/docs/windows/button](http://reactdesktop.js.org/docs/windows/button)