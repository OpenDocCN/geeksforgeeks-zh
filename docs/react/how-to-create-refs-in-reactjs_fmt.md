...
> 原文: [https://www.geeksforgeeks.org/how-to-create-refs-in-reactjs/](https://www.geeksforgeeks.org/how-to-create-refs-in-reactjs/)
...
## 方法 3: 使用回调引用
该方法在 **React 16.3** 之前使用。所以如果你正在使用 React < 16.3 使用这个方法。
