...
在本例中，我们将看到如何使用 ReactJS 语义 UI 消息集合来显示基本消息。
...
在本例中，我们将使用带有类型列表的消息元素，通过使用 ReactJS 语义 UI 消息集合以列表的形式显示消息。
...
[https://react.semantic-ui.com/collections/message](https://react.semantic-ui.com/collections/message)