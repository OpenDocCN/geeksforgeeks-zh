...
> 原文: [https://www.geeksforgeeks.org/how-to-create-loading-screen-in-reactjs/](https://www.geeksforgeeks.org/how-to-create-loading-screen-in-reactjs/)
...
**安装所需的包:** 现在我们将使用以下命令安装 `react-loading` 包:
...
**说明:** 首先在上面的例子中，我们从 `ReactLoading` 包导入 `ReactLoading` 组件。之后，我们将使用我们的 `ReactLoading` 组件来添加不同类型的加载屏幕。我们可以设置加载屏幕的类型、颜色、高度和宽度。
