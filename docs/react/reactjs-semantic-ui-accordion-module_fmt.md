...
> 原文: [https://www.geeksforgeeks.org/reactjs-semantic-ui-accordion-module/](https://www.geeksforgeeks.org/reactjs-semantic-ui-accordion-module/)
...
这是展示如何使用 ReactJS 语义 UI 手风琴模块使用手风琴元素的基本示例。
...
在本例中，我们通过使用 ReactJS 语义 UI 折叠模块，在折叠元素中使用了样式属性和流体变化。
...
**参考:** [https://react.semantic-ui.com/modules/accordion](https://react.semantic-ui.com/modules/accordion)