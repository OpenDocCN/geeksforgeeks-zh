...
> 原文: [https://www.geeksforgeeks.org/how-to-push-data-into-firebase-realtime-database-using-reactjs/](https://www.geeksforgeeks.org/how-to-push-data-into-firebase-realtime-database-using-reactjs/)
...
**步骤 5:** 通过用下面的代码创建 `firebase.js` 文件，将 Firebase 初始化到您的项目中。
...
**步骤 7:** 现在实现主体部分。这里，我们将使用一个名为 `set` 的方法，它将数据推送到我们的实时数据库。
