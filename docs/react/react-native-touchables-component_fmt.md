...
> 原文：[https://www.geeksforgeeks.org/react-native-touchables-component/](https://www.geeksforgeeks.org/react-native-touchables-component/)
...
*   **TouchableNativeFeedback：** 用于安卓系统中，显示响应用户触摸的墨水表面反应波纹。
*   **TouchableWithoutFeedback：** 如果您需要处理轻击手势，但不想显示任何反馈，请使用 `TouchableWithoutFeedback`。
...
**参考：** [https://reactnative.dev/docs/handling-touches](https://reactnative.dev/docs/handling-touches)