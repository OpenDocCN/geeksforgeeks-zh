...
> 原文: [https://www.geeksforgeeks.org/how-to-use-onkeypress-event-in-reactjs/](https://www.geeksforgeeks.org/how-to-use-onkeypress-event-in-reactjs/)
...
### 步骤 2
创建项目文件夹(即 `functiondemo`)后，使用以下命令移动到该文件夹:
```jsx
cd functiondemo
```
