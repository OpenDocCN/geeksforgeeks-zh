...
> 原文: [https://www.geeksforgeeks.org/react-native-activityindicator-component/](https://www.geeksforgeeks.org/react-native-activityindicator-component/)
...
现在让我们实现 `ActivityIndicator`。这里我们创建了一个活动指示器。
