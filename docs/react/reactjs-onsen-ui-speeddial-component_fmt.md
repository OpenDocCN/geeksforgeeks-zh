...
> 原文：[https://www.geeksforgeeks.org/reactjs-onsen-ui-speeddial-component/](https://www.geeksforgeeks.org/reactjs-onsen-ui-speeddial-component/)
...
export default function App() {
  return (
    <div style={{
      ...
      <SpeedDial direction='right' disabled={false} position='left bottom'>
        <Fab><Icon size={26} style={{ verticalAlign: 'middle' }} /></Fab>
...
[https://onsen.io/v2/api/react/SpeedDial.html](https://onsen.io/v2/api/react/SpeedDial.html)