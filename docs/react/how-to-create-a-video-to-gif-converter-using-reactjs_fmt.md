...
> 原文：[https://www.geeksforgeeks.org/how-to-create-a-video-to-gif-converter-using-reactjs/](https://www.geeksforgeeks.org/how-to-create-a-video-to-gif-converter-using-reactjs/)
...
此外，您还可以了解 `FFMPEG`，它是一个免费的开源软件项目，由一大套库和程序组成，用于处理视频、音频和其他多媒体文件和流，您可以从 [https://ffmpeg.org/](https://ffmpeg.org/) 链接查看。
...
**文件名 - Button.jsx：** 这个组件是一个 `convert` 按钮，当你点击它的时候会自动把 .mp4 文件改成 .gif 文件。
...
**文件名 - Inputfile.jsx：** 该组件用于获取视频文件（.mp4 文件）的用户输入。
