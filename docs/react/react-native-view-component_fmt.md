...
在本文中，我们将看到如何在 react-native 中创建视图组件。为此，我们将使用反应原生视图组件。它基本上是一个小容器，支持带有 flexbox、样式、一些触摸处理和辅助功能控件的布局。视图直接映射到在任何运行 React Native 的平台上等效的原生视图，无论是UIView、android.view 等等。
...
**参考:** [https://reactnative.dev/docs/view](https://reactnative.dev/docs/view)