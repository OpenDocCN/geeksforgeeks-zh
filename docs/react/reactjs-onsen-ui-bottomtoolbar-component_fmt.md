...
> 原文：[https://www.geeksforgeeks.org/reactjs-onsen-ui-bottomtoolbar-component/](https://www.geeksforgeeks.org/reactjs-onsen-ui-bottomtoolbar-component/)
...
*   `transparent`：用于使工具栏透明。
*   `align`：用于垂直对齐其子元素，也适用于块元素的 flexbox。
  ...
  return (
    <div style={{
      ...
      <BottomToolbar style={{backgroundColor:'lightcoral', padding: 10}} 
        align="center" modifier="flat-material">
        Sample Content of the Bottom Toolbar!
      </BottomToolbar>
    </div>
  );
}
...
[https://onsen.io/v2/api/react/BottomToolbar.html](https://onsen.io/v2/api/react/BottomToolbar.html)