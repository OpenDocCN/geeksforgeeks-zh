...
React Suite 是一个流行的前端库，包含一组为中间平台和后端产品设计的 React 组件。徽章组件允许用户在其子组件的右上角生成一个小徽章。我们可以在 ReactJS 中使用以下方法来使用 React 套件徽章组件。
...
[https://rsuitejs.com/components/badge/](https://rsuitejs.com/components/badge/)