...
这是一个基本示例，展示了如何使用 ReactJS 语义 UI 转换模块来使用转换插件。
...
在本例中，我们使用 ReactJS 语义 UI 过渡模块将动画更改为在过渡插件中抖动。
...
**参考:** [https://react.semantic-ui.com/modules/transition](https://react.semantic-ui.com/modules/transition)