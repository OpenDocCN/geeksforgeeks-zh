...
原文：[https://www.geeksforgeeks.org/what-are-the-features-of-reactjs/](https://www.geeksforgeeks.org/what-are-the-features-of-reactjs/)
...
如果 **index.js** 中的值为 `isPass={false}` ，则显示以下输出。
