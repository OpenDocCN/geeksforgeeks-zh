...
> 原文：[https://www.geeksforgeeks.org/how-to-improve-slow-react-application-rendering/](https://www.geeksforgeeks.org/how-to-improve-slow-react-application-rendering/)
...
下面是一个例子，说明如果一个函数中有一些大的计算，那么如何使用 `useMemo` 钩子来拯救。
...
**解释：** 在这种情况下，`useMemo` 钩子作为依赖项包含 `counter1`。因此，计数器 1 仍然显示延迟，但不影响计数器 2 的性能。