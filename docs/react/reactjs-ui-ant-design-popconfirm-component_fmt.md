...
> 原文: [https://www.geeksforgeeks.org/reactjs-ui-ant-design-popconfirm-component/](https://www.geeksforgeeks.org/reactjs-ui-ant-design-popconfirm-component/)
...
*   **步骤 2:** 创建项目文件夹(即 `demo`)后，使用以下命令移动到该文件夹。
