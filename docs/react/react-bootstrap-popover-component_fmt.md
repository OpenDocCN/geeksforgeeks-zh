...
Reaction-Bootstrap 是一个前端框架，其设计考虑到了 Reaction。 `Popover` 组件是悬停在父窗口上的容器类型元素。 就像弹出信息一样，在父窗口上某个事件上触发。 我们可以在 ReactJS 中使用以下方法来使用 Reaction-Bootstrap `Popover` 组件。
...
[https://react-bootstrap.github.io/components/overlays/#popovers](https://react-bootstrap.github.io/components/overlays/#popovers)