...
> 原文: [https://www.geeksforgeeks.org/how-to-get-cell-value-on-react-table/](https://www.geeksforgeeks.org/how-to-get-cell-value-on-react-table/)
...
我们可以通过将 `onClick` 事件添加到 `<td>` 标签来获取表格的单元格/列值。
...
**输出:**现在打开浏览器，转到 `http://localhost:3000/`，点击 `react-table` 单元格的会看到如下输出。

![](img/b782e4d0f8068137779f2e97576588a8.png)

输出

**参考:** [https://www.npmjs.com/package/react-table](https://www.npmjs.com/package/react-table)