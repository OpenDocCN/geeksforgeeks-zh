...
React Suite 是一个流行的前端库，包含一组为中间平台和后端产品设计的 React 组件。导航栏组件允许用户在页面顶部提供导航。我们可以在 ReactJS 中使用以下方法来使用 React Suite Navbar 组件。
...
## 参考
[https://rsuitejs.com/components/navbar/](https://rsuitejs.com/components/navbar/)