...
> 原文: [https://www.geeksforgeeks.org/how-to-get-key-attribute-of-parent-div-when-button-is-clicked-in-reactjs/](https://www.geeksforgeeks.org/how-to-get-key-attribute-of-parent-div-when-button-is-clicked-in-reactjs/)
...
*   **步骤 3:** 创建`Parent.js`和`Child.js`组件。
