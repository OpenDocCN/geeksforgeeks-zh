...
> 原文: [https://www.geeksforgeeks.org/react-native-flexbox-flexdirection-property/](https://www.geeksforgeeks.org/react-native-flexbox-flexdirection-property/)
...
*   `column`: 是 `flexDirection` 属性的默认值。它从上到下对齐子项目。
*   `row`: 将孩子的物品从左向右对齐。
*   `column-reverse`: 它将子项目从下向上对齐。它与 `column` 值相反。
*   `row-reverse`: 从右向左对齐孩子。
...
[https://reactnative.dev/docs/flexbox#flex-direction](https://reactnative.dev/docs/flexbox#flex-direction)