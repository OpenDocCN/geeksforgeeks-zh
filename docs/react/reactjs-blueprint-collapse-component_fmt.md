...
> 原文：[https://www.geeksforgeeks.org/reactjs-blueprint-collapse-component/](https://www.geeksforgeeks.org/reactjs-blueprint-collapse-component/)
...
*   `component`：用于表示作为根元素渲染的组件。
*   `isOpen`：用于指示部件是打开还是关闭。
*   `keepChildrenMounted`：用于指示折叠关闭时子组件是否保持安装状态。
*   `transitionDuration`：用于表示过渡所用的时间长度，单位为毫秒。
...
[https://blueprintjs.com/docs/#core/components/collapse](https://blueprintjs.com/docs/#core/components/collapse)