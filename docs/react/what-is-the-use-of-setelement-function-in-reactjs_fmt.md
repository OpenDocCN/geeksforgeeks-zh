...
> 原文: [https://www.geeksforgeeks.org/what-is-the-use-of-setelement-function-in-reactjs/](https://www.geeksforgeeks.org/what-is-the-use-of-setelement-function-in-reactjs/)
...
**注意:** 在那个创建的文件夹中，转到 `src` 文件夹，删除 `App.test.js`、`logo.svg` 和 `setupTests.js`，因为这些文件在这个项目中不是必需的，我们的文件夹名是 `state`。
