...
> 原文：[https://www.geeksforgeeks.org/animated-sliding-page-gallery-using-framer-motion-and-react-js/](https://www.geeksforgeeks.org/animated-sliding-page-gallery-using-framer-motion-and-react-js/)
...
### 步骤 2
创建项目文件夹，即`page-gallery`后，使用以下命令移动到该文件夹。
```jsx
$ cd page-gallery
```
