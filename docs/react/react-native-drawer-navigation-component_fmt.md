...
> 原文: [https://www.geeksforgeeks.org/react-native-drawer-navigation-component/](https://www.geeksforgeeks.org/react-native-drawer-navigation-component/)
...
*   `navigation.toggleDrawer()`: 用于拨动抽屉。
