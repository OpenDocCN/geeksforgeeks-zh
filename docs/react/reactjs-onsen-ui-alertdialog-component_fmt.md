# React Onsen-UI AlertDialog 组件

> 原文: [https://www.geeksforgeeks.org/reactjs-onsen-ui-alertdialog-component/](https://www.geeksforgeeks.org/reactjs-onsen-ui-alertdialog-component/)
...
*   **步骤 2:** 在创建项目文件夹（即 `foldername`）后，使用以下命令将 `cd` 移动到该文件夹:
...
[https://onsen.io/v2/api/react/AlertDialog.html](https://onsen.io/v2/api/react/AlertDialog.html)