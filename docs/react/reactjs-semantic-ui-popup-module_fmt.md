...
这是展示如何使用 ReactJS 语义 UI 弹出模块来使用弹出模块的基本示例。
...
在本例中，我们通过使用 ReactJS 语义 UI 弹出模块，在弹出模块中添加了文本而不是图标。
...
**参考:** [https://react.semantic-ui.com/modules/popup](https://react.semantic-ui.com/modules/popup)