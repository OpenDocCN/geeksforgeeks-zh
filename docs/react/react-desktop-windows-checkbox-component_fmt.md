...
Reaction Desktop 是一个将原生桌面体验带到 Web 上的受欢迎的库。该库提供 MacOS 和 Windows OS 组件。复选框组件用于允许用户从给定选项中进行二元选择。我们可以在 ReactJS 中使用以下方法来使用 Reaction Desktop Windows 复选框组件。
...
*   `theme`：它用于设置 UI 主题，然后该组件及其子元素使用该主题。
...
## 引用
[http://reactdesktop.js.org/docs/windows/checkbox](http://reactdesktop.js.org/docs/windows/checkbox)