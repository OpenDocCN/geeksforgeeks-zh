...
> 原文: [https://www.geeksforgeeks.org/react-suite-dropdown-component/](https://www.geeksforgeeks.org/react-suite-dropdown-component/)

React Suite 是一个流行的前端库，包含一组为中间平台和后端产品设计的 React 组件。下拉菜单组件允许用户提供导航，如果你想选择一个值，使用选择选择器。我们可以在 ReactJS 中使用以下方法来使用 React Suite 下拉组件。

## 下拉道具

*   `activeKey`: 用于设置激活下拉项组件中事件键对应状态的选项。
...
[https://rsuitejs.com/components/dropdown/](https://rsuitejs.com/components/dropdown/)