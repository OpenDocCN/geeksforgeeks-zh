...
*   **变异:** 变异属性用于提高元素的品质，如颜色、大小等。变异是冲突。它们用于修改元素。
*   **内容:** 内容为属性用于描述表头、菜单等。`content` 属性用于扩展元素。
*   **行为:** 行为是语义界面中用于设置验证的属性，向获取 API 请求。
...
[https://react.semantic-ui.com/addons/portal](https://react.semantic-ui.com/addons/portal)