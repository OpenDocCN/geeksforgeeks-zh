...
> 原文: [https://www.geeksforgeeks.org/how-to-access-a-dom-element-in-react/](https://www.geeksforgeeks.org/how-to-access-a-dom-element-in-react/)
...
访问引用: 当我们在渲染中将引用分配给一个元素时，我们可以使用引用的 `current` 属性来访问该元素。
