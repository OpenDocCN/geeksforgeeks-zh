...
> 原文：[https://www.geeksforgeeks.org/how-to-authenticate-phone-number-using-firebase-in-reactjs/](https://www.geeksforgeeks.org/how-to-authenticate-phone-number-using-firebase-in-reactjs/)
...
*   **步骤 6：** 进入你的 Firebase 控制台，启用如下所示的手机登录方式。
...
*   **步骤 8：** 用下面的代码创建两个文件，即 `login.js` 和 `main.js`。
...
*   **步骤 9：** 最后在 `App.js` 文件中导入所有需要的文件，如下图。
