...
> 原文: [https://www.geeksforgeeks.org/reactjs-evergreen-switch-component/](https://www.geeksforgeeks.org/reactjs-evergreen-switch-component/)
...
*   `disabled`: 当设置为真时，开关禁用。
*   `invalid`: 当设置为真时，开关无效。
*   `appearance`: 用于复选框的外观。
*   `hasCheckIcon`: 当设置为真时，开关有一个检查图标。
*   `defaultChecked`: 当设置为真时，开关默认为真。
...
[https://evergreen.segment.com/components/switch](https://evergreen.segment.com/components/switch)