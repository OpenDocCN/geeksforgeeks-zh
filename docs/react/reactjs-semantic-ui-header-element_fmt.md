...
在本例中，我们将通过使用 ReactJS Semantic UI 头元素来使用基本的头元素。
...
在本例中，我们将通过使用 ReactJS Semantic UI 头元素来使用具有大小属性和禁用状态的头元素。
...
[https://react.semantic-ui.com/elements/header](https://react.semantic-ui.com/elements/header)