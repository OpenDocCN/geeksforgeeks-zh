...
> 原文：[https://www.geeksforgeeks.org/choose-multiple-options-from-dropdown-as-a-tag-or-create-using-reactjs/](https://www.geeksforgeeks.org/choose-multiple-options-from-dropdown-as-a-tag-or-create-using-reactjs/)
...
在上面的例子中，我们从可用的选项中选择了 `One` 和 `Two`，但也添加了我们自己的选项，即 `Random`。这就是我们如何在 ReactJS 中使用 `Chip` 选择和创建多个选项。