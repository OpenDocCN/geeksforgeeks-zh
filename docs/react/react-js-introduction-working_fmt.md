...
> 原文: [https://www.geeksforgeeks.org/react-js-introduction-working/](https://www.geeksforgeeks.org/react-js-introduction-working/)
...
**注意:** React 不是框架。它只是脸书为了解决我们之前面临的一些问题而开发的一个库。
...
与浏览器的 DOM 元素不同，React 元素是简单的对象，创建起来很便宜。React DOM 负责更新 DOM 以匹配 React 元素。原因是 JavaScript 非常快，值得在其中保留一个 DOM 树来加速它的操作。

虽然 React 被设想用于浏览器，但由于其设计，它也可以与 Node.js 一起用于服务器。