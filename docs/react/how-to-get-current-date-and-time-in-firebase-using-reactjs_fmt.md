...
> 原文: [https://www.geeksforgeeks.org/how-to-get-current-date-and-time-in-firebase-using-reactjs/](https://www.geeksforgeeks.org/how-to-get-current-date-and-time-in-firebase-using-reactjs/)
...
现在实现时间和日期部分。这里，我们将使用一个名为 `Timestamp` 的方法，它可以帮助我们获得当前的日期和时间。
