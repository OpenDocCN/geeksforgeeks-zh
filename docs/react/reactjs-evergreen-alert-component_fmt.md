...
React Evergreen 是一个受欢迎的前端库，它有一组 React 组件来构建漂亮的产品，因为这个库是灵活的、合理的默认值和用户友好的。报警组件用于紧急中断，要求确认，通知用户情况。我们可以在 ReactJS 中使用以下方法来使用常青树警报组件。
...
**参考:** [https://evergreen.segment.com/components/alert](https://evergreen.segment.com/components/alert)