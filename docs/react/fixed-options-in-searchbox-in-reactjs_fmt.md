...
> 原文：[https://www.geeksforgeeks.org/fixed-options-in-searchbox-in-reactjs/](https://www.geeksforgeeks.org/fixed-options-in-searchbox-in-reactjs/)

固定选项是指将我们定义的选项放在搜索框中。固定选项不能在搜索栏中更改。React 的 Material UI 有这个组件可供我们使用，非常容易集成。我们可以使用以下方法将固定选项放入 ReactJS 中的搜索框中。
...
![输出结果](img/0bf97b9e55f561209f67867dba96709c.png)
