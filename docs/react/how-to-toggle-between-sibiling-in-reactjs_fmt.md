...
> 原文：[https://www.geeksforgeeks.org/how-to-toggle-between-sibiling-in-reactjs/](https://www.geeksforgeeks.org/how-to-toggle-between-sibiling-in-reactjs/)
...
## App.css
在 `src` 文件夹中添加 `App.css` 文件，创建盒子，使其变成绿色。
