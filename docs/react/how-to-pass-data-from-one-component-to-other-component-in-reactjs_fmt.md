...
> 原文：[https://www.geeksforgeeks.org/how-to-pass-data-from-one-component-to-other-component-in-reactjs/](https://www.geeksforgeeks.org/how-to-pass-data-from-one-component-to-other-component-in-reactjs/)
...
如下图。我们创建了两个名为 `Child.js` 和 `Parent.js` 的组件，如下所示。

![](img/bda514a2625f64c091742936a31e64e8.png)

我们创建了两个名为 `Child.js` 和 `Parent.js` 的组件，如上图所示。
...
**示例：** 在本例中，我们使用 Context API 在兄弟之间传递数据。因此，我们有一个不同的项目。

**项目结构：** 如下图。我们创建了两个名为 `Child1.js` 和 `Child2.js` 的组件，如下所示。
