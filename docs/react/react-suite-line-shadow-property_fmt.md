...
> 原文: [https://www.geeksforgeeks.org/react-suite-line-shadow-property/](https://www.geeksforgeeks.org/react-suite-line-shadow-property/)

React Suite Charts 是一个流行的前端库，包含一组 React 组件，用于提供一组基于 rsuite 和 echarts 的图表。线条阴影属性很重要，它有助于将阴影添加到我们的图形中。

我们可以在 ReactJS 中使用以下方法来使用线阴影属性。这里我们使用折线图来演示线阴影属性。`area` 属性用于在图形中添加阴影。
...
**参考:** [https://charts.rsuitejs.com/#%E5%9B%BE%E7%BA%BF%E9%98%B4%E5%BD%B1](https://charts.rsuitejs.com/#%E5%9B%BE%E7%BA%BF%E9%98%B4%E5%BD%B1)