...
> 原文: [https://www.geeksforgeeks.org/react-suite-checktreepicker-component/](https://www.geeksforgeeks.org/react-suite-checktreepicker-component/)
...
*   `uncheckableItemValues`: 用于设置不渲染复选框的选项值。
*   `value`: 用于表示值(受控)。
...
**参考:** [https://rsuitejs.com/components/check-tree-picker/](https://rsuitejs.com/components/check-tree-picker/)