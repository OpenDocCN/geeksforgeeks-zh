...
在本文中，我们将了解如何在 ReactJS Semantic UI 中使用 `Tab Module`，`Tab Module` 与一个 `menu` 一起使用，该菜单的内容可以在特定的选项卡单击中显示。
...
这是展示如何使用 ReactJS 语义 UI 标签模块使用标签模块的基本示例。
...
在本例中，我们使用 ReactJS 语义 UI 标签模块展示了标签模块中的加载状态。
...
**参考:** [https://react.semantic-ui.com/modules/tab](https://react.semantic-ui.com/modules/tab)