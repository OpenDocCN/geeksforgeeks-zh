...
> 原文：[https://www.geeksforgeeks.org/reactjs-semantic-ui-breadcrumb-collections/](https://www.geeksforgeeks.org/reactjs-semantic-ui-breadcrumb-collections/)
...
在本例中，我们将使用一个基本的面包屑元素，通过使用 ReactJS Semantic UI 面包屑集合来显示内容之间的层次结构。
...
在本例中，我们将使用包含分割线的面包屑元素，通过使用 ReactJS Semantic UI 面包屑集合来显示各部分之间的关系。
...
**参考：** [https://react.semantic-ui.com/collections/breadcrumb](https://react.semantic-ui.com/collections/breadcrumb)