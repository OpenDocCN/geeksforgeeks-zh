...
这是展示如何使用 ReactJS 语义 UI Textarea 插件来使用 Textarea 插件的基本示例。
...
在本例中，我们已经使用 ReactJS 语义 UI textarea 插件更改了 Textarea 中的行的大小。
...
**参考:** [https://react.semantic-ui.com/addons/text-area](https://react.semantic-ui.com/addons/text-area)