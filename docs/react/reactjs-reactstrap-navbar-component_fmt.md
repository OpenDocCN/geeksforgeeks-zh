# Reactstrap Navbar 组件

> 原文：[https://www.geeksforgeeks.org/reactjs-reactstrap-navbar-component/](https://www.geeksforgeeks.org/reactjs-reactstrap-navbar-component/)
...
## 示例 1
现在在 `App.js` 文件中写下以下代码。这里，我们展示了带有 `expand` 属性的 `Navbar` 组件。
...
## 示例 2
现在在 `App.js` 文件中写下以下代码。在这里，我们展示了不带 `expand` 属性的 `Navbar` 组件。
...
## 参考
[https://reactstrap.github.io/components/navbar/](https://reactstrap.github.io/components/navbar/)