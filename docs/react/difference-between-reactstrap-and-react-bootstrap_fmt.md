...
> 原文：[https://www.geeksforgeeks.org/difference-between-reactstrap-and-react-bootstrap/](https://www.geeksforgeeks.org/difference-between-reactstrap-and-react-bootstrap/)
...
| 下载 | 更多下载次数 | 下载次数减少 |
| 装置 | `npm install react-bootstrap` | `npm install reactstrap` |
| 从计算机上卸载 | `npm uninstall react-bootstrap` | `npm uninstall reactstrap` |
