...
> 原文：[https://www.geeksforgeeks.org/how-to-create-bluetooth-toggle-button-in-reactjs/](https://www.geeksforgeeks.org/how-to-create-bluetooth-toggle-button-in-reactjs/)
...
export default function App() {
  ...
  return (
    <div style={{ display: "block", padding: 30 }}>
      ...
      <List
        subheader={<ListSubheader>Mobile Bluetooth Settings</ListSubheader>}
        style={{
          width: 200,
        }}
      >
...
**参考：** [https://material-ui.com/components/lists/#switch](https://material-ui.com/components/lists/#switch)