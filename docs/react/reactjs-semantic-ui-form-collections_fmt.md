...
在本例中，我们将看到如何通过使用 ReactJS 语义 UI 表单集合，使用按钮、复选框和表单元素创建基本表单。
...
在本例中，我们将看到如何使用按钮、复选框和表单元素创建表单，表单状态为加载，以通过使用 ReactJS 语义 UI 表单集合自动显示加载指示器。
...
**参考:** [https://react.semantic-ui.com/collections/form](https://react.semantic-ui.com/collections/form)