...
> 原文: [https://www.geeksforgeeks.org/react-suite-domhelper-component/](https://www.geeksforgeeks.org/react-suite-domhelper-component/)
...
在下面的示例中，我们使用了 `addStyle` 方法，在单击按钮时将样式添加到我们的元素中。
...
export default class App extends React.Component {
  ...
  // Function to set the states with the latest style
  showView() {
...
在下面的示例中，我们使用了 `hasClass` 方法来检查元素是否有自定义命名的类，当用户点击按钮时会触发该功能。
...
export default class App extends React.Component {
  ...
  constructor(props) {
    super(props);
    this.state = {
      htmlCode: `<div class="view" style="font-size: 16px; color: orange;"></div>`
    };
  }
