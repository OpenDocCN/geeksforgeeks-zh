...
Reaction Desktop 是一个将原生桌面体验带到 Web 上的受欢迎的库。该库提供 MacOS 和 Windows OS 组件。`ToolbarNav` 组件用于允许用户添加。我们可以在 ReactJS 中使用以下方法来使用 Reaction Desktop MacOS `ToolbarNav` 组件。
...
[https://reactdesktop.js.org/docs/mac-os/toolbar-nav](https://reactdesktop.js.org/docs/mac-os/toolbar-nav)