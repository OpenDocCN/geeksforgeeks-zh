...
> 原文: [https://www.geeksforgeeks.org/reactjs-onsen-ui-backbutton-component/](https://www.geeksforgeeks.org/reactjs-onsen-ui-backbutton-component/)
  ...
  return (
    <div style={{
      ...
      <Toolbar modifier="material" >
        <div className="left">
          <BackButton modifier="material"></BackButton>
        </div>
...
[https://onsen.io/v2/api/react/BackButton.html](https://onsen.io/v2/api/react/BackButton.html)