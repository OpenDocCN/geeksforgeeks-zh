...
> 原文: [https://www.geeksforgeeks.org/react-rebass-forms-select-component/](https://www.geeksforgeeks.org/react-rebass-forms-select-component/)
...
**步骤 3:** 在给定的目录中安装 `React Rebass` 和 `@rebass/forms` 组件。
...
**参考:** [https://rebassjs.org/forms/select](https://rebassjs.org/forms/select)