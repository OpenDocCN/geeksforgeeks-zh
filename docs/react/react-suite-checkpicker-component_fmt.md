...
> 原文: [https://www.geeksforgeeks.org/react-suite-checkpicker-component/](https://www.geeksforgeeks.org/react-suite-checkpicker-component/)

React Suite 是一个流行的前端库，包含一组为中间平台和后端产品设计的 React 组件。检核器组件允许用户选择多个数据。该组件还支持分组。我们可以在 ReactJS 中使用下面的方法来使用 React Suite `CheckPicker` 组件。
...
[https://rsuitejs.com/components/check-picker/](https://rsuitejs.com/components/check-picker/)