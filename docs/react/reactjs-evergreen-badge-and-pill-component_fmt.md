...
React Evergreen 是一个受欢迎的前端库，它有一组 React 组件来构建漂亮的产品，因为这个库是灵活的、合理的默认值和用户友好的。徽章和药丸组件是带有背景色的标签。它们用于标记目的。我们可以在 ReactJS 中使用以下方法来使用常青树徽章和药丸组件。
...
`参考:` [https://evergreen.segment.com/components/badges](https://evergreen.segment.com/components/badges)