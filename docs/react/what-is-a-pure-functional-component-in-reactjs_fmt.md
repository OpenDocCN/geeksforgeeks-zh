...
> 原文：[https://www.geeksforgeeks.org/what-is-a-pure-functional-component-in-reactjs/](https://www.geeksforgeeks.org/what-is-a-pure-functional-component-in-reactjs/)
...
然而，功能组件不能利用 `React.PureComponent` 带来的性能改进和渲染优化，因为根据定义它们不是类。
