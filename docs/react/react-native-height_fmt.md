...
下面的方法涵盖了如何在 [React Native](https://www.geeksforgeeks.org/introduction-react-native/) 中设置高度。为此，我们将使用 `height` 属性。它基本上为给定的组件提供了特定的高度。
...
**参考:** [https://reactnative.dev/docs/height-and-width](https://reactnative.dev/docs/height-and-width)