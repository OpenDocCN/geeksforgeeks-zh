...
> 原文：[https://www.geeksforgeeks.org/how-to-show-upload-or-download-percentage-in-reactjs/](https://www.geeksforgeeks.org/how-to-show-upload-or-download-percentage-in-reactjs/)
  ...
  React.useEffect(() => {
    const timer = setInterval(() => {
      setUploadOrDownloadCount(
        (beforeValue) => (beforeValue >= 100 ? 0 : beforeValue + 10)
      );
    }, 800);
    return () => {
      clearInterval(timer);
