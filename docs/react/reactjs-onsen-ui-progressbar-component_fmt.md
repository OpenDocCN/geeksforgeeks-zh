...
> 原文: [https://www.geeksforgeeks.org/reactjs-onsen-ui-progressbar-component/](https://www.geeksforgeeks.org/reactjs-onsen-ui-progressbar-component/)
...
*   `modifier`: 用于进度条的外观。
*   `value`: 用于表示当前进度的值。
*   `secondaryValue`: 用于表示当前次要进度的值。
*   `indeterminate`: 如果设置为真，用于显示无限循环动画。

## 预设修改器

*   `material`: 用于显示材质设计进度条。
...
## 参考
[https://onsen.io/v2/api/react/ProgressBar.html](https://onsen.io/v2/api/react/ProgressBar.html)