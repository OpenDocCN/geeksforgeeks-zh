...
*   `visible`：如果设置为真，工具栏会显示在屏幕上。

## 预设修改器

*   `material`：用于显示材质设计工具栏。
*   `transparent`：用于使工具栏透明。
*   `cover-content`：用于在页面内容上方显示工具栏。
*   `noshadow`：用于没有阴影的工具栏。
...
## 参考
[https://onsen.io/v2/api/react/Toolbar.html](https://onsen.io/v2/api/react/Toolbar.html)