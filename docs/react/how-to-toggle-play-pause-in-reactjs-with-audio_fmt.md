...
> 原文: [https://www.geeksforgeeks.org/how-to-toggle-play-pause-in-reactjs-with-audio/](https://www.geeksforgeeks.org/how-to-toggle-play-pause-in-reactjs-with-audio/)
...
*   使用 `Audio` 类引用 ReactJS 中的音频文件。
*   将歌曲的默认状态设置为不播放。
*   创建一个功能来处理歌曲的播放/暂停。
*   使用 `Audio` 类的 `play()` 和 `pause()` 功能进行这些操作。
