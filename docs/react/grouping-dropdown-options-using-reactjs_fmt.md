...
> 原文: [https://www.geeksforgeeks.org/grouping-dropdown-options-using-reactjs/](https://www.geeksforgeeks.org/grouping-dropdown-options-using-reactjs/)

将选项分组意味着根据条件将选项分组，以获得更好的用户体验。例如，在我们的手机上，所有联系人都按其第一个字母分组，这样用户就更容易搜索联系人。React 的 Material UI 有这个组件可以给我们用，非常容易集成。
