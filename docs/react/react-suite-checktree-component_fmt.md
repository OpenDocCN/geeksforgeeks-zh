...
> 原文：[https://www.geeksforgeeks.org/react-suite-checktree-component/](https://www.geeksforgeeks.org/react-suite-checktree-component/)
...
*   `uncheckItemValues`：用于设置不渲染复选框的选项值。
*   `value`：用于表示值(受控)。
...
![输出](img/04def73f1249f4d3a8fd19f2bebdcfc5.png)

## 参考

[https://rsuitejs.com/components/check-tree/](https://rsuitejs.com/components/check-tree/)