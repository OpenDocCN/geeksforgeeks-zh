...
> 原文: [https://www.geeksforgeeks.org/reactjs-semantic-ui-modal-module/](https://www.geeksforgeeks.org/reactjs-semantic-ui-modal-module/)
...
## 示例 1
这是展示如何使用 ReactJS 语义 UI 模态模块使用模态模块的基本示例。
...
## 示例 2
在本例中，我们使用 ReactJS 语义 UI 模态模块将对齐方式更改为页面顶部，而不是模态模块的中心。
...
**参考:** [https://react.semantic-ui.com/modules/modal](https://react.semantic-ui.com/modules/modal)