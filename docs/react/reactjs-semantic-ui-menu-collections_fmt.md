...
这是展示如何使用 ReactJS 语义 UI 菜单集合来使用菜单集合的基本示例。
...
在本例中，我们使用 ReactJS 语义 UI 菜单集合来显示菜单集合中的禁用状态。
...
**参考:** [https://react.semantic-ui.com/collections/menu](https://react.semantic-ui.com/collections/menu)