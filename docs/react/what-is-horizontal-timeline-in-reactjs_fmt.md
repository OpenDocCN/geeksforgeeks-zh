...
> 原文：[https://www.geeksforgeeks.org/what-is-horizontal-timeline-in-reactjs/](https://www.geeksforgeeks.org/what-is-horizontal-timeline-in-reactjs/)
...
| January 15(th), 2021 | Festival |
| March 22(nd), 2021 | Board Exam |
...
*   **步骤 3:** 创建 ReactJS 应用程序后，使用以下命令安装 `react-horizontal-timeline`。

```
npm i react-horizontal-timeline
```

*   **步骤 4:** 现在，使用以下命令安装 `prop-types`。
...
[https://www.npmjs.com/package/react-horizontal-timeline](https://www.npmjs.com/package/react-horizontal-timeline)