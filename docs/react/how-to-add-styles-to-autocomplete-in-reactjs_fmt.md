...
> 原文: [https://www.geeksforgeeks.org/how-to-add-styles-to-autocomplete-in-reactjs/](https://www.geeksforgeeks.org/how-to-add-styles-to-autocomplete-in-reactjs/)
...
![项目结构](img/41d788cac635d58e7d4ac76ce4375af7.png)

## 示例
现在在 `App.js` 文件中写下以下代码。在这里，`App` 是我们编写代码的默认组件。以下代码添加了带有样式的自动完成组件。
...
![选择语言时自动完成](img/d7a5886ffdfea3813139ce0a54888884.png)

## 参考
[https://www.npmjs.com/package/react-autocomplete](https://www.npmjs.com/package/react-autocomplete)