...
在本例中，我们将通过使用语义 UI Input 元素，使用一个带有占位符道具的简单输入组件。
...
在本例中，我们将使用一个简单的输入组件，该组件将被禁用状态禁用，并通过使用语义用户界面输入元素使用占位符道具。
...
**参考:** [https://react.semantic-ui.com/elements/input](https://react.semantic-ui.com/elements/input)