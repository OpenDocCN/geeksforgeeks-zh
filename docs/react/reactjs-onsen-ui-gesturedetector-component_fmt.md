...
> 原文: [https://www.geeksforgeeks.org/reactjs-onsen-ui-gesturedetector-component/](https://www.geeksforgeeks.org/reactjs-onsen-ui-gesturedetector-component/)
...
*   `onSweep`: 是一个回调函数，当用户向任意方向刷卡时调用。
*   `onSwipeLeft`: 是用户左刷时调用的回调函数。
...
[https://onsen.io/v2/api/react/GestureDetector.html](https://onsen.io/v2/api/react/GestureDetector.html)