...
> 原文: [https://www.geeksforgeeks.org/animated-sliding-image-gallery-using-framer-and-reactjs/](https://www.geeksforgeeks.org/animated-sliding-image-gallery-using-framer-and-reactjs/)
...
*   **步骤 2:** 创建项目文件夹，即 `image-gallery` 后，使用以下命令移动到该文件夹。
...
[https://codesandbox.io/s/animated-sliding-image-gallery-9pplj](https://codesandbox.io/s/animated-sliding-image-gallery-9pplj)