# 构建一个显示“你好，世界！”的React应用程序

> 原文: [https://www.geeksforgeeks.org/build-a-basic-react-app-that-display-hello-world/](https://www.geeksforgeeks.org/build-a-basic-react-app-that-display-hello-world/)
...
恭喜你，你已经创建了你的第一个 react 应用程序。你今天学到了一些新东西。不要停止学习，继续。学习 [React](https://www.geeksforgeeks.org/reactjs-tutorials/)