...
Reaction Desktop 是一个将原生桌面体验带到 Web 上的受欢迎的库。该库提供 MacOS 和 Windows OS 组件。NavPane 组件用于允许用户在元素之间轻松地导航，因为它是导航窗格。我们可以在 ReactJS 中使用以下方法来使用 Reaction Desktop Windows NavPane 组件。
...
## 引用
[http://reactdesktop.js.org/docs/windows/nav-pane](http://reactdesktop.js.org/docs/windows/nav-pane)