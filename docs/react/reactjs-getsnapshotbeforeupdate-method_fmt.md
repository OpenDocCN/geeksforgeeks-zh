# React.js getSnapshotBeforeUpdate() 方法

> 原文: [https://www.geeksforgeeks.org/reactjs-getsnapshotbeforeupdate-method/](https://www.geeksforgeeks.org/reactjs-getsnapshotbeforeupdate-method/)
...
**步骤 2:** 创建项目文件夹(即 `foldername`)后，使用以下命令将移动到该文件夹:
...
**参考:** [https://reactjs.org/docs/react-component.html#getsnapshotbeforeupdate](https://reactjs.org/docs/react-component.html#getsnapshotbeforeupdate)