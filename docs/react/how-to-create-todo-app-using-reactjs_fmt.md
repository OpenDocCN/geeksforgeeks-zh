...
> 原文：[https://www.geeksforgeeks.org/how-to-create-todo-app-using-reactjs/](https://www.geeksforgeeks.org/how-to-create-todo-app-using-reactjs/)
...
*   该文件将把我们的应用程序渲染成位于 `public` 文件夹中的 HTML 文件。还用文件名 `app.js`
