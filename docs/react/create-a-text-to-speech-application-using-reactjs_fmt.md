# 使用 ReactJS 创建文本到语音的应用程序

> 原文：[https://www.geeksforgeeks.org/create-a-text-to-speech-application-using-reactjs/](https://www.geeksforgeeks.org/create-a-text-to-speech-application-using-reactjs/)
