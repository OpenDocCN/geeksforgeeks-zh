...
`Material UI` 提供了名为【风格功能】的低级实用功能，用于构建强大的设计系统。
...
*   [创建 react app 的知识。](https://www.geeksforgeeks.org/reactjs-setting-development-environment/)

## 安装

要安装 `Material UI`，请在工作目录中运行以下命令。
...
在本例中我们将在 `App.js` 中进行更改，我们将导入 `Material UI` 并放置一个原色按钮。
