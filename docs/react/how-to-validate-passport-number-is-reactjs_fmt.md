...
> 原文: [https://www.geeksforgeeks.org/how-to-validate-passport-number-is-reactjs/](https://www.geeksforgeeks.org/how-to-validate-passport-number-is-reactjs/)

**护照号码**验证是验证用户护照号码的重要步骤。以下示例显示了如何使用 ReactJS 中的 npm 模块验证用户的护照号码。
...
*   `str`: 是字符串类型的输入值。
*   `countryCode`: 是该护照的国家代码，例如: `'AM'`、`'US'`、`'IN'` 等。
