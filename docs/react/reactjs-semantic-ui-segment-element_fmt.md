...
在本例中，我们将使用一个简单的片段组件，通过使用 Semantic UI Segment 元素来创建一段内容。
...
在本例中，我们将使用一个带有加载状态的 `Segment` 组件来显示 `segment` 的内容正在使用语义 UI Segment 元素进行加载。
...
**参考:** [https://react.semantic-ui.com/elements/segment](https://react.semantic-ui.com/elements/segment)