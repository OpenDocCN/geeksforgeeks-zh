...
> 原文: [https://www.geeksforgeeks.org/reactjs-blueprint-inputgroup-component/](https://www.geeksforgeeks.org/reactjs-blueprint-inputgroup-component/)

Blueprint 是一个基于 React 的网络用户界面工具包。该库非常适合构建桌面应用程序的复杂数据密集型界面，并且非常受欢迎。

输入组组件为用户提供了一种向他们提供文本输入的方式。它是从用户那里收集数据的基本组件。我们可以在 ReactJS 中使用以下方法来使用 ReactJS Blueprint `InputGroup` 组件。
...
[https://blueprintjs.com/docs/#core/components/text-inputs](https://blueprintjs.com/docs/#core/components/text-inputs)