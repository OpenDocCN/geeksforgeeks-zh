...
> 原文: [https://www.geeksforgeeks.org/how-to-create-sticky-footer-in-reactjs/](https://www.geeksforgeeks.org/how-to-create-sticky-footer-in-reactjs/)
...
*   **步骤 2:** 创建项目文件夹后，即`react-footer`，使用以下命令移动到该文件夹:
...
在本例中，我们将设计一个页脚，为此，我们需要操作`App.js`文件和`App.css`以及`Footer.js`文件。
