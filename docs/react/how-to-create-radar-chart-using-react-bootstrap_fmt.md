...
> 原文: [https://www.geeksforgeeks.org/how-to-create-radar-chart-using-react-bootstrap/](https://www.geeksforgeeks.org/how-to-create-radar-chart-using-react-bootstrap/)
...
*   **步骤 4:** 在 `index.js` 中添加 Bootstrap CSS 和 fontawesome CSS。
