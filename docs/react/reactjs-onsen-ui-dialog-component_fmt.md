...
*   `onCancel`: 是回调函数，只有当 `cancelable` 为真时才会触发。
*   `isOpen`: 用于指示对话框是否打开并显示。
*   `cancelable`: 用于指定对话框是否可取消。
...
## 参考
[https://onsen.io/v2/api/react/Dialog.html](https://onsen.io/v2/api/react/Dialog.html)