...
> 原文：[https://www.geeksforgeeks.org/how-to-concatenate-unicode-and-variable-in-reactjs/](https://www.geeksforgeeks.org/how-to-concatenate-unicode-and-variable-in-reactjs/)
...
为了连接，我们首先将 Unicode 转换为它的数值，为此，我们将使用 `parseInt`。
