...
> 原文：[https://www.geeksforgeeks.org/redux-toolkit-better-way-to-write-redux-code-in-reactjs/](https://www.geeksforgeeks.org/redux-toolkit-better-way-to-write-redux-code-in-reactjs/)
...
*   **步骤 3:** 现在使用以下命令，在我们创建的项目中通过 `npm` 或 `yarn` 安装 `Redux Toolkit`:
