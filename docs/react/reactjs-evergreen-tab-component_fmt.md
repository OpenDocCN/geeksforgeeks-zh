...
*   `isSelected`: 当设置为真时，选项卡被选择。
*   `appearance`: 用于表示标签的外观。
*   `direction`: 用于表示拉环的方向性。
*   `className`: 用于表示传递给 Tab 的类名。

`TabNavigation` 道具: 这个不接受任何道具。

`Tablist` 道具: 这个不接受任何道具。
...
![输出](img/b5478e3a5d8d3c773f2c4b3f43482580.png)

**参考:** [https://evergreen.segment.com/components/tabs](https://evergreen.segment.com/components/tabs)