...
> 原文:[https://www.geeksforgeeks.org/react-js-higher-order-components/](https://www.geeksforgeeks.org/react-js-higher-order-components/)
...
在这个示例中，让我们实现一些逻辑。让我们制作一个计数器应用程序。在 HighOrder.js 中，我们传递`handleClick`和`show`道具来调用组件的功能。
...
**参考:** [https://reactjs.org/docs/higher-order-components.html](https://reactjs.org/docs/higher-order-components.html)