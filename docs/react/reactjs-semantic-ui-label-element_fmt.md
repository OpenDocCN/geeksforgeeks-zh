...
在本例中，我们将使用标签和图标元素，通过使用 ReactJS 语义 UI Label 元素来显示基本标签。
...
在本例中，我们将使用标签和图标元素，通过使用 ReactJS 语义 UI 标签元素来显示禁用的标签。
...
**参考:** [https://react.semantic-ui.com/elements/label](https://react.semantic-ui.com/elements/label)