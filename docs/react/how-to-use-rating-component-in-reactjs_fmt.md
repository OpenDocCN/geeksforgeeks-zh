...
评级组件有助于以评级的形式获取用户反馈。借助这个功能，users 还可以对自己购买的产品进行评级。React 的 Material UI 有这个组件可供我们使用，非常容易集成。我们可以在 ReactJS 中使用以下方法来使用评级组件。
...
**参考:** [https://material-ui.com/components/rating/](https://material-ui.com/components/rating/)