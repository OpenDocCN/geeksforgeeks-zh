...
> 原文:[https://www.geeksforgeeks.org/how-to-deploy-react-project-on-firebase/](https://www.geeksforgeeks.org/how-to-deploy-react-project-on-firebase/)
...
我们可以通过访问控制台中 firebase 提供的托管链接来验证我们的网站部署成功，如下图所示:
