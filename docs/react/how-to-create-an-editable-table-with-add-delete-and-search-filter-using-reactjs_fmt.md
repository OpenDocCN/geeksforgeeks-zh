...
> 原文：[https://www.geeksforgeeks.org/how-to-create-an-editable-table-with-add-delete-and-search-filter-using-reactjs/](https://www.geeksforgeeks.org/how-to-create-an-editable-table-with-add-delete-and-search-filter-using-reactjs/)
...
我们不需要一些像 `App.css`、`logo.svg` 这样的文件，去掉它们，添加一个新的文件 `TableDemo.js`，我们的表组件将驻留在这个文件中。
...
现在相应地在 `App.js` 和 `TableDemo.js` 文件中写下以下代码。在这里，`App` 是我们的默认组件，我们已经替换了默认代码。
