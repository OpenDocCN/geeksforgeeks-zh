...
在本例中，我们将使用一个图标组件，通过使用 ReactJS 语义 UI Icon 元素来启用图标的状态。
...
在本例中，我们将使用一个图标组件，通过使用 ReactJS 语义 UI 图标元素，将图标的状态设置为禁用。
...
在本例中，我们将使用一个图标组件，通过使用 ReactJS 语义 UI Icon 元素，将图标的状态作为加载状态。
...
**参考:** [https://react.semantic-ui.com/elements/icon](https://react.semantic-ui.com/elements/icon)