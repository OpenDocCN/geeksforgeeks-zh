...
*   **错误:** 使用该状态的用户可以很容易地检测到或看到可能有错误的单元格或行值。
...
在本例中，我们将使用 ReactJS 语义 UI `Table` 集合，使用表格、标题和评级元素来显示基本表格。
...
在本例中，我们将使用 ReactJS 语义 UI `Table` 集合，使用表格、标题和评级元素来显示带有错误状态的表格。
...
**参考:** [https://react.semantic-ui.com/collections/table](https://react.semantic-ui.com/collections/table)