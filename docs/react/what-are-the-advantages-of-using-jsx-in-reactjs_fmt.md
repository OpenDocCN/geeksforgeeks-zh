...
> 原文: [https://www.geeksforgeeks.org/what-are-the-advantages-of-using-jsx-in-reactjs/](https://www.geeksforgeeks.org/what-are-the-advantages-of-using-jsx-in-reactjs/)
...
### 步骤 2
创建项目文件夹后，例如 `example`，使用以下命令移动到该文件夹:
...
### 步骤 3
新建一个名为 `Components` 的文件夹，创建文件 `Nojsx.js` 和 `Jsx.js`。
...
在 `App.js`、`Nojsx.js` 和 `Jsx.js` 文件中写下以下代码。
...
两种成分会产生相同的结果。我们可以得出结论，用 JSX 编写组件代码比不用 JSX 编写要简单得多。
