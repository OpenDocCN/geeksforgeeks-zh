...
> 原文: [https://www.geeksforgeeks.org/react-suite-cascader-component/](https://www.geeksforgeeks.org/react-suite-cascader-component/)
...
### 步骤 2:
在创建项目文件夹(即文件夹名`)后，使用以下命令将`移动到该文件夹:
```jsx
cd foldername
```

### 步骤 3:
创建 ReactJS 应用程序后，使用以下命令安装所需的`rsuite`模块:
```jsx
npm install rsuite
```
...
## 参考:
[https://rsuitejs.com/components/cascader/](https://rsuitejs.com/components/cascader/)