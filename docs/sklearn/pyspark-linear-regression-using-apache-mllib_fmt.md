...
> 原文: [https://www.geeksforgeeks.org/pyspark-linear-regression-using-apache-mllib/](https://www.geeksforgeeks.org/pyspark-linear-regression-using-apache-mllib/)

问题陈述：为航运公司建立一个预测模型，以估计一艘船需要多少船员。数据集包含 159 个实例和 9 个特征。
