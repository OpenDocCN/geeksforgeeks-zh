...
> 原文: [https://www.geeksforgeeks.org/ml-naive-bayes-scratch-implementation-using-python/](https://www.geeksforgeeks.org/ml-naive-bayes-scratch-implementation-using-python/)
...
*   条件概率可以这样找到。
*   假设我们有一个假设( *H* )和证据( *E* )，根据贝叶斯定理，在得到表示为 *P(H)* 的证据之前假设的概率和得到表示为 *P(H|E)* 的证据之后假设的概率之间的关系是:
...
一套 *13* 张牌中有 *3* 张面牌，总共有 *4* 套，所以 *P(面)= 12/52*。
