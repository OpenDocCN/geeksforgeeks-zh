# 使用 GridSearchCV 进行 SVM 超参数调谐

> 原文：[https://www.geeksforgeeks.org/svm-hyperparameter-tuning-using-gridsearchcv-ml/](https://www.geeksforgeeks.org/svm-hyperparameter-tuning-using-gridsearchcv-ml/)
