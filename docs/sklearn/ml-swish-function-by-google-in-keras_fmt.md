...
> 原文: [https://www.geeksforgeeks.org/ml-swish-function-by-google-in-keras/](https://www.geeksforgeeks.org/ml-swish-function-by-google-in-keras/)
...
下面是 Swish 函数对许多社区主导激活函数(如 ReLU、LReLU、Leaky ReLU 等)的性能度量。
