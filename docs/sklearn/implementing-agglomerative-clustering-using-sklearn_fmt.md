...
> 原文：[https://www.geeksforgeeks.org/implementing-agglomerative-clustering-using-sklearn/](https://www.geeksforgeeks.org/implementing-agglomerative-clustering-using-sklearn/)
...
因此，借助于`轮廓分数`，可以得出结论，对于给定的数据和聚类技术，最佳聚类数是 2。