...
> 原文：[https://www.geeksforgeeks.org/ml-reinforcement-learning-algorithm-python-implementation-using-q-learning/](https://www.geeksforgeeks.org/ml-reinforcement-learning-algorithm-python-implementation-using-q-learning/)

**先决条件：** [Q-Learning in Python](https://www.geeksforgeeks.org/q-learning-in-python/)。
...
**注意：** 上面的图在复制代码时可能看起来不一样，因为 `networkx` 库根据给定的边生成一个随机图。
