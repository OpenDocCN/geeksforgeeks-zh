...
> 原文: [https://www.geeksforgeeks.org/ml-word-encryption-using-keras/](https://www.geeksforgeeks.org/ml-word-encryption-using-keras/)
...
*   张量流: 从[这里](https://www.tensorflow.org/install)学习安装张量流
*   NumPy: Learn to install numpy from [here](https://numpy.org/)
