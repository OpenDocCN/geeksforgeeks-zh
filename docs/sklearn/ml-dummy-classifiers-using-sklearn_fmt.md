...
> 原文: [https://www.geeksforgeeks.org/ml-dummy-classifiers-using-sklearn/](https://www.geeksforgeeks.org/ml-dummy-classifiers-using-sklearn/)
...
通过比较 `KNeighborsClassifier` 和虚拟分类器的得分，我们得出结论，对于给定的数据，`KNeighborsClassifier` 实际上是一个好的分类器。