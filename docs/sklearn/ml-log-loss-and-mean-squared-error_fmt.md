...
> 原文: [https://www.geeksforgeeks.org/ml-log-loss-and-mean-squared-error/](https://www.geeksforgeeks.org/ml-log-loss-and-mean-squared-error/)
...
N  : no. of samples.
M  : no. of attributes.
y_ij : indicates whether ith sample belongs to jth class or not.
p_ij : indicates probability of ith sample belonging to jth class.
```
