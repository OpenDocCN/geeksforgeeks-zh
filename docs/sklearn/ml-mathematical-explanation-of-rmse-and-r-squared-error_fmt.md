...
> 原文：[https://www.geeksforgeeks.org/ml-mathematical-explanation-of-rmse-and-r-squared-error/](https://www.geeksforgeeks.org/ml-mathematical-explanation-of-rmse-and-r-squared-error/)

`RMSE`：均方根误差是回归线与数据点拟合程度的量度。`RMSE` 也可以解释为残差中的标准差。
