...
> 原文: [https://www.geeksforgeeks.org/ml-rainfall-prediction-using-linear-regression/](https://www.geeksforgeeks.org/ml-rainfall-prediction-using-linear-regression/)
...
我们将使用 Scikit-learn 的 `LinearRegression` 模型来训练我们的数据集。一旦模型被训练好，我们就可以为各种列给出我们自己的输入，如温度、露点、压力等。根据这些属性来预测天气。
