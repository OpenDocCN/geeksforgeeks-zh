...
> 原文: [https://www.geeksforgeeks.org/how-to-install-scikit-learn-on-linux/](https://www.geeksforgeeks.org/how-to-install-scikit-learn-on-linux/)
...
### 步骤 2: 获取 scikit-learn 存储库，并使用以下命令克隆它。
