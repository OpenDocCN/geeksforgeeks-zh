...
> 原文: [https://www.geeksforgeeks.org/ml-implement-face-recognition-using-k-nn-with-scikit-learn/](https://www.geeksforgeeks.org/ml-implement-face-recognition-using-k-nn-with-scikit-learn/)
...
这包括三个 Python 文件，其中第一个用于检测人脸并将其存储为列表格式，第二个用于存储数据为`.csv`文件格式，第三个用来识别人脸。
