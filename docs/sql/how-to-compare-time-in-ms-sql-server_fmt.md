...
> 原文：[https://www.geeksforgeeks.org/how-to-compare-time-in-ms-sql-server/](https://www.geeksforgeeks.org/how-to-compare-time-in-ms-sql-server/)
...
在 MS SQL Server 中，查询可以被设计为仅使用 `if` 语句来比较两个或多个 `datetime` 变量。
