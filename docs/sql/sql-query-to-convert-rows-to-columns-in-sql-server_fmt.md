...
> 原文: [https://www.geeksforgeeks.org/sql-query-to-convert-rows-to-columns-in-sql-server/](https://www.geeksforgeeks.org/sql-query-to-convert-rows-to-columns-in-sql-server/)
...
| **名称** | **学院** | **辊号** | **主题** | **马克** |
| :--- | :--- | :--- | :--- | :--- |
| ROMY | BVP | 0261150 | DBMS | 95 |
| ROMY | BVP | 0261150 | NETWORKING | 90 |
| ROMY | BVP | 0261150 | GRAPHICS | 100 |
| PUSHKAR | MSIT | 08999 | DBMS | 79 |
| PUSHKAR | MSIT | 08999 | NETWORKING | 97 |
| PUSHKAR | MSIT | 08999 | GRAPHICS | 98 |

如果我们将此表的数据存储为以下形式会更好：

| **名称** | **学院** | **辊号** | **DBMS** | **NETWORKING** | **GRAPHICS** |
| :--- | :--- | :--- | :--- | :--- | :--- |
| ROMY | BVP | 0261150 | 95 | 90 | 100 |
| PUSHKAR | MSIT | 08999 | 79 | 97 | 98 |

我们可以使用 SQL 中的 `PIVOT` 函数将行转换为列。
...
为了演示的目的，我们将在名为 `geeks` 的数据库中创建一个 `demo_table`。
...
我们使用了 `AVG` 聚合函数，因为一个值的平均值就是该值本身。
