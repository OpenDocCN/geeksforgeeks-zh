...
> 原文: [https://www.geeksforgeeks.org/sin-and-cos-function-in-mysql/](https://www.geeksforgeeks.org/sin-and-cos-function-in-mysql/)
...
90 度余弦即 1.5707963267948966 弧度使用 `COS()` 函数。
