...
请注意，在下载 MySQL 连接器之前，您应该清楚您使用的 MySQL 版本，即版本 5 还是版本 8。要检查您的计算机上安装了哪个版本的 MySQL，请打开 MySQL 命令行客户端；编写查询`show variables like '%version%';`。这会给你一个包含多行的表格，检查表格的版本行，确认你安装的版本。
