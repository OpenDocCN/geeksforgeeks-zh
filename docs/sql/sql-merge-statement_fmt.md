...
## 先决条件
[`INSERT`](https://www.geeksforgeeks.org/sql-insert-statement/)、[`UPDATE`](https://www.geeksforgeeks.org/sql-update-statement/)、[`DELETE`](https://www.geeksforgeeks.org/sql-delete-statement/)
...
*   什么时候需要删除数据？
    当目标表中有数据而源表中没有数据时，*即*当数据与源表不匹配时。
