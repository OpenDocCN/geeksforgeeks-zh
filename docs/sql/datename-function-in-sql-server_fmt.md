...
> 原文: [`https://www.geeksforgeeks.org/datename-function-in-sql-server/`](https://www.geeksforgeeks.org/datename-function-in-sql-server/)

## DATENAME()功能

SQL Server 中的这个函数用于查找指定日期的给定部分。此外，它以字符串形式返回输出值。
