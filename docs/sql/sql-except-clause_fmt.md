...
## 例:
说我们有两个关系，学生和 TA(助教)。我们想把那些不是助教的学生都退回来。该查询可以表述为:
...
要保留重复项，我们必须明确地写`EXCEPTALL`而不是 `EXCEPT`。
...
本文由 **Anannya Uberoi** 供稿。如果你喜欢 GeeksforGeeks 并想投稿，你也可以使用`contribute.geeksforgeeks.org`写一篇文章或者把你的文章邮寄到`contribute@geeksforgeeks.org`。看到你的文章出现在极客博客主页上，帮助其他极客。
