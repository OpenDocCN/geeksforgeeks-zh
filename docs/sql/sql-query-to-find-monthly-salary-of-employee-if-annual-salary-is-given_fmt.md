...
> 原文：[https://www.geeksforgeeks.org/sql-query-to-find-monthly-salary-of-employee-if-annual-salary-is-given/](https://www.geeksforgeeks.org/sql-query-to-find-monthly-salary-of-employee-if-annual-salary-is-given/)
...
要使用数据库，我们需要在 `SQL` 的平台上使用一个查询，比如 `MySql`、`Oracle` 等。问题是，
...
现在把工资四舍五入到小数点后 2 位，为此我们已经使用了`round`功能，见下图
