...
> 原文: [https://www.geeksforgeeks.org/sql-query-to-get-information-of-employee-where-employee-is-not-assigned-to-the-department/](https://www.geeksforgeeks.org/sql-query-to-get-information-of-employee-where-employee-is-not-assigned-to-the-department/)
...
## 步骤-3: 创建表
使用如下 SQL 查询创建一个包含 5 列的表 `employee`。
