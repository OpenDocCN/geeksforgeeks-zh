...
> 原文: [https://www.geeksforgeeks.org/sql-query-to-delete-duplicate-rows/](https://www.geeksforgeeks.org/sql-query-to-delete-duplicate-rows/)

通过本文，我们将学习如何从数据库表中删除重复的行。正如我们所知，数据库中的表里存在重复数据往往会浪费内存空间。它记录了不准确的数据，也无法从数据库中取出正确的数据。
