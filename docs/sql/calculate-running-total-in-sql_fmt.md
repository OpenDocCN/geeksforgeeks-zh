...
> 原文：[https://www.geeksforgeeks.org/calculate-running-total-in-sql/](https://www.geeksforgeeks.org/calculate-running-total-in-sql/)
...
### 示例 3：使用 PARTITION BY 和 OVER 来查找运行总数
