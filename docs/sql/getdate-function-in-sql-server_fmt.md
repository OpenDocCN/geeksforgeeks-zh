...
> 原文: [https://www.geeksforgeeks.org/getdate-function-in-sql-server/](https://www.geeksforgeeks.org/getdate-function-in-sql-server/)
...
### 输出
| index number | id_num | news | Generate_at |
| :--- | :--- | :--- | :--- |
