...
> 原文: [https://www.geeksforgeeks.org/unix_timestamp-function-in-mysql/](https://www.geeksforgeeks.org/unix_timestamp-function-in-mysql/)
...
*   **`date` –**
    日期值，可以是日期、日期时间、时间戳或 "YYYYMMDD" 或 "YYMMDD" 格式的数字。
...
## 示例-2
使用日期值 '1999-01-22' 运行 `UNIX_TIMESTAMP()`。
...
## 示例-4
使用日期时间值和分数秒 '2020-10-17 02:35:43.12345' 来工作 `UNIX_TIMESTAMP()`。
