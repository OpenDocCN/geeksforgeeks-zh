...
> 原文: [https://www.geeksforgeeks.org/sql-query-to-print-name-of-distinct-employee-whose-dob-is-between-a-given-range/](https://www.geeksforgeeks.org/sql-query-to-print-name-of-distinct-employee-whose-dob-is-between-a-given-range/)
...
我们的`geeks`数据库中有以下`department`表:
...
`Date`数据类型使用格式`YYYY-MM-DD`。使用以下语句向`department`表添加数据:
