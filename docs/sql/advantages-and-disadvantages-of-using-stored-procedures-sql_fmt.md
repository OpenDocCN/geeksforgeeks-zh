...
> 原文: [https://www.geeksforgeeks.org/advantages-and-disadvantages-of-using-stored-procedures-sql/](https://www.geeksforgeeks.org/advantages-and-disadvantages-of-using-stored-procedures-sql/)

**存储过程**是 SQL 中的一种代码，可以存储起来以备后用，可以多次使用。因此，无论何时需要执行查询，都可以不调用它，而只调用存储过程。您也可以将参数传递给存储过程，以便存储过程可以基于传递的参数值进行操作。
