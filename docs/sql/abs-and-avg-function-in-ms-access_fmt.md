# MS Access中的`Abs()`和`Avg()`功能

> 原文：[https://www.geeksforgeeks.org/abs-and-avg-function-in-ms-access/](https://www.geeksforgeeks.org/abs-and-avg-function-in-ms-access/)
