...
| `SELECT [column1, column2, ....]`<br>`FROM table1`<br>`LEFT OUTER JOIN table2 ON`<br>`table1.matching_column = table2.matching_column` | `SELECT [column1, column2, ....]`<br>`FROM table1`<br>`RIGHT OUTER JOIN table2 ON`<br>`table1.matching_column = table2.matching_column` | `SELECT [column1, column2, ....]`<br>`FROM table1`<br>`FULL OUTER JOIN table2 ON`<br>`table1.matching_column = table2.matching_column` |