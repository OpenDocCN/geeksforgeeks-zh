# 用 PL/SQL 统计两个日期之间特殊的一天的次数

> 原文: [https://www.geeksforgeeks.org/count-the-number-of-a-special-day-between-two-dates-by-using-pl-sql/](https://www.geeksforgeeks.org/count-the-number-of-a-special-day-between-two-dates-by-using-pl-sql/) 计算两个日期之间的特殊天数
