...
> 原文: [https://www.geeksforgeeks.org/sql-query-to-rename-stored-procedure/](https://www.geeksforgeeks.org/sql-query-to-rename-stored-procedure/)
...
我们将创建一个名为 `Display` 的过程来查看表格的所有内容。
...
为了演示，让我们将程序名称从 `Display` 重命名为 `Show`。
