...
> 原文：[https://www.geeksforgeeks.org/sql-query-to-drop-unique-key-constraints-using-alter-command/](https://www.geeksforgeeks.org/sql-query-to-drop-unique-key-constraints-using-alter-command/)

在这里，我们看到如何使用 `ALTER` 命令删除唯一约束。`ALTER` 用于添加、删除或修改现有表中的列。它还用于在现有表上添加和删除各种约束。
