...
> 原文: [https://www.geeksforgeeks.org/sql-query-to-select-data-from-tables-using-join-and-where/](https://www.geeksforgeeks.org/sql-query-to-select-data-from-tables-using-join-and-where/)
...
### 步骤 3: 在数据库中创建一个表 1 作为员工，我们将在其中执行我们的操作
...
### 步骤 4: 创建另一个表 2 作为部门，我们将在此存储第二家公司员工的数据
