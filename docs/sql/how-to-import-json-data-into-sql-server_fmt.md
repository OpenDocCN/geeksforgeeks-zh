...
> 原文：[https://www.geeksforgeeks.org/how-to-import-json-data-into-sql-server/](https://www.geeksforgeeks.org/how-to-import-json-data-into-sql-server/)
...
现在，为了在 SQL 服务器中导入 JSON 数据，我们将使用 `OPENROWSET(BULK)`。
