...
> 原文: [https://www.geeksforgeeks.org/sql-software-and-query-optimization-tools/](https://www.geeksforgeeks.org/sql-software-and-query-optimization-tools/)
...
1.  **SolarWinds Database Performance Analyzer –**
    关系数据库的性能监控，如 `Assure SQL`、`MySQL`、`ase`、`IBM DB2` 数据库。
