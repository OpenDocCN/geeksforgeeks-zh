...
> 原文: [https://www.geeksforgeeks.org/sql-query-to-check-given-format-of-a-date/](https://www.geeksforgeeks.org/sql-query-to-check-given-format-of-a-date/)
...
我们的`极客`数据库中有一个名为`department`的下表。
