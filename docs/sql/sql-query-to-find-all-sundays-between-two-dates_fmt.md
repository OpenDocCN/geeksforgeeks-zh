...
> 原文: [https://www.geeksforgeeks.org/sql-query-to-find-all-sundays-between-two-dates/](https://www.geeksforgeeks.org/sql-query-to-find-all-sundays-between-two-dates/)
...
`DATEADD(part, number, date)` : 该方法用于将指定的 `number` 添加到给定的 `date` 的 `part` 中。
