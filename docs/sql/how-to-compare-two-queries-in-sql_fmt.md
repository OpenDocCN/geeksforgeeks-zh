...
> 原文: [https://www.geeksforgeeks.org/how-to-compare-two-queries-in-sql/](https://www.geeksforgeeks.org/how-to-compare-two-queries-in-sql/)
...
**在已创建的数据库中创建表:**
我们使用 `CREATE TABLE` 命令创建一个新的 SQL 数据库。
...
**将值插入到创建的表中:**
我们使用 `INSERT INTO` 命令创建一个新的 SQL 数据库。
