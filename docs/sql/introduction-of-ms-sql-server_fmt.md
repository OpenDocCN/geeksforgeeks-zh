...
> 原文：[https://www.geeksforgeeks.org/introduction-of-ms-sql-server/](https://www.geeksforgeeks.org/introduction-of-ms-sql-server/)
...
3.  `SQL` 和 `SQL Server` 被构建为两层，其中 `SQL Server` 位于顶层，用于与关系数据库进行交互。
