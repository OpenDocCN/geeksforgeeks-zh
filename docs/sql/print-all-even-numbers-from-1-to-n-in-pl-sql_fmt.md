...
> 原文：[https://www.geeksforgeeks.org/print-all-even-numbers-from-1-to-n-in-pl-sql/](https://www.geeksforgeeks.org/print-all-even-numbers-from-1-to-n-in-pl-sql/)
...
`方法`是用 2 初始化一个`数`，并不断增加 2，直到`数`为 <= `n`。下面是它的实现：
