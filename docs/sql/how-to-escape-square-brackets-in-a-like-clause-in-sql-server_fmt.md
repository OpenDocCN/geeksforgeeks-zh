...
> 原文: [https://www.geeksforgeeks.org/how-to-escape-square-brackets-in-a-like-clause-in-sql-server/](https://www.geeksforgeeks.org/how-to-escape-square-brackets-in-a-like-clause-in-sql-server/)
...
方括号 `[]` 是 SQL 中 `LIKE` 子句使用的通配符运算符之一。用于匹配指定[范围](https://www.geeksforgeeks.org/sql-query-to-match-any-part-of-string/)内的任意单个字符，如 `([b-h])` 或集合 `([ghijk])`。
