...
> 原文: [https://www.geeksforgeeks.org/sql-remove-duplicates-without-distinct/](https://www.geeksforgeeks.org/sql-remove-duplicates-without-distinct/)
...
使用分组删除重复项的想法是根据输出中要选择的所有列进行分组。例如，如果我们希望打印“名字、姓氏和手机号”的唯一值，我们可以简单地将这三个值分组。
