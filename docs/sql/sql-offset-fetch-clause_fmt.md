...
![员工表](img/221680a1a149aa2d9ee0ae768b0554ed.png)
...
![偏移输出](img/2e340c8ea361e00d8d6227e52c214b81.png)
...
![FETCH范围输出](img/6037ce7c63f66c5a8a20e40aaff9f982.png)
...
![FETCH最后几行输出](img/afbb2f36325583c0789cd3d8b7b0352d.png)

## 要点:

1.  对于 `FETCH`，`OFFSET` 子句是必需的。你永远不能使用 `ORDER BY...FETCH`。
