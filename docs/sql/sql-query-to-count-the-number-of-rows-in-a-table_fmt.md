...
> 原文: [https://www.geeksforgeeks.org/sql-query-to-count-the-number-of-rows-in-a-table/](https://www.geeksforgeeks.org/sql-query-to-count-the-number-of-rows-in-a-table/)
...
`count()` 函数的作用是:返回表中的行数。它与 `Select()` 语句一起使用。
