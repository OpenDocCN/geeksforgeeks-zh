...
> 原文: [https://www.geeksforgeeks.org/sql-query-to-display-last-5-records-from-employee-table/](https://www.geeksforgeeks.org/sql-query-to-display-last-5-records-from-employee-table/)
...
> `WHERE`
>
> `<id_column> > (SELECT COUNT(*) FROM <table_name>) - (要检索的行数);`
...
> **语法:**
>
> `PREPARE <statement_name> FROM "<any valid SQL query>"; /*使用 ? (问号)表示在执行时必须用一个值替换它*/`
>
> `EXECUTE <statement_name> USING <template_values or parameters values>;`
