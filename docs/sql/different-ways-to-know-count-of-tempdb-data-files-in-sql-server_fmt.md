...
> 原文: [https://www.geeksforgeeks.org/different-ways-to-know-count-of-tempdb-data-files-in-sql-server/](https://www.geeksforgeeks.org/different-ways-to-know-count-of-tempdb-data-files-in-sql-server/)
...
另一种常见的方法是在 TempDB 的 `sys.database_files` 中查找 tempDB 文件的数量。
...
另一种常见的方法是在 TempDB 的 `sys.database_files` 中查找 tempDB 文件的**细节**。
