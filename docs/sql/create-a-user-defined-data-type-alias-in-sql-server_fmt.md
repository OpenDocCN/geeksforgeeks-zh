...
> 原文: [https://www.geeksforgeeks.org/create-a-user-defined-data-type-alias-in-sql-server/](https://www.geeksforgeeks.org/create-a-user-defined-data-type-alias-in-sql-server/)
...
要解除规则与用户定义数据类型的绑定，请使用`sp_unbindrule`。
