...
> 原文: [https://www.geeksforgeeks.org/isdate-function-in-sql-server/](https://www.geeksforgeeks.org/isdate-function-in-sql-server/)

**ISDATE()函数:**
SQL Server 中的这个函数用于检查指定的表达式是否为有效日期。
