...
> 原文: [https://www.geeksforgeeks.org/abs-and-avg-function-in-sqlite/](https://www.geeksforgeeks.org/abs-and-avg-function-in-sqlite/)
...
现在，我们将使用一个真实的数据库示例。首先，让我们创建一个名为 `students` 的表，其中列有 `name` 和 `age`，并插入一些行！
