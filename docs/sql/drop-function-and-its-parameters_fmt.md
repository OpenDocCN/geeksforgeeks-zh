...
> 原文: [https://www.geeksforgeeks.org/drop-function-and-its-parameters/](https://www.geeksforgeeks.org/drop-function-and-its-parameters/)

## 删除函数

[删除函数](https://www.geeksforgeeks.org/sql-drop-truncate/) 语句可用于删除现有的用户定义函数。
...
*   `schema_name` –
    `schema_name` 是可选参数。`schema_name` 定义了用户定义函数所属的模式的名称。
*   `function_name` –
    `function_name` 是将要删除的函数的名称。
