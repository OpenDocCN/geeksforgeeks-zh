...
> 原文:`https://www.geeksforgeeks.org/mysql-conv-function/`
...
*   `数字`–用于指定需要更改基数的数字。
*   `current_base`–用于指定数字的当前基本系统。
*   `new_base`–用于指定需要转换数字的期望基数系统。
...
## 示例-1:
实现 `CONV()`函数，将数字从数字基数系统 10 转换为数字基数系统 2。
...
## 示例-2:
实现 `CONV()`函数，将数字从数字基数系统 2 转换为数字基数系统 10。
...
## 示例-3:
实现 `CONV()`函数，将负数从数字基数系统 8 转换为数字基数系统 10。
...
## 示例-4:
实现 `CONV()`函数，将数字从基数系统 16 转换为基数系统 10。
