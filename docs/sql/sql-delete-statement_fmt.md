...
## 注意:
根据我们在 WHERE 子句中提供的条件，我们可以删除单个以及多个记录。如果我们省略 WHERE 子句，那么所有的记录都将被删除，并且表将是空的。
...
Delete the rows from the table Student where Age is 20. This will delete 2 rows(third row and fifth row).
