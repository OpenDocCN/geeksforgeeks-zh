...
> 原文：[https://www.geeksforgeeks.org/difference-between-drop-and-truncate-in-sql/](https://www.geeksforgeeks.org/difference-between-drop-and-truncate-in-sql/)

先决条件 – [在 SQL 中 `DELETE` 和 `TRUNCATE`](https://www.geeksforgeeks.org/sql-drop-truncate/)
