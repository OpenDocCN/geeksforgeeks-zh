...
> 原文: [https://www.geeksforgeeks.org/difference-between-nosql-and-newsql/](https://www.geeksforgeeks.org/difference-between-nosql-and-newsql/)
...
| 5. | Improve the [CAP](https://www.geeksforgeeks.org/the-cap-theorem-in-dbms/) attribute. | Improve [ACID](https://www.geeksforgeeks.org/acid-properties-in-dbms/) attribute. |
| 6. | Online transaction processing is not supported. | Full support for [Online transaction processing](https://www.geeksforgeeks.org/on-line-transaction-processing-oltp-system-in-dbms/). |
...
| 9. | 示例: DynamoDB、MongoDB、RavenDB 等。 | 示例: VoltDB、CockroachDB、NuoDB 等。 |