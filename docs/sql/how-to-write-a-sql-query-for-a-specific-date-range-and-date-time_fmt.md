...
> 原文: [https://www.geeksforgeeks.org/how-to-write-a-sql-query-for-a-specific-date-range-and-date-time/](https://www.geeksforgeeks.org/how-to-write-a-sql-query-for-a-specific-date-range-and-date-time/)
...
## 步骤 3: 创建 PERSONAL 表
在数据库 `GeeksForGeeks` 中创建一个 `PERSONAL` 表。该表有 3 列，即婴儿名、病房号和出生日期时间，包含各种婴儿的姓名、病房号以及出生日期和时间。
...
## 步骤 7: 检索特定日期范围内的婴儿详情
检索 2000 年 1 月 1 日上午 12:00 至 2002 年 9 月 18 日下午 12:00 之间出生的婴儿的详细信息。
...
## 步骤 8: 检索另一个日期范围内的婴儿详情
检索 2001 年 5 月 1 日上午 11:00 至 2005 年 5 月 1 日晚上 10:00 之间出生的婴儿的详细信息。
...
## 步骤 9: 检索特定日期之后出生的婴儿详情
检索 2005 年圣诞节当天或之后出生的婴儿的详细信息。
