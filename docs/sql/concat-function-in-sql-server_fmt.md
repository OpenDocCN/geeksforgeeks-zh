...
> 原文: [https://www.geeksforgeeks.org/concat-function-in-sql-server/](https://www.geeksforgeeks.org/concat-function-in-sql-server/)
...
### 参数:
*   `string_1`，`string_2`，…。`string_n` – 需要连接的给定字符串。
