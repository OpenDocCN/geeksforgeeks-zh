...
> 原文：[`https://www.geeksforgeeks.org/merge-statement-sql-explained/`](https://www.geeksforgeeks.org/merge-statement-sql-explained/)

## 先决条件

[`MERGE` 语句](https://www.geeksforgeeks.org/sql-merge-statement/)
...
因此在这个例子中，由于要求它按照更新的列表更新产品列表中的产品，因此 `PRODUCT_LIST` 将作为目标，`UPDATED_LIST` 将作为源表。
...
1.  目标表的咖啡价格是 15.00 英镑，而源表是 25.00 英镑
