...
> 原文: [https://www.geeksforgeeks.org/how-to-find-last-value-from-any-table-in-sql-server/](https://www.geeksforgeeks.org/how-to-find-last-value-from-any-table-in-sql-server/)

我们可以在 [SQL Server](https://www.geeksforgeeks.org/introduction-of-ms-sql-server/) 中使用 `LAST_VALUE()` 从任何表中查找最后一个值。`LAST_VALUE()` 函数是一种窗口函数，其结果是给定数据集的有序分区中的最后一个值。
