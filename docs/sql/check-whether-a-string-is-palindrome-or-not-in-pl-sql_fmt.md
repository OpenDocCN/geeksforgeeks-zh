...
> 原文: [https://www.geeksforgeeks.org/check-whether-a-string-is-palindrome-or-not-in-pl-sql/](https://www.geeksforgeeks.org/check-whether-a-string-is-palindrome-or-not-in-pl-sql/)
...
### 进场
是取弦，倒弦，检查倒弦是否与原弦相等。如果相等，则是回文，否则不是。
