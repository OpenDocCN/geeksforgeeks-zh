...
> 原文: [https://www.geeksforgeeks.org/mitigation-sql-injection-attack-using-prepared-statements-parameterized-queries/](https://www.geeksforgeeks.org/mitigation-sql-injection-attack-using-prepared-statements-parameterized-queries/)
...
String query = "SELECT userName, balance "+
               "FROM accounts WHERE userID = ? and password = ?";
