...
> 原文: [https://www.geeksforgeeks.org/difference-between-ddl-and-dml-in-dbms/](https://www.geeksforgeeks.org/difference-between-ddl-and-dml-in-dbms/)
...
| `DDL` 中基本命令有 `CREATE`、`DROP`、`RENAME`、`ALTER` 等。 | `DML` 中基本命令有 `UPDATE`、`INSERT`、`MERGE` 等。 |
