...
> 原文: [https://www.geeksforgeeks.org/how-to-update-current-timestamp-in-mysql/](https://www.geeksforgeeks.org/how-to-update-current-timestamp-in-mysql/)
...
创建一个员工表，将 `empLoginTime` 字段作为时间戳。
