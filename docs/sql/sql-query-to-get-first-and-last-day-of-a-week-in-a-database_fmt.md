...
> 原文: [https://www.geeksforgeeks.org/sql-query-to-get-first-and-last-day-of-a-week-in-a-database/](https://www.geeksforgeeks.org/sql-query-to-get-first-and-last-day-of-a-week-in-a-database/)
...
## 步骤 6: 现在我们将使用 `DATEADD` 函数找出下周的第一天是什么
...
## 步骤 7: 现在我们将使用 `DATEADD` 函数找出下周的最后一天是什么
