...
> 原文: [https://www.geeksforgeeks.org/concatenation-of-strings-in-pl-sql/](https://www.geeksforgeeks.org/concatenation-of-strings-in-pl-sql/)

## 先决条件
[PL/SQL 简介](https://www.geeksforgeeks.org/plsql-introduction/)
...
## 方法
是使用[串联](https://docs.oracle.com/cd/B19306_01/server.102/b14200/operators003.htm)运算符，即 `||`。
