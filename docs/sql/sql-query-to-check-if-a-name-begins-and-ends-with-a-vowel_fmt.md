...
> 原文: [https://www.geeksforgeeks.org/sql-query-to-check-if-a-name-begins-and-ends-with-a-vowel/](https://www.geeksforgeeks.org/sql-query-to-check-if-a-name-begins-and-ends-with-a-vowel/)
...
## 步骤 7: 使用字符串函数和 IN 运算符进行查询，检查姓名是否以元音开头和结尾
