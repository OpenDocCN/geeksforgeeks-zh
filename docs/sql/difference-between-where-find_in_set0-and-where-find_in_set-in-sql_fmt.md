...
> 原文:[https://www . geeksforgeks . org/where-find _ in _ set 0 和 where-find_in_set-in-sql 之间的区别/](https://www.geeksforgeeks.org/difference-between-where-find_in_set0-and-where-find_in_set-in-sql/)
