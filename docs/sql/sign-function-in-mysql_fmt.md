...
MySQL 中的 [`SIGN()`](https://www.geeksforgeeks.org/sql-functions-aggregate-scalar-functions/) 函数用来返回给定数字的符号。如果数字为正数，则返回 `1`；如果数字为负数，则返回 `-1`；如果数字为零，则返回 `0`。
