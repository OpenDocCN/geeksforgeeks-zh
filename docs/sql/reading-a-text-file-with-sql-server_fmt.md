...
> 原文: [https://www.geeksforgeeks.org/reading-a-text-file-with-sql-server/](https://www.geeksforgeeks.org/reading-a-text-file-with-sql-server/)

这里我们将看到，如何用 SQL Server 读取一个文本文件。我们可以使用 `OPENROWSET(BULK)` 函数读取文本文件。
