...
> 原文: [https://www.geeksforgeeks.org/query-to-find-2nd-largest-value-in-a-column-in-table/](https://www.geeksforgeeks.org/query-to-find-2nd-largest-value-in-a-column-in-table/)

## 问题
编写一个 SQL 查询来查找表中某列的第二大值。

## 示例
在第一个示例中，在`Income`列中查找第二大值，在第二个示例中，在`Cost`列中查找第二大值。
