...
> 原文: [https://www.geeksforgeeks.org/mysql-queries-on-date-manipulation/](https://www.geeksforgeeks.org/mysql-queries-on-date-manipulation/)

在 [MySQL](https://www.geeksforgeeks.org/sql-tutorial/) 中，日期是一种数据类型，默认遵循格式 `'YYYY-MM-DD'`，但是通过使用日期格式化功能，我们可以格式化日期，并且可以在表格中获得所需的日期格式，甚至可以使用不同的日期功能来操作日期。
...
使用以下 [SQL](https://www.geeksforgeeks.org/sql-tutorial/) 查询创建一个 3 列的表 `order_details` 如下。
