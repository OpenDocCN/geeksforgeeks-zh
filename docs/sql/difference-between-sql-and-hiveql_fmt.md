...
> 原文: [https://www.geeksforgeeks.org/difference-between-sql-and-hiveql/](https://www.geeksforgeeks.org/difference-between-sql-and-hiveql/)
...
| `SELECT` 命令 | 支持 | 部分排序支持 `SORT BY` 子句，限制返回的行数 |
