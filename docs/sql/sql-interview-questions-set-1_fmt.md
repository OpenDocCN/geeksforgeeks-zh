...
> 原文: [https://www.geeksforgeeks.org/sql-interview-questions-set-1/](https://www.geeksforgeeks.org/sql-interview-questions-set-1/)
...
在表中给出名字、姓氏和姓氏的地方查找员工姓名。缺少一些名字，如名字、姓氏，可能是姓氏。在这里，我们将使用`COALESCE()`函数，该函数将首先返回非空值。
