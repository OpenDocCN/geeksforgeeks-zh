...
> 原文: [https://www.geeksforgeeks.org/how-to-get-latest-updated-records-in-sql/](https://www.geeksforgeeks.org/how-to-get-latest-updated-records-in-sql/)
...
为了得到前一天、前一周、前一个月等数据，我们可以使用 `DATEADD` 函数。
