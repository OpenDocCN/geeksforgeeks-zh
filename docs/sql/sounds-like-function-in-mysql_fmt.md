...
> 原文: [https://www.geeksforgeeks.org/sounds-like-function-in-mysql/](https://www.geeksforgeeks.org/sounds-like-function-in-mysql/)

## Soundex LIKE:
MySQL 中的这个函数用来比较给定的两个字符串表达式的 Soundex 代码。它用作 `SOUNDEX(exp1) = SOUNDEX(exp2)` 来检索听起来相似的字符串。
