...
> 原文: [https://www.geeksforgeeks.org/sql-query-to-update-all-rows-in-a-table/](https://www.geeksforgeeks.org/sql-query-to-update-all-rows-in-a-table/)
...
*   [`Select`](https://www.geeksforgeeks.org/sql-select-query/)

SQL 是一种不区分大小写的语言，即 `SELECT * FROM products` 与 `select * from products` 相同。但是我们习惯用大写字母写关键词和表名，用小写字母写列名。
