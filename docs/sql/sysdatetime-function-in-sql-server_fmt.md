...
> 原文: [https://www.geeksforgeeks.org/sysdatetime-function-in-sql-server/](https://www.geeksforgeeks.org/sysdatetime-function-in-sql-server/)
...
*   此函数用于查找运行 SQL Server 的计算机的日期和时间。
*   此函数属于日期函数。
*   该函数不接受任何参数。
