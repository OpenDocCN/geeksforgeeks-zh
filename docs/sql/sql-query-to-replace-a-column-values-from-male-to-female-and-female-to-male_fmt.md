...
> 原文: [https://www.geeksforgeeks.org/sql-query-to-replace-a-column-values-from-male-to-female-and-female-to-male/](https://www.geeksforgeeks.org/sql-query-to-replace-a-column-values-from-male-to-female-and-female-to-male/)
...
在 SQL 中借助 `EXEC sp_help EMPDATA`，我们可以看到表的结构。像许多列、数据类型、大小、可空性和约束。`EXEC Sp_help` 查询类似于 `DESC` 查询或 description 查询。
...
## 步骤 6: 执行查询，将列值从“男”替换为“女”，将“女”替换为“男”。

最后，在这一步中，我们将实现查询，将列值从“男性”替换为“女性”，将“女性”替换为“男性”。这里我们使用 [`UPDATE`](https://www.geeksforgeeks.org/sql-update-statement/) ，以及 [`CASE`](https://www.geeksforgeeks.org/sql-case-statement/) 语句。
