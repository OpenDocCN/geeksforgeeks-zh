...
> 原文：[https://www.geeksforgeeks.org/implicit-join-vs-explicit-join-in-sql/](https://www.geeksforgeeks.org/implicit-join-vs-explicit-join-in-sql/)
...
使用下面的 SQL 语句查看 `student` 表的内容：
```sql
SELECT * FROM student;
```
![](img/1070b5f606cec28d3a4e69c2279bee3c.png)

使用下面的 SQL 语句查看 `course` 表的内容：
```sql
SELECT * FROM course;
```
