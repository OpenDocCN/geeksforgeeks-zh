...
> 原文：[https://www.geeksforgeeks.org/sql-query-to-get-first-and-last-day-of-a-month-in-a-database/](https://www.geeksforgeeks.org/sql-query-to-get-first-and-last-day-of-a-month-in-a-database/)
...
## 步骤 3：在日历数据库中创建表格
在日历数据库中创建表格，表格名称为 `dates`，列为 `daydate`，如下所示。
```sql
