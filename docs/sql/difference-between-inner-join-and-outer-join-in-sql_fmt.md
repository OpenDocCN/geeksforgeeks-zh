...
> 原文：[https://www.geeksforgeeks.org/difference-between-inner-join-and-outer-join-in-sql/](https://www.geeksforgeeks.org/difference-between-inner-join-and-outer-join-in-sql/)
...
| 7. | SQL 语法：<br>`select * from table1 INNER JOIN / JOIN table2 ON table1.column_name = table2.column_name;` | SQL 语法：<br>`select * from table1 LEFT OUTER JOIN / RIGHT OUTER JOIN / FULL OUTER JOIN / FULL JOIN table2 ON table1.column_name = table2.column_name;` |