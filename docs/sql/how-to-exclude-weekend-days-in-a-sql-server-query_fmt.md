...
> 原文：[https://www.geeksforgeeks.org/how-to-exclude-weekend-days-in-a-sql-server-query/](https://www.geeksforgeeks.org/how-to-exclude-weekend-days-in-a-sql-server-query/)
...
## 步骤 5：编写 SQL 查询以获取所有工作日

现在我们将编写 SQL 查询，它将获得除非工作日之外的所有工作日。
