# MS Access中的`Atn()`和`Cos()`函数

> 原文：[https://www.geeksforgeeks.org/atn-and-cos-function-in-ms-access/](https://www.geeksforgeeks.org/atn-and-cos-function-in-ms-access/)
