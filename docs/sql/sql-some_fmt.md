...
*   `SOME` 必须与子查询中的至少一行匹配，并且必须在前面有比较运算符。
...
## 说明
有 `Salary > some(‘计算机科学’系讲师Salary)` 的讲师获得返还。“计算机科学”系的 `Salary` 是 1.3，2，2。这意味着任何 `Salary` 高于 1.3 的讲师都可以包括在最终结果中。

## 练习:
尝试使用 [ANY](https://www.geeksforgeeks.org/sql-all-and-any/) 子句编写相同的查询。
