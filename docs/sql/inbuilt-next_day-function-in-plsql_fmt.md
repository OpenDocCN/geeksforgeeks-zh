...
> 原文: [https://www.geeksforgeeks.org/inbuilt-next_day-function-in-plsql/](https://www.geeksforgeeks.org/inbuilt-next_day-function-in-plsql/)
...
| Wednesday | The first Wednesday is later than a date. |
| Thursday | The first Thursday is later than a date. |
| Friday | The first Friday is later than a date |
