...
> 原文: [https://www.geeksforgeeks.org/php-inserting-into-mysql-database/](https://www.geeksforgeeks.org/php-inserting-into-mysql-database/)
...
这里，`column1`、`column2`、`column3`、…`columnN` 是表中要插入数据的列的名称。
