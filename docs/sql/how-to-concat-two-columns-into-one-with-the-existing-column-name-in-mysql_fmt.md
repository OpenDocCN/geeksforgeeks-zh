...
> 原文：[https://www.geeksforgeeks.org/how-to-concat-two-columns-into-one-with-the-existing-column-name-in-mysql/](https://www.geeksforgeeks.org/how-to-concat-two-columns-into-one-with-the-existing-column-name-in-mysql/)
...
为了演示，我们将使用 `FIRSTNAME` 和 `LASTNAME` 列的串联值替换 `FIRSTNAME`。
