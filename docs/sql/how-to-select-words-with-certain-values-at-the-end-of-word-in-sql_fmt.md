...
> 原文：[https://www.geeksforgeeks.org/how-to-select-words-with-certain-values-at-the-end-of-word-in-sql/](https://www.geeksforgeeks.org/how-to-select-words-with-certain-values-at-the-end-of-word-in-sql/)
...
| **Pattern** | **Description** |
| :--- | :--- |
| `a%` | A value that begins with `a`. |
| `%a` | A value that ends with `a`. |
| `_a` | A value that has any one character followed by `a`. |
| `%_a%` | A value containing any one character. |
