# 替换 MS 访问中的 `Replace()` 和 `Space()` 功能

> 原文: [https://www.geeksforgeeks.org/replace-and-space-function-in-ms-access/](https://www.geeksforgeeks.org/replace-and-space-function-in-ms-access/)
