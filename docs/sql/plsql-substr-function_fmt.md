...
### 示例-3
在将参数传递给 `SUBSTR` 函数时，在 `start_position` 参数中传递负值。
...
### 示例-4
在 `start_position` 参数中传递一个大于 `input_string` 中字符数的值。
