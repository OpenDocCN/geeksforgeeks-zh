...
> 原文: [https://www.geeksforgeeks.org/how-to-export-sql-server-data-to-a-csv-file/](https://www.geeksforgeeks.org/how-to-export-sql-server-data-to-a-csv-file/)
...
从菜单栏中的查看选项打开对象资源管理器。它出现在屏幕的左侧。

![](img/64d175b32322af34554e5ed477968a9b.png)

我们可以在数据库文件夹中看到 `geeks` 数据库。

## 步骤 7: 启动导出向导

右键点击 `geeks` 数据库，点击**任务 -> 导出数据**。

![](img/27cee00a065d3d19afec9b8d5ec23326.png)

## 步骤 8: 配置向导（服务器信息）

导入导出向导打开，填写服务器名称、数据库等详细信息。然后点击下一步。

![](img/db897e3612aed76e77957d2ed7822bde.png)

## 步骤 9: 选择目标

选择‘平面文件目的地’作为目的地，选择文件路径。可以选择任何文本文件作为目标文件。我们选择了 `hello.txt` 作为目标文件来保存 SQL Server 数据。然后单击下一步。

![](img/cf914647b4315203522643e9e07f91d0.png)

## 步骤 10: 选择表和分隔符

选择表名，选择逗号作为分隔符。然后单击下一步继续。

![](img/7268aba3bc4de09e8c4e27280c870454.png)

## 步骤 11: 保存并运行包

在保存和运行包窗口中不需要更改。单击下一步。

![](img/c78b8bed0309b50a5a2907c7324ff9d1.png)

## 步骤 12: 完成向导

在“完成”向导窗口中，检查导出过程中设置的所有设置。单击“完成”开始将 `SQL` 数据库导出到 `CSV`。
