...
> 原文: [https://www.geeksforgeeks.org/ucase-or-upper-function-in-mysql/](https://www.geeksforgeeks.org/ucase-or-upper-function-in-mysql/)

## `UCASE()`

这个函数可以用来将字符串转换成大写。该功能类似于 `UPPER()` 功能。`UPPER()` 和 `UCASE()` 都是内置的 MySQL 函数。
