...
> 原文: [https://www.geeksforgeeks.org/weekday-and-weekdayname-function-in-ms-access/](https://www.geeksforgeeks.org/weekday-and-weekdayname-function-in-ms-access/)
...
| --- | --- |
| `date` | 这是必需的。有效日期。 |
| `firstdayofweek` | 可选，它将指定一周的第一天<br>`0 :` 对于 NLS API 设置<br>`1 :` 周日(默认)<br>`2 :` 周一<br>`3 :` 周二<br>`4 :` 周三<br>`5 :` 周四<br>`6 :` 周五<br>`7 :` 周六 |
...
| 参数 | 描述 |
| --- | --- |
| `number` | 这是必需的。它将在 1 到 7 的范围内 |
| `abbreviate` | 可选。如果缩写为 `true`，则为 `false` |
| `firstdayofweek` | 可选，它将指定一周的第一天<br>`0 :` 对于 NLS API 设置<br>`1 :` 周日(默认)<br>`2 :` 周一<br>`3 :` 周二<br>`4 :` 周三<br>`5 :` 周四<br>`6 :` 周五<br>`7 :` 周六 |
