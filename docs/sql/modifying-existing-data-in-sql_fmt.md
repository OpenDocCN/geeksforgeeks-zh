...
> 原文: [https://www.geeksforgeeks.org/modifying-existing-data-in-sql/](https://www.geeksforgeeks.org/modifying-existing-data-in-sql/)
...
| name | kind | contact | city | marks _ 获得了 |
| --- | --- | --- | --- | --- |
| Asu | Santosh | | | |
