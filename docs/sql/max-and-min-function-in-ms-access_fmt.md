# MS Access 中的 Max() 和 Min() 函数

> 原文: [https://www.geeksforgeeks.org/max-and-min-function-in-ms-access/](https://www.geeksforgeeks.org/max-and-min-function-in-ms-access/)

## 1. Max() 函数

`Max()` 函数返回给定集合的最大值。在函数中传递一个查询，它将在符合条件的记录中，返回表达式计算结果的最大值。
