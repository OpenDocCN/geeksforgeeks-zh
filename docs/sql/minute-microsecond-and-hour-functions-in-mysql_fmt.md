...
> 原文: [https://www.geeksforgeeks.org/minute-microsecond-and-hour-functions-in-mysql/](https://www.geeksforgeeks.org/minute-microsecond-and-hour-functions-in-mysql/)
...
## 2. MICROSECOND()
MySQL 函数 `MICROSECOND()` 用于返回日期时间值的微秒部分。它可以在 0 到 999999 之间。当日期时间在 `MICROSECOND()` 函数中传递时，它将返回微秒值。
