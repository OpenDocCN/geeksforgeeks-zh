...
> 原文：[https://www.geeksforgeeks.org/sql-full-outer-join-using-where-clause/](https://www.geeksforgeeks.org/sql-full-outer-join-using-where-clause/)
...
| 产品_id | 手机品牌 | 成本 | 客户名称 | Customer_id | Customer_name | e-mail address |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| one | 加北 5G | Thirty thousand | 里沙卜 | one | Sriti | abc@gmail.com |
| Two | 三星 Galaxy M51 | Twenty-eight thousand | Srishti | Two | Lajieshen |  |
| three | iPhone 12 Pro | 1,28,000 | 等于 Haman） |  |  |  |
| four | 三星 Galaxy S20 | Fifty-five thousand | 严厉的 |  |  |  |
| five | Realme X50 Pro | Forty thousand | 万里 |  |  |  |
|  |  |  |  | T143 | pooja | T1135 |
...
使用带有完全外部连接的 `WHERE` 子句有助于检索在连接两个具有空条目的表时没有条目匹配的所有行。
...
我们已经考虑了一个来自**电子商务网站的手机客户和购买信息在大亿日**。数据库电子商务有两个表，一个包含产品信息，另一个包含客户信息。现在，我们将在这两个表之间执行 `FULL OUTER JOIN`，将它们连接成一个表，并获得关于客户和他们从网站上购买的产品的完整数据。
...
有关 SQL 语法的更多信息，请访问我们的网站 [SQL 教程](https://www.geeksforgeeks.org/sql-tutorial/)。
