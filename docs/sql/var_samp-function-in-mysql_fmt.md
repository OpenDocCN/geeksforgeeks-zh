...
在本例中，我们将找到在公司“PQR 索恩”工作的员工收入的样本方差。为了演示，创建一个名为 `EmployeeDetails` 的表。
...
```sql
INSERT INTO EmployeeDetails(Employee_Name, Working_At, Work_Location, Joining_Date, Annual_Income)
VALUES
