...
> 原文: [https://www.geeksforgeeks.org/python-tensorflow-math-zero_fraction/](https://www.geeksforgeeks.org/python-tensorflow-math-zero_fraction/)
...
`tensorflow.math.zero_fraction(values, name)`
