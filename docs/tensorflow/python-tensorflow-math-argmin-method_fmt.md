...
> 原文：[https://www.geeksforgeeks.org/python-tensorflow-math-argmin-method/](https://www.geeksforgeeks.org/python-tensorflow-math-argmin-method/)

[TensorFlow](https://www.geeksforgeeks.org/introduction-to-tensorflow/) 是谷歌为开发机器学习模型和深度学习神经网络而设计的开源 Python 库。`argmin()` 是 `tensorflow.math` 模块中的一种方法。此方法用于找到轴上的最小值。
