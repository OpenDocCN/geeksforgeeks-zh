# Python - TensorFlow `tf.math.reciprocal()`

> 原文: [https://www.geeksforgeeks.org/python-tensorflow-math-reciprocal/](https://www.geeksforgeeks.org/python-tensorflow-math-reciprocal/)

[TensorFlow](https://www.geeksforgeeks.org/introduction-to-tensorflow/) 是谷歌为开发机器学习模型和深度学习神经网络而设计的开源 Python 库。`reciprocal()` 用来求 `x` 的元素方向倒数。

> **语法:** `tf.math.reciprocal(x, name)`
>
> **参数:**
>
