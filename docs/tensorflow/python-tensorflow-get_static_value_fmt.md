...
> 原文: [https://www.geeksforgeeks.org/python-tensorflow-get_static_value/](https://www.geeksforgeeks.org/python-tensorflow-get_static_value/)
...
`tensorflow.get_static_value(张量，部分)`
