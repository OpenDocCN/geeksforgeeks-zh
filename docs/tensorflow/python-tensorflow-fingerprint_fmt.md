# TensorFlow `tf.fingerprint()`

> 原文: [https://www.geeksforgeeks.org/python-tensorflow-fingerprint/](https://www.geeksforgeeks.org/python-tensorflow-fingerprint/)

TensorFlow 是谷歌设计的开源 Python 库，用于开发机器学习模型和深度学习神经网络。

`tf.fingerprint()` 用于生成指纹值。
