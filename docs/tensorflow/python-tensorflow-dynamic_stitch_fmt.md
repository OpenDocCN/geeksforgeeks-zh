...
> 原文: [https://www.geeksforgeeks.org/python-tensorflow-dynamic_stitch/](https://www.geeksforgeeks.org/python-tensorflow-dynamic_stitch/)
...
`tensorflow.dynamic_stitch(索引, 数据, 名称)`
