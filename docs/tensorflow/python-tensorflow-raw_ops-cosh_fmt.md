# TensorFlow `raw_ops.Cosh()` 函数详解

> 原文链接: [https://www.geeksforgeeks.org/python-tensorflow-raw_ops-cosh/](https://www.geeksforgeeks.org/python-tensorflow-raw_ops-cosh/)
...
![Cosh函数可视化输出](img/e4571d74d1c886fb023134351a63dd6e.png)