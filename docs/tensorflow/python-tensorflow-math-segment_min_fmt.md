...
> 原文: [https://www.geeksforgeeks.org/python-tensorflow-math-segment_min/](https://www.geeksforgeeks.org/python-tensorflow-math-segment_min/)
...
`tensorflow.math.segment_min(data, segment_ids, name)`
