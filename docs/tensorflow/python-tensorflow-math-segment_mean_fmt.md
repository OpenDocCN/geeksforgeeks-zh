...
> 原文: [https://www.geeksforgeeks.org/python-tensorflow-math-segment_mean/](https://www.geeksforgeeks.org/python-tensorflow-math-segment_mean/)
...
`tensorflow.math.segment_mean(data, segment_ids, name)`
