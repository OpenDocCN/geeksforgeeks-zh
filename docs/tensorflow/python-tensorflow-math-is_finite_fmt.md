...
> 原文: [https://www.geeksforgeeks.org/python-tensorflow-math-is_finite/](https://www.geeksforgeeks.org/python-tensorflow-math-is_finite/)

TensorFlow 是谷歌设计的开源 Python 库，用于开发机器学习模型和深度学习神经网络。

`tf.math.is_finite()` 用于检查 `x` 的元素有限性。

## 语法

`tensorflow.math.is_finite(x, name)`
