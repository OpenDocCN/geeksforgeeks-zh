...
> 原文：[https://www.geeksforgeeks.org/python-tensorflow-math-asinh/](https://www.geeksforgeeks.org/python-tensorflow-math-asinh/)

[TensorFlow](https://www.geeksforgeeks.org/introduction-to-tensorflow/) 是谷歌为开发机器学习模型和深度学习神经网络而设计的开源 Python 库。
`asinh()` 用于寻找输入 `x` 的元素级双曲反正弦值。
...
*   `x`: 输入张量。此张量允许的数据类型是 `bfloat16`，`half`，`float32`，`float64`。
*   `name` (可选): 定义操作的名称。
