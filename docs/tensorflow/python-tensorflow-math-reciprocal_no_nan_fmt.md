...
> 原文: [https://www.geeksforgeeks.org/python-tensorflow-math-reciprocal_no_nan/](https://www.geeksforgeeks.org/python-tensorflow-math-reciprocal_no_nan/)

[TensorFlow](https://www.geeksforgeeks.org/introduction-to-tensorflow/) 是谷歌为开发机器学习模型和深度学习神经网络而设计的开源 Python 库。`reciprocal_no_nan()` 用于求 `x` 的元素安全倒数，即如果 `x` 为 0，则其倒数也为 0。
