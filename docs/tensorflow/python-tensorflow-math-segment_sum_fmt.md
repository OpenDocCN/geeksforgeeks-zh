...
> 原文: [https://www.geeksforgeeks.org/python-tensorflow-math-segment_sum/](https://www.geeksforgeeks.org/python-tensorflow-math-segment_sum/)

TensorFlow 是谷歌设计的开源 Python 库，用于开发机器学习模型和深度学习神经网络。

`segment_sum()` 用来求一个张量的段中元素的和。

> **语法:** `tensorflow.math.segment_sum(data, segment_ids, name)`
>
> **参数:**
>
