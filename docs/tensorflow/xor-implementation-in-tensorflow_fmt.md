...
> 原文: [https://www.geeksforgeeks.org/xor-implementation-in-tensorflow/](https://www.geeksforgeeks.org/xor-implementation-in-tensorflow/)
...
**步骤 1:** 导入所有需要的库。这里我们用的是 `TensorFlow` 和 `numpy`。
...
**步骤 9:** 现在所有需要的东西都已经初始化，我们将启动 `Tensorflow Session`，并通过初始化上面声明的所有变量来开始训练。
