# TensorFlow `tf.raw_ops.Sin()`

> 原文链接: [https://www.geeksforgeeks.org/python-tensorflow-raw_ops-sin/](https://www.geeksforgeeks.org/python-tensorflow-raw_ops-sin/)
