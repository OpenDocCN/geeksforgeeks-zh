...
> 原文: [https://www.geeksforgeeks.org/tensorflow-math-special-spence-function-in-python/](https://www.geeksforgeeks.org/tensorflow-math-special-spence-function-in-python/)

[`TensorFlow`](https://www.geeksforgeeks.org/introduction-to-tensorflow/) 是谷歌为开发机器学习模型和深度学习神经网络而设计的开源 python 库。

## `spence()` 方法

`spence()` 用于计算 `x` 的元素式 spence 积分，定义为 `log(t)/(1–t)` 从 `1` 到 `x` 的积分，定义域为所有正实数。
