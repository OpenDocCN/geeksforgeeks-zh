# TensorFlow `segment_max()` 函数详解

> 原文: [https://www.geeksforgeeks.org/python-tensorflow-math-segment_max/](https://www.geeksforgeeks.org/python-tensorflow-math-segment_max/)
...
```py
tensorflow.math.segment_max(data, segment_ids, name=None)
```
