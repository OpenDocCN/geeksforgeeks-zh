...
> 原文: [https://www.geeksforgeeks.org/python-tensorflow-math-igammac/](https://www.geeksforgeeks.org/python-tensorflow-math-igammac/)
...
其中 `γ(a, x)` 是下不完全 `γ` 函数，定义为:

![](img/c41a7a75baadda57db668825a794edfe.png)

**语法:**
`tensorflow.math.igammac(x, y, name)`
