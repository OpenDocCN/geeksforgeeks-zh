...
> 原文: [https://www.geeksforgeeks.org/tensorflow-how-to-create-a-numpy-ndarray-from-a-tensor/](https://www.geeksforgeeks.org/tensorflow-how-to-create-a-numpy-ndarray-from-a-tensor/)
...
本示例使用形状为 `(2, 2)` 的张量，因此生成的数组的形状将为 `(2, 2)`。
