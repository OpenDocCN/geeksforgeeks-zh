...
> 原文: [https://www.geeksforgeeks.org/python-tensorflow-math-sigmoid/](https://www.geeksforgeeks.org/python-tensorflow-math-sigmoid/)
...
> `tensorflow.math.sigmoid(x, name)`
>
> **参数:**
