...
> 原文: [https://www.geeksforgeeks.org/tensorflow-math-special-fresnel_sin-function-in-python/](https://www.geeksforgeeks.org/tensorflow-math-special-fresnel_sin-function-in-python/)
...
> 语法: `tensorflow.math.special.fresnel_sin(x, name)`
>
> 参数:
>
...
> Result: tf.Tensor([0.43825915 0.34341568 0.496313   0.42051575 0.49919138], shape=(5,), dtype=float64)