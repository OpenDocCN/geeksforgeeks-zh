...
> 原文: [https://www.geeksforgeeks.org/python-tensorflow-math-reduce_variance/](https://www.geeksforgeeks.org/python-tensorflow-math-reduce_variance/)

TensorFlow 是谷歌设计的开源 Python 库，用于开发机器学习模型和深度学习神经网络。

`reduce_variance()` 用于寻找元素在张量维度上的方差。

> **语法:** `tensorflow.math.reduce_variance(input_tensor, axis, keepdims, name)`
>
> **参数:**
>
