...
> 原文: [https://www.geeksforgeeks.org/python-tensorflow-math-segment_prod/](https://www.geeksforgeeks.org/python-tensorflow-math-segment_prod/)
...
`tensorflow.math.segment_prod(data, segment_ids, name)`
