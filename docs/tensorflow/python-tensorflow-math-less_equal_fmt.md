...
> 原文: [https://www.geeksforgeeks.org/python-tensorflow-math-less_equal/](https://www.geeksforgeeks.org/python-tensorflow-math-less_equal/)
...
```python
tensorflow.math.less_equal(x, y, name)
```
