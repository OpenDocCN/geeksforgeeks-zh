...
> 原文: [https://www.geeksforgeeks.org/python-tensorflow-clip_by_norm/](https://www.geeksforgeeks.org/python-tensorflow-clip_by_norm/)

[`TensorFlow`](https://www.geeksforgeeks.org/introduction-to-tensorflow/) 是谷歌为开发机器学习模型和深度学习神经网络而设计的开源 Python 库。

`clip_by_norm()` 用于将张量值裁剪到最大 L2 范数。

> **语法:** `tensorflow.clip_by_norm(t, clip_norm, axis, name)`
>
> **参数:**
>
> *   `t`: 需要裁剪的是输入张量。
> *   `clip_norm`: 定义最大裁剪值的是 0-D 标量张量。
> *   `axis` (可选): 一维向量张量定义了用于计算 L2 范数的维度。如果没有提供，将使用所有尺寸。
> *   `name` (可选): 定义操作的名称。
>
> **返回:**
>
