...
> 原文: [https://www.geeksforgeeks.org/tensorflow-tf-data-dataset-reduce/](https://www.geeksforgeeks.org/tensorflow-tf-data-dataset-reduce/)

借助`tf.data.Dataset.reduce()`方法，可以得到数据集中所有元素的约简变换。
