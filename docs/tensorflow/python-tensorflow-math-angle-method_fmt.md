...
> 原文: [https://www.geeksforgeeks.org/python-tensorflow-math-angle-method/](https://www.geeksforgeeks.org/python-tensorflow-math-angle-method/)

[TensorFlow](https://www.geeksforgeeks.org/introduction-to-tensorflow/) 是谷歌为开发机器学习模型和深度学习神经网络而设计的开源 Python 库。

`angle()` 是 TensorFlow 数学模块中的方法。这种方法被用来寻找张量的元素态参数。默认情况下，所有元素都被视为复数(a+bi)。对于实数，复数部分(b)被认为是零。`atan2(b, a)` 是由这个函数计算的参数。
