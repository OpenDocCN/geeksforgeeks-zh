# TensorFlow `tf.raw_ops.Atan()`

> 哎哎哎: [https://www.geeksforgeeks.org/python-tensorflow-raw_ops-atan/](https://www.geeksforgeeks.org/python-tensorflow-raw_ops-atan/)
