...
> 原文: [https://www.geeksforgeeks.org/template-method-design-pattern/](https://www.geeksforgeeks.org/template-method-design-pattern/)
...
*   **具体类**实现了在父类中被定义为抽象的`templateMethod`所需的所有操作。可以有许多不同的具体类。
