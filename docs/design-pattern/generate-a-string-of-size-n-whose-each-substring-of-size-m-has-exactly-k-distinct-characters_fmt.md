...
> 原文: [https://www.geeksforgeeks.org/generate-a-string-of-size-n-whose-each-substring-of-size-m-has-exactly-k-distinct-characters/](https://www.geeksforgeeks.org/generate-a-string-of-size-n-whose-each-substring-of-size-m-has-exactly-k-distinct-characters/)
...
> **输出:** `abcaaab`
> **解释:**
> 大小为 5 的每个子串“abcaa”、“bcaaa”、“caaab”都有 3 个不同的字母。

## 方法
在一个大小为 `N` 的字符串中，每个大小为 `M` 的子串必须包含正好 `K` 个不同的字母。
