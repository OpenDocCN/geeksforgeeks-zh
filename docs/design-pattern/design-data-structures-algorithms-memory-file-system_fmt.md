...
或者，我们可以实现目录，使其包含单独的文件和子目录列表。这使得`numberOfFiles()`方法稍微干净一点，因为它不需要使用`instanceof`运算符，但是它确实禁止我们按照日期或名称对文件和目录进行干净的排序。
...
- [https://stackoverflow.com/questions/14126575/data-structures-used-to-build-file-systems](https://stackoverflow.com/questions/14126575/data-structures-used-to-build-file-systems)
