...
> 原文：[https://www.geeksforgeeks.org/singleton-design-pattern-introduction/](https://www.geeksforgeeks.org/singleton-design-pattern-introduction/)
...
*   **早期初始化：** 在这个方法中，不管是否使用，类都会被初始化。这种方法的主要优点是简单。您可以在加载类时启动类。它的缺点是无论是否使用，类总是被初始化。
