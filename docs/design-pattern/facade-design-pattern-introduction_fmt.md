...
> 原文：[https://www.geeksforgeeks.org/facade-design-pattern-introduction/](https://www.geeksforgeeks.org/facade-design-pattern-introduction/)
...
你作为客户，想要访问不同餐厅的不同菜单。你不知道他们有什么不同的菜单。你只需要去找一个熟悉酒店的酒店老板。无论你想要哪份菜单，你都要告诉酒店老板，他会从各自的餐厅里拿出来，递给你。在这里，酒店管理员充当了**门面**，因为他隐藏了系统酒店的复杂性。
...
同样，餐厅有三种类型，可以实现酒店接口。让我们看看其中一家餐馆的代码。
...
**进一步解读：** [Python 中的门面方法](https://www.geeksforgeeks.org/facade-method-python-design-patterns/)
