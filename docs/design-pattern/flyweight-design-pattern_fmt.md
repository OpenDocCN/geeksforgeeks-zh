...
我们在[反击](https://en.wikipedia.org/wiki/Counter-Strike)的游戏中实现恐怖分子和反恐怖分子的创建。所以我们有两个班一个是 **T** 恐怖分子( **T** )另一个是**C**counter**T**恐怖分子( **CT** )。每当一个玩家要一件武器时，我们就把他要的武器分配给他。在任务中，恐怖分子的任务是放置炸弹，而反恐怖分子必须扩散炸弹。
