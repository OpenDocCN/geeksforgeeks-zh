# Python Bokeh–在图形上绘制钻石

> 原文: [https://www.geeksforgeeks.org/python-bokeh-plotting-diamonds-on-a-graph/](https://www.geeksforgeeks.org/python-bokeh-plotting-diamonds-on-a-graph/)
...
> *   `y` : 菱形标记中心的 y 坐标
> *   `size` : 菱形标记的直径，默认为 4
> *   `angle` : 菱形标记的旋转角度，默认为 0
> *   `angle_unit` : 角度的单位，默认为弧度
> *   `fill_alpha` : 钻石标记的填充α值
> *   `fill_color` : 钻石标记的填充颜色值
