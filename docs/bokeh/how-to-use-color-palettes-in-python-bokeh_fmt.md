...
> 原文: [https://www.geeksforgeeks.org/how-to-use-color-palettes-in-python-bokeh/](https://www.geeksforgeeks.org/how-to-use-color-palettes-in-python-bokeh/)
...
1.  [Matplotlib 选项板](#matplotlib-选项板)
2.  [D3 调色板](#d3-选项板)
3.  [啤酒调色板](#啤酒调色板)
4.  [可用性调色板](#可用性调色板)
5.  [大型托盘](#大型托盘)
...
示例：我们将使用 `vbar()` 功能绘制多个竖线来演示大型调色板。
