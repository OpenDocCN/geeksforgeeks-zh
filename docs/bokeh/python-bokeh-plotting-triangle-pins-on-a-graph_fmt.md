...
> 原文: [https://www.geeksforgeeks.org/python-bokeh-plotting-triangle-pins-on-a-graph/](https://www.geeksforgeeks.org/python-bokeh-plotting-triangle-pins-on-a-graph/)

Bokeh 是一个 Python 交互式数据可视化工具。它使用 HTML 和 JavaScript 来渲染它的图。它以现代网络浏览器为呈现目标，提供优雅、简洁的新颖图形结构和高性能交互性。

Bokeh 可用于在图形上绘制三角形引脚。可以使用 `plotting` 模块的 `triangle_pin()` 方法在图形上绘制三角形引脚。

## `plotting.figure.triangle_pin()`
