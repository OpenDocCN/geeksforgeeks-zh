...
> 原文: [https://www.geeksforgeeks.org/python-bokeh-making-a-pie-chart/](https://www.geeksforgeeks.org/python-bokeh-making-a-pie-chart/)
...
在示例 2 中，我们将可视化一些数据。在数据中，我们提供了 2017-2018 年 GVA 在印度的行业份额。这些股份是:
