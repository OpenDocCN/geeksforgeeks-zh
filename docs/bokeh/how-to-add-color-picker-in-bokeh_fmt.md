...
> 原文：[https://www.geeksforgeeks.org/how-to-add-color-picker-in-bokeh/](https://www.geeksforgeeks.org/how-to-add-color-picker-in-bokeh/)
...
我们用颜色选择器绘制一个折线图。这里我们已经明确指定了折线图颜色 `"black"`。线条的颜色默认为折线图的 `"blue"`。我们可以从颜色选择器中选择任何颜色，并更改折线图颜色。这里我选择了 `"green"`。
