...
> 原文：[https://www.geeksforgeeks.org/add-interactive-slider-to-bokeh-plots/](https://www.geeksforgeeks.org/add-interactive-slider-to-bokeh-plots/)
...
> **语法：**
>
> `Slider(start=0, end=10, value=1, step=.1, title="填充")`
>
> **参数：**
>
> *   `start`：代表滑块开始值。
