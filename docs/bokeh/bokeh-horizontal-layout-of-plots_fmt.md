...
> 原文：[https://www.geeksforgeeks.org/bokeh-horizontal-layout-of-plots/](https://www.geeksforgeeks.org/bokeh-horizontal-layout-of-plots/)
...
在 Bokeh 行布局中，所有的图将只显示在一行中。这可以使用 Bokeh 支持的行布局功能来完成：
