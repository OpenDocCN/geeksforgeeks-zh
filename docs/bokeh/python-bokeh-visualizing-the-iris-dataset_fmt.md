...
> 原文: [https://www.geeksforgeeks.org/python-bokeh-visualizing-the-iris-dataset/](https://www.geeksforgeeks.org/python-bokeh-visualizing-the-iris-dataset/)
...
1.  导入所需的模块:
    ...
    *   `flowers`来自`bokeh.sampledata.iris`
2.  用标题实例化一个图形对象。
3.  给 x 轴和 y 轴命名。
4.  绘制所有 3 个物种的图表。
5.  显示模型。
