...
> 原文: [https://www.geeksforgeeks.org/python-bokeh-plotting-hexagon-bins-on-a-graph/](https://www.geeksforgeeks.org/python-bokeh-plotting-hexagon-bins-on-a-graph/)
...
> *   `size`: 六边形瓷砖箱的半径，默认为 1
> *   `palette`: 方向值，默认为 Viridis256
> *   `orientation`: 调色板颜色映射面元，默认为点
