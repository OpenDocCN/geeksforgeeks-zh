...
> 原文：[https://www.geeksforgeeks.org/adding-borders-to-the-images-using-python-opencv/](https://www.geeksforgeeks.org/adding-borders-to-the-images-using-python-opencv/)
...
*   这是一个开源图书馆。
*   旨在解决计算机视觉问题。
*   它利用高度优化的数值操作库，即 `NumPy` 以及 `MATLAB` 风格语法。

## 要给图像添加边框

`OpenCV` 有一个包 `copyMakeBorder` 可以帮助在图像周围制作边框。

> **语法：** `cv2.copyMakeBorder()`
>
> **`copyMakeBorder` 参数：**
>
> *   输入影像
