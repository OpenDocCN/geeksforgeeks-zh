...
> 原文: [https://www.geeksforgeeks.org/displaying-the-coordinates-of-the-points-clicked-on-the-image-using-python-opencv/](https://www.geeksforgeeks.org/displaying-the-coordinates-of-the-points-clicked-on-the-image-using-python-opencv/)
...
5.  在用户定义的函数中，使用 `cv2.EVENT_LBUTTONDOWN` 属性检查鼠标左键点击。
6.  在外壳上显示坐标。
7.  在创建的窗口上显示坐标。
8.  使用 `cv2.EVENT_RBUTTONDOWN` 属性对鼠标右键单击进行同样的操作。在图像上显示坐标时更改颜色，以区别于左键单击。
