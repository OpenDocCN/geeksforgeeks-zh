...
> 原文: [https://www.geeksforgeeks.org/find-circles-and-ellipses-in-an-image-using-opencv-python/](https://www.geeksforgeeks.org/find-circles-and-ellipses-in-an-image-using-opencv-python/)
...
*   **按惯性过滤–** 与圆相似的对象具有更大的惯性，例如，对于圆，该值为 1，对于椭圆，该值介于 0 和 1 之间，对于直线，该值为 0。要按惯性比过滤，请将 `filterByInertia` 设置为 1，并适当设置为 `minInertiaRatio` (0 <= minRatio <= 1) 和 `maxInertiaRatio` (<=1)。
