...
> 原文: [https://www.geeksforgeeks.org/how-to-install-opencv-for-python-in-windows/](https://www.geeksforgeeks.org/how-to-install-opencv-for-python-in-windows/)
...
如果 `PIP` 不存在，通过[如何在 Windows 上安装 PIP？](https://www.geeksforgeeks.org/how-to-install-pip-on-windows/)并按照提供的说明操作。
