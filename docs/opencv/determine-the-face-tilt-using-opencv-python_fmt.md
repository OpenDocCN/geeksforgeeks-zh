...
> 原文: [https://www.geeksforgeeks.org/determine-the-face-tilt-using-opencv-python/](https://www.geeksforgeeks.org/determine-the-face-tilt-using-opencv-python/)
...
*   人脸检测分类器: [`haarcascade_frontalface_default.xml`](https://drive.google.com/file/d/15tK4N1O0-H7hsykNOg0g3zCzasERhjAa/view?usp=sharing)
*   眼睛检测分类器: [`haarcascade_eye.xml`](https://drive.google.com/file/d/1LomiNJxNeNJ6W5KIH8GaeuhlJwvnqtTw/view?usp=sharing)
...
*   当给定两个点 `(x_{1}, y_{1})` 和 `(x_{2}, y_{2})` 时，连接两个点的直线与 `x` 轴的角度 `\theta` 可以通过以下表达式从几何中获得: `\theta = \arctan(\frac{x_2 - x_1}{y_2 - y_1})`
