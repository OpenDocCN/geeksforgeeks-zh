...
> 原文: [https://www.geeksforgeeks.org/draw-multiple-rectangles-in-image-using-python-opencv/](https://www.geeksforgeeks.org/draw-multiple-rectangles-in-image-using-python-opencv/)
...
*   `rectangle()`: 在 OpenCV 中，使用`cv2.rectangle`函数在 Python 中的图像上绘制矩形。
    > 语法: `cv2.rectangle(image, start_coordinate, end_coordinate, color, thickness)`
