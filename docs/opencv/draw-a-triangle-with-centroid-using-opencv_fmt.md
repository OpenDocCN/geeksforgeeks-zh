...
> 原文: [https://www.geeksforgeeks.org/draw-a-triangle-with-centroid-using-opencv/](https://www.geeksforgeeks.org/draw-a-triangle-with-centroid-using-opencv/)

## 先决条件
[使用 OpenCV 的几何形状](https://www.geeksforgeeks.org/draw-geometric-shapes-images-using-opencv/)
