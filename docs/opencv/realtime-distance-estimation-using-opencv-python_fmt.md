...
> 原文：[https://www.geeksforgeeks.org/realtime-distance-estimation-using-opencv-python/](https://www.geeksforgeeks.org/realtime-distance-estimation-using-opencv-python/)
...
1.  `Measured_distance`： It is the distance between the camera and the object when shooting the reference image, `Known_distance = 72.2 # cm`
2.  `real_width`： It measures the width of objects in the real world, and here we measure the width of faces around, which is known as `_width = 14.3 # cm`
3.  `width_in_rf_image`
