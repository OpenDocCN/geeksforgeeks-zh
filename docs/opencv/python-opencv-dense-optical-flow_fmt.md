...
> 原文: [https://www.geeksforgeeks.org/python-opencv-dense-optical-flow/](https://www.geeksforgeeks.org/python-opencv-dense-optical-flow/)
...
定义的方法为 `calcOpticalFlowFarneback()`。
