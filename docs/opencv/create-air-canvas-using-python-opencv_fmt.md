...
> 原文: [https://www.geeksforgeeks.org/create-air-canvas-using-python-opencv/](https://www.geeksforgeeks.org/create-air-canvas-using-python-opencv/)
...
*   [Python 3](https://www.geeksforgeeks.org/python-programming-language/)
*   `numpy`
*   [OpenCV](https://www.geeksforgeeks.org/opencv-python-tutorial/)

## 算法

1.  开始读取帧并将捕获的帧转换为 `HSV` 颜色空间(易于颜色检测)。
2.  准备画布框架，并在上面放置相应的油墨按钮。
3.  调整跟踪条值以找到彩色标记的遮罩。
4.  使用形态学操作(腐蚀和膨胀)对蒙版进行预处理。
5.  检测轮廓，找到最大轮廓的中心坐标，并将其保存在连续帧的数组中(用于在画布上绘制点的数组)。
6.  最后在框架和画布上画出存储在数组中的点。
...
**输出:**
![Sample project screenshot](img/2868ef4e0349861d2fed8d57245aac74.png)

![](img/9a64920ab71f84514371b314e6b67ba5.png)