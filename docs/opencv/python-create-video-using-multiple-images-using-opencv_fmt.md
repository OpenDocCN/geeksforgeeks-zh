# Python：使用 OpenCV 通过多张图像创建视频

> 原文：[https://www.geeksforgeeks.org/python-create-video-using-multiple-images-using-opencv/](https://www.geeksforgeeks.org/python-create-video-using-multiple-images-using-opencv/)

众所周知，OpenCV 是一个广泛使用的图像处理库。它提供了广泛意义上的图像处理。让我们看看如何使用 OpenCV 通过多张图像创建视频。
