...
> 原文: [https://www.geeksforgeeks.org/check-if-the-camera-is-opened-or-not-using-opencv-python/](https://www.geeksforgeeks.org/check-if-the-camera-is-opened-or-not-using-opencv-python/)
...
*   启动摄像头。这里，在 `VideoCapture()` 中 0 表示内置网络摄像头，而 1 表示使用外部网络摄像头。
