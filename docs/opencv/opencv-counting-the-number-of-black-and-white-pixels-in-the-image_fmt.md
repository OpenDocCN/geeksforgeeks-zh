...
> 原文: [https://www.geeksforgeeks.org/opencv-counting-the-number-of-black-and-white-pixels-in-the-image/](https://www.geeksforgeeks.org/opencv-counting-the-number-of-black-and-white-pixels-in-the-image/)
...
OpenCV 提供了 `imshow()` 方法来显示我们最近阅读的图像。
...
> `number_of_white_pix = np.sum(img == 255)` # 仅提取白色像素
>
> `number_of_black_pix = np.sum(img == 0)` # 仅提取黑色像素
