# 使用 Python–OpenCV 统计人脸数量

> 原文: [https://www.geeksforgeeks.org/count-number-of-faces-using-python-opencv/](https://www.geeksforgeeks.org/count-number-of-faces-using-python-opencv/)

**先决条件:** [使用 `dlib` 和 `openCV` 进行人脸检测](https://www.geeksforgeeks.org/opencv-facial-landmarks-and-face-detection-using-dlib-and-opencv/)
