...
> 原文: [https://www.geeksforgeeks.org/python-opencv-cv2-imread-method/](https://www.geeksforgeeks.org/python-opencv-cv2-imread-method/)
...
## 参数
- `path`: 代表待读图像路径的字符串。
- `flag`: 指定读取图像的方式。它的默认值是 `cv2.IMREAD_COLOR`。
