...
> 原文: [https://www.geeksforgeeks.org/storing-opencv-image-in-sqlite3-with-python/](https://www.geeksforgeeks.org/storing-opencv-image-in-sqlite3-with-python/)
...
内容存储在 `table` 变量中，然后转换成 `CSV` 文件保存到系统中。
