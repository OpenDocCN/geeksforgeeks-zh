...
> 原文：[https://www.geeksforgeeks.org/addition-blending-images-using-opencv-python/](https://www.geeksforgeeks.org/addition-blending-images-using-opencv-python/)

当我们谈论图像时，我们知道所有关于矩阵的信息，或者是二值图像(`0`，`1`)、灰度图像(`0-255`)或者是 RGB 图像(`255 255 255`)。所以图像的加法就是将两个矩阵的数字相加。在 OpenCV 中，我们有一个命令 `cv2.add()` 来添加图像。
