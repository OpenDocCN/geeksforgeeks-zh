...
> 原文: [https://www.geeksforgeeks.org/cartooning-an-image-using-opencv-python/](https://www.geeksforgeeks.org/cartooning-an-image-using-opencv-python/)
...
![Cartooning an Image using OpenCV (python)1](img/2647dfa85ee240a7ad1166368c5902f0.png) **漫画版**

![1](img/af25b99ede29e83e6f04b0a9345aa22d.png) **从图像获得的边缘(自适应阈值结果)**
