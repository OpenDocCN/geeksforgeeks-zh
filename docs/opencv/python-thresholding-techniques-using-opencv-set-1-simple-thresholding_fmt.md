...
> 原文: [https://www.geeksforgeeks.org/python-thresholding-techniques-using-opencv-set-1-simple-thresholding/](https://www.geeksforgeeks.org/python-thresholding-techniques-using-opencv-set-1-simple-thresholding/)
...
> **参数:**
> - `source`: 输入图像数组(必须为灰度)。
> - `thresholdValue`: 低于和高于阈值的值，像素值将相应改变。
...
*   `cv2.THRESH_BINARY_INV`: `cv2.THRESH_BINARY` 的反相或相反情况。
