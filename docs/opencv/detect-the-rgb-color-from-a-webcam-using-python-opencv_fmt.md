...
> 原文: [https://www.geeksforgeeks.org/detect-the-rgb-color-from-a-webcam-using-python-opencv/](https://www.geeksforgeeks.org/detect-the-rgb-color-from-a-webcam-using-python-opencv/)

**先决条件:** `Python NumPy`、[Python OpenCV](https://www.geeksforgeeks.org/opencv-python-tutorial/)
...
1.  导入 `cv2` 和 `NumPy` 模块。
2.  使用 `cv2.VideoCapture(0)` 方法捕捉网络摄像头视频。
