...
> 原文: [https://www.geeksforgeeks.org/python-opencv-cv2-flip-method/](https://www.geeksforgeeks.org/python-opencv-cv2-flip-method/)
...
- `flipCode`: 指定如何翻转数组的标志；0 表示绕 x 轴翻转，正值（例如 1）表示绕 y 轴翻转。负值（例如，-1）表示绕两个轴翻转。
