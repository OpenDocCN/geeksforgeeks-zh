...
> 原文: [https://www.geeksforgeeks.org/live-webcam-drawing-using-opencv/](https://www.geeksforgeeks.org/live-webcam-drawing-using-opencv/)

让我们看看如何使用 OpenCV 绘制网络摄像头捕捉到的对象的运动。我们的程序从网络摄像头获取视频输入，并跟踪我们正在移动的物体。在识别物体后，它将精确地制作轮廓。之后，它会在输出屏幕上打印你所有的绘图。
...
**输出:**
![](img/e26643a658b70ffc6060a376efa852e7.png)