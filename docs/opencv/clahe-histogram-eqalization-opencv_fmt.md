...
> 原文：[https://www.geeksforgeeks.org/clahe-histogram-eqalization-opencv/](https://www.geeksforgeeks.org/clahe-histogram-eqalization-opencv/)
...
我们也可以将 CLAHE 应用于彩色图像，其中通常将其应用于`亮度通道`，并且仅均衡`HSV 图像`的`亮度通道`后的结果比均衡`BGR 图像`的所有通道好得多。
