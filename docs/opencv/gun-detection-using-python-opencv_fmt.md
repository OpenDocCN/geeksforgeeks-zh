...
> 原文: [https://www.geeksforgeeks.org/gun-detection-using-python-opencv/](https://www.geeksforgeeks.org/gun-detection-using-python-opencv/)

## 先决条件
[Python OpenCV](https://www.geeksforgeeks.org/opencv-python-tutorial/)
...
### 1) 创建枪支的哈卡卡德文件
参考[创建自己的哈卡卡德](https://pythonprogramming.net/haar-cascade-object-detection-python-opencv-tutorial/)。
