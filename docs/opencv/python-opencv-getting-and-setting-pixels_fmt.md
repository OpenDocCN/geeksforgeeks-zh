...
> 原文: [https://www.geeksforgeeks.org/python-opencv-getting-and-setting-pixels/](https://www.geeksforgeeks.org/python-opencv-getting-and-setting-pixels/)
...
在图像上做黑色十字的 Python 代码。

为此，我们将提取所有 `(i, j)`，使得 `i==j` 或 `i+j == img.shape[0]`，并且对于具有索引 `(i, j)` 的所有像素，像素的值将设置为 `[0, 0, 0]`。
