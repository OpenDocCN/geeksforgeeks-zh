...
> 原文：[https://www.geeksforgeeks.org/erosion-dilation-images-using-opencv-python/](https://www.geeksforgeeks.org/erosion-dilation-images-using-opencv-python/)

**形态运算**是一组基于形状处理图像的运算。他们将结构化元素应用于输入图像并生成输出图像。最基本的形态操作有两个：**侵蚀和扩张**。
