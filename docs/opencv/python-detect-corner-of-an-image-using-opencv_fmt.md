...
> 原文: [https://www.geeksforgeeks.org/python-detect-corner-of-an-image-using-opencv/](https://www.geeksforgeeks.org/python-detect-corner-of-an-image-using-opencv/)
...
> 语法: `cv2.goodFeaturesToTrack(image, maxCorners, qualityLevel, minDistance[, corners[, mask[, blockSize[, useHarrisDetector[, k]]]])`
