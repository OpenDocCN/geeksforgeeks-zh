...
> 原文：[https://www.geeksforgeeks.org/feature-detection-and-matching-with-opencv-python/](https://www.geeksforgeeks.org/feature-detection-and-matching-with-opencv-python/)
...
> **语法：**
>
> `cv2.cornerHarris(图像、dest、块大小、kSize、freeParameter、bordertype)`
>
> **参数：**
>
> *   `图像` – 检测特征的源图像
