...
> 原文: [https://www.geeksforgeeks.org/python-opencv-cv2-blur-method/](https://www.geeksforgeeks.org/python-opencv-cv2-blur-method/)

## 简介

`OpenCV-Python`是一个Python绑定库，旨在解决计算机视觉问题。`cv2.blur()`方法用于使用归一化箱式滤波器模糊图像。该函数使用内核平滑图像，内核表示为:
