...
> 原文: [https://www.geeksforgeeks.org/difference-between-jpeg-and-psd/](https://www.geeksforgeeks.org/difference-between-jpeg-and-psd/)

## 1. 联合摄影专家组(JPEG)

自 1982 年 6 月以来，ISO 的第 8 工作组(WG8)一直致力于静态图像压缩和解压缩的标准。1987 年 6 月，提出了 10 种不同的彩色和灰度静止图像编码技术。基于离散余弦变换的自适应变换编码技术取得了最佳的主观效果。

JPEG 适用于彩色和灰度静止图像。视频序列也可以通过静态图像的大量编码和解码来处理，这种技术被称为运动 JPEG。
