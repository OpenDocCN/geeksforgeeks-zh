...
> 原文：[https://www.geeksforgeeks.org/general-steps-of-software-testing-process/](https://www.geeksforgeeks.org/general-steps-of-software-testing-process/)

这是`软件测试`过程的11个步骤，是一种基于经验的解决测试任务的实用方法。
...
## 步骤-11:评估测试有效性–
测试改进最好通过在每个软件测试任务的顶部评估测试的有效性来实现。虽然这种评估主要由测试人员执行，但是如果 `it` 组织中存在 `功能`，它应该涉及开发人员、软件用户和质量保证专业人员。