...
> 原文：[https://www.geeksforgeeks.org/different-ways-to-reduce-emergency-maintenance-load/](https://www.geeksforgeeks.org/different-ways-to-reduce-emergency-maintenance-load/)
...
4.  **`Total Productive Maintenance (TPM)`：**
    `TPM` is a maintenance strategy that aims at keeping assets up and running without any interruption as wells as improving condition of assets also. It simply focuses on achieving perfect production and increasing equipment effectiveness.
