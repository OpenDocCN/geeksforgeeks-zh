...
> 原文: [https://www.geeksforgeeks.org/difference-between-cost-variance-and-schedule-variance/](https://www.geeksforgeeks.org/difference-between-cost-variance-and-schedule-variance/)
...
成本差异(`CV`)为负表示项目超预算，进度差异(`SV`)为负表示项目进度落后。
