...
> 原文：[https://www.geeksforgeeks.org/types-of-em-requests-and-responses/](https://www.geeksforgeeks.org/types-of-em-requests-and-responses/)
...
自动响应通常是预定义的响应，即每当发生紧急情况时发送的预定义维护请求。这些维护请求由工作单管理软件或系统自动生成，无需任何人工干预。

### 3. 人工请求

`Emergency maintenance requests` 也可以手动生成，即由员工、技术人员、团队成员生成。`Emergency Maintenance requests` 简单意味着需要立即采取行动来修复故障资产。在这些情况下，维护请求通常由故障发生时在现场的员工或团队成员发送。
