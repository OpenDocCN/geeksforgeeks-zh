...
> 原文：[https://www.geeksforgeeks.org/difference-between-continuous-integration-and-continuous-delivery/](https://www.geeksforgeeks.org/difference-between-continuous-integration-and-continuous-delivery/)
...
| 3. | 它的主要目的是提供快速的反馈，这样如果代码库中有任何缺陷，就可以尽快识别和解决。 | 它的主要目标是拥有随时可以部署到生产环境中的代码库。 |
...
| 8. | 与 `CD` 相比，这一过程不太复杂，成本也较低。 | 与 `CI` 相比，这一过程更加复杂，成本也更高。 |
...
- [https://www.geeksforgeeks.org/ci-cd-continuous-integration-and-continuous-delivery/](https://www.geeksforgeeks.org/ci-cd-continuous-integration-and-continuous-delivery/)