...
> 原文:[https://www.geeksforgeeks.org/software-engineering-software-review/](https://www.geeksforgeeks.org/software-engineering-software-review/)
...
*   **(i)代码审查:**
    ...
    *   **(iii)演练:**
        开发团队成员由作者和其他相关方指导，参与者就缺陷提出问题并做出评论。
    *   **(iv)技术审查:**
