...
> 原文：`https://www.geeksforgeeks.org/difference-between-software-and-framework/`
...
| 软件的例子包括`微软 office`、`Skype`、`Pandora`、`Chrome`等。 | 框架的例子包括`ActiveX`、`.NET`、`Cocoa`、`Cocoa Touch`等。 |
