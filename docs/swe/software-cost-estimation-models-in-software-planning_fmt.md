...
> 原文：[https://www.geeksforgeeks.org/software-cost-estimation-models-in-software-planning/](https://www.geeksforgeeks.org/software-cost-estimation-models-in-software-planning/)
...
使用该模型的方法利用一个方程来获得期望的值，如成本、时间和努力等。这些都依赖于同一个变量，如大小。下面是最常见的等式示例：
...
这些模型也被称为多变量模型。这个模型往往基于第一个方程，实际上取决于代表软件开发环境不同方面的几个变量。
