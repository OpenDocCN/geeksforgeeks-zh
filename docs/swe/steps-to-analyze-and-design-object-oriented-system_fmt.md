...
> 原文: [https://www.geeksforgeeks.org/steps-to-analyze-and-design-object-oriented-system/](https://www.geeksforgeeks.org/steps-to-analyze-and-design-object-oriented-system/)

## 面向对象分析(OOA)
[面向对象分析(OOA)](https://www.geeksforgeeks.org/object-oriented-analysis-and-design/)是作为面向对象软件工程的一部分而执行的第一个技术活动。面向对象分析引入新概念来研究问题。
