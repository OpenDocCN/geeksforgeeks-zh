...
> 原文：[https://www.geeksforgeeks.org/software-testing-penetration-testing/](https://www.geeksforgeeks.org/software-testing-penetration-testing/)

## 渗透测试简介
在伦理黑客中俗称笔测或`五旬节`。这是网络攻击的一种形式，基本上是为了检查系统的安全状况。人们经常将这种渗透测试或笔测试与漏洞评估测试混淆。
