...
> 原文：`https://www.geeksforgeeks.org/steps-to-perform-rcm/`
...
2.  **定义功能：**
    其次，需要定义所选设备的功能。人们应该知道系统是如何工作的，以便能够相应地处理它。一个系统包含许多设备，因此了解所选设备的功能至关重要，以便选择合适的维护策略。

3.  **定义故障模式：**
    第三，需要确定所选设备和系统发生故障的不同方式。定义故障模式应该是主要目标之一，这样人们就可以在故障发生之前确定保护故障的方法。

4.  **查明根本原因：**
    第四，需要查明此类故障的主要原因，以便能够永久消除故障。根本原因是此类故障发生的主要原因。有必要确定故障的主要原因，以便识别和实施有效的解决方案和维护策略，从而永久消除故障。可以使用操作员、经验丰富的技术人员、`RCM` 团队、专家等来确定根本原因。
...
6.  **选择维修策略：**
    这一步非常关键和重要。确定维护策略是保存故障的唯一方法，因此选择适当的维护策略非常重要，该策略必须具有成本效益和可靠性，并且在技术上可行。有两种维护策略，即基于条件的维护和基于使用的预防性维护。相应地选择维护策略。如果任何故障模式没有任何维护选项，那么唯一能做的就是重新设计系统，以消除和修改故障模式。
