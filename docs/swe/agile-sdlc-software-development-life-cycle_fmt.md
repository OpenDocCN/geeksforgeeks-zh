...
> 原文: [https://www.geeksforgeeks.org/agile-sdlc-software-development-life-cycle/](https://www.geeksforgeeks.org/agile-sdlc-software-development-life-cycle/)
...
与敏捷软件开发生命周期一样，一个产品被分成小的`增量构建`，因此在每个构建都是按照下面的过程在迭代中提供的。
