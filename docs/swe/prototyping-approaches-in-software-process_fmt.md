...
> 原文：[https://www.geeksforgeeks.org/prototyping-in-software-process/](https://www.geeksforgeeks.org/prototyping-approaches-in-software-process/)
...
*   **用户参与系统**
    用户参与开发过程不仅是为了满足他们的需求，也意味着系统已经对其做出了承诺，并且可能希望它发挥作用。
