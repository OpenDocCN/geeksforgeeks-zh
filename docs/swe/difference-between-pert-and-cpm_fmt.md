...
> 原文: [https://www.geeksforgeeks.org/difference-between-pert-and-cpm/](https://www.geeksforgeeks.org/difference-between-pert-and-cpm/)
...
| 2. | 面向事件的技术是指在事件的基础上构建网络。 | 面向活动的技术是指网络是在活动的基础上构建的。 |
| 3. | 这是一个概率模型。 | 这是一个确定性模型。 |
...
| 8. | 它不使用任何虚拟活动。 | 它使用虚拟活动来表示活动的顺序。 |
| 9. | 适用于需要研发的项目。 | 适用于建筑工程。 |