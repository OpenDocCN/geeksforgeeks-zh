...
> 原文：[https://www.geeksforgeeks.org/difference-between-smoke-testing-and-regression-testing/](https://www.geeksforgeeks.org/difference-between-smoke-testing-and-regression-testing/)
...
| 03. | 冒烟测试的测试用例是回归测试的一部分，并且只覆盖核心功能。 | 回归测试从功能规范或[软件需求规范(SRS)](https://www.geeksforgeeks.org/how-to-write-a-good-srs-for-your-project/)中获得。 |
...
| 10. | 对时间和人力的要求低于回归测试。 | 对时间和人力的要求比烟雾测试更少。 |