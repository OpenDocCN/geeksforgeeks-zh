...
> 原文：`https://www.geeksforgeeks.org/w5hh-principle/`
...
W5HH 原则概述了一系列可以帮助项目经理更有效地管理软件项目的问题。W5HH 中的每个字母代表一系列问题中的一个问题，以帮助项目经理领导。（注意有五个“W”问题和两个“H”问题）。

| **W5HH** | **问题** | **什么意思** |
| :--- | :--- | :--- |
| 为什么？ | 系统为什么在开发？ | 这让团队专注于开发软件的业务原因。 |
| 什么？ | 会做什么？ | 这是确定需要完成的任务的指导原则。 |
| 什么时候？ | 什么时候完工？ | 这包括项目的重要里程碑和时间表。 |
