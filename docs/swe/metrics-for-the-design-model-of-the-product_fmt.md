...
> 原文：[https://www.geeksforgeeks.org/metrics-for-the-design-model-of-the-product/](https://www.geeksforgeeks.org/metrics-for-the-design-model-of-the-product/)
...
1.  **Structural Complexity –**
    ...
    S(k) = f2out(k)
    ```
    其中 `fout` 表示模块 `k` 的扇出（扇出表示从属于模块 `k` 的模块数量）。
