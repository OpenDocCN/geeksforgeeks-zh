...
> 原文：[`https://www.geeksforgeeks.org/difference-between-prototype-model-and-incremental-model/`](https://www.geeksforgeeks.org/difference-between-prototype-model-and-incremental-model/)

## 1. 原型模型
原型模型是一个软件开发生命周期模型，在客户对最终产品应该是怎样的以及它的需求还不完全了解的时候使用。因此，在这个模型中，最终产品的原型首先由开发人员开发，然后进行测试，并根据客户反馈进行更改，直到客户对原型满意为止。
