...
> 原文：[https://www.geeksforgeeks.org/difference-between-cucumber-testing-and-selenium-testing/](https://www.geeksforgeeks.org/difference-between-cucumber-testing-and-selenium-testing/)
...
| 黄瓜测试 | 硒测试 |
| --- | --- |
| 它使用行为驱动开发工具。 | 它使用功能和性能（`Selenium Grid`）工具。 |
| `黄瓜插件`工作更快。 | 插件比黄瓜慢。 |
| `黄瓜框架`支持除 `Ruby` 之外的其他语言，如 `Java`、`Scala`、`Groovy` 等。 | `Selenium` 支持 `Java`，`.Net` 和许多其他语言。 |
