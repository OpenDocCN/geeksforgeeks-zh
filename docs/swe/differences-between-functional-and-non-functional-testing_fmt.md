...
> 原文：[https://www.geeksforgeeks.org/differences-between-functional-and-non-functional-testing/](https://www.geeksforgeeks.org/differences-between-functional-and-non-functional-testing/)
...
| **例：**<br><br>```<br>1. Unit Testing<br>2. Smoke Testing<br>3. Integration Testing<br>4. Regression Testing<br>``` | **例：**<br><br>```<br>1. Performance Testing<br>2. Load Testing<br>3. Stress Testing<br>4. Scalability Testing<br>``` |