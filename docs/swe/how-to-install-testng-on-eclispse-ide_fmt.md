# 如何在 Eclipse IDE 上安装 TestNG？

> 原文：[https://www.geeksforgeeks.org/how-to-install-testng-on-eclispse-ide/](https://www.geeksforgeeks.org/how-to-install-testng-on-eclispse-ide/)
...
*   进入 `Eclipse IDE` 中的`帮助`菜单，点击`安装新软件`。
*   粘贴网址，勾选测试的依赖项。
