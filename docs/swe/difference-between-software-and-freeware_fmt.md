...
> 原文:[https://www.geeksforgeeks.org/difference-between-software-and-freeware/](https://www.geeksforgeeks.org/difference-between-software-and-freeware/)
...
| 软件的例子包括`微软 Word`、`Slack`、`Pandora`、`Safari`等。 | 免费软件的例子包括`Adobe reader`、`免费工作室`、`skype`等。 |
