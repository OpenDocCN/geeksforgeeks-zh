...
> 原文：[https://www.geeksforgeeks.org/software-engineering-classical-waterfall-model/](https://www.geeksforgeks.org/software-engineering-classical-waterfall-model/)
...
维护是软件生命周期最重要的阶段。花在维护上的 effort 占开发整个软件总 effort 的 60%。基本上有三种类型的维护：
