...
> 原文: [https://www.geeksforgeks.org/advantages-and-disadvantages-of-materials-requirements-planning-mrp-systems/](https://www.geeksforgeks.org/advantages-and-disadvantages-of-materials-requirements-planning-mrp-systems/)

## 物料需求计划(MRP)系统

建立一个逻辑方法论，类似于物料需求`计划` (MRP)，可以创建一个思想，要求在你的时间内将物料的完美度量传送到特定的区域。
