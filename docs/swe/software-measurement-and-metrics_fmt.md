...
> 原文：[https://www.geeksforgeeks.org/software-measurement-and-metrics/](https://www.geeksforgeeks.org/software-measurement-and-metrics/)

## 软件度量
度量是产品或过程的特定属性的大小、数量、数量或维度的表现。软件测量是对软件产品或软件过程特征的滴定估算。它是软件工程领域的权威。软件测量过程由国际标准化组织标准定义和管理。
