...
> 原文: [https://www.geeksforgeeks.org/software-engineering-cocomo-model/](https://www.geeksforgeeks.org/software-engineering-cocomo-model/)
...
| 软件项目 | a | b | c | d |
| --- | --- | --- | --- | --- |
| 有机的 | 2.4 | 1.05 | 2.5 | 0.38 |
| 半分离的 | 3.0 | 1.12 | 2.5 | 0.35 |
| 植入的 | 3.6 | 1.20 | 2.5 | 0.32 |

工作量是以人-月来衡量的，从公式中可以明显看出，它依赖于千行代码。发育时间以月为单位。
...
| 成本动因 | 极低 | 低的 | Nominal | 高的 | 非常高 |
| --- | --- | --- | --- | --- | --- |
| **产品属性** |  |  |  |  |  |
| 所需的软件可靠性 | 0.75 | 0.88 | 1 | 1.15 | 1.4 |
| 应用程序数据库的大小 |  | 0.94 | 1 | 1.08 | 1.16 |
| 产品的复杂性 | 0.7 | 0.85 | 1 | 1.15 | 1.3 |
| **硬件属性** |  |  |  |  |  |
| 运行时性能约束 |  |  | 1 | 1.11 | 1.3 |
| 内存限制 |  |  | 1 | 1.06 | 1.21 |
| 虚拟机环境的不稳定性 |  | 0.87 | 1 | 1.15 | 1.3 |
| 所需周转时间 |  | 0.94 | 1 | 1.07 | 1.15 |
| **人员属性** |  |  |  |  |  |
| 分析师能力 | 1.46 | 1.19 | 1 | 0.86 | 0.71 |
| 应用体验 | 1.29 | 1.13 | 1 | 0.91 | 0.82 |
| 软件工程师能力 | 1.42 | 1.17 | 1 | 0.86 | 0.7 |
| 虚拟机体验 | 1.21 | 1.1 | 1 | 0.9 |  |
| 编程语言经验 | 1.14 | 1.07 | 1 | 0.95 |  |
| **项目属性** |  |  |  |  |  |
| 软件工程方法的应用 | 1.24 | 1.1 | 1 | 0.91 | 0.82 |
| 软件工具的使用 | 1.24 | 1.1 | 1 | 0.91 | 0.83 |
| 所需的开发时间表 | 1.23 | 1.08 | 1 | 1.04 | 1.1 |
