...
> 原文: [https://www.geeksforgeeks.org/planning-guidelines-in-software-engineering/](https://www.geeksforgeeks.org/planning-guidelines-in-software-engineering/)
...
## 为生命周期所有阶段的努力和日程安排分配提供建议

下面是一个给定的表格。在此表中，您将看到努力和日程安排的分配。价值可能因不同项目而异，但分配通常通过提供跨应用领域范围的平均期望而发挥着重要作用。
