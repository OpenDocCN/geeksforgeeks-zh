...
> 原文: [https://www.geeksforgeeks.org/steps-of-perform-emergency-maintenance-effectively/](https://www.geeksforgeeks.org/steps-of-perform-emergency-maintenance-effectively/)

紧急顾名思义，是指会造成更大伤害的压力事件。任何类型的紧急情况都需要立即采取行动。紧急维护(`EM`)是一种维护措施，当任何紧急情况(即设备或资产故障)意外发生时，需要立即执行。执行`EM`是为了将资产恢复到其正常工作状态。
...
在采取任何措施之前，需要理解紧急情况的实际含义。紧急情况是指对生命、系统、生产等造成更大威胁的事件，因此需要立即采取行动以最小化其影响。并非所有发生的故障或问题都被视为紧急情况。需要能够区分哪些故障或停机是真正的紧急情况，哪些不是。故障情况可以分为以下两种类型：
