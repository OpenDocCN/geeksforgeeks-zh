...
> 原文:[https://www.geeksforgeeks.org/negative-testing-in-software-engineering/](https://www.geeksforgeeks.org/negative-testing-in-software-engineering/)
...
阴性测试确保交付给客户的产品或应用没有 bug。为了构建有效的阴性测试场景，我们需要富有创造力和智慧的测试工程师。每个软件公司的目标是能够进行阴性测试。因此，通过实现负测试，我们可以提高软件的质量。