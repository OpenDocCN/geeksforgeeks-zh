...
> 原文：[https://www.geeksforgeeks.org/difference-between-scrum-and-six-sigma/](https://www.geeksforgeeks.org/difference-between-scrum-and-six-sigma/)

## 前提
[敏捷开发模型](https://www.geeksforgeeks.org/software-engineering-agile-development-models/) [精益软件开发](https://www.geeksforgeeks.org/lean-software-development-lsd/)
...
| 02. | 它基于 `DMAIC` 和 `DMADV` 原则。 | 它基于敏捷原则。 |
