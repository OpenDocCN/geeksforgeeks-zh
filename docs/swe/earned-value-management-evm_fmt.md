...
2.  **根据基线评估绩效 –**
    建立 `PMB` 后，根据基线评估和分析项目绩效也变得至关重要。为了评估绩效，项目经理跟踪资源的使用情况、物理工作进展、计算成本进度绩效，并找出项目中的问题，以便在项目实施期间采取所需行动。

## 缺乏基线导致的问题:

1.  **进度问题的监控–**
        监控意味着我们可以将项目的进度与计划进行比较。实际上，基线用于比较实际工作和计划工作，以便我们可以评估项目的进度。例如(`Ex-`)，如果一个项目计划在 3 个月内完成，成本为 1000 美元，一个月后项目经理意识到不可能在这样的成本和时间内完成项目，他/她可以采取必要的措施。
2.  **进度延迟–**
