...
> 原文：[https://www.geeksforgeeks.org/difference-between-component-and-unit-testing/](https://www.geeksforgeeks.org/difference-between-component-and-unit-testing/)
...
[单元测试](https://www.geeksforgeeks.org/unit-testing-software-testing/)是对软件的单个单元，即一组计算机程序模块、使用程序和操作程序进行测试，以确定它们是否适合使用的一种软件测试。这是一种测试方法，使用它来测试每个独立的模块，以确定开发人员自己是否有任何问题。它与独立模块的功能正确性相关。
