...
> 原文：[https://www.geeksforgeeks.org/various-approaches-of-partitioning/](https://www.geeksforgeeks.org/various-approaches-of-partitioning/)

如果系统具有层次结构，程序结构可以很容易地在水平和垂直方向上划分，图(a)代表了这个视图。
