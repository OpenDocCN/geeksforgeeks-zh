...
> 原文：[https://www.geeksforgeeks.org/difference-between-lean-development-model-and-agile-development-model/](https://www.geeksforgeeks.org/difference-between-lean-development-model-and-agile-development-model/)

## 精益模型

精益是一种高效的方法论，它认为价值通过持续改进流向客户，并为客户创造价值。它优化了可用资源，以创建一个稳定的工作流程，将客户的需求放在中心位置。1915 年，亨利·福特在福特汽车公司的高地公园工厂首次使用精益模型。一般是指一套专门称为*精益制造*的知识。这侧重于基于需求而非供应的生产。它包含 5 个原则。
...
| 03. | 敏捷是使用不同的框架设计的，比如 `scrum`、`看板`等等。 | 精益是利用制造过程的过渡来设计的。 |
