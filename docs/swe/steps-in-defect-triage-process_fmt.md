...
> 原文：[https://www.geeksforgeeks.org/steps-in-defect-triage-process/](https://www.geeksforgeeks.org/steps-in-defect-triage-process/)
...
2.  其次，QA团队随后进一步召集会议。在此会议期间，每个缺陷都经过仔细分析，以查看是否为其正确分配了优先级和严重程度。如果没有，则对特定缺陷进行更正。
