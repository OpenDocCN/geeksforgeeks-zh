...
> 原文：[https://www.geeksforgeeks.org/why-requirement-elicitation-is-difficult/](https://www.geeksforgeeks.org/why-requirement-elicitation-is-difficult/)
...
3.  **设计用例模型–**
    它通常以图形方式表示需求。这些只是收集和收集系统的需求以及内部和外部的影响。
