...
> 原文：[https://www.geeksforgeeks.org/benchmark-testing-in-software-testing/](https://www.geeksforgeeks.org/benchmark-testing-in-software-testing/)
...
这里我们就举两个基准测试的案例。假设有一个 web 应用程序，我们将看到 web 应用程序的数据库性能和 web 的客户端服务器应用程序的基准组件是什么。
