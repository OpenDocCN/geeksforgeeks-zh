...
> 原文: [https://www.geeksforgeeks.org/example-basis-path-testing-white-box-testing/](https://www.geeksforgeeks.org/example-basis-path-testing-white-box-testing/)
...
*   **步骤-2:**
    将顺序语句放入一个单独的节点。例如，语句1、2和3都是顺序语句，因此应合并为一个节点。对于其他语句，我们将遵循[此处](https://www.geeksforgeeks.org/various-path-testing-in-software-engineering/)讨论的表示法。
