...
> 原文: [https://www.geeksforgeeks.org/performance-testing-software-testing/](https://www.geeksforgeeks.org/performance-testing-software-testing/)
...
`性能测试`是分析产品质量和能力的过程。这是一种测试方法，用于确定系统在不同工作负载下的速度、可靠性和稳定性。`性能测试`也称为`性能测试`。
