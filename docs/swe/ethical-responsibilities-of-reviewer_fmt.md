...
> 原文：[https://www.geeksforgeeks.org/ethical-responsibilities-of-reviewer/](https://www.geeksforgeeks.org/ethical-responsibilities-of-reviewer/)
...
## 2. 能力
能力基本上被描述为拥有足够知识、所需技能、资格、力量的质量或状态。对于评审过程，评审员应仅在其拥有评审特定材料的知识、专长和所需技能时才接受评审。

如果审查人员不是材料方面的专家，则可能存在实质性缺陷或材料被拒绝。因此，在这种情况下，审查者不应接受审查。

## 3. 及时性与响应性
及时性简单来说是在有利或最佳时间完成某事的质量，而响应性简单来说是快速积极反应的质量。评审者也有责任在要求的时间内快速评审材料并在给定的时间段内提交。
...
## 5. 建设性批评
建设性基本上是一个过程，个人以令人愉快的方式表达他/她对特定事物的看法，无论是否存在积极或消极方面。
