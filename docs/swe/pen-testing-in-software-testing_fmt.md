...
> 原文：[`https://www.geeksforgeeks.org/pen-testing-in-software-testing/`](https://www.geeksforgeeks.org/pen-testing-in-software-testing/)

`pen`测试，一系列活动，旨在识别系统中存在的各种潜在漏洞，任何攻击都可以利用这些漏洞来利用组织。它使组织能够在了解当前存在的漏洞和不适当的系统配置后修改其安全策略和计划。本文概述了笔测试，为什么要使用笔测试，这有什么好处，它是如何进行的。本文还概述了笔测试的各个阶段。此外，它给出了一支笔的平均成本的估计概况。
...
*   **黑盒** – 测试人员无法获得有关漏洞的信息。这是一个刮擦策略。
*   **白盒** – 关于漏洞的所有信息都提供给测试人员。
*   **灰色框** – 存在漏洞的部分信息。
