...
> 原文：[https://www.geeksforgeeks.org/ci-cd-continuous-integration-and-continuous-delivery/](https://www.geeksforgeeks.org/ci-cd-continuous-integration-and-continuous-delivery/)
...
持续部署是一种进步，它减少了操作和测试团队将软件部署到生产环境的手动工作，因为它是在自动验收测试后自动部署到生产环境的。
