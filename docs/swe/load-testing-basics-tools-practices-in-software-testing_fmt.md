...
> 原文：[https://www.geeksforgeeks.org/load-testing-basics-tools-practices-in-software-testing/](https://www.geeksforgeeks.org/load-testing-basics-tools-practices-in-software-testing/)
...
7.  说到大负荷，它们导致了大量的负荷发生器。因此，在测试完成之前，将不必要的负载发生器及其应用程序设置为休眠模式可能是合适的。
