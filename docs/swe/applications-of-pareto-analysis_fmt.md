...
> 原文: [https://www.geeksforgeeks.org/applications-of-pareto-analysis/](https://www.geeksforgeeks.org/applications-of-pareto-analysis/)
...
在业务中，客户角色也很重要。因此，每个组织或企业或公司都会在特定时间段内分析客户关系。组织分析的是客户盈利性(`CP`)，而不是产品。

客户盈利性基本上是指组织或企业在给定时间内向客户或客户群提供服务或产品而获得的利润。利润是通过特定时期内与客户关系相关的收入和成本的差异来分析的。有些客户利润更高，有些利润更低。
...
`ABC`分析简单意味着根据消耗值对产品或物品进行分类。这里，消耗值简单意味着在给定时间段内被消耗的产品或物品的总价值。
