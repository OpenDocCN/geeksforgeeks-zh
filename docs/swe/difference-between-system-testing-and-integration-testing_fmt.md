...
> 原文：[https://www.geeksforgeeks.org/difference-between-system-testing-and-integration-testing/](https://www.geeksforgeeks.org/difference-between-system-testing-and-integration-testing/)
...
本次测试分为系统的`功能性`和`非功能性`需求。在功能测试中，测试类似于`黑盒测试`，`黑盒测试`基于规范，而不是所用编程语言的代码和语法。另一方面，在非功能测试中，它通过用相应的编程语言生成测试用例来检查性能和可靠性。
