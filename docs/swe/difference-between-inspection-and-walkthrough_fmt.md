...
> 原文：[https://www.geeksforgeeks.org/difference-between-inspection-and-walkthrough/](https://www.geeksforgeeks.org/difference-between-inspection-and-walkthrough/)
...
检查被定义为正式、严格、深入的小组审查，旨在尽可能接近问题的源头识别问题。检查提高了软件产品的可靠性、可用性和可维护性。

在软件开发期间产生的任何可读的东西都可以被检查。检查可以与结构化、系统化的测试相结合，为创建无缺陷的程序提供一个强大的工具。
