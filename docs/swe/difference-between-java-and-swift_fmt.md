...
> 原文: [https://www.geeksforgeks.org/difference-between-java-and-swift/](https://www.geeksforgeks.org/difference-between-java-and-swift/)

## 1. Java

[Java](https://www.geeksforgeeks.org/java/) 是一种面向对象、平台无关、并发的通用编程语言，也是 Sun Micro System 于 1995 年首次开发的计算平台。它是由詹姆斯·高斯林开发的。
...
[Swift](https://www.geeksforgeeks.org/swift-programming-language/) 是一种伟大的、本能的、编译的通用编程语言，由苹果公司开发，于 2014 年首次发布。它用于为苹果操作系统、苹果操作系统、手表操作系统、电视操作系统等开发软件应用程序。它是由克里斯·拉特纳开发的。
...
| 04. | 在继承过程中，它使用 `extends` 关键字，例如 `class Child extends Parents`。 | 在继承过程中，它使用 `:` 符号，例如 `class Child : Parent` |
