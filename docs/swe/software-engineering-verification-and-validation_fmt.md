...
> 原文: [https://www.geeksforgeeks.org/software-engineering-verification-and-validation/](https://www.geeksforgeeks.org/software-engineering-verification-and-validation/)

验证和确认是调查一个软件系统是否满足规范和标准以及它是否满足要求的目的的过程。巴里·博姆对验证和确认的描述如下:
