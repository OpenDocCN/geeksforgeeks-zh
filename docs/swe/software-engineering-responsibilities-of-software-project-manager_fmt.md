...
> 原文：[https://www.geeksforgeeks.org/software-engineering-responsibilities-of-software-project-manager/](https://www.geeksforgeeks.org/software-engineering-responsibilities-of-software-project-manager/)
...
软件项目有许多限制，但是主要和基本的限制包括：`时间`、`成本`和`质量`。任何一个因素都会严重影响第三个。因此，`软件项目管理`对于在规定的时间和预算内开发高质量的软件项目至关重要。
