...
> 原文: [https://www.geeksforgeeks.org/overview-of-continual-service-improvement-csi/](https://www.geeksforgeeks.org/overview-of-continual-service-improvement-csi/)
...
持续服务管理包括七个阶段的改进过程。这七个步骤被称为`知识螺旋`。从一个层次收集的知识成为下一个层次的输入。渐渐地，实际获得的知识升级成为其他层面的投入。
