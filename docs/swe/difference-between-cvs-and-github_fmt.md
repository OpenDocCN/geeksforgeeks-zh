...
> 原文：[https://www.geeksforgeeks.org/difference-between-cvs-and-github/](https://www.geeksforgeeks.org/difference-between-cvs-and-github/)
...
| 导航 | `CVS` 不允许导航到存储库。 | `GitHub` 允许用户导航可用性。 |
