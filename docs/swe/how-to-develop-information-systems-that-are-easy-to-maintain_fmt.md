...
> 原文: [https://www.geeksforgeeks.org/how-to-develop-information-systems-that-are-easy-to-maintain/](https://www.geeksforgeeks.org/how-to-develop-information-systems-that-are-easy-to-maintain/)
...
对于用户来说，维护对于文档来说很重要，到目前为止，我们已经看到了这一点，以及维护对于系统平稳运行的重要性。对于交流来说，文档对于开发团队和所有潜在用户来说都是非常重要的。如果只有在开发团队成员缺席的情况下才需要紧急维护，那么文档证明是非常有用的，因为所有的事实都有一个记录，记录了所有的假设，未来的维护因此变得非常容易。为了方便，无错误的功能维护是必要的系统，也为了跟上不断变化的要求和不断变化的技术。因此，我们正在讨论的文档和其他要素维护是软件开发中不受欢迎但非常重要的方面。
