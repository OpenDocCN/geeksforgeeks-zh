...
> 原文: [https://www.geeksforgeeks.org/overview-of-defect-clustering/](https://www.geeksforgeeks.org/overview-of-defect-clustering/)

## 缺陷聚类:
当 bug 没有正确地分布在整个应用程序中时，一些少量的特性会导致应用程序中出现与质量相关的主要问题，这就是所谓的缺陷聚类。一系列的罪魁祸首因为缺陷聚集的目的而被纵容。例如遗留代码倾向于破坏最近的特性，这些特性经历了频繁的变化，第三部分集成也参与其中。
