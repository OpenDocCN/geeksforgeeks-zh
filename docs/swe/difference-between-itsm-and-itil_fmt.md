...
> 原文：[https://www.geeksforgeeks.org/difference-between-itsm-and-itil/](https://www.geeksforgeeks.org/difference-between-itsm-and-itil/)

## 1. ITSM

这是一种实际的做法，或者你可以称之为管理不同种类 IT 运营的专业学科。ITSM 代表信息技术服务管理，即与业务需求相匹配的信息技术服务的实施和管理质量。诚然，信息技术将在人类商业中发挥重要作用。计算机、电话、网络和打印机等设备控制由信息技术部门负责。现在，ITSM 不仅是信息技术组织的热点，也是企业绩效的热点。ITSM 软件不再是短期过程。
...
它是 ITSM 的一个基本掩护指导但其提供了最好的实践。ITIL 被认为是安赛乐的注册商标。ITIL 指的是信息技术基础设施库，它是一个框架，旨在规划、交付、选择和维护组织中信息技术服务的整个生命周期。ITIL v2 在服务支持和交付方面采用了适用且统一的结构，并包括业务遵循的原始流程，因为 ITIL v3 将帮助业务部门改进其服务以及每项服务战略的指导方针。
