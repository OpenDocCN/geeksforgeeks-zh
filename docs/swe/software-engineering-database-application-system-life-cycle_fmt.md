...
> 原文: [https://www.geeksforgeeks.org/software-engineering-database-application-system-life-cycle/](https://www.geeksforgeeks.org/software-engineering-database-application-system-life-cycle/)
...
## 7. 操作
数据库系统及其应用投入运行，通常新旧系统并行运行一段时间。

## 8. 监控和维护
系统在运行阶段持续监控和维护。数据内容和软件应用都可能出现增长和扩展。数据库基本需要时不时的修改和识别。
