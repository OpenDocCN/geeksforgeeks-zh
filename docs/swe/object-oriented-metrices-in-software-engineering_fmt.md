...
> 原文：[https://www.geeksforgeeks.org/object-oriented-metrices-in-software-engineering/](https://www.geeksforgeeks.org/object-oriented-metrices-in-software-engineering/)
...
*   `类如千篇一律`：对于结构相同的项目，类是一个模式、模板或蓝图。可以使用类创建的项称为实例。
*   `类作为实例工厂`：基本上类是既包含模式又包含基于该模式创建项目的东西，实例就像使用类创建机制“制造”的单个项目。
