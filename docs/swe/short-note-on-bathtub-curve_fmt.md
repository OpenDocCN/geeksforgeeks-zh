...
正常寿命段简称为通常寿命期或稳态运行期。也可以说这一部分代表了资产的正常运行寿命。通过观察曲线，可以很容易地理解，在这一部分，资产仍然会发生故障，但处于正常且较低的速率。在这一部分中，故障通常是由于过载、隐藏缺陷、与其他物体碰撞、人员失误等造成的。
...
磨损期简称老化期。通过看曲线，很容易理解，在这一节中，资产的失败率随着时间的增加而逐渐增加。资产发生故障的次数通常会随着时间的推移而增加。在这一部分中，故障通常是由于疲劳、磨损、逐渐恶化、腐蚀等而发生的。这个时期仅仅代表资产生命周期的结束。