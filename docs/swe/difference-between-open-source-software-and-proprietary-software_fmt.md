...
> 原文：[`https://www.geeksforgeeks.org/difference-between-open-source-software-and-proprietary-software/`](https://www.geeksforgeeks.org/difference-between-open-source-software-and-proprietary-software/)
...
一些开源软件的例子包括 `Android`、`Ubuntu`、`Firefox`、`OpenOffice` 等。
...
专有软件的一些例子包括 `Windows`、`MacOS`、`Internet Explorer`、`Google Earth`、`Microsoft Office` 等。
...
| 10. | 例如 `Android`、`Linux`、`Firefox`、`OpenOffice`、`GIMP`、`VLC` 媒体播放器等。 | 比如 `Windows`、`MacOS`、`Internet Explorer`、`Google Earth`、`Microsoft Office`、`Adobe Flash Player`、`Skype` 等。 |
```