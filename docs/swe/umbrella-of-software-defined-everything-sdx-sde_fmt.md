...
> 原文: [https://www.geeksforgeeks.org/umbrella-of-software-defined-everything-sdx-sde/](https://www.geeksforgeeks.org/umbrella-of-software-defined-everything-sdx-sde/)
...
*   **软件定义的网络**
    在软件定义的网络(`SDN`)中，网络架构被抽象，以使网络设备可编程。
