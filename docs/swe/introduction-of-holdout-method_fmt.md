...
> 原文: [https://www.geeksforgeeks.org/introduction-of-holdout-method/](https://www.geeksforgeeks.org/introduction-of-holdout-method/)

`保持方法`是评估分类器最简单的方法。在这种方法中，数据集（数据项或例子的集合）被分成两组，称为`训练集`和`测试集`。
