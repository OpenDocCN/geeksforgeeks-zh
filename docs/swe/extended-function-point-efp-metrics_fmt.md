...
> 原文: [https://www.geeksforgeeks.org/extended-function-point-efp-metrics/](https://www.geeksforgeeks.org/extended-function-point-efp-metrics/)
...
| 序号 | 测量参数 | 计数 | * | 简单加权因子 | 平均加权因子 | 复数加权因子 | 计算值 |
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | 外部输入数量 | 32 | * | 3 | 4 | 6 | 128 |
| 2 | 外部产出数量 | 60 | * | 4 | 5 | 7 | 300 |
| 3 | 外部查询数量 | 24 | * | 3 | 4 | 6 | 96 |
| 4 | 内部文件数量(`ILF`) | 8 | * | 7 | 10 | 15 | 80 |
| 5 | 外部接口数量(`EIF`) | 2 | * | 5 | 7 | 10 | 14 |
| 6 | 转换次数 | 23 | * | | | | 23 |
| 7 | 过渡次数 | 32 | * | | | | 32 |
| | 计数-总计 | | | —–> | | | 673 |
...
计算 3D 功能点，通过计算总的计算值来计算。所以，对于 3D 功能点，需要的索引是 673。