...
> 原文：[https://www.geeksforgeeks.org/difference-between-testing-vs-checking/](https://www.geeksforgeeks.org/difference-between-testing-vs-checking/)

测试是一个探索、投资、学习的过程。这是一种发现新信息的技术，执行测试的人被称为测试员。有许多类型的测试，例如：

*   [单元测试](https://www.geeksforgeeks.org/unit-testing-software-testing/)
*   [Alpha 测试](https://www.geeksforgeeks.org/alpha-testing-software-testing/)
...
*   [白盒测试](https://www.geeksforgeeks.org/software-engineering-white-box-testing/) 和 [黑盒测试](https://www.geeksforgeeks.org/software-engineering-black-box-testing/)
