...
> 原文: [https://www.geeksforgeeks.org/difference-between-noops-and-devops/](https://www.geeksforgeeks.org/difference-between-noops-and-devops/)

## 1. NoOps

NoOps 意味着自动部署、监控和管理应用程序。字面意思是没有操作。NoOps 是一个技术环境，通过包括`人工智能`和`机器学习`的技术从底层基础设施实现自动化。
