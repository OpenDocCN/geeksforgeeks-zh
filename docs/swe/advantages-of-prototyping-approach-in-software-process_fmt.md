...
> 原文：[https://www.geeksforgeeks.org/advantages-of-prototyping-approach-in-software-process/](https://www.geeksforgeeks.org/advantages-of-prototyping-approach-in-software-process/)
...
*   当相对容易原型化的软件应用程序总是涉及人机交互（HCI）时，建议使用原型化模型。
