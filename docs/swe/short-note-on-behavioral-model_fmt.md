...
> 原文：`https://www.geeksforgeeks.org/short-note-on-behavioral-model/`
...
1.  **电梯按钮**是电梯上的一组按钮类型。为了到达您想要访问的特定楼层，该特定楼层的“电梯按钮”被按下。按下，将产生照明，电梯将开始向您按下“电梯按钮”的特定楼层移动。一旦电梯到达那个特定的楼层，照明就会被取消。
