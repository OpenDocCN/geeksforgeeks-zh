...
> 原文：[https://www.geeksforgeeks.org/categories-of-software-defect/](https://www.geeksforgeeks.org/categories-of-software-defect/)
...
顾名思义，遗漏的错误是偶然发生的事情。省略一词意味着被遗漏或被执行的东西。这个错误最常见的例子是，假设我们在编程中让一个函数打开它的括号，但最后却忘了关闭。

### 3. 清晰度错误

自然语言中最常见的错误。这个错误的发生是由于开发人员和客户之间缺乏理解。它大部分时间从需求传递到软件。
