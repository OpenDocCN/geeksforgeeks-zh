...
> 原文：[https://www.geeksforgeeks.org/product-metrics-in-software-engineering/](https://www.geeksforgeeks.org/product-metrics-in-software-engineering/)
...
| (3) | 圈复杂度 | 这是对程序控制复杂性的度量。这种控制复杂性可能与程序的可理解性有关。 |
| (4) | 标识符长度 | 这是对程序中不同标识符平均长度的度量。标识符越长，程序越容易理解。 |
| (5) | 条件嵌套的深度 | 这是对程序中 `if` 语句嵌套深度的度量。深度嵌套的 `if` 语句很难理解，并且可能容易出错。 |
