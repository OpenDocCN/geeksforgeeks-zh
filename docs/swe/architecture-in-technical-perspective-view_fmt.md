...
> 原文：[https://www.geeksforgeeks.org/architecture-in-technical-perspective-view/](https://www.geeksforgeeks.org/architecture-in-technical-perspective-view/)
...
*   **Use case view –**
    A use case view is generally used in requirements discipline to provide and give basis for planning technical content of iterations. Using use case diagrams, it is modeled statically, and using UML behavioral diagrams, it is modeled dynamically.
*   **Design View –**
