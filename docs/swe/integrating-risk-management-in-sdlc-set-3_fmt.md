...
> 原文:[https://www.geeksforgeeks.org/integrating-risk-management-in-sdlc-set-3/](https://www.geeksforgeeks.org/integrating-risk-management-in-sdlc-set-3/)
...
### 2. 集成测试活动
集成完组件后，下一步是测试组件接口是否正确，并评估其集成情况。这个过程被称为集成测试。
...
### 3. 系统测试活动
在此步骤中，对集成系统进行测试，以确保其满足从用户处收集的所有系统要求。
...
### 3. 验收测试活动
Delivered system is put into acceptance testing to check whether it meets all user requirements or not.
