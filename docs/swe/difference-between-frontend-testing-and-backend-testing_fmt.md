...
> 原文: [https://www.geeksforgeeks.org/difference-between-frontend-testing-and-backend-testing/](https://www.geeksforgeeks.org/difference-between-frontend-testing-and-backend-testing/)
...
| **例:** 1.`单元测试` 2.`验收测试` | **例:** 1.`SQL测试` 2.`原料药测试` |