...
> 原文：[https://www.geeksforgeeks.org/goal-question-metric-approach-in-software-quality/](https://www.geeksforgeeks.org/goal-question-metric-approach-in-software-quality/)

`GQM` 或目标问题度量方法是一种通过以下方式识别重要且有意义的度量的方法：
...
| 目标 | 目的–评估 对象–编程工具 ABC 问题–T2 观点的有效性–项目经理的观点 |
| :--- | :--- |
