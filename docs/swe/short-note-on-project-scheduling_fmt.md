...
简单来说就是一种机制，用于沟通和了解需要完成或必须执行的任务，哪些组织资源将被给予或分配给这些任务，以及需要在什么时间段或时间框架内执行工作。有效的项目进度安排会导致项目的成功、成本的降低和客户满意度的提高。项目管理中的时间安排意味着列出项目中已交付的活动、可交付成果和里程碑。它包含的笔记比一般的每周计划笔记要多。项目进度最常见和最重要的形式是甘特图。
