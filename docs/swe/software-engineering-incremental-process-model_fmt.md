...
> 原文: [https://www.geeksforgeeks.org/software-engineering-incremental-process-model/](https://www.geeksforgeeks.org/software-engineering-incremental-process-model/)
...
1.  **Staged Delivery Model** – 一次只构建项目的一部分。
    ![](img/a654f5cb47b93b797bd2bc443e25b43a.png)

2.  **Parallel Development Model** – 不同的子系统同时开发。如果有足够的资源，它可以减少开发所需的日历时间，即 TTM（Time to Market）。
