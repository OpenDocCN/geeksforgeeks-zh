...
[缺陷分诊会](https://www.geeksforgeeks.org/defect-triage-meeting/)一般称为解决和修复缺陷。不同的参与者，即测试负责人、项目经理、技术负责人和开发团队负责人是会议的重要参与者。没有他们，就无法做出决定，会议也无法完成。在三个不同的阶段，即会前、会中和会后，缺陷分类会议完成。
