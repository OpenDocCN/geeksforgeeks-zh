...
> 原文: [https://www.geeksforgeeks.org/artifact-software-development/](https://www.geeksforgeeks.org/artifact-software-development/)
...
软件生命周期的工件通常被组织并分成两组，即管理组和工程组。这些集合根据其底层语言进行进一步划分。这些工件集如下图所示：
...
1.  **Requirement Set –**
    ...
    *   需求模型间的一致性分析。
2.  **设计集–**
    可视化建模工具中使用的工具。为了设计设计模型，使用了 [`UML`](https://www.geeksforgeeks.org/unified-modeling-language-uml-introduction/)符号。这个集合仅仅包含许多不同层次的抽象。设计模型通常包括确定材料清单的所有结构和行为数据或信息。这些集合工件主要包括测试模型、设计模型、软件架构描述。
3.  **实现集–**
