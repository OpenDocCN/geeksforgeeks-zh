...
> 原文：[https://www.geeksforgeeks.org/fault-reduction-techniques-in-software-engineering/](https://www.geeksforgeeks.org/fault-reduction-techniques-in-software-engineering/)
...
故障预防、故障排除和容错代表了针对软件系统故障的偶然性及其对系统的影响的连续防线。尽管事实上，每一种技术的好处都是显著的，但是收益递减法则主张它们应该在每一种技术最有效的地方统一使用。