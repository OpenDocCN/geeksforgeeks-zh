...
> 原文：[https://www.geeksforgeeks.org/difference-between-software-and-computer-platform/](https://www.geeksforgeeks.org/difference-between-software-and-computer-platform/)

### 1. `软件`
软件，顾名思义，就是一种告诉或指示计算机做什么和不做什么的软件系统，用于操作计算机和执行一些特定的任务。

### 2. 计算机平台
计算机平台，顾名思义，只是一种环境中的数字平台，用于执行预托管应用程序或软件，被称为计算机的`操作系统`。
...
| 软件类型包括`应用软件`、`免费软件`、`驱动程序`、`开源软件`等。 | 计算机平台的类型包括`大型机`、`个人计算机`、`小型机`等。 |
