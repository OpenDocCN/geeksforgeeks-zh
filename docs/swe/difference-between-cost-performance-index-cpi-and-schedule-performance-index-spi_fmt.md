# 成本绩效指数(CPI)与进度绩效指数(SPI)的差异

> 原文: [https://www.geeksforgeeks.org/difference-between-cost-performance-index-cpi-and-schedule-performance-index-spi/](https://www.geeksforgeeks.org/difference-between-cost-performance-index-cpi-and-schedule-performance-index-spi/)
...
| 如果 `CPI` 小于 1，则项目超出预算。 | 如果 `SPI` 小于 1，则项目落后于计划。 |
| 如果 `CPI` 大于 1，则项目在预算之内。 | 如果 `SPI` 大于 1，则项目提前。 |
| 如果 `CPI` 等于 1，那么项目就在预算范围内。 | 如果 `SPI` 等于 1，则项目按计划进行。 |