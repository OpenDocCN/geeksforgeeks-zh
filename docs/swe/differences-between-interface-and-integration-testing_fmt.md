...
> 原文：[`https://www.geeksforgeeks.org/differences-between-interface-and-integration-testing/`](https://www.geeksforgeeks.org/differences-between-interface-and-integration-testing/)

## 接口测试

接口测试是一种软件测试类型，检查两个不同软件系统之间的正确通信。接口是集成两个组件的连接。接口可以是任何东西，比如应用编程接口、`API`、网络服务等等。这些连接接口的测试被定义为接口测试。
