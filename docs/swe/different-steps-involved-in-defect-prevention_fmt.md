...
> 原文：[https://www.geeksforgeeks.org/different-steps-involved-in-defect-prevention/](https://www.geeksforgeeks.org/different-steps-involved-in-defect-prevention/)
...
2.  **预估预期影响：**
    预估缺陷对成本的预期影响也是缺陷预防的重要一环。每当在系统中遇到缺陷时，出现的主要问题是需要采取什么措施来解决它以及解决它所需的数量。更关键的缺陷是，解决它需要更多的努力和资源。因此，如果缺陷以某种方式遇到或发生，最好估计缺陷对成本的预期影响。之后，应该采取一些措施来尽量减少它们的发生。

3.  **`Minimize Expected Impact`：**
    在识别并评估关键缺陷的影响后，应采取一些措施和行动，在缺陷发生之前将其最小化或永久消除。最小化预期影响也是缺陷预防的重要组成部分。如果无法消除缺陷，则应尝试降低其发生的可能性及其影响。
