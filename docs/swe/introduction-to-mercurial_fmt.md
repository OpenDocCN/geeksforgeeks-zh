...
Mercurial 主要构建在 `Python` 中，这使得它可以跨平台兼容。这也是 Mercurial 主要用作命令行工具的原因之一，尽管也有可用的 GUI 工具。Mercurial 一直是 Adium、Mozilla、Netbeans、Vim、blow 等大品牌使用的版本控制系统。除此之外，许多个人开发人员使用 Mercurial 来管理他们的代码。
