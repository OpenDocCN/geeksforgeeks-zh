...
> 原文：`https://www.geeksforgeeks.org/graph-matrices-in-software-testing/`
...
连接矩阵用于计算控制图的`圈复杂度`。虽然还有其他三种方法可以找到圈复杂度，但是这种方法也很有效。
...
可以看出，所有其他方法都给出相同的结果。方法 1、2 和 3 已经在这里详细讨论过[。](https://www.geeksforgeeks.org/basis-path-testing-in-software-testing/?ref=rp)