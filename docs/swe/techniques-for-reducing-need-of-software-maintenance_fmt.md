...
> 原文：[`https://www.geeksforgeeks.org/techniques-for-reducing-need-of-software-maintenance/`](https://www.geeksforgeeks.org/techniques-for-reducing-need-of-software-maintenance/)
...
重新设计这些系统的一种方法是使用设计模式。设计模式基本上是将成功的和既定的设计实践以及专家的经验结合成一组组件的设计技术，这些组件以更好的结构展示已知的行为。一个例子是面向对象的技术，它被认为可以提高软件开发的成本节约和质量。
