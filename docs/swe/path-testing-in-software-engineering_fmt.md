...
> 原文：[https://www.geeksforgeeks.org/path-testing-in-software-engineering/](https://www.geeksforgeeks.org/path-testing-in-software-engineering/)
...
*   **制作集合：**
    根据控制流图和计算的圈复杂度制作一组所有路径的集合。集合的基数等于计算的圈复杂度。
*   **创建测试用例：**
