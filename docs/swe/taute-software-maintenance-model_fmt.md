...
> 原文：[https://www.geeksforgeeks.org/taut-software-maintenance-model/](https://www.geeksforgeeks.org/taute-software-maintenance-model/)
...
5.  **测试阶段–**
    在此阶段，维护团队确保软件中请求的修改得到正确实施。然后用已经可用的测试用例测试源代码。新的测试用例也可以被设计来进一步测试软件。这种测试被称为`回归测试`。
6.  **文档阶段–**
