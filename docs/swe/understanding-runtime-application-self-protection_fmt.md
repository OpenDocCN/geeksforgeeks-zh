...
> 原文: [https://www.geeksforgeeks.org/understanding-runtime-application-self-protection/](https://www.geeksforgeeks.org/understanding-runtime-application-self-protection/)
...
`RASP` 技术正式是基于服务器的技术，与运行时应用并行工作。可以通过集成 `app` 源代码调用的函数来触发。大多数开发人员更喜欢在代码库中使用触发器调用，这实际上允许根据他们的业务需求构建定制的安全系统。
