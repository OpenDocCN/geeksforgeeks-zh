...
> 原文：[https://www.geeksforgeeks.org/difference-between-mrp-and-drp/](https://www.geeksforgeeks.org/difference-between-mrp-and-drp/)
...
## 2. 配送需求计划(`DRP`)
是物料需求计划(`MRP`)的延伸。这是一个通过确定货物的数量和地点来提高交货效率的过程。
