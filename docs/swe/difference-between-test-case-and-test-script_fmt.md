...
> 原文：[https://www.geeksforgeeks.org/difference-between-test-case-and-test-script/](https://www.geeksforgeeks.org/difference-between-test-case-and-test-script/)
...
| 9. | 测试用例分为`委托测试用例`、`肯定测试用例`、`可重用测试用例`、`否定测试用例`和`用户界面测试用例`。 | 测试脚本分为`手动测试脚本`和`自动化测试脚本`。 |
