...
> 原文：[https://www.geeksforgeeks.org/defect-triage-a-simple-process/](https://www.geeksforgeeks.org/defect-triage-a-simple-process/)
...
*   **被拒绝：**
    如果缺陷报告是重复的，或者分诊团队不能复制问题，或者没有保持正确的缺陷报告格式，那么特定的缺陷分诊报告被拒绝。
*   **确认：**
    如果所有事情都是正确的，那么缺陷报告被确认，并进一步等待解决问题或缺陷。
*   **进行中的开发：**
    在这种情况下，缺陷处于冲刺阶段，即缺陷正在处理中，特别是为了解决和修复缺陷。简单地说，缺陷正在解决中。
*   **Released：**
