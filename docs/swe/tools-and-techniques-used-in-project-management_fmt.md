...
> 原文：[https://www.geeksforgeeks.org/tools-and-techniques-used-in-project-management/](https://www.geeksforgeeks.org/tools-and-techniques-used-in-project-management/)
...
项目管理 simply means to track or control progress and tasks of project. These tools are extension of project planning tools.
...
度量管理工具 are very good for software as they provide very quick and easy way to track [software development](https://www.geeksforgeeks.org/software-development-life-cycle-sdlc/), set goals, and measure performance. These tools help in capturing and finding out specific metrics that are useful and provide overall measure of quality. These tools focus more on process and product characteristics.

例如，“每个功能点的缺陷”、“代码行/人月”。

## 6. 质量保证工具

软件工程中的质量保证 simply means to maintain level of quality of software product by focusing on each step of process of development or production and delivery. It prevents mistakes and any defects or errors in manufactured products.

这些实际上是审核源代码以确保符合语言标准的度量工具。一些用于质量管理计划和控制质量过程的工具是帕累托图、控制图、直方图和散点图等。

## 7. 数据库管理工具

数据库管理 simply means to organize, store, and retrieve data from computer in efficient manner. It provides consistent interfaces for project for all data, in particular, configuration objects are primary repository elements.
