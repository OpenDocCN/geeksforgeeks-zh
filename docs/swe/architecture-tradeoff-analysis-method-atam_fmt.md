...
> 原文: [https://www.geeksforgeeks.org/architecture-tradeoff-analysis-method-atam/](https://www.geeksforgeeks.org/architecture-tradeoff-analysis-method-atam/)
...
3.  **架构利益相关者**
    任何对架构的实现有兴趣并以某种方式与该架构相关的个人、团队或组织都是该架构的利益相关者。利益相关者包括用户、维护者、性能工程师、测试人员、集成人员和开发人员。
...
6.  **分析架构方法**
    每个场景都按照优先级进行比较和评级，然后将评级较高的场景映射到架构上。
7.  **集思广益场景**
    较大的利益相关方群体展示并贡献当前场景及其关注点。
8.  **分析架构方法**
    步骤 6 再次重复，在步骤中增加了来自更大的利益相关者的知识。
9.  **展示结果**
    在评估结束时，团队审查现有和新发现的风险、非风险、敏感点和权衡。团队讨论是否出现了任何新的风险主题。然后，团队将所有文档提供给利益相关者。
