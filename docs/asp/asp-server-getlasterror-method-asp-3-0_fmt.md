...
> 原文: [https://www.geeksforgeeks.org/asp-server-getlasterror-method-asp-3-0/](https://www.geeksforgeeks.org/asp-server-getlasterror-method-asp-3-0/)
...
**注:** 如果 IIS 在处理 ASP 文件或应用程序的 **Global.asa 文件** 时遇到错误，将生成 500;100 个自定义错误。
