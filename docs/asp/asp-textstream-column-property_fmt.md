...
> 原文：[https://www.geeksforgeeks.org/asp-textstream-column-property/](https://www.geeksforgeeks.org/asp-textstream-column-property/)

`ASP` `Column` 属性用于返回文本流文件中当前字符位置的列号。它是只读属性。
