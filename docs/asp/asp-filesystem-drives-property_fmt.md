...
> 原文：[https://www.geeksforgeeks.org/asp-filesystem-drives-property/](https://www.geeksforgeeks.org/asp-filesystem-drives-property/)

`FileSystemObject.Drives` 属性用于返回系统中所有驱动器对象的只读集合。单个的驱动元件可以被砍掉以获得它们的属性。
