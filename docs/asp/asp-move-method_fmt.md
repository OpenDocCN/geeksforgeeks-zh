...
**ASP Move 方法**用于将指定的文件或文件夹移动到给定的目的地。
...
*   **destination:** 它指定文件或文件夹将被移动到的目的地。它不允许通配符。这是必需的参数。

下面的例子演示了 **ASP Move 方法**。

### 示例 1: 下面的代码演示了 ASP File.Move 方法。
...
### 示例 2: 下面的代码演示了 ASP Folder.Move 方法。
