...
> 原文: [https://www.geeksforgeeks.org/p5-js-enqueue-operation-in-queue/](https://www.geeksforgeeks.org/p5-js-enqueue-operation-in-queue/)
...
下面的例子运行使用 `$node skeleton.js` 命令获取基本队列骨架。
...
通过调用 `queue1.enqueue(25)` 将‘25’入队后，后方的入队功能变为 25。
