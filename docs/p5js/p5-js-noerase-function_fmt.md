...
p5.js 中的 `noErase()`功能用于取消 `Erase()`功能的效果。它会将 `fill()`、`stroke()`和 `blendMode()`函数的功能恢复到使用 `erase()`之前的状态。在此功能之后完成的任何绘图都将正常绘制。
...
[https://p5js.org/reference/#/p5/noErase](https://p5js.org/reference/#/p5/noErase)