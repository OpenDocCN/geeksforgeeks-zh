...
> 原文: [https://www.geeksforgeeks.org/p5-js-mediaelement-onended-method/](https://www.geeksforgeeks.org/p5-js-mediaelement-onended-method/)

`p5.js`库中的`MediaElement`对象的`onended()`方法用于调度一个函数，每当音频或视频结束时，就会调用该函数。如果媒体元素正在循环，则不会调用此回调。此媒体元素作为参数传递给回调。
