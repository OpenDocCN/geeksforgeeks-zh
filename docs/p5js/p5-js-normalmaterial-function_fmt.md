...
> 原文: [https://www.geeksforgeeks.org/p5-js-normalmaterial-function/](https://www.geeksforgeeks.org/p5-js-normalmaterial-function/)

`p5.js` 中的 `normalMaterial()` 函数用于为对象创建一个法线材质。正常的材料不受任何光的影响，也不反射任何光。面向 x 轴的表面变为红色，面向 y 轴的表面变为绿色，面向 z 轴的表面变为蓝色。它通常用作调试的占位符材料。
...
[https://p5js.org/reference/#/p5/normalMaterial](https://p5js.org/reference/#/p5/normalMaterial)