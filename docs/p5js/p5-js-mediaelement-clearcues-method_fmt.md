...
> 原文：[https://www.geeksforgeeks.org/p5-js-mediaelement-clearcues-method/](https://www.geeksforgeeks.org/p5-js-mediaelement-clearcues-method/)

`p5.js`库的`MediaElement`的`clearCues()`方法用于清除媒体元素的所有当前已调度的提示，这些提示已经使用`addCue()`方法进行了调度。
...
**示例：** 下面的示例说明了`p5.js`库的`clearCues()`方法。
