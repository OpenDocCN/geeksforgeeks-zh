...
p5.js 中的`vertex()`函数用于指定用于绘制形状的顶点的坐标。只能和`beginShape()`和`endShape()`功能一起使用，制作点、线、三角形、四边形、多边形等各种形状和曲线。
...
**参考:**[https://p5js.org/reference/#/p5/vertex](https://p5js.org/reference/#/p5/vertex)