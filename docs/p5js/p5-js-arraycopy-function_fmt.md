...
p5.js 中的 `arrayCopy()` 函数用于将一部分源数组元素复制到另一个目标数组中。该功能从未来版本中折旧。
...
本示例使用 `arrayCopy()` 函数将源数组元素复制到目标数组。
...
**参考:** [https://p5js.org/reference/#/p5/arrayCopy](https://p5js.org/reference/#/p5/arrayCopy)