...
p5.js 中的 `mousePressed()`函数在鼠标点击文档时工作。`mouseButton`变量用于指定按下哪个按钮。如果未定义`mousePressed()`功能，则使用`touchStarted()`功能代替`mousePressed()`功能。
...
**参考:**[https://p5js.org/reference/#/p5/mousePressed](https://p5js.org/reference/#/p5/mousePressed)