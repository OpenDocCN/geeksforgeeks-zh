...
`line()`函数是 p5.js 中的一个内置函数，用来画线。为了改变线条的颜色，使用了`stroke()`函数，为了改变线条的宽度，使用了`strokeWeight()`函数。
...
本示例使用`line()`函数在不使用 z 坐标的情况下绘制直线。
...
[https://p5js.org/reference/#/p5/line](https://p5js.org/reference/#/p5/line)