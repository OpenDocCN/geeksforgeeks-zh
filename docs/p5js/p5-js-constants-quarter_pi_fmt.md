...
下面的程序说明了 p5.js 中的 `QUARTER_PI` 常数：
...
function draw() {
    ...
    // Display result
    text("Value of QUARTER_PI is " + QUARTER_PI, 30, 150);
}
```
...
[https://p5js.org/reference/#/p5/QUARTER_PI](https://p5js.org/reference/#/p5/QUARTER_PI)