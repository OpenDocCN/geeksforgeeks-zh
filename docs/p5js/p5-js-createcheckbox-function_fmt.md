...
> 原文: [https://www.geeksforgeeks.org/p5-js-createcheckbox-function/](https://www.geeksforgeeks.org/p5-js-createcheckbox-function/)
...
*   `label`：该参数保持复选框旁边显示的标签。
*   `value`：该参数保持复选框的状态（真/假）。
...
**参考：** [https://p5js.org/reference/#/p5/createCheckbox](https://p5js.org/reference/#/p5/createCheckbox)