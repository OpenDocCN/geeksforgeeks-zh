...
`min(a, b)` 函数接受两个参数，这两个参数是两个不同的数字，并进行比较，以获得其中的最小值。`min(arr)` 函数接受单个参数数组。
...
[https://p5js.org/reference/#/p5/min](https://p5js.org/reference/#/p5/min)