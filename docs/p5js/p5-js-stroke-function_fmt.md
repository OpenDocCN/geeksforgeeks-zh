...
`stroke()` 功能用于绘制文字和形状周围的线条和边框。颜色对象可以根据颜色模式按照 RGB 或 HSB 进行设置。颜色对象也可以根据 RGB、RGBA、十六进制 CSS 颜色或命名颜色字符串设置为字符串。
...
**参考:** [https://p5js.org/reference/#/p5/stroke](https://p5js.org/reference/#/p5/stroke)