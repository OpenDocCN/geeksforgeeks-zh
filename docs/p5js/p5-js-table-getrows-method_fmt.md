...
`p5.js` 中的 `Table` 对象的 `getRows()` 方法用于返回对表中所有行的引用，作为一个 `TableRow` 对象的数组。每个返回的行对象都可以用于根据需要获取和设置值。
...
### 参考:
[https://p5js.org/reference/#/p5.Table/getRows](https://p5js.org/reference/#/p5.Table/getRows)