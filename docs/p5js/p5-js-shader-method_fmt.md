...
p5.js 中的`着色器()`函数使得在 `WEBGL` 模式下使用自定义着色器填充形状成为可能。可以使用 `loadShader()` 方法加载自定义着色器，甚至可以对其进行编程以在其上移动图形。
...
**参考:** [https://p5js.org/reference/#/p5/shader](https://p5js.org/reference/#/p5/shader)