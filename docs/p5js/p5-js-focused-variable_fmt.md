...
p5.js 中的`focused`变量用于检查当前窗口或草图是否聚焦。当草图聚焦时，`focused`变量将有一个真值，否则它将是假的。它类似于 CSS 中的 focus 属性。在 p5.js 中，这个变量只给出主窗口或草图的信息。如果用户更改标签或点击检查窗口，它会将变量设置为 false。
...
**参考:**[https://p5js.org/reference/#/p5/focused](https://p5js.org/reference/#/p5/focused)