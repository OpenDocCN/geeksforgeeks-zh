...
除了方向键、Ctrl、Shift、Alt、Backspace 和 Delete 键等操作键之外，每次按下一个键时都会调用 `keyTyped()` 函数。最近键入的键存储在 `key` 变量中。
...
**参考:** [https://p5js.org/reference/#/p5/keyTyped](https://p5js.org/reference/#/p5/keyTyped)