# p5.js | p5.Table clearRows()方法

> 原文: [https://www.geeksforgeeks.org/p5-js-p5-table-clearrows-method/](https://www.geeksforgeeks.org/p5-js-p5-table-clearrows-method/)

`p5.js` 中 `p5.Table` 的 `clearRows()` 方法用于清除表中的所有行。它不影响列及其标题。它可用于清除表，而不影响其列结构。它没有参数。
...
[https://p5js.org/reference/#/p5.Table/clearRows](https://p5js.org/reference/#/p5.Table/clearRows)