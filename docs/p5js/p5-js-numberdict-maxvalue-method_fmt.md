...
> 原文: [https://www.geeksforgeeks.org/p5-js-numberdict-maxvalue-method/](https://www.geeksforgeeks.org/p5-js-numberdict-maxvalue-method/)

p5.js 中的 `NumberDict` 用于查找数字字典中的最高值。一个数字字典可以存储多个键值对。
...
function setup() {
  ...
  getBtn = createButton("Get highest Value");
