...
p5.js 中的 `touchMoved()` 函数在注册了触摸移动时被调用。如果没有定义 `touchMoved()` 函数，如果定义了 `mouseDragged()` 函数，将改为调用该函数。
...
[https://p5js.org/reference/#/p5/touchMoved](https://p5js.org/reference/#/p5/touchMoved)