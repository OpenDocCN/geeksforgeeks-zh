...
p5.js 中的 `sort()`函数用于对数组元素进行排序。如果数组元素是字符串，则按字母顺序排序；如果数组元素是整数，则按升序排序。
...
**参考:**[https://p5js.org/reference/#/p5/sort](https://p5js.org/reference/#/p5/sort)