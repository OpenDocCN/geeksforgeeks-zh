...
p5.js 中的 `asin()`函数用于计算正弦(反正弦)的倒数。如果输入值范围为-1 到 1，则它返回-π/2 到π/2 之间的范围。
...
该函数接受单个参数`value`，该值存储`asin()`函数的定义域。
...
如果值大于 1 或小于-1，则返回`NaN`。

## 参考:

[https://p5js.org/reference/#/p5/asin](https://p5js.org/reference/#/p5/asin)