...
> 原文：[https://www.geeksforgeeks.org/p5-table-getcolumncount-method/](https://www.geeksforgeeks.org/p5-table-getcolumncount-method/)
...
function setup() {
  ...
  removeColBtn = createButton("Clear Last Column");
...
function clearLastColumn() {
  let lastColumn = table.getColumnCount() - 1;
  if (lastColumn >= 0)
...
## 参考：
[https://p5js.org/reference/#/p5.Table/getColumnCount](https://p5js.org/reference/#/p5.Table/getColumnCount)