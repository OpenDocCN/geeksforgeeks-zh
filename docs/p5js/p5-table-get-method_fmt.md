...
`p5.js` 中的 `Table.get()` 方法用于从表的给定行和列中检索值。行可以由行标识指定，列可以由其列标识或列名指定。
...
[https://p5js.org/reference/#/p5.Table/get](https://p5js.org/reference/#/p5.Table/get)