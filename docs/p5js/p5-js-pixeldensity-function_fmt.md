...
p5.js 中的 `pixelDensity()` 功能用于设置高像素密度显示器的像素缩放。像素密度的默认值设置为匹配显示密度。像素密度(1)用于关闭显示密度。不带参数的 `pixelDensity()` 函数返回草图的当前像素密度。
...
**参考:** [https://p5js.org/reference/#/p5/pixelDensity](https://p5js.org/reference/#/p5/pixelDensity)