...
*   `value`：该字符串参数用于设置输入的默认值。
*   `type`：这是一个设置输入类型的字符串参数。它可以有“文本”、“密码”等值，用于接受特定格式的文本。

## 返回值

返回一个指向 p5 的指针。具有创建的节点的元素。
...
[https://p5js.org/reference/#/p5/createInput](https://p5js.org/reference/#/p5/createInput)