...
p5.js 中的 `trim()` 功能用于从输入字符串的开头和结尾移除空白字符和制表符。该功能也用于删除回车和 Unicode `"nbsp"` 字符。
...
该函数接受一个参数 `Strings` 或一个 `Array_of_Strings`，它们将被修剪。
...
[https://p5js.org/reference/#/p5/trim](https://p5js.org/reference/#/p5/trim)