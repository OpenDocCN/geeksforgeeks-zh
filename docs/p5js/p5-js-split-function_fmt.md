...
p5.js 中的 `split()`函数用于使用分隔符将输入字符串分割成多个部分。该分隔符可以是输入字符串各部分之间使用的任何字符串或符号。
...
本示例使用 `split()`函数，使用 delemeter 将输入字符串分解为多个子字符串。
...
**参考:**[https://p5js.org/reference/#/p5/split](https://p5js.org/reference/#/p5/split)