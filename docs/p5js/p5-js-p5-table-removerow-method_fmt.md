...
> 原文: [https://www.geeksforgeeks.org/p5-js-p5-table-removerow-method/](https://www.geeksforgeeks.org/p5-js-p5-table-removerow-method/)

`p5.js` 中 `Table` 对象的 `removeRow()` 方法用于从表中移除给定的行。要删除的行是使用其行标识指定的。
...
**参考:** [https://p5js.org/reference/#/p5.Table/removeRow](https://p5js.org/reference/#/p5.Table/removeRow)