...
> 原文：[https://www.geeksforgeeks.org/how-to-create-seven-segment-clock-using-p5-js-library/](https://www.geeksforgeeks.org/how-to-create-seven-segment-clock-using-p5-js-library/)
...
我们将使用 `Visual Studio Code` 来编写我们的代码，以创建七段显示时钟。
