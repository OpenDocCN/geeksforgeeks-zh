...
p5.js 中的 `year()` 函数用于从系统时钟返回当前年份。它返回一个代表当前年份的整数值。
...
下面的程序说明了 p5.js 中的 `year()` 函数。本示例使用 `year()` 函数从系统时钟返回当前年份。
...
[https://p5js.org/reference/#/p5/year](https://p5js.org/reference/#/p5/year)