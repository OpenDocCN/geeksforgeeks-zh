...
p5.js 中的 `mouseReleased()` 函数在鼠标按钮释放时工作。当没有定义 `mouseReleased()` 函数时，使用 `touchEnded()` 函数代替 `mouseReleased()` 函数。
...
本示例使用 `mouseReleased()` 函数更改鼠标指针颜色。
...
**参考:** [https://p5js.org/reference/#/p5/mouseReleased](https://p5js.org/reference/#/p5/mouseReleased)