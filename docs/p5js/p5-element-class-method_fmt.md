# p5.js Element类的`class()`方法

> 原文：[https://www.geeksforgeeks.org/p5-element-class-method/](https://www.geeksforgeeks.org/p5-element-class-method/)

`p5.js`中的`class()`方法用于设置或返回元素的类。当没有类被指定为参数时，它返回元素的当前类。一个元素可以分配多个类。此外，一个类可以指定给页面上的多个元素。
...
[https://p5js.org/reference/#/p5.Element/class](https://p5js.org/reference/#/p5.Element/class)