...
p5.js 中的 `cone()` 功能用于绘制给定半径和高度的圆锥体。
...
*   `detailY`: 此参数存储 y 维的线段数。
*   `cap`: 此参数存储一个布尔值，指示是否绘制圆锥体的底面。

下面的程序说明了 p5.js 中的 `cone()` 函数：

### 示例 1

本示例使用 `cone()` 函数绘制给定半径和高度的圆锥体。
...
[https://p5js.org/reference/#/p5/cone](https://p5js.org/reference/#/p5/cone)