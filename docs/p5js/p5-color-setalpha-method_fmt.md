# p5.js 颜色 setAlpha() 方法

> 原文: [https://www.geeksforgeeks.org/p5-color-setalpha-method/](https://www.geeksforgeeks.org/p5-color-setalpha-method/)

p5.js 中的 `setAlpha()` 方法用于设置一个 p5 `Color` 对象的 Alpha 分量。alpha 值的范围取决于当前的颜色模式。在默认的 RGB 颜色模式下，该值可以在 0 到 255 之间。
...
**参考:** [https://p5js.org/reference/#/p5.Color/setAlpha](https://p5js.org/reference/#/p5.Color/setAlpha)