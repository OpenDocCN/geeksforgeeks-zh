...
p5 的 `getNum()`方法。p5.js 中的 `Table` 用于从表的给定行和列中检索浮点值。行可以由行标识指定，列可以由其列标识或列名指定。
...
**参考:** [https://p5js.org/reference/#/p5.Table/getNum](https://p5js.org/reference/#/p5.Table/getNum)