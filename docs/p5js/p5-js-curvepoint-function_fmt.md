...
p5.js 中的 `curvePoint()`函数用于计算给定点处曲线的坐标。它获取特定轴的曲线坐标，并在点“t”处找到曲线坐标，该点可以指定为参数。
...
下面的例子说明了 p5.js 中的 `curvePoint()`函数:
...
## 参考:
[https://p5js.org/reference/#/p5/curvePoint](https://p5js.org/reference/#/p5/curvePoint)