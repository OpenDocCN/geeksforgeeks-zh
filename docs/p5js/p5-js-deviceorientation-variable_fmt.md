...
> 原文: [https://www.geeksforgeeks.org/p5-js-deviceorientation-variable/](https://www.geeksforgeeks.org/p5-js-deviceorientation-variable/)

`deviceOrientation` 变量包含设备的方向。代码中该变量的值将设置为 `landscape` 或 `portrait`。它在移动设备中用于检测方向，如果需要，可用于将草图更改为另一个方向。当没有数据可用时，变量将被设置为 `undefined`。
