...
> 原文: `https://www.geeksforgeeks.org/p5-js-setred-function/`

p5.js 中的 `setRed()` 功能用于在 RGB 颜色模式下设置颜色的红色值。它设置 RGB 格式的第一个值。
...
下面的程序说明了 p5.js 中的 `setRed()` 功能。

## 示例-1:

本示例使用 `setRed()` 功能设置 RGB 颜色格式的红色值。
