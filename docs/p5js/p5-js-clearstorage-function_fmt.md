...
p5.js 中的 `clearStorage()` 函数用于使用 `storeItem()` 功能清除本地存储集中的所有项目。当前域的项目将被删除。尝试使用 `getItem()` 函数检索任何项目将返回空值。它不接受任何参数。
...
[https://p5js.org/reference/#/p5/clearStorage](https://p5js.org/reference/#/p5/clearStorage)
...
参考: [https://p5js.org/reference/#/p5/rectMode](https://p5js.org/reference/#/p5/rectMode)