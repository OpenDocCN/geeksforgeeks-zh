...
p5.js 中的 `setGreen()` 函数用于在 RGB 颜色模式下设置颜色的绿色值。它设置 RGB 格式的第二个值。
...
下面的程序说明了 p5.js 中的 `setGreen()` 函数：

### 示例-1

本示例使用 `setGreen()` 函数设置 RGB 颜色格式的绿色值。
...
[https://p5js.org/reference/#/p5.Color/setGreen](https://p5js.org/reference/#/p5.Color/setGreen)