...
> 原文：[https://www.geeksforgeeks.org/p5-js-dom-and-rendering-complete-reference/](https://www.geeksforgeeks.org/p5-js-dom-and-rendering-complete-reference/)

DOM 是一种以结构化分层方式来表示网页的方式，这样程序员和用户将更容易浏览文档。p5.js 中使用的函数如下。

## 数字正射影像图

*   [p5.js `select()`功能](https://www.geeksforgeeks.org/p5-js-select-function/#:~:text=The%20select()%20function%20is,search%20within%20a%20given%20element.)
...
*   [p5.js `changed()`功能](https://www.geeksforgeeks.org/p5-js-changed-function/)
*   [p5.js `input()`功能](https://www.geeksforgeeks.org/p5-js-input-function/#:~:text=The%20input()%20function%20is,event%20listener%20to%20an%20element.)
