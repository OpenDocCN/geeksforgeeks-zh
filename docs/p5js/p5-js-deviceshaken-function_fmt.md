...
**第一步：** 使用任意浏览器在手机上打开 p5.js 的在线网页编辑器 `https://editor.p5js.org/`。
...
**参考：** [https://p5js.org/reference/#/p5/deviceShaken](https://p5js.org/reference/#/p5/deviceShaken)