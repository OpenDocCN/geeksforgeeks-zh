...
p5.js 中的 `lightness()` 函数用于从颜色或像素阵列中提取 HSL 明度值。
...
本示例使用 `lightness()` 函数从像素阵列中提取 HSL 明度值。
...
本示例使用 `lightness()` 函数从像素阵列中提取 HSL 明度值，并将其用作灰度值。
...
[https://p5js.org/reference/#/p5/lightness](https://p5js.org/reference/#/p5/lightness)