...
p5.js 中的 `mouseClicked()`功能在鼠标按键被按下和释放时工作。浏览器可能包含附加到各种鼠标事件的不同默认行为。要防止此事件的默认行为，请在方法的末尾添加`return false`。
...
[https://p5js.org/reference/#/p5/mouseReleased](https://p5js.org/reference/#/p5/mouseReleased)