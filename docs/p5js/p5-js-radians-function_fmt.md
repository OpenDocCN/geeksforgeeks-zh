...
p5.js 中的 `radians()` 函数用于将给定的度数测量值转换为其对应的弧度值。
...
**参数：** 本功能接受单参数 `degrees`，转换为弧度。

**返回值：** 返回角度的转换弧度值。

下面的程序说明了 p5.js 中的 `radians()` 函数：

**示例 1：** 本示例使用 `radians()` 函数将给定度数转换为其对应的弧度。
...
**示例 2：** 本示例使用 `radians()` 函数将给定度数转换为其对应的弧度。
...
**参考：** [https://p5js.org/reference/#/p5/radians](https://p5js.org/reference/#/p5/radians)