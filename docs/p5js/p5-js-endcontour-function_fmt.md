...
p5.js 中的 `endContour()` 函数用于在使用 `beginContour()` 函数创建计数时停止记录顶点。这些函数用于从另一个形状中移除形状的一部分。
...
[https://p5js.org/reference/#/p5/endContour](https://p5js.org/reference/#/p5/endContour)