...
p5.js 中的帧数变量用于保存程序启动后显示的帧数。在`setup()`函数中，该值为 0，在`draw()`的第一次迭代后，该值为 1，以此类推。
...
**参考:**[https://p5js.org/reference/#/p5/frameCount](https://p5js.org/reference/#/p5/frameCount)