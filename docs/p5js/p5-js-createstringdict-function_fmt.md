...
> 原文: [https://www.geeksforgeeks.org/p5-js-createstringdict-function/](https://www.geeksforgeeks.org/p5-js-createstringdict-function/)

`createStringDict()` 函数用于创建 p5.js 的 `StringDict` 实例。数据可以作为键值对单独传递，也可以使用对象作为值的集合给出。
...
下面的程序说明了 p5.js 中的 `createStringDict()` 函数：
