...
该功能接受如上所述的十二个参数，如下所述:

*   `x1` 该参数存储第一个锚点的 x 坐标
*   `y1` 该参数存储第一个锚点的 y 坐标
*   `x2` 该参数存储第一个控制点的 x 坐标
*   `y2` 该参数存储第一个控制点的 y 坐标
*   `x3` 该参数存储第二个控制点的 x 坐标
*   `y3` 该参数存储第二个控制点的 y 坐标
*   `x4` 该参数存储第二个锚点的 x 坐标
*   `y4` 该参数存储第二个锚点的 y 坐标
*   `z1` 该参数存储第一个锚点的 z 坐标
*   `z2` 该参数存储第一个控制点的 z 坐标
*   `z3` 该参数存储第二个控制点的 z 坐标
*   `z4` 该参数存储第二个锚点的 z 坐标
...
本示例使用`bezier()`函数，用所有参数绘制一条 bezier()曲线。
...
[https://p5js.org/reference/#/p5/bezier](https://p5js.org/reference/#/p5/bezier)