...
该功能接受存储曲线分辨率的单参数 `detail`。

下面的程序说明了 p5.js 中的 `bezierDetail()` 函数:

## 示例 1

本示例使用 `bezierDetail()` 函数设置 Beziers 显示的分辨率。
...
[https://p5js.org/reference/#/p5/bezierDetail](https://p5js.org/reference/#/p5/bezierDetail)