...
> 原文: [`https://www.geeksforgeeks.org/p5-js-element-hasclass-method/`](https://www.geeksforgeeks.org/p5-js-element-hasclass-method/)
...
function setup() {
  ...
  setBtn = createButton("Add color class to element");
  setBtn.position(30, 40);
  setBtn.mouseClicked(() => {
    tmpElement.addClass("color");
  });

  removeBtn = createButton("Remove color class from element");
...
[`https://p5js.org/reference/#/p5.Element/hasClass`](https://p5js.org/reference/#/p5.Element/hasClass)