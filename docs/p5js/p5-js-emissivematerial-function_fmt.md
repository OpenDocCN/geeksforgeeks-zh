...
> 原文：[https://www.geeksforgeeks.org/p5-js-emissivematerial-function/](https://www.geeksforgeeks.org/p5-js-emissivematerial-function/)

p5.js 中的 `emissiveMaterial()` 函数用于为给定颜色的几何图形创建发射材料。物体的发射率使它看起来像是在发光。与环境材料或镜面材料不同，即使场景中没有光，发光材料仍会以最大强度显示。
...
*   `color`：是 p5.Color 对象或定义材料颜色的颜色字符串。

## 示例

下面的例子说明了 p5.js 中的 `emissiveMaterial()` 函数。下面的示例表明，无论环境光线如何，发光材料总是会发光。
...
[https://p5js.org/reference/#/p5/emissiveMaterial](https://p5js.org/reference/#/p5/emissiveMaterial)