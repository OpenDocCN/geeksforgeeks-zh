...
> 原文: [https://www.geeksforgeeks.org/p5-js-createnumberdict-function/](https://www.geeksforgeeks.org/p5-js-createnumberdict-function/)

`createNumberDict()`函数用于创建 p5.js 给定数据的 `NumberDict` 实例。数据可以通过键值对单独传递，也可以使用对象作为值的集合给出。
...
**参考:** [https://p5js.org/reference/#/p5/createNumberDict](https://p5js.org/reference/#/p5/createNumberDict)