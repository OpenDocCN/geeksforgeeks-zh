...
p5.js 中的 `key` 变量始终包含最近按下的键的值。为了获得适当的资本化，最好在 `keyPressed()` 中使用。对于非 ASCII 键，使用 `keyCode` 变量。
...
## 参考:
[https://p5js.org/reference/#/p5/key](https://p5js.org/reference/#/p5/key)