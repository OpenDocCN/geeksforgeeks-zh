...
p5.js 中的 `mouseMoved()`函数在每次鼠标移动且没有按下鼠标按钮时被调用。
...
本示例使用 `mouseMoved()`函数在鼠标移动到上方时改变矩形的颜色。
...
**参考:**[https://p5js.org/reference/#/p5/mouseMoved](https://p5js.org/reference/#/p5/mouseMoved)