...
每当按下一个键时，调用`keyReleased()`功能。最近键入的 ASCII 键存储在`key`变量中，但是，它不区分大写和小写字符。非 ASCII 字符可以用它们各自的代码在`keyCode`变量中访问。
...
[https://p5js.org/reference/#/p5/keyReleased](https://p5js.org/reference/#/p5/keyReleased)