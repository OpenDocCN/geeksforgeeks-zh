...
> 原文: [https://www.geeksforgeeks.org/p5-js-ambientmaterial-function/](https://www.geeksforgeeks.org/p5-js-ambientmaterial-function/)

p5.js 中的 `ambientMaterial()` 函数用于为给定颜色的几何图形创建环境材质。环境材质用于定义对象在任何光线下反射的颜色。如果环境材质设置为仅反射红色，而灯光仅反射蓝色，则对象不会反射任何光线。
...
*   `color`: 是 p5.Color 对象或定义环境材质颜色的颜色字符串。
