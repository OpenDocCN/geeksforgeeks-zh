...
> 原文：[https://www.geeksforgeeks.org/p5-js-transform-complete-reference/](https://www.geeksforgeeks.org/p5-js-transform-complete-reference/)

p5.js 变换函数用于将形状或对象变换到指定角度的指定轴上。所有的变换功能如下。

## 改变

*   [`p5.js rotate()`功能](https://www.geeksforgeeks.org/p5-js-rotate-function/#:~:text=The%20rotate()%20function%20in,axis%20over%20a%20specified%20angle.)
...
*   [`p5.js scale()`功能](https://www.geeksforgeeks.org/p5-js-scale-function/)
*   [`p5.js shearX()`功能](https://www.geeksforgeeks.org/p5-js-typography-shearx-function/#:~:text=The%20shearX()%20function%20in,specified%20in%20the%20current%20angleMode.)
*   [`p5.js shearY()`功能](https://www.geeksforgeeks.org/p5-js-typography-sheary-function/)
