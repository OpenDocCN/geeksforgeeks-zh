...
p5.js 中的 `displayWidth` 变量用于存储设备的屏幕显示宽度，它是根据默认的像素宽度。该变量用于在任何显示尺寸上运行全屏程序。将其乘以像素度，返回实际屏幕尺寸。
...
**参考:** [https://p5js.org/reference/#/p5/displayWidth](https://p5js.org/reference/#/p5/displayWidth)