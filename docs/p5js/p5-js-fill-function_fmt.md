...
`fill()`函数用于给形状填充颜色。该函数支持所有类型的颜色对象。例如 RGB，RGBA，十六进制 CSS 颜色，以及所有命名的颜色字符串。颜色对象也可以根据 RGB、RGBA、十六进制 CSS 颜色或命名颜色字符串设置为字符串。
...
**参考:** [https://p5js.org/reference/#/p5/fill](https://p5js.org/reference/#/p5/fill)