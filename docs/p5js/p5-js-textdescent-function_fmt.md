...
下面的例子说明了 p5.js 中的 `textDescent()` 函数:
...
**参考:** [https://p5js.org/reference/#/p5/textDescent](https://p5js.org/reference/#/p5/textDescent)