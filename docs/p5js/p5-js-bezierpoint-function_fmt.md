...
p5.js 中的 `bezierPoint()`函数用于计算给定点处贝塞尔曲线的坐标。它接受特定轴的贝塞尔曲线的坐标，并在“t”点找到曲线的坐标，该点可以指定为参数。
...
[https://p5js.org/reference/#/p5/bezierPoint](https://p5js.org/reference/#/p5/bezierPoint)