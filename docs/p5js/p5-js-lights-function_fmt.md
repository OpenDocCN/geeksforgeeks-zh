...
p5.js 中的 `lights()` 功能用于设置场景中默认的环境光和方向光。使用的默认环境光是 `ambientLight(128, 128, 128)`，方向光是 `directionalLight(128, 128, 128, 0, 0, -1)`。此功能可用于在场景中快速添加默认灯光。
...
**参考:** [https://p5js.org/reference/#/p5/lights](https://p5js.org/reference/#/p5/lights)