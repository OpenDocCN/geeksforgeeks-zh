...
p5.js 中的 `hue()` 函数用于从颜色或像素数组中提取 HSB 和 HSL 色相值。
...
## 示例 1:
本示例使用 `hue()` 函数从颜色或像素阵列中提取 HSB 和 HSL 色相值。
...
## 示例 2:
本示例使用 `hue()` 函数从颜色中提取 HSB 和 HSL 色调值，并将颜色值填充为灰度整数值。
...
## 参考:
[https://p5js.org/reference/#/p5/hue](https://p5js.org/reference/#/p5/hue)