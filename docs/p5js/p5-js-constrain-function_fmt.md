...
p5.js 中的 `constrain()` 函数用于将一个数约束在给定的最小值和最大值之间。
...
*   `high`: 是一个数字，表示该数字被限制的最大极限。

## 返回值

返回一个带有约束值的数字。

下面的例子说明了 p5.js 中的 `constrain()` 函数。
...
[https://p5js.org/reference/#/p5/constrain](https://p5js.org/reference/#/p5/constrain)