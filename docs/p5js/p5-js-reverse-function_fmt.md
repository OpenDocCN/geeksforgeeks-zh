...
p5.js 中的 `reverse()` 功能用于反转给定数组元素的顺序。
...
下面的程序举例说明了 p5.js 中的 `reverse()` 函数。本示例使用 `reverse()` 函数来反转给定数组元素的顺序。
...
function draw() {
    ...
    text("First reversed array is : " + Array3, 50, 30);
    text("Second reversed array is : " + Array4, 50, 50);
}
```
...
[https://p5js.org/reference/#/p5/reverse](https://p5js.org/reference/#/p5/reverse)