...
p5.js 中的 `createVector()`函数用于创建新的 p5 向量，该向量包含大小和方向。这提供了二维或三维向量，特别是几何向量。
...
**参考:**[https://p5js.org/reference/#/p5/createVector](https://p5js.org/reference/#/p5/createVector)