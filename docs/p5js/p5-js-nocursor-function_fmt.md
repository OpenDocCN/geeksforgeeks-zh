...
p5.js 中的 `noCursor()`功能用于隐藏光标使其不可见。
...
下面程序举例说明了 p5.js 中的 `noCursor()`函数：
...
function draw() {
  ...
  text("Position of mouse is " + mouseX + ", " + mouseY, 30, 40);
}
```
...
**参考:** [https://p5js.org/reference/#/p5/noCursor](https://p5js.org/reference/#/p5/noCursor)