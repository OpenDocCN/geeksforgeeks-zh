...
p5.js 中的`height`变量是一个存储绘图画布高度的系统变量。它设置`createCanvas()`函数的第二个参数。
...
## 参考:
[https://p5js.org/reference/#/p5/height](https://p5js.org/reference/#/p5/height)