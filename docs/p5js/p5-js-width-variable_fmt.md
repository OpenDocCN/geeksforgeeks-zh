...
p5.js 中的 `width` 变量是一个系统变量，存储绘图画布的宽度。一旦执行代码，该值将由 `createCanvas()` 函数的第一个参数自动初始化。
...
[https://p5js.org/reference/#/p5/width](https://p5js.org/reference/#/p5/width)