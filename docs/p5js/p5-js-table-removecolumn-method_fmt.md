# p5.js 表格 `removeColumn()` 方法

> 原文: [https://www.geeksforgeeks.org/p5-js-table-removecolumn-method/](https://www.geeksforgeeks.org/p5-js-table-removecolumn-method/)

p5.js 中的 `Table` 对象的 `removeColumn()` 方法用于从表中移除给定的列。要删除的列可以通过使用其标题或索引值（列标识）来指定。
...
*   `column`: 它是一个字符串或数字，表示要删除的列的名称或列标识。
...
[https://p5js.org/reference/#/p5.Table/removeColumn](https://p5js.org/reference/#/p5.Table/removeColumn)