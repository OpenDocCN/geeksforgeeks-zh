...
`quad()`函数是 p5.js 中的一个内置函数，用于绘制四边形。四边形是四边多边形。它的功能是创建一个类似于矩形的形状，但是两条边之间的角度并不局限于 90 度。
...
**参考:** [https://p5js.org/reference/#/p5/quad](https://p5js.org/reference/#/p5/quad)