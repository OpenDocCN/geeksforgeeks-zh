...
> 原文: [https://www.geeksforgeeks.org/p5-js-element-removeclass-method/](https://www.geeksforgeeks.org/p5-js-element-removeclass-method/)

p5 的 `removeClass()` 方法用于移除 p5.js 中元素的指定类。一个元素可以分配多个类。此外，一个类可以指定给页面上的多个元素。
...
下面的示例说明了 p5.js 中的 `removeClass()` 方法。
...
[https://p5js.org/reference/#/p5.Element/removeClass](https://p5js.org/reference/#/p5.Element/removeClass)