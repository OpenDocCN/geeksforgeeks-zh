...
建议在 `preload()` 功能中加载图像，因为加载的图像可能无法立即使用。图像最好从相对路径加载，因为由于浏览器的安全特性，某些浏览器可能会阻止从其他远程位置加载。
...
此示例显示了从 URL 加载图像以及可能发生的两次回调。

```
let img;
let url = 'https://media.geeksforgeeks.org/wp-content/uploads/20190314004249/sample-image.png';
...
**参考:** [https://p5js.org/reference/#/p5/loadImage](https://p5js.org/reference/#/p5/loadImage)