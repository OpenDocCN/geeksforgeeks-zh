...
它和**椭圆**一样，因为圆只是半径相同(半长轴和半短轴相同)的椭圆的特例。
...
## Finding bounding-box of a triangle

Finding bounding-box of a triangle is very similar to finding bounding-box for **line-segment.**
...
## Finding bounding-box of a polygon

A triangle is a polygon, and if we find the **bounding-box of a triangle** then finding bounding-box for polygon shouldn’t be any difficulty. We just have to generalize so that we can have any number of vertices and we are done.
