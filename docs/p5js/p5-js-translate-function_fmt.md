...
p5.js 中的 `translate()` 功能用于指定显示窗口内物体的位移量。`x` 参数用于指定左/右平移，`y` 参数用于指定上/下平移。
...
本示例使用 `translate()` 函数指定在显示窗口内移动对象的量。
...
**参考:** [https://p5js.org/reference/#/p5/translate](https://p5js.org/reference/#/p5/translate)