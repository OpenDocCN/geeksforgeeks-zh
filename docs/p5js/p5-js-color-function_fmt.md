...
`color()`函数用于创建颜色并将其存储到变量中。颜色函数的参数是 RGB 或 HSB 值，具体取决于当前的`colorMode()`函数。`color()`功能的默认模式是从 0 到 255 的 RGB 值。因此，函数`color(255, 204, 0)`将返回亮黄色。
...
**参考:** [https://p5js.org/reference/#/p5/color](https://p5js.org/reference/#/p5/color)