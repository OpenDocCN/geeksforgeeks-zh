...
> 原文: [https://www.geeksforgeeks.org/p5-js-image-getcurrentframe-method/](https://www.geeksforgeeks.org/p5-js-image-getcurrentframe-method/)

`p5.js`库中`p5.Image`的`getCurrentFrame()`方法用于返回当前显示的GIF动画帧的索引。
