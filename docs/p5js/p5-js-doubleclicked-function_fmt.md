# p5.js | doubleClicked() 功能

> 原文: [https://www.geeksforgeeks.org/p5-js-doubleclicked-function/](https://www.geeksforgeeks.org/p5-js-doubleclicked-function/)

每当鼠标或定点设备引起**点击**事件时，就会调用 `doubleClicked()` 功能。当指向设备在单个元素上连续快速单击两次时，就会发生这种情况。`MouseEvent` 回调参数可用于访问单击的详细信息。
...
*   `event`: 这是一个可选的 `MouseEvent` 回调参数。它可用于访问点击详情。

下面的程序说明了 p5.js 中的 `doubleClicked()` 功能:
...
**参考:** [https://p5js.org/reference/#/p5/doubleClicked](https://p5js.org/reference/#/p5/doubleClicked)