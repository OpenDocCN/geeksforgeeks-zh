...
> 原文: [https://www.geeksforgeeks.org/p5-js-exitpointerlock-function/](https://www.geeksforgeeks.org/p5-js-exitpointerlock-function/)

## 功能
`exitPointerLock()`函数退出以前使用的指针锁定。例如，如果指针被锁定，则它解锁指针，反之亦然。它用于退出由`requestPointerLock()`函数调用的指针锁。
...
### 第一步
打开 P5.js 的网页编辑器：`https://editor.p5js.org/`
