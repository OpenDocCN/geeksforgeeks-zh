# numpy.ma.MaskedArray.toflex()函数

> 原文：[https://www.geeksforgeeks.org/numpy-ma-maskedarray-toflex-function-python/](https://www.geeksforgeeks.org/numpy-ma-maskedarray-toflex-function-python/)
...
## 返回值
返回一个新的灵活类型的`ndarray`，有两个字段：第一个元素包含一个值，第二个元素包含对应的掩码布尔值。返回的记录形状与`self.shape`匹配。
