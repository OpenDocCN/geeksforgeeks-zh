...
> 原文: [https://www.geeksforgeeks.org/random-sampling-in-numpy-sample-function/](https://www.geeksforgeeks.org/random-sampling-in-numpy-sample-function/)

`numpy.random.sample()` 是 numpy 中做随机抽样的功能之一。它返回一个指定形状的数组，并在半开间隔 `[0.0, 1.0).` 内用随机浮动填充它。

> **语法:** `numpy.random.sample(size=None)`
>
> **参数:**
