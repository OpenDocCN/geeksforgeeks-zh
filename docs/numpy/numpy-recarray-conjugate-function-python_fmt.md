# Numpy recarray conjugate() 函数 | Python

> 原文: [https://www.geeksforgeeks.org/numpy-recarray-conjugate-function-python/](https://www.geeksforgeeks.org/numpy-recarray-conjugate-function-python/)
...
**语法:**
`numpy.recarray.conjugate(out=None)`
