...
> 原文: [https://www.geeksforgeeks.org/appending-values-at-the-end-of-an-numpy-array/](https://www.geeksforgeeks.org/appending-values-at-the-end-of-an-numpy-array/)
...
> *   `轴`: 我们要沿其插入值的轴。
>
> **返回:** 数组的一个副本，其值按照所提到的对象沿着给定的轴附加在末尾。

## 示例 1: 向 1D 数组追加单个值

对于 1D 数组，使用 `轴` 参数是不必要的，因为默认情况下数组是扁平的。
...
## 示例 2: 在 1D 数组末尾追加另一个数组

您可以将列表或数组传递给 `append` 函数，结果将是相同的。
