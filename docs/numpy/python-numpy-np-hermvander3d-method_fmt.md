...
> 原文: [https://www.geeksforgeeks.org/python-numpy-np-hermvander3d-method/](https://www.geeksforgeeks.org/python-numpy-np-hermvander3d-method/)

借助于`np.hermvander3d()`方法，我们可以从给定度数的埃尔米特级数中得到三维伪范德蒙矩阵。
...
## 例#1
在这个例子中我们可以看到，通过使用`np.hermvander3d()`方法，我们能够得到埃尔米特级数的三维伪范德蒙矩阵。
...
输出:
> [[ 1.000e+00  2.000e+00 -2.000e+00 -4.000e+00 -4.000e+00
>   2.000e+00  4.000e+00  4.000e+00  2.000e+00  4.000e+00  4.000e+00
>   4.000e+00 -8.000e+00 -8.000e+00  4.000e+00  8.000e+00]]
