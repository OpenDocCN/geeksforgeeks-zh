...
> 原文: [https://www.geeksforgeeks.org/numpy-string-operations-lstrip-function/](https://www.geeksforgeeks.org/numpy-string-operations-lstrip-function/)
...
- **`chars`** : 【字符串或 unicode，可选】要删除的字符集。如果省略或无，它将删除空白。`chars` 参数不是前缀或后缀；我们想要剥离的是它的所有价值组合。
