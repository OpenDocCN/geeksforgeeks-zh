...
> 原文: [https://www.geeksforgeeks.org/python-numpy-np-legmul-method/](https://www.geeksforgeeks.org/python-numpy-np-legmul-method/)

`np.legmul()`方法是将一个勒让德级数相乘得到另一个。它返回两个勒让德级数 `c1 * c2` 的乘积。
