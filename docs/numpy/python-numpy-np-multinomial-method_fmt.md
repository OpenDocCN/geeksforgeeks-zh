...
> 原文: [https://www.geeksforgeeks.org/python-numpy-np-multinomial-method/](https://www.geeksforgeeks.org/python-numpy-np-multinomial-method/)

借助`np.multinomial()`方法，可以得到多项式分布的数组。
