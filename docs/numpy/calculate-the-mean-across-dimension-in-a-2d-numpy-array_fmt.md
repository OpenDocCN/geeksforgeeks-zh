...
> 原文: [https://www.geeksforgeeks.org/calculate-the-mean-across-dimension-in-a-2d-numpy-array/](https://www.geeksforgeeks.org/calculate-the-mean-across-dimension-in-a-2d-numpy-array/)

我们可以通过函数 `np.mean()` 使用 numpy 求出 2d 数组的每一行和每一列的平均值。这里我们必须提供寻找平均值的轴。
