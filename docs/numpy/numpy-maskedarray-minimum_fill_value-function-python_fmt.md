# numpy.MaskedArray.minimum_fill_value() 函数

> 原文：[https://www.geeksforgeeks.org/numpy-maskedarray-minimum_fill_value-function-python/](https://www.geeksforgeeks.org/numpy-maskedarray-minimum_fill_value-function-python/)
...
- **obj**：类数组、数据类型或标量。返回最大填充值的数组数据类型或标量。
