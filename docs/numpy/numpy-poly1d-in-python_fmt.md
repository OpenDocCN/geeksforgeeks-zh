...
- `arr`: 【array_like】多项式系数按幂的递减顺序给出。如果第二个参数(根)设置为真，那么数组值就是多项式方程的根。
- `root`: 【bool，可选】`True` 表示多项式根。默认值为假。
...
`poly1d(3, 2, 6)` = 3x<sup>2</sup>+2x+6
`poly1d([1, 2, 3], True)` = (x-1)(x-2)(x-3) = x<sup>3</sup>–6x<sup>2</sup>+11x-6
