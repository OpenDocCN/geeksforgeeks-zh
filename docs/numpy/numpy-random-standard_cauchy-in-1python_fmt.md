...
> 原文: [https://www.geeksforgeeks.org/numpy-random-standard_cauchy-in-1python/](https://www.geeksforgeeks.org/numpy-random-standard_cauchy-in-1python/)

借助`numpy.random.standard_cauchy()`方法，我们可以看到从一个标准的 Cauchy 分布中得到随机样本并返回随机样本。
...
在这个例子中我们可以看到，通过使用`numpy.random.standard_cauchy()`方法，我们能够获得标准 Cauchy 分布的随机样本，并从中生成随机样本。
