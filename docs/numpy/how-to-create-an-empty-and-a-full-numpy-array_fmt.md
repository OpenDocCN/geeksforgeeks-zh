...
> 原文: [https://www.geeksforgeeks.org/how-to-create-an-empty-and-a-full-numpy-array/](https://www.geeksforgeeks.org/how-to-create-an-empty-and-a-full-numpy-array/)

有时需要为一个特定的问题同时创建一个空数组和一个满数组。在这种情况下，我们有两个函数命名为 `numpy.empty()` 和 `numpy.full()` 来创建一个空数组和一个满数组。
