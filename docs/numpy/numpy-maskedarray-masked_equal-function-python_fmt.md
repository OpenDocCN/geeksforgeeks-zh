# Numpy maskedarray . masked_equal()函数 | Python

> 原文: [https://www.geeksforgeeks.org/numpy-maskedarray-masked_equal-function-python/](https://www.geeksforgeeks.org/numpy-maskedarray-masked_equal-function-python/)
