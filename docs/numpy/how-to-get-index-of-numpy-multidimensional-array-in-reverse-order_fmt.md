...
> 原文：[https://www.geeksforgeeks.org/how-to-get-index-of-numpy-multidimensional-array-in-reverse-order/](https://www.geeksforgeeks.org/how-to-get-index-of-numpy-multidimensional-array-in-reverse-order/)
...
对于布尔数据，我们有相同的方法，但是由于它只有 0 或 1 作为值，我们可以使用 [`argmax()`](https://www.geeksforgeeks.org/numpy-argmax-python/) 来找到最高值的索引（对于 `axis=1` 的每一行）。因为真等于 1，假等于 0，所以它会记录第一个真值的索引。
