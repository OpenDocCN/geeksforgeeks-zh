...
> 原文: [https://www.geeksforgeeks.org/how-to-delete-last-n-rows-from-numpy-array/](https://www.geeksforgeeks.org/how-to-delete-last-n-rows-from-numpy-array/)
...
## 方法二: 使用 `numpy.delete()` 方法

它用于根据行号删除 NumPy 数组中的元素。

> **语法:** `numpy.delete(array_name, [rownumber1, rownumber2, ..., rownumbern], axis)`
> **参数:**
> *   `array_name` 是数组的名称。
> *   行号是行值
> *   `axis` 指定的行或列
