...
> 原文: [https://www.geeksforgeeks.org/numpy-ndarray-nbytes-method-python/](https://www.geeksforgeeks.org/numpy-ndarray-nbytes-method-python/)

`numpy.ndarray.nbytes()` 函数返回数组元素消耗的总字节数。

> **语法:** `numpy.ndarray.nbytes(arr)`
>
> **参数:**
> `arr` : 【阵 _ 象】输入阵。
>
