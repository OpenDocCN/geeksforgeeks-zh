...
> 原文: [https://www.geeksforgeeks.org/differences-flatten-ravel-numpy/](https://www.geeksforgeeks.org/differences-flatten-ravel-numpy/)

我们有两种类似的方法将数组转换成 1D 数组: `flatten()` 和 `ravel()`
