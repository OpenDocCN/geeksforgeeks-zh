...
> 原文: [https://www.geeksforgeeks.org/numpy-random-dirichlet-in-python/](https://www.geeksforgeeks.org/numpy-random-dirichlet-in-python/)

借助 `dirichlet()` 方法，我们可以从狄利克雷分布中得到随机样本，并利用这种方法返回一些随机样本的 numpy 数组。
