...
>
> **参数：**
> - `number`：输入数字。只有整数十进制数可以用作输入。
> - `base`：【int，可选】将数字转换为的进制系统。有效范围为 2-36，默认值为 2。
> - `padding`：【int，可选】在左边添加零的个数。默认值为 0。
>
> **返回：** 进制系统中输入数字的字符串表示。
