...
> 原文：[https://www.geeksforgeeks.org/how-to-get-the-floor-ceiling-and-truncated-values-of-the-elements-of-a-numpy-array/](https://www.geeksforgeeks.org/how-to-get-the-floor-ceiling-and-truncated-values-of-the-elements-of-a-numpy-array/)
...
小于或等于 `x` 的最大整数，其中 `x` 是数组元素，称为 floor 值。可以使用函数 [`numpy.floor()`](https://www.geeksforgeeks.org/numpy-floor-python/) 找到。
