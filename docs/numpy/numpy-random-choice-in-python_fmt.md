...
> 原文: [https://www.geeksforgeeks.org/numpy-random-choice-in-python/](https://www.geeksforgeeks.org/numpy-random-choice-in-python/)
...
> **参数:**
>
> **1)** `a` - 具有随机样本的一维 numpy 阵列。
>
> **2)** `size` – numpy 阵列随机样本的输出形状。
>
> **3)** `replace` – 样品是否更换。
>
> **4)** `p` – `a` 中每个样本的概率
