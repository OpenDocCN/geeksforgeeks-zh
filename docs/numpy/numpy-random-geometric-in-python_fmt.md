# Python 中的 `numpy.random.geometric()`

> 原文: [https://www.geeksforgeeks.org/numpy-random-geometric-in-python/](https://www.geeksforgeeks.org/numpy-random-geometric-in-python/)
