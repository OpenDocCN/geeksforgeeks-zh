...
> 原文：`https://www.geeksforgeeks.org/python-numpy-np-hermfit-method/`

借助`np.hermfit()`方法，可以得到埃尔米特级数的最小二乘拟合。
...
在这个示例中，我们可以看到，通过使用`np.hermfit()`方法，我们能够获得给定数据的埃尔米特级数的最小二乘拟合。
...
> [4.00000000e+00 5.0000000e-01 1.56777498e-16]
