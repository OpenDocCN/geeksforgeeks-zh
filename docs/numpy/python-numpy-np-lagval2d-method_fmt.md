...
> 原文: [https://www.geeksforgeeks.org/python-numpy-np-lagval2d-method/](https://www.geeksforgeeks.org/python-numpy-np-lagval2d-method/)

借助`np.lagval2d()`方法，可以得到 x 点的二维拉盖尔级数。
