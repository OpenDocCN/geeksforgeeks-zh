...
> 原文: [https://www.geeksforgeeks.org/numpy-string-operations-swapcase-function/](https://www.geeksforgeeks.org/numpy-string-operations-swapcase-function/)
...
## 返回
[`ndarray`] 输出字符串或 unicode 的低位数组，具体取决于输入类型。
