...
> 原文: [https://www.geeksforgeeks.org/python-numpy-np-hermdiv-method/](https://www.geeksforgeeks.org/python-numpy-np-hermdiv-method/)

借助`np.hermdiv()`方法，可以得到两个厄米级数的除法。
