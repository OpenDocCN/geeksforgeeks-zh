...
- **数组**: *array_like* 元素以弧度为单位。
  2pi 弧度 = 360 度

## 返回

所有 `x` 的双曲正切为 `x` 的数组，即数组元素。
...
[https://docs.scipy.org/doc/numpy-dev/reference/generated/numpy.tanh.html#numpy.tanh](https://docs.scipy.org/doc/numpy-dev/reference/generated/numpy.tanh.html#numpy.tanh)