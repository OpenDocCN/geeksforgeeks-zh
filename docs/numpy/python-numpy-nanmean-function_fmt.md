...
> 原文: [https://www.geeksforgeeks.org/python-numpy-nanmean-function/](https://www.geeksforgeeks.org/python-numpy-nanmean-function/)
...
- `keepdims`: 如果设置为真，缩小的轴将作为尺寸为 1 的尺寸留在结果中。使用此选项，结果将会正确地广播到原始 `a` 中。
