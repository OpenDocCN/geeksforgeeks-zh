# Python | Numpy NP.assert_array_almost_equal()方法

> 原文: [https://www.geeksforgeeks.org/python-numpy-np-assert_array_almost_equal-method/](https://www.geeksforgeeks.org/python-numpy-np-assert_array_almost_equal-method/)
