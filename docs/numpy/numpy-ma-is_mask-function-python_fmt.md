...
> 原文: [`https://www.geeksforgeeks.org/numpy-ma-is_mask-function-python/`](https://www.geeksforgeeks.org/numpy-ma-is_mask-function-python/)
...
## 返回
【bool】如果 `m.dtype.type` 为 `MaskType`，则返回 `True`，否则返回 `False`。
