# `numpy.ma.masked_invalid()` 函数

> 原文: [https://www.geeksforgeeks.org/numpy-maskedarray-masked_invalid-function-python/](https://www.geeksforgeeks.org/numpy-maskedarray-masked_invalid-function-python/)
