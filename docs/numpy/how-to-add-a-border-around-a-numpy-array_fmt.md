...
> 原文：[https://www.geeksforgeeks.org/how-to-add-a-border-around-a-numpy-array/](https://www.geeksforgeeks.org/how-to-add-a-border-around-a-numpy-array/)

有时我们需要在 NumPy 矩阵周围添加边框。Numpy 提供了一个名为 `numpy.pad()` 的函数来构造边框。下面的例子展示了如何在身份矩阵周围构建“0”的边界。
