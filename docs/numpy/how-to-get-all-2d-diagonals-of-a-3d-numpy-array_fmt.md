...
> 原文: [https://www.geeksforgeeks.org/how-to-get-all-2d-diagonals-of-a-3d-numpy-array/](https://www.geeksforgeeks.org/how-to-get-all-2d-diagonals-of-a-3d-numpy-array/)

让我们来看看获取三维 NumPy 数组的所有 2D 对角线的程序。所以，为此我们使用了 `numpy.diagonal()` 功能的 numpy 库。这个函数从 n 维数组中返回指定的对角线。
