...
> 原文: [https://www.geeksforgeeks.org/python-numpy-polynomial-legline-method/](https://www.geeksforgeeks.org/python-numpy-polynomial-legline-method/)

`np.legline()`方法求一个**勒让德级数**，其图形为直线。
