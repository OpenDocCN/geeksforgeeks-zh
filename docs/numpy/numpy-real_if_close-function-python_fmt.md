...
> 原文: [https://www.geeksforgeeks.org/numpy-real_if_close-function-python/](https://www.geeksforgeeks.org/numpy-real_if_close-function-python/)
...
> **参数:**
> `arr` : 【阵 _ 象】输入阵。
> `tol` : 【浮动】“接近零”定义为公差。数组中元素复杂部分的机器公差。
>
