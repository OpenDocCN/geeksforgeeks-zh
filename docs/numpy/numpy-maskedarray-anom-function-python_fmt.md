# NumPy MaskedArray.anom() 函数

> 原文: [https://www.geeksforgeeks.org/numpy-maskedarray-anom-function-python/](https://www.geeksforgeeks.org/numpy-maskedarray-anom-function-python/)
...
>
> **参数:**
> `axis`: 【int 或 None】异常所在的轴。
> `dtype`: 【数据类型，可选】用于计算方差的类型。
>
> **返回:** 【ndarray】一组异常。
