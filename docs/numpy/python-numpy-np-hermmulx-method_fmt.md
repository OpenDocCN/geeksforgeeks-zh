...
> 原文: [https://www.geeksforgeeks.org/python-numpy-np-hermmulx-method/](https://www.geeksforgeeks.org/python-numpy-np-hermmulx-method/)

借助`np.hermmulx()`方法，我们可以得到 Hermite 级数与 `x` 的乘积，其中 `x` 为自变量。
