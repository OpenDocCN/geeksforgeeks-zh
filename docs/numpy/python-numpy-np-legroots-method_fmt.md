...
> 原文: [https://www.geeksforgeeks.org/python-numpy-np-legroots-method/](https://www.geeksforgeeks.org/python-numpy-np-legroots-method/)
...
- `c`: 【array_like】勒让德级数系数的一维数组。

## 返回

- 【ndarray】系列根的数组。如果所有的根都是真实的，那么出来也是真实的，否则就是复杂的。
