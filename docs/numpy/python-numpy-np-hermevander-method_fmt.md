...
> 原文: [https://www.geeksforgeeks.org/python-numpy-np-hermevander-method/](https://www.geeksforgeeks.org/python-numpy-np-hermevander-method/)

借助`np.hermevander()`方法，可以得到给定度数下的伪范德蒙矩阵。
