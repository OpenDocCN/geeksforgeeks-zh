...
> 原文: [https://www.geeksforgeeks.org/find-the-union-of-two-numpy-arrays/](https://www.geeksforgeeks.org/find-the-union-of-two-numpy-arrays/)

为了找到两个一维数组的并集，我们可以使用 Python Numpy 库的函数 `numpy.union1d()`。它返回唯一的排序数组，其值位于两个输入数组中的任何一个中。
