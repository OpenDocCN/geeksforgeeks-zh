# Python NumPy `chebvander2d()` 方法

> 原文：[https://www.geeksforgeeks.org/python-numpy-np-chebvander2d-method/](https://www.geeksforgeeks.org/python-numpy-np-chebvander2d-method/)
...
返回大小为 `array.size + (degree + 1)` 的 2D 矩阵。
