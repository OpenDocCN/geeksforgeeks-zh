...
> 原文: [https://www.geeksforgeeks.org/element-wise-concatenation-of-two-numpy-arrays-of-string/](https://www.geeksforgeeks.org/element-wise-concatenation-of-two-numpy-arrays-of-string/)
...
first_name = np.array(['Geeks'], dtype = np.str)
print("Printing first name array:")
print(first_name)

# creating array as last name
last_name = np.array(['forGeeks'], dtype = np.str)
...
# creating array as first_name
first_name = np.array(['Akash', 'Ayush', 'Diksha', 'Radhika'], dtype = np.str)
print("Printing first name array:")
print(first_name)

# creating array as last name
last_name = np.array(['Kumar', 'Sharma', 'Tewari', 'Pegowal'], dtype = np.str)
print("Printing last name array:")
print(last_name)
