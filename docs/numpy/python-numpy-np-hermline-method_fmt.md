...
> 原文: [https://www.geeksforgeeks.org/python-numpy-np-hermline-method/](https://www.geeksforgeeks.org/python-numpy-np-hermline-method/)

借助`np.hermline()`方法，可以得到埃尔米特级数指定的直线。
