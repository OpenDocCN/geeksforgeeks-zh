# NumPy MaskedArray.transpose() 函数 | Python

> 原文: [https://www.geeksforgeeks.org/numpy-maskedarray-transpose-function-python/](https://www.geeksforgeeks.org/numpy-maskedarray-transpose-function-python/)
...
**语法:**
`numpy.ma.transpose(axis)`

**参数:**
- `axis`: 【整数列表，可选】默认情况下，反转尺寸，否则根据给定值排列轴。
