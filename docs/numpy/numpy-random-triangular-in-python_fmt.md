# Python 中的 `numpy.random.triangular()`

> 原文: [https://www.geeksforgeeks.org/numpy-random-triangular-in-python/](https://www.geeksforgeeks.org/numpy-random-triangular-in-python/)
