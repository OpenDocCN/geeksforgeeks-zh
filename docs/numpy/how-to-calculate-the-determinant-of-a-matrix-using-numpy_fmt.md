...
> 原文: [https://www.geeksforgeeks.org/how-to-calculate-the-determinant-of-a-matrix-using-numpy/](https://www.geeksforgeeks.org/how-to-calculate-the-determinant-of-a-matrix-using-numpy/)
...
## 示例 1：使用 `numpy.linalg.det()` 函数计算 2X2 `NumPy` 矩阵的行列式
