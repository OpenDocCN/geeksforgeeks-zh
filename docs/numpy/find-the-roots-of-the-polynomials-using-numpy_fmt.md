...
> 原文：[https://www.geeksforgeeks.org/find-the-roots-of-the-polynomials-using-numpy/](https://www.geeksforgeeks.org/find-the-roots-of-the-polynomials-using-numpy/)
...
>
> **参数：**
> **p：** 【array_like】Rank-1 多项式系数数组。
>
> **返回：** 【ndarray】包含多项式根的数组。

让我们看一些例子：

### 例 1：求多项式 x<sup>2</sup> +2x + 1 的根
...
### 例 2：求多项式 x<sup>3</sup> +3 x<sup>2</sup> + 2x +1 的根
...
例如，对于多项式 x<sup>2</sup> +3x + 1，数组将是 `[1, 3, 1]`
