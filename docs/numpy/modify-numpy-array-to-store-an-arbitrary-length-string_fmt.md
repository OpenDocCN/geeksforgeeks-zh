...
> 原文: [https://www.geeksforgeeks.org/modify-numpy-array-to-store-an-arbitrary-length-string/](https://www.geeksforgeeks.org/modify-numpy-array-to-store-an-arbitrary-length-string/)
...
**解决方案:** 创建数组时，为其分配 `'object'` 数据类型。这让您拥有 python 字符串的所有行为。
