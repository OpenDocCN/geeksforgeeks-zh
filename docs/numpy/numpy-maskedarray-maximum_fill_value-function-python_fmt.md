# Numpy MaskedArray.maximum_fill_value() 函数 | Python

> 原文：[https://www.geeksforgeeks.org/numpy-maskedarray-maximum_fill_value-function-python/](https://www.geeksforgeeks.org/numpy-maskedarray-maximum_fill_value-function-python/)
...
## 参数
- `obj`：【ndarray、dtype 或标量】返回最小填充值的数组、数据类型或标量。
