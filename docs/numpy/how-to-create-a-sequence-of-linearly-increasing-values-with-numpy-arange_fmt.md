...
> 原文: [https://www.geeksforgeeks.org/how-to-create-a-sequence-of-linearly-increasing-values-with-numpy-arange/](https://www.geeksforgeeks.org/how-to-create-a-sequence-of-linearly-increasing-values-with-numpy-arange/)
...
> **语法:** `numpy.arange(开始, 停止, 步进)`
>
> **参数:**
>
> *   `开始` 是起始值
> *   `停止` 是结束值
> *   `步进` 是给定范围内的线性增量值。它是可选的。默认情况下，它是 1。
>
> **返回类型:**
>
> *   返回元素数组
