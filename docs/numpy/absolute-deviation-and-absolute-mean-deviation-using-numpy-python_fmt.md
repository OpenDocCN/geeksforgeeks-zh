...
> 原文：[https://www.geeksforgeeks.org/absolute-deviation-and-absolute-mean-deviation-using-numpy-python/](https://www.geeksforgeeks.org/absolute-deviation-and-absolute-mean-deviation-using-numpy-python/)
...
## 绝对偏差
数据集中某个元素的绝对偏差是该元素与给定点之间的绝对差值。观测值 `X1`，`X2`，`X3`，…，`Xn` 围绕值 `A` 的绝对偏差定义为：
