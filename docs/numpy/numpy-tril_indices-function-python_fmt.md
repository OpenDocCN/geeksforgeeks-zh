# numpy.tril_indices() 函数 | Python

> 原文: [https://www.geeksforgeeks.org/numpy-tril_indices-function-python/](https://www.geeksforgeeks.org/numpy-tril_indices-function-python/)

## `numpy.tril_indices()` 函数
