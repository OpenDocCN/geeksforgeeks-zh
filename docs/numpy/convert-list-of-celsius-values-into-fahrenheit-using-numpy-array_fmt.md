...
> 原文: [https://www.geeksforgeeks.org/convert-list-of-celsius-values-into-fahrenheit-using-numpy-array/](https://www.geeksforgeeks.org/convert-list-of-celsius-values-into-fahrenheit-using-numpy-array/)

让我们看看如何通过将摄氏温度列表转换成华氏温度来将其转换成 NumPy 数组。
将 Celsius 转换为 Fahrenheit 的公式为:
