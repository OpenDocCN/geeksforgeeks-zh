# Numpy MaskedArray `masked_outside()` 函数 | Python

> 原文: [https://www.geeksforgeeks.org/numpy-maskedarray-masked_outside-function-python/](https://www.geeksforgeeks.org/numpy-maskedarray-masked_outside-function-python/)
