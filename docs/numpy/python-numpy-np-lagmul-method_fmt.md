...
> 原文: [https://www.geeksforgeeks.org/python-numpy-np-lagmul-method/](https://www.geeksforgeeks.org/python-numpy-np-lagmul-method/)

`np.lagmul()`方法是将一个`拉盖尔级数`相乘得到另一个。它返回两个`拉盖尔级数`和`c1 * c2`的乘积。
