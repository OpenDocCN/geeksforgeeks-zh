# NumPy recarray.flatten() 函数

> 原文: [https://www.geeksforgeeks.org/numpy-recarray-flatten-function-python/](https://www.geeksforgeeks.org/numpy-recarray-flatten-function-python/)
...
- `'A'`的意思是，如果数组在内存中是 Fortran 连续的，则按列主顺序展平，否则按行主顺序展平。
