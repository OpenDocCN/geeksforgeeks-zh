...
> 原文: [https://www.geeksforgeeks.org/numpy-matrix-operations-empty-function/](https://www.geeksforgeeks.org/numpy-matrix-operations-empty-function/)
...
**参数:**
- `shape`: 【int 或 int 的元组】所需输出空矩阵的形状。
- `dtype`: 【可选】所需输出数据类型。
