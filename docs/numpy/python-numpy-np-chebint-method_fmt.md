...
> 原文：[`https://www.geeksforgeeks.org/python-numpy-np-chebint-method/`](https://www.geeksforgeeks.org/python-numpy-np-chebint-method/)

借助`np.chebint()`方法，我们可以得到具有坐标值的阵列形式的切比雪夫级数的积分值。
