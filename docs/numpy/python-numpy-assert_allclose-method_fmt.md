...
> 原文: [https://www.geeksforgeeks.org/python-numpy-assert_allclose-method/](https://www.geeksforgeeks.org/python-numpy-assert_allclose-method/)

借助 `numpy.assert_allclose()` 方法，可以得到两个数组对象不相等时的断言错误。
