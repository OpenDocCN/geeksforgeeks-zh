...
> 原文：[https://www.geeksforgeeks.org/find-indices-of-elements-equal-to-zero-in-a-numpy-array/](https://www.geeksforgeeks.org/find-indices-of-elements-equal-to-zero-in-a-numpy-array/)

有时我们需要找出数组中所有空元素的索引。Numpy提供了许多函数来计算所有空元素的索引。

## 方法1：使用`numpy.where()`查找空元素的索引
...
## 方法2：使用`numpy.argwhere()`查找空元素的索引
