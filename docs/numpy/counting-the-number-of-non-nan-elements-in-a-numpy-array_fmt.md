...
> 原文：[https://www.geeksforgeeks.org/counting-the-number-of-non-nan-elements-in-a-numpy-array/](https://www.geeksforgeeks.org/counting-the-number-of-non-nan-elements-in-a-numpy-array/)
...
*   `np.isnan(data)`: 对数组的条目执行 `np.isnan()` 操作后返回一个布尔数组。
