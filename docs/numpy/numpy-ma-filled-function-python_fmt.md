...
> 原文: [https://www.geeksforgeeks.org/numpy-ma-filled-function-python/](https://www.geeksforgeeks.org/numpy-ma-filled-function-python/)
...
>
> **参数:**
> **arr:** 【`MaskedArray` 或 `array_like`】一个输入对象。
