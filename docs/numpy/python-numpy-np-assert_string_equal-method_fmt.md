...
> 原文: [https://www.geeksforgeeks.org/python-numpy-np-assert_string_equal-method/](https://www.geeksforgeeks.org/python-numpy-np-assert_string_equal-method/)

借助`np.assert_string_equal()`方法，可以得到两个字符串不相等时的断言错误。
