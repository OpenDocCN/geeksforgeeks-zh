...
> 原文: [https://www.geeksforgeeks.org/get-the-qr-factorization-of-a-given-numpy-array/](https://www.geeksforgeeks.org/get-the-qr-factorization-of-a-given-numpy-array/)

在本文中，我们将讨论矩阵的`QR分解`。矩阵的二维码分解是将一个矩阵分解成“A = QR”，其中 Q 是正交的，R 是上三角矩阵。我们使用`numpy.linalg.qr()`函数分解矩阵。
