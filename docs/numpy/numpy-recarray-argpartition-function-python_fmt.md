...
> 原文: [https://www.geeksforgeeks.org/numpy-recarray-argpartition-function-python/](https://www.geeksforgeeks.org/numpy-recarray-argpartition-function-python/)
...
- `axis`:【int 或 None】要排序的轴。如果为“无”，则数组在排序前被展平。默认值为-1，沿最后一个轴排序。
