...
> 原文：`https://www.geeksforgeeks.org/how-to-skip-every-nth-index-of-numpy-array/`
...
这里，`开始`是起始索引，`结束`是停止索引，`步长`是步长，步长不等于 0。并且，它返回一个包含分别属于 `步长` 索引的元素的子数组。假设数组的索引从 0 开始。
