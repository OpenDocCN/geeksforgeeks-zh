# numpy.iscomplexobj()在Python中的使用

> 哎哎哎:# t0]https://www . geeksforgeeks . org/num py-isccomplexixobj-python/

## 函数描述

`numpy.iscomplexobj(array)`：这个逻辑函数有助于检查数组或复数数组的复杂类型。即使虚部等于零，它也被认为是一个复杂对象。
...
[https://docs.scipy.org/doc/numpy-1.13.0/reference/generated/numpy.iscomplexobj.html#numpy.iscomplexobj](https://docs.scipy.org/doc/numpy-1.13.0/reference/generated/numpy.iscomplexobj.html#numpy.iscomplexobj)