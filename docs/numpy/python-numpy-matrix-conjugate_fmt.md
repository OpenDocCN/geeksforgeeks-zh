...
> 原文: [https://www.geeksforgeeks.org/python-numpy-matrix-conjugate/](https://www.geeksforgeeks.org/python-numpy-matrix-conjugate/)

借助于`matrix.conjugate()`方法，我们能够找到具有一维或一维以上的给定矩阵的**共轭**。
