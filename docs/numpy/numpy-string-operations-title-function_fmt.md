...
> 原文: [https://www.geeksforgeeks.org/numpy-string-operations-title-function/](https://www.geeksforgeeks.org/numpy-string-operations-title-function/)
...
**返回值：** 根据输入类型，返回字符串或 unicode 的输出数组。
