...
> 原文: [https://www.geeksforgeeks.org/python-numpy-fromrecords-method/](https://www.geeksforgeeks.org/python-numpy-fromrecords-method/)

借助`numpy.core.fromrecords()`方法，我们可以使用单个记录的列表来创建记录数组。
