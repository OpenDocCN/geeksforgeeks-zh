...
> 原文：[https://www.geeksforgeeks.org/convert-a-numpy-array-into-a-csv-file/](https://www.geeksforgeeks.org/convert-a-numpy-array-into-a-csv-file/)
...
**方法一：使用 `DataFrame.to_csv()`。**

此方法用于将数据帧写入 CSV 文件。

**示例：** 将数组转换为 [Pandas DataFrame](https://www.geeksforgeeks.org/python-pandas-dataframe/) 后保存为 CSV 格式。
