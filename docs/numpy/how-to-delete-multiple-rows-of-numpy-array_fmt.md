...
*   [`numpy.delete()`](https://www.geeksforgeeks.org/numpy-delete-python/)–`numpy.delete()`是 Python 中的一个函数，它返回一个新的数组，并沿着所提到的轴删除子数组。通过将轴的值保持为零，有两种可能的方法可以使用`numpy.delete()`删除多行。
