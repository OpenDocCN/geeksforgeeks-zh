...
> 原文: [https://www.geeksforgeeks.org/python-numpy-np-logseries-method/](https://www.geeksforgeeks.org/python-numpy-np-logseries-method/)

借助`np.logseries()`方法，可以得到数组形式的对数级数。
