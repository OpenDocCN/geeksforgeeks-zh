...
> 原文: [https://www.geeksforgeeks.org/python-numpy-np-chebval-method/](https://www.geeksforgeeks.org/python-numpy-np-chebval-method/)

借助 `np.chebval()` 方法，可以得到切比雪夫级数在 `x` 点求值后的系数数组。
