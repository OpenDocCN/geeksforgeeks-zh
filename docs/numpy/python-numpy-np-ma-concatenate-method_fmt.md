...
> 原文: [https://www.geeksforgeeks.org/python-numpy-np-ma-concatenate-method/](https://www.geeksforgeeks.org/python-numpy-np-ma-concatenate-method/)

借助`np.ma.concatenate()`方法，我们可以将两个数组串联起来。
