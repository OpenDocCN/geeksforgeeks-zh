...
> 原文: [https://www.geeksforgeeks.org/numpy-recarray-ravel-function-python/](https://www.geeksforgeeks.org/numpy-recarray-ravel-function-python/)
...
【类似数组】扁平数组，与输入数组具有相同的类型，并根据选择进行排序。
