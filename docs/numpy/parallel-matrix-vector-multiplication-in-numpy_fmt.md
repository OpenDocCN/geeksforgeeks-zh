...
> 原文: [https://www.geeksforgeeks.org/parallel-matrix-vector-multiplication-in-numpy/](https://www.geeksforgeeks.org/parallel-matrix-vector-multiplication-in-numpy/)
...
对于矩阵-向量乘法，我们将使用 NumPy 的 `np.matmul()` 函数来定义一个 4×4 的矩阵和一个长度为 4 的向量。
