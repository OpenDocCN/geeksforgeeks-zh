...
> 原文: [https://www.geeksforgeeks.org/how-to-compute-numerical-negative-value-for-all-elements-in-a-given-numpy-array/](https://www.geeksforgeeks.org/how-to-compute-numerical-negative-value-for-all-elements-in-a-given-numpy-array/)
...
所以，要求一个元素的数值负值，就要用到 `numpy` 库的 `numpy.negative()` 函数。
