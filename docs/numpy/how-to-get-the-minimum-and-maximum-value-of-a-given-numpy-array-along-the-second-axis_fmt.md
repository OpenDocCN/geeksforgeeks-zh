...
> 原文: [https://www.geeksforgeeks.org/how-to-get-the-minimum-and-maximum-value-of-a-given-numpy-array-along-the-second-axis/](https://www.geeksforgeeks.org/how-to-get-the-minimum-and-maximum-value-of-a-given-numpy-array-along-the-second-axis/)
...
> **语法:** `numpy.amax(a, axis=None, out=None, keepdims=<no value>, initial=<no value>, where=<no value>)`

**`numpy.amin()`:** 此函数返回数组的最小值或沿轴的最小值(如果提到的话)。

> **语法:** `numpy.amin(a, axis=None, out=None, keepdims=<no value>, initial=<no value>, where=<no value>)`
...
# find row-wise max values 
rslt1 = np.amax(arr, 1)
print("\nMaximum value along the second axis:", rslt1)
