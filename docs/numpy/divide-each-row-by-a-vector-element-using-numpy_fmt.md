...
> 原文: [https://www.geeksforgeeks.org/divide-each-row-by-a-vector-element-using-numpy/](https://www.geeksforgeeks.org/divide-each-row-by-a-vector-element-using-numpy/) 将每行除以一个向量元素
