...
> 原文: [https://www.geeksforgeeks.org/python-numpy-np-chebroots-method/](https://www.geeksforgeeks.org/python-numpy-np-chebroots-method/)

借助`np.chebroots()`方法，可以得到切比雪夫级数的根。
