...
> **参数:**
> `arr`: *[array_like]* 输入数组。
> `decimals`: *[int, optional]* 我们要四舍五入的小数位数。默认值= 0。如果是负数，它指定小数点左边的位置。
> `out`: *[optional]* 输出结果的数组。
...
[https://docs.scipy.org/doc/numpy-dev/reference/generated/numpy.round_.html#numpy.round_](https://docs.scipy.org/doc/numpy-dev/reference/generated/numpy.round_.html#numpy.round_)