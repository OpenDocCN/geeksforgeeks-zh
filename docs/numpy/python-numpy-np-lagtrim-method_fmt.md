# Python NumPy 例如 lagtrim()方法

> 原文: [https://www.geeksforgeeks.org/python-numpy-np-lagtrim-method/](https://www.geeksforgeeks.org/python-numpy-np-lagtrim-method/)

借助`np.lagtrim()`方法，我们可以使用`lagtrim()`方法修剪多项式的小拖尾值。
