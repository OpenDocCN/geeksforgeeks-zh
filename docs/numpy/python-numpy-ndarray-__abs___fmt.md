...
> 原文链接：[https://www.geeksforgeeks.org/python-numpy-ndarray-__abs__/](https://www.geeksforgeeks.org/python-numpy-ndarray-__abs__/)

借助`ndarray.__abs__()`，可以找到数组中每个元素的**绝对值**。假设我们有一个值`1.34`，借助`ndarray.__abs__()`它会转换成`1`。
