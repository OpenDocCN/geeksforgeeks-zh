...
> `数组:`【`array_like`】输入数组或对象，其元素，我们需要测试。
> `出:`【标准排列，可选】输出数组与输入数组尺寸相同，放置有结果。
...
[`https://docs.scipy.org/doc/numpy-1.13.0/reference/generated/numpy.exp2.html`](https://docs.scipy.org/doc/numpy-1.13.0/reference/generated/numpy.exp2.html)