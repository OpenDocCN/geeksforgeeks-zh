...
> 原文: [https://www.geeksforgeeks.org/numpy-maskedarray-conjugate-function-python/](https://www.geeksforgeeks.org/numpy-maskedarray-conjugate-function-python/)
...
- `casting`: ['no', 'equiv', 'safe', 'same_kind', 或 'unsafe'] 提供了允许哪种铸造的策略。
- `order`: 使用这个索引顺序读取一个的元素。
