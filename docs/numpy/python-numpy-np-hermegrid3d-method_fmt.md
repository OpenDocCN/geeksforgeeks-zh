# Python NumPy `hermegrid3d()` 方法

> 原文: [https://www.geeksforgeeks.org/python-numpy-np-hermegrid3d-method/](https://www.geeksforgeeks.org/python-numpy-np-hermegrid3d-method/)
