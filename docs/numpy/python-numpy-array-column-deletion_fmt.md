...
> 原文: [https://www.geeksforgeeks.org/python-numpy-array-column-deletion/](https://www.geeksforgeeks.org/python-numpy-array-column-deletion/)
...
### 方法 2: 使用 `compress()` 和 `logical_not()`
