# Python | numpy.ndarray.__mul__()

> 哎哎哎:# t0]https://www.geeksforgeeks.org/python-numpy-numpy-ndaarray-__mul__/

借助`numpy.ndarray.__mul__()`，我们可以将`ndarray.__mul__()`方法中作为参数提供的特定值相乘。值将乘以`numpy 数组`中的每个元素。
