...
> 原文: [https://www.geeksforgeeks.org/multiplication-two-matrices-single-line-using-numpy-python/](https://www.geeksforgeeks.org/multiplication-two-matrices-single-line-using-numpy-python/)
...
这是一种简单的矩阵乘法技术，但对于较大的输入数据集，这是一种昂贵的方法。在这里，我们使用嵌套的循环来迭代每行和每列。
...
使用 `Numpy` 的乘法也称为矢量化，其主要目的是减少或消除程序中 `for` 循环的显式使用，从而使计算变得更快。
