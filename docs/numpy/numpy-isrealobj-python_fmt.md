...
`numpy.isrealobj(array)`：这个逻辑函数有助于检查数组是否没有复数类型或者数组是否有复数。即使虚部等于零，也不认为是实物体。
...
[https://docs.scipy.org/doc/numpy-1.13.0/reference/generated/numpy.isrealobj.html#numpy.isrealobj](https://docs.scipy.org/doc/numpy-1.13.0/reference/generated/numpy.isrealobj.html#numpy.isrealobj)