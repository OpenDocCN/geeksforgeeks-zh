...
> 原文: [https://www.geeksforgeeks.org/python-numpy-np-lagval3d-method/](https://www.geeksforgeeks.org/python-numpy-np-lagval3d-method/)

借助`np.lagval3d()`方法，可以得到`x`点的三维拉盖尔级数。
