...
> 原文: [https://www.geeksforgeeks.org/python-numpy-np-hermmul-method/](https://www.geeksforgeeks.org/python-numpy-np-hermmul-method/)

借助`np.hermmul()`方法，可以得到两个厄米级数的乘积。
