...
> 原文：[https://www.geeksforgeeks.org/python-numpy-practice-exercises-questions-and-solutions/](https://www.geeksforgeeks.org/python-numpy-practice-exercises-questions-and-solutions/)
...
*   [使用 NumPy 展平 Python 中的矩阵](https://www.geeksforgeeks.org/flatten-a-matrix-in-python-using-numpy/)
...
*   [使用 NumPy 计算给定矩阵的行数和列数](https://www.geeksforgeeks.org/find-the-number-of-rows-and-columns-of-a-given-matrix-using-numpy/)
...
*   [使用 NumPy 计算矩阵和向量的内积、外积和叉积](https://www.geeksforgeeks.org/calculate-inner-outer-and-cross-products-of-matrices-and-vectors-using-numpy/)
...
*   [使用 NumPy 找到矩阵或向量范数](https://www.geeksforgeeks.org/find-a-matrix-or-vector-norm-using-numpy/)
*   [使用 NumPy 计算给定矩阵的 QR 分解](https://www.geeksforgeeks.org/calculate-the-qr-decomposition-of-a-given-matrix-using-numpy/)
*   [使用 NumPy 计算给定矩阵的条件数](https://www.geeksforgeeks.org/compute-the-condition-number-of-a-given-matrix-using-numpy/)
...
*   [使用 NumPy 计算欧氏距离](https://www.geeksforgeeks.org/calculate-the-euclidean-distance-using-numpy/)
...
*   [使用`NumPy`计算`Python`中的平均值、方差和标准差](https://www.geeksforgeeks.org/calculate-the-average-variance-and-standard-deviation-in-python-using-numpy/)
...
*   [用`NumPy`求多项式的根](https://www.geeksforgeeks.org/find-the-roots-of-the-polynomials-using-numpy/)
...
*   [使用`NumPy`创建直方图](https://www.geeksforgeeks.org/numpy-histogram-method-in-python/)