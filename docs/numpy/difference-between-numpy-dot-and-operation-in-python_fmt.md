...
> 原文: [https://www.geeksforgeeks.org/difference-between-numpy-dot-and-operation-in-python/](https://www.geeksforgeeks.org/difference-between-numpy-dot-and-operation-in-python/)
...
它执行正规矩阵乘法。如果第一个数组的列数等于第二个数组的行数，则只检查 `numpy.dot()` 函数，否则会显示错误。
