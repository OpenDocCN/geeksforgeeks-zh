# numpy.ma.masked_all_like() 函数

> 原文: [https://www.geeksforgeeks.org/numpy-ma-masked_all_like-function-python/](https://www.geeksforgeeks.org/numpy-ma-masked_all_like-function-python/)
