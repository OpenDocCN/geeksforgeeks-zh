...
> 原文: [https://www.geeksforgeeks.org/numpy-matrix-operations-rand-function/](https://www.geeksforgeeks.org/numpy-matrix-operations-rand-function/)
...
### 参数
*args*: 输出矩阵的形状。如果给定 `N` 个整数，每个整数指定一个维度的大小。如果作为元组给出，这个元组给出完整的形状。如果有多个参数，并且第一个参数是元组，则忽略其他参数。
