...
> 原文: [https://www.geeksforgeeks.org/python-numpy-issubdtype-function/](https://www.geeksforgeeks.org/python-numpy-issubdtype-function/)
...
>
> **参数:**
> `arg1`, `arg2`: 【dtype_like】dtype 或代表 typecode 的字符串。
>
> **返回:** 【布尔】布尔结果。
