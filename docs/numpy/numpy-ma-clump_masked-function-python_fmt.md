# numpy.ma.clump_masked() 函数

> 原文：[https://www.geeksforgeeks.org/numpy-ma-clump_masked-function-python/](https://www.geeksforgeeks.org/numpy-ma-clump_masked-function-python/)

`numpy.ma.clump_masked()` 函数返回一个切片列表，该列表对应于一维数组中被屏蔽的块。

## 语法

`numpy.ma.clump_masked(arr)`
