...
> 原文: [https://www.geeksforgeeks.org/python-numpy-np-chebpow-method/](https://www.geeksforgeeks.org/python-numpy-np-chebpow-method/)

借助`np.chebpow()`方法，可以得到**切比雪夫系列**的幂。
