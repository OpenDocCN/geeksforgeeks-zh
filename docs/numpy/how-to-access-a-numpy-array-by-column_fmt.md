...
> 原文: [https://www.geeksforgeeks.org/how-to-access-a-numpy-array-by-column/](https://www.geeksforgeeks.org/how-to-access-a-numpy-array-by-column/)
...
[`NumPy`](https://www.geeksforgeeks.org/python-numpy/) 遵循标准的基于 0 的索引。

![](img/7ab31b130b4fa6dab34385ff477f242e.png)

[`NumPy`](https://www.geeksforgeeks.org/python-numpy/) 中的行和列类似于 Python 列表。
...
> **语法:**
>
> **列:** `numpy_Array_name[..., 列]`
>
> **行:** `numpy_Array_name[行, ...]`
>
> 其中 `...` 表示给定行或列中没有元素。

**注意:** 这不是一个非常实用的方法，但是你必须尽可能了解。
