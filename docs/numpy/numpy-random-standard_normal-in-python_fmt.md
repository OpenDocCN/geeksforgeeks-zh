...
> 原文: [https://www.geeksforgeeks.org/numpy-random-standard_normal-in-python/](https://www.geeksforgeeks.org/numpy-random-standard_normal-in-python/)

借助 `numpy.random.standard_normal()` 方法，我们可以从标准正态分布中获取随机样本，并利用该方法将随机样本作为 numpy 数组返回。

> **语法:** `numpy.random.standard_normal(size=None)`
>
