# NumPy的hermegrid2d()方法

> 原文：[https://www.geeksforgeeks.org/python-numpy-np-hermegrid2d-method/](https://www.geeksforgeeks.org/python-numpy-np-hermegrid2d-method/)
...
## 例1
在这个例子中我们可以看到，通过使用`np.hermegrid2d()`方法，我们能够用这个方法来评估x和y的笛卡尔乘积上的2-D hermite级数。
