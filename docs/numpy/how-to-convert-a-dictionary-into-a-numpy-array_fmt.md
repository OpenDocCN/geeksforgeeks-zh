...
> 原文：[https://www.geeksforgeeks.org/how-to-convert-a-dictionary-into-a-numpy-array/](https://www.geeksforgeeks.org/how-to-convert-a-dictionary-into-a-numpy-array/)
...
> **参数：**
>
> **object**：一个数组，任何暴露数组接口的对象。
>
> **dtype**：数组所需的数据类型。
>
> **copy**：如果为真（默认），则复制对象。否则，只有当 `__array__` 返回副本时，才会创建副本。
>
> **order**：指定阵列的内存布局。
>
