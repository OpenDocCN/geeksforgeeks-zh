...
> 原文: [https://www.geeksforgeeks.org/python-numpy-getmaskarray-method/](https://www.geeksforgeeks.org/python-numpy-getmaskarray-method/)

借助`numpy.getmaskarray()`方法，我们可以得到以 numpy 数组形式表示掩码值的掩码矩阵。
