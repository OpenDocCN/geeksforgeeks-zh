...
> 原文：[https://www.geeksforgeeks.org/calculate-the-average-variance-and-standard-deviation-in-python-using-numpy/](https://www.geeksforgeeks.org/calculate-the-average-variance-and-standard-deviation-in-python-using-numpy/)
...
> - `returned`：默认为 `False`。如果为 `True`，则返回元组，否则只返回平均值
...
> - `out`：放置结果的备用输出数组
> - `ddof`：δ自由度
> - `keepdims`：如果设置为 `True`，减少的轴将作为尺寸为 1 的维度留在结果中
