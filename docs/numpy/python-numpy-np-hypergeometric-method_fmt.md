...
> 原文: [https://www.geeksforgeeks.org/python-numpy-np-hypergeometric-method/](https://www.geeksforgeeks.org/python-numpy-np-hypergeometric-method/)

借助 `np.hypergeometric()` 方法，可以得到阵列形式的超几何分布。
