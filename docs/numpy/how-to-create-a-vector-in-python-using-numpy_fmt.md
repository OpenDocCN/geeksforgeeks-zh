...
> 原文: [https://www.geeksforgeeks.org/how-to-create-a-vector-in-python-using-numpy/](https://www.geeksforgeeks.org/how-to-create-a-vector-in-python-using-numpy/) 创建 python 矢量
...
> **返回:** 返回 `numpy.ndarray` 的向量

**注:** 我们也可以用其他方法创建向量，这些方法返回一维数组，例如 `np.arange(10)`，`np.zeros((4, 1))` 给出一维数组，但最合适的方法是将 `np.array` 与一维列表一起使用。
