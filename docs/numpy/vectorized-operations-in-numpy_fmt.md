...
> 原文: [https://www.geeksforgeeks.org/vectorized-operations-in-numpy/](https://www.geeksforgeeks.org/vectorized-operations-in-numpy/)
...
在 NumPy 数组上使用矢量化求和方法。我们将比较矢量化求和方法和简单的非矢量化操作，即计算 0–14,999 之间数字总和的迭代方法。
