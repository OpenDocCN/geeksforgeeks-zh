...
- **x**: `array_like`，元素以弧度为单位。`2pi` 弧度 = `360` 度。

## 返回

所有 `x` 的双曲余弦值的数组，即数组元素的双曲余弦。
...
[https://docs.scipy.org/doc/numpy-dev/reference/generated/numpy.cosh.html#numpy.cosh](https://docs.scipy.org/doc/numpy-dev/reference/generated/numpy.cosh.html#numpy.cosh)