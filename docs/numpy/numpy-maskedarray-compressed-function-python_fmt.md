...
> 原文: [https://www.geeksforgeeks.org/numpy-maskedarray-compressed-function-python/](https://www.geeksforgeeks.org/numpy-maskedarray-compressed-function-python/)

`numpy.MaskedArray.compressed()` 函数将所有未屏蔽的数据作为一维数组返回。

> **语法:** `numpy.MaskedArray.compressed(self)`
>
> **返回:** 【ndarray】返回一个保存未屏蔽数据的新数组。
