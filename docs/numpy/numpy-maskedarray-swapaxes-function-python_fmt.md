...
> 原文: [https://www.geeksforgeeks.org/numpy-maskedarray-swapaxes-function-python/](https://www.geeksforgeeks.org/numpy-maskedarray-swapaxes-function-python/)

`numpy.MaskedArray.swapaxes()` 函数用于返回 `axis1` 和 `axis2` 互换的屏蔽阵列视图。
