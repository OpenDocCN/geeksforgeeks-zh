# NumPy `np.char.endswith()`方法

> 原文: [https://www.geeksforgeeks.org/python-numpy-np-char-endswith-method/](https://www.geeksforgeeks.org/python-numpy-np-char-endswith-method/)
