...
> 原文：[https://www.geeksforgeeks.org/python-numpy-np-hermesub-method/](https://www.geeksforgeeks.org/python-numpy-np-hermesub-method/)

借助 `np.hermesub()` 方法，可以得到两个 HermiteE 级数的减法。
