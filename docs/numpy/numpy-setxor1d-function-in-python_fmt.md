...
> 原文: [https://www.geeksforgeeks.org/numpy-setxor1d-function-in-python/](https://www.geeksforgeeks.org/numpy-setxor1d-function-in-python/)

`numpy.setxor1d()` 函数查找两个数组的异或集合，并返回仅在一个（而不是两个）输入数组中排序的唯一值。

> **语法:** `numpy.setxor1d(arr1, arr2, assume_unique=False)`
>
> **参数:**
