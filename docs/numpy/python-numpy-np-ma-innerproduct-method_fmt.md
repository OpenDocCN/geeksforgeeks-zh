...
> 原文：[https://www.geeksforgeeks.org/python-numpy-np-ma-innerproduct-method/](https://www.geeksforgeeks.org/python-numpy-np-ma-innerproduct-method/)

借助 `np.ma.innerproduct()` 方法，我们可以计算两个列表的向量乘积。
