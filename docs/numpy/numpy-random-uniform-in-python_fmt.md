...
> 原文: [https://www.geeksforgeeks.org/numpy-random-uniform-in-python/](https://www.geeksforgeeks.org/numpy-random-uniform-in-python/)
...
> **语法:** `numpy.random.uniform(low=0.0, high=1.0, size=None)`
>
