...
> 哎哎哎:# t0]https://www . geeksforgeeks . orgpython-num py-num py 转发器/

借助`Numpy numpy.transpose()`，我们可以利用 Numpy 的`numpy.transpose()`方法，实现一行内转置的简单功能。它可以转置二维数组，但对一维数组没有影响。这个方法转置二维数组。
