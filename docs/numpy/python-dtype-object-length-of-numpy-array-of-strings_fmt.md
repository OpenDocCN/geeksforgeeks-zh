...
> 原文: [https://www.geeksforgeeks.org/python-dtype-object-length-of-numpy-array-of-strings/](https://www.geeksforgeeks.org/python-dtype-object-length-of-numpy-array-of-strings/)
...
`问题2`：给定一个 numpy 数组，其底层数据为字符串类型。找到数据类型。
