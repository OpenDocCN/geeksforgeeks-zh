...
> 原文: [https://www.geeksforgeeks.org/python-check-if-all-values-in-numpy-are-zero/](https://www.geeksforgeeks.org/python-check-if-all-values-in-numpy-are-zero/)

给定一个 numpy 数组，任务是检查 numpy 数组是否包含全零。让我们讨论几个解决上述任务的方法。

## 方法 1: 使用 `numpy.count_nonzero()`
