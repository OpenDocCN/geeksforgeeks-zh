...
> 原文：[https://www.geeksforgeeks.org/how-to-add-one-polynomial-to-another-using-numpy-in-python/](https://www.geeksforgeeks.org/how-to-add-one-polynomial-to-another-using-numpy-in-python/)

在本文中，让我们看看如何将一个多项式添加到另一个多项式中。给出两个多项式作为输入，结果是两个多项式的相加。

*   多项式`p(x)= C3x^2+C2x+C1`在 NumPy 中表示为：`( C1、C2、C3 )` {系数(常数)}。
