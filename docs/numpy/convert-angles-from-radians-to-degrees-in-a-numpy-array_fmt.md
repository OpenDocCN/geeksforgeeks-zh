...
> 原文：[https://www.geeksforgeeks.org/convert-angles-from-radians-to-degrees-in-a-numpy-array/](https://www.geeksforgeeks.org/convert-angles-from-radians-to-degrees-in-a-numpy-array/)

在本文中，我们将讨论如何将由不同角度组成的数组元素从弧度转换为度数。

要将角度从弧度转换为度数，我们只需将弧度乘以 180/π。我们也可以使用 `numpy.rad2deg()` 方法进行同样的操作。
