...
> 原文: [https://www.geeksforgeeks.org/python-numpys-structured-array/](https://www.geeksforgeeks.org/python-numpys-structured-array/)
...
使用 `numpy.sort()` 方法，将顺序作为参数传递，可以对结构数组进行排序。此参数采用需要对其进行排序的字段的值。
