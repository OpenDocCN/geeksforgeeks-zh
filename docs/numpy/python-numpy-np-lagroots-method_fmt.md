# Python | NumPy `np.lagroots()` 方法

> 原文：[https://www.geeksforgeeks.org/python-numpy-np-lagroots-method/](https://www.geeksforgeeks.org/python-numpy-np-lagroots-method/)
...
>
> **返回：**【`ndarray`】系列根的数组。如果所有的根都是真实的，那么输出也是真实的，否则就是复数的。
