...
> 原文：[https://www.geeksforgeeks.org/extracting-the-real-and-imaginary-parts-of-an-numpy-array-of-complex-numbers/](https://www.geeksforgeeks.org/extracting-the-real-and-imaginary-parts-of-an-numpy-array-of-complex-numbers/)

Numpy 库给了我们像 `real()`、`imag()` 这样的函数来求一个复数的实部和虚部。
