# jQWidgets jqxWindow showCloseButton 属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxwindow-showclosebutton-property/](https://www.geeksforgeeks.org/jqwidgets-jqxwindow-showclosebutton-property/)
...
用于设置 `showCloseButton` 属性。

```javascript
$('#jqxWindow').jqxWindow({ showCloseButton: true });
```

获取 `showCloseButton` 属性。
...
下面的示例说明了 jQWidgets 中的 `jqxWindow` `showCloseButton` 属性。在下面的例子中，`showCloseButton` 已经设置为 `true`。
