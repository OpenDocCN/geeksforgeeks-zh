...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxfileupload-remove-event/](https://www.geeksforgeeks.org/jqwidgets-jqxfileupload-remove-event/)
...
**示例:**以下示例说明了 jQWidgets 中的 jqxFileUpload **移除事件**。
