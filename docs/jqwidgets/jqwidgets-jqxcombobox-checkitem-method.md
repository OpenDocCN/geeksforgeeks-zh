# jQWidgets jqxComboBox check item()方法

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxcombobox-check item-method/](https://www.geeksforgeeks.org/jqwidgets-jqxcombobox-checkitem-method/)
...
checkItem()方法用于使用项目名称检查 jqxComboBox 小部件的项目。它接受对象/字符串类型的单个参数*项*，不接受任何参数。
