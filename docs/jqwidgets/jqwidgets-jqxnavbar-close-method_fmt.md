...
> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxnavbar-close-method/](https://www.geeksforgeeks.org/jqwidgets-jqxnavbar-close-method/)
...
`close()`方法用于在导航栏最小化时关闭弹出窗口小部件。它不接受任何参数，也不返回值。
...
下面的例子说明了 jQWidgets `jqxNavBar` 的 `close()`方法。
