# jQWidgets jqxlloader 文本属性

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxlloader-text-property/](https://www.geeksforgeeks.org/jqwidgets-jqxloader-text-property/)
...
**文本属性**用于设置或返回加载器元素的文本。它接受字符串类型的值，默认值是“加载...”。
...
下面的例子说明了 jQWidgets jqxLoader 文本属性。
