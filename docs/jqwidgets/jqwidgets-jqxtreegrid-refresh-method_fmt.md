...
> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxtreegrid-refresh-method/](https://www.geeksforgeeks.org/jqwidgets-jqxtreegrid-refresh-method/)
...
下面的示例说明了 jQWidgets jqxTreeGrid `refresh()` 方法。
