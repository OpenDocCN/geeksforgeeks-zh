...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxresponsevepanel-animation type-property/](https://www.geeksforgeeks.org/jqwidgets-jqxresponsivepanel-animationtype-property/)
...
**动画类型属性**用于设置或返回用于显示/隐藏面板的动画类型。它接受字符串类型的值，默认值是“淡化”。
