# jQWidgets jqxnumber input group size 属性

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxnumberinput-group size-property/](https://www.geeksforgeeks.org/jqwidgets-jqxnumberinput-groupsize-property/)
...
**组大小属性**用于设置或返回数值中小数点左边每组的位数。它接受数字类型值，默认值为 3。
...
下面的例子说明了 jQWidgets jqxnumber input group size 属性。
