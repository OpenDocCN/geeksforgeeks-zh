# jQWidgets jqxRadioButton enableContainerClick 属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxradiobutton-enablecontainerclick-property/](https://www.geeksforgeeks.org/jqwidgets-jqxradiobutton-enablecontainerclick-property/)
...
`enableContainerClick` 属性用于设置或返回容器的点击是否作为圆形按钮上的点击来处理。它接受布尔类型值，默认值为真。
...
下面的示例说明了 jQWidgets jqxRadioButton `enableContainerClick` 属性。
...
<body>
    ...
    <h3>
        jQWidgets jqxRadioButton enableContainerClick Property
    </h3>
...
![](img/819819ec9a2732a50dbce85ff4079891.png)
