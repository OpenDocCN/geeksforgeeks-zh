...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxcalendar-stepmonths-property/](https://www.geeksforgeeks.org/jqwidgets-jqxcalendar-stepmonths-property/)
...
当点击左侧或右侧导航按钮时，`stepMonths` 属性用于设置或返回日历的导航步骤。它接受数字类型值，默认值为 `1`。
