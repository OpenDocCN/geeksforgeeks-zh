# jQWidgets jqxScheduler max 属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxscheduler-max-property/](https://www.geeksforgeeks.org/jqwidgets-jqxscheduler-max-property/)
...
`max` 属性用于设置或返回显示的 `jqxScheduler` 的最大导航日期。类型为 `$.jqx.date`，默认值为 `new $.jqx.date(9999, 12, 31)`。
...
下面的示例说明了 jQWidgets 中的 `jqxScheduler` `max` 属性。
...
![](img/cbca1f0059a9df25bff51036a84636a5.png)
