...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxchart-tooltiphidedelay-property/](https://www.geeksforgeeks.org/jqwidgets-jqxchart-tooltiphidedelay-property/)
...
`toolTipHideDelay` 属性用于设置或返回工具提示隐藏延迟。即该属性用于设置或返回工具提示，以毫秒为单位隐藏延迟。它接受数字类型值，默认值为 4000。
...
**示例:** 下面的示例说明了 jQWidgets 中的 `jqxChart` `toolTipHideDelay` 属性。
