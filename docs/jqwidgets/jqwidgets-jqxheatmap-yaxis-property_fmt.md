...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxheatmap-yaxis-property/](https://www.geeksforgeeks.org/jqwidgets-jqxheatmap-yaxis-property/)
...
*   `标签`: 用于设置 y 轴的标签。
*   `相对位置`: 用于设置轴是否相对于默认位置显示在相对侧。默认值为 `false`。
*   `isin window`: 用于设置轴是否显示在反转位置。默认值为 `false`。
