...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxcalendar-setmindate-property/](https://www.geeksforgeeks.org/jqwidgets-jqxcalendar-setmindate-property/)
...
`setMinDate(min)` 属性用于设置或返回最小导航日期。接受 `Date` 类型值，默认值为‘1900，1，1’。
