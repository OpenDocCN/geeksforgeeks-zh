# jQWidgets jqxSplitter width 属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxsplitter-width-property/](https://www.geeksforgeeks.org/jqwidgets-jqxsplitter-width-property/)
...
``width`` 属性用于设置或获取指定 ``jqxSplitter`` 的宽度。
...
以下示例说明了 jQWidgets ``jqxSplitter`` ``width`` 属性。在下面的示例中，``width`` 属性的值被设置为 300。
