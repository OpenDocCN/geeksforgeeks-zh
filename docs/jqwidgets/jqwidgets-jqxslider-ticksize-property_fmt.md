...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxslider-ticksize-property/](https://www.geeksforgeeks.org/jqwidgets-jqxslider-ticksize-property/)
...
`tickSize` 属性用于设置或返回 `jqxSlider` 小部件的主要刻度大小。它接受数字类型值，默认值为 7。
