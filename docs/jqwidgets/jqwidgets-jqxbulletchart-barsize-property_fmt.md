...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxbulletchart-barsize-property/](https://www.geeksforgeeks.org/jqwidgets-jqxbulletchart-barsize-property/)
...
`barSize` 属性用于设置或返回项目符号图表的条形图大小。它接受数组类型值，默认值为 `50%`。
...
下面的示例说明了 jQWidgets 中的 `jqxBulletChart` `barSize` 属性。
...
<body>
    <center>
        ...
        <h3>
            jQWidgets jqxBulletChart barSize Property
        </h3>
        <div id="gfg"></div>
    </center>
...
![](img/6fec5464078a443891dc7ed36ef9e3e5.png)
