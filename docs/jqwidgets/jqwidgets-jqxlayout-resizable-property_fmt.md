# jQWidgets jqxLayout 可调整大小属性

> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxlayout-resizable-property/](https://www.geeksforgeeks.org/jqwidgets-jqxlayout-resizable-property/)
...
`resizable` 属性用于设置或返回指定 `jqxLayout` 小部件的面板是否可以动态调整大小。
...
**示例：** 以下示例说明了 jQWidgets `jqxLayout` `resizable` 属性。在下面的例子中，`resizable` 属性的值被设置为 `true`。
...
**参考：** [https://www.jqwidgets.com/jquery-widgets-documentation/documentation/jqxlayout/jquery-layout-api.htm?search=](https://www.jqwidgets.com/jquery-widgets-documentation/documentation/jqxlayout/jquery-layout-api.htm?search=)