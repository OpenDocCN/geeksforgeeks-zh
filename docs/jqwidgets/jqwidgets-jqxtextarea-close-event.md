# jQWidgets jqxTextArea 关闭事件

> 原文:[https://www . geeksforgeeks . org/jqwidgets-jqxtextarea-close-event/](https://www.geeksforgeeks.org/jqwidgets-jqxtextarea-close-event/)
...
当文本区自动建议弹出窗口关闭时，触发 jqxTextArea *关闭*事件。
...
**示例:**以下示例说明了 jQWidgets jqxTextArea *关闭*事件。
...
        <h3>
            jQWidgets jqxTextArea close Event
        </h3>
...
            $('#jqxTA').on('close', function() {
                alert("The pop-up has been closed");
            });
        });
    </script>
</body>
...
![](img/1be6669578d91ec104e582b95202e33c.png)
