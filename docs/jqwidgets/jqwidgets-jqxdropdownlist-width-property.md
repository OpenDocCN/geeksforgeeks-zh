...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxddropdownlist-width-property/](https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-width-property/)
...
*宽度*属性用于设置或返回 jqxDropDownList 的宽度。它接受数字/字符串类型的值，默认值为空。
...
**示例:**以下示例说明了 jQWidgets 中的 jqxDropDownList *宽度*属性。
