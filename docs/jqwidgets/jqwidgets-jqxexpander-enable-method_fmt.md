...
> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxexpander-enable-method/](https://www.geeksforgeeks.org/jqwidgets-jqxexpander-enable-method/)
...
`enable()`方法用于启用扩展器。它不接受任何参数，也不返回值。

### 语法：
```html
$('Selector').jqxExpander('enable');
```
...
下面的例子说明了 jQWidgets `jqxExpander` `enable()`方法。
...
<body>
    <center>
        ...
        <h3>jQWidgets jqxExpander enable() Method</h3>
        <div id='jqxExp'>
        ...
        <input type="button" id="jqxBtn" value="Enable Expander" style="padding: 5px 15px; margin-top: 20px;">
    </center>
...
### 输出：
![](img/390e9fd36444234742ab01d9f9c0c155.png)
