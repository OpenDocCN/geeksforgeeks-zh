...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxresponsivepanel-destroy-method/](https://www.geeksforgeeks.org/jqwidgets-jqxresponsivepanel-destroy-method/)
...
下面的示例说明了 jQWidgets 中的 `jqxResponsivePanel` `destroy()`方法。
