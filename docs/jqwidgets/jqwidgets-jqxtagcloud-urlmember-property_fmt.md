...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxtagcloud-urlmember-property/](https://www.geeksforgeeks.org/jqwidgets-jqxtagcloud-urlmember-property/)
...
`urlMember` 属性用于设置或获取指定 `jqxTagCloud` 的锚点元素所使用的字段名。
...
下面的示例说明了 jQWidgets `jqxTagCloud` `urlMember` 属性。在下面的示例中， `urlMember` 属性的值已设置为“URL”。
