# jq 构件 jqxListBox getSelectedItems()方法

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxlistbox-getselecteditems-method/](https://www.geeksforgeeks.org/jqwidgets-jqxlistbox-getselecteditems-method/)
