...
> 原文：[`https://www.geeksforgeeks.org/jqwidgets-jqxexpander-setheadercontent-method/`](https://www.geeksforgeeks.org/jqwidgets-jqxexpander-setheadercontent-method/)
...
`setHeaderContent()` 方法用于将特定内容设置到扩展头。它接受字符串类型的单参数头内容，并且不返回任何值。
