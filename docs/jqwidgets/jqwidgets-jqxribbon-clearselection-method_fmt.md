...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxribbon-clearselection-method/](https://www.geeksforgeeks.org/jqwidgets-jqxribbon-clearselection-method/)
...
`clearSelection()` 方法用于取消选中所选项目并折叠其在小部件中的内容。它不接受任何参数，也不返回值。
...
下面的示例说明了 jQWidgets `jqxRibbon` 的 `clearSelection()` 方法。
...
<body>
    <center>
        ...
        <h3>
            jQWidgets jqxRibbon clearSelection() Method
        </h3>
    </center>
    ...
    <center>
        <input type="button" id="jqxBtn" value="Unselect Selection Item" style="padding: 5px 15px; margin-top: 15px;">
    </center>
...
![](img/995a1b4d90141dbeb30702af145e7ae0.png)
