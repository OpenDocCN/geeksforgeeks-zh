...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxfileupload-cancelall-method/](https://www.geeksforgeeks.org/jqwidgets-jqxfileupload-cancelall-method/)
...
`cancelAll()` 方法用于设置按钮，该按钮明确使用另一个按钮来取消所有文件。它不接受任何参数，也不返回值。
...
下面的示例说明了 `jQWidgets` 中的 `jqxFileUpload` `cancelAll()` 方法。
