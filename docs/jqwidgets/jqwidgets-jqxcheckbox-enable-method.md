...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxcheckbox-enable-method/](https://www.geeksforgeeks.org/jqwidgets-jqxcheckbox-enable-method/)
...
**enable()** 方法用于启用复选框。它不接受任何参数，也不返回值。

**语法:**

```html
$('selector').jqxCheckBox('enable');
```
...
**示例:**以下示例说明了 jQWidgets 中的 jqxCheckBox **enable()** 方法。
...
    <h3>
        jQWidgets jqxCheckBox enable() Method
    </h3>
...
        value="Enable the CheckBox" style="padding: 8px 25px;" />
...
![](img/c238179d0066e7518b1cdc9b5ad76d32.png)
