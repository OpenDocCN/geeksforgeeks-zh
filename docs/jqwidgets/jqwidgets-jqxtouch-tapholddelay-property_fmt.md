# jQWidgets jqxttouch tapHoldDelay 属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxtouch-tapholddelay-property/](https://www.geeksforgeeks.org/jqwidgets-jqxtouch-tapholddelay-property/)
...
`tapHoldDelay` 属性用于设置或获取指定 `jqxTouch` 小部件的点击保持延迟。当这个延迟过去后，`taphold` 事件将被触发。

## 语法

*   用于设置 `tapHoldDelay` 属性:
    ```javascript
...
下面的示例说明了 `jQWidgets` `jqxttouch` `tapHoldDelay` 属性。在下面的示例中，`tapHoldDelay` 属性的值被设置为 2500。
