...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-focus-method/](https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-focus-method/)
...
## 语法
```javascript
$("Selector").jqxDropDownList('focus');
```
...
下面的例子说明了 jQWidgets 中的 `jqxDropDownList` `focus()`方法。
...
### 输出
![](img/8a7dbd56c3814e3a0622b74a67230d39.png)
