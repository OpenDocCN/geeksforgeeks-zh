...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxmenu-clicktoopen-property/](https://www.geeksforgeeks.org/jqwidgets-jqxmenu-clicktoopen-property/)
...
**点击打开属性**用于设置或返回用户点击后的项目是否打开。它接受布尔类型值，默认值为 false。
