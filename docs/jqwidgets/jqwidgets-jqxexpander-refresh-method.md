# jQWidgets jqxExpander 刷新()方法

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxexpander-refresh-method/](https://www.geeksforgeeks.org/jqwidgets-jqxexpander-refresh-method/)
...
**刷新()方法用于刷新扩展器小部件**。它不接受任何参数，也不返回值。

**语法:**

```html
$('Selector').jqxExpander('refresh');
```
...
下面的例子说明了 jQWidgets jqxExpander refresh()方法。
...
![](img/d105bd630b93dcb9e035125a38647d29.png)
