# jqwidgets jqxdatetimeinput showFooter 属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdatetimeinput-showfooter-property/](https://www.geeksforgeeks.org/jqwidgets-jqxdatetimeinput-showfooter-property/)
...
`showFooter` 属性用于设置或返回一个值，该值指示下拉日历的页脚是否显示。它接受布尔类型值，默认值为 `false`。
...
下面的例子说明了 jQWidgets 中的 `jqxDateTimeInput` `showFooter` 属性。
...
![](img/13aac25d849cec8e1de35a8f8be4ca3f.png)
