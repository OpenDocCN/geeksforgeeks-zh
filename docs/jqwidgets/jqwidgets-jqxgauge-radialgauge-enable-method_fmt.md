...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxgauge-radialgauge-enable-method/](https://www.geeksforgeeks.org/jqwidgets-jqxgauge-radialgauge-enable-method/)
...
`enable()`方法用于使能`jqxRadialGauge`元件。它不接受任何参数，也不返回值。
