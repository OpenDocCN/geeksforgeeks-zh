...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-unselectitem-method/](https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-unselectitem-method/)
...
`unselectItem()`方法用于使用项目名称取消选择项目。它接受对象/字符串类型的单个参数`item`，并且不返回值。
