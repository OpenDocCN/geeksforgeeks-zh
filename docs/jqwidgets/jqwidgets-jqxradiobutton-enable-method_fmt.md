...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxradiobutton-enable-method/](https://www.geeksforgeeks.org/jqwidgets-jqxradiobutton-enable-method/)
...
`enable()` 方法用于启用单选按钮选项。它不接受任何参数，也不返回值。
