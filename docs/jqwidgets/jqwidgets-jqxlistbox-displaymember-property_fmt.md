...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxlistbox-displaymember-property/](https://www.geeksforgeeks.org/jqwidgets-jqxlistbox-displaymember-property/)
...
以下示例说明了 jQWidgets 中的 `jqxListBox` `displayMember` 属性。
