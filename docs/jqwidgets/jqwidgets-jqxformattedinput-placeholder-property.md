# jQWidgets jqxformatedinput 占位符属性

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxformatedinput-placeholder-property/](https://www.geeksforgeeks.org/jqwidgets-jqxformattedinput-placeholder-property/)
...
**占位符属性**用于设置或返回 jqxFormattedInput 小部件的占位符。它接受字符串类型值，默认值为空”。
...
下面的例子说明了 jQWidgets jqxformatedinput placeHolder 属性。
