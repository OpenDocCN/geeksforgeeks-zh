# jQWidgets jqxPasswordInput maxLength 属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxpasswordinput-maxlength-property/](https://www.geeksforgeeks.org/jqwidgets-jqxpasswordinput-maxlength-property/)
...
`maxLength` 属性用于设置或返回密码字段中允许的最大字符数。它接受数字类型的值，默认值为空。
