# jQWidgets jqxScheduler toolbrangeformatsubr 属性

> 原文:[https://www . geeksforgeeks . org/jqwidgets-jqxscheduler-toolbrangerformatsubr-property/](https://www.geeksforgeeks.org/jqwidgets-jqxscheduler-toolbarrangeformatabbr-property/)
...
每当显示的 jqxScheduler 的宽度不足以显示完整的格式时，**toolbrangeformatsubr**属性用于设置或返回工具栏的日期格式。类型为字符串，默认值为“*日/月/年*”。
...
**示例:**下面的示例说明了 jQWidgets 中的 jqxScheduler**toolbrangeformatsprep**属性。
