...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxexpander-collapse-method/](https://www.geeksforgeeks.org/jqwidgets-jqxexpander-collapse-method/)
...
`collapse()`方法用于折叠扩张器。它不接受任何参数，也不返回值。
