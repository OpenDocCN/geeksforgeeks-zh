# jQWidgets jqxResponsivePanel autoClose 属性

> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxresponsivepanel-autoclose-property/](https://www.geeksforgeeks.org/jqwidgets-jqxresponsivepanel-autoclose-property/)
...
`autoClose` 属性用于将其值设置为 `true`，这意味着在单击响应面板外部的光标后，它会关闭。它接受布尔类型值，默认值为 `true`。
