...
> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxscheduler-getselection-method/](https://www.geeksforgeeks.org/jqwidgets-jqxscheduler-getselection-method/)
...
`getSelection()` 方法用于从显示的 `jqxScheduler` 中返回选定的单元格。它没有参数。它返回一个对象。
...
<body>
    <center>
        ...
        <h3>jQWidgets jqxScheduler getSelection() method</h3>
