...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxresponsevepanel-close-method/](https://www.geeksforgeeks.org/jqwidgets-jqxresponsivepanel-close-method/)
...
**示例:**下面的示例说明了 jQWidgets 中的 jqxResponsivePanel**close()**方法。
