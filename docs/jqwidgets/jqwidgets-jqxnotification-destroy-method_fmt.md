...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxnotification-destroy-method/](https://www.geeksforgeeks.org/jqwidgets-jqxnotification-destroy-method/)
...
以下示例说明了 jQWidgets 中的 `jqxNotification` `destroy()`方法:
