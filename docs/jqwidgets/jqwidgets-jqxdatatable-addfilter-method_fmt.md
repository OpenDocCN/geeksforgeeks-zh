...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdatatable-addfilter-method/](https://www.geeksforgeeks.org/jqwidgets-jqxdatatable-addfilter-method/)
...
*   `dataField`: 这是要应用过滤器的指定列。此参数为字符串类型。
*   `filtergroup`: 这是创建的滤镜组对象。
