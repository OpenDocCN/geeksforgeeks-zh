# jQWidgets jqxMenu autoloseinterval 属性

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxmenu-autocloseineterval-property/](https://www.geeksforgeeks.org/jqwidgets-jqxmenu-autocloseinterval-property/)
...
**autoCloseInterval 属性**用于设置或返回时间间隔，在该时间间隔之后，所有打开的项目都将被关闭。它接受数字类型值，默认值为 10000。
