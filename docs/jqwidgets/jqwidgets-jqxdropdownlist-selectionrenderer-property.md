...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxddropdownlist-selectionrenderer-property/](https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-selectionrenderer-property/)
...
*selectionRenderer* 属性用于设置或返回在 jqxDropDownList 的内容区域中呈现所选项时调用的回调函数。它接受布尔类型值，默认值为空。
...
**示例:**以下示例说明了 jQWidgets 中的 jqxDropDownList*selectionRenderer*属性。
...
                    }
                    return "<b>Please Select Option</b>";
                }
            });
        });
    </script>
...
![](img/ac1de451eabf3163a7f22eccec668cbc.png)
