...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdocking-dragstart-event/](https://www.geeksforgeeks.org/jqwidgets-jqxdocking-dragstart-event/)
...
当用户开始拖动指定 `jqxDocking` 的窗口时，触发 `dragStart` 事件。
...
以下示例说明了 `jQWidgets` 的 `dragStart` 事件。
