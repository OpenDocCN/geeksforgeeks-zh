...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxbullethart-tooltipformatformation-property/](https://www.geeksforgeeks.org/jqwidgets-jqxbulletchart-tooltipformatfunction-property/)
...
*工具提示格式功能*属性用于设置或返回 bulletcharts 的工具提示格式功能。它接受函数类型值，默认值为 null。
...
**示例:**以下示例说明了 jQWidgets 中的 jqxbullethart*tooltipformatformation*属性。
