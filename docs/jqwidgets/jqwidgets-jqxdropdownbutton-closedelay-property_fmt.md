# jQWidgets jqxDropDownButton closeDelay 属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdropdownbutton-closedelay-property/](https://www.geeksforgeeks.org/jqwidgets-jqxdropdownbutton-closedelay-property/)
...
`closeDelay` 属性用于设置或获取显示的下拉按钮的关闭动画的延迟。它属于数字类型，默认值为 400。
...
下面的示例说明了 `jQWidgets` 中的 `jqxDropDownButton` `closeDelay` 属性。
