...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxbutton-imgheight-property/](https://www.geeksforgeeks.org/jqwidgets-jqxbutton-imgheight-property/)
...
`imgHeight` 属性用于设置或获取显示按钮图像的高度。它属于数字类型，默认值为 16。
...
以下示例说明了 jQWidgets 中的 `jqxButton` `imgHeight` 属性。
