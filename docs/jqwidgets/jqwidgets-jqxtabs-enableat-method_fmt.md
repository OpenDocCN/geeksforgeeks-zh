...
> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxtabs-enableat-method/](https://www.geeksforgeeks.org/jqwidgets-jqxtabs-enableat-method/)
...
`enableAt()` 方法用于启用给定索引的标签。它接受数字类型的单参数索引。索引从 0 开始。它不返回值。

## 语法

```html
$('Selector').jqxTabs('enableAt', index);
```
...
下面的例子说明了 jQWidgets `jqxTabs` `enableAt()` 方法。
...
<body>
    <center>
        ...
        <h3>
            jQWidgets jqxTabs enableAt() Method
        </h3>
...
![](img/1e0874ef635e9107e4cb7153268fa4fb.png)
