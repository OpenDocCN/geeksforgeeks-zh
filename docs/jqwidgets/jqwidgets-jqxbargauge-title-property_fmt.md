...
> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxbargauge-title-property/](https://www.geeksforgeeks.org/jqwidgets-jqxbargauge-title-property/)
...
从[这个](https://www.jqwidgets.com/download/)链接下载 `jQWidgets`。在 `HTML` 文件中，找到下载文件夹中的脚本文件：
...
以下示例说明了 `jQWidgets` 中的 `jqxBarGauge` `title` 属性：
