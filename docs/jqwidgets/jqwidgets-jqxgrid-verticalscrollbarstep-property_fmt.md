# jQWidgets jqxGrid verticalscrollbarstep 属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxgrid-verticalscrollbarstep-property/](https://www.geeksforgeeks.org/jqwidgets-jqxgrid-verticalscrollbarstep-property/)

**jQWidgets** 是一个 JavaScript 框架，用于为 PC 和移动设备制作基于 web 的应用程序。它是一个非常强大、优化、独立于平台并且得到广泛支持的框架。`jqxGrid` 用于说明以表格形式显示数据的 jQuery 小部件。此外，它完全支持与数据的连接，以及分页、分组、排序、过滤和编辑。

每当用户点击滚动条的箭头时，`verticalscrollbarstep` 属性用于设置或获取滚动条的步骤。它属于数字类型，其默认值为 5。

## 语法

*   设置 `verticalscrollbarstep` 属性。

```html
$('#Selector').jqxGrid({ verticalscrollbarstep: 10});
```

*   返回 `verticalscrollbarstep` 属性。
...
以下示例说明了 jQWidgets 中的 `jqxGrid` `verticalscrollbarstep` 属性。
...
<body>
    <center>
        ...
        <h3>jQWidgets jqxGrid verticalscrollbarstep property</h3>
        <br />
        <div id="jqxg"></div>
        <div>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#jqxBtn").on("click", function () {
                var vss = $('#jqxg').jqxGrid('verticalscrollbarstep');
                $('#log').text("Steps: " + vss);
            });
        });
    </script>
...
![](img/ee09806293acd82151b684ccbf79b157.png)
