...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxbutton-disabled-property/](https://www.geeksforgeeks.org/jqwidgets-jqxbutton-disabled-property/)
...
`disabled` 属性用于启用或禁用所需按钮。为布尔类型，默认值为 `false`。
...
以下示例说明了 jQWidgets 中的 `jqxButton` `disabled` 属性。
