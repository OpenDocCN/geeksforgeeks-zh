...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxribbon-refresh-method/](https://www.geeksforgeeks.org/jqwidgets-jqxribbon-refresh-method/)
...
`refresh()`方法用于刷新`jqxRibbon`小部件。它不接受任何参数，也不返回值。
