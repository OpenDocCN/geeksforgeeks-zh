# jQWidgets jqxCalendar columnHeaderHeight 属性

> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxcalendar-columnheaderheight-property/](https://www.geeksforgeeks.org/jqwidgets-jqxcalendar-columnheaderheight-property/)
...
`columnHeaderHeight` 属性用于设置或返回日历列标题的高度。列标题用于显示日历日名称。它接受数字类型值，默认值为 20。
...
下面的示例说明了 `jQWidgets` 中的 `jqxCalendar` `columnHeaderHeight` 属性。
...
![](img/72e2d2526b19f5b37c7cf72a4e383fb4.png)
