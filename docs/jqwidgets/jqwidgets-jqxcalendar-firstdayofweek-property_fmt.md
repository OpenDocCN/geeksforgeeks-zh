# jQWidgets jqxCalendar firstDayOfWeek 属性

> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxcalendar-firstdayofweek-property/](https://www.geeksforgeeks.org/jqwidgets-jqxcalendar-firstdayofweek-property/)
...
`firstDayOfWeek` 属性用于设置或返回显示在第一天列中的日期。默认情况下，“星期日”是日历的第一天。它接受数字类型值，默认值为 0。
