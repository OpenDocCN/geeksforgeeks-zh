# jQWidgets jqxExpander 销毁()方法

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxexpander-destroy-method/](https://www.geeksforgeeks.org/jqwidgets-jqxexpander-destroy-method/)
...
**销毁()**方法用于销毁膨胀机。它不接受任何参数，也不返回值。

**语法:**

```html
$('Selector').jqxExpander('destroy');
```
...
下面的例子说明了 jQWidgets jqxExpander destroy()方法。
...
![](img/2158cbf0282536bac81480f1b3acd907.png)
