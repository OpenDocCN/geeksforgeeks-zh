# jQWidgets jqxMenu animationShowDuration 属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxmenu-animationshowduration-property/](https://www.geeksforgeeks.org/jqwidgets-jqxmenu-animationshowduration-property/)
...
`animationShowDuration` 属性用于设置或返回表演动画的持续时间。它接受数字类型值，默认值为 350。

## 语法

设置 `animationShowDuration` 属性。
...
下面的例子说明了 jQWidgets jqxMenu `animationShowDuration` 属性。
