# jQWidgets jqxLoader isModal 属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxloader-ismodal-property/](https://www.geeksforgeeks.org/jqwidgets-jqxloader-ismodal-property/)
...
`isModal` 属性用于设置或返回显示为模态对话框的加载器元素。接受布尔类型值，默认值为 `假`。
...
下面的示例说明了 jQWidgets `jqxLoader` `isModal` 属性。
