...
> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxbulletchart-render-method/](https://www.geeksforgeeks.org/jqwidgets-jqxbulletchart-render-method/)
...
`render()` 方法用于渲染 `jqxBulletChart` 小部件。它不接受任何参数，也不返回值。

## 语法

```html
$('.selector').jqxBulletChart('render');
```
...
以下示例说明了 jQWidgets 中的 `jqxBulletChart` `render()`方法。
...
<body>
    <center>
        ...
        <h3>
            jQWidgets jqxBulletChart render() Method
        </h3>
...
![](img/7c03716e5bf634437c5b0b1769a786e6.png)
