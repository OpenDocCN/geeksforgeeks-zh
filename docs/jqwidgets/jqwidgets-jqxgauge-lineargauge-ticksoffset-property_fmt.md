...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxgauge-lineargauge-ticksoffset-property/](https://www.geeksforgeeks.org/jqwidgets-jqxgauge-lineargauge-ticksoffset-property/)
...
**示例:** 下面的示例说明了 jQWidgets 中的 `jqxLinearGauge` `ticksOffset` 属性。
