...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxexpander-focus-method/](https://www.geeksforgeeks.org/jqwidgets-jqxexpander-focus-method/)
...
`focus()` 方法用于对焦扩展器。对焦后可以使用键盘导航。它不接受任何参数，也不返回值。

## 语法

```javascript
$('Selector').jqxExpander('focus');
```

## 示例

首先，从给定的链接 [https://www.jqwidgets.com/download/](https://www.jqwidgets.com/download/) 下载 `jQWidgets`。在 HTML 文件中，找到下载文件夹中的脚本文件并引入。
...
下面的例子说明了 `jQWidgets` `jqxExpander` `focus()` 方法。
...
![](img/5b13ad89649bf7e029a996b3b0dea431.png)
