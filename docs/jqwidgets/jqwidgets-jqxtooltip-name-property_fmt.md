...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxtooltip-name-property/](https://www.geeksforgeeks.org/jqwidgets-jqxtooltip-name-property/)
...
下面的示例说明了 `jQWidgets` `jqxTooltip` `name` 属性。
