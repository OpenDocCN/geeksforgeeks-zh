# jQWidgets jqxRibbon 滚动位置属性

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxribbon-scroll position-property/](https://www.geeksforgeeks.org/jqwidgets-jqxribbon-scrollposition-property/)
...
**滚动条位置属性**用于设置或返回滚动条按钮的位置。它接受字符串类型的值，默认值为“两者”。
...
下面的例子说明了 jQWidgets jqxRibbon scroll position 属性。
...
        <h3>
            jQWidgets jqxRibbon scrollPosition Property
        </h3>
    </center>
...
![](img/b3e9863846f9e6f1beb79b3ecc800129.png)
