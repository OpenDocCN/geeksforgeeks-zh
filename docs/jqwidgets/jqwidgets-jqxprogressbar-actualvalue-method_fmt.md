...
> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxprogressbar-actualvalue-method/](https://www.geeksforgeeks.org/jqwidgets-jqxprogressbar-actualvalue-method/)
...
### `actualValue()`方法
`actualValue()`方法用于设置进度条的值。它接受数字类型的单个参数值，不返回任何值。
