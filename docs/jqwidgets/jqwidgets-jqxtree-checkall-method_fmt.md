...
> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxtree-checkall-method/](https://www.geeksforgeeks.org/jqwidgets-jqxtree-checkall-method/)
...
`checkAll()`方法用于检查树小部件的所有项目。它不接受任何参数，也不返回值。

### 语法：
```html
$('Selector').jqxTree('checkAll');
```
...
下面的例子说明了 jQWidgets jqxTree `checkAll()`方法。
...
### 输出：
![](img/01531f8cd2f9d53af6a681ce1d3c4932.png)
