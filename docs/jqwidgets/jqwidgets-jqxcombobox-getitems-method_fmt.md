...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxcombobox-getitems-method/](https://www.geeksforgeeks.org/jqwidgets-jqxcombobox-getitems-method/)
...
`getItems()` 方法用于从 `jqxComboBox` 获取所有物品。它不接受任何参数，并返回一个项目数组。
...
**示例:** 下面的示例说明了 `jQWidgets` 中的 `jqxComboBox` `getItems()` 方法。
...
<body>
    <center>
        ...
        <div id='jqxCB'></div>
        <br>
        <input type="button" id='jqxBtn' style="padding: 5px 20px;" value="Get Items" />
    </center>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#jqxBtn').on('click', function () {
                alert("First Option: " + item1.label + ", Last Option: " + item2.label);
            });
        });
    </script>
</body>
...
![](img/18add08ea32acc9e560f13a24280e648.png)
