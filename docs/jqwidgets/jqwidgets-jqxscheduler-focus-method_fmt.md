...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxscheduler-focus-method/](https://www.geeksforgeeks.org/jqwidgets-jqxscheduler-focus-method/)
...
`focus()` 方法用于聚焦显示的 `jqxScheduler`。它没有参数，也不返回任何内容。
...
<script type="text/javascript" src="jqwidgets/*"></script>
```
