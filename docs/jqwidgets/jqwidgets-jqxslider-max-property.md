# jQWidgets jqxSlider 最大属性

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxslider-max-property/](https://www.geeksforgeeks.org/jqwidgets-jqxslider-max-property/)
...
max 属性用于设置或返回滑块小部件的最大值。它接受数字类型值，默认值为 10。
...
下面的例子说明了 jQWidgets jqxSlider max 属性。
...
![](img/4ca138f627083b19270c31ffc16249b7.png)
