...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-indeterminateitem-method/](https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-indeterminateitem-method/)
...
`indeterminateItem()` 方法用于设置项目的不确定状态。它不接受任何参数，也不返回值。
...
**示例:** 下面的示例说明了 `jQWidgets` 中的 `jqxDropDownList` `indeterminateItem()` 方法。
