...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxradiobutton-boxsize-property/](https://www.geeksforgeeks.org/jqwidgets-jqxradiobutton-boxsize-property/)
...
`boxSize` 属性用于设置或返回 `jqxRadioButton` 小部件的大小。它接受字符串类型值，默认值为“13px”。
