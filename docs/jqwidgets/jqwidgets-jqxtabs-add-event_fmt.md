...
> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxtabs-add-event/](https://www.geeksforgeeks.org/jqwidgets-jqxtabs-add-event/)
...
`添加事件`用于在 `jqxTabs` 小部件中添加新标签时触发。

**语法：**

```javascript
$('Selector').on('add', function (event) { });
```
...
下面的例子说明了 jQWidgets `jqxTabs` `添加事件`。
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#jqxBtn').click(function () {
                $('#jqxTabs').jqxTabs('addLast', 'JavaScript', 
...
![](img/bdd7ee432ad3715bd3c9c0d174089a0d.png)
