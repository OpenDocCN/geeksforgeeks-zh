# jqwidgets jqxlistox removeItem()方法

> [https://www.geeksforgeeks.org/jqwidgets-jqxlistbox-removeitem-method/](https://www.geeksforgeeks.org/jqwidgets-jqxlistbox-removeitem-method/)
...
`removeItem()` 方法用于移除列表框的项目。它不返回任何东西。
...
**示例:** 下面的示例说明了 jQWidgets 中的 `jqxListBox` `removeItem()` 方法。
...
![](img/4c06083db3606d4d08cfd3080c89a013.png)
