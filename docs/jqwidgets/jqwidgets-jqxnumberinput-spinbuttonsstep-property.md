# jQWidgets jqxnumber input spinnettonsstep 属性

> 原文:[https://www . geeksforgeeks . org/jqwidgets-jqxnumberinput-spinbutenstep-property/](https://www.geeksforgeeks.org/jqwidgets-jqxnumberinput-spinbuttonsstep-property/)
...
**自旋按钮步长属性**用于设置或返回增加/减少步长。它接受数字类型值，默认值为 1。
...
下面的例子说明了 jQWidgets jqxnumber input spinButtonsStep 属性。
