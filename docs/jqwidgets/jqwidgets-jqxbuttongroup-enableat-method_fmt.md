...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxbuttongroup-enableat-method/](https://www.geeksforgeeks.org/jqwidgets-jqxbuttongroup-enableat-method/)
...
**示例:** 下面的示例说明了 jQWidgets 中的 `jqxButtonGroup` 的 `enableAt()` 方法。
