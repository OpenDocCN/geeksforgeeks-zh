...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxgrid-autoresizecolumns-method/](https://www.geeksforgeeks.org/jqwidgets-jqxgrid-autoresizecolumns-method/)
...
*   `cell`: 用于调整网格列的大小，以适应单元格文本。它是一个可选参数，类型为 string。
*   `column`: 用于调整列的大小，以适应列文本。它是一个可选参数，类型为 string。
...
<body>
    <center>
        ...
        <h3>jQWidgets jqxGrid autoresizecolumns() method</h3>
        <br />
        <div id="jqxg"></div>
        <div>
