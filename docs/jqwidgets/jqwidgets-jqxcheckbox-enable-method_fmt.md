...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxcheckbox-enable-method/](https://www.geeksforgeeks.org/jqwidgets-jqxcheckbox-enable-method/)
...
以下示例说明了 jQWidgets 中的 `jqxCheckBox` `enable()` 方法。
