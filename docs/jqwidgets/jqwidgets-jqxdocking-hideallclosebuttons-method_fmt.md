...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdocking-hideallclosebuttons-method/](https://www.geeksforgeeks.org/jqwidgets-jqxdocking-hideallclosebuttons-method/)
...
### 示例:
下面的示例说明了 jQWidgets `jqxDocking` `hideAllCloseButtons()` 方法。
