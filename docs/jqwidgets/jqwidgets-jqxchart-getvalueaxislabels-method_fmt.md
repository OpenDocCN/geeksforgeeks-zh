...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxchart-getvalueaxislabels-method/](https://www.geeksforgeeks.org/jqwidgets-jqxchart-getvalueaxislabels-method/)
...
`getValueAxisLabels()`方法用于获取值轴的标签坐标。它以 `groupIndex` 类型值为参数，取数字类型值，返回数组类型值。
