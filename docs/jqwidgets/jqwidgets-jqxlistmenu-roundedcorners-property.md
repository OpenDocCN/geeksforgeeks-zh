...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxlistmenu-roundedcorners-property/](https://www.geeksforgeeks.org/jqwidgets-jqxlistmenu-roundedcorners-property/)
...
**圆角属性**用于设置或返回小部件的圆角属性。它接受布尔类型值，默认值为真。
