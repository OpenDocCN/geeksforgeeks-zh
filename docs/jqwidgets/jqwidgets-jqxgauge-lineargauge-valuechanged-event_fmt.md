...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxgauge-lineargauge-valuechanged-event/](https://www.geeksforgeeks.org/jqwidgets-jqxgauge-lineargauge-valuechanged-event/)
...
以下示例说明了 `jQWidgets` 中的 `jqxLinearGauge` `valueChanged` 事件。
