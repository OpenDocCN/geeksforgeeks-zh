...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxddropdownlist-val-method/](https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-val-method/)
...
**val()方法**用于设置或返回所选值。它接受字符串类型的单个参数值，并返回字符串类型的值。
...
```html
$("Selector").jqxDropDownList('val', 'New Value'); // or
...
```html
var value = $("Selector").jqxDropDownList('val'); //or
...
下面的例子说明了 jQWidgets 中的 jqxDropDownList val()方法。
...
![](img/cb470f7edb44612f8d7ba2659fe3b7a6.png)
