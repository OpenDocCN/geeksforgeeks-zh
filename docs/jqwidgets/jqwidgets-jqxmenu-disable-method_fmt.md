...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxmenu-disable-method/](https://www.geeksforgeeks.org/jqwidgets-jqxmenu-disable-method/)
...
`disable()` 方法用于启用或禁用菜单小部件。它接受两个参数，第一个是字符串类型的项目标识，第二个是布尔类型值的值。它不返回值。
...
下面的例子说明了 jQWidgets `jqxMenu` `disable()` 方法。
...
![](img/77ead63470917352f9d87ac9aa4a112a.png)
