...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxsplitter-theme-property/](https://www.geeksforgeeks.org/jqwidgets-jqxsplitter-theme-property/)
...
`主题`属性用于为指定的 `jqxSplitter` 设置或获取主题。
...
以下示例说明了 `jQWidgets` `jqxSplitter` `主题` 属性。在下面的例子中，`主题`属性的值被设置为“energyblue”。
