...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxddropdownlist-height-property/](https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-height-property/)
...
*高度*属性用于设置或返回 jqxDropDownList 小部件的高度。它接受数字/字符串类型的值，默认值为空。
...
**示例:**以下示例说明了 jQWidgets 中的 jqxDropDownList *高度*属性。
