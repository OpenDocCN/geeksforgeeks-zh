# jQWidgets jqxResponsivePanel toggleButton 属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxresponsivepanel-togglebutton-property/](https://www.geeksforgeeks.org/jqwidgets-jqxresponsivepanel-togglebutton-property/)
...
`toggleButton` 属性用于设置或返回渲染 `toggleButton` 的元素。它接受字符串/对象类型值，默认值为空。
