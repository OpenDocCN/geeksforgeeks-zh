# jQWidgets jqxExpander toggleMode 属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxexpander-togglemode-property/](https://www.geeksforgeeks.org/jqwidgets-jqxexpander-togglemode-property/)
...
`toggleMode` 属性用于设置或返回用于扩展或折叠 `jqxExpander` 小部件内容的用户交互。它接受字符串类型值，默认值为“单击”。
...
**示例:** 以下示例说明了 jQWidgets `jqxExpander` `toggleMode` 属性。
