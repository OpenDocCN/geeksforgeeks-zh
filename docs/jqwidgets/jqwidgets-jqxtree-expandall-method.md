...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxtree-expandll-method/](https://www.geeksforgeeks.org/jqwidgets-jqxtree-expandall-method/)
...
**expandAll()方法**用于扩展 jqxTree 小部件的所有项目。它不接受任何参数，也不返回值。
