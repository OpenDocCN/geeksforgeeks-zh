# jQWidgets jqxDropDownList filter delay 属性

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxddropdownlist-filter delay-property/](https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-filterdelay-property/)
...
*滤波器延迟*属性用于设置或返回滤波器延迟。它接受数字类型的值，默认值为 100。
...
**示例:**以下示例说明了 jQWidgets 中的 jqxDropDownList*filter delay*属性。
