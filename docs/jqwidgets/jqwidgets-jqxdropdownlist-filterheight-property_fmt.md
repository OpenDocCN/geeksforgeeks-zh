# jQWidgets jqxDropDownList filterHeight 属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-filterheight-property/](https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-filterheight-property/)
...
`filterHeight` 属性用于设置或返回过滤器的高度。它接受数字类型值，默认值为 27。
