...
> 原文: [https://www.geeksforgeks.org/jqwidgets-jqxtooltip-open-event/](https://www.geeksforgeks.org/jqwidgets-jqxtooltip-opening-event/)
...
**示例:** 以下示例说明了 `jQWidgets` `jqxTooltip` `opening` 事件。
