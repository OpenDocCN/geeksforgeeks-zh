...
> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-disableitem-method/](https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-disableitem-method/)
...
下面的示例说明了 jQWidgets 中的 `jqxDropDownList` `disableItem()` 方法。
