...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxsortable-connectwith-property/](https://www.geeksforgeeks.org/jqwidgets-jqxsortable-connectwith-property/)
...
`connectWith` 属性用来做一个选择器，用来连接其他列表。它接受布尔/字符串类型的值，默认值为真。
...
以下示例说明了 jQWidgets 中的 `jqxSortable` `connectWith` 属性:
