# jQWidgets jqxnumber input negative 符号属性

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxnumberinput-negative symbol-property/](https://www.geeksforgeeks.org/jqwidgets-jqxnumberinput-negativesymbol-property/)
...
**否定符号属性**用于设置或返回用作否定符号的字符串。它接受字符串类型的值，默认值为“-”。
...
下面的例子说明了 jQWidgets jqxnumber input negative symbol 属性。
