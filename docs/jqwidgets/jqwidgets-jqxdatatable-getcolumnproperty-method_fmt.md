...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdatatable-getcolumnproperty-method/](https://www.geeksforgeeks.org/jqwidgets-jqxdatatable-getcolumnproperty-method/)
...
## 示例
下面的示例说明了 jQWidgets `getColumnProperty()` 方法。
