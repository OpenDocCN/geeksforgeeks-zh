...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxcombobox-selectitem-method/](https://www.geeksforgeeks.org/jqwidgets-jqxcombobox-selectitem-method/)
...
`selectItem()`方法用于使用项目值选择项目。它接受对象/字符串类型的单个参数`item`，并且不返回值。
...
以下示例说明了 jQWidgets 中的 `jqxComboBox` `selectItem()`方法:
...
<body>
    <center>
        ...
        <h3>
            jQWidgets jqxComboBox selectItem() Method
        </h3>
        <div id='jqxCB'></div>
        <br>
...
![](img/9eb408046a4fc5f6f11e58a68c840211.png)
