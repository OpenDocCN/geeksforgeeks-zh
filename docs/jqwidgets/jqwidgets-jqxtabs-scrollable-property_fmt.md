...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxtabs-scrollable-property/](https://www.geeksforgeeks.org/jqwidgets-jqxtabs-scrollable-property/)
...
## 滚动属性
`scrollable` 属性用于设置或返回是否启用滚动。它接受布尔类型值，默认值为 `true`。
...
下面的例子说明了 jQWidgets `jqxTabs` `scrollable` 属性。
...
## 输出
![](img/917ea628d9ffe1f251b7ee4fe2e215e1.png)
