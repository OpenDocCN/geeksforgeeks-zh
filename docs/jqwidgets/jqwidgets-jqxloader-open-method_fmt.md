...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxloader-open-method/](https://www.geeksforgeeks.org/jqwidgets-jqxloader-open-method/)
...
`open()`方法用于打开当前加载器元件。它不接受任何参数，也不返回值。
