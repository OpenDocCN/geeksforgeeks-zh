...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxtabs-closebuttonsize-property/](https://www.geeksforgeeks.org/jqwidgets-jqxtabs-closebuttonsize-property/)
...
**关闭按钮大小属性**用于设置或返回关闭按钮大小。它接受数字类型值，默认值为 `16`。
...
```javascript
$('selector').jqxTabs({ closeButtonSize: Number });
```

返回 `closeButtonSize` 属性。

```javascript
var closeButtonSize = $('selector').jqxTabs('closeButtonSize');
```
...
下面的例子说明了 `jQWidgets` `jqxTabs` `closeButtonSize` 属性。
...
<body>
    <center>
        ...
        <h3>
            jQWidgets jqxTabs closeButtonSize Property
        </h3>
...
![](img/b3e7d28e70c9c86328880bacb9c836d4.png)

**参考:** [https://www.jqwidgets.com/jquery-widgets-documentation/documentation/jqxtabs/jquery-tabs-api.htm](https://www.jqwidgets.com/jquery-widgets-documentation/documentation/jqxtabs/jquery-tabs-api.htm)