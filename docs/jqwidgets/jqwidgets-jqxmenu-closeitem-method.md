...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxmenu-closeitem-method/](https://www.geeksforgeeks.org/jqwidgets-jqxmenu-closeitem-method/)
...
**closeItem()方法**用于关闭菜单项。它接受字符串类型的单参数菜单项，不返回值。
