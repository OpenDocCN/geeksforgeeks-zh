# jQWidgets jqxDropDownList dropDownHorizontalAlignment 属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-dropdownhorizontalalignment-property/](https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-dropdownhorizontalalignment-property/)
...
`dropDownHorizontalAlignment` 属性用于设置或返回下拉列表的对齐方式。它接受字符串类型值，默认值为“左”。
...
下面的例子说明了 jQWidgets 中的 `jqxDropDownList` `dropDownHorizontalAlignment` 属性。
...
![](img/0d89687ebbebba026dde77713f198c5b.png)
