# jQWidgets jqxDropDownList 搜索模式属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-searchmode-property/](https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-searchmode-property/)
...
`searchMode` 属性用于设置或返回项目增量搜索模式。当用户在下拉列表中键入内容，并尝试使用输入的文本和选定的搜索模式来查找搜索到的项目时，将使用此属性。它接受字符串类型的值，默认值为 `"startswith"`。
...
以下示例说明了 jQWidgets 中的 `jqxDropDownList` `searchMode` 属性。
