...
> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxchart-tooltipshowdelay-property/](https://www.geeksforgeeks.org/jqwidgets-jqxchart-tooltipshowdelay-property/)
...
`toolTipShowDelay` 属性用于设置或返回工具提示显示属性。即该属性用于设置或返回以毫秒为单位显示延迟的工具提示。该值的范围可以从 0 到 10000 毫秒。它接受数字类型值，默认值为 500。
...
下面的示例说明了 `jQWidgets` 中的 `jqxChart` `toolTipShowDelay` 属性。
