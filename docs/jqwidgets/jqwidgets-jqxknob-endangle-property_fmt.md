...
> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxknob-endangle-property/](https://www.geeksforgeeks.org/jqwidgets-jqxknob-endangle-property/)
...
```javascript
var allowValueChangeOnClick = $('#jqxKnob').jqxKnob('endAngle');
```
...
以下示例说明了 jQWidgets `jqxKnob` 的 `endAngle` 属性。在下面的示例中，`endAngle` 属性的值被设置为 360。
