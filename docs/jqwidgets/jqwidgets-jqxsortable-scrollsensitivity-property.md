...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxsortable-scroll sensitivity-property/](https://www.geeksforgeeks.org/jqwidgets-jqxsortable-scrollsensitivity-property/)
...
**示例:**下面的示例说明了 jQWidgets 中的 jqxSortable **滚动敏感度属性**。
