...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxrating-itemheight-property/](https://www.geeksforgeeks.org/jqwidgets-jqxrating-itemheight-property/)
...
`itemHeight` 属性用于设置或返回评级项目的高度。它接受数字类型值，默认值为*自动*。
...
以下示例说明了 jQWidgets jqxRating `itemHeight` 属性。
