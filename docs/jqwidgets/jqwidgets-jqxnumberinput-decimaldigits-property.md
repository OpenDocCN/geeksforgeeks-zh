...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxnumberinput-decimaldigits-property/](https://www.geeksforgeeks.org/jqwidgets-jqxnumberinput-decimaldigits-property/)
...
下面的例子说明了 jQWidgets jqxNumberInput decimal gits 属性。
