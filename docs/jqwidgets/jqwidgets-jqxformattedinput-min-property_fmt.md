# jqxFormattedInput min 属性

> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxformattedinput-min-property/](https://www.geeksforgeeks.org/jqwidgets-jqxformattedinput-min-property/)
...
`min` 属性用于设置或返回小部件的最小值。它接受字符串类型的值，默认值是十进制的“-9223372036854775808”(-2⁶)。
