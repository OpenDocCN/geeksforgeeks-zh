# jqwidgets jqxNotification animationCloseDelay 属性

> 原文链接: https://www.geeksforgeeks.org/jqwidgets-jqxnotification-animationandcloseay-property/
...
以下示例说明了 jQWidgets 中的 `jqxNotification` `animationCloseDelay` 属性：
