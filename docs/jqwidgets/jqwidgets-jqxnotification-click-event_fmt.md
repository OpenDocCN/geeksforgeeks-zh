...
> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxnotification-click-event/](https://www.geeksforgeeks.org/jqwidgets-jqxnotification-click-event/)
...
以下示例说明了 `jQWidgets` 中的 `jqxNotification` `click` 事件。
