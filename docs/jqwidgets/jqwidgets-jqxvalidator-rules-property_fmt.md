...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxvalidator-rules-property/](https://www.geeksforgeeks.org/jqwidgets-jqxvalidator-rules-property/)
...
`rules` 属性用于为指定的 `jqxValidator` 设置规则。
...
以下示例说明了 jQWidgets `jqxValidator` 的 `rules` 属性。
