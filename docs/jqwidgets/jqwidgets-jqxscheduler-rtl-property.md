...
如果显示的 **jqxScheduler** 是否从右向左对齐，则***【RTL】***属性用于设置或返回。为布尔类型，默认值为*假*。
...
**示例:**下面的示例说明了 jQWidgets 中的 **jqxScheduler** *rtl* 属性。
...
        <h3>jQWidgets jqxScheduler rtl property
        </h3>
