...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxgrid-rowdoubleclick-event/](https://www.geeksforgeeks.org/jqwidgets-jqxgrid-rowdoubleclick-event/)
...
以下示例说明了 `jQWidgets` 中的 `jqxGrid` `rowdoubleclick` 事件。
...
<body>
    <center>
        ...
        <h3>jQWidgets jqxGrid rowdoubleclick Event</h3>
        <br/>
        <div id="jqxg"></div>
        <br />
        <div id="log"></div>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#jqxg").on("rowdoubleclick", function (event) {
                $('#log').html("Double clicked row index: " + event.args.rowindex);
            });
        });
    </script>
</body>
