...
> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxscrollbar-theme-property/](https://www.geeksforgeeks.org/jqwidgets-jqxscrollbar-theme-property/)
...
`theme` 属性用于设置或获取指定 `jqxScrollBar` 的主题。
...
下面的示例说明了 jQWidgets jqxScrollBar `theme` 属性。在以下示例中，`theme` 属性的值已设置为 `'energyblue'`。
