...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdatatable-sort-event/](https://www.geeksforgeeks.org/jqwidgets-jqxdatatable-sort-event/)

`jQWidgets` 是一个 JavaScript 框架，用于为 PC 和移动设备制作基于 web 的应用程序。它是一个非常强大、优化、独立于平台并且得到广泛支持的框架。`jqxDataTable` 用于读取和显示 HTML 表格中的数据。这也用于显示来自各种数据源的数据，如 XML、JSON、Array、CSV 或 TSV。

当指定 `jqxDataTable` 的排序顺序或排序列发生变化时，触发 `sort` 事件。
...
<body>
    <center>
        ...
        <h3>
            jQWidgets jqxDataTable sort Event
        </h3>
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                $("#Data_Table").on(
                    'sort', function (event) {
                        var args = event.args;
                        var Sort_Column = args.sortcolumn;
                        $("#log").html(JSON.
                            stringify(Sort_Column));
                    })
            });
        </script>
...
![](img/9b6fe888d99d4ee83fb59641bee36b29.png)
