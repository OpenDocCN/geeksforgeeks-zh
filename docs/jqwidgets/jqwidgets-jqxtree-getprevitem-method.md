# jqwidgets jqxtree get reviem()方法

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxtree-getprevitem-method/](https://www.geeksforgeeks.org/jqwidgets-jqxtree-getprevitem-method/)
...
**获取预览()方法**用于获取所选项目的上一个项目。它不接受任何参数，并返回对象类型值。
