...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdragdrop-data-property/](https://www.geeksforgeeks.org/jqwidgets-jqxdragdrop-data-property/)
...
`data` 属性用于设置或返回通过可拖动小部件传输的某种信息。它接受对象类型值，默认值为空。
...
以下示例说明了 jQWidgets 中的 `jqxDragDrop` `data` 属性。
