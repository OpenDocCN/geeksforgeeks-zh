...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxsortable-change-event/](https://www.geeksforgeeks.org/jqwidgets-jqxsortable-change-event/)
...
以下示例说明了 `jQWidgets` 中的 `jqxSortable` `change` 事件。
