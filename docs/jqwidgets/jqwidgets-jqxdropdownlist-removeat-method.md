...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxddropdownlist-remove at-method/](https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-removeat-method/)
...
removeAt()方法用于使用索引号从列表框中移除一个项目。它接受数字类型的单个参数索引，并且不返回任何值。索引从 0 开始。
