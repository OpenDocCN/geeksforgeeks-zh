...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxnumberinput-clear-method/](https://www.geeksforgeeks.org/jqwidgets-jqxnumberinput-clear-method/)
...
`clear()`方法用于清除小部件中的值。它不接受任何参数，也不返回值。
