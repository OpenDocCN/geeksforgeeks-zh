...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxtabs-removeat-method/](https://www.geeksforgeeks.org/jqwidgets-jqxtabs-removeat-method/)
...
`removeAt()` 方法用于删除特定索引的选项卡。它接受数字类型的单个参数 `index`。索引从 0 开始。它不返回值。
...
下面的例子说明了 jQWidgets jqxTabs `removeAt()` 方法。
...
<body>
    <center>
        ...
        <h3>
            jQWidgets jqxTabs removeAt() Method
        </h3>
        ...
        <input id="jqxBtn" type="button" 
            value="Remove Tab of Given Index" 
...
![](img/4f34f9413be75d087bd37f507fddf1ca.png)
