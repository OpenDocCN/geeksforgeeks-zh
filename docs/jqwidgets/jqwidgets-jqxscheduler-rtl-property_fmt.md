# jQWidgets jqxScheduler rtl 属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxscheduler-rtl-property/](https://www.geeksforgeeks.org/jqwidgets-jqxscheduler-rtl-property/)
...
如果显示的 **jqxScheduler** 是否从右向左对齐，则 `rtl` 属性用于设置或返回。为布尔类型，默认值为 `false`。
...
```html
$("#Selector").jqxScheduler({ rtl: true });
```

*   获取 `rtl` 属性。

```html
var rtl = $('#Selector').jqxScheduler('rtl');
```
...
下面的示例说明了 jQWidgets 中的 **jqxScheduler** `rtl` 属性。
...
<body>
    <center>
        ...
        <h3>jQWidgets jqxScheduler rtl property</h3>
        <div id="jqxs"></div>
        <div>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#jqxBtn").on("click", function () {
                var r = $('#jqxs').jqxScheduler('rtl');
                $('#log').text("Aligned right to left: " + r);
            });
        });
    </script>
</body>
...
![](img/54f549ec818794f130bfe5b1d3818238.png)
