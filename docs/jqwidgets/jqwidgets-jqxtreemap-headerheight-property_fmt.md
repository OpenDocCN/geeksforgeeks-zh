...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxtreemap-headerheight-property/](https://www.geeksforgeeks.org/jqwidgets-jqxtreemap-headerheight-property/)
...
`headerHeight` 属性用于设置或获取指定 `jqxTreeMap` 的父扇区表头高度。此属性接受数值。
...
以下示例说明了 jQWidgets `jqxTreeMap` `headerHeight` 属性。在下面的例子中，`headerHeight` 属性的值被设置为 23。
