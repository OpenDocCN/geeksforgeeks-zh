...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-clear-method/](https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-clear-method/)
...
下面的示例说明了 jQWidgets 中的 `jqxDropDownList` `clear()` 方法。
