# jQWidgets jqxDropDownList scrollBarSize 属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-scrollbarsize-property/](https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-scrollbarsize-property/)
...
`scrollBarSize` 属性用于设置或返回滚动条的大小。它接受数字类型值，默认值为 17。
...
下面的示例说明了 `jQWidgets` 中的 `jqxDropDownList` `scrollBarSize` 属性。
...
![](img/3945653b9db48adf4d3a15db257ef315.png)
