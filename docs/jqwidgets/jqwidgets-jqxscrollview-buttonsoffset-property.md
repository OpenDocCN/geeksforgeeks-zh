# jQWidgets jqxScrollView 按钮集合属性

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxscrollview-button soffset-property/](https://www.geeksforgeeks.org/jqwidgets-jqxscrollview-buttonsoffset-property/)
...
*按钮设置*属性用于设置或返回小部件*按钮设置*属性。它设置与导航按钮默认位置的偏移量。它接受数组类型值，默认值为[0，0]。
...
**示例:**以下示例说明了 jQWidgets 中的 jqxScrollView *按钮集合*属性。
