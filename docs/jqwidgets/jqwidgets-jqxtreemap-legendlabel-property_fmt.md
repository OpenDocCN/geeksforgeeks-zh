# jqwidgets jqxtreeMap legendLabel 属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxtreemap-legendlabel-property/](https://www.geeksforgeeks.org/jqwidgets-jqxtreemap-legendlabel-property/)
...
下面的示例说明了 jQWidgets `jqxTreeMap` 的 `legendLabel` 属性。在下面的例子中，`legendLabel` 属性的值被设置为“TreeMap”。
