...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxcombobox-show arrow-property/](https://www.geeksforgeeks.org/jqwidgets-jqxcombobox-showarrow-property/)
...
**显示箭头属性**用于设置或返回表示其下拉按钮的 jqxComboBox。它接受布尔类型值，默认值为真。
