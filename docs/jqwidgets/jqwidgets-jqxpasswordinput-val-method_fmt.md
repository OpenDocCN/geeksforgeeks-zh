...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxpasswordinput-val-method/](https://www.geeksforgeeks.org/jqwidgets-jqxpasswordinput-val-method/)
...
`val()` 方法用于设置或返回小部件的值。它不接受任何参数，也不返回值。
...
**参考:** [https://www.jqwidgets.com/jquery-widgets-documentation/documentation/jqxpasswordinput/jquery-password-input-api.htm](https://www.jqwidgets.com/jquery-widgets-documentation/documentation/jqxpasswordinput/jquery-password-input-api.htm)