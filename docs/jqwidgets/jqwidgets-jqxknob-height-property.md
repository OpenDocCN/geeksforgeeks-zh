# jQWidgets jqxKnob 高度属性

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxknob-height-property/](https://www.geeksforgeeks.org/jqwidgets-jqxknob-height-property/)
...
*   用于设置*高度*属性。
    ...
    ```html
    $('#jqxKnob').jqxKnob({height: 400 });
    ```

*   获得*高度*属性。

    ```html
    var allowValueChangeOnClick = $('#jqxKnob').jqxKnob('height');
    ```
...
**示例:**以下示例说明了 jQWidgets jqxKnob ***高度*** 属性。在以下示例中， ***高度*** 属性的值已设置为 400。
...
            GeeksforGeeks
        </h1>
        <h3> jQWidgets jqxKnob height Property </h3>
        <div id='jqx_Knob'>
        </div>
...
![](img/7bb7779085ea58920f87695848cbed1e.png)
