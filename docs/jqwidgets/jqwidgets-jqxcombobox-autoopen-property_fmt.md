...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxcombobox-autoopen-property/](https://www.geeksforgeeks.org/jqwidgets-jqxcombobox-autoopen-property/)
...
`autoOpen` 属性用于设置或返回鼠标光标移动时下拉菜单是否自动打开。它接受布尔类型值，默认值为假。
...
以下示例说明了 jQWidgets 中的 `jqxComboBox` `autoOpen` 属性:
