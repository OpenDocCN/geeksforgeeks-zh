...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxtreegrid-collapserow-method/](https://www.geeksforgeeks.org/jqwidgets-jqxtreegrid-collapserow-method/)
...
下面的示例说明了 jQWidgets jqxTreeGrid `collapseRow()` 方法。在下面的示例中，第三行将被折叠。
      ...
      <center>
         ...
         <script type="text/javascript">
            $(document).ready(function () {
                ...
                $('#button_for_collapseRow').click(function () {
                    $("#jqxTreeGrid").jqxTreeGrid('collapseRow', 3);
                });
            });
         </script>
      </center>
