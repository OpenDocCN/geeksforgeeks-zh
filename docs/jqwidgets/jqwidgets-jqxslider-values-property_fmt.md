# jQWidgets jqxSlider `values` 属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxslider-values-property/](https://www.geeksforgeeks.org/jqwidgets-jqxslider-values-property/)
...
`values` 属性用于设置或返回范围滑块的值。对于此属性，`rangeSlider` 属性应设置为 `true`。它接受数组类型值，默认值为 `[0, 10]`。
...
下面的例子说明了 jQWidgets `jqxSlider` `values` 属性。
...
<body>
    <center>
        ...
        <h3>
            jQWidgets jqxSlider values Property
        </h3>
        <div id='content'>
...
![](img/627375342e0eaf0ad1042e26eb8e9308.png)
