# jQWidgets jqxSlider rtl 物业

> 原文:[https://www . geeksforgeeks . org/jqwidgets-jqxslider-RTL-property/](https://www.geeksforgeeks.org/jqwidgets-jqxslider-rtl-property/)
...
**rtl 属性**用于设置或返回一个值，该值指示 jqxSlider 小部件元素是否对齐以支持使用从右向左字体的区域设置。它接受布尔类型值，默认值为 false。
...
```html
$('selector').jqxSlider({ rtl: Boolean });
```

归还 rtl 的财产。

```html
var rtl = $('selector').jqxSlider('rtl');
```
...
下面的例子说明了 jQWidgets jqxSlider rtl 属性。
...
![](img/39d9240c0e519d7695a3dee2ad3dd1be.png)
