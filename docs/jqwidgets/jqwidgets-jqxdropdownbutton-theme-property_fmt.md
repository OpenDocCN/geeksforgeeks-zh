# jQWidgets jqxDropDownButton 按钮主题属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdropdownbutton-theme-property/](https://www.geeksforgeeks.org/jqwidgets-jqxdropdownbutton-theme-property/)
...
这一对 CSS 文件由 jQWidgets 使用，即 `jqx.base.css` 和 `jqx.[theme-name].css`。基本样式表用于生成与小部件布局相关的样式，如边框宽度、填充、边距、位置。小部件的颜色和背景可以通过使用第二个 CSS 文件来应用。
