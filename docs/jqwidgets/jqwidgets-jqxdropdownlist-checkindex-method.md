...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxdropdownlist-check index-method/](https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-checkindex-method/)
...
当“复选框”属性值设置为真时， **checkIndex()** 方法用于检查列表项。它接受数字类型的单个参数索引，并且不返回任何值。索引从 0 开始。
...
**示例:**下面的示例说明了 jQWidgets 中的 jqxDropDownList**checkIndex()**方法。
