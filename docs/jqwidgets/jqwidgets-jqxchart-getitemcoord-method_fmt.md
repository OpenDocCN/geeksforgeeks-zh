...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxchart-getitemcoord-method/](https://www.geeksforgeeks.org/jqwidgets-jqxchart-getitemcoord-method/)
...
`getItemCoord()`方法用于获取数据点的坐标。它将 `groupIndex`、`serieIndex` 和 `itemIndex` 类型作为数字类型的参数，并将坐标作为对象类型返回。
...
下面的示例说明了 `jQWidgets` 中的 `jqxHeatMap` `getItemCoord()`方法:
...
[https://www.jqwidgets.com/jquery-widgets-documentation/documentation/jqxchart/jquery-chart-api.htm](https://www.jqwidgets.com/jquery-widgets-documentation/documentation/jqxchart/jquery-chart-api.htm)