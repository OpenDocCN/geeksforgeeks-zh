# jQWidgets jqxChart 源属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxchart-source-property/](https://www.geeksforgeeks.org/jqwidgets-jqxchart-source-property/)
...
`source` 属性用于设置或返回源属性。即该属性用于设置或返回 `jqxChart` 源。它接受对象类型值，默认值为 `null`。
...
以下示例说明了 `jQWidgets` 中的 `jqxChart` `source` 属性:
