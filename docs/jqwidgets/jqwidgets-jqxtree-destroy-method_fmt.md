...
> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxtree-destroy-method/](https://www.geeksforgeeks.org/jqwidgets-jqxtree-destroy-method/)
...
`destroy()`方法用于销毁 `jqxTree` 小部件。它不接受任何参数，也不返回值。
