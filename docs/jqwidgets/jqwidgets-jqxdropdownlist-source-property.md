# jQWidgets jqxDropDownList 源属性

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxddropdownlist-source-property/](https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-source-property/)
...
*来源*属性用于设置或返回项目的来源。它接受数组类型值，默认值为空。
...
**示例:**以下示例说明了 jQWidgets 中的 jqxDropDownList *源*属性。
...
![](img/24456165a2cb97c3e1d92580607a71e4.png)
