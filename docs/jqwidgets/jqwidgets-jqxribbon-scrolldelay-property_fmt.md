...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxribbon-scrolldelay-property/](https://www.geeksforgeeks.org/jqwidgets-jqxribbon-scrolldelay-property/)
...
`scrollDelay` 属性用于设置或返回滚动延迟。它接受数字类型值，默认值为 50。
