...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxribbon-mode-property/](https://www.geeksforgeeks.org/jqwidgets-jqxribbon-mode-property/)
...
`模式`属性用于设置或返回功能区的显示模式。它接受字符串类型值，其默认值为“默认值”。
