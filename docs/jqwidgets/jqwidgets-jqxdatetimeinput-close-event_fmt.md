...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdatetimeinput-close-event/](https://www.geeksforgeeks.org/jqwidgets-jqxdatetimeinput-close-event/)
...
以下示例说明了 `jQWidgets` 中的 `jqxDateTimeInput` `close` 事件。
