# jQWidgets jqxPopover 偏移属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxpopover-offset-property/](https://www.geeksforgeeks.org/jqwidgets-jqxpopover-offset-property/)
...
`offset` 属性用于设置或获取指定 `jqxPopover` 小部件与其位置的偏移量。
...
### 示例:
下面的示例说明了 `jQWidgets` `jqxPopover` `offset` 属性。在以下示例中，`offset` 属性的值已设置为 `{left: 25, top: 25}`。
