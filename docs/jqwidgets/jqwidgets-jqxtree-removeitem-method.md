...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxtree-remove item-method/](https://www.geeksforgeeks.org/jqwidgets-jqxtree-removeitem-method/)
...
**removeItem()方法**用于从小部件中移除一个项目。它接受对象类型的单个参数项，不返回任何值。
