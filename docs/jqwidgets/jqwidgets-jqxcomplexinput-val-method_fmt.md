...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxcomplexinput-val-method/](https://www.geeksforgeeks.org/jqwidgets-jqxcomplexinput-val-method/)
...
`val()` 方法用于设置或返回小部件的值。它接受字符串/对象类型值的单个参数值，并返回字符串类型值。
