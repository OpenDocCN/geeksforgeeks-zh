...
> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxform-destroy-method/](https://www.geeksforgeeks.org/jqwidgets-jqxform-destroy-method/)
...
`destroy()` 方法用于销毁 `jqxForm` 元素。它不接受任何参数，也不返回值。
