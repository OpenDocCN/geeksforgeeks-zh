# jQWidgets jqxResponsivePanel is call 馥郁()方法

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxresponsevepanel-is called-method/](https://www.geeksforgeeks.org/jqwidgets-jqxresponsivepanel-iscollapsed-method/)
...
**IsCollabged()方法**返回小部件的布尔值。如果面板折叠或展开，它将返回 true 或 false。它不接受任何参数，并返回一个布尔值。
...
下面的例子说明了 jQWidgets 中的 jqxResponsivePanel is call 馥()方法。
