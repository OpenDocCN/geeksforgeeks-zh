...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxgauge-lineargauge-max-property/](https://www.geeksforgeeks.org/jqwidgets-jqxgauge-lineargauge-max-property/)
...
以下示例说明了 jQWidgets 中的 `jqxLinearGauge` `max` 属性。
