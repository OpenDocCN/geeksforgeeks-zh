...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxtoolbar-inittools-property/](https://www.geeksforgeeks.org/jqwidgets-jqxtoolbar-inittools-property/)
...
**初始化工具属性**是一个回调函数，因此可以对工具属性中所述的工具进行设置。它属于函数类型，其默认值为 null。
...
*   **类型:**是工具属性中定义的工具的指定类型。
*   **指数:**是规定的指数。
*   **工具:**它是一个给定的 jQuery 对象，表示工具。
*   **菜单自动初始化:**它指定是为工具栏工具调用 initTools 属性，即该值为假，还是为弹出菜单工具调用 initTools 属性，即该值为真。它属于布尔类型。
