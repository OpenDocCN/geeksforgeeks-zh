...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxtree-checkles-property/](https://www.geeksforgeeks.org/jqwidgets-jqxtree-checkboxes-property/)
...
**复选框属性**用于设置或返回是否给项目添加复选框。要使用这个特性，需要包含 jqxcheckbox.js，它接受布尔类型值，默认值为 false。
...
下面的示例说明了 jQWidgets jqxTree 复选框属性。
