# jQWidgets jqxTree 复选框属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxtree-checkboxes-property/](https://www.geeksforgeeks.org/jqwidgets-jqxtree-checkboxes-property/)
...
``checkboxes`` 属性用于设置或返回是否给项目添加复选框。要使用这个特性，需要包含 ``jqxcheckbox.js``，它接受布尔类型值，默认值为 ``false``。
...
下面的示例说明了 jQWidgets ``jqxTree`` ``checkboxes`` 属性。
...
<body>
    ...
    <h3>
        jQWidgets jqxTree checkboxes Property
    </h3>
...
![](img/acc7f09dec02f1392892b18c7c362874.png)
