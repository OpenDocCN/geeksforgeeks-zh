...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxslider-showrange-property/](https://www.geeksforgeeks.org/jqwidgets-jqxslider-showrange-property/)
...
`showRange` 属性用于设置或返回是否显示滑块范围背景。它接受布尔类型值，默认值为 `true`。
