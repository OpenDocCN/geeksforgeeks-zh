# jqwidget jqxdatetimeinput 验证字符串属性

> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxdatetimeinput-todaystring-property/](https://www.geeksforgeeks.org/jqwidgets-jqxdatetimeinput-todaystring-property/)
...
当 `showFooter` 属性设置为 `true` 时，`todayString` 属性用于设置或返回显示在下拉列表中的“今日”字符串。它接受字符串类型的值，默认值为 `"Today"`。
...
以下示例说明了 jQWidgets 中的 `jqxDateTimeInput` 的 `todayString` 属性。
...
<body>
    <center>
        ...
        <h3>
            jQWidgets jqxDateTimeInput todayString Property
        </h3>
...
![](img/92ef289ac9a32c4f3ee8873bc2809c66.png)
