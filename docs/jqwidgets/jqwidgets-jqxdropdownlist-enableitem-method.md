# jQWidgets jqxDropDownList enable item()方法

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxddropdownlist-enable item-method/](https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-enableitem-method/)
...
**enableItem()方法**用于启用一个项目。它接受字符串/对象类型的单个参数项，并且不返回值。
...
```html
$("Selector").jqxDropDownList('enableItem', item );
```
...
下面的例子说明了 jQWidgets 中的 jqxDropDownList enableItem()方法。
...
        <input id="jqxBtn" type="button" value="Enable Item" 
...
![](img/34c61038f0abb537ad4b905e20bd0734.png)
