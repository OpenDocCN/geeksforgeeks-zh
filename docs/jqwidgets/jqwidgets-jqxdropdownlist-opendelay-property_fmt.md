# jQWidgets jqxDropDownList openDelay 属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-opendelay-property/](https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-opendelay-property/)
...
`openDelay` 属性用于设置或返回“打开”动画的延迟。它接受数字类型值，默认值为 350。
...
下面的示例说明了 jQWidgets 中的 `jqxDropDownList` `openDelay` 属性。
...
![](img/72b2d415cce5bda961ed12fd6a898a53.png)
