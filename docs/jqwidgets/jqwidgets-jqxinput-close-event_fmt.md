...
> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxinput-close-event/](https://www.geeksforgeeks.org/jqwidgets-jqxinput-close-event/)

jQWidgets 是一个 JavaScript 框架，用于为 PC 和移动设备制作基于 web 的应用程序。它是一个非常强大、优化、独立于平台并且得到广泛支持的框架。`jqxInput` 用于表示包含自动完成功能的 jQuery 输入小部件。

**关闭事件**用于在自动提示弹出窗口关闭时触发。
...
下面的例子说明了 jQWidgets 中的 `jqxInput` 关闭事件。
...
![](img/0a72a961c6cb9b29ecb4fec9129b3cb1.png)
