# jQWidgets jqxDropDownList dropDownVerticalAlignment 属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-dropdownverticalalignment-property/](https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-dropdownverticalalignment-property/)
...
下面的例子说明了 jQWidgets 中的 `jqxDropDownList` `dropDownVerticalAlignment` 属性。
