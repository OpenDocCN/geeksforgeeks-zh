# jQWidgets jqxScheduler delete 约会()方法

> 原文:[https://www . geeksforgeeks . org/jqwidgets-jqxscheduler-delete 约会-method/](https://www.geeksforgeeks.org/jqwidgets-jqxscheduler-deleteappointment-method/)
...
**删除约会()方法**用于从显示的 jqxScheduler 中删除约会。它不返回任何东西。
...
下面的例子说明了 jqxScheduler **在 jQWidgets 中删除约会()方法**。
...
        <h3>jQWidgets jqxScheduler deleteAppointment()
            method
        </h3>
