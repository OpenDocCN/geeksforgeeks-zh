# jQWidgets jqxnumber input decimal separator 属性

> 原文:[https://www . geeksforgeeks . org/jqwidgets-jqxnumberinput-decimal separator-property/](https://www.geeksforgeeks.org/jqwidgets-jqxnumberinput-decimalseparator-property/)
...
**十进制分隔符属性**用于设置或返回数值中用作十进制分隔符的字符。它接受字符类型值，默认值为“.”
...
下面的例子说明了 jQWidgets jqxnumber input decimal separator 属性。
