...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxcalendar-showothermonthdays-property/](https://www.geeksforgeeks.org/jqwidgets-jqxcalendar-showothermonthdays-property/)
...
*showOtherMonthDays* 属性用于设置或返回值，检查是否显示其他月份的日期。它接受布尔类型值，默认值为*真*。
