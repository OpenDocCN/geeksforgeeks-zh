...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxcombobox-getitems-method/](https://www.geeksforgeeks.org/jqwidgets-jqxcombobox-getitems-method/)
...
**示例:**下面的示例说明了 jQWidgets 中的 jqxComboBox**getItems()***T5】方法。*
