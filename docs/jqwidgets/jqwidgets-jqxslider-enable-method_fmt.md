...
> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxslider-enable-method/](https://www.geeksforgeeks.org/jqwidgets-jqxslider-enable-method/)
...
`enable()` 方法用于启用禁用的 `jqxSlider` 小部件。它不接受任何参数，也不返回值。
