...
> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxbutton-width-property/](https://www.geeksforgeeks.org/jqwidgets-jqxbutton-width-property/)
...
下面的例子说明了 jQWidgets 中的 `jqxButton` `width` 属性。
