# jQWidgets jqxnumber input placeHolder 属性

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxnumberinput-placeholder-property/](https://www.geeksforgeeks.org/jqwidgets-jqxnumberinput-placeholder-property/)
...
**占位符属性**用于设置或返回小部件值为空时显示的占位符。它接受字符串类型值，默认值为空" "。
...
下面的例子说明了 jQWidgets jqxnumber input placeHolder 属性。
