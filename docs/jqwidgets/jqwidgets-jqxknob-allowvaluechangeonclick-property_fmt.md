# jqxKnob 小部件的 allowValueChangeOnClick 属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxknob-allowvaluechangeonclick-property/](https://www.geeksforgeeks.org/jqwidgets-jqxknob-allowvaluechangeonclick-property/)
...
`allowValueChangeOnClick` 属性用于设置或获取指定的 `jqxKnob` 的值是否可以在点击时更改。

## 语法

### 设置 `allowValueChangeOnClick` 属性

```javascript
$('#jqxKnob').jqxKnob({allowValueChangeOnClick: true });
```

### 获取 `allowValueChangeOnClick` 属性
...
下面的示例说明了 `jQWidgets` 中的 `jqxKnob` `allowValueChangeOnClick` 属性。
...
[https://www.jqwidgets.com/jquery-widgets-documentation/documentation/jqxknob/jquery-knob-api.htm](https://www.jqwidgets.com/jquery-widgets-documentation/documentation/jqxknob/jquery-knob-api.htm)