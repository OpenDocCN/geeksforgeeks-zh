...
> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxmenu-close-method/](https://www.geeksforgeeks.org/jqwidgets-jqxmenu-close-method/)
...
下面的例子说明了 jQWidgets jqxMenu `close()`方法。
...
<body>
    ...
    <h3>
        jQWidgets jqxMenu close() Method
    </h3>
    ...
    <center>
        <input type="button" value="Close Menu" 
            id="jqxBtn" 
...
![](img/1da0dd5062fc2ccfa3d65ca064605826.png)
