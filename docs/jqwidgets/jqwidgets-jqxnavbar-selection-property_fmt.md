...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxnavbar-selection-property/](https://www.geeksforgeeks.org/jqwidgets-jqxnavbar-selection-property/)
...
**选择属性**用于设置或返回是否可以选择项目。它接受布尔类型值，默认值为 `true`。
...
下面的例子说明了 jQWidgets `jqxNavBar` `selection` 属性。
