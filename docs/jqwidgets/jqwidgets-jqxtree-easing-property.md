# jQWidgets jqxTree 宽松属性

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxtree-easing-property/](https://www.geeksforgeeks.org/jqwidgets-jqxtree-easing-property/)
...
**缓和属性**用于将动画的缓和设置或返回到 JQuery 支持的一个缓和。它接受字符串类型的值，默认值为“easeInOutCirc”。
...
下面的示例说明了 jQWidgets jqxTree 宽松属性。
...
    <h3>
        jQWidgets jqxTree easing Property
    </h3>
...
![](img/135f5025c4c44f8d7b003304bac7a5cd.png)
