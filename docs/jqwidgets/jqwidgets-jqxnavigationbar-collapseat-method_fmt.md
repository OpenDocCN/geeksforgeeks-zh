...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxnavigationbar-collapseat-method/](https://www.geeksforgeeks.org/jqwidgets-jqxnavigationbar-collapseat-method/)
...
下面的示例说明了 `jQWidgets` `jqxNavigationBar` `collapseAt()` 方法。在下面的示例中，标题位于将要折叠的第 0 行索引处。
