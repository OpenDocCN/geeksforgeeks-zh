...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxmenu-source-property/](https://www.geeksforgeeks.org/jqwidgets-jqxmenu-source-property/)
...
`source` 属性用于设置或返回数据的来源。它接受对象类型值，默认值为空。
...
下面的示例说明了 jQWidgets `jqxMenu` `source` 属性。
