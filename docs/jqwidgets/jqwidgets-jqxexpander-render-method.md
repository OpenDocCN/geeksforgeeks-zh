# jQWidgets jqxExpander 渲染()方法

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxexpander-render-method/](https://www.geeksforgeeks.org/jqwidgets-jqxexpander-render-method/)
...
**渲染()方法**用于渲染扩展器小部件。它不接受任何参数，也不返回值。

**语法:**

```html
$('Selector').jqxExpander('render');
```
...
下面的例子说明了 jQWidgets jqxExpander render()方法。
...
![](img/2b6347502c21f6a471095aa46b0269f9.png)
