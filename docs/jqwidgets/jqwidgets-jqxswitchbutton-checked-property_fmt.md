# jQWidgets jqxSwitchButton 勾选属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxswitchbutton-checked-property/](https://www.geeksforgeeks.org/jqwidgets-jqxswitchbutton-checked-property/)
...
`checked` 属性用于设置或获取显示的开关按钮的勾选状态。它属于布尔类型，默认值为假。
...
下面的例子说明了 `jQWidgets` 中的 `jqxSwitchButton` `checked` 属性。
