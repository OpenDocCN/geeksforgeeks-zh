# jQWidgets jqxTabs 扩展事件

> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxtabs-expanded-event/](https://www.geeksforgeeks.org/jqwidgets-jqxtabs-expanded-event/)
...
**展开事件**用于 `jqxTabs` 小部件任意一个标签展开时触发。

### 语法

```javascript
$('Selector').on('expanded', function (event) { });
```
...
下面的例子说明了 jQWidgets `jqxTabs` 扩展事件。
...
<body>
    <center>
        ...
        <h3>
            jQWidgets jqxTabs expanded Event
        </h3>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#jqxTabs').on('expanded', function (event) {
                alert('Expanded event triggered');
            });
        });
    </script>
</body>
...
![](img/5ce6101ee1f186567b239723ece4b1d8.png)
