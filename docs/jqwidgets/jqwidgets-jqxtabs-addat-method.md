...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxtabs-addat-method/](https://www.geeksforgeeks.org/jqwidgets-jqxtabs-addat-method/)
...
**addAt()方法**用于在给定位置添加制表符。添加选项卡包含选项卡的内容。该方法接受下面给出的三个参数:
