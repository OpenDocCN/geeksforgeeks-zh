# jQWidgets jqxExpander collapseAnimationDuration 属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxexpander-collapseanimationduration-property/](https://www.geeksforgeeks.org/jqwidgets-jqxexpander-collapseanimationduration-property/)
...
`collapseAnimationDuration` 属性用于设置或返回折叠动画持续时间。它接受数字类型值，默认值为 `400`。
...
下面的例子说明了 jQWidgets jqxExpander `collapseAnimationDuration` 属性。
