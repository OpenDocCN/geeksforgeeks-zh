# jQWidgets jqxformatedinput dropdown width 属性

> 原文:[https://www . geeksforgeeks . org/jqwidgets-jqxformatedinput-dropdown width-property/](https://www.geeksforgeeks.org/jqwidgets-jqxformattedinput-dropdownwidth-property/)
...
**下拉宽度属性**用于设置或返回下拉小部件的宽度。它接受数字/字符串类型的值，默认值为空。
...
下面的例子说明了 jQWidgets jqxformatedinput dropdown width 属性。
