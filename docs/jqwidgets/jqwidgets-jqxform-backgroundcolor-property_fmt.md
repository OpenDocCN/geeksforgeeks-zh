...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxform-backgroundcolor-property/](https://www.geeksforgeeks.org/jqwidgets-jqxform-backgroundcolor-property/)
...
以下示例说明了 jQWidgets 中的 `jqxForm` `backgroundColor` 属性:
