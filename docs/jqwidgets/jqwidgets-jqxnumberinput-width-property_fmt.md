# jQWidgets jqxNumberInput width 属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxnumberinput-width-property/](https://www.geeksforgeeks.org/jqwidgets-jqxnumberinput-width-property/)
...
`width` 属性用于设置或返回 `jqxNumberInput` 小部件的宽度。它接受数字/字符串类型的值，默认值为空。
...
下面的例子说明了 jQWidgets `jqxNumberInput` `width` 属性。
...
![](img/dee69cc9ec1a05e1ae81cf55f1d9dc73.png)
