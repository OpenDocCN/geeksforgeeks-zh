...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxform-getcomponentbyname-method/](https://www.geeksforgeeks.org/jqwidgets-jqxform-getcomponentbyname-method/)
...
`getComponentByName()` 方法是利用组件的名称获取组件信息。它不返回任何值，并将组件名称作为参数。
...
下面的例子说明了 jQWidgets 中的 `jqxForm` `getComponentByName()` 方法。
...
![](img/74594847dd6d2ea6f2649af00b865d39.png)

## 参考

[https://www.jqwidgets.com/jquery-widgets-documentation/documentation/jqxform/jquery-form-api.htm?search=](https://www.jqwidgets.com/jquery-widgets-documentation/documentation/jqxform/jquery-form-api.htm?search=)