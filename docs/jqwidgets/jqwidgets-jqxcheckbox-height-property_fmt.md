# jQWidgets jqxCheckBox 高度属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxcheckbox-height-property/](https://www.geeksforgeeks.org/jqwidgets-jqxcheckbox-height-property/)
...
`height` 属性用于设置或返回 `jqxCheckBox` 的高度。它接受数字/字符串类型的值，默认值为空。
...
以下示例说明了 jQWidgets 中的 `jqxCheckBox` 高度属性:
...
<body>
    ...
    <h3>
        jQWidgets jqxCheckBox height Property
    </h3>
...
![](img/dc6316499dd16948bacb52a038071014.png)
