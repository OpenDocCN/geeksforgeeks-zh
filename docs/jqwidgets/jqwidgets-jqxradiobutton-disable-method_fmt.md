...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxradiobutton-disable-method/](https://www.geeksforgeeks.org/jqwidgets-jqxradiobutton-disable-method/)
...
`disable()`方法用于禁用单选按钮。它不接受任何参数，也不返回值。
