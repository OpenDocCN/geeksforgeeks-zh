# jQWidgets jqxGauge 线性仪表缓和属性

> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxgauge-lineargauge-easing-property/](https://www.geeksforgeeks.org/jqwidgets-jqxgauge-lineargauge-easing-property/)
...
**示例：** 下面的示例说明了 `jQWidgets` 中的 `jqxLinearGauge` **缓和**属性。
