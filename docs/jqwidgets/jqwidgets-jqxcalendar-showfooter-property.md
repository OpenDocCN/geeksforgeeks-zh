# jQWidgets jqxCalendar show footer 属性

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxcalendar-show footer-property/](https://www.geeksforgeeks.org/jqwidgets-jqxcalendar-showfooter-property/)
...
*显示页脚*属性用于设置或返回一个值，该值指示日历的页脚是否显示。它接受布尔类型值，默认值为*真。*
...
**示例:**下面的示例说明了 jQWidgets 中的 jqxCalendar *showFooter* 属性。
