# jQWidgets jqxCheckBox 不定()方法

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxcheckbox-不定-method/](https://www.geeksforgeeks.org/jqwidgets-jqxcheckbox-indeterminate-method/)
...
**不确定()方法**用于设置复选框的不确定状态。它不接受任何参数，也不返回值。
...
以下示例说明了 jQWidgets 中的 jqxCheckBox 不定()方法:
