...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxgauge-lineargauge-orientation-property/](https://www.geeksforgeeks.org/jqwidgets-jqxgauge-lineargauge-orientation-property/)
...
以下示例说明了 `jQWidgets` 中的 `jqxlineargage` `方向` 属性。
