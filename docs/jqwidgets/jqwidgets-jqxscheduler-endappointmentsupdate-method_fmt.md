...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxscheduler-endappointmentsupdate-method/](https://www.geeksforgeeks.org/jqwidgets-jqxscheduler-endappointmentsupdate-method/)
...
**endAppointmentsUpdate()方法**用于终止更新过程以及重新启动调度程序的渲染。它没有参数，也不返回任何内容。

## 语法

```html
$('#Selector').jqxScheduler('endAppointmentsUpdate');
```
...
下面的例子说明了 `jqxScheduler` 的 `endAppointmentsUpdate()` 方法在 jQWidgets 中的作用。
...
<head>
    ...
    <script type="text/javascript" 
            src="jqwidgets/jqxscheduler.js"></script>
    <script type="text/javascript"
            src="jqwidgets/jqxscheduler.api.js"></script>
</head>
...
![](img/37f082c2ad0cf95e85d9843e3077d4e4.png)
