...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxbuttongroup-enablehover-property/](https://www.geeksforgeeks.org/jqwidgets-jqxbuttongroup-enablehover-property/)
...
`enableHover` 属性用于启用或禁用显示的 `jqxButtonGroup` 的高亮状态。它属于布尔类型，默认值为 `false`。
...
```javascript
var enableHover = $('#Selector').jqxButtonGroup('enableHover');
```
...
<body>
    <center>
        ...
        <h3>jQWidgets jqxButtonGroup enableHover property</h3>
        <br />
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#jqxBtn").on("click", function () {
                var eh = $("#jqxBG").jqxButtonGroup("enableHover");
