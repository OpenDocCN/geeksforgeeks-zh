...
> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxcheckbox-destroy-method/](https://www.geeksforgeeks.org/jqwidgets-jqxcheckbox-destroy-method/)
...
`destroy()` 方法用于销毁复选框。它不接受任何参数，也不返回值。
...
下面的示例说明了 jQWidgets 中的 `jqxCheckBox` `destroy()` 方法。
...
<body>
    ...
    <br>
    <input type="button" id='jqxBtn' value="Destroy the CheckBox" style="padding: 8px 25px;" />
