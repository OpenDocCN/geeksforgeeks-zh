...
> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxribbon-render-method/](https://www.geeksforgeeks.org/jqwidgets-jqxribbon-render-method/)
...
下面的示例说明了 `jQWidgets` `jqxRibbon` `render()` 方法。
