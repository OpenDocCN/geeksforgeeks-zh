...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxsplitter-collapse-method/](https://www.geeksforgeeks.org/jqwidgets-jqxsplitter-collapse-method/)
...
下面的示例说明了 jQWidgets jqxSplitter `collapse()` 方法。
