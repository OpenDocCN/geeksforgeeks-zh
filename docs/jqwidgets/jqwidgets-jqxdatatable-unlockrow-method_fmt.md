...
> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxdatatable-unlockrow-method/](https://www.geeksforgeeks.org/jqwidgets-jqxdatatable-unlockrow-method/)
...
*   `rowIndex`：这是将要解锁的指定行。它的值从第 0 个索引开始。
...
下面的示例说明了 jQWidgets `unlockRow()` 方法。
