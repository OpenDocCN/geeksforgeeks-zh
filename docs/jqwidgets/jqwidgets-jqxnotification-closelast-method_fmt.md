...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxnotification-closelast-method/](https://www.geeksforgeeks.org/jqwidgets-jqxnotification-closelast-method/)
...
`closeLast()`方法用于关闭最后一个通知。它不接受任何参数，也不返回值。
...
从链接下载 jQWidgets。在 HTML 文件中，找到下载文件夹中的脚本文件:
...
以下示例说明了 jQWidgets 中的 `jqxNotification` `closeLast()`方法:
...
`https://www.jqwidgets.com/jquery-widgets-documentation/documentation/jqxnotification/jquery-notification-api.htm?search=`