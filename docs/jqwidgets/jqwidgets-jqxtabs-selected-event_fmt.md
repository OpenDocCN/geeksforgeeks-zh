# jQWidgets jqxTabs 选定事件

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxtabs-selected-event/](https://www.geeksforgeeks.org/jqwidgets-jqxtabs-selected-event/)
...
*   The `<li>` element is used for tag title, and the `<div>` element is used for tag content.

## 选择事件

**选择事件**用于在从 `jqxTabs` 小部件中选择标签时触发。
...
下面的例子说明了 jQWidgets `jqxTabs` 选择的事件。
...
<body>
    <center>
        ...
        <h3>
            jQWidgets jqxTabs selected Event
        </h3>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#jqxTabs').on('selected', function (event) {
                alert('selected event triggered');
            });
        });
    </script>
</body>
...
![](img/44d34c40bf3bb179618278cbc23e7c44.png)
