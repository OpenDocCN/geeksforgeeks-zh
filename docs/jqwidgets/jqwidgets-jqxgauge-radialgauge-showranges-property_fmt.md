...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxgauge-radialgauge-showranges-property/](https://www.geeksforgeeks.org/jqwidgets-jqxgauge-radialgauge-showranges-property/)
...
`showRanges` 属性用于设置或返回 `showRanges` 属性，即用于设置是否显示 `jqxGauge` 元素的范围。它接受一个布尔值，默认值为 `true`。
...
以下示例说明了 jQWidgets 中的 `jqxGauge` `showRanges` 属性:

## 示例

在本例中，我们将 `showRanges` 属性设置为 `false`。
...
<body>
    <center>
        ...
        <h3>jQWidgets jqxGauge showRanges property</h3>
...
![](img/3df091f744578e30e0914353356b076f.png)
