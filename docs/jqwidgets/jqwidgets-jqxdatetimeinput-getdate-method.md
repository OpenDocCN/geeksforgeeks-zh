# jqwidget jqxdatetimeinput getdate()方法

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxdatetimeinput-get date-method/](https://www.geeksforgeeks.org/jqwidgets-jqxdatetimeinput-getdate-method/)
...
**getDate()方法**用于返回当前日期。它不接受任何参数，并返回日期对象。
