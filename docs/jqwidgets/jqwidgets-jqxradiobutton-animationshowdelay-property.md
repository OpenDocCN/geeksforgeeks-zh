# jQWidgets jqxRadioButton animationshoulday 属性

> 原文:[https://www . geeksforgeeks . org/jqwidgets-jqxradiobutton-animationshowdelay-property/](https://www.geeksforgeeks.org/jqwidgets-jqxradiobutton-animationshowdelay-property/)
...
**animationShowDelay 属性**用于设置或返回将要检查 jqxRadioButton 时动画的时间延迟。它接受数字类型值，默认值为 250。
...
下面的例子说明了 jQWidgets jqxRadioButton animationshoulday 属性。
...
    <h3>
        jQWidgets jqxRadioButton animationShowDelay Property
    </h3>
...
![](img/ea0b5cf0cd8f7e7eba81699f8142fcab.png)
