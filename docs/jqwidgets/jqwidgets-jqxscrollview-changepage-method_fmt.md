...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxscrollview-changepage-method/](https://www.geeksforgeeks.org/jqwidgets-jqxscrollview-changepage-method/)
...
`changePage()` 方法用于导航到另一个页面。它接受数字类型的单个参数 `index`，并且不返回值。
