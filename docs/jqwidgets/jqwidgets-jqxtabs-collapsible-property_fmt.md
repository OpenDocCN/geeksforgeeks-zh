...
> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxtabs-collapsible-property/](https://www.geeksforgeeks.org/jqwidgets-jqxtabs-collapsible-property/)
...
`collapsible` 属性用于启用或禁用可折叠功能。它接受布尔类型值，默认值为 `false`。
...
以下示例说明了 jQWidgets jqxTabs `collapsible` 属性。
