# jQWidgets jqxListBox 复选框属性

> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxlistbox-checkboxes-property/](https://www.geeksforgeeks.org/jqwidgets-jqxlistbox-checkboxes-property/)

**jQWidgets** 是一个 JavaScript 框架，用于为 PC 和移动设备制作基于 web 的应用程序。它是一个非常强大、优化、独立于平台并且得到广泛支持的框架。`jqxListBox` 用于说明一个 jQuery ListBox 小部件，它包含一个可选择元素的列表。

`checkboxes` 属性用于设置或返回所述列表框是否应在列表的每个项目旁边显示一个复选框。为布尔类型，默认值为 `false`。
...
下面的例子说明了 jQWidgets 中的 jqxListBox `checkboxes` 属性。
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#jqxBtn").on("click", function () {
                var check_boxes = $("#jqxLB")
                    .jqxListBox("checkboxes");
                $("#log").text(check_boxes);
            });
        });
    </script>
</body>
...
![](img/af372808ab4dad6e362e1f0273b549d4.png)
