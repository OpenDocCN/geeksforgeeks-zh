# jqwidgets jqxnombinput setdecimal()方法

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxnumberinput-set decimal-method/](https://www.geeksforgeeks.org/jqwidgets-jqxnumberinput-setdecimal-method/)
...
**setDecimal()** 方法用于设置小部件的值。它接受数字类型的单个参数值，不返回任何值。
...
**示例:**下面的示例说明了 jQWidgets jqxnumber input**setDecimal()**方法。
...
![](img/c95c286c8353c630b2c49a2851777904.png)
