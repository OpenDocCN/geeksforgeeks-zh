...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxformattedinput-close-method/](https://www.geeksforgeeks.org/jqwidgets-jqxformattedinput-close-method/)
...
`close()` 方法用于关闭 `jqxFormattedInput` 小部件弹出窗口。它不接受任何参数，也不返回值。
