...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-additem-method/](https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-additem-method/)
...
`addItem()` 方法用于向 `jqxDropDownList` 添加新项。如果新项目添加成功，则返回 `true`，否则返回 `false`。
