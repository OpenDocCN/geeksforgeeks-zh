# jQWidgets jqxValidator onSuccess 属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxvalidator-onsuccess-property/](https://www.geeksforgeeks.org/jqwidgets-jqxvalidator-onsuccess-property/)
...
`onSuccess` 属性用于设置或获取一个回调函数，该函数将在成功验证时被调用。
...
下面的示例说明了 jQWidgets `jqxValidator` `onSuccess` 属性。
