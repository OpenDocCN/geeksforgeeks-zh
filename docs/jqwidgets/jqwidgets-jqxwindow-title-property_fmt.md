# jQWidgets jqxWindow 标题属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxwindow-title-property/](https://www.geeksforgeeks.org/jqwidgets-jqxwindow-title-property/)

## 介绍

`jQWidgets` 是一个 JavaScript 框架，用于为 PC 和移动设备制作基于 web 的应用程序。它是一个非常强大、优化、独立于平台并且得到广泛支持的框架。`jqxWindow` 用于在应用程序中输入数据或查看信息。

`title` 属性用于设置或获取窗口的标题内容。
...
以下示例说明了 jQWidgets 中的 jqxWindow `title` 属性。在本例中，标题设置为“公司名称”。
