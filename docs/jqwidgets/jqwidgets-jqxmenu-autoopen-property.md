# jQWidgets jqxMenu 自开性质

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxmenu-auto open-property/](https://www.geeksforgeeks.org/jqwidgets-jqxmenu-autoopen-property/)
...
**自动打开属性**用于设置或返回用户悬停时顶层菜单项是否自动打开。它接受布尔类型值，默认值为真。
...
下面的例子说明了 jQWidgets jqxMenu 自动打开属性。
