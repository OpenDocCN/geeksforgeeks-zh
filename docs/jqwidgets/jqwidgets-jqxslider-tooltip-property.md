...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxslider-tooltip-property/](https://www.geeksforgeeks.org/jqwidgets-jqxslider-tooltip-property/)
...
**工具提示属性**用于设置或返回滑块工具提示是否显示。它接受布尔类型值，默认值为 false。
...
下面的例子说明了 jQWidgets jqxSlider 工具提示属性。
