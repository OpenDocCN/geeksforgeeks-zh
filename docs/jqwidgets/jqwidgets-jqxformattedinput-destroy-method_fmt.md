...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxformattedinput-destroy-method/](https://www.geeksforgeeks.org/jqwidgets-jqxformattedinput-destroy-method/)
...
`destroy()`方法用于销毁 `jqxFormattedInput` 小部件。它不接受任何参数，也不返回值。
...
下面的例子说明了 `jQWidgets` `jqxFormattedInput` `destroy()`方法。
