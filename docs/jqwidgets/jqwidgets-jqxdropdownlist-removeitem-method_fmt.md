# jqxDropDownList removeItem()方法

> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-removeitem-method/](https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-removeitem-method/)
...
`removeItem()` 方法用于从列表框中移除项。它接受对象/字符串类型的单个参数 `item`，并且不返回值。
