...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxgauge-radialgauge-pointer-property/](https://www.geeksforgeeks.org/jqwidgets-jqxgauge-radialgauge-pointer-property/)
...
**指针属性**用于设置或返回指针属性，即用于设置 `jqxGauge` 元素的指针属性，它接受一个对象值，默认值为 `{ pointerType: 'default', style: { fill: 'theme-specific-color', stroke: 'theme-specific-color' }, length: '70%', width: '2%', visible: true }`。
