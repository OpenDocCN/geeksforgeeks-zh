...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxlistmenu-width-property/](https://www.geeksforgeeks.org/jqwidgets-jqxlistmenu-width-property/)
...
**宽度属性**用于设置或返回 jqxListMenu 小部件的宽度。它接受字符串类型的值，默认值为“100%”。
...
下面的例子说明了 jQWidgets 中的 jqxListMenu 宽度属性。
