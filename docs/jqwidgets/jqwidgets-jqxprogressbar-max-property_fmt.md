# jQWidgets jqxProgressBar max 属性

> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxprogressbar-max-property/](https://www.geeksforgeeks.org/jqwidgets-jqxprogressbar-max-property/)
...
以下示例说明了 jQWidgets 中的 `jqxProgressBar` `max` 属性。
