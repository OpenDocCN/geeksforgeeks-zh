# jQWidgets jqxGrid 可编辑属性

> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxgrid-editable-property/](https://www.geeksforgeeks.org/jqwidgets-jqxgrid-editable-property/)
...
以下示例说明了 jQWidgets 中的 `jqxGrid` **可编辑**属性。
