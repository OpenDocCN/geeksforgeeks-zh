...
`方向`属性用于设置或返回 bulletcharts 的方向。接受字符串类型，默认值为`"横排"`。它的可能值如下。
...
从链接下载 [jQWidgets f](https://www.jqwidgets.com/download/) 。在 HTML 文件中，找到下载文件夹中的脚本文件。
