# jQWidgets jqxTree toggleIndicatorSize 属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxtree-toggleindicatorsize-property/](https://www.geeksforgeeks.org/jqwidgets-jqxtree-toggleindicatorsize-property/)
...
设置 `toggleIndicatorSize` 属性。

```javascript
$('selector').jqxTree({ toggleIndicatorSize: Number });
```

返回 `toggleIndicatorSize` 属性。
...
**示例:** 以下示例说明了 jQWidgets `jqxTree` `toggleIndicatorSize` 属性。
