...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxddropdownlist-scrollbarsize-property/](https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-scrollbarsize-property/)
...
*滚动条大小*属性用于设置或返回滚动条的大小。它接受数字类型值，默认值为 17。
...
**示例:**下面的示例说明了 jQWidgets 中的 jqxDropDownList*scrollBarSize*属性。
