...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxchart-removecolorscheme-method/](https://www.geeksforgeeks.org/jqwidgets-jqxchart-removecolorscheme-method/)
...
## removeColorScheme()方法
`removeColorSchema()`方法用于按名称删除配色方案。它以方案类型值为参数，采用字符串类型值，不返回值。
...
## 示例
以下示例说明了 `jQWidgets` 中的 `jqxChart` `removeColorScheme()`方法:
