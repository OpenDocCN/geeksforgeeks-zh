...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxtabs-selecteditem-property/](https://www.geeksforgeeks.org/jqwidgets-jqxtabs-selecteditem-property/)
...
**selectedItem 属性**用于设置或返回所选标签。它接受数字类型值，默认值为 0。
