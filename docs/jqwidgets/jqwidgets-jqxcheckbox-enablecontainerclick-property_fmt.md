...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxcheckbox-enablecontainerclick-property/](https://www.geeksforgeeks.org/jqwidgets-jqxcheckbox-enablecontainerclick-property/)
...
`enableContainerClick` 属性用于设置或返回容器上的点击，这些点击作为复选框上的点击来处理。它接受布尔类型值，默认值为 `true`。
...
以下示例说明了 jQWidgets 中的 `jqxCheckBox` `enableContainerClick` 属性。
