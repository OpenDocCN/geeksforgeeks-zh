...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxtree-clear-method/](https://www.geeksforgeeks.org/jqwidgets-jqxtree-clear-method/)
...
`clear()`方法用于移除小部件中的所有元素。它不接受任何参数，也不返回值。
