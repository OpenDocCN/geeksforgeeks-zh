...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxlistbox-render-method/](https://www.geeksforgeeks.org/jqwidgets-jqxlistbox-render-method/)
...
下面的示例说明了 jQWidgets 中的 `jqxListBox` `render()` 方法。
