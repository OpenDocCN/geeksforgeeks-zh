...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxdatetimeinput-template-property/](https://www.geeksforgeeks.org/jqwidgets-jqxdatetimeinput-template-property/)
...
下面的例子说明了 jQWidgets 中的 jqxDateTimeInput 模板属性。
