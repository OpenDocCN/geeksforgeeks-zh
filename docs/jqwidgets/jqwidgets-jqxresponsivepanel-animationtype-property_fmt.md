# jQWidgets jqxResponsivePanel 动画类型属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxresponsivepanel-animationtype-property/](https://www.geeksforgeeks.org/jqwidgets-jqxresponsivepanel-animationtype-property/)
...
`animationType` 属性用于设置或返回用于显示/隐藏面板的动画类型。它接受字符串类型的值，默认值是“淡化”。
...
下面的例子说明了 jQWidgets 中的 `jqxResponsivePanel` `animationType` 属性。
...
![](img/504eb6f38e6e3d92feacae1998ed4405.png)
