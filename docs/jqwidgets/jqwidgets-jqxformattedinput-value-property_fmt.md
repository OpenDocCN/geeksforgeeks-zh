# jQWidgets jqxFormattedInput value 属性

> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxformattedinput-value-property/](https://www.geeksforgeeks.org/jqwidgets-jqxformattedinput-value-property/)
...
`value` 属性用于设置或返回 `jqxFormattedInput` 小部件的值。它接受字符串类型值，默认值为 `"0"`。
...
下面的示例说明了 jQWidgets `jqxFormattedInput` `value` 属性。
...
![](img/4b9b59d2df3120b545f720ddfd822569.png)
