# jQWidgets jqxSplitter 高度属性

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxsplitter-height-property/](https://www.geeksforgeeks.org/jqwidgets-jqxsplitter-height-property/)
...
**高度属性**用于设置或获取指定 jqxSplitter 的高度。
...
*   设置*高度*属性:
    ...
    ```html
    $('#jqxSplitter').jqxSplitter({ height: 200 });
    ```

*   获取*高度*属性:

    ```html
    var disabled = $('#jqxSplitter').jqxSplitter('height');
    ```
...
**示例:**以下示例说明了 jQWidgets **jqxSplitter 高度***T5*属性。在以下示例中，*高度*属性的值已设置为 200。
...
![](img/8130ee46948a9c899c0b98798e333d2b.png)
