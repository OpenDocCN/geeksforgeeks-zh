# jQWidgets jqxBulletChart labelsFormat 属性

> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxbulletchart-labelsformat-property/](https://www.geeksforgeeks.org/jqwidgets-jqxbulletchart-labelsformat-property/)
...
`labelsFormat` 属性用于设置或返回项目符号图表标签格式。它接受字符串类型值，默认值为 `null`。它的可能值如下：
