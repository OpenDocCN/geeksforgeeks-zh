# jQWidgets jqxnumber 输入位数属性

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxnumberinput-digits-property/](https://www.geeksforgeeks.org/jqwidgets-jqxnumberinput-digits-property/)
...
**位数属性**用于设置或返回输入字段允许的位数。它接受数字类型值，默认值为 8。
