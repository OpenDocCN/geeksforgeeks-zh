...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-unselectindex-method/](https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-unselectindex-method/)
...
`unselectIndex()`方法用于通过使用索引号来取消选择项目。它接受数字类型的单个参数`index`，并且不返回任何值。
...
**链接文件:** 从链接[https://www.jqwidgets.com/download](https://www.jqwidgets.com/download)下载`jQWidgets`。在HTML文件中，找到下载文件夹中的脚本文件。
