...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxsortable-cursor-property/](https://www.geeksforgeeks.org/jqwidgets-jqxsortable-cursor-property/)
...
`光标`属性用于定义排序时显示的光标。它接受字符串类型的值，默认值为“自动”。
...
**示例:** 以下示例说明了 jQWidgets 中的 jqxSortable `光标`属性:
