# jQWidgets jqxDropDownList selectedIndex 属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-selectedindex-property/](https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-selectedindex-property/)
...
`selectedIndex` 属性用于设置或返回选择的索引。它接受数字类型值，默认值为-1。
...
以下示例说明了 jQWidgets 中的 `jqxDropDownList` `selectedIndex` 属性。
...
![](img/b303ce2f28d94b1ede45863541c8a720.png)
