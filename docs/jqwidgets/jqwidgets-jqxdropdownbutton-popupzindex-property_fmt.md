# jQWidgets jqxDropDownButton popupZIndex 属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdropdownbutton-popupzindex-property/](https://www.geeksforgeeks.org/jqwidgets-jqxdropdownbutton-popupzindex-property/)
...
`popupZIndex` 属性用于设置或获取显示的下拉按钮弹出窗口的 z 索引。它属于数字类型，默认值为 20000。
...
下面的示例说明了 jQWidgets 中的 `jqxDropDownButton` `popupZIndex` 属性。
