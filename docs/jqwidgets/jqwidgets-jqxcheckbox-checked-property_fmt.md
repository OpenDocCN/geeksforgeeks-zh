# jQWidgets jqxCheckBox 勾选属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxcheckbox-checked-property/](https://www.geeksforgeeks.org/jqwidgets-jqxcheckbox-checked-property/)
...
`checked` 属性用于设置或返回复选框选中状态。它接受一个布尔值，默认值为 `false`。
...
以下示例说明了 `jqxCheckBox` 在 jQWidgets 中 `checked` 属性。
