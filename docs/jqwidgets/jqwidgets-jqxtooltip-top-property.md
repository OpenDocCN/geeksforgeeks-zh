...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxtooltip-top-property/](https://www.geeksforgeeks.org/jqwidgets-jqxtooltip-top-property/)
...
*top* 属性用于根据*位置*属性设置或返回 jqxTooltip 的垂直偏移量。它接受数字/字符串类型的值，默认值为 0。
...
**示例:**以下示例说明了 jQWidgets jqxTooltip *top* 属性。
