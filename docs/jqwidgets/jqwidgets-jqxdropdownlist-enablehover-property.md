...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxddropdownlist-enable hover-property/](https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-enablehover-property/)
...
**启用悬停属性**用于启用/禁用悬停状态。它接受布尔类型值，默认值为真。
