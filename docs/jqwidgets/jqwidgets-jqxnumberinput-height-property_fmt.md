# jQWidgets jqxNumberInput 高度属性

> 原文: `https://www.geeksforgeeks.org/jqwidgets-jqxnumberinput-height-property/`
...
下面的例子说明了 jQWidgets `jqxNumberInput` `height` 属性。
...
**参考:** `https://www.jqwidgets.com/jquery-widgets-documentation/documentation/jqxnumberinput/jquery-number-input-api.htm`