# jQWidgets jqxDropDownList indextendateindex()方法

> 原文:[https://www . geeksforgeeks . org/jqwidgets-jqxddropdownlist-inderedendex-method/](https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-indeterminateindex-method/)
...
当“复选框”属性值设置为*真*时，**不确定指数()**方法用于不确定列表项。它接受数字类型的单个参数索引，并且不返回任何值。
...
**示例:**下面的示例说明了 jQWidgets 中的 jqxddropdownlist**indendesteindex()**方法。
...
![](img/166ba43612811e3702202439c87fa269.png)
