# jQWidgets jqxnumber 输入十进制属性

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxnumberinput-decimal-property/](https://www.geeksforgeeks.org/jqwidgets-jqxnumberinput-decimal-property/)
...
**十进制属性**用于设置或返回输入的数字。它接受数字类型值，默认值为 0。
