# jQWidgets jqxformatedinput focus()方法

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxformatedinput-focus-method/](https://www.geeksforgeeks.org/jqwidgets-jqxformattedinput-focus-method/)
...
**focus()方法**用于聚焦 jqxFormattedInput 小部件。它不接受任何参数，也不返回值。

**语法:**

```html
$('Selector').jqxFormattedInput('focus');
```
...
下面的例子说明了 jQWidgets jqxFormattedInput focus()方法。
...
![](img/8d2f0e0adca0d2e0b8e6ec8c8caa2cae.png)
