...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxtree-getnextitem-method/](https://www.geeksforgeeks.org/jqwidgets-jqxtree-getnextitem-method/)
...
**getNextItem()方法**用于获取所选项目的下一项。它不接受任何参数，并返回对象类型值。
