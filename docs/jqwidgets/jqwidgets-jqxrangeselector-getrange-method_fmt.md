# jqwidgets jqxremilector(方法)

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxrangeselector-getrange-method/](https://www.geeksforgeeks.org/jqwidgets-jqxrangeselector-getrange-method/)
...
`getRange()` 方法用于获取选定的范围。它不接受任何参数，并返回对象类型值。对象值包含范围选择器的起始值（from）和结束值（to）。
...
下面的例子说明了 jQWidgets `jqxRangeSelector` `getRange()` 方法。
...
![](img/d2ece875577dcd8f5da5c4c285caf56b.png)
