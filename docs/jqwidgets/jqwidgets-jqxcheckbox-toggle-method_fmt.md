# jQWidgets jqxCheckBox toggle()方法

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxcheckbox-toggle-method/](https://www.geeksforgeeks.org/jqwidgets-jqxcheckbox-toggle-method/)
...
`toggle()`方法用于切换检查状态。当用户单击复选框时，会自动调用此方法。它不接受任何参数，也不返回值。
