...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxchart-crosshairslinewidth-property/](https://www.geeksforgeeks.org/jqwidgets-jqxchart-crosshairslinewidth-property/)
...
`crosshairsLineWidth` 属性用于设置或返回十字光标线的宽度。它接受数字类型值，默认值为 1.0。
...
以下示例说明了 `jQWidgets` 中的 `jqxChart` `crosshairsLineWidth` 属性:
