...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxmenu-closeitem-method/](https://www.geeksforgeeks.org/jqwidgets-jqxmenu-closeitem-method/)
...
`closeItem()` 方法用于关闭菜单项。它接受字符串类型的单参数菜单项，不返回值。
...
下面的例子说明了 jQWidgets `jqxMenu` `closeItem()` 方法。
...
<body>
    ...
    <h3>
        jQWidgets jqxMenu closeItem() Method
    </h3>
    ...
    <center>
        <input type="button" value="Close Item" 
            id="jqxBtn" 
...
![](img/6367b9e4eb012a13286d17738d823a69.png)
