...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdocking-expandwindow-method/](https://www.geeksforgeeks.org/jqwidgets-jqxdocking-expandwindow-method/)
...
### 示例:
下面的示例说明了 jQWidgets `jqxDocking` `expandWindow()` 方法。
