...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxeditor-editable-property/](https://www.geeksforgeeks.org/jqwidgets-jqxeditor-editable-property/)
...
### 可编辑属性
用于设置或返回可编辑属性，即编辑器可以设置为可编辑或不可编辑。它接受布尔类型值，默认值为真。
