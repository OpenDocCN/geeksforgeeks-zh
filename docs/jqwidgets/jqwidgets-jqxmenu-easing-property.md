# jQWidgets jqxMenu 宽松属性

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxmenu-easing-property/](https://www.geeksforgeeks.org/jqwidgets-jqxmenu-easing-property/)
...
**缓和属性**用于将动画的缓和设置或返回到 jQuery 支持的缓和之一。它接受字符串类型的值，默认值为“easeInOutSine”。
...
下面的例子说明了 jQWidgets jqxMenu 宽松属性。
