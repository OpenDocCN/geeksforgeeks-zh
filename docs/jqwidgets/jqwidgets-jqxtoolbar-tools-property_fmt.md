...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxtoolbar-tools-property/](https://www.geeksforgeeks.org/jqwidgets-jqxtoolbar-tools-property/)
...
`tools` 属性用于设置或返回显示的 `jqxToolBar` 中的工具种类。它属于字符串类型，默认值为“”。
...
**示例:** 下面的示例说明了 `jQWidgets` 中的 `jqxToolBar` `tools` 属性。
