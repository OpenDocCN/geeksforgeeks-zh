# jQWidgets jqxGauge RadialGauge 边框属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxgauge-radialgauge-border-property/](https://www.geeksforgeeks.org/jqwidgets-jqxgauge-radialgauge-border-property/)
...
`border` 属性用于设置或返回边框属性，即用于设置 `jqxGauge` 元素的边框。它接受一个对象，默认值为 `{ size: '10% '，样式:{ stroke:' # cccccccc ' }，可见:true，显示渐变:true }`。
...
**示例:** 以下示例说明了 `jQWidgets` 中的 `jqxGauge` `border` 属性。
