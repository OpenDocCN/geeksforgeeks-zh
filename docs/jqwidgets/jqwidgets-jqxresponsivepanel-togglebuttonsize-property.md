...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxresponsevepanel-togglebuttonsize-property/](https://www.geeksforgeeks.org/jqwidgets-jqxresponsivepanel-togglebuttonsize-property/)
...
**toggleButtonSize 属性**用于设置或返回 toggleButton 的大小。它接受数字/字符串类型的值，默认值为 30。
