# jQWidgets jqxTextArea 渲染()方法

> 原文:[https://www . geeksforgeeks . org/jqwidgets-jqxtextarea-render-method/](https://www.geeksforgeeks.org/jqwidgets-jqxtextarea-render-method/)
...
**渲染()方法**用于渲染 jqxTextArea 小部件。它不接受任何参数，也不返回值。
...
下面的例子说明了 jQWidgets jqxTextArea render()方法。
...
![](img/4fb96a5de9f8d90989191a34a385e8ad.png)
