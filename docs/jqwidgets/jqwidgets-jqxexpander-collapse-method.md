# jQWidgets jqxExpander 折叠()方法

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxexpander-collapse-method/](https://www.geeksforgeeks.org/jqwidgets-jqxexpander-collapse-method/)
...
**折叠()方法**用于折叠扩张器。它不接受任何参数，也不返回值。

**语法:**

```html
$('Selector').jqxExpander('collapse'); 
```
...
下面的例子说明了 jQWidgets jqxExpander collapse()方法。
...
![](img/62452ebc6adbebdc91333c6659c26899.png)
