# jQWidgets jqxTree 刷新()方法

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxtree-refresh-method/](https://www.geeksforgeeks.org/jqwidgets-jqxtree-refresh-method/)
...
**刷新()方法**用于刷新 jqxTree 小部件。它不接受任何参数，也不返回值。

**语法:**

```html
$('Selector').jqxTree('refresh');
```
...
下面的例子说明了 jQWidgets jqxTree refresh()方法。
...
    <h3>
        jQWidgets jqxTree refresh() Method
    </h3>
...
            alert("Refresh the jqxTree Widget");
        });
    </script>
</body>
...
![](img/01bec26ebfce1e236d6474d513d6a665.png)
