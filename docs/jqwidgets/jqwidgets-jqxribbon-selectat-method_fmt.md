# jqxRibbon 的 `selectAt()` 方法

> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxribbon-selectat-method/](https://www.geeksforgeeks.org/jqwidgets-jqxribbon-selectat-method/)
...
`selectAt()` 方法用于选择给定索引的项目。它接受数字类型的单参数 `index`，不返回值。
...
下面的例子说明了 jQWidgets `jqxRibbon` `selectAt()` 方法。
...
<body>
    <center>
        ...
        <h3>
            jQWidgets jqxRibbon selectAt() Method
        </h3>
    </center>
    ...
    <center>
        <input type="button" id="jqxBtn" 
            value="Select Item of Given Index" 
...
![](img/4f29872cb2123fb01652ca633e0c9acd.png)
