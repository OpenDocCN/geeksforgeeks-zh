...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxtooltip-close-method/](https://www.geeksforgeeks.org/jqwidgets-jqxtooltip-close-method/)
...
`close()`方法用于设置工具提示关闭前的时间。如果未设置此方法，工具提示将立即关闭。它接受数字类型的单参数索引，不返回任何值。
...
下面的例子说明了 jQWidgets `jqxTooltip` `close()`方法。
...
![](img/07aaebe1fe0d9a80069c96def799eab5.png)
