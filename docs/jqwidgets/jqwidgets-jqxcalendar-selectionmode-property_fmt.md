...
> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxcalendar-selectionmode-property/](https://www.geeksforgeeks.org/jqwidgets-jqxcalendar-selectionmode-property/)
...
`selectionMode` 属性用于设置或返回选择模式。它接受字符串类型值，其默认值为 `"default"`。
...
**示例：** 以下示例说明了 jQWidgets 中的 `jqxCalendar` `selectionMode` 属性。
