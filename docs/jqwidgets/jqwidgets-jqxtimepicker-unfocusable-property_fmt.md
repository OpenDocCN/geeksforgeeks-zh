...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxtimepicker-unfocusable-property/](https://www.geeksforgeeks.org/jqwidgets-jqxtimepicker-unfocusable-property/)
...
`unfocusable` 属性用于检查时间元素是否可聚焦。它接受布尔类型值。
...
## 链接文件
从给定链接下载。在 HTML 文件中，找到下载文件夹中的脚本文件。
...
## 示例
下面的示例说明了 jQWidgets `jqxTimePicker` `unfocusable` 属性。
