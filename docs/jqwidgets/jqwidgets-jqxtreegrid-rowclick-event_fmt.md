...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxtreegrid-rowclick-event/](https://www.geeksforgeeks.org/jqwidgets-jqxtreegrid-rowclick-event/)
...
下面的示例说明了 `jQWidgets` `jqxTreeGrid` `rowClick` 事件。
