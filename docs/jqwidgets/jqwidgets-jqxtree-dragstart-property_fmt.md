...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxtree-dragstart-property/](https://www.geeksforgeeks.org/jqwidgets-jqxtree-dragstart-property/)
...
`dragStart` 属性用于设置项目拖动开始时调用的回调函数。它接受函数类型值，默认值为空。
