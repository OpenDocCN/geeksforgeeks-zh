# jQWidgets jqxNumberInput valueChanged 事件

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxnumberinput-valuechanged-event/](https://www.geeksforgeeks.org/jqwidgets-jqxnumberinput-valuechanged-event/)
...
下面的例子说明了 jQWidgets jqxNumberInput `valueChanged` 事件。
