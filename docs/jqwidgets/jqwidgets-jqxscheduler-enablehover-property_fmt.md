# jQWidgets jqxScheduler 启用悬停属性

> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxscheduler-enablehover-property/](https://www.geeksforgeeks.org/jqwidgets-jqxscheduler-enablehover-property/)
...
`enableHover` 属性用于设置或返回单元格悬停是否在 `jqxScheduler` 中显示。它属于布尔类型，默认值为 `true`。
...
**示例：** 以下示例说明了 jQWidgets 中的 `jqxScheduler` 的 `enableHover` 属性。
