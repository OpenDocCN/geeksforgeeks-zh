# jQWidgets jqxInput 变更事件

> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxinput-change-event/](https://www.geeksforgeeks.org/jqwidgets-jqxinput-change-event/)

jQWidgets 是一个 JavaScript 框架，用于为 PC 和移动设备制作基于 web 的应用程序。它是一个非常强大、优化、独立于平台并且得到广泛支持的框架。`jqxInput` 用于表示包含自动完成功能的 jQuery 输入小部件。

当输入值改变时，触发`change`事件。
...
下面的例子说明了 jQWidgets 中的 `jqxInput` 更改事件。
...
![](img/de302ac7ea9bd58ca9c66ef0f9c31585.png)
