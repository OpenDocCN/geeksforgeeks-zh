# jQWidgets jqxDateTimeInput dropDownVerticalAlignment 属性

> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxdatetimeinput-dropdownverticalalignment-property/](https://www.geeksforgeeks.org/jqwidgets-jqxdatetimeinput-dropdownverticalalignment-property/)
...
`dropDownVerticalAlignment` 属性用于设置或返回下拉垂直对齐。它接受字符串类型的值，默认值为“bottom”。
...
下面的例子说明了 jQWidgets 中的 `jqxDateTimeInput` `dropDownVerticalAlignment` 属性。
