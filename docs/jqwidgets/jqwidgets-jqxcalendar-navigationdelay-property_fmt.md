...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxcalendar-navigationdelay-property/](https://www.geeksforgeeks.org/jqwidgets-jqxcalendar-navigationdelay-property/)
...
`navigationDelay` 属性用于设置或返回切换视图之间的动画延迟时间。它接受数字类型值，默认值为 400。
...
以下示例说明了 `jQWidgets` 中的 `jqxCalendar` `navigationDelay` 属性。
