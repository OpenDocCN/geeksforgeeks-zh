...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxmaskedinput-readonly-property/](https://www.geeksforgeeks.org/jqwidgets-jqxmaskedinput-readonly-property/)
...
`readOnly` 属性用于设置或返回输入的只读状态。它接受布尔类型值，默认值为 `false`。
