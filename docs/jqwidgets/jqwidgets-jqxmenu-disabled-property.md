...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxmenu-disabled-property/](https://www.geeksforgeeks.org/jqwidgets-jqxmenu-disabled-property/)
...
**禁用属性**用于启用或禁用 jqxMenu 小部件。它接受布尔类型值，默认值为 false。
