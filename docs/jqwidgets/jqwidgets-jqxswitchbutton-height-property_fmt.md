# jQWidgets jqxSwitchButton 高度属性

> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxswitchbutton-height-property/](https://www.geeksforgeeks.org/jqwidgets-jqxswitchbutton-height-property/)
...
`height` 属性用于设置或获取显示的开关按钮的高度。它属于数字或字符串类型，默认值为 `null`。
...
以下示例说明了 jQWidgets 中的 `jqxSwitchButton` `height` 属性。
