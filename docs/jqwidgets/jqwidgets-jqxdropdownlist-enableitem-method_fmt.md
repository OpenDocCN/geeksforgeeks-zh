...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-enableitem-method/](https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-enableitem-method/)
...
`enableItem()` 方法用于启用一个项目。它接受字符串/对象类型的单个参数 `item`，并且不返回值。
