# jQWidgets jqxTabs 拖拽事件

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxtabs-dragend-event/](https://www.geeksforgeeks.org/jqwidgets-jqxtabs-dragend-event/)
...
下面的例子说明了 jQWidgets `jqxTabs` `dragEnd` 事件。
...
<body>
    <center>
        ...
        <h3>
            jQWidgets jqxTabs dragEnd Event
        </h3>
...
![](img/0c35b36f6b9cd53f8e62bc7d70224160.png)
