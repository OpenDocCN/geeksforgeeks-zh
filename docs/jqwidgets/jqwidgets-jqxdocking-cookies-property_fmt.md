...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdocking-cookies-property/](https://www.geeksforgeeks.org/jqwidgets-jqxdocking-cookies-property/)
...
**示例:** 下面的示例说明了 jQWidgets `jqxDocking` 的 `cookies` 属性。在下面的示例中，`cookies` 属性的值被设置为 `true`。
