...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-ensurevisible-method/](https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-ensurevisible-method/)
...
`ensureVisible()` 方法用于确保项目可见。它接受数字类型的单参数 `index`，不返回值。索引从 0 开始。
