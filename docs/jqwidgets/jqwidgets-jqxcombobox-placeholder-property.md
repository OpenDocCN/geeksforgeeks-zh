...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxcombobox-placeholder-property/](https://www.geeksforgeeks.org/jqwidgets-jqxcombobox-placeholder-property/)
...
**占位符属性**用于设置或返回占位符的输入字段。它接受字符串类型值，默认值为“”。
