...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdocking-windowsmode-property/](https://www.geeksforgeeks.org/jqwidgets-jqxdocking-windowsmode-property/)
...
下面的示例说明了 `jQWidgets` 的 `windowsMode` 属性。在下面的例子中，`windowsMode` 属性的值被设置为 `'floating'`。
