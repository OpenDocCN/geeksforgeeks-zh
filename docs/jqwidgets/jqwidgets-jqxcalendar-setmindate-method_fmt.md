...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxcalendar-setmindate-method/](https://www.geeksforgeeks.org/jqwidgets-jqxcalendar-setmindate-method/)
...
`setMinDate()` 方法用于设置日历小部件中可以导航的最低日期。此方法接受“日期/字符串”类型的单个参数 `date`。它不返回值。
