# jQWidgets jqxDropDownButton set content()方法

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxdropdownbutton-set content-method/](https://www.geeksforgeeks.org/jqwidgets-jqxdropdownbutton-setcontent-method/)
...
**设置内容()方法**用于设置显示的下拉按钮的内容。它包含一个参数，即可以是字符串或 HTML 类型的内容。它不返回任何东西。
...
**示例:**下面的示例说明了 jQWidgets 中的 jqxDropDownButton**setContent()方法**。
