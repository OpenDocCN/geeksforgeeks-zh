# jQWidgets jqxFormattedInput 变更事件

> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxformattedinput-change-event/](https://www.geeksforgeeks.org/jqwidgets-jqxformattedinput-change-event/)
...
以下示例说明了 jQWidgets `jqxFormattedInput` 更改事件。
...
<body>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $("#jqxFI").on("change", function (event) {
...
![](img/5b1227faea26c3ed4fed6984f9415470.png)
