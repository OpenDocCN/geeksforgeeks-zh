...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxtabs-enabledhover-property/](https://www.geeksforgeeks.org/jqwidgets-jqxtabs-enabledhover-property/)
...
**启用悬停属性**用于启用或禁用标签悬停效果。它接受布尔类型值，默认值为真。
