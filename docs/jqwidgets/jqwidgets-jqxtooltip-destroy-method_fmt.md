...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxtooltip-destroy-method/](https://www.geeksforgeeks.org/jqwidgets-jqxtooltip-destroy-method/)
...
`destroy()`方法用于通过从 DOM 中移除工具提示元素来销毁工具提示元素。它不接受任何参数，也不返回值。
