...
> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxscheduler-clearappointmentsselection-method/](https://www.geeksforgeeks.org/jqwidgets-jqxscheduler-clearappointmentsselection-method/)
...
`clearAppointmentsSelection()` 方法用于从显示的 `jqxScheduler` 中清除预约选择。它没有参数，也不返回任何内容。
...
下面的例子说明了 `jqxScheduler` `clearAppointmentsSelection()` 方法在 jQWidgets 中的作用。
