# jQWidgets jqxDataTable 页面大小选项属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdatatable-pagesizeoptions-property/](https://www.geeksforgeeks.org/jqwidgets-jqxdatatable-pagesizeoptions-property/)
...
**示例:** 以下示例说明了 jQWidgets `pageSizeOptions` 属性。在下面的例子中，`pageSizeOptions` 属性的值被设置为 `[1, 2, 3, 4]`。
