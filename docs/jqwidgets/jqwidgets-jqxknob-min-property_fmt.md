# jQWidgets jqxKnob min 属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxknob-min-property/](https://www.geeksforgeeks.org/jqwidgets-jqxknob-min-property/)
...
以下示例说明了 jQWidgets `jqxKnob` 的 `min` 属性。在以下示例中， `min` 属性的值已设置为 0。
