# jqwidgets jqxtarea popup zindex 属性

> 原文:[https://www . geeksforgeeks . org/jqwidgets-jqxtextarea-popupzindex-property/](https://www.geeksforgeeks.org/jqwidgets-jqxtextarea-popupzindex-property/)
...
**弹出菜单属性**用于设置或返回自动建议弹出菜单的 z 索引。它接受数字类型值，默认值为 20000。
...
```html
$('selector').jqxTextArea({ popupZIndex: false });
```

返回 popupZIndex 属性。

```html
var popupZIndex = $('selector').jqxTextArea('popupZIndex');
```
...
下面的示例说明了 jQWidgets jqxTextArea popupZIndex 属性。
...
        <h3>
            jQWidgets jqxTextArea popupZIndex Property
        </h3>
...
![](img/77df3e9bdb3d722bd5d89aae733334b5.png)
