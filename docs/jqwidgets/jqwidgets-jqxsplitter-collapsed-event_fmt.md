...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxsplitter-collapsed-event/](https://www.geeksforgeeks.org/jqwidgets-jqxsplitter-collapsed-event/)
...
当指定 `jqxSplitter` 的面板折叠时，会触发 `collapsed` 事件。
...
下面的示例说明了 jQWidgets jqxSplitter `collapsed` 事件。
