# jQWidgets jqxTree animationhidedduration 属性
...
**animationhidedduration 属性**用于设置或返回 jqxTree 小部件的隐藏持续时间。它接受数字类型的值，默认值是快速。
...
下面的例子说明了 jQWidgets jqxTree animationhidedduration 属性。
