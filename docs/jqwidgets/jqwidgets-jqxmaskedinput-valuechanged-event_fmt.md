# jQWidgets jqxMaskedInput valueChanged 事件

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxmaskedinput-valuechanged-event/](https://www.geeksforgeeks.org/jqwidgets-jqxmaskedinput-valuechanged-event/)
...
下面的例子说明了 jQWidgets jqxMaskedInput `valueChanged` 事件。
