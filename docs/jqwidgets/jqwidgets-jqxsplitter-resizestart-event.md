# jqwidgets jqxssplitter resize start event

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxsplitter-resize start-event/](https://www.geeksforgeeks.org/jqwidgets-jqxsplitter-resizestart-event/)
...
当指定 jqxSplitter 的“调整开始”操作开始时，触发 ***【调整开始】*** 事件。
...
**示例:**下面的示例说明了 jQWidgets jqxSplitter***resizeStart***事件。
...
        </h1>
        <h3>
            jQWidgets jqxSplitter resizeStart Event
        </h3>
        <div id='jqx_Splitter'>
...
                    resizable: true
                });
                $('#jqx_Splitter').on('resizeStart',
                    function () {
                        $("#log").html(
                       "Resizing has been started."
                        );
                    });
            });
        </script>
...
![](img/ddd4ca64f0fcf829c651bd988e72c732.png)
