# jQWidgets jqxComboBox check index()方法

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxcombobox-check index-method/](https://www.geeksforgeeks.org/jqwidgets-jqxcombobox-checkindex-method/)
...
checkIndex()方法用于在“checkboxes”属性为真时检查 jqxComboBox 列表项。此方法与“复选框”属性一起使用。它接受数字类型的单个参数*索引*，并且不返回任何值。
