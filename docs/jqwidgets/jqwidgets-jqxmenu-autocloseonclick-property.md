# jQWidgets jqxMenu 自动锁定点击属性

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxmenu-autocloseonclick-property/](https://www.geeksforgeeks.org/jqwidgets-jqxmenu-autocloseonclick-property/)
...
**自动关闭点击属性**用于设置或返回点击后自动关闭打开的弹出窗口。它接受布尔类型值，默认值为真。
