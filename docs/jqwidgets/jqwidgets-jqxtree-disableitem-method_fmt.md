# jQWidgets jqxtreme disableItem()方法

> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxtree-disableitem-method/](https://www.geeksforgeeks.org/jqwidgets-jqxtree-disableitem-method/)
...
`disableItem()`方法用于禁用小部件的一个树项目。它接受对象类型的单个参数项，不返回任何值。

## 语法

```html
$('Selector').jqxTree('disableItem', element);
```
...
下面的例子说明了 jQWidgets `jqxTree` `disableItem()`方法。
...
<body>
    ...
    <h3>
        jQWidgets jqxTree disableItem() Method
    </h3>
...
![](img/16ea1aec82ae1da167e4ed0a83ee32d0.png)
