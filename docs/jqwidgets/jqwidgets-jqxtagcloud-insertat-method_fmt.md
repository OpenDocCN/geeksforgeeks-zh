...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxtagcloud-insertat-method/](https://www.geeksforgeeks.org/jqwidgets-jqxtagcloud-insertat-method/)
...
以下示例说明了 `jQWidgets` 的 `insertAt()` 方法。在下面的示例中，将在第 0 个元素之前插入一个新元素。
