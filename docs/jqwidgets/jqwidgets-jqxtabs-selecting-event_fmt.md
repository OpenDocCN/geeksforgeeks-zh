...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxtabs-selecting-event/](https://www.geeksforgeeks.org/jqwidgets-jqxtabs-selecting-event/)
...
`选择事件`用于当用户开始从 `jqxTabs` 小部件中选择选项卡时触发。

**语法:**

```html
$('Selector').on('selecting', function (event) { });
```
...
下面的例子说明了 jQWidgets `jqxTabs` 选择事件。
...
<h3>
            jQWidgets jqxTabs selecting Event
        </h3>
...
                alert('selecting event triggered');
            });
        });
    </script>
</body>
...
![](img/983915b58139116be3a9c0416b915e4b.png)
