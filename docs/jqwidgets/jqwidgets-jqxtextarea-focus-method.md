...
> 原文:[https://www . geeksforgeeks . org/jqwidgets-jqxtextarea-focus-method/](https://www.geeksforgeeks.org/jqwidgets-jqxtextarea-focus-method/)
...
**focus()** 方法用于设置 jqxTextArea 小部件的焦点。它不接受任何参数，也不返回值。
...
**示例:**下面的示例说明了 jQWidgets jqxTextArea**focus()**方法。
...
![](img/368a3861aea65bcbcef81c2e3ec6e70a.png)
