# jQWidgets jqxnumber input spinButtonsWidth 属性

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxnumberinput-spinbutonswidth-property/](https://www.geeksforgeeks.org/jqwidgets-jqxnumberinput-spinbuttonswidth-property/)
...
**微调按钮开关属性** y 用于设置或返回微调按钮的宽度。它接受数字类型值，默认值为 18。
...
下面的例子说明了 jQWidgets jqxnumber input spinButtonsWidth 属性。
