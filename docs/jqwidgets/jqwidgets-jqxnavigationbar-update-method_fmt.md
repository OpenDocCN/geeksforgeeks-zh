...
> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxnavigationbar-update-method/](https://www.geeksforgeeks.org/jqwidgets-jqxnavigationbar-update-method/)
...
## 示例：
下面的示例说明了 `jQWidgets` `jqxNavigationBar` `update()` 的方法。在下面的示例中，第 0 个项目的标题和内容正在更新。
