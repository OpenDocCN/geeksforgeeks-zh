# jQWidgets jqxTextArea maxLength 属性

> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxtextarea-maxlength-property/](https://www.geeksforgeeks.org/jqwidgets-jqxtextarea-maxlength-property/)

`jQWidgets` 是一个 JavaScript 框架，用于为 PC 和移动设备制作基于 web 的应用程序。`jqxTextArea` 代表一个 jQuery Textarea 小部件，用于在文本框中插入文本内容。

`maxLength` 属性用于设置或返回文本区域的最大字符长度。它接受数字类型值，默认值为空。
...
以下示例说明了 `jQWidgets` `jqxTextArea` 的 `maxLength` 属性。
...
![](img/363f407892fdffa7ff1c7b4cecdd4a70.png)
