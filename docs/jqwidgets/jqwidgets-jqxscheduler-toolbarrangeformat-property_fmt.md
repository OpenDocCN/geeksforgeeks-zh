...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxscheduler-toolbarrangeformat-property/](https://www.geeksforgeeks.org/jqwidgets-jqxscheduler-toolbarrangeformat-property/)
...
`toolBarRangeFormat` 属性用于在显示的 `jqxScheduler` 中设置或返回工具栏的日期格式。它属于字符串类型，默认情况下，它的值为“日 MMMM 年”。

## 语法

*   设置 `toolBarRangeFormat` 属性。
...
下面的示例说明了 jQWidgets 中的 `jqxScheduler` `toolBarRangeFormat` 属性。
...
<body>
    <center>
        ...
        <h3>jQWidgets jqxScheduler toolBarRangeFormat property </h3>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#jqxBtn").on("click", function () {
                var trf = $('#jqxs').jqxScheduler('toolBarRangeFormat');
                $('#log').text("Toolbars date format: " + trf);
            });
        });
    </script>
</body>
...
![](img/b035773068ce10558d36f54d2e25789b.png)
