# jQWidgets jqxMaskedInput 值属性

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxmaskedinput-value-property/](https://www.geeksforgeeks.org/jqwidgets-jqxmaskedinput-value-property/)
...
**值属性**用于设置或返回屏蔽输入的值。它接受字符串类型值，默认值为空。
...
下面的示例说明了 jQWidgets jqxMaskedInput 值属性。
