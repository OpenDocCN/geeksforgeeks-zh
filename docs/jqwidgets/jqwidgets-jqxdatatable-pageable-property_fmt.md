# jQWidgets jqxDataTable 可分页属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdatatable-pageable-property/](https://www.geeksforgeeks.org/jqwidgets-jqxdatatable-pageable-property/)

`jQWidgets` 是一个 JavaScript 框架，用于为 PC 和移动设备制作基于 web 的应用程序。它是一个非常强大、优化、独立于平台并且得到广泛支持的框架。`jqxDataTable` 用于读取和显示 HTML 表格中的数据。这也用于显示来自各种数据源的数据，如 XML、JSON、Array、CSV 或 TSV。

`pageable` 属性用于检查指定的 `jqxDataTable` 是否处于分页模式。该属性有两个可能的值，即“真”和“假”。
...
下面的例子说明了 `jQWidgets` 的 `pageable` 属性。在下面的示例中，`pageable` 属性的值被设置为“真”。
...
<body>
    <center>
        ...
        <h3>
            jQWidgets jqxDataTable pageable Property
        </h3>
...
![](img/b04b66613b4b460cae33c69b7ea309f7.png)
