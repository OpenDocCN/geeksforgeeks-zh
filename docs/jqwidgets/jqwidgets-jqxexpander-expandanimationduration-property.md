# jQWidgets jqxExpander expandinationduration 属性

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxexpander-expandinationduration-property/](https://www.geeksforgeeks.org/jqwidgets-jqxexpander-expandanimationduration-property/)
...
**扩展动画持续时间属性**用于设置或返回扩展动画持续时间。它接受数字类型值，默认值为 400。
...
下面的例子说明了 jQWidgets jqxExpander expandinationduration 属性。
...
![](img/2cf5ae800557878d8ec3629e8534aa5d.png)
