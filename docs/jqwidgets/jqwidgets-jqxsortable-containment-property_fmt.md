...
> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxsortable-containment-property/](https://www.geeksforgeeks.org/jqwidgets-jqxsortable-containment-property/)
...
以下示例说明了 `jQWidgets` 中的 `jqxSortable` **包含属性**：
