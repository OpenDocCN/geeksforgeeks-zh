...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdropdownbutton-destroy-method/](https://www.geeksforgeeks.org/jqwidgets-jqxdropdownbutton-destroy-method/)
...
**destroy()方法** 用于销毁显示的下拉按钮。它没有参数，也不返回任何内容。
...
<body>
    <center>
      ...
      <h3>jQWidgets jqxDropDownButton destroy() method</h3>
      <br />
      <div>
        <input
          type="button"
