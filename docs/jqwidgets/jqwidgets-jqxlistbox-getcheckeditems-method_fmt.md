...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxlistbox-getcheckeditems-method/](https://www.geeksforgeeks.org/jqwidgets-jqxlistbox-getcheckeditems-method/)
...
下面的示例说明了 jQWidgets 中的 `jqxListBox` `getCheckedItems()` 方法。
