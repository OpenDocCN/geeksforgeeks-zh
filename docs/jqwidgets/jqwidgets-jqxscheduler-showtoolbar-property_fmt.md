# jQWidgets jqxScheduler showToolbar 属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxscheduler-showtoolbar-property/](https://www.geeksforgeeks.org/jqwidgets-jqxscheduler-showtoolbar-property/)
...
`showToolbar` 属性用于设置或返回 `jqxScheduler` 的导航工具栏是否可见。它属于布尔类型，默认值为 `true`。
...
以下示例说明了 jQWidgets 中的 `jqxScheduler` `showToolbar` 属性。
...
<body>
    <center>
        ...
        <h3>jQWidgets jqxScheduler showToolbar property</h3>
