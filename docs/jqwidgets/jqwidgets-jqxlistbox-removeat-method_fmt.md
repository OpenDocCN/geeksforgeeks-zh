# jqxListBox removeAt()方法

> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxlistbox-removeat-method/](https://www.geeksforgeeks.org/jqwidgets-jqxlistbox-removeat-method/)
...
下面的示例说明了 jQWidgets 中的 `jqxListBox` `removeAt()` 方法。
