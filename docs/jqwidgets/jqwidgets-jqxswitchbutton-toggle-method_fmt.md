...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxswitchbutton-toggle-method/](https://www.geeksforgeeks.org/jqwidgets-jqxswitchbutton-toggle-method/)
...
`toggle()`方法用于切换开关按钮的选中状态。此外，只要用户按下显示的开关按钮，该方法就会自动调用。它没有参数，也不返回任何内容。
