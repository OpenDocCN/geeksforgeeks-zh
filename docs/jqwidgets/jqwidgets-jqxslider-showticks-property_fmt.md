...
> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxslider-showticks-property/](https://www.geeksforgeeks.org/jqwidgets-jqxslider-showticks-property/)
...
`showTicks` 属性用于设置或返回是否显示刻度。它接受布尔类型值，默认值为 `true`。
...
下面的例子说明了 jQWidgets `jqxSlider` 的 `showTicks` 属性。
...
<body>
    <center>
        ...
        <h3>
            jQWidgets jqxSlider showTicks Property
        </h3>
        <div id='content'>
...
![](img/11061d02eefb80625e7f4422687d1a11.png)
