# jQWidgets jqxdatetime input dropdowhorizontalignment 属性

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxdatetimeinput-dropdowhorizontalization-property/](https://www.geeksforgeeks.org/jqwidgets-jqxdatetimeinput-dropdownhorizontalalignment-property/)
...
**下拉水平对齐属性**用于设置或返回下拉水平对齐。它接受字符串类型值，默认值为“左”。
...
下面的例子说明了 jQWidgets 中的 jqxDateTimeInput dropdowhorizontalignment 属性。
