# jQWidgets jqxTagCloud 显示成员属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxtagcloud-displaymember-property/](https://www.geeksforgeeks.org/jqwidgets-jqxtagcloud-displaymember-property/)
...
以下示例说明了 `jQWidgets` `jqxTagCloud` `displayMember` 属性。在下面的例子中，`displayMember` 属性的值被设置为 `'Name'`。
