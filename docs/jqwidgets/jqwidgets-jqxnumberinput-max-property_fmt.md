# jqwidgets jqxNumberInput max 属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxnumberinput-max-property/](https://www.geeksforgeeks.org/jqwidgets-jqxnumberinput-max-property/)
...
`max` 属性用于设置或返回 `jqxNumberInput` 小部件的最大值。它接受数字类型值，默认值为 `99999999`。
