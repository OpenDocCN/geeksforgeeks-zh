# jQWidgets jqxComboBox autodropdownhead 属性

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxcombobox-autodropdownheight-property/](https://www.geeksforgeeks.org/jqwidgets-jqxcombobox-autodropdownheight-property/)
...
*自动下拉高度*属性用于设置或返回下拉列表中显示的组合框列表的高度。它被计算为项目高度的总和。它接受布尔类型值，默认值为*假*。
...
**示例:**下面的示例说明了 jQWidgets 中的 jqxComboBox*autodropdownhead*属性。
