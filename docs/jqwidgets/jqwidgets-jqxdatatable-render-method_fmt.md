...
> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxdatatable-render-method/](https://www.geeksforgeeks.org/jqwidgets-jqxdatatable-render-method/)
...
下面的例子说明了`jQWidgets`的`render()`方法。
