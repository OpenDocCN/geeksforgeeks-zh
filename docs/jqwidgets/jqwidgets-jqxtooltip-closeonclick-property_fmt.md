# jQWidgets jqxTooltip closeOnClick 属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxtooltip-closeonclick-property/](https://www.geeksforgeeks.org/jqwidgets-jqxtooltip-closeonclick-property/)
...
`closeOnClick` 属性用于设置或返回工具提示点击后是否关闭。它接受布尔类型值，默认值为 `true`。
