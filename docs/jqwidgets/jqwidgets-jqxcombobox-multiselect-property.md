...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxcombobox-multiselect-property/](https://www.geeksforgeeks.org/jqwidgets-jqxcombobox-multiselect-property/)
...
*多选*属性用于在多选模式下设置或返回 jqxComboBox。它接受布尔类型值，默认值为*假*。
...
**示例:**以下示例说明了 jQWidgets 中的 jqxComboBox *多选*属性。
