...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdropdownbutton-focus-method/](https://www.geeksforgeeks.org/jqwidgets-jqxdropdownbutton-focus-method/)
...
`focus()`方法用于聚焦显示的下拉按钮。它没有参数，也不返回任何内容。
...
下面的例子说明了 `jQWidgets` 中的 `jqxDropDownButton` `focus()`方法。
