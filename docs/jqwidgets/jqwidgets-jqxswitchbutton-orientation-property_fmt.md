...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxswitchbutton-orientation-property/](https://www.geeksforgeeks.org/jqwidgets-jqxswitchbutton-orientation-property/)
...
方向属性用于检查显示的开关按钮的方向。它属于字符串类型，默认值为 `"horizontal"`。
...
<html lang="en">
  ...
  <body>
    <center>
      ...
      <h3>jQWidgets jqxSwitchButton orientation property</h3>
      <br />
      <div id="jqxSB"></div>
      <div>
        <input
    ...
    <script type="text/javascript">
      $(document).ready(function () {
        ...
        $("#jqxBtn").on("click", function () {
          var orn = $("#jqxSB").jqxSwitchButton("orientation");
