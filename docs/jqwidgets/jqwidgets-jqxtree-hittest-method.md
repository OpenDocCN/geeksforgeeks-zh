...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxtree-hittest-method/](https://www.geeksforgeeks.org/jqwidgets-jqxtree-hittest-method/)
...
**hitTest()方法**用于获取特定位置的项目。它接受左边的两个参数，并在数字类型的顶部设置偏移量并返回对象类型值。
