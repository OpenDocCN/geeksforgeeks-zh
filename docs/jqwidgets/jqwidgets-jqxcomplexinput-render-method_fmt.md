...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxcomplexinput-render-method/](https://www.geeksforgeeks.org/jqwidgets-jqxcomplexinput-render-method/)
...
下面的例子说明了 jQWidgets `jqxComplexInput` `render()`方法。
