...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxeditor-linebreak-property/](https://www.geeksforgeeks.org/jqwidgets-jqxeditor-linebreak-property/)
...
**lineBreak 属性**用于设置或返回 `lineBreak` 属性，即该属性决定在编辑器中按回车键时是创建 `BR`、`P` 还是 `DIV` 标签。它接受字符串类型值，默认值为“默认值”。
