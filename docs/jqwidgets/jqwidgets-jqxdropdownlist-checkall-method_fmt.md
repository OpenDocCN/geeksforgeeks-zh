...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-checkall-method/](https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-checkall-method/)
...
当 `checkboxes` 属性值为 `true` 时，`checkAll()` 方法用于检查所有列表项。它不接受任何参数，也不返回值。

## 语法
```html
$("Selector").jqxDropDownList('checkAll');
```
...
## 示例
下面的示例说明了 jQWidgets 中的 `jqxDropDownList` `checkAll()` 方法。
...
<body>
    <center>
        ...
        <h3>
            jQWidgets jqxDropDownList checkAll() Method
        </h3>

        <div id='jqxDDL'></div>

        <input id="jqxBtn" type="button" value="Check All Items" 
...
## 输出
![](img/52b8ddfafa7c8a5c72f2f8afecc81245.png)
