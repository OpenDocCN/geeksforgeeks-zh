# jQWidgets jqxToolBar 最小宽度属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxtoolbar-minwidth-property/](https://www.geeksforgeeks.org/jqwidgets-jqxtoolbar-minwidth-property/)
...
**最小宽度属性**用于设置或返回显示的 `jqxToolBar` 的最小宽度。它是数字或字符串类型，缺省值为空。
...
下面的例子说明了 jQWidgets 中的 `jqxToolBar` `minWidth` 属性。
...
<body>
    <center>
        ...
        <h3>jQWidgets jqxToolBar minWidth property
        </h3>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#jqxBtn").on("click", function () {
                var mw = $('#jqxtb').jqxToolBar('minWidth');
                $('#log').text("Minimum width of toolbar: " + mw);
            });
        });
    </script>
</body>
...
![](img/149caf2f0df0ade21e2147048a8d5bc6.png)
