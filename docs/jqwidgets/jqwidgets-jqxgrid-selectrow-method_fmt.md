...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxgrid-selectrow-method/](https://www.geeksforgeeks.org/jqwidgets-jqxgrid-selectrow-method/)

**jQWidgets** 是一个 JavaScript 框架，用于为 PC 和移动设备制作基于 web 的应用程序。它是一个非常强大、优化、独立于平台并且得到广泛支持的框架。`jqxGrid` 用于说明以表格形式显示数据的 jQuery 小部件。此外，它完全支持与数据的连接，以及分页、分组、排序、过滤和编辑。

## selectrow() 方法

`selectrow()` 方法用于从显示的 `jqxGrid` 中选择一行。其中，选择模式为单行、多行或多行扩展。它有一个名为 `rowBoundIndex` 的参数，类型为数字。它不返回任何东西。
...
下面的例子说明了 jQWidgets 中的 `jqxGrid` `selectrow()`方法。
...
<body>
    <center>
        ...
        <h3>jQWidgets jqxGrid unselectrow() method
        </h3>
        <br />
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#jqxBtn").on("click", function () {
                ...
                $("#log").text("Fourth row is unselected!");
            });
        });
    </script>
</body>
...
![](img/bf5e0cfec0651db819877d5c76046670.png)
