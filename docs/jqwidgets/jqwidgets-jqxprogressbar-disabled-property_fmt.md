...
> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxprogressbar-disabled-property/](https://www.geeksforgeeks.org/jqwidgets-jqxprogressbar-disabled-property/)
...
`disabled` 属性用于设置或返回进度条是否禁用。它接受布尔类型值，默认值为 `false`。
