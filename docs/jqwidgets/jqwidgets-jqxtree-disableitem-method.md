...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxtree-disable item-method/](https://www.geeksforgeeks.org/jqwidgets-jqxtree-disableitem-method/)
...
**disableItem()方法**用于禁用小部件的一个树项目。它接受对象类型的单个参数项，不返回任何值。
