# jQWidgets jqxnumber 输入自旋模式属性

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxnumberinput-spin mode-property/](https://www.geeksforgeeks.org/jqwidgets-jqxnumberinput-spinmode-property/)
...
**自旋模式属性**用于设置或返回自旋模式。它接受字符串类型值，默认值为“高级”。

它的可能值是–

*   **“高级”–**用于根据插入符号的位置增加/减少值。
*   **“简单”–**用于禁用旋转行为。
...
下面的例子说明了 jQWidgets jqxnumber input spin mode 属性。
