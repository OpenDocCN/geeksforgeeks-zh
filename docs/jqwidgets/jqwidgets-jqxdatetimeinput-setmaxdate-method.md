# jqwidget jqxdatetimeinput mxadate()方法

> 哎哎哎:# t0]https://www . geeksforgeeks . org/jqwidgets-jqxdatetimeinput-setmaxdate-method/
...
**setMaxDate()** 方法用于设置可以导航的最大日期。它接受日期/字符串类型的单参数日期，并且不返回任何值。
...
**示例:**下面的示例说明了 jQWidgets 中的 jqxDateTimeInput**setMaxDate()**方法。
...
![](img/602d2f5072e3db3b0d976ecf5817cfdc.png)
