...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxwindow-maxheight-property/](https://www.geeksforgeeks.org/jqwidgets-jqxwindow-maxheight-property/)

## jQWidgets 与 jqxWindow 简介
...
下面的示例说明了 jQWidgets 中的 jqxWindow `maxHeight` 属性。在本例中，最大高度设置为 250。
