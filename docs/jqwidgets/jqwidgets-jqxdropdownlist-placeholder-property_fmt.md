# jQWidgets jqxDropDownList 占位符属性

> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-placeholder-property/](https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-placeholder-property/)
...
`placeHolder` 属性用于设置或返回所选内容为空时显示的文本。它接受字符串类型值，默认值为“请选择”。
...
以下示例说明了 `jQWidgets` 中的 `jqxDropDownList` `placeHolder` 属性。
...
<body>
    <center>
        ...
        <h3>
            jQWidgets jqxDropDownList placeHolder Property
        </h3>
        <div id='jqxDDL'></div>
    </center>
    <script type="text/javascript">
...
![](img/82f134889077db48732aae9c32f451a4.png)
