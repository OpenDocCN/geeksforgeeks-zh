# jQWidgets jqxTree collapse item()方法

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxtree-collapse item-method/](https://www.geeksforgeeks.org/jqwidgets-jqxtree-collapseitem-method/)
...
**collapseItem()方法**用于通过传递一个元素作为参数来折叠一个树项。它接受对象类型的单个参数项，不返回任何值。
