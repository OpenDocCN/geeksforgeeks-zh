# jQWidgets jqxNumberInput allowNull 属性

> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxnumberinput-allownull-property/](https://www.geeksforgeeks.org/jqwidgets-jqxnumberinput-allownull-property/)
...
`allowNull` 属性用于设置或返回 `jqxNumberInput` 小部件值是否可以为空。它接受布尔类型值，默认值为真。
