...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxtabs-showclosebuttons-property/](https://www.geeksforgeeks.org/jqwidgets-jqxtabs-showclosebuttons-property/)
...
**showCloseButtons 属性**用于设置或返回每个选项卡中是否显示关闭按钮。它接受布尔类型值，默认值为 false。
