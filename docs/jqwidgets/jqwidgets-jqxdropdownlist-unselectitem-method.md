# jQWidgets jqxDropDownList unselect item()方法

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxddropdownlist-unselect item-method/](https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-unselectitem-method/)
...
**取消选择项目()方法**用于使用项目名称取消选择项目。它接受对象/字符串类型的单个参数项，并且不返回值。

**语法:**

```html
$("Selector").jqxDropDownList('unselectItem', item);
```
...
下面的例子说明了 jQWidgets 中的 jqxDropDownList unselectItem()方法。
...
![](img/f60e0bec94520fa56dab17f95dd395c5.png)
