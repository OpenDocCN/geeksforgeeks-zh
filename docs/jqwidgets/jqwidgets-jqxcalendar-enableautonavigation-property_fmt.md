# jQWidgets jqxCalendar 启用自动导航属性

> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxcalendar-enableautonavigation-property/](https://www.geeksforgeeks.org/jqwidgets-jqxcalendar-enableautonavigation-property/)
...
`enableAutoNavigation` 属性用于设置或返回一个值，该值指示自动导航是否启用。如果这个属性为真，那么点击另一个月的日期会自动导航到前一个月或下一个月。它接受布尔类型值，默认值为真。
