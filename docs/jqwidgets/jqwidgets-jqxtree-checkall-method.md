...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxtree-check all-method/](https://www.geeksforgeeks.org/jqwidgets-jqxtree-checkall-method/)
...
**checkAll()方法**用于检查树小部件的所有项目。它不接受任何参数，也不返回值。
