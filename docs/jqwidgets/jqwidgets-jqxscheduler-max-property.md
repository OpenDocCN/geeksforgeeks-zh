# jQWidgets jqxScheduler 最大属性

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxscheduler-max-property/](https://www.geeksforgeeks.org/jqwidgets-jqxscheduler-max-property/)
...
***【max】***属性用于设置或返回显示的 **jqxScheduler** 的最大航空日期。类型为 **jqxDate** ，默认值为“new $.jqx.date(9999，12，31)”
...
**示例:**下面的示例说明了 jQWidgets 中的 **jqxScheduler** *max* 属性。
