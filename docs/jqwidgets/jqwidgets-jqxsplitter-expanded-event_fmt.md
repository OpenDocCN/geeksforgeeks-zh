...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxsplitter-expanded-event/](https://www.geeksforgeeks.org/jqwidgets-jqxsplitter-expanded-event/)
...
当展开指定 `jqxSplitter` 的面板时，会触发 `expanded` 事件。
...
以下示例说明了 `jQWidgets` `jqxSplitter` 的 `expanded` 事件。
