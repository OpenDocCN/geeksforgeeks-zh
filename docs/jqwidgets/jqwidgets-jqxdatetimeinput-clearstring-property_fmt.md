# jqwidgets jqxdatetimeinput clearstring property

> 哎哎哎:# t0]https://www . geeksforgeeks . org/jqwidgets-jqxdatetimeinput-clearstring-property/
...
`clearString` 属性用于设置或返回当 `showFooter` 属性设置为真时显示的“清除”字符串。它接受字符串类型值，默认值为“清除”。
...
下面的例子说明了 jQWidgets 中的 `jqxDateTimeInput` `clearString` 属性。
...
![](img/f31c36c8d5feabe92d98af7dbc0870fe.png)
