...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdatatable-width-property/](https://www.geeksforgeeks.org/jqwidgets-jqxdatatable-width-property/)
...
`width` 属性用于设置或获取指定 `jqxDataTable` 的宽度。
...
以下示例说明了 jQWidgets `width` 属性。在下面的示例中，`width` 属性的值被设置为 600。
