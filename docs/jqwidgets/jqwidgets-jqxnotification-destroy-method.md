# jQWidgets jqxNotification 销毁()方法

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxnotification-destroy-method/](https://www.geeksforgeeks.org/jqwidgets-jqxnotification-destroy-method/)
...
**销毁()方法**用于销毁通知。它不接受任何参数，也不返回值。

**语法:**

```html
$('Selector').jqxNotification('destroy');
```
...
**示例:**以下示例说明了 jQWidgets 中的 jqxNotification destroy()方法:
...
    <h3>
        jQWidgets jqxNotification destroy() method
    </h3>
...
![](img/50f37ad04c93585ee66b3645d56d0b03.png)
