...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxrangeselector-height-property/](https://www.geeksforgeeks.org/jqwidgets-jqxrangeselector-height-property/)
...
**高度属性**用于设置或返回范围选择器的高度。它接受数字/字符串类型的值，默认值为 100。
...
下面的例子说明了 jQWidgets jqxRangeSelector 高度属性。
