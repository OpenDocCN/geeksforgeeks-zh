...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxradiobutton-focus-method/](https://www.geeksforgeeks.org/jqwidgets-jqxradiobutton-focus-method/)
...
**焦点()方法**用于在小部件上设置焦点。它不接受任何参数，也不返回值。
