...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxnumberinput-val-method/](https://www.geeksforgeeks.org/jqwidgets-jqxnumberinput-val-method/)
...
下面的示例说明了 `jQWidgets` `jqxNumberInput` `val()`方法。
