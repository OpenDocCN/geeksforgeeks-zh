...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxlistbox-enableat-method/](https://www.geeksforgeeks.org/jqwidgets-jqxlistbox-enableat-method/)
...
下面的示例说明了 jQWidgets 中的 `jqxListBox` **enableAt()** 方法。
