...
> 原文:[https://www . geeksforgeeks . org/jqwidgets-jqxtooltip-absolutepsitiony-property/](https://www.geeksforgeeks.org/jqwidgets-jqxtooltip-absolutepositiony-property/)
...
如果位置属性设置为“绝对”，则**绝对位置属性**用于设置或返回工具提示的垂直位置。它接受数字/字符串类型的值，默认值为 0。
...
下面的例子说明了 jQWidgets jqxTooltip 的绝对位置属性。
