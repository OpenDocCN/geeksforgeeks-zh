...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxtree-check item-method/](https://www.geeksforgeeks.org/jqwidgets-jqxtree-checkitem-method/)
...
**checkItem()方法**用于检查树小部件项目。它接受两个参数，第一个是对象类型的项，第二个是布尔类型的状态。它不返回值。
