# jQWidgets jqxTextArea 物品属性

> 原文:[https://www . geeksforgeeks . org/jqwidgets-jqxtextarea-items-property/](https://www.geeksforgeeks.org/jqwidgets-jqxtextarea-items-property/)
...
**项目属性**用于设置或返回弹出菜单中显示的最大项目数。它接受数字类型值，默认值为 8。
...
下面的例子说明了 jQWidgets jqxTextArea items 属性。
...
![](img/d0d9a4d00a178a56b905305937aef5c3.png)
