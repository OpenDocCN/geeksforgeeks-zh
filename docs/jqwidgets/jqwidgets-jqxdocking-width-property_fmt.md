...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdocking-width-property/](https://www.geeksforgeeks.org/jqwidgets-jqxdocking-width-property/)
...
以下示例说明了 `jQWidgets` `宽度` 属性。在下面的示例中， `宽度` 属性的值被设置为 250。
