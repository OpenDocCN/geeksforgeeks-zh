...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxtouch-swiperight-event/](https://www.geeksforgeeks.org/jqwidgets-jqxtouch-swiperight-event/)
...
**当用户向指定的 jqxTouch 小部件的右侧滑动时，触发**滑动** **事件**。**
...
****示例:**以下示例说明了 jQWidgets jqxttouch**swiperight 事件**。**
