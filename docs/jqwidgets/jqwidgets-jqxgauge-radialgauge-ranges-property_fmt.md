# jQWidgets jqxGauge 辐射范围属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxgauge-radialgauge-ranges-property/](https://www.geeksforgeeks.org/jqwidgets-jqxgauge-radialgauge-ranges-property/)
...
`ranges` 属性用于设置或返回 ranges 属性，即该属性是一个对象数组，每个对象属于不同的范围。范围是具有指定大小的彩色区域。它接受数组值，默认值为 `[]`。
...
以下示例说明了 jQWidgets 中的 `jqxGauge` `ranges` 属性:
