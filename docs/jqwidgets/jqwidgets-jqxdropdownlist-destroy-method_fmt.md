...
> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-destroy-method/](https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-destroy-method/)
...
## 示例
下面的示例说明了 jQWidgets 中的 `jqxDropDownList` `destroy()` 方法。
