# jqwidgets jqxtoltip open()方法

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxtooltip-open-method/](https://www.geeksforgeeks.org/jqwidgets-jqxtooltip-open-method/)
...
`open()`方法用于打开工具提示小部件。它不接受任何参数，也不返回值。
...
下面的例子说明了`jQWidgets` `jqxTooltip` `open()`方法。
...
<body>
    <center>
        ...
        <h3>
            jQWidgets jqxTooltip open() Method
        </h3>
        <br><br>
...
![](img/93fe2793b491c6fff1baf1348a0945b9.png)
