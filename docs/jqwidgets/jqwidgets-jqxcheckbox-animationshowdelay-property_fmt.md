...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxcheckbox-animationshowdelay-property/](https://www.geeksforgeeks.org/jqwidgets-jqxcheckbox-animationshowdelay-property/)
...
`animationShowDelay` 属性用于设置或返回当复选框被选中时淡入淡出动画的延迟。它接受数字类型值，默认值为 250。

## 语法

设置 `animationShowDelay` 属性。
...
下面的示例说明了 jQWidgets 中的 `jqxCheckBox` `animationShowDelay` 属性。
