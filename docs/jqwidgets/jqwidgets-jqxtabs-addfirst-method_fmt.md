...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxtabs-addfirst-method/](https://www.geeksforgeeks.org/jqwidgets-jqxtabs-addfirst-method/)
...
## addFirst()方法
`addFirst()` 方法用于在开始位置添加制表符。添加选项卡包含选项卡的标题和内容。该方法接受下面给出的两个参数：
*   **标签标题:** 接受新增标签的标题。
*   **标签内容:** 接受新增标签的内容。
...
下面的例子说明了 jQWidgets jqxTabs `addFirst()` 方法。
...
<body>
    <center>
        ...
        <h3>
            jQWidgets jqxTabs addFirst() Method
        </h3>
...
## 输出
![](img/253d67fc7ae8531051bdec93e694c613.png)
