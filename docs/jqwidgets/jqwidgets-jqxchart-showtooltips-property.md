...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxchart-show tooltiples-property/](https://www.geeksforgeeks.org/jqwidgets-jqxchart-showtooltips-property/)
...
**显示工具提示**属性用于设置或返回显示工具提示属性。即该属性用于启用或禁用图表的工具提示。它接受布尔类型值，默认值为真。
...
**示例:**下面的示例说明了 jqxChart **在 jQWidgets 中显示工具提示**属性。
