# jQWidgets jqxTree 渲染()方法

> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxtree-render-method/](https://www.geeksforgeeks.org/jqwidgets-jqxtree-render-method/)
...
`渲染()`方法用于在屏幕上渲染 `jqxTree` 小部件。它不接受任何参数，也不返回值。

**语法：**

```html
$('Selector').jqxTree('render');
```
...
下面的例子说明了 jQWidgets `jqxTree` `render()`方法。
...
<body>
    ...
    <h3>
        jQWidgets jqxTree render() Method
    </h3>
    ...
    <script type="text/javascript">
        ...
        $('#jqxBtn').click(function() {
            ...
            alert("jqxTree Widget Rendering");
        });
    </script>
</body>
...
![](img/443c24c8b5153dbd43a234e8517e6899.png)
