# jqwidgets jqxtoltip 汽车置物

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxtooltip-autohide-property/](https://www.geeksforgeeks.org/jqwidgets-jqxtooltip-autohide-property/)
...
### 自动隐藏属性
用于设置或返回工具提示在持续时间等于自动隐藏延迟属性后是否自动隐藏。它接受布尔类型值，默认值为真。
...
下面的例子说明了 jQWidgets `jqxTooltip` `autoHide` 属性。
...
<body>
    <center>
        ...
        <h3>
            jQWidgets jqxTooltip autoHide Property
        </h3>
        <br><br>
        <input type="button" id="jqxBtn" style="background: green;" value="GeeksforGeeks" />
    </center>
...
### 输出:
![](img/5384105e3af0dc847d19a768056f1049.png)
