...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxlistmenu-placeholder-property/](https://www.geeksforgeeks.org/jqwidgets-jqxlistmenu-placeholder-property/)
...
`placeHolder` 属性用于设置或返回过滤器输入字段的占位符。它接受字符串类型的值，默认值是“过滤列表项……”。
