...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxtabs-scroll-property/](https://www.geeksforgeeks.org/jqwidgets-jqxtabs-scrollable-property/)
...
**滚动属性**用于设置或返回是否启用滚动。它接受布尔类型值，默认值为真。
...
下面的例子说明了 jQWidgets jqxTabs 可滚动属性。
