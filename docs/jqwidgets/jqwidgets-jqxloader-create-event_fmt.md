...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxloader-create-event/](https://www.geeksforgeeks.org/jqwidgets-jqxloader-create-event/)
...
下面的例子说明了 jQWidgets `jqxLoader` `create` 事件。
