...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxgrid-adaptive-property/](https://www.geeksforgeeks.org/jqwidgets-jqxgrid-adaptive-property/)
...
**自适应**属性用于设置或返回显示的 `jqxGrid` 的自适应模式是否启用。它是布尔类型，缺省值为假。
...
以下示例说明了 jQWidgets 中的 `jqxGrid` **自适应**属性。
...
<body>
    <center>
        ...
        <h3>jQWidgets jqxGrid adaptive property</h3>
        <br />
        <div id="jqxg"></div>
        <div>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#jqxBtn").on("click", function () {
                var adp = $('#jqxg').jqxGrid('adaptive');
                $('#log').text("Adaptive: " + adp);
            });
        });
    </script>
</body>
...
![](img/78584bccd3681c02f06dd56b1afaf69b.png)
