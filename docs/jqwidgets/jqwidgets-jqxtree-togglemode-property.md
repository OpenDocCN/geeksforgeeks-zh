...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxtree-toggle mode-property/](https://www.geeksforgeeks.org/jqwidgets-jqxtree-togglemode-property/)
...
**示例:**以下示例说明了 jQWidgets jqxTree*toggle mode*属性。
