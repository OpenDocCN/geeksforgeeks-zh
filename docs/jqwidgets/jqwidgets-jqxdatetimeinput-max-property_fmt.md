...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdatetimeinput-max-property/](https://www.geeksforgeeks.org/jqwidgets-jqxdatetimeinput-max-property/)
...
`max` 属性用于设置或返回 `jqxDateTimeInput` 小部件的最大日期。它接受 `Date` 类型值，默认值为 `new Date(2100, 1, 1)`。
