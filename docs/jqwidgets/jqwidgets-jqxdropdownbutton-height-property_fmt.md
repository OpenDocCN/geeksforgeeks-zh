...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdropdownbutton-height-property/](https://www.geeksforgeeks.org/jqwidgets-jqxdropdownbutton-height-property/)
...
下面的示例说明了 `jQWidgets` 中的 `jqxDropDownButton` `高度`属性。
