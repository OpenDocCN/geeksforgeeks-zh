# jQWidgets jqxSlider 步骤属性

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxslider-step-property/](https://www.geeksforgeeks.org/jqwidgets-jqxslider-step-property/)
...
**步长属性**用于用户使用键盘箭头时设置或返回滑块的步长。它接受数字类型值，默认值为 1。
...
下面的例子说明了 jQWidgets jqxSlider 步骤属性。
