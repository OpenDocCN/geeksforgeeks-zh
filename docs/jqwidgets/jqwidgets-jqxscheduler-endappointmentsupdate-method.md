# jQWidgets jqxScheduler endapointupdate()方法

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxscheduler-endapointmentupdate-method/](https://www.geeksforgeeks.org/jqwidgets-jqxscheduler-endappointmentsupdate-method/)
...
**endapointmentupdate()方法**用于终止更新过程以及重新启动调度程序的渲染。它没有参数，也不返回任何内容。
...
下面的例子说明了 jqxScheduler**endapointmentupdate()方法**在 jQWidgets 中的作用。
