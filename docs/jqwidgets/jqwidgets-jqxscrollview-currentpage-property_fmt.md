...
> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxscrollview-currentpage-property/](https://www.geeksforgeeks.org/jqwidgets-jqxscrollview-currentpage-property/)
...
以下示例说明了 `jQWidgets` 中的 `jqxScrollView` `currentPage` 属性。
