...
> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxcheckbox-disable-method/](https://www.geeksforgeeks.org/jqwidgets-jqxcheckbox-disable-method/)
...
以下示例说明了 jQWidgets 中的 `jqxCheckBox` `disable()` 方法。
...
<body>
    ...
    <br>
    <input type="button" id='jqxBtn' value="Disable the CheckBox" style="padding: 8px 25px;" />
