...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxpopover-open-event/](https://www.geeksforgeeks.org/jqwidgets-jqxpopover-open-event/)
...
示例: 以下示例说明了 `jQWidgets` `jqxPopover` 的 `open` 事件。
