...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxpopover-showarrow-property/](https://www.geeksforgeeks.org/jqwidgets-jqxpopover-showarrow-property/)
...
`showArrow` 属性用于设置或获取指定 `jqxPopover` 小部件的箭头是否显示。
...
```html
var arrowOffsetValue = $('#jqxPopover').jqxPopover('showArrow');
```
...
下面的示例说明了 `jQWidgets` `jqxPopover` `showArrow` 属性。在下面的例子中， `showArrow` 属性的值被设置为 `true`。
...
[https://www.jqwidgets.com/jquery-widgets-documentation/documentation/jqxpopover/jquery-popover-api.htm](https://www.jqwidgets.com/jquery-widgets-documentation/documentation/jqxpopover/jquery-popover-api.htm)