...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxvalidator-validationsuccess-event/](https://www.geeksforgeeks.org/jqwidgets-jqxvalidator-validationsuccess-event/)
...
当表单验证无误时，触发 `validationSuccess` 事件。
...
以下示例说明了 jQWidgets `validationSuccess` 事件。
...
[https://www.jqwidgets.com/jquery-widgets-documentation/documentation/jqxvalidator/jquery-validator-api.htm](https://www.jqwidgets.com/jquery-widgets-documentation/documentation/jqxvalidator/jquery-validator-api.htm)