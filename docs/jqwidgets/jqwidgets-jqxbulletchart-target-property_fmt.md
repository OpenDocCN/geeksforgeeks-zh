# jQWidgets jqxbullethart 目标属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxbulletchart-target-property/](https://www.geeksforgeeks.org/jqwidgets-jqxbulletchart-target-property/)
...
`target` 属性用于设置或返回 bulletcharts 的目标。它接受对象类型值，默认值为：
