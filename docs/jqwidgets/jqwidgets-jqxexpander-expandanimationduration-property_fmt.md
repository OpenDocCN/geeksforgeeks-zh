...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxexpander-expandanimationduration-property/](https://www.geeksforgeeks.org/jqwidgets-jqxexpander-expandanimationduration-property/)
...
`expandAnimationDuration` 属性用于设置或返回扩展动画持续时间。它接受数字类型值，默认值为 400。
...
下面的例子说明了 jQWidgets `jqxExpander` `expandAnimationDuration` 属性。
