...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxmenu-setitemopendirection-method/](https://www.geeksforgeeks.org/jqwidgets-jqxmenu-setitemopendirection-method/)
...
`setItemOpenDirection()`方法用于设置小部件的项目弹出打开方向。它接受下面讨论三个参数:
