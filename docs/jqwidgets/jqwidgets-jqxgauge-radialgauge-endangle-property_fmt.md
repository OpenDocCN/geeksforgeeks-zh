# jQWidgets jqxGauge RadialGauge endAngle 属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxgauge-radialgauge-endangle-property/](https://www.geeksforgeeks.org/jqwidgets-jqxgauge-radialgauge-endangle-property/)
...
`endAngle` 属性用于设置或返回 `endAngle` 属性，即用于设置 `jqxGauge` 的结束角度。它接受一个数值，默认值为 270。
...
以下示例说明了 jQWidgets 中的 `jqxGauge` `endAngle` 属性。
...
![](img/08389312795fe385cb7fab3fa75237c1.png)
