...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxtreegrid-ensurerowvisible-method/](https://www.geeksforgeeks.org/jqwidgets-jqxtreegrid-ensurerowvisible-method/)
...
## 示例
下面的示例说明了 jQWidgets `jqxTreeGrid` 的 `ensureRowVisible()` 方法。在下面的示例中，垂直滚动条将向上移动到第四行。
