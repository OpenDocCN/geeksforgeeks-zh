# jQWidgets jqxTooltip 显示延迟属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxtooltip-showdelay-property/](https://www.geeksforgeeks.org/jqwidgets-jqxtooltip-showdelay-property/)
...
`showDelay` 属性用于设置或返回持续时间，超过该时间后将显示工具提示。它接受数字类型的值，默认值为 100。
...
以下示例说明了 jQWidgets `jqxTooltip` 的 `showDelay` 属性。
