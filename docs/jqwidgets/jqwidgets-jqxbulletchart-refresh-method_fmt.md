...
> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxbulletchart-refresh-method/](https://www.geeksforgeeks.org/jqwidgets-jqxbulletchart-refresh-method/)
...
下面的示例说明了 `jQWidgets` 中的 `jqxBulletChart` `refresh()` 方法。
