# jQWidgets jqxRating 宽度属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxrating-width-property/](https://www.geeksforgeeks.org/jqwidgets-jqxrating-width-property/)
...
以下示例说明了 jQWidgets `jqxRating` `宽度`属性。
