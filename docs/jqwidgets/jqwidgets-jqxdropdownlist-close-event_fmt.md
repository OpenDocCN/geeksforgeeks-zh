# jQWidgets jqxDropDownList 关闭事件

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-close-event/](https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-close-event/)
...
下面的例子说明了 `jQWidgets` 中的 `jqxDropDownList` 关闭事件。
...
<body>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $("#jqxDDL").on('close', function (event) {
                alert("List popup closing");
            });
        });
    </script>
</body>
...
![](img/943d6953d1f4db5314f694880dfd660e.png)
