# jQWidgets jqxDropDownList disablet()方法

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxddropdownlist-disablet-method/](https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-disableat-method/)
...
**disablet()**方法用于通过索引号禁用项目。它接受数字类型的单个参数索引，并且不返回任何值。索引从 0 开始。
...
**示例:**下面的示例说明了 jQWidgets 中的 jqxDropDownList**disablet()**方法。
