# jQWidgets jqxScheduler touchRowsHeight 属性

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxscheduler-touchrowsheight-property/](https://www.geeksforgeeks.org/jqwidgets-jqxscheduler-touchrowsheight-property/)
...
**触摸行高**属性用于设置或返回触摸设备上显示的 jqxScheduler 中的行高。它属于数字类型，默认值为 37。

**语法:**

*   设置 touchRowsHeight 属性。

    ```html
    $("Selector").jqxScheduler({ touchRowsHeight: 40 });
    ```

*   返回 touchRowsHeight 属性。

    ```html
    var touchRowsHeight = 
        $('Selector').jqxScheduler('touchRowsHeight');
    ```
...
**示例:**以下示例说明了 jQWidgets 中的 jqxScheduler**touchrowsheit**属性。
...
        <h3>jQWidgets jqxScheduler touchRowsHeight
            property
        </h3>
...
                var trh = $('#jqxs').jqxScheduler('touchRowsHeight');
                $('#log').text("Rows height on touch device: " + trh);
            });
        });
    </script>
</body>
...
![](img/2ffd9099d84b380ab80d90490a7cc6c3.png)
