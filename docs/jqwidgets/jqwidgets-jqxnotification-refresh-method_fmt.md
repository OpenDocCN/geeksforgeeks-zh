...
> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxnotification-refresh-method/](https://www.geeksforgeeks.org/jqwidgets-jqxnotification-refresh-method/)
...
`refresh()`方法用于刷新通知。它不接受任何参数，也不返回值。
