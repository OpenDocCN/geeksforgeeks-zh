...
> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxbulletchart-ticks-property/](https://www.geeksforgeeks.org/jqwidgets-jqxbulletchart-ticks-property/)
...
`ticks` 属性用于设置或返回 bulletcharts 的记号。它接受对象类型值，默认值为：
...
**示例：** 下面的示例说明了 jQWidgets 中的 `jqxBulletChart` `ticks` 属性。
