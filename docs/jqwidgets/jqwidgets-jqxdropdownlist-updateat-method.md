...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxddropdownlist-updateat-method/](https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-updateat-method/)
...
**updateAt()方法**用于将一个项目更新到下拉列表中。它接受两个参数，第一个是对象类型的**项**，第二个是数字类型的**索引**。它不返回值。
