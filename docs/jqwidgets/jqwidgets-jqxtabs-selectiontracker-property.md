...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxtabs-selection tracker-property/](https://www.geeksforgeeks.org/jqwidgets-jqxtabs-selectiontracker-property/)
...
**选择跟踪器属性**用于设置或返回选择跟踪器是否启用。它接受布尔类型值，默认值为 false。
