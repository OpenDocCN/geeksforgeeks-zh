...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxcombobox-selectindex-method/](https://www.geeksforgeeks.org/jqwidgets-jqxcombobox-selectindex-method/)
...
selectIndex()方法用于使用索引号选择项目。组合框使用从零开始的索引。它接受数字类型的单个参数索引，并且不返回任何值。
