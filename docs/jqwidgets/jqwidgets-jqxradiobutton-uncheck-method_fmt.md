# jQWidgets jqxRadioButton 取消选中()方法

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxradiobutton-uncheck-method/](https://www.geeksforgeeks.org/jqwidgets-jqxradiobutton-uncheck-method/)
...
`取消选中()`方法用于取消选中单选按钮选项。它不接受任何参数，也不返回值。
