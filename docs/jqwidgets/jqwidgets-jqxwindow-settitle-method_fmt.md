...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxwindow-settitle-method/](https://www.geeksforgeeks.org/jqwidgets-jqxwindow-settitle-method/)
...
下面的示例说明了 jQWidgets `setTitle()` 方法。
