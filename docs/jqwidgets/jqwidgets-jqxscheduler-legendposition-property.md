...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxscheduler-legendposition-property/](https://www.geeksforgeeks.org/jqwidgets-jqxscheduler-legendposition-property/)
...
**legendPosition 属性**用于设置或返回显示的 jqxScheduler 的 legendPosition。它属于字符串类型，默认情况下它的值是底部。
...
        <h3>jQWidgets jqxScheduler legendPosition
            property
        </h3>
