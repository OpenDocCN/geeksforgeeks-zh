...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-enableat-method/](https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-enableat-method/)
...
`enableAt()`方法用于通过使用索引号来启用禁用的项目。它接受 Number 类型的单参数`index`，并且不返回任何值。索引从 0 开始。
