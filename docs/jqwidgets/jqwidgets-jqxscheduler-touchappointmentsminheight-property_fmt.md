# jQWidgets jqxScheduler touchAppointmentsMinHeight 属性

> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxscheduler-touchappointmentsminheight-property/](https://www.geeksforgeeks.org/jqwidgets-jqxscheduler-touchappointmentsminheight-property/)
...
**touchAppointmentsMinHeight** 属性用于在触摸设备上显示的 **jqxScheduler** 中设置或返回预约的最小高度。它属于数字类型，默认值为 27。

## 语法

*   设置 `touchAppointmentsMinHeight` 属性。

```html
$("#Selector").jqxScheduler({ touchAppointmentsMinHeight: 40 });
```

*   返回 `touchAppointmentsMinHeight` 属性。
...
下面的示例说明了 jQWidgets 中的 jqxScheduler `touchAppointmentsMinHeight` 属性。
...
<body>
    <center>
        ...
        <h3>
            ...
            touchAppointmentsMinHeight property
        </h3>
        <div id="jqxs"></div>
        <div>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#jqxBtn").on("click", function () {
                var t = $('#jqxs').jqxScheduler(
                      'touchAppointmentsMinHeight');
                $('#log').text(
                  "Minimum height on touch devices: " + t);
            });
        });
    </script>
</body>
...
![](img/3c34be6cf38ac71cd9b4569888893603.png)

**参考：**[https://www.jqwidgets.com/jquery-widgets-documentation/documentation/jqxscheduler/jquery-scheduler-api.htm?search=](https://www.jqwidgets.com/jquery-widgets-documentation/documentation/jqxscheduler/jquery-scheduler-api.htm?search=)