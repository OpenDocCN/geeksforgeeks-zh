...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxcalendar-width-property/](https://www.geeksforgeeks.org/jqwidgets-jqxcalendar-width-property/)
...
**宽度属性**用于设置或返回日历的宽度。它接受数字/字符串类型的值，默认值为空。
...
以下示例说明了 jQWidgets 中的 jqxCalendar 宽度属性:
