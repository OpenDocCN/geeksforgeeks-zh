...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxvalidator-hide-method/](https://www.geeksforgeeks.org/jqwidgets-jqxvalidator-hide-method/)
...
下面的示例说明了 `jqwidgets jqxValidator hide()` 方法。
