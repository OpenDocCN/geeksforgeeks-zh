...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxbutton-render-method/](https://www.geeksforgeeks.org/jqwidgets-jqxbutton-render-method/)
...
`render()`方法用于渲染 `jqxButton` 小部件。它没有参数，也不返回任何内容。
...
## 示例:
下面的示例说明了 jQWidgets 中的 `jqxButton` `render()` 方法。
