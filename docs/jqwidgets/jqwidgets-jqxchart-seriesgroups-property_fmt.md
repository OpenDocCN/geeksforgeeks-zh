...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxchart-seriesgroups-property/](https://www.geeksforgeeks.org/jqwidgets-jqxchart-seriesgroups-property/)
...
```html
var seriesGroups = $('Selector').jqxChart('seriesGroups');
```
