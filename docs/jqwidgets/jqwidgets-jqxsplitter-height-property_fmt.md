...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxsplitter-height-property/](https://www.geeksforgeeks.org/jqwidgets-jqxsplitter-height-property/)
...
**示例:** 以下示例说明了 `jQWidgets` `jqxSplitter` `高度` 属性。在以下示例中，`高度` 属性的值已设置为 `200`。
