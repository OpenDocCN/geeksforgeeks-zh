# jQWidgets jqxFormattedInput 宽度属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxformattedinput-width-property/](https://www.geeksforgeeks.org/jqwidgets-jqxformattedinput-width-property/)
...
下面的例子说明了 jQWidgets `jqxFormattedInput` `width` 属性。
