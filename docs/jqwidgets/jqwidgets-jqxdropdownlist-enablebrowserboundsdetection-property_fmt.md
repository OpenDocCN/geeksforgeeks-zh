# jQWidgets jqxDropDownList enableBrowserBoundsDetection 属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-enablebrowserboundsdetection-property/](https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-enablebrowserboundsdetection-property/)
...
`enableBrowserBoundsDetection` 属性用于设置或返回下拉是否检测到浏览器窗口的边界并自动调整下拉位置。它接受布尔类型值，默认值为 `false`。
...
以下示例说明了 jQWidgets 中的 `jqxDropDownList` `enableBrowserBoundsDetection` 属性。
