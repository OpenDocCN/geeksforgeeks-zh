...
> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxnumberinput-textchanged-event/](https://www.geeksforgeeks.org/jqwidgets-jqxnumberinput-textchanged-event/)
...
**示例：** 以下示例说明了 jQWidgets jqxNumberInput `textchanged` 事件。
