# jQWidgets jqxBarGauge 值属性

> 原文:[https://www . geeksforgeeks . org/jqwidgets-jqxbargage-values-property/](https://www.geeksforgeeks.org/jqwidgets-jqxbargauge-values-property/)
...
***值*** 属性用于设置或返回 BarGauge 的值数组。它接受字符串类型值，默认值为空数组[]。
...
**示例:**以下示例说明了 jQWidgets jqxBarGauge *值*属性。
