...
> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxtoolbar-destroy-method/](https://www.geeksforgeeks.org/jqwidgets-jqxtoolbar-destroy-method/)
...
`destroy()` 方法用于销毁显示的 `jqxToolBar` 及其所有工具。它没有参数，也不返回任何内容。
...
下面的例子说明了 jQWidgets 中的 `jqxToolBar destroy()` 方法。
...
![](img/06ff0e6eb182b20466decc24b5d1b769.png)
