# jQWidgets jqxNavBar selectedItem 属性

> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxnavbar-selecteditem-property/](https://www.geeksforgeeks.org/jqwidgets-jqxnavbar-selecteditem-property/)
...
`selectedItem` 属性用于设置或返回所选项。它接受数字类型值，默认值为 `0`。
