...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxcombobox-getvisibleitems-method/](https://www.geeksforgeeks.org/jqwidgets-jqxcombobox-getvisibleitems-method/)
...
下面的示例说明了 `jQWidgets` 中的 `jqxComboBox` `getVisibleItems()` 方法。
