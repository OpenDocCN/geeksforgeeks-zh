# jqxMenu 的 `animationHideDelay` 属性

> 原文链接：[https://www.geeksforgeeks.org/jqwidgets-jqxmenu-animationhidedelay-property/](https://www.geeksforgeeks.org/jqwidgets-jqxmenu-animationhidedelay-property/)
...
`animationHideDelay` 属性用于设置或返回隐藏动画开始前的延迟。它接受数字类型值，默认值为 500。
...
下面的例子说明了 jQWidgets `jqxMenu` 的 `animationHideDelay` 属性。
