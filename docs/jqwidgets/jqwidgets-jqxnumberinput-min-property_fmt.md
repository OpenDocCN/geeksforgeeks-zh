# jQWidgets jqxNumberInput min 属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxnumberinput-min-property/](https://www.geeksforgeeks.org/jqwidgets-jqxnumberinput-min-property/)
...
`min` 属性用于设置或返回 `jqxNumberInput` 小部件的最小值。它接受数字类型值，默认值为 -99999999。
