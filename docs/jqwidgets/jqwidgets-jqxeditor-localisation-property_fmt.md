...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxeditor-localisation-property/](https://www.geeksforgeeks.org/jqwidgets-jqxeditor-localisation-property/)
...
以下示例说明了 `jQWidgets` 中的 `jqxEditor` **localisation** 属性。
