...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxwindow-disable-method/](https://www.geeksforgeeks.org/jqwidgets-jqxwindow-disable-method/)
...
**示例:** 下面的示例说明了 jQWidgets `disable()` 方法。
...
<html lang="en">
  ...
  <body>
    <center>
      ...
      <h3> jQWidgets jqxWindow disable() Method </h3>
...
![](img/b8af3a567e5ce2fcffa5c0d99032319b.png)
