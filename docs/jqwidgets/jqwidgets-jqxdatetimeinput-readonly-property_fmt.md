...
> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxdatetimeinput-readonly-property/](https://www.geeksforgeeks.org/jqwidgets-jqxdatetimeinput-readonly-property/)
...
`readonly` 属性用于设置或返回小部件是否只读。它接受布尔类型值，默认值为 `false`。
