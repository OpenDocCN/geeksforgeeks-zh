# jqxNumberInput setDecimal() 方法

> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxnumberinput-setdecimal-method/](https://www.geeksforgeeks.org/jqwidgets-jqxnumberinput-setdecimal-method/)
...
下面的示例说明了 jQWidgets `jqxNumberInput` 的 `setDecimal()` 方法。
