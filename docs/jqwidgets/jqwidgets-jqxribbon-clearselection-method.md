# jQWidgets jqxRibbon clear selection()方法

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxribbon-clear selection-method/](https://www.geeksforgeeks.org/jqwidgets-jqxribbon-clearselection-method/)
...
**示例:**下面的示例说明了 jQWidgets jqxRibbon*clear selection()*方法。
