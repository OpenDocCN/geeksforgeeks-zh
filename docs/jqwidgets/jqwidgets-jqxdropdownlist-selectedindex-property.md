...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxddropdownlist-selectedindex-property/](https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-selectedindex-property/)
...
***选择索引*** **属性**用于设置或返回选择的索引。它接受数字类型值，默认值为-1。
...
**示例:**以下示例说明了 jQWidgets 中的 jqxDropDownList*selectedIndex*属性。
