# jQWidgets jqxButtonGroup render()方法

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxbuttongroup-render-method/](https://www.geeksforgeeks.org/jqwidgets-jqxbuttongroup-render-method/)
...
`render()`方法用于返回显示的 `jqxButtonGroup`。它没有参数，也不返回任何内容。
