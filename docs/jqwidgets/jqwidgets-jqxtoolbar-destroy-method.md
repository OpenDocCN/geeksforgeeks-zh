# jQWidgets jqxToolBar 销毁()方法

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxtoolbar-destroy-method/](https://www.geeksforgeeks.org/jqwidgets-jqxtoolbar-destroy-method/)
...
**销毁()方法**用于销毁显示的 jqxToolBar 及其所有工具。它没有参数，也不返回任何内容。
