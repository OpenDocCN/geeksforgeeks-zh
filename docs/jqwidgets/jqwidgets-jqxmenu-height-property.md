...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxmenu-height-property/](https://www.geeksforgeeks.org/jqwidgets-jqxmenu-height-property/)
...
**高度属性**用于设置或返回 jqxMenu 小部件的高度。它接受数字/字符串类型的值，默认值为空。
...
下面的例子说明了 jQWidgets jqxMenu 高度属性。
