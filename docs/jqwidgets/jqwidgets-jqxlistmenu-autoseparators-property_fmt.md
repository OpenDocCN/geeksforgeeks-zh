# jqwidgets jqxlistmenu 自动拆分器特性

> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxlistmenu-autoseparators-property/](https://www.geeksforgeeks.org/jqwidgets-jqxlistmenu-autoseparators-property/)
...
`autoSeparators` 属性用于设置或返回是否生成自动分隔符。它是一系列具有相同开始字符的列表项。该属性的另一种选择是 `data-auto-separators="true"`。它接受布尔类型值，默认值为 `false`。
