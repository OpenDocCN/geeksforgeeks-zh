...
`uncheckRow()` 方法用于取消选中指定 `jqxTreeGrid` 的选中行。复选框设置为 `true`。
...
下面的示例说明了 jQWidgets `jqxTreeGrid` 的 `uncheckRow()` 方法。在下面的示例中，选中的第一行将被取消选中。
    ...
    <center>
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                $('#button_for_uncheckRow').click(function () {
                    $("#jqxTreeGrid").jqxTreeGrid('uncheckRow', 1);
                });
            });
        </script>
    </center>
