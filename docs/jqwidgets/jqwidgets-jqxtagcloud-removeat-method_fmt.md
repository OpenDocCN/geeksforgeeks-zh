...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxtagcloud-removeat-method/](https://www.geeksforgeeks.org/jqwidgets-jqxtagcloud-removeat-method/)
...
下面的示例说明了 `jQWidgets` `removeAt()` 的方法。在下面的示例中，索引为 0 的元素被移除。
