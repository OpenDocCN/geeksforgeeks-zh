...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxscheduler-min-property/](https://www.geeksforgeeks.org/jqwidgets-jqxscheduler-min-property/)
...
以下示例说明了 jQWidgets 中的 `jqxScheduler` `min` 属性。
