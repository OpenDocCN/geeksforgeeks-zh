# jQWidgets jqxKnob 禁用属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxknob-disabled-property/](https://www.geeksforgeeks.org/jqwidgets-jqxknob-disabled-property/)
...
`disabled` 属性用于设置或获取指定的 `jqxKnob` 是否禁用。
...
```javascript
var allowValueChangeOnClick = $('#jqxKnob').jqxKnob('disabled');
```
...
以下示例说明了 jQWidgets jqxKnob `disabled` 属性。在以下示例中， `disabled` 属性的值已设置为 `true`。
