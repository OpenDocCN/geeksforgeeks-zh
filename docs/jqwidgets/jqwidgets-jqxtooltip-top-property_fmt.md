# jqwidgets jqxtoltip top property

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxtooltip-top-property/](https://www.geeksforgeeks.org/jqwidgets-jqxtooltip-top-property/)
...
`top` 属性用于根据 `position` 属性设置或返回 `jqxTooltip` 的垂直偏移量。它接受数字/字符串类型的值，默认值为 `0`。
...
以下示例说明了 jQWidgets `jqxTooltip` `top` 属性。
...
<body>
    <center>
        ...
        <h3>
            jQWidgets jqxTooltip top Property
        </h3>
        <br><br>
...
![](img/8870110aee2c052be8c579cc7ea9e8c9.png)
