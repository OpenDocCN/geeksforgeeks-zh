...
> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxlayout-height-property/](https://www.geeksforgeeks.org/jqwidgets-jqxlayout-height-property/)
...
下面的示例说明了 `jQWidgets` `jqxLayout` `height` 属性。在以下示例中，`height` 属性的值已设置为 100。
