...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxfileupload-render-method/](https://www.geeksforgeeks.org/jqwidgets-jqxfileupload-render-method/)
...
下面的示例说明了 jQWidgets 中的 `jqxFileUpload` `render()` 方法。
