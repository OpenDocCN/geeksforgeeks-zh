...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxexpander-destroy-method/](https://www.geeksforgeeks.org/jqwidgets-jqxexpander-destroy-method/)
...
`destroy()`方法用于销毁膨胀机。它不接受任何参数，也不返回值。
