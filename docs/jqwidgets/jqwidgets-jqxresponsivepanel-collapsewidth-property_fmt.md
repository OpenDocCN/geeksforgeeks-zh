# jQWidgets jqxResponsivePanel collapseWidth 属性

> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxresponsivepanel-collapsewidth-property/](https://www.geeksforgeeks.org/jqwidgets-jqxresponsivepanel-collapsewidth-property/)
...
`collapseWidth` 属性用于设置或返回面板折叠时的宽度。它接受数字类型的值，默认值为空。
...
下面的例子说明了 jQWidgets 中的 `jqxResponsivePanel` `collapseWidth` 属性。
