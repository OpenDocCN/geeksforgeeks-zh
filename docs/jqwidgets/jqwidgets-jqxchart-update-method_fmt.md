...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxchart-update-method/](https://www.geeksforgeeks.org/jqwidgets-jqxchart-update-method/)
...
`update()`方法用于更新图表。它不接受任何参数，也不返回值。
...
**示例:** 以下示例说明了 `jqxChart` `update()`方法在 `jQWidgets` 中:
