# jQWidgets jqxScrollView 电流页属性

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxscrollview-current page-property/](https://www.geeksforgeeks.org/jqwidgets-jqxscrollview-currentpage-property/)
...
*currentPage* 属性用于设置或返回当前页面显示的元素。它接受数字类型值，默认值为 0。
...
**示例:**以下示例说明了 jQWidgets 中的 jqxScrollView*current page*属性。
...
![](img/27754511de1d55eca5d73ac23c8f360f.png)
