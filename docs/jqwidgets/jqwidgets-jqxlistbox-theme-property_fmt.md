...
> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxlistbox-theme-property/](https://www.geeksforgeeks.org/jqwidgets-jqxlistbox-theme-property/)
...
以下示例说明了 `jQWidgets` 中的 `jqxListBox` `主题`属性。
