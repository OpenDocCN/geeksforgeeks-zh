# jQWidgets jqxKnob 最大属性

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxknob-max-property/](https://www.geeksforgeeks.org/jqwidgets-jqxknob-max-property/)
...
***【最大值】*** 属性用于设置或获取指定 jqxKnob 的最大值属性。
...
**示例:**以下示例说明了 jQWidgets jqxKnob***max***属性。在以下示例中， ***max*** 属性的值已设置为 50。
