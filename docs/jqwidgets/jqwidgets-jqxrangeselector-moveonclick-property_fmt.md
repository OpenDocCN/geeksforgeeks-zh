# jQWidgets jqxRangeSelector moveOnClick 属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxrangeselector-moveonclick-property/](https://www.geeksforgeeks.org/jqwidgets-jqxrangeselector-moveonclick-property/)
...
`moveOnClick` 属性用于设置或返回是否可以通过点击范围选择器来改变滑块的位置。它接受布尔类型值，默认值为 `true`。
...
```javascript
var moveOnClick = $('selector').jqxRangeSelector('moveOnClick');
```
