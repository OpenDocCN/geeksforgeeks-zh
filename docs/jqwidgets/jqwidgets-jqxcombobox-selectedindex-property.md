...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxcombobox-selectedindex-property/](https://www.geeksforgeeks.org/jqwidgets-jqxcombobox-selectedindex-property/)
...
**selectedIndex 属性**用于设置或返回所选索引。它接受数字类型值，默认值为-1。
