...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxnavbar-selectat-method/](https://www.geeksforgeeks.org/jqwidgets-jqxnavbar-selectat-method/)
...
**selectAt()方法**用于选择给定索引的项目。它接受数字类型的单参数索引，不返回任何值。
