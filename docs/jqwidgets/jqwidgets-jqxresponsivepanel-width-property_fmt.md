...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxresponsivepanel-width-property/](https://www.geeksforgeeks.org/jqwidgets-jqxresponsivepanel-width-property/)
...
下面的例子说明了 jQWidgets 中的 `jqxResponsivePanel` `width` 属性。
