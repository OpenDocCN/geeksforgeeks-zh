...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxribbon-updateat-method/](https://www.geeksforgeeks.org/jqwidgets-jqxribbon-updateat-method/)
...
下面的例子说明了 jQWidgets `jqxRibbon` 的 `updateAt()` 方法。
