...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxtimepicker-footer-property/](https://www.geeksforgeeks.org/jqwidgets-jqxtimepicker-footer-property/)
...
`footer` 属性用于设置或返回是否显示页脚。它接受布尔类型值，默认值为 `false`。
...
## 示例
以下示例说明了 jQWidgets jqxTimePicker `footer` 属性。
