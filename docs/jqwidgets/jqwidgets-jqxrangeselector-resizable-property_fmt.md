# jQWidgets jqxRangeSelector 可调整大小属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxrangeselector-resizable-property/](https://www.geeksforgeeks.org/jqwidgets-jqxrangeselector-resizable-property/)
...
`可调整大小属性`用于设置或返回范围选择器滑块是否可调整大小。它接受布尔类型值，默认值为真。
...
下面的例子说明了 jQWidgets `jqxRangeSelector` 的可调整大小属性。
...
<body>
    ...
    <h3>
        jQWidgets jqxRangeSelector resizable Property
    </h3>
...
![](img/dc9f4de25921442fb32d3ee3e8bb1aca.png)
