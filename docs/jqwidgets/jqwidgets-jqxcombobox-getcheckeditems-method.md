# jqwidget jqxcombo obex getchechkeditems()方法

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxcombobox-getcheckeditems-method/](https://www.geeksforgeeks.org/jqwidgets-jqxcombobox-getcheckeditems-method/)
...
getCheckedItems()方法用于返回选中的项。它不接受任何参数，并返回一个对象数组。
...
以下示例说明了 jQWidgets 中的 jqxComboBox getCheckedItems()方法:
...
        <h3>
            jQWidgets jqxComboBox getCheckedItems() Method
        </h3>
...
                var cItems = "";
                var items = $("#jqxCB").jqxComboBox('getCheckedItems');
...
![](img/6cd5b0aba1730352275cdacbc87a9cc3.png)
