# jq 构件 jqxDateTimeInput editMode 属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdatetimeinput-editmode-property/](https://www.geeksforgeeks.org/jqwidgets-jqxdatetimeinput-editmode-property/)
...
`editMode` 属性用于设置或返回组件的编辑模式。它接受字符串类型值，默认值为 `false`。
...
下面的例子说明了 jQWidgets 中的 `jqxDateTimeInput` `editMode` 属性。
...
<body>
    <center>
        ...
        <h3>
            jQWidgets jqxDateTimeInput editMode Property
        </h3>
...
![](img/4e1c4d6e9ed7161de758458da1980677.png)
