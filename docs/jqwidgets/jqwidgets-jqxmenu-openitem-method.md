...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxmenu-open item-method/](https://www.geeksforgeeks.org/jqwidgets-jqxmenu-openitem-method/)
...
**openItem()方法**用于打开小部件的菜单项。它接受字符串类型的单个参数**菜单项**，并且不返回值。
