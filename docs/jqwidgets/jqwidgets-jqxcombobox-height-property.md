...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxcombobox-height-property/](https://www.geeksforgeeks.org/jqwidgets-jqxcombobox-height-property/)
...
*高度*属性用于设置或返回 jqxComboBox 的高度。它接受数字/字符串类型的值，默认值为空。
...
**示例:**以下示例说明了 jQWidgets 中的 jqxComboBox *高度*属性。
