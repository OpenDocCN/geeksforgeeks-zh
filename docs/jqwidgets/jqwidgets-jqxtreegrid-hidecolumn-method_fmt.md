...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxtreegrid-hidecolumn-method/](https://www.geeksforgeeks.org/jqwidgets-jqxtreegrid-hidecolumn-method/)
...
下面的示例说明了 jQWidgets jqxTreeGrid `hideColumn()` 方法。在下面的示例中，“公司”的列名将被隐藏。
