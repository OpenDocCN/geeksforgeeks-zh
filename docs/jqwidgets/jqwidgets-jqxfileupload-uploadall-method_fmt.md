...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxfileupload-uploadall-method/](https://www.geeksforgeeks.org/jqwidgets-jqxfileupload-uploadall-method/)
...
`uploadAll()` 方法用于设置明确使用另一个按钮上传所有文件的按钮。它不接受任何参数，也不返回值。
...
下面的示例说明了 `jQWidgets` 中的 `jqxFileUpload` `uploadAll()` 方法。
