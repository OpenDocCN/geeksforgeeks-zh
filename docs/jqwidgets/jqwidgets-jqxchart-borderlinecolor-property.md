...
> 原文:[https://www . geeksforgeeks . org/jqwidgets-jqxchart-borderinecolor-property/](https://www.geeksforgeeks.org/jqwidgets-jqxchart-borderlinecolor-property/)
...
**示例:**以下示例说明了 jQWidgets 中的 jqxChart **边界线颜色**属性:
