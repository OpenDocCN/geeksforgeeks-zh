...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxcomplexinput-getreal-method/](https://www.geeksforgeeks.org/jqwidgets-jqxcomplexinput-getreal-method/)
...
`getReal()`方法用于获取输入数字的实部。它接受可选的数字类型的单参数复数，并且不返回值。
