# jQWidgets jqxMenu 最小化()方法

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxmenu-minimum-method/](https://www.geeksforgeeks.org/jqwidgets-jqxmenu-minimize-method/)
...
**最小化()方法**用于最小化小部件。它不接受任何参数，也不返回值。
...
下面的例子说明了 jQWidgets jqxMenu 最小化()方法。
