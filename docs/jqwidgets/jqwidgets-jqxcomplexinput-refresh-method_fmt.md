...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxcomplexinput-refresh-method/](https://www.geeksforgeeks.org/jqwidgets-jqxcomplexinput-refresh-method/)
...
下面的例子说明了 jQWidgets `jqxComplexInput` `refresh()`方法。
