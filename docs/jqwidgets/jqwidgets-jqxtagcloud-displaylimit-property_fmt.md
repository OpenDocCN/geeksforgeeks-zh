...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxtagcloud-displaylimit-property/](https://www.geeksforgeeks.org/jqwidgets-jqxtagcloud-displaylimit-property/)
...
**示例:** 以下示例说明了 `jQWidgets` `jqxTagCloud` 的 `displayLimit` 属性。在下面的例子中，`displayLimit` 属性的值被设置为 14。
