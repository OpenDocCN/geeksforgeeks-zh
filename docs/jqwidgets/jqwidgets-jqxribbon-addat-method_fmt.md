...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxribbon-addat-method/](https://www.geeksforgeeks.org/jqwidgets-jqxribbon-addat-method/)
...
下面的示例说明了 jQWidgets jqxRibbon `addAt()`方法。
