...
> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxscrollbar-destroy-method/](https://www.geeksforgeeks.org/jqwidgets-jqxscrollbar-destroy-method/)
...
`destroy()`方法用于销毁指定的`jqxScrollBar`小部件。
...
**示例：** 下面的示例说明了`jQWidgets` `jqxScrollBar`的`destroy()`方法。
