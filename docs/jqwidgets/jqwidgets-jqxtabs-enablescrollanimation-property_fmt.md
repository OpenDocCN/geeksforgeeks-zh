# jQWidgets jqxTabs enableScrollAnimation 属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxtabs-enablescrollanimation-property/](https://www.geeksforgeeks.org/jqwidgets-jqxtabs-enablescrollanimation-property/)
...
`enableScrollAnimation` 属性用于设置或返回滚动动画是否启用。它接受布尔类型值，默认值为 `true`。
