...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxscheduler-toolbarheight-property/](https://www.geeksforgeeks.org/jqwidgets-jqxscheduler-toolbarheight-property/)
...
***工具栏高度*** 属性用于在显示的 **jqxScheduler** 中设置或返回工具栏的高度。它属于数字类型，默认值为 54。
...
*   返回*工具栏高度*属性。
    ...
    ```html
    var toolbarHeight = 
        $('#Selector').jqxScheduler('toolbarHeight');
    ```
...
**示例:**下面的示例说明了 jQWidgets 中的**jqxScheduler***toolbar height*属性。
