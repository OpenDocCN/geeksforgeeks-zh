...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxscrollbar-setposition-method/](https://www.geeksforgeeks.org/jqwidgets-jqxscrollbar-setposition-method/)
...
下面的示例说明了 jQWidgets `jqxScrollBar` `setPosition()` 方法。
