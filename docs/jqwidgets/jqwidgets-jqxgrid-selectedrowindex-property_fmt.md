# jQWidgets jqxGrid selectedrowindex 属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxgrid-selectedrowindex-property/](https://www.geeksforgeeks.org/jqwidgets-jqxgrid-selectedrowindex-property/)

`jQWidgets` 是一个 JavaScript 框架，用于为 PC 和移动设备制作基于 web 的应用程序。它是一个非常强大、优化、独立于平台并且得到广泛支持的框架。`jqxGrid` 用于说明以表格形式显示数据的 jQuery 小部件。此外，它完全支持与数据的连接，以及分页、分组、排序、过滤和编辑。

`selectedrowindex` 属性用于选择特定索引处的行。它是数字类型，缺省值是-1。
...
```javascript
var selectedrowindex = $('#Selector').jqxGrid('selectedrowindex');
```
...
下面的例子说明了 `jQWidgets` 中的 `jqxGrid` `selectedrowindex` 属性。
...
<body>
    <center>
        ...
        <h3>jQWidgets jqxGrid selectedrowindex property</h3>
        <br />
        <div id="jqxg"></div>
        <div>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#jqxBtn").on("click", function () {
                var sri = $('#jqxg').jqxGrid('selectedrowindex');
                $('#log').text("Selected row index: " + sri);
            });
        });
    </script>
</body>
...
![](img/422e64617e80ec511b82b0883aa39842.png)
