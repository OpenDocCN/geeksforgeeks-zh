...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxknob-width-property/](https://www.geeksforgeeks.org/jqwidgets-jqxknob-width-property/)
...
**示例:** 以下示例说明了 jQWidgets `jqxKnob` `width` 属性。在以下示例中，`width` 属性的值已设置为 300。
