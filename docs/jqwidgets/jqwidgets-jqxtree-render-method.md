...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxtree-render-method/](https://www.geeksforgeeks.org/jqwidgets-jqxtree-render-method/)
...
**渲染()方法**用于在屏幕上渲染 jqxTree 小部件。它不接受任何参数，也不返回值。
