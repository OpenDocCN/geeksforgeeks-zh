# jQWidgets jqxValidator hintType 属性

> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxvalidator-hinttype-property/](https://www.geeksforgeeks.org/jqwidgets-jqxvalidator-hinttype-property/)
...
`hintType` 属性用于设置或获取指定 `jqxValidator` 的提示类型。此方法接受两个可能的值，即“tooltip”和“label”。
...
以下示例说明了 `jQWidgets` 的 `hintType` 属性。在下面的例子中，`hintType` 属性的值被设置为“label”。
