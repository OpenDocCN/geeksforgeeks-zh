...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdocking-destroy-method/](https://www.geeksforgeeks.org/jqwidgets-jqxdocking-destroy-method/)
...
下面的示例说明了 jQWidgets `jqxDocking` `destroy()` 方法。
