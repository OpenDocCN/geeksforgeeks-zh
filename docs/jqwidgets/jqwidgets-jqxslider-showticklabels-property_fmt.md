# jQWidgets jqxSlider showTickLabels 属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxslider-showticklabels-property/](https://www.geeksforgeeks.org/jqwidgets-jqxslider-showticklabels-property/)
...
下面的例子说明了 jQWidgets jqxSlider `showTickLabels` 属性。
