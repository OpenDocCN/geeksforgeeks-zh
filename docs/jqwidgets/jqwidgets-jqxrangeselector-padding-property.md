# jQWidgets jqxRangeSelector 填充属性

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxrangeselector-padding-property/](https://www.geeksforgeeks.org/jqwidgets-jqxrangeselector-padding-property/)
...
**填充属性**用于设置或返回范围选择器是否被禁用。它接受布尔类型值，默认值为 false。
...
下面的例子说明了 jQWidgets jqxRangeSelector 填充属性。
