...
***editDialogDateTimeFormatString***属性用于在显示的**jqxsscheduler**的编辑对话框中设置或返回日期时间输入的格式字符串，只要约会没有设置为*全天*。它属于字符串类型，默认值为“日/月/年 hh:mm tt”。
...
**示例:**下面的示例说明了 jQWidgets 中的**jqxScheduler***editDialogDateTimeFormatString*属性。
