...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxmaskedinput-val-method/](https://www.geeksforgeeks.org/jqwidgets-jqxmaskedinput-val-method/)
...
`val()` 方法用于设置或返回小部件的值。它接受字符串类型的单个参数 `value`，并返回字符串类型的值。
