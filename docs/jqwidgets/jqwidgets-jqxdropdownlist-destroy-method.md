# jQWidgets jqxDropDownList 销毁()方法

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxddropdownlist-destroy-method/](https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-destroy-method/)
...
```html
$("Selector").jqxDropDownList('destroy');
```
...
**示例:**下面的示例说明了 jQWidgets 中的 jqxDropDownList**destroy()**方法。
...
        <input id="jqxBtn" type="button" value="Destroy Widget" 
...
                $("#jqxDDL").jqxDropDownList('destroy');
            });
        });
    </script>
</body>
...
![](img/f5b5c66b0949e91853455f5afda295e5.png)
