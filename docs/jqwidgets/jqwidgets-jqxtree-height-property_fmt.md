# jQWidgets jqxTree 高度属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxtree-height-property/](https://www.geeksforgeeks.org/jqwidgets-jqxtree-height-property/)
...
`height` 属性用于设置或返回小部件的高度。它接受数字/字符串类型的值，默认值为空。
...
以下示例说明了 jQWidgets `jqxTree` `height` 属性。
...
<body>
    ...
    <h3>
        jQWidgets jqxTree height Property
    </h3>
...
![](img/50984015e48b3683490eeac0e62bfdc6.png)
