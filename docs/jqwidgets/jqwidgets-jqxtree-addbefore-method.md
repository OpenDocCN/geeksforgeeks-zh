...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxtree-addbefore-method/](https://www.geeksforgeeks.org/jqwidgets-jqxtree-addbefore-method/)
...
**addBefore()方法**用于将一个项目添加为另一个项目的同级。它接受两个参数，第一个是对象类型的**项**，第二个是该项的 **id** 。它不返回值。
