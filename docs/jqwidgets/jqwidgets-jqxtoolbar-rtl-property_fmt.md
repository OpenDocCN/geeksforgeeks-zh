...
`rtl` 属性用于设置或获取一个值，该值说明小部件的元素是否在从右到左字体的帮助下被排列为偏好区域设置。为布尔类型，默认值为 `false`。
...
下面的示例说明了 `jQWidgets` 中的 `jqxToolBar` `rtl` 属性。
...
<body>
    <center>
        ...
        <h3>jQWidgets jqxToolBar rtl property</h3>
