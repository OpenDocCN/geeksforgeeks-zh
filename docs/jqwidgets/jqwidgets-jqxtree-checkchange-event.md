...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxtree-check change-event/](https://www.geeksforgeeks.org/jqwidgets-jqxtree-checkchange-event/)
...
**检查更改事件**用于当用户更改复选框的状态时触发，即选中、取消选中或处于不确定状态。
