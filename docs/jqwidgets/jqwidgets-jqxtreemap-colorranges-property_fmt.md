...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxtreemap-colorranges-property/](https://www.geeksforgeeks.org/jqwidgets-jqxtreemap-colorranges-property/)
...
`colorRanges` 属性用于设置或获取指定 `jqxTreeMap` 的颜色范围。
...
下面的示例说明了 `jQWidgets` `jqxTreeMap` `colorRanges` 属性。
