# jqxFormattedInput 的 popupZIndex 属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxformattedinput-popupzindex-property/](https://www.geeksforgeeks.org/jqwidgets-jqxformattedinput-popupzindex-property/)
...
`popupZIndex` 属性用于设置或返回弹出选项的 z 索引。它接受数字类型值，默认值为 `20000`。
...
下面的例子说明了 jQWidgets `jqxFormattedInput` 的 `popupZIndex` 属性。
