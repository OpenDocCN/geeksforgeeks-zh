# jQWidgets jqxScheduler touch 约会明八房产

> 原文:[https://www . geeksforgeeks . org/jqwidgets-jqxscheduler-touch dependencies Minh h8-property/](https://www.geeksforgeeks.org/jqwidgets-jqxscheduler-touchappointmentsminheight-property/)
...
**触摸预约明八**属性用于在触摸设备上显示的 **jqxScheduler** 中设置或返回预约的最小高度。它属于数字类型，默认值为 27。
...
**示例:**下面的示例说明了 jQWidgets 中的 jqxScheduler*touch depressions minh8*属性。
