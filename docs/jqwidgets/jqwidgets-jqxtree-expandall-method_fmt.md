...
> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxtree-expandall-method/](https://www.geeksforgeeks.org/jqwidgets-jqxtree-expandall-method/)
...
`expandAll()` 方法用于扩展 `jqxTree` 小部件的所有项目。它不接受任何参数，也不返回值。

**语法：**

```javascript
$('Selector').jqxTree('expandAll');
```
...
下面的例子说明了 jQWidgets `jqxTree` `expandAll()` 方法。
...
<body>
    ...
    <h3>
        jQWidgets jqxTree expandAll() Method
    </h3>
    <div id='jqxTree'>
        <ul>
    ...
    <center>
        <input type="button" id="jqxBtn" value="Expand All Items" style="padding: 5px 15px; margin-top: 20px;">
    </center>
...
![](img/25531ef1291636bb0dbc8ff01cd9df18.png)
