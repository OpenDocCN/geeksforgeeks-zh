# jQWidgets jqxRangeSelector 禁用属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxrangeselector-disabled-property/](https://www.geeksforgeeks.org/jqwidgets-jqxrangeselector-disabled-property/)
...
`disabled` 属性用于设置或返回范围选择器是否禁用。它接受布尔类型值，默认值为 `false`。
...
下面的例子说明了 jQWidgets `jqxRangeSelector` `disabled` 属性。
...
<body>
    ...
    <h3>
        jQWidgets jqxRangeSelector disabled Property
    </h3>
...
![](img/37c3070d643c0485f9eb0876e95b3701.png)
