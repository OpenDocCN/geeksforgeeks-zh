...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxbutton-val-method/](https://www.geeksforgeeks.org/jqwidgets-jqxbutton-val-method/)
...
下面的示例说明了 `jQWidgets` 中的 `jqxButton` `val()` 方法。
