...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxformattedinput-open-method/](https://www.geeksforgeeks.org/jqwidgets-jqxformattedinput-open-method/)
...
**open()方法** 用于打开 `jqxFormattedInput` 弹出小部件。它不接受任何参数，也不返回值。
...
下面的例子说明了 jQWidgets `jqxFormattedInput` `open()`方法。
...
![](img/f00d6a9e34fe173c7f54a82800ae441c.png)
