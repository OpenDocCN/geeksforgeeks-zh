# jQWidgets jqxNotification autoCloseDelay 属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxnotification-autoclosedelay-property/](https://www.geeksforgeeks.org/jqwidgets-jqxnotification-autoclosedelay-property/)
...
`autoCloseDelay` 属性用于设置或返回 `autoCloseDelay` 属性。即该属性用于设置或返回通知自动关闭的持续时间。它接受数字/字符串类型值，默认值为 3000。

**语法:**

*   设置 `autoCloseDelay` 属性。
