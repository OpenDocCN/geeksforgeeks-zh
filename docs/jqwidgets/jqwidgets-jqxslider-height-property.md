...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxslider-height-property/](https://www.geeksforgeeks.org/jqwidgets-jqxslider-height-property/)
...
**高度属性**用于设置或返回滑块部件的高度。它接受数字/字符串类型的值，默认值为 35。
...
下面的例子说明了 jQWidgets jqxSlider 高度属性。
