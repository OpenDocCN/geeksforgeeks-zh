# jQWidgets jqxRangeSelector showMinorTicks 属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxrangeselector-showminorticks-property/](https://www.geeksforgeeks.org/jqwidgets-jqxrangeselector-showminorticks-property/)
...
`showMinorTicks` 属性用于设置或返回是否显示次要刻度。它接受布尔类型值，默认值为 `false`。
