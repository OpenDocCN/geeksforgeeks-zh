...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxnavigationbar-expandat-method/](https://www.geeksforgeeks.org/jqwidgets-jqxnavigationbar-expandat-method/)
...
下面的示例说明了 `jQWidgets` `jqxNavigationBar` `expandAt()` 方法。在下面的例子中，第二项将被展开。
...
<body>
    <center>
        ...
        <div id="jqx_Navigation_Bar" style="margin: 25px;" align="left">
        ...
        <input type="button" style="margin: 29px;" id="jqxbutton_for_expandAt" value="Expand the above second item"/>
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                $('#jqxbutton_for_expandAt').on('click', function () {
                    $('#jqx_Navigation_Bar').jqxNavigationBar('expandAt', 1);
                });
            });
        </script>
    </center>
