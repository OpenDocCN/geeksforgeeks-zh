# jq 构件 jqxDateTimeInput 第一周属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdatetimeinput-firstdayofweek-property/](https://www.geeksforgeeks.org/jqwidgets-jqxdatetimeinput-firstdayofweek-property/)
...
`firstDayOfWeek` 属性用于设置或返回第一天列中是否显示哪一天。默认情况下，日历的第一天是“星期日”。
...
下面的例子说明了 jQWidgets 中的 `jqxDateTimeInput` `firstDayOfWeek` 属性。
...
<body>
    <center>
        ...
        <h3>
            jQWidgets jqxDateTimeInput firstDayOfWeek Property
        </h3>
...
![](img/813c417999b3947a6c3e9b9812cf8a32.png)
