...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxcalendar-setmaxdate-method/](https://www.geeksforgeeks.org/jqwidgets-jqxcalendar-setmaxdate-method/)
...
`setMaxDate()` 方法用于设置可以导航的最高日期。此接受 `Date` 或 `String` 类型的单个参数 `date`。它不返回值。
