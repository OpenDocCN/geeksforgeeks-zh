# jQWidgets jqxCalendar showDayNames 属性

> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxcalendar-showdaynames-property/](https://www.geeksforgeeks.org/jqwidgets-jqxcalendar-showdaynames-property/)
...
`showDayNames` 属性用于设置或返回值，检查是否显示日期名称。它接受布尔类型值，默认值为`true`。
