...
> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxcalendar-rtl-property/](https://www.geeksforgeeks.org/jqwidgets-jqxcalendar-rtl-property/)
...
以下示例说明了 jQWidgets 中的 `jqxCalendar` `rtl` 属性。
...
<body>
    <center>
        ...
        <h3>
            jQWidgets jqxCalendar rtl Property
        </h3>
        <div id='jqxcal'></div>
    </center>
...
![](img/a4d4bec71ed6b6c7a47ca656084b8a72.png)
