...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdatatable-selectrow-method/](https://www.geeksforgeeks.org/jqwidgets-jqxdatatable-selectrow-method/)
...
下面的示例说明了 `jQWidgets` 的 `selectRow()` 方法。
