...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxeditor-focus-method/](https://www.geeksforgeeks.org/jqwidgets-jqxeditor-focus-method/)
...
`focus()`方法用于在 `jqxEditor` 小部件上设置焦点。它不接受任何参数，也不返回值。
