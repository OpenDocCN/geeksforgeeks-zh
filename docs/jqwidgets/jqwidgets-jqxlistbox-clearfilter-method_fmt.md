...
> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxlistbox-clearfilter-method/](https://www.geeksforgeeks.org/jqwidgets-jqxlistbox-clearfilter-method/)
...
下面的示例说明了 `jQWidgets` 中的 `jqxListBox` `clearFilter()` 方法。
