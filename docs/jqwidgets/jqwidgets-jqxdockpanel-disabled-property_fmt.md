...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdockpanel-disabled-property/](https://www.geeksforgeeks.org/jqwidgets-jqxdockpanel-disabled-property/)
...
`disabled` 属性用于设置或获取指定的 `jqxDockPanel` 是否禁用。
...
**示例:** 以下示例说明了 jQWidgets jqxDockPanel `disabled` 属性。在以下示例中，`disabled` 属性的值已设置为 `true`。
...
**参考:** [https://www.jqwidgets.com/jquery-widgets-documentation/documentation/jqxdockpanel/jquery-dockpanel-api.htm](https://www.jqwidgets.com/jquery-widgets-documentation/documentation/jqxdockpanel/jquery-dockpanel-api.htm)