...
每当显示的 jqxGrid 没有数据可显示时，**s*****how mptyrow*****属性用于显示或隐藏空行的标签。它是布尔类型，默认值为*真*。**
...
****示例:**以下示例说明了 jQWidgets 中的 jqxGrid *showemptyrow* 属性。**
...
        <h3>jQWidgets jqxGrid showemptyrow property
        </h3>
        <br/>
