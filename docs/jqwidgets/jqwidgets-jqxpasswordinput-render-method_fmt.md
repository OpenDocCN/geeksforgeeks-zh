...
> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxpasswordinput-render-method/](https://www.geeksforgeeks.org/jqwidgets-jqxpasswordinput-render-method/)
...
`render()` 方法用于渲染小部件。它不接受任何参数，也不返回值。
