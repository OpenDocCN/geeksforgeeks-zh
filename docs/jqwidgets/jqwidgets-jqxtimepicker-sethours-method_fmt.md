...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxtimepicker-sethours-method/](https://www.geeksforgeeks.org/jqwidgets-jqxtimepicker-sethours-method/)
...
`setHours()`方法用于设置小时时间。它接受数字类型的单参数`hour_time`，不返回任何值。
