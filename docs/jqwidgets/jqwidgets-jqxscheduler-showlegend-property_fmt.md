# jQWidgets jqxScheduler showLegend 属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxscheduler-showlegend-property/](https://www.geeksforgeeks.org/jqwidgets-jqxscheduler-showlegend-property/)
...
`showLegend` 属性用于设置或返回 `jqxScheduler` 的图例条是否可见。为布尔类型，默认值为 `false`。
...
以下示例说明了 `jQWidgets` 中的 `jqxScheduler` 的 `showLegend` 属性。
