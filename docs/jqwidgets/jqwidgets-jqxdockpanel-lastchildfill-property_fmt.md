# JqWidgets JqxDockpanel lastchildfill 属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdockpanel-lastchildfill-property/](https://www.geeksforgeeks.org/jqwidgets-jqxdockpanel-lastchildfill-property/)
...
`lastchildfill` 属性用于设置或获取指定 `jqxDockPanel` 的 `lastchildfill` 属性。当其值为真时，最后一个子级获得可用的宽度和高度。
...
以下示例说明了 JQWidgets JQxDockpanel `lastchildfill` 属性。在下面的例子中，`lastchildfill` 属性的值被设置为 true。
...
[https://www.jqwidgets.com/jquery-widgets-documentation/documentation/jqxdockpanel/jquery-dockpanel-api.htm?search=](https://www.jqwidgets.com/jquery-widgets-documentation/documentation/jqxdockpanel/jquery-dockpanel-api.htm?search=)