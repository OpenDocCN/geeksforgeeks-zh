# jQWidgets jqxDropDownList valueMember 属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-valuemember-property/](https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-valuemember-property/)
...
`valueMember` 属性用于设置或返回项目的 `valueMember`。此属性指定要设置为列表项“值”的对象属性的名称。它接受字符串类型值，默认值为 `""`。
...
## 示例
以下示例说明了 jQWidgets 中的 `jqxDropDownList` `valueMember` 属性。
