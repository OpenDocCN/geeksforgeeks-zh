...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxsortable-deactivate-event/](https://www.geeksforgeeks.org/jqwidgets-jqxsortable-deactivate-event/)
...
下面的示例说明了 jQWidgets 中的 `jqxSortable` `deactivate` 事件。
