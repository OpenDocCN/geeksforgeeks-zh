# jQWidgets jqxnumber 输入变更事件

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxnumber input-change-event/](https://www.geeksforgeeks.org/jqwidgets-jqxnumberinput-change-event/)
...
**示例:**以下示例说明了 jQWidgets jqxNumberInput **更改**事件。
