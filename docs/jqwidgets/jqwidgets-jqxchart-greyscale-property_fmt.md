...
> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxchart-greyscale-property/](https://www.geeksforgeeks.org/jqwidgets-jqxchart-greyscale-property/)
...
以下示例说明了 `jQWidgets` 中的 `jqxChart` 灰度属性：
