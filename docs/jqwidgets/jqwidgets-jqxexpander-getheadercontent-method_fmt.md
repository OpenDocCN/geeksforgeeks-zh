...
> 哎哎哎:# t0]https://www . geeksforgeeks . org/jqwidgets-jxexpander-getheader-content-method/
...
`getHeaderContent()`方法用于获取扩展器小部件的头部内容。它不接受任何参数，并返回字符串值。

## 语法

```html
$('Selector').jqxExpander('getHeaderContent');
```
...
下面的例子说明了 jQWidgets `jqxExpander` `getHeaderContent()`方法。
...
            value="Get Expander Header Content" 
...
![](img/db552c2439d4f461666067016415ddc1.png)
