# jQWidgets jqxDragDrop dropAction 属性

> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxdragdrop-dropaction-property/](https://www.geeksforgeeks.org/jqwidgets-jqxdragdrop-dropaction-property/)
...
下面的示例说明了 `jQWidgets` 中的 `jqxDragDrop` `dropAction` 属性。
