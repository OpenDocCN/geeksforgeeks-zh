...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxlistmenu-changepage-method/](https://www.geeksforgeeks.org/jqwidgets-jqxlistmenu-changepage-method/)
...
`changePage()`方法用于使用选择器或对象设置显示的页面。它接受对象/字符串类型的单个参数`item`，并且不返回值。
