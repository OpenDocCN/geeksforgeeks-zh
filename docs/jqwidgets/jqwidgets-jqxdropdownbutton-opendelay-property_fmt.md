# jQWidgets jqxDropDownButton openDelay 属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdropdownbutton-opendelay-property/](https://www.geeksforgeeks.org/jqwidgets-jqxdropdownbutton-opendelay-property/)
...
**openDelay** 属性用于设置或获取显示的下拉按钮的打开动画的延迟。它属于数字类型，默认值为 350。
...
下面的示例说明了 jQWidgets 中的 `jqxDropDownButton` `openDelay` 属性。
...
![](img/4328fd2df6ffd6826a90f82f0e03d69e.png)
