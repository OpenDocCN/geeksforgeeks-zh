...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-clearfilter-method/](https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-clearfilter-method/)
...
### 示例
下面的示例说明了 jQWidgets 中的 `jqxDropDownList` `clearFilter()` 方法。
