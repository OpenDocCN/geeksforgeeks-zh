...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxddropdownlist-clear selection-method/](https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-clearselection-method/)
...
**清除选择()**方法用于清除所有选定的项目。它不接受任何参数，也不返回值。
