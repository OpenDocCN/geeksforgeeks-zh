# jQWidgets jqxPopover 位置属性

> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxpopover-position-property/](https://www.geeksforgeeks.org/jqwidgets-jqxpopover-position-property/)
...
`位置`属性用于设置或获取指定 `jqxPopover` 小部件的位置。它的可能值是“顶部”、“右侧”、“底部”和“左侧”。
...
以下示例说明了 jQWidgets jqxPopover `位置`属性。在下面的例子中，`位置`属性的值被设置为“右”。
