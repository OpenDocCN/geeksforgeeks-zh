...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxlistbox-val-method/](https://www.geeksforgeeks.org/jqwidgets-jqxlistbox-val-method/)
...
这个示例说明了 jQWidgets 中的 `jqxListBox` `val()` 方法。
