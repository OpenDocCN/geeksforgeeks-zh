# jQWidgets jqxDateTimeInput 模板属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdatetimeinput-template-property/](https://www.geeksforgeeks.org/jqwidgets-jqxdatetimeinput-template-property/)
...
`模板属性`用于设置或返回模板，作为默认样式的替代。它接受字符串类型的值，默认值为“默认值”。
...
下面的例子说明了 jQWidgets 中的 `jqxDateTimeInput` `template` 属性。
...
<body>
    <center>
        ...
        <h3>
            jQWidgets jqxDateTimeInput template Property
        </h3>
...
![](img/9f0ca28f950c1b98ddec7456084c5caf.png)
