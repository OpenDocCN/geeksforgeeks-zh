...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdatatable-sortby-method/](https://www.geeksforgeeks.org/jqwidgets-jqxdatatable-sortby-method/)
...
*   `dataField`: 这是指定的列名，将根据该列名执行排序。
*   `sortOrder`: 这是排序顺序字符串。其值为“asc”（升序）、“desc”（降序）或空。
