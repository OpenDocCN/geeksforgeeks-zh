# jqwidgets jqxlstmt 动画持续时间属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxlistmenu-animationduration-property/](https://www.geeksforgeeks.org/jqwidgets-jqxlistmenu-animationduration-property/)
...
`animationDuration` 属性用于设置或返回以毫秒为单位的动画持续时间。它接受数字类型的值，默认值为 250。
...
![](img/1c41aa5b6426f0a3d92029d84fa17ec4.png)
