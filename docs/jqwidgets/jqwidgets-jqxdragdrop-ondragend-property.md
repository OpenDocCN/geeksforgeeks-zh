# jq 小部件 jqxDragDrop 减减减减减减减属性

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxdragdrop-ondragend-property/](https://www.geeksforgeeks.org/jqwidgets-jqxdragdrop-ondragend-property/)
...
*onDragEnd* 属性用于设置或返回拖动结束时正在执行的回调。接受函数类型值，默认值为*空值*。
...
**示例:**下面的示例说明了 jQWidgets 中的 jqxDragDrop onDragEnd 属性。
