# jQWidgets jqxtremap 销毁方法

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxtreemap-destroy-method/](https://www.geeksforgeeks.org/jqwidgets-jqxtreemap-destroy-method/)
...
***销毁*** 方法用于销毁指定的 jqxTreeMap 小部件。此方法从网页中移除 jqxTreeMap 小部件。
...
**示例:**下面的示例说明了 jQWidgets jqxTreeMap ***摧毁*** 的方法。
