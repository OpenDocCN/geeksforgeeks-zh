...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxtabs-auto height-property/](https://www.geeksforgeeks.org/jqwidgets-jqxtabs-autoheight-property/)
...
**自动高度属性**用于设置或返回 jqxTabs 标题的高度，该高度将等于具有最大高度的项目。它接受字符串类型值，默认值为真。
