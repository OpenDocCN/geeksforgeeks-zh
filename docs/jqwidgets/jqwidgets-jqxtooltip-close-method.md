...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxtooltip-close-method/](https://www.geeksforgeeks.org/jqwidgets-jqxtooltip-close-method/)
...
**关闭()方法**用于设置工具提示关闭前的时间。如果未设置此方法，工具提示将立即关闭。它接受数字类型的单参数索引，不返回任何值。
