...
> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxslider-focus-method/](https://www.geeksforgeeks.org/jqwidgets-jqxslider-focus-method/)
...
下面的例子说明了 jQWidgets `jqxSlider` `focus()`方法。
...
<body>
    <center>
        ...
        <h3>
            jQWidgets jqxSlider focus() Method
        </h3>

        <div id="jqxSlider"></div>

        <input type="button" id="jqxBtn" 
            value="Focus on the Slider Widget" 
...
![](img/85169247ae10d22cabcd524f5e921165.png)
