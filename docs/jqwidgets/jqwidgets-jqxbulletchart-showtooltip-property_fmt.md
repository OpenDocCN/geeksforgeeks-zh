# jQWidgets jqxbullethart show tooltip 属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxbulletchart-showtooltip-property/](https://www.geeksforgeeks.org/jqwidgets-jqxbulletchart-showtooltip-property/)
...
`showTooltip` 属性用于设置或返回 bulletcharts 的工具提示。它接受布尔类型值，默认值为 `true`。
