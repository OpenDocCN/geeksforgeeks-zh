# jQWidgets jqxGauge RadialGauge start angle 属性

> 原文:[https://www . geeksforgeeks . org/jqwidgets-jqxgauge-radial gage-startangle-property/](https://www.geeksforgeeks.org/jqwidgets-jqxgauge-radialgauge-startangle-property/)
...
**startAngle 属性**用于设置或返回 startAngle 属性，即用于设置 jqxGauge 的起始角度。它接受一个数值，默认值为 30。
...
下面的例子说明了 jQWidgets 中的 jqxGauge **startAngle 属性**:
...
![](img/38193ff8380e4830625e3aa46edc1d1a.png)
