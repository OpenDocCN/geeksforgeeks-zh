# jQWidgets jqxnumber 输入旋转按钮属性

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxnumberinput-spin buttons-property/](https://www.geeksforgeeks.org/jqwidgets-jqxnumberinput-spinbuttons-property/)
...
**旋转按钮属性**用于显示或隐藏旋转按钮。它接受布尔类型值，默认值为 false。
...
下面的例子说明了 jQWidgets jqxnumber input spin buttons 属性。
