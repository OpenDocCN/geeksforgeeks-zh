...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxknob-value-property/](https://www.geeksforgeeks.org/jqwidgets-jqxknob-value-property/)
...
以下示例说明了 jQWidgets `jqxKnob` 的 `value` 属性。在以下示例中，`value` 属性的值已设置为 5。
