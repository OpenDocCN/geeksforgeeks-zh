# jQWidgets jqxsscheduler 约会工具提示属性

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxscheduler-约会工具提示-property/](https://www.geeksforgeeks.org/jqwidgets-jqxscheduler-appointmenttooltips-property/)
...
**约会工具提示**属性用于设置或返回显示的 jqxScheduler 的工具提示是否启用。它属于布尔类型，默认值为真。
...
**示例:**以下示例说明了 jQWidgets 中的 jqxScheduler **约会工具提示**属性。
...
        <h3>jQWidgets jqxScheduler appointmentTooltips
            property
        </h3>
