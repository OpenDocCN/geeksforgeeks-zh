...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxtextarea-opened-property/](https://www.geeksforgeeks.org/jqwidgets-jqxtextarea-opened-property/)
...
`opened` 属性用于获取一个值，该值指示自动建议弹出窗口是否打开。它接受布尔类型值，默认值为 `false`。
...
以下示例说明了 jQWidgets jqxTextArea `opened` 属性。
