...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxtabs-enable at-method/](https://www.geeksforgeeks.org/jqwidgets-jqxtabs-enableat-method/)
...
**enableAt()方法**用于启用给定索引的标签。它接受数字类型的单参数索引。索引从 0 开始。它不返回值。
