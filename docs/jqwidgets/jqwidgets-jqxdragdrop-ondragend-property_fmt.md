# jq 小部件 jqxDragDrop onDragEnd 属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdragdrop-ondragend-property/](https://www.geeksforgeeks.org/jqwidgets-jqxdragdrop-ondragend-property/)
...
`onDragEnd` 属性用于设置或返回拖动结束时正在执行的回调。接受函数类型值，默认值为 `null`。
...
下面的示例说明了 `jQWidgets` 中的 `jqxDragDrop` `onDragEnd` 属性。
...
<body class='default'>
    <center>
        ...
        <h3>
            jQWidgets jqxDragDrop onDragEnd Property
        </h3>
...
![](img/fa37cbf7997e0f182927786e7bb881a6.png)
