...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdragdrop-dragzindex-property/](https://www.geeksforgeeks.org/jqwidgets-jqxdragdrop-dragzindex-property/)
...
以下示例说明了 jQWidgets 中的 `jqxDragDrop` `dragZIndex` 属性。
