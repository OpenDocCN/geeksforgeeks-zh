...
> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxslider-tooltiphidedelay-property/](https://www.geeksforgeeks.org/jqwidgets-jqxslider-tooltiphidedelay-property/)
...
`tooltipHideDelay` 属性用于设置或返回工具提示元素的隐藏延迟。它接受数字类型值，默认值为 500。
...
下面的例子说明了 jQWidgets jqxSlider `tooltipHideDelay` 属性。
