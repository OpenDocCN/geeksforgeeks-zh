# jQWidgets jqxformatedinput selectFirst()方法

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxformatedinput-selectfirst-method/](https://www.geeksforgeeks.org/jqwidgets-jqxformattedinput-selectfirst-method/)
...
**selectFirst()方法**用于在输入字段的数字开头添加插入符号。它不接受任何参数，也不返回值。

**语法:**

```html
$('Selector').jqxFormattedInput('selectFirst');
```
...
下面的例子说明了 jQWidgets jqxformatedinput select first()方法。
...
                $("#jqxFI").jqxFormattedInput('selectFirst');
            })
        });
    </script>
</body>
...
![](img/3c83673fdb236494112e8158dba9f2c8.png)
