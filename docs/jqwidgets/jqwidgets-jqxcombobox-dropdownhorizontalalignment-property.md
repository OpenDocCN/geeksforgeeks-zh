# jQWidgets jqxComboBox dropdowhorizontalignment 属性

> 原文:[https://www . geeksforgeeks . org/jqwidgets-jqxcombobox-dropdowhorizontalization-property/](https://www.geeksforgeeks.org/jqwidgets-jqxcombobox-dropdownhorizontalalignment-property/)
...
*下拉水平对齐*属性用于设置或返回下拉的水平对齐。它接受字符串类型值，默认值为“left”。
...
**示例:**下面的示例说明了 jQWidgets 中的 jqxComboBox*dropdowhorizontalignment*属性。
