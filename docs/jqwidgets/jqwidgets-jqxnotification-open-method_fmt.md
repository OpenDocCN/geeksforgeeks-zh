...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxnotification-open-method/](https://www.geeksforgeeks.org/jqwidgets-jqxnotification-open-method/)
...
以下示例说明了 `jQWidgets` 中的 `jqxNotification` `open()`方法:
