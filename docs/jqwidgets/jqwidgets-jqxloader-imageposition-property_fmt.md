...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxloader-imageposition-property/](https://www.geeksforgeeks.org/jqwidgets-jqxloader-imageposition-property/)
...
`imagePosition` 属性用于设置或返回图像的位置。它接受字符串类型的值，默认值是“中心”。
...
下面的示例说明了 jQWidgets jqxLoader `imagePosition` 属性。
