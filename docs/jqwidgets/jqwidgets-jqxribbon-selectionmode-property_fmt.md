# jQWidgets jqxRibbon selectionMode 属性

> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxribbon-selectionmode-property/](https://www.geeksforgeeks.org/jqwidgets-jqxribbon-selectionmode-property/)
...
`selectionMode` 属性用于设置或返回选择模式。它接受字符串类型值，默认值为 `"click"`。
...
下面的例子说明了 jQWidgets jqxRibbon `selectionMode` 属性。
