# jQWidgets jqxDateTimeInput close()方法

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdatetimeinput-close-method/](https://www.geeksforgeeks.org/jqwidgets-jqxdatetimeinput-close-method/)
...
下面的例子说明了 `jQWidgets` 中的 `jqxDateTimeInput` `close()` 方法。
