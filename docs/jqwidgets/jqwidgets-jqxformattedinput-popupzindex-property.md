# jqwidget jqxfformattitinput popup zinindex property

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxformatedinput-popupzindex-property/](https://www.geeksforgeeks.org/jqwidgets-jqxformattedinput-popupzindex-property/)
...
**弹出属性**用于设置或返回弹出选项的 z 索引。它接受数字类型值，默认值为 20000。
...
```html
$('selector').jqxFormattedInput({ popupZIndex: Number });
```

返回 popupZIndex 属性。

```html
var popupZIndex = $('selector').jqxFormattedInput('popupZIndex');
```
...
下面的例子说明了 jQWidgets jqxformatedinput popupZIndex 属性。
...
![](img/fc34d11d3110a84cab6679ee0890e03f.png)
