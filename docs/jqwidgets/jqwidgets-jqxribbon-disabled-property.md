...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxribbon-disabled-property/](https://www.geeksforgeeks.org/jqwidgets-jqxribbon-disabled-property/)
...
***禁用*** **属性**用于启用或禁用功能区。它接受布尔类型值，默认值为 false。
...
**示例:**以下示例说明了 jQWidgets jqxRibbon *禁用的*属性。
