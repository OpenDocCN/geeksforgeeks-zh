...
> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxresponsivepanel-isopened-method/](https://www.geeksforgeeks.org/jqwidgets-jqxresponsivepanel-isopened-method/)
...
`isOpened()` 方法在面板打开或关闭时返回 `true` 或 `false`。它不接受任何参数，并返回一个布尔值。
