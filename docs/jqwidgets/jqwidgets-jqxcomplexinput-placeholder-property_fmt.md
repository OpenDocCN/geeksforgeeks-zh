# jQWidgets jqxComplexInput 占位符属性

> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxcomplexinput-placeholder-property/](https://www.geeksforgeeks.org/jqwidgets-jqxcomplexinput-placeholder-property/)
...
`placeHolder` 属性用于设置或返回 `jqxComplexInput` 小部件的占位符值。它接受字符串类型值，默认值为空。
