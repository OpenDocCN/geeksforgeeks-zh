# jQWidgets jqxMenu 自动导航主项目属性

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxmenu-autosizemainitems-property/](https://www.geeksforgeeks.org/jqwidgets-jqxmenu-autosizemainitems-property/)
...
**自动调整主项目属性**用于在菜单模式为“水平”时，设置或返回 jqxMenu 小部件主项目的自动调整大小。它接受布尔类型值，默认值为真。
