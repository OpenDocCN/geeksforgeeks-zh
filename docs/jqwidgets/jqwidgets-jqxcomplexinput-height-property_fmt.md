# jQWidgets jqxComplexInput 高度属性

> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxcomplexinput-height-property/](https://www.geeksforgeeks.org/jqwidgets-jqxcomplexinput-height-property/)
...
`height` 属性用于设置或返回 `jqxComplexInput` 小部件的高度。它接受数字/字符串类型的值，默认值为空。
...
以下示例说明了 jQWidgets `jqxComplexInput` `height` 属性。
