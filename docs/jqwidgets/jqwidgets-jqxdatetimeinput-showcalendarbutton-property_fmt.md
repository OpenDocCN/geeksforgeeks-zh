# jQWidgets jqxDateTimeInput showCalendarButton 属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdatetimeinput-showcalendarbutton-property/](https://www.geeksforgeeks.org/jqwidgets-jqxdatetimeinput-showcalendarbutton-property/)
...
`showCalendarButton` 属性用于设置或返回日历按钮是否可见。它接受布尔类型值，默认值为真。
...
下面的例子说明了 jQWidgets 中的 `jqxDateTimeInput` `showCalendarButton` 属性。
...
<body>
    <center>
        ...
        <h3>
            jQWidgets jqxDateTimeInput showCalendarButton Property
        </h3>
...
![](img/49d75c14ce4fa29d778727a7dd93ffcf.png)
