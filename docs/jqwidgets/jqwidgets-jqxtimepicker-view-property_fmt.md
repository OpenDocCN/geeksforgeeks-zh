...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxtimepicker-view-property/](https://www.geeksforgeeks.org/jqwidgets-jqxtimepicker-view-property/)
...
`view` 属性用于设置或返回元素是横向还是纵向。它接受字符串类型值，默认值为 `"纵向"`。
...
下面的例子说明了 jQWidgets `jqxTimePicker` `view` 属性。
...
<body>
    <center>
        ...
        <h3>jQWidgets jqxTimePicker view Property</h3>
        <div id="jqxTP"></div>
    </center>
