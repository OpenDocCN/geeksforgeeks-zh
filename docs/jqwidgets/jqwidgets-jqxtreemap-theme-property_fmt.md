...
> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxtreemap-theme-property/](https://www.geeksforgeeks.org/jqwidgets-jqxtreemap-theme-property/)
...
下面的示例说明了 `jQWidgets` `jqxTreeMap` `主题` 属性。在以下示例中，`主题` 属性的值已设置为“energyblue”。
...
<body>
    <center>
        ...
        <div id="Tree_Map"></div>
        <input type="button" style="margin: 28px;" id="button_for_theme" value="Value of the theme property"/>
        <div id="log"></div>
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                $("#button_for_theme").click(
                    function () {
                        var theme_Value = $('#Tree_Map').jqxTreeMap('theme');
                        $("#log").html((theme_Value));
                    });
            });
        </script>
    </center>
