...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxeditor-width-property/](https://www.geeksforgeeks.org/jqwidgets-jqxeditor-width-property/)
...
`宽度`属性用于设置或返回宽度小部件。它接受数字类型值，默认值为 `null`。
