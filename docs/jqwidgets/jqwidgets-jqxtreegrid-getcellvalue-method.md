...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxtreegrid-getcellvalue-method/](https://www.geeksforgeeks.org/jqwidgets-jqxtreegrid-getcellvalue-method/)
...
*   **行键:**这是将返回其单元格值与数据字段匹配的指定行。
*   **数据字段:**这是将返回其单元格值与行关键字匹配的数据字段或列名。
...
**示例:**下面的示例说明了 jQWidgets jqxTreeGrid**getCellValue()**方法。在下面的示例中，将返回“公司”列第二行的单元格值。
