...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxbutton-toggled-property/](https://www.geeksforgeeks.org/jqwidgets-jqxbutton-toggled-property/)
...
`toggled` 属性用于设置或获取显示按钮的切换状态。它属于布尔类型，默认值为假。
...
下面的例子说明了 jQWidgets 中的 `jqxButton` `toggled` 属性。
