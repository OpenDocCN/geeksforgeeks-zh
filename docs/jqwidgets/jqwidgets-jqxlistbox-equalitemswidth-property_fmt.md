...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxlistbox-equalitemswidth-property/](https://www.geeksforgeeks.org/jqwidgets-jqxlistbox-equalitemswidth-property/)
...
要设置 `equalItemsWidth` 属性:

```javascript
$("#jqxListBox").jqxListBox({equalItemsWidth:false}); 
```

要获取 `equalItemsWidth` 属性:
...
下面的例子说明了 jQWidgets 中的 `jqxListBox` 的 `equalItemsWidth` 属性。
