...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxcombobox-width-property/](https://www.geeksforgeeks.org/jqwidgets-jqxcombobox-width-property/)
...
*宽度*属性用于设置或返回 jqxComboBox 小部件的宽度。它接受数字/字符串类型的值，默认值为*空。*
...
**示例:**以下示例说明了 jQWidgets 中的 jqxComboBox *宽度*属性。
