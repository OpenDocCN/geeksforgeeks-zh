...
> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxswitchbutton-uncheck-method/](https://www.geeksforgeeks.org/jqwidgets-jqxswitchbutton-uncheck-method/)
...
`uncheck()`方法用于取消选中显示的按钮。它没有参数，也不返回任何东西。
...
以下示例说明了`jQWidgets`中的`jqxSwitchButton` `uncheck()`方法。
