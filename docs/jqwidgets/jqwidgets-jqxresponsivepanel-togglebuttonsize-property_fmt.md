...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxresponsivepanel-togglebuttonsize-property/](https://www.geeksforgeeks.org/jqwidgets-jqxresponsivepanel-togglebuttonsize-property/)
...
`toggleButtonSize` 属性用于设置或返回 `toggleButton` 的大小。它接受数字/字符串类型的值，默认值为 30。
...
下面的例子说明了 jQWidgets 中的 `jqxResponsivePanel` `toggleButtonSize` 属性。
...
<body>
    ...
    <h3>
        jQWidgets jqxResponsivePanel toggleButtonSize Property
    </h3>
...
![](img/84b9bae987f71aef6a36e9dfbbe14216.png)
