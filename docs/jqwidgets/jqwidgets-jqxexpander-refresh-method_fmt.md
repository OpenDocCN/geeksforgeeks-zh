...
> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxexpander-refresh-method/](https://www.geeksforgeeks.org/jqwidgets-jqxexpander-refresh-method/)
...
`refresh()`方法用于刷新扩展器小部件。它不接受任何参数，也不返回值。
