...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdocking-cookieoptions-property/](https://www.geeksforgeeks.org/jqwidgets-jqxdocking-cookieoptions-property/)
...
下面的示例说明了 `jQWidgets` `jqxDocking` `cookieOptions` 属性。
