...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxtabs-showclosebuttons-property/](https://www.geeksforgeeks.org/jqwidgets-jqxtabs-showclosebuttons-property/)
...
`showCloseButtons` 属性用于设置或返回每个选项卡中是否显示关闭按钮。它接受布尔类型值，默认值为 `false`。
...
下面的例子说明了 jQWidgets jqxTabs 的 `showCloseButtons` 属性。
...
<body>
    <center>
        ...
        <h3>
            jQWidgets jqxTabs showCloseButtons Property
        </h3>
...
![](img/2a6e7259bb45b3ddb5b699211a320235.png)
