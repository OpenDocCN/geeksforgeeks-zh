...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxlistmenu-destroy-method/](https://www.geeksforgeeks.org/jqwidgets-jqxlistmenu-destroy-method/)
...
`destroy()`方法用于销毁小部件。它不接受任何参数，也不返回值。

### 语法

```javascript
$("Selector").jqxListMenu('destroy');
```
...
下面的例子说明了 jQWidgets 中的 `jqxListMenu` `destroy()`方法。
...
<body>
    ...
    <h3>
        jQWidgets jqxListMenu destroy() Method
    </h3>
...
![](img/460c37ae69931437c81493a8effe505c.png)
