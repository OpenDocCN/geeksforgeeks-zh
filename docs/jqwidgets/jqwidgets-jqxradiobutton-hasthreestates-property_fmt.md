...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxradiobutton-hasthreestates-property/](https://www.geeksforgeeks.org/jqwidgets-jqxradiobutton-hasthreestates-property/)
...
`hasThreeStates` 属性用于设置或返回按钮的 3 种状态。它接受布尔类型值，默认值为 `false`。
...
下面的例子说明了 jQWidgets jqxRadioButton `hasThreeStates` 属性。
