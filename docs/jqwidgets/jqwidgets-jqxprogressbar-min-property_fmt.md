...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxprogressbar-min-property/](https://www.geeksforgeeks.org/jqwidgets-jqxprogressbar-min-property/)
...
以下示例说明了 jQWidgets 中的 jqxProgressBar `min` 属性。
