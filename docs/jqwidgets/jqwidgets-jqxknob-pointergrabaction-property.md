# jQWidgets jqxKnob pointer rab action 属性

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxknob-pointer grab action-property/](https://www.geeksforgeeks.org/jqwidgets-jqxknob-pointergrabaction-property/)
...
***指针拉动作*** 属性用于设置或获取指定 jqxKnob 的指针拉动作属性。它的可能值是“正常”、“进度栏”和“指针”。
...
**示例:**下面的示例说明了 jQWidgets jqxKnob***pointer grab action***属性。在以下示例中， ***指针活动*** 属性的值已设置为“指针”。
