...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxbuttongroup-getselection-method/](https://www.geeksforgeeks.org/jqwidgets-jqxbuttongroup-getselection-method/)
...
`getSelection()`方法用于从显示的 `jqxButtonGroup` 返回所选按钮的索引。它没有参数。它返回一个数字或数字数组。
