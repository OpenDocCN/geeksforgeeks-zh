# jQWidgets jqxBulletChart disabled 属性

> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxbulletchart-disabled-property/](https://www.geeksforgeeks.org/jqwidgets-jqxbulletchart-disabled-property/)
...
下面的示例说明了 `jqxBulletChart` 在 jQWidgets 中的 `disabled` 属性。
