...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdatetimeinput-setmindate-method/](https://www.geeksforgeeks.org/jqwidgets-jqxdatetimeinput-setmindate-method/)
...
`setMinDate()` 方法用于设置可以导航的最小日期。它接受日期/字符串类型的单参数 `Date`，并且不返回任何值。
...
<body>
    <center>
        ...
        <h3>
            jQWidgets jqxDateTimeInput setMinDate() Method
        </h3>
