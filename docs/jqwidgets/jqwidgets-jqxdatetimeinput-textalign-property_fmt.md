# jqwidget jqxdatetimeinput 文本字符串属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdatetimeinput-textalign-property/](https://www.geeksforgeeks.org/jqwidgets-jqxdatetimeinput-textalign-property/)
...
`textAlign` 属性用于设置或返回文本内容的位置。它接受字符串类型值，默认值为“左”。
...
以下示例说明了 jQWidgets 中的 `jqxDateTimeInput` `textAlign` 属性。
...
<body>
    <center>
        ...
        <h3>
            jQWidgets jqxDateTimeInput textAlign Property
        </h3>
...
![](img/4783c5a65a44bba2e41c71559edfa460.png)
