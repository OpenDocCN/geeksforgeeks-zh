...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxscrollbar-vertical-property/](https://www.geeksforgeeks.org/jqwidgets-jqxscrollbar-vertical-property/)
...
以下示例说明了 jQWidgets `jqxScrollBar` 的 `vertical` 属性。在下面的例子中，`vertical` 属性的值被设置为 `true`。
