...
> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxformattedinput-focus-method/](https://www.geeksforgeeks.org/jqwidgets-jqxformattedinput-focus-method/)
...
## focus()方法
`focus()`方法用于聚焦 `jqxFormattedInput` 小部件。它不接受任何参数，也不返回值。
