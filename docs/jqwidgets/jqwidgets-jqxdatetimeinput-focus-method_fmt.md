...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdatetimeinput-focus-method/](https://www.geeksforgeeks.org/jqwidgets-jqxdatetimeinput-focus-method/)
...
`focus()`方法用于聚焦小部件元素。它不接受任何参数，也不返回值。
