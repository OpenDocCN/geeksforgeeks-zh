...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxlayout-unpin-event/](https://www.geeksforgeeks.org/jqwidgets-jqxlayout-unpin-event/)
...
当一组指定的 `jqxLayout` 小部件被取消固定时，触发 `unpin` 事件。
...
下面的示例说明了 `jQWidgets` `jqxLayout` 的 `unpin` 事件。
