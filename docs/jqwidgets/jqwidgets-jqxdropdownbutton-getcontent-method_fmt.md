...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdropdownbutton-getcontent-method/](https://www.geeksforgeeks.org/jqwidgets-jqxdropdownbutton-getcontent-method/)
...
**getContent()方法** 用于返回显示的下拉按钮的内容。返回的内容是使用 `setContent()` 方法设置的下拉按钮的内容。它不接受任何参数，并返回一个 jQuery 对象。
