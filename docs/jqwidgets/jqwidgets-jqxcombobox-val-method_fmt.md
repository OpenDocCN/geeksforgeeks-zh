...
> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxcombobox-val-method/](https://www.geeksforgeeks.org/jqwidgets-jqxcombobox-val-method/)
...
`val()`方法用于设置或返回选定的值。它接受可选的字符串类型的单个参数值，并返回字符串类型值。
...
// Set the value
$('selector').jqxComboBox('val', 'New Value');  or
...
以下示例说明了 jQWidgets 中的 `jqxComboBox` `val()`方法：
...
![](img/f5df08c61744c998107ec4b6dcb42192.png)
