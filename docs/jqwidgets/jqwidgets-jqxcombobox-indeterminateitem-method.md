# jQWidgets jqxComboBox 不确定项()方法

> 原文:[https://www . geeksforgeeks . org/jqwidgets-jqxcombobox-indesidenteitem-method/](https://www.geeksforgeeks.org/jqwidgets-jqxcombobox-indeterminateitem-method/)
...
*不确定项目()*方法用于将复选框项目状态设置为不确定。它接受字符串/对象类型的单个参数项，并且不返回值。
...
**示例:**下面的示例说明了 jQWidgets 中的 jqxComboBox *不确定项()*方法。
