...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxpopover-theme-property/](https://www.geeksforgeeks.org/jqwidgets-jqxpopover-theme-property/)
...
下面的示例说明了 jQWidgets `jqxPopover` `主题` 属性。在以下示例中，`主题` 属性的值已设置为“energyblue”。
