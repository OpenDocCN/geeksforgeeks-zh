...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxtree-allowdrag-property/](https://www.geeksforgeeks.org/jqwidgets-jqxtree-allowdrag-property/)
...
**允许拖动属性**用于启用或禁用小部件的拖动选项。它接受布尔类型值，默认值为 false。
