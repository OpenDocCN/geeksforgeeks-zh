...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxformattedinput-rtl-property/](https://www.geeksforgeeks.org/jqwidgets-jqxformattedinput-rtl-property/)
...
`rtl` 属性用于设置或返回一个值，该值指示 `jqxFormattedInput` 小部件元素是否对齐以支持使用从右向左字体的区域设置。它接受布尔类型值，默认值为 `false`。
