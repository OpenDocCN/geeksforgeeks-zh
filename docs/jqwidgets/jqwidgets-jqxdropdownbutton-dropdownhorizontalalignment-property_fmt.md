...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdropdownbutton-dropdownhorizontalalignment-property/](https://www.geeksforgeeks.org/jqwidgets-jqxdropdownbutton-dropdownhorizontalalignment-property/)
...
`dropDownHorizontalAlignment` 属性用于设置或获取显示的下拉按钮的对齐。类型为字符串，默认值为 `left`。
...
获取 `dropDownHorizontalAlignment` 属性。
...
下面的示例说明了 jQWidgets 中的 `jqxDropDownButton` `dropDownHorizontalAlignment` 属性。
