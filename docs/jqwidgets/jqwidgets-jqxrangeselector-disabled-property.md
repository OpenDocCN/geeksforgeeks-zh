...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxrangeselector-disabled-property/](https://www.geeksforgeeks.org/jqwidgets-jqxrangeselector-disabled-property/)
...
**禁用属性**用于设置或返回范围选择器是否禁用。它接受布尔类型值，默认值为 false。
...
下面的例子说明了 jQWidgets jqxRangeSelector 禁用属性。
