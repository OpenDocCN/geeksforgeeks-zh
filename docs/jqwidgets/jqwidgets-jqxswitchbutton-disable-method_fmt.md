...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxswitchbutton-disable-method/](https://www.geeksforgeeks.org/jqwidgets-jqxswitchbutton-disable-method/)
...
`disable()` 方法用于禁用显示的开关按钮。它没有参数，也不返回任何内容。
