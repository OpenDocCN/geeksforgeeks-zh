...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxrating-value-property/](https://www.geeksforgeeks.org/jqwidgets-jqxrating-value-property/)
...
`value` 属性用于设置或返回 `jqxRating` 小部件的值。它接受数字类型值，默认值为 0。
...
以下示例说明了 jQWidgets jqxRating `value` 属性。
