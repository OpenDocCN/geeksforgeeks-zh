# jq 构件 jqxDateTimeInput rtl 属性

> 哎哎哎:# t0]https://www . geeksforgeeks . org/jqwidgets-jqxdatetimeinput-RTL-property/上
...
```html
$('selector').jqxDateTimeInput({ rtl: Boolean });
```

归还`rtl`的财产。

```html
var rtl = $('selector').jqxDateTimeInput('rtl');
```
...
下面的例子说明了 jQWidgets 中的`jqxDateTimeInput`的`rtl`属性。
...
<h3>
            jQWidgets jqxDateTimeInput rtl Property
        </h3>
...
![](img/e7042d84949cd24494274d30b1cf2b36.png)
