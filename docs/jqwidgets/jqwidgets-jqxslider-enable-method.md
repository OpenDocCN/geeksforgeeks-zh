# jQWidgets jqxSlider 使能()方法

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxslider-enable-method/](https://www.geeksforgeeks.org/jqwidgets-jqxslider-enable-method/)
...
**启用()方法**用于启用禁用的 jqxSlider 小部件。它不接受任何参数，也不返回值。

**语法:**

```html
$('Selector').jqxSlider('enable');
```
...
下面的例子说明了 jQWidgets jqxSlider enable()方法。
...
        <h3>
            jQWidgets jqxSlider enable() Method
        </h3>

        <div id="jqxSlider"></div>

        <input type="button" id="jqxBtn" 
            value="Enable the Slider Widget" 
...
![](img/636da1835b6ff9a4d76d4361de99090c.png)
