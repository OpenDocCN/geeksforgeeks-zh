# jQWidgets jqxbullethart 范围属性

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxbullethart-ranges-property/](https://www.geeksforgeeks.org/jqwidgets-jqxbulletchart-ranges-property/)
...
`ranges` 属性用于设置或返回 bulletcharts 的范围。它接受数组类型值。它的可能值是–
...
从 https://www.jqwidgets.com/download/ 链接下载 jQWidgets。在 HTML 文件中，找到下载文件夹中的脚本文件:
...
以下示例说明了 jQWidgets 中的 `jqxBulletChart` `ranges` 属性:
...
![](img/fb4c8b9f6914b8c8e3b59602c07a3a3c.png)

### 参考:

[https://www . jqwidgets . com/jquery-widgets-documentation/documentation/jqxbullethart/jquery-bullet-chart-API . htm](https://www.jqwidgets.com/jquery-widgets-documentation/documentation/jqxbulletchart/jquery-bullet-chart-api.htm)