...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdocking-disable-method/](https://www.geeksforgeeks.org/jqwidgets-jqxdocking-disable-method/)
...
下面的示例说明了 jQWidgets `jqxDocking` `disable()` 方法。
