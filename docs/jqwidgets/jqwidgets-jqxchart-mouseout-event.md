...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxchart-mouse out-event/](https://www.geeksforgeeks.org/jqwidgets-jqxchart-mouseout-event/)
...
**示例:**以下示例说明了 jQWidgets 中的 jqxChart **鼠标退出**事件:
