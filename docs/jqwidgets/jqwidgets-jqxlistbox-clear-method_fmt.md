...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxlistbox-clear-method/](https://www.geeksforgeeks.org/jqwidgets-jqxlistbox-clear-method/)
...
下面的示例说明了 jQWidgets 中的 `jqxListBox` `clear()` 方法。
