# jQWidgets jqxdatetime input close()方法

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxdatetimeinput-close-method/](https://www.geeksforgeeks.org/jqwidgets-jqxdatetimeinput-close-method/)
...
**close()** 方法用于隐藏弹出日历。它不接受任何参数，也不返回值。

**语法:**

```html
$('Selector').jqxDateTimeInput('close'); 
```
...
下面的例子说明了 jQWidgets 中的 j **qxDateTimeInput close()** 方法。
...
        <h3>
            jQWidgets jqxDateTimeInput close() Method
        </h3>
...
![](img/9aeda5abae76764a92f373613c67ff33.png)
