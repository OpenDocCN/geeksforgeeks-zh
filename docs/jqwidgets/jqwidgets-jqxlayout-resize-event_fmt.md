# jqwidget jxllayout resize event

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxlayout-resize-event/](https://www.geeksforgeeks.org/jqwidgets-jqxlayout-resize-event/)
...
**示例:**
下面的示例说明了 `jQWidgets` `jqxLayout` **调整大小** 事件。
