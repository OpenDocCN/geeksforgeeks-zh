# jQWidgets jqxbullethart 描述属性

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxbullethart-description-property/](https://www.geeksforgeeks.org/jqwidgets-jqxbulletchart-description-property/)
...
*描述*属性用于设置或返回项目符号图描述。它接受字符串类型值，默认值为“描述”。
...
**示例:**下面的示例说明了 jQWidgets 中的 jqxbullethart*描述*属性。
