# jQWidgets jqxNotification 不透明度属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxnotification-opacity-property/](https://www.geeksforgeeks.org/jqwidgets-jqxnotification-opacity-property/)
...
以下示例说明了 jQWidgets 中的 `jqxNotification` 不透明度属性:
