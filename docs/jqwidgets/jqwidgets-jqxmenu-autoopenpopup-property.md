...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxmenu-autoopenpopup-property/](https://www.geeksforgeeks.org/jqwidgets-jqxmenu-autoopenpopup-property/)
...
**自动打开弹出属性**用于在按下鼠标右键时打开上下文菜单。它接受布尔类型值，默认值为真。
