# jQWidgets jqxnumber input promptChar 属性

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxnumberinput-promptchar-property/](https://www.geeksforgeeks.org/jqwidgets-jqxnumberinput-promptchar-property/)
...
**提示字符属性**用于设置或返回可编辑字符为空时显示的提示字符。它接受字符类型值，默认值为“_”。
...
下面的例子说明了 jQWidgets jqxnumber input promptChar 属性。
