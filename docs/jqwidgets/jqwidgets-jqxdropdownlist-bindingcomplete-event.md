# jqwidgets jqxdropsdownlist binding complete event

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxddropdownlist-binding complete-event/](https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-bindingcomplete-event/)
...
下面的例子说明了 jQWidgets 中的 jqxDropDownList bindingComplete 事件。
...
            $("#jqxDDL").on('bindingComplete', function (event) {
                alert("Data Binding Completed");
            });
...
![](img/4f0efad8e43f850d59f0d33f1db11edf.png)
