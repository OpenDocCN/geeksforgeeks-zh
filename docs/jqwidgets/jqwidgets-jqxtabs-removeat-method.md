...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxtabs-remove at-method/](https://www.geeksforgeeks.org/jqwidgets-jqxtabs-removeat-method/)
...
removeAt()方法用于删除特定索引的选项卡。它接受数字类型的单个参数索引。索引从 0 开始。它不返回值。
