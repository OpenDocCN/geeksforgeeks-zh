# jQWidgets jqxbullethart 渲染()方法

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxbullethart-render-method/](https://www.geeksforgeeks.org/jqwidgets-jqxbulletchart-render-method/)
...
**示例:**以下示例说明了 jQWidgets 中的 jqxbullethart**render()**方法。
