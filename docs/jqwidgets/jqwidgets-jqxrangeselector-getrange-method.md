...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxrangeselector-get range-method/](https://www.geeksforgeeks.org/jqwidgets-jqxrangeselector-getrange-method/)
...
**获取范围()方法**用于获取选定的范围。它不接受任何参数，并返回对象类型值。对象值包含范围选择器的起始值(从)和结束值(到)。
