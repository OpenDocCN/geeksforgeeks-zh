...
> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxdatetimeinput-getdate-method/](https://www.geeksforgeeks.org/jqwidgets-jqxdatetimeinput-getdate-method/)
...
`getDate()`方法用于返回当前日期。它不接受任何参数，并返回日期对象。
...
下面的例子说明了 jQWidgets 中的 `jqxDateTimeInput` `getDate()`方法。
...
<body>
    <center>
        ...
        <h3>
            jQWidgets jqxDateTimeInput getDate() Method
        </h3>
...
![](img/ff763c81e476394f65cb2c36377c30a3.png)
