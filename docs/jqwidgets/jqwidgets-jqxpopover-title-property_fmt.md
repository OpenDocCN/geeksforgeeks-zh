# jQWidgets jqxPopover title 属性

> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxpopover-title-property/](https://www.geeksforgeeks.org/jqwidgets-jqxpopover-title-property/)
...
`title` 属性用于设置或获取指定 `jqxPopover` 小部件的标题。
...
## 示例
下面的示例说明了 `jQWidgets` `jqxPopover` `title` 属性。在下面的例子中，`title` 属性的值被设置为“Company_Name”。
...
**参考:** [https://www.jqwidgets.com/jquery-widgets-documentation/documentation/jqxpopover/jquery-popover-api.htm?search=](https://www.jqwidgets.com/jquery-widgets-documentation/documentation/jqxpopover/jquery-popover-api.htm?search=)