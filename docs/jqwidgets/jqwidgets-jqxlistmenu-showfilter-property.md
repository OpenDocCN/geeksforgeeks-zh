...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxlistmenu-show filter-property/](https://www.geeksforgeeks.org/jqwidgets-jqxlistmenu-showfilter-property/)
...
**显示过滤器**属性用于设置或返回过滤器输入字段是否可见。它接受布尔类型值，默认值为 false。
