...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxtabs-expand-method/](https://www.geeksforgeeks.org/jqwidgets-jqxtabs-expand-method/)
...
**展开()方法**用于展开当前选中的标签页。它不接受任何参数，也不返回值。
