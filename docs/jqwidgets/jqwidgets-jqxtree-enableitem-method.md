...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxtree-enable item-method/](https://www.geeksforgeeks.org/jqwidgets-jqxtree-enableitem-method/)
...
**enableItem()方法**用于启用一个 jqxTree 小部件项。它接受对象类型的单个参数项，不返回任何值。
