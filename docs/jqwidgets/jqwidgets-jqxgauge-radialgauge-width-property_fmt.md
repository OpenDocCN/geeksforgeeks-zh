# jQWidgets jqxGauge RadialGauge 宽度属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxgauge-radialgauge-width-property/](https://www.geeksforgeeks.org/jqwidgets-jqxgauge-radialgauge-width-property/)
...
`width` 属性用于设置或返回宽度属性，即用于设置或获取 `jqxGauge` 元素的宽度。它接受一个数值，默认值为 350。
...
以下示例说明了 jQWidgets 中的 `jqxGauge` `width` 属性。
...
![](img/615df46d654793f3a375f28d72238c67.png)
