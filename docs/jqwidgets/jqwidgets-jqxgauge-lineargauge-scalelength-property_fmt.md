# jQWidgets jqxGauge linear gauge scale length 属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxgauge-lineargauge-scalelength-property/](https://www.geeksforgeeks.org/jqwidgets-jqxgauge-lineargauge-scalelength-property/)
...
下面的示例说明了 jQWidgets 中的 `jqxLinearGauge` `scaleLength` 属性。
