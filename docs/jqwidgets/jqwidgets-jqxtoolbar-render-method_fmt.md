...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxtoolbar-render-method/](https://www.geeksforgeeks.org/jqwidgets-jqxtoolbar-render-method/)
...
`render()` 方法用于渲染显示的 `jqxToolBar` 小部件。它没有参数，也不返回任何内容。
