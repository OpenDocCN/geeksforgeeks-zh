...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdocking-showallclosebuttons-method/](https://www.geeksforgeeks.org/jqwidgets-jqxdocking-showallclosebuttons-method/)
...
下面的示例说明了 jQWidgets `jqxDocking` `showAllCloseButtons()` 方法。
