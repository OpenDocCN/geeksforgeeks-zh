# jQWidgets jqxBarGauge relativeInnerRadius 属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxbargauge-relativeinnerradius-property/](https://www.geeksforgeeks.org/jqwidgets-jqxbargauge-relativeinnerradius-property/)
...
`relativeInnerRadius` 属性用于设置杆规的相对内半径。默认值为 `0.3`。
...
**CDN 链接:** 从 [https://www.jqwidgets.com/download/](https://www.jqwidgets.com/download/) 链接下载 jQWidgets。在 HTML 文件中，找到下载文件夹中的脚本文件:
...
<head>
    ...
    <script type="text/javascript" 
            src="jqwidgets/jqxbargauge.js"></script>
