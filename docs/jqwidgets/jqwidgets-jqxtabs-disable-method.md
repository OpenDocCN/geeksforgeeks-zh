# jQWidgets jqxTabs 禁用()方法

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxtabs-disable-method/](https://www.geeksforgeeks.org/jqwidgets-jqxtabs-disable-method/)
...
**禁用()方法**用于禁用选项卡小部件。它不接受任何参数，也不返回值。
