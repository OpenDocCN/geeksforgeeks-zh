...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxradiobutton-checked-property/](https://www.geeksforgeeks.org/jqwidgets-jqxradiobutton-checked-property/)
...
`checked` 属性用于设置或返回是否勾选了 `jqxRadioButton` 小部件。它接受布尔类型值，默认值为 `false`。
...
下面的示例说明了 jQWidgets `jqxRadioButton` 的 `checked` 属性。
