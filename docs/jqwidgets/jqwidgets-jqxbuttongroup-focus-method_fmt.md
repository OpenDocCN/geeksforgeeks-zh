...
> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxbuttongroup-focus-method/](https://www.geeksforgeeks.org/jqwidgets-jqxbuttongroup-focus-method/)
...
`focus()`方法用于聚焦显示的`jqxButtonGroup`。它没有参数，也不返回任何内容。
