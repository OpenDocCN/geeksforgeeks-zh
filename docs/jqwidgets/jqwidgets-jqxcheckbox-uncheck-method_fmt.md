# jQWidgets jqxCheckBox uncheck()方法

> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxcheckbox-uncheck-method/](https://www.geeksforgeeks.org/jqwidgets-jqxcheckbox-uncheck-method/)
...
`uncheck()` 方法用于取消选中复选框。它不接受任何参数，也不返回值。
...
下面的示例说明了 `jqxCheckBox` 在 jQWidgets 中的 `uncheck()` 方法。
