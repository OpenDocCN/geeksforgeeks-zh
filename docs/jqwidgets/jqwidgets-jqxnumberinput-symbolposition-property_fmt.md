# jQWidgets jqxNumberInput `symbolPosition` 属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxnumberinput-symbolposition-property/](https://www.geeksforgeeks.org/jqwidgets-jqxnumberinput-symbolposition-property/)
...
`symbolPosition` 属性用于设置或返回符号在输入字段中的位置。它接受字符串类型值，默认值为“左”。
...
下面的例子说明了 jQWidgets jqxNumberInput `symbolPosition` 属性。
...
![](img/a4eadb54214ee1e80612e8aa5aeec0e8.png)
