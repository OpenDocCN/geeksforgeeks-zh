# jQWidgets jqxTree 崩溃事件

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxtree-collapse-event/](https://www.geeksforgeeks.org/jqwidgets-jqxtree-collapse-event/)
...
```javascript
$('Selector').on('collapse', function (event) {  });
```
...
下面的例子说明了 jQWidgets jqxTree 崩溃事件。
...
<body>
    ...
    <h3>
        jQWidgets jqxTree collapse Event
    </h3>
...
![](img/94c9704a7104d9439971a8a59510751d.png)
