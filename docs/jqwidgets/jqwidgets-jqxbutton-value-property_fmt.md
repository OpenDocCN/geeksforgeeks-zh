...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxbutton-value-property/](https://www.geeksforgeeks.org/jqwidgets-jqxbutton-value-property/)
...
`value` 属性用于设置或获取显示按钮的值。它属于字符串类型，默认值为 `""`。
...
下面的例子说明了 `jQWidgets` 中的 `jqxButton` `value` 属性。
