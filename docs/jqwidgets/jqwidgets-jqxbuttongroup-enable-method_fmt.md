...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxbuttongroup-enable-method/](https://www.geeksforgeeks.org/jqwidgets-jqxbuttongroup-enable-method/)
...
以下示例说明了 jQWidgets 中的 `jqxButtonGroup` `enable()` 方法。
