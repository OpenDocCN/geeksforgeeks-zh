...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxmenu-initialized-event/](https://www.geeksforgeeks.org/jqwidgets-jqxmenu-initialized-event/)
...
下面的例子说明了 jQWidgets `jqxMenu` 初始化事件。
...
<body>
    ...
    <h3>
        jQWidgets jqxMenu initialized Event
    </h3>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('#jqxMenu').on('initialized', function () {
                alert("Menu Item is Initialized");
            });
...
![](img/5c92cc58619cf8d2732bde46b3a75e32.png)
