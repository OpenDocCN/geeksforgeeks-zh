# jQWidgets jqxnumber input destroy()方法

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxnumber input-destroy-method/](https://www.geeksforgeeks.org/jqwidgets-jqxnumberinput-destroy-method/)
...
```html
$('Selector').jqxNumberInput('destroy');
```
...
下面的例子说明了 jQWidgets jqxNumberInput destroy()方法。
...
        <h3>
            jQWidgets jqxNumberInput destroy() Method
        </h3>
...
![](img/f9f0c076795f11b3d4b4dd79e4bce465.png)
