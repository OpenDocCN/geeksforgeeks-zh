...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxheatmap-destroy-method/](https://www.geeksforgeeks.org/jqwidgets-jqxheatmap-destroy-method/)
...
`destroy()`方法用于销毁 `jqxHeatMap`。它不接受任何参数，也不返回值。
...
下面的示例说明了 jQWidgets 中的 `jqxHeatMap` `destroy()`方法:
