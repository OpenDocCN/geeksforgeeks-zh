...
> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxlistbox-multipleextended-property/](https://www.geeksforgeeks.org/jqwidgets-jqxlistbox-multipleextended-property/)
...
要设置 `multipleextended` 属性：

```javascript
$("#jqxListBox").jqxListBox({multipleextended: true}); 
```

要获得 `multipleextended` 属性：
