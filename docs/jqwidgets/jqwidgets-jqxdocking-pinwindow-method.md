...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxdocking-pinwindow-method/](https://www.geeksforgeeks.org/jqwidgets-jqxdocking-pinwindow-method/)
...
**pinWindow()** 方法用于锁定指定 jqxDocking 的窗口。
...
**示例:**下面的示例说明了 jQWidgets jqxDocking**pinWindow()**方法。在下面的例子中，调用 **pinWindow()** 方法后，窗口将被固定，不会被拖动到任何地方。
...
![](img/375f114c9d4e8e5c4d3e076c6a5ef879.png)
