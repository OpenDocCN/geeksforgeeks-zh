# jQWidgets jqxDateTimeInput 值属性

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxdatetimeinput-value-property/](https://www.geeksforgeeks.org/jqwidgets-jqxdatetimeinput-value-property/)
...
*值*属性用于设置或返回 jqxDateTimeInput 小部件的值。它接受日期类型值，默认值为“今天的日期”。
...
```html
$('selector').jqxDateTimeInput({ value: Date });
```

*   返回*值*属性。

```html
var value = $('selector').jqxDateTimeInput('value');
```
...
**示例:**以下示例说明了 jQWidgets 中的 jqxDateTimeInput *值*属性。
...
![](img/881289f877dce411954ec1e68c3319d9.png)
