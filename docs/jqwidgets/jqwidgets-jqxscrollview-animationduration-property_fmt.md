...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxscrollview-animationduration-property/](https://www.geeksforgeeks.org/jqwidgets-jqxscrollview-animationduration-property/)
...
`animationDuration` 属性用于设置或获取当前页面改变时开始的动画持续时间。
...
**示例:** 下面的示例说明了 `jQWidgets` `jqxScrollView` 的 `animationDuration` 属性。在下面的例子中，`animationDuration` 属性的值被设置为 4000。
...
**参考:** [https://www.jqwidgets.com/jquery-widgets-documentation/documentation/jqxscrollview/jquery-scrollview-api.htm](https://www.jqwidgets.com/jquery-widgets-documentation/documentation/jqxscrollview/jquery-scrollview-api.htm)