...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxnumberinput-getdecimal-method/](https://www.geeksforgeeks.org/jqwidgets-jqxnumberinput-getdecimal-method/)
...
**示例:** 下面的示例说明了 jQWidgets jqxNumberInput `getDecimal()` 方法。
