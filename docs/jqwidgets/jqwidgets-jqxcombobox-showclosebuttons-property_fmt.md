...
> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxcombobox-showclosebuttons-property/](https://www.geeksforgeeks.org/jqwidgets-jqxcombobox-showclosebuttons-property/)
...
`showCloseButtons` 属性用于设置或返回 `jqxComboBox` 在多选模式下显示项目关闭按钮。它接受布尔类型值，默认值为 `true`。

## 语法

设置 `showCloseButtons` 属性。
