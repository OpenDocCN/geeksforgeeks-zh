...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxcomplexinput-getimaginary-method/](https://www.geeksforgeeks.org/jqwidgets-jqxcomplexinput-getimaginary-method/)
...
`getImaginary()` 方法用于返回复数的虚部。它接受数字类型的单个参数 `complexNumber`，它是可选的，不返回值。
