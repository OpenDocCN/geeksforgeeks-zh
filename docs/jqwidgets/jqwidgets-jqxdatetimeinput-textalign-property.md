...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxdatetimeinput-textalign-property/](https://www.geeksforgeeks.org/jqwidgets-jqxdatetimeinput-textalign-property/)
...
***文本对齐*** **属性**用于设置或返回文本内容的位置。它接受字符串类型值，默认值为“左”。
...
**示例:**以下示例说明了 jQWidgets 中的 jqxDateTimeInput*textAlign*属性。
