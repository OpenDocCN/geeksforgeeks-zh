# jQWidgets jqxExpander 扩展事件

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxexpander-expanding-event/](https://www.geeksforgeeks.org/jqwidgets-jqxexpander-expanding-event/)
...
**扩展事件用于在 `jqxExpander` 小部件将要被扩展时触发。**

## 语法

```javascript
$('Selector').on('expanding', function () { });
```
...
下面的例子说明了 `jQWidgets` `jqxExpander` 扩展事件。
...
<body>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#jqxExp').on('expanding', function () {
                alert("Expander expanding");
            })
        });
    </script>
</body>
...
![](img/7e7d9206845ac8f6ddefd1c715fe3d25.png)
