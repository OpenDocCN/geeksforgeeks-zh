...
> 原文: `https://www.geeksforgeeks.org/jqwidgets-jqxgauge-lineargauge-rangesize-property/`
...
`rangeSize` 属性用于设置或返回 `rangeSize` 属性。即它用于设置或返回范围的大小。它接受数字/字符串类型值，默认值为 '5%'。
...
下面的示例说明了 `jQWidgets` 中的 `jqxLinearGauge` `rangeSize` 属性。
