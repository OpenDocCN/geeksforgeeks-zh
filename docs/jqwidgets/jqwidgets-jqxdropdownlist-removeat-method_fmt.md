...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-removeat-method/](https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-removeat-method/)
...
`removeAt()` 方法用于使用索引号从列表框中移除一个项目。它接受数字类型的单个参数 `index`，并且不返回任何值。索引从 0 开始。
...
下面的例子说明了 jQWidgets 中的 `jqxDropDownList` `removeAt()` 方法。
...
![](img/cea9296f572ad7c3af2980fd1263e3ab.png)
