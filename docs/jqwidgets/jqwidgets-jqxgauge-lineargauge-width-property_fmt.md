...
> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxgauge-lineargauge-width-property/](https://www.geeksforgeeks.org/jqwidgets-jqxgauge-lineargauge-width-property/)
...
**示例：** 下面的示例说明了 jQWidgets 中的 `jqxLinearGauge` **宽度**属性。
