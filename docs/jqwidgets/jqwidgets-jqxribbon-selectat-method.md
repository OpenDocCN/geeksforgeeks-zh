# jqwidgets jqxribon select at()方法

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxribbon-selectat-method/](https://www.geeksforgeeks.org/jqwidgets-jqxribbon-selectat-method/)
...
selectAt()方法用于选择给定索引的项目。它接受数字类型的单参数索引，不返回值。
