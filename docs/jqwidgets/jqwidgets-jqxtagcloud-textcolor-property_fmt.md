# jQWidgets jqxTagCloud textColor 属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxtagcloud-textcolor-property/](https://www.geeksforgeeks.org/jqwidgets-jqxtagcloud-textcolor-property/)
...
下面的示例说明了 jQWidgets `jqxTagCloud` `textColor` 属性。在下面的例子中，`textColor` 属性的值被设置为“红色”。
