# jQWidgets jqxsscheduler 任命能力属性

> 原文:[https://www . geeksforgeeks . org/jqwidgets-jqxscheduler-约会能力-属性/](https://www.geeksforgeeks.org/jqwidgets-jqxscheduler-appointmentopacity-property/)
...
***约会能力*** 属性用于设置或返回 **jqxScheduler** 中显示的约会的不透明度。它是布尔类型，默认值为*假*。
...
**示例:**下面的示例说明了 jQWidgets 中的 **jqxScheduler** *约会能力*属性。
