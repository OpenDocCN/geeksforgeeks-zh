...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxtagcloud-width-property/](https://www.geeksforgeeks.org/jqwidgets-jqxtagcloud-width-property/)
...
以下示例说明了 `jQWidgets` `jqxTagCloud` `宽度属性`。在下面的示例中，`宽度` 属性的值被设置为 450。
