...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxtree-getselecteditem-method/](https://www.geeksforgeeks.org/jqwidgets-jqxtree-getselecteditem-method/)
...
`getSelectedItem()`方法用于获取所选项目。它不接受任何参数，并返回对象类型值。
