# jQWidgets jqxScrollView 显示按钮属性

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxscrollview-show buttons-property/](https://www.geeksforgeeks.org/jqwidgets-jqxscrollview-showbuttons-property/)
...
**显示按钮属性**用于设置或返回导航按钮是否可见。它接受布尔类型值，默认值为真。
