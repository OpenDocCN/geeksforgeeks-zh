# jqwidgets jqxlist menu disabled property

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxlistmenu-disabled-property/](https://www.geeksforgeeks.org/jqwidgets-jqxlistmenu-disabled-property/)
...
**禁用属性**用于设置或返回禁用属性。它接受布尔类型值，默认值为 false。
