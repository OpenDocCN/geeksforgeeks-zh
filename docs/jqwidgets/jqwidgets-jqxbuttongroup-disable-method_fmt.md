...
> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxbuttongroup-disable-method/](https://www.geeksforgeeks.org/jqwidgets-jqxbuttongroup-disable-method/)
...
下面的示例说明了 jQWidgets 中的 `jqxButtonGroup` `disable()` 方法。
