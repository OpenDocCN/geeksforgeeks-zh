...
> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxscheduler-exportdata-method/](https://www.geeksforgeeks.org/jqwidgets-jqxscheduler-exportdata-method/)
...
## exportData()方法
`exportData()`方法用于将显示的 `jqxScheduler` 的数据导出到 Excel、ICS、XML、JSON、HTML、TSV 或 CSV。它不返回任何东西。
...
## 示例
下面的示例说明了 jQWidgets 中的 `jqxScheduler` `exportData()`方法。
