# jQWidgets jqxComboBox enableSelection 属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxcombobox-enableselection-property/](https://www.geeksforgeeks.org/jqwidgets-jqxcombobox-enableselection-property/)
...
`enableSelection` 属性用于设置或返回启用/禁用选择。它接受布尔类型值，默认值为 `true`。
...
![](img/a3c4406e42fdbbe6f8b1d846e65a8c32.png)
