...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxknob-destroy-method/](https://www.geeksforgeeks.org/jqwidgets-jqxknob-destroy-method/)
...
**示例:**下面的示例说明了 jQWidgets jqxKnob ***破坏()*** 的方法。
