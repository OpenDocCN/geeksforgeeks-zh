# jQWidgets jqxformatedinput 下拉属性

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxformatedinput-drop down-property/](https://www.geeksforgeeks.org/jqwidgets-jqxformattedinput-dropdown-property/)
...
**下拉属性**用于设置或返回下拉选项是否启用。此选项用于更改给定数字的基数。它接受布尔类型值，默认值为 false。
...
下面的例子说明了 jQWidgets jqxFormattedInput 下拉属性。
