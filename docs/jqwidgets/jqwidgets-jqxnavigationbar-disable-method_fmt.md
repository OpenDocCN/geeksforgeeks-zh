...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxnavigationbar-disable-method/](https://www.geeksforgeeks.org/jqwidgets-jqxnavigationbar-disable-method/)
...
下面的示例说明了 jQWidgets `jqxNavigationBar` `disable()` 方法。
