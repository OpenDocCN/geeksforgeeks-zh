...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxcombobox-clear-method/](https://www.geeksforgeeks.org/jqwidgets-jqxcombobox-clear-method/)
...
**示例:**下面的示例说明了 jQWidgets 中的 jqxComboBox **clear()** 方法。
...
            style="padding: 5px 20px" value="Clear All Items" />
    </center>
