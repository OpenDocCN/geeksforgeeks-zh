# jQWidgets jqxTagCloud minFontSize 属性

> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxtagcloud-minfontsize-property/](https://www.geeksforgeeks.org/jqwidgets-jqxtagcloud-minfontsize-property/)
...
下面的示例说明了 jQWidgets `jqxTagCloud` 的 `minFontSize` 属性。在下面的例子中，`minFontSize` 属性的值被设置为 25。
