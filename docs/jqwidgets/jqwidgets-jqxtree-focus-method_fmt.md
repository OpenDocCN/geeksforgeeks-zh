...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxtree-focus-method/](https://www.geeksforgeeks.org/jqwidgets-jqxtree-focus-method/)
...
`focus()`方法用于将焦点设置到小部件上。它不接受任何参数，也不返回值。
