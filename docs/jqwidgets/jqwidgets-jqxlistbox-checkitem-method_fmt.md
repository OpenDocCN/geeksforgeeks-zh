# jqxListBox checkItem() 方法

> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxlistbox-checkitem-method/](https://www.geeksforgeeks.org/jqwidgets-jqxlistbox-checkitem-method/)
...
这个示例说明了 `jQWidgets` 中的 `jqxListBox` `checkItem()` 方法。
