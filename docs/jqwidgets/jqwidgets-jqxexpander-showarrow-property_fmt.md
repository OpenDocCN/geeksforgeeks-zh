# jQWidgets jqxExpander showArrow 属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxexpander-showarrow-property/](https://www.geeksforgeeks.org/jqwidgets-jqxexpander-showarrow-property/)
...
`showArrow` 属性用于设置或返回表头的箭头是否显示。接受布尔类型值，默认值为 `true`。
