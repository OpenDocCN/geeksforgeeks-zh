...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxtabs-unselect-event/](https://www.geeksforgeeks.org/jqwidgets-jqxtabs-unselected-event/)
...
**未选择事件**用于用户选择标签时触发。触发此事件后，最后选择的选项卡变为未选择。
...
下面的例子说明了 jQWidgets jqxTabs 未选中事件。
