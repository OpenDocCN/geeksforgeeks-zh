# jQWidgets jqxTabs scrolnimationduration 属性

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxtabs-scrolnimationduration-property/](https://www.geeksforgeeks.org/jqwidgets-jqxtabs-scrollanimationduration-property/)
...
**滚动动画持续时间属性**用于设置或返回滚动动画的持续时间。它接受数字类型值，默认值为 250。
...
下面的例子说明了 jQWidgets jqxTabs scrolnimationduration 属性。
