...
> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxwindow-draggable-property/](https://www.geeksforgeeks.org/jqwidgets-jqxwindow-draggable-property/)

`jQWidgets` 是一个 JavaScript 框架，用于为 PC 和移动设备制作基于 web 的应用程序。它是一个非常强大、优化、独立于平台并且得到广泛支持的框架。`jqxWindow` 用于在应用程序中输入数据或查看信息。

`draggable` 属性用于设置或获取窗口是否可拖动。
...
以下示例说明了 `jQWidgets` 中的 `jqxWindow` `draggable` 属性。对于本例，`draggable` 设置为 `true`。
