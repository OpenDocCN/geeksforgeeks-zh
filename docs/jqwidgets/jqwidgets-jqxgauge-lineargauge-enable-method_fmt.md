# jQWidgets jqxGauge linear gauge enable()方法

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxgauge-lineargauge-enable-method/](https://www.geeksforgeeks.org/jqwidgets-jqxgauge-lineargauge-enable-method/)
...
`enable()`方法用于使能`jqxLinearGauge`元素。它不接受任何参数，也不返回值。
...
以下示例说明了 jQWidgets 中的 `jqxLinearGauge` `enable()`方法:
