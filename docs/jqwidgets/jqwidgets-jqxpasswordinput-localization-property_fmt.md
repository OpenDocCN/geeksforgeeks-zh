...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxpasswordinput-localization-property/](https://www.geeksforgeeks.org/jqwidgets-jqxpasswordinput-localization-property/)
...
`localization` 属性用于设置小部件中使用的各种文本值。它接受 `Object` 类型值。其默认值为：
...
下面的例子说明了 jQWidgets 中的 `jqxPasswordInput` `localization` 属性。
