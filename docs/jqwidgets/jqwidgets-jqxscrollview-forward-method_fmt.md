...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxscrollview-forward-method/](https://www.geeksforgeeks.org/jqwidgets-jqxscrollview-forward-method/)
...
`forward()` 方法用于导航到下一页。它不接受任何参数，也不返回值。
