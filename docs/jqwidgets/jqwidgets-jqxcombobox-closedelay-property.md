# jQWidgets jqxComboBox close delay 属性

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxcombobox-close delay-property/](https://www.geeksforgeeks.org/jqwidgets-jqxcombobox-closedelay-property/)
...
*关闭延迟*属性用于设置或返回“关闭”动画的延迟。它接受数字类型值，默认值为 400。
...
**示例:**下面的示例说明了 jQWidgets 中的 jqxComboBox *closeDelay* 属性。
