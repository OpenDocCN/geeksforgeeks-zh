...
> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxbuttongroup-buttonclick-event/](https://www.geeksforgeeks.org/jqwidgets-jqxbuttongroup-buttonclick-event/)
...
<html lang="en">
  ...
  <body>
    <center>
      ...
      <div id="jqxBG">
        <button style="padding: 6px 36px" id="l">1st</button>
        <button style="padding: 6px 36px" id="c">2nd</button>
        <button style="padding: 6px 36px" id="r">3rd</button>
      </div>
    </center>
