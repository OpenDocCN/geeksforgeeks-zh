...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxswitchbutton-check-method/](https://www.geeksforgeeks.org/jqwidgets-jqxswitchbutton-check-method/)
...
下面的示例说明了 `jQWidgets` 中的 `jqxSwitchButton` `check()` 方法。
