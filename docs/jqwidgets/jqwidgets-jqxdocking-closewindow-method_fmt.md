...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdocking-closewindow-method/](https://www.geeksforgeeks.org/jqwidgets-jqxdocking-closewindow-method/)
...
下面的示例说明了 jQWidgets `jqxDocking` `closeWindow()` 方法。在下面的例子中，一个 id 为 `"Second_Window"` 的窗口已经关闭。
