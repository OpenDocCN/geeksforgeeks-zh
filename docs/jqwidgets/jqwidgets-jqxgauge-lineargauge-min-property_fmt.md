...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxgauge-lineargauge-min-property/](https://www.geeksforgeeks.org/jqwidgets-jqxgauge-lineargauge-min-property/)
...
下面的示例说明了 jQWidgets 中的 `jqxLinearGauge` `min` 属性。
