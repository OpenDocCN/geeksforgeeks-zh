# jQWidgets jqxScheduler row sheight 属性

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxscheduler-rowsheight-property/](https://www.geeksforgeeks.org/jqwidgets-jqxscheduler-rowsheight-property/)
...
***行高度*** 属性用于设置或返回显示的 jqxScheduler 行的高度。它属于数字类型，默认值为 27。
...
**示例:**下面的示例说明了 jQWidgets 中的**jqxScheduler***row sheight*属性。
