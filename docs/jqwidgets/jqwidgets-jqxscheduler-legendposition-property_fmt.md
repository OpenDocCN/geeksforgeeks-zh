...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxscheduler-legendposition-property/](https://www.geeksforgeeks.org/jqwidgets-jqxscheduler-legendposition-property/)
...
`legendPosition` 属性用于设置或返回显示的 `jqxScheduler` 的 `legendPosition`。它属于字符串类型，默认情况下它的值是底部。
...
下面的示例说明了 jQWidgets 中的 `jqxScheduler` `legendPosition` 属性。
...
<body>
    <center>
        ...
        <h3>jQWidgets jqxScheduler legendPosition property</h3>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#jqxBtn").on("click", function () {
                var lp = $('#jqxs').jqxScheduler('legendPosition');
                $('#log').text("Legend position: " + lp);
            });
        });
    </script>
</body>
...
![](img/a8581e33b5790e1d23d75d5d03e60da9.png)
