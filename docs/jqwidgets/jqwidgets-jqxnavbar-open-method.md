...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxnavbar-open-method/](https://www.geeksforgeeks.org/jqwidgets-jqxnavbar-open-method/)
...
**打开()方法**用于在导航条最小化时打开弹出窗口。它不接受任何参数，也不返回值。
