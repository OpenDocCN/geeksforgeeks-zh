...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxslider-disabled-property/](https://www.geeksforgeeks.org/jqwidgets-jqxslider-disabled-property/)
...
**禁用属性**用于设置或返回滑块选项是否被禁用。它接受布尔类型值，默认值为 false。
...
下面的例子说明了 jQWidgets jqxSlider 禁用属性。
