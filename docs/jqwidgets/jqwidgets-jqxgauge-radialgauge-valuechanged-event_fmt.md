...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxgauge-radialgauge-valuechanged-event/](https://www.geeksforgeeks.org/jqwidgets-jqxgauge-radialgauge-valuechanged-event/)
...
**示例:** 以下示例说明了 jQWidgets 中的 `jqxRadialGauge` `valueChanged` 事件。
