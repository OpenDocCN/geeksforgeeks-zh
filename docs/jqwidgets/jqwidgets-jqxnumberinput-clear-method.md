# jQWidgets jqxnumber input clear()方法

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxnumber input-clear-method/](https://www.geeksforgeeks.org/jqwidgets-jqxnumberinput-clear-method/)
...
**清除()方法**用于清除小部件中的值。它不接受任何参数，也不返回值。

**语法:**

```html
$('Selector').jqxNumberInput('clear');
```
...
下面的例子说明了 jQWidgets jqxNumberInput clear()方法。
...
        <h3>
            jQWidgets jqxNumberInput clear() Method
        </h3>
...
![](img/32fcfcd7fee6cccc59c89ac1296b1769.png)
