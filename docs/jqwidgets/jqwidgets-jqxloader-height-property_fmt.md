# jQWidgets jqxLoader 高度属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxloader-height-property/](https://www.geeksforgeeks.org/jqwidgets-jqxloader-height-property/)
...
下面的例子说明了 jQWidgets `jqxLoader` 的`高度`属性。
