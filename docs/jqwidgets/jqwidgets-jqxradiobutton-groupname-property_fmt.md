# jQWidgets jqxRadioButton 组名属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxradiobutton-groupname-property/](https://www.geeksforgeeks.org/jqwidgets-jqxradiobutton-groupname-property/)
...
`groupName` 属性用于设置或返回组名。它接受字符串类型值，默认值为空`" "`。
...
下面的例子说明了 jQWidgets `jqxRadioButton` `groupName` 属性。
