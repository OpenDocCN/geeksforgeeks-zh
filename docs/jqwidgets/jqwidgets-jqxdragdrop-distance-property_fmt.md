...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdragdrop-distance-property/](https://www.geeksforgeeks.org/jqwidgets-jqxdragdrop-distance-property/)
...
`distance` 属性用于设置或返回拖动开始前光标通过所需的距离。它接受数字类型值，默认值为 5。
...
**示例:** 以下示例说明了 jQWidgets 中的 `jqxDragDrop` `distance` 属性。
...
**参考:** [https://www.jqwidgets.com/jquery-widgets-documentation/documentation/jqxdragdrop/jquery-dragdrop-api.htm](https://www.jqwidgets.com/jquery-widgets-documentation/documentation/jqxdragdrop/jquery-dragdrop-api.htm)