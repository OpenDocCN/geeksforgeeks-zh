# jqwidgets jqxpexprover animationary property
...
`animationOpenDelay`属性用于设置或获取显示指定的`jqxPopover`小部件的时间。其可能的值为“快速”、“慢速”，时间单位为毫秒(例如 1000)。
...
**示例:**以下示例说明了 jQWidgets `jqxPopover`的`animationOpenDelay`属性。在下面的例子中，`animationOpenDelay`属性的值被设置为“慢速”。
