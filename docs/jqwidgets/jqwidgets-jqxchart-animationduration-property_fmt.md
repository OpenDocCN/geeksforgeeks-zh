...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxchart-animationduration-property/](https://www.geeksforgeeks.org/jqwidgets-jqxchart-animationduration-property/)
...
以下示例说明了 jQWidgets 中的 `jqxChart` `animationDuration` 属性:
