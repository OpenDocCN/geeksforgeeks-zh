# jQWidgets jqxSlider value 属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxslider-value-property/](https://www.geeksforgeeks.org/jqwidgets-jqxslider-value-property/)
...
`value` 属性用于设置或返回滑块小部件的值。它接受数字/对象类型值，默认值为 `0`。
...
下面的示例说明了 jQWidgets `jqxSlider` `value` 属性。
