...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxscrollview-height-property/](https://www.geeksforgeeks.org/jqwidgets-jqxscrollview-height-property/)
...
`height` 属性用于设置或返回 `jqxScrollView` 小部件的高度。它接受数字/字符串类型的值，默认值为 320。
...
下面的示例说明了 jQWidgets 中的 `jqxScrollView` `height` 属性。
