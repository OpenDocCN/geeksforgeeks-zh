...
> 原文:[https://www . geeksforgeeks . org/jqwidgets-jqxtextarea-drop down width-property/](https://www.geeksforgeeks.org/jqwidgets-jqxtextarea-dropdownwidth-property/)
...
**下拉宽度属性**用于设置或返回 jqxTextArea 下拉(弹出)宽度。它接受数字/字符串类型的值，默认值为空。
