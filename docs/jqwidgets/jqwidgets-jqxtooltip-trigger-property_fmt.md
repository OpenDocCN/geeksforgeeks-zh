...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxtooltip-trigger-property/](https://www.geeksforgeeks.org/jqwidgets-jqxtooltip-trigger-property/)
...
`trigger` 属性用于设置或返回触发工具提示的方式。它接受字符串类型值，默认值为“悬停”。
...
以下示例说明了 `jQWidgets` `jqxTooltip` `trigger` 属性。
