...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxcalendar-readonly-property/](https://www.geeksforgeeks.org/jqwidgets-jqxcalendar-readonly-property/)
...
`readOnly` 属性用于设置或返回只读状态的日历。它接受布尔类型值，默认值为 `false`。
...
### 示例:
以下示例说明了 jQWidgets 中的 `jqxCalendar` `readOnly` 属性。
