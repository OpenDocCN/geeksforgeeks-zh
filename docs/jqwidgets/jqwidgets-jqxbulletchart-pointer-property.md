# jQWidgets jqxbullethart 指针属性

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxbullethart-pointer-property/](https://www.geeksforgeeks.org/jqwidgets-jqxbulletchart-pointer-property/)
...
*指针*属性用于设置或返回 bulletcharts 的指针。它接受对象类型值。
...
**示例:**下面的示例说明了 jQWidgets 中的 jqxBulletChart 指针属性。
