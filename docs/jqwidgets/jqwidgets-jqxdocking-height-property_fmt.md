# jQWidgets jqxDocking height 属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdocking-height-property/](https://www.geeksforgeeks.org/jqwidgets-jqxdocking-height-property/)
...
`height` 属性用于设置或获取指定 `jqxDocking` 的高度。
...
下面的示例说明了 jQWidgets `jqxDocking` `height` 属性。在下面的示例中，`height` 属性的值已设置为 140。
