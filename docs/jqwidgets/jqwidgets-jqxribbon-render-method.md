# jQWidgets jqxRibbon 渲染()方法

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxribbon-render-method/](https://www.geeksforgeeks.org/jqwidgets-jqxribbon-render-method/)
...
**render()** 方法用于在屏幕上渲染 jqxRibbon 小部件。它不接受任何参数，也不返回值。
...
**示例:**下面的示例说明了 jQWidgets jqxRibbon**render()**方法。
...
      <h3>jQWidgets jqxRibbon render() Method</h3>
    </center>
...
![](img/19d61afef6ee910567edb78fc9db21b3.png)
