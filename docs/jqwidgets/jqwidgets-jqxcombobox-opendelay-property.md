# jQWidgets jqxComboBox open delay 属性

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxcombobox-open delay-property/](https://www.geeksforgeeks.org/jqwidgets-jqxcombobox-opendelay-property/)
...
*打开延迟*属性用于设置或返回“打开”动画的延迟。它接受数字类型的值，默认值为 350。
...
**示例:**下面的示例说明了 jQWidgets 中的 jqxComboBox *openDelay* 属性。
