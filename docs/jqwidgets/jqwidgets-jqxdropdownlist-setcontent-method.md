...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxddropdownlist-set content-method/](https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-setcontent-method/)
...
**设置内容()方法**用于设置下拉列表的内容。它接受字符串类型的单参数**内容**，不返回值。
