...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxtabs-togglemode-property/](https://www.geeksforgeeks.org/jqwidgets-jqxtabs-togglemode-property/)
...
**toggleMode** 属性用于设置或返回用于切换不同选项卡的用户交互。它接受字符串类型值，默认值为 `"click"`。
...
下面的例子说明了 jQWidgets jqxTabs `toggleMode` 属性。
...
<body>
    <center>
        ...
        <h3>
            jQWidgets jqxTabs toggleMode Property
        </h3>
...
![](img/faf709538113444bd811a2b56969ebc6.png)
