...
> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxeditor-destroy-method/](https://www.geeksforgeeks.org/jqwidgets-jqxeditor-destroy-method/)
...
`destroy()`方法用于销毁`jqxEditor`小部件元素。它不接受任何参数，也不返回值。
...
### 链接文件：
从[https://www.jqwidgets.com/download/](https://www.jqwidgets.com/download/)链接下载`jQWidgets`。在HTML文件中，找到下载文件夹中的脚本文件：
```html
