...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxcombobox-search mode-property/](https://www.geeksforgeeks.org/jqwidgets-jqxcombobox-searchmode-property/)
...
**搜索模式属性**用于设置或返回项目搜索模式。当用户在编辑字段中键入内容时，此属性非常有用。它接受字符串类型值，默认值为“startswith”。
