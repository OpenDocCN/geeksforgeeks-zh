# jQWidgets jqxTree toggleMode 属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxtree-togglemode-property/](https://www.geeksforgeeks.org/jqwidgets-jqxtree-togglemode-property/)
...
`toggleMode` 属性用于设置或返回用于展开或折叠任何项目的用户交互。它接受字符串类型值及其默认值“dblclick”。
...
```html
$('selector').jqxTree({ toggleMode: 'dblclick' });
```
...
**示例:** 以下示例说明了 jQWidgets `jqxTree` 的 `toggleMode` 属性。
...
<body>
    ...
    <h3>
        jQWidgets jqxTree toggleMode Property
    </h3>
...
![](img/d28d5eff6c369defbeb1cb78f1955703.png)
