# jQWidgets jqxdropbdown 按钮动画类型属性

> 原文:[https://www . geeksforgeeks . org/jqwidgets-jqxddropdownbutton-animation type-property/](https://www.geeksforgeeks.org/jqwidgets-jqxdropdownbutton-animationtype-property/)
...
***动画类型*** 属性用于设置或获取要使用的动画样式。为字符串类型，默认值为*滑动*。
...
**示例:**下面的示例说明了 jQWidgets 中的 jqxdropdown button*animation type*属性。
