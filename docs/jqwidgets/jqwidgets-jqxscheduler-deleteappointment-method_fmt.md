...
> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxscheduler-deleteappointment-method/](https://www.geeksforgeeks.org/jqwidgets-jqxscheduler-deleteappointment-method/)
...
**deleteAppointment()方法**用于从显示的 jqxScheduler 中删除约会。它不返回任何东西。

## 语法

```html
$('#Selector').jqxScheduler('deleteAppointment', appointmenId);
```

## 参数

*   **appointmentId**：指定的约会 Id。它属于字符串类型。
...
下面的例子说明了 jqxScheduler **在 jQWidgets 中 deleteAppointment()方法**。
...
<body>
    <center>
        ...
        <h3>jQWidgets jqxScheduler deleteAppointment() method</h3>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#jqxBtn").on("click", function () {
                ...
                $('#log').text(
                  "C functions appointment is deleted!"
                );
            });
        });
    </script>
...
![](img/c9b598a50a0e819423796eb256d13d8d.png)

## 参考

[https://www.jqwidgets.com/jquery-widgets-documentation/documentation/jqxscheduler/jquery-scheduler-api.htm](https://www.jqwidgets.com/jquery-widgets-documentation/documentation/jqxscheduler/jquery-scheduler-api.htm)