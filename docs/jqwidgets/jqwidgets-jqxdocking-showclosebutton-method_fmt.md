...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdocking-showclosebutton-method/](https://www.geeksforgeeks.org/jqwidgets-jqxdocking-showclosebutton-method/)
...
以下示例说明了 `jQWidgets` `jqxDocking` `showCloseButton()` 方法。
