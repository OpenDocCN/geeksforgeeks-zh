...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxbutton-focus-method/](https://www.geeksforgeeks.org/jqwidgets-jqxbutton-focus-method/)
...
### 示例:
下面的示例说明了 `jQWidgets` 中的 `jqxButton` `focus()`方法。
