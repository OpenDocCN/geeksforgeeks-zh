# jQWidgets jqxExpander headerPosition 属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxexpander-headerposition-property/](https://www.geeksforgeeks.org/jqwidgets-jqxexpander-headerposition-property/)
...
`headerPosition` 属性用于设置或返回标题位置。它接受字符串类型值，默认值为 `"top"`。
...
下面的例子说明了 jQWidgets `jqxExpander` `headerPosition` 属性。
