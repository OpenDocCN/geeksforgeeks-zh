...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxchart-showlegend-property/](https://www.geeksforgeeks.org/jqwidgets-jqxchart-showlegend-property/)
...
以下示例说明了 `jqxChart` 在 `jQWidgets` 中显示图例属性。
