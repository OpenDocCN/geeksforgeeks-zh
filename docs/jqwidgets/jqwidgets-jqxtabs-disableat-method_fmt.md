...
> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxtabs-disableat-method/](https://www.geeksforgeeks.org/jqwidgets-jqxtabs-disableat-method/)
...
`disableAt()` 方法用于禁用给定索引的标签。它接受数字类型的单参数 `index`。索引从 0 开始。它不返回值。
...
下面的例子说明了 jQWidgets jqxTabs `disableAt()` 方法。
...
<body>
    <center>
        ...
        <h3>
            jQWidgets jqxTabs disableAt() Method
        </h3>
        ...
        <input id="jqxBtn" type="button" value="Disable 3rd index Tabs" 
...
![](img/180e502608f669bf115f9c547e6c8f1f.png)
