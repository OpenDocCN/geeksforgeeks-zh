...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxwindow-expand-event/](https://www.geeksforgeeks.org/jqwidgets-jqxwindow-expand-event/)
...
**示例:** 以下示例说明了 jQWidgets 中的 jqxWindow `展开事件`。
