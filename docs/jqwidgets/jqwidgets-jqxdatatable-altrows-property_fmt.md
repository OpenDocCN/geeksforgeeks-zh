...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdatatable-altrows-property/](https://www.geeksforgeeks.org/jqwidgets-jqxdatatable-altrows-property/)
...
下面的示例说明了 `jQWidgets` 的 `altRows` 属性。在下面的例子中，`altRows` 属性的值被设置为“真”。
