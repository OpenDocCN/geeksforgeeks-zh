# jQWidgets jqxTabs gettitlete()方法

> 原文:[https://www . geeksforgeeks . org/jqwidgets-jqxtabs-gettitlete-method/](https://www.geeksforgeeks.org/jqwidgets-jqxtabs-gettitleat-method/)
...
**gettitlete()方法**用于获取一个 Tab 的标题。它接受数字类型的单参数索引。索引从 0 开始。它返回字符串类型值。
