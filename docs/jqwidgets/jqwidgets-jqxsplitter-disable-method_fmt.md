...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxsplitter-disable-method/](https://www.geeksforgeeks.org/jqwidgets-jqxsplitter-disable-method/)
...
**示例:** 下面的示例说明了`jQWidgets` `jqxSplitter`的`disable()`方法。
