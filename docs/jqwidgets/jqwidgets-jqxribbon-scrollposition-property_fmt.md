...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxribbon-scrollposition-property/](https://www.geeksforgeeks.org/jqwidgets-jqxribbon-scrollposition-property/)
...
下面的例子说明了 jQWidgets `jqxRibbon` `scrollPosition` 属性。
