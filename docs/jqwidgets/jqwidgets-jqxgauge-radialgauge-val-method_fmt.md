...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxgauge-radialgauge-val-method/](https://www.geeksforgeeks.org/jqwidgets-jqxgauge-radialgauge-val-method/)
...
`val()`方法用于设置 `jqxGauge` 元素的值。它不返回任何值，并将包含这些值的对象作为参数。
