...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxpopover-close-event/](https://www.geeksforgeeks.org/jqwidgets-jqxpopover-close-event/)
...
当指定的 jqxPopover 小部件关闭时，会触发**关闭事件。**
...
****示例:**以下示例说明了 jQWidgets jqxPopover***close***事件。**
