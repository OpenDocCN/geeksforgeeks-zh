...
> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxgauge-radialgauge-ticksminor-property/](https://www.geeksforgeeks.org/jqwidgets-jqxgauge-radialgauge-ticksminor-property/)
...
`ticksMinor` 属性用于设置或返回 `ticksMinor` 属性，即用于设置或获取 `jqxGauge` 元素的次要刻度的属性。它接受一个对象值，默认值为 `{ size: '10%', interval: 5, style: { stroke: '#898989' }, visible: true }`。
