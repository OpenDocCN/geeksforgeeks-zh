# jQWidgets jqxTagCloud valueMember 属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxtagcloud-valuemember-property/](https://www.geeksforgeeks.org/jqwidgets-jqxtagcloud-valuemember-property/)
...
以下示例说明了 `jQWidgets` `jqxTagCloud` `valueMember` 属性。在以下示例中，`valueMember` 属性的值已设置为 `'Rating'`。
