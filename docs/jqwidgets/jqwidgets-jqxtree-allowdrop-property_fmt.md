# jQWidgets jqxTree allowDrop 属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxtree-allowdrop-property/](https://www.geeksforgeeks.org/jqwidgets-jqxtree-allowdrop-property/)
...
## allowDrop 属性
`allowDrop` 属性用于启用或禁用小部件的拖放选项。它接受布尔类型值，默认值为 `false`。
...
## 输出
![](img/5f91f867825474679a14c1cb71f55111.png)
