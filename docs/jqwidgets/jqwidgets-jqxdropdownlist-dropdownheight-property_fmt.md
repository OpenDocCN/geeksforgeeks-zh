# jQWidgets jqxDropDownList dropDownHeight 属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-dropdownheight-property/](https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-dropdownheight-property/)
...
`dropDownHeight` 属性用于设置或返回 `jqxDropDownList` 的列表框的高度。它接受数字类型值，默认值为 200。
...
下面的例子说明了 jQWidgets 中的 `jqxDropDownList` `dropDownHeight` 属性。
...
![](img/268ddf45407b0a009551d999f164fda0.png)
