# jQWidgets jqxDropDownList dropDownWidth 属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-dropdownwidth-property/](https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-dropdownwidth-property/)
...
`dropDownWidth` 属性用于设置或返回 `jqxDropDownList` 列表框的宽度。它接受数字类型值，默认值为 200。
...
下面的例子说明了 jQWidgets 中的 `jqxDropDownList` `dropDownWidth` 属性。
...
![](img/be66656f25f646ebe1d7502c0c5364bf.png)
