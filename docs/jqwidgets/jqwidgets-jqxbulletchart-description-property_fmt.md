...
> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxbulletchart-description-property/](https://www.geeksforgeeks.org/jqwidgets-jqxbulletchart-description-property/)
...
`description` 属性用于设置或返回项目符号图描述。它接受字符串类型值，默认值为“描述”。
...
下面的示例说明了 jQWidgets 中的 `jqxBulletChart` `description` 属性。
...
<body>
    <center>
        ...
        <h3>
            jQWidgets jqxBulletChart description Property
        </h3>
        <div id="gfg"></div>
    </center>
...
![](img/1e06430a82bba020ba823d2336b32bc4.png)
