# jQWidgets jqxTextArea 高度属性

> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxtextarea-height-property/](https://www.geeksforgeeks.org/jqwidgets-jqxtextarea-height-property/)
...
`height` 属性用于设置或返回 `jqxTextArea` 的高度。它接受字符串/数字类型的值，默认值为空。
...
以下示例说明了 jQWidgets `jqxTextArea` `height` 属性。
...
<body>
    <center>
        ...
        <h3>
            jQWidgets jqxTextArea height Property
        </h3>
...
![](img/c4586179747c3aa7328e9abf5cbdd94c.png)
