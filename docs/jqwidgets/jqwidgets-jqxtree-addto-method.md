...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxtree-addto-method/](https://www.geeksforgeeks.org/jqwidgets-jqxtree-addto-method/)
...
**addTo()方法**用于添加一个项目。它接受两个参数，第一个是对象类型的项目，第二个是项目的 id。它不返回值。
