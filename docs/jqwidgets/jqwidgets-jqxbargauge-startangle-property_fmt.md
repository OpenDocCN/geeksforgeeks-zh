...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxbargauge-startangle-property/](https://www.geeksforgeeks.org/jqwidgets-jqxbargauge-startangle-property/)
...
`startAngle` 属性用于设置棒线规的 **开始角度**。默认值为 **225**。
