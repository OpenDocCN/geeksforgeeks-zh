...
> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxcalendar-setmaxdate-property/](https://www.geeksforgeeks.org/jqwidgets-jqxcalendar-setmaxdate-property/)
...
`setMaxDate` 属性用于设置或返回最大导航日期。它接受日期类型值，默认值为“2100，1，1”。
...
以下示例说明了 `jQWidgets` 中的 `jqxCalendar` `setMaxDate` 属性。
...
<body>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#jqxcal').jqxCalendar('setMaxDate', new Date(2025, 0, 1));
        });
    </script>
</body>
