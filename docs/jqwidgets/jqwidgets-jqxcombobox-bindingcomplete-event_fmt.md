...
> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxcombobox-bindingcomplete-event/](https://www.geeksforgeeks.org/jqwidgets-jqxcombobox-bindingcomplete-event/)
...
`bindingComplete` 事件用于在数据绑定操作完成时触发。
...
以下示例说明了 jQWidgets 中的 `jqxComboBox` `bindingComplete` 事件：
...
<body>
    <center>
        ...
        <h3>
            jQWidgets jqxComboBox bindingComplete Event
        </h3>
        <div id='jqxCB'></div>
    </center>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $("#jqxCB").on('bindingComplete', function (event) {
...
![](img/3852c4f4387165195fffb1cd76ed81be.png)
