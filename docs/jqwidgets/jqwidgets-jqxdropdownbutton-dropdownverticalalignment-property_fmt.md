# jQWidgets jqxDropDownButton dropDownVerticalAlignment 属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdropdownbutton-dropdownverticalalignment-property/](https://www.geeksforgeeks.org/jqwidgets-jqxdropdownbutton-dropdownverticalalignment-property/)
...
`dropDownVerticalAlignment` 属性用于设置或获取显示的下拉按钮的对齐。类型为字符串，默认值为 `bottom`。
...
获取 `dropDownVerticalAlignment` 属性。
...
以下示例说明了 jQWidgets 中的 `jqxDropDownButton` 的 `dropDownVerticalAlignment` 属性。
...
<html lang="en">
  ...
  <body>
    <center>
      ...
      <h3>jQWidgets jqxDropDownButton dropDownVerticalAlignment property</h3>
      <br />
