# jQWidgets jqxTabs 未选中事件

> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxtabs-unselected-event/](https://www.geeksforgeeks.org/jqwidgets-jqxtabs-unselected-event/)
...
`unselected` 事件用于用户选择标签时触发。触发此事件后，最后选择的选项卡变为未选择。

**语法：**

```javascript
$('Selector').on('unselected', function (event) { });
```
...
下面的例子说明了 jQWidgets `jqxTabs` `unselected` 事件。
...
<body>
    <center>
        ...
        <h3>
            jQWidgets jqxTabs unselected Event
        </h3>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#jqxTabs').on('unselected', function (event) {
                alert('Unselected event triggered');
            });
        });
    </script>
</body>
...
![](img/953ea1caca2a1d455d17a13ec7149e0c.png)
