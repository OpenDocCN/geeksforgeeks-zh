# jQWidgets jqxDropDownButton open delay 属性

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxdropdownbutton-open delay-property/](https://www.geeksforgeeks.org/jqwidgets-jqxdropdownbutton-opendelay-property/)
...
**打开延迟**属性用于设置或获取显示的下拉按钮的打开动画的延迟。它属于数字类型，默认值为 350。
...
**示例:**下面的示例说明了 jQWidgets 中的 jqxDropDownButton*open delay*属性。
