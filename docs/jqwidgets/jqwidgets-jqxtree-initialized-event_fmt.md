# jQWidgets jqxTree 初始化事件

> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxtree-initialized-event/](https://www.geeksforgeeks.org/jqwidgets-jqxtree-initialized-event/)
...
**初始化事件**用于在创建并初始化 `jqxTree` 小部件时触发。

**语法：**

```javascript
$('Selector').on('initialized', function (event) {  });
```
...
下面的例子说明了 jQWidgets `jqxTree` 初始化事件。
...
<body>
    ...
    <h3>
        jQWidgets jqxTree initialized Event
    </h3>
...
![](img/5e4efe6ea3d541e4cd6dc706b1193832.png)
