# jQWidgets jqxTabs disablet()方法

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxtabs-disablet-method/](https://www.geeksforgeeks.org/jqwidgets-jqxtabs-disableat-method/)
...
**disable()方法**用于禁用给定索引的标签。它接受数字类型的单参数索引。索引从 0 开始。它不返回值。
