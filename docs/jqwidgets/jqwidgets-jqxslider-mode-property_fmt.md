# jQWidgets jqxSlider `mode` 属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxslider-mode-property/](https://www.geeksforgeeks.org/jqwidgets-jqxslider-mode-property/)
...
`mode` 属性用于设置或返回滑块小部件的模式。它接受字符串类型的值，默认值是“默认值”。
...
下面的例子说明了 jQWidgets jqxSlider `mode` 属性。
