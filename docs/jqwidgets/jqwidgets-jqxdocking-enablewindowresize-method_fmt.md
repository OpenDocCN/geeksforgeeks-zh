...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdocking-enablewindowresize-method/](https://www.geeksforgeeks.org/jqwidgets-jqxdocking-enablewindowresize-method/)
...
下面的示例说明了 `jQWidgets` `jqxDocking` `enableWindowResize()` 方法。
