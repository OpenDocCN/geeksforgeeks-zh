...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxribbon-enableat-method/](https://www.geeksforgeeks.org/jqwidgets-jqxribbon-enableat-method/)
...
**enableAt()** 方法用于通过使用索引号来启用禁用的项目。它接受单个参数 `index`，该参数为数字类型，不返回值。
