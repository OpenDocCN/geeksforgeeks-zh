...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxtree-refresh-method/](https://www.geeksforgeeks.org/jqwidgets-jqxtree-refresh-method/)
...
`refresh()`方法用于刷新 `jqxTree` 小部件。它不接受任何参数，也不返回值。
