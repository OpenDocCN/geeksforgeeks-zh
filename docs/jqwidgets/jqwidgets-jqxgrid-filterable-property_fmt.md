# jQWidgets jqxGrid 可过滤属性

> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxgrid-filterable-property/](https://www.geeksforgeeks.org/jqwidgets-jqxgrid-filterable-property/)

**jQWidgets** 是一个 JavaScript 框架，用于为 PC 和移动设备制作基于 web 的应用程序。它是一个非常强大、优化、独立于平台并且得到广泛支持的框架。`jqxGrid` 用于说明以表格形式显示数据的 jQuery 小部件。此外，它完全支持与数据的连接，以及分页、分组、排序、过滤和编辑。

**可过滤属性**用于启用或禁用显示的 `jqxGrid` 的过滤属性。如果该属性值为真，则网格的过滤面板将显示在列弹出菜单中。它是布尔类型，默认值为 `false`。
...
以下示例说明了 jQWidgets 中的 `jqxGrid` **可过滤**属性。
...
<body>
    <center>
        ...
        <h3>jQWidgets jqxGrid filterable property</h3>
        <br />
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#jqxBtn").on("click", function () {
                var f = $('#jqxg').jqxGrid('filterable');
                $('#log').text("Filterable: " + f);
            });
        });
    </script>
</body>
...
![](img/6e3b49311980e15dd2137e64429c3ec1.png)
