...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxlistbox-dragend-property/](https://www.geeksforgeeks.org/jqwidgets-jqxlistbox-dragend-property/)
...
以下示例说明了 `jQWidgets` 中的 `jqxListBox` `dragEnd` 属性。
