...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxgrid-endupdate-method/](https://www.geeksforgeeks.org/jqwidgets-jqxgrid-endupdate-method/)
...
### 示例:
下面的示例说明了 `jQWidgets` 中的 `jqxGrid` `endupdate()`方法。
