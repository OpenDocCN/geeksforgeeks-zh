# jQWidgets jqxGrid verticalscrollbarlargestep 属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxgrid-verticalscrollbarlargestep-property/](https://www.geeksforgeeks.org/jqwidgets-jqxgrid-verticalscrollbarlargestep-property/)

`jQWidgets` 是一个 JavaScript 框架，用于为 PC 和移动设备制作基于 web 的应用程序。它是一个非常强大、优化、独立于平台并且得到广泛支持的框架。`jqxGrid` 用于说明以表格形式显示数据的 jQuery 小部件。此外，它完全支持与数据的连接，以及分页、分组、排序、过滤和编辑。

`verticalscrollbarlargestep` 属性用于设置或获取滚动条的大步长。此外，该属性定义了每当用户点击滚动条的大拇指上方或下方的部分时修改垂直滚动条的值的步骤。它是数字类型，默认值为 400。

## 语法

*   设置 `verticalscrollbarlargestep` 属性。
...
*   返回 `verticalscrollbarlargestep` 属性。
...
以下示例说明了 `jQWidgets` 中的 `jqxGrid` `verticalscrollbarlargestep` 属性。
...
<body>
    <center>
        ...
        <h3>jQWidgets jqxGrid verticalscrollbarlargestep property</h3>
        <br />
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#jqxg").jqxGrid({
                ...
                sortable: true,
                theme: 'energyblue',
                verticalscrollbarlargestep: 1000,
                height: "260px",
                width: "250px",
                columns: [
                    {
            ...
            $("#jqxBtn").on("click", function () {
                var vsls = $('#jqxg').jqxGrid('verticalscrollbarlargestep');
                $('#log').text("Steps: " + vsls);
            });
        });
    </script>
...
![](img/3800a5970e0e736d4e4e9f41cd4b118e.png)
