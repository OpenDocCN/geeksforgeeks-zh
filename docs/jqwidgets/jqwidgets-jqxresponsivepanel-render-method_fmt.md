...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxresponsivepanel-render-method/](https://www.geeksforgeeks.org/jqwidgets-jqxresponsivepanel-render-method/)
...
`render()` 方法用于在屏幕上渲染小部件。它不接受任何参数，也不返回值。
...
下面的例子说明了 jQWidgets 中的 `jqxResponsivePanel` `render()` 方法。
...
![](img/c6706bf15b4dba75cb31e205ad7ba49b.png)
