...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxsortable-activate-event/](https://www.geeksforgeeks.org/jqwidgets-jqxsortable-activate-event/)
...
以下示例说明了 `jQWidgets` 中的 `jqxSortable` `activate` 事件。
