# jQWidgets jqxComplexInput 变更事件

> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxcomplexinput-change-event/](https://www.geeksforgeeks.org/jqwidgets-jqxcomplexinput-change-event/)
...
以下示例说明了 jQWidgets `jqxComplexInput` 更改事件。
...
<body>
    <center>
        ...
        <h3>
            jQWidgets jqxComplexInput change Event
        </h3>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $("#jqxCI").on("change", function (event) {
                alert("Value changed");
            });
        });
    </script>
...
![](img/1f74b64e1f8d1b2c2dbcd6fbbaf36d57.png)
