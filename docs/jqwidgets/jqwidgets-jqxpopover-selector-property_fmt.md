...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxpopover-selector-property/](https://www.geeksforgeeks.org/jqwidgets-jqxpopover-selector-property/)
...
`selector` 属性用于设置或获取指定 `jqxPopover` 小部件的选择器。选择器是显示弹出窗口的元素。
...
以下示例说明了 jQWidgets jqxPopover `selector` 属性。在下面的例子中，`selector` 属性的值被设置为 `$("#button_for_Popover")`。
...
[https://www.jqwidgets.com/jquery-widgets-documentation/documentation/jqxpopover/jquery-popover-api.htm](https://www.jqwidgets.com/jquery-widgets-documentation/documentation/jqxpopover/jquery-popover-api.htm?search=)