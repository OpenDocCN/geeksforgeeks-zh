...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxcombobox-template-property/](https://www.geeksforgeeks.org/jqwidgets-jqxcombobox-template-property/)
...
**模板属性**用于设置或返回按钮的模板，作为默认样式的替代。它接受字符串类型值，其默认值为“default”。
...
以下示例说明了 jQWidgets 中的 jqxComboBox 模板属性:
