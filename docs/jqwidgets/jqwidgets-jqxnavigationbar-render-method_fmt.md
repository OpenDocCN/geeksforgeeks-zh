...
> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxnavigationbar-render-method/](https://www.geeksforgeeks.org/jqwidgets-jqxnavigationbar-render-method/)
...
下面的示例说明了 `jQWidgets` `jqxNavigationBar` `render()` 方法。在下面的示例中，前面第 0 个项目被禁用，但是 `render()` 方法将其渲染到其原始导航栏。
