# jQWidgets jqxGrid showheader 属性

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxgrid-show header-property/](https://www.geeksforgeeks.org/jqwidgets-jqxgrid-showheader-property/)
...
**showheader 属性**用于显示或隐藏显示的 jqxGrid 中的列标题。它属于布尔类型，其缺省值为真。
...
下面的例子说明了 jQWidgets 中的 jqxGrid showheader 属性。
...
                var sh = $('#jqxg').jqxGrid('showheader');
                $('#log').text("Columns header is visible: " + sh);
            });
        });
    </script>
</body>
...
![](img/5ce5ac8ca1b846c1aa9b57e07a9b1447.png)
