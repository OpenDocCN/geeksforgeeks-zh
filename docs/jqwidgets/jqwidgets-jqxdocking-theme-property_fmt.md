# jQWidgets jqxDocking 主题属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdocking-theme-property/](https://www.geeksforgeeks.org/jqwidgets-jqxdocking-theme-property/)
...
`theme` 属性用于设置或获取指定 `jqxDocking` 的主题。
...
以下示例说明了 `jQWidgets` `theme` 属性。在以下示例中，`theme` 属性的值已设置为 `'energyblue'`。
