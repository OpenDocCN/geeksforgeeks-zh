# jQWidgets jqxbullethart bar size 属性

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxbullethart-bar size-property/](https://www.geeksforgeeks.org/jqwidgets-jqxbulletchart-barsize-property/)
...
*条形图大小*属性用于设置或返回项目符号图表的条形图大小。它接受数组类型值，默认值为 50%。
...
**示例:**下面的示例说明了 jQWidgets 中的 jqxbullethart*bar size*属性。
