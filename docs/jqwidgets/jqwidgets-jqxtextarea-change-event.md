# jQWidgets jqxTextArea 变更事件

> 原文:[https://www . geeksforgeeks . org/jqwidgets-jqxtextarea-change-event/](https://www.geeksforgeeks.org/jqwidgets-jqxtextarea-change-event/)
...
当文本区域值改变时，触发 jqxTextArea *改变*事件。
...
**示例:**以下示例说明了 jQWidgets jqxTextArea *变更*事件。
...
        <h3>
            jQWidgets jqxTextArea change Event
        </h3>
...
            $('#jqxTA').on('change', function() {
                alert("Textarea value changed");
            });
        });
    </script>
</body>
...
![](img/9c9bd14a82c04cf0bd8bb12b5c75e67e.png)
