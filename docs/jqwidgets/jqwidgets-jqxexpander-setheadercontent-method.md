# jqwidgets jqxeexpander setheader content()方法

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxexpander-setheadercontent-method/](https://www.geeksforgeeks.org/jqwidgets-jqxexpander-setheadercontent-method/)
...
**setHeaderContent()方法**用于将特定内容设置到扩展头。它接受字符串类型的单参数头内容，并且不返回任何值。

**语法:**

```html
$('Selector').jqxExpander('setHeaderContent', 'headerContent');
```
...
下面的例子说明了 jQWidgets jqxExpander setHeaderContent()方法。
...
            value="Set Header Content of Expander" 
...
![](img/8b935809468477dd158764d5dd452751.png)
