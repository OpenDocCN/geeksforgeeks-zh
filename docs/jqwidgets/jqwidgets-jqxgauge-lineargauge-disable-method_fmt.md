...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxgauge-lineargauge-disable-method/](https://www.geeksforgeeks.org/jqwidgets-jqxgauge-lineargauge-disable-method/)
...
`disable()` 方法用于禁用 `jqxLinearGauge` 元素。它不接受任何参数，也不返回值。
