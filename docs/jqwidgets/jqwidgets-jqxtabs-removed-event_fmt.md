# jQWidgets jqxTabs 移除事件

> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxtabs-removed-event/](https://www.geeksforgeeks.org/jqwidgets-jqxtabs-removed-event/)
...
**移除事件**用于在从 `jqxTabs` 小部件中移除选项卡时触发。
...
下面的例子说明了 jQWidgets jqxTabs 移除事件。
...
<body>
    <center>
        ...
        <h3>
            jQWidgets jqxTabs removed Event
        </h3>
        <div id='jqxTabs'>
...
![](img/de202f88385307563d277f0eed9d7515.png)
