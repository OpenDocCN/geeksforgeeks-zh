# jQWidgets jqxScrollBar disabled 属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxscrollbar-disabled-property/](https://www.geeksforgeeks.org/jqwidgets-jqxscrollbar-disabled-property/)
...
以下示例说明了 jQWidgets jqxScrollBar `disabled` 属性。在以下示例中，`disabled` 属性的值已设置为 `true`。
...
[https://www.jqwidgets.com/jquery-widgets-documentation/documentation/jqxscrollbar/jquery-scrollbar-api.htm](https://www.jqwidgets.com/jquery-widgets-documentation/documentation/jqxscrollbar/jquery-scrollbar-api.htm)