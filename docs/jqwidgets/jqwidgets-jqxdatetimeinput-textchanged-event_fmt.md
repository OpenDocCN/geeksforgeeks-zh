# jQWidgets jqxDateTime 输入文本更改事件

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdatetimeinput-textchanged-event/](https://www.geeksforgeeks.org/jqwidgets-jqxdatetimeinput-textchanged-event/)
...
`textchanged` 事件用于在 `jqxDateTimeInput` 小部件的文本发生更改时触发。

**语法:**
```javascript
$('Selector').on('textchanged', function (event) {  });
```
...
**示例:** 以下示例说明了 `jQWidgets` 中的 `jqxDateTimeInput` `textchanged` 事件。
...
<body>
    <center>
        ...
        <h3>
            jQWidgets jqxDateTimeInput textchanged Event
        </h3>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#jqxDTI').on('textchanged', function (event) {
                alert("Textchanged event Triggered");
            });
        });
    </script>
</body>
...
**输出:**
![](img/660fe7a39f326d507b3bd57c66306167.png)
