# jQWidgets jqxTabs 崩溃事件

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxtabs-collapsed-event/](https://www.geeksforgeeks.org/jqwidgets-jqxtabs-collapsed-event/)
...
```javascript
$('Selector').on('collapsed', function (event) { });
```
...
下面的例子说明了 jQWidgets `jqxTabs` 折叠事件。
...
<body>
    <center>
        ...
        <h3>
            jQWidgets jqxTabs collapsed Event
        </h3>
...
![](img/5fe1367140962705238aeebd78557c19.png)
