# jQWidgets jqxformatedinput 值属性

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxformatedinput-value-property/](https://www.geeksforgeeks.org/jqwidgets-jqxformattedinput-value-property/)
...
下面的示例说明了 jQWidgets jqxFormattedInput 值属性。
