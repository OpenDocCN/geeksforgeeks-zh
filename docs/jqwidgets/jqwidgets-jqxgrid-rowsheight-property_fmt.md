# jQWidgets jqxGrid rowsheight 属性

> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxgrid-rowsheight-property/](https://www.geeksforgeeks.org/jqwidgets-jqxgrid-rowsheight-property/)
...
<body>
    <center>
        ...
        <h3>jQWidgets jqxGrid rowsheight property</h3>
        <br />
        <div id="jqxg"></div>
        <div>
