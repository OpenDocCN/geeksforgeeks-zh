...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxcheckbox-locked-property/](https://www.geeksforgeeks.org/jqwidgets-jqxcheckbox-locked-property/)
...
`locked` 属性用于设置或返回复选框的锁定状态。在锁定状态下，不允许用户选中/取消选中复选框。它接受布尔类型值，默认值为 `false`。
...
以下示例说明了 jQWidgets 中的 `jqxCheckBox` `locked` 属性:
