# jQWidgets jqxKnob step 属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxknob-step-property/](https://www.geeksforgeeks.org/jqwidgets-jqxknob-step-property/)
...
**step 属性用于设置或获取指定 `jqxKnob` 的步长属性。它用于指定递增或递减步长。**
...
下面的示例说明了 `jQWidgets` `jqxKnob` `step` 属性。在下面的示例中，`step` 属性的值被设置为 5。
