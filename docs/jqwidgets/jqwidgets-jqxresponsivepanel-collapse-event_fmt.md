# jQWidgets jqxResponsivePanel 折叠事件

> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxresponsivepanel-collapse-event/](https://www.geeksforgeeks.org/jqwidgets-jqxresponsivepanel-collapse-event/)
...
`collapse` 事件用于当浏览器宽度变得小于折叠断点的值时触发。
...
以下示例说明了 jQWidgets 中的 `jqxResponsivePanel` `collapse` 事件。
