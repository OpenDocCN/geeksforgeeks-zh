# jQWidgets jqxPopover 宽度属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxpopover-width-property/](https://www.geeksforgeeks.org/jqwidgets-jqxpopover-width-property/)
...
以下示例说明了 jQWidgets jqxPopover `宽度`属性。在下面的示例中，`宽度`属性的值被设置为 180。
