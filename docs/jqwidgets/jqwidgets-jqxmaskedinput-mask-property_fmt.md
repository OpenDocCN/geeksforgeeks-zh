...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxmaskedinput-mask-property/](https://www.geeksforgeeks.org/jqwidgets-jqxmaskedinput-mask-property/)
...
`mask` 属性用于设置或返回屏蔽的输入字段。它接受字符串类型值，默认值为 `"# # # # # #"`。
...
以下示例说明了 jQWidgets `jqxMaskedInput` `mask` 属性。
