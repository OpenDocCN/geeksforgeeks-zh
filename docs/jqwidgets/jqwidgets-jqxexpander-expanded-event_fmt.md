...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxexpander-expanded-event/](https://www.geeksforgeeks.org/jqwidgets-jqxexpander-expanded-event/)
...
扩展事件用于在 `jqxExpander` 小部件扩展时触发。

语法:
```javascript
$('Selector').on('expanded', function () { });
```
...
### 输出
![](img/67e8f3f35afd48e9ba8cfbc429ab9da9.png)
