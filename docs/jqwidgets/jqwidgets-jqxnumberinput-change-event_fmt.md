# jQWidgets jqxNumberInput 变更事件

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxnumberinput-change-event/](https://www.geeksforgeeks.org/jqwidgets-jqxnumberinput-change-event/)
...
以下示例说明了 `jQWidgets` `jqxNumberInput` `change` 事件。
...
<body>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $("#jqxNumberInput").on('change', function() {
...
![](img/84c013fd741be7d6373ed22dcaf4dc26.png)
