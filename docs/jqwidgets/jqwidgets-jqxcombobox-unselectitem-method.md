# jQWidgets jqxComboBox unselect item()方法

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxcombobox-unselect item-method/](https://www.geeksforgeeks.org/jqwidgets-jqxcombobox-unselectitem-method/)
...
unselectItem()方法用于从 jqxComboBox 中取消选择该项。它接受对象/字符串类型的单个参数项，并且不返回值。
