...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdatetimeinput-showtimebutton-property/](https://www.geeksforgeeks.org/jqwidgets-jqxdatetimeinput-showtimebutton-property/)
...
`showTimeButton` 属性用于设置或返回时间按钮是否可见。它接受布尔类型值，默认值为 `false`。

**语法:**

设置 `showTimeButton` 属性。
```html
