...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxlistmenu-backlabel-property/](https://www.geeksforgeeks.org/jqwidgets-jqxlistmenu-backlabel-property/)
...
`backLabel` 属性用于设置或返回反向按钮标签。它接受字符串类型的值，默认值是“返回”。
