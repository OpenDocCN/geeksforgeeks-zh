# jQWidgets jqxTabs 滚动步长属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxtabs-scrollstep-property/](https://www.geeksforgeeks.org/jqwidgets-jqxtabs-scrollstep-property/)
...
**滚动步长属性**用于设置或返回滚动步长。它接受数字类型值，默认值为 `70`。
...
下面的例子说明了 jQWidgets `jqxTabs` `scrollStep` 属性。
...
<body>
    <center>
        ...
        <h3>
            jQWidgets jqxTabs scrollStep Property
        </h3>
...
![](img/b3c6c5dd78023ba73e231afe2c3ed1a8.png)
