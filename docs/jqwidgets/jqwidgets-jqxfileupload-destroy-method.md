# jQWidgets jqxFileUpload 销毁()方法

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxfileupload-destroy-method/](https://www.geeksforgeeks.org/jqwidgets-jqxfileupload-destroy-method/)
...
**销毁()**方法用于设置明确使用另一个按钮销毁文件的按钮。它不接受任何参数，也不返回值。
...
**示例:**下面的示例说明了 jQWidgets 中的 jqxFileUpload **destroy()** 方法。
