# jQWidgets jqxtreme expandItem()方法

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxtree-expanditem-method/](https://www.geeksforgeeks.org/jqwidgets-jqxtree-expanditem-method/)
...
**expandItem()方法**用于通过传递一个元素作为参数来扩展一个 jqxTree 小部件项。它接受对象类型的单个参数项，不返回任何值。
