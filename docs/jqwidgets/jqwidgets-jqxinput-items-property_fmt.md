...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxinput-items-property/](https://www.geeksforgeeks.org/jqwidgets-jqxinput-items-property/)
...
**示例:** 以下示例说明了 `jQWidgets` 中的 `jqxInput` `items` 属性。
