...
`getcellvaluebyid()`方法用于使用显示的 jqxGrid 中该行的 id 返回指定单元格的值。
...
下面的例子说明了 jQWidgets 中的 jqxGrid `getcellvaluebyid()`方法。
...
<body>
    <center>
        ...
        <h3>jQWidgets jqxGrid getcellvaluebyid()
            method
        </h3>
...
![](img/7b464508853ed52b4e5c3d7ec27d394d.png)
