# jQWidgets jqxScheduler 时区属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxscheduler-timezone-property/](https://www.geeksforgeeks.org/jqwidgets-jqxscheduler-timezone-property/)
...
`timeZone` 属性用于设置或返回显示的 `jqxScheduler` 的时区。它属于字符串类型。它没有默认值。
...
下面的示例说明了 jQWidgets 中的 `jqxScheduler` `timeZone` 属性。
