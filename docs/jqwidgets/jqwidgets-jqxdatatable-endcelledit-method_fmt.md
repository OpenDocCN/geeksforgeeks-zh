...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdatatable-endcelledit-method/](https://www.geeksforgeeks.org/jqwidgets-jqxdatatable-endcelledit-method/)
...
*   `rowIndex`: 这是单元格编辑将要结束的指定行。它的值从 0 开始。
*   `dataField`: 这是上面指定的将要结束的行的数据字段。它的值是字符串格式。
