# jQWidgets jqxDropDownList selectiitem()方法

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxddropdownlist-selectitem-method/](https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-selectitem-method/)
...
**选择项()方法**用于从列表框中选择一个项目。它接受对象类型的单参数**项**，不返回值。
...
下面的例子说明了 jQWidgets 中的 jqxDropDownList selectItem()方法。
...
![](img/04e33a8f0435e9f714e21e6ec00599d1.png)
