...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxtabs-toggle mode-property/](https://www.geeksforgeeks.org/jqwidgets-jqxtabs-togglemode-property/)
...
**切换模式属性**用于设置或返回用于切换不同选项卡的用户交互。它接受字符串类型值，默认值为“单击”。
