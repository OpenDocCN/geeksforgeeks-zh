# jQWidgets jqxDropDownList filter placeholder 属性

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxddropdownlist-filter placeholder-property/](https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-filterplaceholder-property/)
...
*过滤器占位符*属性用于设置或返回过滤器输入的占位符。它接受字符串类型值，默认值为“查找”。
...
**示例:**以下示例说明了 jQWidgets 中的 jqxDropDownList*filter placeholder*属性。
