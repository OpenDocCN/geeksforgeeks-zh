# jQWidgets jqxMenu popupZIndex 属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxmenu-popupzindex-property/](https://www.geeksforgeeks.org/jqwidgets-jqxmenu-popupzindex-property/)
...
下面的例子说明了 jQWidgets `jqxMenu` `popupZIndex` 属性。
...
![](img/43d08a2a8f66a094df38930380ee692e.png)
