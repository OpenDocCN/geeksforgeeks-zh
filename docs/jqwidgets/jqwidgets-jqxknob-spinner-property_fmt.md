# jQWidgets jqxKnob 微调器属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxknob-spinner-property/](https://www.geeksforgeeks.org/jqwidgets-jqxknob-spinner-property/)
...
`spinner` 属性用于设置或获取指定 `jqxKnob` 的微调器。
...
以下示例说明了 jQWidgets `jqxKnob` 的 `spinner` 属性。
