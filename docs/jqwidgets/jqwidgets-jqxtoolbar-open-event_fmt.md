...
> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxtoolbar-open-event/](https://www.geeksforgeeks.org/jqwidgets-jqxtoolbar-open-event/)
...
下面的例子说明了 jQWidgets 中的 `jqxToolBar` **open事件**。
...
<body>
    <center>
        ...
        <h3>jQWidgets jqxToolBar open event</h3>
