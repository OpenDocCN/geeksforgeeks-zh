...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdatetimeinput-showweeknumbers-property/](https://www.geeksforgeeks.org/jqwidgets-jqxdatetimeinput-showweeknumbers-property/)
...
`showWeekNumbers` 属性用于设置或返回值是否显示周数。它接受布尔类型值，默认值为 `true`。
