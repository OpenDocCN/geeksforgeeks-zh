...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxchart-titlepadding-property/](https://www.geeksforgeeks.org/jqwidgets-jqxchart-titlepadding-property/)
...
**标题填充属性**用于设置或返回标题填充属性。即该属性用于设置图表标题的填充。它接受填充类型值，默认值为 `{ left:2, top:2, right:2, bottom:2 }`。
...
下面的示例说明了 jQWidgets 中的 jqxChart **标题填充**属性。
