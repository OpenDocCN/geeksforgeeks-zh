...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxpopover-arrowoffsetvalue-property/](https://www.geeksforgeeks.org/jqwidgets-jqxpopover-arrowoffsetvalue-property/)
...
`arrowOffsetValue` 属性用于设置或获取箭头相对于指定 `jqxPopover` 默认位置的偏移。

## 语法

*   用于设置 `arrowOffsetValue` 属性。

```javascript
$('#jqxPopover').jqxPopover({arrowOffsetValue: 10});
```

*   获取 `arrowOffsetValue` 属性。
...
下面的示例说明了 jQWidgets `jqxPopover` `arrowOffsetValue` 属性。
...
[https://www.jqwidgets.com/jquery-widgets-documentation/documentation/jqxpopover/jquery-popover-api.htm?search=](https://www.jqwidgets.com/jquery-widgets-documentation/documentation/jqxpopover/jquery-popover-api.htm?search=)