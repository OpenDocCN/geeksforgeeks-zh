# jQWidgets jqxPopover 关闭事件

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxpopover-close-event/](https://www.geeksforgeeks.org/jqwidgets-jqxpopover-close-event/)
...
当指定的 `jqxPopover` 小部件关闭时，会触发 `close` 事件。
...
以下示例说明了 `jQWidgets` `jqxPopover` 的 `close` 事件。
...
![](img/ffad1c68459b98971167aade744efa5b.png)
