# jQWidgets jqxBarGauge values 属性

> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxbargauge-values-property/](https://www.geeksforgeeks.org/jqwidgets-jqxbargauge-values-property/)
...
`values` 属性用于设置或返回 BarGauge 的值数组。它接受字符串类型值，默认值为空数组 `[]`。
...
以下示例说明了 jQWidgets jqxBarGauge `values` 属性。
...
<body>
    <center>
        ...
        <h3>
            jQWidgets jqxBarGauge values Property
        </h3>
...
![](img/d28f5da6cac766a6a3ac730ce5e5dc87.png)
