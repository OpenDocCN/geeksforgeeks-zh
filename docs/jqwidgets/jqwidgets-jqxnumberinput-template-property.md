# jQWidgets jqxnumber 输入模板属性

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxnumberinput-template-property/](https://www.geeksforgeeks.org/jqwidgets-jqxnumberinput-template-property/)
...
下面的例子说明了 jQWidgets jqxNumberInput 模板属性。
