...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxslider-min-property/](https://www.geeksforgeeks.org/jqwidgets-jqxslider-min-property/)
...
**min 属性**用于设置或返回滑块小部件的最小值。它接受数字类型值，默认值为 0。
