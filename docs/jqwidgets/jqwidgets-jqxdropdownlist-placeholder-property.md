...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxddropdownlist-placeholder-property/](https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-placeholder-property/)
...
**示例:**以下示例说明了 jQWidgets 中的 jqxDropDownList *占位符*属性。
