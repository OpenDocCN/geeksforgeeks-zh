...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxnotification-showclosebutton-property/](https://www.geeksforgeeks.org/jqwidgets-jqxnotification-showclosebutton-property/)
...
以下示例说明了 jQWidgets 中的 `jqxNotification` `showCloseButton` 属性:
