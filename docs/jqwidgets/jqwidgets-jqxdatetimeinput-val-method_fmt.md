# jqwidget jqxdatetimeinput val()方法

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdatetimeinput-val-method/](https://www.geeksforgeeks.org/jqwidgets-jqxdatetimeinput-val-method/)
...
`val()` 方法用于设置或返回 `jqxDateTimeInput` 小部件的日期。它接受日期/字符串类型的单个参数日期，并返回日期类型值。
...
**示例:** 下面的示例说明了 `jQWidgets` 中的 `jqxDateTimeInput` `val()` 方法。
...
![](img/610f95aca36303e6947748cac5841952.png)
