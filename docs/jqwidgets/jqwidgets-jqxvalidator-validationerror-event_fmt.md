...
> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxvalidator-validationerror-event/](https://www.geeksforgeeks.org/jqwidgets-jqxvalidator-validationerror-event/)
...
当表单验证有一些错误时，会触发 `validationError` 事件。
...
**示例：** 以下示例说明了 `jQWidgets` 的 `validationError` 事件。
