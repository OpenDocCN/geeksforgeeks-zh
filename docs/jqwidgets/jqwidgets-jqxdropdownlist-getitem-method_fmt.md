...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-getitem-method/](https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-getitem-method/)
...
`getItem()`方法用于通过使用索引号来获取该项。它接受数字类型的单个参数`index`，并且不返回任何值。
