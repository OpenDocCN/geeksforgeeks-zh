...
> 原文:[https://www . geeksforgeeks . org/jqwidgets-jqxgauge-radial gage-width-property/](https://www.geeksforgeeks.org/jqwidgets-jqxgauge-radialgauge-width-property/)
...
**宽度属性**用于设置或返回宽度属性，即用于设置或获取 jqxGauge 元素的宽度。它接受一个数值，默认值为 350。
...
以下示例说明了 jQWidge **ts:** 中的 jqxGauge 宽度属性
