# jq 构件 jqxdatetimeinput allownulldate 属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdatetimeinput-allownulldate-property/](https://www.geeksforgeeks.org/jqwidgets-jqxdatetimeinput-allownulldate-property/)
...
`allowNullDate` 属性用于设置或返回是否允许空值作为输入值。它接受布尔类型值，默认值为真。
...
下面的例子说明了 jQWidgets 中的 `jqxDateTimeInput` `allowNullDate` 属性。
...
<body>
    <center>
        ...
        <h3>
            jQWidgets jqxDateTimeInput allowNullDate Property
        </h3>
...
![](img/35ca6afc524f6d26224c37d442ab7a5e.png)
