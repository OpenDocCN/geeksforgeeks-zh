...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxslider-focus-method/](https://www.geeksforgeeks.org/jqwidgets-jqxslider-focus-method/)
...
**焦点()方法**用于设置小部件的焦点。它不接受任何参数，也不返回值。
