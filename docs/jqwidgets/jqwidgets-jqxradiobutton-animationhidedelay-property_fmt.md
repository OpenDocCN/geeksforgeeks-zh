...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxradiobutton-animationhidedelay-property/](https://www.geeksforgeeks.org/jqwidgets-jqxradiobutton-animationhidedelay-property/)
...
当 `jqxRadioButton` 小部件将被取消选中时，`animationHideDelay` 属性用于设置或返回动画的隐藏延迟。它接受数字类型的值，默认值为 300。
...
下面的例子说明了 jQWidgets `jqxRadioButton` `animationHideDelay` 属性。
...
**参考:** [https://www.jqwidgets.com/jquery-widgets-documentation/documentation/jqxcheckandradio/jquery-radiobutton-getting-started.htm](https://www.jqwidgets.com/jquery-widgets-documentation/documentation/jqxcheckandradio/jquery-radiobutton-getting-started.htm)