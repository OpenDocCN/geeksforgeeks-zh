...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxtree-selectitem-method/](https://www.geeksforgeeks.org/jqwidgets-jqxtree-selectitem-method/)
...
**选择项()方法**用于选择一个项目。它接受对象类型的单个参数项，不返回任何值。
