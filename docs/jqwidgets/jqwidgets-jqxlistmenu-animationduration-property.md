...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxlistmenu-animation duration-property/](https://www.geeksforgeeks.org/jqwidgets-jqxlistmenu-animationduration-property/)
...
**动画持续时间属性**用于设置或返回以毫秒为单位的动画持续时间。它接受数字类型的值，默认值为 250。
