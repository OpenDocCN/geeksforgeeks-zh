...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdockpanel-height-property/](https://www.geeksforgeeks.org/jqwidgets-jqxdockpanel-height-property/)
...
`height` 属性用于设置或获取指定 `jqxDockPanel` 的高度。
...
以下示例说明了 jQWidgets jqxdockmpanel `height` 属性。在下面的示例中，`height` 属性的值被设置为 180。
