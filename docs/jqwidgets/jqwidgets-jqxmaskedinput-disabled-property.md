...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxmaskedinput-disabled-property/](https://www.geeksforgeeks.org/jqwidgets-jqxmaskedinput-disabled-property/)
...
**禁用属性**用于启用或禁用 jqxMaskedInput 小部件。它接受布尔类型值，默认值为 false。
...
下面的例子说明了 jQWidgets jqxMaskedInput 禁用属性。
