# jQWidgets jqxCalendar restrictedDates 属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxcalendar-restricteddates-property/](https://www.geeksforgeeks.org/jqwidgets-jqxcalendar-restricteddates-property/)
...
`restrictedDates` 属性用于设置或返回日历的限制日期。受限日期不可点击。它接受数组类型值，默认值为 `[]`。
...
**示例:** 下面的示例说明了 jQWidgets 中的 `jqxCalendar` `restrictedDates` 属性。
