...
**`position`** 属性用于设置或返回标签是位于“顶部”还是“底部”。它接受字符串类型值，默认值为 `"top"`。
...
从给定的链接 [https://www.jqwidgets.com/download/](https://www.jqwidgets.com/download/) 下载 jQWidgets。在 HTML 文件中，找到下载文件夹中的脚本文件并引用它们。

下面的例子说明了 jQWidgets `jqxTabs` `position` 属性。
