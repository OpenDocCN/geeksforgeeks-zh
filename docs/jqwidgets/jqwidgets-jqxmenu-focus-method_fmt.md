...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxmenu-focus-method/](https://www.geeksforgeeks.org/jqwidgets-jqxmenu-focus-method/)
...
`focus()`方法用于聚焦小部件。它不接受任何参数，也不返回值。
