...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxdatatable-endrowedit-method/](https://www.geeksforgeeks.org/jqwidgets-jqxdatatable-endrowedit-method/)
...
*   **行索引:**这是编辑将要结束的行索引。它的值从 0 开始。
*   **取消更改:**这是一个可选参数，其值为布尔值。如果其值为真，则取消更改。
