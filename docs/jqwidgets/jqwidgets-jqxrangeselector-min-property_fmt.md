# jqxRangeSelector min 属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxrangeselector-min-property/](https://www.geeksforgeeks.org/jqwidgets-jqxrangeselector-min-property/)
...
`min` 属性用于设置或返回范围选择器刻度的最小值。它接受数字/日期对象/日期字符串类型值，默认值为 0。
