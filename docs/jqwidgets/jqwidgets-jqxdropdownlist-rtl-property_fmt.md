...
> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-rtl-property/](https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-rtl-property/)
...
## 示例
下面的示例说明了 `jQWidgets` 中的 `jqxDropDownList` `rtl` 属性。
...
## 输出
![](img/ef86c6200b525884a9b05a50dcb07d51.png)
