...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdocking-hideallcollapsebuttons-method/](https://www.geeksforgeeks.org/jqwidgets-jqxdocking-hideallcollapsebuttons-method/)
...
`hideAllCollapseButtons()` 方法用于隐藏指定 jqxDocking 的所有窗口的折叠按钮。
...
**示例:** 下面的示例说明了 jQWidgets jqxDocking `hideAllCollapseButtons()` 方法。
