...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxdatetimeinput-min-property/](https://www.geeksforgeeks.org/jqwidgets-jqxdatetimeinput-min-property/)
...
**min 属性**用于设置或返回 jqxDateTimeInput 小部件的最小日期。它接受日期类型值，默认值为日期(1900，1，1)。
