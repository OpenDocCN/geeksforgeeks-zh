...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxslider-getvalue-method/](https://www.geeksforgeeks.org/jqwidgets-jqxslider-getvalue-method/)
...
`getValue()`方法用于获取小部件的值。它不接受任何参数，并返回一个数值。
