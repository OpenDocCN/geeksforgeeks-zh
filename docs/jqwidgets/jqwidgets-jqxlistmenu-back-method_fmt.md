...
> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxlistmenu-back-method/](https://www.geeksforgeeks.org/jqwidgets-jqxlistmenu-back-method/)
...
`back()`方法用于导航到上一页。它不接受任何参数，也不返回值。

**语法：**

```html
$("Selector").jqxListMenu('back');
```
...
下面的例子说明了 jQWidgets 中的 `jqxListMenu` `back()`方法。
...
<body>
    ...
    <h3>
        jQWidgets jqxListMenu back() Method
    </h3>
...
![](img/2a4ee72e2db7381fcdd2dc4868dbe509.png)

**参考：** [https://www.jqwidgets.com/jquery-widgets-documentation/documentation/jqxlistmenu/jquery-listmenu-api.htm](https://www.jqwidgets.com/jquery-widgets-documentation/documentation/jqxlistmenu/jquery-listmenu-api.htm)