...
> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxdatatable-removefilter-method/](https://www.geeksforgeeks.org/jqwidgets-jqxdatatable-removefilter-method/)
...
下面的例子说明了`jQWidgets`的`removeFilter()`方法。
