# jQWidgets jqxbullethart 高度属性

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxbullethart-height-property/](https://www.geeksforgeeks.org/jqwidgets-jqxbulletchart-height-property/)
...
下面的例子说明了 jQWidgets 中的 jqxbullethart*高度*属性。
