# jQWidgets jqxBulletChart pointer 属性

> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxbulletchart-pointer-property/](https://www.geeksforgeeks.org/jqwidgets-jqxbulletchart-pointer-property/)
...
`pointer` 属性用于设置或返回 bulletcharts 的指针。它接受对象类型值。
...
下面的示例说明了 jQWidgets 中的 `jqxBulletChart` `pointer` 属性。
...
<body>
    <center>
        ...
        <h3>
            jQWidgets jqxBulletChart pointer Property
        </h3>
        <div id="gfg"></div>
    </center>
...
![](img/6d2bf8b80b7b60a006304621970e674d.png)
