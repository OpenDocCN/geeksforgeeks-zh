...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxexpander-expand-method/](https://www.geeksforgeeks.org/jqwidgets-jqxexpander-expand-method/)
...
`expand()`方法用于扩展扩展器内容。它不接受任何参数，也不返回值。
