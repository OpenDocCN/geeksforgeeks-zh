...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxtabs-addlast-method/](https://www.geeksforgeeks.org/jqwidgets-jqxtabs-addlast-method/)
...
### addLast()方法
`addLast()` 方法用于添加结束位置的制表符。添加选项卡包含选项卡的标题和内容。该方法接受下面给出的两个参数：
*   **标签标题:** 接受新增标签的标题。
*   **标签内容:** 接受新增标签的内容。
...
下面的例子说明了 jQWidgets `jqxTabs` `addLast()` 方法。
...
### 输出
![](img/0e3cd0915c2b79522bdbcbf4c5dbd6e1.png)
