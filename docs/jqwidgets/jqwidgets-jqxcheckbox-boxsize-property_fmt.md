...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxcheckbox-boxsize-property/](https://www.geeksforgeeks.org/jqwidgets-jqxcheckbox-boxsize-property/)
...
`boxSize` 属性用于设置或返回复选框的大小。它接受字符串类型值，默认值为 `"13px"`。
