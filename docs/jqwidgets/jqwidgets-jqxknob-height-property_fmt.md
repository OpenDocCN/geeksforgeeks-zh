...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxknob-height-property/](https://www.geeksforgeeks.org/jqwidgets-jqxknob-height-property/)
...
以下示例说明了 jQWidgets jqxKnob `高度` 属性。在以下示例中，`高度` 属性的值已设置为 400。
