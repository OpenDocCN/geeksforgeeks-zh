...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxtree-ensurevisible-method/](https://www.geeksforgeeks.org/jqwidgets-jqxtree-ensurevisible-method/)
...
`ensureVisible()` 方法用于保证元素的可见性。它接受对象类型的单个参数 `item`，并且不返回值。
