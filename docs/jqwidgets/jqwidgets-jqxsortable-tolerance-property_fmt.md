...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxsortable-tolerance-property/](https://www.geeksforgeeks.org/jqwidgets-jqxsortable-tolerance-property/)
...
`tolerance` 属性用于在悬停其他项目时设置或返回测试模式。它接受字符串/函数类型值，默认值为“intersect”。
...
**示例:** 以下示例说明了 `jQWidgets` 中的 `jqxSortable` `tolerance` 属性。
