...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxswitchbutton-onlabel-property/](https://www.geeksforgeeks.org/jqwidgets-jqxswitchbutton-onlabel-property/)
...
## onLabel 属性
`onLabel` 属性用于设置或获取显示按钮被选中时显示的字符串。它属于字符串类型，默认值为“开”。
