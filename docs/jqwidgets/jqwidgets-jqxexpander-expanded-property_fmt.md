...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxexpander-expanded-property/](https://www.geeksforgeeks.org/jqwidgets-jqxexpander-expanded-property/)
...
`expanded` 属性用于设置或返回展开状态（折叠或展开）。它接受布尔类型值，默认值为 `true`。
