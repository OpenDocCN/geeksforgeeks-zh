# jQWidgets jqxDropDownList 复选框属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-checkboxes-property/](https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-checkboxes-property/)
...
`checkboxes` 属性用于设置或返回复选框是否显示在列表项旁边。它接受布尔类型值，默认值为 `false`。
...
## 输出
![](img/2e730df6b1e8b555e6c0394eec025d3b.png)
