...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxloader-close-method/](https://www.geeksforgeeks.org/jqwidgets-jqxloader-close-method/)
...
`close()`方法用于关闭当前装载机。它不接受任何参数，也不返回值。
