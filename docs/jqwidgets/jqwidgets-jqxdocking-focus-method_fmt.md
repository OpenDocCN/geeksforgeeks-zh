...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdocking-focus-method/](https://www.geeksforgeeks.org/jqwidgets-jqxdocking-focus-method/)
...
下面的示例说明了 jQWidgets `jqxDocking` `focus()` 方法。
