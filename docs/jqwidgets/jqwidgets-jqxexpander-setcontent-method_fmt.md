...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxexpander-setcontent-method/](https://www.geeksforgeeks.org/jqwidgets-jqxexpander-setcontent-method/)
...
`setContent()`方法用于设置扩展器小部件的内容。它接受字符串类型的单参数内容，不返回任何值。
