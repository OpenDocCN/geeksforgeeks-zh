...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxtoolbar-maxwidth-property/](https://www.geeksforgeeks.org/jqwidgets-jqxtoolbar-maxwidth-property/)
...
***【最大宽度】*** 属性用于设置或返回显示的 **jqxToolBar** 的最大宽度。类型为数字或字符串，默认值为 *null* 。
...
**示例:**下面的示例说明了 jQWidgets 中的 jqxToolBar *maxWidth* 属性。
