...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxtagcloud-hideitem-method/](https://www.geeksforgeeks.org/jqwidgets-jqxtagcloud-hideitem-method/)
...
`hideItem()` 方法用于隐藏具有指定 `jqxTagCloud` 的特定索引的元素。
...
下面的示例说明了 jQWidgets `hideItem()` 的方法。在下面的示例中，具有第一个索引的项目被隐藏。
