...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxribbon-height-property/](https://www.geeksforgeeks.org/jqwidgets-jqxribbon-height-property/)
...
以下示例说明了 `jQWidgets` `jqxRibbon` `height` 属性。
