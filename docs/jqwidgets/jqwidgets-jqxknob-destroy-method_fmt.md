# jQWidgets jqxKnob 销毁()方法

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxknob-destroy-method/](https://www.geeksforgeeks.org/jqwidgets-jqxknob-destroy-method/)
...
下面的示例说明了 `jQWidgets` `jqxKnob` `destroy()` 的方法。
...
<body>
    <center>
        ...
        <h3>
            jQWidgets jqxKnob destroy() Method
        </h3>
        <div id='jqx_Knob'>
        </div>
        <input type="button" style="margin: 65px;" 
               id="button_for_destroy"
            value="Destroy the above jqxKnob"/>
        <div id="log"></div>
        <script type="text/javascript">
...
![](img/9a6fc90ea5ffa74e2815ccf10d3baa5a.png)
