...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxtreegrid-getselection-method/](https://www.geeksforgeeks.org/jqwidgets-jqxtreegrid-getselection-method/)

## jQWidgets 与 jqxTreeGrid 简介
...
## 示例
下面的示例说明了 jQWidgets `jqxTreeGrid` 的 `getSelection()` 方法。在下面的示例中，返回第一行第一列的值。
         ...
         <script type="text/javascript">
            $(document).ready(function () {
                ...
                $('#button_for_getSelection').click(
                    function () {
                        var Selected_Row = $("#jqxTreeGrid").jqxTreeGrid('getSelection');
                        $("#log").html(JSON.stringify(Selected_Row[0].Employee_Name))
                    });
            });
         </script>
      </center>
