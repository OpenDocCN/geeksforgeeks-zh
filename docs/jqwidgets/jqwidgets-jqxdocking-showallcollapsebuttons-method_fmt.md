...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdocking-showallcollapsebuttons-method/](https://www.geeksforgeeks.org/jqwidgets-jqxdocking-showallcollapsebuttons-method/)
...
`showAllCollapseButtons()` 方法用于显示指定 `jqxDocking` 的所有窗口的折叠按钮。
...
### 示例:
下面的示例说明了 jQWidgets `jqxDocking` `showAllCollapseButtons()` 方法。
