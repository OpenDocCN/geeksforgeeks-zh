# jQWidgets jqxRibbon 取消选择事件

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxribbon-unselect-event/](https://www.geeksforgeeks.org/jqwidgets-jqxribbon-unselect-event/)
...
下面的例子说明了 jQWidgets jqxRibbon 取消选择事件。
...
<body>
    <center>
        ...
        <h3>
            jQWidgets jqxRibbon unselect Event
        </h3>
    </center>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $("#jqxRibbon").on('unselect', function () {
                alert("Unselected the Selected Tab");
            });
        });
    </script>
</body>
...
![](img/87f22ac346d63b6f2c59b60f2fe7934e.png)
