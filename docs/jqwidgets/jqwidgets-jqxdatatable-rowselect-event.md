...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxdatatable-row select-event/](https://www.geeksforgeeks.org/jqwidgets-jqxdatatable-rowselect-event/)
...
**示例:**以下示例说明了 jQWidgets **rowSelect** 事件。
