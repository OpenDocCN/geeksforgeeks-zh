...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxnavbar-width-property/](https://www.geeksforgeeks.org/jqwidgets-jqxnavbar-width-property/)
...
**宽度属性**用于设置或返回 jqxNavBar 小部件的宽度。它接受数字/字符串类型的值，默认值为空。
...
下面的例子说明了 jQWidgets jqxNavBar 的宽度属性。
