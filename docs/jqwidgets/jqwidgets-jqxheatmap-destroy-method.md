# jQWidgets jqxHeatMap 销毁()方法

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxheatmap-destroy-method/](https://www.geeksforgeeks.org/jqwidgets-jqxheatmap-destroy-method/)
...
**销毁()方法**用于销毁 jqxHeatMap。它不接受任何参数，也不返回值。

**语法:**

```html
$('Selector').jqxHeatMap('destroy');
```
...
**示例:**下面的示例说明了 jQWidgets 中的 jqxHeatMap destroy()方法:
...
          GeeksforGeeks
        </h1>
        <h3>jQWidgets jqxHeatMap destroy() method</h3>
        <body class='default'>
            <div id="heatmap"></div>
            <br>
...
![](img/dc0fabb9f36b75e120d0a2f807f4e058.png)
