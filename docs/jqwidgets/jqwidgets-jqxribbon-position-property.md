...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxribbon-position-property/](https://www.geeksforgeeks.org/jqwidgets-jqxribbon-position-property/)
...
*位置*属性用于设置或返回色带标题的位置。它接受字符串类型值，默认值为“top”。
...
**示例:**以下示例说明了 jQWidgets jqxRibbon *位置*属性。
