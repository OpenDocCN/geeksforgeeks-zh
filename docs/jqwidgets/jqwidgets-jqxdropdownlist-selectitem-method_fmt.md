...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-selectitem-method/](https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-selectitem-method/)
...
`selectItem()` 方法用于从列表框中选择一个项目。它接受对象类型的单参数 `item`，不返回值。
