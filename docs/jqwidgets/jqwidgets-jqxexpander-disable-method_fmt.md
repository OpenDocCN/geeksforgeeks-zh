...
> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxexpander-disable-method/](https://www.geeksforgeeks.org/jqwidgets-jqxexpander-disable-method/)
...
`disable()`方法用于禁用膨胀机。它不接受任何参数，也不返回值。
