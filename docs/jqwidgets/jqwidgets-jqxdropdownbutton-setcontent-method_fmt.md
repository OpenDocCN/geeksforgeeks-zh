...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdropdownbutton-setcontent-method/](https://www.geeksforgeeks.org/jqwidgets-jqxdropdownbutton-setcontent-method/)
...
`setContent()` 方法用于设置显示的下拉按钮的内容。它包含一个参数，即可以是字符串或 HTML 类型的内容。它不返回任何东西。
...
下面的示例说明了 `jQWidgets` 中的 `jqxDropDownButton` `setContent()` 方法。
...
<html lang="en">
  ...
  <body>
    <center>
      ...
      <h3>jQWidgets jqxDropDownButton setContent() method</h3>
      <br />
      <div>
        <input
          type="button"
...
![](img/68e9137e63664ca96b9eee383d341195.png)
