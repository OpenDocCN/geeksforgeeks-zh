...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxtoolbar-gettools-method/](https://www.geeksforgeeks.org/jqwidgets-jqxtoolbar-gettools-method/)
...
下面的示例说明了 `jQWidgets` 中的 `jqxToolBar` `getTools()` 方法。
