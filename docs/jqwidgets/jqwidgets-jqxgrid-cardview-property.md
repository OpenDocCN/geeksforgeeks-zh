...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxgrid-card view-property/](https://www.geeksforgeeks.org/jqwidgets-jqxgrid-cardview-property/)
...
**示例:**以下示例说明了 jQWidgets 中的 jqxGrid **cardview** 属性。
