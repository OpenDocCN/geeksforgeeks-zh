...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxtoolbar-refresh-method/](https://www.geeksforgeeks.org/jqwidgets-jqxtoolbar-refresh-method/)
...
`refresh()`方法用于刷新显示的`jqxToolBar`。它没有参数，也不返回任何内容。
...
下面的示例说明了`jQWidgets`中的`jqxToolBar` `refresh()`方法。
