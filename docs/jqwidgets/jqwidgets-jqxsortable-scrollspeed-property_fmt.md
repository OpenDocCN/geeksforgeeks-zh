...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxsortable-scrollspeed-property/](https://www.geeksforgeeks.org/jqwidgets-jqxsortable-scrollspeed-property/)
...
以下示例说明了 jQWidgets 中的 `jqxSortable` `scrollSpeed` 属性。
