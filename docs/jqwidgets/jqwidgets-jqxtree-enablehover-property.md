...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxtree-enable hover-property/](https://www.geeksforgeeks.org/jqwidgets-jqxtree-enablehover-property/)
...
**启用悬停属性**用于启用或禁用悬停状态。它接受布尔类型值，默认值为真。
