...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxscheduler-beginappointmentsupdate-method/](https://www.geeksforgeeks.org/jqwidgets-jqxscheduler-beginappointmentsupdate-method/)
...
`beginAppointmentsUpdate()` 方法用于开始更新过程以及结束日程安排和预约渲染。它没有参数，也不返回任何内容。
...
<body>
    <center>
        ...
        <h3>jQWidgets jqxScheduler beginAppointmentsUpdate() method</h3>
        <div id="jqxs"></div>
        <div>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#jqxBtn").on("click", function () {
                $('#jqxs').jqxScheduler('beginAppointmentsUpdate');
                $('#log').text("Appointment update began!");
            });
        });
    </script>
</body>
