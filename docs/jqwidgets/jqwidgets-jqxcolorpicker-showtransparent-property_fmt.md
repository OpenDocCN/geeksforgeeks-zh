# jQWidgets jqxColorPicker showTransparent 属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxcolorpicker-showtransparent-property/](https://www.geeksforgeeks.org/jqwidgets-jqxcolorpicker-showtransparent-property/)
...
`showTransparent` 属性用于设置或返回 `showTransparent` 属性。它接受布尔类型值，默认值为 `false`。
