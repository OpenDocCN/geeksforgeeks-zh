...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxheatmap-width-property/](https://www.geeksforgeeks.org/jqwidgets-jqxheatmap-width-property/)
...
以下示例说明了 `jQWidgets` 中的 `jqxHeatMap` `宽度属性`:
