...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxslider-setvalue-method/](https://www.geeksforgeeks.org/jqwidgets-jqxslider-setvalue-method/)
...
`setValue()` 方法用于设置 `jqxSlider` 小部件值。它不接受任何参数，也不返回值。
