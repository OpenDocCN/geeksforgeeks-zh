...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxmenu-disable-method/](https://www.geeksforgeeks.org/jqwidgets-jqxmenu-disable-method/)
...
**禁用()方法**用于启用或禁用菜单小部件。它接受两个参数，第一个是字符串类型的项目标识，第二个是布尔类型值的值。它不返回值。
