...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxtree-allowdrop-property/](https://www.geeksforgeeks.org/jqwidgets-jqxtree-allowdrop-property/)
...
**allowDrop 属性**用于启用或禁用小部件的拖放选项。它接受布尔类型值，默认值为 false。
