...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxtree-getprevitem-method/](https://www.geeksforgeeks.org/jqwidgets-jqxtree-getprevitem-method/)
...
`getPrevItem()` 方法用于获取所选项目的上一个项目。它不接受任何参数，并返回对象类型值。
...
下面的例子说明了 jQWidgets `jqxTree` `getPrevItem()` 方法。
...
![](img/7fabf66079cccd80e263dd13bf042419.png)
