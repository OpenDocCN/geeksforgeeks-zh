# jQWidgets jqxDropDownButton autoOpen 属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdropdownbutton-autoopen-property/](https://www.geeksforgeeks.org/jqwidgets-jqxdropdownbutton-autoopen-property/)
...
`autoOpen` 属性用于设置或获取当鼠标光标在显示的小部件上触摸时，显示的下拉按钮是否自动打开。它是布尔类型，默认值为 `假`。
...
下面的示例说明了 jQWidgets 中的 `jqxDropDownButton` `autoOpen` 属性。
...
<body>
    <center>
      ...
      <h3>jQWidgets jqxDropDownButton autoOpen property</h3>
      <br />
...
![](img/7c276457353e148b9865ef6a940e043d.png)
