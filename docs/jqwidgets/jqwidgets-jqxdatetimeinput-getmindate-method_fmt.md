...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdatetimeinput-getmindate-method/](https://www.geeksforgeeks.org/jqwidgets-jqxdatetimeinput-getmindate-method/)
...
`getMinDate()` 方法用于获取最小导航日期。它不接受任何参数，并返回最小日期对象。
