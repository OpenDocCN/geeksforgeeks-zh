...
> 原文：[`https://www.geeksforgeeks.org/jqwidgets-jqxpasswordinput-refresh-method/`](https://www.geeksforgeeks.org/jqwidgets-jqxpasswordinput-refresh-method/)
...
`refresh()`方法用于刷新小部件。它不接受任何参数，也不返回值。
...
[`https://www.jqwidgets.com/jquery-widgets-documentation/documentation/jqxpasswordinput/jquery-password-input-api.htm`](https://www.jqwidgets.com/jquery-widgets-documentation/documentation/jqxpasswordinput/jquery-password-input-api.htm)