...
> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-close-method/](https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-close-method/)
...
### 示例
下面的示例说明了`jQWidgets`中的`jqxDropDownList` `close()`方法。
