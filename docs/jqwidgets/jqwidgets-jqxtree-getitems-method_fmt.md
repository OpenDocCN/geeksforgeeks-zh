...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxtree-getitems-method/](https://www.geeksforgeeks.org/jqwidgets-jqxtree-getitems-method/)
...
`getItems()` 方法用于以数组的形式返回小部件的所有项。它不接受任何参数，并返回数组类型值。
