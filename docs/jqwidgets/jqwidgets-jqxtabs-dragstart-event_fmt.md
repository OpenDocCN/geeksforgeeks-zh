...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxtabs-dragstart-event/](https://www.geeksforgeeks.org/jqwidgets-jqxtabs-dragstart-event/)
...
下面的例子说明了 jQWidgets `jqxTabs` `dragStart` 事件。
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#jqxTabs').on('dragStart', function (event) {
                alert('dragStart event triggered');
            });
        });
    </script>
</body>
...
![](img/29f45e21b5b5d1605a4b22b52e4fd8c1.png)
