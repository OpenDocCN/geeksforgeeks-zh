...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxradiobutton-enablecontainerclick-property/](https://www.geeksforgeeks.org/jqwidgets-jqxradiobutton-enablecontainerclick-property/)
...
**enableContainerClick 属性**用于设置或返回容器的点击是否作为圆形按钮上的点击来处理。它接受布尔类型值，默认值为真。
