# jqwidgets jqxrender panel animation hidedelay property
...
**animationhideday 属性**用于设置或返回面板隐藏时动画的速度。它接受数字/字符串类型的值，默认值为“快速”。
...
下面的例子说明了 jQWidgets 中的 jqxresponsepanel animationhidedlay 属性。
