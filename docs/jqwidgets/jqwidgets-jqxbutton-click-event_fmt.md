...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxbutton-click-event/](https://www.geeksforgeeks.org/jqwidgets-jqxbutton-click-event/)
...
以下示例说明了 `jQWidgets` 中的 `jqxButton` `点击事件`。
