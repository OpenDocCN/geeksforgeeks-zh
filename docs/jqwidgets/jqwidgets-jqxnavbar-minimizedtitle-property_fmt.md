...
> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxnavbar-minimizedtitle-property/](https://www.geeksforgeeks.org/jqwidgets-jqxnavbar-minimizedtitle-property/)
...
`minimizedTitle` 属性用于在最小化状态下设置或返回 `jqxNavBar` 小部件的标题。它接受字符串/HTML 元素类型值，默认值为“”。
