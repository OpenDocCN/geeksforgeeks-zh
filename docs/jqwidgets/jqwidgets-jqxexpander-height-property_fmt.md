# jQWidgets jqxExpander 高度属性

> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxexpander-height-property/](https://www.geeksforgeeks.org/jqwidgets-jqxexpander-height-property/)
...
`高度属性`用于设置或返回膨胀机高度。它接受数字/字符串类型的值，默认值为“自动”。
...
下面的例子说明了 jQWidgets `jqxExpander` 的 `高度属性`。
...
![](img/b1a4cddb4aa4fa4e4aefbc7d0b93c4b3.png)
