...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxgauge-radialgauge-min-property/](https://www.geeksforgeeks.org/jqwidgets-jqxgauge-radialgauge-min-property/)
...
`min` 属性用于设置或返回 `min` 属性，即用于设置 `jqxGauge` 的最小值，接受数值，默认值为 0。
