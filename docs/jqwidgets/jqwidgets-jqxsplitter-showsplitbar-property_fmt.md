...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxsplitter-showsplitbar-property/](https://www.geeksforgeeks.org/jqwidgets-jqxsplitter-showsplitbar-property/)
...
`showSplitBar` 属性用于设置或获取指定 `jqxSplitter` 的拆分条是否显示。
...
### 示例:
下面的示例说明了 jQWidgets `jqxSplitter` `showSplitBar` 属性。在下面的示例中，`showSplitBar` 属性的值已设置为 `true`。
