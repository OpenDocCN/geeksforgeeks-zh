# jq 构件 jqxDateTimeInput selectionMode 属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdatetimeinput-selectionmode-property/](https://www.geeksforgeeks.org/jqwidgets-jqxdatetimeinput-selectionmode-property/)
...
`selectionMode` 属性用于设置或返回下拉日历的选择模式。它接受字符串类型的值，默认值为“默认值”。
