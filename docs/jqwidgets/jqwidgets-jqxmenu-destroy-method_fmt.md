# jQWidgets jqxMenu 销毁()方法

> 原文: [`https://www.geeksforgeeks.org/jqwidgets-jqxmenu-destroy-method/`](https://www.geeksforgeeks.org/jqwidgets-jqxmenu-destroy-method/)
...
<body>
    ...
    <h3>
        jQWidgets jqxMenu destroy() Method
    </h3>
    ...
    <center>
        <input type="button" value="Destroy the Widget" 
            id="jqxBtn" 
...
![](img/749729989d9692659285c422091a56b3.png)
