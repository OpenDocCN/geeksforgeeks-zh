# jQWidgets jqxtreme uncheckAll()方法

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxtree-uncheckall-method/](https://www.geeksforgeeks.org/jqwidgets-jqxtree-uncheckall-method/)
...
`uncheckAll()`方法用于取消勾选所有的 `jqxTree` 小部件元素。它不接受任何参数，也不返回值。

**语法:**

```html
$('Selector').jqxTree('uncheckAll');
```
...
下面的例子说明了 jQWidgets `jqxTree` `uncheckAll()`方法。
...
<body>
    ...
    <h3>
        jQWidgets jqxTree uncheckAll() Method
    </h3>
...
![](img/e811bf1f404f1de9a52a8566e1e2884d.png)
