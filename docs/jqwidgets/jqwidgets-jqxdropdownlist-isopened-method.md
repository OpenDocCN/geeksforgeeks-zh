# jQWidgets jqxDropDownList isopended()方法

> 原文:[https://www . geeksforgeeks . org/jqwidgets-jqxddropdownlist-isopended-method/](https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-isopened-method/)
...
**等边框()**方法用于检查弹出窗口是否打开。不接受任何参数，返回*真*，如果弹出窗口打开，否则返回*假*。

**语法:**

```html
$("Selector").jqxDropDownList('isOpened');
```
...
**示例:**下面的示例说明了 jQWidgets 中的 jqxDropDownList**isopended()**方法。
...
                var res = $("#jqxDDL").jqxDropDownList('isOpened');

                alert("Is Popup Opened: " + res)
            });
        });
    </script>
</body>
...
![](img/17d5da0121491ba238346e081f8e3956.png)
