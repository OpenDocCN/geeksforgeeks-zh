# jQWidgets jqxInput 高度属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxinput-height-property/](https://www.geeksforgeeks.org/jqwidgets-jqxinput-height-property/)

**jQWidgets** 是一个 JavaScript 框架，用于为 PC 和移动设备制作基于 web 的应用程序。它是一个非常强大、优化、独立于平台并且得到广泛支持的框架。`jqxInput` 用于表示包含自动完成功能的 jQuery 输入小部件。

`height` 属性用于设置或返回 `jqxInput` 小部件的高度。它接受数字/字符串类型的值，默认值为空。
...
以下示例说明了 jQWidgets 中的 `jqxInput` `height` 属性。
...
![](img/bdb82745c5301ca80c3ede1b577ba862.png)
