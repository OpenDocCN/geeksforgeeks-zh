...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxtoolbar-disabletool-method/](https://www.geeksforgeeks.org/jqwidgets-jqxtoolbar-disabletool-method/)
...
`disableTool()` 方法用于从显示的 `jqxToolBar` 中禁用工具。它不返回任何东西。
...
<body>
    <center>
        ...
        <h3>jQWidgets jqxToolBar disableTool() method</h3>
        <div id="jqxtb"></div>
        <div>
