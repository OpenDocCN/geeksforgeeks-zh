# jQWidgets jqxDropDownList open delay 属性

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxdropdownlist-open delay-property/](https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-opendelay-property/)
...
*打开延迟*属性用于设置或返回“打开”动画的延迟。它接受数字类型值，默认值为 350。
...
**示例:**下面的示例说明了 jQWidgets 中的 jqxDropDownList*open delay*属性。
