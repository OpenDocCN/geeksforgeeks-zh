...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxchart-click-event/](https://www.geeksforgeeks.org/jqwidgets-jqxchart-click-event/)
...
以下示例说明了 jQWidgets 中的 `jqxChart` 点击事件。
