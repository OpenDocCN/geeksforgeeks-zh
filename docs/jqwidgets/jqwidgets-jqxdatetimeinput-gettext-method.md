# jqwidget jqxdatetimeinput gettext()方法

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxdatetimeinput-gettext-method/](https://www.geeksforgeeks.org/jqwidgets-jqxdatetimeinput-gettext-method/)
...
**getText()方法**用于返回输入字段文本。它不接受任何参数，并返回字符串类型的值。

**语法:**

```html
$('Selector').jqxDateTimeInput('getText');
```
...
下面的例子说明了 jQWidgets 中的 jqxDateTimeInput **getText()方法**。
...
                var getText = $('#jqxDTI')
                    .jqxDateTimeInput('getText');

                alert("Text Content: " + getText);
            })
        });
    </script>
</body>
...
![](img/0597e4b1966d8c41096dba0d4e0f8a17.png)
