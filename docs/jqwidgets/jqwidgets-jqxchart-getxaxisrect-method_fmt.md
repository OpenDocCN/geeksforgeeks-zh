...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxchart-getxaxisrect-method/](https://www.geeksforgeeks.org/jqwidgets-jqxchart-getxaxisrect-method/)
...
`getXAxisRect()`方法用于获取 x 轴的矩形坐标。它以单个数字类型值`groupIndex`为参数，返回一个包含矩形数据的对象。
...
**示例:** 下面的示例说明了 jQWidgets 中的 jqxChart `getXAxisRect()`方法:
...
<head>
    ...
    <script type="text/javascript" 
            src="jqwidgets/jqxchart.api.js"></script>
    <script type="text/javascript" 
