...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxtree-collapse all-method/](https://www.geeksforgeeks.org/jqwidgets-jqxtree-collapseall-method/)
...
**collapseal()方法**用于折叠小部件的所有项目。它不接受任何参数，也不返回值。
