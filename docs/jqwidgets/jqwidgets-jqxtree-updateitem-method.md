...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxtree-updateitem-method/](https://www.geeksforgeeks.org/jqwidgets-jqxtree-updateitem-method/)
...
**更新项目()方法**用于更新项目。它接受对象类型的两个参数项和 new_item，并且不返回任何值。
