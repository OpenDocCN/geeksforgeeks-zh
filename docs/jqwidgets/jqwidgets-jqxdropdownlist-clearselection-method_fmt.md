...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-clearselection-method/](https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-clearselection-method/)
...
**`clearSelection()`** 方法用于清除所有选定的项目。它不接受任何参数，也不返回值。
...
**示例：** 下面的示例说明了 `jQWidgets` 中的 `jqxDropDownList` `clearSelection()` 方法。
...
<body>
    <center>
        ...
        <div id='jqxDDL'></div>
        <input id="jqxBtn" type="button" value="Clear Selected Item"
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $("#jqxBtn").on('click', function() {
                $("#jqxDDL").jqxDropDownList('clearSelection');
            }); 
        });
    </script>
</body>
...
![](img/799e366dc1e762e808bc74e942de33cf.png)
