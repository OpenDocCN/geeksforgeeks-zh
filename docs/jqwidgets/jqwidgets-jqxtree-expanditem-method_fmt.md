...
> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxtree-expanditem-method/](https://www.geeksforgeeks.org/jqwidgets-jqxtree-expanditem-method/)
...
`expandItem()`方法用于通过传递一个元素作为参数来扩展一个 `jqxTree` 小部件项。它接受对象类型的单个参数 `item`，不返回任何值。
...
下面的例子说明了 jQWidgets `jqxTree` `expandItem()`方法。
...
![](img/83ab882d4ac8b680ccb5acaa52dbab9d.png)
