# jQWidgets jqxCalendar clearString 属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxcalendar-clearstring-property/](https://www.geeksforgeeks.org/jqwidgets-jqxcalendar-clearstring-property/)
...
`clearString` 属性用于设置或返回“显示页脚”属性为真时显示的“清除”字符串。它接受字符串类型值，默认值为“清除”。
...
下面的示例说明了 `jQWidgets` 中的 `jqxCalendar` `clearString` 属性。
