# jqwidgets jqxtoltip 展示箭头性质

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxtooltip-show arrow-property/](https://www.geeksforgeeks.org/jqwidgets-jqxtooltip-showarrow-property/)
...
*显示箭头*属性用于设置或返回工具提示的箭头是否显示。它接受布尔类型值，默认值为*假*。
...
**示例:**以下示例说明了 jQWidgets jqxTooltip*showArrow*属性。
