...
> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxtabs-gettitleat-method/](https://www.geeksforgeeks.org/jqwidgets-jqxtabs-gettitleat-method/)
...
`getTitleAt()` 方法用于获取一个 Tab 的标题。它接受数字类型的单参数 `index`。索引从 0 开始。它返回字符串类型值。
...
下面的例子说明了 jQWidgets jqxTabs `getTitleAt()` 方法。
...
![](img/998828c65fa1bb7982da54574ed21e4a.png)
