# jQWidgets jqxListBox refresh()方法

> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxlistbox-refresh-method/](https://www.geeksforgeeks.org/jqwidgets-jqxlistbox-refresh-method/)
...
下面的示例说明了`jQWidgets`中的`jqxListBox` `refresh()`方法。
