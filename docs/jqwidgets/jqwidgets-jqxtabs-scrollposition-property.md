...
> 原文:[https://www . geeksforgeeks . org/jqwidgets-jqxtabs-scroll position-property/](https://www.geeksforgeeks.org/jqwidgets-jqxtabs-scrollposition-property/)
...
**滚动位置属性**用于设置或返回滚动箭头的位置。它接受字符串类型的值，默认值为“右”。
