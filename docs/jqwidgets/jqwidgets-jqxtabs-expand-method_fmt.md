# jQWidgets jqxTabs 展开()方法

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxtabs-expand-method/](https://www.geeksforgeeks.org/jqwidgets-jqxtabs-expand-method/)
...
`展开()`方法用于展开当前选中的标签页。它不接受任何参数，也不返回值。

## 语法

```javascript
$('Selector').jqxTabs('expand');
```
...
下面的例子说明了 jQWidgets `jqxTabs` `expand()`方法。
...
<body>
    <center>
        ...
        <h3>
            jQWidgets jqxTabs expand() Method
        </h3>
        ...
        <br>
        <input id="jqxBtn1" type="button" 
            value="Collapse Tabs" 
            style="padding: 5px 15px;">
        <input id="jqxBtn2" type="button" 
            value="Expand Tabs" 
            style="padding: 5px 15px;">
    </center>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#jqxBtn1').click(function () {
                $('#jqxTabs').jqxTabs('collapse');
            });

            $('#jqxBtn2').click(function () {
...
![](img/cf875780c8c808226e938787fd3a1533.png)
