# jQWidgets jqxCalendar enableOtherMonthDays 属性

> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxcalendar-enableothermonthdays-property/](https://www.geeksforgeeks.org/jqwidgets-jqxcalendar-enableothermonthdays-property/)
...
`enableOtherMonthDays` 属性用于设置或返回一个值，该值指示是否启用其他月日。它接受布尔类型值，默认值为真。
...
以下示例说明了 jQWidgets 中的 `jqxCalendar` `enableOtherMonthDays` 属性。
...
<body>
    <center>
        ...
        <h3>
            jQWidgets jqxCalendar enableOtherMonthDays Property
        </h3>
        <div id='jqxcal'></div>
    </center>
...
![](img/3377438e8013c2280e9d39428a7e0308.png)
