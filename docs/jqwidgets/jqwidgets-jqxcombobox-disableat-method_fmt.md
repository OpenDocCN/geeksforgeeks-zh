...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxcombobox-disableat-method/](https://www.geeksforgeeks.org/jqwidgets-jqxcombobox-disableat-method/)
...
`disableAt()` 方法用于通过使用索引号来禁用项目。它接受数字类型的单个参数 `index`，并且不返回任何值。
...
<body>
    <center>
        ...
        <div id='jqxCB'></div>
        <br>
        <input type="button" id='jqxBtn' style="padding: 5px 20px;" value="Disable Item" />
    </center>
