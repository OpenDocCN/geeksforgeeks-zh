# jQWidgets jqxMenu 还原()方法

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxmenu-restore-method/](https://www.geeksforgeeks.org/jqwidgets-jqxmenu-restore-method/)
...
**restore()方法**用于将小部件从小部件的“最小化”状态恢复。它不接受任何参数，也不返回值。

**语法:**

```html
$('Selector').jqxMenu('restore');
```
...
下面的例子说明了 jQWidgets jqxMenu restore()方法。
...
    <h3>
        jQWidgets jqxMenu restore() Method
    </h3>
...
    <center>
        <input type="button" value="Restore the Widget" 
            id="jqxBtn" 
...
![](img/605017e89741631259300df6c6c37f15.png)
