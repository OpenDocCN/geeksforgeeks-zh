## jQWidgets jqxDataTable 可过滤属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdatatable-filterable-property/](https://www.geeksforgeeks.org/jqwidgets-jqxdatatable-filterable-property/)
...
以下示例说明了 `jQWidgets` `可过滤` 属性。在下面的示例中，`filterable` 属性的值被设置为“真”。
