...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxlayout-pin-event/](https://www.geeksforgeeks.org/jqwidgets-jqxlayout-pin-event/)
...
当一组指定的 `jqxLayout` 部件被固定时，触发 `pin` 事件。
...
下面的示例说明了 `jQWidgets` 的 `jqxLayout` 的 `pin` 事件。
