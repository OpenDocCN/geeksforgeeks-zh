...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdocking-enable-method/](https://www.geeksforgeeks.org/jqwidgets-jqxdocking-enable-method/)
...
以下示例说明了 `jQWidgets` `jqxDocking` `enable()` 方法。
