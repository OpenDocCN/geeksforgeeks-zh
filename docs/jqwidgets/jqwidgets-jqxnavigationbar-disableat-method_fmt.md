...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxnavigationbar-disableat-method/](https://www.geeksforgeeks.org/jqwidgets-jqxnavigationbar-disableat-method/)
...
`disableAt()`方法用于使用指定的项目索引禁用指定的`jqxNavigationBar`的项目。
...
下面的示例说明了 jQWidgets `jqxNavigationBar` `disableAt()`方法。在下面的示例中，第 0 行索引处的项目将被禁用。
