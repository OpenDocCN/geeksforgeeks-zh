# jQWidgets jqxSplitter 刷新()方法

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxsplitter-refresh-method/](https://www.geeksforgeeks.org/jqwidgets-jqxsplitter-refresh-method/)
...
**刷新()** **方法**用于刷新指定的 jqxSplitter。此方法执行布局并排列分割面板。
...
**示例:**下面的示例说明了 jQWidgets**jqxSplitter**T4【刷新()方法。
