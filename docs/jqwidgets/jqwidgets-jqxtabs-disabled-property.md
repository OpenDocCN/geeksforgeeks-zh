...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxtabs-disabled-property/](https://www.geeksforgeeks.org/jqwidgets-jqxtabs-disabled-property/)
...
*禁用的*属性用于启用或禁用 jqxTabs 小部件。它接受布尔类型值，默认值为*假*。
...
**示例:**以下示例说明了 jQWidgets jqxTabs *禁用的*属性。
