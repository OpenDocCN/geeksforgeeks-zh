...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxtimepicker-width-property/](https://www.geeksforgeeks.org/jqwidgets-jqxtimepicker-width-property/)
...
下面的例子说明了 jQWidgets `jqxTimePicker` `width` 属性。
