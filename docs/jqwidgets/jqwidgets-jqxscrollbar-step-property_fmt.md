# jQWidgets jqxScrollBar step 属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxscrollbar-step-property/](https://www.geeksforgeeks.org/jqwidgets-jqxscrollbar-step-property/)
...
`step` 属性用于设置或获取指定 `jqxScrollBar` 的步长。当用户按下滚动条按钮时，该步长值用于增加或减少滚动条上的步长。
...
**示例:** 下面的示例说明了 jQWidgets `jqxScrollBar` 的 `step` 属性。在下面的示例中， `step` 属性的值被设置为 70。
