# jQWidgets jqxCalendar showFooter 属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxcalendar-showfooter-property/](https://www.geeksforgeeks.org/jqwidgets-jqxcalendar-showfooter-property/)
...
`showFooter` 属性用于设置或返回一个值，该值指示日历的页脚是否显示。它接受布尔类型值，默认值为 `true`。
...
下面的示例说明了 jQWidgets 中的 `jqxCalendar` `showFooter` 属性。
...
<body>
    <center>
        ...
        <h3>
            jQWidgets jqxCalendar showFooter Property
        </h3>
        <div id='jqxcal'></div>
    </center>
...
![](img/40c60b102262dce54b11a243a4624269.png)
