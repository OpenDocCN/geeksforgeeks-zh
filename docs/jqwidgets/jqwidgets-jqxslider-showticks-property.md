...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxslider-showtics-property/](https://www.geeksforgeeks.org/jqwidgets-jqxslider-showticks-property/)
...
**显示刻度属性**用于设置或返回是否显示刻度。它接受布尔类型值，默认值为真。
