# jQWidgets jqxScheduler toolbrangerformat 属性

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxscheduler-toolbrangerformat-property/](https://www.geeksforgeeks.org/jqwidgets-jqxscheduler-toolbarrangeformat-property/)
...
***工具栏*** 属性用于在显示的 **jqxScheduler** 中设置或返回工具栏的日期格式。它属于字符串类型，默认情况下，它的值为“日 MMMM 年”。
...
**示例:**下面的示例说明了 jQWidgets 中的**jqxScheduler***toolbrangerformat*属性。
