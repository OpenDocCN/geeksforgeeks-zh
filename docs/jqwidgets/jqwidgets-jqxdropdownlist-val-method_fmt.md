...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-val-method/](https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-val-method/)
...
`val()`方法用于设置或返回所选值。它接受字符串类型的单个参数值，并返回字符串类型的值。
