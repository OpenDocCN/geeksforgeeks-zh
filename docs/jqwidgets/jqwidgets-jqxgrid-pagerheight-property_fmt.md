# jQWidgets jqxGrid pagerheight 属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxgrid-pagerheight-property/](https://www.geeksforgeeks.org/jqwidgets-jqxgrid-pagerheight-property/)
...
`pagerheight` 属性用于设置或获取 `jqxGrid` 的寻呼机高度。它的类型为数字或字符串，默认值为 `40`。
...
下面的例子说明了 `jQWidgets` 中的 `jqxGrid` 的 `pagerheight` 属性。
...
<body>
    <center>
        ...
        <h3>jQWidgets jqxGrid pagerheight property</h3>
        <br />
