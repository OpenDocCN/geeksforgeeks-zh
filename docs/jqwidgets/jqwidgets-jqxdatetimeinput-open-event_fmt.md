# jq 构件 jqxDateTimeInput 公开事件

> 哎哎哎:# t0]https://www . geeksforgeeks . org/jqwidgets-jqxdatetimeinput-open event/
...
当 `jqxDateTimeInput` 小部件弹出窗口打开时，使用 `open` 事件触发。
...
**示例:** 以下示例说明了 `jQWidgets` 中的 `jqxDateTimeInput` `open` 事件。
...
<body>
    <center>
        ...
        <h3>
            jQWidgets jqxDateTimeInput open Event
        </h3>
...
![](img/02728dc73de0fa70ebe592e16e00ea8c.png)
