...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxpasswordinput-complete-reference/](https://www.geeksforgeeks.org/jqwidgets-jqxpasswordinput-complete-reference/)

`jqxPasswordInput` 是一个 jQuery 小部件，它支持输入字段密码，并对密码的强度有很好的视觉反馈。
