...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxwindow-content-property/](https://www.geeksforgeeks.org/jqwidgets-jqxwindow-content-property/)
...
以下示例说明了 `jQWidgets` 中的 `jqxWindow` `内容`属性。对于本例，内容设置为“GFG”。点击“打开下面的窗口”按钮后，现有内容“极客博客”将被替换为“GFG”。
