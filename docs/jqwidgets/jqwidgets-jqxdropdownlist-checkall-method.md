...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxddropdownlist-checkall-method/](https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-checkall-method/)
...
当“复选框”属性值为*真*时， **checkAll()** 方法用于检查所有列表项。它不接受任何参数，也不返回值。
...
**示例:**下面的示例说明了 jQWidgets 中的 jqxDropDownList**checkAll()**方法。
