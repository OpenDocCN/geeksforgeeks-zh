# jqxDateTimeInput 的 getText() 方法

> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxdatetimeinput-gettext-method/](https://www.geeksforgeeks.org/jqwidgets-jqxdatetimeinput-gettext-method/)
...
`getText()` 方法用于返回输入字段文本。它不接受任何参数，并返回字符串类型的值。
