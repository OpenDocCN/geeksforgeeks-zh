...
> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxtextarea-minlength-property/](https://www.geeksforgeeks.org/jqwidgets-jqxtextarea-minlength-property/)
...
`minLength` 属性用于设置或返回触发自动完成建议前所需的最小字符数。它接受数字类型值，默认值为 1。
...
以下示例说明了 jQWidgets jqxTextArea `minLength` 属性。
