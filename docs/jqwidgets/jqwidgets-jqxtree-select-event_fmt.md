...
> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxtree-select-event/](https://www.geeksforgeeks.org/jqwidgets-jqxtree-select-event/)
...
下面的例子说明了 jQWidgets `jqxTree` `选择事件`。
...
<body>
    ...
    <h3>
        jQWidgets jqxTree select Event
    </h3>
...
![](img/bf3e51acc04015d424d5673f4bc9d362.png)
