...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxformattedinput-refresh-method/](https://www.geeksforgeeks.org/jqwidgets-jqxformattedinput-refresh-method/)
...
**refresh()方法** 用于刷新 `jqxFormattedInput` 小部件。它不接受任何参数，也不返回值。
...
下面的例子说明了 jQWidgets `jqxFormattedInput` `refresh()`方法。
