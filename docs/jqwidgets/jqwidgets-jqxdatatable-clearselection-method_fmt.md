...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdatatable-clearselection-method/](https://www.geeksforgeeks.org/jqwidgets-jqxdatatable-clearselection-method/)

**jQWidgets** 是一个 JavaScript 框架，用于为 PC 和移动设备制作基于 web 的应用程序。它是一个非常强大、优化、独立于平台并且得到广泛支持的框架。**jqxDataTable** 用于读取和显示 HTML 表格中的数据。这也用于显示来自各种数据源的数据，如 XML、JSON、Array、CSV 或 TSV。

`clearSelection()` 方法用于清除选择。此方法不接受任何参数。
...
下面的示例说明了 jQWidgets `clearSelection()` 方法。
...
<body>
    <center>
        ...
        <h3>jQWidgets jqxDataTable clearSelection() Method</h3>
        <div id="table"></div>
        <input type="button" style="margin: 30px;" id="jqxbutton" value="Clear the selected second row"/>
    </center>
</body>
