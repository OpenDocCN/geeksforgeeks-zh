...
> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxtabs-disable-method/](https://www.geeksforgeeks.org/jqwidgets-jqxtabs-disable-method/)
...
`disable()`方法用于禁用选项卡小部件。它不接受任何参数，也不返回值。

**语法：**

```javascript
$('Selector').jqxTabs('disable');
```
...
下面的例子说明了 jQWidgets `jqxTabs` `disable()`方法。
...
<body>
    <center>
        ...
        <h3>
            jQWidgets jqxTabs disable() Method
        </h3>
        ...
        <input id="jqxBtn" type="button" value="Disable Tabs" 
...
![](img/f8d4b90947ad67e03361de430dfc60bd.png)
