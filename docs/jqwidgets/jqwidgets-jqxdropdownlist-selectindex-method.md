# jQWidgets jqxDropDownList selectiondex()方法

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxddropdownlist-selectindex-method/](https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-selectindex-method/)
...
selectIndex()方法用于使用索引号从列表框中选择一个项目。它接受数字类型的单参数索引，不返回值。

**语法:**

```html
$("Selector").jqxDropDownList('selectIndex', index);
```
...
下面的例子说明了 jQWidgets 中的 jqxDropDownList selectIndex()方法。
...
![](img/aa1654e9663018e970dd10bff5120e59.png)
