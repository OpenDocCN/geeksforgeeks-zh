...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxtabs-removefirst-method/](https://www.geeksforgeeks.org/jqwidgets-jqxtabs-removefirst-method/)
...
`removeFirst()` 方法用于删除第一个选项卡。它不接受任何参数，也不返回值。
...
下面的例子说明了 jQWidgets jqxTabs `removeFirst()` 方法。
...
<body>
    <center>
        ...
        <h3>
            jQWidgets jqxTabs removeFirst() Method
        </h3>
...
![](img/9277bb72e91e1bdeb94ced50497eaaa3.png)
