# jQWidgets jqxBulletChart animationDuration 属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxbulletchart-animationduration-property/](https://www.geeksforgeeks.org/jqwidgets-jqxbulletchart-animationduration-property/)
...
`animationDuration` 属性用于确定动画时间。它的默认值为 `null`。它的可能值是数字、`"slow"`、`"fast"`。
...
下面的示例说明了 jQWidgets 中的 `jqxBulletChart` `animationDuration` 属性。
