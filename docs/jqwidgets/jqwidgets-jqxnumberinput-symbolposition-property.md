# jQWidgets jqxnumber input symbolPosition 属性

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxnumberinput-symbolposition-property/](https://www.geeksforgeeks.org/jqwidgets-jqxnumberinput-symbolposition-property/)
...
**符号位置属性**用于设置或返回符号在输入字段中的位置。它接受字符串类型值，默认值为“左”。
...
下面的例子说明了 jQWidgets jqxnumber input symbolPosition 属性。
