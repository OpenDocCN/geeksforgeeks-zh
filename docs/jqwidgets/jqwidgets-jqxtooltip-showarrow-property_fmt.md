# jqwidgets jqxTooltip showArrow 属性

> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxtooltip-showarrow-property/](https://www.geeksforgeeks.org/jqwidgets-jqxtooltip-showarrow-property/)
...
`showArrow` 属性用于设置或返回工具提示的箭头是否显示。它接受布尔类型值，默认值为 `false`。
...
以下示例说明了 jQWidgets `jqxTooltip` 的 `showArrow` 属性。
...
<body>
    <center>
        ...
        <h3>
            jQWidgets jqxTooltip showArrow Property
        </h3>
        <br><br>
...
![](img/d6cb7dc38ee404487cc644cf3af03d37.png)
