...
> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxbulletchart-height-property/](https://www.geeksforgeeks.org/jqwidgets-jqxbulletchart-height-property/)
...
下面的例子说明了 jQWidgets 中的 `jqxBulletChart` `height` 属性。
...
<body>
    <center>
        ...
        <h3>
            jQWidgets jqxBulletChart height Property
        </h3>
        <div id="gfg"></div>
    </center>
...
![](img/63e926259040f1863ab89ab1a24d91b0.png)

`jqxBulletChart` 高度

**参考：** [https://www.jqwidgets.com/jquery-widgets-documentation/documentation/jqxbulletchart/jquery-bullet-chart-api.htm](https://www.jqwidgets.com/jquery-widgets-documentation/documentation/jqxbulletchart/jquery-bullet-chart-api.htm)