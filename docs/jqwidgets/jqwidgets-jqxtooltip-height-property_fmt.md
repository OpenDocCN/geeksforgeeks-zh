# jQWidgets jqxTooltip 高度属性

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxtooltip-height-property/](https://www.geeksforgeeks.org/jqwidgets-jqxtooltip-height-property/)
...
`height` 属性用于设置或返回 `jqxTooltip` 的高度。它接受数字/字符串类型的值，默认值为“自动”。
...
以下示例说明了 jQWidgets jqxTooltip `height` 属性。
...
![](img/a8a7702835e29cf9e8a93a9bd5d79a7d.png)
