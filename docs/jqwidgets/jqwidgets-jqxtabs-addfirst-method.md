...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxtabs-addfirst-method/](https://www.geeksforgeeks.org/jqwidgets-jqxtabs-addfirst-method/)
...
**addFirst()方法**用于在开始位置添加制表符。添加选项卡包含选项卡的标题和内容。该方法接受下面给出的两个参数:
