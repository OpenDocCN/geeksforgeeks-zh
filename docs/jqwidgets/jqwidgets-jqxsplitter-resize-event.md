# jqwidgets jqxssplitter resize event

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxsplitter-resize-event/](https://www.geeksforgeeks.org/jqwidgets-jqxsplitter-resize-event/)
...
当指定 jqxSplitter 的“调整大小”操作结束时，将触发**调整大小事件。**
...
****示例:**下面的示例说明了 jQWidgets jqxSplitter ***调整大小*** 事件。**
