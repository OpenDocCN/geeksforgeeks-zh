# jQWidgets jqxResponsivePanel 刷新()方法

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxresponsevepanel-refresh-method/](https://www.geeksforgeeks.org/jqwidgets-jqxresponsivepanel-refresh-method/)
...
```html
$('Selector').jqxResponsivePanel('refresh');
```
...
下面的例子说明了 jQWidgets 中的 jqxResponsivePanel refresh()方法。
...
    <h3>
        jQWidgets jqxResponsivePanel refresh() Method
    </h3>
...
                $('#jqxRP').jqxResponsivePanel('refresh');
...
![](img/358ceabe30626cf5cef4e1c0b9892e8b.png)
