...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxnavigationbar-val-method/](https://www.geeksforgeeks.org/jqwidgets-jqxnavigationbar-val-method/)
...
下面的示例说明了 jQWidgets `jqxNavigationBar` `val()` 方法。
