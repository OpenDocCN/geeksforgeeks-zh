# jqwidgets jqxdropsdownlist 检查变更事件

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-checkchange-event/](https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-checkchange-event/)
...
<body>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $("#jqxDDL").on('checkChange', function (event) {
                alert("Checkbox Checked other value");
            });
        });
    </script>
</body>
...
![](img/983a9b7e70bf801df894c8ce97dde547.png)
