...
> 原文:[https://www . geeksforgeeks . org/jqwidgets-jqxchart-border line width-property/](https://www.geeksforgeeks.org/jqwidgets-jqxchart-borderlinewidth-property/)
...
**边框线宽度**属性用于设置或返回边框线宽度属性。即该属性用于设置或返回边框线宽度。它接受数字类型值，默认值为 1。
...
**示例:**以下示例说明了 jQWidgets 中的 jqxChart **边界线宽度**属性。
