...
> 原文:[https://www . geeksforgeeks . org/jqwidgets-jqxslider-tooltipformatformation-property/](https://www.geeksforgeeks.org/jqwidgets-jqxslider-tooltipformatfunction-property/)
...
**工具提示格式功能属性**用于设置或返回工具提示元素的格式。它接受函数类型值，默认值为空。
