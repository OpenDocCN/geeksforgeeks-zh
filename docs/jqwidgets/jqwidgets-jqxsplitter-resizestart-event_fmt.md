# jqxSplitter resizeStart 事件

> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxsplitter-resizestart-event/](https://www.geeksforgeeks.org/jqwidgets-jqxsplitter-resizestart-event/)
...
当指定 `jqxSplitter` 的“调整开始”操作开始时，触发 `resizeStart` 事件。
...
下面的示例说明了 `jQWidgets` `jqxSplitter` 的 `resizeStart` 事件。
