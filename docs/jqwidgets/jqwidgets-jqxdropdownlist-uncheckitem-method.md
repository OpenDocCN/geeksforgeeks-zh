...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxddropdownlist-uncheckitem-method/](https://www.geeksforgeeks.org/jqwidgets-jqxdropdownlist-uncheckitem-method/)
...
**取消选中项目()方法**用于在“复选框”属性值设置为真时，使用项目名称取消选中列表项目。它接受对象/字符串类型的单个参数项，并且不返回值。
