...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxtreegrid-clearfilters-method/](https://www.geeksforgeeks.org/jqwidgets-jqxtreegrid-clearfilters-method/)
...
下面的示例说明了 jQWidgets `jqxTreeGrid` 的 `clearFilters()` 方法。在下面的示例中，为“公司”列中的“极客”添加的过滤器已被清除。
