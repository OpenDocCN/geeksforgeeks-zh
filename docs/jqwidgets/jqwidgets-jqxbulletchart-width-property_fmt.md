# jQWidgets jqxBulletChart 宽度属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxbulletchart-width-property/](https://www.geeksforgeeks.org/jqwidgets-jqxbulletchart-width-property/)
...
`width` 属性用于设置或返回 bulletcharts 的宽度。它接受字符串/数字类型值，默认值为 500。
