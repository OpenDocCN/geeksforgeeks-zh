# jqwidgets jqxcombo getselecteditems()方法

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxcombobox-getselecteditems-method/](https://www.geeksforgeeks.org/jqwidgets-jqxcombobox-getselecteditems-method/)
...
`getSelectedItems()`方法用于在打开“多选”时返回选定的项目。返回值是一个带有对象的数组。它不接受任何参数，并返回一个元素数组。
...
以下示例说明了 jQWidgets 中的 `jqxComboBox` `getSelectedItems()`方法:
...
![](img/82bab3565c943c3315d814c2fde9c7c8.png)
