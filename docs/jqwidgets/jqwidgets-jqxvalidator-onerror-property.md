# jQWidgets jqxValidator one error 属性

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxvalidator-one rror-property/](https://www.geeksforgeeks.org/jqwidgets-jqxvalidator-onerror-property/)
...
**示例:**下面的示例说明了 jQWidgets jqxValidator***onError***属性。
