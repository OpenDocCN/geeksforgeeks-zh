# jqxResponsivePanel 的 initContent 属性

> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxresponsivepanel-initcontent-property/](https://www.geeksforgeeks.org/jqwidgets-jqxresponsivepanel-initcontent-property/)
...
`initContent` 属性用于初始化响应面板内容。它接受函数类型值，默认值为 `null`。
