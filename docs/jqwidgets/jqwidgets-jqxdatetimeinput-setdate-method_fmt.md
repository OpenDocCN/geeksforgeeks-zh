...
> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxdatetimeinput-setdate-method/](https://www.geeksforgeeks.org/jqwidgets-jqxdatetimeinput-setdate-method/)
...
`setDate()` 方法用于设置想要导航的日期。它接受日期/字符串类型的单个参数 `Date`，并且不返回值。
