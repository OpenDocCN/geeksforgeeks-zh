...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxcombobox-remove at-method/](https://www.geeksforgeeks.org/jqwidgets-jqxcombobox-removeat-method/)
...
**removeAt()** 方法用于从列表框中删除给定索引处的项目。它接受数字类型的单个参数索引，如果项目被移除，则返回布尔值*真*，否则返回*假*。
...
            value="Remove Item At Given Position" />
    </center>
