...
> 原文:[https://www.geeksforgeeks.org/jqwidgets-jqxdatetimeinput-open-method/](https://www.geeksforgeeks.org/jqwidgets-jqxdatetimeinput-open-method/)
...
`open()`方法用于打开弹出日历。它不接受任何参数，也不返回值。
