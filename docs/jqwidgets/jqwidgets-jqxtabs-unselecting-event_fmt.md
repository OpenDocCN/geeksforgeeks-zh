...
> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxtabs-unselecting-event/](https://www.geeksforgeeks.org/jqwidgets-jqxtabs-unselecting-event/)
...
**取消选择事件**用于用户选择标签时触发。触发此事件后，最后选定的选项卡将变为未选定。

## 语法

```javascript
$('Selector').on('unselecting', function (event) { });
```
...
下面的例子说明了 jQWidgets jqxTabs 取消选择事件。
...
<body>
    <center>
        ...
        <h3>
            jQWidgets jqxTabs unselecting Event
        </h3>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#jqxTabs').on('unselecting', function (event) {
                alert('Tab unselecting event triggered');
            });
        });
    </script>
</body>
...
![](img/9ea7cf4419b8c1c64305977f2d07dc51.png)
