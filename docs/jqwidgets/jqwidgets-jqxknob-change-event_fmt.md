...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxknob-change-event/](https://www.geeksforgeeks.org/jqwidgets-jqxknob-change-event/)
...
当指定的 `jqxKnob` 的值改变时，触发 `change` 事件。
...
**示例:** 以下示例说明了 jQWidgets jqxKnob `change` 事件。
