# jQWidgets jqxTagCloud minValueToDisplay 属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxtagcloud-minvaluetodisplay-property/](https://www.geeksforgeeks.org/jqwidgets-jqxtagcloud-minvaluetodisplay-property/)
...
`minValueToDisplay` 属性用于设置或获取值低于指定值的标签。
...
以下示例说明了 jQWidgets `jqxTagCloud` `minValueToDisplay` 属性。在下面的例子中，`minValueToDisplay` 属性的值被设置为 1。
