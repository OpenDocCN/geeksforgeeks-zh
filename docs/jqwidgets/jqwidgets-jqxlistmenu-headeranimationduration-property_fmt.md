# jQWidgets jqxListMenu headerAnimationDuration 属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxlistmenu-headeranimationduration-property/](https://www.geeksforgeeks.org/jqwidgets-jqxlistmenu-headeranimationduration-property/)
...
`headerAnimationDuration` 属性用于设置或返回头部的动画持续时间。它接受数字类型的值，默认值为 0。
