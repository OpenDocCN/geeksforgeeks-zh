...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxtreegrid-showstatusbar-property/](https://www.geeksforgeeks.org/jqwidgets-jqxtreegrid-showstatusbar-property/)
...
以下示例说明了 jQWidgets `jqxTreeGrid` `showStatusbar` 属性。在下面的例子中， `showStatusbar` 属性的值被设置为 `true` 。
...
<body>
    <center>
        ...
        <h3>jQWidgets jqxTreeGrid showStatusbar Property</h3>
