...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxcheckbox-focus-method/](https://www.geeksforgeeks.org/jqwidgets-jqxcheckbox-focus-method/)
...
`focus()` 方法用于聚焦复选框。它不接受任何参数，也不返回值。
