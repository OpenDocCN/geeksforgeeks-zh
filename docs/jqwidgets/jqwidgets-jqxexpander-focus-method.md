...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxexpander-focus-method/](https://www.geeksforgeeks.org/jqwidgets-jqxexpander-focus-method/)
...
**对焦()方法用于对焦扩展器**。对焦后可以使用键盘导航。它不接受任何参数，也不返回值。
