...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxscrollbar-width-property/](https://www.geeksforgeeks.org/jqwidgets-jqxscrollbar-width-property/)
...
`width` 属性用于设置或获取指定 `jqxScrollBar` 的宽度。
...
下面的示例说明了 jQWidgets jqxScrollBar `width` 属性。在下面的例子中，`width` 属性的值被设置为 300。
