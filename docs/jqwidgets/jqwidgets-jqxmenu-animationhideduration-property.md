# jQWidgets jqxMenu 动画持续时间属性

> 哎哎哎:# t0]https://www . geeksforgeeks . org/jqwidgets-jqxmenu-animation hideduration-property/
...
animationHideDuration 属性用于设置或返回隐藏动画的持续时间。它接受数字类型值，默认值为 250。
...
下面的例子说明了 jQWidgets jqxMenu animationhidedduration 属性。
...
    <h3>
        jQWidgets jqxMenu animationHideDuration Property
    </h3>
...
![](img/9902a474d265302fdf7557ca2267c9e6.png)
