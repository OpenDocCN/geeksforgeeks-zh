...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxslider-values-property/](https://www.geeksforgeeks.org/jqwidgets-jqxslider-values-property/)
...
**值属性**用于设置或返回范围滑块的值。对于此属性，“范围滑块”属性应设置为真。它接受数组类型值，默认值为[0，10]。
...
下面的例子说明了 jQWidgets jqxSlider 值属性。
