...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxcombobox-focus-method/](https://www.geeksforgeeks.org/jqwidgets-jqxcombobox-focus-method/)
...
**示例:**下面的示例说明了 jQWidgets 中的 jqxComboBox **focus()** 方法。
