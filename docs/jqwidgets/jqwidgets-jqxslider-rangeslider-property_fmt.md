...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxslider-rangeslider-property/](https://www.geeksforgeeks.org/jqwidgets-jqxslider-rangeslider-property/)
...
`rangeSlider` 属性用于设置或返回滑块是否显示为范围滑块并有两个拇指。它接受布尔类型值，默认值为 `false`。
