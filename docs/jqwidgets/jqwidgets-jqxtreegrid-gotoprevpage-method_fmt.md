# jqxTreeGrid goToPrevPage()方法

> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxtreegrid-gotoprevpage-method/](https://www.geeksforgeeks.org/jqwidgets-jqxtreegrid-gotoprevpage-method/)
...
下面的示例说明了 jQWidgets `jqxTreeGrid` 的 `goToPrevPage()` 方法。
      ...
      <center>
         ...
         <script type="text/javascript">
            $(document).ready(function () {
                ...
                $("#jqxTreeGrid").jqxTreeGrid('goToPage', 3);

                $('#button_for_goToPrevPage').click(function () {
                    $("#jqxTreeGrid").jqxTreeGrid('goToPrevPage');
                });
            });
         </script>
      </center>
