...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxcombobox-close-method/](https://www.geeksforgeeks.org/jqwidgets-jqxcombobox-close-method/)
...
**示例:**下面的示例说明了 jQWidgets 中的 jqxComboBox **close()** 方法。
