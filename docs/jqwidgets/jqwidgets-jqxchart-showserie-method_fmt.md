...
> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxchart-showserie-method/](https://www.geeksforgeeks.org/jqwidgets-jqxchart-showserie-method/)
...
`showSerie()` 方法用于显示图表系列。它采用数字类型值，不返回任何值。
