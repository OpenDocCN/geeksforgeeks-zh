...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxchart-saveasjpeg-method/](https://www.geeksforgeeks.org/jqwidgets-jqxchart-saveasjpeg-method/)
...
**示例:**下面的示例说明了 jQWidgets 中的 jqxChart saveAsJPEG()方法:
