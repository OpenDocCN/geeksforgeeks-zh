# jQWidgets jqxWindow zIndex 属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxwindow-zindex-property/](https://www.geeksforgeeks.org/jqwidgets-jqxwindow-zindex-property/)

**jQWidgets** 是一个 JavaScript 框架，用于为 PC 和移动设备制作基于 web 的应用程序。它是一个非常强大、优化、独立于平台并且得到广泛支持的框架。`jqxWindow` 用于在应用程序中输入数据或查看信息。

`zIndex` 属性用于设置或获取指定的 `jqxWindow` 的 z-index。
...
下面的示例说明了 `jQWidgets` 中的 `jqxWindow` `zIndex` 属性。在下面的示例中，`zIndex` 已被设置为 9999。
