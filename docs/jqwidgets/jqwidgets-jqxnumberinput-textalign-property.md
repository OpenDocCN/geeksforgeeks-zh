# jQWidgets jqxnumber 输入文本对齐属性

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxnumberinput-textalign-property/](https://www.geeksforgeeks.org/jqwidgets-jqxnumberinput-textalign-property/)
...
**textAlign 属性**用于设置或返回 jqxNumberInput 小部件的对齐方式。它接受字符串类型的值，默认值为“正确”。
...
下面的例子说明了 jQWidgets jqxnumber input textAlign 属性。
