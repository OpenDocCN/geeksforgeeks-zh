...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxcombobox-unselectindex-method/](https://www.geeksforgeeks.org/jqwidgets-jqxcombobox-unselectindex-method/)
...
`unselectIndex()` 方法用于通过使用索引号来取消选择该项。`jqxComboBox` 使用从零开始的索引。它接受数字类型的单个参数 `index`，并且不返回任何值。
