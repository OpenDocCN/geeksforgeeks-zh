...
> 原文:[https://www . geesforgeks . org/jqwidgets-jqxchart-save aspng-method/](https://www.geeksforgeeks.org/jqwidgets-jqxchart-saveaspng-method/)
...
**saveAsPNG()方法**用于将图表内容导出为 PNG 图像。它以 fileName、exportServer 类型值为参数，采用 String 类型值，不返回值。
...
**示例:**下面的示例说明了 jQWidgets 中的 jqxChart saveAsPNG()方法:
