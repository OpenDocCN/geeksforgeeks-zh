...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxscheduler-touchrowsheight-property/](https://www.geeksforgeeks.org/jqwidgets-jqxscheduler-touchrowsheight-property/)
...
`touchRowsHeight` 属性用于设置或返回触摸设备上显示的 `jqxScheduler` 中的行高。它属于数字类型，默认值为 37。
...
以下示例说明了 `jQWidgets` 中的 `jqxScheduler` `touchRowsHeight` 属性。
...
<body>
    <center>
        ...
        <h3>jQWidgets jqxScheduler touchRowsHeight property</h3>
