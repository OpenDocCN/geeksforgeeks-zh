...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxtreemap-hoverenabled-property/](https://www.geeksforgeeks.org/jqwidgets-jqxtreemap-hoverenabled-property/)
...
以下示例说明了 `jQWidgets` `jqxTreeMap` `悬停启用` 属性。在以下示例中，`悬停启用` 属性的值已设置为真。
