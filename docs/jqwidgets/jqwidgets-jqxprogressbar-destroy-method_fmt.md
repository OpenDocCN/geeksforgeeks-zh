# jQWidgets jqxProgressBar 销毁()方法

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxprogressbar-destroy-method/](https://www.geeksforgeeks.org/jqwidgets-jqxprogressbar-destroy-method/)
...
`销毁()`方法用于销毁进度条小部件。它不接受任何参数，也不返回值。
