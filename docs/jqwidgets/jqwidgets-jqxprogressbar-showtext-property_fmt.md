# jQWidgets jqxProgressBar showText 属性

> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxprogressbar-showtext-property/](https://www.geeksforgeeks.org/jqwidgets-jqxprogressbar-showtext-property/)
...
`showText` 属性用于设置或返回进度条在百分比文本中的可见性。它接受布尔类型值，默认值为 `false`。
