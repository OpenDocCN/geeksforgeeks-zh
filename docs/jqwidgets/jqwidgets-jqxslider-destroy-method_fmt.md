# jQWidgets jqxSlider 销毁()方法

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxslider-destroy-method/](https://www.geeksforgeeks.org/jqwidgets-jqxslider-destroy-method/)
...
下面的例子说明了 jQWidgets `jqxSlider` `destroy()` 方法。
...
<body>
    <center>
        ...
        <h3>
            jQWidgets jqxSlider destroy() Method
        </h3>
...
![](img/4c34c164465b6a951aaa3fd8fd8fd328.png)
