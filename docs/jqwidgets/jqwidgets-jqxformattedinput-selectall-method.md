# jQWidgets jqxformatedinput selectAll()方法

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxformatedinput-selectall-method/](https://www.geeksforgeeks.org/jqwidgets-jqxformattedinput-selectall-method/)
...
**selectAll()方法**用于选择输入字段的所有文本。它不接受任何参数，也不返回值。
...
下面的例子说明了 jQWidgets jqxformatedinput selectAll()方法。
