...
> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxheatmap-reverseyaxisposition-method/](https://www.geeksforgeeks.org/jqwidgets-jqxheatmap-reverseyaxisposition-method/)
...
`reverseYAxisPosition()` 方法用于反转设置 y 轴位置。它采用布尔类型值，不返回任何值。
...
以下示例说明了 jQWidgets 中的 `jqxHeatMap` `reverseYAxisPosition()` 方法:
