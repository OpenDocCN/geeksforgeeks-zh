...
> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxbulletchart-title-property/](https://www.geeksforgeeks.org/jqwidgets-jqxbulletchart-title-property/)
...
`title` 属性用于设置或返回 bulletcharts 的标题。它接受字符串类型值，默认值为“Title”。
...
下面的示例说明了 jQWidgets 中的 `jqxBulletChart` `title` 属性。
