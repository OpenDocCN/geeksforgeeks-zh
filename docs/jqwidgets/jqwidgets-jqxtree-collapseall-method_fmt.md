...
> 原文：[https://www.geeksforgeeks.org/jqwidgets-jqxtree-collapseall-method/](https://www.geeksforgeeks.org/jqwidgets-jqxtree-collapseall-method/)
...
`collapseAll()`方法用于折叠小部件的所有项目。它不接受任何参数，也不返回值。

**语法：**

```javascript
$('Selector').jqxTree('collapseAll');
```
...
下面的例子说明了 jQWidgets jqxTree `collapseAll()`方法。
...
![](img/69be1c7c5fc58c224e172b7207b41c6d.png)
