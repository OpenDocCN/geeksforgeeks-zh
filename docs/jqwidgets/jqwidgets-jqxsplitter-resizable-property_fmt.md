# jQWidgets jqxSplitter 可调整大小属性

> 原文: [https://www.geeksforgeeks.org/jqwidgets-jqxsplitter-resizable-property/](https://www.geeksforgeeks.org/jqwidgets-jqxsplitter-resizable-property/)
...
`resizable` 属性用于设置或获取指定 `jqxSplitter` 的可调整大小属性。
...
以下示例说明了 jQWidgets `jqxSplitter` 的 `resizable` 属性。在下面的例子中，`resizable` 属性的值被设置为 `true`。
