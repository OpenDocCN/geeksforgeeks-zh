# jqwidgets jqxtoltip 不透明性质

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxtooltip-不透明度-property/](https://www.geeksforgeeks.org/jqwidgets-jqxtooltip-opacity-property/)
...
*不透明度*属性用于设置或返回工具提示元素的不透明度。它接受数字类型值，默认值为 0.9。不透明度值必须介于 0 和 1 之间。
...
**示例:**以下示例说明了 jQWidgets jqxTooltip *不透明度*属性。
