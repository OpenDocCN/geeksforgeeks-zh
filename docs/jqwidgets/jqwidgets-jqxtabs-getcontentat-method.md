# jqwidgets jqxtabs get content()方法

> 原文:[https://www . geesforgeks . org/jqwidgets-jqxtabs-getcontentat-method/](https://www.geeksforgeeks.org/jqwidgets-jqxtabs-getcontentat-method/)
...
**getContentAt()方法**用于获取一个 Tab 的内容。它接受数字类型的单参数索引。索引从 0 开始。它返回字符串类型值(选项卡内容)。
