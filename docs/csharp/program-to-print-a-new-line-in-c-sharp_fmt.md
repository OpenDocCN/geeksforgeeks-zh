...
> 原文：[https://www.geeksforgeeks.org/program-to-print-a-new-line-in-c-sharp/](https://www.geeksforgeeks.org/program-to-print-a-new-line-in-c-sharp/)

有多种方法可以在消息中打印新行。

*   使用：`\n` – 打印新行。
*   通过使用：`\x0A` 或 `\xA` (ASCII 文字为 `\n`) – 它会打印新行。
