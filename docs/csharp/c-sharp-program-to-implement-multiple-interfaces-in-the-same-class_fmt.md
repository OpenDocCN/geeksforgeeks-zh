...
> 原文：[https://www.geeksforgeeks.org/c-sharp-program-to-implement-multiple-interfaces-in-the-same-class/](https://www.geeksforgeeks.org/c-sharp-program-to-implement-multiple-interfaces-in-the-same-class/)
...
2.  创建三个名为`firstinterface`、`secondinterface`和`thirdinterface`的接口，并在其中声明方法。
...
*   之后，在`Int_Class`中，我们定义了`myfun1`、`myfun2`和`myfun3`的定义。
