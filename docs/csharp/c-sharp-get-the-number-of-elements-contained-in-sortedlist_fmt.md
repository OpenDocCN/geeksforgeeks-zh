...
> 原文：[https://www.geeksforgeeks.org/c-sharp-get-the-number-of-elements-contained-in-sortedlist/](https://www.geeksforgeeks.org/c-sharp-get-the-number-of-elements-contained-in-sortedlist/)

`SortedList.Count` 属性用于获取 `SortedList` 对象中包含的元素数量。
...
*   [https://docs.microsoft.com/en-us/dotnet/api/system.collections.sortedlist.count?view=netframework-4.7.2](https://docs.microsoft.com/en-us/dotnet/api/system.collections.sortedlist.count?view=netframework-4.7.2)