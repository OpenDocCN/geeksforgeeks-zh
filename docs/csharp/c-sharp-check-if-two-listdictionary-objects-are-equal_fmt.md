...
> 原文：[https://www.geeksforgeeks.org/c-sharp-check-if-two-listdictionary-objects-are-equal/](https://www.geeksforgeeks.org/c-sharp-check-if-two-listdictionary-objects-are-equal/)

`Equals(Object)`方法从`Object`类继承而来，用于检查指定的`ListDictionary`对象是否等于另一个列表字典对象。
