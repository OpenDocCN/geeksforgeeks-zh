...
> 原文：[https://www.geeksforgeeks.org/getting-the-hash-code-of-the-given-index-in-c-sharp/](https://www.geeksforgeeks.org/getting-the-hash-code-of-the-given-index-in-c-sharp/)

在 C# 8.0 中引入了[`Index`结构](https://www.geeksforgeeks.org/index-struct-in-c-sharp-8-0/)。它表示可用于索引集合或序列的类型，并且可以从开始或结束开始。您可以借助`Index`结构提供的`GetHashCode()`方法找到指定索引的哈希码。此方法返回指定索引的哈希代码。
