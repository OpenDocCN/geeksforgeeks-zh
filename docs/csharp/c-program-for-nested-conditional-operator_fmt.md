...
> 原文：[https://www.geeksforgeeks.org/c-program-for-nested-conditional-operator/](https://www.geeksforgeeks.org/c-program-for-nested-conditional-operator/)
...
通过上面的条件操作符，它逐个检查条件是否为真，然后执行`真_块`，否则执行`假_块`，如果第一个为假，则执行`假_块_外部`。
