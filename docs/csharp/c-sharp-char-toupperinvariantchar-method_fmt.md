...
> 原文：[https://www.geeksforgeeks.org/c-sharp-char-toupperinvariantchar-method/](https://www.geeksforgeeks.org/c-sharp-char-toupperinvariantchar-method/)
...
如果 `c` 已经是大写或者不是字母，这个方法返回 `c` 参数的大写等价物，或者 `c` 的不变值。

以下程序说明了 `Char.ToUpperInvariant()` 方法的使用：
...
*   [`https://docs.microsoft.com/en-us/dotnet/api/system.char.toupperinvariant?view=netframework-4.7.2`](https://docs.microsoft.com/en-us/dotnet/api/system.char.toupperinvariant?view=netframework-4.7.2)