...
> 原文：[https://www.geeksforgeeks.org/basic-crud-create-read-update-delete-in-asp-net-mvc-using-c-sharp-and-entity-framework/](https://www.geeksforgeeks.org/basic-crud-create-read-update-delete-in-asp-net-mvc-using-c-sharp-and-entity-framework/)
...
之后，添加视图，但记得将模板更改为列表。然后运行项目，转到 URL `https://localhost:port_number/Controller_name/Action_Method_name`
...
在此之后，添加视图与之前类似，但是记住将模板更改为编辑。然后运行项目，转到网址 `https://localhost:port_number/Controller_name/Action_Method_name?想要编辑`
...
如前所述添加视图后，请记住将模板更改为删除。然后运行项目，转到网址 `https://localhost:port_number/Controller_name/Action_Method_name?ID_U_want_Delete`
