# C# 检查两个 HashSet<T> 对象是否相等

> 原文：[https://www.geeksforgeeks.org/c-sharp-check-if-two-hashsett-objects-are-equal/](https://www.geeksforgeeks.org/c-sharp-check-if-two-hashsett-objects-are-equal/)

从 `Object` 类继承的 `Equals(Object)` 方法用于检查指定的 [`HashSet<T>`](https://www.geeksforgeeks.org/c-sharp-hashset-class/) 对象是否等于另一个 `HashSet<T>` 对象。
