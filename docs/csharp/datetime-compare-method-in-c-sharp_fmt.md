...
> 原文：[https://www.geeksforgeeks.org/datetime-compare-method-in-c-sharp/](https://www.geeksforgeeks.org/datetime-compare-method-in-c-sharp/)
...
该方法返回一个有符号数，表示 `t1` 和 `t2` 的相对值。

> **小于零**: 如果 `t1` 早于 `t2`。
> **零**: 如果 `t1` 和 `t2` 一样。
> **大于零**: 如果 `t1` 晚于 `t2`。

以下程序说明了 `DateTime.Compare(DateTime, DateTime)` 方法的使用：
...
*   [https://docs.microsoft.com/en-us/dotnet/api/system.datetime.compare?view=netframework-4.7.2](https://docs.microsoft.com/en-us/dotnet/api/system.datetime.compare?view=netframework-4.7.2)