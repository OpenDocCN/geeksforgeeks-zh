...
| 方法 | 描述 |
| --- | --- |
| **[`CompareTo()`](https://www.geeksforgeeks.org/int32-compareto-method-in-c-sharp-with-examples/)** | 此方法用于将此实例与指定的对象或 `Int32` 进行比较，并返回其相对值的指示。 |
...
| **[`ToString()`](https://www.geeksforgeeks.org/c-sharp-int32-tostring-method-set-1/)** | 此方法用于将此实例的数值转换为其等效的字符串表示形式。 |
