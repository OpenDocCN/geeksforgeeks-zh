...
> 原文: [https://www.geeksforgeeks.org/linq-filtering-operator-where/](https://www.geeksforgeeks.org/linq-filtering-operator-where/)
...
`Where` 运算符根据谓词函数筛选值。或者换句话说，我们可以说它根据给定的条件或标准从序列中返回值。`Where` 子句不是查询中的强制子句。
