...
[关键词](https://www.geeksforgeeks.org/c-sharp-keywords/) 是一种语言中用于某种内部过程或代表某种预定义动作的词语。`ushort` 是一个关键字，用于声明一个变量，该变量可以存储范围从 `0` 到 `65,535` 的无符号整数值。是 `System.UInt16` 的别名。
