...
> 原文: [https://www.geeksforgeeks.org/datetime-fromfiletime-method-in-c-sharp/](https://www.geeksforgeeks.org/datetime-fromfiletime-method-in-c-sharp/)

`DateTime.FromFileTime(Int64)`方法用于将指定的 Windows 文件时间转换为等效的本地时间。
...
## 返回值
该方法返回一个对象，该对象表示文件时间参数表示的日期和时间的本地时间等价物。

## 异常
如果文件时间小于 0 或代表大于最大值的时间，该方法将给出`ArgumentOutOfRangeException`。

以下程序说明了`DateTime.FromFileTime(Int64)`方法的使用:
...
## 参考
*   [https://docs.microsoft.com/en-us/dotnet/api/system.datetime.fromfiletime?view=netframework-4.7.2](https://docs.microsoft.com/en-us/dotnet/api/system.datetime.fromfiletime?view=netframework-4.7.2)