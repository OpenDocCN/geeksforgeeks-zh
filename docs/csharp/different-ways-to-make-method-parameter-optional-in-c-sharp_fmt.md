...
> 原文：[https://www.geeksforgeeks.org/different-ways-to-make-method-parameter-optional-in-c-sharp/](https://www.geeksforgeeks.org/different-ways-to-make-method-parameter-optional-in-c-sharp/)
...
## 2. By using [Method Overloading](https://www.geeksforgeeks.org/c-sharp-method-overloading/)
...
**例：** 这里我们有两个同名的方法，但是这些方法的参数表不同，即第一个 `my_mul` 方法只取一个参数，第二个 `my_mul` 方法取三个参数。
