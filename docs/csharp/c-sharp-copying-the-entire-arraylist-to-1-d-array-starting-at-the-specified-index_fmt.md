...
> 原文:[https://www.geeksforgeeks.org/c-sharp-copying-the-entire-arraylist-to-1-d-array-starting-at-the-specified-index/](https://www.geeksforgeeks.org/c-sharp-copying-the-entire-arraylist-to-1-d-array-starting-at-the-specified-index/)

`ArrayList.CopyTo(Array, Int32)`方法用于将整个[ArrayList](https://www.geeksforgeeks.org/c-arraylist-class/)复制到兼容的一维数组中，从目标数组的指定索引处开始。
...
## 参数:
- `array`: 一维数组是从数组列表中复制的元素的目的地。数组必须具有从零开始的索引。
- `arrayIndex`: 是`array`中开始复制的从零开始的索引。

## 异常:
- `ArgumentNullException`: 如果`array`为空。
- `ArgumentOutOfRangeException`: 如果`arrayIndex`小于零。
- `ArgumentException`: 如果数组是多维的，或者源数组列表中的元素数量大于目标数组可以包含的元素数量。
- `InvalidCastException`: 如果源数组列表的类型不能自动转换为目标`array`的类型。
...
## 参考:
- [https://docs.microsoft.com/en-us/dotnet/api/system.collections.arraylist.copyto?view=netframework-4.7.2#System_Collections_ArrayList_CopyTo_System_Array_System_Int32_](https://docs.microsoft.com/en-us/dotnet/api/system.collections.arraylist.copyto?view=netframework-4.7.2#System_Collections_ArrayList_CopyTo_System_Array_System_Int32_)