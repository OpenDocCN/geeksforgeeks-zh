...
> 原文: [https://www.geeksforgeeks.org/c-sharp-how-to-get-typecode-for-the-class-string/](https://www.geeksforgeeks.org/c-sharp-how-to-get-typecode-for-the-class-string/)

`GetTypeCode()` 方法用于获取指定字符串的 `TypeCode`。
...
*   [https://docs.microsoft.com/en-us/dotnet/api/system.string.gettypecode?view=netframework-4.7.2](https://docs.microsoft.com/en-us/dotnet/api/system.string.gettypecode?view=netframework-4.7.2)