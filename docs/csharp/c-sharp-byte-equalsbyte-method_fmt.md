...
> 原文：[https://www.geeksforgeeks.org/c-sharp-byte-equalsbyte-method/](https://www.geeksforgeeks.org/c-sharp-byte-equalsbyte-method/)
...
**返回值：** 此方法返回 `true` 如果 `obj` 等于此实例，否则返回 `false`。

以下程序说明了 `Byte.Equals(byte)` 方法的使用：
...
*   [https://docs.microsoft.com/en-us/dotnet/api/system.byte.equals?view=netframework-4.7.2#System_Byte_Equals_System_Byte_](https://docs.microsoft.com/en-us/dotnet/api/system.byte.equals?view=netframework-4.7.2#System_Byte_Equals_System_Byte_)