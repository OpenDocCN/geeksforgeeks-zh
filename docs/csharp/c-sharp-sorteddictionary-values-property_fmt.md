# C# | SortedDictionary.Values 属性

> 原文：[https://www.geeksforgeeks.org/c-sharp-sorteddictionary-values-property/](https://www.geeksforgeeks.org/c-sharp-sorteddictionary-values-property/)
...
它返回一个包含 `SortedDictionary` 中的值的集合。
...
*   [https://docs.microsoft.com/en-us/dotnet/api/system.collections.generic.sorteddictionary-2.values?view=netframework-4.7.2](https://docs.microsoft.com/en-us/dotnet/api/system.collections.generic.sorteddictionary-2.values?view=netframework-4.7.2)