...
> 原文: [https://www.geeksforgeeks.org/c-sharp-check-if-two-list-objects-are-equal/](https://www.geeksforgeeks.org/c-sharp-check-if-two-list-objects-are-equal/)

从 `Object` 类继承的 `Equals(Object)` 方法用于检查指定的 `List<T>` 对象是否等于另一个 `List<T>` 对象。
