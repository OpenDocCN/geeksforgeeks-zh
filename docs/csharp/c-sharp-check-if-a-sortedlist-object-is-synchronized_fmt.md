...
> 原文：[https://www.geeksforgeeks.org/c-sharp-check-if-a-sortedlist-object-is-synchronized/](https://www.geeksforgeeks.org/c-sharp-check-if-a-sortedlist-object-is-synchronized/)
...
如果对 `SortedList` 对象的访问是同步的(线程安全的)，则此方法返回 `True`，否则此方法返回 `False`。默认值为 `假`。
...
*   [`https://docs.microsoft.com/en-us/dotnet/api/system.collections.sortedlist.issynchronized?view=netframework-4.7.2`](https://docs.microsoft.com/en-us/dotnet/api/system.collections.sortedlist.issynchronized?view=netframework-4.7.2)