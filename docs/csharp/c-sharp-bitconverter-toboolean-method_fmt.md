...
> 原文: [https://www.geeksforgeeks.org/c-sharp-bitconverter-toboolean-method/](https://www.geeksforgeeks.org/c-sharp-bitconverter-toboolean-method/)
...
如果值中 `startIndex` 处的字节非零，则该方法返回真，否则返回假。
...
以下程序说明了 `BitConverter.ToBoolean(Byte[], Int32)` 方法的使用:
...
*   [https://docs.microsoft.com/en-us/dotnet/api/system.bitconverter.toboolean?view=netframework-4.7.2](https://docs.microsoft.com/en-us/dotnet/api/system.bitconverter.toboolean?view=netframework-4.7.2)