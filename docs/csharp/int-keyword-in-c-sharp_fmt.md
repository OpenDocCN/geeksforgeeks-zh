...
[关键词](https://www.geeksforgeeks.org/c-sharp-keywords/) 是一种语言中用于某种内部过程或代表某种预定义动作的词语。`int` 是一个关键字，用于声明一个变量，该变量可以存储从 `-2,147,483,648` 到 `2,147,483,647` 范围内的整数值类型(有符号整数)。是 `System.Int32` 的别名。
