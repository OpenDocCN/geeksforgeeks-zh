...
> 原文：[https://www.geeksforgeeks.org/int64-equals-method-in-c-sharp-with-examples/](https://www.geeksforgeeks.org/int64-equals-method-in-c-sharp-with-examples/)

`Int64.Equals()` 方法用于获取一个值，该值显示当前实例是否等于指定对象或 `Int64`。此方法的重载列表中有 2 种方法，如下所示：
...
以下程序说明了 `Int64.Equals(Int64)` 方法的使用：
...
>
> **返回值：** 如果 `obj` 是 `Int64` 的实例，并且等于该实例的值，则该方法返回 `true`，否则返回 `false`。
...
*   [https://docs.microsoft.com/en-us/dotnet/api/system.int64.equals?view=netframework-4.7.2](https://docs.microsoft.com/en-us/dotnet/api/system.int64.equals?view=netframework-4.7.2)