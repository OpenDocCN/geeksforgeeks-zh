...
> 原文：[https://www.geeksforgeeks.org/c-sharp-sorteddictionary-clear-method/](https://www.geeksforgeeks.org/c-sharp-sorteddictionary-clear-method/)

该方法用于从 `SortedDictionary<TKey, TValue>` 中移除所有键/值对。
