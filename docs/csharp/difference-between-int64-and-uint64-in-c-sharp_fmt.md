...
> 原文：[https://www.geeksforgeeks.org/difference-between-int64-and-uint64-in-c-sharp/](https://www.geeksforgeeks.org/difference-between-int64-and-uint64-in-c-sharp/)
...
| 4. | 占用内存中 8 字节空间。 | 还需要占用内存中 8 字节的空间。 |
| 5. | `Int64` 的范围是从 -9223372036854775808 到 +922372036854775807。 | `UInt64` 范围从 0 到 18446744073709551615。 |
| 6. | 声明 `Int64` 的语法：<br>```cs<br>Int64 variable_name;<br>``` | 声明 `UInt64` 的语法：<br>```cs<br>UInt64 variable_name;<br>``` |