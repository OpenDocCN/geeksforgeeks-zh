...
[关键词](https://www.geeksforgeeks.org/c-sharp-keywords/) 是一种语言中用于某种内部过程或代表某种预定义动作的词语。`char` 是一个关键字，用于声明一个变量，该变量存储从 `+U0000 到 U+FFFF` 范围内的字符值。是 [`System.Char`](https://www.geeksforgeeks.org/c-sharp-char-struct/) 的别名。
