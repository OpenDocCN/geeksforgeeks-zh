...
`Uri.Equals(Object)` 方法用于比较两个 `Uri` 实例是否相等。
...
如果两个实例代表相同的 URI，则该方法返回布尔值 `true`，否则返回 `false`。

下面的程序说明了 `Uri.Equals(Object)` 方法的使用：
...
*   [https://docs.microsoft.com/en-us/dotnet/api/system.uri.equals?view=netstandard-2.1](https://docs.microsoft.com/en-us/dotnet/api/system.uri.equals?view=netstandard-2.1)