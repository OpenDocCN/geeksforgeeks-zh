...
> 原文：[https://www.geeksforgeeks.org/different-ways-to-sort-an-array-in-descending-order-in-c-sharp/](https://www.geeksforgeeks.org/different-ways-to-sort-an-array-in-descending-order-in-c-sharp/)
...
## 方法一：使用 `Array.Sort()` 和 `Array.Reverse()` 方法
首先，使用 [`Array.Sort()`](https://www.geeksforgeeks.org/how-to-sort-an-array-in-c-sharp-array-sort-method-set-1/) 方法将一个数组按升序排序，然后使用 `Array.Reverse()` 方法将其反转。
