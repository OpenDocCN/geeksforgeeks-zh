...
> 原文: [https://www.geeksforgeeks.org/c-sharp-check-if-two-stringcollection-objects-are-equal/](https://www.geeksforgeeks.org/c-sharp-check-if-two-stringcollection-objects-are-equal/)

## Equals(object) 方法
`Equals(object)` 方法继承自 `Object` 类，用于检查指定的 `StringCollection` 对象是否等于另一个字符串集合对象。
