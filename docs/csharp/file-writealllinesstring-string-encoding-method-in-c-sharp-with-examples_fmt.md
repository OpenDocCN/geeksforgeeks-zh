# File.WriteAllLines(String, String[], Encoding) 方法详解及示例

> 原文: [https://www.geeksforgeeks.org/file-writealllinesstring-string-encoding-method-in-c-sharp-with-examples/](https://www.geeksforgeeks.org/file-writealllinesstring-string-encoding-method-in-c-sharp-with-examples/)

`File.WriteAllLines(String, String[], Encoding)` 是一个内置的 `File` 类方法，用于创建新文件，使用指定的编码将指定的字符串数组写入文件，然后关闭文件。
...
*   `path`: 这是指定的文件，将把字符串数组写入此文件。
*   `contents`: 这是要写入文件的字符串数组。
*   `encoding`: 这表示应用于字符串数组的字符编码。
...
下面是说明 `File.WriteAllLines(String, String[], Encoding)` 方法的程序。
...
// of File.WriteAllLines(String, String[], Encoding) method

// Using System, System.IO and System.Text namespaces
using System;
using System.IO;
using System.Text;
...
class GFG {
    public static void Main()
    {
        ...
        // Creating some string array to write into the file
