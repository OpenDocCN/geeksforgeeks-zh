# C# | SortedDictionary.Count 属性

> 原文：[https://www.geeksforgeeks.org/c-sharp-sorteddictionary-count-property/](https://www.geeksforgeeks.org/c-sharp-sorteddictionary-count-property/)

此属性用于获取包含在 `SortedDictionary<TKey, TValue>` 中的键/值对的数量。
...
## 返回值
返回 `SortedDictionary` 中包含的键/值对的个数。
