...
> 原文: [https://www.geeksforgeeks.org/program-to-input-weekday-number-and-print-the-weekday-in-c-sharp/](https://www.geeksforgeeks.org/program-to-input-weekday-number-and-print-the-weekday-in-c-sharp/)

C# 程序打印给定工作日号码（0-6）的工作日名称。一个 [`switch` 语句](https://www.geeksforgeeks.org/switch-statement-in-c-sharp/) 允许用一个值或事例列表检查一个值。
