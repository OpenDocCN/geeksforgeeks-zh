...
> 原文: [https://www.geeksforgeeks.org/how-to-set-the-name-of-the-checkbox-in-c-sharp/](https://www.geeksforgeeks.org/how-to-set-the-name-of-the-checkbox-in-c-sharp/)
...
3.  **步骤 3:** 拖放后，您将转到 CheckBox 控件的属性，使用`名称属性`设置 CheckBox 的名称。
...
比上面的方法稍微复杂一点。在此方法中，您可以使用以下语法以编程方式设置复选框的`名称属性`:

```cs
public string Name { get; set; }
```

这里，CheckBox 的`名称`是字符串类型的。以下步骤用于设置复选框的`名称属性`:
...
2.  **步骤 2:** 创建 CheckBox 后，设置`CheckBox`类提供的 CheckBox 的`Name`属性。
