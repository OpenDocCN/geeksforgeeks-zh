...
[关键词](https://www.geeksforgeeks.org/c-sharp-keywords/) 是一种语言中用于某种内部过程或代表某种预定义动作的词语。`long` 是一个关键字，用于声明一个变量，该变量可以存储范围从 **-9,223,372,036,854,775,808** 到 **9,223,372,036,854,775,807** 的带符号整数值。是 `System.Int64` 的别名。
