# C# 获取或设置与排序列表中指定键相关联的值

> 原文：[https://www.geeksforgeeks.org/c-sharp-get-or-set-the-value-associated-with-specified-key-in-sortedlist/](https://www.geeksforgeeks.org/c-sharp-get-or-set-the-value-associated-with-specified-key-in-sortedlist/)

`SortedList.Item[Object]`属性用于获取和设置与排序列表对象中特定键相关联的值。
...
这里，`key`与要获取或设置的值相关联。它属于`object`类型。

**返回值：** 如果找到了与排序列表对象中的`key`参数相关联的值，则该属性返回空值。
...
- [https://docs.microsoft.com/en-us/dotnet/api/system.collections.sortedlist.item?view=netframework-4.7.2](https://docs.microsoft.com/en-us/dotnet/api/system.collections.sortedlist.item?view=netframework-4.7.2)