...
[关键词](https://www.geeksforgeeks.org/c-sharp-keywords/) 是一种语言中用于某种内部过程或代表某种预定义动作的词语。`ulong` 是用于声明变量的关键字，该变量可以存储范围从 `0` 到 `18,446,744,073,709,551,615` 的无符号整数值。是 `System.UInt64` 的别名。

`ulong` 关键字占用内存中 8 字节(64 位)的空间。
