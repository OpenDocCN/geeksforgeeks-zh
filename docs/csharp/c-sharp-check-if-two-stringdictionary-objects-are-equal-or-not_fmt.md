...
> 原文：[https://www.geeksforgeeks.org/c-sharp-check-if-two-stringdictionary-objects-are-equal-or-not/](https://www.geeksforgeeks.org/c-sharp-check-if-two-stringdictionary-objects-are-equal-or-not/)

`Equals(Object)`方法是从[`Object`](https://www.geeksforgeeks.org/c-object-class/)类继承而来的，用于检查一个指定的字符串对象是否等于另一个[`StringDictionary`](https://www.geeksforgeeks.org/c-stringdictionary-class/)对象。
