...
> 原文：[https://www.geeksforgeeks.org/decimal-gettypecode-method-in-c-sharp-with-examples/](https://www.geeksforgeeks.org/decimal-gettypecode-method-in-c-sharp-with-examples/)

`Decimal.GetTypeCode` 方法用于获取值类型 `Decimal` 的类型代码。
...
## 参考
*   [https://docs.microsoft.com/en-us/dotnet/api/system.decimal.gettypecode?view=netframework-4.7.2](https://docs.microsoft.com/en-us/dotnet/api/system.decimal.gettypecode?view=netframework-4.7.2)