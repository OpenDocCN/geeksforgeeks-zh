...
> 原文：[https://www.geeksforgeeks.org/csharp-program-to-check-if-strings-are-rotations-of-each-other-or-not/](https://www.geeksforgeeks.org/csharp-program-to-check-if-strings-are-rotations-of-each-other-or-not/)
