...
> 原文：[https://www.geeksforgeeks.org/how-to-create-a-shallow-copy-of-sortedlist-object-in-c-sharp/](https://www.geeksforgeeks.org/how-to-create-a-shallow-copy-of-sortedlist-object-in-c-sharp/)

## `SortedList.Clone()` 方法

`SortedList.Clone()` 方法用于创建一个 [`SortedList`](https://www.geeksforgeeks.org/c-sortedlist-class/) 对象的浅拷贝。
...
**返回值：** 它返回一个浅拷贝的 [`SortedList`](https://www.geeksforgeeks.org/c-sortedlist-class/) 对象。返回值的类型为 `Object`。
...
*   [https://docs.microsoft.com/en-us/dotnet/api/system.collections.sortedlist.clone?view=netframework-4.7.2](https://docs.microsoft.com/en-us/dotnet/api/system.collections.sortedlist.clone?view=netframework-4.7.2)