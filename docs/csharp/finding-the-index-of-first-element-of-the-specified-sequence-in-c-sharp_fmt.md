...
> 原文：[https://www.geeksforgeeks.org/finding-the-index-of-first-element-of-the-specified-sequence-in-c-sharp/](https://www.geeksforgeeks.org/finding-the-index-of-first-element-of-the-specified-sequence-in-c-sharp/)

在 C# 8.0 中引入了[索引结构](https://www.geeksforgeeks.org/index-struct-in-c-sharp-8-0/)。它表示可用于索引集合或序列的类型，并且可以从开始或结束开始。您可以在`Index`结构提供的`开始`属性的帮助下找到指向指定集合或序列的第一个元素的索引。
