...
> 原文：[https://www.geeksforgeeks.org/c-sharp-how-to-change-the-windowheight-of-the-console/](https://www.geeksforgeeks.org/c-sharp-how-to-change-the-windowheight-of-the-console/)

给定 C# 中的普通控制台，任务是更改控制台的窗口高度。

## 方法
这可以使用 C# 中 `System` 包的 `Console` 类中的 `WindowHeight` 属性来完成。`WindowHeight` 是指控制台窗口的高度，单位为行。
