...
> 原文:[https://www . geeksforgeeks . org/如何设置 c-sharp 中的 flowlayoutpanel 的前景色/](https://www.geeksforgeeks.org/how-to-set-foreground-color-of-flowlayoutpanel-in-c-sharp/)

在 Windows 窗体中，FlowLayoutPanel 控件用于在水平或垂直流动方向上排列其子控件。或者换句话说，FlowLayoutPanel 是一个容器，用于在其中水平或垂直组织不同或相同类型的控件。在 FlowLayoutPanel 控件中，可以使用**前景色属性**设置控件的前景色。此属性是环境属性。您可以通过两种不同的方式设置此属性:

**1。设计时:**设置 FlowLayoutPanel 的前景色是最简单的方法，如以下步骤所示:
...
*   **Step 3:** After drag and drop you will go to the properties of the FlowLayoutPanel and set the foreground color of the FlowLayoutPanel as shown in the below image:
...
*   **步骤 2:** 创建完 FlowLayoutPanel 后，设置 FlowLayoutPanel 类提供的 FlowLayoutPanel 的 ForeColor 属性。
