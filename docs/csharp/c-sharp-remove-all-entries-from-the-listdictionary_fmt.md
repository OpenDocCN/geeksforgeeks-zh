...
> 原文：[https://www.geeksforgeeks.org/c-sharp-remove-all-entries-from-the-listdictionary/](https://www.geeksforgeeks.org/c-sharp-remove-all-entries-from-the-listdictionary/)

`ListDictionary.Clear()` 方法用于从列表字典中删除所有条目。
