...
> 原文: [https://www.geeksforgeeks.org/how-to-get-a-comma-separated-string-from-an-array-in-c-sharp/](https://www.geeksforgeeks.org/how-to-get-a-comma-separated-string-from-an-array-in-c-sharp/)

给定一个数组，现在我们的任务是从给定的数组中获取一个逗号分隔的字符串。所以我们可以使用 [`String.Join()`](https://www.geeksforgeeks.org/c-sharp-join-method-set-1/) 方法来完成这个任务。此方法借助数组中每个项目之间的逗号分隔符来连接数组中的项目。
