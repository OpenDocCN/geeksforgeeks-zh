...
> 原文: [https://www.geeksforgeeks.org/c-sharp-check-if-a-hashtable-is-equal-to-another-hashtable/](https://www.geeksforgeeks.org/c-sharp-check-if-a-hashtable-is-equal-to-another-hashtable/)

`Hashtable` 类表示基于键的哈希代码组织的`键和值对`的集合。该键用于访问集合中的项。
...
这里 `myTable1` 和 `myTable2` 是需要检查的两个哈希表。
