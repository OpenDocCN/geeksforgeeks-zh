...
> 原文：[https://www.geeksforgeeks.org/c-sharp-type-getenumunderlyingtype-method/](https://www.geeksforgeeks.org/c-sharp-type-getenumunderlyingtype-method/)

`Type.GetEnumUnderlyingType()` 方法用于返回当前枚举类型的底层类型。
...
如果当前类型不是枚举或枚举类型无效（由于包含多个实例字段），该方法将返回 `ArgumentException`。
...
*   [https://docs.microsoft.com/en-us/dotnet/api/system.type.getenumunderlyingtype?view=netframework-4.8](https://docs.microsoft.com/en-us/dotnet/api/system.type.getenumunderlyingtype?view=netframework-4.8)