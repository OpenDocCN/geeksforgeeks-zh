...
> 原文: [https://www.geeksforgeeks.org/c-sharp-check-if-two-ordereddictionary-objects-are-equal/](https://www.geeksforgeeks.org/c-sharp-check-if-two-ordereddictionary-objects-are-equal/)

## Equals(object) 方法
`Equals(object)`方法继承自`Object`类，用于检查指定的`OrderedDictionary`对象是否等于另一个有序字典对象。
