...
> 原文: [https://www.geeksforgeeks.org/c-sharp-check-if-listdictionary-has-a-fixed-size/](https://www.geeksforgeeks.org/c-sharp-check-if-listdictionary-has-a-fixed-size/)

`ListDictionary.IsFixedSize` 属性用于获取一个值，该值指示列表字典是否有固定的大小。
...
*   [https://docs.microsoft.com/en-us/dotnet/api/system.collections.specialized.listdictionary.isfixedsize?view=netframework-4.7.2](https://docs.microsoft.com/en-us/dotnet/api/system.collections.specialized.listdictionary.isfixedsize?view=netframework-4.7.2)