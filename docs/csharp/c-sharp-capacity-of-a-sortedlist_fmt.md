...
> 原文: [https://www.geeksforgeeks.org/c-sharp-capacity-of-a-sortedlist/](https://www.geeksforgeeks.org/c-sharp-capacity-of-a-sortedlist/)

## C#

## 排序列表的容量

`SortedList.Capacity`属性用于获取或设置`SortedList`对象的容量。
...
该属性返回`SortedList`对象可以包含的`System.Int32`类型的元素个数。
...
*   检索`Capacity`属性的值是一个 O(1) 操作，而设置容量是一个 O(n) 操作，其中 n 是新容量。
...
*   [https://docs.microsoft.com/en-us/dotnet/api/system.collections.sortedlist.capacity?view=netframework-4.7.2](https://docs.microsoft.com/en-us/dotnet/api/system.collections.sortedlist.capacity?view=netframework-4.7.2)