...
> 原文：[`https://www.geeksforgeeks.org/finding-the-start-index-of-the-specified-range-in-c-sharp/`](https://www.geeksforgeeks.org/finding-the-start-index-of-the-specified-range-in-c-sharp/)

在 C# 8.0 中引入了[范围结构](https://www.geeksforgeeks.org/range-structure-in-c-sharp-8-0/)。它表示具有开始和结束索引的范围。您可以借助`Range`结构提供的`Start`属性找到给定范围的开始索引。
