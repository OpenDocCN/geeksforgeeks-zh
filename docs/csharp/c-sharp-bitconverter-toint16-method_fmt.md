...
> 原文: [https://www.geeksforgeeks.org/c-sharp-bitconverter-toint16-method/](https://www.geeksforgeeks.org/c-sharp-bitconverter-toint16-method/)
...
以下程序说明了 `BitConverter.ToInt16(byte[], Int32)` 方法的使用:
...
*   [https://docs.microsoft.com/en-us/dotnet/api/system.bitconverter.toint16?view=netframework-4.7.2](https://docs.microsoft.com/en-us/dotnet/api/system.bitconverter.toint16?view=netframework-4.7.2)