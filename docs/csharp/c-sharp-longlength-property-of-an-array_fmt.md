...
> 原文：[https://www.geeksforgeeks.org/c-sharp-longlength-property-of-an-array/](https://www.geeksforgeeks.org/c-sharp-longlength-property-of-an-array/)

`Array.LongLength` 属性用于获取一个 64 位整数，该整数表示[数组](https://www.geeksforgeeks.org/c-array-class/)所有维度中的元素总数。
...
## 注意
在上面的程序中可以看到 `Array.Length` 属性总是返回类型 `System.Int32`，但是 `Array.LongLength` 属性总是返回类型 `System.Int64`。

## 参考
*   [https://docs.microsoft.com/en-us/dotnet/api/system.array.longlength?view=netframework-4.7.2](https://docs.microsoft.com/en-us/dotnet/api/system.array.longlength?view=netframework-4.7.2)