...
> 原文：[https://www.geeksforgeeks.org/stack-equals-method-in-c-sharp/](https://www.geeksforgeeks.org/stack-equals-method-in-c-sharp/)

`Equals(object)`方法从`Object`类继承而来，用于检查指定的`Stack`类对象是否等于另一个`Stack`类对象。这个方法属于`System.Collections`命名空间。
