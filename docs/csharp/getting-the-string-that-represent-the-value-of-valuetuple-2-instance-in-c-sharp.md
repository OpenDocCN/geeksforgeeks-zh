...
> 原文:[https://www . geesforgeks . org/get-the-string-of-value-tuple-2-instance-in-c-sharp/](https://www.geeksforgeeks.org/getting-the-string-that-represent-the-value-of-valuetuple-2-instance-in-c-sharp/)
...
**返回类型:**该方法的返回类型为*系统。弦*。因此，它将返回一个表示 ValueTuple < T1，T2 >对象的字符串。
