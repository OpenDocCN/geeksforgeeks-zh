...
> 原文:[https://www . geeksforgeks . org/c-sharp-决策-else-else-梯形-嵌套-开关-嵌套-开关/](https://www.geeksforgeeks.org/c-sharp-decision-making-else-else-ladder-nested-switch-nested-switch/)
...
在本例中，只有 `statement 1` 被认为与 `if` 语句相关联。
