...
> 原文: [https://www.geeksforgeeks.org/c-sharp-indexers-using-string-as-an-index/](https://www.geeksforgeeks.org/c-sharp-indexers-using-string-as-an-index/)

## 先决条件与索引器介绍

**先决条件**: C# 中的[属性](https://www.geeksforgeeks.org/c-sharp-properties/)。
