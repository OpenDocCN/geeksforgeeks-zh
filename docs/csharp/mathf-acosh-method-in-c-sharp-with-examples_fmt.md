# MathF.Acosh() 方法在 C# 中的应用及示例

> 原文：`https://www.geeksforgeeks.org/mathf-acosh-method-in-c-sharp-with-examples/`

`MathF.Acosh()` 方法用于返回浮点值的双曲余弦值。

> **语法：** `public static float Acosh(float x);`
> 这里，它取一个标准的浮点数。
>
