...
> 原文: [https://www.geeksforgeeks.org/c-sharp-how-to-change-bufferheight-of-the-console/](https://www.geeksforgeeks.org/c-sharp-how-to-change-bufferheight-of-the-console/)
...
## 方法
这可以使用 C# 中 `System` 包的 `Console` 类中的 `BufferHeight` 属性来完成。
