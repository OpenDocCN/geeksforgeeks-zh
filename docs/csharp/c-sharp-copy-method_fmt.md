...
**说明:**该方法接受单参数字符串，即需要复制的原始字符串。它返回字符串值，这是与字符串值相同的新字符串。`Copy()`方法的类型是`System.String`。
...
**参考:**[https://msdn.microsoft.com/en-us/library/system.string.copy](https://msdn.microsoft.com/en-us/library/system.string.copy)