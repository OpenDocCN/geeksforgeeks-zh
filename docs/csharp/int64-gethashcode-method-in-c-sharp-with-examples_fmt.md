# Int64.GetHashCode 方法及示例

> 原文：[https://www.geeksforgeeks.org/int64-gethashcode-method-in-c-sharp-with-examples/](https://www.geeksforgeeks.org/int64-gethashcode-method-in-c-sharp-with-examples/)
...
class GFG {
    ...
    public static void Main()
    {
        ...
        Console.WriteLine("HashCode for Int64 is: {0}", result);
    }
}
```
...
*   [https://docs.microsoft.com/en-us/dotnet/api/system.int64.gethashcode?view=netframework-4.7.2](https://docs.microsoft.com/en-us/dotnet/api/system.int64.gethashcode?view=netframework-4.7.2)