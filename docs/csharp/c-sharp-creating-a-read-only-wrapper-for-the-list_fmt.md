...
> 原文：[https://www.geeksforgeeks.org/c-sharp-creating-a-read-only-wrapper-for-the-list/](https://www.geeksforgeeks.org/c-sharp-creating-a-read-only-wrapper-for-the-list/)

## `List<T>.AsReadOnly` 方法

`List<T>.AsReadOnly` 方法用于获取当前集合的只读 `ReadOnlyCollection<T>` 包装。
