...
在 Windows 窗体中，DateTimePicker 控件用于在窗体中选择和显示具有特定格式的日期/时间。在日期选择器控件中，您可以使用**名称属性**在表单上设置日期选择器的名称。您可以通过两种不同的方式设置此属性:

**1。设计时:**设置日期时间选择器的名称是最简单的方法，如以下步骤所示:
...
*   **Step 3:** After drag and drop you will go to the properties of the DateTimePicker and set the name of the DateTimePicker as shown in the below image:
...
**2。运行时:**比上面的方法稍微复杂一点。在此方法中，您可以借助给定的语法以编程方式设置 DateTimePicker 控件的名称:
...
*   **步骤 2:** 创建日期选择器后，设置由日期选择器类提供的日期选择器的名称属性。
