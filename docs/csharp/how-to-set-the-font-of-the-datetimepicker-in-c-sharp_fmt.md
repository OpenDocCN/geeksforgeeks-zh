...
> 原文：[https://www.geeksforgeeks.org/how-to-set-the-font-of-the-datetimepicker-in-c-sharp/](https://www.geeksforgeeks.org/how-to-set-the-font-of-the-datetimepicker-in-c-sharp/)

在 Windows 窗体中，`DateTimePicker` 控件用于在窗体中选择和显示具有特定格式的日期/时间。在日期选择器控件中，可以使用 `字体属性` 设置表单上日期选择器的字体。此属性是环境属性。您可以通过两种不同的方式设置此属性：

## 1. 设计时

最简单的方法是设置日期选择器的字体，如以下步骤所示：
...
比上面的方法稍微复杂一点。在此方法中，您可以借助给定的语法以编程方式设置 `DateTimePicker` 控件的字体：
