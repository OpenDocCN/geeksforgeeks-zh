# LINQ | 元素操作符 | ElementAtOrDefault

> 原文：[https://www.geeksforgeeks.org/linq-element-operator-elementatordefault/](https://www.geeksforgeeks.org/linq-element-operator-elementatordefault/)
...
## ElementAtOrDefault 运算符

`ElementAtOrDefault` 运算符用于从给定集合或序列的特定索引中返回一个元素，如果索引超出范围，它将提供一个默认值。它克服了 `ElementAt` 运算符的 `ArgumentOutOfRangeException` 问题。
