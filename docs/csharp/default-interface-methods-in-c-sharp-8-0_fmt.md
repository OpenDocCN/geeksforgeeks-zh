...
> 原文：[https://www.geeksforgeeks.org/default-interface-methods-in-c-sharp-8-0/](https://www.geeksforgeeks.org/default-interface-methods-in-c-sharp-8-0/)
...
*   您可以使用访问修饰符，如 `private`、`protected`、`internal`、`public`、`virtual`、`abstract`、`override`、`sealed`、`static`、`extern` 等。在界面上。并且在使用修饰语关键字时要小心。
*   您可以在接口中创建静态字段、方法、属性、索引器和事件。
*   您可以覆盖修改器。
*   默认访问的显式访问修饰符是 `public`。
...
> 错误 CS1061:“Example_Class”不包含“display_2”的定义，并且找不到接受“Example_Class”类型的第一个参数的可访问扩展方法“display_2”（是否缺少 using 指令或程序集引用？）
