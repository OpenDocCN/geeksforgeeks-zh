...
> 原文：[https://www.geeksforgeeks.org/how-to-get-the-index-value-in-c-sharp/](https://www.geeksforgeeks.org/how-to-get-the-index-value-in-c-sharp/)

## 介绍

在 C# 8.0 中引入了[索引结构](https://www.geeksforgeeks.org/index-struct-in-c-sharp-8-0/)。它表示可用于索引集合或序列的类型，并且可以从开始或结束开始。您可以借助索引结构提供的`Value`属性获得索引值。
