...
> 原文: [https://www.geeksforgeeks.org/c-sharp-how-to-check-current-state-of-a-thread/](https://www.geeksforgeeks.org/c-sharp-how-to-check-current-state-of-a-thread/)

`Thread`类负责在多线程编程中创建和管理线程。它提供了一个名为`ThreadState`的属性来检查线程的当前状态。线程的初始状态是`Unstarted`状态。
...
*   [https://docs.microsoft.com/en-us/dotnet/api/system.threading.thread.threadstate?view=netframework-4.7.2](https://docs.microsoft.com/en-us/dotnet/api/system.threading.thread.threadstate?view=netframework-4.7.2)