...
> 原文：[https://www.geeksforgeeks.org/check-if-two-sorteddictionary-objects-are-equal-in-c-sharp/](https://www.geeksforgeeks.org/check-if-two-sorteddictionary-objects-are-equal-in-c-sharp/)

## Equals(Object) 方法

`Equals(Object)` 方法继承自 `Object` 类，用于检查指定的排序字典对象是否等于另一个排序字典对象。
