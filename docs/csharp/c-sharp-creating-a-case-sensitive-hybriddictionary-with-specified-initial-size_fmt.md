# C# | 创建具有指定初始大小的区分大小写的混合字典

> 原文：[https://www.geeksforgeeks.org/c-sharp-creating-a-case-sensitive-hybrid-dictionary-with-specified-initial-size/](https://www.geeksforgeeks.org/c-sharp-creating-a-case-sensitive-hybrid-dictionary-with-specified-initial-size/)

`HybridDictionary(Int32)` 构造函数用于创建一个具有指定初始大小的区分大小写的混合字典。
...
这里，`initialSize` 是混合字典最初可以包含的大约条目数。
