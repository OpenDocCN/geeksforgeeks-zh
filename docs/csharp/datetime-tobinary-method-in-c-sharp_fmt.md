...
> 原文：[https://www.geeksforgeeks.org/datetime-tobinary-method-in-c-sharp/](https://www.geeksforgeeks.org/datetime-tobinary-method-in-c-sharp/)
...
以下程序说明了 `DateTime.ToBinary()` 方法的使用。
...
*   [https://docs.microsoft.com/en-us/dotnet/api/system.datetime.tobinary?view=netframework-4.7.2](https://docs.microsoft.com/en-us/dotnet/api/system.datetime.tobinary?view=netframework-4.7.2)