...
> 原文：[https://www.geeksforgeeks.org/getting-the-hash-code-of-the-valuetuple-in-c-sharp/](https://www.geeksforgeeks.org/getting-the-hash-code-of-the-valuetuple-in-c-sharp/)

## `ValueTuple.GetHashCode` 方法

`ValueTuple.GetHashCode` 方法用于获取当前 `ValueTuple` 实例的 `HashCode`。它由 `ValueTuple` 结构提供。
