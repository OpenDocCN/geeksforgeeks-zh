...
> 原文：[https://www.geeksforgeeks.org/c-sharp-how-to-get-hash-code-for-the-specified-key-of-a-hashtable/](https://www.geeksforgeeks.org/c-sharp-how-to-get-hash-code-for-the-specified-key-of-a-hashtable/)

`Hashtable.GetHash(Object)` 方法用于获取一个 [`Hashtable`](https://www.geeksforgeeks.org/c-hashtable-class/) 对象的指定键的哈希码。该方法继承自 [`Object`](https://www.geeksforgeeks.org/c-object-class/) 类。
...
如果 `Key` 为 `null`，该方法将抛出 `NullReferenceException`。
...
*   [https://docs.microsoft.com/en-us/dotnet/api/system.collections.hashtable.gethash?view=netframework-4.7.2](https://docs.microsoft.com/en-us/dotnet/api/system.collections.hashtable.gethash?view=netframework-4.7.2)