...
> 原文: [https://www.geeksforgeeks.org/c-sharp-type-getenumvalues-method/](https://www.geeksforgeeks.org/c-sharp-type-getenumvalues-method/)

`Type.GetEnumValues()`方法用于返回当前枚举类型中常量值的数组。
...
*   [https://docs.microsoft.com/en-us/dotnet/api/system.type.getenumvalues?view=netframework-4.8](https://docs.microsoft.com/en-us/dotnet/api/system.type.getenumvalues?view=netframework-4.8)