...
> 原文：[`https://www.geeksforgeeks.org/console-clear-method-in-c-sharp/`](https://www.geeksforgeeks.org/console-clear-method-in-c-sharp/)

此方法用于清除控制台缓冲区和相应控制台窗口的显示信息。

> **语法：** `public static void Clear();`
>
> **异常：** 如果出现输入/输出错误，该方法抛出`异常`。

下面的程序展示了`Console.Clear()`方法的使用。
