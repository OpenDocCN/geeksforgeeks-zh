...
> 原文：[https://www.geeksforgeeks.org/c-sharp-how-to-copy-a-string-into-another-string/](https://www.geeksforgeeks.org/c-sharp-how-to-copy-a-string-into-another-string/)

`String.Copy(string)`方法用于创建与指定的[`String`](https://www.geeksforgeeks.org/c-string-class/)具有相同值的字符串的新实例。换句话说，这种方法用于将一个字符串的数据复制到一个新的[`String`](https://www.geeksforgeeks.org/c-string-class/)中。
...
该方法的返回类型为`System.String`。该方法返回一个新字符串，该字符串包含类似于`value`的数据。
...
*   [https://docs.microsoft.com/en-us/dotnet/api/system.string.copy?view=netframework-4.7.2#definition](https://docs.microsoft.com/en-us/dotnet/api/system.string.copy?view=netframework-4.7.2#definition)