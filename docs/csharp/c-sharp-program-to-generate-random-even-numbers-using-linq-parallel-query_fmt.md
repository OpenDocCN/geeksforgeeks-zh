...
> 原文：[https://www.geeksforgeeks.org/c-sharp-program-to-generate-random-even-numbers-using-linq-parallel-query/](https://www.geeksforgeeks.org/c-sharp-program-to-generate-random-even-numbers-using-linq-parallel-query/)
...
其中`start`是序列中的第一个整数值，`stop`是要生成的序列整数的数量。
