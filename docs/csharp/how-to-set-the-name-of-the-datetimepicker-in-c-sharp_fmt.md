...
> 原文：[https://www.geeksforgeeks.org/how-to-set-the-name-of-the-datetimepicker-in-c-sharp/](https://www.geeksforgeeks.org/how-to-set-the-name-of-the-datetimepicker-in-c-sharp/)

在 Windows 窗体中，`DateTimePicker` 控件用于在窗体中选择和显示具有特定格式的日期/时间。在日期选择器控件中，您可以使用 `Name` 属性在表单上设置日期选择器的名称。您可以通过两种不同的方式设置此属性：

## 1. 设计时

设置日期时间选择器的名称是最简单的方法，如以下步骤所示：
...
*   **Step 3:** 拖放完成后，转到 `DateTimePicker` 的属性窗口并设置其名称，如下图所示：
    ![](img/a3eee5772db57a18b1631b4198928347.png)
...
比上面的方法稍微复杂一点。在此方法中，您可以借助给定的语法以编程方式设置 `DateTimePicker` 控件的名称：

```csharp
public string Name { get; set; }
```

以下步骤显示了如何动态设置日期时间选择器的名称：
...
*   **步骤 2:** 创建日期选择器后，设置由 `DateTimePicker` 类提供的 `Name` 属性。
...
namespace WindowsFormsApp48 {
    public partial class Form1 : Form {
        ...
        private void Form1_Load(object sender, EventArgs e) {
            ...
            // Creating and setting the properties of the DateTimePicker
            DateTimePicker dt = new DateTimePicker();
