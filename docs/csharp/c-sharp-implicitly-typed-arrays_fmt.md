...
> 原文：[https://www.geeksforgeeks.org/c-sharp-implicitly-typed-arrays/](https://www.geeksforgeeks.org/c-sharp-implicitly-typed-arrays/)
...
### 示例 3
下面的代码演示了隐式类型的[交错](https://www.geeksforgeeks.org/c-jagged-arrays/)数组的使用。
