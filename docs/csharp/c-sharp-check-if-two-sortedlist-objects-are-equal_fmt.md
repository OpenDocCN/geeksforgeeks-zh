...
> 原文：[https://www.geeksforgeeks.org/c-sharp-check-if-two-sortedlist-objects-are-equal/](https://www.geeksforgeeks.org/c-sharp-check-if-two-sortedlist-objects-are-equal/)

从`Object`类继承的`Equals(Object)`方法用于检查指定的[排序列表](https://www.geeksforgeeks.org/c-sortedlist-class/)对象是否等于另一个`SortedList`对象。
