...
> 原文：[https://www.geeksforgeeks.org/c-sharp-type-getnestedtype-method/](https://www.geeksforgeeks.org/c-sharp-type-getnestedtype-method/)

`Type.GetNestedType()`方法用于获取嵌套在当前类型中的特定类型。此方法的重载列表中有 2 种方法，如下所示：
...
> **语法：** `public Type GetNestedType(string name, BindingFlags bindingAttr);`
>
> **参数：**
...
> **语法：** `public Type GetNestedType(string name);`
>
> 在这里，它获取包含嵌套类型名称的字符串。
>
...
*   [https://docs.microsoft.com/en-us/dotnet/api/system.type.getnestedtype?view=netframework-4.8](https://docs.microsoft.com/en-us/dotnet/api/system.type.getnestedtype?view=netframework-4.8)