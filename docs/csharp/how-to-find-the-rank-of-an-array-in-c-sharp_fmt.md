...
> 原文：[https://www.geeksforgeeks.org/how-to-find-the-rank-of-an-array-in-c-sharp/](https://www.geeksforgeeks.org/how-to-find-the-rank-of-an-array-in-c-sharp/)

`Array.Rank` 属性用于获取[数组](https://www.geeksforgeeks.org/c-sharp-arrays/)的秩。秩是数组的维数。例如，一维数组返回 1，二维数组返回 2，依此类推。
...
**属性值：** 返回 `System.Array` 的秩（维数），类型为 `Int32`。
...
*   [https://docs.microsoft.com/en-us/dotnet/api/system.array.rank?view=netframework-4.7.2](https://docs.microsoft.com/en-us/dotnet/api/system.array.rank?view=netframework-4.7.2)