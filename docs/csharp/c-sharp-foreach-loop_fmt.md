...
**先决条件:** [`c# 中的循环`](https://www.geeksforgeeks.org/loops-in-c-sharp/)
...
2.  Foreach 循环**不跟踪索引**。所以我们不能使用 ForEach 循环获得数组索引:
...
*   在 for 循环中，我们向前和向后迭代数组，例如从索引 0 到 9 和从索引 9 到 0。但是在 foreach 循环中，我们只向前迭代数组，而不是向后迭代。
