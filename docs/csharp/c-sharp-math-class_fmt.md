...
> 原文：`https://www.geeksforgeeks.org/c-sharp-math-class/`

在 C# 中，`Math`类属于系统命名空间。它用于为对数函数、三角函数和其他有用的数学函数提供静态方法和常数。它是一个静态类，继承了对象类。
...
1.  `Math.E`字段：该字段表示自然对数基数，由常数`e`指定
2.  `Math.PI`字段：它表示圆的周长与直径的比值，由常数`π`(π)指定。
...
| `Acosh()` | 返回指定数字的反双曲余弦值。 |
| [`Asin()`](https://www.geeksforgeeks.org/c-math-asin-method/) | 返回正弦值为指定数字的角度。 |
| `Asinh()` | 返回指定数字的反双曲正弦值。 |
...
| `Atanh()` | 返回指定数字的反双曲正切值。 |
| [`BigMul()`](https://www.geeksforgeeks.org/c-math-bigmul-method/) | 产生两个 32 位数字的乘积。 |
| `Cbrt()` | 返回指定值的立方根。 |
| [`Ceiling()`](https://www.geeksforgeeks.org/c-math-ceiling-method/) | 返回大于或等于指定数字的最小整数值。 |
| `Clamp()` | 它用于将值限制在给定的范围内。 |
...
| [`DivRem()`](https://www.geeksforgeeks.org/c-math-divrem-method/) | 计算两个数的商，并在输出参数中返回余数。 |
| [`Exp()`](https://www.geeksforgeeks.org/c-math-exp-method/) | 返回`e`的指定幂。 |
| [`Floor()`](https://www.geeksforgeeks.org/c-math-floor-method/) | 返回小于或等于指定数字的最大整数值。 |
| [`IEEERemainder()`](https://www.geeksforgeeks.org/c-math-ieeeremainder-method/) | 返回一个指定数除以另一个指定数所得的余数。 |
...
| [`Round()`](https://www.geeksforgeeks.org/c-math-round-method-set-1/) | 将值舍入到最接近的整数或指定的小数位数。 |
| [`Sign()`](https://www.geeksforgeeks.org/c-math-sign-method/) | 返回一个指示数字符号的整数。 |
| [`Sin()`](https://www.geeksforgeeks.org/c-math-sin-method/) | 返回指定角度的正弦值。 |
| [`Sinh()`](https://www.geeksforgeeks.org/c-math-sinh-method/) | 返回指定角度的双曲正弦值。 |
| [`Sqrt()`](https://www.geeksforgeeks.org/c-math-sqrt-method/) | 返回指定数字的平方根。 |
| [`Tan()`](https://www.geeksforgeeks.org/c-math-tan-method/) | 返回指定角度的切线。 |
| [`Tanh()`](https://www.geeksforgeeks.org/c-math-tanh-method/) | 返回指定角度的双曲正切值。 |
| [`Truncate()`](https://www.geeksforgeeks.org/c-math-truncate-method/) | 计算数字的整数部分。 |
