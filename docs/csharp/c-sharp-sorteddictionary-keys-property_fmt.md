...
> 原文：`https://www.geeksforgeeks.org/c-sharp-sorteddictionary-keys-property/`

此属性用于获取包含 `SortedDictionary` 中的键的集合。

## 语法：

> `public System.Collections.Generic.SortedDictionary<TKey>.KeyCollection Keys { get; }`

## 返回值：

它返回一个包含 `SortedDictionary` 中的键的集合。
...
*   `https://docs.microsoft.com/en-us/dotnet/api/system.collections.generic.sorteddictionary-2.keys?view=netframework-4.7.2`