...
> 原文: [https://www.geeksforgeeks.org/c-sharp-setting-the-capacity-to-the-actual-number-of-elements-in-a-sortedlist-object/](https://www.geeksforgeeks.org/c-sharp-setting-the-capacity-to-the-actual-number-of-elements-in-a-sortedlist-object/)

`SortedList.TrimToSize` 方法用于将容量设置为 `SortedList` 对象中元素的实际数量。
...
如果 `SortedList` 对象为[只读](https://www.geeksforgeeks.org/c-check-if-a-sortedlist-is-read-only/)或者 `SortedList` 具有[固定大小](https://www.geeksforgeeks.org/c-check-if-a-sortedlist-object-has-a-fixed-size/)，此方法将抛出 `NotSupportedException`。
