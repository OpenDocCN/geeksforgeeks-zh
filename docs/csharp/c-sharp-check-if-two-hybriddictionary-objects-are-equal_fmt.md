...
> 原文: [https://www.geeksforgeeks.org/c-sharp-check-if-two-hybriddictionary-objects-are-equal/](https://www.geeksforgeeks.org/c-sharp-check-if-two-hybriddictionary-objects-are-equal/)

`Equals(object)`方法继承自[`Object`](https://www.geeksforgeeks.org/c-object-class/)类，用于检查指定的[`HybridDictionary`](https://www.geeksforgeeks.org/c-hybriddictionary-class/)对象是否等于另一个混合字典对象。
