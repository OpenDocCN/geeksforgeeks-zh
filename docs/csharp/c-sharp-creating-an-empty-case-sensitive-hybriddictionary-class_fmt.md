...
> 原文：[https://www.geeksforgeeks.org/c-sharp-creating-an-empty-case-sensitive-hybriddictionary-class/](https://www.geeksforgeeks.org/c-sharp-creating-an-empty-case-sensitive-hybriddictionary-class/)

`HybridDictionary()` 创建一个空的区分大小写的混合字典。
