...
> 原文：[https://www.geeksforgeeks.org/c-sharp-getting-the-key-at-the-specified-index-of-a-sortedlist-object/](https://www.geeksforgeeks.org/c-sharp-getting-the-key-at-the-specified-index-of-a-sortedlist-object/)

`SortedList.GetKey(Int32)`方法用于获取`SortedList`对象指定索引处的键。
...
这里，`index`是要获取的密钥的从零开始的索引。

## 返回值：

该方法返回`SortedList`对象指定索引处的键。
...
*   [https://docs.microsoft.com/en-us/dotnet/api/system.collections.sortedlist.getkey?view=netframework-4.7.2](https://docs.microsoft.com/en-us/dotnet/api/system.collections.sortedlist.getkey?view=netframework-4.7.2)