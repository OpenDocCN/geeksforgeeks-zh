# C# Tuple<T1, T2, T3, T4, T5, T6> 类

> 原文: [https://www.geeksforgeeks.org/c-sharp-tuple-6-class/](https://www.geeksforgeeks.org/c-sharp-tuple-6-class/)

`Tuple<T1, T2, T3, T4, T5, T6>` 类用于创建一个 6 元组或六元组。它表示一个包含六个元素的元组。您可以通过调用 [`Tuple<T1, T2, T3, T4, T5, T6>(T1, T2, T3, T4, T5, T6)` 构造函数](https://www.geeksforgeeks.org/how-to-create-6-tuple-in-c-sharp/# Using%20Tuple%3CT1,T2,T3,T4,T5,T6%3E(T1,%20T2,%20T3,%20T4,%20T5,%20T6)%20Constructor) 或静态的 [`Create` 方法](https://www.geeksforgeeks.org/how-to-create-6-tuple-in-c-sharp/# Using%20the%20Create%20method) 来实例化 `Tuple<T1, T2, T3, T4, T5, T6>` 对象。您可以使用只读的 `Item1`、`Item2`、`Item3`、`Item4`、`Item5` 和 `Item6` 实例属性来检索元组元素的值。
...
| 构造函数 | 描述 |
| :--- | :--- |
| [`Tuple<T1, T2, T3, T4, T5, T6>(T1, T2, T3, T4, T5, T6)`](https://www.geeksforgeeks.org/how-to-create-6-tuple-in-c-sharp/# Using%20Tuple%3CT1,T2,T3,T4,T5,T6%3E(T1,%20T2,%20T3,%20T4,%20T5,%20T6)%20Constructor) | 初始化 `Tuple<T1, T2, T3, T4, T5, T6>` 类的新实例。 |
...
| [`Item6`](https://www.geeksforgeeks.org/c-sharp-how-to-get-sixth-element-of-the-tuple/) | 获取当前元组对象的第六个分量的值。 |
...
*   [https://docs.microsoft.com/en-us/dotnet/api/system.tuple-6?view=netframework-4.8](https://docs.microsoft.com/en-us/dotnet/api/system.tuple-6?view=netframework-4.8)