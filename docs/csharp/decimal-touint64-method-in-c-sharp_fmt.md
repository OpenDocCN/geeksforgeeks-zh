# Decimal.ToUInt64() 方法（C#）

> 原文：[https://www.geeksforgeeks.org/decimal-touint64-method-in-c-sharp/](https://www.geeksforgeeks.org/decimal-touint64-method-in-c-sharp/)
...
返回一个 64 位无符号整数，相当于指定值，即 `d`。

## 异常

如果指定值为负值或大于 `MaxValue`，该方法将给出 `OverflowException`。
...
*   [https://docs.microsoft.com/en-us/dotnet/api/system.decimal.touint64?view=netframework-4.7.2](https://docs.microsoft.com/en-us/dotnet/api/system.decimal.touint64?view=netframework-4.7.2)