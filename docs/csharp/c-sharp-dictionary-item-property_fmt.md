...
> 原文: [https://www.geeksforgeeks.org/c-sharp-dictionary-item-property/](https://www.geeksforgeeks.org/c-sharp-dictionary-item-property/)
...
是与指定键关联的值。如果找不到指定的键，`get` 操作抛出 `KeyNotFoundException`，`set` 操作用指定的键创建新元素。
...
*   [https://docs.microsoft.com/en-us/dotnet/api/system.collections.generic.dictionary-2.item?view=netframework-4.7.2](https://docs.microsoft.com/en-us/dotnet/api/system.collections.generic.dictionary-2.item?view=netframework-4.7.2)