...
> 原文:[https://www . geeksforgeeks . org/如何设置 c-sharp 中 numericupdown 的大小/](https://www.geeksforgeeks.org/how-to-set-the-size-of-the-numericupdown-in-c-sharp/)

在 windows 窗体中，NumericUpDown 控件用于提供显示数值的 Windows 旋转框或上下控件。或者换句话说，NumericUpDown 控件提供了一个使用上下箭头移动并保存一些预定义数值的界面。在 NumericUpDown 控件中，可以使用 **Size 属性**设置上下控件的高度和宽度值(以像素为单位)。您可以通过两种不同的方式设置此属性:

**1。设计时间:**设置 NumericUpDown 的大小是最简单的方法，如以下步骤所示:
...
*   **Step 3:** After drag and drop you will go to the properties of the NumericUpDown and set the size of the NumericUpDown as shown in the below image:

    ![](img/59ab70efd8c4069f5b0c0e212705c237.png)

    **输出:**

    ![](img/5b906b098eadf850992d59c76d8ac722.png)

**2。运行时:**比上面的方法稍微复杂一点。在此方法中，您可以借助给定的语法以编程方式设置 NumericUpDown 控件的高度和宽度:

```cs
public System.Drawing.Size Size { get; set; }
```

这里，“大小”以像素为单位表示 NumericUpDown 控件的高度和宽度。以下步骤显示了如何动态设置 NumericUpDown 的位置:
