...
此方法用于通过在右侧用空格填充字符串来左对齐字符串中的字符。参数 `totalWidth` 将指定字符串中填充字符的数量，该方法将返回一个新字符串。
...
*   **返回值:** 这个方法将返回填充字符串左边部分的字符串。返回值类型为 `System.String`。
...
此方法用于通过用右侧的指定字符填充来左对齐该字符串中的字符。参数 `totalWidth` 将指定字符串中的填充字符数，而 `paddingChar` 是指定的字符。
...
*   **返回值:** 此方法将返回一个新字符串，该字符串将等效于当前字符串，但会左对齐，并在右侧填充 `paddingChar` 参数指定的字符。如果 `totalWidth` 小于字符串的长度，则该方法返回相同的字符串。如果 `totalWidth` 等于字符串的长度，则该方法返回一个与当前字符串相同的新字符串。返回值类型为 `System.String`。
...
*   [https://msdn.microsoft.com/en-us/library/system.string.padright(v=vs.110).aspx](https://msdn.microsoft.com/en-us/library/system.string.padright(v=vs.110).aspx)
*   [https://msdn.microsoft.com/en-us/library/system.string.padright(v=vs.110).aspx](https://msdn.microsoft.com/en-us/library/system.string.padright(v=vs.110).aspx)