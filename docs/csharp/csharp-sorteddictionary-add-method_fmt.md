...
> 原文：[https://www.geeksforgeeks.org/csharp-sorteddictionary-add-method/](https://www.geeksforgeeks.org/csharp-sorteddictionary-add-method/)
...
以下是说明使用 `SortedDictionary<TKey, TValue>.Add()` 方法的程序。
...
* [https://docs.microsoft.com/en-us/dotnet/api/system.collections.generic.sorteddictionary-2.add?view=netframework-4.7.2](https://docs.microsoft.com/en-us/dotnet/api/system.collections.generic.sorteddictionary-2.add?view=netframework-4.7.2)