...
> 原文：[https://www.geeksforgeeks.org/c-sharp-charenumerator-gethashcode-method/](https://www.geeksforgeeks.org/c-sharp-charenumerator-gethashcode-method/)

`GetHashCode()`方法作为默认的哈希函数，返回当前对象的哈希代码。该方法继承自[`Object`类](https://www.geeksforgeeks.org/c-sharp-object-class/)。
...
该方法返回一个与当前对象的哈希码对应的`Int32`值。

下面是说明使用`CharEnumerator.GetHashCode()`方法的程序。
