...
> 原文：[https://www.geeksforgeeks.org/how-to-create-an-ordereddictionary-in-c-sharp/](https://www.geeksforgeeks.org/how-to-create-an-ordereddictionary-in-c-sharp/)

`OrderedDictionary()`构造函数用于初始化 `OrderedDictionary` 类的新实例，该实例将为空，并将具有默认的初始容量。[`OrderedDictionary` 类](https://www.geeksforgeeks.org/c-sharp-ordereddictionary-class/)表示可由键或索引访问的键/值对的集合。它存在于 `System.Collections.Specialized` 命名空间中。
