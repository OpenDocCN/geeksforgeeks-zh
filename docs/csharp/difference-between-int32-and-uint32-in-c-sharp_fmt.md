...
`Int32`结构用来表示 32 位有符号整数。`Int32`可以存储在`-2147483648`到`+2147483647`范围内的包括负值和正值的两种类型的值。
...
`UInt32`结构用于表示 32 位无符号整数。`UInt32`只能存储范围从`0`到`4294967295`的正值。
...
| **6。** | 声明`Int32`的语法: `Int32 variable_name;` | 声明`UInt32`的语法: `UInt32 variable_name;` |