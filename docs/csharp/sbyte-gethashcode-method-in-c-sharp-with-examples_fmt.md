# SByte.GetHashCode 方法及示例

> 原文：[https://www.geeksforgeeks.org/sbyte-gethashcode-method-in-c-sharp-with-examples/](https://www.geeksforgeeks.org/sbyte-gethashcode-method-in-c-sharp-with-examples/)

`SByte.GetHashCode` 方法用于获取当前 `SByte` 实例的哈希码。
...
class GFG {
    ...
    public static void Main()
    {
        ...
        Console.WriteLine("HashCode for SByte is: {0}", result);
    }
}
```
