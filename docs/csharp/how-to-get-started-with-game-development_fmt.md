...
> 原文：[https://www.geeksforgeeks.org/how-to-get-started-with-game-development/](https://www.geeksforgeeks.org/how-to-get-started-with-game-development/)
...
**1. 学习计算机编程：** 游戏中有趣的世界观都是用计算机编程创造的。所以，你有理由知道编程，以防你想进入这个世界！现在如果你有一些编程语言的编码基础知识，比如`C#`、`Python`、`Java`等。那就太好了，否则最好先学编程，再继续前进。
...
**注：** 如果你是完全初学者，可以参考哈佛大学的 [`CS50: 计算机科学导论`](https://online-learning.harvard.edu/course/cs50-introduction-computer-science)，对计算机编程有一个基本的了解。
...
其他一些常见的游戏设计模式有`享元`、`原型`、`观察者`等。最好先了解这些游戏模式，然后在各种小游戏中应用。这将帮助你理解游戏设计模式对游戏开发的各种影响和好处。

**注：** 一本学习游戏设计模式的奇书是 [`由罗伯特·尼斯特罗姆编写的《游戏编程模式》`](https://www.amazon.in/Game-Programming-Patterns-Robert-Nystrom/dp/0990582906)，它将详细阐述各种设计模式以优化你的游戏。
