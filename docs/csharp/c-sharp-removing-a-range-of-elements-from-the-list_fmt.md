...
> 原文: [https://www.geeksforgeeks.org/c-sharp-removing-a-range-of-elements-from-the-list/](https://www.geeksforgeeks.org/c-sharp-removing-a-range-of-elements-from-the-list/)

## `List<T>.RemoveRange(Int32, Int32)` 方法
`List<T>.RemoveRange(Int32, Int32)` 方法用于从 `List<T>` 中移除一系列元素。
...
## 示例
以下程序说明了 `List<T>.RemoveRange(Int32, Int32)` 方法的使用:
...
## 参考
*   [https://docs.microsoft.com/en-us/dotnet/api/system.collections.generic.list-1.removerange?view=netframework-4.7.2](https://docs.microsoft.com/en-us/dotnet/api/system.collections.generic.list-1.removerange?view=netframework-4.7.2)