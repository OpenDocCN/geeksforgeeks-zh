...
> 原文：[https://www.geeksforgeeks.org/c-sharp-type-getenumnames-method/](https://www.geeksforgeeks.org/c-sharp-type-getenumnames-method/)

`Type.GetEnumNames()`方法用于返回当前枚举类型成员的名称。
...
*   [https://docs.microsoft.com/en-us/dotnet/api/system.type.getenumnames?view=netframework-4.8](https://docs.microsoft.com/en-us/dotnet/api/system.type.getenumnames?view=netframework-4.8)