# C# 从 OrderedDictionary 中删除带有指定键的条目

> 原文: [https://www.geeksforgeeks.org/c-sharp-remove-entry-with-specified-key-from-ordereddictionary/](https://www.geeksforgeeks.org/c-sharp-remove-entry-with-specified-key-from-ordereddictionary/)
...
*   [https://docs.microsoft.com/en-us/dotnet/api/system.collections.specialized.ordereddictionary.remove?view=netframework-4.7.2](https://docs.microsoft.com/en-us/dotnet/api/system.collections.specialized.ordereddictionary.remove?view=netframework-4.7.2)