...
> 原文：[https://www.geeksforgeeks.org/c-sharp-remove-a-specified-item-from-sortedset/](https://www.geeksforgeeks.org/c-sharp-remove-a-specified-item-from-sortedset/)

`SortedSet` 类表示按排序顺序排列的对象集合。这个类隶属于 `System.Collections.Generic` 命名空间。`SortedSet<T>.Remove(T)` 方法用于从排序集中移除指定的项目。
