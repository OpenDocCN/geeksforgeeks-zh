...
> 原文：[https://www.geeksforgeeks.org/uint64-maxvalue-field-in-c-sharp-with-examples/](https://www.geeksforgeeks.org/uint64-maxvalue-field-in-c-sharp-with-examples/)
...
*   [https://docs.microsoft.com/en-us/dotnet/api/system.uint64.maxvalue?view=netstandard-2.1](https://docs.microsoft.com/en-us/dotnet/api/system.uint64.maxvalue?view=netstandard-2.1)