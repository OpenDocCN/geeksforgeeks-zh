...
> 原文:[https://www.geeksforgeeks.org/c-sharp-string-concat-with-examples-set-2/](https://www.geeksforgeeks.org/c-sharp-string-concat-with-examples-set-2/)
...
**返回值:** 该方法的返回类型为`System.String`。这个方法返回一个字符串作为两个字符串连接的结果，即 `strA` 和 `strB`。
...
**返回值:** 该方法的返回类型为`System.String`。该方法返回一个由三个字符串串联而成的字符串，即 `strA`、`strB` 和 `strC`。
...
**返回值:** 该方法的返回类型为`System.String`。此方法返回`items`的串联元素。
...
**下一个:** [Set-3](https://www.geeksforgeeks.org/c-string-concat-with-examples-set-3/)
