# MathF.Asinh(Single) 方法（C#）

> 原文：[https://www.geeksforgeeks.org/mathf-asinh-method-in-c-with-examples/](https://www.geeksforgeeks.org/mathf-asinh-method-in-c-with-examples/)
...
**返回值：**
该方法返回给定值的双曲反正弦。如果该数字小于 1，则返回 `NaN`。
