...
> 原文：[https://www.geeksforgeeks.org/c-sharp-int64-tostring-method-set-2/](https://www.geeksforgeeks.org/c-sharp-int64-tostring-method-set-2/)

`Int64.ToString` 方法用于将当前实例的数值转换为其等价的字符串表示。该方法的重载列表中有以下 4 种方法：
...
**参考：**
* [https://docs.microsoft.com/en-us/dotnet/api/system.int64.tostring?view=netframework-4.7.2](https://docs.microsoft.com/en-us/dotnet/api/system.int64.tostring?view=netframework-4.7.2)