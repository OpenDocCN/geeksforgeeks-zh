...
> 原文：[https://www.geeksforgeeks.org/passing-arrays-as-arguments-in-c-sharp/](https://www.geeksforgeeks.org/passing-arrays-as-arguments-in-c-sharp/)
...
**代码：** 在下面的程序中，我们将一维数组 `arr` 传递给方法 `Result`。该方法是静态的，它将打印传递给它的数组元素。
...
**代码：** 在下面的程序中，我们将一个二维数组 `arr` 传递给给出矩阵转置的 `transpose` 方法。[`GetLength()`](https://www.geeksforgeeks.org/c-total-number-of-elements-present-in-an-array/) 方法用于统计特定维度中元素的总数。
