...
`Byte` 结构的 `MinValue` 字段用于表示字节数据类型的最小可能值。该字段的值为常量，意味着用户不能更改该字段的值。该字段的值为 `0`。
...
class GFG {
    ...
    static public void Main()
    {
        ...
        // Taking an array of the integers
...
*   [https://docs.microsoft.com/en-us/dotnet/api/system.byte.minvalue?view=netstandard-2.1](https://docs.microsoft.com/en-us/dotnet/api/system.byte.minvalue?view=netstandard-2.1)