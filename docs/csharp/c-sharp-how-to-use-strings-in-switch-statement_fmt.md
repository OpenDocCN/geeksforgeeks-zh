...
> 原文: [https://www.geeksforgeeks.org/c-sharp-how-to-use-strings-in-switch-statement/](https://www.geeksforgeeks.org/c-sharp-how-to-use-strings-in-switch-statement/)

[`switch`](https://www.geeksforgeeks.org/c-sharp-decision-making-else-else-ladder-nested-switch-nested-switch/#switch) 语句是多路分支语句。它提供了一种简单的方法，可以根据表达式的值将执行转发到代码的不同部分。*字符串是 `switch` 语句中唯一可以使用的非整数类型*。
