...
*   [类](https://www.geeksforgeeks.org/c-sharp-class-and-object/)
*   [变量](https://www.geeksforgeeks.org/c-sharp-variables/)
*   [方法](https://www.geeksforgeeks.org/c-sharp-methods/)
*   [构造函数](https://www.geeksforgeeks.org/c-sharp-constructors/)
...
借助 `static` 关键字声明一个静态类。静态类只能包含静态数据成员、静态方法和静态构造函数。不允许创建静态类的对象。静态类是 [`sealed`](https://www.geeksforgeeks.org/c-sealed-class/) ，意味着一个静态类不能从另一个类继承。
...
*   除 [`索引器`](https://www.geeksforgeeks.org/c-indexers/) 、终结器或类之外的类型不能使用 `static` 关键字。
*   实例不引用静态成员。
*   在 C# 中，不允许引用静态方法或属性访问器。
*   在 C# 中，如果 `static` 关键字与类一起使用，则该静态类始终包含静态成员。