...
> 原文: [https://www.geeksforgeeks.org/c-sharp-type-getenumname-method/](https://www.geeksforgeeks.org/c-sharp-type-getenumname-method/)

`类型.GetEnumName(Object)`方法用于返回具有当前枚举类型指定值的常量的名称。
...
该方法返回具有指定值的当前枚举类型成员的名称。如果没有找到这样的常数，那么它将返回`null`。
