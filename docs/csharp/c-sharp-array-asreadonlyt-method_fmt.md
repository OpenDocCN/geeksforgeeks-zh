# C# | `Array.AsReadOnly<T>(T[])` 方法

> 原文: [https://www.geeksforgeeks.org/c-sharp-array-asreadonlyt-method/](https://www.geeksforgeeks.org/c-sharp-array-asreadonlyt-method/)
...
该方法返回只读的 `ReadOnlyCollection<T>` 包装器。

## 异常

如果数组为空，这个方法抛出 `ArgumentNullException`。

## 示例

下面是举例说明 `Array.AsReadOnly<T>(T[])` 方法：
...
*   [https://docs.microsoft.com/en-us/dotnet/api/system.array.asreadonly?view=netframework-4.7.2](https://docs.microsoft.com/en-us/dotnet/api/system.array.asreadonly?view=netframework-4.7.2)