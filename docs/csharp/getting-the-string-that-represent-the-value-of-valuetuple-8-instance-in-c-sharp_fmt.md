...
> 原文: [https://www.geeksforgeeks.org/getting-the-string-that-represent-the-value-of-valuetuple-8-instance-in-c-sharp/](https://www.geeksforgeeks.org/getting-the-string-that-represent-the-value-of-valuetuple-8-instance-in-c-sharp/)
...
此方法返回一个字符串，该字符串将表示 `ValueTuple<T1, T2, T3, T4, T5, T6, T7, TRest>` 对象的值。此方法表示的字符串的形式为 `(Item1, Item2, Item3, Item4, Item5, Item6, Item7, Item8..)`。这里，`Item1`、`Item2`、`Item3`、`Item4`、`Item5`、`Item6`、`Item7` 表示 `Item1`、`Item2`、`Item3`、`Item4`、`Item5`、`Item6`、`Item7` 的属性值，`Item8` 表示 `ValueTuple<T1, T2, T3, T4, T5, T6, T7, TRest>` 对象的 `Next` 的值。`Item1` 属性和任何附加嵌套组件的值后跟 `Item8`。它将代表一个`字符串`。如果任何属性包含空值，则为空`字符串`。
...
该方法的返回类型为`系统.字符串`。因此，它将返回一个表示 `ValueTuple<T1, T2, T3, T4, T5, T6, T7, TRest>` 对象的字符串。
