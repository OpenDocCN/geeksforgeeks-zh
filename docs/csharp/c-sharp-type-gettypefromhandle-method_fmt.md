...
> 原文：[https://www.geeksforgeeks.org/c-sharp-type-gettypefromhandle-method/](https://www.geeksforgeeks.org/c-sharp-type-gettypefromhandle-method/)
...
该方法返回指定`RuntimeTypeHandle`引用的类型，如果句柄的`Value`属性为空，则返回`null`。

以下程序说明了`Type.GetTypeFromHandle()`方法的使用：
...
*   [https://docs.microsoft.com/en-us/dotnet/api/system.type.gettypefromhandle?view=netframework-4.8](https://docs.microsoft.com/en-us/dotnet/api/system.type.gettypefromhandle?view=netframework-4.8)