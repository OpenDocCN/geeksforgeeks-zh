...
> 原文：[https://www.geeksforgeeks.org/how-to-set-the-font-of-the-content-present-in-the-combobox-in-c-sharp/](https://www.geeksforgeeks.org/how-to-set-the-font-of-the-content-present-in-the-combobox-in-c-sharp/)

在 Windows 窗体中，组合框在单个控件中提供了两种不同的功能，这意味着组合框同时作为文本框和列表框工作。在组合框中，一次只显示一个项目，其余项目出现在下拉菜单中。您可以使用`Font`属性来设置组合框中内容的字体。您可以使用两种不同的方法设置此属性：

## 1. 设计时

使用以下步骤设置组合框控件中元素的字体是最简单的方法：
...
*   **第三步：** 拖放完成后，转到`ComboBox`控件的属性（Properties）窗口，设置其中元素的字体。
    ![](img/480fa115cb59f9e4200a63c0cec98540.png)
...
比上面的方法稍微复杂一点。在此方法中，您可以在给定语法的帮助下，以编程方式设置组合框中元素的字体：

```cs
public virtual System.Drawing.Font Font { get; set; }
```

这里，`Font`表示应用于组合框内容的字体。以下步骤用于设置组合框元素的字体：
