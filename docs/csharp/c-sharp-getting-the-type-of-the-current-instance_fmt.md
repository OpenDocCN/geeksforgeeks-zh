...
> 原文：[https://www.geeksforgeeks.org/c-sharp-getting-the-type-of-the-current-instance/](https://www.geeksforgeeks.org/c-sharp-getting-the-type-of-the-current-instance/)

`Object.GetType()`方法用于查找当前实例的类型。此方法返回用于考虑的类型类的实例。
