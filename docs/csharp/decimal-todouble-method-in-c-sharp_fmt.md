...
> 原文：[https://www.geeksforgeeks.org/decimal-todouble-method-in-c-sharp/](https://www.geeksforgeeks.org/decimal-todouble-method-in-c-sharp/)

此方法用于将指定的十进制值转换为等效的双精度浮点数。这种方法会产生舍入误差，因为双精度浮点数的有效位数少于十进制数。

> **语法：** `public static double ToDouble(decimal d);`
> 这里，`d` 是要转换的十进制值。
>
...
*   [https://docs.microsoft.com/en-us/dotnet/api/system.decimal.todouble?view=netframework-4.7.2](https://docs.microsoft.com/en-us/dotnet/api/system.decimal.todouble?view=netframework-4.7.2)