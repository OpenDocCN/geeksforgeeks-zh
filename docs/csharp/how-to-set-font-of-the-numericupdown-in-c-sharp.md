...
在 Windows 窗体中，NumericUpDown 控件用于提供显示数值的 Windows 旋转框或上下控件。或者换句话说，NumericUpDown 控件提供了一个使用上下箭头移动并保存一些预定义数值的界面。在 NumericUpDown 控件中，可以使用字体属性设置上下控件中显示的内容的字体。您可以通过两种不同的方式设置此属性:

**1。设计时:**最简单的方法是设置 NumericUpDown 的字体，如下步骤所示:
...
*   **Step 3:** After drag and drop you will go to the properties of the NumericUpDown and set the font of the NumericUpDown as shown in the below image;
...
**2。运行时:**比上面的方法稍微复杂一点。在此方法中，您可以借助给定的语法，以编程方式设置 NumericUpDown 控件中显示的内容的字体:

```cs
public virtual System.Drawing.Font Font { get; set; }
```

这里，字体表示 NumericUpDown 控件中存在的内容的字体。以下步骤显示了如何动态设置 NumericUpDown 的字体:
...
*   **第二步:**创建 numericpdown 后，设置 numericpdown 类提供的 numericpdown 的 Font 属性。
