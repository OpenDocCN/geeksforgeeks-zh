...
## 语法
`public static decimal Subtract(decimal a1, decimal a2);`
...
## 异常
如果返回值小于`MinValue`或大于`MaxValue`，该方法将给出`OverflowException`。
...
## 参考
- [https://docs.microsoft.com/en-us/dotnet/api/system.decimal.subtract?view=netcore-2.2](https://docs.microsoft.com/en-us/dotnet/api/system.decimal.subtract?view=netcore-2.2)