...
> 原文：[https://www.geeksforgeeks.org/c-sharp-how-to-change-the-cursorleft-of-the-console/](https://www.geeksforgeeks.org/c-sharp-how-to-change-the-cursorleft-of-the-console/)

给定 C# 中的普通控制台，任务是更改控制台的光标。

## 方法

这可以使用 C# 中 `System` 包的 `Console` 类中的 `CursorLeft` 属性来完成。这将改变光标的水平位置。基本上，它获取或设置光标在缓冲区内的列位置。
