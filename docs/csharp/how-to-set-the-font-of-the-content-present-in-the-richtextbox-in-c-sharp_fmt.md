...
> 原文: [https://www.geeksforgeeks.org/how-to-set-the-font-of-the-content-present-in-the-richtextbox-in-c-sharp/](https://www.geeksforgeeks.org/how-to-set-the-font-of-the-content-present-in-the-richtextbox-in-c-sharp/)
...
设置 `RichTextBox` 中显示的内容的字体是最简单的方法，如以下步骤所示：
...
*   **第三步:** 拖放之后，转到 `RichTextBox` 控件的属性，设置其中显示内容的字体。
    ![](img/6b0e4c08e6bf6f9a5bb2f1ed7a6936dc.png)
...
比上面的方法稍微复杂一点。在此方法中，您可以在给定语法的帮助下，以编程方式设置 `RichTextBox` 控件中显示的内容的字体:

```cs
public virtual System.Drawing.Font Font { get; set; }
```

这里，`Font` 是应用于 `RichTextBox` 内容的字体类型。以下步骤显示了如何动态设置 `RichTextBox` 的 `Font` 属性:
