# MathF.Abs() 方法在 C# 中的示例

> 原文：`https://www.geeksforgeeks.org/mathf-abs-method-in-c-sharp-with-examples/`
...
class GFG {
    ...
    public static void Main()
    {
        ...
        // Display the value
        Console.WriteLine("Absolute float value is {0}", round);
    }
}
```
