...
> 原文: [https://www.geeksforgeeks.org/mathf-acos-method-in-c-sharp-with-examples/](https://www.geeksforgeeks.org/mathf-acos-method-in-c-sharp-with-examples/)
...
该方法返回一个角度 θ，以弧度为单位，类型为 `System.Single` 且数值会小于 `Single.MaxValue`。
