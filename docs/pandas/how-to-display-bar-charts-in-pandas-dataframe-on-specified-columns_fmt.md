...
> 原文: [https://www.geeksforgeeks.org/how-to-display-bar-charts-in-pandas-dataframe-on-specified-columns/](https://www.geeksforgeeks.org/how-to-display-bar-charts-in-pandas-dataframe-on-specified-columns/)

在本文中，我们将看到如何在指定列的数据框中显示条形图。为了完成这个任务，我们使用熊猫数据框的`style.bar()`方法。
