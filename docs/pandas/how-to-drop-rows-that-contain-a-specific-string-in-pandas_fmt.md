...
> 原文: [https://www.geeksforgeeks.org/how-to-drop-rows-that-contain-a-specific-string-in-pandas/](https://www.geeksforgeeks.org/how-to-drop-rows-that-contain-a-specific-string-in-pandas/)

在本文中，我们将看到如何删除熊猫中包含特定字符串的行。现在，要删除带有特定字符串的行，我们可以使用 `pandas` 库中的 `contains()` 函数。

> `series.str.contains(string, case=True, flags=0, na=None, regex=True)`
>
> **返回**–
>
> 布尔值的系列或索引
