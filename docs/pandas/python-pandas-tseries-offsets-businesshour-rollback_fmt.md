...
> 原文: [https://www.geeksforgeeks.org/python-pandas-tseries-offsets-businesshour-rollback/](https://www.geeksforgeeks.org/python-pandas-tseries-offsets-businesshour-rollback/)
...
Pandas `tseries.offsets.BusinessHour.rollback()` 功能仅在不偏移的情况下提供向后到下一偏移的日期滚动。
...
### 示例 1
仅当不在偏移上时，使用 `pandas.tseries.offsets.BusinessHour.rollback()` 功能将提供的日期向后滚动到下一个偏移。
