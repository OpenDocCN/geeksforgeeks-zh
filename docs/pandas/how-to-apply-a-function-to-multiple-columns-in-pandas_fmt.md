...
> 原文: [https://www.geeksforgeeks.org/how-to-apply-a-function-to-multiple-columns-in-pandas/](https://www.geeksforgeeks.org/how-to-apply-a-function-to-multiple-columns-in-pandas/)

让我们看看如何将一个函数应用于 Pandas 数据框中的多列。要执行此任务，将使用 [`apply()`](https://www.geeksforgeeks.org/python-pandas-apply/) 功能。
