...
> 原文：[https://www.geeksforgeeks.org/python-pandas-tseries-offsets-custombusinesshour-name/](https://www.geeksforgeeks.org/python-pandas-tseries-offsets-custombusinesshour-name/)
...
## 示例 #1
使用 `pandas.tseries.offsets.CustomBusinessHour.name` 属性将应用于给定偏移对象的频率名称打印为字符串。
