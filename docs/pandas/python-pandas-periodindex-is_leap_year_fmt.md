...
> 原文: [https://www.geeksforgeeks.org/python-pandas-periodindex-is_leap_year/](https://www.geeksforgeeks.org/python-pandas-periodindex-is_leap_year/)
...
使用 `PeriodIndex.is_leap_year` 属性检查给定周期索引对象中的每个元素，无论它是否是闰年。
...
使用 `PeriodIndex.is_leap_year` 属性检查给定 `PeriodIndex` 对象中的每个元素，无论它是否是闰年。
