...
> 原文: [https://www.geeksforgeeks.org/python-pandas-series-itemsize/](https://www.geeksforgeeks.org/python-pandas-series-itemsize/)
...
Pandas `Series.itemsize` 属性返回给定序列对象的基础数据项的数据类型的大小。
...
使用 `Series.itemsize` 属性检查给定序列对象的基础数据的大小。
...
使用 `Series.itemsize` 属性检查给定 Series 对象的基础数据的大小。
