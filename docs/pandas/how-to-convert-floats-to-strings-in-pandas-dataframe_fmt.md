...
> 原文: [https://www.geeksforgeeks.org/how-to-convert-floats-to-strings-in-pandas-dataframe/](https://www.geeksforgeeks.org/how-to-convert-floats-to-strings-in-pandas-dataframe/)
...
现在，我们将列 `Marks` 的数据类型从 `float64` 更改为 `object`。
...
现在，我们将列 `Percentage` 的数据类型从 `float64` 更改为 `object`。
