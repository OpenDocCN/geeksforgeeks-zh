...
> 原文: [https://www.geeksforgeeks.org/python-pandas-series-str-match/](https://www.geeksforgeeks.org/python-pandas-series-str-match/)
...
使用`Series.str.match()`函数将传递的正则表达式与给定序列对象的基础数据中的字符串进行匹配。
