...
> 原文：[https://www.geeksforgeeks.org/pandas-groupby-sort-within-groups/](https://www.geeksforgeeks.org/pandas-groupby-sort-within-groups/)
...
## 示例 3
我们再举一个由各种汽车和自行车的最高速度组成的数据框的例子。我们将尝试在车型组中获得最高速度。
