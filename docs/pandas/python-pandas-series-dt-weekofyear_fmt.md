...
> 原文: [`https://www.geeksforgeeks.org/python-pandas-series-dt-weekofyear/`](https://www.geeksforgeeks.org/python-pandas-series-dt-weekofyear/)
...
## 示例 1
使用`Series.dt.weekofyear`属性返回给定 Series 对象的基础数据中一年中的第几周。
...
## 示例 2
使用`Series.dt.weekofyear`属性返回给定 Series 对象的基础数据中的年第几周。
