...
> 原文：[https://www.geeksforgeeks.org/python-pandas-series-quantile/](https://www.geeksforgeeks.org/python-pandas-series-quantile/)
...
使用 `Series.quantile()` 函数返回给定序列对象中基础数据的期望分位数。
