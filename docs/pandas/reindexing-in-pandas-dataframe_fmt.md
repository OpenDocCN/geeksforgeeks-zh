...
> 原文: [https://www.geeksforgeeks.org/reindexing-in-pandas-dataframe/](https://www.geeksforgeeks.org/reindexing-in-pandas-dataframe/)
...
### 代码#1:
数据框中缺少的值可以通过向关键字 `fill_value` 传递一个值来填充。该关键字替换 `NaN` 值。
