...
> 原文: [https://www.geeksforgeeks.org/how-to-read-all-csv-files-in-a-folder-in-pandas/](https://www.geeksforgeeks.org/how-to-read-all-csv-files-in-a-folder-in-pandas/)
...
3.  循环浏览 `csv_files` 列表，使用 [`pandas.read_csv()`](https://www.geeksforgeeks.org/python-read-csv-using-pandas-read_csv/) 读取该文件。
4.  将每个 csv 文件转换为数据帧。
5.  显示其位置、名称和内容。
