...
> 原文: [https://www.geeksforgeeks.org/python-pandas-period-end_time/](https://www.geeksforgeeks.org/python-pandas-period-end_time/)
...
使用 `Period.end_time` 属性查找给定周期对象的结束时间。
