...
> 原文: [https://www.geeksforgeeks.org/python-pandas-tseries-offsets-businesshour-kwds/](https://www.geeksforgeeks.org/python-pandas-tseries-offsets-businesshour-kwds/)
...
Pandas `tseries.offsets.BusinessHour.kwds` 属性返回应用于给定偏移对象的关键字参数。
...
使用 `pandas.tseries.offsets.BusinessHour.kwds` 属性返回应用于给定偏移量的关键字参数。
