...
> 原文：[https://www.geeksforgeeks.org/how-to-search-a-value-within-a-pandas-dataframe-row/](https://www.geeksforgeeks.org/how-to-search-a-value-within-a-pandas-dataframe-row/)
...
> **语法**：`df[df['column_name'] == value_you_are_look_for]`
> 其中 `df` 是我们的数据帧
