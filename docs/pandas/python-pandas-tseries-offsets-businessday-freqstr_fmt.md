...
> 原文: [https://www.geeksforgeeks.org/python-pandas-tseries-offsets-businessday-freqstr/](https://www.geeksforgeeks.org/python-pandas-tseries-offsets-businessday-freqstr/)
...
使用 `pandas.tseries.offsets.BusinessDay.freqstr` 属性以字符串形式返回应用于给定工作日偏移对象的频率。
