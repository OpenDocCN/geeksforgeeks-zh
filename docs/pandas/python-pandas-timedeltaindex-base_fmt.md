...
> 原文链接: https://www.geeksforgeeks.org/python-pandas-timedeltaindex-base/
...
## 示例 #1
使用 `TimedeltaIndex.base` 属性找出时间增量索引对象的基址。
...
## 示例 #2
使用 `TimedeltaIndex.base` 属性找出 TimedeltaIndex 对象的基址。
