...
> 原文: [https://www.geeksforgeeks.org/python-pandas-tseries-offsets-dateoffset-nanos/](https://www.geeksforgeeks.org/python-pandas-tseries-offsets-dateoffset-nanos/)
...
pandas `tseries.offsets.DateOffset.nanos` 属性返回时间偏移中的纳秒数。它需要是一个固定的频率偏移(像一天而不是一个工作日这样的常数)。

> **语法:** `pandas.tseries.offsets.DateOffset.nanos`
>
> **参数:** 无
>
> **返回:** 日期偏移量中的纳秒数
...
使用 `pandas.tseries.offsets.DateOffset.nanos` 属性返回给定日期偏移对象中的纳秒数。
