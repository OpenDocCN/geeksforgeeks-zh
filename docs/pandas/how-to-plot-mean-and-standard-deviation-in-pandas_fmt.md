...
> 原文：[https://www.geeksforgeeks.org/how-to-plot-mean-and-standard-deviation-in-pandas/](https://www.geeksforgeeks.org/how-to-plot-mean-and-standard-deviation-in-pandas/)

## 误差线

**误差线**是指数据框中包含的误差的图表，显示了一组测量值或计算值的置信度与精度。误差线有助于显示实际和准确的缺失部分，并直观地显示数据框中不同区域的误差。误差线是一种描述性的行为，它包含了关于数据差异的信息，以及进行适当更改的建议，以构建对用户更有洞察力和影响力的数据。
