...
> 原文: [https://www.geeksforgeeks.org/python-pandas-series-nsmallest/](https://www.geeksforgeeks.org/python-pandas-series-nsmallest/)
...
使用`Series.nsmallest()`函数返回给定序列对象的前 n 个最小元素。
