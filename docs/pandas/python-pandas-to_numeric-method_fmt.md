...
> 原文: [https://www.geeksforgeeks.org/python-pandas-to_numeric-method/](https://www.geeksforgeeks.org/python-pandas-to_numeric-method/)
...
使用 `errors='coerce'`。它将用 NaN 替换所有非数值。
