...
> 原文：[https://www.geeksforgeeks.org/python-pandas-timedeltaindex-resolution/](https://www.geeksforgeeks.org/python-pandas-timedeltaindex-resolution/)
...
使用 `TimedeltaIndex.resolution` 属性找出给定对象可用的最低分辨率。
