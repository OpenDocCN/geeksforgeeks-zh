...
> 原文：[https://www.geeksforgeeks.org/how-to-convert-a-pandas-series-to-python-list/](https://www.geeksforgeeks.org/how-to-convert-a-pandas-series-to-python-list/)
...
**在上面的例子中，我们将 Panda 系列数据作为 `np.array(['ant'，' bat'，' cat'，' dog'])` 传递。
指数为 `[100，101，102，103]`**
