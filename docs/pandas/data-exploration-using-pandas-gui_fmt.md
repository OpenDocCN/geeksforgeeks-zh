...
> 原文：[https://www.geeksforgeeks.org/data-exploration-using-pandas-gui/](https://www.geeksforgeeks.org/data-exploration-using-pandas-gui/)
...
汇总统计信息为您提供了数据分布的概述。在熊猫中，我们使用 `describe()` 方法来获得数据的统计。
