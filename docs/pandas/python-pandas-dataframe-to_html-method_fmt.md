...
> 原文: [https://www.geeksforgeeks.org/python-pandas-dataframe-to_html-method/](https://www.geeksforgeeks.org/python-pandas-dataframe-to_html-method/)

借助 `DataFrame.to_html()` 方法，我们可以用该方法得到一个数据帧的 HTML 格式。
