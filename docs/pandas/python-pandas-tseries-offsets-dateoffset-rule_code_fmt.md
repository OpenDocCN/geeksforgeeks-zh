...
> 原文：[https://www.geeksforgeeks.org/python-pandas-tseries-offsets-dateoffset-rule_code/](https://www.geeksforgeeks.org/python-pandas-tseries-offsets-dateoffset-rule_code/)
...
Pandas `tseries.offsets.DateOffset.rule_code` 属性返回应用于给定日期偏移对象的规则代码。例如，月的规则代码是 `"M"`。
...
使用 `pandas.tseries.offsets.DateOffset.rule_code` 属性返回应用于给定日期偏移对象的规则代码。
