...
> 原文: [https://www.geeksforgeeks.org/python-pandas-tseries-offsets-dateoffset-kwds/](https://www.geeksforgeeks.org/python-pandas-tseries-offsets-dateoffset-kwds/)
...
pandas `tseries.offsets.DateOffset.kwds` 属性返回应用于给定 `DateOffset` 对象的关键字参数。如果没有应用 `kwds` 参数，则返回“{ 0 }”。
