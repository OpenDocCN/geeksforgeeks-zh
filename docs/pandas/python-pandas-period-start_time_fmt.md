# Pandas Period.start_time 属性详解

> 原文：[https://www.geeksforgeeks.org/python-pandas-period-start_time/](https://www.geeksforgeeks.org/python-pandas-period-start_time/)
...
使用 `Period.start_time` 属性查找给定周期对象的开始时间。
