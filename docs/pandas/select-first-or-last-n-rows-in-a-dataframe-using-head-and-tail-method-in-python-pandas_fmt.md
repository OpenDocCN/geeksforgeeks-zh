...
> 原文: [https://www.geeksforgeeks.org/select-first-or-last-n-rows-in-a-dataframe-using-head-and-tail-method-in-python-pandas/](https://www.geeksforgeeks.org/select-first-or-last-n-rows-in-a-dataframe-using-head-and-tail-method-in-python-pandas/)

让我们讨论如何使用 `head()` & `tail()` 方法从数据框中选择顶部或底部的 N 行。

## 1) 使用熊猫数据框的 `head()` 方法从数据框中选择前 N 行
...
## 2) 使用熊猫数据框的 `tail()` 方法从数据框中选择最后 N 行
