...
> 原文: [https://www.geeksforgeeks.org/python-pandas-tseries-offsets-custombusinessday-copy/](https://www.geeksforgeeks.org/python-pandas-tseries-offsets-custombusinessday-copy/)
...
Pandas `tseries.offsets.CustomBusinessDay.copy()` 函数创建给定偏移对象的副本。

## 语法
**语法:** `pandas.tseries.offsets.CustomBusinessDay.copy()`
...
### 示例 1
使用 `pandas.tseries.offsets.CustomBusinessDay.copy()` 功能创建给定偏移对象的副本。
