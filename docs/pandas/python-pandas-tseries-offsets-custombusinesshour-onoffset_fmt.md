...
> 原文: [https://www.geeksforgeeks.org/python-pandas-tseries-offsets-custombusinesshour-onoffset/](https://www.geeksforgeeks.org/python-pandas-tseries-offsets-custombusinesshour-onoffset/)
...
Pandas `tseries.offsets.CustomBusinessHour.onOffset()` 功能用于检查给定的时间戳是否在偏移上。
...
## 示例 #1
使用 `pandas.tseries.offsets.CustomBusinessHour.onOffset()` 功能检查给定的时间戳是否在偏移上。
