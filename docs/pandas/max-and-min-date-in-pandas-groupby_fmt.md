...
> 原文: [https://www.geeksforgeeks.org/max-and-min-date-in-pandas-groupby/](https://www.geeksforgeeks.org/max-and-min-date-in-pandas-groupby/)

**先决条件:** `熊猫`

熊猫`groupby`功能非常强大。该函数能够将数据集分成不同的组进行分析。
