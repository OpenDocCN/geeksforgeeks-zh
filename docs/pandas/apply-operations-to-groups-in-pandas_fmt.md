...
> 原文: [https://www.geeksforgeeks.org/apply-operations-to-groups-in-pandas/](https://www.geeksforgeeks.org/apply-operations-to-groups-in-pandas/)

**先决条件:** [Pandas](https://www.geeksforgeeks.org/python-pandas/)
...
转换是执行特定于组的操作，其中单个值发生变化，而数据的形状保持不变。我们使用 [`transform()`](https://www.geeksforgeeks.org/python-pandas-dataframe-transform/) 函数来实现。
