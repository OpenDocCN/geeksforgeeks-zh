...
> 原文: [https://www.geeksforgeeks.org/loop-or-iterate-over-all-or-certain-columns-of-a-dataframe-in-python-pandas/](https://www.geeksforgeeks.org/loop-or-iterate-over-all-or-certain-columns-of-a-dataframe-in-python-pandas/)
...
`DataFrame`类提供了一个成员函数`iteritems()`，它给出了一个迭代器，可以用来迭代数据框的所有列。对于数据帧中的每一列，它都返回一个包含列名及其内容的元组的迭代器。
