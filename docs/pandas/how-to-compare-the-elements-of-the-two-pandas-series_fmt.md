...
> 原文：[https://www.geeksforgeeks.org/how-to-compare-the-elements-of-the-two-pandas-series/](https://www.geeksforgeeks.org/how-to-compare-the-elements-of-the-two-pandas-series/)

有时我们需要比较熊猫系列来进行一些比较分析。借助关系运算符可以比较两个熊猫系列，我们可以很容易地一次比较两个系列的对应元素。结果将以真或假的形式显示。我们也可以使用类似 `Series.equals()` 的函数来比较两个熊猫系列。
...
## 方法二：使用 `Series.equals()` 功能

`Series.equals()` 功能测试两个物体是否包含相同的元素。此功能允许将两个系列或数据帧相互比较，以查看它们是否具有相同的形状和元素。
