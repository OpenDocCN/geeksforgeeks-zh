...
> 原文：[https://www.geeksforgeeks.org/python-pandas-series-dt-to_pydatetime/](https://www.geeksforgeeks.org/python-pandas-series-dt-to_pydatetime/)
...
## 示例 #1
使用`Series.dt.to_pydatetime()`函数将给定的序列对象作为本机 python datetime 对象的数组返回。
