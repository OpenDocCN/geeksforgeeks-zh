...
> 原文：[https://www.geeksforgeeks.org/how-to-drop-rows-that-contain-a-specific-value-in-pandas/](https://www.geeksforgeeks.org/how-to-drop-rows-that-contain-a-specific-value-in-pandas/)

在本文中，我们将讨论如何删除 Pandas 中包含特定值的行。删除行意味着从数据框中删除值。我们可以通过使用条件或关系运算符来删除特定的值。
