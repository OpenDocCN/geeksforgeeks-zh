...
> 原文：[https://www.geeksforgeeks.org/highlight-the-nan-values-in-pandas-dataframe/](https://www.geeksforgeeks.org/highlight-the-nan-values-in-pandas-dataframe/)
...
现在，进入重点部分。我们的目标是突出那些具有 `NaN` 值的单元格。
