...
> 原文: [https://www.geeksforgeeks.org/python-pandas-tseries-offsets-businesshour-name/](https://www.geeksforgeeks.org/python-pandas-tseries-offsets-businesshour-name/)
...
## 示例 1
使用 `pandas.tseries.offsets.BusinessHour.name` 属性以字符串形式返回应用于给定偏移的频率名称。
