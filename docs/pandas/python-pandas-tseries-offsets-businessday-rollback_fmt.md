...
> 原文: [https://www.geeksforgeeks.org/python-pandas-tseries-offsets-businessday-rollback/](https://www.geeksforgeeks.org/python-pandas-tseries-offsets-businessday-rollback/)
...
### 语法
`pandas.tseries.offsets.BusinessDay.rollback(dt)`
...
### 示例 #1
如果不在偏移上，使用 `pandas.tseries.offsets.BusinessDay.rollback()` 功能将提供的日期向后滚动到下一个偏移。
