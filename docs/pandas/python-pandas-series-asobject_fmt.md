...
> 原文：[https://www.geeksforgeeks.org/python-pandas-series-asobject/](https://www.geeksforgeeks.org/python-pandas-series-asobject/)
...
使用 `Series.asobject` 属性返回包含给定系列对象的装箱值的对象系列。
