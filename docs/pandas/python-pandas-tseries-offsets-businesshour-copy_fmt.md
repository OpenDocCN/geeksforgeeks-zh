...
> 原文: [https://www.geeksforgeeks.org/python-pandas-tseries-offsets-businesshour-copy/](https://www.geeksforgeeks.org/python-pandas-tseries-offsets-businesshour-copy/)
...
Pandas `tseries.offsets.BusinessHour.copy()` 功能用于创建给定偏移对象的副本。
...
## 示例 1
使用 `pandas.tseries.offsets.BusinessHour.copy()` 功能创建给定偏移对象的副本。
