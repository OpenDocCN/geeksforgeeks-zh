...
> 原文：[https://www.geeksforgeeks.org/percentile-rank-of-a-column-in-a-pandas-dataframe/](https://www.geeksforgeeks.org/percentile-rank-of-a-column-in-a-pandas-dataframe/)

让我们看看如何在熊猫数据框中找到一列的百分位数。我们将使用带有参数`pct = True`的`rank()`函数来找到百分位数。
