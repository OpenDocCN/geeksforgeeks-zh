...
> 原文: [https://www.geeksforgeeks.org/python-pandas-timestamp-tzname/](https://www.geeksforgeeks.org/python-pandas-timestamp-tzname/)
...
## 示例 #1
使用 `Timestamp.tzname()` 函数返回给定时间戳对象设置到的时区名称。
...
## 示例 #2
使用 `Timestamp.tzname()` 函数返回给定时间戳对象已设置到的时区名称。
