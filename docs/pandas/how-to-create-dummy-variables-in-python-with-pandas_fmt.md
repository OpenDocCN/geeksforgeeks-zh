...
> 原文: [https://www.geeksforgeeks.org/how-to-create-dummy-variables-in-python-with-pandas/](https://www.geeksforgeeks.org/how-to-create-dummy-variables-in-python-with-pandas/)
...
> **语法:** `pandas.get_dummies(data, prefix=None, prefix_sep='_', )`
>
> **参数:**
>
> *   `data` = 输入数据，即包括熊猫数据帧。名单。准备好。numpy 数组等。
> *   `prefix` = 初始值
> *   `prefix_sep` = 数据值分离。
>
> **返回类型:** 虚拟变量。
