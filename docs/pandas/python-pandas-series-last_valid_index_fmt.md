# Pandas Series.last_valid_index() 函数

> 原文: [https://www.geeksforgeeks.org/python-pandas-series-last_valid_index/](https://www.geeksforgeeks.org/python-pandas-series-last_valid_index/)
...
## 示例 #1
使用 `Series.last_valid_index()` 函数返回给定序列对象的最后一个有效索引。
