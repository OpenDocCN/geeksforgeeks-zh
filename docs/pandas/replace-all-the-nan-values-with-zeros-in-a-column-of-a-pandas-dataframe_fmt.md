...
> 原文：[https://www.geeksforgeeks.org/replace-all-the-nan-values-with-zeros-in-a-column-of-a-pandas-dataframe/](https://www.geeksforgeeks.org/replace-all-the-nan-values-with-zeros-in-a-column-of-a-pandas-dataframe/)
...
`DataFrame.fillna(自身，值=无，方法=无，轴=无，位置=假，限制=无，向下转换=无)`
...
数据帧或无。填充了空值的对象，如果 `inplace=True`，则为无。
