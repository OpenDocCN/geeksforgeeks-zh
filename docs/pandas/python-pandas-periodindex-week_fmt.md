...
> 原文: [https://www.geeksforgeeks.org/python-pandas-periodindex-week/](https://www.geeksforgeeks.org/python-pandas-periodindex-week/)
...
使用 `PeriodIndex.week` 属性找出给定 `PeriodIndex` 对象中包含的每个 period 元素的周序数值。
