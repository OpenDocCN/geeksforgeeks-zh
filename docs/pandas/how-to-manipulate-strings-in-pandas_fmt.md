...
> 原文：`https://www.geeksforgeeks.org/how-to-manipulate-strings-in-pandas/`
...
`pandas`库提供了一个`.str()`方法，可用于将数据框中的任何列创建为字符串。此后，python 文档或本文[中定义的任何字符串操作](https://www.geeksforgeeks.org/python-strings/)都可以用于该数据。
