...
> 原文：[https://www.geeksforgeeks.org/string-munging-in-pandas-dataframe/](https://www.geeksforgeeks.org/string-munging-in-pandas-dataframe/)
...
现在创建一个字典并通过 `pd.DataFrame()` 创建数据框。
