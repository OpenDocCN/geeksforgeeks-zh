...
> 原文：[https://www.geeksforgeeks.org/sort-the-pandas-dataframe-by-two-or-more-columns/](https://www.geeksforgeeks.org/sort-the-pandas-dataframe-by-two-or-more-columns/)
...
**示例 2：** 根据“名称”和“收藏夹_颜色”列按升序对数据框进行排序。
...
**示例 3：** 基于“等级”和“收藏夹_颜色”列的数据框就地排序。在就地排序的情况下，`Dataframe.sort_values()`方法在实际数据帧中执行更改时不返回任何内容。
