...
> 原文: [https://www.geeksforgeeks.org/python-pandas-series-dt-strftime/](https://www.geeksforgeeks.org/python-pandas-series-dt-strftime/)
...
## 示例 #1
使用`Series.dt.strftime()`函数将给定序列对象中的日期转换为指定的日期格式。
