...
> 原文: [https://www.geeksforgeeks.org/how-to-select-rows-from-pandas-dataframe/](https://www.geeksforgeeks.org/how-to-select-rows-from-pandas-dataframe/)

`pandas.DataFrame.loc`是根据提供的条件从熊猫数据框中选择行的函数。在本文中，让我们学习根据一些条件从熊猫数据框中选择行。

## 语法

`df.loc[df['cname'] condition]`

**参数:**
- `df`: 代表数据框
- `cname`: 代表列名
- `condition`: 代表必须选择行的条件
...
**产量:**
![](img/4dab3dac76a8afe0f825eda9a732647f.png)
