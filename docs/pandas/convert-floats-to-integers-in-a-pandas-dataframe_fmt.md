...
> 原文：[https://www.geeksforgeeks.org/convert-floats-to-integers-in-a-pandas-dataframe/](https://www.geeksforgeeks.org/convert-floats-to-integers-in-a-pandas-dataframe/)
...
### 示例 1：使用 `DataFrame.astype()` 将一个列从浮点转换为整数
...
### 示例 1：使用 `DataFrame.apply(np.int64)` 将单个列从浮点转换为整数
