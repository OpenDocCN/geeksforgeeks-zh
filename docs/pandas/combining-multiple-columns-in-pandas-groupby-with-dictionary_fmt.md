...
> 原文：[https://www.geeksforgeeks.org/combining-multiple-columns-in-pandas-groupby-with-dictionary/](https://www.geeksforgeeks.org/combining-multiple-columns-in-pandas-groupby-with-dictionary/)

让我们看看如何借助不同的例子，使用`groupby`和字典来组合`Pandas`中的多个列。
