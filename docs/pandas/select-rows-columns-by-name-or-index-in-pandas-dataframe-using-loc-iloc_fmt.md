...
> 原文: [https://www.geeksforgeeks.org/select-rows-columns-by-name-or-index-in-pandas-dataframe-using-loc-iloc/](https://www.geeksforgeeks.org/select-rows-columns-by-name-or-index-in-pandas-dataframe-using-loc-iloc/)
...
我们使用单冒号`[ : ]`来选择我们想要选择的所有行和列列表，如下所示:
