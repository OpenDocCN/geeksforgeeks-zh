...
> 原文：[https://www.geeksforgeeks.org/get-the-substring-of-the-column-in-pandas-python/](https://www.geeksforgeeks.org/get-the-substring-of-the-column-in-pandas-python/)
...
## 示例 4
我们也可以使用 `str.extract` 来完成这个任务。在本例中，我们将在“姓氏”列中存储每个人的姓氏。
