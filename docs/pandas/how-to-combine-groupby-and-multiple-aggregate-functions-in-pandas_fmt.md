...
> 原文: [https://www.geeksforgeeks.org/how-to-combine-groupby-and-multiple-aggregate-functions-in-pandas/](https://www.geeksforgeeks.org/how-to-combine-groupby-and-multiple-aggregate-functions-in-pandas/)
...
熊猫`dataframe.groupby()`功能用于根据给定的条件将数据帧中的数据分成组。
...
Pandas `dataframe.agg()`功能用于对基于指定轴的数据进行一个或多个操作。
