...
> 原文：[https://www.geeksforgeeks.org/python-pandas-date_range-method/](https://www.geeksforgeeks.org/python-pandas-date_range-method/)
...
> `normalize`：将开始/结束日期归一化到生成日期范围前的午夜。
> `name`：结果日期时间索引的名称。
> `closed`：使间隔相对于给定频率向“左”、“右”或两侧关闭（无，默认）。
>
> **返回：** `DatetimeIndex`
