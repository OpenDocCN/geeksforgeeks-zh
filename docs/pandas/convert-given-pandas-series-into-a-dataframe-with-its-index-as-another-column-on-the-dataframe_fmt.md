...
> 原文: [https://www.geeksforgeeks.org/convert-given-pandas-series-into-a-dataframe-with-its-index-as-another-column-on-the-dataframe/](https://www.geeksforgeeks.org/convert-given-pandas-series-into-a-dataframe-with-its-index-as-another-column-on-the-dataframe/)
...
> **语法:** `pandas.Series(数据, 索引, 数据类型, 副本)`
> **返回:** 系列对象。
...
现在，我们将使用[**`series.to_frame()`**](https://www.geeksforgeeks.org/python-pandas-series-to_frame/)和[**`dataframe.reset_index()`**](https://www.geeksforgeeks.org/python-pandas-dataframe-reset_index/)方法将给定的 Pandas 系列转换为数据帧，其索引作为数据帧上的另一列。
