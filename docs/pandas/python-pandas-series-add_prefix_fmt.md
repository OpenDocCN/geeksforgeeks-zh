...
> 原文: [https://www.geeksforgeeks.org/python-pandas-series-add_prefix/](https://www.geeksforgeeks.org/python-pandas-series-add_prefix/)
...
使用 `Series.add_prefix()` 函数为给定序列对象中的每个索引标签添加前缀。
...
现在我们将使用 `Series.add_prefix()` 函数在给定序列对象中的每个索引标签之前添加字符串标签 'IPL 2019_'。
