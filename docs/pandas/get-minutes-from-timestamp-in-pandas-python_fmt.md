...
> 原文：[https://www.geeksforgeeks.org/get-minutes-from-timestamp-in-pandas-python/](https://www.geeksforgeeks.org/get-minutes-from-timestamp-in-pandas-python/)
...
在上面创建的时间戳对象中，分钟的值是“0”。让我们使用 `Timestamp.minute` 属性提取这个值。
