...
> 原文: [https://www.geeksforgeeks.org/apply-a-function-to-single-or-selected-columns-or-rows-in-pandas-dataframe/](https://www.geeksforgeeks.org/apply-a-function-to-single-or-selected-columns-or-rows-in-pandas-dataframe/)

在本文中，我们将学习对 `Dataframe` 中的单个或选定列或行应用函数的不同方法。我们将使用 `Dataframe/series.apply()` 方法来应用函数。
...
## 方法二: 使用 `Dataframe/series.apply()` 和 `[]` 运算符
