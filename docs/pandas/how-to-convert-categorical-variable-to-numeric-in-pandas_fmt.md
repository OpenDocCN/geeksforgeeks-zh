...
> 原文：[https://www.geeksforgeeks.org/how-to-convert-categorical-variable-to-numeric-in-pandas/](https://www.geeksforgeeks.org/how-to-convert-categorical-variable-to-numeric-in-pandas/)
...
下一步是将假人列连接到数据帧中。在 pandas 中，有一个 `concat()` 方法，可以调用它来连接两个数据帧。您应该为它提供两个数据框的名称和轴。这将为您提供合并的数据框。
