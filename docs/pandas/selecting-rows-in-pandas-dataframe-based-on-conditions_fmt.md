...
> 原文：[https://www.geeksforgeeks.org/selecting-rows-in-pandas-dataframe-based-on-conditions/](https://www.geeksforgeeks.org/selecting-rows-in-pandas-dataframe-based-on-conditions/)
...
**代码#2：** 使用`loc[]`从给定数据框中选择“年龄”等于 21 且“流”出现在选项列表中的所有行。
