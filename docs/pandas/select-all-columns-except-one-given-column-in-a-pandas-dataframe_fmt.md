...
[`数据框架`](https://www.geeksforgeeks.org/python-pandas-dataframe/)数据结构是[`熊猫`](https://www.geeksforgeeks.org/python-pandas-dataframe/)库的心脏。数据框基本上是二维系列对象。它们有行和列，行代表索引，列代表内容。现在，让我们看看如何选择除熊猫数据框中一个给定列之外的所有列。
