...
> 原文: [https://www.geeksforgeeks.org/python-pandas-series-factorize/](https://www.geeksforgeeks.org/python-pandas-series-factorize/)
...
### 参数
- `sort`: 排序 `uniques` 和 shuffle 标签保持关系。
...
## 示例 #1
使用 `Series.factorize()` 函数对给定序列对象的底层数据进行编码。
