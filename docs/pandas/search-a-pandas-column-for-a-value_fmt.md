...
> 原文: [https://www.geeksforgeeks.org/search-a-pandas-column-for-a-value/](https://www.geeksforgeeks.org/search-a-pandas-column-for-a-value/)
...
*   [`where()`](https://www.geeksforgeeks.org/python-pandas-dataframe-where/#:~:text=Pandas%20where()%20method%20is,are%20filled%20with%20NaN%20value.) - 用于检查数据帧的一个或多个条件，并相应地返回结果。默认情况下，不满足条件的行用 NaN 值填充。
