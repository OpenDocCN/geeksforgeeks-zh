...
> 原文: [https://www.geeksforgeeks.org/how-to-flatten-multiindex-in-pandas/](https://www.geeksforgeeks.org/how-to-flatten-multiindex-in-pandas/)
...
`Dataframe` 是输入数据帧，我们必须创建 `dataframe` `MultiIndex`。
