...
> 原文: [https://www.geeksforgeeks.org/python-pandas-series-as_blocks/](https://www.geeksforgeeks.org/python-pandas-series-as_blocks/)
...
使用 `Series.as_blocks()` 函数将给定的序列对象作为字典返回。
...
使用 `Series.as_blocks()` 函数返回给定的序列对象作为字典。
