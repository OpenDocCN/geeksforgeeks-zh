...
> 原文: `https://www.geeksforgeeks.org/python-pandas-multiindex-to_hierarchical/`
...
使用 `MultiIndex.to_hierarchical()` 功能重复多索引中的标签。
...
使用 `MultiIndex.to_hierarchical()` 功能重复并重新排列多索引中的标签。
