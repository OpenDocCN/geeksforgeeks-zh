...
> 原文: [https://www.geeksforgeeks.org/pandas-groupby-summarising-aggregating-and-grouping-data-in-python/](https://www.geeksforgeeks.org/pandas-groupby-summarising-aggregating-and-grouping-data-in-python/)
...
摘要包括计数，描述数据帧中存在的所有数据。我们可以使用 `describe()` 方法总结数据框中的数据。此方法用于从数据框中获取最小值、最大值、总和、计数值以及特定列的数据类型。
