...
> 原文: [https://www.geeksforgeeks.org/how-to-get-column-names-in-pandas-dataframe/](https://www.geeksforgeeks.org/how-to-get-column-names-in-pandas-dataframe/)

在分析实际数据集时，这些数据集的大小通常非常大，我们可能需要获取列名来执行某些操作。我们来讨论一下如何在 Pandas [数据框](https://www.geeksforgeeks.org/python-pandas-dataframe/)中获取列名。
