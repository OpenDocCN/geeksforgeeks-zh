...
> 原文: [https://www.geeksforgeeks.org/how-to-iterate-over-dataframe-groups-in-python-pandas/](https://www.geeksforgeeks.org/how-to-iterate-over-dataframe-groups-in-python-pandas/)
...
## 方法二：将 `dataframe.groupby()` 和 `groupby_object.groups.keys()` 一起使用
