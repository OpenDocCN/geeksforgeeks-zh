...
> 原文: [https://www.geeksforgeeks.org/python-pandas-series-aggregate/](https://www.geeksforgeeks.org/python-pandas-series-aggregate/)
...
使用`Series.aggregate()`函数对给定序列对象的底层数据进行聚合。
