...
> 原文: [https://www.geeksforgeeks.org/python-pandas-datetimeindex-microsecond/](https://www.geeksforgeeks.org/python-pandas-datetimeindex-microsecond/)
...
## 示例#1:
使用 `DatetimeIndex.microsecond` 属性查找 `DatetimeIndex` 对象中的微秒值。
...
## 示例#2:
使用 `DatetimeIndex.microsecond` 属性查找 `DatetimeIndex` 对象中存在的微秒值。
