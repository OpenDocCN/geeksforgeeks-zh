# Pandas CustomBusinessHour.rule_code属性

> 原文：[https://www.geeksforgeeks.org/python-pandas-tseries-offsets-custombusinesshour-rule_code/](https://www.geeksforgeeks.org/python-pandas-tseries-offsets-custombusinesshour-rule_code/)
...
**语法：** `pandas.tseries.offsets.CustomBusinessHour.rule_code`
...
使用 `pandas.tseries.offsets.CustomBusinessHour.rule_code` 属性将应用于给定偏移对象的频率的规则代码打印为字符串。
