...
> 原文：[https://www.geeksforgeeks.org/python-pandas-tseries-offsets-businessday-rule_code/](https://www.geeksforgeeks.org/python-pandas-tseries-offsets-businessday-rule_code/)
...
Pandas `tseries.offsets.BusinessDay.rule_code` 属性允许您在函数中使用偏移量以简化操作，而不是导入和初始化类。它还返回应用于偏移对象的频率规则代码。
...
使用 `pandas.tseries.offsets.BusinessDay.rule_code` 属性返回应用于给定偏移对象的频率的规则代码。
