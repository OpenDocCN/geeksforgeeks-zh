...
> 原文: [https://www.geeksforgeeks.org/how-to-group-dataframe-rows-into-list-in-pandas-groupby/](https://www.geeksforgeeks.org/how-to-group-dataframe-rows-into-list-in-pandas-groupby/)
...
我们可以在第 1 列使用 [`groupby()`](https://www.geeksforgeeks.org/python-pandas-dataframe-groupby/) 方法，并应用该方法在每组熊猫数据框上应用一个列表。
...
我们可以使用第 1 列的 `groupby()`方法和 [`agg()`](https://www.geeksforgeeks.org/python-pandas-series-agg/) 方法对每组熊猫数据帧应用聚合，包括 [`lambda`](https://www.geeksforgeeks.org/python-lambda/) 函数。
...
我们可以使用第 1 列的 `groupby()`方法和 `agg()`方法对每组熊猫数据帧应用聚合列表。
...
我们可以在第 1 列使用 `groupby()`方法，通过传递“ [`pd.Series.tolist`](https://www.geeksforgeeks.org/python-pandas-series-tolist/) 作为参数。
