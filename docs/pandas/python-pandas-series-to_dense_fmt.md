...
> 原文: [https://www.geeksforgeeks.org/python-pandas-series-to_dense/](https://www.geeksforgeeks.org/python-pandas-series-to_dense/)
...
使用`Series.to_dense()`函数将给定的序列对象转换为密集序列对象。
...
使用`Series.to_dense()`功能将给定的系列对象转换为密集系列对象。
