...
> 原文: [https://www.geeksforgeeks.org/sort-rows-or-columns-in-pandas-dataframe-based-on-values/](https://www.geeksforgeeks.org/sort-rows-or-columns-in-pandas-dataframe-based-on-values/)
...
- `kind`: 可以有三个输入 (`'quicksort'`, `'mergesort'` 或 `'heapsort'`) 的用于对数据帧进行排序的算法的字符串。
