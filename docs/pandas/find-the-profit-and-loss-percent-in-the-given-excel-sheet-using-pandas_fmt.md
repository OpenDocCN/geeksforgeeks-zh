# 使用熊猫在给定的 Excel 表格中找出盈亏百分比

> 原文: [https://www.geeksforgeeks.org/find-the-profit-and-loss-percent-in-the-given-excel-sheet-using-pandas/](https://www.geeksforgeeks.org/find-the-profit-and-loss-percent-in-the-given-excel-sheet-using-pandas/)
...
要获取上面使用的 excel 文件，点击这里[。](https://drive.google.com/file/d/1HNlNTcOL9XY_amMMj4PuRT5D7oeHsZmG/view?usp=sharing)
