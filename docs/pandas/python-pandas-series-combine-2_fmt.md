...
> 原文: [https://www.geeksforgeeks.org/python-pandas-series-combine-2/](https://www.geeksforgeeks.org/python-pandas-series-combine-2/)
...
使用 `Series.combine()` 函数查找两个系列对象中每个索引标签的最大值。
...
使用 `Series.combine()` 函数查找两个系列对象中每个索引标签的最小值。
