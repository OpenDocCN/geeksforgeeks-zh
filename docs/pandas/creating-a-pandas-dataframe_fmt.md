...
数据框是一种二维数据结构，即数据以表格形式排列成行和列。在按行和列排列的数据框数据集，我们可以在一个数据框中存储任意数量的数据集。我们可以对这些数据集执行许多操作，如算术运算、列/行选择、列/行添加等。
...
*   [使用列表创建数据框](https://www.geeksforgeeks.org/create-a-pandas-dataframe-from-lists/)
