...
> 原文: [https://www.geeksforgeeks.org/how-to-filter-and-save-the-data-as-new-files-in-excel-with-python-pandas/](https://www.geeksforgeeks.org/how-to-filter-and-save-the-data-as-new-files-in-excel-with-python-pandas/)

## 前提条件
[Python 熊猫](https://www.geeksforgeeks.org/pandas-tutorial/)
...
## 说明
*   首先，我们导入了 `pandas` 库。
*   然后我们已经在 `data` 对象中加载了 `datasets.xlsx` excel 文件。
*   为了从该 `Species` 列中获取唯一值，我们使用了 `unique()` 函数。为了检查 `Species` 列中的唯一值，我们在 `speciesdata` 对象中调用了 `unique()`。
