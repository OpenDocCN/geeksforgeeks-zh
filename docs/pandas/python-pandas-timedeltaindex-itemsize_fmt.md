...
> 原文链接：https://www.geeksforgeeks.org/python-pandas-timedeltaindex-itemsize/
...
**示例 #2：** 使用 `TimedeltaIndex.itemsize` 属性找出 TimedeltaIndex 对象中底层数据的数据类型大小。
