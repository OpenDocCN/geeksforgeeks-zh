...
> 原文: [https://www.geeksforgeeks.org/how-to-apply-functions-in-a-group-in-a-pandas-dataframe/](https://www.geeksforgeeks.org/how-to-apply-functions-in-a-group-in-a-pandas-dataframe/)

在本文中，让我们看看如何在熊猫数据框中的一个组中应用函数。执行此任务需要遵循的步骤是–

*   导入必要的库。
*   将数据设置为熊猫数据框。
*   使用 `apply` 功能来查找不同的统计度量，如滚动平均值、平均值、总和、最大值和最小值。您可以为此使用 [lambda 功能](https://www.geeksforgeeks.org/python-lambda-anonymous-functions-filter-map-reduce/)。
