...
> 原文: [https://www.geeksforgeeks.org/python-pandas-series-dt-days_in_month/](https://www.geeksforgeeks.org/python-pandas-series-dt-days_in_month/)
...
## 示例#1
使用`Series.dt.days_in_month`属性在序列对象中查找给定日期当月的天数。
