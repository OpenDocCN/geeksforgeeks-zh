...
> 原文: [https://www.geeksforgeeks.org/how-to-combine-two-dataframe-in-python-pandas/](https://www.geeksforgeeks.org/how-to-combine-two-dataframe-in-python-pandas/)
...
*   把他们都联合起来，`join='outer'`。这是默认选项，因为它导致零信息丢失。
*   走十字路口，`join='inner'`。
