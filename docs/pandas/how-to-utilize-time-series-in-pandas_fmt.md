...
> 原文：[https://www.geeksforgeeks.org/how-to-utilize-time-series-in-pandas/](https://www.geeksforgeeks.org/how-to-utilize-time-series-in-pandas/)
...
> **语法：** `pandas.date_range(start=None, end=None, periods=None, freq=None)`
>
> **参数：**
>
> *   **开始：** 从开始日期开始的开始日期时间。
