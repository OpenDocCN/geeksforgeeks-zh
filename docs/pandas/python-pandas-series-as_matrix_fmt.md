...
> 原文: [https://www.geeksforgeeks.org/python-pandas-series-as_matrix/](https://www.geeksforgeeks.org/python-pandas-series-as_matrix/)
...
## 示例 1
使用 `Series.as_matrix()` 函数返回给定序列对象的 numpy 数组表示。
