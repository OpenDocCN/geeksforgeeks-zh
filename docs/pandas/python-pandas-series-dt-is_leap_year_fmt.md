...
> 原文: [https://www.geeksforgeeks.org/python-pandas-series-dt-is_leap_year/](https://www.geeksforgeeks.org/python-pandas-series-dt-is_leap_year/)

`Series.dt`可用于访问系列的值，如 datetimelike，并返回几个属性。如果日期属于闰年，Pandas `Series.dt.is_leap_year`属性返回一个布尔指示符。
...
使用`Series.dt.is_leap_year`属性检查给定序列对象的基础数据中的日期是否属于闰年。
