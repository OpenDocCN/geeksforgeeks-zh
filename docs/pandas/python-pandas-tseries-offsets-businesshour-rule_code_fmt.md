...
> 原文: [https://www.geeksforgeeks.org/python-pandas-tseries-offsets-businesshour-rule_code/](https://www.geeksforgeeks.org/python-pandas-tseries-offsets-businesshour-rule_code/)
...
**语法：** `pandas.tseries.offsets.BusinessHour.rule_code`
...
使用 `pandas.tseries.offsets.BusinessHour.rule_code` 属性以字符串形式返回应用于给定偏移的频率的规则代码。
