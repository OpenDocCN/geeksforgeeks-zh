...
> 原文: [https://www.geeksforgeeks.org/python-pandas-timestamp-timetz/](https://www.geeksforgeeks.org/python-pandas-timestamp-timetz/)
...
使用 `Timestamp.timetz()` 函数返回包含给定时间戳对象的时间和时区信息的时间对象。
