...
> 原文: [https://www.geeksforgeeks.org/python-pandas-series-is_monotonic_decreasing/](https://www.geeksforgeeks.org/python-pandas-series-is_monotonic_decreasing/)
...
Pandas `Series.is_monotonic_decreasing` 属性返回一个布尔值。如果给定序列对象中的数据单调递减，则返回 `True`，否则返回 `False`。

> **语法:** `Series.is_monotonic_decreasing`
> **参数:** 无
> **返回:** 布尔值
