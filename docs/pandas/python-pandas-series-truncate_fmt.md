...
> 原文: [https://www.geeksforgeeks.org/python-pandas-series-truncate/](https://www.geeksforgeeks.org/python-pandas-series-truncate/)
...
### 示例#1
使用 `Series.truncate()` 函数从给定日期之前的序列中截断一些数据。
...
### 示例#2
使用 `Series.truncate()` 函数在给定索引标签之前和给定索引标签之后截断序列中的一些数据。
