...
> 原文: [https://www.geeksforgeeks.org/python-pandas-tseries-offsets-custombusinessday-freqstr/](https://www.geeksforgeeks.org/python-pandas-tseries-offsets-custombusinessday-freqstr/)
...
## 示例 #1
使用 `pandas.tseries.offsets.CustomBusinessDay.freqstr` 属性以字符串形式返回应用于给定偏移对象的频率。
