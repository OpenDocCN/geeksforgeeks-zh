# Python | Pandas tseries.offsets.BusinessHour.next_bday

> 原文: [https://www.geeksforgeeks.org/python-pandas-tseries-offsets-businesshour-next_bday/](https://www.geeksforgeeks.org/python-pandas-tseries-offsets-businesshour-next_bday/)
...
pandas `tseries.offsets.BusinessHour.next_bday` 功能用于移至下一个工作日。

> **语法:** `pandas.tseries.offsets.BusinessHour.next_bday`
> 
> **参数:** 无
> 
> **返回:** 偏移量
...
**示例 2:** 使用 `pandas.tseries.offsets.BusinessHour()` 功能创建 10 天 10 个工作时间的偏移量。
