# Pandas tseries.offsets.CustomBusinessDay.onOffset 方法详解

> 原文：[https://www.geeksforgeeks.org/python-pandas-tseries-offsets-custombusinessday-onoffset/](https://www.geeksforgeeks.org/python-pandas-tseries-offsets-custombusinessday-onoffset/)
...
Pandas 的 `tseries.offsets.CustomBusinessDay.onOffset()` 功能检查给定的时间戳是否有偏移。

> **语法：** `pandas.tseries.offsets.CustomBusinessDay.onOffset(dt)`
>
> **参数：**
> **dt：** 日期
>
