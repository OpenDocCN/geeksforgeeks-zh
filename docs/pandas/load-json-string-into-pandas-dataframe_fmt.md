...
> 原文: [https://www.geeksforgeeks.org/load-json-string-into-pandas-dataframe/](https://www.geeksforgeeks.org/load-json-string-into-pandas-dataframe/)

让我们看看如何在熊猫数据框中使用 JSON 格式的数据集。这可以使用内置的 `read_json()` 功能来完成。它使我们能够阅读熊猫数据框中的 JSON。

## 示例

考虑 JSON 文件路径 `path_to_json.json`:
