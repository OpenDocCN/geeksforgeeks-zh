...
> 原文: [https://www.geeksforgeeks.org/collapse-multiple-columns-in-pandas/](https://www.geeksforgeeks.org/collapse-multiple-columns-in-pandas/)

在熊猫中操作数据框时，我们可能会遇到折叠列的情况。让它成为多列的累积数据，或者根据其他要求折叠。让我们看看如何折叠熊猫中的多个列。
