...
> 原文: [https://www.geeksforgeeks.org/pandas-filter-a-dataframe-by-the-sum-of-rows-or-columns/](https://www.geeksforgeeks.org/pandas-filter-a-dataframe-by-the-sum-of-rows-or-columns/)
...
1.  创建或导入数据框
2.  对行求和: 这可以使用`.sum()`函数并通过参数`axis=1`来完成
