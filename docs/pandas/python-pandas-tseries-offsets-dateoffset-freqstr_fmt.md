...
> 原文：https://www.geeksforgeeks.org/python-pandas-tseries-offsets-dateoffset-freqstr/
...
## 示例 #1
使用 `pandas.tseries.offsets.DateOffset.freqstr` 属性以字符串形式返回应用于给定日期偏移对象的频率对象。
