...
> 原文: [https://www.geeksforgeeks.org/python-pandas-index-dtype_str/](https://www.geeksforgeeks.org/python-pandas-index-dtype_str/)
...
使用 `Index.dtype_str` 属性以字符串形式查找给定索引对象的基础数据的数据类型。
