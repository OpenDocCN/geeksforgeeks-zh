...
> 原文: [https://www.geeksforgeeks.org/python-pandas-series-nlargest/](https://www.geeksforgeeks.org/python-pandas-series-nlargest/)
...
## 示例 #1
使用`Series.nlargest()`函数返回给定序列对象的第一个 n 大元素。
