...
> 原文：[https://www.geeksforgeeks.org/ranking-rows-of-pandas-dataframe/](https://www.geeksforgeeks.org/ranking-rows-of-pandas-dataframe/)
...
我们举一个4个学生得分的例子。我们将根据学生的最高分对他们进行排名。
...
注意这里我们看到拉杰和阿琼各得90分，因此他们的排名是2.5（第二和第三排名的平均值，即他们共享的两个排名）。对于表中的其他标记也可以看到这一点。