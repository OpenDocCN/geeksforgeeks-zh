...
> 原文: [https://www.geeksforgeeks.org/clean-the-string-data-in-the-given-pandas-dataframe/](https://www.geeksforgeeks.org/clean-the-string-data-in-the-given-pandas-dataframe/)
...
很多时候我们会遇到这样的情况，我们需要编写适合手头任务的自定义函数。
...
现在我们将看到使用熊猫 `DataFrame.apply()` 功能的更好、更高效的方法。
...
让我们使用熊猫 `DataFrame.apply()` 功能以正确的格式格式化产品名称。在熊猫 `DataFrame.apply()` 函数中，我们将使用 `lambda` 函数。
