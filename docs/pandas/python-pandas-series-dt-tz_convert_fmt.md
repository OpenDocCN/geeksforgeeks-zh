...
> 原文：[https://www.geeksforgeeks.org/python-pandas-series-dt-tz_convert/](https://www.geeksforgeeks.org/python-pandas-series-dt-tz_convert/)
...
使用`Series.dt.tz_convert()`函数转换给定序列对象中时间戳的时区。
