# pandas `describe_option()` 函数在 Python 中

> 原文: [https://www.geeksforgeeks.org/pandas-describe_option-function-in-python/](https://www.geeksforgeeks.org/pandas-describe_option-function-in-python/)

Pandas 有一个选项系统，可以让你自定义其行为的某些方面，显示相关的选项是用户最有可能调整的。让我们看看如何查看指定选项的描述。

## `describe_option()`

> **语法:** `pandas.describe_option(pat, _print_desc=False)`
>
> **参数:**
>
> *   `pat` : `Regexp`，应该匹配单个选项。
...
>
> **返回:** 无。默认情况下，如果 `_print_desc` 为假，则描述为 `unicode` 字符串。
