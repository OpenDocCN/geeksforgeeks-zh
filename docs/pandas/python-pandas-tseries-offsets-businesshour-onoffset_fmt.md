...
> 原文: [https://www.geeksforgeeks.org/python-pandas-tseries-offsets-businesshour-onoffset/](https://www.geeksforgeeks.org/python-pandas-tseries-offsets-businesshour-onoffset/)
...
Pandas `tseries.offsets.BusinessHour.onOffset()` 功能用于检查通过日期是否偏移。
...
## 示例 #1
使用 `pandas.tseries.offsets.BusinessHour.onOffset()` 功能检查通过日期是否偏移。
