...
> 原文：[https://www.geeksforgeeks.org/select-a-single-column-of-data-as-a-series-in-pandas/](https://www.geeksforgeeks.org/select-a-single-column-of-data-as-a-series-in-pandas/)
...
在上面两个例子中，我们使用了 `pd.Series()` 选择数据框中的一列作为一个系列。