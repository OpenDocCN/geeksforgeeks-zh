...
> 原文: [https://www.geeksforgeeks.org/join-pandas-dataframes-matching-by-substring/](https://www.geeksforgeeks.org/join-pandas-dataframes-matching-by-substring/)
...
*   [`merge()`](https://www.geeksforgeeks.org/python-pandas-merging-joining-and-concatenating/): 合并两个数据帧
