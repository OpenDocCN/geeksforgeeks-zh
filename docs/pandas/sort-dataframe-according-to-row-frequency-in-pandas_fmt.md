...
> 原文: [https://www.geeksforgeeks.org/sort-dataframe-according-to-row-frequency-in-pandas/](https://www.geeksforgeeks.org/sort-dataframe-according-to-row-frequency-in-pandas/)
...
*   `sort_values():` This method helps us sort data frames. In this method, we pass the column, and our data frame is sorted according to the column.
