...
> 原文: [https://www.geeksforgeeks.org/how-to-read-json-files-with-pandas/](https://www.geeksforgeeks.org/how-to-read-json-files-with-pandas/)
...
这里我们将创建 JSON 数据，然后使用 `pd.DataFrame()` 方法通过它创建一个数据框架。
