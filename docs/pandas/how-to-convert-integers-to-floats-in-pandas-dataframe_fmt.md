...
> 原文: [https://www.geeksforgeeks.org/how-to-convert-integers-to-floats-in-pandas-dataframe/](https://www.geeksforgeeks.org/how-to-convert-integers-to-floats-in-pandas-dataframe/)
...
### 示例 1: 使用 `DataFrame.astype()` 将单个列从 int 转换为 float
...
在上例中，我们将列“Weight”的数据类型从“int64”更改为“float64”。

### 示例 2: 使用 `DataFrame.astype()` 将多个列从 int 转换为 float
...
在上例中，我们将列“Age”和“Strike_rate”的数据类型从“int64”更改为“float64”。
...
### 示例 1: 使用 `pandas.to_numeric()` 将单个列从 int 转换为 float
...
在上例中，我们将列“Weight”的数据类型从“int64”更改为“float32”。
