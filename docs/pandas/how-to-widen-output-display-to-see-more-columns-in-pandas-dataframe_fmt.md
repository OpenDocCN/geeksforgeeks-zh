...
> 原文: [https://www.geeksforgeeks.org/how-to-widen-output-display-to-see-more-columns-in-pandas-dataframe/](https://www.geeksforgeeks.org/how-to-widen-output-display-to-see-more-columns-in-pandas-dataframe/)

在 Python 中，如果数据框中有更多的列，那么并非所有的列都会显示在输出显示中。因此，让我们看看如何扩大输出显示，以看到更多的列。

## 方法一：使用 `pandas.set_option()` 函数
