...
> 原文：[https://www.geeksforgeeks.org/how-to-count-observations-by-group-in-pandas/](https://www.geeksforgeeks.org/how-to-count-observations-by-group-in-pandas/)
...
*   `squeeze`：如果可能，减少返回类型的维度，否则返回一致的类型
