...
> 原文：[https://www.geeksforgeeks.org/how-to-get-the-descriptive-statistics-for-pandas-dataframe/](https://www.geeksforgeeks.org/how-to-get-the-descriptive-statistics-for-pandas-dataframe/)

`describe()`方法用于计算描述性统计数据，如计数、唯一值、平均值、标准差、最小值和最大值等。在本文中，让我们学习获取熊猫数据框的描述性统计数据。
...
>
> **参数：**
> `percentiles`：表示函数必须返回的百分位值。默认值为 0.25、0.5 和 0.75
> `include`：代表必须包含的数据类型列表
> `exclude`：代表必须排除的数据类型列表
