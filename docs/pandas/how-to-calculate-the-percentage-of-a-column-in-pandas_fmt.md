...
> 原文：[https://www.geeksforgeeks.org/how-to-calculate-the-percentage-of-a-column-in-pandas/](https://www.geeksforgeeks.org/how-to-calculate-the-percentage-of-a-column-in-pandas/)

`百分比`由数值除以所有数值之和再乘以 100 的数学公式计算得出。这也适用于熊猫数据帧。这里，熊猫系列的预定义 [`sum()`](https://www.geeksforgeeks.org/python-pandas-series-sum/) 方法用于计算一列所有值的总和。
