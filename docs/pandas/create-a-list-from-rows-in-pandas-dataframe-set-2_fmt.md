...
> 原文: [https://www.geeksforgeeks.org/create-a-list-from-rows-in-pandas-dataframe-set-2/](https://www.geeksforgeeks.org/create-a-list-from-rows-in-pandas-dataframe-set-2/)

在早期的帖子中，我们讨论了一些将数据框的行提取为 Python 列表的方法。在这篇文章中，我们将看到更多实现这一目标的方法。
...
正如我们在输出中看到的，我们已经成功地将给定数据框的每一行提取到一个列表中。就像任何其他 Python 的列表一样，我们可以对提取的列表执行任何列表操作。
