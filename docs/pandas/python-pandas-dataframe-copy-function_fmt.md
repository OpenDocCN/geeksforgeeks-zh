# 蟒蛇熊猫–DataFrame.copy()功能

> 原文: [https://www.geeksforgeeks.org/python-pandas-dataframe-copy-function/](https://www.geeksforgeeks.org/python-pandas-dataframe-copy-function/)
