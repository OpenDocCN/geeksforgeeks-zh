...
> 原文: [https://www.geeksforgeeks.org/find-exponential-of-a-column-in-pandas-python/](https://www.geeksforgeeks.org/find-exponential-of-a-column-in-pandas-python/)

让我们看看如何在 [Pandas DataFrame](https://www.geeksforgeeks.org/python-pandas-dataframe/) 中找到一列的指数。首先，让我们创建一个数据框架：
