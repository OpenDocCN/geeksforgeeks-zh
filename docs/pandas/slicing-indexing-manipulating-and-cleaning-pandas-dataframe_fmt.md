...
> 原文: [https://www.geeksforgeeks.org/slicing-indexing-manipulating-and-cleaning-pandas-dataframe/](https://www.geeksforgeeks.org/slicing-indexing-manipulating-and-cleaning-pandas-dataframe/)

在 Pandas 的帮助下，我们可以对数据集执行许多功能，如切片、索引、操作和清理数据框。

## 案例 1: 使用数据框对熊猫数据框进行切片
...
### 示例 1: 使用 `dataframe.assign()` 将 lambda 函数应用于列
