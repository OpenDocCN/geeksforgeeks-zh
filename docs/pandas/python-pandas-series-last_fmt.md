...
## 参数
- `offset`: 字符串，日期偏移，日期实用程序。相对偏移

## 返回值
`subset`: 与调用者类型相同

## 示例 1
使用 `Series.last()` 函数返回给定系列对象中最近 5 天的条目。
...
**输出:**
![输出](img/5a21306bde93bf2b74eb868cf4bfac07.png)
...
**输出:**
![输出](img/c7e77b95bd07705d670708170aedc1ca.png)
...
**输出:**
![输出](img/74481ea2022fd0c73fc3a6266e861b65.png)
