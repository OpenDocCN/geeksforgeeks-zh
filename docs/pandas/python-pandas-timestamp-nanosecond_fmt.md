...
> 原文: [https://www.geeksforgeeks.org/python-pandas-timestamp-nanosecond/](https://www.geeksforgeeks.org/python-pandas-timestamp-nanosecond/)
...
使用 `Timestamp.nanosecond` 属性在给定的 `Timestamp` 对象中查找纳秒值。
...
使用 `Timestamp.nanosecond` 属性在给定的时间戳对象中查找纳秒值。
