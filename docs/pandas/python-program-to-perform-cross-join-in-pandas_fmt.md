...
> 原文：[https://www.geeksforgeeks.org/python-program-to-perform-cross-join-in-pandas/](https://www.geeksforgeeks.org/python-program-to-perform-cross-join-in-pandas/)
