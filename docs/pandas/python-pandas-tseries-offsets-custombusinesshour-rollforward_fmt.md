...
> 原文: [https://www.geeksforgeeks.org/python-pandas-tseries-offsets-custombusinesshour-rollforward/](https://www.geeksforgeeks.org/python-pandas-tseries-offsets-custombusinesshour-rollforward/)
...
Pandas `tseries.offsets.CustomBusinessHour.rollforward()` 功能用于将提供的日期向前滚动到下一个偏移量，如果不在偏移量上。

**语法:**
`pandas.tseries.offsets.CustomBusinessHour.rollforward(dt)`
...
## 示例 #1
如果提供的日期不在偏移上，使用 `pandas.tseries.offsets.CustomBusinessHour.rollforward()` 功能向前滚动。
