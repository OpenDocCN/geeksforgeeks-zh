...
在本文中，我们的基本任务是打印系列中最频繁出现的值。我们可以使用 [`value_counts()`](https://www.geeksforgeeks.org/python-pandas-series-value_counts/) 方法找到元素出现的次数。通过使用 [`mode()`](https://www.geeksforgeeks.org/python-pandas-series-mode/) 方法可以访问最频繁的元素。
