...
> 原文：[https://www.geeksforgeeks.org/creating-a-pandas-series-from-lists/](https://www.geeksforgeeks.org/creating-a-pandas-series-from-lists/)

`Series` 是一个一维标注数组，能够保存任意数据类型（整数、字符串、浮点数、Python 对象等）。必须记住，与 Python 列表不同，`Series` 总是包含相同类型的数据。
