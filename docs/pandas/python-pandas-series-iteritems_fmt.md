...
> 原文: [https://www.geeksforgeeks.org/python-pandas-series-iteritems/](https://www.geeksforgeeks.org/python-pandas-series-iteritems/)
...
## 示例#1:
使用`Series.iteritems()`函数迭代给定系列对象中的所有元素。
