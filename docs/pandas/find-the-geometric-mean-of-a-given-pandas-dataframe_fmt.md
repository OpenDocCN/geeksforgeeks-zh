...
> 原文：[https://www.geeksforgeeks.org/find-the-geometric-mean-of-a-given-pandas-dataframe/](https://www.geeksforgeeks.org/find-the-geometric-mean-of-a-given-pandas-dataframe/)
...
**步骤 3：** 用 `scipy.stats.gmean()` 找到几何平均值，并将其存储到新列中。
