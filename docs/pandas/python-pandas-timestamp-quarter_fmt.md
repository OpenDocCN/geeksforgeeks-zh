...
> 原文: [https://www.geeksforgeeks.org/python-pandas-timestamp-quarter/](https://www.geeksforgeeks.org/python-pandas-timestamp-quarter/)
...
## 示例 1
使用 `Timestamp.quarter` 属性查找给定时间戳对象的日期位于哪个季度。
