...
> 原文: [https://www.geeksforgeeks.org/python-pandas-timedeltaindex-to_pytimedelta/](https://www.geeksforgeeks.org/python-pandas-timedeltaindex-to_pytimedelta/)
...
使用 `TimedeltaIndex.to_pytimedelta()` 函数将给定的时间增量索引对象转换为一个数组。
...
使用 `TimedeltaIndex.to_pytimedelta()` 函数将给定的时间增量索引对象转换为数组。
