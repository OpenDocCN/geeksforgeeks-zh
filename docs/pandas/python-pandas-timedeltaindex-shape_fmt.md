# Pandas TimedeltaIndex.shape 属性

> 原文：[https://www.geeksforgeeks.org/python-pandas-timedeltaindex-shape/](https://www.geeksforgeeks.org/python-pandas-timedeltaindex-shape/)
...
**语法：** `TimedeltaIndex.shape`

**返回：** 形状

## 示例 1

使用 `TimedeltaIndex.shape` 属性找出给定对象中底层数据的形状。
