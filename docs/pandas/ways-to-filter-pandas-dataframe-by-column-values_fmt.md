...
> 原文: [https://www.geeksforgeeks.org/ways-to-filter-pandas-dataframe-by-column-values/](https://www.geeksforgeeks.org/ways-to-filter-pandas-dataframe-by-column-values/)
...
示例 1: 使用 `[ ]` 从给定数据框中选择 `Percentage` 大于 75 的所有行。
...
示例 2: 使用 `loc[ ]` 从给定数据框中选择 `Percentage` 大于 70 的所有行。
