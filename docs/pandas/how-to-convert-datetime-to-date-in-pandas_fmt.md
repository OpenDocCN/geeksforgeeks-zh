...
> 原文: [https://www.geeksforgeeks.org/how-to-convert-datetime-to-date-in-pandas/](https://www.geeksforgeeks.org/how-to-convert-datetime-to-date-in-pandas/)
...
*   `DateTime` 是数据帧中的日期时间列
*   `dt.date` 用于将日期时间转换为日期
*   `Date` 列是从日期时间中获取日期的新列
