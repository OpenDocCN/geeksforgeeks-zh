...
> 原文: [https://www.geeksforgeeks.org/how-to-sort-grouped-pandas-dataframe-by-group-size/](https://www.geeksforgeeks.org/how-to-sort-grouped-pandas-dataframe-by-group-size/)
...
*   [`groupby()`](https://www.geeksforgeeks.org/python-pandas-dataframe-groupby/)：`groupby()`用于根据列值对数据进行分组。
*   `size()`：这个用来获取数据帧的大小。
*   [`sort_values()`](https://www.geeksforgeeks.org/python-pandas-dataframe-sort_values-set-1/)：此函数按传递列的升序或降序对数据框进行排序。
