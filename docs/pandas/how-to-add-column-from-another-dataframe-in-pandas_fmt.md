...
> 原文: [https://www.geeksforgeeks.org/how-to-add-column-from-another-dataframe-in-pandas/](https://www.geeksforgeeks.org/how-to-add-column-from-another-dataframe-in-pandas/)
...
> **语法:** `insert(位置, "new_name", "extracted_column")`
