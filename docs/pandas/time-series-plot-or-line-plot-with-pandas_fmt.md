...
> 原文: [https://www.geeksforgeeks.org/time-series-plot-or-line-plot-with-pandas/](https://www.geeksforgeeks.org/time-series-plot-or-line-plot-with-pandas/)

**先决条件:** [从列表创建熊猫数据框](https://www.geeksforgeeks.org/create-a-pandas-dataframe-from-lists/)
