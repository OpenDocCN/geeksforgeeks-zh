...
> 原文: [https://www.geeksforgeeks.org/python-pandas-timedeltaindex-to_native_types/](https://www.geeksforgeeks.org/python-pandas-timedeltaindex-to_native_types/)
...
>
> **参数:**
> - `slicer`: 指定格式化过程中使用哪些值的索引器。(int，类似数组)
...
使用 `TimedeltaIndex.to_native_types()` 函数将给定的时间增量索引对象格式化为其本机格式。
