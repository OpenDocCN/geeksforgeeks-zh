...
> 原文: [https://www.geeksforgeeks.org/pandas-built-in-data-visualization-ml/](https://www.geeksforgeeks.org/pandas-built-in-data-visualization-ml/)
...
在调用 `plt.style.use()` 之前，地块看起来是这样的:
