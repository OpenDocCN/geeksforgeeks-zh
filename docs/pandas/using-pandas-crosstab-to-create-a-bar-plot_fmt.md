...
> 原文：[https://www.geeksforgeeks.org/using-pandas-crosstab-to-create-a-bar-plot/](https://www.geeksforgeeks.org/using-pandas-crosstab-to-create-a-bar-plot/)
...
> 语法：`DataFrame.plot(kind="bar", stacked=True, rot=0)`
