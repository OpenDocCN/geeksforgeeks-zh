# Python | Pandas tseries.offsets.BusinessDay.rollforward()

> 原文: [https://www.geeksforgeeks.org/python-pandas-tseries-offsets-businessday-rollforward/](https://www.geeksforgeeks.org/python-pandas-tseries-offsets-businessday-rollforward/)
...
`pandas.tseries.offsets.BusinessDay.rollforward(dt)`
...
如果不在偏移上，使用 `pandas.tseries.offsets.BusinessDay.rollforward()` 功能将提供的日期向前滚动到下一个偏移。
