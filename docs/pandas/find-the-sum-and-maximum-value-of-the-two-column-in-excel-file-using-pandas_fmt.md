# 用Pandas求Excel文件中两列的总和和最大值

> 原文：[https://www.geeksforgeeks.org/find-the-sum-and-maximum-value-of-the-two-column-in-excel-file-using-pandas/](https://www.geeksforgeeks.org/find-the-sum-and-maximum-value-of-the-two-column-in-excel-file-using-pandas/)

在这些文章中，我们将讨论如何从Excel中读取数据并执行一些数学运算，然后将其存储到`DataFrame`中的新列中。假设我们的Excel文件是这样的。
