...
> 原文: [https://www.geeksforgeeks.org/python-pandas-periodindex-year/](https://www.geeksforgeeks.org/python-pandas-periodindex-year/)
...
使用`PeriodIndex.year`属性找出给定周期索引对象中每个元素的周期年份。
