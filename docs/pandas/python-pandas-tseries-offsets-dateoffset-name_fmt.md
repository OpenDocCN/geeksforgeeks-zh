...
> 原文: [https://www.geeksforgeeks.org/python-pandas-tseries-offsets-dateoffset-name/](https://www.geeksforgeeks.org/python-pandas-tseries-offsets-dateoffset-name/)
...
使用 `pandas.tseries.offsets.DateOffset.name` 属性返回应用于给定日期偏移对象的频率名称。
...
使用 `pandas.tseries.offsets.DateOffset.name` 属性返回应用于给定 `DateOffset` 对象的关键字参数。
