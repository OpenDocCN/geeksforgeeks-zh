...
> 原文：[https://www.geeksforgeeks.org/add-a-pandas-series-to-another-pandas-series/](https://www.geeksforgeeks.org/add-a-pandas-series-to-another-pandas-series/)
...
它将一个序列对象追加到另一个序列对象的末尾，并返回追加的序列。
