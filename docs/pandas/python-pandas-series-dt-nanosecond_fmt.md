...
> 原文: [https://www.geeksforgeeks.org/python-pandas-series-dt-nanosecond/](https://www.geeksforgeeks.org/python-pandas-series-dt-nanosecond/)
...
使用`Series.dt.nanosecond`属性返回给定 Series 对象的基础数据中日期时间的纳秒。
