# 如何用 Python 从字典中创建 DataFrame？

> 原文：[https://www.geeksforgeeks.org/how-to-create-dataframe-from-dictionary-in-python-pandas/](https://www.geeksforgeeks.org/how-to-create-dataframe-from-dictionary-in-python-pandas/)

让我们讨论一下如何从 Pandas 的字典中创建 DataFrame。有多种方法可以完成这项任务。

## 方法 1：使用 Pandas 的默认构造函数

使用 Pandas 的默认构造函数从字典中创建 DataFrame，即 `DataFrame` 类。
...
从简单字典创建 DataFrame，即带有关键字和简单值（如整数值或字符串值）的字典。
...
从不同方向的字典中创建 DataFrame，即字典键作为 DataFrame 中的索引。
