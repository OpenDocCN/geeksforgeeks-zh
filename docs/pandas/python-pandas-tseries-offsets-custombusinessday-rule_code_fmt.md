...
> 原文: [https://www.geeksforgeeks.org/python-pandas-tseries-offsets-custombusinessday-rule_code/](https://www.geeksforgeeks.org/python-pandas-tseries-offsets-custombusinessday-rule_code/)
...
> **语法:** `pandas.tseries.offsets.CustomBusinessDay.rule_code`
>
> **参数:** 无
>
> **返回:** 所用频率的规则码
...
使用 `pandas.tseries.offsets.CustomBusinessDay.rule_code` 属性返回应用于给定偏移对象的频率的规则代码。
