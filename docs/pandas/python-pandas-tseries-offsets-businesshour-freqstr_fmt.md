# Python | Pandas tseries.offsets.BusinessHour.freqstr

> 原文: [https://www.geeksforgeeks.org/python-pandas-tseries-offsets-businesshour-freqstr/](https://www.geeksforgeeks.org/python-pandas-tseries-offsets-businesshour-freqstr/)
...
## 示例 #1
使用 `pandas.tseries.offsets.BusinessHour.freqstr` 属性以字符串形式返回应用于给定偏移的频率。
