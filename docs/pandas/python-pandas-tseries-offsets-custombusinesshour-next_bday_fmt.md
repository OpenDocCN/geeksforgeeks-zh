...
> 原文: [https://www.geeksforgeeks.org/python-pandas-tseries-offsets-custombusinesshour-next_bday/](https://www.geeksforgeeks.org/python-pandas-tseries-offsets-custombusinesshour-next_bday/)
...
> **语法:** `pandas.tseries.offsets.CustomBusinessHour.next_bday`
>
> **参数:** 无
>
> **返回:** 移至下一工作日
...
使用 `pandas.tseries.offsets.CustomBusinessHour.next_bday` 属性将给定的时间戳移动到下一个工作日。
