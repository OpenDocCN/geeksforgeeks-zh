...
> 原文: [https://www.geeksforgeeks.org/processing-time-with-pandas-dataframe/](https://www.geeksforgeeks.org/processing-time-with-pandas-dataframe/)
...
使用 `pd.date_range` 创建五个日期和时间，生成固定频率的日期和时间跨度序列。然后我们用 `pandas.Series.dt` 提取特征。
...
# Create 6 dates
dates = pd.Series(date_range('2/5/2019', periods = 6, freq ='M'))
