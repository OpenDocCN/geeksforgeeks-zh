...
> 原文: [https://www.geeksforgeeks.org/python-pandas-periodindex-weekday/](https://www.geeksforgeeks.org/python-pandas-periodindex-weekday/)
...
## 示例 1
使用 `PeriodIndex.weekday` 属性找出给定 PeriodIndex 对象中每个周期元素的星期几。
