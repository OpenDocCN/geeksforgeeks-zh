...
> 原文：[https://www.geeksforgeeks.org/python-pandas-tseries-offsets-businessday-copy/](https://www.geeksforgeeks.org/python-pandas-tseries-offsets-businessday-copy/)
...
Pandas `tseries.offsets.BusinessDay.copy()` 函数返回给定工作日偏移对象的副本。

> **语法：** `pandas.tseries.offsets.BusinessDay.copy()`
> 
> **参数：** 无
> 
> **返回：** 返回副本
