...
## 先决条件
[在熊猫数据框上创建视图|设置–1](https://www.geeksforgeeks.org/creating-views-on-pandas-dataframe/)
...
## 解决方案#1
将 csv 文件中的数据读入 Python 时，我们可以选择所有想要读入 DataFrame 的列。
...
## 解决方案#2
将 csv 文件中的数据读入 Python 时，我们可以列出所有不想读入 DataFrame 的列。就像放下那些柱子。
