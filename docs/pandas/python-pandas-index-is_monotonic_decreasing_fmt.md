...
> 原文: [https://www.geeksforgeeks.org/python-pandas-index-is_monotonic_decreasing/](https://www.geeksforgeeks.org/python-pandas-index-is_monotonic_decreasing/)

## 熊猫索引

熊猫索引是一个实现有序的、可切片的集合的不可变数组。它是存储所有熊猫对象的轴标签的基本对象。

## 熊猫 `Index.is_monotonic_decreasing` 属性
...
使用 `Index.is_monotonic_decreasing` 属性找出给定索引对象中的底层数据是否单调递减。
