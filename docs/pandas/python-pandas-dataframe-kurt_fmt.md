...
> 原文链接: https://www.geeksforgeeks.org/python-pandas-dataframe-kurt/
...
> **语法:** `DataFrame.kurt(axis=None, skipna=None, level=None, numeric_only=None, **kwargs)`
>
> **参数:**
...
>
> **返回:** Kurt: Series 或 DataFrame（如果指定了级别）
...
**示例 #2:** 使用 `kurt()` 函数查找数据帧的峰度，该数据帧中有一些 `NaN` 值。求指数轴上的峰度。
