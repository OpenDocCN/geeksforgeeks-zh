...
> 原文: [https://www.geeksforgeeks.org/how-to-read-all-excel-files-under-a-directory-as-a-pandas-dataframe/](https://www.geeksforgeeks.org/how-to-read-all-excel-files-under-a-directory-as-a-pandas-dataframe/)
...
2.  使用 `glob` python 包来检索与指定模式匹配的文件/路径名，例如 `*.xlsx`。
