# 蟒蛇|熊猫 tseries.offsets.BusinessHour.isAnchored

> 原文: [https://www.geeksforgeeks.org/python-pandas-tseries-offsets-businesshour-isanchored/](https://www.geeksforgeeks.org/python-pandas-tseries-offsets-businesshour-isanchored/)
...
## 示例#1
使用 `pandas.tseries.offsets.BusinessHour.isAnchored()` 功能检查给定的偏移对象是否被锚定。
