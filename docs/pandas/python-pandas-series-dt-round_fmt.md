...
> 原文: [https://www.geeksforgeeks.org/python-pandas-series-dt-round/](https://www.geeksforgeeks.org/python-pandas-series-dt-round/)
...
使用`Series.dt.round()`函数将给定序列对象的日期时间数据舍入到指定的频率。
