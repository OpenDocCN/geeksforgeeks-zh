...
> 原文：[https://www.geeksforgeeks.org/how-to-get-client-ip-address-and-mac-address-in-laravel/](https://www.geeksforgeeks.org/how-to-get-client-ip-address-and-mac-address-in-laravel/)
...
为了获得 IP 地址，我们必须包括 `use Illuminate\Http\Request`，然后在控制器中添加下面预标签的代码。它会给出网络的接入点地址。
