...
> 原文: [https://www.geeksforgeeks.org/tensorflow-js-tf-initializers-identity-function/](https://www.geeksforgeeks.org/tensorflow-js-tf-initializers-identity-function/)
...
**示例 2:** 在本例中，我们将使用 `identity()` 和 `dense()` 函数使用具有密集层的恒等式矩阵。
...
**参考:** [https://js.tensorflow.org/api/3.6.0/#initializers.identity](https://js.tensorflow.org/api/3.6.0/#initializers.identity)