...
> 原文：[https://www.geeksforgeeks.org/tensorflow-js-tf-data-generator-function/](https://www.geeksforgeeks.org/tensorflow-js-tf-data-generator-function/)
...
*   `generator`：是一个 JavaScript 生成器函数，返回一个 JavaScript 迭代器。
...
[https://js.tensorflow.org/api/3.6.0/#data.generator](https://js.tensorflow.org/api/3.6.0/#data.generator)