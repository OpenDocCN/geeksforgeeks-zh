...
> 原文: [https://www.geeksforgeeks.org/tensorflow-js-tf-spectral-fft-function/](https://www.geeksforgeeks.org/tensorflow-js-tf-spectral-fft-function/)

`TensorFlow.js`是谷歌开发的开源库，用于在浏览器或节点环境下运行机器学习模型和深度学习神经网络。

`tf.spectral.fft()`函数用于`FFT`（快速傅立叶变换），即它在输入的最内部维度上计算指定的一维`DFT`（离散傅立叶变换）。
...
**参考:** [https://js.tensorflow.org/api/latest/#spectral.fft](https://js.tensorflow.org/api/latest/#spectral.fft)