# TensorFlow.js tf.customGrad()函数

> 原文: [https://www.geeksforgeeks.org/tensorflow-js-tf-customgrad-function/](https://www.geeksforgeeks.org/tensorflow-js-tf-customgrad-function/)
