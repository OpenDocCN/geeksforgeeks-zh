...
> 原文: [https://www.geeksforgeeks.org/tensorflow-js-tf-layers-add-function/](https://www.geeksforgeeks.org/tensorflow-js-tf-layers-add-function/)
...
*   **数据类型:** 可选参数，代表数据类型。默认情况下，它有“float32”，还支持其他值如“int32”、“bool”等。
...
[https://js.tensorflow.org/api/latest/#layers.add](https://js.tensorflow.org/api/latest/#layers.add)