# Tensorflow.js tf.data.microphone()功能

> 原文: [https://www.geeksforgeeks.org/tensorflow-js-tf-data-microphone-function/](https://www.geeksforgeeks.org/tensorflow-js-tf-data-microphone-function/)

`Tensorflow.js` 是谷歌开发的开源库，用于在浏览器或节点环境下运行机器学习模型和深度学习神经网络。

`tf.data.microphone()` 函数用于产生一个迭代器，该迭代器使用浏览器的本机 FFT 从麦克风音频流创建频域频谱图张量。
...
运行下面的代码后，会请求允许启动麦克风。给予许可后，下面的代码将返回并给出输出。
...
**参考:** [https://js.tensorflow.org/api/latest/#data.microphone](https://js.tensorflow.org/api/latest/#data.microphone)