...
> 原文: [https://www.geeksforgeeks.org/tensorflow-js-tf-max-function/](https://www.geeksforgeeks.org/tensorflow-js-tf-max-function/)
...
**参考:** [https://js.tensorflow.org/api/latest/#max](https://js.tensorflow.org/api/latest/#max)