...
> 原文: [https://www.geeksforgeeks.org/tensorflow-js-tf-logsumexp-function/](https://www.geeksforgeeks.org/tensorflow-js-tf-logsumexp-function/)
...
*   `x`: 输入张量。
*   `axis`: 要减少的指定尺寸。默认情况下，它会缩小所有尺寸。它是可选参数。
*   `keepDims`: 如果该参数值为真，它将保留长度为 1 的缩减尺寸，否则张量的秩将缩减 1。它也是可选参数。
...
**参考:** [https://js.tensorflow.org/api/latest/#logSumExp](https://js.tensorflow.org/api/latest/#logSumExp)