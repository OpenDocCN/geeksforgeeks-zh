...
> 原文: [https://www.geeksforgeeks.org/tensorflow-js-tf-constraints-maxnorm-function/](https://www.geeksforgeeks.org/tensorflow-js-tf-constraints-maxnorm-function/)
...
`参考:` [https://js.tensorflow.org/api/latest/#class:constraints.Constraint](https://js.tensorflow.org/api/latest/#class:constraints.Constraint)