...
> 原文：`https://www.geeksforgeeks.org/tensorflow-js-tf-data-dataset-map-function/`
...
*   `transform`：将数据集元素映射到变换后的数据集元素的函数。
...
**参考：** `https://js.tensorflow.org/api/latest/#tf.data.Dataset.map`