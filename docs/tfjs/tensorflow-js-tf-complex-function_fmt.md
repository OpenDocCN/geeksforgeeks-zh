...
> 原文: [https://www.geeksforgeeks.org/tensorflow-js-tf-complex-function/](https://www.geeksforgeeks.org/tensorflow-js-tf-complex-function/)
...
实参数为 `tf.Tensor` 代表复数的实部，`imag` 参数是 `tf.Tensor` 表示复数的虚部。
例如，
...
**参考:** [https://js.tensorflow.org/api/latest/#complex](https://js.tensorflow.org/api/latest/#complex)