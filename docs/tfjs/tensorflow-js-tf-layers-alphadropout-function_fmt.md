...
> 原文: [https://www.geeksforgeeks.org/tensorflow-js-tf-layers-alphadropout-function/](https://www.geeksforgeeks.org/tensorflow-js-tf-layers-alphadropout-function/)
...
const alphaDropout = tf.layers.alphaDropout({poolSize:[2,2]});
...
**参考:** [https://js.tensorflow.org/api/3.6.0/#layers.alphaDropout](https://js.tensorflow.org/api/3.6.0/#layers.alphaDropout)