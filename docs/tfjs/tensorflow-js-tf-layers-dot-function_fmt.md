...
> 原文: [https://www.geeksforgeeks.org/tensorflow-js-tf-layers-dot-function/](https://www.geeksforgeeks.org/tensorflow-js-tf-layers-dot-function/)
...
*   `Parameter`: It is an object with the following fields:
    ...
    *   `batchInputShape`: Define the shape of the batch for the samples in the input layer. It is used to make the input layer.
    ...
    *   `input type`: is the data type of the input data in the layer.
...
**参考:** [https://js.tensorflow.org/api/latest/#layers.dot](https://js.tensorflow.org/api/latest/#layers.dot)