# TensorFlow.js TF.metrics.binaryCrossentropy() 函数

> 原文: [https://www.geeksforgeeks.org/tensorflow-js-tf-metrics-binarycrossentropy-function/](https://www.geeksforgeeks.org/tensorflow-js-tf-metrics-binarycrossentropy-function/)

TensorFlow.js 是谷歌开发的开源库，用于在浏览器或节点环境中运行机器学习模型以及深度学习神经网络。

`tf.metrics.binaryCrossentropy()` 函数是使用二进制张量并返回 tf.Tensor 对象的二进制交叉熵度量函数。
