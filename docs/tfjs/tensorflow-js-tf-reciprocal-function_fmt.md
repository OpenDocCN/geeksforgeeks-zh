# TensorFlow.js `tf.reciprocal()` 函数

> 原文: [https://www.geeksforgeeks.org/tensorflow-js-tf-reciprocal-function/](https://www.geeksforgeeks.org/tensorflow-js-tf-reciprocal-function/)

**TensorFlow.js** 是谷歌开发的开源库，用于在浏览器或节点环境下运行机器学习模型和深度学习神经网络。

`tf.reciprocal()` 函数用于返回指定张量元素的倒数。
