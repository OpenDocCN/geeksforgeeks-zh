# TensorFlow.js TF.lessEqual() 函数

> 哎哎哎:# t0]https://www . geeksforgeeks . org/tensorlow-js-TF-lesequal-function/

`TensorFlow.js` 是谷歌开发的开源库，用于在浏览器或节点环境下运行机器学习模型和深度学习神经网络。

`TF.lessEqual()` 函数用于返回两个指定张量值的布尔值张量，即如果第一个张量值小于或等于第二个张量值，则返回真，否则返回假。它支持广播。
...
它返回布尔值的张量，即如果第一个张量的值小于或等于第二个张量的值，则返回 `true`，否则返回 `false`。
