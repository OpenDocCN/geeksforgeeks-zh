...
## tf.layers.masking()函数

> 原文: [https://www.geeksforgeeks.org/tensorflow-js-tf-layers-masking-function/](https://www.geeksforgeeks.org/tensorflow-js-tf-layers-masking-function/)
...
*   **batchSize:** 是一个可选参数，用于制作 `batchInputShape`，它只接受数字。
*   **dtype:** 为可选参数，代表数据类型。默认情况下，它有“float32”，还支持其他值如“int32”、“bool”等。
...
**参考:** [https://js.tensorflow.org/api/3.6.0/#layers.masking](https://js.tensorflow.org/api/3.6.0/#layers.masking)