...
> 原文: [https://www.geeksforgeeks.org/tensorflow-js-tf-tensorbuffer-class-get-method/](https://www.geeksforgeeks.org/tensorflow-js-tf-tensorbuffer-class-get-method/)

TensorFlow.js 是谷歌开发的开源库，用于在浏览器或节点环境下运行机器学习模型和深度学习神经网络。

`tf.TensorBuffer` 类的 `get()` 方法用于返回给定位置的指定缓冲区中的值。
...
参考: [https://js.tensorflow.org/api/latest/#tf.TensorBuffer.get](https://js.tensorflow.org/api/latest/#tf.TensorBuffer.get)