...
> 原文：[`https://www.geeksforgeeks.org/tensorflow-js-tf-metrics-categoricalcrossentropy-function/`](https://www.geeksforgeeks.org/tensorflow-js-tf-metrics-categoricalcrossentropy-function/)
...
## 参考：
[`https://js.tensorflow.org/api/3.6.0/#metrics.categoricalCrossentropy`](https://js.tensorflow.org/api/3.6.0/#metrics.categoricalCrossentropy)