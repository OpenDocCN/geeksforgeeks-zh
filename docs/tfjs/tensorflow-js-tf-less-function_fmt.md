...
> 原文：[`https://www.geeksforgeeks.org/tensorflow-js-tf-less-function/`](https://www.geeksforgeeks.org/tensorflow-js-tf-less-function/)
...
**参考：** [`https://js.tensorflow.org/api/latest/#less`](https://js.tensorflow.org/api/latest/#less)