...
> 原文：`https://www.geeksforgeeks.org/tensorflow-js-tf-keep-function/`

Tensorflow.js 是一个开源库，由谷歌开发，用于在浏览器或节点环境中运行机器学习模型以及深度学习神经网络。

`keep()`函数用于保持`tf.tidy()`方法中形成的张量输入不被自发丢弃。
...
`https://js.tensorflow.org/api/latest/#keep`