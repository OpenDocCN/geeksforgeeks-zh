...
> 原文: [https://www.geeksforgeeks.org/tensorflow-js-tf-metrics-precision-function/](https://www.geeksforgeeks.org/tensorflow-js-tf-metrics-precision-function/)

TensorFlow.js 是谷歌开发的开源库，用于在浏览器或节点环境中运行机器学习模型以及深度学习神经网络。

`tf.metrics.precision()` 函数用于参照名称计算期望的精度。
...
**参考:** [https://js.tensorflow.org/api/latest/#metrics.precision](https://js.tensorflow.org/api/latest/#metrics.precision)