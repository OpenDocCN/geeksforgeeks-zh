...
> 原文：[https://www.geeksforgeeks.org/tensorflow-js-tf-linalg-bandpart-function/](https://www.geeksforgeeks.org/tensorflow-js-tf-linalg-bandpart-function/)
...
*   `numUpper`: 要保留的子对角线数量。如果为负，保留整个上三角形。
...
**参考：** [https://js.tensorflow.org/api/latest/#linalg.bandPart](https://js.tensorflow.org/api/latest/#linalg.bandPart)