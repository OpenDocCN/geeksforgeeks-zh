...
> 哎哎哎:# t0]https://www.geeksforgeeks.org/tensorflow-js-tf-spaceToBatchND-function/
...
*   `blockShape`: 必须是形状为[M]的一维数组，因为所有值都必须大于或等于 1。
*   `paddings`: 形状为[M，2]的二维数组，所有值必须大于或等于 0。这里填充等于[padStart，padEnd]。
...
https://js.tensorflow.org/api/latest/#spaceToBatchND