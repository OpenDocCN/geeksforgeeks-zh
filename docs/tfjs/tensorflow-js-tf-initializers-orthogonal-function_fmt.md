# TensorFlow.js TF.initializer.orthogonal()函数

> 原文: [https://www.geeksforgeeks.org/tensorflow-js-tf-initializers-orthogonal-function/](https://www.geeksforgeeks.org/tensorflow-js-tf-initializers-orthogonal-function/)
...
*   `arguments`: 它是一个包含种子（一个数）和增益（一个数）的对象，种子（一个数）是随机数生成器种子，增益（一个数）是要应用于正交矩阵的乘法因子。它的默认值被认为是 1。
...
**参考:** [https://js.tensorflow.org/api/3.6.0/#initializers.orthogonal](https://js.tensorflow.org/api/3.6.0/#initializers.orthogonal)