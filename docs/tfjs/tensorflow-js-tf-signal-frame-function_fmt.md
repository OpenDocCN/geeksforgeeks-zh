...
> 原文: [https://www.geeksforgeeks.org/tensorflow-js-TF-signal-frame-function/](https://www.geeksforgeeks.org/tensorflow-js-tf-signal-frame-function/)
...
```
tf.signal.frame(signal, frameLength, frameStep, padEnd?, padValue?)
```
...
[https://js.tensorflow.org/api/latest/#signal.frame](https://js.tensorflow.org/api/latest/#signal.frame)