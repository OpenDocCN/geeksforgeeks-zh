...
> 原文: [https://www.geeksforgeeks.org/tensorflow-js-tf-equal-function/](https://www.geeksforgeeks.org/tensorflow-js-tf-equal-function/)
...
它返回布尔值的张量，即如果第一个张量的值等于第二个张量的值，则返回 `true`，否则返回 `false`。
...
**参考:** [https://js.tensorflow.org/api/latest/#equal](https://js.tensorflow.org/api/latest/#equal)