...
> 原文: [https://www.geeksforgeeks.org/tensorflow-js-tf-step-function/](https://www.geeksforgeeks.org/tensorflow-js-tf-step-function/)

`Tensorflow.js` 是谷歌开发的开源库，用于在浏览器或节点环境下运行机器学习模型和深度学习神经网络。

`tf.step()` 函数用于返回输入张量元素的步长，即如果元素大于 0 则返回 1，否则返回`alpha`，其中`alpha`是函数`step()`的参数。
