# TensorFlow.js `tf.greaterEqual()` 函数

> 原文: [https://www.geeksforgeeks.org/tensorflow-js-tf-greaterequal-function/](https://www.geeksforgeeks.org/tensorflow-js-tf-greaterequal-function/)
...
它返回布尔值的张量，即如果第一个张量的值大于或等于第二个张量的值，则返回 `true`，否则返回 `false`。
...
**参考:** [https://js.tensorflow.org/api/latest/#greaterEqual](https://js.tensorflow.org/api/latest/#greaterEqual)