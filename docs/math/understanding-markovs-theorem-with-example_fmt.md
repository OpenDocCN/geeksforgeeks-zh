...
> 原文：[https://www.geeksforgeeks.org/understanding-markovs-theorem-with-example/](https://www.geeksforgeeks.org/understanding-markovs-theorem-with-example/)
...
假设在一个 100 分的班级测试中，学生的平均分数是 75 分。那么随机从班上选出来的学生小于或等于 50 分的概率是多少。
