...
> 原文: [https://www.geeksforgeeks.org/similarities-and-difference-between-java-and-c/](https://www.geeksforgeeks.org/similarities-and-difference-between-java-and-c/)
...
| Dynamic binding | no | be |
| Operator overload | be | no |
| Template class | be | no |
| Interference and packet | no | be |
| 应用程序接口 | no | be |

3.  **应用:** c++ 和 Java 都有广阔的应用领域。以下是两种语言的应用:
    *   **c++ 编程语言的应用:**
        1.  适合开发大型软件(如乘客预订系统)。
        2.  MySQL 是用 C++ 编写的。
        3.  为了快速执行，C++ 主要用于游戏开发。
...
4.  **环境:** C++ 是平台相关的，而 [Java 是平台无关的编程语言](https://www.geeksforgeeks.org/java-platform-independent/)。我们必须在同一个平台上编写和运行 C++ 代码。Java 有 **WORA(写一次，到处跑)**特性，通过这个特性，我们可以在一个平台上写一次代码，我们可以在任何地方运行代码。
...
| Suffer from: | Java has been influenced by Ada 83, Pascal, C++, [C #](https://www.geeksforgeeks.org/csharp-programming-language/) and other languages. | C++ was influenced by Ada, Algol, BASIC, CLU, and C. |
| Affected by: | Java language has influenced development of BeanShell, C#, Clojure, Groovy, Hack, J#, Kotlin, PHP, Python, Scala etc. languages. | C++ has influenced development of C#, Java, JS++, Moon, Perl, PHP, Python, Rust, Seed 7 and many other languages. |
