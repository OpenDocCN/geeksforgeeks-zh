...
> 原文：[https://www.geeksforgeeks.org/quickly-swap-two-arrays-size-c/](https://www.geeksforgeeks.org/quickly-swap-two-arrays-size-c/)
...
一个快速的解决方案是使用 `std::swap()`。如果数组大小相同，它可以直接交换数组。
