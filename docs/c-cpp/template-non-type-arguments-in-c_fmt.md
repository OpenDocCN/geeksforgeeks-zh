...
> 原文: [https://www.geeksforgeeks.org/template-non-type-arguments-in-c/](https://www.geeksforgeeks.org/template-non-type-arguments-in-c/)
...
在上面的例子中，模板提供了[数组](https://www.geeksforgeeks.org/introduction-to-arrays/)的大小作为参数。这意味着编译器在[编译时](https://www.geeksforgeeks.org/runtime-and-compile-time-constants-in-c/)本身就知道[数组](https://www.geeksforgeeks.org/array-data-structure/)的 `size`。每当创建模板类时，都必须指定参数。
