...
> 原文：[https://www.geeksforgeeks.org/creating-a-cpp-reusable-header-file-and-its-implementation-files/](https://www.geeksforgeeks.org/creating-a-cpp-reusable-header-file-and-its-implementation-files/)
...
**示例：** 这里实现了 `complexNum` 类。它被分成两个文件。头文件扩展名为 `.h`，包含类定义。
...
头文件已经被程序员使用，非常有用，在实现各种数据结构和算法时变得很方便。例如[动态数组](https://www.geeksforgeeks.org/how-do-dynamic-arrays-work/)可以使用 `<vector>` 头文件实现。
