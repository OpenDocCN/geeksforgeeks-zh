...
> 原文: [https://www.geeksforgeeks.org/difference-between-identifiers-and-variables-in-c/](https://www.geeksforgeeks.org/difference-between-identifiers-and-variables-in-c/)
...
| **示例：**<br>`enum geeks_articles_in {`<br>`    Jan=1, Feb, Mar, Apr, May, Jun, Jul`<br>`}`<br>`int geeks_f_geeks(int gfg_id){/*... 代码 ... */ }` | **示例：**<br>`short int geeks_id{}, int a{}, long float b{}, unsigned int c{}, char ch` 等 |