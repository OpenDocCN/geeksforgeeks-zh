...
> 原文：[https://www.geeksforgeeks.org/basic_istreamunget-in-c-with-examples/](https://www.geeksforgeeks.org/basic_istreamunget-in-c-with-examples/)
...
**参数：**
`basic_istream::unget()` 方法不接受任何参数。

**返回值：**
函数 `basic_istream::unget()` 返回 `basic_istream` 对象。

下面是程序说明 `std::basic_istream::unget()`：
