...
> 原文: [https://www.geeksforgeeks.org/conditional-or-ternary-operator-in-c-c/](https://www.geeksforgeeks.org/conditional-or-ternary-operator-in-c-c/)
...
自条件运算符`?:`需要三个操作数才能工作，因此它们也被称为三元运算符。

### 工作:
这里`Expression1`是需要评估的条件。如果条件(`Expression1`)为真，则执行`Expression2`，并返回结果。否则，如果条件(`Expression1`)为假，则执行`Expression3`，并返回结果。
