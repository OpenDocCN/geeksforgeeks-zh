...
## 先决条件
[多线程](https://www.geeksforgeeks.org/multithreading-c-2/)、 [`pthread_self()`在 C 用例](https://www.geeksforgeeks.org/pthread_self-c-example/)
...
如果你使用 Linux，那么编译这个程序`gcc program_name.c -lpthread`
