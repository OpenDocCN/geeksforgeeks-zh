...
> 原文: [https://www.geeksforgeeks.org/gcvt-convert-float-value-string-c/](https://www.geeksforgeeks.org/gcvt-convert-float-value-string-c/)
...
以下程序显示了当除法结果存储在浮点类型（结果精度可达小数点后六位）时与直接存储在字符串类型时的输出差异。
