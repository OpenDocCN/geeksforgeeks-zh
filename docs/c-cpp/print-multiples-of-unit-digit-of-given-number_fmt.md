...
> 原文: [https://www.geeksforgeeks.org/print-multiples-of-unit-digit-of-given-number/](https://www.geeksforgeeks.org/print-multiples-of-unit-digit-of-given-number/)

给定一个数字 `N`。任务是打印 `N` 单位位数从 `N` 到 `N` 的倍数。
