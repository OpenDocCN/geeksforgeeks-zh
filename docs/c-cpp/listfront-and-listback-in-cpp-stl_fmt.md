...
> 原文:`https://www.geeksforgeeks.org/listfront-and-listback-in-cpp-stl/`
...
1.  使用[`push_front()`或`push_back()`功能](https://www.geeksforgeeks.org/listpush_front-listpush_back-c-stl/)向列表中添加号码。
2.  比较第一个和最后一个元素。
