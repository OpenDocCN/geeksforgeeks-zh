...
> 原文: [https://www.geeksforgeeks.org/how-to-return-multiple-values-from-a-function-in-c-or-cpp/](https://www.geeksforgeeks.org/how-to-return-multiple-values-from-a-function-in-c-or-cpp/)
...
考虑一个例子，其中的任务是找到两个不同数字中较大和较小的那个。我们可以编写多个函数。主要的问题是调用多个函数的麻烦，因为我们需要返回多个值，当然，需要键入更多的代码行。

#### 1. Return multiple values with pointers:

Pass parameters with addresses and use pointers to change their values. These values become the original parameters.
