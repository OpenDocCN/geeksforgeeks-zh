...
> 原文: [https://www.geeksforgeeks.org/program-print-upto-100-without-using-loops/](https://www.geeksforgeeks.org/program-print-upto-100-without-using-loops/)

如果我们仔细看一下这个问题，我们可以看到“循环”的思想是跟踪某个计数器值，例如 `i=0` 直到 `i <= 100`。所以如果我们不被允许使用循环，在C语言中我们还能如何跟踪某些东西呢！
