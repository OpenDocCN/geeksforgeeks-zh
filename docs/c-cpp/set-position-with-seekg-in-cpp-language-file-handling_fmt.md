...
> 原文：[https://www.geeksforgeeks.org/set-position-with-seekg-in-cpp-language-file-handling/](https://www.geeksforgeeks.org/set-position-with-seekg-in-cpp-language-file-handling/)
...
2.  `istream& seekg(streamoff 偏移量，ios_base::seekdir dir);`
