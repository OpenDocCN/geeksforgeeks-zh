...
> 原文：[https://www.geeksforgeeks.org/sort-an-array-according-to-absolute-difference-with-given-value-using-functors/](https://www.geeksforgeeks.org/sort-an-array-according-to-absolute-difference-with-given-value-using-functors/)
...
解决方案基于[函子](https://www.geeksforgeeks.org/functors-in-cpp/)。将给定数字 `k` 之差的绝对值与数组值 `arr[i]` 进行比较，如果第一个对象的值小于第二个对象的值，则返回 `true`。使用 [`stable_sort`](https://www.geeksforgeeks.org/stable_sort-c-stl/) 保留等值顺序。
