# c++ STL 中的 forward_list::remove() 和 forward_list::remove_if()

> 原文：`https://www.geeksforgeeks.org/forward_listremove-forward_listremove_if-c-stl/`
