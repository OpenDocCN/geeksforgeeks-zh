...
> 原文：[https://www.geeksforgeeks.org/opencv-c-program-for-coin-detection/](https://www.geeksforgeeks.org/opencv-c-program-for-coin-detection/)
...
4.  运行命令：`./coin`
5.  包含硬币的图像必须与代码在同一目录中。在运行代码之前，请确保您的系统上安装了 OpenCV。
