...
**返回值:**
`basic_istream::operator>>` 返回 `basic_istream` 对象。

下面是说明 `std::basic _ is tream::operator>>` 的程序：
...
**参考:**
[http://www.cplusplus.com/reference/istream/basic_istream/operator%3E%3E/](http://www.cplusplus.com/reference/istream/basic_istream/operator%3E%3E/)