...
> 原文: [https://www.geeksforgeeks.org/c-program-for-lower-case-to-uppercase-and-vice-versa-in-a-file/](https://www.geeksforgeeks.org/c-program-for-lower-case-to-uppercase-and-vice-versa-in-a-file/)
...
如果找到了文件，那么在 `while` 循环的帮助下，使用[将该文件的所有字符转换成大写。](https://www.geeksforgeeks.org/conversion-whole-string-uppercase-lowercase-using-stl-c/) 通过传递文件指针，使用 `fclose()` 函数关闭文件。
