...
> 原文：[https://www.geeksforgeeks.org/program-print-hollow-pyramid-diamond-pattern/](https://www.geeksforgeeks.org/program-print-hollow-pyramid-diamond-pattern/)

## 先决条件
[循环](https://www.geeksforgeeks.org/c-language-2-gq/loops-control-structure-gq/)，[If Else 语句](https://www.geeksforgeeks.org/decision-making-c-c-else-nested-else/)

### 1. 空心金字塔/三角形图案
图案与金字塔图案相似。唯一的区别是，我们将用空格字符替换所有内部的`#`字符，并且我们将在最后一行中使用`2*N-1`（`N` =模式中的行数）个`#`字符。
