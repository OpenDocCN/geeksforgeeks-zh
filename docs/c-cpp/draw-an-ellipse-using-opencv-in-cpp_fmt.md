...
> 原文: [https://www.geeksforgeeks.org/draw-an-ellipse-using-opencv-in-cpp/](https://www.geeksforgeeks.org/draw-an-ellipse-using-opencv-in-cpp/)

在本文中，任务是使用 [C++](https://www.geeksforgeeks.org/c-plus-plus/) 中的 [OpenCV](https://www.geeksforgeeks.org/introduction-to-opencv/) 绘制一个椭圆。将使用 OpenCV C++ 库中的 [`ellipse()`](https://www.geeksforgeeks.org/draw-ellipse-c-graphics/) 函数。

**语法:**

> `ellipse(图像, 中心坐标, 轴长度, 角度, 开始角度, 结束角度, 颜色, 厚度, 线型, 偏移)`
...
**说明:** 在上述程序中，以 `0` 度的角度画出一个椭圆，即水平椭圆。
