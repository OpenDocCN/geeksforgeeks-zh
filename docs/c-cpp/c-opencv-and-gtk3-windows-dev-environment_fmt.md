...
> 原文:[https://www.geeksforgeeks.org/c-opencv-and-gtk3-windows-dev-environment/](https://www.geeksforgeeks.org/c-opencv-and-gtk3-windows-dev-environment/)
...
获得 `pacman` 和 `MinGW` 最简单的方法是通过一个名为 `MSYS2` 的开源项目。转到 [MSYS2 首页](http://www.msys2.org/)下载最符合你系统的 `MSYS2` 安装程序(可能是 64 位，因为 i686 实际上是 32 位)。
