...
> 原文：[`https://www.geeksforgeeks.org/c-program-copy-string-without-using-strcpy-function/`](https://www.geeksforgeeks.org/c-program-copy-string-without-using-strcpy-function/)
...
## 方法
这里我们输入一个字符串，然后借助循环将第一个数组的内容转移到第二个数组。

## 错误
如果目标字符串长度小于源字符串，整个字符串值不会被复制到目标字符串中。
