...
> 原文: [https://www.geeksforgeeks.org/arg-function-for-complex-number-in-c/](https://www.geeksforgeeks.org/arg-function-for-complex-number-in-c/)

复数的 `arg()` 函数在 `<complex>` 头文件中定义。这个函数用来返回复数 `z` 的参数。
