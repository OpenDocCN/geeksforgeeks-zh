# 当 N 除以 [1, N] 范围内的所有数字时，不同余数的计数

> 原文: [https://www.geeksforgeeks.org/count-of-distinct-remainders-when-n-is-divided-by-all-the-numbers-from-the-range-1-n/](https://www.geeksforgeeks.org/count-of-distinct-remainders-when-n-is-divided-by-all-the-numbers-from-the-range-1-n/)
