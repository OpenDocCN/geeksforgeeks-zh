...
> 原文：[https://www.geeksforgeeks.org/polar-function-for-complex-number-in-cpp/](https://www.geeksforgeeks.org/polar-function-for-complex-number-in-cpp/)

复数的 `polar()` 函数在 `<complex>` 头文件中定义。`polar` 函数用于从相角和幅值中求复数。
