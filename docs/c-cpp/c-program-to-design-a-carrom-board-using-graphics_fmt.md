...
> 原文：[https://www.geeksforgeeks.org/c-program-to-design-a-carrom-board-using-graphics/](https://www.geeksforgeeks.org/c-program-to-design-a-carrom-board-using-graphics/)

在本文中，我们将讨论如何使用[图形](https://www.geeksforgeeks.org/basic-graphic-programming-in-c/)绘制**卡罗姆板**。

**进场:**

*   使用 [`rectangle()`](https://www.geeksforgeeks.org/draw-rectangle-c-graphics/) 功能创建板的轮廓。
*   使用 `rectangle()` 功能在大矩形内创建另一个小矩形。
