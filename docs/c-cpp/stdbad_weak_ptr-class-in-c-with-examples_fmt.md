...
> 原文: [https://www.geeksforgeeks.org/stdbad_weak_ptr-class-in-c-with-examples/](https://www.geeksforgeeks.org/stdbad_weak_ptr-class-in-c-with-examples/)
...
int main()
{
    ...
    // try block
    try {
        shared_ptr<int> A_Computer_Science_portal_for_Geeks(wp);
    }
...
**参考:** [www.cplusplus.com/reference/memory/bad_weak_ptr/](https://www.cplusplus.com/reference/memory/bad_weak_ptr/)