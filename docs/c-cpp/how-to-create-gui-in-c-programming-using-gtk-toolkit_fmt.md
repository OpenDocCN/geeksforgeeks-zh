...
> 原文:[https://www.geeksforgeeks.org/how-to-create-gui-in-c-programming-using-gtk-toolkit/](https://www.geeksforgeeks.org/how-to-create-gui-in-c-programming-using-gtk-toolkit/)
...
*   窗口类型值 `GTK_WINDOW_TOPLEVEL` 意味着制作的窗口将是一个标准的框架窗口。其他排序值可能是 `GTK_WINDOW_POPUP`，这意味着将创建一个无框架的对话窗口。
