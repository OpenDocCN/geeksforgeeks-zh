...
> 原文: [https://www.geeksforgeeks.org/virtual-destruction-using-shared_ptr/](https://www.geeksforgeeks.org/virtual-destruction-using-shared_ptr/)

**先决条件:** [`shared_ptr`](https://www.geeksforgeeks.org/auto_ptr-unique_ptr-shared_ptr-weak_ptr-2/) [虚拟析构器](https://www.geeksforgeeks.org/virtual-destructor/)
