...
> 原文：[`https://www.geeksforgeeks.org/basic_istreamputback-in-c-with-examples/`](https://www.geeksforgeeks.org/basic_istreamputback-in-c-with-examples/)
...
`iostream::basic_istream::putback()` 返回 `basic_istream` 对象。

以下是以更好的方式理解 `std::basic_istream::putback()` 实现的程序：
...
[`http://www.cplusplus.com/reference/istream/istream/putback/`](http://www.cplusplus.com/reference/istream/istream/putback/)