...
> 原文: [https://www.geeksforgeks.org/define-vs-undef-in-c-language/](https://www.geeksforgeeks.org/define-vs-undef-in-c-language/)

在本文中，我们将讨论 [C 语言](https://www.geeksforgeeks.org/c-language-set-1-introduction/)中 `#define` 和 `#undef` 预处理器的区别。
...
在本例中，当使用 `#undef` 时，将删除 `#define` 命令，宏将变得未定义，编译器将显示错误。