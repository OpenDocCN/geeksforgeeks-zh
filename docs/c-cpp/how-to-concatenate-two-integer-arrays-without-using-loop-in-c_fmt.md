...
> 原文：[https://www.geeksforgeeks.org/how-to-concatenate-two-integer-arrays-without-using-loop-in-c/](https://www.geeksforgeeks.org/how-to-concatenate-two-integer-arrays-without-using-loop-in-c/)
...
想法是在 C 中使用 [`memcpy()`](http://geeksquiz.com/memcpy-in-cc/) 或 [`memmove()`](http://geeksquiz.com/memmove-in-cc/)。
