...
> 原文：[https://www.geeksforgeeks.org/how-to-convert-a-single-character-to-string-in-cpp/](https://www.geeksforgeeks.org/how-to-convert-a-single-character-to-string-in-cpp/)
...
想法是使用[字符串类](https://www.geeksforgeeks.org/c-string-class-and-its-applications/)，它有一个构造函数，允许我们指定字符串的大小作为第一个参数，指定大小的字符作为第二个参数。
