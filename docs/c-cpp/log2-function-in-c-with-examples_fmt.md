...
> 原文: [https://www.geeksforgeeks.org/log2-function-in-c-with-examples/](https://www.geeksforgeeks.org/log2-function-in-c-with-examples/)
...
该函数取一个值 `x`，在 **[0, ∞]** 的范围内，要找到其对数值。

## 返回类型:

根据以下条件，以双精度、浮点或长双精度类型返回对数值:
...
**参考:** [http://www.cplusplus.com/reference/cmath/log2/](http://www.cplusplus.com/reference/cmath/log2/)