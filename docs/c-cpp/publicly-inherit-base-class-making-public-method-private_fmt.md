...
> 原文：[https://www.geeksforgeeks.org/publicly-inherit-base-class-making-public-method-private/](https://www.geeksforgeeks.org/publicly-inherit-base-class-making-public-method-private/)
...
我们使用`using`语法在派生类范围内重新声明基类函数。我们在派生类的私有部分中完成。
