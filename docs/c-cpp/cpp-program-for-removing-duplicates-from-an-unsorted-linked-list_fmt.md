...
> 原文：[https://www.geeksforgeeks.org/cpp-program-for-removing-duplicates-from-an-unsorted-linked-list/](https://www.geeksforgeeks.org/cpp-program-for-removing-duplicates-from-an-unsorted-linked-list/)
...
2. 使用[算法在线性时间内移除重复项，以移除排序链表中的重复项](https://www.geeksforgeeks.org/remove-duplicates-from-a-sorted-linked-list/)。`O(n)`
请注意，这种方法没有保留元素的原始顺序。
**时间复杂度：** `O(nLogn)`
...
更多详细信息，请参考完整文章[从未排序的链表中删除重复项](https://www.geeksforgeeks.org/remove-duplicates-from-an-unsorted-linked-list/)！