...
> 原文：[https://www.geeksforgeeks.org/c-program-to-create-indian-national-flag-using-graphics/](https://www.geeksforgeeks.org/c-program-to-create-indian-national-flag-using-graphics/)

在本文中，我们将讨论如何使用[图形](https://www.geeksforgeeks.org/basic-graphic-programming-in-c/)绘制**印度国旗**。

**方法：**

*   使用 [`rectangle()`](https://www.geeksforgeeks.org/draw-rectangle-c-graphics/) 函数绘制一个矩形。
...
*   阿育王脉轮将使用函数 [`circle()`](https://www.geeksforgeeks.org/draw-circle-c-graphics/) 制成。
*   最后，将使用函数 [`setfillstyle()`](https://www.geeksforgeeks.org/setfillstyle-floodfill-c/) 和 [`floodfill()`](https://www.geeksforgeeks.org/setfillstyle-floodfill-c/) 填充所有空间。
