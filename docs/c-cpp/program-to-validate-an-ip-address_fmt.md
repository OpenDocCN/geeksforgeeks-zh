...
> 原文：[https://www.geeksforgeeks.org/program-to-validate-an-ip-address/](https://www.geeksforgeeks.org/program-to-validate-an-ip-address/)
...
**步骤 3)** 如果 `dot_counter` = 3 返回 0，否则返回 1
