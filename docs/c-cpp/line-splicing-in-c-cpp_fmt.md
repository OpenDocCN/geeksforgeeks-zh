...
以上问题的答案是`Line splicing`。以 `a \` 结尾的行在翻译过程中很早就与下一行拼接在一起。[2.2 翻译阶段](http://en.cppreference.com/w/cpp/language/translation_phases)。
...
本文由`比沙尔·库马尔·杜贝`供稿。如果你喜欢 GeeksforGeeks 并想投稿，你也可以使用`contribute.geeksforgeeks.org`写一篇文章或者把你的文章邮寄到`contribute@geeksforgeeks.org`。看到你的文章出现在极客博客主页上，帮助其他极客。
