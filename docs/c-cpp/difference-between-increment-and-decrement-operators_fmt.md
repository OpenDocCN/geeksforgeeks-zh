...
> 原文: [https://www.geeksforgeeks.org/difference-between-increment-and-decrement-operators/](https://www.geeksforgeeks.org/difference-between-increment-and-decrement-operators/)
...
增量运算符用于在表达式中增加变量的值。在前缀增量中，值先增加，然后在表达式中使用。而在后缀增量中，值先在表达式中使用，然后才增加。
...
减量运算符用于在表达式中减少变量的值。在前缀减量中，值先减少，然后在表达式中使用。而在后缀减量中，值先在表达式中使用，然后才减少。
