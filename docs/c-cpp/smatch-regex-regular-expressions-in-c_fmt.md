...
> 原文: [https://www.geeksforgeeks.org/smatch-regex-regular-expressions-in-c/](https://www.geeksforgeeks.org/smatch-regex-regular-expressions-in-c/)
...
*   因此，您可以将 `size()-1` 的值传递给其他三个成员函数 (`str()`、`position()`、`length()`)。
