...
> 原文：[https://www.geeksforgeeks.org/pattern-searching-using-c-library/](https://www.geeksforgeeks.org/pattern-searching-using-c-library/)
...
想法是在 C++ `string` 类中使用 [`find()`](https://www.geeksforgeeks.org/c-string-class-and-its-applications/)。
