# C++ STL 中的 `forward_list::emplace_front()`

> 原文：[https://www.geeksforgeeks.org/forward_listemplace_front-in-c-stl/](https://www.geeksforgeeks.org/forward_listemplace_front-in-c-stl/)
...
使用 `emplace_front()` 函数输入一个空的前向列表，并对给定的前向列表进行排序。
