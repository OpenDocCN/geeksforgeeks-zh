...
> 原文: [https://www.geeksforgeeks.org/use-cases-of-mouse-programming-in-c-c-set-2/](https://www.geeksforgeeks.org/use-cases-of-mouse-programming-in-c-c-set-2/)
...
*   `restrictMouse()`: 用于通过设置以下参数来设置鼠标指针的水平和垂直限制。`AX = 7` 水平限制，`AX = 8` 垂直限制。
