...
> 原文：[https://www.geeksforgeeks.org/find-indices-of-all-occurrence-of-one-string-in-other/](https://www.geeksforgeeks.org/find-indices-of-all-occurrence-of-one-string-in-other/)
...
一个简单的解决方案是逐个检查给定字符串的所有子字符串。如果子串匹配，打印其索引。
...
一个高效的解决方案是 [KMP 字符串匹配算法](https://www.geeksforgeeks.org/searching-for-patterns-set-2-kmp-algorithm/)。