...
> 原文: [https://www.geeksforgeeks.org/nested-loops-in-c-with-examples/](https://www.geeksforgeeks.org/nested-loops-in-c-with-examples/)
...
下面的程序使用嵌套的 `for` 循环来打印一个 3×3 的 2D 矩阵。
