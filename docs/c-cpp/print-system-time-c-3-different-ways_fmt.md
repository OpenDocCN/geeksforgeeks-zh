...
> 原文: [https://www.geeksforgeeks.org/print-system-time-c-3-different-ways/](https://www.geeksforgeeks.org/print-system-time-c-3-different-ways/)

## 第一种方法
[使用 `time()` 打印当前日期和时间](https://www.geeksforgeeks.org/c-program-print-current-day-date-time/)
