...
> 原文: [https://www.geeksforgeeks.org/c-program-to-find-the-largest-number-among-three-numbers/](https://www.geeksforgeeks.org/c-program-to-find-the-largest-number-among-three-numbers/)
...
在下面的程序中，为了找到三个数字中最大的一个，使用了 `if`、`if-else`、`nested if-else` 和 `Ternary operator`。
