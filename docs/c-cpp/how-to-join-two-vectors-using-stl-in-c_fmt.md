...
> 原文: [https://www.geeksforgeeks.org/how-to-join-two-vectors-using-stl-in-c/](https://www.geeksforgeeks.org/how-to-join-two-vectors-using-stl-in-c/)
...
连接可以借助 STL 中提供的 `set_union()` 函数来完成。
