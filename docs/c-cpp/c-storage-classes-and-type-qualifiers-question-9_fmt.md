...
> 原文：`https://www.geeksforgeeks.org/c-storage-classes-and-type-qualifiers-question-9/`
...
**解释：** 由于 `num` 是 `static` 的，此外，由于语句 `return num--` 是后缀，因此它会返回 `num` 的旧值，并为下一次函数调用更新该值。
...
`https://www.geeksforgeeks.org/c-language-2-gq/storage-classes-gq/`