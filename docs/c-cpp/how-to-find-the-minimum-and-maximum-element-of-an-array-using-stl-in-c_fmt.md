...
> 原文：`https://www.geeksforgeeks.org/how-to-find-the-minimum-and-maximum-element-of-an-array-using-stl-in-c/`
...
要使用 `min_element()` 和 `max_element()`，必须包含 `algorithm` 作为头文件。
