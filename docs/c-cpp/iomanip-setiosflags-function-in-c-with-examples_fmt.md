...
> 原文: [https://www.geeksforgeeks.org/iomanip-setiosflags-function-in-c-with-examples/](https://www.geeksforgeeks.org/iomanip-setiosflags-function-in-c-with-examples/)

C++ 中 `iomanip` 库的 `setiosflags()` 方法用于设置指定为该方法参数的 `ios` 库格式标志。
...
**参考:** [http://www.cplusplus.com/reference/iomanip/setiosflags/](http://www.cplusplus.com/reference/iomanip/setiosflags/)