...
> 原文：[https://www.geeksforgeeks.org/how-to-access-global-variable-if-there-is-a-local-variable-with-same-name-in-c-cpp/](https://www.geeksforgeeks.org/how-to-access-global-variable-if-there-is-a-local-variable-with-same-name-in-c-cpp/)
...
**2)** 如果我们在 C++ 中有一个同名的局部变量，我们可以使用[**作用域解析运算符(`::`)**](https://www.geeksforgeeks.org/scope-resolution-operator-in-c/)来访问一个全局变量。
