...
> 原文：[https://www.geeksforgeeks.org/cpp-program-to-find-the-smallest-missing-number/](https://www.geeksforgeeks.org/cpp-program-to-find-the-smallest-missing-number/)
...
*   否则，从第一个和最后一个索引中找到中间元素，并检查中间元素是否等于所需元素。即 `第一 + 中间索引`。
