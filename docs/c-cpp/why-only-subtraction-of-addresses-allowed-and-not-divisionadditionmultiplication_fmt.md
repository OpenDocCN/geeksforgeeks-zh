# 为什么只允许指针减法而不允许除法、加法、乘法？

> 原文：[https://www.geeksforgeeks.org/why-only-subtraction-of-addresses-allowed-and-not-divisionadditionmultiplication/](https://www.geeksforgeeks.org/why-only-subtraction-of-addresses-allowed-and-not-divisionadditionmultiplication/)

## 为什么允许减法？

可以减去两个地址，因为两个地址之间的内存将是有效内存。
让我们假设`ptr_1`和`ptr_2`是有效地址。很明显，这两个地址之间的内存是有效的。
