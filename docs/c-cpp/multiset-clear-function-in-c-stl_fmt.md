...
> 原文: [`https://www.geeksforgeeks.org/multiset-clear-function-in-c-stl/`](https://www.geeksforgeeks.org/multiset-clear-function-in-c-stl/)

`multiset::clear()` 函数是 C++ STL 中的内置函数，它从多集容器中移除所有元素。移除后多集容器的最终大小为 0。
