...
> 原文：[https://www.geeksforgeeks.org/custom-c-user-snippet-in-visual-studio-code/](https://www.geeksforgeeks.org/custom-c-user-snippet-in-visual-studio-code/)
...
在我们的代码片段中，我们使用了一个 `"boilerplate"` 作为“打印到控制台”，这意味着当我们键入 `boilerplate` 并按回车键时，我们的代码片段被执行。

前缀作为 `"boilerplate code"` 给出。这将在键入代码片段的名称时可见。
