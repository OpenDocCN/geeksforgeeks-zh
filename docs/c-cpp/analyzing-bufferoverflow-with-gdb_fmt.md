...
> 原文: [https://www.geeksforgeeks.org/analyzing-bufferoverflow-with-gdb/](https://www.geeksforgeeks.org/analyzing-bufferoverflow-with-gdb/)

**先决条件:** [GDB(分步介绍)](https://www.geeksforgeeks.org/gdb-step-by-step-introduction/)

一个 `缓冲区溢出` 经常发生在定义的变量内的内容被复制到另一个变量而不做 `边界检查` 或考虑缓冲区的大小。让我们借助内置于每个 Linux 系统中的 [GNU 调试器(GDB)](https://www.geeksforgeeks.org/gdb-step-by-step-introduction/) 来分析缓冲区溢出。
