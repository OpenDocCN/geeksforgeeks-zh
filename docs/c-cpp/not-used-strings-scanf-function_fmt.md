...
> 原文: [https://www.geeksforgeeks.org/not-used-strings-scanf-function/](https://www.geeksforgeeks.org/not-used-strings-scanf-function/)
...
1.  `&`用于获取变量的地址。C没有字符串类型，字符串只是一个字符数组，数组变量存储第一个索引位置的地址。
