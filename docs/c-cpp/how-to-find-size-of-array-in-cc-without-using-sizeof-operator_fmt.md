# 不使用 sizeof 如何在 C/C++ 中求数组的大小？

> 原文：[https://www.geeksforgeeks.org/how-to-find-size-of-array-in-cc-without-using-sizeof-operator/](https://www.geeksforgeeks.org/how-to-find-size-of-array-in-cc-without-using-sizeof-operator/)
...
一种解决方案是编写我们自己的 `sizeof` 操作符（详见[这个](https://www.geeksforgeeks.org/implement-your-own-sizeof/)）。
