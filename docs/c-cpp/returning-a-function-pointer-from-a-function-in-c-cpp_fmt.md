...
> 原文: [https://www.geeksforgeeks.org/returning-a-function-pointer-from-a-function-in-c-cpp/](https://www.geeksforgeeks.org/returning-a-function-pointer-from-a-function-in-c-cpp/)
...
> `返回类型(* function_pointer_name)(argument_type_1, argument_type_2, …, argument_type_n) = &function_name;`
>
> 或
>
> `返回类型(* function_pointer_name)(argument_type_1, argument_type_2, …, argument_type_n) = function_name;`
...
> `typedef 返回类型(* function_pointer_name)(argument_type_1, argument_type_2, …, argument_type_n);`
>
> 这将创建一个表示特定函数指针的类型。
