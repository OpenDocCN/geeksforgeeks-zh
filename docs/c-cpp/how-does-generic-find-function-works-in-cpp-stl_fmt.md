...
> 原文：[https://www.geeksforgeeks.org/how-does-generic-find-function-works-in-cpp-stl/](https://www.geeksforgeeks.org/how-does-generic-find-function-works-in-cpp-stl/)
...
*   它将一个[迭代器](https://www.geeksforgeeks.org/iterators-c-stl/)返回到范围 `[first, last]` 中的第一个元素，该元素等于给定的 `key`。
...
*   该函数基于关键元素搜索矢量从 `begin` 到 `end` 的元素。如果该值不存在，那么它将返回 `end` 迭代器。
