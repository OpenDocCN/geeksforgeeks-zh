# 使用C中的fork()从同一父进程创建n个子进程

> 原文:[https://www.geeksforgeeks.org/create-n-child-process-parent-process-using-fork-c/](https://www.geeksforgeeks.org/create-n-child-process-parent-process-using-fork-c/)
...
本文由 迪本杜·罗伊·乔杜里 供稿。如果你喜欢 GeeksforGeeks 并想投稿，你也可以使用[contribute.geeksforgeeks.org](http://www.contribute.geeksforgeeks.org)写一篇文章或者把你的文章邮寄到 contribute@geeksforgeeks.org。看到你的文章出现在极客博客主页上，帮助其他极客。
