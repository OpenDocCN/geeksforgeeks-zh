...
> 原文：[https://www.geeksforgeeks.org/useful-array-algorithms-in-c-stl/](https://www.geeksforgeeks.org/useful-array-algorithms-in-c-stl/)
...
在上面的代码中，使用 `copy_n()` 在 `ar1` 中复制 `ar` 的元素。
