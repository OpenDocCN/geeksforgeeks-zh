...
`for`循环是一个重复控制结构，它允许我们编写一个执行特定次数的循环。该循环使我们能够在一行中一起执行 n 个步骤。
...
3. Condition is checked. 1 <= 0 2 3 4 5 6 yields true.
    3.a) "hello world" gets printed 1st time.
    3.b) updation is done. now i=2.
4. condition checked. <=5
    4.a) 2nd
    4.b)
5.
    5.a) 3rd time
...
7.
    ...
    7.b)
8. false.
9. flow goes outside the loop to return
```
