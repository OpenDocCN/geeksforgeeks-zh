...
> 原文: [https://www.geeksforgeeks.org/difference-between-turbo-c-and-dev-c/](https://www.geeksforgeeks.org/difference-between-turbo-c-and-dev-c/)
...
| 序号 | Turbo C++ 程序 | Dev C++ |
| :--- | :--- | :--- |
| 1. | 在 Turbo C++ 中，有 2 个头文件。`#include <conio.h>` 是额外的，在 Dev C++ 的代码中不存在。这个头文件基本上包含了 `getch()` 函数，用来成功返回程序。 | 在 Dev C++ 代码中，我们使用默认情况下由 `main()` 函数包含的 `return 0`。 |
