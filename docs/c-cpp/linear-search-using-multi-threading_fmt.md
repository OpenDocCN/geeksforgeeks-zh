...
> 原文：[https://www.geeksforgeeks.org/linear-search-using-multi-threading/](https://www.geeksforgeeks.org/linear-search-using-multi-threading/)
...
## 先决条件
[多线程](https://www.geeksforgeeks.org/multithreading-in-cpp/)
...
## 练习
以上代码将数组划分为四个子数组。将其扩展为一个决定划分（或线程）数量的参数。