...
> 原文：[https://www.geeksforgeeks.org/swapping-of-subranges-from-different-containers-in-c/](https://www.geeksforgeeks.org/swapping-of-subranges-from-different-containers-in-c/)

容器是保存其他对象集合的容器对象。它们被实现为类模板，这允许作为元素支持的类型有很大的灵活性。

给定[`vector`](https://www.geeksforgeeks.org/vector-in-cpp-stl/)和[`list`](https://www.geeksforgeeks.org/list-cpp-stl/)中的一些元素，交换它们的一些元素。
