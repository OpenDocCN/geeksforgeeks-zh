...
> 原文：[https://www.geeksforgeeks.org/list-max_size-function-in-c-stl/](https://www.geeksforgeeks.org/list-max_size-function-in-c-stl/)
...
下面程序举例说明 `list::max_size()` 函数在 C++ STL 中：
