...
> 原文：[https://www.geeksforgeeks.org/fopen-for-an-existing-file-in-write-mode/](https://www.geeksforgeeks.org/fopen-for-an-existing-file-in-write-mode/)
...
**参考资料：**
[`不要对 fopen() 和文件创建做假设`](https://www.securecoding.cert.org/confluence/display/seccode/FIO03-C.+Do+not+make+assumptions+about+fopen%28%29+and+file+creation)
[`C11 (C 标准修订)`](http://en.wikipedia.org/wiki/C11_(C_standard_revision))
