...
> 原文: [https://www.geeksforgeeks.org/forward_listbefore_begin-in-c-stl/](https://www.geeksforgeeks.org/forward_listbefore_begin-in-c-stl/)

`forward_list::before_begin()` 是 CPP STL 中的一个内置函数，它返回一个迭代器，该迭代器指向 `forward_list` 第一个元素之前的位置。
