...
查找并打印 `std::vector<string>` 中的重复单词

> 原文: [https://www.geeksforgeeks.org/find-print-duplicate-words-stdvectorstring-using-stl-functions/](https://www.geeksforgeeks.org/find-print-duplicate-words-stdvectorstring-using-stl-functions/)
