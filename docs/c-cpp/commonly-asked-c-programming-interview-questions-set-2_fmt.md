...
> 原文：[https://www.geeksforgeeks.org/commonly-asked-c-programming-interview-questions-set-2/](https://www.geeksforgeeks.org/commonly-asked-c-programming-interview-questions-set-2/)
...
详见 [实现自己的 `sizeof`](https://www.geeksforgeeks.org/implement-your-own-sizeof/)。
...
在优化中省略了声明为 `volatile` 的对象，因为它们的值可以随时被当前代码范围之外的代码更改。详见 [理解 C 中的 `volatile` 限定词](https://www.geeksforgeeks.org/understanding-volatile-qualifier-in-c/)。

## 变量可以既有 `const` 又有 `volatile` 吗？
