...
> 原文：[https://www.geeksforgeeks.org/c-program-to-read-a-range-of-bytes-from-file-and-print-it-to-console/](https://www.geeksforgeeks.org/c-program-to-read-a-range-of-bytes-from-file-and-print-it-to-console/)
...
3.  [`fclose()`](https://www.geeksforgeeks.org/c-fopen-function-with-examples/)：关闭文件。

## 进场

*   初始化一个[文件指针](https://www.geeksforgeeks.org/basics-file-handling-c/)，比如`FILE *fptr1`。
*   初始化一个数组来存储将从文件中读取的字节。
*   使用函数`fopen()`打开文件，如`fptr1 = fopen(argv[1], "r")`。
*   [迭代一个循环](https://www.geeksforgeeks.org/range-based-loop-c/)直到读取并存储给定文件，在变量中扫描字符，使用`fgetc()`函数。
