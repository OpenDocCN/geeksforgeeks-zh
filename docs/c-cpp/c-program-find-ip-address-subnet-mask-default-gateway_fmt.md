...
> 原文: [https://www.geeksforgeeks.org/c-program-find-ip-address-subnet-mask-default-gateway/](https://www.geeksforgeeks.org/c-program-find-ip-address-subnet-mask-default-gateway/)

## 术语

**IP 地址:** IP 地址是互联网协议地址的缩写，是一个网络硬件的识别号。拥有一个 IP 地址允许设备通过基于 IP 的网络(如互联网)与其他设备通信。
