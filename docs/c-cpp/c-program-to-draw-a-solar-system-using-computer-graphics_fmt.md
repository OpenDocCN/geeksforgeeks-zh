...
> 原文: [https://www.geeksforgeeks.org/c-program-to-draw-a-solar-system-using-computer-graphics/](https://www.geeksforgeeks.org/c-program-to-draw-a-solar-system-using-computer-graphics/)

## 先决条件

[`graphics.h`](https://www.geeksforgeeks.org/include-graphics-h-codeblocks/) [在代码块中包含 `graphics.h`](https://www.geeksforgeeks.org/include-graphics-h-codeblocks/)
...
*   [`outtextxy()`](https://www.geeksforgeeks.org/outtextxy-function-c/): 用于显示屏幕上指定点(x，y)的文本或字符串。
*   [`矩形()`](https://www.geeksforgeeks.org/draw-rectangle-c-graphics/): 用于绘制矩形。
    *   绘制矩形需要左上角和右下角的坐标。
    *   `左`指定左上角的 X 坐标，`上`指定左上角的 Y 坐标，`右`指定右下角的 X 坐标，`下`指定右下角的 Y 坐标。
