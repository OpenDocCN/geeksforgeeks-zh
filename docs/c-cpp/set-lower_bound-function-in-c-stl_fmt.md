...
> 原文: [https://www.geeksforgeeks.org/set-lower_bound-function-in-c-stl/](https://www.geeksforgeeks.org/set-lower_bound-function-in-c-stl/)
...
**参数:** 该函数接受一个强制参数 `key`，该键指定要返回其下限的元素。
