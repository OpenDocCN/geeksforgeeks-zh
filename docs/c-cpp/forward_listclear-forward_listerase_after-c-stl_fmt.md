...
> 原文：[https://www.geeksforgeeks.org/forward_listclear-forward_listerase_after-c-stl/](https://www.geeksforgeeks.org/forward_listclear-forward_listerase_after-c-stl/)
...
`erase_after()`函数用于从指定位置旁边的容器或范围中移除元素。
