...
> 原文：[https://www.geeksforgeeks.org/find-elements-of-an-array-which-are-divisible-by-n-using-stl-in-c/](https://www.geeksforgeeks.org/find-elements-of-an-array-which-are-divisible-by-n-using-stl-in-c/)
...
这可以使用 C++ 中的 [`count_if()`](https://www.geeksforgeeks.org/count_if-in-c/) 方法来实现。
...
其中 `function` 将给定序列的元素逐个作为参数，并根据该函数中指定的条件返回一个布尔值。
