...
> 原文: [https://www.geeksforgeeks.org/why-is-the-size-of-an-empty-class-not-zero-in-c/](https://www.geeksforgeeks.org/why-is-the-size-of-an-empty-class-not-zero-in-c/)
...
出于同样的原因（不同的对象应该有不同的地址），`new` 总是返回指向不同对象的指针。请参见以下示例。
