...
> 原文: [https://www.geeksforgeeks.org/how-to-join-two-arrays-using-stl-in-c/](https://www.geeksforgeeks.org/how-to-join-two-arrays-using-stl-in-c/) 连接两个数组
...
## 方式:
连接可以借助 STL 中提供的 [`set_union()`](https://www.geeksforgeeks.org/std-set_union-in-cpp/) 功能完成。
