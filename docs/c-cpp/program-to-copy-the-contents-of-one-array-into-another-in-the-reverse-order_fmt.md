...
> 原文：[https://www.geeksforgeeks.org/program-to-copy-the-contents-of-one-array-into-another-in-the-reverse-order/](https://www.geeksforgeeks.org/program-to-copy-the-contents-of-one-array-into-another-in-the-reverse-order/)
...
设`len`为原数组长度。我们将每个元素 `original_arr[i]` 复制到 `copied_arr[len - i - 1]` 中，以在 `copied_arr[]` 中获得反转。
