...
> 原文：`https://www.geeksforgeeks.org/program-to-check-if-two-strings-are-same-or-not/`
...
> **输出：** 是
>
> **输入：** `string1 = "GeeksforGeeks"`，`string2 = "GeeksforGeeks"`
> **输出：** 是
>
> **输入：** `string1 = "GeeksforGeeks"`，`string2 = "Geeks"`
> **输出：** 否
>
> **输入：** `string1 = "GeeksforGeeks"`，`string2 = "geeksforgeks"`
> **输出：** 否

## 方法

这可以借助 C 中的 [`strcmp()`](https://www.geeksforgeeks.org/strcmp-in-c-cpp/) 方法来完成，请注意，该方法区分大小写。
