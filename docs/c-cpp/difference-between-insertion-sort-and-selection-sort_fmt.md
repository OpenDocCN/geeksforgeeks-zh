...
> 原文: [https://www.geeksforgeeks.org/difference-between-insertion-sort-and-selection-sort/](https://www.geeksforgeeks.org/difference-between-insertion-sort-and-selection-sort/)
...
| 3。 | When the array has been arranged in ascending order, the time complexity in the best case is `O(N)`. | Without the best case, the time complexity is `O(n^2)` in all cases. |
