# C++ STL 中 unordered_multimap::rehash() 函数

> 原文：[https://www.geeksforgeeks.org/unordered_multimap-rehash-function-in-c-stl/](https://www.geeksforgeeks.org/unordered_multimap-rehash-function-in-c-stl/)

`unordered_multimap::rehash(N)` 是 C++ STL 中的内置函数，它将容器中的桶数设置为 N 或更多。如果 N 大于容器中当前的桶数（桶数），则强制*重新散列*。
...
**参考：** [http://www.cplusplus.com/reference/unordered_map/unordered_multimap/rehash/](http://www.cplusplus.com/reference/unordered_map/unordered_multimap/rehash/)