...
> 原文：[https://www.geeksforgeeks.org/passing-a-function-as-a-parameter-in-cpp/](https://www.geeksforgeeks.org/passing-a-function-as-a-parameter-in-cpp/)
...
在 [C++11](https://www.geeksforgeeks.org/c-11-vs-c-14-vs-c-17/) 中，有一个 `std::function<>` [模板](https://www.geeksforgeeks.org/templates-cpp/)类，允许将函数作为对象传递。`std::function<>` 的一个对象可以如下创建。
