...
> 原文: [https://www.geeksforgeeks.org/brief-overview-comparison-of-object-oriented-programming-from-c-to-java/](https://www.geeksforgeeks.org/brief-overview-comparison-of-object-oriented-programming-from-c-to-java/)
...
| 类的方法 (示例打印客户) | 创建的函数 (`printCustomer` 示例) |
