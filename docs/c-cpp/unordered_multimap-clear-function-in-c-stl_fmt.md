# C++ STL 中的无序 multimap clear() 函数

> 原文: [https://www.geeksforgeeks.org/unordered_multimap-clear-function-in-c-stl/](https://www.geeksforgeeks.org/unordered_multimap-clear-function-in-c-stl/)

`unordered_multimap::clear()` 是 C++ STL 中的内置函数，用于清除 `unordered_multimap` 容器的内容。调用函数后，容器的最终大小为 0。
