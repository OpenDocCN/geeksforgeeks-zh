...
> 原文: [https://www.geeksforgeeks.org/policy-based-data-structures-g/](https://www.geeksforgeeks.org/policy-based-data-structures-g/)
...
**注意：** `order_of_key` 和 `find_by_order` 两个函数都是在对数时间内工作的。
