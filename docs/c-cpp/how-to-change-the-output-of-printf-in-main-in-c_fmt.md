...
> 原文: [https://www.geeksforgeeks.org/how-to-change-the-output-of-printf-in-main-in-c/](https://www.geeksforgeeks.org/how-to-change-the-output-of-printf-in-main-in-c/)
...
不允许更改 `main()`。只有 `fun()` 可以改变。现在，考虑以下使用宏参数的程序，
