...
| C does not support virtual and buddy functions. | C++ supports virtual and [friend functions](https://www.geeksforgeeks.org/friend-class-function-cpp/) . |
...
| C does not support direct support for exception handling. | C++ supports exception handling . |
| [`scanf()`](https://www.geeksforgeeks.org/scanf-and-fscanf-in-c-simple-yet-poweful/) and [`printf()`](https://www.geeksforgeeks.org/scanf-and-fscanf-in-c-simple-yet-poweful/) functions are used for input/output in C, | [`cin`](https://www.geeksforgeeks.org/basic-input-output-c/) and [`cout`](https://www.geeksforgeeks.org/basic-input-output-c/) are used for [input/output in C++.](https://www.geeksforgeeks.org/basic-input-output-c/) |
