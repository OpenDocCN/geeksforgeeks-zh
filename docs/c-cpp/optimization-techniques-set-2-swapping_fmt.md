...
> 原文：[https://www.geeksforgeeks.org/optimization-techniques-set-2-swapping/](https://www.geeksforgeeks.org/optimization-techniques-set-2-swapping/)
...
乍一看，我们可能认为代码没有问题。然而，当被提示选择异或交换逻辑背后的原因时，这个人毫无头绪。或许任何交换式操作都可以满足某些角落情况的需要。
