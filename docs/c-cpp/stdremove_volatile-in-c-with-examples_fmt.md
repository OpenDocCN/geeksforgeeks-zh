...
> 原文: [https://www.geeksforgeeks.org/stdremove_volatile-in-c-with-examples/](https://www.geeksforgeeks.org/stdremove_volatile-in-c-with-examples/)
...
模板 `std::remove_volatile` 接受单个参数 `T`（性状类）检查 `T` 是否无挥发合格。

## 返回值

模板 `std::remove_volatile` 返回布尔值：
...
**参考:** [http://www.cplusplus.com/reference/type_traits/remove_volatile/](http://www.cplusplus.com/reference/type_traits/remove_volatile/)