# C++ STL 中的 unordered_multimap bucket_count() 函数

> 原文：[https://www.geeksforgeeks.org/unordered_multimap-bucket_count-function-in-c-stl/](https://www.geeksforgeeks.org/unordered_multimap-bucket_count-function-in-c-stl/)

`unordered_multimap::bucket_count()` 是 C++ STL 中的内置函数，返回 `unordered_multimap` 容器中的桶总数。桶是容器内部哈希表中的一个槽，元素根据它们的哈希值被分配给这个槽。
