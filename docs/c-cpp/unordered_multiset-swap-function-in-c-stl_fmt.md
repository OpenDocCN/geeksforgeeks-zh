# C++ STL 中的 unordered_multiset::swap() 函数

> 原文：[https://www.geeksforgeeks.org/unordered_multiset-swap-function-in-c-stl/](https://www.geeksforgeeks.org/unordered_multiset-swap-function-in-c-stl/)

``unordered_multiset::swap()``是 C++ STL 中的一个内置函数，它交换两个``unordered_multiset``容器的内容。
...
**参数：** 该函数只接受一个强制参数，即``unordered_multiset2``，``unordered_multiset1``的交换将通过该参数完成。
