...
C++ 中 `iomanip` 库的 `resetiosflags()` 方法用于将指定为该方法参数的 `ios` 库格式标志复位。
...
**参考:** [http://www.cplusplus.com/reference/iomanip/resetiosflags/](http://www.cplusplus.com/reference/iomanip/resetiosflags/)