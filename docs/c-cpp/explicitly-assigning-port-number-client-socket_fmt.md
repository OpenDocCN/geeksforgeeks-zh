...
> 原文：[https://www.geeksforgeeks.org/explicitly-assigning-port-number-client-socket/](https://www.geeksforgeeks.org/explicitly-assigning-port-number-client-socket/)
...
有些协议，如`NFS`协议，要求客户端程序只在某个端口号上运行。因此在这种情况下，客户端只需要强制分配该端口号，因为它在 111 或 2049 上运行的是[端口号](https://serverfault.com/questions/377170/which-ports-do-i-need-to-open-in-the-firewall-to-use-nfs)。这可以使用在客户端套接字中指定特定端口号的`bind()`系统调用来完成。
...
**参考**：[https://stackoverflow.com/questions/4118241/what-客户端-情况-需要-绑定](https://stackoverflow.com/questions/4118241/what-客户端-情况-需要-绑定)
