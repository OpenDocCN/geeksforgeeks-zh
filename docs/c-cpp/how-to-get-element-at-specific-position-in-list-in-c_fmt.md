...
> 原文：[https://www.geeksforgeeks.org/how-to-get-element-at-specific-position-in-list-in-c/](https://www.geeksforgeeks.org/how-to-get-element-at-specific-position-in-list-in-c/)
...
这个函数接受两个参数，即遍历列表的迭代器和要移动到的位置。对于[随机访问](https://www.geeksforgeeks.org/random-access-iterators-in-cpp/)和[双向迭代器](https://www.geeksforgeeks.org/bidirectional-iterators-in-cpp/)，位置可以为负。
