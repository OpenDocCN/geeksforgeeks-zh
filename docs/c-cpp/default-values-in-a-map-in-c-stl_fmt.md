...
> 原文：[https://www.geeksforgeeks.org/default-values-in-a-map-in-c-stl/](https://www.geeksforgeeks.org/default-values-in-a-map-in-c-stl/)
...
1.  用默认值声明一个[结构](https://www.geeksforgeeks.org/structures-c/)(比如说结构`Node`)。
2.  用映射到结构`Node`的键初始化映射。
