...
> 原文：[https://www.geeksforgeeks.org/c-c-if-else-statement-with-examples/](https://www.geeksforgeeks.org/c-c-if-else-statement-with-examples/)

[C/C++](https://www.geeksforgeeks.org/decision-making-c-c-else-nested-else/) 中的决策有助于编写决策驱动的语句，并基于某些条件执行一组特定的代码。

仅 `if` 语句就告诉我们，如果条件为真，它将执行一组语句，如果条件为假，它不会执行。但是如果条件是假的，我们想做别的事情怎么办。C/C++ `else` 语句来了。当条件为假时，我们可以使用 `else` 语句和 `if` 语句来执行一段代码。
...
1.  [C/C++ 中的决策](https://www.geeksforgeeks.org/decision-making-c-c-else-nested-else/)
...
6.  [用 C/C++ 继续语句](https://www.geeksforgeeks.org/continue-statement-cpp/)
