...
你会注意到 `void main()` 被高亮显示。这意味着我们的程序已经开始运行。

![Code is executing](img/f990f638322d624c17df7e5a5f357f0f.png)

## 第 10 步

进入运行菜单，点击`跳过(或 F8)` 进入下一步。
...
![Step over#5](img/1b8493cd7ebcdc1ef94ebd7787c85383.png)
...
看一下手表和输出面板。从用户获得输入后，编译器会覆盖变量中的值。
