...
通过使用 [`getc()`](https://www.geeksforgeeks.org/eof-and-feof-in-c/) 方法读取文件中的字符，可以很容易地对字符进行计数。对于从文件中读取的每个字符，将计数器递增 1。
...
[![](img/74fc891317513c7cdb34f18e46217249.png)](https://media.geeksforgeeks.org/wp-content/uploads/20190528110912/Screenshot-from-2019-05-28-11-06-03.png)
