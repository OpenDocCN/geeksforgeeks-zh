...
> 原文：[https://www.geeksforgeeks.org/g-fact-41-setting-decimal-precision-in-c/](https://www.geeksforgeeks.org/g-fact-41-setting-decimal-precision-in-c/)
...
在 C 中，有一个格式说明符。要打印小数点后 4 位数字，我们可以在 `printf()` 中使用 `%0.4f`。下面是演示同样方法的程序：
