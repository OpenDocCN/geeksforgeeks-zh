...
```cpp
Students in first subject : John Bob Mary Serena
Students in second subject : Jim Mary John Bob

Students attending both subjects are :
Bob Jim John Mary Serena
```

2.  它也可以用来求两个集合并集。程序如上。
