# 反转一个文件的内容并将其存储在另一个文件中

> 原文：[https://www.geeksforgeeks.org/reverse-the-content-of-a-file-and-store-it-in-another/](https://www.geeksforgeeks.org/reverse-the-content-of-a-file-and-store-it-in-another/)
