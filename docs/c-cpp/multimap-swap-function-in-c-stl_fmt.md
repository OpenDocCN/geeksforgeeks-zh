...
> 原文：[https://www.geeksforgeeks.org/multimap-swap-function-in-c-stl/](https://www.geeksforgeeks.org/multimap-swap-function-in-c-stl/)
...
该函数接受一个要与 `multimap1_name` 交换的参数。
