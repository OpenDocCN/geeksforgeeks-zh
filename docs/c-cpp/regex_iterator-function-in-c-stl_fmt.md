...
> 原文: [https://www.geeksforgeeks.org/regex_iterator-function-in-c-stl/](https://www.geeksforgeeks.org/regex_iterator-function-in-c-stl/)
...
*   `CharT`: 这是一个字符类型。
*   `Traits`: 为 regex traits 类型。

## 返回值

这个方法返回一个带有结果序列的字符串对象。
