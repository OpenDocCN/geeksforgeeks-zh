...
> 原文: [https://www.geeksforgeeks.org/flexible-array-members-structure-c/](https://www.geeksforgeeks.org/flexible-array-members-structure-c/)
...
**注意：** 在结构中使用柔性数组成员时，定义了一些关于成员实际大小的约定。在上面的例子中，惯例是成员 `stud_name` 具有字符大小。
