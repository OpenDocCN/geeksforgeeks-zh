...
来源: [gcc.gnu.org](https://gcc.gnu.org/onlinedocs/gcc/Designated-Inits.html)
...
在结构初始值设定项中，用`.fieldname = `或`fieldname:`在元素值之前。例如，给定以下结构，
...
**参考:** [https://gcc.gnu.org/onlinedocs/gcc/Designated-Inits.html](https://gcc.gnu.org/onlinedocs/gcc/Designated-Inits.html)