...
> 原文：[https://www.geeksforgeeks.org/write-one-line-functions-for-strcat-and-strcmp/](https://www.geeksforgeeks.org/write-one-line-functions-for-strcat-and-strcmp/)

递归可以用来在一行中完成两个任务。下面是 `strcat()` 和 `strcmp()` 的单行实现。
