# C++ 中的 vector::erase() 和 vector::clear()

> 原文：[https://www.geeksforgeeks.org/vector-erase-and-clear-in-cpp/](https://www.geeksforgeeks.org/vector-erase-and-clear-in-cpp/)
