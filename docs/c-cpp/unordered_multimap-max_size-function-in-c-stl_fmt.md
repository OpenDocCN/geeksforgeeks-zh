...
> 原文: [https://www.geeksforgeeks.org/unordered_multimap-max_size-function-in-c-stl/](https://www.geeksforgeeks.org/unordered_multimap-max_size-function-in-c-stl/)

`unordered_multimap::max_size()` 是 C++ STL 中的内置函数，返回 `unordered_multimap` 容器可以容纳的最大元素数。
