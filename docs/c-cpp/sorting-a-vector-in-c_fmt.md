...
先决条件：[std::sort in C++](https://www.geeksforgeeks.org/sort-c-stl/)、[Vector in C++](https://www.geeksforgeeks.org/vector-in-cpp-stl/)、[Initialize a Vector in C++](https://www.geeksforgeeks.org/initialize-a-vector-in-cpp-different-ways/)。
