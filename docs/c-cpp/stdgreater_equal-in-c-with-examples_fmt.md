...
## 返回类型:
根据条件返回一个 [**布尔值**](https://www.geeksforgeeks.org/bool-data-type-in-c/) (让 a & b 为 2 个元素):

*   **True:** If a is greater than or equal to B. 。
*   **False:** If a is less than b 。

下面是 C++ 中 `std::greater_equal` 的图示:
...
## 参考:
T2【http://www . cplusplus . com/Reference/functional/great _ equal/