...
> 原文：[https://www.geeksforgeeks.org/difference-between-relational-operator-and-stdstringcompare-in-c/](https://www.geeksforgeeks.org/difference-between-relational-operator-and-stdstringcompare-in-c/)之间的差异

[使用关系运算符](https://www.geeksforgeeks.org/comparing-string-objects-using-relational-operators-c/)比较字符串，[使用 `compare()`](https://www.geeksforgeeks.org/stdstringcompare-in-c/)
...
4.  **操作：** 我们可以直接使用 `compare()` 对字符串的一部分进行比较，而使用关系运算符则需要相当长的过程。

## 示例对比

**示例：** 比较 `str1` 从第3个位置开始的3个字符与 `str2` 从第4个位置开始的3个字符。
