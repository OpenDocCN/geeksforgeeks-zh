...
> 原文: [https://www.geeksforgeeks.org/norm-function-in-cpp-with-examples/](https://www.geeksforgeeks.org/norm-function-in-cpp-with-examples/)

`norm()` 函数在 `complex` 头文件中定义。这个函数用来返回复数 `z` 的平方值。
