...
> 原文：[https://www.geeksforgeeks.org/anything-written-sizeof-never-executed-c/](https://www.geeksforgeeks.org/anything-written-sizeof-never-executed-c/)

在 C/C++ 中，`sizeof()` 运算符用于查找数据类型或变量的大小。用 `sizeof()` 编写的表达式从不执行。
