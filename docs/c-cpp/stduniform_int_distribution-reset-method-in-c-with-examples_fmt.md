# C++ 中的 `uniform_int_distribution` 类

## `reset()` 方法详解

> 原文: [https://www.geeksforgeeks.org/stduniform_int_distribution-reset-method-in-c-with-examples/](https://www.geeksforgeeks.org/stduniform_int_distribution-reset-method-in-c-with-examples/)

C++ 中 `uniform_int_distribution` 类的 `reset()` 方法用于重置这个 `uniform_int_distribution`。
...
**参考:** [https://en.cppreference.com/w/cpp/numeric/random/uniform_int_distribution/reset](https://en.cppreference.com/w/cpp/numeric/random/uniform_int_distribution/reset)