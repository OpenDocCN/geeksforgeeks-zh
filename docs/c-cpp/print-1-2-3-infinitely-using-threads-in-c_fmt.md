...
> 原文：[https://www.geeksforgeeks.org/print-1-2-3-infinitely-using-threads-in-c/](https://www.geeksforgeeks.org/print-1-2-3-infinitely-using-threads-in-c/)

用线程无限打印1 2 3。创建三个线程，即`T1`、`T2`和`T3`，这样它们将无限地打印1 2 3序列。
...
**先决条件：** [C中的线程](https://www.geeksforgeeks.org/multithreading-c-2/)

**进场：**

*   开始无限循环，并将变量`done`初始化为1。
*   现在，检查`done`的值是否不等于1。
