...
> 原文: [https://www.geeksforgeeks.org/namespace-c-set-3-creating-header-nesting-aliasing-access/](https://www.geeksforgeeks.org/namespace-c-set-3-creating-header-nesting-aliasing-accessing/)
...
这里我们可以看到，命名空间是在`file1.h`中创建的，并且该命名空间的`value()`在`file2.cpp`中被调用。
