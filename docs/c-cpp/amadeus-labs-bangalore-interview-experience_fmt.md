...
> 原文：[https://www.geeksforgeeks.org/amadeus-labs-bangalore-interview-experience/](https://www.geeksforgeeks.org/amadeus-labs-bangalore-interview-experience/)
...
2.  `C++` 继承。它是如何工作的？什么是 `Vtable` 和 `Vptr`？
    ...
    丙类公共乙
    ```
3.  有 3 个文鼎机器，咖啡，茶，随机。服务员误把机器的标签放错了地方。如何用最少的尝试纠正标签？你从哪里开始？
...
## 第3轮
这是导演轮采访。由于那天交通拥挤，我到达的有点晚。但是导演很有耐心，说得很好。问题主要涉及当前项目和期望(他们的+我们的)。大约花了 30 分钟。
