...
> 原文: [https://www.geeksforgeeks.org/wcsstr-function-in-c-with-example/](https://www.geeksforgeeks.org/wcsstr-function-in-c-with-example/)

`wcsstr()` 函数在 `<cwchar>` 头文件中定义。`wcsstr()` 函数查找目标字符串中第一次出现的源。
