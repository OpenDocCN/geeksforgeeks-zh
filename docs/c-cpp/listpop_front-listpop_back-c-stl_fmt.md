...
> 原文：[https://www.geeksforgeeks.org/listpop_front-listpop_back-c-stl/](https://www.geeksforgeeks.org/listpop_front-listpop_back-c-stl/)
...
使用`push_front()`函数输入一个空列表，列表中有以下数字和顺序，打印列表的反面。
