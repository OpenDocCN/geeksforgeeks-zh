# C++ STL 中的 deque get_allocator

> 原文: [https://www.geeksforgeeks.org/deque-get_allocator-in-c-stl/](https://www.geeksforgeeks.org/deque-get_allocator-in-c-stl/)

[`deque::get_allocator()`](https://www.geeksforgeeks.org/deque-cpp-stl/) 是 C++ STL 中的一个内置函数，用来获取容器 `deque` 的分配器。
...
下面的程序说明了 [`deque::get_allocator()`](https://www.geeksforgeeks.org/deque-cpp-stl/) 函数的工作原理。
