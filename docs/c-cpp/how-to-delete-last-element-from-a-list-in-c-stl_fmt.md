...
> 原文：[https://www.geeksforgeeks.org/how-to-delete-last-element-from-a-list-in-c-stl/](https://www.geeksforgeeks.org/how-to-delete-last-element-from-a-list-in-c-stl/)
...
通过将其迭代器传递给`erase()`函数，可以轻松删除最后一个元素。要到达指向最后一个元素的迭代器，有两种方法：
