...
> 原文: [https://www.geeksforgeeks.org/how-to-implement-user-defined-shared-pointers-in-c/](https://www.geeksforgeeks.org/how-to-implement-user-defined-shared-pointers-in-c/)
...
**何时使用:**
当我们想要将一个原始指针分配给多个所有者时，应该使用 `shared_ptr`。
