...
> 原文: [https://www.geeksforgeeks.org/fork-memory-shared-bw-processes-created-using/](https://www.geeksforgeeks.org/fork-memory-shared-bw-processes-created-using/)

先决条件: [C](https://www.geeksforgeeks.org/fork-system-call/)中的`fork()`。
