...
2.  阅读`cin`会刷新`cout`，所以我们不需要显式刷新来做到这一点。

**参考文献:**

*   [http://searchstorage.techtarget.com/definition/buffer-flush](http://searchstorage.techtarget.com/definition/buffer-flush)
*   [https://stackoverflow.com/questions/15042849/what-does-flushing-the-buffer-mean](https://stackoverflow.com/questions/15042849/what-does-flushing-the-buffer-mean)

**相关文章:**
[在 C 中使用 fflush(stdin)](https://www.geeksforgeeks.org/use-fflushstdin-c/)
