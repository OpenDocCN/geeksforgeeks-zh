# C++ STL 中的向量 `insert()` 函数

> 原文：[https://www.geeksforgeeks.org/vector-insert-function-in-c-stl/](https://www.geeksforgeeks.org/vector-insert-function-in-c-stl/)
