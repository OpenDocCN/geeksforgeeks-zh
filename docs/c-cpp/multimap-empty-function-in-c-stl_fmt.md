...
> 原文: [https://www.geeksforgeeks.org/multimap-empty-function-in-c-stl/](https://www.geeksforgeeks.org/multimap-empty-function-in-c-stl/)
...
### 返回值:
该方法返回一个 `布尔` 类型的值。当 `multimap` 为空时返回 `true`，否则返回 `false`。
