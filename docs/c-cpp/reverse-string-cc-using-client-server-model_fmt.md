...
> 原文: [https://www.geeksforgeeks.org/reverse-string-cc-using-client-server-model/](https://www.geeksforgeeks.org/reverse-string-cc-using-client-server-model/)

本文描述了一个客户机和服务器设置，其中客户机连接，向服务器发送一个字符串，服务器显示原始字符串，并使用套接字连接向客户机发送反向字符串。

## 先决条件

[插座编程](https://www.geeksforgeeks.org/socket-programming-cc/)
