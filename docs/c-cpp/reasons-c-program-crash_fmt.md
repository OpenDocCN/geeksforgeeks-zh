...
[Stack Overflow](https://www.geeksforgeeks.org/heap-overflow-stack-overflow/)：可能存在`非终止递归`导致内存耗尽。
...
现在，程序试图将 ASCII 编码的空终止字符串“excessive”存储在`A`缓冲区中。
