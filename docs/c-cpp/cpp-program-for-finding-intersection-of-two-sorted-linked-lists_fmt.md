...
> 原文: [https://www.geeksforgeeks.org/cpp-program-for-finding-intersection-of-two-sorted-linked-lists/](https://www.geeksforgeeks.org/cpp-program-for-finding-intersection-of-two-sorted-linked-lists/)
...
*   **时间复杂度:** O(m+n)，其中 m 和 n 分别是第一和第二链表中的节点数。只需要遍历列表一次。
*   **辅助空间:** O(最大(m，n))。输出列表最多可以存储 m+n 个节点。
