...
> 原文：[https://www.geeksforgeeks.org/print-a-semicolon-without-using-semicolon-in-ccpp/](https://www.geeksforgeeks.org/print-a-semicolon-without-using-semicolon-in-ccpp/)

另一个有趣的问题是，如何在程序中不使用任何分号的情况下打印分号。下面是打印“；”的方法：

## 1. 在 `if` 语句中使用 `printf`/`putchar`
...
**相关文章：**[C/C++ 无分号打印 Hello World](https://www.geeksforgeeks.org/print-hello-world-without-semicolon-in-ccpp/)
