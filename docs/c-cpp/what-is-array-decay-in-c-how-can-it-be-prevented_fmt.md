...
> 原文：[https://www.geeksforgeeks.org/what-is-array-decay-in-c-how-can-it-be-prevented/](https://www.geeksforgeeks.org/what-is-array-decay-in-c-how-can-it-be-prevented/)
...
处理衰减的典型解决方案是将数组的大小也作为参数传递，而不在数组参数上使用 `sizeof`（详见[本](https://www.geeksforgeeks.org/using-sizof-operator-with-array-paratmeters/)）。
