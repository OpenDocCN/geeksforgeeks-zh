...
| **语法:**`class name(cont class name&obj){`<br><br>`//body}` | **语法:**`className obj1、obj 2；obj 2 = obj 1；` |
...
**说明:**这里，`t2 = t1；`调用`赋值运算符`，同`t2 . operator =(t1)；`和`Test t3 = t1`调用`复制构造函数`，同`Test T3(t1)；`
