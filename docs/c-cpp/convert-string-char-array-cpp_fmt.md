...
> 原文：[`https://www.geeksforgeeks.org/convert-string-char-array-cpp/`](https://www.geeksforgeeks.org/convert-string-char-array-cpp/)
...
`c_str()` 函数的作用是：返回一个指向数组的指针，该数组包含一个空终止的字符序列，该序列代表字符串的当前值。
语法：
