...
> 原文: [https://www.geeksforgeeks.org/common-subtleties-vector-stls/](https://www.geeksforgeeks.org/common-subtleties-vector-stls/)

## 先决条件
[矢量基础知识](http://geeksquiz.com/vector-sequence-containers-the-c-standard-template-library-stl-set-1/)
...
### 3. `clear()` 函数
`clear()` 函数使向量有零个元素，即-无元素，不使元素全为 0。
