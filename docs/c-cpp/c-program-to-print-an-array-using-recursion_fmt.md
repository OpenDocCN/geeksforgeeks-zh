...
> 原文: [https://www.geeksforgeeks.org/c-program-to-print-an-array-using-recursion/](https://www.geeksforgeeks.org/c-program-to-print-an-array-using-recursion/)
...
[静态变量](https://www.geeksforgeeks.org/static-variables-in-c/)有一个特性，即使超出其作用域后也能保留其值！因此，静态变量会保留其在先前作用域中的值，而不会在新作用域中再次初始化。
