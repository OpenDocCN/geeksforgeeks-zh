...
> 原文: [https://www.geeksforgeeks.org/advantages-and-disadvantages-of-c/](https://www.geeksforgeeks.org/advantages-and-disadvantages-of-c/)
...
*   C++ 程序可以支持[联合](https://www.geeksforgeeks.org/union-c/)和[结构](https://www.geeksforgeeks.org/structures-c/)，它们是独立文件和组合文件的混合，它使用的是标准的 C++ 应用程序，称为`.CPP`。C++ 使用提到的保留库字为`goto`，这和 Java 的`continue`，或者`break`命令是一样的。
