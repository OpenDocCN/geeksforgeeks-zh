# C++ STL 中的 unordered_multiset::reserve()

> 原文: [https://www.geeksforgeeks.org/unordered_multiset-reserve-in-c-stl/](https://www.geeksforgeeks.org/unordered_multiset-reserve-in-c-stl/)

`unordered_multiset` 的 `reserve()` 功能将容器中的桶数（桶数）设置为最适合包含至少 `n` 个元素。
