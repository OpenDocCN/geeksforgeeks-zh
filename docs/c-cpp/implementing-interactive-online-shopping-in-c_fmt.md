...
> 原文: [https://www.geeksforgeeks.org/implementing-interactive-online-shopping-in-c/](https://www.geeksforgeeks.org/implementing-interactive-online-shopping-in-c/)
...
首先，菜单会显示给顾客。选择后，将显示所有产品及其价格。然后客户将选择产品并选择数量(产品数量)。这个过程一直持续到购物完成。每当顾客完成购物时，就会显示商品、数量、成本，最后是要支付的总金额。
