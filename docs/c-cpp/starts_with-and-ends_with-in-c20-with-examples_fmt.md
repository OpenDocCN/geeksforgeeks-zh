...
> `template <typename PrefixType> bool starts_with(PrefixType prefix) const noexcept;`
...
下面的程序演示了在 [C++](https://www.geeksforgeeks.org/c-plus-plus/) 中以`starts_with()`开头的概念：
...
> `template <typename SuffixType> bool ends_with(SuffixType suffix) const noexcept;`
...
下面的程序演示了 [C++](https://www.geeksforgeeks.org/c-plus-plus/) 中以`ends_with()`结尾的概念：
