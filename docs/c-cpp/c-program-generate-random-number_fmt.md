...
> 原文：[https://www.geeksforgeeks.org/c-program-generate-random-number/](https://www.geeksforgeeks.org/c-program-generate-random-number/)

下面的实现是生成从 1 到给定极限的随机数。下面的函数产生类似于 [`srand()`](https://www.geeksforgeeks.org/rand-and-srand-in-cpp/) 函数的行为。
