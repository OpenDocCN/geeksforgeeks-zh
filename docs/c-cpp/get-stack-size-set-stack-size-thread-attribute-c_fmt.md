# 获取堆栈大小，在 C 中设置线程属性的堆栈大小

> 原文: [https://www.geeksforgeeks.org/get-stack-size-set-stack-size-thread-attribute-c/](https://www.geeksforgeeks.org/get-stack-size-set-stack-size-thread-attribute-c/)
...
为编译使用 `gcc program_name.c -lpthread`
