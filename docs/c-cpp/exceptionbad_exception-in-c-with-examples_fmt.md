...
> 原文: [https://www.geeksforgeeks.org/exceptionbad_exception-in-c-with-examples/](https://www.geeksforgeeks.org/exceptionbad_exception-in-c-with-examples/)
...
`异常::bad_exception` 返回一个空终止字符，用于标识异常。

## `注意:`

要使用`异常::bad_exception`，应该设置合适的试捕块。
...
[http://www.cplusplus.com/reference/exception/bad_exception/](http://www.cplusplus.com/reference/exception/bad_exception/)