# C++ STL 中的 unordered_multimap::max_load_factor() 函数

> 原文: [https://www.geeksforgeeks.org/unordered_multimap-max_load_factor-function-in-c-stl/](https://www.geeksforgeeks.org/unordered_multimap-max_load_factor-function-in-c-stl/)

`unordered_multimap::max_load_factor()` 是 C++ STL 中的内置函数，返回 `unordered_multimap` 容器的最大[加载因子](https://www.geeksforgeeks.org/unordered_multimap-load_factor-function-in-c-stl/)。该函数还提供了设置最大负载系数的选项。
...
int main()
{
    ...
    // inserts key and element in sample1
