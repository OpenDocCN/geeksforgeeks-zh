...
> 原文: [https://www.geeksforgeeks.org/print-decorative-christmas-tree-c/](https://www.geeksforgeeks.org/print-decorative-christmas-tree-c/)

既然圣诞节就在门口，就该用程序员的方式庆祝一下了。让我们用 C 语言建造一棵装饰圣诞树。

为了印刷圣诞树，我们正在一个接一个地印刷各种尺寸的金字塔。为装饰，每个位置随机印一个字。
