...
> 原文: [https://www.geeksforgeeks.org/priority_queuepush-priority_queuepop-c-stl/](https://www.geeksforgeeks.org/priority_queuepush-priority_queuepop-c-stl/)
...
**Result:**
Adds an element of value same as that of the parameter passed in the priority queue.
...
**Result:**
The top element of the priority queue is removed.
