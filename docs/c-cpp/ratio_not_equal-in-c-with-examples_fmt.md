...
> 原文：[https://www.geeksforgeeks.org/ratio_not_equal-in-c-with-examples/](https://www.geeksforgeeks.org/ratio_not_equal-in-c-with-examples/)

`ratio_not_equal`是 C++ STL 中的一个内置函数，用于检查两个给定的比率是否不相等。
