...
> 原文: [https://www.geeksforgeeks.org/how-to-speed-up-g-during-compile-time/](https://www.geeksforgeeks.org/how-to-speed-up-g-during-compile-time/)
...
*   用`fconcepts`编译程序不会给出任何[错误](https://www.geeksforgeeks.org/errors-in-cc/)，因为`fconcepts`会忽略警告。
*   如果代码执行正常，就会给出错误。
...
通常，函数不允许使用`auto`变量作为函数参数。但是使用 `-fconcepts` 这个错误可以忽略。
