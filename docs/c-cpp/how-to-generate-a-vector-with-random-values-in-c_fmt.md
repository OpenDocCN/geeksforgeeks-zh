...
> 原文：[https://www.geeksforgeeks.org/how-to-generate-a-vector-with-random-values-in-c/](https://www.geeksforgeeks.org/how-to-generate-a-vector-with-random-values-in-c/)

[向量](https://www.geeksforgeeks.org/vector-in-cpp-stl/)是[动态数组](https://www.geeksforgeeks.org/how-do-dynamic-arrays-work/)，能够在插入或删除元素时自动调整自身大小，其存储由[容器](https://www.geeksforgeeks.org/containers-cpp-stl/)自动处理。也可以使用[`generate`](https://www.geeksforgeeks.org/stdgenerate-in-c/)功能和[`rand()`](https://www.geeksforgeeks.org/rand-and-srand-in-ccpp/)功能创建随机值。
...
> **`void srand(unsigned int seed)`**：这个函数用值 `seed` 播种 `rand()` 使用的伪随机数生成器。
