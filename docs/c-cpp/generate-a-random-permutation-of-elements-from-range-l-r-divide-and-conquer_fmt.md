...
**方法:** 我们将使用[分治](https://www.geeksforgeeks.org/divide-and-conquer-algorithm-introduction/)算法进行求解。我们将创建一个全局[向量](https://www.geeksforgeeks.org/vector-in-cpp-stl/)，它将存储由我们的递归函数`generate_random_permutation()`生成的随机数。
