...
> 原文: [https://www.geeksforgeeks.org/program-to-find-the-largest-number-using-ternary-operator/](https://www.geeksforgeeks.org/program-to-find-the-largest-number-using-ternary-operator/)

任务是编写一个程序，使用[三进制运算符](https://www.geeksforgeeks.org/cc-ternary-operator-some-interesting-observations/)在以下情况中找出最大的数字：
*   两个数字。
*   三个数字。
*   四个数字。
