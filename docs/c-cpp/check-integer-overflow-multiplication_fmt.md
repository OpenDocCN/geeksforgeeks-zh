...
> 原文：[https://www.geeksforgeeks.org/check-integer-overflow-multiplication/](https://www.geeksforgeeks.org/check-integer-overflow-multiplication/)

给定两个整数 `a` 和 `b`，找出它们的乘积 (`a * b`) 是否超过有符号的 64 位整数。如果超过打印 `Yes`，否则打印 `No`。
