# c++ STL 中的 `unordered_set::bucket_size()`

> 原文：[`https://www.geeksforgeeks.org/unordered_set-bucket_size-in-c-stl/`](https://www.geeksforgeeks.org/unordered_set-bucket_size-in-c-stl/)

`unordered_set::bucket_size()` 函数是 C++ STL 中的内置函数，它返回无序集容器中特定存储桶中存在的元素总数。
...
下面的程序说明了 `unordered_set::bucket_size()` 函数：
