...
> 原文：[https://www.geeksforgeeks.org/print-hello-world-without-semicolon-in-ccpp/](https://www.geeksforgeeks.org/print-hello-world-without-semicolon-in-ccpp/)
...
这里要注意的是使用 `!`（NOT 运算符）在 `while` 循环中，以避免无限循环。
...
**相关文章：** [如何在 C/C++ 中不使用分号打印分号（;）？](https://www.geeksforgeeks.org/print-a-semicolon-without-using-semicolon-in-ccpp/)
