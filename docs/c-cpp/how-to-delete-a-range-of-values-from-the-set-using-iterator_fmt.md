...
> 原文: [https://www.geeksforgeeks.org/how-to-delete-a-range-of-values-from-the-set-using-iterator/](https://www.geeksforgeeks.org/how-to-delete-a-range-of-values-from-the-set-using-iterator/)
...
在该方法中，从集合中删除一系列元素。这在两个[迭代器](https://www.geeksforgeeks.org/iterators-c-stl/)的帮助下完成。第一个迭代器指向范围的开始元素，第二个迭代器指向范围的最后一个元素。第一个迭代器是*独占*，而最后一个迭代器是*包含*，这意味着最后一个迭代器指向的元素也会被删除。
