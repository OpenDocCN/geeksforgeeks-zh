...
> 原文：[https://www.geeksforgeeks.org/c-storage-classes-and-type-qualifiers-question-19/](https://www.geeksforgeeks.org/c-storage-classes-and-type-qualifiers-question-19/)
...
**解释：** 注意 `arr[]` 是静态的，`fun()` 所以没有返回地址的问题，`arr[]` 会留下来。
