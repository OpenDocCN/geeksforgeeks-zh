...
> 原文: [https://www.geeksforgeeks.org/how-to-reverse-a-vector-using-stl-in-c/](https://www.geeksforgeeks.org/how-to-reverse-a-vector-using-stl-in-c/) 反转矢量
...
可以借助 STL 提供的 `reverse()` 功能进行倒车。`reverse()` 的时间复杂度是 `O(n)`，其中 `n` 是字符串的长度。
