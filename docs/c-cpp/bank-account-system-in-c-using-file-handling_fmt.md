...
> 原文: [https://www.geeksforgeeks.org/bank-account-system-in-c-using-file-handling/](https://www.geeksforgeeks.org/bank-account-system-in-c-using-file-handling/)

本文重点介绍如何使用 [C 语言](https://www.geeksforgeeks.org/c-language-set-1-introduction/)和[在 C 中进行文件处理](https://www.geeksforgeeks.org/basics-file-handling-c/)来创建银行账户系统。
...
1.  在主功能中创建一个菜单，为菜单创建不同的[功能](https://www.geeksforgeeks.org/functions-in-c/)，使用[开关案例语句](https://www.geeksforgeeks.org/switch-statement-cc/)调用。有四种不同的功能-
    1.  `account()`- 该功能用于新建账户。
    2.  `transfermoney()`- 该功能用于向账户转账
    3.  `checkbalance()`- 该功能用于检查账户中的余额。
    4.  `login()`- 该功能用于登录账号。
