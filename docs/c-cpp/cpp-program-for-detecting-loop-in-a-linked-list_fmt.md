...
> 原文：[https://www.geeksforgeeks.org/cpp-program-for-detecting-loop-in-a-linked-list/](https://www.geeksforgeeks.org/cpp-program-for-detecting-loop-in-a-linked-list/)
...
通过修改链表数据结构，不用 hashmap 就可以解决这个问题。
...
2.  Example suppose (`1 <= data on node <= 10^3`) then after visiting assign the as `-1` it is out of given range.
