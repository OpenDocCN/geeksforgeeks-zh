...
> 原文: [https://www.geeksforgeeks.org/c-program-to-check-if-a-singly-linked-list-is-palindrome/](https://www.geeksforgeeks.org/c-program-to-check-if-a-singly-linked-list-is-palindrome/)
...
```cpp
a->NULL Is Palindrome
b->a->NULL Not Palindrome
a->b->a->NULL Is Palindrome
c->a->b->a->NULL Not Palindrome
a->c->a->b->a->NULL Not Palindrome
b->a->c->a->b->a->NULL Not Palindrome
a->b->a->c->a->b->a->NULL Is Palindrome
```
