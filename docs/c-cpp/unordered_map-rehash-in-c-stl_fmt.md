# C++ STL 中的 unordered_map 重散列

> 原文: [https://www.geeksforgeeks.org/unordered_map-rehash-in-c-stl/](https://www.geeksforgeeks.org/unordered_map-rehash-in-c-stl/)

`std::unordered_map::rehash()` 是一个 C++ STL 的内置函数，它将容器中的桶数设置为 n 个或更多。
...
*   如果 `s` 大于容器中的当前桶数，则重新哈希。新存储桶计数可以大于或等于 `n`。
