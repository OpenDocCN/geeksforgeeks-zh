...
> 原文：[https://www.geeksforgeeks.org/c-program-to-check-if-two-linked-lists-are-identical/](https://www.geeksforgeeks.org/c-program-to-check-if-two-linked-lists-are-identical/)
...
O(n) 对于迭代和递归版本。n 是 `a` 和 `b` 中较小列表的长度。
