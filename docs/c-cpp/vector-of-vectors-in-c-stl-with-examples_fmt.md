...
> 原文: [https://www.geeksforgeeks.org/vector-of-vectors-in-c-stl-with-examples/](https://www.geeksforgeeks.org/vector-of-vectors-in-c-stl-with-examples/)

**先决条件:** [C++ STL 中的向量](https://www.geeksforgeeks.org/vector-in-cpp-stl/)

向量被称为[动态数组](https://www.geeksforgeeks.org/how-do-dynamic-arrays-work/)，能够在插入或删除元素时自动调整自身大小，其存储由容器自动管理。

**向量向量**是一个[二维向量](https://www.geeksforgeeks.org/2d-vector-in-cpp-with-user-defined-size/)，其中每一行本身都是一个向量，并且行数可以变化。向量的每个索引位置存储一个向量，可以使用[迭代器](https://www.geeksforgeeks.org/iterators-c-stl/)来遍历和访问该向量。它类似于[向量数组](https://www.geeksforgeeks.org/array-of-vectors-in-c-stl/)，但具有动态属性。
