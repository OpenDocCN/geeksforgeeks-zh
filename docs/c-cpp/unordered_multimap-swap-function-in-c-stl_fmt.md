# C++ STL 中 unordered_multimap::swap() 函数

> 原文: [https://www.geeksforgeeks.org/unordered_multimap-swap-function-in-c-stl/](https://www.geeksforgeeks.org/unordered_multimap-swap-function-in-c-stl/)

`unordered_multimap::swap()` 是 C++ STL 中的一个内置函数，它交换两个 `unordered_multimap` 容器的内容。两个容器的尺寸可以不同。
...
## 参数
该函数接受单个强制参数 `unordered_multimap_name2`，该参数指定了要与之交换 `unordered_multimap_name1` 的无序多映射。
