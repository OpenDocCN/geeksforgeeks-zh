...
> 原文：[https://www.geeksforgeeks.org/priority_queue-value_type-in-c-stl/](https://www.geeksforgeeks.org/priority_queue-value_type-in-c-stl/)

`priority_queue::value_type`方法是 C++ STL 中的一个内置函数，它表示作为一个元素存储在`priority_queue`中的对象类型。它充当模板参数的同义词。
