...
> 原文：[https://www.geeksforgeeks.org/cpp14-program-to-turn-an-image-by-90-degree/](https://www.geeksforgeeks.org/cpp14-program-to-turn-an-image-by-90-degree/)
...
编写我们的伪代码会很容易。在 C/C++ 中，我们通常按行主顺序遍历矩阵。每行被转换成最终图像的不同列。我们需要构建最终图像的列。请参见以下算法：
