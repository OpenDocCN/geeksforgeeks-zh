...
> 原文: [https://www.geeksforgeeks.org/methods-to-concatenate-string-in-c-c-with-examples/](https://www.geeksforgeeks.org/methods-to-concatenate-string-in-c-c-with-examples/)
...
`init` 和 `add` 字符串应该是字符数组 (`char*`)。该函数将 `add` 字符串连接到 `init` 字符串的末尾。
