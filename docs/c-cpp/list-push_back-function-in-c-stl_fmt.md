...
> 原文: [https://www.geeksforgeeks.org/list-push_back-function-in-c-stl/](https://www.geeksforgeeks.org/list-push_back-function-in-c-stl/)
...
**参数:** 该功能接受单个参数，该参数为强制 `value`。这是指需要添加到列表中的元素，`list_name`。
