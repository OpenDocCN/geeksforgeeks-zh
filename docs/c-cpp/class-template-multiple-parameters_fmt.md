...
> 原文：[https://www.geeksforgeeks.org/class-template-multiple-parameters/](https://www.geeksforgeeks.org/class-template-multiple-parameters/)
...
本文由**萨基提瓦里**供稿。如果你喜欢极客（我们知道你喜欢！）并愿意投稿，也可以使用`contribute.geeksforgeeks.org`写一篇文章或者将文章邮寄到`contribute@geeksforgeeks.org`。看到你的文章出现在极客博客主页上，帮助其他极客。
