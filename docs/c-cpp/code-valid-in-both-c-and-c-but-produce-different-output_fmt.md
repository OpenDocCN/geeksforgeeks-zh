...
> 原文: [https://www.geeksforgeeks.org/code-valid-in-both-c-and-c-but-produce-different-output/](https://www.geeksforgeeks.org/code-valid-in-both-c-and-c-but-produce-different-output/)
...
请注意，当 [`extern`](https://www.geeksforgeeks.org/understanding-extern-keyword-in-c/) 声明放在函数内部时，结果是不同的:那么函数范围内存在同名的标识符会禁止隐式 [`typedef`](https://www.geeksforgeeks.org/typedef-versus-define-c/) 对 C++ 生效，C 和 C++ 的结果也是一样的。还要注意的是，上例中的歧义是由于在 [`sizeof`](https://www.geeksforgeeks.org/sizeof-operator-c/) 运算符中使用了括号。
...
参考: [https://en.wikipedia.org/wiki/Compatibility_of_C_and_C%2B%2B](https://en.wikipedia.org/wiki/Compatibility_of_C_and_C%2B%2B)