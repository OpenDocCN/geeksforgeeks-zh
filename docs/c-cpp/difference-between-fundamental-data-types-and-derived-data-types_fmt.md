...
> 原文：[https://www.geeksforgeeks.org/difference-between-fundamental-data-types-and-derived-data-types/](https://www.geeksforgeeks.org/difference-between-fundamental-data-types-and-derived-data-types/)
...
| 字符用于字符。可以分为字符、有符号字符、无符号字符。 | 指针用于存储变量的地址。 |
