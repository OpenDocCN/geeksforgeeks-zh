...
> 原文: [https://www.geeksforgeeks.org/implicit-type-conversion-in-c-with-examples/](https://www.geeksforgeeks.org/implicit-type-conversion-in-c-with-examples/)

## 前提

[数据类型](https://www.geeksforgeeks.org/data-types-in-c/)，[类型转换](https://www.geeksforgeeks.org/type-conversion-c/)
