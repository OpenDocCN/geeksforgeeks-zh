...
> 原文: [https://www.geeksforgeeks.org/middle-of-three-using-minimum-comparisons/](https://www.geeksforgeeks.org/middle-of-three-using-minimum-comparisons/)
...
```cpp
// CPP program to find middle of three distinct numbers
#include <bits/stdc++.h>
using namespace std;
...
```java
// Java program to find middle of three distinct numbers
import java.util.*;
...
```csharp
// C# program to find middle of three distinct numbers
using System;
...
```php
<?php
// PHP program to find middle of three distinct numbers
