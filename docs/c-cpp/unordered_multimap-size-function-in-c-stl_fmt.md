# C++ STL 中 unordered_multimap::size() 函数

> 原文: [https://www.geeksforgeeks.org/unordered_multimap-size-function-in-c-stl/](https://www.geeksforgeeks.org/unordered_multimap-size-function-in-c-stl/)

`unordered_multimap::size()` 是 C++ STL 中的内置函数，返回 `unordered_multimap` 的大小。它表示容器中元素的数量。
