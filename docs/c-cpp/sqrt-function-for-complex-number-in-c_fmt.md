...
> 原文：[https://www.geeksforgeeks.org/sqrt-function-for-complex-number-in-c/](https://www.geeksforgeeks.org/sqrt-function-for-complex-number-in-c/)

`sqrt()` 函数的复数版本在 `complex` 头文件中定义。该函数用于计算复数 `z` 的平方根，该复数 `z` 具有沿负实轴切割的分支。
