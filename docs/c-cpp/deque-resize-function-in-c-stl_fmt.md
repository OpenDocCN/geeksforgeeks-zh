...
> 原文: [https://www.geeksforgeeks.org/deque-resize-function-in-c-stl/](https://www.geeksforgeeks.org/deque-resize-function-in-c-stl/)

`deque::resize()` 是 C++ STL 中的一个内置函数，它改变了 deque 的大小。
...
该函数只接受一个强制参数 `n`，该参数指定了 deque 的大小。
