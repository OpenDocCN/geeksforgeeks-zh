...
> 原文: [https://www.geeksforgeeks.org/draw-a-line-using-opencv-in-c/](https://www.geeksforgeeks.org/draw-a-line-using-opencv-in-c/)
...
*   `color`: 待画线的颜色。它是一个代表 3 种颜色的元组..(蓝色、绿色、红色)。
*   `thickness`: 所画线条的厚度。
