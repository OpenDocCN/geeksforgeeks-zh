...
> 原文: [https://www.geeksforgeeks.org/cpp-program-to-check-for-majority-element-in-a-sorted-array/](https://www.geeksforgeeks.org/cpp-program-to-check-for-majority-element-in-a-sorted-array/)

## 问题:
写一个函数，找出给定的整数 `x` 在 `n` 个整数的排序数组中出现的次数是否超过 `n/2` 次。
...
## 方法 3:
如果已经给定数组已排序并且存在多数元素，那么检查某个特定元素是否像检查数组的中间元素是否是我们要检查的数字一样简单。
...
更多细节请参考完整的文章[检查排序数组中的多数元素！](https://www.geeksforgeeks.org/check-for-majority-element-in-a-sorted-array/)