...
> 原文：[https://www.geeksforgeeks.org/maximum-value-of-unsigned-short-int-in-c/](https://www.geeksforgeeks.org/maximum-value-of-unsigned-short-int-in-c/)
...
1.  作为无符号数据类型，它只能存储正值。
2.  取 16 位大小。
3.  可以存储在无符号短整型数据类型中的最大整数值通常为 `65535`，位于 `2^16–1` 附近（但与[编译器相关](https://www.geeksforgeeks.org/compile-32-bit-program-64-bit-gcc-c-c/)）。
