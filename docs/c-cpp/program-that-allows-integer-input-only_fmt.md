...
> 原文:[https://www.geeksforgeeks.org/program-that-allows-integer-input-only/](https://www.geeksforgeeks.org/program-that-allows-integer-input-only/)
...
1.  **第 1 步:**用户创建一个名为`getIntegerOnly()`的函数，并将其分配给 `int x`。
