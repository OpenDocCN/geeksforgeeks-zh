...
> 原文：[https://www.geeksforgeeks.org/how-to-convert-c-style-strings-to-stdstring-and-vice-versa/](https://www.geeksforgeeks.org/how-to-convert-c-style-strings-to-stdstring-and-vice-versa/)
...
但是我们为什么需要这种转型呢？从 C 字符串到 `std::string`？这是因为：
...
为什么我们需要这个转换？从 `std::string` 到 C 字符串？
...
C 字符串和 `std::string` 都有各自的优势。一个人应该懂得它们之间的转换，才能轻松有效地解决问题。
