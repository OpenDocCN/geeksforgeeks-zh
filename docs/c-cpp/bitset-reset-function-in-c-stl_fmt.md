...
> 原文: [https://www.geeksforgeeks.org/bitset-reset-function-in-c-stl/](https://www.geeksforgeeks.org/bitset-reset-function-in-c-stl/)
...
该函数接受一个参数 `index`，表示该位必须被重置为零的位置。如果未传递任何参数，位集中的所有位都会重置为零。
