...
> 原文: [https://www.geeksforgeeks.org/draw-a-triangle-in-c-graphics/](https://www.geeksforgeeks.org/draw-a-triangle-in-c-graphics/)
...
**方法:** 想法是借助几条线创建一个三角形。我们将通过向 `line()` 传递 4 个数字来在图形中绘制一条线，函数为:
> `line(a, b, c, d)`
