...
> 原文：[https://www.geeksforgeeks.org/c-cpp-program-to-find-the-size-of-int-float-double-and-char/](https://www.geeksforgeeks.org/c-cpp-program-to-find-the-size-of-int-float-double-and-char/)
...
要找到四个变量的大小：
1.  在 `int`、`char`、`float` 和 `double` 中定义了四种类型的变量。
2.  变量的大小是使用 `sizeof()` 运算符计算的。
