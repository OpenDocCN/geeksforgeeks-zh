...
`std::not_equal_to` 是一个用于非等式比较和二元函数对象类的函数对象类。它根据两个参数是否相等的条件返回一个 [布尔值](https://www.geeksforgeeks.org/bool-data-type-in-c/)。
...
**参考:** [http://www.cplusplus.com/reference/functional/not_equal_to/](http://www.cplusplus.com/reference/functional/not_equal_to/)