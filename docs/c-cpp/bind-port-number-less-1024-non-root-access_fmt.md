...
> 原文：[https://www.geeksforgeeks.org/bind-port-number-less-1024-non-root-access/](https://www.geeksforgeeks.org/bind-port-number-less-1024-non-root-access/)
...
1.  **方法 1**：使用 [`CAP_NET_BIND_SERVICE`](http://man7.org/linux/man-pages/man7/capabilities.7.html) 授予进程的低编号端口访问权限：
    为此，我们只需要在终端运行以下命令：
