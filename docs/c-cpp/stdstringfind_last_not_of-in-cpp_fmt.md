# std::string::find_last_not_of 在 C++ 中

> 原文: [https://www.geeksforgeeks.org/stdstringfind_last_not_of-in-cpp/](https://www.geeksforgeeks.org/stdstringfind_last_not_of-in-cpp/)
...
## 语法 4: 从索引 `idx` 中搜索不是 C 字符串 `cstr` 元素的最后一个字符
