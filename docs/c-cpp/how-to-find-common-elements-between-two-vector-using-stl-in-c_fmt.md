...
> 原文: [https://www.geeksforgeeks.org/how-to-find-common-elements-between-two-vector-using-stl-in-c/](https://www.geeksforgeeks.org/how-to-find-common-elements-between-two-vector-using-stl-in-c/) 在两个向量之间查找公共元素
...
借助 STL 中提供的 `set_intersection()` 函数，可以找到常用元素。
