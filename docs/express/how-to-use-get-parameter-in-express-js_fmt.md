...
> 原文: [https://www.geeksforgeeks.org/how-to-use-get-parameter-in-express-js/](https://www.geeksforgeeks.org/how-to-use-get-parameter-in-express-js/)
...
您可以在命令行上使用以下命令运行您的 express 服务器。
...
打开浏览器转到 `http://localhost:3000`，手动切换到 `http://localhost:3000/some_id` 会看到如下输出。
