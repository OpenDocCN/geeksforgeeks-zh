...
> 原文: [https://www.geeksforgeeks.org/express-js-res-sendfile-function/](https://www.geeksforgeeks.org/express-js-res-sendfile-function/)
...
### 参数:
`path` 参数描述路径，`options` 参数包含 `maxAge`、`root`` 等各种属性，`fn` 为回调函数。
...
### 参考:
[https://expressjs.com/en/5x/api.html#res.sendFile](https://expressjs.com/en/5x/api.html#res.sendFile)