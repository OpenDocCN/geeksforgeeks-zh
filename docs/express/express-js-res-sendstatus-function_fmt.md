...
> 原文: [https://www.geeksforgeeks.org/express-js-res-sendstatus-function/](https://www.geeksforgeeks.org/express-js-res-sendstatus-function/)

`res.sendStatus()` 函数用于将响应 HTTP 状态代码设置为 `statusCode`，并将其字符串表示作为响应体发送。
...
## 参考
[https://expressjs.com/en/5x/api.html#res.sendStatus](https://expressjs.com/en/5x/api.html#res.sendStatus)