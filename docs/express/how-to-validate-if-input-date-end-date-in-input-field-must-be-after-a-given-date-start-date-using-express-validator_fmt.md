...
> 原文: [https://www.geeksforgeeks.org/how-to-validate-if-input-date-end-date-in-input-field-must-be-after-a-given-date-start-date-using-express-validator/](https://www.geeksforgeeks.org/how-to-validate-if-input-date-end-date-in-input-field-must-be-after-a-given-date-start-date-using-express-validator/)
...
**文件名 – `form.js`:** 该文件包含显示表单的逻辑，以提交带有开始和结束日期的项目数据。
...
**文件名 – `validator.js`:** 该文件包含所有验证逻辑(验证输入字段的逻辑，只接受给定日期之后的日期)。
...
**注意:** 我们在 `register.js` 文件中使用了一些布尔玛类(CSS 框架)来设计内容。