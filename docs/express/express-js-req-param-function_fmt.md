...
> 原文: [https://www.geeksforgeeks.org/express-js-req-param-function/](https://www.geeksforgeeks.org/express-js-req-param-function/)
...
5.  现在向 `http://localhost:3000?title=GeeksforGeeks` 发出 GET 请求，然后您将在控制台上看到以下输出:
...
现在向 `http://localhost:3000?title=GeeksforGeeks&domain=CS` 发出 GET 请求，然后您将在控制台上看到以下输出:
