...
> 原文: [https://www.geeksforgeeks.org/express-js-res-links-function/](https://www.geeksforgeeks.org/express-js-res-links-function/)

`res.links()` 函数用于连接作为参数属性提供的链接，以填充响应的 `Link` HTTP 头字段。
...
5.  现在打开浏览器，转到 `http://localhost:3000/` ，现在检查你的控制台，你会看到如下输出:
...
[https://expressjs.com/en/5x/api.html#res.links](https://expressjs.com/en/5x/api.html#res.links)