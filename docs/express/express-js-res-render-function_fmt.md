...
> 原文:[https://www.geeksforgeeks.org/express-js-res-render-function/](https://www.geeksforgeeks.org/express-js-res-render-function/)

`res.render()`函数用于渲染视图，并将渲染后的HTML字符串发送给客户端。
...
[https://expressjs.com/en/5x/api.html#res.render](https://expressjs.com/en/5x/api.html#res.render)