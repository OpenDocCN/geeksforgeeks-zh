...
> 原文: [https://www.geeksforgeeks.org/how-to-validate-if-input-in-input-field-exactly-equals-to-some-other-value-using-express-validator/](https://www.geeksforgeeks.org/how-to-validate-if-input-in-input-field-exactly-equals-to-some-other-value-using-express-validator/)
...
该文件包含所有的验证逻辑(验证输入字段只允许某些精确值的逻辑)。
