...
默认编码为 `'utf8'`，`data` 参数基本上是用户想要结束响应的数据。
...
5.  现在打开浏览器，转到 `http://localhost:3000/` 会看到空白响应，因为这个函数是用来快速结束没有任何数据的响应。
...
[https://expressjs.com/en/4x/api.html#res.end](https://expressjs.com/en/4x/api.html#res.end)