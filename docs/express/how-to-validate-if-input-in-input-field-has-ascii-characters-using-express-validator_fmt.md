...
> 原文: [https://www.geeksforgeeks.org/how-to-validate-if-input-in-input-field-has-ascii-characters-using-express-validator/](https://www.geeksforgeeks.org/how-to-validate-if-input-in-input-field-has-ascii-characters-using-express-validator/)
...
该文件包含所有验证逻辑（验证输入字段只接受 ascii 字符的逻辑）。
