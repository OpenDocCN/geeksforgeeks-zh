...
> 原文: [https://www.geeksforgeeks.org/express-js-router-use-function/](https://www.geeksforgeeks.org/express-js-router-use-function/)
...
4.  现在打开您的浏览器并访问 `http://localhost:3000/user`，您可以在屏幕上看到以下输出:
