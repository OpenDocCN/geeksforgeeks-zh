...
### 第 4 步
用以下代码创建一个 `index1.js` 文件。我们正在使用端口 3000。我们目前正在发送一个简单的消息，表示第一个应用程序。
...
### 第 6 步
用以下代码创建一个 `index2.js` 文件。我们正在使用端口 4000。我们目前正在发送一条简单的消息，表示第二个应用程序。
