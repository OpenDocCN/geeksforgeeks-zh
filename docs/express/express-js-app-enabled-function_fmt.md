...
> 原文: [https://www.geeksforgeeks.org/express-js-app-enabled-function/](https://www.geeksforgeeks.org/express-js-app-enabled-function/)

`app.enabled()` 功能用于返回设置 `name` 的布尔值。
