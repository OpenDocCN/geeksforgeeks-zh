...
> 原文: [https://www.geeksforgeeks.org/how-to-validate-if-input-date-start-date-in-input-field-must-be-before-a-given-date-end-date-using-express-validator/](https://www.geeksforgeeks.org/how-to-validate-if-input-date-start-date-in-input-field-must-be-before-a-given-date-end-date-using-express-validator/)
...
**文件名 – `validator.js`:** 该文件包含所有验证逻辑(验证输入字段的逻辑，只接受给定日期之前的日期)。
