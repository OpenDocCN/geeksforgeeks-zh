...
> 原文: [https://www.geeksforgeeks.org/express-js-app-param-function/](https://www.geeksforgeeks.org/express-js-app-param-function/)
...
这就是如何使用 `express` 的 `app.param()` 函数添加回调触发器来路由参数。