...
> 原文: [https://www.geeksforgeeks.org/express-js-res-location-function/](https://www.geeksforgeeks.org/express-js-res-location-function/)

## 功能介绍

`res.location()` 函数用于将响应位置 HTTP 头设置为指定的路径参数。基本上是用来设置响应头的。它不会结束响应，在使用它之后，如果你想写，你可以写一个响应体。
