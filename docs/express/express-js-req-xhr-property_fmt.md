...
4.  现在向 `http://localhost:3000` 发出 GET 请求。
...
现在打开浏览器，向 `http://localhost:3000` 发出 GET 请求，现在可以在屏幕上看到如下输出:
...
[https://expressjs.com/en/4x/api.html#req.xhr](https://expressjs.com/en/4x/api.html#req.xhr)