...
> 原文：[https://www.geeksforgeeks.org/how-to-validate-if-input-in-input-field-has-hexadecimal-number-only-using-express-validator/](https://www.geeksforgeeks.org/how-to-validate-if-input-in-input-field-has-hexadecimal-number-only-using-express-validator/)
...
该文件包含所有验证逻辑（验证输入字段只允许十六进制数字的逻辑）。
