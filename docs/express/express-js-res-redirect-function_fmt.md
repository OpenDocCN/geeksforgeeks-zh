...
> 原文: [https://www.geeksforgeeks.org/express-js-res-redirect-function/](https://www.geeksforgeeks.org/express-js-res-redirect-function/)
...
现在打开浏览器，转到 `http://localhost:3000/verify`，现在检查你的控制台，你会看到如下输出:
