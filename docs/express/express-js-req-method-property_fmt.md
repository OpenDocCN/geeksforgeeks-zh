...
> 原文: [https://www.geeksforgeeks.org/express-js-req-method-property/](https://www.geeksforgeeks.org/express-js-req-method-property/)
...
## 输出:
现在打开浏览器，向 `http://localhost:3000/user` 发出 POST 请求，现在可以在控制台上看到如下输出:
...
## 参考:
[https://expressjs.com/en/4x/api.html#req.method](https://expressjs.com/en/4x/api.html#req.method)