...
> 原文: [https://www.geeksforgeeks.org/express-js-res-append-function/](https://www.geeksforgeeks.org/express-js-res-append-function/)

`res.append()`函数将指定的值追加到HTTP响应头字段中，如果还没有设置头，则使用指定的值创建头。
...
**参数:** `field`参数描述需要追加的字段名称，`value`参数可以是字符串，也可以是数组。
**返回:** 返回一个对象。
