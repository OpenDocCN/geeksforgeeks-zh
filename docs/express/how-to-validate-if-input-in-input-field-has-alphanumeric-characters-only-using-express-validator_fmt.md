...
> 原文: [https://www.geeksforgeeks.org/how-to-validate-if-input-in-input-field-has-alphanumeric-characters-only-using-express-validator/](https://www.geeksforgeeks.org/how-to-validate-if-input-in-input-field-has-alphanumeric-characters-only-using-express-validator/)
...
该文件包含所有验证逻辑(验证输入字段只允许字母数字字符的逻辑)。
...
**注意:** 我们在 `signup.js` 文件中使用了一些布尔玛类(CSS 框架)来设计内容。