...
> 原文: [https://www.geeksforgeeks.org/express-js-req-stale-property/](https://www.geeksforgeeks.org/express-js-req-stale-property/)

`req.stale`属性表示传入的请求是否为*stale*，该属性与`req.fresh`属性相反。
...
现在打开浏览器，向`http://localhost:3000/user`发出 GET 请求，现在屏幕上可以看到如下输出:
