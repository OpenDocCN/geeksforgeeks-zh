...
> 原文: [https://www.geeksforgeeks.org/how-to-validate-if-input-in-input-field-has-full-width-string-only-using-express-validator/](https://www.geeksforgeeks.org/how-to-validate-if-input-in-input-field-has-full-width-string-only-using-express-validator/)
...
*   通过验证输入验证输入:检查(`输入字段名`)和验证链是带“.”的 `width()`
