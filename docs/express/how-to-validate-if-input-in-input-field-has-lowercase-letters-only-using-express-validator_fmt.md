...
> 原文: [https://www.geeksforgeeks.org/how-to-validate-if-input-in-input-field-has-lowercase-letters-only-using-express-validator/](https://www.geeksforgeeks.org/how-to-validate-if-input-in-input-field-has-lowercase-letters-only-using-express-validator/)
...
*   通过 `validateInputField` 验证输入: `check('inputFieldName')` 和带有“.”的验证链。
