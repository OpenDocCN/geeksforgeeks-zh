...
> 原文: [https://www.geeksforgeeks.org/express-js-req-acceptslanguages-function/](https://www.geeksforgeeks.org/express-js-req-acceptslanguages-function/)

`request.acceptsLanguages()` 函数根据请求的 Accept-Language HTTP 头字段返回指定语言的第一个被接受的语言，如果没有指定语言被接受，则返回 `false`。
...
[https://expressjs.com/en/4x/api.html#req.acceptsLanguages](https://expressjs.com/en/4x/api.html#req.acceptsLanguages)