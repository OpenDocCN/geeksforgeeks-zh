...
> 原文: [https://www.geeksforgeeks.org/how-to-return-favicon-ico-as-req-url-in-expressjs/](https://www.geeksforgeeks.org/how-to-return-favicon-ico-as-req-url-in-expressjs/)
...
在 `main.js` 中运行 Node.js:在终端中运行 `node main.js`。刚开始就结束了；我们做了一个服务器，但没有激活它。
