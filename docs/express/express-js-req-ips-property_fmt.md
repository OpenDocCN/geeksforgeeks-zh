...
考虑上面的代码，但是这次向 `http://localhost:3000/` 发出 GET 请求，标头设置为 `x-forward-for:203.0.113.195, 70.41.3.18, 150.172.238.178`，现在您可以在控制台上看到以下输出:
...
[https://expressjs.com/en/4x/api.html#req.ips](https://expressjs.com/en/4x/api.html#req.ips)