...
> 原文: [https://www.geeksforgeeks.org/how-to-validate-if-input-in-input-field-is-a-valid-date-using-express-validator/](https://www.geeksforgeeks.org/how-to-validate-if-input-in-input-field-is-a-valid-date-using-express-validator/)
...
*   通过 `validateInputField` 验证输入：`check(输入字段名)` 和带有“.”的验证 `isDate()` 上的链。
