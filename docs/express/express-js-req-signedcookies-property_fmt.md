...
> 原文: [https://www.geeksforgeeks.org/express-js-req-signedcookies-property/](https://www.geeksforgeeks.org/express-js-req-signedcookies-property/)

`req.signedCookies` 属性包含由请求发送的签名 cookie，未签名，并且在使用 `cookie-parser` 中间件时可以使用。
...
2.  使用以下命令确保您已经安装了 `express` 和 `cookie-parser` 模块:
...
[https://expressjs.com/en/4x/api.html#req.signedCookies](https://expressjs.com/en/4x/api.html#req.signedCookies)