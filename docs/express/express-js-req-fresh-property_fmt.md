...
> 原文: [https://www.geeksforgeeks.org/express-js-req-fresh-property/](https://www.geeksforgeeks.org/express-js-req-fresh-property/)
...
考虑上面的代码，但是这次，在 Header 设置为 `Cache-Control: no-cache` 的情况下，向 `http://localhost:3000/` 发出 GET 请求，现在您可以在控制台上看到以下输出:
