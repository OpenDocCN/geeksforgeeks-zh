...
> 原文：[https://www.geeksforgeeks.org/how-to-validate-if-input-in-input-field-is-a-valid-credit-card-number-using-express-validator/](https://www.geeksforgeeks.org/how-to-validate-if-input-in-input-field-is-a-valid-credit-card-number-using-express-validator/)
...
该文件包含所有验证逻辑（用于验证输入字段以仅允许有效信用卡号的逻辑）。
...
![数据库ˌ资料库](img/bd5611556bf16d6d713a27cc919cd266.png)

## 输出

![尝试使用无效卡号提交表格（不遵循 luhn 公式）](img/5233659064993b6835d901c936fd7ecc.png)

![尝试使用无效的卡号提交表格（不遵循 luhn 公式，也没有以数字 9 开头的信用卡）](img/ba3436942113ec18bf524d094dfc15df.png)

![尝试提交卡号无效的表格时的响应](img/7dc3b102b4eb9689bab6406fac2dcccc.png)

![尝试使用有效的卡号提交表格（遵循 luhn 公式）](img/384338fd32efe85f4f1930c8186420f7.png)

![尝试使用有效卡号提交表格时的回应](img/ec3aac4fb2bc03193ff633050ffa309c.png)

## 成功提交表单后的数据库

![成功提交表单后的数据库](img/080315196a477fede87d263dafa6f1b9.png)
