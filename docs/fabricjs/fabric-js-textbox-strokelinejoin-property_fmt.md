...
> 原文: [https://www.geeksforgeeks.org/fabric-js-textbox-strokelinejoin-property/](https://www.geeksforgeeks.org/fabric-js-textbox-strokelinejoin-property/)
...
本示例使用 FabricJS 设置 `strokeLineJoin` 属性的值。
