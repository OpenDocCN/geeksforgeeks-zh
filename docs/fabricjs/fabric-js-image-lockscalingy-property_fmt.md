...
> 原文: [https://www.geeksforgeeks.org/fabric-js-image-lockscalingy-property/](https://www.geeksforgeeks.org/fabric-js-image-lockscalingy-property/)
...
*   之后，初始化一个由 Fabric 提供的 `Canvas` 和 `image` 类的实例，并使用 `lockScalingY` 属性用来锁定垂直缩放。
*   之后，在画布上渲染图像。
