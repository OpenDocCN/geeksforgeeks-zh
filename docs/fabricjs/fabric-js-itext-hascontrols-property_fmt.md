...
> 原文: [https://www.geeksforgeeks.org/fabric-js-itext-hascontrols-property/](https://www.geeksforgeeks.org/fabric-js-itext-hascontrols-property/)
...
本示例使用 FabricJS 设置画布 `Itext` 的 `hasControls` 属性。
