# Fabric.js 文本框 left 属性

> 原文: [https://www.geeksforgeeks.org/fabric-js-textbox-left-property/](https://www.geeksforgeeks.org/fabric-js-textbox-left-property/)
...
本示例使用 FabricJS 在画布文本框上设置 `left` 属性。
