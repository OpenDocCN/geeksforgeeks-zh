...
> 原文: [https://www.geeksforgeeks.org/fabric-js-image-lockscalingx-property/](https://www.geeksforgeeks.org/fabric-js-image-lockscalingx-property/)
...
*   `lockScalingX`: 该参数取一个布尔值来锁定水平缩放。

## 示例

本示例使用 FabricJS 设置画布图像的 `lockScalingX` 属性，如下例所示:
