...
> 原文：[https://www.geeksforgeeks.org/fabric-js-polygon-originx-property/](https://www.geeksforgeeks.org/fabric-js-polygon-originx-property/)
...
下面的例子说明了 `Fabric.js` 中的 `Polygon` `originX` 属性：
