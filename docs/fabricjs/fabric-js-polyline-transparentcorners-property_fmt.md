...
> 原文：[https://www.geeksforgeeks.org/fabric-js-polyline-transparentcorners-property/](https://www.geeksforgeeks.org/fabric-js-polyline-transparentcorners-property/)

在本文中，我们将看到如何使用 `FabricJS` 设置画布 `Polyline` 的角可见性。画布意味着折线是可移动的，可以根据需要拉伸。此外，当涉及到初始笔画颜色、填充颜色、笔画宽度或半径时，可以对圆进行自定义。
