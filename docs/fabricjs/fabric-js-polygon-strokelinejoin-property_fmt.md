...
> 原文: [https://www.geeksforgeeks.org/fabric-js-polygon-strokelinejoin-property/](https://www.geeksforgeeks.org/fabric-js-polygon-strokelinejoin-property/)
...
*   **strokeLineJoin**: 对象笔划的角样式（`"bevel"`、`"round"`、`"miter"` 之一）
...
以下示例说明了 `Fabric.js` 多边形 `strokeLineJoin` 在 JavaScript 中。
