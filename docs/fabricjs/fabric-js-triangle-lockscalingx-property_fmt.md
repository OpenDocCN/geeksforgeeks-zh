...
> 原文: [https://www.geeksforgeeks.org/fabric-js-triangle-lockscalingx-property/](https://www.geeksforgeeks.org/fabric-js-triangle-lockscalingx-property/)
...
该示例使用 FabricJS 锁定画布三角形的水平缩放，如下所示。
