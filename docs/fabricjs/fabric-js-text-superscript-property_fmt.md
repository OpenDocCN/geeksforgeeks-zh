...
> 原文: [https://www.geeksforgeeks.org/fabric-js-text-superscript-property/](https://www.geeksforgeeks.org/fabric-js-text-superscript-property/)
...
<head>
    <script src="https://github.com/denim2x/fabric.js/releases/download/v2.0.0-beta.6/fabric.min.js">
    </script>
</head>
...
[http://fabricjs.com/docs/fabric.Text.html#superscript](http://fabricjs.com/docs/fabric.Text.html#superscript)