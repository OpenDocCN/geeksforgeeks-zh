...
> 原文: [https://www.geeksforgeeks.org/fabric-js-textbox-fill-property/](https://www.geeksforgeeks.org/fabric-js-textbox-fill-property/)
...
这里我们使用 FabricJS 设置画布 Textbox 的填充颜色。
