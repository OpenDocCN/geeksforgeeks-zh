# Fabric.js | Triangle lockMovementX 属性

> 原文: [https://www.geeksforgeeks.org/fabric-js-triangle-lockmovementx-property/](https://www.geeksforgeeks.org/fabric-js-triangle-lockmovementx-property/)
...
本示例使用 `FabricJS` 锁定画布三角形的水平移动，如下所示。
