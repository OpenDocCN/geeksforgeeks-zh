...
> 原文: [https://www.geeksforgeeks.org/fabric-js-group-strokeuniform-property/](https://www.geeksforgeeks.org/fabric-js-group-strokeuniform-property/)

在本文中，我们将看到如何使用 `Fabric.js` 设置一组画布的 `strokeUniform`。`Fabric.js` 中的组是活动的，可以根据需要拉伸。此外，当涉及到初始笔画颜色、高度、宽度、填充颜色或笔画宽度时，可以定制该组。
