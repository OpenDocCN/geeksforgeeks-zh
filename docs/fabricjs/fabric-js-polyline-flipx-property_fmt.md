...
> 原文: [https://www.geeksforgeeks.org/fabric-js-polyline-flipx-property/](https://www.geeksforgeeks.org/fabric-js-polyline-flipx-property/)
...
下面的例子说明了 Fabric.js 中的 `flipX` 属性:
