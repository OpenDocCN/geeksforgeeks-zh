...
> 原文: [https://www.geeksforgeeks.org/fabric-js-ellipse-strokedashoffset-property/](https://www.geeksforgeeks.org/fabric-js-ellipse-strokedashoffset-property/)
...
本示例使用 FabricJS 库将笔画虚线偏移设置为画布椭圆，如下所示。
