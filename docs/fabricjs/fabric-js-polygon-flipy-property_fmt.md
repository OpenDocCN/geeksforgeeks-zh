...
> 原文：[https://www.geeksforgeeks.org/fabric-js-polygon-flipy-property/](https://www.geeksforgeeks.org/fabric-js-polygon-flipy-property/)
...
下面的例子说明了 Fabric.js 中的多边形 `flipY` 属性：
