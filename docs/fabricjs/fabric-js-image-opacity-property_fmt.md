...
> 原文: [https://www.geeksforgeeks.org/fabric-js-image-opacity-property/](https://www.geeksforgeeks.org/fabric-js-image-opacity-property/)
...
本示例使用 `FabricJS` 设置画布图像的不透明度，如下例所示。
