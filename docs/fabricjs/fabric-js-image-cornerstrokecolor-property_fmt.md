...
> 原文: [https://www.geeksforgeeks.org/fabric-js-image-cornerstrokecolor-property/](https://www.geeksforgeeks.org/fabric-js-image-cornerstrokecolor-property/)
...
3.  之后，初始化一个由 Fabric.js 提供的 `Canvas` 和 `image` 类的实例，并使用 `cornerStrokeColor` 属性来设置角的颜色。
4.  之后，在画布上渲染图像。
