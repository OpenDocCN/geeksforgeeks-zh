...
> 原文：[https://www.geeksforgeeks.org/fabric-js-textbox-inverted-property/](https://www.geeksforgeeks.org/fabric-js-textbox-inverted-property/)
...
本示例使用 Fabric.js 设置画布 Textbox 的反转属性。
