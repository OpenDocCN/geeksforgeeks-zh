...
> 原文: [https://www.geeksforgeeks.org/fabric-js-textbox-cursorduration-property/](https://www.geeksforgeeks.org/fabric-js-textbox-cursorduration-property/)
...
*   `cursorDuration`: 以毫秒为单位指定光标淡入的持续时间。

## 示例

本示例使用 Fabric.js 设置 Textbox 的光标持续时间。
