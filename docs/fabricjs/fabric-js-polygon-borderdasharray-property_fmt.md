...
> 原文: [https://www.geeksforgeeks.org/fabric-js-polygon-borderdasharray-property/](https://www.geeksforgeeks.org/fabric-js-polygon-borderdasharray-property/)
...
给出正确的尺寸像素是创建多边形的必要条件。

下面的例子说明了 Fabric.js 中的 `Polygon` `borderDashArray` 属性:
