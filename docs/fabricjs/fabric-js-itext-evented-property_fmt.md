# Fabric.js Itext evented 属性

> 原文：[https://www.geeksforgeeks.org/fabric-js-itext-evented-property/](https://www.geeksforgeeks.org/fabric-js-itext-evented-property/)
...
本示例使用 FabricJS 设置画布 Itext 的 `evented` 属性，如下例所示：
