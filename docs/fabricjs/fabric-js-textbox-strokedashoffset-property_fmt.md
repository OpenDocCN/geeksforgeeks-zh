...
> 原文: [https://www.geeksforgeeks.org/fabric-js-textbox-strokedashoffset-property/](https://www.geeksforgeeks.org/fabric-js-textbox-strokedashoffset-property/)
...
本示例使用 `fabricjs` 库设置画布文本框的笔画虚线偏移，如下所示。
