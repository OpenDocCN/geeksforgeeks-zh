...
> 原文: [https://www.geeksforgeeks.org/fabric-js-textbox-editable-property/](https://www.geeksforgeeks.org/fabric-js-textbox-editable-property/)
...
*   `可编辑`: 指定文本框的编辑模式。值为`真`使文本框可编辑，值为`假`禁用编辑。
