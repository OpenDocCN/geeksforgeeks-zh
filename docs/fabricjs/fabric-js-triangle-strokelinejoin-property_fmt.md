...
> 原文: [https://www.geeksforgeeks.org/fabric-js-triangle-strokelinejoin-property/](https://www.geeksforgeeks.org/fabric-js-triangle-strokelinejoin-property/)
...
*   `宽度`: 指定三角形的宽度。
*   `高度`: 指定三角形的高度。
*   `strokeLineJoin`: 指定画布对象笔画的角样式。此参数的可接受值为 `斜角`、`圆角` 和 `斜接`。

## 示例

本示例使用 FabricJS 设置画布 `triangle.html` 的 `strokeLineJoin` 属性。
