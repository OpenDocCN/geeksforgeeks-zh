# Fabric.js Ellipse paintFirst 属性

> 原文：[https://www.geeksforgeeks.org/fabric-js-ellipse-paintfirst-property/](https://www.geeksforgeeks.org/fabric-js-ellipse-paintfirst-property/)
...
本示例使用 FabricJS 设置画布椭圆的 `paintFirst` 属性。
