...
> 原文: [https://www.geeksforgeeks.org/fabric-js-image-touchcornersize-property/](https://www.geeksforgeeks.org/fabric-js-image-touchcornersize-property/)
...
本示例使用 FabricJS 设置画布图像的 `touchCornerSize` 属性，如下例所示:
