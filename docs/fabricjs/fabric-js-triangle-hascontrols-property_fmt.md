# Fabric.js | Triangle `hasControls` 属性

> 原文: [https://www.geeksforgeeks.org/fabric-js-triangle-hascontrols-property/](https://www.geeksforgeeks.org/fabric-js-triangle-hascontrols-property/)
...
该示例使用 FabricJS 禁用画布三角形的控件，如下所示。请注意，您必须单击对象才能看到控件。
