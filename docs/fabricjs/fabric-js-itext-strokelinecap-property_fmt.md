...
> 原文: [https://www.geeksforgeeks.org/fabric-js-itext-strokelinecap-property/](https://www.geeksforgeeks.org/fabric-js-itext-strokelinecap-property/)
...
本示例使用 Fabric.js 设置画布 Itext 的 `strokeLineCap` 属性。
