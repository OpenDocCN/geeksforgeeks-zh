...
> 原文: [https://www.geeksforgeeks.org/fabric-js-polyline-excludefromexport-property/](https://www.geeksforgeeks.org/fabric-js-polyline-excludefromexport-property/)
...
*   **excludeFromExport:** 当为 `true` 时，对象不在 OBJECT/JSON 中导出。
