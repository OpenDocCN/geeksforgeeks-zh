...
> 原文: [https://www.geeksforgeeks.org/fabric-js-image-strokeuniform-property/](https://www.geeksforgeeks.org/fabric-js-image-strokeuniform-property/)

在本文中，我们将看到如何设置统一的笔画宽度图像。`fabric.Image` 是用于创建图像实例的 `fabric.js` 类之一。画布图像意味着图像是可移动的，可以根据需要拉伸。`strokeUniform` 用于锁定统一笔划。
...
*   `strokeUniform`: 该参数取布尔值，锁定画布图像的均匀描边。
