# Fabric.js Group strokeLineJoin 属性

> 原文: [https://www.geeksforgeeks.org/fabric-js-group-strokelinejoin-property/](https://www.geeksforgeeks.org/fabric-js-group-strokelinejoin-property/)

## 简介

在本文中，我们将看到如何使用 `Fabric.js` 设置画布的组的 `strokeLineJoin`。`Fabric.js` 中的组是可移动的，可以根据需要拉伸。此外，当涉及到初始笔画颜色、高度、宽度、填充颜色或笔画宽度时，可以自定义该组。
...
*   `strokeLineJoin`: 对象笔划的角样式（`"miter"`、`"round"`、`"bevel"` 之一）
