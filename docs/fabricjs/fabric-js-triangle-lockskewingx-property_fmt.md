...
> 原文：[`https://www.geeksforgeeks.org/fabric-js-triangle-lockskewingx-property/`](https://www.geeksforgeeks.org/fabric-js-triangle-lockskewingx-property/)
...
本示例使用 FabricJS 设置画布三角形的水平倾斜，如下所示。
