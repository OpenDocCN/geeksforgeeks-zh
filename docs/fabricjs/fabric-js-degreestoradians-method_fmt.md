# Fabric.js degreesToRadians()方法

> 原文：[https://www.geeksforgeeks.org/fabric-js-degreestoradians-method/](https://www.geeksforgeeks.org/fabric-js-degreestoradians-method/)

`degreesToRadians()`方法用于将指定度数的值转换为其对应的弧度值。
