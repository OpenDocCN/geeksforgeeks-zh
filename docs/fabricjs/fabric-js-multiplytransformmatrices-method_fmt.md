...
> 原文: [https://www.geeksforgeeks.org/fabric-js-multiplytransformmatrices-method/](https://www.geeksforgeeks.org/fabric-js-multiplytransformmatrices-method/)

`multiplyTransformMatrices()` 方法用于将两个指定的矩阵相乘以实现嵌套变换。例如，如果函数为 `multiplyTransformMatrices(a, b)`，则表示矩阵 `a` 将乘以矩阵 `b`。
...
*   `a`: 该参数保存第一个指定的变换矩阵。
*   `b`: 此参数保存第二个指定的变换矩阵。
*   `is2x2`: 该参数为布尔值，保存将矩阵相乘为 2×2 矩阵的标志。
...
<body>
  <script type="text/javascript">
    ...
    console.log(fabric.util.multiplyTransformMatrices([1, 2, 3, 4], [5, 6, 7, 8]));
    console.log(fabric.util.multiplyTransformMatrices([1, 2, 3, 4], [5, 6, 7, 8], true));
    console.log(fabric.util.multiplyTransformMatrices([1, 2, 3, 4], [5, 6, 7, 8], false));
  </script>
</body>
