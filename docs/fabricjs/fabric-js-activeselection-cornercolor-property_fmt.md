...
> 原文: [https://www.geeksforgeeks.org/fabric-js-activeselection-cornercolor-property/](https://www.geeksforgeeks.org/fabric-js-activeselection-cornercolor-property/)

Fabric.js 是一个用于处理画布的 JavaScript 库。画布 `ActiveSelection` 是用于创建活动选择实例的 Fabric.js 类之一。画布活动选择意味着活动选择是可移动的，可以根据需要拉伸。在本文中，我们将使用 `cornerColor` 属性来设置画布角的颜色。
