...
> 原文: [https://www.geeksforgeeks.org/fabric-js-text-strokedasharray-property/](https://www.geeksforgeeks.org/fabric-js-text-strokedasharray-property/)
...
本示例使用 FabricJS 向文本画布添加描边虚线图案，如下所示。
