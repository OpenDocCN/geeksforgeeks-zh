...
> 原文: [https://www.geeksforgeeks.org/fabric-js-rect-cornerdasharray-property/](https://www.geeksforgeeks.org/fabric-js-rect-cornerdasharray-property/)
...
该示例使用 FabricJS 设置一个虚线模式来控制画布状矩形的角，如下所示。你必须点击对象才能看到控制角的虚线图案。
