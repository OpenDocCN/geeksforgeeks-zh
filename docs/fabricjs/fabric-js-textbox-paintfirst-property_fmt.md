...
> 原文：[https://www.geeksforgeeks.org/fabric-js-textbox-paintfirst-property/](https://www.geeksforgeeks.org/fabric-js-textbox-paintfirst-property/)
...
本示例使用 FabricJS 设置画布文本框的 `paintFirst` 属性。
