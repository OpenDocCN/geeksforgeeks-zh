...
> 原文: [https://www.geeksforgeeks.org/fabric-js-itext-selectionbackgroundcolor-property/](https://www.geeksforgeeks.org/fabric-js-itext-selectionbackgroundcolor-property/)
...
*   `selectionBackgroundColor`: 该参数取一个字符串值。
