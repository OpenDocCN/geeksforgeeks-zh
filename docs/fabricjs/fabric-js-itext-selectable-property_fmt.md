...
> 原文: [https://www.geeksforgeeks.org/fabric-js-itext-selectable-property/](https://www.geeksforgeeks.org/fabric-js-itext-selectable-property/)
...
**方法:** 首先导入 fabric.js 库。导入库后，在主体标签中创建一个包含 Itext 的画布块。之后，初始化一个由 Fabric.js 提供的 `Canvas` 和 `Itext` 类的实例，并使用 `selectable` 属性来禁用可选性。
