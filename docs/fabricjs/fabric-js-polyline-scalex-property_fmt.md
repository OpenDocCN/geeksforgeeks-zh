...
> 原文: [https://www.geeksforgeeks.org/fabric-js-polyline-scalex-property/](https://www.geeksforgeeks.org/fabric-js-polyline-scalex-property/)
...
下面的例子说明了 `Fabric.js` 中的 `scaleX` 属性:
