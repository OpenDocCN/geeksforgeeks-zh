...
> 原文: [https://www.geeksforgeeks.org/fabric-js-textbox-cornercolor-property/](https://www.geeksforgeeks.org/fabric-js-textbox-cornercolor-property/)
...
本示例使用 Fabric.js 更改画布 Textbox 的控制角颜色。请注意，您必须单击对象才能看到颜色。
