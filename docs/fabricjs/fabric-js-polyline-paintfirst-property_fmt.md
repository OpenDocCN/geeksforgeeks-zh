# Fabric.js 折线绘制 paintFirst 属性

> 原文: [https://www.geeksforgeeks.org/fabric-js-polyline-paintfirst-property/](https://www.geeksforgeeks.org/fabric-js-polyline-paintfirst-property/)
...
*   **paintFirst:** 它定义首先绘制填充或描边（填充或描边之一）。
