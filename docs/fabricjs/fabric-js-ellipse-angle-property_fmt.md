...
> 原文: [https://www.geeksforgeeks.org/fabric-js-ellipse-angle-property/](https://www.geeksforgeeks.org/fabric-js-ellipse-angle-property/)
...
本示例使用 FabricJS 启用画布状椭圆的角度，如下所示。
