...
> 原文: [https://www.geeksforgeeks.org/fabric-js-circle-willdrawshadow-method/](https://www.geeksforgeeks.org/fabric-js-circle-willdrawshadow-method/)
...
本示例使用 `FabricJS` 设置画布圆的 `willDrawShadow()` 方法，如下例所示。
...
[http://fabricjs.com/docs/fabric.Circle.html#willDrawShadow](http://fabricjs.com/docs/fabric.Circle.html#willDrawShadow)