...
> 原文: [https://www.geeksforgeeks.org/fabric-js-itext-flipx-property/](https://www.geeksforgeeks.org/fabric-js-itext-flipx-property/)
...
本示例使用 FabricJS 设置画布 Itext 的 `flipX` 属性，如下例所示:
