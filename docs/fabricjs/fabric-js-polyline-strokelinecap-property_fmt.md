...
> 原文: [https://www.geeksforgeeks.org/fabric-js-polyline-strokelinecap-property/](https://www.geeksforgeeks.org/fabric-js-polyline-strokelinecap-property/)

在本文中，我们将看到如何使用 `FabricJS` 设置画布折线的 `strokeLineCap`，它用于填充对象。画布折线意味着折线是可移动的，可以根据需要拉伸。此外，在初始描边颜色、高度、宽度、填充颜色或描边宽度方面，可以自定义折线。
...
*   `strokeLineCap`: 对象笔画的线条结束样式（“butt”、“round”、“square”之一）
