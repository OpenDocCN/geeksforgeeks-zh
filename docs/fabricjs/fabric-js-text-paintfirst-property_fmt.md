...
> 原文: [https://www.geeksforgeeks.org/fabric-js-text-paintfirst-property/](https://www.geeksforgeeks.org/fabric-js-text-paintfirst-property/)
...
以下示例说明了 `Fabric.js` 中 `paintFirst` 属性的使用:
