...
> 原文: [https://www.geeksforgeeks.org/fabric-js-textbox-selectionbackgroundcolor-property/](https://www.geeksforgeeks.org/fabric-js-textbox-selectionbackgroundcolor-property/)
...
本示例使用 FabricJS 更改画布文本框的选定背景颜色。请注意，您必须单击对象才能看到其选择背景颜色。
