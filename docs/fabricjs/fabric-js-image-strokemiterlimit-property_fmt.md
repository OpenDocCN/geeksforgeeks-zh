...
> 原文: [https://www.geeksforgeeks.org/fabric-js-image-strokemiterlimit-property/](https://www.geeksforgeeks.org/fabric-js-image-strokemiterlimit-property/)
...
本示例使用 FabricJS 设置画布图像的 `strokeMiterLimit` 属性，如下例所示：
