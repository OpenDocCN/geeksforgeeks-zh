...
> 原文: [https://www.geeksforgeeks.org/fabric-js-activeselection-statefullcache-property/](https://www.geeksforgeeks.org/fabric-js-activeselection-statefullcache-property/)
...
**方法:** 首先导入 **fabric.js** 库。导入库后，在主体标签中创建一个包含动态选择的画布块。之后，初始化画布实例和 **Fabric.js** 提供的 `ActiveSelection` 类，并使用 `statefullCache` 属性。
