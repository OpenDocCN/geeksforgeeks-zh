...
> 原文: [https://www.geeksforgeeks.org/fabric-js-triangle-lockuniscaling-property/](https://www.geeksforgeeks.org/fabric-js-triangle-lockuniscaling-property/)
...
*   `width`: 指定三角形的宽度。
*   `height`: 指定三角形的高度。
*   `lockUniScaling`: 指定是否锁定非均匀缩放。

## 示例:

本示例使用 FabricJS 锁定画布三角形的非均匀缩放。
