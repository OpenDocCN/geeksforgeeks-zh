...
> 原文: [https://www.geeksforgeeks.org/fabric-js-polygon-lockskewingx-property/](https://www.geeksforgeeks.org/fabric-js-polygon-lockskewingx-property/)
...
下面的例子说明了 JavaScript 中的多边形 `lockSkewingX` 属性:
