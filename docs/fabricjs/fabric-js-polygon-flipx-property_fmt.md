...
> 原文：[https://www.geeksforgeeks.org/fabric-js-polygon-flipx-property/](https://www.geeksforgeeks.org/fabric-js-polygon-flipx-property/)
...
下面的例子说明了 Fabric.js 中的多边形 `flipX` 属性：
