...
> 原文: [https://www.geeksforgeeks.org/fabric-js-textbox-fontweight-property/](https://www.geeksforgeeks.org/fabric-js-textbox-fontweight-property/)
...
*   `fontWeight`: 指定字体粗细，可以是粗体、普通、400、500 等。
