...
> 原文：[https://www.geeksforgeeks.org/fabric-js-textbox-linethrough-property/](https://www.geeksforgeeks.org/fabric-js-textbox-linethrough-property/)
...
我们将使用 FabricJS 向文本框画布中的文本添加 linethrough，如下所示。
