# Fabric.js 多边形 paintFirst 属性

> 原文：[https://www.geeksforgeeks.org/fabric-js-polygon-paintfirst-property/](https://www.geeksforgeeks.org/fabric-js-polygon-paintfirst-property/)
...
*   **paintFirst**：指定是先画填充还是先画描边（`'fill'` 或 `'stroke'` 之一）。

下面的例子说明了 Fabric.js 多边形绘制首先在 JavaScript 中：
