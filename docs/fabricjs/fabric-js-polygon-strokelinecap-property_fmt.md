# Fabric.js 多边形 strokeLineCap 属性

> 原文: [https://www.geeksforgeeks.org/fabric-js-polygon-strokelinecap-property/](https://www.geeksforgeeks.org/fabric-js-polygon-strokelinecap-property/)
...
以下示例说明了 `Fabric.js` 中的多边形 `strokeLineCap` 属性。
