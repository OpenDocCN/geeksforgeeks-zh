...
> 原文: [https://www.geeksforgeeks.org/fabric-js-ellipse-transparentcorners-property/](https://www.geeksforgeeks.org/fabric-js-ellipse-transparentcorners-property/)
...
*   `rx`: 指定水平半径。
*   `ry`: 指定垂直半径。
*   `transparentCorners`: 指定控制角的可见性。

## 示例:

本示例使用 FabricJS 设置画布椭圆的控制角的可见性。
