...
> 原文: [https://www.geeksforgeeks.org/fabric-js-activeselection-skewx-property/](https://www.geeksforgeeks.org/fabric-js-activeselection-skewx-property/)

Fabric.js 是一个用于处理画布的 JavaScript 库。画布动态选举是 fabric.js 的一个类，用于创建动态选举实例。画布活动选择意味着活动选择是可移动的，可以根据需要拉伸。在本文中，我们将使用 `skewX` 属性。
...
本示例使用 FabricJS 设置画布 `ActiveSelection` 的 `skewX` 属性，如下例所示。
