...
> 原文: [https://www.geeksforgeeks.org/fabric-js-polygon-strokedashoffset-property/](https://www.geeksforgeeks.org/fabric-js-polygon-strokedashoffset-property/)
...
以下示例说明了 `Fabric.js` 多边形 `strokeDashOffset` 属性。
