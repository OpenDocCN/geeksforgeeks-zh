...
> 原文: [https://www.geeksforgeeks.org/fabric-js-polygon-cornerstrokecolor-property/](https://www.geeksforgeeks.org/fabric-js-polygon-cornerstrokecolor-property/)
...
*   `cornerColor`: 它是一个字符串，指定了用于控制转角的颜色。

### 注意:

尺寸 `pixel` 是创建多边形的必备条件。

下面的例子说明了 JavaScript 中的 `polygon cornerStrokeColor` 属性:
...
<body>
  ...
  <script>
    ...
    var polygon = new fabric.Polygon([
      ...
      // Set the corner stroke color to red
