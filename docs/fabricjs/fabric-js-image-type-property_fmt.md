...
> 原文：[https://www.geeksforgeeks.org/fabric-js-image-type-property/](https://www.geeksforgeeks.org/fabric-js-image-type-property/)
...
本示例使用 FabricJS 设置画布图像的 `type` 属性，如下例所示：
