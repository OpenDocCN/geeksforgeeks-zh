# Fabric.js Textbox borderDashArray 属性

> 原文: [https://www.geeksforgeeks.org/fabric-js-textbox-borderdasharray-property/](https://www.geeksforgeeks.org/fabric-js-textbox-borderdasharray-property/)
...
*   使用 CDN 导入库后，我们将在 `body` 标签中创建一个画布块，其中将包含我们的文本框。
...
本示例使用 FabricJS 设置画布状文本框的边框虚线图案，如下所示。请注意，您必须单击椭圆才能看到边框。
