...
> 原文: [https://www.geeksforgeeks.org/fabric-js-circle-lockskewingy-property/](https://www.geeksforgeeks.org/fabric-js-circle-lockskewingy-property/)

在本文中，我们将看到如何使用 `FabricJS` 锁定圆形画布的垂直倾斜。帆布圈是可移动的，可以根据需要拉伸。此外，当涉及到初始笔画颜色、高度、宽度、填充颜色或笔画宽度时，可以自定义圆圈。
...
本示例使用 `FabricJS` 设置画布圆的垂直倾斜，如下所示。
