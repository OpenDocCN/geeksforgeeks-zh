...
> 原文:[https://www . geeksforgeks . org/fabric-js-ellipse-bordercolor-property/](https://www.geeksforgeeks.org/fabric-js-ellipse-bordercolor-property/)
...
本示例使用 `FabricJS` 更改画布椭圆的边框颜色，如下所示。请注意，您必须单击椭圆才能看到边框。
