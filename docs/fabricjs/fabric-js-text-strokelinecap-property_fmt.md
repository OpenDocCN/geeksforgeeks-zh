# Fabric.js 文本 strokeLineCap 属性

> 原文: [https://www.geeksforgeeks.org/fabric-js-text-strokelinecap-property/](https://www.geeksforgeeks.org/fabric-js-text-strokelinecap-property/)
...
以下示例说明了 `Fabric.js` 中 `strokeLineCap` 属性的使用:
