...
> 原文: [https://www.geeksforgeeks.org/fabric-js-text-lineheight-property/](https://www.geeksforgeeks.org/fabric-js-text-lineheight-property/)
...
以下示例说明了 `Fabric.js` 中 `lineHeight` 属性的使用:
...
[http://fabricjs.com/docs/fabric.Text.html#lineHeight](http://fabricjs.com/docs/fabric.Text.html#lineHeight)