...
> 原文：[https://www.geeksforgeeks.org/fabric-js-polygon-hascontrols-property/](https://www.geeksforgeeks.org/fabric-js-polygon-hascontrols-property/)
...
下面的例子说明了 `Fabric.js` 多边形在 JavaScript 中的 `hasControls` 属性：
...
[http://fabricjs.com/docs/fabric.Polygon.html#hasControls](http://fabricjs.com/docs/fabric.Polygon.html#hasControls)