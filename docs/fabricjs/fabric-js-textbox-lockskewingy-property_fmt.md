...
> 原文: [https://www.geeksforgeeks.org/fabric-js-textbox-lockskewingy-property/](https://www.geeksforgeeks.org/fabric-js-textbox-lockskewingy-property/)
...
*   之后，我们将初始化 FabricJS 提供的 `canvas` 和 `Textbox` 的实例，并使用 `lockSkewingY` 属性设置画布文本框的垂直倾斜锁定，并在 Canvas 上呈现 `Textbox`，如下例所示。
