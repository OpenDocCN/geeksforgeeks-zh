...
> 原文: [https://www.geeksforgeeks.org/fabric-js-polygon-cornercolor-property/](https://www.geeksforgeeks.org/fabric-js-polygon-cornercolor-property/)
...
下面的例子说明了 Fabric.js 中的多边形 `cornerColor` 属性:
