...
> 原文: [https://www.geeksforgeeks.org/fabric-js-textbox-visible-property/](https://www.geeksforgeeks.org/fabric-js-textbox-visible-property/)
...
本示例使用 FabricJS Textbox visible Property 将画布文本框的可见性设置为`false`，因此文本将不可见。
