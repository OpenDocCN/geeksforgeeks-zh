# Fabric.js Text min_text_width 属性

> 原文: [https://www.geeksforgeeks.org/fabric-js-text-min_text_width-property/](https://www.geeksforgeeks.org/fabric-js-text-min_text_width-property/)
...
下面的例子说明了 `Fabric.js` 中 `MIN_TEXT_WIDTH` 属性的使用:
