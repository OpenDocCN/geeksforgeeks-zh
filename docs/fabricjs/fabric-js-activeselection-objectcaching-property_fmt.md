...
> 原文: [https://www.geeksforgeeks.org/fabric-js-activeselection-objectcaching-property/](https://www.geeksforgeeks.org/fabric-js-activeselection-objectcaching-property/)
...
*   `objectCaching`: 设置为“真”时，对象缓存在一个附加画布上。当设置为“假”时，除非必要，否则不缓存对象(剪辑路径)。默认值设置为真。

## 示例

本示例使用 FabricJS 设置画布 `ActiveSelection` 的 `objectCaching` 属性，如下例所示。
