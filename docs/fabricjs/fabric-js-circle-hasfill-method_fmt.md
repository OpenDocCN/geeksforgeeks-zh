...
> 原文: [https://www.geeksforgeeks.org/fabric-js-circle-hasfill-method/](https://www.geeksforgeeks.org/fabric-js-circle-hasfill-method/)
...
这个方法返回布尔值，如果对象将绘制填充，则返回 true。

## 示例

本示例使用 FabricJS 设置画布圆的 `hasFill()` 方法，如下例所示:
