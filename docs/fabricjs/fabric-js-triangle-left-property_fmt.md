...
> 原文: [https://www.geeksforgeeks.org/fabric-js-triangle-left-property/](https://www.geeksforgeeks.org/fabric-js-triangle-left-property/)
...
本示例使用 `FabricJS` 设置相对于画布三角形左侧的位置，如下所示。
