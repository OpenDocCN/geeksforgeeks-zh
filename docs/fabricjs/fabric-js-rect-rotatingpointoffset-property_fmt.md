# Fabric.js | Rect rotatingPointOffset 属性

> 原文: [https://www.geeksforgeeks.org/fabric-js-rect-rotatingpointoffset-property/](https://www.geeksforgeeks.org/fabric-js-rect-rotatingpointoffset-property/)
