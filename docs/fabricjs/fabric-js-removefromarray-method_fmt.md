...
> 原文: [https://www.geeksforgeeks.org/fabric-js-removefromarray-method/](https://www.geeksforgeeks.org/fabric-js-removefromarray-method/)

`removeFromArray()`方法用于从指定的值数组中移除一个值。
...
<head>
    ...
    <script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/fabric.js/3.6.2/fabric.min.js.map">
    </script>
    <script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/fabric.js/3.6.2/fabric.js">
    </script>
</head>
<body>
