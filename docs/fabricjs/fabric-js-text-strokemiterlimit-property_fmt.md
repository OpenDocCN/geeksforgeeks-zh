# Fabric.js Text strokeMiterLimit 属性

> 原文: [https://www.geeksforgeeks.org/fabric-js-text-strokemiterlimit-property/](https://www.geeksforgeeks.org/fabric-js-text-strokemiterlimit-property/)
...
*   `strokeMiterLimit`: 对象笔划的最大斜接长度(用于 `strokeLineJoin="miter"`)。

以下示例说明了 `Fabric.js` 中 `strokeMiterLimit` 属性的使用:
...
**参考:** [http://fabricjs.com/docs/fabric.Text.html#strokeMiterLimit](http://fabricjs.com/docs/fabric.Text.html#strokeMiterLimit)