...
> 原文: [https://www.geeksforgeeks.org/fabric-js-line-strokewidth-property/](https://www.geeksforgeeks.org/fabric-js-line-strokewidth-property/)
...
*   `strokeWidth`: 指定画布线条中描边颜色的宽度。包含数值。
