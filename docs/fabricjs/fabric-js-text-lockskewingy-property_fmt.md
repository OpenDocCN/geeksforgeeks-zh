...
> 原文: [https://www.geeksforgeeks.org/fabric-js-text-lockskewingy-property/](https://www.geeksforgeeks.org/fabric-js-text-lockskewingy-property/)
...
以下示例说明了 `Fabric.js` 中 `lockSkewingY` 属性的使用:
