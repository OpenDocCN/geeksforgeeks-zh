...
> 原文：[https://www.geeksforgeeks.org/fabric-js-itext-fontstyle-property/](https://www.geeksforgeeks.org/fabric-js-itext-fontstyle-property/)
...
*   之后，初始化一个由 Fabric 提供的 `Canvas` 和 `Itext` 类的实例。并使用 `fontStyle` 属性来设置文本的字体样式。
...
本示例使用 FabricJS 设置画布 `Itext` 的 `fontStyle` 属性，如下例所示：
...
<body> 
  ...
  <div style="text-align: center;"> 
    <canvas id="canvas" width="400" height="200" style="border:1px solid solid;"> 
    </canvas> 
  </div>
