...
> 原文: [https://www.geeksforgeeks.org/fabric-js-itext-flipy-property/](https://www.geeksforgeeks.org/fabric-js-itext-flipy-property/)
...
本示例使用 FabricJS 设置画布 `Itext` 的 `flipY` 属性，如下例所示:
