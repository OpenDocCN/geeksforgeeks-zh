...
> 原文: [https://www.geeksforgeeks.org/fabric-js-polygon-hasborders-property/](https://www.geeksforgeeks.org/fabric-js-polygon-hasborders-property/)
...
下面的例子说明了 Fabric.js 多边形 `hasBorders` 属性在 JavaScript 中的使用:

## 示例 1

在本例中，`hasBorders` 属性设置为 `false`。
...
[http://fabricjs.com/docs/fabric.Polygon.html#hasBorders](http://fabricjs.com/docs/fabric.Polygon.html#hasBorders)