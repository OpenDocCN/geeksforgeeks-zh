...
> 原文: [https://www.geeksforgeeks.org/fabric-js-polygon-lockscalingflip-property/](https://www.geeksforgeeks.org/fabric-js-polygon-lockscalingflip-property/)
...
下面的例子说明了 Fabric.js 中的多边形 `lockScalingFlip` 属性:
