...
> 原文: [https://www.geeksforgeeks.org/fabric-js-rect-lockmovementy-property/](https://www.geeksforgeeks.org/fabric-js-rect-lockmovementy-property/)
...
本示例使用 FabricJS 锁定画布状矩形的垂直移动，如下所示。
