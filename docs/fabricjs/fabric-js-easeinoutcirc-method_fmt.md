...
> 原文: [https://www.geeksforgeeks.org/fabric-js-easeinoutcirc-method/](https://www.geeksforgeeks.org/fabric-js-easeinoutcirc-method/)
...
`easeInOutCirc()`方法用于循环缓和其所使用的对象的效果。
