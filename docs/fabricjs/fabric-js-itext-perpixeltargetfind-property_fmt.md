...
> 原文: [https://www.geeksforgeeks.org/fabric-js-itext-perpixeltargetfind-property/](https://www.geeksforgeeks.org/fabric-js-itext-perpixeltargetfind-property/)
...
本示例使用 Fabric.js 设置画布 `Itext` 的 `perPixelTargetFind` 属性。
