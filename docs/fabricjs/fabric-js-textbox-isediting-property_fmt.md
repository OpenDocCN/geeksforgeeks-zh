...
> 原文: [https://www.geeksforgeeks.org/fabric-js-textbox-isediting-property/](https://www.geeksforgeeks.org/fabric-js-textbox-isediting-property/)
...
本示例使用 Fabric.js 设置 `Textbox` 的 `isEditing` 属性。
