...
> 原文: [`https://www.geeksforgeeks.org/fabric-js-triangle-hasborders-property/`](https://www.geeksforgeeks.org/fabric-js-triangle-hasborders-property/)
...
该示例使用 FabricJS 禁用画布三角形的边框，如下所示。
