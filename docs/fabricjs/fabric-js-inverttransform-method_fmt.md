...
> 原文：[`https://www.geeksforgeeks.org/fabric-js-inverttransform-method/`](https://www.geeksforgeeks.org/fabric-js-inverttransform-method/)

`invertTransform()`方法用于返回指定数组变换的反形式。该函数计算数组元素的逐位反转。
...
<body>
    <script type="text/javascript">
        ...
        console.log(fabric.util.invertTransform([1, 2, 3]));
        console.log(fabric.util.invertTransform([1, 2, 3, 4]));
        console.log(fabric.util.invertTransform([1, 2, 3, 4, 5]));
        console.log(fabric.util.invertTransform([1, 2, 3, 4, 5, 6]));
    </script>
</body>
</html>
```
