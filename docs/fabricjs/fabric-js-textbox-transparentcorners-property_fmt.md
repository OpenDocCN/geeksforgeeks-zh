...
> 原文: [https://www.geeksforgeeks.org/fabric-js-textbox-transparentcorners-property/](https://www.geeksforgeeks.org/fabric-js-textbox-transparentcorners-property/)
...
本示例使用 FabricJS 将画布文本框的角的可见性设置为 `false`。
...
本示例使用 FabricJS 将画布文本框的角的可见性设置为 `true`，因此控制角是透明的。
