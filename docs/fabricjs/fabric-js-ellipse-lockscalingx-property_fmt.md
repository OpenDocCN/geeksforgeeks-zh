...
> 原文：[https://www.geeksforgeeks.org/fabric-js-ellipse-lockscalingx-property/](https://www.geeksforgeeks.org/fabric-js-ellipse-lockscalingx-property/)
...
本示例使用 FabricJS 锁定画布椭圆的水平缩放，如下所示。
