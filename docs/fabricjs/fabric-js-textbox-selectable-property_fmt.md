...
> 原文: [https://www.geeksforgeeks.org/fabric-js-textbox-selectable-property/](https://www.geeksforgeeks.org/fabric-js-textbox-selectable-property/)
...
本示例使用 FabricJS 可选属性创建不可选择的对象画布文本框。
