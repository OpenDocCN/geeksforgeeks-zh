...
> 原文: [https://www.geeksforgeeks.org/fabric-js-graphemesplit-method/](https://www.geeksforgeeks.org/fabric-js-graphemesplit-method/)

`graphemeSplit()`方法用于将指定的字符串以用户感知的单个单位划分，即指定字符串的每个字符将被转换为单个字符串单位。
