...
> [原文](https://www.geeksforgeeks.org/fabric-js-circle-angle-property/)

在本文中，我们将看到如何使用 `FabricJS` 绘制一个固定角度的画布圆。帆布圈是可移动的，可以根据需要拉伸。此外，当涉及到初始笔画颜色、高度、宽度、填充颜色、或笔画宽度时，可以自定义圆圈。
...
**示例:** 本示例使用 `FabricJS` 启用画布状圆圈的角度，如下所示。启用 `angle` 属性后，它将按定义的角度旋转圆。
