...
> 原文: [https://www.geeksforgeeks.org/fabric-js-itext-stroke-property/](https://www.geeksforgeeks.org/fabric-js-itext-stroke-property/)
...
本示例使用 Fabric.js 设置画布 Itext 的笔画属性。
