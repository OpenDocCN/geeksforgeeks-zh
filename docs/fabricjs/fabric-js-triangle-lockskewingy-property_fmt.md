...
> 原文: [https://www.geeksforgeeks.org/fabric-js-triangle-lockskewingy-property/](https://www.geeksforgeeks.org/fabric-js-triangle-lockskewingy-property/)
...
本示例使用 FabricJS 设置画布三角形的垂直倾斜，如下所示。
