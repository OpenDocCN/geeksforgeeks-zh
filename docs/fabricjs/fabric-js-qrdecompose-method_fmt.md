...
<body>
    <script type="text/javascript">
        ...
        console.log(fabric.util.qrDecompose([1, 2, 3, 4, 5, 6]));
    </script>
</body>
...
以下示例演示了使用不同输入数组调用 `qrDecompose()` 方法的结果。
