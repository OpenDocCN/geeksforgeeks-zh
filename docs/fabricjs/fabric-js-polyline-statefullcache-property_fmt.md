# Fabric.js 折线 statefullCache 属性

> 原文：[https://www.geeksforgeeks.org/fabric-js-polyline-statefullcache-property/](https://www.geeksforgeeks.org/fabric-js-polyline-statefullcache-property/)

在本文中，我们将使用 Fabric.js 查看折线的 `statefullCache` 属性。Fabric.js 中的折线是可移动的，并且可以根据要求进行拉伸。此外，当涉及到初始笔画颜色、高度、宽度、填充颜色或笔画宽度时，可以自定义折线。
