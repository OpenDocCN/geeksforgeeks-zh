...
> 原文: [https://www.geeksforgeeks.org/fabric-js-group-hovercursor-property/](https://www.geeksforgeeks.org/fabric-js-group-hovercursor-property/)

在本文中，我们将看到如何使用 `Fabric.js` 设置画布的 `悬停光标` 或 `组`。`Fabric.js` 中的组是可移动的，可以根据需要拉伸。此外，当涉及到初始笔划颜色、高度、宽度、填充颜色或笔划宽度时，可以自定义该组。
