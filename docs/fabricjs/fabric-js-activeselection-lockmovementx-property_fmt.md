...
> 原文: [https://www.geeksforgeeks.org/fabric-js-activeselection-lockmovementx-property/](https://www.geeksforgeeks.org/fabric-js-activeselection-lockmovementx-property/)
...
本示例使用 FabricJS 设置画布 `ActiveSelection` 的 `lockMovementX` 属性，如下例所示。
