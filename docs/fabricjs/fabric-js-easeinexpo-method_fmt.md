...
放松功能指定参数随时间的变化率。正是他的方程式使某物在开始时缓慢移动，在接近结束时加速或减速。最常见的一组宽松方程式来自罗伯特·彭纳的书和网页。
...
<body>
    <script type="text/javascript">
        ...
        console.log(fabric.util.ease.easeInExpo(1, 2, 3, 4));
    </script>
</body>
...
<body>
    <script type="text/javascript">
        ...
        // Calling the easeInExpo() function over
        // the specified parameter values
        console.log(fabric.util.ease.easeInExpo(t, b, c, d));
    </script>
</body>
