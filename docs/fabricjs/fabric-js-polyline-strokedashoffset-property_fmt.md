...
> 原文: [https://www.geeksforgeeks.org/fabric-js-polyline-strokedashoffset-property/](https://www.geeksforgeeks.org/fabric-js-polyline-strokedashoffset-property/)

在本文中，我们将看到如何使用 FabricJS 将笔划偏移添加到折线画布上。画布意味着编写的折线是可移动的、可旋转的、可调整大小的，并且可以拉伸。但是在本文中，我们将添加一个笔画偏移。此外，折线本身不能像文本框一样编辑。
