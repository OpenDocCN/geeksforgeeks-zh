...
> 原文: [https://www.geeksforgeeks.org/fabric-js-polygon-cornerstyle-property/](https://www.geeksforgeeks.org/fabric-js-polygon-cornerstyle-property/)
...
下面的例子说明了 Fabric.js 中的 `Polygon` `cornerStyle` 属性:
