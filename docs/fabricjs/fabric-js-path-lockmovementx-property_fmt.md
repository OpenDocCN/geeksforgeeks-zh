...
> 原文: [https://www.geeksforgeeks.org/fabric-js-path-lockmovementx-property/](https://www.geeksforgeeks.org/fabric-js-path-lockmovementx-property/)
...
以下示例说明了在 JavaScript 中使用 `fabric.js` `Path lockMovementX` 属性：
