...
> 原文: [https://www.geeksforgeeks.org/fabric-js-circle-strokedashoffset-property/](https://www.geeksforgeeks.org/fabric-js-circle-strokedashoffset-property/)
...
本示例使用 FabricJS 库设置画布圆的描边虚线偏移，如下所示。
