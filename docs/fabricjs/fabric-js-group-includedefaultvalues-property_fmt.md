...
> 原文: [https://www.geeksforgeeks.org/fabric-js-group-includedefaultvalues-property/](https://www.geeksforgeeks.org/fabric-js-group-includedefaultvalues-property/)
...
以下示例说明了在 JavaScript 中使用 `fabric.js` Group `includeDefaultValues` 属性:
