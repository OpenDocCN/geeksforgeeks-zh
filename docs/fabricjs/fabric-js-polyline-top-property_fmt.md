...
> 原文：[`https://www.geeksforgeeks.org/fabric-js-polyline-top-property/`](https://www.geeksforgeeks.org/fabric-js-polyline-top-property/)
...
*   `top`：物体的顶部位置。请注意，默认情况下，它相对于对象顶部。您可以通过设置 `originY = {top/center/bottom}` 来更改此设置。
