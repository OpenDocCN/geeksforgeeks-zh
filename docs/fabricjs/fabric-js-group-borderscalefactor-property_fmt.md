# Fabric.js Group borderScaleFactor 属性

> 原文：[https://www.geeksforgeeks.org/fabric-js-group-borderscalefactor-property/](https://www.geeksforgeeks.org/fabric-js-group-borderscalefactor-property/)
...
*   `borderScaleFactor`：指定画布组的边框缩放。它包含一个数字值。
