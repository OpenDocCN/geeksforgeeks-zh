...
> 原文: [https://www.geeksforgeeks.org/fabric-js-image-strokewidth-property/](https://www.geeksforgeeks.org/fabric-js-image-strokewidth-property/)
...
本示例使用 `FabricJS` 设置画布图像的 `strokeWidth` 属性，如下例所示：
