# fabric.js getRandomInt()方法

> 原文: [https://www.geeksforgeeks.org/fabric-js-getrandomint-method/](https://www.geeksforgeeks.org/fabric-js-getrandomint-method/)

`getRandomInt()`方法用于返回两个指定数字之间的随机数。
...
该方法返回最小值和最大值之间的随机数（包括）。每次运行输入文件时，输出都会改变。
