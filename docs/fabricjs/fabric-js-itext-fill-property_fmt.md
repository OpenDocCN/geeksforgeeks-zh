...
> 原文: [https://www.geeksforgeeks.org/fabric-js-itext-fill-property/](https://www.geeksforgeeks.org/fabric-js-itext-fill-property/)
...
本示例使用 FabricJS 设置画布 Itext 的填充属性，如下例所示:
