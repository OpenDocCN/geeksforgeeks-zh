...
> 原文: [https://www.geeksforgeeks.org/fabric-js-circle-strokeuniform-property/](https://www.geeksforgeeks.org/fabric-js-circle-strokeuniform-property/)
...
本示例使用 FabricJS 锁定画布 Circle 的统一笔画宽度。
