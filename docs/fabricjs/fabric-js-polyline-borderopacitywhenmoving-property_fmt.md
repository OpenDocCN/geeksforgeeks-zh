...
> 原文：[https://www.geeksforgeeks.org/fabric-js-polyline-borderopacitywhenmoving-property/](https://www.geeksforgeeks.org/fabric-js-polyline-borderopacitywhenmoving-property/)
...
以下示例说明了 Fabric.js 中的 `borderOpacityWhenMoving` 属性：
