...
> 原文: [https://www.geeksforgeeks.org/fabric-js-triangle-strokedashoffset-property/](https://www.geeksforgeeks.org/fabric-js-triangle-strokedashoffset-property/)
...
本示例使用 `FabricJS` 设置画布三角形的笔画偏移，如下所示。
