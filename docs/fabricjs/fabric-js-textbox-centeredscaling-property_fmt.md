...
> 原文：[https://www.geeksforgeeks.org/fabric-js-textbox-centeredscaling-property/](https://www.geeksforgeeks.org/fabric-js-textbox-centeredscaling-property/)
...
*   之后，我们将初始化由 FabricJS 提供的 canvas 和 Textbox 的实例，并使用 `centeredScaling` 属性启用 canvas Textbox 的居中缩放，并在 Canvas 上呈现 Textbox，如下所示。
...
该示例使用 FabricJS 来启用画布状文本框的居中缩放，如下所示。
