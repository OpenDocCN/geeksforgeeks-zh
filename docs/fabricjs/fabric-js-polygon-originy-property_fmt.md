# Fabric.js 多边形 originY 属性

> 原文: [https://www.geeksforgeeks.org/fabric-js-polygon-originy-property/](https://www.geeksforgeeks.org/fabric-js-polygon-originy-property/)
...
下面的例子说明了 `Fabric.js` 中的多边形 `originY` 属性:
