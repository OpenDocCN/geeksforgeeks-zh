...
> 原文: [https://www.geeksforgeeks.org/fabric-js-textbox-stroke-property/](https://www.geeksforgeeks.org/fabric-js-textbox-stroke-property/)
...
本示例使用 `Fabric.js` 设置 `Textbox` 的笔画颜色。
