...
> 原文: [https://www.geeksforgeeks.org/fabric-js-text-strokelinejoin-property/](https://www.geeksforgeeks.org/fabric-js-text-strokelinejoin-property/)
...
*   `strokeLineJoin`: 对象笔划的角样式(“斜角”、“圆形”、“斜接”之一)

以下示例说明了 `Fabric.js` 中 `strokeLineJoin` 属性的使用:
