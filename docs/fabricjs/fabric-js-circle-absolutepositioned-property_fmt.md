...
> 原文: [https://www.geeksforgeeks.org/fabric-js-circle-absolutepositioned-property/](https://www.geeksforgeeks.org/fabric-js-circle-absolutepositioned-property/)
...
本示例使用 `FabricJS` 设置创建的简单画布圆的`绝对`位置。
