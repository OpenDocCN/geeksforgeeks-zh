...
> 原文: [https://www.geeksforgeeks.org/fabric-js-itext-strokedasharray-property/](https://www.geeksforgeeks.org/fabric-js-itext-strokedasharray-property/)
...
本示例使用 `Fabric.js` 设置画布 `Itext` 的 `strokeDashArray` 属性，如下例所示。
