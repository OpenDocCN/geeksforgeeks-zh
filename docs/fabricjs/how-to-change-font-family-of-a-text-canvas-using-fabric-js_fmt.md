...
> 原文: [https://www.geeksforgeeks.org/how-to-change-font-family-of-a-text-canvas-using-fabric-js/](https://www.geeksforgeeks.org/how-to-change-font-family-of-a-text-canvas-using-fabric-js/)
...
我们可以使用 FabricJS 来更改画布状文本的字体系列，如下所示:
...
点击运行 IDE 按钮后，您必须再次点击运行按钮来更改字体系列。
