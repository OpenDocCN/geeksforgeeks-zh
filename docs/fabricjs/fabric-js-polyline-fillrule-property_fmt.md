...
> 原文：[https://www.geeksforgeeks.org/fabric-js-polyline-fillrule-property/](https://www.geeksforgeeks.org/fabric-js-polyline-fillrule-property/)
...
*   **填充规则**：指定填充对象的规则。接受的值为 `"nonzero"` 和 `"evenodd"`。
