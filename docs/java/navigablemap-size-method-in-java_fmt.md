...
> 原文: [https://www.geeksforgeeks.org/navigablemap-size-method-in-java/](https://www.geeksforgeeks.org/navigablemap-size-method-in-java/)

`NavigableMap` 接口的 `size()` 方法用于获取映射的大小，映射的大小是指映射中键值对或映射的数量。
