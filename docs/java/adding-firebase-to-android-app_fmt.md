...
> 原文：[https://www.geeksforgeeks.org/adding-firebase-to-android-app/](https://www.geeksforgeeks.org/adding-firebase-to-android-app/)

在线提供各种服务，如存储、在线处理、实时数据库、用户授权等。谷歌开发了一个名为“Firebase”的平台，提供所有这些在线服务。它还提供了这些服务的日常使用分析以及用户使用它的详细信息。
...
1.  **更新**安卓工作室（>= 2.2）
2.  在 `Firebase` 中创建一个**新项目**，点击“Add project”。

![](img/67aaa8f7dbf0ae86276e4620d130b2f9.png)

3.  现在打开安卓工作室，点击左上角的**Tools**。

![](img/972c435c46f28b194883f9997fb0f2ab.png)

4.  在下拉菜单中点击**Firebase**选项。

![](img/75355bdaa1c0938117956f5d8d4f36b7.png)

5.  屏幕右侧将出现一个菜单。它将显示 `Firebase` 提供的各种**服务**。选择所需的服务。
6.  在所需服务的菜单中点击**Connect to Firebase**选项。

![](img/67d0b8cc3c4c197f661388e5fe9dd003.png)

7.  点击**Add [YOUR SERVICE NAME] to the app option**来添加服务的依赖项。（在下图中，选择了 `Firebase` cloud messaging 服务）
...
1.  创建一个 `firebase` 项目
    *   在 `Firebase` 控制台中点击**create project**来创建一个项目。

![](img/e3f71653d3ee6f46aa42b9ff42ef79ab.png)

*   在弹出窗口中填写有关项目的必要详细信息。如果需要，编辑项目ID。

![](img/0cc716906b28d67fe718bf7d8eebc8f8.png)

*   点击创建项目，最终创建它。
2.  现在将这个项目添加到安卓应用程序中
    *   在起始窗口中点击**Add firebase to your android app**选项。

![](img/83b572ac174db0782daf5ef9cb0c7f7e2.png)

*   将会出现一个提示，提示您在哪里输入应用程序的软件包名称。
    *   现在该应用程序已连接到 `Firebase`。现在，所有基于云以及基于服务器的服务都可以在应用程序中轻松使用。
    *   现在该应用程序将在 `firebase` 注册。
3.  也可以通过以下步骤提供应用程序的 `SHA1` 证书：
...
4.  现在下载**google-services.json**文件并将其放在安卓应用程序的根目录中。
