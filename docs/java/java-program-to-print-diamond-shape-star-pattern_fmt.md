...
> 原文：[https://www.geeksforgeeks.org/java-program-to-print-diamond-shape-star-pattern/](https://www.geeksforgeeks.org/java-program-to-print-diamond-shape-star-pattern/)
    ...
    public static void main(String[] args)
    {
        ...
        do {
            ...
            do {
                // Print star
                System.out.print("*");
            } while (++n <= m * 2 - 1); // Condition for inner do-while loop 2

            // A new row requires a new line
            System.out.println();

        } while (++m <= number); // Condition for outer do-while loop 1
