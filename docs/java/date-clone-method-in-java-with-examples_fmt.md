# Java 中的 Date.clone() 方法，示例

> 原文: [`https://www.geeksforgeeks.org/date-clone-method-in-java-with-examples/`](https://www.geeksforgeeks.org/date-clone-method-in-java-with-examples/)
...
### 参考:
[`https://docs.oracle.com/javase/8/docs/api/java/util/Date.html#clone--`](https://docs.oracle.com/javase/8/docs/api/java/util/Date.html#clone--)