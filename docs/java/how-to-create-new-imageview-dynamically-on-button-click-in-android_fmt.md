...
> 原文：[https://www.geeksforgeeks.org/how-to-create-new-imageview-dynamically-on-button-click-in-android/](https://www.geeksforgeeks.org/how-to-create-new-imageview-dynamically-on-button-click-in-android/)
...
下面是完整的 `MainActivity.java` 文件的代码。代码中添加了注释，以更详细地理解代码。
