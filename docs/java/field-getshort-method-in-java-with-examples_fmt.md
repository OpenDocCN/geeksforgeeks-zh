...
> 原文：[https://www.geeksforgeeks.org/field-getshort-method-in-java-with-examples/](https://www.geeksforgeeks.org/field-getshort-method-in-java-with-examples/)
...
该方法接受单个参数 `obj`，该参数是从中提取短值的对象。

## 返回值

该方法返回转换为 `short` 类型的字段的值。
