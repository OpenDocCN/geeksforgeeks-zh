...
> 原文：[https://www.geeksforgeeks.org/arraydeque-addfirst-method-in-java/](https://www.geeksforgeeks.org/arraydeque-addfirst-method-in-java/)

`java.util.ArrayDeque.addFirst(Object element)`方法用于在这个 deque 的前面插入一个特定的元素。

## 语法
```java
ArrayDeque.addFirst(Object element)
```
