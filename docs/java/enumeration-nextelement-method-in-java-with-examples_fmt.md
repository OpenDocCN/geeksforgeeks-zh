...
> 原文: [https://www.geeksforgeks.org/enumeration-nextelement-method-in-java-with-examples/](https://www.geeksforgeks.org/enumeration-nextelement-method-in-java-with-examples/)
...
如果没有更多元素存在，这个方法抛出`NoSuchElementException`。
...
[https://docs.oracle.com/javase/10/docs/api/java/util/Enumeration.html#nextElement()](https://docs.oracle.com/javase/10/docs/api/java/util/Enumeration.html#nextElement())