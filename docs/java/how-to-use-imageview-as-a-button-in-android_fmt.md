...
> 原文：[https://www.geeksforgeeks.org/how-to-use-imageview-as-a-button-in-android/](https://www.geeksforgeeks.org/how-to-use-imageview-as-a-button-in-android/)
...
我们将构建一个简单的应用程序，其中我们将显示一个[`ImageView`](https://www.geeksforgeeks.org/imageview-in-android-with-example/)，当我们点击该图像视图时，我们将进入一个新的活动，或者简单地说，我们将使用图像视图作为一个按钮在不同的活动之间切换。下面给出了一个示例视频，以了解我们将在本文中做什么。请注意，我们将使用 `Java` 语言来实现这个项目。
