# 如何在安卓中创建嵌套的 RecyclerView

> 原文：[https://www.geeksforgeeks.org/how-to-create-a-nested-recyclerview-in-android/](https://www.geeksforgeeks.org/how-to-create-a-nested-recyclerview-in-android/)
