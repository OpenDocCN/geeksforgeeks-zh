...
> 原文：[https://www.geeksforgeeks.org/how-to-install-selenium-webdriver-on-windows-for-java/](https://www.geeksforgeeks.org/how-to-install-selenium-webdriver-on-windows-for-java/)
...
**第一步：** 首先去 [甲骨文官网](https://www.oracle.com/java/technologies/javase-downloads.html) 下载 Java。
...
**第六步：** 现在通过右键单击 *项目名称- >新建- >类* 创建一个 java 类，并创建一个任意名称的类，例如 Demo。这里，我们用类名 *【GFG】* ：创建

![](img/b02db405c462cf13eb1f281eb57feb45.png)

**第七步：** 接下来，点击您的 *项目- >构建路径- >配置构建路径* 并添加 *外部 JARs* ，如图所示。
...
**第八步：** 现在，转到你为 java 下载的文件 Selenium 解压的文件夹，选择名为 **【lib】的文件夹中存在的所有 jar 文件。**

![](img/61da2f39d1d2ae644638d5d0aa2f113d.png)

**第九步：** 然后只需点击 **应用** 并在插入所有的 jar 文件后关闭，您就可以开始了，因为您已经成功地在项目中添加了 Selenium jars。
