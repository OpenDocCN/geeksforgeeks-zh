...
> 原文: [https://www.geeksforgeeks.org/biginteger-intvalue-method-in-java/](https://www.geeksforgeeks.org/biginteger-intvalue-method-in-java/)
...
[BigInteger.intValue() 文件](https://docs.oracle.com/javase/7/docs/api/java/math/BigInteger.html#intValue())