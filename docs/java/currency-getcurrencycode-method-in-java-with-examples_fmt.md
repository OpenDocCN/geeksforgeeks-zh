...
> 原文：[https://www.geeksforgeeks.org/currency-getcurrencycode-method-in-java-with-examples/](https://www.geeksforgeeks.org/currency-getcurrencycode-method-in-java-with-examples/)

Java 中的 `Currency` 类的 `getCurrencyCode()` 方法用于检索该货币的货币代码，实际上是 ISO 4217 官方的货币代码。
...
**异常：** 如果调用了无效代码，该方法将抛出 `RuntimeException`。
