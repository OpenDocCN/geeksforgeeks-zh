...
> 原文: [https://www.geeksforgeeks.org/java-program-to-delete-a-column-in-a-table-using-jdbc/](https://www.geeksforgeeks.org/java-program-to-delete-a-column-in-a-table-using-jdbc/)
...
*   使用 MySQL
    ...
    *   [`Connection()`](https://www.geeksforgeeks.org/establishing-jdbc-connection-in-java/)
    *   `Statement()`
    *   `ResultSet()` 包含 JDBC 应用编程接口提供的类
