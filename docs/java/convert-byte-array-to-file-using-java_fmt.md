...
> 原文：[https://www.geeksforgeeks.org/convert-byte-array-to-file-using-java/](https://www.geeksforgeeks.org/convert-byte-array-to-file-using-java/)

要将`byte[]`转换为文件，使用`String`类的`getBytes()`方法，简单的`write()`方法可以将该字节转换为文件。

## 程序 1：将字符串转换为字节数组并写入文件
