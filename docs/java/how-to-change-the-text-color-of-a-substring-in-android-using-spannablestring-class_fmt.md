...
> 原文：[https://www.geeksforgeeks.org/how-to-change-the-text-color-of-a-substring-in-android-using-spannablestring-class/](https://www.geeksforgeeks.org/how-to-change-the-text-color-of-a-substring-in-android-using-spannablestring-class/)
...
1.  在 `activity_main.xml` 文件中添加以下代码。这将在 `activity_main` 布局中添加两个 `TextView`。
...
<LinearLayout
    ...
    <TextView
        ...
        android:text="GeeksForGeeks A Computer Science Portal for Geeks"
