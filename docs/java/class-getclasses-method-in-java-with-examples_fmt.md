...
> 原文：`https://www.geeksforgeeks.org/class-getclasses-method-in-java-with-examples/`
...
**参考：** `https://docs.oracle.com/javase/9/docs/api/java/lang/Class.html#getClasses--`