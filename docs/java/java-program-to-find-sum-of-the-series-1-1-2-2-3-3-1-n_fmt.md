# Java 程序求数列 1/1! + 2/2! + 3/3! + …… + 1/N! 的和

> 原文: [https://www.geeksforgeeks.org/java-program-to-find-sum-of-the-series-1-1-2-2-3-3-1-n/](https://www.geeksforgeeks.org/java-program-to-find-sum-of-the-series-1-1-2-2-3-3-1-n/)
...
*   输入术语数 `n`
*   创建一个函数来计算数列的和，比如，`calculateSum()`。
*   在 `calculateSum()` 函数中，创建一个变量 `sum`，用于存储序列的总和。
*   循环运行 `N` 次。
*   调用 `factorial()` 函数计算给定数字的阶乘。
*   返回总和。
