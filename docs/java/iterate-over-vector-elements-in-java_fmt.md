...
> 原文：[https://www.geeksforgeeks.org/iterate-over-vector-elements-in-java/](https://www.geeksforgeeks.org/iterate-over-vector-elements-in-java/)
...
*   我们也可以使用枚举接口来遍历我们的向量。
*   它使用 `hasMoreElements()` 函数检查我们的向量是否有更多的元素。
*   直到到达空值，它使用 `nextElement()` 方法打印值。
