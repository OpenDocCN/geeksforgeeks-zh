...
> 原文：[https://www.geeksforgeeks.org/java-math-sinh-method-examples/](https://www.geeksforgeeks.org/java-math-sinh-method-examples/)
...
## 示例 2
展示当自变量为 `NaN` 或无穷大时 `java.lang.Math.sinh()` 方法的工作。
