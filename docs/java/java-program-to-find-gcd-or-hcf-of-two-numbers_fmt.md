...
> 原文: [https://www.geeksforgeeks.org/java-program-to-find-gcd-or-hcf-of-two-numbers/](https://www.geeksforgeeks.org/java-program-to-find-gcd-or-hcf-of-two-numbers/)
...
`两个规定数字的 GCD` 如果从大的数字中减去小的数字不会改变。
