...
> 原文：[https://www.geeksforgeeks.org/how-to-crop-image-from-camera-and-gallery-in-android/](https://www.geeksforgeeks.org/how-to-crop-image-from-camera-and-gallery-in-android/)

在上一篇文章中，我们已经讨论了如何在安卓中从图库中选择图像，但是在这个项目中没有**裁剪功能**。有时候我们在手机上拍照，想更新为个人资料图片。但我们需要移除背景。因此，在这种情况下，我们可以使用裁剪图像功能来移除背景，然后上传图像。下面给出一个视频示例，来了解一下我们在本文中要做什么。注意，我们将使用 **Java** 语言来实现这个项目。
...
导航到**渐变脚本 > `build.gradle` (模块: 应用)**，并在依赖项部分添加以下依赖项。
...
**github link:** [https://github.com/Anni1123/CropImage](https://github.com/Anni1123/CropImage)