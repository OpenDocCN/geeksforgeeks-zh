...
> 原文: `https://www.geeksforgeeks.org/java-string-concat-examples/`

[Java 字符串](https://www.geeksforgeeks.org/string-class-in-java/) `concat()`方法将一个字符串连接到另一个字符串的末尾。此方法返回一个字符串，该字符串的值被传递到方法中，并附加到字符串的末尾。考虑下图:
