...
> 原文: [https://www.geeksforgeeks.org/java-program-to-extract-a-image-from-a-pdf/](https://www.geeksforgeeks.org/java-program-to-extract-a-image-from-a-pdf/)
...
[执行](https://pdfbox.apache.org/download.html)操作需要下载外部文件。有关用于参考[的模块的更多文档。](https://pdfbox.apache.org/)
