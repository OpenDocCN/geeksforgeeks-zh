...
> 原文：[https://www.geeksforgeeks.org/how-to-run-your-first-spring-boot-application-in-intellij-idea/](https://www.geeksforgeeks.org/how-to-run-your-first-spring-boot-application-in-intellij-idea/)
...
成功创建或导入 `spring boot` 项目后，将自动创建一个名为 `Application.java(Herre demo application)` 的文件，这是您的入口点。您可以将其视为 `Spring Boot` 应用程序的 `main` 方法。
...
您可以看到 [Tomcat 服务器](https://www.geeksforgeeks.org/difference-between-apache-tomcat-server-and-apache-web-server/)在您给出的端口上启动，如下图所示。
