...
> 原文：[https://www.geeksforgeeks.org/getting-data-from-microsoft-exchange-server-in-java/](https://www.geeksforgeeks.org/getting-data-from-microsoft-exchange-server-in-java/)
...
此外，从 2020 年 10 月 13 日起，微软预计每个使用 `Exchange 网络服务`进行 `Office 365` 集成的人都将转向 `微软 Graph`。此外，2020 年 10 月 13 日，将停止支持 `Exchange 网络服务(EWS)`中的基本身份验证。
