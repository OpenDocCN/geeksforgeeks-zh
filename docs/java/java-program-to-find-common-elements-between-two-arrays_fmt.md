...
> 原文：[https://www.geeksforgeeks.org/java-program-to-find-common-elements-between-two-arrays/](https://www.geeksforgeeks.org/java-program-to-find-common-elements-between-two-arrays/)
...
通过使用 [`HashSet`](https://www.geeksforgeeks.org/hashset-in-java/) 的 `retainAll()` 方法，我们可以找到两个数组之间的公共元素。
...
3.  使用 `Collections.retainAll()` 方法找出两组中的公共元素。此方法只保留集合 1 中两个集合的公共元素。
4.  集合 1 现在只包含公共元素。
