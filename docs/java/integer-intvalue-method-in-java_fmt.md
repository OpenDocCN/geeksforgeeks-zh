...
> 原文：[https://www.geeksforgeeks.org/integer-intvalue-method-in-java/](https://www.geeksforgeeks.org/integer-intvalue-method-in-java/)

存在于 [`java.lang`](https://www.geeksforgeeks.org/java-lang-package-java/) 包中的 [`Integer`](https://www.geeksforgeeks.org/java-lang-integer-class-java/) 类的 [`intValue()`](https://www.geeksforgeeks.org/integer-intvalue-method-in-java/) 是 Java 中的一个内置方法，它将该整数的值作为 `int` 返回。
