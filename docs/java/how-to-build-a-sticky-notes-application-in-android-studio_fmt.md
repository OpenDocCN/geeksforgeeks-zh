...
> 原文：[https://www.geeksforgeeks.org/how-to-build-a-sticky-notes-application-in-android-studio/](https://www.geeksforgeeks.org/how-to-build-a-sticky-notes-application-in-android-studio/)
...
这个类将在上一步中形成。转到 `AppWidget.java` 文件，参考以下代码。以下是 `AppWidget.java` 文件的代码。代码中添加了注释，以更详细地理解代码。
...
这是一个助手类，提供保存、更新和检索文件内容的功能。前往 `StickyNote.java` 文件并参考以下代码。以下是 `StickyNote.java` 文件的代码。代码中添加了注释，以更详细地理解代码。
