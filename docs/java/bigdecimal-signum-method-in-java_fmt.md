...
> 原文:[https://www.geeksforgeeks.org/bigdecimal-signum-method-in-java/](https://www.geeksforgeeks.org/bigdecimal-signum-method-in-java/)
...
### 参考:
[https://docs.oracle.com/javase/7/docs/api/java/math/BigDecimal.html#signum()](https://docs.oracle.com/javase/7/docs/api/java/math/BigDecimal.html#signum())