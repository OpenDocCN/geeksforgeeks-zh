...
> 原文：[https://www.geeksforgeeks.org/law-of-demeter-in-java-principle-of-least-knowledge/](https://www.geeksforgeeks.org/law-of-demeter-in-java-principle-of-least-knowledge/)

根据德米特里法则，类应该尽可能了解其他几个类并与之交互。它用于通过限制类与其他类的交互来放松耦合，以提供稳定性，因为更紧密的耦合会使程序难以维护。因此，当我们限制班级之间的交流时，我们可以执行最少知识的原则。局部对象在参数中传递，在方法中实例化，或者应该是实例变量。在德米特里法则中，一个方法不应该调用任何非本地对象的方法。

> 我们正试图阻止类似 `A.getObjectB().getObjectC().display()` 这种说法，它违反了德米特里法则。
