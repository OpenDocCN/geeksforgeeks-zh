# ConcurrentSkipListSet 的 `size()` 方法
...
`java.util.concurrent.ConcurrentSkipListSet.size()` 方法是 Java 中的一个内置函数，它给出了集合中存在的元素的总数。
...
[https://docs.oracle.com/javase/8/docs/api/java/util/concurrent/ConcurrentSkipListSet.html#size--](https://docs.oracle.com/javase/8/docs/api/java/util/concurrent/ConcurrentSkipListSet.html#size--)