...
> 原文：[https://www.geeksforgeeks.org/java-program-to-read-a-large-text-file-line-by-line/](https://www.geeksforgeeks.org/java-program-to-read-a-large-text-file-line-by-line/)
...
> **注意：** 指定 `BufferedReader` 的大小或保持该大小为 `BufferedReader` 的默认大小。`BufferedReader` 的默认大小是 8KB。
