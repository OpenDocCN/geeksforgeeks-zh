...
> 原文：[https://www.geeksforgeeks.org/conversion-of-array-to-arraylist-in-java/](https://www.geeksforgeeks.org/conversion-of-array-to-arraylist-in-java/)
...
*   由于返回的列表是固定大小的，因此我们不能在其中添加更多的元素，但是我们可以使用`ArrayList`类中定义的`set(index, new element)`方法用新元素替换现有元素。
