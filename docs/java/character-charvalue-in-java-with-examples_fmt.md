...
> 原文：[https://www.geeksforgeeks.org/character-charvalue-in-java-with-examples/](https://www.geeksforgeeks.org/character-charvalue-in-java-with-examples/)

`Character.charValue()` 是 Java 中的内置方法，返回这个字符对象的值。此方法将字符对象转换为其基本数据类型字符。
