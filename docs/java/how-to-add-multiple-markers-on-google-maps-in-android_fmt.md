...
> 原文：[https://www.geeksforgeeks.org/how-to-add-multiple-markers-on-google-maps-in-android/](https://www.geeksforgeeks.org/how-to-add-multiple-markers-on-google-maps-in-android/)

谷歌地图用于大多数应用程序，这些应用程序用于表示谷歌地图上的许多位置和标记。我们在谷歌地图上看到了多个位置的标记。在本文中，我们将看一下在 Android 中谷歌地图上的多标记实现。
