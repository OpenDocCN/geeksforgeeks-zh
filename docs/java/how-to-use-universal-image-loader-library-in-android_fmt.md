...
> `implementation "com.nostra13.universal-image-loader:universal-image-loader:1.9.5"`
...
### 第四步：在 `activity_main.xml` 中创建新的 `ImageView`
...
### 第五步：初始化你的 `ImageView` 并在 `MainActivity.java` 文件中使用 UIL（通用图像加载器）
