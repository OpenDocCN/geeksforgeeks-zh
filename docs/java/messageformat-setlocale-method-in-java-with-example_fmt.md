...
> 原文：`https://www.geeksforgeeks.org/messageformat-setlocale-method-in-java-with-example/`
...
## 参考
`https://docs.oracle.com/javase/9/docs/api/java/text/MessageFormat.html#setLocale-java.util.Locale-`