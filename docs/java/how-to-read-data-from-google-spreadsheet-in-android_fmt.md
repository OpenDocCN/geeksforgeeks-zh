...
> 原文：[https://www.geeksforgeeks.org/how-to-read-data-from-google-spreadsheet-in-android/](https://www.geeksforgeeks.org/how-to-read-data-from-google-spreadsheet-in-android/)
...
### 第三步：向 `AndroidManifest.xml` 文件添加互联网权限
...
为了存储数据，我们必须创建一个新的 java 类。要创建一个新的 java 类，导航到 `应用程序 > java > 你的应用程序的包名 > 右键单击它 > 新建 > Java 类` 并将其命名为 `UserModal` 并添加下面的代码。
