...
> 原文：[https://www.geeksforgeeks.org/java-program-to-move-all-uppercase-characters-to-the-end/](https://www.geeksforgeeks.org/java-program-to-move-all-uppercase-characters-to-the-end/)
...
class GFG {
    ...
    static void shiftuppercase(String m, int length)
    {
        // Creating an object of Queue class of character type
        ...
        for (int i = 0; i < length; ++i) {
            ...
            // Condition check for the uppercase characters
            // If uppercase use ASCII values of the character
            if (m.charAt(i) >= 65 && m.charAt(i) <= 90) {
                Q.add(m.charAt(i));
            }
            ...
            // Character is lowercase
                ...
                // Leave it as it is on its index
                System.out.print(m.charAt(i));
        }
