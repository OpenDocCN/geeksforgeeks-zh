...
2.  对于每个循环，不要跟踪索引。因此，我们无法使用 For-Each 循环获得数组索引
...
[迭代器 vs-每个在 Java](https://www.geeksforgeeks.org/iterator-vs-foreach-in-java/)
