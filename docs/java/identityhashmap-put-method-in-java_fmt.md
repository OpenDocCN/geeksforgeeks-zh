...
> 原文：[`https://www.geeksforgeeks.org/identityhashmap-put-method-in-java/`](https://www.geeksforgeeks.org/identityhashmap-put-method-in-java/)
...
该方法采用两个参数，都是 `IdentityHashMap` 的对象类型。
