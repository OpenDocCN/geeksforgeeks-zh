...
> 原文:`https://www.geeksforgeeks.org/association-composition-aggregation-java/`

关联是两个独立的类之间通过它们的对象建立的关系。关联可以是一对一、一对多、多对一、多对多。在面向对象编程中，一个对象与另一个对象通信，以使用该对象提供的功能和服务。成分和聚集是两种结合形式。
