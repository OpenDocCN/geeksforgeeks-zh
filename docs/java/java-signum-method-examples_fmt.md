...
*   如果传递的参数小于零，那么`signum()`函数将返回 `-1.0`。
...
**Return**:
This method returns the signum function value of the argument passed to it.

## 例 1

展示 `java.lang.Math.signum()` 方法的工作。
...
展示参数为 `NaN` 时 `java.lang.Math.signum()` 方法的工作。
