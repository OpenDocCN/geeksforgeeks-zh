# AbstractMap.put() 方法在 Java 中用例子

> 原文: [https://www.geeksforgeeks.org/abstractmap-put-method-in-java-with-examples/](https://www.geeksforgeeks.org/abstractmap-put-method-in-java-with-examples/)
...
该方法取两个参数，都是 `AbstractMap` 的 `Object` 类型:
