...
> 原文：[https://www.geeksforgeeks.org/longest-prefix-matching-a-trie-based-solution-in-java/](https://www.geeksforgeeks.org/longest-prefix-matching-a-trie-based-solution-in-java/)
...
寻找最长前缀的时间复杂度是 `O(n)`，其中 `n` 是输入字符串的长度。构建 Trie 的时间复杂度请参考[这个](https://www.geeksforgeeks.org/trie-insert-and-search/)。
