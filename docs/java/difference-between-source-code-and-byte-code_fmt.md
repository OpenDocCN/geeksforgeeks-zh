...
> 原文：[https://www.geeksforgeeks.org/difference-between-source-code-and-byte-code/](https://www.geeksforgeeks.org/difference-between-source-code-and-byte-code/)
...
**字节码**是介于源代码和机器码之间的中间代码。它是低级代码，是用高级语言编写的源代码编译的结果。由 [`JVM`](https://www.geeksforgeeks.org/jvm-works-jvm-architecture/) 这样的虚拟机处理。
