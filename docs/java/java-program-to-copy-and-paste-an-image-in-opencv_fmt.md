...
> 原文：[https://www.geeksforgeeks.org/java-program-to-copy-and-paste-an-image-in-opencv/](https://www.geeksforgeeks.org/java-program-to-copy-and-paste-an-image-in-opencv/)
...
在本地目录下系统中本地目录下出现的样本图像。下面显示了从中提取图像以解释为多维数组的目录：
