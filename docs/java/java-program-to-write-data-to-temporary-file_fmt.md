...
> 原文: [https://www.geeksforgeeks.org/java-program-to-write-data-to-temporary-file/](https://www.geeksforgeeks.org/java-program-to-write-data-to-temporary-file/)
...
由于我们现在已经习惯了创建临时文件的过程，我们现在将使用它向临时文件中写入数据。将字符写入临时文件的最有效方法是使用 Java `BufferedWriter` 类。它用于为编写器实例提供缓冲，并提高性能。
