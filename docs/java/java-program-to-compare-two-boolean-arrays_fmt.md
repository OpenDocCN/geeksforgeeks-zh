...
> 原文：[https://www.geeksforgeeks.org/java-program-to-compare-two-boolean-arrays/](https://www.geeksforgeeks.org/java-program-to-compare-two-boolean-arrays/)

如果两个数组包含相同顺序的相同元素，则它们是相等的。在 Java 中，我们可以用两种方式比较两个布尔数组：

*   通过使用 Java 内置方法即 `Arrays.equals()` 方法。
*   通过使用天真的方法。
...
Java 中的 `Arrays` 类提供了方法 `Arrays.equals()` 来检查两个数组是否相等。
