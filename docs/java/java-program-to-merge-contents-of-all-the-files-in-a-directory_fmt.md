...
> 原文：[https://www.geeksforgeeks.org/java-program-to-merge-contents-of-all-the-files-in-a-directory/](https://www.geeksforgeeks.org/java-program-to-merge-contents-of-all-the-files-in-a-directory/)
...
对于下面的例子，比如说文件夹存储在路径：`F:\GeeksForGeeks`。
...
4.  循环读取 `GeeksForGeeks` 目录中所有文件的内容。
5.  在每个文件的循环中。
