...
> 原文:[https://www.geeksforgeeks.org/ArrayList-get-method-Java-examples/](https://www.geeksforgeeks.org/ArrayList-get-method-Java-examples/)

Java 中 [`ArrayList`](https://www.geeksforgeeks.org/arraylist-in-java/) 的 `get()` 方法用于获取列表中指定索引的元素。
...
**异常:**如果索引超出范围(`index >= size()`)，它将抛出[`IndexOutOfBoundsException`](https://www.geeksforgeeks.org/array-index-out-of-bounds-exception-in-java/)。
