...
> 原文：[https://www.geeksforgeeks.org/how-to-print-fast-output-in-competitive-programming-using-java/](https://www.geeksforgeeks.org/how-to-print-fast-output-in-competitive-programming-using-java/)
...
[`BufferedWriter`](https://www.geeksforgeeks.org/io-bufferedwriter-class-methods-java/) 将文本写入字符输出流，缓冲字符以提供单个字符、数组和字符串的高效写入。它使表演变得很快。
...
- `write(char[] array)`: 将指定数组中的字符写入 writer。
