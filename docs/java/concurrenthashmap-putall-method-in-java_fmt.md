...
## 参数
函数接受一个 `ConcurrentHashMap` `conn_hash_map` 作为它唯一的参数，并用*这个*映射复制它所有的映射。
...
## 参考
[https://docs.oracle.com/javase/7/docs/api/java/util/concurrent/ConcurrentHashMap.html#putAll(java.util.Map)](https://docs.oracle.com/javase/7/docs/api/java/util/concurrent/ConcurrentHashMap.html#putAll(java.util.Map))