...
> 原文: [https://www.geeksforgeeks.org/collections-newsetfrommap-method-in-java-with-examples/](https://www.geeksforgeeks.org/collections-newsetfrommap-method-in-java-with-examples/)
...
如果地图不为空，此方法抛出 `IllegalArgumentException`。
...
## 示例 2: 适用于 `IllegalArgumentException`
