...
> 原文：[https://www.geeksforgeeks.org/how-to-create-dynamic-webview-in-android-with-firebase/](https://www.geeksforgeeks.org/how-to-create-dynamic-webview-in-android-with-firebase/)
...
现在验证您的应用程序是否连接到 Firebase。转到您的 `build.gradle` 文件。导航到 `应用程序 > 渐变脚本 > 构建.gradle 文件`，并确保以下依赖项已添加到您的依赖项部分。
