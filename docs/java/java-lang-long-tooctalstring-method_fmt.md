# Java Long.toOctalString() 方法示例

> 原文: [https://www.geeksforgeeks.org/java-lang-long-tooctalstring-method/](https://www.geeksforgeeks.org/java-lang-long-tooctalstring-method/)
...
**参数:** 该函数接受单个强制参数 `num`，该参数将被转换为字符串。参数为 `long` 数据类型。
