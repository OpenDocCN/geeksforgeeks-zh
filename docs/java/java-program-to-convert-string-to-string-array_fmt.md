...
> 原文: [https://www.geeksforgeeks.org/java-program-to-convert-string-to-string-array/](https://www.geeksforgeeks.org/java-program-to-convert-string-to-string-array/)
...
1.  定义模式(REGEX)
2.  然后使用编译方法创建一个模式
3.  然后使用 `Pattern.split()` 方法，用特定的模式分割字符串，并将其存储在数组中。
4.  打印字符串数组
