...
> 原文: [https://www.geeksforgeeks.org/how-to-create-dynamic-intro-slider-in-android-using-firebase-firestore/](https://www.geeksforgeeks.org/how-to-create-dynamic-intro-slider-in-android-using-firebase-firestore/)

我们已经看到[在安卓](https://www.geeksforgeeks.org/how-to-create-a-basic-intro-slider-of-an-android-app/)中创建了一个基本的 Intro Slider，用于通知我们的用户关于我们的应用程序的功能以及更多。在这篇文章中，我们将在 [Firebase](https://www.geeksforgeeks.org/firebase-introduction/) 的帮助下，看看动态介绍滑块在我们的应用程序中的实现。借助 `Firebase Firestore`，我们可以从 `Firebase` 控制台动态更改所有数据。现在让我们转向实现。
