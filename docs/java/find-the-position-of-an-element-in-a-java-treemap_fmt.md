...
> 原文:[https://www . geeksforgeeks . org/find-a-Java-tree map 中元素的位置/](https://www.geeksforgeeks.org/find-the-position-of-an-element-in-a-java-treemap/)
...
*   没有直接的方法来找出键在树形图中的位置。
*   但是，我们可以使用 [`TreeMap headMap()`方法](https://www.geeksforgeeks.org/treemap-headmap-method-in-java/)。
*   方法返回树图中键严格小于 `key_point` 键的部分。
*   因此，如果键存在于树图中，那么它的头映射的 `size()` 等于键在树图中的位置。
