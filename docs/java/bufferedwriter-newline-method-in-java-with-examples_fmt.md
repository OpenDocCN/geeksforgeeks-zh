...
> 原文: [https://www.geeksforgeeks.org/bufferedwriter-newline-method-in-java-with-examples/](https://www.geeksforgeeks.org/bufferedwriter-newline-method-in-java-with-examples/)
...
下面的程序说明了 `java.io` 包中 `BufferedWriter` 类中的 `newLine()`方法:
