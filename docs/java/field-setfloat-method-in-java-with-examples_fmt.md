...
> 原文: [https://www.geeksforgeeks.org/field-setfloat-method-in-java-with-examples/](https://www.geeksforgeeks.org/field-setfloat-method-in-java-with-examples/)

`setFloat()` 是 `java.lang.reflect.Field` 的方法，用于将字段的值设置为指定对象上的浮点数。当您需要将对象字段的值设置为浮点数时，可以使用此方法在对象上设置值。
...
## 参考:
[https://docs.oracle.com/javase/8/docs/api/java/lang/reflect/Field.html#setFloat-java.lang.Object-float-](https://docs.oracle.com/javase/8/docs/api/java/lang/reflect/Field.html#setFloat-java.lang.Object-float-)