...
> 原文: [https://www.geeksforgeeks.org/linkedtransferqueue-poll-method-in-java/](https://www.geeksforgeeks.org/linkedtransferqueue-poll-method-in-java/)
...
## 参考:
[https://docs.oracle.com/javase/7/docs/api/java/util/concurrent/LinkedTransferQueue.html#poll()](https://docs.oracle.com/javase/7/docs/api/java/util/concurrent/LinkedTransferQueue.html#poll())