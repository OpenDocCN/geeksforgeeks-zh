...
> 原文：[`https://www.geeksforgeeks.org/java-math-max-method-examples/`](https://www.geeksforgeeks.org/java-math-max-method-examples/)
...
参数：该函数接受两个参数 `num1` 和 `num2`，并返回其中的最大值。

## 返回值

函数返回两个数字的最大值。数据类型将与参数的数据类型相同。
