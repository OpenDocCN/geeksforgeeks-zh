# Java 中的 `Buffer.remaining()` 方法示例

> 原文：[https://www.geeksforgeeks.org/buffer-remaining-methods-in-java-with-examples/](https://www.geeksforgeeks.org/buffer-remaining-methods-in-java-with-examples/)

`java.nio.Buffer` 类的 `remaining()` 方法用于返回当前位置与限制（limit）之间的元素个数。
...
## 参考
[https://docs.oracle.com/javase/9/docs/api/java/nio/Buffer.html#remaining--](https://docs.oracle.com/javase/9/docs/api/java/nio/Buffer.html#remaining--)