...
> 原文: [https://www.geeksforgeeks.org/distributed-objects-in-ejbenterprise-java-beans-explicit-vs-implicit-middleware/](https://www.geeksforgeeks.org/distributed-objects-in-ejbenterprise-java-beans-explicit-vs-implicit-middleware/)
...
随着分布式对象的应用变得越来越大，需要事务&安全等中间件服务。有两种方法可以得到它:
...
可以购买中间件&编写调用中间件 API 的代码。传统的分布式对象编程(如 CORBA)使用了这样一个过程。
...
是无需编写中间件 API，就可以在企业应用中驾驭复杂中间件的地方。人们需要遵循这些步骤来利用中间件的力量，如下图所示
