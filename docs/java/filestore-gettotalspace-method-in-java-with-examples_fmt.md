...
> 原文: [https://www.geeksforgeeks.org/filestore-gettotalspace-method-in-java-with-examples/](https://www.geeksforgeeks.org/filestore-gettotalspace-method-in-java-with-examples/)

一个`FileStore`类的`getTotalSpace()`方法用于返回文件存储的总大小，以字节为单位。此方法将总大小作为长值返回。
