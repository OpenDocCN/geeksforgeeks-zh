...
> 原文：`https://www.geeksforgeeks.org/logmanager-getlogmanager-method-in-java-with-examples/`
...
`https://docs.oracle.com/javase/9/docs/api/java/util/logging/LogManager.html#getLogManager--`