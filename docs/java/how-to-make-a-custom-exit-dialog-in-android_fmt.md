...
> 原文：[https://www.geeksforgeeks.org/how-to-make-a-custom-exit-dialog-in-android/](https://www.geeksforgeeks.org/how-to-make-a-custom-exit-dialog-in-android/)
...
我们还创建了一个新的可绘制文件（`card_round.xml`）并将 elasq，flaticon 引用为 [警报图标](https://elasq.com/icon/alert-icon-free/)，并将其粘贴到可绘制文件夹中。`card_round.xml` 代码如下
