# 用示例复制 Java 中的 Collections.copy() 方法

> 原文：[https://www.geeksforgeeks.org/collections-copy-method-in-java-with-examples/](https://www.geeksforgeeks.org/collections-copy-method-in-java-with-examples/)
...
如果目标列表太小，无法包含整个源列表，此方法将抛出 `IndexOutOfBoundsException`。

以下是说明 `checkData()` 方法的示例。
