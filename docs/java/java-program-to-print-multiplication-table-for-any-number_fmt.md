...
> 原文:[https://www.geeksforgeeks.org/java-program-to-print-multiplication-table-for-any-number/](https://www.geeksforgeeks.org/java-program-to-print-multiplication-table-for-any-number/)
...
1. 使用 `for` 循环打印 10 以内的乘法表。
2. 使用 `while` 循环打印给定范围内的乘法表。

### 方法 1: 使用 `for` 循环打印 10 以内的乘法表
