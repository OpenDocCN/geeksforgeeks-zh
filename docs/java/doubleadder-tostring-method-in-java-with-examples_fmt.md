...
> 原文: [https://www.geeksforgeks.org/doubleadder-tostring-method-in-java-with-examples/](https://www.geeksforgeks.org/doubleadder-tostring-method-in-java-with-examples/)

`DoubleAdder.toString()` 是 `java` 中的一个内置方法，返回 `sum()` 方法的 `String` 表示形式。创建类的对象时，其初始值为零。
...
**参考:** [https://docs.oracle.com/javase/8/docs/api/java/util/concurrent/atomic/DoubleAdder.html#toString--](https://docs.oracle.com/javase/8/docs/api/java/util/concurrent/atomic/DoubleAdder.html#toString--)