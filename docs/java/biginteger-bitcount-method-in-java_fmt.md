...
> 原文: [https://www.geeksforgeeks.org/biginteger-bitcount-method-in-java/](https://www.geeksforgeeks.org/biginteger-bitcount-method-in-java/)

先决条件: [大整数基础知识](https://www.geeksforgeeks.org/biginteger-class-in-java/)

`bitCount()`方法返回这个大整数的二进制补码表示中与其符号位不同的位数。当在大整数上实现位向量样式集时，此方法很有用。
...
**参考:** [https://docs.oracle.com/javase/7/docs/api/java/math/BigInteger.html#bitCount()](https://docs.oracle.com/javase/7/docs/api/java/math/BigInteger.html#bitCount())