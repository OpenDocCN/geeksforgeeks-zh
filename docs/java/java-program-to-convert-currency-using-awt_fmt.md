...
> 原文: [https://www.geeksforgeeks.org/java-program-to-convert-currency-using-awt/](https://www.geeksforgeeks.org/java-program-to-convert-currency-using-awt/)
...
6.  最后，为了改变值，我们使用 `Object.setText(object)`，第二个对象是选择我们想要替换的字段。
