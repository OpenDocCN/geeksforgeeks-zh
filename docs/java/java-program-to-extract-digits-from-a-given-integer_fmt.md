...
> 原文: [https://www.geeksforgeeks.org/java-program-to-extract-digits-from-a-given-integer/](https://www.geeksforgeeks.org/java-program-to-extract-digits-from-a-given-integer/)
...
*   使用 `Integer.toString()` 函数 (使用内置方法)
*   使用模运算符

**方法 1: 使用 `Integer.toString()`**

这个方法是一个已经存在于 java 目录中的内置方法，它返回字符串对象。这个字符串对象代表整数值。

**语法:** 因为字符串在 java 中是不可变的，这意味着字符串在 Java 中是一个类。所以，
