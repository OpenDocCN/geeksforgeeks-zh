...
> 原文:[https://www.geeksforgeeks.org/building-a-machine-learning-model-using-j48-classifier/](https://www.geeksforgeeks.org/building-a-machine-learning-model-using-j48-classifier/)
...
现在我们已经讨论完了，`Weka` 有 `Java API`，你可以用它来创建机器学习模型，所以现在让我们用 `API` 来创建一个模型
