...
> 原文：[https://www.geeksforgeeks.org/how-to-fetch-audio-file-from-storage-in-android/](https://www.geeksforgeeks.org/how-to-fetch-audio-file-from-storage-in-android/)
...
在这里，我们触发“音频”类型的意图，并将动作作为 `ACTION_GET_CONTENT`。转到 `MainActivity.java` 文件，参考以下代码。下面是 `MainActivity.java` 文件的代码。代码中添加了注释，以更详细地理解代码。
