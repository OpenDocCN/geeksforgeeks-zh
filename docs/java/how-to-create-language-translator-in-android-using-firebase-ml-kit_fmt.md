...
> 原文：[https://www.geeksforgeeks.org/how-to-create-language-translator-in-android-using-firebase-ml-kit/](https://www.geeksforgeeks.org/how-to-create-language-translator-in-android-using-firebase-ml-kit/)
...
点击此选项后，您将看到下面的屏幕。在此屏幕上，点击**连接到 Firebase** 选项，将您的应用程序连接到 Firebase。点击连接选项，将你的应用程序连接到 Firebase，并将下面的依赖项添加到你的 `build.gradle` 文件中。
...
[观看演示视频](https://media.geeksforgeeks.org/wp-content/uploads/20210211162847/Screenrecorder-2021-02-11-16-18-41-56.mp4)
