...
> 原文: [https://www.geeksforgeeks.org/longadder-intvalue-method-in-java-with-examples/](https://www.geeksforgeeks.org/longadder-intvalue-method-in-java-with-examples/)

`LongAdder`类创建一个初始和为零的新加法器。`LongAdder.intValue()` 是 Java 中的一个内置方法，它将总和作为 `int` 值返回。创建类的对象时，其初始值为零。
