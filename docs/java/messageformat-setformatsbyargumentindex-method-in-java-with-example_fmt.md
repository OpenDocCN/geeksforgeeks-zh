...
> 原文：[https://www.geeksforgeeks.org/messageformat-setformatsbyargumentindex-method-in-java-with-example/](https://www.geeksforgeeks.org/messageformat-setformatsbyargumentindex-method-in-java-with-example/)
...
如果新格式元素数组为空，该方法抛出 `NullPointerException`。
...
[https://docs.oracle.com/javase/9/docs/api/java/text/MessageFormat.html#setFormatsByArgumentIndex-java.text.Format:A-](https://docs.oracle.com/javase/9/docs/api/java/text/MessageFormat.html#setFormatsByArgumentIndex-java.text.Format:A-)