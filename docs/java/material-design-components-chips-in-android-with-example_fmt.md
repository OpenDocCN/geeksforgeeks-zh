...
> 原文：[https://www.geeksforgeeks.org/material-design-components-chips-in-android-with-example/](https://www.geeksforgeeks.org/material-design-components-chips-in-android-with-example/)
...
*   调用 `MainActivity.java` 文件中的以下代码来处理芯片按钮，它显示了简单的 Toast 消息。
