# Java 中的 ByteBuffer replicate() 方法及示例

> 原文：[https://www.geeksforgeeks.org/bytebuffer-duplicate-method-in-java-with-examples/](https://www.geeksforgeeks.org/bytebuffer-duplicate-method-in-java-with-examples/)
...
该方法返回携带前一字节缓冲区内容的新字节缓冲区。

以下是说明 `replicate()` 方法的示例：
