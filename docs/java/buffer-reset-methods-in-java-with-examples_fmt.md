...
> 原文：[https://www.geeksforgeeks.org/buffer-reset-methods-in-java-with-examples/](https://www.geeksforgeeks.org/buffer-reset-methods-in-java-with-examples/)
...
[https://docs.oracle.com/javase/9/docs/api/java/nio/Buffer.html#reset--](https://docs.oracle.com/javase/9/docs/api/java/nio/Buffer.html#reset--)