...
> 原文: [https://www.geeksforgeeks.org/linkedblockingqueue-toarray-method-in-java/](https://www.geeksforgeeks.org/linkedblockingqueue-toarray-method-in-java/)
...
public class GFG {
    public static void main(String[] args) {
        ...
        LinkedBlockingQueue<Integer> linkedQueue = new LinkedBlockingQueue<Integer>(capacityOfQueue);
...
**程序 2:** 在 `toArray(T[] a)`中传递不同于 `LinkedBlockingQueue` 包含的元素类型的数组。`toArray(T[] a)`方法将因此引发异常 `ArrayStoreException`。
...
**程序 3:** 在 `toArray(T[] a)`中传递空数组。因此 `toArray(T[] a)`方法将引发 `NullPointerException`。
...
*   [`https://docs.oracle.com/javase/8/docs/api/java/util/concurrent/LinkedBlockingQueue.html#toArray--`](https://docs.oracle.com/javase/8/docs/api/java/util/concurrent/LinkedBlockingQueue.html#toArray--)
*   [`https://docs.oracle.com/javase/8/docs/api/java/util/concurrent/LinkedBlockingQueue.html#toArray-T:A-`](https://docs.oracle.com/javase/8/docs/api/java/util/concurrent/LinkedBlockingQueue.html#toArray-T:A-)