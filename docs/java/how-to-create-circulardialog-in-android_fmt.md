...
> 原文：[https://www.geeksforgeeks.org/how-to-create-circulardialog-in-android/](https://www.geeksforgeeks.org/how-to-create-circulardialog-in-android/)
...
| 属性 | 描述 |
| --- | --- |
| `CDConstants.SUCCESS` | 在循环对话框中显示成功消息。 |
| `.setAnimation` | 用于将动画设置为循环对话框。 |
| `.setTextSize` | 用于在循环对话框中设置文本大小。 |
| `.setDuration` | 用于以毫秒为单位设置动画时间。 |
| `CDConstants.LARGE` | 用于设置对话框的大小。 |
...
[视频演示](https://media.geeksforgeeks.org/wp-content/uploads/20210117163728/Screenrecorder-2021-01-17-16-32-45-522.mp4)