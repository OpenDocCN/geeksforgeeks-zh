...
> 原文:[https://www . geeksforgeks . org/monthday-getdayofmonth-method-in-Java-with-examples/](https://www.geeksforgeeks.org/monthday-getdayofmonth-method-in-java-with-examples/)

Java 中`MonthDay`类的`getDayOfMonth()`方法得到月日字段。
