...
> 原文: [https://www.geeksforgeeks.org/java-program-to-list-all-files-in-a-directory-and-nested-sub-directories/](https://www.geeksforgeeks.org/java-program-to-list-all-files-in-a-directory-and-nested-sub-directories/)

**先决条件:** [`File` 类](https://www.geeksforgeeks.org/file-class-in-java/)

给定一个主目录/文件夹，列出其中的所有文件，如果这个目录有其他嵌套的子目录，列出其中的文件。在上面的问题中很容易观察到一个简单的递归模式。

**算法:**

1.  为 home 目录创建一个 `File` 对象。
2.  获取 home 目录的文件数组。
3.  如果数组 `[i]` 是一个文件：
    *   打印出文件名。
4.  如果数组 `[i]` 是一个目录：
