...
> 原文：[https://www.geeksforgeeks.org/count-of-words-ending-at-the-given-suffix-in-java/](https://www.geeksforgeeks.org/count-of-words-ending-at-the-given-suffix-in-java/)
...
*   使用 `split()` 方法提取给定句子中的所有单词。
*   现在对于每个单词，使用 `endsWith()` 方法检查当前单词是否以给定的后缀结束。
