...
> 原文：[https://www.geeksforgeeks.org/implement-various-types-of-partitions-in-quick-sort-in-java/](https://www.geeksforgeeks.org/implement-various-types-of-partitions-in-quick-sort-in-java/)
...
**注：**
> 快速排序算法一般是不稳定的算法，因为快速排序无法保持元素的相对顺序。
