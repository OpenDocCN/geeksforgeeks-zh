...
但是，有很多**理由让你熟悉 SAX**，即使你使用的是 DOM。下面是 SAX 相对于 [DOM](https://www.geeksforgeeks.org/dom-document-object-model/) 的各种**优势**：
...
2.  **`InputSource`**: 这个类允许 SAX 应用程序将关于输入源的信息封装在一个对象中，该对象可以包括公共标识符、系统标识符、字节流(可能具有指定的编码)和/或字符流。
