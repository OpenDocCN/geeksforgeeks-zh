# Java 中的 BitSet clone()方法，示例

> 原文：[https://www.geeksforgeeks.org/bitset-clone-method-in-java-with-examples/](https://www.geeksforgeeks.org/bitset-clone-method-in-java-with-examples/)
...
下面的程序说明了`BitSet clone()`方法在Java中的工作原理。
