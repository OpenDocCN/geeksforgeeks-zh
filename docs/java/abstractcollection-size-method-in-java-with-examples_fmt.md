...
> 原文: [https://www.geeksforgeeks.org/abstractcollection-size-method-in-java-with-examples/](https://www.geeksforgeeks.org/abstractcollection-size-method-in-java-with-examples/)

[`AbstractCollection`](https://www.geeksforgeeks.org/abstractcollection-in-java-with-examples/) 的 `size()` 方法用于获取集合的大小或集合中存在的元素数量。
