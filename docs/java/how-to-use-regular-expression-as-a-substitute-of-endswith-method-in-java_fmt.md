...
> 原文: [https://www.geeksforgeeks.org/how-to-use-regular-expression-as-a-substitute-of-endswith-method-in-java/](https://www.geeksforgeeks.org/how-to-use-regular-expression-as-a-substitute-of-endswith-method-in-java/)

所以主要讨论什么是 `endsWith()`方法，所以它是 `String` 类的一个方法，检查字符串是否以指定的后缀结尾。此方法返回一个 `boolean` 值 `true` 或 `false`。
