...
> 原文：[https://www.geeksforgeeks.org/how-to-add-hyperlink-to-the-contents-of-a-cell-using-java/](https://www.geeksforgeeks.org/how-to-add-hyperlink-to-the-contents-of-a-cell-using-java/)
...
1.  从 `poi.apache.org/download.html` 下载下面提到的 Jar 文件
    *   [`poi-3.17.jar`](https://mvnrepository.com/artifact/org.apache.poi/poi/3.17)
    *   [`poi-ooxml-3.17.jar`](https://mvnrepository.com/artifact/org.apache.poi/poi-ooxml/3.17)
    *   [`commons-codec-1.10.jar`](https://mvnrepository.com/artifact/commons-codec/commons-codec/1.10)
    *   [`poi-ooxml-schemas-3.17.jar`](https://mvnrepository.com/artifact/org.apache.poi/poi-ooxml-schemas/3.17)
...
*   现在，在源代码包中的 `com.mycompany.<your project name>` 下创建一个 java 类。
*   很好，现在你可以用图书馆了。
