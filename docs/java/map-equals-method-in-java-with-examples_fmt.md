...
> 原文: [https://www.geeksforgeeks.org/map-equals-method-in-java-with-examples/](https://www.geeksforgeeks.org/map-equals-method-in-java-with-examples/)
...
该方法接受该地图类型的一个参数 `object`，并引用要用该地图检查其相等性的地图。
