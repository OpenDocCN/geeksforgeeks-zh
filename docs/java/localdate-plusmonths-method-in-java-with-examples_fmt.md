...
> 原文: [https://www.geeksforgeeks.org/localdate-plusmonths-method-in-java-with-examples/](https://www.geeksforgeeks.org/localdate-plusmonths-method-in-java-with-examples/)
...
此方法接受单个参数 `monthsToAdd`，代表要添加的月份，可以是负数。

## 返回值

该方法返回一个基于该日期的 `LocalDate`，加上月份，不为空。
...
[https://docs.oracle.com/javase/10/docs/api/java/time/LocalDate.html#plusMonths(long)](https://docs.oracle.com/javase/10/docs/api/java/time/LocalDate.html#plusMonths(long))