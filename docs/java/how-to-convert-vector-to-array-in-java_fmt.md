...
> 原文: [https://www.geeksforgeeks.org/how-to-convert-vector-to-array-in-java/](https://www.geeksforgeeks.org/how-to-convert-vector-to-array-in-java/)
...
1.  获取向量。
2.  使用 [`toArray()` 方法](https://www.geeksforgeeks.org/vector-toarray-method-in-java-with-examples/) 将向量转换为对象数组
...
## 方法 2: 使用 toArray(new String[vector.size()]) 方法

进场:

1.  创建了矢量字符串类型。
2.  使用 `add(E)` 方法将元素添加到矢量中。
