...
> 原文: [https://www.geeksforgeeks.org/copyonwritearrayset-add-method-in-java/](https://www.geeksforgeeks.org/copyonwritearrayset-add-method-in-java/)

`add(E e)` 方法将参数中传递的元素插入到集合的末尾或集合中的指定索引处。向集合中添加新元素时，该函数返回 `true`。
...
## 参数:
该函数接受单个强制参数 `元素`，该元素指定要添加到集合中的元素。
...
## 参考:
[https://docs.oracle.com/javase/8/docs/api/java/util/concurrent/CopyOnWriteArraySet.html#add-E-](https://docs.oracle.com/javase/8/docs/api/java/util/concurrent/CopyOnWriteArraySet.html#add-E-)