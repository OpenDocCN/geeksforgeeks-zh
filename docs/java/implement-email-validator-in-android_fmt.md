...
> 原文：[https://www.geeksforgeeks.org/implement-email-validator-in-android/](https://www.geeksforgeeks.org/implement-email-validator-in-android/)
...
*   有关安卓系统中预定义模式的更多信息，请参考[`Patterns`](https://developer.android.com/reference/android/util/Patterns)。
