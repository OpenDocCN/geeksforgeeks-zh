...
> 原文: [https://www.geeksforgeeks.org/different-ways-to-prevent-method-overriding-in-java/](https://www.geeksforgeeks.org/different-ways-to-prevent-method-overriding-in-java/)

继承是任何面向对象编程（OOP）语言的基本规则，但是仍然有一些方法可以防止子类中的方法重写，如下所示：

`方法:`

1.  使用 [`static`](https://www.geeksforgeeks.org/static-methods-vs-instance-methods-java/) 方法
2.  使用 [`private`](https://www.geeksforgeeks.org/access-modifiers-java/) 访问修饰符
3.  使用 [`default`](https://www.geeksforgeeks.org/access-modifiers-java/) 访问修改器
4.  使用 [`final`](https://www.geeksforgeeks.org/final-keyword-java/) 关键词方法
...
防止覆盖的最后一种方法是通过在你的方法中使用 [`final`](https://www.geeksforgeeks.org/final-keyword-java/) 关键字。`final` 关键字终止了继承。因此，如果一个方法成为最终的，它将被认为是最终的实现，没有其他类可以覆盖这个行为。
