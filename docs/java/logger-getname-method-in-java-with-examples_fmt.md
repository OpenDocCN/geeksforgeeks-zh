...
> 原文: [https://www.geeksforgeeks.org/logger-getname-method-in-java-with-examples/](https://www.geeksforgeeks.org/logger-getname-method-in-java-with-examples/)

`getName()` 是 `Logger` 类的一个方法，用来获取 Logger 的名称。很多时候，您必须检查记录器名称，以便我们可以使用此方法来获取记录器名称。
