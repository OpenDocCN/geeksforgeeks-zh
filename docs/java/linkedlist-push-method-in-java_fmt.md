...
> 原文: [https://www.geeksforgeeks.org/linkedlist-push-method-in-java/](https://www.geeksforgeeks.org/linkedlist-push-method-in-java/)
...
该方法接受一个对象类型的参数`element`，表示要插入的元素。类型`Object`应该是由链接列表表示的同一堆栈。

## 返回类型

该方法的返回类型为`void`，即不返回任何值。
