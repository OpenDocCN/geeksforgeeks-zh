...
> 原文: [https://www.geeksforgeeks.org/hashset-remove-method-in-java/](https://www.geeksforgeeks.org/hashset-remove-method-in-java/)

`HashSet remove()`方法用于从 `HashSet` 中移除特定元素。请注意，它仅在 JDK 1.2 版之后可用，并且会在 JDK 1 和 JDK 1.1 版之前抛出编译错误。
