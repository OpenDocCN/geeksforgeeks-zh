...
> 原文：[https://www.geeksforgeeks.org/how-to-convert-arraylist-to-hashset-in-java/](https://www.geeksforgeeks.org/how-to-convert-arraylist-to-hashset-in-java/)

[`ArrayList`](https://www.geeksforgeeks.org/arraylist-in-java/)：在 Java 中，数组列表可以有重复项，也可以保持插入顺序。
...
## 方法四：使用[流](https://www.geeksforgeeks.org/stream-in-java/)
