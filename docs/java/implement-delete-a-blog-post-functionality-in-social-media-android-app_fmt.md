...
> 原文：[https://www.geeksforgeeks.org/implement-delete-a-blog-post-functionality-in-social-media-android-app/](https://www.geeksforgeeks.org/implement-delete-a-blog-post-functionality-in-social-media-android-app/)
...
这是一个用于`RecyclerView`的`ViewHolder`类。
