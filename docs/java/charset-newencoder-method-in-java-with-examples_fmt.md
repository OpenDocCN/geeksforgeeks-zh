...
> 原文：`https://www.geeksforgeeks.org/charset-newencoder-method-in-java-with-examples/`
...
如果字符集不支持编码，函数抛出 `UnsupportedOperationException`。
...
`https://docs.oracle.com/javase/9/docs/api/java/nio/charset/Charset.html#newEncoder--`