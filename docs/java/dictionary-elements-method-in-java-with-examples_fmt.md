# Java 中的 Dictionary.elements() 方法，带示例

> 原文：[https://www.geeksforgeeks.org/dictionary-elements-method-in-java-with-examples/](https://www.geeksforgeeks.org/dictionary-elements-method-in-java-with-examples/)

Java 中 `Dictionary` 类的 `elements()` 方法用于获取字典中存在的值的枚举。
