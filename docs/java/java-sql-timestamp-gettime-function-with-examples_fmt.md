...
> 原文: [https://www.geeksforgeeks.org/java-sql-timestamp-gettime-function-with-examples/](https://www.geeksforgeeks.org/java-sql-timestamp-gettime-function-with-examples/)
...
### 示例 2
创建时间戳，使用 `getTime()` 获取时间戳对象的时间，并将时间设置在 1970 年 1 月 1 日之前。负长值代表 1970 年 1 月 1 日之前的时间。
...
## 参考
[https://docs.oracle.com/javase/7/docs/api/java/sql/Timestamp.html](https://docs.oracle.com/javase/7/docs/api/java/sql/Timestamp.html)