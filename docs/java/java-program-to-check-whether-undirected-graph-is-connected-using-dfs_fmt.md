...
> 原文: [https://www.geeksforgeeks.org/java-program-to-check-whether-undirected-graph-is-connected-using-dfs/](https://www.geeksforgeeks.org/java-program-to-check-whether-undirected-graph-is-connected-using-dfs/)
...
1.  取一个布尔 `visited[]` 数组。
2.  从任一顶点开始深度优先搜索，并在 `visited[]` 数组中将访问的顶点标记为真。
3.  完成 DFS 后，检查 `visited[]` 数组中的所有顶点是否都标记为真。
