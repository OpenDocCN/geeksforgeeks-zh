...
> 原文: [https://www.geeksforgeeks.org/hashmap-remove-method-in-java/](https://www.geeksforgeeks.org/hashmap-remove-method-in-java/)
...
参数: 该方法采用一个参数 `key`，其映射将从地图中移除。
返回值: 该方法返回之前映射到指定键的值，如果该键不存在，则该方法返回空值。
