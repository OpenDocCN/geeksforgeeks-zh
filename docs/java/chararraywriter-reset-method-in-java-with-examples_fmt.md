...
Java 中的 `CharArrayWriter` 类的 `reset()` 方法用于重置缓冲区，以便可以再次使用，而不会扔掉已经分配的缓冲区。
...
**参考：** [https://docs.oracle.com/javase/10/docs/api/java/io/CharArrayWriter.html#reset()](https://docs.oracle.com/javase/10/docs/api/java/io/CharArrayWriter.html#reset())