...
> 原文：[https://www.geeksforgeeks.org/how-to-integrate-razorpay-payment-gateway-in-android/](https://www.geeksforgeeks.org/how-to-integrate-razorpay-payment-gateway-in-android/)
...
### 第二步：在 build.gradle 文件中添加 Razor 支付库的依赖关系
...
导航到 `app > AndroidManifest.xml` 文件，并在其中添加以下代码。
