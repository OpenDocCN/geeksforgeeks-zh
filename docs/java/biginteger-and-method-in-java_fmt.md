...
> 原文: [https://www.geeksforgeeks.org/biginteger-and-method-in-java/](https://www.geeksforgeeks.org/biginteger-and-method-in-java/)
...
该方法接受一个`BigInteger`类型的参数`val`，并引用要与当前大整数“与”的值。
...
[https://docs.oracle.com/javase/7/docs/api/java/math/BigInteger.html#and(java.math.BigInteger)](https://docs.oracle.com/javase/7/docs/api/java/math/BigInteger.html#and(java.math.BigInteger))