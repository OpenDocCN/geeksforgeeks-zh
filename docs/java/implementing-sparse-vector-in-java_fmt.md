...
> 原文：[https://www.geeksforgeeks.org/implementing-sparse-vector-in-java/](https://www.geeksforgeeks.org/implementing-sparse-vector-in-java/)
...
public class SparseVector {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Enter number of entries for Vector A :");
        int n1 = scan.nextInt();
        System.out.println("Enter " + n1 + " (int, double) pairs :");
        for (int i = 0; i < n1; i++)
            A.put(scan.nextInt(), scan.nextDouble());

        System.out.println("Enter number of entries for vector B :");
        int n2 = scan.nextInt();
