...
> 原文: [https://www.geeksforgeeks.org/how-to-update-data-in-api-using-volley-in-android/](https://www.geeksforgeeks.org/how-to-update-data-in-api-using-volley-in-android/)

## 先决条件

*   [使用凌空库](https://www.geeksforgeeks.org/json-parsing-in-android-using-volley-library/) 解析安卓系统中的 JSON
*   [如何在安卓中使用凌空将数据发布到 API？](https://www.geeksforgeeks.org/how-to-post-data-to-api-using-volley-in-android/)
