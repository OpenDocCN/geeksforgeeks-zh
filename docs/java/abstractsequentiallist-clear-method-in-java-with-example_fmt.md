# Java中的AbstractSequentialList.clear()方法示例

> 原文：`https://www.geeksforgeeks.org/abstractsequentiallist-clear-method-in-java-with-example/`

Java中`AbstractSequentialList`的`clear()`方法用于移除列表中的所有元素。该调用返回后，列表将为空。
