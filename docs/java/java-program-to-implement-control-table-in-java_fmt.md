...
> 原文：[https://www.geeksforgeeks.org/java-program-to-implement-control-table-in-java/](https://www.geeksforgeeks.org/java-program-to-implement-control-table-in-java/)
...
在 Java 程序下面展示了用于改变 ASCII 码的控制表的用法。我们使用了`populatable()`方法，该方法使用`HashMap`来存储新的 ASCII 码。它不需要任何争论。
