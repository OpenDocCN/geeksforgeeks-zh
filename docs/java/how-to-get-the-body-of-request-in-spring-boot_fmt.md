...
> 原文：[https://www.geeksforgeeks.org/how-to-get-the-body-of-request-in-spring-boot/](https://www.geeksforgeeks.org/how-to-get-the-body-of-request-in-spring-boot/)
...
**第四步：** 转到 `src->main->java->com.gfg.spring.boot.app` 并创建一个名为 `Controller` 的 Java 类，并添加注释 `@RestController`。现在创建如下所示的 GET 应用编程接口：
