...
> 原文: [https://www.geeksforgeeks.org/gregoriancalendar-settimezone-method-in-java/](https://www.geeksforgeeks.org/gregoriancalendar-settimezone-method-in-java/)
...
## 参数:
该方法采用指定新时区值的`TimeZone`对象的一个参数`tz`。
