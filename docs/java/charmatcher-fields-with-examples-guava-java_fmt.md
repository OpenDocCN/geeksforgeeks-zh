...
`CharMatcher.DIGIT` 根据 Unicode 判断一个字符是否是数字。如果您只想匹配 ASCII 数字，可以使用 `range('0', '9')`。
...
**参考:**[https://Google . github . io/guava/releases/19.0/API/docs/com/Google/common/base/charmatcher . html # DIGIT](https://google.github.io/guava/releases/19.0/api/docs/com/google/common/base/CharMatcher.html#DIGIT)

### JAVA_LETTER

`CharMatcher.JAVA_LETTER` 根据 JAVA 的定义判断一个字符是字母还是数字。
...
`CharMatcher.ANY` 字段匹配任意字符，即匹配所有字符。
...
`CharMatcher.JAVA_LOWER_CASE` 根据 JAVA 的定义，判断一个字符是否是小写。
...
**参考:**[https://Google . github . io/guava/releases/19.0/API/docs/com/Google/common/base/charmatcher . html # JAVA _ low _ CASE](https://google.github.io/guava/releases/19.0/api/docs/com/google/common/base/CharMatcher.html#JAVA_LOWER_CASE)

### JAVA_UPPER_CASE

`CharMatcher.JAVA_UPPER_CASE` 根据 JAVA 的定义判断一个字符是否是大写。
...
**参考:** [https://Google . github . io/guava/releases/19.0/API/docs/com/Google/common/base/charmatcher . html # JAVA _ digest](https://google.github.io/guava/releases/19.0/api/docs/com/google/common/base/CharMatcher.html#JAVA_DIGIT)