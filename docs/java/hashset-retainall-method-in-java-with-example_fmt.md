...
> 原文:[https://www.geeksforgeeks.org/hashset-retainall-method-in-java-with-example/](https://www.geeksforgeeks.org/hashset-retainall-method-in-java-with-example/)

`java.util.HashSet` 类的 `retainAll()` 方法用于从该集合中保留指定集合中包含的所有元素。
