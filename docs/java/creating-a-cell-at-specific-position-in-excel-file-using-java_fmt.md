...
> 原文: [https://www.geeksforgeeks.org/creating-a-cell-at-specific-position-in-excel-file-using-java/](https://www.geeksforgeeks.org/creating-a-cell-at-specific-position-in-excel-file-using-java/)

`阿帕奇 POI` 可用于在给定 Excel 文件中特定位置创建单元格。Apache POI 是 Apache 基金会提供的一个 API。
...
2.  在 `pom.xml` 文件中添加以下 maven 依赖项：
    ...
    ```
3.  在 `javaresource` 文件夹中编写 java 代码：
    ```java
    import java.io.*;
    ...
    public class CreateCellAtSpecificPosition {
        public static void main(String[] args) throws FileNotFoundException, IOException {
            ...
            // Creating a row at specific position using predefined class provided by Apache POI
            // Specific row number
...
**极客 xlsx 文件**中的输出：
![](img/ae7e5b1ff503c7ebd4cae663a6634439.png)