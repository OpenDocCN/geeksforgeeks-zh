...
> 原文：[https://www.geeksforgeeks.org/class-getfields-method-in-java-with-examples/](https://www.geeksforgeeks.org/class-getfields-method-in-java-with-examples/)

[`java.lang.Class`](https://www.geeksforgeeks.org/java-lang-class-class-java-set-1/) 类的 `getFields()` 方法用于获取该类的字段，这些字段是公共字段及其成员。方法以字段对象数组的形式返回该类的字段。
