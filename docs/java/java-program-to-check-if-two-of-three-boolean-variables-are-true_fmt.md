...
> 原文：[https://www.geeksforgeeks.org/java-program-to-check-if-two-of-three-boolean-variables-are-true/](https://www.geeksforgeeks.org/java-program-to-check-if-two-of-three-boolean-variables-are-true/)
...
我们初始化三个布尔变量`flag1`、`flag2`和`flag3`，一个布尔值为假，一个值为真。
...
这里，我们检查`flag1`是否为真，如果`flag2`或`flag3`中有一个为真，那么`ans`应该为真。否则，如果`flag1`为假，那么当`flag2`和`flag3`都为真时，`ans`将为真。
