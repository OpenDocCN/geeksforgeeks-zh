...
> 原文：[https://www.geeksforgeeks.org/java-program-to-compute-the-running-total-of-a-list/](https://www.geeksforgeeks.org/java-program-to-compute-the-running-total-of-a-list/)
...
*   **第 7 步：** 使用 `hasNext()` 方法迭代正在运行的总列表的元素，直到列表中剩下一个元素。
*   **步骤 8：** 打印将运行总列表的列表。

## 实现

下面的 Java 程序用来说明元素列表运行总数的计算。
