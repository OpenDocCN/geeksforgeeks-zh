...
> 原文: [https://www.geeksforgeeks.org/how-to-use-header2actionbar-library-in-android-app/](https://www.geeksforgeeks.org/how-to-use-header2actionbar-library-in-android-app/)
...
在安卓工作室创建新项目请参考 [【如何在安卓工作室创建/启动新项目】](https://www.geeksforgeeks.org/android-how-to-create-start-a-new-project-in-android-studio/)。请注意，选择 `Java` 作为编程语言。
...
*   右键点击 `主`，选择 `新建 > 目录`
*   键入 `libs` 作为目录名
*   从 [这里](https://github.com/AChep/Header2ActionBar/blob/master/sample/Header2ActionBarDemo/src/main/libs/Header2ActionBar-0.2.1.jar) 下载库，粘贴到 `libs` 目录里面。
...
导航至 `应用程序 > res > 值 > styles.xml` 并参考以下代码。下面是 `styles.xml` 文件的代码。
