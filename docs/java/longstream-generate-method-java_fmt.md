...
> 原文: [https://www.geeksforgeeks.org/longstream-generate-method-java/](https://www.geeksforgeeks.org/longstream-generate-method-java/)
...
2.  `LongSupplier` : the supplier of long-value elements.
