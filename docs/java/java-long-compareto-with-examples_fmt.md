# Java Long.compareTo() 方法详解

> 原文：[https://www.geeksforgeeks.org/java-long-compareto-with-examples/](https://www.geeksforgeeks.org/java-long-compareto-with-examples/)
