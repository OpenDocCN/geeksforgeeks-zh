...
> 原文：[https://www.geeksforgeeks.org/formatting-the-text-in-a-pdf-using-java/](https://www.geeksforgeeks.org/formatting-the-text-in-a-pdf-using-java/)
...
PDF 文档类是在 **iText** 中表示 PDF 文档的类。这个类属于 `com.itextpdf.kernel.pdf` 包。要创建这个类（在编写模式下），您需要将一个类别为 `PdfWriter` 的对象传递给它的构造函数。
