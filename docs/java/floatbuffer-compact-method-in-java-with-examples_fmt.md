# Java中的FloatBuffer compact()方法示例

> 原文：[https://www.geeksforgeeks.org/floatbuffer-compact-method-in-java-with-examples/](https://www.geeksforgeeks.org/floatbuffer-compact-method-in-java-with-examples/)
...
该方法返回与该缓冲区内容相同的新浮动缓冲区。

## 异常

如果这个缓冲区是只读的，这个方法抛出`ReadOnlyBufferException`。

下面的程序说明了`compact()`的方法：
