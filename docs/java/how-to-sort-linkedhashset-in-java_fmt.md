...
> 原文: [https://www.geeksforgeeks.org/how-to-sort-linkedhashset-in-java/](https://www.geeksforgeeks.org/how-to-sort-linkedhashset-in-java/)
...
*   使用[`ArrayList`](https://www.geeksforgeeks.org/arraylist-in-java/)
*   使用[`TreeSet`](https://www.geeksforgeeks.org/treeset-in-java-with-examples/)
*   使用[流](https://www.geeksforgeeks.org/stream-in-java/)

## 方法 1 (使用 `ArrayList`)

在这个方法中，我们将 `LinkedHashSet` 转换成一个 `ArrayList`，然后使用 [`Collections`](https://www.geeksforgeeks.org/collections-in-java-2/) 类的 [`sort()`](https://www.geeksforgeeks.org/collections-sort-java-examples/) `方法`对 `ArrayList` 进行排序。
