# Java 中 Matcher.replaceAll(Function) 方法示例

> 原文: [https://www.geeksforgeeks.org/matcher-replaceallfunction-method-in-java-with-examples/](https://www.geeksforgeeks.org/matcher-replaceallfunction-method-in-java-with-examples/)

`Matcher`类的`replaceAll(Function)`方法表现为一种追加和替换方法。此方法用参数中传递的函数替换匹配器中匹配的模式的所有实例。
