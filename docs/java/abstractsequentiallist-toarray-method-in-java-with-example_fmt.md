# Java 中 AbstractSequentialList.toArray() 方法示例

> 原文：[https://www.geeksforgeks.org/abstractsequentiallist-toarray-method-in-java-with-example/](https://www.geeksforgeks.org/abstractsequentiallist-toarray-method-in-java-with-example/)

`AbstractSequentialList` 的 `toArray()` 方法用于形成与抽象顺序列表相同元素的数组。基本上，它将抽象序列列表中的所有元素复制到一个新数组中。
