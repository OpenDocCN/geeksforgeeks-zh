...
> 原文: [https://www.geeksforgeeks.org/java-8-clock-millis-method-with-examples/](https://www.geeksforgeeks.org/java-8-clock-millis-method-with-examples/)
...
## 异常:
如果无法从时钟获得瞬间，此方法抛出`DateTimeException`。
...
## 程序 1:
使用`millis()`和用`systemDefaultZone`创建的`Clock`对象
