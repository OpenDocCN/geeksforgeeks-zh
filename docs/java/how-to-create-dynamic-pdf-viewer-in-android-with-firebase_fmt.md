...
> 原文：[https://www.geeksforgeeks.org/how-to-create-dynamic-pdf-viewer-in-android-with-firebase/](https://www.geeksforgeeks.org/how-to-create-dynamic-pdf-viewer-in-android-with-firebase/)
...
现在验证您的应用程序是否连接到 Firebase。转到您的 `build.gradle` 文件。导航到 `应用程序 > 渐变脚本 > build.gradle` 文件，并确保以下依赖项已添加到您的依赖项部分。

> `implementation 'com.google.firebase:firebase-database:19.6.0'`

添加此依赖项后，在您的渐变文件中添加 PDF 查看器的依赖项。

### 第三步：在 build.gradle 文件中添加 PDF 查看器的依赖项
...
## 第八步：在 Firebase 控制台中为你的 PDF 添加网址
