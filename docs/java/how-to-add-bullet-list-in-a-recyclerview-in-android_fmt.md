...
## 1. 添加依赖项
在依赖项部分的回收视图中，在`build.gradle`文件中添加支持库。
...
## 2. 创建项目符号可绘制文件
在[可绘制文件夹](https://www.geeksforgeeks.org/android-project-folder-structure/)中创建`bullet.xml`文件。
...
## 4. 创建自定义列表项布局
使用以下代码创建一个新的`custom_layout.xml`文件。
