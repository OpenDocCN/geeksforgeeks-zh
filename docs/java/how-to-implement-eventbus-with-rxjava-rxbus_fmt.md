...
> 原文：[https://www.geeksforgeeks.org/how-to-implement-eventbus-with-rxjava-rxbus/](https://www.geeksforgeeks.org/how-to-implement-eventbus-with-rxjava-rxbus/)
...
![图一。了解 RxJava–RxBus](img/eeb101b2fc4d2a65010a3e86a69cf9c2.png)
...
下一步是创建一个 Singleton 应用程序，通过这个用 Java 编写的应用程序，我们可以访问上一步创建的 Rx 总线。
