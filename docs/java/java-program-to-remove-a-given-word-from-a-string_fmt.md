...
> 原文：[https://www.geeksforgeeks.org/java-program-to-remove-a-given-word-from-a-string/](https://www.geeksforgeeks.org/java-program-to-remove-a-given-word-from-a-string/)
...
1.  使用搜索技术的简单方法
2.  使用[`String.replace()`方法](https://www.geeksforgeeks.org/java-lang-string-replace-method-java/#:~:text=String%20replace()%20%3A%20This%20method,newch%20%3A%20the%20new%20character.)的最佳方法
...
## 方法二：使用[`String.replace()`方法](https://www.geeksforgeeks.org/java-lang-string-replace-method-java/#:~:text=String%20replace()%20%3A%20This%20method,newch%20%3A%20the%20new%20character.)
