...
> 原文: [https://www.geeksforgeeks.org/java-program-to-generate-harmonic-series/](https://www.geeksforgeeks.org/java-program-to-generate-harmonic-series/)

调和级数是算术级数的倒数。一般来说，一个[调和级数](https://www.geeksforgeeks.org/harmonic-progression/)中的术语可以表示为

> `h1 = 1/a`，`h2 = 1/(a+d)`，`h3 = 1/(a+2d)`，`H4 = 1/(a+3d)`………..，`hn = 1/(a+nd)`。

其中 `h` 为调和级数，`a` 为[等差数列](https://www.geeksforgeeks.org/arithmetic-progression/)，`d` 为等差数列的[公差](https://www.geeksforgeeks.org/arithmetic-progression-common-difference-and-nth-term-class-10-maths/)，`n` 为第 n 项。
