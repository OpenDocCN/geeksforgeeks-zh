...
> 原文：[`https://www.geeksforgeeks.org/calendar-islenient-method-in-java-with-examples/`](https://www.geeksforgeeks.org/calendar-islenient-method-in-java-with-examples/)
