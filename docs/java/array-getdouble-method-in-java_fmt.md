...
> 原文：[https://www.geeksforgeeks.org/array-getdouble-method-in-java/](https://www.geeksforgeeks.org/array-getdouble-method-in-java/)
...
类型转换不是必需的，因为返回类型是双精度的。

下面的程序说明了 `Array` 类的 `getDouble()` 方法。
