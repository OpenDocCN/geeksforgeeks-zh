...
> 原文: [https://www.geeksforgeeks.org/java-program-to-display-time-in-different-country-format/](https://www.geeksforgeeks.org/java-program-to-display-time-in-different-country-format/)

`Locale`类和`DateFormat`类用于显示时间不同的国家格式。
