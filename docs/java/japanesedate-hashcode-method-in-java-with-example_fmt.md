# Java 中的 `JapaneseDate` `hashCode()` 方法示例

> 原文：[https://www.geeksforgeeks.org/japanesedate-hashcode-method-in-java-with-example/](https://www.geeksforgeeks.org/japanesedate-hashcode-method-in-java-with-example/)

`java.time.chrono.JapaneseDate` 类的 `hashCode()` 方法用于获取特定日本日期的哈希代码。
