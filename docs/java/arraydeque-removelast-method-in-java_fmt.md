...
> 原文：`https://www.geeksforgeeks.org/arraydeque-removelast-method-in-java/`

`java.util.ArrayDeque.removeLast()`方法用于移除 Deque 的最后一个元素。
...
如果德格为空，该方法抛出 `NoSuchElementException`。
