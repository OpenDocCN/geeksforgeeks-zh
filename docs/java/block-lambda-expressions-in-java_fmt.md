...
> 原文: [https://www.geeksforgeeks.org/block-lambda-expressions-in-java/](https://www.geeksforgeeks.org/block-lambda-expressions-in-java/)
...
在这种情况下，lambda 在其 lambda 主体中可能需要不止一个表达式。Java 支持表达式 Lambdas，它包含具有多个语句的代码块。我们称这种类型的λ体为“块状体”。包含块体的 Lambda 可称为“Block Lambdas”。
