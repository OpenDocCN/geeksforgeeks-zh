...
> 原文: [https://www.geeksforgeeks.org/java-program-to-get-elements-by-index-from-linkedhashset/](https://www.geeksforgeeks.org/java-program-to-get-elements-by-index-from-linkedhashset/)
...
## 方法 2: 将 LinkedHashSet 转换为 Array

将 `LinkedHashSet` 转换为 `Array`，通过 `Array` 可以在给定的索引处访问元素。

### 算法

1.  使用 [`toArray()`](https://www.geeksforgeeks.org/arraylist-toarray-method-in-java-with-examples/) 的方法将给定的链接数据集转换为数组。
2.  访问数组中给定索引上的元素。
...
## 方法 3: 将 LinkedHashSet 转换为 List

将 `LinkedHashSet` 转换为 `List`，在给定的索引处获取想要的元素。
