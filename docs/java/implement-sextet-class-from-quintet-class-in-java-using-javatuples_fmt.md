...
> 原文: [https://www.geeksforgeeks.org/implement-sextet-class-from-quintet-class-in-java-using-javatuples/](https://www.geeksforgeeks.org/implement-sextet-class-from-quintet-class-in-java-using-javatuples/)

**先决条件:** [`Sextet`类](https://www.geeksforgeeks.org/sextet-class-in-java-tuples/) [`Quintet`类](https://www.geeksforgeeks.org/quintet-class-in-java-tuples/)

以下是在 Java 中使用 `Quintet` 类实现 `Sextet` 类的方法:
