# compare()方法在Java中是如何工作的

> 原文：[https://www.geeksforgeeks.org/how-compare-method-works-in-java/](https://www.geeksforgeeks.org/how-compare-method-works-in-java/)

## 先决条件
[Java 中的比较器接口](https://www.geeksforgeeks.org/comparator-interface-java/) [Java 中的 TreeSet](https://www.geeksforgeeks.org/treeset-in-java-with-examples/)
