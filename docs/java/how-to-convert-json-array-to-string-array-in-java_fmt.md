...
> 原文: [https://www.geeksforgeeks.org/how-to-convert-json-array-to-string-array-in-java/](https://www.geeksforgeeks.org/how-to-convert-json-array-to-string-array-in-java/)

[JSON](https://www.geeksforgeeks.org/javascript-json/) 代表 JavaScript 对象符号。它是网络应用程序广泛使用的数据交换格式之一。JSON 数组和 [JavaScript](https://www.geeksforgeeks.org/introduction-to-javascript/) 中的数组几乎一样。它们可以理解为以索引方式收集的数据(字符串、数字、布尔值)。给定一个 JSON 数组，我们将讨论如何在 Java 中将它转换成 `String` 数组。
...
我们在这里使用的方法是，首先将所有的 JSON 数组元素插入到一个 [列表](https://www.geeksforgeeks.org/list-interface-java-examples/) 中，因为这样更容易将列表转换成数组。
...
我们将使用 [`toArray()`](https://www.geeksforgeeks.org/arraylist-toarray-method-in-java-with-examples/) 方法将列表转换为字符串数组。
