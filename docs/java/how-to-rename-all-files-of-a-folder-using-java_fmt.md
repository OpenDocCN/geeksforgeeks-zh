...
> 原文: [https://www.geeksforgeeks.org/how-to-rename-all-files-of-a-folder-using-java/](https://www.geeksforgeeks.org/how-to-rename-all-files-of-a-folder-using-java/) 重命名文件夹中的所有文件
