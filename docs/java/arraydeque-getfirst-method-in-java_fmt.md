...
> 原文：`https://www.geeksforgeeks.org/arraydeque-getfirst-method-in-java/`

`java.util.ArrayDeque.getFirst()`方法用于检索或获取`ArrayDeque`的第一个元素。在这个过程中，该方法并不从`deque`中删除元素，而是返回`deque`的第一个元素。
