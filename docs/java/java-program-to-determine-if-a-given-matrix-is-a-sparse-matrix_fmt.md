...
> 原文：[https://www.geeksforgeeks.org/java-program-to-determine-if-a-given-matrix-is-a-sparse-matrix/](https://www.geeksforgeeks.org/java-program-to-determine-if-a-given-matrix-is-a-sparse-matrix/)
...
1.  获取矩阵。
2.  遍历矩阵的元素并计算零的数量。
3.  检查计数是否大于 `(m*n)/2`，如果是，则输出“是”，否则输出“否”。
