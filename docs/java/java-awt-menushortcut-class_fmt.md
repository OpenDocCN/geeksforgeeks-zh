...
`MenuShortcut` 类是 Java AWT 的一部分。`MenuShortcut` 类实现了使用虚拟键码实现的菜单快捷方式。`MenuShortcut` 类表示 `MenuItem` 的键盘加速器。

### 类的构造函数:

1.  `MenuShortcut(int k)` :用指定的键创建一个菜单快捷键对象。
...
| 方法 | 说明 |
| --- | --- |
| `equals(MenuShortcut)` | 返回此菜单快捷方式是否与另一个菜单快捷方式相同。 |
...
## Java program to create a menubar and add MenuItems to it and also add MenuShortcut to MenuItems
...
public class Shortcut_1 extends Frame implements ActionListener {
    ...
    Shortcut_1() {
        ...
        MenuShortcut menushortcut_1 = new MenuShortcut(KeyEvent.VK_A, false);
        MenuShortcut menushortcut_2 = new MenuShortcut(KeyEvent.VK_B, false);
...
## Java program to create a menubar and add MenuItems to it and also add MenuShortcut to MenuItems and also add shift modifier to MenuShortcut
...
public class Shortcut_2 extends Frame implements ActionListener {
    ...
    Shortcut_2() {
        ...
        // create menu shortcuts
        MenuShortcut menushortcut_1 = new MenuShortcut(KeyEvent.VK_A, true);
        MenuShortcut menushortcut_2 = new MenuShortcut(KeyEvent.VK_B, true);
        MenuShortcut menushortcut_3 = new MenuShortcut(KeyEvent.VK_C, true);
...
## 参考:
[`https://docs.oracle.com/javase/7/docs/api/java/awt/MenuShortcut.html`](https://docs.oracle.com/javase/7/docs/api/java/awt/MenuShortcut.html)