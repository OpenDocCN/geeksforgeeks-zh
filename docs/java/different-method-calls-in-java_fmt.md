...
> 原文：[https://www.geeksforgeeks.org/different-method-calls-in-java/](https://www.geeksforgeeks.org/different-method-calls-in-java/)
...
1.  **用户自定义方法**：这些是用户在特定类中实现的执行特定操作的方法。
