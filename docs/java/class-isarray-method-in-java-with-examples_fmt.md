...
> 原文：[https://www.geeksforgeeks.org/class-isarray-method-in-java-with-examples/](https://www.geeksforgeeks.org/class-isarray-method-in-java-with-examples/)
...
## 返回值：
如果这个类是数组类，这个方法返回`true`。否则返回`false`。
