...
> 原文：[https://www.geeksforgeeks.org/calendar-get-method-in-java-with-examples/](https://www.geeksforgeeks.org/calendar-get-method-in-java-with-examples/)
...
该方法取整数类型的一个参数 `field_value`，指需要返回其值的日历。
...
[https://docs.oracle.com/javase/7/docs/api/java/util/Calendar.html#get(int)](https://docs.oracle.com/javase/7/docs/api/java/util/Calendar.html#get(int))