...
> 原文: [https://www.geeksforgeeks.org/floatbuffer-get-methods-in-java-with-examples/](https://www.geeksforgeeks.org/floatbuffer-get-methods-in-java-with-examples/)
...
**参数:** 该方法以 `index` (将读取浮点数的指数)为参数。

**返回值:** 该方法返回给定指标下的 `float` 值。
