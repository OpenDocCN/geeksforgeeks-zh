# Java中的`Matcher start(int)`方法示例

> 原文：[https://www.geeksforgeeks.org/matcher-startint-method-in-java-with-examples/](https://www.geeksforgeeks.org/matcher-startint-method-in-java-with-examples/)

`Matcher`类的`start(int group)`方法用于从指定的组中获取已经完成的匹配结果的开始索引。
...
**参考：** [Oracle文档](https://docs.oracle.com/javase/9/docs/api/java/util/regex/Matcher.html#start-int-)