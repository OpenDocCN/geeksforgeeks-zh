# Java 中的 Logger setParent() 方法示例

> 原文: [https://www.geeksforgeeks.org/logger-setparent-method-in-java-with-examples/](https://www.geeksforgeeks.org/logger-setparent-method-in-java-with-examples/)
...
如果存在安全管理器，并且调用方没有登录权限（`"control"`），则此方法引发 `SecurityException`。
...
[https://docs.oracle.com/javase/10/docs/api/java/util/logging/Logger.html#setParent(java.util.logging.Logger)](https://docs.oracle.com/javase/10/docs/api/java/util/logging/Logger.html#setParent(java.util.logging.Logger))