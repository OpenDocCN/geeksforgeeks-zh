...
`Tab`类是JavaFX的一部分。选项卡类创建一个包含在选项卡窗格中的对象。选项卡可以包含任何节点作为其内容。选项卡窗格可以包含多个选项卡。当用户单击选项卡时，选项卡的内容对用户可见。

## 类的构造函数

1.  `Tab()`: 创建一个新的空选项卡。
2.  `Tab(String t)`: 用指定的标题创建新的选项卡。
3.  `Tab(String t, Node c)`: 用指定的标题和内容创建一个新的选项卡。
...
[https://docs.oracle.com/javase/8/javafx/api/javafx/scene/control/Tab.html](https://docs.oracle.com/javase/8/javafx/api/javafx/scene/control/Tab.html)