...
> 原文：[https://www.geeksforgeeks.org/java-program-to-represent-graphs-using-linked-list/](https://www.geeksforgeeks.org/java-program-to-represent-graphs-using-linked-list/)
...
无向图中顶点的最大数量是 `n*(n-1)`，其中 `n` 是无向图中存在的节点总数。
...
现在跳到下一种类型的图，即我们使用链表表示的有向图。在有向图中，两个节点在单向顶点上相连。
