...
> 原文：[https://www.geeksforgeeks.org/character-isletterordigit-in-java-with-examples/](https://www.geeksforgeeks.org/character-isletterordigit-in-java-with-examples/)
...
## 参数：
该函数接受单个强制参数 `ch`，表示要测试的字符。

## 返回值：
该函数返回一个布尔值。如果字符是字母或数字，布尔值为 `true`，否则为 `false`。
...
## 参考：
[https://docs.oracle.com/javase/7/docs/api/java/lang/Character.html#isLetterOrDigit(char)](https://docs.oracle.com/javase/7/docs/api/java/lang/Character.html#isLetterOrDigit(char))