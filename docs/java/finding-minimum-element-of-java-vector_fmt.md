...
> 原文: [https://www.geeksforgeeks.org/finding-minimum-element-of-java-vector/](https://www.geeksforgeeks.org/finding-minimum-element-of-java-vector/)
...
*   为了找到给定向量的最小元素，我们使用 [`Collections.min()`](https://www.geeksforgeeks.org/collections-max-method-in-java-with-examples/) 方法。
*   这直接找到向量中的最小值。
...
*   接下来，我们将取一个变量，让 `minNumber` 表示最小值，并分配可能的最小值。
