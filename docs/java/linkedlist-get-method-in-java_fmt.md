...
> 原文: [https://www.geeksforgeeks.org/linkedlist-get-method-in-java/](https://www.geeksforgeeks.org/linkedlist-get-method-in-java/)
...
## 参数:
参数`index`是整数数据类型，指定要从链接列表中提取的元素的位置或索引。
