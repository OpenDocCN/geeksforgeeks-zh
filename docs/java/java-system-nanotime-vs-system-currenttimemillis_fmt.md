...
> 原文: [https://www.geeksforgeeks.org/java-system-nanotime-vs-system-currenttimemillis/](https://www.geeksforgeeks.org/java-system-nanotime-vs-system-currenttimemillis/)
...
1.  少`精确`。结果在 1/1000 到 15/1000 秒之间。在某些机器上，分辨率甚至低于 50 毫秒，最高只能达到 10 毫秒。
...
2.  少`准确`。该方法提供纳秒精度，但不一定是纳秒精度。无法保证值更改的频率。
