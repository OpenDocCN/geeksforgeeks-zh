...
> 原文：`https://www.geeksforgeks.org/difference-between-core-java-and-advanced-java/`

**核心 Java:** `Core Java` 是 Java 编程语言中用于创建或开发通用应用程序的部分。

**高级 Java:** `Advanced Java` 也是 Java 编程语言的一部分，一般处理网站和移动应用等在线应用。
