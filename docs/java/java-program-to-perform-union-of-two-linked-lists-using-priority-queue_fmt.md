...
> 原文：[https://www.geeksforgeeks.org/java-program-to-perform-union-of-two-linked-lists-using-priority-queue/](https://www.geeksforgeeks.org/java-program-to-perform-union-of-two-linked-lists-using-priority-queue/)
...
> 因此，我们可以得出结论，在最小堆中，最小的元素将位于堆的根，而在最大堆中，最大的元素将位于堆的根。在堆上实现 `remove()` 函数时，根元素将被移除。因为输出应该是递增的，所以可以使用最小堆。`PriorityQueue` 用于在 Java 中实现最小堆。
