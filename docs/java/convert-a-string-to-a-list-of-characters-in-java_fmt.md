...
> 原文：[https://www.geeksforgeeks.org/convert-a-string-to-a-list-of-characters-in-java/](https://www.geeksforgeeks.org/convert-a-string-to-a-list-of-characters-in-java/)
...
4.  使用 `mapToObj()` 方法将 `IntStream` 转换为 `Stream<Character>`。
5.  使用 `collect()` 将元素收集为字符列表，并返回列表。
