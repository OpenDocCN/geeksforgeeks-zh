# Java 中的 `tertiaryOrder()` 方法，带示例

> 原文：[https://www.geeksforgeeks.org/collationelementiterator-tertiaryorder-method-in-java-with-examples/](https://www.geeksforgeeks.org/collationelementiterator-tertiaryorder-method-in-java-with-examples/)

`CollationElementIterator` 类的 `tertiaryOrder()` 方法用于提供每个排序元素的第三级组件。
...
[https://docs.oracle.com/javase/9/docs/api/java/text/CollationElementIterator.html#tertiaryOrder-int-](https://docs.oracle.com/javase/9/docs/api/java/text/CollationElementIterator.html#tertiaryOrder-int-)