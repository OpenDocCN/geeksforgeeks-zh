# Java 中 AbstractSet 的 toString() 方法

> 原文: [https://www.geeksforgeks.org/abstractset-tostring-method-in-java-with-example/](https://www.geeksforgeks.org/abstractset-tostring-method-in-java-with-example/)

`AbstractSet` 的 `toString()` 方法用于返回集合元素的字符串表示。
