...
> 原文：[https://www.geeksforgeeks.org/android-searchview-with-example/](https://www.geeksforgeeks.org/android-searchview-with-example/)
...
创建`menu.xml`并将`搜索视图`作为菜单项添加到动作栏，标题为“搜索”。下面是`menu.xml`文件的完整代码。
