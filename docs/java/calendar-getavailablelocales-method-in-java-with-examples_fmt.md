...
> 原文: [https://www.geeksforgeeks.org/calendar-getavailablelocales-method-in-java-with-examples/](https://www.geeksforgeeks.org/calendar-getavailablelocales-method-in-java-with-examples/)
...
## 参考:
[https://docs.oracle.com/javase/7/docs/api/java/util/Calendar.html#clone()](https://docs.oracle.com/javase/7/docs/api/java/util/Calendar.html#clone())