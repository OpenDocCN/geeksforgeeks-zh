# Java 中的构造函数 equals() 方法示例

> 原文：[https://www.geeksforgeeks.org/constructor-equals-method-in-java-with-examples/](https://www.geeksforgeeks.org/constructor-equals-method-in-java-with-examples/)

[`Constructor`](https://www.geeksforgeeks.org/constructors-in-java/) 类提供了关于一个类的单个构造器的信息，并且还提供了对该构造器的访问。
...
该方法接受 `Object`，该对象是要与之比较的参考对象。

## 返回值

如果该对象与 `obj` 参数相同，则该方法返回 `true`。否则返回 `false`。
...
[https://docs.oracle.com/javase/10/docs/api/java/lang/reflect/Constructor.html#equals(java.lang.Object)](https://docs.oracle.com/javase/10/docs/api/java/lang/reflect/Constructor.html#equals(java.lang.Object))