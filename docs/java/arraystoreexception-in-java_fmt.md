...
> 原文：`https://www.geeksforgeeks.org/arraystoreexception-in-java/`
...
2.  `ArrayStoreException(String s)`：用指定的消息 `s` 构造一个 `ArrayStoreException` 实例。
...
> 线程“main”中的异常 `java.lang.ArrayStoreException: java.lang.Integer`
...
> `ArrayStoreException: java.lang.ArrayStoreException: java.lang.Integer`