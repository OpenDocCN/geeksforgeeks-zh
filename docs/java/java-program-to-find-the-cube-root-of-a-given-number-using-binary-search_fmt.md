...
> 原文:[https://www . geeksforgeks . org/Java-program-to-find-给定数字的立方根-使用二进制搜索/](https://www.geeksforgeeks.org/java-program-to-find-the-cube-root-of-a-given-number-using-binary-search/)
