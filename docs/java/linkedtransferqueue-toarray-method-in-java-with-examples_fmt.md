...
> 原文: [https://www.geeksforgeeks.org/linkedtransferqueue-toarray-method-in-java-with-examples/](https://www.geeksforgeeks.org/linkedtransferqueue-toarray-method-in-java-with-examples/)
...
**程序 3:** 显示 `NullPointerException` 的程序。
...
*   [https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/concurrent/LinkedTransferQueue.html#toArray()](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/concurrent/LinkedTransferQueue.html#toArray())
*   [https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/concurrent/LinkedTransferQueue.html#toArray(T%5B%5D)](https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/concurrent/LinkedTransferQueue.html#toArray(T%5B%5D))