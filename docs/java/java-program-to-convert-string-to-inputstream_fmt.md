...
> 原文: [https://www.geeksforgeeks.org/java-program-to-convert-string-to-inputstream/](https://www.geeksforgeeks.org/java-program-to-convert-string-to-inputstream/)
...
public class GFG {
    ...
    public static void main(String[] args) throws IOException {
        ...
        // Creating an object of BufferedReader class to take input
        BufferedReader br = new BufferedReader(new InputStreamReader(stream));

        // Printing the input stream using readLine() method
