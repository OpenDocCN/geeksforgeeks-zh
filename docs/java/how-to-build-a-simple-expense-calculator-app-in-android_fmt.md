...
> 原文：[https://www.geeksforgeeks.org/how-to-build-a-simple-expense-calculator-app-in-android/](https://www.geeksforgeeks.org/how-to-build-a-simple-expense-calculator-app-in-android/)
...
现在，让我们为自定义操作栏和回收视图行布局添加布局资源文件。转到 `app > res > 布局` 并添加以下 `xml` 文件。下面是 `custom_action_bar.xml` 文件的代码。
