# Java LinkedHashSet containsAll()方法详解

> 原文: [https://www.geeksforgeeks.org/linkedhashset-containsall-method-in-java-with-example/](https://www.geeksforgeeks.org/linkedhashset-containsall-method-in-java-with-example/)
