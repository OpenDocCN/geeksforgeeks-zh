...
[`java.nio.ByteBuffer`](https://www.geeksforgeeks.org/tag/java-bytebuffer/) 类的 `reset()` 方法用于将该缓冲区的位置重置到之前标记的位置。调用此方法既不会改变也不会丢弃标记的值。
...
[https://docs.oracle.com/javase/9/docs/api/java/nio/ByteBuffer.html#reset--](https://docs.oracle.com/javase/9/docs/api/java/nio/ByteBuffer.html#reset--)