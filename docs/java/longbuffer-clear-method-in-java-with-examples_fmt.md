...
> 原文: [https://www.geeksforgeeks.org/longbuffer-clear-method-in-java-with-examples/](https://www.geeksforgeeks.org/longbuffer-clear-method-in-java-with-examples/)

[`LongBuffer`](https://www.geeksforgeeks.org/tag/java-longbuffer/)类的`clear()`方法用来清除这个缓冲区。清除该缓冲区时，进行以下更改:
...
该方法在清除`LongBuffer`实例中的所有数据后返回该`LongBuffer`实例。
...
[https://docs.oracle.com/javase/9/docs/api/java/nio/LongBuffer.html](https://docs.oracle.com/javase/9/docs/api/java/nio/LongBuffer.html)