...
> 原文：[`https://www.geeksforgeeks.org/customize-java-annotation-with-examples/`](https://www.geeksforgeeks.org/customize-java-annotation-with-examples/)
...
创建自定义注释的第一步是使用 `@interface` 关键字声明它：
