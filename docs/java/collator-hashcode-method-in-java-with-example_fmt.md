...
> 原文：`https://www.geeksforgeeks.org/collator-hashcode-method-in-java-with-example/`
...
**参考：** `https://docs.oracle.com/javase/9/docs/api/java/text/Collator.html#hashCode--`