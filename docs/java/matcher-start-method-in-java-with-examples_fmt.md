...
> 原文: [https://www.geeksforgeeks.org/matcher-start-method-in-java-with-examples/](https://www.geeksforgeeks.org/matcher-start-method-in-java-with-examples/)

`Matcher`类的`start()`方法用于获取已经完成的匹配结果的开始索引。
