...
> 原文：[https://www.geeksforgeeks.org/java-program-to-find-if-a-given-year-is-a-leap-year/](https://www.geeksforgeeks.org/java-program-to-find-if-a-given-year-is-a-leap-year/)
...
在这里，用户可以灵活地输入自己选择的年份，因为 `Scanner` 类是在这里导入的，其余的 `if-else` 块也合并在一个语句中，以检查输入的年份是否是闰年。以下程序说明了确定一年是否为闰年的方法：
