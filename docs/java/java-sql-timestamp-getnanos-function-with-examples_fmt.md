...
> 原文: [https://www.geeksforgeeks.org/java-sql-timestamp-getnanos-function-with-examples/](https://www.geeksforgeeks.org/java-sql-timestamp-getnanos-function-with-examples/)
...
创建一个时间戳，并使用 `getNanos()`获取时间戳对象的小数部分。
...
创建时间戳，使用 `getNanos()`获取时间戳对象的小数部分，不要设置任何秒的小数。
