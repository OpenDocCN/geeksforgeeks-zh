...
> 原文: [https://www.geeksforgeeks.org/hashtable-size-method-in-java/](https://www.geeksforgeeks.org/hashtable-size-method-in-java/)
...
该方法返回表的大小，这也意味着表中存在的键值对的数量。

下面的程序说明了 `java.util.Hashtable.size()` 方法：
