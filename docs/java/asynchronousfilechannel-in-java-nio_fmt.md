...
> 原文: [https://www.geeksforgeeks.org/asynchronousfilechannel-in-java-nio/](https://www.geeksforgeeks.org/asynchronousfilechannel-in-java-nio/)

[Java.nio 包](https://www.geeksforgeeks.org/introduction-to-java-nio-with-examples/)在 java 1.4 版本中推出。它允许我们同时处理不同的通道，因为它支持并发和多线程。异步文件通道 API 负责 java NIO 包，它是在 NIO 通道包下定义的。为了将异步文件通道应用编程接口导入我们的程序，请遵循以下语法:
