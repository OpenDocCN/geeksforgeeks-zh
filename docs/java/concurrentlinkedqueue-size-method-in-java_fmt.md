...
## 返回值
这个方法返回 `这个 ConcurrentLinkedQueue 中的元素数量`。

下面的程序说明了并发链接队列的 `size()` 方法：
...
**参考:** [https://docs.oracle.com/javase/8/docs/api/java/util/concurrent/ConcurrentLinkedQueue.html#size--](https://docs.oracle.com/javase/8/docs/api/java/util/concurrent/ConcurrentLinkedQueue.html#size--)