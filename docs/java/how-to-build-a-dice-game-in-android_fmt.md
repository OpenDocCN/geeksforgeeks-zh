...
> 原文：[https://www.geeksforgeeks.org/how-to-build-a-dice-game-in-android/](https://www.geeksforgeeks.org/how-to-build-a-dice-game-in-android/)
...
XML 代码用于构建活动的结构及其样式部分。它包含一个 [`TextView`](https://www.geeksforgeeks.org/textview-widget-in-android-using-java-with-examples/) 在活动的最顶端显示游戏结果。然后它包含两个 [`ImageView`](https://www.geeksforgeeks.org/imageview-in-kotlin/) ，每个都有一个 `TextView` 用于玩家名称和掷骰子的图像。活动底部有 [`Button`](https://www.geeksforgeeks.org/button-in-kotlin/) 掷骰子。下面是 `activity_main.xml` 文件的代码。
...
[https://media.geeksforgeeks.org/wp-content/uploads/20201227040305/Edited_20201227_020713.mp4](https://media.geeksforgeeks.org/wp-content/uploads/20201227040305/Edited_20201227_020713.mp4)