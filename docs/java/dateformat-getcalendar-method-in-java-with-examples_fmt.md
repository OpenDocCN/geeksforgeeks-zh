...
> 原文：[https://www.geeksforgeeks.org/dateformat-getcalendar-method-in-java-with-examples/](https://www.geeksforgeeks.org/dateformat-getcalendar-method-in-java-with-examples/)

Java 中 `DateFormat` 类的 `getCalendar()` 方法用于获取与该日期/时间格式对象关联的日历。
