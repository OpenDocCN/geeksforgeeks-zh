...
> 原文：`https://www.geeksforgeeks.org/atomiclong-getandset-method-in-java-with-examples/`
...
`https://docs.oracle.com/javase/8/docs/api/java/util/concurrent/atomic/AtomicLong.html#getAndSet--`