# 用示例链接 Java 中的 `hashCode()` 方法

> 原文: [https://www.geeksforgeeks.org/linkedhashset-hashcode-method-in-java-with-example/](https://www.geeksforgeeks.org/linkedhashset-hashcode-method-in-java-with-example/)
...
## 返回
该方法返回一个整数值，这是 `LinkedHashSet` 实例的 `hashCode` 值。
