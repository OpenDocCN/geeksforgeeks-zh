...
> 原文：[https://www.geeksforgeeks.org/java-program-to-implement-synchronousqueue-api/](https://www.geeksforgeeks.org/java-program-to-implement-synchronousqueue-api/)
...
2.  `SynchronousQueue(boolean fair)`：在这种情况下，如果多个线程正在等待，则这些线程被授权以先进先出的方式访问。
