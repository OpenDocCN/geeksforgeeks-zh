# Java 中的 `Hashtable.keySet()` 方法，带示例

> 原文: [https://www.geeksforgeeks.org/hashtable-keyset-method-in-java-with-examples/](https://www.geeksforgeeks.org/hashtable-keyset-method-in-java-with-examples/)

`Hashtable.keySet()` 用于在哈希表中创建一组关键元素。它基本上返回一个键的集合视图，或者我们可以创建一个新的集合并将关键元素存储在其中。
