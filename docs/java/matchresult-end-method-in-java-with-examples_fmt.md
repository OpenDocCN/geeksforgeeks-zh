...
> 原文：[https://www.geeksforgeeks.org/matchresult-end-method-in-java-with-examples/](https://www.geeksforgeeks.org/matchresult-end-method-in-java-with-examples/)

`MatchResult` 接口的 `end()` 方法用于获取匹配结果中最后一个匹配字符后的偏移量。
