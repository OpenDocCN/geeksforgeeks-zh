...
> 原文: [https://www.geeksforgeeks.org/keypairgenerator-genkeypair-method-in-java-with-examples/](https://www.geeksforgeeks.org/keypairgenerator-genkeypair-method-in-java-with-examples/)

`java.security.KeyPairGenerator`类的`genKeyPair()`方法用于生成密钥对。
