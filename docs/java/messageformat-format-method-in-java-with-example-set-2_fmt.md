...
> 原文: [https://www.geeksforgeeks.org/messageformat-format-method-in-java-with-example-set-2/](https://www.geeksforgeeks.org/messageformat-format-method-in-java-with-example-set-2/)
...
**异常:** 如果模式为空，该方法抛出 `NullPointerException`。
