...
> 原文：[https://www.geeksforgeks.org/abstractcollection-tostring-method-in-java-with-examples/](https://www.geeksforgeeks.org/abstractcollection-tostring-method-in-java-with-examples/)

[`AbstractCollection`](https://www.geeksforgeeks.org/abstractcollection-in-java-with-examples/) 的 `toString()` 方法用于返回集合元素的字符串表示。
