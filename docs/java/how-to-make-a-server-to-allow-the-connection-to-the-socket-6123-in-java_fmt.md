...
> 原文: [https://www.geeksforgeeks.org/how-to-make-a-server-to-allow-the-connection-to-the-socket-6123-in-java/](https://www.geeksforgeeks.org/how-to-make-a-server-to-allow-the-connection-to-the-socket-6123-in-java/)
...
*   用 `Socket` 类的 `getnetaddress()` 方法和 `InetAddress` 类的 `getHostAddress()` 获取连接的地址。
