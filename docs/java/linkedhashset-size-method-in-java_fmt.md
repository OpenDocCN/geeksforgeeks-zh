...
> 原文: [https://www.geeksforgeeks.org/linkedhashset-size-method-in-java/](https://www.geeksforgeeks.org/linkedhashset-size-method-in-java/)
...
该方法返回`LinkedHashSet`中存在的元素的大小或数量。
