...
> 原文: [https://www.geeksforgeeks.org/biginteger-compareto-method-in-java/](https://www.geeksforgeeks.org/biginteger-compareto-method-in-java/)

`java.math.BigInteger.compareTo(BigInteger val)`方法将此 BigInteger 与作为参数传递的 BigInteger 进行比较。
...
## 参数:
该方法接受单个强制参数`val`，它是要与大整数对象进行比较的大整数。
...
### 示例 1: 下面的程序说明了当两个 BigInteger 相等时 BigInteger 类的 compareTo()方法
...
## 参考:
[BigInteger compareTo()文档](https://docs.oracle.com/javase/7/docs/api/java/math/BigInteger.html#compareTo(java.math.BigInteger))