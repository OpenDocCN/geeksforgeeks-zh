# 用示例将`put()`方法放入 Java 中

> 原文：[https://www.geeksforgeeks.org/floatbuffer-put-methods-in-java-with-examples-set-1/](https://www.geeksforgeeks.org/floatbuffer-put-methods-in-java-with-examples-set-1/)
