...
> 原文：[https://www.geeksforgeeks.org/date-tostring-method-in-java-with-examples/](https://www.geeksforgeeks.org/date-tostring-method-in-java-with-examples/)

`Date`类的`toString()`方法将该日期对象转换为“dow mon dd hh:mm:ss zzz yyy”形式的字符串。此方法重写类对象中的`toString`。
