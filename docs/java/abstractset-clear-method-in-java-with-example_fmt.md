# Java中AbstractSet.clear()方法详解

> 原文：[https://www.geeksforgeeks.org/abstractset-clear-method-in-java-with-example/](https://www.geeksforgeeks.org/abstractset-clear-method-in-java-with-example/)

Java中`AbstractSet`的`clear()`方法用于移除一个集合中的所有元素。此调用返回后，集合将为空。
