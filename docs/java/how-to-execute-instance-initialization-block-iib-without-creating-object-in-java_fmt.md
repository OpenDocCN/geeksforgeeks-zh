...
> 原文: [https://www.geeksforgeeks.org/how-to-execute-instance-initialization-block-iib-without-creating-object-in-java/](https://www.geeksforgeeks.org/how-to-execute-instance-initialization-block-iib-without-creating-object-in-java/)
...
class GFG {
    // Instance block
    {
        System.out.println("Instance block inside main method called without creating an object");
    }

    public static void main(String[] args) {
        // Executing instance block without creating an object
        new GFG() {
            {
                // This is an instance block inside an anonymous class
            }
        };

        // Normal object creation for comparison
        GFG obj1 = new GFG();
        GFG obj2 = new GFG();
        GFG obj3 = new GFG();
    }
