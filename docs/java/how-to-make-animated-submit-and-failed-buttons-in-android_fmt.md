...
> 原文：[https://www.geeksforgeeks.org/how-to-make-animated-submit-and-failed-buttons-in-android/](https://www.geeksforgeeks.org/how-to-make-animated-submit-and-failed-buttons-in-android/)
...
现在，导航到`渐变脚本 > 构建.gradle(模块: 应用)`在依赖项部分添加下面的依赖项。
