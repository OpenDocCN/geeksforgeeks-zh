...
> 原文: [https://www.geeksforgeeks.org/messageformat-applypattern-method-in-java-with-example/](https://www.geeksforgeeks.org/messageformat-applypattern-method-in-java-with-example/)
...
## 参数:
该方法以字符串 `newPattern` 为参数，该参数是该消息格式对象的新文本模式。

## 返回值:
此方法不返回任何内容。

## 异常:
如果指定的新模式为空，该方法抛出 `NullPointerException`。

以下是说明 `applyPattern()` 方法的示例:
...
## 参考:
[https://docs.oracle.com/javase/9/docs/api/java/text/MessageFormat.html#applyPattern-java.lang.String-](https://docs.oracle.com/javase/9/docs/api/java/text/MessageFormat.html#applyPattern-java.lang.String-)