...
> 原文: [https://www.geeksforgeeks.org/how-to-label-image-in-android-using-firebase-ml-kit/](https://www.geeksforgeeks.org/how-to-label-image-in-android-using-firebase-ml-kit/)
...
### 第四步: 在你的安卓应用和 `AndroidManifest.xml` 文件中添加访问互联网和元数据的权限
