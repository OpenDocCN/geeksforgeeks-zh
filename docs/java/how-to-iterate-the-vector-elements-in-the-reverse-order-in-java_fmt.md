...
> 原文：[https://www.geeksforgeeks.org/how-to-iterate-the-vector-elements-in-the-reverse-order-in-java/](https://www.geeksforgeeks.org/how-to-iterate-the-vector-elements-in-the-reverse-order-in-java/)
...
要使用 `for` 循环向后迭代向量元素，我们可以通过从索引 `Vector.size()-1` 运行循环到索引 `0` 来从向后遍历向量。
...
class GFG {
    public static void main(String[] args)
    {
        ...
        // Iterating from index equal to numbers.size()-1 to
...
`Vector` 类有一个 `listIterator()` 方法，用来迭代向量。`listIterator()` 方法从遍历必须开始的地方获取起始索引，并返回列表迭代器。
