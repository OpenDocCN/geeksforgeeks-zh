...
> 原文：[https://www.geeksforgeeks.org/how-to-build-a-facebook-like-custom-recyclerview-in-android/](https://www.geeksforgeeks.org/how-to-build-a-facebook-like-custom-recyclerview-in-android/)

我们已经看到在我们的应用程序中用简单的数据在安卓系统中实现[回收视图](https://www.geeksforgeeks.org/android-recyclerview/)。在本文中，我们将看一下**脸书喜欢的定制回收视图在安卓**中的实现。
