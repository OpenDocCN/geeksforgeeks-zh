...
> 原文: [https://www.geeksforgeeks.org/java-program-to-find-the-area-of-a-triangle/](https://www.geeksforgeeks.org/java-program-to-find-the-area-of-a-triangle/)

三角形是多边形。它有三条边和三个顶点，每个顶点都有一个角度。它是一个封闭的二维形状。在这篇文章中，我们将学习如何找到三角形的面积。
...
当给定三角形的高度和底边时，则三角形的面积为其底边和高度乘积的一半。
...
现在假设我们只知道边，那么上面的公式就不能应用了。面积将使用三角形的尺寸来计算。这个公式俗称海伦公式。
