...
> 原文: [https://www.geeksforgeeks.org/how-to-pass-integer-by-reference-in-java/](https://www.geeksforgeeks.org/how-to-pass-integer-by-reference-in-java/)
...
我们知道 `Integer` 是一个不可变类，因此我们通过此方法将整数值包装在一个可变对象中。
...
## 4. 使用 Apache MutableInt 类

我们可以通过导入 Commons Apache 的包来使用 `MutableInt` 类。
