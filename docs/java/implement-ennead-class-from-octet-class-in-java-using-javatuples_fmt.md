...
> 原文: [https://www.geeksforgeeks.org/implement-ennead-class-from-octet-class-in-java-using-javatuples/](https://www.geeksforgeeks.org/implement-ennead-class-from-octet-class-in-java-using-javatuples/)

**先决条件:** [八位体班](https://www.geeksforgeeks.org/octet-class-in-java-tuples/)
...
class `GfG` {
    public static void main(`String[]` args) {
        // Create Octet
        `Octet<String, String, String, String, String, String, String, String>` octet = new `Octet<String, String, String, String, String, String, String, String>`(
            "Octet", "Septet", "Sextet", "Quintet", "Quartet", "Triplet", "Pair", "Unit");
        ...
        // Create Ennead from Octet
        `Ennead<String, String, String, String, String, String, String, String, String>` ennead = octet.`addAt8("Ennead")`;
