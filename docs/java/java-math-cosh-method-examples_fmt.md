...
> 原文: [https://www.geeksforgeeks.org/java-math-cosh-method-examples/](https://www.geeksforgeeks.org/java-math-cosh-method-examples/)
...
## 例 2 :
展示参数为 `NaN` 或无穷大时 `java.lang.Math.cosh()` 方法的工作。
