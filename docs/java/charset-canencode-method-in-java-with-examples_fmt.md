...
> 原文：[https://www.geeksforgeeks.org/charset-canencode-method-in-java-with-examples/](https://www.geeksforgeeks.org/charset-canencode-method-in-java-with-examples/)
...
该函数返回一个布尔值。如果它支持编码，则返回`true`，否则返回`false`。
...
[https://docs.oracle.com/javase/9/docs/api/java/nio/charset/Charset.html#canEncode--](https://docs.oracle.com/javase/9/docs/api/java/nio/charset/Charset.html#canEncode--)