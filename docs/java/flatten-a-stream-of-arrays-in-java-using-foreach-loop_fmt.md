...
> 原文：[https://www.geeksforgeeks.org/flatten-a-stream-of-arrays-in-java-using-foreach-loop/](https://www.geeksforgeeks.org/flatten-a-stream-of-arrays-in-java-using-foreach-loop/)
...
5.  现在，通过使用 `toArray()` 方法将其转换为数组来展平流。
