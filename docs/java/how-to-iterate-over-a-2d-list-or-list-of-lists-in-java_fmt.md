...
> 原文：[https://www.geeksforgeeks.org/how-to-iterate-over-a-2d-list-or-list-of-lists-in-java/](https://www.geeksforgeeks.org/how-to-iterate-over-a-2d-list-or-list-of-lists-in-java/)
...
*   每一行的 2D 列表可以通过 [`Iterator`](https://www.geeksforgeeks.org/how-to-use-iterator-in-java/) 的 [`next()`](https://www.geeksforgeeks.org/how-to-use-iterator-in-java/) 方法获取。

```java
listOfListsIterator.next();
```

但是 [`next()`](https://www.geeksforgeeks.org/how-to-use-iterator-in-java/) 方法返回迭代器作为对象的对象。因此，我们需要将这个返回的对象转换成一个列表。
