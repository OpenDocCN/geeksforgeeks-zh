# Java中的整数toOctalString()方法

> 原文: [https://www.geeksforgeeks.org/integer-tooctalstring-method-in-java/](https://www.geeksforgeeks.org/integer-tooctalstring-method-in-java/)
...
## 返回值:
该函数将整数参数的字符串表示形式返回为基数为 8 的无符号整数。
