# 用示例列出 Java 中的`subList()`方法

> 原文：[https://www.geeksforgeeks.org/list-sublist-method-in-java-with-examples/](https://www.geeksforgeeks.org/list-sublist-method-in-java-with-examples/)
...
`参数：`这个函数有两个参数`fromIndex`和`toIndex`，分别是开始和结束范围，从给定的列表创建一个子列表。
