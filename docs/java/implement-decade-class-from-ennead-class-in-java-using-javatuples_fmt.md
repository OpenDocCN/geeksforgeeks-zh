...
> 原文: [https://www.geeksforgeeks.org/implement-decade-class-from-ennead-class-in-java-using-javatuples/](https://www.geeksforgeeks.org/implement-decade-class-from-ennead-class-in-java-using-javatuples/)

## 先决条件
[十年班](https://www.geeksforgeeks.org/decade-class-in-java-tuples/) [恩内班](https://www.geeksforgeeks.org/ennead-class-in-java-tuples/)

下面是用 Java 中的 `Ennead` 类实现 `Decade` 类的方法:
...
# Java Tuples - Ennead到Decade的转换示例
