...
> 原文: [https://www.geeksforgeeks.org/javafx-directorychooser-class/](https://www.geeksforgeeks.org/javafx-directorychooser-class/)
...
| `getTitle()` | 返回目录选择器的标题。 |
| `setInitialDirectory(File val)` | 设置属性 `initialDirectory` 的值 |
| `setTitle(String t)` | 设置目录选择器的标题。 |
| `showDialog(Stage window)` | 显示新的目录选择对话框。 |

## 以下程序说明了目录选择器类的使用:

### 1. Java Program to create DirectoryChooser and add it to the stage
...
### 2. Java Program to create DirectoryChooser, set title, initial directory and add it to the stage
