# Java 中的整数 doubleValue() 方法

> 原文: [https://www.geeksforgeeks.org/integer-doublevalue-method-in-java/](https://www.geeksforgeeks.org/integer-doublevalue-method-in-java/)
