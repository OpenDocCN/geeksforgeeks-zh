...
> 原文：[https://www.geeksforgeeks.org/how-to-add-a-new-column-to-a-table-using-jdbc-api/](https://www.geeksforgeeks.org/how-to-add-a-new-column-to-a-table-using-jdbc-api/)
...
*   右键单击它，选择 构建路径 -> 配置构建路径 -> 库 -> 添加 JARS
...
![Add a new column](img/9f27383f87f2f105f09145bc7f20aa4e.png)

![Output of the table content after adding new column](img/0990dc6bbfe5f55e02c6cfad91d993e9.png)