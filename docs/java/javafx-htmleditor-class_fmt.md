...
| `setHtmlText(String h)` | 设置编辑器的 HTML 文本。 |

下面的程序说明了 `HTMLEditor` 类的使用：

### 1. Java program to create a HTMLEditor and add to the stage
...
### 2. Java program to create a HTMLEditor and set initial HTML text to it and add to the stage
