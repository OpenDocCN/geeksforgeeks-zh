...
> 原文：[https://www.geeksforgeeks.org/how-to-build-a-video-calling-android-app-with-jitsi-meet-sdk/](https://www.geeksforgeeks.org/how-to-build-a-video-calling-android-app-with-jitsi-meet-sdk/)
...
### 第四步：在 build.gradle(Module:app)中添加 java 1.8 兼容性支持
...
现在是时候设计应用程序的布局了。为此，转到 **app > res > layout > activity_main.xml** 并将下面编写的代码粘贴到 `activity_main.xml` 文件中。
