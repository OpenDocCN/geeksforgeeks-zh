...
> 原文：[https://www.geeksforgeeks.org/java-program-to-access-all-data-as-object-array/](https://www.geeksforgeeks.org/java-program-to-access-all-data-as-object-array/)
...
*   我们已经创建了包含产品标识和产品名称的 `Product` 类的构造函数。在主功能中，我们已经创建了 `Product` 类的单个对象。之后，我们使用构造函数将初始值传递给每个对象。
