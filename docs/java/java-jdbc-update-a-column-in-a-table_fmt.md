...
> 原文: [https://www.geeksforgeeks.org/java-jdbc-update-a-column-in-a-table/](https://www.geeksforgeeks.org/java-jdbc-update-a-column-in-a-table/)
...
public class Database {
    ...
    public static void main(String[] args) throws ClassNotFoundException {
        try {
            // this Class.forName() method is user for driver registration with name of the driver
            ...
            // Executing the query, student is the table name and RollNo is the new column
...
![Update a column in a table](img/3fc6536713c9ed4af4daf4e00dad3f92.png)
![Updated table](img/b4227cc319f01ec861d131c28b39cb56.png)