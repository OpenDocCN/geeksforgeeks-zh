...
> 原文：`https://www.geeksforgeeks.org/how-do-i-generate-random-integers-within-a-specific-range-in-java/`
...
*   沙吾提线程局部随机 1860 年(Java)。使用中。竞争对手。线程局部随机)什么事 `nextInt()`凯伊姆，是吗 `Min`(最小)你好-`Max`魏冄
