...
> 原文：[https://www.geeksforgeeks.org/how-to-convert-char-to-string-in-java/](https://www.geeksforgeeks.org/how-to-convert-char-to-string-in-java/)
...
## 方法 2：使用 `Character` 类的 `toString()` 方法
