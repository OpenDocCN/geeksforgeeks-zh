...
> 原文：[https://www.geeksforgeeks.org/collections-list-method-in-java-with-examples/](https://www.geeksforgeeks.org/collections-list-method-in-java-with-examples/)
...
该方法以 `枚举 e` 为参数，为返回的数组列表提供元素。

## 返回值

这个方法返回 `一个数组列表`，包含指定枚举返回的元素。
