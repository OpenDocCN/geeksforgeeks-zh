# Java中的ArrayList ensureCapacity()方法，带示例

> 原文：[https://www.geeksforgeeks.org/arraylist-ensurecapacity-method-in-java-with-examples/](https://www.geeksforgeeks.org/arraylist-ensurecapacity-method-in-java-with-examples/)

`java.util.ArrayList`类的`ensureCapacity()`方法增加了这个`ArrayList`实例的容量，如果需要的话，确保它至少可以容纳最小容量参数指定的元素数量。
