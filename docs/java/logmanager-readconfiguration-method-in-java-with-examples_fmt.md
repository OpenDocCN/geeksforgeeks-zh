...
> 原文: [https://www.geeksforgeeks.org/logmanager-readconfiguration-method-in-java-with-examples/](https://www.geeksforgeeks.org/logmanager-readconfiguration-method-in-java-with-examples/)
...
*   `IOException`: 如果读取配置时出现任何 IO 错误。
*   `SecurityException`: 如果在调用方没有日志记录权限的情况下存在安全管理器。
...
**参考:** [https://docs.oracle.com/javase/9/docs/api/java/util/logging/LogManager.html#readConfiguration--](https://docs.oracle.com/javase/9/docs/api/java/util/logging/LogManager.html#readConfiguration--)