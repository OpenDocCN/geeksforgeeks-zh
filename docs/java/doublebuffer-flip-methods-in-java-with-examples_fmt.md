...
> 原文: [https://www.geeksforgeeks.org/doublebuffer-flip-methods-in-java-with-examples/](https://www.geeksforgeeks.org/doublebuffer-flip-methods-in-java-with-examples/)

`java.nio.DoubleBuffer`类的`flip()`方法用于翻转该缓冲区。通过翻转该缓冲区，这意味着缓冲区将被修剪到当前位置，然后该位置将被更改为零。在此过程中，如果缓冲区上有任何标记，则该标记将被自动丢弃。
...
[https://docs.oracle.com/javase/9/docs/api/java/nio/DoubleBuffer.html#flip--](https://docs.oracle.com/javase/9/docs/api/java/nio/DoubleBuffer.html#flip--)