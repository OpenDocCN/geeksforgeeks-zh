...
> 原文：[https://www.geeksforgeeks.org/java-program-to-check-the-accessibility-of-an-static-variable-by-a-static-method/](https://www.geeksforgeeks.org/java-program-to-check-the-accessibility-of-an-static-variable-by-a-static-method/)

`Static`关键字是 Java 中的非访问修饰符，主要用于内存管理。此静态关键字主要适用于以下情况：
