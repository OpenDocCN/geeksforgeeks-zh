...
> 原文：[https://www.geeksforgeeks.org/concurrentlinkeddeque-addlast-method-in-java/](https://www.geeksforgeeks.org/concurrentlinkeddeque-addlast-method-in-java/)

`java.util.concurrent.ConcurrentLinkedDeque.addLast()` 是 Java 中的一个内置函数，它将指定的元素插入到 deque 的末尾。
...
该方法只接受单个参数 `elem`，该参数将被添加到 `ConcurrentLinkedDeque` 的末尾。
...
[https://docs.oracle.com/javase/7/docs/api/java/util/concurrent/ConcurrentLinkedDeque.html#addLast(java.lang.Object)](https://docs.oracle.com/javase/7/docs/api/java/util/concurrent/ConcurrentLinkedDeque.html#addLast(java.lang.Object))