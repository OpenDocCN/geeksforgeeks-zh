...
> 原文：[https://www.geeksforgeeks.org/java-program-to-implement-hashtables-with-linear-probing/](https://www.geeksforgeeks.org/java-program-to-implement-hashtables-with-linear-probing/)
...
通过创建一个辅助类并在主类中进行测试，实现具有线性探测的哈希表。
