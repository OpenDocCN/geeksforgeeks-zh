# Java中的`DigestInputStream.setMessageDigest()`方法，带示例

> 原文：[https://www.geeksforgeeks.org/digestinputstream-setmessagedigest-method-in-java-with-examples/](https://www.geeksforgeeks.org/digestinputstream-setmessagedigest-method-in-java-with-examples/)
...
**注意：** 本文中的所有程序都不会在联机IDE上运行，因为不存在“name”文件。您可以在系统的Java编译器上检查这些代码。要检查此代码，请在您的系统上创建一个文件“名称”。

以下是说明`setMessageDigest()`方法的示例：
...
**参考：** [https://docs.oracle.com/javase/9/docs/api/java/security/DigestInputStream.html#setMessageDigest-java.security.MessageDigest-](https://docs.oracle.com/javase/9/docs/api/java/security/DigestInputStream.html#setMessageDigest-java.security.MessageDigest-)