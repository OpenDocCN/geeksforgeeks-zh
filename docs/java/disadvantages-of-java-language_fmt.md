...
> 原文：[https://www.geeksforgeeks.org/disadvantages-of-java-language/](https://www.geeksforgeeks.org/disadvantages-of-java-language/)
...
## 6- 无无符号类型
与 C/C++ 不同，Java 不支持无符号 int、无符号 char、…等。但是在 `Java 8` 中，引入了无符号长整型和无符号整型的 API（请看[这篇甲骨文文档](https://blogs.oracle.com/darcy/unsigned-integer-arithmetic-api-now-in-jdk-8)）。
