...
> 原文：[https://www.geeksforgeeks.org/abstractlist-clear-method-in-java-with-examples/](https://www.geeksforgeeks.org/abstractlist-clear-method-in-java-with-examples/)

`java.util.AbstractList` 类的 `clear()` 方法用于从该列表中移除所有元素。该方法调用返回后，列表将为空。
