...
> 原文：[https://www.geeksforgeeks.org/bidi-isrighttoleft-method-in-java-with-examples/](https://www.geeksforgeeks.org/bidi-isrighttoleft-method-in-java-with-examples/)
...
如果此 `Bidi` 同时具有从右到左线和基本方向，则此方法返回 `true`，否则返回 `false`。
