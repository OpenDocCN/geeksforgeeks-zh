...
```java
thisMap.get(key_element)
```

## 参数:
该方法取一个对象类型的参数 `key_element` ，指的是应该取关联值的键。

## 返回值:
该方法返回与该地图集合中的 `key_element` 相关联的值。
...
## 参考:
[https://docs.oracle.com/javase/7/docs/api/java/util/Map.html#get(java.lang.Object)](https://docs.oracle.com/javase/7/docs/api/java/util/Map.html#get(java.lang.Object))