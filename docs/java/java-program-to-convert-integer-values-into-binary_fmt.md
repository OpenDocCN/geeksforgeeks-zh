...
> 原文: [https://www.geeksforgeeks.org/java-program-to-convert-integer-values-into-binary/](https://www.geeksforgeeks.org/java-program-to-convert-integer-values-into-binary/)
...
*   **使用内置方法-** [`toBinaryString()`](https://www.geeksforgeeks.org/java-lang-integer-tobinarystring-method/) **Java 的整数类**
