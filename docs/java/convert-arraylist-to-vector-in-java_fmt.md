...
> 原文：[https://www.geeksforgeeks.org/convert-arraylist-to-vector-in-java/](https://www.geeksforgeeks.org/convert-arraylist-to-vector-in-java/)
...
`Vector(Collection c)`：创建包含集合 `c` 元素的向量。
...
public class GFG {
    public static void main(String[] args)
    {
        ...
        // create vector and pass the ArrayList in vector constructor
...
**返回值：** 如果至少执行了一个追加动作，则该方法返回 `true`，否则返回 `false`。
