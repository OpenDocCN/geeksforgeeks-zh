...
> 原文：[https://www.geeksforgeeks.org/learn-java-for-android-app-development-a-complete-guide/](https://www.geeksforgeeks.org/learn-java-for-android-app-development-a-complete-guide/)
...
*   [Java 中的对象类](https://www.geeksforgeeks.org/object-class-in-java/) – `java.lang` 包中存在 `Object` 类。Java 中的每个类都是直接或间接从 `Object` 类派生出来的。
...
*   [Java 中的泛型](https://www.geeksforgeeks.org/generics-in-java/) – 泛型是指参数化类型。其思想是允许类型（`int`、`strings`、…等和用户定义的类型）成为方法、类和接口的参数。
