...
> 原文：[https://www.geeksforgeeks.org/how-to-overload-and-override-main-method-in-java/](https://www.geeksforgeeks.org/how-to-overload-and-override-main-method-in-java/)
...
Java 中的静态方法与类相关联，而非静态方法与对象相关联。静态属于类的范畴，静态方法不需要对象来调用。静态方法可以通过使用类名(`ClassName.staticMethodName()`)直接调用。
