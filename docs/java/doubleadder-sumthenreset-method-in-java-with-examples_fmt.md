# Java 中的 `DoubleAdder.sumThenReset()` 方法示例

> 原文: [https://www.geeksforgeeks.org/doubleadder-sumthenreset-method-in-java-with-examples/](https://www.geeksforgeeks.org/doubleadder-sumthenreset-method-in-java-with-examples/)
...
[https://docs.oracle.com/javase/8/docs/api/java/util/concurrent/atomic/DoubleAdder.html#sumThenReset--](https://docs.oracle.com/javase/8/docs/api/java/util/concurrent/atomic/DoubleAdder.html#sumThenReset--)