...
此方法返回一个`布尔值`，指示标记和重置方法的可支持性。

## 覆盖

该方法被 `FilterInputStream` 类中的 `markSupported()` 覆盖。
...
[https://docs.oracle.com/javase/10/docs/api/java/io/BufferedInputStream.html#markSupported()](https://docs.oracle.com/javase/10/docs/api/java/io/BufferedInputStream.html#markSupported())