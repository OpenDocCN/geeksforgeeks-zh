# Calendar 类中的 clear() 方法，带示例

> 原文：[https://www.geeksforgeeks.org/calendar-clear-method-in-java-with-examples/](https://www.geeksforgeeks.org/calendar-clear-method-in-java-with-examples/)
...
[https://docs.oracle.com/javase/7/docs/api/java/util/Calendar.html#clear()](https://docs.oracle.com/javase/7/docs/api/java/util/Calendar.html#clear())