...
> 原文: [https://www.geeksforgeeks.org/how-to-remove-duplicates-from-arraylist-in-java/](https://www.geeksforgeeks.org/how-to-remove-duplicates-from-arraylist-in-java/)
...
1.  获取具有重复值的数组列表。
2.  从此数组列表创建一个新列表。
3.  使用 `stream()`. 返回不同对象流的 `distinct()` 方法。
4.  将此对象流转换为列表
