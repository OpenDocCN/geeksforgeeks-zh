...
> 原文: [https://www.geeksforgeeks.org/how-to-sort-hashtable-in-java/](https://www.geeksforgeeks.org/how-to-sort-hashtable-in-java/)
...
[TreeMap](https://www.geeksforgeeks.org/treemap-in-java/)按照排序顺序存储数据。我们可以使用树形图构造器，将哈希表对象转换成树形图对象。现在，生成的树形图对象是按排序顺序排列的。
