# Java 中的 HashSet equals() 方法示例

> 原文: [https://www.geeksforgeks.org/hashset-equals-method-in-java-with-example/](https://www.geeksforgeks.org/hashset-equals-method-in-java-with-example/)
...
该方法以 `Object` 类型的对象为参数，与该集合进行相等性比较。

## 返回值

如果指定的对象等于这个集合，这个方法返回 `true`。
