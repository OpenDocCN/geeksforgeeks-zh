...
> 原文：[`https://www.geeksforgeeks.org/gregoriancalendar-hashcode-method-in-java/`](https://www.geeksforgeeks.org/gregoriancalendar-hashcode-method-in-java/)
...
该函数返回一个整数值，该整数值代表这个 `GregorianCalendar` 实例的哈希代码。
...
[`https://docs.oracle.com/javase/7/docs/api/java/util/GregorianCalendar.html#hashCode()`](https://docs.oracle.com/javase/7/docs/api/java/util/GregorianCalendar.html#hashCode())