...
> 原文：[https://www.geeksforgeeks.org/chronofield-values-method-in-java-with-examples/](https://www.geeksforgeeks.org/chronofield-values-method-in-java-with-examples/)

`ChronoField`枚举的`values()`方法用于包含该枚举类型常数的数组，按顺序声明。
...
这个方法返回一个包含这个枚举类型的常量的数组，按照它们被声明的顺序。
