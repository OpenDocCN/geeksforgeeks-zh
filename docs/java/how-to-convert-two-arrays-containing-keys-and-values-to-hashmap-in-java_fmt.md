...
> 原文：[https://www.geeksforgeeks.org/how-to-convert-two-arrays-containing-keys-and-values-to-hashmap-in-java/](https://www.geeksforgeeks.org/how-to-convert-two-arrays-containing-keys-and-values-to-hashmap-in-java/)

[`HashMap`](https://www.geeksforgeeks.org/java-util-hashmap-in-java-with-examples/) 是 Java 的[集合框架](https://www.geeksforgeeks.org/collections-in-java-2/)的一部分。它以键值对的形式存储数据。哈希表的这些值可以通过使用它们各自的键来访问，或者键值对可以使用它们的索引（整数类型）来访问。[`HashMap`](https://www.geeksforgeeks.org/java-util-hashmap-in-java-with-examples/) 类似于 Java 中的 [`Hashtable`](https://www.geeksforgeeks.org/hashtable-in-java/)。[`Hashtable`](https://www.geeksforgeeks.org/hashtable-in-java/) 和 [`HashMap`](https://www.geeksforgeeks.org/java-util-hashmap-in-java-with-examples/) 的主要区别在于 [`Hashtable`](https://www.geeksforgeeks.org/hashtable-in-java/) 是同步的，而 [`HashMap`](https://www.geeksforgeeks.org/java-util-hashmap-in-java-with-examples/) 不是。此外，一个哈希表可以有一个 `null` 键和任意数量的 `null` 值。哈希映射中没有保留插入顺序。在 [`HashMap`](https://www.geeksforgeeks.org/java-util-hashmap-in-java-with-examples/) 中，可以使用 `HashMap.put()` 方法添加键和值。我们还可以将两个包含键和值的数组转换成一个包含各自键和值的 [`HashMap`](https://www.geeksforgeeks.org/java-util-hashmap-in-java-with-examples/)。
...
class GFG {
    ...
    public static HashMap map(Integer[] keys, String[] values) {
    ...
    public static void main(String[] args) {
        ...
        String[] values = { "Welcome", "To", "Geeks", "For", "Geeks" };
