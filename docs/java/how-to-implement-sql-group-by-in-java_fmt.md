...
> 原文: [https://www.geeksforgeeks.org/how-to-implement-sql-group-by-in-java/](https://www.geeksforgeeks.org/how-to-implement-sql-group-by-in-java/)

## 先决条件

[Java 集合](https://www.geeksforgeeks.org/collections-in-java-2/)、 [Java 数组列表](https://www.geeksforgeeks.org/arraylist-in-java/)、[Java 中的比较器接口](https://www.geeksforgeeks.org/comparator-interface-java/)
...
*   我们将使用比较器界面的 [`compare()`](https://www.geeksforgeeks.org/comparator-interface-java/) 方法对列表进行排序。使用这种方法非常简单，可以用来链接多个比较器，从而使过程更容易。
