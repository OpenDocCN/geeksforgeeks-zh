# IntMath 类的 Java Guava gcd(int a, int b)方法

> 原文: [https://www.geeksforgeeks.org/java-guava-gcdint-a-int-b-method-of-intmath-class/](https://www.geeksforgeeks.org/java-guava-gcdint-a-int-b-method-of-intmath-class/)
...
如果 `a < 0` 或 `b < 0`，方法 `gcd(int a, int b)` 会抛出 `IllegalArgumentException`。
