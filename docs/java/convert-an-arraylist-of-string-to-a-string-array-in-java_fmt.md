...
> 原文：[https://www.geeksforgeeks.org/convert-an-arraylist-of-string-to-a-string-array-in-java/](https://www.geeksforgeeks.org/convert-an-arraylist-of-string-to-a-string-array-in-java/)
...
1.  获取字符串的数组列表。
2.  使用 `size()` 方法找到数组列表的大小，创建一个这个大小的字符串数组。
3.  使用 `get()` 方法逐个获取数组列表的每个元素。
