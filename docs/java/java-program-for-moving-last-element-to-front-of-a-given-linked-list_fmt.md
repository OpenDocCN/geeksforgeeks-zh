...
> 原文：[https://www.geeksforgeeks.org/java-program-for-moving-last-element-to-front-of-a-given-linked-list/](https://www.geeksforgeeks.org/java-program-for-moving-last-element-to-front-of-a-given-linked-list/)
...
1.  将倒数第二个设为最后一个（`secLast->next = null`）。
2.  将倒数第二个设置为标题（`last->next = *head_ref`）。
3.  将最后一个作为标题（`*head_ref = last`）。
...
详情请参考完整文章：[将最后一个元素移到给定链表的前面](https://www.geeksforgeeks.org/move-last-element-to-front-of-a-given-linked-list/)！