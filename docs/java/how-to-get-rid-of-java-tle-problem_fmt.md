...
> 原文: [https://www.geeksforgeeks.org/how-to-get-rid-of-java-tle-problem/](https://www.geeksforgeeks.org/how-to-get-rid-of-java-tle-problem/)
...
`提示 1 :` 避免使用 [`Scanner` 类](https://www.geeksforgeeks.org/scanner-class-in-java/)，尽量使用 [`BufferedReader` 类](https://www.geeksforgeeks.org/java-io-bufferedreader-class-java/)。
...
## 优化实现 (使用 BufferedReader 和 StringBuffer)
