...
> 原文：[https://www.geeksforgeeks.org/how-to-increase-or-decrease-textview-font-size-in-android-programmatically/](https://www.geeksforgeeks.org/how-to-increase-or-decrease-textview-font-size-in-android-programmatically/)
...
这里我们基本上是创建两个[按钮](https://www.geeksforgeeks.org/button-in-kotlin/)来增加和减少文本大小。还有一个[文本视图](https://www.geeksforgeeks.org/textview-widget-in-android-using-java-with-examples/)，包含罗兰伊普斯姆虚拟文本。下面是 `activity_main.xml` 文件的代码。
