# Java TreeMap containsKey() 和 containsValue() 方法详解

> 原文链接：[https://www.geeksforgeeks.org/java-util-treemap-containskey-containsvalue-java/](https://www.geeksforgeeks.org/java-util-treemap-containskey-containsvalue-java/)

`java.util.TreeMap` 中有两个 `contains()` 的变体，本文将对这两个变体进行讨论。
