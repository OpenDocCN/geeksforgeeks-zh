...
> 原文: [https://www.geeksforgeeks.org/java-arithmetic-operators-with-examples/](https://www.geeksforgeeks.org/java-arithmetic-operators-with-examples/)
...
这是一个二进制运算符，用于将第一个操作数(被除数)除以第二个操作数(除数)，并得出商。
...
这是一个二进制运算符，用于在第一个操作数(被除数)除以第二个操作数(除数)时返回余数。
