...
> 原文: [https://www.geeksforgeeks.org/convert-json-string-to-java-object-using-gson/](https://www.geeksforgeeks.org/convert-json-string-to-java-object-using-gson/)

**先决条件:** [使用 GSON 将 Java 对象转换为 Json 字符串](https://www.geeksforgeeks.org/convert-java-object-to-json-string-using-gson/)
...
*   [Jackson API](https://www.geeksforgeeks.org/convert-java-object-to-json-string-using-jackson-api/)
...
> ```
> **输出:**
> `Organisation [organisation_name=Geeksforgeeks, description=Geeks 的计算机科学门户, Employees=0]`

**操作步骤如下:**

*   **添加 Gson 的 jar 文件（在 Maven 项目的情况下，在 `pom.xml` 文件中添加 Gson 依赖项）**
...
public class Organisation {
    ...
    public String toString() {
        return "Organisation [organisation_name=" + organisation_name + ", description=" + description + ", Employees=" + Employees + "]";
    }
}
```
...
> **初始 JSON 字符串:**
> `{"organization_name":"Geeksforgeeks","description":"Geeks 的计算机科学门户","Employee":"2000"}`
> **预处理 JSON 字符串:**
> `{\"organization_name\":\"Geeksforgeeks\",\"description\":\"Geeks 的计算机科学门户\",\"Employee\":\"2000\"}`
...
public class JsonToObject {
    ...
    private static Organisation getOrganisationObject() {
        ...
        String OrganisationJson = "{\"organisation_name\" : \"GeeksforGeeks\", \"description\" : \"A computer Science portal for Geeks\", \"Employee\" : \"2000\"}";
