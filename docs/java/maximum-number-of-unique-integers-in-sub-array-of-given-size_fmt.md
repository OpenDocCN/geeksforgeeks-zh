...
> 原文：[https://www.geeksforgeeks.org/maximum-number-of-unique-integers-in-sub-array-of-given-size/](https://www.geeksforgeeks.org/maximum-number-of-unique-integers-in-sub-array-of-given-size/)
...
高效的解决方案是使用[窗口滑动技术](https://www.geeksforgeeks.org/window-sliding-technique/)。我们维护一个哈希表来存储每个窗口的唯一元素。
1) 在散列图中存储前 `M` 个元素的计数。
