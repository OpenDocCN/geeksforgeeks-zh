...
[`java.nio.ByteBuffer`](https://www.geeksforgeeks.org/tag/java-bytebuffer/) 类的 `mark()` 方法用于将该缓冲区的标记设置在其位置。
...
[https://docs.oracle.com/javase/9/docs/api/java/nio/ByteBuffer.html#mark--](https://docs.oracle.com/javase/9/docs/api/java/nio/ByteBuffer.html#mark--)