...
> 原文：[https://www.geeksforgeeks.org/how-to-create-a-custom-intro-slider-of-an-android-app/](https://www.geeksforgeeks.org/how-to-create-a-custom-intro-slider-of-an-android-app/)
...
因为我们将从网上下载所有图片，所以我们将使用[毕加索](https://www.geeksforgeeks.org/how-to-use-picasso-image-loader-library-in-android/amp/)从我们的应用程序中的网址下载图片。因此，为了使用来自网址的图像，我们必须在我们的`构建.梯度`文件中添加以下依赖项。
