...
> 原文：[https://www.geeksforgeeks.org/doublebuffer-clear-methods-in-java-with-examples/](https://www.geeksforgeeks.org/doublebuffer-clear-methods-in-java-with-examples/)

`Java.nio.charbuffer`类的`clear()`方法用于清除该缓冲区。清除该缓冲区时，进行以下更改：
...
该方法在清除`DoubleBuffer`实例中的所有数据后返回该实例。
...
[https://docs.oracle.com/javase/9/docs/api/java/nio/DoubleBuffer.html#clear--](https://docs.oracle.com/javase/9/docs/api/java/nio/DoubleBuffer.html#clear--)