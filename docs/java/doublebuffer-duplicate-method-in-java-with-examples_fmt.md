# Java 中的 DoubleBuffer duplicate() 方法示例

> 原文: [https://www.geeksforgeeks.org/doublebuffer-duplicate-method-in-java-with-examples/](https://www.geeksforgeeks.org/doublebuffer-duplicate-method-in-java-with-examples/)

`java.nio.DoubleBuffer` 类的 `duplicate()` 方法用于创建共享给定缓冲区内容的新双缓冲区。
