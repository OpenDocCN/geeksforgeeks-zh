...
> 原文：[https://www.geeksforgeeks.org/java-program-to-find-reverse-of-a-number-using-recursion/](https://www.geeksforgeeks.org/java-program-to-find-reverse-of-a-number-using-recursion/)

[递归](https://www.geeksforgeeks.org/recursion/)是一个函数反复调用自己，直到落在基础条件下，我们的动机达到的过程。要使用递归解决任何问题，我们只需遵循以下步骤：
...
**注意：** 发生溢出时，Java 不会抛出异常，因此如果反转数大于 `Integer.MAX_VALUE` *(2147483647)*，在方法 2 中可能会出现溢出问题，但是在方法 1 中不会有这样的问题。