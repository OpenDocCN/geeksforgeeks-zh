...
> 原文：[https://www.geeksforgeeks.org/java-program-to-get-a-character-from-a-string/](https://www.geeksforgeeks.org/java-program-to-get-a-character-from-a-string/)
...
3.  使用 `IntStream.mapToObj()` 方法将 `IntStream` 转换为 `Stream<Character>`。
4.  使用 `toArray()` 方法将 `Stream<Character>` 转换为 `Character[]`。
