...
> 原文: [https://www.geeksforgeeks.org/java-program-to-add-the-nth-square-series/](https://www.geeksforgeeks.org/java-program-to-add-the-nth-square-series/)
...
在这种方法中，我们将使用下面提到的公式来找到级数的和。这个公式可以用来求第 n 次平方级数的和，通过数学归纳法可以证明其正确性。它比上面说明的要优化得多。
