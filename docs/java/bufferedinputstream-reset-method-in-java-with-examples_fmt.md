# Java 中的 BufferedInputStream reset() 方法示例
...
### 覆盖
该方法覆盖 `FilterInputStream` 中的 `reset()` 方法。
...
### 异常
如果此流未被标记或标记已被无效，或输入流已通过调用 `close()` 方法关闭，或出现输入/输出错误，此方法将抛出 `IOException`。
...
**输入：** ![](img/3b4a246be9babc0cebdeb8acf4f8b4a8.png)
**输出：** ![](img/400473fa39cc253f40ce049b2017d91f.png)
...
**输入：** ![](img/0535eee875913edb892a527352808f09.png)
**输出：** ![](img/fd86a3925d4520d28b7d64cd784ed859.png)
