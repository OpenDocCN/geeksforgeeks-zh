...
> 原文：[https://www.geeksforgeeks.org/check-if-a-value-is-present-in-an-array-in-java/](https://www.geeksforgeeks.org/check-if-a-value-is-present-in-an-array-in-java/)
...
在本例中，`Arrays.binarySearch()` 方法用于二分搜索法。
