...
> 原文: [https://www.geeksforgeeks.org/datainputstream-readdouble-method-in-java-with-examples/](https://www.geeksforgeeks.org/datainputstream-readdouble-method-in-java-with-examples/)
...
该方法由 `DataInput` 接口的 `readDouble()` 方法指定。
...
[![](img/a933b626c20a7bd54c4899d5d1462466.png)](https://media.geeksforgeeks.org/wp-content/uploads/20200601125308/data_double-1.png)
