...
> 原文：[https://www.geeksforgeeks.org/java-program-to-shut-down-computer-in-linux/](https://www.geeksforgeeks.org/java-program-to-shut-down-computer-in-linux/)
...
public class SystemShutDown {
            ...
            throws IOException
    {
        ...
        // Check if Computer Operating System is Linux or not
