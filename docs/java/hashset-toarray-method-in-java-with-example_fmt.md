# HashSet.toArray()方法详解

> 原文：[https://www.geeksforgeeks.org/hashset-toarray-method-in-java-with-example/](https://www.geeksforgeeks.org/hashset-toarray-method-in-java-with-example/)
