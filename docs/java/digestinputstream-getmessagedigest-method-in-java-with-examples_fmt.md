...
> 原文: [https://www.geeksforgeeks.org/digestinputstream-getmessagedigest-method-in-java-with-examples/](https://www.geeksforgeeks.org/digestinputstream-getmessagedigest-method-in-java-with-examples/)
...
**参考:** [https://docs.oracle.com/javase/9/docs/api/java/security/DigestInputStream.html#getMessageDigest--](https://docs.oracle.com/javase/9/docs/api/java/security/DigestInputStream.html#getMessageDigest--)