# Java 中的 `ArrayList.lastIndexOf()` 示例

> 原文：[https://www.geeksforgeeks.org/arraylist-lastindexof-java-example/](https://www.geeksforgeeks.org/arraylist-lastindexof-java-example/)

Java 中 [`ArrayList`](https://www.geeksforgeeks.org/arraylist-in-java/) 的 `lastIndexOf()` 方法用于获取数组列表对象中元素最后一次出现的索引。
