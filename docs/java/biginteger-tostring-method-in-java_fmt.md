...
> 原文: [https://www.geeksforgeeks.org/biginteger-tostring-method-in-java/](https://www.geeksforgeeks.org/biginteger-tostring-method-in-java/)
...
该方法接受单个强制参数基数，即字符串表示的基数。

## 返回值

这个方法返回给定基数下这个大整数的十进制字符串表示。
