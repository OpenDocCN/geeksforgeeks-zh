...
> 原文: [https://www.geeksforgeeks.org/difference-between-byte-code-and-machine-code/](https://www.geeksforgeeks.org/difference-between-byte-code-and-machine-code/)
...
下图举例说明了 Java 源代码如何转换为字节码，再转换为机器码的例子:
