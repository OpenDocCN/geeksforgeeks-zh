...
`java.util.concurrent.ConcurrentSkipListMap`的`clear()`方法是 Java 中的一个内置函数，它删除了该映射中的所有映射。这意味着地图中的所有元素都被移除，并返回一个空地图。
...
## 参考:
[https://docs.oracle.com/javase/8/docs/api/java/util/concurrent/ConcurrentSkipListMap.html#clear--](https://docs.oracle.com/javase/8/docs/api/java/util/concurrent/ConcurrentSkipListMap.html#clear--)