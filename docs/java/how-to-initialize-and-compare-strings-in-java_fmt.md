...
> 原文：[`https://www.geeksforgeeks.org/how-to-initialize-and-compare-strings-in-java/`](https://www.geeksforgeeks.org/how-to-initialize-and-compare-strings-in-java/)
...
1.  **`equals()` 方法：** 比较字符串的**值**是否相等。返回类型是布尔值。几乎在所有情况下，您都可以使用 `useObjects.equals()`。
...
我们将通过下面的例子讨论如何与字符串进行比较来证明上面所说的
