...
在 C++中，如果一个类至少有一个[纯虚函数](https://www.geeksforgeeks.org/pure-virtual-functions-and-abstract-classes/)，那么这个类就变成了抽象的。与 C++不同，在 Java 中，一个单独的 [`abstract`](https://www.geeksforgeeks.org/abstract-keyword-in-java/) 关键字用于使类抽象。
