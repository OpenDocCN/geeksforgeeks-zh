# Java 中的 Date equals() 方法示例

> 原文: [https://www.geeksforgeeks.org/date-equals-method-in-java-with-examples/](https://www.geeksforgeeks.org/date-equals-method-in-java-with-examples/)

`Date`类的`equals()`方法根据毫秒差检查两个日期是否相等。
