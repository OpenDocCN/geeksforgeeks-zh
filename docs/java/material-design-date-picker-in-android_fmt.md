...
> 原文：[https://www.geeksforgeeks.org/material-design-date-picker-in-android/](https://www.geeksforgeeks.org/material-design-date-picker-in-android/)
...
*   现在将以下依赖项添加到[应用级 Gradle](https://www.geeksforgeeks.org/android-build-gradle/)文件中。

> `implementation 'com.google.android.material:material:1.3.0-alpha02'`

*   调用依赖关系后点击`立即同步`按钮。确保您已连接到网络，以便安卓工作室下载所有必需的文件。
*   如果找不到应用程序级 Gradle 文件并调用依赖关系，请参考下图。

![Gradle file](img/3ab3c43ce0129fb77f81e2e2eec20307.png)

### 第三步：将基础应用主题更改为材质主题如下

*   转到`app > src > main > res > values > styles.xml`并更改基础应用程序主题。材质组件包含各种动作栏主题样式，可以调用任何`材料组件`动作栏主题样式，除了`AppCompat`样式。下面是 `styles.xml` 文件的代码。由于我们使用的是材料设计组件，这一步是强制性的。
...
*   这将在整个讨论中保持不变。下面是`activity_main.xml`文件的代码。
...
### 第六步：现在调用下面的代码来实现第二种类型的材料设计日期选择器
...
[在仿真器上运行演示](https://media.geeksforgeeks.org/wp-content/uploads/20201011145100/GFG_nexus_5.mp4)
