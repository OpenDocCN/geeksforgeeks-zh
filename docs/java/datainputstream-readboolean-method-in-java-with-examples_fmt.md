...
> 原文：[`https://www.geeksforgeeks.org/datainputstream-readboolean-method-in-java-with-examples/`](https://www.geeksforgeeks.org/datainputstream-readboolean-method-in-java-with-examples/)
...
该方法由 `DataInput` 接口的 `readBoolean()` 方法指定。
