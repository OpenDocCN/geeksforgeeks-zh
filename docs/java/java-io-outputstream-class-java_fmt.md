# Java中的`Java.io.OutputStream`类

> 原文：[https://www.geeksforgeeks.org/java-io-outputstream-class-java/](https://www.geeksforgeeks.org/java-io-outputstream-class-java/)
...
将从`offset` `off`开始的指定字节数组中的`len`字节写入此输出流。
