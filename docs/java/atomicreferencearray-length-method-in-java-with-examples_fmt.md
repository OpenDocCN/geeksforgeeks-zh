...
一个`AtomicReferenceArray`类的`length()`方法用来返回这个原子引用数组的长度。
...
[https://docs.oracle.com/javase/10/docs/api/java/util/concurrent/atomic/AtomicReferenceArray.html#length()](https://docs.oracle.com/javase/10/docs/api/java/util/concurrent/atomic/AtomicReferenceArray.html#length())