...
> 原文:[https://www.geeksforgeeks.org/java-program-to-convert-hexadecimal-to-binary/](https://www.geeksforgeeks.org/java-program-to-convert-hexadecimal-to-binary/)

**十六进制**是一个非常有用的数字系统，其前提是一次将 4 位组合在一起，构成系统的单个实体，该系统由 16 个符号组成，包括范围从 **0-9** 的 10 个数字和来自 **A-F** 的前 6 个字母。十六进制一词来源于单词**十六进制**表示**六个**和**十进制**表示**十个**。
