...
> 原文：[https://www.geeksforgeeks.org/java-program-to-create-a-singly-linked-list-and-count-the-number-of-nodes/](https://www.geeksforgeeks.org/java-program-to-create-a-singly-linked-list-and-count-the-number-of-nodes/)
...
1.  创建节点链接列表
2.  定义像 `addNode()`，`displayNodes()` 和 `countNodes()` 这样的方法
3.  得到最终答案
