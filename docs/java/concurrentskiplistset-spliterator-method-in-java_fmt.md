...
`java.util.concurrent.ConcurrentSkipListSet.spliterator()` 方法是 Java 中的一个内置函数，它在这个集合的元素之间返回一个弱一致的 `Spliterator`。
...
[https://docs.oracle.com/javase/8/docs/api/java/util/concurrent/ConcurrentSkipListSet.html#spliterator--](https://docs.oracle.com/javase/8/docs/api/java/util/concurrent/ConcurrentSkipListSet.html#spliterator--)