...
> 原文：[https://www.geeksforgeeks.org/arrays-copyof-in-java-with-examples/](https://www.geeksforgeeks.org/arrays-copyof-in-java-with-examples/)
...
对于原始数组和新数组中有效的所有索引，这两个数组将具有相同的值。但是，如果复制的数组长度大于原始数组，则原始数组中缺失的索引在副本中将具有**`零`**。
