...
> 原文：[https://www.geeksforgeeks.org/java-program-to-check-if-a-singly-linked-list-is-palindrome/](https://www.geeksforgeeks.org/java-program-to-check-if-a-singly-linked-list-is-palindrome/)
...
其思想是使用函数调用堆栈作为容器。递归遍历，直到列表结束。当我们从最后一个`null`返回时，我们将处于最后一个节点。最后一个节点将与列表的第一个节点进行比较。
