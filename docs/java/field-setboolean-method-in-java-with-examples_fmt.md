...
> 原文: [https://www.geeksforgeeks.org/field-setboolean-method-in-java-with-examples/](https://www.geeksforgeeks.org/field-setboolean-method-in-java-with-examples/)
...
*   `NullPointerException`: 如果指定对象为空，且字段为实例字段。
...
[https://docs.oracle.com/javase/8/docs/api/java/lang/reflect/Field.html#setBoolean-java.lang.Object-boolean-](https://docs.oracle.com/javase/8/docs/api/java/lang/reflect/Field.html#setBoolean-java.lang.Object-boolean-)