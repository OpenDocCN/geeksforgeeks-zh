...
> 原文: [https://www.geeksforgeeks.org/how-to-use-google-play-install-referrer-api-in-android/](https://www.geeksforgeeks.org/how-to-use-google-play-install-referrer-api-in-android/)
...
### 第二步: 在 `build.gradle` 文件中添加 Google Play Referrer API 的依赖项
