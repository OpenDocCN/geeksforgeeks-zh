...
> 原文：[https://www.geeksforgeeks.org/java-8-biginteger-longvalueexact-method-with-examples/](https://www.geeksforgeeks.org/java-8-biginteger-longvalueexact-method-with-examples/)

`Java 8` 中引入了 `java.math.BigInteger.longValueExact()`。这是一个内置函数，它将 `BigInteger` 的值转换为 `long`，并检查丢失的信息。如果 `BigInteger` 的值大于 `9,223,372,036,854,775,807` 或小于 `-9,223,372,036,854,775,808`；该方法将抛出 `ArithmeticException`，因为大整数不适合长范围。
...
这个方法返回这个 `BigInteger` 的长值。

## 异常

如果 `BigInteger` 的值大于 `9,223,372,036,854,775,807` 或小于 `-9,223,372,036,854,775,808`，则方法抛出 `ArithmeticException`；因为这个范围不适合长距离。
...
### 程序一：演示正数 < `9,223,372,036,854,775,807` 的 `longValueExact()`方法
...
### 程序二：演示负数 > `-9,223,372,036,854,775,808` 的 `longValueExact()`方法
...
### 程序三：演示负数 < `-9,223,372,036,854,775,808` 的 `longValueExact()`方法。它会抛出 `ArithmeticException`
...
### 程序四：演示正数 > `9,223,372,036,854,775,807` 的 `longValueExact()`方法。它会抛出 `ArithmeticException`
...
**参考：**[https://docs.oracle.com/javase/8/docs/api/java/math/BigInteger.html#longValueExact--](https://docs.oracle.com/javase/8/docs/api/java/math/BigInteger.html#longValueExact--)