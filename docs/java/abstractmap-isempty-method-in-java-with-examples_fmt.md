...
> 原文: [https://www.geeksforgeeks.org/abstractmap-isempty-method-in-java-with-examples/](https://www.geeksforgeeks.org/abstractmap-isempty-method-in-java-with-examples/)
...
## 返回值:
如果映射为空或者不包含任何映射对，则该方法返回布尔值 `true`，否则返回布尔值 `false`。
