...
> 原文：[https://www.geeksforgeeks.org/how-to-display-all-users-who-liked-on-a-particular-blog-in-social-media-android-app/](https://www.geeksforgeeks.org/how-to-display-all-users-who-liked-on-a-particular-blog-in-social-media-android-app/)

这是“在 Android Studio 上构建社交媒体应用”教程的第 12 部分，我们将在本文中介绍以下功能：

*   我们将检查喜欢特定博客的用户列表。
*   点击总喜欢数后，我们将被重定向到 `PostLikedBy.Activity`。
*   在这种情况下，我们将使用 `recycler view` 来显示喜欢帖子的用户列表。
