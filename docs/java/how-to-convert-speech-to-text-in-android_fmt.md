...
> 原文：[https://www.geeksforgeeks.org/how-to-convert-speech-to-text-in-android/](https://www.geeksforgeeks.org/how-to-convert-speech-to-text-in-android/)
...
**第一步：** 在`activity_main.xml`中添加以下代码。这里添加了麦克风图标的`ImageView`和显示从语音转换而来的文本的`TextView`。
