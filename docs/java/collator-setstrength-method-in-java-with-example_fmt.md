# Java 中的 Collator.setStrength() 方法示例

> 原文：`https://www.geeksforgeeks.org/collator-setstrength-method-in-java-with-example/`

`java.text.Collator` 类的 `setStrength()` 方法用于设置 `Collator` 对象的强度属性，该属性将在比较两个字符串时帮助该对象。
