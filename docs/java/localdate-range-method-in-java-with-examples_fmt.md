...
> 原文: [https://www.geeksforgeeks.org/localdate-range-method-in-java-with-examples/](https://www.geeksforgeeks.org/localdate-range-method-in-java-with-examples/)
...
*   `UnsupportedTemporalTypeException` 唉哟哟哟哟哟哟哟哟哟哟哟哟哟哟哟哟哟哟哟哟哟哟哟哟哟哟哟哟哟哟哟哟哟哟哟哟哟哟哟哟哟哟哟哟哟哟哟哟哟哟哟哟哟哟哟哟哟哟哟哟哟哟哟哟哟哟哟哟哟哟哟哟哟哟哟。
...
[https://docs.oracle.com/javase/10/docs/api/java/time/LocalDate.html#range(java.time.temporal.TemporalField)](https://docs.oracle.com/javase/10/docs/api/java/time/LocalDate.html#range(java.time.temporal.TemporalField))