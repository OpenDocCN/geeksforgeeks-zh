...
> 原文：[`https://www.geeksforgeeks.org/bigdecimal-tobiginteger-method-in-java/`](https://www.geeksforgeeks.org/bigdecimal-tobiginteger-method-in-java/)
...
**参考：**[`https://docs.oracle.com/javase/7/docs/api/java/math/BigDecimal.html#toBigInteger()`](https://docs.oracle.com/javase/7/docs/api/java/math/BigDecimal.html#toBigInteger())