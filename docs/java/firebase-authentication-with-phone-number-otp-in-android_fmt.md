...
> 原文:[https://www.geeksforgeeks.org/firebase-authentication-with-phone-number-otp-in-android/](https://www.geeksforgeeks.org/firebase-authentication-with-phone-number-otp-in-android/)
...
将您的应用程序连接到 Firebase 后。如果没有添加，请确保在您的 `build.gradle` 文件中添加此依赖项。添加此依赖项后，同步您的项目。
...
## 第九步：在我们的 Firebase 控制台中启用 Firebase 电话认证
