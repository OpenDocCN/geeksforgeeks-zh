...
> 原文：[https://www.geeksforgeeks.org/count-occurrence-of-a-given-character-in-a-string-using-stream-api-in-java/](https://www.geeksforgeeks.org/count-occurrence-of-a-given-character-in-a-string-using-stream-api-in-java/)
...
*   将字符串转换为字符流
*   使用[`filter()`](https://www.geeksforgeeks.org/stream-filter-java-examples/)功能检查流中的字符是否是要计数的字符。
*   使用[`count()`](https://www.geeksforgeeks.org/java-util-stream-collectors-counting-method-examples/)功能对匹配的字符进行计数
