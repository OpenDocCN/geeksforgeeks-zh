...
> 原文: [https://www.geeksforgeeks.org/how-to-convert-a-string-to-arraylist-in-java/](https://www.geeksforgeeks.org/how-to-convert-a-string-to-arraylist-in-java/)
...
**抛出:** `PatternSyntaxException` – 如果提供的正则表达式语法无效。
