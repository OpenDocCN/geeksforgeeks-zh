...
> 原文：[https://www.geeksforgeeks.org/how-to-use-svg-vector-drawables-in-android/](https://www.geeksforgeeks.org/how-to-use-svg-vector-drawables-in-android/)
...
**步骤 2：右键单击 `res` -> `drawable` -> `新建` -> `矢量资产`**
