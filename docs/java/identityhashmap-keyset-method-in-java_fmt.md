...
> 原文: [https://www.geeksforgeeks.org/identityhashmap-keyset-method-in-java/](https://www.geeksforgeeks.org/identityhashmap-keyset-method-in-java/)

`java.util.IdentityHashMap.keySet()` 方法用于创建哈希映射中包含的一组关键元素。它基本上返回一个键的集合视图，或者我们可以创建一个新的集合并将键元素存储在其中。
...
下面的程序用来说明 `java.util.IdentityHashMap.keySet()` 方法:
