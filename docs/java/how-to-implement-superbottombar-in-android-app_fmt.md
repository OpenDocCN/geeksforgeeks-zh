...
> 原文：[https://www.geeksforgeeks.org/how-to-implement-superbottombar-in-android-app/](https://www.geeksforgeeks.org/how-to-implement-superbottombar-in-android-app/)
...
参考[如何在安卓工作室创建菜单文件夹 & 菜单文件](https://www.geeksforgeeks.org/how-to-create-menu-folder-menu-file-in-android-studio/)，创建菜单文件。下面是 `menu.xml` 文件的代码。
