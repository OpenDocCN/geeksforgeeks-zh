# LongStream.Builder add(long t)方法详解

> 原文：[https://www.geeksforgeks.org/longstream-builder-addlong-t-in-java/](https://www.geeksforgeks.org/longstream-builder-addlong-t-in-java/)

`LongStream.Builder add(long t)` 用于在流的构建阶段将元素插入到流中。它向正在构建的流中添加一个元素。
