...
> 原文: [https://www.geeksforgeeks.org/java-if-else-statement-with-examples/](https://www.geeksforgeeks.org/java-if-else-statement-with-examples/)
...
4. flow enters the else block.
   4.a) "i is greater than 15" printed
5. "outside if-else block" printed.
```
