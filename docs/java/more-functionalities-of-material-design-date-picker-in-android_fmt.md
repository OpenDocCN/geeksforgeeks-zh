...
> 原文：[https://www.geeksforgeeks.org/more-functions-of-material-design-date-picker-in-Android/](https://www.geeksforgeeks.org/more-functions-of-material-design-date-picker-in-Android/)

正如在安卓中[材料设计日期选择器](https://www.geeksforgeeks.org/material-design-date-picker-in-android/)中所讨论的，它为用户提供了许多功能，并且易于开发人员实现。因此，在本文中，我们将通过示例讨论材料设计日期选择器的更多功能。请注意，用户界面部分将与第1部分文章中的相同。我们将只使用``Java``文件。

## 功能 1：阻止今天日期之前的所有日期

这个特性对于开发者来说非常有用，可以避免用户选择错误的日期。下面给出了一个示例GIF，以了解我们将在这个功能中做什么。
