# Java 中的 `Collections.synchronizedSet()` 方法示例

> 原文：[https://www.geeksforgeeks.org/collections-synchronizedset-method-in-java-with-examples/](https://www.geeksforgeeks.org/collections-synchronizedset-method-in-java-with-examples/)
