...
> 原文: [https://www.geeksforgeeks.org/bytebuffer-putfloat-methods-in-java-with-examples/](https://www.geeksforgeeks.org/bytebuffer-putfloat-methods-in-java-with-examples/)
...
**参数:** 该方法取一个参数 `float value`，即需要写入的浮点值。
...
下面是举例说明 `putFloat(float value)` 方法的例子:
