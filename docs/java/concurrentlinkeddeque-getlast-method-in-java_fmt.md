# Java 中的 ConcurrentLinkedDeque getLast() 方法

> 原文：[https://www.geeksforgeeks.org/concurrentlinkeddeque-getlast-method-in-java/](https://www.geeksforgeeks.org/concurrentlinkeddeque-getlast-method-in-java/)

`java.util.concurrent.ConcurrentLinkedDeque.getLast()` 方法是 Java 中的内置方法，它返回 deque 容器的最后一个元素。
...
下面的程序说明了 `ConcurrentLinkedDeque.getLast()` 方法：
...
[https://docs.oracle.com/javase/8/docs/api/java/util/concurrent/ConcurrentLinkedDeque.html#getLast--](https://docs.oracle.com/javase/8/docs/api/java/util/concurrent/ConcurrentLinkedDeque.html#getLast--)