...
> 原文：[https://www.geeksforgeeks.org/localdatetime-format-method-in-java/](https://www.geeksforgeeks.org/localdatetime-format-method-in-java/)

Java 中 `LocalDateTime` 类的 `format()` 方法使用指定的格式化程序格式化这个日期时间。
...
这个方法接受一个参数 `formatter`，指定要使用的格式化程序，而不是空值。
...
[https://docs.oracle.com/javase/10/docs/api/java/time/LocalDateTime.html#format(java.time.format.DateTimeFormatter)](https://docs.oracle.com/javase/10/docs/api/java/time/LocalDateTime.html#format(java.time.format.DateTimeFormatter))