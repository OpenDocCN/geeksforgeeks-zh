...
> 原文: [https://www.geeksforgeeks.org/keystore-getdefaulttype-method-in-java-with-examples/](https://www.geeksforgeeks.org/keystore-getdefaulttype-method-in-java-with-examples/)
...
**参考:** [https://docs.oracle.com/javase/9/docs/api/java/security/KeyStore.html#getDefaultType--](https://docs.oracle.com/javase/9/docs/api/java/security/KeyStore.html#getDefaultType--)