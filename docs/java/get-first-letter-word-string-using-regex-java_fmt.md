...
> 原文：[https://www.geeksforgeeks.org/get-first-letter-word-string-using-regex-java/](https://www.geeksforgeeks.org/get-first-letter-word-string-using-regex-java/)
...
本文由**高拉夫·米格拉尼**供稿。如果你喜欢 GeeksforGeeks 并想投稿，你也可以使用`contribute.geeksforgeeks.org`写一篇文章或者把你的文章邮寄到`contribute@geeksforgeeks.org`。看到你的文章出现在极客博客主页上，帮助其他极客。
