...
> 原文：[https://www.geeksforgeeks.org/conversion-of-java-maps-to-list/](https://www.geeksforgeeks.org/conversion-of-java-maps-to-list/)
...
*   `map.values()` 将返回一个映射值的集合。
*   `map.keySet()` 将返回一个映射键点的集合。
...
### 方法 2：`List Listofvalues = new ArrayList(map.values());`
