...
> 原文：[https://www.geeksforgeeks.org/difference-between-uri-and-urn-in-java/](https://www.geeksforgeeks.org/difference-between-uri-and-urn-in-java/)
...
上述示例行完全称为 `URI`，而上述示例的 `www.website.com/html/#posts` 部分称为 `URN`。