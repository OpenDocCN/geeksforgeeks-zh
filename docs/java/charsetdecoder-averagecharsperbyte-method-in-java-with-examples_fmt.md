# Java 中的 CharsetDecoder averageCharsPerByte() 方法示例
...
`averageCharsPerByte()` 方法是 `java.nio.charset.CharsetDecoder` 类的内置方法，它返回每个输入字节将产生的平均字符数。该试探值可用于估计给定输入序列所需的输出缓冲器的大小。
...
**参考：** [https://docs.oracle.com/javase/9/docs/api/java/nio/charset/CharsetDecoder.html#averageCharsPerByte--](https://docs.oracle.com/javase/9/docs/api/java/nio/charset/CharsetDecoder.html#averageCharsPerByte--)