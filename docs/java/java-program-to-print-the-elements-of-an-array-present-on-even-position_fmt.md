...
> 原文: [https://www.geeksforgeeks.org/java-program-to-print-the-elements-of-an-array-present-on-even-position/](https://www.geeksforgeeks.org/java-program-to-print-the-elements-of-an-array-present-on-even-position/)
...
2.  然后在`main()`函数内部，用上例中提到的值声明并初始化一个数组。
