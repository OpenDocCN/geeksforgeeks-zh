...
> 原文：[https://www.geeksforgeeks.org/context-menu-in-android-with-example/](https://www.geeksforgeeks.org/context-menu-in-android-with-example/)
...
打开`res->Layout->activity_main.xml`并编写以下代码。在这个文件中只添加一个[文本视图](https://www.geeksforgeeks.org/textview-widget-in-android-using-java-with-examples/)来显示一个简单的文本。
