...
> 原文：[https://www.geeksforgeeks.org/how-to-play-audio-from-url-in-android/](https://www.geeksforgeeks.org/how-to-play-audio-from-url-in-android/)
...
### 第三步：向 `AndroidManifest.xml` 文件添加权限
