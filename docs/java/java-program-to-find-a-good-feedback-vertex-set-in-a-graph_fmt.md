...
// This if condition will help not to have
// Any duplicate values inside the new List
if (lit.contains(i)) {
...
// the values of the adjacent List as we move on to
// make the vertices. The other values are simultaneously removed.
