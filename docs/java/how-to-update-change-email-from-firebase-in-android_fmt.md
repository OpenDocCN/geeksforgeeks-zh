...
> 原文: [https://www.geeksforgeeks.org/how-to-update-change-email-from-firebase-in-android/](https://www.geeksforgeeks.org/how-to-update-change-email-from-firebase-in-android/)
...
所以主要部分存在于 java 文件中。在这个文件中，我们需要重新认证用户，因为根据文档，更改主电子邮件地址是一个敏感的操作。下面是执行相同操作的代码片段。
