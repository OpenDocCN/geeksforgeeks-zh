...
> 原文：[https://www.geeksforgeeks.org/java-program-to-print-all-unique-words-of-a-string/](https://www.geeksforgeeks.org/java-program-to-print-all-unique-words-of-a-string/)
...
想法是使用 `Map` 来跟踪已经发生的单词。但是首先，我们必须从一个字符串中提取所有的单词，因为一个字符串可能包含许多带有标点符号的句子。
