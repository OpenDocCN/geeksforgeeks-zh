...
> 原文：[https://www.geeksforgeeks.org/implementation-of-facebooks-android-device-year-class-library-in-android/](https://www.geeksforgeeks.org/implementation-of-facebooks-android-device-year-class-library-in-android/)
...
*   右键单击 `res`，选择 `新建 > 目录`
*   键入 `anim` 作为目录名
*   右键点击 `anim`，选择 `新建 > 动画资源文件`
*   键入 `animation` 作为文件名，然后按确定。

下面是 `animation.xml` 文件的代码。
