...
> 原文：[https://www.geeksforgeeks.org/atomicreference-setplain-method-in-java-with-examples/](https://www.geeksforgeeks.org/atomicreference-setplain-method-in-java-with-examples/)

`AtomicReference`类的`setPlain()`方法用于设置该原子引用对象的值，其内存语义为设置，就好像该变量被声明为非易失性和非最终的一样。
