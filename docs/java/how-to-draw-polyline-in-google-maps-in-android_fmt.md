...
> 原文：[https://www.geeksforgeeks.org/how-to-draw-polyline-in-google-maps-in-android/](https://www.geeksforgeeks.org/how-to-draw-polyline-in-google-maps-in-android/)

谷歌地图用于许多安卓应用。在使用谷歌地图时，有许多修改，你会看到在这个应用程序中使用地图。当我们在 OLA 和优步等不同的应用程序中使用谷歌地图时，我们会看到地图上绘制的线条和路线。在本文中，我们将看一下在安卓中的谷歌地图上绘制折线。
