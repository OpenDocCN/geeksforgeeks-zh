...
> 原文：[`https://www.geeksforgeeks.org/buffer-isreadonly-methods-in-java-with-examples/`](https://www.geeksforgeeks.org/buffer-isreadonly-methods-in-java-with-examples/)

[`java.nio.Buffer`](https://www.geeksforgeeks.org/tag/java-bytebuffer/) 类的 [`isReadOnly()`](https://www.geeksforgeeks.org/buffer-isreadonly-methods-in-java-with-examples/) 方法用来判断这个缓冲区是否是只读的。
...
当且仅当该缓冲区为只读时，该方法将返回 `true`。

以下是说明 [`isReadOnly()`](https://www.geeksforgeeks.org/buffer-isreadonly-methods-in-java-with-examples/) 方法的示例：
