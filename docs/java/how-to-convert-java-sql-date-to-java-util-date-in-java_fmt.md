...
> 原文：[https://www.geeksforgeeks.org/how-to-convert-java-sql-date-to-java-util-date-in-java/](https://www.geeksforgeeks.org/how-to-convert-java-sql-date-to-java-util-date-in-java/)

如果我们有 SQL 包的日期对象，那么我们可以很容易地将其转换成一个实用的日期对象。在创建 `util Date` 对象时，我们需要传递 `getTime()` 方法。
