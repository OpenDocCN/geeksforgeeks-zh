...
> 原文：[https://www.geeksforgeeks.org/how-to-change-the-comparator-to-return-a-descending-order-in-java-treeset/](https://www.geeksforgeeks.org/how-to-change-the-comparator-to-return-a-descending-order-in-java-treeset/)
...
为了更改比较器，创建了一个用户定义的类，该类实现了比较器接口，更具体地说，实现比较器之前，遵循伪代码来清楚地理解比较器。在创建的初始状态下，作为参数在树集中传递降序比较器 `descendingComparator()`，以获得相应的降序集合。

**语法：** 传递下降运算符 `descendingComparator()`
