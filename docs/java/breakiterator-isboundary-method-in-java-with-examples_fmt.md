# BreakIterator 是 Java 中的 isBoundary() 方法，带有示例

> 原文: [https://www.geeksforgeeks.org/breakiterator-isboundary-method-in-java-with-examples/](https://www.geeksforgeeks.org/breakiterator-isboundary-method-in-java-with-examples/)
...
该方法以 `offset` 为参数，检查是否为边界。

## 返回值

如果传递的偏移量是边界，则该方法提供 `true`，否则提供 `false`。
...
[https://docs.oracle.com/javase/9/docs/api/java/text/BreakIterator.html#isBoundary-int-](https://docs.oracle.com/javase/9/docs/api/java/text/BreakIterator.html#isBoundary-int-)