...
> 原文: [https://www.geeksforgeeks.org/collationelementiterator-settextcharacteriterator-method-in-java-with-example/](https://www.geeksforgeeks.org/collationelementiterator-settextcharacteriterator-method-in-java-with-example/)
...
这个方法采用了一个新的`CharacterIterator`对象，包含迭代器将要迭代的字符串值。
...
[https://docs.oracle.com/javase/9/docs/api/java/text/CollationElementIterator.html#setText-java.text.CharacterIterator-](https://docs.oracle.com/javase/9/docs/api/java/text/CollationElementIterator.html#setText-java.text.CharacterIterator-)