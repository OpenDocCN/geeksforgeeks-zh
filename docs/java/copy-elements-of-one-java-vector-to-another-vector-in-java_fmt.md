...
> 原文：[https://www.geeksforgeeks.org/copy-elements-of-one-java-vector-to-another-vector-in-java/](https://www.geeksforgeeks.org/copy-elements-of-one-java-vector-to-another-vector-in-java/)

[`Vector`](https://www.geeksforgeeks.org/java-util-vector-class-java/) 类似于数组，但也是可生长的，或者我们可以说不需要固定的大小。以前向量是遗留类的一部分，但现在它是集合的一部分。它还实现了一个列表接口，所以我们也可以在向量上使用列表接口的任何方法。
...
## 方法二：使用 [`add()`](https://www.geeksforgeeks.org/vector-add-method-in-java/) 方法逐一添加
