...
> 原文：[https://www.geeksforgeeks.org/generate-infinite-stream-of-double-in-java/](https://www.geeksforgeeks.org/generate-infinite-stream-of-double-in-java/)

给定的任务是在 Java 中生成一个无限顺序的无序双流。

这可以通过以下方式实现：

## 方法一：使用 `DoubleStream.iterate()`
...
## 方法三：使用 `DoubleStream.generate()` 方法
