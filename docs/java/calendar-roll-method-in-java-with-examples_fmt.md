# Java 中的 Calendar.roll() 方法，带示例

> 原文：[https://www.geeksforgeeks.org/calendar-roll-method-in-java-with-examples/](https://www.geeksforgeeks.org/calendar-roll-method-in-java-with-examples/)
