...
> 原文: [https://www.geeksforgeeks.org/delayqueue-remove-method-in-java/](https://www.geeksforgeeks.org/delayqueue-remove-method-in-java/)
...
**参数:** 该方法将单个对象 `obj` 作为要从该交易队列中移除的参数。

**返回值:** 如果元素删除成功，则返回布尔值 `true`，否则返回 `false`。
