# Java 中的 Character.isIdentifierIgnorable()，示例

> 原文：[https://www.geeksforgeeks.org/character-isidentifierignorable-in-java-with-examples/](https://www.geeksforgeeks.org/character-isidentifierignorable-in-java-with-examples/)

1.  `java.lang.Character.isIdentifierIgnorable(char ch)` 是 Java 中的一个内置方法，用于判断指定字符在 Java 标识符或 Unicode 标识符中是否应被视为可忽略字符。
...
**参数：** 参数 `ch` 是 `char` 数据类型，指的是要测试的字符。

**返回值：** 如果字符是可忽略的控制字符，可能是 Java 或 Unicode 标识符的一部分，则该方法返回 `true`，否则返回 `false`。

下面的程序说明了 `Character.isIdentifierIgnorable(char ch)` 方法：
...
public class gfg {
    public static void main(String[] args) {
        ...
        // Assigns isIdentifierIgnorable results of c1, c2 to boolean primitives
...
2.  `java.lang.Character.isIdentifierIgnorable(int codePoint)` 在所有方面都与前一个方法相似。
...
**参数：** 该函数接受 `int` 数据类型的单个参数 `codePoint`，该参数指定要测试的字符（Unicode 代码点）。

**返回值：** 如果字符是可忽略的控制字符，可能是 Java 或 Unicode 标识符的一部分，则该方法返回 `true`，否则返回 `false`。

下面的程序说明了 `Character.isIdentifierIgnorable(int codePoint)` 方法：
...
public class gfg {
    public static void main(String[] args) {
        ...
        // Assign isIdentifierIgnorable results of cp1, cp2 to boolean primitives bool1, bool2
        boolean bool1 = Character.isIdentifierIgnorable(c1);
        boolean bool2 = Character.isIdentifierIgnorable(c2);
...
**参考：** [https://docs.oracle.com/javase/7/docs/api/java/lang/Character.html#isIdentifierIgnorable(char)](https://docs.oracle.com/javase/7/docs/api/java/lang/Character.html#isIdentifierIgnorable(char))