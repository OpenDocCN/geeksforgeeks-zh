...
> 原文：[https://www.geeksforgeeks.org/calendar-set-method-in-java-with-examples/](https://www.geeksforgeeks.org/calendar-set-method-in-java-with-examples/)

`Calendar` 类中的 `set(int calndr_field, int new_val)` 方法用于将 `calndr_field` 值设置为 `new_val`。此日历的旧字段被新字段替换。
...
[https://docs.oracle.com/javase/8/docs/api/java/util/Calendar.html#set-int-int-](https://docs.oracle.com/javase/8/docs/api/java/util/Calendar.html#set-int-int-)