...
> 原文：[https://www.geeksforgeeks.org/compressing-decompressing-files-using-gzip-format-java/](https://www.geeksforgeeks.org/compressing-decompressing-files-using-gzip-format-java/)
...
在这个例子中，我们有一个文本文件在 `/home/saket/Desktop/GeeksforGeeks/compress.java` 驱动下的“geeksforgeeks”文件夹中，我们正在压缩和生成同一个文件夹中的 GZip 文件。
