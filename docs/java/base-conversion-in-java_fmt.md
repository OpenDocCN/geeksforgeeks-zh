...
想法是使用 `Integer` 包装类中的 [`toString()`](https://www.geeksforgeeks.org/integer-tostring-in-java/) 方法。我们还使用 [`parseInt()`](https://www.geeksforgeeks.org/string-to-integer-in-java-parseint/) 来解析给定基数中给定的数字字符串表示。
