...
> 原文：[https://www.geeksforgeeks.org/filestore-getunallocatedspace-method-in-java-with-examples/](https://www.geeksforgeeks.org/filestore-getunallocatedspace-method-in-java-with-examples/)

一个`FileStore`类的`getUnallocatedSpace()`方法用于获取文件存储中未分配的字节数。此方法对于检查可用空间很有用。此方法将可用的未分配空间作为`long`值返回。
...
参考文献：[https://docs.oracle.com/javase/10/docs/api/java/nio/file/FileStore.html#getUnallocatedSpace()](https://docs.oracle.com/javase/10/docs/api/java/nio/file/FileStore.html#getUnallocatedSpace())