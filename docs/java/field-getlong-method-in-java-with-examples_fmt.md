...
> 原文: [https://www.geeksforgeeks.org/field-getlong-method-in-java-with-examples/](https://www.geeksforgeeks.org/field-getlong-method-in-java-with-examples/)
...
该方法接受单个参数 `obj`，该参数是提取长值的对象。

## 返回值

该方法返回转换为 long 类型的字段的值。
...
[https://docs.oracle.com/javase/8/docs/api/java/lang/reflect/Field.html#getLong-java.lang.Object-](https://docs.oracle.com/javase/8/docs/api/java/lang/reflect/Field.html#getLong-java.lang.Object-)