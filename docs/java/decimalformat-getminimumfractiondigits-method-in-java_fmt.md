...
[https://docs . Oracle . com/javase/7/docs/API/Java/text/decimal format . html # getMinimumFractionDigits()](https://docs.oracle.com/javase/7/docs/api/java/text/DecimalFormat.html#getMinimumFractionDigits())