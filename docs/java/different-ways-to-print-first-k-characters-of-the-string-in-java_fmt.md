...
> 原文：[https://www.geeksforgeeks.org/different-ways-to-print-first-k-characters-of-the-string-in-java/](https://www.geeksforgeeks.org/different-ways-to-print-first-k-characters-of-the-string-in-java/)
...
3.  检查字符串长度是否大于 `k`，然后使用 `str.substring(0, k)` 获取字符串的前 `k` 个字符。
