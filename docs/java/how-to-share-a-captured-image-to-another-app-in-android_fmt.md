...
> 原文：[https://www.geeksforgeeks.org/how-to-share-a-captured-image-to-another-app-in-android/](https://www.geeksforgeeks.org/how-to-share-a-captured-image-to-another-app-in-android/)

**先决条件：** [如何通过意图打开相机并拍摄图像](https://www.geeksforgeeks.org/android-how-to-open-camera-through-intent-and-display-captured-image/)

在本文中，我们将尝试使用[安卓工作室](https://www.geeksforgeeks.org/guide-to-install-and-set-up-android-studio/)将捕获的图像（[来自本文](https://www.geeksforgeeks.org/android-how-to-open-camera-through-intent-and-display-captured-image/)）发送到其他应用程序。
...
2.  这里 `pictureDir`（文件）指的是名为 `DIRECTORY_PICTURES` 的外存目录。
