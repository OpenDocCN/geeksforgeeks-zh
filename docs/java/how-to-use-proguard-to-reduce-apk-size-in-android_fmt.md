...
> 原文：[https://www.geeksforgeeks.org/how-to-use-proguard-to-reduce-apk-size-in-android/](https://www.geeksforgeeks.org/how-to-use-proguard-to-reduce-apk-size-in-android/)
...
buildtypes {
    release {
        //在此进行更改
        minifyEnabled true
        proguardFiles getDefaultFile('proguard-android-optimize.txt'), "proguard-rules.pro"
    }
}
```
