...
> 原文：[https://www.geeksforgeeks.org/calendar-getgreatestminimum-method-in-java-with-examples/](https://www.geeksforgeeks.org/calendar-getgreatestminimum-method-in-java-with-examples/)

`Calendar`类中的`getGreatestMinimum(int calndr_field)`方法用于返回此`Calendar`实例的给定日历字段(`int calndr_field`)的最高最小值。
...
该方法取一个参数`calndr_field`，指的是要操作的日历字段。
...
[https://docs.oracle.com/javase/7/docs/api/java/util/Calendar.html#getGreatestMinimum(int)](https://docs.oracle.com/javase/7/docs/api/java/util/Calendar.html#getGreatestMinimum(int))