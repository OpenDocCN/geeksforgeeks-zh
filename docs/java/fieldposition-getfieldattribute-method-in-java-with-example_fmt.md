...
> 原文: [https://www.geeksforgeeks.org/fieldposition-getfieldattribute-method-in-java-with-example/](https://www.geeksforgeeks.org/fieldposition-getfieldattribute-method-in-java-with-example/)
...
## 参考:
[https://docs.oracle.com/javase/9/docs/api/java/text/FieldPosition.html#getFieldAttribute--](https://docs.oracle.com/javase/9/docs/api/java/text/FieldPosition.html#getFieldAttribute--)