...
> 原文: [https://www.geeksforgeeks.org/jswing-create-translucent-shaped-windows-java/](https://www.geeksforgeeks.org/jswing-create-translucent-shaped-windows-java/)
...
1.  **setBackground(Color c):** 将背景颜色设置为颜色 `c` 的方法。
2.  **Color(int r, int g, int b, int alpha):** 用指定的红、绿、蓝和 alpha 值创建新颜色。其中 `alpha` 是半透明值，其中 255 是不透明的，0 是透明的。
3.  **getRGB(int x, int y):** 返回坐标 `x`, `y` 的 RGB 值。
4.  **setColor(Color c):** 将图形的颜色设置为 `c`。
...
**解释:** 在这里，在输入中我们可以看到背景是透明的，而极客的符号仍然保持原样。透过透明的背景，我们可以看到下面的窗户。我们已经将徽标从背景中分离出来，并将其画在透明的窗户上。
...
**输入 1:** ![](img/add141818a0ebd9405ea3351077eb807.png)
**输出 1:** ![](img/0acee4d426033238b7395712a4fffa34.png)

**输入 2:** ![](img/6a0f66c5724fd0971408310c227e74b3.png)
**输出 2:** ![](img/ebb5d669b00cf11f453defcf6dd36a5d.png)

**输入 3:** ![](img/fd0978a2f94bee4f0af720f43204af30.png)
**输出 3:** ![](img/03471ced469f36ff3d0965cdab24a106.png)
