...
`ByteBuffer`类的`hashCode()`方法用于返回该缓冲区的当前哈希代码。
一个字节缓冲区的哈希码只取决于它的剩余元素；也就是说，从`position()`到`limit()-1`的元素。
...
[https://docs.oracle.com/javase/9/docs/api/java/nio/ByteBuffer.html#hashCode--](https://docs.oracle.com/javase/9/docs/api/java/nio/ByteBuffer.html#hashCode--)