...
> 原文: [https://www.geeksforgeeks.org/identityhashmap-clear-method-in-java/](https://www.geeksforgeeks.org/identityhashmap-clear-method-in-java/)

`java.util.IdentityHashMap.clear()`方法用于清除和移除指定映射中的所有元素或映射。
