...
`java.util.concurrent.ConcurrentSkipListSet.clear()`方法是 Java 中的一个内置函数，它从这个集合中移除所有元素。
...
[https://docs.oracle.com/javase/8/docs/api/java/util/concurrent/ConcurrentSkipListSet.html#clear--](https://docs.oracle.com/javase/8/docs/api/java/util/concurrent/ConcurrentSkipListSet.html#clear--)