# Java 中的 HashMap values()方法

> 原文: [https://www.geeksforgeeks.org/hashmap-values-method-in-java/](https://www.geeksforgeeks.org/hashmap-values-method-in-java/)

`java.util.HashMap.values()`方法用于从映射的值中创建一个集合。它基本上返回哈希表中值的集合视图。
