...
> 原文：[https://www.geeksforgeeks.org/how-to-keep-the-device-screen-on-in-android/](https://www.geeksforgeeks.org/how-to-keep-the-device-screen-on-in-android/)

在[安卓](https://www.geeksforgeeks.org/kotlin-android-tutorial/)中，屏幕超时通常设置为30秒或由用户在系统设置中手动设置，以避免电池耗尽。但也有像秒表、文档阅读器应用程序、游戏等应用程序需要屏幕始终保持清醒的情况。本文演示了如何保持设备屏幕清醒。
...
要更改基本应用程序主题颜色，请转到`app -> res -> values -> colors.xml`，并调用以下颜色组合。
...
这两种方法都是相同的，可以使用感觉更好的方法，但是推荐以编程方式实现这一点，因为在复杂的安卓应用程序中，开发人员在特定的活动中设置许多标志，很容易获得所有这些标志，并手动禁用和管理它们。