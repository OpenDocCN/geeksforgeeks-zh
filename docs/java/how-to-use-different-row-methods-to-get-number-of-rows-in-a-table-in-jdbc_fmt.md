...
> 原文: [https://www.geeksforgeeks.org/how-to-use-different-row-methods-to-get-number-of-rows-in-a-table-in-jdbc/](https://www.geeksforgeeks.org/how-to-use-different-row-methods-to-get-number-of-rows-in-a-table-in-jdbc/)
...
**说明:** SQL 和 Oracle 数据库多用于说明。这里考虑的是 SQL 数据库。这里表名是 `Table_Name`。在这里，它将接受所有的列并计算行数。

**输入:** 表中现有数据如下图所示

*   使用的 SQL server: `sqljdbc4.jar`
*   使用的 SQL 表
