...
> 原文：[https://www.geeksforgeeks.org/hijrahdate-hashcode-method-in-java-with-example/](https://www.geeksforgeeks.org/hijrahdate-hashcode-method-in-java-with-example/)

`HijrahDate`类的`hashCode()`方法用于获取特定 hijrah 日期的哈希代码。
