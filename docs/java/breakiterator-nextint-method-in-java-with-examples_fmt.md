...
> 原文: [https://www.geeksforgeeks.org/breakiterator-nextint-method-in-java-with-examples/](https://www.geeksforgeeks.org/breakiterator-nextint-method-in-java-with-examples/)
...
取 `n`（要跳过的边界数）作为参数。如果 `n` 为正，它将向前跳过边界，否则向后跳过边界。

## 返回值

此方法提供第 n 个下一个边界的索引形成当前边界。
...
[https://docs.oracle.com/javase/9/docs/api/java/text/BreakIterator.html#next-int-](https://docs.oracle.com/javase/9/docs/api/java/text/BreakIterator.html#next-int-)