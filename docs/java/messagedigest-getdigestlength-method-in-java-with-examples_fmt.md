...
> 原文: [https://www.geeksforgeeks.org/messagedigest-getdigestlength-method-in-java-with-examples/](https://www.geeksforgeeks.org/messagedigest-getdigestlength-method-in-java-with-examples/)

`MessageDigest`类的`getDigestLength()`方法用于获取消息摘要对象的对象大小，单位为字节。
