...
> 原文：[https://www.geeksforgeeks.org/linkedlist-pop-method-in-java/](https://www.geeksforgeeks.org/linkedlist-pop-method-in-java/)
...
该方法返回`LinkedList`表示的栈的第一个（栈顶）值。

## 异常

如果`LinkedList`表示的堆栈中没有元素，`pop`方法将抛出`NoSuchElementException()`。
