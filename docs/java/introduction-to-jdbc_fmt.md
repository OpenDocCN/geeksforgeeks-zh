...
## [JDBC 建筑](https://www.geeksforgeeks.org/dbms-architecture-2-level-3-level/)
...
## [JDBC 架构的类型(2 层和 3 层)](https://www.geeksforgeeks.org/dbms-architecture-2-level-3-level/)
...
## [JDBC 的工作](https://www.geeksforgeeks.org/establishing-jdbc-connection-in-java/)
