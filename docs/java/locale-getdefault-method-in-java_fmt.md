# Java 中的 `getDefault()` 方法

> 原文：[https://www.geeksforgeeks.org/locale-getdefault-method-in-java/](https://www.geeksforgeeks.org/locale-getdefault-method-in-java/)
...
**参数：** 取 `Locale.Category` 类型的强制参数 `category`。
