...
> 原文：[https://www.geeksforgeeks.org/java-program-to-append-a-string-in-an-existing-file/](https://www.geeksforgeeks.org/java-program-to-append-a-string-in-an-existing-file/)
...
它在追加模式下给定一个文件对象，构造一个 `FileWriter` 对象。现在让我们切换到这个类的方法，这个类在这里被调用，并在将一个字符串附加到一个现有文件中时起着关键作用，如下所示：
...
class GeeksforGeeks {
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        // Now appending given str to above created file
