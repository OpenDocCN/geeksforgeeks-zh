# Java 中的 ConcurrentSkipListMap clone() 方法，带示例
...
[`java.util.concurrent.ConcurrentSkipListMap`](https://www.geeksforgeeks.org/concurrentskiplistset-in-java-with-examples/) 的 [`clone()`](https://www.geeksforgeeks.org/concurrentskiplistmap-clone-method-in-java-with-examples/) 方法是 Java 中的一个内置函数，它返回这个 `ConcurrentSkipListMap` 实例的一个浅拷贝。键和值本身不会被克隆。
...
函数返回这个 `ConcurrentSkipListMap` 的一个浅拷贝。
...
**参考：** [https://docs.oracle.com/javase/9/docs/api/java/util/concurrent/ConcurrentSkipListMap.html#clone--](https://docs.oracle.com/javase/9/docs/api/java/util/concurrent/ConcurrentSkipListMap.html#clone--)