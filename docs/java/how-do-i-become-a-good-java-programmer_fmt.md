...
> 原文：[https://www.geeksforgeeks.org/how-do-i-become-a-good-java-programmer/](https://www.geeksforgeeks.org/how-do-i-become-a-good-java-programmer/)
...
实现你正在学习的东西。在线或离线练习编程，这会增强你的信心。要有规律，制定目标，并努力在规定的时间内完成。只有当你实际执行你所理解的东西时，知识的深度才会到来。加入 Java 编程实践与竞赛，如：[`CodeChef`](https://www.codechef.com/)、[`SPOJ`](https://www.spoj.com/)、[`ProjectEuler`](https://projecteuler.net/about)。
...
当你开始研究一项新技术时，最好也是最先做的事情就是订阅技术论坛。不管你面对的是什么问题，其他人可能早就已经面对了，你可能会找到解决办法。关注好的博客，并通过分享你的观点来帮助他人。加入 Java 编程社交平台，如：[`StackOverflow`](https://stackoverflow.com/tags)、[`DreamInCode` 论坛](https://www.dreamincode.net/forums/forum/32-java/)、[`Java-Forums`](https://www.java-forums.org/activity.php)、[`Coderanch` 论坛](https://coderanch.com/forums)等。
