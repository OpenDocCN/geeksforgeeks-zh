...
> 原文：[https://www.geeksforgeeks.org/how-to-build-a-simple-magic-8-ball-app-in-android/](https://www.geeksforgeeks.org/how-to-build-a-simple-magic-8-ball-app-in-android/)
...
**球图像：**下面列出了所有的球图像。将它们保存在资源中的可绘制文件夹中。转到 `app > res > drawable` 并粘贴以下文件：
