...
> 原文：[https://www.geeksforgeeks.org/how-to-convert-a-string-value-to-short-value-in-java-with-examples/](https://www.geeksforgeeks.org/how-to-convert-a-string-value-to-short-value-in-java-with-examples/)
...
[短类](https://www.geeksforgeeks.org/java-lang-short-class-java/)的 `valueOf()` 方法将数据从其内部形式转换为人类可读的形式。
