...
> 原文: [https://www.geeksforgeeks.org/difference-between-java-io-and-java-nio/](https://www.geeksforgeeks.org/difference-between-java-io-and-java-nio/)
...
## 1. Stream oriented vs Buffer Oriented Packages
...
## 2. Blocking IO vs Non Blocking IO Packages
