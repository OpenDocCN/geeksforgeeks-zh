...
> 原文：[https://www.geeksforgeeks.org/dictionary-get-method-in-java-with-examples/](https://www.geeksforgeeks.org/dictionary-get-method-in-java-with-examples/)
...
该方法取一个对象类型的参数 `key_element`，指的是应该取其关联值的键。

## 返回值

该方法返回与参数中 `key_element` 关联的值。
