# Java Guava IntMath类的mean()方法

> 原文：[https://www.geeksforgeeks.org/java-guava-mean-method-of-intmath-class/](https://www.geeksforgeeks.org/java-guava-mean-method-of-intmath-class/)

[Guava的`IntMath`类](https://www.geeksforgeeks.org/intmath-class-guava-java/)的`mean(int x, int y)`方法接受两个参数`x`和`y`，并计算它们向负无穷大舍入的算术平均值。这种方法具有溢出弹性。
