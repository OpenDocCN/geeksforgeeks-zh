...
> 原文: [https://www.geeksforgeeks.org/java-program-to-compute-the-sum-of-numbers-in-a-list-using-recursion/](https://www.geeksforgeeks.org/java-program-to-compute-the-sum-of-numbers-in-a-list-using-recursion/)
...
2.  使用 [`ArrayList()`](https://www.geeksforgeeks.org/java-util-arraylist-add-method-java/) 方法

**方法 1:** 将数组列表转换为数组，并在数组上使用递归原理。
