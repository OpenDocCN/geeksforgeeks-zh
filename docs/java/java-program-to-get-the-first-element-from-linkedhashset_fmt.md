...
> 原文: [https://www.geeksforgeeks.org/java-program-to-get-the-first-element-from-linkedhashset/](https://www.geeksforgeeks.org/java-program-to-get-the-first-element-from-linkedhashset/)
...
public class GFG {
        ...
        throws java.lang.Exception
    {
        ...
        // holds True till there is a single element in an object
...
### 方法 3：使用[流](https://www.geeksforgeeks.org/stream-in-java/)
