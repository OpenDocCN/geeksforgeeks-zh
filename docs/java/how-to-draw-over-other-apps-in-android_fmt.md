...
> 原文：[https://www.geeksforgeeks.org/how-to-draw-over-other-apps-in-android/](https://www.geeksforgeeks.org/how-to-draw-over-other-apps-in-android/)
...
为了吸引我们需要的其他应用程序，`android.permission.SYSTEM_ALERT_WINDOW`权限，对于具有`API版本> 23`的 Android，我们需要在运行时请求此权限。`android.permission.SYSTEM_ALERT_WINDOW`允许应用程序使用`WindowManager`类型创建窗口。显示在所有其他应用程序的顶部。
