...
> 原文：[https://www.geeksforgeeks.org/j2se-vs-j2me-vs-j2ee-whats-the-difference/](https://www.geeksforgeeks.org/j2se-vs-j2me-vs-j2ee-whats-the-difference/)
...
著名的 `JVM`，Java 开发的心脏，也是这个版本才给的。正是因为这个特性，Java 有了如此广泛的用途。
...
它用自己作为标准图形用户界面库取代了 `Swings`（在 `J2SE` 中）。
...
库纳尔·塔格拉是一名计算机迷，是德里阿格拉森理工学院的三年级学生。他对即将到来的技术和软件开发有着浓厚的兴趣。他也对音乐充满热情，也喜欢教/学新东西。你可以在 [https://www.linkedin.com/pub/kunal-tagra/57/a25/783](https://www.linkedin.com/pub/kunal-tagra/57/a25/783) 找到他。
