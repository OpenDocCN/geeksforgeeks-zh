...
> 原文: [`https://www.geeksforgeeks.org/finding-maximum-element-of-java-vector/`](https://www.geeksforgeeks.org/finding-maximum-element-of-java-vector/)
...
*   为了找到给定向量的最小元素，我们使用 [`Collections.max()`](https://www.geeksforgeeks.org/collections-max-method-in-java-with-examples/) 方法。
*   这将直接找到向量中的最大值。
...
*   Next, we will take a variable and let us say maxNumber and assign it to the maximum possible value.
