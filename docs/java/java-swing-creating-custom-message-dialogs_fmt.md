...
> 原文: [https://www.geeksforgeeks.org/java-swing-creating-custom-message-dialogs/](https://www.geeksforgeeks.org/java-swing-creating-custom-message-dialogs/)
...
3.  程序创建一个消息窗口，塑造窗口，添加背景色，并通过应用每像素半透明为窗口添加光泽外观。
