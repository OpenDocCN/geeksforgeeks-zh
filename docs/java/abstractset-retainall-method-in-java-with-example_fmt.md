...
> 原文: [https://www.geeksforgeks.org/abstractset-retainall-method-in-java-with-example/](https://www.geeksforgeeks.org/abstractset-retainall-method-in-java-with-example/)

`java.util.AbstractSet` 类的 `retainAll()` 方法用于从该集合中保留指定集合中包含的所有元素。
