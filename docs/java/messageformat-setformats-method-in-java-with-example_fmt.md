...
> 原文: [https://www.geeksforgeeks.org/messageformat-setformats-method-in-java-with-example/](https://www.geeksforgeeks.org/messageformat-setformats-method-in-java-with-example/)
...
**参考:** [https://docs.oracle.com/javase/9/docs/api/java/text/MessageFormat.html#setFormats-java.text.Format:A-](https://docs.oracle.com/javase/9/docs/api/java/text/MessageFormat.html#setFormats-java.text.Format:A-)