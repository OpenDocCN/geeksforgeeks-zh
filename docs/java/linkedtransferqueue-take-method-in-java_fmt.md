...
> 原文: [https://www.geeksforgeeks.org/linkedtransferqueue-take-method-in-java/](https://www.geeksforgeeks.org/linkedtransferqueue-take-method-in-java/)
...
## 异常:
如果在等待过程中被中断，该功能将抛出`InterruptedException`。
...
## 参考:
[https://docs.oracle.com/javase/7/docs/api/java/util/concurrent/LinkedTransferQueue.html#take()](https://docs.oracle.com/javase/7/docs/api/java/util/concurrent/LinkedTransferQueue.html#take())