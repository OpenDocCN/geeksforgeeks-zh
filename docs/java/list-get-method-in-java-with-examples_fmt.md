...
> 原文: [https://www.geeksforgeeks.org/list-get-method-in-java-with-examples/](https://www.geeksforgeeks.org/list-get-method-in-java-with-examples/)
...
该方法接受整数类型的单个参数 `index`，该索引表示该列表中要返回的元素的索引。
...
如果索引超出范围 (`index == size()`)，该方法将抛出 `IndexOutOfBoundsException`。
...
[https://docs.oracle.com/javase/7/docs/api/java/util/List.html#get(int)](https://docs.oracle.com/javase/7/docs/api/java/util/List.html#get(int))