# Inflater 类的 finished() 函数示例

> 原文: [https://www.geeksforgeeks.org/inflater-finished-function-in-java-with-examples/](https://www.geeksforgeeks.org/inflater-finished-function-in-java-with-examples/)

如果压缩数据流已经结束，则 `Inflater` 类的 `finished()` 函数返回真。
...
## 返回类型
该函数返回布尔值，如果所有输入都是未压缩的并存储在给定的缓冲区中，则返回 `true`，否则返回 `false`。
...
## 参考
[https://docs.oracle.com/javase/7/docs/api/java/util/zip/Inflater.html#finished()](https://docs.oracle.com/javase/7/docs/api/java/util/zip/Inflater.html#finished())