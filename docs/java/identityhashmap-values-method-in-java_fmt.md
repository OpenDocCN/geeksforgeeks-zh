...
> 原文: [https://www.geeksforgeeks.org/identityhashmap-values-method-in-java/](https://www.geeksforgeeks.org/identityhashmap-values-method-in-java/)

`java.util.IdentityHashMap.values()` 方法用于从映射的值中创建一个集合。它基本上返回地图中值的集合视图。
...
以下程序用于说明 `java.util.IdentityHashMap.values()` 方法:
