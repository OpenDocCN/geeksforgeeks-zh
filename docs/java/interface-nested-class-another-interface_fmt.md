...
> 原文：[https://www.geeksforgeeks.org/interface-nested-class-another-interface/](https://www.geeksforgeeks.org/interface-nested-class-another-interface/)
...
在上面的例子中，即使我们没有写 `public`，访问说明符也是 `public`。如果我们试图将接口的访问说明符更改为公共以外的任何内容，我们会得到编译器错误。记住，[接口成员只能公开。](https://www.geeksforgeeks.org/g-fact-73/)。
