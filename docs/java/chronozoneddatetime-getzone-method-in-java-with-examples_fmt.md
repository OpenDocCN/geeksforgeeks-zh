...
`ChronoZonedDateTime` 接口的 `getZone()` 方法用于从该时区数据时间获取时区。此方法返回区域标识，如“亚洲/加尔各答”。
...
## 参考
[https://docs.oracle.com/javase/9/docs/api/java/time/chrono/ChronoZonedDateTime.html#getZone--](https://docs.oracle.com/javase/9/docs/api/java/time/chrono/ChronoZonedDateTime.html#getZone--)