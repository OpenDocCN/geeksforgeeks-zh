...
> 原文：[https://www.geeksforgeeks.org/how-to-add-particlesmasher-in-android-app/](https://www.geeksforgeeks.org/how-to-add-particlesmasher-in-android-app/)
...
转到 `app/src/main/res/values/colors.xml` 文件，为应用程序设置颜色。
...
转到 Gradle `build.gradle (Module :app)` 部分，导入以下依赖项，点击上面弹出的“**立即同步**”。

`implementation 'com.ifadai:particle-smasher:1.0.1'`
