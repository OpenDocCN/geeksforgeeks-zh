# Java 中的 `Double.byteValue()` 方法示例

> 原文：[https://www.geeksforgeeks.org/double-bytevalue-method-in-java-with-examples/](https://www.geeksforgeeks.org/double-bytevalue-method-in-java-with-examples/)

`java.lang.Double.byteValue()` 是 Java 中的一个内置方法，它以字节形式返回该 `Double` 的值（通过转换为 `byte`）。基本上，它用于将 `Double` 类型的原语转换缩小为 `byte` 值。
...
[https://docs.oracle.com/javase/8/docs/api/java/lang/Double.html#byteValue--](https://docs.oracle.com/javase/8/docs/api/java/lang/Double.html#byteValue--)