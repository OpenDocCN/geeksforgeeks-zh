...
> 原文：[https://www.geeksforgeeks.org/java-program-to-check-if-jvm-is-32-or-64-bit/](https://www.geeksforgeeks.org/java-program-to-check-if-jvm-is-32-or-64-bit/)
...
在 Java 中，`getProperty()`方法用于获取与系统相关的各种属性的信息。类似地，有两种不同的方法通过使用系统属性`"sun.arch.data.model"`或`"os.arch"`来检查[JVM](https://www.geeksforgeeks.org/jvm-works-jvm-architecture/)的位。它将根据您的 Java 安装返回 32 位或 64 位。
