# Java 中 `Character.equals()` 方法示例

> 原文：[https://www.geeksforgeeks.org/character-equals-method-in-java-with-examples/](https://www.geeksforgeeks.org/character-equals-method-in-java-with-examples/)
...
该函数接受单个参数 `obj`，该参数指定要比较的对象。

## 返回值

函数返回一个布尔值。如果对象相同，则返回 `true`，否则返回 `false`。
...
[https://docs.oracle.com/javase/7/docs/api/java/lang/Character.html#equals(java.lang.Object)](https://docs.oracle.com/javase/7/docs/api/java/lang/Character.html#equals(java.lang.Object))