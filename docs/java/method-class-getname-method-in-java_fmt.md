...
> 原文：[https://www.geeksforgeeks.org/method-class-getname-method-in-java/](https://www.geeksforgeeks.org/method-class-getname-method-in-java/)

[Java](https://www.geeksforgeeks.org/reflection-in-java/)的 `getName()` 方法。`Method`类有助于获取方法的名称，如字符串。要获取一个类的所有方法的名称，请获取该类对象的所有方法。然后在这些方法对象上调用 `getName()`。
