...
> 原文: [https://www.geeksforgeeks.org/hashset-removeall-method-in-java-with-example/](https://www.geeksforgeeks.org/hashset-removeall-method-in-java-with-example/)
...
如果此集合包含空元素，并且指定的集合不允许空元素（可选），或者指定的集合为空，则此方法抛出 `NullPointerException`。
