...
> 原文：[`https://www.geeksforgeeks.org/java-program-to-sort-the-array-elements-in-descending-order/`](https://www.geeksforgeeks.org/java-program-to-sort-the-array-elements-in-descending-order/)
...
> **注意：** 需要记住的一点是，当按降序排序时，`Arrays.sort()`不接受原始数据类型的数组。
