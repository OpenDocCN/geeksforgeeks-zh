...
> 原文: [https://www.geeksforgeeks.org/constructor-chaining-java-examples/](https://www.geeksforgeeks.org/constructor-chaining-java-examples/)
...
注意: 如果有多个块，它们将按照在同一类中定义的顺序执行。见示例。
