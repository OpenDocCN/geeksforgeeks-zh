# Java 中的 Collections.synchronizedSortedSet() 方法示例

> 原文：[https://www.geeksforgeeks.org/collections-synchronizedsortedset-method-in-java-with-examples/](https://www.geeksforgeeks.org/collections-synchronizedsortedset-method-in-java-with-examples/)
...
该方法将 `SortedSet` 作为参数“包装”在同步排序集中。
