...
> 原文: [https://www.geeksforgeeks.org/java-nio-file-filesystem-class-in-java/](https://www.geeksforgeeks.org/java-nio-file-filesystem-class-in-java/)

`java.nio.file.FileSystem` 类提供了一个文件系统的接口。文件系统充当创建不同对象的工厂，如路径、路径匹配器、用户原则允许用户服务、和监视服务。该对象有助于访问文件系统中的文件和其他对象。
