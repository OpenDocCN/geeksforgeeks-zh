...
> 原文：[https://www.geeksforgeeks.org/convert-hashset-to-array-in-java/](https://www.geeksforgeeks.org/convert-hashset-to-array-in-java/)

Java [`HashSet`](https://www.geeksforgeeks.org/hashset-in-java/) 类用于创建一个集合，该集合使用哈希表来存储元素。继承 [`AbstractSet`](https://www.geeksforgeeks.org/abstractset-class-in-java-with-examples/) 类，实现 `Set` 接口。
...
2.  要将一个 `HashSet` 转换成 java 中的数组，我们可以使用 `toArray()` 函数。
