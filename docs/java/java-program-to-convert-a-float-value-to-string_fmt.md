...
> 原文：[https://www.geeksforgeeks.org/java-program-to-convert-a-float-value-to-string/](https://www.geeksforgeeks.org/java-program-to-convert-a-float-value-to-string/)
...
最简单的方法是使用 `java.lang` 包中 `String` 类的 `valueOf()` 方法。此方法接受要分析的浮点值，并从中返回字符串类型的值。
