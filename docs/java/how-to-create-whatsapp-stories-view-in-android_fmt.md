...
> 原文：[https://www.geeksforgeeks.org/how-to-create-whatsapp-stories-view-in-android/](https://www.geeksforgeeks.org/how-to-create-whatsapp-stories-view-in-android/)
...
### 第三步：将主题更新到 themes.xml 文件中的 NoActionBar

导航到 `app > res > values > themes.xml` 并在其中将基本应用程序主题更改为 `NoActionBar`。您可以在下面看到 `themes.xml` 文件的代码。
