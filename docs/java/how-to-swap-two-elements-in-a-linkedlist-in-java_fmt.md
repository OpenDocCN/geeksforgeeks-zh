...
> 原文: [https://www.geeksforgeeks.org/how-to-swap-two-elements-in-a-linkedlist-in-java/](https://www.geeksforgeeks.org/how-to-swap-two-elements-in-a-linkedlist-in-java/)
...
使用[`set()`](https://www.geeksforgeeks.org/set-list-java/)方法交换链表中的两个元素。为了实现我们想要的输出，首先，确保提供给我们的两个元素在链表中都可用。如果两个元素都不存在，只需返回。使用`set()`方法将`element1`的位置设置为`element2`的位置，反之亦然。
