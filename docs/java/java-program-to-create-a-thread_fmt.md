...
> 原文: [https://www.geeksforgeeks.org/java-program-to-create-a-thread/](https://www.geeksforgeeks.org/java-program-to-create-a-thread/)
...
您创建的线程不调用 `run()` 方法。相反，它被创建的新线程调用。
