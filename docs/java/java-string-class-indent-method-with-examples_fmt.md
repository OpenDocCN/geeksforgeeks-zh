# Java 字符串类 `indent()` 方法示例

> 原文: [https://www.geeksforgeeks.org/java-string-class-indent-method-with-examples/](https://www.geeksforgeeks.org/java-string-class-indent-method-with-examples/)

JDK 12 在 `java.lang.String` 类中引入了 `indent()` 方法。此方法用于在行的开头添加或删除空格，以调整每个字符串行的缩进。
...
public class GFG {
    ...
    public static void main(String args[])
    {
        ...
        // (negative)
        String output2 = output1.indent(-3);
