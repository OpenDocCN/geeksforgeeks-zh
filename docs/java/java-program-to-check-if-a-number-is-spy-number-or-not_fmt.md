...
> 原文：[https://www.geeksforgeeks.org/java-program-to-check-if-a-number-is-spy-number-or-not/](https://www.geeksforgeeks.org/java-program-to-check-if-a-number-is-spy-number-or-not/)
...
1.  计算输入数字各位数字的和。
2.  计算输入数字各位数字的乘积。
3.  如果数字之和等于数字之积，则该数字是间谍号，否则是非间谍号。
