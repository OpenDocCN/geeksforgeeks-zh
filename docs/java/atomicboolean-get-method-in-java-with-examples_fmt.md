...
`java.util.concurrent.atomic.AtomicBoolean.get()`是 Java 中的一个内置方法，它返回日期类型的布尔值的当前值。
...
## 参考：
[https://docs.oracle.com/javase/8/docs/api/java/util/concurrent/atomic/AtomicBoolean.html#get--](https://docs.oracle.com/javase/8/docs/api/java/util/concurrent/atomic/AtomicBoolean.html#get--)