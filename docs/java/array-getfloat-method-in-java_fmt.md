...
> 原文: [https://www.geeksforgeeks.org/array-getfloat-method-in-java/](https://www.geeksforgeeks.org/array-getfloat-method-in-java/)
...
类型转换不是必需的，因为返回类型是 `float`。

下面的程序说明了 `Array` 类的 `getFloat()` 方法。
