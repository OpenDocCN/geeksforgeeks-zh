...
> 原文: [https://www.geeksforgeeks.org/floatbuffer-slice-method-in-java-with-examples/](https://www.geeksforgeeks.org/floatbuffer-slice-method-in-java-with-examples/)

`FloatBuffer`类的`slice()`方法用于创建一个新的浮动缓冲区，其内容是给定缓冲区内容的共享子序列。
