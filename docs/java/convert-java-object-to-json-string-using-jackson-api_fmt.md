...
> 原文：[https://www.geeksforgeeks.org/convert-java-object-to-json-string-using-jackson-api/](https://www.geeksforgeeks.org/convert-java-object-to-json-string-using-jackson-api/)
...
在 Maven 项目的情况下，在 `pom.xml` 文件中添加 Jackson 依赖项。
...
## 创建一个 Java 类，用于将 Organisation 对象转换为 JSON
