...
> 原文: [https://www.geeksforgeeks.org/map-isempty-method-in-java-with-examples/](https://www.geeksforgeeks.org/map-isempty-method-in-java-with-examples/)
