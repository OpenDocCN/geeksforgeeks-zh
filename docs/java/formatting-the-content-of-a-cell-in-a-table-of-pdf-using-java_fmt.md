...
> 原文：[https://www.geeksforgeeks.org/formatting-the-content-of-a-cell-in-a-table-of-pdf-using-java/](https://www.geeksforgeeks.org/formatting-the-content-of-a-cell-in-a-table-of-pdf-using-java/)
...
首先在上面输入的 PDF 文件中创建单元格，然后格式化单元格的内容。
