# AbstractMap.equals() 方法在 Java 中的示例

> 原文: [https://www.geeksforgeeks.org/abstractmap-equals-method-in-java-with-examples/](https://www.geeksforgeeks.org/abstractmap-equals-method-in-java-with-examples/)
...
该方法接受一个抽象哈希映射类型的参数 `ihashmap2`，并引用要用该抽象映射检查其相等性的映射。

## 返回值

如果两个对象映射相等，则方法返回真，否则返回假。
