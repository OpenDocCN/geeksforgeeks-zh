...
> 原文: [https://www.geeksforgeeks.org/matcher-regionend-method-in-java-with-examples/](https://www.geeksforgeeks.org/matcher-regionend-method-in-java-with-examples/)

## 描述

`Matcher`类的`regionEnd()`方法用于获取当前匹配器中模式要匹配的区域的`endIndex`。这个方法返回一个整数值，它是这个匹配器区域的`endIndex`。
...
这个方法返回一个整数值，它是这个匹配器区域的`endIndex`。
...
[https://docs.oracle.com/javase/9/docs/api/java/util/regex/Matcher.html#regionEnd--](https://docs.oracle.com/javase/9/docs/api/java/util/regex/Matcher.html#regionEnd--)