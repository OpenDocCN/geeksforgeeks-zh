...
> 原文：[https://www.geeksforgeeks.org/how-to-add-share-button-in-toolbar-in-android/](https://www.geeksforgeeks.org/how-to-add-share-button-in-toolbar-in-android/)
...
点击选择下一步并完成，你的图标已经创建。这里默认给出 `ic_baseline_share_24`。
...
转到 `MainActivity.java` 文件，添加下面给出的代码。我们在这里实现了两种方法 `public boolean onCreateOptionsMenu()` 和 `public boolean onOptionsItemSelected()`。以下是 `MainActivity.java` 文件的代码。代码中添加了注释，以更详细地理解代码。
