...
> 原文：[https://www.geeksforgeeks.org/access-super-class-methods-and-instance-variables-without-super-keyword-in-java/](https://www.geeksforgeeks.org/access-super-class-methods-and-instance-variables-without-super-keyword-in-java/)
...
**超级类：** 可以从中创建许多子类的父类。所有子类都有父类的所有属性。
...
**1. 第一种方法：** `super` 关键字是 java 中的保留词之一。`Super` 引用父类的对象。（参考[这篇](https://www.geeksforgeeks.org/super-keyword/)文章）。
...
class GFG {
    GFG() { // constructor of the parent  class
