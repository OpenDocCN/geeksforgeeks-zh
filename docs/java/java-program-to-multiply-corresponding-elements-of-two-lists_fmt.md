...
> 原文：[https://www.geeksforgeeks.org/java-program-to-multiply-corresponding-elements-of-two-lists/](https://www.geeksforgeeks.org/java-program-to-multiply-corresponding-elements-of-two-lists/)
...
**方法 1：（使用额外空间）** —— 可以将对应的元素相乘，使用内置函数将它们存储在字符串中，最后打印字符串。
