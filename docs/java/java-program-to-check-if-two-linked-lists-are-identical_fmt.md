...
> 原文：[https://www.geeksforgeeks.org/java-program-to-check-if-two-linked-lists-are-identical/](https://www.geeksforgeeks.org/java-program-to-check-if-two-linked-lists-are-identical/)
