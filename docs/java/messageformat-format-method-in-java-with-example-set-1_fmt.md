...
> 原文: [https://www.geeksforgeeks.org/messageformat-format-method-in-java-with-example-set-1/](https://www.geeksforgeeks.org/messageformat-format-method-in-java-with-example-set-1/)
...
*   **Parameter:** - 此方法接受数组对象作为要格式化的参数。
*   **Result:** - `StringBuffer` 区域将用于附加格式化后的数组。
*   **Position:** - 字段位置将用于对齐目的。

## 返回值

该方法返回字符串缓冲区，该缓冲区将附加格式化数组的结果。

## 异常

如果结果为空，该方法抛出 `NullPointerException`。
...
[https://docs.oracle.com/javase/9/docs/api/java/text/MessageFormat.html#format-java.lang.Object:A-java.lang.StringBuffer-java.text.FieldPosition-](https://docs.oracle.com/javase/9/docs/api/java/text/MessageFormat.html#format-java.lang.Object:A-java.lang.StringBuffer-java.text.FieldPosition-)