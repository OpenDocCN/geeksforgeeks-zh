...
> 原文：[https://www.geeksforgeeks.org/circular-fillable-loader-in-android-with-seekbar/](https://www.geeksforgeeks.org/circular-fillable-loader-in-android-with-seekbar/)
...
**第二步：在 `build.gradle`（模块：`app`）文件中添加依赖项**
