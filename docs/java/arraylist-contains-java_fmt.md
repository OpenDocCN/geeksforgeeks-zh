...
[数组列表](https://www.geeksforgeeks.org/arraylist-in-java/)在 [Java](https://www.geeksforgeeks.org/java/) 中的 `contains()` 方法，用于检查给定列表中是否存在指定元素。
