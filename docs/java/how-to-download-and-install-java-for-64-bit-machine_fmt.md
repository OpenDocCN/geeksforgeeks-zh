...
> 原文:[https://www.geeksforgeeks.org/how-to-download-and-install-java-for-64-bit-machine/](https://www.geeksforgeeks.org/how-to-download-and-install-java-for-64-bit-machine/)

[Java](https://www.geeksforgeeks.org/java-tutorials/) 是目前最流行、应用最广泛的编程语言之一。多年来，它一直是最流行的编程语言之一。在本文中，我们将看到如何在 64 位架构机器上下载和安装 Java。

## 为了下载和安装 java，可以遵循以下步骤。

下面描述的所有步骤都是在 Windows 10 操作系统上执行的，但是该过程也与其他操作系统非常相似。
