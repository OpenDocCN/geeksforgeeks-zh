...
> 原文: [https://www.geeksforgeeks.org/currency-tostring-method-in-java-with-examples/](https://www.geeksforgeeks.org/currency-tostring-method-in-java-with-examples/)
...
## 返回值:
此方法返回货币的 ISO 4217 货币代码。

## 异常:
如果调用了无效代码，该方法将抛出`运行时错误`。
