...
> 原文：[`https://www.geeksforgeeks.org/byte-doublevalue-method-in-java-with-examples/`](https://www.geeksforgeeks.org/byte-doublevalue-method-in-java-with-examples/)

[`Byte`](https://www.geeksforgeeks.org/java-lang-byte-class-java/) 类的 `doubleValue()` 方法是 Java 中的一个内置方法，用来将这个 `Byte` 对象的值作为 `double` 返回。
