...
> 原文：[https://www.geeksforgeeks.org/check-if-particular-value-exists-in-java-hashmap/](https://www.geeksforgeeks.org/check-if-particular-value-exists-in-java-hashmap/)
...
**参数:** 该方法只取一个对象类型的参数 `Value`，并引用其映射应该由映射内任何键检查的值。
