...
> 原文: [https://www.geeksforgeeks.org/java-program-to-find-the-largest-of-three-numbers/](https://www.geeksforgeeks.org/java-program-to-find-the-largest-of-three-numbers/)

## 问题陈述
给定三个数字 `x`、`y` 和 `z`，目的是得到这三个数字中最大的一个。
