...
> 原文：[https://www.geeksforgeeks.org/java-util-collections-frequency-java-examples/](https://www.geeksforgeeks.org/java-util-collections-frequency-java-examples/)
...
[`Arrays`类](https://www.geeksforgeeks.org/array-class-in-java/)没有频率方法。但是我们也可以使用`Collections.frequency()`来获取数组中元素的频率。
