...
> 原文：[https://www.geeksforgeeks.org/alert-dialog-with-single-item-selection-in-android/](https://www.geeksforgeeks.org/alert-dialog-with-single-item-selection-in-android/)
...
*   用于实现单项选择的功能是 `setSingleChoiceItems()`，如下所述：

> **语法：**
>
> `setSingleChoiceItems(listItems, checkedItem[0], DialogInterface.OnClickListener)`
>
> **参数：**
>
> **`listItems`：** 是要在警报对话框中显示的项目。
>
> **`checkedItem`：** 是布尔数组，它将选定的值保持为真，将未选定的值保持为假。
>
> **`DialogInterface.OnClickListener()`：** 当项目选择发生变化时进行回调。
