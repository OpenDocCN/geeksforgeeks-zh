...
> 原文：[https://www.geeksforgeeks.org/how-to-read-data-from-sqlite-database-in-android/](https://www.geeksforgeeks.org/how-to-read-data-from-sqlite-database-in-android/)

在我们的 SQLite 数据库的第一部分，我们已经看到了[如何在 Android](https://www.geeksforgeeks.org/how-to-create-and-add-data-to-sqlite-database-in-android/) 中创建数据并将其添加到 SQLite 数据库。在那篇文章中，我们已经将数据添加到我们的 `SQLite 数据库`中。在本文中，我们将`从 SQLite 数据库中读取所有这些数据，并将这些数据显示在`[`recyclerview`](https://www.geeksforgeeks.org/android-recyclerview/)`中。`
