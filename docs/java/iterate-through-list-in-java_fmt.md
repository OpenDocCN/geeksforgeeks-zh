...
1.  使用循环（简单方法）
    *   用于循环
    *   [for-each 循环](https://www.geeksforgeeks.org/for-each-loop-in-java/)
    *   和循环
2.  使用 [迭代器](https://www.geeksforgeeks.org/iterators-in-java/)
3.  使用 [列表迭代器](https://www.geeksforgeeks.org/arraylist-listiterator-method-in-java-with-examples/)
4.  使用 λ 表达式
5.  使用 [`Stream.forEach()`](https://www.geeksforgeeks.org/stream-foreach-method-java-examples/)
