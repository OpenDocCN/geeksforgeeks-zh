# Java 中的 `ChronoField.range()` 方法示例

> 原文：[https://www.geeksforgeeks.org/chronofield-range-method-in-java-with-examples-2/](https://www.geeksforgeeks.org/chronofield-range-method-in-java-with-examples-2/)

`ChronoField` 枚举的 `range()` 方法用于返回计时场常数的有效值范围。该范围内的所有字段都可以表示为长整数。
