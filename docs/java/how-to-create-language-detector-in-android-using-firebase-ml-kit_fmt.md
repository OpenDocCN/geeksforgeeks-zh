...
> 原文: [https://www.geeksforgeeks.org/how-to-create-language-detector-in-android-using-firebase-ml-kit/](https://www.geeksforgeeks.org/how-to-create-language-detector-in-android-using-firebase-ml-kit/)
...
我们将构建一个简单的应用程序，其中我们将显示一个 `EditText` 字段，在该字段中，我们必须添加任何语言的文本和一个用于检测该文本语言的按钮。添加文本后，我们将点击检测语言按钮，我们的文本的语言被检测，我们将看到我们的语言的代码。下面给出了一个示例视频，让我们了解一下在本文中要做什么。注意，我们将使用 `Java` 语言来实现这个项目。
...
### 第三步: 添加语言检测的依赖项，`build.gradle` 文件

导航到 `应用程序 > 梯度脚本 > build.gradle` 文件，并添加以下代码。代码中添加了注释，以便更详细地了解。
