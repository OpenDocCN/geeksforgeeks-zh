...
您可以使用 [`keySet()`](https://www.geeksforgeeks.org/hashmap-keyset-method-in-java/) 方法将 `LinkedHashMap` 的所有键转换为一个集合，然后使用 [`toArray()`](https://www.geeksforgeeks.org/set-toarray-method-in-java-with-example/) 方法将该集合转换为一个数组，现在使用数组索引访问该键并从 `LinkedHashMap` 中获取值。
...
该方法与第一种方法类似，您可以将键转换为 [`ArrayList`](https://www.geeksforgeeks.org/arraylist-in-java/) 或 [`LinkedList`](https://www.geeksforgeeks.org/linked-list-in-java/)，而不是转换为数组。
