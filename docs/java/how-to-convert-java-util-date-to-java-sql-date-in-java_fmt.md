...
> 原文：[https://www.geeksforgeeks.org/how-to-convert-java-util-date-to-java-sql-date-in-java/](https://www.geeksforgeeks.org/how-to-convert-java-util-date-to-java-sql-date-in-java/)
...
`java.util.Date` 类的 `getTime()` 方法返回自 1970 年 1 月 1 日 00:00:00 GTM 以来的毫秒数，由 `Date` 对象表示。
