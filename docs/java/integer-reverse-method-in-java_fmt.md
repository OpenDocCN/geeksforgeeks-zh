# Java 中的 `Integer.reverse()` 方法

> 原文：[https://www.geeksforgeeks.org/integer-reverse-method-in-java/](https://www.geeksforgeeks.org/integer-reverse-method-in-java/)
