...
> 原文：`https://www.geeksforgeeks.org/how-to-print-colored-text-in-java-console/`
...
*   在 `ANSI_COLORNAME` 中，我们必须写下给定特定 ANSI 代码的名称。例如，`public static final String ANSI_BLACK = "\u001B[30m";`
