# Java 中的 `Collator.getInstance(Locale)` 方法示例

> 原文：[https://www.geeksforgeeks.org/collator-getinstancelocale-method-in-java-with-example/](https://www.geeksforgeeks.org/collator-getinstancelocale-method-in-java-with-example/)
...
## 参数
该方法取需要创建排序器对象的 `Locale`。

## 返回值
它提供具有所需区域设置的 `Collator` 对象。
...
## 参考
[https://docs.oracle.com/javase/9/docs/api/java/text/Collator.html#getInstance--](https://docs.oracle.com/javase/9/docs/api/java/text/Collator.html#getInstance--)