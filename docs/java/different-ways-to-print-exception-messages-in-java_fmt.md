...
> 原文：[https://www.geeksforgeeks.org/different-ways-to-print-exception-messages-in-java/](https://www.geeksforgeeks.org/different-ways-to-print-exception-messages-in-java/)

在 Java 中，有三种方法可以打印异常信息。它们都在 `Throwable` 类中。因为 `Throwable` 是所有异常和错误的基类，所以我们可以在任何异常对象上使用这三种方法。
