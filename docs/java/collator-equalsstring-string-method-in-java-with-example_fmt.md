...
`java.text.Collator`类的`equals()`方法用于检查两个字符串是否相同。
...
**参考:**[https://docs . Oracle . com/javase/9/docs/API/Java/text/collator . html # equals-Java . lang . string-Java . lang . string-T4](https://docs.oracle.com/javase/9/docs/api/java/text/Collator.html#equals-java.lang.String-java.lang.String-)