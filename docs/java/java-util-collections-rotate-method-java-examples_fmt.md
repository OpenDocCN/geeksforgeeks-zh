# Java 中的 `Collections.rotate()` 方法，带示例

> 原文：[https://www.geeksforgeeks.org/java-util-collections-rotate-method-java-examples/](https://www.geeksforgeeks.org/java-util-collections-rotate-method-java-examples/)
...
`Arrays` 类没有旋转方法。我们也可以使用 `Collections.rotate()` 来快速旋转数组。
