...
> 原文：[https://www.geeksforgeeks.org/difference-between-applets-and-servlets/](https://www.geeksforgeeks.org/difference-between-applets-and-servlets/)
...
| Applets 中可用的包有：`import java.applet.*;` 和 `import java.awt.*;`。 | servlet 中可用的包有：`import javax.servlet.*;` 和 `import javax.servlet.http.*;`。 |
