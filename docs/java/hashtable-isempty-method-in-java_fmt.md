...
> 原文: [https://www.geeksforgeeks.org/hashtable-isempty-method-in-java/](https://www.geeksforgeeks.org/hashtable-isempty-method-in-java/)
...
如果表为空或不包含任何映射对，则该方法返回布尔值 `true`，否则返回布尔值 `false`。
