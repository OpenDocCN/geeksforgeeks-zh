...
> 原文：[https://www.geeksforgeeks.org/datainputstream-readunsignedshort-method-in-java-with-examples/](https://www.geeksforgeeks.org/datainputstream-readunsignedshort-method-in-java-with-examples/)
...
此方法由 `DataInput` 接口的 `readUnsignedShort()` 方法指定。
...
[https://docs.oracle.com/javase/10/docs/api/java/io/DataInputStream.html#readUnsignedShort()](https://docs.oracle.com/javase/10/docs/api/java/io/DataInputStream.html#readUnsignedShort())