...
> 原文:[https://www.geeksforgeeks.org/how-to-execute-native-shell-commands-from-java-program/](https://www.geeksforgeeks.org/how-to-execute-native-shell-commands-from-java-program/)
...
这个例子展示了如何运行一个简单的 `.bat` 程序。那个 `.bat` 文件显示 windows 系统信息。
