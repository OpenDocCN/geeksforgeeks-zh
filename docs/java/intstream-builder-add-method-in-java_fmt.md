# IntStream.Builder add()方法在Java中的使用

> 原文：[https://www.geeksforgeeks.org/intstream-builder-add-method-in-java/](https://www.geeksforgeeks.org/intstream-builder-add-method-in-java/)
