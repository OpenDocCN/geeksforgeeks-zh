...
> 原文: [https://www.geeksforgeeks.org/arithmetic-expression-having-only-and-operators-in-java/](https://www.geeksforgeeks.org/arithmetic-expression-having-only-and-operators-in-java/)
