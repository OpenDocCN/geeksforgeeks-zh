...
> 原文: [https://www.geeksforgeeks.org/how-is-compiletime-classpath-different-from-runtime-classpath-in-java/](https://www.geeksforgeeks.org/how-is-compiletime-classpath-different-from-runtime-classpath-in-java/)
...
只需在 `pom.xml` 文件中添加依赖项，就会自动在类路径中添加 jars。
