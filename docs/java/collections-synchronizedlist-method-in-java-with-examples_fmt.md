...
> 原文: [https://www.geeksforgeeks.org/collections-synchronizedlist-method-in-java-with-examples/](https://www.geeksforgeeks.org/collections-synchronizedlist-method-in-java-with-examples/)
...
该方法将 `list` 作为参数“包装”在同步列表中。

## 返回值

该方法返回指定列表的 `同步视图`。

以下是说明 `synchronizedList()` 方法的示例
