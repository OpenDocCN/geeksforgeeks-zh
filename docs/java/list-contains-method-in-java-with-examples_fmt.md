# Java List contains() 方法详解

> 原文：[https://www.geeksforgeeks.org/list-contains-method-in-java-with-examples/](https://www.geeksforgeeks.org/list-contains-method-in-java-with-examples/)
...
## 实际应用
在搜索操作中，我们可以检查列表中是否存在给定的元素。

## 参考
[https://docs.oracle.com/javase/7/docs/api/java/util/List.html#contains(java.lang.Object)](https://docs.oracle.com/javase/7/docs/api/java/util/List.html#contains(java.lang.Object))