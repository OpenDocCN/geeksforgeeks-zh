...
> 原文: [https://www.geeksforgeeks.org/linkedlist-addfirst-method-in-java/](https://www.geeksforgeeks.org/linkedlist-addfirst-method-in-java/)

`java.util.LinkedList.addFirst()`方法用于在 `LinkedList` 的开头插入特定的元素。
...
## 参数:
该函数接受单个参数 `element`，如上语法所示。此参数指定的元素附加在列表的开头。
