...
> 原文: [https://www.geeksforgeeks.org/find-palindromic-sub-strings-given-string-set-2/](https://www.geeksforgeeks.org/find-palindromic-sub-strings-given-string-set-2/)
...
4. 枢轴从 `0` 开始，以 `0.5` 的步长移动到终点。
    a) 当 `pivot` 是非分数值时，则回文值是从 `0` 开始的整数。
    b) 当 `pivot` 是一个小数值时，回文值类似于 `0.5`，`1.5`，`2.5`，`3.5`..
