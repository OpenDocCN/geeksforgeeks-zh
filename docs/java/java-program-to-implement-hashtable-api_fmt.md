...
> 原文：[https://www.geeksforgeeks.org/java-program-to-implement-hashtable-api/](https://www.geeksforgeeks.org/java-program-to-implement-hashtable-api/)
...
为了实现 `Hashtable` API，首先我们创建一个类 `Hashtable`，并在这个类中创建 `Hashtable` 的所有方法：
