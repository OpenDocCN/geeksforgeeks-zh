...
> 原文: [https://www.geeksforgeeks.org/java-program-to-convert-object-to-string/](https://www.geeksforgeeks.org/java-program-to-convert-object-to-string/)
...
使用 [`toString()`](https://www.geeksforgeeks.org/integer-tostring-in-java/) 方法或 [`String.valueOf(object_name)`](https://www.geeksforgeeks.org/data-conversion-using-valueof-method-java/) 方法。
