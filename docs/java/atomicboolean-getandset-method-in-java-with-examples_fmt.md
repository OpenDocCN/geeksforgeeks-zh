...
`java.util.concurrent.atomic.AtomicBoolean.getAndSet()` 是 Java 中的一个内置方法，它将给定值设置为参数中传递的值，并在更新前返回数据类型为 `boolean` 的值。
...
该函数接受单个强制参数 `val`，该值指定要更新的值。

### 返回值

该函数将执行更新操作前的值返回到前一个值。
...
public class GFG {
    public static void main(String args[])
    {
        ...
        // Updates and sets
        boolean res = val.getAndSet(true);
...
[https://docs.oracle.com/javase/8/docs/api/java/util/concurrent/atomic/AtomicBoolean.html#getAndSet-boolean-](https://docs.oracle.com/javase/8/docs/api/java/util/concurrent/atomic/AtomicBoolean.html#getAndSet-boolean-)