# AbstractMap.containsKey() 方法详解与示例

> 原文：[https://www.geeksforgeeks.org/abstractmap-containskey-method-in-java-with-examples/](https://www.geeksforgeeks.org/abstractmap-containskey-method-in-java-with-examples/)

`AbstractMap.containsKey()` 方法用于检查特定的键是否被映射到抽象映射中。它将关键元素作为参数，如果该元素在映射中被映射，则返回 `true`。
