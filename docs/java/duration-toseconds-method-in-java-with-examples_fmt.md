# Java 中的 Duration.toSeconds() 方法示例

> 原文：[https://www.geeksforgeeks.org/duration-toseconds-method-in-java-with-examples/](https://www.geeksforgeeks.org/duration-toseconds-method-in-java-with-examples/)

使用 `java.time` 包中 `Duration` 类的 `toSeconds()` 方法，以秒为单位获取该持续时间的值。
