...
> 原文: [https://www.geeksforgeeks.org/biginteger-hashcode-method-in-java/](https://www.geeksforgeeks.org/biginteger-hashcode-method-in-java/)
...
下面的程序说明了`BigInteger`类的`hashCode()`方法。
...
[BigInteger hashCode() 文档](https://docs.oracle.com/javase/7/docs/api/java/math/BigInteger.html#hashCode())