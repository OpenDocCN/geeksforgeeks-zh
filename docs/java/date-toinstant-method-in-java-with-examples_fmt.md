...
> 原文：[`https://www.geeksforgeeks.org/date-toinstant-method-in-java-with-examples/`](https://www.geeksforgeeks.org/date-toinstant-method-in-java-with-examples/)

Java 中 [`Date`](https://www.geeksforgeeks.org/date-class-java-examples/) 类的 `toInstant()` 方法用于将日期对象转换为即时对象。转换过程中会创建一个“瞬间”，用于表示时间线上与此日期相同的点。
...
该方法返回一个 `Instant`，代表时间线上与该日期相同的点。
...
[`https://docs.oracle.com/javase/8/docs/api/java/util/Date.html#toInstant--`](https://docs.oracle.com/javase/8/docs/api/java/util/Date.html#toInstant--)