...
> 原文：[https://www.geeksforgeeks.org/android-how-to-add-radio-buttons-in-an-android-application/](https://www.geeksforgeeks.org/android-how-to-add-radio-buttons-in-an-android-application/)
...
此外，给每个组件分配 ID 以及其他属性，如下图和代码所示。组件上分配的标识有助于在 Java 文件中轻松找到和使用该组件。
...
*   在提交按钮监听器中，设置要执行的操作。这包括以 **Toast** 的形式显示标记的答案。
