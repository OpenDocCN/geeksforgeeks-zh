...
> 原文：[https://www.geeksforgeeks.org/java-program-to-compare-two-objects/](https://www.geeksforgeeks.org/java-program-to-compare-two-objects/)
...
1.  使用 [`equals()`](https://www.geeksforgeeks.org/overriding-equals-method-in-java/)
    *   没有覆盖
    *   压倒一切
...
class Pet {
    ...
    @Override public boolean equals(Object obj)
    {
        ...
        return this.name.equals(p1.name)
            && this.age == p1.age && this.breed.equals(p1.breed);
    }
}
