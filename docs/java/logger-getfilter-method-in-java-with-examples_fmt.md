...
> 原文: [https://www.geeksforgeeks.org/logger-getfilter-method-in-java-with-examples/](https://www.geeksforgeeks.org/logger-getfilter-method-in-java-with-examples/)
...
[https://docs.oracle.com/javase/10/docs/api/java/util/logging/Logger.html#getFilter()](https://docs.oracle.com/javase/10/docs/api/java/util/logging/Logger.html#getFilter())