...
> 原文: [https://www.geeksforgeeks.org/bufferedwriter-flush-method-in-java-with-examples/](https://www.geeksforgeeks.org/bufferedwriter-flush-method-in-java-with-examples/)

Java 中的 `BufferedWriter` 类的 `flush()` 方法用于从缓冲的编写器流中刷新字符。
