...
该方法以 `array` 为参数，该参数为 `int` 值的非空数组。

## 返回值

该方法返回数组中存在的小于或等于数组中其他值的值。
...
[https://google.github.io/guava/releases/22.0/api/docs/com/google/common/primitives/Ints.html#min-int...-](https://google.github.io/guava/releases/22.0/api/docs/com/google/common/primitives/Ints.html#min-int...-)