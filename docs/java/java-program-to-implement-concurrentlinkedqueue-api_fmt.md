...
> 原文：[https://www.geeksforgeeks.org/java-program-to-implement-concurrentlinkedqueue-api/](https://www.geeksforgeeks.org/java-program-to-implement-concurrentlinkedqueue-api/)
...
class ConcurrentLinkedQueueImplmentation<E> {
    ...
    // the array is that of the specified array.
...
public class GFG {
    public static void main(String[] arg)
    {
        ...
        ConcurrentLinkedQueueImplmentation<Integer>
            ...
            = new ConcurrentLinkedQueueImplmentation<Integer>();
