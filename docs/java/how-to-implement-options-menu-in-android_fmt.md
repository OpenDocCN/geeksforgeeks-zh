...
> 原文：[https://www.geeksforgeeks.org/how-to-implement-options-menu-in-android/](https://www.geeksforgeeks.org/how-to-implement-options-menu-in-android/)
...
*   `never`：这意味着菜单永远不会显示，因此将通过溢出菜单提供。
