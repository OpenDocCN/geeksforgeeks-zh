...
> 原文: [https://www.geeksforgeeks.org/java-program-to-create-a-blank-ppt-document/](https://www.geeksforgeeks.org/java-program-to-create-a-blank-ppt-document/)
...
[执行](https://poi.apache.org/download.html)操作需要下载外部文件。有关所用模块的更多文件，请参考[本](https://poi.apache.org/)。
