...
> 原文: [https://www.geeksforgeeks.org/java-program-to-split-an-array-from-specified-position/](https://www.geeksforgeeks.org/java-program-to-split-an-array-from-specified-position/)
...
*   **步骤 3:** 然后我们有两个循环第一个循环从 `0` 到 `pos` 初始化数组 `B` 开始，第二个循环从 `0` 至 `N–pos` 初始化数组 `C` 结束。
