...
该函数接受单个参数`o`，即检查该队列中是否存在该参数。

## 返回值:

该函数返回一个布尔值。如果该队列中存在指定的元素，则返回真，否则返回假。
...
[https://docs.oracle.com/javase/7/docs/api/java/util/concurrent/LinkedTransferQueue.html#contains(java.lang.Object)](https://docs.oracle.com/javase/7/docs/api/java/util/concurrent/LinkedTransferQueue.html#contains(java.lang.Object))