...
> 原文：[`https://www.geeksforgeeks.org/how-to-get-random-elements-from-java-hashset/`](https://www.geeksforgeeks.org/how-to-get-random-elements-from-java-hashset/)
...
*   然后我们将创建一个 [`Random`](https://www.geeksforgeeks.org/java-util-random-class-java/) 类的对象并将调用该类的 `nextInt()` 方法，该方法将为我们提供任何小于或等于 `HashSet` 大小的随机数。
