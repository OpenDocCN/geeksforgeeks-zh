...
> 原文：[https://www.geeksforgeeks.org/class-getdeclaredannotations-method-in-java-with-examples/](https://www.geeksforgeeks.org/class-getdeclaredannotations-method-in-java-with-examples/)

[`java.lang.Class`](https://www.geeksforgeeks.org/java-lang-class-class-java-set-1/) 类的 `getDeclaredAnnotations()` 方法用于获取该类中存在的已声明的注释。方法返回一个已声明注释的数组。
...
## 参考：
[https://docs.oracle.com/javase/9/docs/api/java/lang/Class.html#getDeclaredAnnotations--](https://docs.oracle.com/javase/9/docs/api/java/lang/Class.html#getDeclaredAnnotations--)