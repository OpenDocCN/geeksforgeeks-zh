...
> 原文: [https://www.geeksforgeeks.org/how-to-delete-data-in-sqlite-database-in-android/](https://www.geeksforgeeks.org/how-to-delete-data-in-sqlite-database-in-android/)
...
导航到 `app > res > layout > activity_update_course.xml` 文件，并在该布局中添加一个用于删除课程的按钮。下面是该文件的代码。
...
以下是添加上述代码片段后 `_update_course.xml` 文件 的更新代码。
