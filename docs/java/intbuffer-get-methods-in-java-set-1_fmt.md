...
> 原文: [https://www.geeksforgeeks.org/intbuffer-get-methods-in-java-set-1/](https://www.geeksforgeeks.org/intbuffer-get-methods-in-java-set-1/)
...
**示例 2:** 演示 `java.nio.BufferUnderflowException`
...
**参数:** 该方法以 `index` (从中读取 `int` 的索引)为参数。
