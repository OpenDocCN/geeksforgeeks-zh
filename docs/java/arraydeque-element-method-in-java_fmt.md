# Java 中的 ArrayDeque element() 方法

> 原文：[https://www.geeksforgeeks.org/arraydeque-element-method-in-java/](https://www.geeksforgeeks.org/arraydeque-element-method-in-java/)

`java.util.ArrayDeque.element()` 方法用于检索或获取 `ArrayDeque` 的头部。在这个过程中，该方法不会从 deque 中删除元素，而是返回元素。
