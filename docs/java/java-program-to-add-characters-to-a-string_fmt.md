...
> 原文: [https://www.geeksforgeeks.org/java-program-to-add-characters-to-a-string/](https://www.geeksforgeeks.org/java-program-to-add-characters-to-a-string/)
...
### 方法二: 使用 StringBuffer 类的 insert() 方法
