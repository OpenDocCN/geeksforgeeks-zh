...
> 原文: [https://www.geeksforgeeks.org/java-program-to-convert-milliseconds-to-minutes-and-seconds/](https://www.geeksforgeeks.org/java-program-to-convert-milliseconds-to-minutes-and-seconds/)
...
1.  输入毫秒数。
2.  使用公式将毫秒转换为分钟：`minutes = (milliseconds / 1000) / 60`。
3.  使用公式将毫秒转换为秒：`seconds = (milliseconds / 1000) % 60`。
4.  打印从毫秒转换后的分钟和秒。

**求解方法:** Java 程序将毫秒转换为分和秒。

1.  在简单的 Java 中使用基本输入和输出。
2.  使用 Java 中的方法。
