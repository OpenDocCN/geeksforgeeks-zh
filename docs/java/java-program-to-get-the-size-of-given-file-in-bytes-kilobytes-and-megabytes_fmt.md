...
> 原文：[https://www.geeksforgeeks.org/java-program-to-get-the-size-of-given-file-in-bytes-kilobytes-and-megabytes/](https://www.geeksforgeeks.org/java-program-to-get-the-size-of-given-file-in-bytes-kilobytes-and-megabytes/)
...
但是现在我们可以在 Java 7 之后直接使用 `File.size(路径)`。在这种情况下我们不必创建文件对象，我们可以直接找到文件的大小。