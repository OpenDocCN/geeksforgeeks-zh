...
该方法采用单个参数 `e`，该参数表示要插入到该并发链接队列中的元素。
...
如果指定的元素为空，该方法抛出 `NullPointerException`。
...
[https://docs.oracle.com/javase/8/docs/api/java/util/concurrent/ConcurrentLinkedQueue.html#add-E-](https://docs.oracle.com/javase/8/docs/api/java/util/concurrent/ConcurrentLinkedQueue.html#add-E-)