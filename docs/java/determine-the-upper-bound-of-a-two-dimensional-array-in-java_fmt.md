...
> 原文：[https://www.geeksforgeeks.org/determine-the-upper-bound-of-a-two-dimensional-array-in-java/](https://www.geeksforgeeks.org/determine-the-upper-bound-of-a-two-dimensional-array-in-java/)
...
java 中的数组数组实际上是一维数组的数组。二维数组的每一行都有一个保存列数的`length`字段。但是，我们可以使用以下方法获得行上限和列维度：
