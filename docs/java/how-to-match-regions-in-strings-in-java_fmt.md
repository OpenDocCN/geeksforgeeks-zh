# Java 字符串 `regionMatches()` 方法示例

> 原文: [https://www.geeksforgeeks.org/how-to-match-regions-in-strings-in-java/](https://www.geeksforgeeks.org/how-to-match-regions-in-strings-in-java/)
...
class CheckIfRegionsEqual {
    public static void main(String args[])
    {
        ...
        String str1 = new String("Welcome to Geeksforgeeks.com");
