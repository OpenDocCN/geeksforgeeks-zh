# Java 中的 Collator `getInstance()` 方法示例

> 原文: [https://www.geeksforgeeks.org/collator-getinstance-method-in-java-with-example/](https://www.geeksforgeeks.org/collator-getinstance-method-in-java-with-example/)
