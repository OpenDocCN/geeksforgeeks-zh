...
> 原文：[https://www.geeksforgeeks.org/abstractlist-get-method-in-java-with-examples/](https://www.geeksforgeeks.org/abstractlist-get-method-in-java-with-examples/)

[`java.util.AbstractList`](https://www.geeksforgeeks.org/abstractlist-in-java-with-examples/)类的`get()`方法用于返回该列表中指定位置的元素。
...
如果索引超出范围（`index = size()`），该方法抛出`IndexOutOfBoundsException`。
