...
> 原文: [https://www.geeksforgeeks.org/hashmap-putall-method-in-java/](https://www.geeksforgeeks.org/hashmap-putall-method-in-java/)
...
## 参数:
方法取一个参数`exist_hash_map`，指的是我们要复制的现有地图。

## 返回值:
该方法不返回值。

## 异常:
如果我们要复制的地图为空，该方法抛出`空指针异常`。
