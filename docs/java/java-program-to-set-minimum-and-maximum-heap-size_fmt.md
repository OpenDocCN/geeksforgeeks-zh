...
> 原文：[https://www.geeksforgeeks.org/java-program-to-set-minimum-and-maximum-heap-size/](https://www.geeksforgeeks.org/java-program-to-set-minimum-and-maximum-heap-size/)
...
java 应用程序可以通过使用运行时对象与虚拟机通信。`java.lang` 包中的 `Runtime` 类，它是一个单例类。我们可以如下创建一个运行时对象：
