# 如何在安卓App中使用Canvas API？

> 原文：[https://www.geeksforgeeks.org/how-to-use-canvas-api-in-android-apps/](https://www.geeksforgeeks.org/how-to-use-canvas-api-in-android-apps/)
...
### 第三步：创建一个新的Java类来绘制我们的视图

导航到`应用 > java > 你的应用的包名 > 右键点击它 > 新建 > Java 类`并将其命名为`PaintView`并添加下面的代码。
