...
> 原文: [https://www.geeksforgeeks.org/jvm-create-object-main-class-class-contains-main/](https://www.geeksforgeeks.org/jvm-create-object-main-class-class-contains-main/)
...
由于我们无法在 Java 中创建抽象类的对象，所以保证 `main()` 类的对象不是由 JVM 创建的。
