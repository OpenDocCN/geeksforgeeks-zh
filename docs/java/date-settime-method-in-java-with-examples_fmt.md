...
> 原文: [https://www.geeksforgeeks.org/date-settime-method-in-java-with-examples/](https://www.geeksforgeeks.org/date-settime-method-in-java-with-examples/)

`Date`类的`setTime()`方法设置日期对象。它将`date`对象设置为表示 1970 年 1 月 1 日 00:00:00 GMT 之后的时间毫秒。
