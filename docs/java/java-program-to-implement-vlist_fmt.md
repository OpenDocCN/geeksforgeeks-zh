...
> 原文: [https://www.geeksforgeeks.org/java-program-to-implement-vlist/](https://www.geeksforgeeks.org/java-program-to-implement-vlist/)
...
class VList {
    ...
    public void searchElementWithPosition(int k) {
        System.out.print("Element at postition " + k + " is = ");
    ...
    public void displayVList() {
        ...
        while (startTemp != null) {
            for (int i = 0; i < startTemp.list.size(); i++) {
...
class GFG {
    public static void main(String[] args) {
        ...
        int[] arr = new int[] { 9, 1, 5, 4, 3, 5, 2, 1, 0, 8 };
