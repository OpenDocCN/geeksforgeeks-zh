...
> 原文：[https://www.geeksforgeeks.org/how-to-print-a-collection-in-java/](https://www.geeksforgeeks.org/how-to-print-a-collection-in-java/)
...
`toString` 方法被 Java 中的所有类继承，以便通过重写 `toString` 方法来打印 Java 中的任何集合。重写后，我们可以使用 `for-each` 循环遍历集合，以打印集合中的所有对象。
