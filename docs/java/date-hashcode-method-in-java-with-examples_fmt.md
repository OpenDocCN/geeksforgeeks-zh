...
> 原文：[https://www.geeksforgeeks.org/date-hashcode-method-in-java-with-examples/](https://www.geeksforgeeks.org/date-hashcode-method-in-java-with-examples/)

`Date`类的`hashCode()`方法返回一个值，该值是该对象的哈希代码。
