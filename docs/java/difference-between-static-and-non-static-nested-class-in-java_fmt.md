...
> 原文: [https://www.geeksforgeeks.org/difference-between-static-and-non-static-nested-class-in-java/](https://www.geeksforgeeks.org/difference-between-static-and-non-static-nested-class-in-java/)
...
在 java 中，类可以是静态的，也可以是非静态的。所以让一个类静态和非静态有很大的区别。Java 中有两种类，一种叫做顶层类，另一种叫做嵌套类。顾名思义，顶级类是在 `*.java` 文件中声明的类。
