...
> 原文：[https://www.geeksforgeeks.org/how-to-improve-your-android-coding-through-annotation/](https://www.geeksforgeeks.org/how-to-improve-your-android-coding-through-annotation/)
...
*   `@NonNull`： A variable, parameter or return value that cannot be empty.
