...
[`Map`](https://www.geeksforgeeks.org/map-interface-java-examples/) 有两个集合进行迭代。一个是 [`keySet()`](https://www.geeksforgeeks.org/map-keyset-method-in-java-with-examples/)，另一个是 [`values()`](https://www.geeksforgeeks.org/hashmap-values-method-in-java/)。
