...
> 原文：[https://www.geeksforgeeks.org/how-to-use-enum-constructor-instance-variable-method-in-java/](https://www.geeksforgeeks.org/how-to-use-enum-constructor-instance-variable-method-in-java/)
...
class GFG {
    ...
    public static void main(String[] args)
    {
        ...
        for (fruits f : fruits.values())
            ...
            // Print and dispaly the cost and perkg cost of
            // fruits
