...
> 原文：[https://www.geeksforgeeks.org/localtime-getminute-method-in-java-with-examples/](https://www.geeksforgeeks.org/localtime-getminute-method-in-java-with-examples/)

`LocalTime`类的`getMinute()`方法用于返回小时分钟字段。此方法返回一个 0 到 59 之间的整数值，即一小时的分钟数。
