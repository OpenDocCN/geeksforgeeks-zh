...
**参考:** [https://docs.oracle.com/javase/7/docs/api/java/awt/event/WindowStateListener.html](https://docs.oracle.com/javase/7/docs/api/java/awt/event/WindowStateListener.html)