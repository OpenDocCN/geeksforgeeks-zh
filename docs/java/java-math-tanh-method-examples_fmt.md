...
> 原文: [https://www.geeksforgeeks.org/java-math-tanh-method-examples/](https://www.geeksforgeeks.org/java-math-tanh-method-examples/)
...
展示当自变量为 `NaN` 或无穷大时 `java.lang.Math.tanh()` 方法的工作。
