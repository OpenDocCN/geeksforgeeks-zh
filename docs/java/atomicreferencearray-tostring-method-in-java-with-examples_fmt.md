# Java 中的 AtomicReferenceArray toString()方法
...
`AtomicReferenceArray` 类的 `toString()` 方法用于返回数组当前值的字符串表示。此方法用于将原子引用数组的内容表示为字符串。
...
[https://docs.oracle.com/javase/10/docs/api/java/util/concurrent/atomic/AtomicReferenceArray.html#toString()](https://docs.oracle.com/javase/10/docs/api/java/util/concurrent/atomic/AtomicReferenceArray.html#toString())