# Java 中的 `KeyStore` `getCertificate()` 方法示例

> 原文：`https://www.geeksforgeeks.org/keystore-getcertificate-method-in-java-with-examples/`
...
**参考：** `https://docs.oracle.com/javase/9/docs/api/java/security/KeyStore.html#getCertificate-java.lang.String-`