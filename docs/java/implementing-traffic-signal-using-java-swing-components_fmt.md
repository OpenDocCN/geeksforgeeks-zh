...
> 原文：[https://www.geeksforgeeks.org/implementing-traffic-signal-using-java-swing-components/](https://www.geeksforgeeks.org/implementing-traffic-signal-using-java-swing-components/)

创建一个按钮组，使其包含三个单选按钮红色、黄色、绿色。当单击红色时，您希望显示“停止”，当单击橙色时，您希望显示“就绪”，当单击绿色按钮时，显示“开始”，并使用 2D 图形创建一个使用矩形和椭圆形的交通信号示例演示。
