...
`java.nio.ByteBuffer` 类的 `position(int newPosition)` 方法用于设置该缓冲区的位置。如果标记被定义并且比新位置大，则它被丢弃。
...
## 参考:
[https://docs.oracle.com/javase/9/docs/api/java/nio/ByteBuffer.html#position-int-](https://docs.oracle.com/javase/9/docs/api/java/nio/ByteBuffer.html#position-int-)