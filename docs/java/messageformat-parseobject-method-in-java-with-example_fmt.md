# Java 中的 MessageFormat parseObject()方法与示例

> 原文: [https://www.geeksforgeeks.org/messageformat-parseobject-method-in-java-with-example/](https://www.geeksforgeeks.org/messageformat-parseobject-method-in-java-with-example/)
...
**返回值:** 该方法返回对象数组作为输出。
**异常:** 如果解析位置为空，该方法抛出 `NullPointerException`。
