...
> 原文：[https://www.geeksforgeeks.org/java-program-to-illustrate-the-usage-of-octal-integer/](https://www.geeksforgeeks.org/java-program-to-illustrate-the-usage-of-octal-integer/)
...
将十进制转换为八进制的方法是 `Integer.toOctalString(int num)`。
