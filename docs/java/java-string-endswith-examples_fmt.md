...
> 原文: [https://www.geeksforgeeks.org/java-string-endswith-examples/](https://www.geeksforgeeks.org/java-string-endswith-examples/)

[`String`](https://www.geeksforgeeks.org/string-class-in-java/) 类的 `endsWith()` 方法检查字符串是否以指定的后缀结束。此方法返回一个布尔值 `true` 或 `false`。
