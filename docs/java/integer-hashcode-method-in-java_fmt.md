...
> 原文: [https://www.geeksforgeeks.org/integer-hashcode-method-in-java/](https://www.geeksforgeeks.org/integer-hashcode-method-in-java/)

`java.lang.Integer.hashCode()`方法用于返回特定`Integer`的哈希代码。
...
## 返回值:
该方法为*这个*对象返回一个哈希码整数值，等于这个`Integer`对象所表示的不复杂的本原整数值。
