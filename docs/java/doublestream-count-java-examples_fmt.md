...
> 原文：[https://www.geeksforgeeks.org/doublestream-count-java-examples/](https://www.geeksforgeeks.org/doublestream-count-java-examples/)
...
## 注：
这是一个**终端操作**，即可能穿越流产生结果或副作用。执行终端操作后，流管道被认为已消耗，不能再使用。
