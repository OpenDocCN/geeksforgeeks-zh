...
> 原文: [https://www.geeksforgeeks.org/java-program-to-find-the-largest-clique-in-a-planar-graph/](https://www.geeksforgeeks.org/java-program-to-find-the-largest-clique-in-a-planar-graph/)
...
public class GFG {
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        int y = n - x;
        int found = 0;
        // variable to check if answer is found
        int size
            = 0;
        int min = n + 1;
...
如果我们要提到图的全尺寸(即上面 eg 中的 5)，那么输出如下所示:
