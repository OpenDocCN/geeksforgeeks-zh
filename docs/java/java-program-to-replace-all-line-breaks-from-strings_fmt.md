...
> 原文:[https://www . geeksforgeks . org/Java-program-to-replace-all-line-break-from-strings/](https://www.geeksforgeeks.org/java-program-to-replace-all-line-breaks-from-strings/)
...
此方法返回一个新的 `String` 对象，该对象包含与原始字符串相同的字符序列，但给定的字符被另一个给定的字符替换。
