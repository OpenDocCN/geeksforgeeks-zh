...
> 原文: [https://www.geeksforgeeks.org/json-parsing-in-android-using-retrofit-library/](https://www.geeksforgeeks.org/json-parsing-in-android-using-retrofit-library/)
...
> **注意:** 使用 `Volley` 库解析安卓系统中的 JSON 对象请参考[使用凌空库](https://www.geeksforgeeks.org/json-parsing-in-android-using-volley-library/)解析安卓系统中的 JSON
...
导航到 `应用 > java > 你的应用的包名 > 右键点击 > 新建 > Java 类` 选择为 `Interface` 并将文件命名为 `RetrofitAPI` 并添加下面的代码。在代码内部添加注释，更详细地理解代码。
...
以下是一个使用 `Retrofit` 和 `Picasso` 库从网络 API 获取并显示课程数据的 Android `MainActivity` 示例。
...
[https://media.geeksforgeeks.org/wp-content/uploads/20210217150427/Screenrecorder-2021-01-21-21-39-44-445.mp4](https://media.geeksforgeeks.org/wp-content/uploads/20210217150427/Screenrecorder-2021-01-21-21-39-44-445.mp4)