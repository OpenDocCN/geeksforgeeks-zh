...
> 原文: [https://www.geeksforgeeks.org/integer-rotateright-method-in-java/](https://www.geeksforgeeks.org/integer-rotateright-method-in-java/)
...
`rotateRight()`方法返回通过将指定 `int` 值的二进制补码二进制表示向右旋转指定位数而获得的值。
