...
> 原文：[https://www.geeksforgeeks.org/calendar-gettimezone-method-in-java-with-examples/](https://www.geeksforgeeks.org/calendar-gettimezone-method-in-java-with-examples/)
...
下面的程序说明了`Calendar`类`getTimeZone()`方法的工作：
