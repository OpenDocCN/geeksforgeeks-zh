...
> 原文：[https://www.geeksforgeeks.org/java-program-to-implement-unrolled-linked-list/](https://www.geeksforgeeks.org/java-program-to-implement-unrolled-linked-list/)
...
// Condition check
        // If temp variable is NOT-NULL
        while (temp != null) {

// Print and display the temp array
            // be it one element or many
            System.out.println(temp.array);
