...
> 原文：[https://www.geeksforgeeks.org/how-to-iterate-linkedhashmap-in-java/](https://www.geeksforgeeks.org/how-to-iterate-linkedhashmap-in-java/)
...
## 方法 1：使用 `keySet()` 和 `get()` 方法迭代 `LinkedHashMap`
...
## 方法 2：使用 `entrySet()` 和迭代器迭代 `LinkedHashMap`
