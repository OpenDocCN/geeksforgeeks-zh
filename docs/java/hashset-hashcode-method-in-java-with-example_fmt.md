...
> 原文：[https://www.geeksforgeeks.org/hashset-hashcode-method-in-java-with-example/](https://www.geeksforgeeks.org/hashset-hashcode-method-in-java-with-example/)
...
**返回：** 该方法返回一个整数值，该整数值是 `HashSet` 实例的 `hashCode` 值。
