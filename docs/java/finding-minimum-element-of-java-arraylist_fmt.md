...
> 原文: [https://www.geeksforgeeks.org/finding-minimum-element-of-java-arraylist/](https://www.geeksforgeeks.org/finding-minimum-element-of-java-arraylist/)

要在[数组列表](https://www.geeksforgeeks.org/arraylist-in-java/) (这个类在`java.util`包中找到)中找到最小元素，需要完整遍历数组列表。`ArrayList`类中有一个内置函数，用来寻找数组列表中的最小元素，即时间复杂度为 O(N)，其中 N 是数组列表的大小，下面我们来讨论这两种方法。
