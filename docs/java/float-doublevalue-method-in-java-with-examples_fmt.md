...
> 原文：[https://www.geeksforgeeks.org/float-doublevalue-method-in-java-with-examples/](https://www.geeksforgeeks.org/float-doublevalue-method-in-java-with-examples/)
...
**参考：** [https://docs.oracle.com/javase/7/docs/api/java/lang/Float.html#doubleValue()](https://docs.oracle.com/javase/7/docs/api/java/lang/Float.html#doubleValue())