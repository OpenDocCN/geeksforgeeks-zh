...
> 原文:[https://www.geeksforgeeks.org/java-program-to-implement-binomial-tree/](https://www.geeksforgeeks.org/java-program-to-implement-binomial-tree/)
    ...
    public static void main(String[] args) {
        ...
        while (!exit) {
            ...
            switch (choice) {
                ...
                case 2:
                    System.out.println("Size of tree is = " + tree.getSize());
                    break;
...
class BinomialTreeExample {
    ...
    private void insert(BinoTreeNode bt, int val) throws Exception {
        if (bt.data == -1) {
            bt.data = val;
            size++;
