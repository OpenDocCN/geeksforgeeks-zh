...
> 原文：[https://www.geeksforgeeks.org/java-program-to-illustrate-the-usage-of-floating/](https://www.geeksforgeeks.org/java-program-to-illustrate-the-usage-of-floating/)
...
| 名字 | 宽度 | 范围 |
| --- | --- | --- |
| `float` | 32位 | 1.4e–045 至 3.4e+038 |
| `double` | 64位 | 4.9e–324 至 1.8e+308 |
...
1.  `float a1 = 10.57f;` 等于 10.57
2.  `float a2 = 10f;` 等于 10.0
3.  `float a3 = 9.58;` 它会给出一个误差。
...
public class GFG {
    ...
    public static void main(String[] args)
    {
        ...
        // declared a3 which will contain
        // the output of a1 * a2.
        float a1 = 10.89f;
        float a2 = 7.43f;
        float a3;

        // multiplied a1 and a2 and stored it in a3
        a3 = a1 * a2;

        // printed the value of a3
        System.out.println("The result of a1 x a2 is: " + a3);
    }
}
```
...
```java
The result of a1 x a2 is: 80.912704
```
