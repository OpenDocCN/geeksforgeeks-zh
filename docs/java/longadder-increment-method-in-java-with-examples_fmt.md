...
> 原文：`https://www.geeksforgeeks.org/longadder-increment-method-in-java-with-examples/`

Java 中的 `LongAdder` 类创建一个初始和为零的新加法器。`java.lang.LongAdder.increment()` 是 Java 中的一个内置方法，将值增加 1。
