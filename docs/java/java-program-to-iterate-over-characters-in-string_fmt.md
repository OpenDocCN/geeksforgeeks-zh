...
> 原文：[`https://www.geeksforgeeks.org/java-program-to-iterate-over-characters-in-string/`](https://www.geeksforgeeks.org/java-program-to-iterate-over-characters-in-string/)
...
可以使用迭代器遍历字符串。我们将从`java.text`包中导入`CharacterIterator`和`StringCharacterIterator`类。
