...
> 原文: [https://www.geeksforgeeks.org/java-program-for-case-specific-sorting/](https://www.geeksforgeeks.org/java-program-for-case-specific-sorting/)
...
2.  在列表中添加元素后，我们将使用 `Collections.sort(list)` 方法对列表进行排序。
