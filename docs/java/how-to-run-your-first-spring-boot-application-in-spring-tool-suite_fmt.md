...
成功创建或导入 spring boot 项目后，将自动创建一个文件名 `Application.java` *(Herre demo application)*，这是您的入口点。您可以将其视为 Spring Boot 应用程序的主要方法。

![](img/d92f536645b55f9e009d06a4cd1099d0.png)

## 步骤 4: 运行应用程序

右键点击 `Application.java` > 运行方式 > `Spring Boot App`，如下图所示。

![](img/34569a033165e0035805f9d4d22fbd12.png)

成功运行应用程序后，您可以看到 Tomcat 服务器在默认端口号 8080 上启动的控制台，如下图所示。
