...
> 原文: [https://www.geeksforgeeks.org/keyfactory-getinstance-method-in-java-with-examples/](https://www.geeksforgeeks.org/keyfactory-getinstance-method-in-java-with-examples/)
...
**异常:** 如果没有提供程序支持特定算法的密钥工厂spi应用程序，此方法将引发以下异常:
...
*   `NoSuchAlgorithmException`：如果没有提供程序支持特定算法的密钥工厂spi应用程序。
*   `IllegalArgumentException`：【中文】和【中文】。
