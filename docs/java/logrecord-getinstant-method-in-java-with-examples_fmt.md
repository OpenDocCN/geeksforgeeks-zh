...
> 原文：`https://www.geeksforgeeks.org/logrecord-getinstant-method-in-java-with-examples/`

`LogRecord`的`getInstant()`方法用于获取事件发生的这个瞬间，这有助于记录事件的瞬间。
...
`https://docs.oracle.com/javase/10/docs/api/java/util/logging/LogRecord.html#getInstant()`