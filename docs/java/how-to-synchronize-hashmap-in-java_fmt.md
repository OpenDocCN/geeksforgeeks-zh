...
> 原文：[https://www.geeksforgeeks.org/how-to-synchronize-hashmap-in-java/](https://www.geeksforgeeks.org/how-to-synchronize-hashmap-in-java/)
...
可以使用 [`Collections.synchronizedMap()`](https://www.geeksforgeeks.org/collections-synchronizedmap-method-in-java-with-examples/) 方法同步 HashMap。
