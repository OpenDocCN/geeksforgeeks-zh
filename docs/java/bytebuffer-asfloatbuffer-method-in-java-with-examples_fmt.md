# Java 中的 `ByteBuffer.asFloatBuffer()` 方法示例

> 原文：[`https://www.geeksforgeeks.org/bytebuffer-asfloatbuffer-method-in-java-with-examples/`](https://www.geeksforgeeks.org/bytebuffer-asfloatbuffer-method-in-java-with-examples/)
