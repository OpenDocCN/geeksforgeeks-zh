...
[`java.lang.Class`](https://www.geeksforgeeks.org/java-lang-class-class-java-set-1/) 类的 `getAnnotationsByType()` 方法用于获取该类中存在的指定标注类型的标注。方法返回指定批注类型的批注数组。
...
[https://docs.oracle.com/javase/9/docs/api/java/lang/Class.html#getAnnotationsByType-java.lang.Class-](https://docs.oracle.com/javase/9/docs/api/java/lang/Class.html#getAnnotationsByType-java.lang.Class-)