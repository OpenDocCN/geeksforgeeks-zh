...
> 原文: [https://www.geeksforgeeks.org/decorator-design-pattern-in-java-with-example/](https://www.geeksforgeeks.org/decorator-design-pattern-in-java-with-example/)
...
> 3.  装饰器模式在 [Java IO 类](https://www.geeksforgeeks.org/java-io-packag/)中大量使用，比如 [`FileReader`](https://www.geeksforgeeks.org/different-ways-reading-text-file-java/)、[`BufferedReader`](https://www.geeksforgeeks.org/java-io-bufferedreader-class-java/)、[`Writer`](https://www.geeksforgeeks.org/java-io-bufferedreader-class-java/) 等。
...
`Rectangle.java` 和 `Circle.java` 如下。
