...
> 原文：`https://www.geeksforgeeks.org/logrecord-getillis-method-in-java-with-examples/`
...
`https://docs.oracle.com/javase/10/docs/api/java/util/logging/LogRecord.html#getMillis()`