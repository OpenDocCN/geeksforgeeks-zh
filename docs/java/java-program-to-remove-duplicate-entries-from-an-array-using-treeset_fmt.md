...
> 原文：[https://www.geeksforgeeks.org/java-program-to-remove-duplicate-entries-from-an-array-using-treeset/](https://www.geeksforgeeks.org/java-program-to-remove-duplicate-entries-from-an-array-using-treeset/)

[`TreeSet`](https://www.geeksforgeeks.org/treeset-in-java-with-examples/)的特性是主要关注点，它广泛用于删除数据结构中的重复项，如下所示：

*   `TreeSet`实现[`SortedSet`](https://www.geeksforgeeks.org/sortedset-java-examples/)接口。所以，重复的值是不允许的，并且将是剩余值。
...
6.  使用[`toArray()`](https://www.geeksforgeeks.org/set-toarray-method-in-java-with-example/)的转换方法将上述树集转换为数组。
7.  迭代数组元素。
...
```java
Initial String Array(Containing Duplicates) : [Hello, hi, Wow, cute, thanks, hi, Aww, cute, baby, beloved, Aww]
Duplicate Data entered : hi
