...
> 原文：[https://www.geeksforgeeks.org/localdate-plusyears-method-in-java-with-examples/](https://www.geeksforgeeks.org/localdate-plusyears-method-in-java-with-examples/)
...
该方法接受单个参数 `yearsToAdd`，代表要相加的年，可以是负数。

## 返回值

此方法返回一个基于此日期加上年份的 `LocalDate`，不为空。
...
[https://docs.oracle.com/javase/10/docs/api/java/time/LocalDate.html#plusYears(long)](https://docs.oracle.com/javase/10/docs/api/java/time/LocalDate.html#plusYears(long))