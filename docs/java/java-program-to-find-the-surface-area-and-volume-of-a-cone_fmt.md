...
> 原文: [https://www.geeksforgeeks.org/java-program-to-find-the-surface-area-and-volume-of-a-cone/](https://www.geeksforgeeks.org/java-program-to-find-the-surface-area-and-volume-of-a-cone/)
...
其中 `r` 为圆形底面的半径，`h` 为高度(底面到顶点的垂直距离)，`s` 为圆锥体的倾斜高度。
