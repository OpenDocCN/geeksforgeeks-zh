...
> 原文: [`https://www.geeksforgeeks.org/how-to-convert-an-array-to-linkedhashset-in-java/`](https://www.geeksforgeeks.org/how-to-convert-an-array-to-linkedhashset-in-java/)
...
**1. 使用 `Arrays.asList()` 方法和 `LinkedHashSet` 构造函数**

`LinkedHashSet` 类提供了一个接受集合对象的构造函数。但要使用它，我们需要使用 `Arrays` 类的 `asList` 方法将数组转换为 `List`。
