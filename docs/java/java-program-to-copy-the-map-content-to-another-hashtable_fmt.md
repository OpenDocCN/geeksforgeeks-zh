...
> 原文：[https://www.geeksforgeeks.org/java-program-to-copy-the-map-content-to-another-hashtable/](https://www.geeksforgeeks.org/java-program-to-copy-the-map-content-to-another-hashtable/)
...
该方法采用一个参数 `hashmap`，该散列表引用了我们想要复制的现有地图。
...
如果我们要复制的地图为空，该方法将抛出 `NullPointerException`。
