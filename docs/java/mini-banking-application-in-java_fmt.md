...
> 原文:[https://www.geeksforgeeks.org/mini-banking-application-in-java/](https://www.geeksforgeeks.org/mini-banking-application-in-java/)
...
#### 输出
该类为客户提供了菜单驱动的界面，客户可以在此创建账户、登录账户、转账等。
