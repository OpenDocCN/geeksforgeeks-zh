...
## 先决条件
确保您已经安装了 `Java Development Kit (JDK)` 版本 8 或更高版本。要检查，只需进入终端，输入以下命令，检查它是否存在。
...
## 程序
这些是要依次遵循的步骤，下面将通过视觉辅助工具进一步讨论:

1.  根据操作系统将 `SpringToolSuite` 下载到本地机器上。
2.  将下载的 `Jar` 文件移动到相应的文件夹。
3.  解压这个 `Jar` 文件，打开相应的文件夹。
4.  点击 `Spring Tools 4` 应用文件。
5.  选择代表工作区的目录，并按下“启动”按钮。

### 第一步
[去他们的网站，在 Spring Tools 4 中的 Eclipse 部分](https://spring.io/tools)下载。根据您的操作系统选择相应的文件。
...
### 第二步
点击按钮后一个 `Jar` 文件将被下载到你的本地系统。现在创建一个文件夹，并将这个 `Jar` 文件移动到那个文件夹。双击那个 `Jar` 文件。一个弹出窗口会这样出现。

![](img/e39124da832546c1ad13b3bb8d1bb815.png)

### 步骤 3
成功解包后，将创建一个新文件夹，如下图所示。现在打开文件夹。

![](img/ddbb8bf2efd3bcbaf77d7417d8718655.png)

### 第 4 步
现在在这个文件夹中点击 `springtoolsuite 4` 应用文件，如下图所示。

![](img/9a10a673136b2751aac6ca063c3170e4.png)

### 第 5 步
现在点击“浏览”按钮，然后点击“启动”按钮，选择您的目录作为工作区。你完蛋了。

![](img/e6dadec039fc4c4c7a886bfaa142dd8c.png)

> 这是 `Spring Tools 4` (`Eclipse` 的 `Spring Tools 4`) IDE 的主屏幕。
