...
> 原文: [https://www.geeksforgeeks.org/java-program-to-find-the-roots-of-quadratic-equation/](https://www.geeksforgeeks.org/java-program-to-find-the-roots-of-quadratic-equation/)
...
## 行列式 `(b^2–4ac)` 告诉我们根的性质

1.  如果 `(b^2–4ac) > 0`，根是实数且不同。
2.  如果 `(b^2–4ac) = 0`，根是实数且相等。
3.  如果 `(b^2–4ac) < 0`，根是复数且不同。
