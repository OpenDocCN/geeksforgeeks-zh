...
> 原文：[https://www.geeksforgeeks.org/buffer-array-methods-in-java-with-examples/](https://www.geeksforgeeks.org/buffer-array-methods-in-java-with-examples/)

`java.nio.Buffer` 类的 `array()` 方法用于返回支持此缓冲区的数组。
