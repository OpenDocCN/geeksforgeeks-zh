...
> 原文：[https://www.geeksforgeeks.org/initialize-a-list-in-a-single-line-with-a-specified-value/](https://www.geeksforgeeks.org/initialize-a-list-in-a-single-line-with-a-specified-value/)
...
*   获取值 `N`
*   使用 [`Collections.nCopies()` 方法](https://www.geeksforgeeks.org/collections-ncopies-java/)生成单值为 `N` 的集合
*   将此收藏存储为列表。
