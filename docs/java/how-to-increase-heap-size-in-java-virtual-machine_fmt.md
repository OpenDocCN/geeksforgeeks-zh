...
> 原文：[https://www.geeksforgeeks.org/how-to-increase-heap-size-in-java-virtual-machine/](https://www.geeksforgeeks.org/how-to-increase-heap-size-in-java-virtual-machine/)
...
Java 虚拟机实现可以为程序员或用户提供对堆初始大小的控制，如果堆可以动态扩展或收缩，还可以提供对最大和最小堆大小的控制。每当计算需要的堆超过自动存储管理系统所能提供的堆时，Java 虚拟机就会抛出 `OutOfMemoryError`。
