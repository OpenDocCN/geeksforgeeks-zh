...
> 原文：[https://www.geeksforgeeks.org/difference-between-jdk-and-jre-in-java/](https://www.geeksforgeeks.org/difference-between-jdk-and-jre-in-java/)

`JDK` 和 `JRE` 是 `Java` 编程中的核心概念，它们的区别是一些最受欢迎的面试问题。我们在编程时不会使用这些概念，但是如果我们想成为一名 `Java` 开发人员，我们必须了解这些概念。
