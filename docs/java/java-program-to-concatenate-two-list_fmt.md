...
> 原文：[https://www.geeksforgeeks.org/java-program-to-concatenate-two-list/](https://www.geeksforgeeks.org/java-program-to-concatenate-two-list/)
...
```java
concatenated_list.addAll(list1); // 串联第一个列表
concatenated_list.addAll(list2); // 串联第二个列表
```
