...
> 原文：[https://www.geeksforgeeks.org/jackson-annotations-for-java-application/](https://www.geeksforgeeks.org/jackson-annotations-for-java-application/)
...
它便于使用 getter 方法返回映射。稍后，这些映射被用来以与其他属性相同的方式序列化 JSON 的附加属性。
