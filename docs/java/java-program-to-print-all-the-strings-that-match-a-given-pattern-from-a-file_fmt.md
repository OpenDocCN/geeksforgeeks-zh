...
> 原文: [https://www.geeksforgeeks.org/java-program-to-print-all-the-strings-that-match-a-given-pattern-from-a-file/](https://www.geeksforgeeks.org/java-program-to-print-all-the-strings-that-match-a-given-pattern-from-a-file/)
...
为此，需要导入一个名为“`Pattern`”和的类，该类的方法只用于匹配文件中存在的字符串。
