# Java 中的 Calendar.clone() 方法示例

> 原文：[Calendar clone() method in Java with examples](https://www.geeksforgeeks.org/calendar-clone-method-in-java-with-examples/)

`Calendar` 类中的 `clone()` 方法用于克隆日历对象。它基本上创建了这个对象的一个浅拷贝。
...
[Calendar.clone()](https://docs.oracle.com/javase/7/docs/api/java/util/Calendar.html#clone())