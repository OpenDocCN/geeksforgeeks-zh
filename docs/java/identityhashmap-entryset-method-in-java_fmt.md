...
> 原文: [https://www.geeksforgeeks.org/identityhashmap-entryset-method-in-java/](https://www.geeksforgeeks.org/identityhashmap-entryset-method-in-java/)

`java.util.IdentityHashMap.entrySet()`方法用于创建一组包含在映射中的相同元素。它基本上返回身份哈希映射的集合视图，或者我们可以创建一个新的集合并将映射元素存储到其中。
...
下面的程序说明了 `java.util.IdentityHashMap.entrySet()`方法:
