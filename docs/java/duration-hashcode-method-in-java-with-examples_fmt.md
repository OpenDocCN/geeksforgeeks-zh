...
> 原文：[https://www.geeksforgeeks.org/duration-hashcode-method-in-java-with-examples/](https://www.geeksforgeeks.org/duration-hashcode-method-in-java-with-examples/)

使用 `java.time` 包中 `Duration` 类的 `hashCode()` 方法获取该时长的 hashCode 值。
