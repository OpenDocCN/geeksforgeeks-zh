...
> 原文：[https://www.geeksforgeeks.org/dateformatsymbols-geteras-method-in-java-with-examples/](https://www.geeksforgeeks.org/dateformatsymbols-geteras-method-in-java-with-examples/)

Java 中 `DateFormatSymbols` 类的 `getEras()` 方法用于获取字符串格式的 Era 字符串。例如，“公元前”和“公元”。
