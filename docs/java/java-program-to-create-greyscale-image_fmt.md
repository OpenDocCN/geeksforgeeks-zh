...
> 原文：[https://www.geeksforgeeks.org/java-program-to-create-greyscale-image/](https://www.geeksforgeeks.org/java-program-to-create-greyscale-image/)
...
*   要读写图像文件，我们必须导入 `File` 类。这个类通常表示文件和目录路径名。
