...
> 原文：[https://www.geeksforgeeks.org/can-we-extend-final-method-in-java/](https://www.geeksforgeeks.org/can-we-extend-final-method-in-java/)
...
*   `GFGParent` 类有一个 `final` 方法，随机命名为 `dataDisplay()`，它是作为这里的最终方法创建的。
