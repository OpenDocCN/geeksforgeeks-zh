...
> 原文：[https://www.geeksforgeeks.org/different-ways-to-generate-string-by-using-characters-and-numbers-in-java/](https://www.geeksforgeeks.org/different-ways-to-generate-string-by-using-characters-and-numbers-in-java/)
...
6.  以相反的顺序遍历循环，并将 `jth` 位置字符添加到变量 `finalAnswer` 中。
7.  现在，打印结果。
...
class GFG {
    ...
    public static String generateNewString(String str, int num) {
