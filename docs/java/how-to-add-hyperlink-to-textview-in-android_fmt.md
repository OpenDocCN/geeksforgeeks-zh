...
> 原文：[https://www.geeksforgeeks.org/how-to-add-hyperlink-to-textview-in-android/](https://www.geeksforgeeks.org/how-to-add-hyperlink-to-textview-in-android/)
...
**步骤 2：处理 `strings.xml` 文件**

打开 `values>strings.xml` 文件。我们必须制作两个字符串来添加一个超链接，所以使用下面提供的代码。
...
[https://media.geeksforgeeks.org/wp-content/uploads/20210525114802/WhatsApp-Video-2021-05-25-at-11.45.02.mp4](https://media.geeksforgeeks.org/wp-content/uploads/20210525114802/WhatsApp-Video-2021-05-25-at-11.45.02.mp4)