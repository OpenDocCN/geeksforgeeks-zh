...
> 原文：[https://www.geeksforgeeks.org/convert-double-to-integer-in-java/](https://www.geeksforgeeks.org/convert-double-to-integer-in-java/)
...
>
> 例如：`10.6` 将使用 `Math.round()` 方法转换为 `11`，`10.4` 将使用 typecasting 或 `Double.intValue()` 方法转换为 `10`。