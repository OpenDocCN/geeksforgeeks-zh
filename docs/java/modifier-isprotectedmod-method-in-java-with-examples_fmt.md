...
> 原文: [https://www.geeksforgeeks.org/modifier-isprotectedmod-method-in-java-with-examples/](https://www.geeksforgeeks.org/modifier-isprotectedmod-method-in-java-with-examples/)
...
## 返回:
如果`mod`包含受保护的修改器，则该方法返回`true`否则为假。
...
**参考文献:** [https://docs.oracle.com/javase/10/docs/api/java/lang/reflect/Modifier.html#isProtected(int)](https://docs.oracle.com/javase/10/docs/api/java/lang/reflect/Modifier.html#isProtected(int))