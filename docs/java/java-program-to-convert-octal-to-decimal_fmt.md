...
> 原文：[https://www.geeksforgeeks.org/java-program-to-convert-octal-to-decimal/](https://www.geeksforgeeks.org/java-program-to-convert-octal-to-decimal/)
...
要将任意字符串形式转换为十进制，我们可以使用 `type.parseType()` 方法。比如这里需要从八进制转换到十进制，八进制形式是整数，可以用 `Integer.parseInt()` 来转换。
