...
> 原文：[https://www.geeksforgeeks.org/how-to-retrieve-image-from-firebase-in-realtime-in-android/](https://www.geeksforgeeks.org/how-to-retrieve-image-from-firebase-in-realtime-in-android/)
...
**第七步：使用 `activity_main.xml` 和 `MainActivity.java` 文件**

转到 `activity_main.xml` 和 `MainActivity.java` 文件，参考以下代码。下面是 `activity_main.xml` 和 `MainActivity.java` 文件的代码。
...
[output.mp4](https://media.geeksforgeeks.org/wp-content/uploads/20201224140814/output.mp4)