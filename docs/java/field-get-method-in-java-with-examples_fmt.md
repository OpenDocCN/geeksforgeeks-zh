...
> 原文：[https://www.geeksforgeeks.org/field-get-method-in-java-with-examples/](https://www.geeksforgeeks.org/field-get-method-in-java-with-examples/)
...
该方法接受单个参数 `obj`，该参数是从中提取字段值的对象。

## 返回值

该方法返回对象 `obj` 中表示字段的值；原始值在返回之前被包装在适当的对象中。
...
3.  `NullPointerException` – 如果指定的对象为空，并且该字段是实例字段。
...
[https://docs.oracle.com/javase/8/docs/api/java/lang/reflect/Field.html#get-java.lang.Object-](https://docs.oracle.com/javase/8/docs/api/java/lang/reflect/Field.html#get-java.lang.Object-)