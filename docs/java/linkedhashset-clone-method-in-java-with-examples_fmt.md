...
> 原文: [https://www.geeksforgeeks.org/linkedhashset-clone-method-in-java-with-examples/](https://www.geeksforgeeks.org/linkedhashset-clone-method-in-java-with-examples/)

[`LinkedHashSet`](https://www.geeksforgeeks.org/linkedhashset-in-java-with-examples/) 类的 `clone()` 方法用于返回上述哈希集的浅拷贝。它只是创建了一个集合的副本。
