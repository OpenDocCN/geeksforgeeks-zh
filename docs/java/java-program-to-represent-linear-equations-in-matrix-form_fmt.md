...
> 原文：[https://www.geeksforgeeks.org/java-program-to-represent-linear-equations-in-matrix-form/](https://www.geeksforgeeks.org/java-program-to-represent-linear-equations-in-matrix-form/)
...
1.  `Scanner`包应该导入到程序中，以便使用`Scanner`类的对象从用户处获取输入。
2.  数组将被初始化以存储方程的变量。
