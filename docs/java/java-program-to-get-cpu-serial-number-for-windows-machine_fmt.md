...
> 原文：[https://www.geeksforgeeks.org/java-program-to-get-cpu-serial-number-for-windows-machine/](https://www.geeksforgeeks.org/java-program-to-get-cpu-serial-number-for-windows-machine/)
...
*   这个类的构造函数假设默认字符编码和默认字节缓冲区大小是可以接受的。要自己指定这些值，请在 `FileOutputStream` 上构建一个输出流编写器。
...
public class GFG {
    ...
    {
        // Initially declaring and initializing an empty string
        String result = "";
        ...
        try {
            ...
            // Creating an object of FileWriter class to write on
            ...
            // Closing all file connections to release memory spaces
            fw.close();
    ...
    public static void main(String[] args)
    {
        ...
        // Calling the method1 to retrieve CPU serial number and printing the same
        System.out.println(
