...
> 原文: [https://www.geeksforgeeks.org/buffer-arrayoffset-method-in-java-with-examples/](https://www.geeksforgeeks.org/buffer-arrayoffset-method-in-java-with-examples/)
...
该方法返回该缓冲区数组中缓冲区第一个元素的偏移量。

## 异常

如果此缓冲区由数组支持但为只读，则此方法将抛出 `ReadOnlyBufferException`。
...
## 示例 2：为 ReadOnlyBufferException
...
[https://docs.oracle.com/javase/9/docs/api/java/nio/Buffer.html#arrayOffset--](https://docs.oracle.com/javase/9/docs/api/java/nio/Buffer.html#arrayOffset--)