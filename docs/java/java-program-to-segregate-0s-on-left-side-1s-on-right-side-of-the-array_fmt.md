...
[`sort()`](https://www.geeksforgeeks.org/arrays-sort-in-java-with-examples/) 是一个方法，是一个[`java.util.Arrays`](https://www.geeksforgeeks.org/array-class-in-java/)类方法。
...
保持左指针，当在数组中找到零时，与左指针的位置交换，并增加左指针。
