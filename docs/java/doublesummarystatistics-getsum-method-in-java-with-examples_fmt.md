...
> 原文: [https://www.geeksforgeks.org/doublesummarystatistics-getsum-method-in-java-with-examples/](https://www.geeksforgeks.org/doublesummarystatistics-getsum-method-in-java-with-examples/)
...
该方法返回 `DoubleSummaryStatistics` 中记录的总和。
...
[https://docs.oracle.com/javase/10/docs/api/java/util/DoubleSummaryStatistics.html#getSum()](https://docs.oracle.com/javase/10/docs/api/java/util/DoubleSummaryStatistics.html#getSum())