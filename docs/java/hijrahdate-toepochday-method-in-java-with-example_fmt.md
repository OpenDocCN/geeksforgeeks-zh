...
## 返回值
此方法返回当前回历日期和 1389-10-22 之间存在的纪元天数。
...
## 参考
[https://docs.oracle.com/javase/9/docs/api/java/time/chrono/HijrahDate.html#toEpochDay--](https://docs.oracle.com/javase/9/docs/api/java/time/chrono/HijrahDate.html#toEpochDay--)