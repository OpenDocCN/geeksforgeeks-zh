...
> 原文：[https://www.geeksforgeeks.org/how-to-save-data-to-the-firebase-realtime-database-in-android/](https://www.geeksforgeeks.org/how-to-save-data-to-the-firebase-realtime-database-in-android/)
...
在本文中，我们将构建一个简单的应用程序，在这个应用程序中，我们将借助一些文本字段从用户那里获取数据，并将这些数据存储在 `Firebase 实时数据库`中。请注意，我们使用的是 Firebase 实时数据库，该应用程序是使用 `JAVA` 语言编写的。
...
为了将多个数据发送到 Firebase 实时数据库，我们必须创建一个对象类，并将整个对象类发送到 Firebase。要创建一个对象类，导航到**应用程序 > java > 你的应用程序的包名 > 右键单击它，然后单击新建 > Java 类 > 给你的类命名**。我的情况是 `EmployeeInfo`，并在下面添加代码。
...
## Java Firebase 数据库集成示例

本文介绍如何使用 Java 语言（一种计算机语言，尤用于创建网站）将数据添加到 Firebase 实时数据库。
    ...
    private void addDatatoFirebase(String name, String phone, String address) {
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                // inside the method of on Data change we are setting our object class to our database reference.
