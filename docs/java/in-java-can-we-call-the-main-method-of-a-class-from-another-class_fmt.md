...
> 原文：[https://www.geeksforgeeks.org/in-java-can-we-call-the-main-method-of-a-class-from-another-class/](https://www.geeksforgeeks.org/in-java-can-we-call-the-main-method-of-a-class-from-another-class/)
...
### 错误 2：从其他地方调用 `main()` 方法时必须传递 `String[] args` 参数
...
### 错误 3：调用 `main()` 方法将导致无限循环，因为内存栈只知道运行 `main()` 方法
