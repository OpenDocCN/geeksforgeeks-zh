...
> 原文：[https://www.geeksforgeeks.org/convert-iterator-to-iterable-in-java/](https://www.geeksforgeeks.org/convert-iterator-to-iterable-in-java/)

给定一个迭代器，任务是将其转换为 Java 中的 `Iterable`。
