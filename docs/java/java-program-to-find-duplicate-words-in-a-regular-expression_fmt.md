...
> 原文：[https://www.geeksforgeeks.org/java-program-to-find-duplicate-words-in-a-regular-expression/](https://www.geeksforgeeks.org/java-program-to-find-duplicate-words-in-a-regular-expression/)

给定一个用字符串表示的表达式。任务是在 Java 的正则表达式中找到重复的元素。使用[映射](https://www.geeksforgeeks.org/map-interface-java-examples/)或[集合](https://www.geeksforgeeks.org/set-in-java/)数据结构来识别句子中单词的唯一性。
