# CopyOnWriteArraySet 中的 contains() 方法

> 原文: [https://www.geeksforgeeks.org/copyonwritearrayset-contains-method-in-java/](https://www.geeksforgeeks.org/copyonwritearrayset-contains-method-in-java/)

`contains()` 方法检查给定元素是否存在于集合中。
...
该方法接受一个强制参数 `o`，该参数指定要在集合中检查其是否存在的元素。

## 返回值

该方法返回 `true` 如果元素存在，否则返回 `false`。
...
[https://docs.oracle.com/javase/8/docs/api/java/util/concurrent/CopyOnWriteArraySet.html#contains-java.lang.Object-](https://docs.oracle.com/javase/8/docs/api/java/util/concurrent/CopyOnWriteArraySet.html#contains-java.lang.Object-)