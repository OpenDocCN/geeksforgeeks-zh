...
> 原文：[https://www.geeksforgeeks.org/java-program-to-print-all-unique-subsets-in-an-array-of-subsets-using-bit-manipulation/](https://www.geeksforgeeks.org/java-program-to-print-all-unique-subsets-in-an-array-of-subsets-using-bit-manipulation/)
...
*   空间复杂度：`O(n×2^n)` 来保持长度 `n` 的所有子集，因为每个 `n` 元素可能存在或不存在。
