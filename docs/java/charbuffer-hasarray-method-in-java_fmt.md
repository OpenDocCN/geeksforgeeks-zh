...
> 原文：[https://www.geeksforgeeks.org/charbuffer-hasarray-method-in-java/](https://www.geeksforgeeks.org/charbuffer-hasarray-method-in-java/)
...
当且仅当该缓冲区由数组支持且不是只读时，该方法将返回 `真`。否则返回 `假`。
