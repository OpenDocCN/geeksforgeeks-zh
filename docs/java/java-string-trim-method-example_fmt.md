...
> 原文：[https://www.geeksforgeeks.org/java-string-trim-method-example/](https://www.geeksforgeeks.org/java-string-trim-method-example/)
...
`trim()` 方法的返回类型为 `String`。它返回省略的字符串，没有前导和尾随空格。
