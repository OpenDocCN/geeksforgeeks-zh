...
> 原文：[https://www.geeksforgeeks.org/java-program-to-get-the-attributes-of-a-file/](https://www.geeksforgeeks.org/java-program-to-get-the-attributes-of-a-file/)
...
*   `java.nio.file`：这个包用来访问 `Files` 类，使用了内置的方法 `getPath()` 有助于获取 `path` 对象。
