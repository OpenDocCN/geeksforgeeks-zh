# Java 中的 Console.flush() 方法示例

> 原文：[https://www.geeksforgeeks.org/console-flush-method-in-java-with-examples/](https://www.geeksforgeeks.org/console-flush-method-in-java-with-examples/)
...
以下程序说明了 `IO` 包中 `Console` 类的 `flush()` 方法：
