...
### 1. Java Program to create a ImagePattern from a image and apply it to the rectangle
...
### 2. Java Program to create an ImagePattern form an image, set the x, y coordinate, its height and width, and whether it is proportional or not and apply it to the rectangle
