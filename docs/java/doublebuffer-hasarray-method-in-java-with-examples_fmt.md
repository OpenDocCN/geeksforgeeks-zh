...
> 原文: [https://www.geeksforgeeks.org/doublebuffer-hasarray-method-in-java-with-examples/](https://www.geeksforgeeks.org/doublebuffer-hasarray-method-in-java-with-examples/)
...
如果且仅当该缓冲区由数组支持且不是只读的，则该方法将返回 `true`。否则它返回 `false`。
