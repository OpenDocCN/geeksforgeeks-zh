...
> 原文: [https://www.geeksforgeeks.org/list-size-method-in-java-with-examples/](https://www.geeksforgeeks.org/list-size-method-in-java-with-examples/)

Java 中[列表接口](https://www.geeksforgeeks.org/list-interface-java-examples/)的 `size()` 方法用于获取该列表中的元素个数。也就是说，此方法返回此列表容器中存在的元素的计数。
