...
> 原文：[https://www.geeksforgeeks.org/format-specifiers-in-different-programming-languages/](https://www.geeksforgeeks.org/format-specifiers-in-different-programming-languages/)
...
在 C 语言编程中，我们使用 `scanf()` 进行格式化输入，使用 `printf()` 进行格式化输出，[`get()`](https://www.geeksforgeeks.org/difference-getchar-getch-getc-getche/) 或 [`getchar()`](https://www.geeksforgeeks.org/difference-getchar-getch-getc-getche/) 进行未格式化输入，[`put()`](https://www.geeksforgeeks.org/putchar-function-in-c/) 或 [`putchar()`](https://www.geeksforgeeks.org/putchar-function-in-c/) 进行未格式化输出。
