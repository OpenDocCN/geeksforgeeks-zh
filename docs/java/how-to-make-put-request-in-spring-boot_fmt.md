# 如何在 Spring Boot 进行 PUT 请求？

> 原文：[https://www.geeksforgeeks.org/how-to-make-put-request-in-spring-boot/](https://www.geeksforgeeks.org/how-to-make-put-request-in-spring-boot/)
...
转到 `src->main->java->com.gfg.spring.boot.app`，创建一个名为 `Controller` 的 Java 类，并添加注释 `@RestController`。现在创建一个如下所示的 put API：
...
现在去 [Postman](https://www.geeksforgeeks.org/introduction-postman-api-development/) 添加网址并发出 PUT 请求，如下图所示：
