...
> 原文：[https://www.geeksforgeeks.org/java-program-to-implement-priorityblockingqueue-api/](https://www.geeksforgeeks.org/java-program-to-implement-priorityblockingqueue-api/)
...
它实现了 `Serializable`、`Iterable<E>`、`Collection<E>`、`BlockingQueue<E>`、`Queue<E>` 接口，并扩展了 `AbstractQueue<E>` 类。
