...
1.  `TabPane()`: 创建一个没有选项卡的新选项卡窗格。
2.  `TabPane(Tab... t)`: 用指定的选项卡创建一个新的选项卡面板。
...
| `getTabs()` | 返回选项卡窗格的选项卡。 |
| `setSide(Side v)` | 在此选项卡窗格中放置选项卡的位置。 |
| `setSelectionModel(SingleSelectionModel v)` | 设置用于选项卡选择的模型。 |
| `getSelectionModel()` | 返回选项卡选择的选择模型。 |
| `getTabMaxHeight()` | 返回选项卡窗格中选项卡的最大高度。 |
| `getTabMinHeight()` | 返回选项卡窗格中选项卡的最小高度。 |
| `getTabMaxWidth()` | 返回选项卡窗格中选项卡的最大宽度。 |
| `getTabMinWidth()` | 返回选项卡窗格中选项卡的最小宽度。 |
| `setTabMaxHeight(double v)` | 设置选项卡窗格中选项卡的最大高度。 |
| `setTabMinHeight(double v)` | 设置选项卡窗格中选项卡的最小高度。 |
| `setTabMaxWidth(double v)` | 设置选项卡窗格中选项卡的最大宽度。 |
| `setTabMinWidth(double v)` | 设置选项卡窗格中选项卡的最小宽度。 |
...
**参考:** [https://docs.oracle.com/javase/8/javafx/api/javafx/scene/control/TabPane.html](https://docs.oracle.com/javase/8/javafx/api/javafx/scene/control/TabPane.html)