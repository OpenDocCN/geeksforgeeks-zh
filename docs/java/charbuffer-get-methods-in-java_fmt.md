...
> 原文: [https://www.geeksforgeeks.org/charbuffer-get-methods-in-java/](https://www.geeksforgeeks.org/charbuffer-get-methods-in-java/)
...
此方法抛出 `BufferUnderflowException` – 如果缓冲区的当前位置不小于其限制，则抛出此异常。
