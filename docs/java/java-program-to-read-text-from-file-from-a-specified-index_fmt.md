...
> 原文：[https://www.geeksforgeeks.org/java-program-to-read-text-from-file-from-a-specified-index/](https://www.geeksforgeeks.org/java-program-to-read-text-from-file-from-a-specified-index/)
...
public class GFG {
    ...
    public static void main(String args[]) {
        try {
            ...
            // discards 7 bytes of data from the input stream.
            fin.skip(7);
