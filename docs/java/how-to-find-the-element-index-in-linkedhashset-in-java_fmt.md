...
> 原文: [https://www.geeksforgeeks.org/how-to-find-the-element-index-in-linkedhashset-in-java/](https://www.geeksforgeeks.org/how-to-find-the-element-index-in-linkedhashset-in-java/)
...
通过将 `LinkedHashSet` 转换为 [`ArrayList`](https://www.geeksforgeeks.org/arraylist-in-java/) 来查找 Java 中 `LinkedHashSet` 中的元素索引，过程分为两部分:
...
使用数组在 Java 中查找 `LinkedHashSet` 中的元素索引，过程分为两部分:

1.  使用 [`toArray()`](https://www.geeksforgeeks.org/linkedhashset-toarray-method-in-java-with-example/) 方法将链接的哈希集转换为数组。
