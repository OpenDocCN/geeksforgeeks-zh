# 寻找前 N 个奇数与偶数之和的 Java 程序

> 原文: [https://www.geeksforgeeks.org/java-program-to-find-the-sum-of-first-n-odd-even-numbers/](https://www.geeksforgeeks.org/java-program-to-find-the-sum-of-first-n-odd-even-numbers/)
