...
> 原文: [https://www.geeksforgeeks.org/double-floatvalue-in-java-with-examples/](https://www.geeksforgeeks.org/double-floatvalue-in-java-with-examples/)
...
**返回类型:** 它返回一个 `float` 值，即 `DoubleObject` 的类型铸造值。
