...
> 原文：[https://www.geeksforgeeks.org/navigablemap-ceilingkey-method-in-java/](https://www.geeksforgeeks.org/navigablemap-ceilingkey-method-in-java/)

Java 中`NavigableMap`接口的`ceilingKey()`方法用于返回大于等于给定键的最小键，如果不存在这样的键，则返回`null`。
...
接受单个参数`key`，该键是要映射的键，属于该集合接受的键类型。
...
[https://docs.oracle.com/javase/10/docs/api/java/util/NavigableMap.html#ceilingKey(K)](https://docs.oracle.com/javase/10/docs/api/java/util/NavigableMap.html#ceilingKey(K))