...
> 原文：[https://www.geeksforgeeks.org/how-to-get-city-and-state-name-from-pincode-in-android/](https://www.geeksforgeeks.org/how-to-get-city-and-state-name-from-pincode-in-android/)
...
导航至应用程序 > `AndroidManifest.xml` 文件，并添加以下权限。
