...
该函数接受一个参数`newVal`，这是该十进制格式实例允许设置的最大整数位数的新值。
...
[https://docs . Oracle . com/javase/7/docs/API/Java/text/decimal format . html # setmaximumintegergits(int)](https://docs.oracle.com/javase/7/docs/api/java/text/DecimalFormat.html#setMaximumIntegerDigits(int))