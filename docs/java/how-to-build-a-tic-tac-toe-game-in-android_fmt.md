...
> 原文: [https://www.geeksforgeeks.org/how-to-build-a-tic-tac-toe-game-in-android/](https://www.geeksforgeeks.org/how-to-build-a-tic-tac-toe-game-in-android/)
...
**添加图片:** 所有图片如下。将它们保存在资源中的可绘制文件夹中。转到 `app > res > drawable` 并粘贴以下文件:

*   [grid](https://media.geeksforgeeks.org/wp-content/uploads/20201230114433/grid-300x300.png)
