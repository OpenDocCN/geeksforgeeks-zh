...
> 原文: [https://www.geeksforgeeks.org/convert-array-to-hashset-in-java/](https://www.geeksforgeeks.org/convert-array-to-hashset-in-java/)
...
`HashSet` 构造函数可以取另一个集合对象来构造包含指定数组元素的新集合。
