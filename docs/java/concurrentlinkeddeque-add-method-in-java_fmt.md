...
> 原文: [https://www.geeksforgeeks.org/concurrentlinkeddeque-add-method-in-java/](https://www.geeksforgeeks.org/concurrentlinkeddeque-add-method-in-java/)

`java.util.concurrent.ConcurrentLinkedDeque.add()` 是 Java 中的一个内置函数，它在 deque 的末尾插入指定的元素。
...
该方法只接受单个参数 `elem`，该参数将被添加到并发链接请求的尾部。
...
当 `null` 作为参数传递给函数时，该程序涉及带有异常处理的字符串类型的并发链接请求。
...
[https://docs.oracle.com/javase/7/docs/api/java/util/concurrent/ConcurrentLinkedDeque.html#add(java.lang.Object)](https://docs.oracle.com/javase/7/docs/api/java/util/concurrent/ConcurrentLinkedDeque.html#add(java.lang.Object))