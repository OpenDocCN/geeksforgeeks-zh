...
[番石榴的大整数类](https://www.geeksforgeeks.org/bigintegermath-class-guava-java/)的`ceilingPowerOfTwo(BigInteger x)`方法返回大于或等于`x`的2的最小幂，这相当于`BigInteger.valueOf(2).pow(log2(x, ceiling))`。
...
## 异常:
如果`x <= 0`，此方法抛出`IllegalArgumentException`。
...
## 参考:
[https://Google . github . io/guava/releases/21.0/API/docs/com/Google/common/math/bigintermath . html # ceilingPowerOfTwo-Java . math . biginger-](https://google.github.io/guava/releases/21.0/api/docs/com/google/common/math/BigIntegerMath.html#ceilingPowerOfTwo-java.math.BigInteger-)