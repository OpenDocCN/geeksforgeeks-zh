# Java中的AlgorithmParametersGenerator.generateParameters()方法示例

> 原文：[https://www.geeksforgeeks.org/algorithmparametergenerator-generateparameters-method-in-java-with-examples/](https://www.geeksforgeeks.org/algorithmparametergenerator-generateparameters-method-in-java-with-examples/)

使用`Java.security.AlgorithmParametersGenerator`类的`generateParameters()`方法来生成参数。
...
该方法返回新的`AlgorithmParameters`对象。
