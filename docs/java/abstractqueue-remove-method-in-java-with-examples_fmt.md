...
> 原文: [https://www.geeksforgeeks.org/abstractqueue-remove-method-in-java-with-examples/](https://www.geeksforgeeks.org/abstractqueue-remove-method-in-java-with-examples/)
...
## 参考:
[https://docs.oracle.com/javase/8/docs/api/java/util/AbstractQueue.html#remove--](https://docs.oracle.com/javase/8/docs/api/java/util/AbstractQueue.html#remove--)