...
> 原文: [https://www.geeksforgeeks.org/how-to-add-textswitcher-with-animation-in-android-using-java/](https://www.geeksforgeeks.org/how-to-add-textswitcher-with-animation-in-android-using-java/)

一个 [`TextSwitcher`](https://developer.android.com/reference/android/widget/TextSwitcher) 用于在屏幕上激活文本。它是 [`ViewSwitcher`](https://developer.android.com/reference/android/widget/ViewSwitcher) 类的子类。它只包含一个 `TextView` 类型的子级。为了在 `TextSwitcher` 上设置动画，我们必须添加动画标签，或者我们可以编程添加。以下是 `TextSwitcher` 的一些用法:

*   **在日期选择器中更改数字**
*   **Countdown of timer clock**

`TextSwitcher` 使用两种类型的动画:
