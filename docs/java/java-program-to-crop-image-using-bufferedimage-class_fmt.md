...
> 原文：[https://www.geeksforgeeks.org/java-program-to-crop-image-using-bufferedimage-class/](https://www.geeksforgeeks.org/java-program-to-crop-image-using-bufferedimage-class/)
...
1.  更改图像的尺寸
2.  使用 `BufferedImage` 类和 `Color` 的一些内置方法
