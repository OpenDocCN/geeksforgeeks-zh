...
> 原文: [https://www.geeksforgeeks.org/scipy-linear-algebra-scipy-linalg/](https://www.geeksforgeeks.org/scipy-linear-algebra-scipy-linalg/)
...
`linalg.solve` 函数用于求解给定的线性方程。它用于自动评估方程和寻找未知变量的值。

> **语法:** `scipy.linalg.solve(a, b, sym_pos, lower, overwrite_a, overwrite_b, debug, check_finite, assume_a, trans)`
...
> **语法:** `scipy.linalg.inv(a, overwrite_a, check_finite)`
>
> **参数:**
>
> *   `a`: 是正方形矩阵。
> *   `overwrite_a` (**可选**): 丢弃方块矩阵中的数据。
> *   `check_finite` (**可选**): 检查输入矩阵是否只包含有限个数。
>
> **返回:**
>
...
> **语法:** `scipy.linalg.pinv(a, cond, rcond, return_rank, check_finite)`
>
> **参数:**
>
> *   `a`: 是输入矩阵。
...
> *   `check_finite` (**可选**): 它检查输入矩阵是否只由有限个数字组成。
>
> **返回:**
>
