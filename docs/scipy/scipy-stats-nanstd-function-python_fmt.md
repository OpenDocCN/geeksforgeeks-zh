# scipy.stats.nanstd() 函数 | Python

> 原文: [https://www.geeksforgeeks.org/scipy-stats-nanstd-function-python/](https://www.geeksforgeeks.org/scipy-stats-nanstd-function-python/)
...
> **参数:**
> `array`: 输入数组或对象，其元素包含用于计算标准差的 NAN 值。
> `axis`: 计算标准偏差的轴。默认情况下，`axis=0`。
>
