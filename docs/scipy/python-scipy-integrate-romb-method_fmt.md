...
> 原文: [https://www.geeksforgeeks.org/python-scipy-integrate-romb-method/](https://www.geeksforgeeks.org/python-scipy-integrate-romb-method/)

借助`scipy.integrate.romb()`方法，我们可以利用函数从极限 a 到极限 b 的样本，得到龙贝格积分。
