...
> 原文: [https://www.geeksforgeeks.org/scipy-stats-zmap-function-python/](https://www.geeksforgeeks.org/scipy-stats-zmap-function-python/)
...
- `scores`: 【array_like】输入要计算 Z 分数的数组或对象。
- `compare`: 【array_like】输入数组或对象，对其取归一化的平均值和标准偏差。
