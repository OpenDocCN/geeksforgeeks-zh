...
> 原文: [https://www.geeksforgeeks.org/python-scipy-stats-halfgennorm-logpdf-method/](https://www.geeksforgeeks.org/python-scipy-stats-halfgennorm-logpdf-method/)

借助 `stats.halfgennorm.logpdf()` 方法，可以得到概率密度函数的对数值。
