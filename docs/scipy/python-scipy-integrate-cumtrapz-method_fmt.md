# Python Scipy integrate.cumtrapz() 方法

> 原文：[https://www.geeksforgeeks.org/python-scipy-integrate-cumtrapz-method/](https://www.geeksforgeeks.org/python-scipy-integrate-cumtrapz-method/)

借助 `scipy.integrate.cumtrapz()` 方法，利用复合梯形法则可以得到 `y(x)` 的累积积分值。
