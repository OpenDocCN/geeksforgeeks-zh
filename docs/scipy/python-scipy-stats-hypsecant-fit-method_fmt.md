...
> 原文: [https://www.geeksforgeeks.org/python-scipy-stats-hypsecant-fit-method/](https://www.geeksforgeeks.org/python-scipy-stats-hypsecant-fit-method/)

借助`stats.hypsecant.fit()`方法，我们可以利用该方法得到一般数据的参数估计。
