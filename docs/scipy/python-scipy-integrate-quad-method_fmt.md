...
> 原文: [https://www.geeksforgeeks.org/python-scipy-integrate-quad-method/](https://www.geeksforgeeks.org/python-scipy-integrate-quad-method/)

借助`scipy.integrate.quad()`方法，可以得到给定函数从极限`a`到极限`b`的积分。
