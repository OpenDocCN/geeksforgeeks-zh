...
> 原文: [https://www.geeksforgeeks.org/scipy-stats-genlogistic-python/](https://www.geeksforgeeks.org/scipy-stats-genlogistic-python/)

`scipy.stats.genlogistic()` 是一个广义 logistic 连续随机变量，用标准格式和一些形状参数来定义，以完成其规格。
