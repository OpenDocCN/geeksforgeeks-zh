...
> 原文: [https://www.geeksforgeeks.org/scipy-stats-gmean-function-python/](https://www.geeksforgeeks.org/scipy-stats-gmean-function-python/)
...
> **参数:**
> `array`: 输入具有计算几何平均值元素的数组或对象。
> `axis`: 计算平均值的轴。默认`axis=0`。
> `dtype`: 设置返回元素的类型。
