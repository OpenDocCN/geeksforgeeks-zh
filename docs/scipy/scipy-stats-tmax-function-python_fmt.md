...
> 原文: [https://www.geeksforgeeks.org/scipy-stats-tmax-function-python/](https://www.geeksforgeeks.org/scipy-stats-tmax-function-python/)
...
- **轴**: 轴，统计数据将沿着该轴计算。默认 `axis=0`。
- **限制**: 考虑数组的下限和上限，小于下限或大于上限的值将被忽略。如果限制为 `None` [默认值]，则使用所有值。
