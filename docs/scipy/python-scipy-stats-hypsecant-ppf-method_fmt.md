...
> 原文: [https://www.geeksforgeeks.org/python-scipy-stats-hypsecant-ppf-method/](https://www.geeksforgeeks.org/python-scipy-stats-hypsecant-ppf-method/)

借助`stats.hypsecant.ppf()`方法，我们可以得到百分点函数的值，即逆(cdf)。
