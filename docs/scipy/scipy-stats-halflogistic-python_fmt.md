...
> 原文: [https://www.geeksforgeeks.org/scipy-stats-halflogistic-python/](https://www.geeksforgeeks.org/scipy-stats-halflogistic-python/)

`scipy.stats.halflogistic()` 是一个半 logistic 连续随机变量，用标准格式和一些形状参数定义，以完成其规格。
