...
> 原文: [https://www.geeksforgeeks.org/python-scipy-stats-hypsecant-logsf-method/](https://www.geeksforgeeks.org/python-scipy-stats-hypsecant-logsf-method/)

借助`stats.hypsecant.logsf()`方法，可以得到生存函数的对数值，即**对数(1–CDF)**。
