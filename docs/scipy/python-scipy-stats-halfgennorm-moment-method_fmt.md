...
> 原文: [https://www.geeksforgeeks.org/python-scipy-stats-halfgennorm-moment-method/](https://www.geeksforgeeks.org/python-scipy-stats-halfgennorm-moment-method/)

借助`stats.halfgennorm.moment()`方法，可以得到 n 阶非中心矩的值。
