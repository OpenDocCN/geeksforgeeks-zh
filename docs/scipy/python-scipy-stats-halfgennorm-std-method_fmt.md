# Python | Scipy stats.halfgennorm.std()方法

> 原文：[https://www.geeksforgeeks.org/python-scipy-stats-halfgennorm-std-method/](https://www.geeksforgeeks.org/python-scipy-stats-halfgennorm-std-method/)
