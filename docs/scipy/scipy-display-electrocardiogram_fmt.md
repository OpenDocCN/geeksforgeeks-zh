...
> 原文: [https://www.geeksforgeeks.org/scipy-display-electrocardiogram/](https://www.geeksforgeeks.org/scipy-display-electrocardiogram/)
...
在 Python 中使用 Scipy，我们可以通过使用 `scipy.misc.electrocardiogram()` 来生成心电图。它用于加载心电图，将只返回一维信号。返回的信号是 5 分钟长的心电图，这是心脏电活动的医学记录，它基本上返回一个 n 维数组。
