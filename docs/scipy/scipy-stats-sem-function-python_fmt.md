...
> 原文: [https://www.geeksforgeeks.org/scipy-stats-sem-function-python/](https://www.geeksforgeeks.org/scipy-stats-sem-function-python/)

`scipy.stats.sem(arr, axis=0, ddof=0)` 函数用于计算输入数据平均值的标准误差。

## 参数

- `arr`: 【`array_like`】输入具有计算标准误差的元素的数组或对象。
