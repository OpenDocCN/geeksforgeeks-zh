# Python | Scipy integrate.dblquad()方法

> 原文: [https://www.geeksforgeeks.org/python-scipy-integrate-dblquad-method/](https://www.geeksforgeeks.org/python-scipy-integrate-dblquad-method/)

## 方法介绍

借助`scipy.integrate.dblquad()`方法，可以得到给定函数从极限 a 到极限 b 的二重积分。
