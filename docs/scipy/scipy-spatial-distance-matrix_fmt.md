...
> 原文: [https://www.geeksforgeeks.org/scipy-spatial-distance-matrix/](https://www.geeksforgeeks.org/scipy-spatial-distance-matrix/)

距离矩阵包含矩阵向量之间成对计算的距离。`scipy.spatial`包为我们提供了`distance_matrix()`计算距离矩阵的方法。通常矩阵是二维数组的形式，矩阵的向量是矩阵行（一维数组）。
