...
> 原文: [https://www.geeksforgeeks.org/scipy-stats-genhalflogistic-python/](https://www.geeksforgeeks.org/scipy-stats-genhalflogistic-python/)

`scipy.stats.genhalflogistic()` 是一个广义的半 logistic 连续随机变量，用标准格式和一些形状参数来定义，以完成其规格。
