...
> 原文: [https://www.geeksforgeeks.org/design-iir-bandpass-chebyshev-type-1-filter-using-scipy-python/](https://www.geeksforgeeks.org/design-iir-bandpass-chebyshev-type-1-filter-using-scipy-python/)
...
切比雪夫Ⅰ型通过在通带中加入相等的纹波，将整个通带内理想和实际频率响应之间的绝对差异降至最小。
