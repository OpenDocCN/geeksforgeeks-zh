...
> 原文：[https://www.geeksforgeeks.org/how-to-truncate-a-file-in-golang/](https://www.geeksforgeeks.org/how-to-truncate-a-file-in-golang/)

在 Go 语言中，您可以借助 `Truncate()` 函数来截断文件的大小。该函数用于以指定的大小截断给定文件的大小。
