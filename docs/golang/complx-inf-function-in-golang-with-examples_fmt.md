...
> 原文: [https://www.geeksforgeeks.org/complx-inf-function-in-golang-with-examples/](https://www.geeksforgeeks.org/complx-inf-function-in-golang-with-examples/)

`Inf()` 函数用来返回一个复无穷，即复数 `(+Inf, +Inf)`。要使用此功能，必须导入 `math/cmplx` 包。
