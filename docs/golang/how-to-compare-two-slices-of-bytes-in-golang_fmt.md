...
> 原文：[https://www.geeksforgeeks.org/how-to-compare-two-slices-of-bytes-in-golang/](https://www.geeksforgeeks.org/how-to-compare-two-slices-of-bytes-in-golang/)
...
这个函数是在 `bytes` 包下定义的，所以你必须在程序中导入 `bytes` 包来访问 `比较` 函数。
