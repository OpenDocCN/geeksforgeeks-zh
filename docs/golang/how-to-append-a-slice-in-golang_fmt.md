...
> 原文：[https://www.geeksforgeeks.org/how-to-append-a-slice-in-golang/](https://www.geeksforgeeks.org/how-to-append-a-slice-in-golang/)
...
我们知道，零值切片类型是零，这种类型切片的容量和长度是 0。但是在 `append` 函数的帮助下，可以将值追加到 `nil` 切片中。
