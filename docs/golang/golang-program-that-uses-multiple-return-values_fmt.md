...
> 原文: [https://www.geeksforgeeks.org/golang-program-that-uses-multiple-return-values/](https://www.geeksforgeeks.org/golang-program-that-uses-multiple-return-values/)
