# fmt.Sprint() 函数示例（Golang）

> 原文：[https://www.geeksforgeeks.org/fmt-sprint-function-in-golang-with-examples/](https://www.geeksforgeeks.org/fmt-sprint-function-in-golang-with-examples/)
