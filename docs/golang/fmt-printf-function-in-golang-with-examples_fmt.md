# fmt.Printf() 函数示例 (Golang)

> 原文: [https://www.geeksforgeks.org/fmt-printf-function-in-golang-with-examples/](https://www.geeksforgeks.org/fmt-printf-function-in-golang-with-examples/)
