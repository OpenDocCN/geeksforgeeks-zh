...
> 原文：[https://www.geeksforgeeks.org/how-to-fetch-an-integer-variable-as-string-in-golang/](https://www.geeksforgeeks.org/how-to-fetch-an-integer-variable-as-string-in-golang/)
...
### 3. `strconv.FormatUint()`
返回给定基数中 `x` 的字符串表示，即 `2 <= 基数 <= 36`。
