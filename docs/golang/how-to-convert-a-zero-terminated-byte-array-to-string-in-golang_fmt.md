...
> 原文：[https://www.geeksforgeeks.org/how-to-convert-a-zero-terminated-byte-array-to-string-in-golang/](https://www.geeksforgeeks.org/how-to-convert-a-zero-terminated-byte-array-to-string-in-golang/)
...
它也用于将以零结尾的字节数组转换为字符串。但是性能不如前面的功能。
