# 如何在 Golang 中获取 Float64 型随机数？

> 原文：[https://www.geeksforgeeks.org/how-to-get-float64-type-random-number-in-golang/](https://www.geeksforgeeks.org/how-to-get-float64-type-random-number-in-golang/)
...
在 `math/rand` 软件包提供的 `Float64()` 函数的帮助下，您可以从默认来源生成一个 `float64` 的伪随机数 in [0.0，1.0]。因此，您需要借助 `import` 关键字在程序中添加一个 `math/rand` 包。
