...
> 原文：[https://www.geeksforgeeks.org/how-to-sort-a-slice-of-ints-in-golang/](https://www.geeksforgeeks.org/how-to-sort-a-slice-of-ints-in-golang/)
...
Go 语言允许您根据切片的类型对其元素进行排序。因此，使用以下函数对 `int` 类型的切片进行排序。这些函数是在 `sort` 包下定义的，因此您必须在程序中导入 `sort` 包来访问这些函数：
