...
> 原文: [https://www.geeksforgeeks.org/how-to-get-current-weekday-in-golang/](https://www.geeksforgeeks.org/how-to-get-current-weekday-in-golang/)
...
## 示例 1
在这个示例中，我们可以看到通过使用`time.Now().Weekday()`函数，我们能够得到工作日。
