...
> 原文：[https://www.geeksforgeeks.org/how-to-pause-the-execution-of-current-goroutine/](https://www.geeksforgeeks.org/how-to-pause-the-execution-of-current-goroutine/)
...
此功能暂停当前 goroutine 至少指定的持续时间，完成指定的持续时间后，goroutine 自动唤醒并恢复工作。如果该函数的值为负或零，则该函数立即返回。它是在 `time` 包下定义的，所以你必须在你的程序中导入 `time` 包来访问睡眠功能。
