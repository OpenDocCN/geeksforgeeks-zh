...
> 原文: [https://www.geeksforgeeks.org/python-vs-other-programming-languages/](https://www.geeksforgeeks.org/python-vs-other-programming-languages/)
...
*   **集成和解释语言:** Python 是一种解释语言，因为 Python 代码一次一行地执行。Python 另外是一种集成语言，因为人们可以不用太多的扩展就可以将 `python` 与另一种语言集成在一起，如 [**c++**](https://www.geeksforgeeks.org/c-plus-plus/) 等等。
