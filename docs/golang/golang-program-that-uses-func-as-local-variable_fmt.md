...
> 原文：[https://www.geeksforgeeks.org/golang-program-that-uses-func-as-local-variable/](https://www.geeksforgeeks.org/golang-program-that-uses-func-as-local-variable/)
