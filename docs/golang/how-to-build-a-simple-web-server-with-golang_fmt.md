...
> 原文: [https://www.geeksforgeeks.org/how-to-build-a-simple-web-server-with-golang/](https://www.geeksforgeeks.org/how-to-build-a-simple-web-server-with-golang/)
...
创建一个包含 `.go` 文件的项目文件夹，例如 `server.go`。
...
`http://localhost:5000/` 或 `http://localhost:5000/hi`
