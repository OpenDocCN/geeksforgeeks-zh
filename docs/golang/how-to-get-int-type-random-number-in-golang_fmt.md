...
> 原文：[https://www.geeksforgeeks.org/how-to-get-int-type-random-number-in-golang/](https://www.geeksforgeeks.org/how-to-get-int-type-random-number-in-golang/)
...
在 `math/rand` 包提供的 `Int()` 函数的帮助下，您可以从默认来源生成整数类型的非负伪随机数。因此，您需要在程序中添加一个 `math/rand` 包，借助 `import` 关键字来访问 `Int()` 函数。
