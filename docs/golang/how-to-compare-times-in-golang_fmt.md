...
> 原文: [https://www.geeksforgeeks.org/how-to-compare-times-in-golang/](https://www.geeksforgeeks.org/how-to-compare-times-in-golang/)
...
在这个示例中，我们可以看到，通过使用`Before()`和`After()`函数，我们可以使用这些函数来比较日期。
