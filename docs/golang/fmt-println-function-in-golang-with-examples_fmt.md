# fmt.Println() 函数示例（Golang）

> 原文：[https://www.geeksforgeeks.org/fmt-println-function-in-golang-with-examples/](https://www.geeksforgeeks.org/fmt-println-function-in-golang-with-examples/)
...
在上面的代码中，可以看到函数 `Println()` 在指定的字符串中没有包含任何空格，仍然在输出中打印了空格，这可以从上面的输出中看到。
