...
> 原文：[https://www.geeksforgeeks.org/how-to-rename-and-move-a-file-in-golang/](https://www.geeksforgeeks.org/how-to-rename-and-move-a-file-in-golang/)
...
*   它是在 `os` 包下定义的，所以您必须在程序中导入 `os` 包才能访问 `Remove()` 函数。
