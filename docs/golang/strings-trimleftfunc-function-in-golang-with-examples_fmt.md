...
> Original: `https://www.geeksforgeeks.org/strings-trimleftfunc-function-in-golang-with-examples/`

`strings.TrimLeftFunc()`函数返回字符串`s`的片段，其中删除了满足`f(c)`的所有前导Unicode代码点`c`。
