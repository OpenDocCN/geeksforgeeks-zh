...
> 原文：[https://www.geeksforgeeks.org/multiple-interfaces-in-golang/](https://www.geeksforgeeks.org/multiple-interfaces-in-golang/)
...
如上例所示，我们有两个带方法的接口，即 `details()` 和 `articles()`。在这里，`details()` 方法提供了作者的基本细节，`articles()` 方法提供了作者的未决文章。
