...
> 原文：[https://www.geeksforgeeks.org/fmt-fprint-function-in-golang-with-examples/](https://www.geeksforgeeks.org/fmt-fprint-function-in-golang-with-examples/)
...
*   `a ...interface{}`：用于包含一些字符串或常量变量的代码中。
