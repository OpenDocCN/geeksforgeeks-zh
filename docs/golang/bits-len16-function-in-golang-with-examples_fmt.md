# bits.Len16() 在 Golang 中的作用及示例

> 原文：[https://www.geeksforgeks.org/bits-len16-function-in-golang-with-examples/](https://www.geeksforgeks.org/bits-len16-function-in-golang-with-examples/)
