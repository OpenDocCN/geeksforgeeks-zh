# io包中的NewSectionReader()函数及示例

> 原文：`https://www.geeksforgeeks.org/io-newsectionreader-function-in-golang-with-examples/`
...
它返回一个`SectionReader`，从指定的读取器“r”读取，该读取器从指定的偏移量“off”开始，以 EOF 结束，即在给定的“n”字节数后的文件结束。
