...
> 原文: [https://www.geeksforgeeks.org/command-line-arguments-in-golang/](https://www.geeksforgeeks.org/command-line-arguments-in-golang/)
...
尽量使用离线编译器，效果更好。将以下文件保存为 `cmdargs1.go`
