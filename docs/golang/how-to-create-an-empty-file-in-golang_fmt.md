...
> 原文: [https://www.geeksforgeeks.org/how-to-create-an-empty-file-in-golang/](https://www.geeksforgeeks.org/how-to-create-an-empty-file-in-golang/)
...
*   它是在 `os` 包下定义的，所以您必须在程序中导入 `os` 包才能访问 `Create()` 函数。
