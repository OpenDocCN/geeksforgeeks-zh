...
> 原文: [https://www.geeksforgeeks.org/how-to-read-a-file-line-by-line-to-string-in-golang/](https://www.geeksforgeeks.org/how-to-read-a-file-line-by-line-to-string-in-golang/)

## 使用 `bufio` 包扫描仪

逐行读取文件。让文本文件命名为 `sample.txt`，文件内部内容如下:
