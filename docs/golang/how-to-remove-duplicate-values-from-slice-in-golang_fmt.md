...
> 原文: [https://www.geeksforgeeks.org/how-to-remove-duplicate-values-from-slice-in-golang/](https://www.geeksforgeeks.org/how-to-remove-duplicate-values-from-slice-in-golang/)

[数组](https://www.geeksforgeeks.org/arrays-in-go/)是一种数据结构。同样，在 Golang 中，我们有比数组更灵活、更强大、更轻量级和更方便的切片。由于[切片](https://www.geeksforgeeks.org/slices-in-golang/)比数组更灵活，因此其灵活性取决于其大小。就像数组一样，它有索引值和长度，但是它的大小不是固定的。当我们声明一个切片时，我们不指定它的大小。
...
在这里，我们将看到如何从切片中移除重复的元素。我们已经定义了一个传递切片值的函数，并使用映射函数来检查和删除重复的值。
