...
> 原文：[https://www.geeksforgeeks.org/function-returning-multiple-values-in-go-language/](https://www.geeksforgeeks.org/function-returning-multiple-values-in-go-language/)
...
这里，`name1` 和 `name2` 是返回值的名称，`para1` 和 `para2` 是函数的参数。
