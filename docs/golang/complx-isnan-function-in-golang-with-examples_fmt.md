# Golang `cmplx.IsNaN()` 函数示例

> 原文: [https://www.geeksforgeeks.org/complx-isnan-function-in-golang-with-examples/](https://www.geeksforgeeks.org/complx-isnan-function-in-golang-with-examples/)
