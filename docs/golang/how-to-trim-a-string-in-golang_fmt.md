...
> 原文：[https://www.geeksforgeeks.org/how-to-trim-a-string-in-golang/](https://www.geeksforgeeks.org/how-to-trim-a-string-in-golang/)
...
此函数用于修剪字符串中所有在此函数中指定的前导和尾随 Unicode 代码点。
...
此函数用于修剪字符串的左侧（在函数中指定）Unicode 代码点。
...
此函数用于修剪字符串的右侧（在函数中指定）Unicode 代码点。
...
此方法用于从给定字符串中修剪尾部后缀字符串。如果给定的字符串不包含指定的后缀字符串，则此函数返回原始字符串，不做任何更改。
...
该方法用于从给定字符串中修剪前导前缀字符串。如果给定的字符串不包含指定的前缀字符串，则此函数返回原始字符串，不做任何更改。
