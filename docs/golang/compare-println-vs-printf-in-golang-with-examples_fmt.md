...
> 原文: [https://www.geeksforgeeks.org/compare-println-vs-printf-in-golang-with-examples/](https://www.geeksforgeeks.org/compare-println-vs-printf-in-golang-with-examples/)

`Println` 和 `Printf` 是在 Golang 中打印输出的函数。两者都存在于包 `fmt` 内。但是，这两个函数提供的输出不同，如下所示:
