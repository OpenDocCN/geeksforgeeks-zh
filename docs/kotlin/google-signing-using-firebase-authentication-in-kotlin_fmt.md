...
> 原文：[https://www.geeksforgeeks.org/google-signing-using-firebase-authentication-in-kotlin/](https://www.geeksforgeeks.org/google-signing-using-firebase-authentication-in-kotlin/)
...
#### 第七步：使用 `activity_dashboard.xml` 文件
...
#### 第八步：使用 `DashboardActivity.kt` 文件
