...
> 原文：[https://www.geeksforgeeks.org/how-to-make-a-scientific-calculator-android-app-using-android-studio/](https://www.geeksforgeeks.org/how-to-make-a-scientific-calculator-android-app-using-android-studio/)
...
导航到 `app > res > values > colors.xml` 文件，并为不同的颜色添加下面的代码。代码中添加了注释，以便更详细地了解。
...
bminus.setOnClickListener {
    // on clicking on minus we are checking if the user has already a minus operation on screen.
...
bfact.setOnClickListener {
    if (tvMain.text.toString().isEmpty()) {
        ...
        // on below line we are getting int value and calculating the factorial value of the entered number.
