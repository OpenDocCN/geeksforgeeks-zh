...
> 原文: [https://www.geeksforgeeks.org/building-ui-using-jetpack-compose-in-android/](https://www.geeksforgeeks.org/building-ui-using-jetpack-compose-in-android/)
...
2.  对[Jetpack Compose](https://www.geeksforgeeks.org/basics-of-jetpack-compose-in-android/)的基本了解
...
[视频演示](https://media.geeksforgeeks.org/wp-content/uploads/20211026125808/Screen-20211026-093622.mp4)
...
让我们创建一个 `BottomSection`，但是在此之前，为了简单起见，我们应该创建这个类。因为我们的 `BottomSection` 元素有两个字段或视图，所以让我们这样做。

### 第六步：为 BottomSection (BottomMenuContent.kt) 创建类
