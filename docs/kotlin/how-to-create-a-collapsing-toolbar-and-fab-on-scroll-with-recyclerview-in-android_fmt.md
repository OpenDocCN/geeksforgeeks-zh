...
在本文中，我们将使用[循环查看](https://www.geeksforgeeks.org/android-recyclerview/)在滚动中创建一个折叠工具栏和浮动操作按钮。许多流行的应用程序都有这种效果，例如 LinkedIn。下面是展示我们将要构建的内容的示例视频。请注意，我们将使用`Kotlin`语言来实现这个项目。
