...
> 原文：[https://www.geeksforgeeks.org/how-to-find-the-screen-resolution-of-a-device-programmatically-in-android/](https://www.geeksforgeeks.org/how-to-find-the-screen-resolution-of-a-device-programmatically-in-android/)
...
转到代表应用程序用户界面的 `activity_main.xml` 文件，创建一个按钮，点击该按钮将生成一个[吐司](https://www.geeksforgeeks.org/android-what-is-toast-and-how-to-use-it-with-examples/)，显示宽度和长度上可用的像素数。下面是 `activity_main.xml` 文件的代码。
