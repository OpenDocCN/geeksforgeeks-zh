...
> 原文：[https://www.geeksforgeeks.org/how-to-programmatically-take-a-screenshot-on-android/](https://www.geeksforgeeks.org/how-to-programmatically-take-a-screenshot-on-android/)
...
`view`是指我们希望捕获快照的布局视图。我们的代码中有一个 id 为`container`的视图。
...
![图像#1。输出。](img/66c3cf34703f2de2bd830dedb3c5c923.png)
