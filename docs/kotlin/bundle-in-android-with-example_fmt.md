...
> 原文：[https://www.geeksforgeeks.org/bundle-in-android-with-example/](https://www.geeksforgeeks.org/bundle-in-android-with-example/)
...
- `putString(String key, String value)`，`getString(String key, String defaultValue)`
- `putStringArray(String key, String[] values)`，`getStringArray(String key)`
- `putChar(String key, char value)`，`getChar(String key)`
...
> 例如：`Boolean b = bundle.getBoolean("在此传递密钥");`
