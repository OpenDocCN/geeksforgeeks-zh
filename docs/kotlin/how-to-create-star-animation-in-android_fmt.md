...
> 原文：[https://www.geeksforgeeks.org/how-to-create-star-animation-in-android/](https://www.geeksforgeeks.org/how-to-create-star-animation-in-android/)
...
> implementation 'com.sofakingforever.libraries:animated-star-android:1.1.4@aar'
...
### 步骤 4：使用 array.xml 文件

在 `values` 文件夹中创建一个 `array.xml` 文件。右键单击，然后单击 `New > Values Resource File`，然后创建一个名为 `array` 的文件。
