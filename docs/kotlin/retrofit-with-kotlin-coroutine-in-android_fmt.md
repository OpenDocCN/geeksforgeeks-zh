...
> 原文: [https://www.geeksforgeeks.org/retrofit-with-kotlin-coroutine-in-android/](https://www.geeksforgeeks.org/retrofit-with-kotlin-coroutine-in-android/)
...
**第五步: 我们将创建一个改装界面来添加 URL 的端点(在我们的例子中引号是端点)**
...
**第七步: 现在我们将在 MainActivity 中链接改装对象和改装界面文件**
