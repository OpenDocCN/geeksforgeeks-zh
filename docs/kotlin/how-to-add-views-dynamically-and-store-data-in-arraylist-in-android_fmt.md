...
> 原文：[https://www.geeksforgeeks.org/how-to-add-views-dynamically-and-store-data-in-arraylist-in-android/](https://www.geeksforgeeks.org/how-to-add-views-dynamically-and-store-data-in-arraylist-in-android/)
...
转到`activity_main.xml`文件，参考以下代码。下面是`activity_main.xml`文件的代码。注意它有一个 id 为`parent_linear_layout`的 Linear Layout 父布局，我们将对其进行膨胀以添加我们的视图。
