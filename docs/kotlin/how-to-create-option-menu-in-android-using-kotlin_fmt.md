...
> 原文：[https://www.geeksforgeeks.org/how-to-create-option-menu-in-android-using-kotlin/](https://www.geeksforgeeks.org/how-to-create-option-menu-in-android-using-kotlin/)

在本文中，我们将学习如何使用 Kotlin 在安卓应用程序中创建选项菜单。为了在活动中有一个选项菜单，我们需要创建一个新的菜单 XML 文件，并使用`菜单编辑器`对其进行膨胀。`inflate()`方法。在`menu.xml`中，我们将根据应用程序的要求设计选项菜单。
...
我们需要创建一个新的菜单 XML 文件，使用`<item>`标签，我们可以在菜单内创建项目。

## 第三步：为菜单选项中的项目图标创建矢量资产

[矢量资产](https://www.geeksforgeeks.org/how-to-add-vector-assets-in-android-studio/)参考本链接。

## 第四步：`menu.xml` 文件参考该代码
