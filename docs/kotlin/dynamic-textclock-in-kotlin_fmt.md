...
这里，我们将在 Kotlin 文件中以编程方式创建`TextClock`。
...
在这个文件中，我们使用`TextView`和`Button`，并设置所有小部件的属性。
...
![](img/ce2a62399ec4f95ab0a682fa5a0fc25a.png)
![](img/94e1fcc5d5aaddc486f805ca84c74b72.png)