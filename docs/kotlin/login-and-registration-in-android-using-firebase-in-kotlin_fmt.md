...
> 原文：[https://www.geeksforgeeks.org/login-and-registration-in-android-using-firebase-in-kotlin/](https://www.geeksforgeeks.org/login-and-registration-in-android-using-firebase-in-kotlin/)
...
**第 4 步：** 现在我们来为注册活动编码。在注册活动中，我们将创建一个 `FirebaseAuth` 对象，并使用它调用 `createUserWithEmailAndPassword(email, pass)` 函数。并使用 `addOnCompleteListener()` 功能进行检查，如果响应成功则显示[吐司](https://www.geeksforgeeks.org/android-what-is-toast-and-how-to-use-it-with-examples/)。
