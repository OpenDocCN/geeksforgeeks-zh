...
> 原文：`https://www.geeksforgeeks.org/data-binding-with-livedata-in-android/`

**先决条件：**

*   [`Data binding`](https://www.geeksforgeeks.org/overview-of-data-binding-in-android-architecture-components/)
*   [`Real-time data`](https://www.geeksforgeeks.org/livedata-in-android-architecture-components/) 和 [`View model`](https://www.geeksforgeeks.org/viewmodel-in-android-architecture-components/)
