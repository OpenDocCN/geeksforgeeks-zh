...
> 原文: [https://www.geeksforgeeks.org/how-to-send-data-from-activity-to-fragment-in-android/](https://www.geeksforgeeks.org/how-to-send-data-from-activity-to-fragment-in-android/)
...
### 第二步: 在布局文件夹中创建自定义片段布局(`my_custom_fragment.xml`)
...
### 第四步: 为自定义片段(`MyCustomFragment.kt`)创建一个类
...
### 第五步: 初始化 `MyCustomFragment` 类，并从 `EditText` (`MainActivity.kt`) 传递值
