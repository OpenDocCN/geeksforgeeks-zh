...
> 原文：[https://www.geeksforgeeks.org/how-to-capture-screenshot-of-a-view-and-save-it-to-gallery-in-android/](https://www.geeksforgeeks.org/how-to-capture-screenshot-of-a-view-and-save-it-to-gallery-in-android/)
...
转到`activity_main.xml`文件，参考以下代码。下面是`activity_main.xml`文件的代码。注意它有一个[材料卡片视图](https://www.geeksforgeeks.org/cardview-in-android-with-example/)，id 为`card_View`，我们将在本文中截图这个视图。
...
转到`AndroidManifest.xml`文件和以下代码。它有两个权限读取和写入外部存储。在`application`标签中，它有`android:usesCleartextTraffic="true"`。
...
[视频演示](https://media.geeksforgeeks.org/wp-content/uploads/20210208210909/capture_view_android_gfg.mp4)

`GitHub` 仓库在[这里](https://github.com)。