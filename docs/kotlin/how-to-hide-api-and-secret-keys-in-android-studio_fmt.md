...
> 原文：[https://www.geeksforgeeks.org/how-to-hide-api-and-secret-keys-in-android-studio/](https://www.geeksforgeeks.org/how-to-hide-api-and-secret-keys-in-android-studio/)
...
在项目选项中，你会发现需要打开的 `Gradle` 文件夹的 `.gitignore` 文件。
