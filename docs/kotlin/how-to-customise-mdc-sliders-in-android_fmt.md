...
> 原文: [https://www.geeksforgeeks.org/how-to-customise-mdc-sliders-in-android/](https://www.geeksforgeeks.org/how-to-customise-mdc-sliders-in-android/)
...
| 最大值 | `android:valueTo` |
| 步长(离散) | `android:stepSize` |
| 初始选定值(滑块) | `android:value` |
| 初始选定值(范围滑块) | `app:values` |
| 高度 | `app:trackHeight` |
| 颜色 | `app:trackColor` |
| 轨道活动部分的颜色 | `app:trackColorActive` |
| 轨道非活动部分的颜色 | `app:trackColorInactive` |
...
```
app:thumbColor = "CustomColorValue"
```

拇指半径的 XML 属性:

```
app:thumbRadius = "valueInDp"
```
...
| 颜色 | `app:thumbColor` |
| 半径 | `app:thumbRadius` |
| 海拔 | `app:thumbElevation` |
| 光晕颜色 | `app:haloColor` |
| 光环半径 | `app:haloRadius` |
| 笔画颜色 | `app:strokeColor` |
| 笔画宽度 | `app:strokeWidth` |
...
| 轨道非活动部分的颜色 | `app:tickColorInactive` |
