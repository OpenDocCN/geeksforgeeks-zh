...
> 原文：[https://www.geeksforgeeks.org/android-sqlite-database-in-kotlin/](https://www.geeksforgeeks.org/android-sqlite-database-in-kotlin/)
...
现在运行您的`MainActivity`应用程序并查看`输出`。
