...
> 原文: [https://www.geeksforgeeks.org/dynamic-checkedtextview-in-kotlin/](https://www.geeksforgeeks.org/dynamic-checkedtextview-in-kotlin/)
...
现在，我们需要修改我们的布局。为此: 转到 `app`>`res`>`layout` 并粘贴以下代码:
...
最后一步是对我们的 `CheckedTextView` 进行编码。打开 `app/src/main/Java/your package name/MainActivity.kt`
...
![](img/462475f8135410a1a78c4fbd09aa84de.png)
![](img/5dc49e1aa65844bd4afe55347609cad3.png)