...
> 原文：[https://www.geeksforgeeks.org/exposed-drop-down-menu-in-android/](https://www.geeksforgeeks.org/exposed-drop-down-menu-in-android/)
...
转到 `dropdown_item.xml` 文件，参考以下代码。下面是 `dropdown_item.xml` 文件的代码。这是一个单文本视图，我们将把它作为下拉列表中的一个项目。
