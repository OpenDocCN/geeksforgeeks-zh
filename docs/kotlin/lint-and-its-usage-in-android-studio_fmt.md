...
> 原文: [https://www.geeksforgeeks.org/lint-and-its-usage-in-android-studio/](https://www.geeksforgeeks.org/lint-and-its-usage-in-android-studio/)
...
android {
  lintOptions {
    baseline file("lint-geeksforgeks-example.xml")
  }
}
```
