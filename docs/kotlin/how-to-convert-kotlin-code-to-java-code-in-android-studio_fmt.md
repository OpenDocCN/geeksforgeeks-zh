...
> 原文：[https://www.geeksforgeeks.org/how-to-convert-kotlin-code-to-java-code-in-android-studio/](https://www.geeksforgeeks.org/how-to-convert-kotlin-code-to-java-code-in-android-studio/)
...
打开要转换成 Java 的 Kotlin 类/文件。考虑下面提到的 `MainActivity` 文件的代码进行转换。
