...
> 原文：[https://www.geeksforgeeks.org/how-to-send-data-back-to-mainactivity-in-android-using-kotlin/](https://www.geeksforgeeks.org/how-to-send-data-back-to-mainactivity-in-android-using-kotlin/)
...
> **注**：用 java 实现参考本文：[如何使用 Java 将数据从一个活动发送到第二个活动](https://www.geeksforgeeks.org/android-how-to-send-data-from-one-activity-to-second-activity/)

## 逐步实施

**第一步**：[使用 kotlin 在安卓中创建新项目](https://www.geeksforgeeks.org/how-to-create-project-in-android-studio-using-kotlin/)
