# 如何在Android Studio中搭建石头剪刀布游戏？

> 原文：[https://www.geeksforgeeks.org/how-to-build-a-rock-paper-scissor-game-in-android-studio/](https://www.geeksforgeeks.org/how-to-build-a-rock-paper-scissor-game-in-android-studio/)

石头剪刀布（又称**石头剪刀布**）是一种手游，在两个人之间进行，每个玩家同时形成三种形状中的一种。比赛的获胜者根据以下规则决定：

*   石头 vs 纸 -> 纸赢。
*   石头 vs 剪刀 -> 石头获胜。
*   纸 vs 剪刀 -> 剪刀获胜。

在这个游戏中，用户将被要求做出选择，并根据用户和计算机的选择，然后结果将与计算机和用户的选择一起显示。在这篇文章中，我们将使用`Kotlin`和`XML`在Android Studio中构建石头剪刀布游戏。
...
要在Android Studio创建新项目，请参考[如何在Android Studio创建/启动新项目](https://www.geeksforgeeks.org/android-how-to-create-start-a-new-project-in-android-studio/)。注意选择`Kotlin`作为编程语言。
