...
> 原文：[https://www.geeksforgeeks.org/how-to-make-cardview-checkable-in-android/](https://www.geeksforgeeks.org/how-to-make-cardview-checkable-in-android/)
...
### 步骤 2：使用 `build.gradle`（应用级）文件

导航至 `Gradle 脚本 > build.gradle (模块: app)` 并在依赖项部分添加以下依赖项。

> `implementation 'com.google.android.material:material:1.1.0'`

在 `plugins{ }` 标签中添加 `kotlin-android-extensions`。
