...
> 原文: [https://www.geeksforgeeks.org/dynamic-imageswitcher-in-kotlin/](https://www.geeksforgeeks.org/dynamic-imageswitcher-in-kotlin/)
...
首先，我们声明一个数组 `flowers`，它包含用于 `ImageView` 的图像资源。
...
点击下一步按钮，然后我们得到视图中的另一个动画图像。

![](img/96e1a39f032a6b68fa177ab9b6543797.png)
![](img/c6522ac2de0f019eee5f01da25e10906.png)