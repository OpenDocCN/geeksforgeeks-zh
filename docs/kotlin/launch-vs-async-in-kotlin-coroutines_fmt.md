...
> 原文: [https://www.geeksforgeeks.org/launch-vs-async-in-kotlin-coroutines/](https://www.geeksforgeeks.org/launch-vs-async-in-kotlin-coroutines/)
...
由于`fetchUserAndSaveInDatabase()`没有返回任何东西，我们可以使用启动来完成该任务，然后在主线程上做一些事情。
