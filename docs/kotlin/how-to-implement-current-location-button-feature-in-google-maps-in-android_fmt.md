...
原文: [https://www.geeksforgeeks.org/how-to-implement-current-location-button-feature-in-google-maps-in-android/](https://www.geeksforgeeks.org/how-to-implement-current-location-button-feature-in-google-maps-in-android/)
...
**第五步: 在 `activity_main.xml` 文件(前端)中实现一个简单的按钮 & 谷歌地图片段**
