...
| `android:padding` | 用于设置填充。 |
| `android:checkMark` | 用于设置勾号的可绘制性。 |
| `android:checkMarkTint` | 用于设置复选标记的色调。 |
| `android:checkMarkTintMode` | 用于应用复选标记色调的混合模式。 |
| `android:checked` | 用于设置 `checkedTextView` 的初始选中状态，默认情况下为 `false`。 |
...
该文件包含 `strings.xml` 中指定的 `app_name` 等信息以及其他重要的 android 信息。
...
![](img/02bba806262d840e1a7926b159d34070.png)
![](img/ded1dae9d28372ea6d55a6ec7c242a29.png)