...
> 原文：[https://www.geeksforgeeks.org/create-an-expandable-notification-containing-some-text-in-android/](https://www.geeksforgeeks.org/create-an-expandable-notification-containing-some-text-in-android/)
...
> 
> 由于`NotificationCompat`目前已被弃用，每当试图构建通知时（在我们的例子中是点击按钮），您的代码总是会崩溃。相反，只需使用`Notification`。
