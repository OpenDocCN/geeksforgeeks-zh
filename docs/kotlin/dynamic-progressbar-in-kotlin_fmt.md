...
> 原文：[https://www.geeksforgeeks.org/dynamic-progressbar-in-kotlin/](https://www.geeksforgeeks.org/dynamic-progressbar-in-kotlin/)
...
打开 `app/src/main/Java/your package name/MainActivity.kt`。在这个文件中，我们声明了一个变量 `progressBar` 来创建 `progressBar` 小部件，如下所示：
