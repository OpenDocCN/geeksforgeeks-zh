# 在Android日期选择器对话框中设置最小和最大可选日期

> 原文: [https://www.geeksforgeeks.org/set-min-and-max-selectable-dates-in-datepicker-dialog-in-android/](https://www.geeksforgeeks.org/set-min-and-max-selectable-dates-in-datepicker-dialog-in-android/)
...
### 第一步：在Android Studio新建项目

要在Android Studio创建新项目，请参考[如何在Android Studio创建/启动新项目](https://www.geeksforgeeks.org/android-how-to-create-start-a-new-project-in-android-studio/)。我们在`Kotlin`中演示了该应用程序，因此在创建新项目时，请确保选择`Kotlin`作为主要语言。
