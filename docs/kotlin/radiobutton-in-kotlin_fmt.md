...
默认情况下，单选按钮处于`关闭`(未选中)状态，但我们可以使用`android:checked`属性来更改单选按钮的默认状态。
...
| `android:maxWidth` | 用于使视图最大宽度达到这么多像素。 |
| `android:minWidth` | 用于使视图至少有这么多像素宽。 |
| `android:background` | 用于设置单选按钮控件的背景。 |
| `android:visibility` | 用于控制可见性。 |
...
![](img/aceebc4809a1f7ff1beee124b75fb963.png)
![](img/31e4914c511f5b9e6123db425506bd07.png)