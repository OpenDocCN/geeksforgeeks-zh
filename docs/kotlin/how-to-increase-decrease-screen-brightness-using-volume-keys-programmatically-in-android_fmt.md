...
> 原文：[https://www.geeksforgeeks.org/how-to-increase-decrease-screen-brightness-using-volume-keys-programmatically-in-android/](https://www.geeksforgeeks.org/how-to-increase-decrease-screen-brightness-using-volume-keys-programmatically-in-android/)
...
通过这篇文章，我们想让你知道音量按钮可以用来增加和降低屏幕亮度。下面给出一个 GIF 示例，来了解一下在本文中我们要做什么。注意，我们要用 `Kotlin` 语言来实现这个项目。
