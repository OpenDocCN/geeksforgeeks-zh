...
> 原文: [https://www.geeksforgeeks.org/how-to-adjust-the-volume-of-android-phone-programmatically-from-the-app/](https://www.geeksforgeeks.org/how-to-adjust-the-volume-of-android-phone-programmatically-from-the-app/)
...
我们唯一要做的改变就是传递参数 `AudioManager.FLAG_SHOW_UI` 代替 `AudioManager.FLAG_PLAY_SOUND`。下面是 `MainActivity.kt` 文件的代码。代码中添加了注释，以更详细地理解代码。
