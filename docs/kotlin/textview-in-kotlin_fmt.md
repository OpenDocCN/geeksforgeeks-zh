...
| 属性 | 描述 |
| --- | --- |
| `android:text` | 设置文本视图的文本 |
| `android:id` | 给文本视图一个唯一的标识 |
| `android:cursorVisible` | 使用此属性使光标可见或不可见。默认值可见。 |
| `android:drawableBottom` | 将图像或其他图形资源设置在文本视图的下方。 |
| `android:drawableEnd` | 将图像或其他图形资源设置到文本视图的末尾。 |
| `android:drawableLeft` | 将图像或其他图形资源设置在文本视图的左侧。 |
| `android:drawablePadding` | 为文本视图中的可绘制内容(图像或其他图形资源)设置填充。 |
| `android:autoLink` | 此属性用于自动检测 url 或电子邮件，并将其显示为可点击的链接。 |
| `android:autoText` | 自动纠正文本视图文本中的拼写错误。 |
| `android:capitalize` | 无论用户在文本视图中键入什么，它都会自动大写。 |
| `android:drawableRight` | 在文本视图中将可绘制对象设置在文本的右侧。 |
| `android:drawableStart` | 在文本视图中将可绘制内容设置为文本的开头。 |
| `android:drawableTop` | 在“文本视图”中将可绘图项设置在文本的顶部。 |
| `android:ellipsize` | 如果文本长度超过文本视图宽度，当您希望文本被椭圆化时，请使用此属性。 |
| `android:ems` | 设置 ems 中 Textview 的宽度。 |
| `android:gravity` | 我们可以垂直或水平对齐文本视图的文本，或者两者都对齐。 |
| `android:height` | 用于设置文本视图的高度。 |
| `android:hint` | 用于在没有文本时显示提示。 |
| `android:inputType` | 用于设置文本视图的输入类型。可以是号码、密码、电话等。 |
| `android:lines` | 用于根据行数设置文本视图的高度。 |
...
| `android:maxWidth` | 设置文本视图可以具有的最大宽度。 |
| `android:minWidth` | 设置文本视图可以拥有的最少行数。 |
| `android:textAllCaps` | 用大写字母显示文本视图的所有文本。 |
| `android:textColor` | 设置文本的颜色。 |
| `android:textSize` | 设置文本的字体大小。 |
| `android:textStyle` | 设置文本的样式。例如，粗体、斜体、粗斜体。 |
| `android:typeface` | 设置文本的字体。例如，普通、无衬线、衬线等 |
| `android:width` | 设置文本视图的宽度。 |
