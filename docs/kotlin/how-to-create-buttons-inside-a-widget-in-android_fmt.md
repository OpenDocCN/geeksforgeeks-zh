...
> 原文: [https://www.geeksforgeeks.org/how-to-create-buttons-inside-a-widget-in-android/](https://www.geeksforgeeks.org/how-to-create-buttons-inside-a-widget-in-android/)

#### 先决条件

*   [如何创建安卓应用的基本小部件？](https://www.geeksforgeeks.org/how-to-create-a-basic-widget-of-an-android-app/)
*   [如何创建安卓应用的动态小部件？](https://www.geeksforgeeks.org/how-to-create-a-dynamic-widget-of-an-android-app/)
...
1.  在我们的应用程序中，由于我们希望显示两个名为“活动 1”和“活动 2”的按钮，我们需要在 `new_app_widget.xml` 文件中声明它们，该文件位于“资源”文件夹的“布局”中。
2.  整个编程(后端)是在主源文件夹中新创建的 `NewAppWidget.kt` Kotlin 类文件中完成的。这里，我们构建按钮。由于这些按钮会将用户重定向到不同的活动，我们需要创建两个空活动，我们将它们分别命名为“活动 1”和“活动 2”。
