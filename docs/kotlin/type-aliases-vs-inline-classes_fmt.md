...
> 原文：[https://www.geeksforgeeks.org/type-aliases-vs-inline-classes/](https://www.geeksforgeeks.org/type-aliases-vs-inline-classes/)
...
这里，类型别名进入图片，类型别名提供了一种方法来为我们复杂或太长的类名定义一个替代名称。类型别名不会引入新类型。它们与相应的底层类型相同。
