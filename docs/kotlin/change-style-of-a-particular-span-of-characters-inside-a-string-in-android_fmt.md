...
> 原文：[https://www.geeksforgeeks.org/change-style-of-a-particular-span-of-characters-inside-a-string-in-android/](https://www.geeksforgeeks.org/change-style-of-a-particular-span-of-characters-inside-a-string-in-android/)

[`TextView`](https://www.geeksforgeeks.org/textview-in-kotlin/) 用于显示文本或字符序列，更好的说法是字符串。这些字符串可以硬编码，也可以在运行时声明。通常，文本以原始格式显示，其中相同的文本格式应用于字符串中的每个字符。如果我们希望应用样式，格式将应用于整个字符串。没有对不同的字符应用不同的样式的直接规定。
