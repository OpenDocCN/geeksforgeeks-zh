...
> 原文：[https://www.geeksforgeeks.org/kotlin-flow-in-android-with-example/](https://www.geeksforgeeks.org/kotlin-flow-in-android-with-example/)
...
要在安卓工作室创建新项目，请参考如何在安卓工作室创建/启动新项目。注意选择`Kotlin`作为编程语言。
