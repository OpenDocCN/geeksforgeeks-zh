...
`RatingBar` 可以手动或编程创建，但我们将讨论编程或动态创建。
...
在这里，我们可以将应用程序中可以使用的所有字符串放在任意文件中。因此，我们更新了 `app_name`，它可以在活动的顶部看到。
...
![](img/f1f00b91b5af81bbca7e85748b7914b4.png)
![](img/d3faccb1014123b7d589fba687a15baa.png)