...
> 原文：[https://www.geeksforgeeks.org/how-to-create-a-splash-screen-in-android-using-kotlin/](https://www.geeksforgeeks.org/how-to-create-a-splash-screen-in-android-using-kotlin/)
...
转到`activity_main.xml`文件，并添加一个文本，当用户进入主活动时，该文本将显示“欢迎来到极客论坛”。下面是`activity_main.xml`文件的代码。
