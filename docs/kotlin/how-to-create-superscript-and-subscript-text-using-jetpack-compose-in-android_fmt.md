...
> 原文：[https://www.geeksforgeeks.org/how-to-create-superscript-and-subscript-text-using-jetpack-compose-in-android/](https://www.geeksforgeeks.org/how-to-create-superscript-and-subscript-text-using-jetpack-compose-in-android/)
...
*   [Jetpack Compose 在 Android 中的基础知识。](https://www.geeksforgeeks.org/basics-of-jetpack-compose-in-android/)

## 分步实施

### 第一步：创建新项目

使用 `Jetpack Compose` 在 `Android Studio` 中创建新项目请参考[如何使用 Jetpack Compose 在 Android Studio Canary 版本中创建新项目](https://www.geeksforgeeks.org/how-to-install-android-studio-canary-version/)。
