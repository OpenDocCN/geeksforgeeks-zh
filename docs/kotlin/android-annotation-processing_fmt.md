...
> 原文：[https://www.geeksforgeeks.org/android-annotation-processing/](https://www.geeksforgeeks.org/android-annotation-processing/)
...
1.  命名模块`gfg-annotations`。
2.  将包设置为`com.geeksforgeeks.gfg_annotations`。
