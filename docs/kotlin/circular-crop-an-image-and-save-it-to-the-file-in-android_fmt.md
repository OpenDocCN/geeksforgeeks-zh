...
1.  `getCircularBitmap(bitmap)`: 裁剪图像
2.  `saveMediaToStorage(bitmap)`: 保存图像。参考[如何在安卓系统中抓取视图截图并保存到图库？](https://www.geeksforgeeks.org/how-to-capture-screenshot-of-a-view-and-save-it-to-gallery-in-android/)
