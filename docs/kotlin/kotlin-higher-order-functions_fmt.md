...
> 原文: [https://www.geeksforgeeks.org/kotlin-higher-order-functions/](https://www.geeksforgeeks.org/kotlin-higher-order-functions/)
...
我们可以将 `λ表达式` 作为参数传递给高阶函数。有两种类型的 `lambda` 表达式可以传递：
