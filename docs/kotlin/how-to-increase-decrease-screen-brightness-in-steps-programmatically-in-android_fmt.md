...
> 原文：[https://www.geeksforgeeks.org/how-to-increase-decrease-screen-brightness-in-steps-programmatically-in-android/](https://www.geeksforgeeks.org/how-to-increase-decrease-screen-brightness-in-steps-programmatically-in-android/)
...
下面给出一个 GIF 示例，来了解一下在本文中我们要做什么。注意，我们要用 **Kotlin** 语言来实现这个项目。
...
接下来，转到 `activity_main.xml` 文件，该文件代表项目的 UI。如图所示添加两个按钮，一个使亮度值最大，另一个使亮度值最小。下面是 `activity_main.xml` 文件的代码。
