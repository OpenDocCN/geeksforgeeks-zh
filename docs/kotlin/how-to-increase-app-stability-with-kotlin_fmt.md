...
> 原文：[https://www.geeksforgeeks.org/how-to-increase-app-stability-with-kotlin/](https://www.geeksforgeeks.org/how-to-increase-app-stability-with-kotlin/)
...
运行时异常是一个空指针异常。Java 中的对象引用可以被赋予一个特定的空值。当程序试图使用空值的对象引用时，会引发 `NullPointerException`。Kotlin 和这件事有什么关系？那么是什么阻止了你使用 Kotlin 伙伴呢？
...
有许多问题是我们开发人员在没有意识到的情况下创造出来的，其中许多是微妙而难以分析的。以下是一些利用 Kotlin 可以避免的困难。
