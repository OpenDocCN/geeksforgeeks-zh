...
> 原文: [https://www.geeksforgeeks.org/how-to-insert-image-to-screen-at-the-touched-coordinates-in-android/](https://www.geeksforgeeks.org/how-to-insert-image-to-screen-at-the-touched-coordinates-in-android/)

在本文中，我们将学习在屏幕上的触摸坐标上放置图像。我们可以在屏幕上插入多个图像。[`onTouchListener`](https://developer.android.com/reference/android/view/View.OnTouchListener)将用于获取屏幕上触摸位置的坐标，以便可以在该位置插入图像。下面给出了一个示例 GIF，以了解我们将在本文中做什么。注意，我们将使用`Kotlin`语言来实现这个项目。
