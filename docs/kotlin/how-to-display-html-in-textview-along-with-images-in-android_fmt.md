...
> 原文：[https://www.geeksforgeeks.org/how-to-display-html-in-textview-along-with-images-in-android/](https://www.geeksforgeeks.org/how-to-display-html-in-textview-along-with-images-in-android/)
...
*   [`EditText`](https://www.geeksforgeeks.org/android-edittext-in-kotlin/) 用户输入 HTML 文本的地方，
*   [`Button`](https://www.geeksforgeeks.org/button-in-kotlin/) 触发事件显示 HTML 文本，
*   [`ScrollView`](https://www.geeksforgeeks.org/scrollview-in-android/) 进行平滑滚动，
*   [`TextView`](https://www.geeksforgeeks.org/textview-in-kotlin/) 处理输入后显示 HTML。
...
### 步骤 4: 创建一个 Kotlin 类 `ImageGetter.kt`
