...
> 原文：[https://www.geeksforgeeks.org/how-to-handle-ime-options-on-action-button-click-in-android/](https://www.geeksforgeeks.org/how-to-handle-ime-options-on-action-button-click-in-android/)
...
*   `EditorInfo.IME_ACTION_DONE` = 当 IME 选项未指定时（默认）
*   `EditorInfo.IME_ACTION_SEARCH` = 当 IME 选项是搜索动作时。
*   `EditorInfo.IME_ACTION_GO` = 当 IME 选项是开始动作时
*   `EditorInfo.IME_ACTION_NEXT` = 当 IME 选项是下一步动作时
*   `EditorInfo.IME_ACTION_PREVIOUS` = 当 IME 选项为上一步动作时
*   `EditorInfo.IME_ACTION_SEND` = 当 IME 选项是发送动作时
