...
> 原文: [https://www.geeksforgeeks.org/html-area-referrerpolicy-attribute/](https://www.geeksforgeeks.org/html-area-referrerpolicy-attribute/)

**HTML `<area>` referrerpolicy 属性**用于指定客户端的引用信息，在取出结果时会发送给服务器。
...
*   **同源:** 指定为同站点源发送推荐人，但跨源请求将不发送推荐人信息。
...
![HTML area referrerpolicy Attribute](img/c66e62c460c846f22f2ac73f4477eb56.png)
