...
> 原文：[https://www.geeksforgeeks.org/how-to-define-a-term-or-name-in-a-definition-list-using-html5/](https://www.geeksforgeeks.org/how-to-define-a-term-or-name-in-a-definition-list-using-html5/)
...
**示例：** 本示例创建了一个包含`Machine Learning`和`Artificial Intelligence`这两个术语的定义列表，并给出了它们各自的定义。
