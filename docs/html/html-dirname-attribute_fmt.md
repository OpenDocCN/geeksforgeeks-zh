...
**HTML | dirname 属性**用于在*提交表单*后启用输入的文本方向和文本区域字段。dirname 属性的值必须是输入字段和文本区域的名称，后跟**。目录“**”。
可以与 **<input>** 和 **<textarea>** 元素一起使用。
...
**输出:**
![示例-1 输出](img/44207ea1f6fb18d2120d094a6c0c246b.png)
...
<form action="/action_page.php">
    ...
    <textarea name="Geeks" dirname="geeks.dir" placeholder="write something here">
    </textarea>
    <input type="submit" value="Submit">
</form>
...
**输出:**
![示例-2 输出](img/5a51873874a735a0214291eade703810.png)
