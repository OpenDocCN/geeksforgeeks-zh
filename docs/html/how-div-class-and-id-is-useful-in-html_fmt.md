...
> 原文：[https://www.geeksforgeeks.org/how-div-class-and-id-is-useful-in-html/](https://www.geeksforgeeks.org/how-div-class-and-id-is-useful-in-html/)

在本文中，我们将讨论 `id`、`div` 和 `class` 在 HTML 中是如何有用的。`Id`、`Div` 和 `class` 是构建 HTML 页面的重要概念。让我们一个一个来讨论。

*   [HTML 中的 Id 属性](https://www.geeksforgeeks.org/html-id-attributes/)
*   [HTML 中的 Div 标签](https://www.geeksforgeeks.org/div-tag-html/)
*   [Class attributes in HTML](https://www.geeksforgeeks.org/html-class-attribute/)
...
现在，在这里您将看到如何在 `Id` 和 `Div` 以及 `class` 的帮助下，通过使用 CSS 为您的网页添加更多的功能。
...
在上面的例子中，您可以直接看到，通过使用`Id`，我们可以向不同的标题添加单独的功能，`class`是通用的，我们可以编写一次`CSS`脚本，并且可以在任何地方使用它，这对于可重用性也很有用。