...
> 原文: [https://www.geeksforgeeks.org/html-frame-marginheight-attribute/](https://www.geeksforgeeks.org/html-frame-marginheight-attribute/)

**HTML `<frame>` 边距高度属性**用于指定框架元素中内容的上下边距。
...
**支持的浏览器:** HTML `<frame>` `marginheight` 属性支持的浏览器如下:
