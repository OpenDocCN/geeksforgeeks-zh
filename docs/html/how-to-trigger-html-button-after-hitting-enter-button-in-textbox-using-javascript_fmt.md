...
> 原文：[https://www.geeksforgeeks.org/how-to-trigger-html-button-after-hitting-enter-button-in-textbox-using-javascript/](https://www.geeksforgeeks.org/how-to-trigger-html-button-after-hitting-enter-button-in-textbox-using-javascript/)
...
**注意：** 两次 `keydown` 和 `keypress` 事件不断重复，直到按键被按下。两者可能会显示类似的结果，但 `keypress` 不会在所有浏览器中检测到所有按键。
