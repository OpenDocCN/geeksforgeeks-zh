...
**HTML onstalled Attribute** 是一个事件属性，当媒体数据通过浏览器但数据不可用时发生。
...
**属性值:** 该属性包含一个单值脚本，在启动事件属性调用时工作。该属性由 [**<音频**](https://www.geeksforgeeks.org/html5-audio/)[**<和视频**](https://www.geeksforgeeks.org/html5-video/) 标签支持。
