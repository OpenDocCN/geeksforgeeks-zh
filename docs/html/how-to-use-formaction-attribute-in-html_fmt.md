...
> 原文：[https://www.geeksforgeeks.org/how-to-use-formaction-attribute-in-html/](https://www.geeksforgeeks.org/how-to-use-formaction-attribute-in-html/)

在本文中，我们将学习如何在 HTML 中使用 `formaction` 属性。基本上，`formaction` 属性用于定义在提交表单之后表单的数据发送到哪里。它覆盖了 `<form>` 元素的 `action` 属性的特征。

**我们为什么要使用 `formaction` 属性？**
...
<body style="text-align:center;">
    ...
    <form method="get" target="_self">
        ...
        <input type="submit" value="submit for Java User" 
               formaction="https://practice.geeksforgeeks.org/courses/java-backend-live">

        <input type="submit" value="submit for python User"
               formaction="https://www.geeksforgeeks.org/python-programming-language/">
    </form>
</body>
