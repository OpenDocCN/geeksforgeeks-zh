...
> 原文: [https://www.geeksforgeeks.org/how-to-create-reflection-effect-using-html-and-css/](https://www.geeksforgeeks.org/how-to-create-reflection-effect-using-html-and-css/)
...
*   **第三步:** 现在使用选择器后的`::after`，在 X 轴上旋转原始文本，保持原点为底部。
*   **第四步:** 应用`-webkit-background-clip`属性将旋转后的文本剪切成多个剪切块。它将使文本的上部分可见，如输出图像所示。
*   **第五步:** 现在应用透明颜色，降低旋转文本的`opacity`。

**注意:** 确保根据你的背景降低不透明度。如果你使用的是较暗的背景，降低不透明度 0.1-0.2，如果你使用的是较亮的背景，则降低 0.6-0.8。
