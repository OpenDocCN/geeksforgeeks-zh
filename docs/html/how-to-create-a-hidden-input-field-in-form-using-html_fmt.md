...
> 原文: [https://www.geeksforgeeks.org/how-to-create-a-hidden-input-field-in-form-using-html/](https://www.geeksforgeeks.org/how-to-create-a-hidden-input-field-in-form-using-html/)
...
*   使用 [`type`](https://www.geeksforgeeks.org/html-input-type-attribute/) 属性配合 [`<input>`](https://www.geeksforgeeks.org/html-input-tag/) 标记。
*   将`type`属性设置为值`"hidden"`。
