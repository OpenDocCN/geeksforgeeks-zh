...
> 原文: [https://www.geeksforgeeks.org/html-course-understanding-and-building-project-structure/](https://www.geeksforgeeks.org/html-course-understanding-and-building-project-structure/)
...
HTML5 是 HTML 脚本语言的第五个版本。它支持许多旧版本的 HTML 不支持的新东西。例如：在 HTML5 中有一个新的东西叫做**语义元素**。语义元素有有意义的名称，可以说明内容的类型。例如页眉、页脚、表格等。HTML5 引入了许多语义元素，这些元素使开发人员更容易编写和理解代码，并指导浏览器如何对待它们。要了解更多关于 HTML5 的新内容，请访问：

*   [HTML 和 HTML5 的区别](https://www.geeksforgeeks.org/html-html5-difference/)
