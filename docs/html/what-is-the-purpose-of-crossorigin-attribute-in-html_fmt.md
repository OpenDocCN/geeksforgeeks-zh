...
> 原文：[https://www.geeksforgeeks.org/what-is-the-purpose-of-crossorigin-attribute-in-html/](https://www.geeksforgeeks.org/what-is-the-purpose-of-crossorigin-attribute-in-html/)
...
**值:** 该属性包含两个值，如下所示：
*   `anonymous`：有默认值。它定义了一个 CORS 请求，该请求将在不传递凭据信息的情况下发送。
*   `use-credentials`：跨来源请求将与凭证、cookies 和证书一起发送。

**示例:** 下面的代码演示了在 `<script>` 元素中使用 `crossorigin` 属性。
