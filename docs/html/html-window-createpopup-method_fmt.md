...
> 原文: [https://www.geeksforgeeks.org/html-window-createpopup-method/](https://www.geeksforgeeks.org/html-window-createpopup-method/)

html 窗口中的 `createPopup()` 方法用于创建一个弹出窗口。
...
**注意:** 在 Internet Explorer 11 之前，`Window createPopup()` 方法工作。
