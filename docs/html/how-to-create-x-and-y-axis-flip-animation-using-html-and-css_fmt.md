...
> 原文：[https://www.geeksforgeeks.org/how-to-create-x-and-y-axis-flip-animation-using-html-and-css/](https://www.geeksforgeeks.org/how-to-create-x-and-y-axis-flip-animation-using-html-and-css/)
...
在 CSS 中，我们做的第一件事就是给身体提供一个背景。将背景应用于 `div` 和一些边框半径，以获得圆角。应用标识符为 `animate` 的线性动画制作动画。使用 `@keyframes`，我们将动画应用于我们的标识符。我们在前半帧沿着 X 轴旋转，在静止时沿着 Y 轴旋转。这不是必需的，但是您可以更改旋转角度以获得不同类型的翻转效果。这个是基本的翻转效果。
