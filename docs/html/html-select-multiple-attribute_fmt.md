...
> 原文: [https://www.geeksforgeeks.org/html-select-multi-attribute/](https://www.geeksforgeeks.org/html-select-multi-attribute/)

**HTML `<select>` 多属性**为布尔属性。它指定允许用户选择在 `<select>` 元素中呈现的多个值。
