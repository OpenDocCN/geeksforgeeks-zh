...
> 原文: [https://www.geeksforgeeks.org/how-to-insert-email-address-into-form-using-html5/](https://www.geeksforgeeks.org/how-to-insert-email-address-into-form-using-html5/) 将电子邮件地址插入表单
...
*   将`type`属性与设置为值`"email"`的`<input>`元素一起使用。
