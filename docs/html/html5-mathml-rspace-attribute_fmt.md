...
> 原文: [https://www.geeksforgeeks.org/html5-mathml-rspace-attribute/](https://www.geeksforgeeks.org/html5-mathml-rspace-attribute/)

此属性保存运算符默认值 thickmathspace (4.32px)之后的空间长度值。此属性仅被 MathML `<mo>` 标签接受。
...
**支持的浏览器:** HTML5 MathML rspace 属性支持的浏览器如下:
