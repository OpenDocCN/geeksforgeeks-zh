...
> 原文: [https://www.geeksforgeeks.org/html-menuitem-disabled-attribute/](https://www.geeksforgeeks.org/html-menuitem-disabled-attribute/)

**HTML** `<menuitem>` **禁用** 属性是一个布尔属性，用于指定菜单项是否被禁用。*禁用的*菜单项不可选择，通常看起来是灰色的。
...
**示例:** 下面的代码演示了在 `<menuitem>` 标签中使用 **禁用** 属性。
