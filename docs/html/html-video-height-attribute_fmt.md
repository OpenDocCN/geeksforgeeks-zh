...
**Attribute Values:** It contains a single value **pixels** which specifies the height of the video player in terms of pixels.

Below example illustrates the use of the height attribute in the `<video>` element:
