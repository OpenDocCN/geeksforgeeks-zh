...
> 原文: [https://www.geeksforgeeks.org/html-frame-frameborder-attribute/](https://www.geeksforgeeks.org/html-frame-frameborder-attribute/)

**HTML `<frame>` 框架边框属性**用于指定框架之间是否应该显示边框。为此，我们使用两个值 0 和 1，其中 0 定义无边框，1 定义边框。
...
**支持的浏览器:** HTML `<frame>` 框架边框属性支持的浏览器如下:
