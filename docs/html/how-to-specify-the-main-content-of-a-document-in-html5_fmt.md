...
> 原文：[https://www.geeksforgeeks.org/how-to-specify-the-main-content-of-a-document-in-html5/](https://www.geeksforgeeks.org/how-to-specify-the-main-content-of-a-document-in-html5/)

`<article>` 标签是 HTML5 中新增的切片元素之一。HTML 文章标签用于表示一篇文章。更具体地说，`<article>` 标签内的内容独立于网站的其他内容（即使可能相关）。
