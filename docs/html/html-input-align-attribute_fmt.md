...
**HTML `<input>` 对齐属性**与 `<input type="image">` 一起设置图像的水平对齐。HTML 5 不支持。
...
**注意:** 由于 `<input type="image">` 不受 HTML5 的支持，所以可以用那里的 CSS 代替这个属性。CSS `<input type="image" style="float:right">`。
**支持的浏览器:**
