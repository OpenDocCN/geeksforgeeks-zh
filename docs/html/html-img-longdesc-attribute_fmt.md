...
**longdesc 属性**仅适用于旧版本的 HTML（即 HTML 4.0 或更旧版本）。使用最新版本的 HTML 的浏览器不再支持它。

## 示例

在本例中，我们将包括 *GFG.html，它是一个包含图像附加细节的普通 Html 文件。*
...
        <img src="https://media.geeksforgeeks.org/wp-content/uploads/20210816073840/gfg5.png"
...
但是，以上示例中使用的功能不再推荐，任何浏览器都不支持。相反，我们可以将链接 (<a> 标签) 添加到将显示图像描述的图像中。为此，我们将把 *GFG.html* 文件纳入我们的 *index.html* 文件。
