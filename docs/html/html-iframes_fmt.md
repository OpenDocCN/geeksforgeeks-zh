...
> [GeeksforGeeks](https://www.geeksforgeeks.org/html-iframe/)
...
    <iframe src="https://ide.geeksforgeeks.org/index.php" height="200" width="400"></iframe>
</body>
...
*   [**HTML `<iframe>` 高度属性**](https://www.geeksforgeeks.org/html-iframe-height-attribute/)
*   [**HTML `<iframe>` 宽度属性**](https://www.geeksforgeeks.org/html-iframe-width-attribute/)
*   **HTML `<iframe>` 加载属性**
*   [**HTML `<iframe>` 滚动属性**](https://www.geeksforgeeks.org/html-iframe-scrolling-attribute/)
*   [**HTML `<iframe>` 名称属性**](https://www.geeksforgeeks.org/html-iframe-name-attribute/)
*   [**HTML `<iframe>` referrer policy 属性**](https://www.geeksforgeeks.org/html-iframe-referrerpolicy-attribute/)
*   [**HTML `<iframe>` 沙盒属性**](https://www.geeksforgeeks.org/html-iframe-sandbox-attribute/)
*   [**HTML `<iframe>` src 属性**](https://www.geeksforgeeks.org/html-iframe-src-attribute/)
*   [**HTML `<iframe>` srcdoc 属性**](https://www.geeksforgeeks.org/html-iframe-srcdoc-attribute/)
...
<body>
    <p>Content goes here</p>
    <iframe src="https://ide.geeksforgeeks.org/tryit.php" height="300" width="400" style="border: 4px solid orange"></iframe>
</body>
...
    <iframe height="300" width="350" src="https://media.geeksforgeeks.org/wp-content/uploads/20210910170539/gfg-221x300.png" name="iframe_a"></iframe>
    <p><a href="https://ide.geeksforgeeks.org/tryit.php" target="iframe_a">GeeksforGeeks IDE</a></p>
