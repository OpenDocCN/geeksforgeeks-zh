...
> 原文: [https://www.geeksforgeeks.org/creating-a-3d-flip-button-using-html-and-css/](https://www.geeksforgeeks.org/creating-a-3d-flip-button-using-html-and-css/)
...
`transform-style` 属性用于定义效果应该保留 3D 定位，以便效果看起来正确。`:hover` 选择器可用于选择超链接并使用 `transform` 属性。每当按钮悬停在上方时，`rotateX()` 值用于旋转按钮。
