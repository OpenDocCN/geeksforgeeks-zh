...
在本节中，我们将为切换按钮创建一个基本结构。在这里，我们只需要在 HTML 文档中添加一个复选框和一个标签，如下所示。我们可以通过使用 [`HTML <label>` 标签](https://www.geeksforgeeks.org/html-label-tag/) 和 [`HTML <input type="checkbox">`](https://www.geeksforgeeks.org/html-input-typecheckbox/) 来实现。
...
在上一节中，我们已经创建了拨动开关的结构。我们将在本节中设计开关并使其具有响应性。
