# 如何在 iframe 元素中指定页面的 HTML 内容？

> 原文：[https://www.geeksforgeeks.org/how-to-specify-the-html-content-of-the-page-to-show-in-the-iframe-element-html5/](https://www.geeksforgeeks.org/how-to-specify-the-html-content-of-the-page-to-show-in-the-iframe-element-html5/)

## HTML5 中的实现

在这篇文章中，我们将学习如何在网页浏览器中使用带有 HTML 的 JavaScript 静态和动态地将网页内容指定到 `<iframe>`。我们需要一个网页浏览器，即 Chrome（推荐）或 Electron 应用。本文将解释如何将任何外部网页分配或嵌入到另一个网页中，甚至使用 JavaScript 动态更改嵌入网页的内容。让我们开始吧！
...
<body>
  ...
  <iframe id="embed1" src="https://www.geeksforgeeks.org"
