...
这个标签接受以下属性，并且必须在 `<注释>` 和 `<注释-xml>` 上使用这些属性：
...
**输出:**
![Output Image](img/a313bcd40812974592a959f2d0bf3002.png)

**支持的浏览器:** HTML 5 MathML `<semantics>` 标签支持的浏览器如下:
