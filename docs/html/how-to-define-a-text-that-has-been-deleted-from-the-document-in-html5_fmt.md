...
> 原文：[https://www.geeksforgeeks.org/how-to-define-a-text-that-has-been-deleted-from-the-document-in-html5/](https://www.geeksforgeeks.org/how-to-define-a-text-that-has-been-deleted-from-the-document-in-html5/)

在本文中，我们将学习如何定义从文档中删除的一些文本。
这可用于显示内容的最新更新或删除可能不正确的内容。后面通常是经过更新或更正的文本。

我们将使用 [`<del>`](https://www.geeksforgeeks.org/html-del-tag/) 元素来指定已经从文档中删除的文本。浏览器通常会划掉这个标签中的文本，以区别于其他内容。这个元素有两个属性，可以用来指定引用和进行更改的时间。
