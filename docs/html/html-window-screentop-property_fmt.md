...
> 原文: [https://www.geeksforgeeks.org/html-window-screentop-property/](https://www.geeksforgeeks.org/html-window-screentop-property/)
...
**返回值:** 返回一个数字，表示窗口相对于屏幕的水平和垂直距离，以像素为单位。
