...
> 原文：[https://www.geeksforgeeks.org/how-to-specify-that-a-keygen-element-should-be-disabled-in-html/](https://www.geeksforgeeks.org/how-to-specify-that-a-keygen-element-should-be-disabled-in-html/)
...
这可以通过使用`<keygen>`元素的`disabled`属性来实现。这将阻止元素生成它应该生成的键值对。
...
在以下示例中，`<keygen>`元素使用`disabled`属性禁用。
