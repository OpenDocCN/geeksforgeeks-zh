...
> 原文: [https://www.geeksforgeeks.org/how-to-set-the-focus-on-drop-down-list-automatically-when-the-page-loads-in-html5/](https://www.geeksforgeeks.org/how-to-set-the-focus-on-drop-down-list-automatically-when-the-page-loads-in-html5/)

本文的目的是在 HTML5 中加载页面时自动聚焦下拉列表。

`<select>` `autofocus` 属性是一个布尔属性，指定当页面加载时下拉列表应该自动获得焦点。
...
**注意:** 火狐不支持 `<select>` 标签的 `autofocus` 属性。
