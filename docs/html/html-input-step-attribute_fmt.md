...
HTML 中的 **HTML `<input>` 步长属性**用于设置 `<input>` 元素的离散步长。数字输入的默认步进值为 1。
**用法:** 适用于以下输入类型:
...
**示例:** 本示例说明了在 `<input>` 元素中使用 `step` 属性。
...
![输出示例](img/848be72073dcc710460723e8b3e3b9ec.png)

**支持的浏览器:** `<input>` 步长属性的 **支持浏览器如下:**
