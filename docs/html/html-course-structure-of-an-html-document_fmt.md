...
> 原文: [https://www.geeksforgeeks.org/html-course-structure-of-an-html-document/](https://www.geeksforgeeks.org/html-course-structure-of-an-html-document/)
...
下面是 HTML 中 (`<b>`) 标签的一个例子，它告诉浏览器加粗其中的文本。
...
**<head>**: 头部标签包含元数据、标题、页面 CSS 等。所有可以在 `<head>` 元素内使用的 HTML 元素有:
