...
该属性包含单值*语言代码*，用于指定内容的语言。

## HTML 4.1 与 HTML 5 的区别:

在 HTML 5 中，lang 属性可以与任何 HTML 元素一起使用，但在 HTML 4.1 中，lang 属性与 `<base>`、`<br>`、`<frame>`、`<frameset>`、`<hr>`、`<iframe>`、`<param>` 和 `<script>` 元素一起使用。
...
![输出示例](img/055f9e25c9bb6bb4995e191519eec438.png)
