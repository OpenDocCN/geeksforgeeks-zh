...
**HTML <form> 方法属性**用于指定提交表单时发送数据的 HTTP 方法。HTTP 方式有两种，分别是 **GET** 和 **POST**。方法属性可以与 **<form>** 元素一起使用。
**属性值:**
...
![GET 方法示例输出](img/07467e481e977ab25f599a90096ac614.png)
...
![POST 方法示例输出](img/9f2b02c98f2f0d0f88bfb56d97258eef.png)
