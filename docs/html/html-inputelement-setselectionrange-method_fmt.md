...
> 原文: [https://www.geeksforgeeks.org/html-inputelement-setselectionrange-method/](https://www.geeksforgeeks.org/html-inputelement-setselectionrange-method/)
...
**支持的浏览器:** HTML InputElement.setSelectionRange() 方法支持的浏览器如下:
