...
要使用 Lazy Loading，使用 html 中图像标签的 Loading 属性。以下是加载属性支持的值:

*   **auto:** 默认浏览器的懒加载行为，与不包含属性相同。
*   **lazy:** 延迟加载资源，直到它到达与视口的计算距离。
*   **eager:** 立即加载资源，无论它位于页面的什么位置。
...
![Lazy Loading Images](img/e6d6a451c2e2cc5d77be9befb1e9c2b2.png)
