...
> 原文: [https://www.geeksforgeeks.org/html-course-building-main-content-section-3/](https://www.geeksforgeeks.org/html-course-building-main-content-section-3/)
...
4.  **对于每一列**:
    ...
    *   为内容描述声明一个段落 `<p>` 元素。
    *   声明一个锚点标签 `<a>` 来添加一个外部链接，它将被设计为一个按钮。我们将使用上一篇文章中创建的按钮。因此，将类“按钮”分配给锚标签。

以下是主要内容第 3 节的完整 HTML 代码
...
<section class="container" id="section-3">
    <div id="row">
        ...
        <div id="column21">
            ...
            <p>
                The work requires understanding of Computer Science concepts. Candidates who are active on Practice Portal will be preferred.
            </p>

            <a href="https://www.geeksforgeeks.org/careers/" target="_blank" class="button">
                Apply Here
            </a>
        </div>
...
```css
/* Add fixed width for each column and align text to center */
#column21,
#column22,
#column23,
#column24 {
...
*   **对图像进行造型**:我们在栏目中为我们的图像增加了两个类，分别是 `image` 和 `image-full`。
