...
> 原文：[https://www.geeksforgeeks.org/how-to-send-data-of-html-form-directly-to-json-file/](https://www.geeksforgeeks.org/how-to-send-data-of-html-form-directly-to-json-file/)
    ...
    <div id="form_page">
        <div id="form_body">
            ...
            <div id="input_year" class="input">
                <input id="school" type="text" name="college" placeholder="College">
            </div>
            <div class="id input">
...
`gfg.php` 这个文件演示了 HTML 表单内容发布到的 PHP 代码。
