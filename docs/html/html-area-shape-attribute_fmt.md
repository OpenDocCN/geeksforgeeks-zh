...
**HTML 区域形状属性**与坐标属性一起用于描述 `<area>` 元素的大小、形状和位置。
...
![之前点击具体区域](https://media.geeksforgeeks.org/wp-content/uploads/20190227165729/area11.png)

**点击具体区域后:**

![点击具体区域后](https://media.geeksforgeeks.org/wp-content/uploads/20190227165802/area2.png)

## 支持的浏览器

**HTML 区域形状属性**支持的浏览器如下:
