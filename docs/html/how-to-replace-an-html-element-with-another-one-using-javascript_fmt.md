...
> 原文：[https://www.geeksforgeeks.org/how-to-replace-an-html-element-with-another-one-using-javascript/](https://www.geeksforgeeks.org/how-to-replace-an-html-element-with-another-one-using-javascript/)
...
*   **`appendChild()`：** 创建文本节点后，我们必须使用 `appendChild()` 方法将其附加到元素上。
    **语法：**
...
**`childNodes[位置]`：** 该属性返回一个作为节点列表对象的子节点集合。这些节点按照它们在源代码中出现的方式进行排序，并且可以通过从 0 开始的索引号进行访问。
