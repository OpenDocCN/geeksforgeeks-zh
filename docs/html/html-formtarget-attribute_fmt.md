...
**HTML 表单目标属性**用于指定名称或关键字，表示提交表单后在哪里显示结果。它指定提交的结果将在当前窗口、新选项卡或新框架中打开。该属性覆盖了 `<form>` 元素的目标属性特征。

**用途:** 用于 `<button>` 和 `<input type="submit">` 以及 `<input type="image">`
...
![输出示例](img/4f00b494157756f3db2fd8dfb06f8ed5.png)
