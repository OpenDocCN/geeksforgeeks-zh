...
> 原文: [https://www.geeksforgeeks.org/web-htmlcanvaselement-api-canvas-element-width-property/](https://www.geeksforgeeks.org/web-htmlcanvaselement-api-canvas-element-width-property/)

在网络应用编程接口中，有一个**画布元素**，它有一个宽度属性，以 CSS 像素表示画布的宽度。有一个 **HTMLCanvasElement.width** 属性，我们可以通过它从画布元素中获取这个 *width 属性*，它是一个*正*整数。
