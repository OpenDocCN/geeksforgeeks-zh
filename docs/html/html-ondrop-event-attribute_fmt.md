...
| **Ondrag**   | The Ondrag event is used to drag elements.                                      |
...
| 事件       | 功能                                                                 |
| ----------- | ----------------------------------------------------------------------------- |
| **反应物** | This event is used when the element is dragged and enters a valid drop target. |
| **波浪；** | When the dragged element is over the drop location, this event is used.        |
| **软骨上** | This event occurs when the dragged element leaves the drop target.              |
| **护套**   | This event occurs when the dragged element is placed on the drop target.       |
```
...
<img id="gfg" src="https://media.geeksforgeeks.org/wp-content/uploads/gg-4.png"
...
![拖动元素前](img/7d7d0dff0224ab572f046b6f1bfd0527.png)

**拖放元素后:**

![拖放元素后](img/80dbabf2b7003fe95fd9ef1c38e5b1c4.png)
