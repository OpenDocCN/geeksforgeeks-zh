...
**HTML 日期时间属性**用于指定插入和删除文本的日期和时间。它也代表了 `<时间>` 元素的日期和时间。
**语法:**
...
<time datetime="2017-02-14T20:00">scienceportal</time>
...
![Output Image](https://www.geeksforgeeks.org/wp-content/uploads/2020/07/f175da8ca93349622ebd980c4e9f908e.png)

**支持的浏览器:** 日期时间属性支持的浏览器如下:
