...
**TML** `<ins>` 中的 **datetime 属性**用于指定插入文本的日期和时间。日期时间以格式 YYYY-MM-DDThh:mm:ssTZD 插入。
**语法:**
...
**属性值:**该属性包含单个值 **YYYY-MM-DDThh:mm:ssTZD** ，用于指定文本被插入的日期和时间。
日期时间成分解释如下:
...
    <h2>
        HTML <ins>datetime</ins> Attribute
    </h2>
...
![Output Image](img/2114121fac831b2134e313a07a5d23d1.png)

**支持的浏览器:** HTML `<ins>` 日期时间属性支持的浏览器如下:
