...
> 原文: [https://www.geeksforgeeks.org/how-to-add-a-datepicker-in-form-using-html/](https://www.geeksforgeeks.org/how-to-add-a-datepicker-in-form-using-html/)
...
*   在输入元素中使用设置为`datetime-local`的`type`属性。
