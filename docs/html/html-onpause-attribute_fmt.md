...
**用法**: 此属性用于 `<audio>` 和 `<video>` 标签。

**属性值:** 该属性包含单值脚本，在事件属性调用时工作。该属性由 `<audio>` 和 `<video>` 标签支持。
...
![输出示例](img/542835a06b6daeaf63ae9d245e88d10a.png) ![输出示例](img/293efada1dd0777e13c9cfc7558ca347.png)
