...
> 原文：[https://www.geeksforgeeks.org/how-to-set-character-encoding-for-document-in-html5/](https://www.geeksforgeeks.org/how-to-set-character-encoding-for-document-in-html5/)
...
*   字符编码可以在 HTML 的 `meta` 标签中指定。
*   `meta` 标签用于指定关于网页的元数据，不会显示在网页中。
*   `meta` 标签帮助搜索引擎理解网页是关于什么的。
*   `meta` 标签应该和 `head` 标签放在一起。
