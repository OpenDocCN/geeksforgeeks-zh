...
> 原文: [https://www.geeksforgeeks.org/html-ondragenter-event-attribute/](https://www.geeksforgeeks.org/html-ondragenter-event-attribute/)
...
**属性值:** 该属性包含单值 `script`，在调用 `ondragenter` 事件属性时生效。
...
<!-- ondragenter event call here -->
            <p id = "geeks" ondragenter="dragenter_time()" draggable="true">
            Drag to know time
            </p>
        </center>
    </body>
...
**支持的浏览器:** 以下列出了 `ondragenter` 事件属性支持的浏览器:
