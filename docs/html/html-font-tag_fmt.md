...
> [HTML 字体标记](https://www.geeksforgeeks.org/html 字体标记/)
...
[**字体类型**](https://www.geeksforgeeks.org/html-font-face-attribute/) 字体类型可以在 HTML 文档中使用带有字体标签的人脸属性进行设置。但是用户使用的字体需要先安装在系统中。
