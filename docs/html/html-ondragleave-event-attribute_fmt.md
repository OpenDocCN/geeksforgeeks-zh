...
> 原文: [https://www.geeksforgeeks.org/html-ondragleave-event-attribute/](https://www.geeksforgeeks.org/html-ondragleave-event-attribute/)
...
**属性值:** 软骨事件属性包含单值 `script`，当软骨事件被调用时起作用。
**注意:** 图片和链接默认是可拖动的。
**例:**
...
**支持的浏览器:** `ondragleave` 事件属性支持的浏览器如下:
