...
**HTML usemap 属性**用于将图像/对象指定为图像地图。它与地图元素的名称或 id 属性相关，并在 **img** 和 **map** 元素之间创建关系。

**支持的标签:**

*   [img](https://www.geeksforgeeks.org/html-img-usemap-attribute/)
*   [object](https://www.geeksforgeeks.org/html-object-usemap-attribute/?ref=rp)
...
![Output Image](https://media.geeksforgeeks.org/wp-content/uploads/20190227165729/area11.png)
