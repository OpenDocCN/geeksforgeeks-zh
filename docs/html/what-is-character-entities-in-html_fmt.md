...
> 原文: [https://www.geeksforgeeks.org/什么是 html 中的字符实体/](https://www.geeksforgeeks.org/what-is-character-entities-in-html/)
...
<figure class="table">
| mark | Entity name | Entity number | Details |
| --- | --- | --- | --- |
| `&` | `&amp;` | `&#38;` | &的记号名称 |
| `<` | `&lt;` | `&#60;` | 不到 |
| `>` | `&gt;` | `&#62;` | 大于 |
...
![HTML Character entities output](img/64d6548748d3f92377e3f82ffeb55a4d.png)
