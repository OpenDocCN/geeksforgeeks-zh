...
> [HTML dfn 标签](https://www.geeksforgeeks.org/html-dfn-attribute/)

HTML 中的 `<dfn>` 标签表示定义元素，用于表示 HTML 中的定义实例。通常，定义实例是术语在文档中的第一次使用。`<dfn>` 标签需要一个开始标签和一个结束标签。
...
**示例 2:** 使用 `<dfn>` 标签的 [title 属性](https://www.geeksforgeeks.org/html-title-attribute/)。
...
**示例 3:** 在 `<dfn>` 元素中使用 [<缩写>标记](https://www.geeksforgeeks.org/html-abbr-tag/)的 [title 属性](https://www.geeksforgeeks.org/html-title-attribute/)。
