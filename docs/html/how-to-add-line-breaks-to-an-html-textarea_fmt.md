...
> 原文：[https://www.geeksforgeeks.org/how-to-add-line-breaks-to-an-html-textarea/](https://www.geeksforgeeks.org/how-to-add-line-breaks-to-an-html-textarea/)
...
**使用的函数：**
`split()`：是一个预定义的 JavaScript 函数，使用参数将字符串拆分为数组。
`join()`：是一个预定义的 JavaScript 函数，它连接一个数组，使用提供的参数将其转换为字符串。
