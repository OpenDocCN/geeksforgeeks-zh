...
> 原文: [https://www.geeksforgeeks.org/html5-game-development-infinitely-scrolling-background/](https://www.geeksforgeeks.org/html5-game-development-infinitely-scrolling-background/)
...
它是用 MS Paint 制成的。可以使用任何其他软件，如 Photoshop 或 Gimp。
