...
[**< head >**](https://www.geeksforgeeks.org/html-head-tag/#:~:text=The%20tag%20in%20HTML,head%3E%20element%20can%20be%20omitted.) **:** 头像标签包含一个网页的“幕后”元素。标题中的元素在网页前端不可见。<头部>元素内部使用的 HTML 元素包括:

*   [< style >](https://www.geeksforgeeks.org/html-style-tag/)
*   [< title >](https://www.geeksforgeeks.org/html-title-tag/)
*   [T2>基地](https://www.geeksforgeeks.org/html-base-tag/)
*   <【no script】>
*   [< script >](https://www.geeksforgeeks.org/html-script-tag/)
