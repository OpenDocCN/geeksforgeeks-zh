...
> 原文: [https://www.geeksforgeeks.org/html-input-formmethod-attribute/](https://www.geeksforgeeks.org/html-input-formmethod-attribute/)

**HTML `<input>` formmethod 属性**用于指定将表单数据发送到动作 URL 的 HTTP 方法。该属性用于覆盖 `<form>` 元素的方法属性。
