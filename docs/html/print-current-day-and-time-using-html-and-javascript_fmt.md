...
> 原文: [https://www.geeksforgeeks.org/print-current-day-and-time-using-html-and-javascript/](https://www.geeksforgeeks.org/print-current-day-and-time-using-html-and-javascript/)
...
**分钟**和**毫秒**分别使用 `getMinutes()` 和 `getMilliseconds()` 功能打印。
...
![Output Image](img/50540f5395d9c54a078bcd6c06e73ac1.png)
