...
> 原文: [https://www.geeksforgeeks.org/html5-mathml-rowlines-attribute/](https://www.geeksforgeeks.org/html5-mathml-rowlines-attribute/)

此属性保存行边框值，可以使用空格分隔多个值也可以考虑。可能的值是无、实线和虚线。该属性仅被 `<mtable>` 标签接受。
