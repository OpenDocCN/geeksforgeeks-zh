...
> 原文: [https://www.geeksforgeeks.org/html-oncontextmenu-event-attribute/](https://www.geeksforgeeks.org/html-oncontextmenu-event-attribute/)
...
**支持的浏览器:** oncontextmenu 属性支持的浏览器如下:
