...
> 原文: [https://www.geeksforgeeks.org/html5-mathml-rowspan-attribute/](https://www.geeksforgeeks.org/html5-mathml-rowspan-attribute/)

该属性保存单元格扩展多少行的值。该属性仅被 `<mtd>` 标签接受。
