...
> 原文: [https://www.geeksforgeeks.org/html-course-building-header-of-the-website/](https://www.geeksforgeeks.org/html-course-building-header-of-the-website/)
...
让我们再次看看我们的 `index.html` 文件中的标题代码的部分。代码的高亮部分显示了标题的图像菜单:
