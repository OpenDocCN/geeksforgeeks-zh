...
`alt` 属性用于提供一个替代文本，当主要的 `<img>`、`<area>` 或 `<input>` 标签无法显示其分配的值时，该文本将被显示。

**支持标签:**

*   [`<area>`](https://www.geeksforgeeks.org/html-area-alt-attribute/)
*   [`<img>`](https://www.geeksforgeeks.org/html-img-alt-attribute/)
*   [`<input>`](https://www.geeksforgeeks.org/html-input-alt-attribute/)

**属性值:** 包含一个值 **文本**，用于指定支持元素的替代文本，如果图像未显示。
...
<body style="text-align:center;">
    ...
    <input id="myImage" type="image" src="https://media.geeksforgeeks.org/wp-content/uploads/gfg-40.png" alt="Submit" width="48" height="48">
</body>
</html>
```
