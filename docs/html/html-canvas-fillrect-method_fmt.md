...
本示例使用 `fillRect()` 方法创建矩形并填充默认颜色（黑色）。
...
![示例 1 输出](img/6020bdbad5fd81c49602d5830c62b7a6.png)

## 示例 2

本示例使用 `fillRect()` 方法创建矩形，并用绿色填充。
...
![示例 2 输出](img/62442268bf9cac551bf443d802a01f93.png)
