...
> 原文: [https://www.geeksforgeeks.org/html5-mathml-mathsize-attribute/](https://www.geeksforgeeks.org/html5-mathml-mathsize-attribute/)

HTML5 中的 `MathML mathsize` 属性用于指定内容的大小。可能的值有小的、正常的、大的或自定义长度值。该属性被 `<mi>` 、 `<mn>` 、 `<mo>` 、 `<ms>` 和 `<mtext>` 标签接受。
...
![例 1 输出](img/7d01a5528e99ecc535b7dbaaa7558ce8.png)
...
![例 2 输出](img/f0509a62f5a1e4efdf5c399fb21d648f.png)
