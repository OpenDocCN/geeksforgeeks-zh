...
> 原文：[https://www.geeksforgeeks.org/create-a-table-of-content-in-tree-view-architecture-using-html-css-and-javascript/](https://www.geeksforgeeks.org/create-a-table-of-content-in-tree-view-architecture-using-html-css-and-javascript/)
...
在上一节中，我们已经创建了基本树形视图元素的结构。在本节中，我们将设计树形视图的结构。
...
这是合并上述部分后的最终代码。它将在树形视图架构中显示内容表。
