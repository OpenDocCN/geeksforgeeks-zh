...
> 原文: [https://www.geeksforgeeks.org/html-keygen-keytype-attribute/](https://www.geeksforgeeks.org/html-keygen-keytype-attribute/)

[**HTML<keygen>**](https://www.geeksforgeeks.org/html-keygen-tag/)**key type**属性用于定义将要使用的密钥类型。基本上，该属性用于保护表单数据。
...
![输出](img/ecb5934cebe7388bade3aa4839fa7cf6.png)
