...
`marker-mid`属性在给定形状的可标记元素的所有顶点（不包括第一个和最后一个顶点）绘制一个多标记或箭头。`marker-mid`属性仅对以下七个元素有影响，即`路径、折线、多边形、直线、圆、椭圆`和`矩形`。
...
![示例 1 输出](img/b1e2bfcdafdc8bc7adf24daf5c3d536e.png)
...
![示例 2 输出](img/8a7649f27e9cb0232ec9987cd6c75787.png)
