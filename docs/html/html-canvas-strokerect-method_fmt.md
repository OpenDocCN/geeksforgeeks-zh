...
> 原文: [https://www.geeksforgeeks.org/html-canvas-strokerect-method/](https://www.geeksforgeeks.org/html-canvas-strokerect-method/)

**strokeRect()方法**用于绘制给定颜色的矩形。笔画的默认颜色是黑色。
