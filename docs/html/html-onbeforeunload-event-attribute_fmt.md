...
> 原文: [https://www.geeksforgeeks.org/html-onbeforeunload-event-attribute/](https://www.geeksforgeeks.org/html-onbeforeunload-event-attribute/)
...
**属性值:** 该属性包含单值脚本，调用 onbeforeunload 事件时运行。<body> 标签支持该事件属性。
...
![输出示例](img/b5780c7f96124a0c347ce5f1447ffe67.png)

**支持的浏览器:** 支持onbeforeunload属性的浏览器如下:
