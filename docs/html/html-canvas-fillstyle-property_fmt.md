...
> 原文: [https://www.geeksforgeeks.org/html-canvas-fillstyle-property/](https://www.geeksforgeeks.org/html-canvas-fillstyle-property/)
...
        var x = document.getElementById("GFG");
        var contex = x.getContext("2d");
        var gr = contex.createLinearGradient(0, 100, 0, 200);
        gr.addColorStop(0, "green");
