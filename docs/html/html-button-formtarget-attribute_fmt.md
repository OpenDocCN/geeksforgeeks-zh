...
> 原文: [https://www.geeksforgeeks.org/html-button-formtarget-attribute/](https://www.geeksforgeeks.org/html-button-formtarget-attribute/)

**HTML 按钮表单目标属性**用于指定提交的结果将在**当前窗口、新选项卡还是新框架中打开**。该属性覆盖<形态>目标属性的特征。只能和按钮一起使用。
...
![Output Image](img/7479b20f60857c6ef9f73b4a51db45d1.png)
