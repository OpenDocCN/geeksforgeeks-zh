...
> 原文：[https://www.geeksforgeeks.org/how-to-define-a-possible-line-break-using-html5/](https://www.geeksforgeeks.org/how-to-define-a-possible-line-break-using-html5/)

在本文中，我们通过使用 `<wbr>` 元素来定义 HTML 中可能的换行符。它代表断字机会，用于定义文本中被浏览器视为换行符的位置。当使用的单词太长，浏览器可能会在不适合文本的地方换行时，通常会用到它。
