...
> 原文：[https://www.geeksforgeeks.org/how-to-specify-the-coordinates-of-an-area-in-html5/](https://www.geeksforgeeks.org/how-to-specify-the-coordinates-of-an-area-in-html5/)

在本文中，我们将看到如何在 HTML5 中设置元素的坐标。`<area>`的[`coords`](https://www.geeksforgeeks.org/html-coords-attribute/)属性用于指定影像地图中某个区域的坐标。`shape`属性用于指定区域的大小、形状和位置。坐标`(0,0)`表示草图的左上角。
...
在此示例中，用形状参数和坐标指定了三个形状区域，以便可以单击它们来查看形状。
