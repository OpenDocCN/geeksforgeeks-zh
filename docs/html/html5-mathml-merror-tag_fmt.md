...
# HTML5 MathML `<merror>` 标签

> 原文: [https://www.geeksforgeeks.org/html5-mathml-merror-tag/](https://www.geeksforgeeks.org/html5-mathml-merror-tag/)

**HTML5 MathML `<merror>` 标签** 是 HTML5 中的一个内置元素，用于将表达式包装在一个框中，使其引人注目。该标签用于显示错误信息。通常，当您的 MathML 标记出错或发生任何类型的错误时，它不会单独弹出，您会得到一个 XML 解析。
...
<p>
        This tag is used to display the error in any expression
    </p>
...
![Output Image](img/bac207b5384b815e1eb884c9f4535dd0.png)
