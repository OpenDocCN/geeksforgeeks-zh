...
> 原文：[https://www.geeksforgeeks.org/how-to-design-runtime-generated-pdf-via-html/](https://www.geeksforgeeks.org/how-to-design-runtime-generated-pdf-via-html/)
    ...
    <div class="container">
        ...
        <div class="card" id="makepdf">
            ...
            <ul>
                ...
                <li>
                    <h4>This is an example of generating pdf from HTML during runtime</h4>
                </li>
            </ul>
        </div>
    </div>
...
*   在 HTML 文档的 `<head>` 标签中包含 jsPDF CDN。CDN 如下，在谷歌搜索‘jsPDF CDN’获取最新版本。
*   使用 `fromHTML()` 方法从 HTML div 生成一个 pdf。
