...
> 原文：[https://www.geeksforgeeks.org/how-to-create-scroll-indicator-using-html-css-and-javascript/](https://www.geeksforgeeks.org/how-to-create-scroll-indicator-using-html-css-and-javascript/)
...
<body>
    <!--The scroll indicator line at the top of page-->
    <div class="line" id="scrollIndicator"></div>
    <!--Content to fill the page to enable scrolling-->
    <div class="text">
...
<style>
    ...
    /* Formatting text to fill the page */
    .text {
        font-size: 80px;
        color: green;
        text-align: center;
...
<script>
    ...
    // Height of entire web page - height of viewable portion of browser
    const maxHeight = window.document.body.scrollHeight - window.innerHeight;

    function moveScrollIndicator(e) {
        // Calculating width of the scrollIndicator element
        const percentage = ((window.scrollY) / maxHeight) * 100;
        // Pixels scrolled by the user to total scrollable Pixels
