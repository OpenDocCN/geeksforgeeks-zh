...
> 原文: [https://www.geeksforgeeks.org/design-an-event-webpage-using-html-css/](https://www.geeksforgeeks.org/design-an-event-webpage-using-html-css/)
...
<head>
    <style>
        ...
        section {
            width: 100%;
            height: 100vh;
            background: url('https://media.geeksforgeeks.org/wp-content/uploads/20210408155049/gfg9.png');
        ...
        /* Styling the background of left floatig section */
        ...
        /* Styling the hover effect of left floatig section */
        ...
        /* Styling the links of the events section */
        section .events ul {
            position: absolute;
            top: 50%;
        ...
        /* Styling the texts of time class of events section */
        ...
        /* Styling the lists of details class of events section */
