...
*   **<!DOCTYPE html> :** 定义文档的类型。这里它定义了文档类型是 html。
*   **<html></html>:** 它是根元素，所有其他标签都包含在其中。它决定了 HTML 文档的开始和结束。
*   **<head></head> :** 它包含了 HTML 文档的元数据&实际上并没有显示在网页上。标题以<头>开始，以</头>结束。
*   **<title></title> :** 用于创建文档的标题，标题出现在顶部的标题栏中。每个文档中至少出现一个标题。文档的标题部分以<标题>开始，以</标题>结束，在两者之间，输入您想要作为标题的文本。
*   **<body></body> :** 包含要在网页上显示的文档内容。内容可以是图像、一些文本、一些链接等。这部分代表 web 文档的主体，通常包括标题、文本和段落。
*   **<p> :** 用于定义段落。
*   **<br> :** 用于单行断线。
*   **<img> :** 用于定义给定来源的图像。
*   **<sup> :** 用于定义上标数据。
...
        <img src = "https://media.geeksforgeeks.org/wp-content/cdn-uploads/gfg_200x200-min.png" width = "200" height = "100">
...
![HTML Output](img/43f85fb3df60ee9393080f411022868a.png)
...
![HTML Code](img/90c0435756af32cda4a8f66a8c66282b.png)

**第三步:**点击文件(顶部)选择另存为，保存文档。

![Save HTML](img/5009a6b1ac2536f911546eb6d48eddad.png)

**第四步:**选择要保存 HTML 文档的目的地，给文档命名，使用扩展名 ***.html*** 示例:Geeks.html

![Save HTML File](img/7d5822f1a4bd79f4e9bdacd316672973.png)
...
![Browser Window](img/f5469e536b05984821b5c4cf139d8e46.png)
