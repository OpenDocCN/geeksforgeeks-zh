...
> 原文：[https://www.geeksforgeeks.org/how-to-create-non-rectangular-header-using-html-css/](https://www.geeksforgeeks.org/how-to-create-non-rectangular-header-using-html-css/)
...
以下代码添加在 `style.css` 文件中，用于 HTML 代码中。CSS 用于给 HTML 页面提供不同类型的动画和效果，以便所有用户都可以交互。

*   恢复所有浏览器效果。
*   使用类和 id 给 HTML 元素赋予效果。
*   使用 CSS `clip-path()` 功能为标题赋予特定的形状。
