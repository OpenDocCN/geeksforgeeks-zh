...
> 原文：[https://www.geeksforgeeks.org/different-ways-to-apply-colors-in-an-html-document/](https://www.geeksforgeeks.org/different-ways-to-apply-colors-in-an-html-document/)
...
*   `Color`：用于设置文本的颜色。
*   `Background color`：用于设置网页、特定块或元素的背景颜色。

## 例子 1

我们可以用 [`文字`](https://www.geeksforgeeks.org/html-body-text-attribute/) 属性设置文字的颜色，用 [`BG-color`](https://www.geeksforgeeks.org/html-bgcolor-attribute/) 设置背景颜色。
