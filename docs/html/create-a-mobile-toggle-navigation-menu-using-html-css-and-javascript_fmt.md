...
> 原文：[https://www.geeksforgeeks.org/create-a-mobile-toggle-navigation-menu-using-html-css-and-javascript/](https://www.geeksforgeeks.org/create-a-mobile-toggle-navigation-menu-using-html-css-and-javascript/)
...
在本节中，我们将创建一个基本的站点结构，并为将用作菜单图标的图标附加字体-Awesome 的 CDN 链接。
...
在上一节中，我们已经创建了基本网站的结构，我们将在其中使用菜单图标。在本节中，我们将设计导航栏的结构。
...
## 合并 HTML、CSS 和 JavaScript 代码

这是合并上述部分后的最终代码。它将移动导航动画菜单。
