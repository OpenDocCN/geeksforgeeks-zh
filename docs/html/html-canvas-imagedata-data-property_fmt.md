...
> 原文: [https://www.geeksforgeeks.org/html-canvas-imagedata-data-property/](https://www.geeksforgeeks.org/html-canvas-imagedata-data-property/)

**ImageData data** 属性用于返回包含指定 ImageData 对象的图像数据的对象。图像数据对象中的每个像素包含四条信息，即 RGBA 值:
