...
> 原文：[https://www.geeksforgeeks.org/how-to-create-an-image-overlay-icon-using-html-and-css/](https://www.geeksforgeeks.org/how-to-create-an-image-overlay-icon-using-html-and-css/)
...
在本节中，我们将创建一个基本结构，并为将在悬停时用作图标的图标附加 Font Awesome 的 CDN 链接。

### Font Awesome 图标的 CDN 链接
...
在上一节中，我们已经创建了基本网站的结构，我们将在其中用作图像叠加图标。在本节中，我们将设计图像覆盖图标的结构。
