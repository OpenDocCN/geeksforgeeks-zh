...
> 原文: [https://www.geeksforgeeks.org/html-option-disabled-attribute/](https://www.geeksforgeeks.org/html-option-disabled-attribute/)

HTML 中 `<option>` 元素的 **禁用** 属性用于指定选项值被禁用。禁用的选项不可点击且不可用。它是一个布尔属性。
