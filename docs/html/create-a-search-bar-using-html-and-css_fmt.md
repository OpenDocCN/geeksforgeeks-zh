...
> 原文：[https://www.geeksforgeeks.org/create-a-search-bar-using-html-and-css/](https://www.geeksforgeeks.org/create-a-search-bar-using-html-and-css/)
...
在这一部分，我们将只创建基本的网站结构，并为图标附加字体的 CDN 链接，这些图标将用作栏中的搜索图标。
