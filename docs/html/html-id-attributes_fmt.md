...
![示例输出](img/82ffd030d68274f0f1c582a18108bd97.png)
...
![示例输出](img/886c33b86857b8be9d6dd3fe76a98d36.png)

**注意:** 在 HTML5 中，id 属性可以被任何 HTML 标签使用，但是在 HTML 4.01 中使用 id 属性有一些限制。不能被 `<base>`, `<head>`, `<html>`, `<meta>`, `<param>`, `<script>`, `<style>`, `<title>` 标签使用。在 HTML4.01 中，id 不能以数字开头。
...
![示例输出](img/4b3554dffc1526777e9d098f4bdc57c0.png)
