...
当在元素上按下鼠标按钮，并且与 onmousedown 事件相关的事件发生顺序（对于左/鼠标按钮）时，将触发此 onmousedown 属性。
...
<body>
    <h1>GeeksforGeeks</h1>
    <h2>onmousedown 属性</h2>
    <p id="gfg" onmousedown="mouseDown()" onmouseup="Geeks()">
        <b>GeeksforGeeks:</b> A computer science portal for Geeks. It is best website for learning<br>
        computer science.
    </p>
