...
![确定图像大小](img/3753a770239201f7d0dbe4f07505528c.png)

### 创建叠加图像的地图:

![创建叠加图像的地图](img/d1f598fc53b32a94643755021721cde3.png)

### 确定要映射区域的坐标:

可以做矩形、圆形、多边形三种形状。使用 MS-Paint 可以很容易地找到坐标。
![确定要映射区域的坐标](img/109e8f5c48934ddf3c5ca2c8edea3a13.png)
...
影像来源: [https://www.pixabay.com/photo/2013/07/12/16/57/world-map-151576_960_720.png](https://www.pixabay.com/photo/2013/07/12/16/57/world-map-151576_960_720.png)
