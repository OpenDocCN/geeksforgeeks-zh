...
> 原文: [https://www.geeksforgeeks.org/html-optgroup-disabled-attribute/](https://www.geeksforgeeks.org/html-optgroup-disabled-attribute/)

HTML 中 `<optgroup>` 元素的 **禁用** 属性用于指定选项组被禁用。禁用的 `optgroup` 不可点击且不可用。它是一个布尔属性。
