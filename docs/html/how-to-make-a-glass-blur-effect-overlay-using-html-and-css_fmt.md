...
> 原文：[https://www.geeksforgeeks.org/how-to-make-a-glass-blur-effect-overlay-using-html-and-css/](https://www.geeksforgeeks.org/how-to-make-a-glass-blur-effect-overlay-using-html-and-css/)

为了在叠加上产生背景模糊效果，`filter: blur()` 属性与 `::before` 伪元素一起使用。`filter: blur()` 属性在框或任何需要的元素上产生模糊效果，`::before` 用于添加模糊的背景，而不应用任何额外的标记。
