...
> 原文: [https://www.geeksforgeeks.org/html-onbeforeprint-event-attribute/](https://www.geeksforgeeks.org/html-onbeforeprint-event-attribute/)
...
**属性值:** 该属性包含单属性值脚本，在文档即将打印时生效。<body>标签支持该属性。
...
![输出示例](img/1508c42bd537ddbf3f0b51c18bbaf16b.png)
