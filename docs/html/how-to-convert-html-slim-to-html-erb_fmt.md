...
> 原文：[https://www.geeksforgeeks.org/how-to-convert-html-slim-to-html-erb/](https://www.geeksforgeeks.org/how-to-convert-html-slim-to-html-erb/)
...
`slimrb` 是一个命令行工具，意味着 convert 和 `--erb` 表示文件将被转换为 erb 格式。然后按照命令给出瘦文件名 `<slim file name>`。
