...
HTML 中的 `<time>` 日期时间属性用于定义 `<time>` 元素的机器可读日期/时间。日期时间以 `YYYY-MM-DDThh:mm:ssTZD` 格式插入。
**语法:**
...
![输出示例](img/605c276efafdd2cf157e2d8e1cc22631.png)

**支持的浏览器:** HTML `<time>` 日期时间属性支持的浏览器如下:
