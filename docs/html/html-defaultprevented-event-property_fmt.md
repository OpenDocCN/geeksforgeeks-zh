...
> 原文: [https://www.geeksforgeeks.org/html-defaultprevented-event-property/](https://www.geeksforgeeks.org/html-defaultprevented-event-property/)
    ...
    <script>
        document.getElementById("mylink").addEventListener(
            "click", function(event) {
                ...
                alert("Is preventDefault() called : " + event.defaultPrevented);
            });
    </script>
...
**输出:**
**点击按钮前:**
![点击按钮前](img/d4ecef4c4ad151fb9703321042c3333d.png)

**点击按钮后:**
![点击按钮后](img/3f5ab4365470a25761baf275e84bbb54.png)
