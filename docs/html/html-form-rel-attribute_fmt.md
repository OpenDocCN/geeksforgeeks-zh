...
HTML `<form>` rel 属性用于定义当前文档和链接文档之间的关系。"rel" 代表关系。它表示，我们将外部 CSS 与 HTML 页面连接起来。
...
![Example 1 Output](img/2d3e9eea303246c5e7a762d25b718c75.png)
...
![Example 2 Output](img/70b047ba5ae2269d73d197f2acc8ae24.png)
