...
> 原文：[https://www.geeksforgeeks.org/how-to-set-bullet-colors-in-html-lists-using-only-css/](https://www.geeksforgeeks.org/how-to-set-bullet-colors-in-html-lists-using-only-css/)
...
首先，CSS 中没有直接的方法可以改变无序列表中项目符号的颜色。但是，要使用 CSS 更改无序列表中项目符号的颜色，我们必须首先放弃默认的列表样式，并手动定义列表中每个列表项之前的 `::before` 中的内容。
