...
*   **left:** 它将 `<iframe>` 的对齐方式设置为左侧。
*   **right:** 它将 `<iframe>` 的对齐方式设置为右侧。
*   **middle:** 它将 `<iframe>` 的对齐方式设置为中间。
*   **top:** 它将 `<iframe>` 的对齐方式设置为顶部。
*   **bottom:** 设置 `<iframe>` 与底部的对齐方式。
...
<iframe align="left" src="https://ide.geeksforgeeks.org/index.php" 
...
<iframe align="right" src="https://ide.geeksforgeeks.org/index.php" 
        height="200" width="250">
    </iframe>
</body>
...
![输出示例](img/f5d5a3d9b6ee987ec06a8f4ae71ef80d.png)
