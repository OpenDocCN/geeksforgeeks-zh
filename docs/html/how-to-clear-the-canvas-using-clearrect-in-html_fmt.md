...
> 原文：[https://www.geeksforgeeks.org/how-to-clear-the-canvas-using-clearrect-in-html/](https://www.geeksforgeeks.org/how-to-clear-the-canvas-using-clearrect-in-html/)

画布 2D API 的 `clearRect()` 方法，用于通过将像素颜色设置为透明黑色（`rgba(0, 0, 0, 0)`）来擦除矩形区域中的像素。
...
在以下示例中，`clearRect()` 方法用于从 (50, 20) 中清除大小为 (200×300) 的矩形的像素。
...
**参考：** [https://www.geeksforgeeks.org/html-canvas-clearrect-method/](https://www.geeksforgeeks.org/html-canvas-clearrect-method/)