...
![Output Image](https://media.geeksforgeeks.org/wp-content/uploads/20200402161021/rowspan-html.png)

**支持的浏览器:** `<th>` 行跨属性的 **HTML 支持的浏览器如下:**
