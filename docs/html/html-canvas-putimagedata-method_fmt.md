...
> 原文: [https://www.geeksforgeeks.org/html-canvas-putimagedata-method/](https://www.geeksforgeeks.org/html-canvas-putimagedata-method/)
...
*   **dirtyHeight:** 是用来在画布上绘制图像的高度。它也是可选的。
