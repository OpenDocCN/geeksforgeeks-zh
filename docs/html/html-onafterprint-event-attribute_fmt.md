...
> 原文: [https://www.geeksforgeeks.org/html-onafterprint-event-attribute/](https://www.geeksforgeeks.org/html-onafterprint-event-attribute/)
...
**属性值:** 该属性包含单值脚本，在调用 `onafterprint` 事件属性时工作。该属性与 `<body>` 标签相关联。
...
![输出示例](img/32f84c871818a37e46277cda5471de5c.png)
