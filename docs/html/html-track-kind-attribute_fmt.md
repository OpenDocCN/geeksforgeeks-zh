...
**HTML `<track>` 种类属性**用于指定视频和音频文件的轨道种类。如果听众或观众是聋子，这是非常有用的。
...
![输出示例](img/52613f4ef3bbacb7d51c1956b1fed90e.png)

**例 2:** 本例用音频元素说明了 `<track>` 类属性的使用。
...
![输出示例](img/79df2d05814237b5050afed0f5e1e6ed.png)

**支持的浏览器:**HTML `<track>` 种类属性支持的浏览器如下:
