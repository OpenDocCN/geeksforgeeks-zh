...
![HTML table bgcolor Attribute](img/7b33fcdf86cb1c6fea9ab295bb20056a.png)
...
![HTML body Bgcolor Attribute](img/1c38dea082d1f6901aa075092e4d39db.png)

**注意:** HTML 5 不支持 `bgcolor` 属性。
**支持的浏览器:** `bgcolor` 属性支持的浏览器如下:
