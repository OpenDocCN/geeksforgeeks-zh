...
> 原文: [https://www.geeksforgeeks.org/html-window-pagexoffset-property/](https://www.geeksforgeeks.org/html-window-pagexoffset-property/)
...
**支持的浏览器:** Window pageXOffset 属性支持的浏览器如下:
