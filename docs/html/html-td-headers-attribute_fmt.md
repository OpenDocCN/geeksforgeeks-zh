...
**Attribute Values:** It contains the value i.e. **header_id** which specifies the space-separated list of ids to one or more Header cells that the table data cell is related to.
