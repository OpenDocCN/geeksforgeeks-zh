...
> 原文: [https://www.geeksforgeeks.org/html-navigator-javaenabled-method/](https://www.geeksforgeeks.org/html-navigator-javaenabled-method/)
...
**支持的浏览器:** navigator.javaEnabled() 支持的浏览器如下:
