...
> 原文: [https://www.geeksforgeeks.org/html-canvas-shadowoffsety-property/](https://www.geeksforgeeks.org/html-canvas-shadowoffsety-property/)

**画布阴影偏移属性**用于**设置**或**返回**阴影与形状的垂直距离。
