...
> 原文：[https://www.geeksforgeeks.org/how-to-customize-a-select-html-form-element-with-css3/](https://www.geeksforgeeks.org/how-to-customize-a-select-html-form-element-with-css3/)

使用 HTML 中的 [`<select>`](https://www.geeksforgeeks.org/html-select-tag/) 标签创建下拉列表。 [`<select>`](https://www.geeksforgeeks.org/html-select-tag/) 标签包含 [`<option>`](https://www.geeksforgeeks.org/html-option-tag/) 标签以显示可用选项的下拉列表。在本文中，您将学习到许多用 CSS 3 自定义 [`<select>`](https://www.geeksforgeeks.org/html-select-tag/) HTML 表单元素的方法。

### 注意
表单中使用 [`<select>`](https://www.geeksforgeeks.org/html-select-tag/) 标签接收用户响应。
