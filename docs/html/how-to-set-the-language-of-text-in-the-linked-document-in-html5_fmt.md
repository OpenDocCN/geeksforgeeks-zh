...
> 原文：[https://www.geeksforgeeks.org/how-to-set-the-language-of-text-in-the-linked-document-in-html5/](https://www.geeksforgeeks.org/how-to-set-the-language-of-text-in-the-linked-document-in-html5/)
...
下面的代码说明了 `hreflang` 属性在 `link` 元素中的使用。
