...
**输出:**在本例中，`<html>` 标签包含 `<head>` 和 `<body>`。《head>` 和 `<body>` 标签包含另一个元素，因此称为嵌套元素。
...
<body>
<!-- h1 tag does not contain end tag -->
<h1>GeeksforGeeks</h1>
<!-- p tag does not contain end tag -->
<p>Computer science portal</p>
</body>
</html>
```
...
对于 Ex. `<br>`, `<link>`, `<input>` 等，都是 HTML 元素。
