...
> 原文:[https://www . geesforgeks . org/design-an-about-us-page-use-html-and-CSS/](https://www.geeksforgeeks.org/design-an-about-us-page-using-html-and-css/)

对于不懂 HTML 和 CSS 的人来说，创建一个有吸引力的页面似乎很难。如果有人不知道使用 CSS，那么他们将无法使页面看起来更好或更有吸引力。因此，本文的重点将放在 CSS 的实现上。

**创建结构**:在这一节中，我们将使用一些标签来创建网页的简单结构，如< li >和<部分>。因此，它将帮助我们创建一个简单的网页，我们可以通过运行以下代码进行检查:
