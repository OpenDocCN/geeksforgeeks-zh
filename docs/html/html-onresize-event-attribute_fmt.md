...
> 原文: [https://www.geeksforgeeks.org/html-onresize-event-attribute/](https://www.geeksforgeeks.org/html-onresize-event-attribute/)
...
**属性值:** 该属性包含单个值 `script`，在请求事件调用时有效。
**注意:** 这个属性和 `<body>` 标签配合使用。
**例:**
