...
> 原文: [https://www.geeksforgeeks.org/html-img-cross-origin-attribute/](https://www.geeksforgeeks.org/html-img-cross-origin-attribute/)

**HTML 交叉源属性用于支持 CORS 请求的 `<img>` 元素，用于加载来自第三方服务器或其他域的 png 或 jpg 文件。**
...
**示例:** 下面的代码说明了 `<img>` 元素中交叉原点属性的使用。它被设置为“匿名”值，该值检索 png 或 jpg 文件而不传递凭据信息。
...
![GeeksforGeeks logo](img/b30653a32422df57d3fabf4874f64f0f.png)
