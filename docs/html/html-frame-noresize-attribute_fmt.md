...
> 原文: [https://www.geeksforgeeks.org/html-frame-noresize-attribute/](https://www.geeksforgeeks.org/html-frame-noresize-attribute/)

**HTML `<frame>` noresize 属性**用于指定用户不能调整框架元素的大小。这种类型的属性用于查看框架元素的大小。
...
**支持的浏览器:** HTML `<frame>` 无大小属性支持的浏览器如下:
