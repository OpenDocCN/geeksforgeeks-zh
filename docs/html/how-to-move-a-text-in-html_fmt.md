...
在本文中，我们将学习如何使用 HTML [`<marquee>`](https://www.geeksforgeeks.org/html-marquee-tag/) 标签在您的网站上创建移动内容。HTML 中的`<marquee>`标签用于在网页中创建滚动文本或图像。它可以水平地从左向右或从右向左滚动，也可以垂直地从上到下或从下到上滚动。
