...
> 原文：[https://www.geeksforgeeks.org/how-to-specify-that-the-user-is-required-to-select-a-value-before-submitting-the-form-in-html5/](https://www.geeksforgeeks.org/how-to-specify-that-the-user-is-required-to-select-a-value-before-submitting-the-form-in-html5/)

本文的目的是指定要求用户在 HTML5 中提交表单之前选择一个值。这将迫使用户在提交表单之前输入一个值。

`<select>` 的 [`required`](https://www.geeksforgeeks.org/html-select-required-attribute/) 属性可用于此目的。这是一个布尔属性，表示在提交表单之前必须填写输入字段。`required` 属性支持文本、网址、电话、电子邮件、密码、日期选择器、号码、复选框、广播和文件。
