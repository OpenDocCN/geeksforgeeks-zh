...
> 原文：[https://www.geeksforgeeks.org/how-to-get-the-title-of-an-html-page/](https://www.geeksforgeeks.org/how-to-get-the-title-of-an-html-page/)

任务是使用 JavaScript 获取 HTML 文档的标题。有许多方法可以做到这一点，但这里讨论一些最优选的技术。

## 示例 1

本示例使用 `document.title` 属性获取文档的标题。
...
本示例通过首先按标签名称选择标题，然后取索引 0 处的元素来获取文档的标题。使用 `document.getElementsByTagName()` 方法。
