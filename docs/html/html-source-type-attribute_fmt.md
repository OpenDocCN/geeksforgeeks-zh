...
**HTML `<source>` 类型属性**用于指定媒体资源的 MIME 类型。
**语法:**
...
![输出示例](img/7f5749a42c77a72c6c0b9e4eff29fc40.png)

**例 2:** 本例用视频文件说明 `<source>` 类型属性。
...
![输出示例](img/9bfb07705e80b2105eb7877ec85ae33d.png)
