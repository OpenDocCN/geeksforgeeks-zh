...
`<data>`元素通过机器可读的翻译器给出给定内容的地址。这个元素为处理器提供了一个机器可读的值，并在浏览器中提供了一个人类可读的值。
...
**注意:** 如果内容是日期或时间相关的内容，则使用`<time>`元素代替数据元素。
...
![Output Image](img/99040ae0945cfc5f0724a813a6846edf.png)
