...
> 原文：[https://www.geeksforgeeks.org/how-to-create-right-aligned-menu-links-using-html-and-css/](https://www.geeksforgeeks.org/how-to-create-right-aligned-menu-links-using-html-and-css/)
...
在本节中，我们将创建一个基本的网站结构，以创建一个右对齐的菜单链接。
...
在上一节中，我们已经创建了基础网站的结构。在本节中，我们将设计导航栏的结构。
...
这是合并以上两部分后的最终代码。您可以看到主页、职业和我们的产品默认左对齐，但关于我们和联系我们右对齐。
