...
> 原文: [https://www.geeksforgeeks.org/html-canvas-getimagedata-method/](https://www.geeksforgeeks.org/html-canvas-getimagedata-method/)

**getImageData()方法**用于在画布上复制指定矩形的像素数据。图像数据对象中每个像素有 4 条信息，即 RGBA 值:
...
    <canvas id="gfgCanvas" width="300" height="300" style="border:1px solid;"></canvas>
