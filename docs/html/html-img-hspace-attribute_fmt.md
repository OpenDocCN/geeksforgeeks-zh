...
**HTML `<img>` hspace 属性**用于指定图像左右两侧的空格数。HTML 5 不支持 hspace 属性，你可以在那里使用 CSS。
...
**输出:**
![Image without hspace](https://media.geeksforgeeks.org/wp-content/uploads/gfg-40.png)
![Image with hspace](https://media.geeksforgeeks.org/wp-content/uploads/gfg-40.png)
