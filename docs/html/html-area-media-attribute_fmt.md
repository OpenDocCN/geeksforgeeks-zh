...
HTML 区域媒体属性用于指定目标网址优化的媒体或设备。该属性指定样式是用于特定设备，如打印媒体或语音。这个属性可以接受几个值。仅当 `href` 属性存在时使用。这个属性纯粹是咨询的。
...
| Braille feedback device | Braille feedback device |
| hand-hold | Handheld device (small limited bandwidth) |
| project | projector |
| print | Print preview mode/print page |
| Computer screen | Computer screen |
| Teletypewriters and similar media use fixed-pitch character grids. | Teletypewriters and similar media use fixed-pitch character grids. |
| TV | TV |
</figure>
...
![点击特定可点击区域前](img/43fc281477b709ed24a267c98b27fa79.png)

![点击具体可点击区域后](img/395068ac4e1b69d69d916d82cccbede9.png)
