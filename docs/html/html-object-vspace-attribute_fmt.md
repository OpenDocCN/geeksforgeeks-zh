...
**HTML `<object>` vspace 属性**用于指定对象底部和顶部的空白数量。
**语法:**
...
**注意:**HTML 5 中不支持 `<object>` vspace 属性。使用 CSS 边距属性而不是该属性。
以下示例说明了 HTML 中的 `<object>` vspace 属性:
...
![示例 1 输出](img/fc5992f4cc1f23ac99055e45bf780e52.png)
...
![示例 2 输出](img/21a91d18e88fcdd5122352b96acc510a.png)

**支持的浏览器:** `<object>` vspace 属性支持的浏览器如下:
