...
> 原文: [https://www.geeksforgeeks.org/how-to-create-a-working-slider-using-html-and-css/](https://www.geeksforgeeks.org/how-to-create-a-working-slider-using-html-and-css/)
...
**第二部分:** 该部分包括所有用于制作幻灯片的样式。用于移动每张幻灯片的动画是通过设置每张幻灯片所需的 `margin-left` 属性来定义的。这使它看起来像是在每张幻灯片之间平滑过渡。
