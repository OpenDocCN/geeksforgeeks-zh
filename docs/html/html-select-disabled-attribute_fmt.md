...
> 原文: [https://www.geeksforgeeks.org/html-select-disabled-attribute/](https://www.geeksforgeeks.org/html-select-disabled-attribute/)

在 HTML 中，`<select>` 元素的 `disabled` 属性用于指定选择元素被禁用。禁用的下拉列表不可点击且不可用。它是一个布尔属性。
