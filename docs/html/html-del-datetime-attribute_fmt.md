...
HTML 中的 `<del>` 标签的 `datetime` 属性用于指定被删除文本的日期和时间。日期时间以 **YYYY-MM-DDThh:mm:ssTZD** 格式插入。
**语法:**
...
![输出示例](img/7b02b26fe82dcd9682f50c84a1a59bf4.png)

**支持的浏览器:** HTML `<del> dateTime` 属性支持的浏览器如下:
