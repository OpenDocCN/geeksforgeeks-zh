...
> 原文：[https://www.geeksforgeeks.org/how-to-apply-amazing-hover-effect-over-button-using-html-and-css/](https://www.geeksforgeeks.org/how-to-apply-amazing-hover-effect-over-button-using-html-and-css/)
...
**第一步：** 首先，我们将使用 `HTML` 的 `button` 标签设计一个简单的按钮结构。注释已经在代码中，以供您参考。
