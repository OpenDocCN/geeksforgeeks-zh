...
该策略用于将资源识别为非关键资源，并且只有在需要时才会加载资源。换句话说，只要网页内容不是必需的，惰性加载就会推迟网页内容的加载。这项技术有助于优化页面并允许它们以后加载。通常，网页上的图像尺寸很大。为此，延迟加载对于延迟屏幕外的图像非常有用。请参考[什么是懒装？](https://www.geeksforgeeks.org/what-is-lazy-loading/)条。
...
*   **急切:** 图像对应的它将加载没有任何延迟，即立即加载资源，而不管它在页面上的位置。
...
<body>
  ...
  <img src="https://media.geeksforgeeks.org/wp-content/uploads/20210816073836/gfg1.png"
      loading="lazy"
      alt="gfg"/>

  <!-- More images with loading="lazy" attribute -->
...
<body>
  ...
  <!-- More images with loading="auto" attribute -->
  ...
  <!-- More images with loading="eager" attribute -->
