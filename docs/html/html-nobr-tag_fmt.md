...
**< nobr >** 标记用于创建单行文本，不管语句有多长，这个标记与 [**< wbr >**](https://www.geeksforgeeks.org/html-5-wbr-tag/) 标记一起使用。创建的单行语句使水平滚动阅读整行。 **< nobr >** 标签与 [< br >](https://www.geeksforgeeks.org/html-br-tag/) 标签完全相反。您可以使用 CSS 空白属性来替换这个标记。
...
        formatting style, coding style, and try to make your close 
        to them.
        </nobr>
    </center>
</body>
