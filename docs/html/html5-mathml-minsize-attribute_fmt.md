...
> 原文: [https://www.geeksforgeeks.org/html5-mathml-minsize-attribute/](https://www.geeksforgeeks.org/html5-mathml-minsize-attribute/)
...
**支持的浏览器:** HTML5 MathML *minsize* 属性支持的浏览器如下:
