...
> 原文: [https://www.geeksforgeeks.org/html-autocapitalize-attribute/](https://www.geeksforgeeks.org/html-autocapitalize-attribute/)
...
**示例:** 在 HTML 代码下面，使用带有 `<input>` 标签的自动大写属性。
...
![输出示例](img/3857b4c5d35354117970b7ab555cdbb7.png)
