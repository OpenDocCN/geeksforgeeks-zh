...
> [HTML basefont 标签](https://www.geeksforgeeks.org/html-basefont-attribute/)
...
![输出示例](img/c058028a8eb2a9107b7dbdc1a195172b.png)

`<basefont>` 标签用于设置浏览器中所有文本的默认文本颜色、字体大小、字体系列。HTML5 不再支持此标签。因此，作为替代，我们在代码示例中使用了 CSS。互联网浏览器 9 和早期版本支持 `<basefont>` 标签。
...
![输出示例](img/7ce8421ec47552f9b3f66a087f6ad7f8.png)
