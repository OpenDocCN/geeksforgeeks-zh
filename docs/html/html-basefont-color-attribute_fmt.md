...
> 原文: [https://www.geeksforgeeks.org/html-basefont-color-attribute/](https://www.geeksforgeeks.org/html-basefont-color-attribute/)

**HTML <basefont> 颜色属性**用于设置文档中的默认字体颜色。
