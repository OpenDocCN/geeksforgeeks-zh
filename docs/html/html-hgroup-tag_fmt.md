...
> [HTML hgroup 标签](https://www.geeksforgeeks.org/html-hgroup-标签/)

HTML 中的 `<hgroup>` 标签代表标题组，用于对标题元素进行分组。HTML 中的 `<hgroup>` 标签用于包装一个或多个从 `<h1>` 到 `<h6>` 的标题元素，如标题和子标题。
