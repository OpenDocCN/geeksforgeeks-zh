...
> 原文：[https://www.geeksforgeeks.org/how-to-write-articles-in-html-document/](https://www.geeksforgeeks.org/how-to-write-articles-in-html-document/)

`<article>`标签是 HTML5 中新的切片元素之一。HTML article 标签用来表示一篇文章。更具体地说，`<article>`标签中的内容独立于网站的其他内容（即使它可能是相关的）。
