...
**HTML `<output>` 表单属性**用于指定 `<output>` 元素可以包含一个或多个表单。
...
它包含单个值 **form_id** ，该值包含指定输出元素所属的一个或多个的值，即 form_id。该属性的值应该是 `<表单>` 元素的 id。
...
![输出示例](img/a8b19ec21e2796a09cf5d70f58bb3fe5.png)

## 支持的浏览器:

**HTML 输出表单属性**支持的浏览器如下:
