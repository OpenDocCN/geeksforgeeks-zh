...
> 原文: [https://www.geeksforgeeks.org/html-keyboardevent-what-property/](https://www.geeksforgeeks.org/html-keyboardevent-what-property/)

**键盘事件，属性**用于返回触发*按键*事件的按键的 Unicode 字符代码。它还返回触发 *onkeydown* 或 *onkeyup* 事件的密钥的 Unicode 密钥代码。
...
<p>要获取按键的 Unicode 字符代码，请在输入字段中按下键。</p>
