...
*   **y:** 此参数指定圆心的 y 坐标。
*   **r:** 此参数指定圆的半径。
*   **sAngle:** 此参数指定起始角度，单位为弧度(弧的圆的 3 点钟位置表示 0)。
*   **eAngle:** 该参数以弧度为单位指定结束角度。
*   **counterclockwise:** 该参数指定绘图应该是顺时针还是逆时针。默认为假，表示顺时针方向。
...
![示例 1 输出](img/7cb7397db3bd8328a116b812499a8bd1.png)
...
![示例 2 输出](img/cbc793b56744a1b981c64cf5eaea79e8.png)

## 支持的浏览器

**HTML 画布 arc()方法**支持的浏览器如下:
