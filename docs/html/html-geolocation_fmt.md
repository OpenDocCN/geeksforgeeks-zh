...
![latitude and longitude](img/857428d4f56486484c80b7f1bfd7e085.png)
...
| 错误代码 | 错误描述 |
| --- | --- |
| PERMISSION_DENIED | 应用程序没有权限使用位置服务。 |
| POSITION_UNAVAILABLE | 设备的位置不确定。 |
| TIMEOUT | 获取用户位置的请求超时。 |
| UNKNOWN_ERROR | 获取位置信息的时间超过了最大超时间隔。 |
