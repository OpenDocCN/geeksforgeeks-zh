...
> 原文: [https://www.geeksforgeeks.org/html-iframe-marginheight-attribute/](https://www.geeksforgeeks.org/html-iframe-marginheight-attribute/)
...
以下示例说明了 `<iframe>` 的 `marginheight` 属性：
...
**支持的浏览器:** `<iframe>` 的 `marginheight` 属性支持的浏览器如下:
