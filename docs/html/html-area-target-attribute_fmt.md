...
**HTML `<area>` 目标属性**用于指定打开链接文档的位置。它只在 `href` 属性出现在 `<area>` 元素中时有效。
...
![输出](img/230fc40af27f9325e471186698180aa0.png)

**点击特定区域后:**

![点击后](img/d8add3b76278b105e339b1bf35a83715.png)

**支持的浏览器:** `<HTML area>` 目标属性支持的浏览器如下:
