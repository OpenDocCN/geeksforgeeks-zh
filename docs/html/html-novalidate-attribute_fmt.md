...
**HTML 更新属性**用于指定提交表单时不验证表单数据。它是一个布尔属性。它可以与 `<form>` 元素一起使用。
**适用:**

*   [**<form>**](https://www.geeksforgeeks.org/html-form-novalidate-attribute/?ref=rp)
...
![输出](img/df4cef5570b78ce7120ad4e4a9172fc6.png)
