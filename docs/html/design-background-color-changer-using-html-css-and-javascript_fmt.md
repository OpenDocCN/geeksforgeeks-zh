...
> 原文: [https://www.geeksforgeeks.org/design-background-color-changer-using-html-css-and-javascript/](https://www.geeksforgeeks.org/design-background-color-changer-using-html-css-and-javascript/)
...
HTML 布局是使用函数调用的 `div` 标签、`id` 属性和锚点标签创建的。它定义了网页的结构。
...
通过使用 CSS 属性，我们将对网页进行修饰，使其看起来更有吸引力。颜色、宽度、高度和位置属性根据项目要求给出。
...
JavaScript 代码用于给网页赋予功能。这里我们使用了带有 `id` 参数的箭头函数。
