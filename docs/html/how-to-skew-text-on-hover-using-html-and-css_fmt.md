...
> 原文：[https://www.geeksforgeeks.org/how-to-skew-text-on-hover-using-html-and-css/](https://www.geeksforgeeks.org/how-to-skew-text-on-hover-using-html-and-css/)
...
**第二部分：** 在本部分中，我们将首先使用基本的 CSS 属性设计 `span` 标签。此外，我们将使用 `:nth-child()` 选择器选择元素的子元素，并使用 `skewY()` 属性在悬停时产生所需的效果。
