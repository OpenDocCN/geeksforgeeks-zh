...
> 原文：[https://www.geeksforgeeks.org/how-to-return-html-or-build-html-using-javascript/](https://www.geeksforgeeks.org/how-to-return-html-or-build-html-using-javascript/)
...
考虑一个包含 3 个列表项的无序列表。并且您想要移除其中的第一个子节点：
...
使用 `removeChild()` 方法，我们可以从无序列表中移除第一个子节点：
