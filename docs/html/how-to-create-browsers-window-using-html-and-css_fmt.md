...
> 原文：[https://www.geeksforgeeks.org/how-to-create-browsers-window-using-html-and-css/](https://www.geeksforgeeks.org/how-to-create-browsers-window-using-html-and-css/)
...
在这一部分，我们将创建一个基本的网站结构，并为将用作菜单图标的图标附加 `font-awesome` 的 CDN 链接。
