...
*   [**HTML <a> href 属性**](https://www.geeksforgeeks.org/html-a-tag/)
*   [**HTML <base> href 属性**](https://www.geeksforgeeks.org/html-base-href-attribute/)
*   [**HTML <area> href 属性**](https://www.geeksforgeeks.org/html-area-href-attribute/)
*   [**HTML <link> href 属性**](https://www.geeksforgeeks.org/html-link-href-attribute/)
...
<html>
  ...
  <body>
    <img
      src="https://media.geeksforgeeks.org/wp-content/cdn-uploads/20210908192254/logo2.png"
      width="200"
      height="200" />
  </body>
</html>
...
**[**HTML <area> href 属性:**](https://www.geeksforgeeks.org/html-area-href-attribute/)****<区域> href** 属性用于指定目标页面的 URL。当<区域>中不存在 *href* 属性时，该元素将不是超链接。****
...
**[**HTML <link> href 属性:**](https://www.geeksforgeeks.org/html-link-href-attribute/)**HTML<链接> href 属性用于指定链接文档的 URL。它主要包含样式表文件的网址。******
