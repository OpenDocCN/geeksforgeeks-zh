...
> 原文: [https://www.geeksforgeeks.org/html-window-matchmedia-method/](https://www.geeksforgeeks.org/html-window-matchmedia-method/)

html 中的 `window.matchMedia()` 方法用于返回一个 `MediaQueryList` 对象，该对象代表指定 CSS 媒体查询字符串的结果。`matchMedia()` 方法的值可以是 CSS @media 规则的任何媒体选项，如最小高度、最小宽度、方向等。
...
*   **调整浏览器窗口大小前:**
    ![调整浏览器窗口大小前](img/aa0710ab1d628c7231d93fd038ad21f1.png)
*   **调整浏览器窗口大小后:**
    ![调整浏览器窗口大小后](img/fcecd49760a06ce3157703a29704ccc9.png)
