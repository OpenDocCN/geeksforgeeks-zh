...
> 原文：[https://www.geeksforgeeks.org/how-to-toggle-between-one-checkbox-and-a-whole-group-of-checkboxes-in-html/](https://www.geeksforgeeks.org/how-to-toggle-between-one-checkbox-and-a-whole-group-of-checkboxes-in-html/)

给定一个有一个复选框和一组复选框的 HTML 文档，任务是在 JavaScript 的帮助下在它们之间切换。

我们可以通过使用事件 `onChange()` 来实现这一点，每当我们选中或取消选中复选框时，就会触发该事件。

我们可以给这个事件传递一个函数，如果单独的复选框是选中的，则该函数应该使用 `forEach` 循环取消选中组中的所有复选框，并且还应该取消选中组中任何复选框的单独复选框。
