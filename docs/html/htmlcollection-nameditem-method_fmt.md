...
> 原文: [https://www.geeksforgeeks.org/htmlcollection-nameditem-method/](https://www.geeksforgeeks.org/htmlcollection-nameditem-method/)
...
    <center>
        <h1>GeeksForGeeks</h1>
        <h2>HTMLCollection namedItem() 方法</h2>
...
<script>
            function Geeks() {
                var w = document.getElementsByTagName("P").namedItem("GFG");
                alert(w.innerHTML);
            }
        </script>
    </center>
