...
方式是在之前使用伪选择器[，在](https://www.geeksforgeeks.org/css-before-selector/)之后使用[。使用前，我们将制作条状效果，使用后，我们将确保它来回移动，给它一种反射的外观，使我们的按钮看起来闪闪发光。](https://www.geeksforgeeks.org/css-after-selector/)
