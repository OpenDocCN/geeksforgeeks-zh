...
> 原文: [https://www.geeksforgeeks.org/html-neumorphism-login-form/](https://www.geeksforgeeks.org/html-neumorphism-login-form/)

新形态结合了平面设计和 skeuomorphism 的发展。**新形态**，或**软用户界面**，是一种视觉风格，结合了背景颜色、形状、渐变、高光和阴影，以确保图形强烈的按钮和开关。所有这些都可以实现柔软的挤压塑料外观，以及几乎**的三维造型**。

为了更好地理解，请访问: [https://www.geeksforgeeks.org/html-responsive-modal-log in-form/](https://www.geeksforgeeks.org/html-responsive-modal-log in-form/)

**按照代码使用 CSS 创建一个新的登录表单:**
...
              Geeksforgeeks Signin</button>
            <div class="gfg-link"><a href="#">
...
![](img/318bd989c336711023297e3fe0d63c8b.png)
