...
**Note:** The `srclang` attribute is required with `kind = “subtitles”`.
...
*   **language_code:** It contains the value `language_code`. It defines a two-letter language code which specifies the language of the track text.
...
**Supported Browsers:** The browsers supported by the `<track> srclang Attribute` are listed below:
