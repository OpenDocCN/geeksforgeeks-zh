...
> 原文：[https://www.geeksforgeeks.org/how-to-sharpen-blurry-text-in-html5-canvas/](https://www.geeksforgeeks.org/how-to-sharpen-blurry-text-in-html5-canvas/)
...
我们可以通过使用 [`window.devicePixelRatio`](https://www.geeksforgeeks.org/html-dom-window-devicepixelratio-property/) 属性来解决这个问题。
...
我们在这里假设了两个条件，当我们保持 `window.devicePixelRatio` = 1 时，我们可以看到模糊的效果，但是当我们保持该值为 2 时，我们可以看到我们得到了清晰的文本。这是因为 **1** 的值表示经典的 **96 DPI（在某些平台上为 76 DPI）**显示器，而 **2** 的值预计用于 **HiDPI/Retina 显示器。**