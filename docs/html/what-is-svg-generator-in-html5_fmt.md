...
> 原文：[https://www.geeksforgeeks.org/what-is-svg-generator-in-html5/](https://www.geeksforgeeks.org/what-is-svg-generator-in-html5/)
...
<body>
    <svg width="300" height="100">
        <rect width="300" height="100" style="fill:green;stroke-width:5;stroke:rgb(0,0,0)" />
    </svg>
</body>
</html>
```
...
<body>
    <svg width="300" height="300">
        <circle cx="50" cy="50" r="40" stroke="black" stroke-width="5" fill="orange" />
    </svg>
</body>
</html>
```
...
<body>
    <svg width="300" height="200">
        <polygon points="100,10 40,198 190,78 10,78 160,198" style="fill:purple; stroke:black;stroke-width:3;" />
    </svg>
</body>
</html>
```
