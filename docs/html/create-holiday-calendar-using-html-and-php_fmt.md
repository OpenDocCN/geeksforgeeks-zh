...
> 原文：[https://www.geeksforgeeks.org/create-holiday-calendar-using-html-and-php/](https://www.geeksforgeeks.org/create-holiday-calendar-using-html-and-php/)
...
### 示例
我们将显示 2021 年 8 月的日历作为示例。我们将创建一个 2021 年 8 月所有假期的列表，使用 CSS [`background-color`](https://www.geeksforgeeks.org/css-background-color-property/) 属性突出显示假期，鼠标悬停显示假期名称。
...
## 输出
在下面的输出中，当鼠标悬停在“8 月 30 日”单元格上时，会将节日名称显示为“Janmashtami”。
