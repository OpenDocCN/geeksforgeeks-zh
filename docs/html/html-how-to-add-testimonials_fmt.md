...
通常，推荐语包含用户的姓名、图片、他/她的身份（可选）以及最重要的他/她的引用文本。
...
```html
<div class="container">
    <img src="https://media.geeksforgeeks.org/wp-content/uploads/20190921104515/download18.png"
         alt="" 
         width="318" 
         height="159" 
...
**输出:**
![示例输出](img/fe858493760637bb0768f721516688b4.png)
