...
> 原文: [https://www.geeksforgeeks.org/how-to-add-jquery-code-to-html-file/](https://www.geeksforgeeks.org/how-to-add-jquery-code-to-html-file/)
...
## 方法 2: 通过 CDN 包含 jQuery

按照下面的步骤在 HTML 文件中包含 Jquery。
