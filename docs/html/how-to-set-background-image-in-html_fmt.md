...
> 原文: [https://www.geeksforgeeks.org/how-to-set-background-image-in-html/](https://www.geeksforgeeks.org/how-to-set-background-image-in-html/)
...
**注意:** HTML 5 不支持 `<body>` 标签中的背景属性，只好用 `CSS` 将背景图片添加到网页中。
...
这里我们必须使用 HTML 的[样式属性](https://www.geeksforgeeks.org/html-style-attribute/)和 `CSS` 的[背景图像属性](https://www.geeksforgeeks.org/css-background-image-property/)。
