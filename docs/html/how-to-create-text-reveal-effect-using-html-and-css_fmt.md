...
> 原文: [https://www.geeksforgeeks.org/how-to-create-text-reveal-effect-using-html-and-css/](https://www.geeksforgeeks.org/how-to-create-text-reveal-effect-using-html-and-css/)
...
*   **第二步:** 然后使用[动画](https://www.geeksforgeeks.org/css-animations/)属性，标识符命名为`animate`。
*   **步骤 3:** 现在使用`@keyframes`为每一帧设置动画，并为每一帧设置不同的高度和宽度。
...
第二步: 然后使用标识符为文本输入 `p` 的 `animation` 属性。

步骤 3: 现在使用 `@keyframes` 从宽度 0 到 100%制作动画。
