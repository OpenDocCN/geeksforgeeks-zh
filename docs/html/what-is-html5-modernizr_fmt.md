...
它是一个 JavaScript 库，可以检测我们的网页浏览器支持哪些下一代网页技术。HTML 和 CSS 中引入了许多新功能，但是许多浏览器不支持这些新功能。因此，Modernizr 允许开发者测试 HTML & CSS 中的一些新技术，然后为不支持这些技术的浏览器提供回退。例如，如果浏览器不支持 GIF 视频，那么我们希望显示 mp4 视频。我们可以根据功能创建 CSS 规则，如果浏览器不支持新功能，这些规则将自动应用于网页。
...
在本例中，我们将检查我们的浏览器是否支持 HTML5 视频，是否使用了 Modernizr。
