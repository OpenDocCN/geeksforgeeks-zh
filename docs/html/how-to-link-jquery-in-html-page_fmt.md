...
> 原文：[https://www.geeksforgeeks.org/how-to-link-jquery-in-html-page/](https://www.geeksforgeeks.org/how-to-link-jquery-in-html-page/)
...
现在让我们将其链接到我们的 HTML 代码。只需在 HTML 文件的 `<head>` 部分下添加以下代码：
...
**2. 包括来自一个 CDN 的 jQuery：** 如果你不想使用上面的方法，这里有它的替代解决方案。在这种方法中，您必须通过像谷歌内容分发网络这样的内容分发网络来包含 jQuery。很简单，只需在 HTML 文件的 `<head>` 部分下添加以下代码：
