...
> 原文: [https://www.geeksforgeeks.org/web-api-htmlbodyelement-background-property/](https://www.geeksforgeeks.org/web-api-htmlbodyelement-background-property/)
...
该属性返回一个表示背景图像资源位置描述的 DOMString 。
