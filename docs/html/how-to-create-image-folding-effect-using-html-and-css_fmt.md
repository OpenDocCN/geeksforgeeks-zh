...
> 原文: [https://www.geeksforgeeks.org/how-to-create-image-folding-effect-using-html-and-css/](https://www.geeksforgeeks.org/how-to-create-image-folding-effect-using-html-and-css/)
...
- 使用 [`nth-child()`](https://www.geeksforgeeks.org/css-nth-child-selector/) 选择器属性为不同的列表项赋予不同的样式。

**HTML 代码:**
1.  首先，我们创建一个 HTML 文件 (`index.html`)。
2.  然后我们将提供所有动画效果的 CSS 文件链接到我们的 HTML。里面还放置了 `<头>` 的标签。
