...
*   [HTML `<a>` 媒体属性](https://www.geeksforgeeks.org/html-a-media-attribute/?ref=rp)
*   [HTML `<area>` 媒体属性](https://www.geeksforgeeks.org/html-area-media-attribute/)
*   [HTML `<link>` 媒体属性](https://www.geeksforgeeks.org/html-link-media-attribute/)
*   [HTML `<source>` 媒体属性](https://www.geeksforgeeks.org/html-source-media-attribute/)
*   [HTML `<style>` 媒体属性](https://www.geeksforgeeks.org/html-style-media-attribute/)
