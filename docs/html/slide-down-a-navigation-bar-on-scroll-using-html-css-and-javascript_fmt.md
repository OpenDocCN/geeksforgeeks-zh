...
> 原文: [https://www.geeksforgeeks.org/slide-down-a-navigation-bar-on-scroll-using-html-CSS-and-JavaScript/](https://www.geeksforgeeks.org/slide-down-a-navigation-bar-on-scroll-using-html-CSS-and-JavaScript/)
...
在本节中，我们将为向下滑动的导航栏创建一个基本的网站结构，当用户向下滚动页面时，它将显示效果。
