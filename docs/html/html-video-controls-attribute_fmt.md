...
**Note:** Always specify the width and the height of the video; otherwise, the web page will be confused about how much space the video will require, and this may cause the web page to slow down.

**Supported Browsers:** The browsers supported by the HTML `<video>` controls Attribute are listed below:
