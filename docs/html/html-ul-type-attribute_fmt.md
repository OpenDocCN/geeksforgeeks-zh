...
The **HTML `<ul>` type Attribute** is used to specify which kind of marker is used in the list.
...
**Supported Browsers:** The browsers supported by the HTML `<ul>` Type attribute are listed below:
