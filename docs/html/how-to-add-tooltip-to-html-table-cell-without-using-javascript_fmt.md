...
> 原文: [https://www.geeksforgeeks.org/how-to-add-tooltip-to-html-table-cell-without-using-javascript/](https://www.geeksforgeeks.org/how-to-add-tooltip-to-html-table-cell-without-using-javascript/)
...
- 初始设置 `display: none`。
- 每当用户悬停在该特定元素上时，只需将属性更改为 `display: block`。
