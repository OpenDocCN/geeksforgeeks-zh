...
> 原文: [https://www.geeksforgeeks.org/html-option-selected-attribute/](https://www.geeksforgeeks.org/html-option-selected-attribute/)

选择的 **HTML `<option>` 属性**用于指定*页面加载*时默认选择哪个选项。这是一个布尔属性。默认情况下，将显示具有选定属性的选项。
**语法:**
...
**支持的浏览器:** **HTML `<option>` 选择属性**支持的浏览器如下:
