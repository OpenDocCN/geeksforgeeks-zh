...
The **HTML `<th>` width Attribute** is used to specify the width of a table header cell. If the width attribute is not set, it takes the default width according to content. It is not supported by HTML 5.
...
**Supported Browsers:** The browsers supported by the **HTML `<th>` width attribute** are listed below:
