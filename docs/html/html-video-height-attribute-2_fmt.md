...
The **HTML `<video>` height Attribute** is used to set the height of the video player in terms of pixels. This attribute is new in HTML5.
...
**Attribute Values:** It contains a single value, pixels, which sets the height of the video frame.
...
                                type="video/mp4">
            <source src="https://media.geeksforgeeks.org/wp-content/uploads/20190616234019/Canvas.move_.ogg" 
                                type="video/ogg">
        </video>
    </center>
</body>
...
**Supported Browsers:** The browsers supported by the HTML `<video>` height Attribute are listed below:
