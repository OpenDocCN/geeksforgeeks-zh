# 使用 HTML、CSS & JavaScript 创建音乐网站模板

> 原文：[https://www.geeksforgeeks.org/create-a-music-website-template-using-html-css-javascript/](https://www.geeksforgeeks.org/create-a-music-website-template-using-html-css-javascript/)
...
*   我们将创建基本布局，即一个 `div` 标签内的两个 `div`（左和右）。在左边的区域我们会写一些文字，在右边的区域我们会放置播放或暂停的图像。我们还将创建一个基本的`导航条`并在右侧浮动。
