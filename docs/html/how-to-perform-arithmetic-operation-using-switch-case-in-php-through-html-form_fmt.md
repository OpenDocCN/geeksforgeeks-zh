...
> 原文：[https://www.geeksforgeeks.org/how-to-perform-arithmetic-operation-using-switch-case-in-php-through-html-form/](https://www.geeksforgeeks.org/how-to-perform-arithmetic-operation-using-switch-case-in-php-through-html-form/)

我们将使用 PHP 执行基本的算术运算，如加法、减法、乘法和除法。我们使用 HTML 表单来获取输入值，并选择一个选项来使用 `switch` `case` 执行特定的操作。
...
**输出：** 打开 Web 浏览器，输入 `localhost/gfg/code.php`
