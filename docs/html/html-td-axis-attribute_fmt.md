...
The **HTML `<td>` axis attribute** is used to *categorize the cell content*. It is used for grouping related information. This attribute does not display a visual effect on the web browser but it is used by screen readers. It is not supported by HTML 5.
...
**Supported Browsers:** The browsers supported by **HTML `<td>` axis attribute** are listed below:
