...
> 原文：[https://www.geeksforgeeks.org/how-to-define-a-thematic-change-in-the-content-in-html5/](https://www.geeksforgeeks.org/how-to-define-a-thematic-change-in-the-content-in-html5/)

在本文中，我们将看到如何定义页面内容中的主题变化。当段落的描述改变时，这有助于在段落之间引入中断。

HTML 中的`<HR>`元素用于表示内容中的主题变化。它可以与对齐、阴影、宽度和大小等属性一起使用，以指定其特征。这是一个自结束标签。

以下示例显示了使用`<hr>`标签来标记段落之间的主题变化：
