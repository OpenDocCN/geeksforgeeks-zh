...
> 原文：[https://www.geeksforgeeks.org/how-to-create-mousemove-parallax-effects-using-html-css-javascript/](https://www.geeksforgeeks.org/how-to-create-mousemove-parallax-effects-using-html-css-javascript/)
...
在这一步中，我们将使用上面的方法创建一个 movemouse 视差效果。
