...
HTML 中的 `<big>` 标签用于将选定的文本大小增加一个大于周围文本的大小。在 HTML 5 中，它可以被 CSS 使用。

**注意:** HTML 5 不支持 `<big>` 标签。
...
![例 1 输出](img/0ea1732ba938dff01f6dc1df43254e4f.png)
...
![例 2 输出](img/d2e2ea82d01b56163639f573c643e0fa.png)
