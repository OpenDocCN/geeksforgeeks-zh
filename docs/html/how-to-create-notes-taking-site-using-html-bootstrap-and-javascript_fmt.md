...
> 原文：[https://www.geeksforgeeks.org/how-to-create-notes-taking-site-using-html-bootstrap-and-javascript/](https://www.geeksforgeeks.org/how-to-create-notes-taking-site-using-html-bootstrap-and-javascript/)
    ...
    <div class="container my-3">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <button class="btn btn-primary" id="addBtn" style="background-color:green">Add Note</button>
            </div>
        </div>
        <hr>
        <h1>Your Notes</h1>
