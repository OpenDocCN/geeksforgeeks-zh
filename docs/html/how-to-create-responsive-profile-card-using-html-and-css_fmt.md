...
> 原文：[https://www.geeksforgeeks.org/how-to-create-responsive-profile-card-using-html-and-css/](https://www.geeksforgeeks.org/how-to-create-responsive-profile-card-using-html-and-css/)
...
2.  创建完 HTML 文件后，我们将使用`<title>`标签为我们的网页赋予标题。应该是`<br/>`放置在`<head>`标签之间。
3.  然后，我们将提供所有动画效果的 css 文件链接到我们的 html。这也放在`<head>`标签之间。
...
*   使用 CSS 的`nth-child`选择器特性来调用不同的链接。
