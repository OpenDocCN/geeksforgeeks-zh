...
> 原文: [https://www.geeksforgeeks.org/html-window-screen-left-property/](https://www.geeksforgeeks.org/html-window-screen-left-property/)
...
    double click the "Check Screen Left" button: 
    </p>
...
**点击**![](img/81676f13f2260c3e97af5059681a2181.png)**按钮后**

**支持的浏览器:** **窗口屏幕左侧属性**支持的浏览器如下:
