...
> 原文：[https://www.geeksforgeeks.org/how-to-draw-graphics-using-canvas-in-html5/](https://www.geeksforgeeks.org/how-to-draw-graphics-using-canvas-in-html5/)

在本文中，我们将使用文档中的`canvas`元素来绘制图形。HTML 中的这个标记用于使用 JavaScript 在网页上绘制图形。它可以用来绘制路径、方框、文本、渐变和添加图像。默认情况下，它不包含边框和文本。
