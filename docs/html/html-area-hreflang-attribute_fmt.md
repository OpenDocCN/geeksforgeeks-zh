...
**注意:** `<area>` hreflang 属性在 HTML 5 中是新的。
...
![alt_attribute](https://media.geeksforgeeks.org/wp-content/uploads/20190227165729/area11.png)

*   **点击后具体可点击区域:**

![alt_attribute](https://media.geeksforgeeks.org/wp-content/uploads/20190227165802/area2.png)

**支持的浏览器:** `<area>` hreflang 属性支持的浏览器如下:
