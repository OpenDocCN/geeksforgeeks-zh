...
> 原文: [https://www.geeksforgeeks.org/html-object-hspace-attribute-2/](https://www.geeksforgeeks.org/html-object-hspace-attribute-2/)

**HTML `<对象>` hspace 属性**用于指定对象左右两边的空格数。
