...
> 原文：[https://www.geeksforgeeks.org/how-to-create-todo-app-using-html-css-js-and-bootstrap/](https://www.geeksforgeeks.org/how-to-create-todo-app-using-html-css-js-and-bootstrap/)
...
为 HTML、CSS 和 JavaScript 创建三个文件。要创建这些文件，请运行以下命令：
