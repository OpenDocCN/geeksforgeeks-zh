...
> 原文：[https://www.geeksforgeeks.org/how-to-create-a-download-link-with-html/](https://www.geeksforgeeks.org/how-to-create-a-download-link-with-html/)
...
**下载链接**是用户点击后会下载特定文件的链接。现在，让我们谈谈编写代码时将在代码中使用的属性。`download`属性用于使链接可下载。它将指定目标（pdf、zip、jpg、doc 等），只有当用户点击链接时才会下载。

**注意：**`download`属性只能在之前设置了`href`属性的情况下使用。
