...
这些标签帮助我们在网页中编写段落语句。它们以 `<p>` 标记开始，以 `<</p>>` 结束。这里 `<br>` 标签用于断行，充当回车。`<br>` 为空标记。
**示例** :
...
**关于 HTML 的更多信息，请参考**:[https://www.geeksforgeeks.org/html-tutorials/](https://www.geeksforgeeks.org/html-tutorials/)
