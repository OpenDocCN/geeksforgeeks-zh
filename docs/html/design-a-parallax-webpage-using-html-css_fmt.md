...
> 原文: [https://www.geeksforgeeks.org/design-a-parallax-webpage-using-html-css/](https://www.geeksforgeeks.org/design-a-parallax-webpage-using-html-css/)
...
*   在 HTML 页面中，我们有分区，在每个分区中，有一个标题和一个小段落。在 CSS 文件中，我们已经装饰了我们的文本并将头部放置在固定的位置。
