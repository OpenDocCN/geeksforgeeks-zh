...
> 原文: [https://www.geeksforgeeks.org/html-window-inner-width-property/](https://www.geeksforgeeks.org/html-window-inner-width-property/)
...
**返回值:** 返回一个数字，以像素为单位表示浏览器窗口的内容区域宽度。
