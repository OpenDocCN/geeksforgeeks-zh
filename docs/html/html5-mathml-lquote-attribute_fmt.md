...
# HTML5 MathML lquote 属性

> 原文: [https://www.geeksforgeeks.org/html5-mathml-lquote-attribute/](https://www.geeksforgeeks.org/html5-mathml-lquote-attribute/)
...
**支持的浏览器:** HTML 5 MathML *lquote* 属性支持的浏览器如下。
