...
**HTML | min 属性**用于指定量表的下限。最小属性值必须小于最大属性值。它的默认值为 0。既可以在 `<input>` 又可以在 `<meter>` 元素。

*   **<input>**: 当最小属性出现在输入元素中时，它指定一个 `<input>` 元素的最小值。
    **语法:**
...
![示例-1 输出](img/aef253f62780ac4af0dd8dda575d3537.png)

*   **<meter>**: 当仪表元件中存在时，它指定一个仪表的最小值。
    **语法:**
...
![示例-2 输出](img/bc26ad106fde89c32c3e2a65017f0bae.png)
