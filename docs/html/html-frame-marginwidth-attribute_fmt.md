...
> 原文: [https://www.geeksforgeeks.org/html-frame-margin-width-attribute/](https://www.geeksforgeeks.org/html-frame-margin-width-attribute/)

**HTML `<frame>` 边距宽度属性**用于指定框架元素中内容的左右边距。
...
**支持的浏览器:** HTML `<frame>` 边框属性支持的浏览器如下:
