...
**HTML span 属性**用于定义一个 `<col>` 或 `<colgroup>` 元素应该跨越的列数。
...
**示例 1:** 此示例说明了 `<col>` 元素中 `span` 属性的使用。
...
![输出示例 1](img/9ef90800ca894a210a6c8a23cab7c668.png)
...
![输出示例 2](img/0e7e74354dccadad576e87bcfeb425cf.png)
