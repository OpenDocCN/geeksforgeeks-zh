...
> 原文：[https://www.geeksforgeeks.org/how-to-open-a-hyperlink-in-another-window-or-tab-in-html/](https://www.geeksforgeeks.org/how-to-open-a-hyperlink-in-another-window-or-tab-in-html/)

有多种方法可以在另一个窗口或选项卡中打开超链接，例如使用 JavaScript、jQuery 或 HTML。要使用 HTML 在另一个窗口或选项卡中打开超链接，请使用 `target` 属性，并在定位选项卡中为其提供值 `_blank`。
