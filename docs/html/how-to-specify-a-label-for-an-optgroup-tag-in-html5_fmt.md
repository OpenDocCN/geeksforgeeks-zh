...
> 原文: [https://www.geeksforgeeks.org/how-to-specify-a-label-for-an-optgroup-tag-in-html5/](https://www.geeksforgeeks.org/how-to-specify-a-label-for-an-optgroup-tag-in-html5/)

HTML `<optgroup>` 元素在 `<select>` 元素内创建选项分组。

[HTML `<optgroup>` 标签属性](https://www.geeksforgeeks.org/html-optgroup-label-attribute/) `label` 文本用于指定选项组的标签。`disabled` 属性用于指定应禁用选项组。
...
**示例 2:** 以下示例演示了具有 `disabled` 属性的 `optgroup` 标记。
