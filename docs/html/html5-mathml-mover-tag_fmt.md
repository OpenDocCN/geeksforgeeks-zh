...
*   **align:** 该属性保存过脚本的对齐值。可能的值是左、右和中间。
*   **accent:** 该属性指定运算符是否应被视为重音。可能的值为真或假。

下面的例子说明了 HTML5 MathML <mover> 标签的概念:
...
![Output](img/25f950344cf6a5c22aa6481d28c08ab7.png)
