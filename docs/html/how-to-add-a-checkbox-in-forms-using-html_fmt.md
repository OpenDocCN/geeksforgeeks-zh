...
> 原文：[https://www.geeksforgeeks.org/how-to-add-a-checkbox-in-forms-using-html/](https://www.geeksforgeeks.org/how-to-add-a-checkbox-in-forms-using-html/)
...
*   现在使用带有`<input>`元素的`type`属性。
*   将`type`属性设置为值`"checkbox"`
