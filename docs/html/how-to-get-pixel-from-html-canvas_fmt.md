...
> 原文：[https://www.geeksforgeeks.org/how-to-get-pixel-from-html-canvas/](https://www.geeksforgeeks.org/how-to-get-pixel-from-html-canvas/)
    ...
    <center>
        ...
        <script>
            ...
            function find() {
                ...
                (20,20) */
                var ImageData = gfg.getImageData(20, 20, 60, 60);
...
<body>
    <center>
        ...
        <script>
            ...
            method */
            function find() {
                var ImageData = geeks.getImageData(20, 20, 60, 60);
