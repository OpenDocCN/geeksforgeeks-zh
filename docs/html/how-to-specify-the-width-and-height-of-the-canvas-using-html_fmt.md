...
> 原文：[https://www.geeksforgeeks.org/how-to-specify-the-width-and-height-of-the-canvas-using-html/](https://www.geeksforgeeks.org/how-to-specify-the-width-and-height-of-the-canvas-using-html/)

HTML 中的`<canvas>`标记用于使用 JavaScript 在网页上绘制图形。它可以用来绘制路径、方框、文本、渐变和添加图像。默认情况下，它不包含边框和文本。
