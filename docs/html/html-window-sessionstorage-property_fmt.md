...
> 原文: [https://www.geeksforgeeks.org/html-window-sessionstorage-property/](https://www.geeksforgeeks.org/html-window-sessionstorage-property/)
...
<button ondblclick="Storage()">Display Data</button>
