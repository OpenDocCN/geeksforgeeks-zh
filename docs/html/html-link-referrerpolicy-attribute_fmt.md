...
> 原文: [https://www.geeksforgeeks.org/html-link-referer-policy-attribute/](https://www.geeksforgeeks.org/html-link-referer-policy-attribute/)

**HTML <link> referrerpolicy 属性** 用于指定在取出资源时将发送到服务器的引用信息。
...
**示例:** 下面的代码说明了 <link> 引用者策略属性的使用，我们已经将引用者策略属性设置为无引用者。
