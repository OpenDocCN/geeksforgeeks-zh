...
> 原文: [https://www.geeksforgeeks.org/html-navigator-user-agent-property/](https://www.geeksforgeeks.org/html-navigator-user-agent-property/)
...
**支持的浏览器:** **Navigator userAgent** 支持的浏览器如下:
