...
它将一个网址或数据 URI 作为 `longdesc` 属性的值。
...
```html
<!--HTML code to demonstrate longdesc attribute inside the img element-->
<!DOCTYPE html>
<html>
...
<body>
    ...
    <img src="https://media.geeksforgeeks.org/wp-content/uploads/20210101144014/gfglogo.png" 
         width="100" 
         height="132" 
         longdesc="https://www.geeksforgeeks.org/html-iframe-longdesc-attribute/">
...
<body>
    <a href="https://www.geeksforgeeks.org/html-iframe-longdesc-attribute/"> 
        <img src="https://media.geeksforgeeks.org/wp-content/uploads/20210101144014/gfglogo.png">
    </a>
</body>
...
由于大多数浏览器不支持 `longdesc` 属性，用户应该在 [`< a >`](https://www.geeksforgeeks.org/html-a-tag/) 标签内使用 [`<img>`](https://www.geeksforgeeks.org/html-img-tag/) 标签为图片提供长描述。