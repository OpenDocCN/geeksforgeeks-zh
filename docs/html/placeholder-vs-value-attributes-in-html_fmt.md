...
> 原文: [https://www.geeksforgeeks.org/placeholder-vs-value-attributes-in-html/](https://www.geeksforgeeks.org/placeholder-vs-value-attributes-in-html/)
...
[**值属性:**](https://www.geeksforgeeks.org/html-value-attribute/) 值属性用于将默认值设置为`<input>`元素。它表示与输入相关的值，值集中的内容在表单提交时被发送到服务器。如果没有手动值被插入，那么默认值将在提交时被传递。
...
    <form>
        <label for="Name">Name:</label>
        <input name="Name" type="text" value="Your name" /><br><br>

        <label for="Password">Enter password:</label>
        <input name="Password" type="password" value="12345" /><br><br>
