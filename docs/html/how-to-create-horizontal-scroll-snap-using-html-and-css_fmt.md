...
> 原文：[https://www.geeksforgeeks.org/how-to-create-horizontal-scroll-snap-using-html-and-css/](https://www.geeksforgeeks.org/how-to-create-horizontal-scroll-snap-using-html-and-css/)
...
*   创建一个 HTML 文件。
*   将提供所有动画效果的 CSS 文件链接到我们的 HTML。这也放在`<head>`标签之间。
*   为创建按钮添加六个锚点。
...
<body>
    ...
    <!-- img-1 -->
    <a href="#">
        <img src="https://media.geeksforgeeks.org/wp-content/uploads/20210223165952/gfglogo.png">
    </a>
    <!-- img-2 -->
    <a href="#">
        <img src="https://media.geeksforgeeks.org/wp-content/uploads/20210218121103/resize16136304481344613575img2-300x150.jpg">
    </a>
    <!-- img-3 -->
    <a href="#">
