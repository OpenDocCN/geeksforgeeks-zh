...
> 原文：[https://www.geeksforgeeks.org/how-to-set-the-height-and-width-of-the-video-player-in-html5/](https://www.geeksforgeeks.org/how-to-set-the-height-and-width-of-the-video-player-in-html5/)

在本文中，我们将学习在 HTML5 中设置视频播放器的宽度和高度。
...
**方式：** 视频标签的 HTML5 `width` 和 `height` 属性分别用于设置视频播放器的高度和宽度。`source` 标签用于指定视频、音频等多媒体资源。`source` 标签的 `src` 属性指定了资源的路径。
