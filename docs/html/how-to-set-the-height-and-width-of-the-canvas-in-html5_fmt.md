...
> 原文：[https://www.geeksforgeeks.org/how-to-set-the-height-and-width-of-the-canvas-in-html5/](https://www.geeksforgeeks.org/how-to-set-the-height-and-width-of-the-canvas-in-html5/)
...
*   `height`：借助 `height` 属性我们可以设置高度。
*   `width`：借助 `width` 属性我们可以设置宽度。
