...
> 原文: [https://www.geeksforgeeks.org/html5-mathml-frame-spacing-attribute/](https://www.geeksforgeeks.org/html5-mathml-frame-spacing-attribute/)

该属性定义了表格和框架之间的空间。该属性仅被 `<mtable>` 标签接受。
...
![Output Image](img/dd2915896f1301ea6743637d990c8414.png)
