...
> [HTML SVG 过滤器](https://www.geeksforgeeks.org/html-svg-filter/)

SVG `<filter>` 元素用于定义过滤器。要唯一标识过滤器，请使用 `id`。过滤器在 `def` 元素中定义。
...
![SVG Filter Example](img/de1badb3c7b13f4b669cc0587910094c.png)
...
![SVG Filter Example with Different Shape and Custom Shadow](img/8acf340dffc17f8081aef654e62405f0.png)
