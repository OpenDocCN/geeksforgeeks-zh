...
> 原文：[https://www.geeksforgeeks.org/how-to-create-a-rainbow-using-html5/](https://www.geeksforgeeks.org/how-to-create-a-rainbow-using-html5/)

在本文中，我们将讨论如何使用 HTML5 创建彩虹。为了创建彩虹，我们必须知道 `SVG` 标签如何工作及其属性。

## 进场

首先，我们必须使用 `SVG` 标签的 `width` 和 `height` 属性来创建彩虹结构的基础。
现在我们将使用 `circle` 元素来创建彩虹的结构，并用各自的颜色填充它。
