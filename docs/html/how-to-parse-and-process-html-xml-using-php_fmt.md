...
> 原文：[`https://www.geeksforgeeks.org/how-to-parse-and-process-html-xml-using-php/`](https://www.geeksforgeeks.org/how-to-parse-and-process-html-xml-using-php/)
...
[`simplexml_load_string()`](https://www.geeksforgeeks.org/php-simplexml_load_string-function/) 函数用于解析给定的 XML，然后 XML 对象可以用于访问 XML 数据。
