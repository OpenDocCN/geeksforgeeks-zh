...
> 原文: [https://www.geeksforgeeks.org/html-scientific-calculator/](https://www.geeksforgeeks.org/html-scientific-calculator/)

在这里，一个科学计算器将通过使用 HTML、CSS 和 JavaScript 形成。

*   **计算器标题:**这是我们应用程序顶部的标题，“GeeksforGeeks 科学计算器”。
*   **输出屏幕:**这将是输出屏幕，所有文本都将在此显示。比如用户将要键入的输入和根据用户输入计算的答案。因此，我们可以再次将其分解为两个更小的部分，如下所示:
    *   **问题输出:**这将是用户给出的输入。
    *   **答案输出:**这将是根据用户输入计算的结果。
...
*   百分率
*   阶乘
*   常数(饼图、欧拉常数、对数 2 基数 e、对数 10 基数 e)
*   指数
*   原木底座 2，10，e
*   力量
*   正弦、谭、余弦(以弧度输入角度)
...
![生成的科学计算器](img/af85644d0a74604fc9351ec53ab5c065.png)

**计算 cos(0)值:**

![计算 cos(0)值](img/ac1632d218e4696eaa5822e09d45876b.png)

![计算 cos(0)值](img/4d90e23a3c037cc0d81d6dfd651e4265.png)
