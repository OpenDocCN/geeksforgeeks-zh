...
**Example:** Below code illustrates the use of **crossorigin** attribute in the `<video>` element. It is set to “anonymous” value which retrieves the audio files without passing credentials information.
...
<h3>HTML <video> crossorigin Attribute</h3>
