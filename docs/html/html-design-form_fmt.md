...
![输出](img/018aedcfe2e1757f2c64c08e79850ca5.png)
...
1.  **HTML 表单中的文本字段:**
    文本字段是一行输入字段，允许用户输入文本。文本字段输入控件是使用“输入”元素创建的，其类型属性的值为“text”。
...
![输出](img/24b8c992b5b71964413825073afbe3d9.png)

2.  **HTML 表单中的密码字段:**
    密码字段是一种文本字段，其中输入的文本使用星号或点进行屏蔽，以防止用户身份被屏幕上的其他人看到。密码字段输入控件是使用“输入”元素创建的，其类型属性的值为“password”。
...
![输出](img/5f43ed98cae7b1c9543a2061738ca939.png)
...
![输出](img/24a24582f5541956aa059cbcc527052d.png)
...
![输出](img/0af04820c2d3542441bf1a83bf4fbde4.png)

### HTML 表单中的文件选择框:

文件选择框用于允许用户选择本地文件并将其作为附件发送到 web 服务器。它类似于一个带有按钮的文本框，允许用户浏览文件。也可以写入文件的路径和名称，而不是浏览文件。文件选择框是使用“输入”元素创建的，其类型属性的值为“file”。
...
![输出](img/0c73a2b84dbd841e86ae8164acb693f8.png)
...
![输出](img/a7536fa7a6a0aff7f6c385ab582f7548.png)
...
![输出](img/fd238f3cdcdf879416cb0ea5337a23e8.png)

![输出](img/cbf70c9671abfae4cd4613c28b05a844.png)
...
![输出](img/757b631ec8f6f25409532a6ba28e18f1.png)
...
**HTML 表单中的目标属性:**
目标属性用于指定提交的结果将在当前窗口、新选项卡还是新框架中打开。使用的默认值是“self”，这将导致表单在同一窗口中提交。为了使表单结果在新的浏览器选项卡中打开，该值应设置为“blank”。
