...
> 原文: [https://www.geeksforgeeks.org/radio-button-vs-checkbox-in-html/](https://www.geeksforgeeks.org/radio-button-vs-checkbox-in-html/)

## 单选按钮

单选按钮一般用于 HTML 表单。当您需要从网站访问者那里收集一些数据时，需要 HTML 表单。当您只想从几个可用选项中选择一个选项时，可以使用单选按钮。
...
复选框也多用于 HTML 表单。复选框允许您从选项列表中选择一个或多个选项。
