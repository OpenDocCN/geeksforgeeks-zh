...
> 原文: [https://www.geeksforgeeks.org/html-script-referer-policy-attribute/](https://www.geeksforgeeks.org/html-script-referer-policy-attribute/)
...
下面的代码说明了<脚本>元素中 referrerpolicy 属性的使用。
...
![示例输出](img/df66d42e1188031fdf248ee5cd34255c.png)
