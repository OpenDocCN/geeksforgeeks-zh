...
The `<tt>` tag is the abbreviation of teletype text. This tag is deprecated from HTML 5. It was used for marking keyboard input. It was mainly used for formatting purposes. This tag was used in HTML 4 (not supported in HTML5).
**Syntax:**
