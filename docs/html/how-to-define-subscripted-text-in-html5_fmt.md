...
> 原文：[https://www.geeksforgeeks.org/how-to-define-subscripted-text-in-html5/](https://www.geeksforgeeks.org/how-to-define-subscripted-text-in-html5/)

在本文中，我们使用文档中的`<sub>`元素来定义 HTML 中的下标文本。此标签用于向 HTML 文档添加下标文本。`<sub>`标签定义下标文本。下标文本出现在正常行下方半个字符处，有时以较小的字体呈现。下标文字可以用于化学式，就像 H2O 被写成 H₂O 一样。
