...
> 原文：[https://www.geeksforgeeks.org/what-is-the-application-cache-and-why-it-is-used-in-html5/](https://www.geeksforgeeks.org/what-is-the-application-cache-and-why-it-is-used-in-html5/)

任务是了解 HTML5 中的应用程序缓存。HTML 代表超文本标记语言，它被用来使用标记语言设计网页。HTML5 是最新的，或者我们也可以说它是 HTML 的第五个版本。

**HTML5 中的应用缓存：** HTML5 的当前版本引入了应用缓存，这意味着一个 web 应用被缓存，无需互联网连接即可访问。现在，我们只需在应用程序中创建一个清单文件，就可以制作一个无需互联网连接即可运行的离线 web 应用程序。
