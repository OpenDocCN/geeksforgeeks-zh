...
> 原文: [https://www.geeksforgeeks.org/html-img-referrerpolicy-attribute/](https://www.geeksforgeeks.org/html-img-referrerpolicy-attribute/)

**HTML `<img>` referrer policy 属性**用于指定获取图像时将发送到服务器的参考信息。
...
![GeeksforGeeks logo](img/c9808bc55951a3dc0aa9229dcbd3dcca.png)
