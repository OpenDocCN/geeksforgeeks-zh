...
> 原文: [https://www.geeksforgeeks.org/html-navigator-product-property/](https://www.geeksforgeeks.org/html-navigator-product-property/)
...
**支持的浏览器:** *Navigator 产品属性*支持的浏览器如下:
