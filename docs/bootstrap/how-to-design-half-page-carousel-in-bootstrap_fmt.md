...
> 原文：[https://www.geeksforgeeks.org/how-to-design-half-page-carousel-in-bootstrap/](https://www.geeksforgeeks.org/how-to-design-half-page-carousel-in-bootstrap/)
...
**示例：** 在此示例中，我们将更改三个类别 CSS 属性的值，它们是`.carousel-inner`、`.item.active`和`.item img`。它将固定页面转盘的高度。
