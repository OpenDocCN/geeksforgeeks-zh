...
> 原文：[https://www.geeksforgeeks.org/how-to-use-image-overlay-correctly-with-bootstrap/](https://www.geeksforgeeks.org/how-to-use-image-overlay-correctly-with-bootstrap/)

在这篇文章中，我们将学习如何使用 Bootstrap 正确地使用图像覆盖。但在此之前，首先，我们需要知道什么是图像叠加。

## 图像叠加

图像叠加一般是指图像作为背景图像，并在图像内部插入文本、链接。可以使用引导程序中存在的`card-img-overlay`属性来完成。我们也可以用普通的 CSS 和引导主题来做。今天我们将学习这两种技术来了解财产。
            ...
            <div class="card r">
                ...
                <div class="card-img-overlay card-inverse">
                    ...
                    <div class="card-block">
                        <a href="#" class="card-link text-white">Link</a>
...
## 示例 2：仅使用 CSS 而不使用 bootstrap 类

在本例中，我们将演示使用 CSS 的图像覆盖，而 Bootstrap 将包含在代码中。但是在编写代码之前，我们必须包含引导 CDN，以便将引导效果应用到我们的网站。
