...
列表组用于以有组织的方式显示一系列内容。使用`.list-group`和`.list-group-item`类创建项目列表。`.list-group`类与`<ul>`元素一起使用，`.list-group-item`与`<li>`元素一起使用。
...
使用`<div>`和`<a>`标签代替`<ul>`和`<li>`创建带有链接项目的组列表。`.list-group-item-action`类用于设置悬停效果将背景颜色改为灰色。
...
`.disabled`类用于禁用文本内容。这个类将文本颜色设置为浅色。当在链接上使用时，它将移除悬停效果。
...
`.list-group-horizontal`类用于水平显示项目列表，而不是垂直显示。
...
用于设置项目列表的颜色。为列表项目着色的类别有：`.list-group-item-success`、`.list-group-item-secondary`、`.list-group-item-info`、`.list-group-item-warning`、`.list-group-item-danger`、`.list-group-item-primary`、`.list-group-item-dark`和`.list-group-item-light`。
...
<body>
    ...
    <div class="container">
        <h2>List Groups</h2>
        <ul class="list-group">
            <li class="list-group-item d-flex justify-content-between align-items-center">Data Structure
                <span class="badge badge-success">10</span>
            </li>
            <li class="list-group-item d-flex justify-content-between align-items-center">Computer Network
                <span class="badge badge-success">23</span>
            </li>
            <li class="list-group-item d-flex justify-content-between align-items-center">Operating System
