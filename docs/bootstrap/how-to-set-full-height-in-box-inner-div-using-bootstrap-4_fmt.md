...
> 原文: [https://www.geeksforgeeks.org/how-to-set-full-height-in-box-inner-div-using-bootstrap-4/](https://www.geeksforgeeks.org/how-to-set-full-height-in-box-inner-div-using-bootstrap-4/) 设置盒内全高
...
下面的代码创建了三个水平排列的 div，但问题是类 `box-inner` 的内部 div 的高度在所有 div 中都不相同，并且取决于 div 中的文本。我们希望所有 div 的高度都相同，并且等于文本最长的 div 的高度。
...
**解决方案:** 我们将使用 `d-flex` 类来增加所有草皮的高度，同时我们将添加 `width: 100%;` 因此所有草皮的宽度都是可用面积的最大值。
