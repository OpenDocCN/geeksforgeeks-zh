...
> 原文: [https://www.geeksforgeeks.org/how-to-set-the-button-alignment-in-bootstrap/](https://www.geeksforgeeks.org/how-to-set-the-button-alignment-in-bootstrap/)
...
这是目前网上最常用的方法。在这种情况下，父 div 被分配一个 `relative` 位置，而子 div 被分配一个 `absolute` 位置。
