...
> 原文：[https://www.geeksforgeeks.org/how-to-create-a-vertical-or-basic-form-using-bootstrap/](https://www.geeksforgeeks.org/how-to-create-a-vertical-or-basic-form-using-bootstrap/)

**表单**几乎在你访问的每一个网站中都有使用。它通常用于从用户那里收集数据。它由各种交互控件组成，使用户能够输入数据。这些控件被包装在`<form>`标签中，也可以根据需要通过将控件的不同属性设置为不同的值来设计或设置样式。
...
*   在代码主体中包含`<form>`标签，用于创建表单并包装您想要包含在表单中的所有表单控件。
