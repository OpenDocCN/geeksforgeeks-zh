...
> 原文：[https://www.geeksforgeeks.org/how-to-design-full-width-dropdown-navbar-using-bootstrap/](https://www.geeksforgeeks.org/how-to-design-full-width-dropdown-navbar-using-bootstrap/)
...
1.  在 Bootstrap 4 中，通过基于便利性在内部或外部添加 CSS 属性，Navbar 中的全宽下拉列表是可能的。只关注类 `.dropdown` 和 `.dropdown-menu`。
2.  首先聚焦下拉菜单的父类 `.dropdown`，然后使其在位置上保持静态，如下所示：
...
下面的示例说明了如何使用 CSS 属性在导航栏中制作 Bootstrap 4 全宽下拉列表。
...
2.  类似于方法 1，只关注类 `.dropdown` 和 `.dropdown-menu`。
3.  添加类 `.position-static` 连同 `.dropdown` 类，`.dropdown` 类是下拉菜单的父类，如下：

```html
<li class="nav-item dropdown position-static">
```

4.  现在，添加 `.w-100`，`.mt-0` 类以及 `.dropdown-menu` 类如下：
...
下面的示例说明了如何使用 Bootstrap 4 实用程序在导航栏中制作 Bootstrap 4 全宽下拉列表。
...
**参考:**[T2】https://getbootstrap.com/docs/4.0/components/navbar/](https://getbootstrap.com/docs/4.0/components/navbar/)