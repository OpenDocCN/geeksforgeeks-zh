...
> 原文：[https://www.geeksforgeeks.org/how-to-align-images-in-bootstrap-4/](https://www.geeksforgeeks.org/how-to-align-images-in-bootstrap-4/)
...
*   将图像放置在`<body>`标签内的所需行。
*   将图像元素包装在`.float-left`类为向左对齐，`.float-right`向右对齐。
*   对于中心对齐，我们需要使用`.mx-auto`和`.d-block`类自举。
*   为了创建一个响应的图像，我们可以使用`.img-fluid`类内的`<img>`标签。
