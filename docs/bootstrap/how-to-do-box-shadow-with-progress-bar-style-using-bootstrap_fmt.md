...
> 原文：[https://www.geeksforgeeks.org/how-to-do-box-shadow-with-progress-bar-style-using-bootstrap/](https://www.geeksforgeeks.org/how-to-do-box-shadow-with-progress-bar-style-using-bootstrap/)
...
<body>
    <div class="container">
        ...
        <table>
            <tr>
                <td style="box-shadow: 4px 2px 2px 5px rgba(0, 255, 0, 0.3);">
            ...
            <tr>
                <td style="box-shadow:23px 1px 16px rgba(0, 255, 0, 0.3);">
...
<body>
    <div class="container">
        ...
        <table>
            <tr>
                <td style="box-shadow: 1px 2px 2px 5px rgba(0, 255, 0, 0.3); 
