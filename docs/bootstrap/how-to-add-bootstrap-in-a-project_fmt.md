...
> 原文: [https://www.geeksforgeeks.org/how-to-add-bootstrap-in-a-project/](https://www.geeksforgeeks.org/how-to-add-bootstrap-in-a-project/)
...
这种安装 Bootstrap 的方法相当简单，但需要稳定的互联网连接。强烈建议您遵循此方法。

**第一步:** 转到[获取引导](https://getbootstrap.com/)并点击开始。在那里你会发现下面的 CDN 链接。

**第二步:** 复制链接&粘贴到`<head>`标签里面。
...
这种安装 Bootstrap 的方法也很简单，但是可以脱机工作(不需要互联网连接)，但是可能不适用于某些浏览器。
