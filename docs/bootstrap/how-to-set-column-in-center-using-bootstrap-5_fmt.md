...
> 原文：[https://www.geeksforgeeks.org/how-to-set-column-in-center-using-bootstrap-5/](https://www.geeksforgeeks.org/how-to-set-column-in-center-using-bootstrap-5/)

这里的目标是在 bootstrap 中居中一列。Bootstrap 是一个免费的开源 CSS 框架，致力于响应性、移动优先的前端网络开发。在 Bootstrap 中有两种方法可以将列居中。
