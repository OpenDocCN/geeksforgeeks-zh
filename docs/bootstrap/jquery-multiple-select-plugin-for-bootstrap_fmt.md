# jQuery Bootstrap 多选插件

> 原文:[https://www.geeksforgeeks.org/jquery-multiple-select-plugin-for-bootstrap/](https://www.geeksforgeeks.org/jquery-multiple-select-plugin-for-bootstrap/)
...
插件可以通过两种方式包含，即使用 Bootstrap 的个人单独包含。使用 `bootstrap.js` 来创建 js 文件，或者一次创建所有的 js 文件。
