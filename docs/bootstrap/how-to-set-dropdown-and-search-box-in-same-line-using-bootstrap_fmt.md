...
> 原文: [https://www.geeksforgeeks.org/how-to-set-dropdown-and-search-box-in-same-line-using-bootstrap/](https://www.geeksforgeeks.org/how-to-set-dropdown-and-search-box-in-same-line-using-bootstrap/)
...
我们将创建一个导航栏，并创建一个下拉菜单和搜索框，它们最初不会以直线形式出现。我们可以使用列表形式的 HTML 结构的无序列表`<ul>`。
...
<body>
    <h2 align="Center" style="color:green;">
        Dropdown menu and search box without navigation bar
    </h2>
...
![](img/1857f81bf4df2b7758cb398e61812b84.png) ![](img/e9867eaac2e2a3537785e4c015db3c2f.png)