...
> 原文: [https://www.geeksforgeeks.org/how-to-load-notification-alert-on-top-right-corner-without-click-of-button-in-bootstrap/](https://www.geeksforgeeks.org/how-to-load-notification-alert-on-top-right-corner-without-click-of-button-in-bootstrap/)
...
在本例中，我们将在用户滚动页面中的 `<div>` 时显示推送通知。要创建引导吐司，我们需要在一个分部上使用 `toast` 类，并在其中添加两个分部，类别为 `toast-header` 和 `toast-body`。我们将使用 `jquery` 显示通知。
