...
> 原文: [https://www.geeksforgeeks.org/how-to-create-a-bootstrap-tooltip-using-jquery/](https://www.geeksforgeeks.org/how-to-create-a-bootstrap-tooltip-using-jquery/)
...
首先从 Bootstrap 官网导入 Bootstrap CSS 的所有 Bootstrap CDN。
...
从 jQuery CDN 官方网站导入 jQuery 链接到 HTML 文件。

## 第三步

要创建工具提示，我们必须给任何元素添加 `data-bs-toggle` 属性，要添加工具提示悬停时需要显示的文本，我们必须给 HTML 元素添加 `title` 属性。
...
之后，将 jQuery 代码段添加到下面给定的 HTML 文件中的脚本标签中：
...
因此，我们已经使用 jQuery 在 Bootstrap 中成功创建了工具提示。
