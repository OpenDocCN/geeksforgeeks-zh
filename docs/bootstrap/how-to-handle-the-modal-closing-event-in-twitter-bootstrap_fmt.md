...
> 原文：[如何在 Twitter Bootstrap 中处理模态关闭事件](https://www.geeksforgeeks.org/how-to-handle-the-modal-closing-event-in-twitter-bootstrap/)

[推特引导中的模态关闭事件|第 1 集](https://www.geeksforgeeks.org/how-to-use-modal-closing-event-in-twitter-bootstrap/)

## 先决知识

[Bootstrap 4 | 模态](https://www.geeksforgeeks.org/bootstrap-4-modal/)
...
引导事件有：`show.bs.modal`、`shown.bs.modal`、`hide.bs.modal`、`hidden.bs.modal` 等。在所有这些事件中，我们对 `hide.bs.modal` 和 `hidden.bs.modal` 事件感兴趣。
