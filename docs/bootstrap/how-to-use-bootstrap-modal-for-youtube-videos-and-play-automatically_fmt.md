...
> 原文：[https://www.geeksforgeeks.org/how-to-use-bootstrap-modal-for-youtube-videos-and-play-automatically/](https://www.geeksforgeeks.org/how-to-use-bootstrap-modal-for-youtube-videos-and-play-automatically/)
...
这个例子实现了如何在 Bootstrap 模式下嵌入 YouTube 视频但不自动播放。
...
本示例实现了如何在 Bootstrap 模态内部自动播放 YouTube 视频。要让 YouTube 视频以引导模式自动播放，我们必须放置`?autoplay=1`在附加的 Youtube 的源文件之后。
