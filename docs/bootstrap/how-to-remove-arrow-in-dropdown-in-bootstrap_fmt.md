...
> 原文: [https://www.geeksforgeeks.org/how-to-remove-arrow-in-dropdown-in-bootstrap/](https://www.geeksforgeeks.org/how-to-remove-arrow-in-dropdown-in-bootstrap/)
...
每个引导下拉按钮或链接在 CSS 中的选择器后都有一个 `::after`。`::after` 选择器通常用于在元素内容之后插入一些文本。在这种情况下，内容是一个下拉箭头。要删除它，只需将内容转到 `“无”`。
