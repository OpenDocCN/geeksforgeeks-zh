...
> 原文：[https://www.geeksforgeeks.org/how-to-create-jumbotron-using-bootstrap-5/](https://www.geeksforgeeks.org/how-to-create-jumbotron-using-bootstrap-5/)
...
我们使用了`jumbotron-fluid`类和`jumbotron`类。
...
## 示例 3：对 Jumbotron 进行样式化

我们还可以对 Jumbotron 进行样式化，并添加背景图像，使其更具吸引力，如下图所示。
