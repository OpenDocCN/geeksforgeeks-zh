...
> 原文：[https://www.geeksforgeeks.org/how-to-align-buttons-in-card-footer-in-bootstrap/](https://www.geeksforgeeks.org/how-to-align-buttons-in-card-footer-in-bootstrap/)

当您熟悉浮动元素时，卡片页脚中按钮的对齐非常容易。还有一种方法可以将按钮放在卡片页脚的任何位置，使其左右对齐。在本文中，您将学习如何对齐引导卡页脚部分的按钮。
