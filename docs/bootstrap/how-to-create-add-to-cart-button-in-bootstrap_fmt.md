...
> 原文：[https://www.geeksforgeeks.org/how-to-create-add-to-cart-button-in-bootstrap/](https://www.geeksforgeeks.org/how-to-create-add-to-cart-button-in-bootstrap/)
...
现在，正如您在**输出**中看到的，我们已经在 HTML 正文中包含了**添加到购物车**按钮，上面有一个小购物车图标。
