...
> 原文: [https://www.geeksforgeeks.org/bootstrap-4-holy-grail-layout/](https://www.geeksforgeeks.org/bootstrap-4-holy-grail-layout/)
...
我们将使用 `Bootstrap 4` 来实现相同的简单布局。我们将直接用于实现该设计的组件有:
