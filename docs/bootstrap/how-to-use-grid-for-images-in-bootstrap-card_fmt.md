...
> 原文：[https://www.geeksforgeeks.org/how-to-use-grid-for-images-in-bootstrap-card/](https://www.geeksforgeeks.org/how-to-use-grid-for-images-in-bootstrap-card/)
...
先设置数值 [`display: grid;`](https://www.geeksforgeeks.org/css-grid-property/) 的 `div` 包装所有的图像，将其转换成网格布局。然后设置 [`grid-template-columns`](https://www.geeksforgeeks.org/css-grid-template-columns-property/) 的值为 `auto auto` 的网格容器来指定网格布局中的列数。现在设置 `width` 值为 `100%` 的图像得到一个完美的网格。
