...
### 步骤 1
在所有其他样式表之前将 Bootstrap 和[jQuery CDN](https://www.geeksforgeeks.org/how-to-add-jquery-code-to-html-file/)包含到`<head>`标记中，以加载 CSS。
...
### 步骤 2
在`<ul>`标记中的`.nav`类之后添加`.nav-pilles`类。
...
<html lang="en">
  ...
  <body>
    <div class="container">
      ...
      <!--Include .nav-pills class after .nav class in <ul> tag-->
      <ul class="nav nav-pills">
        <li class="active"><a href="#">Home</a></li>
...
![带有下拉菜单的药丸](img/22ce55054e3413432b99e04f344014e3.png)
