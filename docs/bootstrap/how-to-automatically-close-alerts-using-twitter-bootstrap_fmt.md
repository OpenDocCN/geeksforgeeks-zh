...
> 原文：[https://www.geeksforgeeks.org/how-to-automatically-close-alerts-using-twitter-bootstrap/](https://www.geeksforgeeks.org/how-to-automatically-close-alerts-using-twitter-bootstrap/)
...
在此示例中，使用 id 在脚本中访问警报，然后警报在 5 秒钟后关闭。
...
在本例中，使用警报的类在脚本中访问警报，警报在 2 秒后关闭。
...
![](img/cdaee1c7d2e386691d03ae27137cd644.png)
![](img/0100b14cf67b8f7d5b34bead1f008a77.png)

## 示例 3

在本例中，bootstrap `hide` 类被动态添加到 alert 中，5 秒后关闭 alert。`addClass()` 是使用 JavaScript 向任何元素添加类的方法。
