...
> 原文：[https://www.geeksforgeeks.org/what-is-the-bootstrap-page-header/](https://www.geeksforgeeks.org/what-is-the-bootstrap-page-header/)
...
**第一步：** 将 Bootstrap 和 jQuery CDN 包含到 [`<head>`](https://www.geeksforgeeks.org/html-head-tag/) 标签之前，所有其他样式表加载我们的 CSS。
...
**第三步：** 要使用页眉，请将您的页眉包装在一个 `<div>` 中，该分区的等级为 `page-header`。
