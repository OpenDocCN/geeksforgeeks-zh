...
> 原文: [https://www.geeksforgeeks.org/how-to-add-image-before-optgroup-label-using-bootstrap/](https://www.geeksforgeeks.org/how-to-add-image-before-optgroup-label-using-bootstrap/)

## 什么是 optgroup 标签？

它是一个 HTML 标签，用于对 [`<select>` 标签](https://www.geeksforgeeks.org/html-select-tag/) 中给出的选项进行分组。这结合了具有不同标签的不同组中的选项。
...
以下示例演示了使用 Bootstrap 在标签前具有图像的 `optgroup`。
