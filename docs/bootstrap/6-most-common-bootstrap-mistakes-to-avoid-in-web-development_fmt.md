...
> 原文：[https://www.geeksforgeeks.org/6-most-common-bootstrap-mistakes-to-avoid-in-web-development/](https://www.geeksforgeeks.org/6-most-common-bootstrap-mistakes-to-avoid-in-web-development/)
...
**如果是。那么你肯定在你的应用程序中使用了 [Bootstrap](https://www.geeksforgeeks.org/bootstrap-tutorials/) (或者你可能已经使用了)，这篇文章值得一读(让我们继续……)**

如果我们问……**如何开始应用程序的前端部分，你的答案是什么？**
...
让我们以应用程序中的模态对话框为例。要触发模态对话框，请在按钮或锚点等控制器组件上设置 `data-toggle="modal"`，然后使用 `data-*` 属性传递额外的参数。

```html
<button type="button" data-toggle="modal" data-target="#myModal" data-backdrop="static" data-keyboard="false">打开我的模态</button>
```

*   `#myModal` 用于定位 HTML 代码。
*   `data-backdrop="static"` 指定当用户在模式外单击时，模式不会关闭
