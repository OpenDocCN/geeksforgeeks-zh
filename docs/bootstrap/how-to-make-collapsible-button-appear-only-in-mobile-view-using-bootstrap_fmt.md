...
> 原文: [https://www.geeksforgeeks.org/how-to-make-collapsible-button-appear-only-in-mobile-view-using-bootstrap/](https://www.geeksforgeeks.org/how-to-make-collapsible-button-appear-only-in-mobile-view-using-bootstrap/)
    ...
    <nav id="header-nav" 
        ...
        <div class="container">
            <div class="navbar-header">
                ...
                <!-- Display content of collapse button -->
