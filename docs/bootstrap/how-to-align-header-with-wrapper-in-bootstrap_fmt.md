...
> 原文：[https://www.geeksforgeeks.org/how-to-align-header-with-wrapper-in-bootstrap/](https://www.geeksforgeeks.org/how-to-align-header-with-wrapper-in-bootstrap/)
...
**工作原理：** 创建一个包装器，并为其分配一定的宽度。使用 `margin: auto` 或 `margin-left: auto` 或 `margin-right: auto` 属性对其应用自动水平边距。确保您的内容将居中。
