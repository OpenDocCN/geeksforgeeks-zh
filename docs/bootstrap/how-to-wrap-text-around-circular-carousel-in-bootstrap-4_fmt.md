...
> 原文：[https://www.geeksforgeeks.org/how-to-wrap-text-around-circular-carousel-in-bootstrap-4/](https://www.geeksforgeeks.org/how-to-wrap-text-around-circular-carousel-in-bootstrap-4/)

与包装圆形图像或任何形状的图像相比，包装圆形旋转木马相当忙乱。在本文中，首先，我们必须创建一个旋转木马来使其循环，然后我们可以使用文本来包装旋转木马。
首先，你必须创建 [`Bootstrap Carousel`](https://www.geeksforgeeks.org/bootstrap-carousel/)。要使旋转木马呈圆形，可以使用 [`CSS border-radius property`](https://www.geeksforgeeks.org/css-border-radius-property/) 属性。然后写下你的环绕文字，使用主 div 上的 [`CSS Circle() function`](https://www.geeksforgeeks.org/css-circle-function/)。这将以适当的方式包装您的圆形转盘：
下面的示例说明了上面的方法：
