...
## 示例 1
本示例使用 bootstrap 在所有设备和屏幕宽度上创建等宽的列网格。
...
## 示例 2
本示例使用 bootstrap 创建等宽响应列网格。当屏幕尺寸小于 576px 时，各列自动相互堆叠。
...
## 示例 3
本示例使用 bootstrap 创建不等宽响应列网格。当屏幕尺寸小于 576px 时，各列自动相互堆叠。
