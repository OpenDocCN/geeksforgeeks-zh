...
> 原文：[https://www.geeksforgeeks.org/how-to-configure-modal-width-in-bootstrap/](https://www.geeksforgeeks.org/how-to-configure-modal-width-in-bootstrap/)
...
Bootstrap 具有预定义的类，用于更改模式维度属性，以便与包含`.modal-dialog`的`div`元素一起使用。这些列表如下：
...
我们还可以通过更改包含`.modal-dialog`类的`div`的 CSS 属性来自定义模态的宽度/高度。下面是同样的解决方案。
