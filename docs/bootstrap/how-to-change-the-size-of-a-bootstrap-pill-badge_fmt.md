...
> 原文：[https://www.geeksforgeeks.org/how-to-change-the-size-of-a-bootstrap-pill-badge/](https://www.geeksforgeeks.org/how-to-change-the-size-of-a-bootstrap-pill-badge/)
...
你可以简单的给 `span` 标签添加一个样式属性，`span` 标签以 `badge badge-pill` 为类，根据你的意愿改变字体大小。
...
我们还可以将徽章的 `span` 标签包装在不同的标题标签中，以达到预期的效果。
...
## 方法三：通过使用内部/外部 CSS 覆盖类

我们还可以为徽章添加我们自己的自定义类名，并且在 CSS 文件中，我们可以更新 `font-size` 属性以达到期望的结果。
