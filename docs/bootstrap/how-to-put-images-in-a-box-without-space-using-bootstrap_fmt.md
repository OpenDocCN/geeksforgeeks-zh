...
> 原文：[https://www.geeksforgeeks.org/how-to-put-images-in-a-box-without-space-using-bootstrap/](https://www.geeksforgeeks.org/how-to-put-images-in-a-box-without-space-using-bootstrap/)
...
### 3. 使用 Bootstrap 4 CSS

我们将使用预定义的类 `cards` 来使图像出现在一个盒子中。
