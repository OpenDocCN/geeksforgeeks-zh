...
> 原文：[https://www.geeksforgeeks.org/how-to-create-dismissible-alerts-in-bootstrap/](https://www.geeksforgeeks.org/how-to-create-dismissible-alerts-in-bootstrap/)
...
我们可以添加关闭按钮并使用`.alert-dismissible`类，在警报右侧增加额外的填充，定位关闭按钮。在关闭按钮上，我们使用`data-bs-dismiss="alert"`属性，该属性触发 JavaScript 功能。这里建议使用`<button>`元素，以便所有设备都能正常工作。我们可以使用`.fade`和`.show`类以在警报被消除时激活警报。
