...
> 原文:[https://www.geeksforgeeks.org/bootstrap-close-icon-for-dismissing-content-with-examples/](https://www.geeksforgeeks.org/bootstrap-close-icon-for-dismissing-content-with-examples/)
...
**注意:** `data-dismiss` 属性可以与按钮标签一起使用，以消除组件，如模式或警报。
