# jQuery UI 按钮小部件 `widget()` 方法

> 原文：[https://www.geeksforgeeks.org/jquery-ui-button-widget-method/](https://www.geeksforgeeks.org/jquery-ui-button-widget-method/)
...
> <link rel='stylesheet'
> href="http://ajax.googleapis.com/ajax/libs/jqueryui/1.8.16/themes/ui-light/jquery-ui.css">
