...
*   [jQuery UI 可调整大小 `destroy()` 方法](https://www.geeksforgeeks.org/jquery-ui-resizable-destroy-method/)
*   [jQuery UI 可调整大小 `disable()` 方法](https://www.geeksforgeeks.org/jquery-ui-resizable-disable-method/)
...
[`jQuery UI widget()` 方法](https://www.geeksforgeeks.org/jquery-ui-widget-method/)
...
*   [jQuery UI 手风琴 `destroy()` 方法](https://www.geeksforgeeks.org/jquery-ui-accordion-destroy-method/)
*   [jQuery UI 手风琴 `disable()` 方法](https://www.geeksforgeeks.org/jquery-ui-accordion-disable-method/)
*   [jQuery UI 手风琴 `option()` 方法](https://www.geeksforgeeks.org/jquery-ui-accordion-option-method/)
*   [jQuery UI 手风琴 `widget()` 方法](https://www.geeksforgeeks.org/jquey-ui-accordion-widget-method/)
*   [jQuery UI 手风琴 `widget('instance')` 方法](https://www.geeksforgeeks.org/jquery-ui-accordion-widget-instance-method/)
...
*   [jQuery UI 按钮 `widget('instance')` 方法](https://www.geeksforgeeks.org/jquery-ui-button-widget-instance-method/)
...
*   [jQuery UI Datepicker dayNames 选项](https://www.geeksforgeeks.org/jquery-ui-datepicker-daynames-option/)
