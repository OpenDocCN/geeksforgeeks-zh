...
> 原文：[https://www.geeksforgeeks.org/jquery-ui-button-instance-method/](https://www.geeksforgeeks.org/jquery-ui-button-instance-method/)
...
<link href="http://ajax.googleapis.com/ajax/libs/jqueryui/1.8.16/jquery-ui.css" rel="stylesheet" type="text/css" />
```
