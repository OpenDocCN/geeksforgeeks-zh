...
> 原文：[https://www.geeksforgeeks.org/jquery-ui-sortable-delay-option/](https://www.geeksforgeeks.org/jquery-ui-sortable-delay-option/)

jQuery UI 可排序小部件 `delay` 选项用于设置以毫秒为单位的时间，以定义排序应该何时开始。
