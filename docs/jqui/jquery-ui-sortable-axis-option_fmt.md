...
> 原文：[https://www.geeksforgeeks.org/jquery-ui-sortable-axis-option/](https://www.geeksforgeeks.org/jquery-ui-sortable-axis-option/)

jQuery UI 可排序小部件 `axis` 选项用于定义只能水平或垂直拖动的项目。它的可能值是–`"x"`、`"y"`。
