...
> 原文: [https://www.geeksforgeeks.org/jquery-ui-selectable-disabled-option/](https://www.geeksforgeeks.org/jquery-ui-selectable-disabled-option/)
...
jQuery UI [可选](https://www.geeksforgeeks.org/jquery-selectable-and-accordion/) `disabled` 选项用于在设置为 `true` 时禁用可选元素。

## 语法

*   **用 `disabled` 选项初始化可选元素:**
...
[https://api.jqueryui.com/selectable/#option-disabled](https://api.jqueryui.com/selectable/#option-disabled)