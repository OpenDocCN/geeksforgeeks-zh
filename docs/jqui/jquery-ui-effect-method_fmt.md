...
`jQuery UI`框架提供了`effect()`的方法，无需使用`show()`和`hide()`方法，即可管理所选元素上不同种类的视觉效果。有许多类型的效果作为参数传递给`effect()`方法。
...
```html
<link href="https://code.jquery.com/ui/1.10.4/themes/ui-light/jquery-ui.css" rel="stylesheet" type="text/css"/>
<script src="https://code.jquery.com/jquery-1.10.2.js"></script>
```

*效应类型*有多种，可根据项目要求传递到`effect()`方法。在下面的例子中，我们将只演示其中的一些以及输出图像。

## 示例 1

以下示例演示了 jQuery UI `effect()`方法，其中*摇动*效果，选项设置为*时间*和*距离*。
...
下面的代码演示了 jQuery UI `effect()`方法，用*分解*效果，用*缓和*设置为“摇摆”。
