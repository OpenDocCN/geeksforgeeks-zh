...
> 原文: [https://www.geeksforgeeks.org/jquery-ui-selectable-classes-option/](https://www.geeksforgeeks.org/jquery-ui-selectable-classes-option/)
...
```html
$( ".selector" ).selectable( "option", "classes.ui-selectable", "class-name");
```
...
[https://api.jqueryui.com/selectable/#option-classes](https://api.jqueryui.com/selectable/#option-classes)