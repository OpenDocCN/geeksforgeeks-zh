...
> 原文：[https://www.geeksforgeeks.org/jquery-ui-sortable-disabled-option/](https://www.geeksforgeeks.org/jquery-ui-sortable-disabled-option/)

jQuery UI 可排序小部件 `disabled` 选项用于禁用可排序元素，如果它设置为 `true`。
...
[https://api.jqueryui.com/sortable/#option-disabled](https://api.jqueryui.com/sortable/#option-disabled)