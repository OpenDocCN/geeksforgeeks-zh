...
> 原文: [https://www.geeksforgeeks.org/jquery-ui-spinner-to-select-numeric-data/](https://www.geeksforgeeks.org/jquery-ui-spinner-to-select-numeric-data/)
...
我们可以使用页面值来设置 Page up 或 Page down 按键值。
