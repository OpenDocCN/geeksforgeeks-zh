# jQuery UI 选项(optionName)方法

> 原文: [https://www.geeksforgeeks.org/jquery-ui-option-optionname-method/](https://www.geeksforgeeks.org/jquery-ui-option-optionname-method/)

jQuery UI `option(optionName)`方法用于检查方法是否返回一个布尔值，该值表示对象选项是否存在。
