...
> 原文: [https://www.geeksforgeeks.org/jquery-ui-selectable-cancel-option/](https://www.geeksforgeeks.org/jquery-ui-selectable-cancel-option/)

jQuery UI 由 GUI 小部件、视觉效果和使用 Query JavaScript 库实现的主题组成。jQuery 用户界面非常适合为网页构建用户界面。它可以用来构建高度交互的 web 应用程序，也可以用来轻松添加小部件。

**jQuery UI Selectable Cancel Option** 用于防止在匹配元素上开始选择。
...
**参考:** [https://api.jqueryui.com/selectable/#option-cancel](https://api.jqueryui.com/selectable/#option-cancel)