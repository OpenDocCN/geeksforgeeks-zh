...
*   [jQuery 用户界面对话框`close()`方法](https://www.geeksforgeeks.org/jquery-ui-dialog-close-method/)
*   [jQuery 用户界面对话框`destroy()`方法](https://www.geeksforgeeks.org/jquery-ui-dialog-destroy-method/)
*   查询用户界面对话框`instance()`方法
*   [jQuery UI 对话框`isOpen()`方法](https://www.geeksforgeeks.org/jquery-ui-dialog-isopen-method/)
*   jquery ui move toop()对话框凯伊姆
*   [jQuery 用户界面对话框`open()`方法](https://www.geeksforgeeks.org/jquery-ui-dialog-isopen-method/)
