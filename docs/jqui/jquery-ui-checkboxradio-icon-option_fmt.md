# jQuery UI Checkbox Radio Icon Option

> 原文: [`https://www.geeksforgeeks.org/jquery-ui-checkboxradio-icon-option/`](https://www.geeksforgeeks.org/jquery-ui-checkboxradio-icon-option/)
