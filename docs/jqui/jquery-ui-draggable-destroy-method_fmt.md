# jQuery UI 可拖动 `destroy()` 方法

> 原文: [https://www.geeksforgeeks.org/jquery-ui-draggable-destroy-method/](https://www.geeksforgeeks.org/jquery-ui-draggable-destroy-method/)
...
**示例:** 下面的示例说明了 jQuery UI 中的可拖动 `destroy()` 方法。
