...
> 原文: [https://www.geeksforgeeks.org/jquery-ui-datepicker-getdate-method/](https://www.geeksforgeeks.org/jquery-ui-datepicker-getdate-method/)

jQuery UI datepicker `getDate()` 方法用于从日期字段获取日期。
