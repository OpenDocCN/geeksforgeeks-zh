# jQuery UI DatePicker onChangeMonthYear 选项
...
[https://API . jquery ui . com/date picker/# option-onchangemonthyear](https://api.jqueryui.com/datepicker/#option-onChangeMonthYear)