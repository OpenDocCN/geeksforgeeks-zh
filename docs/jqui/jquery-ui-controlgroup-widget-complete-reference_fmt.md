# jQuery UI 控件组小部件完整参考

> 原文：[https://www.geeksforgeeks.org/jquery-ui-controlgroup-widget-complete-reference/](https://www.geeksforgeeks.org/jquery-ui-controlgroup-widget-complete-reference/)

[`jQuery UI Controlgroup Widget`](https://www.geeksforgeeks.org/jquery-ui-Controlgroup-widget/) 用于向网站添加可输入的内容。这个小部件中有很多选项、方法和事件，它们都在下面列出和分类。
