# jQuery UI 日期选择器 `setDate()` 方法

> 原文：[https://www.geeksforgeeks.org/jquery-ui-datepicker-setdate-method/](https://www.geeksforgeeks.org/jquery-ui-datepicker-setdate-method/)

jQuery UI datepicker `setDate()` 方法用于从日期字段设置日期。
