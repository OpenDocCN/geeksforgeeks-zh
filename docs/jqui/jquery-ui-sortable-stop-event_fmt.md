...
> 原文: [https://www.geeksforgeeks.org/jquery-ui-sortable-stop-event/](https://www.geeksforgeeks.org/jquery-ui-sortable-stop-event/)
...
jQuery UI 可排序 `stop` 事件用于在列表项排序停止时触发。
...
**参考:** [https://api.jqueryui.com/sortable/#event-stop](https://api.jqueryui.com/sortable/#event-stop)