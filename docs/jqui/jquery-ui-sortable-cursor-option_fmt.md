...
> 原文: [https://www.geeksforgeeks.org/jquery-ui-sortable-cursor-option/](https://www.geeksforgeeks.org/jquery-ui-sortable-cursor-option/)

`jQuery UI` 可排序小部件的 `cursor` 选项用于定义排序元素时显示的光标。
